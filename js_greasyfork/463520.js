...
// @namespace    大麦定制
// @version      3.0.1
// @description  定制大麦抢票脚本，高相应高并发多线程
// @author       xyzzz66
// @license      xyzzz66
...
// @downloadURL https://update.greasyfork.org/scripts/463520/%E5%A4%A7%E9%BA%A6%E6%8A%A2%E7%A5%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/463520/%E5%A4%A7%E9%BA%A6%E6%8A%A2%E7%A5%A8.meta.js
// ==/UserScript==
...
var $style = $('<style>' +
    '#control_container{margin: 20px 0; background:#fddde6;padding:20px 0;}' +
    'p{margin:10px 0;}' +
    ...
    '.input_wrapper_phone{width: 50%;font-size: 25px;margin:20px 20px;padding:20px 20px; text-align:center;}' +
    '.notice{margin:10px 10px;padding:10px 10px;color:#fddde6;border-style: solid; border-width: 1px; border-color:#fddde6;}' +
...
function detail_ui() {
    ...
    var $wx = $(`<div id="wx" class="notice"><p>定制版大麦抢票</p><p>版本： ${version}</p></div>`);
...
function phone_detail_ui() {
    ...
    var $control_container = $("<div id='control_container'></div>");
    var $wx = $(`<div id="wx" class="notice"><p>大麦定制 </p><p>版本： ${version}</p></div>`);
    ...
    var $notice2 = $('<div id="notice2" class="notice"><p></p></div>');
