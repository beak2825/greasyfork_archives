// ==UserScript==
// @name         Steam Language BBCode quick copy
...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/405861/Steam%20Language%20BBCode%20quick%20copy.user.js
// @updateURL https://update.greasyfork.org/scripts/405861/Steam%20Language%20BBCode%20quick%20copy.meta.js
// ==/UserScript==
...
(function() {
  ...
  function steamButton(){
    ...
    const $container = document.querySelector('table.game_language_options').parentNode.querySelector('div.block_title');
  ...
  function parseSteamLanguage($document){
    ...
    for(var i = 0; i < keys.length; i++){
      ...
      if(keys.length === 1){
        ...
        output += `[b]${keygroup.join(' 和 ')} 语言${multi ? "": ""}[/b]: `;
      }
