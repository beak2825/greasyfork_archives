// ==UserScript==
// @name         精简版 Pokemon Showdown Gen9dlc2汉化
// @namespace    http://tampermonkey.net/
// @license      MIT
// @version      2024.9.1
// @author       WyAk
// @description  精简版 Pokemon Showdown Gen9汉化
// @match        *://china.psim.us/*
...
// @downloadURL https://update.greasyfork.org/scripts/491707/%E7%B2%BE%E7%AE%80%E7%89%88%20Pokemon%20Showdown%20Gen9dlc2%E6%B1%89%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/491707/%E7%B2%BE%E7%AE%80%E7%89%88%20Pokemon%20Showdown%20Gen9dlc2%E6%B1%89%E5%8C%96.meta.js
// ==/UserScript==
var translations = {
    ...
    "Your username must contain at least one letter.": "你的用户名至少要包含一个字母。",
    "Home": "主页",
    "Format:": "分级：",
    "Team:": "队伍：",
    "Team": "队伍",
    ...
    "Loading...": "正在加载...",
    "Work offline": "离线模式",
    "Your team is valid for this tournament.": "你的队伍在本次锦标赛中合法。",
    "You challenged less than 10 seconds after your last challenge! It's cancelled in case it's a misclick.": "你在上次挑战后10秒内进行了挑战！以防出错，这次挑战被取消了。",
    "Challenge cancelled because they changed their username.": "挑战取消，因为他更改了用户名。",
    "Your searches and challenges have been cancelled because you changed your username.": "你的搜索和挑战已被取消，因为你更改了用户名。",
    "You are disconnected and cannot chat.": "你已断开连接，无法聊天。",
    "This server is requesting an invalid login key.This probably means that either you are notconnected to a server, or the server is set upincorrectly.": "服务器登录密钥请求无效。你没有连接到服务器，或者服务器设置错误。",
    "The server is restarting. Battles will be available again in a few minutes.": "服务器正在重新启动,几分钟后才能开始对局。",
    "You have been disconnected – possibly because the server was restarted.": "你已断开连接 - 可能是因为服务器已重启。",
    "You have been logged out and disconnected.": "你已经登出并且断开了连接",
    "(Others will be able to see your name change. To change name privately, use \"Log out\")": "其他人可以看到你更改了用户名，想要私下的更改用户名，点击‘登出’按钮",
    "If you wanted to change your name while staying connected, use the 'Change Name' button or the '/nick' command.": "如果你想要在保持连接的情况下更改用户名，点击‘更改用户名’按钮或者使用/nick指令。",
    "The name you chose is registered.": "你选择的用户名已经被注册了。",
  	"You have been successfully registered.": "你已成功注册。",
    ...
    "Please finish your battles quickly. No new battles can be started until the server resets in a few minutes.": "请尽快结束战斗！在服务器数分钟后的重置前，无法启动任何新的战斗。",
    "We fixed the crash without restarting the server!": "我们在没有重新启动服务器的情况下修复了崩溃！",
    "The server restart was canceled.": "服务器取消了重新启动。",
    "Log in": "登录",
    "Username": "用户名",
    "Open": "查找",
    "Battles:": "对战：",
    ...
    "You have no teams": "你没有队伍。",
    "You need to go into the Teambuilder and build a team for this format.": "你需要在队伍编辑器中为这个分级添加一个队伍。",
    "Please select a team.": "请选择一个队伍。",
    "Season rankings": "赛季排名",
    "You can't change name in the middle of these games:": "你不能在以下比赛中更改用户名：",
    "Forfeit and change name": "弃权并更改用户名",
    "Your username must be less than 19 characters long.": "你的用户名长度不能超过18个字符。",
    "(color)": "(颜色)",
    "You are already challenging someone. Cancel that challenge before challenging someone else.": "你正在挑战某人。取消该挑战才能挑战其他人。",
    ...
    "and": " 和 ",
    "You can also set natures by typing": "你可以在基础点数框内输入",
    ...
    "Clearing your cookies (specifically,": "清除你的cookie（准确的说，是",
    ") will delete your teams.": ") 将清空你的队伍。",
    "If you want to clear your cookies or": "如果你想清除cookie或",
    ", you can use the Backup/Restore feature to save your teams as text first.": "，可以使用备份/还原功能先将你的队伍保存为文本。",
    ...
    "Folders": "文件夹",
    "(add folder)": "(添加文件夹)",
    "Did you have a good day?": "你今天过的怎样?",
    "Yes, my day was pretty good": "我今天过得很好",
    "No, it wasn't great": "不是很好",
    "Aww, that's too bad. :( I hope playing on Pokemon Showdown today can help cheer you up!": "啊，太糟糕了 :( 我希望今天的PS战斗能帮你振作起来！",
    "All teams": "所有队伍",
    "New Team": "新的队伍",
    "New Box": "新的箱子",
    "Undo Delete": "撤销",
    ...
    "you don't have any teams lol": "你还没有队伍",
    ...
    "Add a Pokemon to your team before uploading it!": "上传之前先将宝可梦添加到你的队伍中！",
    "You need at least one Pokemon to validate.": "你需要至少一个宝可梦来确认是否合法。",
    "Clear clipboard": "清除剪贴板",
    "No move": "没有招式",
    "Clipboard:": "剪贴板：",
    "Other teams":"其他队伍",
    "Upload to Showdown database (saves across devices)":"上传到Showdown数据库（跨设备保存)",
    "Browsers sometimes randomly clear cookies - you should upload your teams to the Showdown database or make a backup yourself if you want to make sure you don't lose them.": "浏览器有时会随机清除cookie - 如果你想确保不会丢失队伍，你应该将队伍上传到Showdown数据库，或者自己备份。",
    "(Private:":"(私人的：",
    "(No Folder)": "（无文件夹）",
    ...
    "Your old password was incorrect.": "你的旧密码不正确。",
    "Your new passwords do not match.": "你的新密码不匹配。",
    "Your passwords do not match.": "你的密码不匹配。",
    "Your password was successfully changed.": "你的密码已成功更改。",
    "Your username is no longer available.": "你的选择的用户名不可使用。",
    "Graphics": "界面：",
    "Layout:": "布局：",
    ...
    "Highlight when your name is said in chat": "当你的名字出现在聊天窗口时，名字颜色会高亮",
    ...
    "Search replays": "搜索回放",
    "Public": "公开的",
    "Private (your own replays only)": "私人的 (你自己的回放)",
    "More replays": "更多回放",
    "More": "更多",
    "Replay": "回放",
    ...
    "You cannot mega evolve Rayquaza": "你不能超级进化烈空坐",
    ...
    "Deals 1/8 max HP every turn; 1/4 if Steel or Water.": "每回合造成1/8最大生命值的伤害，如果是钢系或水系则为1/4",
    ...
    "User: +1 Atk, +1 Spe. Clears any Substitute and hazards.": "清钉，使用者的速度和攻击提高1级",
    "Hits 3 times.": "攻击三次",
    "Raises the user Attack": "提升使用者的攻击",
    "Raises the user攻击": "提升使用者的攻击",
    "Raises the user's Attack": "提升使用者的攻击",
    "User's Electric type becomes typeless; must be Electric.": "必须具有电属性，使用后自己的电属性将会消失",
    ...
    "High critical hit ratio. 10% chance to poison.": "容易击中要害有10%几率使对手中毒",
    ...
    "10% chance to burn. 10% chance to flinch.": "有10%几率使目标陷入灼伤状态有10%几率使目标畏缩",
    ...
    "Charges turn 1. Hits turn 2. 30% paralyze.": "第一回合充能，第二回合攻击。30%几率使目标麻痹",
    ...
    "Charges, then raises SpA, SpD, Spe by 2 turn 2.": "先充能，然后提升使用者的特攻、特防和速度各2级",
    ...
    "Charges turn 1. Hits turn 2. 30% burn.": "第一回合充能，第二回合攻击。有30%几率使目标灼伤",
    ...
    "30% chance to burn the target. Thaws target.": "30%几率使目标陷入灼伤状态能令使用者解除冰冻状态",
    ...
    "User heals HP=target's Atk stat. Lowers Atk by 1.": "使用者回复和目标当前攻击数值相同的HP。降低目标的攻击1级",
    ...
    "Causes the target to become confused.": "使目标陷入混乱状态",
    ...
    "Charges turn 1. Hits turn 2.": "第1回合蓄力，第2回合攻击对手",
    ...
    "User takes sure-hit 2x damage until its next turn.": "下次使出招式之前，任何以你为目标的招式必中且伤害翻倍",
    ...
    "50% chance to sleep, poison, or paralyze target.": "50%几率使目标陷入中毒状态、麻痹状态或睡眠状态",
    ...
    "User's Electric type: typeless; must be Electric.": "使用者是电系时，使用后自身电属性变成无属性",
    ...
    "User +1 Atk, Spe. Clears all substitutes/hazards.": "使用者提升1级攻击和速度。移除双方所有替身/入场生效状态",
    ...
    "This Pokemon cannot be poisoned. Gaining this Ability while poisoned cures it.": "不会陷入中毒和剧毒状态，获得特性时治愈中毒和剧毒状态",
    ...
    "This Pokemon cannot be frozen. Gaining this Ability while frozen cures it.": "不会陷入冰冻状态，获得该特性时可治愈冰冻状态",
    ...
    "If an ally uses its item, this Pokemon gives its item to that ally immediately.": "同伴使用道具后会立即将你的道具交给它",
    ...
    "This Pokemon's attacks that are not very effective on a target deal double damage.": "造成的效果不好的伤害翻倍",
    ...
    "This Pokemon cannot be burned. Gaining this Ability while burned cures it.": "不会陷入灼伤状态，获得该特性时可治愈灼伤状态",
    ...
    "Fire damage against this Pokemon is dealt with 1/2 offensive stat; 1/2 burn damage.": "火属性招式和灼伤对你造成的伤害变为原本的一半",
    ...
    "If this Pokemon poisons or badly poisons a target, the target also becomes confused.": "因你的招式而陷入中毒状态的对手同时也会陷入混乱状态",
    ...
    "A swamp enveloped your team!": "我方围被沼泽包围了！",
    ...
    "Wonder Room wore off, and Defense and Sp. Def stats returned to normal!": "奇妙空间结束了，防御与特防的能力值复原了！",
    ...
    "The Tailwind blew from behind your team!": "从你的身后吹起了顺风！",
    ...
    "Battle timer is now OFF.": "战斗计时器关闭了。",
    "Register an account to protect your ladder rating!": "注册账号以保护你的分数！",
    ...
    "Your username is no longer available.": "你选择的用户名不可用。",
    "This server is requesting an invalid login key. This probably means that either you are notconnected to a server, or the server is set upincorrectly.": "服务器登录密钥请求无效。你没有连接到服务器，或者服务器设置错误。",
    "Sleep Clause Mod activated.": "催眠条款已生效。",
    "[Unavailable choice] Can't switch: The active Pokemon is trapped": "[无效的选择]无法切换：在场的宝可梦被困住了",
    "[Invalid choice] Can't undo: A trapping/disabling effect would cause undo to leak information": "[无效的选择]无法取消：招式被禁用/束缚类技能会导致信息泄露",
    ...
    "(If a Terastallized Pokemon uses Roost, it remains Flying-type.)": "(太晶化飞行属性的宝可梦使用此招式后，宝可梦的飞行属性不会失去。）",
    "(In Gen 1, moves with 100% accuracy can still miss 1/256 of the time.)": "(在第一世代，100%命中率的招式仍然有1/256概率被闪避。）",
    "(Since gen 7, Dark is immune to Prankster moves.)": "(从第七世代起，恶作剧之心招式对恶系宝可梦无效。）",
    ...
    "Forfeiting makes you lose the battle. Are you sure?": "这样做会使你输掉这场战斗。 你确定吗？",
    "Forfeiting makes you lose the game. Are you sure?": "这样做会让你输掉游戏。 你确定吗？",
    "Battle timer is ON: inactive players will automatically lose when time's up.": "战斗计时器已开启：玩家时间用尽则判负。",
    ...
    "You must choose a username before you challenge someone.": "在挑战某人之前，你必须输入用户名。",
    "Your replay has been uploaded! It's available at:": "你的回放已上传！可从以下网址获取：",
    ...
    "During the public phase, you can discuss the state of the ladder": "在公开时期，你可以在 ",
    ...
    "(More than 4 moves is usually a sign of Illusion Zoroark/Zorua.) (Your opponent has two indistinguishable Pokemon, making it impossible for you to tell which one has which moves/ability/item.)": "(超过4个招式通常是索罗亚克/索罗亚的幻觉的征兆。) (你的对手有两个无法区分的宝可梦，你无法分辨哪一个有哪一个的招式/特性/道具。)",
    "(More than 4 moves is usually a sign of Illusion Zoroark/Zorua.)": "(超过4个招式通常是索罗亚克/索罗亚的幻觉的征兆。)",
    "(Your opponent has two indistinguishable Pokemon, making it impossible for you to tell which one has which moves/ability/item.)": "(你的对手有两个无法区分的宝可梦，你无法分辨哪一个有哪一个的招式/特性/道具。)",
    ...
    "How will you start the battle?": "你将如何战斗？",
    "What about the rest of your team?": "你队伍的其他成员？",
    ...
    "Back": "返回",
    "At who?": " 对谁使用？",
    "You are trapped and cannot switch!": "你被困住了，无法切换！",
    "(Terastallized)": "(太晶化)",
    ...
    "(and Detect, King's Shield, Spiky Shield)": "(看穿，王者盾牌，尖刺防守)所阻挡",
    "✓ Sound": "✓ 声音类招式 ",
    ...
    "✓ Powder": "✓ 粉末类招式 ",
    "(doesn't affect Grass, Overcoat, Safety Goggles)": "(不会影响防尘，防尘护目镜和草系宝可梦)",
    "✓ Bite": "✓ 啃咬类招式 ",
    ...
    "Deals damage to the target equal to the user's level.": "对目标造成与使用者等级相等的伤害。",
    ...
    "The user restores 1/2 of its maximum HP, rounded down.": "使用者回复1/2最大HP，向下取整。",
    "The user restores 1/2 of its maximum HP, rounded down. Until the end of the turn, Flying-type users lose their Flying type and pure Flying-type users become typeless. Does nothing if the user's HP is full.": "使用者回复1/2最大HP，向下取整。直到回合结束，失去飞行属性；只有飞行属性的宝可梦变为无属性。如果HP已满，使用失败。",
    ...
    "The user recovers 1/2 the HP lost by the target, rounded down.": "回复使用者的1/2最大HP，向下取整。",
    ...
    "Raises the Attack of the user and all allies 1 stage.": "提升使用者和所有同伴1级攻击。",
    ...
    "The user restores 1/2 of its maximum HP if no weather conditions are in effect, 2/3 of its maximum HP if the weather is Sunny Day, and 1/4 of its maximum HP if the weather is Hail, Rain Dance, or Sandstorm, all rounded down.": "如果没有天气，使用者回复最大生命值的1/2，如果天气是晴天，则恢复其最大HP的2/3，如果天气为冰雹、下雨或沙暴，则恢复最大HP的1/4，全部向下取整。",
    ...
    "Raises the user's Defense by 1 stage. As long as the user remains active, the power of the user's Ice Ball and Rollout will be doubled (this effect is not stackable).": "令使用者的防御提升1级。使用冰球和滚动进行攻击的威力将加倍。",
    ...
    "The target loses its held item if it is a Berry or a Gem. This move cannot cause Pokemon with the Sticky Hold Ability to lose their held item. Items lost to this move cannot be regained with Recycle or the Harvest Ability.": "如果对手持有树果或宝石，道具会被烧毁。被烧净的道具不能被回收利用或收获特性收回。",
...
var regex_sent_out_first2 = new RegExp(/^([A-z0-9é,'.()* ’:-]+?), ([A-z0-9é,'.()* ’:-]+?) will be sent out first.$/);
var regex_sent_out_first = new RegExp(/^([A-z0-9é,'.()* ’:-]+?) will be sent out first.$/);
...
var regex_disconnected = new RegExp(/^(.+?) disconnected and has ([0-9]+?) seconds to reconnect!$/);
...
var regex_toradiating_aura = new RegExp(/^The opposing (.+?) is radiating a (dark|fairy|bursting|blazing) aura!$/);
var regex_radiating_aura = new RegExp(/^(.+?) is radiating a (dark|fairy|bursting|blazing) aura!$/);
...
var regex_toCrafty_Quick_Wide_Shield = new RegExp(/^Wide Guard protected the opposing (.+?)!$/);
var regex_Crafty_Quick_Wide_Shield = new RegExp(/^Wide Guard protected (.+?)!$/);
...
var t = function (originalStr) {
    ...
    if(originalStr.match(regex_timer_on)){
        return "战斗计时器已开启：玩家时间用尽则判负。(由" + RegExp.$1 + "发起)";
    }
    if (originalStr.match(regex_reconnected)) {
        return RegExp.$1 + "重新连接了，他还剩" + RegExp.$2 + "秒。";
    }
    ...
    if ((originalStr.match(/ \/ /g) || []).length >= 1) {
    ...
    if (originalStr.match(regex_toafter_taunt)) {
        return "对手的" + trans_from_dict(RegExp.$1) + "受到了挑衅，无法使出" + translations[RegExp.$2].replace("节拍器", "挥指").replace("刷新", "焕然一新") + "！";
    }
    if (originalStr.match(regex_after_taunt)) {
        return trans_from_dict(RegExp.$1) + "受到了挑衅，无法使出" + translations[RegExp.$2].replace("节拍器", "挥指").replace("刷新", "焕然一新") + "！";
    }
    if (originalStr.match(regex_tocannot_use2)) {
        return "对手的" + trans_from_dict(RegExp.$1) + "无法使出" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "！";
    }
    if (originalStr.match(regex_cannot_use2)) {
        return trans_from_dict(RegExp.$1) + "无法使出" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "！";
    }
    ...
    if (originalStr.match(regex_tomagic_bounce)) {
        return  "对手的" + trans_from_dict(RegExp.$1) + "把" + translations[RegExp.$2] + "反射了回去！";
    }
    if (originalStr.match(regex_magic_bounce)) {
        return  trans_from_dict(RegExp.$1) + "把" + translations[RegExp.$2] + "反射了回去！";
    }
    ...
    if (originalStr.match(regex_acho)) {
     ...
     if (originalStr.match(regex_uteamsvf)) {
        return  "你的队伍在" + RegExp.$1 + "分级中合法。";
    }
     if (originalStr.match(regex_Metronome)) {
        return "挥动手指后，使出了" + translations[RegExp.$1].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "！";
    }
    ...
    if (originalStr.match(regex_thwctf)) {
     ...
     if (originalStr.match(regex_tobroke)) {
        return  "突破了对手的" + trans_from_dict(RegExp.$1) + "的保护！";
    }
     if (originalStr.match(regex_broke)) {
        return  "突破了" + trans_from_dict(RegExp.$1) + "的保护！";
    }
    ...
    if (originalStr.match(regex_disconnected)) {
        return  RegExp.$1 + "断开了连接，他还有" + RegExp.$2 + "秒的时间重新连接！";
    }
    if (originalStr.match(regex_disconnected2)) {
        return  RegExp.$1 + "断开了连接，他还有一分钟的时间重新连接！";
    }
    if (originalStr.match(regex_usemove3)) {
        return  translations[RegExp.$1] + "将对你的" + translations[RegExp.$3] + "使用" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "。";
    }
    if (originalStr.match(regex_usemove2)) {
        return  translations[RegExp.$1] + "将对" + translations[RegExp.$3] + "使用" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "。";
    }
    if (originalStr.match(regex_usemove)) {
        return  translations[RegExp.$1] + "将使用" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "。";
    }
    if (originalStr.match(regex_reconnecte)) {
        return  RegExp.$1 + "还有" + RegExp.$2 + "秒的时间重新连接！";
    }
    if (originalStr.match(regex_todisable)) {
        return   "对手的" + trans_from_dict(RegExp.$1) + "因定身法而无法使出" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "！";
    }
    if (originalStr.match(regex_disable)) {
        return   trans_from_dict(RegExp.$1) + "因定身法而无法使出" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "！";
    }
    if (originalStr.match(regex_todisable2)) {
        return   "封住了对手的" + trans_from_dict(RegExp.$1) + "的" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "！";
    }
    if (originalStr.match(regex_disable2)) {
        return   "封住了" + trans_from_dict(RegExp.$1) + "的" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "！";
    }
    if (originalStr.match(regex_nextdamage)) {
        return  " 下次伤害：" + RegExp.$1;
    }
    if (originalStr.match(regex_item_was_held_up)) {
        return    translations[RegExp.$1] + " (" + trans_from_dict(RegExp.$2 == "stolen" ? "窃取" : RegExp.$2 == "tricked"  ? "戏法" : RegExp.$2 == "disturbed"  ? "灵骚" : RegExp.$2 == "frisked"  ? "察觉" : RegExp.$2 == "found" ? "回收": "收获") + "; 红牌举起了)";
    }
    ...
    if (originalStr.match(regex_item_held_up)) {
        return   translations[RegExp.$1] + " (红牌举起过了)";
    }
    ...
    if (originalStr.match(regex_use3)) {
        return   translations[RegExp.$1] + "将" + trans_from_dict(RegExp.$2 == "Terastalliz" ? "太晶" : "超级进") + "化，然后对你的" +  translations[RegExp.$4] + "使用" + translations[RegExp.$3].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新").replace("不开启", "定身法") + "。";
    }
    ...
    if (originalStr.match(regex_toradiating_aura)) {
        return  "对手的" + trans_from_dict(RegExp.$1) + "释放着" + trans_from_dict(RegExp.$2 == "dark" ? "暗黑" : RegExp.$2 == "fairy"  ? "妖精" : RegExp.$2 == "bursting" ? "溅射" : "炽热") + "气场！";
    }
    if (originalStr.match(regex_radiating_aura)) {
        return  trans_from_dict(RegExp.$1) + "释放着" + trans_from_dict(RegExp.$2 == "dark" ? "暗黑" : RegExp.$2 == "fairy"  ? "妖精" : RegExp.$2 == "bursting" ? "溅射" : "炽热") + "气场！";
    }
    ...
    if (originalStr.match(regex_toair_light)) {
        return   "对手的" + trans_from_dict(RegExp.$1) + "被冷" + trans_from_dict(RegExp.$2 == "freezing air" ? "冻的空气" : "光") + "包围了！";
    }
    if (originalStr.match(regex_air_light)) {
        return   trans_from_dict(RegExp.$1) + "被冷" + trans_from_dict(RegExp.$2 == "freezing air" ? "冻的空气" : "光") + "包围了！";
    }
    ...
    if (originalStr.match(regex_toloses_flying)) {
        return   "(对手的" + trans_from_dict(RegExp.$1) + "在本回合失去了飞行属性。)";
    }
    if (originalStr.match(regex_loses_flying)) {
        return   "(" + trans_from_dict(RegExp.$1) + "在本回合失去了飞行属性。)";
    }
    ...
    if (originalStr.match(regex_areintheback5)) {
        return  trans_from_dict(RegExp.$1) + ", " + trans_from_dict(RegExp.$2) + ", " + trans_from_dict(RegExp.$3) + ", " + trans_from_dict(RegExp.$4) + "和" + trans_from_dict(RegExp.$5) + "在后面。";
    }
    if (originalStr.match(regex_areintheback3)) {
        return  trans_from_dict(RegExp.$1) + ", " + trans_from_dict(RegExp.$2) + "和" + trans_from_dict(RegExp.$3) + "在后面。";
    }
    if (originalStr.match(regex_areintheback2)) {
        return  trans_from_dict(RegExp.$1) + "和" + trans_from_dict(RegExp.$2) + "在后面。";
    }
    ...
    if (originalStr.match(regex_toCrafty_Quick_Wide_Shield)) {
        return  "对手的" + trans_from_dict(RegExp.$1) + "受到了广域防守的保护！";
    }
    if (originalStr.match(regex_Crafty_Quick_Wide_Shield)) {
        return  trans_from_dict(RegExp.$1) + "受到了广域防守的保护！";
    }
    ...
    if (originalStr.match(regex_toeerie_spell)) {
        return   "削减了对手的" + trans_from_dict(RegExp.$1) + "的" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "的PP" + RegExp.$3 + "点！";
    }
    if (originalStr.match(regex_eerie_spell)) {
        return   "削减了" + trans_from_dict(RegExp.$1) + "的" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "的PP" + RegExp.$3 + "点！";
    }
    if (originalStr.match(regex_Unavailable_choice_cant_move)) {
        return  "[无效的选择] 无法使出:" + trans_from_dict(RegExp.$1) + "的" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念") + "被禁用";
    }
     if (originalStr.match(regex_toleppaberry)) {
        return  "对手的" + trans_from_dict(RegExp.$1) + "用苹野果恢复了" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "的PP！";
    }
     if (originalStr.match(regex_leppaberry)) {
        return  trans_from_dict(RegExp.$1) + "用苹野果恢复了" + translations[RegExp.$2].replace("节拍器", "挥指").replace("超能力", "精神强念").replace("刷新", "焕然一新") + "的PP！";
    }
    ...
    return originalStr.replace("挑战Cup", "Challenge Cup").replace("'s team:", "的队伍：").replace(" cancelled the challenge.", "取消了挑战。").replace(" rejected the challenge.", "拒绝了挑战。").replace(" lost due to inactivity.", "因超时而判负。").replace(" reconnected.", "重新连接了。").replace(" disconnected!", "断开了连接！").replace(" forfeited.", "投降了。").replace("(Tera type BP minimum)", "(太晶化后的最低招式威力)").replace(" joined;", "加入了房间; ").replace("(priority", "(优先度").replace("(approximate)", "(近似计算)").replace("of its health!)", "的生命值！)").replace("(Hit 1 time)", "(受到1次伤害)").replace("(Hit 2 times)", "(受到2次伤害)").replace("(Hit 3 times)", "(受到3次伤害)").replace("(Hit 4 times)", "(受到4次伤害)").replace("(Hit 5 times)", "(受到5次伤害)").replace("(Hit 6 times)", "(受到6次伤害)").replace("(no Terrain)", "(没有场地)").replace("(blocked by target's Dynamax)", "(对极巨化宝可梦无效)").replace("(fails if target's level is higher)", "(如果目标等级更高，使用失败)").replace("(+1% per level above target)", "(比目标每高1级，命中率+1%)");
...
function translateNode(node) {
    ...
    if (node.parentNode?.tagName == "STRONG" || node.parentNode?.getAttribute("class") == "col movenamecol" || node.parentNode?.parentNode?.getAttribute("class") == "tooltip tooltip-move" ||
