...
// @version      0.44
// @description  do work ttc
// @author       MrFaq
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/394552/Tetris%20Ultimate%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/394552/Tetris%20Ultimate%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/PzVpYre.png",64);
        loadGhostSkin("https://i.imgur.com/1QYz0a2.png",64);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/9lhA4M6.png')";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://julf0.github.io/jstris-sfx/TU_harddrop.wav",abs:1};
    this.ready={url:"https://julf0.github.io/jstris-sfx/TU_ready.wav",abs:1,set:1};
    this.go={url:"https://julf0.github.io/jstris-sfx/TU_go.wav",abs:1,set:0};
    this.died={url:"https://julf0.github.io/jstris-sfx/TU_topout.wav",abs:1,set:1}; //TU actually doesn't have a topout sfx, this one was manually added from the gamefiles
    this.hold={url:"https://julf0.github.io/jstris-sfx/TU_hold.wav",abs:1,set:0};
    this.move={url:"blank.wav",abs:1,set:0}; //no sound exists for TU
    this.comboTones={url:"blank.wav",abs:1,set:2,duration:2500,spacing:500,cnt:8};
    this.linefall={url:"blank.wav",abs:1,set:0}; //no sound exists for TU
...
Game['eventSounds']  = [
"https://julf0.github.io/jstris-sfx/TU_tspin.wav",
"https://julf0.github.io/jstris-sfx/TU_tspin.wav",
"https://julf0.github.io/jstris-sfx/TU_single.wav",
"https://julf0.github.io/jstris-sfx/TU_tspin.wav",
"https://julf0.github.io/jstris-sfx/TU_double.wav",
"https://julf0.github.io/jstris-sfx/TU_triple.wav",
"https://julf0.github.io/jstris-sfx/TU_tspin.wav",
"https://julf0.github.io/jstris-sfx/TU_tetris.wav",
"blank.wav", //no sound exists for TU
"https://julf0.github.io/jstris-sfx/TU_tspin.wav", 
"https://julf0.github.io/jstris-sfx/TU_tetris.wav", 
];
...
Game['rotationSounds']  = [
"https://julf0.github.io/jstris-sfx/TU_rotate.wav", //rotate left
"https://julf0.github.io/jstris-sfx/TU_rotate.wav", //rotate right
"https://julf0.github.io/jstris-sfx/TU_rotate.wav", //rotate 180°
];
...
var songsMP = [
"https://julf0.github.io/jstris-sfx/TU_bgm_extended.mp3",
]

var songSP = "https://julf0.github.io/jstris-sfx/TU_bgm_extended.mp3"
