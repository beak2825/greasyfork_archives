...
// @downloadURL https://update.greasyfork.org/scripts/382109/%E7%BD%91%E9%A1%B5%E7%89%88%E5%BE%AE%E4%BF%A1%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/382109/%E7%BD%91%E9%A1%B5%E7%89%88%E5%BE%AE%E4%BF%A1%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
/* jshint ignore:start */
...
(function() {
  ...
  webwxsync_url = 'https://wx2.qq.com/cgi-bin/mmwebwx-bin/webwxsync?';

  webwxinit_url = 'https://wx2.qq.com/cgi-bin/mmwebwx-bin/webwxinit?';

  webwxgetcontact_url = 'https://wx2.qq.com/cgi-bin/mmwebwx-bin/webwxgetcontact?';
        ...
        if (modified_response.AddMsgList.length > 0) {
          ...
          for (k = 0, len1 = ref1.length; k < len1; k++) {
            ...
            if (wx_msg.MsgType === 10002) {
              ...
              results1.push(console.log("有人发出了红包"));
            } else if (wx_msg.MsgType === 10000) {
              results1.push(GM_notification("有人收到红包"));
            } else {
  ...
  GM_addStyle('.main_inner{max-width:80%}');

  GM_addStyle('.main{height:98%; padding-top:10px}');
