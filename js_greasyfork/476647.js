...
// @description  Mn1
// @author       Seu Nome
// @match        https://pasino.com/mines  
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/476647/mn.user.js
// @updateURL https://update.greasyfork.org/scripts/476647/mn.meta.js
// ==/UserScript==
...
(function() {
    ...
    function calculateMinesResult() {
        ...
        var mines = $("#mines").val();
        var nonce = 17; // Alterando o nonce para a posição 17
