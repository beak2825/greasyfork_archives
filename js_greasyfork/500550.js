...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/500550/KOSTROMA%20%7C%20%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1%20by%20LKiar.user.js
// @updateURL https://update.greasyfork.org/scripts/500550/KOSTROMA%20%7C%20%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1%20by%20LKiar.meta.js
// ==/UserScript==
  ...
  `Никто из состава администрации не будет просить у вас все различные пароли, пин-коды, информация о привязках и так далее. Не ведитесь на обманы!`,
...

        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br>` +
                ...
                `С уважением,ГС ГОСС - Egor_Crown .<br>` +
