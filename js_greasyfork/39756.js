...
// @downloadURL https://update.greasyfork.org/scripts/39756/QuickAssist%20%7C%20Updated%20by%20Marentdev.user.js
// @updateURL https://update.greasyfork.org/scripts/39756/QuickAssist%20%7C%20Updated%20by%20Marentdev.meta.js
// ==/UserScript==
...
$(document).ready(function(){
    ...
    var conditions = '<a href="javascript:void(0);" style="color:#3c5365;text-decoration:none;" data-action="normal" data-message="Salut,<br/>Tu n\'as pas les [COLOR=#006d80][B]conditions requises[/B][/COLOR] pour proposer une [COLOR=#006d80][B]vente[/B][/COLOR], un [COLOR=#006d80][B]échange[/B][/COLOR] ou un [COLOR=#006d80][B]service  payant[/B][/COLOR]. [FA]fa-shopping-cart[/FA]<br/><br/>Voici les conditions :<br/>[LIST]<br/>[*][B]1000 messages [FA]fa-envelope-o[/FA][/B]<br/>[*][B]500 j\'aime [FA]fa-thumbs-o-up[/FA][/B]<br/>[*][B]6 mois d’ancienneté [FA]fa-calendar-o[/FA][/B]<br/>[/LIST]"><i class="fa fa-certificate"></i> Conditions</a>';
    ...
    $('.formButtonGroup').after('<br />' + style + '<div class="barre" id="barre">' + bye + resolu + deplacement_resolu + deplacement_resolu2 + deplacement_resolu3 + doublon + titre + deplacement + conditions + warez + scan + shop + pub + spam + pres + virus + staff + ras +'</div><br />'); // UI
