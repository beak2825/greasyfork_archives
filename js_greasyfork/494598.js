...
// @downloadURL https://update.greasyfork.org/scripts/494598/For%20guidance%20by%20Kokojambo.user.js
// @updateURL https://update.greasyfork.org/scripts/494598/For%20guidance%20by%20Kokojambo.meta.js
// ==/UserScript==
...
const buttons = [
...

    {
        ...
        content:
        	...
        	'[Color=White][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
        ...
        '[Color=White][CENTER][B]С уважением Главный Администратор сервера CHOCO .[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	...
	},
    {
	  ...
	  '[Color=White][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
        ...
        "[COLOR=White][CENTER][B]С уважением Главный Администратор сервера CHOCO[/CENTER][/B][/COLOR]",
...
'[Color=white][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]'+
	...
	"[CENTER][B][COLOR=White]С уважением Главный Администратор сервера CHOCO [/B][/CENTER][/COLOR]",
      prefix: PIN_PREFIX,
	...
	},
    {
	  ...
	  content:
		...
		'[Color=White][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
            ...
            '[Color=White][CENTER][B]Закрыто.[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
        {
	...
	},
    {
        ...
        '[B][COLOR=White][CENTER] С уважением Главный Администратор сервера CHOCO [/B][/CENTER][/COLOR]',
        prifix: PIN_PREFIX,
        status: true,
    },
