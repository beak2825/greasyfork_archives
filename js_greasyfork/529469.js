// ==UserScript==
// @name   🌱【免费版】西南大学继续教育学院网|四川省教师继续教育西华师范大学培训中心|如需视频秒过等高级功能见收费版本：https://doc.zhanyc.cn/pages/xndxjxjy/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.0
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需如需自动下一集、视频秒过等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.eduwest.com/*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/529469/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E8%A5%BF%E5%8D%97%E5%A4%A7%E5%AD%A6%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E5%AD%A6%E9%99%A2%E7%BD%91%7C%E5%9B%9B%E5%B7%9D%E7%9C%81%E6%95%99%E5%B8%88%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E8%A5%BF%E5%8D%8E%E5%B8%88%E8%8C%83%E5%A4%A7%E5%AD%A6%E5%9F%B9%E8%AE%AD%E4%B8%AD%E5%BF%83%7C%E5%A6%82%E9%9C%80%E8%A7%86%E9%A2%91%E7%A7%92%E8%BF%87%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxndxjxjy.user.js
// @updateURL https://update.greasyfork.org/scripts/529469/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E8%A5%BF%E5%8D%97%E5%A4%A7%E5%AD%A6%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E5%AD%A6%E9%99%A2%E7%BD%91%7C%E5%9B%9B%E5%B7%9D%E7%9C%81%E6%95%99%E5%B8%88%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E8%A5%BF%E5%8D%8E%E5%B8%88%E8%8C%83%E5%A4%A7%E5%AD%A6%E5%9F%B9%E8%AE%AD%E4%B8%AD%E5%BF%83%7C%E5%A6%82%E9%9C%80%E8%A7%86%E9%A2%91%E7%A7%92%E8%BF%87%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxndxjxjy.meta.js
// ==/UserScript==
(function () {
    let $jq = $;
    unsafeWindow.$jq = $;
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、视频秒过等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/xndxjxjy/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/cw_file_video.shtml")) {
                plugMain.page_video();
            } else if (url.includes("/courseware/cw_study.shtml?")) {
                // await plugMain.setUserName();
                plugMain.page_videoStatus();
            } else if (url.includes("/courseware/cw_study_tree.shtml?")) {
                // await plugMain.setUserName();
                plugMain.page_videoLeft();
            }

        },
        async page_videoLeft() {
            console.log("%c page_videoLeft", "background:rgb(0,0,0);color:#fff");
            await plugMain.waitOf((a) => $(".sub-menu").length > 0);
            await plugMain.waitTimeout(1000);
            if ($(".sub-menu .study-undo,.sub-menu .study-doing").length == 0) {
                plugMain.alertMsg("课程已经全部学完了");
                return;
            }
            $(".sub-menu .study-undo,.sub-menu .study-doing").eq(0).prev().click();
            setTimeout(() => {
                top.plugMain.clickVideoList = true;
            }, 2000);
        },
        async page_videoStatus() {
            console.log("%c page_list", "background:rgb(0,0,0);color:#fff");
            await plugMain.waitOf((a) => top.plugMain.clickVideoList == true);
            let index = setInterval(() => {
                if ($("#cwLearningTimer").text() == "已完成") {
                    clearInterval(index);
                    plugMain.setGMData("topReload", plugMain.now());
                }
            }, 1000);
        },
        async page_video() {
