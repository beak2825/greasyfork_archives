...
// @grant         none
// @version       1.1.2
// @downloadURL https://update.greasyfork.org/scripts/419611/ao3%20savior%20config.user.js
// @updateURL https://update.greasyfork.org/scripts/419611/ao3%20savior%20config.meta.js
// ==/UserScript==
...
(function () {
  ...
  window.ao3SaviorConfig = {
    ...
    authorBlacklist: ['Hated Author 1', 'Bumblebee_roll', 'Yaoiwriteronly', 'NocturnalAzura', 'yourmothersmeatloaf', 'simp4sunarin', 'Sakusasfacemask', 'whatsonot22', 'iamacatboy', 'syubbiechubs22', 'Jellyrs', 'Chibi_Mochi'],

    // Excludes works with a title that exactly matches at least one term
    titleBlacklist: ['One Too Many- Haikyuu Omega verse', 'Sylvester And The Magic Pebble'],
