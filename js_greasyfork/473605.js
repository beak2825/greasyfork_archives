// ==UserScript==
// @name        freebitco.in autoplayer V1.1.0
// @author jessonfoo
...
// @grant       none
// @license MIT
// @namespace https://greasyfork.org/users/221605
// @downloadURL https://update.greasyfork.org/scripts/473605/freebitcoin%20autoplayer%20V110.user.js
// @updateURL https://update.greasyfork.org/scripts/473605/freebitcoin%20autoplayer%20V110.meta.js
// ==/UserScript==
...
(function () {
    ...
    function btc() {
        ...
        newDiv1.innerHTML = '<span id="xclosed">X</span>' +
            ...
            'Target Profit <input type="number" id="target" name="stopGain" placeholder="500" value=500 class="input field">'+
        ...
        function reset() {
            ...
            document.getElementById('double_your_btc_payout_multiplier').value = "3.25";
        ...
        eventAdd(document.getElementById('start'), 'click', function () {
            ...
            nextBet = setInterval(function () {
                ...
                setTimeout(function () {
                    ...
                    ) ||  Number(document.getElementById('net_balance').innerText)*100000000 > Number(document.getElementById('target').value)) {
                    document.getElementById('stop').click();

                    if(document.getElementById('repeat-target').checked && (Number(document.getElementById('time_remaining').innerText.split(/\D/g)[0]) > 7)) {
                        setTimeout(function(){ return document.getElementById('start').click();},1500);
                    }
                    return reset();
                }else{
                    return betRandom();
