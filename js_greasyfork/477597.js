// ==UserScript==
// @name                超星学习小助手|支持作业、考试、视频、章节测验全自动处理|高覆盖率题库|已支持自主收录|一键复制题目
// @namespace           aliangsq
// @version             5.4
// @description         【🥇操作简单】超星学习小助手【🔊功能齐全】支持视频、音频倍速秒过；文档、图书自动完成；字体解密；章节测验、课后作业、考试自动答题、自动提交、自动收录答案；支持自动切换任务点、自动登录等。【📔独家题库】独家丰富试题库，每日更新，精准识别。
// @author              aliangsq
// @match               *://*.chaoxing.com/*
// @match               *://*.edu.cn/*
// @match               *://*.nbdlib.cn/*
// @match               *://*.hnsyu.net/*
// @connect             chati.aliangsq.cn
// @run-at              document-end
// @grant               unsafeWindow
...
// @antifeature ads
// @downloadURL https://update.greasyfork.org/scripts/477597/%E8%B6%85%E6%98%9F%E5%AD%A6%E4%B9%A0%E5%B0%8F%E5%8A%A9%E6%89%8B%7C%E6%94%AF%E6%8C%81%E4%BD%9C%E4%B8%9A%E3%80%81%E8%80%83%E8%AF%95%E3%80%81%E8%A7%86%E9%A2%91%E3%80%81%E7%AB%A0%E8%8A%82%E6%B5%8B%E9%AA%8C%E5%85%A8%E8%87%AA%E5%8A%A8%E5%A4%84%E7%90%86%7C%E9%AB%98%E8%A6%86%E7%9B%96%E7%8E%87%E9%A2%98%E5%BA%93%7C%E5%B7%B2%E6%94%AF%E6%8C%81%E8%87%AA%E4%B8%BB%E6%94%B6%E5%BD%95%7C%E4%B8%80%E9%94%AE%E5%A4%8D%E5%88%B6%E9%A2%98%E7%9B%AE.user.js
// @updateURL https://update.greasyfork.org/scripts/477597/%E8%B6%85%E6%98%9F%E5%AD%A6%E4%B9%A0%E5%B0%8F%E5%8A%A9%E6%89%8B%7C%E6%94%AF%E6%8C%81%E4%BD%9C%E4%B8%9A%E3%80%81%E8%80%83%E8%AF%95%E3%80%81%E8%A7%86%E9%A2%91%E3%80%81%E7%AB%A0%E8%8A%82%E6%B5%8B%E9%AA%8C%E5%85%A8%E8%87%AA%E5%8A%A8%E5%A4%84%E7%90%86%7C%E9%AB%98%E8%A6%86%E7%9B%96%E7%8E%87%E9%A2%98%E5%BA%93%7C%E5%B7%B2%E6%94%AF%E6%8C%81%E8%87%AA%E4%B8%BB%E6%94%B6%E5%BD%95%7C%E4%B8%80%E9%94%AE%E5%A4%8D%E5%88%B6%E9%A2%98%E7%9B%AE.meta.js
// ==/UserScript==

/*********************************自定义配置区******************************************************** */
var setting = {
    showBox: 1,     // 显示脚本浮窗，0为关闭，1为开启，不建议关闭
    tiku: 0,        // 题库服务器切换，0为主线路，1为备用线路
    ...
    examTurnTime: 1, // 考试自动跳转下一题随机间隔时间(3-7s)之间，0为关闭，1为开启
...
var _w = unsafeWindow,
    ...
    _host = ["https://chati.aliangsq.cn","http://chati.aliangsq.cn","http://chati.aliangsq.cn:1212","https://chati.aliangsq.cn:1212"][setting.tiku];
...
if (_l.hostname == 'i.mooc.chaoxing.com' || _l.hostname == "i.chaoxing.com") {
    ...
    if (params == null || params == '$mArg' || $.parseJSON(params)['attachments'].length <= 0) {
        ...
        setTimeout(() => {
            ...
            logger('共计'+_mlist.length+'个任务', 'pink')
            missonStart()
        }, 3000)
    }
...
function showTips() {
    var _msg = "题库官网：https://chati.alingsq.cn <br> <span style='color: red;'>题库为第三方题库，与本脚本无任何关系，有能力者可自行更换。</span> <br> 脚本失效问题请直接GreasyFork私信或油猴中文网私信。<br> 脚本基于Ne-21修改，致敬大佬！";
...
function showBox() {
    if (setting.showBox && top.document.querySelector('#ne-21notice') == undefined) {
        var box_html = `<div id="ne-21box" style="border: 2px dashed rgb(0, 85, 68); width: 330px; position: fixed; top: 5%; right: 20%; z-index: 99999; background-color: rgba(184, 247, 255, 0.5); overflow-x: auto;">
        ...
        <div id="ne-21notice" style="border-top: 1px solid #000;border-bottom: 1px solid #000;margin: 4px 0px;overflow: hidden;"><p style="font-family: cursive;font-weight: bold;text-align: center;"><a href="https://chati.alingsq.cn" target="_blank" style="color: #9118d9;">如何自动收录答案到题库？点击查看</a></p></div>
        <div style-"display: flex;"><div style="display: flex;padding: 2px 5px;">Token：<input type="password" id="lemtktoken" placeholder="请输入Token" style="width: 70%;" /><button style="width: 25%;" id="lemtkcopy">复制</button></div><div style="display: flex;justify-content: center;"><button id="lemtkpro">开启/关闭高级搜索</button>|<button id="lemtkbtn">保存Token</button>|<button id="lemtksq">获取/重置Token</button></div></div>
        ...
        $("#lemtksq").click(function(){
            window.open("https://chati.aliangsq.cn","_blank")
        })
...
function doHomeWork(index, TiMuList) {
    ...
    switch (_type) {
        ...
        case 2:
            ...
            getAnswer(_type, _question).then((agrs) => {
                let _answerTmpArr = agrs.split('-----分隔符-----')
        ...
        switch (_type) {
            ...
            case 2:
                ...
                if (_rightAns.length <= 0) {
                    ...
                    _answer = _answerTmpArr.join('-----分隔符-----')
                } else {
    ...
    for (let i = 0; i < TiMuList.length; i++) {
        ...
        switch (_TimuType) {
            ...
            case 1:
                ...
                _a['answer'] = tidyStr(_answer.join('-----分隔符-----'))
                break
            case 2:
                ...
                _a['answer'] = tidyStr(_TAnswer.join('-----分隔符-----'))
                break
            case 3:
                if (_selfAnswerCheck == "marking_dui") {
...
function getAnswer(_t, _q) {
    if (GM_getValue("lemtkpro")) {
        logger("🎈请注意：您正在使用高级搜索功能(beta)。","#CC33FF")
        tkurl = _host + '/api/v1/mcx'
    } else {
        tkurl = _host + '/cx/api.php'
    }
    return new Promise((resolve, reject) => {
...
function startDoWork(index, doms, c, TiMuList) {
    ...
    switch (_TimuType) {
        ...
        case 2:
            ...
            getAnswer(_TimuType, _question).then((agrs) => {
                let _answerList = agrs.split("-----分隔符-----")
                $.each(_textareaList, (i, t) => {
                    setTimeout(() => {
