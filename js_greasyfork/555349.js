// ==UserScript==
// @name         Fehlende Fahrzeuge kaufen / SAVE
// @namespace    xxx
// @version      1.0.7
...
// @downloadURL https://update.greasyfork.org/scripts/555349/Fehlende%20Fahrzeuge%20kaufen%20%20SAVE.user.js
// @updateURL https://update.greasyfork.org/scripts/555349/Fehlende%20Fahrzeuge%20kaufen%20%20SAVE.meta.js
// ==/UserScript==
...
(async () => {
  ...
  const EXTENSION_VEHICLE_OVERRIDE = {
    ...
    //12: { 5: [130, 130, 130, 131, 131, 131, 131]},
    //12: {6: [171, 173, 174, 171, 173, 174,]},
    //9: {3: [65, 68, 69]},
    //9: {7: [92, 92, 93, 93]},
  }
  ...
  //  0: [30, 30, 30, 30, 30, 34, 34, 34, 34, 34], // FW
  //  0: [30, 30, 30, 30, 30, 30, 30, 30, 34, 34, 34, 34, 34, 34, 34, 34], // FW
  //  0: [2, 2, 53, 3, 34, 57, 121, 5, 27, 33, 114, 12, 10, 167, 16, 30, 30, 30, 30, 30], // FW
  //  2: [28, 28, 28, 28, 28, 28, 28, 28, 29, 29, 29, 29, 74, 55, 56], // RD
  //  5: [31, 31, 31, 31, 31, 157, 157, 157, 157, 157], // RTH
  // 6: [32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32], // POL
  // 0: [30, 30, 30], // FW
  }
