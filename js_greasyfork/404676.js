...
// @downloadURL https://update.greasyfork.org/scripts/404676/%E6%99%BA%E6%85%A7%E8%81%8C%E6%95%99MOOC%E5%AD%A6%E9%99%A2%20--%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B%20%28%E8%93%9D%E7%89%88%29.user.js
// @updateURL https://update.greasyfork.org/scripts/404676/%E6%99%BA%E6%85%A7%E8%81%8C%E6%95%99MOOC%E5%AD%A6%E9%99%A2%20--%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B%20%28%E8%93%9D%E7%89%88%29.meta.js
// ==/UserScript==
(function () {
    'use strict';
    const setting = {
        ...
        if (current.next().length == 0) {
            ...
            if (parent.next().length == 0) {
                ...
                if (ancestor.next().length == 0) {
                    ...
                    check(ancestor.next().find(".np--level-3").first());
                }
            } else {
                check(parent.next().find(".np--level-3").first())
            }
            return;
        }
        //查询下一个是否已完成
        if (current.next().find("span.np--type.active").length > 0) {
            check(current.next());
            return;
        }
        //查询下一项所属类别
