...
// @downloadURL https://update.greasyfork.org/scripts/553518/%D0%92%20%D0%9D%D0%95%D0%9E%D0%94%D0%9E%D0%91%D0%A0%D0%95%D0%9D%D0%9D%D0%AB%D0%95.user.js
// @updateURL https://update.greasyfork.org/scripts/553518/%D0%92%20%D0%9D%D0%95%D0%9E%D0%94%D0%9E%D0%91%D0%A0%D0%95%D0%9D%D0%9D%D0%AB%D0%95.meta.js
// ==/UserScript==

// ==UserScript==
// @name 🚀 АВТО-ПЕРЕМЕЩЕНИЕ: РП БИОГРАФИИ (Неодобренные)
// @namespace https://forum.blackrussia.online/
// @version 1.1
// @description Добавляет отдельную кнопку с красным фоном и текстом "В неодобренные".
...
(function() {
    ...
    const NODE_TARGET = 792; // Неодобренные биографии
    const PREFIX_ID = 4; // Префикс 'Отказано' (для прохождения проверки)
    const MOVE_BUTTON_ID = 'move_to_rejected_standalone';
    ...
    // === ФУНКЦИЯ ДОБАВЛЕНИЯ КНОПКИ (ИЗМЕНЕН ДИЗАЙН) ===
    ...
    $(document).ready(() => {
        ...
        addButton('В неодобренные', MOVE_BUTTON_ID);
