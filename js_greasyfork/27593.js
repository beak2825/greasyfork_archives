...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/27593/RED%20Populate%20Label%20Collage.user.js
// @updateURL https://update.greasyfork.org/scripts/27593/RED%20Populate%20Label%20Collage.meta.js
// ==/UserScript==
...
function startSearch() {
  ...
  function addSelectedToCollage() {
    var urls = [];
    var base = 'https://redacted.ch/torrents.php?id=';
    var elems = dom.qsa('.group input', table);
    for (var i = elems.length; i--; ) {
