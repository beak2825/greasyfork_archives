...
// @namespace    wwbnq
// @version      2.5.2
// @description  shushubuyue月
// @author       爱坤七号
// @match        *://*.shushubuyue.net/*
// @match        *://*.shushubuyue.com/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=shushubuyue.net
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/502425/shushubuyue.user.js
// @updateURL https://update.greasyfork.org/scripts/502425/shushubuyue.meta.js
// ==/UserScript==
...
(function () {
    ...
    function stay() {
        ...
        // 输入
        msgInput.value = "宝宝 月嘛"
        msgInput.dispatchEvent(new Event('input'))
        msgInput.dispatchEvent(new Event('change'))

        // 发送
        if (msgInput.value == "宝宝 月嘛" && sendButton) {
            sendButton.click();
