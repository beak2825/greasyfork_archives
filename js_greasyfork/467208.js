...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/467208/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B5%D0%B1%D1%8F%20%7C%7C%20Purple.user.js
// @updateURL https://update.greasyfork.org/scripts/467208/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B5%D0%B1%D1%8F%20%7C%7C%20Purple.meta.js
// ==/UserScript==
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOT=RED] 2. Ваша должность: [COLOR=BLACK]ГР/КФ[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 3. Ссылка на /astats: [COLOR=BLACK] *Ссылка* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 4. Доп работа(Мп. Посты и т.п):<br>"+
		"[B][CENTER][COLOT=RED] КФ: *Ссылка*<br>"+
		"[B][CENTER][COLOT=RED] МП: *Ссылка*<br>"+
		"[B][CENTER][COLOT=RED] Пост: *Ссылка*<br>"+
		"[B][CENTER][COLOT=RED] 5. Количество заработанных баллов за день: [COLOR=BLACK] *Число* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 6. Дата отчёта: [COLOR=BLACK] *Число* [/COLOR]<br><br>"+
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOT=RED] 1. Ник: [COLOR=BLACK]Raf_Khumaryan[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 2. Ваша должность: [COLOR=BLACK]ГР/КФ[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 3. Дата получения выговора/предупреждения: [COLOR=BLACK] *Число* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 4. Что снять (выговор/пред/устник):<br>"+
		"[B][CENTER][COLOT=RED] 5.Статистика: [COLOR=BLACK] За баллы [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, отчет Raf_Khumaryan [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOT=RED] 1. Ник: [COLOR=BLACK]Raf_Khumaryan[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 2. Уровень администрирования: [COLOR=BLACK]4[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 3. Занимая должность: [COLOR=BLACK] ГР/КФ [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 4. Есть ли в ближайшее время обзвоны/важные мероприятия: (Если есть, укажите лицо подменяющее вас): [COLOR=BLACK]Нет[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 5. Срок неактива: (с - по -, Максимум неделя): [COLOR=BLACK] *Число* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 6. Причина неактива: [COLOR=BLACK] По семейным обстоятельствам [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOT=RED] 2. Уровень администрирования: [COLOR=BLACK]4[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 3. Занимая должность: [COLOR=BLACK] ГР/КФ [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 4. Дата собрания, на который нужен отгул: [COLOR=BLACK]Нет[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 5. Причина неактива: [COLOR=BLACK] По семейным обстоятельствам [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
