...
(function() {
    ...
    var websiteMap = [
       ...
       {website : ["coinadster.com"],
        ...
        {website : ["claimlite.club"],
         defaultButtonSelectors: [".card-body.py-3.px-1 .btn.btn-danger.btn-md.w-50.mt-2"],
         toggleCaptchaSelector:[".form-control.form-control-sm.custom-select.mb-1"],
         toggleCaptchaSelectorIndex: 0,
         captchaButtonSubmitSelector: "#claimFaucet .btn.btn-danger.btn-md.w-50.mt-2",
         allMessageSelectors: [".alert.alert-success",".alert.alert-danger"],
         messagesToCheckBeforeMovingToNextUrl: ["can claim again", "You can claim again in", "you won"],
         timeoutbeforeMovingToNextUrl: 140000},
