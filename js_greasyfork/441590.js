// ==UserScript==
// @name         FOR CHIEF ADMINS | BLACK RUSSIA
...
// @downloadURL https://update.greasyfork.org/scripts/441590/FOR%20CHIEF%20ADMINS%20%7C%20BLACK%20RUSSIA.user.js
// @updateURL https://update.greasyfork.org/scripts/441590/FOR%20CHIEF%20ADMINS%20%7C%20BLACK%20RUSSIA.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    {
      title: '_______________________________________ДЛЯ ОБЖАЛОВАНИЯ________________________________________________',
    },
     {
      title: 'Отказ в обж',
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' + '[CENTER]' +
        "[CENTER]В обжаловании[COLOR=#ff0000] отказано[/COLOR][/CENTER]" +
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER]Перебаню ваш аккаунт на 7 дней.[/CENTER]" +
		'[Color=#00ff00][CENTER]Одобрено, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      title: 'Пере-бан на 15',
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]Перебаню ваш аккаунт на 15 дней.[/CENTER]" +
		'[Color=#00ff00][CENTER]Одобрено, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      title: 'Пере-бан на 30',
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]Перебаню ваш аккаунт на 30 дней.[/CENTER]" +
		'[Color=#00ff00][CENTER]Одобрено, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]Ответ был дан в прошлом обжаловании. Просьба не создавать похожие темы.[/CENTER]" +
		'[Color=#ff0000][CENTER]Отказано, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]Если вы не согласны с наказанием то обратитесь в раздел [Color=#ff4500](Жалобы на администрацию)[/COLOR][/CENTER]<br>" +
		'[Color=#ff0000][CENTER]Закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
      title: 'Нет доказательства ОБЖ',
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]В обжаловании отказано.<br>[Color=#ff0000]Причина[/COLOR]: нет доказательств, пожалуйста подайте снова но уже с доказательствами.[/CENTER]<br>" +
		'[Color=#ff0000][CENTER]Отказано, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]Ваше обжалование не по форме, прочитайте внимательно правила подачи обжалований, и подайте снова.[/CENTER]<br>" +
		'[Color=#ff0000][CENTER]Отказано, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]Ваш аккаунт будет [Color=#00ff00] разблокирован[/COLOR], впредь больше не нарушайте.<br>Приятной игры на сервере BLACK RUSSIA | YELLOW.[/CENTER]<br>" +
		'[Color=#00FF00][CENTER]Одобрено, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]В обжаловании [Color=#ff0000] отказано[/COLOR].<br>4.1. различные формы (Слива); (не обжалуются)[/CENTER]<br>" +
		'[Color=#ff0000][CENTER]Отказано, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]В обжаловании [Color=#ff0000]отказано[/COLOR].<br>4.9. обман администрации. (не обжалуется)[/CENTER]<br>" +
		'[Color=#FF0000][CENTER]Отказано, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      title: 'Нет ВК для нонРП обмена',
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]Для обжалования NonRP обмана нужно прикрепить ссылку на страницы Вконтакте двух сторон.[/CENTER]" +
		'[Color=#ff0000][CENTER]Отказано, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]В обжаловании [Color=#ff0000] отказано[/COLOR].<br>3.3. Прикрепление доказательств обязательно. [Color=#ff0000]Примечание:[/COLOR] загрузка доказательств в соц. сети (ВКонтакте, instagram) запрещается.[/CENTER]<br>" +
		'[Color=#ff0000][CENTER]Отказано, закрыто.[/SIZE][/CENTER][/color][/FONT]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
	...
	},
    {
      ...
      content:
		'[Color=#ffffff][FONT=trebuchet ms][CENTER][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' +
        "[CENTER]В обжаловании [COLOR=#ff0000]отказано[/COLOR],<br>4.7. использование стороннего программного обеспечения; [Color=#ffff00](обжалованию не подлежит)[/COLOR][/CENTER]<br>" +
		'[Color=#ff0000][CENTER]Отказано. Закрыто[/SIZE][/CENTER][/color][/FONT]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
