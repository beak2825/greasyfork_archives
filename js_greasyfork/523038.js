// ==UserScript==
// @name         Novosibirsk | Скрипт для Руководства сервера
...
// @grant        none
// @license 	 MIT
// @downloadURL https://update.greasyfork.org/scripts/523038/Novosibirsk%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/523038/Novosibirsk%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0.meta.js
// ==/UserScript==
...
{
            title: 'На рассмотрение (опру) (для девушек текст)',
            content:
            "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Запросила доказательства у администратора.<br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=orange]На рассмотрении.[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
	...
	},
{
    ...
    '[CENTER]Приятной игры и времяпровождения на сервере [COLOR=green]Novosibirsk[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: CLOSE_PREFIX,
    status: false,
    },
{
    ...
    content:
    '[SIZE=4][FONT=Courier New][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]В доказательствах нету  /myreports. Предоставьте в новой теме /myreports.[/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождения на сервере [COLOR=green]Novosibirsk[/COLOR].[/CENTER][/B][/SIZE]',
    ...
    },
{
	  ...
	  content:
		...
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>[Color=#7FFFD4]Приятной игры на просторах сервера Novosibirsk. [/CENTER] " +
        ...
        },
{
	  ...
	  content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба была одобрена и по отношению к администратору будут приняты необходимые меры.<br>"+
        ...
        },
{
            ...
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            " Жалоба передана Основному Заместителю Главного Администратора - @Jack_Winstoned .<br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        },
{
            ...
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            " Жалоба передана Заместителю Главного Администратора по направлению ОПГ и ГОСС - @Nekit_Regis .<br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
    ...
    status: true,
	  ...
	  content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Вам было выдано наказания Техническим специалистом, вы можете написать жалобу здесь : [URL='https://forum.blackrussia.online/index.php?forums/Сервер-№34-novosibirsk.1543/']*Нажмите сюда*[/URL]<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>[Color=#7FFFD4]Приятной игры на просторах сервера Novosibirsk. [/CENTER] " +
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
        ...
        },
{
      ...
      content:
        "[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        	"[B][CENTER][COLOR=lavender] Тема будет находится в закреплении, у вас есть 24 часа на возвращение имущества, и предъявления видеофиксации.<br>[/CENTER]<br>" +
		'[Color=Orange][CENTER]На рассмотрении...[/I][/CENTER][/color]',
	  prefix: PIN_PREFIX,
	  status: true,
    },
        {
 ...
 title: '| Договор |',
	  content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Игрок которого вы обманули -  Обговорите с ним,а потом уже мы сможем вас обжаловать.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>[Color=#7FFFD4]Приятной игры на просторах сервера Novosibirsk. [/CENTER] " +
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
{
 title: '|В жб на адм |',
	  content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Раздел Обжалование - это амнистия совершённого деяния с вашей стороны,если вы не согласны и не признаёте свою вину,то вы ошиблись разделом.<br>"+
        "[B][CENTER][COLOR=lavender] Для жалоб есть раздел под названием 'Жалобы на администрацию' <br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>[Color=#7FFFD4]Приятной игры на просторах сервера Novosibirsk. [/CENTER] " +
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
