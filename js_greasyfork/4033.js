...
// @version     1.3.0
// @downloadURL https://update.greasyfork.org/scripts/4033/Polygon%20Script%20v2.user.js
// @updateURL https://update.greasyfork.org/scripts/4033/Polygon%20Script%20v2.meta.js
// ==/UserScript==
...
function elFactual( i ) {
    ...
    if ( tasksCheck == -1 ) {
        ...
        if ( jQueryLatest( "#pac-input" ).is( ":focus" ) ) {
            ...
            if ( i.keyCode == 67 && i.ctrlKey === false ) { //C: Switch to Sat 2
...
function checkForUpdateMessage() {
    if ( localStorage.getItem( 'Polygons-v130' ) === null ) {
        alert( 'The Polygon script has been updated to version 1.3.0\n\n Added CiCis, Cracker Barrel, El Pollo Loco, Panda Express, and Sunoco \n\n' +
            'All search automatically. \n\n' +
             'This message should only display once. Contact Zachary if it continues to show.');
        localStorage.setItem( 'Polygons-v130', true );
    }
}