...
// @downloadURL https://update.greasyfork.org/scripts/30886/Xthor%20shoutbox%20BETA.user.js
// @updateURL https://update.greasyfork.org/scripts/30886/Xthor%20shoutbox%20BETA.meta.js
// ==/UserScript==
...
#control_label_casino {
    ...
    width:29px;
    height:31px;
    background:url("https://img.xthor.to/2019/04/54feef_DH0lGFshout_casino_ico.png") no-repeat center center #1f1f1f;
    border-radius:0 5px 5px 0;
    -moz-border-radius:0 5px 5px 0;
    -webkit-border-radius:0 5px 5px 0;
    ...
    delete xhr.responseText;
        ...
        doc.find("tr").each(function() {
            ...
            if (HideConf.system_casino || HideConf.system_gang || HideConf.system_bookmaker || HideConf.system_tombola || HideConf.system_chifoumi ||
                ...
                HideConf.system_potcommun || HideConf.system_jeton)
            {
                        ...
                        if (ValueAttributeClass.indexOf("fa-globe")!=-1)
                        {
                            ...
                            if (remove_after==false && HideConf.system_forum)
                            {
                                ...
                                if (ListBaliseI.length>0)
                                {
                                    for (var i = 0; i < ListBaliseI.length; i++)
                                    {
                                        if (ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa-comments")!== -1 || ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa-comment")!== -1 )
                                            remove_after=true;
                                    }
                                }
                            }
                            ...
                            if (remove_after==false && HideConf.system_market)
                            {
                                ...
                                if (ListBaliseA.length>0)
                                {
                                    for (var i = 0; i < ListBaliseA.length; i++)
                                    {
                                        //./pic/smilies/trump-icon.png https://xthor.to/shop.php?&market
                                ...
                                if (ListBaliseImg.length>0)
                                {
                                    ...
                                    {
                                        if (ListBaliseImg[i].getAttribute("src").indexOf("kerviel.png")!== -1 || ( ListBaliseImg[i].getAttribute("src").indexOf("telephone.gif")!== -1 && srrdb==false) )
                                            remove_after=true;
                                    }
                                }
                            }
                            ...
                            if (remove_after==false && HideConf.system_gang)
                            {
                                ListBaliseA =  $(this).find('a');
                                ListBaliseImg =  $(this).find('img');
                                if (ListBaliseA.length>0 && ListBaliseImg.length>0)
                                {

                                    for (var j = 0; j < ListBaliseImg.length; j++)
                                    {
                                        //<img border='0' src="./pic/smilies/1832ae_alcapone.gif" alt="" />
                                        if (ListBaliseImg[j].getAttribute("src").indexOf("alcapone.gif")!== -1)
                                        {
                                            for (var i = 0; i < ListBaliseA.length; i++)
                                            {
