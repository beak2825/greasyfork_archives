...
let css = `
  ...
  .cf-section.cf-highlight.cf-status-display {background: #1E4D2B!important;}
  ...
  .summary, .menu2, .iogc-tourny-odd {background-color: #194024!important;} 
  ...
  .iogc-PlayerFavoritePanel {border-color: #1C4628!important;}
  ...
  .statLine TD, #profile h3 .line {border-color: #14321C!important;}
  ...
  DIV[style="border-bottom:2px dotted #ddd;margin:10px 0;"] {border-bottom-color: #14321C!important;}
  ...
  DIV[style="border-top:3px solid #CCC"], #forum .header, .iogc-SidePanel-inner, .list-item {border-top-color: #14321C!important;}
