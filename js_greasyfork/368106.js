// ==UserScript==
// @name         百度网盘高速下载助手
// @version      2018.03.23_0.9.24.Mod
// @description # 网盘内和分享链接页面均显示[高速下载]按钮，支持百度企业网盘；
// @description # [高速下载]按钮：支持获取高速直接下载链接 / 普通直接下载链接；
// @description # 文件夹/大文件/单文件/多文件 可以直接普通下载，免调用度盘客户端；
// @description # 支持获取单个文件的直接高速下载链接 (任何的文件非会员不限速下载);
// @description # 单个文件的直接高速下载链接支持IDM/迅雷挂机稳定不限速进行下载；
// @description # 获取的高速下载链接支持IDM/迅雷稳定全速下载(建议退出账户后获取)
// @author       ivesjay、zd423、网友们
// @license       MIT
// @date           2016-10-01
// @modified    2018-03-23
...
// @namespace undefined
// @downloadURL https://update.greasyfork.org/scripts/368106/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E9%AB%98%E9%80%9F%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/368106/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E9%AB%98%E9%80%9F%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
(function() {
    ...
    function PanHelper(){
        ...
        function addButton(){
            ...
            var $dropdownbutton_a = $('<a class="g-button" href="javascript:void(0);"><span class="g-button-right"><span class="text" style="width: auto;">高速下载</span></span></a>');
        ...
        function getCurrentPage(){
            var hash = location.hash;
            //理论上修复我的网盘中有按钮,但是点击下载或显示链接报错
            var currrentPage = decodeURIComponent(hash.substring(hash.indexOf('#')+1,hash.indexOf('/')));
            if(currrentPage == ''){
                currrentPage = decodeURIComponent(hash.substring(hash.indexOf('=')+1,hash.indexOf('&')));
            }
            return currrentPage;
        }
    ...
    function PanShareHelper(){
        ...
        function addButton(){
            ...
            var $dropdownbutton_a_span = $('<span class="g-button-right"><em class="icon icon-download" title="百度网盘高速下载助手"></em><span class="text" style="width: auto;">高速下载</span></span>');
