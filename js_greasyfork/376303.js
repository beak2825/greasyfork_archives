// ==UserScript==
        ...
        // @grant          unsafeWindow
        // grant          GM_openInTab
// @downloadURL https://update.greasyfork.org/scripts/376303/WEXNET%20All%20Shipments.user.js
// @updateURL https://update.greasyfork.org/scripts/376303/WEXNET%20All%20Shipments.meta.js
        // ==/UserScript==
        //
        ...
        function PostShipments(val) {
            ...
            if (val == "28470463502193900614" || val == "36785398606136366791" || "30157937704933417084") {
                ...
                $("#5660121065705389 tr.even,#5660121065705389 tr.odd").each(function (i, xtr) {
                    ...
                    shipment.TYPE = cs($("#apexir_SAVED_REPORTS").val());
