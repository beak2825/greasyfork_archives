// ==UserScript==
// @name N.NOVGOROD | Кураторы форума
// @name:ru N.NOVGOROD | Кураторы форума 
...
// @grant       none
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/530468/NNOVGOROD%20%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/530468/NNOVGOROD%20%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
(function () {
  'use strict';
...

{
    ...
    content: "[CENTER][FONT=georgia]Доброго времени суток, уважаемый(-ая) [U]{{ user.name }}[/U]![/font][/center]<br><br>" +
    "[font=georgia][center]Ваша RolePlay биография взята на рассмотрение. Ожидайте ответа в данной теме.[/font][/center]<br><br>" +
"[Center][Color=yellow][ICODE]На рассмотрении...[/ICODE][/COLOR][/center]",     
    prefix: PIN_PREFIX,
    status: true,
...
{
    title: `Отказано(NickName указан на англ языке)`,
    content: "[CENTER][FONT=georgia]Доброго времени суток, уважаемый(-ая) [U]{{ user.name }}[/U]![/font][/center]<br><br>" +
    "[font=georgia][center]Ваша [COLOR=rgb(255, 0, 0)]RolePlay[/COLOR] [COLOR=rgb(255, 0, 0)]биография[/COLOR] была рассмотрена и [COLOR=rgb(255, 0, 0)]получила статус[/COLOR]:[/font][center]<br>" +
    "[center][COLOR=red][ICODE]Отказано[/ICODE][/color][/center]<br><br>" +
...

{
    ...
    "[font=georgia][center]Ваша [COLOR=rgb(255, 0, 0)]RolePlay[/COLOR] [COLOR=rgb(255, 0, 0)]биография[/COLOR] была рассмотрена и [COLOR=rgb(255, 0, 0)]получила статус[/COLOR]:[/font][center]<br>" +
    "[center][COLOR=red][ICODE]Отказано[/ICODE][/color][/center]<br><br>" +
    "[center][font=Georgia][color=red]Причина[/color]: Запрещено создание Role Play биографии, если у Вас NonRolePlay никнейм.[/font][/center]<br><br>" +
    "[center][FONT=georgia]Приятной игры на сервере [COLOR=rgb(255, 215, 0)]NOVGOROD[/COLOR].[/center][/FONT]",
    prefix: UNACCEPT_PREFIX,
    status: false,
},
