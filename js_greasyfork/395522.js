// ==UserScript==
// @name         Torn City - Special Gym Ratios (Works On All Platforms)
// @namespace    Sumair.hanksRatio
// @version      0.1.0
// @description  Modified version of RGiskard's Hanks Ratio that monitors battle stat ratios and provides warnings if they approach levels that would preclude access to special gyms
// @author       MSAGSimair [2363320]
// @include      *.torn.com/gym.php*
// @require      http://code.jquery.com/jquery-latest.js
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/395522/Torn%20City%20-%20Special%20Gym%20Ratios%20%28Works%20On%20All%20Platforms%29.user.js
// @updateURL https://update.greasyfork.org/scripts/395522/Torn%20City%20-%20Special%20Gym%20Ratios%20%28Works%20On%20All%20Platforms%29.meta.js
// ==/UserScript==
...
jQuery.noConflict(true)(document).ready(function($) {
	...
	setInterval(function() {
        ...
        $statContainers.each(function(index, element) {
            ...
            stat = GetAbbreviationsFullForm(stat);
            if (stats[stat]) {
                var gymStatus;
...
function GetAbbreviationsFullForm(statString) {
    if (statString == 'str') {
        return 'strength';
