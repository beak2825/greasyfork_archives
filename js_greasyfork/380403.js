// ==UserScript==
// @name         b0t4k404
// @namespace    B0T4K404 ---FMC--- Full Mouse Control 
// @version      1.0
...
// @grant        none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/380403/b0t4k404.user.js
// @updateURL https://update.greasyfork.org/scripts/380403/b0t4k404.meta.js
// ==/UserScript==
...
document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> <span style='color: #FDC944'><b><font size='4'><u> [!] B0T4K404 [!] </u></font></b></span> </span></span></center><br></br>";
document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> <span style='color: #5b7ace'><b><u> Left Click </u></b></b> To do Normal <b> Split (x1)<b></span></span></center>";
document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> <span style='color: #5b7ace'><b><u>Scroll</u></b></b> To <b>Give Mass (Faster than Normal)<b></span></span></center>";
document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_d'> <span style='color: #5b7ace'><b><u>Right Click</u></b></b> To perform <b>Full Split (x8)<b></span></span></center>";
    document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> <span style='color: #686CEE'><b><font size='4'><u></u></font></b></span> </span></span></center><br></br>";
    document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_d'> <span style='color: #f60101'><b>Otherwise, you can play normally. Even with the script enabled, you can use ordinary keyboard.</b></span></span></center>";
