...
// @license GNU GPLv3
// @downloadURL https://update.greasyfork.org/scripts/371824/CSGO%E9%A5%B0%E5%93%81%E4%BB%B7%E6%A0%BC%E5%AF%B9%E6%AF%94%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/371824/CSGO%E9%A5%B0%E5%93%81%E4%BB%B7%E6%A0%BC%E5%AF%B9%E6%AF%94%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
        ...
        onload: function (response) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (Trim(name) == Trim(itemName)) {
                    ...
                    $(li).html('<a href="' + url + '" style="padding: 0px"><span class="myTitle">悠悠出售：</span>' + '在售数量：<span class="mySum">' + sum + '</span>售价：<span class="myPrice">¥' + price + '</span></a>');
                    return;
                }
            }
        }
        ...
        onload: function (response) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (Trim(name) == Trim(itemName)) {
                    ...
                    $(li).html('<a href="' + url + '" style="padding: 0px"><span class="myTitle">悠悠出租：</span>' + '出租数量：<span class="mySum">' + sum + '</span>短租：<span class="myPrice">¥' + short_price + '\/天</span>长租：<span class="myPrice">¥' + long_price + '\/天</span></a>');
                    return;
                }
            }
            $(li).html('<a href="javascript:return false;" style="padding: 0px"><span class="myTitle">悠悠出租：</span><span style="color: #FF0000">查找不到数据！</span></a>');
...
function c5() {
    $('.tab-content').on('mouseenter', 'li:not(.c5li)', function () { // 选择不包含c5li类的li，否则会嵌套触发事件
        ...
        var v5Li = $('<li class="rm-menu-item c5li" style="height: 25px;"><span class="myTitle">BUFF：</span><span>载入中...</li>');
        $(list).append(v5Li);
