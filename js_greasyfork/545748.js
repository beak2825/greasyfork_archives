...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/545748/Block%20PMs.user.js
// @updateURL https://update.greasyfork.org/scripts/545748/Block%20PMs.meta.js
// ==/UserScript==
...
(function() {
    ...
    const selectors = [
        '#message_reply_body > a:nth-child(3)',
        '#btn_message_sent',
        '#message_reply_preview > a:nth-child(3)'
    ];
