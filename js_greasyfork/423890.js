// ==UserScript==
// @name         显示README.md文件内容[无外引用,兼容kiwibrowser]
// @namespace    http://tampermonkey.net/
// @version      1.0.6
// @description  为网站显示README.md内容
// @author       aotmd
// @match        http://gal2.acg18.win/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/423890/%E6%98%BE%E7%A4%BAREADMEmd%E6%96%87%E4%BB%B6%E5%86%85%E5%AE%B9%5B%E6%97%A0%E5%A4%96%E5%BC%95%E7%94%A8%2C%E5%85%BC%E5%AE%B9kiwibrowser%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/423890/%E6%98%BE%E7%A4%BAREADMEmd%E6%96%87%E4%BB%B6%E5%86%85%E5%AE%B9%5B%E6%97%A0%E5%A4%96%E5%BC%95%E7%94%A8%2C%E5%85%BC%E5%AE%B9kiwibrowser%5D.meta.js
// ==/UserScript==


(function () {
    setTimeout(() => {
        var 主区域 = document.createElement('div');
        主区域.className = "readmeview list-wrapper";
        document.body.appendChild(主区域);
        主区域.innerHTML = "<div class='topnameclass'>README.md</div>";
        axios.get(window.location.protocol + '//' + location.hostname + '//' + "README.md")
            .then(function (response) {
                var result = wrapToBr(response.data);
                console.log(result);
                //结果初始化
                let 结果;
                结果 = document.createElement('div');
                结果.style = 'padding: 20px;';
                document.getElementsByClassName('readmeview')[0].appendChild(结果);
                结果.innerHTML = result;
            })
