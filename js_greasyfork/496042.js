// ==UserScript==
// @name   KF_script_by_support
// @name:ru script Кураторы форума FF
// @description  Suggestions for improving the script write here ---> -
// @description:ru Author GREEN RUSSIA | SUPPORT
...
// @downloadURL https://update.greasyfork.org/scripts/496042/KF_script_by_support.user.js
// @updateURL https://update.greasyfork.org/scripts/496042/KF_script_by_support.meta.js
// ==/UserScript==
...
const LD_PREFIX = 4; // Prefix that will be set when thread send to project team
const WATCHED_PREFIX = 12;
const CLOSE_PREFIX = 6;
const OTKAZBIO_PREFIX = 3;
const ODOBRENOBIO_PREFIX = 2;
const NARASSMOTRENIIBIO_PREFIX = 5;
const buttons = [
    {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба была передана на рассмотрение [COLOR=rgb(216, 0, 0)]Лидеру.[/color][/CENTER]<br>" +
    ...
    },
    {
      ...
      status: true,
        ...
        {
		title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ                                ᅠ⠀             ⠀ ⠀⠀ᅠ ᅠᅠ🍺 Правила Семьи 🍺ᅠᅠ          ⠀        ⠀    ⠀      ⠀ᅠ     ᅠ ᅠ     ᅠ ᅠ ᅠ ',
        dpstyle: 'oswald: 3px;     color: #fff; background: #212428; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 1px solid #BF40BF; width: 96%',
	},
      {
      title: 'ТК',
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        ...
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]2.01.[/color] Запрещен TK (Team Kill) — убийство члена своей или союзной семьи [COLOR=rgb(255, 0, 0)] | Выговор [/COLOR][/QUOTE][/CENTER]<br><br>" +
    ...
    },
    {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]2.02.[/color] Запрещен PG (PowerGaming) — присвоение свойств персонажу, не соответствующих реальности, отсутствие страха за свою жизнь [COLOR=rgb(255, 0, 0)] | Выговор/Устный выговор [/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      status: false,
    },
    {
    ...
    },
    {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        ...
        "[CENTER]Пример: вам выдали доступ к оружию 1000 патронов, вам разрешили брать только по 30 патронов и то не так часто, вы взяли больше 30 патронов то вам выговор.[/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    ...
    },
    {
    ...
    },
     {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]2.07.[/color] Запрещено использование верхнего регистра (CapsLock) при написании любого текста в чате семьи [COLOR=rgb(255, 0, 0)] | Mute 30 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
     {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]2.08.[/color] Запрещено упоминать или оскорблять родных в чате семьи [COLOR=rgb(255, 0, 0)]| Mute 120 минут + Выговор[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    ...
    },
     {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]2.11.[/color] Запрещен флуд — 3 и более повторяющихся сообщений от одного и того же игрока в чат семьи [COLOR=rgb(255, 0, 0)] | Mute 30 минут [/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    ...
    },
     {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        ...
        "[CENTER]Примечание: своё игровое имущество перекинуть на другой свой аккаунт[/CENTER]<br><br>" +
        "[CENTER]Пример: с одного своего аккаунта положить свою сумку Суприм на склад семьи, и потом уже зайти на свой другой аккаунт и уже оттуда забрать свою сумку Суприм[/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
     {
      title: 'Полит/Религ в чате фамы',
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
    ...
    },
     {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]2.17.[/color] Запрещено продажа или покупка репутации семьи любыми способами, скрытие нарушителей, читеров заместителем семьи [COLOR=rgb(255, 0, 0)] | Увольнение + ЧС семьи[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
     {
      title: 'Злоуп симвл в чате фамы',
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]2.18.[/color] Запрещено злоупотребление знаков препинания и прочих символов в чате семьи [COLOR=rgb(255, 0, 0)] | Mute 30 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
    ...
    },
 {
    ...
    },
    {
      ...
      content: "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        ...
        "Причиной отказа могло послужить какое-либо нарушение из Правила Role-Play ситуаций[/CENTER][/FONT]",
...
$(document).ready(() => {
    ...
    addButton('💖 Script FoX Factory 💖', 'selectAnswer');
