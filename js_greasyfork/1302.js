...
// @include     http://vendetta.de*
// @include     http://www.ravengames.de*
// @version     1
// @downloadURL https://update.greasyfork.org/scripts/1302/stiddaride%20%28Vers%C3%A3o%20Portuguesa%29.user.js
// @updateURL https://update.greasyfork.org/scripts/1302/stiddaride%20%28Vers%C3%A3o%20Portuguesa%29.meta.js
// ==/UserScript==
//
...
document.body.innerHTML = document.body.innerHTML.replace(/Chemische Ausbildung/g, 'Treino Químico');
...
document.body.innerHTML = document.body.innerHTML.replace(/Name/g, 'Nome');
document.body.innerHTML = document.body.innerHTML.replace(/Voraussetzung/g, 'Pré-requisitos');
document.body.innerHTML = document.body.innerHTML.replace(/Dauer/g, 'Duração');
document.body.innerHTML = document.body.innerHTML.replace(/Punkte/g, 'Pontos');
document.body.innerHTML = document.body.innerHTML.replace(/Berechnen/g, 'Calcular');
document.body.innerHTML = document.body.innerHTML.replace(/Angriffs-/g, 'Ataque -');
document.body.innerHTML = document.body.innerHTML.replace(/wert/g, 'Poder');
document.body.innerHTML = document.body.innerHTML.replace(/Verteidigungs-/g, 'Dedesa -');
document.body.innerHTML = document.body.innerHTML.replace(/Angriffsbonus/g, 'Bônus de Ataque');
document.body.innerHTML = document.body.innerHTML.replace(/Verteidigungsbonus/g, 'Bônus de Defesa');
document.body.innerHTML = document.body.innerHTML.replace(/Geschwindigkeit/g, 'Velocidade');
document.body.innerHTML = document.body.innerHTML.replace(/Lohn/g, 'Salário');
