...
// @downloadURL https://update.greasyfork.org/scripts/388421/For%20KUAHI%20%3C3.user.js
// @updateURL https://update.greasyfork.org/scripts/388421/For%20KUAHI%20%3C3.meta.js
// ==/UserScript==
...
console.log("%cMai <3 Script is enabled. I love Kuahi.", "font-size: 25px; font-weight: bold; background: red; color: white; padding: 10px; border: solid 2px orange;");
