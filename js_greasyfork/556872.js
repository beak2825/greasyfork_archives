// ==UserScript==
// @name Torn Trade Autofill Buttons - Ghost
...
// @grant none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/556872/Torn%20Trade%20Autofill%20Buttons%20-%20Ghost.user.js
// @updateURL https://update.greasyfork.org/scripts/556872/Torn%20Trade%20Autofill%20Buttons%20-%20Ghost.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    multiplierContainer.style.marginTop = '20px'; // Increased spacing from Change button
    ...
    function updateInputValue(subtractAmount) {
        try {
            ...
            console.log('Trade Autofill: Initial amount: ' + initialAmount + ', Subtracted: ' + subtractAmount + ', New value: ' + newValue);
        } catch (error) {
        ...
        if (visibleInput && changeButtonWrap) {
            ...
            if (initialAmount === 0 && visibleInput.value) {
                ...
                if (!isNaN(parsed) && parsed > 0) {
                    ...
                    console.log('Trade Autofill: Captured initial amount > 0: ' + initialAmount);
                    captured = true;
                }
            }
            // Only show containers if initialAmount > 0
            if (initialAmount > 0) {
                ...
                if (captured) resetMultiplier(); // Highlight 1x if newly captured
            } else {
                multiplierContainer.style.display = 'none';
                container.style.display = 'none';
            }
            ...
            multiplierContainer.style.display = 'none';
            container.style.display = 'none';
            console.log('Trade Autofill: Input or Change button not found');
        }
    }
    ...
    console.log('Trade Autofill: Initialized (v4.7 - safe when wallet=0)');
})();