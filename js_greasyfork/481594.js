// ==UserScript==
// @name         Deal aanmaken tools & fixes van Lukas
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/481594/Deal%20aanmaken%20tools%20%20fixes%20van%20Lukas.user.js
// @updateURL https://update.greasyfork.org/scripts/481594/Deal%20aanmaken%20tools%20%20fixes%20van%20Lukas.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (redTable && redTable.querySelector('td[bgcolor="#FF9999"]') !== null) {
    ...
    function logistiekToggleInputs() {
        ...
        const website = selectedVal == "4" || selectedVal == "8" || selectedVal == "9" || selectedVal == "10" || selectedVal == "14";
    ...
    function getHtmlReserveerText() {
        ...
        switch (reserveren) {
            ...
            case "13":
                ...
                break;
            case "14":
                reserveertext = "na aankoop via WhatsApp of website reserveren (onder vermelding van Social Deal)";
                break;
            default:
                reserveertext = "";
        }
