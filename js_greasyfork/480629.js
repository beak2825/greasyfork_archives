...
(function() {
    ...
    function generateURL() {
        ...
        return `https://www.waze.com/partnerhub/map-tool/alerts?lon=${lon}&lat=${lat}`;
    }
    function openRT() {
        ...
        try {
            ...
            if (toolbarWrap !== null) {
              ...
              //toolbarWrap.insertAdjacentHTML('afterend', '<div class="WazeControlORT" id="WME_ORT" style="margin:0 5px;"><a href="#" id="btn-openrt">REPORT</a></div>');
                toolbarWrap.insertAdjacentHTML('afterend', '<div class="WazeControlORT" id="WME_ORT" style="margin:0 5px;"><a href="#" id="btn-openrt"><strong>report</strong></a></div>');
