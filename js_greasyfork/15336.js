...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/15336/Theme%20Noel.user.js
// @updateURL https://update.greasyfork.org/scripts/15336/Theme%20Noel.meta.js
// ==/UserScript==
$('#logo img').remove();
...
$(document).ready(function(){
                ...
                var css = '.PageNav a.currentPage{color:#FA2104;background:url(rgba.php?r=20&g=122&b=191&a=127);background:#f81006;_filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#7F147ABF,endColorstr=#7F147ABF);border-color: #FA2104;position:relative}';
...
$(document).ready(function(){
    ...
    $(document).ready(function(){
                ...
                var css = '::-webkit-scrollbar-thumb{cursor:pointer!important;-webkit-border-radius:10px;-webkit-border-radius:0px;-moz-border-radius:0px;-khtml-border-radius:0px;border-radius:0px;background: #FA2104;}';
    ...
    $('head').append('<style>' + css + '</style>');
     ...
     $(document).ready(function(){
                ...
                var css = '.primaryContent a{color:#FA2104}';
    ...
    $('head').append('<style>' + css + '</style>');
      ...
      $(document).ready(function(){
                ...
                var css = '.message .publicControls .Author:hover{-webkit-border-radius:3px;-moz-border-radius:3px;-khtml-border-radius:3px;border-radius:3px;color:#FA2104;-webkit-box-shadow:0px 0px 0px 1px rgba(44,110,188,0.4);-moz-box-shadow:0px 0px 0px 1px rgba(44,110,188,0.4);-khtml-box-shadow:0px 0px 0px 1px rgba(44,110,188,0.4);box-shadow:0px 0px 0px 1px rgba(206, 12, 38, 0.34)}';
