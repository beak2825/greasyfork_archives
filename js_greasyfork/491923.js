...
// @downloadURL https://update.greasyfork.org/scripts/491923/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Beng%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/491923/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Beng%5D.meta.js
// ==/UserScript==
(function(f)
    {
...
s.parentNode.removeChild(s)})(function(){if(isDefined(window.TWDB)){new west.gui.Dialog(TWDB.script.name,'<div class="txcenter"><b><br>The UserScript ClothCalc is installed twice, with two different language versions. You will have to uninstall one of them for the script to work properly!</br></b></div>',west.gui.Dialog.SYS_WARNING).addButton("OK").show();
} else { 
    TWDB = {};
        ...
        TWDB.ClothCalc = {
            ...
            checkCache: function () {
                ...
                if (items || skills || customs) {
                    var mouseover_txt = "the Data is outdated, click for Update";
                    if (items) { mouseover_txt += " [Inventory]"; }
                    if (skills) { mouseover_txt += " [Skill]"; }
                    if (customs) { mouseover_txt += " [Custom skills]"; }
                    ...
                    $button = jQuery('<div title="the Data is up to Date" style="position:absolute;top:0px;right:0px;width:20px;height:20px;background: url(' + TWDB.images.iconData + ')no-repeat -20px 0px;" /></div>');
                    this.up2date = true;
                }
            ...
            open: function (p_id, p_type) {
                ...
                this.gui.job.sort = jQuery('<div style="position:absolute;top:10px;left:0px;height:20px;" />')
                    ...
                    .append('<img src="' + TWDB.images.iconExperience + '" title=" Sort by experience " alt=" Sort by experience " onclick="javascript:TWDB.ClothCalc.joblist.order(\'experience\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                    ...
                    .append('<img src="' + TWDB.images.iconLaborpoints + '" title=" Sort by workpoints " alt=" Sort by workpoints " onclick="javascript:TWDB.ClothCalc.joblist.order(\'laborpoints\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                    .append('<img src="' + TWDB.images.iconMoti + '" title=" Sort by motivation " alt=" Sort by motivation " onclick="javascript:TWDB.ClothCalc.joblist.order(\'motivation\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                ...
                **/
                ...
                this.gui.job.mode = jQuery("<div style=\"position:absolute;top:10px;right:30px;width:20px;height:20px;background:url('" + TWDB.images.jobTime + '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:block;" title=" Job time " />');
                this.gui.job.search = jQuery("<div style=\"position:absolute;top:35px;right:50px;width:20px;height:20px;background:url('" + TWDB.images.iconSearch + '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:none;" title=" Find this job on the map " />');
                ...
                this.gui.job.button = jQuery('<div style="position:absolute;top:35px;right:4px;width:26px;height:20px;background:url(\'/images/window/character/title_editbtn.jpg\') no-repeat scroll 0 0 transparent;cursor:pointer;" title=" Select job here " />');
                ...
                this.gui.custom.button = jQuery('<div style="position:absolute;top:35px;right:4px;width:26px;height:20px;background:url(\'/images/window/character/title_editbtn.jpg\') no-repeat scroll 0 0 transparent;cursor:pointer;" title=" Select job here " />');
                ...
                this.gui.window = wman.open(this.uid, null, "noreload").setMiniTitle("TWDB Cloth Calc").setTitle("tw-db.info Cloth Calc")
                    .addTab("Job", "Jobs", tabclick).addTab("Custom skills", "Custom", tabclick)
                ...
                var f = $('<div title="save Position" style="width:20px;height:20px;position:absolute;left:0px;top:0px;background:url(\'' + TWDB.images.iconSave + "') no-repeat scroll 0px -20px transparent;cursor:pointer;display:block;\" />")
            ...
            joblist: {
                ...
                init: function (parent) {
                    ...
                    for (jobid in parent.calcdata.jobs) {
                        ...
                        tmp.str = "Â§" + job.name.toUpperCase() + "Â§";       // separator that doesn't occur in jobs/products
                        if (job.gameid !== 0) {
                            ...
                            for (itemid in jobData.yields) {
                                ...
                                tmp.str += ItemManager.get(itemid).name.toUpperCase() + "Â§";
                            }
                        }
                ...
                search: function (string, absolute) {
                    var regexp = new RegExp(isDefined(absolute) ? "Â§" + string.toUpperCase() + "Â§" : string.toUpperCase(), 'i');
                    var state = true;
                    var _self = this;
                    var $found = [];
                    $.each(this.elements, function (k, el) {
            ...
            customs: {
                ...
                addConfig: function () {
                    ...
                    if (e >= 15) {
                        (new UserMessage(
                            "too much entries, only ten are allowed",
                ...
                editConfig: function (e, t) {
                    if (typeof t == "undefined") {
                            ...
                            .append(jQuery("<tr />")
                                ...
                                .append(
                                    ...
                                    .append(
                                        ...
                                        .getMainDiv())));
                        o
                            .append('<tr><td colspan="2">please go to tw-db.info an get the code snippets to inserts here from there <a href="https://tw-db.info/?strana=calc" target="_blank">tw-db.info Calculator</a></td></tr>');
                        ...
                        var u = function (e) {
                            (new UserMessage(
                                "the inserts you have done are incorrect: " + e,
                                UserMessage.TYPE_ERROR))
                            .show();
                            return false
                        };
            ...
            jobSearch: function() {
                ...
                for (var i = 0; i < pos.length; i++) {
                    ...
                    if (Premium.hasBonus("automation")) {
                        var $td = jQuery("<td />");
                        var btn = new west.gui.Button("default", function (id, x, y) { return function() {
        ...
        (function ($) {
            ...
            var Loader = (function($) {
                ...
                var registerScript = function() {
                    ...
                    var content = $("<div style='font-family:comic sans ms; font-size:13pt; padding-top:10px; text-align:center;' />")
                                 .append("The UserScript ClothCalc is a project created by the TW-DB.info team. It offers plenty of features and extensions that will give you an enhanced game experience - saving your time and optimizing some of your activities.", Paypal, "Thank you!");
                ...
                _self.reset = function (confirm, type) {
                    try {
                        if (confirm) {
                            ...
                            var div = $('<div><h2>do you really want to reset the whole Cache of tw-db Userscript?</h2></div>');
            ...
            var Settings = function ($) {
                ...
                var values = [
                        ...
                        // [0, "questgroup", "Show the daily Quests as Groups", false],

                        [9, "", "Market", false],                    // Market
                        ...
                        [9, "", "Miscellaneous", false],                               // Miscellaneous
                    ...
                    combobox.addItem('left','left').addItem('right','right').addItem('custom','saved Position');
                    combobox.select(String(settings['clothPos']));
                    $('tr.placeholder_clothPos', table).removeClass('placeholder_clothPos').append($('<td colspan="2" />').append(combobox.getMainDiv(), '<span>&nbsp;right</span>'));
                ...
                var injectJobWindowBestWear = function() {
                    try {
                        ...
                        JobWindow.prototype.getBestWearButton  = function() {
                            ...
                            var _this = this;
                            return $div.append($('<div class="twdb_bestwear" title="Show this Job at ClothCalc Window">').click(function(ev){
  ...
  ///////////////////////////////////////
            var Sleep = (function($) {
                ...
                var init = function() {
                    if (loader.ready) { return; };
                    // Settings.addOption( '?interface' , 'directsleep', 0 ,'Get a Button to directly go to Hotel or Barrack'); // for new settings system only
            ...
            var Analyser = (function ($) {
                ...
                var init = function ( ) {
                  ...
                  GameInject.addTabOnMessagesWindow( 'Job-Analyser' , 'analyser-job' , function(){show('job');} );

                  if ( Settings.get('chestanalyser',true) ) {
                    GameInject.ItemUse(Chest.add);
                    GameInject.addTabOnMessagesWindow( 'Chest Analyser' , 'analyser-chest' , function(){Chest.show();} );
                  }
                ...
                var showJobs = function() {
                  ...
                  tmp.data('sum','&sum;');
                  tmp.data('sum-t','switch to &Oslash;');
                  tmp.data('avg','&Oslash;');
                  tmp.data('avg-t','switch to &sum;');
                  gui.footer.append(tmp);
                  ...
                  var div = $('<div style="margin: 0px 6px 0px 6px;width:680px;" />')
                    .append(
                        $('<a href="#">Switch between rewards and found items</a>')
            ...
            var Notes = function (e) {
                ...
                var o = function (e) {
                    Cache.save("notes", e);
                    (new UserMessage("saved successful",
            ...
            var Map = function (e) {
                ...
                var d = function () {   // minimap - coordinates bar
                    ...
                    var t = function() {
                        ...
                        var u = (new west.gui.Button("Ok", function() { o(); }, null, null, "Scroll the map to the given coordinates")).setWidth("48");
                        var a = e('<img title="Show map coordinates" src="' + Images.iconCount + '" />')
                                .click(function() {
            ...
            var BonusJobs = function ($) {
                ...
                var injectBonusJobs = function () {   // minimap - bonus job bar
                    ...
                    var inject = function() {
                        var dom = $('<div id="mmap_twdb_bonusjobs" />')
                            .append($('<input title="Show Gold-Bonus Jobs" type="checkbox" ' + (bonus.gold ? 'checked="checked"' : "") + ' />')
                            ...
                            .append($('<input title="Show Silver-Bonus Jobs" type="checkbox" ' + (bonus.silver ? 'checked="checked"' : "") + ' />')
                            ...
                            .append($('<img title="Bonus-Jobs Export" src="' + Images.iconExport + '" />')
                                .click(function() { exportBonusJobs(); }))
                            .append( $( '<img title="Bonus-Jobs Import" src="' + Images.iconImport + '" />')
                                .click(function() { importBonusJobs(); }))
                            .append($('<img title="Bonus-Jobs Reset" src="' + Images.iconReset2 + '" />')
                ...
                var exportBonusJobs = function () {
                    ...
                    var h = $("<div />")
                        ...
                        .append(
                            $(
                                '<img src="' + Images.iconName + '" title=" Sort by name "  style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                            .click(function () {
                                c("name")
                            }))
                        .append(
                            $(
                                '<img src="' + Images.iconCount + '" title=" Sort by Country " style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                            .click(function () {
                                c("country")
                            }));
                    (new west.gui.Dialog("Bonus-Jobs Export", $(
                ...
                var importBonusJobs = function () {
                    ...
                    (new west.gui.Dialog("Bonus-Jobs Import", txtarea))
                ...
                var resetBonusJobs = function (e) {
                    try {
                        if (e) {
                            ...
                            Cache.save("bonusjobs", bonusjobs);
                            handleBonusJobs();
                            (new UserMessage("Bonus-Jobs Reset",
                                UserMessage.TYPE_SUCCESS)).show()
                        } else {
            ...
            var SellTip = (function ($) {
                ...
                var getDiv = function (el) {
                    ...
                    if ( Settings.get('sellTip1',true) ) {
                        ...
                        if ( count > 1 ) {
                            sell = true;
                            title = ('this item you have more than once').escapeHTML();
                        };
                        };
                    };
                    ...
                    if ( Settings.get('sellTip2',true) && ClothCalc.isLoaded() ) {
                        ...
                        sell = true;
                        title = ('this item is not used for any job or custom defined activity (ClothCalc)').escapeHTML();
                        };
                    };
                    ...
                    if ( sell ) {
                        el.divMain.append('<img src="' + Images.iconSell + '" class="TWDBsellTip" title="' + title + '" title=" this item you have not yet " style="position:absolute;bottom:4px;right:0px;width:19px;height:19px;padding:0px;border:0px;margin:0px;" />');
                    };
                };
                return _self;
            })($);
            ...
            var Collector = function (e) {
                    ...
                    if (Settings.get("collector", true)) {
                        ...
                        GameInject.injectTrader("collector", function (e) {
                            if (t.isNewItem(e.item_id)) {
                                var imgInject = '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" this item you have not yet " ' + ' style="position:absolute;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />'
                                return imgInject;
                        }
                            return "";
                        });
                ...
                var s = function (e) {
                    ...
                    if (t.isNewItem(e.obj.item_id)) {
                        e.divMain
                            .append('<img src="' + Images.iconNew + '" class="TWDBcollector" title=" this item you have not yet " style="position:absolute;top:-8px;left:-15px;padding:0px;border:0px;margin:0px;" />')
                    }
                };
                var o = function (e) {
                    if (t.isNewItem(e)) {
            ...
            var BuyTip = function (e) {
                ...
                var a = function (e, t) {
                    ...
                    e.divMain
                        .append('<img src="' + Images["iconStar3"] + '" class="TWDBbuyTip" width="25px" height="25px"     title="Calculating, please wait..."  style="position:absolute;bottom:-8px;right:-5px;padding:0px;border:0px;margin:0px;" />');
                            ...
                            for (i = 0; i < TaskQueue.queue.length; i++) {
                                if (TaskQueue.queue[i].type === 'job') {
                                    ...
                                    if (TaskQueue.queue[i].data.job_points < 0) {                                               // negative LP
                                        $notice = west.gui.Icon.get('exclamation-priority-3', 'negative labor points');
                                    } else if (TaskQueue.queue[i].data.job_points < (TaskQueue.queue[i].data.job.malus / 5)) {  // low LP (< difficulty/5)
                                        $notice = west.gui.Icon.get('exclamation-priority-2', 'low labor points');
                                    } else if (badcloth) {  // suboptimal LP
                                        $notice = west.gui.Icon.get('exclamation-priority-1', 'not optimal labor points');
                                    }
                                    if ($notice !== null) {
            ...
            w.Map.refresh(true);
                ...
                var QuestbookSwitch = function() {
                    try {
                        ...
                        QuestGroupWindowView.showSolvedQuest = function (quest) {
                            ...
                            var $swbutton = $('<a href="#"> Show completion text </a>').addClass("introshown").click(function () {
                                var $t = $(this),
                                    is = $t.hasClass("introshown");
                                $endtext.toggle(is);
                                $introtext.toggle(!is);
                                $t.text(is ? ' Show introduction text ' : ' Show completion text ');
                ...
                var enhanceMarketSellDialog = function() {
                    ...
                    MarketWindow.TWDB_touchUpSellDialog = function(dialog) {
                        ...
                        // building controls...
                        $("#twdb_msd_desc_cc", $dc)
                            .append($('<div class="tw2gui-iconset tw2gui-icon-save" title="Save description for future auctions">')
                                        .click(function(){savePresets("description",$("textarea#auction_description", $dc).val());}),
                                    $('<div class="tw2gui-iconset tw2gui-icon-abort" title="Reset description">')
                                        .click(function(){savePresets("description","");$("textarea#auction_description", $dc).val("")}));

                        $("#twdb_msd_buy_cc", $dc)
                            .append(new west.gui.Checkbox("", "twdb_msd_buy_fix", togglePresets).setTitle("Use as default price").setValue(2).divMain)  // (label, groupClass, callback)
                            .append($('<div class="tw2gui_checkbox" title="Set item&#38;#39;s buying price">')
                                    .append('<span class="invPopup_buyicon" style="height:20px;">')
                                    .click(function(){
                                        $('#market_max_price', $dc).val(item4sale.price || 1).keyup();}))
                            .append('&nbsp;&nbsp;')
                            .append(new west.gui.Checkbox("", "twdb_msd_buy_fix", togglePresets).setTitle("Use as default price").setValue(1).divMain)  // (label, groupClass, callback)
                            .append($('<div class="tw2gui_checkbox" title="Set item&#38;#39;s selling price">')
                        ...
                        $("#twdb_msd_bid_cc", $dc)
                            .append(new west.gui.Checkbox("", "twdb_msd_bid_fix", togglePresets).setTitle("Use as default price").setValue(2).divMain)  // (label, groupClass, callback)
                            .append($('<div class="tw2gui_checkbox" title="Set item&#38;#39;s buying price">')
                                    .append('<span class="invPopup_buyicon" style="height:20px;">')
                                    .click(function(){
                                        $('#market_min_bid', $dc).val(item4sale.price || 1).keyup();}))
                            .append('&nbsp;&nbsp;')
                            .append(new west.gui.Checkbox("", "twdb_msd_bid_fix", togglePresets).setTitle("Use as default price").setValue(1).divMain)  // (label, groupClass, callback)
                            .append($('<div class="tw2gui_checkbox" title="Set item&#38;#39;s selling price">')
                                    .append('<span class="invPopup_sellicon" style="height:20px;">')
                                    .click(function(){
                        ...
                        $("#twdb_msd_opt_cc", $dc)
                            .append($('<span class="tw2gui-iconset tw2gui-icon-save" title="Save duration and rights for future auctions" style="display: inline-block;">')
                                    ...
                                    $('<span class="tw2gui-iconset tw2gui-icon-abort" title="Reset options" style="display: inline-block;">')
                ...
                var weeklyCrafting = function() {
                    if (w.Character.professionId && w.Character.professionSkill > 599) {
                        ...
                        var weeklyCraftingNotice = function (id) {
                            ...
                            var notice = "<div style='text-align:center;'>You can craft again!<br />"
  ...
  /////////////////////////////
                        ...
                        Inventory.addItems = function (category, page) {
                            ...
                            if (!$('#CC_pin_items').length) {
                                Inventory.DOM.children('.actions').append(
                                    ...
                                    .attr({ title: "Toggle item pinning mode".twdb_twiceHTMLUnescape() /**TODO: get rid of unescape */ })
            ...
            var Quests = function(e) {
                ...
                /*
                 * var i = function() { var t = { "daily Quests": e('<div
                 ...
                 * n.open[o]; var a = "daily Quests"; for (var f = 0; f <
                ...
                var s = function () {
                    ...
                    var n = function (t) {
                                                    ...
                                                    if (s) {
                                                        e(this)
                                                            .children(
                                                                ".quest_mmaplink")
                                                            .after(
                                                                '<span title="Show this Job at ClothCalc Window" class="quest_mmaplink" title="" onclick="javascript:void(Quest.CCopen(\'' + s.name + "','item'))\"><img src=\"" + Images.iconLight + '" /></span>')
                                                    }
                                                    ...
                                                    if (o) {
                                                        e(this)
                                                            .children(
                                                                ".quest_mmaplink")
                                                            .after(
                                                                '<span title="Show this Job at ClothCalc Window" class="quest_mmaplink" title="" onclick="javascript:void(Quest.CCopen(\'' + o.id + "','job'))\"><img src=\"" + Images.iconLight + '" /></span>')
                                                    }
                                                }
                                            }
                                        }
                        ...
                        if (t.group < 142 && (t.group != 69 || t.id >= 20000) || [200,201].indexOf(t.group) > -1) {
                            ...
                            .append('<a target="_blank" title="show that quest at tw-db.info" href="' + Script.protocol + '://' + Script.url + "/quest_redirect.php?id=" + t.id + '" style="margin-left:10px;"><img src="' + Images.questwiki + '" /></a>');
                        }
                    };
                ...
                var o = function () {
                    try {
                        ...
                        QuestWindow.cancelQuest = function (t) {
                            (new west.gui.Dialog("Cancel Quest?",
                                "Are you sure that you want to cancel that Quest?"))
                            .setIcon(
                                    west.gui.Dialog.SYS_QUESTION)
                                .setModal(
                                    true,
            ...
            var Customs = function(e) {
                ...
                var f = function (e) {
                    ...
                    (new west.gui.Dialog("delete - Custom skills",
                ...
                var l = function () {
                    ...
                    if (e >= 15) {
                        (new UserMessage("too much entries, only ten are allowed",
                        ...
                        .append(
                            ...
                            .append(
                                ...
                                .append(
                                    ...
                                    .getMainDiv())))
                        .append(
                            e('<tr><td colspan="2">please go to tw-db.info an get the code snippets to inserts here from there <a href="https://' + Script.url + '/?strana=calc" target="_blank">tw-db.info Calculator</a></td></tr>'));
            ...
            var DuelMotivation = (function ($) {
                ...
                var checkMoti = function (iniRun) {
                    ...
                    setBar(motivation + '%', 'Duel Motivation:&nbsp;' + motivation + '%', iniRun ? "duelmot_dim" : "");
                };
                ...
                var initCountdown = function (forceProt) {
                    ...
                    kotimeStr = "<div style='text-align:center;'>K.O. time<br />";
                    if (!oldSystem && ko > now && !forceProt) {
                        kotimeStr += "Duel suspension until&nbsp;" + new Date(ko).toLocaleString() + "<br />";
                    ...
                    kotimeStr += "Duel protection until&nbsp;" + new Date(prot).toLocaleString() + "</div>";
                    ...
                    try {
                        ...
                        if (w.Character.position.x == w.Character.homeTown.x && w.Character.position.y == w.Character.homeTown.y) {
                            if (n) {
                                n = false;
                                (new west.gui.Dialog("Deposit your Cash",
                                    e("<span class='twdb_banking'>You have arrived to your Hometown. Would you like to deposit your Cash? <br />Money: " + w.Character.money + "</span>"))).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false)
            ...
            var Market = function ($) {
                ...
                var Reminder = function ($) {
                    ...
                    _self.create = function (data, $imgEl) {
                        var $msg = $("<div />").append('<span style="position:relative; width:100%;display:block;">End of Auction: ' +
                                    data.auction_ends_in.getTimeString4Timestamp() + "</span>"),
                            input = (new west.gui.Textfield("twdb_analyser_last")).maxlength(4)
                                .onlyNumeric().setLabel("Remind before Auction ends: ").setPlaceholder("Minutes");
                ...
                var createTownList = function () {
                    try {
                        ...
                        for (var o = 0; o < town_array.length; o++) {
                            ...
                            s += '<div><a onclick="TownWindow.open(' + u.x + ", " + u.y + ');">' + u.name + "</a>" + ' <a title="Show Town on Map" onclick="Map.center(' + u["x"] + ", " + u["y"] + ')"><img src="' + Game.cdnURL + '/images/icons/center.png" /></a>' + " Distance: " + u["distance"] + ' <a title="Travel to Town" onclick="TaskQueue.add(new TaskWalk(' + u.town_id + ",'town'))\"><img src=\"" + Game.cdnURL + '/images/map/icons/instantwork.png"></a>' + (u["money"] == 0 ? "" : " " + u["money"] + "$") + "<br />";
                    ...
                    try {
                        ...
                        newfunction = newfunction
                            ...
                            .replace(
                                ...
                                ".appendToThCell('head','healthpoints','Sort by health','<span class=\"sort sort-healthpoints\">'+'Lp'+'</span>');")
                            .replace(
