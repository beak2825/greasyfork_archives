// ==UserScript==
// @name         LLL NM(PZ) - Game Master Mode
// @namespace    LLL NM(PZ) plugin
// @version      1.0
...
// @icon         https://i.imgur.com/L5U3dDU.png
// @grant        none
// @license      MIT
// @require      https://update.greasyfork.org/scripts/460322/1408713/Geoguessr%20Styles%20Scan.js
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/556424/LLL%20NM%28PZ%29%20-%20Game%20Master%20Mode.user.js
// @updateURL https://update.greasyfork.org/scripts/556424/LLL%20NM%28PZ%29%20-%20Game%20Master%20Mode.meta.js
// ==/UserScript==
...
(function () {
    ...
    const backgroundImageUrl = "https://i.imgur.com/VmqkCsN.png";
    ...
    const addBigZeroElements = () => {
        setTimeout(() => {
            ...
            if (!bigZero1) {
                ...
                bigZero1.style.backgroundColor = 'rgba(0, 0, 0, 0.5)';
                bigZero1.style.padding = '5px 15px';
                bigZero1.style.borderRadius = '8px';
            ...
            if (!bigZero2) {
                ...
                bigZero2.style.backgroundColor = 'rgba(0, 0, 0, 0.5)';
                bigZero2.style.padding = '5px 15px';
                bigZero2.style.borderRadius = '8px';
