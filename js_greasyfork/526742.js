...
// @name         Кураторы форума by H.Timer

// @namespace    https://forum.blackrussia.online/

// @version      1.3.5.3

// @description  Скрипт для Кураторов форума на ответы на жалобы игроков | Спасибо, что выбрали именно его
...
// @downloadURL https://update.greasyfork.org/scripts/526742/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20HTimer.user.js
// @updateURL https://update.greasyfork.org/scripts/526742/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20HTimer.meta.js
// ==/UserScript==
...

{
   ...
   '[I][CENTER][SIZE=10][COLOR=rgb(275, 0, 0)][ICODE]На рассмотрение...[/ICODE][/SIZE][/CENTER][/COLOR]', 
  ...
  '[I][CENTER][SIZE=10][COLOR=rgb(275, 0, 0)][ICODE]Закрыто.[/ICODE][/SIZE][/CENTER][/COLOR]', 
   ...
   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
                    "[I][CENTER][COLOR=rgb(250, 0,  0) ][FONT=times new roman][SIZE=4]Закрыто.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>"+
...
dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(245, 255, 0, 1.5)',
            ...
            "[CENTER][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.08.[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Запрещена любая форма аморальных действий в сторону игроков[/COLOR][COLOR=rgb(255, 0, 0)]| Jail 30 минут / Warn[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[LIST]<br><br>' +
  ...
  '[I][CENTER][SIZE=10][COLOR=rgb(275, 0, 0)][ICODE]Закрыто.[/ICODE][/SIZE][/CENTER][/COLOR]', 
     ...
     "[LIST]<br>" +
              ...
              "[*][LEFT][CENTER][FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]Примечание: [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]поведение, не соответствующее сотруднику государственного служащего.[/SIZE][/COLOR][/FONT][/CENTER][/LEFT]<br>" +
              "[*][LEFT][CENTER][FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]Пример:  [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]открытие огня по игрокам без причины,расстрел машин без причины, нарушение ПДД без причины,сотрудник на служебном транспорте кричит о наборе в свою семью на спавне.[/SIZE][/COLOR][/FONT][/CENTER][/LEFT]<br>" +
          ...
          },       
  {
   ...
   '[I][CENTER][SIZE=10][COLOR=rgb(275, 0, 0)][ICODE]Закрыто.[/ICODE][/SIZE][/CENTER][/COLOR]', 
        ...
        dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(245, 255, 0, 1.5)',
            ...
            "[CENTER][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.19.[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Запрещено оскорбление или косвенное упоминание родных вне зависимости от чата (IC или OOC) [/COLOR][COLOR=rgb(255, 0, 0)]| Mute 120 минут / Ban 7 - 15 дней[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              ...
              "[*][LEFT][CENTER][FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] термин «MQ» расценивается, как упоминание родных.[/SIZE][/COLOR][/FONT][/CENTER][/LEFT]<br>" +
                            "[*][LEFT][CENTER][FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] термин «СШ» расценивается, как оскорбление родных.[/SIZE][/COLOR][/FONT][/CENTER][/LEFT]<br>" +
              "[/LIST]<br><br>" +
                    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
             '[I][CENTER][SIZE=10][COLOR=rgb(275, 0, 0)][ICODE]Закрыто.[/ICODE][/SIZE][/CENTER][/COLOR]',        
            prefix: ACCEPT_PREFIX,
	   ...
	   },
       {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=6][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=6]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
          ...
          },
         {
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[I][CENTER][SIZE=6][COLOR=rgb(275, 0, 0)][ICODE]На рассмотрение...[/ICODE][/SIZE][/CENTER][/COLOR]',
            prefix: PIN_PREFIX,
            status: true,
          }, 
           {
