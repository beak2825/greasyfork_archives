...
// @grant        none
// @license      none
// @icon https://i.postimg.cc/vm0DvBkq/0c8013e97c9eb74506280cebb5441ce0.jpg
// @downloadURL https://update.greasyfork.org/scripts/534971/%D0%BB%D0%B5%D0%BE%D0%BD%D1%82%D0%B8%D0%B9%20%D0%BB%D0%B5%D1%81%D0%BE%D1%80%D1%83%D0%B1%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/534971/%D0%BB%D0%B5%D0%BE%D0%BD%D1%82%D0%B8%D0%B9%20%D0%BB%D0%B5%D1%81%D0%BE%D1%80%D1%83%D0%B1%D0%BE%D0%B2.meta.js
// ==/UserScript==
...
},
{
    ...
    content:
    "[CENTER][SIZE=14px][COLOR=rgb(255, 182, 193)]Здравствуйте, уважаемый[/COLOR] {{ user.mention }}.<br><br>" +
    "[COLOR=Lavender]Блокировка выдана за нарушение данного пункта правил:[/COLOR]<br><br>[COLOR=rgb( 255, 0, 0)]2.28.[/COLOR]  [COLOR=Lavender]Запрещена покупка/продажа внутриигровой валюты в любых ее проявлениях за реальные деньги[/COLOR] | [COLOR=rgb(255, 0, 0)]PermBan с обнулением аккаунта + ЧС проекта[/COLOR][/CENTER][/SIZE]",
},
{
	title: 'Дублирование',
    color: 'black',
...
},
{
    ...
    content:
    "[CENTER][SIZE=14px][COLOR=rgb(255, 182, 193)]Здравствуйте, уважаемый[/COLOR] {{ user.mention }}.<br><br>" +
    "Ваши с взломщиком аккаунты заблокированы. Если все привязки к аккаунту принадлежат вам, то создайте тему в разделе жалоб на технических специалистов.<br><br>" +
    "[COLOR=Lavender]Украденное имущество восстановлению не подлежит[/COLOR].<br><br>" +
    "[COLOR=rgb(255, 182, 193)]Закрыто[/COLOR].[/CENTER][/SIZE]",
    prefix: 7,
    status: false,
},
...
},
{
	...
	color: 'oswald: 3px; color: lavender; background: mediumpurple; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: black',
	content:
    "[CENTER][SIZE=14px][COLOR=rgb(255, 182, 193)]Здравствуйте, уважаемый[/COLOR] {{ user.mention }}.<br><br>" +
...
},
{
	...
	color: 'oswald: 3px; color: #f0e68c; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #FF0000',
	content:
...
},
{
     ...
     color: 'oswald: 3px; color: red; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #ffffff',
     content:
    "[CENTER][SIZE=14px][COLOR=rgb(255, 182, 193)]Здравствуйте, уважаемый[/COLOR] {{ user.mention }}.<br><br>" +
...
},
{
	...
	$(`button#selectAnswer`).click(() => {
		...
		function addAnswers() {
       $('.button--icon--reply').after(`<button type="button" class="button--cta uix_quickReply--button button button--icon button--icon--write rippleButton" id="selectAnswer" style="oswald: 4px; width: 55px; margin-left: 10px; margin-top: 9px; margin-bottom: 3px; color: lavender; background: mediumpurple; border: none; border-radius: 13px;">ответы</button>`,
        );
        }
...
const Button3 = buttonConfig("Технический раздел", "https://forum.blackrussia.online/forums/Тех-раздел-makhachkala.1884/");
const Button4 = buttonConfig("Жалобы на тех.", "https://forum.blackrussia.online/forums/Сервер-№42-makhachkala.1883/");
const Button5 = buttonConfig("Игроки", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.1912/");
