...
// @version      1.0.0
// @description  Official Gota.io AP Clan Extension
// @author       Sasuke
...
// @downloadURL https://update.greasyfork.org/scripts/371592/AP%20Clan%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/371592/AP%20Clan%20Script.meta.js
// ==/UserScript==
...
// Cosmetics //
///////////////
GM_addStyle('#logo {background-image: url("https://i.imgur.com/a2UkA8R.png");}');
...
$('#profile-clan-membership').text('ΛΡ遊 - AP Clan');
$(".main-bottom-left").append('<a id="APDiscord" href=" target="https://discord.gg/cjsUqt9"_blank">Discord</a>');
$("#umdiscord").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "aqua",
...
$("#main-content").append('<a id="trailyt" href="https://discord.gg/4qw3tH7" target="_blank">AP CLAN</a>');
$("#trailyt").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "red",
...
console.log("%cAP Clan Script is enabled. Message Sasuke (Sasuke#7237) if help needed.", "font-size: 25px; font-weight: bold; background: red; color: white; padding: 10px; border: solid 2px orange;");
