// ==UserScript==
// @name          RED Demotion Buffer Calculator
...
// @namespace     passtheheadphones.m
// @include       https://redacted.ch/*
// @downloadURL https://update.greasyfork.org/scripts/25301/RED%20Demotion%20Buffer%20Calculator.user.js
// @updateURL https://update.greasyfork.org/scripts/25301/RED%20Demotion%20Buffer%20Calculator.meta.js
// ==/UserScript==
...
function toBytes(amount) {
  ...
  if ( amount[1] == "KB" ) bytes *= KB;
  else if ( amount[1] == "MB" ) bytes *= MB;
  else if ( amount[1] == "GB" ) bytes *= GB;
  else if ( amount[1] == "TB" ) bytes *= TB;
  else if ( amount[1] == "PB" ) bytes *= PB;
