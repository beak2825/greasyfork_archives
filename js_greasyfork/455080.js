...
// @description  PSChina Server TranslationGEN1-9完整汉化
// @author       善安
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/455080/Showdown%EF%BC%81.user.js
// @updateURL https://update.greasyfork.org/scripts/455080/Showdown%EF%BC%81.meta.js
// ==/UserScript==
var translations = {
    ...
    "Evolves Charcadet into Armarouge when used..": "进化红莲铠骑",
    "Activates the Protosynthesis or Quark Drive Abilities. Single use.": "给特性为古代活性或夸克充能的宝可梦携带后激活特性",
    "Prevents other Pokemon from lowering the holder's stat stages.": "携带后不会因其他宝可梦的招式或特性而降低能力",
    "Holder's moves that hit 2-5 times hit 4-5 times; Population Bomb hits 4-10 times.": "连续攻击招式保底4次",
    "Evolves Charcadet into Ceruledge when used.": "进化苍炎刃鬼",
    "When an opposing Pokemon raises a stat stage, the holder copies it. Single use.": "在对手提高能力时有一次机会可以提高同样的能力",
