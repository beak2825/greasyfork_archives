// ==UserScript==
// @name         MiniCRM Megbízási szerződés Gomb
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  ProSec · Értékesítés > Megbízási szerződés
// @author       Vacsati
// @match        https://r3.minicrm.hu/20941/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/422146/MiniCRM%20Megb%C3%ADz%C3%A1si%20szerz%C5%91d%C3%A9s%20Gomb.user.js
// @updateURL https://update.greasyfork.org/scripts/422146/MiniCRM%20Megb%C3%ADz%C3%A1si%20szerz%C5%91d%C3%A9s%20Gomb.meta.js
// ==/UserScript==
...
(function() {
    ...
    function button_Creator() {
        ...
        var uri = window.location.href.split('/');
        var timer, max=20;
        var copy_Url = "https://www.prosec.hu/php/minicrm_megbizasi.php?q=form&pid="+uri[5];
        ...
        function create_copy_button(){
            ...
            var gomb = '<a href="'+copy_Url+'" target="_blank"><button type="button" class="btn btn-default btn-success btn-sm" style="min-width: 80px;;margin-bottom:4px;">Megbízási</button></a>';
