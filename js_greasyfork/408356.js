// ==UserScript==
// @name        [KissAnime] Beta6 Default Server
// @namespace   Mohamed
// @author      Mohamed
// @version     2020.08.06
// @icon        http://kissanime.ru/Content/images/favicon.ico
// @description Sets KissAnime/Beta6 Defaut player.
// @grant       none
// @include     *://kissanime.ru/anime/*
// @require     http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js
// @downloadURL https://update.greasyfork.org/scripts/408356/%5BKissAnime%5D%20Beta6%20Default%20Server.user.js
// @updateURL https://update.greasyfork.org/scripts/408356/%5BKissAnime%5D%20Beta6%20Default%20Server.meta.js
// ==/UserScript==

function main() {
    var updateLink = "&s=beta6";
    var $ = window.jQuery;
    var webLink = window.location.href;
    console.log(webLink);
    //kimcartoon
    if (webLink.indexOf("kissanime") > -1) {
        if (webLink.indexOf("&s=") > -1 && webLink.indexOf("&s=beta6") === -1) {
            window.stop();
            ...
            webLink = webLink.replace(currentServer, "&s=beta6");
