// ==UserScript==
// @name Krunker  cikanhook
// @description   cikanhook
// @version       0.1
// @author        cikan
// @supportURL    https://skidlamer.github.io/wp
// @homepage      https://skidlamer.github.io/
// @iconURL       https://i.imgur.com/p9rhhWK.png
// @match         *://krunker.io/*
...
// @grant         none
// @noframes
// @namespace https://greasyfork.org/users/777959
// @downloadURL https://update.greasyfork.org/scripts/427255/Krunker%20%20cikanhook.user.js
// @updateURL https://update.greasyfork.org/scripts/427255/Krunker%20%20cikanhook.meta.js
// ==/UserScript==
...
(function(dogStr, dog) {
        ...
        */
        ...
        initGUI() {
            function createButton(name, iconURL, fn) {
                ...
                menuItemIcon.style.backgroundImage = `url("https://krunker.io/img/guide/0.gif")`
    ...
    <img src="https://i.imgur.com/XKLreYE.png" width="90%">
<div class="imageButton discordSocial" onmouseenter="playTick()" onclick="openURL('https://discord.gg/ktreb9S8yV')"><span style='display:inline'></span></div>`
    ...
    // Tabs stuff
            const tabNames = ["Aim", "Visuals", "Shits", "Tweaks", "Movement", "Other"]
    if (dog.isClient) {
        tabNames.push("Client")
    }
    builder.style(`.cheatTabButton { color: black; background: #A200F6; padding: 2px 7px; font-size: 15px; cursor: pointer; text-align: center; } .cheatTabActive { background: #00BCD4;}`)
    ...
    tab(0, () => {
        ...
        builder.slider("Aim 523k", "aimbotRange", 0, 1000, 10, "Set above 0 to make the aimbot pick enemies only at the selected range")
        builder.slider("Aim smoothnes", "aim mooth", -4, 1, 0.1, "The lower it is, the lower the aimbot will shoot (0 - head, -4 - body)")
        ...
        builder.checkbox("super killer aim", "AImbot", "Makes the aimbot shoot at NPCs")
        ...
        builder.checkbox("wall shoot", "wall shoot", "Makes the aimbot shoot enemies behind walls")
        ...
        builder.checkbox("you no to reload after this", "you no to reload after this", "Automatically reloads your weapon when it's out of ammo")
        builder.checkbox("Prevent melee throwing", "preventMeleeThrowing", "Prevents you from throwing your knife")
        //builder.checkbox("swap when out of ammo", ""swap when out of ammo", "Automatically swaps the weapon when you're out of ammo")
    })

    tab(1, () => {
        builder.select("ESP Electronic Stability Program [H]", "esp", {
            "None": 0,
            "Nametags": 1,
            "Box ESP": 2,
            "Full ESP": 3,
        })
        builder.select("ESP Electronic Stability ProgramFont Size", "espFontSize", {
            "30px": 999999,
            "25px": 25,
            "20px": 20,
            "15px": 15,
