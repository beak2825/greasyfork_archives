// ==UserScript==
// @name         重庆理工大学新版正方教务系统导出课程表
// @namespace    https://github.com/31415926535x/CollegeProjectBackup/tree/master/ZhengfangClassScheduleToICS
// @version      1.03
// @description  对新版正方教务系统课表页面进行解析，导出ics日历文件（可对 ``include`` 进行一定的修改以适用不同的学校的链接）
// @author       小腾、 (修改自 31415926535x、dml19 )
// @supportURL   https://github.com/31415926535x/CollegeProjectBackup/blob/master/ZhengfangClassScheduleToICS/Readme.md
// @compatible   chrome
// @compatible   firefox
// @license      MIT
// @include      *://jwxt.*.edu.cn/*
// @include      *://jwxt.cqut.edu.cn/*
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/440482/%E9%87%8D%E5%BA%86%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%E6%96%B0%E7%89%88%E6%AD%A3%E6%96%B9%E6%95%99%E5%8A%A1%E7%B3%BB%E7%BB%9F%E5%AF%BC%E5%87%BA%E8%AF%BE%E7%A8%8B%E8%A1%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/440482/%E9%87%8D%E5%BA%86%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%E6%96%B0%E7%89%88%E6%AD%A3%E6%96%B9%E6%95%99%E5%8A%A1%E7%B3%BB%E7%BB%9F%E5%AF%BC%E5%87%BA%E8%AF%BE%E7%A8%8B%E8%A1%A8.meta.js
// ==/UserScript==

// 学期周数 默认为20
var weeks = 20

// 作息时间表(花溪校区)，如有不同可自行增删
var classtime = {
    '1': { 'start': '0820', 'end': '0905' },
    '2': { 'start': '0915', 'end': '1000' },
    '3': { 'start': '1020', 'end': '1105' },
    '4': { 'start': '1115', 'end': '1200' },
    '5': { 'start': '1400', 'end': '1445' },
    '6': { 'start': '1455', 'end': '1540' },
    '7': { 'start': '1600', 'end': '1645' },
    '8': { 'start': '1655', 'end': '1740' },
    '9': { 'start': '1900', 'end': '1945' },
    '10': { 'start': '1950', 'end': '2035' }
};
// 学校教务系统的网址，对于新版教务系统的地址基本一样的，主要需修改上面 include中的教务系统的地址
...
function ClassScheduleToICS() {
    ...
    // --------------------------------------------------------------------------
    // 通过节次确定时间， 默认每天上午8点20上课，每小节课45分钟，一大节100分钟（含休息时间），下午2点上课
