...
// @version     1.3.11
// @downloadURL https://update.greasyfork.org/scripts/376125/GN_CommonValuesFiller.user.js
// @updateURL https://update.greasyfork.org/scripts/376125/GN_CommonValuesFiller.meta.js
// ==/UserScript==
...
var artefacts = [
  ...
  new Artefact('pn_ring1', 'Кольцо пирата-капитана', 15, 1, 13, 20000, enum_ac.event, enum_at.jewelry, enum_as.ring, enum_amc.ring, { attack: 2, defence: 5, spellpower: 3, knowledge: 2, initiative: 2 }, enum_aset.pirate),
  new Artefact('p_pistol1', 'Пистолет пирата-капитана', 15, 1, 15, 20000, enum_ac.event, enum_at.weapon, enum_as.right_arm, enum_amc.weapon, { attack: 7, spellpower: 1, knowledge: 1, initiative: 5 }, { increase_range_combat_damage: 12 }, enum_aset.pirate),  
  ...
  // event -> robber
  new Artefact('rhelm1', 'Шлем разбойника', 13, 1, 12, 16000, enum_ac.event, enum_at.armor, enum_as.head, enum_amc.helm, { attack:1, defence: 3, initiative: 3}, { magic_protection: 12, range_combat_protection: 10, close_combat_protection: 8}, enum_aset.robber),
  new Artefact ('rbow2', 'Простой лук разбойника', 5, 1, 6, 8000, enum_ac.event, enum_at.weapon, enum_as.rear, enum_amc.weapon, {attack: 1, iniative: 1}, {increase_range_combat_damage: 12 }, enum_aset.robber),
  new Artefact ('rbow1', 'Лук разбойника', 13, 1, 8, 16000, enum_ac.event, enum_at.weapon, enum_as.rear, enum_amc.weapon, {attack: 1, iniative: 2}, {increase_range_combat_damage: 16 }, enum_aset.robber),
