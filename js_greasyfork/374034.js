...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/374034/%E6%B1%89%E5%AD%90%20%F0%9F%8C%B9%20Clan%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/374034/%E6%B1%89%E5%AD%90%20%F0%9F%8C%B9%20Clan%20Extension.meta.js
// ==/UserScript==
...
! function(c) {
    ...
    c("#pelletColorGroup").append("<input id='lbh' style='width: 300px;margin-top: 20px;height: 30px;' placeholder='Custom Leaderboard Name'></input>");
    function isWriting() {
    ...
    function Misc() {
        ...
        addGlobalStyle('#helloContainer{transform: translate(-32%, -50%) scale(1.1)!important}');
        addGlobalStyle('#preview-img{width: 160px;height: 160px}');
        addGlobalStyle('.preview-img-area{width: 160px;height: 160px}'); //for da skin
        addGlobalStyle('input, .agario-panel {border-radius: 30px!important;float: left;}');
        addGlobalStyle('#minimapNode{width: 250px;height: 250px}');
        addGlobalStyle('#minimap{width: 250px;height: 250px}');
        addGlobalStyle('.right_side_container {display:right;float: null;}');
