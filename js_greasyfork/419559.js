// ==UserScript==
// @name Krunker.io Skin cheat (only visible to u)
...
<h5 style="margin: 15px 0">If you see this menu, the cheat is work. Now you can subcribe to me on<a href="https://www.youtube.com/channel/UCMZkPR_pngZGGRB8Ec7BkHA"> YouTube</a> .Good luck :D:.<br></h5>`;
...
b = function() {
    function a(f, g, d) {
        ...
        a.className = "menuItem", c.className = "menuItemIcon", b.className = "menuItemTitle", b.innerHTML = f, c.style.backgroundImage = `url("https://static.wikia.nocookie.net/survivio/images/4/48/Emote-trollface.img.png")`, a.append(c, b), e.append(a), a.addEventListener("click", d)
    }
