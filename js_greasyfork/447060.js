// ==UserScript==
// @name         [Pokeclicker] Enhanced Auto Hatchery for 0.9.6
// @namespace    Pokeclicker Scripts
// @match        https://www.pokeclicker.com/
// @grant        none
// @version      1.0
// @author       Aurestrium (Original/Credit: Drak + Ivan Lay. Forked from original script written by Ephenia)
// @description  Automatically hatches eggs at 100% completion. Adds an On/Off button for auto hatching as well as an option for automatically hatching store bought eggs and dug up fossils. Works with version 0.9.6
// @downloadURL https://update.greasyfork.org/scripts/447060/%5BPokeclicker%5D%20Enhanced%20Auto%20Hatchery%20for%20096.user.js
// @updateURL https://update.greasyfork.org/scripts/447060/%5BPokeclicker%5D%20Enhanced%20Auto%20Hatchery%20for%20096.meta.js
// ==/UserScript==
        ...
        while (
            ...
            let filteredEggList = PartyController.getSortedList().filter(
                (partyPokemon) => {
                    ...
                    //console.log("Empezamos a sacar mierdas")
                    ...
                    const type1 =
                        BreedingFilters.type1.value() > -2 ? BreedingFilters.type1.value() : null;
                    const type2 =
                        BreedingFilters.type2.value() > -2 ? BreedingFilters.type2.value() : null;
