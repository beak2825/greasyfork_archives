...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/457413/Google%20Knowledge%20Graph%20ID.user.js
// @updateURL https://update.greasyfork.org/scripts/457413/Google%20Knowledge%20Graph%20ID.meta.js
// ==/UserScript==

async function processEl(kpActionEl) {
...
window.addEventListener('load', async () => {
    let kpActionEls = document.querySelectorAll('[class*="kp-"] > :first-child');

    [...kpActionEls].forEach(processEl);
});