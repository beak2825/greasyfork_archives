...
// @grant        none
// @license      TANGMING
// @downloadURL https://update.greasyfork.org/scripts/534620/bcs%E4%B8%8A%E6%9E%B6%E6%8F%92%E4%BB%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/534620/bcs%E4%B8%8A%E6%9E%B6%E6%8F%92%E4%BB%B6.meta.js
// ==/UserScript==
function sleep(ms) {
...
// 添加按钮到页面
        ...
        async function fetchShops() {
            try {
                ...
                const res = await fetch("https://www.bcsozon.com/prod-api/system/ozonShop/ozon/list", {
                    headers: {
        ...
        async function extractCheckedRows() {
            ...
            try {
                // 获取仓库 ID
                const res = await fetch("https://www.bcsozon.com/prod-api/system/ozonRecord/warehouse", {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        "accept": "application/json, text/plain, */*",
                ...
                // 获取用户名
                const profile_res = await fetch("https://www.bcsozon.com/prod-api/system/user/profile", {
                    method: "GET",
                    credentials: "include",
                    headers: {
                        "authorization": "Bearer " + token
                ...
                for (const checkbox of checkboxes) {
                    ...
                    try {
                        const catRes = await fetch("https://www.bcsozon.com/prod-api/system/ozonRecord/getCategoryId", {
                            method: "POST",
                            credentials: "include",
                            headers: {
                                "authorization": "Bearer " + token,
                        ...
                        // 添加商品
                        const addRes = await fetch("https://www.bcsozon.com/prod-api/system/ozonRecord/ht/user/add", {
                            method: "POST",
                            credentials: "include",
                            headers: {
                                "authorization": "Bearer " + token,
                ...
                setTimeout(async () => {
                    const ofprid_list = []
                    fetch("https://www.bcsozon.com/prod-api/system/ozonRecord/fixOzonStatus", {
                        method: "GET",
                        credentials: "include",
                        headers: {
                            "authorization": "Bearer " + token
                    ...
                    for (let i = 0; i < sku_list.length; i++) {
                        const prodRes = await fetch(`https://www.bcsozon.com/prod-api/system/ozonRecord/ozon/list?pageNum=1&pageSize=10&username=${userName}&sku=${sku_list[i]}`, {
                            method: "GET",
                            credentials: "include",
                            headers: {
                                "authorization": "Bearer " + token
                    ...
                    await sleep(3000)
                    fetch("https://www.bcsozon.com/prod-api/system/ozonRecord/pl/add/stocks", {
                        method: "POST",
                        credentials: "include",
                        headers: {
                            "authorization": "Bearer " + token,
