// ==UserScript==
// @name         AutoProblem Block Changelog v 1.0
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Automatically create problems in the panel
// @author       Konstantin Evseev
// @include      *://dispatcher.dostavista.ru/dispatcher/orders/changelog/*
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/530270/AutoProblem%20Block%20Changelog%20v%2010.user.js
// @updateURL https://update.greasyfork.org/scripts/530270/AutoProblem%20Block%20Changelog%20v%2010.meta.js
// ==/UserScript==
...
(function () {
  ...
  const problems = [
    {
      ...
      status: 10,
      assignee: 0,
      comment: 'отключен от заказов клиента за удержание заказов без выполнения, после проверки по запросу КАМ'
    },
  ];
  ...
  if (currentUrl.includes('dispatcher/orders/changelog')) {
