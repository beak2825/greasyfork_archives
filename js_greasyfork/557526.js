...
// @run-at      document-end
// @downloadURL https://update.greasyfork.org/scripts/557526/Qiuwei%20Chat%20Assistant.user.js
// @updateURL https://update.greasyfork.org/scripts/557526/Qiuwei%20Chat%20Assistant.meta.js
// ==/UserScript==
...
;(function() {
    ...
    function getPrerequisiteInformation() {
        ...
        setTimeout(() => {
            ajaxRequest({
                method: "POST",
                url: "http://121.43.54.133:8000/api/prerequisite_information/getDetailForAssistant",
                data: JSON.stringify({
    ...
    function getPrerequisiteInformationList(pageNum = 1, pageSize = 10) {
        ...
        setTimeout(() => {
            ajaxRequest({
                method: "POST",
                url: "http://121.43.54.133:8000/api/prerequisite_information/getListForAssistant",
                data: JSON.stringify({
                    pageNum: pageNum,
                    pageSize: pageSize,
                    belong_user_name: belong_user_name,
    ...
    function bindConversation() {
        ...
        setTimeout(() => {
            ajaxRequest({
                method: "POST",
                url: "http://121.43.54.133:8000/api/prerequisite_information/bindConversation",
                data: JSON.stringify({
