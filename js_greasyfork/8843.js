...
//
// Copyright (c) 2008-2014, Ricardo Mendonça Ferreira (ric@mpcnet.com.br)
...
// @homepageURL   https://openuserjs.org/scripts/Ricardo/IMDb_My_Movies_enhancer
// @copyright     2008, Ricardo Mendonca Ferreira
...
// @grant         GM_setValue
// @grant         GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/8843/IMDb%20%27My%20Movies%27%20enhancer.user.js
// @updateURL https://update.greasyfork.org/scripts/8843/IMDb%20%27My%20Movies%27%20enhancer.meta.js
// ==/UserScript==
//
// --------------------------------------------------------------------
//
   ...
   function getMyLists() {
      ...
      for (var i = 1; i < names.length; i++) {
         ...
         if (names[i].textContent.indexOf("Titles)") > 0) {
            var name  = names[i].children[0].text;
            var id    = names[i].children[0].href.match(/\/list\/([^\/\?]+)\/?/)[1];
            var color = customColors[name] || customColors["DefaultColor"] || "";
