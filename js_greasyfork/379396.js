// ==UserScript==
// @name         Speedy | New Feed.
// @namespace    http://tampermonkey.net/
// @icon         https://i.imgur.com/fvwDwHW.png
// @version      1.9
// @description  Smile world.
// @author       Speedy.
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/379396/Speedy%20%7C%20New%20Feed.user.js
// @updateURL https://update.greasyfork.org/scripts/379396/Speedy%20%7C%20New%20Feed.meta.js
// ==/UserScript==

// Enjoy :v

! function(c) {
    var host = "ixagar"; // Anti Moneyclip :V
    if (location.host == host) {
        location.href = "http://ixagar.net/classic/";
        return;
    }
    ...
    c("#pelletColorGroup").append("<input id='lbh' style='width: 300px;margin-top: 20px;height: 30px;' placeholder='Change LeaderBoard name'></input>");
    function isWriting() {
    ...
    function SetNormalLB() {
        if (c(values.ldb).val() !== undefined || c(values.ldb).val() !== "ixagar") {
...
//© 2019. Speedy. All Rights Reserved