// ==UserScript==
// @name         Для крутышей с 11 / By K. Stoyn
...
// @icon https://i.postimg.cc/P5Ckff18/68a2c7ce9ff4a0564fc872ff64208953.jpg
// @downloadURL https://update.greasyfork.org/scripts/532812/%D0%94%D0%BB%D1%8F%20%D0%BA%D1%80%D1%83%D1%82%D1%8B%D1%88%D0%B5%D0%B9%20%D1%81%2011%20%20By%20K%20Stoyn.user.js
// @updateURL https://update.greasyfork.org/scripts/532812/%D0%94%D0%BB%D1%8F%20%D0%BA%D1%80%D1%83%D1%82%D1%8B%D1%88%D0%B5%D0%B9%20%D1%81%2011%20%20By%20K%20Stoyn.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
	  title: 'Жб не по форме',
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано. Закрыто.<br>Приятной игры на сервере INDIGO![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	...
	},
    {
	  ...
	  content:
		...
		'[B][CENTER][COLOR=red][ICODE]Закрыто.<br>Приятной игры на сервере INDIGO![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	...
	},
{
    ...
    },
    {
	  ...
	  content:
		...
		'[B][CENTER][COLOR=GREEN][ICODE]Одобрено. Закрыто.<br>Приятной игры на сервере INDIGO![/ICODE][/COLOR][/CENTER][/B]',
	...
	},
    {
     title: 'перемещение в жб на лд',
	  content:
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано.<br>Приятной игры на сервере INDIGO![/ICODE][/COLOR][/CENTER][/B]',
	...
	},
    {
	  ...
	  content:
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=YELLOW][ICODE]На рассмотрении.<br>Приятной игры на сервере INDIGO![/ICODE][/COLOR][/CENTER][/B]',
...
if(prefix == TRANSFER_PREFIX_TR49) {
				moveThread(prefix, 1192); // в жб на техов
			}
if(prefix == TRANSFER_PREFIX_OBJ49) {
				moveThread(prefix, 520); //  в обж
			}
if(prefix == TRANSFER_PREFIX_ADM49) {
				moveThread(prefix, 517); //  в жб на адм
			}
if(prefix == TRANSFER_PREFIX_LD49) {
				moveThread(prefix, 518); //  в жб на лд
			}
if(prefix == TRANSFER_PREFIX_PLAYER49) {
				moveThread(prefix, 519); // в жб на игроков
			}
}
}
