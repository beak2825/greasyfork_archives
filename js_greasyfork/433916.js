...
(function() {
  ...
  function chnToPy(l1) {
    ...
    const I10useful = I1[0] !== undefined
    const I11useful = I1[1] !== undefined
    
    if (I11useful && I10useful) {
      I1[0] = I1[0].replace(/ /g, '-');
      I1[1] = I1[1].replace(/ /g, '-');
  ...
  function ucfirst(l1) {
    if (l1.length > 0) {
      ...
      var spare = "";
      return [first + spare, first_full + spare];
    }
  }
      ...
      Defaults.prototype.reset = function () {
        ...
        function matcher (params, data) {
          ...
          if (stripDiacritics(data.text).toPinYin != undefined) {
            ...
            console.error('method toPinYin doesnt exist')
          }
