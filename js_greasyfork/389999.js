...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/389999/ASITI%20History.user.js
// @updateURL https://update.greasyfork.org/scripts/389999/ASITI%20History.meta.js
// ==/UserScript==
...
(function() {
    ...
    function showTraining(training) {
        ...
        row.innerHTML = `<th>Training</th><td>${training ? training.split('').join(' ') : '-'}</td>`;
