...
// @downloadURL https://update.greasyfork.org/scripts/421913/HWM-UI-UX-MOD.user.js
// @updateURL https://update.greasyfork.org/scripts/421913/HWM-UI-UX-MOD.meta.js
// ==/UserScript==
    ...
    function showFactions() {
        ...
        allClasses.forEach((clazz, index) => {
            let factionIcon = `<div id="fc${index}">
									<img class="faction-icon" src="https://dcdn.heroeswm.ru/i/f/${allClasses[index][3]}?v=1.1" alt="${allClasses[index][1]}">
								</div>`
...
<!--            <img height="70px" src="https://i.imgur.com/oqyVp7G.png">-->
    ...
    function getAllTexts() {
        ...
        texts.addText(new LocalizedText("MenuMap", "Map", "Карта", "Мапа"))
        ...
        texts.addText(new LocalizedText("myself", "Myself", "Я", "Я"))
