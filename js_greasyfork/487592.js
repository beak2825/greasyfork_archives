// ==UserScript==
// @name        Wall Battlestats (NPO Version)
// @namespace   seintz.torn.wall-battlestats
// @version     1.71.1
// @description show tornstats spies on faction wall page
// @author      finally [2060206], seintz [2460991], colors added by Entropi [2486892]
// @license     GNU GPLv3
// @run-at      document-end
...
// @downloadURL https://update.greasyfork.org/scripts/487592/Wall%20Battlestats%20%28NPO%20Version%29.user.js
// @updateURL https://update.greasyfork.org/scripts/487592/Wall%20Battlestats%20%28NPO%20Version%29.meta.js
// ==/UserScript==
...
function updateStats(id, node, parentNode) {
    ...
    for (let i = 0; i < stats.length; i++) {
        ...
        if (i === 0) {
            ...
            if (difference > 180 * 24 * 60 * 60) {
                stale = 'text-decoration-line: line-through;';
            }

            stats[0] = `<span style='${color}${stale}'>${stats[i]}</span>`;
        }
    }
