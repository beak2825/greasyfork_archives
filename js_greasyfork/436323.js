...
(function () {
  ...
  function overrideSiteIcons() {
    ...
    console.log("[PKU Art] overrideSiteIcons() has been used at " + (/* @__PURE__ */ new Date()).toLocaleString());
    const replaceIcons = () => {
...
${downloadUrl}`);
  ...
  function restoreCourseQueryValues() {
    ...
    console.log("[PKU Art] restoreCourseQueryValues() has been used at " + (/* @__PURE__ */ new Date()).toLocaleString());
  ...
  function refactorCourseQueryPagination() {
    ...
    const refactor = () => {
      ...
      console.log("[PKU Art] refactorCourseQueryPagination() has been used at " + (/* @__PURE__ */ new Date()).toLocaleString());
