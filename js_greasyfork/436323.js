...
${downloadUrl}`);
  ...
  function refactorElectiveWorkPage() {
    if (!/^https:\/\/elective\.pku\.edu\.cn\/elective2008\/edu\/pku\/stu\/elective\/controller\/electiveWork\/(ElectiveWorkController\.jpf|election\.jsp)/.test(
      window.location.href
    )) {
      return;
    }
