...
var Bamboo = {
    ...
    **/
    ...
    initFunc(){
        var ulList;
        //定义播放速度列表
        var extSpeedArr = [0.8, 1, 1.25, 1.5,1.6,1.7,1.8,1.9, 2, ];
