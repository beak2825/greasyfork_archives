// ==UserScript==
// @name         Baidu Time Display Button
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Display current time on baidu.com with a big button
// @match        https://www.baidu.com/*
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/502204/Baidu%20Time%20Display%20Button.user.js
// @updateURL https://update.greasyfork.org/scripts/502204/Baidu%20Time%20Display%20Button.meta.js
// ==/UserScript==
...
(function() {
    ...
    function addTimeButton() {
        ...
        timeButton.style.backgroundColor = '#4e6ef2';  // Baidu blue
        ...
        timeDisplay.style.border = '2px solid #4e6ef2';
