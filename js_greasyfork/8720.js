...
// @icon        http://164.xkw.pw/1.ico
// @require     http://code.jquery.com/jquery-2.1.1.min.js
// @namespace   https://greasyfork.org/zh-CN/scripts/8720-tieba-insert-musiclink
// @version     1.0.4
// @grant hander
// @author	 zoohaveany(修改)
// @downloadURL https://update.greasyfork.org/scripts/8720/Tieba_Insert_MusicLink.user.js
// @updateURL https://update.greasyfork.org/scripts/8720/Tieba_Insert_MusicLink.meta.js
// ==/UserScript==

/***
2014年之前版本信息丢失，且本脚本真正的作者早已无更新
2014/6/1 修复火狐吧友说该脚本在chrome的浮动回帖框会出现两个插入框的问题
2015年000lgy修改
*/
//JQuery支持
$ = unsafeWindow.$;
...
function convertLinks() {
	...
	temp += 'src="http://tieba.baidu.com/tb/static-common/img/rich_editor/music.png" class="BDE_Music">';
