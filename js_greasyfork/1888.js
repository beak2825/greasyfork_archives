...
// @description  Améliore le moteur de recherche de la Cour de justice de l'Union européenne en ajoutant dans la liste des résultats une référence qui peut être directement utilisée (dans un article, des conclusions, etc.) et copiée dans le presse-papier.
// @version	       2.7
// @namespace      RJ
// @include        http://curia.europa.eu/juris/*
// @downloadURL https://update.greasyfork.org/scripts/1888/Cour%20de%20justice%20de%20l%27Union%20europ%C3%A9enne.user.js
// @updateURL https://update.greasyfork.org/scripts/1888/Cour%20de%20justice%20de%20l%27Union%20europ%C3%A9enne.meta.js
// ==/UserScript==
...
function ProcessSearch() {
    ...
    el.addEventListener("click", function() {
        ...
        document.getElementById("mainForm:matierePanel").getElementsByTagName("input")[0].click();
		window.setTimeout(function() {
            ...
            document.getElementsByClassName("dialog_footer")[1].getElementsByTagName("input")[0].click();
		}, 2000);
    }, false);
}
