...
// @downloadURL https://update.greasyfork.org/scripts/497627/%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE%2009.user.js
// @updateURL https://update.greasyfork.org/scripts/497627/%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE%2009.meta.js
// ==/UserScript==
...
(function () {
    ...
    content:
    '[SIZE=4][FONT=Courier New[CENTER]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба взята на рассмотрение[/Color]. Просьба не создавать подобных тем, иначе форумный аккаунт может быть заблокирован[/CENTER]<br><br>"+
    ...
    '[CENTER][Color=Orange]На рассмотрении.[/Color][/CENTER][/SIZE]',
    prefix: SA_PREFIX,
    status: true,
    },
    {
