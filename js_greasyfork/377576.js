...
// @downloadURL https://update.greasyfork.org/scripts/377576/4chan%20GET%20Modified%20fixed.user.js
// @updateURL https://update.greasyfork.org/scripts/377576/4chan%20GET%20Modified%20fixed.meta.js
// ==/UserScript==
...
function progress() {
    ...
    document.getElementsByName("getstatus")[0].innerHTML = "Waiting for: " + n + dots;
    }
...
document.getElementsByName("btqrpost")[0].addEventListener("click", function(e) {
    if (document.getElementById("qr")) {
        ...
        alert("4chan X Quick Reply is not Open");
}, false);
