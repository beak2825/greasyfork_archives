...
// @downloadURL https://update.greasyfork.org/scripts/549493/HUANGHUIXUE.user.js
// @updateURL https://update.greasyfork.org/scripts/549493/HUANGHUIXUE.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "ZHANG YIWEN";
    const NEW_NAME = "HUANG HUIXUE";
    const NEW_BIRTHDAY = "(**0113)";
    const NEW_EXPIRE_DATE = "2034-01-12";
