...
// @version      6.0
// @description  Специально для  CHilli.
// @author       Onix
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/494179/Chilli.user.js
// @updateURL https://update.greasyfork.org/scripts/494179/Chilli.meta.js
// ==/UserScript==
...
{
	  title: '| Отчёт следящего |',
	  content:
	 "[CENTER][COLOR=#8f3333]╭──── ➳༻❀✿❀༺➳ ────╮[/COLOR]<br>"+
   "[CENTER][COLOR=#8f3333][FONT=Times New Roman]1. Nick_Name:[/COLOR] [COLOR=#d44c4c] Artem_Truchachew.[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]2. Должность:[/COLOR] [COLOR=#d44c4c]Следящий Л ОПГ.[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]3. Ваша организация:[/COLOR] [COLOR=#d44c4c]Л ОПГ[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]4. Онлайн организации на протяжении всего дня [ /fonline]:[/COLOR] [COLOR=#d44c4c][url=https://cloud.mail.ru/public/tPgW/nPS1YMXUb]*Кликабельно*[/url](смотреть папку с сегодняшней датой)[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]5. Как вы взаимодействовали с фракцией:[/COLOR] [COLOR=#d44c4c]Чекал норму, следил за мс, за сс[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]6. Какие плюсы работы фракции:[/COLOR] [COLOR=#d44c4c]Большой онлайн[/FONT][/COLOR][/CENTER]<br>"+
          "[CENTER][COLOR=#8f3333][FONT=Times New Roman]7. Какие минусы работы фракции:[/COLOR] [COLOR=#d44c4c]Нету[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333]╰──── ➳༻❀✿❀༺➳ ────╯[/COLOR][/CENTER]<br>",
},
{
   ...
   "[CENTER][COLOR=#8f3333][FONT=Times New Roman]1. Nick_Name:[/COLOR] [COLOR=#d44c4c] Artem_Truchachew.[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]2. Должность:[/COLOR] [COLOR=#d44c4c]Следящий Л ОПГ.[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]3. За какой день подается отчёт:[/COLOR] [COLOR=#d44c4c]Сегодняшний.[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]4. Какая работа была проделана:[/COLOR] [COLOR=#d44c4c]Видно на скриншотах.[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]5. Скриншоты проделанной работы: [url=https://cloud.mail.ru/public/sKVq/QKNu9y4tj]*кликабельно*.[/url][COLOR=#d44c4c](смотреть папку с сегодняшней датой)[/FONT][/COLOR][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333]╰──── ➳༻❀✿❀༺➳ ────╯[/COLOR][/CENTER]<br>",
},
    {
	  title: '| Норма |',
   ...
   "[CENTER][COLOR=#8f3333][FONT=Times New Roman]1. Nick_Name:[/COLOR] [COLOR=#d44c4c] Artem_Truchachew.[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]2. Должность:[/COLOR] [COLOR=#d44c4c]Следящий Л ОПГ.[/FONT][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333][FONT=Times New Roman]3. Скриншот /astats: [url=https://cloud.mail.ru/public/vPgB/jMcrVkHNV]*кликабельно*.[/url][COLOR=#d44c4c](смотреть папку с сегодняшней датой)[/FONT]  [/COLOR][/COLOR][/CENTER]<br>"+
     "[CENTER][COLOR=#8f3333]╰──── ➳༻❀✿❀༺➳ ────╯[/COLOR][/CENTER]<br>",
},
{
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для криминальных организаций:<br><br>"+
                ...
                "[*][FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]Исключение: [/COLOR][COLOR=rgb(209, 213, 216)]территория проведения войны за бизнес, когда мероприятие не проходит[/COLOR][/SIZE][/FONT][/Spoiler][/CENTER][/B]<br><br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=crimson]CHILLI[/COLOR].<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/qqpxm7bR/download-2.gif[/img][/url]<br>",
	  prefix: ACCEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как с момента совершенного нарушения со стороны игрока прошло более 72 часов. Срок написания жалобы составляет три дня (72 часа) с момента совершенного нарушения со стороны игрока сервера.<br><br>"+
                ...
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=crimson]CHILLI[/COLOR].<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/4xbt01NG/download-5.gif[/img][/url]<br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
},
{
