...
// @downloadURL https://update.greasyfork.org/scripts/503601/BWP_PLUGIN.user.js
// @updateURL https://update.greasyfork.org/scripts/503601/BWP_PLUGIN.meta.js
// ==/UserScript==
...
function get_date() {
    ...
    if (day === '01') {
        if (month === '01') {
            ...
            firstDayOfMonth = (year - 1) + '-' + (month - 1).toString().padStart(2, '0') + '-01';
