// ==UserScript==
// @name         Ed Combined Hartmut Zabel
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/484471/Ed%20Combined%20Hartmut%20Zabel.user.js
// @updateURL https://update.greasyfork.org/scripts/484471/Ed%20Combined%20Hartmut%20Zabel.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var buchungTextsZahl = "180.680";
    var accountsecurity = "5423432 0196 20";
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10894543510") > 0 || window.location.href.indexOf("10733495263") > 0) {
...
//CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10894543786") > 0 ) {
