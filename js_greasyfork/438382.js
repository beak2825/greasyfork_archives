...
(function loop() {
    ...
    am.style.color = "#2A0";
    am.download = unsafeWindow?.__INITIAL_STATE__?.bvid + ".m4a";
    vm.download = unsafeWindow?.__INITIAL_STATE__?.bvid + ".m4v";
    var pdata = unsafeWindow?.__playinfo__?.data;
    ...
    var len = 0; //avc编码使用 let len = pddv?.length - pdata?.accept_quality?.length;
