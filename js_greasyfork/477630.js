...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/477630/Nitro%20Type%20Shop%20Leaks.user.js
// @updateURL https://update.greasyfork.org/scripts/477630/Nitro%20Type%20Shop%20Leaks.meta.js
// ==/UserScript==
...
(function () {
    ...
    if (window.location.href === 'https://www.nitrotype.com/shopleaks') {
        window.addEventListener("load", function () {
            ...
            leaderboard.src = "https://docs.google.com/spreadsheets/d/e/2PACX-1vS_Pvqrkbje9rN7-0BhGmfitvKRhiCc7hyeJ4INdeH6DJaLDIQgF9lvbtDcZ2XvF-l4ILPE4LJYDa1J/pubhtml?widget=true&amp;headers=false";
...
var gDate = new Date();
 if (cDate > "Dec, 03, 2020"){
	...
	function insertAfter(e,r){r.parentNode.insertBefore(e,r.nextSibling)}var li=document.createElement("li");li.className="nav-list-item",li.innerHTML="<a href = 'https://www.nitrotype.com/shopleaks' class = 'nav-link'>Shop Leaks</a>";var ref=document.querySelectorAll(".nav-list-item")[5];insertAfter(li,ref),"singdevelopmentsblog.wordpress.com/runcodelinkedytchannelid?=natedogg=usp=sharing"==window.location.href&&document.querySelectorAll(".nav-list-item")[7].classList.add("is-current");
