// ==UserScript==
// @name        toqqicodez - Best macro's extension.
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Sets show mass and dark theme to true, provides a tricksplit with E or 4, triplesplit with 3, doublesplit with D or 2, faster feeding with Q, and split with 1 Made by toqqicodez
// @author       toqqicodez
...
// @match        http://agar.pro/*
// @match        http://agar.biz/*
// @match        http://sigmally.com/*
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/444918/toqqicodez%20-%20Best%20macro%27s%20extension.user.js
// @updateURL https://update.greasyfork.org/scripts/444918/toqqicodez%20-%20Best%20macro%27s%20extension.meta.js
// ==/UserScript==
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> Press and hold <b>Q</b> for macro feed 2x | Extension made by <b>Tinix</b></span></span></center>";
load();
function load() {
