// ==UserScript==
// @name           ICEbot v4 افتارات مختلفة  websocket
...
// @downloadURL https://update.greasyfork.org/scripts/503892/ICEbot%20v4%20%D8%A7%D9%81%D8%AA%D8%A7%D8%B1%D8%A7%D8%AA%20%D9%85%D8%AE%D8%AA%D9%84%D9%81%D8%A9%20%20websocket.user.js
// @updateURL https://update.greasyfork.org/scripts/503892/ICEbot%20v4%20%D8%A7%D9%81%D8%AA%D8%A7%D8%B1%D8%A7%D8%AA%20%D9%85%D8%AE%D8%AA%D9%84%D9%81%D8%A9%20%20websocket.meta.js
// ==/UserScript==
...
if (botnick === '0') {
    ws.send('42[3,{"v":20000,"nick":"' + rnext(nick) + '","avatar":' + Math.floor(Math.random() * numAvatars + 1) + ',"platform":0,"sala":"' + room.substring(2) + '"}]');
} else if (botnick === '1') {
    ws.send('42[3,{"v":20000,"nick":"' + nick + Math.floor(Math.random() * numAvatars + 1) + '","avatar":' + Math.floor(Math.random() * numAvatars + 1) + ',"platform":0,"sala":"' + room.substring(2) + '"}]');
}
                        clearInterval(inter)
                    }
                },50)
