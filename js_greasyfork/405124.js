...
// @version             12.1
// @run-at              document-end
// @downloadURL https://update.greasyfork.org/scripts/405124/Maximize%20Video.user.js
// @updateURL https://update.greasyfork.org/scripts/405124/Maximize%20Video.meta.js
// ==/UserScript==
...
;(() => {
  ...
  const handle = {
    ...
    hotKey(e) {
      ...
      if (e.keyCode == 27) {
        maximize.playerControl()
        var black=document.createElement("div");//添加遮挡
        black.id="black_top"
        //black.style="background-color:black;width:100%;height:60px;z-index:999999;position:absolute;top:0px;";
    ...
    if (getComputedStyle(gv.controlBtn).position != "fixed") {
      tool.addStyle(
        [
          ...
          "#htmlToothbrush #bodyToothbrush .parentToothbrush {overflow:visible !important;z-index:888888 !important;transform:none !important;-webkit-transform-style:flat !important;transition:none !important;contain:none !important;}",
