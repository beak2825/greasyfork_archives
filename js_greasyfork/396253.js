...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/396253/AmazonBot.user.js
// @updateURL https://update.greasyfork.org/scripts/396253/AmazonBot.meta.js
// ==/UserScript==
...
(async function () {
    ...
    if (current_url.match('/signin*') !== null) {
        ...
        let product_id = current_url.substring(36, 46)
        // When out of stock
