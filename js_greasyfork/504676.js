// ==UserScript==
// @name         Скрипт для заявок | VOLGOGRAD
...
const buttons = [
	...
	content:
	'[CENTER][SIZE=14][FONT=Verdana][COLOR=RED]Здравствуйте, уважаемые игроки.<br><br>' +
	'Список допущенных к обзвону: [/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
    '[CENTER][SIZE=4][FONT=Verdana][COLOR=WHITE]Ник. [/FONT][/SIZE][/COLOR][/CENTER]<br>' +
    '[CENTER][SIZE=4][FONT=Verdana][COLOR=WHITE]Ник. [/FONT][/SIZE][/COLOR][/CENTER]<br>' +
    '[CENTER][SIZE=4][FONT=Verdana][COLOR=WHITE]Ник. [/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
    '[CENTER][SIZE=14][FONT=Verdana][COLOR=RED]Список отказанных заявок: [/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
    '[CENTER][SIZE=4][FONT=Verdana][COLOR=WHITE]Ник. [/FONT][/SIZE][/COLOR][/CENTER]<br>' +
    '[CENTER][SIZE=4][FONT=Verdana][COLOR=WHITE]Ник. [/FONT][/SIZE][/COLOR][/CENTER]<br>' +
    '[CENTER][SIZE=4][FONT=Verdana][COLOR=WHITE]Ник. [/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
    "[CENTER][SIZE=4][FONT=Verdana][COLOR=WHITE]Обзвон состоится день.месяц.год в хх:хх по МСК в официальном Discord канале BLACK RUSSIA VOLGOGRAD - [URL='https://discord.com/invite/tuTmvDK38A']Клик[/URL].<br><br>" +
        	'Приятной игры на сервере VOLGOGRAD.[/FONT][/SIZE][/COLOR][/CENTER]',
        ...
        },
{
	...
	content:
	'[CENTER][SIZE=14][FONT=Verdana][COLOR=RED]Здравствуйте, уважаемые игроки.<br><br>' +
	'Заявки закрыты на рассмотрение. [/FONT][/SIZE][/COLOR][/CENTER]',
    	prefix: PIN_PREFIX,
	status: true,
 },
];
