// ==UserScript==
// @name         Hide Non Weather Report Posts from Havel
// @namespace    http://tampermonkey.net/
// @version      2.2
// @description  Hide posts within אייוועלט בולעטין that's not containing hurricane-related texts and allow them to be toggled
// @author       יעקב פריינד (obviously credit for the one and only @Knaper Yaden)
// @match        *://*.ivelt.com/forum/viewtopic.php*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/512041/Hide%20Non%20Weather%20Report%20Posts%20from%20Havel.user.js
// @updateURL https://update.greasyfork.org/scripts/512041/Hide%20Non%20Weather%20Report%20Posts%20from%20Havel.meta.js
// ==/UserScript==
...
(function() {
    ...
    const wordsToMatch = ['ההה"ה','וועטער'];

    // Function to check if the page meets the specific condition
    function isTargetPage() {
        const topicTitleLink = document.querySelector('h2.topic-title a[href*="./viewtopic.php?t=67134"]');
    ...
    function hidePosts() {
        ...
        posts.forEach(post => {
            ...
            if (!wordsToMatch.some(word => postText.includes(word))) {
                ...
                messageText.innerText = 'נישט קיין האריקען באריכט באהאלטן - ';
