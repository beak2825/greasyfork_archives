...
// @downloadURL https://update.greasyfork.org/scripts/553657/TimerHooker%202026.user.js
// @updateURL https://update.greasyfork.org/scripts/553657/TimerHooker%202026.meta.js
// ==/UserScript==
/**
 * ---------------------------
    ...
    var helper = function (eHookContext, timerContext, util) {
        return {
            applyUI: function () {
                ...
                // Build DOM safely to satisfy Trusted Types policies
                var container = document.createElement('div');
                container.className = '_th-container';
                var input = document.createElement('div');
                input.className = '_th-click-hover _item-input';
                input.textContent = 'x' + displayNum;
                container.appendChild(input);
                var item_x2 = document.createElement('div');
                item_x2.className = '_th-item _item-x2';
                item_x2.textContent = '>';
                container.appendChild(item_x2);
                var item_x_2 = document.createElement('div');
                item_x_2.className = '_th-item _item-x-2';
                item_x_2.textContent = '<';
                container.appendChild(item_x_2);
                var item_xx2 = document.createElement('div');
                item_xx2.className = '_th-item _item-xx2';
                item_xx2.textContent = '>>';
                container.appendChild(item_xx2);
                var item_xx_2 = document.createElement('div');
                item_xx_2.className = '_th-item _item-xx-2';
                item_xx_2.textContent = '<<';
                container.appendChild(item_xx_2);
                var item_reset = document.createElement('div');
                item_reset.className = '_th-item _item-reset';
                item_reset.textContent = 'O';
                container.appendChild(item_reset);

                var cover = document.createElement('div');
                cover.className = '_th_cover-all-show-times _th_hidden';
                var times = document.createElement('div');
                times.className = '_th_times';
                times.textContent = 'x' + displayNum;
                cover.appendChild(times);
            ...
            var timerHooker = {
                ...
                init: function () {
                    ...
                    if (!normalUtil.isInIframe()) {
                        ...
                        this.ensureUIAlive();
                        this._setInterval.call(window, this.ensureUIAlive.bind(this), 1500);
                        window.addEventListener('yt-navigate-finish', this.ensureUIAlive.bind(this));
                        window.addEventListener('spfdone', this.ensureUIAlive.bind(this));
                    } else {
                    ...
                    this.observeMedia();
                    this._setInterval.call(window, this.observeMedia.bind(this), this.videoSpeedInterval);
                },
                /**
                ...
                ensureUIAlive: function () {
                    var n = document.querySelector('._th-container');
                    if (!n) {
