// ==UserScript==
// @name         Grant's заявки на должности.
...
// @downloadURL https://update.greasyfork.org/scripts/493108/Grant%27s%20%D0%B7%D0%B0%D1%8F%D0%B2%D0%BA%D0%B8%20%D0%BD%D0%B0%20%D0%B4%D0%BE%D0%BB%D0%B6%D0%BD%D0%BE%D1%81%D1%82%D0%B8.user.js
// @updateURL https://update.greasyfork.org/scripts/493108/Grant%27s%20%D0%B7%D0%B0%D1%8F%D0%B2%D0%BA%D0%B8%20%D0%BD%D0%B0%20%D0%B4%D0%BE%D0%BB%D0%B6%D0%BD%D0%BE%D1%81%D1%82%D0%B8.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        {
            title: 'Закрытие заявок на лидера.',
            content:
            '[CENTER][B][COLOR=rgb(247, 218, 100)]Доброго времени суток.[/COLOR]<br><br>' +
            'Список одобренных и отказанных кандидатов на должность лидера "[COLOR=rgb(247, 218, 100)]организация[/COLOR]"<br>' +
            '[COLOR=rgb(97, 189, 109)]Одобренные:[/COLOR]<br><br><br>' +
            '[COLOR=rgb(226, 80, 65)]Отказанные:[/COLOR]<br><br><br>' +
            'Те люди, которые были одобрены в кандидаты на пост лидера, отпишите Главным Следящим, если они этого ещё не сделали. Контакты в 1 теме.<br><br>' +
            '[COLOR=rgb(226, 80, 65)]Закрыто.[/COLOR][/B][/CENTER]',
        ...
        },
        {
            ...
            "[CENTER][B][SIZE=4]Дублирование предыдущей темы.<br>При повторном дублировании ваш форумный аккаунт может быть заблокирован.[/SIZE][/B]<br><br>" +
        ...
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]В вашей теме доказательства не рабочие.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        ...
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Неправильно написан ваш ник/ник администратора. Либо ник во все отсутсвует.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Неправильно написан ваш ник/ник другого игрока. Либо ник во все отсутсвует.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        ...
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Не по форме. Обжалование рассмотрению не подлежит.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        ...
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Иследуя ваш форумный аккаунт не увидел вашу жалобу на данного игрока. Не пытайтесь обмануть администрацию.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        ...
        },
        {
            ...
            content:
            '[CENTER][B][SIZE=4][COLOR=rgb(247, 218, 100)]Доброго времени суток.[/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Ваше обжалование было передано [COLOR=blue]Руководителю Модераторов дискорда.[/COLOR][/SIZE][/B]<br><br>" +
            '[COLOR=rgb(243, 121, 52)][B]На рассмотрении.[/COLOR]',
            prefix: PINN_PREFIX,
            status: true,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        ...
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Если вы не согласны с наказанием выданым администратором - обратитесь в раздел жалоб на администрацию.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Раздел не предназначен для подобных тем - обратитесь в жалобы на игроков.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Данный игрок является лидером какой-либо фракции - обратитесь в жалобы на лидеров.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
        },
        {
            ...
            content:
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Обратитесь в обжалование наказаний.[/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
