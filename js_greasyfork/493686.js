...
// @downloadURL https://update.greasyfork.org/scripts/493686/Z-PAR-%E6%97%A7-shop-yes.user.js
// @updateURL https://update.greasyfork.org/scripts/493686/Z-PAR-%E6%97%A7-shop-yes.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    function checkTriggerElement() {
        var triggerElementXpath = 'id("app")/DIV[1]/DIV[3]/SECTION[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/DIV[1]/TABLE[1]/TBODY[1]/TR[1]/TD[1]/DIV[1]/SPAN[2]';
        ...
        if (triggerElement) {
            ...
            if (isClickCompleted) {
                // 随机生成3到6秒的延迟
                var randomDelay = Math.floor(Math.random() * (7000 - 4000 + 1)) + 4000;
