...
// @match        https://bitcosite.com/faucet/
// @match        https://acryptominer.io/user/faucet
// @match        https://freecryptoss.com/faucet
...
// @match        https://coinpayufree.com/faucet
// @match        https://bitupdate.info/faucet/
// @match        https://bitupdate.info/madfaucet/
// @match        https://faucetearning.com/faucet
...
// @downloadURL https://update.greasyfork.org/scripts/520753/AB%20Links%20Solver.user.js
// @updateURL https://update.greasyfork.org/scripts/520753/AB%20Links%20Solver.meta.js
// ==/UserScript==
...
(function() {
    ...
    consoleBox.style.backgroundColor = 'black';
    consoleBox.style.overflowY = 'scroll';
    consoleBox.style.border = '1px solid black';
    consoleBox.style.padding = '10px';
    consoleBox.style.textAlign = 'center';  // Alinea el texto a la izquierda
    consoleBox.style.color = 'white';  // Establece el color del texto
