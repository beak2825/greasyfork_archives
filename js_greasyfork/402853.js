...
// @author      Hacker, from earlier credits - ErmiyaEskandary, Luca, CTHack, Jaime Argila and 20 others
// @description slither.io bot 
// @include     http://slither.io/
// @version     6.7
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/402853/Demon%20Lord.user.js
// @updateURL https://update.greasyfork.org/scripts/402853/Demon%20Lord.meta.js
// ==/UserScript==

var customBotOptions = {
    // target fps
     targetFps: 30,
    //this variable targetFps: 30, has a default value of 30 and changes the snake's speed
    ...
    // angle or higher where enemy heady is considered in the rear
     rearHeadAngle: 2*3 * Math.PI / 4,
    // attack enemy rear head at this angle
    // rearHeadDir: Math.PI / 2,
    // quick radius toggle size in approach mode
     radiusApproachSize: 26,
            ...
            for (var snake = 0, ls = window.snakes.length; snake < ls; snake++) {
                ...
                if (window.snakes[snake].id !== window.snake.id &&
                    ...
                    scPoint = {
                        ...
                        snake: snake,
                        radius: bot.getSnakeWidth(window.snakes[snake].sc) / 1
                    };
...
//checkCollision: function() {
        ...
        scoreFood: function(f) {
            f.score =  8*Math.pow(Math.ceil(f.sz / bot.opt.foodRoundSize) * bot.opt.foodRoundSize, 2) /
        ...
        every: function() {
            ...
            bot.speedMult = window.snake.sp / 9.20;
...
(function() {
    ...
    window.nick.value = userInterface.loadPreference('savedNick', 'FLIP YOU');
