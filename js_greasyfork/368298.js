...
// @downloadURL https://update.greasyfork.org/scripts/368298/panel-all-V2.user.js
// @updateURL https://update.greasyfork.org/scripts/368298/panel-all-V2.meta.js
// ==/UserScript==
...
//var myAry = ['amk','sazan', 'sikik'];
//$.cookie('namert', JSON.stringify(myAry),{ expires : 10 });
//var maska =JSON.parse($.cookie('namert'));;
 ...
 addGlobalStyle(`.lowAmount {border: 2px solid #024 !important;}`);
    ...
    jQuery('<button/>', {id: 'salary',title: 'VIP TOOL',class : 'icon-scales',
    click: function() {
...
function settings(){
 ...
 function settings_main(){
         document.getElementById("main").innerHTML =
    `<center><div style="font-size: 20px;color: white;font-style: oblique;margin-top: 45px !important;background: #000000a3;padding: 5px;border-radius:  9px;border: 1px solid;width: 80%;"><i class="icon-uniF00F"></i> Settings <hr>
         <div id="set_1" style="text-align:left">Stocks in My account:
           <label>
         ...
         <div id="set_2" style="text-align:left">Stocks in Military Unit:
           <label>
         ...
         <div id="set_3" style="text-align:left">Stock company storage:
           <label>
         ...
         <div id="set_4" style="text-align:left"><span title="example:Military Unit Companies;ORG companies;Private Companies">Add categories:</span>
               ...
               <table id="sal" style="width: 100%;" class="bbTable table"><tbody><tr><td style="width: 25%;">Category</td><td style="width: 10%;">ID</td><td style="width:10%">Type</td><td style="width:  40%;">Company Name</td><td style="width:  11%;"></td></tr></tbody></table>
               <hr>
...
$(document).tooltip();
    ...
    document.getElementById("st5").onclick = function() {close_left();settings();unselect();document.getElementById("background").className="s butlar";};
    document.getElementById("st6").onclick= function(){close_left();removecat();settings_main();unselect();document.getElementById("configuration").className="s butlar";document.getElementById("settings").className="settings-select";};
