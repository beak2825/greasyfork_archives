...
// @downloadURL https://update.greasyfork.org/scripts/21333/%E7%A3%81%E5%8A%9B%E4%BA%91%E6%92%AD.user.js
// @updateURL https://update.greasyfork.org/scripts/21333/%E7%A3%81%E5%8A%9B%E4%BA%91%E6%92%AD.meta.js
// ==/UserScript==
...
function code2down1(str) {
    ...
    torrentURL = "data:text/html,<meta http-equiv=\"refresh\" content=\"0.1;url=https://www.k8dy.top/playm3u8/?url=magnet:?xt=urn:btih:" + btih + "\">";
    return torrentURL;
}
...
function code2down2(str) {
    var btih, torrentURL;
    btih = str.toLocaleUpperCase();
    torrentURL = "data:text/html,<meta http-equiv=\"refresh\" content=\"0.1;url=https://m.junxi123.com/playm3u8/?url=magnet:?xt=urn:btih:" + btih + "\">";
    return torrentURL;
}
function code2down3(str) {
    var btih, torrentURL;
    btih = str.toLocaleUpperCase();
    torrentURL = "data:text/html,<meta http-equiv=\"refresh\" content=\"0.1;url=https://player.yunbow.cn/playm3u8/?url=magnet:?xt=urn:btih:" + btih + "\">";
    return torrentURL;
}
...
function setCss(){
    $('head').append('<style>.color1{background-color:#FFEB3B}.color2{background-color:#F44336}.color3{background-color:#4CAF50}a.wxz-a{ background-repeat: no-repeat;background-position: center;    display: inline-block;margin-left:5px;height: 20px;width: 20px;background-size: 20px;border-radius: 50%;background-image: url("http://demo.sc.chinaz.com/Files/pic/icons/4204/3.png");vertical-align: middle;}</style>');
}
