...
// @version      0.1
// @description  Tetris Friends Water theme for Jstris
// @author       Oki, Eddie, Bang
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/391858/Water%20%28TF%29%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/391858/Water%20%28TF%29%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/T2JzLYH.png",32);
        loadGhostSkin("https://i.imgur.com/EhS1B10.png",36);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('http://cosmicdolphins.wordpress.com/files/2009/07/space_dolphin_by_akagloomy.jpg')";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://www.dropbox.com/s/d4zuoj98vnd51zk/fx_hrddp.mp3?dl=1",abs:1};
    this.ready={url:"https://www.dropbox.com/s/6o6us3n347zalx8/fx_01tic.mp3?dl=1",abs:1,set:1};
    this.go={url:"https://www.dropbox.com/s/yz8y8jhbj43l61a/fx_go.mp3?dl=1",abs:1,set:0};
    this.died={url:"https://www.dropbox.com/s/ey2vcxz56ksuf55/fx_ko.mp3?dl=1",abs:1,set:1};
    this.hold={url:"https://www.dropbox.com/s/72xbk1pju0r2nyr/fx_hold.mp3?dl=1",abs:1,set:0};
    this.move={url:"https://www.dropbox.com/s/4h9pgmxeg7p5zy9/fx_fall.mp3?dl=1",abs:1,set:0};
    this.linefall={url:"https://www.dropbox.com/s/cg4h41w6lnlaya4/fx_lne01.mp3?dl=1",abs:1,set:0};
};
...
Game['eventSounds']  = [
"https://www.dropbox.com/s/fciipd3w8zazfbt/vo_tspinsingle.mp3?dl=1",
"https://www.dropbox.com/s/gx2bjplh8150rae/vo_tspinmini.mp3?dl=1",
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_clear1.mp3",       //no sound exists for TF
"https://www.dropbox.com/s/ole7ouq93itayzb/vo_tspindouble.mp3?dl=1",
"https://www.dropbox.com/s/qmbar1yhvkx1s6x/vo_lne02.mp3?dl=1",
"https://www.dropbox.com/s/ce04lusu1cp79dj/vo_tspintriple.mp3?dl=1",
"https://www.dropbox.com/s/5lo21mv5cdqsup8/vo_lne03.mp3?dl=1",
"https://www.dropbox.com/s/eqi6nlrx60oifvj/vo_tetrs.mp3?dl=1",
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_perfectclear.mp3", //no sound exists for TF
"https://www.dropbox.com/s/caisy0hopbcnw86/vo_b2btspin.mp3?dl=1",
"https://www.dropbox.com/s/g6ebulq1qgcs4r5/vo_b2btetrs.mp3?dl=1"
...
Game['rotationSounds']  = [
"https://www.dropbox.com/s/akdqnl3b0ld0qfe/fx_rta01.mp3?dl=1", //rotate left
"https://www.dropbox.com/s/akdqnl3b0ld0qfe/fx_rta01.mp3?dl=1", //rotate right
"https://www.dropbox.com/s/akdqnl3b0ld0qfe/fx_rta01.mp3?dl=1" //rotate 180°
];
...
var songsMP = [
"https://www.dropbox.com/s/jn944kilxehv546/Donkey%20Kong%20Country%20-%20Aquatic%20Ambience%20%28Restored%29.mp3?dl=1",
]

var songSP = "https://www.dropbox.com/s/jn944kilxehv546/Donkey%20Kong%20Country%20-%20Aquatic%20Ambience%20%28Restored%29.mp3?dl=1"
