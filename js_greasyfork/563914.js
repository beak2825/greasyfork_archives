...
// @downloadURL https://update.greasyfork.org/scripts/563914/CHEN%20SHUAIHAN.user.js
// @updateURL https://update.greasyfork.org/scripts/563914/CHEN%20SHUAIHAN.meta.js
// ==/UserScript==
...
(function () {
    ...
    /************ 配置区 ************/
    const OLD_NAME = "JIANG CHENXI"; // 英文名字
    const NEW_NAME = "CHEN SHUAIHAN"; // 新名字
    const NEW_BIRTHDAY = "(**0728)";
