...
// @downloadURL https://update.greasyfork.org/scripts/471228/Assist%20Request.user.js
// @updateURL https://update.greasyfork.org/scripts/471228/Assist%20Request.meta.js
// ==/UserScript==
'use strict';

{
  ...
  const buttonList = [
    ...
    {name: 'Under 1b', value: '0b-1b'},
    {name: '1b - 3b', value: '1b-3b'},
    {name: '3b - 5b', value: '3b-5b'},
    {name: '5b - 8b', value: '5b-8b'},
    {name: '8b - 10b', value: '8b-10b'},
    {name: 'Over 10b', value: '10b+'},
  ];
