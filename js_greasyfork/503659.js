...
// @version      1.1.3
// @description  Для люпими Novosibirsk
// @author       V.Rezinka
...
// @downloadURL https://update.greasyfork.org/scripts/503659/Novosibirsk.user.js
// @updateURL https://update.greasyfork.org/scripts/503659/Novosibirsk.meta.js
// ==/UserScript==
	...
	const PIN_PREFIX = 2; //  префикс закрепить
        const PIN_PREFIXX = 2; //  префикс передачи админам
...
const PIN_PREFIXXXXXX = I ; //  префикс передачи в жб на тех
...
},
{
	...
	addButton('Закрытие без перемещение в окончательные ответы', 'closed_complaint');
	addAnswers();
