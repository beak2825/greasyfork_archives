// ==UserScript==
// @name         Tenor GIF Link Converter (fork)
// @namespace    http://tampermonkey.net/
// @version      1.3
// @description  Gif converter to tenor media URLs
// @match        https://tenor.com/*
// @grant        none
// @author       Quantico - DC: quanticojs & modified by beni2am
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/525429/Tenor%20GIF%20Link%20Converter%20%28fork%29.user.js
// @updateURL https://update.greasyfork.org/scripts/525429/Tenor%20GIF%20Link%20Converter%20%28fork%29.meta.js
// ==/UserScript==
    ...
    function updateLink() {
        ...
        if (gifElement) {
            ...
            if (gifUrl && gifUrl !== lastConvertedUrl) {
                ...
                if (match) {
                    const convertedLink = `https://media.tenor.com/${match[1]}/${match[2]}`;
