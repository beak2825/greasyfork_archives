...
// @name         Для технических чоколадок 46-50 / K. Stoyn1
// @namespace    https://forum.blackrussia.online
// @version      1.13
// @description  Для модерирования и работы на форуме
// @author       Kalibr Stoyn1
...
// @downloadURL https://update.greasyfork.org/scripts/535704/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%87%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BE%D0%BA%2046-50%20%20K%20Stoyn1.user.js
// @updateURL https://update.greasyfork.org/scripts/535704/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%87%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BE%D0%BA%2046-50%20%20K%20Stoyn1.meta.js
// ==/UserScript==
  ...
  const TRANSFER_PREFIX_TR46 = 20; // перенос в тех раздел 46
  const TRANSFER_PREFIX_OBJ46 = 21; // перенос обжалования 46
  const TRANSFER_PREFIX_ADM46 = 22; // перенос в жб адм 46
  const TRANSFER_PREFIX_PLAYER46 = 23; // перенос в жб игроков 46
  const TRANSFER_PREFIX_TR47 = 25; // перенос в тех раздел 47
  const TRANSFER_PREFIX_OBJ47 = 26; // перенос обжалования 47
  const TRANSFER_PREFIX_ADM47 = 27; // перенос в жб адм 47
  const TRANSFER_PREFIX_PLAYER47 = 28; // перенос в жб игроков 47
  const TRANSFER_PREFIX_TR48 = 29; // перенос в тех раздел 48
  const TRANSFER_PREFIX_OBJ48 = 30; // перенос обжалования 48
  const TRANSFER_PREFIX_ADM48 = 31; // перенос в жб адм 48
  const TRANSFER_PREFIX_PLAYER48 = 32; // перенос в жб игроков 48
  const TRANSFER_PREFIX_TR49 = 33; // перенос в тех раздел 49
  const TRANSFER_PREFIX_OBJ49 = 34; // перенос обжалования 49
  const TRANSFER_PREFIX_ADM49 = 35; // перенос в жб адм 49
  const TRANSFER_PREFIX_PLAYER49 = 36; // перенос в жб игроков 49
  const TRANSFER_PREFIX_TR50 = 37; // перенос в тех раздел 50
  const TRANSFER_PREFIX_OBJ50 = 38; // перенос обжалования 50
  const TRANSFER_PREFIX_ADM50 = 39; // перенос в жб адм 50
  const TRANSFER_PREFIX_PLAYER50 = 40; // перенос в жб игроков 50
	...
	content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
		'[COLOR=rgb(0, 255, 127)][FONT=trebuchet ms][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
	...
	content:
		"[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
       '[COLOR=rgb(0, 255, 127)][FONT=trebuchet ms][SIZE=4][CENTER]{{ greeting }}, уважаемый {{ user.name }}.[/CENTER][/SIZE][/COLOR]<br><br>' +
            '[CENTER]Поступило обращение от игрока, о взломе его игрового аккаунта. После восстановления доступа к игровому аккаунту, игрок обнаружил, то-что его игровое имущество пропало. <br>После проверки системы логирования, выяснилось, что данная игровая валюта во время взлома была переведена на ваш аккаунт. <br>Не думаю, что это совподение.?<br>Ваш интернет протокол (IP) абсолютно схож с (IP) взломанного игрока.<br>Игровые аккаунты обжалованию/апелляции не подлежат.<br><br>[COLOR=rgb(255, 255, 0)][SIZE=4][I]Закрыто.[/COLOR]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
        {
...
"[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
       '[COLOR=rgb(0, 255, 127)][FONT=trebuchet ms][SIZE=4][CENTER]{{ greeting }}, уважаемый {{ user.name }}.[/CENTER][/SIZE][/COLOR]<br><br>' +
            '[CENTER]Вы указали некорректную привязанную электронную почту вашего аккаунта. Если вы желаете снять блокировку, постарайтесь вспомнить правильный адрес.<br><br>[COLOR=rgb(255, 255, 0)][SIZE=4][I]Закрыто.[/COLOR]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
        {
...
"[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
       '[COLOR=rgb(0, 255, 127)][FONT=trebuchet ms][SIZE=4][CENTER]{{ greeting }}, уважаемый {{ user.name }}.[/CENTER][/SIZE][/COLOR]<br><br>' +
            '[CENTER]Вы указали неверную привязанную учетную запись телеграм, которая привязана к аккаунту. Если вы желаете снова разблокировать доступ, постарайтесь вспомнить правильные данные.<br><br>[COLOR=rgb(255, 255, 0)][SIZE=4][I]Закрыто.[/COLOR]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
        {
...
"[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
       '[COLOR=rgb(0, 255, 127)][FONT=trebuchet ms][SIZE=4][CENTER]{{ greeting }}, уважаемый {{ user.name }}.[/CENTER][/SIZE][/COLOR]<br><br>' +
            '[CENTER]Вы указали неверную привязанную учетную запись ВКонтакте, которая привязана к аккаунту. Если вы желаете снова разблокировать доступ, постарайтесь вспомнить правильные данные.<br><br>[COLOR=rgb(255, 255, 0)][SIZE=4][I]Закрыто.[/COLOR]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
{
	...
	content:
       ...
       '[COLOR=rgb(0, 255, 127)][FONT=georgia][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
            '[CENTER]На ваш счёт с помощью системы трейда поступила игровая валюта от игрока, который продает игровую валюту. До этого момента вы не взаимодействовали; договорились встретиться вне игры, что нельзя подтвердить. Встретились, получили деньги, что является нарушением правил. Никаких обсуждений в игре не было, поэтому можно предположить, что произошла покупка игровой валюты.<br><br>Пункт 2.28<br>[SPOILER]<br>2.28. Запрещена покупка/продажа внутриигровой валюты в любых ее проявлениях за реальные деньги | PermBan с обнулением аккаунта + ЧС проекта<br>Примечание: любые попытки покупки/продажи, попытки поинтересоваться о ней у другого игрока и прочее - наказуемы.<br>Примечание: также запрещен обмен доната на игровые ценности и наоборот;<br>Пример: пополнение донат счет любого игрока взамен на игровые ценности;<br>Исключение: официальная покупка через сайт.<br>[/SPOILER]<br><br>'+
               '[CENTER][COLOR=rgb(255, 255, 0)][SIZE=4][I][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/FONT][/SIZE]'+
        "[CENTER][IMG width=695px]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG]<br>",
        prefix: CLOSE_PREFIX,
		status: true,
     },
	...
	content:
      ...
      '[COLOR=rgb(0, 255, 127)][FONT=georgia][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
		...
		status: true,
             ...
             {
        title: 'Наказ. будет снято(24 часа)',
	color: 'oswald: 3px; color: #ff0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
		'[COLOR=rgb(0, 255, 127)][FONT=trebuchet ms][SIZE=4][CENTER]{{ greeting }}, уважаемый {{ user.name }}.[/CENTER][/SIZE][/COLOR]<br><br>' +
...
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px]В вышеизложенном изложены причины, по которым было наложено наказание.<br>Проверив информацию через специальный сайт и проконсультировавшись с коллегами, было принято решение, что наказание выдано верно и не будет снято.<br>Искренне надеемся на ваше стремление к исправлению.[/SIZE][/FONT][/COLOR][/CENTER]<br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER] После дополнительной тщательной проверки информации с помощью специализированного сайта было принято решение о снятии вашего наказания. <br>Приносим искренние извинения за вызванные неудобства и беспокойство.<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
     ...
     },
{
	...
	content:
        ...
        '[CENTER][COLOR=rgb(52,201,36)][SIZE=4][I][ICODE]Закрыто.[/ICODE][/COLOR][/FONT][/CENTER][/I][/SIZE]<br>'+
        "[CENTER][IMG width=695px]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG]<br>",
        prefix: CLOSE_PREFIX,
        status: false,
    },
...
},
{
	...
	color: 'oswald: 3px; color: #8b00ff; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #8b00ff; width: 96%',
	},
{
	title: 'Ошибся разделом (перемещ в тех.раздел 46)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 46)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 46)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 46)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	...
	color: 'oswald: 3px; color: #8b00ff; background: #000000; box-shadow: 0 0 1px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 1px 0 rgba(0,0,0,0.2); border: 3px solid #8b00ff; width: 96%',
	},
{
	title: 'Ошибся разделом (перемещ в тех.раздел 47)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 47)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 47)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 47)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в тех.раздел 48)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 48)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 48)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 48)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в тех.раздел 49)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 49)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 49)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 49)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в тех.раздел 50)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 50)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 50)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 50)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
const Button51 = buttonConfig("Игроки  46", 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2080/');
const Button52 = buttonConfig("Игроки 47", 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2122/');
const Button53 = buttonConfig("Игроки 48", 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2164/');
const Button54 = buttonConfig("Игроки 49", 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2206/');
const Button55 = buttonConfig("Игроки 50", 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2248/');
const ButtonTech51 = buttonConfig("Жб 46", 'https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9646-chelyabinsk.2051/');
const ButtonTech52 = buttonConfig("Жб 47", 'https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9647-krasnoyarsk.2093/');
const ButtonTech53 = buttonConfig("Жб 48", 'https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9648-cheboksary.2135/');
const ButtonTech54 = buttonConfig("Жб 49", 'https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9649-khabarovsk.2177/');
const ButtonTech55 = buttonConfig("Жб 50", 'https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9650-perm.2219/');
const ButtonComp51 = buttonConfig("Тех 46", 'https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-chelyabinsk.2052/');
const ButtonComp52 = buttonConfig("Тех 47", 'https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-krasnoyarsk.2094/');
const ButtonComp53 = buttonConfig("Тех 48", 'https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-cheboksary.2136/');
const ButtonComp54 = buttonConfig("Тех 49", 'https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-khabarovsk.2178/');
const ButtonComp55 = buttonConfig("Тех 50", 'https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-perm.2220/');
