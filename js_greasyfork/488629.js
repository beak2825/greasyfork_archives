// ==UserScript==
// @name                WME Lupa Cromática pt-BR
// @namespace           http://userscripts.org/users/419370
// @description         Adiciona cores a segmentos de vias conforme seus atributos
...
// @version             1.02
// @grant               none
// @downloadURL https://update.greasyfork.org/scripts/488629/WME%20Lupa%20Crom%C3%A1tica%20pt-BR.user.js
// @updateURL https://update.greasyfork.org/scripts/488629/WME%20Lupa%20Crom%C3%A1tica%20pt-BR.meta.js
// ==/UserScript==

// CRÉDITOS DO CÓDIGO A TIMBONES
// https://greasyfork.org/pt-BR/scripts/3206-wme-color-highlights?version=1316797
// Baseado na versão 2.38, de 24/01/2024.

(function()
{

// global variables
var wmech_version = "1.02"
...
function highlightSegments(event) {
  ...
  if (event && event.type && event.type == 'click') {
    if ( (showLocked | showToll | showNoCity | showNoName | showAltName | showOneWay | showRestrictions
     | specificCity | specificEditor | specificRoadType | showRecent | showSpeedLimits | showSpeed| showAvgSpeedCams | showLanes | showNoHNs
     ) == false) {
...
//ALTERADO
    ...
    // acima de 110km/h em ambos os sentidos = contínua
      else if (showSpeed
             && (attributes.junctionID == null)
             && ((attributes.fwdDirection && (attributes.fwdMaxSpeed > 110)) || (attributes.revDirection && (attributes.revMaxSpeed > 110)) ))
    {
      newColor = "#000000";
      newOpacity = 0.9;
      newWidth = 8;
    ...
    // 110km/h em ambos os sentidos = contínua
    // 110km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 110)) && (attributes.revDirection && (attributes.revMaxSpeed != 110)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 110)) && (attributes.revDirection && (attributes.revMaxSpeed == 110))) ) )
    ...
    // 100km/h em ambos os sentidos = contínua
    // 100km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 100)) && (attributes.revDirection && (attributes.revMaxSpeed != 100)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 100)) && (attributes.revDirection && (attributes.revMaxSpeed == 100))) ) )
    {
      newColor = "#bf9000";
      newOpacity = 0.9;
    ...
    // 90km/h em ambos os sentidos = contínua
    // 90km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 90)) && (attributes.revDirection && (attributes.revMaxSpeed != 90)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 90)) && (attributes.revDirection && (attributes.revMaxSpeed == 90))) ) )
    {
      newColor = "#f1c232";
      newOpacity = 0.9;
    ...
    // 80km/h em ambos os sentidos = contínua
    // 80km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 80)) && (attributes.revDirection && (attributes.revMaxSpeed != 80)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 80)) && (attributes.revDirection && (attributes.revMaxSpeed == 80))) ) )
    {
      newColor = "#ffd966";
      newOpacity = 0.9;
    ...
    // 70km/h em ambos os sentidos = contínua
    // 70km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 70)) && (attributes.revDirection && (attributes.revMaxSpeed != 70)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 70)) && (attributes.revDirection && (attributes.revMaxSpeed == 70))) ) )
    {
      newColor = "#ffe599";
      newOpacity = 0.9;
    ...
    // 60km/h em ambos os sentidos = contínua
    // 60km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 60)) && (attributes.revDirection && (attributes.revMaxSpeed != 60)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 60)) && (attributes.revDirection && (attributes.revMaxSpeed == 60))) ) )
    {
      newColor = "#3d85c6";
      newOpacity = 0.9;
    ...
    // 50km/h em ambos os sentidos = contínua
    // 50km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 50)) && (attributes.revDirection && (attributes.revMaxSpeed != 50)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 50)) && (attributes.revDirection && (attributes.revMaxSpeed == 50))) ) )
    {
      newColor = "#6fa8dc";
      newOpacity = 0.9;
    ...
    // 40km/h em ambos os sentidos = contínua
    // 40km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 40)) && (attributes.revDirection && (attributes.revMaxSpeed != 40)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 40)) && (attributes.revDirection && (attributes.revMaxSpeed == 40))) ) )
    {
      newColor = "#9fc5e8";
      newOpacity = 0.9;
    ...
    // 30km/h em ambos os sentidos = contínua
    // 30km/h em um dos sentidos   = tracejada
    else if (showSpeed
             && (attributes.junctionID == null)
             && ( ((attributes.fwdDirection && (attributes.fwdMaxSpeed == 30)) && (attributes.revDirection && (attributes.revMaxSpeed != 30)))
             ||   ((attributes.fwdDirection && (attributes.fwdMaxSpeed != 30)) && (attributes.revDirection && (attributes.revMaxSpeed == 30))) ) )
    {
      newColor = "#cfe2f3";
      newOpacity = 0.9;
...
//      else if (showSpeed
//             && (attributes.junctionID == null)
//             && ((value.fwdMaxSpeed !== value.revMaxSpeed))
//    {
//      newColor = "#ccff00";
//      newOpacity = 0.8;
//      newWidth = 8;
...
function initialiseHighlights()
{
  ...
  section.innerHTML  = '<b>Destacar segmentos</b><br>'
                     + '<label title="Traceçado = Travas Automáticas (se disponível)"><input type="checkbox" id="_cbHighlightLocked" title="Locked Segments" /> '
                     + 'Com Trava* (Vermelho)</label><br>'
                     + '<label title="Cor Laranja. Segmentos sem velocidade máxima definida"><input type="checkbox" id="_cbHighlightSpeedLimits" /> '
                     + 'Sem Velocidade*</label>'
                     + '&nbsp; <label><input type="checkbox" id="_cbHighlightPlusRampLimits" />+Rampas</label>'
                     + '&nbsp; <label><input type="checkbox" id="_cbHighlightPlusStreetLimits" />+Ruas</label><br>'
                     + '<label title="Segmentos com velocidades de 30/40/50/60/70/80/90/100/110. Contínua: igual nos sentigos. Tracejada: diferente nos sentidos."><input type="checkbox" id="_cbHighlightSpeed" /> '
                     + 'Com Velocidade (Variadas)</label>'
                     + '<label><input type="checkbox" id="_cbHighlightUnnamed" /> '
                     + 'Sem Nome (Laranja)</label><br>'
                     + '<label title="Tracejado = Sem Nome"><input type="checkbox" id="_cbHighlightAltName" /> '
                     + 'Com nome alternativo* (Lima)</label><br>'
                     + '<label><input type="checkbox" id="_cbHighlightNoCity" /> '
                     + 'Sem Cidade (Azul)</label><br>'
                     + '<label title="Excluindo Vias Rápidas e Rampas"><input type="checkbox" id="_cbHighlightNoHN" /> '
                     + 'Sem Números* (Marrom Tracejado)</label><br />'
                     + '<label><input type="checkbox" id="_cbHighlightOneWay" /> '
                     + 'Mão Única (Azul)</label><br>'
                     + '<label><input type="checkbox" id="_cbHighlightRestrictions" /> '
                     + 'Restrição de Período/Veículo (Roxo)</label><br>'
                     + '<label><input type="checkbox" id="_cbHighlightToll" /> '
                     + 'Pedágio (Marrom)</label><br>'
                     + '<label title="Zona com Radar de Velocidade Média"><input type="checkbox" id="_cbHighlightAvgSpeedCams" /> '
                     + 'Radar de Velocidade Média* (Azul)</label><br>'
                     + '<label><input type="checkbox" id="_cbHighlightCity" /> '
                     + 'Filtro por Cidade (Rosa)</label> &nbsp;'
                     + '  <label><input type="checkbox" id="_cbHighlightCityInvert" /> Inverter</label><br> '
                     + '  <select id="_selectCity" name="_selectCity" style="margin: 0 0 4px 20px"></select>'
                     + '<span id="_numCityHighlighted"></span><br>'
                     + '<label><input type="checkbox" id="_cbHighlightRoadType" /> Destaque por Tipo de Via (Roxo)</label><br> '
  ...
  section.innerHTML  = '<b>Opções Avançadas</b><br>'
             + '<label><input type="checkbox" id="_cbHighlightRecent" /> Editado Recentemente (Verde)</label><br> '
             + '  <input type="number" min="0" max="365" size="3" id="_numRecentDays"  style="margin: 0 0 4px 20px" /> dias<br>'
             + '<label><input type="checkbox" id="_cbHighlightEditor" /> Filtro por Editor (Verde)</label><br> '
             + '  <select id="_selectUser" name="_selectUser" style="margin: 0 0 4px 20px"></select>'
             + '<span id="_numUserHighlighted"></span><br>'
             + '<label><input type="checkbox" id="_cbHighlightRoutingPref" /> Preferência de Roteamento (Cor Variada)</label><br>'
             + '<label title="Navegação por Faixa"><input type="checkbox" id="_cbHighlightLanes" /> Navegação por Faixa (Ciano)</label><br>'
             ;
  addon.appendChild(section);
  ...
  section.className = 'checkbox';
  section.innerHTML  = '<label title="parques/árvores = verde, água = azul, estacionamento = ciano, outros = rosa">'
                     + ' <input type="checkbox" id="_cbHighlightPlaces" /><b>Destacar Locais</b>*</label>'
                     + ' <span id="wmedebug" style="color: gray"></span><br>'
                     + '<label><input type="checkbox" id="_cbHighlightLockedPlaces" /> Locais Travados* (Vermelho)</label><br>'
                     + '<label title="Se estiver faltando nome, rua ou categoria errada"><input type="checkbox" id="_cbHighlightIncompletePlaces" /> '
                     +    'Locais Incompletos (Laranja Tracejado)</label><br>'
                     ;

  addon.appendChild(section);

  addon.innerHTML    += '<b><a href="https://greasyfork.org/pt-BR/scripts/488629-wme-lupa-crom%C3%A1tica-pt-br" target="_blank"><u>'
                     + 'WME Lupa Cromática pt-BR</u></a></b> &nbsp; v' + wmech_version;
  addon.innerHTML    += '<br><br><b><a href="https://greasyfork.org/scripts/3206-wme-color-highlights" target="_blank"><u>'
                     + 'Based on WME Color Highlights v2.38<br>Special thanks to Timbones</u></a></b>';

  var newtab = document.createElement('li');
  newtab.innerHTML = '<a href="#sidepanel-highlights" data-toggle="tab">Lupa Cromática</a>';
  ...
  getId('_cbHighlightSpeed').onclick = highlightSegments;
  ...
  if (localStorage.WMEHighlightScript) {
    ...
    getId('_cbHighlightSpeed').checked  = options[8];
  ...
  var saveHighlightOptions = function() {
    if (localStorage) {
      ...
      options[8] = getId('_cbHighlightSpeed').checked;
