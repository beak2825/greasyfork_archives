...
// @description	度盘万能钥匙油猴插件版本，功能包括：1、自动填写私密分享的提取码；2、百度网盘直链全速下载（PanDownload网页版）,不依赖第三方下载器；3、网页中百度网盘链接状态判断实时判断
// @include		*://**/*
...
// @grant       GM_setValue
// @run-at		document-end
// @downloadURL https://update.greasyfork.org/scripts/384530/%E3%80%90%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E3%80%91%E8%B6%85%E7%BA%A7%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/384530/%E3%80%90%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E3%80%91%E8%B6%85%E7%BA%A7%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
(function() {
    ...
    if(website_host=="pan.baidu.com" || website_host=="yun.baidu.com"){
		...
		if (location.href.indexOf('baidu.com/s/') > 0) {//v5
			...
			$('<a class="g-button" href="' + url + '" title="转到 Pandownload 网页版"><span class="g-button-right"><em class="icon icon-picpre-download" style="color:#d60;"><font color="#090"></em><span class="text" style="width: auto;"><font color="#090">Pandownload</font></span></span></a>').insertBefore('.x-button-box a.g-button[data-button-id=b3]');
			$('<a class="g-button" href="https://www.xiaokesoso.com" title="资源搜索" target="_blank"><span class="g-button-right"><span class="text" style="width: auto;"><font color="#090">资源搜索</font></span></span></a>').insertBefore('.x-button-box a.g-button[data-button-id=b3]');
		}
