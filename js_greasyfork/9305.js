// ==UserScript==
// @name        Wanikani Override for landscape
...
// @downloadURL https://update.greasyfork.org/scripts/9305/Wanikani%20Override%20for%20landscape.user.js
// @updateURL https://update.greasyfork.org/scripts/9305/Wanikani%20Override%20for%20landscape.meta.js
// ==/UserScript==
...
exportFunction(WKO_ignoreAnswer, unsafeWindow, {defineAs: "WKO_ignoreAnswer"});
...
{	
	var button =  $("<li style='width:14%;'><span title='Ignore Answer' id='WKO_button' onclick='WKO_ignoreAnswer();' >Ignore Answer</span></li>");
		
	$("#additional-content ul li").css("width", "17%");
	$("#additional-content ul").append(button);
}
...
function scriptInit()
{
	...
	GM_addStyle("#answer-exception {width:85%}");
