// ==UserScript==
// @name         Autotrading (Buy) - Ongoing
// @version      0.75
// @description  Auto buy
// @include      https://*/game.php*screen=market&mode=exchange*
// @namespace https://greasyfork.org/users/1388863
// @downloadURL https://update.greasyfork.org/scripts/530513/Autotrading%20%28Buy%29%20-%20Ongoing.user.js
// @updateURL https://update.greasyfork.org/scripts/530513/Autotrading%20%28Buy%29%20-%20Ongoing.meta.js
// ==/UserScript==
...
(function() {
    ...
    function createUI() {
        ...
        if (savedStatus === 'running') {
            intervalId = setInterval(autoFillAllMaterials, Math.random() * 15000 + 2000);
