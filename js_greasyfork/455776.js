// ==UserScript==
// @name         Скрипт для ГС ОПГ и ЗГС ОПГ
// @namespace   Denzel Galkin
// @version      1.0.0
// @description  Denzel Galkin
// @author       Denzel Galkin
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @icon         https://icons.iconarchive.com/icons/aha-soft/iron-man/48/Ironman-Mask-3-Old-icon.png
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/455776/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93%20%D0%B8%20%D0%97%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93.user.js
// @updateURL https://update.greasyfork.org/scripts/455776/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93%20%D0%B8%20%D0%97%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93.meta.js
// ==/UserScript==
    ...
    const buttons = [
        ...
        },
        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br>` +
                ...
                `С уважением,Главный Следящий за ОПГ - Denzel Galkin.<br>` +
        ...
        },
        {
            ...
            content:
                ...
                "[CENTER]С уважением,Главный Следящий за ОПГ - Denzel Galkin. <br><br>" +
 ...
 
        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br>` +
                ...
                `Пожалуйста ожидайте ответа от ГС ОПГ - @Denzel Galkin .<br><br>` +
                `С уважением,ЗГС ОПГ <br>` +
                `[COLOR=orange]На рассмотрение.[/color] [/CENTER][/FONT][/SIZE]`,
            prefix: PIN_PREFIX,
            status: true,
        },
