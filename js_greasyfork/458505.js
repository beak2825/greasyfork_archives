// ==UserScript==
// @name        elaw's iAm TC bot (iAM V2.4 EAR)
// @version     2.4 EAR
// @description Remove unneeded components and Optimize the room to fit the browser window.
// @author      elaw
// @url         https://kemetgenix.com
// @Instagram   https://www.instagram.com/KemetGenix/
// @license     Copyright (C) elaw
// @icon        https://avatars.tinychat.com/50/b12c3d/6f/small/php7RzE9a.jpeg
...
// @downloadURL https://update.greasyfork.org/scripts/458505/elaw%27s%20iAm%20TC%20bot%20%28iAM%20V24%20EAR%29.user.js
// @updateURL https://update.greasyfork.org/scripts/458505/elaw%27s%20iAm%20TC%20bot%20%28iAM%20V24%20EAR%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    var CTS = {
        ...
        YouTube: {
            API_KEY: "AIzaSyC_v7fhi2chP25n625swPggIarT2Qp6u9M",
            XHR: new XMLHttpRequest(),
            Playing: false,
            MessageQueueList: [],
        ...
        Favorited: ["PHATBOOTYPBG2", "HOTGIRLSUMMER", "LIMELIGHTTV", "THEBODEGA", "SUCKAFREELIVE01"],
        SafeList: [],
        GreenRoomIgnoreList: [],
        GreenRoomList: [],
        WatchList: [],
    ...
    function CTSRoomInject() {
        ...
        window.CTSImages = [
            "https://scontent-atl3-2.cdninstagram.com/v/t51.2885-15/37064919_259910084808345_4606863384334303232_n.jpg?stp=dst-jpg_e35&_nc_ht=scontent-atl3-2.cdninstagram.com&_nc_cat=109&_nc_ohc=D_ADJeedvnsAX_p2OcK&edm=ABmJApABAAAA&ccb=7-5&ig_cache_key=MTgzNTk4NTA4OTk2MDg2NDgwOQ%3D%3D.2-ccb7-5&oh=00_AfD_GcXRpUYasJ68OM_MXhGx3K2Ub4ThNIq_BWczz8m5zw&oe=63BC13C7&_nc_sid=6136e7", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgprnYQvOYLFQucnVK4rXyYR5ZI5kf08ua4w&usqp=CAU", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZsHS__xxWVIkPhAAh44d6pASAc4-8n5_D6Q&usqp=CAU", "https://i.imgur.com/QdOTqIR.jpg", "https://i.imgur.com/qqFsein.jpg", "https://i.imgur.com/vVD5pUb.jpg", "https://i.imgur.com/Sux2Age.jpg", "https://i.imgur.com/cIKznlf.jpg", "https://i.imgur.com/iEMP5I6.jpg", "https://i.imgur.com/rEGy1tK.jpg", "https://i.imgur.com/JR6Ped5.jpg", "https://i.imgur.com/m3dX7yn.jpg", "https://i.imgur.com/2cJqV1K.jpg", "https://i.imgur.com/QL1M4yG.jpg", "https://i.imgur.com/Syy1mUU.jpg", "https://i.imgur.com/sRpDOp3.jpg", "https://i.imgur.com/Im7dWdM.jpg", "https://i.imgur.com/9uCdYyq.png", "https://i.imgur.com/X9Kp6ka.jpg", "https://i.imgur.com/TOZTx1M.jpg", "https://i.imgur.com/wcjxVjk.png", "https://i.imgur.com/UZfmih9.png", "https://i.imgur.com/mkauZUT.jpg", "https://i.imgur.com/GfPqv7d.jpg", "https://i.imgur.com/R7AOtjV.jpg", "https://i.imgur.com/Qso6n8k.jpg", "https://i.imgur.com/vVfj23z.jpg", "https://i.imgur.com/BYPsShX.jpg", "https://i.imgur.com/1EWYBQw.jpg", "https://i.imgur.com/Oaq0eip.jpg", "https://i.imgur.com/HVHaJ1r.jpg", "https://i.imgur.com/SImcSc2.png", "https://i.imgur.com/CgRDCdy.jpg", "https://i.imgur.com/VMtXsES.png", "https://i.imgur.com/oxHz9un.jpg", "https://i.imgur.com/VN6x9QA.jpg", "https://i.imgur.com/9KhjWvW.jpg", "https://i.imgur.com/fu0eiv4.jpg", "https://i.imgur.com/QgcvxZf.jpg", "https://i.imgur.com/2kz8Roz.jpg", "https://i.imgur.com/A2AdQd8.jpg", "https://i.imgur.com/zuNUJ4J.jpg", "https://i.imgur.com/CW4mVWE.jpg", "https://i.imgur.com/Lq4qnDF.jpg", "https://i.imgur.com/N1KmzQo.jpg", "https://i.imgur.com/pAReFTB.jpg", "https://i.imgur.com/ZKMQwxk.jpg", "https://i.imgur.com/aSDE7i4.jpg", "https://i.imgur.com/kabITqS.jpg", "https://i.imgur.com/W7oaDNe.jpg", "https://i.imgur.com/VHYmth8.jpg",
        ];
        window.CTSEightBall = ["It is certain.", "It is decidedly so.", "Without a doubt.", "Yes - definitely.", "Fuck Yea!!", "As  I see it, yes.", "Most Likely.", "You Damn Right!", "Yes.", "And you know this... Maaane.", "Reply hazy, try again.", "Ask again later.", "Better not tell you now.", "Cannot predict now.", "Concentrate and ask again.", "Don't count on it.", "My reply is no.", "My sources say no.", "Outlook not so good.", "Very doubtful."];
        window.CTSWelcomes = ["💥Who let you in,  ", "💥What's poppin ", "💥How the FUCK did you get here ", "💥Ugly ass ", "💥Wassam ", "💥Salutations ", "💥What’s kickin’, little chicken? ", "💥What's up ", "💥Greetings ", "💥Bean Head Ass "];
        window.CTSSound = {
            ModAlert: new Audio("https://www.myinstants.com/media/sounds/55463983741159354957959692288_35100067f45.mp3"),
            HIGHLIGHT: new Audio("https://www.myinstants.com/media/sounds/movie_1.mp3"),
            GREET: new Audio("https://www.myinstants.com/media/sounds/jetsons-doorbell_FaDmxLe.mp3"),
            MENTION: new Audio("https://www.myinstants.com/media/sounds/called-my-name.mp3"),
            MSG: new Audio("null"),
            GIFT: new Audio("https://tinychat.com" + window.rootDir + "/sound/magic.mp3"),
            PVTMSG: new Audio("https://www.myinstants.com/media/sounds/psst-roblox-doors.mp3")
        };
        window.CTSRadioStations = [
            ["FUBU Radio", "https://streaming.radio.co/s9a5207ec7/low"]
        ];
        ...
        ChatLogElement.querySelector("#chat").insertAdjacentHTML("afterend", '<div class="cts-message-unread" style="display:none;">Youve got mail! Faceheadass</div>');
        //SCRIPT INIT -> PREPARE()
        clearInterval(CTS.ScriptLoading);
        CTS.ScriptInit = true;
        CTSRoomPrepare();
    ...
    function BotCommandCheck() {
        ...
        if (isCommand(arguments[1])) {
            ...
            } else if (arguments[1].match(/^!whoisbot$|^!8ball |^!banks$|^!modalert$ |^!coin$|^!social$|^!urb |^!guest$|^!dad$|^!tip$|^!advice$/i)) {
                ...
                if (!isCommand(arguments[1])) {
                    ...
                    if (arguments[1].length == 1 && CTS.Game.Trivia.ANum.includes(arguments[1].toUpperCase()) && !Guessed && !CTS.Game.Trivia.Waiting) {
                        if (CTS.Game.Trivia.Correct === arguments[1].toUpperCase()) {
                            ...
                            Send("msg", "✨[TRIVIA]✨\n" + User.username + " that's wrong, maybe you should try Googling the answer next round.");
                            if (CTS.Game.Trivia.Attempts == 2) {
                                Send("msg", "✨[TRIVIA]✨\nNobody got it! Dumbasses\nNext round will start in shortly.\nThe answer however was: " + CTS.Game.Trivia.Correct);
                                Trivia.Wait();
                            }
                        }
                    }
    ...
    function TriviaCommand() {
        ...
        if (arguments[1].match(/^!triviashop$/i)) {
            ...
            Send("msg", "✨[TRIVIA]✨\n" + User.username + ",\nYou are smarter than a 2nd grader. You have an IQ of " + User.triviapoints + ".");
        }
    }
    ...
    function BotCommandCheckPUB() {
        if (arguments[1].match(/^!whoisbot$/i)) BotCommand(5, arguments[0])
         if (CTS.UserList[arguments[0]].mod || isSafeListed(CTS.UserList[arguments[0]].username)) Send("msg", "!bot");
        ...
        if (CTS.PublicCommandToggle) {
            if (arguments[1].match(/^!8ball [\w\s]*\??/i)) {
                ...
                } else if (arguments[1].match(/^!guest$/i)) {
                if (CTS.UserList[arguments[0]].username) Send("msg", "☣️☣️HOW TO CHANGE NICKNAME FROM GUEST☣️☣️ \n ☛  On the LEFT side where the ROOM USERS are listed \n ☛ click where it says 'guest/guest-(random numbers)' from the userlist \n ☛ select CHANGE NICKNAME \n ☛ enter a nickname of your choosing \n ☛ cam down and cam back up\n");
                 } else if (arguments[1].match(/^!modalert$/i)) {
                if (CTS.UserList[arguments[0]].username) Send("msg", "☣️☣️Waaake  Theee Fuuuuck Upppp☣️☣️ \n Can I get a Mod to...   \n ☛ Cam me up \n ☛ Close this FOOL \n ☛ Change this damn song \n ☛ Close the bot so I can cam the fuck up\n")
                if (window.TinychatApp.BLL.SettingsFeature.prototype.getSettings().enableSound && !window.CTSMuted) {
            window.CTSSound.ModAlert.volume = window.CTSRoomVolume;
            window.CTSSound.ModAlert.play();
        }
                    ;
                } else if (arguments[1].match(/^!advice$/i)) {
                    Advice(CTS.UserList[arguments[0]].username);
                } else if (arguments[1].match(/^!banks$/i)) {
                if (CTS.UserList[arguments[0]].username) Send("msg", "https://www.tampermonkey.net/\n (iAm Link)💣\nhttps://greasyfork.org/en/scripts/443987\n");
                }
            }
        }
    }
    ...
    function BotCheck() {
        if (CTS.UserList[arguments[0]].mod) {
            ...
            if (arguments[1].match(/^!bot$/i)) {
                ...
                CTS.HostWaiting = false;
                //RESET GAMES
                if (CTS.Host != CTS.Me.handle && CTS.Game.NoReset) CTS.Game.NoReset = true;
    ...
    function HTMLtoTXT() {
        ...
        p.appendChild(text);
        return p.innerHTML.replace(/(?:(?:(?:https?|ftps?):)?\/\/)(?:\S+(?::\S*)?@)?(?:(?!(?:10|127)(?:\.\d{1,3}){3})(?!(?:169\.254|192\.168)(?:\.\d{1,3}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{1,3}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z0-9\u00a1-\uffff][a-z0-9\u00a1-\uffff_-]{0,62})?[a-z0-9\u00a1-\uffff]\.)+(?:[a-z\u00a1-\uffff]{2,}\.?))(?::\d{2,5})?(?:[/?#]\S*)?/igm,(url)=> (new URL(url).hostname.includes('xn--')) ? `URL BLOCKED` : `<a target="_blank" href="${url}">${url}</a>`).replace(/[\u2680-\u2685]/g, "<span style=\"font-size:275%;\">$&</span>").replace(/\n|\r/g, "<br>");
    }
        ...
        if (isCommand(arguments[1])) {
            if (CTS.UserList[arguments[0]].owner) {
                if (!CTS.Me.owner) {
                    ...
                    if (arguments[1].match(/^!version$/i)) Send("pvtmsg", "Im fucking wit " + CTS.Project.Name + "v" + Ver(), CTS.UserList[arguments[0]].handle);
                } else {
    ...
    function AddUserNotification() {
        if (CTS.FullLoad && CTS.ShowedSettings) {
            ...
            if (arguments[0] == 1) {
                ...
                Notification = arguments[3] + " has " + ((!arguments[4]) ? "joined!" : "left. They was pussy anyway!");
            } else if (arguments[0] == 3) {
                Notification = arguments[2] + "has mentioned you! Not wanting SHIT!";
                ...
                Notification = "with the account name " + arguments[3] + " changed their name to " + arguments[5] + " I SEE YOU ";
            }
        ...
        if (user != -1) {
            if (CTS.Me.mod) {
                if (arguments[1]) {
                    ...
                    var len = CTS.Camera.List.length;
                    if (CTS.UserList[user].username !== user && !CTS.GreenRoomList.includes(CTS.UserList[user].username)) {
    ...
    var CommandList = {
        ...
        greenroomtoggle: function() {
            ...
            Settings();
            Alert(GetActiveChat(), "✓ Command Accepted!\n" + ((CTS.GreenRoomToggle) ? "Green Room Auto Allow ON! CAREFUL" : "Green Room Auto Allow OFF!"));
        },
        clr: function() {
            CTS.Message[GetActiveChat()] = [];
        ...
        share: function() {
            var msg = "elaw's iAm Script:\nInstall...\n1. (Tamper Monkey Link)\nhttps://www.tampermonkey.net/\n2. (iAm Link)💣\nhttps://greasyfork.org/en/scripts/443987\n ✊🏿(The Black Land Design | Clothing for the Culture)✊🏿\nhttps://KemetGenix.com";
            if (GetActiveChat() !== 0) {
       ...
       modalert: function() {
            var msg = "☣️☣️Waaake  Theee Fuuuuck Upppp☣️☣️ \n Can I get a Mod to...   \n ☛ Cam me up \n ☛ Close this FOOL \n ☛ Change this damn song \n ☛ Close the bot so I can cam the fuck up\n";
            if (GetActiveChat() !== 0) {
                Send("pvtmsg", msg, GetActiveChat());
                PushPM(GetActiveChat(), msg);
            } else {
        ...
        guest: function() {
            var msg = "☣️☣️HOW TO CHANGE NICKNAME FROM GUEST☣️☣️ \n ☛  On the LEFT side where the ROOM USERS are listed \n ☛ click where it says 'guest/guest-(random numbers)' from the userlist \n ☛ select CHANGE NICKNAME \n ☛ enter a nickname of your choosing \n ☛ cam down and cam back up\n";
            if (GetActiveChat() !== 0) {
                Send("pvtmsg", msg, GetActiveChat());
                PushPM(GetActiveChat(), msg);
            } else {
        ...
        trivia: function() {
            if (CTS.Host === CTS.Me.handle && CTS.CanHostTriviaGames) {
                ...
                Alert(GetActiveChat(), "✓ Command Accepted!\n" + ((CTS.Game.Trivia.Started) ? "Trivia is now on!\n" : "Trivia is now off! Bout Fucking time!!! Sheesh\n"));
        ...
        version: function() {
            if (!CTS.Me.owner) {
                var msg = "🔥Im fucking with " + CTS.Project.Name + "v" + Ver();
                if (GetActiveChat() !== 0) {
                    Send("pvtmsg", msg, GetActiveChat());
                    PushPM(GetActiveChat(), msg);
                } else {
    ...
    var ServerInList = {
        joined: function() {
            ...
            CTS.Me = {
                ...
                "username": (arguments[0].self.username === "") ? "" : arguments[0].self.username.toUpperCase(),
            ...
            if (CTS.Me.nick.match(/^guest(?:\-[0-9]{1,10})?/i) && CTS.Me.username !== user) Send("nick", CTS.Me.username); //AUTO CORRECT NAME
        ...
        userlist: function() {
            ...
            for (var user = 0; user < len; user++) {
                ...
                var username = (arguments[0].users[user].username === "") ? "" : arguments[0].users[user].username.toUpperCase();
                ...
                CTS.UserList.push({
                    ...
                    "namecolor": window.CTSNameColor[Rand(0, window.CTSNameColor.length - 1)],
                    "avatar": (arguments[0].users[user].avatar === "") ? "https://avatars.tinychat.com/50/b12c3d/6f/small/php7RzE9a.jpeg" : arguments[0].users[user].avatar,
        ...
        join: function() {
            AKBS(arguments[0]);
            var user = (arguments[0].username === "") ? "" : arguments[0].username.toUpperCase();
            ...
            if (user === "elaw" && CTS.Room.Name.toUpperCase() !== "elaw" && !CTS.hasGreetedWC) { // Meet your creator
                CTS.hasGreetedWC = true;
                window.CTSSound.C.play();
                Send("msg", "HI! ELAW You were missed " + arguments[0].nick.toUpperCase() + "!");
            } else {
                if ((CTS.GreetList.includes(user) || (CTS.Host == CTS.Me.handle && CTS.GreetList.includes("-ALL"))) && CTS.NoGreet === false) {
                    Send("msg","[ 🕊 PEACE 🕊 ]\n" + (window.CTSWelcomes[Rand(0, window.CTSWelcomes.length - 1)] + arguments[0].nick.toUpperCase()) + ((CTS.GreetMode) ? ".\n" + (((user != "GUEST, change your Nickname") ? "You are signed in as " + user : "You are not signed in") + ".\nWelcome to the room! Sit back, relax and smoke sum.") : "!"));
                    if (window.TinychatApp.BLL.SettingsFeature.prototype.getSettings().enableSound && !window.CTSMuted) {
            ...
            CTS.NoGreet = false;
            AddUser(arguments[0].handle, arguments[0].mod, window.CTSNameColor[Rand(0, window.CTSNameColor.length - 1)], (arguments[0].avatar === "") ? "https://avatars.tinychat.com/standart/small/eyePink.png" : arguments[0].avatar, arguments[0].nick, user, ((user !== "ChangeName") ? true : false), arguments[0].owner);
            RoomUsers();
            debug();
        },
        sysmsg: function() {
        ...
        nick: function() {
            ...
            if (user != -1) {
                ...
                if ((CTS.GreetList.includes(CTS.UserList[user].username) || (CTS.Host == CTS.Me.handle && CTS.GreetList.includes("-ALL"))) && CTS.NoGreet === false) Send("msg", " 💥 [Alert] 💥  \n\n" + CTS.UserList[user].nick + "\nwith the account name " + CTS.UserList[user].username + " changed their name to " + arguments[0].nick + " tryna be slick nshit🔥\nEYE SEE YOU");
        ...
        AskQuestion: function() {
            ...
            if (CTS.Game.Trivia.Started) {
                if (CTS.Game.Trivia.QuestionList.length > 0) {
                    ...
                    CTS.Game.Trivia.Worth = ((CTS.Game.Trivia.QuestionList[0].difficulty === "easy") ? Rand(5000, 10000) : (CTS.Game.Trivia.QuestionList[0].difficulty === "medium") ? Rand(20, 30) : Rand(10000, 40000));
                    ...
                    CTS.Game.Trivia.Timer = setTimeout(function(g) {
                        Send("msg", "[TRIVIA]\nToo hard dumbasses? Next question coming up in sixty seconds!\nThe answer however was: " + CTS.Game.Trivia.Correct);
                        g.Wait();
                    }, 240000, this);
                } else {
    ...
    function SetLocalValues() {
        if (CTS.StorageSupport) {
            ...
            CTS.Game.Trivia.HighScore = JSON.parse(Load("TriviaHighScore", JSON.stringify(["elaw", 1])));
            CTS.Game.Fish.HighScore = JSON.parse(Load("FishHighScore", JSON.stringify(["elaw", 13337])));
            ...
            CTS.FavoritedRooms = JSON.parse(Load("FavoritedRooms", JSON.stringify(["PHATBOOTYPBG2", "HOTGIRLSUMMER", "LIMELIGHTTV", "THEBODEGA", "SUCKAFREELIVE01"])));
            CTS.MainBackground = Load("MainBackground", "url(https://i.pinimg.com/originals/d2/b9/83/d2b983efffe7ec7fb2ee3e4346ebcdd6.jpg) rgb(0, 0, 0) no-repeat");
    ...
    function debug() {
        if (window.DebugClear === false) {
            ...
            console.clear();
            console.log("             (     \n   (    *   ))\ )  \n   )\ \` )  /(()/(  \n (((_) ( )(_)/(_)) \n )\___(_(_()(_))   \n((/ __|_   _/ __|  \n | (__  | | \__ \  /\n  \___| |_| |___/  \nelaw's TinyChat Optimizer Script\nCREATOR: elaw\nVERSION: " + Ver() + "\nCONSOLE DEBUG: FALSE\n\nJoin the discord today!\n");
        }
    }
