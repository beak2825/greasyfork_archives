...
// @downloadURL https://update.greasyfork.org/scripts/14493/12306%20%E6%9E%9C%E6%9E%9C%E7%A7%92%E7%A5%A8%E5%8A%A9%E6%89%8B%20V3.user.js
// @updateURL https://update.greasyfork.org/scripts/14493/12306%20%E6%9E%9C%E6%9E%9C%E7%A7%92%E7%A5%A8%E5%8A%A9%E6%89%8B%20V3.meta.js
// ==/UserScript==
...
withjQuery(function ($, window) {
    ...
    function refreshStation() {
        ...
        var fromStations = ["SZN"];
        var toStations = ["AOH", "SNH", "SHH"];

        var queryTimes = 1;

        var resetStation = function (stationDom, stationGroup) {
            var stationText = stationGroup[Math.round(Math.random() * (stationGroup.length - 1))];
            $(stationDom).val(stationText);
        }

        setInterval(function () {
            if ($("#query_ticket").text() == "停止查询") {
                resetStation("#fromStation", fromStations);
                resetStation("#toStation", toStations);
                queryTimes++;
            }
        }, 1000);
    }
