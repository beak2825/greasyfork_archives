...
// @include     http://es1.the-west.es/game.php*
// @copyright  2014+, neversleep1911
// @downloadURL https://update.greasyfork.org/scripts/7326/Vendetta%20Duel%20Rating.user.js
// @updateURL https://update.greasyfork.org/scripts/7326/Vendetta%20Duel%20Rating.meta.js
// ==/UserScript==
...
(function (func) {
    ...
    TW_DuelRating.showMainWindow = function() {
        ...
        TW_DuelRating.gui.table
        	.appendToThCell('head', 'vdr_player_rank', 'Rango', 'Rango')
        	.appendToThCell('head', 'vdr_player_name', 'Nombre personaje', 'Nombre personaje')
        	.appendToThCell('head', 'vdr_player_duel_win', 'Victorias', 'Vict.')
        	.appendToThCell('head', 'vdr_player_duel_loss', 'Derrotas', 'Derr.')
        	.appendToThCell('head', 'vdr_player_duel_diff', 'Diferencia', 'Dif.')
        	.appendToThCell('head', 'vdr_player_duel_win_percent', '% Victorias', 'Vict. %');
        ...
        button = new west.gui.Button('Monkey Island', function() { TW_DuelRating.updateTable(1251); });
        footer.append($(button.getMainDiv()).css({ position: 'absolute', right: 0, top: '6px' }));
        TW_DuelRating.gui.buttons.push(button);

        button = new west.gui.Button('Black_Block', function() { TW_DuelRating.updateTable(2564); });
