...
// @downloadURL https://update.greasyfork.org/scripts/523398/Auto%20BUY%20V59%20Up%2064.user.js
// @updateURL https://update.greasyfork.org/scripts/523398/Auto%20BUY%20V59%20Up%2064.meta.js
// ==/UserScript==
...
(function () {
    ...
    function getHighestStockResource() {
        ...
        if (woodStock >= ironStock && woodStock >= stoneStock && woodStock > 63) {
            return { type: 'wood', stock: woodStock };
        } else if (stoneStock >= woodStock && stoneStock >= ironStock && stoneStock > 63) {
            return { type: 'stone', stock: stoneStock };
        } else if (ironStock > 63) {
    ...
    function autoFill() {
        ...
        if (resource) {
            ...
            let buyAmount = 63* Math.floor(resource.stock / 63);
