...
// @downloadURL https://update.greasyfork.org/scripts/443211/Nitro%20Type%20-%20Safe%20Space.user.js
// @updateURL https://update.greasyfork.org/scripts/443211/Nitro%20Type%20-%20Safe%20Space.meta.js
// ==/UserScript==
...
.nt-safe-space-chatroom-reply-sticker-shortcut, .nt-safe-space-chatroom-reply-toolbar-option-shortcut {
    ...
    let userStickers = raceObj.userStickers.filter((s) => s.equipped).sort((a, b) => a.equipped - b.equipped).map(s => s.lootID)
