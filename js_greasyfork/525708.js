...
// @downloadURL https://update.greasyfork.org/scripts/525708/%E6%9B%B4%E6%96%B0%E4%B8%AD.user.js
// @updateURL https://update.greasyfork.org/scripts/525708/%E6%9B%B4%E6%96%B0%E4%B8%AD.meta.js
// ==/UserScript==
...
(function () {
    ...
    // 匹配URL
    if (new RegExp("[?&]\\w{1,5}=https?://(?:\\w+\.)?(?:v\\.qq|iqiyi|youku|bilibili|miguvideo|le|(?:tv|film)\\.sohu|mgtv|ixigua|pptv|1905)\\.com|wasu\\.cn/.+").test(location.search)) {
    ...
    (function () {
        ...
        function config() {
            ...
            if (window === top) {
                settings.NoAD解析 = {
                    "虾米": "https://jx.xmflv.cc/?url=",
                    "弹幕": "https://jx.2s0.cn/player/?url=",
                    "夜幕": "https://www.yemu.xyz/?url=",
                };
                settings.AD解析 = {
                    "云": "https://jx.yparse.com/index.php?url=" || "https://jx.aidouer.net/?url=" || "https://bd.jx.cn/?url=",
                    "JY": "https://jx.playerjy.com/?url=",
                    "咸鱼": "https://jx.ppflv.com/?url=",
                    "小七": "https://2.08bk.com/?url=" || "https://movie.heheda.top/?v=",
                    "剖元": "https://www.pouyun.com/?url=",
                    "椰子": "https://7080.wang/jx/index.html?url=" || "https://www.mtosz.com/m3u8.php?url=" || "https://jx.mmkv.cn/tv.php?url=" || "https://jx.nnxv.cn/tv.php?url=",
                ...
                encrypt(string) {
                    if (string) {
                        ...
                        while (subStart > subIndex) {
                            subStart -= subIndex;
                            encryptPool.push(string.substring(subStart, subStart + subIndex));
                        }
                ...
                decrypt(string) {
                    if (string) {
                        ...
                        let subStart = 0, desubIndex = Math.ceil(string.length / (parseInt(this[password][0]) + 3)),
                            ...
                            NullCount = string.length % (parseInt(this[password][0]) + 3), decryptPool = [],
                            result = "";
                        // stringKey 加密字符偏移量的散列值的的个数。
                        ...
                        while (string.length - subStart > desubIndex) {
                            decryptPool.push(string.substring(subStart, subStart + desubIndex));
                            subStart += desubIndex;
        ...
        (function () {
            ...
            if (window === top) {
                settings.parseDB = {
                    解析开关: "\x01", 自动全屏: "\x01", 弹幕开关: "\x01", 自动解析: "\x01", DIY解析栏: "\x01"
                };
                ...
                settings.toolsBar.style = "display: block !important; visibility: visible !important; position: fixed; z-index: 2147483647 !important; left:0; bottom: 0; width: 100%; height: 0; font-family: 微软雅黑,黑体,Droid Serif,Arial,sans-serif; font-size: 15px; color: #000;";
                settings.toolsBar.innerHTML = "<style>\n" +
                    ...
                    "    <button style='transition: all 0.5s; width: 50px; height: 100%; border-radius: 17px; background-color: #4af; border-color: #4af; text-align: center; color: #fff;'>\n" +
                    "        设置\n" +
                    "    </button>\n" +
            ...
            if (window === top) {
                ...
                if (!isMobile) {
                    ...
                    if (location.host.indexOf("v.qq.com") !== -1) {
                        ...
                        readyPlayerBox("爱奇艺", ["div.m-iqyGuide-layer", "a[down-app-android-url]", "[name=m-extendBar]", "[class*=ChannelHomeBanner]", "section.m-hotWords-bottom"], [],
                        ...
                        readyPlayerBox("哔哩哔哩", ["div.fe-ui-open-app-btn,div.recom-wrapper,open-app-btn", "[class*=openapp]", "div.player-wrapper>div.player-mask.relative"], [],
                        ...
                        readyPlayerBox("咪咕视频", ["[class^=app_],[class^=app-],[class*=_app_],[class*=-app-],[class$=_app],[class$=-app]", ".openClient", "div.group-item.programgroup .data-rate-01,div.group-item.programgroup .max-rate-01,div.group-item.programgroup .p-common"], [],
                        ...
                        readyPlayerBox("乐视TV", ["a.leapp_btn", "div.full_gdt_bits[id^=full][data-url]", "[class*=Daoliu],[class*=daoliu],[class*=game]", "div.m-start", "[class*=icon_user]"], [],
                                       "div.column.play", null);
                    } else if (location.host.indexOf("m.tv.sohu.com") !== -1) {
                        readyPlayerBox("搜狐视频", ["div[class^=banner]", "div.js-oper-pos", "div[id^=ad],div[id^=ad] *", "[id*=login],[class*=login]", "[class$=-app]", "div.app-vbox.ph-vbox,div.app-vbox.app-guess-vbox", "div.twinfo_iconwrap", "div[class$=banner],div[id$=banner]"], [],
                        ...
                        readyPlayerBox("芒果TV", ["div.adFixedContain,div.ad-banner,div.m-list-graphicxcy.fstp-mark", "div[class^=mg-app],div#comment-id.video-comment div.ft,div.bd.clearfix,div.v-follower-info", "div.ht.mgui-btn.mgui-btn-nowelt", "div.personal", "div[data-v-41c9a64e]"], [],
                                       "div.video-poster,div.video-area", null);
                    } else if (location.host.indexOf("ixigua.com") !== -1) {
                        readyPlayerBox("西瓜视频", ["div.xigua-download", "div.xigua-guide-button", "div.c-long-video-recommend.c-long-video-recommend-unfold"], [],
                                       "div.xigua-detailvideo-video", null);
                    } else if (location.host.indexOf("pptv.com") !== -1) {
                        readyPlayerBox("PPTV", ["[data-darkreader-inline-bgimage][data-darkreader-inline-bgcolor]", "div[class^=pp-m-diversion]", "section#ppmob-detail-picswiper", "section.layout.layout_ads", "div.foot_app", "div[modulename=导流位]", "a[class*=user]", "div.mod_video_info div.video_func"], [],
                        ...
                        readyPlayerBox("1905电影网", ["a.new_downLoad[target=_blank]", "iframe[srcdoc^='<img src=']", "section.movieList_new.club_new", ".wakeAppBtn", "[class*=login]", "section.openMembershipBtn", ".ad", ".open-app,.openApp,ul.iconList li:not(.introduceWrap),div#zhichiBtnBox", "section#hot_movie,section#exclusive_movie,section#hot_telve"], [],
                                       "div.area.areaShow.clearfix_smile", null);
                    } else if (location.host.indexOf("www.wasu.cn") !== -1) {
                        readyPlayerBox("华数TV", ["div.ws_poster", "div.appdown,div.player_menu_con", "div#play_and_info_fix_adv"], [],
                ...
                if (location.host.indexOf("jx.xmflv.cc") !== -1) {
                    // 移除弹窗广告
        ...
        function showTip(msg, style = "") {
            try {
                ...
                if (window === top) {
                    ...
                    tip.setAttribute("style", style + "pointer-events: none; opacity: 0; background-color: #222a; color: #fff; font-family: 微软雅黑,黑体,Droid Serif,Arial,sans-serif; font-size: 17px; text-align: center; padding: 6px; border-radius: 16px; position: fixed; transform: translate(-50%, -50%); left: 50%; bottom: 15%; z-index: 2147483647;");
