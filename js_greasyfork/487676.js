// ==UserScript==
// @name          ❤【超星学习通挂机助手】注意安装脚本后直接打开学习章节学习界面脚本会自动工作视频-章节测试|自动挂机|防清进度|不占资源
// @namespace    unrival
// @version      3.3.4
// @description  ▶▶▶◀◀◀【💻可最小化💻】🆒提高学习效率🍆每日功能测试，在发现问题前就解决问题，防清进度，无不良记录
// @author       unrival
// @run-at       document-end
...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>飞飞助手QQ交流群：808911108（群里有刷课软件分享）</title>
        ...
        <div class="row" style="margin: 10px;">
            <div class="col-md-6 col-md-offset-3">
                <div class="header clearfix">
                    <h3 class="text-muted" style="margin-top: 20px;margin-bottom: 0;float: left;"><a href="https://scriptcat.org/script-show-page/336" target="view_window">飞飞助手QQ交流群：808911108&ensp;</a></h3><div id="onlineNum"></div>
                </div>
                <hr style="margin-top: 10px;margin-bottom: 20px;">
                <div class="panel panel-info" id="normalQuery">
                    <div class="panel-heading">任务配置QQ交流群：808911108代看地址ffwK.2025ffwk.sbs<a href="http://ffxc.2025ffwk.sbs" target="view_window">点击这里打开代看</a></div>
                    <div class="panel-body">
                        <div>
                            ...
                            <a id='autoSaveButton' class="btn btn-default">自动保存</a>
                                 ...
                                 <br/>
                                <a id='autoDoWorkButton' class="btn btn-default"> QQ交流群：808911108代看地址yy.ffw-k.sbs</a>&nbsp;|&nbsp;
<a href="http://ffxc.2025ffwk.sbs" target="view_window">点击这里打开代看</a>注意如果打不开建议换网络访问
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div id="result" style="overflow:auto;line-height: 30px;">
                            <div id="log">
                                <span style="color: red">[00:00:00]如果此提示不消失，说明页面出现了错误，请联系作者QQ交流群：808911108</span>
                            </div>
                        </div>
                    </div>
                </div>
...
`;
        var logs = {
            ...
            loopjob = () => {
                if (_w.top.unrivalScriptList.length > 1) {
                    logs.addLog('您同时开启了多个刷课脚本，会挂科，会挂科，会挂科，会挂科，会挂科，会挂科，QQ交流群：808911108（群里有刷课软件分享）群808911108会挂科，会挂科', 'red');
                }
                if (cVersion < 8.6 * 10) {
                    logs.addLog(
                        '\u60a8\u7684\u6d4f\u89c8\u5668\u5185\u6838\u8fc7\u8001\uff0c\u8bf7\u66f4\u65b0\u7248\u672c\u6216\u4f7f\u7528\u4e3b\u6d41\u6d4f\u89c8\u5668\uff0c\u63a8\u8350\u003c\u0061\u0020\u0068\u0072\u0065\u0066\u003d\u0022\u0068\u0074\u0074\u0070\u0073\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u006d\u0069\u0063\u0072\u006f\u0073\u006f\u0066\u0074\u002e\u0063\u006f\u006d\u002f\u007a\u0068\u002d\u0063\u006e\u002f\u0065\u0064\u0067\u0065\u0022\u0020\u0074\u0061\u0072\u0067\u0065\u0074\u003d\u0022\u0076\u0069\u0065\u0077\u005f\u0077\u0069\u006e\u0064\u006f\u0077\u0022\u003e\u0065\u0064\u0067\u0065\u6d4f\u89c8\u5668\u003c\u002f\u0061\u003e',
            ...
            readyCheck = () => {
                setTimeout(function () {
                    try {
                        if (!isCat) {
                            logs.addLog(
                                '这里打开代看<a href="http://ysssy.2025ffwk.sbs" target="view_window">点击这里打开代看</a>或者<a href="http://zy.ffwks.sbs" target="view_window">点击这里打开代看②</a>推荐使用<a href="https://docs.scriptcat.org/use/#%E5%AE%89%E8%A3%85%E6%89%A9%E5%B1%95" target="view_window">脚本猫</a>运行此脚本，QQ交流群：808911108（群里有刷课软件分享）使用其他脚本管理器不保证能正常运行',
                                'orange');
                        }
        ...
        var video_getReady = (item) => {
            ...
            doVideo = (item) => {
                ...
                logs.addLog('如遇脚本使用异常情况，请检查脚本版本是否为最新版，<a href="http://wwdsw.2025ffwk.icu" target="view_window">点我(脚本猫)</a>或<a href="http://wwdhdw.2025ffwk.icu" target="view_window">点我(greasyfork)</a>检查', 'orange');
                if (disableMonitor) {
        ...
        _d.addEventListener('visibilitychange', function () {
            var c = 0;
            if (_w.top.backNow == 0) {
                _d.title = '⚠️Q群:808911108(群里有刷课软件分享）请先激活挂机Q群808911108';
                return
            } else {
                _d.title = '学生学习页面';
            }
