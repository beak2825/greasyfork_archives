...
// @description  Предложения по улучшению скрипта писать сюда ---> https://vk.com/neo_krest
// @description:ru Предложения по улучшению скрипта писать сюда ---> https://vk.com/neo_krest
// @description:uk Приятного использования ---> https://vk.com/neo_krest
// @version 0.03
...
// @grant        none
// @license    MIT
// @supportURL https://vk.com/neo_krest
// @icon https://emoji.gg/assets/emoji/9372-blurple-boost-level-9.png
// @downloadURL https://update.greasyfork.org/scripts/505307/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20GROZNY%20%7C%20Black%20Russia.user.js
// @updateURL https://update.greasyfork.org/scripts/505307/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20GROZNY%20%7C%20Black%20Russia.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      title: `Мало дат`,
      content:
        `[Color=rgb(255, 0, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br><br>` +
        `[CENTER][B][I][FONT=georgia]Укажите больше дат, в каком возрасте у вашего персонажа происходили какие-либо события.[/CENTER]<br><br>`+
        `[CENTER][B][I][Color=rgb(255, 0, 0)][FONT=Georgia][CENTER][I]Отказано[/CENTER][/color]`,
    ...
    },
    {
      ...
      content:
        `[Color=rgb(255, 0, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br><br>` +
        `[CENTER][B][I][FONT=georgia]Имя и Фамилия в заголовке темы должны быть написаны в родительном падеже.[/CENTER]<br><br>`+
        `[CENTER][B][I][Color=rgb(255, 0, 0)][FONT=Georgia][CENTER][I]Отказано[/CENTER][/color]`,
      prefix: NARASSMOTRENIIBIO_PREFIX,
       status: false,
    },
    {
      title: `Детство + Ю. Вз Ж`,
      content:
        `[Color=rgb(222, 0, 0)][FONT=Georgia][CENTER][I]{{ greeting }},уважаемый {{ user.mention }}.[/color][/CENTER]<br>` +
        `[Color=rgb(255, 255, 255)][FONT=Georgia][CENTER][I]Детство начинается с 1 года до 14 лет.[/color][/CENTER]` +
        `[Color=rgb(255, 255, 255)][FONT=Georgia][CENTER][I]Юность начинается с 14-15 лет.[/color][/CENTER]<br>` +
        `[Color=rgb(222, 0, 0)][FONT=Georgia][CENTER][I]Отказано.[/color][/CENTER]` ,
