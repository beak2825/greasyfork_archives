 // ==UserScript==
// @name        2020 MouseHunt AutoBot
// @author      Ooi Keng Siang, CnN, Hunter12345, iJiB
// @version    	2020.09.24
// @namespace   http://ooiks.com/blog/mousehunt-autobot, https://devcnn.wordpress.com/
// @description An advance user script to automate sounding the hunter horn in MouseHunt
...
// @grant		unsafeWindow
// @grant		GM_info
// @downloadURL https://update.greasyfork.org/scripts/375435/2020%20MouseHunt%20AutoBot.user.js
// @updateURL https://update.greasyfork.org/scripts/375435/2020%20MouseHunt%20AutoBot.meta.js
// ==/UserScript==
...
var objBestTrap = {
    weapon : {
        arcane : ['New Horizon','Infinite Winter Horizon','Event Horizon','Droid Archmagus','Chrome Grand Arcanum','Chrome Arcane Capturing Rod','Grand Arcanum','Anniversary Arcane Capturing Rod Of Never Yielding Mystery','Arcane Capturing Rod Of Nev','Sprinkly Cupcake Surprise','Arcane Blast'],
        ...
        forgotten : ['Infinite Labyrinth','Endless Labyrinth','Crystal Mineral Crusher','Crystal Crucible','Festive Forgotten Fir','Stale Cupcake Golem','Scarlet Ember Root','Tarannosaurus Rex','The Forgotten Art of Dance','Anniversary Ancient Box','Ancient Box'],
        hydro : ['Queso Fount','School of Sharks','Rune Shark','Chrome Phantasmic Oasis','Phantasmic Oasis','Bubbles: The Party Crasher','Chrome Oasis Water Node','Oasis Water Node','Haunted Shipwreck','Glacier Gatler','Steam Laser Mk. III','Steam Laser Mk. II'],
        law : ['Ember Prison Core','Meteor Prison Core','Judge Droid','Surprise Party','Christmas Cactus','Law Laser','Engine Doubler','Bandit Deflector','Supply Grabber','S.L.A.C. II','The Law Draw','S.L.A.C'],
        physical : ['Smoldering Stone Sentinel','Chrome MonstroBot','Sandstorm MonstroBot','Sandtail Sentinel','Rocket Propelled Gavel','Chrome RhinoBot','New Year\'s Fireworks','Warden Slayer','Enraged RhinoBot','Isle Idol','Chrome Onyx Mallet','RhinoBot'],
        rift : ['Chrome Celestial Dissonance','Celestial Dissonance','Timesplit Dissonance','Mysteriously unYielding','Focused Crystal Laser','Biomolecular Re-atomizer','Christmas Crystalabra','Multi-Crystal Laser','Crystal Tower'],
        ...
        tactical : ['Gouging Geyserite','Chrome Sphynx Wrath','Sphynx Wrath','Dimensional Chest','Chesla\'s Revenge','Zugzwang\'s Ultimate Move','Well of Wisdom','Isle Idol','Zugzwang\'s First Move','Veiled Vine','Horrific Venus Mouse','Thorned Venus Mouse','Blackstone Pass'],    },

    base : {
		luck : ['Minotaur Base','Glowing Golem Guardian Base','Fissure Base','Rift Base','Attuned Enerchi Induction Base','Monkey Jade Base','Sheep Jade Base','Depth Charge Base','Horse Jade Base','Snake Jade Base','Dragon Jade Base','Eerier Base','Papyrus Base'],
...
function embedTimer(targetPage) {
    if (showTimerInPage) {
        ...
        if (headerElement) {
			...
			preferenceHTMLStr += '<option value="Celestial Dissonance">Cel Dis</option>';
...
function soundHorn() {
    ...
    if (!aggressiveMode) {
        ...
        var headerElement = (isNewUI) ? document.getElementById('mousehuntHud').firstChild : document.getElementById('envHeaderImg');
        if (headerElement) {
            // need to make sure that the timer is ready before we can click on it
            var headerStatus = headerElement.getAttribute('class');
            headerStatus = headerStatus.toLowerCase();
            if (document.getElementsByClassName('mousehuntHud-hornTimer')[0].innerText == "Ready!") {
                // timer is ready, let's sound the horn!
