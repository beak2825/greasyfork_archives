...
// @downloadURL https://update.greasyfork.org/scripts/423989/ms_argos_log.user.js
// @updateURL https://update.greasyfork.org/scripts/423989/ms_argos_log.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function() {
        let timer = setInterval(function () {
            if (location.pathname.includes('/keyword_search')) {
