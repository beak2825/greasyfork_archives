...
// @include        *://*.ogame.gameforge.*/game/admin2/uebersicht.php?session=*&user*
// @version        06/12/2015
// @grant        GM_addStyle
// @grant        GM_xmlhttpRequest
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/28183/OGameBadWordFinder.user.js
// @updateURL https://update.greasyfork.org/scripts/28183/OGameBadWordFinder.meta.js
// ==/UserScript==
	...
	function DoModify(){
		...
		GM_xmlhttpRequest({
			...
			// type here the URL with the badwords
			 url: 'http://paci.comastuff.com/OGtools/bw.html',
