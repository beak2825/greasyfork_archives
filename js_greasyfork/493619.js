// ==UserScript==
// @name         Скрипт для Куратора Адм Volodya_Medvedev || Purple
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/493619/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%90%D0%B4%D0%BC%20Volodya_Medvedev%20%7C%7C%20Purple.user.js
// @updateURL https://update.greasyfork.org/scripts/493619/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%90%D0%B4%D0%BC%20Volodya_Medvedev%20%7C%7C%20Purple.meta.js
// ==/UserScript==
               ...
               },
 {
               ...
               },
    {
	  ...
	  content:
		"[FONT=courier new][B][CENTER][COLOR=RED][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/4dCP7byM/GFL6g.png[/img][/url][/CENTER]' +
        "[FONT=courier new][B][CENTER][COLOR=WHITE]Если Вы не согласны с решением Технического Специалиста, обратитесь в раздел жалоб на Технических специалистов. <br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/4dCP7byM/GFL6g.png[/img][/url][/CENTER]' +
        "[FONT=courier new][B][CENTER][COLOR=WHITE]С уважением, [/COLOR][COLOR=RED]Куратор Администрации[/COLOR] - Volodya_Medvedev.<br>",
        	      prefix: CLOSE_PREFIX,
      status: false
               ...
               },
{
	  ...
	  content:
		"[FONT=courier new][B][CENTER][COLOR=RED][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/4dCP7byM/GFL6g.png[/img][/url][/CENTER]' +
        "[FONT=courier new][B][CENTER][COLOR=WHITE]Вы ошиблись разделом.<br>Обратитесь в технический раздел. <br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/4dCP7byM/GFL6g.png[/img][/url][/CENTER]' +
        "[FONT=courier new][B][CENTER][COLOR=WHITE]С уважением, [/COLOR][COLOR=RED]Куратор Администрации[/COLOR] - Volodya_Medvedev.<br>",
        	      prefix: CLOSE_PREFIX,
      status: false
               ...
               },
    {
	  ...
	  content:
		"[FONT=courier new][B][CENTER][COLOR=RED][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/4dCP7byM/GFL6g.png[/img][/url][/CENTER]' +
        "[FONT=courier new][B][CENTER][COLOR=WHITE]Жалоба/биография будет пересмотрена [/COLOR][COLOR=BLUE]Главным Куратором Форума.[/COLOR] <br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/4dCP7byM/GFL6g.png[/img][/url][/CENTER]' +
        "[FONT=courier new][B][CENTER][COLOR=WHITE]С уважением, [/COLOR][COLOR=RED]Куратор Администрации[/COLOR] - Volodya_Medvedev.<br>",
        	      prefix: CLOSE_PREFIX,
      status: false
