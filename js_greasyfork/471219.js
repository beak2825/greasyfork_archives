// ==UserScript==
// @name        Gray | Скрипт для ГА/ЗГА/КУРАТОРОВ/ГКФ/ЗГКФ
// @namespace    https://forum.blackrussia.online
// @version      1.99
// @description  По вопросам обратная связь в Вк: https://vk.com/lmhokage
// @author      Takesha_Hokage
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license      MIT
// @collaborator
// @icon https://sun6-21.userapi.com/s/v1/ig2/UGa8FKXwf5vw2zu5q8NRJNuY5MvIMGKdl02Qd_OJb7CCWAOSI4Lt95v9NCIZrvUWDaeFbM5DS3Yvtugnn9iOPc_F.jpg?size=912x912&quality=95&crop=28,39,912,912&ava=1
// @downloadURL https://update.greasyfork.org/scripts/471219/Gray%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D0%A3%D0%A0%D0%90%D0%A2%D0%9E%D0%A0%D0%9E%D0%92%D0%93%D0%9A%D0%A4%D0%97%D0%93%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/471219/Gray%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D0%A3%D0%A0%D0%90%D0%A2%D0%9E%D0%A0%D0%9E%D0%92%D0%93%D0%9A%D0%A4%D0%97%D0%93%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
const buttons = [
	{
	  ...
	  content:
        ...
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#00BFFF]Gray[/COLOR].<br><br>"+
...
},
{
	...
	},
     {
      ...
      content:
		       ...
		       '[CENTER][FONT=TIMES NEW ROMAN] [COLOR=YELLOW]  На рассмотрении [/COLOR][/FONT] [/CENTER]'+
		        "[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 100, 0)][B][SIZE=1]Gray[/SIZE][/B][/COLOR]",
	  prefix: PIN_PREFIX,
	  status: true,
    },
	 {
	...
	"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]Gray[/SIZE][/B][/COLOR]",
	  prefix: TEX_PREFIX,
	  status: false,
    },	
    ...
    },
{
 ...
 '[CENTER][FONT=TIMES NEW ROMAN] [COLOR=RED]  Отказано [/COLOR][/FONT] [/CENTER]', 
    ...
    },
	{
	  ...
	  content:
		'[B][CENTER][FONT=TIMES NEW ROMAN][COLOR=MediumPurple]{{greeting}}, уважаемый {{ user.name }}.[/color][/CENTER]<br>' +
