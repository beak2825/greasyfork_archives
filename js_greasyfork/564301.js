// ==UserScript==
// @name         YouMind Code Collapse (Default Expanded)
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  YouMind 代码块折叠功能，默认状态：[展开]
// @author       YouMind User
// @match        https://youmind.com/*
// @match        https://*.youmind.com/*
// @grant        GM_addStyle
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/564301/YouMind%20Code%20Collapse%20%28Default%20Expanded%29.user.js
// @updateURL https://update.greasyfork.org/scripts/564301/YouMind%20Code%20Collapse%20%28Default%20Expanded%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    function initCodeCollapse() {
        ...
        function processBlock(pre) {
            ...
            // 2. 创建头部 (默认展开样式)
            // 注意：不添加 ym-header-collapsed 类，文字设为 Collapse
            const header = document.createElement('div');
            header.className = HEADER_CLASS;
            header.innerHTML = `
                <span class="ym-label">Code</span>
                <span class="ym-btn-text">Collapse</span>
            `;

            // 3. 默认展开，不添加 ym-collapsed 类
