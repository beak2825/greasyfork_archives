// ==UserScript==
// @name         Geoguessr Blink Mode (duels fix)
// @description  Original made by macca7224 & victheturtle | Shows the round briefly, then screen goes black and you have unlimited time to make your guess.
// @version      1.4.0
// @author       Rawblocky, macca7224
// @license      MIT
...
// @downloadURL https://update.greasyfork.org/scripts/550637/Geoguessr%20Blink%20Mode%20%28duels%20fix%29.user.js
// @updateURL https://update.greasyfork.org/scripts/550637/Geoguessr%20Blink%20Mode%20%28duels%20fix%29.meta.js
// ==/UserScript==
...
const checkStatus = () => {
    if (!(location.pathname.includes('/duels')) && !(location.pathname.includes('/multiplayer'))) {
        return;
    }
