// ==UserScript==
// @name         Брендинг шаблоны only Романова без защиты от мисскликов
// @version      1.0.14
...
// @downloadURL https://update.greasyfork.org/scripts/424199/%D0%91%D1%80%D0%B5%D0%BD%D0%B4%D0%B8%D0%BD%D0%B3%20%D1%88%D0%B0%D0%B1%D0%BB%D0%BE%D0%BD%D1%8B%20only%20%D0%A0%D0%BE%D0%BC%D0%B0%D0%BD%D0%BE%D0%B2%D0%B0%20%D0%B1%D0%B5%D0%B7%20%D0%B7%D0%B0%D1%89%D0%B8%D1%82%D1%8B%20%D0%BE%D1%82%20%D0%BC%D0%B8%D1%81%D1%81%D0%BA%D0%BB%D0%B8%D0%BA%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/424199/%D0%91%D1%80%D0%B5%D0%BD%D0%B4%D0%B8%D0%BD%D0%B3%20%D1%88%D0%B0%D0%B1%D0%BB%D0%BE%D0%BD%D1%8B%20only%20%D0%A0%D0%BE%D0%BC%D0%B0%D0%BD%D0%BE%D0%B2%D0%B0%20%D0%B1%D0%B5%D0%B7%20%D0%B7%D0%B0%D1%89%D0%B8%D1%82%D1%8B%20%D0%BE%D1%82%20%D0%BC%D0%B8%D1%81%D1%81%D0%BA%D0%BB%D0%B8%D0%BA%D0%BE%D0%B2.meta.js
// ==/UserScript==
...
const branding = [
  ...
  uber = [
    ...
    {
      only:
        'брендирование данного типа неактуально и не соответствует требованиям сервиса. Обновите брендирование в соответствии с новыми требованиями',
    },
    {
      only:
        'брендирование не соответствует требованиям сервиса. Размещать любую рекламу на брендированном автомобиле можно только по согласованию',
    },
  ...
  lightbox_rf = [
      ...
      {only: 'cветовой короб попал в кадр не полностью',},
      {only: 'брендированная наклейка на световом коробе не просматривается',},
...
head.append(style);
style.innerHTML =
  '.templates-item{border-bottom: 1px solid #cacaca; padding: 4px 8px;}.template-head{background-color:#d8e6ea;font-weight:bold;padding:2px 10px}.templates-item:hover{background-color: #f3f3f3; cursor: pointer}';
  ...
  return arr
    .map((i) => {
      if (i.th) {
        ...
        if (i.menu) {
          return `<li itemvalue='${i.translate}' class='templates-item' style="background-color: #b6d7a8;">${i.text}</li>`;
        } else {
...
btnRemarks.addEventListener('click', () => {
  ...
  fnTranslate([...lightbox, ...lightbox_rf], selectCity());
});
