// ==UserScript==
// @name         AutoClickShortlink
// @namespace    Shortlink
// @version      1.1
// @description  Multi Shortlink Auto Click
// @author       Saputra
// @match        https://vsl.one/*
...
(function() {
   ...
   var websiteData = [
        ...
        {url : "https://sports4dbtc.com/shortlinks.html", login: "", password: ""},
        {url : "https://vsl.one", login: "", password: ""},
    ];

    var websiteMap = [{

            website: ["sports4dbtc.com"],
            defaultButtonSelectors: [".card-body.p-1 .btn.btn-success.btn-sm"],
            timeoutbeforeMovingToNextUrl: 12000
...

        {
            ...
            website: ["vsl.one"],
            defaultButtonSelectors: [".card-body.p-1 .btn.btn-success.btn-sm"],
            timeoutbeforeMovingToNextUrl: 15000
    ...
    function mad() {
        ...
        if(document.querySelector("body").innerText.includes("This ad does not exist or has expired")){
            window.location.href = "https://mad.fun/link/";
        }
