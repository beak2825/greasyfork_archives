...
// @downloadURL https://update.greasyfork.org/scripts/33231/5chBBSViewserSP.user.js
// @updateURL https://update.greasyfork.org/scripts/33231/5chBBSViewserSP.meta.js
// ==/UserScript==
    ...
    for(var a=0; a<kids.length; a++){
      ...
      if(kid.nodeType == 3){
        kid.nodeValue = kid.nodeValue
          ...
          .replace(/hhttp:/g  , "http:")
          .replace(/^(.*?)(B0[0-Z]{8,8})(.*?)$/gm  , "https://www.amazon.co.jp/exec/obidos/ASIN/$2/\n\r($1$2$3)")
        ;
      }else{
...
$(function () {
  $('a').each(function () {
    ...
    if (end == "jpg" || end == "png" || end == "gif" || end == "bmp" || end == "rge" || end == "rig") {
      $(this).after($('<a href=' + addres + ' target="_blank"><img src=' + addres + ' style="max-width:100%;"></a></br>'));
    }
  });
});
