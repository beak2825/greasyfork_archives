...
// @downloadURL https://update.greasyfork.org/scripts/551816/%E5%9C%96%E7%89%87%E7%80%8F%E8%A6%BD%E5%99%A8ME.user.js
// @updateURL https://update.greasyfork.org/scripts/551816/%E5%9C%96%E7%89%87%E7%80%8F%E8%A6%BD%E5%99%A8ME.meta.js
// ==/UserScript==
...
if (bool_run) {
    ...
    <div id="img_box" style="display:none;">
        <div class="img_tit">
            ...
            <button id="but_rotate_left" title="向右旋轉" onclick="fun_rotateLeft()" style="font-size:24px; font-weight:bold; color:#FFFFFF;">&gt;</button>
            <button id="but_rotate_right" title="向左旋轉" onclick="fun_rotateRight()" style="font-size:24px; font-weight:bold; color:#FFFFFF;">&lt;</button>
    ...
    function main() {
        ...
        document.getElementById("but_rotate_left").onclick = function () {
            fun_rotateLeft();
        };
        document.getElementById("but_rotate_right").onclick = function () {
            fun_rotateRight();
        };
    ...
    //圖片旋轉 -90度
    function fun_rotateLeft() {
        img_rotation -= 90;
        if (img_rotation <= -360) {
            img_rotation = 0;
        }
        obj_img.style.transform = "rotate(" + img_rotation + "deg)";
    }

    //圖片旋轉 +90度
    function fun_rotateRight() {
        img_rotation += 90;
        if (img_rotation >= 360) {
            img_rotation = 0;
        }
