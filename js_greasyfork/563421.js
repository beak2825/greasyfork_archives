...
// @description  河北教师教育网-2025年中小学幼儿园教师全员远程培训项目。目前已经适配高等教育出版社，奥鹏教育，项目不同，可用的倍速不同，可全自动学习所有未完成课程！后续还会发布师学通和电视台项目。
...
class Utils {
    ...
    */
    ...
    // 高级功能按钮文字
    static vipBtnText="目前已经适配高等教育出版社，奥鹏教育，项目不同可用的倍速不同，可全自动学习所有未完成课程！后续还会发布师学通和电视台项目"
    // 网站ID，设置后可跳转到对应文档
    static webId='6953679e3f1a47e81a682ae0'
    // 脚本启动弹窗 的文字介绍，软件功能简介
    static swFireText="目前已经适配高等教育出版社，奥鹏教育，项目不同可用的倍速不同，可全自动学习所有未完成课程！后续还会发布师学通和电视台项目 。"
    // 详细的弹窗介绍文本，软件功能，可详细说明
    static softIntro="目前已经适配高等教育出版社最高50倍速，奥鹏教育常速，项目不同可用的倍速不同，可全自动学习所有未完成课程！后续还会发布师学通和电视台项目。"
