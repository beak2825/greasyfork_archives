...
// @author      Kerek, Tjololo, clickhappier, and feihtality and saqfish duh
...
// @downloadURL https://update.greasyfork.org/scripts/14713/HIT%20Scraper%20WITH%20EXPORT%20with%20next%20accept.user.js
// @updateURL https://update.greasyfork.org/scripts/14713/HIT%20Scraper%20WITH%20EXPORT%20with%20next%20accept.meta.js
// ==/UserScript==
...
var aonlabel = $("<label>").text("Accept Next");
var aonchk = document.createElement('input');
aonchk.type = 'checkbox';
aonchk.id = 'aonchk';
aonchk.onclick = function(eew) {
    if (this.checked) {
        aon=true;
        aonlabel.css('background-color','red');
    }else {
        aon=false;
        aonlabel.css('background-color','#384147');
    }
};
aonlabel.append(aonchk);
$('div.controlpanel_thClassic').append(aonlabel);
