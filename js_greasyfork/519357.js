...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/519357/RED%3A%20File%20Count.user.js
// @updateURL https://update.greasyfork.org/scripts/519357/RED%3A%20File%20Count.meta.js
// ==/UserScript==
  ...
  for (var i = rows.length; i--; ) {
    ...
    if (isMusic) {
      ...
      for (var j = numFiles; j--; ) {
        if (/\.(flac|mp3|m4a|ac3|dts|dsf|dff)\s*$/i.test(fileRows[j].cells[0].textContent)) {
          ++numTracks;
