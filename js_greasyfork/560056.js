// ==UserScript==
// @name         Coomer & Kemono: Auto-Load High-Res Images
// @name:zh-CN   Coomer & Kemono: 自动加载高清原图
// @name:zh-TW   Coomer & Kemono: 自動加載高清原圖
// @namespace    http://tampermonkey.net/
// @version      1.2
// @description  Automatically replace thumbnails with high-resolution original images on Coomer and Kemono websites. Works with scroll loading.
// @description:zh-CN 自动将Coomer和Kemono网站的缩略图替换为高清原图。支持滚动动态加载，无需手动点击。
// @description:zh-TW 自動將Coomer和Kemono網站的縮略圖替換為高清原圖。支持滾動動態加載，無需手動點擊。
// @author       Bennieqin
// @license      MIT
// @match        *://coomer.st/*
// @match        *://coomer.su/*
...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/560056/Coomer%20%20Kemono%3A%20Auto-Load%20High-Res%20Images.user.js
// @updateURL https://update.greasyfork.org/scripts/560056/Coomer%20%20Kemono%3A%20Auto-Load%20High-Res%20Images.meta.js
// ==/UserScript==
