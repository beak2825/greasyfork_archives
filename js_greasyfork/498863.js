...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/498863/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82.user.js
// @updateURL https://update.greasyfork.org/scripts/498863/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82.meta.js
// ==/UserScript==
...
`[COLOR=rgb(184, 49, 47)]Отказано[/COLOR],[S]закрыто.[/S] <br><br>`,
        ...
        },
 {
	...
	},
  {
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		" [CENTER][SIZE=4][FONT=georgia][SIZE=4][FONT=georgia]Ваша жалоба взята на рассмотрение ЗГА. [CENTER]<br><br>" +
             "Ожидайте, пожалуйста пока Администратор  вынесет вердикт[COLOR=rgb(184, 49, 47)] и не нужно создавать копии этой темы.[/COLOR][/FONT] <br><br>" +
		`  [CENTER] [COLOR=rgb(250, 197, 28)][FONT=georgia]На рассмотрении.[/FONT][/COLOR]<br><br>`,
        ...
        },
 {
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[SIZE=4][FONT=georgia]Передаю вашу жалобу Главному Администратору  - [USER=346772]@Dmitry Anatolyevic[/USER]  <br><br>"+
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Передаю вашу жалобу Специальной администрации.  <br><br>"+
        ` [CENTER][COLOR=rgb(250, 197, 28)][FONT=georgia]На рассмотрении. [/FONT][/COLOR][/SIZE] [CENTER] <br><br>`,
	...
	},
 {
     ...
     `[CENTER] Обратитесь  в раздел - [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.845/']Обжалование (кликабельно)[/URL]<br>`+
        `[CENTER] [COLOR=rgb(184, 49, 47)]Отказано[/COLOR],[S]закрыто.[/S] [CENTER] <br><br>`,
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба была одобрена, необходимые меры будет приняты.[/CENTER]<br>" +
