...
// @grant        GM_download
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/519627/Amazon%20Manga%20Downloader%20%28Imagenes%29.user.js
// @updateURL https://update.greasyfork.org/scripts/519627/Amazon%20Manga%20Downloader%20%28Imagenes%29.meta.js
// ==/UserScript==

(function() {
    'use strict';

    // Estilos CSS para la ventana de descargas (ahora rectangular y desplazable)
    GM_addStyle(`
        #downloadContainer {
            position: fixed;
            bottom: 20px;
