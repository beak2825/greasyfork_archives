// ==UserScript==
// @name         Extension Clan ?ω❥|Private Extension
// @namespace    Private Extension
// @version      2.0
// @description  Version editada del OGARio by szymy
// @author       Brayan
// @match        http://agar.io/*
// @run-at       document-start
// @grant        GM_xmlhttpRequest
// @connect      agar.io
// @downloadURL https://update.greasyfork.org/scripts/22968/Extension%20Clan%20%CF%89%E2%9D%A5%7CPrivate%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/22968/Extension%20Clan%20%CF%89%E2%9D%A5%7CPrivate%20Extension.meta.js
// ==/UserScript==

// Copyright © 2016 ogario.ovh

if (location.host == "agar.io" && location.pathname == "/") {
    location.href = "http://agar.io/Clan?ω❥" + location.hash;
    return;
}
...
function inicio() {
    document.title = "CLAN ?ω❥";
    modificarTextoMinimapa("By ZetaBlack");
    modificarTextoLeaderboard("CLAN ?ω❥");
    modificarCanalYoutube("Suscribanse al canal", "UC52JW6d475jx7izciHkfZCA");
    modificarFooter("Visita el grupo del CLAN ?ω❥","https://www.facebook.com/groups/306586019702473//?ref=nf_target&fref=nf");
    panelDerecho();
