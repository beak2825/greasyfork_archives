...
// @name         GM_config-lib
// @namespace    sizzle
// @version      fix-2023.05.09_orig-2021.11.21
// @description  GM_config is a user script library that allows the user to edit certain saved values through a graphical settings menu.
// @license      LGPL-3.0
// ==/UserLibrary==
// ==/UserScript==
/*
...
GM_configStruct.prototype = {
  ...
  close: function() {
	// fix: Uncaught TypeError: this.frame is null (on page redirect)
	if (this.frame) {
