// ==UserScript==
// @name         Discord HIT Exporter (Worker Site)
// @namespace    none
// @version      1.0
// @description  Allows you to export HITs in Discord friendly formatting.
// @author       Morgs
// @include      https://worker.mturk.com/*
// @grant        GM_setClipboard
// @downloadURL https://update.greasyfork.org/scripts/373857/Discord%20HIT%20Exporter%20%28Worker%20Site%29.user.js
// @updateURL https://update.greasyfork.org/scripts/373857/Discord%20HIT%20Exporter%20%28Worker%20Site%29.meta.js
// ==/UserScript==

//Based on [MTurk Worker] HIT Exporter by Kaduchi, edited for discord formatting by Morgs.

/* globals GM_setClipboard */

const hitExports = `plain` // Valid options are: `all`, `short`, `plain`, `bbcode` or `markdown`
const turkerview = false // Use turkerview in HIT exports
const turkopticon = false // Use turkopticon in HIT exports
const turkopticon2 = false // Use turkopticon2 in HIT exports
...
`@here :moneybag: :money_mouth: :moneybag:`,
`**Title:** ${hit.title}`,
`**Reward:** ${hit.monetary_reward.amount_in_dollars.toMoneyString()}`,
`**Panda:** https://worker.mturk.com/projects/${hit.hit_set_id}/tasks/accept_random`,
