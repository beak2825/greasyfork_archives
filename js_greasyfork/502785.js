...
// @downloadURL https://update.greasyfork.org/scripts/502785/%D0%9A%D0%BE%D0%BC%D0%B0%D0%BD%D0%B4%D0%B0%20Rus%20Mobile.user.js
// @updateURL https://update.greasyfork.org/scripts/502785/%D0%9A%D0%BE%D0%BC%D0%B0%D0%BD%D0%B4%D0%B0%20Rus%20Mobile.meta.js
    // ==/UserScript==
    ...
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
    	  prefix: PIN_PREFIX,
        status: false,
        },
    	{
    ...
    '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за вашу жалобу. Мы тщательно рассмотрели вашу жалобу и приняли решение [COLOR=rgb(0, 255, 0)]в вашу пользу[/COLOR][/size][/font][/CENTER]<br><br>' +
    ...
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
        },
        {
    	  ...
    	  content:
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за вашу жалобу. Понимаем, что нарушения правил могут быть неприятным опытом.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Однако, для проведения расследования и принятия соответствующих мер, нам необходимы дополнительные доказательства.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Просим вас предоставить нам больше информации и доказательств, чтобы мы могли принять необходимые меры в отношении нарушителя. Ваше сотрудничество и понимание важны для нас. Спасибо за ваше участие![/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
        ...
        },
        {
    	  ...
    	  content:
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за вашу жалобу.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]После проведения расследования мы пришли к выводу, что в данной жалобе мы не усмотрели нарушения правил игры.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Мы всегда стремимся поддерживать честную и справедливую игровую среду для всех участников. Ваша внимательность и активное участие в сообществе игры оцениваются нами. Спасибо за понимание![/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
    	prefix: UNACCEPT_PREFIX,
        status: false,
        },
        {
    	  ...
    	  content:
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за вашу жалобу. Мы провели расследование и пришли к выводу, что не можем наказать игрока.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Мы также хотим проинформировать вас, что игрок уже был наказан за данное нарушение. Мы всегда стремимся поддерживать честную и справедливую игровую среду для всех участников.[/size][/font][/CENTER]<br><br>' +
    ...
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
        ...
        },
        {
    	  ...
    	  content:
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за вашу жалобу. Однако, мы обнаружили, что данная жалоба является дубликатом предыдущей.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Мы постоянно работаем над обеспечением честной и справедливой игровой среды, и ваше активное участие в этом процессе важно для нас.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Если у вас возникнут новые обстоятельства или новые причины для жалобы, не стесняйтесь обращаться к нам снова. Спасибо за ваше сотрудничество![/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
    	prefix: UNACCEPT_PREFIX,
        status: false,
        },
        {
    	  title: 'Имя_Фамилия ник',
    	  content:
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    ...
    '[CENTER][size=15px][font=Trebuchet MS]Игрок понесет наказание, согласно пункту правил: [color=rgb(255,200,0)]2.1 [/color]Никнейм игрока должен быть в формате Имя_Фамилия, без каких-либо посторонних символов, цифр и так далее I [color=rgb(255,0,0)]Устное предупреждение / Смена Ника.[/color][/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Ваша активная позиция и участие в создании безопасного и приятного игрового опыта очень важны для нас. Спасибо за ваше участие. [/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
        },
        {
    ...
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за вашу жалобу. Мы тщательно рассмотрели вашу жалобу и приняли следующие решение:[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Игрок понесет наказание, согласно пункту правил: [color=rgb(255,200,0)]3.02 [/color]Запрещены любые формы покупки/продажи игрового аккаунта/имущества за реальные деньги |  [color=rgb(255,0,0)]Бан навсегда + Обнуление переданного имущества.[/color][/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Ваша активная позиция и участие в создании безопасного и приятного игрового опыта очень важны для нас. Спасибо за ваше участие. [/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
    ...
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]',
        ...
        },
        {
    	  title: 'Био одобрена',
    	  content:
	'[CENTER][img]https://forum.russia-game.ru/attachments/1720721601499-png.181/[/img][/CENTER]<br>'+
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    ...
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]<br><br>' +
	'[CENTER][img]https://forum.russia-game.ru/attachments/1720721601499-png.181/[/img][/CENTER]',
    	  prefix: ACCEPT_PREFIX,
        status: false,
        },
        {
    	  title: 'Био отказана мало инфы',
    	  content:
	'[CENTER][img]https://i.postimg.cc/qv7Hj67R/1.gif[/img][/CENTER]<br>'+
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    ...
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]В связи с тем, что информации в пунктах "Детство", "Юность и взрослая жизнь", "Настоящее время" - очень мало.<br>С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]<br><br>' +
	'[CENTER][img]https://i.postimg.cc/qv7Hj67R/1.gif[/img][/CENTER]',
    	prefix: UNACCEPT_PREFIX,
        status: false,
        },
        {
    ...
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за создание RP биографии. Ваша биография получает Статус: [Color=rgb(255, 00 ,0)]Отказано.[/color][/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Пожалуйста исправьте несостыковку в возрасте вашего персонажа.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]<br><br>' +
	'[CENTER][img]https://i.postimg.cc/qv7Hj67R/1.gif[/img][/CENTER]',
    	  prefix: UNACCEPT_PREFIX,
        status: false,
        ...
        },
	{
		...
		"content":
	'[CENTER][img]https://i.postimg.cc/qv7Hj67R/1.gif[/img][/CENTER]<br>'+
	'[CENTER][size=15px][font=Trebuchet MS]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)]{{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
	'[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за создание RP биографии. Ваша биография получает Статус: [color=rgb(255,00,0)]Отказано.[/color][/size][/font][/CENTER]<br><br>' +
	'[CENTER][size=15px][font=Trebuchet MS]Причиной тому послужило: Заголовок, оформленный не по форме, ознакомьтесь с правилами создания РП Биографии. Оформите заголовок по данной форме: [quote]Role Play биография персонажа - Имя_Фамилия[/quote][/size][/font][/CENTER]<br><br>' +
	'[CENTER][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]<br><br>' +
	'[CENTER][img]https://i.postimg.cc/qv7Hj67R/1.gif[/img][/CENTER]',
			prefix: "UNACCEPT_PREFIX",
		status: false
        },
    ...
    '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за создание RP биографии. Ваша биография получает Статус: [Color=rgb(255, 00 ,0)]Отказано.[/color][/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS]Причиной тому послужило: Копипаст.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старший Модератор Sera_Levante, [COLOR=rgb(255,200,0)]РУСЬ Mobile[/color].[/size][/font][/CENTER]<br><br>' +
	'[CENTER][img]https://i.postimg.cc/qv7Hj67R/1.gif[/img][/CENTER]',
    	  prefix: UNACCEPT_PREFIX,
        status: false,
