...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/467953/%E7%BF%BB%E9%A1%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/467953/%E7%BF%BB%E9%A1%B5.meta.js
// ==/UserScript==
...
(function() {
  ...
  function windowScroll(e) {
    ...
    wheel.timer = setTimeout(()=>{
      if ( html.clientHeight + scrollY + wheel.thresold>=lastPageHeight + (html.scrollHeight - lastPageHeight) * 0.8 ) joinPage();
    }, wheel.delay)
  };
 
 
  function joinPage() {
    lastPageHeight = html.scrollHeight;
