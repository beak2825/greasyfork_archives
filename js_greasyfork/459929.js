...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/459929/Maxim_Restucia%20%D0%93%D0%A1%D0%A5%D0%97%D0%93%D0%A1%D0%A5.user.js
// @updateURL https://update.greasyfork.org/scripts/459929/Maxim_Restucia%20%D0%93%D0%A1%D0%A5%D0%97%D0%93%D0%A1%D0%A5.meta.js
// ==/UserScript==
...
`[FONT=georgia] [[COLOR=red] Примечание: [/COLOR] После одобрение, с вами свяжится Старшая Администрация. Вам будет необходимо добавить представителя старшей администрации в друзья, после вас добавят в специальную беседу.<br>`+
  `Никто из состава администрации не будет просить у вас все различные пароли, пин-коды, информация о привязках и так далее. Не ведитесь на обманы!`,
        ...
        },
        {
            ...
            content: ` [SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый игрок !<br>` +
                ` Благодарим за ваше обращение!<br>` +
                ` С хелпером будет проведена профилактическая беседа.<br>` +
	  ...
	  content:
		...
		"[B][CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
	  ...
	  status: false,
        },
        {
            ...
            content: `${greeting}, уважаемый хелпер !<br>` +
                `Благодарим за ваше Обращения !<br>` +
                `Ваша жалоба одобрена, в сторону Хелпера будут применины меры.` +
                ` [COLOR=lightgreen]Одобрено[/color],закрыто [/CENTER][/FONT][/SIZE]`,
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content:
                `${greeting}, уважаемый игрок. [/CENTER]<br><br>` +
        ...
        {
            title: `Наказания снято`,
            content: `${greeting}, уважаемый хелпер. [/CENTER]<br><br>` +
        ...
        },
        {
            ...
            content: `${greeting}, уважаемый игрок. [/CENTER]<br><br>` +
                `[CENTER]Данный игрок больше не являеться хелпером.<br>` +
                `[CENTER] [COLOR=red] Отказано[/color],закрыто.[/CENTER][/FONT][/SIZE]`,
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
            title: 'Хелпер был снят',
            content: `${greeting}, уважаемый игрок.[/CENTER]<br><br>` +
        ...
        content:`${greeting}, уважаемый хелпер. <br><br>`+
