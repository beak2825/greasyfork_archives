...
// @version      0.8.3
// @description  标记网页上的所有番号, 在相关网站快速方便的进行搜索。感谢iqxin，此脚本为iqxin创作，版权属原作者所有，本人只是修改了一些不能用的网址和加了免梯子网址自用，如有兴趣者可自行下载。
// @author       testqdg
// @license      MIT
// @match        *://**/*
...
// @downloadURL https://update.greasyfork.org/scripts/443204/%E6%A0%B9%E6%8D%AE%E7%95%AA%E5%8F%B7%E5%BF%AB%E9%80%9F%E6%90%9C%E7%B4%A2%28%E5%85%8D%E6%A2%AF%E5%AD%90%29.user.js
// @updateURL https://update.greasyfork.org/scripts/443204/%E6%A0%B9%E6%8D%AE%E7%95%AA%E5%8F%B7%E5%BF%AB%E9%80%9F%E6%90%9C%E7%B4%A2%28%E5%85%8D%E6%A2%AF%E5%AD%90%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function createPattenr(id){
        var linkJavbusPage = "https://www.seejav.blog/" + id;
        var linkJavdb = "https://javdb39.com/search?q=" + id + "&f=all";
        var linkJavbus = "https://www.seejav.blog/search/" + id;
        var linkJavLib = "https://www.o58c.com/cn/vl_searchbyid.php?keyword=" + id;
    ...
    function getInfo(avID,oReload){
        ...
        GM_xmlhttpRequest({
            method: 'get',
            url: 'https://www.seejav.blog/' + avID,
            headers: {
            ...
            onload: function (data) {
                ...
                image.src = "https://www.seejav.blog/" + imgSrc;
