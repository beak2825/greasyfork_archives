// ==UserScript==
// @name         Claimlite/faucet
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Collect Faucet
// @author       White
// @match        https://claimlite.club/faucet/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=claimlite.club
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/479780/Claimlitefaucet.user.js
// @updateURL https://update.greasyfork.org/scripts/479780/Claimlitefaucet.meta.js
// ==/UserScript==
...
(async function() {
    ...
    const handlePageRedirection = () => {
        ...
        if (url === 'https://claimlite.club/faucet/' || url === 'https://claimlite.club/faucet') {
            window.location.href = 'https://claimlite.club/faucet/login';
        }
    };
 ...
 const waitForCaptchaCompletion = async () => {
    ...
    const executeScript = async () => {
        ...
        if (window.location.href.includes('https://claimlite.club/faucet/login')) {
...
const targetURL = 'https://claimlite.club/faucet/member/dashboard';
