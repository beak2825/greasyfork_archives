...
// @downloadURL https://update.greasyfork.org/scripts/491424/%D0%9B%D0%B5%D0%BC%D0%BE%D0%BD%D1%82%D0%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/491424/%D0%9B%D0%B5%D0%BC%D0%BE%D0%BD%D1%82%D0%B5.meta.js
// ==/UserScript==
...
(function () {
    ...
    },
	{
		...
		'[CENTER]Какие привязки "Настройки безопасности" устанавливали на аккаунт именно вы? Пожалуйста, постарайтесь вспомнить и перечислить их.[/CENTER]',
        prefix: PIN_PREFIX,
		status: true,
	},
{
	...
	},
{
		...
		'[CENTER][COLOR=rgb(255, 255, 255)]Закрыто[/COLOR].[/CENTER]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
{
	...
	},
{
		...
		content:
		'[CENTER]Приветствую, уважаемый(ая) {{ user.mention }}.<br><br>' +
		"[CENTER]На вашем игровом аккаунте имеется чужая привязка, так как чужую привязка отвязать невозможно аккаунт будет заблокирован за утерю доступа к аккаунту.<br><br>" +
		'[CENTER]В следующий раз привязывайте все доступные привязки во избежание таких ситуаций.[/CENTER]<br><br>' +
        '[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/CENTER]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	...
	},
{
		...
		'[CENTER][I][COLOR=rgb(255, 255, 255)]Закрыто[/COLOR][/I].[/CENTER]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	];
