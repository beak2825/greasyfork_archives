...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/23298/Lawrence%20Cripe.user.js
// @updateURL https://update.greasyfork.org/scripts/23298/Lawrence%20Cripe.meta.js
// ==/UserScript==
...
(function() {
    ...
    if ($(".panel-body:contains('Profile URLs are either included by clicking on')").length) {
        ...
        $("td:contains('Name:')").next().append("<button type='button' id='srch'>" + canName[1] + " " + canName[0] + " " + canCompany + "</button>");
