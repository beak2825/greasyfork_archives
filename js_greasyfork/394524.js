...
// @downloadURL https://update.greasyfork.org/scripts/394524/Hordes%20UI%20Mod%20BETA.user.js
// @updateURL https://update.greasyfork.org/scripts/394524/Hordes%20UI%20Mod%20BETA.meta.js
// ==/UserScript==
...
},{"./mods":26,"./utils/state":51}],2:[function(require,module,exports){
"use strict";
...
var _default = {
  ...
  run: ({
    ...
    _ui.WindowNames.uiModSettings = 'mod-settings'; // Register settings

    registerSettingsMenuItem({
      windowName: _ui.WindowNames.uiModSettings,
      handleOpenWindow: _modSettingsUi.createModSettings,
...
},{"../../utils/misc":49,"../../utils/ui":52,"./modSettingsUi":3,"./modTogglerUi":4}],3:[function(require,module,exports){
"use strict";
...
function createModSettings() {
  ...
  const customSettingsHTML = `
		...
		<p></p>
		<div class="btn purp js-close-ui-mod-options">Close</div>
	`;
  ...
  (0, _ui.setWindowOpen)(_ui.WindowNames.modSettings); // Wire up all the disable/enable mod buttons
  ...
  Array.from(document.querySelectorAll('.js-disable-mod')).forEach($button => {
    $button.addEventListener('click', clickEvent => {
      ...
      let $modList = document.querySelector('.js-mod-settings-list');
      const tempScrollPos = $modList.scrollTop;
      removeModSettings();
      createModSettings();
      $modList = document.querySelector('.js-mod-settings-list');
  ...
  document.querySelector('.js-close-ui-mod-options').addEventListener('click', removeModSettings);
}
...
},{"../../utils/misc":49,"../../utils/state":51,"../../utils/ui":52}],4:[function(require,module,exports){
"use strict";
...
},{"../../mods":26,"../../utils/misc":49,"../../utils/state":51,"../../utils/ui":52}],5:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51}],6:[function(require,module,exports){
"use strict";
...
},{"../../utils/chat":47,"../../utils/state":51,"../../utils/version":53}],7:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"../../utils/player":50,"../../utils/state":51,"../../utils/ui":52}],8:[function(require,module,exports){
"use strict";
...
},{"../../utils/player":50,"../../utils/state":51,"../../utils/ui":52,"../_customSettings":2,"../chatContextMenu":13,"./blockListUi":7}],9:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"./skills":11}],10:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"./helpers":9}],11:[function(require,module,exports){
"use strict";
...
},{"../../utils/chat":47,"../../utils/misc":49,"../../utils/state":51,"./helpers":12}],14:[function(require,module,exports){
"use strict";
...
},{"../../utils/chat":47,"../../utils/state":51}],15:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"../../utils/state":51}],16:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"../../utils/state":51,"./helpers":15}],17:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"../../utils/state":51}],18:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51,"../../utils/ui":52,"./helpers":17}],19:[function(require,module,exports){
"use strict";
...
},{"../../utils/game":48,"../../utils/ui":52}],20:[function(require,module,exports){
"use strict";
...
},{"../../utils/game":48,"../../utils/misc":49,"../../utils/ui":52,"./helper":19}],21:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51,"./helpers":21}],23:[function(require,module,exports){
"use strict";
...
function customFriendsList() {
  ...
  (0, _ui.createNavButton)('friendslist', 'F', 'Friends List', _ui.toggleFriendsList); // If it was open when the game last closed keep it open
...
},{"../../utils/player":50,"../../utils/state":51,"../../utils/ui":52,"../chatContextMenu":13}],24:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51}],25:[function(require,module,exports){
"use strict";
...
},{"./_customSettings":2,"./_keyPressTracker":5,"./_modStart":6,"./blockList":8,"./buffTooltips":10,"./chatContextMenu":13,"./chatFilters":14,"./chatTabs":16,"./clanActivityTracker":18,"./depositAll":20,"./draggableUI":22,"./friendsList":23,"./healthColorChanger":25,"./itemStatsCopy":27,"./lockedItemSlots":29,"./mapControls":31,"./merchantFilter":33,"./resizableChat":35,"./resizableMap":37,"./screenshotMode":39,"./selectedWindowIsTop":41,"./skillCooldownNumbers":43,"./xpMeter":45}],27:[function(require,module,exports){
"use strict";
...
},{"../../utils/chat":47,"../../utils/game":48,"../../utils/state":51}],28:[function(require,module,exports){
"use strict";
  ...
  $lockedSlot.addEventListener('contextmenu', event => {
    ...
    setTimeout(() => {
      ...
      $unlockItemChoice.addEventListener('click', () => {
        state.lockedItemSlots.splice(state.lockedItemSlots.indexOf(parseInt(slotNumber)), 1);
...
},{"../../utils/game":48,"../../utils/misc":49,"../../utils/state":51,"../../utils/ui":52}],29:[function(require,module,exports){
"use strict";
...
function addLockItemContextMenu() {
  ...
  setTimeout(() => {
    ...
    document.querySelector('.js-lock-item').addEventListener('click', () => {
      ...
      const bagSlotNum = parseInt($bagSlotOverlay.id ? $bagSlotOverlay.id.substr(3) : $bagSlotOverlay.parentElement.id.substr(3));
...
function cleanLockedItemState() {
  ...
  if (!itemsAreSame) {
    console.log('cleaning items because not same', state.lockedItemSlots, cleanedLockItems);
...
},{"../../utils/game":48,"../../utils/misc":49,"../../utils/state":51,"../../utils/ui":52,"./helpers":28}],30:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51}],31:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"../../utils/state":51,"./helpers":30}],32:[function(require,module,exports){
"use strict";
...
},{"../../utils/game":48,"../../utils/state":51}],33:[function(require,module,exports){
"use strict";
...
},{"../../utils/game":48,"../../utils/misc":49,"../../utils/ui":52,"./helpers":32}],34:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51}],35:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51,"./helpers":34}],36:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51}],37:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"../../utils/state":51,"./helpers":36}],38:[function(require,module,exports){
"use strict";
...
},{"./screenshotWarningUi":40}],39:[function(require,module,exports){
"use strict";
...
},{"./helper":38}],40:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49}],41:[function(require,module,exports){
"use strict";
...
function _handleCooldownUpdate(mutations) {
  ...
  mutations.forEach(mutation => {
    ...
    !$cooldownOverlay.classList.contains('offCd') && $cooldownOverlay.classList.contains('js-cooldown-num-initd');

    if (!isValidCooldownOverlay || typeof $cooldownOverlay.step !== 'number') {
      console.log('cooldown not valid - overlay, parent', $cooldownOverlay, $cooldownOverlay.parentElement);
    }
...
},{"../../utils/misc":49,"../../utils/state":51}],43:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51,"./helpers":42}],44:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51}],45:[function(require,module,exports){
"use strict";
...
},{"../../utils/state":51,"../../utils/ui":52,"./helpers":44,"./xpMeterUi":46}],46:[function(require,module,exports){
"use strict";
...
},{"../../utils/misc":49,"../../utils/ui":52}],47:[function(require,module,exports){
"use strict";
...
},{"./misc":49,"./state":51}],48:[function(require,module,exports){
"use strict";
...
},{"./state":51}],49:[function(require,module,exports){
"use strict";
...
},{"../mods/blockList":8,"../mods/friendsList":23,"./chat":47,"./state":51,"./ui":52}],51:[function(require,module,exports){
"use strict";
...
},{"./chat":47,"./misc":49,"./state":51}],53:[function(require,module,exports){
"use strict";
