...
// @run-at 		document-end
// @downloadURL https://update.greasyfork.org/scripts/2796/MultiIMG.user.js
// @updateURL https://update.greasyfork.org/scripts/2796/MultiIMG.meta.js
// ==/UserScript==
// Pomysł by @Mehgods
...
function main() {
	...
	function replaceTags(content) {
		...
		content = content.replace(/\[([A-Za-z0-9\+=\/]{5,})\]/g, '');
		content = content.replace(/^(([\s]+)?<br(.*?)>){2,}/mg, '');
