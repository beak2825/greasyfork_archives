...
// @downloadURL https://update.greasyfork.org/scripts/406085/SK%20WMS%20layers.user.js
// @updateURL https://update.greasyfork.org/scripts/406085/SK%20WMS%20layers.meta.js
// ==/UserScript==
...
async function init() {
	...
	//skupiny vrstiev v menu
	var groupTogglerDisplay = addGroupToggler(true, "layer-switcher-group_display");
	//vrstvy v menu
	var WMSLayerTogglers = {};
	//zobrazenie
	WMSLayerTogglers.wms_kataster = addLayerToggler(groupTogglerDisplay, "Katastrálna mapa", true, [addNewLayer("wms_kataster", service_wms_kataster, "1,2,3,5,6,7,8,10,11,12,13,14,15", 0, 1, false)]);
	...
	const { tabLabel, tabPane } = W.userscripts.registerSidebarTab("wms-sk");
	tabLabel.innerText = 'WMS';
    tabLabel.title = 'SK WMS layers';
	...
	opacityLabel.textContent = "Priehladnost vrstvy: " + opacityRange.value + " %";
	...
	opacityRange.addEventListener("input", function() {
		...
		if (value !== "" && value !== "undefined") {
			...
			document.getElementById("WMSOpacityLabel").textContent = "Priehladnost vrstvy: " + document.getElementById("WMSOpacity").value + " %";
		}
	});
