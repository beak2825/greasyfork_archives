// ==UserScript==
// @name         town star butter
// @namespace    wiolentmonkey
// @version      0.3
// @description  butter craft
// @author       gela
// @match        https://townstar.sandbox-games.com/launch/
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/435863/town%20star%20butter.user.js
// @updateURL https://update.greasyfork.org/scripts/435863/town%20star%20butter.meta.js
// ==/UserScript==
...
(function() {
    ...
    const trackedItems = [
        ...
        {item: 'Wheat', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Sugarcane', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Brine', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Salt', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Sugar', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Milk', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Eggs', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Butter', count: 0, first: 0, oneMin: 6, oneHour: 0},
    ];
    let loaded = 0;

    const craftedItems = [
        {item: 'Milk', keepAmt: 2, sellMin: 10},
        {item: 'Eggs', keepAmt: 2, sellMin: 10},
        {item: 'Sugarcane', keepAmt: 5, sellMin: 10},
        {item: 'Brine', keepAmt: 8, sellMin: 10},
        {item: 'Wheat', keepAmt: 6, sellMin: 10},
        {item: 'Sugar', keepAmt: 2, sellMin: 10},
        {item: 'Salt', keepAmt: 3, sellMin: 10},
        {item: 'Butter', keepAmt: 0, sellMin: 100},
    ]
