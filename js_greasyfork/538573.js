...
// @noframes
// @connect           *
// @downloadURL https://update.greasyfork.org/scripts/538573/%F0%9F%AB%A7%E9%BC%A0%E6%A0%87%E6%8C%87%E9%92%88%E7%BE%8E%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/538573/%F0%9F%AB%A7%E9%BC%A0%E6%A0%87%E6%8C%87%E9%92%88%E7%BE%8E%E5%8C%96.meta.js
// ==/UserScript==
                    ...
                    <div class="section-content collapsed" id="normalContent">
                        ...
                        <div class="cursor-list" id="normalCursorList">
                            ${Object.entries(PRESET_CURSORS).map(([name, url]) => `
                                <div class="cursor-option" data-url="${url}" ${url === config.cursorNormal ? 'data-selected="true"' : ''}>
                                    <img class="cursor-preview" src="${url}" alt="${name}">
                                    <span class="cursor-name">${name}</span>
                                </div>
                            `).join('')}
                        </div>
                        <div class="preview-area" id="normalCursorPreview">
                            预览普通光标效果
                        </div>
                    </div>
                </div>
                <div class="section">
                    ...
                    <div class="section-content collapsed" id="hoverContent">
                        ...
                        <div class="cursor-list" id="hoverCursorList">
                            ${Object.entries(PRESET_CURSORS).map(([name, url]) => `
                                <div class="cursor-option" data-url="${url}" ${url === config.cursorHover ? 'data-selected="true"' : ''}>
                                    <img class="cursor-preview" src="${url}" alt="${name}">
                                    <span class="cursor-name">${name}</span>
                                </div>
                            `).join('')}
                        </div>
                        <div class="preview-area" id="hoverCursorPreview">
                            预览悬停光标效果
                        </div>
                    </div>
                </div>
                <div class="section">
                    ...
                    <div class="section-content collapsed" id="clickContent">
                        ...
                        <div class="cursor-list" id="clickCursorList">
                            ${Object.entries(PRESET_CURSORS).map(([name, url]) => `
                                <div class="cursor-option" data-url="${url}" ${url === config.cursorClick ? 'data-selected="true"' : ''}>
                                    <img class="cursor-preview" src="${url}" alt="${name}">
                                    <span class="cursor-name">${name}</span>
                                </div>
                            `).join('')}
                        </div>
                        <div class="preview-area" id="clickCursorPreview">
                            预览点击光标效果
                        </div>
                    </div>
                </div>
