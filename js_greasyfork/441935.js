// ==UserScript==
// @name        download thread - 4chan.org
...
// @description 2022-03-22, 11:15:24 p.m.
// @downloadURL https://update.greasyfork.org/scripts/441935/download%20thread%20-%204chanorg.user.js
// @updateURL https://update.greasyfork.org/scripts/441935/download%20thread%20-%204chanorg.meta.js
// ==/UserScript==

// function to click all a elements with class "download-button"
...
// add button to top of page
var downloadAllButton = document.createElement("button");
downloadAllButton.innerHTML = "Download All";
downloadAllButton.addEventListener("click", clickAllDownloadButtons);
document.body.insertBefore(downloadAllButton, document.body.firstChild);
