...
// @downloadURL https://update.greasyfork.org/scripts/33419/John%20Doe%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/33419/John%20Doe%20script.meta.js
// ==/UserScript==
...
$(document).ready(function() {
    ...
    $(document).keyup(function(event){
        if (event.which == 49 || event.which == 103){ //1 or keypad 7
            if ($('#yes-playable').is(':checked')) $('input[value=NOT_PLAYABLE]').click();
            else $('#yes-playable').click();
