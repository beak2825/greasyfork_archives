...
// @downloadURL https://update.greasyfork.org/scripts/555028/instagram-dm-unsender.user.js
// @updateURL https://update.greasyfork.org/scripts/555028/instagram-dm-unsender.meta.js
// ==/UserScript==
...
// === Mobile-layout visibility patch ===
(function() {
    function adjustIDMUMenu() {
        const m = document.getElementById("idmu-menu");
        if (!m) return;
        if (window.innerWidth < 700) {      // narrow/mobile viewport
            ...
            m.style.maxWidth = "calc(100% - 20px)";
            m.style.background = "rgba(0,0,0,0.25)";
            m.style.borderRadius = "8px";
            m.style.padding = "4px";
        } else {                           // reset for wider screens
            m.style.left = "";
            m.style.right = "20px";
            m.style.background = "";
    ...
    window.addEventListener("resize", adjustIDMUMenu);
    adjustIDMUMenu(); // run once on load
})();