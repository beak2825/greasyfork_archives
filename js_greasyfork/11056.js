...
// @version             1.2.01
// @author              xanderb
// @description         This script localizes WME Validator for Massachusetts, USA. You also need main package (WME Validator) installed. installed.
// @include             /^https:\/\/(www|beta)\.waze\.com\/(?!user\/)(.{2,6}\/)?editor.*$/
// @grant               none
// @run-at              document-start
// @icon                data:image/png;base64,
// @downloadURL https://update.greasyfork.org/scripts/11056/WME%20Validator%20Localization%20for%20Massachusetts.user.js
// @updateURL https://update.greasyfork.org/scripts/11056/WME%20Validator%20Localization%20for%20Massachusetts.meta.js
// ==/UserScript==
//
/*
Updated for compatibility with the US English language in WME 30Mar2017 - xanderb
*/
...
window.WME_Validator_United_States = {
  ...
  ".author": "xanderb",
  ".updated": "2017-03-30",
  ".link": "https://greasyfork.org/en/scripts/11056-wme-validator-localization-for-massachusetts",
  ".lng": "EN-US",
  ...
  "130.title": "City name on SR Alt",
  "130.problem.en": "The segment matched custom conditions",
  "130.problem": "State Roads with SR-xx as Alt should not have a city name",
  "130.solution.en": "Solve the issue",
  "130.solution": "Reinput the SR alternate without the city name",
  "131.enabled": true,
  "131.params": {
  ...
  "131.title": "Improper Exit Naming",
  "131.problem.en": "The segment matched custom conditions",
  "131.problem": "This segment has an entrance / exit name which does not follow the USA standards for exit naming, or is a ramp with non entrance / exit name",
  "131.solution.en": "Solve the issue",
  "131.solution": "For numbered exits use \"Exit(s) ##: Name / Other Name\". For entrances & unnumbered exits use \"to Name / Other Name\". Separate all shields and names with slashes (/) and spaces. Verify if this is supposed to be a ramp",
  "132.enabled": true,
  "132.params": {
  ...
  "132.problem": "City or County Hwy Name is not used here",
  ...
  "133.title": "Bad TTS Street name",
  "133.problem.en": "The segment matched custom conditions",
  "133.problem": "Streets that start with St and Dr result in TTS reading Street or Drive",
  "133.solution.en": "Solve the issue",
  "133.solution": "Add a period after Jr, St, Dr, or Rev where required",
  "134.enabled": true,
  ...
  "134.title": "Alley not Private Road",
  "134.problem.en": "The segment matched custom conditions",
  "134.problem": "Named Alleys should be set to the Private Road Type",
  ...
  "135.title": "Incorrect Highway Name",
  "135.problem.en": "The segment matched custom conditions",
  "135.problem": "Massachusetts uses SR for state and US for national highway names",
  ...
  "137.solutionLink": "W:Road_types/USA#Railroad",
  "137.title.en": "Custom check",
  "137.title": "Name on Railroad",
  "137.problem.en": "The segment matched custom conditions",
  "137.problem": "Names on Railroads are not needed for routing and clutter the app UI",
  "137.solution.en": "Solve the issue",
  "137.solution": "Remove the Names and Cities from Railroad segments",
  "138.enabled": true,
  "138.params": {
  ...
  "138.title": "Invalid Interstate Name",
  "138.problem.en": "The segment matched custom conditions",
  "138.problem": "There seems to be an extra space there",
  "138.solution.en": "Solve the issue",
  "138.solution": "Remove the extra space in the name",
  "139.enabled": true,
  "139.params": {
  ...
  "139.title": "City Name on Freeway",
  "139.problem.en": "The segment matched custom conditions",
  "139.problem": "City names on Freeway segments can cause detours",
  "139.solution.en": "Solve the issue",
  "139.solution": "Remove the City Name",
  "150.enabled": true,
