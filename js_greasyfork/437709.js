...
// @downloadURL https://update.greasyfork.org/scripts/437709/Show%20total%20incoming%20troops%20in%20village%20info.user.js
// @updateURL https://update.greasyfork.org/scripts/437709/Show%20total%20incoming%20troops%20in%20village%20info.meta.js
// ==/UserScript==
    ...
    incomings.forEach(function (ele) {
        ...
        setTimeout(function() {
            $.get(window.location.origin + "/game.php?village=" + game_data.village.id + "&screen=info_command&ajax=details&id=" + id, function (r) {
                ...
                let responseUnits = JSON.parse(JSON.stringify(r)).units;
                counterGetAmnt++;
                if (type === "attack") {
