...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/423953/Shiki%20Rating.user.js
// @updateURL https://update.greasyfork.org/scripts/423953/Shiki%20Rating.meta.js
// ==/UserScript==
...
function appendShikiRating() {
    ...
    var malLabel = getLocale() === 'ru' ? 'На основе оценок MyAnimeList' : 'From MAL users';
    ...
    shikiCountLabel = (getLocale() === 'ru')
        ? 'На основе ' + shikiCountLabel + ' оценок Shikimori'
