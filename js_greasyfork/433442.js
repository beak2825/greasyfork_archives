...
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/433442/MeTruyenChu%20downloader.user.js
// @updateURL https://update.greasyfork.org/scripts/433442/MeTruyenChu%20downloader.meta.js
// ==/UserScript==
    ...
    $(document).ready(function() {
        ...
        $(this).mbDownloader({
            ...
            classNames: {
                ...
                chapterNotContent: 'iframe, script, style, a, div, p:has(a[href*="vtruyen.com"])',
            ...
            ebook: {
                fallbackCover: 'https://static.cdnno.com/background/vtruyen.jpg'
            },
            chapters: {
                chapListSlice: [6, -1],
            },
