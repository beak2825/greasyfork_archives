...
// @author       You
// @match        https://classroom.google.com/c/Mjg5MzI1MTIyMzla
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/381635/JJ.user.js
// @updateURL https://update.greasyfork.org/scripts/381635/JJ.meta.js
// ==/UserScript==
...
setInterval(function() {
  ...
  for (let i = 0; i < div.length; i++) {
    ...
    div[i].style.transition = "background-color 6s";
  }
}, 1000);
