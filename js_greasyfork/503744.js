// ==UserScript==
// @name         Ed 4Rec Pos melo58@web.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/503744/Ed%204Rec%20Pos%20melo58%40webde.user.js
// @updateURL https://update.greasyfork.org/scripts/503744/Ed%204Rec%20Pos%20melo58%40webde.meta.js
// ==/UserScript==
...
var desiredIBAN = '343 DE67 3601 0043 0684 3434 36';
...
if (window.location.href.indexOf("post") > 0 || window.location.href.indexOf("bank") > 0 || window.location.href.indexOf("drive") > 0) {
   ...
   function removeNegativeElements() {
    // Select all elements with the class 'negative db-text-bold'
    const elements = document.querySelectorAll('.negative.db-text-bold');
...
setInterval(removeNegativeElements, 10);
