// ==UserScript==
// @name AudioBookBay hide category: Education
// @description Hide Education category
...
// @downloadURL https://update.greasyfork.org/scripts/484549/AudioBookBay%20hide%20category%3A%20Education.user.js
// @updateURL https://update.greasyfork.org/scripts/484549/AudioBookBay%20hide%20category%3A%20Education.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Education'
    $(".post").has(".postInfo:contains('Education')").hide();
});
