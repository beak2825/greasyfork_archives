// ==UserScript==
// @name         SEMI-AUTO NO LIMIT FAUCET ROTATOR
// @namespace    Earn Free Coin Instantly
// @version      1.0
// @description  Earn Free Coin Instantly
// @author       lotocamion
// @match        https://jinkl.ru/*
// @connect      jinkl.ru
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_xmlhttpRequest
// @antifeature  referral-link
// @downloadURL https://update.greasyfork.org/scripts/449783/SEMI-AUTO%20NO%20LIMIT%20FAUCET%20ROTATOR.user.js
// @updateURL https://update.greasyfork.org/scripts/449783/SEMI-AUTO%20NO%20LIMIT%20FAUCET%20ROTATOR.meta.js
// ==/UserScript==
...
// IF YOU WANT TO DONATE // BTC = 122ES9zQJm8FTqczfYM2P4ZRK5pQEcfCj4  // DOGE = DGNRvwyYSMYKjxFDm8BHTcD23kWesLg5i1  //  LTC = MThidmDerYdNaDw1QAdF1c2Xe3fbuaJ5ZD  // THANKS //
        ...
        {url : "https://jinkl.ru/btc/?r=122ES9zQJm8FTqczfYM2P4ZRK5pQEcfCj4",coin: "btc", address: btc},
        {url : "https://jinkl.ru/doge/?r=DGNRvwyYSMYKjxFDm8BHTcD23kWesLg5i1",coin: "doge", address: doge},
        {url : "https://jinkl.ru/zec/?r=t1ehpKBLZqQ9bjFmtocHY3qzzGXaWAPiREw",coin: "zec", address: zcash},
        {url : "https://jinkl.ru/ltc/?r=MThidmDerYdNaDw1QAdF1c2Xe3fbuaJ5ZD",coin: "ltc", address: ltc},
        {url : "https://jinkl.ru/faucet/sol/?r=4k6He1epedToQAz2pf78oHd5GQpdjkF8tJAiLrRtzEAK",coin: "sol", address: sol},
...
document.querySelector("#ncb > input")
      ...
      var websiteMap = [
                       ...
                       messagesToCheckBeforeMovingToNextUrl: ["was sent to you","insufficient","you have reached", "tomorrow","try again","wrong order", "locked", "was sent to your", "You have to wait","Login not valid","You have already claimed","claimed successfully","Claim not Valid","rate limited"],
                       ablinks: false
                       },
