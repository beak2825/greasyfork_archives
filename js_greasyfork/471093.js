// ==UserScript==
// @name         Ellililunch AO3 Re-read Savior 2
...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471093/Ellililunch%20AO3%20Re-read%20Savior%202.user.js
// @updateURL https://update.greasyfork.org/scripts/471093/Ellililunch%20AO3%20Re-read%20Savior%202.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (seriesTrue != undefined) {
        ...
        */
        ...
        // chapters are reported as either class="chapters" or class="chapters" data-ao3e-original
    ...
    if (oldBookmarkNotes === "") { //learned this from: https://stackoverflow.com/questions/154059/how-do-i-check-for-an-empty-undefined-null-string-in-javascript
        ...
        // my code just for now to get all my old bookmarks into my new system:
        newBookmarkNotes = fic_info;
        // automatically checks the Private Bookmark checkbox. Set to false if you don't want this.
    ...
    newBookmarkNotes = newBookmarkNotes.replace('End Racism in the OTW | ',''); /// sorry!!!
    ...
    if (WIP_tag == "WIP") {
        newBookmarkNotes = newBookmarkNotes + "<br>Read up to chapter " + latestChapter;
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Automatically tags WIP's "WIP" (for fics only)
    if (seriesTrue == undefined) {
    ...
    // trying out my if statements again:
        ...
        if (words.includes(" ")) {
            words = words.replace(/\s/g, ""); //https://www.w3schools.com/jsref/jsref_string_replaceall.asp, https://futurestud.io/tutorials/remove-all-whitespace-from-a-string-in-javascript
        }
    ...
    tag_input_box.value = "tracker 1.9.1,     " + word_tag + ",       " + WIP_tag + ",       ";
