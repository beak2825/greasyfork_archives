...
// @contributor  _VcrazY_
// @downloadURL https://update.greasyfork.org/scripts/481295/pancake%20mod%20%5B%20WORKING%202023%20%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/481295/pancake%20mod%20%5B%20WORKING%202023%20%5D.meta.js
// ==/UserScript==
let AUTHOR = "W4IT"
...
setInterval(function() {
    if (autosecondary == true) {
        newSend(["G", [secondary, true]]);
    }
}, 10);
setInterval(function() {
    if (autoprimary == true) {
        newSend(["G", [primary, true]]);
    }
}, 10);
setInterval(function() {
    if (q == true) {
...
function place(p__14702) {
    ...
    newSend(['G', [p__14702, null]]);
    newSend(['d', [1, angle]]);
    newSend(['d', [0, angle]]);
    newSend(['G', [myPlayer.weapon, true]]);
    newSend(['G', [p__14702, null]]);
    newSend(['d', [1, angle]]);
    newSend(['d', [0, angle]]);
    newSend(['G', [myPlayer.weapon, true]]);
