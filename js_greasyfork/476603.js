...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/476603/rb17.user.js
// @updateURL https://update.greasyfork.org/scripts/476603/rb17.meta.js
// ==/UserScript==

(function() {
    'use strict';

    let clickCounter = Math.floor(Math.random() * 11) + 10; //
