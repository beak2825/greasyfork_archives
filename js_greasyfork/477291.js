// ==UserScript==
// @name         YouTube Rounded UI (late 2022 version)
// @version      20251223.00.27
// @description  This is the old version of YouTube Rounded UI from late 2022. (special thanks to sapondanaisriwan and ytuserstyles for these codes)
...
// @downloadURL https://update.greasyfork.org/scripts/477291/YouTube%20Rounded%20UI%20%28late%202022%20version%29.user.js
// @updateURL https://update.greasyfork.org/scripts/477291/YouTube%20Rounded%20UI%20%28late%202022%20version%29.meta.js
// ==/UserScript==
...
(function() {
let css = `
html[dark] { --yt-spec-general-background-a: #181818 !important; --yt-spec-general-background-b: #0f0f0f !important; --yt-spec-brand-background-primary: rgba(33, 33, 33, 0.98) !important; --yt-spec-10-percent-layer: rgba(255, 255, 255, 0.1) !important; --yt-spec-base-background: #0f0f0f !important; --yt-spec-guide-background-active: #272727 !important }
html:not([dark]) { --yt-spec-general-background-a: #f9f9f9 !important; --yt-spec-general-background-b: #f1f1f1 !important; --yt-spec-brand-background-primary: rgba(255, 255, 255, 0.98) !important; --yt-spec-10-percent-layer: rgba(0, 0, 0, 0.1) !important; --yt-spec-base-background: #fff !important; --yt-spec-guide-background-active: #f2f2f2 !important }
...
div#chip-bar.style-scope.ytd-search-header-renderer > yt-chip-cloud-renderer.style-scope.ytd-search-header-renderer > div#container.style-scope.yt-chip-cloud-renderer { display: none !important }
ytd-video-description-infocards-section-renderer.style-scope.ytd-structured-description-content-renderer > #header.ytd-video-description-infocards-section-renderer, ytd-video-description-infocards-section-renderer.style-scope.ytd-structured-description-content-renderer > #action-buttons.ytd-video-description-infocards-section-renderer { display: none !important }
ytd-video-description-infocards-section-renderer.style-scope.ytd-structured-description-content-renderer { border-top: 0px !important }
...
ytd-watch-flexy[rounded-player-large]:not([fullscreen]):not([theater]) #ytd-player.ytd-watch-flexy, ytd-watch-flexy[rounded-player] #ytd-player.ytd-watch-flexy { border-radius: 0px !important }
#voice-search-button.ytd-masthead { background-color: var(--yt-spec-general-background-a) !important; margin-left: 4px !important }
#search-clear-button.ytd-searchbox { margin-right: 0px !important }
.ytSearchboxComponentSuggestionsContainer { top: 48px }
.ytSuggestionComponentSuggestion, .ytSuggestionComponentRoundedSuggestion { height: 32px !important; border-radius: 0 !important; margin: 0 !important }
.ytSuggestionComponentIcon { margin-right: 12px !important }
...
.yt-spec-button-shape-next--call-to-action.yt-spec-button-shape-next--outline { letter-spacing: 0.5px !important }
yt-chip-cloud-chip-renderer, .ytChipShapeChip { letter-spacing: 0.25px !important; font-weight: 400 !important }
[page-subtype="history"] #channel-header.ytd-tabbed-page-header { padding-top: 0 !important; padding-bottom: 0 !important }
...
/* Revert classic Subscribed notification */
yt-button-shape.style-scope.ytd-subscribe-button-renderer { display: flex !important }
yt-smartimation.ytd-subscribe-button-renderer, .smartimation__content > __slot-el, .smartimation__content { display: flex !important }
#notification-preference-toggle-button:not([hidden]) + yt-animated-action #notification-preference-button.ytd-subscribe-button-renderer[invisible], #subscribe-button-shape.ytd-subscribe-button-renderer[invisible] { pointer-events: auto; visibility: visible; position: static }
...
/* Revert channel UI and other tweaks */
...
@font-face { font-family: no-parens;
...
ytd-item-section-renderer[static-comments-header] #header.ytd-item-section-renderer { background-color: transparent !important }
div#sponsor-button.style-scope.ytd-video-owner-renderer > ytd-button-renderer.style-scope.ytd-video-owner-renderer > yt-button-shape > .yt-spec-button-shape-next--mono.yt-spec-button-shape-next--outline { background-color: var(--yt-spec-badge-chip-background) !important; border: 0px !important; color: var(--yt-spec-text-primary) !important }
...
.yt-spec-button-shape-next--mono.yt-spec-button-shape-next--filled[aria-label="Join this channel"] { background-color: var(--yt-spec-badge-chip-background) !important; border: none !important; color: var(--yt-spec-text-primary) !important }
.ytp-sb-subscribe { background-color: #f00 !important; color: #fff !important; text-transform: uppercase !important }
.ytp-sb-unsubscribe { background-color: #eee !important; color: #606060 !important; text-transform: uppercase !important }
...
.ytSubThreadThreadline { visibility: hidden !important }
...
#more-replies > yt-button-shape > button > div.yt-spec-button-shape-next__icon path, #more-replies-icon > yt-button-shape > button > div path, #more-replies-sub-thread > yt-button-shape > button > div path { d: path("m7 10 5 5 5-5z") }
#pinned-comment-badge > ytd-pinned-comment-badge-renderer > yt-icon > yt-icon-shape { color: var(--yt-spec-text-primary) !important }#creator-heart-button.ytd-creator-heart-renderer { width: 32px !important; height: 32px !important }
...
[d*="M19 3.87v9.77C19 17.7 15.86 21 12 21s-7-3.3-7-7.37v-.13c0-1.06.22-2.13.62-3.09.5-1.19 1.29-2.21 2.27-2.97.85-.66 1.83-1.14 2.87-1.65.39-.19.77-.38 1.15-.58.36-.19.72-.38 1.08-.56v3.22l1.55-1.04L19 3.87M20 2l-6 4V3c-.85.44-1.7.88-2.55 1.33-1.41.74-2.9 1.34-4.17 2.32-1.13.87-2.02 2.05-2.58 3.37-.46 1.09-.7 2.29-.7 3.48v.14C4 18.26 7.58 22 12 22s8-3.74 8-8.36V2zM9.45 12.89 14 10v5.7c0 1.82-1.34 3.3-3 3.3s-3-1.47-3-3.3c0-1.19.58-2.23 1.45-2.81z"] { d: path("M14.72,17.84c-0.32,0.27-0.83,0.53-1.23,0.66c-1.34,0.33-2.41-0.34-2.62-0.46c-0.21-0.11-0.78-0.38-0.78-0.38 s0.35-0.11,0.41-0.13c1.34-0.54,1.89-1.24,2.09-2.11c0.2-0.84-0.16-1.56-0.31-2.39c-0.12-0.69-0.11-1.28,0.12-1.9 c0.02-0.05,0.12-0.43,0.12-0.43s0.11,0.35,0.13,0.41c0.71,1.51,2.72,2.18,3.07,3.84c0.03,0.15,0.05,0.3,0.05,0.46 C15.8,16.3,15.4,17.26,14.72,17.84z M12.4,4.34c-0.12,0.08-0.22,0.15-0.31,0.22c-2.99,2.31-2.91,5.93-2.31,8.55l0.01,0.03l0.01,0.03 c0.06,0.35-0.05,0.7-0.28,0.96c-0.24,0.26-0.58,0.41-0.95,0.41c-0.44,0-0.85-0.2-1.22-0.6c-0.67-0.73-1.17-1.57-1.5-2.46 c-0.36,0.77-0.75,1.98-0.67,3.19c0.04,0.51,0.12,1,0.25,1.43c0.18,0.6,0.43,1.16,0.75,1.65c1.05,1.66,2.88,2.82,4.78,3.05 c0.42,0.05,0.85,0.08,1.26,0.08c1.34,0,3.25-0.27,4.74-1.57c1.77-1.56,2.35-3.99,1.44-6.06c-0.
...
ytd-reel-shelf-renderer.ytd-structured-description-content-renderer { display: none !important }
/* Revert video list and watch UI fixes */
ytd-watch-flexy #comment-teaser.ytd-watch-metadata { display: none }
...
ytd-watch-flexy #attached-survey.ytd-rich-grid-media, ytd-watch-flexy #avatar-link.ytd-rich-grid-media { display: none }
...
ytd-watch-flexy ytd-thumbnail[size=large] a.ytd-thumbnail, ytd-watch-flexy ytd-thumbnail[size=large]:before, ytd-watch-flexy ytd-thumbnail[size=large][large-margin] a.ytd-thumbnail, ytd-watch-flexy ytd-thumbnail[size=large][large-margin]:before { border-radius: 8px }
...
ytd-watch-flexy ytd-rich-grid-renderer[reduced-top-margin] #contents.ytd-rich-grid-renderer { padding-top: 0px }
...
h1.ytd-watch-metadata { font-family: "YouTube Sans","Roboto",sans-serif !important; font-weight: 600 !important; font-size: 2rem !important; line-height: 2.8rem !important }
#title.ytd-feed-nudge-renderer, #title.ytd-playlist-sidebar-primary-info-renderer, ytd-inline-form-renderer[component-style=INLINE_FORM_STYLE_TITLE] #text-displayed.ytd-inline-form-renderer, [page-subtype="playlist"] .page-header-view-model-wiz__page-header-title--page-header-title-medium, [page-subtype="playlist"] .page-header-view-model-wiz__page-header-title--page-header-title-large, [page-subtype="playlist"] .yt-page-header-view-model__page-header-title--page-header-title-medium, [page-subtype="playlist"] .yt-page-header-view-model__page-header-title--page-header-title-large { font-family: "YouTube Sans","Roboto",sans-serif !important; }
...
#panel-button .yt-spec-button-shape-next__icon path { d: path("M10 3H17V7H10V3ZM20 0H0V14H20V0ZM1 1H19V13H1V1Z"); transform: scale(1.20) }
.yt-spec-button-shape-next--size-m[aria-label="Promote"], #flexible-item-buttons [aria-label="Promote"] { display: none !important }
.yt-spec-button-shape-next--size-m[aria-label="Ask"], #flexible-item-buttons [aria-label="Ask"] { display: none !important }
yt-button-view-model.ytd-menu-renderer .yt-spec-button-shape-next--size-m, ytd-download-button-renderer .yt-spec-button-shape-next--size-m, #loop-button > .yt-spec-button-shape-next--size-m { margin-left: 8px !important }
...
ytd-watch-metadata[action-buttons-update-owner-width] #owner.ytd-watch-metadata { min-width: calc(50% - 6px) !important }
#actions.ytd-watch-metadata { min-width: auto !important }
/* Undoing UI changes after 2024 update */
...
ytd-button-renderer.ytd-feed-filter-chip-bar-renderer { background-color: transparent !important }
#left-arrow-button.ytd-feed-filter-chip-bar-renderer, #right-arrow-button.ytd-feed-filter-chip-bar-renderer { background-color: var(--yt-spec-base-background) !important }
#left-arrow.ytd-feed-filter-chip-bar-renderer:after { background: linear-gradient(to right, var(--yt-spec-base-background) 20%, rgba(255, 255, 255, 0) 80%) }
#right-arrow.ytd-feed-filter-chip-bar-renderer:before { background: linear-gradient(to left, var(--yt-spec-base-background) 20%, rgba(255, 255, 255, 0) 80%) }
#background.ytd-masthead { background: var(--yt-spec-base-background) !important backdrop-filter: none !important }
...
.ytp-progress-bar .ytp-scrubber-button { opacity: 0 !important }
.ytp-progress-bar:hover .ytp-scrubber-button { opacity: 1 !important }
