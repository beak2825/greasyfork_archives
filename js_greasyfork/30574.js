// ==UserScript==
// @name       Tiberium Alliances Info Sticker DB edit
...
// @downloadURL https://update.greasyfork.org/scripts/30574/Tiberium%20Alliances%20Info%20Sticker%20DB%20edit.user.js
// @updateURL https://update.greasyfork.org/scripts/30574/Tiberium%20Alliances%20Info%20Sticker%20DB%20edit.meta.js
// ==/UserScript==
(function () {
                                    ...
                                    try {
                                        ...
                                        for (i = this.toFlipH.length - 1; i >= 0; i--) {
                                            ...
                                            if(e.isDisposed()) this.toFlipH.splice(i, 1);
                                                ...
                                                dele = e.getContentElement().getDomElement();
                                                // würde alles erneut spiegeln, deswegen auskommentiert
                                                // früher notwendig, weil getDecoratorElement() statt getContentElement() verwendet wurde
                                                // seid qooxdoo 5.0.1 ist dieses erneute transformieren nicht mehr erforderlich
                                                // theoretisch könnte das hier auch einfach gelöscht werden, aber wie heißt es so schön? Lösche nix, kommentiere aus - wer weiß, wozu man das nochmal braucht :D
                                                /*if (dele != null) {
