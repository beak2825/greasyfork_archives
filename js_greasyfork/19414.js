...
// @include        *
// @downloadURL https://update.greasyfork.org/scripts/19414/custom%20DLSite%20linker.user.js
// @updateURL https://update.greasyfork.org/scripts/19414/custom%20DLSite%20linker.meta.js
// ==/UserScript==


/*
based on: http://userscripts-mirror.org/scripts/review/155521

1.1.1
commented out document.normalize(); it was causing http://overwatchlf.com/ to break
...
var textToLink = function(nodeValue)
{
    ...
    var DLSiteRegEx = new RegExp('r(j|e)[0-9]{6}','gi'); 
    var matches = null;
    var text = null;
    var index = null;
    var leftStr = null;
    ...
    while ((matches = nodeValue.substring(fromIndex).match(DLSiteRegEx)) !== null)
    {
        ...
        if (link.match(/rj/i)) {
          anchor = "<a href=\"http://www.dlsite.com/maniax/work/=/product_id/" + link.toUpperCase() + ".html\">" + text + "</a>";
        } else {
          anchor = "<a href=\"http://www.dlsite.com/ecchi-eng/work/=/product_id/" + link.toUpperCase() + ".html\">" + text + "</a>";
        }
...
var main = function()
{
    //document.normalize(); // this line causes http://overwatchlf.com/ to break. commented out
    var elements = null;
    var element = null;
    var nodeValue = null;
