// ==UserScript==
// @name         Crosspost from Bluesky
// @namespace    https://lit.link/toracatman
// @version      2025-07-11
// @description  Bluesky から 他の SNS に 半自動的に 同時投稿します。
// @author       トラネコマン
// @match        https://bsky.app/*
// @icon         data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/541993/Crosspost%20from%20Bluesky.user.js
// @updateURL https://update.greasyfork.org/scripts/541993/Crosspost%20from%20Bluesky.meta.js
// ==/UserScript==

function getPostText() {
    return Array.from(document.querySelectorAll(".ProseMirror p"))
        .map(textContent => {
...
setInterval(() => {
    //2つ以上作成しない
    if (document.querySelector('div[data-testid="secondToolbar"]') != null) return;

    //ツールバーの取得
    let toolbar = document.querySelector('button[data-testid="openGalleryBtn"]');
    if (toolbar == null) return;
    toolbar = toolbar.parentNode.parentNode;

    if (toolbar.getAttribute("data-second") == "true") return;
    toolbar.setAttribute("data-second", "true");
    let toolbarlist = toolbar.firstElementChild;
    ...
    toolbar2.setAttribute("data-testid", "secondToolbar");
    ...
    if (btn_twitter) {
        ...
        newBtn.setAttribute("aria-label", "Twitterで共有");
        newBtn.setAttribute("data-testid", "TwitterButton");
    ...
    if (btn_substitute) {
        ...
        newBtn.innerHTML = '<span style="font-size: 20px; font-weight: bold; line-height: 1; color: hsl(211, 99%, 53%);">代</span>';
    ...
    if (btn_clipboard) {
        ...
        newBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="hsl(211, 99%, 53%)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><path d="M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2"/></g></svg>';
    ...
    newBtn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="hsl(211, 99%, 53%)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0-18 0m9 5v.01"/><path d="M12 13.5a1.5 1.5 0 0 1 1-1.5a2.6 2.6 0 1 0-3-4"/></g></svg>';
