// ==UserScript==
// @name         聚合搜索
// @namespace    http://tampermonkey.net/sx
// @version      1.0
...
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/499486/%E8%81%9A%E5%90%88%E6%90%9C%E7%B4%A2.user.js
// @updateURL https://update.greasyfork.org/scripts/499486/%E8%81%9A%E5%90%88%E6%90%9C%E7%B4%A2.meta.js
// ==/UserScript==
...
const defaultUrlMap = [
  ...
  {
    name: '百度',
    searchUrl: 'https://m.baidu.com/s?wd=%s',
    keyName: 'wd',
  },
  {
    name: 'F搜',
  ...
  {
    name: 'Google',
    searchUrl: 'https://www.google.com.hk/search?q=%s',
    keyName: 'q',
  },
  {
    name: '开发者',
  ...
  {
    name: '微信文章',
    searchUrl: 'https://weixin.sogou.com/weixin?type=2&s_from=input&query=%s',
    keyName: 'query',
  },
  {
    name: 'Bing',
  ...
  {
    name: 'Bing',
    searchUrl: 'https://cn.bing.com/search?ensearch=0&q=%s',
    keyName: 'q',
  },
  {
    name: '知乎',
