// ==UserScript==
// @name              （TEST）B站成分检测器_尘白串子增强版
// @version           0.0.1
// @author            ChuanZi4000+
// @namespace         github.com/Charles9371
// @license           GPLv3
// @description       基于原有的插件，添加了对于尘白串子的检测，如果原版更新了会尽量更新上
// @homepage          https://github.com/Charles9371/bilibili-comment-checker-cbjqplEnhanced
// @supportURL        https://github.com/Charles9371/bilibili-comment-checker-cbjqplEnhanced/issues
// @match             *://*.bilibili.com/*
...
// @downloadURL https://update.greasyfork.org/scripts/526298/%EF%BC%88TEST%EF%BC%89B%E7%AB%99%E6%88%90%E5%88%86%E6%A3%80%E6%B5%8B%E5%99%A8_%E5%B0%98%E7%99%BD%E4%B8%B2%E5%AD%90%E5%A2%9E%E5%BC%BA%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/526298/%EF%BC%88TEST%EF%BC%89B%E7%AB%99%E6%88%90%E5%88%86%E6%A3%80%E6%B5%8B%E5%99%A8_%E5%B0%98%E7%99%BD%E4%B8%B2%E5%AD%90%E5%A2%9E%E5%BC%BA%E7%89%88.meta.js
// ==/UserScript==
...
(function BiliChecker() {
	...
	/**
	 * 自动启动检测低于的等级设置，默认为5，需要打开对应设置开关生效
	 */
	...
	const checkers = [
		...
		{
			displayName: "猫meme",
			displayIcon: "https://i0.hdslb.com/bfs/face/54791ce892f22b055177421e0da433d31b812bb1.jpg@100w_100h.webp",
			keywords: ["猫meme"],
			followings: [
				1447557097, // 猫meme也是00后
				411221815, // 龟的猫meme
				1189535278, // 猫meme红领巾
				3546739199969781, // 香蕉猫meme哦
				3546732994496727, // 橘猫meme
				1886361511, // 老表猫meme
				699359321, // 猫meme小剧场江笑笑
				1746616203, // 猫meme往事剧场
				11652599, // 喵总裁-猫meme
				3493272368450077, // 冻干猫meme
				3546694388025971, // 猫meme练习生-真实案件
				3546742343600468, // 果汁猫meme
				1941966720, // 榴莲猫meme日常
				3546755912173945, // 微笑猫meme小剧场
				68024345, // 仔仔的猫meme
				400615611, // 南猫meme日记
				349743468, // 迷人小猫meme
				267187773, // 猫meme打工发疯版
				3546755224308355, // 橘猫meme日记
				170852106, // 猫meme不凡人
				1423403343, // 炭猫meme日记
				1915827617, // 猫meme的毛坯人生
				3546749887056664, // 小熊的猫meme日常
				3546779496745852, // 猫meme成长记
				1227322027, // 猫meme羊仔
				1886775845, // -小猫meme的日常
				1910233504, // 猫meme小故事_
				3546391435544871, // 猫meme小剧场0w0
				696061808, // 猫meme家族剧
				397882325, // 番茄猫meme小剧场
				41865233, // 猫meme小日记
				20706136, // 豆子猫meme小剧场
				3461577883781458, // 毅羽猫meme小剧场
				3546740806388166, // 猫meme的猫猫剧场
				3546780029422424, // 纯情猫meme日记
				2037016053, // 猫meme日记喵
				2145903419, // 阿汐猫meme故事会
				1013893655, // CoCo酱猫meme
				476892023, // 百佳猫meme饭
				3546791305808100, // 福宝的猫meme日常
				1359706601, // 猫meme爱吃咸鱼
				3493079218653642, // 法棍猫meme
				1673939311, // 猫meme乡村日记
				3546744648370227, // 洪荒掌管猫meme的神
				1150371283, // 猫meme精神世界
				3546759143885189, // 猫meme界主
				3546766488111168, // 猫meme小蛋挞
				622848281, // 乖猫meme小剧场
				3546735565605239, // 猫meme乐趣剧场V
				1740285610, // 小懒猫meme
				3546814135405246, // 猫meme发财猫
				508125195, // 福宝的猫meme日常哈
				692301490, // 猫meme推文
				498914798, // 猫meme的小舞台
				34950071, // 猫meme小酒窝
				5039616, // 猫meme爱讲故事
				...
				443101643, // 猫meme苏苏
				1431207089, // 猫meme储蓄罐
				3546788258646183, // 猫meme小短剧场
				475774986, // 猫meme日常剧
				3546789250599116, // 海猫meme日记
				1853200971, // 猫meme酱
				3546580823050500, // 和表弟的猫meme
				2087241555, // 猫meme小雷
				3546772534200935, // 猫meme可乐饼
				411191075, // 猫meme小巨场
				1827333356, // 猫meme日常剧场
				3546757910760130, // 猫meme剧仔
				175767555, // 一口猫meme
				3493133729925509, // 猫meme传奇
				3546556022131135, // 一只优雅猫-meme
				399083637, // 猫meme是个大学牲
				124893150, // 猫meme左卫门
				3546784026594030, // 猫meme爱忆
				3546775621208327, // 猫meme小小故事
				1851004413, // 墨冰仙猫meme版
				3546653227223677, // 紧跟时事猫meme
				3546747676658271, // 猫meme小日常yu
				506532100, // 发财小猫meme
				1647997150, // 猫meme同学
				3546771523373170, // 腼腆猫meme
				1502156342, // 猫meme的麦当
				479239735, // 是猫meme呢
				3231266, // 葵葵酱-猫meme版
				1526901316, // 嘉乐猫meme
				17061193, // 圆球猫meme
				3546744866474627, // 猫meme有梦想
				1744986577, // 快乐猫meme小剧场
				3546753699679028, // 猫meme有剧
				1081369555, // 猫meme回忆录o
				29377899, // 阿狗的猫meme
				65423327, // 叶子猫meme
				488048942, // 白薯的猫meme剧场
				3546763354966134, // 星光赶路猫meme
				236116998, // 猫meme心灵直通车
			],
			blacklist: [
				1447557097, // 猫meme也是00后
				411221815, // 龟的猫meme
		...
		},
		{
			...
			followings: [
				...
				3493127736265152, // 俗爱大好蛋 -官方签约UP
				1987282286, // 傻蛋子奶酪 -热门UP主
			]
		},
		{
			displayName: "GLITCH",
		...
		},
		{
			...
			keywords: ["MyGo!!!!!", "MyGo", "mygo", "迷途之子", "AveMujica", "Mujica", "avemujica", "mujica", "颂乐人偶", "母鸡卡", "阿瓦母鸡卡", "高松灯", "千早爱音", "要乐奈", "长崎爽世", "长崎素世", "椎名立希", "丰川祥子", "若叶睦", "偷摸零", "阿侬酱", "长期素食", "三角初华", "八幡海铃", "祐天寺若麦"],
			followings: [
		...
		},
		{
			// 火眼金睛，识破迷信，崇尚科学，从我做起
			displayName: "牛鬼蛇神",
			displayIcon: "https://i0.hdslb.com/bfs/face/db94d2fc63002288485b32e434b481074328e0a5.jpg@100w_100h.webp",
			keywords: ["目清是个小道士", "日注意事项！", "【占卜】"],
			followings: [
				388262063, // 目清是个小道士
			],
			blacklist: [
	...
	// 加入检测尘白禁区串子和川龟成分，目前仅支持黑名单和关注列表
	fetch("https://raw.githubusercontent.com/Charles9371/cbjq_PL/main/cbjqplList.json")
    .then(response => response.json()) // 解析响应体为 JSON
    .then(res => {
        console.log(`【（改）B站成分检测器】即时\n尘白禁区串子列表加载完成\n`, res);

        // 提取 PLList 中的 UID 和 reason 字段
        const plUIDs = res.PLList.map(item => item.UID);
        const plReasons = res.PLList.map(item => item.reason);

		// 提取 PendingList 中的 UID 和 reason 字段
        const pendingUIDs = res.PendingList.map(item => item.UID);
        const pendingReasons = res.PendingList.map(item => item.reason);
        ...
        checkers.push({
            ...
            blacklist: [...plUIDs],
            followings: [...plUIDs],
            entryReasons: [...plReasons]
        });

		checkers.push({
            displayName: "观察对象",
            displayIcon: "观",
            blacklist: [...pendingUIDs],
            followings: [...pendingUIDs],
            entryReasons: [...pendingReasons]
        });

		checkers.push({
            displayName: "川龟",
            displayIcon: "龟",
            blacklist: [...res.ChuanGuiList],
            followings: [...res.ChuanGuiList],
        });
    })
    .catch(error => {
        console.error(`【（改）B站成分检测器】即时\n尘白禁区串子列表加载失败\n`, error);
	...
	// bilibili游戏区功能匹配
	waitForKeyElements("div.user-info a.user-name", (element) => {
		if (element && element.length > 0) {
			...
			element.after(button);
			button.one('click', function () {
				let userId = element.attr("href").match(/space\.bilibili\.com\/(\d+)/)[1];
				checkComposition(userId, "", element, button.find(".composition-name-control"), element, '');
			});
			...
			copy.on('click', function () {
				let userName = element.text().trim().replace(/<[^>]+>/g, ''); 
				let userId = element.attr("href").match(/space\.bilibili\.com\/(\d+)/)[1];
				let info = `${userId}, // ${userName}`;
			...
			// 自动检测低等级用户
			if (GM_getValue('AutoLower5') === 'false'){
				return;
			}

			// Obtain user Level
			let userLevelElement = element.closest(".user-info").find("i.bui-user-level").get(0);

			if (userLevelElement) {
				let userLevel = userLevelElement.getAttribute("level");
				if (userLevel) {
					userLevel = parseInt(userLevel, 10);
					console.log("用户等级:", userLevel);

					if (userLevel < TRIGGER_LEVEL) {
						button.click(); // Auto Trigger the search
					}
					
				} else {
					console.log("未找到用户等级信息");
				}

			} else {
				console.log("未找到 user-level 元素");
			}
		}
	});
    ...
    waitForKeyElements("div#info div#user-name[data-user-profile-id]", (element) => {
        if (element && element.length > 0) {
			...
			// Obtain user Level
			let userLevelElement = element.closest("#info").find("#user-level img").get(0);

			if (userLevelElement) {
				let src = userLevelElement.src;
				let userLevel;

				if (src.includes("level_h.svg")) { //Special for level for Level 6 +
					userLevel = 6;
				} else {
					let levelMatch = src.match(/level_(\d+)\.svg/i);
	...
	function checkComposition(id, elemname, element, elemload, eleminst, elemcss) {
				...
				.then((found) => {
					if (found.length > 0) {
						...
						<div style="margin-top: 20px;">
							<button id="customButton-${id}" data-id="${id}" style="background-color:rgb(251, 114, 114); color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">
								举报尘白串子
							</button>
						</div>
						`;
					...
					delete checking[id];
					checked[id] = found
					// Add Extra Tag for profiling
					for (let elements of checking[id]) {
						elements.elemload.parent().parent().attr('class', 'composition-checked');
						elements.elemload.text('报');
						elements.elemload.attr('title', '到尘白禁区PL吧留档串子');
						elements.elemload.on('click', function () {
							profilingChuanZi(id);
						});
					}
		...
		// Add Tag for Profiling 
		let profileTag = $(`<div class="composition-checked" title="${'举报串子：'} 将会打开尘白禁区PL吧进行举报 " style="${GM_getValue('Lite') === 'true' ? 'margin:2px 0 2px 8px!important;' : ""}${'opacity:0.5!important'}"><div class="composition-badge">
			<span class="composition-name" ${GM_getValue('Lite') === 'true' ? 'style="padding:0px!important;"' : ""}>${GM_getValue('Lite') === 'true' ? "" : '举报串子'}</span>
				<span class="composition-icon" ${GM_getValue('Lite') === 'true' ? 'style="margin-right:-6px!important;"' : ""}>${'报'}</span>
			</div>
		</div>`);
		profileTag.on('click', function () {
			profilingChuanZi(id);
		});
		if (elemcss) profileTag.css(elemcss);
		if (eleminst) eleminst.after(profileTag);
	}
	dom = `<div>
	...
	function showAllUser() {
		Swal.fire({
			...
			didOpen: () => {
				const buttons = document.querySelectorAll('button[id^="customButton-"]');
				buttons.forEach(button => {
					const id = button.getAttribute('data-id'); // 从 data-id 中读取 id
	...
	function profilingChuanZi(id){
		const reportInfo = `#CBJQPL# UID:${id} @asdFg⚡ `;
		try {
			alert(`即将前往尘白PL吧进行对用户 UID: ${id} 留档举报，请注意使用截图保存证据以及其UID截图防止岁与更名，文字版UID 将会保存到剪切板 （需要浏览器授权）`);

			window.open('https://tieba.baidu.com/f?kw=%E5%B0%98%E7%99%BD%E7%A6%81%E5%8C%BApl&fr=index&fp=0&ie=utf-8', '_blank');

			if (navigator.clipboard) {
				navigator.clipboard.writeText(reportInfo);
				console.log('UID 已成功存入剪贴板：', reportInfo);
			} else {
				console.error('浏览器不支持剪贴板 API');
				prompt('请手动复制以下 UID：', reportInfo);
			}
		} catch (error) {
	...
	function setting(conf_name, tips, bool) {
		if (bool) {
	...
	// Init GM values 
    if (GM_getValue('Reply') === undefined) {
        GM_setValue('Reply', 'false'); 
    }
    if (GM_getValue('Lite') === undefined) {
        GM_setValue('Lite', 'false'); 
    }
    if (GM_getValue('Auto') === undefined) {
        GM_setValue('Auto', 'false'); 
    }
	if (GM_getValue('AutoLower5') === undefined) {
        GM_setValue('AutoLower5', 'false');
    }

	if (GM_getValue('Reply') === 'true') {
		GM_registerMenuCommand('查询用户历史评论(AICU数据库)：✅ 已启用', function () {
			setting('Reply', '查询用户历史评论', false)
		});
	} else {
		GM_registerMenuCommand('查询用户历史评论(AICU数据库)：❌ 已禁用', function () {
			setting('Reply', '查询用户历史评论', true)
		});
	}

	if (GM_getValue('Lite') === 'true') {
		GM_registerMenuCommand('隐藏用户成分名称(仅显示图片)：✅ 已启用', function () {
			setting('Lite', '隐藏用户成分名称', false)
		});
	} else {
		GM_registerMenuCommand('隐藏用户成分名称(仅显示图片)：❌ 已禁用', function () {
			setting('Lite', '隐藏用户成分名称', true)
		});
	}

	if (GM_getValue('Auto') === 'true') {
		GM_registerMenuCommand('自动检测用户成分(易触发风控)：✅ 已启用', function () {
			setting('Auto', '自动检测用户成分', false)
		});
	} else {
		GM_registerMenuCommand('自动检测用户成分(易触发风控)：❌ 已禁用', function () {
			setting('Auto', '自动检测用户成分', true)
		});
	}

	if (GM_getValue('AutoLower5') === 'true') {
		GM_registerMenuCommand('自动检测低于5级用户成分(易触发风控)：✅ 已启用', function () {
			setting('AutoLower5', '自动检测低于5级用户成分', false)
		});
	} else {
		GM_registerMenuCommand('自动检测低于5级用户成分(易触发风控)：❌ 已禁用', function () {
			setting('AutoLower5', '自动检测低于5级用户成分', true)
		});
	}
	...
	// 注：以下代码用于绕过哔哩哔哩风控机制——
	// 一是伪造 WebGL 指纹，防止因禁用 WebGL 导致的风控错误（如 -352）；
	// 二是拦截对 B站 API 的请求，自动添加 dm_img_list、dm_img_str 和 dm_cover_img_str 参数，并重新生成 WBI 签名。
	// 这两部分均参考了逆向文章中的思路，确保即使在诸如 LibreWolf 禁用了 WebGL 的环境下，也能正常获取数据。
	if (!window.__bilibiliRiskBypassInjected) {
		// 伪造 WebGL 指纹：覆盖 canvas.getContext 方法
		let fakeGL = {
		...
		// 拦截 fetch 请求，自动添加风控参数并重新生成签名
		const origFetch = window.fetch;
		window.fetch = async (...args) => {
			let url;
			try {
				url = new URL(args[0], location.origin);
			} catch (e) {
				return origFetch(...args);
			}
			// 针对 api.bilibili.com 下的相关接口添加风险绕过参数
			if (
				url.host === "api.bilibili.com" &&
				( url.pathname.startsWith("/x/relation/followings") ||
				url.pathname.startsWith("/x/polymer/web-dynamic/v1/feed/space")
				// 如有其他需要绕过风控的接口，可在此处增加判断条件
				)
			) {
				// 添加 WebGL 相关的参数（确保这些值为白名单内的合法值）
				...
				// 取出所有参数，删除可能存在的签名字段，然后重新生成签名
				let paramsObj = Object.fromEntries(url.searchParams.entries());
				delete paramsObj.wts;
				delete paramsObj.w_rid;
				// 假设 wbiSign 函数已定义并可用（参见 bilibili-API-collect 中的实现）
		...
		window.__bilibiliRiskBypassInjected = true;
	}
	...
	// 						if (replyContent && typeof (replyContent) === 'object' && replyContent.code !== undefined) {
    ...
    //                         for (let i = 0; i < rule.blacklist.length; i++) {
    //                             const uid = rule.blacklist[i].toString();
    //                             const reason = rule.entryReasons && i < rule.entryReasons.length ? rule.entryReasons[i] : null;
    //                             ruleMap.set(uid, reason);
    //                         }

    //                         if (ruleMap.has(id)) {
    //                             const reason = ruleMap.get(id);
    //                             const hit = {
    //                                 ...rule,
    //                                 reason: `黑名单`,
	// 								sure: true,
	...
	// 				for (let rule of checkers) {
	// 					if (rule.followings) { 
	// 						// 将 followings 和 entryReasons 转换为 Map
	// 						const ruleMap = new Map();
	// 						for (let i = 0; i < rule.followings.length; i++) {
	// 							const uid = rule.followings[i].toString();
	// 							const reason = rule.entryReasons && i < rule.entryReasons.length ? rule.entryReasons[i] : null;
	// 							ruleMap.set(uid, reason);
	// 						}
							...
							if (followingContent && followingContent.code !== undefined) {
								if (followingContent.code === 0) {
									...
									if (currentPage === 1) {
										...
										if (totalFollowings === 0) break; // 啥都没关注时，直接结束
										pageSize = followingContent.data.list.length; // 获取每页数量
										totalPages = Math.min(Math.ceil(totalFollowings / pageSize), maxPages); // 先得到大致页数并与最多可获取页数对比取较小值
										if (totalPages === 1) break; // 只有一页时，直接结束
									}
									if (currentPage >= totalPages) break; // 达到最大页数时结束
									currentPage++; // 获取下一页
							...
							if (replyContent && typeof (replyContent) === 'object' && replyContent.code !== undefined) {
								if (replyContent.code === 0) {
									...
									if (currentPage === 1) {
										totalReplys = cursor.all_count;
										if (totalReplys === 0) break; // 啥都没评论时，直接结束
										totalPages = Math.min(Math.ceil(totalReplys / pageSize), maxPages); // 先得到大致页数并与最多可获取页数对比取较小值
										if (totalPages === 1 || cursor.is_end) break; // 只有一页或者达到最大页数时，直接结束
									}
									if (currentPage >= totalPages || cursor.is_end) break; // 达到最大页数时结束
									currentPage++; // 获取下一页
