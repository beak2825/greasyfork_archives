// ==UserScript==
// @name         Bmx Twitch Adblock
// @namespace    https://bmx-tv.net
// @version      2.0.0
// @description  Blocking Ads For BMX Twitch Streams
// @author       https://bmx-tv.net/
// @match        *://*.twitch.tv/*
// @run-at       document-start
// @inject-into  page
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/524264/Bmx%20Twitch%20Adblock.user.js
// @updateURL https://update.greasyfork.org/scripts/524264/Bmx%20Twitch%20Adblock.meta.js
// ==/UserScript==
(function() {
    'use strict';
    var ourtwitchAdBMXVersion = 2;// Only bump this when there's a breaking change to Twitch, the script, or there's a conflict with an unmaintained extension which uses this script
    if (window.twitchAdBMXVersion && window.twitchAdBMXVersion >= ourtwitchAdBMXVersion) {
        console.log("skipping vaft as there's another script active. ourVersion:" + ourtwitchAdBMXVersion + " activeVersion:" + window.twitchAdBMXVersion);
        window.twitchAdBMXVersion = ourtwitchAdBMXVersion;
        return;
    }
    window.twitchAdBMXVersion = ourtwitchAdBMXVersion;
    ...
    // - twitchAdBMX : TwitchNoSub : window.Worker
    //
    // But it's fine in this scenario:
    // - TwitchNoSub : twitchAdBMX : window.Worker
    //
