...
// @downloadURL https://update.greasyfork.org/scripts/555240/API-Speicher.user.js
// @updateURL https://update.greasyfork.org/scripts/555240/API-Speicher.meta.js
// ==/UserScript==

'use strict'

const DB_NAME = 'lss-api-storage-1';
const DB_VERSION = 6;
...
function updateMissions(db, maxAge = 3_60000) {
