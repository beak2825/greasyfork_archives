...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/496092/Macros%20agario.user.js
// @updateURL https://update.greasyfork.org/scripts/496092/Macros%20agario.meta.js
// ==/UserScript==
...
function keydown(event) {
    if (event.keyCode == 69 && DioMasa === false) {
        DioMasa = true;
        setTimeout(funcionmasa, DuracionDelay);
    } // Dar masa
    if (event.keyCode == 84) {
