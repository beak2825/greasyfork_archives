...
// @version      0.1.0
// @author       RenAllQi
// @description  🐷 目前已经支持的平台：超星学习通(功能奇全) 🐸知到智慧树（仅仅答题！我宝宝的专属）功能包括：视频，跳转任务点，章节测试、考试完成，自动切换、保存。使用脚本请进入对应平台的页面。
// @license      MIT
...
// @downloadURL https://update.greasyfork.org/scripts/538052/%E6%88%98%E7%A5%9E%E5%A5%A5%E5%A5%87.user.js
// @updateURL https://update.greasyfork.org/scripts/538052/%E6%88%98%E7%A5%9E%E5%A5%A5%E5%A5%87.meta.js
// ==/UserScript==
...
(function (vue, pinia, rxjs, md5, ElementPlus) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createVNode(_component_el_input, {
            ...
            placeholder: "获取的密钥的密钥填到这里即可，题库问题与脚本无关，题库没有就沉下心，静下去。哈哈哈"
          }, {
            prepend: vue.withCtx(() => [
  ...
  const _hoisted_3$2 = /* @__PURE__ */ vue.createElementVNode("p", null, '2、脚本没有开发自己到题库，而是接入了第三方题库，如需填写密钥，依次操作：[1] 点击标签页"答题" --> [2] 在文本框内填写 --> [3] 刷新', -1);
  const _hoisted_4$1 = /* @__PURE__ */ vue.createElementVNode("p", { style: { "font-weight": "500" } }, "务必注意：", -1);
  const _hoisted_5$1 = /* @__PURE__ */ vue.createElementVNode("p", null, "-- 脚本出现相关问题，请在脚本反馈区反馈，或者私信作者486779764@qq.com修复。", -1);
  const _hoisted_6$1 = /* @__PURE__ */ vue.createElementVNode("p", null, "-- 题库密钥请确认能够搜索到题目再获取，题库均为网络收集的第三方题库，出现任何问题与脚本无关。本人仅仅是中科院战神奥奇，没时间去调试太多功能", -1);
  const _hoisted_7$1 = [
    _hoisted_2$2,
    _hoisted_3$2,
    _hoisted_4$1,
  ...
  const hookError = () => {
    ...
    var doc = _unsafeWindow.document;
    ["selectstart", "copy", "cut", "paste", "contextmenu"].forEach((eventName) => {
  ...
  class XMLHttpRequestInterceptor {
    ...
    intercept(urlList) {
      ...
      XMLHttpRequest.prototype.open = function(method, url2, async, user, password) {
        self.originalOpen.apply(this, [method, url2, async, user, password]);
  ...
  const _sfc_main$3 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit: __emit }) {
      ...
      logStore.addLog("孩子请不要多个脚本同时使用，会有奥奇肘击你", "warning");
      logStore.addLog("如果脚本出现异常，说明本人已进局子了", "warning");
      const urlLogicPairs = [
              ...
              vue.createElementVNode("div", {
                ...
                vue.createElementVNode("div", _hoisted_2, [
                  ...
                  vue.createVNode(_component_el_tooltip, {
                    ...
                    effect: "dark",
                    placement: "top-start",
                    content: "<span>注意事项：<br/>此版本已经陨落了,老大陨落。<br/></span>",
                    "raw-content": ""
                  }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_el_icon, {
