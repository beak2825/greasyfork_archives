...
// @downloadURL https://update.greasyfork.org/scripts/485929/%E6%98%93%E4%BB%93%E5%A4%B4%E7%A8%8B%E4%BF%A1%E6%81%AF%E7%BB%B4%E6%8A%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/485929/%E6%98%93%E4%BB%93%E5%A4%B4%E7%A8%8B%E4%BF%A1%E6%81%AF%E7%BB%B4%E6%8A%A4.meta.js
// ==/UserScript==
...
class Fee1OrderIndexPage extends Page {
    ...
    addExportli() {
        ...
        let aId = "cqgg-fee1-import-excel-a";
        let html = '<li id=' + liId + ' style="width: 180px"><a href="javascript:void(0)" id=' + aId + '>'
            + Fee1OrderIndexPage.importBtnName + '</a></li>';
    ...
    openLayer() {
        ...
        layer.open({
            ...
            area: ['40%', '500px'],
            offset: "",
            title: Fee1OrderIndexPage.importBtnName,
            anim: 1,
            shade: false,
            maxmin: true,
            content: url,
...
class Fee1OrderListPage extends Page {
    ...
    createButtonReal(node, buttonId, tbCode, insertLocation) {
        ...
        button.innerText = Fee1OrderListPage.buttonName;
        button.id = buttonId;
