...
// @name         自用薅rewards羊毛
// @version      V1.8
// @description  自动完成微软Rewards每日搜索任务。
// @note         更新于 2025年5月4日，依据V3.1.1修改
// @author       VvLin
// @match        https://*.bing.com/*
// @exclude      https://rewards.bing.com/*
// @license      GNU GPLv3
// @icon         https://raw.githubusercontent.com/xushier/HD-Icons/main/border-radius/Fenrus_A.png
...
// @namespace https://greasyfork.org/users/669970
// @downloadURL https://update.greasyfork.org/scripts/496052/%E8%87%AA%E7%94%A8%E8%96%85rewards%E7%BE%8A%E6%AF%9B.user.js
// @updateURL https://update.greasyfork.org/scripts/496052/%E8%87%AA%E7%94%A8%E8%96%85rewards%E7%BE%8A%E6%AF%9B.meta.js
// ==/UserScript==
...
var appkey = "52e0616198c3220e9b126bc27f0e9314";//从api.gumengya.com网站申请的热门词接口APIKEY
...
function checkAndExecute() {
    ...
    var now = new Date();
    // 设置时间为3AM
    var targetTime = new Date(now.getFullYear(), now.getMonth(), now.getDate(), 0, 9, 0, 0);

    // 如果时间过了?3AM?则设置targetTime为明天的3AM
    if (now > targetTime) {
    ...
    // 如果为负，说明是同一天的未来，调整为正数
    if (timeToWait < 0) {
        timeToWait += 24 * 60 * 60 * 1000; // ??????
    }
    // 使用setTimeout计算出时间后执行任务
    setTimeout(function () {
        executeDailyTask();
        // 重新调度，每天都能执行
        checkAndExecute();
