...
// @downloadURL https://update.greasyfork.org/scripts/492949/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/492949/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
(function () {
  'use strict';
    ...
    title: '_________________________________RolePlay ситуации________________________________________'
         },
         {
          ...
          "[CENTER][COLOR=rgb(0, 255, 215)][FONT=courier new][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
           ...
           "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(117, 20, 196)]Barnaul[/COLOR].<br><br>"+
         ...
         },
         {
          ...
          '[CENTER][COLOR=rgb(0, 255, 215)][FONT=courier new][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR][/CENTER]<br><br>' +
            "[CENTER][SIZE=4][FONT=courier new][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [COLOR=rgb(255, 0, 67)]отказана[/COLOR] т.к ваш все никнеймы должны быть написаны на русском языке. [/COLOR][/CENTER]<br><br>" +
           	"[CENTER][FONT=TIMES NEW ROMAN] [I][SIZE=3][COLOR=LightSlateGray]  Ознакомиться с правилами создания РП ситуаций [/COLOR][URL='https://forum.blackrussia.online/threads/barnaul-Правила-написания-РП-Ситуаций.8035445/'][Color=crimson][U]*тут*[/U][/color][/URL][/CENTER]<br><br>" +
              "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(117, 20, 196)]Barnaul[/COLOR].<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>',
          prefix: UNACCEPT_PREFIX,
          status: false,
  ...
  title: 'био одобрено',
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][FONT=TIMES NEW ROMAN] [I][SIZE=3][COLOR=LightSlateGray]  Ознакомиться с правилами создания РП Биографий [/COLOR][URL='https://forum.blackrussia.online/threads/barnaul-Правила-написания-rp-биографии.8035405/'][Color=crimson][U]*тут*[/U][/color][/URL][/CENTER]<br><br>" +
             "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(117, 20, 196)]Barnaul[/COLOR].<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>',
  ...
  title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴Неофициальные RP организации ╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][FONT=TIMES NEW ROMAN] [I][SIZE=3][COLOR=LightSlateGray]  Ознакомиться с правилами создания Неофициальных RP организаций [/COLOR][URL='https://forum.blackrussia.online/threads/barnaul-Правила-создания-roleplay-организаций.8035501/'][Color=crimson][U]*тут*[/U][/color][/URL][/CENTER]<br><br>" +
             "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(117, 20, 196)]Barnaul[/COLOR].<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>',
      prefix: UNACCEPT_PREFIX,
	  status: false,
