...
// @nocompat Chrome
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/440968/TW-Collections.user.js
// @updateURL https://update.greasyfork.org/scripts/440968/TW-Collections.meta.js
// ==/UserScript==
(function (e) {
  ...
  TWT = {
        ...
        Options: {
          ...
          checkbox_text: {
            ...
            twdbadds: {
              ...
              options: {
                filterBuyMarket: 'Filtre dans le march&eacute; pour n\'afficher que les items manquants <a target=\'_blank\' href="https://tw-db.info/?strana=userscript">(twdb add)</a>'
              }
            }
          },
          message: {
        ...
        Options: {
          ...
          checkbox_text: {
            ...
            twdbadds: {
              ...
              options: {
                filterBuyMarket: 'Market filter : show only marked missing items <a target=\'_blank\' href="https://tw-db.info/?strana=userscript">(twdb add)</a>'
              }
            }
          },
          message: {
    ...
    isGreasyLang: function (lang) {
      ...
      if ($.inArray(lang.idscript, oldIdLangs) > -1) {
        var dlg = new west.gui.Dialog("Unmaintained language script for TW Collection", "<div><b>You are using an obsolete version of '" + lang.name + "' language script for TW Collection.</b>" + "<br><br>You should manually uninstall this script and <br><a target='_blank' href='https://greasyfork.org/scripts/" + TWT.langPatchs[lang.short_name].link + "'>" + "Install the correct version  of " + lang.name + " script.</a>" + "</div>", west.gui.Dialog.SYS_WARNING).setModal(true, false, {
      ...
      translate: {
        open: function () {
          ...
          $.each(langPatchs, function (lang) {
            txtArea += "<a target='_blank' href='https://greasyfork.org/scripts/" + langPatchs[lang].link + "'>" + langPatchs[lang].texte + " by " + langPatchs[lang].author + "</a><br>";
          });
      ...
      addCheckBoxMarket: function (div) {
        ...
        if (TWT.isTWDBHere && TWT.Settings.isChecked("twdbadds.filterBuyMarket")) {
          if ($('#buyFilterIsCollect2').length == 0) {
            ...
            TWT.Market.insertedCB2 = new west.gui.Checkbox('<img src="data:image/png;base64,"' + ' style="width:18px;height:18px">' + TWT.LANG.twdbadds.buyFilterLabel, false, function () {
                if (this.isSelected()) {
      ...
      try {
        ...
        if (strLang.length > 0) {
          ...
          var parent = new west.gui.Dialog(TWT.LANG.Options.update.title, "<div><br>" + TWT.LANG.Options.update.updlangmaj + "<br><center>" + strLang + "</center></div>").setIcon(west.gui.Dialog.SYS_INFORMATION).setModal(true, false, {
              ...
              parent.hide();
              window.open("https://greasyfork.org/scripts/" + ScriptUpdater.scriptId, '_blank');
            }).addButton('Close');
          parent.show();
        }
      } catch (e) {
        ...
        var gocheck = function () {
          ...
          if (ScriptUpdater.scriptCurrentVersion < ScriptUpdater.scrnv[ScriptUpdater.scriptId]) {
            ...
            var parent = new west.gui.Dialog(TWT.LANG.Options.update.title, "<div style='" + ((strNew.length > 0) ? "width:650px;height:250px;" : "") + "font-size:16px;text-align:justify;'><BR>" + TWT.LANG.Options.update.updscript + "<div id='boxnews' style='margin-top:20px;font-size:14px;font-style: italic;'>" + strNew + "</div></div>").setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false, {
                ...
                parent.hide();
                window.open("https://greasyfork.org/scripts/" + ScriptUpdater.scriptId + "/code.user.js", '_self');
