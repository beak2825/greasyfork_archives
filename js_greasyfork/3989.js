...
// @copyright  2014+, You
// @downloadURL https://update.greasyfork.org/scripts/3989/A-chan%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/3989/A-chan%20script.meta.js
// ==/UserScript==
...
function updateThread(){
    ...
    if(xmlThreadLength > ThreadLength){
		document.getElementsByTagName('div')[11].innerHTML = xmlHttp.responseText.split('<hr>')[1];
    }
}
