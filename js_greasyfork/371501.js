...
// @include      http*://j.gs*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/371501/flamzy.user.js
// @updateURL https://update.greasyfork.org/scripts/371501/flamzy.meta.js
// ==/UserScript==
        ...
        var rellenar_entradas = function (videos_restantes) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#entradas", info_container).html("Llevas " + total_entradas + " entradas de 150.");
                }
            });
        };
