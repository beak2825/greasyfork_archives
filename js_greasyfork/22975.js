...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/22975/Barre%20d%27outils%20RealityGaming.user.js
// @updateURL https://update.greasyfork.org/scripts/22975/Barre%20d%27outils%20RealityGaming.meta.js
// ==/UserScript==

$(document).ready(function(){
$(".aideTabLinks").after('<div class="Menu JsOnly tabMenu premiumTabLinks" id="XenForoUniq800" style="display: none; visibility: visible; position: fixed; right: 15px; top: 90px;"><div class="primaryContent menuHeader"><h3>Premium</h3><div class="muted">Liens rapides</div></div><ul class="secondaryContent blockLinksList"><li><a href="https://realitygaming.fr/actualites/">/</a>Actualité</li><li><a href="https://realitygaming.fr/categories/zone-premium.66/">Zone Premium</a></li></ul></div>');
