...
// @downloadURL https://update.greasyfork.org/scripts/418394/onlineliga%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/418394/onlineliga%20Helper.meta.js
// ==/UserScript==
        ...
        if(playerId)
        {
            $.get("https://www.onlineliga.de/player/overview?playerId=" + playerId,function(data){
                if(data){
                    ...
                    var fieldMobileStats = $(".hidden-xs div.player-attr").eq(5).parent();7
