// ==UserScript==
// @name         学习通(考试版)
// @namespace    2485786435@qq.com
// @version      0.1.1
// @description  自动搜索学习通考试答案，支持自动答题、自动切换题目、隐藏答案搜索提示框，支持自定义每个功能的开启或关闭
// @author       2485786435
...
// @supportURL   
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/382850/%E5%AD%A6%E4%B9%A0%E9%80%9A%28%E8%80%83%E8%AF%95%E7%89%88%29.user.js
// @updateURL https://update.greasyfork.org/scripts/382850/%E5%AD%A6%E4%B9%A0%E9%80%9A%28%E8%80%83%E8%AF%95%E7%89%88%29.meta.js
// ==/UserScript==
...
function fillAnswer(obj, tip) {
    ...
    obj.code == 1 && $input.each(function(index) {
        if (this.value == 'true') {
            ...
            index = $.inArray(setting.TiMu[3][index], data) + 1 || (setting.TiMu[1] == '1' && String(obj.data).match(setting.TiMu[3][index]));
