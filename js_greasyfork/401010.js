...
// @include             https://*
// @run-at              document-end
// @namespace https://greasyfork.org/users/515137
// @downloadURL https://update.greasyfork.org/scripts/401010/highlight-my-interest.user.js
// @updateURL https://update.greasyfork.org/scripts/401010/highlight-my-interest.meta.js
// ==/UserScript==
...
SettingService.DefaultSetting = {
  ...
  sites: {
    'https://weibo.com/*': DefaultKeywords,
    'https://m.weibo.cn/*': DefaultKeywords,
  },
}
