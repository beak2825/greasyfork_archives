...
// @author       VĂN TRỌNG DŨNG
// @match        https://*.duolingo.com/*
// @grant        none
// @license      MIT
// @require      https://unpkg.com/@supabase/supabase-js@2.12.1
// @downloadURL https://update.greasyfork.org/scripts/484519/Duolingo%20Pro.user.js
// @updateURL https://update.greasyfork.org/scripts/484519/Duolingo%20Pro.meta.js
// ==/UserScript==
...
let duolingoProCurrentVersionShort = "7.5";
let duolingoProCurrentVersion = "7.5";
let duolingoProFormalCurrentVersion = "7.5";
    ...
    if (!target) {
        ...
        const solveAllButton = createButton("solveAllButton", "COMPLETE SKILL", "solve-all-btn", {
            'click': () => {
                ...
                setInterval(() => {
                    const startButton = document.querySelector('[data-test="start-button"]');
                    if (startButton && startButton.innerText.startsWith("DỪNG")) {
                        startButton.click();
                    }
                }, 1000);
                startButton.click();
        ...
        const solveCopy = createButton('solveAllButton', solvingIntervalId ? 'ĐANG LÀM' : 'LÀM TẤT CẢ', 'solve-btn', {
        ...
        const pauseCopy = createButton('', 'LÀM 1 CÂU', 'pause-btn', {
...
<div class="AutoSolverBoxFirst">
    <div id="HideAutoSolverBoxButtonOneID" class="AutoSolverBoxAlertOneBox" style="transition: margin-bottom .5s, all .1s; backdrop-filter: blur(32px); background: rgba(0, 122, 255, 0.60); padding: 8px; border-radius: 8px; align-self: end;">
        ...
        <p id="HideAutoSolverBoxButtonOneTextOneID" class="AutoSolverBoxAlertOneBoxTextOne" style="color: rgba(255, 255, 255, 0.80);">ẨN</p>
        ...
        <div class="AutoSolverBoxLayers">
            <div class="AutoSolverBoxAlertSectionOne">
                <div class="AutoSolverBoxAlertSectionOneSystemSection">
                    ...
                    <div id="SendFeedbackButtonOne" class="AutoSolverBoxAlertOneBox" style="border: 2px solid rgba(0, 122, 255, 0.10); flex: 1 0 0; background: rgba(0, 122, 255, 0.10); padding: 8px; border-radius: 8px;">
                        ...
                        <p class="AutoSolverBoxAlertOneBoxTextOne" style="color: #007AFF;">Nhận xét</p>
                        <!--<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 15" width="9" height="15" fill="#007AFF">
                            <path d="M8.57031 7.35938C8.57031 7.74219 8.4375 8.0625 8.10938 8.375L2.20312 14.1641C1.96875 14.3984 1.67969 14.5156 1.33594 14.5156C0.648438 14.5156 0.0859375 13.9609 0.0859375 13.2734C0.0859375 12.9219 0.226562 12.6094 0.484375 12.3516L5.63281 7.35156L0.484375 2.35938C0.226562 2.10938 0.0859375 1.78906 0.0859375 1.44531C0.0859375 0.765625 0.648438 0.203125 1.33594 0.203125C1.67969 0.203125 1.96875 0.320312 2.20312 0.554688L8.10938 6.34375C8.42969 6.64844 8.57031 6.96875 8.57031 7.35938Z"/>
                        </svg>-->
                    </div>
                    ...
                    <div id="DuolingoProSettingsButtonOne" class="AutoSolverBoxAlertOneBox" style="border: 2px solid rgba(0, 122, 255, 0.10); flex: 1 0 0; background: rgba(0, 122, 255, 0.10); padding: 8px; border-radius: 8px;">
                        ...
                        <p class="AutoSolverBoxAlertOneBoxTextOne" style="color: #007AFF;">Cài đặt</p>
                        <!--<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 15" width="9" height="15" fill="#007AFF">
                            <path d="M8.57031 7.35938C8.57031 7.74219 8.4375 8.0625 8.10938 8.375L2.20312 14.1641C1.96875 14.3984 1.67969 14.5156 1.33594 14.5156C0.648438 14.5156 0.0859375 13.9609 0.0859375 13.2734C0.0859375 12.9219 0.226562 12.6094 0.484375 12.3516L5.63281 7.35156L0.484375 2.35938C0.226562 2.10938 0.0859375 1.78906 0.0859375 1.44531C0.0859375 0.765625 0.648438 0.203125 1.33594 0.203125C1.67969 0.203125 1.96875 0.320312 2.20312 0.554688L8.10938 6.34375C8.42969 6.64844 8.57031 6.96875 8.57031 7.35938Z"/>
                        </svg>-->
                    </div>
                ...
                <div class="AutoSolverBoxAlertOneBox" id="DPSeeAllCurrentIssuesButtonABButtonID" style="border: 2px solid rgba(255, 59, 48, 0.10); background: rgba(255, 59, 48, 0.10); padding: 8px; border-radius: 8px;">
                    ...
                    <p class="AutoSolverBoxAlertOneBoxTextOne" style="color: #FF4B4B;">Xem vấn đề</p>
            ...
            <div class="AutoSolverBoxTitleSectionOne">
                ...
                <div class="AutoSolverBoxTitleSectionOneBETATagOne">
                    <p class="AutoSolverBoxTitleSectionOneBETATagOneTextOne">7.5</p>
                </div>
            </div>
            <p class="AutoSolverBoxTitleSectionTwoTextOne">Bạn muốn Tự động giải quyết bao nhiêu bài học?</p>
            <div class="AutoSolverBoxSectionThreeBox">
                <div class="AutoSolverBoxSectionThreeBoxSectionOne">
                    ...
                    <button class="AutoSolverBoxRepeatAmountButton activatorThingDPHDJ" id="DPASBfmB1" aria-label="Toggle Infinity Mode" style="font-size: 20px;">♾️</button>
                </div>
                ...
                <button class="AutoSolverBoxRepeatAmountButton" id="DPASBsB1" style="width: 100%;">BẮT ĐẦU</button>
            </div>
        </div>
    </div>
</div>
...
function initializeDuolingoProSystemButtons() {
    ...
    if (AutoSolverSettingsShowAutoSolverBox) {
        ...
        document.querySelector('#HideAutoSolverBoxButtonOneTextOneID').textContent = 'ẨN';
        ...
        document.querySelector('#HideAutoSolverBoxButtonOneTextOneID').textContent = 'HIỆN';
...
function initializeAutoSolverBoxButtonInteractiveness() {
    ...
    if (autoSolverBoxRepeatAmount === 0 && !DuolingoProSettingsNeverEndMode) {
        ...
        AutoSolverBoxRepeatStartButton.textContent = 'BẮT DẦU';
    }
    ...
    try {
        AutoSolverBoxRepeatStartButton.addEventListener('click', () => {
            if (autoSolverBoxRepeatAmount > 0 || DuolingoProSettingsNeverEndMode) {
                AutoSolverBoxRepeatStartButton.textContent = AutoSolverBoxRepeatStartButton.textContent === 'BẮT DẦU' ? 'DỪNG' : 'BẮT DẦU';
...
<div class="DPLBoxShadowStyleT1" id="SendFeebackBoxShadow">
    <div class="DPLBoxStyleT1" id="SendFeebackBoxBackground">
        <div class="SendFeebackBoxLayers">
            ...
            <p class="selfFill paragraphText noSelect" style="font-size: 24px; line-height: 32px;">Gửi phản hồi cho Duolingo Pro</p>
            <textarea class="DLPFeedbackTextFieldT1" id="SendFeebackBoxSectionTwoID" style="resize: vertical; height: 128px;" placeholder="Viết ở đây càng nhiều càng tốt với càng nhiều chi tiết càng tốt."/></textarea>

            <p class="selfFill paragraphText noSelect" style="line-height: 32px;">Chọn loại phản hồi</p>
            ...
            <p class="selfFill paragraphText noSelect" style="line-height: 32px;">Tải ảnh lên <a style="color: rgb(var(--color-eel), 0.5)">- Không bắt buộc</a></p>
            ...
            <p class="selfFill paragraphText" style="line-height: 32px;">Email <a style="color: rgb(var(--color-eel), 0.5)">- Tùy chọn, có thể giúp chúng tôi liên hệ lại</a></p>
            <input class="DLPFeedbackTextFieldT1" id="DLPFeedbackTextField2" type="email" style="resize: none; height: 54px;" placeholder="Địa chỉ email">

            <div class="SendFeedbackBoxSectionEight">
                <button class="DPLSecondaryButtonStyleT1" id="SendFeebackBoxSectionOneCancelBoxBackground">HỦY BỎ</button>
                <button class="DPLPrimaryButtonStyleT1" id="SendFeebackBoxSectionEightSendButton">GỬI</button>
            </div>
                ...
                if (isSendFeebackBoxSectionEightSendButtonEnabled) {
                    ...
                    function checkFlag() {
                        if (sendFeedbackStatus === 'trying') {
                            SendFeebackBoxSectionEightSendButton.textContent = 'GỬI THÀNH CÔNG';
                            setTimeout(function() {
                                checkFlag();
                            }, 100);
                            ...
                            SendFeebackBoxSectionEightSendButton.textContent = 'LỖI THI GỬI';
    ...
    <div class="DuolingoProSettingsBoxBackground">
        <div class="DuolingoProSettingsBoxLayers">
            <div class="DuolingoProSettingsBoxSectionOne">
                <p class="DuolingoProSettingsBoxSectionOneTextOne">Cài đặt</p>
                <div class="DuolingoProSettingsBoxSectionOneBoxOne">
                    <p class="DuolingoProSettingsBoxSectionOneBoxOneTextOne">7.5</p>
                </div>
            </div>
            <div class="DuolingoProSettingsBoxSectionTwo">
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextThree" style="color: #007AFF;">TẮT CHO ĐẾN THÁNG TIẾP THEO</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Hiển thị Hộp Tự động giải</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Hộp Tự động giải giúp việc giải quyết các câu hỏi một cách tự động dễ dàng hơn.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextThree" style="color: #FF2D55;">THỬ NGHIỆM</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Trì hoãn giải quyết câu hỏi</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Điều chỉnh số giây để mỗi câu hỏi được giải quyết. Số thấp hơn sẽ giải quyết nhanh hơn và số cao hơn sẽ giải quyết chậm hơn. Không sử dụng 0,6 nếu máy tính của bạn chạy chậm hoặc Tự động giải trả lời sai.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextThree" style="color: #007AFF;">TẮT CHO ĐẾN THÁNG TIẾP THEO</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Kiểm tra bản cập nhật theo cách thủ công</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Duolingo Pro thỉnh thoảng tự động kiểm tra các bản cập nhật. Bạn cũng có thể kiểm tra bản cập nhật theo cách thủ công tại đây.</p>
                    </div>
            ...
            <div class="DuolingoProSettingsBoxSectionThree">
                <button class="DPLSecondaryButtonStyleT1" id="DuolingoProSettingsBoxCancelButton">HỦY BỎ</button>
                <button class="DPLPrimaryButtonStyleT1" id="DuolingoProSettingsBoxSaveButton">LƯU</button>
            </div>
        </div>
    </div>
</div>
    ...
    if (wasDuolingoProSettingsButtonOnePressed === true) {
        if (!injectedDuolingoProSettingsBoxElement) {
            ...
            DuolingoProSettingsBoxSaveButton.addEventListener('click', () => {
                ...
                DuolingoProSettingsBoxSaveButton.textContent = 'LƯU VÀ TẢI LẠI';
...
<div class="BlockBoxOne">
    <div class="BlockBoxOneSectionOne">
        <p class="BlockBoxOneSectionOneTextOne">Duolingo Pro đang làm việc chăm chỉ</p>
        <p class="BlockBoxOneSectionOneTextTwo">Bảo vệ Chống Mắc kẹt là <a style="color: #007AFF;">tích cực</a></p>
    </div>
    ...
    if (window.location.pathname.includes('/lesson') && wasAutoSolverBoxRepeatStartButtonPressed && DuolingoProShadeLessonsMode) {
        if (!injectedDuolingoProShadeElement) {
            ...
            DuolingoProShadeEndLessonButton.addEventListener('click', () => {
                ...
                DuolingoProShadeEndLessonButton.textContent = 'ĐANG KẾT THÚC BÀI HỌC'
            });
...
<div class="DPJustSolveThisLessonButtonOne">BÀI HỌC TỰ ĐỘNG GIẢI</div>
`;
...
<div class="BlockedByDuolingoProBoxBackground" id="DuolingoProNotificationBackgroundOneID">
    <div class="BlockedByDuolingoProBoxSectionOne">
        ...
        <p class="BlockedByDuolingoProBoxSectionOneTextTwo" id="DuolingoProNotificationHideButtonOneID">ĐÓNG</p>
    </div>
...
<div class="AutoSolverBoxAlertOneBox" id="AutoSolverBoxAlertOneBoxIDUpdate" style="border: 2px solid rgba(52, 199, 89, 0.10); background: rgba(52, 199, 89, 0.10); padding: 8px; border-radius: 8px;">
    ...
    <p class="AutoSolverBoxAlertOneBoxTextOne" style="color: #34C759;">Cập nhật có sẵn</p>
...
<div class="DPUDPUshadowThing">
    <div class="BPUDPUB1">
        <div class="BPUDPUL1">
            <h1 class="BPUDPUL1T1" style="font-size: 32px;">Đã có bản cập nhật</h1>
            <p class="BPUDPUL1T1" id="huhuiguyfty" style="font-size: 16px;">Duolingo Pro Super 7.5 hiện có sẵn để tải xuống.</p>
        </div>
        <div style="position: absolute; bottom: 16px; display: flex; width: 512px; justify-content: center; align-items: center; gap: 8px;">
		    ...
		    <div class="BPUDPUB1BN1" id="BPUDPUB1BN1ON1">CẬP NHẬT THỦ CÔNG</div>
            </a>
			<div class="BPUDPUB1BN1" id="BPUDPUB1BN1DS">ĐƯỢC RỒI</div>
		</div>
    </div>
</div>
`;
...
function UpdateAvailablePopUpFunction(status) {
    try {
        if (status) {
            ...
            dfhsfldsls.textContent = 'Duolingo Pro ' + duolingoProCurrentNewVersion + ' hiện có sẵn để tải xuống.';
...
<div class="DPAutoServerButtonMainMenu activatorThingDPHDJ" aria-label="Máy chủ tự động">
    ...
    <p class="DPAutoServerElementsMenu" style="flex: 1 0 0; color: #007AFF; font-size: 16px; font-style: normal; font-weight: 700; line-height: normal; margin: 0px; user-select: none; -moz-user-select: none; -webkit-text-select: none; -webkit-user-select: none;">Máy chủ tự động</p>
        ...
        if (targetDiv) {
            ...
            if (targetDiv && targetDivLast) {
                ...
                otherTargetDiv.addEventListener('click', () => {
                    notificationCall("Đang xây dựng", "Máy chủ tự động đang được xây dựng và hiện không có sẵn. Chúng tôi sẽ cho bạn biết khi nào bạn có thể sử dụng nó.");
                });
...
function DuolingoProCounterOneFunction() {
    ...
    if (window.location.pathname.includes('/lesson') && wasAutoSolverBoxRepeatStartButtonPressed) {
        if (!injectedDuolingoProCounterOneElement) {
            ...
            if (DuolingoProSettingsNeverEndMode) {
                DuolingoProShadeStatusOne.textContent = '♾️';
...
<div class="DPIPUShadowThing">
    <div class="DPIPUB1">
        <div class="DPIPUL1">
            <h2 class="DPIPUL1T1">Sự cố đang hoạt động</h2>
            <p class="DPIPUL1T2" id="DPIPUL1T2DATE">Dang truyền tải...</p>
        </div>
        <div class="DPIPUL2">

        </div>
        <div class="DPIPUL3" style="display: flex; justify-content: center; align-items: flex-start; gap: 8px; align-self: stretch;">
            <div class="DPIPUL3B1">XEM CÁCH SỬA CHỮA</div>
            <div class="DPIPUL3B1" id="DPIPUL3BDissmissID">ĐƯỢC RỒI</div>
        </div>
    </div>
</div>
`;
...
`;
            ...
            async function updateWarningsFromURL(url, currentVersion) {
                try {
                    ...
                    alert(`Lỗi tìm nạp hoặc phân tích cú pháp dữ liệu: ${error.message}`);
                }
            }
...
function solving() {
    ...
    updateSolveButtonText(isAutoMode ? "ĐANG LÀM" : "LÀM TẤT CẢ");
