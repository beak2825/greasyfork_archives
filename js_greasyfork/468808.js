// ==UserScript==
// @name        Github Repository Tab Creator
// @namespace   Violentmonkey Scripts
// @match       *://github.com/*/*
// @grant       none
// @version     1.0.1
// @author      Der_Floh
// @description Template Script to Create your own Repository Tab
// @license     MIT
// @icon        https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png
// @homepageURL https://greasyfork.org/de/scripts/468808-github-repository-tab-creator
// @supportURL  https://greasyfork.org/de/scripts/468808-github-repository-tab-creator/feedback
// @downloadURL https://update.greasyfork.org/scripts/468808/Github%20Repository%20Tab%20Creator.user.js
// @updateURL https://update.greasyfork.org/scripts/468808/Github%20Repository%20Tab%20Creator.meta.js
// ==/UserScript==
...
const name1 = "EXAMPLE-NAME"; // <-- Name for the tab (has to be something)
const icon1 = "https://somewebsite/EXAMPLE-ICON.png"; // <-- icon to use for the tab (possible: image link, svg string, html element, empty for no icon)
createTabElem(name1, icon1, (event) => {
...
createTabElem(name2, icon2, (event) => {
  const currentLocation = window.location.toString();
