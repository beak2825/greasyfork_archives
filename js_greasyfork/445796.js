...
// @version      1.0.1
// @description  PDD推广工具依赖
// @author       lkpbooder
// @grant        none
// @include      https://yingxiao.pinduoduo.com/marketing/main/create/ocpx*
// @include      https://yingxiao.pinduoduo.com/marketing/main/create/new*
// @downloadURL https://update.greasyfork.org/scripts/445796/PDD%E5%95%86%E5%93%81%E6%8E%A8%E5%B9%BF%E4%BE%9D%E8%B5%96.user.js
// @updateURL https://update.greasyfork.org/scripts/445796/PDD%E5%95%86%E5%93%81%E6%8E%A8%E5%B9%BF%E4%BE%9D%E8%B5%96.meta.js
// ==/UserScript==
...
ah.proxy({
  ...
  onResponse: (response, handler) => {
    if(response.config.url.search("/goodsPromotion/cpc/unit/batchQueryBidLimit")>-1){
      let data= JSON.parse(response.response)
      let bidLimit=[]
      data.result.forEach(item=>{
        bidLimit.push(item.minValue/1000)
      })
      localStorage.setItem("bidLimit",JSON.stringify(bidLimit))
    }
