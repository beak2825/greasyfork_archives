// ==UserScript==
// @name         Duolingo Auto Solver & Queue
// @namespace    discord @stocktown
// @match        https://*.duolingo.com/*
// @grant        none
// @version      1.0
// @author       DEARLY
// @description  Duolingo Auto Solver with automatic "Listening" lesson starter [2024]
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/487328/Duolingo%20Auto%20Solver%20%20Queue.user.js
// @updateURL https://update.greasyfork.org/scripts/487328/Duolingo%20Auto%20Solver%20%20Queue.meta.js
// ==/UserScript==
...
function startListeningLesson() {
    const listeningButton = document.querySelector('button.V59Mk._1tbaI span._1fHYG');
    if (listeningButton && listeningButton.textContent.includes('Escuta')) {
