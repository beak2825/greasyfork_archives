// ==UserScript==
// @name              百度文库下载器-支持百度文库、淘豆网、豆丁网、道客巴巴、原创力文档
// @version           2.0.2
// @namespace         http://bdwk.gg999.top
// @description       百度文库、淘豆网、豆丁网、道客巴巴、原创力文档解析下载功能 【保持原格式】界面简洁，脚本仅限学习.
// @author            waahah
// @antifeature       membership  淘豆网及豆丁网和道客巴巴等可直接导出PDF
// @requi
...
// @downloadURL https://update.greasyfork.org/scripts/481288/%E7%99%BE%E5%BA%A6%E6%96%87%E5%BA%93%E4%B8%8B%E8%BD%BD%E5%99%A8-%E6%94%AF%E6%8C%81%E7%99%BE%E5%BA%A6%E6%96%87%E5%BA%93%E3%80%81%E6%B7%98%E8%B1%86%E7%BD%91%E3%80%81%E8%B1%86%E4%B8%81%E7%BD%91%E3%80%81%E9%81%93%E5%AE%A2%E5%B7%B4%E5%B7%B4%E3%80%81%E5%8E%9F%E5%88%9B%E5%8A%9B%E6%96%87%E6%A1%A3.user.js
// @updateURL https://update.greasyfork.org/scripts/481288/%E7%99%BE%E5%BA%A6%E6%96%87%E5%BA%93%E4%B8%8B%E8%BD%BD%E5%99%A8-%E6%94%AF%E6%8C%81%E7%99%BE%E5%BA%A6%E6%96%87%E5%BA%93%E3%80%81%E6%B7%98%E8%B1%86%E7%BD%91%E3%80%81%E8%B1%86%E4%B8%81%E7%BD%91%E3%80%81%E9%81%93%E5%AE%A2%E5%B7%B4%E5%B7%B4%E3%80%81%E5%8E%9F%E5%88%9B%E5%8A%9B%E6%96%87%E6%A1%A3.meta.js
// ==/UserScript==
...
(function () {
    ...
    */
    ...
    $(function () {
        ...
        const InterfaceList = [
            { "host": "wkdownload", "url": "http://wen.gg999.top/?url=" },
        ...
        css(`#zuihuitao {cursor:pointer; position:fixed; top:100px; left:0px; width:0px; z-index:2147483647; font-size:12px; text-align:left;}
			#zuihuitao .logo { position: absolute;right: 0; width: 1.375rem;padding: 10px 2px;text-align: center;color: #fff;cursor: auto;border-radius: 0 4px 4px 0;transform: translate3d(100%, 5%, 0);background: deepskyblue;}
			#zuihuitao .die { position:absolute; left:28px; top:0; text-align:center;background-color:#54be99; border:1px solid gray;}
        ...
        const html = $(`<div id='zuihuitao'>
		            <div class='die' style="border-radius: 10px;">
		                <div style='display:flex;'>
		                    <div style='width:128px; padding:0px 0;'>
		                    <br>
		                        <div style='font-size:16px; text-align:center; color:#fff; line-height:21px;'>某度文库下载</div>
		                        <ul style='margin:0 24px;'>
		                            <li id="li0">下载</li>
		                            <div style='clear:both;'></div>
		                        </ul>
		                        <br>
		                        <div style='font-size:16px; text-align:center; color:#fff; line-height:21px;'>其它文库下载</div>
		                        <ul style='margin:0 25px;'>
		                            <li id="li2">导出文档为PDF</li>
                                    <li id="li3">自动展开此文档</li>
		                            <div style='clear:both;'></div>
		                        </ul>
		                        <br>
							</div>`);
        ...
        $("#li0").bind("click", e => {
            if (host == InterfaceList[1].host) {
                ...
                e.preventDefault();
                alert('此为百度文库解析，其它文库请使用导出PDF');
            }
        });
        $("#li2").bind("click", () => {
            if (confirm('请确保每一页都加载完再下载，是否下载？')) {
                main();
            }
        });
        $("#li3").on("click", () => {
