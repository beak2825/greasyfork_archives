// ==UserScript==
// @name               CopyTrade OptionYard - Client
// @author              Sykes
// @namespace          Optionyard
// @description          CopyTrade
// @include         https://www.optionyard.com/traderoom/
// @version      1.2
// @downloadURL https://update.greasyfork.org/scripts/4331/CopyTrade%20OptionYard%20-%20Client.user.js
// @updateURL https://update.greasyfork.org/scripts/4331/CopyTrade%20OptionYard%20-%20Client.meta.js
// ==/UserScript==
...
var peer = new Peer('copytradeclientOY1',{key: 'enotiqsoyx4dkj4i'});
var ws = new WebSocket('ws://localhost:8100');
var noclient = window.setInterval(function(){Reload()}, 50000);

peer.on('open', function(id) {
  console.log('CopyTradeID: ' + id);
 document.onreadystatechange = function () {
     if (document.readyState == "complete") {
     ws.send('#OptionYard loaded!')
   }
 }
});
...
console.log('Master disconntect');
noclient = window.setInterval(function(){Reload()}, 50000);
} 
...
function Reload(){
location.reload();
console.log('Master not connected. Reload page.')
} 