// ==UserScript==
// @name         S1 Markdown It
// @namespace    https://github.com/rkanuj/s1-markdown-it
// @version      0.1.0
// @author       rkanuj
// @description  求你们不要再复制 AI 的 Markdown 格式文本了！
// @license      MIT
// @icon         https://bbs.saraba1st.com/favicon.ico
// @match        https://*.saraba1st.com/2b/thread-*
// @match        https://*.saraba1st.com/2b/forum.php?*tid=*
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/525389/S1%20Markdown%20It.user.js
// @updateURL https://update.greasyfork.org/scripts/525389/S1%20Markdown%20It.meta.js
// ==/UserScript==

(t=>{if(typeof GM_addStyle=="function"){GM_addStyle(t);return}const n=document.createElement("style");n.textContent=t,document.head.append(n)})(" .s1-markdown-it>*:first-child{margin-top:0;padding-top:0}.s1-markdown-it p,.s1-markdown-it blockquote,.s1-markdown-it table,.s1-markdown-it pre{margin:1em 0}.s1-markdown-it h1,.s1-markdown-it h2,.s1-markdown-it h3,.s1-markdown-it h4,.s1-markdown-it h5,.s1-markdown-it h6{margin:20px 0 10px;padding:0}.s1-markdown-it h1 p,.s1-markdown-it h2 p,.s1-markdown-it h3 p,.s1-markdown-it h4 p,.s1-markdown-it h5 p,.s1-markdown-it h6 p{margin-top:0}.s1-markdown-it ul,.s1-markdown-it ol{margin-left:0}.s1-markdown-it ul li,.s1-markdown-it ol li{margin-left:2em} ");
  ...
  class EntityDecoder {
    ...
    emitNumericEntity(lastCp, expectedLength) {
      ...
      if (this.consumed <= expectedLength) {
        (_a2 = this.errors) === null || _a2 === undefined ? undefined : _a2.absenceOfDigitsInNumericCharacterReference(this.consumed);
        return 0;
      }
    ...
    emitNotTerminatedNamedEntity() {
      ...
      (_a2 = this.errors) === null || _a2 === undefined ? undefined : _a2.missingSemicolonAfterCharacterReference();
      return this.consumed;
    }
    /**
     * Emit a named entity.
...
`;
  ...
  document.querySelectorAll('td[id^="postmessage_"]').forEach((el) => {
    if (el.innerHTML.match(/\n#{2,6} ./)) {
      const html = el.innerHTML.replace(/<br>/g, "");
      el.innerHTML = md.render(html);
      el.classList.add("s1-markdown-it");
    }
  });
