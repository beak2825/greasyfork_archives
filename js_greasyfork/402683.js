// ==UserScript==
// @name         CANAL VERMELHO WEST
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Ajudar os piazoes da craudete a anexar os docs.
...
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/402683/CANAL%20VERMELHO%20WEST.user.js
// @updateURL https://update.greasyfork.org/scripts/402683/CANAL%20VERMELHO%20WEST.meta.js
// ==/UserScript==
...
(function() {
    ...
    var mapa_f = function(){
        ...
        setTimeout(function (){document.querySelector("#formPrincipal\\:pickListOrgaos > div:nth-child(1) > ul > li:nth-child(2)").click()},1*tempo)
        ...
        setTimeout(function (){document.querySelector("#formPrincipal\\:pickListOrgaos > div:nth-child(1) > ul > li:nth-child(2)").click()},5*tempo)
        ...
        setTimeout(function (){document.querySelector("#formPrincipal\\:tbPlvChv\\:0\\:plvConteudo").value ="Bill of Lading"},9*tempo)
        setTimeout(function (){document.querySelector("#formPrincipal\\:pickListOrgaos > div:nth-child(1) > ul > li:nth-child(2)").click()},9*tempo)
