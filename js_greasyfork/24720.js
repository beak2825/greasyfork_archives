// ==UserScript==
// @name            Hardliner Feindinfo Tool ^^
// @version         17.06.06
// @description     Show Offense and Defense Level of Enemies & Friends.
// @namespace       https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @include         https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @author          MarcBender2010
// @downloadURL https://update.greasyfork.org/scripts/24720/Hardliner%20Feindinfo%20Tool%20%5E%5E.user.js
// @updateURL https://update.greasyfork.org/scripts/24720/Hardliner%20Feindinfo%20Tool%20%5E%5E.meta.js
// ==/UserScript==
(function () {
    ...
    function createTweak() {
      ...
      webfrontend.gui.region.RegionCityStatusInfoEnemy.prototype.onCitiesChange = function () {
        ...
        if (!widget.hasOwnProperty("offLevel")) {
          ...
          offWidget.setTextColor("yellow");
          offWidget.setThemedFont("bold");
          offWidget.add(new qx.ui.basic.Label("   Base Offensive :"), {
            row : 0,
            column : 0
          });
          ...
          offWidget.add(new qx.ui.basic.Label(" Defensive :"), {
            row : 0,
            column : 2
          });
          widget.defLevel = new qx.ui.basic.Label("Test");
