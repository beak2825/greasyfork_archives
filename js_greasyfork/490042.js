...
// @version      1.1.6
// @description  Только для главных кураторов форума
// @author       Thomas_Allen
...
// @downloadURL https://update.greasyfork.org/scripts/490042/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/490042/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%9A%D0%A4.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
      ...
      },
    {
      ...
      content:
        ...
        "[/LIST]<br><br>" +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(135, 206, 250)][FONT=times new roman][SIZE=4]VLADIKAVKAZ[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
         "[COLOR=rgb(51, 204, 51)][FONT=times new roman][SIZE=4][I]Одобрено.[/I][/SIZE][/FONT][/COLOR]<br><br>"+
    ...
    title: 'Неполн.сделка',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Данных доказательств недостаточно для корректного рассмотрения жалобы.[/I][/SIZE][/FONT]<br><br>" +
        "[I][FONT=times new roman][SIZE=4]На ваших доказательствах неполное условие сделки. [/SIZE][/FONT][/I][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
    ...
    },
    {
      title: 'OOC оск',
      content:
        '[COLOR=rgb(0, 0, 139)][FONT=times new roman][SIZE=4][I]{{ greeting }},  {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(169, 169, 169)][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту  правил сервера:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        ...
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(135, 206, 250)][FONT=times new roman][SIZE=4]VLADIKAVKAZ[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
      "[COLOR=rgb(51, 204, 51)][FONT=times new roman][SIZE=4][I]Одобрено.[/I][/SIZE][/FONT][/COLOR]<br><br>"+
     "[url=https://postimages.org/][img]https://i.postimg.cc/P5H80x1Q/rHMfMqI.gif[/img][/url]",
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
      title: 'Упом род',
      content:
        '[COLOR=rgb(75, 0, 130)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту  правил сервера:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        ...
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(135, 206, 250)][FONT=times new roman][SIZE=4]VLADIKAVKAZ[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        "[COLOR=rgb(51, 204, 51)][FONT=times new roman][SIZE=4][I]Одобрено.[/I][/SIZE][/FONT][/COLOR]<br><br>"+
     "[url=https://postimg.cc/LnRqKy7V][img]https://i.postimg.cc/SNYc93fH/kX40ePs.png[/img][/url]",
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
...
title: 'не на русском в чате',
    ...
    },
    {
     ...
     {
	  title: '_____________________________________________ღ прочее ღ_____________________________________________ ',
     },
    {
      ...
      content:
        ...
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: PIN_PREFIX,
      status: true,
     },
     {
     ...
     },
    {
      ...
      content:
        ...
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        "[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]<br><br>"+
    ...
    },
    {
     ...
     content:
        ...
        "[FONT=times new roman][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
         "[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]<br><br>"+
        "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        ...
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
         "[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]<br><br>"+
        "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
     prefix: UNACCEPT_PREFIX,
      status: false,
...
title: 'нонрп обман донат/не донат(отказ)',
     ...
     },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография получает статус:[I] [/I][/COLOR][I][COLOR=rgb(0,255,127)]Одобрено. [/COLOR][/I][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(95, 158, 160)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>"+
    "[url=https://postimages.org/][img]https://i.postimg.cc/T3cg5HBn/di-9TOO.gif[/img][/url]",
        prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана.[/COLOR]<br><br>" +
   ...
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к она составлена не по форме. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы ее не дополнили. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к она оформлена неграмотно. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
       prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к она написана от 3-его лица. [/COLOR]<br><br>" +
         "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к она уже была одобрена. [/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы приписали суперспособности своему персонажу. [/COLOR]<br><br>" +
  "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
       "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
     prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
       '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы ее скопировали у другого человека. [/COLOR]<br><br>" +
         "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к у вас NonRP NickName. [/COLOR]<br><br>" +
         "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к ваш NickName должен быть написан на русском языке. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255,0,0)]отказана [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к дата рождения не совпадает с возрастом. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
       "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к ваша семья расписана не полностью. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255,0,0)]отказана [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к ваша дата рождения расписана не полностью. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
      prefix: PIN_PREFIX,
      status: true,
      },
         {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)] Минимальный возраст для создания биографий - 18 лет. [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)] В вашей биографии недостаточно информации, добавьте больше информации о себе в новой теме. [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
      status: false,
	...
	},
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация [I] [/I][/COLOR][I][COLOR=rgb(0,255,127)]одобрена.[/COLOR][/I][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
     "[url=https://postimages.org/][img]https://i.postimg.cc/T3cg5HBn/di-9TOO.gif[/img][/url]",
        prefix: ACCEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы не туда попали. [/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к она составлена не по форме. [/COLOR]<br><br>"+
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
     prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана. [/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
     prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к ваш все никнеймы должны быть написаны на русском языке. [/COLOR]<br><br>" +
   ...
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организаций [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к она оформлена неграмотно. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
       prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы ее скопировали у другого человека. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы ее не дополнили. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
	...
	},
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация получает статус: [I] [/I][/COLOR][I][COLOR=rgb(0,255,127)]Одобрено. [/COLOR][/I][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
     "[url=https://postimages.org/][img]https://i.postimg.cc/T3cg5HBn/di-9TOO.gif[/img][/url]",
        prefix: ACCEPT_PREFIX,
      status: false,
...
title : 'не туда'  ,
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы не туда попали. [/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
      status: false,
  ...
  title : 'не по форме'  ,
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к она составлена не по форме. [/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана. [/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
     prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к ваш все никнеймы должны быть написаны на русском языке. [/COLOR]<br><br>" +
   ...
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к она оформлена неграмотно. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
       prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы ее скопировали у другого человека. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к вы ее не дополнили. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]отказана  [I] [/I][/COLOR][I][COLOR=rgb(209, 213, 216)]т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [I] [/I][/COLOR][I][COLOR=rgb(255, 0, 0)]BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(135, 206, 250)]VLADIKAVKAZ[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>"+
   "[url=https://postimg.cc/jWQNkG1V][img]https://i.postimg.cc/FKwZ1vgK/8082.jpg[/img][/url]",
      prefix: UNACCEPT_PREFIX,
