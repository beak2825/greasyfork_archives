...
// @match        *://www.twitch.tv/*
// @match        *://jackbox.fun/*
// @downloadURL https://update.greasyfork.org/scripts/465152/Auto%20Join%20Jackbox.user.js
// @updateURL https://update.greasyfork.org/scripts/465152/Auto%20Join%20Jackbox.meta.js
// ==/UserScript==
...
(function() {
    ...
    const TwitchMessagesObserver = class {
        ...
        checkMessage(message) {
            ...
            if (LOG.ENBALED) {
                console.log(LOG.PREFIX, LOG.STYLE, `Сообщение от ${username}: ${text}`);
            }
        ...
        checkCode(text) {
            ...
            if (LOG.ENBALED) {
                console.log(LOG.PREFIX, LOG.STYLE, `Код: ${code}. (${text})`);
            }
