...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/473773/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%7C%20GOLD.user.js
// @updateURL https://update.greasyfork.org/scripts/473773/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%7C%20GOLD.meta.js
// ==/UserScript==
...
},
{
 ...
 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил: [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]3.21.[/color] Запрещается реклама промокодов в игре, а также их упоминание в любом виде во всех чатах [Color=#ff0000]| Ban 30 дней[/color].[/COLOR]<br><br>"+
 ...
 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
        ...
        },
  {
	  ...
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender]Данный игрок получит наказание. [/SIZE][/FONT] <br><br>"+
    ...
    },
{
	  ...
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#CCFF66]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/SIZE][/FONT][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=RED]Главному куратору форума[/COLOR], пожалуйста, ожидайте ответа и не создавайте копии данной темы. В противном случае Вы можете получить блокировку форумного аккаунта. [/SIZE][/FONT]<br><br>"+
...
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#f4d7e1] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил: [/SIZE][/FONT]<br><br>"+
...
},
{
	  ...
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[I][B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
    ...
    },
{
	...
	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		...
		"[I][B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender]Обратитесь в раздел жалоб на сотрудников той или иной оргнизации.[/SIZE][/FONT] <br><br>"+
                 "[B][CENTER][COLOR=RED][ICODE]Закрыто[/ICODE][/COLOR]<br><br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: CLOSE_PREFIX,
	  status: false,
...
},
{
	  ...
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для Министерства Обороны: [/SIZE][/FONT] <br><br>"+
...
},
{
	  ...
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для СМИ: [/SIZE][/FONT] <br><br>"+
...
},
{
	  ...
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для УМВД: [/SIZE][/FONT] <br><br>"+
...
},
{
	  ...
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для ФСБ: [/SIZE][/FONT] <br><br>"+
...
},
{
	  ...
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для ФСИН: [/SIZE][/FONT] <br><br>"+
	  ...
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		...
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для силовых структур: [/SIZE][/FONT] <br><br>"+
                ...
                "[*][FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]поведение, не соответствующее сотруднику силовых структур.[/COLOR][/SIZE][/FONT]<br>" +
...
},
{
	  ...
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан за нарушение общих правил криминальных организаций. [/SIZE][/FONT] <br><br>"+
...
},
{
	  ...
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан за нарушение правил ограблений и похищений. [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][Spoiler][/COLOR][COLOR=rgb(209, 213, 216)] Jail (от 10 до 60 минут) / Warn / Ban[/COLOR]<br>"+
"[*][FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]само наказание и его длительность выдаются на усмотрение администратора, размер выдаваемого наказания зависит от степени нарушения со стороны игрока. Строгий или устный выговор лидеру фракции может выдать только главный следящий за бандами или непосредственно его заместитель.[/COLOR][/SIZE][/FONT][/Spoiler][/CENTER][/B]<br><br>"+
                "[B][CENTER][COLOR=GREEN][ICODE]Одобрено, закрыто[/ICODE][/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
...
},
{
	  ...
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как администрация сервера не несёт ответственности за утраченные Вами средства при обмане и т.д. Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленными в данном разделе. [/SIZE][/FONT]<br><br>"+
                "[B][CENTER][COLOR=RED][ICODE]Отказано, закрыто[/ICODE][/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
  ...
  {
                	  title: '| Био отказ (место рождения не совпадает с указанным в био) |',
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-биография получает статус - [COLOR=RED]Отказано[/COLOR], так как место рождения не совпадает с тем, которое указано в биографии (из пункта «Дата и место рождения«). Убедительная просьба ознакомиться с правилами подачи RolePlay-биографий, закрепленными в данном разделе. [/SIZE][/FONT] <br><br>"+
       "[B][CENTER][COLOR=RED][ICODE]❖ Отказано ❖[/ICODE][/COLOR]<br><br>"+
	"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
  ...
  {
                	  title: '| Био отказ (не имеет смысла) |',
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-биография получает статус - [COLOR=RED]Отказано[/COLOR], так как она не имеет смысловой части. Каждый пункт в биографии должен быть раскрыт четко, не углубляясь в подробности. Не стоит расписывать в биографии каждый день персонажа, достаточно будет самого основного, что произошло в этот период (Детство / Юность и взрослая жизнь / Настоящее время). Убедительная просьба ознакомиться с правилами подачи RolePlay-биографий, закрепленными в данном разделе. [/SIZE][/FONT]   <br><br>"+
       "[B][CENTER][COLOR=RED][ICODE]❖ Отказано ❖[/ICODE][/COLOR]<br><br>"+
	"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
  ...
  {
                	  title: '| Био отказ (пол указан неправильно) |',
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-биография получает статус - [COLOR=RED]Отказано[/COLOR], так как пол Вашего персонажа указан неправильно. Убедительная просьба ознакомиться с правилами подачи RolePlay-биографий, закрепленными в данном разделе. [/SIZE][/FONT]   <br><br>"+
       "[B][CENTER][COLOR=RED][ICODE]❖ Отказано ❖[/ICODE][/COLOR]<br><br>"+
	"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
  ...
  {
                	  title: '| Био на доработке (заголовок не по форме) |',
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-биография получает статус [COLOR=YELLOW]«На доработке»[/COLOR]. Оформите правильно заголовок Вашей биографии. Вам дается 24 часа на добавление/исправление данных в биографии (после добавления/исправления данных обязательно отписать в данной теме). Если биография не будет доработана, то она автоматически получит статус «отказано» [/SIZE][/FONT]  <br><br>"+
       "[B][CENTER][COLOR=YELLOW][ICODE]❖ На доработке ❖[/ICODE][/COLOR]<br><br>"+
	"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: NARASSMOTRENIIBIO_PREFIX,
	  status: false,
  ...
  {
                	  title: '| Био на доработке (имя не на русском) |',
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-биография получает статус [COLOR=YELLOW]«На доработке»[/COLOR]. Напишите Ваше имя и фамилию на русском языке как пункте *Имя и фамилия*, так и в заголовке биографии. Вам дается 24 часа на добавление/исправление данных в биографии (после добавления/исправления данных обязательно отписать в данной теме). Если биография не будет доработана, то она автоматически получит статус «отказано» [/SIZE][/FONT]  <br><br>"+
       "[B][CENTER][COLOR=YELLOW][ICODE]❖ На доработке ❖[/ICODE][/COLOR]<br><br>"+
	"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: NARASSMOTRENIIBIO_PREFIX,
	  status: false,
  ...
  {
                	  title: '| Био на доработке (отсутствует 1 пункт био) |',
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-биография получает статус [COLOR=YELLOW]«На доработке»[/COLOR]. Допишите отсутствующий пункт в биографии, опираясь на правила ее создания и оформления. Вам дается 24 часа на добавление/исправление данных в биографии (после добавления/исправления данных обязательно отписать в данной теме). Если биография не будет доработана, то она автоматически получит статус «отказано» [/SIZE][/FONT]  <br><br>"+
       "[B][CENTER][COLOR=YELLOW][ICODE]❖ На доработке ❖[/ICODE][/COLOR]<br><br>"+
	"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: NARASSMOTRENIIBIO_PREFIX,
	  status: false,
  ...
  {
                	  title: '| Био на доработке (возраст ниже 18 лет) |',
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-биография получает статус [COLOR=YELLOW]«На доработке»[/COLOR]. Минимальный возраст для написания RP-биографии - 18 лет, исправьте Ваш возраст. Вам дается 24 часа на добавление/исправление данных в биографии (после добавления/исправления данных обязательно отписать в данной теме). Если биография не будет доработана, то она автоматически получит статус «отказано» [/SIZE][/FONT]  <br><br>"+
       "[B][CENTER][COLOR=YELLOW][ICODE]❖ На доработке ❖[/ICODE][/COLOR]<br><br>"+
	"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: NARASSMOTRENIIBIO_PREFIX,
	  status: false,
...
"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
  ...
  {
                	  title: '| RP ситуация отказ (ошибки) |',
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-ситуация получает статус - [COLOR=#FF0000]Отказано[/COLOR], так как в ней допущено большое количество орфографических/пунктуационных ошибок. Убедительная просьба ознакомиться с правилами подачи RolePlay-ситуаций, закрепленными в данном разделе. [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][COLOR=RED][ICODE]❖ Отказано ❖[/ICODE][/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
  ...
  {
                	  title: '| RP ситуация отказ (скопирована) |',
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-ситуация получает статус - [COLOR=#FF0000]Отказано[/COLOR], так как она скопирована. Убедительная просьба ознакомиться с правилами подачи RolePlay-ситуаций, закрепленными в данном разделе. [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][COLOR=RED][ICODE]❖ Отказано ❖[/ICODE][/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
  ...
  {
                	  title: '| RP ситуация отказ (не по форме) |',
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-ситуация получает статус - [COLOR=#FF0000]Отказано[/COLOR], так как она составлена не по форме. Убедительная просьба ознакомиться с правилами подачи RolePlay-ситуаций, закрепленными в данном разделе. [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][COLOR=RED][ICODE]❖ Отказано ❖[/ICODE][/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
  ...
  {
                	  title: '| RP ситуация отказ (неправильная отыгровка RP) |',
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-ситуация получает статус - [COLOR=#FF0000]Отказано[/COLOR], так как Вы неправильно отыграли RP с помощью /do и /me. Убедительная просьба ознакомиться с правилами подачи RolePlay-ситуаций, закрепленными в данном разделе. [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][COLOR=RED][ICODE]❖ Отказано ❖[/ICODE][/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
  ...
  {
                	  title: '| RP ситуация отказ (оформление) |',
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#CCFF66][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-ситуация получает статус - [COLOR=#FF0000]Отказано[/COLOR], так как она должна быть оформлена грамотно и красиво. Убедительная просьба ознакомиться с правилами подачи RolePlay-ситуаций, закрепленными в данном разделе. [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][COLOR=RED][ICODE]❖ Отказано ❖[/ICODE][/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/xdvhzWPj/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
