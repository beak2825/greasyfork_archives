...
// @grant           GM_setValue
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/377232/Youtube%20by%20Jacqueb.user.js
// @updateURL https://update.greasyfork.org/scripts/377232/Youtube%20by%20Jacqueb.meta.js
// ==/UserScript==

function lol() {
    if(document.getElementById("logo") != null) {
        document.getElementById("logo").innerHTML = "<img src='https://i.lensdump.com/i/AbqY7o.png' width='120px' height='40px'>"
    }
}

setInterval(function() {lol()},100);
(function () {
    "use strict";
    ...
    var iridium = {
        ...
        inject: function (is_user_script) {
            ...
            default_language = {
                ...
                iridium_api: {
                    settings_button: "Jacqueb Settings",
            ...
            iridium_api = {
                ...
                isSettingsPage: window.location.pathname === "/jacqueb-settings",
                ...
                initializeSettings: function (new_settings) {
                    ...
                    if (iridium_settings = document.getElementById("jacqueb-settings")) {
                ...
                initializeSettingsButton: function () {
                    ...
                    if (buttons && !(iridium_settings_button = document.getElementById("iridium_settings_button"))) {
                        ...
                        iridium_settings_button.innerHTML =
                            "<a id='iridium_settings_button' href='/jacqueb-settings' target='jacqueb-settings'>" +
        ...
        ini: function () {
            ...
            if (this.isAllowedPage()) {
                ...
                this.is_settings_page = window.location.pathname === "/jacqueb-settings";
