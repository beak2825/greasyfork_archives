// ==UserScript==
// @name    Forum Curators Chilli 
// @name:ru Кураторы Форума  Chilli 
// @name:uk Куратори форуму  Chilli 
// @namespace    https://forum.blackrussia.online
// @version      3.1.1
// @description   Version 3.1.1 bagofix
// @description:ru   Version 3.1.1 bagofix
// @description:uk | Version 3.1.1 bagodiz
...
// @downloadURL https://update.greasyfork.org/scripts/451469/Forum%20Curators%20Chilli.user.js
// @updateURL https://update.greasyfork.org/scripts/451469/Forum%20Curators%20Chilli.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
		...
		'[Color=Green][CENTER]Одобрено, закрыто.<br> ' +
    ...
    },
    {
      ...
      content:
		...
		'[Color=Green][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
        "[CENTER] Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][/FONT]",
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
    ...
    },
     {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Игрок будет наказан по пункту правил:[/FONT][/B][FONT=georgia][I][B]2.37. Запрещены OOC угрозы, в том числе и завуалированные | Mute 120 минут / Ban 7 дней[/B][/I][/FONT][B][I][FONT=georgia]Одобрено, закрыто[/I][/B][/CENTER]<br>" +
        "[CENTER][I][B][FONT=georgia]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][/FONT][/B]",
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		...
		'[Color=Green][CENTER]Одобрено, закрыто.[/CENTER]<br>' +
		"[CENTER] Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][/FONT]",
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Игрок будет наказан по пункту правил:[/FONT][/I][/B][FONT=georgia][I][B]3.09. Запрещены любые угрозы о наказании игрока со стороны администрации | Mute 30 минут [/B][/I][/FONT][B][I][FONT=georgia]Одобрено, закрыто[/I][/B][/CENTER] <br>" +
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из [URL='https://forum.blackrussia.online/index.php?threads/Правила-написания-rp-биографии-chilli.1302958/']Правила написания RP биографии | CHILLI[/URL].[/CENTER][/FONT]",
