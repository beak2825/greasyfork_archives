...
// @version      0.1
// @description  Script that allows you to skip entering code for auth
// @author       ls
// @match        https://otp.zone3000.net/otp/auth
// @icon         data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==
// @grant        window.close
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/477768/Auto-auth%20z3.user.js
// @updateURL https://update.greasyfork.org/scripts/477768/Auto-auth%20z3.meta.js
// ==/UserScript==


// INSTRUCTION: Define Own OTP CODE here:
const myOtpCode = '';
    ...
    function getAuthCode(otpCode){
        ...
        (function () {
            ...
            e = class {
                constructor(r = 30, e = 6) {
                    if (this.expiry = r, this.length = e, this.length > 8 || this.length < 6) {
                        throw 'Error: invalid code length';
                    }
                }

                dec2hex(r) {
                    return (r < 15.5 ? '0' : '') + Math.round(r)
                        .toString(16);
                }
                ...
                base32tohex(r) {
                    var e,
                        ...
                        o,
                        h;
                    for ('ABCDEFGHIJKLMNOPQRSTUVWXYZ234567', e = '', t = '', o = 0; o < r.length;) {
                        h = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567'.indexOf(r.charAt(o)
                            .toUpperCase()), e += this.leftpad(h.toString(2), 5, '0'), o++;
                    }
                    for (o = 0; o + 4 <= e.length;) {
                        n = e.substr(o, 4), t += parseInt(n, 2)
                            .toString(16), o += 4;
                    }
                    return t;
                }
                ...
                leftpad(r, e, n) {
                    return e + 1 >= r.length && (r = Array(e + 1 - r.length)
                        .join(n) + r), r;
                }
                ...
                getOtp(r, e = (new Date).getTime()) {
                    var n,
                        ...
                        w,
                        d;
                    if (o = this.base32tohex(r), n = Math.round(e / 1e3), d = this.leftpad(this.dec2hex(Math.floor(n / this.expiry)), 16, '0'), (w = new jsSHA('SHA-1', 'HEX')).setHMACKey(o, 'HEX'), w.update(d), 'KEY MUST BE IN BYTE INCREMENTS' === (t = w.getHMAC('HEX'))) {
        ...
        !function (r) {
            ...
            function t(r, e, n) {
                ...
                for (d = e || [0], h = (n = n || 0) >>> 3, o = 0; o < r.length; o += 1) {
                    t = r.charCodeAt(o), i = (w = o + h) >>> 2, d.length <= i && d.push(0), d[i] |= t << 8 * (3 - w % 4);
                }
                return {
                    value: d,
                    binLen: 8 * r.length + n,
            ...
            function o(r, e, n) {
                var t,
                    ...
                    l = [],
                    s = 0;
                if (l = e || [0], d = (n = n || 0) >>> 3, -1 === r.search(/^[a-zA-Z0-9=+\/]+$/)) {
                    throw new Error('Invalid character in base-64 string');
                }
                if (w = r.indexOf('='), r = r.replace(/\=/g, ''), -1 !== w && w < r.length) {
                    throw new Error('Invalid %27=%27 found in base-64 string');
                }
                for (t = 0; t < r.length; t += 4) {
                    for (i = r.substr(t, 4), h = 0, o = 0; o < i.length; o += 1) {
                        h |= 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.indexOf(i[o]) << 18 - 6 * o;
                    }
                    for (o = 0; o < i.length - 1; o += 1) {
                        for (u = (a = s + d) >>> 2; l.length <= u;) {
                            l.push(0);
                        }
            ...
            function h(r, e) {
                var n,
                    ...
                    h = 4 * r.length;
                for (n = 0; n < h; n += 1) {
                    t = r[n >>> 2] >>> 8 * (3 - n % 4), o += '0123456789abcdef'.charAt(t >>> 4 & 15) + '0123456789abcdef'.charAt(15 & t);
                }
            ...
            function i(r, e) {
                var n,
                    ...
                    u = 4 * r.length;
                for (n = 0; n < u; n += 3) {
                    for (h = n + 1 >>> 2, i = r.length <= h ? 0 : r[h], h = n + 2 >>> 2, w = r.length <= h ? 0 : r[h], o = (r[n >>> 2] >>> 8 * (3 - n % 4) & 255) << 16 | (i >>> 8 * (3 - (n + 1) % 4) & 255) << 8 | w >>> 8 * (3 - (n + 2) % 4) & 255, t = 0; t < 4; t += 1) {
                        8 * n + 6 * t <= 32 * r.length ? d += 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.charAt(o >>> 6 * (3 - t) & 63) : d += e.b64Pad;
                    }
                }
                return d;
            }
            ...
            function w(r) {
                var e,
                    ...
                    o = 4 * r.length;
                for (e = 0; e < o; e += 1) {
                    n = r[e >>> 2] >>> 8 * (3 - e % 254) & 255, t += String.fromCharCode(n);
                }
                return t;
            }
            ...
            function d(r) {
                ...
                if (e = r || {}, n.outputUpper = e.outputUpper || !1, n.b64Pad = e.b64Pad || '=', 'boolean' != typeof n.outputUpper) {
                        ...
                        h = function (r, n, t) {
                            return function (r, e, n, t) {
                                ...
                                if (a = n || [0], w = (t = t || 0) >>> 3, 'UTF8' === e) {
                                    ...
                                    for (h = 0; h < r.length; h += 1) {
                                        for (o = r.charCodeAt(h), 'UTF16LE' === e && (o = (i = 255 & o) << 8 | o >>> 8), d = (u = s + w) >>> 2; a.length <= d;) {
                                            a.push(0);
                                        }
                                        a[d] |= o << 8 * (2 - u % 4), s += 2;
                                    }
            ...
            function D(r, e) {
                var n,
                    ...
                    S = C,
                    E = y;
                for (n = e[0], t = e[1], o = e[2], h = e[3], i = e[4], d = 0; d < 80; d += 1) {
                    u[d] = d < 16 ? r[d] : O(u[d - 3] ^ u[d - 8] ^ u[d - 14] ^ u[d - 16], 1), w = d < 20 ? E(O(n, 5), l(t, o, h), i, 1518500249, u[d]) : d < 40 ? E(O(n, 5), s(t, o, h), i, 1859775393, u[d]) : d < 60 ? E(O(n, 5), f(t, o, h), i, 2400959708, u[d]) : E(O(n, 5), s(t, o, h), i, 3395469782, u[d]), i = h, h = o, o = O(t, 30), t = n, n = w;
                }
            ...
            function G(r, e, n, t) {
                var o,
                    h,
                    i;
                for (i = 15 + (e + 65 >>> 9 << 4); r.length <= i;) {
                    r.push(0);
                }
                for (r[e >>> 5] |= 128 << 24 - e % 2532, r[i] = e + n, h = r.length, o = 0; o < h; o += 16) {
            ...
            function _(r, n, t) {
                ...
                if (('SHA-224' === t || 'SHA-256' === t) && 2 & SUPPORTED_ALGS) {
                    O = 64, k = 1, Z = Number, D = C, G = L, _ = y, F = b, I = U, Y = A, N = T, K = p, j = c, V = M;
                } else {
                ...
                for (o = n[0], h = n[1], i = n[2], w = n[3], d = n[4], u = n[5], a = n[6], l = n[7], g = 0; g < O; g += 1) {
                    g < 16 ? (Q = g * k, z = r.length <= Q ? 0 : r[Q], J = r.length <= Q + 1 ? 0 : r[Q + 1], W[g] = new Z(z, J)) : W[g] = G(I(W[g - 2]), W[g - 7], F(W[g - 15]), W[g - 16]), s = _(l, N(d), j(d, u, a), V[g], W[g]), f = D(Y(o), K(o, h, i)), l = a, a = u, u = d, d = D(w, s), w = i, i = h, h = o, o = D(s, f);
                }
            ...
            var F = function (r, e, n) {
                var t,
                    ...
                    b = [],
                    P = !1;
                if (t = (c = n || {}).encoding || 'UTF8', g = c.numRounds || 1, a = u(e, t), g !== parseInt(g, 10) || 1 > g) {
                ...
                if ('SHA-1' === A && 1 & SUPPORTED_ALGS) {
                    ...
                    return function (r, e, n, t, o) {
                        ...
                        for (r[e >>> 5] |= 128 << 24 - e % 2532, r[w] = e + n, i = r.length, h = 0; h < i; h += u) {
                            t = _(r.slice(h, h + u), t, o);
                        }
                        if ('SHA-224' === o && 2 & SUPPORTED_ALGS) {
                            d = [t[0], t[1], t[2], t[3], t[4], t[5], t[6]];
                        } else if ('SHA-256' === o && 2 & SUPPORTED_ALGS) {
                            d = t;
                ...
                o = k(A), this.setHMACKey = function (r, e, n) {
                    ...
                    var e,
                        ...
                        w = 0,
                        d = s >>> 5;
                    for (n = (e = a(r, p, E)).binLen, h = e.value, t = n >>> 5, i = 0; i < t; i += d) {
        ...
        return (new jsOTP.totp()).getOtp(otpCode);
    };
    ...
    waitForKeyElements (
        ...
        () => {
            if(!myOtpCode) {
              alert('DEFINE YOUR OTP CODE IN THE SCRIPT');
              return;
            }
            const authCode = getAuthCode(myOtpCode);

            document.querySelector('#id_OTPkey').value = authCode;
