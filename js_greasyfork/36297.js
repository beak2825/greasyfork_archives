var meta = function () {/*
// ==UserScript==
// @name                WME Route Speeds (MapOMatic fork Puerto Rico experiment)
// @description         Shows segment's speed in a route.
// @include             /^https:\/\/(www|beta)\.waze\.com\/(?!user\/)(.{2,6}\/)?editor\/?.*$/
// @version             2017.12.12.001.PR
// @namespace           https://greasyfork.org/pl/scripts/4393-wme-route-speeds-puerto-rico-experiment
// @grant               none
...
// @downloadURL https://update.greasyfork.org/scripts/36297/WME%20Route%20Speeds%20%28MapOMatic%20fork%20Puerto%20Rico%20experiment%29.user.js
// @updateURL https://update.greasyfork.org/scripts/36297/WME%20Route%20Speeds%20%28MapOMatic%20fork%20Puerto%20Rico%20experiment%29.meta.js
// ==/UserScript==
*/};

/*Version history:
 * 2017.12.12.001.PR
 * experimental version for Cefin, adding PR country code
 * 
...
function getRoutingManager() {
	if (Waze.model.countries.get(235) || Waze.model.countries.get(40) || Waze.model.countries.get(182)) { // US & Canada
