...
// @include      http*://www.o58c.com/*
// @include      http*://*j41g.com/*
// @include      http*://www.e59f.com/*
// @description  Jav小司机。简单轻量速度快！感谢wddd，此脚本为wddd创作，版权属原作者所有，我只是修改了一些不能用的网址和加了免梯子网址自用，如有兴趣者可自行下载。
// @grant        GM_xmlhttpRequest
// @grant        GM_addStyle
// @grant        GM_setValue
// @grant        GM_getValue
// @homepage     https://github.com/wdwind/JavMiniDriver
// @downloadURL https://update.greasyfork.org/scripts/443238/Jav%E5%B0%8F%E5%8F%B8%E6%9C%BA%28%E4%BF%AE%E6%94%B9%29.user.js
// @updateURL https://update.greasyfork.org/scripts/443238/Jav%E5%B0%8F%E5%8F%B8%E6%9C%BA%28%E4%BF%AE%E6%94%B9%29.meta.js
// ==/UserScript==
...
// 1.1.4
/**
 * Add support for j41g.com and e59f.com
 * Block ad
 ...
 * Add support for javlib.com and o58c.com
*/
// 1.1.1
/**
...
class MiniDriver {
    ...
    addTorrentLinks() {
        ...
        let btsow = `https://btsow.rest/search/${this.editionNumber}`;
        let javbus = `https://www.seejav.blog/${this.editionNumber}`;
        ...
        let javdb = `https://javdb39.com/search?q=${this.editionNumber}`;
