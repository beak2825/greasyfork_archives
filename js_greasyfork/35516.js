...
// @downloadURL https://update.greasyfork.org/scripts/35516/JB.user.js
// @updateURL https://update.greasyfork.org/scripts/35516/JB.meta.js
// ==/UserScript==
...
(function() {
    ...
    var JailAutoBustOut = {
         ...
         * Start autoclicking
         */
        start: function(intervalSec, eventCallbacks) {            
            if (this.enabled) return;
            this.enabled = true;
            this.counter = 0;
    ...
    function JailAutoBustOutInjection() {
        ...
        var $inputInterval = $('<input type="text" size="2" value="25">');
        ...
        $btnAutoclick.click(function(e) {
            ...
            if (JailAutoBustOut.enabled) {
                ...
                JailAutoBustOut.start(interval, 
                                      {
