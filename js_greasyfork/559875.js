// ==UserScript==
// @name         YouTube - Non-Rounded Design + Pre-August 2021 styled icons combo
// @version      2025.12.29
// @description  This script will revert both non-rounded UI and icons style before August 2021 changes.
// @author       Magma_Craft
// @license MIT
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/559875/YouTube%20-%20Non-Rounded%20Design%20%2B%20Pre-August%202021%20styled%20icons%20combo.user.js
// @updateURL https://update.greasyfork.org/scripts/559875/YouTube%20-%20Non-Rounded%20Design%20%2B%20Pre-August%202021%20styled%20icons%20combo.meta.js
// ==/UserScript==
...
/* Add Old Icons restorer code + including fixes */
/*home*/
...
/*library*/
ytd-guide-entry-renderer a[href*="/feed/library"] path,
ytd-guide-entry-renderer a[href*="/feed/you"] path,
ytd-mini-guide-entry-renderer a[href*="/feed/library"] path,
ytd-mini-guide-entry-renderer a[href*="/feed/you"] path,
...
[d*="m15.01 7.34 1.64 1.64L8.64 17H6.99v-1.64l8.02-8.02m0-1.42-9.02 9.02V18h3.06l9.02-9.02-3.06-3.06zm2.9-1.49 1.67 1.67-.67.67-1.67-1.67.67-.67m0-1.41L15.83 5.1l3.09 3.09L21 6.11l-3.09-3.09zM21 10h-1v10H4V4h10V3H3v18h18V10z"],
...
d: path("M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-1.91l-.01-.01L23 10z");
transform: translate(-6px, -10.6px) !important
}
...
ytd-guide-entry-renderer > a[href*="/playlist?list=LL"] path {
transform: scale(0.8) translate(4px, 4px) !important
}
/*dislike*/
...
d: path("M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2zm-2 1H8v-6c0-2.48 1.51-4.5 4-4.5s4 2.02 4 4.5v6z");
transform: scale(3.2) translate(-12px, -12px)
}
...
yt-icon-button.ytd-notification-topbar-button-renderer path {
...
/* Revert colors before late August 2021 (additional fixed included) */
#return-youtube-dislike-bar, #ryd-bar { background: #909090 !important } 
.ytLikeButtonViewModelHost .yt-spec-button-shape-next--size-m[aria-pressed="true"], .ytLikeButtonViewModelHost .yt-spec-button-shape-next--size-m[aria-pressed="true"] path, .ytDislikeButtonViewModelHost .yt-spec-button-shape-next--size-m[aria-pressed="true"], .ytDislikeButtonViewModelHost .yt-spec-button-shape-next--size-m[aria-pressed="true"] path { color: var(--yt-spec-call-to-action) !important; fill: var(--yt-spec-call-to-action) !important } 
.ytLottieComponentHost svg { opacity: .5 !important } 
.ytLikeButtonViewModelHost .yt-spec-button-shape-next--size-m[aria-pressed="true"] .ytLottieComponentHost svg { opacity: 1 !important }
...
#expand-icon, #icon.expand-icon.style-scope.ytd-info-row-renderer { color: #909090 !important }
#label-icon.yt-dropdown-menu, #icon-label.yt-dropdown-menu { color: var(--yt-spec-text-secondary) !important }
#call-to-action-icon { color: #909090 !important }
#expand-arrow, #collapse-arrow { color: var(--yt-spec-text-secondary) !important } 
.style-scope.ytd-button-renderer.style-black { color: #909090 !important } 
/* Other */
.ytp-popup.ytp-settings-menu .ytp-menuitem-icon { display: none !important }
.ytp-popup.ytp-settings-menu .ytp-menuitem-label { padding-left: 20px !important }
.ytp-popup.ytp-settings-menu .ytp-big-mode .ytp-menuitem-label { padding-left: 22px !important }
.ytp-popup.ytp-settings-menu .ytp-menuitem-icon:not(:empty) { padding-left: 0 }
[role="menuitemradio"] .ytp-menuitem-label { text-align: right }
