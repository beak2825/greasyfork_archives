// ==UserScript==
// @name        animebytes Collage Building Helper  (Edited for AnimeBytes by AnimeAi)
// @author      Z4ppy - Updated by jungletek, DubbyHarry. Fixed for Proton by junh1024. (Edited for AnimeBytes by AnimeAi)
// @namespace   jungletek.animebytes.tv
// @description Make it easier to build your collage.
// @include     https://*animebytes.tv/torrents.php*
// @include     https://*animebytes.tv/collages.php*
...
// @version     0.1a
// @date        2018-06-23
// @downloadURL https://update.greasyfork.org/scripts/369769/animebytes%20Collage%20Building%20Helper%20%20%28Edited%20for%20AnimeBytes%20by%20AnimeAi%29.user.js
// @updateURL https://update.greasyfork.org/scripts/369769/animebytes%20Collage%20Building%20Helper%20%20%28Edited%20for%20AnimeBytes%20by%20AnimeAi%29.meta.js
// ==/UserScript==
...
var URL = new Object();
function parseURL() {
	var URLArr = document.URL.match(/^(https:\/\/(?:ssl\.)?animebytes\.tv)\/([\w\/\.]+?)(\?(.*?))?(#.*)?$/);
	URL.Host = URLArr[1]; //protocol + hostname, eg. https://animebytes.tv
	URL.Path = URLArr[2];
	URL.Hash = URLArr[5];
...
function init() {
	...
	if ((URL.Path == 'torrents.php' || URL.Path == 'collages.php') && (collageID != 0)) {
