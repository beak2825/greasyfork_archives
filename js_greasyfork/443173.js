...
// @version      0.1
// @description  Moby 弹窗通知
// @author       wujiandao
// @match        https://moby.gg/
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/443173/Moby%20Notify.user.js
// @updateURL https://update.greasyfork.org/scripts/443173/Moby%20Notify.meta.js
// ==/UserScript==
 

var a1 = document.querySelector("#main-view > div.border-r.pt-16.lg\\:pt-0.dark\\:border-light-border.border-white-border > div > div:nth-child(2) > div:nth-child(2) > div > div > ul > a:nth-child(1)").innerHTML;
