...
// @downloadURL https://update.greasyfork.org/scripts/505103/%E7%BD%91%E6%98%93BUFF%E4%BB%B7%E6%A0%BC%E6%AF%94%E4%BE%8B%28%E6%89%BE%E6%8C%82%E5%88%80%29%E6%8F%92%E4%BB%B6%EF%BC%88%E6%B3%A2%E5%93%A5%E4%BC%98%E5%8C%96%E7%89%88%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/505103/%E7%BD%91%E6%98%93BUFF%E4%BB%B7%E6%A0%BC%E6%AF%94%E4%BE%8B%28%E6%89%BE%E6%8C%82%E5%88%80%29%E6%8F%92%E4%BB%B6%EF%BC%88%E6%B3%A2%E5%93%A5%E4%BC%98%E5%8C%96%E7%89%88%EF%BC%89.meta.js
// ==/UserScript==

(function () {

    const LIST_RATE_SHOW_THRESHOLD = 0.8;  // buff 比率大于这个值，不展示且不请求steam
    ...
    window.buffHelperMarkerListScale = async function (items) {
        ...
        async function marketListLoadData(item, good, randomID, secendTry) {
            ...
            let buff_sell_min_price = item.sell_min_price;                  // [a] buff出售最低价
            let steam_price_cny = item.goods_info.steam_price_cny * 100;    // [a] buff提供的steam国区售价
            ...
            if (helper_config.buffSellThreshold >= buff_sell_num) {
                ...
                const _sss_scale = +buff_sell_min_price / +item.goods_info.steam_price_cny / 0.87;
                if(_sss_scale > LIST_RATE_SHOW_THRESHOLD) {
                    paintingGradient(Math.round(_sss_scale * 1000) / 1000, target, 3);
                    updateProgressBar(randomID);
                    return;
                }
