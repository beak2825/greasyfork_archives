...
// @grant        GM_info
// @downloadURL https://update.greasyfork.org/scripts/471653/JumpDownloader.user.js
// @updateURL https://update.greasyfork.org/scripts/471653/JumpDownloader.meta.js
// ==/UserScript==
...
(async function (axios, JSZip, saveAs, ImageDownloader) {
  ...
  const title00 = jsonData.readableProduct.title;
  const title0 = title00.split(']')[0].trim();
  const title2 = title0.replaceAll(/\[|\【/g, '');
