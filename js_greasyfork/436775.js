...
// @downloadURL https://update.greasyfork.org/scripts/436775/%E3%80%90%E7%94%B5%E8%84%91%20%20%E6%89%8B%E6%9C%BA%20%E5%85%A8%E7%BD%91%E5%94%AF%E4%B8%80%E5%85%A8%E8%87%AA%E5%8A%A8%E8%84%9A%E6%9C%AC%E3%80%91VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/436775/%E3%80%90%E7%94%B5%E8%84%91%20%20%E6%89%8B%E6%9C%BA%20%E5%85%A8%E7%BD%91%E5%94%AF%E4%B8%80%E5%85%A8%E8%87%AA%E5%8A%A8%E8%84%9A%E6%9C%AC%E3%80%91VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
				...
				try {
					...
					function jxbvipobj() {
						...
						if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:isyour|miao101|douyin|kuaishou|douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|qq|xiami|migu|ximalaya|app-echo|1ting|lrts|haokan|baidu|wbdy|web3v|9ku)\./)) {
							...
							cssobj('[class*="bg"][style*="background-image:"]:not([class*="tem"]),[id*="bg"][style*="background-image:"]:not([id*="tem"]),[data-ad-stat][class*="btn"],script+div[class][id]:not([style])>a[class][id][onclick][style],script+div[class][id]:not([style])>a[class][id][onclick][style]+div[class][id][style]');
																	...
																	try {
																		...
																		function vipjxdmaobj() {
																			setTimeout(function() {
																				...
																				try {
																					if (jxb.match(new RegExp("^https:\/\/(?!.+?(?:强制(?:弹[小大]窗|跳转|搜索)|播放器))")) && !(jxb.match(new RegExp("(?:透明无接口|布米米|视频选集|Youtube|麻花影视|旋风视频)")))) {
																						if (objj.match('acfun') || (pcliwaiobj && localStorage.getItem("jxywyfsgbobj") != null & !(sessionStorage.getItem("jxywygdfsgbobj") == '1'))) {
									...
									if (jxbpcobj && (pcliwaiobj || ttbkjjliobj || mmkjjtjobj || obj.match(/^https?:\/\/(?:www\.bilibili\.com\/(?!bangumi\/play\/)|www\.acfun\.cn\/(?!bangumi\/))/))) {
										try {
											...
											function sddjb() {
												try {
													if (pcliwaiobj || ttbkjjliobj) {
														if (document.querySelector("div#江小白")) {} else {
															jxqzsxobjzdbtobj();
															zddjjk();
														}
													} else {}
