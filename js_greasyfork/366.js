...
// @version     11
// @downloadURL https://update.greasyfork.org/scripts/366/Howrse%20Swap%20all%20v4%20%3E%3E%20v3%20Default%20Coats.user.js
// @updateURL https://update.greasyfork.org/scripts/366/Howrse%20Swap%20all%20v4%20%3E%3E%20v3%20Default%20Coats.meta.js
// ==/UserScript==
...
else if(document.URL.indexOf("/rechercher") > 0 || document.URL.indexOf("bureau/?type") >0 || document.URL.indexOf("/affixe?id") > 0 || document.URL.indexOf("/race?id") > 0 || document.URL.indexOf("/marche/vente") > 0 || document.URL.indexOf("saillie?") > 0)
{
...
//	This will allow the script to not try and change the coat file for any foal of a breed that uses generic coats for foals.
//	Without this, you end up with an invisible horse.  Opps.
		if(tmpStyle.indexOf("/generique") < 0)
		{
...
function changeBreedingFarmIcons()
{
	...
	else if(document.URL.indexOf("/race?id") > 0 || document.URL.indexOf("saillie?") > 0) size = "300";
	else size = "120";
