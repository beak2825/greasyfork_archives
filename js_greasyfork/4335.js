...
// ==UserScript==
// @name               CopyTrade - OptionYard
// @author              Sykes
// @namespace          Optionyard
// @description          CopyTrade
// @include         https://www.optionyard.com/traderoom/
// @version      1.3
// @downloadURL https://update.greasyfork.org/scripts/4335/CopyTrade%20-%20OptionYard.user.js
// @updateURL https://update.greasyfork.org/scripts/4335/CopyTrade%20-%20OptionYard.meta.js
// ==/UserScript==
...
var peer = new Peer('copytrademasterOY', {key: 'enotiqsoyx4dkj4i'});

var conn = peer.connect('copytradeserverOY');

var ws = new WebSocket("ws://localhost:8100");

var timer =  window.setInterval(function(){ScrollPos()}, 1000);
...
conn.send(e.data + "," + window.pageYOffset.toString() + ",10");
console.log("MouseData send: " + e.data);
} else {
console.log("Tab has no focus! No MouseData send!");
}
};
...
conn.send('+' + window.pageYOffset.toString());
console.log("ScrollPos send: " + window.pageYOffset.toString());
}
else {
}
};
