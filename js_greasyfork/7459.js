// ==UserScript==
// @name         OCMP50 About Us Do-er thingy
...
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/7459/OCMP50%20About%20Us%20Do-er%20thingy.user.js
// @updateURL https://update.greasyfork.org/scripts/7459/OCMP50%20About%20Us%20Do-er%20thingy.meta.js
// ==/UserScript==
// ------------------------------------------------------------------------------------

//Set this to whatever "about us" is in whatever language you need
var about_us_translation = "회사 소개";
...
function getGoogleResults(task){
    var result = $('<a>').prop('href', task).prop('hostname');
    task = googleAPIPrefix + result + "%20"+"+\""+encodeURIComponent(about_us_translation)+"\"";
    var task2 = googleAPIPrefix + result + "%20+\"about us\"";
