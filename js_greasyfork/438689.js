...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/438689/Bot.user.js
// @updateURL https://update.greasyfork.org/scripts/438689/Bot.meta.js
// ==/UserScript==
var adminarray = [];
...
if (cmd == "/help") {
    MPP.chat.send("(rc - roomcolor) Commands are: /help /about /yes /no /name /id /color /hi /bye. | Bot owner commands: /rc1 /rc2 /rc3 /rc4 /rc5 /ban /unban.")
}
if (cmd == "/about") {
