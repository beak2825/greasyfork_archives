...
// @description zh-cn
// @namespace   jd.com
// @namespace   auction.jd.com
// @version     1.2.1
// @grant       none
// @homepageURL https://greasyfork.org/zh-CN/scripts/13063-x4%E7%9A%84%E5%A4%BA%E5%AE%9D%E5%B2%9B%E8%84%9A%E6%9C%AC
// @include     http://paimai.jd.com/*
// @downloadURL https://update.greasyfork.org/scripts/13063/x4%E7%9A%84%E5%A4%BA%E5%AE%9D%E5%B2%9B%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/13063/x4%E7%9A%84%E5%A4%BA%E5%AE%9D%E5%B2%9B%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
$('body').append(sdiv);
var sbtn = $('<button>开始夺宝</btton>');
var ebtn = $('<button>停</btton>');
var cbtn = $('<button>测</btton>');
sdiv.append(ebtn);
sdiv.append(cbtn);
sdiv.append(sbtn);
...
cbtn.click(function () {
  ...
  var ttt = setInterval(function () {
    ...
    $.getJSON('http://paimai.jd.com/json/current/englishquery?paimaiId=' + paimaiId + '&skuId=0&start=0&end=1', function (data) {
  ...
  $.getJSON('http://paimai.jd.com/json/current/englishquery?paimaiId=' + paimaiId + '&skuId=0&start=0&end=1', function (data) {
    ...
    setTimeout(function () {
      runtimer = setInterval(function () {
        ...
        $('#xxxtimes').text((ttimenum / 1000).toFixed(4) + ' ms');
        // 自动关闭弹窗提示
        if ($('.ui-dialog').size()) {
