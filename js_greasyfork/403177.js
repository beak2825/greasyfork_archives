...
// @author         Adir Avisar (based on Travian wave builder 1.8 by adipiciu)
...
// @version        1.0
// @downloadURL https://update.greasyfork.org/scripts/403177/%28Personal%29%20Wave%20Builder.user.js
// @updateURL https://update.greasyfork.org/scripts/403177/%28Personal%29%20Wave%20Builder.meta.js
// ==/UserScript==
...
function ok () {
	...
	wNr += 1;
	( wNr < $g('twb_multi').value && wNr < 10000 ) ? addWave() : wNr = 0;
}
...
var multi = $e('INPUT',[['id','twb_multi'],['type','number'],['value',1],['title',langStrings[4]],['min',1],['max',10000],['style','width:40px;margin:0 8px;']]);
