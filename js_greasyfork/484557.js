// ==UserScript==
// @name AudioBookBay hide category: Lecture
// @description Hide Lecture category
...
// @downloadURL https://update.greasyfork.org/scripts/484557/AudioBookBay%20hide%20category%3A%20Lecture.user.js
// @updateURL https://update.greasyfork.org/scripts/484557/AudioBookBay%20hide%20category%3A%20Lecture.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Lecture'
    $(".post").has(".postInfo:contains('Lecture')").hide();
});
