...
// @version        1.12
// @author         Alex_2oo8
// @downloadURL https://update.greasyfork.org/scripts/12974/%5BHWM%5D%20TransferSearch.user.js
// @updateURL https://update.greasyfork.org/scripts/12974/%5BHWM%5D%20TransferSearch.meta.js
// ==/UserScript==
...
//		if ( /&nbsp;&nbsp;[0-9]{2}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}/.test( td_arr[i].innerHTML ) )
    ...
    document.getElementById('TSearchByAll').addEventListener( 'click', function() { search( id, elem, 'All' ); }, false );
