// ==UserScript==
// @name         EveTRX.xyz (Pescador de Cripto)
...
// @match        *://evetrx.xyz/?a=roll*
// @match        https://*.pescadordecripto.com/dashboard/
// @match        https://*.pescadordecripto.com/install/
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/408843/EveTRXxyz%20%28Pescador%20de%20Cripto%29.user.js
// @updateURL https://update.greasyfork.org/scripts/408843/EveTRXxyz%20%28Pescador%20de%20Cripto%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function evebch(){
        ...
        if (window.location.href.indexOf("evetrx.xyz/?a=roll") > -1) {
            setInterval(function(){
                window.history.go(0);
            },300000);
        }
    ...
    function open(){
        if (window.location.href == "https://pescadordecripto.com/dashboard/") {
            window.open("https://evetrx.xyz/?a=roll", "EveTRX","width=10,height=10,left=-3000,top=-3000");
        }
    ...
    if (window.location.href == "https://pescadordecripto.com/install/") {
        document.getElementById('evetrx-xyz').classList.add("faucet-active");
    }
})();