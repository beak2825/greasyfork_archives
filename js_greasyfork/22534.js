...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/22534/Reapers%20split%20extension%E3%80%9A%E3%80%9B.user.js
// @updateURL https://update.greasyfork.org/scripts/22534/Reapers%20split%20extension%E3%80%9A%E3%80%9B.meta.js
// ==/UserScript==
 
    //replaces title
    //h2 selects all h2 elements
    $("h2").replaceWith('<h4>ᖇᗴᗩᑭᗴᖇᔕ ᗴ᙭丅ᗴᑎᔕᎥᗝᑎ</h4>');
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_t'> Press <b>T</b> to split 16</span></span></center>";
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_a'> Press <b>A</b> to triple split</span></span></center>";
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_d'> Press <b>D</b> to double split</span></span></center>";
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_s'> Press <b>S</b> to split once</span></span></center>";
