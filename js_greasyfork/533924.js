...
// @version    1.0.2
// @description  Версия для сервера GREEN
...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/533924/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80%20GREEN.user.js
// @updateURL https://update.greasyfork.org/scripts/533924/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80%20GREEN.meta.js
...
},
{
    ...
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[URL='https://forum.kingrussia.com/index.php?forums/66/'] [U] «Жалобы на администрацию»[/U].[/URL][/FONT][/size][/CENTER]<br><br>" +
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[URL='https://forum.kingrussia.com/index.php?forums/67/'] [U] «Жалобы на лидеров»[/U].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
 	  "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[URL='https://forum.kingrussia.com/index.php?forums/112/'] [U] «Обжалование наказаний»[/U].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[URL='https://forum.kingrussia.com/index.php?forums/65/'] [U] «Жалобы на игроков»[/U].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
