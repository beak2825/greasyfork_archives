// ==UserScript==
// @name         OC Stalker Frontend
// @namespace    TurtleOCStalker2
// @version      2.2
// @description  Fetch OC & user activity info from GitHub and append info in OC tab
// @match        https://www.torn.com/factions.php*
// @grant        GM_xmlhttpRequest
// @connect      api.github.com
// @connect      raw.githubusercontent.com
// @downloadURL https://update.greasyfork.org/scripts/543047/OC%20Stalker%20Frontend.user.js
// @updateURL https://update.greasyfork.org/scripts/543047/OC%20Stalker%20Frontend.meta.js
// ==/UserScript==
...
(async function () {
  ...
  viewmode="desktop"; //force desktop version for now
...
function renderMode2() {
  ...
  try {
    const [OC, BC] = await Promise.all([gmFetchJson(OC_JSON_URL), gmFetchJson(BC_JSON_URL)]);
