...
// @downloadURL https://update.greasyfork.org/scripts/473839/Jesus%20Caprio%20chisto%E2%9D%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/473839/Jesus%20Caprio%20chisto%E2%9D%A4.meta.js
// ==/UserScript==
...
const buttons = [
	{
	...
	},
     {
      ...
      content:
	            ...
	            "[CENTER][FONT=Montserrat Alternates Regular][COLOR=MediumPurple]{{greeting}}, уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
	           
		        " [FONT=Clear Sans Medium][B][CENTER]Ваша жалоба взята на рассмотрение.<br>" +
		       ...
		       '[CENTER][FONT=TIMES NEW ROMAN] [COLOR=YELLOW]  На рассмотрении [/COLOR][/FONT] [/CENTER]'+
		        "[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255,255)][B][SIZE=1]MURMANSK[/SIZE][/B][/COLOR]",
	  prefix: PIN_PREFIX,
	  status: true,
    },
	 {
 ...
 {
      title: 'в логах нету этого',
      content:
        '[Color=rgb(148, 0, 211)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]На данный момент по предоставленным доказательствам наказание не может быть выдано.[/CENTER]<br>" +
    ...
    },
    {
    ...
    },
     {
      ...
      content:
        ...
        "[CENTER] Приятной игры на [Color=blue]MURMANSK[/I][/CENTER][/color][/FONT]",
      prefix:ACCEPT_PREFIX, 
      status: false,
    },
{
    ...
    },
  {
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][FONT=georgia][I][B]С администратором будет проведена строгая беседа.<br>Спасибо за Ваше обращение.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR]. [/FONT][/I][/CENTER] " +
		'[Color=Green][CENTER]Одобрено, закрыто.[/I][/B][/CENTER][/color][/FONT]'+
		"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : ACCEPT_PREFIX,
	  status: false,
    }, 
{     title: 'проведу беседу сниму наказание', 
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]С администратором будет проведена строгая беседа.<br>Ваше наказание будет снято в течение нескольких часов.<br>Спасибо за Ваше обращение.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR]. [/FONT][/I][/CENTER] " +
		'[Color=Green][CENTER]Одобрено, закрыто.[/I][/B][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : ACCEPT_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Срок написания жалобы составляет один день (48 часа) с момента совершенного нарушения со стороны администратора сервера.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Администратор предоставил доказательства, наказание выдано верно.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : CLOSE_PREFIX, 
	  status: false,
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Дата указанная в жалобе, отличается от даты на скриншоте.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : UNACCEPT_PREFIX, 
	  status: false,
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Недостаточно доказательств нарушения со стороны администратора.<br>Благодарим вас за ваше обращение.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : UNACCEPT_PREFIX, 
	  status: false,
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Нарушений со стороны администратора не было найдено.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : UNACCEPT_PREFIX, 
	  status: false,
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Как доказательство прикладывается скриншот окна бана при входе на сервер.<br>Подайте новую жалобу и прикрепите такой скриншот, если он у вас имеется.<br>Благодарим вас за обращение.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : UNACCEPT_PREFIX, 
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Вы ошиблись разделом.<br>Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.2375/']*Обжалование наказаний*[/URL].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix : UNACCEPT_PREFIX, 
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Вы ошиблись разделом.<br>Обратитесь в [URL='https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-murmansk.2346/']*технический раздел*[/URL].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix : UNACCEPT_PREFIX, 
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Срок блокировки аккаунта будет снижен до 30 дней.<br>С момента разблокировки аккаунта, не повторяйте подобных действий.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Срок блокировки аккаунта будет снижен до 15 дней.<br>С момента разблокировки аккаунта, не повторяйте подобных действий.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Green][CENTER]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Срок блокировки аккаунта будет снижен до 7 дней.<br>С момента разблокировки аккаунта, не повторяйте подобных действий.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Green][CENTER]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : ACCEPT_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]К сожалению, вам отказано в смягчении наказания.<br>Не расстраивайтесь и всего вам доброго.<br>Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix : UNACCEPT_PREFIX, 
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Вы ошиблись разделом.<br>Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.2372/']*жалобы на администрацию*[/URL]."+
        "[CENTER]Приятной игры на просторах сервера [COLOR=rgb(0, 255, 255)]MURMANSK[/COLOR].[/CENTER]<br>" +
		'[Color=Red][CENTER]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
			"[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(148,0,211)]Куратор Администрации [/COLOR][URL='https://vk.com/hrnwtrrrr']Jesus Caprio[/URL][/FONT][/CENTER]<br>" , 
      prefix: UNACCEPT_PREFIX, 
	  status: false,
