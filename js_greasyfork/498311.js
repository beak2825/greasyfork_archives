// ==UserScript==
// @name    Скрипт для кураторов форума сервера Lime | Jerry Marrero
// @name:ru Скрипт для кураторов форума сервера Lime | Jerry Marrero
// @author Jerry Marrero
// @name:Кураторы форума | Marrero
// @description Создано для кураторов форума, для ответов на различные темы.
// @description: Предложения, баги, ошибки и прочее по улучшению скрипта писать сюда -> https://vk.com/boorjooomi
// @version 5.1
...
// @grant        none
// @license    MIT
// @supportURL https://vk.com/boorjooomi
// @icon https://catherineasquithgallery.com/uploads/posts/2021-03/1614574746_13-p-stikeri-na-belom-fone-14.png
// @downloadURL https://update.greasyfork.org/scripts/498311/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20Lime%20%7C%20Jerry%20Marrero.user.js
// @updateURL https://update.greasyfork.org/scripts/498311/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20Lime%20%7C%20Jerry%20Marrero.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      title: 'Уже наказан',
         ...
         '[Color=Lime][CENTER] Решено! [/I][/CENTER][/color][/FONT]',
    ...
    },
    {
      ...
      content:
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба была передана на рассмотрение Куратору Администрации.[/CENTER]<br>" +
        '[Color=Flame][CENTER]Ожидайте ответа.[/I][/CENTER][/color][/FONT]',
      prefix: GA_PREFIX,
      status: true,
    },
     {
      ...
      content:
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба была передана на рассмотрение Заместителю Главного Администратора.[/CENTER]<br>" +
        '[Color=Flame][CENTER]Ожидайте ответа.[/I][/CENTER][/color][/FONT]',
      prefix: GA_PREFIX,
      status: true,
    },
     ...
     },
    {
        ...
        },
     {
            ...
            '[COLOR=red][FONT=courier new]Решено,закрыто![/FONT][/COLOR][/I][/B][/CENTER]',
            prefix: RESHENO_PREFIX,
            status: false,
        },
    {
 ...
 {
            title: 'Долг-Рп процесс',
            content:
            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
            "[CENTER]Давая долг вы идете на страх и риск, это рп процесс.[/CENTER]<br>" +
...
"3:50 - Игрок выходит из игры[/SPOILER][/CENTER]<br>" +
    ...
    },
    {
        ...
        content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
          "[CENTER]Игрок уже наказан.[/CENTER]<br>" +
        '[Color=Red][CENTER]Закрыто.[/I][/CENTER][/color][/FONT]',
        prefix: RESHENO_PREFIX,
        status: false,
    },
