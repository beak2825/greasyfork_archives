...
// @downloadURL https://update.greasyfork.org/scripts/369842/%E5%A0%86%E7%B3%96%E7%BD%91%E4%B8%8B%E8%BD%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/369842/%E5%A0%86%E7%B3%96%E7%BD%91%E4%B8%8B%E8%BD%BD.meta.js
// ==/UserScript==
        ...
        layer.tab({
            ...
            success: function (layero, index) {
                ...
                body.context.getElementById(
                    ...
                    var value = body.context.getElementById('set_remind_email')
                        .value
                    ...
                    body.context.getElementById('overview_email').innerHTML =
                        value || '已清空'
                }
                body.context.getElementById(
                    'save_remind_mobile'
                ).onclick = function () {
                    var value = body.context.getElementById('set_remind_mobile')
                        .value
                    ...
                    body.context.getElementById('overview_mobile').innerHTML =
                        value || '已清空'
                }
                body.context.getElementById(
                    'reset_notice_status'
                ...
                body.context.getElementById(
                    ...
                    var value = body.context.getElementById('set_remind_token')
                        .value
                            ...
                            var pins = board_pins.map(function (pin) {
                                return {
                                    ...
                                    imgName:
                                        pin.id +
                                        '.' +
                                        pin.photo.path.split('.')[
                                            pin.photo.path.split('.').length - 1
                                        ]
                                }
                            })
                            //交互确定下载方式
