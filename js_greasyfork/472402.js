...
// @downloadURL https://update.greasyfork.org/scripts/472402/%D0%90%D0%B4%D0%BC%D1%82%D1%83%D0%BB%D1%81%20anapa%20KF.user.js
// @updateURL https://update.greasyfork.org/scripts/472402/%D0%90%D0%B4%D0%BC%D1%82%D1%83%D0%BB%D1%81%20anapa%20KF.meta.js
// ==/UserScript==
...
title: 'био отказ(заголовок темы)',
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][SIZE=4][FONT=times new roman][CENTER]{{ greeting }}, уважаемый игрок.[/CENTER][/COLOR]<br>' +
        "[CENTER]Ваша РП биография получает статус: [COLOR=rgb(255, 0, 0)]Отказано[/COLOR].<br>Ваша биография составлена не по форме. Убедительная просьба ознакомится с формой подач РП биографий тут:  [URL='https://forum.blackrussia.online/threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-rp-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.5625884/']Правил создания RolePlay биографии[/URL].[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][SIZE=4][FONT=times new roman][CENTER]{{ greeting }}, уважаемый игрок.[/CENTER][/COLOR]<br>' +
        "[CENTER]В Вашей РП биографии нет личного фото.<br> <br> [Color=#FF8C00]Отказано, закрыто[/COLOR][/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
	  status: false,
    },
    {
