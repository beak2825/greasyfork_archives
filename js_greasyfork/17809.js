// ==UserScript==
// @name           Partis zs prijave
// @version        0.04
// @description    Luksuz funkcije
// @author         Oficir
// @include        *.partis.si/*
// @namespace https://greasyfork.org/users/1868
// @downloadURL https://update.greasyfork.org/scripts/17809/Partis%20zs%20prijave.user.js
// @updateURL https://update.greasyfork.org/scripts/17809/Partis%20zs%20prijave.meta.js
// ==/UserScript==
...
function quickmsg(){
    ...
    if(confirm("Zadeva: + msg1 + \n_____________________________\nSporočilo:\n" + msg1 + "\n_____________________________\nPošljem?")){
		$.post("http://www.partis.si/profil/sendmsg", {to: usern, subject: "Odgovor na Prijavo sistemske napake", msg: msg1} );
	}
...
addlinklist("", "ZS napake", "http://www.partis.si/img/icons/email_go.png",true);
