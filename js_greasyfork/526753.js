...
// @version 1
// @description just a basic macro
// @author renato
// @match *://sploop.io/*
// @icon https://sploop.io/img/ui/favicon.png
// @license MIT
// @namespace https://greasyfork.org/users/1311498
// @downloadURL https://update.greasyfork.org/scripts/526753/Sploopio%20Blatant%20Placement%2C%20auto-heal.user.js
// @updateURL https://update.greasyfork.org/scripts/526753/Sploopio%20Blatant%20Placement%2C%20auto-heal.meta.js
// ==/UserScript==
...
CanvasRenderingContext2D.prototype.fillRect = function(x, y, width, height) {
    ...
    if (Sploop.isInGame()) {
        if (this.fillStyle === "#a4cc4f") {
            ...
            if (Sploop.HEALTH < 0 && Sploop.HEALTH > 0 && Toggles.AUTOHEAL) {
                setTimeout(()=>{
...
function repeater(code, callback, interval) {
    ...
    function start(key) {
        // Only start the interval if conditions are met and no interval is active
    ...
    function stop(key) {
        // Only stop the interval if the code matches
