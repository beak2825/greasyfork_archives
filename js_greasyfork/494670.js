...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/494670/AP.user.js
// @updateURL https://update.greasyfork.org/scripts/494670/AP.meta.js
// ==/UserScript==
 
(function() {
    'use strict';
 
    let name = localStorage.getItem("AutoPrice_Name") || "";
    let max_price = "";
    let t = -1;
