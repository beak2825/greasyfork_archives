...
// @downloadURL https://update.greasyfork.org/scripts/392866/For%20the%20girl%20that%20i%20love.user.js
// @updateURL https://update.greasyfork.org/scripts/392866/For%20the%20girl%20that%20i%20love.meta.js
// ==/UserScript==
...
// Cosmetics //
///////////////
GM_addStyle('#logo {background-image: url("https://cdn.discordapp.com/attachments/584271015153106974/589784487383007252/heart.png");}');
...
$('#btn-play').text('em Rekt Noobs <3 ');
$('#btn-servers').text('ems Room');
$('#profile-clan-membership').text('em is best <3');
$(".main-bottom-left").append('<a id="<3" href="https://agario-skins.org/custom-skins/heart" target="_blank">emi <3</a>');
$("#umdiscord").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "#fff",
...
$("#main-content").append('<a id="umroster" href="https://cdn.discordapp.com/attachments/550099780441997312/645764057172934656/Screenshot_2019-09-28-21-51-32.png" target="_blank">clickkk</a>');
$("#umroster").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "#fff",
...
console.log("%c click Script is enabled. dont forget Arrow", "font-size: 25px; font-weight: bold; background: red; color: white; padding: 10px; border: solid 2px orange;");
