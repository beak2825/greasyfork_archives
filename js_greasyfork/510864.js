...
// @downloadURL https://update.greasyfork.org/scripts/510864/shadow%20client.user.js
// @updateURL https://update.greasyfork.org/scripts/510864/shadow%20client.meta.js
// ==/UserScript==
...
function Y(a) {
  ...
  b.replace("Health Color & Visuals", /"#04c213":"#c20d04"/, "'#3H8K2A' : '#121212',\n\n        Hooks.Tracers(...arguments)\n        Hooks.PlaceHelper(...arguments)\n    ");
  const i = {
    values: h
  };
