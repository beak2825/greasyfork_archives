...
// @description         Εμφανίζει την λίστα με τις χρυσές και ασημένιες δουλειές 
// @grant               none
// @author 		Macabre2077
...
// @author 		Kigka (Greek translation)
// @version             0.2
...
// @downloadURL https://update.greasyfork.org/scripts/33695/TW%20Gold%20Jobs%20Finder.user.js
// @updateURL https://update.greasyfork.org/scripts/33695/TW%20Gold%20Jobs%20Finder.meta.js
// ==/UserScript==
...
(function (f) {
    ...
    if (window.hasOwnProperty("GoldJobs")) {
        new west.gui.Dialog(GoldJobs.SCRIPT_NAME, '<div class="txcenter"><b><br>Το UserScript GoldJobs εγκαθίσταται δύο φορές, με δύο διαφορετικές γλωσσικές εκδόσεις. Θα πρέπει να απεγκαταστήσετε ένα από αυτά για να λειτουργήσει σωστά το script!</br></b></div>', west.gui.Dialog.SYS_WARNING).addButton("OK").show();
    } else {

        GoldJobs = {
            version: VERSION,
            //CHECK_FILE_URL: 0,
            FEEDBACK_URL: "http://www.revtw2.gr",
            CHECK_FILE_URL: "https://greasyfork.org/el/scripts/33695-tw-gold-jobs-finder/code",
            SCRIPT_SITE: "https://greasyfork.org/el/scripts/33695-tw-gold-jobs-finder",
            ...
            GAME_VERSION_SUPPORTED_MAX: 2.80,
            bestJobTime: 0
        };
        ...
        GoldJobs.languages = {
            ...
            "el_GR": {
                ...
                distanceTime: "Χρόνος ταξιδιού ",
                showJob: "Εμφάνιση",
                title: "Χρυσές και Ασημένιες δουλειές",
                loaded: "Φόρτωση: ",
                changelist: "Λίστα αλλαγών",
                version: "Έκδοση",
                update_available: "Gold Jobs Διαθέσιμη αναβάθμιση",
                update_question: "Μπορείτε να κατεβάσετε την τελευταία έκδοση από το userscripts.org. Μετάβαση στην σελίδα",
                loading: "Φόρτωση...",
                exportTitle: "Share",
                exportButtonTitle: "Share",
                generatedBy: "Δημιουργία από TW Gold Jobs Finder",
                generatedByBb: "[i][url=" + GoldJobs.SCRIPT_SITE + "]Generated by TW Gold Jobs Finder[/url][/i]",
