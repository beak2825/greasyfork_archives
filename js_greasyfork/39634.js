...
// @downloadURL https://update.greasyfork.org/scripts/39634/Z%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/39634/Z%20script.meta.js
// ==/UserScript==
banner = true;
var stalled = 0;
if(banner){
...
function ban(){
    ...
    setTimeout(function(){ban();}, 4000);
}

function check () {
    if (!document.getElementById('video_container').querySelector('iframe')) {
        stalled ++;
        if (stalled >= 10) window.location.reload();
    }
    else stalled = 0;
}