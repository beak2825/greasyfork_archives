// ==UserScript==
// @name         Richup.io Name & Flag Replacer (Lithuanian Cities)
// @namespace    http://tampermonkey.net/
// @version      1.1.3
// @description  Replaces default city/country names and flags with Lithuanian city names and coats of arms on richup.io game pages.
// @author       Giedrius Rackevicius
// @match        https://richup.io/room/*
// @grant        none
// @run-at       document-idle
// @downloadURL https://update.greasyfork.org/scripts/534514/Richupio%20Name%20%20Flag%20Replacer%20%28Lithuanian%20Cities%29.user.js
// @updateURL https://update.greasyfork.org/scripts/534514/Richupio%20Name%20%20Flag%20Replacer%20%28Lithuanian%20Cities%29.meta.js
// ==/UserScript==
...
(() => {
  ...
  const initializeScript = () => {
    ...
    const textReplacements = {
      ...
      Paris: "Vėtrungė",
      // Kaunas
      "United Kingdom": "Kaunas",
      Liverpool: "Žaliakalnis",
      Manchester: "Šilainiai",
      London: "Centras",
      // Vilnius
      USA: "Vilnius",
      "San Francisco": "Naujamiestis",
      "New York": "Senamiestis",
      // Airports
      "TLV Airport": "SQQ Airport",
      "MUC Airport": "PLQ Airport",
      "CDG Airport": "KUN Airport",
      "JFK Airport": "VNO Airport",
      // Companies
      "Electric Company": "Ignitis",
      "Water Company": "Utenos Vandenys",
      // Prison related phrases
      "out of prison": "out of Lukiškės",
      "in prison": "in Lukiškės",
      "In Prison": "In Lukiškės",
      "got into prison": "got into Lukiškės",
    };
    ...
    const svgReplacements = {
      ...
      [normalizeSvgString(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/a/ad/Marijampole_COA.svg",
      // Israel / Utena
      [normalizeSvgString(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/a/ac/Coat_of_arms_of_Utena_(Lithuania).svg",
      // Italy / Alytus
      [normalizeSvgString(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/d/d4/Coat_of_arms_of_Alytus_(Lithuania).svg",
      // Germany / Panevėžys
      [normalizeSvgString(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/0/03/Coat_of_Arms_of_Panevezys.svg",
      // China / Šiauliai
      [normalizeSvgString(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/c/c8/Šiauliai_COA_small.svg",
      // France / Klaipėda
      [normalizeSvgString(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/4/49/Coat_of_arms_of_Klaipeda_(Lithuania).svg",
      // United Kingdom / Kaunas
      [normalizeSvgString(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/3/33/Coat_of_arms_of_Kaunas.svg",
      // USA / Vilnius
      [normalizeSvgString(
        ...
        "https://upload.wikimedia.org/wikipedia/commons/e/e2/Coat_of_Arms_of_Vilnius.svg",
    };
    ...
    const replaceMatchingSvg = (svgElement) => {
      ...
      if (replacementUrl) {
        ...
        let title = "Lithuanian COA"; // Default title
        try {
