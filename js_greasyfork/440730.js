// ==UserScript==
// @name         Catier Hack Client | Katana + Musket | AUTOHEAL |  Anti-Insta  |  starter resources and more!!
// @version      v.1.3
// @description  This was SISI's HacK but I decided to name it Catier Hack Client. Not only the name of the mod was changed, also the power of it! To know how to use it read the description! Hope you enjoy!! this is a sad copy of pancake mod
// @author       W4IT#1814
// @match        *://moomoo.io/*
// @match        *://*.moomoo.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/440730/Catier%20Hack%20Client%20%7C%20Katana%20%2B%20Musket%20%7C%20AUTOHEAL%20%7C%20%20Anti-Insta%20%20%7C%20%20starter%20resources%20and%20more%21%21.user.js
// @updateURL https://update.greasyfork.org/scripts/440730/Catier%20Hack%20Client%20%7C%20Katana%20%2B%20Musket%20%7C%20AUTOHEAL%20%7C%20%20Anti-Insta%20%20%7C%20%20starter%20resources%20and%20more%21%21.meta.js
// ==/UserScript==
let AUTHOR = "W4IT"
...
document.getElementById('gameName').innerHTML = 'Meow Hack Client';
document.getElementById('loadingText').innerHTML = ' Back for more?... '
document.getElementById('diedText').innerHTML = "Well You Got Close";
document.getElementById('diedText').style.color = "#00ffOOff";
document.title = ' Meowmod';
document.getElementById("leaderboard").append ('Meowmod');
        ...
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 style="font-size: 17px;">#1 Catier catnip hack menu</h2>
                </div>
