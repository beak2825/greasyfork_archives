...
// @copyright 2022,
// @downloadURL https://update.greasyfork.org/scripts/449364/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B4%D0%B5%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%7C%20%D0%9F%D0%9A.user.js
// @updateURL https://update.greasyfork.org/scripts/449364/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B4%D0%B5%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%7C%20%D0%9F%D0%9A.meta.js
// ==/UserScript==
...
const buttons = [
	...
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
        "[CENTER]Нарушитель будет наказан за нарушение правил нападения на Воинскую Часть.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER]С правилами можно ознакомиться по ссылке → [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BD%D0%B0%D0%BF%D0%B0%D0%B4%D0%B5%D0%BD%D0%B8%D1%8F-%D0%BD%D0%B0-%D0%B2%D0%BE%D0%B5%D0%BD%D0%BD%D1%83%D1%8E-%D1%87%D0%B0%D1%81%D1%82%D1%8C.185332/']*Нажмите сюда*.[/URL][/SIZE][/QUOTE][/CENTER]<br><br>" +
		'[CENTER]Одобрено, закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: OKAY_PREFIX,
	  status: false,
	},
    ...
    {
	  title: 'НРП КОП | Задержание без отыгровок РП',
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
	...
	},
    {
	  title: 'Био одобрена',
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER][/FONT][/SIZE]<br><br>' +
        "[SIZE=4][FONT=Georgia][CENTER]Ваша биография одобрена.[/CENTER][/FONT][/SIZE]<br><br>" +
		'[SIZE=4][FONT=Georgia][CENTER]Одобрено, закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: OKAY_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
        "[CENTER]В Вашей биографии допущены серьезные ошибки.[/CENTER]<br><br>" +
        "[CENTER]Перечитайте правила составления РП биографий.[/CENTER]<br>" +
		'[CENTER]Отказано, закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
