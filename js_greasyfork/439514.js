// ==UserScript==
// @name         New Notion-Translate for ZH-Ch
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/439514/New%20Notion-Translate%20for%20ZH-Ch.user.js
// @updateURL https://update.greasyfork.org/scripts/439514/New%20Notion-Translate%20for%20ZH-Ch.meta.js
// ==/UserScript==
...
(function() {
  ...
  const I18n = new I18N();
    ...
    // 左栏
		...
		// 个人工作区
		"Personal Plan": '个人套餐',
    		'Create work account': '创建工作账号',
    		'Add another account': '添加另一个账号',
    		'Log out all': '全部注销',
    		"Get Windows app": '获取Windows应用',
    		'Join or create workspace': '加入（创建）工作区',
    		'Log out': '注销',
		...
		// -----------------
		'Share': '分享',
            'Share or publish to the web': '分享/发布此页面',
            'View all comments': '查看全部评论',
            'View all updates': '查看全部更新',
            'Pin this page in your sidebar': '收藏本页至边栏',
            //'Style, export, and more': '风格、导出、更多选项..',
		...
		//【...】
    		...
    		'Import': '导入',
    		'Export': '导出',
    		'Connect Slack channel': '链接 Slack',
    		'Move to': '移动到',
    		'Word count: ': "字数统计 ",
        'Duplicate': '创建副本',
        'Turn into': '切换块格式',
        'Turn into page in': '跳转链接',
        'Copy link to block': '拷贝模块链接',
        ...
        'Babic blocks': '基础内容块',
            ...
            'Block equation': '公式块',
            'Synced block': '同步块',
            'Toggle heading 1': '收展列表级1',
            'Toggle heading 2': '收展列表级2',
            'Toggle heading 3': '收展列表级3',

        'Inline': '行内块',
            'Mention a person': '@个人',
            'Mention a page': '@页面',
            'Date or reminder': '@时间',
            'Inline equation': '插入公式',
...
//数据库模块
		...
		'Search': '搜索',
		'New': '新增',
        'Replicate page formats inside this database with templates.': '复制模板中的页面格式到数据库中',
		'New template': '新的模版',
		'Tags': '标签',
        'Created': '创建时间',
        'Hide all': '隐藏全部',
        ...
        'Group by': '分组依据',
        'Learn about databases': '学习更多 Databases',
		...
		// -----------------
		// 设置 => 通知
		'My notifications & settings': '通知',
		'My notifications': '我的通知',
		'Learn about mobile and desktop notifications.': '了解有关手机和桌面通知的消息。',
		'Mobile push notifications': '向手机推送通知',
		'Receive push notifications on mentions and comments via your mobile app.': '立即通过您的移动应用接收有关提及和评论的推送通知。',
		...
		'Language': '语言',
		'Change the language used in the user interface.': '更改用户界面中使用的语言。',
