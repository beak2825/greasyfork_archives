...
// @downloadURL https://update.greasyfork.org/scripts/489020/XBVR%20Dark%20Edition.user.js
// @updateURL https://update.greasyfork.org/scripts/489020/XBVR%20Dark%20Edition.meta.js
// ==/UserScript==
...
(function () {
  ...
  * {
  ...
  .navbar-tabs {
  	...
  	flex-shrink: 0;
  	min-height: 3.25rem;
  	background: linear-gradient(90deg, #7957d5, transparent 90%);
  }
  .navbar-menu {
  	background-color: #232323;
  ...
  .loading-overlay .loading-background {
  	background: hsla(0, 0%, 0%, .77) !important;
}
