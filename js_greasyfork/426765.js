...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/426765/cztery_godziny.user.js
// @updateURL https://update.greasyfork.org/scripts/426765/cztery_godziny.meta.js
// ==/UserScript==
...
(function() {
    ...
    var callback = function(mutationsList, observer) {
        ...
        var osiem_exists = document.getElementById('cztery');
        if ( osiem_exists == null )
        {
            console.log('ADDING cztery');
            ...
            input_btn.id = 'cztery';
            input_btn.textContent = 'cztery godziny';
            ...
            input_btn.onclick = function (){
                ...
                document.getElementById('timesheet_edit_form_duration').value = '04:00';
                changedDuration('04:00');
