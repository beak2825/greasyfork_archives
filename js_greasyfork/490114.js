// ==UserScript==
// @name         New style for forum curators | Yaroslavl | by D.Korneplod (KrooTyk)
// @namespace    https://forum.blackrussia.online/
// @version      7.1
// @description  Скрипт для Кураторов форума на ответы на жалобы игроков; RP био; RP ситуации | Black Russia, по всем вопросам на счет скрипта VK - https://vk.com/krootyk , последнее обновление 17.03.2024
// @author       Skezzy_Beezy & Denis_Korneplod
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license      MIT
// @icon https://i.ibb.co/St8VLD6/image.png
// @downloadURL https://update.greasyfork.org/scripts/490114/New%20style%20for%20forum%20curators%20%7C%20Yaroslavl%20%7C%20by%20DKorneplod%20%28KrooTyk%29.user.js
// @updateURL https://update.greasyfork.org/scripts/490114/New%20style%20for%20forum%20curators%20%7C%20Yaroslavl%20%7C%20by%20DKorneplod%20%28KrooTyk%29.meta.js
// ==/UserScript==
...
(function () {
	...
	const buttons = [
	{
		...
		content:
		'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый(-ая)[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	...
	},
	{
        ...
        dpstyle: 'oswald: 3px;     color: #fff; background: #7851A9; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #7851A9',
	},
         {
            ...
            content:
            '[CENTER][url=https://postimages.org/][img]https://i.ibb.co/d4LXLtq/logobryaroslavl.png[/img][/url][/CENTER]<br>' +
            ...
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[CENTER][COLOR=#FFB000][SIZE=4][B]✿❯────「 ❖На рассмотрении❖ 」───❮✿[/B][/SIZE][/COLOR][/CENTER]<br>",
            prefix: PIN_PREFIX,
            status: true,
          },
          {
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]По данным доказательствам нельзя выдать наказание игроку. Все нарушения должны быть подтверждены через определенные ресурсы, а не только по предоставленным доказательствам.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
               "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              ...
              "[/LIST]<br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
          ...
          },
{
        ...
        },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
         {
          ...
          },
          {
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[CENTER][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4][/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Запрещено использование любых нецензурых слов/выражений в VIP чате[/COLOR][COLOR=rgb(255, 0, 0)]| Mute 30 минут[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/CENTER][/B][/COLOR]<br>" ,
            prefix: ACCEPT_PREFIX,
          ...
          },
{
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Нарушитель будет наказан за введение/попытку введения в заблуждения игроков командами.[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | Ban 15 - 30 дней / PermBan[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              "[CENTER][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.37.[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Запрещено: OOC угрозы, в том числе и завуалированные.[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | Mute 120 минут / Ban 7 дней[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
      	...
      	},
        {
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Данный промокод является системным, или был выпущен  разработчиками.[/SIZE][/FONT][/COLOR][/CENTER][/I]" +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Игрок ничего не нарушет.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
	...
	},
    {
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил ограблений/похищений :[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Благодарим вас за обращение![/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
              "[CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Игрок получит своё наказание[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | Warn[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
	...
	},
	 {
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию - [/I][URL='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.2925/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров - [/I][URL='https://forum.blackrussia.online/forums/Жалобы-на-лидеров.2926/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Вы ошиблись разделом, обратитесь в раздел жалоб на Агентов поддержки - [/I][URL='https://forum.blackrussia.online/threads/•-yaroslavl-Жалобы-на-Агентов-Поддержки.7021312/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Вы ошиблись разделом, обратитесь в раздел Обжалование наказаний - [/I][URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.2928/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
            status: false,
	...
	},
    {
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Видео фиксация не полная, фрапс обрезан[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
    {
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Ваша жалоба составлена не по форме. Внимательно прочитайте правила подачи жалоб на игроков - [URL=https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/]ТЫК[/URL][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/CENTER]<br>' +
            '[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          ...
          },
          {
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              "[CENTER][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]3.08.[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Запрещено: любые формы «слива» посредством использования глобальных чатов.[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | PermBan[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              "[CENTER][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4][/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Запрещено: заменять чужие объявления в СМИ, редакция в личных целях[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | Ban 7 дней[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Нарушитель будет наказан за слив семейного склада.[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | Ban 15 - 30 дней [/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Владельцы и заместители транспортных/строительных/таксо компаний[/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]выдают премии по собственному желанию.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Они могут, как выдавать, так и не выдавать премию.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Все операции связанные с долгами должны[/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]проводиться строго через банковскую систему проекта.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В иных случаях передача игровой валюты может расцениваться, как обход системы.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
              '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
	   ...
	   },
       {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография получает статус [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография получает статус:[/CENTER]<br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пунктах *Детство*, *Юность*, *Взросление*, *Зрелость* и *Наши дни* слишком мало информации.[/SIZE][/FONT][/I][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии заголовок написан не по форме, внимательно прочитайте правила РП Биографии в закрепленые в данном разделе[/SIZE][/FONT][/I][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография написана не по форме [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Вы не дополнили свою RolePlay Биографию [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография оформлена неграмотно.[/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
            "[LIST]<br>" +
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография написана от 3-его лица [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Вы приписали своему персонажу суперспособности  [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография скопирована частино/полность у другого человека[/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]У вас NonRp NickName [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии не совпадает дата рождения с возрастом [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
         {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В ваша RolePlay Биографии семья расписано не полностью[/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В ваша RolePlay Биографии дата рождения расписано не полностью [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
	...
	},
      {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Ситуация получает статус [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#00FF00][SIZE=5]✿❯────「 ❖[B]Одобрено❖[/B] 」────❮✿[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: ACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Вы ошиблись разделом [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Ситуация написана не по форме [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
         {
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Ситуация написана не грамотно т.е в ней много ошибок.[/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Ситуация скопирована частично/полностью у другого человека[/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
         {
          title: 'Не дополнили',
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Вы не дополнили свою RolePlay Ситуацию [/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Ситуации заголовок написан не по форме, внимательно прочитайте правила РП Ситуации в закрепленые в данном разделе[/SIZE][/FONT][/I][/COLOR][/CENTER]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
          ...
          },
       {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый(-ая) {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Организация скопирована частично/полностью у другого человека[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              '[CENTER][COLOR=#FF0000][SIZE=5]✿❯────「 [B]❖Отказано❖[/B] 」────❮✿​[/SIZE][/COLOR][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://img0.liveinternet.ru/images/attach/d/0/137/577/137577876_KRASNUYY_2.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
            prefix: UNACCEPT_PREFIX,
