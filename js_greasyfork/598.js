...
// @description Recherche des messages
// @downloadURL https://update.greasyfork.org/scripts/598/AutoMessagerie2.user.js
// @updateURL https://update.greasyfork.org/scripts/598/AutoMessagerie2.meta.js
// ==/UserScript==
...
search.appendChild(input);    
    ...
    $('#liste_messages #searchMessage input').keyup(function () {
       var auth = localStorage.getItem('SIF_Messagerie2.0');
       ...
       else alert("Vous n avez pas l autorisation d'utiliser cette mise a jour. Procurez vous la au 420 rue Hoblet ou contactez Odul.");
    });
    
    $("#zone_messagerie .titre").html($("#zone_messagerie .titre").html().replace("Messagerie", "Com2.0 <br> par SIF"));
