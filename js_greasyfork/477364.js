...
// @downloadURL https://update.greasyfork.org/scripts/477364/%E7%94%B5%E8%84%91%E6%97%A0%E5%B9%BF%EF%BC%8C%E6%89%8B%E6%9C%BA%E6%9C%89%E5%B9%BF.user.js
// @updateURL https://update.greasyfork.org/scripts/477364/%E7%94%B5%E8%84%91%E6%97%A0%E5%B9%BF%EF%BC%8C%E6%89%8B%E6%9C%BA%E6%9C%89%E5%B9%BF.meta.js
// ==/UserScript==
        ...
        function config() {
            ...
            if (window === top) {
                ...
                */
                ...
                "7哥":"https://jx.nnxv.cn/tv.php?url=",// TODO

                "SP流":"https://jx.m3u8.tv/jiexi/?url=",// TODO 
 
                "JX":"https://jiexi.site/?url=",// TODO
                              
                "PM":"https://www.playm3u8.cn/jiexi.php?url=",// TODO
                
                "x米":"https://jx.xmflv.com/?url=",// TODO

                "小m":"https://jx.xiaofengtv.com/jx.php?url=",// TODO 
                
               

              
               };
                settings.AD解析 = {    // TODO (告)
                ...
                settings.Default解析 = {      // 配置优先解析源
                        ...
                        "腾讯视频": {
                        "电脑端": [settings.NoAD解析["7哥"], settings.AD解析["x米"], settings.AD解析["小m"]],
                        "手机端": [settings.NoAD解析["7哥"]]
                    },
                    "爱奇艺": {
                        "电脑端": [settings.NoAD解析["7哥"], settings.AD解析["x米"], settings.AD解析["小m"]],
                        "手机端": [settings.NoAD解析["7哥"]]
                    ...
                    "优酷视频": {
                        "电脑端": [settings.AD解析["7哥"], settings.AD解析["x米"]],
                        "手机端": [settings.NoAD解析["7哥"]]
                    },
                    "哔哩哔哩": {
                        "电脑端": [settings.NoAD解析["7哥"], settings.NoAD解析["x米"]],
                        "手机端": [settings.NoAD解析["7哥"], settings.NoAD解析["x米"]]
                    },
                    "咪咕视频": {
                        "电脑端": [settings.AD解析["7哥"], settings.AD解析["x米"]],
                        "手机端": []
                    ...
                    "搜狐视频": {
                        "电脑端": [settings.NoAD解析["7哥"]],
                        "手机端": [settings.NoAD解析["7哥"]]
                    },
                    "芒果TV": {
                        "电脑端": [settings.NoAD解析["7哥"], settings.NoAD解析["x米"], settings.NoAD解析["小m"], settings.NoAD解析["虾米解析"], settings.NoAD解析["夜幕解析"]],
                        "手机端": [settings.NoAD解析["7哥"], settings.NoAD解析["x米"], settings.NoAD解析["小m"], settings.NoAD解析["虾米解析"], settings.NoAD解析["夜幕解析"]]
                    },
                    "西瓜视频": {
                        "电脑端": [settings.NoAD解析["7哥"]],
                        "手机端": [settings.NoAD解析["7哥"]]
        ...
        (function () {
            ...
            if (window === top) {
                ...
                settings.toolsBar.innerHTML = "<style>\n" +
                    "    text{font-family: 微软雅黑,黑体,Droid Serif,Arial,sans-serif; font-size: 8px; color: #000; position: absolute; transform: translateY(-50%); top: 50%;}\n" +
                    ...
                    "    <button style='transition: all 0.5s; width: 12px; height:  %; border-radius: 3px; background-color: #4af; border-color: #4af; text-align: center; color: #fff;'>\n" +
                    "        .\n" +
                    "    </button>\n" +
                ...
                SettingsBtn.addEventListener("click", function () {
                    if (SettingsBlock.style.opacity === "0") {
                        ...
                        SettingsBlock.style.width = "100px";
                    } else {
                        SettingsBtn.innerText = ".";
                ...
                if (settings.parseDB.解析开关) {
                    if (!sessionStorage.getItem("parse.tip.")) {
                        showTip(" ");
                        sessionStorage.setItem("parse.tip.", "\x01");
                    }
                    config();
                }
