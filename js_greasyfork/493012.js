// ==UserScript==
// @name         Anapa | скрипт для булдовых
// @namespace    https://forum.blackrussia.online
// @version      2.6
// @description  По вопросам(ВК): https://vk.com/mihail_bloodov
// @author       Leonard_Bloodov (Миша)
...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/493012/Anapa%20%7C%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%B1%D1%83%D0%BB%D0%B4%D0%BE%D0%B2%D1%8B%D1%85.user.js
// @updateURL https://update.greasyfork.org/scripts/493012/Anapa%20%7C%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%B1%D1%83%D0%BB%D0%B4%D0%BE%D0%B2%D1%8B%D1%85.meta.js
// ==/UserScript==
      ...
      },
     {
	  ...
	  content:
	    ...
	    "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 "[I][CENTER][COLOR=orange][FONT=book antiqua][SIZE=4]Жалоба взята на рассмотрение, не создавайте дубликаты, а терпеливо ожидайте ответа.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
         "[I][CENTER][COLOR=orange][FONT=book antiqua][SIZE=4]Ведь терпение ключ к победе.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=blue]ANAPA[/COLOR].<br><br>"+
 "[I][CENTER][COLOR=blue][FONT=book antiqua][SIZE=4]by Bloodov.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
		'[I][CENTER][COLOR=yellow][FONT=book antiqua][SIZE=4]На рассмотрении.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' ,
	  prefix: PIN_PREFIX,
	  status: true,
	},
     {
	  ...
	  content:
		...
		"[B][CENTER][COLOR=#f4d58d][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 "[I][CENTER][COLOR=Green][FONT=book antiqua][SIZE=4]Ваша жалоба составлена не по форме, в следствии чего не подлежит рассмотрению.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
 "[I][CENTER][COLOR=orange][FONT=book antiqua][SIZE=4]Ознакомьтесь с правилами подачи жалоб ниже и не повторяйте таких ошибок.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
 "[I][CENTER][COLOR=blue][FONT=book antiqua][SIZE=4]by Bloodov [/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
		"[CENTER][B][COLOR=RED]| [URL='https://forum.blackrussia.online/index.php?threads/3429394/'][Color=lavender]Правила подачи жалоб[/URL] [COLOR=RED]|<br>"+
         ...
         "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>" +
       '[I][CENTER][COLOR=RED][FONT=book antiqua][SIZE=4]Отказано, закрыто.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' ,
	  prefix: PIN_PREFIX,
	  status: false,
	},
     {
	...
	},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#f4d58d][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 "[I][CENTER][COLOR=purple][FONT=Book antiqua][SIZE=4]Проверив систему логировки, было принято, что нарушений не имеется. Если у вас имеются доп доказательства предоставьте их в другой жалобе.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
         "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
		   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
 "[I][CENTER][COLOR=blue][FONT=book antiqua][SIZE=4]by Bloodov.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
		 '[I][CENTER][COLOR=RED][FONT=book antiqua][SIZE=4]Отказано, закрыто.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' ,
	...
	},
    {
	...
	},
     {
      ...
      '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#f4d58d][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 "[I][CENTER][COLOR=orange][FONT=book antiqua][SIZE=4]Ваши доказателства должны быть предоставлены в фотохостинге, а в случае фрапса на ютуб. Будьте внимательны перед следующей подачей[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
 "[I][CENTER][COLOR=blue][FONT=book antiqua][SIZE=4] by Bloodov[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
		  "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
			 '[I][CENTER][COLOR=red][FONT=book antiqua][SIZE=4]Отказано, закрыто[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>',
	...
	},
    {
	...
	},
     {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#f4d58d][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 "[I][CENTER][COLOR=orange][FONT=book antiqua][SIZE=4]Ваши видио доказательства представлены не полностью, в следствии не подлежат рассмотрению.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
 "[I][CENTER][COLOR=blue][FONT=book antiqua][SIZE=4]by Bloodov[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
		 "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
		 '[I][CENTER][COLOR=red][FONT=book antiqua][SIZE=4]Отказано, закрыто[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>',
	...
	},
   {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#f4d58d][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 "[I][CENTER][COLOR=green][FONT=book antiqua][SIZE=4]Благодарим за обращение, игрок будет наказан по данному пункту общих правил серверов, а именно 2.19. Запрещен DM (DeathMatch) — убийство или нанесение урона без веской IC причины | Jail 60 минут Примечание: разрешен ответный DM в целях защиты, обязательно иметь видео доказательство в случае наказания администрации, нанесение урона по транспорту также является нарушением данного пункта правил.Примечание: нанесение урона с целью защиты особняка или его территории, а также нанесение урона после ДТП не является веской IC причиной, для войны семей предусмотрено отдельное системное мероприятие.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
 "[I][CENTER][COLOR=blue][FONT=book antiqua][SIZE=4] by Bloodov [/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
	   "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
       '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
		 '[I][CENTER][COLOR=green][FONT=book antiqua][SIZE=4]Одобрено[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>',
	...
	},
{
   ...
   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
     ...
     {
	  title: ' Передача с кф с логами ',
	  content:
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 "[I][CENTER][COLOR=blue][FONT=book antiqua][SIZE=4]Ваша жалоба передается куратору форума, владеющего логирование (либо же иным проверяющим). Не создавайте дубликаты данной темы или же вы получите наказание[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
		 "[I][CENTER][COLOR=blue][FONT=book antiqua][SIZE=4]by Bloodov.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
         "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
		 '[I][CENTER][COLOR=yellow][FONT=book antiqua][SIZE=4]На рассмотрении[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>',
