...
// @grant	   GM_listValues
// @version       2015.3.1
// @downloadURL https://update.greasyfork.org/scripts/3069/LetterboxMarker.user.js
// @updateURL https://update.greasyfork.org/scripts/3069/LetterboxMarker.meta.js
// ==/UserScript==
...
var bs=document.getElementsByTagName("th");
var themen=null;
for(var i=0;i<bs.length;i++) {
	if(bs[i].firstChild && bs[i].firstChild.data && bs[i].firstChild.data.substr(1,6)=="Themen") {
		themen=bs[i].parentNode;
	}
}
...
function displayMarkers() {
	...
	var headerCell=themen.getElementsByTagName("th")[0].cloneNode(false);
