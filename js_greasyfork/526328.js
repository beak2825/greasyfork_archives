...
// @downloadURL https://update.greasyfork.org/scripts/526328/Tech%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/526328/Tech%20Script.meta.js
// ==/UserScript==
...
' [/FONT]',
	...
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
	"Ваша тема создана не по форме.<br>Пересоздайте тему и заполните форму, как указано ниже:<br><br>Пример:<br> Lev_Kalashnikov | махинации<br>Форма заполнения темы:<br>01. Ваш игровой никнейм:<br>02. Игровой никнейм технического специалиста:<br>03. Сервер, на котором Вы играете:<br>04. Описание ситуации (описать максимально подробно и раскрыто):<br>05. Любые скриншоты, которые могут помочь в решении проблемы (если таковые имеются):<br>06. Дата и время произошедшей технической проблемы (постарайтесь указать максимально точно):<br><br>" +
	'Закрыто.',
...
{
	title: 'Передача Руководству осн',
	color: '',
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
	"Ваша тема закреплена и ожидает вердикта Заместителя Куратора Технических Специалистов и/или Куратора Технических Специалистов.<br>" +
