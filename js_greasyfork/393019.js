...
// @match        http://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/393019/New%20Userscript.user.js
// @updateURL https://update.greasyfork.org/scripts/393019/New%20Userscript.meta.js
// ==/UserScript==
...
(function() {
    ...
    // Your code here...
       ...
       if (a.keyCode == 90) {//Full Houses Base
                socket.emit("1",4.725,130,7);
                socket.emit("1",5.245,130,4);
...
socket.emit("1",11.10,311,1);
       ...
       if (a.keyCode == 46) {//Defend Full Houses and Tanks
...
socket.emit("1",3.265,130,1);socket.emit("1",3.735,130,1);socket.emit("1",4.205,130,1);
       ...
       if (a.keyCode == 115) {//Full Defense Base
                socket.emit("1",4.73,245,3);
                socket.emit("1",5.0025,245,3);
                socket.emit("1",5.5475,245,3);
                socket.emit("1",5.82,245,3);
