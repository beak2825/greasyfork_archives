// ==UserScript==
// @name  Скрипт для Кураторов Форума by J.Murphy (BLACK)
...
// @downloadURL https://update.greasyfork.org/scripts/531644/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20JMurphy%20%28BLACK%29.user.js
// @updateURL https://update.greasyfork.org/scripts/531644/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20JMurphy%20%28BLACK%29.meta.js
// ==/UserScript==
    ...
    },
{
   ...
   "[HEADING=3][CENTER][COLOR=#00FF00][I][B][FONT=georgia][SIZE=4]Одобрено![/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      "[CENTER][IMG width=695px]https://i.ibb.co/D1QkYF3/8P4g6gO.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(0, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4]ГКФ @Nikita_Guobrozul , ЗГКФ @Esenia_Dolmatova  [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
    "[SPOILER][I][FONT=georgia][SIZE=4][COLOR=rgb(255, 255, 255)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://eu-markt.ru/image/catalog/description/222_0a77c632c31a320dd6c278f194992a21.png[/IMG][/CENTER]<br>"+
    ...
    },
  {
      ...
      content:
       "[CENTER][IMG width=695px]https://i.ibb.co/D1QkYF3/8P4g6gO.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(0, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4]Уважаемый пользователь, ваше обращение было рассмотрено и переадресовано [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4] Главному Куратору форума, @Nikita_Guobrozul [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4]. Он ознакомится с вашей жалобой и предоставит ответ в ближайшее время. Пожалуйста, следите за обновлениями в данной теме. Благодарим за ваше терпение и понимание![/SIZE][/FONT]<br><br>" +
   ...
   "[IMG]https://eu-markt.ru/image/catalog/description/222_0a77c632c31a320dd6c278f194992a21.png[/IMG][/CENTER]<br>"+
    ...
    },
    {
      ...
      "[CENTER][IMG width=695px]https://i.ibb.co/D1QkYF3/8P4g6gO.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(0, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4]Кураторам @Joseph Murphy, @Greenfield Stoyn [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(0, 0, 0)][I][FONT=georgia][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
    "[SPOILER][I][FONT=georgia][SIZE=4][COLOR=rgb(255, 255, 255)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/SIZE][/FONT][/SPOILER]<br><br>" +
 "[IMG]https://eu-markt.ru/image/catalog/description/222_0a77c632c31a320dd6c278f194992a21.png[/IMG][/CENTER]<br>"+
   "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]SERVER[/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia][/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 255, 0)][I][B][FONT=georgia][SIZE=4]На рассмотрении![/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
