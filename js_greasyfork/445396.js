...
// @namespace    -
// @version     1.5.3
// @description BEST MOOMOO HACK FOR SANDBOX
// @author      dune
// @match        *://moomoo.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/445396/whatever%20mod.user.js
// @updateURL https://update.greasyfork.org/scripts/445396/whatever%20mod.meta.js
// ==/UserScript==
   ...
   , function(e, t, n) {
       (function(t) {
           e.exports.maxScreenWidth = 1920,
               ...
               e.exports.maxPlayers = t && -1 != t.argv.indexOf("--largeserver") ? 80 : Infinity,
   ...
   , function(e, t, n) {
    ...
    document.getElementById("pingDisplay")), Ee = document.getElementById("shutdownDisplay"), Me = document.getElementById("menuCardHolder"), Ae = document.getElementById("guideCard"), Pe = document.getElementById("loadingText"), Be = document.getElementById("gameUI"), Ce = document.getElementById("actionBar"), Oe = document.getElementById("scoreDisplay"), Re = document.getElementById("foodDisplay"), je = document.getElementById("woodDisplay"), _e = document.getElementById("stoneDisplay"), Ue = document.getElementById("killCounter"), De = document.getElementById("leaderboardData"), Le = document.getElementById("nameInput"), Fe = document.getElementById("itemInfoHolder"), ze = document.getElementById("ageText"), He = document.getElementById("ageBarBody"), Ve = document.getElementById("upgradeHolder"), qe = document.getElementById("upgradeCounter"), Ye = document.getElementById("allianceMenu"), We = document.getElementById("allianceHolder"), Xe = document.getElementById("allianceManager"), Ne = document.getElementById("mapDisplay"), Ge = document.getElementById("diedText"), Je = document.getElementById("skinColorHolder"), Ke = Ne.getContext("2d");
       ...
       function hatmacros(e) {
           switch (e) {
               case "ShiftLeft":
                   Jt(R.y <= o.snowBiomeTop ? 15 : R.y >= 6850 && R.y <= 7550 ? 31 : 12);
                   Jt(11, 1);
                   break;
               case "KeyC":
                   Jt(6);
       ...
       function sn(e) {
           if (e.startsWith("s.")) {
               if (settings[e.slice(2)] && typeof settings[e.slice(2)] === "function") {
                   settings[e.slice(2)]();
               }
           }
       ...
       function pn() {
           return R ? settings.getruby ? 90**100 : tracker.autoaiming && nEy.length ? nEA : tracker.intrap && settings.autobreak ? angleToTrap : (-1 != se.id ? cn = Math.atan2(se.currentY - se.startY, se.currentX - se.startX) : R.lockDir || on || (cn = Math.atan2(ie - z / 2, ne - F / 2)),
                                                                                                                                                  s.fixTo(cn || 0, 2)) : 0
       }
       ...
       window.addEventListener("keydown", s.checkTrusted((function(e) {
           ...
           27 == t ? Qt() : R && R.alive && kn() && (gn[t] || (gn[t] = 1, hatmacros(e.code),
                                                               tracker.intrap ? [foodPlacer, boostPlacer, spikePlacer, millPlacer, turretPlacer].forEach(e => e.stop(t)) : [foodPlacer, boostPlacer, spikePlacer, millPlacer, turretPlacer].forEach(e => e.start(t)),
                                                               69 == t ? r.send("7", 1) : 67 == t ? (Mt || (Mt = {}),
                                                                                                     Mt.x = R.x,
                                                                                                     Mt.y = R.y) : 88 == t ? (R.lockDir = R.lockDir ? 0 : 1,
                                                                                                                              r.send("7", 0)) : null != R.weapons[t - 49] ? Sn(R.weapons[t - 49], !0) : null != R.items[t - 49 - R.weapons.length] ? Sn(R.items[t - 49 - R.weapons.length]) : 81 == t ? Sn(R.items[0]) : 82 == t ? settings.instaType == "WR" ? auI = !auI : insta("normal") : 77 == t ? atM = !atM : mn[t] ? bn() : 32 == t && (O = 1,
        vn(e))))
       }))),
           ...
           if (R && R.alive) {
               ...
               13 == t ? rn() : kn() && gn[t] && (gn[t] = 0,
                                                  [foodPlacer, boostPlacer, spikePlacer, millPlacer, turretPlacer].forEach(e => e.stop(t)),
                                                  mn[t] ? bn() : 32 == t && (O = 0,
                                                                             vn(e), Jt(tracker.combatclick), Sn(R.weapons[0], !0)))
           }
       })));
       var wn = void 0;
       function bn() {
       ...
       function dmgPotential() {
           let temp = 0 + (primaryReload[R.sid] == 1 ? (1.5 * l.weapons[R.weapons[0]].dmg) : 0) + (secondaryReload[R.sid] == 1 && R.weapons[1] ? (l.weapons[R.weapons[1]].dmg || l.projectiles[l.weapons[R.weapons[1]].projectile].dmg || 0) : 0) + (turretReload[R.sid] == 1 && nEy[9] != 22 ? 25 : 0);
           nEy[9] == 6 && (temp *= 0.75);
           return temp;
       }
       function Sn(e, t) {
       ...
       function Mn(e, t, n, i) {
           ...
           m.showText(e, t, 50, .18, 800/*500*/, Math.abs(n), n >= 0 ? "#fff" : "#8ecc51")
       }
       var An = 99999;
       function Pn() {
           le = !1;
               ...
               (_ = N[a]).active && (r = _.x + _.xWiggle - t,
                                     ...
                                     _.layer == e && ki(r, s, _.scale + (_.blocker || 0)) && (be.globalAlpha = _.hideFromEnemy ? .6 : 1,
                                                                                              _.isItem ? (i = ri(_),
                                                                                                          be.save(),
                                                                                                          be.translate(r, s),
                                                                                                          (_.dir > 1e300 || _.dir < -1e300 ? (_.hideFromEnemy ? .6 : 1, be.rotate(Math.atan2(Math.sin(_.dir), Math.cos(_.dir)))) : be.rotate(_.dir)),
       ...
       function Wn(e, t, n) {
           (_ = Ii(e)) && (_.startAnim(t, n), n == 10 || n == 14 ? (_.sr = 1,secondaryReload[e] = -111/l.weapons[_.secondary].speed)
                           ...
                           R == _ && R.skins[40] && R.weapons[1] == 10 && !tracker.bulltick && !tracker.insta && !tracker.emp && tracker.intrap && (tracker.breakHC++))
       }
       function Xn(e, t, n) {
           be.globalAlpha = 1;
       ...
       function li(e) {
           for (var t = 0; t < e.length; )
               nt.add(e[t], e[t + 1], e[t + 2], e[t + 3], e[t + 4], e[t + 5], l.list[e[t + 6]], !0, e[t + 7] >= 0 ? {
                   ...
                   (15 == e[t+6] && Math.sqrt(Math.pow((R.y2-e[t + 2]),2)+Math.pow((R.x2-e[t + 1]),2)) < 100 && e[t+7] != R.sid && !isAlly(e[t+7])) && (aT(), setAutobreaker(e[t + 1], e[t + 2], e[t])),
                   t += 8
       }
       ...
       function combatClick(){
           if(tracker.combatclick == "bull"){
               ...
               let a = (R.weapons[1] == 10 && !(tracker.breakHC == 2 && primaryReload[R.sid] == 1) ? 10 : R.weapons[0]);
               Sn(a, !0);
       ...
       function Si(e, t) {
           (_ = Ii(e)) && (Qz(_, t), (t <= _.health ? (_.hitTime = tC) : _.buildItem()), _.health = t)
       }
       function Qz(_, t){
           let d = t - _.health;
           if(d > 0){
       ...
       function healing(e, t) {
           ...
           if(R.skinIndex == 6){
               if ([30, 33, 35, 34, 38, 40].includes(e) // appl
                   && W.filter(item => fgdo(item, R) < 300 && item.sid != R.sid &&(primaryReload[item.sid] == 1 || secondaryReload[item.sid] == 1)).length > 0) {
                   doSoldierAnti()
       ...
       function predictReload(){
           let changed = W.filter(item => (lastPrimaryReload[item.sid] != primaryReload[item.sid]) && item.sid != R.sid)
           let potential = changed.filter(item => primaryReload[item.sid] == 1 && (fgdo(item, R) < 260))
           if(potential.length){
       ...
       function canPlace(e, t = R.dir) {
           let center = {
               x: Math.cos(t) * l.list[e].scale + R.x,
               y: Math.sin(t) * l.list[e].scale + R.y
           }
           let blockers = N.filter(args => args.x && args.y && args.scale
                                   && fgdo(args, center) + o.playerScale <= args.scale + l.list[e].scale);
           return (blockers.length ? false : true);
       }
       ...
       function autopush(mySpikes, enemyTrap) {
           ...
           let position = {
               x: spike.x + (distance * Math.cos(enemyToSpike)),
               y: spike.y + (distance * Math.sin(enemyToSpike))
           };
           angle = () => {
               if(enemyToSpike > 70){
       ...
       function autoplace() {
           ...
           if (R.items[4] == 16) {
               if (gn[66]) {
                   ...
                   if (fgd(nEy, R) > window.boostDist) {
                       ...
                       let s = (fgd(nEy, R) <= 70 ? [nEA, nEA + 2 * Math.PI] : [nEA + Math.PI / 2, nEA + 3 * Math.PI / 2])
           ...
           var element;
           let myTraps = N.filter(args => args.owner && (args.owner.sid === R.sid || isAlly(args.owner.sid)) && args.trap);
           if (myTraps.length) {
       ...
       function Ti(e) {
           ...
           predictReload()
           manageTick()
           let hatList = [15,31,6,7,22,(R.weapons[0] != 7 && R.weapons[0] != 0 ? 12 : 6),11,26,53,40], accList = [11, 18, 21];
           let hats = et.filter(e => hatList.includes(e.id)), accessories = tt.filter(e => accList.includes(e.id));
           hats.forEach(x => {
               if(R.points >= x.price && !(R.skins[x.id])) r.send("13c", 1, x.id, 0), hatList.splice(0, 1); // remove it from the list
           });
           accessories.forEach(x => {
               if(R.points >= x.price && !(R.tails[x.id])) r.send("13c", 1, x.id, 1), accList.splice(0, 1); // remove it from the list
           });
       }
       function manageTick(){
           if (queueTick[tC]) {
       ...
       function otherHat(){
           if(R.y >= 6850 && R.y <= 7550){
               ...
               Jt(11)
               Jt(21,1)
           } else if((R.shameCount > 0 && (nEy.length && fgd(nEy, R) > 260)) || (R.shameCount > 5)){
               Jt(7)
               Jt(11, 1)
       ...
       function doWeaponStuff(_){
           ...
           if (atM
               && (!R.itemCounts[3]
                   || fgdo(N.filter(args => args.owner && args.owner.sid === R.sid && args.pps).sort((a, b) => fgdo(a, R) - fgdo(b, R))[0], R) > 90)) {
               let ang = Math.atan2(R.y1-R.y2, R.x1-R.x2)
               place(R.items[3], ang), place(R.items[3], ang + Math.PI / 2.2), place(R.items[3], ang - Math.PI / 2.2);
           }
       }
       function updateToggles() {
           ...
           for (let [elem, value] of Object.entries(settings)){
               if (typeof value != "function") {
                   toggles.innerHTML += `<p style="font-size: 17px;">${elem}: ${value}</p>`;
                   localStorage[elem] = value;
               }
           }
           toggles.innerHTML += `<p style="font-size: 17px;">autoinsta: ${auI}</p>`;
       }
       function Ii(e) {
           for (var t = 0; t < W.length; ++t)
               if (W[t].sid == e)
                   ...
                   if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                       ...
                       if ("" != w) {
                           if (be.font = (_.nameScale || 30) + "px Hammersmith One",
                               be.fillStyle = _ == R ? "#fff" : R.team && _.team == R.team ? "#8ecc51" : "#cc5151",
                       ...
                       Rn.crosshair.isLoaded && nEy[0] == _.sid && auI && nEy.length && (b = 2 * o.playerScale -10,
                       ...
                       if(_.isPlayer){
                           ...
                           _.old = Date.now();
                           _.health > 0 && (o.healthBarWidth, be.fillStyle = rt, be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY, 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8), be.fill(), be.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151", be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad, 2 * o.healthBarWidth * (_.healthMov/_.maxHealth), 17 - 2 * o.healthBarPad, 7), be.fill())
                           br(be, _.x - f , _.y - d - _.scale - o.nameY + 85, "#39A4E2", Math.abs(0.36 * o.reloadBarWidth * (_.pr<primaryReload[_.sid]?_.pr+(primaryReload[_.sid]-_.pr)*Math.min(1,_.dt/111):primaryReload[_.sid])), 8, -26.5);

                           br(be, _.x - f + 50 + 4, _.y - d - _.scale - o.nameY + 85, "#39A4E2", Math.abs( 0.36 * o.reloadBarWidth * (_.sr<secondaryReload[_.sid]?_.sr+(secondaryReload[_.sid]-_.sr)*Math.min(1,_.dt/111):secondaryReload[_.sid])), 8, -26.5);
                       } else {
...
//# sourceMappingURL=bundle.js.map// ==UserScript==// ==UserScript==
// @name         New Userscript
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  try to take over the world!
// @author       You
// @match        https://discord.com/channels/@me/900534006079176704
