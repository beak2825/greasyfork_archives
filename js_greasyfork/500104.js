// // ==UserScript==
// @name         Скрипт для Кураторов форума | Black Russia  Chelyabinsk
...
// @license      MIT
// @collaborator ford
// @icon https://sun1-22.userapi.com/s/v1/ig2/eISx8l5mYqWGAxdm9jwG5ZTPs56jFUgDuA43n37fX_rDinbLcUIj9jSQameMZzqROSabaNw99ElSr_r4WuDVv68j.jpg?size=1024x1024&quality=95&crop=127,127,1024,1024&ava=1
// @downloadURL https://update.greasyfork.org/scripts/500104/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20Black%20Russia%20%20Chelyabinsk.user.js
// @updateURL https://update.greasyfork.org/scripts/500104/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20Black%20Russia%20%20Chelyabinsk.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    {
        title: 'НЕ ЧЕКАЕТСЯ В ЛОГАХ',
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый игрок.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Все нарушения должны быть подтверждены через определенные ресурсы, не только по доказательствам предоставленным игроком, но на тот момент подтверждение по техническим причинам получить было невозможно.[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 255, 255)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(218, 165, 32)]Сhelyabinsk[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
    ...
    },
{
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый игрок.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 102, 0)][I][FONT=times new roman][SIZE=4]Главной Администрации[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
        "[FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 255, 255)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(218, 165, 32)]Сhelyabinsk[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
    ...
    },
	{
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый игрок.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 102, 0)][I][FONT=times new roman][SIZE=4]ГКФ/ЗГКФ[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
        "[FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 255, 255)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(218, 165, 32)]Сhelyabinsk[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 165, 0)][FONT=times new roman][SIZE=4][I][CENTER]На рассмотрении.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
      prefix: PIN_PREFIX,
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый игрок.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]В таких случаях нужен фрапс.[/I][/SIZE][/FONT]<br><br>" +
        "[I][FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 255, 255)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(218, 165, 32)]Сhelyabinsk[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый игрок.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.154/']*жалоб на администрацию*.[/URL][/I][/FONT][/SIZE]<br><br>" +
    ...
    },
    {
      ...
      content:
        ...
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 255, 255)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(218, 165, 32)]Сhelyabinsk[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        ...
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - Ситуации - [/COLOR][/I][COLOR=rgb(209, 213, 216)][URL='https://forum.blackrussia.online/threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-role-play-%D1%81%D0%B8%D1%82%D1%83%D0%B0%D1%86%D0%B8%D0%B8.463789/']*Нажмите сюда*[/URL][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 255, 255)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(218, 165, 32)]Сhelyabinsk[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания Неофициальной RP - Организации - [/COLOR][/I][COLOR=rgb(209, 213, 216)][URL='https://forum.blackrussia.online/threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB%D0%B0-%D0%9D%D0%B5%D0%BE%D1%84%D0%B8%D1%86%D0%B8%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5-rp-%D0%BE%D1%80%D0%B3%D0%B0%D0%BD%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D0%B8.39469/']*Нажмите сюда*[/URL][/COLOR][/FONT][/SIZE]<br><br>" +
       '[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 255, 255)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(218, 165, 32)]Сhelyabinsk[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
