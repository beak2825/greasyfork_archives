// ==UserScript==
// @name         Crosshair Color and health color
// @namespace    http://tampermonkey.net/
// @version      0.6
// @description  Crosshair color and yolk color  is gonna be changed. I update colors every once in a while.
// @author       Cobra~LOL
...
// @grant        none
// @license MIT 
// @downloadURL https://update.greasyfork.org/scripts/445081/Crosshair%20Color%20and%20health%20color.user.js
// @updateURL https://update.greasyfork.org/scripts/445081/Crosshair%20Color%20and%20health%20color.meta.js
// ==/UserScript==
...
.pause-popup--container {
    display: grid;
    width: auto;
    grid-template-columns: 15.5em auto 26em;
    margin-top: 8em;
    margin-right: auto;
	margin-left: auto;
    grid-gap: 2em;
...
@media only screen and (max-width: 922px)  {
	.pause-popup--container {
		...
		grid-template-columns: 9.5em auto 35em;
	}
}

/* CrazyGames */
@media only screen and (max-width: 923px) and (min-height: 486px)  {
	.pause-popup--container {
		grid-template-columns: 9.5em auto 35em;
	}
}
...
/* CrazyGames */
@media only screen and (max-width: 939px) and (min-height: 502px)  {
	.pause-popup--container {
		grid-template-columns: 9.5em auto 35em;
	}
}p: 24%;
...
:root {
	...
	--ss-yellow: #FAF179;
	--ss-yolk0: #f1c59a;
//PASTE YOUR CSS HERE IN THE MIDDLE DONT DELETE THE LINE ABOVE

</style>`); //DONT DELETE THIS EITHER
