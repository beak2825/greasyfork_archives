...
// @version     1
// @grant		none
// @downloadURL https://update.greasyfork.org/scripts/25345/Palette%20132.user.js
// @updateURL https://update.greasyfork.org/scripts/25345/Palette%20132.meta.js
// ==/UserScript==
...
function init()
{
	if(String(window.location).split('/')[3]=='edit')
	{
		...
		//1.1
		viewstr='<TD align="right"><a href="javascript:prevVisTog()"><u>'+unescape('%u043F%u0440%u0435%u0432%u044C%u044E%3A')+'</u></a></TD><TD style=""><div id="html_prev" style="width:auto;overflow:hidden;height:17px;padding:2px;word-wrap:break-word;border:solid 1px #A0A0A0;"><i>'+unescape('%20%u041A%u043B%u0438%u043A%u043D%u0438%u0442%u0435%2C%20%u0447%u0442%u043E%u0431%u044B%20%u0440%u0430%u0437%u0432%u0435%u0440%u043D%u0443%u0442%u044C')+'</i></div></TD>';
		var headIndex;
		...
		if(elemChild[i].childNodes.length>2)
		{
			...
			//alert(elemChild[i].getElementsByTagName('TD')[2].attributes[1].value);
			try{if(parseInt(elemChild[i].getElementsByTagName('TD')[2].attributes[1].value)==2)
			{
