// ==UserScript==
// @name         高校考试网(gaoxiaokaoshi.com)
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  根据原作者Aisen改变增加了网络题库的功能
// @author       Aisen
...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/427442/%E9%AB%98%E6%A0%A1%E8%80%83%E8%AF%95%E7%BD%91%28gaoxiaokaoshicom%29.user.js
// @updateURL https://update.greasyfork.org/scripts/427442/%E9%AB%98%E6%A0%A1%E8%80%83%E8%AF%95%E7%BD%91%28gaoxiaokaoshicom%29.meta.js
// ==/UserScript==
var $ = window.jQuery;
var out = {};
var setting = {
        ...
        GM_xmlhttpRequest({
            ...
            onload: data => {
                if (JSON.parse(data.responseText).message === 200) {
                    GM_xmlhttpRequest({
                        url: 'http://47.95.221.79:8080/loginController/mks/theAnswer',
                        method: 'GET',
                        headers: {
                            "Content-Type": "application/json"
                        },
