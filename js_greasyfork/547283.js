// ==UserScript==
// @name         Для Куратора и Заместителя 16-20
...
// @icon https://avatars.mds.yandex.net/i?id=d74b233607e9cc5e772a9abd3b4ad217_l-4298597-images-thumbs&n=13
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/547283/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%B8%20%D0%97%D0%B0%D0%BC%D0%B5%D1%81%D1%82%D0%B8%D1%82%D0%B5%D0%BB%D1%8F%2016-20.user.js
// @updateURL https://update.greasyfork.org/scripts/547283/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%B8%20%D0%97%D0%B0%D0%BC%D0%B5%D1%81%D1%82%D0%B8%D1%82%D0%B5%D0%BB%D1%8F%2016-20.meta.js
// ==/UserScript==
...
{
  title: 'Утеря привязки',
  content:
  "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER][/CENTER]<br>" +
  '[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
  '[CENTER][B][COLOR=rgb(255, 255, 255)][FONT=verdana]Благодарим вас за обратную связь. Ваше обращение было принято к рассмотрению, и мы вынесли следующий вердикт.[/FONT][/COLOR][/B][/CENTER]<br><br>' +
  '[CENTER][COLOR=rgb(255, 0, 0)][B][FONT=verdana]4.01[/FONT][/B][/COLOR][B][FONT=verdana]. Создавая игровой аккаунт на нашем проекте, игрок автоматически соглашается со всеми правилами проекта.[/FONT][/B][/CENTER]<br><br>' +
  '[CENTER][B][COLOR=rgb(255, 255, 255)][FONT=verdana]Утерянный доступ к аккаунте без возможности предоставить привязку/привязки автоматически означает, что вы не можете предоставить доказательства того, что привязка является именно вашей. Следовательно, мы не можем подтвердить правдивость данных слов. Такие аккаунты блокируются с причиной "Утеря доступа к аккаунту".[/FONT][/COLOR][/B][/CENTER]<br><br>' +
  '[CENTER][B][FONT=verdana][COLOR=rgb(255, 255, 255)]В данной ситуации нам, к сожалению, не удастся разблокировать ваш аккаунт. Для обеспечения безопасности рекомендуется создать новый аккаунт и принять все возможные меры по защите данных. Наша команда технических специалистов настоятельно рекомендует вам установить дополнительные меры безопасности, такие как двухфакторную аутентификацию, сложные пароли и регулярное обновление паролей.[/COLOR][/FONT][/B][/CENTER]<br><br>' +
  '[CENTER][B][COLOR=rgb(255, 255, 255)][FONT=verdana]Пожалуйста, будьте внимательны при создании нового аккаунта и храните данные доступа в надежном месте. Мы приносим извинения за возможные неудобства, связанные с этой ситуацией, и стараемся обеспечить безопасность всех наших пользователей.[/FONT][/COLOR][/B][/CENTER]<br>' +
  '[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
  '[CENTER][B][I][FONT=verdana][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR][/FONT][/I][/B][/CENTER]',
  prefix: CLOSE_PREFIX,
...
},
{
  ...
  "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER][/CENTER]<br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
  '[CENTER][B][FONT=verdana][COLOR=rgb(255, 255, 255)]Ваша жалоба передана на рассмотрение [/COLOR][COLOR=rgb(251, 160, 38)]Куратору Технических Специалистов[/COLOR][COLOR=rgb(255, 255, 255)].<br><br>@Raf_Piatigorsky<br><br> Пожалуйста, ожидайте ответа. [/COLOR][/FONT][/B][/CENTER]<br>' +
  '[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]',
  prefix: PIN_PREFIX,
	status: true,
},
{
  ...
  "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER][/CENTER]<br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
  '[CENTER][B][FONT=verdana][COLOR=rgb(255, 255, 255)]Ваше обжалование передано на рассмотрение [/COLOR][COLOR=rgb(251, 160, 38)]Куратору Технических Специалистов[/COLOR][COLOR=rgb(255, 255, 255)].<br><br>@Raf_Piatigorsky<br><br> Пожалуйста, ожидайте ответа. [/COLOR][/FONT][/B][/CENTER]<br>' +
  '[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]',
  prefix: PIN_PREFIX,
	status: true,
},
{
  ...
  "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER][/CENTER]<br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
  '[CENTER][B][FONT=verdana][COLOR=rgb(255, 255, 255)]Ваша жалоба передана на рассмотрение [/COLOR][COLOR=rgb(251, 160, 38)]Заместителю Куратора Технических Специалистов[/COLOR][COLOR=rgb(255, 255, 255)].<br><br>@Andrew_Benassy<br><br> Пожалуйста, ожидайте ответа. [/COLOR][/FONT][/B][/CENTER]<br>' +
  '[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]',
  prefix: PIN_PREFIX,
	status: true,
},
