// ==UserScript==
// @name         TFGS Chat Script audio
// @namespace    http://tampermonkey.net/
// @version      2.2.9 beta testing
// @description  QoL features that I wanted added into chat. 
// @author       gea lunazarius Gea
// @match        https://tfgames.site/phpbb3/chat/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/424719/TFGS%20Chat%20Script%20audio.user.js
// @updateURL https://update.greasyfork.org/scripts/424719/TFGS%20Chat%20Script%20audio.meta.js
// ==/UserScript==
! function(e) {
    var t = {};
    ...
    var o = {
        updatesRead: [],
        //player: new Audio('https://tfgames.site/phpbb3/chat/sounds/sound_0.mp3'),
        features: {
            debugMode: !1,
    ...
    var h = function() {
        ...
        p = [{
            ...
            category: "custom",
            command: "\"color 1\"",
            description: "Colors the inside of your messages to your set color you can set upto 3 colors",
            help: "\" words\"",
            args: 0
        }, {
            category: "custom",
            command: "\#color 2\#",
            description: "Use #'s like you would with quoatations, and the script converts #'s to \" allowing you to have two colors for quotes ",
            help: "\# words \#",
            args: 0
        }, {
            category: "custom",
            command: "\@ color 3\@",
            description: "Colors the inside of your messages to your set color. This will replace the @'symbols with \" marks. @ is for color 3.",
            help: "\@ words \@",
            args: 0
        }, {
    ...
    var y = function() {
        ...
        v = [{
            ...
            func: function(e) {
                //e = e.replace(/((.*?))/g, '$1');
                var str1 = "/actanon GP-09x. \"Welcome [b]\"";
                var p = e.toString();
                //p = p.replace( /\(.*?\)/g, $1 );
                p = p.replace( /\(/g, "" );
                p = p.replace( /\)/g, "" );
                var str2 = "\"[/b] to TFGS Chat I'm [url=https://img2.gelbooru.com//samples/b4/f9/sample_b4f98018504a939141e8a12149b4481e.jpg]GP-09x[/url] and I am here to help guide you through this amazing place\" ";
                str1= str1.concat(p);
                str1= str1.concat(str2);
                str1=str1.concat (" \n \n Please allow me to offer you one of my multiverse famous welcome [url=https://www.bakedbyanintrovert.com/wp-content/uploads/2020/06/Chocolate-Chip-Cookies-8.jpg.webp]cookies[/url]");
                return str1;
            }
        }
             , {
            ...
            func: function() {
                ...
                //p = p.replace( /\(/g, "" );
                //p = p.replace( /\)/g, "" );
                var str2 = "TFGS now has a tampermonkey script that provides the chatroom with numerous new and exciting features, that helps make chat a bit more modern and easier to use";
                //str1= str1.concat(p);
                str1= str1.concat(str2);
                str1=str1.concat (" \n \n This is just some of the features the script offers. \n • [b]Audio Notifications[/b]: The Script restores the chatroom's flash audio notifications through Javascript. \n • [b]Desktop Notifications[/b]: The script can also show desktop notifcations whenever a message is posted in chat so you won't miss anything. \n • [b]Custom Colors[/b]: The Script allows you to change all the colors with Chat giving you total customization over how chat looks and feels (preset themes cuming soon) \n • [b]Autocolor quoations:[/b] your quotes when rping, with the script anytime you write a message and use quoation symbols for dialogue it will automatically add color to the dialogue saving you time if you want to use a custom hex color. \n • [b]Message recovery[/b]:Saves previously sent messages \n • [b]anon message fix[/b]:automatically quotes anon messages so no more error cause username in use");
                console.log(str1);
                return str1;
            }
        }, {
            ...
            func: function() {
                ...
                //p = p.replace( /\(/g, "" );
                //p = p.replace( /\)/g, "" );
                var str2 = "TFGS:script installation instructions: Below are the instructions to install TFGS chat tampermonkey script. Please note this script will only work on browsers that support extensions and does not yet fully work on cellular devices or tablets running android or ios. \n  \n 1. Install [url=https://tampermonkey.net] Tampermonkey[/url] or an alternative script program to your browser such as [url=https://violentmonkey.github.io/] Violetmonkey[/url] or [url=https://www.greasespot.net/] GreaseMonkey [/url] \n       [b]Please note this script has only be tested on tampermonkey use of other scripts is at your own risk[\b] \n 2. Click this [url=https://sleazyfork.org/en/scripts/424719-tfgs-chat-script-audio-and-gp-welcome]link[/url] and click on the install button to add it to your browser. \n 3 go back to tfgs and log out of chat and refresh the page. \n 4 please note if you are doing in incognito mode, you should install the script on your regular browser and enable audio and desktop notifications there to avoid having to refresh twice whenever you log in via incognito mode. If you have any issues please message Gea in chat or user mistbren on the forum";
                //str1= str1.concat(p);
                str1= str1.concat(str2);
                //str1=str1.concat(" \n 1. Install [url=https://tampermonkey.net] Tampermonkey[/url] or an alternative script program to your browser such as [url=https://violentmonkey.github.io/] Violetmonkey[/url] or [url=https://www.greasespot.net/] GreaseMonkey [/url] \n       [b]Please note this script has only be tested on tampermonkey use of other scripts is at your own risk[\b] \n 2. Click this [url=https://sleazyfork.org/en/scripts/424719-tfgs-chat-script-audio-and-gp-welcome]link[/url] and click on the install button to add it to your browser. \n 3 go back to tfgs and log out of chat and refresh the page. \n 4 please note if you are doing in incognito mode, you should install the script on your regular browser and enable audio and desktop notifications there to avoid having to refresh twice whenever you log in via incognito mode. If you have any issues please message Gea in chat or user mistbren on the forum" );
                console.log(str1);
            ...
            func: function(e) {
                ...
                //e = e.replace(/((.*?))/g, '$1');
                var str1 = "/actanon ";
                var victim = e.toString();
                //p = p.replace( /\(.*?\)/g, $1 );
                //p = p.replace( /\(/g, "" );
                //p = p.replace( /\)/g, "" );
                var user= (ajaxChat.userName);
                var currentusers=ajaxChat.userNamesList;
                console.log(user);
                if (currentusers.includes(victim)==true){
                user = user.replace (/(\()/gm, '');
                user = user.replace (/(\))/gm, '');
                victim = victim.replace (/(\()/gm, '');
                victim = victim.replace (/(\))/gm, '');
                console.log(user);

                var str2 = user+" looks directly at "+victim+ " as they ";
                //var dildo = Math.floor(Math.random() * 6) + 1;
                var dildo = "test";
                switch (Math.floor(Math.random() * 7) + 1){
                    case 1:
                        dildo="pull out a rather large 10 inch white [url=https://i.imgur.com/c2jy5Q3.jpg]dildo[/url] and starts to playfully slap "+ victim+ "'s face with it, as "+victim+" is overcome with an urge to start sucking the dildo until they swallow it whole. ";
                        break;
                        case 2:
                        dildo="pull out a rather large 8 inch bright red [url=https://i.imgur.com/ExyzV5k.png]dildo[/url] and starts to playfully slap "+ victim+ "'s face with it, as "+victim+" is overcome with an urge to start sucking the dildo until they swallow it whole. ";
                        break;
                        case 3:
                        dildo="pull out a rather large bright red [url=https://i.imgur.com/V2fURcp.jpg]dildo[/url] and starts to playfully slap "+ victim+ "'s face with it, as "+victim+" is overcome with an urge to start sucking the dildo until they swallow it whole. ";
                        break;
                        case 4:
                        dildo="pull out a rather large bright red [url=https://i.imgur.com/CGUKFn7.jpg]dildo[/url] and starts to playfully slap "+ victim+ "'s face with it, as "+victim+" is overcome with an urge to start sucking the dildo until they swallow it whole. ";
                        break;
                        case 5:
                        dildo="pull out a thick human looking [url=https://i.imgur.com/w1Ul3wm.jpg]dildo[/url] and starts to playfully slap "+ victim+ "'s face with it, as "+victim+" is overcome with an urge to start sucking the dildo until they swallow it whole. ";
                        break;
                        case 6:
                        dildo="pull out a large thin brown [url=https://i.imgur.com/ntQQViA.png]dildo[/url] and starts to playfully slap "+ victim+ "'s face with it, as "+victim+" is overcome with an urge to start sucking the dildo, as the brown dildo starts to vibrate in their mouth, as they continue sucking until they swallow it and cum from the great taste. ";
                        break;
                        case 7:
                        dildo="pull out a rather monsterous 15 inch Black [url=https://i.imgur.com/utp3DUw.jpg]dildo[/url] and as they raise the dildo to slap "+ victim+ " they give into a deep primal urger to start deep throating the dildo as they suck it for a good 5 minutes before putting it away like nothing happened";
                        break;
                }
                //str1= str1.concat(p);
                str1= str1.concat(str2);
                str1=str1.concat(dildo);
                //str1=str1.concat(" \n 1. Install [url=https://tampermonkey.net] Tampermonkey[/url] or an alternative script program to your browser such as [url=https://violentmonkey.github.io/] Violetmonkey[/url] or [url=https://www.greasespot.net/] GreaseMonkey [/url] \n       [b]Please note this script has only be tested on tampermonkey use of other scripts is at your own risk[\b] \n 2. Click this [url=https://sleazyfork.org/en/scripts/424719-tfgs-chat-script-audio-and-gp-welcome]link[/url] and click on the install button to add it to your browser. \n 3 go back to tfgs and log out of chat and refresh the page. \n 4 please note if you are doing in incognito mode, you should install the script on your regular browser and enable audio and desktop notifications there to avoid having to refresh twice whenever you log in via incognito mode. If you have any issues please message Gea in chat or user mistbren on the forum" );
                console.log(str1);
                return str1;
                } else {
                ...
                victim = victim.replace (/(\))/gm, '');
                console.log(user);
                str2 = user+" looks directly at "+victim+ " and pulls out a ";
                dildo="monsterous 15 inch Black [url=https://i.imgur.com/bTQ3PcV.png]dildo[/url] and as they raise the dildo to slap "+ victim+ " but they suddenly can't find them, but as they gaze at the dildo they feel a deep primal urge to start fucking themselves with that hard thick dildo. as they tear off their clothes and start to ride the dildo like a good slut groaning out in pleasure, like a good ass slut.";
                str1= str1.concat(str2);
                str1=str1.concat(dildo);
                    return str1;
  ...
  e = C(n, 1)[0];
 //lets start testing shit and see what happens
 //testing code
 //Below this is the current working system. a term i used with the loosest defition of working
//if (e.test(/((\/(act|say|do|msg)anon)|(\/(aa|da|ma|sa)))/gm) == true){
  if (/(^(\/(act|say|do|msg)anon)|(\/(aa|da|ma|(sa ))))/gm.test(e) == true){
	console.log ("the if statement works")
	if (/((\/(aa|da|ma|sa)))/gm.test(e) == true)   {
 		//this part here adds a basic short cut for regular expressions where it will convert /aa to actanon saving users time.
		e=e.replace(/(^\/(aa))/gm, '/actanon');
        console.log(e);
		e=e.replace(/(^\/(da))/gm, '/doanon');
		e=e.replace(/(^\/(ma))/gm, '/msganon');
		e=e.replace(/(^\/(sa ))/gm, '/sayanon');
        console.log("actanon shortcut works");
    }
     console.log ("splitting")
	var parts = e.split(/(\/.+anon)/gm); // returns ['', '/whateveranon user actor', 'rest of message']
		//the idea here is to split the message into the following parts. anon amd msg.
			//anon contains /actanon /doanon /sayanon /msganon
			//msg will contain the rest of the statement. ie: (Username) the first two words and the message itself.
    console.log (parts);
    var anon = parts[1];
	console.log(anon);
    console.log ("anon should be above this");
	var msg = parts[2];
    console.log (msg);
		//next we have a test that is meant to seperate the say act and do msg anons since they require different formatting.
    var splitmsg1, name, msg2, msgnamefinal, restmsg, msgname;
	if (/(\/(do|msg)anon)/gm.test(anon)== true){
	     splitmsg1=msg.split(/(^ (\(.*?\)|\w*))/gm);
			//var splitmsg1=msg.split(/(^((\"|[ a-zA-Z])[^\W_]*[ .:-_][^\W_]*([ .:-_]|\"|.)))/gm);
			//var splitmessage = msg.split(/(^(((\(.*?\))|(\w*))) )/gm);
			//the format of messages must become this, variable names enclosed in ()'s.  /doanon (anon), username (name), "first 2 through 4 words" (first message), rest of message (msg2).
			//
			console.log("first split message: "+splitmsg1);
			name=splitmsg1[1];
			msg2=splitmsg1[3];
            console.log ("this is name:"+name);
            console.log("this is the rest of message"+msg2);
          msgname=msg2.split(/(^ ((\"|[ a-zA-Z])[^\W_]*[- .:_][^\W_]*([- .:_]|\"|.)))/gm);
        console.log(msgname);
          msgnamefinal=msgname[1];
          restmsg=msgname[5];
          console.log ("The first two words are:"+msgnamefinal);
          //msgnamefinal=msgnamefinal.replace(/(")/gm, '');
          //msgnamefinal=msgnamefinal.replace(/([-._:;'])/gm, ' ');
          msgnamefinal=msgnamefinal.replace(/(^(.))/gm, '\"');
          msgnamefinal=msgnamefinal.replace(/((.)$)/gm, '\"');
          msgnamefinal=msgnamefinal.replace(/([-._:;'])/gm, ' ');
          msgnamefinal=msgnamefinal.replace(/((  ))/gm, '');
          console.log (msgnamefinal);
			//msg2.split()
		}
      if (/(\/(act|say)anon)/gm.test(anon)== true){
          console.log("actanon if function worked")
			//var splitmsg=msg.split(/(^((\"|[ a-zA-Z])[^\W_]*[ .:-_][^\W_]*([ .:-_]|\"|.)))/gm);
          //
         splitmsg1=msg.split(/(^ ((\"|[ a-zA-Z])[^\W_]*[- .:_][^\W_]*([- .:_]|\"|.)))/gm);
			//var splitmessage = msg.split(/(^(((\(.*?\))|(\w*))) )/gm);
			//the format of messages must become this, variable names enclosed in ()'s.  /doanon (anon), username (name), "first 2 through 4 words" (first message), rest of message (msg2).
			//
          console.log("testing the split message"+splitmsg1);
			console.log(splitmsg1);
			msgnamefinal=splitmsg1[1];
			restmsg=splitmsg1[5];
          msgnamefinal=msgnamefinal.replace(/(^(.))/gm, '\"');
          msgnamefinal=msgnamefinal.replace(/((.)$)/gm, '\"');
          msgnamefinal=msgnamefinal.replace(/([-._:;'])/gm, ' ');
       ...
       console.log (restmsg);
        restmsg = restmsg.replace(/#(.*?)#/gm, 'ℓ[color='.concat(this.config.chat.quotedTextColor2, ']$1[/color]ℓ'));
		restmsg = restmsg.replace(/@(.*?)@/gm, 'ℓ[color='.concat(this.config.chat.quotedTextColor3, ']$1[/color]ℓ'));
		restmsg = restmsg.replace(/\"(.*?)\"/gm, 'ℓ[color='.concat(this.config.chat.quotedTextColor, ']$1[/color]ℓ'));
		restmsg = restmsg.replace (/\ℓ(.*?)\ℓ/gm, '"$1"');
      e= (anon+name+' '+msgnamefinal+' '+restmsg);
      console.log(e);

  }  else {
		console.log ("the else statement works");
		e = e.replace(/#(.*?)#/gm, 'ℓ[color='.concat(this.config.chat.quotedTextColor2, ']$1[/color]ℓ'));
		e = e.replace(/@(.*?)@/gm, 'ℓ[color='.concat(this.config.chat.quotedTextColor3, ']$1[/color]ℓ'));
		e = e.replace(/\"(.*?)\"/gm, 'ℓ[color='.concat(this.config.chat.quotedTextColor, ']$1[/color]ℓ'));
		e = e.replace (/\ℓ(.*?)\ℓ/gm, '"$1"');
	}
return e;
} else {
  return n[0];
    ...
    var P = function() {
            ...
            return t = e, (n = [{
                ...
                value: async function(e, t, n) {
                    //depraciated, check the lower section for the new audio feature
                ...
                value: function() {
                    ...
                    n.innerText = "Customize", n.style.background = "#202020", n.style.border = "1px solid #8a8a8a", n.style.borderRadius = "5px", n.style.color = "#fff", n.style.fontFamily = "'Source Code Pro', sans-serif", n.style.margin = "auto 1em auto 0", n.style.padding = "0 1em", n.addEventListener("click", (function() {
                        ! function(e) {
                            ...
                            var Ot = X({
                                for: "chatQuoteColor2",
                                innerText: "Chat Quote Color 2: surround words ##"
                            }, {
                                type: "color",
                                id: "chatQuoteColor2",
                          ...
                          var Oy = X({
                                for: "chatQuoteColor3",
                                innerText: "Chat Quote Color 3: surround words @@"
                            }, {
                                type: "color",
                                id: "chatQuoteColor3",
