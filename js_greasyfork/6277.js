...
// @downloadURL https://update.greasyfork.org/scripts/6277/Multiple%20Windows%20Live%20IDs.user.js
// @updateURL https://update.greasyfork.org/scripts/6277/Multiple%20Windows%20Live%20IDs.meta.js
// ==/UserScript==
		...
		var profileString = GM_getValue("MWLID.profiles"),
			profiles = [
				{ name: "Account 1", mail: "test1@live.com", pass: "P@ssw0rd" },
				{
					...
					mail: "test2@live.com",
					pass: "P@ssw0rd",
					photo: "data:image/gif;base64,abcd",
				},
				{
					name: "Account 3",
					mail: "test3@live.com",
