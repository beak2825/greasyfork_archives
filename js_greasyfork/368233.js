...
// @version      0.1
// @description  A cleanup script for Talibri - use with quicker menu
// @author       Reznal
// @match        https://talibri.com/*
// @grant        none
// @require https://greasyfork.org/scripts/5392-waitforkeyelements/code/WaitForKeyElements.js?version=115012
// @downloadURL https://update.greasyfork.org/scripts/368233/Talibri%20Tab%20Cleanup.user.js
// @updateURL https://update.greasyfork.org/scripts/368233/Talibri%20Tab%20Cleanup.meta.js
// ==/UserScript==
...
function inventoryTabs(){
  ...
  quickMenu.setAttribute("id","quick-menu-tabs");

  let nav = `${quickMenu.outerHTML}
    <div class="panel">
...
function smithMasteryTabs(){
  let quickMenu = document.getElementById("quick-menu");
  let mainPage = document.getElementsByClassName("main-page")[0];
  let itemsPanel = mainPage.getElementsByClassName("row")[4];
  let componentsPanel = mainPage.getElementsByClassName("row")[5];
...
function tailorMasteryTabs(){
  let quickMenu = document.getElementById("quick-menu");
  let mainPage = document.getElementsByClassName("main-page")[0];
  let clothPanel = mainPage.getElementsByClassName("row")[4];
  let componentsPanel = mainPage.getElementsByClassName("row")[2];
...
waitForKeyElements("#quick-menu", checkPage);