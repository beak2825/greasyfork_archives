// ==UserScript==
// @name         Vertragssignature Angelika Schwabe
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/464902/Vertragssignature%20Angelika%20Schwabe.user.js
// @updateURL https://update.greasyfork.org/scripts/464902/Vertragssignature%20Angelika%20Schwabe.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "2600 0965 69" ){
            if (vorgemerkt == "no"){
            ...
            var xHTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 154,113.68 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Capital Invest Services PLC">Capital Invest Services PLC</a></h3><p>2023-04-21T13:11 Withdrawal Trading Account: AY01-503DE-SM</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">103.045</span><span aria-hidden="true" class="balance-decimal plus">,63&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';
