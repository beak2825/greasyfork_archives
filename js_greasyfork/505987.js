// ==UserScript==
// @name   🌱【免费版】绵阳公需课|如需自动下一集、自动换课程、秒过、自动答题等高级功能见收费版本：https://doc.zhanyc.cn/pages/mygxk/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、秒过、自动答题等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.mianyang.cn/*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/505987/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E7%BB%B5%E9%98%B3%E5%85%AC%E9%9C%80%E8%AF%BE%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E7%A7%92%E8%BF%87%E3%80%81%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesmygxk.user.js
// @updateURL https://update.greasyfork.org/scripts/505987/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E7%BB%B5%E9%98%B3%E5%85%AC%E9%9C%80%E8%AF%BE%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E7%A7%92%E8%BF%87%E3%80%81%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesmygxk.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、秒过、自动答题等高级功能，可点击下方按钮查看付费版本"
    ...
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/member/login.jhtml")) {
                plugMain.showPaidContent(`免费版本不包含全自动换学员账号功能，如需使用请安装收费版本`);
            } else if (/.*\/jxjy\/pc\/zxxx_.*\/index.jhtml.*/.test(url)) {
                plugMain.page_video();
            } else if (/.*\/jxjy\/pc\/ksz_.*\/index.jhtml.*/.test(url)) {
        ...
        async page_video() {
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    if ($(".overTitle:last").text() == '【已完成】') {
                        clearInterval(plugMain.pageData.video.index)
                        if ($(".exam_btns.formal:visible").length > 0) {
                            plugMain.showPaidContent(`免费版本不包含考试答题功能，如需使用请安装收费版本`);
                            return
                        }
                    }
                    ...
                    if ($("#jAlertParent:visible").length > 0) {
                        ...
                        if (plugMain.getElByText($("span.text"), '是否继续播放视频？') != null) {
                            $("#jAlertButton2").click()
                            plugMain.pageData.waitTime = 0
                            return
                        }
                        plugMain.confirmRun("检测到提示信息，3秒后刷新页面").then(a => {
                            location.reload()
                        })
                        return
                    }
