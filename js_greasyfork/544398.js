// ==UserScript==
// @name         Скрипт для Majora_Cullen
// @namespace    http://tampermonkey.net/
// @version      4.2
// @description  Скрипт для Majora_Cullen(написан администратором Maga_Zavodchikov)
// @author       AZARTY
// @match        https://forum.blackrussia.online/threads/*
// @icon         https://forum.blackrussia.online/threads/
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/544398/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20Majora_Cullen.user.js
// @updateURL https://update.greasyfork.org/scripts/544398/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20Majora_Cullen.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
    "[B][CENTER][COLOR=RED]С уважением куратора форума Major_Cullen<3.[/COLOR]<br>" +
    "[B][CENTER][COLOR=RED]Приятной игры на 82 сервере Vologda.[/COLOR]<br>",
      },
      {
                           ...
                           },
    {
	  ...
	  content:
		...
		"[B][CENTER][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
		"[B][CENTER][COLOR=RED] Ваша RP биографии составлен не по форме.<br>Отказано, закрыто.</br>"+
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
    "[B][CENTER][COLOR=RED]С уважением куратора форума Major_Cullen<3.[/COLOR]<br>" +
    "[B][CENTER][COLOR=RED]Приятной игры на 82 сервере Vologda.[/COLOR]<br>",
        prefix: UNACCСEPT_PREFIX,
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
    "[B][CENTER][COLOR=RED]С уважением Кукуратора форума Major_Cullen.[/COLOR]<br>" +
    "[B][CENTER][COLOR=RED]Приятной игры на 82 сервере Vologda.[/COLOR]<br>",
        prefix: ACCСEPT_PREFIX,
        status: false,
                 },
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
    "[B][CENTER][COLOR=RED]С уважением куратора форума Major_Cullen.[/COLOR]<br>" +
    "[B][CENTER][COLOR=RED]Приятной игры на 82 сервере Vologda.[/COLOR]<br>",
        prefix: ACCСEPT_PREFIX,
        status: false,
                 },
                 ...
                 },
    {
	  ...
	  content:
		...
		"[B][CENTER][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
		"[B][CENTER][COLOR=RED] Игрок будет наказан по пункту правил:<br> 1.11. Всем силовым структурам запрещен одиночный патруль или конвоирование, минимум 2 сотрудника | Jail 30 минут </br><br>[COLOR=#00BC00] Одобрено, закрыто.[/COLOR]</br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
        "[B][CENTER][COLOR=RED]С уважением куратора форума Major_Cullen<3.[/COLOR]<br>" +
    "[B][CENTER][COLOR=RED]Приятной игры на 82 сервере Vologda.[/COLOR]<br>",
                       prefix: ACCСEPT_PREFIX,
