...
// @grant        GM_setValue
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/515936/Greasy%20Fork%20Bookmark.user.js
// @updateURL https://update.greasyfork.org/scripts/515936/Greasy%20Fork%20Bookmark.meta.js
// ==/UserScript==
...
function scriptPage(){
    if(location.href.match('/scripts/') && $s(".script-meta-block")){
        ...
        li.addEventListener('click', e =>{
            ...
            // checkbox event
            $sa(".modal-body > ul > li").forEach(checkbox =>{
                checkbox.onclick = e =>{
        ...
        // If already bookmarked this script, li.innerText = '★';
        if(favScripts.findIndex(({ scriptTitle }) => scriptTitle === title) !== -1) li.innerHTML = `<a>★</a>`;
