// @name         Ultra mod (Best mod)
// @namespace    Ultra mod Best Mod 2021/2022 Modification by iC3Peak Credits FZ (Super Mod) | DarkWolf ( D4rK Mÿþhîçæł Mõđ ) | WAIT 4 IT ( pancake mod ), modified by Furiousflames
// @version      Ultra_V.16-(BeTa)
// @description  Controls ( End = Mod Menu|Home = Music Menu|Page Up = Police Hat|Page Down = Animal Hat|Num Lock 1 = Auto Hat|Num Lock 0 = 360Hit|Num Lock 2 = Auto Insta Kill|Num Lock 3 = Auto Aleatory Hat|Num Lock 5 = Auto WindMill
...
document.getElementById('desktopInstructions').innerHTML = '  By iC3PeaK and Furiousflames '
...
document.getElementById("leaderboard").append ('By iC3PeaK an Furiousflames');
