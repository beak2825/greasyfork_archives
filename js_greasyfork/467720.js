...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/467720/%E4%B9%90%E4%BA%AB.user.js
// @updateURL https://update.greasyfork.org/scripts/467720/%E4%B9%90%E4%BA%AB.meta.js
// ==/UserScript==
...
(function() {
    ...
    function TimeProcess() {
        ...
        //console.log(playBtn);
        if (playBtn.length > 0 && playBtn.css('display') != 'none') {
            console.log('点击播放.');
            //playBtn.click();
        ...
        if (muteBtn.length > 0 && muteBtn.css('display') != 'none') {
            ...
            if (title != '取消静音') {
                console.log('点击静音.');
                $("#video-player_html5_api").prop('muted', true);
            }
        }
