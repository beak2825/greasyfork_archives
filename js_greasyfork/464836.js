...
// @version           0.2
// @description      腾讯、爱奇艺、优酷、芒果、Bilibili、pptv、乐视等其它网站；
...
// @charset		      UTF-8
// @license           GPL License
// @downloadURL https://update.greasyfork.org/scripts/464836/VIP%E8%A7%86%E9%A2%91%E4%BF%AE%E6%94%B9%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/464836/VIP%E8%A7%86%E9%A2%91%E4%BF%AE%E6%94%B9%E7%89%88.meta.js
// ==/UserScript==
...
const superVip = (function () {
    ...
    const _CONFIG_ = {
        ...
        videoParseList: [
            {"name": "通道1", "type": "1,3", "url": "https://jx.jsonplayer.com/player/?url="},
            /*{"name": "通道2", "type": "1,3", "url": "https://jx.playerjy.com/?url="},*/
            {"name": "通道3", "type": "1,3", "url": "https://jx.xmflv.com/?url="},
            /*{"name": "通道4", "type": "1,3", "url": "https://jx.nnxv.cn/tv.php?url="},*/
            /*{"name": "通道5", "type": "1,3", "url": "https://jx.dj6u.com/?url="},*/
            /*{"name": "通道6", "type": "1,3", "url": "https://jx.rdhk.net/?v="},*/
            {"name": "通道7", "type": "1,3", "url": "https://api.okjx.cc:3389/jx.php?url="},
            {"name": "通道8", "type": "1,3", "url": "https://okjx.cc/?url="},
            {"name": "通道9", "type": "1,3", "url": "https://jx.aidouer.net/?url="},
            {"name": "通道10", "type": "1,3", "url": "https://jx.iztyy.com/Bei/?url="},
            {"name": "通道11", "type": "1,2", "url": "https://jx.yparse.com/index.php?url="},
            {"name": "通道12", "type": "1,3", "url": "https://www.yemu.xyz/?url="},
            {"name": "通道13", "type": "1,2", "url": "https://im1907.top/?jx="},
            {"name": "通道14", "type": "1,3", "url": "https://www.mtosz.com/m3u8.php?url="},
            {"name": "通道15", "type": "1,3", "url": "https://jx.m3u8.tv/jiexi/?url="},
            {"name": "通道16", "type": "1,3", "url": "https://parse.123mingren.com/?url="},
            {"name": "通道17", "type": "1,3", "url": "https://jx.4kdv.com/?url="},

            {"name": "通道18", "type": "1,3", "url": "https://ckmov.ccyjjd.com/ckmov/?url="},
            {"name": "通道19", "type": "1,3", "url": "https://www.8090g.cn/?url="},
            {"name": "通道20", "type": "1,3", "url": "https://api.qianqi.net/vip/?url="},
            {"name": "通道21", "type": "1,3", "url": "https://vip.laobandq.com/jiexi.php?url="},
            {"name": "通道22", "type": "1,3", "url": "https://www.playm3u8.cn/jiexi.php?url="},
            {"name": "通道23", "type": "1,3", "url": "https://www.administratorw.com/video.php?url="},
            {"name": "通道24", "type": "1,3", "url": "https://www.ckplayer.vip/jiexi/?url="},
            {"name": "通道25", "type": "1,3", "url": "https://go.yh0523.cn/y.cy?url="},
            {"name": "通道26", "type": "1,3", "url": "https://jx.blbo.cc:4433/?url="},
        ],
        playerContainers: [
            {
                host: "v.qq.com",
        ...
        generateElement(container) {
            ...
            $(container).append(`
                <div id="${_CONFIG_.vipBoxId}">
                    ...
                    <div class="img_box" id="vip_auto" style="color:white;font-size:16px;font-weight:bold;border-radius:5px;" title="是否打开自动解析。若自动解析失败，请手动选择其它通道尝试！！">${autoPlay}</div>
                </div>`);
            return new Promise((resolve, reject) => resolve(container));
        }
        ...
        autoPlay(container) {
            ...
            vipBox.find("#vip_auto").on("click", function () {
                if (!!GM_getValue(_CONFIG_.autoPlayerKey, null)) {
                    ...
                    $(this).html("关");
                    $(this).attr("title", "是否打开自动解析。若自动解析失败，请手动选择其它通道尝试！！");
                } else {
    ...
    return {
        start: () => {
            ...
            if (playerNode === null || playerNode.length <= 0) {
                console.warn(window.location.host + "如网站不支持，请联系作者，作者将会第一时间处理（注意：请记得提供有问题的网址）");
                return;
            }
