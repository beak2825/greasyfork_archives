...
// @version      3.1
// @description  Monitora a saúde e o humor no Popmundo. Útil para caçadas.
// @author       Popper
// @match        *://**/*
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/530503/Monitor%20Popmundo%2050%20%F0%9F%A4%93.user.js
// @updateURL https://update.greasyfork.org/scripts/530503/Monitor%20Popmundo%2050%20%F0%9F%A4%93.meta.js
// ==/UserScript==
...
(function() {
    ...
    let actionInProgress = false; // Controle para evitar ações simultâneas
    let loginNavigationComplete = false; // Controle para verificar se a navegação pós-login foi concluída
    let availableCharacters = []; // Lista de personagens disponíveis para seleção

    // Variáveis para login automático
    ...
    let selectedCharacterId = GM_getValue('selectedCharacterId', ''); // Novo: armazena o ID do personagem
    ...
    const ACTION_DELAY = 14000; // 14 segundos de delay entre ações
    ...
    function performAutoLogin() {
        ...
        setTimeout(() => {
            const usernameField = document.getElementById('ctl00_cphRightColumn_ucLogin_txtUsername');
            if (usernameField) {
                usernameField.value = username;
                addToStatusLog('👤 Campo de usuário preenchido');

                setTimeout(() => {
                    const passwordField = document.getElementById('ctl00_cphRightColumn_ucLogin_txtPassword');
                    if (passwordField) {
