...
// @match        http*://rarbg.to/s/*
// @match        http*://rarbg.to/top10*
// @match        http*://rarbgprx.org/torrents.php*
// @require      https://code.jquery.com/jquery-3.1.0.min.js
// @icon         https://rarbgprx.org/favicon.ico
// @namespace    https://greasyfork.org/pt-BR/scripts/373374-rarbg-big-previewer-2
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/373374/RARBGPreviewer.user.js
// @updateURL https://update.greasyfork.org/scripts/373374/RARBGPreviewer.meta.js
// ==/UserScript==
...
$('.lista a').each(function() {
    ...
    if (matches) {
        var img = '<img src="' + matches[1] + '" width="300">';
        $(this).prepend(img);
    }
});