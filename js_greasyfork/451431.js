// ==UserScript==
// @name         Grundos.cafe - RS Clock ONLY (AIO Sidebar)
...
// @downloadURL https://update.greasyfork.org/scripts/451431/Grundoscafe%20-%20RS%20Clock%20ONLY%20%28AIO%20Sidebar%29.user.js
// @updateURL https://update.greasyfork.org/scripts/451431/Grundoscafe%20-%20RS%20Clock%20ONLY%20%28AIO%20Sidebar%29.meta.js
// ==/UserScript==
/* globals $ */
...
let sound = localStorage.getItem('sound', "http://codeskulptor-demos.commondatastorage.googleapis.com/pang/pop.mp3");
  ...
  if (document.getElementById("userinfo")) {
    ...
    document.querySelector("#sb_edge").prepend(settingsButton);
    ...
    document.querySelector("#sb_edge").prepend(settingsButtonClose);
    ...
    document.querySelector("#sb_edge").prepend(settings_modal);
...
var timerContainer = document.createElement("div");
    ...
    document.querySelector("#aio_sidebar > .shops").append(timerContainer);
    timerContainer.innerHTML = "RS: 06:" + st;
    timerContainer.style = "position:absolute;background:" + clockbg + ";padding-top:1px;padding-bottom:2px;width:100px;font-size:12;color:" + clockfont + ";text-align:center;";
    }
}
...
var containerStyle1 = "margin:5px auto 10px;height:10px;border:1px solid;background:"
var containerStyle1b = ";border-color:"
var containerStyle2 = ";padding-top:2px;padding-bottom:2px;width:94px;font-size:10px;color:"
