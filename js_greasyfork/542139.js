// ==UserScript==
// @name         Технический Специалист GRAY 19 / Aqua 18
// @namespace    https://forum.blackrussia.online
// @version      1.0
// @description  для GRAY 19 /  Aqua 18
...
// @downloadURL https://update.greasyfork.org/scripts/542139/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9%20%D0%A1%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%20GRAY%2019%20%20Aqua%2018.user.js
// @updateURL https://update.greasyfork.org/scripts/542139/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9%20%D0%A1%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%20GRAY%2019%20%20Aqua%2018.meta.js
// ==/UserScript==
  ...
  const TRANSFER_PREFIXXXXXX = 24 ; //  префикс передачи в жб на тех
          const TRANSFER_PREFIXX18 = 25; //  префикс передачи админам
  const TRANSFER_PREFIXXX18 = 26; //  префикс передачи в обжалования
  const TRANSFER_PREFIXXXXX18 = 27; //  префикс передачи в жб на игроков
  const TRANSFER_PREFIXXXX18 = 28; //  префикс передачи в тех раздел
  const TRANSFER_PREFIXXXXXX18 = 29 ; //  префикс передачи в жб на тех
...
},
{
  ...
  dpstyle: 'oswald: 3px;     color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	...
	status: false,
        ...
        {
	title: 'В обжалование наказаний 19',
	color: '',
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
...
},
{
  ...
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIXXXXX, false));
          $('button#transfer').click(() => editThreadData(TRANSFER_PREFIXX18, false));
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIXXX18, false));
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIXXXX18, false));
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIXXXXXX18, false));
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIXXXXX18, false));
...
if(prefix == TRANSFER_PREFIXXXXXX) {
        ...
        if(prefix == TRANSFER_PREFIXXX) {
            ...
            if(prefix == TRANSFER_PREFIXX18) {
				moveThread(prefix, 842);
                       }
if(prefix == TRANSFER_PREFIXXXXX18) {
				moveThread(prefix, 844);
			}
if(prefix == TRANSFER_PREFIXXXXXX18) {
				moveThread(prefix, 1199);
			}

          if(prefix == TRANSFER_PREFIXXXX18) {
				moveThread(prefix, 815);
			}
        if(prefix == TRANSFER_PREFIXXX18) {
