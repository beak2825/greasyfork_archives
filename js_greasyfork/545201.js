// ==UserScript==
// @name        BlueSky Rename "Posts" to "Tweets"
// @description Ensures BlueSky is using the correct terminology by replacing all instances of "post" with "tweet".
...
// @author      4ns0n
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/545201/BlueSky%20Rename%20%22Posts%22%20to%20%22Tweets%22.user.js
// @updateURL https://update.greasyfork.org/scripts/545201/BlueSky%20Rename%20%22Posts%22%20to%20%22Tweets%22.meta.js
// ==/UserScript==
(function () {
    "use strict";
    ...
    const allReplacements = {
        en: [
            { pattern: /\bPost(s)?\b/g, replacement: "Tweet$1" },
            { pattern: /\b([Rr]e)?post(s|ed)?\b/g, replacement: "$1tweet$2" },
        ],
    };
