// ==UserScript==
// @name         KURSK | Forum Script для СтХ by L.King 
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/475837/KURSK%20%7C%20Forum%20Script%20%D0%B4%D0%BB%D1%8F%20%D0%A1%D1%82%D0%A5%20by%20LKing.user.js
// @updateURL https://update.greasyfork.org/scripts/475837/KURSK%20%7C%20Forum%20Script%20%D0%B4%D0%BB%D1%8F%20%D0%A1%D1%82%D0%A5%20by%20LKing.meta.js
// ==/UserScript==
    ...
    const buttons = [
        {
            ...
            content:
               `[CENTER] [CENTER][FONT=georgia][SIZE=4][COLOR=rgb(97, 189, 109)]Одобрено,[/COLOR] ждём вашего[COLOR=rgb(250, 197, 28)] [U]возвращения[/U]![/COLOR][/SIZE][/FONT]<br>`+
                `[FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR][color=red] Kursk.[/SIZE][/FONT][/CENTER]<br>`+
                `[SIZE=4][FONT=georgia][CENTER][COLOR=rgb(127, 255, 212)] Приятной игры и времяпровождение  на сервере[/color][color=red] Kursk (55)[/COLOR][/FONT][/SIZE][/CENTER]`,
        },
       {
            ...
            content:
               ...
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=red] Kursk.[/SIZE][/FONT][/CENTER]<br>`+
               `[SIZE=4][FONT=georgia][CENTER][COLOR=rgb(127, 255, 212)] Приятной игры и времяпровождение  на сервере[/color][color=red] Kursk (55)[/COLOR][/FONT][/SIZE][/CENTER]`,
        },
        {
