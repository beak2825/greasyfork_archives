// ==UserScript==
// @name         OGLight_mr
// @namespace    https://openuserjs.org/users/redmer
// @version      5.2.2
// @description  OGLight script for OGame -with litle modification about espionage probe count during attack
// @author       Oz
// @license      MIT
// @copyright    2019, Oz
...
// @downloadURL https://update.greasyfork.org/scripts/545833/OGLight_mr.user.js
// @updateURL https://update.greasyfork.org/scripts/545833/OGLight_mr.meta.js
// ==/UserScript==
...
class MessageManager extends Manager {
    ...
    addToSpyTable(message, wrapper) {
        if (!this.spytable.querySelector(`[data-id="${message.id}"]`)) {
            ...
            var bonusCargo = 1 + .042 * Math.ceil(delta / 36e5) + bonusFleetSpeed, messageDom = document.querySelector(`[data-msg-id="${message.id}"]`);
            bonusCargo = 1;
