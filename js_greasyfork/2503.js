...
// @downloadURL https://update.greasyfork.org/scripts/2503/Tumblr%20NotificationsNotes%20Enhancer.user.js
// @updateURL https://update.greasyfork.org/scripts/2503/Tumblr%20NotificationsNotes%20Enhancer.meta.js
// ==/UserScript==
...
RunInPage(function(){
	...
	function replyBtnClick(e) {
		...
		var urlparams = Tumblr.PostForms.parse_url_params($newtextpost.attr('href'));
	...
	AfterAutoPaginationQueue.push(appendButtons);
