...
// @version 1.0.7
// @description Reviving the felt theme for MxRP
// @author 0xEFF <dez@oxeff.xyz> (https://github.com/hecksadecimal)
// @license AGPL-3.0
// @grant GM_addStyle
// @run-at document-start
// @match https://mxrp.chat/bbcodeguide
// @include https://mxrp.chat*/*
// @downloadURL https://update.greasyfork.org/scripts/408890/MxRP%20Felt.user.js
// @updateURL https://update.greasyfork.org/scripts/408890/MxRP%20Felt.meta.js
// ==/UserScript==

(function() {
let css = "";
if (location.href === "https://mxrp.chat/bbcodeguide") {
  css += `
  body {
      background-color: #115203 !important;
      color: #25a40c !important; 
  }


  `;
}
if (location.href.startsWith("https://mxrp.chat")) {
		css += `
		/*
		...
		*/
		...
		#logo {background: transparent url('https://mxrp.chat/static/img/logo-felt.png') no-repeat scroll 0px bottom; background-size:contain; max-width:100%;image-rendering: auto; -ms-interpolation-mode: auto;}
		...
		#prompt-cursor {background: transparent url('https://mxrp.chat/static/img/cursor-felt.png') no-repeat scroll 0px bottom; image-rendering: -moz-crisp-edges; -ms-interpolation-mode: nearest-neighbor; image-rendering: -webkit-optimize-contrast; image-rendering: pixelated;}

		/* Wrapper */
		#wrapper { background: #082900 url('https://mxrp.chat/static/img/felt_manor_background.png') no-repeat bottom right; background-attachment: fixed;}
		...
		@media (max-width: 650px) { 
			...
			#fixed-bg {position:fixed;top:0px;bottom:0px;right:0px;left:0px;background: #082900 url('https://mxrp.chat/static/img/felt_manor_background.png') no-repeat bottom center; background-size:900px;transform: translateZ(0);will-change:scroll-position;pointer-events: none;}
		...
		#spinner_image {background:url('https://mxrp.chat/static/img/8_ball_big.gif'); background-size:140px 140px;width:140px;height:140px}
		...
		#chat_wrapper { background: #082900 url('https://mxrp.chat/static/img/felt_manor_background.png') no-repeat bottom right; background-attachment: fixed;}
		...
		body:not(.disable_left_bar) #chat_logo {top:13px;left:20px; background: transparent url('https://mxrp.chat/static/img/logo-felt.png') no-repeat scroll 0px bottom; background-size:cover; width:150px;height:54px; background-size:150px 54px;image-rendering: auto; -ms-interpolation-mode: auto;}
		...
		#activity_spinner {width:35px;height:40px;float:left;background-image:url('https://mxrp.chat/static/img/8_ball_off.gif'); background-repeat:no-repeat; background-position:0px 5px; background-size:30px 30px;position:absolute;bottom:7px}
		#send_form:not(.disable_activity_indicator) #activity_spinner.active_sb {background-image:url('https://mxrp.chat/static/img/8_ball_bg.gif');}
		#send_form:not(.disable_activity_indicator) #activity_spinner.active_self {background-image:url('https://mxrp.chat/static/img/8_ball.gif');}
		...
		body.disable_left_bar #chat_logo {display:block;left:auto;right:90px; top:10px; background: transparent url('https://mxrp.chat/static/img/logo-felt.png') no-repeat scroll 0px bottom; background-size:cover; width:150px;height:54px; background-size:150px 54px;image-rendering: auto; -ms-interpolation-mode: auto;}
		...
		@media (-webkit-min-device-pixel-ratio: 1.1), (min-device-pixel-ratio: 1.1), (min-resolution: 100dpi) {
			#activity_spinner {background-image:url('https://mxrp.chat/static/img/8_ball_off.gif');}
			#send_form:not(.disable_activity_indicator) #activity_spinner.active_sb {background-image:url('https://mxrp.chat/static/img/8_ball_bg.gif');}
			#send_form:not(.disable_activity_indicator) #activity_spinner.active_self {background-image:url('https://mxrp.chat/static/img/8_ball.gif');}
			#spinner_image {background:url('https://mxrp.chat/static/img/8_ball_big.gif'); background-size:140px 140px;}
		}
