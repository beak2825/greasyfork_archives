...
// @grant        none
// @require      https://greasyfork.org/scripts/375096-bs-library/code/BS_Library.js?version=755975
// @downloadURL https://update.greasyfork.org/scripts/368765/BS%20Notification.user.js
// @updateURL https://update.greasyfork.org/scripts/368765/BS%20Notification.meta.js
// ==/UserScript==
// jshint esversion: 6
const BS = window.BS;
...
(() => {
    ...
    setTimeout(()=>{
        ...
        sB.oninput=(a,b,c)=>{
            let usercontainer=BS.Module.Get('#sbUser > ul').children;
            let onlineNames=[];
            ...
            let active=BS.Module.Get('#sbPosts').children;
