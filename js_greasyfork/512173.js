...
// @grant           none
// @downloadURL https://update.greasyfork.org/scripts/512173/Undiscord%20Remade.user.js
// @updateURL https://update.greasyfork.org/scripts/512173/Undiscord%20Remade.meta.js
// ==/UserScript==
(function() {
    ...
    <div class="window-body" style="display: flex; flex-direction: row;">
        ...
        <div class="main col">
            ...
            <pre id="logArea" class="logarea scroll">
                ...
                <center>
                    <div>---</div>
                    <div style="font-size: smaller;">Build Version 127</div>
                    <div>---</div>
                </center>
            </pre>
