// ==UserScript==
// @name         职培考试高速自动答题系统模拟已考10分钟，保持时间限制
// @namespace    http://tampermonkey.net/
// @version      10.1
// @description  高速自动填写所有题型，确保选择和提交成功，屏幕居中控制面板，模拟已考10分钟，保持时间限制
// @author       You
// @match        *://*/*
// @run-at       document-start
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/531662/%E8%81%8C%E5%9F%B9%E8%80%83%E8%AF%95%E9%AB%98%E9%80%9F%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E7%B3%BB%E7%BB%9F%E6%A8%A1%E6%8B%9F%E5%B7%B2%E8%80%8310%E5%88%86%E9%92%9F%EF%BC%8C%E4%BF%9D%E6%8C%81%E6%97%B6%E9%97%B4%E9%99%90%E5%88%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/531662/%E8%81%8C%E5%9F%B9%E8%80%83%E8%AF%95%E9%AB%98%E9%80%9F%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E7%B3%BB%E7%BB%9F%E6%A8%A1%E6%8B%9F%E5%B7%B2%E8%80%8310%E5%88%86%E9%92%9F%EF%BC%8C%E4%BF%9D%E6%8C%81%E6%97%B6%E9%97%B4%E9%99%90%E5%88%B6.meta.js
// ==/UserScript==
...
(function () {
    ...
    function getVueInstance() {
        ...
        if (vueInstance && !window.timeAdjusted) {
            try {
                // 只修改开始时间，让系统认为已经考了10分钟
                const tenMinutesInMs = 10 * 60 * 1000; // 10分钟的毫秒数
                if (vueInstance.clockStart) {
                    // 保存原始finishTimes值
                    const originalFinishTimes = vueInstance.finishTimes;
                    ...
                    console.log('[自动答题] 最低考试时间限制为：', originalFinishTimes, '分钟');
                    
                    if (originalFinishTimes > 0) {
                        const remainingTime = Math.max(0, originalFinishTimes - 10);
                        if (remainingTime > 0) {
                            showToast(`已模拟考试10分钟，还需等待${remainingTime}分钟才能交卷`, 3000);
                        } else {
                            showToast('已模拟考试10分钟，已满足最低考试时长', 3000);
                        }
                    } else {
                        showToast('已模拟考试10分钟', 3000);
                    }
                }
