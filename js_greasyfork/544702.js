// ==UserScript==
// @name         BLACK | Скрипт Для Кураторов Форума Z.litvinenko
// @namespace    https://forum.blackrussia.online
// @version      3.0
// @description  Для Кураторов Форума - BLACK RUSSIA | BLACK
// @author       Z.Litvinenko
...
// @downloadURL https://update.greasyfork.org/scripts/544702/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Zlitvinenko.user.js
// @updateURL https://update.greasyfork.org/scripts/544702/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Zlitvinenko.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]К нарушителю будут применены меры в соответствии со следующим пунктом общих правил проекта:[/I][/FONT][/SIZE]<br>" +
    "[FONT=georgia][QUOTE][COLOR=rgb(255,0,0)][SIZE=4]2.50.[/COLOR][/SIZE][/FONT][FONT=georgia][COLOR=rgb(209,213,216)][SIZE=4]Запрещены задержания, аресты, а также любые действия со стороны игроков, состоящих во фракциях в интерьере аукциона, казино, а также во время системных мероприятий[COLOR=rgb(255,0,0)] | Ban 7 - 15 дней + увольнение из организации[/QUOTE][/COLOR][/SIZE][/FONT]" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[FONT=georgia][SIZE=4][COLOR=#00FF00][I]Одобрено, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
       prefix: ACCEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      {
        title: '| Отказ слив склада |',
      content:
    "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[CENTER][FONT=georgia][SIZE=4][I][COLOR=rgb(192, 192, 192)]В описании семьи должны быть указаны условия взаимодействия со складом. Если лидер семьи предоставил неограниченный доступ к складу и забыл снять его, администрация не несет ответственности за возможные последствия. Жалобы по данному пункту правил принимаются только от лидера семьи.[/COLOR][/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[CENTER][FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Примечание:[/I][/COLOR][COLOR=rgb(209, 213, 216)] Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/COLOR][/SIZE][/FONT][/CENTER]<br>" +
    "[CENTER][IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG][/CENTER]<br>"+
    ...
    "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[CENTER][FONT=georgia][SIZE=4][I][COLOR=rgb(192, 192, 192)]В данный момент ваша жалоба отказана, создайте новую жалобу и прикрепите ссылку на форумный аккаунт игрока.[/COLOR][/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[CENTER][FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Примечание:[/I][/COLOR][COLOR=rgb(209, 213, 216)] Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/COLOR][/SIZE][/FONT][/CENTER]<br>" +
    "[CENTER][IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG][/CENTER]<br>"+
    "[CENTER][FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
