...
// @downloadURL https://update.greasyfork.org/scripts/15353/WME%20Validator%20Localization%20for%20Hawaii.user.js
// @updateURL https://update.greasyfork.org/scripts/15353/WME%20Validator%20Localization%20for%20Hawaii.meta.js
// ==/UserScript==
//
/*
...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named SR-### in Hawaii",
    "solutionEN": "Change name to SR-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Hawaii:.*\\b(?:State (Hwy|R(ou)?te)|SH-)\\b/i"
  },
  ...
  "134.params": {
    ...
    "regexp": "/[0-9]+[A-Z]? ([Aa]lt(ernate)?|[Bb](us(iness)?|yp(ass)?)|[Cc]onn(ector)?|[Ll]oop|[Ss]pur|[Tt]ruck)\\b/"
  },
