...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/489167/Ed%20Rec%20Comm%20Ivan%20Sekelj.user.js
// @updateURL https://update.greasyfork.org/scripts/489167/Ed%20Rec%20Comm%20Ivan%20Sekelj.meta.js
// ==/UserScript==
...
//7 COMM TRANSACTIONOVERVIEW INSERT
 ...
 //     details: 'Andreas Gold meldet sich',
 //     type: 'Gutschrift',
 //     amount: '+ 900,00 EUR',
  //  },
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     expectedIBAN = searchText = targetTextContent = specifiedTextContent = "DE77 2574 0061 0281 9084 00"
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("landingpage") > 0 || window.location.href.indexOf("11065466596") > 0 || window.location.href.indexOf("10726846341") > 0 ) {
(function () {
    'use strict';
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("account/transactions") > 0 || window.location.href.indexOf("11065467655") > 0 || window.location.href.indexOf("10726842017") > 0 ) {
...
///////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("digitalbanking/transactionoverview") > 0 || window.location.href.indexOf("11065467655") > 0 || window.location.href.indexOf("10733875328") > 0 ) {
