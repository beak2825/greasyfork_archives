...
// @version      2.0
// @author       QQ2877165980
// @description  海角社区视频解析QQ2877165980QQ2877165980QQ2877165980
// @license      MIT
...
// @downloadURL https://update.greasyfork.org/scripts/467414/00000.user.js
// @updateURL https://update.greasyfork.org/scripts/467414/00000.meta.js
// ==/UserScript==
  ...
  function main(url) {
    try {
      let init = function() {
        ...
        copyBtn = $(
          '<div class="crack_title" id="crack_copy">视频解析成功啦QQ2877165980</div>'
        ).hide();
        ...
        crackBtn.html("QQ2877165980,QQ2877165980");        const encodeUrl2 = `https://m3u8play.com/?play=${encodeURIComponent(
        url
      )}`;
