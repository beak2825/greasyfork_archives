...
// @match      https://forum.blackrussia.online/threads/
 ...
 // @icon
// @downloadURL https://update.greasyfork.org/scripts/513740/KF_100.user.js
// @updateURL https://update.greasyfork.org/scripts/513740/KF_100.meta.js
// ==/UserScript==
(function () {
  'use strict';
     ...
     },
{
     ...
     },
  {
     ...
     },
     {
       ...
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
         "🍃 Причина: Отсутствие личного фото 🍃 [/CENTER][/FONT]",
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
     {
     ...
     },
  {
     ...
     },
     {
      ...
      {
 		title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ                                ᅠ⠀             ⠀ ⠀⠀ᅠ ᅠᅠРП ситуэйшнᅠᅠ ᅠᅠ          ⠀        ⠀    ⠀      ⠀ᅠ     ᅠ ᅠ     ᅠ ᅠ ᅠ ',
         dpstyle: 'oswald: 3px;     color: #FFD700; background: #181513; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 1px solid #FFD700; width: 96%',
},
          {
       title: 'Ошиблись разделом',
     ...
     },
  {
      ...
      prefix: UNACCEPT_PREFIX,
       ...
       status: false,
          ...
          {
 		title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ                                ᅠ⠀             ⠀ ⠀⠀ᅠ ᅠᅠорганизации ᅠᅠ          ⠀        ⠀    ⠀      ⠀ᅠ     ᅠ ᅠ     ᅠ ᅠ ᅠ ',
         dpstyle: 'oswald: 3px;     color: #FFD700; background: #181513; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 1px solid #FFD700; width: 96%',
},
              {
       title: 'Ошиблись разделом',
