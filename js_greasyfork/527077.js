...
// @version      1.0.7
// @description  TwitterからMisskeyに投稿できる拡張機能です！
// @author       AranoYuki
// @match        https://x.com/*
...
// @sandbox      DOM
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/527077/Misstter.user.js
// @updateURL https://update.greasyfork.org/scripts/527077/Misstter.meta.js
// ==/UserScript==
...
/**
 * content_script/Clients/twitter.tsx
 */
...
const foundTweetButtonHandler = tweetButton => {
  ...
  const tweetBox = tweetButton.parentElement
  if (tweetBox) {
...
const foundAttachmentsImageHandler = attachmentsImage => {
  ...
  const editButton = attachmentsImage.querySelector(editButtonSelector)
