// ==UserScript==
// @name         [CHILLI] | Курация администрации
...
// @downloadURL https://update.greasyfork.org/scripts/485331/%5BCHILLI%5D%20%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%86%D0%B8%D1%8F%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8.user.js
// @updateURL https://update.greasyfork.org/scripts/485331/%5BCHILLI%5D%20%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%86%D0%B8%D1%8F%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8.meta.js
// ==/UserScript==
...
const buttons = [
	...
	},
    {
      title: 'NonRP обман (2)',
      content:
        '[CENTER][FONT=georgia][SIZE=4][COLOR=rgb(255, 0, 0)]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/COLOR]<br><br>' +
        "[COLOR=rgb(255, 255, 255)][SIZE=4]Обжалование в вашу пользу должен писать игрок, которого вы обманули.[/COLOR]<br>" +
        "[COLOR=rgb(255, 255, 255)]В доказательствах должны иметься: окно блокировки вашего аккаунта, переписка с обманутым игроком, где вы решили на какую компенсацию он согласен и ваше сообщение, в котором вы признаете совершенную ошибку и впредь обязуетесь не повторять ее.[/COLOR]<br>" +
        "[COLOR=rgb(255, 255, 255)]После всего этого главная администрация рассмотрит обжалование, но это не гарантирует того, что вас обжалуют.[/SIZE][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4]Закрыто.[/COLOR][/SIZE][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
	  ...
	  content:
		"[CENTER][FONT=georgia][SIZE=4][COLOR=RED]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/SIZE][/CENTER]<br><br>"+
		"[CENTER][SIZE=4][COLOR=white] Проверив доказательства администратора, было принято решение, что наказание выдано верно.[/SIZE]<br><br>"+
		'[CENTER][COLOR=RED][SIZE=4]Закрыто.[/COLOR][/SIZE][/FONT][/CENTER]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
		"[B][CENTER][SIZE=4][FONT=georgia][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/SIZE][/CENTER][/B]<br><br>"+
		"[B][CENTER][SIZE=4][COLOR=WHITE] Ваша жалоба взята на рассмотрение, пожалуйста ожидайте ответа.[/SIZE]<br>"+
        "[B][CENTER][SIZE=4][COLOR=WHITE] Напоминаю, за дублирование тем ваш Форумный Аккаунт может заблокирован на 3 и более дней.[/SIZE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][SIZE=4][COLOR=orange]На рассмотрении.[/COLOR][/FONT][/SIZE]<br><br>",
	  prefix: PIN_PREFIX,
	  status: true,
    },
   {
      title: 'Не по теме',
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(255, 255, 255)][FONT=georgia][SIZE=4]Ваше сообщение никоим образом не относится к предназначению данного раздела.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]Закрыто.[/SIZE][/FONT][/COLOR][/CENTER]<br>',
      prefix: CLOSE_PREFIX,
      status: false,
    },
   {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=georgia][COLOR=rgb(255, 255, 255)]Ваша жалоба составлена не по форме.[/COLOR]<br>" +
        "[COLOR=rgb(255, 255, 255)]Внимательно прочитайте правила составления жалоб.[/COLOR][/FONT][/SIZE]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]Закрыто.[/SIZE][/FONT][/COLOR][/CENTER]<br>',
      prefix: CLOSE_PREFIX,
      status: false,
    },
	{
      ...
      content:
        '[CENTER][FONT=georgia][FONT=times new roman][COLOR=rgb(255, 3, 3)][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}[/SIZE][/COLOR][/FONT]<br><br>' +
        "[COLOR=rgb(255, 255, 255)][SIZE=4][FONT=times new roman]Ваше наказание будет снято / снижено в ближайшее время.[/FONT][/SIZE]<br>" +
        "[FONT=georgia][COLOR=rgb(255, 255, 255)][SIZE=4]Пожалуйста, впредь не повторяйте ошибок, которые могут привести к таким последствиям, а также внимательно изучите общие правила серверов - [URL='https://forum.blackrussia.online/index.php?threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%BE%D0%B2.312571/']*Нажмите сюда*[/URL].[/SIZE][/COLOR][/FONT]<br><br>" +
        "[COLOR=rgb(255, 255, 255)][SIZE=4][FONT=georgia]Обжалование одобрено.[/FONT][/SIZE]<br><br>" +
        '[FONT=georgia][COLOR=rgb(255, 3, 3)][SIZE=4]Закрыто.[/SIZE][/COLOR][/FONT][/COLOR][/CENTER]',
	      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[CENTER][FONT=georgia][COLOR=rgb(255, 3, 3)][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}[/SIZE][/COLOR][/FONT]<br><br>' +
        "[COLOR=rgb(255, 255, 255)][SIZE=4][FONT=georgia]Администрация не готова сократить или снять вам наказание.[/FONT][/SIZE]<br>" +
        "[SIZE=4][FONT=georgia]В обжаловании отказано.[/FONT][/SIZE][/COLOR]<br><br>" +
        "[FONT=georgia][COLOR=rgb(255, 255, 255)][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/COLOR][/FONT]<br><br>" +
        '[FONT=georgia][COLOR=rgb(255, 3, 3)][SIZE=4]Закрыто.[/SIZE][/FONT][/COLOR]<br>',
      prefix: CLOSE_PREFIX,
      status: false,
    },
     {
      ...
      content:
        '[CENTER][FONT=georgia][SIZE=4][COLOR=rgb(255, 0, 0)]{{ greeting }}, уважаемый {{ user.mention }}[/COLOR][/SIZE][/FONT]<br><br>' +
        "[COLOR=rgb(209, 255, 255)][FONT=georgia][SIZE=4]Ваше обжалование переадресовано[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Главному Администратору[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=georgia][SIZE=4].[/SIZE][/FONT][/COLOR]<br>" +
        '[FONT=georgia][SIZE=4][COLOR=rgb(209, 255, 255)]Ожидайте ответа в данной теме, копии создавать не нужно.[/COLOR][/SIZE][/FONT][/CENTER]<br><br>' +
        '[CENTER][FONT=georgia][COLOR=rgb(255, 150, 3)]На рассмотрении[/FONT][/COLOR].[/CENTER]',
      prefix: GA_PREFIX,
      status: false,
    },
	{
...

{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как ваши доказательства не открываются. <br><br>"+
                ...
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=crimson]CHILLI[/COLOR].<br><br>"+
...
status: false,
},
    {
      ...
      content:
        ...
        '[FONT=georgia][SIZE=4][I][COLOR=rgb(209, 213, 216)]Ожидайте ответа в данной теме, копии создавать не нужно.[/COLOR][/I][/SIZE][/FONT][/CENTER]<br>' +
        '[CENTER][COLOR=rgb(250, 197, 28)]На рассмотрении[/COLOR].[/CENTER]',
      prefix: GA_PREFIX,
      status: false,
    },
    {
...
$(document).ready(() => {
	...
	addButton('NonRP обман (2)', 'accepted');
	addButton('Наказание верное', 'verno');
    addButton('На рассмотрение', 'pin');
	addButton('Не по теме', 'tema');
	addButton('Не по форме', 'forma');
	addButton('Обжалование одобрено', 'odobreno');
	addButton(`Обжалование отказано`, `otkazano`);
    addButton ('Обжалование передано ГА', 'oga');
	...
	$(`button#rodni`).click(() => pasteContent(0, threadData, true));
    $(`button#accepted`).click(() => pasteContent(1, threadData, true));
    $(`button#verno`).click(() => pasteContent(2, threadData, true));
    $(`button#pin`).click(() => pasteContent(3, threadData, true));
    $(`button#tema`).click(() => pasteContent(4, threadData, true));
    $(`button#forma`).click(() => pasteContent(5, threadData, true));
    $(`button#odobreno`).click(() => pasteContent(6, threadData, true));
    $(`button#otkazano`).click(() => pasteContent(7, threadData, true));
    $(`button#oga`).click(() => pasteContent(8, threadData, true));
