// ==UserScript==
// @name          Black Russia | Скрипт для КФ | Upd 10.25
...
// @grant         none
// @license       none
// @downloadURL https://update.greasyfork.org/scripts/468119/Black%20Russia%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%20Upd%201025.user.js
// @updateURL https://update.greasyfork.org/scripts/468119/Black%20Russia%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%20Upd%201025.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к заголовок оформлен неверно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.1, Заголовок RP биографии должен быть составлен по следующей форме: Биография | Nick_Name.[/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        ...
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она оформлена неверно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.2, Биография должна быть составлена реалистично — ваш персонаж не может обладать сверхспособностями.[/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title : 'био сущ. человека' ,
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она составлена неверно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.3, Запрещено составлять биографию существующих людей. Пример: биография Бреда Питта, Аль Капоне и т. д. [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.4, Запрещено копировать чужие RP биографии. [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к у у вас содержатся грамматические или орфографические ошибки. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.5, Биография должна быть читабельна и не содержать грамматических или орфографических ошибок. [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к ваша биография оформлена неверным шрифтом. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.6, Шрифт биографии должен быть Times New Roman либо Verdana, минимальный размер — 15.[/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title : 'отсутствие фото' ,
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к отсутствуют фото и иные материалы. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.7, В биографии должны присутствовать фотографии и иные материалы, относящиеся к истории вашего персонажа.[/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title : 'факт наруш. правила серва' ,
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она составлена неверно.[/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.8, Запрещено включать в биографию факторы, позволяющие нарушать правила сервера. [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title : 'обьем биографии' ,
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она составлена неверно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.9, Минимальный объём RP биографии — 200 слов, максимальный — 600. [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к в вашей биографии присутствуют логические противоречия. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Согласно п.п правил 1.10, В биографии не должно быть логических противоречий. [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Пример: в пункте «Возраст» вы указываете, что вам 16 лет, а дальше описываете, что окончили университет, открыли свой бизнес и зарабатываете миллионы рублей.[/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false, 
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]В вашей RolePlay - биографии есть недочеты.<br><br>" +
            "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Даю вам 24 часа на ее дополнение.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Внимательно прочитайте правила создания RP - биографий закрепленные [URL='https://forum.blackrussia.online/threads/Правила-составления-rp-биографии.13425782/']в данном разделе. [/URL][/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
            prefix: PIN_PREFIX,
            status: true,
