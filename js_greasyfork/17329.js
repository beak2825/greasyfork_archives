...
// @downloadURL https://update.greasyfork.org/scripts/17329/AgarioUserFilter.user.js
// @updateURL https://update.greasyfork.org/scripts/17329/AgarioUserFilter.meta.js
// ==/UserScript==
...
window.launch = function() {
    ...
    var specialusers = ['TAGS']; // use a comma seperated list ['item1', 'item2', 'item3']. if any name contains any of the items in this list, it will be highlighted yellow
    var enemies = ['OTHERS']; // for red highlight
