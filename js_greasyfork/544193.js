// ==UserScript==
// @name         Ed Start 4Rec sp.markus.mutz@t-online.de
...
// @downloadURL https://update.greasyfork.org/scripts/544193/Ed%20Start%204Rec%20spmarkusmutz%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/544193/Ed%20Start%204Rec%20spmarkusmutz%40t-onlinede.meta.js
// ==/UserScript==


//FINÜBERSICHT
    const BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: 193000 },
        { index: 1, adjustmentAmount: 193000 },
   //     { index: 2, adjustmentAmount: 0 },
        { index: 6, adjustmentAmount: 0 },
        { index: 7, adjustmentAmount: 193000 },
...
// UMSATZE & KONTODETAILS BALANCE
  const IBAN_CHECK_RAW = 'DE98 6805 0101 0011 2511 54';      //
   ...
   const DELTA_EUR = 193000; // ← change this value
...
//=============================================================================================================================
//=============================================================================================================================
// KONTODETAILS BALANCE NEW FROM 15.12
