...
// @downloadURL https://update.greasyfork.org/scripts/471704/%E3%80%90TT%E5%8A%A9%E6%89%8B%E3%80%91%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E5%B7%A5%E5%85%B7%E7%AE%B1%E7%9B%B4%E9%93%BE%E8%A7%A3%E6%9E%90%20%E2%80%94%E2%80%94%E6%8C%81%E7%BB%AD%E6%9B%B4%E6%96%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/471704/%E3%80%90TT%E5%8A%A9%E6%89%8B%E3%80%91%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E5%B7%A5%E5%85%B7%E7%AE%B1%E7%9B%B4%E9%93%BE%E8%A7%A3%E6%9E%90%20%E2%80%94%E2%80%94%E6%8C%81%E7%BB%AD%E6%9B%B4%E6%96%B0.meta.js
            // ==/UserScript==
            ...
            , function(module, exports, __webpack_require__) {
                ...
                function modulesToDom(list, options) {
                    for (var idCountMap = {}, identifiers = [], i = 0; i < list.length; i++) {
                        ...
                        -1 !== index ? (stylesInDom[index].references++,
                        stylesInDom[index].updater(obj)) : stylesInDom.push({
            ...
            , function(module, exports, __webpack_require__) {
                ...
                var AppBase_1 = __webpack_require__(17)
                  , SiteEnum_1 = __webpack_require__(6)
                  , Ele_1 = __webpack_require__(19)
                  , EventEnum_1 = __webpack_require__(8)
                  , BaiDuPanFile_1 = __webpack_require__(20)
                  , Alert_1 = __webpack_require__(21)
                  , Logger_1 = __webpack_require__(0)
                  , PanInfo_1 = __webpack_require__(25)
                  , BaiduRoutes_1 = __webpack_require__(26)
                  , Common_1 = __webpack_require__(11)
                  , Config_1 = __webpack_require__(12)
                  , clipboard_1 = __importDefault(__webpack_require__(27))
                  , Core_1 = __webpack_require__(7)
                  , PanRes_1 = __webpack_require__(28)
                  , AriaConfig_1 = __webpack_require__(29)
                  , Http_1 = __webpack_require__(10)
                  , mdui_1 = __importDefault(__webpack_require__(30))
                  , BaiDuPanParse = function(_super) {
                    function BaiDuPanParse() {
                        var _this = null !== _super && _super.apply(this, arguments) || this;
                        return _this.appName = "网盘解析",
                        _this.rules = new Map([[SiteEnum_1.SiteEnum.BD_DETAIL_OLD, /[pan|yun].baidu.com\/disk\/home/i], [SiteEnum_1.SiteEnum.BD_DETAIL_Share, /[pan|yun].baidu.com\/s\//i], [SiteEnum_1.SiteEnum.BD_DETAIL_NEW, /[pan|yun].baidu.com\/disk\/main/i]]),
                        _this.homeProcess = {
                            selector: ".tcuLAu",
                    ...
                    return __extends(BaiDuPanParse, _super),
                    BaiDuPanParse.prototype.loader = function() {
                        Core_1.Core.addStyleUrl("//lib.baomitu.com/mdui/1.0.2/css/mdui.min.css");
                    }
                    ,
                    BaiDuPanParse.prototype.run = function() {
                        switch (BaiDuPanParse._site = this.site,
                        this.site) {
                    ...
                    BaiDuPanParse.getMainBtn = function() {
                        ...
                        return btnEle.setAttribute("style", "margin-right:8px"),
                        btnEle;
                    }
                    ,
                    BaiDuPanParse.initDownFileNew = function() {
                        ...
                        null != fileList && 0 != (null == fileList ? void 0 : fileList.length) ? BaiDuPanParse.isMultipleFile(fileList) && BaiDuPanParse.isDirFile(fileList) ? Alert_1.Alert.info("暂不支持文件夹解析!", 3, "error") : (null == fileList ? void 0 : fileList.length) > 1 ? Alert_1.Alert.info("暂不支持多文件解析", 3, "error") : BaiDuPanParse.initSingleDownFile(fileList[0]) : Alert_1.Alert.info("还没选文件哦~", 3, "warning");
                    }
                    ,
                    BaiDuPanParse.initDownFile = function() {
                        if (this._site != SiteEnum_1.SiteEnum.BD_DETAIL_Share) {
                            ...
                            Logger_1.Logger.debug(fileList),
                            null != fileList && 0 != (null == fileList ? void 0 : fileList.length) ? BaiDuPanParse.isMultipleFile(fileList) && BaiDuPanParse.isDirFile(fileList) ? Alert_1.Alert.info("暂不支持文件夹解析!", 3, "error") : (null == fileList ? void 0 : fileList.length) > 20 ? Alert_1.Alert.info("选择文件过多,请选择20个以内的文件进行解析", 3, "error") : BaiDuPanParse.initSingleDownFile(fileList[0]) : Alert_1.Alert.info("还没选文件哦~", 3, "warning");
                        } else
                            Alert_1.Alert.info("请将文件保存到网盘在进行解析", 3, "error");
                    }
                    ,
                    BaiDuPanParse.initSingleDownFile = function(file) {
                        var currentCode = Config_1.Config.get(BaiDuPanParse.panCode, "")
                        ...
                        BaiDuPanParse.md.handleUpdate(),
                        BaiDuPanParse.singleEvent();
                        var boxH = {
                            top: ($(unsafeWindow.window).height() - $("#" + BaiDuPanParse.prefix + "-box").height()) / 2 + "px"
                        };
                        $("#" + BaiDuPanParse.prefix + "-box").css(boxH),
                        $("#" + BaiDuPanParse.prefix + "-parser").on("click", (function() {
                            $("#" + BaiDuPanParse.prefix + "-parser").attr("disabled", "true"),
                            BaiDuPanParse.parser(file);
                        }
                        ));
                    }
                    ,
                    BaiDuPanParse.singleEvent = function() {
                        var currentCode = Config_1.Config.get(BaiDuPanParse.panCode, "")
                          , currentKey = Config_1.Config.get(BaiDuPanParse.panKey, "");
                        ...
                        $("." + BaiDuPanParse.prefix + "-close").on("click", (function() {
                            var _a, _b;
                            null === (_a = BaiDuPanParse.md) || void 0 === _a || _a.close(),
                            null === (_b = BaiDuPanParse.md) || void 0 === _b || _b.destroy();
                        }
                        ));
                    }
                    ,
                    ...
                    BaiDuPanParse.getShareListInfo = function(code, pwd) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(_a) {
                                switch (_a.label) {
                                case 0:
                                    return key = "sharelist-info-" + code + "-" + code,
                                    (fileInfo = Config_1.Config.get(key, !1)) ? [2, fileInfo] : [4, BaiduRoutes_1.BaiduRoutes.getShareList(code, pwd)];

                                case 1:
                                    return 0 != (res = _a.sent()).errno ? (BaiDuPanParse.log("关键数据1获取失败,请重试！"),
                                    Logger_1.Logger.debug(fileInfo),
                                    [2, !1]) : (Config_1.Config.set(key, res, 86400),
                                    [2, res]);
                                }
                            }
                            ));
                    ...
                    BaiDuPanParse.parser = function(file) {
                        var _this = this
                          , code = Config_1.Config.get(BaiDuPanParse.panCode, "");
                        ...
                        try {
                            BaiduRoutes_1.BaiduRoutes.pcsQuery([file.fs_id]).then((function(pcs) {
                                return __awaiter(_this, void 0, void 0, (function() {
                                    var obj, fileInfo;
                                    return __generator(this, (function(_a) {
                                        return obj = new PanRes_1.ParserV3,
                                        fileInfo = pcs.list[0],
                                        obj.fid = fileInfo.fs_id,
                                        obj.size = fileInfo.size,
                                        obj.PCSPath = window.btoa(fileInfo.dlink),
                                        obj.code = code,
                                        BaiDuPanParse.log("开始获取加速直链，请稍后1"),
                                        BaiduRoutes_1.BaiduRoutes.parserV3(obj).then((function(panFile) {
                                            var _a;
                                            1 == panFile.code ? (BaiDuPanParse.log("解析完成"),
                                            BaiDuPanParse.setUrl(panFile.data.dlink),
                                            BaiDuPanParse.setUserAgent(panFile.data.ua),
                                            BaiDuPanParse.setAria2(panFile.data.dlink, file.server_filename, panFile.data.ua)) : Alert_1.Alert.html("解析失败", null !== (_a = panFile.msg) && void 0 !== _a ? _a : panFile.message).then((function() {}
                                            ));
                                        }
                                        )),
                                        [2];
                    ...
                    BaiDuPanParse.shareFile = function(file) {
                        ...
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(_b) {
                                switch (_b.label) {
                                case 0:
                                    if (storeKey = "pan_share_" + file.fs_id,
                                    BaiDuPanParse.log("查询本地缓存数据"),
                                    panInfo = Config_1.Config.get(storeKey, void 0))
                                        return BaiDuPanParse.log("查询到缓存数据,开始解析链接"),
                                ...
                                case 4:
                                    return Logger_1.Logger.debug(share),
                                    BaiDuPanParse.lock = !1,
                                    [7];

                                case 5:
                                    if (0 == share.errno)
                                        return BaiDuPanParse.log("创建临时分享链接成功,准备写入本地缓存"),
                    ...
                    BaiDuPanParse.setUrl = function(url) {
                        $("#" + BaiDuPanParse.prefix + "-parser").hide(),
                        $("#" + BaiDuPanParse.prefix + "-parser-url").attr("data-clipboard-text", url).show();
                    }
                    ,
                    BaiDuPanParse.setAria2 = function(fileUrl, fileName, userAgent) {
                        $("#" + BaiDuPanParse.prefix + "-btn-aria").show(),
                        $("#" + BaiDuPanParse.prefix + "-btn-aria").click((function() {
                    ...
                    BaiDuPanParse.getParseUrl = function(dLink, panInfo) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(_a) {
                                switch (_a.label) {
                                case 0:
                                    return key = Config_1.Config.get(BaiDuPanParse.panKey, ""),
                                ...
                                case 1:
                                    panRes = _a.sent(),
                                    panParseInfo = panRes,
                                    1 == panRes.code && Config_1.Config.set(cacheKey, panRes, 3600),
                                    _a.label = 2;
                    ...
                    BaiDuPanParse.getParseUrlV2 = function(panInfo) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(_a) {
                                switch (_a.label) {
                                case 0:
                                    return Config_1.Config.get(BaiDuPanParse.panKey, ""),
                                    cacheKey = panInfo.id + "-PanParse-Cache",
                    ...
                    BaiDuPanParse.setCode = function(code) {
                        Alert_1.Alert.input("请输入验证码", code ? String(code) : "").then((function(res) {
                            ...
                            $("#" + BaiDuPanParse.prefix + "-code-v").text(res.value));
                        }
                        ));
                    }
                    ,
                    ...
                    BaiDuPanParse.getLogid = function() {
                        return Common_1.Common.getCookie("BAIDUID");
                    }
                    ,
                    ...
                    ,
                    BaiDuPanParse.prefix = "tt",
                    BaiDuPanParse.help = "https://wiki.tttt.ee/wiki/xinshou.html ",
                    BaiDuPanParse.install = "https://wiki.tttt.ee/wiki/install.html",
                    BaiDuPanParse.joinus = "https://wiki.tttt.ee",
                    BaiDuPanParse.panKey = "PanTools_Key",
                    BaiDuPanParse.panCode = "PanTools_Code",
                    BaiDuPanParse.flowInfoKey = "PanTools_Flow_New",
                    BaiDuPanParse.AriaConfig = "AriaConfig_Cache",
                    BaiDuPanParse.lock = !1,
                    BaiDuPanParse;
                }(AppBase_1.AppBase);
            ...
            , function(module, exports, __webpack_require__) {
                ...
                exports.Core = void 0;
                var BrowerType_1 = __webpack_require__(18)
                  , Core = function() {
                    function Core() {}
                    ...
                    Core.autoLazyload = function(isOk, callback, time) {
                        void 0 === time && (time = 5),
                        isOk() ? callback() : setTimeout((function() {
                    ...
                    Core.humanSize = function(source) {
                        ...
                        var index;
                        return index = Math.floor(Math.log(source) / Math.log(1024)),
                        (source / Math.pow(1024, index)).toFixed(2) + " " + ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"][index];
                    }
                    ,
                    Core;
                }();
                ...
                var Logger_1 = __webpack_require__(0)
                  ...
                  , Http = function() {
                    ...
                    return Http.ajax = function(option) {
                        ...
                        option.url.indexOf("pai") > -1 && (head.Author = null !== (_b = Config_1.Config.env.script.author) && void 0 !== _b ? _b : "dingding",
                    ...
                    Http._getData = function(data, contentType) {
                        if (void 0 === contentType && (contentType = "json"),
                        data instanceof Map) {
                    ...
                    Http.get = function(url, data, time_out, anonymous) {
                        return void 0 === data && (data = new Map),
                        void 0 === time_out && (time_out = 120),
                        void 0 === anonymous && (anonymous = !1),
                        new Promise((function(resolve, reject) {
                            Http.ajax({
                                url: url,
                                method: "GET",
            ...
            , function(module, exports, __webpack_require__) {
                ...
                var Common = function() {
                    ...
                    return Common.randStr = function(len) {
                        void 0 === len && (len = 4);
                        for (var $chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", pwd = "", i = 0; i < len; i++)
                            pwd += $chars.charAt(Math.floor(62 * Math.random()));
                        return pwd;
                    }
                    ,
                  ...
                  , Config = function() {
                    ...
                    Config.get = function(key, defaultValue) {
                        ...
                        if (objStr) {
                            ...
                            if (-1 == obj.exp || obj.exp > (new Date).getTime())
                                return Logger_1.Logger.info(key + " cache true"),
                                obj.value;
                        }
                        return Logger_1.Logger.info(key + " cache false"),
                        defaultValue;
                    }
                    ,
                    Config.getLocalStorage = function(key, defaultValue) {
                        ...
                        if (objStr) {
                            var obj = JSON.parse(objStr);
                            if (-1 == obj.exp || obj.exp > (new Date).getTime())
                                return Logger_1.Logger.info(key + " storage cache true"),
                                obj.value;
                        }
                        return Logger_1.Logger.info(key + " storage cache false"),
                        defaultValue;
                    }
                    ,
            ...
            , function(module, exports, __webpack_require__) {
                ...
                var Container_1 = __webpack_require__(4)
                  , Logger_1 = __webpack_require__(0)
                  , BaiDuPanParse_1 = __webpack_require__(5)
                  , PaiPaiHelper = function() {
                    function PaiPaiHelper() {
                        this.plugins = new Array,
                        this.plugins = [Container_1.Container.register(BaiDuPanParse_1.BaiDuPanParse)],
                  ...
                  , AppBase = function() {
                    ...
                    AppBase.prototype.linkTest = function(url) {
                        ...
                        return this.rules.forEach((function(v, k) {
                            ...
                            flag = !0,
                            _this.site = k,
                            !1) : (Logger_1.Logger.warn("app:" + _this.appName + " test fail"),
                            !0);
                        }
                        )),
                        flag;
            ...
            , function(module, exports, __webpack_require__) {
                ...
                exports.Ele = void 0;
                var EventEnum_1 = __webpack_require__(8)
                  , Ele = function() {
                    function Ele() {}
            ...
            , function(module, exports, __webpack_require__) {
                ...
                var Alert = function() {
                    ...
                    return Alert.confirm = function(msg, confirmTxt, cancelTxt) {
                        return void 0 === confirmTxt && (confirmTxt = "确定"),
                    ...
                    Alert.input = function(msg, defValue, validator) {
                        return void 0 === defValue && (defValue = ""),
                        void 0 === validator && (validator = function(res) {
                    ...
                    Alert.html = function(title, html, width, time) {
                        return void 0 === width && (width = void 0),
                ...
                module.exports = function() {
                    ...
                    var uniqueArray = function uniqueArray(arr) {
                      ...
                      , applyCustomClass = function applyCustomClass(elem, params, className) {
                        if (removeCustomClasses(elem, params),
                    ...
                    var oldInputVal, focusInput = function focusInput(input) {
                        ...
                        return !!oldContainer && (oldContainer.parentNode.removeChild(oldContainer),
                        ...
                        params.reverseButtons && (actions.insertBefore(cancelButton, loader),
                    ...
                    var renderContainer = function renderContainer(instance, params) {
                        ...
                        if (container) {
                            ...
                            queueStep && (container.setAttribute("data-queue-step", queueStep),
                      ...
                      , renderInput = function renderInput(instance, params) {
                        ...
                        params.input && (rerender && showInput(params),
                      ...
                      , setAttributes = function setAttributes(inputType, inputAttributes) {
                        ...
                        if (input)
                            for (var attr in removeAttributes(input),
                            inputAttributes)
                    ...
                    renderInputType.file = function(input, params) {
                        return setInputLabel(input, input, params),
                        setInputPlaceholder(input, params),
                        input;
                    }
                    ,
                    renderInputType.range = function(range, params) {
                        ...
                        return rangeInput.value = params.inputValue,
                    ...
                    renderInputType.select = function(select, params) {
                        ...
                        return setInputLabel(select, select, params),
                        select;
                    }
                    ,
                    ...
                    renderInputType.checkbox = function(checkboxContainer, params) {
                        ...
                        return setInnerHtml(label, params.inputPlaceholder),
                        checkboxContainer;
                    }
                    ,
                    ...
                    var renderContent = function renderContent(instance, params) {
                        ...
                        params.html ? (parseHtmlToContainer(params.html, htmlContainer),
                        show(htmlContainer, "block")) : params.text ? (htmlContainer.textContent = params.text,
                        show(htmlContainer, "block")) : hide(htmlContainer),
                      ...
                      , adjustSuccessIconBackgoundColor = function adjustSuccessIconBackgoundColor() {
                        for (var popup = getPopup(), popupBackgroundColor = window.getComputedStyle(popup).getPropertyValue("background-color"), successIconParts = popup.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), i = 0; i < successIconParts.length; i++)
                            successIconParts[i].style.backgroundColor = popupBackgroundColor;
                    }
                      , setContent = function setContent(icon, params) {
                        icon.textContent = "",
                        params.iconHtml ? setInnerHtml(icon, iconContent(params.iconHtml)) : "success" === params.icon ? setInnerHtml(icon, '\n      <div class="swal2-success-circular-line-left"></div>\n      <span class="swal2-success-line-tip"></span> <span class="swal2-success-line-long"></span>\n      <div class="swal2-success-ring"></div> <div class="swal2-success-fix"></div>\n      <div class="swal2-success-circular-line-right"></div>\n    ') : "error" === params.icon ? setInnerHtml(icon, '\n      <span class="swal2-x-mark">\n        <span class="swal2-x-mark-line-left"></span>\n        <span class="swal2-x-mark-line-right"></span>\n      </span>\n    ') : setInnerHtml(icon, iconContent({
                            question: "?",
                            warning: "!",
                            info: "i"
                        }[params.icon]));
                        ...
                        return new Promise((function(resolve) {
                            !function step(i, callback) {
                                ...
                                Swal.fire(currentSteps[i]).then((function(result) {
                                    void 0 !== result.value ? (queueResult.push(result.value),
                                    step(i + 1, callback)) : resetAndResolve(resolve, {
                      ...
                      , createStepElement = function createStepElement(step) {
                        ...
                        return addClass(stepEl, swalClasses["progress-step"]),
                        setInnerHtml(stepEl, step),
                        stepEl;
                    }
                      , createLineElement = function createLineElement(params) {
                        var lineEl = document.createElement("li");
                        return addClass(lineEl, swalClasses["progress-step-line"]),
                      ...
                      , renderProgressSteps = function renderProgressSteps(instance, params) {
                        ...
                        params.progressSteps.forEach((function(step, index) {
                            ...
                            if (progressStepsContainer.appendChild(stepEl),
                      ...
                      , renderPopup = function renderPopup(instance, params) {
                        var container = getContainer()
                          , popup = getPopup();
                        params.toast ? (applyNumericalStyle(container, "width", params.width),
                        popup.style.width = "100%") : applyNumericalStyle(popup, "width", params.width),
                      ...
                      , addClasses = function addClasses(popup, params) {
                        ...
                        addClass(popup, swalClasses.toast)) : addClass(popup, swalClasses.modal),
                    ...
                    function mixin(mixinParams) {
                        var MixinSwal = function(_this) {
                            ...
                            function MixinSwal() {
                                return _classCallCheck(this, MixinSwal),
                    ...
                    var showLoading = function showLoading(buttonToReplace) {
                        ...
                        show(actions),
                        buttonToReplace && (hide(buttonToReplace),
                      ...
                      , stopTimer = function stopTimer() {
                        if (globalState.timeout)
                            return stopTimerProgressBar(),
                            globalState.timeout.stop();
                    }
                      , resumeTimer = function resumeTimer() {
                        if (globalState.timeout) {
                            var remaining = globalState.timeout.start();
                            return animateTimerProgressBar(remaining),
                            remaining;
                        }
                    }
                      ...
                      , increaseTimer = function increaseTimer(n) {
                        if (globalState.timeout) {
                            ...
                            return animateTimerProgressBar(remaining, !0),
                            remaining;
                        }
                    }
                    ...
                    var bodyClickListener = function bodyClickListener(event) {
                      ...
                      , toastIncompatibleParams = ["allowOutsideClick", "allowEnterKey", "backdrop", "focusConfirm", "focusDeny", "focusCancel", "returnFocus", "heightAuto", "keydownListenerCapture"]
                    ...
                    var fixScrollbar = function fixScrollbar() {
                      ...
                      , lockBodyScroll = function lockBodyScroll() {
                        ...
                        container.ontouchmove = function(e) {
                            preventTouchMove && (e.preventDefault(),
                            e.stopPropagation());
                        }
                        ;
                    }
                      ...
                      , IEfix = function IEfix() {
                        "undefined" != typeof window && isIE11() && (fixVerticalPositionIE(),
                    ...
                    function removePopupAndResetState(instance, container, returnFocus, didClose) {
                        ...
                        container.parentNode && !document.body.getAttribute("data-swal2-queue-step") && container.parentNode.removeChild(container),
                        isModal() && (undoScrollbar(),
                        undoIOSfix(),
                        undoIEfix(),
                        unsetAriaHidden()),
                        removeBodyClasses();
                    ...
                    var prepareResolveValue = function prepareResolveValue(resolveValue) {
                      ...
                      , handlePopupAnimation = function handlePopupAnimation(instance, popup, innerParams) {
                        ...
                        animationIsSupported ? animatePopup(instance, popup, container, innerParams.returnFocus, didClose || onAfterClose) : removePopupAndResetState(instance, container, innerParams.returnFocus, didClose || onAfterClose);
                    }
                      ...
                      , animatePopup = function animatePopup(instance, popup, container, returnFocus, didClose) {
                        ...
                        popup.addEventListener(animationEndEvent, (function(e) {
                            e.target === popup && (globalState.swalCloseEventFinishedCallback(),
                      ...
                      , triggerDidCloseAndDispose = function triggerDidCloseAndDispose(instance, didClose) {
                        setTimeout((function() {
                            "function" == typeof didClose && didClose(),
                            instance._destroy();
                        }
                        ));
                    };
                    ...
                    function showValidationMessage(error) {
                        ...
                        input && (input.setAttribute("aria-invalid", !0),
                    ...
                    function setParameters(params) {
                        ...
                        params.showLoaderOnConfirm && !params.preConfirm && warn("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"),
                    ...
                    var swalStringParams = ["swal-title", "swal-html", "swal-footer"]
                      , getTemplateParams = function getTemplateParams(params) {
                        ...
                        return showWarningsForElements(templateContent),
                        _extends(getSwalParams(templateContent), getSwalButtons(templateContent), getSwalImage(templateContent), getSwalIcon(templateContent), getSwalInput(templateContent), getSwalStringParams(templateContent, swalStringParams));
                    }
                      ...
                      , getSwalIcon = function getSwalIcon(templateContent) {
                        ...
                        return icon && (showWarningsForAttributes(icon, ["type", "color"]),
                      ...
                      , getSwalInput = function getSwalInput(templateContent) {
                        ...
                        return inputOptions.length && (result.inputOptions = {},
                      ...
                      , getSwalStringParams = function getSwalStringParams(templateContent, paramNames) {
                        ...
                        for (var i in paramNames) {
                            ...
                            tag && (showWarningsForAttributes(tag, []),
                      ...
                      , openPopup = function openPopup(params) {
                        ...
                        isModal() && (fixScrollContainer(container, params.scrollbarPadding, initialBodyOverflow),
                        setAriaHidden()),
                      ...
                      , handleConfirmButtonClick = function handleConfirmButtonClick(instance, innerParams) {
                        ...
                        innerParams.input ? handleConfirmOrDenyWithInput(instance, innerParams, "confirm") : confirm(instance, innerParams, !0);
                    }
                      , handleDenyButtonClick = function handleDenyButtonClick(instance, innerParams) {
                        instance.disableButtons(),
                        innerParams.returnInputValueOnDeny ? handleConfirmOrDenyWithInput(instance, innerParams, "deny") : deny(instance, innerParams, !1);
                    }
                      ...
                      , handleInputValidator = function handleInputValidator(instance, innerParams, inputValue) {
                        ...
                        Promise.resolve().then((function() {
                            ...
                            validationMessage ? instance.showValidationMessage(validationMessage) : confirm(instance, innerParams, inputValue);
                        }
                        ));
                    }
                      , deny = function deny(instance, innerParams, value) {
                        innerParams.showLoaderOnDeny && showLoading(getDenyButton()),
                        innerParams.preDeny ? Promise.resolve().then((function() {
                      ...
                      , confirm = function confirm(instance, innerParams, value) {
                        ...
                        innerParams.preConfirm ? (instance.resetValidationMessage(),
                        Promise.resolve().then((function() {
                      ...
                      , addKeydownHandler = function addKeydownHandler(instance, globalState, innerParams, dismissWith) {
                        ...
                        globalState.keydownHandlerAdded = !1),
                        innerParams.toast || (globalState.keydownHandler = function(e) {
                      ...
                      , setFocus = function setFocus(innerParams, index, increment) {
                        ...
                        if (focusableElements.length)
                            return (index += increment) === focusableElements.length ? index = 0 : -1 === index && (index = focusableElements.length - 1),
                      ...
                      , keydownHandler = function keydownHandler(instance, e, dismissWith) {
                        var innerParams = privateProps.innerParams.get(instance);
                        innerParams && (innerParams.stopKeydownPropagation && e.stopPropagation(),
                        "Enter" === e.key ? handleEnter(instance, e, innerParams) : "Tab" === e.key ? handleTab(e, innerParams) : -1 !== [].concat(arrowKeysNextButton, arrowKeysPreviousButton).indexOf(e.key) ? handleArrows(e.key) : -1 !== escKeys.indexOf(e.key) && handleEsc(e, innerParams, dismissWith));
                    }
                      ...
                      , handleEsc = function handleEsc(e, innerParams, dismissWith) {
                        callIfFunction(innerParams.allowEscapeKey) && (e.preventDefault(),
                    ...
                    function _main(userParams) {
                        ...
                        globalState.timeout && (globalState.timeout.stop(),
                        delete globalState.timeout),
                        clearTimeout(globalState.restoreFocusTimeout);
                        var domCache = populateDomCache(this);
                        return render(this, innerParams),
                    ...
                    var prepareParams = function prepareParams(userParams, mixinParams) {
                        ...
                        !1 === userParams.animation && (params.showClass = {
                      ...
                      , populateDomCache = function populateDomCache(instance) {
                        ...
                        return privateProps.domCache.set(instance, domCache),
                        domCache;
                    }
                      , setupTimer = function setupTimer(globalState$$1, innerParams, dismissWith) {
                        var timerProgressBar = getTimerProgressBar();
                        hide(timerProgressBar),
                        innerParams.timer && (globalState$$1.timeout = new Timer((function() {
                            dismissWith("timer"),
                            delete globalState$$1.timeout;
                        }
                        ),innerParams.timer),
                        innerParams.timerProgressBar && (show(timerProgressBar),
                        setTimeout((function() {
                      ...
                      , initFocus = function initFocus(domCache, innerParams) {
                        if (!innerParams.toast)
                            return callIfFunction(innerParams.allowEnterKey) ? void (focusButton(domCache, innerParams) || setFocus(innerParams, -1, 1)) : blurActiveElement();
                    }
                    ...
                    function _destroy() {
                        ...
                        delete globalState.swalCloseEventFinishedCallback),
                        globalState.deferDisposalTimer && (clearTimeout(globalState.deferDisposalTimer),
                    ...
                    var currentInstance, runDidDestroy = function runDidDestroy(innerParams) {
                        ...
                        function SweetAlert() {
                            if (_classCallCheck(this, SweetAlert),
            ...
            , function(module, __webpack_exports__, __webpack_require__) {
                ...
                var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1)
                  , _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__)
                  , _node_modules_css_loader_dist_cjs_js_Swal_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2)
                  , _node_modules_css_loader_dist_cjs_js_Swal_css__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(_node_modules_css_loader_dist_cjs_js_Swal_css__WEBPACK_IMPORTED_MODULE_1__)
                  , options = {
                    insert: "head",
                    singleton: !1
                };
            ...
            , function(module, __webpack_exports__, __webpack_require__) {
                ...
                var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1)
                  , _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__)
                  , _node_modules_css_loader_dist_cjs_js_Alert_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3)
                  , _node_modules_css_loader_dist_cjs_js_Alert_css__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(_node_modules_css_loader_dist_cjs_js_Alert_css__WEBPACK_IMPORTED_MODULE_1__)
                  , options = {
                    insert: "head",
                    singleton: !1
                };
                ...
                var Http_1 = __webpack_require__(10)
                  ...
                  , BaiduRoutes = function() {
                    ...
                    BaiduRoutes.getShareFile = function(shareid, uk, fid) {
                        var data = new Map;
                        return data.set("clienttype", "2"),
                        data.set("shareid", shareid),
                        data.set("uk", uk),
                        data.set("fid", fid),
                        data.set("channel", "android_11_netdisk"),
                        Http_1.Http.post("https://pan.baidu.com/share/list", data, "formdata");
                    }
                    ,
                    ...
                    BaiduRoutes.getShareListV1 = function(shortUrl, pwd) {
                        var data = new Map;
                        return data.set("shorturl", shortUrl),
                        data.set("dir", ""),
                        data.set("root", 1),
                        data.set("pwd", pwd),
                        Http_1.Http.post("https://pan.baidu.com/share/wxlist?channel=weixin&version=2.2.2&clienttype=25&web=1", data, "formdata");
                    }
                    ,
                    BaiduRoutes.parserV3 = function(data) {
                        var _data = new Map;
                        return _data.set("uk", data.uk),
                        _data.set("shareid", data.shareid),
                        _data.set("fid", data.fid),
                        _data.set("size", data.size),
                        _data.set("PCSPath", data.PCSPath),
                        _data.set("link", data.link),
                        _data.set("uid", data.uid),
                        _data.set("md5", data.md5),
                        _data.set("code", data.code),
                    ...
                    BaiduRoutes.pcsQuery = function(fsids) {
                        var data = new Map;
                        return data.set("method", "filemetas"),
                        data.set("dlink", 1),
                        data.set("fsids", "[" + fsids.join(",") + "]"),
                    ...
                    BaiduRoutes.pcsQueryV2 = function(sign, timestamp, fsids) {
                        var url = "https://pan.baidu.com/api/sharedownload?channel=chunlei&clienttype=12&web=1&app_id=250528&sign=" + sign + "&timestamp=" + timestamp
                          , data = new Map([["fid_list", "[" + fsids.join(",") + "]"]]);
                        return data.set("primaryid", unsafeWindow.window.locals.get("shareid")),
                        data.set("uk", unsafeWindow.window.locals.get("share_uk")),
                        data.set("product", "share"),
                        data.set("extra", BaiDuPanParse_1.BaiDuPanParse._getExtra()),
                        Http_1.Http.post(url, data, "formdata");
                    }
                    ,
                    BaiduRoutes.root = "http://pan.tttt.ee////",
                    BaiduRoutes;
                }();
                            ...
                            686: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
                                ...
                                var fakeCopyAction = function fakeCopyAction(value, options) {
                                    var fakeElement = function createFakeElement(value) {
                                        ...
                                        return fakeElement.style.top = "".concat(yPosition, "px"),
                                ...
                                function _createSuper(Derived) {
                                    ...
                                    return function _createSuperInternal() {
                                        ...
                                        return function _possibleConstructorReturn(self, call) {
                                            if (call && ("object" === clipboard_typeof(call) || "function" == typeof call))
                                                return call;
                            ...
                            828: function(module) {
                                ...
                                module.exports = function closest(element, selector) {
                                    for (; element && 9 !== element.nodeType; ) {
                                        if ("function" == typeof element.matches && element.matches(selector))
                                            return element;
                            ...
                            279: function(module) {
                                ...
                                E.prototype = {
                                    ...
                                    off: function(name, callback) {
                                        ...
                                        return liveEvents.length ? e[name] = liveEvents : delete e[name],
                                        this;
                                    }
                                },
                                module.exports = E,
