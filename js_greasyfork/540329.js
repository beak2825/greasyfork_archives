...
// @author       ChaoticAdventure
// @match        https://retroachievements.org/forums/topic/*
// @icon         https://static.retroachievements.org/assets/images/ra-icon.webp
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/540329/WritingTeam%20Implement%20Template%20Generator.user.js
// @updateURL https://update.greasyfork.org/scripts/540329/WritingTeam%20Implement%20Template%20Generator.meta.js
// ==/UserScript==

(function() {
    'use strict';

    // This function validates that the user is logged in to the WritingTeam account.
    function checkAccount() {
        console.log("Checking account...");
        const loginImage = document.querySelector('img.icon-sm.rounded-sm.userpic');
        console.log("Submit button found:", loginImage);

        if (loginImage) {
            // Check if user is logged in to the WritingTeam account
            const hasLoginImage = loginImage.src.includes("WritingTeam");
            console.log("Is logged in:", hasLoginImage);
            return hasLoginImage;
        }
