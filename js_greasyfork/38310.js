// ==UserScript==
// @name         千門牛奶20180209
// @namespace    http://swordman-s1.yytou.com/?id=6733667&time=1516927482088&key=46503f919df08b94a8a480d61f69294e&s_line=1&arg=4173821
// @version      2.5
// @description  更新幫副~將幫派副本功能拿掉!
// @author       MARBO&jj
// @match        http://swordman-s1.yytou.com/?id=6733667&time=1516927482088&key=46503f919df08b94a8a480d61f69294e&s_line=1&arg=4173821
// @grant        http://swordman-s1.yytou.com/?id=6733667&time=1516927482088&key=46503f919df08b94a8a480d61f69294e&s_line=1&arg=4173821
// @downloadURL https://update.greasyfork.org/scripts/38310/%E5%8D%83%E9%96%80%E7%89%9B%E5%A5%B620180209.user.js
// @updateURL https://update.greasyfork.org/scripts/38310/%E5%8D%83%E9%96%80%E7%89%9B%E5%A5%B620180209.meta.js
// ==/UserScript==
...
function killTianJianTargetFunc(){
	...
	if (killTianJianTargetButton.innerText == '殺天劍'){
	    mySkillLists=prompt("請輸入連續單放出招技能:","覆雨劍法");
...
function qmj_addbtns() {
    var a = ['山坳', '石街','桃花泉', '潭畔草地', '長空棧道','臨淵石台', '千尺幢', '玉女峰', '猢猻愁', '沙丘小洞', '九老洞', '懸根松', '夕陽嶺', '青雲坪', '湖邊','玉壁瀑布','碧水寒潭','懸崖','寒水潭','戈壁','盧崖瀑布','啟母石','無極老姆洞','山溪畔','奇槐坡','小洞天','天梯','雲步橋','觀景台','危崖前','無名山峽谷','天策','賭場','破陣','鱷魚','挖鐵','杭界山','朱果','風泉','殺孽龍','殺盾陣'];
    var b = [];
...
function wooo(){//朱果
    alert("鬼城3898亂石山2354龍淵刀樓1539桃花渡1789綠水山1259戈壁綠洲2039帝龍陵2389佛門石窟2429大福船3094天龍山3104八卦門3649濱海古城3399");
}
function jianjian(){// 劍
...
// 外傳1 ------------------------------------------------------------------------------------------------------
		...
		function qmj_addbtns2() {
		    if (ssssButton.innerText == '小功能'){
			    var aaa = ['悟性裝','寶箱3000','通靈','上香','打鳥','蓮花','冰月谷','突破丹禮包','狂暴丹','掌門手諭','投資','煉藥'];
			    var bbb = [];
			...
			for (var i=0; i<20; i++)
  {
		...
		function liandrugSecondFunc(){
			if($('span:contains("煉藥")').text().slice(-6) == '明天再來吧！'){
				ssssButton.innerText = '小功能';
		    	clearInterval(liandrugInterval);
		    	// clearInterval(killrunInterval);
				clearTimeout(liandrugSecondFunc);
