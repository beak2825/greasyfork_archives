...
// @grant        none
// @license      GNU GPLv3 
// @downloadURL https://update.greasyfork.org/scripts/457603/%E7%99%BE%E5%BA%A6%20%E6%97%B6%E5%85%89%E6%9C%BA.user.js
// @updateURL https://update.greasyfork.org/scripts/457603/%E7%99%BE%E5%BA%A6%20%E6%97%B6%E5%85%89%E6%9C%BA.meta.js
// ==/UserScript==
...
(function() {
    ...
    // 根据 location.href 识别日期区间搜索行为
		// https://www.baidu.com/s?wd=GDFDA&gpc=stf%3D1577808000%2C1610035200%7Cstftype%3D2
	// 其中，“wd=”后面是关键词，“gpc=”后面是结果过滤，“stf%3D……%2C……%7Cstftype%3D2”是日期区间的标识
	// 识别搜索关键词 kw 和日期区间始末点 qiri 和 vsri（单位秒，转换前要先转成毫秒）
	...
	function dateTOnum(odate){	//日期转换成秒数
		return odate / 1000;
	}
