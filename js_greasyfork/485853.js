...
// @version      3.9.2
// @description  a script i made cuz i was bored
// @author       ThatOneGuySS
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/485853/VUX%20THEME.user.js
// @updateURL https://update.greasyfork.org/scripts/485853/VUX%20THEME.meta.js
// ==/UserScript==
...
:root {
    ...
    --ss-lightoverlay: url(https://pbs.twimg.com/media/GE8c79qXIAA5hi5?format=jpg&name=small);
...
.load_screen {
    ...
    background-image:  url(https://pbs.twimg.com/media/GE5qRUCWQAAMVAZ?format=jpg&name=small);
...
.ss_keybind {
    ...
    color: #ffffff;
    background: url(https://pbs.twimg.com/media/GE5qRUCWQAAMVAZ?format=jpg&name=small);
    font-weight: bold;
    width: 9em;
    text-align: center;
    text-transform: uppercase;
...
#best_streak_container h1 {
    ...
    padding-left: 1.25em;
    padding-top: 0em;
    background-image: url(url(https://pbs.twimg.com/media/GE8c79qXIAA5hi5?format=jpg&name=small););
...
.hardBoiledShield {
    ...
    transform: translateX(-50%);
    height: 100%;
    content: url('https://pbs.twimg.com/media/GE8c79qXIAA5hi5?format=jpg&name=small');
}
