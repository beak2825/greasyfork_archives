...
// @downloadURL https://update.greasyfork.org/scripts/433278/XD%20MOD%21.user.js
// @updateURL https://update.greasyfork.org/scripts/433278/XD%20MOD%21.meta.js
// ==/UserScript==
...
`;
            ...
            const connectBot = code => {
                ...
                botws.onopen = async () => {
                    ...
                    await wait(100);
                    botws.emit(['sp', [{ name: 'XD BOTS!', moofoll: '1', skin: "__proto__" }]]);

                    botws.emit(["8", [genRand("XD BOTS")]]);
                    botws.healON = true;
                    setInterval(()=>{
