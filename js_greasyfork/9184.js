...
// @namespace      http://fotka.com/profil/suchar/
// @include        http://fotka.com/*
// @version        2.7
// @copyright      2014+, suchar, 2015 Shaitan
// @author         suchar
// @run-at         document-end
// @grant          unsafeWindow
// @grant          GM_getValue
// @grant          GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/9184/MultiKoszyk%20fotkapl.user.js
// @updateURL https://update.greasyfork.org/scripts/9184/MultiKoszyk%20fotkapl.meta.js
// ==/UserScript==
...
if (document.getElementById("content")){ // czy to nie popup?
    dodajMenuGorne();
    if (document.getElementById("profile-container") != null){ // czy jesteśmy na profilu?
        dodajPrzyciskProfil();
        dodajMenuPowod();
    }
}
...
function dodajPrzyciskProfil(){
    ...
    var koszyk;
    var powod;
    var url = "http://fotka.com/profil/" + unsafeWindow._currentProfile.login + "/";
    for(var x=1; x<=ile_koszykow; x++){
...
function dodajMenuPowod(){
    ...
    menu.id = "koszyk_menu";
    menu.style.cssText = "border: 1px solid rgb(197, 197, 197); padding: 0px 3px 3px; z-index: 101; position: fixed; display: block; background-color: rgb(255, 255, 255); text-align: left; background-image: url(http://fotka.com/img/operacje/menu.gif); background-repeat: no-repeat; display: none;";
...
function dodajProfil(){
    ...
    var av = _currentProfile.profile_av_32_url;
    var koszyk_nr;
    ...
    dodajWpis("http://fotka.com/profil/" + login + "/", powod, av, koszyk_nr);
