...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/429621/%3C%3E%20Kurt%20Mod%20-%20%C3%9Cs%20%C4%B0n%C5%9Faat%C4%B1.user.js
// @updateURL https://update.greasyfork.org/scripts/429621/%3C%3E%20Kurt%20Mod%20-%20%C3%9Cs%20%C4%B0n%C5%9Faat%C4%B1.meta.js
// ==/UserScript==
...
<hr />
<h3>• Kurt & Java Üs İnşaatı</h3>
<hr />
<button onclick="BSB();">TC Üssü I</button>
<button onclick="TB();">Skore Üs</button>
<button onclick="XBase();">TC Üssü II</button>
<button onclick="SmallCornerBase();">Tombul Üs</button>
<button onclick="SSLQ();">Tombul Üs II</button>
<br><br>
<button onclick="deathrainbase();">Aşırtma Üssü I</button>
<button onclick="bryanss();">Aşırtma Üssü II</button>
<br><br>
<input type="number" value="1000" class="F" placeholder="speed" style="width: 20%;">
<button class="Fe">Hızı Kaydet</button>
<button id="SSL5">Kalkan Üssü</button>
<br><br>
<input type="number" value="825" class="F2" placeholder="speed" style="width: 20%;">
<button class="Fe2">Hızı Kaydet</button>
  <button id="SSL6">Altın Jenerator</button> &nbsp;
<br><br>
<input type="number" value="2500" class="F0" placeholder="speed" style="width: 20%;">
<button class="Fe0">Hızı Kaydet</button>
  <button id="SSL0">Kapan Üssü</button> &nbsp;
  `;
...
TH()
  ...
  if (trade.innerHTML == "Altın Jenerator Etkin") {
    trade.innerHTML = "Altın Jenerator Etkinleştir";
  } else {
    trade.innerHTML = "Altın Jenerator Etkin";
  }
}
...
MB()
  ...
  if (trade.innerHTML == "Kalkan Üssü Etkin") {
    trade.innerHTML = "Kalkan Etkinleştir";
  } else {
    trade.innerHTML = "Kalkan Üssü Etkin";
  }
}
...
BRYSCRBSE();
  ...
  if (trade.innerHTML == "Kapan Üssü Etkin") {
    trade.innerHTML = "Kapan Üssü Etkinleştir";
  } else {
    trade.innerHTML = "Kapan Üssü Etkin";
  }
}
       var upgradeBombs = () => {
