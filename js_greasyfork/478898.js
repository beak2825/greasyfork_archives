// ==UserScript==
// @name         Mops Time Tracker
// @namespace    http://tampermonkey.net/
// @version      2.4
// @description  Автоматическая запись тасков в Time Tracker
// @author       OlyaR
// @match        *://mops-dafuc0a6ftbqguhy.z01.azurefd.net/*
// @match        *://tng-mops-portal.azurewebsites.net/*
// @match        *://mops-portal.azurewebsites.net/timetracker
// @icon         https://www.google.com/s2/favicons?sz=64&domain=triplenext.net
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/478898/Mops%20Time%20Tracker.user.js
// @updateURL https://update.greasyfork.org/scripts/478898/Mops%20Time%20Tracker.meta.js
// ==/UserScript==
...
function initialize() {
    ...
    if (radioButtons.length > 0 && textField) {
        ...
        // Обработчик изменения значения для всех радиокнопок
        radioButtons.forEach(function(radio) {
            radio.addEventListener("change", function() {
                if (radio.checked) {
                    ...
                    var textMappings = {
                        "Complex": "",
                        "Custom": optionsCustom[0],
                        "PreFilterPictures": "40/40",
                        "ImageChoice": "30/30",
                        "ImageBackgroundRemoval": options[0],
                    ...
                    // Устанавливаем курсор в конец текста в поле ввода
                    textField.focus();
 ...
 function showDropdown(textField, options) {
    ...
    // Устанавливаем ширину выпадающего списка в 50% от ширины родительского элемента
    var parentWidth = textField.parentElement.offsetWidth;
    dropdown.style.width = parentWidth * 0.5 + 'px';
...
dropdown.addEventListener('change', function() {
    ...
    // Устанавливаем курсор в конец текста в поле ввода с помощью requestAnimationFrame
