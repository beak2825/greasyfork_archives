...
// @author         hateradio
// @version        3.1.1
// @description    This is a cross-browser BBCode helper. It works with both What.CD and Waffles.fm and other sites . . . CDs and waffles, mmm. Added Brokenstones
// @homepage       https://greasyfork.org/scripts/5080-whutbbcode
...
// @exclude        http*://*brokenstones.me/*logchecker*
// @exclude        http*://*brokenstones.me/user.php?action=notify*
// @exclude        http*://*brokenstones.me/reportsv2.php*
// @exclude        http*://*brokenstones.me/tools.php?action=clear_cache*
...
// @since          Sep 30 2010
// 2010+, hateradio
// Please don't modify or edit my script and re-release it. D: (sorry hateradio!) - techietrash
// Send me a message if you want something modified.
// @downloadURL https://update.greasyfork.org/scripts/5080/WhutBBCode%20BS.user.js
// @updateURL https://update.greasyfork.org/scripts/5080/WhutBBCode%20BS.meta.js
// ==/UserScript==
	...
	WhutBB.$ = {
		data: {
			...
			web: [
				[':test', /^$|^localhost$/],
				['what', /(?:what)\.cd/],
				['brokenstonesme', /(?:brokenstones\.me)/],
	...
	WhutBB.db = {
		sites: {
			':default': function () {
				return {
					name: '',
					link: 'https://greasyfork.org/scripts/5080-whutbbcode',
					beneath: true,
					blueprint: [],
					width: 430,
					emoticonDir: '',
			...
			brokenstonesme: function () {
				return {
					link: 'https://greasyfork.org/scripts/5080-whutbbcode',
					emoticonDir: 'https://brokenstones.me/static/common/smileys/',
					emoticons: 'gazelle_bs',
					width: 430,
					blueprint: [
						['b', 'i', 'u', 's'], ['important', 'heading', 'code'],
