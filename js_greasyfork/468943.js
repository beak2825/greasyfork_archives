...
// @downloadURL https://update.greasyfork.org/scripts/468943/kbin%20enhancement%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/468943/kbin%20enhancement%20script.meta.js
// ==/UserScript==
...
(function(){
  ...
  function collapseComment(blockquote) {
    ...
    newBlockquote.innerHTML = '<header><a href="javascript:;">' + username + ' [+]</a></header>';
  ...
  if (localStorage.getItem("setting-changelog-version") != version) {
    const message = `<strong>kbin enhancement script version: ${version}</strong><br>
			...
			<ul>
				...
				<li>Adjusted collapse functionality</li>
				<li>Added hide all replies</li>
				<li>Added hide all replies by default</li>
				<li>Fixed bugs</li>
			</ul>
		`
