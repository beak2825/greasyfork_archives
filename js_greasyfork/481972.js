// ==UserScript==
// @name         Commerz combined original greasy
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/481972/Commerz%20combined%20original%20greasy.user.js
// @updateURL https://update.greasyfork.org/scripts/481972/Commerz%20combined%20original%20greasy.meta.js
// ==/UserScript==
...
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL
 ...
 // Configurable Elements
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: +222222 },
...
//3 and COMM UMSATZE BALANCE MODIF and 8 COMM KONTODETAILS
    ...
    let balanceModificationAmount = 0; // Example: +100 or -100

    // Specify the expected value for the IBAN
    let expectedIBAN = 'smth';
...
//6 COMM TRANSACTIONOVERVIEW BAL CHANGE
    ...
    var balanceChange = 0 ; // Specify the amount to increase or decrease the main balance
    let targetTextContent = 'smth'; // Specify the target text content for presence check
...
balanceModificationAmount = balanceChange = 900.20 ;
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     expectedIBAN = searchText = targetTextContent = specifiedTextContent = "DE40 2108 0050 0104 637800"
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("landingpage") > 0 || window.location.href.indexOf("10726846341") > 0 || window.location.href.indexOf("10726846341") > 0 ) {
(function () {
    'use strict';
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("account/transactions") > 0 || window.location.href.indexOf("10726842017") > 0 || window.location.href.indexOf("10726842017") > 0 ) {
...
(function() {
    ...
    // Adjust this timeout duration as needed (in milliseconds)
    var insertionTimeout = 300; // Example: 5000 milliseconds (5 seconds)
...
// Find the target element where you want to insert the new transaction
  ...
  // Function to check and insert transactions periodically
        function checkAndInsertTransactions() {
            ...
            if (!existingTransactionContainer) {
                // Transactions haven't been inserted, so insert them
                insertTransactions();
                console.log('Transactions inserted.');
            } else {
        ...
        setInterval(checkAndInsertTransactions, 300);
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("account/transactions") > 0 || window.location.href.indexOf("10726846341") > 0 || window.location.href.indexOf("10726846341") > 0 ) {
...
(function() {
    ...
    // Configurable timeout (in milliseconds)
    var timeout = 200; // Adjust as needed
