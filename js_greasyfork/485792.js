...
// @match        https://pokemondb.net/pokedex/all/*
// @match        http://smogtours.psim.us/*
// @match        http://localhost:8000/*
// @match        http://g410178v57.qicp.vip-80.psim.us/*
// @match        https://www.pikalytics.com/
// @grant        none
// @require      https://cdn.bootcss.com/jquery/3.4.1/jquery.min.js
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/485792/Showdown%E7%BF%BB%E8%AD%AF%28%E5%90%AB%E6%8E%92%E5%90%8D%E7%B6%B2%29.user.js
// @updateURL https://update.greasyfork.org/scripts/485792/Showdown%E7%BF%BB%E8%AD%AF%28%E5%90%AB%E6%8E%92%E5%90%8D%E7%B6%B2%29.meta.js
// ==/UserScript==
var translations = {
    ...
    //特性說明 Abllity
    "On switch-in, this Pokemon restores 1/4 of its ally's maximum HP, rounded down.": "出場時款待同伴，使其回復少量ＨＰ。",
    "Fighting, Normal moves hit Ghost. Accuracy can't be lowered, ignores evasiveness.": "一般屬性和格鬥屬性的招式可擊中幽靈屬性的寶可夢。可無視對手閃避率的變化，且命中率不會被降低。",
    "This Pokemon's moves have a 30% chance of badly poisoning.": "靠著含有毒素的鎖鏈的力量，有時會讓被招式擊中的對手陷入劇毒狀態。",
    "On switch-in, this Pokemon lowers the evasiveness of opponents 1 stage. Once per battle.": "在對戰中首次出場時，會四處散播甜膩的蜜香，降低對手的閃避率。",
    "If this Pokemon is a Terapagos, it transforms into its Terastal Form on entry.": "出場時，會吸收周圍的能量，變為太晶形態。",
    "Terapagos: If full HP, attacks taken have 0.5x effectiveness unless naturally immune.": "蘊藏著所有屬性力量的甲殼會將自身ＨＰ全滿時受到的傷害全都變為效果不好。",
    "Terapagos: Terastallizing ends the effects of weather and terrain. Once per battle.": "太樂巴戈斯變為星晶形態時，蘊藏其身的力量會將天氣和場地的影響全部歸零。",
    "If this Pokemon poisons or badly poisons a target, the target also becomes confused.": "因為桃歹郎的招式而陷入中毒狀態的對手同時也會陷入混亂狀態。",
