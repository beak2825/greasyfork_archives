// ==UserScript==
// @name         【减负社区】【超星学习通小助手】【完全免费】视频-章节测试|自动挂机|防清进度|不占资源
// @namespace    unrival
// @version      4.0
// @description  ▶▶▶上次更新：2025.3.5◀◀◀【💻可最小化💻】🆒支持超星视频、文档、答题、自定义正确率、掉线自动登录🤘取消视频文件加载，多开也不占用网速，放心追剧🍊自定义答题正确率，提高学习效率🍆每日功能测试，在发现问题前就解决问题，防清进度，无不良记录
// @author       unrival
// @run-at       document-end
    ...
    <body>
        <div class="row" style="margin: 10px;">
            <div class="col-md-6 col-md-offset-3">
               ...
               <div class="panel panel-info" id='remarks' style="width: 100% height: 100%">
                    <div class="panel-heading">作者留言</div>
                    <div class="panel-body" style="height: 100%;">
                                    <img src="`+ base222 + `" alt="Smiley face" width="120" height="120">

                                    <p>作者是 <s>大四学生</s> 社畜，相信大家都是被大学网课而耽误的强国少年，当时因为脚本作者不更新，索性copycopy修改修改自己用，随后一想干脆发布出去，没想到发展到现在都有人用<p/>
                                    <p>当时放个赞赏码在这纯属侥幸，也没想到现在会从哥哥姐姐们手里收到零零碎碎的小费<p/>
                                    <p>感谢各位一直以来的支持，因为在实习实在是太忙啦！<p/>
                                    <p>这个版本修复一些细节问题<p/>
                                    <p>还有后台一直有人反馈题库问题，后面作者将对接更多题库提高准确率<p/>
                                    <p>Bug反馈邮箱 MMRQONE@Gmail.com 可以带图 建议带账号密码 方便我测试<p/>
                                    <p>留言于：2024.5.17<p/>
                ...
                <div class="panel panel-info" id="normalQuery">
                    ...
                    <div class="panel-body">
                        <div>
                                 高倍速是会清进度的，建议一倍速运行，除非是真的没时间了才调高倍数<br/>
                ...
                <div class="panel panel-info" id='tikupeizhi' style="width: 100% ;height:100%">
                    <div class="panel-heading">题库配置
                    </div>
                    <div class="panel-body" style="height: 100%;">

                            <p>关注微信公众号：一之哥哥，发送 “token” 领取你的token，可以提高答题并发数量。</p><br/>
                           <div style="padding: 0;font-size: 20px;float: left;">题库Token：</div>
                           <input type="text" id="token" style="width: 150px;" value="`+tikutoken+`">
                           <a id='updateToken' class="btn btn-default" >保存</a><br/><br/>
