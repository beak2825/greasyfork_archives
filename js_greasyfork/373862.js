...
// @grant        GM_getValue
// @grant        GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/373862/wsmud_pluginss.user.js
// @updateURL https://update.greasyfork.org/scripts/373862/wsmud_pluginss.meta.js
// ==/UserScript==
// 2018年10月31日 师门任务品质
...
(function () {
  ...
  var goods = {
    ...
    var place = {
        ...
        "逍遥派-林间小道": "jh fam 5 start;go west",
        ...
        "丐帮-暗道": "jh fam 6 start;go down;go east;go east;go east;go east",
...
<span class='zdy-item zdwk'>挖矿(Y)</span><br>
<span class='zdy-item go_wd'>武当(X)</span>
<span class='zdy-item go_gb'>丐帮(C)</span>
<span class='zdy-item go_em'>峨眉(V)</span>
<span class='zdy-item go_sl'>少林(B)</span>
<span class='zdy-item go_hs'>华山(N)</span>
<span class='zdy-item go_xy'>逍遥(M)</span>
</div>
`;
...
`;
            ...
            $(".go_wd").on("click", WG.go_wd);
			$(".go_em").on("click", WG.go_em);
			$(".go_sl").on("click", WG.go_sl);
			$(".go_hs").on("click", WG.go_hs);
			$(".go_gb").on("click", WG.go_gb);
			$(".go_xy").on("click", WG.go_xy);
            setTimeout(() => {
                var logintext = '';
...
`;
    ...
    var Helper = {
        ...
        kksBoss: function (data) {
            var boss_place = data.content.match("当空皓月");
