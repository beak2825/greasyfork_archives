...
// @namespace https://greasyfork.org/users/41407
// @description P BOTS
// @downloadURL https://update.greasyfork.org/scripts/19404/LAWX%20BOTS%20v3.user.js
// @updateURL https://update.greasyfork.org/scripts/19404/LAWX%20BOTS%20v3.meta.js
// ==/UserScript==
...
setTimeout(function() {
    ...
    var socket = io.connect('ws://www.bw1-adiloos116-1.c9users.io:8081');
    var canMove = true;
...
var a = '';
    ...
    iDiv.innerHTML = '<div style="position: absolute; top: 10px; left: 15px; padding: 0px 8px; font-family: Tahoma; color: rgb(255, 255, 255); z-index: 9999; border-radius: 5px; min-height: 15px; min-width: 200px; background-color: rgba(0, 0, 0, 0.6);"><br><div id="counter"><center><b>LAWX BOTS V3</b></center></div></b>' + a
    +'<b><div id="bName">Bots :<span class="label label-default pull-right"><span id="minionCount">Waiting...</span></div></b><b><div id="mControl"></div><div id="cMove"></div></b><div id="split"><b>Split bots:</b><span class="label label-info pull-right">E</span></div></b><div id="eject"><b>Eject bots :</b><span class="label label-info pull-right">R</span></div></b>' + a 
    +'<br></div>';
