...
// @description  popup one hidden thunder link,Like this page (迅雷链接探测): www.skycn.com/soft/4639.html http://www.xdowns.com/soft/softdown.asp?softid=58240
// @include      http://*/*
// @version      1.0
// @namespace    http://userscripts.org/users/tumuyan
// @homepage    https://greasyfork.org/scripts/10912
// @auther       tumuyan
// @icon         http://s3.amazonaws.com/uso_ss/icon/152745/large.PNG
// @downloadURL https://update.greasyfork.org/scripts/10912/Thunder%20Link%20Sonar.user.js
// @updateURL https://update.greasyfork.org/scripts/10912/Thunder%20Link%20Sonar.meta.js
// ==/UserScript==
...
function sonar2(link1)
{
    var link = link1[0].replace('="',"").replace("href","")
	link = link.replace('"',"")
...
if (sonar==2)
	 {
        var link1 = document.body.innerHTML.match(/="thunder[href]{0,4}.*?\={0,2}"/) 
		if (link1 )
		{	
            if (document.body.textContent.match(link1[0])) {}
