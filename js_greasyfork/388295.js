// ==UserScript==
// @name              afd-release-tool
// @version           0.0.4
// @icon              https://www.baidu.com/favicon.ico
// @description       afd 上线工具
// @require           https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js
// @require           https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/moment.min.js
// @match             *://orp.baidu.com/*
// @run-at       document-end
// @namespace https://greasyfork.org/users/216399
// @downloadURL https://update.greasyfork.org/scripts/388295/afd-release-tool.user.js
// @updateURL https://update.greasyfork.org/scripts/388295/afd-release-tool.meta.js
// ==/UserScript==
        ...
        if (orpInfo) {
            ...
            if ($hiLog.length === 0) {
                const tpl = `
                    <label>
                       请输入 hi 群号: 
                       <input id="imTo" value="1549471" placeholder="默认发送至 1674687" style="border:1px solid #ccc;width: 150px;height: 50px;margin-right: 10px;padding: 4px 6px;border-radius: 4px;"/>
                    </label>
                    <br>
                    <div id="cmatch">
    ...
    if (startTime && endTime) {
        const processMap = {
            ...
            single: {
                name: '单台',
                stay: '15min',
                others: '\n辛苦验证:\n\tnativeads-render：bjyz-bac-orp-feed-ads-75838.bjyz:8270/common\n\tnativeads-cover：bjyz-bac-orp-ecom-odp-63504.bjyz:8200/common'
            },
            tcSide: {
                name: '单边',
                stay: '45min'
