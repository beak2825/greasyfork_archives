...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/538631/%D0%9A%D0%A4%20WHITE%28%D0%9E%D0%B1%D1%89%D0%B8%D0%B9%29.user.js
// @updateURL https://update.greasyfork.org/scripts/538631/%D0%9A%D0%A4%20WHITE%28%D0%9E%D0%B1%D1%89%D0%B8%D0%B9%29.meta.js
// ==/UserScript==
...

    {
    ...
    },
     {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
        `[B][CENTER][COLOR=#FFFF00]${greeting}, уважаемый(ая) ${user.mention} [/COLOR][/CENTER][/B]<br><br>`+
        `[B][CENTER][COLOR=lavender]Игрок будет наказан по данному пункту правил:<br>4.09. Запрещено использовать никнейм, содержащий в себе матерные слова или оскорбления (в том числе завуалированные), а также слова политической или религиозной направленности. | Устное замечание + смена игрового никнейма / PermBan <br><br>`+
        `[CENTER][B][COLOR=RED]| [Color=lavender]Благодарю за обращение. [COLOR=RED]|<br>`+
         `[B][CENTER][COLOR=lavender]Приятной игры на  [COLOR=rgb(209, 213, 216)]WHITE[/COLOR].<br><br>`+
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>',
      prefix: ACCEPT_PREFIX,
...
$(document).ready(() => {
        ...
        addButton(`Открепить тему Одобрено`, `accepted`);
        addButton(`Открепить тему Отказано`, `unaccept`);
