...
// @namespace yyyzzz999
// @author yyyzzz999
// @description (7/8/22) Warns about downloading based on resulting Ratio Loss due to forgetting to buy w/FL
...
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/418488/MAM%20Ratio%20Protect%20BETA.user.js
// @updateURL https://update.greasyfork.org/scripts/418488/MAM%20Ratio%20Protect%20BETA.meta.js
// ==/UserScript==
// Many Thanks to GardenShade, yyywwwyyyhhh, sora12192, Onigiri & ooglyboogly for advice, testing, and code contributions!
// Thanks to all the members who've sent me bug reports like ridel, stuartnz,
/*jshint esversion: 6 */
...
if (DEBUG) console.log("Welcome to MAM Ratio Protect v2.07!");
...
if (DEBUG) console.log("MAM Ratio Protect v2.07 Completed Normally.");
