...
// @version        3.5.5
// @downloadURL https://update.greasyfork.org/scripts/39818/YouTube%20HD%20Suite.user.js
// @updateURL https://update.greasyfork.org/scripts/39818/YouTube%20HD%20Suite.meta.js
// ==/UserScript==
...
var HdSuite = function () {
    ...
    this.checkVersionCallback = function( json ) {
        ...
        if ( json.rev > this.version.rev ) {
            ...
            a.href = '//userscripts-mirror.org/scripts/source/39167.user.js';
            a.title = 'Update now!';
    ...
    this.createMenu = function() {
        ...
        a = d.createElement('a');
        a.id   = 'hdsuite_logo';
        a.href = 'https://userscripts-mirror.org/scripts/show/39167';
        a.title = 'Go to userscripts-mirror.org page.';
    ...
    this.checkVersion = function( force ) {
        ...
        if ( force || !last_update_check || (now - last_update_check) > (3600 * 24 * 1000) ) {
            ...
            script.src  = '//userscripts-mirror.org/scripts/source/92923.user.js';
