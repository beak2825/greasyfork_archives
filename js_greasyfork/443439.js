...
// @downloadURL https://update.greasyfork.org/scripts/443439/shumin-github.user.js
// @updateURL https://update.greasyfork.org/scripts/443439/shumin-github.meta.js
// ==/UserScript==

function github_part(){
...
if ( window.location.host.indexOf("github") >= 0 ) github_part();
else if ( window.location.host.indexOf("sourcegraph") >= 0 ) sourcegraph_part();