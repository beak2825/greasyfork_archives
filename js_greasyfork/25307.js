...
// @downloadURL https://update.greasyfork.org/scripts/25307/x4%E7%9A%84%E5%A4%BA%E5%AE%9D%E5%B2%9B%E8%84%9A%E6%9C%AC%E2%80%A2%E6%94%B92.user.js
// @updateURL https://update.greasyfork.org/scripts/25307/x4%E7%9A%84%E5%A4%BA%E5%AE%9D%E5%B2%9B%E8%84%9A%E6%9C%AC%E2%80%A2%E6%94%B92.meta.js
// ==/UserScript==
var sdiv = $('<div><b>最高出价<input id="maxpirce" type="text" maxlength="5" style="width:55px;">' +
             '<input type="checkbox" id="notestchujia">正式出价  | ' +
             '监测间隔<input type="text" id="checkppp" value="50" style="width:25px;"></b>' +
            ...
            runtimer = setInterval(function () {
                ...
                if (ttimenum <= 2000) {
                    ...
                    $.getJSON(document.location.protocol + '//dbditem.jd.com/json/current/englishquery?paimaiId=' + paimaiId + '&skuId=0&start=0&end=1', function (data) {
                        ...
                        if (oldjia !== 0) nowjia = 4;// nowp - oldjia;
                        ...
                        if (ttimenum <= (1050 + cbkttt + checktimess)) {
                            ...
                            if (myygcj > parseInt($('#maxpirce').val())  && parseInt($('#maxpirce').val()) >= nowp) { //出价大于最大价格
                                myygcj = parseInt($('#maxpirce').val());
                            }
