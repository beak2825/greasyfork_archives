// ==UserScript==
// @name              Joker的VIP破解脚本
// @namespace         Joker的VIP破解脚本
// @version           1.0
// @description       【❤️ 视频解析，体会拥有VIP的感觉❤️，完全免费，无广告】
// @author            Joker
...
// @charset		      UTF-8
// @license           GPL License
// @downloadURL https://update.greasyfork.org/scripts/432545/Joker%E7%9A%84VIP%E7%A0%B4%E8%A7%A3%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/432545/Joker%E7%9A%84VIP%E7%A0%B4%E8%A7%A3%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
const superVip = (function () {
    ...
    const _CONFIG_ = {
        ...
        videoParseList: [
            {"name": "高速通道0", "type": "3", "url": "https://jx.bozrc.com:4433/player/?url="},
            {"name": "高速通道1", "type": "1,3", "url": "https://jx.bozrc.com:4433/player/?url="},
            {"name": "高速通道2", "type": "1,3", "url": "https://api.okjx.cc:3389/jx.php?url="},
            {"name": "高速通道3", "type": "1,3", "url": "https://jx.playerjy.com/?url="},
            {"name": "高速通道4", "type": "1,3", "url": "https://jx.m3u8.tv/jiexi/?url="},
            ...
            {"name": "lele", "type": "1,3", "url": "https://lecurl.cn/?url="},
        ...
        playerContainers: [
            {
                ...
                name: "Default",
                displayNodes: ["#mask_layer", ".mod_vip_popup", "#mask_layer"]
            },
            {
                host: "m.v.qq.com",
            ...
            util.findTargetEle(_CONFIG_.currentPlayerNode.container)
                .then((container) => {
                    ...
                    if (type.includes("1")) {
                        ...
                        $(container).append(`<div style="${iframeDivCss}"><iframe id="iframe-player-4a5b6c" src="${url}" frameborder="0" allowfullscreen="true" width="100%" height="100%"></iframe></div>`);
                    }
                });
        }
