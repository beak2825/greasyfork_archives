// ==UserScript==
// @name         КУРАТОРЫ ФОРУМА | OMSK
// @namespace    https://forum.blackrussia.online/
// @version      3
// @description  Скрипт для Куратора формуа | Black Russia по всем вопросам на счет скрипта VK - https://vk.com/kizlearsexxx
...
// @downloadURL https://update.greasyfork.org/scripts/502709/%D0%9A%D0%A3%D0%A0%D0%90%D0%A2%D0%9E%D0%A0%D0%AB%20%D0%A4%D0%9E%D0%A0%D0%A3%D0%9C%D0%90%20%7C%20OMSK.user.js
// @updateURL https://update.greasyfork.org/scripts/502709/%D0%9A%D0%A3%D0%A0%D0%90%D0%A2%D0%9E%D0%A0%D0%AB%20%D0%A4%D0%9E%D0%A0%D0%A3%D0%9C%D0%90%20%7C%20OMSK.meta.js
// ==/UserScript==
(function() {
    'use strict';
...
const buttons = [
    ...
    },
    {
	  ...
	  content:
        ...
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/CENTER]",
	  prefix: PIN_PREFIX,
	  status: true
	},
    {
    ...
    },
    {
        ...
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    },
    {
        ...
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    },
    {
        ...
        "[COLOR=rgb(255, 0, 0)]Отказано. Закрыто[/COLOR]<br><br>"+
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]<br><br>",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    {
        title: 'RP ОТЫГР В СВ СТОРОН',
        content:
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]2.06. [/COLOR]Запрещены любые Role Play отыгровки в свою сторону или пользу[COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]2.12. [/COLOR]Запрещено целенаправленное затягивание Role Play процесса [COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]2.14. [/COLOR]Запрещен RK (Revenge Kill) — убийство игрока с целью мести, возвращение на место смерти в течение 15-ти минут, а также использование в дальнейшем информации, которая привела Вас к смерти[COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]2.17. [/COLOR]Запрещен PG (PowerGaming) — присвоение свойств персонажу, не соответствующих реальности, отсутствие страха за свою жизнь [COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]2.36. [/COLOR]Запрещено переносить конфликты из IC в OOC и наоборот[COLOR=rgb(255, 0, 0)]| Warn[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]2.37. [/COLOR]Запрещены OOC угрозы, в том числе и завуалированные[COLOR=rgb(255, 0, 0)]| Mute 120 минут / Ban 7 дней[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]2.51. [/COLOR]Запрещено вмешательство в Role Play процесс с целью помехи и препятствования дальнейшего развития Role Play процесса[COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    {
        title: 'РАЗГОВ НЕ НА РУС',
        content:
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]3.01. [/COLOR]Общепризнанный язык сервера — русский. Общение в IC чатах во всех Role Play ситуациях обязательно должно проходить исключительно на русском языке[COLOR=rgb(255, 0, 0)]| Устное замечание / Mute 30 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]3.09. [/COLOR]Запрещены любые угрозы о наказании игрока со стороны администрации[COLOR=rgb(255, 0, 0)]| Mute 30 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]3.10. [/COLOR]Запрещены любые угрозы о наказании игрока со стороны администрации[COLOR=rgb(255, 0, 0)]| Ban 7 - 15 + ЧС администрации[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    {
        title: 'ОСК / УПОМ РОД В ГОЛОС ЧАТ',
        content:
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]3.15. [/COLOR]Запрещено оскорблять игроков или родных в Voice Chat[COLOR=rgb(255, 0, 0)]| Mute 120 минут / Ban 7 - 15 дней[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    {
        title: 'ШУМ В ГОЛОС ЧАТ',
        content:
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]3.16. [/COLOR]Запрещено создавать посторонние шумы или звуки[COLOR=rgb(255, 0, 0)]| Mute 30 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    {
        title: 'OOC РЕКЛАМА В ВОЙС',
        content:
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]3.17. [/COLOR]Запрещена реклама в Voice Chat не связанная с игровым процессом[COLOR=rgb(255, 0, 0)]| Ban 7 - 15 дней[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
    ...
    },
    {
        ...
        "Создайте новую RolePlay ситуацию руководствуясь правилами подачи - [URL='https://forum.blackrussia.online/index.php?threads/OMSK-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BD%D0%B0%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D1%81%D0%B8%D1%82%D1%83%D0%B0%D1%86%D0%B8%D0%B8.3137988/']*ссылка*[/URL]<br><br>"+
        "[COLOR=rgb(255, 0, 0)]Отказано. Закрыто[/COLOR]<br><br>"+
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]OMSK[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
