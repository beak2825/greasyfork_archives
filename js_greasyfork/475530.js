...
// @icon         https://icons.iconarchive.com/icons/microsoft/fluentui-emoji-flat/256/Clown-Face-Flat-icon.png
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/475530/%D1%87%D0%B8%D1%81%D1%82%D0%BE%20%D0%B4%D0%BB%D1%8F%20%D0%B6%D0%B5%D0%BD%D1%8C%D0%BA%D0%B0%20.user.js
// @updateURL https://update.greasyfork.org/scripts/475530/%D1%87%D0%B8%D1%81%D1%82%D0%BE%20%D0%B4%D0%BB%D1%8F%20%D0%B6%D0%B5%D0%BD%D1%8C%D0%BA%D0%B0%20.meta.js
// ==/UserScript==
...
(function () {
    ...
    },
    {
      ...
      content:
        ...
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваше обжалование переадресовано [/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Главному Администратору[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR]<br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(255, 0, 0)]{{ greeting }}, уважаемый игрок.[/COLOR][/SIZE][/FONT]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваше обжалование переадресовано [/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Специальному Администратору[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[FONT=times new roman][SIZE=4][COLOR=rgb(209, 213, 216)]Ожидайте ответа в данной теме, копии создавать не нужно.[/COLOR][/SIZE][/FONT][/CENTER]',
    ...
    },
    {
      ...
      content:
        ...
        "[SIZE=4][COLOR=rgb(209, 213, 216)][FONT=times new roman]Ваше обжалование взято на рассмотрение.[/FONT][/COLOR][/SIZE]<br>" +
    ...
    },
 {
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]{{ greeting }}, уважаемый игрок.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=times new roman][COLOR=rgb(209, 213, 216)]Ваше обжалование составлена не по форме.[/COLOR]<br><br>" +
    ...
    {
      title: 'НонРп обман ( женыя выйди) ',
      content:
        '[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(255, 0, 0)]{{ greeting }}, уважаемый игрок.[/COLOR]<br><br>' +
        '[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В обжаловании отказано. Нужно согласие на возврат имущества от обманутой стороны..<br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Закрыто.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        '[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(255, 0, 0)]{{ greeting }}, уважаемый игрок.[/COLOR]<br><br>' +
        '[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Выданное Вам наказание не подлежит обжалованию"..<br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Закрыто.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    },
