...
// @downloadURL https://update.greasyfork.org/scripts/433753/%E9%82%A6%E5%BE%B7%E6%8F%90%E5%8F%96%E7%BD%91%E9%A1%B5%E5%B9%BF%E5%91%8A%E9%93%BE%E6%8E%A5.user.js
// @updateURL https://update.greasyfork.org/scripts/433753/%E9%82%A6%E5%BE%B7%E6%8F%90%E5%8F%96%E7%BD%91%E9%A1%B5%E5%B9%BF%E5%91%8A%E9%93%BE%E6%8E%A5.meta.js
// ==/UserScript==
...
(function() {
    ...
    function show_adhref(is_onload = 0, is_right = 1) {
        ...
        if (ahref_content !== '' ) {
            show_content +=  `<textarea id="textarea_getad" style="user-select:auto !important;position:fixed;top:5px;${right_field}:${position1};z-index:10000000  !important;width: 400px  !important;height:200px !important;">${desc}${ahref_content}</textarea>
                `;
        }
        if (ahref_samedomain_a_str !== '') {
            show_content += `<div id="" style="user-select:auto !important;color:#000 !important;overflow: scroll;text-align: left;cursor:pointer;background:#fff;position:fixed;top:300px;${right_field}:${position1};z-index:10000000;width: 400px;height:200px;">${desc}同域名:\r\n${ahref_samedomain_a_str}</div>
