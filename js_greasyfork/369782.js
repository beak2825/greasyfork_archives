...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/369782/ASITI%20History.user.js
// @updateURL https://update.greasyfork.org/scripts/369782/ASITI%20History.meta.js
// ==/UserScript==
...
(function() {
    ...
    function showTraining(training) {
        ...
        row.innerHTML = `<th>Trening</th><td>${training ? training.split('').join(' ') : '-'}</td>`;
