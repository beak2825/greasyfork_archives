...
// @icon         https://i.pinimg.com/736x/67/ff/6c/67ff6cb3239abd9fad499c58b2dfdb17.jpg
// @grant        none
// @license      none
// @supportURL   https://vk.com/lmHokage
// @downloadURL https://update.greasyfork.org/scripts/525625/%D0%93%D0%90%20%20%D0%97%D0%93%D0%90%20%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%7C%7C%20GRAY.user.js
// @updateURL https://update.greasyfork.org/scripts/525625/%D0%93%D0%90%20%20%D0%97%D0%93%D0%90%20%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%7C%7C%20GRAY.meta.js
// ==/UserScript==
     ...
     },
{
...
},
    {
      ...
      content:
        `[B]${greeting}.<br><br>`+
        `Внимательно ознакомившись с вашей жалобой было принято решение, что вам нужно обратиться в раздел жалоб на Администрацию → [URL='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.883/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/B]`,
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
      ...
      content:
        `[B]${greeting}.<br><br>`+
        `Внимательно ознакомившись с вашей жалобой было принято решение, что вам нужно обратиться в раздел Обжалование → [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.886/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/B]`,
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
	  ...
	  content:
		`[B]${greeting}.<br><br>`+
		`Внимательно ознакомившись с вашей жалобой было принято решение, что вам нужно обратиться в раздел жалоб на игроков → [URL='https://forum.blackrussia.online/forums/Жалобы-на-игроков.885/']*Кликабельно*[/URL]<br><br>`+
		`Закрыто.[/B]`,
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
		`[B]${greeting}.<br><br>`+
		`Внимательно ознакомившись с вашей жалобой было принято решение, что вам нужно обратиться в раздел жалоб на лидеров → [URL='https://forum.blackrussia.online/forums/Жалобы-на-лидеров.884/']*Кликабельно*[/URL]<br><br>`+
		`Закрыто.[/B]`,
        prefix: CLOSE_PREFIX,
        status: false,
	},
    {
      ...
      content:
        `[B]${greeting}.<br><br>`+
        `Внимательно ознакомившись с вашей жалобой было принято решение, что вам нужно обратиться в раздел жалоб на технических специалистов → [URL='https://forum.blackrussia.online/forums/Сервер-№19-gray.1200/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/B]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
	  ...
	  content:
		`[B]${greeting}.<br><br>`+
        `Ваша жалоба передана Основному Заместителю Главного Администратора — [USER=1300852]Will Winston[/USER].<br><br>`+
        `Ожидайте ответа.[/B]`,
      prefix: PIN_PREFIX,
	  status: true,
	},
    {
	  ...
	  content:
		`[B]${greeting}.<br><br>`+
        `Ваша жалоба передана Главному Администратору — [USER=407088]Diego Cooper[/USER].<br><br>`+
        `Ожидайте ответа.[/B]`,
      prefix: GA_PREFIX,
	  status: true,
    },
