// ==UserScript==
// @name       Hybrid - Calls - Contact (3 answers first question)
// @version    2.01
// @author	   jawz
...
// @downloadURL https://update.greasyfork.org/scripts/28235/Hybrid%20-%20Calls%20-%20Contact%20%283%20answers%20first%20question%29.user.js
// @updateURL https://update.greasyfork.org/scripts/28235/Hybrid%20-%20Calls%20-%20Contact%20%283%20answers%20first%20question%29.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Contact")').length) {
    ...
    createButton('DC',1,2,3,3,'Disconnected');
    createButton('DC - Directory',1,2,3,3,'Disconnected - Directory');
    createButton('DC - No Complete',1,2,3,3,'Disconnected - Could Not Complete');
