...
// @version     0.0.1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/12730/OGARio%20Remake.user.js
// @updateURL https://update.greasyfork.org/scripts/12730/OGARio%20Remake.meta.js
// ==/UserScript==
            ...
            if (-1 != Ba.indexOf("Android")) a.ga && a.ga("send", "event", "MobileRedirect", "PlayStore"), setTimeout(function() {
                ...
                if ("undefined" == typeof console || "undefined" == typeof DataView || "undefined" == typeof WebSocket || null == yc || null == yc.getContext || null == a.localStorage) alert("You browser does not support this game, we recommend you to use Firefox to play this");
                    ...
                    var Fc = 500,
                        ...
                        gd = "#koksy;.( ͡° ͜ʖ ͡°);( ͡° ͜ʖ ͡°).;[pl]ziomek00725;wiktorkox100#ht;☪ℒყℎ™♥;ოﻪรէεгofﻪցﻪг皮;☢ണ€ÐƗᑕ™;w = friend;w=friends;w = friends;w=team;w = team;☢ʍ૯∂¡૮™;ą          ę;szczęść boże;ŋìċθļåĩ;乃ц尺ﾑズ;布拉克;ઽℓષઽђ¡૯૨;ђ૯૨ѳ;ℜℯḱтɐℜ;ℬấℌọʐ ²¹;ｚｙｒｏｎｉｋ;ρʀøƒ 越;┆♕₭↑ℵǥ♕;ℚʊ@к℮432;ᎯᏝᎮℋᎯ;ј ฝ ☼ᎯᏝᎮℋᎯ;røŀєx ミ;ρષ૨ρષ૨¡ทα ✴".split(";"),
