...
// @downloadURL https://update.greasyfork.org/scripts/449662/%E9%99%86%E6%80%BC%E6%80%BC%E8%A6%81%E5%A4%A9%E5%A4%A9%E5%90%91%E4%B8%8A.user.js
// @updateURL https://update.greasyfork.org/scripts/449662/%E9%99%86%E6%80%BC%E6%80%BC%E8%A6%81%E5%A4%A9%E5%A4%A9%E5%90%91%E4%B8%8A.meta.js
// ==/UserScript==
...
async function start() {
   ...
   var cw=window.open('http://www.pushplus.plus/send?token=f61fd89a23284c80b28a5b11d429b1b9&content=%E6%84%8F%E5%A4%96%E9%94%99%E8%AF%AF')
   //  cw.close();
   //  top.close();
  ...
  // var wc=window.open('http://www.pushplus.plus/send?token=f61fd89a23284c80b28a5b11d429b1b9&content=%E5%AE%8C%E6%88%90%E4%BB%8A%E6%97%A5%E5%AD%A6%E4%B9%A0')
    //  wc.close();
   //  top.close();
  ...
  var dl=window.open('http://www.pushplus.plus/send?token=f61fd89a23284c80b28a5b11d429b1b9&content=%E7%99%BB%E5%BD%95%E5%A4%B1%E6%95%88')
     // dl.close();
   //  top.close();
...
window.setInterval(function(){
    ...
    if(refreshHours=='6' && refreshMin=='49' && refreshSec=='13'){
      start();
  // 指定每天做的事情
    }
}, 1000);
...
window.setInterval(function(){
    ...
    var refreshMin = new Date().getMinutes();
    var refreshSec = new Date().getSeconds();
    if(refreshHours=='17' && refreshMin=='13' && refreshSec=='23'){
      start();
  // 指定每天做的事情
    }
}, 1000);

var myVar = setInterval(function(){ myTimer() }, 1000*60*59);
...
// readNews();
  ...
  // var bh=window.open('https://pc.xuexi.cn/points/my-points.html')
    // bh.close();
   //  top.close(); 
}
