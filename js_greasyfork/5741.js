...
// @name          TakeMyFile Short Links Elongator

// @namespace     DevelopmentSimplyPut(developmentsimplyput.blogspot.com)

// @description   Elongates all TakeMyFile short links to their direct links

// @include       *

// @version 0.0.1.20141015205405
// @downloadURL https://update.greasyfork.org/scripts/5741/TakeMyFile%20Short%20Links%20Elongator.user.js
// @updateURL https://update.greasyfork.org/scripts/5741/TakeMyFile%20Short%20Links%20Elongator.meta.js
// ==/UserScript==
...
function GetDirectLink(str)
{
	GM_xmlhttpRequest(
							{
								method: "GET",
								url: 'http://tmf.myegy.com/2-ar.php?id=' + str.replace('http://takemyfile.com/',""),
...
var Urls=new Array();
var UrlsPattern=/http:\/\/takemyfile\.com\/(?:\w*)/g;
