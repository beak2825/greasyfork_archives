// ==UserScript==
// @name        YAKUTSK | ГА/ЗГА/Кураторы by Voodman
// @namespace    http://forum-limerussia.hgweb.ru/index.php
// @version      1.1
// @description  Специально для BlackRussia || YAKUTSK by S.Voodman
// @author       S.Voodman| YAKUTSK
// @match        http://forum-limerussia.hgweb.ru/index.php?threads/*
// @include     http://forum-limerussia.hgweb.ru/index.php?threads/
// @match       http://forum-limerussia.hgweb.ru/index.php?threads/*
// @include     http://forum-limerussia.hgweb.ru/index.php?forums/
// @match       http://forum-limerussia.hgweb.ru/index.php?forums/Сервер-№1-red.28/post-thread&inline-mode=1*
// @include        http://forum-limerussia.hgweb.ru/index.php?forums/Сервер-№1-red.28/post-thread&inline-mode=1*
// @icon         https://icons.iconarchive.com/icons/aha-soft/iron-man/48/Ironman-Mask-3-Old-icon.png
// @grant        none
// @license      MIT
// @supportURL https://vk.com/id659131672
// @downloadURL https://update.greasyfork.org/scripts/544954/YAKUTSK%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20by%20Voodman.user.js
// @updateURL https://update.greasyfork.org/scripts/544954/YAKUTSK%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20by%20Voodman.meta.js
// ==/UserScript==
...
(async function () {
    ...
    //      `Пожалуйста, прикрепите доказательства к жалобе, которые подтверждают нарушение администратора.<br><br>`+
        //      `[COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере YAKUTSK.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
    ...
    //         `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере YAKUTSK [/COLOR][/CENTER]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
    //  },
    //  {
    ...
    //         `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на серверае YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
	//  },
    //  {
	...
	},
    {
	  ...
	  content:
        ...
        `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
            ...
            `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
            prefix: UNACCEPT_PREFIX,
            status:false,
    },
	// {
    ...
    },
    {
        ...
        content:
            ...
            `[CENTER][COLOR=rgb(0, 255, 0)]Рассмотрено. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
	...
	},*/
    {
        ...
        content:
            ...
            `[CENTER]Отказано, закрыто Приятной игры на сервере YAKUTSK[/CENTER][/FONT][/SIZE]<br><br>`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    },
    ...
    },
    {
	  ...
	  content:
		...
		`[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
	{
    ...
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  [user=304273]Aleksey_Bootman[/user]<br><br>`+
	...
	},
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Основному Заместителю Главного Администратора —  [user=2079621]John_Harris[/user] <br><br>`+
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
	...
	//   content:
	// 	`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
    //     `[CENTER]Передаю вашу жалобу Главному Администратору — Pasha_Versachi <br><br>`+
    //     `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
    //   prefix: GA_PREFIX,
	//   status: true,
	// },
    ...
    },
    {
        ...
        `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
            ...
            content:
            `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
            `[CENTER][SIZE=4][FONT=georgia]Ваша жалоба передана - [COLOR=rgb(246, 207, 0)]Руководству Модерации[/COLOR].<br><br>`+
            `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
 ...
 },
    {
        ...
        `[CENTER][COLOR=rgb(0, 255, 0)]Одобрено. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: ACCEPT_PREFIX,
        status: false,
    },
    {
        ...
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/FONT][/SIZE][/CENTER]`,
        prefix: PIN_PREFIX,
        status:true,
    },
    {
        ...
        `[COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
      ...
      `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
      ...
      `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
       ...
       `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/SIZE][/FONT]<br>`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю ваше обжалование Главному Администратору —  [user=1098111]Pasha_Versachi[/user] <br><br>`+
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
      prefix: GA_PREFIX,
	  status: true,
    },
    ...
    const buttons2 = [
      ...
      content: `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто. Приятной игры на сервере YAKUTSK[/CENTER][/color]`,
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    // {
    ...
    const buttons3 = [
        ...
        },
        {
            ...
            content:
                ...
                `[CENTER][COLOR=rgb(0, 255, 0)]Одобрено. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER]Передаю вашу жалобу Главному Администратору —  [user=1098111]Pasha_Versachi[/user] <br><br>`+
                `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
            prefix: GA_PREFIX,
            status: true,
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] ${user.mention}[/CENTER]<br><br>`+
                `[CENTER]Ваша жалоба была передана на рассмотрение техническому специалисту.[/CENTER]<br><br>` +
                `[CENTER][COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
            prefix: TECH_PREFIX,
            status: true,
        },
        {
