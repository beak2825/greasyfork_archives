...
// @downloadURL https://update.greasyfork.org/scripts/523844/MEXC%20Auto%20Trade%20Button.user.js
// @updateURL https://update.greasyfork.org/scripts/523844/MEXC%20Auto%20Trade%20Button.meta.js
// ==/UserScript==
...
(function() {
    ...
    const CONSTANTS = {
        ...
        CHECK_INTERVAL: 3000,
        FIB_LEVELS: [0.5, 0.236, -0.236, -0.5]
    };
    ...
    const TradingHandler = {
        ...
        executeNormalTrade: (inputs) => {
            ...
            Utils.modifyReactInput(SELECTORS.TAKE_PROFIT, fibLevels[0.5]);
