...
// @version      0.48
// @description  Puyo Puyo Tetris theme for Jstris
// @author       Oki, Eddie, Harry
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/412140/PPT%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/412140/PPT%20Theme.meta.js
// ==/UserScript==
...
function CustomSFXset(){
    ...
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_died.wav",abs:1,set:1};
...
function atGameStart() {
    ...
    img.onload = function(){
        ...
        bgctx.drawImage(img,46,115,482,564); // Or at whatever offset you like
    };
    img.src = "https://i.imgur.com/aSyckzS.png";
...
queueCopy0.style.transform = "scale(0.75,0.75) translate(3px, -14px)"
queueCopy1.style.transform = "scale(0.65,0.65) translate(-3px, -18px)"
queueCopy2.style.transform = "scale(0.65,0.65) translate(-3px, -34px)"
queueCopy3.style.transform = "scale(0.65,0.65) translate(-3px, -46px)"
queueCopy4.style.transform = "scale(0.65,0.65) translate(-3px, -56px)"


holdCanvas.style.float = "none"
holdCanvas.style.position = "absolute"
holdCanvas.style.transform = "scale(0.7,0.7)"
holdCanvas.style.top = "5px"
holdCanvas.style.left = "16px"
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_tspinsingle.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_tspinmini.wav",
"https://raw.githubusercontent.com/lightminn/PPT-arle/5cef8f725164286ef4d861c53ed2a8d9fa726741/clear1.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_tspindouble.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_tspintriple.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_clear4.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_perfectclear.wav",   //no sound exists for TB
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_tspindouble.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/PPT_clear4.wav"
];
