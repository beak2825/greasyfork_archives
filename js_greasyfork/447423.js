// ==UserScript==
// @name         GD教师JXJY信息管理平台-公需课
// @namespace    https://greasyfork.org/
// @version      1.24.04
// @description  GD教师JXJY信息管理平台GXK
// @author       Cosil.C
// @match        http*://jsxx.gdedu.gov.cn/*
// @match        http*://jsglpt.gdedu.gov.cn/login*
// @icon         https://jsglpt.gdedu.gov.cn/favicon.ico
// @license      GPL
// @downloadURL https://update.greasyfork.org/scripts/447423/GD%E6%95%99%E5%B8%88JXJY%E4%BF%A1%E6%81%AF%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0-%E5%85%AC%E9%9C%80%E8%AF%BE.user.js
// @updateURL https://update.greasyfork.org/scripts/447423/GD%E6%95%99%E5%B8%88JXJY%E4%BF%A1%E6%81%AF%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0-%E5%85%AC%E9%9C%80%E8%AF%BE.meta.js
// ==/UserScript==
    ...
    function handleTest() {
        ...
        let data = {
            "百县千镇万村高质量发展工程与城乡区域协调发展": [
                "C", "A", "C", "B", "A",
                "B", "D", "C", "D", "D",
                "ABC", "ABD", "ABC", "ABC", "ABCD",
                "ABCDE", "ABCDE", "ABCD", "ABC",
                "A", "A", "B", "A", "A",
                "A", "B", "B", "A", "A"
            ],
            "新质生产力与高质量发展": [
        ...
        let map = {"a": 0, "A": 0, "b": 1, "B": 1, "c": 2, "C": 2, "d":3, "D": 3, "e": 4, "E": 4};
