// ==UserScript==
// @name   🌱【免费版】新疆建设职业技术学院培训中心过人脸|如需自动下一集、过人脸识别、考试自动答题等高级功能见收费版本：https://doc.zhanyc.cn/pages/xjjszyjsxy/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、过人脸识别、考试自动答题等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.xjjsxy.net.cn/*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/513688/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%96%B0%E7%96%86%E5%BB%BA%E8%AE%BE%E8%81%8C%E4%B8%9A%E6%8A%80%E6%9C%AF%E5%AD%A6%E9%99%A2%E5%9F%B9%E8%AE%AD%E4%B8%AD%E5%BF%83%E8%BF%87%E4%BA%BA%E8%84%B8%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%BF%87%E4%BA%BA%E8%84%B8%E8%AF%86%E5%88%AB%E3%80%81%E8%80%83%E8%AF%95%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxjjszyjsxy.user.js
// @updateURL https://update.greasyfork.org/scripts/513688/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%96%B0%E7%96%86%E5%BB%BA%E8%AE%BE%E8%81%8C%E4%B8%9A%E6%8A%80%E6%9C%AF%E5%AD%A6%E9%99%A2%E5%9F%B9%E8%AE%AD%E4%B8%AD%E5%BF%83%E8%BF%87%E4%BA%BA%E8%84%B8%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%BF%87%E4%BA%BA%E8%84%B8%E8%AF%86%E5%88%AB%E3%80%81%E8%80%83%E8%AF%95%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxjjszyjsxy.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需如需自动下一集、过人脸识别、考试自动答题等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/xjjszyjsxy/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("/coursePlay/")) {
                plugMain.page_video();
            } else if (url.includes("/examProcess/")) {
        ...
        async page_video() {
            ...
            await plugMain.waitOf((a) => $(".courseName").length > 0);
            ...
            let $el = null;
            $(".courseName").each((i, el) => {
                if (
                    $(el).parents("li:first").is(".active") ||
                    $(el).parents("li:first").find(".studyOver").length > 0
                ) {
                    return true;
                }
                $el = $(el);
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (plugMain.getElByText($(".el-dialog__title"), "摄像头") != null) {
                    ...
                    // if ($(`[aria-label="摄像头"]`).is(":visible")) {
                    //   plugMain.getElByText($(`[aria-label="摄像头"] button`), "确 定").click();
                    //   return;
                    // }
