// ==UserScript==
// @name           REAL Debrid Download Helper by ekstra26
// @namespace      extra2019
// @version        2019v1
// @author         kuehlschrank (updated by Ramses then extra26)
// @description    Downloads files, copies URLs and queues magnet links by real-debrid.com.
// @include        http*
...
// @downloadURL https://update.greasyfork.org/scripts/380327/REAL%20Debrid%20Download%20Helper%20by%20ekstra26.user.js
// @updateURL https://update.greasyfork.org/scripts/380327/REAL%20Debrid%20Download%20Helper%20by%20ekstra26.meta.js
// ==/UserScript==
...
var servs = [
	
	{
		...
		headers:function(h) { h['Authorization'] = 'Bearer 7QYYP5H2IVXIUPJN77AZDJXEYZGNPAK5NGYDJRV5ME4P562NYGXA' ; return h; },
...
function setRealDebridToken() {
	...
	if(typeof t == 'string') {
		GM_setValue('7QYYP5H2IVXIUPJN77AZDJXEYZGNPAK5NGYDJRV5ME4P562NYGXA', t.trim());
	}
}
