...
// @exclude        */frames*
// @exclude        */brd.php*
// @downloadURL https://update.greasyfork.org/scripts/394657/hwm_adv_dd_menu.user.js
// @updateURL https://update.greasyfork.org/scripts/394657/hwm_adv_dd_menu.meta.js
// ==/UserScript==
...
my_links.push('<a href="auction.php?cat=helm&sort=0&art_type=helmet17">Шлем рассвета</a>');
my_links.push('<a href="auction.php?cat=cuirass&sort=0&art_type=armor17">Кираса рассвета</a>');
my_links.push('<a href="auction.php?cat=boots&sort=0&art_type=boots17">Сапоги рассвета</a>');
my_links.push('<a href="auction.php?cat=necklace&sort=0&art_type=wzzamulet16">Амулет битвы</a>');
my_links.push('<a href="auction.php?cat=shield&sort=0&art_type=shield16">Щит пламени</a>');
my_links.push('<a href="auction.php?cat=weapon&sort=0&art_type=sword18">Гладий предвестия</a>');
my_links.push('<a href="auction.php?cat=necklace&sort=0&art_type=clover_amul">КФ</a>');
my_links.push('<a href="auction.php?cat=cloack&sort=0&art_type=finecl">ПС</a>');
my_links.push('<a href="auction.php?cat=weapon&sort=0&art_type=super_dagger">КП</a>');
my_links.push('<a href="auction.php?cat=weapon&sort=0&art_type=lbow">ЛС</a>');
my_links.push('<a href="auction.php?cat=weapon&sort=0&art_type=cold_sword2014">МХ</a>');
my_links.push('<a href="auction.php?cat=ring&sort=0&art_type=sun_ring">КС</a>');
my_links.push('<a href="auction.php?cat=ring&sort=0&art_type=coldring_n">КХ</a>');
my_links.push('<a href="auction.php?cat=weapon&sort=0&art_type=ssword10">Меч отваги</a>');
my_links.push('<a href="auction.php?cat=necklace&sort=0&art_type=samul17">Оскал дракона</a>');
// etc.
...
if ( replace_chat && my_links.length>0 ) {
	...
	if ( all_li_subnav ) {
		all_li_subnav.parentNode.innerHTML = '<font color="f5c137">&nbsp;<b>Рынок</b>&nbsp;</font>';
