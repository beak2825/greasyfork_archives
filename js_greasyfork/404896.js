...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/404896/EX%E6%A0%87%E7%AD%BE%E6%B1%89%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/404896/EX%E6%A0%87%E7%AD%BE%E6%B1%89%E5%8C%96.meta.js
// ==/UserScript==
var tag = {};
...
tag['tatsuta'] = "龙田";tag['tenryuu'] = "天龙";tag['yozora mikazuki'] = "三日月夜空";tag['rika shiguma'] = "志熊理科";tag['demon'] = "恶魔";tag['eromazun'] = "エロマズン";tag['ma-kurou | madou'] = "まー九郎";tag['smalldom'] = "体格差";
...
tag['hino hino'] = "緋乃ひの";tag['saihate-kukan'] = "最果て空間";tag['mutou mato'] = "武藤まと";tag['tamatamasanmyaku'] = "たまたま山脈";tag['tamatanuki'] = "たまたぬき";tag['codeine girl'] = "コデインガール";tag['ui kozeki'] = "古关忧";
...
tag['akikusa peperon'] = "秋草ぺぺろん";tag['nakano sora'] = "中乃空";tag['very long hair'] = "超长头发";tag['kurohonyasan'] = "くろほんやさん";tag['yamashita kurowo'] = "山下クロヲ";tag['bai asuka'] = "唄飛鳥";tag['cirno'] = "琪露诺";
...
tag['sabaku'] = "砂漠";tag['shaian'] = "しゃいあん";tag['nazunaya honpo'] = "薺屋本舗";tag['yamazaki kazuma'] = "山崎かずま";tag['hirari'] = "ひらり";tag['hirahira'] = "ひらひら";tag['living clothes'] = "活体衣服";tag['kama'] = "迦摩";
tag['binsen'] = "びんせん";tag['stirrup legwear'] = "踩脚袜";tag['tamachi yuki'] = "たまちゆき";tag['narusawa kei'] = "なるさわ景";tag['riamu yumemi'] = "梦见璃亚梦";tag['nejimaki kougen'] = "ねじまきこうげん";tag['yuuka hayase'] = "早濑优香";
...
tag['eula lawrence'] = "优菈·劳伦斯";tag['clarisse'] = "克拉莉丝";tag['madoka higuchi'] = "樋口 円香";tag['aya shameimaru'] = "射命丸 文";tag['byakuren hijiri'] = "聖 白蓮";tag['momiji inubashiri'] = "犬走 椛";tag['yuzu hanaoka'] = "花冈柚子";
...
tag['hibiki ganaha'] = "我那霸响";tag['cervix prolapse'] = "宫颈脱垂";tag['clit stimulation'] = "刺激阴蒂";tag['nipple stimulation'] = "刺激乳头";tag['school gym uniform'] = "学校体操服";tag['eirin yagokoro'] = "八意 永琳";
tag['blue archive'] = "碧蓝档案";tag['mutsuki asagi'] = "浅黄睦月";tag['hina sorasaki'] = "空崎日奈";tag['asuna ichinose'] = "一之濑明日奈";tag['alice tendou'] = "天童爱丽丝";tag['momoi saiba'] = "才羽桃井";tag['midori saiba'] = "才羽绿";
tag['multiple orgasms'] = "连续高潮";tag['transparent clothing'] = "情趣透明服";tag['autofellatio'] = "自己口活";tag['autopaizuri'] = "自己玩奶";tag['sensei'] = "老师";tag['hifumi ajitani'] = "阿慈谷日富美";tag['ai generated'] = "AI生成";
tag['aoko aozaki'] = "苍崎青子";tag['mahou tsukai no yoru | witch on the holy night'] = "魔法使之夜";tag['high heels'] = "高跟鞋";tag['multiple handjob'] = "多人手淫";tag['rough translation'] = "机翻";tag['multiple handjob'] = "多人手淫";
tag['extraneous ads'] = "有广告";tag['anko mitarashi'] = "御手洗红豆";tag['kurenai yuhi'] = "夕日紅";tag['painted nails'] = "美甲";tag['oshi no ko'] = "我推的孩子";tag['akane kurokawa'] = "黑川茜";tag['aqua hoshino'] = "星野爱久爱海";
tag['kana arima'] = "有马加奈";tag['ruby hoshino'] = "星野 瑠美衣";tag['aponia'] = "阿波尼亚";tag['honkai gakuen'] = "崩壊学園";tag['raiden shogun'] = "雷電 将軍";tag['gotoubun no hanayome | the quintessential quintuplets'] = "五等分的花嫁";
tag['nino nakano'] = "中野 二乃";tag['rakudai kishi no cavalry | chivalry of a failed knight'] = "落第骑士英雄谭";tag['stella vermillion'] = "史黛菈·法米利昂";tag['goddess of victory nikke'] = "勝利の女神NIKKE";tag['clay'] = "克雷伊";
tag['mushoku tensei'] = "无职转生";tag['hilda boreas greyrat'] = "希尔达·伯雷亚斯·格雷拉特";tag['wuthering waves'] = "鸣潮";tag['cantarella'] = "坎特蕾拉";tag['mato seihei no slave'] = "魔都精兵的奴隶";tag['ren yamashiro'] = "山城恋";
tag['seishun buta yarou wa bunny girl senpai no yume o minai'] = "青春猪头少年不会梦到兔女郎学姐";tag['mai sakurajima'] = "桜島 麻衣";tag['ryuu lion'] = "琉·利昂";tag['kyokou suiri'] = "虚構推理";tag['yuki-onna'] = "雪女";tag['chizuru ichinose'] = "一之濑千鹤";
tag['honkai star rail'] = "崩坏: 星穹铁道";tag['himeko'] = "姫子";tag['kafka'] = "卡芙卡";tag['sephie michaela deviluke'] = "赛菲·米卡埃拉·戴比路克";tag['saeko busujima'] = "毒岛冴子";tag['kanojo okarishimasu | rent-a-girlfriend'] = "租借女友";
tag['cinderella'] = "灰姑娘";tag['dorothy'] = "多萝西";tag['maiden'] = "玛伊登";tag['rapi'] = "拉毗";tag['soda'] = "苏打";tag['astra yao'] = "耀嘉音";tag['carlotta'] = "珂莱塔";tag['ruan mei'] = "阮梅";tag['sirius'] = "天狼星";tag['elsa granhiert'] = "艾尔莎·葛兰希尔黛 ";
tag['komi-san wa komyushou desu.'] = "古见同学有交流障碍症";tag['shouko komi'] = "古見 硝子";tag['shuuko komi'] = "古見 秀子";tag['roxy migurdia'] = "洛琪希·米格路迪亚";tag['sylphiette'] = "希露菲叶特";tag['aether'] = "空";tag['yae miko'] = "八重神子 ";
tag['code geass'] = "Code Geass 反叛的鲁路修";tag['kallen stadtfeld | kallen kouzuki'] = "红月卡莲/卡莲·修坦菲尔特";tag['lelouch vi britannia'] = "鲁路修·Vi·布里塔尼亚";tag['mrs. yuigahama'] = "由比滨结衣的母亲";tag['maya yotsuba'] = "四葉真夜";
tag['shokugeki no soma'] = "食戟之灵";tag['alice nakiri'] = "薙切 愛里寿";tag['erina nakiri'] = "薙切 绘里奈";tag['ryou kurokiba'] = "黑木场凉";tag['souma yukihira'] = "幸平 創真";tag['spy x family'] = "间谍过家家";tag['yor forger'] = "约尔·福杰";
tag['sono bisque doll wa koi o suru | my dress-up darling'] = "更衣人偶坠入爱河";tag['marin kitagawa'] = "喜多川海梦";tag['lipstick mark'] = "唇印";tag['aegir'] = "埃吉尔";tag['ai hoshino'] = "星野爱";
tag['tsujou kougeki ga zentai kougeki de 2-kai kougeki no okaasan wa suki desu ka | do you love your mom and her two-hit multi-target attacks'] = "普通攻击是全体二连击，这样的妈妈你喜欢吗？";tag['mamako oosuki'] = "大槻真守子";
...
document.body.innerHTML = document.body.innerHTML.replace(/Search Keywords/g, '搜索关键词');document.body.innerHTML = document.body.innerHTML.replace(/pages/g, '页');
document.body.innerHTML = document.body.innerHTML.replace(/many/g, '很多');document.body.innerHTML = document.body.innerHTML.replace(/Thumbnail/g, '略缩图');
...
document.body.innerHTML = document.body.innerHTML.replace(/Misc/g, '其它');document.body.innerHTML = document.body.innerHTML.replace(/First/g, '第一页');
document.body.innerHTML = document.body.innerHTML.replace(/Prev/g, '上一页');document.body.innerHTML = document.body.innerHTML.replace(/Next/g, '下一页');
document.body.innerHTML = document.body.innerHTML.replace(/Last/g, '最后一页');document.body.innerHTML = document.body.innerHTML.replace(/Jump/g, '跳转');
document.body.innerHTML = document.body.innerHTML.replace(/Seek/g, '搜索');document.body.innerHTML = document.body.innerHTML.replace(/Found about/g, '找到');
document.body.innerHTML = document.body.innerHTML.replace(/results/g, '个结果');document.body.innerHTML = document.body.innerHTML.replace(/Found/g, '一共有');
document.body.innerHTML = document.body.innerHTML.replace(/Normal/g, '小缩图');document.body.innerHTML = document.body.innerHTML.replace(/Large/g, '大略缩图');
