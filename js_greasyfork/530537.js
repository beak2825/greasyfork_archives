// ==UserScript==
// @name         Скрипт для кураторов форума 29
// @namespace    https://forum.blackrussia.online
// @version      2.1
// @description
// @author       Alvaro_Morennis
...
// @downloadURL
// @updateURL
// @description author Alvaro_Morennis
// @downloadURL https://update.greasyfork.org/scripts/530537/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%2029.user.js
// @updateURL https://update.greasyfork.org/scripts/530537/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%2029.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
     ...
     },
     {
      ...
      content:
	            "[QUOTE][CENTER][FONT=TIMES NEW ROMAN] [[COLOR=rgb(255, 255, 0)]{{greeting}}, уважаемый-(ая) {{ user.name }} [/COLOR][/CENTER]<br><br>"+
                '[IMG]https://i.postimg.cc/gkW3s4Ff/index-1.png[/IMG]<br>'+ 
    ...
    },
	 {
      title: 'ГКФ',
      content:
	"[QUOTE][CENTER][FONT=TIMES NEW ROMAN][[COLOR=rgb(255, 255, 0)] {{greeting}}, уважаемый-(ая) {{ user.name }} [/COLOR][/CENTER][/QUOTE]<br><br>"+
 ...
 
     {
      title: 'ГА',
      content:
	"[B][CENTER][FONT=TIMES NEW ROMAN][[COLOR=rgb(255, 255, 0)]{{greeting}} ，уважаемый-(ая) {{ user.name }} [/ICODE][/COLOR][/CENTER]<br><br>"+
    '[IMG]https://i.postimg.cc/gkW3s4Ff/index-1.png[/IMG]<br>'+ 
    ...
    },
	{
      title: 'Теху',
      content:
        "[B][QUOTE][CENTER][FONT=TIMES NEW ROMAN][[COLOR=rgb(255, 255, 0)]{{greeting}},уважаемый-(ая) {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[IMG]https://i.postimg.cc/gkW3s4Ff/index-1.png[/IMG]<br>'+ 
 ...
 prefix: CLOSE_PREFIX,
	...
	},
	{
      title: 'Жалобы на Лд',
	  content:
	    "[B][CENTER][FONT=TIMES NEW ROMAN][[COLOR=rgb(255, 255, 0)]{{greeting}} ，уважаемый-(ая) {{ user.name }} [/COLOR][/CENTER]<br><br>"+
    ...
    },
{
      ...
      content:
        '[[COLOR=rgb(255, 255, 0)][FONT=Georgia][QUOTE][CENTER][I]{{ greeting }}, уважаемый-(ая) {{ user.mention }}.[/color][/CENTER]<br>' +
    ...
    },
{
    ...
    {
      title: 'Ник не совпадает с доками',
      content:
       "[B][CENTER][FONT=TIMES NEW ROMAN][[COLOR=rgb(255, 255, 0)]{{greeting}} ,уважаемый-(ая) {{ user.name }} [/COLOR][/CENTER]<br><br>"+
 
		" [FONT=georgia] [B][CENTER]NickName игрока в форме подачи отличается от игрока в доказательствах.<br><br>" +
		"[FONT=TIMES NEW ROMAN] [I][SIZE=3][COLOR=LightSlateGray]  Ознакомиться с правилами подачи жалоб на игроков можно [/COLOR][URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-игроков.3429394/'][Color=crimson][U]*тут*[/U][/color][/URL].[/CENTER]<br><br>" +
		 '[CENTER][FONT=TIMES NEW ROMAN] [COLOR=RED]  Отказано [/COLOR][/FONT] [/CENTER]'+
       '[IMG]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG]<br>',
    ...
    },
     {
      ...
      content:
       "[B][CENTER][FONT=TIMES NEW ROMAN][[COLOR=rgb(255, 255, 0)]{{greeting}} ,уважаемый-(ая) {{ user.name }} [/COLOR][/CENTER]<br><br>"+
		...
		" [FONT=georgia] [B][CENTER]По предоставленным доказательствам, не можем выдать наказание..<br><br>" +
		"[FONT=TIMES NEW ROMAN] [I][SIZE=3][COLOR=LightSlateGray]  Ознакомиться с правилами подачи жалоб на игроков можно [/COLOR][URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-игроков.3429394/'][Color=crimson][U]*тут*[/U][/color][/URL].[/CENTER]<br><br>" +
		 '[CENTER][FONT=TIMES NEW ROMAN] [COLOR=RED]  Отказано [/COLOR][/FONT] [/CENTER]'+
       '[IMG]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG]<br>',
    ...
    },
{
      title: 'Мат в VIP чат',
      content:
		'[[COLOR=rgb(255, 255, 0)][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый-(ая) {{ user.name }}.[/color][/CENTER]<br>' +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 140, 0)][B][SIZE=1]Rostov[/SIZE][/B][/COLOR]"+
    ...
    },
    {
	  ...
	  content:
'[CENTER][B][FONT=TIMES NEW ROMAN][[COLOR=rgb(255, 255, 0)][SIZE=1]{{greeting}} ,уважаемый-(ая) {{user.name}}[/SIZE][/COLOR]<br><br>' +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 140, 0)][B][SIZE=1]Rostov[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
        ...
        " [FONT=georgia] [B][CENTER]Запрещено рекламировать на серверах любые проекты, серверы, сайты, сторонние Discord-серверы, YouTube каналы и тому подобное[COLOR=RED]| Ban 7 дней / PermBan [/COLOR]<br><br>" +
 '[CENTER][FONT=TIMES NEW ROMAN] [COLOR=lightgreen]  Одобрено [/COLOR][/FONT] [/CENTER]'+
    ...
    },
{
      ...
      content:
        '[[COLOR=rgb(255, 255, 0)][FONT=TIMES NEW ROMAN][CENTER][I]{{ greeting }}, уважаемый-(ая) {{ user.mention }}.[/color][/CENTER]<br>' +
