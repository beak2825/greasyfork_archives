...
// @downloadURL https://update.greasyfork.org/scripts/6628/MouseHunt%20AutoBot%20Enhanced%20Edition.user.js
// @updateURL https://update.greasyfork.org/scripts/6628/MouseHunt%20AutoBot%20Enhanced%20Edition.meta.js
// ==/UserScript==
...
function embedTimer(targetPage) {
    if (showTimerInPage) {
        ...
        if (headerElement) {
            ...
            preferenceHTMLStr += '</select> Current Selection : Burroughs Rift(Green)';
