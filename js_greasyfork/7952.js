...
if (typeof CookieCheat === "undefined") {
	var CookieCheat = {
		...
		numFormats: {
			...
			"fullNamesShortScale": [
				{ name: "Tredecillion", plural: "Tredecillion", num:  Math.pow(1000, 14) },
				{ name: "Duodecillion", plural: "Duodecillion", num:  Math.pow(1000, 13) },
				{ name: "Undecillion", plural: "Undecillion", num:  Math.pow(1000, 12) },
				{ name: "Decillion", plural: "Decillion", num:  Math.pow(1000, 11) },
				{ name: "Nonillion", plural: "Nonillion", num:  Math.pow(1000, 10) },
				{ name: "Octillion", plural: "Octillion", num:  Math.pow(1000, 9) },
				{ name: "Septillion", plural: "Septillion", num:  Math.pow(1000, 8) },
				{ name: "Sextillion", plural: "Sextillion", num:  Math.pow(1000, 7) },
				{ name: "Quintillion", plural: "Quintillion", num:  Math.pow(1000, 6) },
				{ name: "Quadrillion", plural: "Quadrillion", num:  Math.pow(1000, 5) },
				{ name: "Trillion", plural: "Trillion", num:  Math.pow(1000, 4) },
				{ name: "Billion", plural: "Billion", num:  Math.pow(1000, 3) },
				{ name: "Million", plural: "Million", num: Math.pow(1000, 2) },
				{ name: "Thousand", plural: "Thousand", num: 1000 },
				{ name: "", num: 1 }
			],
			...
			"fullNamesLongScale": [
				{ name: "Octillion", plural: "Octillion", num:  Math.pow(1000, 16) },
				{ name: "Septilliard", plural: "Septilliard", num:  Math.pow(1000, 15) },
				{ name: "Septillion", plural: "Septillion", num:  Math.pow(1000, 14) },
				{ name: "Sextilliard", plural: "Sextilliard", num:  Math.pow(1000, 13) },
				{ name: "Sextillion", plural: "Sextillion", num:  Math.pow(1000, 12) },
				{ name: "Quintilliard", plural: "Quintilliard", num:  Math.pow(1000, 11) },
				{ name: "Quintillion", plural: "Quintillion", num:  Math.pow(1000, 10) },
				{ name: "Quadrilliard", plural: "Quadrilliard", num:  Math.pow(1000, 9) },
				{ name: "Quadrillion", plural: "Quadrillion", num:  Math.pow(1000, 8) },
				{ name: "Trilliard", plural: "Trilliard", num:  Math.pow(1000, 7) },
				{ name: "Trillion", plural: "Trillion", num:  Math.pow(1000, 6) },
				{ name: "Billiard", plural: "Billiard", num:  Math.pow(1000, 5) },
				{ name: "Billion", plural: "Billion", num:  Math.pow(1000, 4) },
				{ name: "Milliard", plural: "Milliard", num:  Math.pow(1000, 3) },
				{ name: "Million", plural: "Million", num: Math.pow(1000, 2) },
				{ name: "Thousand", plural: "Thousand", num: 1000 },
				{ name: "", num: 1 }
			],
		...
		launch: function () {
			...
			if (!_.isUndefined(localStorage["CookieClickerCheatsBeautifyThem"])) {
				CookieCheat.currentNumFormat = JSON.parse(localStorage["CookieClickerCheatsBeautifyThem"]);
				CookieCheat.changeBeautify(CookieCheat.currentNumFormat)
			}
			if (!_.isUndefined(localStorage["CookieClickerCheatsShouldShowTimeLeft"])) {
				CookieCheat.shouldShowTimeLeft = JSON.parse(localStorage["CookieClickerCheatsShouldShowTimeLeft"]);
			}
			CookieCheat.miscVars.upgradesGenericsFunctions.addCpsForObjectUpgrades(CookieCheat.miscVars.upgradesGenericsFunctions.modifyObjectCps);
			CookieCheat.miscVars.upgradesGenericsFunctions.addCpsForPercentUpgrades(CookieCheat.miscVars.upgradesGenericsFunctions.modifyPercentCps);
			CookieCheat.miscVars.upgradesGenericsFunctions.achievsForAllObjects();
			...
			Game.Popup("Cookie Clicker Cheats v." + __VERSION__ + " launched !");
		...
		CookieCheat.Models = {
			AutoClickWrinklersModel: Backbone.Model.extend({
				initialize: function() {
					...
					if (!_.isUndefined(localStorage["CookieClickerCheatsAutoClickWrinklers"])) {
						this.set(JSON.parse(localStorage["CookieClickerCheatsAutoClickWrinklers"]));
					}
					this.save();
					this.set({
						intervalId: 0
				...
				save: function () {
					localStorage["CookieClickerCheatsAutoClickWrinklers"] = JSON.stringify(this.toJSON());
				},
				go: function() {
					var that = this;
					var t = function () {
			...
			AutoClickModel: Backbone.Model.extend({
				initialize: function() {
					...
					if (this.get("running") !== false)
						this.set({running:false});
					if (!_.isUndefined(localStorage["CookieClickerCheatsAutoClick"])) {
						this.set(JSON.parse(localStorage["CookieClickerCheatsAutoClick"]));
					}
					this.save();
					this.set({
						intervalId: 0
				...
				save: function () {
					localStorage["CookieClickerCheatsAutoClick"] = JSON.stringify(this.toJSON());
				},
				go: function() {
					var that = this;
					var t = function () {
			...
			AutoSpawnModel: Backbone.Model.extend({
				initialize: function() {
					...
					if (this.get("running") !== false)
						this.set({running:false});
					if (!_.isUndefined(localStorage["CookieClickerCheatsAutoSpawn"])) {
						this.set(JSON.parse(localStorage["CookieClickerCheatsAutoSpawn"]));
					}
					this.save();
					this.set({
						intervalId: 0
				...
				save: function () {
					localStorage["CookieClickerCheatsAutoSpawn"] = JSON.stringify(this.toJSON());
				},
				go: function() {
					var that = this;
					var t = function () {
			...
			AutoGoldenClickModel: Backbone.Model.extend({
				save: function () {
					localStorage["CookieClickerCheatsAutoGoldenClick"] = JSON.stringify(this.toJSON());
				},
				initialize: function() {
					if (this.get("count") !== 0)
						this.set({count: 0});
					if (this.get("running") !== false)
						this.set({running:false});
					if (!_.isUndefined(localStorage["CookieClickerCheatsAutoGoldenClick"])) {
						this.set(JSON.parse(localStorage["CookieClickerCheatsAutoGoldenClick"]));
					}
					this.save();
			...
			AutoReindeerClickModel: Backbone.Model.extend({
				save: function () {
					localStorage["CookieClickerCheatsAutoReindeerClick"] = JSON.stringify(this.toJSON());
				},
				initialize: function() {
					if (this.get("count") !== 0)
						this.set({count: 0});
					if (this.get("running") !== false)
						this.set({running:false});
					if (!_.isUndefined(localStorage["CookieClickerCheatsAutoReindeerClick"])) {
						this.set(JSON.parse(localStorage["CookieClickerCheatsAutoReindeerClick"]));
					}
					this.save();
					this.set({intervalId:0});
					if (this.get("running"))
	...
	CookieCheat.initCollections = function () {
		CookieCheat.Collections = {
			BuildingsCollection: Backbone.Collection.extend({
				...
				localStorage: new Store("CookieClickerCheatsBuildings"),
				initialize: function () {
					return this;
				}
			}),
			UpgradesCollection: Backbone.Collection.extend({
				...
				localStorage: new Store("CookieClickerCheatsUpgrades"),
				initialize: function () {
					return this;
				}
			}),
			ChoicesCollection: Backbone.Collection.extend({
				...
				localStorage: new Store("CookieClickerCheatsGoldenChoices"),
				initialize: function () {
					return this;
				},
			...
			SavesCollection: Backbone.Collection.extend({
				...
				localStorage: new Store("CookieClickerCheatsSaves"),
				initialize: function () {
					return this;
				},
	...
	CookieCheat.initViews = function () {
		CookieCheat.Views = {
			...
			SafeCookiesView: Backbone.View.extend({
				...
				initialize: function() {
					var that = this;
					CookieCheat.cookieToKeep = JSON.parse(localStorage["CookieClickerCheatsSafeAmount"] || 0);
					CookieCheat.godMustCheck = JSON.parse(localStorage["CookieClickerCheatsGodCheck"] || 0);
					this.radioChecked = JSON.parse(localStorage["CookieClickerCheatsRadioChecked"] || 3);
					this.f();
					this.render();
				...
				render: function() {
					...
					$(toChange).find("#fixCookies").click(function() {if (confirm("CookieGod will reset your cookies ! Are you sure ?")) {Game.Popup("Respect from CookHeaven... - CookieGod");Game.cookies = Game.cookiesd = 0;}else Game.Popup('"Coward... - CookieGod"')});
				...
				changed: function() {
					localStorage["CookieClickerCheatsRadioChecked"] = JSON.stringify(this.radioChecked);
					if (this.radioChecked === 3) {
						CookieCheat.cookieToKeep = parseInt("0" + $(this.elName).find(".numberToKeep").val(), 10);
						localStorage["CookieClickerCheatsSafeAmount"] = JSON.stringify(CookieCheat.cookieToKeep);
						this.render();
					} else {
						this.f();
					}
				...
				changedGod: function() {
					...
					localStorage["CookieClickerCheatsGodCheck"] = JSON.stringify(CookieCheat.godMustCheck);
					this.render();
				},
				f: function () {
			...
			EarnChipsView: Backbone.View.extend({
				...
				initialize: function() {
					this.heavenEarned = JSON.parse(localStorage["CookieClickerCheatsEarnHeavenAmount"] || 0);
					this.render();
					return (this);
				},
				render: function() {
				...
				changed: function() {
					if (_.isUndefined(Game.prestige["Heavenly chips"]))
						Game.prestige["Heavenly chips"] = 0;
					var toGive = parseInt($(this.elName).find(".numberToEarn").val(), 10);
					if (_.isFinite(toGive + Game.prestige["Heavenly chips"])) {
						this.heavenEarned += toGive;
						Game.prestige["Heavenly chips"] += toGive;
						localStorage["CookieClickerCheatsEarnHeavenAmount"] = JSON.stringify(this.heavenEarned);
						Game.recalculateGains = 1;
						Game.Popup("The CookieGod gave you " + Beautify(toGive) + " chips from Heaven !");
					} else {
						Game.Popup("The CookieGod hates infinity, sorry...");
					}
			...
			EarnCookiesView: Backbone.View.extend({
				...
				initialize: function() {
					this.cookieEarned = JSON.parse(localStorage["CookieClickerCheatsEarnAmount"] || 0);
					this.render();
					return (this);
				},
				render: function() {
				...
				changed: function() {
					...
					if (_.isFinite(toGive + Game.cookies)) {
						...
						Game.Earn(toGive);
						localStorage["CookieClickerCheatsEarnAmount"] = JSON.stringify(this.cookieEarned);
						Game.Popup("The CookieGod gave you " + Beautify(toGive) + " cookies !");
					} else {
						Game.Popup("The CookieGod hates infinity, sorry...");
					}
					$(this.elName).find(".numberToEarn").val(0);
	...
	CookieCheat.addButton = function () {
		$("#comments").append('<div id="cheatButton" class="warning button"><span style="top: -8px;font-size: 0.8em;position: relative;">More<br>Cheats</span></div>');
		l("cheatButton").onclick = function() {
			Game.ShowMenu('cheats');
		};
	};
	...
	CookieCheat.loadChoices = function () {
		CookieCheat.choices = {
			...
			"auto click": {
				...
				type: "autoClick",
				message: "'Auto click ! Clicking ' + this.params.clicksPerSecond + ' times per second for ' + this.realTime + ' seconds !'",
				recalculateGains: false,
				params: {
					clicksPerSecond: 10,
					baseTime: 5
			...
			"cheaper": {
				...
				type: "buildingSales",
				message: "'Cheaper : ' + this.params.buildingName + ' price x' + this.params.priceMultiplicator + ' for ' + this.realTime + ' seconds !'",
				recalculateGains: true,
				params: {
					baseTime: 12,
		...
		l('goldenCookie').onclick = Game.goldenCookie.click = function() {
			if (Game.goldenCookie.life > 0) {
				...
				if (typeof choice !== "undefined") {
					...
					Game.Popup("Nothing happened... Easter egg spotted !! Here is a face cookie.");
	...
	Game.UpdateMenu = function() {
		...
		if (Game.onMenu === "cheats") { // Cheat menu here
			str += CookieCheat.strForFeatures.topHeadBand();
			if (CookieCheat.currentTab === "tools")
				str += CookieCheat.strForFeatures.tools();
			else if (CookieCheat.currentTab === "cheats")
				str += CookieCheat.strForFeatures.cheats();
			else if (CookieCheat.currentTab === "mods")
				str += CookieCheat.strForFeatures.mods();
		}
