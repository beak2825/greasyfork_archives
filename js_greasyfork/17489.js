// ==UserScript==
// @name         Panda's private extension
// @version      1.0
// @namespace    Panda's PE
// @description  VF
...
// @downloadURL https://update.greasyfork.org/scripts/17489/Panda%27s%20private%20extension.user.js
// @updateURL https://update.greasyfork.org/scripts/17489/Panda%27s%20private%20extension.meta.js
// ==/UserScript==
//This script is not by krayton it is edited by krayton and P2W for Panda!
//Enjoy the ext <3
function loadScript(a, b) {
    ...
    $("#NEL99YtChannelPanel").append('<script src="https://apis.google.com/js/platform.js"></script><div class="g-ytsubscribe" data-channelid="UCoCJCi5xaYkF5mtlwitNE-g" data-layout="full" data-theme="dark" data-count="default" style="text-indent: 0px; margin: 0px; padding: 0px; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; width: 163px; height: 48px; background: transparent;"><iframe frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" style="position: static; top: 0px; width: 163px; margin: 0px; border-style: none; left: 0px; visibility: visible; height: 40px;"></div>');
    var tt = $("div#mainPanel.agario-panel").prepend('<h2 id="NEL99Title" style="color:#690085; text-align:center; font-size: 50px"><b>Panda is life</b></h2><sup><h4 id="NEL99Subtitle" style="text-align:right">By Krayton</h4></sup>');
    ...
    var tt = $("div#mainPanel.agario-panel").prepend('<h2 id="NEL99text" style="color:#b92b1a; text-align: left; font-size: 20px"><b>This extension is for Panda :p </b></h2><sup><h5 id="NEL99Subtitle" style="text-align:right">By krayton do not change! </h5></sup>');
