// ==UserScript==
// @name         NOVGOROD | Скрипт для Кураторов форума
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/507359/NOVGOROD%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/507359/NOVGOROD%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
    ...
    const buttons = [
        {
            ...
            'текст<br><br>' +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        },
{
    title: "----------------------------------------------------- Жалобы на игроков (одобрено) -----------------------------------------------------"
},
        {
            ...
            '[CENTER][FONT=verdana][Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].[/SIZE][/FONT][/CENTER]<br>',
        ...
        },
        {
            ...
            "[LIST][*][B][B][FONT=verdana][SIZE=4][B][B][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] езда на скутере по горам, езда на любом транспортном средстве по встречным полосам, нарушая все правила дорожного движения без какой-либо причины, намеренное создание аварийных ситуаций на дорогах и так далее.[/SIZE][/FONT][/LIST][/QUOTE]" +
            '<br>[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
         {
            ...
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].',
        ...
        {
            title: `РП в свою пользу`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][COLOR=rgb(255, 0, 0)][B][SIZE=4]2.06.[/SIZE][/B][/COLOR][SIZE=4][B] Запрещены любые Role Play отыгровки в свою сторону или пользу [COLOR=rgb(255, 0, 0)] | Jail 30 минут[/COLOR][/SIZE][/CENTER][LIST]" +
            "[*][SIZE=4][B][B][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] при остановке Вашего транспортного средства правоохранительными органами у Вас очень резко и неожиданно заболевает сердце, ломаются руки, блокируются двери машины или окна и так далее.[/SIZE][/LIST][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT]<br><br>" +
            "[QUOTE][CENTER][B][FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)]2.14.[/COLOR] Запрещен RK (Revenge Kill) — убийство игрока с целью мести, возвращение на место смерти в течение 15-ти минут, а также использование в дальнейшем информации, которая привела Вас к смерти [COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/SIZE][/B][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)]2.17.[/COLOR] Запрещен PG (PowerGaming) — присвоение свойств персонажу, не соответствующих реальности, отсутствие страха за свою жизнь [COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/SIZE][/FONT][/CENTER][/QUOTE]<br>" +
            '[CENTER][Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][FONT=verdana][SIZE=4][B][COLOR=rgb(255, 0, 0)]2.32.[/COLOR] Запрещено введение в заблуждение, обман администрации на всех ресурсах проекта [COLOR=rgb(255, 0, 0)]| Ban 7 - 15 дней[/COLOR][/B][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][B][SIZE=4][COLOR=rgb(255, 0, 0)]2.34.[/COLOR] Запрещен уход от наказания [COLOR=rgb(255, 0, 0)]| Ban 15 - 30 дней (суммируется к общему наказанию дополнительно)[/COLOR][/SIZE][/B]" +
            "[LIST][*][B][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] зная, что в данный момент игроку может быть выдано наказание за какое-либо нарушение, изменение никнейма или передача своего имущества на другие аккаунты и тому подобное.[/SIZE][/B]<br>" +
            "[*][B][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] выход игрока из игры не является уходом от наказания.[/SIZE][/B][/LIST][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][B][SIZE=4][COLOR=rgb(255, 0, 0)]2.36.[/COLOR] Запрещено переносить конфликты из IC в OOC и наоборот [COLOR=rgb(255, 0, 0)]| Warn[/COLOR][/SIZE][/B][/CENTER]" +
            "[LIST][*][LEFT][SIZE=4][B][B][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] все межфракционные конфликты решаются главными следящими администраторами.[/B][/B][/SIZE][/LEFT][/LIST][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][B][FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)]2.37.[/COLOR] Запрещены OOC угрозы, в том числе и завуалированные [COLOR=rgb(255, 0, 0)]| Mute 120 минут / Ban 7 дней[/COLOR][/B][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][B][SIZE=4][COLOR=rgb(255, 0, 0)]2.38.[/COLOR] Запрещено распространять личную информацию игроков и их родственников [COLOR=rgb(255, 0, 0)]| Ban 15 - 30 дней / PermBan[/COLOR][/SIZE][/B]" +
            "[LIST][*][B][SIZE=4][COLOR=rgb(255, 0, 0)]Исключение:[/COLOR] личное предоставление данной информации, разрешение на распространение от владельца.[/SIZE][/B][/LIST][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][SIZE=4][B][COLOR=rgb(255,0 ,0)]2.39.[/COLOR] Злоупотребление нарушениями правил сервера [COLOR=rgb(255, 0, 0)]| Ban 7 - 30 дней[/COLOR][/B][/SIZE]" +
            "[LIST][*][SIZE=4][B][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] неоднократное (от шести и более) нарушение правил сервера, которые были совершены за прошедшие 7 дней.[/B][/SIZE]<br>" +
            "[*][SIZE=4][B][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] наказания выданные за нарушения правил текстовых чатов, помеху (kick) в учет не идут.[/B][/SIZE]<br>" +
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][SIZE=4][B][COLOR=rgb(255, 0, 0)]2.46.[/COLOR] Запрещено ездить по полям на любом транспорте [COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/B][/SIZE][/CENTER]" +
            "[LIST][*][B][SIZE=4][B][COLOR=rgb(255, 0, 0)]Исключение:[/COLOR] разрешено передвижение на кроссовых мотоциклах и внедорожниках.[/B][/SIZE][/B][/LIST][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].',
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][COLOR=rgb(255, 0, 0)][B][SIZE=4]2.51.[/SIZE][/B][/COLOR][SIZE=4][B] Запрещено вмешательство в Role Play процесс с целью помехи и препятствования дальнейшего развития Role Play процесса [/B][COLOR=rgb(255, 0, 0)][B]| Jail 30 минут[/B][/COLOR][/SIZE][/CENTER]" +
            "[LIST][*][SIZE=4][B][COLOR=rgb(255, 0, 0)][B]Пример:[/B][/COLOR][B] вмешательство в Role Play процесс при задержании игрока сотрудниками ГИБДД, вмешательство в проведение тренировки или мероприятия какой-либо фракции и тому подобные ситуации.[/B][/B][/SIZE][/LIST][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        {
            title: `тим мёртвая рука`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            '[QUOTE][CENTER][B][SIZE=4][COLOR=rgb(255, 0, 0)]2.56.[/COLOR] Запрещается объединение в команду между убийцей и выжившим на мини-игре "Мертвая рука" [COLOR=rgb(255, 0, 0)]| Jail 30 минут[/COLOR][/SIZE][/B][/CENTER]' +
            "[LIST][*][SIZE=4][B][B][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] правило действует только на время Хэллоуинского ивента.[/B][/B][/SIZE][/LIST][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        {
            title: `общение на иностранных языках`,
            content:
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][B][FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)]3.01.[/COLOR] Общепризнанный язык сервера — русский. Общение в IC чатах во всех Role Play ситуациях обязательно должно проходить исключительно на русском языке [COLOR=rgb(255, 0, 0)]| Устное замечание / Mute 30 минут[/COLOR][/B][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][SIZE=4][B][COLOR=rgb(255, 0, 0)]3.07.[/COLOR] Запрещены совершенно любые оскорбления или действия, порочащие честь и достоинства, несущие в себе подтекст сексуального характера вне зависимости от чата [COLOR=rgb(255, 0, 0)]| Mute 30 минут[/COLOR][/B][/SIZE][/CENTER]" +
            "[LIST][*][SIZE=4][B][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] «дырка», «шмара», «ведро», «мадагаскарский присосконог», «свиноногий бандикут», «скорострел» и так далее.[/B][/SIZE][/LIST][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        {
            title: `Угроза о наказании со стороны администрации`,
            content:
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)][B]3.09.[/B][/COLOR][B] Запрещены любые угрозы о наказании игрока со стороны администрации [/B][COLOR=rgb(255, 0, 0)][B]| Mute 30 минут[/B][/COLOR][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][B][FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)]3.10.[/COLOR] Запрещена выдача себя за администратора, если таковым не являетесь [COLOR=rgb(255, 0, 0)]| Ban 7 - 15 + ЧС администрации[/COLOR][/B][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][B][FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)]3.12.[/COLOR] Запрещено подавать репорт написанный транслитом, с сообщением не по теме (Offtop), с включенным Caps Lock и повторять обращение (если ответ был уже дан ранее) [COLOR=rgb(255, 0, 0)]| Report Mute 30 минут[/COLOR][/B][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][B][FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)]3.13.[/COLOR] Запрещено подавать репорт с использованием нецензурной брани [COLOR=rgb(255, 0, 0)]| Report Mute 30 минут[/COLOR][/B][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        {
            title: `оск игроков / родных в войс`,
            content:
            "[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][B][FONT=verdana][SIZE=4][color=rgb(255, 0, 0)]3.15.[/color] Запрещено оскорблять игроков или родных в Voice Chat [color=rgb(255, 0, 0)]| Mute 120 минут / Ban 7 - 15 дней[/color][/B][/QUOTE]<br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        {
            title: `Реклама сторонних ресурсов в войс`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            "[FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(97, 189, 109)]принята [/COLOR]администрацией сервера. В ближайшее время, [COLOR=rgb(209, 72, 65)]игрок будет наказан согласно пункту правил:[/COLOR][/SIZE][/FONT][/CENTER]<br><br>" +
            "[QUOTE][CENTER][B][SIZE=4][COLOR=rgb(255, 0, 0)]3.17.[/COLOR] Запрещена реклама в Voice Chat не связанная с игровым процессом [COLOR=rgb(255, 0, 0)]| Ban 7 - 15 дней[/COLOR][/SIZE][/B][/CENTER]" +
            "[LIST][*][SIZE=4][B][COLOR=rgb(255, 0, 0)]Пример:[/COLOR] реклама Discord серверов, групп, сообществ, ютуб каналов и т.д.[/B][/SIZE][/LIST][/QUOTE]<br><br>" +
            '[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].<br>',
        ...
        },
        {
            ...
            `[QUOTE][CENTER][FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(250, 220, 25)][U]отклонена[/U][/COLOR] администрацией сервера.[/SIZE][/FONT][/CENTER][/QUOTE]<br><br>`+
            ...
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].[/FONT][/SIZE][/CENTER]",
        ...
        },
        {
            ...
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)]NOVGOROD[/COLOR].",
        ...
        },
        {
            ...
            "<br><br>[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        },
        {
            ...
            '[CENTER][SIZE=4][FONT=verdana]Подайте жалобу в раздел [url="https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.3553/"]"Жалобы на администрацию"[/url]<br><br>' +
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        },
        {
            ...
            `[QUOTE][CENTER][FONT=verdana][SIZE=4]Ваша жалоба на указанного игрока была рассмотрена и [COLOR=rgb(250, 220, 25)][U]отклонена[/U][/COLOR] администрацией сервера.[/SIZE][/FONT][/CENTER][/QUOTE]<br><br>`+
            "[CENTER][SIZE=4][FONT=verdana]Причина отклонения жалобы на игрока: Не правильный раздел.<br><br>" +
            '[CENTER][SIZE=4][FONT=verdana]Подайте жалобу в раздел [url="https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-novgorod.3535/"]"Жалобы на технических специалистов"[/url]<br><br>' +
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        },
        {
            title: `Одобрено`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            `Ваше заявление на RP биографию была рассмотрена и ей дан следующий статус: [COLOR=rgb(97, 189, 109)][U]Одобрено[/U][/COLOR].<br><br>`+
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            `Ваша RP биография была рассмотрена и [COLOR=rgb(250, 220, 25)][U]отклонена[/U][/COLOR] администрацией сервера.<br>`+
            ...
            'Ознакомьтесь с [url=https://forum.blackrussia.online/threads/n-novgorod-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9872935/]"Правилами подачи RP биографий"[/url]<br><br>' +
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        },
        {
            ...
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            `Ваша RP биография была рассмотрена и [COLOR=rgb(250, 220, 25)][U]отклонена[/U][/COLOR] администрацией сервера.<br>`+
            "Причина отклонения RP биографии: у вас много орфографических ошибок<br><br>" +
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        {
            title: `Скопированная РП био (полность/часть)`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            `Ваша RP биография была рассмотрена и [COLOR=rgb(250, 220, 25)][U]отклонена[/U][/COLOR] администрацией сервера.<br>`+
        ...
        },
        {
            title: `Одобрено`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            `Ваше заявление на RP ситуация была рассмотрена и ей дан следующий статус: [COLOR=rgb(97, 189, 109)][U]Одобрено[/U][/COLOR].<br><br>`+
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        },
       {
            title: `отказано`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            `Ваша RP ситуация была рассмотрена и [COLOR=rgb(250, 220, 25)][U]отклонена[/U][/COLOR] администрацией сервера.<br><br>`+
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        {
            title: `----------------------------------------------------------------- Не официальные организации -----------------------------------------------------------------`,
        },
        {
            title: `Одобрено`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            `Ваше заявление на не официальную организацию была рассмотрена и ей дан следующий статус: [COLOR=rgb(97, 189, 109)][U]Одобрено[/U][/COLOR].<br><br>`+
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
        ...
        },
        {
            title: `отказано`,
            content: `[CENTER][COLOR=rgb(251, 160, 38)][FONT=verdana][SIZE=4]Здравствуйте.[/SIZE][/FONT][/COLOR]<br><br>`+
            `Ваша не официальная организация была рассмотрена и [COLOR=rgb(250, 220, 25)][U]отклонена[/U][/COLOR] администрацией сервера.<br>`+
            "Причина отклонения RP ситуации: <br><br>" +
            "[Center][SIZE=4][FONT=verdana]Благодарим вас за обращение. Приятной игры на сервере [COLOR=rgb(250, 220, 25)][B]NOVGOROD[/B][/COLOR].",
