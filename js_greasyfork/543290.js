...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/543290/Intake%20SOM%20FitClinic.user.js
// @updateURL https://update.greasyfork.org/scripts/543290/Intake%20SOM%20FitClinic.meta.js
// ==/UserScript==
    ...
    ///////////////////////////////////////////////////////////////////////////////////
                ...
                if (hulpvraagEl && hulpvraagEl.innerHTML == '') {
                    ...
                    if (verwachtHerstelPatientDD) {
                        console.log(verwachtHerstelPatientDD)

                        if (verwachtHerstelPatientDD.includes('bepalen')) {
                            dropdownValueHerstelPatient = '716';
                        } else if (verwachtHerstelPatientDD.includes('klachten')) {
                            dropdownValueHerstelPatient = '717';
                        } else if (verwachtHerstelPatientDD.includes('Stabilisatie')) {
                            dropdownValueHerstelPatient = '718';
                        } else if (verwachtHerstelPatientDD.includes('Herstel')) {
                            dropdownValueHerstelPatient = '719';
                        }
                    }
                    console.log(dropdownValueHerstelPatient)
                ...
                if (consultatieConcelusieEl && consultatieConcelusieEl.innerHTML == '') {
                    ...
                    if (verwachtHerstelFysioEl) {
                        ...
                        if (verwachtHerstelFysioDD) {
                            ...
                            if (verwachtHerstelFysioDD.includes('bepalen')) {
                                dropdownValueHerstelFysio  = '716';
                            } else if (verwachtHerstelFysioDD.includes('klachten')) {
                                dropdownValueHerstelFysio  = '717';
                            } else if (verwachtHerstelFysioDD.includes('Stabilisatie')) {
                                dropdownValueHerstelFysio  = '718';
                            } else if (verwachtHerstelFysioDD.includes('Herstel')) {
                                dropdownValueHerstelFysio  = '719';
                            }
                        }
