...
// @match        *://*.91huayi.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/555897/%E5%8D%8E%E5%8C%BB%E7%BD%91%E5%8A%A9%E6%89%8B2025.user.js
// @updateURL https://update.greasyfork.org/scripts/555897/%E5%8D%8E%E5%8C%BB%E7%BD%91%E5%8A%A9%E6%89%8B2025.meta.js
// ==/UserScript==
...
(function () {
    ...
    function examherftest() {
        ...
        // 优先：如果 "已完成"，跳下一个课程 (防误跳)
        if (state == "已完成") {
            console.log("state = '已完成'，直接切换下一个课程");
            playNextVideo();
            return;
        }

        // 否则：轮询 #jrks 可点击
        if (examBtn && examBtn.style.display !== "none" && !examBtn.disabled) {
