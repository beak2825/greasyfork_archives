// ==UserScript==
// @name Для раководства ОПГ || by F Angel || Special for Novicov ☠
...
// @downloadURL https://update.greasyfork.org/scripts/560126/%D0%94%D0%BB%D1%8F%20%D1%80%D0%B0%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%9E%D0%9F%D0%93%20%7C%7C%20by%20F%20Angel%20%7C%7C%20Special%20for%20Novicov%20%E2%98%A0.user.js
// @updateURL https://update.greasyfork.org/scripts/560126/%D0%94%D0%BB%D1%8F%20%D1%80%D0%B0%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%9E%D0%9F%D0%93%20%7C%7C%20by%20F%20Angel%20%7C%7C%20Special%20for%20Novicov%20%E2%98%A0.meta.js
// ==/UserScript==
...
"[CENTER] ТВОЙ ТЕКСТ.[/CENTER]<br><br>"+
     "[Color=rgb(255, 255, 255)]Приятной игры и времяпровождения на сервере [COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/FONT][/CENTER]"
    },
   {
...
content:
 "[url=https://postimages.org/][img]https://i.ibb.co/D1QkYF3/8P4g6gO.png[/img][/url]"+
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(0, 0, 0)][B]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Ваша жалоба взята закреплена и передана Заместителю главного администратора-@Mommy_Legenda. Просьба не создавать подобных тем, иначе ваш Форумный аккаунт может быть [U]заблокирован.[/U][/CENTER]<br><br>"+
'[CENTER][Color=rgb(0, 0, 0)]Ожидайте ответа...[/CENTER][/B][/SIZE]'+
     "[Color=rgb(255, 255, 255)]Приятной игры и времяпровождения на сервере [COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/FONT][/CENTER]",
prefix: PIN_PREFIX,
status: true,
},
...
content:
 "[url=https://postimages.org/][img]https://i.ibb.co/D1QkYF3/8P4g6gO.png[/img][/url]"+
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(0, 0, 0)][B]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Ваша жалоба взята закреплена и передана Главному администратору-@Skay Eagle. Просьба не создавать подобных тем, иначе ваш Форумный аккаунт может быть [U]заблокирован.[/U][/CENTER]<br><br>"+
'[CENTER][Color=rgb(0, 0, 0)]Ожидайте ответа...[/CENTER][/B][/SIZE]'+
     "[Color=rgb(255, 255, 255)]Приятной игры и времяпровождения на сервере [COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/FONT][/CENTER]"
     ,
prefix: PIN_PREFIX,
...
"[Color=rgb(0, 0, 0)]Примечание: Доказательства должны быть в первоначальном виде.<br><br>"+
     "[Color=rgb(255, 255, 255)]Приятной игры и времяпровождения на сервере [COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/FONT][/CENTER]<br><br>"+
...
content:
 "[url=https://postimages.org/][img]https://i.ibb.co/D1QkYF3/8P4g6gO.png[/img][/url]"+
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(0, 0, 0)][B]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER] Ваша жалоба составлена не по форме. Пожалуйста, ознакомьтесь с - [URL='https://forum.blackrussia.online/threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.3429391/'][COLOR=rgb(0,0,0)]«Правилами подачи Жалоб на Лидеров».[/color][/URL][/CENTER]<br><br>"+
     "[Color=rgb(255, 255, 255)]Приятной игры и времяпровождения на сервере [COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/FONT][/CENTER]<br><br>"+
     "[CENTER] [Color=rgb(0, 0, 0)][I]Отказано.[/I][/CENTER]"
     ,
prefix: UNACCEPT_PREFIX,
...
content:
 "[url=https://postimages.org/][img]https://i.ibb.co/D1QkYF3/8P4g6gO.png[/img][/url]"+
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(0, 0, 0)][B]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER] Данный раздел не занимается обжалованиями наказаний, обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.4006/'][COLOR=rgb(0,0,0)]«Обжалования наказаний».[/color][/URL][/CENTER]<br><br>"+
     "[Color=rgb(255, 255, 255)]Приятной игры и времяпровождения на сервере [COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/FONT][/CENTER]<br><br>"+
     "[CENTER] [Color=rgb(0, 0, 0)][I]Отказано.[/I][/CENTER]"
     ,
prefix: UNACCEPT_PREFIX,
...
"[CENTER] Выше поданные заявки находятся на рассмотрении. Все что ниже будет отказано.[/CENTER]<br><br>"+
     "[CENTER] Ожидайте ответа от руководства ОПГ.[/CENTER]<br><br>"+
     "[Color=rgb(255, 255, 255)]Приятной игры и времяпровождения на сервере [COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/FONT][/CENTER]"
     ,
},
{
