// ==UserScript==
// @name         ARZAMAS | Скрипт для Главных Кураторов форума / Заместителей [F] By Richmond_Brooks
// @namespace    https://forum.blackrussia.online
// @version      0.4
// @description  По всем вопросам/фиксам/улучшениям - https://vk.com/developssh | Улучшенная версия
// @author       Richmond_Brooks | 08.04.24
...
// @collaborator none
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/492910/ARZAMAS%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%BB%D0%B0%D0%B2%D0%BD%D1%8B%D1%85%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%20%D0%97%D0%B0%D0%BC%D0%B5%D1%81%D1%82%D0%B8%D1%82%D0%B5%D0%BB%D0%B5%D0%B9%20%5BF%5D%20By%20Richmond_Brooks.user.js
// @updateURL https://update.greasyfork.org/scripts/492910/ARZAMAS%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%BB%D0%B0%D0%B2%D0%BD%D1%8B%D1%85%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%20%D0%97%D0%B0%D0%BC%D0%B5%D1%81%D1%82%D0%B8%D1%82%D0%B5%D0%BB%D0%B5%D0%B9%20%5BF%5D%20By%20Richmond_Brooks.meta.js
// ==/UserScript==
    ...
    },
{
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/8cffXvQ9/image.png[/img][/url]<br>' +
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый(ая) {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Док-ва котрые вы прикрепили не рабоатют. Соответственно - Выношу на тему вердикт: [ISPOILER][COLOR=red]''Отказано, закрыто''[/COLOR][/ISPOILER] Вы можете загрузить их на Имгур | Япикс <br>"+
         "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/BZM1VV8z/download-5.gif[/img][/url]<br>' + 
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/QN7x3PcR/image.png[/img][/url]<br>',
      prefix: UNACCEPT_PREFIX,
    ...
    },
{
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/8cffXvQ9/image.png[/img][/url]<br>' +
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый(ая) {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] В данном случае, нужна видио фиксация. Соответственно - Выношу на тему вердикт: [ISPOILER][COLOR=red]''Отказано, закрыто''[/COLOR][/ISPOILER]<br>"+
         "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/BZM1VV8z/download-5.gif[/img][/url]<br>' + 
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/QN7x3PcR/image.png[/img][/url]<br>',
      prefix: UNACCEPT_PREFIX,
    ...
    },
{
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/8cffXvQ9/image.png[/img][/url]<br>' +
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый(ая) {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender]Док-ва должны загружатся на фото-видио хостинги по типу Имгур / Япикс / Ютуб. Другие - Не рассматриваются<br>"+
        "[B][CENTER][COLOR=lavender]Соответственно - Выношу на тему вердикт: [ISPOILER][COLOR=red]''Отказано, закрыто''[/COLOR][/ISPOILER]. <br><br>"+
         "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/BZM1VV8z/download-5.gif[/img][/url]<br>' + 
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/QN7x3PcR/image.png[/img][/url]<br>',
  ...
  const AcceptRpSitution = [
    {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/8cffXvQ9/image.png[/img][/url]<br>' +
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый(ая) {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender]После проверки вашей РП ситуации, она была одобрена.<br>"+
      "[B][CENTER][COLOR=lavender]Соответственно, выношу вердикт на тему: [ISPOILER][COLOR=lime]''Одобрено, закрыто''[/COLOR][/ISPOILER]. <br><br>"+
      '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mDkmFFKZ/download-2.gif[/img][/url]<br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/QN7x3PcR/image.png[/img][/url]<br>',
      prefix: ACCEPT_PREFIX,
      status: false,
  ...
  const UnAcceptRpSitution = [
    {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/8cffXvQ9/image.png[/img][/url]<br>' +
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый(ая) {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender]После проверки вашей РП ситуации, она была отказана.<br>"+
      "[B][CENTER][COLOR=lavender]Соответственно, выношу вердикт на тему: [ISPOILER][COLOR=red]''Отказано, закрыто''[/COLOR][/ISPOILER]. <br><br>"+
      '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/BZM1VV8z/download-5.gif[/img][/url]<br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/QN7x3PcR/image.png[/img][/url]<br>',
      prefix: UNACCEPT_PREFIX,
  ...
  const UnAcceptNeof = [
    {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/8cffXvQ9/image.png[/img][/url]<br>' +
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый(ая) {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender]После проверки вашей организации, она была отказана.<br>"+
      "[B][CENTER][COLOR=lavender]Соответственно, выношу вердикт на тему: [ISPOILER][COLOR=red]''Отказано, закрыто''[/COLOR][/ISPOILER]. <br><br>"+
      '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/BZM1VV8z/download-5.gif[/img][/url]<br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/QN7x3PcR/image.png[/img][/url]<br>',
      prefix: UNACCEPT_PREFIX,
  ...
  const UnAcceptNeofPer = [
    {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/8cffXvQ9/image.png[/img][/url]<br>' +
         '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый(ая) {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender]Вы ошиблись разделом для подачи формы, пожалуйста ознакомьтесь с форумом!<br>"+
      "[B][CENTER][COLOR=lavender]Соответственно, выношу вердикт на тему: [ISPOILER][COLOR=red]''Отказано, закрыто''[/COLOR][/ISPOILER]. <br><br>"+
      '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/BZM1VV8z/download-5.gif[/img][/url]<br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/QN7x3PcR/image.png[/img][/url]<br>',
      prefix: UNACCEPT_PREFIX,
...
// Добавление кнопок при загрузке страницы
  ...
  addButton('- | -', '', 'border-radius: 13px; margin-right: 7px; margin-bottom: 5px; border: 2px solid; border-color: rgb(255, 255, 255, 0.5);');
  addButton('✔️ | Одобрить Ситуацию', 'SituationAcc', 'border-radius: 13px; margin-right: 7px; margin-bottom: 5px; border: 2px solid;  border-color: rgb(0, 255, 9, 0.5);');
  addButton('❌ | Отказать Ситуацию', 'SituationUnAcc', 'border-radius: 13px; margin-right: 7px; margin-bottom: 5px; border: 2px solid;  border-color: rgb(255, 0, 59, 0.5);');
  addButton('- | -', '', 'border-radius: 13px; margin-right: 7px; margin-bottom: 5px; border: 2px solid; border-color: rgb(255, 255, 255, 0.5);');
  addButton('✔️ | Одобрить Организацию', 'ANeof', 'border-radius: 13px; margin-right: 7px; margin-bottom: 5px; border: 2px solid;  border-color: rgb(0, 255, 9, 0.5);');
  addButton('🗃️ | Переодресовать Организацию', 'perNeof', 'border-radius: 13px; margin-right: 7px; margin-bottom: 5px; border: 2px solid; border-color: rgb(247, 255, 0, 0.5);');
  addButton('❌ | Отказать Организацию', 'UNeof', 'border-radius: 13px; margin-right: 7px; margin-bottom: 5px; border: 2px solid;  border-color: rgb(255, 0, 59, 0.5);');
...
const threadData = getThreadData();
  ...
  $('button#SituationAcc').click(() => AcceptSituationRp());  
  $('button#SituationUnAcc').click(() => AcceptSituationUnRp());  
  $('button#ANeof').click(() => AcceptNeofficial());  
  $('button#UNeof').click(() => UnAcceptNeofficial());  
  $('button#perNeof').click(() => UnAcceptPerNeofficial());  
...
function AcceptSituationRp() {
  const threadData = getThreadData();
  const template = Handlebars.compile(AcceptRpSitution[0].content);
  ...
  const targetForumID = 1532;

  moveThreadSituation(targetForumID);
  
  editThreadData(AcceptRpSitution[0].prefix, false);
  $('.button--icon.button--icon--reply.rippleButton').trigger('click');
}

function moveThreadSituation(targetForumID) {
...
function AcceptSituationUnRp() {
  const threadData = getThreadData();
  const template = Handlebars.compile(UnAcceptRpSitution[0].content);
  ...
  const targetForumID = 1534;

  moveThreadSituationF(targetForumID);
  
  editThreadData(UnAcceptRpSitution[0].prefix, false);
  $('.button--icon.button--icon--reply.rippleButton').trigger('click');
}

function moveThreadSituationF(targetForumID) {
...
function AcceptNeofficial() {
  const threadData = getThreadData();
  const template = Handlebars.compile(AcceptNeof[0].content);
  ...
  const targetForumID = 1525;

  moveThreadNeof(targetForumID);
  
  editThreadData(AcceptNeof[0].prefix, false);
  $('.button--icon.button--icon--reply.rippleButton').trigger('click');
}

function moveThreadNeof(targetForumID) {
...
function UnAcceptNeofficial() {
  const threadData = getThreadData();
  const template = Handlebars.compile(UnAcceptNeof[0].content);
  ...
  const targetForumID = 1527;

  moveThreadNeofF(targetForumID);
  
  editThreadData(UnAcceptNeof[0].prefix, false);
  $('.button--icon.button--icon--reply.rippleButton').trigger('click');
}

function moveThreadNeofF(targetForumID) {
...
function UnAcceptPerNeofficial() {
  const threadData = getThreadData();
  const template = Handlebars.compile(UnAcceptNeofPer[0].content);
  ...
  editThreadData(UnAcceptNeofPer[0].prefix, false);
  $('.button--icon.button--icon--reply.rippleButton').trigger('click');
}
...
function moveThreadToForumAcceptRp(targetForumID) {
