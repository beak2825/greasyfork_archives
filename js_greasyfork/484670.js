// ==UserScript==
// @name         Скрипт для Кураторов || Saratov
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/484670/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%7C%7C%20Saratov.user.js
// @updateURL https://update.greasyfork.org/scripts/484670/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%7C%7C%20Saratov.meta.js
// ==/UserScript==
...
const buttons = [
{
    ...
    },
    {
	  ...
	  content:
		"[B][CENTER][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=White] В обжалование отказано. <br><br>"+
        "[B][CENTER][COLOR=White]С уважением [/COLOR][COLOR=RED]Куратор Администрации  [/COLOR]<br><br>",
    prefix: CLOSE_PREFIX,
      status: false,
    },
	{
	  ...
	  content:
		"[B][CENTER][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=White] Обжлование не по форме. <br><br>"+
        "[B][CENTER][COLOR=White]С уважением [/COLOR][COLOR=RED]Куратор Администрации  [/COLOR]<br><br>",
    prefix: CLOSE_PREFIX,
      status: false,
    },
