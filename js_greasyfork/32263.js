...
// @version 1.38.3
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/32263/TWLeoTools.user.js
// @updateURL https://update.greasyfork.org/scripts/32263/TWLeoTools.meta.js
// ==/UserScript==
    ...
    LTstart = {
      ...
      langs: {
        ...
        es: {
          ...
          ApiGui1: 'El script incluye varias funciones que simplifican la vida cotidiana en The West:</b><ul style="margin-left:15px;"><li>Accesos directos útiles</li><li>Botón cerrar sesión</li><li>Quitar barra de tareas</li><li>Puntos de habilidad en ventanas de trabajo</li><li>Cambiar el título y nombre del jugador en el Ayuntamiento</li><li>Mapa de duelo</li><li>Resaltar bonus de inicio conexión diario día 5</li><li>Nombre de la ciudad en ventana de mercado</li><li>Recordatorio en el mercado</li><li>Esconder logros completados</li><li>Mejora del mercado de recetas</li><li>CTRL+click muestra el artículo en TW-DB.info</li><li>Y más...</li><li>Más información: ',
          ...
          FeatEquipManagerPlus: 'Mejorar el gestor de equipos en el inventario',
