// ==UserScript==
// @name AudioBookBay hide category: Detective
// @description Hide Detective category
...
// @downloadURL https://update.greasyfork.org/scripts/484547/AudioBookBay%20hide%20category%3A%20Detective.user.js
// @updateURL https://update.greasyfork.org/scripts/484547/AudioBookBay%20hide%20category%3A%20Detective.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Detective'
    $(".post").has(".postInfo:contains('Detective')").hide();
});
