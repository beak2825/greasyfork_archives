...
// @author       zemelee
// @version      7.1
// @description  使用教程：https://www.bilibili.com/video/BV19c411w7qK;一个可以代刷问卷的网站：sugarblack.top;有疑问请加qq群咨询：774326264 || 427847187 || 850281779 || 931614446；不要因为安装量少就不安装啊！我是23年5月新出的脚本，而且还在不断更新中！（2023.8.27）作者很自信这是GF网站上最好用的脚本之一
// @match        *://*.wjx.*
...
(async function () {
    ...
    //-->现在是研究生了😡 (2024-11-22)
    // 如果三番确认代码没有问题但是完全没有效果，可以看看油猴脚本是否开启了开发者模式（可以百度一下），好像油猴需要打开这个模式才能运行了。
    //  有一个很好用的刷问卷的网站：sugarblack.top, 可以自定义作答时长、ip、比例，超好用(尖椒!!)
    //  sugarblack.top这个网站可以免费解析出问卷的问题，可以用这个网站快捷完成下方代码的填写
    //  解析步骤：填写问卷链接，点击解析，点击“复制比例”按钮，将代码粘贴到下方；删除"q11e"字符串，如果有页数添加 nextPage()。
