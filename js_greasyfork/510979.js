...
// @downloadURL https://update.greasyfork.org/scripts/510979/ICEbot%20v4x.user.js
// @updateURL https://update.greasyfork.org/scripts/510979/ICEbot%20v4x.meta.js
// ==/UserScript==
...
function arrayFilter(array) {
  return array.filter((value, index, arr) => arr.indexOf(value) === index);
    ...
    fetch("/logout?__cpo=aHR0cHM6Ly9nYXJ0aWMuaW8#")
...
localStorage.setItem("avatar",0)
     ...
     if(msg.data=="avatar1"){
f("#avatar").src = "https://garticphone.com/images/avatar/11.svg";
avatar=1
localStorage.setItem("avatar",1)
     }
     if(msg.data=="avatar2"){
...
f("#avatar").src = "https://lh3.googleusercontent.com/a/ACg8ocKZOaD8_bOX1IkC1gu7VolGsuYyhG4knI_f2n2piYT1UAw1KPE=s300";
avatar=36
...
<button>
<img width="100" style="margin-top:-5px;" height="100" src="https://garticphone.com/images/avatar/11.svg" class="selectedavatar" onclick="window.postMessage('avatar1','*')"></button>
<button>
...
<input class="broadcastspam" type="range" oninput="postMessage('broadcastspam')" min="100" max="10000">
<h2 class="messagespamvalue" id="messagems"></h2>
<input class="messagespam" type="range" oninput="postMessage('messagespam')" min="100" max="10000">
<h2 class="answerspamvalue" id="answerms"></h2>
<input class="answerspam" type="range" oninput="postMessage('answerspam')" min="100" max="10000">
    </div>
