// ==UserScript==
// @name         Ed Real Cons Combined Horst Herrlinger
...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487932/Ed%20Real%20Cons%20Combined%20Horst%20Herrlinger.user.js
// @updateURL https://update.greasyfork.org/scripts/487932/Ed%20Real%20Cons%20Combined%20Horst%20Herrlinger.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        ...
        { index: 1, adjustmentAmount: 500 },
        { index: 2, adjustmentAmount: 500 },
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE82 2916 6568";
    var targetTextContent2 = " 0003 8067 00";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 500.0; // Adjust the amount as needed
