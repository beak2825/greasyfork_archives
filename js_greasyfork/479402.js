// ==UserScript==
// @name            Simple YouTube Age Restriction Bypass by przejebanee
...
// @compatible      edge
// @compatible      safari
// @description     age restrict bypass
// @match           sima
// @version 0.0.1.20231109213558
// @namespace https://greasyfork.org/users/1214301
// @downloadURL https://update.greasyfork.org/scripts/479402/Simple%20YouTube%20Age%20Restriction%20Bypass%20by%20przejebanee.user.js
// @updateURL https://update.greasyfork.org/scripts/479402/Simple%20YouTube%20Age%20Restriction%20Bypass%20by%20przejebanee.meta.js
// ==/UserScript==
...
(function iife(ranOnce) {
    ...
    function isSearchResult(parsedData) {
        ...
        return (
            typeof (parsedData === null || parsedData === void 0 || (_parsedData$contents3 = parsedData.contents) === null || _parsedData$contents3 === void 0
                    ? void 0
                    : _parsedData$contents3.twoColumnSearchResultsRenderer) === 'object' 
            || (parsedData === null || parsedData === void 0 || (_parsedData$contents4 = parsedData.contents) === null || _parsedData$contents4 === void 0
                    ...
                    ? void 0
                    : _parsedData$contents4.targetId) === 'search-feed' 
            || (parsedData === null || parsedData === void 0 || (_parsedData$onRespons = parsedData.onResponseReceivedCommands) === null || _parsedData$onRespons === void 0
                    ...
                    ? void 0
                    : _parsedData$onRespons.targetId) === 'search-feed'
        );
    }
    ...
    const logSuffix = '\uD83D\uDC1E You can report bugs at: https://t.me/przejebaneL';
