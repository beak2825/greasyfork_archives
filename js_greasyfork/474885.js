// ==UserScript==
// @name Для Кураторов форума | ARKHANGELSK [56]
// @namespace https://forum.blackrussia.online
// @version 0.0.4
// @description Куратор форума
...
// @downloadURL https://update.greasyfork.org/scripts/474885/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20ARKHANGELSK%20%5B56%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/474885/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20ARKHANGELSK%20%5B56%5D.meta.js
// ==/UserScript==
...
title: 'СВОЙ ОТВЕТ',
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"Твой текст <br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
},
{
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Ваша жалоба взята [Color=Orange]на рассмотрение[/Color], ожидайте ответа от администрации. Просьба не создавать подобных тем, иначе форумный аккаунт может быть заблокирован.[/CENTER]<br><br>"+
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Ваша жалоба передана [Color=Orange]на рассмотрение[/Color] [Color=OrangeRed]техническому специалисту[/Color]. Ожидайте ответа, не создавайте подобных тем, иначе форумный аккаунт может быть заблокирован.  [/CENTER]<br><br>"+
'[CENTER][Color=Orange]На рассмотрении.[/Color][/CENTER][/B][/SIZE]',
prefix: TEXU_PREFIX,
status: true,
},
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Ваша жалоба передана [Color=Red]Главному администратору[/Color] - @Amir Shelby ♅ [/CENTER]<br><br>"+
'[CENTER][Color=Orange]На рассмотрении.[/Color][/CENTER][/B][/SIZE]',
prefix: GA_PREFIX,
status: true,
},
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Ваша жалоба передана на рассмотрение [Color=Red] Специальному администратору[/Color], а также его заместителям.[/CENTER]<br><br>"+
'[CENTER][Color=Orange]На рассмотрении.[/Color][/CENTER][/B][/SIZE]',
prefix: SA_PREFIX,
status: true,
},
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Долг выдается только через банк.<br><br>"+
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушений со стороны игрока не найдено.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Скриншот/видео не соответствует действительности.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Доказательств на нарушение от данного игрока недостаточно. Доказательства должны быть предоставлены в хорошем качестве и с полным процессом сделки или нарушения от какого-либо игрока.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Ваша жалоба отказана, т.к в ней нету таймкодов. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Вы используете не оригинальные файлы игры (сборку), поэтому ваша жалоба не подлежит рассмотрению.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Отсутствуют доказательства - следовательно, рассмотрению не подлежит. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Ваши доказательства не работают.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Загрузите доказательства на нарушение игрока, на другой хостинг.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Дублирование темы. Если вы дальше будете заниматься данной деятельностью (дублированием тем), то ваш форумный аккаунт будет заблокирован на 3 дня и более.<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Ваша жалоба отказана по причине: нельзя писать одну жалобу на двух и более игроков (на каждого игрока отдельная жалоба).<br><br>"+
'[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>'+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нету логитипа сервера.<br><br>"+
"[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Время подачи жалобы вышло. [/CENTER]<br><br>"+
"[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
...
"[Color=Red]2.01.[/Color] Запрещено поведение, нарушающее нормы процессов Role Play режима игры [Color=Red]| Jail 30 минут[/Color]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"[Color=Red]2.15.[/Color] Запрещен TK (Team Kill) — убийство члена своей или союзной фракции, организации без наличия какой-либо IC причины [Color=Red]| Jail 60 минут / Warn[/Color] [Color=Orange](за два и более убийства)[/Color]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"[Color=Red]2.16.[/Color] Запрещен SK (Spawn Kill) — убийство или нанесение урона на титульной территории любой фракции / организации, на месте появления игрока, а также на выходе из закрытых интерьеров и около них [Color=Red]| Jail 60 минут / Warn[/Color] [Color=Orange](за два и более убийства)[/Color]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"[Color=Red]2.57.[/Color] Запрещается брать в долг игровые ценности и не возвращать их. [Color=Red]| Ban 30 дней / permban[/Color]<br><br>[Color=Red]Примечание:[/Color] займ может быть осуществлен только через зачисление игровых ценностей на банковский счет, максимальный срок займа 30 календарных дней, если займ не был возвращен, аккаунт должника блокируется;<br>[Color=Red]Примечание:[/Color] при невозврате игровых ценностей общей стоимостью менее 5 миллионов включительно аккаунт будет заблокирован на 30 дней, если более 5 миллионов, аккаунт будет заблокирован навсегда;<br>[Color=Red]Примечание:[/Color] жалоба на игрока, который занял игровые ценности и не вернул в срок, подлежит рассмотрению только при наличии подтверждения суммы и условий займа в игровом процессе, меры в отношении должника могут быть приняты только при наличии жалобы и доказательств. Жалоба на должника подается в течение 10 дней после истечения срока займа. Договоры вне игры не будут считаться доказательствами.<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"[Color=Red]1.11.[/COLOR] Всем силовым структурам запрещен одиночный патруль или конвоирование, минимум 2 сотрудника [Color=Red]| Jail 30 минут[/COLOR]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"[Color=Red]6.01.|7.01.|8.01.|9.01.[/COLOR] Запрещено наносить урон игрокам без Role Play причины на территории УМВД | ГИБДД | ФСБ | ФСИН [Color=Red]| DM / Jail 60 минут / Warn[/COLOR]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"[Color=Red]6.02.[/COLOR] Запрещено выдавать розыск без Role Play причины [Color=Red]| Warn[/COLOR]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"Запрещено провоцировать сотрудников государственных организаций [Color=Red]| Jail 30 минут[/COLOR]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"Запрещено без причины наносить урон игрокам на территории ОПГ [Color=Red]| Jail 60 минут[/COLOR]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"Запрещено устраивать дуэли где-либо, а также на территории ОПГ [Color=Red]| Jail 30 минут[/COLOR]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"За нарушение правил нападения на Войсковую Часть выдаётся предупреждение [Color=Red]| Jail 30 минут (NonRP нападение) / Warn[/COLOR] [Color=Orange](Для сотрудников ОПГ)[/COLOR]<br><br>"+
"[Color=rgb(47, 250,68)][CENTER]Одобрено, закрыто.[/CENTER][/color]<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
...
content:
'[SIZE=4][Color=Aqua][FONT=​Georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}![/Color]<br><br>'+
"[CENTER]Вы не исправили свою RP биографию.<br><br>"+
"[CENTER][COLOR=rgb(255,0,0)]Отказано[/COLOR].<br><br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=DeepPink]ARKHANGELSK[/COLOR].[/CENTER][/B][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
