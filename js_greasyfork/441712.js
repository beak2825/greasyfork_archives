// ==UserScript==
// @name            DuckDuckGo Extended [shorter version] (Mobile)
...
// @version         2.12
// @author          tumpio
// @downloadURL https://update.greasyfork.org/scripts/441712/DuckDuckGo%20Extended%20%5Bshorter%20version%5D%20%28Mobile%29.user.js
// @updateURL https://update.greasyfork.org/scripts/441712/DuckDuckGo%20Extended%20%5Bshorter%20version%5D%20%28Mobile%29.meta.js
// ==/UserScript==
...
;;GImages==https://www.google.com/search?tbm=isch&q={searchTerms}\
;;YouTube==http://www.youtube.com/results?search_query={searchTerms}&aq=f\
;;GScholar==https://scholar.google.com/scholar?hl=en&q={searchTerms}\
;;Wikipedia==http://en.wikipedia.org/w/index.php?title=Special%3ASearch&profile=default&search={searchTerms}\
;;GMaps==http://maps.google.com/maps?q={searchTerms}",
...
#ddg_extented li:first-child { border-top-left-radius: 5px; border-bottom-left-radius: 5px }\
#ddg_extented li:last-child { border-top-right-radius: 5px; border-bottom-right-radius: 5px }\
...
function onHashChange() {
    ...
    window.addEventListener("hashchange", function() {
        if (window.location.hash.indexOf("{searchTerms}") !== -1)
            window.location.href = window.location.hash.substr(1).replace("{searchTerms}", document.getElementById("search_form_input").value);
    }, false);
}
