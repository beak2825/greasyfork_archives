// ==UserScript==
// @name            注释·pixiv快速打开原图＆自动收藏＆原图链接打包下载&图片预览
...
// @downloadURL https://update.greasyfork.org/scripts/448908/%E6%B3%A8%E9%87%8A%C2%B7pixiv%E5%BF%AB%E9%80%9F%E6%89%93%E5%BC%80%E5%8E%9F%E5%9B%BE%EF%BC%86%E8%87%AA%E5%8A%A8%E6%94%B6%E8%97%8F%EF%BC%86%E5%8E%9F%E5%9B%BE%E9%93%BE%E6%8E%A5%E6%89%93%E5%8C%85%E4%B8%8B%E8%BD%BD%E5%9B%BE%E7%89%87%E9%A2%84%E8%A7%88.user.js
// @updateURL https://update.greasyfork.org/scripts/448908/%E6%B3%A8%E9%87%8A%C2%B7pixiv%E5%BF%AB%E9%80%9F%E6%89%93%E5%BC%80%E5%8E%9F%E5%9B%BE%EF%BC%86%E8%87%AA%E5%8A%A8%E6%94%B6%E8%97%8F%EF%BC%86%E5%8E%9F%E5%9B%BE%E9%93%BE%E6%8E%A5%E6%89%93%E5%8C%85%E4%B8%8B%E8%BD%BD%E5%9B%BE%E7%89%87%E9%A2%84%E8%A7%88.meta.js
// ==/UserScript==
...
(function() {
    ...
    if((tagSave!=GM_getValue('tagSave')&&tagSave!='锁定锁定')||(tagSaveSafe!=GM_getValue('tagSaveSafe')&&tagSaveSafe!='锁定锁定')){
...
*/
	...
	<div class="recommend_inner_all" id="recommend_inner_all" style="height:225px;position: relative;z-index: 0;overflow: auto;">
        ...
        //No11_path：<path d="M682.225853 470.765979c8.511293-8.511293 21.278232-17.022585 29.789524-29.789524 51.067756-59.579048 72.345987-136.180682 59.579048-217.037962-17.022585-114.902451-106.391158-204.271023-221.293608-221.293609-93.624219-12.766939-182.992792 21.278232-242.57184 89.368573-46.812109 63.834695-72.345987 140.436328-59.579049 217.037962 12.766939 63.834695 42.556463 119.158097 93.624219 161.71456-148.947621 51.067756-255.338779 191.504084-255.338779 353.218644v93.624219C86.435368 977.187891 133.247478 1024 192.826526 1024h638.346948c59.579048 0 106.391158-46.812109 106.391158-106.391158v-93.624219c0-161.71456-106.391158-302.150888-255.338779-353.218644zM375.819318 151.592505c34.045171-42.556463 85.112926-63.834695 136.180682-63.834694 8.511293 0 17.022585 0 29.789524 4.255646 76.601634 12.766939 136.180682 76.601634 148.947621 148.947621 8.511293 55.323402-8.511293 106.391158-42.556463 144.691975-42.556463 46.812109-102.135512 72.345987-165.970206 59.579048-76.601634-12.766939-136.180682-76.601634-148.947621-148.947621-8.511293-51.067756 8.511293-106.391158 42.556463-144.691975z m476.632387 766.016337c0 12.766939-8.511293 21.278232-21.278231 21.278232h-638.346948c-12.766939 0-21.278232-8.511293-21.278231-21.278232v-93.624219c0-161.71456 131.925036-289.383949 289.383949-289.383949h97.879865c161.71456 0 289.383949 131.925036 289.38395 289.383949v93.624219z" fill="#fff" id="path18" style="transform: scale(0.0124) translate(251px, -122px) rotate(17deg);"></path>
        ...
        if(src!=null&&title!=null&&date!=null&&date_type!=null){
            ...
            historyDelete.onclick=function(){
                ...
                if(getCookie('history_R18')==0){//隐藏R-18
                    ...
                    for(var i=0;i<GMall.length;i++){
                        if(GMall[i].split('+')[GMall[i].split('+').length-1]==0){
                            ...
                            if(count==history_itemNumber){
                                console.log(GMall[i])
                                // if((GMall[i-1].split('+')[2]!=GMall[i].split('+')[2]&&GMall[i].split('+')[2]!=GMall[i+1].split('+')[2])||(GMall[i-1].split('+')[2]!=GMall[i].split('+')[2]&&GMall[i]==null)){
                                //     date_delete=1
                                //     }
                                GMall[i]=''
                                break
                    ...
                    // var history_deleteAdd=i
                }
                else if(getCookie('history_R18')==1){//显示R-18
                    console.log(GMall[history_itemNumber-1])
                    GMall[history_itemNumber-1]=''
                    // if((GMall[history_itemNumber-2].split('+')[2]!=GMall[history_itemNumber-1].split('+')[2]&&GMall[history_itemNumber-1].split('+')[2]!=GMall[history_itemNumber].split('+')[2])||(GMall[history_itemNumber-2].split('+')[2]!=GMall[history_itemNumber-1].split('+')[2]&&GMall[history_itemNumber-1]==null)){
                    //     date_delete=1
                    // }
                    /*                     for(i=0;i<GMall.length;i++){
                        if(GMall[i].split('+')[GMall[i].split('+').length-1]==0){
                            count++
                            if(count==history_itemNumber){
                                console.log(GMall[i])
                    ...
                    // history_deleteAdd=history_itemNumber-1
                }
                var final_value=''
                ...
                // var history_listLastItem=document.getElementsByClassName('history_textOut')[document.getElementsByClassName('history_textOut').length-1]
                // var history_lastNum=parseInt(history_listLastItem.id.match(/\d+/))
                ...
                /*                 if(historyDelete.closest('div').previousSibling.className=='history_date'&&historyDelete.closest('div').id=='history14'){
                    historyDelete.closest('div').previousSibling.remove()
                } */
                            ...
                            onload: function(res) {
                                if(res.status === 200){
                                    ...
                                    for(var i=0;i<b.length;i++){
                                        id[i]=b[i].match(/(?<="id":")\d+(?=","title")/)[0]
                                        title[i]=b[i].match(/(?<="title":").*?(?=","illustType")/)[0]
                                        src[i]=b[i].match(/(?<=,"url":").*?(?=","description")/)[0]
                                        pageCount[i]=b[i].match(/(?<=,"pageCount":).*?(?=,"isBookmarkable")/)[0]
                                        /*                                         if(b[i].match('tags":["R-18"')!=null){
                                            R18[i]=1//为R18图片
                                        }
                                        else{
                                            R18[i]=0//非R18图片
                                    ...
                                    for(var j=0;j<30;j++){
                                        ...
                                        // var src='https://tse4-mm.cn.bing.net/th/id/OIP-C.rHuc8SKa0wLVwCqqA27uIwHaEt?pid=ImgDet&rs=1'
                                        ...
                                        //https://tse4-mm.cn.bing.net/th/id/OIP-C.rHuc8SKa0wLVwCqqA27uIwHaEt?pid=ImgDet&rs=1
                                    }
                                }
                            }
                        })
    ...
    function r18_block(blur){
        ...
        new MutationObserver(mutations => {//动图预览相关
            /*             for(var o=0;o<mutations.length;o++){
                                    if(mutations[k].addedNodes[0]!=null&&mutations[k].addedNodes[0].id=='root'){
                        console.log(root)
                        // var canvas_before=mutations[k].addedNodes[0]
                        // mutations[k].addedNodes[0].click()
                    }
                if(mutations[o].addedNodes[0]!=null){
                    // alert('a')
                    console.log(mutations[o].addedNodes[0])
                }
            } */
            if(window.location.href.match('#preview')!=null){
                ...
                for(var k=0;k<mutations.length;k++){
                    ...
                    if(qq==0&&mutations[k].addedNodes[0]!=null&&mutations[k].addedNodes[0].className=='sc-tu09d3-1 inGOuX'){
                        // mutations[k].addedNodes[0].click()
                        // console.log(canvas_div.childNodes)
                        ...
                        for(var q=0;q<canvas_div.childNodes.length;q++){
                            if(canvas_div.childNodes[q].tagName=='CANVAS'){
                                ...
                                break
                                // canvas_div.childNodes[q].style.width='640px'
                                // canvas_div.childNodes[q].style.height='320px'
                            }
                        }
                        qq=1
                    }
            ...
            /*             if(window.location.href.match(/\/artworks\?/)!=null){
                console.log('搜索')
                for(var o=0;o<mutations.length;o++){
                    if(mutations[o].addedNodes[0].tagNam!='IMG'){
                        console.log(mutations[o].addedNodes[0])
                    }
                    if(mutations[o].addedNodes[0]!=null){
                        if(mutations[o].addedNodes[0].className=='sc-jn70pf-2 dhOsiK'){//热门作品“会员界面”覆盖的class
                            console.log('class')
                        }
                    }
                }
            ...
            for(var i=0;i<mutations.length;i++){
                if(mutations[i].addedNodes.length!=0){
                    if(mutations[i].addedNodes[0].src!=null){
                            ...
                            if(mutations[i].addedNodes[0].src.match("master1200")==null){
                                switch(mutations[i].type) {
                                    case 'childList':
                                        ...
                                        if(count==0&&mutations[i].addedNodes[0].id!='bigImg_1'&&mutations[i].addedNodes[0].parentNode.nextSibling!=null&&mutations[i].addedNodes[0].parentNode.nextSibling.innerText.match("R-18")!=null){
                    ...
                    else if(mutations[i].addedNodes[0].childNodes[0]!=null&&mutations[i].addedNodes[0].childNodes[0].className=='sc-162tykz-1 bmXCSR'){//预览图部分预览作者
                        ...
                        // console.log(document.getElementsByClassName('sc-13xx43k-0 sc-13xx43k-1 BSrHG kcxqsH')[0].style.width)
                        if(user_out!=null){
        ...
        if(getCookie('Size')!=2){
            ...
            if(el!=null){
                ...
                if(event.altKey!=true&&event.ctrlKey!=true&&event.target.closest('svg')!=null&&event.target.closest('button')!=null){
                    ...
                    lock_white=document.createElementNS("http://www.w3.org/2000/svg", 'path');
                    lock_black=document.createElementNS("http://www.w3.org/2000/svg", 'path');
                    lock_red=document.createElementNS("http://www.w3.org/2000/svg", 'path');
                    lock_out=document.createElementNS("http://www.w3.org/2000/svg", 'path');
                    lock_white.setAttribute('d',"M29.9796 20.5234C31.1865 21.2121 32 22.511 32 24V28 C32 30.2091 30.2091 32 28 32H21C18.7909 32 17 30.2091 17 28V24C17 22.511 17.8135 21.2121 19.0204 20.5234 C19.2619 17.709 21.623 15.5 24.5 15.5C27.377 15.5 29.7381 17.709 29.9796 20.5234Z")
                    lock_white.setAttribute('fill',"#fff")
                    lock_black.setAttribute('d',"M28 22C29.1046 22 30 22.8954 30 24V28C30 29.1046 29.1046 30 28 30H21 C19.8954 30 19 29.1046 19 28V24C19 22.8954 19.8954 22 21 22V21C21 19.067 22.567 17.5 24.5 17.5 C26.433 17.5 28 19.067 28 21V22ZM23 21C23 20.1716 23.6716 19.5 24.5 19.5C25.3284 19.5 26 20.1716 26 21V22H23 V21Z")
                    lock_black.setAttribute('fill',"#000")
                    ...
                    lock_out.setAttribute('d',"M21,5.5 C24.8659932,5.5 28,8.63400675 28,12.5 C28,18.2694439 24.2975093,23.1517313 17.2206059,27.1100183 C16.4622493,27.5342993 15.5379984,27.5343235 14.779626,27.110148 C7.70250208,23.1517462 4,18.2694529 4,12.5 C4,8.63400691 7.13400681,5.5 11,5.5 C12.829814,5.5 14.6210123,6.4144028 16,7.8282366 C17.3789877,6.4144028 19.170186,5.5 21,5.5 Z")
                    lock_out.setAttribute('fill',"#ff4060")
                    event.target.closest("button").childNodes[0].childNodes[1].remove()
                    event.target.closest("button").childNodes[0].appendChild(lock_red)
                    event.target.closest("button").childNodes[0].appendChild(lock_out)
                    event.target.closest("button").childNodes[0].appendChild(lock_white)
                    event.target.closest("button").childNodes[0].appendChild(lock_black)
                    getFinalUrl(1,event,getPageNum(event,0))
                    // }
                }
    ...
    function checkCookie(){
        ...
        morefunction.addEventListener('click',()=>{
            ...
            if(w>0){
                ...
                elem_1.style.transform="rotate(58deg) translateX(94px)"
                elem_2.style.transform="rotate(-29deg) translateX(86px)"
                elem_3.style.transform="rotate(32deg) translateX(81px)"
                elem_4.style.transform="rotate(37deg) translateX(125px)"
                elem_5.style.transform="rotate(-36deg) translateX(135px)"
                elem_6.style.transform="rotate(60deg) translateX(136px)"
                elem_7.style.transform="rotate(1deg) translateX(79px)"
                elem_8.style.transform="rotate(13deg) translateX(119px)"
                elem_9.style.transform="rotate(-58deg) translateX(147px)"
                elem_10.style.transform="rotate(-12deg) translateX(124px)"
                elem_11.style.transform="rotate(-54deg) translateX(102px)"
                click_num++
            }
            else if(w<0){
        ...
        if(getCookie('tagCookieSetting')==1){
            ...
            if(event.target.id=='spin'||event.target.id=='path_spin'){//
                ...
                if(document.getElementById('tag_view_out').style.backgroundColor=='rgb(229, 229, 229)'){
                    ...
                    if(getCookie('tagCookieType')==0){
                        if(GM_getValue('tagSave')!=''){
                            // document.getElementById('tag_view_text').style.fontWeight=500
                            document.getElementById('tag_view_text').value=GM_getValue('tagSave')
                        }
                        else if(GM_getValue('tagSave')==''){
                            // document.getElementById('tag_view_text').style.fontWeight=550
    ...
    document.body.addEventListener('mousemove',function(event){
        ...
        if((pre_check=="1"||pre_check=="2"||pre_check=="3")&&event.ctrlKey!=true){
            ...
            for(var ab=0;ab<10;ab++){
                ...
                else if(eventt.className=="sc-1nhgff6-4 boBnlf"||eventt.className=="sc-l7cibp-1 krFoBL"||eventt.className=="sc-9y4be5-1 jtUPOE"||eventt.className=="sc-1kr69jw-0 hkzusx"||eventt.className=="userImgUl"){//分别对应“大图页面画师下方滚动图”，“大图页面图片推荐、主页‘推荐作品’”，“主页除‘推荐作品’以外大部分位置”，更多作者图片ul元素
                    var className=true
                    break
                }
                else{
    ...
    document.body.addEventListener('mousemove',function(event){
        ...
        if(eventT_ul!=null){
            if(ab!=false&&eventT_ul!=null&&(eventT_ul.className=="sc-iasfms-1 hYfnPb"||eventT_ul.className=="sc-iasfms-3 jDiPOg"||eventT_ul.className=="sc-l7cibp-1 krFoBL"||eventT_ul.className=="sc-1kr69jw-0 hkzusx"||eventT_ul.className=="sc-9y4be5-1 jtUPOE"||eventT_ul.className=='userImgUl')){//分别对应“大图片页面下推荐图片部分单个图片”和“主页面部分图片单个图片”、“大图片页面画师信息下滚动部分单个图片”、更多作者图片部分ul元素
                var ab=true
                }
            else{
                ab=false
        ...
        /*         if(ab==false&&(eventT.id=='bigImg_numBack'||eventT.id=='bigImg_numText'||eventT.id=='bigImg_1')){
            ab=true
        } */
        if(ab==false){
    ...
    /* window.addEventListener('mousemove',function(event){
        ...
        if(document.getElementById('bigImg_1')!=null){
            var mouseX=event.clientX
            var mouseY=event.clientY
            var imgX=document.getElementById('bigImg_1').style.left.match(/\d+/)[0]
            var imgY=document.getElementById('bigImg_1').style.top.match(/\d+/)[0]
            var imgWidth=document.getElementById('bigImg_1').width.match(/\d+/)[0]
            var imgHeight=document.getElementById('bigImg_1').height.match(/\d+/)[0]
            if(mouseX>=imgX&&mouseY>=imgY){//图片在左上角
                document.getElementById('bigImg_1').style.transformOrigin='bottom right'
            }
            else if(mouseX>=imgX&&mouseY<imgY){//图片在左下角
                document.getElementById('bigImg_1').style.transformOrigin='top right'
            }
            else if(mouseX<imgX&&mouseY>=imgY){//图片在右上角
                document.getElementById('bigImg_1').style.transformOrigin='bottom left'
            }
            else if(mouseX>=imgX&&mouseY<imgY){//图片在右下角
                document.getElementById('bigImg_1').style.transformOrigin='top left'
            }
        }
    }) */
    //————————————————————————————————————————————————————
    ...
    /*     window.addEventListener('mousemove',function(event){
        if(event.target.tagName=='IMG'&&(event.target.src.match('square1200')!=null||event.target.src.match('custom1200')!=null)){
            // if(event.keyCode
        }
    }) */
    ...
    document.addEventListener('click',function(event){
        // console.log(event.target)
        if(event.target.id=='user_svg'/*&&event.target.id=='user_svg'*/){
            // alert('a')
    ...
    window.addEventListener('click',function(event){
        if(document.getElementById('history_pageNum')!=null){
            /*             if(GM_getValue('pixiv_history')!=null&&GM_getValue('pixiv_history').split(',')!=null){
                var all_historyList=GM_getValue('pixiv_history').split(',').length
                }
            else{
                all_historyList=0
            } */
        ...
        if(event.target.id=='history_pageNum'){
            ...
            document.getElementById('history_pageInput').onkeydown=function(e){
                if(e.keyCode==13){
                    ...
                    /*                     if(document.getElementById('history_pageInput')!=null){
                        document.getElementById('history_pageInput').outerHTML='<text id="history_pageNum">'+document.getElementById('history_pageInput').value+'</text>'
                        if(parseInt(document.getElementById('history_pageNum').innerText)>(parseInt(all_historyList/15)+1)){
                            document.getElementById('history_pageNum').innerText=(parseInt(all_historyList/15)+1)
                        }
                        else if(parseInt(document.getElementById('history_pageNum').innerText)<1){
                            document.getElementById('history_pageNum').innerText=1
                        }
                        addHistory((parseInt(document.getElementById('history_pageNum').innerText)-1)*15)
                    } */
                }
            }
        }
    ...
    /*     window.addEventListener('keydown',function(e){
        var history='2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220417+0,2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220417+0,2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220417+0,2016/08/16/00/03/30/58466452_p0+#オリジナル 仮想と狭間 - よー清水@画集予約受付中的插画+220416+0,2016/08/11/22/15/09/58390527_p0+#オリジナル C0お品書き - よー清水@画集予約受付中的插画+220416+0,2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220416+0,2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220416+0,2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220416+0,2016/08/16/00/03/30/58466452_p0+#オリジナル 仮想と狭間 - よー清水@画集予約受付中的插画+220415+0,2016/08/11/22/15/09/58390527_p0+#オリジナル C0お品書き - よー清水@画集予約受付中的插画+220415+0,2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220415+0,2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220415+0,2016/08/25/00/04/37/58631790_p0+#オリジナル 天空の宮殿 - よー清水@画集予約受付中的插画+220412+0,2016/08/16/00/03/30/58466452_p0+#オリジナル 仮想と狭間 - よー清水@画集予約受付中的插画+220412+0,2016/08/11/22/15/09/58390527_p0+#オリジナル C0お品書き - よー清水@画集予約受付中的插画+220412+0'
        if(e.keyCode==68){
            alert(GM_getValue('pixiv_history'))
        }
        else if(e.keyCode==46){
            GM_deleteValue('pixiv_history')
        }
        else if(e.keyCode==65){
            GM_setValue('pixiv_history',history)
        }
    ...
    /*     window.addEventListener('keydown',function(e){
        if(e.keyCode==68){
            console.log(GM_getValue('tagSave'))
            console.log(GM_getValue('tagSaveSafe'))
        }
    }) */
