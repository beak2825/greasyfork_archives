...
// @icon         https://simpleicons.org/icons/applearcade.svg
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/459592/html%E8%A7%86%E9%A2%91%E5%BF%AB%E6%8D%B7%E9%94%AE-log.user.js
// @updateURL https://update.greasyfork.org/scripts/459592/html%E8%A7%86%E9%A2%91%E5%BF%AB%E6%8D%B7%E9%94%AE-log.meta.js
// ==/UserScript==
(function (w) {
  if (w) {
    w.name = "h5player";
...
const hasUseKey = {
  keyCodeList: [
    13, 16, 17, 18, 27, 32, 37, 38, 39, 40, 49, 50, 51, 52, 67, 68, 69, 70, 72,
    73, 74, 75, 76, 77, 78, 79, 80, 81, 82, 83, 84, 85, 87, 88, 89, 90, 97, 98,
    99, 100, 220,
  ],
  keyList: [
    "enter",
  ...
  setCurrentTimeDown(num) {
    ...
    if (TCC$1.doTask("subtractCurrentTime"));
      ...
      if (this.player()) {
        ...
        this.tips(
          i18n.t("tipsMsg.backward") + Math.abs(num) + i18n.t("tipsMsg.seconds")
        );
      }
    }
  },
