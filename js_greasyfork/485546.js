// ==UserScript==
// @name     MAHE Autofill Button for Discharge of ENT001
// @version  1.0
// @grant    none
...
// @downloadURL https://update.greasyfork.org/scripts/485546/MAHE%20Autofill%20Button%20for%20Discharge%20of%20ENT001.user.js
// @updateURL https://update.greasyfork.org/scripts/485546/MAHE%20Autofill%20Button%20for%20Discharge%20of%20ENT001.meta.js
// ==/UserScript==
...
(function() {
  ...
  button.addEventListener('click', function() {
    ...
    if (input4.value == '') {
      input4.value = '9686676675';
    }
    if (input5.value == '') {
      input5.value = 'Dr. Suresh Pillai';
    }
    if (input6.value == '') {
