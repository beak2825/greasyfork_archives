...
// @grant        all
// @downloadURL https://update.greasyfork.org/scripts/17381/Not%20bloomed%20TM%20-%20V112.user.js
// @updateURL https://update.greasyfork.org/scripts/17381/Not%20bloomed%20TM%20-%20V112.meta.js
// ==/UserScript==
                ...
                return ((Math.pow(2,Math.log(weight*SI)/Math.log(Math.pow(2,7))) - Math.pow(2,Math.log(weight*wage/(wage_rate))/Math.log(Math.pow(2,7)))).toFixed(1)*10) - 1 ;
                 ...
                 function return_starting_blooming(Last_Season_Avg_Ti,Season_Avg,SI,age,rec)
                        {var Age = parseInt(age);
                         ...
                         if ((Age == 19)&&(rec > 2.0)&&(rec <3.5)&&(Season_Avg > 6)&&(Season_Avg<10)) {return "$$$"}
                         if ((Age == 20)&&(rec > 2.0)&&(rec <4.0)&&(Season_Avg > 5)&&(Season_Avg<9)&&(SIN > 1999) &&(SIN<16000)) {return "$$$"} 
                         if ((Age == 21)&&(rec > 2.0)&&(rec <4.0)&&(Season_Avg > 5)&&(Season_Avg<8)&&(SIN > 1999) &&(SIN<16000)) {return "$$$"} else {return "----";}
