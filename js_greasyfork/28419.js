...
// @match *://*.ikukudm.com/comiclist/*/*
// @match *://*.kkkkdm.cc/comiclist/*/*
// @match *://*.cartoonmad.com/comic/*
// @match *://*.manhuagui.com/comic/*/*
// @match *://e-hentai.org/s/*/*
// @match *://exhentai.org/s/*/*
// @match *://nhentai.net/g/*/*
// @match *://*.nyahentai.fun/g/*/*/*
// @downloadURL https://update.greasyfork.org/scripts/28419/Manga%20Loader%20Personal.user.js
// @updateURL https://update.greasyfork.org/scripts/28419/Manga%20Loader%20Personal.meta.js
// ==/UserScript==
...
var implementations = [{
  ...
  name: 'kukudm',
  match: "^https?://((.*).ikukudm.com|kkkkdm.cc)/comiclist/[0-9]+/[0-9]+/[0-9]+.htm",
  img: function(ctx) {
    var script = getEl('td > script[language=javascript]', ctx);
    if(script) {
      return 'http://pc.ihhmh.com/' + script.textContent.match(/\+"([^']+)/)[1]; // https://s444.kukudm.com/
    }
  },
  next: function(ctx) {
  ...
  name: 'cartoonmad',
  match: "https?://(www\\.)?cartoonmad\.com/comic/[0-9]{5,}\.html",
  img: 'tr:nth-child(4) > td > table > tbody > tr:nth-child(1) > td > a > img',
  next: 'a.onpage+a',
  curpage: 'a.onpage',
  numpages: function() {
  ...
  name: 'manhuagui',
  match: "https?://(www|tw)\.manhuagui\.com/comic/[0-9]+/[0-9]+\.html",
  img: '#mangaFile',
  next: function() {
      return W._next;
  },
  ...
  wait: function() {
    if (getEl('#mangaFile')) {
      ...
      W._next = location.href.replace(/([0-9]+)?\.html.*/,'.html#p='+(ex('curpage') + 1));
  ...
  pages: function(url, num, cb, ex) {
    ...
    var nexturl =  url.replace(/([0-9]+)?\.html.*/,'.html#p='+(num + 1));
    //var imgurl = W._base + W.cInfo.files[num - 1];
    var numStr = num.toString();
    while(numStr.length<4){
      numStr ='0'+numStr;
    }
    var imgurl = W._base.replace(/([0-9]+)?\.jpg.webp/,numStr+'.jpg.webp');
    cb(imgurl, nexturl);
  }
}, {
  name: 'geh-and-exh',
  ...
  name: 'nyahentai',
  match: "^https?://zh.nyahentai\\.fun\\/g\\/[0-9]+/list/[0-9]+",
...
var getViewer = function(prevChapter, nextChapter) {
  ...
  document.head.innerHTML = '<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">';
