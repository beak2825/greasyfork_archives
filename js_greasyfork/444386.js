...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/444386/TwitterTool.user.js
// @updateURL https://update.greasyfork.org/scripts/444386/TwitterTool.meta.js
// ==/UserScript==
...
(function () {
    ...
    let tws = [
        "/sougenco/status/1537739484120625154"
    ]

    let gzs = [
       // "qgx_dev", "LifeQGame","QG11111","YingZKing","DongDong_MC",
        "sougenco"
    ...
    async function autotw(a1 = false, a2 = false,a3 = false) {
        ...
        if (openTw) {
            document.querySelector("#id__wafp4a3ppa > div:nth-child(3) > div > div > div > div")
            await sleep(1000);
            let like = document.querySelector("#react-root > div > div > div.css-1dbjc4n.r-18u37iz.r-13qz1uu.r-417010 > main > div > div > div > div.css-1dbjc4n.r-14lw9ot.r-jxzhtn.r-1ljd8xs.r-13l2t4g.r-1phboty.r-1jgb5lz.r-11wrixw.r-61z16t.r-1ye8kvj.r-13qz1uu.r-184en5c > div > section > div > div > div:nth-child(1) > div > div:nth-child(1) > article > div > div > div > div:nth-child(3) > div:nth-child(5) > div > div:nth-child(3) > div > div > div > div")
            if (like && !a1) {
                console.log("推文点喜欢！");
                like.click()
            ...
            let retweet = document.querySelector("#react-root > div > div > div.css-1dbjc4n.r-18u37iz.r-13qz1uu.r-417010 > main > div > div > div > div.css-1dbjc4n.r-14lw9ot.r-jxzhtn.r-1ljd8xs.r-13l2t4g.r-1phboty.r-1jgb5lz.r-11wrixw.r-61z16t.r-1ye8kvj.r-13qz1uu.r-184en5c > div > section > div > div > div:nth-child(1) > div > div:nth-child(1) > article > div > div > div > div:nth-child(3) > div:nth-child(5) > div > div:nth-child(2) > div > div > div > div")
            if (retweet && !a2) {
                console.log("推文点转推！");
                retweet.click()
                await sleep(1000);
            ...
            let pinglun = document.querySelector("#react-root > div > div > div.css-1dbjc4n.r-18u37iz.r-13qz1uu.r-417010 > main > div > div > div > div.css-1dbjc4n.r-14lw9ot.r-jxzhtn.r-1ljd8xs.r-13l2t4g.r-1phboty.r-1jgb5lz.r-11wrixw.r-61z16t.r-1ye8kvj.r-13qz1uu.r-184en5c > div > section > div > div > div:nth-child(1) > div > div:nth-child(1) > article > div > div > div > div:nth-child(3) > div:nth-child(5) > div > div:nth-child(1) > div > div > div > div")
            if (pinglun && !a3) {
                console.log("评论！");
                pinglun.click()
