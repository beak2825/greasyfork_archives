...
// @description       Скрипт, который подходит для всех серверов, предназначен для быстрой реакции кураторов форума в различных разделах. Он разработан с учётом размеров экрана телефона. Также в скрипт встроен счётчик слов в РПБ.
