...
// @icon           http://i1222.photobucket.com/albums/dd496/buyukbang/Buyukbang%20IMDB%20Bar/large.jpg
// @screenshot     http://i1222.photobucket.com/albums/dd496/buyukbang/Buyukbang%20IMDB%20Bar/Buyukbang_IMDB_Bar_New.jpg
...
// @grant          GM_openInTab
// @grant          GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/26752/BuyukBang%20IMDb%20Bar.user.js
// @updateURL https://update.greasyfork.org/scripts/26752/BuyukBang%20IMDb%20Bar.meta.js
// ==/UserScript==
...
//ShareBus
trackers.push(new SearchEngine("Download Link: ShareBus", "http://www.sharebus.org/index.php?act=Search&CODE=01&forums=all&search_in=imdbid&result_type=topics&keywords=%imdbkod", true,
...
//Tehparadox.com
trackers.push(new SearchEngine("Download Link: Tehparadox.com via Google", "http://www.google.com.tr/search?q=site%3Atehparadox.com intitle:'"+cleanTitle+"'", true,
...
function SearchEngine(shortname, searchurl, usesIMDBID, icon) {
	...
	this.getHTML = function (title, id) {
		if (this.shortname == "blank") {
			...
			var html = "<a href=\"" + this.getSearchUrl(title, id) + "\" target=\"_blank\"><img class=\"img\" style=\"-moz-opacity: 0.4;\" border=\"0\" src=\"" + this.icon + "\" title=\"" + this.shortname + "\"><\/a>&nbsp;";
		}
		return html;
	}
