// ==UserScript==
// @license       666
// @name         大麦抢票（pc网页+手机浏览器自动提交）
// @namespace    公众号：时光线报
// @version      1.0.9
// @description  辅助抢购大麦网门票自动提交订单：网页普通场次自动下单、选座场次需手动选座；手机版浏览器普通场次自动提交
// @author       secret11979
...
// @downloadURL https://update.greasyfork.org/scripts/463405/%E5%A4%A7%E9%BA%A6%E6%8A%A2%E7%A5%A8%EF%BC%88pc%E7%BD%91%E9%A1%B5%2B%E6%89%8B%E6%9C%BA%E6%B5%8F%E8%A7%88%E5%99%A8%E8%87%AA%E5%8A%A8%E6%8F%90%E4%BA%A4%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/463405/%E5%A4%A7%E9%BA%A6%E6%8A%A2%E7%A5%A8%EF%BC%88pc%E7%BD%91%E9%A1%B5%2B%E6%89%8B%E6%9C%BA%E6%B5%8F%E8%A7%88%E5%99%A8%E8%87%AA%E5%8A%A8%E6%8F%90%E4%BA%A4%EF%BC%89.meta.js
// ==/UserScript==
...
$(document).ready(function () {
    ...
    if (curr_url.includes("https://m.damai.cn/damai/")) {
        ...
        if (phone_order_url) {
            ...
            if (Number(reload_cnt) > 10) {
                alert("刷新太频繁，也可能被盾，请关闭该窗口重新进入网址抢购");
...
function detail_ui() {
    ...
    var $wx = $(`<div id="wx" class="notice"><p>公众号【时光线报】 </p><p>版本： ${version}</p></div>`);
...
function phone_detail_ui() {
    ...
    var $control_container = $("<div id='control_container'></div>");
    var $wx = $(`<div id="wx" class="notice"><p>最新版请联系上级</p><p>版本： ${version}</p></div>`);
...
function detail_seat_ui() {
    ...
    var $wx = $(`<div id="wx" class="notice"><p> </p><p>版本： ${version}</p></div>`);
    var $number_input = $('<div class="input_wrapper" id="number_input_wrapper">请输入人数：<input id="number_input" type="number" value="1" min="1" max="6"></div>');
    var $start_btn = $('<button id="start_btn">开始抢票</button>');
    var $end_btn = $('<button id="end_btn">停止抢票</button>');
    var $notice = $('<div id="notice" class="notice"><h3>使用步骤</h3><p>1.登录，填写购票人信息</p><p>2.选择场次->价格->填写人数</p><p>3.点击‘开始抢票’</p></div>');
