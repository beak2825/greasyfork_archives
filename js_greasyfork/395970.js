...
// @downloadURL https://update.greasyfork.org/scripts/395970/%E8%B7%B3%E8%BD%AC%E9%93%BE%E6%8E%A5%E4%BF%AE%E5%A4%8D%EF%BC%88%E7%A7%BB%E9%99%A4%E9%87%8D%E5%AE%9A%E5%90%91%E5%A4%96%E9%93%BE%E7%9B%B4%E8%BE%BE%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/395970/%E8%B7%B3%E8%BD%AC%E9%93%BE%E6%8E%A5%E4%BF%AE%E5%A4%8D%EF%BC%88%E7%A7%BB%E9%99%A4%E9%87%8D%E5%AE%9A%E5%90%91%E5%A4%96%E9%93%BE%E7%9B%B4%E8%BE%BE%EF%BC%89.meta.js
// ==/UserScript==
!function() {
  "use strict";
  ...
  var sites$B = [ defineSite([ "ACG\u76d2\u5b50", "acgbox.link", {
    transform: {
  ...
  } ]) ], BAIDU_RE = /^(http:\/\/[^.]+\.[^.]+\.baidu\.com|https:\/\/baike\.baidu\.com)/, sites$z = [ defineSite([ "\u767e\u5ea6\u641c\u7d22", "baidu.com", {
    transform: {
  ...
  } ]) ], urlMap = new Map, sites$x = [ defineSite([ "Bing \u641c\u7d22", /^(?:\w+\.)?bing\.com$/, {
    transform: {
  ...
  } ]) ], sites$w = [ defineSite([ "\u4e66\u7b7e\u5730\u7403", "bookmarkearth.cn", {
    transform: {
  ...
  } ]) ], REMOVE_ATTRS = [ "onclick", "onmouseover", "onmouseout" ], sites$h = [ defineSite([ "NGA \u73a9\u5bb6\u793e\u533a", /^(bbs\.nga\.cn|ngabbs\.com|g\.nga\.cn)$/, {
    transform: {
    ...
    ngaCn: sites$h,
    nodeseekCom: [ [ "NodeSeek", "nodeseek.com", {
      transform: {
