// ==UserScript==
// @name        C&C:TA Navigate
// @namespace   CnC_TA_Navigate
// @author  	Vulcano
// @version     1.0.0.1
// @date        2015-03-25
...
// @description [ALT]+[N] opens a window to enter coords and follow it
// @include   	https://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @downloadURL https://update.greasyfork.org/scripts/15064/CC%3ATA%20Navigate.user.js
// @updateURL https://update.greasyfork.org/scripts/15064/CC%3ATA%20Navigate.meta.js
// ==/UserScript==

(function (){
    console.log('C&C:TA Navigate loading ...');
    var nav_load_main = function() {  
        ...
        function initialize() {
            ...
            navBox = new qx.ui.window.Window("Nav To");
            navBox.setPadding(1);
    ...
    console.log('C&C:TA Navigate loaded successfully !!!');
})();
