...
// @downloadURL https://update.greasyfork.org/scripts/31870/Contact%20Accuracy%20-%20Contacts.user.js
// @updateURL https://update.greasyfork.org/scripts/31870/Contact%20Accuracy%20-%20Contacts.meta.js
// ==/UserScript==

if ($('li:contains("2664-68")').length) {
    ...
    number.append('<br>');
     ...
     //Answers//
    createButton('Yes/Link/Current', 0,0,0);
    createButton('Yes/Link/Past', 0,0,1);
    createButton('Yes/Recently/Link', 1,0,0);
    createButton('Past/Linked/Yes', 2,0,0);
    createButton('Yes/Linkedin/Wrong Title', 0,0,2);
    createButton('Yes/Evidence/Wrong Title', 3,3,0);
