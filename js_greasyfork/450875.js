// ==UserScript==
// @name        Mouse to where(Open in self).
// @namespace   Mouse to where(Open in self).
...
// @downloadURL https://update.greasyfork.org/scripts/450875/Mouse%20to%20where%28Open%20in%20self%29.user.js
// @updateURL https://update.greasyfork.org/scripts/450875/Mouse%20to%20where%28Open%20in%20self%29.meta.js
// ==/UserScript==

(function() {
  'use strict';
  const openInSelf = true
  const addStyle = ()=>{
