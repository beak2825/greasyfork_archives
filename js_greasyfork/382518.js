// ==UserScript==
// @name         Youtube PlaybackRate
// @namespace    https://greasyfork.org/en/users/119330-edward-sluder
// @version      0.8
// @description  Automatically play youtube videos at n rate
// @author       EPS
// @match        https://www.youtube.com/watch?*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/382518/Youtube%20PlaybackRate.user.js
// @updateURL https://update.greasyfork.org/scripts/382518/Youtube%20PlaybackRate.meta.js
// ==/UserScript==
...
(function() {
    ...
    function ourPlaybackRate() {
        ...
        ourVideo = document.querySelectorAll( 'video' );      
            ...
            ourVideo[0].playbackRate = 1.8;
            ourVideo[0].focus;
           // showPlayback( ourVideo[0] );
            ourVideo[0].requestFullscreen();
