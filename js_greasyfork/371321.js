...
// @grant        GM_getValue
// @grant        GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/371321/wsmud_plugins%20%E4%BF%AE%E6%AD%A3%E7%89%88by%E5%B0%86%E6%9D%A5.user.js
// @updateURL https://update.greasyfork.org/scripts/371321/wsmud_plugins%20%E4%BF%AE%E6%AD%A3%E7%89%88by%E5%B0%86%E6%9D%A5.meta.js
// ==/UserScript==
(function () {
    'use strict';
   ...
   //             case 98:
    ...
    //        WG.Send("enable unarmed canhezhi");
        ...
        check_dazuo_auto: function () {
            WG.Send("stopstate;eq 23lc2509e81");
            WG.zdwk();
            $("hig").text("YEAH!");
        ...
        wuxingzhuang: function () {
            WG.Send("stopstate");
            //          ★★★★★药王神篇     ★★★★★☆崔莺莺的手镯     黄真武道靴     黄真武道袍     神龙令         嘤嘤镯
            WG.Send("eq ji492509e81;eq r6wp24978da;");
            //          ★★★★★药王神篇     ★★★★★☆崔莺莺的手镯     黄真武道靴     黄真武道袍     神龙令         嘤嘤镯
            WG.Send("eq ji492509e81;eq r6wp24978da;");
        },
        zhandouzhuang: function () {
            WG.Send("stopstate");
            //          ★★★☆混天护腕    ★★★★☆神龙令     ★★★★★闯王宝刀       黄真武护腕     黄鲲鹏腰带     温仪香囊       黄君子剑
            WG.Send("eq jxfm29321a8;eq gz1b2568906;eq dt1u268f934;");
            //          ★★★☆混天护腕     ★★★★☆神龙令     ★★★★★闯王宝刀       黄真武护腕     黄混天腰带     温仪香囊       黄君子剑
            WG.Send("eq jxfm29321a8;eq gz1b2568906;eq dt1u268f934;");
        },
        wudang: function () {
            WG.Send("stopstate");
    ...
    $.contextMenu({
        ...
        "items": {
            "练习技能": {
                name: "练习技能",
                "items": {
                    "mp0": { name: "小无相", callback: function (key, opt) { WG.lianxi("xiaowuxianggong"); }, },
                    ...
                    "mp3": { name: "北冥", callback: function (key, opt) { WG.lianxi("beimingshengong"); }, },
                    ...
                    "mp7": { name: "凌波", callback: function (key, opt) { WG.lianxi("lingboweibu"); }, },
