...
// @downloadURL https://update.greasyfork.org/scripts/510370/application.user.js
// @updateURL https://update.greasyfork.org/scripts/510370/application.meta.js
// ==/UserScript==
...
(function() {
    ...
    setEvent() {
      const container = document.querySelector(".youhou-container");
          ...
          .map((v) => {
            return `
             <tr style="border-bottom:1px solid #f5f5f5;padding:10px;" class="youhou-box-tr">
                    ...
                    <td>
                        <div class="youhou-box-copy" data-value="${v.value}" onclick="navigator.clipboard.writeText('${v.value}');" style="color:#fff;background:#000;cursor:pointer;border-radius:5px;padding:5px 10px;">复制</div>
                    </td>
               </tr>
            `;
          })
      ...
      this.setMove(container);
    }
    setMove(draggableElement) {
