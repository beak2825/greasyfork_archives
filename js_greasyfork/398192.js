...
// ==UserScript==
// @name           MooMoo.io Dark hack (HA$) 2020
// @namespace      -
// @version          ╳1╳
// @description    【Hacks & Hackkeys】 ➜ 〖 AUTO HEAL - T 〗 〖 MOD - MENU - ESC 〗 〖 INSTAKILL - R 〗 〖 AUTOSPIKE - V 〗 〖 MORE FPS 〗 〖taken in the creator CHIPERMOD〗 〖 BOOST & SPIKE - G 〗 〖 AUTOWINDMILL - N 〗 〖 HATMACRO 【U CAN CHANGE A KEY FOR HAT MACRO】 〗 〖 PREMIUM MAP 〗 〖 INSTAWINDMILL´S - O 〗 〖 INSTATRAPS / BOOSTPADS - I 〗 〖 CX insta - SPACEBAR 〗 〖 INSTASPIKE´S - Ü 〗 〖 AIMCURSOR 〗 〖 BIG SHOP 〗 〖☭HotlineMod☭ WEBSITE - TOP LEFT【WOLF SYMBOL】 〗
// @author         Saints
// @match          *://moomoo.io/*
// @match          *://dev.moomoo.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/398192/MooMooio%20Dark%20hack%20%28HA%24%29%202020.user.js
// @updateURL https://update.greasyfork.org/scripts/398192/MooMooio%20Dark%20hack%20%28HA%24%29%202020.meta.js
// ==/UserScript==

$('#menuContainer').append('If you want to go to the HotlineMod website click on the wolf symbol in the top left')
...
document.getElementById('enterGame').innerHTML = 'дорога в ад';
document.getElementById('loadingText').innerHTML = '. . . . . . . . . Load Dark king top:D . . . . . . . . .  ';
document.getElementById('nameInput').placeholder = "PInK";
document.getElementById('chatBox').placeholder = "Dark pro XD";
document.getElementById('diedText').innerHTML = ',блять';
...
document.getElementById("gameName").innerHTML = "dark hack(HA$)"
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">HotlineMod - Settings</h2>
        </div>
...
<label class="container">More FPS
        ...
        <div class="modal-body" style="font-size: 17px;">
            <div class="flexControl">
                <h3 style="color: Purple; font-size: 17px;">Hat-keys</h3>
...
document.addEventListener('keydown', (e)=>{
    ...
    if(e.keyCode == 111 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        if(healToggle == 0) {
            if(hatToggle == 0) {
                document.title = "Heal - off|☭HotlineMod☭"
            } else {
                document.title = "Heal - off|☭HotlineMod☭"
            }
        } else {
            if(hatToggle == 0) {
                document.title = "Heal - on|☭HotlineMod☭"
            } else {
                document.title = "Heal - on|☭HotlineMod☭"
            }
        }
