// ==UserScript==
// @name        Тюмень для  тюменевцев
// @namespace    https://forum.blackrussia.online/
// @version      5.99.1
// @description  Специально для BlackRussia || меня
// @author       
...
// @downloadURL https://update.greasyfork.org/scripts/502783/%D0%A2%D1%8E%D0%BC%D0%B5%D0%BD%D1%8C%20%D0%B4%D0%BB%D1%8F%20%20%D1%82%D1%8E%D0%BC%D0%B5%D0%BD%D0%B5%D0%B2%D1%86%D0%B5%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/502783/%D0%A2%D1%8E%D0%BC%D0%B5%D0%BD%D1%8C%20%D0%B4%D0%BB%D1%8F%20%20%D1%82%D1%8E%D0%BC%D0%B5%D0%BD%D0%B5%D0%B2%D1%86%D0%B5%D0%B2.meta.js
// ==/UserScript==
...
(async function () {
    ...
    //      `Пожалуйста, прикрепите доказательства к жалобе, которые подтверждают нарушение администратора.<br><br>`+
        //      `[COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере TYUMEN.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
    ...
    //         `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
    //  },
    //  {
    ...
    //         `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на серверае TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
	//  },
    //  {
    ...
    //     `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере TYUMEN[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
	//   prefix: PIN_PREFIX,
	//   status: true,
    //  },
    //  {
	...
	// 	`[CENTER][COLOR=rgb(250, 197, 28)]На рассмотрении. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
    //   prefix: PIN_PREFIX,
	//   status: true,
    //  },
     /*{
      ...
      `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},*/
    // {
    ...
    //   `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
	//   prefix: UNACCEPT_PREFIX,
	//   status: false,
	// },
    {
	...
	},
    {
	  ...
	  content:
        ...
        `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
            ...
            `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервереTYUMEN[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
            prefix: UNACCEPT_PREFIX,
            status:false,
    },
	// {
	...
	// },
    {
        ...
        `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    ...
    },
    {
        ...
        content:
            ...
            `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
        prefix: UNACCEPT_PREFIX,
        status:false,
    },
    {
        ...
        content:
            ...
            `[CENTER][COLOR=rgb(0, 255, 0)]Рассмотрено. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br>`,
	...
	},*/
    {
        ...
        content:
            ...
            `[CENTER]Отказано, закрыто Приятной игры на сервере TYUMEN[/CENTER][/FONT][/SIZE]<br><br>`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    },
    ...
    },
    {
	  ...
	  content:
		...
		`[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
	{
    ...
    },
    {
	  ...
	  content:
        ...
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
    {
    ...
    },
    {
        ...
        `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
        ...
        `[CENTER][COLOR=rgb(0, 255, 0)]Одобрено. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: ACCEPT_PREFIX,
        status: false,
    },
    {
        ...
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере TYUMEN[/COLOR][/FONT][/SIZE][/CENTER]`,
        prefix: PIN_PREFIX,
        status:true,
    },
    {
        ...
        `[COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
      ...
      `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
      ...
      `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
       ...
       `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере TYUMEN[/COLOR][/CENTER][/SIZE][/FONT]<br>`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю ваше обжалование Главному Администратору —  [user=308750]Anatoliy Pyatak ღ[/user] <br><br>`+
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br>`,
      prefix: GA_PREFIX,
	  status: true,
    },
    ...
    const buttons2 = [
      ...
      content: `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто. Приятной игры на сервере TYUMEN[/CENTER][/color]`,
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    // {
    ...
    const buttons3 = [
        ...
        },
        {
            ...
            content:
                ...
                `[CENTER][COLOR=rgb(0, 255, 0)]Одобрено. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br>`,
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER]Передаю вашу жалобу Главному Администратору —  [user=308750]Wyatt_Capone[/user] <br><br>`+
                `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере TYUMEN[/COLOR][/CENTER]<br>`,
            prefix: GA_PREFIX,
            status: true,
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] ${user.mention}[/CENTER]<br><br>`+
                `[CENTER]Ваша жалоба была передана на рассмотрение техническому специалисту.[/CENTER]<br><br>` +
                `[CENTER][COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере TYUMEN[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
            prefix: TECH_PREFIX,
            status: true,
        },
        {
