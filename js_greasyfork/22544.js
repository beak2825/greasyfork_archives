...
// @version      0.1
// @description  show desktop notifications (no new messages)
// @author       menya
// @match        https://*.waysofhistory.com/*
// @exclude      https://ruforum.waysofhistory.com/
// @exclude      https://ru.waysofhistory.com/
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/22544/Notifications.user.js
// @updateURL https://update.greasyfork.org/scripts/22544/Notifications.meta.js
// ==/UserScript==
  ...
  function wsdecorator(func) {
    return function () {
      try {
        ...
        //     break;
          case 3:
            notif('Новый ' + REPORT_TYPE[message.data.type] + ' отчет!');
            break;
          case 8:
