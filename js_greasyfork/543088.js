// ==UserScript==
// @name        GN_FilterBattles_fixed
// @namespace   nexterot
// @description Фильтр текущих боев
// @include     https://*.heroeswm.ru/bselect.php*
// @include     https://*.lordswm.com/bselect.php*
// @include     /^https{0,1}:\/\/(www\.heroeswm\.ru|178\.248\.235\.15)\/bselect\.php.*/
// @version     1.0.6f2
// @license     none
// @homepage    https://greasyfork.org/ru/scripts/543088-gn-filterbattles-fixed
// @downloadURL https://update.greasyfork.org/scripts/543088/GN_FilterBattles_fixed.user.js
// @updateURL https://update.greasyfork.org/scripts/543088/GN_FilterBattles_fixed.meta.js
// ==/UserScript==
...
if (window.location.href.endsWith("bselect.php")) {
