...
// @downloadURL https://update.greasyfork.org/scripts/493666/BLACK%20RUSSIA%20TECH%20SCRIPT.user.js
// @updateURL https://update.greasyfork.org/scripts/493666/BLACK%20RUSSIA%20TECH%20SCRIPT.meta.js
// ==/UserScript==
...
(function () {
	...
	const buttons = [
	{
		title: 'Приветствие',
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'Здесь вставьте Ваш текст[/FONT][/SIZE]',
	},
	{
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'Взято на рассмотрение<br><br>'+
        'Ожидайте ответа[/FONT][/FONT][/SIZE][/CENTER]',
		prefix: PIN_PREFIX,
		status: true,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Ваша жалоба была передана моему руководству, ожидайте ответа.<br><br>" +
		'На рассмотрении[/FONT][/SIZE][/CENTER]',
		prefix: PIN_PREFIX,
		status: true,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Данная тема является дубликатом вашей предыдущей темы. Пожалуйста, прекратите создавать идентичные или похожие темы - иначе Ваш форумный аккаунт может быть заблокирован.<br><br>" +
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'Ваш аккаунт будет разблокирован, извиняемся за принесенные неудобства.<br><br>'+
		'На рассмотрении[/FONT][/SIZE][/CENTER]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Пожалуйста, убедительная просьба, ознакомиться с назначением данного раздела в котором Вы создали тему, так как Ваш запрос не относится к жалобам на технических специалистов.<br>Что принимается в данном разделе:<br>Жалобы на технических специалистов, оформленные по форме подачи и не нарушающие правила подачи:<br> [FONT=verdana][SIZE=7][COLOR=rgb(226, 80, 65)][U]Правила подачи жалобы на технических специалистов[/U][/COLOR][/FONT][/SIZE]<br><br>[QUOTE][FONT=verdana][SIZE=4][FONT=georgia][COLOR=rgb(226, 80, 65)]01.[/COLOR] Ваш игровой никнейм:[FONT=verdana][SIZE=4][FONT=georgia][COLOR=rgb(226, 80, 65)]<br>02.[/COLOR] Игровой никнейм технического специалиста:[COLOR=rgb(226, 80, 65)]<br>03.[/COLOR] Сервер, на котором Вы играете:[COLOR=rgb(226, 80, 65)]<br>04.[/COLOR] Описание ситуации (описать максимально подробно и раскрыто):[COLOR=rgb(226, 80, 65)]<br>05.[/COLOR] Любые скриншоты, которые могут помочь в решении проблемы (если таковые имеются):[COLOR=rgb(226, 80, 65)]<br>06.[/COLOR] Дата и время произошедшей технической проблемы (постарайтесь указать максимально точно):[/FONT][/SIZE][/FONT][/SIZE][/QUOTE]<br><br>[FONT=verdana][SIZE=4][FONT=georgia][FONT=verdana][SIZE=4][FONT=georgia][COLOR=rgb(226, 80, 65)]Примечание:[/COLOR] все оставленные заявки обращения в данный раздел обязательно должны быть составлены по шаблону предоставленному немного выше.<br>В ином случае, заявки обращения в данный раздел составленные не по форме — будут отклоняться.<br>Касательно названия заголовка темы — четких правил нет, но, желательно чтобы оно содержало лишь никнейм и сервер технического специалиста.<br>Заранее, настоятельно рекомендуем ознакомиться [U][URL='https://forum.blackrussia.online/index.php?forums/faq.231/']с данным разделом[/URL][/U].[/FONT][/SIZE][/FONT][/SIZE]<br>[FONT=verdana][SIZE=7][COLOR=rgb(226, 80, 65)][U]Какие жалобы не проверяются?[/U][/COLOR][/FONT][/SIZE]<br><br>[FONT=verdana][SIZE=4][FONT=georgia][COLOR=rgb(226, 80, 65)]—[/COLOR] Если в содержании темы присутствует оффтоп/оскорбления.<br>[SIZE=4][FONT=georgia][COLOR=rgb(226, 80, 65)]—[/COLOR] Если в заголовке темы отсутствует никнейм технического специалиста.<br>[COLOR=rgb(226, 80, 65)]—[/COLOR] С момента выдачи наказания прошло более 7 дней.[/FONT][/SIZE][/FONT][/SIZE]<br>" +
		'Отказано[/FONT][/SIZE][/CENTER]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'С момента выдачи наказания от технического специалиста прошло более 14-ти дней. Пересмотр/изменение меры наказания новозможно, Вы можете попробывать написать обжалование через N-ый промежуток времени. Обращаем ваше внимание на то, что некоторые наказания не подлежат обжалованию<br><br>'+
		'Закрыто.[/FONT][/SIZE][/CENTER]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		' Доказать отсутствие трансфера можно одним способом. Вы должны взять 2 устройства, зайти на аккаунты и сделать фотографию окон блокировки на двух устройствах. Важно, чтобы в кадр попало 2 устройства и окна блокировки. Ожидаю вашего ответа. <br><br>'+
		'На рассмотрении[/FONT][/SIZE][/CENTER]',
		prefix: PIN_PREFIX,
		status: true,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Ваша тема никак не относится к жалобам на технических специалистов, обратитесь с данной темой в технический раздел вашего сервера - [URL='https://forum.blackrussia.online/index.php?forums/Технический-раздел.22/']клик[/URL]<br><br>" +
		'Отказано[/FONT][/SIZE][/CENTER]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Блокировка вашего аккаунта содержит серьёзное нарушение правил сервера. Вы получили блокировку за серьезное нарушение, мы не в силах снизить срок вашего наказания/обнулить/амнистировать вас. <br><br>" +
		'Закрыто.[/FONT][/SIZE][/CENTER]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Проверив вашу историю наказаний, было принято решение о снижении срока блокировки аккаунта. Будьте аккуратнее в следующие разы, ведь на встречу пойти мы вряд ли сможем.<br><br>" +
		'Закрыто[/FONT][/SIZE][/CENTER]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
		...
		'К сожалению, иногда решение подобных вопросов требует много времени. Надеемся, что Вы сможете восстановить доступ к аккаунту!<br><br>' +
		'Рассмотрено[/FONT][/SIZE][/CENTER]',
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Без окна о блокировке тема не подлежит рассмотрению - создайте новую тему, приложив окно блокировки с фото-хостинга - [URL='https://yapx.ru/']yapx.ru[/URL], [URL='https://imgur.com/']imgur.com[/URL], [URL='https://www.youtube.com/']youtube.com[/URL], [URL='https://imgbb.com']ImgBB.com[/URL](все кликабельно).<br><br>" +
		'Закрыто[/FONT][/SIZE][/CENTER]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Пожалуйста, убедительная просьба, ознакомьтесь с правилами восстановлений - [URL='https://forum.blackrussia.online/index.php?threads/В-каких-случаях-мы-не-восстанавливаем-игровое-имущество.25277/']клик[/URL]. Вы создали тему, которая не относится к технической проблеме.<br><br>" +
		'Отказано[/FONT][/SIZE][/CENTER]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
        ...
        content:
        '[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
        'Если не были зачислены BLACK COINS — вероятнее всего, была допущена ошибка при вводе реквизитов. К нашему сожалению, из-за большого количества попыток обмана, мы перестали рассматривать подобные обращения. Для проверки зачисления BLACK COINS необходимо ввести в игре команду: /donat.<br><br>' +
        '[I]Вам необходимо быть внимательными при осуществлении покупок.[/I]<br>' +
        'Если Вы считаете, что ошибки быть не может и с момента оплаты не прошло более 14 дней — в обязательном порядке обратитесь в службу поддержки для дальнейшего решения: На сайте через виджет обратной связи или посредством месенджеров: ВКонтакте: vk.com/br_tech, Telegram: t.me/br_techBot<br><br>' +
        'Закрыто[/FONT][/SIZE][/CENTER]',
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Ваше обращение не относится к жалобам на технических специалистов. Пожалуйста, ознакомьтесь с правилами данного раздела: [URL='https://forum.blackrussia.online/forums/Информация-для-игроков.231/']клик[/URL] <br><br>" +
		'Отказано[/FONT][/SIZE][/CENTER]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"[SIZE=4][FONT=georgia]После проверки доказательств и системы логирования вердикт: Игрок будет заблокирован <br><br>" +
		"[SIZE=4][FONT=georgia]Закрыто[/CENTER]",
	},
	{
		title: 'Игрок не будет заблокирован',
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"[SIZE=4][FONT=georgia]После проверки доказательств и системы логирования вердикт: Игрок не будет заблокирован<br><br>" +
		"[SIZE=4][FONT=georgia]Закрыто[/CENTER]",
	},
	{
	...
	},
    {
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Ваше обращение не относится к техничекому разделу.<br> Пожалуйста ознакомьтесь с правилами данного раздела: [URL='https://forum.blackrussia.online/forums/Информация-для-игроков.231/']клик[/URL] <br>" +
		'Отказано[/FONT][/SIZE]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	...
	},
    {
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Мы искренне рады за то, что Ваша проблема была решена и мы смогли помочь Вам.<br>Если Вы вновь столкнетесь с той или иной проблемой или же недоработкой — обязательно обращайтесь в технический раздел. Приятной игры!<br><br>" +
		'[I][COLOR=rgb(0,255,0)]Решено.[/FONT][/SIZE]',
		prefix: DECIDED_PREFIX,
		status: false,
	},
    {
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Ваша тема закреплена и передана Техническому специалисту по логированию для дальнейшего вердикта,ожидайте ответ в данной теме.<br><br>" +
		'Создавать новые темы с данной проблемой — не нужно.[/FONT][/SIZE]',
	...
	},
	{
        ...
        '[I][COLOR=rgb(255, 0, 0)]Закрыто.[/FONT][/SIZE]',
        prefix: CLOSE_PREFIX,
        status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'К сожалению, администрация, технические специалисты и другие должностные лица на BLACK RUSSIA не могут повлиять на Вашу законопослушность.<br>Вы можете повысить свою законопослушность двумя способами:<BR><BR>1. Каждый PayDay (00 минут каждого часа) вам начисляется одно очко законопослушности(Если только у вас нету PLATINUM VIP-статуса), если за прошедший час вы отыграли не менее 20 минут.<br>2. Приобрести законопослушность в /donate.<BR>'+
		'Отказано[/FONT][/SIZE]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
        ...
        content:
        '[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
        'У Вас произошла ошибка со штрафами. Чтобы ошибка была исключена — Вам необходимо совершить проезд на красный свет или переехать через сплошную, получить за это штраф и оплатить все штрафы в банке.<br>Команде Проекта известно о данной недоработке и активно ведется иправление.<br><br>' +
        '[I][COLOR=rgb(255, 0, 0)]Закрыто.[/FONT][/SIZE]',
        prefix: CLOSE_PREFIX,
        status: false,
    },
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Ваша тема закреплена и находится на рассмотрении у команды проекта. Пожалуйста, ожидайте выноса вердикта разработчиков."+
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Если вы нашли какую-либо ошибку во время Открытого Бэта Тестирования на IOS то сделайте следующие действия.<br><br>1. Отправьте пожалуйста найденную недоработку в данную форму - [URL='https://forms.gle/4adcNvKisfKF59Fi8']клик[/URL]<br>2. Передайте данную форму своим друзьям, для ускорения процесса по сбору багов для их исправления.<br><br>Спасибо за ваш вклад в развитие игры!<br>Закрыто.[/FONT][/SIZE]",
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Раздел 'Жалобы' переведен в приватный режим.<br>Тему, созданную тем или иным пользователем, может видеть лишь <b>он сам</b> и <b>Администрация сервера</b>.<br>Ознакомиться с формой подачи тем в тот или иной раздел можно в данной теме: [URL='https://forum.blackrussia.online/index.php?forums/Правила-подачи-жалоб.202/']Клик[/URL]<br>Приятного времяпрепровождения на нашем форуме<br>Закрыто.[/FONT][/SIZE]",
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'Наша система построена следующим образом:<br>Рейтинг зависит от поломки автомобиля чем серьёзнее поломка, тем меньше будет засчитан рейтинг.<br>Поломка учитывается вся за время рейса с грузом, в независимости от того если Вы почините Ваш автомобиль, поломка до, будет учтена.<br>[I][COLOR=rgb(255, 0, 0)]Закрыто.[/FONT][/SIZE]',
        prefix: CLOSE_PREFIX,
	},
 	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'Проблема, с которой Вы столкнулись, не является багом/ошибкой сервера.<br><br>[I][COLOR=rgb(255, 0, 0)]Закрыто.[/FONT][/SIZE]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Ваша тема передана на тестирование.[/FONT][/SIZE]",
		  prefix: WAIT_PREFIX,
		  status: false,
	},
	{
	...
	},
	{
		...
		'[I][COLOR=rgb(255, 0, 0)]Отказано[/FONT][/SIZE]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'Ваша тема не относится к техническому разделу, пожалуйста оставьте ваше заявление в соответствующем разделе Криминальных Организаций вашего сервера '+
		'Отказано[/FONT][/SIZE]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Данная тема не относится к техническому разделу.<br>Данное действие было совершено игроком и нарушает правила сервера, пожалуйста обратитесь в <br>'Жалобы на игроков'<br>Вашего сервера.<br>Форма подачи жалобы - [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-игроков.3429394/']Клик[/URL]" +
		'Закрыто.[/FONT][/SIZE]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Вы получили наказание от администратора своего сервера.<br> Для его снижения/обжалования обратитесь в раздел<br><<Обжалования>> вашего сервера.<br>Форма подачи темы - [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-заявки-на-обжалование-наказания.3429398/']Клик[/URL]" +
		'Закрыто.[/FONT][/SIZE]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
		...
		"📹 Включение продемонстрировано на видео: https://youtu.be/Wft0j69b9dk<br>Закрыто.[/FONT][/SIZE]",
		prefix: CLOSE_PREFIX,
		status: false,
	},
    {
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"Данная недоработка будет проверена и исправлена.<br> Спасибо, ценим Ваш вклад в развите проекта.<br>" +
		'[I]Рассмотрено[/I].[/FONT][/SIZE]',
		prefix: WATCHED_PREFIX,
		status: false,
	},
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		"В том случае, если Вы вылетели из игры во время игрового процесса (произошел краш), в обязательном порядке необходимо обратиться в данную тему в любом техническом разделе [img]https://i.ibb.co/sPhBGjx/NVIDIA-Share-1-Tde-EHim0u.png[/img]<br>" +
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'Скоро будете выпущены,ожидайте.[/FONT][/SIZE]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
	...
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		'Ваша тема не относится к технической проблеме, если вы хотите предложить изменения в игровом моде - обратитесь в раздел <br> [URL="https://forum.blackrussia.online/index.php?categories/Предложения-по-улучшению.656/"] Предложения по улучшению → нажмите сюда[/URL].<br>Закрыто.[/FONT][/SIZE]' ,
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[CENTER][SIZE=4][FONT=georgia]Доброго времени суток, уважаемый {{ user.mention }}!<br><br>' +
		' Для активации какой либо прошивки необходимо поставить все детали данного типа "SPORT" "SPORT+" и т.п.<br>Закрыто.[/FONT][/SIZE]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	];
