...
// @author          TheLastTaterTot, d2-mac, MajkiiTelini
// @include         https://beta.waze.com/*editor*
// @include         https://www.waze.com/*editor*
// @exclude         https://www.waze.com/*user/editor*
// @grant           none
// @run-at          document-end
// @downloadURL https://update.greasyfork.org/scripts/34554/WME%20Simple%20Permalink%20%28from%20WME%20KeepMyLayers%29.user.js
// @updateURL https://update.greasyfork.org/scripts/34554/WME%20Simple%20Permalink%20%28from%20WME%20KeepMyLayers%29.meta.js
// ==/UserScript==
/* jshint -W097 */
...
var initSimplePermalink = function() {
    if (!document.getElementById('kmlPLPlaceholder')) {
        ...
        var getKMLPermalink = function(currPl) {
            ...
            return location.origin + '/cs/' + kmlShortPL;
        };
