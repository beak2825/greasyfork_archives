...
// @homepageURL  https://greasyfork.org/scripts/451839-allinonedownloader
...
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/451839/AllInOneDownloader.user.js
// @updateURL https://update.greasyfork.org/scripts/451839/AllInOneDownloader.meta.js
// ==/UserScript==
...
(async function(axios, JSZip, saveAs, CryptoJS, ImageDownloader, PublusConfigDecoder, PublusCoordsGenerator, PublusNovelPage, PublusPage, SpeedReaderTools) {
  ...
  const scriptDict = {
    ...
    'animebbg.net': 'https://update.greasyfork.org/scripts/540934/animebbgdownloader.js',
    ...
    onload: (res) => {
      try {
        ...
        if (error.message.includes('unsafe-eval')) {
          ...
          window.prompt('Failed to run external script, please deactivate AllInOneDownloader and try this instead:', `https://greasyfork.org/scripts/${scriptID}`);
        }
      }
    }
  });
