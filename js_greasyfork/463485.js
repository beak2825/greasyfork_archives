// ==UserScript==
// @name         Volgograd Скрипт для гс/згс
// @namespace    https://forum.blackrussia.online
// @version      1.1
// @description  По вопросам обратная связь в Вк: https://vk.com/abdusalamov200
// @author       Ded_Stoyn
...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/463485/Volgograd%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%B3%D1%81%D0%B7%D0%B3%D1%81.user.js
// @updateURL https://update.greasyfork.org/scripts/463485/Volgograd%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%B3%D1%81%D0%B7%D0%B3%D1%81.meta.js
// ==/UserScript==
...
(async function () {
    ...
    const buttons = [
        ...
        {
            title: `Открытие заявок на лд ГОСС/ОПГ`,
            content:
        ...
        `Игровой уровень не менее 8-го. <br>`+
          `   - Возраст не менее 15 лет;
              - Не иметь банов/варнов;
              - Иметь игровой lvl не ниже 8-ого для ОПГ
              - Наличие рабочего микрофона;
              - Наличие Role Play биографии в данной теме ( не менее 15-ти строк );
              - Знание правил лидеров/сервера;
              - Nick_Name должен соответствовать Role Play нормам <br>`+

         `   Форма подачи заявления:[/FONT][/SIZE].<br><br>`+

            `[SIZE=6][FONT=times new roman][COLOR=rgb(153 , 0, 153)] ООС информация:[/COLOR] [/FONT][/SIZE].<br>`+
            `[SIZE=5][FONT=times new roman]1. Ваше Имя:.<br>`+
            `2. Ваш возраст:.<br>`+
            `3. Ваш часовой пояс ( от Мск ):.<br>`+
            `4. Ваш online день:<br>`+
            `5. Имелись ли баны/варны:<br>`+
            `6. Расскажите о себе (минимум 5 строк):[/FONT][/SIZE].<br><br>`+
            `7. Ссылка на вашу vk страницу(кликабельная):.<br><br>`+
            `8. Ваш Discord Nick_Name:.<br>`+
            `9. Скриншот вашей статистики:.<br>`+
            `10. Скриншот ваших привязок:.<br>`+


            `[SIZE=6][FONT=times new roman][COLOR=rgb(153 , 0, 153)] IC информация: [/COLOR][/FONT][/SIZE].<br>`+
            `[SIZE=5][FONT=times new roman]1. Ваш Nick_Name:.<br>`+
            `2. Ссылка на вашу одобренную Role Play биографию:.<br>`+
            `3. Почему именно вы должны занять пост лидера?:.<br>`+
            `4. Имеется ли опыт в данной организации ( указать подробно ):.<br>`+
            `5. Были ли вы лидером любой другой организации?.<br>`+
