// ==UserScript==
// @name Кураторы Администрации, ГА, ЗГА by F. Rolex
// @namespace https://forum.blackrussia.online
// @version 2.33
// @description Live for yourself)
// @author  Frank_Rolex
// @match https://forum.blackrussia.online/threads/*
// @include https://forum.blackrussia.online/threads/
// @grant none
// @license MIT
// @collaborator Frank_Rolex
// @icon https://kalix.club/uploads/posts/2023-12/1702978023_kalix-club-p-fon-blek-rasha-krasivo-foni-30.jpg
// @downloadURL https://update.greasyfork.org/scripts/496551/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%90%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%2C%20%D0%93%D0%90%2C%20%D0%97%D0%93%D0%90%20by%20F%20Rolex.user.js
// @updateURL https://update.greasyfork.org/scripts/496551/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%90%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%2C%20%D0%93%D0%90%2C%20%D0%97%D0%93%D0%90%20by%20F%20Rolex.meta.js
// ==/UserScript==
...
const SA_PREFIX = 11;
const GA_PREFIX = 12; // Prefix that will be set when thread send to project team
const V_PREFIX = 1;
const buttons = [
    {
    ...
    },
    {
      ...
      content:
        '[CENTER][I][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Доброго времени суток, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR][/I]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Недостаточно доказательств для корректного рассмотрения вашего обращения. Прикрепите скрин или фрапс на котором видно Nick_Name администратора и наказание, которое было вам выдано.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[I][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Закрыто.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        '[CENTER][I][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Доброго времени суток, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR][/I]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Не работают доказательства - следовательно, рассмотрению не подлежит.[/I][/SIZE][/FONT][/COLOR]<br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][SIZE=4][FONT=times new roman][COLOR=rgb(209, 213, 216)]Вы ошиблись сервером/разделом. Переношу вашу жалобу в необходимый раздел.[/COLOR][/FONT][/SIZE][/I]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Закрыто.[/I][/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: V_PREFIX,
      status: true,
    },
    ...
    },
    {
      ...
      content:
        ...
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила подачи жалоб на игроков/администрацию/обжалований в соответствующем разделе форума.[/COLOR][/I][/FONT][/SIZE]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Закрыто.[/I][/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[CENTER][FONT=times new roman][SIZE=4][I][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый {{ user.mention }}.[/COLOR][/I][/SIZE][/FONT]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4]Специальному Администратору или его заместителям.[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4][/SIZE][/FONT][/I][/COLOR]<br><br>" +
        '[FONT=times new roman][SIZE=4][I][COLOR=rgb(209, 213, 216)]Ожидайте ответа в данной теме, копии создавать не нужно.[/COLOR][/I][/SIZE][/FONT][/CENTER]',
      prefix: SA_PREFIX,
      status: true,
    },
...
title: 'Док-ва отред.',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I]На ваших доказательствах отсутствует /time, следовательно рассмотрению не подлежит[/I][/SIZE][/FONT][/COLOR]<br><br>" +
    ...
    {
      title: 'Неадекват.повед.',
      content:
        '[CENTER][FONT=times new roman][SIZE=4][I][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый {{ user.mention }}.[/COLOR]<br><br>' +
        '[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Жалобы, содержащие неадекватность и несут оскорбительный характер в сторону администрации рассмотрению не подлежат. Напишите жалобу адекватно.<br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Отказано.[/I][/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/COLOR][/FONT]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Если вы не согласны с наказанием, то обратитесь в раздел жалоб на администрацию.<br><br>" +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Отказано, закрыто.[/I][/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        "[SIZE=4][FONT=times new roman]За это время вы должны связаться с жертвой обмана и вернуть ему украденное имущество. После чего видео фиксацию возврата имущества предоставить в этой жалобе. Если вы выполните все условия, ваш аккаунт будет полностью разблокирован. Если же украденное имущество будет передано друзьям/твинк аккаунт, то аккаунты будут заблокированы без возможности обжаловать наказание.<br><br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/COLOR][/FONT]<br><br>' +
        '[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Ваш аккаунт будет разблокирован, впредь больше не нарушайте.<br>' +
        'Приятной игры на BLACK RUSSIA RolePlay.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
    ...
    {
      title: 'Нет VK NonRP обман',
      content:
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/COLOR][/FONT]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Нет ВК для рассмотрения NonRP обмана.<br><br>" +
