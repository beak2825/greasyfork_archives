...
// @downloadURL https://update.greasyfork.org/scripts/23531/Reddit%20Overwrite.user.js
// @updateURL https://update.greasyfork.org/scripts/23531/Reddit%20Overwrite.meta.js
// ==/UserScript==
...
function UpdateDeleteAllSpan()
{
	if (unsafeWindow.num_user_comments){
		...
		dlink.setAttribute('href', 'javascript:void(0)');
		dlink.appendChild(document.createTextNode('ALEX OVERWRITE ALL visible comment(s) on this page - MAKE SURE YOU ARE ON THE COMMENTS TAB.  It is also HIGHLY recommended to use Reddit Enhancement Suite with the Never Ending Reddit feature to extend the comments as far down as possible.'));
