...
// @downloadURL https://update.greasyfork.org/scripts/503887/Color%20Favorites%20for%20Multiple%20Sites.user.js
// @updateURL https://update.greasyfork.org/scripts/503887/Color%20Favorites%20for%20Multiple%20Sites.meta.js
// ==/UserScript==

(function() {
    'use strict';

    // Создание кнопки "Сохранить цвет"
    function createAddToFavoritesButton() {
        ...
        addButton.style.marginLeft = '0'; // Установить отступ слева на 0
        addButton.className = 'fr-command fr-btn custom-save-color-btn';

        // Добавление стилей для кнопки
        addButton.style.backgroundColor = '#007bff'; // Задний фон кнопки
        addButton.style.color = '#fff'; // Цвет текста
        addButton.style.border = 'none'; // Убираем рамку
        addButton.style.padding = '10px 20px'; // Отступы внутри кнопки
        addButton.style.borderRadius = '5px'; // Скругленные углы
        addButton.style.cursor = 'pointer'; // Указатель при наведении
    ...
    // Создание слотов для избранных цветов
    function createFavoritesSlots() {
        ...
        slotsContainer.style.gridTemplateColumns = 'repeat(5, 1fr)'; // Сетка 5 колонок
    ...
    // Обновление слотов для избранных цветов
    ...
    // Добавление нового цвета в избранное
    ...
    // Отображение слотов и кнопки при открытии редактора
