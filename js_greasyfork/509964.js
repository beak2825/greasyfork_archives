...
// @downloadURL https://update.greasyfork.org/scripts/509964/wiki-%E5%B7%A5%E6%97%B6%E7%BB%9F%E8%AE%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/509964/wiki-%E5%B7%A5%E6%97%B6%E7%BB%9F%E8%AE%A1.meta.js
// ==/UserScript==

(o=>{const t=document.createElement("style");t.dataset.source="vite-plugin-monkey",t.innerText=o,document.head.appendChild(t)})('@font-face{font-family:iconfont;src:url(//at.alicdn.com/t/c/font_4622934_otm49hwnffj.woff2?t=1727177061564) format("woff2"),url(//at.alicdn.com/t/c/font_4622934_otm49hwnffj.woff?t=1727177061564) format("woff"),url(//at.alicdn.com/t/c/font_4622934_otm49hwnffj.ttf?t=1727177061564) format("truetype")}.iconfont{font-family:iconfont!important;font-size:16px;font-style:normal;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.icon-data:before{content:"\\e63d"}.icon-yanfagongshi:before{content:"\\e603"}.icon-fuzhi:before{content:"\\ec7a"}.group-btn-wrapper[data-v-611b1a7f]{position:fixed;right:16px;top:50%;transform:translateY(-50%);display:flex;flex-direction:column;justify-content:center;gap:16px}.group-btn-wrapper i[data-v-611b1a7f]{font-size:24px;color:#ccc;cursor:pointer}.group-btn-wrapper i[data-v-611b1a7f]:hover{color:#666}.show-total-box[data-v-611b1a7f]{position:fixed;background:#999;color:#fff;padding:8px}');
...
(function(vue) {
  ...
  */
  ...
  const App_vue_vue_type_style_index_0_scoped_611b1a7f_lang = "";
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-611b1a7f"), n = n(), vue.popScopeId(), n);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-611b1a7f"]]);
