...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/517395/PTP%20-%20Count%20to%2060%20Tracker.user.js
// @updateURL https://update.greasyfork.org/scripts/517395/PTP%20-%20Count%20to%2060%20Tracker.meta.js
// ==/UserScript==
...
var { skipToEnd, autoFill, fireGameMode, focus, focusPosition } = setLocalSettings();
...
if (!elementToClick && skipToEnd) DisableSkiptoEnd();
...
function setLocalSettings() {
    ...
    window.localStorage.CT60_Settings = JSON.stringify({ skipToEnd, autoFill, fireGameMode, focus, focusPosition });

    return { skipToEnd, autoFill, fireGameMode, focus, focusPosition };
};
...
function DisableSkiptoEnd() {
    let skiptoendcheck = document.getElementById('skipToEndToggle');
    if (skiptoendcheck.checked == true) {
        skiptoendcheck.click()
    };
};