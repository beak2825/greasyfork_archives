...
// @downloadURL https://update.greasyfork.org/scripts/441570/West%20Wiki%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/441570/West%20Wiki%20Helper.meta.js
// ==/UserScript==
...
(function () {
  ...
  function sendWWHData(locale, items, sets) {
    const base_url = "https://the-west.tools";
    const data = {
      locale: locale,
