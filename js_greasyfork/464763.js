...
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/464763/ClanOnline%20NightNI.user.js
// @updateURL https://update.greasyfork.org/scripts/464763/ClanOnline%20NightNI.meta.js
// ==/UserScript==
...
;(function(){
  ...
  */
  ...
  Popup.prototype.renderMembers = function(members){
    ...
    */
    ...
    var titleTipText = count === 1
      ? 'JesteĹ tylko ty'
      : `${count} klanowiczĂłw (ĹÄcznie z tobÄ)`
  ...
  Popup.prototype.setBattleInfo = function(){
    ...
    if(isNewInterface) this.title.dataset.tip = 'Dodatek aktywuje siÄ po zakoĹczeniu walki'
    else this.title.setAttribute('tip', 'Dodatek aktywuje siÄ po zakoĹczeniu walki')
  ...
  Popup.prototype.loadStateFromDisk = function(){
    try {
      ...
      console.log('Klanowicze online: bĹÄdna konfiguracja, reset. PowĂłd:', error)
