...
$(document).ready(function(){
                ...
                var css = '.menuVisiteur{position:fixed;top:0;left:50px;-webkit-box-shadow:0px 2px 5px rgba(206, 12, 38, 0.22);-moz-box-shadow:0px 2px 5px rgba(206, 12, 38, 0.22);-khtml-box-shadow:0px 2px 5px rgba(206, 12, 38, 0.22);box-shadow:0px 2px 5px rgba(206, 12, 38, 0.22);position:fixed;z-index:2147;-webkit-border-radius:0px 0px 3px 3px;-moz-border-radius:0px 0px 3px 3px;-khtml-border-radius:0px 0px 3px 3px;border-radius:0px 0px 3px 3px;border-top:none!important;border:1px solid rgb(106,155,179);border:1px solid #CE0C26;_border:1px solid rgb(106,155,179);background:#CE0C26 url("styles/realitygaming/images/main/pattern3-ts.png") repeat-x bottom!important;height:30px;line-height:10px;margin-top:-5px}';
...
$(document).ready(function(){
                ...
                var css = '.PageNav a.currentPage{color:#fff;background:url(rgba.php?r=20&g=122&b=191&a=127);background:#CE0C26;_filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#7F147ABF,endColorstr=#7F147ABF);border-color: #CE0C26;position:relative}';
...
$(document).ready(function(){
    ...
    var css = '.forumNodeInfo .nodeIcon,.categoryForumNodeInfo .nodeIcon{background-image:url("http://i.imgur.com/zRRRwjs.png");background-position:0 -242px;width:32px;height:32px}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie391{width: 30px;height: 35px;background: url("http://www.smileys-gratuits.com/smiley-noel/noel-2.gif") no-repeat 0px -0px;}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie354{width: 30px;height: 40px;background: url("http://www.smiley-lol.com/smiley/saisons/hiver/bonhommebleu.gif") no-repeat 0px 0px;}';
