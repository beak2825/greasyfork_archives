...
// @author       Something begins, nexterot
// @license     none
...
// @grant       none
// @homepage    https://greasyfork.org/ru/scripts/532800-clan-depo-quick-sets
// @downloadURL https://update.greasyfork.org/scripts/532800/Clan%20depo%20quick%20sets.user.js
// @updateURL https://update.greasyfork.org/scripts/532800/Clan%20depo%20quick%20sets.meta.js
// ==/UserScript==
const setAmount = 5;
const redirectTo = null; // "/inventory.php"
...
async function fetchDataAndProcess(requiredArts, battlesAmount) {
    ...
    consequetiveFetches(neededLinks, () => {
        if (redirectTo)
        {
...
if (document.body.innerHTML.includes('&amp;sklad_rc_on=0'))
{
    console.log('clan depo quick sets: edit mode is enabled');
    return;
}
