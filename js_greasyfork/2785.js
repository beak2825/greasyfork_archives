...
// @downloadURL https://update.greasyfork.org/scripts/2785/Virtonomica%3ANotes.user.js
// @updateURL https://update.greasyfork.org/scripts/2785/Virtonomica%3ANotes.meta.js
// ==/UserScript==
var run = function() {
...
// http://www.iconsearch.ru/uploads/icons/crystalclear/24x24/kedit.png
       ...
       var wc = $("<li><div id=main_notes style='float:left;cursor:pointer; color: white;'> <img height='24' width='24' alt='Список напоминаний' src=http://cdn1.iconfinder.com/data/icons/humano2/32x32/apps/gnome-sticky-notes-applet.png> <span id=all_notes> ("+ len+")</span></div>").click( function() {
           $("#notes").toggle();
           if( $('#notes').is(':visible') ) {
                   // код для visible
               // Оповещения
...
// http://www.iconsearch.ru/uploads/icons/ultimategnome/48x48/stock_export.png
       var wc_export = $("<span id=main_notes_export style='cursor:pointer; color: white;'><img height='24' width='24' src=http://cdn1.iconfinder.com/data/icons/basicset/save_32.png title='Окно экспорта/импорта' alt='Окно экспорта/импорта'></span>").click( function() {
...
// http://www.iconsearch.ru/uploads/icons/ull_icons/24x24/message_add.png
   var wc = $("<li style='cursor:pointer; color: white;'><img height='24' width='24' alt='Добавить напоминание' src=http://cdn1.iconfinder.com/data/icons/oxygen/32x32/actions/document-new.png title='Добавить напоминание'> </li>").click( function() {
       $("#notes").toggle();
       // Обновить зампетку
       notes = JSON.parse( window.localStorage.getItem('notes') );
       if ( notes == null ) notes = new Object();
