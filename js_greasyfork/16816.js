...
// @namespace    420x
// @version      2.0.1
// @description  420x by Zephyr&Krayton
// @author       Zephyr&Krayton
// @match        http*://agar.io
// @include      http://*agar.io/agarplus.io
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/16816/420x.user.js
// @updateURL https://update.greasyfork.org/scripts/16816/420x.meta.js
// ==/UserScript==
// Script by krayton&Zephyr
// For ZBC
// variables
...
var ci = setInterval(function()
{
    ...
    else
    {
        ...
        $(Rem3).replaceWith('');
        // Remove Thing
        $(Thing).replaceWith('<div align="middle"><script src="https://apis.google.com/js/platform.js" gapi_processed="true"></script><div id="___ytsubscribe_0" style="text-indent: 0px; margin: 0px; padding: 0px; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; width: 176px; height: 48px; background: transparent;"><iframe frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" style="position: static; top: 0px; width: 176px; margin: 0px; border-style: none; left: 0px; visibility: visible; height: 48px;" tabindex="0" vspace="0" width="100%" id="I0_1453914609634" name="I0_1453914609634" src="https://www.youtube.com/subscribe_embed?usegapi=1&amp;channelid=UCs9ZSQRVsv2ZtmZTefRotWQ&amp;layout=full&amp;theme=dark&amp;count=default&amp;height=48&amp;width=163&amp;origin=http%3A%2F%2Fagar.io&amp;gsrc=3p&amp;ic=1&amp;jsh=m%3B%2F_%2Fscs%2Fapps-static%2F_%2Fjs%2Fk%3Doz.gapi.en.JpdoJPJ5hQs.O%2Fm%3D__features__%2Fam%3DAQ%2Frt%3Dj%2Fd%3D1%2Ft%3Dzcms%2Frs%3DAGLTcCMrDhGj8PwnRZ6lDn8FgkiuwDfUVw#_methods=onPlusOne%2C_ready%2C_close%2C_open%2C_resizeMe%2C_renderstart%2Concircled%2Cdrefresh%2Cerefresh%2Conload&amp;id=I0_1453914609634&amp;parent=http%3A%2F%2Fagar.io&amp;pfname=&amp;rpctoken=32074165" data-gapiattached="true"></iframe></div></div></div><font face="header"><font color="#d16c5b"><h2 align="middle"><font size="6">420χ</font>');
        // Change Title
        $(Title).replaceWith('');
        // Remove This
