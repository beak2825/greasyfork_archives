...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/532720/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/532720/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
const buttons = [
	{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J4v7nzq5/crPNFEh.png[/img][/url]<br>' +
...
},
{
    ...
    "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]2.01.[/color] Запрещено поведение, нарушающее нормы процессов Role Play режима игры [Color=#ff0000]| Jail 30 минут[/color].[/COLOR]<br><br>" +
                ...
                "[B][CENTER][COLOR=#7b68ee]С уважением [/COLOR][COLOR=#7b68ee]Главный Куратор Форума.[/COLOR]<br>"+
...
},
{
 ...
 $(document).ready(() => {
    ...
    addButton('На рассмотрение💫', 'pin', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 140, 0, 10);');
    ...
    addButton('Одобрено✅', 'accepted', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(110, 192, 113, 10);');
    addButton('Отказано⛔', 'unaccept', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(220, 89, 89, 10);');
    addButton('Теху', 'Texy', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(0, 0, 139, 10);');
