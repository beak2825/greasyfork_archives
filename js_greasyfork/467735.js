// ==UserScript==
// @name    Forum Curators | Cherry
// @name:ru Кураторы Форума | Cherry
// @description  Suggestions for improving the script write here ---> https://vk.com/pavlyashikigor
// @description:ru Предложения по улучшению скрипта писать сюда ---> https://vk.com/pavlyashikigor
// @version 1.0.2
...
// @grant        none
// @license    MIT
// @supportURL https://vk.com/pavlyashikigor
// @icon https://imgur.com/a/HxUIQvg2
// @downloadURL https://update.greasyfork.org/scripts/467735/Forum%20Curators%20%7C%20Cherry.user.js
// @updateURL https://update.greasyfork.org/scripts/467735/Forum%20Curators%20%7C%20Cherry.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content: '[Color=Orange][CENTER]Взято на рассмотрение![/CENTER][/color]' + '[CENTER]  [/CENTER]',
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER] Приятной игры на сервере [COLOR=rgb(222, 12, 98)]CHERRY.[/COLOR][/FONT]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба была передана на рассмотрение [Color=Red]Главному Администратору[/color] - @Liana_Mironova[/CENTER]<br>" +
        '[Color=Flame][CENTER]Пожалуйста, ожидайте ответа и не создавайте подобных тем.[/I][/CENTER][/color][/FONT]',
      prefix: GA_PREFIX,
      status: true,
    },
    {
      ...
      content:
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба была передана на рассмотрение Специальному администратору и его заместителю.[/CENTER]<br>" +
        '[Color=Flame][CENTER]Пожалуйста, ожидайте ответа и не создавайте подобных тем.[/I][/CENTER][/color][/FONT]',
      prefix: SPECY_PREFIX,
      status: true,
    },
