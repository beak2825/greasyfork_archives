...
// @name			Test tab BR2
// @namespace		TTBR2
// @description		My little test2
// @version 3.05
// @include https://*.facebook.com/kingdomsofcamelot/*
// @downloadURL https://update.greasyfork.org/scripts/450498/Test%20tab%20BR2.user.js
// @updateURL https://update.greasyfork.org/scripts/450498/Test%20tab%20BR2.meta.js
// ==/UserScript==
...
Tabs.Test = {
  ...
  init : function (div){
    ...
    document.getElementById('pbalertWhisper').addEventListener ('click', function (){SEND_ALERT_AS_WHISPER=this.checked}, true);
  },
  ...
  createFakeAttack : function (cityNum, isScout, isWild, isFalse, secs, numMilitia){
    ...
    march.players.u1234567.n = 'Big Brother Is Watching';
