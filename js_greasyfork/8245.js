// ==UserScript==
// @name          Ru-Board_Extrim_Max4_ABP_Fix-CSS
// @namespace     https://greasyfork.org
// @description	  Дополнение, исправляющее работу Adblock Plus для форума Ru-Board. Экстремальная часть функционала  Ad-Охотника в Maxthon4 и Maxthon5.
// @author        ALeXkRU
// @homepage      https://greasyfork.org/ru/scripts/8245-ru-board-extrim-max4-abp-fix-css
...
// @license       CC BY-SA
// @version       0.20181220200003
// @grant         GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/8245/Ru-Board_Extrim_Max4_ABP_Fix-CSS.user.js
// @updateURL https://update.greasyfork.org/scripts/8245/Ru-Board_Extrim_Max4_ABP_Fix-CSS.meta.js
// ==/UserScript==
...
// !		" body>script+table.tb>tbody>tr>td>table>tbody>tr:first-of-type{position: relative !important; display: block !important; height: 2em !important;width: 16em !important; overflow: auto !important; border-color: SlateGrey !important; border-style: solid !important;border-width: 4px !important;}",
...
// !		" input[name=\"signature\"]{color:#003399!important;\"checked\" !important;}",
	...
	// -!!   размер поля ввода
		" textarea{height: 364px!important;width: 948px!important;}",
