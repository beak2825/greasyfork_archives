...
// @run-at       document-end
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/24523/Torn%20Trader.user.js
// @updateURL https://update.greasyfork.org/scripts/24523/Torn%20Trader.meta.js
// ==/UserScript==
...
function scriptSettings(){
    ...
    //addRadio(DIV_innerBlock, 'name', 'text'); pricesTraveling
}
