...
// @author       Microblink
// @match        https://mls.microblink.com/eval*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/381009/SortCategory.user.js
// @updateURL https://update.greasyfork.org/scripts/381009/SortCategory.meta.js
// ==/UserScript==
...
(function() {
    ...
    function sort_them_all(){
        ...
        var form_control = form_control_elements.item(4);

        if(!form_control){
            form_control = form_control_elements.item(3);
        }
        ...
        sort_form_control(form_control);
