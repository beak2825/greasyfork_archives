// ==UserScript==
// @name         Скрипт для КФ/ЗГСФ/ГСФ || Astrakhan || V2.0
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/498107/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%D0%97%D0%93%D0%A1%D0%A4%D0%93%D0%A1%D0%A4%20%7C%7C%20Astrakhan%20%7C%7C%20V20.user.js
// @updateURL https://update.greasyfork.org/scripts/498107/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%D0%97%D0%93%D0%A1%D0%A4%D0%93%D0%A1%D0%A4%20%7C%7C%20Astrakhan%20%7C%7C%20V20.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
{    
	  ...
	  title: '| Одобрено |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/wBJsRqr5/2291427a-5801-428e-95cb-aa0c76f40c63.gif[/img][/url]<br>' +
...
title: '| Нету в системе логирования |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J4nxDX5b/Devilman-Crybaby-Akira.gif[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
...
},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/3xfP07Gw/d9baed5e165a77c3390dd7a63176b4ee.gif[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
...
},
{
	  title: '| Тех. спецу |',
	  content:
		'[CENTER]	[url=https://postimages.org/][img]https://i.postimg.cc/q79SQLjV/Cillian-Murphy-in-PB-series-5.gif[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
