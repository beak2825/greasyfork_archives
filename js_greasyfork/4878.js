...
// @grant          GM_openInTab
// @downloadURL https://update.greasyfork.org/scripts/4878/FetLife%20ASL%20Search%20%28Females%20included%29.user.js
// @updateURL https://update.greasyfork.org/scripts/4878/FetLife%20ASL%20Search%20%28Females%20included%29.meta.js
// ==/UserScript==
...
FL_ASL.main = function () {
    ...
    html_string += '<label><input type="checkbox" name="user[sex]" value="FEM" checked="checked" />Femme</label>';
    ...
    html_string += '<label><input type="checkbox" name="user[role]" value="babygirl" checked="checked" />babygirl</label>';
    ...
    html_string += ' my <label><input type="radio" name="fl_asl_loc" value="city_id" checked="checked" />city</label>';
    html_string += '<label><input type="radio" name="fl_asl_loc" value="area_id" />state/province</label>';
