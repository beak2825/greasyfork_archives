...
// @version 2.3.6
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/11573/The-West%20Deluxe%20Jobs.user.js
// @updateURL https://update.greasyfork.org/scripts/11573/The-West%20Deluxe%20Jobs.meta.js
// ==/UserScript==
...
(function (fn) {
  ...
  (DJ.Updater = function () {
    if (!window.scriptRequest) {
      scriptRequest = true;
      $.getScript(DJ.updateUrl);
    }
    var intVal = setInterval(function () {
        if (window.scriptUp) {
          scriptUp.c('DJ', DJ.version, DJ.name, DJ.updateAd, DJ.website, DJ.lang);
