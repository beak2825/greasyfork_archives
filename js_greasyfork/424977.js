...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/424977/%E5%85%B6%E4%B9%90%E8%87%AA%E5%8A%A8%E5%8A%A0%E4%BD%93%E5%8A%9B.user.js
// @updateURL https://update.greasyfork.org/scripts/424977/%E5%85%B6%E4%B9%90%E8%87%AA%E5%8A%A8%E5%8A%A0%E4%BD%93%E5%8A%9B.meta.js
// ==/UserScript==
...
`
    ...
    function autoRate(){
        ...
        //
        if(curDate.getHours()==votedHistory.getHours()&&curDate.getMinutes()==votedHistory.getMinutes()){
            if(!timeToStart){
                timeToStart=curDate.getSeconds()>=votedHistory.getSeconds();
                votedHistory.setVotedDate();
            }
        }
        if(timeToStart) {
            clearInterval(autoTimeId);
            ...
            console.log(curDate.getHours()+":"+curDate.getMinutes()+":"+curDate.getSeconds());
            generateRate();
            setTimeout(function(){startVote();},parseInt(START_DELAY*Math.random())*500+5000);
        }
