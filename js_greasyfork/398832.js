...
// @author       Drigtime pour la création de Owl & Haaxed pour l'adaptation à Flatybot. Mis à jour par iPanda. Corrigé par Archymede.
...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/398832/Owl%20FlatyBot.user.js
// @updateURL https://update.greasyfork.org/scripts/398832/Owl%20FlatyBot.meta.js
// ==/UserScript==
...
<div class="modal fade" id="pathSetting" tabindex="-1" role="dialog" style="top: 100px;"></div>`;
    ...
    $('#path-creator-bar').on('click', '.fa-save', function () {
        var firstIf = false;
        var txt = "-- Generated On Dofus-Map with Owl Scripts --\r\n" +
            ...
            "MANDATORY_MONSTERS = {" + $('#mendatory-ennemy-field').val() + "}\r\n\r\n" +
			"MAX_PODS = 90\r\n\r\n" +
            "";
