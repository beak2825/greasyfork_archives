// ==UserScript==
// @name         Flight Rising Archeology
// @version      1.0
// @description  Automatically digs for you! Various completion/repeat options available.
...
// @license      GNU GPLv3
// @downloadURL https://update.greasyfork.org/scripts/469103/Flight%20Rising%20Archeology.user.js
// @updateURL https://update.greasyfork.org/scripts/469103/Flight%20Rising%20Archeology.meta.js
// ==/UserScript==
...
async function main() {
    ...
    if (toggleState) {
        ...
        if ($('#archaeology-dig-timer-text')[0].innerText == "Ready!") {
            // if rugged
            if (workTypeStatus == 0) {
                console.debug("Starting Rugged work...");
                // start rugged select
