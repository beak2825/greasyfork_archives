// ==UserScript==
// @name         FreeSteam.io (Pescador de Cripto)
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/411458/FreeSteamio%20%28Pescador%20de%20Cripto%29.user.js
// @updateURL https://update.greasyfork.org/scripts/411458/FreeSteamio%20%28Pescador%20de%20Cripto%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function freesteam_io(){
        ...
        if (window.location.href.indexOf("freesteam.io/free") > -1) {
            setInterval(function(){
                window.history.go(0);
            },300000);
        }
    ...
    function open(){
        if (window.location.href.indexOf("pescadordecripto.com/dashboard") > -1) {
            window.open("https://freesteam.io/free", "_blank","width=10,height=10,left=-3000,top=-3000");
        }
    ...
    if (window.location.href.indexOf("pescadordecripto.com/install") > -1) {
        document.getElementById('freesteam-io').classList.add("faucet-active");
    }
})();