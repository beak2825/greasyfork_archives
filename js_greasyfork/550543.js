// ==UserScript==
// @name        Полный скрипт для Кураторов Форума by Tony Garfild || LIME
// @namespace    http://tampermonkey.net/
// @version      2.1
// @description  Скрипт для Кураторов Форума 07 LIME
// @author       Tony Garfild
...
// @license    MIT
// @downloadURL
// @downloadURL https://update.greasyfork.org/scripts/550543/%D0%9F%D0%BE%D0%BB%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20Tony%20Garfild%20%7C%7C%20LIME.user.js
// @updateURL https://update.greasyfork.org/scripts/550543/%D0%9F%D0%BE%D0%BB%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20Tony%20Garfild%20%7C%7C%20LIME.meta.js
// ==/UserScript==
...
const buttons = [
{
	  ...
	  content:
        ...
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
},
{
	  title: '| На рассмотрении |',
	  content:
	    	"[B][CENTER][COLOR=Plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sxZgvyph/Pics-Art-07-12-03-23-18.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=Plum][FONT=courier new] Ваша жалоба [COLOR=Plum]на рассмотрении[/COLOR],<br><br>"+
                "[*][SIZE=4][COLOR=plum][FONT=courier new]Ожидайте ответа в данной теме. Не создавайте повторные темы в противном случае Вы можете получить блокировку форумного аккаунта.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/5yV83CvG/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=Plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=Plum]RUSSIA[/COLOR] [COLOR=Plum]LIME[/COLOR].<br><br>",
...
},
{
	  ...
	  content:
	    	"[B][CENTER][COLOR=red][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/ZqztV9ZX/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=yellow]передана на рассмотрение Главному Администратору[/COLOR],<br><br>"+
...
},
{
	  ...
	  content:
	    	"[B][CENTER][COLOR=red][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/ZqztV9ZX/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new][Color=#ff0000]2.01.[/color] Запрещено поведение, нарушающее нормы процессов Role Play режима игры [Color=#ff0000]| Jail 30 минут[/color].[/COLOR]<br><br>" +
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/ZqztV9ZX/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new][Color=#ff0000]2.02.[/color] Запрещено целенаправленно уходить от Role Play процесса всеразличными способами [Color=#ff0000]| Jail 30 минут / Warn[/color].[/COLOR]<br><br>" +
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/ZqztV9ZX/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new][Color=#ff0000]2.03.[/color] Запрещен NonRP Drive — вождение любого транспортного средства в невозможных для него условиях, а также вождение в неправдоподобной манере [Color=#ff0000]| Jail 30 минут[/color].[/COLOR]<br><br>" +
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/ZqztV9ZX/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new][Color=#ff0000]2.04.[/color] Запрещены любые действия способные привести к помехам в игровом процессе, а также выполнению работ, если они этого не предусматривают и если эти действия выходят за рамки игрового процесса данной работы. [Color=#ff0000]| Ban 10 дней / Обнуление аккаунта (при повторном нарушении)[/color].[/COLOR]<br><br>" +
...
},
{
	  ...
	  content:
	    	"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sxZgvyph/Pics-Art-07-12-03-23-18.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=Book Antiqua] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=plum][FONT=Book Antiqua][Color=#ff0000]2.05.[/color] Запрещены любые OOC обманы и их попытки, а также любые IC обманы с нарушением Role Play правил и логики [Color=#ff0000]| PermBan[/color].[/COLOR]<br><br>" +
                "[*][SIZE=4][COLOR=plum][FONT=Book Antiqua]Примечание: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new]после IC договоренности получить денежные средства и сразу же выйти из игры с целью обмана игрока, или же, договорившись через OOC чат (/n), точно также получить денежные средства и сразу же выйти из игры и тому подобные ситуации.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                ...
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sxZgvyph/Pics-Art-07-12-03-23-18.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=plum][FONT=Book Antiqua] Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
},
{
...
},
{
	  ...
	  content:
	    	"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new][Color=#ff0000]2.09.[/color]  Запрещено сливать склад фракции / семьи путем взятия большого количестве ресурсов, или же брать больше, чем разрешили на самом деле [Color=#ff0000]| Ban 15 - 30 дней / PermBan[/color].[/COLOR]<br><br>" +
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]2.11.[/color] Запрещено использование рабочего или фракционного транспорта в личных целях [Color=#ff0000]| Jail 30 минут[/color].[/COLOR]<br><br>" +
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
	    	"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sxZgvyph/Pics-Art-07-12-03-23-18.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=Plum][FONT=Book Antiqua] Ваша жалоба [COLOR=Plum]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=Plum][FONT=Book Antiqua][Color=#ff0000]2.19.[/color] Запрещен DM (DeathMatch) — убийство или нанесение урона без веской IC причины [Color=#ff0000]| Jail 60 минут[/color].[/COLOR]<br><br>" +
                ...
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sxZgvyph/Pics-Art-07-12-03-23-18.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=plum][FONT=Book Antiqua] Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plumD]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
},
{
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                ...
                "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Примечание: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new]любые попытки покупки/продажи, попытки поинтересоваться о ней у другого игрока и прочее - наказуемы.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Примечание: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new]также запрещен обмен доната на игровые ценности и наоборот;[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Пример: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new]пополнение донат счет любого игрока взамен на игровые ценности;[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Исключение: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new]официальная покупка через сайт.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new][Color=#ff0000]2.54.[/color] Запрещено неуважительное обращение, оскорбление, неадекватное поведение, угрозы в любом их проявлении по отношению к администрации [Color=#ff0000]| Mute 180 минут[/color].[/COLOR]<br><br>" +
                 "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sxZgvyph/Pics-Art-07-12-03-23-18.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=Book Antiqua] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=plum][FONT=Book Antiqua][Color=#ff0000]3.04.[/color] Запрещено оскорбление или косвенное упоминание родных вне зависимости от чата (IC или OOC) [Color=#ff0000]| Mute 120 минут / Ban 7 - 15 дней[/color].[/COLOR]<br><br>" +
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]1.11.[/color] Всем силовым структурам запрещен одиночный патруль или конвоирование, минимум 2 сотрудника [Color=#ff0000]| Jail 30 минут[/color].[/COLOR]<br><br>" +
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]2.02.[/color] Наносить урон игрокам, которые находятся вне территории воинской части, запрещено [Color=#ff0000]| Jail 60 минут / Warn[/color].[/COLOR]<br><br>" +
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]6.01.[/color] Запрещено наносить урон игрокам без Role Play причины на территории УМВД. [Color=#ff0000]| Jail 60 минут / Warn[/color].[/COLOR]<br><br>" +
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                ...
                "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Пример: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new]задержание, выдача розыска, обыск без RP отыгровки.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]6.01.[/color] Запрещено наносить урон игрокам без Role Play причины на территории ГИБДД. [Color=#ff0000]| Jail 60 минут / Warn[/color].[/COLOR]<br><br>" +
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]6.02.[/color] Запрещено выдавать розыск без Role Play причины. [Color=#ff0000]| Warn[/color].[/COLOR]<br><br>" +
                "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Пример: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new]задержание, выдача розыска, обыск, изъятие прав без RP отыгровки.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]6.01.[/color] Запрещено наносить урон игрокам без Role Play причины на территории ФСБ. [Color=#ff0000]| Jail 60 минут / Warn[/color].[/COLOR]<br><br>" +
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		 ...
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]6.03.[/color] Запрещено nRP поведение. [Color=#ff0000]| Warn[/color].[/COLOR]<br><br>" +
                "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Пример: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new]задержание, выдача розыска без RP отыгровки.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
                "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]LIME[/COLOR].<br><br>",
		 prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
	   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sxZgvyph/Pics-Art-07-12-03-23-18.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=plum][FONT=Book Antiqua] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как нарушений со стороны данного игрока не было найдено. <br><br>"+
                "[B][CENTER][COLOR=plum][FONT=Book Antiqua]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
                '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sxZgvyph/Pics-Art-07-12-03-23-18.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][FONT=Book Antiqua] Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
	    	"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>'+
                "[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=red]отказана[/COLOR], так как все долговые перечисление должны перечисляться через банковскую систему.<br><br>",
		 prefix: UNACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как администрация сервера не несёт ответственности за утраченные Вами средства при обмане и т.д. <br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
                '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как доказательств на нарушение от данного игрока  недостаточно. <br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
                '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как доказательств на нарушение от данного игрока  отсутствуют. <br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
                 '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как ваша жалоба составлена не по форме. <br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
                '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/W4rHzJJw/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  title: '| Нет /time |',
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/66HtYZsB/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как на ваших доказательствах отсутствует /time.  <br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
                '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/66HtYZsB/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/66HtYZsB/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как отсутствует time коды. Если видео длится больше 3-ех минут - Вы должны указать time коды нарушений. <br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
               '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/66HtYZsB/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/NFkcwMCF/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=plum][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как ваши доказательства не открываются. <br><br>"+
                "[B][CENTER][COLOR=plum][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
               '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/NFkcwMCF/Pics-Art-07-12-03-23-18-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=plum]Приятной игры на [COLOR=plum]BLACK[/COLOR] [COLOR=plum]RUSSIA[/COLOR] [COLOR=plum]LIME[/COLOR].<br><br>",
      prefix: UNACCСEPT_PREFIX,
...
"[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило - Биография скопирована <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
                '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=lime]нарушением считаются такие действия, как езда на скутере по горам, намеренное создание аварийных ситуаций при передвижении. Передвижение по полям на любом транспорте, за исключением кроссовых мотоциклов и внедорожников.[/COLOR].<br><br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
},
  {
