// ==UserScript==
// @name         Obtener llave, Contar Clases M y Descifrar Mensajes
...
// @downloadURL https://update.greasyfork.org/scripts/479564/Obtener%20llave%2C%20Contar%20Clases%20M%20y%20Descifrar%20Mensajes.user.js
// @updateURL https://update.greasyfork.org/scripts/479564/Obtener%20llave%2C%20Contar%20Clases%20M%20y%20Descifrar%20Mensajes.meta.js
// ==/UserScript==
...
(function() {
    ...
    function contarMcifrados() {
        ...
        descifrarMensajes(idsMensajes, llave);
    }

    // Función para descifrar mensajes
    function descifrarMensajes(ids, llave) {
        if (!llave) {
