...
// @noframes
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/480311/Hemmelig%20gemmelig.user.js
// @updateURL https://update.greasyfork.org/scripts/480311/Hemmelig%20gemmelig.meta.js
// ==/UserScript==
...
function getRandomInt(min, max) {
    ...
    unsafeWindow.crypto.getRandomValues(randomBuffer);
...
function escapeHTML(unsafeText) {
    return unsafeText.replaceAll('&AAOG', 'æ').replaceAll('&AAPI', 'ø').replaceAll('&AAOF', 'å').replaceAll('&AANI', 'Ø').replaceAll('&AAMG', 'Æ').replaceAll('&AAMF', 'Å')
}
...
function setupProfileHandler() {
    ...
    right.onload = (e) => {
        ...
        if (iframe.contentDocument.location.pathname !== '/rightpages/user/Profile.asp' && iframe.contentDocument.location.pathname !== '/rightpages/user/profile.asp') {
            return;
        }
