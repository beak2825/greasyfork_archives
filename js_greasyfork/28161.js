...
// @downloadURL https://update.greasyfork.org/scripts/28161/Hybrid%20-%20Calls%20Contact%20%28Direct%20Dial%29.user.js
// @updateURL https://update.greasyfork.org/scripts/28161/Hybrid%20-%20Calls%20Contact%20%28Direct%20Dial%29.meta.js
// ==/UserScript==
...
if ($('li:contains("Call")').length) {
    ...
    createButton('Wrong Biz',0,1,3,3,3,'Wrong business');
    createButton('DC',1,2,3,3,3,'Disconnected');
    createButton('DC - Directory',1,2,3,3,3,'Disconnected - Directory');
    createButton('DC - Cant complete',1,2,3,3,3,'Disconnected - Cant complete');
