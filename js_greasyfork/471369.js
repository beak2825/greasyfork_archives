...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471369/rplace%202023%20Lockard%20Overlay%202.user.js
// @updateURL https://update.greasyfork.org/scripts/471369/rplace%202023%20Lockard%20Overlay%202.meta.js
// ==/UserScript==
  ...
  addEventListener('load', () => {
    ...
    const loadOverlay = () => {
      const name = "LockardLogo";
        const url = "https://i.ibb.co/WWBtQcJ/overlay-2.png";
      const x = 0;
      const y = 0;
      const width = 1500;
      const height = 1000;
