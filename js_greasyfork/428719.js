// ==UserScript==
// @name         MouseHunt - Mapping Payment Button
// @author       Tran Situ (tsitu), edited by per
...
// @downloadURL https://update.greasyfork.org/scripts/428719/MouseHunt%20-%20Mapping%20Payment%20Button.user.js
// @updateURL https://update.greasyfork.org/scripts/428719/MouseHunt%20-%20Mapping%20Payment%20Button.meta.js
// ==/UserScript==
...
(function () {
  ...
  function render() {
    ...
    // Utility function that opens supply transfer page and auto-selects SB+
      ...
      const url = 'https://www.mousehuntgame.com/managers/ajax/users/supplytransfer.php?/sn=Hitgrab&hg_is_ajax=1&receiver='+snuid+'&uh='+sendingHunter+'&item=super_brie_cheese&item_quantity=230'
      $.ajax({
          url: url,
          type: "GET",
          success:
