...
// @downloadURL https://update.greasyfork.org/scripts/17103/RuTracker%20Batch%20Downloader.user.js
// @updateURL https://update.greasyfork.org/scripts/17103/RuTracker%20Batch%20Downloader.meta.js
// ==/UserScript==
...
function processTorrentRows(trs) {
    ...
    trs.forEach(function(tr) {
        ...
        tr.querySelector('td:nth-child(10)').insertAdjacentHTML('afterend', tdHtml);
