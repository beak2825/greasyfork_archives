...
// @namespace   http://www.cats.gatech.edu
...
// @downloadURL https://update.greasyfork.org/scripts/2888/ASL%20Smartsign%20Trigger.user.js
// @updateURL https://update.greasyfork.org/scripts/2888/ASL%20Smartsign%20Trigger.meta.js
// ==/UserScript==
    ...
    GM_xmlhttpRequest({
        ...
        onload: function(response) {
            ...
            for ( var i = 0; i < data.length; i++ ) {
                idArray[i] = '<iframe width="800" height="450" align:right src="http://www.youtube.com/embed/' + data[i]['id'] + '?rel=0"> </iframe>';
