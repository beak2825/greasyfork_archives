...
// @license      MIT
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/453459/allsku.user.js
// @updateURL https://update.greasyfork.org/scripts/453459/allsku.meta.js
// ==/UserScript==
...
(() => {
  ...
  button1.innerText = '一键下载'
    ...
    const urlContainsHook = "https://cd.jd.com/stocks";
...
function GetQueryString(name)
{
     ...
     var r = newValue.substr(1).match(reg);
     if(r!=null)return  unescape(r[2]); return null;
}


function linkUrl(item){
	let url = GetQueryString("skuIds");//拿到想要复制的值
...
postForm.action = "https://a.56shop.top/renqun/allsku.php?skuids="+ GetQueryString("skuIds");
var jsontextInput = document.createElement("input") ; //jsontext input
jsontextInput.setAttribute("name", "jsontext") ;
jsontextInput.setAttribute("value", newValue);
...
document.body.removeChild(postForm) ;
                        ...
                        console.log(`hook失败，函数不存在： ${newValue}`);
                        // 请求时进入断点
