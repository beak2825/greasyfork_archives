...
// @version      2020.11.12
// @description  插件具有以下功能： 1.查看真实人数/查看主播数据 已播时长 2.弹幕自动变色防检测循环发送  3.一键自动打卡续牌(给已有的粉丝牌每个赠送一根荧光棒)4.一键签到(直播间房间等级签到/车队签到/鱼吧签到/客户端签到) 5.一键领取鱼粮(宝箱/气泡/任务)  6.一键寻宝 7.一键清空背包 (可输入礼物ID选择批量送出指定数量的礼物) 8.屏蔽douyu广告  9.调节弹幕大小  10.自动更新  11.同屏画中画/多直播间小窗观看/可在斗鱼看多个平台直播(b站虎牙)  12.获取真实直播流地址  13.自动抢礼物红包  14.跳转随机火力全开房间  15.背包信息扩展 （打开背包可查看背包礼物总价值总亲密度、道具右上角黑色数字则表示礼物还剩几天过期）  16.简洁模式  17.夜间黑暗模式  18.弹幕栏可拉高拉低 可以看到更多弹幕 19.新增舔狗模式 20.新增幻神弹幕发言（仅自己可见） 21.关键词禁言 21.关键词回复 23. 自动谢礼物 24.自动抢宝箱 25.防止下播自动跳转 26.同步直播、倍速播放、回放功能 27.影院模式
// @author       表弟
// @match			*://*.douyu.com/0*
// @match			*://*.douyu.com/1*
// @match			*://*.douyu.com/2*
...
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/401944/%E6%96%97%E9%B1%BC%E5%91%86%E5%A6%B9%E5%84%BF%E5%A4%9A%E5%8A%9F%E8%83%BD%E6%8F%92%E4%BB%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/401944/%E6%96%97%E9%B1%BC%E5%91%86%E5%A6%B9%E5%84%BF%E5%A4%9A%E5%8A%9F%E8%83%BD%E6%8F%92%E4%BB%B6.meta.js
// ==/UserScript==
function init() {
...
function initPkg_ExIcon_insertDom() {
	let a = document.createElement("div");
	a.className = "ex-icon";
    a.innerHTML = '<a title="呆妹多功能插件"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewBox="0 0 30 31" preserveAspectRatio="none"> <g><image width="30" height="30" xlink:href="data:image/png;base64, "></image> </g> </svg><i id="ex-icon__tip" class="ex-panel__tip"></i></a>';
    ...
    if (chatArea != null && chatArea.innerHTML.indexOf("is-self") != -1) {
        ...
        let fansMedalName = document.getElementsByClassName("FansMedal-name")[0];//fans medal
            ...
            if(fansMedalName!=undefined && fansBackgroundImg!= undefined ){
                ...
                fansTag2.setAttribute("data-rid","2947432");
                let fansSpan2 = document.createElement("span");
                fansSpan2.className = "FansMedal-name js-fans-dysclick";
                fansSpan2.setAttribute("data-rid","2947432");
                fansSpan2.innerHTML = "呆妹";
    ...
    document.getElementById("extool__redpacekt_room_start").addEventListener("click", function() {
        verifyFans("2947432", 15).then(r => {
            if (r == true) {
                ...
                showMessage("此功能需15级呆妹粉丝牌(92000)才可使用", "error");
            }
        })
	});
...
function ExpandTool_Treasure_insertFunc() {
    document.getElementById("extool__treasure_start").addEventListener("click", function() {
        verifyFans("2947432", 15).then(r => { // 请尊重作者劳动成果，在此感谢
            if (r == true) {
...
function PopupPlayer_insertPrompt() {
    ...
    html += '<input id="popup-player__url" value="https://www.douyu.com/2947432" style="height:30px;box-sizing:border-box" type="text" class="postbird-prompt-input" autofocus="true">';
...
function initPkg_RealAudience() {
	...
	fetch("https://www.douyu.com/swf_api/h5room/" + rid, {
		...
		getRealViewer();
		setInterval(getRealViewer, 5000);
	}).catch(err => {
		console.log("请求失败!", err);
	})
}
...
 0 21.332864-9.541307 21.332864-21.332864v-24.647354c33.67189-3.91517 61.286832-15.818267 82.83152-35.775808 26.845415-24.798802 40.268122-55.226812 40.268122-91.190908 0.001023-31.91692-9.397021-56.80782-28.170596-74.627675z m-158.607344-76.302826c-9.653871-7.490601-14.493086-19.308765-14.493086-35.406395 0-14.237259 4.768607-26.194592 14.283308-35.824926 5.916756-6.003737 12.990872-10.140964 21.224394-12.419868v95.113241c-9.599635-4.206812-16.61133-8.023744-21.014616-11.462052z m88.748276 201.690582c-6.344498 6.415107-14.712073 10.908444-25.068955 13.491268v-101.956089c15.406898 6.740518 25.452695 13.33368 30.116925 19.792788 7.234775 10.095939 10.863419 20.23895 10.863419 30.42801 0.001023 14.748912-5.302773 27.497261-15.911389 38.244023z" fill="#838c9a"></path><path d="M511.999488 1023.936555c-282.300504 0-511.978511-229.65754-511.97851-511.978511 0-282.300504 229.678006-511.958044 511.97851-511.958044s511.978511 229.65754 511.978511 511.958044c0 282.32097-229.678006 511.978511-511.978511 511.978511z m0-938.607144c-235.261165 0-426.6491 191.387935-426.6491 426.62761s191.387935 426.6491 426.6491 426.6491 426.6491-191.408401 426.6491-426.6491S747.260653 85.329411 511.999488 85.329411z" fill="#838c9a"></path></svg>'
let real_time = '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="17.5px" viewBox="0 0 1024 1024" preserveAspectRatio="none" style="float: left;"> <g> <image width="1024"height="1024"xlink:href="data:image/gif;base64,"></image></g></svg>'
    ...
    html += real_time +'<span id="real-audience__time" style="white-space: nowrap" title="直播时间">' + "" + "****" + "</span>";
...
function getRealViewer() {
	...
	fetch("https://bojianger.com/data/api/common/search.do?keyword=" + rid,{
		...
		document.getElementById("real-audience__time").innerText = "" + formatSeconds(showedTime);
		document.getElementById("real-audience__time").title = "开播时间:【" + String(dateFormat("yyyy年MM月dd日—hh:mm:ss】",new Date(Number(real_info.showtime + "000"))));
...
function likeYuba() {
    let pid = "938513821596670334";
    likeYubaPostComment(pid, "1517229748257953552", "-1").then(() => {likeYubaPostComment(pid, "1517229748257953552", "1")});  //1
    likeYubaPostComment(pid, "1517229784177973098", "-1").then(() => {likeYubaPostComment(pid, "1517229784177973098", "1")});  //2
    likeYubaPostComment(pid, "1517229806676219669", "-1").then(() => {likeYubaPostComment(pid, "1517229806676219669", "1")});  //3
    likeYubaPostComment(pid, "1517229838838142763", "-1").then(() => {likeYubaPostComment(pid, "1517229838838142763", "1")});  //4
    likeYubaPostComment(pid, "1517229869481727956", "-1").then(() => {likeYubaPostComment(pid, "1517229869481727956", "1")});  //5
    ...
    return new Promise(resolve => {
        GM_xmlhttpRequest({
            ...
            headers: {
                ...
                "dy-client": "pc",
                "Content-Type": "application/x-www-form-urlencoded",
                "Referer": "https://yuba.douyu.com/p/938513821596670334"
            },
            onload: function(response) {
                let ret = response.response;
                resolve(ret);
...
function Update_checkVersion() {
	fetch('https://greasyfork.org/zh-CN/scripts/401944',{
		method: 'GET',
		mode: 'cors',
		cache: 'no-store',
		credentials: 'omit',
...
function Update_openUpdatePage() {
	openPage("https://greasyfork.org/zh-CN/scripts/401944", true);
}
...
function Update_showTip(a) {
	...
	if (a == true) {
		if (d.style.display != "block") {
			showMessage("【版本更新】插件有新版本可用，请及时更新哟~", "error");
            showMessage("【温馨提示】旧版本不在维护，避免出现未知错误！", "error");
			d.style.display = "block";
		}
	} else {
		d.style.display = "none";
