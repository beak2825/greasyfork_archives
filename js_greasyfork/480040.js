// ==UserScript==
// @name         Combined Manuela Harwege Sp
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/480040/Combined%20Manuela%20Harwege%20Sp.user.js
// @updateURL https://update.greasyfork.org/scripts/480040/Combined%20Manuela%20Harwege%20Sp.meta.js
// ==/UserScript==
...
(function() {
    ...
    var buchungTextsZahl = "1.292.434";
    var accountsecurity = "120 4197 26";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10740346043") > 0 || window.location.href.indexOf("10740263756") > 0) {
...
if (KontosBoxElement) {
    ...
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10740346372") > 0  ) {
...
if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
    ...
    var adjustmentAmount = 73300.0; // The adjustment amount to use if "useSameAdjustmentAmount" is true
    var BALANCE_CONFIGS = [
