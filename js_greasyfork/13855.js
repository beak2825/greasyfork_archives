...
// @downloadURL https://update.greasyfork.org/scripts/13855/Tiberium%20Alliances%20Info%20Sticker.user.js
// @updateURL https://update.greasyfork.org/scripts/13855/Tiberium%20Alliances%20Info%20Sticker.meta.js
// ==/UserScript==
(function () {
                        ...
                        calculateInfoData: function () {
                            try {
								...
								//console.log(ncity.get_CommandCenterLevel());
									...
									this.productionLabelTiberium.setTextColor(this.formatNumberColor((powerPac),tiberiumPac));
									}else{this.productionLabelTiberium.setTextColor(this.formatNumberColor((tiberiumPac),(powerPac)));}
									if(crystalPac*2 > tiberiumPac){
									this.productionLabelCrystal.setTextColor(this.formatNumberColor(crystalPac, (tiberiumPac)));
									}else{this.productionLabelCrystal.setTextColor(this.formatNumberColor((tiberiumPac), crystalPac));}
									if(powerPac*2 > tiberiumPac){
									this.productionLabelPower1.setTextColor(this.formatNumberColor( powerPac, (tiberiumPac)));
                                    }else{this.productionLabelPower1.setTextColor(this.formatNumberColor((tiberiumPac), powerPac ));}
									...
									this.contProductionLabelTiberium.setTextColor(this.formatNumberColor((powerProd),tiberiumProd));
									}else{this.contProductionLabelTiberium.setTextColor(this.formatNumberColor((tiberiumProd),(powerProd)));}
									if(crystalProd*2 > tiberiumProd){
									this.contProductionLabelCrystal.setTextColor(this.formatNumberColor(crystalProd, (tiberiumProd)));
									}else{this.contProductionLabelCrystal.setTextColor(this.formatNumberColor((tiberiumProd), crystalProd));}
									if(powerProd*2 > tiberiumProd){
									this.contProductionLabelPower.setTextColor(this.formatNumberColor( powerProd, (tiberiumProd)));
                                    }else{this.contProductionLabelPower.setTextColor(this.formatNumberColor((tiberiumProd), powerProd ));}
