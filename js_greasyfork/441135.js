// // ==UserScript==
// @name         BR | ADM Script for forum by Toretto
...
// @downloadURL https://update.greasyfork.org/scripts/441135/BR%20%7C%20ADM%20Script%20for%20forum%20by%20Toretto.user.js
// @updateURL https://update.greasyfork.org/scripts/441135/BR%20%7C%20ADM%20Script%20for%20forum%20by%20Toretto.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[COLOR=rgb(209, 213, 216)]Приятной игры на [/COLOR][/I][COLOR=rgb(209, 213, 216)][I]BLACK RUSSIA Azure.<br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][FONT=times new roman][SIZE=4][I][COLOR=rgb(255, 0, 0)]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR]<br><br>' +
        '[COLOR=rgb(209, 213, 216)][I][SIZE=4][FONT=times new roman]Заголовок составлен не по форме.[/FONT][/SIZE]<br>' +
        '[SIZE=4][FONT=times new roman]В названии темы необходимо указать никнейм администратора и причину наказания: "Nick_Name | Массовый DM".[/FONT][/SIZE][/I][/COLOR]<br>' +
        '[COLOR=rgb(250, 197, 28)][I][SIZE=4][FONT=times new roman]• Пример:[/FONT][/SIZE][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][SIZE=4][FONT=times new roman] "Leonid_Toretto | Массовый DM".[/FONT][/SIZE]<br><br>' +
        '[SIZE=4][FONT=times new roman]Внимательно изучите правила написания обжалований, закреплённые в этом разделе.[/FONT][/SIZE]<br><br>' +
        '[SIZE=4][FONT=times new roman]Приятной игры на BLACK RUSSIA Azure.[/FONT][/SIZE][/I][/COLOR]<br><br>' +
        '[SIZE=4][FONT=times new roman][I][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/I][/FONT][/SIZE][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    }
];
