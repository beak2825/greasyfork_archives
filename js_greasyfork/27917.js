...
// @downloadURL https://update.greasyfork.org/scripts/27917/Hybrid%20-%20Marchy%20callsy%202.user.js
// @updateURL https://update.greasyfork.org/scripts/27917/Hybrid%20-%20Marchy%20callsy%202.meta.js
// ==/UserScript==
...
if ($('li:contains("Call")').length) {
    ...
    createButton('Biz on Voicemail',0,0,3,3,3,'Business on Voicemail');
    createButton('No',0,0,1,2,2,'');
    createButton('Wrong Biz',0,1,3,3,3,'Wrong business');
    createButton('DC',2,2,3,3,3,'Disconnected');
    createButton('Fax',1,3,3,3,3,'Fax');
    createButton('Ringing',0,2,3,3,3,'Kept ringing','Kept ringing');
    createButton('Silence',0,2,3,3,3,'Rang until silence');
    createButton('Hung Up',0,2,3,3,3,'Hung up on me');
    createButton('Busy',0,2,3,3,3,'Busy signal');
    createButton('Generic VM',0,2,3,3,3,'Voicemail with no info.');
    createButton('Personal VM',0,2,3,3,3,'Personal voicemail');
