// ==UserScript==
// @name         Brew.link to Aiden (debug deluxe)
...
// @downloadURL https://update.greasyfork.org/scripts/524573/Brewlink%20to%20Aiden%20%28debug%20deluxe%29.user.js
// @updateURL https://update.greasyfork.org/scripts/524573/Brewlink%20to%20Aiden%20%28debug%20deluxe%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    try {
        ...
        // Function to ensure the login button exists before attaching the event
        function attachLoginButtonHandler() {
            const loginButtonCheckInterval = setInterval(() => {
                if (loginButton) {
                    clearInterval(loginButtonCheckInterval);
                    log('Login button found. Attaching event handler.');
        ...
        // Initially attach the login button handler
        ...
        // Login button handler is attached above via attachLoginButtonHandler()

        // Login form submission
        // Note: Since we attached the click event above, we don't need to attach another here.
