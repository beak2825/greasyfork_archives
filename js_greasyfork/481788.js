// ==UserScript==
// @name         VORONEZH | Скрипт для КФ
// @namespace    https://forum.blackrussia.online
// @version      1.1
// @description  По вопросам обратная связь в Вк: https://vk.com/tychtosovsem
// @author       Roma_Clever
// @match        https://forum.blackrussia.online/threads/*
// @icon         https://cdn-icons-png.flaticon.com/128/4080/4080314.png
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/481788/VORONEZH%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/481788/VORONEZH%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
const buttons = [
      {
	  title: '______________________________________Раздел Жалобы на игроков______________________________________',
      },
     { title: 'Приветствие',
      content:
    ...
    {
            title: '______________________________________________Перенаправление______________________________________________',
     },
    {
            title: 'ГА',
            content:
    ...
    {
	  title: '______________________________________________ОТКАЗЫ______________________________________________',
	},
    {
	  title: '| Не по форме |',
	  content:
    ...
    {
	  title: '| Док-ва не принимаются |',
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]По данным доказательствам нельзя выдать наказание игроку.<br><br>"+
		"[B][CENTER][COLOR=lavender]Все нарушения должны быть подтверждены через определенные ресурсы, а не только по предоставленным доказательствам.<br><br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
    ...
    {
	  title: '| Качество плохое |',
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=gold]На ваших доказательствах плохое качество, попробуйте прикрепить новую тему, используя другие видеохостинги или способы для предоставления доказательств.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
    ...
    {
	  title: '| Nick не совпадает |',
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=gold]Указанный вами Nick_Name не совпадает с тем, который присутствует на доказательствах.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
    ...
    {
        title: '______________________________________________Доказательства______________________________________________',
           },
    {
	  title: '| Доква обрываются |',
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=pink] Доказательства были оборваны. Оформите ещё раз жалобу, но с полной записью. <br>"+
        "[B][CENTER][COLOR=pink] Если вы не до конца записывали фрапс (видео-фиксацию), то увы, Ваша жалоба отказана. <br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	...
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Жалоба составлена от 3-его лица, рассмотрению не подлежит.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
  {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Предоставленных доказательств недостаточно для принятия решения или они некорректны.<br>"+
      "[B][CENTER][COLOR=lavender] Если у вас имеются дополнительные доказательства, то прикрепите их, создав новую тему.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] В ваших доказательствах отсутствуют условия сделки, рассмотрению не подлежит.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
     {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Доказательства были подвергнуты редактированию, рассмотрению не подлежит. <br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	...
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Вам уже был дан ответ в прошлой жалобе, пожалуйста, прекратите создавать дубликаты данной темы.<br>"+
        "[B][CENTER][COLOR=lavender]В противном случае Ваш форумный аккаунт может быть заблокирован.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=black]В данной ситуации обязательно должен быть фрапс (видеофиксация) всех моментов, в противном случае жалоба будет отказана.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=black]Ваши доказательства не рабочие или же битая ссылка, пожалуйста, загрузите доказательства на фото/видео хостинге.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]На ваших доказательствах присутствует возрастное ограничение, пожалуйста, загрузите ваше видео без ограничений. <br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваши доказательства длятся более 3-ёх минут, в данном случае нужно указать тайм-коды.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	...
	},
{
	...
	},
 {
	  ...
	  content:
		...
		"[B][COLOR=gold]Советуем вам зараннее оформлять жалобы, приятной вам игры.<br>"+
     "[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
    ...
    {
            title: '______________________________________________Наказания за убийства______________________________________________',
          },
    {
	  title: '| DM |',
	  content:
    ...
    {
            title: '______________________________________________Наказания в чатах______________________________________________',
          },
{
	  title: '| MG |',
	  content:
	...
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующее наказание.[Spoiler][color=red]3.07. | [color=lavender] Запрещены совершенно любые оскорбления или действия, порочащие честь и достоинства, несущие в себе подтекст сексуального характера вне зависимости от чата[color=red]  | Mute 30 минут<br>"+
        "[CENTER][COLOR=red]Примечание[COLOR=lavender]: «дырка», «шмара», «ведро», «мадагаскарский присосконог», «свиноногий бандикут», «скорострел» и так далее.[/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Наказание будет выдано в течение 24 часов.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=#00FA9A][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	...
	},
{
    ...
    {
            title: '______________________________________________ЖБ НЕ ТУДА______________________________________________',
           },
    {
	  title: '| В ЖБ на АДМ |',
	  content:
    ...
    {
    title: '______________________________________________NonRP______________________________________________',
           },
	...
	},
{
    ...
    {
        title: '______________________________________________Наказания за рекламу______________________________________________',
          },
     {
            title: 'Реклама войс',
            content:
    ...
    {
            title: '______________________________________________Прочее______________________________________________',
           },
    {
	  title: '| Обход системы |',
	  content:
    ...
    {
      title: '______________________________________________RolePlay биографии______________________________________________',
    },
	{
	  title: '| Одобрено |',
	  content:
	...
	},
 {
    ...
    {
        title: '______________________________________________RolePlay ситуации______________________________________________'
    },
    	{
	  title: '| Одобрено |',
	  content:
	...
	},
  {
    ...
    {
      title: '______________________________________________RolePlay организации______________________________________________'
    },
    {
	  title: '| Одобрено |',
	  content:
