...
// @nocompat     Chrome
// @downloadURL https://update.greasyfork.org/scripts/483108/Autoverify-mod-sync.user.js
// @updateURL https://update.greasyfork.org/scripts/483108/Autoverify-mod-sync.meta.js
// ==/UserScript==
...
class CaptchaWrite {
    ...
    CalcRuleBindingElement(img, input) {
        ...
        imgObj.onload = function () {
            that.CalcRuleBindingElement(imgObj, input)
        }
