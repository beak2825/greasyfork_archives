...
// @downloadURL https://update.greasyfork.org/scripts/396782/TW%20Friends.user.js
// @updateURL https://update.greasyfork.org/scripts/396782/TW%20Friends.meta.js
// ==/UserScript==
	...
	this[scriptObject] = {
		...
		windowManager: {
			...
			buildTable: function(sort) {
				...
				if('https://gr1.the-west.gr' == Game.gameURL || 'https://gr8.the-west.gr' == Game.gameURL || 'https://gr9.the-west.gr' == Game.gameURL) hiroTable.appendToCell('foot', 'hf_last', 'by <a href="javascript:void(PlayerProfileWindow.open(92184));">'+scriptAuthor+'</a>');
