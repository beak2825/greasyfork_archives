...
// @version 2.6.5
// @description Reverts YouTube's 2016 Layout! | Customisation interface(API) included | Customizable thumbnail size | Customizable video player size | Download video button(no redirect) | Grey-out thumbnails on watched videos | Hide suggestions blocks | Hide  all the filter bars | And much more!
// @author 7KT SWE
// @icon https://i.ibb.co/YhZQfdT/7kt-tube.png
// @homepageURL     http://7ktgaming.tk/7kttube/
...
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/427428/7ktTube%20%7C%202016%20REDUX.user.js
// @updateURL https://update.greasyfork.org/scripts/427428/7ktTube%20%7C%202016%20REDUX.meta.js
// ==/UserScript==
...
(function () {
  ...
  const LOCALE = {
    ...
    'zh-tw': {
      togglelinks: 'é¡¯ç¤º / éš±è—é€£çµ',
      stream: 'ä¸²æµ Stream',
      adaptive: 'è‡ªé©æ‡‰ Adaptive',
      videoid: 'å½±ç‰‡ ID: ',
      inbrowser_adaptive_merger: 'ç€è¦½å™¨ç‰ˆè‡ªé©æ‡‰å½±ç‰‡åŠè²éŸ³åˆæˆå™¨'
    },
    zh: {
      togglelinks: 'æ˜¾ç¤º / éšè—é“¾æŽ¥',
      stream: 'ä¸²æµ Stream',
      adaptive: 'è‡ªé€‚åº” Adaptive',
      videoid: 'è§†é¢‘ ID: ',
      inbrowser_adaptive_merger: 'æµè§ˆå™¨ç‰ˆè‡ªé€‚åº”è§†é¢‘åŠå£°éŸ³åˆæˆå™¨'
    },
    kr: {
      togglelinks: 'ë§í¬ ë³´ì´ê¸°/ìˆ¨ê¸°ê¸°',
      stream: 'ìŠ¤íŠ¸ë¦¬ë°',
      adaptive: 'ì¡°ì • ê°€ëŠ¥í•œ',
      videoid: 'Video Id: {{id}}'
    },
    es: {
