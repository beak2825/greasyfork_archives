...
// @author       Amigo57
// @match        *://*.e-sim.org/donateMoney.html?id=*&actionStatus=DONATE_MONEY_OK


// @downloadURL https://update.greasyfork.org/scripts/40359/after-Donate.user.js
// @updateURL https://update.greasyfork.org/scripts/40359/after-Donate.meta.js
// ==/UserScript==
...
(function() {
    ...
    var priceEls4 = document.getElementsByClassName("testDivblue");
    var price1 = priceEls4[0].innerHTML;

    document.body.innerHTML = price1 + `<span style="
    font-size: 30px;
    color: #fffdfd;
    font-style: italic;
    background: #0000008f;
