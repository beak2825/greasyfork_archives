// ==UserScript==
// @name         VLADIMIR | Оформление логов проекта
// @namespace    https://logs.blackrussia.online/
// @version      1.05.05
// @description  Логирование проекта
// @author       Bewerly
// @match        https://logs.blackrussia.online/gslogs/78/*
// @icon         https://freepngimg.com/thumb/eagle/20-eagle-black-siluet-png-image-download-thumb.png
// @license      Bewerly
// @downloadURL https://update.greasyfork.org/scripts/513822/VLADIMIR%20%7C%20%D0%9E%D1%84%D0%BE%D1%80%D0%BC%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5%20%D0%BB%D0%BE%D0%B3%D0%BE%D0%B2%20%D0%BF%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/513822/VLADIMIR%20%7C%20%D0%9E%D1%84%D0%BE%D1%80%D0%BC%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5%20%D0%BB%D0%BE%D0%B3%D0%BE%D0%B2%20%D0%BF%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D0%B0.meta.js
// ==/UserScript==
(function () {
    'use strict';
    ...
    /* function createStyleButton(element) {
        ...
        const styleFAQ = document.createElement('button');
        styleFAQ.className = 'style-button';
        styleFAQ.id = 'style-modal-toggle1';
        styleFAQ.href = '#!';
        styleFAQ.tabIndex = '0';
        styleFAQ.dataset.bsToggle = 'modal';
        styleFAQ.dataset.bsTarget = '#';
        styleFAQ.textContent = 'F.A.Q project';

        const replaceElement1 = document.querySelector(element);
        replaceElement1.replaceWith(styleFAQ);
	} */
    ...
    function createStyleContainerBg(element) {
        ...
        styleTitleBadge.textContent = 'СТИЛЬ ЛОГОВ';
        ...
        switchStyleBlock.innerHTML = `
            ...
            <div class="addingText tooltip-style" style="display: block; width: max-content; margin: 5px; margin-left: 50px">Переливание текста
            <span class="tooltip-style-text">Анимированный градиент
            Повышенная нагрузка</span></div>
            </span>
        `;
        ...
        switchNumsBlock.innerHTML = `
            ...
            <span class="slider round" style="padding-right: 20px;"></span>
            <div class="addingText tooltip-style" style="display: block; width: max-content; margin: 5px; margin-left: 50px">Разряды чисел
        ...
        switchCopyBankBlock.innerHTML = `
            ...
            <span class="slider round" style="padding-right: 20px;"></span>
            <div class="addingText tooltip-style" style="display: block; width: max-content; margin: 5px; margin-left: 50px">Режим доказательств
        ...
        const fonts = ['Bad Script', 'Comfortaa', 'Fira Sans', 'Marmelad', 'Montserrat', 'Neucha', 'Play', 'Roboto', 'Sofia Sans', 'Ubuntu', 'Verdana', 'Times New Roman'];
        fonts.forEach(font => {
        ...
        fontSelectorText.textContent = 'Шрифт';
        ...
        colorSelectorText.textContent = 'Цвет';
        ...
        brightnessSliderText.textContent = 'Яркость';
        ...
        bugReportTG.href = 'https://t.me/pavelbewerly';
        ...
        bugReportVK.href = 'https://vk.me/pavelbewerly'
        ...
        bugReportText.textContent = 'REPORT';
        bugReportBlock.appendChild(bugReportText);
 
        const FAQBlock = document.createElement('label');
        FAQBlock.className = 'faq-block';
        styleContBody.appendChild(FAQBlock);

        const RulesProject = document.createElement('a');
        RulesProject.href = 'https://t.me/pavelbewerly';
        RulesProject.target = '_blank';
        RulesProject.innerHTML = `<img class="bug-report-button" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Telegram_logo.svg/512px-Telegram_logo.svg.png"></img>`;
        FAQBlock.appendChild(RulesProject);

        /* const bugReportVK = document.createElement('a');
        bugReportVK.href = 'https://vk.me/pavelbewerly'
        bugReportVK.target = '_blank';
        bugReportVK.innerHTML = `<img class="bug-report-button" src="https://cdn-icons-png.flaticon.com/512/145/145813.png"></img>`;
        FAQBlock.appendChild(bugReportVK);

        const bugReportGF = document.createElement('a');
        bugReportGF.href = 'https://greasyfork.org/ru/scripts/475162-theme-font-changer/feedback'
        bugReportGF.target = '_blank';
        bugReportGF.innerHTML = `<img class="bug-report-button" src="https://raw.githubusercontent.com/JasonBarnabe/greasyfork/master/public/images/blacklogo512.png"></img>`;
        FAQBlock.appendChild(bugReportGF); */

        const FAQtext = document.createElement('span');
        FAQtext.className = 'addingText';
        FAQtext.textContent = 'F.A.Q по проекту';
        FAQBlock.appendChild(FAQtext);
    ...
    function applySavedColors() {
        ...
        savedColors.textContent = `
                ...
                /* Nickname */
                    .td-player-name[data-v-2d76ca92] a[data-v-2d76ca92] {
                        color: ${savedNick};
                        text-shadow: 0px 0px 10px ${savedNick};
                    }

                /* Category */
                .td-category[data-v-2d76ca92] a[data-v-2d76ca92] {
                    color: ${savedCategory};
                    text-shadow: 0px 0px 10px ${savedCategory}; /* точка */
                }
                `;
...
--- Ububntu --- */
            ...
            /* Powered by Google Fonts API */
                ...
                @import url('https://fonts.googleapis.com/css2?family=Bad+Script&family=Comfortaa&family=Fira+Sans&family=Marmelad&family=Montserrat&family=Neucha&family=Play&family=Roboto:ital@1&family=Sofia+Sans&family=Ubuntu&family=Verdana&family=Times+New+Roman&display=swap');`;
    ...
    function replaceSpinnerImage() {
        ...
        if (spinnerElement) {
            ...
            gifImage.style.textContent = 'ЗАГРУЗКА';
