...
// @downloadURL https://update.greasyfork.org/scripts/373154/WME%20Route%20Speeds%20%28Passes%2C%20Permits%2C%20and%20Vehicles%2C%20oh%20my%29.user.js
// @updateURL https://update.greasyfork.org/scripts/373154/WME%20Route%20Speeds%20%28Passes%2C%20Permits%2C%20and%20Vehicles%2C%20oh%20my%29.meta.js
// ==/UserScript==
*/};

/*Version history:
 * 2018 September - branch development
...
var routespeedsoption19 = false; // Express Passes
...
function saveRouteSpeedsOptions() {
	...
	if (obj1 !== undefined) {
		...
		localStorage.setItem("RouteSpeedsOption19", obj19.checked);
	}
}
//---------------------------------------------------------------------------------------
...
//    if (expressPass) {data.subscription = "ezpass-us" ;}
//     if (expressPass) {data.subscription = "fastrak-flex-us" ;}
...
//                    routehov1 = json.reponse.results.laneType;   // FIXIT - not needed?
...
function initialiseWMERouteSpeeds()
{
	...
	addon.innerHTML = '' +
		...
		'<option id=routespeeds-option18 value="ELECTRIC">Electric</option>'	+
        '</select>'	+
        '</div>'	+
        '<br>'	+
