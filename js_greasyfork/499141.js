...
// @version      0.1
// @description  faucetgame
// @author       LTW
// @license      none
// @match        https://faucetgame.xyz/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=faucetgame.xyz
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/499141/faucetgamexyz.user.js
// @updateURL https://update.greasyfork.org/scripts/499141/faucetgamexyz.meta.js
// ==/UserScript==
...
(function() {
  ...
  const email = '';
  const password = '';
  const redirectUrl = 'https://faucetgame.xyz/faucet';
  ...
  if (window.location.href.includes("/dashboard")) {
    window.location.href = 'https://faucetgame.xyz/faucet';
  }

  if (window.location.href === "https://faucetgame.xyz/" || window.location.href === "https://faucetgame.xyz") {
    window.location.href = "https://faucetgame.xyz/login";
  }
