...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/547521/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%20ULYANOVSK.user.js
// @updateURL https://update.greasyfork.org/scripts/547521/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%20ULYANOVSK.meta.js
// ==/UserScript==
    ...
    },
{
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
        `[B][CENTER][COLOR=#FFFF00]${greeting}, уважаемый(ая) ${user.mention} [/COLOR][/CENTER][/B]<br><br>`+
        `[B][CENTER][COLOR=lavender]Ваша жалоба была передана Техническому специалисту сервера, @Molly_Moretti, на рассмотрение<br>`+
        `[B][CENTER][COLOR=lavender]Возможно на рассмотрении жалобы потребуется больше времени. Просьба ожидать ответа и не создавать копий данной темы. <br>`+
         `[B][CENTER][COLOR=lavender]Приятной игры на  [COLOR=#cc920c]ULYANOVSK[/COLOR].<br><br>`+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
