...
// @namespace      https://greasyfork.org/zh-CN/users/5280-wh-t
...
// @version        1.5.8
// @copyright  https://greasyfork.org/zh-CN/scripts/7251-enhanced-word-highlight https://www.firefox.net.cn/read-29795
// @downloadURL https://update.greasyfork.org/scripts/5026/Enhanced%20word%20highlight.user.js
// @updateURL https://update.greasyfork.org/scripts/5026/Enhanced%20word%20highlight.meta.js
// ==/UserScript==
...
//{	values >
	...
	var _di = { // en/zh locale string for dialog.
		...
		confT:  ['Enhanced word highlight 高级设置'],
		conf:   [['你主要用那种自动翻页工具？',
				'是否默认停用短关键词的高亮？',
				'是否禁用自动高亮（自动抓取关键词来高亮）？',
				...
				'保存面板位置',
				'查找关键词时显示指示条']],
		confR:  [[['Autopagerize GM 脚本','Autopager 扩展','其他（能应付任何自动翻页工具但运作较慢）'],
...
// #### Config I #### --------------------------{{
	...
	urlArr[7] = ['haosou',	 'q=',	 'www.haosou.com'];
...
//			'#' + PRE + '_word_inputs_list > li > label > input[type=image]{vertical-align:top;padding:0;height:12px;}',
	...
	function get_KW_from_URL(urlsearch, _e) {
		...
		if (urlArr[_e][0] =='Baidu' && urlsearch.indexOf('ie=utf-8') == -1 && document.characterSet.toLowerCase()!=='utf-8') kwtmp = urlDecode(KW);  // 如果是百度且非utf-8
