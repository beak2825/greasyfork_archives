...
// @downloadURL https://update.greasyfork.org/scripts/553083/JavScript.user.js
// @updateURL https://update.greasyfork.org/scripts/553083/JavScript.meta.js
// ==/UserScript==

// prettier-ignore
(function () {
  const CODE_SELECTOR = "span[style='color: rgb(204, 0, 0); --darkreader-inline-color: var(--darkreader-text-cc0000, #ff3d3d);']";
...
.x-table td a:not(:last-child) {
          ...
          refactorTbody(magnets, key) {
              ...
              if (this.magnets.length) {
                  ...
                  if (this.M_COPY) {
                      table.querySelector(
                          "thead th:last-child"
                      ).innerHTML = `<a class="text-center" href="${VOID}" data-copy="all" title="复制全部磁链">复制全部</a>`;
                  }
   ...
   class="copy-btn visible-btn"
   data-copy="${link}"
   title="复制磁力链接">磁链</a>

<a href="javascript:void(0)"
   class="add-magnet-btn visible-btn text-success"
   data-magnet="${link}"
   title="添加离线任务">离线</a>
