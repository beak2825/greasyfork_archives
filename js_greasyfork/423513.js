...
// @downloadURL https://update.greasyfork.org/scripts/423513/Corrected%20Coords.user.js
// @updateURL https://update.greasyfork.org/scripts/423513/Corrected%20Coords.meta.js
// ==/UserScript==
...
(function() {
    ...
    function geocachePage() {
		...
		username = document.getElementsByClassName('username')[0].firstChild.data;
	...
	function waitForCorrected() {
		...
		coords = document.getElementById('uxLatLon');
        console.debug('span.uxlatation=',coords);
		coords = coords.className=='myLatLon';
        console.debug('span.uxlatation=',coords);
		if (coords) {
