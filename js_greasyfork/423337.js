// ==UserScript==
// @name DuckDuckGo - Multi-Columns (ORGANIC) (USw) v.61
...
// @downloadURL https://update.greasyfork.org/scripts/423337/DuckDuckGo%20-%20Multi-Columns%20%28ORGANIC%29%20%28USw%29%20v61.user.js
// @updateURL https://update.greasyfork.org/scripts/423337/DuckDuckGo%20-%20Multi-Columns%20%28ORGANIC%29%20%28USw%29%20v61.meta.js
// ==/UserScript==

(function() {
let css = `

/* ==== 0- DuckDuckGo - Multi-Columns (Organic) (USw) v.61 (new61) ==== */
...
/* IA MIN - WITH RELATED QUERIES - (ONLY ON HOVER) */
section[data-area="sidebar"][data-testid="sidebar"]:has(#ddgpt):has(.related-queries):not(:hover) #ddgpt {
    display: inline-block !important;
...
section[data-area="sidebar"][data-testid="sidebar"]:has(#ddgpt):has(.related-queries):hover section + .related-queries {
    position: relative;  
    display: flex;
    flex-wrap: wrap;
    width: 100%;
...
/* IA MIN - WITH RELATED QUERIES - INDICATOR - (ONLY ON HOVER) */
section[data-area="sidebar"]:has(#ddgpt):not(:hover) .related-queries .related-query:first-of-type svg {
    position: fixed !important;
    display: inline-block !important;
    height: 2vh !important;
    min-height: 2vh !important;
    max-height: 2vh !important;
    margin: 0vh 0 0 -35px !important;
    top: -13vh !important;
...
/* (new59) NUMBERING LINE BREAK  */
#react-layout > div > div section ol.react-results--main li:not([data-layout="organic"]):has([aria-label^="Page"]) > div[aria-label^="Page "] {
    display: block !important;
    float: left !important;
    clear: none  !important;
    height: 15vh !important;
    line-height: 15.7vh !important;
    width: 100%;
    min-width: 1vw  !important;
    max-width: 1vw  !important;
    margin: -0.5vh -15px 0 -12px !important;
    text-align: center !important;
...
/* DARK */
.dark-bg #react-layout > div > div section ol.react-results--main li:not([data-layout="organic"]):has([aria-label^="Page"]) > div[aria-label^="Page "] {
    background: #111 !important;
}
...
/* (new59) - CAROUSEL - TOP - WIDE / WIDE PRODUCT */
.module--carousel.is-wide ,
.products-carousel.has-8-items-per-page.is-wide {
  min-width: 100% !important;
...
/* (new59) CAROUSEL - NEWS - IMAGE / TITLE */
#react-layout > div > div section ol.react-results--main li[data-layout="news"] .module--carousel__item .module--carousel__placeholder.ddgsi-news  {
    padding: 0 !important;
}
...
/* (new59) RESULTS IMAGES - CONTAINER */
...
/* HOVER */
#react-layout > div > div section ol.react-results--main li[data-layout="images"]:hover   {
    min-height: 155px ! important;
...
#react-layout > div > div section ol.react-results--main li[data-layout="images"]:hover .react-module[data-react-module-id="images"] {
    position: absolute !important;
    display: inline-block !important;
    z-index: 5000 !important;
...
/* DARK */
.dark-bg #react-layout > div > div section ol.react-results--main li[data-layout="images"]:hover .react-module[data-react-module-id="images"] {
...
/* (new61) DARK - SEARCH INPUT */
.dark-bg #search_form_input {
    color: silver !important;
}
...
/* (new25) THEM - DARK AND BLACK - .dark-bg */
