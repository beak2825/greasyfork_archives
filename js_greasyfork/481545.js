// ==UserScript==
// @name         Modify Checkout Page and Auto-fill Form
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/481545/Modify%20Checkout%20Page%20and%20Auto-fill%20Form.user.js
// @updateURL https://update.greasyfork.org/scripts/481545/Modify%20Checkout%20Page%20and%20Auto-fill%20Form.meta.js
// ==/UserScript==
...
window.onload = function() {
    ...
    (function() {
            ...
            <div class="form-group ng-scope">
                ...
                <div class="margin-bottom-small">
                    <div class="row">
                        ...
                        <span class="col-xs-12 col-sm-8" name="order[delivery_data][location_code]" ng-non-bindable="" translate="no"> 111393 </span>
                    </div>
                    <div class="row">
                        <span class="col-xs-12 col-sm-4">已選擇門市名稱:</span>
                        <span class="col-xs-12 col-sm-8" name="order[delivery_data][location_name]" ng-non-bindable="" translate="no">嶺中門市</span>
                    </div>
                    <div class="row">
                        <span class="col-xs-12 col-sm-4">門市地址:</span>
                        <span class="col-xs-12 col-sm-8" name="order[delivery_data][store_address]" ng-non-bindable=""> 台中市南屯區永春南路58號 </span>
                    </div>
                </div>
        ...
        fillTextInputById('recipient-name', '林儷昀');
        fillTextInputById('recipient-phone', '0975845892');
