...
// @version      3.15
// @description  По вопросам в ВК - https://vk.com/id634092857, туда же и по предложениям на улучшение скрипта)
// @author       May_Henennessy
// @match        https://forum.blackrussia.online/index.php?threads/*
// @grant        none
// @license 	 MIT
// @icon https://icons.iconarchive.com/icons/3xhumed/mega-games-pack-36/256/Call-of-Duty-Modern-Warfare-2-29-icon.png
// @downloadURL https://update.greasyfork.org/scripts/459357/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20Yellow.user.js
// @updateURL https://update.greasyfork.org/scripts/459357/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20Yellow.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
		'[Color=#00FF00][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Вам даётся 24 часа на дополнение вашей РП биографии, в противном случае она получит статус - [Color=#DC143C]Отказано[/color]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: PIN_PREFIX,
    },
    {
      title: 'био отказ',
      content:
		'[Color=#DC143C][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Ваша РП биография получает статус - [Color=#DC143C]Отказано[/color].<br>Причиной отказа послужило нарушение [URL='https://forum.blackrussia.online/index.php?threads/crimson-Правила-составления-РП-Биографий.463667/']Правила написания RP биографии[/URL]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[Color=#00FF00][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Ваша РП ситуация получает статус - [Color=#00FF00]Одобрено[/color]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#DC143C][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Вам даётся 24 часа на дополнение вашей РП ситуации, в противном случае она получит статус - [Color=#DC143C]Отказано[/color]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: PIN_PREFIX,
    },
    {
      title: 'сита отказ',
      content:
		'[Color=#DC143C][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Ваша РП ситуация получает статус - [Color=#DC143C]Отказано[/color]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#00FF00][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        '[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Ваша РП ситуация получает статус - [Color=#00FF00]Одобрено[/color]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Так же хочу отметить, что игровую валюту вы не получите за ограбление чего-либо по РП. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[Color=#00FF00][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Ваша Неофициальная RP организация получает статус - [Color=#00FF00]Одобрено[/color]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#DC143C][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Вам даётся 24 часа на дополнение вашей Неофициальной RP организации, в противном случае она получит статус - [Color=#DC143C]Отказано[/color]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: PIN_PREFIX,
    },
    {
      ...
      content:
		'[Color=#DC143C][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][QUOTE][FONT=courier new]Ваша Неофициальная RP организация получает статус - [Color=#DC143C]Отказано[/color]. [/COLOR][/QUOTE][/FONT][/CENTER] <br>",
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
...
$(document).ready(() => {
    ...
    addButton('⚠ Скрипт от May_Hennessy ⚠', '/');
