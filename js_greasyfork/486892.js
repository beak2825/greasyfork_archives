// ==UserScript==
// @name        Bypass Medium paywall with google text cache
// @namespace   Alex Silver
// @grant       none
// @version     1.0
// @author      Alex Silver <alex.silver@skiff.com>
// @license MIT
// @description Redirects Medium, Towardsdatascience etc to a text-based google cache version, bypassing paywalls
...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/486892/Bypass%20Medium%20paywall%20with%20google%20text%20cache.user.js
// @updateURL https://update.greasyfork.org/scripts/486892/Bypass%20Medium%20paywall%20with%20google%20text%20cache.meta.js
// ==/UserScript==

(function() {
  "use strict";
  location.href = "https://webcache.googleusercontent.com/search?q=cache:" + window.location.href + "&strip=1&vwsrc=0";
})();
