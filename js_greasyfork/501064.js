...
// @version      2024-03-06
// @description  ce script est pour permetre au agence de valider leur rendez vous
// @author       You
// @license MIT
...
// @grant        GM_cookie
// @downloadURL https://update.greasyfork.org/scripts/501064/test%20onclick.user.js
// @updateURL https://update.greasyfork.org/scripts/501064/test%20onclick.meta.js
// ==/UserScript==
...
window.addEventListener('load', function () {
    ...
    if (localStorage.getItem("code_agence") == null || localStorage.getItem("code_agence") == "") {
        ...
        firebaseScript.onload = databaseScript.onload = function() {
            var firebaseConfig = {
                apiKey: "AIzaSyAkPgXsXRAfRD75LsysLvJOkB7vKdMEHtQ",
                authDomain: "groupe-algerie-1.firebaseapp.com",
                databaseURL: "https://groupe-algerie-1-default-rtdb.firebaseio.com",
                projectId: "groupe-algerie-1",
                storageBucket: "groupe-algerie-1.appspot.com",
                messagingSenderId: "241073243669",
                appId: "1:241073243669:web:4ab1aea1884c9489b2f01c",
                measurementId: "G-79QGSNPZ2V"
            };
