// ==UserScript==
// @name        Make AOL READER look like Google Reader - GreasyFork
// @description        Make AOL READER look like former Google Reader
// @namespace   *reader.aol.com/*
// @include     *reader.aol.com/*
// @include        http*://reader.aol.com/*
// @grant          GM_addStyle
// @version     2.4.5
// @downloadURL https://update.greasyfork.org/scripts/2194/Make%20AOL%20READER%20look%20like%20Google%20Reader%20-%20GreasyFork.user.js
// @updateURL https://update.greasyfork.org/scripts/2194/Make%20AOL%20READER%20look%20like%20Google%20Reader%20-%20GreasyFork.meta.js
// ==/UserScript==
...
GM_addStyle(".article-list-expanded .article-header.clearfix { display: none !important; font-size: 13px;}"); 
GM_addStyle(".article-item-full .article-header.clearfix { display: none !important; font-size: 13px;}"); 
GM_addStyle(".article-list-pane  {left: 278px !important;}");
...
GM_addStyle(".cat-nav-list .count { font-size: 13px; color:#226290 !important; font-weight: bold !important; font-family: arial, sans-serif !important;  }");
GM_addStyle(".category-item { font-size: 13px !important; color:red !important;  }");


GM_addStyle(".feed-header {left: 280px !important; right: 0px !important; }");
GM_addStyle(".feed-header h2, .article-header h2 {left: 280px !important; right: 0px !important; line-height: 40px !important; }");
...
GM_addStyle(".article-item-view .article-body { font-size: 13px !important; }");
GM_addStyle("h2.article-title a {color: #226290 !important; }");
GM_addStyle("h2.article-title  { margin-top:2.5px; font-size: 16px !important; font-family: arial, sans-serif !important; font-weight: bold !important}");
...
GM_addStyle(".article-item-list .article-wrap { padding-top:3px !important; padding-bottom:3px !important; font-size: 12.5px !important; }");
...
GM_addStyle(".nav .nav-list, .nav {width: 280px !important;}");
GM_addStyle("#reader-container {margin-left: 280px !important; margin-right: 0px !important;}");
//
//GM_addStyle(".nav {background: #F9FAFA !important; }");
...
GM_addStyle(".section-header {top: 55px !important;}");
GM_addStyle(".section-header, .article-header {height: 46px !important;}");
GM_addStyle(".article-list {margin-top: 38px !important;}");
GM_addStyle(".btn-list .btn-list-item  {height: 46px !important;}");


GM_addStyle(".article-item-modal .dialog-body {width:98% !important; }");

GM_addStyle(".article-pane-container .article-list-pane {top: -47px !important; left: 0px !important; }");
//GM_addStyle(".article-pane-container .article-list-pane {top: 77px !important; left: 280px !important; }");
//GM_addStyle(".section-header, .article-header {width: 80% !important;}");
//GM_addStyle(".article-pane-container-large .article-content {margin-top: 34px !important;}");
