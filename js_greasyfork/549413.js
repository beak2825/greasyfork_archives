...
// @downloadURL https://update.greasyfork.org/scripts/549413/RENXINZHU.user.js
// @updateURL https://update.greasyfork.org/scripts/549413/RENXINZHU.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "BECINIO ROSELYN SERRANO";
    const NEW_NAME = "REN XIN ZHU";
    const NEW_BIRTHDAY = "(**0121)";
    const NEW_EXPIRE_DATE = "2033-06-19";
