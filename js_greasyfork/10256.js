// ==UserScript==
// @name        MTurk HIT DataBase Testing Fixed
// @namespace   localhost
...
// @author      Tjololo, Can't Be Held Liable, Kerek
// @downloadURL https://update.greasyfork.org/scripts/10256/MTurk%20HIT%20DataBase%20Testing%20Fixed.user.js
// @updateURL https://update.greasyfork.org/scripts/10256/MTurk%20HIT%20DataBase%20Testing%20Fixed.meta.js
// ==/UserScript==
...
//
// 2012-10-23 0.20: Added Turkopticon (https://turkopticon.ucsd.edu/) links to overview pages
...
html +='<h1>' + results[0].requesterName + ' (' + results[0].requesterId + ')</h1>\n';
 ...
 html +='<p><a href="https://turkopticon.ucsd.edu/' + results[0].requesterId + '">' +
...
{
  return 'https://turkopticon.ucsd.edu/report?requester[amzn_id]=' + requesterId +
...
HITStorage.format_overview_line = function(req, odd, dot_line, top, i)
{
  ...
  line += '<td><button type="button" title="Show all HITs" style="height: 16px;font-size: 8px; padding: 0px;" id="id-' +
           ...
           i + '">+</button> ' + req[0].trim() +
           '</td>';
  line += '<td><a title="Requesters Turkopticon page" target="_blank" href="https://turkopticon.ucsd.edu/' + req[0].trim() + '">[TO]</a> ';
  line += req[1].trim() + '</td>';
...
else
{
  for (var item=0; item<10; item++) {
    ...
    //to_link.href = 'https://turkopticon.ucsd.edu/' + requesterId;
