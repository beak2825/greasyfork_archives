// ==UserScript==
// @name   🌱【免费版】公共卫生与预防医学继续教育平台|如需自动下一集、自动换课程、秒过高级功能见收费版本：http://doc.zhanyc.cn/pages/GGWSYYFYXJXJYPT/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制、自动下一集功能。如需秒过、自动换课程、课程考试答题、全自动无人值守等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*cpma.org.cn*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/510003/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%85%AC%E5%85%B1%E5%8D%AB%E7%94%9F%E4%B8%8E%E9%A2%84%E9%98%B2%E5%8C%BB%E5%AD%A6%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E7%A7%92%E8%BF%87%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttp%3AdoczhanyccnpagesGGWSYYFYXJXJYPT.user.js
// @updateURL https://update.greasyfork.org/scripts/510003/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%85%AC%E5%85%B1%E5%8D%AB%E7%94%9F%E4%B8%8E%E9%A2%84%E9%98%B2%E5%8C%BB%E5%AD%A6%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E7%A7%92%E8%BF%87%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttp%3AdoczhanyccnpagesGGWSYYFYXJXJYPT.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制、自动下一集功能。如需秒过、自动换课程、课程考试答题、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/GGWSYYFYXJXJYPT/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("/course/onlineStudy/")) {
                plugMain.page_video();
            } else if (url.includes("/edu/brand/detail/")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/brand/detailCourse/")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/course/courseDetails/")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/exam/onlineExam")) {
        ...
        async page_video() {
            ...
            plugMain.showPaidContent(`免费版本不包含秒过功能，如需使用请安装收费版本`);
            setTimeout(async () => {
        ...
        nextVideo(waitTime = 10) {
            layer.msg("视频即将结束，等待下一步操作", { time: 10 * 1000 });
            setTimeout(() => {
                if ($(".section-title.active").parent().next().length > 0) {
                    $(".section-title.active").parent().next().find(".section-title").click()
                } else {
                    plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
                }
                $(".section-title.active").parent().next().find(".section-title").click()
