...
// @description RU версия библиотеки GM_config
// @source      https://github.com/ywzhaiqi/GM_config
// @version     1.1

// @copyright   sizzlemctwizzle, RX-3200
...
1. Change to the Chinese "OK" and "Cancel" buttons.
2. Select has added an array of textContents.
3. Added a lot of features, see the example
*/
...
function GM_configInit(config, args) {
    ...
    if (typeof config.fields == "undefined") {
        ...
        config.isOpen = false;
        config.title = 'Настройки пользовательского скрипта';
        config.css = {
            basic: [
            ...
            skin_1: [  // копия стиля Mouseover Popup Image Viewer
                "#GM_config { background: #EEE; }",
                "#GM_config textarea { width: 98%; height: 45px; margin-top: 5px; }",
...
GM_configStruct.prototype = {
    ...
    open: function () {
        ...
        function buildConfigWin (body, head) {
            ...
            for (var id in fields) {
                ...
                if (settings.line == 'start' && lastParentNode) {  // Переключиться на следующую строку
                    lastParentNode = null;
                }
            ...
            bodyWrapper.appendChild(create('div',
                ...
                create('button', {
                    ...
                    title: 'Some options need to be refreshed to take effect',
                ...
                create('button', {
                    ...
                    textContent: 'Отмена',
                    title: 'Отмена этих настроек, все параметры будут восстановлены',
                    className: 'saveclose_buttons',
                    onclick: function () {
                        config.close()
                    }
                ...
                create('div',
                    ...
                    create('a', {
                        ...
                        href: '#',
                        title: 'Восстановить все настройки по умолчанию',
                        className: 'reset',
                        onclick: function (e) {
                            e.preventDefault();
                            config.reset()
    ...
    toTabs: function() {  // Convert to tab form
...
GM_configField.prototype = {
    ...
    toNode: function(configId, lastParentNode) {
        ...
        function addLabel(pos, labelEl, parentNode, beforeEl) {
            if (!beforeEl) {
                beforeEl = lastParentNode ? parentNode.lastChild : parentNode.firstChild;  // oneLine коррекция
            }
        ...
        switch (type) {
            ...
            case 'select':
                ...
                if (Array.isArray(options)) {  // Изменить на object формат
                    var newOptions = {};
