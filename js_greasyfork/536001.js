...
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/536001/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20by%20Myrphyy.user.js
// @updateURL https://update.greasyfork.org/scripts/536001/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20by%20Myrphyy.meta.js
// ==/UserScript==
...
(function () {
 ...
 title: `Закрытие заявок`,
            ...
            `[CENTER] В случае если вы не согласны с решениям Старшей Администрации то составьте свою претензию в раздел «Жалобы на Администрацию».<br><br>`+
             `  [CENTER] [SIZE=7] [URL=https://www.animatedimages.org/cat-lines-562.htm][IMG]https://www.animatedimages.org/data/media/562/animated-line-image-0387.gif[/IMG][/URL] <br>`+
            `[CENTER] [color=#0000FF] ГС ГОСС [URL='https://vk.com/bmw_mka5_e60']*Кликабельно*[/URL] [/color]<br>`+
            `[CENTER] [color=blue] ЗГС ГОСС [URL='https://vk.com/id890485265']*Кликабельно*[/URL] [/color]<br>`+
             `  [CENTER] [SIZE=7] [URL=https://www.animatedimages.org/cat-lines-562.htm][IMG]https://www.animatedimages.org/data/media/562/animated-line-image-0387.gif[/IMG][/URL] <br>`+
           ...
           `[CENTER] [COLOR=red] [FONT=georgia] [SIZE=7] [LIST]
            ...
            `[FONT=georgia][SIZE=6] После одобрение, с вами свяжется ГС ГОСС или ЗГС ГОСС, после вас добавят в специальную беседу. <br>`+
        ...
        },
        {
            ...
            "[CENTER][FONT=georgia]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Благодарим за ваше обращение! С лидером будет проведена профилактическая беседа.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        },
        {
            ...
            "[CENTER][FONT=georgia]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
             `[CENTER] Лидер получит соответствующее наказание.<br>`+
