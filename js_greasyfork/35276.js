...
// @downloadURL https://update.greasyfork.org/scripts/35276/Hotel%20Calls.user.js
// @updateURL https://update.greasyfork.org/scripts/35276/Hotel%20Calls.meta.js
// ==/UserScript==
...
if ($('li:contains("Hotel")').length) {
    ...
    //Answers//
    createButton('No breakfast',0,0,3,3);
    createButton('Free',0,0,0,3);
