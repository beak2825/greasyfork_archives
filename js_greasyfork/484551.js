// ==UserScript==
// @name AudioBookBay hide category: General Fiction
// @description Hide General Fiction category
...
// @downloadURL https://update.greasyfork.org/scripts/484551/AudioBookBay%20hide%20category%3A%20General%20Fiction.user.js
// @updateURL https://update.greasyfork.org/scripts/484551/AudioBookBay%20hide%20category%3A%20General%20Fiction.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact phrase 'General Fiction'
    $(".post").has(".postInfo:contains('General Fiction')").hide();
});
