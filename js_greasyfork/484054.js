...
// @grant        unsafeWindow
// @run-at        document-end
// @downloadURL https://update.greasyfork.org/scripts/484054/MHRoutineAM1.user.js
// @updateURL https://update.greasyfork.org/scripts/484054/MHRoutineAM1.meta.js
// ==/UserScript==
 
// when(time in 24 hours) and how long(hours) for taking rest.must be from large to small hour.
var restTimes = [ [ 19, 1 ], [ 14, 1 ], [ 1, 10 ] ];
