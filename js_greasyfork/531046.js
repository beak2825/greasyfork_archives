...
// @version      1.1.5
// @description  Stellar Odyssey 汉化，9月最新版本，提前适应下个版本更新。
// @author       SakakiChizuru, hewilson
...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/531046/Stellar%20Odyssey%E6%B1%89%E5%8C%96%E6%8F%92%E4%BB%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/531046/Stellar%20Odyssey%E6%B1%89%E5%8C%96%E6%8F%92%E4%BB%B6.meta.js
// ==/UserScript==
...
const simpleTranslationMap = {
    ...
    "Forge": "锻造厂",
    "Trainer": "训练中心",
    "Gives battling boost against NPCs.": "对 NPC 战斗获得加成",
    "Increases credit and resource gains.": "提高信用点与资源获取",
    "Gives a chance to get a XP bonus while crafting items.": "制作物品时有几率获得额外经验",
    "Increases battling and gathering XP": "增加战斗与采集经验获取",
    "Boost": "增幅",
    "Chance": "几率",
    "Maxed": "已最大等级",
    "Bonus PvP zones": "PvP 区域加成",


    // 武器
    "Enhanced Legendary Laser": "强化传奇激光",
    "Enhanced Legendary Probes": "强化传奇探测器",
    "Enhanced Legendary Weapon": "强化传奇武器",
    "Enhanced Legendary Shield": "强化传奇护盾",
    ...
    // 空间站与建筑
    "Station Exploring bonus": "空间站探索加成",
    "Space stations management where you can build an update every space station located on your claimed systems": "空间站管理 —— 在你已占领的星系中，可以建造并升级所属的每一个空间站",
    "Ready to deploy": "可部署",
    "Go to Galaxy Map and claim a system to deploy it": "前往星图，占领一个星系以完成部署",
    "Portal": "传送门",
    "Astronomy": "天文学",
    ...
    "range boost": "范围增幅",
    "Current bonus": "当前加成",
    "exploring boost": "探索增幅",
    "astronomy boost": "天文增幅",
    "portal boost": "传送增幅",
    "Upgrade node": "升级节点",
    "Create a node in a barren body or boost an existing one": "在荒芜天体上创建一个节点，或强化现有节点",
    "It can be only used ten times per space station on different nodes or the same one": "每个空间站最多可使用十次，可作用于不同或同一节点",
    "Times used": "已用次数",
    "Node boost": "节点增幅",
    "Increases 5% Exploring XP and Cosmic Dust gains within the station range per": "在空间站覆盖范围内，每级增加探索经验和宇宙尘收益 5%",
    "Extends the space station range coverage. Base radius 100 ly. Each level adds 10 ly": "扩展空间站覆盖范围。基础半径 100 光年，每级增加 10 光年",
    "Enhances exploration chances to find more bodies and more nodes on new systems within station range": "提升空间站范围内新星系探索时发现天体与节点的几率",
    "Reduces the cost of teleporting between space stations": "降低空间站间传送所需消耗",
    "Stellar Dock": "星际船坞",
    ...
    "from Amplifier": "来自 资源增幅器",
    "from Trainer": "来自 训练中心",
    ...
    "Ferric Mill": "铁质工坊",
    "Prism Nexus": "棱晶枢纽",
    "No laboratory building´s queues pending": "实验室无排队任务",
    "Enhanced Legendary Sensors": "强化传说级传感器",
    "aerolite": "气陨石",
    "Cost": "消耗",
    "Current timer": "当前计时",
    "cryovita": "寒生晶",
    ...
    "Multi-crafting": "多重锻造",
    "Stellarium": "星辰矿石",
    "Modules efficiency": "模块效率",
    "Drop rate": "掉落率",
    "Next drop in": "下一次掉落",
    "Total upkeep cost": "总维护消耗",
    "Stellarium miner": "星辰采矿机",
    "Enabled": "已启用",
    "Upkeep cost": "维护消耗",
    "Turn off": "关闭",
    "Material generator": "材料生成器",
    "Set up": "部署",
    "Metal scrap generator": "金属碎片生成器",
    "Next tick": "下次更新",
    "Resource miner": "资源采集机",
    "Quantum server": "量子服务器",
    "quantum cores": "量子核心",
    "Craftron": "创制机",
    "Fuel facility": "燃料设施",
    "Research lab": "研究实验室",
    "Item booster": "物品增幅器",
    "Laboratory enhancer": "实验室强化器",
    "Battling Trainer (PvP": "战斗训练(PvP",
    "The Craftron 3000 process metal scraps and generates crafting XP": "创制机 3000 处理金属碎片并产生锻造经验",
    "Available Quantum cores": "可用量子核心",
    "Current rate": "当前产出速率",
    "Battling Skills": "战斗技能",
    "battling weapon boost": "武器战力增幅",
    "battling hull boost": "舰体战力增幅",
    "battling precision boost": "精度战力增幅",
    "battling evasion boost": "回避战力增幅",
    "battling base xp boost": "战斗基础经验增幅",
    "Gathering Skills": "采集技能",
    "gathering base xp boost": "采集基础经验增幅",
    "gathering rare base drop": "稀有资源采集增幅",
    "gathering common base drop": "普通资源采集增幅",
    "Exploring Skills": "探索技能",
    "exploring cosmic dust boost": "宇宙尘探索增幅",
    "Crafting Skills": "锻造技能",
    "crafting base xp boost": "锻造基础经验增幅",
    "Pets Skills": "宠物技能",
    "pets base xp boost": "宠物基础经验增幅",
    "Base building Skills": "基地建设技能",
    "base module efficiency boost": "模块效率增幅",
    "Using alien tech you found a way to extract materials from fallen enemies and replicate them over time": "利用外星科技，你可以从击败的敌人身上提取材料并随时间复制",
    "Gathers Stellarium over time. It can be upgraded to obtain higher amounts": "随时间采集星辰矿石，可升级以获得更多",
    "There is a lot of space junk in space. You collect metal scraps over time from nearby junkyards": "太空中漂浮大量废弃物，你可以从附近废料场随时间收集金属碎片",
    "With advanced technolgy you can extract rare resources more efficiently over time": "借助先进技术，你可以随时间更高效地采集稀有资源",
    "Quantum physics enable the generation of quantum cores": "量子物理技术使量子核心生成成为可能",
    "With a proper facility now we can generate fuel in our base and send it to the ship": "有了合适的设施，我们可以在基地生产燃料并输送至舰船",
    "There is a low change of getting anomalies from enemies. Invest to upgrade your chances of getting those. They have a strange effect on your equipment": "敌人掉落异常物的几率较低，投资升级可提升获取概率，它们会对装备产生奇异效果",
    "Improve dropped items from NPCs": "提升 NPC 掉落物品质",
    "You can improve the output of the laboratory buildings to produce more than one material at once": "可提升实验室产出，使其一次生成多种材料",
    "Train your battling skills to boost your PvP badges gains": "训练战斗技能以提升 PvP 徽章获取量",
    ...
    "borrowed item": "借走物品",
    "donated item": "捐献物品",
    "assign user rank": "分配玩家职级",
    "accept application": "接受申请",
    "apply to squadron": "申请加入舰队",
    "Portal already bought or missing requirements": "传送已购买或缺少必要条件",
    "Staff": "员工",
    "days ago": "天之前",
    "Squadron logs": "舰队日志",
    "Log": "日志",
    ...
    "Special purchases": "特殊购买",
    "Find gathering node in a barren body or boost existing one": "在荒芜天体中寻找采集节点，或强化现有节点",
    "Transfer Space Station": "迁移空间站",
    "Move space station to your current location": "将空间站迁移至当前位置",
    "Current location": "当前位置",
    "Transfer to": "迁移到",
    "Transfer": "迁移",
    "Gives multiplicative battling boost against NPCs. Each level gives 5% boost": "对 NPC 战斗提供乘算加成，每级提供 5% 提升",
    "Reduces the cost of teleporting between space stations. Each lvl decreases the cost by": "降低太空站之间传送的花费，每级减少消耗",
    "Each level improves the chance of getting a crafting xp bonus while crafting items by": "每级提升制作物品时获得制作经验加成的几率",
    ...
    "crafting bonus": "制作加成",
    "add member to group": "添加成员到小队",
    "remove member from group": "将成员移出小队",
    "occupied": "占领中",
    "Battle started": "战斗开始",
    "Under attack": "遭受攻击",
    "Bonus is not active now": "当前加成未生效",
    "Not enough PvP Badges": "PvP 徽章不足",
    "Actions in Zone": "区域内可执行操作",
    "Attack": "攻击",
    "Leave": "离开",
    "This zone is already under attack": "该区域已遭受攻击",
    "You cannot leave a zone you do not occupy": "不能离开一个未被你占领的区域",
    "You cannot leave while under attack": "区域在被攻击时无法离开",
    "You already own this zone": "你已占领该区域",
    "This zone has protection": "该区域处于保护状态",
    "You cannot leave the zone while protection is active": "你不能在保护状态被激活时离开该区域",
}
...
const translationRules = [
    ...
    // 兵器库借走时间.
    {
        id: 'tookItAgo',
        conditions: {
            regex: /^(.+?) took it (?:(\d+)|(a|an)) (second|seconds|minute|minutes|hour|hours|day|days) ago$/
        },
        translation: (ruleId, element, regexRes) => {
            const unitMap = {
                second: '秒',
            ...
            const amount = regexRes[2] || (regexRes[3] === 'an' || regexRes[3] === 'a' ? '1' : '');
    ...
    //
    {
        ...
        conditions: {
            hash: '#/tech',
            regex: /h\s+\+1\s+from\s+base\s+\+\s*(\d+)\s*%\s*chance\s+from\s+base/,
        },
        translation: (ruleId, element, regexRes) => {
            if (regexRes[1]) {
                return joinTranslateRes(ruleId, `当前产出速率: 5 /小时 +1 来自基地 +${regexRes[1]}% 额外几率加成来自基地模块.`);
            }
            return "当前产出速率: 5 /小时";
        },
    },//
    ...
    // 短时间
    {
        ...
        translation: (ruleId, element, regexRes) => {
            return joinTranslateRes(ruleId, `天 ${regexRes[1]}时 ${regexRes[2]}分 `);
        },
    },
    // BattleInfo XP
    {
        id: 'battleXP',
        conditions: {
            regex: /^You gained ([0-9,]+) battling XP and$/
        },
        translation: (ruleId, element, regexRes) => {
            return joinTranslateRes(ruleId, `你获得了 ${regexRes[1]} 战斗经验以及 `);
        },
    },
    {
        id: 'extraTax',
        conditions: {
            regex: /^You taxed ([0-9,]+) extra credits from Roller pet$/
        },
        translation: (ruleId, element, regexRes) => {
            return joinTranslateRes(ruleId, `受滚轮兽影响，你的税收额外提升了 ${regexRes[1]} （无中生税）`);
        },
    },
    // 空间站和声望奖励
    {
    ...
    //PVP
    {
        ...
        translation: (ruleId, element, regexRes) => {
            return joinTranslateRes(ruleId, `使用 ${regexRes[3]} 个 PvP 徽章购买 ${regexRes[1]} 个`, translateText(regexRes[2], element));
        }
    },
    {
        id: 'timeCountdown',
        conditions: {
             regex: /^(\d+)h (\d+)m (\d+)s$|^(\d+)h (\d+)m$|^(\d+)m (\d+)s$|^(\d+)s$/
        },
        translation: (ruleId, element, regexRes) => {
            if (regexRes[1] && regexRes[2] && regexRes[3]) {
                return joinTranslateRes(ruleId,`${regexRes[1]}小时 ${regexRes[2]}分 ${regexRes[3]}秒`);
            } else if (regexRes[4] && regexRes[5]) {
                return joinTranslateRes(ruleId,`${regexRes[4]}小时 ${regexRes[5]}分`);
            } else if (regexRes[6] && regexRes[7]) {
                return joinTranslateRes(ruleId,`${regexRes[6]}分 ${regexRes[7]}秒`);
            } else if (regexRes[8]) {
                return joinTranslateRes(ruleId,`${regexRes[8]}秒`);
            }
            return element;
        }
    },
