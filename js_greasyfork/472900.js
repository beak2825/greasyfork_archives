...
// @version      3.2
// @description  自动登录教务系统
// @author       hsc
// @license      GPL Licence
// @connect      *
// @match        *://zhjw.hpu.edu.cn/*
// @icon         https://h5.cyol.com/special/daxuexi/ck6hfr2g0y/images/loading.gif
// @grant        GM_xmlhttpRequest
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_registerMenuCommand
// @downloadURL https://update.greasyfork.org/scripts/472900/%E6%B2%B3%E5%8D%97%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%E6%95%99%E5%8A%A1%E7%B3%BB%E7%BB%9F%E8%87%AA%E5%8A%A8%E7%99%BB%E5%BD%95.user.js
// @updateURL https://update.greasyfork.org/scripts/472900/%E6%B2%B3%E5%8D%97%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%E6%95%99%E5%8A%A1%E7%B3%BB%E7%BB%9F%E8%87%AA%E5%8A%A8%E7%99%BB%E5%BD%95.meta.js
// ==/UserScript==
...
function step1() {
    ...
    //手动添加规则（操作）
    function addRule(){
        var ruleData = {"url": window.location.href.split("?")[0], "img": "", "input": "", "type": "", "captchaType": ""};
        //检测鼠标右键点击事件
        topNotice("请在验证码图片上点击鼠标 “右”👉 键");
        document.oncontextmenu = function(e){
            e = e || window.event;
            e.preventDefault();
            //如果e.target是img标签，则返回img标签的index,如果是canvas标签，则返回canvas标签的index
            ...
            document.onclick = function(e){
                ...
                div.id = "addRuleDiv";
                div.style.cssText = "position:absolute;top:" + e.clientY + "px;left:" + e.clientX + "px;background-color:rgba(255,255,255,1);border:1px solid black;z-index:9999999999;border-radius:5px;padding:5px;";
                ...
                button1.style.cssText = "background-color: rgba(255,255,255,1); width: 40px; font-size: small; margin-left: 10px; color: black; padding: 2px; border-radius: 5px; cursor: pointer;";
                button1.innerHTML = "确定";
                var button2 = document.createElement("button");
                button2.style.cssText = "background-color: rgba(255,255,255,1); width: 40px; font-size: small; margin-left: 10px; color: black; padding: 2px; margin-right: 10px; border-radius: 5px; cursor: pointer;";
    ...
    setTimeout(function(){
     ...
     setTimeout(step2, 2000); // 2000毫秒 = 2秒
}
