...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/512179/Leia-me%20basic%20cheat.user.js
// @updateURL https://update.greasyfork.org/scripts/512179/Leia-me%20basic%20cheat.meta.js
// ==/UserScript==
...
(function() {
    ...
    function createInstructionsOverlay() {
        ...
        overlay.innerHTML = `
            ...
            <p>1. Clique no botão "Iniciar" para começar a passar páginas automaticamente.</p>
            <p>2. O script vai passar pelas páginas usando a tecla 'Arrow Right' (seta para a direita).</p>
            <p>3. Você pode parar o script a qualquer momento clicando no botão "Parar".</p>
            <p>4. Para abrir a IA, clique no botão "IA" e copie o link para abrir em uma guia anônima.</p>
            <p><strong>Pressione 'ESC' para fechar esta tela.</strong></p>
            <label>
                <input type="checkbox" id="rememberChoice" />
                Lembrar minha decisão
            </label>
        `;
