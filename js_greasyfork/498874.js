// // ==UserScript==
// @name         Sochi | Forum Curators Script
// @namespace    https://forum.blackrussia.online
// @version      6.0.0
// @description  Скрипт для Кураторов Форума! Частое обновление! По вопросам писать в ВК https://vk.com/kirillsokol
// @author       Ivan_Tsoi
...
// @downloadURL https://update.greasyfork.org/scripts/498874/Sochi%20%7C%20Forum%20Curators%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/498874/Sochi%20%7C%20Forum%20Curators%20Script.meta.js
// ==/UserScript==
...
"[COLOR=rgb(255, 0, 0)][SIZE=4]2.16. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещен SK (Spawn Kill) — убийство или нанесение урона на титульной территории любой фракции / организации, на месте появления игрока, а также на выходе из закрытых интерьеров и около них[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Jail 60 минут / Warn (за два и более убийства) [/SIZE][/COLOR]<br>" +
    ...
    },
	{
      ...
      content:
        ...
        "[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4] 7.02 [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещено выдавать розыск, штраф без Role Play причины.[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Warn[/SIZE][/COLOR][/FONT]<br><br>" +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA RolePlay.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(0, 255, 255)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил госс.организаций:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        "[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]6.03 [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещено nRP поведение. [/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] [/SIZE][/COLOR][/FONT]<br><br>" +
        "[LIST]<br>" +
        "[*][LEFT][FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]Примечание: [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]поведение, не соответствующее сотруднику УМВД. Пример:- открытие огня по игрокам без причины,- расстрел машин без причины,- нарушение ПДД без причины,- сотрудник на служебном транспорте кричит о наборе в свою семью на спавне..[/SIZE][/COLOR][/FONT][/LEFT]<br>" +
        "[LIST]<br>" +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA RolePlay.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(0, 255, 255)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
      prefix: ACCEPT_PREFIX,
...

    {
      ...
      content:
        ...
        'Приятной игры на BLACK RUSSIA RolePlay[/I][/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: PIN_PREFIX,
      status: true,
    },
    {
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию - [/I][URL='https://forum.blackrussia.online/index.php?forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.1232/']*нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
	...
	{
     title: 'Не добав.тайм-код',
     content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]В связи с тем, что вы не добавили тайм-коды к доказательствам в отведённое для этого время, ваша жалоба отказана.[/I][/SIZE][/FONT]<br><br>" +
        "[I][FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA RolePlay.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
	{
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил проекта:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        "[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]4.04 [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещено редактировать поданные объявления в личных целях заменяя текст объявления на несоответствующий отправленному игроком.[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | | Jail 30 минут [/SIZE][/COLOR][/FONT]<br><br>" +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA RolePlay.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(0, 255, 255)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
      prefix: ACCEPT_PREFIX,
      status: false,
    ...
    content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/IMG]<br>"+
       "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к. она написана от 3-го лица. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
         "[CENTER][IMG width=695px]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA RolePlay.[/COLOR][/I][/SIZE][/FONT]',
      prefix: UNACCEPT_PREFIX,
...
$(document).ready(() => {
    ...
    $(`button#selectAnswer`).click(() => {
        XF.alert(buttonsMarkup(buttons), null, 'Выберите вердикт by @kirillsokol | Valdemar_Shprot + Valdemar_Teremkov =  ❤️ 💋');
