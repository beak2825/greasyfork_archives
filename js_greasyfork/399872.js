// ==UserScript==
// @name         DB9 Better Torrent Detail Page Info Columns (BassStage Stylesheet Version)
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/399872/DB9%20Better%20Torrent%20Detail%20Page%20Info%20Columns%20%28BassStage%20Stylesheet%20Version%29.user.js
// @updateURL https://update.greasyfork.org/scripts/399872/DB9%20Better%20Torrent%20Detail%20Page%20Info%20Columns%20%28BassStage%20Stylesheet%20Version%29.meta.js
// ==/UserScript==
...
(() => {
  ...
  const addCss = (() => {
    ...
    const stylesheetIsBassStage = !!doc.querySelector('link[href*="ruk4.github.io/db9/bassstage"]')

    if (stylesheetIsBassStage) {
      style.innerHTML += `
        .group_torrent:not(.edition) td:first-child {
          padding-left: 0px !important;
        }

        a#download:after, a#token:after, a#report:after, a#permalink:after, a#editor:after, a#remove:after {
          padding: 0 2px;
        }
      ...
      const exclusives = [...document.querySelectorAll('.group_torrent strong')]
      exclusives.forEach(exclusive => exclusive.textContent = exclusive.textContent.replace('DB9 ', ''))
    }
