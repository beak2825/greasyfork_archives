...
// @downloadURL https://update.greasyfork.org/scripts/425747/Tag%20Checker.user.js
// @updateURL https://update.greasyfork.org/scripts/425747/Tag%20Checker.meta.js
// ==/UserScript==
...
function parsePage() {
    ...
    switch (PAGE_TYPE) {
        ...
        case "user":
            ...
            $('body > form > table > tbody > tr > td:nth-child(1) > dl:nth-child(1)').append(`<dl><dt>Bar & Pub Status</dt><dd><div class="p3 ce"><div id="pokerstatus_${userid}"><i>Loading...</i></div></div></dd></dl>`);
            $('body > table > tbody > tr > td:nth-child(1) > dl:nth-child(1)').append(` <dl><dt>Bar & Pub Status</dt><dd><div class="p3 ce"><div id="pokerstatus_${userid}"><i>Loading...</i></div></div></dd></dl>`);
            break;
        case 'guild':
