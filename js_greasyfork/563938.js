// ==UserScript==
// @name         Letterboxd to Multi-Search (v4.8)
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/563938/Letterboxd%20to%20Multi-Search%20%28v48%29.user.js
// @updateURL https://update.greasyfork.org/scripts/563938/Letterboxd%20to%20Multi-Search%20%28v48%29.meta.js
// ==/UserScript==
        ...
        if (target) {
            ...
            if (filmTitle) {
                ...
                buttonsHtml += `
                    ...
                    <a href="https://www.gaytor.rent/search.php?search=${encodedTitle}" target="_blank" style="${btnBaseStyle} background: #7b1fa2;">Gaytor</a>
                    <a href="https://pinklabel.tv/on-demand/film-search/title/${encodedTitle}" target="_blank" style="${btnBaseStyle} background: #ff00ff;">PinkLabel</a>
                `;
            }
