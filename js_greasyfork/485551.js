// ==UserScript==
// @name         Kotar Books Downloader
// @namespace    https://greasyfork.org/en/users/85671-jcunews
// @version      1.0.1
// @license      AGPL v3
// @author       jcunews
// @description  Add link to download Kotar Books pages into a ZIP file including a book viewer HTML application for use with a web browser (use web browser's zoom feature to zoom in/out pages). Note: that site limits only the first 15 pages for non-free books.
// @match        https://school.kotar.cet.ac.il/KotarApp/Viewer.aspx*
// @match        https://kotar-cet-ac-il.eu1.proxy.openathens.net/KotarApp/Viewer.aspx*
...
// @downloadURL https://update.greasyfork.org/scripts/485551/Kotar%20Books%20Downloader.user.js
// @updateURL https://update.greasyfork.org/scripts/485551/Kotar%20Books%20Downloader.meta.js
// ==/UserScript==
