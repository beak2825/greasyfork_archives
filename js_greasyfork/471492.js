...
// @name:zh-CN     拖拽打开
// @namespace      ASH
// @description    drag open
// @description:zh-CN  鼠标拖拽功能。仅支持拖拽[文本]、[链接]和[图片]
// @version      1.00
// @include      *
// @match        *
// @noframes
...
// @license      GPL-3.0
// @downloadURL https://update.greasyfork.org/scripts/471492/DragOpen.user.js
// @updateURL https://update.greasyfork.org/scripts/471492/DragOpen.meta.js
// ==/UserScript==
/* jshint esversion: 6 */
...
//===============================================================
//Thanks:    黄盐's userscript mouseplus
//           https://greasyfork.org/zh-CN/scripts/35466-mouseplus
  ...
  let storage = {
    ...
    _cfg = {
      ...
      link: {         // drag link
        ...
        "2":  {name:"copyLink",   arg:[]},
        "4":  {name:"copyLink",   arg:[]},
        "24": {name:"copyLink",   arg:[]},
        "42": {name:"copyLink",   arg:[]},
        "6":  {name:"openLink",   arg:[]},
        "0":  {name:"openLinkInBack", arg:[]}
      },
      image: {         // drag image
        "8": {name:"saveImg",    arg:[]},
    ...
    Fn = {
      ...
      openLinkInBack: function(argumentArr, data) {
        //TamperMonkey
        GM_openInTab(getLink(data), {
          active: false
        });
    ...
    local = {
      ...
      link:{
        ...
        openLinkInBack:  {zh:'后台打开',         en:'Open Link In back'},
 ...
 function getLink(data){
  ...
  function getDragFn(data){
    ...
    if(data.target.nodeName === "IMG")
      ...
      return ['link', cfg.link[data.gesture] ? cfg.link[data.gesture] : cfg.link[0]];
    else
