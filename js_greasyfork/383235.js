...
// @match        https://steamcommunity.com/market/listings/730/Glock-18%20%7C%20Moonrise*
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/383235/Glock-18%20%7C%20Moonrise.user.js
// @updateURL https://update.greasyfork.org/scripts/383235/Glock-18%20%7C%20Moonrise.meta.js
// ==/UserScript==
...
//
var sed=[31,58,59,66,90,95,102,121,165,194,237,281,355,385,448,484,487,509,617,630,667,769,837,913,958,968,986];
function c() {
...
if(seed==sed[j]){
    ...
    document.getElementsByClassName('market_listing_item_name')[i].innerHTML="RARE STAR";
}
            }
        }
