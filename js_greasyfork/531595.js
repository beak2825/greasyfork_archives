...
// @downloadURL https://update.greasyfork.org/scripts/531595/Black%2010%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/531595/Black%2010%20Script.meta.js
// ==/UserScript==
...
(function () {
    ...
    },
    {
        ...
        content:
        "[CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER]<br><br>"+
        "[CENTER] [COLOR=AQUA][ICODE] После тщательной проверки поданной жалобы в отношении администратора будут приняты соответствующие меры. Благодарим вас за информацию. [/ICODE][/COLOR][/CENTER]<br><br>"+
        "[CENTER] [COLOR=AQUA][ICODE] Закрыто [/ICODE][/COLOR][/CENTER]<br><br>"+
        '[CENTER] [COLOR=AQUA][ICODE] Приятной игры на нашем сервере.  [/ICODE][/COLOR] [/CENTER]',
