...
// @version        1.7.9
// @description    SGv2 Dark style with a settings menu to customize steamgifts.com and steamtrades.com and sgtools.info. Compatible with most scripts found in the addon registry
...
// @downloadURL https://update.greasyfork.org/scripts/7852/SGv2%20Dark.user.js
// @updateURL https://update.greasyfork.org/scripts/7852/SGv2%20Dark.meta.js
// ==/UserScript==
...
var CustomColorsConfig = (function () {
    function CustomColorsConfig(callback) {
        ...
        var optionline = function (optionName, inputType, id) {
            ...
            return $('<div class="SGv2_Dark__Option" id="' + id + '"><span class="form__heading__text">' + optionName + '</span></div>').append(input);
        };
        var options=[["Settings","text"],["Image Opacity","text","210"],["Page Background","color","260"],["Heading/Giveaway Name Text","color","190"],["Links","color","230"],["Content Background","color","80"],["Comment Children Background","color","70"],["Sidebar/Breadcrumbs Text","color","370"],["General Text","color","130"],["Secondary Text","color","310"],["Sidebar/Table Heading Text","color","380"],["Input Background","color","220"],["Table Heading Background","color","400"],["Giveaway Columns Background","color","140"],["Image background","color","205"],["Page Heading/Menus Background","color","265"],["Sidebar Background","color","360"],["Developer Giveaway Background","color","100"],["Green Buttons Background","color","150"],["red Buttons Background","color","280"],["Yellow Buttons Background","color","490"],["Silver Buttons Background","color","390"],["Group Button Background","color","170"],["Whitelist Button Background","color","480"],["Text Shadows","color","410"],["Text Shadow Opacity","text","420"],["Content Opacity","text","90"],["Header/Footer Background","color","180"],["Nav Button Background","color","240"],["Background Image Opacity","text","40"],["Background Image Brightness","text","30"],["Background Image Blur","text","20"],["Background Image Saturation","text","50"],["Background Image","text","10"],["Shadows","color","340"],["Shadow Opacity","text","350"],["Green Icons/Text","color","160"],["Red Icons/Text","color","290"],["Featured Background","color","110"],["Visited Threads","color","470"],["Colored Name/Level","text","60"],["Trade Have Background","color","450"],["Trade Want Background","color","460"],["Navigation Text","color","250"],["Selection Highlight Background","color","320"],["Selection Highlight Text","color","330"],["Scrollbar","color","300"],["Featured Background Image","text","120"],["Tooltip Background","color","430"],["Tooltip Text","color","440"],["Page Width SG","text","266"],["Button Hover Brightness","text","51"],["Nav Button Hover Brightness","text","245"],["Nav Button Hover Saturation","text","248"],["Code Background","color","57"],["Code Text","color","58"],["List Text","color","235"],["Blockquote Background","color","52"],["Blockquote Text","color","53"],["Poll Background","color","272"],["Chart Background","color","54"],["Chart Heading Text","color","55"],["Heading Size 1 Text","color","192"],["Heading Size 2 Text","color","195"],["Heading Size 3 Text","color","198"],["Poll Text","color","274"],["Poll Question Text","color","277"],["Row Hover Brightness","text","295"],["Chart Text","color","56"],["Background Image Use GPU","text","15"],['Modal Background','color','238'],['Enter Buttons Green Background','color','104'],['Enter Buttons Red Background','color','105'],['Enter Buttons Yellow Background','color','106'],['Notification Blue Background','color','253'],['Notification Green Background','color','254'],['Notification Grey Background','color','255'],['Notification Red Background','color','256'],['Notification Yellow Background','color','257'],["Page Width ST","text","267"],["Hotkeys Enabled","text","200"],["Page Width SGT","text","268"]];
        var optionLength = options.length;
        var SGv2Options =[];
        for (var i = 0; i < optionLength ; i++) {
            SGv2Options.push((optionline(options[i][0], options[i][1], options[i][2], options[i][3], options[i][4], options[i][5], options[i][6], options[i][7], options[i][8], options[i][9], options[i][10], options[i][11], options[i][12], options[i][13], options[i][14], options[i][15], options[i][16], options[i][17], options[i][18], options[i][19], options[i][20], options[i][21], options[i][22], options[i][23], options[i][24], options[i][25], options[i][26], options[i][27], options[i][28], options[i][29], options[i][30], options[i][31], options[i][32], options[i][33], options[i][34], options[i][35], options[i][36], options[i][37], options[i][38], options[i][39], options[i][40], options[i][41], options[i][42], options[i][43], options[i][44], options[i][45], options[i][46], options[i][47], options[i][48], options[i][49], options[i][50], options[i][51], options[i][52], options[i][53], options[i][54], options[i][55], options[i][56], options[i][57], options[i][58], options[i][59], options[i][60], options[i][61], options[i][62], options[i][63], options[i][64], options[i][65], options[i][66], options[i][67], options[i][68], options[i][69], options[i][70], options[i][71], options[i][72], options[i][73], options[i][74], options[i][75], options[i][76], options[i][77], options[i][78], options[i][79], options[i][80])));
        }
        SGv2Options.splice(0,1);
        SGv2Options.sort(function (a, b) {
            return +a[0].id - +b[0].id;
        });
        $('#SGv2_Dark__OptionsContainer-1').append(SGv2Options.slice(0, 30)); $('#SGv2_Dark__OptionsContainer-2').append(SGv2Options.slice(30, 60)); $('#SGv2_Dark__OptionsContainer-3').append(SGv2Options.slice(60, 90));
        ...
        $('.SGv2_Dark__config input').change(function () {
            ...
            addButtonCss('Temp Button', args, 'SGv2 Temp');
        });
...
'221': Color(config[57], 0, 0, 0, 0.3), '222': Color(config[59], 0, 0, 0, (config[26])), '223': Color(config[59], 0, 0, 13), '224': Color(config[59], 0, -4, 4), '225': Color(config[59], 0, 0, -7), '226': Color(config[59], 0, 0, 12), '227': Color(config[60], 0, 2, 3, (+config[26]+ (-0.35))), '228': Color(config[60], 0, 2, 17), '229': Color(config[59], 0, 0, 17), '230': Color(config[60], 0, 2, 8), '231': Color(config[65], 0, 0, -4), '232': Color(config[66], 0, -6, -15), '233': Color(config[37], 0, -14, -5), '234': Color(config[28], 0, 1, -8), '235': Color(config[28], 0, -100, -8), '236': Color(config[22], -3, -14, 1),'237': Color(config[22], 3, -10, -9), '238': Color(config[22], 0, 0, -20), '239': Color(config[22], -3, 12, 17), '240': Color(config[22], 0, 7, -5), '241': Color(config[22], -3, 24, 25), '242': Color(config[22], -3, 30, 35), '243': Color(config[28], 0, 7, 3), '244': Color(config[34], 0, 0, 0, 1), '249': Color(config[23], 0, -3, 39), '256': Color(config[21], 0, 0, 35), '258': Color(config[18], -3, -16, 3), '261': Color(config[18], 3, -11, 16), '265': Color(config[21], 0, 0, 9), '271': Color(config[21], 0, 0, 30), '272': Color(config[11], 0, 0, 46), '273': Color(config[8], 0, 0, 12),'275': Color(config[5], 0, 0, 3), '276': Color(config[5], 0, 0, 16), '286': Color(config[8], 0, 0, 5), '287': Color(config[5], 0, 0, 69), '288': Color(config[21], 0, 0, 42), '289': Color(config[21], 0, 0, 43), '290': Color(config[21], 0, 0, -3), '291': Color(config[21], 0, 0, 7), '292': Color(config[23], 0, -2, 44), '293': Color(config[23], 0, 8, 4) , '294': Color(config[23], 0, 5, -4), '295': Color(config[23], 0, -8, -19),
'296': Color(config[23], 0, -18, -7), '297': Color(config[23], 0, -22, -4), '298': Color(config[23], 0, -8, 11), '299': Color(config[2], 0, -15, 7, 1), '300': Color(config[71], 3, -15, 52, 0.9), '301': Color(config[72], 0, 45, 50), '302': Color(config[73], 6, 11, 35), '303': Color(config[71], -4, -13, 25), '304': Color(config[71], -4, 2, 9), '305': Color(config[71], 0, 2, 5), '306': Color(config[73], -3, 16, 22), '307': Color(config[73], -3, 3, 7), '308': Color(config[73], -3, 17, -10), '309': Color(config[72], 0, 11, 32), '310': Color(config[72], 0, -9, 15), '311': Color(config[72], 0, 2, 7), '312': Color(config[74], 0, 0, 0, 0.23), '313': Color(config[74], 0, 7, -20, 0.9), '314': Color(config[75], 0, 0, 0, 0.14), '315': Color(config[75], 0, 7, -23, 0.63), '316': Color(config[76], 0, 0, 0, 0.2), '317': Color(config[76], 0, 7, -6, 0.9), '318': Color(config[77], 0, 0, 0, 0.23), '319': Color(config[77], 0, 7, -20, 0.9), '320': Color(config[78], 0, 0, 0, 0.23), '321': Color(config[78], 0, 7, -20, 0.9), '322': Color(config[44], 0, 0, 13, 0.5), '323': Color(config[74], 0, 35, -14), '324': Color(config[74], 0, 0, 30), '325': Color(config[75], 0, 25, -17, 0.7), '326': Color(config[75], 0, 6, 30, 0.8), '327': Color(config[76], 0, 0, 6, 1), '328': Color(config[76], 0, 0, 41, 0.95), '329': Color(config[77], 0, 35, -17, 1), '330': Color(config[77], 0, 10, 32, 1), '331': Color(config[78], 0, 35, -17, 1), '332': Color(config[78], 0, -4, 34, 0.9)};
                config.push('SGv2 Dark Version ' + version + '');
                return config;
            };
    }
...
:root {
    --SGSP-body-bg-color: ${config[2]};
    --SGSP-body-bg-image: url(${config[33]});
    --SGSP-button-hover-brightness: brightness(${config[51]});
    --SGSP-chart-bg-color: ${config[0][227]};
    --SGSP-chart-border-color: ${config[0][228]};
    --SGSP-chart-head-bg-color: ${config[0][230]};
    --SGSP-chart-head-border-color: ${config[0][228]};
    --SGSP-chart-head-txt-color: ${config[61]};
    --SGSP-chart-row-bg-color: ${config[0][227]};
    --SGSP-chart-row-txt-color: ${config[68]};
    --SGSP-code-bg-color: ${config[54]};
    --SGSP-code-border-color: ${config[0][220]};
    --SGSP-code-txt-color: ${config[55]};
    --SGSP-content-bg-color: ${config[0][8]} ;
    --SGSP-content-border-color: ${config[0][24]};
    --SGSP-content-inner-bg-color: ${config[0][205]};
    --SGSP-content-inner-border-color: ${config[0][206]};
    --SGSP-featured-bg-color: ${config[0][173]};
    --SGSP-featured-border-color: ${config[0][244]};
    --SGSP-featured-giveaway-bg-gradient: linear-gradient(${config[0][173]} 0%, ${config[0][172]} 100%);
    --SGSP-featured-home-bg-gradient: linear-gradient(${config[0][173]} 0%, ${config[0][172]} 100%);
    --SGSP-featured-user-bg-gradient: linear-gradient(${config[0][173]} 0%, ${config[0][172]} 100%);
    --SGSP-enter-green-buttons-bg-color: linear-gradient(${config[71]} 0%, ${config[71]} 100%);
    --SGSP-enter-green-buttons-txt-color: ${config[0][300]};
    --SGSP-enter-red-buttons-bg-color: linear-gradient(${config[72]} 0%, ${config[72]} 100%);
    --SGSP-enter-red-buttons-txt-color: ${config[0][301]};
    --SGSP-enter-yellow-buttons-bg-color: linear-gradient(${config[73]} 0%, ${config[73]} 100%);
    --SGSP-enter-yellow-buttons-txt-color: ${config[0][302]};
    --SGSP-general-txt-color: ${config[8]};
    --SGSP-giveaway-columns-bg-color: linear-gradient(${config[13]} 0, ${config[0][40]} 100%);
    --SGSP-giveaway-columns-border-color: ${config[0][41]} ${config[0][42]} ${config[0][39]};
    --SGSP-giveaway-columns-boxshadow-color: ${config[0][42]};
    --SGSP-green-buttons-bg-color: linear-gradient(${config[0][63]} 0%, ${config[18]} 50%, ${config[0][64]} 100%);
    --SGSP-green-buttons-txt-color: ${config[0][112]};
    --SGSP-green-buttons-border-color: ${config[0][65]} ${config[0][66]} ${config[0][67]} ${config[0][66]};
    --SGSP-green-icons-txt-color: ${config[0][155]};
    --SGSP-grid-brightness: brightness(${(+config[1]+ (-0.1))});
    --SGSP-grid-hover-brightness: brightness(${(+config[1]+ (0.1))});
    --SGSP-grid-popout-bg-color: ${config[14]};
    --SGSP-grid-popout-border-color: ${config[0][50]};
    --SGSP-group-bg-color: linear-gradient(${config[0][236]} 0%, ${config[0][237]} 50%, ${config[0][238]} 100%);
    --SGSP-group-border-color: ${config[22]};
    --SGSP-group-txt-color: ${config[0][241]};
    --SGSP-header-footer-bg-color: linear-gradient(${config[0][21]} 0%, ${config[0][20]} 100%);
    --SGSP-header-footer-border-color: ${config[0][141]};
    --SGSP-headings-size1-txt-color: ${config[62]};
    --SGSP-headings-size2-txt-color: ${config[63]};
    --SGSP-headings-size3-txt-color: ${config[64]};
    --SGSP-headings-txt-color: ${config[10]};
    --SGSP-image-bg-color: ${config[14]};
    --SGSP-image-border-color: ${config[0][50]};
    --SGSP-image-brightness: brightness(${config[1]});
    --SGSP-image-filters: blur(${clamp(config[31], 0, 2)}px) brightness(${config[30]}) opacity(${config[29]}) saturate(${config[32]});
    --SGSP-input-bg-color: ${config[11]};
    --SGSP-input-border-color: ${config[0][160]};
    --SGSP-invite-bg-color: linear-gradient(${config[0][25]} 0%, ${config[21]} 50%, ${config[0][128]} 100%);
    --SGSP-invite-border-color: ${config[0][27]} ${config[0][28]} ${config[0][135]} ${config[0][28]};
    --SGSP-invite-txt-color: ${config[0][256]};
    --SGSP-link-txt-color: ${config[4]};
    --SGSP-list-txt-color: ${config[56]};
    --SGSP-modal-bg-color: ${config[70]};
    --SGSP-nav-button-bg-color: linear-gradient(${config[0][17]} 0, ${config[28]} 5px, ${config[0][19]} 100%);
    --SGSP-nav-button-hover-brightness: brightness(${config[52]});
    --SGSP-nav-button-hover-saturate: saturate(${config[53]});
    --SGSP-nav-dropdown-bg-color: linear-gradient(${config[15]} 0%, ${config[0][16]} 100%);
    --SGSP-nav-dropdown-border-color: ${config[0][10]};
    --SGSP-nav-dropdown-hover-bg-color: var(--SGSP-nav-button-bg-color);
    --SGSP-nav-txt-color: ${config[43]};
    --SGSP-notification-blue-bg-color: linear-gradient(${config[0][312]} 0%, ${config[0][313]} 100%)!important;
    --SGSP-notification-blue-border-color: ${config[0][323]};
    --SGSP-notification-blue-txt-color: ${config[0][324]};
    --SGSP-notification-green-bg-color: linear-gradient(${config[0][314]} 0%, ${config[0][315]} 100%)!important;
    --SGSP-notification-green-border-color: ${config[0][325]};
    --SGSP-notification-green-txt-color: ${config[0][326]};
    --SGSP-notification-grey-bg-color: linear-gradient(${config[0][316]} 0%, ${config[0][317]} 100%)!important;
    --SGSP-notification-grey-border-color: ${config[0][327]};
    --SGSP-notification-grey-txt-color: ${config[0][328]};
    --SGSP-notification-red-bg-color: linear-gradient(${config[0][318]} 0%, ${config[0][319]} 100%)!important;
    --SGSP-notification-red-border-color: ${config[0][329]};
    --SGSP-notification-red-txt-color: ${config[0][330]};
    --SGSP-notification-yellow-bg-color: linear-gradient(${config[0][320]} 0%, ${config[0][321]} 100%)!important;
    --SGSP-notification-yellow-border-color: ${config[0][331]};
    --SGSP-notification-yellow-txt-color: ${config[0][332]};
    --SGSP-page-width: ${config[50] === `1` ? `1400px` : `100%`};
    --SGSP-page-width-st: ${config[79] === `1` ? `1321px` : `100%`};
    --SGSP-page-width-sgt: ${config[81] === `1` ? `1300px` : `100%`};
    --SGSP-pageheading-bg-color: linear-gradient(${config[0][170]} 0%, ${config[0][60]} 100%);
    --SGSP-pageheading-border-color: ${config[0][61]} ${config[15]} ${config[0][62]} ${config[15]};
    --SGSP-pageheading-txt-color: ${config[7]};
    --SGSP-pinned-bg-color: linear-gradient(${config[0][5]} 0%, ${config[0][83]} 100%);
    --SGSP-pinned-border-color: ${config[0][84]};
    --SGSP-poll-bg-color: ${config[0][222]};
    --SGSP-poll-border-color: var(--SGSP-content-border-color);
    --SGSP-poll-heading-bg-color: ${config[0][224]};
    --SGSP-poll-heading-border-color: ${config[0][223]};
    --SGSP-poll-heading-txt-color: var(--SGSP-headings-txt-color);
    --SGSP-poll-row-txt-color: ${config[65]};
    --SGSP-quote-bg-color: ${config[0][221]};
    --SGSP-quote-border-color: ${config[0][105]};
    --SGSP-quote-txt-color: ${config[58]};
    --SGSP-red-buttons-bg-color: linear-gradient(${config[0][77]} 0%, ${config[19]}  50%, ${config[0][78]} 100%);
    --SGSP-red-buttons-border-color: ${config[0][95]} ${config[0][96]} ${config[0][97]} ${config[0][96]};
    --SGSP-red-buttons-txt-color: ${config[0][99]};
    --SGSP-red-suspension-bot-bg-color: linear-gradient(${config[19]} 18%, ${config[0][78]} 100%);
    --SGSP-red-suspension-top-bg-color: linear-gradient(${config[0][77]} 0%, ${config[19]}  80%, ${config[0][78]} 200%);
    --SGSP-red-icons-txt-color: ${config[37]};
    --SGSP-reply-bg-color: ${config[0][6]};
    --SGSP-reply-border-color: ${config[0][34]};
    --SGSP-row-hover-color: brightness(${config[67]});
    --SGSP-scrollbar-bg-color: ${config[0][176]};
    --SGSP-scrollbar-hover-bg-color: ${config[0][178]};
    --SGSP-scrollbar-thumb-bg-color: ${config[46]};
    scrollbar-color: ${config[46]} ${config[0][176]};
    --SGSP-secondary-txt-color: ${config[9]};
    --SGSP-select-highlight-color: ${config[45]};
    --SGSP-select-highlight-bg-color: ${config[0][322]};
    --SGSP-separator-dark-color: ${config[0][37]};
    --SGSP-separator-hover-color: ${config[0][57]};
    --SGSP-separator-light-color: ${config[0][38]};
    --SGSP-sgtool-content-bg-color: var(--SGSP-content-bg-color);
    --SGSP-sgtool-total-bg-color: var(--SGSP-pinned-bg-color);
    --SGSP-sidebar-bg-color: ${config[0][144]};
    --SGSP-sidebar-border-color: ${config[0][147]};
    --SGSP-sidebar-link-bg-color: var(--SGSP-pageheading-bg-color);
    --SGSP-sidebar-link-border-color: var(--SGSP-pageheading-border-color);
    --SGSP-sidebar-link-txt-color: ${config[7]};
    --SGSP-silver-buttons-bg-color: linear-gradient(${config[0][120]} 0%, ${config[0][121]} 100%);
    --SGSP-silver-buttons-border-color: ${config[0][122]} ${config[0][123]} ${config[0][124]} ${config[0][123]};
    --SGSP-silver-buttons-txt-color: ${config[0][31]};
    --SGSP-spoiler-bg-color: ${config[0][38]};
    --SGSP-tableheading-bg-color: ${config[12]};
    --SGSP-tableheading-border-color: ${config[0][24]};
    --SGSP-tooltip-bg-color: ${config[48]};
    --SGSP-tooltip-border-color: ${config[0][186]};
    --SGSP-tooltip-txt-color: ${config[49]};
    --SGSP-trade-have-bg-color: ${config[0][109]};
    --SGSP-trade-have-border-color: ${config[0][108]};
    --SGSP-trade-have-title-color: ${config[0][108]};
    --SGSP-trade-want-bg-color: ${config[0][110]};
    --SGSP-trade-want-border-color: ${config[0][111]};
    --SGSP-trade-want-title-color: ${config[0][111]};
    --SGSP-visited-txt-color: ${config[39]};
    --SGSP-whitelist-bg-color: linear-gradient(${config[0][193]} 0%, ${config[0][195]} 100%);
    --SGSP-whitelist-border-color: ${config[23]};
    --SGSP-whitelist-txt-color: ${config[0][198]};
    --SGSP-yellow-buttons-bg-color: linear-gradient(${config[0][52]} 0%, ${config[0][54]} 100%);
    --SGSP-yellow-buttons-border-color: ${config[0][103]} ${config[0][56]} ${config[0][104]} ${config[0][56]};
    --SGSP-yellow-buttons-txt-color: ${config[0][51]};
    ...
    --esgst-inner-panel-border-color: ${config[0][50]};
    ...
    --esgst-modal-bg-color: ${Color(config[70], 0, 0, 0, 0.85)};

    --SGSP-ts-1: 0 0 2px ${config[0][12]};
    --SGSP-ts-2: 0 0 3px ${config[0][10]} !important;
    --SGSP-ts-3: 0 0 5px ${config[0][12]}, 1px 1px ${config[0][10]};
    --SGSP-ts-4: 1px 1px ${config[0][12]} !important;
    --SGSP-ts-5: 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]}, 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]}, 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]} !important;
    --SGSP-ts-6: 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]}, 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]}, 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]};
    --SGSP-ts-7: 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]}, 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]};
    --SGSP-ts-8: 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]};
    --SGSP-ts-9: 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]} !important;
    --SGSP-ts-10: 0 1px ${config[0][10]}, 0 -1px ${config[0][10]}, 1px 0 ${config[0][10]}, -1px 0 ${config[0][10]}, 1px 1px ${config[0][10]};
    --SGSP-ts-11: 0 2px ${config[0][10]}, 0 -2px ${config[0][10]}, 2px 0 ${config[0][10]}, -2px 0 ${config[0][10]};
    --SGSP-ts-12: 1px 1px 0 ${config[0][11]}, 0 0 2px ${config[0][10]};
    --SGSP-ts-13: 1px 1px 0 ${config[0][10]} !important;
    --SGSP-ts-14: 1px 1px 1px ${config[0][15]}, -1px 1px 1px ${config[0][15]};
    --SGSP-ts-15: 1px 1px 1px ${config[0][11]}, 0 0 1px ${config[0][12]};
    --SGSP-ts-16: 1px 1px 1px ${config[0][11]}, 0 0 1px ${config[0][12]} !important;
    --SGSP-ts-17: 1px 1px 1px ${config[0][11]}, 0 0 1px ${config[0][12]};
    --SGSP-ts-18: 1px 1px 1px ${config[0][10]} !important;
    --SGSP-ts-19: 1px 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-20: 1px 1px 1px ${config[0][10]}, 0 0 2px ${config[0][10]};
    --SGSP-ts-21: 1px 1px 1px ${config[0][10]} !important;
    --SGSP-ts-22: 1px 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-23: 1px 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-24: 1px 1px 1px ${config[0][10]}, 0 0 2px ${config[0][10]} !important;
    --SGSP-ts-25: 1px 1px 1px ${config[0][10]}, 0 0 2px ${config[0][10]};
    --SGSP-ts-26: 1px 1px 1px ${config[0][10]}, 1px 1px 2px ${config[0][14]};
    --SGSP-ts-27: 1px 1px 1px ${config[0][10]}, 1px 1px 2px ${config[0][13]};
    --SGSP-ts-28: 1px 1px 1px ${config[0][10]}, 1px 1px 2px ${config[0][11]};
    --SGSP-ts-29: 1px 1px 1px ${config[0][10]};
    --SGSP-ts-30: 1px 1px 1px ${config[0][10]};
    --SGSP-ts-31: 1px 1px ${config[0][13]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-32: 1px 1px ${config[0][13]}, 0 0 2px ${config[0][10]} !important;
    --SGSP-ts-33: 1px 1px ${config[0][13]}, 0 0 2px ${config[0][10]} !important;
    --SGSP-ts-34: 1px 1px ${config[0][11]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-35: 1px 1px ${config[0][11]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-36: 1px 1px ${config[0][11]}, 0 0 2px ${config[0][12]};
    --SGSP-ts-37: 1px 1px ${config[0][11]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-38: 1px 1px ${config[0][11]}, 0 0 2px ${config[0][10]};
    --SGSP-ts-39: 1px 1px ${config[0][11]};
    --SGSP-ts-40: 1px 1px ${config[0][12]} !important;
    --SGSP-ts-41: 1px 1px ${config[0][12]};
    --SGSP-ts-42: 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-43: 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-44: 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-45: 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-46: 1px 1px ${config[0][10]}, 0 1px ${config[0][10]}, 1px 0 ${config[0][10]}, 0 -1px ${config[0][10]}, -1px 0 ${config[0][10]} !important;
    --SGSP-ts-47: 1px 1px ${config[0][10]}, 0 1px ${config[0][10]}, 1px 0 ${config[0][10]}, 0 -1px ${config[0][10]}, -1px 0 ${config[0][10]};
    --SGSP-ts-48: 1px 1px ${config[0][10]}, 1px 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-49: 1px 1px ${config[0][10]}, -1px -1px ${config[0][10]}, -1px 0 ${config[0][10]}, 0 -1px ${config[0][10]} !important;
    --SGSP-ts-50: 1px 1px ${config[0][10]} !important;
    --SGSP-ts-51: 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-52: 1px 1px ${config[0][10]}, 0 0 2px ${config[0][10]};
    --SGSP-ts-53: 1px 1px ${config[0][10]}, 1px 1px 2px ${config[0][10]};
    --SGSP-ts-54: 1px 1px ${config[0][10]};
    --SGSP-ts-55: 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-56: 2px 2px 2px ${config[0][10]}, 1px 1px ${config[0][10]};
    --SGSP-ts-57: -1px 1px ${config[0][10]}, 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-58: 1px 1px ${config[0][12]};
    --SGSP-ts-59: -1px 1px ${config[0][10]}, 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]}, 0 0 1px ${config[0][10]}, 0 0 1px ${config[0][10]};
    --SGSP-ts-60: 0 1px ${config[0][15]}, 0 -1px ${config[0][15]}, 1px 0 ${config[0][15]}, -1px 0 ${config[0][15]};
    --SGSP-ts-61: 0 1px ${config[0][12]}, 0 -1px ${config[0][12]}, 1px 0 ${config[0][12]}, -1px 0 ${config[0][12]} !important;
    --SGSP-ts-62: 1px 1px ${config[0][13]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-63: 1px 1px ${config[0][13]}, 0 0 2px ${config[0][10]} !important;
    --SGSP-ts-64: 1px 1px ${config[0][13]}, 0 0 2px ${config[0][10]} !important;
    --SGSP-ts-65: 1px 1px ${config[0][13]}, 0 0 2px ${config[0][10]} !important;
    --SGSP-ts-66: 1px 1px ${config[0][11]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-67: 1px 1px ${config[0][11]}, 0 0 2px ${config[0][10]};
    --SGSP-ts-68: 1px 1px ${config[0][11]}, 0 0 2px ${config[0][10]};
    --SGSP-ts-69: 1px 1px ${config[0][12]};
    --SGSP-ts-70: 1px 1px ${config[0][12]};
    --SGSP-ts-71: 1px 1px ${config[0][12]};
    --SGSP-ts-72: 1px 1px ${config[0][12]};
    --SGSP-ts-73: 1px 1px ${config[0][10]}, 0 0 1px ${config[0][10]} !important;
    --SGSP-ts-74: 1px 1px ${config[0][10]};
    --SGSP-ts-75: 1px 1px ${config[0][10]};
    --SGSP-ts-76: 1px 1px ${config[0][10]};
    --SGSP-ts-77: 1px 1px ${config[0][10]};
}
...
.sg2o-modal-dialog {
    background-color: ${Color(config[70], 0, 0, 0, 0.85)}!important;
}
...
.featured__container > .featured__outer-wrap {
    background-color: transparent!important;
    background-size: cover;
    box-shadow: 0 1px 0 var(--SGSP-featured-border-color), 0 6px 10px 0 ${config[0][150]};
    width: 100%;
}
...
.giveaway__column--group, .featured__column--group {
    ...
    border-radius: 4px;
    box-shadow: 0 -1px 0 0 ${config[0][239]}, 0 1px 0 0 ${config[22]}, 1px 0 0 0 ${config[0][240]}, -1px 0 0 0 ${config[22]}!important;
...
.giveaway__column--whitelist, .featured__column--whitelist, .giveaway__columns--badges .giveaway__column--whitelist {
    ...
    border: none!important;
    box-shadow: 0 -1px 0 0 ${config[0][196]}, 0 1px 0 0 ${config[23]}, 1px 0 0 0 ${config[0][197]}, -1px 0 0 0 ${config[23]}!important;
...
header.small, header.large, header, #header {
    ...
    box-shadow: 0 1px 10px 3px ${config[0][150]}, 0 -1px 0 var(--SGSP-header-footer-border-color) inset, 0 -10px 10px -3px ${config[0][142]} inset;
...
.nav__absolute-dropdown, .dropdown > div, .esgst-header-menu-absolute-dropdown, .esgst-header-menu-relative-dropdown > div {
    background-color: ${config[0][16]}!important;
...
.page__heading ~ div:not(.esgst-button-set):not(.row-spacer):not(.align-button-container):not(#filterControls):not(.btn_actions):not(.notification):not(.pagination):not(.page__heading):not(.table__heading):not(.widget-container):not(.form__row):not(.giveaway__row-outer-wrap):not(.leaderboard):not(.esgst-gf-container):not(.esgst-popup-actions):not(.esgst-popup-scrollable):not(.esgst-text-left):not(.esgst-gv-view):not(.esgst-form-row):not(.esgst-menu-split):not(.giveaway_box_hero):not(.giveaway_box_actions):not(.esgst-button):not(.esgst-button-group):not(.esgst-toggle-switch-container), .page_heading ~ div:not(.esgst-button-set):not(.row-spacer):not(.align-button-container):not(.btn_actions):not(.notification):not(.pagination):not(.page_heading):not(.table_heading):not(.widget-container):not(.form__row):not(.giveaway__row-outer-wrap):not(.leaderboard):not(.esgst-gf-container):not(.dont_block_me), .comments:not(.esgst-text-left), .pagination.pagination--no-results, .pagination_no_results, .esgst-glwc-results .table {
    ...
    border: 1px solid var(--SGSP-content-border-color);
    border-radius: 4px;
    box-shadow: 0 0 5px 1px ${config[0][150]};
    margin-bottom: 8px;
    margin-top: 8px;
    padding: 5px 10px;
    text-shadow: var(--SGSP-ts-41);
...
.page__heading + .table__heading {
    ...
    background-repeat: no-repeat;
    box-shadow: 0 0 5px 1px ${config[0][150]}!important;
...
.sidebar__navigation, #sidebar_sgpp_filters, .sgun_notes_panel, .sidebar_table, .esgst-ags-panel, .sidebar .esgst-adots {
    ...
    background-image: linear-gradient(${config[16]}  0, var(--SGSP-sidebar-bg-color)  6px, ${config[0][145]} 100%);
    border: 1px solid;
    border-color: ${config[0][146]} var(--SGSP-sidebar-border-color) ${config[0][149]} var(--SGSP-sidebar-border-color);
    border-radius: 4px;
...
.SGPP__popup_giveaway {
    background-color: var(--SGSP-body-bg-color);
    border: 1px solid hsla(0, 0%, 0%, 0.5);
    box-shadow: 0 0 10px 3px ${config[0][150]}!important;
    border-radius: 4px;
    min-width: 900px;
    text-align: inherit;
...
.esgst-ags-panel.esgst-popout {
    background-color: var(--SGSP-body-bg-color)!important;
    background-image: linear-gradient(${config[16]}  0, var(--SGSP-sidebar-bg-color)  6px, ${config[0][145]} 100%)!important;
    margin-top: -1px!important;
}
...
.esgst-gf-container .esgst-gf-box {
    background-color: transparent!important;
    background-image: linear-gradient(${Color(config[17], 0, 0, 0, 1)} 0%, ${Color(config[17], 0, -12, -5, 1)} 100%);
    border: 1px solid var(--SGSP-pinned-border-color)!important;
    border-radius: 4px 4px 0 0!important;
    margin-top: 0!important;
...
.ui-tooltip-content .tooltip {
    ...
    box-shadow: 0 0 0 1px var(--SGSP-tooltip-border-color), 2px 2px 8px 0 ${config[0][150]}; 
    color: var(--SGSP-link-txt-color)!important;
    margin: -3px;
    text-shadow: var(--SGSP-ts-71);
}
...
.esgst-cl_gc-popout input:not(.comment__submit-button):not(.ui_tpicker_time_input):not(.sp-input):not([type="file"]):not(.sidebar__search-input), .esgst-ggl-popout input:not(.comment__submit-button):not(.ui_tpicker_time_input):not(.sp-input):not([type="file"]):not(.sidebar__search-input), .esgst-cl_ge-popout input:not(.comment__submit-button):not(.ui_tpicker_time_input):not(.sp-input):not([type="file"]):not(.sidebar__search-input) {
    align-self: center;
    background: ${config[11]}!important;
    border: none;
    border-radius: 4px!important;
...
.featured__outer-wrap.featured__outer-wrap--giveaway[style^="background-color"][style*="!important"][style$="background-image: none;"] .featured__inner-wrap {
    background-image: linear-gradient(hsla(0, 0%, 0%, 0) 0%, ${config[0][172]} 100%);
    padding: 25px;
}
...
.esgst-gv-icons :not(.esgst-button-set):not(.esgst-button-container).giveaway__column--invite-only, .esgst-gv-icons :not(.esgst-button-set):not(.esgst-button-container).giveaway__column--region-restricted {
    box-shadow: 0 -1px 0 0 ${config[0][27]}, 0 1px 0 0 ${config[0][135]}, 1px 0 0 0 ${config[0][28]}, -1px 0 0 0 ${config[0][28]}!important;
}
.esgst-gv-icons .btn_action.green, .esgst-gv-icons [data-draggable-id="elgb"]:not(.esgst-button-set):not(.esgst-button-container).form__submit-button, .esgst-gv-icons :not(.esgst-button-set):not(.esgst-button-container).giveaway__column--contributor-level--positive:not(.esgst-glh-highlight) {
    box-shadow: 0 -1px 0 0 ${config[0][65]}, -1px 0 0 0 ${config[0][66]}, 0 1px 0 0 ${config[0][67]}, 1px 0 0 0 ${config[0][66]}!important;
}
.esgst-gv-icons .btn_action.yellow, .esgst-gv-icons [data-draggable-id="elgb"]:not(.esgst-button-set):not(.esgst-button-container).sidebar__entry-delete {
    box-shadow: 0 -1px 0 0 ${config[0][103]}, -1px 0 0 0 ${config[20]}, 0 1px 0 0 ${config[0][104]}, 1px 0 0 0 ${config[20]}!important;
}
.esgst-gv-icons .btn_action.red, .esgst-gv-icons :not(.esgst-button-set):not(.esgst-button-container).giveaway__column--contributor-level--negative:not(.esgst-glh-highlight), .esgst-gv-icons [data-draggable-id="elgb"]:not(.esgst-button-set):not(.esgst-button-container).sidebar__error {
    box-shadow: 0 -1px 0 0 ${config[0][95]}, -1px 0 0 0 ${config[0][96]}, 0 1px 0 0 ${config[0][97]}, 1px 0 0 0 ${config[0][96]}!important;
}
.esgst-aic-right-button, .esgst-aic-left-button {
    filter: contrast(0.85);
}
...
.sidebar__entry-insert, .form__submit-button[data-draggable-id="elgb"] {
    background-image: var(--SGSP-enter-green-buttons-bg-color)!important;
    color: var(--SGSP-enter-green-buttons-txt-color)!important;
    border-color: ${config[0][303]} ${config[0][304]} ${config[0][305]} ${config[0][304]}!important;
}
.sidebar__entry-delete {
    background-image: var(--SGSP-enter-yellow-buttons-bg-color)!important;
    color: var(--SGSP-enter-yellow-buttons-txt-color)!important;
    border-color: ${config[0][306]} ${config[0][307]} ${config[0][308]} ${config[0][307]}!important;
}
.sidebar__error {
    background-image: var(--SGSP-enter-red-buttons-bg-color)!important;
    color: var(--SGSP-enter-red-buttons-txt-color)!important;
    border-color: ${config[0][309]} ${config[0][310]} ${config[0][311]} ${config[0][310]}!important;
}
.esgst-gv-icons [data-draggable-id="elgb"]:not(.esgst-button-set):not(.esgst-button-container).form__submit-button {
    box-shadow: 0 -1px 0 0 ${config[0][303]}, -1px 0 0 0 ${config[0][304]}, 0 1px 0 0 ${config[0][305]}, 1px 0 0 0 ${config[0][304]}!important;
}
.esgst-gv-icons [data-draggable-id="elgb"]:not(.esgst-button-set):not(.esgst-button-container).sidebar__entry-delete {
    box-shadow: 0 -1px 0 0 ${config[0][306]}, -1px 0 0 0 ${config[0][307]}, 0 1px 0 0 ${config[0][308]}, 1px 0 0 0 ${config[0][307]}!important;
}
.esgst-gv-icons [data-draggable-id="elgb"]:not(.esgst-button-set):not(.esgst-button-container).sidebar__error {
    box-shadow: 0 -1px 0 0 ${config[0][309]}, -1px 0 0 0 ${config[0][310]}, 0 1px 0 0 ${config[0][311]}, 1px 0 0 0 ${config[0][310]}!important;
}`;
    if (config[33] != '') {
		css += `
            ...
            html:after {
            background: var(--SGSP-body-bg-image) top center / cover no-repeat fixed;
            content: "";
            ...
            bottom: 0;
            z-index: -2147483648;
            will-change: ${config[69] === `1` ? `transform` : `unset`};
        }
        .esgst-fmph:before {
            bottom: 0;
            content: "";
            ...
            position: absolute;
            width: calc(100% + 14px);
            background: var(--SGSP-body-bg-color) var(--SGSP-body-bg-image) top center/cover no-repeat fixed!important;
            background-size: 100%;
            filter: var(--SGSP-image-filters);
            z-index: -2147483648;
        }
...
function bookmarkedCss (css) {
    var esgstbookmarkedCss = `
/*     ESGST Bookmarked CSS     */
.esgst-idb-highlight, .esgst-idb-highlight.table__row-outer-wrap {
    background-color: unset!important;
    padding: 10px 0!important;
}
`;
	return esgstbookmarkedCss;
}

function profileCss (css) {
    var esgstsettingsCss = `
/*     ESGST Settings CSS     */
.page__heading ~ div:not(.sidebar__search-container):not(.esgst-button) {
    background-color: unset!important;
...
`;
    if (window.location.search.match(/esgst=ge&url/)) {
      esgstsettingsCss += `.page__heading ~ div:not(.sidebar__search-container).esgst-text-left {
    background-color: var(--SGSP-content-bg-color)!important;
    border: 1px solid var(--SGSP-content-border-color)!important;
    border-radius: 4px;
    margin-top: 8px;
...
.widget-container > [data-esgst-popup] > div > .esgst-text-left {
    ...
    if (window.location.search.match(/esgst=ged/)) {
      esgstsettingsCss += `.widget-container > div > .page__heading:first-child {
    background-color: var(--SGSP-body-bg-color);
    border-bottom: 1px solid var(--SGSP-content-border-color)!important;
    margin-top: -1px;
    padding: 8px 0;
...
.widget-container > div .page__heading:not(.esgst-fmph) + .esgst-gf-container {
    ...
    return esgstsettingsCss;
}

function steamtradesCss (css) {
    var tradesCss = `
/*     ESGST Steamtrades CSS     */
.esgst-header-menu-button {
    border: none!important;
    height: 27px;
}
...
var buttonStyle = `
/* SGv2 Dark Settings Button and Menu*/
#SGv2_Dark__OptionsContainer-2, #SGv2_Dark__OptionsContainer-3, .SGv2_Dark__Dialog .ui-dialog-titlebar, .SGv2_Presets input[type="radio"], .SGv2_Presets input[type="radio"] + label:before {
    display: none;
}
.SGv2_Dark__Option {
    display: grid;
...
.SGv2_Dark__Option input {
    grid-area: 1 / 3 / 2 / 3;
}
#SGv2_Dark__OptionsContainer-1 .SGv2_Dark__Option:first-of-type input {
    width: 160px;
}
...
.SGv2_Dark__sidebar__entry-insert {
    background-image: linear-gradient(${config[0][63]} 0%, ${config[18]}  50%, ${config[0][64]} 100%);
    border-color: ${config[0][65]} ${config[0][66]} ${config[0][67]} ${config[0][66]}!important;
    color: ${config[0][112]}!important;
}
.SGv2_Dark__sidebar__entry-delete {
...
.SGv2_Dark__sidebar__error {
    background-image: linear-gradient(${config[0][77]} 0%, ${config[19]}  50%, ${config[0][78]} 100%);
...
.SGv2_Dark__sidebar__entry-insert:not(:active):hover, .SGv2_Dark__sidebar__entry-delete:not(:active):hover, .SGv2_Dark__sidebar__error:not(:active):hover {
    filter: var(--SGSP-button-hover-brightness);
}
.SGv2_Dark__sidebar__entry-insert:active, .SGv2_Dark__sidebar__entry-delete:active, .SGv2_Dark__sidebar__error:active {
    transition: filter 0.01s;
    will-change: filter;
    margin-top: 0;
    margin-left: 0;
...
.SGv2_Dark__Dialog #dialog-message {
    padding: 0;
}
.SGv2_Dark__Dialog.ui-widget {
...
.SGv2_Dark__config input:not(.comment__submit-button):not(.ui_tpicker_time_input):not(.sp-input):not([type="file"]):not(.form__input--valid):not(.form__input--invalid)[type="color"] {
    border: none;
    background-color: hsla(0,0%,0%,0)!important;
    height: 20px;
    width: 35px;
}
.SGv2_Dark__config input[type="color"]::-moz-color-swatch {
    height: 12px;
}
...
.SGv2_Presets input[name="Preset"] {
    width: 100%;
}
...
.SGv2_Presets input[type="radio"]:checked + label span {
...
.SGv2_Dark__Import_Settings .SGv2_Dark, .SGv2_Dark__Import_Settings #import_settings {
    margin-right: 5px;
}
.SGv2_Presets {
...
.SGv2_Dark__Settings_Container:hover .SGv2_Dark__Settings_Header {
    color: ${config[0][191]};
}
.SGv2_Dark__tabs {
    display: flex;
...
#SGv2_Dark__tab-1:hover, #SGv2_Dark__tab-2:hover, #SGv2_Dark__tab-3:hover {
    opacity: 1!important;
}
.SGv2_Dark__tab-active {
    opacity: 1!important;
}
.SGv2_tooltip {
...
function addButtonCss(themeName, arg, id) {
    var css = getbuttonStyle(arg);
    var idName = id || 'SGv2 Dark';
    var node = document.createElement('style');
    node.setAttribute('type', 'text/css');
    node.setAttribute('name', themeName);
...
var Docobserver = new MutationObserver(function() {
    if (document.body !== null) {
        ...
        if (theme == 'Dark') {
            var SGv2Dark = $('style[id="SGv2 Dark"]');
            $('style[id="SGv2 Dark"]').remove();
            $("body").after($("#esgst-custom-theme").clone(false)).after(SGv2Dark.clone(false));
        }
        makeSureRan();
    }
});
...
function makeSureRan () {
    ...
    $('body').on('click', '.comment__submit-button.SGv2_Dark', function () {
        saveFile($('#current_settings').val(),$('#Preset1').val(),$('#Preset2').val(),$('#Preset3').val(),$('style[id="SGv2 Dark"]').text(),steamtradesCss(),sgppCss(config));
    });
    $('body').on('change', 'input[name=Preset]', function() {
        var attr = (('SGv2 ') + (this.getAttributeNode("id").value));
        var water = '0.8,#0d1617,#a4a4a4,#56b9c0,#10181b,#122729,#86c7d7,#a0a0a0,#808d9d,#8ab1b9,#213c3f,#142729,#22444b,#232c36,#285e64,#1c353c,#1e252b,#47721d,#882828,#d5d54e,#808080,#46a640,#3197a0,#000000,1,0.7,#0b2326,#248082,1,1,0,1,https://i.imgur.com/SNWZ8XZ.jpg,#000000,0.8,#80bf40,#d84141,#06464f,#80A659,1,#5F3F3F,#466062,#C7C7C7,#4D4D4D,#53BFF9,#101F23,1,#1f1f1f,#a6a6a6,0,1.25,1.2,1.25,#151f23,#b7b776,#d84141,#000000,#8cd7d9,#10181b,#10181b,#8ab1b9,#adadad,#adadad,#adadad,#a4a4a4,#8ab1b9,1.25,#a0a0a0,0,#000000,#46731c,#8a2828,#cbc334,#2770b9,#75b927,#3d3d3d,#b92727,#b4b927,1,1';
        var halloween = '0.8,#0b0b0b,#d17518,#a8a82d,#000000,#4a2900,#baba30,#ea8015,#858585,#d17518,#572700,#4d2a00,#151515,#853000,#9b4200,#0b0b0b,#824700,#384927,#742727,#aba33f,#555555,#4a9546,#377e84,#000000,1,0.85,#000000,#a84700,1,1,0,1,https://i.imgur.com/hc8Z9Cx.jpg,#000000,1,#75a644,#d84141,#994d00,#80a659,1,#5f3f3f,#466062,#f1a65b,#4d4d4d,#53bff9,#0d0d0d,1,#1f1f1f,#a6a6a6,0,1.25,1.2,1.05,#080808,#a4962d,#d84141,#121212,#f79533,#000000,#000000,#d17518,#ed8c2c,#ed8c2c,#ed8c2c,#d17518,#d17518,1.25,#ea8015,0,#000000,#46731c,#8a2828,#cbc334,#2770b9,#75b927,#3d3d3d,#b92727,#b4b927,1,1';
...
function switchToLight() {
    ...
    $('style[name^="Theme"] , style[id="SGv2 Temp"]').remove();
    setTheme('Light');
}
...
if (settings !== null) {
    var config = settings;
    if (!(config[config.length - 1].slice(18)).match(version)) {
        Object.keys(localStorage).forEach(function(key) {
            if (/^SGv2 Preset/.test(key) || /^SGv2 Dark Colors/.test(key)) {
                var savedStorage = JSON.parse(localStorage.getItem(key));
                if (savedStorage[29] === '') {
                    savedStorage[29] = "1";
                }
                if (savedStorage[30] === '') {
                ...
                localStorage.setItem(key, JSON.stringify(savedStorage));
            }
        });
        var cfg = (defaultconfig());
        var defaultCfg = cfg.slice(1, (cfg.length - 1));
        var currentCfg = config.slice(1, (config.length - 1));
        if (currentCfg.length != defaultCfg.length) {
            ...
            Object.keys(localStorage).forEach(function(key) {
                if (/^SGv2 Preset/.test(key)) {
                    var savedThemes = JSON.parse(localStorage.getItem(key));
                    localStorage.setItem(key, JSON.stringify(savedThemes.concat(slicedCfg)));
                }
            });
        } else {
            joinedCfg = currentCfg;
        }
        joinedCfg.unshift('');
...
function saveFile(txt1, txt2, txt3, txt4, txt5, txt6, txt7) {
    var file = new Blob(
[`@-moz-document url("Script Settings only, Ignore in style managers") { /*---------------------------------------------- Start of SGv2 Dark Settings v${version}
Current Settings:  ${txt1}
Theme #1:  ${txt2}
Theme #2:  ${txt3}
Theme #3:  ${txt4}
/*---------------------------------------------- End of SGv2 SGv2 Dark Settings v${version} '---------------------------------------------*/
}
...
${txt7}
    ...
    downloadLink.download = ('' + site + ' SGv2 Dark v' + version + '.txt');
