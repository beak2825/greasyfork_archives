// ==UserScript==
// @name         InfiniteChan Betatesst Script
// @version      0.0.1
// @description  Just experimenting with infinitechan
// @author       You
// @include      http://infinitydev.org/ent/thread/*
// @grant        none
// @namespace https://greasyfork.org/users/2657
// @downloadURL https://update.greasyfork.org/scripts/13959/InfiniteChan%20Betatesst%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/13959/InfiniteChan%20Betatesst%20Script.meta.js
// ==/UserScript==
...
function backlinks(){
$('.reply-container').not('.done').each(function() {
$(this).addClass('done');
cite = $(this).find('.cite').attr('data-board_id');
num = $(this).find('.post-reply').attr('data-board_id');

if (cite){
$('.post-reply[data-board_id="'+cite+'"]').append('  <div style="display:inline-block;color:red;">>>'+num+'</div>');
}
