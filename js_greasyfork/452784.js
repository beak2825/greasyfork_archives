...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/452784/Pikachu%20CSS.user.js
// @updateURL https://update.greasyfork.org/scripts/452784/Pikachu%20CSS.meta.js
// ==/UserScript==
setInterval(() => {
$("#room").css({background: "rgba(127, 82, 255, 0.5)" });
$("#room .more").css({background: "rgba(127, 55, 222, 0.5)"});
$("#room .expand").css({background: "rgba(127, 55, 222, 0.5)"});
$("#room .more .info:hover").css({background: "rgba(127, 57, 255, 0.5)"});
$("#room .more .new").css({background: "rgba(127, 57, 255, 0.5)"});
$("#room .more").css({background: "rgba(127, 57, 255, 0.5)"});
$("#room .more .new:hover").css({background: "rgba(247, 218, 69, 0.5);"});
$(".ugly-button").css({background: "rgba(127, 57, 255, 0)", "border-radius": "8px", "-webkit-border-radius": "8px", "-moz-border-radius": "8px" });
$("#room .more .new:hover").css({background: "rgba(127, 0, 222, 0.5)"});
$("#room .more .new:hover").css({background: "rgba(127, 0, 222, 0.5)"});
...
$(".notification-body").css({background: "rgba(128, 63, 180, 0.5)", "backdrop-filter": "blur(2px)"});
$(".notification .x:hover").css({background: "rgba(128, 63, 180, 0.5)"});
$(".notification-body").css({background: "rgba(128, 63, 180, 0.5)", "backdrop-filter": "blur(2px)"});
$(".ugly-button .stuck").css({background: "rgba(128, 63, 180, 0.5)"});
document.body.style = `background-image: url('https://w.wallhaven.cc/full/lm/wallhaven-lmwg12.jpg'); background-position: 25% 75%; background-size: cover; backdrop-effect: blur(2px);`
}, 1);
...
var resize = function(width, height) {
		...
		if(ctx.createLinearGradient) {
			...
			gradient.addColorStop(0, "#FF30FF");
			gradient.addColorStop(0.75, "#4B1B8F");
			gradient.addColorStop(1, "#440084");
			ctx.fillStyle = gradient;
		} else {
			ctx.fillStyle = "#fff";
		}
		ctx.strokeStyle = "#3826B1";
		ctx.lineJoin = "round";
		ctx.lineCap = "round";
		ctx.lineWidth = 10;
