...
// @license 	 MIT
// @author      Ilia Krylov
// @description 15.03.2025, 03:00:30
// @downloadURL https://update.greasyfork.org/scripts/529851/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20AQUA.user.js
// @updateURL https://update.greasyfork.org/scripts/529851/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20AQUA.meta.js
// ==/UserScript==
...
title: 'DM',
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     '[CENTER][COLOR=rgb(255, 0, 250)][FONT=times new roman][ICODE]Доброго времени суток, уважаемый(-ая) {{ user.name }} [/ICODE][/FONT][/COLOR]<br>' +
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(0, 255, 0)]одобрена[/COLOR], игрок получит своё наказание по пункту правил:[/FONT]' +
'[SPOILER="*Нажмите*"][COLOR=rgb(255, 0, 0)]3.04.[/COLOR][FONT=imes new roman]Запрещено оскорбление или косвенное упоминание родных вне зависимости от чата. | [COLOR=rgb(255, 0, 0)]Mute 120 минут / Ban 7 - 15 дней[/COLOR].<br>' +
     '[CENTER][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] термины "MQ", "rnq" расценивается, как упоминание родных.' +
     '[CENTER][COLOR=rgb(255, 0, 0)]Исключение:[/COLOR] если упоминание родных было совершено в ходе Role Play процесса и не содержало в себе прямого или завуалированного оскорбления.[/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
      '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за ваше обращение.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(0, 255, 0)]одобрена[/COLOR], игрок получит своё наказание по пункту правил:[/FONT]' +
'[SPOILER="*Нажмите*"][B][COLOR=rgb(255, 0, 0)]2.05.[/COLOR] [FONT=courier new]Запрещены любые OOC обманы и их попытки, а также любые IC обманы с нарушением Role Play правил и логики. | [COLOR=rgb(255, 0, 0)]PermBan[/COLOR].<br>' +
    '[CENTER][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] после IC договоренности получить денежные средства и сразу же выйти из игры с целью обмана игрока, или же, договорившись через OOC чат (/n), точно также получить денежные средства и сразу же выйти из игры и тому подобные ситуации.' +
    '[CENTER][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] разблокировка игрового аккаунта нарушителя будет возможна только в случае возврата полной суммы причиненного ущерба, либо непосредственно самого имущества, которое было украдено (по решению обманутой стороны).[/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
      '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за ваше обращение.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(0, 255, 0)]одобрена[/COLOR], игрок получит своё наказание по пункту правил:[/FONT]' +
'[SPOILER="*Нажмите*"][COLOR=rgb(255, 0, 0)]3.10.[/COLOR] [FONT=courier new]Запрещена выдача себя за администратора, если таковым не являетесь. | [COLOR=rgb(255, 0, 0)]Ban 7 - 15 дней[/COLOR].[/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
      '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за ваше обращение.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(0, 255, 0)]одобрена[/COLOR], игрок получит своё наказание по пункту правил:[/FONT]' +
'[SPOILER="*Нажмите*"][B][COLOR=rgb(255, 0, 0)]2.31.[/COLOR] [FONT=courier new]Запрещено рекламировать на серверах любые проекты, серверы, сайты, сторонние Discord-серверы, YouTube каналы и тому подобное. | [COLOR=rgb(255, 0, 0)]Ban 7 дней / PermBan[/COLOR].<br>' +
    '[COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] если игрок не использует глобальный чат, чтобы дать свои контактные данные для связи, это не будет являться рекламой.[/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
      '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за ваше обращение.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(0, 255, 0)]одобрена[/COLOR], игрок получит своё наказание по пункту правил:[/FONT]' +
'[SPOILER="*Нажмите*"][B][COLOR=rgb(255, 0, 0)]2.28.[/COLOR] [FONT=courier new] Запрещена покупка, продажа внутриигровой валюты за реальные деньги в любом виде | [COLOR=rgb(255, 0, 0)]PermBan с обнулением аккаунта + ЧС проекта.[/B][/COLOR].' +
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(0, 255, 0)]одобрена[/COLOR], игрок получит своё наказание по пункту правил:[/FONT]' +
'[SPOILER="*Нажмите*"][COLOR=rgb(255, 0, 0)]3.22.[/COLOR] [FONT=courier new]Запрещено публиковать любые объявления в помещениях государственных организаций вне зависимости от чата (IC или OOC) | [COLOR=rgb(255, 0, 0)]Mute 30 минут[/COLOR].[/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
      '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за ваше обращение.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     '[CENTER][COLOR=rgb(255, 0, 250)][FONT=times new roman][ICODE]Доброго времени суток, уважаемый(-ая) {{ user.name }} [/ICODE][/FONT][/COLOR]<br>' +
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(0, 255, 0)]одобрена[/COLOR], игрок получит своё наказание по следующему пункту правил для силовых структур:[/FONT]' +
'[SPOILER="*Нажмите*"][COLOR=rgb(255, 0, 0)]1.11.[/COLOR] [FONT=courier new]Всем силовым структурам запрещен одиночный патруль или конвоирование, минимум 2 сотрудника. | [COLOR=rgb(255, 0, 0)]Warn[/COLOR].[/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
      '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за ваше обращение.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]На вашей видеофиксации отсутствуют условия сделки.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Недостаточно доказательств для корректного рассмотрения вашей жалобы.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Доказательства недоступны к просмотру - следовательно, рассмотрению ваша жалоба не подлежит.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Отсутствуют доказательства[/COLOR] - следовательно, рассмотрению не подлежит. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее.[/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Доказательства в социальных сетях и т.д. не принимаются. Загрузите доказательства на фото-видео хостинги YouTube,Imgur, Yapx и так далее.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]После проверки представленных представленных вами доказательств - нарушений со стороны игрока выявлено не было.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]На ваших доказательствах отсутствует /time.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Ваши доказательства были подвергнуты редактированию - следовательно, рассмотрению не подлежит.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Ваша видеозапись обрывается. Загрузите полную видеозапись на видео-хостинг YouTube.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]В вашей жалобе отсутствуют таймкоды. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]С момента нарушения прошло более 72-ух часов.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Ваша жалоба написана от 3-его лица.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Ответ вам уже был дан ранее.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Игрок уже был наказан ранее.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Ваша жалоба составлена не по форме. Внимательно прочитайте правила подачи жалоб на игроков, закрепленные в этом разделе.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Ваши доказательства не доступны к просмотру. Загрузите доказательства на фото-видео хостинги YouTube,Imgur, Yapx и так далее.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Для корректного рассмотрения вашей жалобы недостаточно доказательств, нужно прикрепить видео-доказательство.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Напишите вашу жалобу в раздел "Жалобы на сотрудников".[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Ваши доказательства в плохом качестве - загрузите на другой хостинг.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Nick_Name игрока указаный вами в жалобе не совпадает с Nick_Name игрока на доказательствах.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за вашу бдительность.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(255, 0, 0)]отказана[/COLOR], причиной на это стало:[/FONT]' +
'[SPOILER="*Нажмите*"][FONT=courier new][B][COLOR=rgb(255, 0, 0)]Вы ошиблись сервером.[/COLOR][/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
       '[CENTER][FONT=courier new][COLOR=rgb(255, 0, 0)]Отказано,[/FONT][/COLOR] [COLOR=rgb(255, 0, 0)]закрыто[/COLOR][/CENTER]<br>',
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша жалоба [COLOR=rgb(0, 255, 0)]одобрена[/COLOR], игрок получит своё наказание по пункту правил:[/FONT]' +
'[SPOILER="*Нажмите*"][B][COLOR=rgb(255, 0, 0)]2.57.[/COLOR] [FONT=courier new]Запрещается брать в долг игровые ценности и не возвращать их. | [COLOR=rgb(255, 0, 0)]Ban 30 дней / permban[/COLOR][/B].<br>' +
     '[CENTER][B][FONT=courier new][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] займ может быть осуществлен только через зачисление игровых ценностей на банковский счет, максимальный срок займа 30 календарных дней, если займ не был возвращен, аккаунт должника блокируется;[/B][/FONT]' +
     '[CENTER][B][FONT=courier new][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] при невозврате игровых ценностей общей стоимостью менее 5 миллионов включительно аккаунт будет заблокирован на 30 дней, если более 5 миллионов, аккаунт будет заблокирован навсегда;[/B][/FONT]' +
     '[CENTER][B][FONT=courier new][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] жалоба на игрока, который занял игровые ценности и не вернул в срок, подлежит рассмотрению только при наличии подтверждения суммы и условий займа в игровом процессе, меры в отношении должника могут быть приняты только при наличии жалобы и доказательств. Жалоба на должника подается в течение 10 дней после истечения срока займа. Договоры вне игры не будут считаться доказательствами.[/B][/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
      '[FONT=times new roman][COLOR=rgb(0, 255, 255)][ICODE]Благодарим вас за ваше обращение.[/ICODE]' +
    '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша Role Play Биография получает статус - [COLOR=rgb(255, 0, 0)]отказано[/COLOR].[/FONT]<br>' +
     '[SPOILER="*Нажмите*"][FONT=courier new][COLOR=rgb(255, 0, 0)]Возраст не совпадает с датой рождения[/COLOR].[/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Отказано,[/COLOR] [COLOR=rgb(255, 0, 0)]закрыто[/COLOR][/FONT][/CENTER]<br>',
      prefix: UNACCEPT_PREFIX,
...
content:
 '[CENTER][IMG]https://i.postimg.cc/yxCq2ZLM/neonbar.gif[/IMG]<br>' +
     ...
     '[img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img]<br>'+
'[CENTER][FONT=times new roman]Ваша Role Play Биография получает статус - [COLOR=rgb(255, 0, 0)]отказано[/COLOR].[/FONT]<br>' +
     '[SPOILER="*Нажмите*"][FONT=courier new][COLOR=rgb(255, 0, 0)]Ваша Role Play биография составлена неграмотно[/COLOR].[/FONT][/SPOILER]<br>' +
     '[FONT=times new roman][B]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/B][/FONT]<br>' +
'[FONT=times new roman][B]С уважением состав Кураторов Форума сервера [COLOR=rgb(0, 255, 255)]AQUA[/COLOR][/B][/FONT]<br>'+
       '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Отказано,[/COLOR] [COLOR=rgb(255, 0, 0)]закрыто[/COLOR][/FONT][/CENTER]<br>',
      prefix: UNACCEPT_PREFIX,
