// ==UserScript==
// @name         z2sam kb display 
// @namespace    http://tampermonkey.net/
// @version      0.25.3
// @description  shows keyboard inputs on screen 
// @author       Oki perhaps and possibly meppydc
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/388020/z2sam%20kb%20display.user.js
// @updateURL https://update.greasyfork.org/scripts/388020/z2sam%20kb%20display.meta.js
// ==/UserScript==
...
(function() {
    window.addEventListener('load', function() {
        ...
        if (typeof Game != "undefined" || typeof Replayer != "undefined") {
            ...
            ///labels are     0     1     2          3
            var labels = ['HL','blue', 'berries',      '180',
                          // 4     5     6     7    8     9
                          'CCW', 'CW', 'HD', 'L', 'SD', 'R']

            let kbdisplay = {left:7,right:9,sd:8,hd:6,ccw:4,cw:5,hold:0,180:3,reset:2,new:1}
