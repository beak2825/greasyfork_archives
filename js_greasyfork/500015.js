...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/500015/aoi%EF%BC%88Dev%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/500015/aoi%EF%BC%88Dev%EF%BC%89.meta.js
// ==/UserScript==
...
(async function() {
    ...
    document.addEventListener('keydown', e => {
        ...
        if(e.keyCode == 9) {
            ...
            selectMap(baseMap.includes(curSel) ? '谷歌影像' : '腾讯地图')
