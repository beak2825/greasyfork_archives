// ==UserScript==
// @name       				网课助手|后台自动挂机|视频文档|章节测验|超高倍速|防清进度|全自动无人值守【网课24H自动刷课：www.gaoxiaowk.icu】
// @version    				4.9.44
// @description				网课助手，专注于帮助大学生从网课中释放出来。让自己的时间把握在自己的手中，拥有人性化的操作页面，流畅的步骤提示，支持 【知到智慧树】 【超星学习通】 【智慧职教(MOOC学院)】 【职教云】，等网课的学习，作业。具体的功能请查看脚本悬浮窗中的教程页面，网课24H自动刷课：www.gaoxiaowk.icu
// @author     				木金
// @license    				MIT
// @match      				*://*.zhihuishu.com/*
// @match      				*://*.chaoxing.com/*
...
// @namespace   			https://wk.bobo91.com
// @homepage    			https://wk.bobo91.com
...
// @connect    				127.0.0.1
// @antifeature				payment
// @downloadURL https://update.greasyfork.org/scripts/513367/%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B%7C%E5%90%8E%E5%8F%B0%E8%87%AA%E5%8A%A8%E6%8C%82%E6%9C%BA%7C%E8%A7%86%E9%A2%91%E6%96%87%E6%A1%A3%7C%E7%AB%A0%E8%8A%82%E6%B5%8B%E9%AA%8C%7C%E8%B6%85%E9%AB%98%E5%80%8D%E9%80%9F%7C%E9%98%B2%E6%B8%85%E8%BF%9B%E5%BA%A6%7C%E5%85%A8%E8%87%AA%E5%8A%A8%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E3%80%90%E7%BD%91%E8%AF%BE24H%E8%87%AA%E5%8A%A8%E5%88%B7%E8%AF%BE%EF%BC%9Awwwgaoxiaowkicu%E3%80%91.user.js
// @updateURL https://update.greasyfork.org/scripts/513367/%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B%7C%E5%90%8E%E5%8F%B0%E8%87%AA%E5%8A%A8%E6%8C%82%E6%9C%BA%7C%E8%A7%86%E9%A2%91%E6%96%87%E6%A1%A3%7C%E7%AB%A0%E8%8A%82%E6%B5%8B%E9%AA%8C%7C%E8%B6%85%E9%AB%98%E5%80%8D%E9%80%9F%7C%E9%98%B2%E6%B8%85%E8%BF%9B%E5%BA%A6%7C%E5%85%A8%E8%87%AA%E5%8A%A8%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E3%80%90%E7%BD%91%E8%AF%BE24H%E8%87%AA%E5%8A%A8%E5%88%B7%E8%AF%BE%EF%BC%9Awwwgaoxiaowkicu%E3%80%91.meta.js
// ==/UserScript==
...
(function(global2, factory) {
  ...
  class GMStoreProvider {
    ...
    setTab(key, value) {
      return new Promise((resolve, reject) => {
        GM_getTab((tab = {}) => {
          ...
          GM_saveTab(tab);
          this.set(this.getTabChangeHandleKey(Reflect.get(tab, const_1$2.$const.TAB_UID), key), value);
          resolve();
        });
      });
    }
    ...
    addTabChangeListener(key, listener) {
      return __awaiter$4(this, void 0, void 0, function* () {
        const uid = yield this.getTab(const_1$2.$const.TAB_UID);
  ...
  Object.defineProperty(cors, "__esModule", { value: true });
  cors.cors = cors.CorsEventEmitter = void 0;
  const common_1$6 = common;
  const const_1$1 = _const;
  const store_1$2 = store;
  class CorsEventEmitter {
    ...
    emit(name, args = [], callback) {
      store_1$2.$store.getTab(const_1$1.$const.TAB_UID).then((uid) => {
        const id = common_1$6.$.uuid().replace(/-/g, "");
        const key = uid + "." + this.eventKey(name);
        store_1$2.$store.set(this.keyOfState(id), 0);
        store_1$2.$store.set(this.keyOfArguments(id), args);
        const listenerId = store_1$2.$store.addChangeListener(this.keyOfState(id), (pre, curr, remote) => {
          store_1$2.$store.removeChangeListener(listenerId);
          callback === null || callback === void 0 ? void 0 : callback(store_1$2.$store.get(this.keyOfReturn(id)), !!remote);
          store_1$2.$store.delete(this.keyOfState(id));
          store_1$2.$store.delete(this.keyOfReturn(id));
          store_1$2.$store.delete(this.keyOfArguments(id));
        }) || 0;
        store_1$2.$store.set(key, (store_1$2.$store.get(key) ? String(store_1$2.$store.get(key)).split(",") : []).concat(id).join(","));
      }).catch(console.error);
    }
    on(name, handler) {
      return new Promise((resolve) => {
        store_1$2.$store.getTab(const_1$1.$const.TAB_UID).then((uid) => {
          ...
          if (originId) {
            ...
            const id = store_1$2.$store.addChangeListener(key, (pre, curr, remote) => __awaiter$3(this, void 0, void 0, function* () {
              if (remote) {
                if (curr === void 0) {
                  return;
                }
                ...
                const id2 = list.pop();
                if (id2) {
                  store_1$2.$store.set(this.keyOfReturn(id2), yield handler(store_1$2.$store.get(this.keyOfArguments(id2))));
                  setTimeout(() => {
                    store_1$2.$store.set(this.keyOfState(id2), 1);
                    store_1$2.$store.set(key, list.join(","));
                  }, 100);
                }
              }
            })) || 0;
    ...
    off(name) {
      ...
      if (originId) {
        ...
        store_1$2.$store.removeChangeListener(originId);
      }
    }
  }
  cors.CorsEventEmitter = CorsEventEmitter;
  if (typeof GM_listValues !== "undefined" && self === top) {
    window.onload = () => {
      store_1$2.$store.list().forEach((key) => {
        if (/_temp_.event.[0-9a-z]{32}.(state|return|arguments)/.test(key)) {
          store_1$2.$store.delete(key);
        }
  ...
  cors.cors = new CorsEventEmitter();
  var project = {};
  ...
  class Script extends BaseScript {
    ...
    onConfigChange(key, handler) {
      const _key = common_1$5.$.namespaceKey(this.namespace, key.toString());
  ...
  Object.defineProperty(start$2, "__esModule", { value: true });
  start$2.addFunctionEventListener = start$2.start = start$2.$win = void 0;
  ...
  start$2.addFunctionEventListener = addFunctionEventListener;
...
`;
          ...
          notes: {
            defaultValue: lib.$ui.notes([
              [
                lib.h("span", [
                  "\u5982\u679C\u60A8\u4F7F\u7528",
                  lib.h("a", { href: "https://wk.bobo91.com", target: "_blank" }, "木金\u684C\u9762\u8F6F\u4EF6"),
                  "\u542F\u52A8\u6D4F\u89C8\u5668\uFF0C\u5E76\u4F7F\u7528\u6B64\u811A\u672C\uFF0C"
                ]),
                    ...
                    if (Object.prototype.hasOwnProperty.call(project2.scripts, key)) {
                      ...
                      script2.onrender = ({ panel, header: header2 }) => {
                        ...
                        if (panel.configsContainer.children.length) {
                          ...
                          panel.lockWrapper.title = "\u{1F6AB}\u5DF2\u540C\u6B65木金\u684C\u9762\u7248\u8F6F\u4EF6\u914D\u7F6E\uFF0C\u5982\u9700\u4FEE\u6539\u8BF7\u5728\u684C\u9762\u7248\u8F6F\u4EF6\u7684\u5DE6\u4FA7\u680F\u8BBE\u7F6E-\u901A\u7528\u8BBE\u7F6E-木金\u914D\u7F6E\uFF0C\u4E2D\u8FDB\u884C\u4FEE\u6539\u3002\u6216\u8005\u524D\u5F80\u811A\u672C\u60AC\u6D6E\u7A97:\u540E\u53F0-\u8F6F\u4EF6\u914D\u7F6E\u540C\u6B65 \u5173\u95ED\u914D\u7F6E\u540C\u6B65\u529F\u80FD\u3002";
        ...
        methods() {
          return {
            getLastVersion: async () => {
              return await request("https://dati.bobo91.com/ocs-version.json?t=" + Date.now(), {
                method: "get",
                type: "GM_xmlhttpRequest"
              });
            }
  ...
  const gotoHome = () => {
    ...
    btn.onclick = () => window.open("https://wk.bobo91.com", "_blank");
    return btn;
  };
  const state$5 = {
    workResult: {
    ...
    scripts: {
      guide: new lib.Script({
        ...
        onrender({ panel }) {
          ...
          contactUs.onclick = () => window.open("https://wk.bobo91.com", "_blank");
          const changeLog = lib.h("button", { className: "base-style-button-secondary" }, "\u{1F4C4}\u67E5\u770B\u66F4\u65B0\u65E5\u5FD7");
          changeLog.onclick = () => CommonProject.scripts.apps.methods.showChangelog();
                ...
                const modal2 = lib.$modal.prompt({
                  ...
                  content: lib.$ui.notes([
                    [
                      lib.h("div", [
                        "\u9898\u5E93\u914D\u7F6E\u586B\u5199\u6559\u7A0B\uFF1A",
                        lib.h("a", { href: "https://wk.bobo91.com" }, "https://wk.bobo91.com")
                      ])
                    ],
                    [
                      lib.h("div", [
...
\u4E3B\u9875\uFF1A${c.homepage || "\u672A\u77E5\u4E3B\u9875"}`,
  ...
  const $playwright = {
    showError: () => {
      const href = "https://wk.bobo91.com";
  ...
  const StudyVideoH5 = {
    ...
    getChapterName(parent) {
      var _a;
      return ((_a = parent.querySelector(".catalogue_title")) == null ? void 0 : _a.textContent) || "\u65E0\u540D\u79F0";
    },
    getNext(opts) {
    ...
    async switchPlaybackRate(rate, remotePage) {
    ...
    async switchLine(definition2, remotePage) {
      const controlsBar = lib.$el(".controlsBar");
      const dl = lib.$el(".definiLines");
      if (controlsBar && dl) {
        controlsBar.style.display = "block";
        dl.style.display = "block";
        await remotePage.click(`.definiLines .${definition2}`);
      }
    },
    hasJob: function() {
      var _a;
    ...
    async handleTestDialog(remotePage) {
      var _a, _b;
      const tip = lib.$el('[role="dialog"][aria-label="\u63D0\u793A"]');
  ...
  const FusionCourseH5 = {
    getCourseName() {
      var _a;
      return ((_a = lib.$el(".right-scroll .catalogue_title")) == null ? void 0 : _a.textContent) || "\u65E0\u540D\u79F0";
    },
    getChapterName(parent) {
      var _a;
      return ((_a = parent.querySelector(".catalogue_title")) == null ? void 0 : _a.textContent) || "\u65E0\u540D\u79F0";
    ...
    hasJob() {
      var _a;
      return ((_a = lib.$$el(".right-scroll .clearfix.video")) == null ? void 0 : _a.length) > 0;
    },
    getNext(opts) {
      let videoItems = Array.from(document.querySelectorAll(".right-scroll .clearfix.video"));
    ...
    switchPlaybackRate(rate, remotePage) {
      return StudyVideoH5.switchPlaybackRate(rate, remotePage);
    },
    switchLine(definition2, remotePage) {
      return StudyVideoH5.switchLine(definition2, remotePage);
    }
  };
        ...
        async oncomplete() {
          ...
          const study2 = async (opts) => {
            ...
            if (state$4.study.stop === false) {
              ...
              if (item) {
                $console.log("\u5373\u5C06\u5B66\u4E60\uFF1A", ((_a = item.querySelector(".catalogue_title")) == null ? void 0 : _a.textContent) || "\u672A\u77E5\u7AE0\u8282");
                await lib.$.sleep(3e3);
                $render.moveToEdge();
  ...
  async function watch(processor, remotePage, options, onended) {
    const reload = (e) => {
      $console.error(e);
    ...
    scripts: {
      ...
      versionRedirect: new lib.Script({
        ...
        async oncomplete() {
          if (top$1 === window) {
            lib.$message.warn({
              content: "木金\u7F51\u8BFE\u52A9\u624B\u4E0D\u652F\u6301\u65E7\u7248\u8D85\u661F, \u5373\u5C06\u5207\u6362\u5230\u8D85\u661F\u65B0\u7248, \u5982\u6709\u5176\u4ED6\u7B2C\u4E09\u65B9\u63D2\u4EF6\u8BF7\u5173\u95ED, \u53EF\u80FD\u6709\u517C\u5BB9\u95EE\u9898\u5BFC\u81F4\u9891\u7E41\u5207\u6362\u3002",
              duration: 0
            });
            await $.sleep(2e3);
  ...
  function searchJob(opts, searchedJobs) {
    ...
    const search = (root2) => {
      ...
      if (win && (videojs || read || chapterTest || hyperlink || pptWithAudio)) {
        ...
        const attachment = knowCardWin.attachments.find(
          (attachment2) => String(attachment2.jobid) === String(JSON.parse(frame_data_str).jobid)
        );
  ...
  const isWork = window.location.href.includes("icve-study/coursePreview/jobTes") || window.location.href.includes("study/spockeepTest") || window.location.href.includes("study/spocjobTest");
  const isExam = window.location.href.includes("icve-study/coursePreview/test") || window.location.href.includes("study/spoctest");
        ...
        methods() {
          return {
            main: async () => {
              ...
              lib.$message.success({ content: "\u5F00\u59CB\u5B66\u4E60\uFF1A" + courseInfo.fileType + "-" + courseInfo.name });
              ...
              if (["ppt", "doc", "pptx", "docx", "pdf", "txt"].some((i) => courseInfo.fileType === i)) {
                ...
                if ((_a = lib.$el(".guide")) == null ? void 0 : _a.innerHTML.includes("\u5F88\u62B1\u6B49\uFF0C\u60A8\u7684\u6D4F\u89C8\u5668\u4E0D\u652F\u6301\u64AD\u653E\u6B64\u7C7B\u6587\u4EF6")) {
  ...
  async function watchFile() {
    var _a;
    const vue = (_a = lib.$el(".el-carousel")) == null ? void 0 : _a.__vue__;
    if (!vue) {
      return;
    }
  ...
  async function start() {
    var _a, _b;
    const vue = (_a = lib.$el(".guide")) == null ? void 0 : _a.__vue__;
  ...
  function getNextObject() {
    var _a, _b;
    return (_b = (_a = lib.$el(".guide")) == null ? void 0 : _a.__vue__) == null ? void 0 : _b.nextObj;
  }
  async function next() {
    var _a, _b;
    ...
    if (id && (nextObject == null ? void 0 : nextObject.id) !== void 0) {
      if (["\u6D4B\u9A8C", "\u8BA8\u8BBA"].some((i) => nextObject.fileType === i)) {
        ...
        (_a = lib.$el(".preOrNext .next .el-link")) == null ? void 0 : _a.click();
        (_b = lib.$el(".preOrNext .next")) == null ? void 0 : _b.click();
      }
    } else {
      lib.$message.success({
        duration: 0,
  ...
  async function waitForLoad() {
    return new Promise((resolve, reject) => {
      const interval = setInterval(() => {
        var _a;
        if (((_a = lib.$el(".guide")) == null ? void 0 : _a.__vue__) !== void 0) {
          clearInterval(interval);
          resolve();
        }
      }, 1e3);
...
if (
	...
	const open = confirm(
		`木金网课脚本不支持当前的脚本管理器（${GM_info.scriptHandler}）。` +
			'请前往 https://wk.bobo91.com 下载指定的脚本管理器，例如 “Scriptcat 脚本猫” 或者 “Tampermonkey 油猴”'
	);

	if (open) {
		window.location.href = 'https://wk.bobo91.com';
	}
	return;
}
...
(function () {
	...
	start({
		...
		renderConfig: {
			...
			title: `木金-${infos.script.version}`
		},
		updatePage:
			GM_info.scriptHandler === 'Tampermonkey'
				? 'https://scriptcat.org/zh-CN/script-show-page/1476'
				: 'https://scriptcat.org/zh-CN/script-show-page/1476'
	});
})();
