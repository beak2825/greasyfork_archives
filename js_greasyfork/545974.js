// ==UserScript==
// @name    FC | VLADIMIR | Goodman ЖБ без фото
// @name:ru КФ | VLADIMIR | Goodman ЖБ без фото
// @name:uk КФ | VLADIMIR | Goodman ЖБ без фото
// @version 0.0.1
...
// @downloadURL https://update.greasyfork.org/scripts/545974/FC%20%7C%20VLADIMIR%20%7C%20Goodman%20%D0%96%D0%91%20%D0%B1%D0%B5%D0%B7%20%D1%84%D0%BE%D1%82%D0%BE.user.js
// @updateURL https://update.greasyfork.org/scripts/545974/FC%20%7C%20VLADIMIR%20%7C%20Goodman%20%D0%96%D0%91%20%D0%B1%D0%B5%D0%B7%20%D1%84%D0%BE%D1%82%D0%BE.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        '[Color=Flame][CENTER]Ожидайте, когда технический специалист вынесет окончательный вердикт.[/I][/CENTER][/color][/FONT]<br>',
      prefix: PINN_PREFIX,
      prefix: TEXY_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=Flame][CENTER]Ожидайте, когда Главный администратор вынесет окончательный вердикт.[/I][/CENTER][/color][/FONT]<br>',
      prefix: PINN_PREFIX,
      prefix: GA_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=Flame][CENTER]Ожидайте, когда администрация вынесет окончательный вердикт.[/I][/CENTER][/color][/FONT]<br>',
      prefix: PINN_PREFIX,
      prefix: PINN_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Нарушитель будет наказан по данному пункту правил:<br> [Color=Red]2.09[/color]. Запрещено сливать склад фракции / семьи путем взятия большого количества ресурсов или превышая допустимый лимит, установленный лидером | [Color=Red]Ban 15 - 30 дней / PermBan[/color][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman]Примечание: [/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=times new roman]в описании семьи должны быть указаны условия взаимодействия со складом. Если лидер семьи предоставил неограниченный доступ к складу и забыл снять его, администрация не несет ответственности за возможные последствия. Жалобы по данному пункту правил принимаются только от лидера семьи. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br>" +
        "[CENTER][B][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman]Примечание: [/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=times new roman]исключение всех или части игроков из состава семьи без ведома лидера также считается сливом. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]У вас отсутстуют доказательства, что вы являетесь лидером данной семьи.[/CENTER]<br>" +
        "[CENTER]Убедительная просьба прикрепить доказательства, что являетесь лидером данной семьи.[/CENTER]<br><br>" +
        "[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
    ...
    {
      title: 'Описание в фаме для патрон',
	  content:
		'[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
		"[CENTER]Даю вам 24 часа на добавление скриншота с вашим описанием где прописаны лимиты.[/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        '[CENTER][B][COLOR=rgb(238, 119, 0)][FONT=times new roman][SIZE=4]На рассмотрении.[/SIZE][/FONT][/COLOR][/B][/CENTER]',
      prefix: PINN_PREFIX,
	  status: true,
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][B][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman]Примечание: [/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=times new roman]ездить на крышах транспортных средств, бегать или ходить по столам в казино, целенаправленная провокация сотрудников правоохранительных органов с целью развлечения, целенаправленная помеха в проведении различных собеседований и так далее. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][B][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman]Примечание: [/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=times new roman]уходить в AFK при остановке транспортного средства правоохранительными органами, выходить из игры для избежания смерти, выходить из игры во время процесса задержания или ареста, полное игнорирование отыгровок другого игрока, которые так или иначе могут коснуться Вашего персонажа. Уходить в интерьер или зеленую зону во время перестрелки с целью избежать смерти или уйти от Role Play процесса и так далее. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][B][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman]Примечание: [/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=times new roman]нарушением считаются такие действия, как езда на скутере по горам, намеренное создание аварийных ситуаций при передвижении. Передвижение по полям на любом транспорте, за исключением кроссовых мотоциклов и внедорожников. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][B][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman]Исключение: [/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=times new roman]обоюдное согласие обеих сторон. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Нарушитель будет наказан по пункту правил:<br> [Color=Red]2.37[/color]. Запрещены OOC-угрозы, в том числе и завуалированные, а также угрозы наказанием со стороны администрации | [Color=Red]Mute 120 минут / Ban 7 - 15 дней. [/color]<br><br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Нарушитель будет наказан по пункту правил:<br> [Color=Red]2.39[/color]. Злоупотребление нарушениями правил сервера | [Color=Red]Ban 7 - 15 дней [/color][/CENTER]<br><br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[Color=Red]Пример:[/color] если игрок, используя баг, убирает ограничение на использование оружия в зелёной зоне, сбивает темп стрельбы, либо быстро перемещается во время войны за бизнес, перестрелки на мероприятии с семейными контейнерами или на мероприятии от администрации. [Color=Red]Jail на 120 минут[/COLOR]. <br>" +
        "[Color=Red]Исключение:[/color] Разрешается использование сбива темпа стрельбы в войне за бизнес при согласии обеих сторон и с уведомлением следящего администратора в соответствующей беседе.<br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Нарушитель будет наказан по данному пункту правил:<br> [Color=Red]3.20[/color]. Запрещается багоюз связанный с анимацией в любых проявлениях. | [Color=Red]Mute 30 минут [/color]<br>" +
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Нарушитель будет наказан по данному пункту правил:<br> [Color=Red]2.28[/color]. Запрещена покупка/продажа внутриигровой валюты за реальные деньги в любом виде | [Color=Red]| PermBan с обнулением аккаунта + ЧС проекта.[/color][/CENTER]<br><br>" +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Нарушитель будет наказан по пунтку правил:<br> [Color=Red]2.11[/color]. Запрещено использование фракционного транспорта в личных целях | [Color=Red]Jail 30 минут[/color][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        '[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]',
      prefix: ACCСEPT_PREFIX,
      status: false,
    ...
    },
    {
	  ...
	  content:
		...
		"[CENTER]В течение 24-х часов укажите тайм-коды, иначе Ваша жалоба будет отказана.[/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        '[CENTER][B][COLOR=rgb(238, 119, 0)][FONT=times new roman][SIZE=4]На рассмотрение.[/SIZE][/FONT][/COLOR][/B][/CENTER]',
      prefix: PINN_PREFIX,
	  status: true,
    },
    {
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Для написания жалобы на администратора обратитесь сюда - [URL]https://forum.blackrussia.online/forums/Жалобы-на-администрацию.3482/[/URL][/CENTER]<br>" +
        "[CENTER][B][I][FONT=georgia]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-администрацию.3429349/'][Color=Red][U]правилами подачи жалоб на администрацию[/U][/color][/URL].[/CENTER]<br><br>" +
        "[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        '[CENTER][B][COLOR=rgb(255, 0, 0)]✿❯────「[SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman]Отказано. ❖  Закрыто.[/FONT][/COLOR][/SIZE]」────❮✿ [/COLOR][/B] [/CENTER]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia] Данные жалобы нужно писать в раздел [COLOR=rgb(255, 0, 0)]Жалобы на сотрудников.[/COLOR][/CENTER]<br>" +
        "[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(255, 123, 0)][SIZE=4][FONT=times new roman]С уважением Главный куратор форума. [/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        '[CENTER][B][COLOR=rgb(255, 0, 0)]✿❯────「[SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman]Отказано. ❖  Закрыто.[/FONT][/COLOR][/SIZE]」────❮✿ [/COLOR][/B] [/CENTER]',
      prefix: UNACCСEPT_PREFIX,
 ...
 $(document).ready(() => {
    ...
    addButton('ЖБ ответы', 'selectAnswer');
