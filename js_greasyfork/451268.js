// ==UserScript==
    ...
    // @namespace    NightSwan
    // @version      0.38
    // @description  B站评论区自动标注战雷玩家，依据是动态里是否有三相相关内容（基于原神指示器和改进三相一些小的修改）
    ...
    // @license MIT
    // @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/451268/%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B%E5%92%8C%E9%9B%B7%E6%89%B9%E6%8C%87%E7%A4%BA%E5%99%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/451268/%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B%E5%92%8C%E9%9B%B7%E6%89%B9%E6%8C%87%E7%A4%BA%E5%99%A8.meta.js
    // ==/UserScript==
    ...
    (function () {
        ...
        const tag_wth_Inner = "<b style='color: #946845'>" + tag_wth + "</b>"
                    ...
                    GM_xmlhttpRequest({
                        ...
                        onload: function (res) {
                            if (res.status === 200) {
                                ...
                                //添加战争雷霆标签
                                    if (st.includes(keyword_wth)) {
                                        c.innerHTML += tag_wth_Inner
                                        wth.add(pid)
                                    } else {
                                        no_wth.add(pid)
                                    }
