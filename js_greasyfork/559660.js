// ==UserScript==
// @name         FC2PPVDB 自动搜索外部资源
// @namespace    fc2ppvdb_ASVL
// @version      3.3.3
// @description  自动搜索影片的外部资源,包括BT下载,字幕,在线播放等等
// @author       sexjpg
// @match        *://*.fc2ppvdb.com/*
...
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/559660/FC2PPVDB%20%E8%87%AA%E5%8A%A8%E6%90%9C%E7%B4%A2%E5%A4%96%E9%83%A8%E8%B5%84%E6%BA%90.user.js
// @updateURL https://update.greasyfork.org/scripts/559660/FC2PPVDB%20%E8%87%AA%E5%8A%A8%E6%90%9C%E7%B4%A2%E5%A4%96%E9%83%A8%E8%B5%84%E6%BA%90.meta.js
// ==/UserScript==
//
...
`;
    ...
    class SearchManager {
        ...
        async videopageSearch() {
            ...
            //这里是单作品的页面,搜索作品的div
            const article_div = document.querySelector('div#article-info')
            Utils.removeDivs()
            ...
            const NoImage = document.querySelector("img#NoImage")
            if (NoImage) NoImage.remove();
            if (!article_div) return
            const activeSites = await this.getActiveSites();
            const id = article_div.getAttribute("data-videoid")
            //这里的element是需要在哪里添加按钮
            const container = Utils.createDiv();
            const element = article_div.querySelector('h2').parentElement
    ...
    class Utils {
        ...
        static async getCachedResult(key) {
            ...
            if (!cacheData) return null; // 如果无缓存，返 null
