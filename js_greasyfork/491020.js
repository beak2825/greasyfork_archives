// ==UserScript==
// @name        от саяна для саянчика згкфа
// @namespace    https://forum.blackrussia.online
// @version      1.49
// @description  По вопросам обратная связь в Вк: https://vk.com/sayan4ik
// @author       Sayan4ik
...
// @downloadURL https://update.greasyfork.org/scripts/491020/%D0%BE%D1%82%20%D1%81%D0%B0%D1%8F%D0%BD%D0%B0%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B0%D1%8F%D0%BD%D1%87%D0%B8%D0%BA%D0%B0%20%D0%B7%D0%B3%D0%BA%D1%84%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/491020/%D0%BE%D1%82%20%D1%81%D0%B0%D1%8F%D0%BD%D0%B0%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B0%D1%8F%D0%BD%D1%87%D0%B8%D0%BA%D0%B0%20%D0%B7%D0%B3%D0%BA%D1%84%D0%B0.meta.js
// ==/UserScript==
...
const buttons = [
	{
	...
	},
     {
      ...
      content:
	            "[CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER]<br><br>"+
		        " [FONT=georgia][B][CENTER]Ваша жалоба взята на рассмотрение.<br>" +
           ...
           "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
	  prefix: PIN_PREFIX,
	  status: true,
    },
	 {
	...
	"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[FONT=georgia][B][CENTER]Ваша жалоба передана на рассмотрение Главному Куратору Форума.<br>" +
		'Не нужно создавать копии данной темы.<br>' +
		'В противном случае Вам будет выдана блокировка ФА.<br><br>'+
         "[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
           "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума  [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
	...
	},
	{
      ...
      content:
         "[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил<br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
	...
	},
	{
	  ...
	  content:
	    "[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		" [FONT=georgia] [B][CENTER]Скорее всего, Вы ошиблись разделом, напишите эту тему в раздел РП Ситуации<br><br>"+
              "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума  [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
	  status: false,
	},
	{
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 3.04.<br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 3.20.<br>3.20. Запрещено использование транслита в любом из чатов | Mute 30 минут.<br>Пример: «Privet», «Kak dela», «Narmalna».<br><br>" +
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил3.22.<br>3.22. Запрещено публиковать любые объявления в помещениях государственных организаций вне зависимости от чата (IC или OOC) | Mute 30 минут.<br>Пример: в помещении центральной больницы писать в чат: «Продам эксклюзивную шапку дешево!!!»<br><br>"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 3.09.<br>3.09. Запрещены любые угрозы о наказании игрока со стороны администрации | Mute 30 минут.<br><br>"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 2.37.<br>2.37. Запрещены OOC угрозы, в том числе и завуалированные | Mute 120 минут / Ban 7 дней.<br><br>" +
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 2.51.<br>2.51. Запрещено вмешательство в Role Play процесс с целью помехи и препятствования дальнейшего развития Role Play процесса | Jail 30 минут.<br>Пример: вмешательство в Role Play процесс при задержании игрока сотрудниками ГИБДД, вмешательство в проведение тренировки или мероприятия какой-либо фракции и тому подобные ситуации.<br><br>" +
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 2.52.<br>2.52. Запрещено располагать аксессуары на теле персонажа, нарушая нормы морали и этики, увеличивать аксессуары до слишком большого размера. | При первом нарушении - обнуление аксессуаров, при повторном нарушении - обнуление аксессуаров + JAIL 30 минут.<br>Пример: слишком большие аксессуары на голове персонажа, имитация гитарой половых органов и тому подобное.<br><br>" +
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 2.01.<br>2.01 Запрещено поведение, нарушающее нормы процессов Role Play режима игры | Jail 30 минут.<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.03. Запрещен NonRP Drive — вождение любого транспортного средства в невозможных для него условиях, а также вождение в неправдоподобной манере | Jail 30 минут.<br><br>" +
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.47. Запрещено ездить по полям на грузовом транспорте, инкассаторских машинах (работа дальнобойщика, инкассатора) | Jail 60 минут.<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.22. Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками |  Ban 15 - 30 дней / PermBan.<br><br>" +
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 2.09.<br>2.09. Запрещено сливать склад фракции / семьи путем взятия большого количестве ресурсов, или же брать больше, чем разрешили на самом деле | Ban 15 - 30 дней / PermBan<br><br>" +
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
          "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил 2.20<br>2.20. Запрещен Mass DM (Mass DeathMatch) — убийство или нанесение урона без веской IC причины более трем игрокам | Warn / Ban 3 - 7 дней.<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>3.21. Запрещается реклама промокодов в игре, а также их упоминание в любом виде во всех чатах. | Ban 30 дней.<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.43. Запрещена продажа / обмен / покупка поощрительной составляющей от лица проекта, будь то бонус-код, либо промокод, который выдается безвозмездно игрокам в целях промоакций | Mute 120 минут.<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.54. Запрещено неуважительное обращение, неадекватное поведение, угрозы в любом их проявлении по отношению к администрации | Mute 180 минут<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.32. Запрещено введение в заблуждение, обман администрации на всех ресурсах проекта | Ban 7 - 15 дней / PermBan<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>3.10. Запрещена выдача себя за администратора, если таковым не являетесь | Ban 15 - 30 + ЧС администрации<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.40.  Запрещены совершенно любые деструктивные действия по отношению к проекту: неконструктивная критика, призывы покинуть проект, попытки нарушить развитие проекта или любые другие действия, способные привести к помехам в игровом процессе |Mute 300 минут / Ban 30 дней (Ban выдается по согласованию с главным администратором)<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.32. Запрещено введение в заблуждение, обман администрации на всех ресурсах проекта | Ban 7 - 15 дней<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
     {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>2.02 Запрещено целенаправленно уходить от Role Play процесса всеразличными способами | Jail 30 минут / Warn <br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>3.18. Запрещено политическое и религиозное пропагандирование | Mute 120 минут / Ban 10 дней<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил ГОСС 6.01. / 7.01. / 8.01. / 9.01.<br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил ГОСС 2.02.<br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
	{
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил ГОСС 6.02.<br>" +
		'6.02. Запрещено выдавать розыск без Role Play причины | Warn.<br><br>' +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
 ...
 
    {
	...
	},
     {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Ваша РП Биография получает статус:[Color=Green]Одобрено.<br><br>" +
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
           "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
    ...
    },
     {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Ваша РП Биография получает статус: [Color=Red]Отказано.<br><br>" +
    ...
    status: false, 
     ...
     
	 {
      ...
      content:
		...
		" [FONT=georgia] Причиной послужило не дорабатывание своей РП Биографии в течении 24 часов<br>" +
           "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
    },
...
" [FONT=georgia] Причиной послужило написание РП Биографии не по форме<br>" +
    ...
    },
	 {
      title: 'Копипаст',
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+        "[B][CENTER]Ваша РП Биография получает статус: [Color=Red]Отказано.<br><br>" +
...
" [FONT=georgia] Причиной послужило то, что Вы написали мало текста в своей РП Биографии<br>" +
	...
	},
	 {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Ваша РП Ситуация получает статус:[Color=Green]Одобрено.<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
	 {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Ваша РП Ситуация получает статус: [Color=Red]Отказано.<br><br>" +
	...
	" [FONT=georgia] Причиной послужило копирование текста / темы<br>" +
	...
	},
	 {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Ваша Неофициальная РП Организация получает статус:[Color=Green]Одобрено.<br><br>" +
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
	 {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Ваша Неофициальная РП Организация получает статус:[Color=Red]Отказано.<br><br>" +
