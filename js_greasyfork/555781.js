// ==UserScript==
// @name         Challenge Link Generator (Korea)
...
// @downloadURL https://update.greasyfork.org/scripts/555781/Challenge%20Link%20Generator%20%28Korea%29.user.js
// @updateURL https://update.greasyfork.org/scripts/555781/Challenge%20Link%20Generator%20%28Korea%29.meta.js
// ==/UserScript==
...
(function () {
  ...
  const TARGET_SHEET = "Sheet2"; // explicit sheet target for this script

  const MAPS = {
    moving: [
      { name: "AI Gen - South Korea", url: "https://www.geoguessr.com/maps/62b36299fa2c6ce9ff5a34b9" },
      { name: "IntersectionGuessr - South Korea", url: "https://www.geoguessr.com/maps/6116af5212eb690001140bc4" },
      { name: "Coupe De La Ligue", url: "https://www.geoguessr.com/maps/6616313abe08f9b164ba399e" },
    ],
    nomove: [
      { name: "AI Gen - South Korea", url: "https://www.geoguessr.com/maps/62b36299fa2c6ce9ff5a34b9" },
      { name: "IntersectionGuessr - South Korea", url: "https://www.geoguessr.com/maps/6116af5212eb690001140bc4" },
      { name: "An Arbitrary Rural South Korea", url: "https://www.geoguessr.com/maps/644fd252e728ab424d581bfc" },
      { name: "Dirty South Korea", url: "https://www.geoguessr.com/maps/63f3c914d245ea5a477d80a9" },
      { name: "South Korea (No Move)", url: "https://www.geoguessr.com/maps/6034c934dcef4f0001aff904" }
    ],
    nmpz: [
      { name: "AI Gen - South Korea", url: "https://www.geoguessr.com/maps/62b36299fa2c6ce9ff5a34b9" },
      { name: "An Arbitrary Rural South Korea", url: "https://www.geoguessr.com/maps/644fd252e728ab424d581bfc" },
  ...
  function createPanel(){
    ...
    p.innerHTML = `
      <div style="font-weight:bold;margin-bottom:6px">Korea Generator</div>
      <div>
  ...
  // moving: 42.5%, nomove: 42.5%, nmpz: 15%
  function pickMode(pref){
    if (pref && pref!=='any') return pref;
    const r = Math.random();
    if (r < 0.425) return 'moving';
    if (r < 0.425 + 0.425) return 'nomove';
    return 'nmpz';
  }
  ...
  async function waitForLoadAndCreate(forcedMode, forcedTimer, mapName, rqId){
    ...
    const clickGenerate = async () => {
      try {
        ...
        // 2) Try the wrapper-specific button (the element you pasted)
        const wrapperBtn = document.querySelector('.function-lock_blurWrapper__NlD1J button');
