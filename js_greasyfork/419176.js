...
// @version 2022.05.07
// @license WTFPL
// @namespace https://greasyfork.org/en/scripts/419176-get-watcher-2
...
// @downloadURL https://update.greasyfork.org/scripts/419176/Get%20Watcher%202.user.js
// @updateURL https://update.greasyfork.org/scripts/419176/Get%20Watcher%202.meta.js
// ==/UserScript==
//<!doctype html><html><head><meta http-equiv="x-ua-compatible" content="ie=edge"></head><body id="hta"><script>
'use strict';

var version='2022.05.07'

var boards='3 a aco adv an asp b bant biz c cgl ck cm co d diy e f fa fit g gd gif \
h hc his hm hr i ic int jp k lgbt lit m mlp mu n news o out p po pol pw qa qst r r9k \
s s4s sci soc sp t tg toy trash trv tv u v vg vip vm vmg vp vr vrpg vst vt w wg wsg wsr x xs y'.split(' ')
