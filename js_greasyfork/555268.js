// ==UserScript==
// @name         VoltageComicsDownloader
// @namespace    https://github.com/Timesient/manga-download-scripts
// @version      0.1
// @license      GPL-3.0
// @author       Timesient
// @description  Manga downloader for voltage-comics.com
// @icon         https://asset.voltage-comics.com/src/volbs/img/ico_180.png
// @homepageURL  https://greasyfork.org/scripts/555268-voltagecomicsdownloader
...
// @downloadURL https://update.greasyfork.org/scripts/555268/VoltageComicsDownloader.user.js
// @updateURL https://update.greasyfork.org/scripts/555268/VoltageComicsDownloader.meta.js
// ==/UserScript==
...
(async function(axios, JSZip, saveAs, ImageDownloader) {
  ...
  const config = await axios({
    method: 'GET',
    url: `https://voltage-comics.com/sws/bibGetCntntInfo?cid=${cid}&dmytime=${Date.now()}&k=${randomString}`
  }).then(res => {
  ...
  ImageDownloader.init({
    ...
    getImagePromises,
    title: config.title || `package_${Date.now()}`
  });
