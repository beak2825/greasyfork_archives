// ==UserScript==
// @name                 UTags Advanced Filter
// @name:zh-CN           UTags Advanced Filter
...
// @downloadURL https://update.greasyfork.org/scripts/556095/UTags%20Advanced%20Filter.user.js
// @updateURL https://update.greasyfork.org/scripts/556095/UTags%20Advanced%20Filter.meta.js
// ==/UserScript==
//
;(() => {
  "use strict"
  ...
  async function loadFilterSettings() {
    try {
      const saved = await getValue2(CONFIG.FILTERS_KEY)
      return saved || {}
    } catch (e) {
      return {}
    }
  ...
  async function saveFilterSettings(settings2) {
    try {
      ...
      await setValue2(CONFIG.FILTERS_KEY, Object.assign({}, prev, settings2))
    } catch (e) {}
  }
  async function loadGlobalState() {
    try {
      const saved = await getValue2(CONFIG.GLOBAL_KEY)
      return saved || {}
    } catch (e) {
      return {}
    }
  ...
  async function saveGlobalState(settings2) {
    try {
      ...
      await setValue2(CONFIG.GLOBAL_KEY, Object.assign({}, prev, settings2))
    } catch (e) {}
  }
  ...
  async function injectGreasyForkFilters() {
    ...
    host2.id = "utaf-host"
    host2.style.cssText = "position:fixed;top:12px;right:12px;z-index:99999;"
    ...
    globalCss.textContent = content_host_default
    ...
    async function resetAll() {
      try {
        await setValue2(CONFIG.FILTERS_KEY, { uiCollapsed: false })
      } catch (e) {}
