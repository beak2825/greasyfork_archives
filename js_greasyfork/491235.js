...
(function () {
    ...
    function delayedFunction() {
        !function (t, e) {
            ...
            var M = "__hooks_load_module", _ = Object.getOwnPropertyNames.bind(Object),
            ...
            var j = window, D = new Proxy({}, {
                ...
                if (!R()) {
                    ...
                    var r;
                    if (e.unshift("[TimerHook]"), "function" == typeof D.log) D.log(e.join(" ")); else (r = console).log.apply(r, e)
                }
            }, N = function () {
                if (!R()) {
                ...
                return n(e, [{
                    key: "mountHost", value: function (t) {
                    ...
                    key: "getDependencyModule", value: function (t) {
                        if (null != this.host) {
                    ...
                    key: "setConfig", value: function (t, e) {
                        var n = this.getDependencyModule("configs");
                        n && n.available() || N("Config module not found, can't set configs values."), n.setValue(this.moduleIdentityName, t, e)
                    }
                }, {
                    key: "getConfig", value: function (t) {
                        var e, n = this.getDependencyModule("configs"), r = (this.declareConfigs().find((function (e) {
                            return e.key === t
                        })) || {}).default;
            ...
            var U = function (e) {
                ...
                return n(a, [{
                    key: "onRateChange", value: function (t) {
                        this.rate = t
                    }
                }, {
                    key: "mountHost", value: function (t) {
            ...
            var H = function (e) {
                ...
                function a() {
                    ...
                    t(this, a);
                    for (var n = arguments.length, i = new Array(n), u = 0; u < n; u++) i[u] = arguments[u];
                    return l(r(e = o.call.apply(o, [this].concat(i))), "isDOMLoaded", !1), l(r(e), "waitDomLoadedCallback", void 0), e
                }
                ...
                return n(a, [{
                    ...
                    key: "waitDomLoaded", value: function () {
                        var t, e, n, r = this;
                    ...
                    key: "applyStyle", value: function (t) {
                        var e = this.style(), n = this.document.createElement("style");
                        if (n.setAttribute("type", "text/css"), n.styleSheet) n.styleSheet.cssText = e; else {
                    ...
                    key: "applyElement", value: function () {
                        var t = this.element();
                    ...
                    key: "init", value: function () {
                        var t = this;
                        P("Started to loading '".concat(this.moduleIdentityName, "' component...")), this.waitDomLoaded().then((function () {
                            t.applyStyle(t.applyElement()), P("UI component '".concat(t.moduleIdentityName, "' loaded."))
                        }))
                    }
                }]), a
            }(U);
            ...
            var q = "hook_timer__change_rate", F = function (e) {
                i(a, e);
                var o = W(a);
                ...
                function a() {
                    ...
                    t(this, a);
                    for (var n = arguments.length, i = new Array(n), u = 0; u < n; u++) i[u] = arguments[u];
                    return l(r(e = o.call.apply(o, [this].concat(i))), "rate", 1), l(r(e), "state", "preparing"), l(r(e), "setIntervalOrigin", void 0), l(r(e), "clearIntervalOrigin", void 0), l(r(e), "inTimeCheckId", void 0), e
                }
                ...
                return n(a, [{
                    ...
                    key: "speedDown", value: function (t) {
                        null == t && (t = this.getConfig("decrementRate")), this.setSpeed(this.rate - t)
                    }
                }, {
                    key: "speedUp", value: function (t) {
                        null == t && (t = this.getConfig("incrementRate")), this.setSpeed(this.rate + t)
                    }
                }, {
                    key: "speedDivide", value: function (t) {
                        null == t && (t = this.getConfig("divideRate")), this.setSpeed(this.rate / (t || 1))
                    }
                }, {
                    key: "speedMultiply", value: function (t) {
                        null == t && (t = this.getConfig("multiplyRate")), this.setSpeed(this.rate * (t || 1))
                    }
                }, {
                    key: "onRateChanged", value: function (t) {
                        P("Timer speed rate changed to:", t), this.sentChangesToIframe(), this.getAllActivateModules().filter((function (t) {
                    ...
                    key: "beginInTimeCheck", value: function () {
                        var t = this;
                    ...
                    key: "launchModules", value: function (t) {
                        var e = this;
                        t.filter((function (t) {
                    ...
                    key: "registerModules", value: function (t) {
                        var e = this;
                    ...
                    key: "waitForModulesLoad", value: function () {
                        var t = this, e = this.getWindow().___hooks_preModules || [];
                    ...
                    key: "exportOuter", value: function () {
                        var t = this;
                    ...
                    key: "listenParentEvent", value: function () {
                        var t = this;
                    ...
                    key: "deactivateModules", get: function () {
                        return this.getConfig("deactivateModules")
                    }
                }, {
                    key: "sentChangesToIframe", value: function () {
                        var t = this.getWindow().document, e = t.querySelectorAll("iframe") || [],
                            n = t.querySelectorAll("frame");
                        if (e.length) for (var r = 0; r < e.length; r++) e[r].contentWindow.postMessage({
                            type: q,
                            rate: this.rate
                        }, "*");
                        if (n.length) for (var o = 0; o < n.length; o++) n[o].contentWindow.postMessage({
                            type: q,
                            rate: this.rate
                        }, "*")
                    }
                    ...
                    key: "declareConfigs", value: function () {
                        return [{key: "multiplyRate", type: f.NUMBER, default: 2}, {
                            key: "divideRate",
                            type: f.NUMBER,
                            default: 2
                    ...
                    key: "setConfig", value: function (t, e) {
                        ...
                        n && n.available() || N("Config module not found, can't set configs values."), n.setValue("host", t, e)
                    }
                }, {
                    key: "getConfig", value: function (t) {
                        var e, n = this.getModule("configs"), r = (this.declareConfigs().find((function (e) {
                            return e.key === t
                        })) || {}).default;
                ...
                return n(e, [{
                    key: "activateModule", value: function (t) {
                        var e = this.getModule(t);
                        e ? (e.activate(), P("Module - '".concat(t, "' activated"))) : N("Activate module failed, ".concat(t, " is not found"))
                    }
                }, {
                    key: "deactivateModule", value: function (t) {
                        var e = this.getModule(t);
                        e || N("Deactivate module failed, '".concat(t, "' is not found")), e.deactivate()
                    }
                }, {
                    ...
                    key: "registerModule", value: function (t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                        e && v() || (this.modules[t.moduleIdentityName] = t, t.mountHost(this))
                    }
                }, {
                    key: "getAllActivateModules", value: function () {
                        return Object.values(this.modules).filter((function (t) {
                            return t.isActive
                        }))
                    }
                }, {
                    key: "getAllModules", value: function () {
                        return Object.values(this.modules)
                    }
                }, {
                    key: "getWindow", value: function () {
                        return p()
                    }
                }]), e
            }());
                ...
                instanceType: function (t) {
                    ...
                    return ut(n, [{
                        ...
                        key: "bind", value: function (t) {
                            ...
                            return yt((e = lt(Z(n.prototype), "bind", this)).call.apply(e, [this, t].concat(it(r))), this)
                        }
                    }, {
                        ...
                        key: "surround", value: function (t) {
                            ...
                            return "function" != typeof l ? l : yt((function () {
                                ...
                                try {
                                    ...
                                    })), y) ? h : (d = h instanceof Promise && c ? h.then((function () {
                                        return l.apply(t, r)
                                    })) : l.apply(this, r), "function" == typeof o && (d = d instanceof Promise && c ? d.then((function (e) {
                                        return o.call(t, Object.assign({}, s, {lastValue: e}))
                                    })) : o.call(this, Object.assign({}, s, {lastValue: d}))), d instanceof Promise && c && f ? d.catch((function (e) {
                                        var n = !1, r = "";
                                    ...
                                    if (!f) throw t;
                                    var p = !1, v = "", g = function (t) {
                                        v = t, p = !0
                                    }, m = a.call(this, Object.assign({}, s, {error: t, resolve: g}));
                                    if (!p) throw t;
                                    return v || m
                                }
                            }), this)
            ...
            var bt, wt = {protect: !1, syncDesc: !0, native: !1}, kt = Object.defineProperty,
                xt = Object.defineProperties;

            function Ot(t, e, n) {
                var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, o = t[e];
                if ("function" == typeof o) {
                    var i = Object.assign({}, wt, r), a = i.native, u = n(a ? o : mt(o));
                    t[e] = a ? u : function () {
                        for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
                        try {
            ...
            var Tt = function (e) {
                ...
                function a() {
                    ...
                    t(this, a);
                    for (var n = arguments.length, i = new Array(n), u = 0; u < n; u++) i[u] = arguments[u];
                    return l(r(e = o.call.apply(o, [this].concat(i))), "percentage", void 0), l(r(e), "interval", {}), l(r(e), "timeout", {}), l(r(e), "setIntervalOrigin", void 0), l(r(e), "setTimeoutOrigin", void 0), l(r(e), "clearIntervalOrigin", void 0), l(r(e), "clearTimeoutOrigin", void 0), e
                }
                ...
                return n(a, [{
                    ...
                    key: "init", value: function () {
                        var t = this;
                        this.percentage = 1 / this.rate, _t(this.window, "setInterval", (function (e) {
                    ...
                    key: "onRateChange", value: function (t) {
                        ...
                        B(c(a.prototype), "onRateChange", this).call(this, t), this.percentage = 1 / t, Object.values(this.interval).forEach((function (t) {
                            ...
                            var n = Date.now(), r = t.exceptNextFireTime, o = t.oldPercentage, i = r - n;
                            i < 0 && (i = 0);
                    ...
                    key: "notifyExec", value: function (t) {
                        var e = this;
                    ...
                    key: "redirectNewestId", value: function (t) {
                        var e = t[0];
                    ...
                    key: "getHookedTimerFunction", value: function (t, e) {
                        var n = t, r = this;
                        return function () {
                            for (var t = arguments.length, o = new Array(t), i = 0; i < t; i++) o[i] = arguments[i];
                            var a = y(), u = o[0];
                            "string" == typeof u && (r.window.__timer = {notifyExec: r.notifyExec.bind(r)}, u += ";__timer.notifyExec(" + a + ")", o[0] = u), "function" == typeof u && (o[0] = function () {
            ...
            var Et, jt = function (e) {
                ...
                function a() {
                    ...
                    t(this, a);
                    for (var n = arguments.length, i = new Array(n), u = 0; u < n; u++) i[u] = arguments[u];
                    return l(r(e = o.call.apply(o, [this].concat(i))), "DateOrigin", void 0), l(r(e), "DateModified", void 0), l(r(e), "rate", 1), l(r(e), "lastDatetime", void 0), l(r(e), "lastMDatetime", void 0), e
                }
                ...
                return n(a, [{
                    ...
                    key: "hookedDate", value: function () {
                        ...
                        _t(this.window, "Date", (function (e) {
                            var r = function (e) {
                                ...
                                function o() {
                                    ...
                                    if (0 === i.length) {
                                        var u = n.DateOrigin.now(), c = u - n.lastDatetime, l = c * n.rate;
                        ...
                        })), this.DateModified = this.window.Date, _t(this.DateModified, "now", (function () {
                            return function () {
            ...
            var Lt = function (e) {
                ...
                return n(o, [{
                    key: "init", value: function () {
                        var t = this, e = this.shortcutList;
                        this.window.addEventListener("keydown", (function (n) {
                            var r, o = Dt(e);
                            try {
                                for (o.s(); !(r = o.n()).done;) {
                                    var i = r.value;
                                    I(n, i) && (n.preventDefault(), n.stopPropagation(), i.operator(t.host))
                                }
                            } catch (t) {
                                o.e(t)
                            } finally {
                    ...
                    key: "shortcutList", get: function () {
                        ...
                        return [["shortcutExpressions.+", function (t) {
                            ...
                            return e = t, "string" == typeof (n = Object.assign({}, e, {conditions: []})).expressions && (n.expressions = n.expressions.split(";")), n.expressions && n.expressions instanceof Array && (n.conditions = n.expressions.map((function (t) {
                                return function (t) {
                                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "+",
            ...
            function Gt(t) {
                var e, n = {}, r = Vt(Object.entries(t).filter((function (t) {
                    var e = w(t, 1)[0];
                    return !["target", "key"].includes(e)
                })));
                try {
                    for (r.s(); !(e = r.n()).done;) {
                        var o = w(e.value, 2), i = o[0], a = o[1];
                        n[i] = a
                    }
                } catch (t) {
                    r.e(t)
            ...
            var Ht = function (e) {
                ...
                function a() {
                    ...
                    t(this, a);
                    for (var n = arguments.length, i = new Array(n), u = 0; u < n; u++) i[u] = arguments[u];
                    return l(r(e = o.call.apply(o, [this].concat(i))), "defines", []), l(r(e), "definePropertiesOrigin", void 0), l(r(e), "definePropertyOrigin", void 0), e
                }
                ...
                return n(a, [{
                    ...
                    key: "init", value: function () {
                        ...
                        Mt(this.window.Object, "defineProperties", (function (e) {
                            var n, r = e.args, o = w(r, 2), i = o[0], a = o[1],
                                u = Object.entries(a).map((function (e) {
                                    var n = w(e, 2), o = n[0], a = n[1], u = Object.assign({target: i, key: o}, a);
                                    return t.hookDefine(u) ? (r[0] = u.target, [u.key, Gt(u)]) : [!1]
                                })).filter((function (t) {
                                    return w(t, 1)[0]
                                }));
                            ...
                            var n = e.args, r = e.preventDefault, o = w(n, 3), i = o[0], a = o[1], u = o[2],
                                c = Object.assign({target: i, key: a}, u);
                            t.hookDefine(c) ? (n[0] = c.target, n[1] = c.key, n[2] = Gt(c)) : r()
                        }))
                    }
                }, {
                    key: "hookDefine", value: function (t) {
                    ...
                    key: "applyDefineRole", value: function (t) {
                        this.defines.push(t)
                    }
                }, {
                    key: "moduleIdentityName", get: function () {
            ...
            var Ft = function (e) {
                ...
                return n(a, [{
                    key: "init", value: function () {
                        var t = this;
                        !function (t, e, n) {
                            Rt(t, e, "after", n, arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {})
                    ...
                    key: "querySelectorAll", value: function (t) {
            ...
            var Kt = function (e) {
                ...
                return n(o, [{
                    ...
                    key: "unlockPlaybackRate", value: function (t) {
                        delete t.playbackRate, delete t.playbackRate, delete t.playbackRate
                    }
                }, {
                    key: "definitionModule", get: function () {
                        return this.getDependencyModule("definition")
                    }
                }, {
                    key: "preventPlaybackRateLock", value: function () {
                        var t = this.definitionModule;
                        t ? t.applyDefineRole((function (t) {
                            if (t.target instanceof HTMLVideoElement && "playbackRate" === t.key) return N("已阻止对该网站视频视频倍率的锁定"), !0
                        })) : N("`Video Speed Module`, dependency: `definition` module is required.")
                    }
                }, {
                    key: "allVideoElements", get: function () {
                        var t = this.getDependencyModule("shadowDOM");
                        return t || N("`Video Speed Module`, dependency: `shadowDOM` module is required."), [].concat(Wt(t ? t.querySelectorAll("video") : []), Wt(this.document.querySelectorAll("video")))
                    }
                }, {
                    key: "moduleIdentityName", get: function () {
                        return "videoSpeed"
            ...
            var Qt = function (e) {
                ...
                return n(o, [{
                    ...
                    key: "openPage", value: function (t) {
                        "function" == typeof D.openInTab ? D.openInTab(t, {active: !0}) : this.window.open(t)
                    }
                }, {
                    key: "init", value: function () {
                        var t = this;
                        B(c(o.prototype), "init", this).call(this), "function" == typeof D.registerMenuCommand && (D.registerMenuCommand("主页", (function () {
                    ...
                    key: "getAllConfigs", value: function () {
                        var t = this;
                        return this.getDeclaredConfigurations().map((function (e) {
                            var n = t.getValue(e.namespace, e.key);
                            return Object.assign({}, e, {value: null != n ? n : e.default})
                        }))
                    }
                }, {
                    key: "getDeclaredConfigurations", value: function () {
                        return g([this.host.declareConfigs().map((function (t) {
                            ...
                            return t.declareConfigs().map((function (e) {
                                return Object.assign({}, e, {namespace: t.moduleIdentityName, modelName: t.moduleName})
                            }))
                        })))))
                    }
                }, {
                    ...
                    key: "saveAllConfigs", value: function (t) {
                        var e = this;
                    ...
                    key: "available", value: function () {
                        return !!this.storage && this.storage.available()
                    }
                }, {
                    key: "resetAll", value: function () {
                        var t = this;
                ...
                return n(e, [{
                    ...
                    key: "available", value: function () {
                        return null == this.isAvailable && (this.isAvailable = [a(D.setValue), a(D.getValue), a(D.listValues), a(D.deleteValue)].every((function (t) {
                            return "function" === t
                        }))), this.isAvailable
                    }
                }]), e
            ...
            var te = function (e) {
                ...
                function a() {
                    ...
                    t(this, a);
                    for (var n = arguments.length, i = new Array(n), u = 0; u < n; u++) i[u] = arguments[u];
                    return l(r(e = o.call.apply(o, [this].concat(i))), "nodeElement", void 0), l(r(e), "clickMapper", {
                ...
                return n(a, [{
                    ...
                    key: "genElement", value: function () {
                        ...
                        return Object.keys(this.clickMapper).forEach((function (n) {
                            var r = e.clickMapper[n], o = t.getElementsByClassName(n)[0];
                    ...
                    key: "style", value: function () {
                        var t = this.position, e = this.positionOffset, n = "right" === t ? "left" : "right",
                            r = "left" === t;
                    ...
                    key: "onUiRateChange", value: function (t) {
                        if (B(c(a.prototype), "onUiRateChange", this).call(this, t), this.nodeElement) {
                            var e = this.nodeElement.querySelector("._th-click-hover") || {},
                                n = this.nodeElement.querySelector("._th_times") || {}, r = this.displayNum;
                            e.innerHTML = "x" + r, n.innerHTML = "x" + r;
                            var o = this.nodeElement.querySelector("._th_cover-all-show-times") || {};
                            o.className = "_th_cover-all-show-times", this.setTimeoutOrigin.bind(this.window)((function () {
                    ...
                    key: "declareConfigs", value: function () {
                        return [{key: "position", type: f.STRING, default: "left"}, {
                            key: "positionOffset",
                            type: f.STRING,
                            default: "20%"
                        }, {
                        ...
                        }, {key: "deeplyColor", type: f.BOOLEAN, default: !0, title: "Deeply Color"}]
                    }
                }]), a
            }(H), ee = new F;
