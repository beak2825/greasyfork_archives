...
// @version      1.5
// @description  我的九尾狐奶奶呀，毛概每次测试都不及格，算了还是用笨办法吧。获取答案通过历史测试的试题解析，或者多做我的考试里面的无限次数测试来增加答案。支持我的考试，我的课程，成绩分析，题库练习，试卷分析。暂不更新了，等要用的时候再说吧。用谷歌浏览器！用谷歌浏览器！用谷歌浏览器！其他浏览器会有bug，不保证能正确运行。
// @author       Aisen
...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/404599/%E9%AB%98%E6%A0%A1%E8%80%83%E8%AF%95%E7%BD%91%28gaoxiaokaoshicom%29%E5%BB%BA%E7%AB%8B%E6%9C%AC%E5%9C%B0%E9%A2%98%E5%BA%93%E8%87%AA%E5%8A%A8%E6%B5%8B%E8%AF%95.user.js
// @updateURL https://update.greasyfork.org/scripts/404599/%E9%AB%98%E6%A0%A1%E8%80%83%E8%AF%95%E7%BD%91%28gaoxiaokaoshicom%29%E5%BB%BA%E7%AB%8B%E6%9C%AC%E5%9C%B0%E9%A2%98%E5%BA%93%E8%87%AA%E5%8A%A8%E6%B5%8B%E8%AF%95.meta.js
// ==/UserScript==
var $ = window.jQuery;
var out = {};
var setting = {
    flag: true, //自动答题，默认开启，关闭为false
    minTime:1,//自动答题，每道题最小等待时间,单位毫秒，默认一秒。
    randomTime: 2, //自动答题，每道题随机等待时间,单位毫秒，默认两秒。总答题答题时间=最小答题时间+随机时间。默认总答题答题时间为1到3秒
...
function doTest() {
   ...
   var type = 1;
    try {
        ...
        var timer = setInterval(justDo, setting.minTime);
		function justDo() {
            if (nextFlag) {
                ...
                i++;
				clearInterval(timer);
				timer = setInterval(justDo, Math.ceil(Math.random()*setting.randomTime + setting.minTime))
...
function pannel() {
    ...
    html += '<div class="answers"><a href=\"http://www.aisencode.cn" target=\"_blank\">Aisen的博客(゜-゜)つロ 干杯~</a> <a href="javascript:" class="append">导入\\出题库</a></div>'
    html += '<div class="askMe">'
    html += '<a href="http://wpa.qq.com/msgrd?v=3&uin=201826658&site=qq&menu=yes" target="_blank">脚本反馈、脚本定制'
    html += '</div>'
