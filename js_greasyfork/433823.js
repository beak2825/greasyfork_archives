...
// @downloadURL https://update.greasyfork.org/scripts/433823/Ohne%20stein%20-%20GRCR.user.js
// @updateURL https://update.greasyfork.org/scripts/433823/Ohne%20stein%20-%20GRCR.meta.js
// ==/UserScript==
        ...
        f.iron, f.power = -1 < c.url.indexOf("decrease_build_time_with_favor") ? 400 : 0, RepConv.Debug && console.log(f)), $.each(Layout.wnd.getAllOpen(), function(c, d) {
          ...
          switch(c.getController()) {
            ...
            case "wonders":
              ...
              RepConv.Debug && console.log(d);
              try {
RepConv.settings[RepConv.Cookie + "_wonder_trade"] && 0 < d && (WorldWonders.spinners.wood.setValue(d / 2), WorldWonders.spinners.iron.setValue(d / 2));
              } catch (Ia) {
              }
              va(c);
              break;
