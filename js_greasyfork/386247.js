...
// @downloadURL https://update.greasyfork.org/scripts/386247/For%20my%20mai.user.js
// @updateURL https://update.greasyfork.org/scripts/386247/For%20my%20mai.meta.js
// ==/UserScript==
...
$('#btn-play').text('Mai Rekt Noobs <3 ');
$('#btn-servers').text('Mais Room');
$('#profile-clan-membership').text('Mai Queen <3');
$(".main-bottom-left").append('<a id="<3" href="https://agario-skins.org/custom-skins/heart" target="_blank">Mai <3</a>');
$("#umdiscord").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "#fff",
...
$("#main-content").append('<a id="umroster" href="https://www.youtube.com/channel/UCvI_A9uzOxwZRcECp0a2BUg" target="_blank">My Queens Channel</a>');
$("#umroster").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "#fff",
...
console.log("%cMai <3 Script is enabled. Message Arrow(Arrow#3144) on discord for needed help.", "font-size: 25px; font-weight: bold; background: red; color: white; padding: 10px; border: solid 2px orange;");
