// ==UserScript==
// @name         Cinema Mode for notalone.tv
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/388167/Cinema%20Mode%20for%20notalonetv.user.js
// @updateURL https://update.greasyfork.org/scripts/388167/Cinema%20Mode%20for%20notalonetv.meta.js
// ==/UserScript==
...
var playerSizeRatio = 465.34 / 826;
...
function toggleCinemaMode () {
    ...
    if (!cinemaModeOn) {
        ...
        underChatBlock.css ('display', 'none');
        player.parent ().css ('height', '100%');
        player.css ('width', '86%');
        player.find ('div#player').css ('height', '87%');
        chat.css ('width', '14%');
        chat.find ('div.box').attr ('style', 'height: 100%; background-image: none; background-color: #2a2b30;');
        ...
        mainBox.removeAttr ('class');
        mainBox.attr ('style', 'position: absolute; width: 100%; height: 100%; padding: 0; background-color: #2a2b30;');
        ...
        underChatBlock.removeAttr ('style');
        ...
        mainBox.attr ('class', 'own-mainbox');
...
$(document).ready (function () {
    ...
    $('div.own-mainbox').attr ('id', 'mainBox');
