...
// @downloadURL https://update.greasyfork.org/scripts/23444/SGW%20Lister%20PostingsSales%20Filterer.user.js
// @updateURL https://update.greasyfork.org/scripts/23444/SGW%20Lister%20PostingsSales%20Filterer.meta.js
// ==/UserScript==
...
console.dir(myInfo);
if ((myInfo['sup'] == true || myInfo['sup'] == "true") && myInfo['dept'] != 'all') {
...
$('table:contains("Item Title")').next().hide();