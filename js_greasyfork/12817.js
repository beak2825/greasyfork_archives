...
// @grant 		 	none
// @downloadURL https://update.greasyfork.org/scripts/12817/IMDB%20Watch%20Now%20Plus.user.js
// @updateURL https://update.greasyfork.org/scripts/12817/IMDB%20Watch%20Now%20Plus.meta.js
// ==/UserScript==

(function() {
  var debug = true;

  var newWindowIconSrc = "data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2210%22%20height%3D%2210%22%3E%3Cg%20transform%3D%22translate%28-826.429%20-698.791%29%22%3E%3Crect%20width%3D%225.982%22%20height%3D%225.982%22%20x%3D%22826.929%22%20y%3D%22702.309%22%20fill%3D%22%23fff%22%20stroke%3D%22%2306c%22%2F%3E%3Cg%3E%3Cpath%20d%3D%22M831.194%20698.791h5.234v5.391l-1.571%201.545-1.31-1.31-2.725%202.725-2.689-2.689%202.808-2.808-1.311-1.311z%22%20fill%3D%22%2306f%22%2F%3E%3Cpath%20d%3D%22M835.424%20699.795l.022%204.885-1.817-1.817-2.881%202.881-1.228-1.228%202.881-2.881-1.851-1.851z%22%20fill%3D%22%23fff%22%2F%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E";
...
// ----------------------------- TV and Movie Title Pages -------------------------
  ...
  function getTitleInfo(){
    var titleRaw = $.trim($($("h1.header span")[0]).text());
  ...
  function ensureParentDiv(){
    var sidebar = $("div#maindetails_sidebar_bottom");
  ...
  function getWatchNowSitesContainerDiv() {
    ...
    ensureParentDiv();
    var parentDiv = $("div#maindetails_sidebar_bottom div.aux-content-widget-5 > div.contextual > div.main");
  ...
  */
  function createSiteItem(options){
    ...
    if(options.searchParams) {
      ...
      newWindowImg = "<a href='#' " + newWinOnclick + " title='open in new window'><img src='" + newWindowIconSrc + "'></a>";
    }
    else{
      href = options.directPath ? options.directPath : options.searchPath;
      newWindowImg = "<a href='" + href +"' target='_blank' title='open in new window'><img src='" + newWindowIconSrc + "'></a>";
    }
