// ==UserScript==
// @name       Manga Loader Fix
// @version    1.11.5
// @description  for my personal use fix css for mangatown mobile, all credit goes to fuzetsu.
...
// @match *://m.mangatown.com/manga/*/*
// -- FOOLSLIDE END
// @namespace https://greasyfork.org/users/78766
// @downloadURL https://update.greasyfork.org/scripts/24674/Manga%20Loader%20Fix.user.js
// @updateURL https://update.greasyfork.org/scripts/24674/Manga%20Loader%20Fix.meta.js
// ==/UserScript==
...
var implementations = [{
  ...
  name: 'manga-town',
  match: "^https?://m.mangatown.com/manga/[^/]+/[^/]+",
  img: '#image',
  next: '#viewer a',
  numpages: '.ch-select select',
  curpage: '.page_select select',
  nextchap: '#top_chapter_list',
  prevchap: '#top_chapter_list',
  wait: 1000
