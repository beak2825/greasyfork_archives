...
// @namespace    https://openuserjs.org/users/Ilya_Gubernov

// @version      1.4
// @description  my skills
// @author       Ilya_Gubernov
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      h/forum.blackrussia.online/index.php?threads/
// @icon         https://icons.iconarchive.com/icons/aha-soft/iron-man/48/Ironman-Mask-3-Old-icon.png
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/465267/Forum%20Script%20for%20%D0%93%D0%A1%D0%97%D0%93%D0%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/465267/Forum%20Script%20for%20%D0%93%D0%A1%D0%97%D0%93%D0%A1.meta.js
// ==/UserScript==
...
`[FONT=georgia] [[COLOR=red] Примечание: [/COLOR] После одобрение, с вами свяжится Старшая Администрация. Вам будет необходимо добавить представителя старшей администрации в друзья, после вас добавят в специальную беседу.<br>`+
  `Никто из состава администрации не будет просить у вас все различные пароли, пин-коды, информация о привязках и так далее. Не ведитесь на обманы!`,
        ...
        {
            title: `В раздел жалоб на сотрудников`,
    ...
    $(document).ready(() => {
        ...
        addButton(`Меню Gubernov`, `selectAnswer`);
