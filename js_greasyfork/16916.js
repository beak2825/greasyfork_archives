// ==UserScript==
// @name         The West - Secteurs BDF
// @version      1.02
// @description  Affiche une carte des secteurs
// @author       Thathanka Iyothanka
// @include		http*://*.the-west.*/game.php*
// @include		http*://*.the-west.*.*/game.php*
// @grant        none
// @namespace https://greasyfork.org/users/13941
// @downloadURL https://update.greasyfork.org/scripts/16916/The%20West%20-%20Secteurs%20BDF.user.js
// @updateURL https://update.greasyfork.org/scripts/16916/The%20West%20-%20Secteurs%20BDF.meta.js
// ==/UserScript==
...
(function (fn) {
    ...
    var maps = ['https://i.imgur.com/4BopidM.png','https://i.imgur.com/sbRlHau.png','https://i.imgur.com/K1KfBod.png']
    ...
    var button = '<div class="fort_battle_button button_store" title="'+'Afficher la carte des secteurs'+'"></div>'
