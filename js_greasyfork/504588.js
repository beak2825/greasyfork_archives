...
// @license      NOME
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/504588/%E5%B9%B2%E9%83%A8%E5%9C%A8%E7%BA%BF.user.js
// @updateURL https://update.greasyfork.org/scripts/504588/%E5%B9%B2%E9%83%A8%E5%9C%A8%E7%BA%BF.meta.js
// ==/UserScript==
(function () {
  'use strict';
    function open() {
...
//let video = document.getElementsByTagName('video')
  ...
  //  video[0].currentTime = video[0].duration-10
   ...
   //播放次数 列表
      var sum = document.querySelectorAll("div[class*='menuch']").length;
      var liebiao = document.getElementsByClassName("menu_item").length;
         ...
         if (video.currentTime < video.duration -60){
           ...
           setTimeout(()=>{window.close();},1000)
                // setTimeout(() => { location.reload();},1000)
                    ...
                    document.getElementsByClassName("menu_item")[sum].click();
