...
// @downloadURL https://update.greasyfork.org/scripts/383429/wsmud_funny.user.js
// @updateURL https://update.greasyfork.org/scripts/383429/wsmud_funny.meta.js
// ==/UserScript==
    ...
    addListener(function(event, message) {
        if (message.type === "text") {
            if (/重新连线|欢迎登陆/.test(message.text)) {
                ...
                if (login === false) {
                    login = true;
                    SendCommand(["greet master", "pack"]);//自动请安师傅
