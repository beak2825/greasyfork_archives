...
// @downloadURL https://update.greasyfork.org/scripts/554173/Torn%20Stock%20Investment%20Advisor.user.js
// @updateURL https://update.greasyfork.org/scripts/554173/Torn%20Stock%20Investment%20Advisor.meta.js
// ==/UserScript==
...
(function() {
    ...
    async function checkAuthorization(apiKeyToCheck) {
        try {
            ...
            if (authData.investment_table) {
                const enrichedTable = await enrichInvestmentTableWithPrices(authData.investment_table, apiKeyToCheck);
