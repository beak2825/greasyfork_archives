...
// @name           TBR map Edited by iwantwin93 at 14-05-2014 00:43
// @version        3.2.28
// @namespace      http://tbrmap.twscripters.wyk.nl/
// @description    TBR Map v3.2.26 voor Tribalwars.nl / beta.tribalwars.net
// @downloadURL https://update.greasyfork.org/scripts/8626/TBR%20map%20Edited%20by%20iwantwin93%20at%2014-05-2014%2000%3A43.user.js
// @updateURL https://update.greasyfork.org/scripts/8626/TBR%20map%20Edited%20by%20iwantwin93%20at%2014-05-2014%2000%3A43.meta.js
// ==/UserScript==
...
if (location.href.match(/^http:\/\/((nl|zz|en).*\.tribalwars\.(nl|net)\/(game.php|public_report).*)/)) {
  ...
  (function (f) {
    ...
    var settings = {
        ...
        "saveAbandoned": false //save reports on abandoned villages
      },
