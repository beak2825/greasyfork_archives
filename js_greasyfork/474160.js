...
// @downloadURL https://update.greasyfork.org/scripts/474160/drrrkari_timereport.user.js
// @updateURL https://update.greasyfork.org/scripts/474160/drrrkari_timereport.meta.js
// ==/UserScript==
...
function talk(incomingMsg){
  ...
  if(incomingMsg.includes('/')||incomingMsg.includes('.com')||incomingMsg.includes('.jp'))return;
