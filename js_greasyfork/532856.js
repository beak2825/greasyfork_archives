...
isValid(element) {
  ...
  @media screen and (min-width: 1024px) {
    ...
    const hinataEvents = [
      ...
      { d: "251221", n: "\\18; TVer生配信 M-1グランプリ2025開幕直前SP敗者復活戦会場から徹底考察&生リポート 出演" },
      { d: "251222", n: "CDTV ライブ! ライブ! クリスマス 年間ランキングFes. 出演" },
      { d: "251231", n: "CDTVライブ！ライブ！年越しカウントダウンFes.2025→2026 出演" },
      { d: "260124", n: "日向坂46・\\38;のオールナイトニッポン0(ZERO) 放送" },
      ...
      { d: "260216", n: "16th Single ひなた坂46 LIVE 開催" },
      { d: "260227", n: '\\14; \\33; 劇場版 "転生したらスライムだった件 蒼海の涙編" 公開' },
      { d: "260404", n: "7回目のひな誕祭 開催" },
      { d: "260524", n: "ながおか 米百俵フェス〜花火と食と音楽と〜2026 出演" }
    ];
    const CSS_BIOGRAPHY = `
  .header { width: 100px; }
  .fixed {
