// ==UserScript==
// @name Google Chrome Webstore Dark and Gray v.2
...
// @downloadURL https://update.greasyfork.org/scripts/461653/Google%20Chrome%20Webstore%20Dark%20and%20Gray%20v2.user.js
// @updateURL https://update.greasyfork.org/scripts/461653/Google%20Chrome%20Webstore%20Dark%20and%20Gray%20v2.meta.js
// ==/UserScript==

(function() {
let css = `
/* ==== 0-Google Chrome Webstore Dark and Gray v.2 - DEV QUANTUM ==== */
...
/* (new2) SIMMILAR TAB =
https://chrome.google.com/webstore/detail/disable-content-security/ieelmcmcagommplceebfedjlakkhpden/related
=== */
/* SIMILAR - TABS SELECTED */
.e-f-b.g-b-Fa[aria-selected="true"] {
...
/* (new2) FIRST */
.ha-Va-bf-hf .ja-ha .ja-ha-De > div > div:first-of-type {
...
span.LXTxRc-N5Lhkf span ,
.Uufqmb,
.g3IrHd ,
.BObyac,
.qwG2Hd  ,
.VfPpkd-rymPhb li span,
.vECq8 ,
.JJ3H1e,
.Vq0ZA,
.F9iKBc,
...
.cD9yc a.UvhDdd + .TS4QDe p.GzKZcb ,
a.UvhDdd ,
.aH8fEd ,
.d2selb span ,
.UywwFc-vQzf8d ,
...
.AeBiU-LgbsSe span ,
a ,
a.mUIrbf-RLmnJb[href$="/reviews"] ,
a[href$="/reviews"].awpk2 ,
a[href$="/reviews"],
.C25Jwf,
a.e-f-y {
...
/* VISITED */
.cD9yc a.UvhDdd:visited + .TS4QDe p.GzKZcb,
.cD9yc:visited ,
a:visited ,
a.e-f-y:visited {
