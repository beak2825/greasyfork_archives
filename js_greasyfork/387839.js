// ==UserScript==
// @name The West - tw-db.info Cloth Calc [es]
// @version 0.48 Rev. 2
...
// @downloadURL https://update.greasyfork.org/scripts/387839/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Bes%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/387839/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Bes%5D.meta.js
// ==/UserScript==
(function(f) {
        var d = document,
        ...
        if (isDefined(window.TWDB)) {
                new west.gui.Dialog(TWDB.script.name, '<div class="txcenter"><b><br>El script de usuario ClothCalc está instalado dos veces, con dos idiomas diferentes. ¡Tiene que desinstalar una de  ellas para que el script funcione correctamente!</br></b></div>', west.gui.Dialog.SYS_WARNING).addButton("OK").show();
        } else {
                TWDB = {};
                TWDB.script = new Object({
                        ...
                        update: "tw-db.info/cache/userscripts/clothcalc/clothcalc_es.user.js",
                ...
                TWDB.ClothCalc = {
                        ...
                        checkCache: function() {
                                ...
                                if (e || t || n) {
                                        var i = "los datos están obsoletos, clic para Actualizar";
                                        if (e) {
                                                i += " [Inventario]"
                                        }
                                        if (t) {
                                        ...
                                        r = jQuery('<div title="los datos están ok" style="position:absolute;top:0px;right:0px;width:20px;height:20px;background: url(' + TWDB.images.iconData + ')no-repeat -20px 0px;" /></div>');
                                        this.up2date = true
                                }
                        ...
                        open: function(e, t) {
                                ...
                                this.gui.job.sort = jQuery('<div style="position:absolute;top:10px;left:0px;height:20px;" />').append('<img src="' + TWDB.images.iconName + '" title=" ordenar por nombre " alt=" ordenar por nombre " onclick="javascript:TWDB.ClothCalc.joblist.order(\'name\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconExperience + '" title=" ordenar por experiencia " alt=" ordenar por experiencia " onclick="javascript:TWDB.ClothCalc.joblist.order(\'experience\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconDollar + '" title=" ordenar por salarios " alt=" ordenar por salarios " onclick="javascript:TWDB.ClothCalc.joblist.order(\'wages\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconLuck + '" title=" odernar por suerte " alt=" odernar por suerte " onclick="javascript:TWDB.ClothCalc.joblist.order(\'luck1\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconLaborpoints + '" title=" ordenar por puntos de trabajo " alt=" ordenar por puntos de trabajo " onclick="javascript:TWDB.ClothCalc.joblist.order(\'laborpoints\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconMoti + '" title=" Ordenar por motivación " alt=" Ordenar por motivación " onclick="javascript:TWDB.ClothCalc.joblist.order(\'motivation\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconDanger + '" title=" ordenar por daño " alt=" ordenar por daño " onclick="javascript:TWDB.ClothCalc.joblist.order(\'danger\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />');
                                this.gui.job.title = jQuery('<div style="position:absolute;top:37px;left:0px;width:187px;height:19px;font-weight:bold;text-align:center;white-space: nowrap;">Seleccionar trabajo aquí >></div>');
                                this.gui.job.mode = jQuery("<div style=\"position:absolute;top:10px;right:30px;width:20px;height:20px;background:url('" + TWDB.images.jobTime + '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:block;" title=" Tiempo de trabajo " />');
                                this.gui.job.search = jQuery("<div style=\"position:absolute;top:35px;right:50px;width:20px;height:20px;background:url('" + TWDB.images.iconSearch + '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:none;" title=" Encontrar este trabajo en el mapa " />');
                                ...
                                this.gui.job.checkbox.setTooltip("Esconder Trabajos que no puede hacer");
                                this.gui.job.checkbox.getMainDiv().css({
                                        position: "absolute",
                                        top: "35px",
                                        right: "30px"
                                });
                                this.gui.job.button = jQuery('<div style="position:absolute;top:35px;right:4px;width:26px;height:20px;background:url(\'/images/window/character/title_editbtn.jpg\') no-repeat scroll 0 0 transparent;cursor:pointer;" title=" Seleccionar trabajo aquí " />');
                                ...
                                this.gui.job.calc = $('<div title=" Recompensas actuales " style="position:absolute;top:60px;width:100px;right:1px;height:30px;display:block;;font-weight:bold;text-align:center;" />');
                                ...
                                this.gui.custom.title = jQuery('<div style="position:absolute;top:36px;left:0px;width:210px;height:19px;font-weight:bold;text-align:center;">Seleccionar trabajo aquí >></div>');
                                this.gui.custom.settings = jQuery('<div title="Ajustes" style="position:absolute;top:35px;right:30px;width:20px;height:20px;background:url(' + TWDB.images.iconSetting + ');cursor:pointer;" />');
                                this.gui.custom.settings.click(function() {
                                        n.customs.showConfig()
                                });
                                this.gui.custom.button = jQuery('<div style="position:absolute;top:35px;right:4px;width:26px;height:20px;background:url(\'/images/window/character/title_editbtn.jpg\') no-repeat scroll 0 0 transparent;cursor:pointer;" title=" Seleccionar trabajo aquí " />');
                                ...
                                this.gui.window = wman.open(this.uid, null, "noreload").setMiniTitle("TWDB Cloth Calc").setTitle("tw-db.info Cloth Calc").addTab("Trabajo", "Jobs", o).addTab("Habilidades a medida", "Custom", o).appendToContentPane(this.gui.job.mainDiv).appendToContentPane(this.gui.custom.mainDiv).appendToContentPane(this.gui.cache).appendToContentPane(this.gui.bag).appendToContentPane(this.gui.copyright);
                                this.gui.window.showLoader();
                                var u = $('<div title="guardar Posición" style="width:20px;height:20px;position:absolute;left:0px;top:0px;background:url(\'' + TWDB.images.iconSave + "') no-repeat scroll 0px -20px transparent;cursor:pointer;display:block;\" />").hover(function() {
                                        ...
                                        (new UserMessage("Guardado con éxito", UserMessage.TYPE_SUCCESS)).show()
                                });
                        ...
                        jobs: {
                                ...
                                getJobPopup: function(e) {
                                        ...
                                        n = "<table>" + '<tr><td colspan="4" style="font-weight:bold;text-align:center;font-size:11px;">' + this.parent.calcdata.jobs[e].name + "</td></tr>" + '<tr><td><img src="' + TWDB.images.iconExperience + '" title=" Experiencia " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' + t.experience + "</td>" + '<td><img src="' + TWDB.images.iconDollar + '" title=" Sueldo " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' + t.wages + "</td></tr>" + '<tr><td><img src="' + TWDB.images.iconLuck + '" title=" Suerte " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' + t.luck1 + "-" + t.luck2 + "</td>" + '<td><img src="' + TWDB.images.iconDanger + '" title=" Peligro " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' + t.danger + "</td></tr>" + '<tr><td><img src="' + TWDB.images.iconLaborpoints + '" title=" ?laborpoints " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' + t.laborpoints + "</td>" + '<td><img src="' + TWDB.images.iconClock + '" title=" Duración " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' + t.duration + "</td></tr>" + '<tr><td><img src="' + TWDB.images.iconMoti + '" title=" Motivación "  height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' + t.resmotivation * 100 + " (" + Math.round(t.motivation * 100) + ")%</td><td></td><td></td></tr>" + "</table>";
                                        return n
                                }
                        },
                        joblist: {
                        ...
                        customs: {
                                ...
                                showConfig: function() {
                                        ...
                                        var n = jQuery('<div title="borrar" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/icons/delete.png') repeat scroll 0px 0px transparent;\" />");
                                        var r = jQuery('<div title="agregar" style="display:block;margin-top:2px;vertical-align:top;height:20px;width:25px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/window/messages/icons.png') repeat scroll 72px -5px transparent;\" />");
                                        var i = jQuery("<div />");
                                        ...
                                        this.parent.gui.custom.config = new west.gui.Dialog("Habilidades a medida", i);
                                ...
                                addConfig: function() {
                                        ...
                                        if (e >= 15) {
                                                (new UserMessage("demasiadas entradas, solo se permiten diez", UserMessage.TYPE_ERROR)).show()
                                        } else {
                                                e++;
                                                this.editConfig(e)
                                        }
                                ...
                                editConfig: function(e, t) {
                                        if (typeof t == "undefined") {
                                                ...
                                                o.append(jQuery("<tr />").append('<td style="vertical-align:middle">Nombre:</td>').append(jQuery("<td />").append(this.parent.gui.custom.name.getMainDiv())));
                                                ...
                                                o.append('<tr><td colspan="2">por favor, vaya a tw-db.info y obtenga el fragmento de código para insertar aquí desde allá <a href="https://tw-db.info/?strana=calc" target="_blank">tw-db.info Calculadora</a></td></tr>');
                                                var o = new west.gui.Dialog(s + "Habilidades a medida", o);
                                                ...
                                                var u = function(e) {
                                                        (new UserMessage("los insertos que ha hecho son incorrectos: " + e, UserMessage.TYPE_ERROR)).show();
                                                        return false
                                                };
                                                if (this.parent.gui.custom.name.getValue() == "") {
                                                        return u("vacío Nombre")
                                                }
                                                if (this.parent.gui.custom.code.getValue() == "") {
                                                        return u("vacío Código [1]")
                                                }
                                ...
                                deleteConfig: function(e, t) {
                                        if (typeof t == "undefined") {
                                                var n = this;
                                                var r = new west.gui.Dialog("borrar - Habilidades a medida", "borrar: " + this.parent.data.custom[e].name + "?");
                        ...
                        jobSearch: function() {
                                ...
                                for (var i = 0; i < t.length; i++) {
                                        ...
                                        u.append(jQuery('<td style="text-align:left;vertical-align:middle">').append(jQuery('<img src="' + TWDB.images.arrow + '" title="Dirección" style="cursor:pointer;-moz-transform: ' + o + "-webkit-transform:" + o + "-rotat-transform:" + o + "-ms-transform:" + o + "transform:" + o + '" />').click(function(e, t) {
                                                return function() {
                                                        Map.center(e, t)
                                                }
                                        }(s.x, s.y))));
                ...
                (function($) {
                        ...
                        var Loader = function(e) {
                                ...
                                var l = function() {
                                        ...
                                        if (o === false) {
                                                ...
                                                try {
                                                        ...
                                                        Error.report(e, "");
                                                        (new UserMessage("no se pudo registrar el script TW-db.info en TheWestApi", UserMessage.TYPE_FATAL)).show();
                                                        return d()
                                                }
                                                if (TWDB.Util.isNewIDsystem()) {
                                ...
                                var h = function() {
                                        ...
                                        var r = e("<div style='font-family:comic sans ms; font-size:13pt; padding-top:10px; text-align:center;' />").append("El script de usuario ClothCalc es un proyecto creado por el equipo de TW-DB.info. Ofrece una gran variedad de características y extensiones que le darán una experiencia de juego mejorada - ahorrando su tiempo y optimizando algunas de sus actividades.", n, "¡Gracias!");
                                        t.setGui(r);
                                        if (t.isOutdated()) {
                                ...
                                t.reset = function(n, s) {
                                        try {
                                                if (n) {
                                                        ...
                                                        var u = e("<div><h2>¿Realmente desea restablecer la caché del script de usuario de tw-db?</h2></div>");
                        ...
                        var Settings = function(e) {
                                ...
                                var s = function() {
                                        ...
                                        r = Window.addTab("settings", "Ajustes", "Ajustes", o);
                                        i.ready = true
                                };
                                ...
                                var o = function() {
                                        ...
                                        var s = [
                                                [9, "", "Inventario", false],
                                                [0, "jobBoniTooltip", "mostrar información de puntos de trabajo en ventana de inventario para el trabajo seleccionado", false],
                                                [0, "collector", "marcar objetos que no poseas en comerciantes y mercado", false],
                                                [0, "buyTip", "mostrar consejo de compra en comerciantes", false],
                                                [0, "sellTip", "mostrar consejo de venta en ventana de inventario", false],
                                                [0, "sellTip1", "vender objetos repetidos", "Ajustes para Consejo de Venta"],
                                                [0, "sellTip2", "vender objetos que no se usan en ningún trabajo", "Ajustes para Consejo de Venta"],
                                                [0, "sellTip3", "nunca vender objetos con nombre", "Ajustes para Consejo de Venta"],
                                                [0, "sellTip4", "nunca vender objeto, que sólo puede ser encontrado", "Ajustes para Consejo de Venta"],
                                                [0, "sellTip5", "Nunca vender objetos de Conjuntos", "Ajustes para Consejo de Venta"],
                                                [0, "pinitems", "Habilita el uso de chinchetas en la sección usados recientemente del Inventario", false],
                                                [0, "collectorsell", "Añade botón para vender todos los artículos menos 1 al vendedor ambulante", false],
                                                [9, "", "Búsquedas", false],
                                                [0, "questwiki", "Incluir tw-db y ClothCalc a las ventanas de Búsqueda", false],
                                                [0, "questcancle", "En la cancelación de una Búsqueda se le preguntará si realmente quiere hacer eso", false],
                                                [0, "qbswitch", "Habilitar el cambio entre introducción y texto terminado en el libro de Búsquedas", false],
                                                [0, "qfulltext", "Mostrar siempre los textos completos en la historia de búsquedas", false],
                                                [9, "", "Mercado", false],
                                                [0, "marketmap", "Usar el Mapa de Mercado", false],
                                                [0, "marketreminder", "Añadir un recordatorio para subastas del mercado", false],
                                                [0, "marketselldialog", "Mejora el diálogo del mercado de venta", false],
                                                [9, "", "Trabajos", false],
                                                [0, "jobwin_ccbutton", "Agregar Calculadora Ropas a la ventana de trabajo", false],
                                                [0, "jobwin_showlp", "Mostrar puntos de trabajo en ventana de trabajo", false],
                                                [9, "", "Lista tareas", false],
                                                [0, "tasklistpoints", "Mostrar puntos de trabajo y pistas-PT en la lista de tareas", false],
                                                [9, "", "GUI", false],
                                                [0, "duelmotivation", "Añadir la motivación de duelo como indicador permanente", false],
                                                [0, "directsleep", "Obtener un Botón para ir directamente al Hotel o Barraca", false],
                                                [0, "deposit", "Agregar un botón para depositar el dinero", false],
                                                [0, "noshopsale", "Desactivar notificación de venta en tienda", false],
                                                [0, "expbarvalues", "Mostrar valores en la barra de experiencia; Agradecimientos y créditos para Leones/Slygoxx", false],
                                                [0, "mini_chatgui", "Permite a la GUI de la sala de chat ser minimizada", false],
                                                [0, "customcounterpos", "Reposiciona los contadores de eventos (evento principal, script de Hiroaki) en pantallas anchas", false],
                                                [0, "noscrollbars", "Cesactiva las barras desplazamiento en pantallas pequeñas o cuando se mueven las ventanas demasiado", false],
                                                [9, "", "Mini mapa", false],
                                                [0, "showbonusjobs", "Mostrar trabajos con prima en el minimapa", false],
                                                [0, "showscrollto", "Añadir un desplazamiento para coordinar el campo de entrada al minimapa", false],
                                                [9, "", "Fuerte", false],
                                                [0, "fortrecruitment", "Mostrar vista general Reclutamiento Fuerte", false],
                                                [0, "enhancedfortrecruitment", "Mostrar vista mejorada Reclutamiento Fuerte", false],
                                                [9, "", "Misceláneo", false],
                                                [0, "chat", "usar chat mejorado", false],
                                                [0, "notes", "usar la función de notas", false],
                                                [0, "forumlastpage", "Añadir un icono en el foro para abrir directamente el último hilo", false],
                                                [0, "fastskillchange", "Activar cambio rápido de habilidades en Ventana Habilidades (Mantener pulsado el botón del ratón hacia abajo)", false],
                                                [0, "autodeposit", "Obtener una pista Depósito si llegas a tu ciudad con Dinero", false],
                                                [0, "chestanalyser", "Crear una estadística para cofres abiertos", false],
                                                [0, "weeklycrafting", "Informarte cuando el período de espera en la elaboración expira", false],
                                                [0, "noworkqueuepa", "Quitar Consejos para la Automatización tareas", "Ajustes Premium"],
                                                [0, "nofetchallpa", "Desactivar símbolo premium al recoger todos los artículos en el mercado", "Ajustes Premium"],
                                                [0, "nowofnuggets", "No usar pepitas como opción por defecto en los juegos del evento (cuando está disponible)", "Ajustes Premium"],
                                                [0, "instanthotel", "Agregar un botón de hotel a las señales de la ciudad", false],
                                                [0, "telegramsource", "Agregar botón para cambiar a texto sin formato en los telegramas", false],
                                                [8, "clothPos"],
                                                [0, "wear_openmin", "Abrir ventana de equipo minimizada cuando abre ClothCalc", false]
                                        ];
                                        var o = {};
                                        var a = e("<table />");
                                        var f = {};
                                        ...
                                        m.addItem("left", "izquierda").addItem("right", "derecha").addItem("custom", "Posición guardada");
                                        m.select(String(n["clothPos"]));
                                        e("tr.placeholder_clothPos", a).removeClass("placeholder_clothPos").append(e('<td colspan="2" />').append(m.getMainDiv(), "<span>&nbsp;derecha</span>"));
                                ...
                                var i = function() {
                                        try {
                                                ...
                                                JobWindow.prototype.getBestWearButton = function() {
                                                        ...
                                                        var n = this;
                                                        return t.append(e('<div class="twdb_bestwear" title="Mostrar este Trabajo en la Ventana ClothCalc">').click(function(e) {
                        ...
                        var Updater = function(e) {
                                ...
                                var s = function() {
                                        ...
                                        if (!Cache.load("version")) Cache.save("version", Script.version + " " + Script.revision);
                                                ...
                                                i = true;
                                                var e = "El Script fue actualizado";
                                                var t = '<div class="txcenter">El script =1= fue actualizado. ¿Quiere ver las notas de la nueva versión?</div>';
                                ...
                                var o = function(e, t) {
                                        var n = "El Script necesita actualizarse";
                                        var r = '<div class="txcenter">Hay una nueva versión disponible para el Script =1=, por favor, haga click en &#38;quot;ok&#38;quot; para actualizar el Script.</div>';
                                        ...
                                        var s = function() {
                                                window.open(i);
                                                (new west.gui.Dialog(Script.name, "Por favor, vuelva a cargar el juego después de la instalación.", "warning")).setModal(true, false, true).show()
                                        };
                                        (new west.gui.Dialog(n, r, west.gui.Dialog.SYS_WARNING)).addButton("Ahora no").addButton("ok", s).show()
                                };
                        ...
                        var Sleep = function(e) {
                                ...
                                var m = function(t, n, r) {
                                        ...
                                        for (var s = 0; s < r; s++)
                                                if (t[s].stage !== 0) i.addItem(s, "Escenario&nbsp;" + t[s].stage + "&nbsp;" + t[s].distance.formatDuration() + "&nbsp;|&nbsp;" + t[s].name);
                        ...
                        var Analyser = function(e) {
                                ...
                                var p = function() {
                                        ...
                                        s = e.extend(true, {}, r);
                                        GameInject.addTabOnMessagesWindow("Analizador de trabajo", "analyser-job", function() {
                                                T("job")
                                        });
                                        if (Settings.get("chestanalyser", true)) {
                                                GameInject.ItemUse(v.add);
                                                GameInject.addTabOnMessagesWindow("Analizador de cofre", "analyser-chest", function() {
                                                        v.show()
                                                })
                                        }
                                        h.ready = true
                                ...
                                var k = function() {
                                        ...
                                        var t = e('<div class="fancytable">' + '<div class="_bg tw2gui_bg_tl"></div>' + '<div class="_bg tw2gui_bg_tr"></div>' + '<div class="_bg tw2gui_bg_bl"></div>' + '<div class="_bg tw2gui_bg_br"></div>' + '<div class="trows">' + '<div class="thead statics">' + '<div class="row row_head">' + '<div class="cell_0 view-rewards view-items" style="width:91px; text-align:center;">' + '<span title="Nombre" style="cursor:pointer, margin-bottom:3px;">' + '<img src="' + Images.iconName + '" />' + "</span>" + "</div>" + '<div class="cell_1 view-rewards view-items" style="width:50px; text-align:center;">' + '<span title="Cuenta">' + '<img src="' + Images.iconCount + '" />' + "</span>" + "</div>" + '<div class="cell_2 view-rewards view-items" style="width:50px; text-align:center;">' + '<span title="Duración">' + '<img src="' + Images.iconClock + '" />' + "</span>" + "</div>" + '<div class="cell_3 view-rewards" style="width:50px; text-align:center;">' + '<span title="Experiencia">' + '<img src="' + Images.iconExperience + '" />' + "</span>" + "</div>" + '<div class="cell_4 view-rewards" style="width:50px; text-align:center;">' + '<span title="Salario">' + '<img src="' + Images.iconDollar + '" />' + "</span>" + "</div>" + '<div class="cell_5 view-rewards" style="width:50px; text-align:center;">' + '<span title="Bono">' + '<img src="' + Images.iconUpb + '" />' + "</span>" + "</div>" + '<div class="cell_6 view-rewards" style="width:50px; text-align:center;">' + '<span title="Motivación">' + '<img src="' + Images.iconMoti + '" />' + "</span>" + "</div>" + '<div class="cell_7 view-rewards" style="width:50px; text-align:center;">' + '<span title="Peligro">' + '<img src="' + Images.iconDanger + '" />' + "</span>" + "</div>" + '<div class="cell_8 view-rewards" style="width:50px; text-align:center;">' + '<span title="Muertos">' + '<img src="' + Images.iconKilled + '" />' + "</span>" + "</div>" + '<div class="cell_9 view-rewards" style="width:50px; text-align:center;">' + '<span title="Productos">' + '<img src="' + Images.iconYield + '" />' + "</span>" + "</div>" + '<div class="cell_9 view-items" style="width:63px; text-align:center;">' + '<span title="Productos">' + '<img src="' + Images.iconYield + '" />' + "</span>" + "</div>" + '<div class="cell_10 view-rewards" style="width:50px; text-align:center;">' + '<span title="Objeto">' + '<img src="' + Images.iconItem + '" />' + "</span>" + "</div>" + '<div class="cell_10 view-items" style="width:378px; text-align:center;">' + '<span title="Objeto">' + '<img src="' + Images.iconItem + '" />' + "</span>" + "</div>" + '<div class="cell_11 view-rewards" style="width:41px; text-align:center;">' + '<span title="Suerte">' + '<img src="' + Images.iconLuck + '" />' + "</span>" + "</div>" + '<div class="cell_reset view-rewards view-items" style="width:20px; text-align:right;">' + '<span title="Reset">' + '<img src="' + Images.iconReset + '" />' + "</span>" + "</div>" + "</div>" + "</div>" + '<div class="tbody">' + '<div class="_bg tw2gui_bg_l"></div>' + '<div class="_bg tw2gui_bg_r"></div>' + "</div>" + '<div class="tfoot statics">' + '<div class="row row_foot"></div>' + "</div>" + "</div>" + "</div>");
                                        ...
                                        m.data("sum", i.jobs);
                                        m.data("sum-t", i.jobs + " Trabajos");
                                        m.data("avg", i.jobs);
                                        m.data("avg-t", i.jobs + " Trabajos");
                                        l.footer.append(m);
                                        ...
                                        m.data("sum", "&sum;");
                                        m.data("sum-t", "cambiar a &Oslash;");
                                        m.data("avg", "&Oslash;");
                                        m.data("avg-t", "cambiar a &sum;");
                                        l.footer.append(m);
                                        ...
                                        l.footer.append(m);
                                        var o = e('<div style="margin: 0px 6px 0px 6px;width:680px;" />').append(e('<a href="#">Cambiar entre recompensas y objetos encontrados</a>').css({
                                                marginTop: "-8px",
                                                display: "block",
                                                textAlign: "center"
                                        }).click(function() {
                        ...
                        var Notes = function(e) {
                                ...
                                var u = function(t) {
                                        ...
                                        n.append(e('<div style="margin-left:8px" />').append((new west.gui.Bbcodes(r)).getMainDiv())).append(r.getMainDiv()).append(e('<div style="margin-left:8px" />').append((new west.gui.Button("Guardar".escapeHTML(), function() {
                                                o(r.getContent());
                                                a(r.getContent())
                                        })).getMainDiv()).append((new west.gui.Button("Avance".escapeHTML(), function() {
                                                a(r.getContent())
                                        })).getMainDiv()));
                                ...
                                var d = function() {
                                        ...
                                        var n = function() {
                                                ...
                                                var u = (new west.gui.Button("Ok", function() {
                                                        o()
                                                }, null, null, "Desplazar el mapa a las coordenadas dadas")).setWidth("48");
                                                var a = e('<img title="Mostrar mapa de coordenadas " src="' + Images.iconCount + '" />').click(function() {
                        ...
                        var BonusJobs = function(e) {
                                ...
                                var u = function() {
                                        ...
                                        TWDB.Util.addCss(t, "minimap");
                                        var n = function() {
                                                var t = e('<div id="mmap_twdb_bonusjobs" />').append(e('<input title="Mostrar trabajos con prima de oro" type="checkbox" ' + (i.gold ? 'checked="checked"' : "") + " />").change(function() {
                                                        i.gold = e(this).is(":checked");
                                                        a()
                                                })).append('<div title="Mostrar trabajos con prima de oro" style="background-color:yellow; border:1px solid red;" />').append(e('<input title="Mostrar trabajos con prima de plata" type="checkbox" ' + (i.silver ? 'checked="checked"' : "") + " />").change(function() {
                                                        i.silver = e(this).is(":checked");
                                                        a()
                                                })).append('<div title="Mostrar trabajos con prima de plata" style="background-color:white; border:1px solid black;" />').append(e('<img title="Trabajos con prima Exportar" src="' + Images.iconExport + '" />').click(function() {
                                                        f()
                                                })).append(e('<img title="Trabajos con prima Importar" src="' + Images.iconImport + '" />').click(function() {
                                                        l()
                                                })).append(e('<img title="Trabajos con prima Reset" src="' + Images.iconReset2 + '" />').click(function() {
                                                        c()
                                                }));
                                ...
                                var f = function() {
                                        ...
                                        var h = e("<div />").css({
                                                ...
                                                position: "relative",
                                                display: "block"
                                        }).append(e('<img src="' + Images.iconName + '" title=" ordenar por nombre "  style="margin:0px 2px 0px 2px;cursor:pointer;" />').click(function() {
                                                c("name")
                                        })).append(e('<img src="' + Images.iconCount + '" title=" Ordenar por País " style="margin:0px 2px 0px 2px;cursor:pointer;" />').click(function() {
                                                c("country")
                                        }));
                                        (new west.gui.Dialog("Trabajos con prima Exportar", e("<div />").append(h).append(a))).addButton("ok").show()
                                };
                                var l = function() {
                                        ...
                                        (new west.gui.Dialog("Trabajos con prima Importar", t)).addButton("ok", r).addButton("cancel").show()
                                };
                                var c = function(e) {
                                        try {
                                                if (e) {
                                                        ...
                                                        Cache.save("bonusjobs", n);
                                                        a();
                                                        (new UserMessage("Trabajos con prima Reset", UserMessage.TYPE_SUCCESS)).show()
                                                } else {
                                                        var o = "tw-db Trabajos con prima Reset";
                                                        var u = '<div class="txcenter">Trabajos con prima Reset</div>';
                                                        (new west.gui.Dialog(o, u, west.gui.Dialog.SYS_QUESTION)).addButton("Todos", function() {
                                                                c("all")
                                                        }).addButton("Trabajos en oro", function() {
                                                                c("silver")
                                                        }).addButton("Trabajos plata", function() {
                                                                c("gold")
                                                        }).addButton("cancel").show()
                                                }
                                        } catch (f) {
                        ...
                        var Chat = function(e) {
                                ...
                                var g = function(t) {
                                        ...
                                        var v = new west.gui.Checkbox("*audaz*", l.bold ? "tw2gui_checkbox_checked" : "", function() {
                                                l.bold = l.bold ? false : true
                                        });
                                        e(v.getMainDiv()).css("display", "block").css("margin-bottom", "5px");
                                        d.append(v.getMainDiv());
                                        var v = new west.gui.Checkbox("ESCRIBIR CON MAYÚSCULA", l.caps ? "tw2gui_checkbox_checked" : "", function() {
                                        ...
                                        m.append('<span style="width:140px;height:15px;display:inline-block;text-align:center;padding: 4px 0px 2px 0px;font-size:11px;">historia</span>');
                                ...
                                var s = function(e) {
                                        ...
                                        if (Settings.get("sellTip2", true) && ClothCalc.isLoaded()) {
                                                if (!ClothCalc.isUsedItem(n.item_id)) {
                                                        r = true;
                                                        i = "este objeto no es usado en ningún trabajo o actividad definida personalizada (Cálculo de Ropa)".escapeHTML()
                                                }
                                        }
                                        ...
                                        if (r) {
                                                e.divMain.append('<img src="' + Images.iconSell + '" class="TWDBsellTip" title="' + i + '" title=" este artículo todavía no lo tienes " style="position:absolute;bottom:4px;right:0px;width:19px;height:19px;padding:0px;border:0px;margin:0px;" />')
                                        }
                                };
                                return t
                        }($);
                        ...
                        var Collector = function(e) {
                                        ...
                                        if (Settings.get("collector", true)) {
                                                ...
                                                GameInject.injectTrader("collector", function(e) {
                                                        if (t.isNewItem(e.item_id)) {
                                                                var n = '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" este artículo todavía no lo tienes " ' + ' style="position:absolute;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />';
                                                                return n
                                                        }
                                                        return ""
                                                });
                                ...
                                var s = function(e) {
                                        ...
                                        if (t.isNewItem(e.obj.item_id)) {
                                                e.divMain.append('<img src="' + Images.iconNew + '" class="TWDBcollector" title=" este artículo todavía no lo tienes " style="position:absolute;top:-8px;left:-15px;padding:0px;border:0px;margin:0px;" />')
                                        }
                                };
                                var o = function(e) {
                                        if (t.isNewItem(e)) {
                                                return '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" este artículo todavía no lo tienes " style="width:18px;height:18px;position:relative;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />'
                                        } else {
                                                return ""
                                        }
                                };
                        ...
                        var BuyTip = function(e) {
                                ...
                                var f = function(e, t) {
                                        ...
                                        if (t == "market") {
                                                ...
                                                return '<img id="TWDBbuyTip' + i + '" src="' + Images["iconStar3"] + '" class="TWDBbuyTip" width="18px" height="18px" title="Calculando, espere por favor..." style="padding:0px;border:0px;margin:0px;" />'
                                        }
                                        if (isDefined(r[n])) {
                                                if (t == "shop") {
                                                        var s = h(n);
                                        ...
                                        e.divMain.append('<img src="' + Images["iconStar3"] + '" class="TWDBbuyTip" width="25px" height="25px"     title="Calculando, espere por favor..."  style="position:absolute;bottom:-8px;right:-5px;padding:0px;border:0px;margin:0px;" />');
                                        Worker.add(function(e, t) {
                                                return function() {
                                                        l(t);
                                                        if (t == "shop") {
                                ...
                                var p = function(e) {
                                        ...
                                        if (!ClothCalc.isItemUsable(e)) {
                                                var n = ItemManager.get(e);
                                                t += '<td colspan="2" style="text-align:center; font-weight:bold;">Nivel ' + n.level + "</td></tr><tr>"
                                        }
                        ...
                        var Snippets = function($) {
                                                        ...
                                                        for (e = 0; e < TaskQueue.queue.length; e++) {
                                                                if (TaskQueue.queue[e].type === "job") {
                                                                        ...
                                                                        if (TaskQueue.queue[e].data.job_points < 0) {
                                                                                n = west.gui.Icon.get("exclamation-priority-3", "Puntos de trabajo negativos")
                                                                        } else if (TaskQueue.queue[e].data.job_points < TaskQueue.queue[e].data.job.malus / 5) {
                                                                                n = west.gui.Icon.get("exclamation-priority-2", "Puntos de trabajo bajos")
                                                                        } else if (r) {
                                                                                n = west.gui.Icon.get("exclamation-priority-1", "Puntos de trabajo no óptimos")
                                                                        }
                                                                        if (n !== null) {
                                ...
                                var QuestbookSwitch = function() {
                                        try {
                                                ...
                                                QuestGroupWindowView.showSolvedQuest = function(e) {
                                                        ...
                                                        var r = $('<a href="#"> Mostrar texto de la finalización </a>').addClass("introshown").click(function() {
                                                                var e = $(this),
                                                                        r = e.hasClass("introshown");
                                                                t.toggle(r);
                                                                n.toggle(!r);
                                                                e.text(r ? " Mostrar texto de introducción " : " Mostrar texto de la finalización ");
                                ...
                                var enhanceMarketSellDialog = function() {
                                        ...
                                        MarketWindow.TWDB_touchUpSellDialog = function(n) {
                                                ...
                                                $("#twdb_msd_desc_cc", r).append($('<div class="tw2gui-iconset tw2gui-icon-save" title="Guardar descripción para futuras subastas">').click(function() {
                                                        u("description", $("textarea#auction_description", r).val())
                                                }), $('<div class="tw2gui-iconset tw2gui-icon-abort" title="Restablecer descripción">').click(function() {
                                                        u("description", "");
                                                        $("textarea#auction_description", r).val("")
                                                }));
                                                $("#twdb_msd_buy_cc", r).append((new west.gui.Checkbox("", "twdb_msd_buy_fix", o)).setTitle("Utilizar como precio por defecto").setValue(2).divMain).append($('<div class="tw2gui_checkbox" title="Fijar precio de compra de los artículos">').append('<span class="invPopup_buyicon" style="height:20px;">').click(function() {
                                                        $("#market_max_price", r).val(e.price || 1).keyup()
                                                })).append("&nbsp;&nbsp;").append((new west.gui.Checkbox("", "twdb_msd_buy_fix", o)).setTitle("Utilizar como precio por defecto").setValue(1).divMain).append($('<div class="tw2gui_checkbox" title="Fijar precio de venta de los artículos">').append('<span class="invPopup_sellicon" style="height:20px;">').click(function() {
                                                        $("#market_max_price", r).val(e.sell_price || Math.round(e.price / 2)).keyup()
                                                }));
                                                $("#twdb_msd_bid_cc", r).append((new west.gui.Checkbox("", "twdb_msd_bid_fix", o)).setTitle("Utilizar como precio por defecto").setValue(2).divMain).append($('<div class="tw2gui_checkbox" title="Fijar precio de compra de los artículos">').append('<span class="invPopup_buyicon" style="height:20px;">').click(function() {
                                                        $("#market_min_bid", r).val(e.price || 1).keyup()
                                                })).append("&nbsp;&nbsp;").append((new west.gui.Checkbox("", "twdb_msd_bid_fix", o)).setTitle("Utilizar como precio por defecto").setValue(1).divMain).append($('<div class="tw2gui_checkbox" title="Fijar precio de venta de los artículos">').append('<span class="invPopup_sellicon" style="height:20px;">').click(function() {
                                                ...
                                                $("#twdb_msd_opt_cc", r).append($('<span class="tw2gui-iconset tw2gui-icon-save" title="Ahorra tiempo y derechos para futuras subastas" style="display: inline-block;">').click(function() {
                                                        u("duration", parseInt($("#market_days", r).data("value"), 10));
                                                        u("rights", parseInt($("#market_rights", r).data("value"), 10))
                                                }), $('<span class="tw2gui-iconset tw2gui-icon-abort" title="Restablecer opciones" style="display: inline-block;">').click(function() {
                                                        u("duration", 1);
                                ...
                                var weeklyCrafting = function() {
                                        if (w.Character.professionId && w.Character.professionSkill > 599) {
                                                var e = function(e) {
                                                        ...
                                                        var r = "<div style='text-align:center;'>¡Puedes elaborar de nuevo!<br />" + '<div class="item  item_inventory" style="display:inline-block;float:none;"><img class="tw_item item_inventory_img" src="' + n.image + '"></div><br />' + n.name + "</div>";
                                                        t.init("", function() {
                                                        ...
                                                        TitleTicker.setNotifyMessage("Elaboración")
                                                };
                                                var t = function() {
                                                ...
                                                Inventory.addItems = function(e, t) {
                                                        ...
                                                        if (!$("#CC_pin_items").length) {
                                                                Inventory.DOM.children(".actions").append($('<div id="CC_pin_items" class="tw2gui_iconbutton" />').attr({
                                                                        title: "Activar modo chincheta".twdb_twiceHTMLUnescape()
                                ...
                                _self.injectTelegramWindowAppendTelegramDisplaySource = function(e) {
                                        try {
                                                ...
                                                TelegramWindow.appendTelegram = function(e, t) {
                                                        ...
                                                        }).before($('<div class="telegram-source"><div>BB</div></div>').attr("title", "Cambiar entre telegrama formateado y fuente").click(function() {
                                ...
                                var i = function() {
                                        ...
                                        var n = function(t) {
                                                                ...
                                                                if (isDefined(t.requirements[n])) {
                                                                        ...
                                                                        if (isDefined(r.jsInfo) && isDefined(r.jsInfo.id)) {
                                                                                if (r.jsInfo.type == "inventory_changed") {
                                                                                        ...
                                                                                        if (s) {
                                                                                                e(this).children(".quest_mmaplink").after('<span title="Mostrar este Trabajo en la Ventana ClothCalc" class="quest_mmaplink" title="" onclick="javascript:void(Quest.CCopen(\'' + s.name + "','item'))\"><img src=\"" + Images.iconLight + '" /></span>')
                                                                                        }
                                                                                } else if (r.jsInfo.type == "task-finish-job") {
                                                                                        var o = Jobs.getJobById(r.jsInfo.id);
                                                                                        if (o) {
                                                                                                e(this).children(".quest_mmaplink").after('<span title="Mostrar este Trabajo en la Ventana ClothCalc" class="quest_mmaplink" title="" onclick="javascript:void(Quest.CCopen(\'' + o.id + "','job'))\"><img src=\"" + Images.iconLight + '" /></span>')
                                                                                        }
                                                                                }
                                                                        }
                                                                }
                                                ...
                                                if (t.group < 142 && (t.group != 69 || t.id >= 2e4) || [200, 201].indexOf(t.group) > -1) {
                                                        t.el.find(".questRequirementHelp").append('<a target="_blank" title="Mostrar esa búsqueda en tw-db.info" href="' + Script.protocol + "://" + Script.url + "/quest_redirect.php?id=" + t.id + '" style="margin-left:10px;"><img src="' + Images.questwiki + '" /></a>')
                                                }
                                        };
                                ...
                                var s = function() {
                                        try {
                                                ...
                                                QuestWindow.cancelQuest = function(t) {
                                                        (new west.gui.Dialog("¿Cancelar búsqueda?", "¿Está seguro que quiere cancelar la búsqueda?")).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false, {
                        ...
                        var Customs = function(e) {
                                ...
                                t.open = function() {
                                        ...
                                        for (var s in n) {
                                                ...
                                                var a = e('<div title="borrar" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/icons/delete.png') repeat scroll 0px 0px transparent;\" />").click(function(e) {
                                                        return function() {
                                                                f(e)
                                                        }
                                                }(s));
                                        ...
                                        if (r < 15) {
                                                t.append(e('<div title="agregar" style="display:block;margin-top:2px;vertical-align:top;height:20px;width:25px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/window/messages/icons.png') repeat scroll 72px -5px transparent;\" />").click(function() {
                                                        l()
                                                }))
                                        }
                                        i = (new west.gui.Dialog("Habilidades a medida", t)).addButton("ok", function() {
                                ...
                                var f = function(e) {
                                        ...
                                        (new west.gui.Dialog("borrar - Habilidades a medida", "borrar: " + String(n[e].name).escapeHTML() + "?")).addButton("ok", r).addButton("cancel").show()
                                };
                                var l = function() {
                                        var e = 0;
                                        for (var t in n) {
                                ...
                                var c = function(t) {
                                        if (isDefined(n[t])) {
                                                ...
                                                var s = "editar - Habilidades a medida"
                                        } else {
                                                var r = "";
                                                var i = "";
                                                var s = "agregar - Habilidades a medida"
                                        }
                                        ...
                                        var a = function() {};
                                        var f = e('<table width="400px" />').append(e("<tr />").append('<td style="vertical-align:middle">Nombre:</td>').append(e("<td />").append(o.getMainDiv()))).append(e("<tr />").append('<td style="vertical-align:middle">Código:</td>').append(e("<td />").append(u.getMainDiv()))).append(e('<tr><td colspan="2">por favor, vaya a tw-db.info y obtenga el fragmento de código para insertar aquí desde allá <a href="https://' + Script.url + '/?strana=calc" target="_blank">tw-db.info Calculadora</a></td></tr>'));
                        ...
                        var DuelMotivation = function(e) {
                                ...
                                var m = function(e) {
                                        ...
                                        d(t + "%", "Motivación duelo:&nbsp;" + t + "%", e ? "duelmot_dim" : "")
                                };
                                var g = function(e) {
                                        if (f) {
                                                w.clearInterval(f)
                                        ...
                                        a = "<div style='text-align:center;'>Tiempo K.O.<br />";
                                        if (!c && n > t && !e) {
                                                a += "Suspensión duelo hasta&nbsp;" + (new Date(n)).toLocaleString() + "<br />";
                                        ...
                                        u = Math.max(0, u);
                                        a += "Protección duelo hasta&nbsp;" + (new Date(r)).toLocaleString() + "</div>";
                        ...
                        var Bank = function(e) {
                                ...
                                var s = function() {
                                        ...
                                        btn.click(function() {
                                                o()
                                        }).addMousePopup("Depositar su dinero")
                                };
                                var o = function() {
                                        (new west.gui.Dialog("Depositar su dinero", e("<span class='twdb_banking'>Dinero: " + w.Character.money + "</span>"))).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false).addButton("yes", function() {
                                                a(1)
                                        }).addButton("no").show()
                                };
                                var u = function() {
                                        try {
                                                ...
                                                if (w.Character.position.x == w.Character.homeTown.x && w.Character.position.y == w.Character.homeTown.y) {
                                                        if (n) {
                                                                n = false;
                                                                (new west.gui.Dialog("Depositar su dinero", e("<span class='twdb_banking'>Ha llegado a su Ciudad. ¿Quiere depositar su dinero? <br />Dinero: " + w.Character.money + "</span>"))).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false).addButton("yes", function() {
                                                                        n = true;
                        ...
                        var Market = function(e) {
                                ...
                                var o = function() {
                                        ...
                                        if (Settings.get("marketmap", true)) {
                                                GameInject.addTabOnMarketWindow("Mapa de Mercado", "marketmap", function() {
                                                        c()
                                                });
                                ...
                                var l = function(e) {
                                        ...
                                        var u = function(t) {
                                                var r = n[t],
                                                        ...
                                                        s = new OnGoingEntry;
                                                s.init();
                                                s.setTooltip("Subasta: " + i.name + ", Final: " + Number(r.ends - (new Date).getTime() / 1e3).getTimeString4Timestamp());
                                                s.setImage(e('<img src="' + Images.notiBell + '" />'));
                                                WestUi.NotiBar.add(s);
                                                TitleTicker.setNotifyMessage("Subasta: " + i.name + ", Final: " + Number(r.ends - (new Date).getTime() / 1e3).getTimeString4Timestamp());
                                                AudioController.play(AudioController.SOUND_NEWMSG);
                                                o(t)
                                        };
                                        t.create = function(r, i) {
                                                var u = e("<div />").append('<span style="position:relative; width:100%;display:block;">Final de subasta: ' + r.auction_ends_in.getTimeString4Timestamp() + "</span>"),
                                                        a = (new west.gui.Textfield("twdb_analyser_last")).maxlength(4).onlyNumeric().setLabel("Recordar antes que la subasta termine: ").setPlaceholder("Minutos");
                                                u.append(a.getMainDiv());
                                                ...
                                                var f = (new west.gui.Dialog("Recordatorio de mercado", u)).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false, {
                                ...
                                var c = function() {
                                        try {
                                                ...
                                                window.MarketWindow.window.setTitle("Mapa de Mercado").setSize(840, 655).addClass("premium-buy");
                                                var t = -111,
                                                        s = -1;
                                ...
                                var m = function() {
                                        try {
                                                ...
                                                for (var u = 0; u < t.length; u++) {
                                                        var a = i[t[u].id];
                                                        o += '<div><a onclick="TownWindow.open(' + a.x + ", " + a.y + ');">' + a.name + "</a>" + ' <a title="Mostrar Ciudad en Mapa" onclick="Map.center(' + a["x"] + ", " + a["y"] + ')"><img src="' + Game.cdnURL + '/images/icons/center.png" /></a>' + " Distancia: " + a["distance"] + ' <a title="Viajar a la Ciudad" onclick="TaskQueue.add(new TaskWalk(' + a.town_id + ",'town'))\"><img src=\"" + Game.cdnURL + '/images/map/icons/instantwork.png"></a>' + (a["money"] == 0 ? "" : " " + a["money"] + "$") + "<br />";
                        ...
                        var Fort = function($) {
                                ...
                                var inject = function() {
                                        try {
                                                ...
                                                fb_sort = fb_sort.replace(/pp ?< ?ownPriv/, "pp<ownPriv&&ownPriv>gv.SERGEANT").replace(/var hidden ?= ?function\(classKey, ?privKey\) ?{ ?return that\.preBattle\.isHidden\(classKey, ?'rank_'\+ ?privKey\); ?};/, "var hidden=function(classKey,privKey, location){return that.preBattle.isHidden(classKey,'rank_'+privKey, null, null, location);};").replace(/return ?{message: ?sorting, ?title: ?title};/, "else if(key=='healthpoints'){title='Ordenar por salud';sorting.append(getSortLink('Menor a mayor Salud actual','>currhealth'));sorting.append(getSortLink('Mayor a menor Salud','<currhealth')); sorting.append(getSortLink('Menor a mayor máxima Salud','>maxhealth'));sorting.append(getSortLink('Mayor a menor Salud','<maxhealth'));sorting.append('<br />');sorting.append(getSortLink('Menor a mayor Distancia','>distance'));sorting.append(getSortLink('Mayor a menor Distancia','<distance'));sorting.append(getVisLink(hidden(null,'-3','atfort')?'Mostrar Jugador en el Fuerte':'Esconder Jugador en el Fuerte','atfort'));sorting.append(getVisLink(hidden(null,'-3','nearbyfort')?'Mostrar Jugador cercano al Fuerte':'Esconder Jugador cercano al Fuerte','nearbyfort'));sorting.append(getVisLink(hidden(null,'-3','notatfort')?'Mostrar Jugador no cercano al Fuerte':'Esconder Jugador no cercano al Fuerte','notatfort'));}return{message:sorting,title:title};");
                                                eval(fb_sort);
