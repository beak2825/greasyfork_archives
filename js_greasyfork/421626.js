// ==UserScript==
// @name         GalaxyTool B.O.R.G.BELLATRIX
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/421626/GalaxyTool%20BORGBELLATRIX.user.js
// @updateURL https://update.greasyfork.org/scripts/421626/GalaxyTool%20BORGBELLATRIX.meta.js
// ==/UserScript==
...
//$("#galaxytableHead > tfoot > tr:nth-child(1) > td").remove();
    ...
    function submit(){
    if (($("[name~='system']")[0].value != 399 || $("[name~='galaxy']")[0].value != 4)) {
        if ($("[name~='system']")[0].value != 399){
            ...
            $("[name~='system']")[0].value = 1;
             ...
             alert("Proceso finalizado, verifica que la vision de galaxia se encuentra en Galaxia 4 y Sistema 399");
        }
