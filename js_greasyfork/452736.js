// // ==UserScript==
// @name         SOCHI | ADM Script for forum by Tsoy
...
// @downloadURL https://update.greasyfork.org/scripts/452736/SOCHI%20%7C%20ADM%20Script%20for%20forum%20by%20Tsoy.user.js
// @updateURL https://update.greasyfork.org/scripts/452736/SOCHI%20%7C%20ADM%20Script%20for%20forum%20by%20Tsoy.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/COLOR][/FONT]<br><br>' +
        '[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]В обжаловании отказано.<br>' +
        'Приятной игры на BLACK RUSSIA RolePlay.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
