...
// @downloadURL https://update.greasyfork.org/scripts/13793/Mr%20MineAutoclicker.user.js
// @updateURL https://update.greasyfork.org/scripts/13793/Mr%20MineAutoclicker.meta.js
// ==/UserScript==
...
var mrMine = {
    ...
    options: {
        ...
        ,monsterHuntingInterval: 0
        ,monsterHuntingIntervalId: null
        ,state: 0
    ...
    run: function() {
        ...
        mrMine.options.monsterHuntingIntervalId = window.setInterval(mrMine.monsterHunting, mrMine.options.monsterHuntingInterval);
    },
    pause: function() {
        ...
        window.clearInterval(mrMine.options.monsterHuntingIntervalId);
    },
