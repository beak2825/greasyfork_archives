...
// @author MadhATTER6
// @description Adds Kickass Torrents search links to the buy buttons on Last.FM
// @version 2.2.1
// @match http://last.fm/*
// @match http://www.last.fm/*
// @namespace https://greasyfork.org/users/2237
// @downloadURL https://update.greasyfork.org/scripts/11164/Lastfm%20Torrent%20Search.user.js
// @updateURL https://update.greasyfork.org/scripts/11164/Lastfm%20Torrent%20Search.meta.js
// ==/UserScript==
...
function createSearchItem(search){
  ...
  a = li.appendChild(document.createElement("a"));
    ...
    a.setAttribute("href",
                   "http://kat.cr/usearch/?q=" + search);
    span = a.appendChild(document.createElement("span"));
      span.className = "media-body";
      img  = span.appendChild(document.createElement("img"));
        img.setAttribute("src", "http://kastatic.com/images/favicon.ico");
        img.className = 'ecommerce-icon';
    a.appendChild(document.createTextNode("Torrent Search"));
    span = a.appendChild(document.createElement('span'));
