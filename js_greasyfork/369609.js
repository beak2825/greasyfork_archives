// ==UserScript==
// @name               My GM-Mouse Gestures
// @name:zh-CN         我的油猴鼠标手势
// @name:zh-TW         我的油猴滑鼠手勢
// @namespace          hoothin
// @version            0.69+(v4)
// @description        Just a Mouse Gestures script
// @description:zh-CN  就是个鼠标手势脚本，自用改。
// @description:zh-TW  就是個滑鼠手勢脚本，自用改。
// @author             hoothin/pangwx(mod)
...
// @compatible         firefox
// @compatible         safari
// @downloadURL https://update.greasyfork.org/scripts/369609/My%20GM-Mouse%20Gestures.user.js
// @updateURL https://update.greasyfork.org/scripts/369609/My%20GM-Mouse%20Gestures.meta.js
// ==/UserScript==
...
function initEventListener(start, move, end, tracer, clientX, clientY, startBool) {
    ...
    var endFun = function(e) {
        ...
        setTimeout(function() {
            if (gesturesContent.parentNode) gesturesContent.parentNode.removeChild(gesturesContent);
        }, 500);
        if (signs) {
...
(function() {
    ...
    if (GM_info.script.version != GM_getValue("gmMouseGestureVersion")) {
        if (!gestures || window.confirm(i18n.update)) gestures = [{
            gesture: "⇩⇨",
            fun: "close"
        }, {
            gesture: "⇨⇧",
    ...
    initEventListener("mousedown", "mousemove", "contextmenu", tracer, "e.clientX", "e.clientY", "e.which === 2");
        ...
        newOrEditOkBtn.onclick = function(e) {
            if (!newOrEditSign.innerHTML) {
                ...
                if (selIndex === 1 && !newOrEditEval.value) {
                    ...
                    gestures.push({
                        gesture: newOrEditSign.innerHTML,
                        fun: code
                    });
                    GM_setValue("gestures", gestures);
                    refreshGestures();
