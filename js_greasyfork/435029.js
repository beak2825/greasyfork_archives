// ==UserScript==
// @name Krunker  Krunkez.tk
// @description   Advanced krunker cheat!
// @version       4.0.2
// @author        ©2021 Skid Lamer & Datz
// @supportURL    https://skidlamer.github.io/wp
// @homepage      https://github.com/ofDataa/ioGame-archive
...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/435029/Krunker%20%20Krunkeztk.user.js
// @updateURL https://update.greasyfork.org/scripts/435029/Krunker%20%20Krunkeztk.meta.js
// ==/UserScript==
        ...
        onLoad() {
            ...
            this.waitFor(_=>this.token).then(_ => {
                ...
                if ( this.isElectron() || !this.isDefined(GM) ) {
                    ...
                    if (confirm('This Script Needs Updating by Datz, Cancel will attempt to use the script anyway \n(CHANCE OF BAN)')) {
                        return window.location.assign("https://twitter.com/Wh0Az");
                    } else {
                        const loader = new Function("WP_fetchMMToken", "Module", this.gamePatch());
                        loader(new Promise(res=>res(this.token)), { csv: async () => 0 });
                        return this.hooking();
                ...
                if (!(document.activeElement.tagName === "INPUT" || !window.endUI && window.endUI.style.display) && dog.settings.keybinds) {
                    switch (event.code) {
                        ...
                        case "KeyH":
                            ...
                            break
                        case "KeyL":
                            this.settings.bhop = (this.settings.bhop + 1) % 5
                            this.wsEvent("ch", [null, "Bhop Mode: " + ["None", "Auto Jump", "Key Jump", "Auto Slide", "Key Slide"][this.settings.bhop], 1])
                            break
                    }
                }
            })
...
<img src="https://dtz-api-staging-1-datazi.datazi.repl.co/krz2.jpg" width="90%">
<div class="imageButton discordSocial" onmouseenter="playTick()" onclick="openURL('https://discord.gg/FmjwsyYM')"><span style='display:inline'></span></div>`
    ...
    // build gui
    tab(0, () => {
        builder.label("Krunkez V3 By Datz#6876")
        builder.label("===Aimbot===")
