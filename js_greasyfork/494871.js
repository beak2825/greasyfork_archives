...
// @grant        GM_info
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/494871/myOneJAVOneWeb.user.js
// @updateURL https://update.greasyfork.org/scripts/494871/myOneJAVOneWeb.meta.js
// ==/UserScript==
(function () {
    'use strict';
    console.clear();
...
/*                 在线观看: { zhushi: '在线观看类', name: '在线', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                ...
                javscreens: {
                    zhushi: 'javscreens',
                    name: 'javscreens', bgcolor: '#FAFAD2', color: 'red',
