// ==UserScript==
// @name           BaiduPanDownloadHelper 1st
...
// @downloadURL https://update.greasyfork.org/scripts/19322/BaiduPanDownloadHelper%201st.user.js
// @updateURL https://update.greasyfork.org/scripts/19322/BaiduPanDownloadHelper%201st.meta.js
// ==/UserScript==
(function () {
  ...
  if (document.readyState == 'interactive') {
    ...
    var mHome = (function () { // 个人主页
      ...
      var addButton = function () {
        $('<a class="icon-btn-download g-button"><span class="g-button-right"><em class="icon icon-offline-download" title="批量下载"></em><span style="width: auto;" class="text">批量下载</span></span></a>').insertAfter('a.g-button[data-button-id="b13"]').click(downloadAll);
      };
      var init = function () {
        addButton();
        setDocumentTitle();
    ...
    var Pan = {
      ...
      shareDirPageProcessor: function () {
        var self = this;
        // 添加批量下载按钮
        $('<a class="bbtn" style="padding-left:10px"><b>批量下载</b></a>').appendTo('.module-list-toolbar>.bar') [0].onclick = function (e) {
          self.downloadAll();
        };
      },
      ...
      albumInfoPageProcessor: function () {
        ...
        var clicked = function (e) {
          ...
          if ($quickFileSave[0]) {
            $('<a class="bbutton" style="margin-left:10px;padding-left:5px;">\t                        <b style="padding-right: 5px;">批量下载</b></a>'
      ...
      downloadAll: function () {
        ...
        function get_share_dlink(obj, data, file_list) {
          ...
          $.ajax(parameter).done(function (json, textStatus, jqXHR) {
            if (json.errno == - 20) {
              $.ajax({
                'url': pic,
                'dataType': 'json',
