...
(function() {
   ...
   var websiteData = [
        {url : "https://viefaucet.com/app/ptc", login: "", password: ""},
        {url : "https://flickr.com", login: "", password: ""},

    ];

    var websiteMap = [{

            website: ["viefaucet.com"],
            defaultButtonSelectors: [".el-card__body .el-button.el-button--primary.claim-button"],
            allMessageSelectors: [".el-notification__group",".el-notification__content"],
            messagesToCheckBeforeMovingToNextUrl: ["You have claimed 21 tokens", "You have claimed 50 tokens", "You have claimed 91 tokens", "You have claimed 20 tokens", "Success"],
            timeoutbeforeMovingToNextUrl: 47000
        },

        {
            website: ["flickr.com"],
            timeoutbeforeMovingToNextUrl: 1000
        },
