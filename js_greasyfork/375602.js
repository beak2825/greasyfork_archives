...
// @date         01/07/2018
// @modified     23/10/2018
// @homepage     https://greasyfork.org/zh-CN/scripts/375602
...
// @downloadURL https://update.greasyfork.org/scripts/375602/wsmud_pluginss.user.js
// @updateURL https://update.greasyfork.org/scripts/375602/wsmud_pluginss.meta.js
// ==/UserScript==

(function () {
    'use strict';
    var updateinfo = "增加新功能,自动研制药物,请在右键->自动->研制药物 \n支付宝搜索 9214712 领大额线下花呗红包";
        ...
        WG.add_hook(["login", "room", "items", "itemadd", "itemremove", "sc", "text", "state", "msg", "perform", "dispfm", "combat"], function (data) {
            if (data.type == "login") {
                ...
                G.skills = data.skills;
                 ...
                 if(data.msg.indexOf("逆转九阴")>=0)
					{
						WG.Send("perform force.duo");
					}
