...
// @grant          GM_setValue
// @grant          GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/377583/CT_leader.user.js
// @updateURL https://update.greasyfork.org/scripts/377583/CT_leader.meta.js
// ==/UserScript==
...
.container th, .container td:first-child {
    background: #626763;
    color: white;
    padding: 5px 10px;
}
...
/* Button Styles */
a[href*="leader_army.php"],
a[href*="leader_army_exchange.php"],
.btn {
    background-color: #ddd9cd;
    background-image: linear-gradient(to top, #626763, #626763);
    border: 2px solid #bfbfbf;
    -webkit-border-radius: 0;
       -moz-border-radius: 0;
            border-radius: 0;
    -webkit-box-shadow: 0 0 1px 0 #000,inset 0 -1px 0 0 #d9d9d9,inset 0 0 0 1px #f2f2f2,0 2px 4px 0 #f2f2f2;
       -moz-box-shadow: 0 0 1px 0 #000,inset 0 -1px 0 0 #d9d9d9,inset 0 0 0 1px #f2f2f2,0 2px 4px 0 #f2f2f2;
            box-shadow: 0 0 1px 0 #000,inset 0 -1px 0 0 #d9d9d9,inset 0 0 0 1px #f2f2f2,0 2px 4px 0 #f2f2f2;
    color: #fff;
...
a[href*="leader_army.php"]:hover,
a[href*="leader_army_exchange.php"]:hover,
a[href*="leader_army.php"]:active,
a[href*="leader_army_exchange.php"]:active,
.btn:hover,.btn:active {
    background-color: #f2f2f2;
    border: 2px solid #8c8c8c;
    -webkit-box-shadow: inset 0 1px 0 0 #fff,inset 0 -1px 0 0 #d9d9d9,inset 0 0 0 1px #f2f2f2;
       -moz-box-shadow: inset 0 1px 0 0 #fff,inset 0 -1px 0 0 #d9d9d9,inset 0 0 0 1px #f2f2f2;
            box-shadow: inset 0 1px 0 0 #fff,inset 0 -1px 0 0 #d9d9d9,inset 0 0 0 1px #f2f2f2;
    color: #8c8c8c;
}
table.wbwhite tbody tr td table tbody tr td table tbody tr td center b font{
    background: #DC143C;
    color: white;
    display: inline !important;
    padding: 5px 10px;
