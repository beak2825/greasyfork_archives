...
// @version      0.0.1
// @description  技行珠海的视频自动播放插件!,倍率调整版.
// @author       cynen
...
// @downloadURL https://update.greasyfork.org/scripts/501549/jxzh%E8%87%AA%E5%8A%A8%E6%92%AD%E6%94%BE%E8%A7%86%E9%A2%91_v2.user.js
// @updateURL https://update.greasyfork.org/scripts/501549/jxzh%E8%87%AA%E5%8A%A8%E6%92%AD%E6%94%BE%E8%A7%86%E9%A2%91_v2.meta.js
// ==/UserScript==
...
(function () {
    ...
    function getJxzh() {
        return {
            seeVideo: function () {
                ...
                console.log("playRateNow: ",playRateNow);
                addrateinfo();//插入一些按钮
                addratebtn(1);
                addratebtn(5);
                addratebtn(10);
                ...
                window.onload = function () {
                    ...
                    let max = Math.ceil(Math.ceil(video.duration) / 60) * 2
                    let currIndex = 0
                    playInterval = setInterval(() => {
                        ...
                        if (currIndex > max) {
                            ...
                            video.player.seek(currIndex * playRateNow);
                            recordDragProcess(currIndex * playRateNow, currIndex * playRateNow, 6);
                        }
                    }, 1000)
    ...
    function addratebtn(ra){//倍率调整按钮
        ...
        document.getElementById("J_prismPlayer").parentNode.append(alink);
    }
    ...
    function addrateinfo(){//插入说明
        ...
        document.getElementById("J_prismPlayer").parentNode.append(adiv1);
    ...
    function addinfo(){//插入说明
        ...
        document.getElementById("J_prismPlayer").parentNode.append(adiv2);
    }
