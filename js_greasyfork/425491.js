// ==UserScript==
// @name         Bilibili English Show Chapter Date
...
// @author       Quin15
// @match        https://www.bilibilicomics.com/detail*
// @icon         https://www.google.com/s2/favicons?domain=bilibili.com
// @grant        GM_xmlhttpRequest
// @run-at       document-idle
// @downloadURL https://update.greasyfork.org/scripts/425491/Bilibili%20English%20Show%20Chapter%20Date.user.js
// @updateURL https://update.greasyfork.org/scripts/425491/Bilibili%20English%20Show%20Chapter%20Date.meta.js
// ==/UserScript==

GM_xmlhttpRequest ({
    method:     'POST',
    url:        "https://www.bilibilicomics.com/twirp/comic.v1.Comic/ComicDetail?device=pc&platform=web",
...
var addButtons = function() {
    ...
    searchAP.style = "padding:6px; margin-left:212px";
    searchAP.setAttribute("data-v-b8e7c12a", "");
    searchAP.setAttribute("data-v-fc75675e", "");
    ...
    coverImg.style = "padding:6px";
    coverImg.setAttribute("data-v-b8e7c12a", "");
    coverImg.setAttribute("data-v-fc75675e", "");
