...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/455182/%E5%8C%97%E5%B7%A5%E5%A4%A7%E6%AF%8F%E6%97%A5%E6%89%93%E5%8D%A1%EF%BC%88%E6%A0%A1%E5%A4%96%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/455182/%E5%8C%97%E5%B7%A5%E5%A4%A7%E6%AF%8F%E6%97%A5%E6%89%93%E5%8D%A1%EF%BC%88%E6%A0%A1%E5%A4%96%EF%BC%89.meta.js
// ==/UserScript==
        ...
        let check = setInterval(() => {
            ...
            if (document.getElementsByClassName("u-icon__icon uicon-checkbox-mark u-iconfont")[1]) {
                ...
                setTimeout(() => {
                    ...
                    var jing = "京内校外（off-campus in Beijing）";
                    ...
                    var test = "今日在校外做核酸检测（I have done the test out of school today）";
                    var reason = "因疫情原因未返校（Not returning to the university for Covid-19 pandemic ）";

                    for (let i = 0; i < u_label.length; i++) {
                        if (label[i] == no || label[i] == jing || label[i] == yi || label[i] == normal 
                            || label[i] == negative || label[i] == covid || label[i] == area 
                            || label[i] == test || label[i] == reason){
                            j = choice.length;
                            choice[j] = i;
                            console.log(label[i]);
                        }
