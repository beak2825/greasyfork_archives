// ==UserScript==
// @name   🌱【免费版】潍坊市医疗保障政策培训平台|如需自动下一集、秒过、自动换课程等高级功能见收费版本：https://doc.zhanyc.cn/course/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、秒过、自动换课程、全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.yxjypx.cn/*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/561071/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%BD%8D%E5%9D%8A%E5%B8%82%E5%8C%BB%E7%96%97%E4%BF%9D%E9%9A%9C%E6%94%BF%E7%AD%96%E5%9F%B9%E8%AE%AD%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E7%A7%92%E8%BF%87%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccncourse.user.js
// @updateURL https://update.greasyfork.org/scripts/561071/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%BD%8D%E5%9D%8A%E5%B8%82%E5%8C%BB%E7%96%97%E4%BF%9D%E9%9A%9C%E6%94%BF%E7%AD%96%E5%9F%B9%E8%AE%AD%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E7%A7%92%E8%BF%87%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccncourse.meta.js
// ==/UserScript==
(function () {
    let $jq = $;
    unsafeWindow.$jq = $;
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、秒过、自动换课程、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/wfsyl/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/course/media".toLowerCase())) {
                // await zfk.setUserName_http();
                plugMain.page_video();
            } else if (url.includes("/course/info".toLowerCase())) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.endsWith("wfyb.yxjypx.cn/".toLowerCase())) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/train/info".toLowerCase())) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            }
        },
        async page_video() {
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    let isFinish = $(".media-status:visible").text() == '已通过'
                    if (isFinish) {
                    ...
                    if (!isPlay) {
                        if (!isFinish) {
                            $(".prism-big-play-btn:visible").click()
                        }
                    }
                } catch (e) {
        ...
        getCurTime() {
            let res = 0;
            try {
                res = plugMain.getVideo().currentTime;
            } catch (e) {
                console.error(e);
            }
            return res;
        ...
        getTotalTime() {
            let res = 0;
            try {
                res = plugMain.getVideo().duration;
            } catch (e) {
                console.error(e);
            }
            return res;
        ...
        async videoIsPlay() {
            return new Promise((resolve) => {
                try {
                    let curTime = plugMain.getCurTime();
                    setTimeout(() => {
                        let time1 = plugMain.getCurTime();
                        let res = time1 > curTime;
                        if (res) {
                            setTimeout(() => {
                                let time2 = plugMain.getCurTime();
