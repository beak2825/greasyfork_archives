...
// @downloadURL https://update.greasyfork.org/scripts/513467/ParagonJSTool.user.js
// @updateURL https://update.greasyfork.org/scripts/513467/ParagonJSTool.meta.js
// ==/UserScript==
...
function create_Reply_Button(){
    ...
    if (emailBodyElements.length > 1) {
        ...
        if (buttonElement) {
            ...
            console.log('第二个 emailBodyElement 中没有找到 button 元素');
        }
    } else {
        console.log('没有足够的 emailBodyElements 元素');
    }
...
`;
    ...
    button.onclick=function Test(){
        ...
        let first_Reply=One("//span[text()='対応履歴']/../../..//div[contains(@class,'pre_') or contains(@class,'contact-text')]",document)
