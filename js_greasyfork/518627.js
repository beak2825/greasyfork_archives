// ==UserScript==
// @name         Discord Embed Hider
// @namespace    http://tampermonkey.net/
// @version      1.3
// @description  Hide specific Discord embed elements
// @author       You
// @match        https://discord.com/channels/1165405556421435483/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/518627/Discord%20Embed%20Hider.user.js
// @updateURL https://update.greasyfork.org/scripts/518627/Discord%20Embed%20Hider.meta.js
// ==/UserScript==
...
(function() {
    ...
    function hideElements() {
        ...
        const elements = document.querySelectorAll("[id^='message-accessories-'] > article > div > div > div.embedProvider_b0068a.embedMargin_b0068a, [id^='message-accessories-'] > article > div > div > div.embedTitle_b0068a.embedMargin_b0068a, .buttons_bdf0de .expression-picker-chat-input-button.buttonContainer_bdf0de, .buttons_bdf0de .separator_a06035, .channelAppLauncher_df39bd .buttonContainer_df39bd.app-launcher-entrypoint");
