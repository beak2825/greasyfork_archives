...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/467080/%E6%B5%8E%E5%AE%81%E8%81%8C%E4%B8%9A%E6%8A%80%E6%9C%AF%E5%AD%A6%E9%99%A2%E4%B8%93%E6%8A%80%E4%BA%BA%E5%91%98%E5%85%AC%E9%9C%80%E7%A7%91%E7%9B%AE.user.js
// @updateURL https://update.greasyfork.org/scripts/467080/%E6%B5%8E%E5%AE%81%E8%81%8C%E4%B8%9A%E6%8A%80%E6%9C%AF%E5%AD%A6%E9%99%A2%E4%B8%93%E6%8A%80%E4%BA%BA%E5%91%98%E5%85%AC%E9%9C%80%E7%A7%91%E7%9B%AE.meta.js
// ==/UserScript==
...
(function() {
    ...
    function zy(){
        ...
        if(document.querySelector("li.clearfix.videoLi.active").querySelector('.progress.video-progress>div')!==null){
            if(document.querySelector("li.clearfix.videoLi.active").querySelector('.progress.video-progress>div').attributes[2].value.search('100')>0){//no100
            next()
            }
        }

        if(document.querySelector("div.modal-scrollable>div>div>div>div.modal-footer>button")!==null){
        document.querySelector("div.modal-scrollable>div>div>div>div.modal-footer>button").click()
        sx()
        }
    ...
    function next(){
        if(document.querySelector("li.clearfix.videoLi.active").nextElementSibling!==null){
        document.querySelector("li.clearfix.videoLi.active").nextElementSibling.click()
        }else{
        document.querySelector("li.clearfix.videoLi.active").parentElement.parentElement.nextElementSibling.querySelector('.clearfix.videoLi').click()
        }
    }
    function dati(){//答题
    ...
    function datixuan(){
        ...
        if(document.getElementsByClassName('checkboxBg').length==0){//单选
        ...
        dtfu.querySelectorAll('li>i')[3].click()
            ...
            var Duox=document.getElementsByClassName('checkboxBg')
