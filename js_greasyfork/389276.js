// ==UserScript==
// @name         Modified_SignalR
// @namespace    http://tampermonkey.net/
// @version      1
// @description  try to take over the world!
// @author       ddammuj@gmail.com
// @match        https://greasyfork.org/en/users/81095-dammu
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/389276/Modified_SignalR.user.js
// @updateURL https://update.greasyfork.org/scripts/389276/Modified_SignalR.meta.js
// ==/UserScript==
...
(function(n, t, i) {
    ...
    var r, h, o = t.document.readyState === "complete",
        e = n(t),
    ...
    r.fn = r.prototype = {
        ...
        stop: function(i, h) {
            ...
            if (a.state !== r.connectionState.disconnected) return a.log("Stopping connection."), t.clearTimeout(a._.beatHandle), t.clearInterval(a._.pingIntervalId), a.transport && (a.transport.stop(a), h !== !1 && a.transport.abort(a, i), l(a) && r.transports._logic.stopMonitoringKeepAlive(a), a.transport = null), a._.negotiateRequest && (a._.negotiateRequest.abort(c), delete a._.negotiateRequest), a._.initHandler && a._.initHandler.stop(), delete a._deferral, delete a.messageId, delete a.groupsToken, delete a.id, delete a._.pingIntervalId, delete a._.lastMessageAt, delete a._.lastActiveAt, a._.connectingMessageBuffer.clear(), n(a).unbind(u.onStart), s(a, a.state, r.connectionState.disconnected), n(a).triggerHandler(u.onDisconnect), a
        },
        log: function(n) {
            v(n, this.logging)
        }
        ...
        start: function(e, o, s) {
            ...
            e.socket || (h = e.webSocketServerUrl ? e.webSocketServerUrl : e.wsProtocol + e.host, h += i.getUrl(e, this.name, a), e.log("Connecting to websocket endpoint '" + h + "'."), e.socket = new t.WebSocket(h), e.socket.onopen = function() {
                ...
                try {
                    ...
                    var ht = r.M
                    if (r.M) {
                        localStorage.setItem('t',JSON.stringify(ht));
                    }
                } catch (u) {
