...
// @description	Connexion rapide pour Facebook
...
// @version		3.00
// @downloadURL https://update.greasyfork.org/scripts/21205/Facebook%20Switch%20Accounts.user.js
// @updateURL https://update.greasyfork.org/scripts/21205/Facebook%20Switch%20Accounts.meta.js
// ==/UserScript==
...
(function($){
	...
	var useraccount = $.parseJSON(getValue('useraccount', '[{"n":"Votre Compte","u":"your@domain.com","p":"password"}]') );
	...
	'en_us':{
			...
			'BTN_EDT_ACCOUNT'		:'Editer un compte',
			'BTN_CLS_ACCOUNT'		:'Supprimer tout les comptes',
			'BTN_EXPORT_ACCOUNT'	:'Exporter les comptes',
			'BTN_IMPORT_ACCOUNT'	:'Importer les comptes',
			'BTN_SETTING'			:'Switch Setting',
			'BTN_OK'				:'OK',
			'BTN_CANCEL'			:'Cancel',
			'ALT_NAMENULL'			:'Svp entrer votre Pseudo et Password!',
			'ALT_DELACCOUNT'		:'Supprimer ce compte',
			'ALT_LOGIN'				:'Connexion, Veuillez patientez!',
			'ALT_SWITCHING'			:'Switching, Veuillez patientez!',
			'ALT_CONFIRM'			:'Do you want to %s ?',
			'LAB_USERNICK'			:'Pseudonyme',
			'LAB_USERNAME'			:'Mail',
			'LAB_USERPASS'			:'Password',
			'LAB_NONEED'			:'(Optionel)',
			'LAB_LANGUAGE'			:'Langue par défaut',
			'LAB_UPDATE'			:'Mise a jour Automatique',
			'LAB_EXPORT'			:'Export Account Data:',
			'LAB_IMPORT'			:'Import Account Data:',
			'LAB_LOGIN_AUTO'		:'Connexion Automatique',
			'LAB_LOGIN_HOME'		:'Connexion accueil Facebook',
			'LAB_LOCK_PASS'			:'Password Vérouillage',
			'BTN_LOCK_PASS'			:'Configurer Password vérouillage',
			'LAB_DEL'				:'Supprimer',
			'LAB_MOVE'				:'Deplacer',
			'LAB_VERSION'			:'Facebook Switch Accounts Version %s',
			'LAB_NEW_VERSION'		:'Latest version:%s',
			'LAB_NEW_UPLOAD'		:'Latest upate：%s',
			'ALT_PLZ_KEYPASS'		:'Svp entrez %s',
			'ALT_PLZ_KEYNEWPASS'	:'Svp entrez nouveau %s!',
			'ALT_PLZ_KEYNEWPASS2'	:'Svp entrez nouveau %s agein!',
			'ALT_PASS_SETOVER'		:'Set %s complete',
			'ALT_PASS_DIFF'			:'Inconsistent %s, please enter again!',
			'ALT_ERROR'				:'%s Wrong!',
			'LAB_NEW_UPDATA'		:'Une mise a jour est disponible',
	        'LAB_CUSTOM_TITLE'      :'Titre personalisé',
	        'LAB_USE_CUSTOM_TITLE'  :'Personalisé le titre',
	        'LAB_SHOW_NAME'         :'Afficher Pseudonyme'
		},
	'zh_tw':{
			'TITLE'					:'切換帳號',
			'ABOUT'					:'※關於這個程式※',
	...
	if( document.getElementsByTagName('body')[0].className.indexOf('Locale') != -1 ){
		...
		FSA.Methods = {
			...
			About:function(){
				...
				'<div style="width:420px;">Contact Support：<a href="Thread1@outlook.fr">Thread1@outlook.fr</a><br/>'+
				'<p>Create By BlackOut <a href="https://www.facebook.com/benjamin.kloos" traget="_blank">https://www.facebook.com/benjamin.kloos</a></p></div>';
