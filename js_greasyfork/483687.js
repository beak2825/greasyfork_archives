// ==UserScript==
// @name         Скрипт для Кураторов Форума || VOLGOGRAD
// @namespace    http://tampermonkey.net/
// @version      1.0.5
// @description  Скрипт для Кураторов Форума
// @author       Ilya Ahanovsky
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/483687/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%7C%20VOLGOGRAD.user.js
// @updateURL https://update.greasyfork.org/scripts/483687/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%7C%20VOLGOGRAD.meta.js
// ==/UserScript==
...
{
    	  title: '| 2.06. Отыгровки в свою пользу|',
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Доброго времени суток, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил: [/SIZE][/FONT] <br><br>"+
...
},
{
	  ...
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Приветствую, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
    ...
    },
{
	  ...
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Приветствую, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
    "[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=Lime] Главному куратору форума (@Ilya Ahanovsky) [/COLOR], ожидайте ответа.[/SIZE][/FONT]<br><br>"+
                 "[B][CENTER][COLOR=YELLOW][ICODE]На рассмотрении у ГКФ[/ICODE][/COLOR]<br><br>",
        prefix: PINN_PREFIX,
	  status: true,
},
    {
	  title: '| На рассмотрении у ЗГКФ |',
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Приветствую, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
    "[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=Lime] Заместителю главного куратора форума (@James_Uzumaki) [/COLOR], ожидайте ответа.[/SIZE][/FONT]<br><br>"+
                 "[B][CENTER][COLOR=YELLOW][ICODE]На рассмотрении у ЗГКФ[/ICODE][/COLOR]<br><br>",
        prefix: PINN_PREFIX,
	  status: true,
},
    {
	  ...
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Приветствую, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
    "[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=RED]Главному администратору (@Angel Extazzy) [/COLOR], ожидайте ответа.[/SIZE][/FONT]<br><br>"+
                 "[B][CENTER][COLOR=YELLOW][ICODE]На рассмотрении у [COLOR=#ff0000][ICODE]Главного администратора[/ICODE][/COLOR]<br><br>",
        prefix: GA_PREFIX,
	  status: true,
},
{
...
},
{
	  ...
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Доброго времени суток, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=RED]Техническому специалисту сервера @Adelard Lemonte[/COLOR], ожидайте ответа.[/SIZE][/FONT]<br><br>"+
...
},
{
	  ...
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Доброго времени суток, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для силовых структур: [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][COLOR=lavender][FONT=times new roman][Color=#ff0000]6.03.[/color] Запрещено nRP поведение [Color=#ff0000]| Warn[/color].[/COLOR][/CENTER][/B]<br><br>"+
                 "[B][CENTER][FONT=georgia][SIZE=4][COLOR=GREEN][ICODE]Одобрено[/ICODE][/COLOR][/SIZE][/FONT]<br><br>",
        prefix: ACCСEPT_PREFIX,
	  status: false,
},
