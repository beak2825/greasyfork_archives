...
// @version      0.77
// @description  Splatoon Theme for Jstris
// @author       Oki, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/387494/Splatoon%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/387494/Splatoon%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/PtW72rR.png",48);
        loadGhostSkin("https://i.imgur.com/j7VRYsc.png",48);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/CRFHx5l.png')";
        document.body.style.backgroundSize="100% 100%";
        document.getElementById("app").style.backgroundColor="rgba(0, 0, 0, 0)";
        document.getElementById("app").style.height="1000px";
        bgLayer.style.opacity=0.95 //grid opacity change
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_lock.wav",abs:1};
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Splat_ready.mp3",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_go.wav",abs:1,set:0};
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_died.wav",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Splat_hold.mp3",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_move.wav",abs:1,set:0};
...
function atGameStart() {
    ...
    img.src = "https://i.imgur.com/8eAsRnk.png";
...
customStyle2.innerHTML='.slot span a {color:rgba(113, 74, 219, 100);} .slot span {color:rgba(206, 246, 36, 100);}';
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear4.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_clear5.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/t99_perfectclear.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_b2btspin.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_b2btetris.mp3"
];
...
Game['rotationSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_rotate.wav", //rotate left
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_rotate.wav", //rotate right
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatoon_rotate.wav" //rotate 180°
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatsong1.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatsong2.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Splatsong3.mp3"
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/Splatsong1.mp3"
