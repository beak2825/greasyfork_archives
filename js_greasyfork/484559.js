// ==UserScript==
// @name AudioBookBay hide category: Literature
// @description Hide Literature category
...
// @downloadURL https://update.greasyfork.org/scripts/484559/AudioBookBay%20hide%20category%3A%20Literature.user.js
// @updateURL https://update.greasyfork.org/scripts/484559/AudioBookBay%20hide%20category%3A%20Literature.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Literature'
    $(".post").has(".postInfo:contains('Literature')").hide();
});
