// ==UserScript==
// @name              [ALL SERVERS] GOLDEN VERSION | Скрипт для Кураторов Форума [Для телефона]
...
// @description       Скрипт, который подходит для всех серверов, предназначен для быстрой реакции кураторов форума в различных разделах. Он разработан с учётом размеров экрана телефона. Золотая версия - по истине премиальный стиль. Также в скрипт встроен счётчик слов в РПБ.
// @downloadURL https://update.greasyfork.org/scripts/553911/%5BALL%20SERVERS%5D%20GOLDEN%20VERSION%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%5B%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D0%BB%D0%B5%D1%84%D0%BE%D0%BD%D0%B0%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/553911/%5BALL%20SERVERS%5D%20GOLDEN%20VERSION%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%5B%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D0%BB%D0%B5%D1%84%D0%BE%D0%BD%D0%B0%5D.meta.js
// ==/UserScript==
 
(function () {
'esversion 6' ;
...
},
{
    ...
    content: 
          ...
          '[COLOR=#D4AF37]Приятной игры на [B][COLOR=#FFD700]BLACK RUSSIA[/COLOR][/B].[/COLOR]<br><br>' +
...
},
{
    ...
    content:
          '[CENTER][FONT=Verdana][SIZE=4][COLOR=#FFD700]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> [COLOR=#D4AF37]{{ user.mention }}[/COLOR].[/SIZE]<br><br>' +
          '[img]https://i.postimg.cc/MTK8CnN1/2c4f6b93a412c9f4348290d4baabdaf9.png[/img]<br><br>' +
          '[SIZE=4][COLOR=#FFA500]▪ Нарушитель будет наказан по пункту правил:[/COLOR][/SIZE][QUOTE][SIZE=4][COLOR=#FF0000]3.10.[/COLOR] [COLOR=#E5E5E5]Запрещена выдача себя за администратора, если таковым не являетесь | [COLOR=rgb(255, 0, 0)]Ban 7 - 15. [/QUOTE][/COLOR]<br>' +
          '[img]https://i.postimg.cc/Ghs1nw7X/bp.webp[/img]<br><br>' +
          '[SIZE=5][B][COLOR=#00AA00]✓ Одобрено ✓[/COLOR][/B][/SIZE]<br><br>' +
          '[COLOR=#D4AF37]Приятной игры на [B][COLOR=#FFD700]BLACK RUSSIA[/COLOR][/B].[/COLOR]<br>' +
          '[COLOR=#B8860B][I]С уважением, администрация сервера![/I][/COLOR][/FONT][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][FONT=Verdana][SIZE=4][COLOR=#FFD700]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> [COLOR=#D4AF37]{{ user.mention }}[/COLOR].[/SIZE]<br><br>' +
          '[img]https://i.postimg.cc/MTK8CnN1/2c4f6b93a412c9f4348290d4baabdaf9.png[/img]<br><br>' +
          '[SIZE=4][COLOR=#FFA500]▪ Нарушитель будет наказан по пункту правил:[/COLOR][/SIZE][QUOTE][SIZE=4][COLOR=#FF0000]2.37.[/COLOR] [COLOR=#E5E5E5]Запрещены OOC угрозы, в том числе и завуалированные | [COLOR=rgb(255, 0, 0)]Mute 120 минут / Ban 7-15 дней.[/QUOTE][/COLOR]<br>' +
          '[img]https://i.postimg.cc/Ghs1nw7X/bp.webp[/img]<br><br>' +
          '[SIZE=5][B][COLOR=#00AA00]✓ Одобрено ✓[/COLOR][/B][/SIZE]<br><br>' +
          '[COLOR=#D4AF37]Приятной игры на [B][COLOR=#FFD700]BLACK RUSSIA[/COLOR][/B].[/COLOR]<br>' +
          '[COLOR=#B8860B][I]С уважением, администрация сервера![/I][/COLOR][/FONT][/CENTER]',
	...
	},
{
    ...
    content:
          ...
          '[COLOR=#D4AF37]{{ user.mention }}[/COLOR].[/SIZE]<br><br>' +
          '[img]https://i.postimg.cc/MTK8CnN1/2c4f6b93a412c9f4348290d4baabdaf9.png[/img]<br><br>' +
          '[SIZE=4][COLOR=#FFA500]▪ В Вашей RolePlay биографии отсутствуют фото и иные материалы, относящиеся к истории Вашего персонажа.[/COLOR][/SIZE]<br>' +
          ...
          '[img]https://i.postimg.cc/Ghs1nw7X/bp.webp[/img]<br><br>' +
          '[SIZE=5][B][COLOR=#FFA500]⏳ Ожидание дополнения (24ч) ⏳[/COLOR][/B][/SIZE]<br><br>' +
          '[/FONT][/CENTER]',
    prefix: PINBIO_PREFIX,
    status: true,
},
{
    ...
    content:
          ...
          '[COLOR=#D4AF37]{{ user.mention }}[/COLOR].[/SIZE]<br><br>' +
          '[img]https://i.postimg.cc/MTK8CnN1/2c4f6b93a412c9f4348290d4baabdaf9.png[/img]<br><br>' +
          '[SIZE=4][COLOR=#FFA500]▪ В Вашей RolePlay биографии присутствуют грамматические ошибки.[/COLOR][/SIZE]<br>' +
...
},
{
    ...
    content:
          ...
          '[COLOR=#D4AF37]{{ user.mention }}[/COLOR].[/SIZE]<br><br>' +
          '[img]https://i.postimg.cc/MTK8CnN1/2c4f6b93a412c9f4348290d4baabdaf9.png[/img]<br><br>' +
          '[SIZE=4][COLOR=#FFA500]▪ В Вашей RolePlay биографии недостаточно информации в основных разделах.[/COLOR][/SIZE]<br>' +
          '[COLOR=#E5E5E5]Дополните разделы (Детство, Настоящее время, Итог и т.д.) в течение [B]24 часов[/B].[/COLOR]<br><br>' +
          '[COLOR=#FF4444]Обязательные разделы для заполнения:[/COLOR]<br>' +
