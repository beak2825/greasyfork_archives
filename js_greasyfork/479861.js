...
(function (e$2) {
  ...
  function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
    ...
    const setupStore = runWithContext(() => pinia._e.run(() => (scope = e$2.effectScope()).run(() => setup({ action }))));
  ...
  function d$2(u2, e2, r2) {
    let i2 = e$2.ref(r2 == null ? void 0 : r2.value), f2 = e$2.computed(() => u2.value !== void 0);
...
`)].join(`
`));
        let p2 = j((h2 = u2.props) != null ? h2 : {}, l2, d2), f2 = e$2.cloneVNode(u2, p2, true);
        for (let s3 in p2) s3.startsWith("on") && (f2.props || (f2.props = {}), f2.props[s3] = p2[s3]);
        return f2;
      }
      return Array.isArray(a2) && a2.length === 1 ? a2[0] : a2;
    }
    return e$2.h(n2, Object.assign({}, l2, d2), { default: () => a2 });
  }
  function b(r2) {
  ...
  let f$2 = e$2.defineComponent({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(t2, { slots: n2, attrs: i2 }) {
    return () => {
      var r2;
  ...
  function k$1({ slot: t2 = e$2.ref({}), name: o2 = "Description", props: s3 = {} } = {}) {
    let e2 = e$2.ref([]);
    function r2(n2) {
    ...
    return e$2.provide(u, { register: r2, slot: t2, name: o2, props: s3 }), e$2.computed(() => e2.value.length > 0 ? e2.value.join(" ") : void 0);
  }
  e$2.defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: null } }, setup(t2, { attrs: o2, slots: s3 }) {
    var n2;
    let e2 = (n2 = t2.id) != null ? n2 : `headlessui-description-${i$4()}`, r2 = w();
    return e$2.onMounted(() => e$2.onUnmounted(r2.register(e2))), () => {
      let { name: i2 = "Description", slot: l2 = e$2.ref({}), props: d2 = {} } = r2, { ...c2 } = t2, f2 = { ...Object.entries(d2).reduce((a2, [g2, m]) => Object.assign(a2, { [g2]: e$2.unref(m) }), {}), id: e2 };
  ...
  let N = e$2.defineComponent({ name: "Disclosure", props: { as: { type: [Object, String], default: "template" }, defaultOpen: { type: [Boolean], default: false } }, setup(t$12, { slots: r2, attrs: o2 }) {
    let s3 = e$2.ref(t$12.defaultOpen ? 0 : 1), e2 = e$2.ref(null), i$12 = e$2.ref(null), n2 = { buttonId: e$2.ref(`headlessui-disclosure-button-${i$4()}`), panelId: e$2.ref(`headlessui-disclosure-panel-${i$4()}`), disclosureState: s3, panel: e2, button: i$12, toggleDisclosure() {
    ...
    return e$2.provide(T, n2), t(e$2.computed(() => u$5(s3.value, { [0]: i.Open, [1]: i.Closed }))), () => {
  ...
  } }), Q = e$2.defineComponent({ name: "DisclosureButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(t2, { attrs: r2, slots: o2, expose: s$12 }) {
    let e2 = O("DisclosureButton"), i2 = U(), n2 = e$2.computed(() => i2 === null ? false : i2.value === e2.panelId.value);
    e$2.onMounted(() => {
    ...
    let l2 = e$2.ref(null);
    s$12({ el: l2, $el: l2 }), n2.value || e$2.watchEffect(() => {
      e2.button.value = l2.value;
    });
    let a2 = s2(e$2.computed(() => ({ as: t2.as, type: r2.type })), l2);
    function c2() {
      var u2;
  ...
  } }), V = e$2.defineComponent({ name: "DisclosurePanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: null } }, setup(t2, { attrs: r2, slots: o2, expose: s3 }) {
    let e2 = O("DisclosurePanel");
    e$2.onMounted(() => {
      t2.id !== null && (e2.panelId.value = t2.id);
    }), e$2.onUnmounted(() => {
      e2.panelId.value = null;
    }), s3({ el: e2.panel, $el: e2.panel }), e$2.provide(k, e2.panelId);
    let i$12 = l(), n2 = e$2.computed(() => i$12 !== null ? (i$12.value & i.Open) === i.Open : e2.disclosureState.value === 0);
    return () => {
      var v2;
  ...
  let Ie = e$2.defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b2, attrs: r2, emit: w2 }) {
    ...
    let D = e$2.computed(() => o2.multiple ? 1 : 0), [y2, L] = d$2(e$2.computed(() => o2.modelValue), (t2) => w2("update:modelValue", t2), e$2.computed(() => o2.defaultValue)), M = e$2.computed(() => y2.value === void 0 ? u$5(D.value, { [1]: [], [0]: void 0 }) : y2.value), k2 = { listboxState: n2, value: M, mode: D, compare(t2, i2) {
      if (typeof o2.by == "string") {
        let l2 = o2.by;
        return (t2 == null ? void 0 : t2[l2]) === (i2 == null ? void 0 : i2[l2]);
      }
      return o2.by(t2, i2);
    }, orientation: e$2.computed(() => o2.horizontal ? "horizontal" : "vertical"), labelRef: e2, buttonRef: f2, optionsRef: v2, disabled: e$2.computed(() => o2.disabled), options: s3, searchQuery: m, activeOptionIndex: p2, activationTrigger: a2, closeListbox() {
      ...
      o2.disabled || L(u$5(D.value, { [0]: () => t2, [1]: () => {
        let i2 = e$2.toRaw(k2.value.value).slice(), l2 = e$2.toRaw(t2), d2 = i2.findIndex((O2) => k2.compare(l2, e$2.toRaw(O2)));
    ...
    }, e$2.computed(() => n2.value === 0)), e$2.provide($, k2), t(e$2.computed(() => u$5(n2.value, { [0]: i.Open, [1]: i.Closed })));
    let C2 = e$2.computed(() => {
      var t2;
    ...
    return e$2.onMounted(() => {
      ...
      return e$2.h(e$2.Fragment, [...t2 != null && M.value != null ? e$1({ [t2]: M.value }).map(([I, Q2]) => e$2.h(f$2, E$1({ features: u$2.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q2 }))) : [], A$1({ ourProps: {}, theirProps: { ...r2, ...T$1(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h2, slots: b2, attrs: r2, name: "Listbox" })]);
    };
  } });
  e$2.defineComponent({ name: "ListboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(o2, { attrs: b2, slots: r2 }) {
    var f2;
  ...
  let je = e$2.defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o2, { attrs: b2, slots: r2, expose: w2 }) {
    var p2;
    ...
    let m = s2(e$2.computed(() => ({ as: o2.as, type: b2.type })), e2.buttonRef);
    return () => {
      var y2, L;
  ...
  } }), Ae = e$2.defineComponent({ name: "ListboxOptions", props: { as: { type: [Object, String], default: "ul" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: null } }, setup(o2, { attrs: b2, slots: r2, expose: w2 }) {
    var p2;
    let n2 = (p2 = o2.id) != null ? p2 : `headlessui-listbox-options-${i$4()}`, e2 = A("ListboxOptions"), f2 = e$2.ref(null);
    ...
    let s3 = l(), m = e$2.computed(() => s3 !== null ? (s3.value & i.Open) === i.Open : e2.listboxState.value === 0);
    return () => {
      var y2, L;
  ...
  } }), Fe = e$2.defineComponent({ name: "ListboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, id: { type: String, default: null } }, setup(o2, { slots: b2, attrs: r2, expose: w2 }) {
    var C2;
    let n2 = (C2 = o2.id) != null ? C2 : `headlessui-listbox-option-${i$4()}`, e2 = A("ListboxOption"), f2 = e$2.ref(null);
    w2({ el: f2, $el: f2 });
    let v2 = e$2.computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n2 : false), s3 = e$2.computed(() => u$5(e2.mode.value, { [0]: () => e2.compare(e$2.toRaw(e2.value.value), e$2.toRaw(o2.value)), [1]: () => e$2.toRaw(e2.value.value).some((t2) => e2.compare(e$2.toRaw(t2), e$2.toRaw(o2.value))) })), m = e$2.computed(() => u$5(e2.mode.value, { [1]: () => {
      var i2;
    ...
    }, [0]: () => s3.value })), p$12 = p(f2), a2 = e$2.computed(() => ({ disabled: o2.disabled, value: o2.value, get textValue() {
      return p$12();
    }, domRef: f2 }));
  ...
  function E({ slot: t2 = {}, name: n2 = "Label", props: i2 = {} } = {}) {
    ...
    return e$2.provide(a, { register: o2, slot: t2, name: n2, props: i2 }), e$2.computed(() => e2.value.length > 0 ? e2.value.join(" ") : void 0);
  }
  let K = e$2.defineComponent({ name: "Label", props: { as: { type: [Object, String], default: "label" }, passive: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(t2, { slots: n2, attrs: i2 }) {
    var r2;
    let e2 = (r2 = t2.id) != null ? r2 : `headlessui-label-${i$4()}`, o2 = d();
    return e$2.onMounted(() => e$2.onUnmounted(o2.register(e2))), () => {
      let { name: l2 = "Label", slot: p2 = {}, props: c2 = {} } = o2, { passive: f2, ...s3 } = t2, u2 = { ...Object.entries(c2).reduce((b2, [g2, m]) => Object.assign(b2, { [g2]: e$2.unref(m) }), {}), id: e2 };
  ...
  let C = Symbol("GroupContext"), oe = e$2.defineComponent({ name: "SwitchGroup", props: { as: { type: [Object, String], default: "template" } }, setup(l2, { slots: c2, attrs: i2 }) {
    let r2 = e$2.ref(null), f2 = E({ name: "SwitchLabel", props: { htmlFor: e$2.computed(() => {
      var t2;
    ...
    return e$2.provide(C, { switchRef: r2, labelledby: f2, describedby: p2 }), () => A$1({ theirProps: l2, ourProps: {}, slot: {}, slots: c2, attrs: i2, name: "SwitchGroup" });
  } }), ue = e$2.defineComponent({ name: "Switch", emits: { "update:modelValue": (l2) => true }, props: { as: { type: [Object, String], default: "button" }, modelValue: { type: Boolean, default: void 0 }, defaultChecked: { type: Boolean, optional: true }, form: { type: String, optional: true }, name: { type: String, optional: true }, value: { type: String, optional: true }, id: { type: String, default: null }, disabled: { type: Boolean, default: false }, tabIndex: { type: Number, default: 0 } }, inheritAttrs: false, setup(l2, { emit: c2, attrs: i2, slots: r2, expose: f2 }) {
    var h2;
    let p2 = (h2 = l2.id) != null ? h2 : `headlessui-switch-${i$4()}`, n2 = e$2.inject(C, null), [t2, s$12] = d$2(e$2.computed(() => l2.modelValue), (e2) => c2("update:modelValue", e2), e$2.computed(() => l2.defaultChecked));
    function m() {
      s$12(!t2.value);
    }
    let E2 = e$2.ref(null), o2 = n2 === null ? E2 : n2.switchRef, L = s2(e$2.computed(() => ({ as: l2.as, type: i2.type })), o2);
    f2({ el: o2, $el: o2 });
    function D(e2) {
      e2.preventDefault(), m();
    }
    ...
    return e$2.onMounted(() => {
      ...
      return e$2.h(e$2.Fragment, [e2 != null && t2.value != null ? e$2.h(f$2, E$1({ features: u$2.Hidden, as: "input", type: "checkbox", hidden: true, readOnly: true, checked: t2.value, form: K2, disabled: b2.disabled, name: e2, value: a2 })) : null, A$1({ ourProps: B, theirProps: { ...i2, ...T$1(b2, ["modelValue", "defaultChecked"]) }, slot: T2, attrs: i2, slots: r2, name: "Switch" })]);
    };
  } }), de = K;
  ...
  const _hoisted_1$a = { class: "mx-auto w-full bg-white p-1.5" };
  ...
  function pausableFilter(extendFilter = bypassFilter, options = {}) {
    ...
    return { isActive: e$2.readonly(isActive), pause, resume, eventFilter };
  }
  function pxValue(px) {
  ...
  function toRef(...args) {
    ...
    const r2 = args[0];
    return typeof r2 === "function" ? e$2.readonly(e$2.customRef(() => ({ get: r2, set: noop }))) : e$2.ref(r2);
  }
  ...
  function useStorage(key, defaults2, storage, options = {}) {
    ...
    e$2.watch(keyComputed, () => update(), { flush });
  ...
  function useDraggable(target, options = {}) {
    ...
    const position = e$2.ref(
      (_a = e$2.toValue(initialValue)) != null ? _a : { x: 0, y: 0 }
    );
  ...
  const _hoisted_1$9 = { class: "text-xl font-black text-white" };
  const _hoisted_2$7 = { class: "no-scrollbar flex min-h-[calc(100%-2.5rem)] flex-1 flex-col p-2" };
  ...
  const _hoisted_2$6 = { class: "text-sm leading-6 text-orange-900" };
        ...
        return ((_a = __props.description) == null ? void 0 : _a.length) ? (e$2.openBlock(), e$2.createElementBlock("div", _hoisted_1$8, [
          e$2.createElementVNode("div", _hoisted_2$6, [
            (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(__props.description, (line, index) => {
              return e$2.openBlock(), e$2.createElementBlock("div", { key: index }, [
                e$2.createElementVNode("p", null, [
                  _cache[0] || (_cache[0] = e$2.createElementVNode("span", { class: "mr-1" }, "•", -1)),
  ...
  const _hoisted_1$7 = { class: "flex w-full py-1 hover:bg-blue-50 hover:bg-opacity-50" };
  const _hoisted_2$5 = { class: "ml-2 self-center text-black" };
  const _hoisted_3$3 = { class: "mx-2 mb-2 flex flex-1 flex-col p-1 text-black" };
              ...
              return [
                e$2.createElementVNode("div", _hoisted_3$3, [
                  ...
                  e$2.withDirectives(e$2.createElementVNode("textarea", {
                    ...
                    onKeydown: _cache[2] || (_cache[2] = e$2.withModifiers(() => {
                    }, ["stop"])),
  ...
  const _hoisted_1$6 = { class: "flex items-center justify-between py-1" };
  const _hoisted_2$4 = { class: "text-black" };
            ...
            e$2.createVNode(e$2.unref(Ie), {
              ...
              default: e$2.withCtx(() => [
                e$2.createElementVNode("div", _hoisted_3$2, [
                  e$2.createVNode(e$2.unref(je), { class: "relative w-full cursor-pointer rounded-lg bg-white px-3 py-1.5 text-left ring-1 ring-gray-300 focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-1 focus-visible:ring-gray-500 focus-visible:ring-white/75 sm:text-sm" }, {
                    default: e$2.withCtx(() => [
                  ...
                  e$2.createVNode(e$2.Transition, {
                    ...
                    default: e$2.withCtx(() => [
                      e$2.createVNode(e$2.unref(Ae), { class: "no-scrollbar absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm" }, {
                        default: e$2.withCtx(() => [
                          (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(e$2.unref(options), (option, index) => {
                            return e$2.openBlock(), e$2.createBlock(e$2.unref(Fe), {
                              ...
                              default: e$2.withCtx(({ active, selected }) => [
  ...
  const _hoisted_1$5 = { class: "my-1 flex items-center py-1 text-black" };
        ...
        return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
          e$2.createElementVNode("div", _hoisted_1$5, [
            ...
            e$2.withDirectives(e$2.createElementVNode("input", {
              ...
              onKeydown: _cache[1] || (_cache[1] = e$2.withModifiers(() => {
              }, ["stop"])),
  ...
  const _hoisted_1$4 = { class: "mb-0.5 mt-1 flex items-center py-1 text-black" };
  ...
  const _hoisted_2$2 = { class: "ml-2 flex-1" };
  const _sfc_main$7 = /* @__PURE__ */ e$2.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        var _a;
        return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
          e$2.createVNode(e$2.unref(oe), { class: "m-0.5 h-fit w-full rounded-lg py-1 hover:bg-blue-50 hover:bg-opacity-50" }, {
            default: e$2.withCtx(() => [
              e$2.createElementVNode("div", _hoisted_1$3, [
                e$2.createVNode(e$2.unref(de), { class: "flex flex-1 flex-row text-black" }, {
                  default: e$2.withCtx(() => [
  ...
  const r = String.raw, e = r`\p{Emoji}(?:\p{EMod}|[\u{E0020}-\u{E007E}]+\u{E007F}|\uFE0F?\u20E3?)`;
        ...
        return e$2.withDirectives((e$2.openBlock(), e$2.createBlock(_sfc_main$d, e$2.mergeProps({
          ...
          default: e$2.withCtx(() => [
            (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(e$2.unref(currPageGroups), (group, index) => {
              return e$2.openBlock(), e$2.createElementBlock("div", { key: index }, [
                e$2.createVNode(_sfc_main$e, e$2.mergeProps({ ref_for: true }, { title: group.name, isFold: group.fold }), {
                  default: e$2.withCtx(() => [
                    (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(group.items, (item, innerIndex) => {
                      return e$2.openBlock(), e$2.createElementBlock("div", { key: innerIndex }, [
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return show.value ? (e$2.openBlock(), e$2.createElementBlock("div", {
          ...
          style: e$2.normalizeStyle({ left: pos.left + "px", top: pos.top + "px" })
        }, [
          (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(menuList.value, (menu2, index) => {
            return e$2.openBlock(), e$2.createElementBlock("div", { key: index }, [
              e$2.createElementVNode("div", {
                ...
                _cache[0] || (_cache[0] = e$2.createElementVNode("span", { class: "mr-0.5" }, "◎", -1)),
...
https://${domain}/${avbv}` : `https://${domain}/${avbv}`;
  ...
  const _sfc_main$3 = /* @__PURE__ */ e$2.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return e$2.withDirectives((e$2.openBlock(), e$2.createBlock(_sfc_main$d, e$2.mergeProps({ title: "bilibili 页面净化大师", widthPercent: 28, heightPercent: 85, minWidth: 360, minHeight: 600 }, {
          onClose: e$2.unref(store).hide
        }), {
          default: e$2.withCtx(() => [
            (e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(currRules, (rule, i2) => {
              return e$2.createElementVNode("div", { key: i2 }, [
                (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(rule.groups, (group, j2) => {
                  return e$2.openBlock(), e$2.createElementBlock("div", { key: j2 }, [
                    e$2.createVNode(_sfc_main$e, e$2.mergeProps({ ref_for: true }, { title: group.name, isFold: group.fold, isSpecial: rule.isSpecial }), {
                      default: e$2.withCtx(() => [
                        (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(group.items, (item, innerIndex) => {
                          return e$2.openBlock(), e$2.createElementBlock("div", { key: innerIndex }, [
                            item.type === "switch" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$7, e$2.mergeProps({
  ...
  const _hoisted_3 = { class: "select-none text-center text-[13px] leading-4" };
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return e$2.unref(sideBtnStore).isShow ? (e$2.openBlock(), e$2.createElementBlock("div", {
          ...
          ref_key: "target",
          ref: target,
          style: e$2.normalizeStyle({ right: e$2.unref(btnPos).right + "px", bottom: e$2.unref(btnPos).bottom + "px" })
        }, [
