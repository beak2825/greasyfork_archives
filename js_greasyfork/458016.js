// ==UserScript==
// @name    Forum Curators |  for Black Russia Irkutsk👨‍💼
// @name:ru Forum Curators |  for Black Russia Irkutsk👨‍💼
// @name:uk Кураторы форуму | for Black Russia Irkutsk👨‍💼
// @description  Предложения по улучшению скрипта писать сюда ---> https://vk.com/citadeell
// @description:ru Предложения по улучшению скрипта писать сюда ---> https://vk.com/citadeell
// @description:uk Приятного использования ---> https://vk.com/citadeell
// @version 4.1.3
...
// @downloadURL https://update.greasyfork.org/scripts/458016/Forum%20Curators%20%7C%20%20for%20Black%20Russia%20Irkutsk%F0%9F%91%A8%E2%80%8D%F0%9F%92%BC.user.js
// @updateURL https://update.greasyfork.org/scripts/458016/Forum%20Curators%20%7C%20%20for%20Black%20Russia%20Irkutsk%F0%9F%91%A8%E2%80%8D%F0%9F%92%BC.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
     {
      ...
      content: '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         ...
         "[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 255)][B][SIZE=1]Irkutsk[/SIZE][/B][/COLOR]",
   ...
   title: 'Жалоба на рассмотрении (ВАЖНО)',
    ...
    },
    {
      ...
      content:
        ...
        '[Color=Lime][CENTER]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]' +
          "[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 25е)][B][SIZE=1]Irkutsk [/SIZE][/B][/COLOR]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=Lime][CENTER]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]' +
          "[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 25)][B][SIZE=1]Irkutsk [/SIZE][/B][/COLOR]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        ...
        '[Color=Lime][CENTER]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]' +
         "[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 25, 255)][B][SIZE=1]Irkutsk [/SIZE][/B][/COLOR]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
