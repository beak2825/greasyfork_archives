// ==UserScript==
// @name         丝丝吧写真视频免费观看
// @name:zh-TW   丝丝吧写真视频免费观看
// @namespace    http://tampermonkey.net/
// @version      0.2.0
// @description  观看丝丝吧写真视频免费
// @description:zh-TW  观看丝丝吧写真视频免费
// @author       FFFFFFeng
// @match        *://*.si88.cc/*
// @icon         https://www.google.com/s2/favicons?domain=swag555.xyz
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/494571/%E4%B8%9D%E4%B8%9D%E5%90%A7%E5%86%99%E7%9C%9F%E8%A7%86%E9%A2%91%E5%85%8D%E8%B4%B9%E8%A7%82%E7%9C%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/494571/%E4%B8%9D%E4%B8%9D%E5%90%A7%E5%86%99%E7%9C%9F%E8%A7%86%E9%A2%91%E5%85%8D%E8%B4%B9%E8%A7%82%E7%9C%8B.meta.js
// ==/UserScript==
(function () {
    let kitty_emojiList = ["😃","😄","😁","😆","😅","🤣","😂","🙂","🙃","🫠","😉","😊","😇","😕","🫤","😟","🙁","☹","😯","😲","🥺","🥹","😦","😧","😨","😰","😥","😢","😭","😱","😖","😣","😞","😓","😩","😫","😤","😡","😠"]
    ...
    function kitty_insertStyle() {
        ...
        style.innerHTML = `
            ...
            #kitty_vipPanel {
                ...
                z-index: 99999;
                font-size: 16px;
                --script-panel-main-color: #DD2476;
            }
            #kitty_vipPanel a {
            ...
            <div class="kitty_panelMain">
                ...
                <div class="kitty_panelBody kitty_panelBody_0">
                    <div class="kitty_searchInput">
                        <input id="kitty_txm" type="text" disabled placeholder="本脚本完全免费">
                    </div>
                ...
                <div class="kitty_panelBody kitty_panelBody_3" style="display:none;">
                    <p>+ 商店线路1: <a target="_blank" href="https://shop.kittymao.xyz">shop.kittymao.xyz</a></p>
                </div>
            </div>
        `
    ...
    function kitty_getCardNumber() {
        ...
        if (kitty_txm) {
            ...
            if (kitty_isSuccess()) {
                kitty_logListPush("请求成功, 请尝试观看", "success")
            } else {
                kitty_logListPush("已准备就绪,请点击GO按钮", "info")
            }
            
            kitty_logListPush("更多脚本请访问官网", "warning")
            kitty_logListPush("www.kittymao.xyz", "warning")
        } else {
            if (kitty_isSuccess()) {
                kitty_logListPush("请求成功, 请尝试观看", "success")
            } else {
                kitty_logListPush(`已准备就绪,请点击GO按钮${kitty_emojiList[kitty_emojiIndex]}`, "info")
            }
            kitty_logListPush("更多脚本请访问官网", "warning")
            kitty_logListPush("www.kittymao.xyz", "warning")
            kitty_emojiIndex++
    ...
    function kitty_getPermission(index, txm, change) {
        ...
        let url = `${host}/ssb/getPermission`
        fetch(url,{
            method: "POST",
            headers: {
            ...
            try {
                if (res.success) {
                    ...
                    kitty_logListPush(res.message, "danger")
                }
            } catch(e) {
    ...
    function dealGetPermissionRes(resData) {
        ...
        cookieArr.forEach((item) => {
            ...
            kitty_setCookie(tempArr[0], tempArr[1])
        })
    ...
    function kitty_isSuccess() {
        return kitty_getCookie("xszfvmlusername")
    }
    ...
    function kitty_isRun() {
        let site = false
        let run = false
        if(document.title.includes('丝丝吧')) {
            site = true
        }
