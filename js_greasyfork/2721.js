...
// @grant          GM.log
// @downloadURL https://update.greasyfork.org/scripts/2721/nicovideo%20Thumbinfo%20popup.user.js
// @updateURL https://update.greasyfork.org/scripts/2721/nicovideo%20Thumbinfo%20popup.meta.js
// ==/UserScript==
...
const CATEGORY_TAG_REGEXP =
  /^(?:エンターテイメント|音楽|歌ってみた|演奏してみた|踊ってみた|VOCALOID|ニコニコインディーズ|動物|料理|自然|旅行|スポーツ|ニコニコ動画講座|車載動画|歴史|科学|ニコニコ技術部|ニコニコ手芸部|作ってみた|政治|アニメ|ゲーム|東方|アイドルマスター|ラジオ|描いてみた|例のアレ|その他|日記|R-18)$/;
// 各国のサーバ名正規表現
