...
// @downloadURL https://update.greasyfork.org/scripts/444132/%5B%E5%AE%9E%E9%AA%8C%5D%20%E8%A7%86%E9%A2%91%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B%EF%BC%88TikTok%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/444132/%5B%E5%AE%9E%E9%AA%8C%5D%20%E8%A7%86%E9%A2%91%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B%EF%BC%88TikTok%EF%BC%89.meta.js
// ==/UserScript==

// 定义基础变量
const mApiBase = 'http://10.10.0.10:3002/2204/downloader/leaf'
const mBtn1Id = '_dcf_downloader_tiktok_task_btn'
const mBtn2Id = '_dcf_downloader_tiktok_tmpl_btn'
const mDialogId = '_dcf_downloader_tiktok_dialog'
const mStorageCateKey = '_dcf_downloader_tiktok_cate'
const mMaxDuration = 600
const mCateOptions = ['自定义分类']
...
function getItem() {
    if (document.getElementById('SIGI_STATE')) {
        const html = document.getElementById('SIGI_STATE').innerHTML
        const data = JSON.parse(html)
        if (data.ItemModule) {
            Object.values(data.ItemModule).map(item => mItems.set(item.id, item))
        }
    }
