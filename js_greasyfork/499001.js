// ==UserScript==
// @name                    Play web-With-MPV
// @name:en-US              Play web-with MPV
// @name:zh                 使用 MPV 播放网页端视频
// @namespace               https://github.com/hkiceflow
// @version                 1.0.1
// @author                  hkiceflow
// @copyright               Grant hkiceflow (https://github.com/hkiceflow)
// @license                 MIT
// @description             使用 mpv 播放网页端的视频，同时支持potolayer
// @homepage                https://github.com/hkiceflow/mpv_video
// @icon                    https://github.com/hkiceflow/tuchuang_mpv/blob/master/img/mpv.png
...
// @grant                   GM_getValue
// @run-at                  document-end
// @downloadURL https://update.greasyfork.org/scripts/499001/Play%20web-With-MPV.user.js
// @updateURL https://update.greasyfork.org/scripts/499001/Play%20web-With-MPV.meta.js
// ==/UserScript==
...
▶️                     Play-With-MPV                     ◀️
▶️                                                       ◀️
▶️       https://github.com/hkiceflow/Play-With-MPV      ◀️
▶️                                                       ◀️
▶️                     © hkiceflow                       ◀️
▶️                                                       ◀️
▶️🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼🔼◀️
...
<div id="${ID.infoDiv}">
    ...
    <table id="${ID.infoTable}">
        ...
        <tr>
            ...
            <td style="text-align: right;">
                <a href="https://github.com/hkiceflow/mpv_video" target="_blank">🌟 项目源码 🌟</a>
            </td>
            <td style="text-align: right;">
                <a href="https://github.com/hkiceflow/mpv_video/issues/new" target="_blank">👻 反馈 👻</a>
            </td>
        </tr>
    </table>
    <span class="${CLASS.footerSpan}">
        ...
        <a href="https://github.com/hkiceflow/mpv_video" target="_blank" class="${CLASS.footerA}" data-tip="项目源码"> © hkiceflow </a>
        <a href="https://github.com/hkiceflow/mpv_video/issues/new" target="_blank" class="${CLASS.footerA}" data-tip="问题反馈"> 👻 </a>
    </span>
</div>
        ...
        <tr>
            ...
            <td colspan="8">
                <div class="tabs">
                    ...
                    <label class="tab">
                        <input type="radio" name="${ID.subtitlePreferRadio}" value="ja-JP" class="tab-input"=>
                        <div class="tab-box" name="${ID.subtitlePreferRadio}">日语</div>
                    </label>
                    <label class="tab">
                        <input type="radio" name="${ID.subtitlePreferRadio}" value="fr-FR" class="tab-input"=>
                        <div class="tab-box" name="${ID.subtitlePreferRadio}">法语</div>
                    </label>
                    <label class="tab">
