...
// @run-at        document-end
// @downloadURL https://update.greasyfork.org/scripts/426325/Auto%20CF.user.js
// @updateURL https://update.greasyfork.org/scripts/426325/Auto%20CF.meta.js
// ==/UserScript==
...
//Non-TE
var normalBase = 2904; //aerb = 3080, pb = 2904, aeib = 2120, eeb = 3149
var normalCharm = 1649; //funnel C/S/G = 1648/1652/1649, rupc = 1651
...
(function() {
    const interval = setInterval(function() {
        if (user.environment_name != "Valour Rift" && user.quests.QuestsRiftValour.is_eclipse_mode != "null") {
            return;
        }
        else {
...
function autoCF(){
    ...
    var floorOneth = document.getElementsByClassName("valourRiftHUD-number")[2].className.match(/[0-9]/g);
