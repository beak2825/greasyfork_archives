...
// @include        *://www.dduxs.com/read/*/*.html
...
// @include        *://www.9txs.org/book/*/*.html
// @include        *://www.35xs.co/book/*/*.html
// @include        *://23us.co/html/*/*/*.html
...
// @run-at         document-end
// @downloadURL https://update.greasyfork.org/scripts/376575/My%20Novel%20Reader.user.js
// @updateURL https://update.greasyfork.org/scripts/376575/My%20Novel%20Reader.meta.js
// ==/UserScript==
...
(function (Vue) {
  ...
  const sites = [
    ...
    {siteName: "顶点小说",
        url: "^https?://www\\.(?:23us|x23us|23wx|xs222)\\.(?:com|cc|co)/html/\\d+/\\d+/\\d+\\.html$",
    ...
    {siteName: '九桃小说网',
      url: '^https?://www\\.9txs\\.org/book/\\d+/\\d+\\.html',
      bookTitleSelector: '#bookname',
      contentReplace: [
          '您可以在百度里搜索“.*? 九桃小说\\(9txs.org\\)”查找最新章节！',
      ]
    },
    {siteName: '闪舞小说网',
