...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/523035/%E3%80%90%E8%B5%9E%E5%8A%A9%E7%89%88%E3%80%91%F0%9F%94%A5%E6%8B%93%E5%B1%95%E5%A2%9E%E5%BC%BA%F0%9F%94%A5%E5%A6%96%E7%81%AB%E7%BD%91%E6%8F%92%E4%BB%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/523035/%E3%80%90%E8%B5%9E%E5%8A%A9%E7%89%88%E3%80%91%F0%9F%94%A5%E6%8B%93%E5%B1%95%E5%A2%9E%E5%BC%BA%F0%9F%94%A5%E5%A6%96%E7%81%AB%E7%BD%91%E6%8F%92%E4%BB%B6.meta.js
// ==/UserScript==
...
void (async function () {
  ...
  */
  ...
  function handleFilterText() {
    ...
    function handleFilter(nodeList) {
      for (let i = 0; i < nodeList.length; i++) {
        ...
        if (!id && item.querySelector(".renick a")) {
          let url = item.querySelector(".renick a").href;
          id = getUrlParameters(url).touserid;
        }
  ...
  async function getUserId(url = "/myfile.aspx", force = false) {
    ...
    let id = res.match(/我的ID(<.*?>)?:?\s*(\d+)/)?.[2] || extractId(res);
    if (force) {
  ...
  async function initSetting() {
    ...
    if (YaoHuoUtils.checkedRestoreData && YaoHuoUtils.checkedRestoreData()) {
  ...
  function handleWindowResize() {
    if (!getSession("yaohuoLoginInfo", {}).timestamp) {
      throw new Error(`异常`);
    }
    // 窗口改变重新计算悬浮按钮的位置
    ...
    let innerH = `
      <div class="yaohuo-modal-mask">
        <div class="yaohuo-wrap">
          <header>🔥拓展增强🔥插件设置<a href="https://update.greasyfork.org/scripts/523035/%E3%80%90%E8%B5%9E%E5%8A%A9%E7%89%88%E3%80%91%F0%9F%94%A5%E6%8B%93%E5%B1%95%E5%A2%9E%E5%BC%BA%F0%9F%94%A5%E5%A6%96%E7%81%AB%E7%BD%91%E6%8F%92%E4%BB%B6.user.js" target="_blank">【检测更新】</a></header>
          <ul>
  ...
  function handleBbsListFloatOpen(isShowVisited = false) {
    ...
    if (
     ...
     `);
      ...
      if (Object.keys(visitedLinks).length) {
        document
  ...
  function handleWindowScroll() {
    window.addEventListener(
      "scroll",
      throttle(() => {
        if (!getSession("yaohuoLoginInfo", {}).token) {
          throw new Error(`错误`);
        }
