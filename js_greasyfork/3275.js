// ==UserScript==
// @name           cz_adv_browse
// @namespace      https://greasyfork.org/users/3453-bondoz
// @version        0.5.9
// @description    Allow user to bookmark, comment, or download torrent in browse page. Integrated with google app engine
// @include        *madoomee*/browse.php*
// @grant          GM_xmlhttpRequest
// @grant          GM_getValue
// @grant          GM_setValue

// @downloadURL https://update.greasyfork.org/scripts/3275/cz_adv_browse.user.js
// @updateURL https://update.greasyfork.org/scripts/3275/cz_adv_browse.meta.js
// ==/UserScript==
