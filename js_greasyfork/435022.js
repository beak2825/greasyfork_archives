// ==UserScript==
// @license MIT
// @name         copy-method-swagger-to-service-js
// @namespace
// @version      1.1
// @description  搭配swagger-to-service-js用于复制函数名
// @author       leesher
...
// @namespace lee
// @downloadURL https://update.greasyfork.org/scripts/435022/copy-method-swagger-to-service-js.user.js
// @updateURL https://update.greasyfork.org/scripts/435022/copy-method-swagger-to-service-js.meta.js
// ==/UserScript==
  ...
  return input;
    ...
    function createFunc(methoud, path, description) {
     ...
     const firstUrlItem =pathSplitArr.pop()
        const methoudName =   toPascalCase( path.replace(".json", ""));

           return _.toLower(methoud)+methoudName
    }
