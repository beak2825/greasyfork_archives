// ==UserScript==
// @name           IlPost.it: Hide Annoying popups (the anti-adblock popup and others)
// @name:it        IlPost.it: Nasconde i popup fastidiosi (il popup anti-adblock ed altri)
...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/534093/IlPostit%3A%20Hide%20Annoying%20popups%20%28the%20anti-adblock%20popup%20and%20others%29.user.js
// @updateURL https://update.greasyfork.org/scripts/534093/IlPostit%3A%20Hide%20Annoying%20popups%20%28the%20anti-adblock%20popup%20and%20others%29.meta.js
// ==/UserScript==

//
// >>>FILENAME=IlPost_it_HideAnnoyingPopups.js<<<
//
...
(function()
{
    ...
    blib.consoleLog(`CY==> IlPost_it_HideAnnoyingPopups: Using library 'BasicLib' (version: ${blib.getVersion()})`);

    const haplib = window.HideAnnoyingPopupsLib;
    blib.consoleLog(`CY==> IlPost_it_HideAnnoyingPopups: Using library 'HideAnnoyingPopupsLib' (version: ${haplib.getVersion()})`);

    //// When enabled, additional log will be shown.
    //haplib.setShowDebugLog(true);

    const myVersion = GM_info.script.version;
    blib.consoleLog(`CY==> IlPost_it_HideAnnoyingPopups: HELLO! Loading script (version: ${myVersion})...`);

    const currUrl = window.location.href;
    blib.consoleLog(`CY==> IlPost_it_HideAnnoyingPopups: currUrl='${currUrl}'`);
    ...
    blib.consoleLog("CY==> IlPost_it_HideAnnoyingPopups: Script loaded");
})();
