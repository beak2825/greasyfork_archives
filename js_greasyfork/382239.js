...
// @namespace https://greasyfork.org/users/295484
// @downloadURL https://update.greasyfork.org/scripts/382239/Anti-410.user.js
// @updateURL https://update.greasyfork.org/scripts/382239/Anti-410.meta.js
// ==/UserScript==
...
(function() {
    ...
    btn_crypt.value = "Chiffrer le message";
...
function crypt(){
    ...
    if(true){
        ...
        var Rep1 = ['Ah', 'Ok', 'Ah ouais quand même', 'ok mon khey', 'de quoi ?', 'ouais', 'non', 'oui vraiment', 'Je sais pas perso', 'Exactement', 'Je vois', 'Oui je comprends', 'Parfaitement', 'ouais t\'as vu', 'vraiment incroyable'];
        var Rep2 = ['https://image.noelshack.com/fichiers/2017/12/1490458236-issou-chauve.png',
                    'http://image.noelshack.com/fichiers/2016/50/1481840292-1480607246-1477607369-1469449722-image.png',
                    'http://image.noelshack.com/fichiers/2017/03/1484789429-02345.jpg',
                    ...
                    'https://image.noelshack.com/fichiers/2018/10/7/1520802292-7.png',
                    'https://image.noelshack.com/fichiers/2017/02/1484351911-0424242.jpg',
                    'https://image.noelshack.com/fichiers/2017/20/1495021226-1485484836-larry.png',
                    'https://image.noelshack.com/fichiers/2017/37/5/1505457442-issou-vieux-dechet.png'];
        var Rep3 = ['.', 'AYAAA', '?', '!', ' '];
        var RepF = " :hap: ";
