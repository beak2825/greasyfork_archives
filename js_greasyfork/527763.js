// ==UserScript==
// @name   KF_script_by_Secret
// @name:ru Script by Кураторы форума
...
// @grant        none
// @license   none
// @supportURL vk.com/sany421 | Thomas_Secret | CHITA
// @description Скрипт для кураторов сервера CHITA
// @downloadURL https://update.greasyfork.org/scripts/527763/KF_script_by_Secret.user.js
// @updateURL https://update.greasyfork.org/scripts/527763/KF_script_by_Secret.meta.js
// ==/UserScript==
    ...
    },
{
 ...
 $(document).ready(() => {
    ...
    addButton('🌟 Script by. Secret 🌟', 'selectAnswer');
