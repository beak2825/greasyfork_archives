// ==UserScript==
// @name   🌱【免费版】好医生|合肥市卫生人力资源服务平台|如需自动下一集、自动换课程、秒过、考试答题等高级功能见收费版本：https://doc.zhanyc.cn/pages/hys2/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、秒过、考试答题、全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.haoyisheng.com/*
// @include    *://*.cmechina.net/*
// @include    *://*haoyisheng.com*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/533143/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%A5%BD%E5%8C%BB%E7%94%9F%7C%E5%90%88%E8%82%A5%E5%B8%82%E5%8D%AB%E7%94%9F%E4%BA%BA%E5%8A%9B%E8%B5%84%E6%BA%90%E6%9C%8D%E5%8A%A1%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E7%A7%92%E8%BF%87%E3%80%81%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpageshys2.user.js
// @updateURL https://update.greasyfork.org/scripts/533143/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%A5%BD%E5%8C%BB%E7%94%9F%7C%E5%90%88%E8%82%A5%E5%B8%82%E5%8D%AB%E7%94%9F%E4%BA%BA%E5%8A%9B%E8%B5%84%E6%BA%90%E6%9C%8D%E5%8A%A1%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E7%A7%92%E8%BF%87%E3%80%81%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpageshys2.meta.js
// ==/UserScript==
(function () {
    let $jq = $;
    unsafeWindow.$jq = $;
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、秒过、考试答题等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/hys2/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/courseExam".toLocaleLowerCase())) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
            } else if (url.includes("/courseIndex?".toLocaleLowerCase())) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/courseDetials".toLocaleLowerCase())) {
                plugMain.page_video();
            } else if (url.includes("/cme/myFavorite.jsp".toLocaleLowerCase())) {
                plugMain.showPaidContent(`免费版本不包含自动答题、自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/cme/study2.jsp".toLocaleLowerCase())) {
                zfk.page_video();
            } else if (url.includes("/cme/course.jsp?".toLocaleLowerCase())) {
                plugMain.showPaidContent(`免费版本不包含自动答题、自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/cme/exam.jsp".toLocaleLowerCase())) {
        ...
        async page_video() {
            ...
            await plugMain.waitOf(a => $(".list-right a.el-button").length > 0)
            await plugMain.waitTimeout(500)

            if (plugMain.getElByText($(".list-right a.el-button"), "考试") != null) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
                return
            }
            plugMain.getElByText($(".list-right a.el-button"), "立即学习")[0].click()
            let timeout = 2;
            let lastTime = null;
