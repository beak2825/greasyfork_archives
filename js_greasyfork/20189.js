...
// @name        Starting To Bloom TM - V1.1.4
...
// @grant        all
// @downloadURL https://update.greasyfork.org/scripts/20189/Starting%20To%20Bloom%20TM%20-%20V114.user.js
// @updateURL https://update.greasyfork.org/scripts/20189/Starting%20To%20Bloom%20TM%20-%20V114.meta.js
// ==/UserScript==
                ...
                { var player_index = transfer_info_ar[i]["id"] ;
                 ...
                 function Last_Season_Avg_Ti(TI,Season_TI,session,months,playerID,wage) {
                    ...
                    { var This_Season = months + 1;
                      ...
                      if ((playerID > 113932342) || (wage < 30001))
                          return 0;
                      else{
