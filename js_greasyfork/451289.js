// ==UserScript==
// @name         新新新·自用三相之力（个人自用版）
// @namespace    www.bilibili.com
// @version      1.11111
// @description  B站评论区自动标注三相玩家，虚拟主播的粉丝，依据是动态里是否有相关内容（基于原神指示器和原三相，新三相一些小的修改）。前一个显示虚拟主播粉丝（ASOUL粉丝名颜色已改为应援色，其余主播由于我没查到就用发色大概代替一下），后一个显示游戏玩家。新加了几个主播给群友用
...
// @license MIT
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/451289/%E6%96%B0%E6%96%B0%E6%96%B0%C2%B7%E8%87%AA%E7%94%A8%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B%EF%BC%88%E4%B8%AA%E4%BA%BA%E8%87%AA%E7%94%A8%E7%89%88%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/451289/%E6%96%B0%E6%96%B0%E6%96%B0%C2%B7%E8%87%AA%E7%94%A8%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B%EF%BC%88%E4%B8%AA%E4%BA%BA%E8%87%AA%E7%94%A8%E7%89%88%EF%BC%89.meta.js
// ==/UserScript==
...
(function () {
    ...
    const tag_gzy_Inner = "<b style='color: #00CCFF'>" + tag_gzy + "</b>"
                        ...
                        if (res.status === 200) {
                            ...
                            if (bshow && (st.includes(keyword_jxt) || st.includes(keyword_ccj) || st.includes(keyword_gcb)||st.includes(keyword_jn)||st.includes(keyword_mml)||st.includes(keyword_sc)||st.includes(keyword_dwr)||st.includes(keyword_bjx)||st.includes(keyword_nql)||st.includes(keyword_xxx)||st.includes(keyword_xhz))) {
                                ...
                                if (st.includes(keyword_xhz)) {
                                 ...
                                 //添加yuunnn标签
                                if (st.includes(keyword_gzy)) {
                                    c.innerHTML += tag_gzy_Inner
                                    gzy.add(pid)
                                } else {
                                    no_gzy.add(pid)
                                }
