...
// @author       dashuo
// @match        https://opensea.io/collection/adam-bomb-squad
// @match        https://opensea.io/assets/adam-bomb-squad?*
// @match        https://opensea.io/collection/adam-bomb-squad?*
// @match        https://opensea.io/account
// @match        https://opensea.io/assets*
// @icon         https://www.google.com/s2/favicons?domain=opensea.io
// @grant        GM_getResourceText
// @resource DATALootRare https://raw.githubusercontent.com/a-dwarf/loot/main/adam-bomb-squad.json
...
// @downloadURL https://update.greasyfork.org/scripts/434927/adam-bomb-squad.user.js
// @updateURL https://update.greasyfork.org/scripts/434927/adam-bomb-squad.meta.js
// ==/UserScript==
...
function onwheelevent(event) {
    ...
    for (var i = 0; i < elements.length; i++) {
     ...
     //   var lootid = parseLootId(bagLabel);
        var loot = findRareByLootId(bagLabel);
