// ==UserScript==
// @name   🌱【免费版】出头科技|湖南农业大学自动看课|江西科技师范|如需极速秒过、自动下一集、自动换课程、考试答题等高级功能见收费版本：https://doc.zhanyc.cn/pages/c8e852/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.2
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需极速秒过、自动下一集、自动换课程、、考试答题等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.superchutou.com/*
// @include    *://*.officeapps.live.com/*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/514607/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%87%BA%E5%A4%B4%E7%A7%91%E6%8A%80%7C%E6%B9%96%E5%8D%97%E5%86%9C%E4%B8%9A%E5%A4%A7%E5%AD%A6%E8%87%AA%E5%8A%A8%E7%9C%8B%E8%AF%BE%7C%E6%B1%9F%E8%A5%BF%E7%A7%91%E6%8A%80%E5%B8%88%E8%8C%83%7C%E5%A6%82%E9%9C%80%E6%9E%81%E9%80%9F%E7%A7%92%E8%BF%87%E3%80%81%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesc8e852.user.js
// @updateURL https://update.greasyfork.org/scripts/514607/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%87%BA%E5%A4%B4%E7%A7%91%E6%8A%80%7C%E6%B9%96%E5%8D%97%E5%86%9C%E4%B8%9A%E5%A4%A7%E5%AD%A6%E8%87%AA%E5%8A%A8%E7%9C%8B%E8%AF%BE%7C%E6%B1%9F%E8%A5%BF%E7%A7%91%E6%8A%80%E5%B8%88%E8%8C%83%7C%E5%A6%82%E9%9C%80%E6%9E%81%E9%80%9F%E7%A7%92%E8%BF%87%E3%80%81%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesc8e852.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需极速秒过、自动下一集、自动换课程、考试答题等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/c8e852/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(lastUrl) {
            if (lastUrl.includes("/educational/studyplan")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (lastUrl.includes("/onlineclass/curriculum/")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (lastUrl.includes("#/video/")) {
                plugMain.page_video();
            } else if (lastUrl.includes("onlineclass/exam/")) {
        ...
        async page_video() {
            ...
            let timeout = 2;
            let checkTime = 0;
            let lastCheckStep = null;
            await plugMain.waitOf(
                (a) =>
                    $('[class^="player_catalog_view"] a[href^="#/video/"]').length > 0
            );
            let $el = null;
            let hasUnfinish = false;
            $('[class^="player_catalog_view"] a[href^="#/video/"]').each((i, el) => {
                if ($(el).find(".anticon-check-circle").length == 0) {
                    hasUnfinish = true;
                    if (!$(el).is('[class^="catalog_playing"]')) {
                        $el = $(el);
                        $(el)[0].click();
                    }
                    return false;
            ...
            if (!hasUnfinish) {
                ...
                let layIndex = layer.alert(
                    "已经为您打开新的窗口，如果没有发现新的窗口被打开，请检查浏览器地址栏右侧是否有一个拦截窗口提示，请选择【始终允许】并点击确定按钮后，刷新当前页面"
                );
                GM_addValueChangeListener(
                    "ljMark",
                    function (name, old_value, new_value, remote) {
                        plugMain.confirmRun("3秒后关闭当前页面").then((a) => {
                            window.close();
                        });
                    }
                );
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (checkTime <= 0) {
                        checkTime = 600;
                        if (lastCheckStep == null) {
                            lastCheckStep = plugMain.getCurTime();
                            return;
                        }
                        if (lastCheckStep == plugMain.getCurTime()) {
                            lastCheckStep = null;
                            location.reload();
                            return;
                        } else {
