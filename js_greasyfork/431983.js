...
// @downloadURL https://update.greasyfork.org/scripts/431983/NTKO%E5%8A%9E%E5%85%ACOA%E5%85%8D%E8%B6%85%E6%97%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/431983/NTKO%E5%8A%9E%E5%85%ACOA%E5%85%8D%E8%B6%85%E6%97%B6.meta.js
// ==/UserScript==
const REFRESH_URL = 'http://192.168.1.65/SubModule/LeftTree.aspx?DelegataFlag=';//保持网页存活的网址

var styleElement = document.createElement('style');
document.getElementsByTagName('head')[0].appendChild(styleElement);
styleElement.append('.timeViewDIV {height: 5px; position: absolute; top: 0px; left: 0px; z-index: 99;border-radius:3px;}');

var refreshTime=60*6;//刷新时间60*6
var firstFlag=true;//首次进页面标识
var refreshBeat=null;//刷新器
var tipBeat=null;//登陆人员刷新器
var fallcount=0
...
var timeViewDIV = document.createElement('DIV');
...
if (undefined != admin &&admin.innerHTML.search('绍相')<0){
    var adminTip = document.createElement("input");
...
//标题菜单替换
var htxt=document.getElementById('lblurl_pnl').firstChild.nextSibling;
var oldOA=document.getElementById('pnl_qt').childNodes[5];
