...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/533382/Survivio%20input%20replay%20recorder.user.js
// @updateURL https://update.greasyfork.org/scripts/533382/Survivio%20input%20replay%20recorder.meta.js
// ==/UserScript==
(function() {
    document.querySelector('#background').style.cssText = 'background-image: url(https://i.imgur.com/edob0SF.png)'
})();
/*** contributors
 * garlic
 * samer kizi
		...
		document.addEventListener(type, (e) => {
			if (keys.indexOf(e.key) !== -1) {
				if (e.type == "keydown") {
					...
					if (e.key == "o") window.slowmo = 1;
					if (e.key == "0") window.slowmo = 2;
					if (e.key == "6") window.slowmo = 2.5;
					if (e.key == "p") window.slowmo = 16;
...
// CSS
GM_addStyle(`
.ad-block-med-rect, .surviv-shirts {
