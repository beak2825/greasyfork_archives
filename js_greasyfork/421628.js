// ==UserScript==
// @name           OGame Fun: Utilidades B.O.R.BELLATRIX
// @namespace      https://greasyfork.org/es/users/385465-nagasis
// @version        1.8.1
// @description    Busca en la base de datos de la galaxia jugadores
// @author         NaGaSiS
// @match          https://bellatrix.ogame.fun/game.php?page=galaxy*
// @include        https://bellatrix.ogame.fun/game.php?page=*
// @grant GM_xmlhttpRequest
// @grant GM_log
// @grant unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/421628/OGame%20Fun%3A%20Utilidades%20BORBELLATRIX.user.js
// @updateURL https://update.greasyfork.org/scripts/421628/OGame%20Fun%3A%20Utilidades%20BORBELLATRIX.meta.js
// ==/UserScript==
    ...
    // ==============================================================================================
     ...
     function MenuLib() {
         ...
         this.menuButton_click = function() {
            ...
            //    alert("CLICK");
             //document.location ="https://bellatrix.ogame.fun/game.php?page=galaxy";
