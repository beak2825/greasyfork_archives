...
// @grant        all
// @downloadURL https://update.greasyfork.org/scripts/20045/Rec%20Transfer%20List%20V10.user.js
// @updateURL https://update.greasyfork.org/scripts/20045/Rec%20Transfer%20List%20V10.meta.js
// ==/UserScript==
...
//			   For  Rez    Vit  Ind  One  Ref Aer  Sar  Com    Deg    Aru
               ...
               function Calc(positionIndex, skills, SI){
				...
				$("a[player_link=" + resultado.player.player_id + "]").closest("tr").append("<td class='right align_right FavPos1' style='padding-right:5px;'><span>" + Calc((arrary[id_index(resultado.player.player_id,arrary)][2]),getSkills(arrary[id_index(resultado.player.player_id,arrary)][2],resultado.player.skills),SI(resultado.player.skill_index))  + "</span></td>");
                if (arrary[id_index(resultado.player.player_id,arrary)][3] > 0){ 
                $("a[player_link=" + resultado.player.player_id + "]").closest("tr").append("<td class='right align_right FavPos2' style='padding-right:5px;'><span>" + Calc((arrary[id_index(resultado.player.player_id,arrary)][3]),getSkills(arrary[id_index(resultado.player.player_id,arrary)][2],resultado.player.skills),SI(resultado.player.skill_index)) + "</span></td>");
                }
                else{
                $("a[player_link=" + resultado.player.player_id + "]").closest("tr").append("<td class='right align_right FavPos2' style='padding-right:5px;'><span>" + "0.000" + "</span></td>");
