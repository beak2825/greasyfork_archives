// ==UserScript==
// @name         Обычный форум || Blue || Для Miny_Leted.
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/526078/%D0%9E%D0%B1%D1%8B%D1%87%D0%BD%D1%8B%D0%B9%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%20%7C%7C%20Blue%20%7C%7C%20%D0%94%D0%BB%D1%8F%20Miny_Leted.user.js
// @updateURL https://update.greasyfork.org/scripts/526078/%D0%9E%D0%B1%D1%8B%D1%87%D0%BD%D1%8B%D0%B9%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%20%7C%7C%20Blue%20%7C%7C%20%D0%94%D0%BB%D1%8F%20Miny_Leted.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
"[B][CENTER]С уважением Miny_Leted. <br><br>"+
...
title: '| Слив склада семьи (не по форме) |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/X7NHmW8Y/image.gif[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как она составлена не по форме. Предоставьте Фрапс следующим образом: прописали /time, открыли меню семьи и показали логи, выделив моменты нарушений игрока (просто нажав на строки).в описании семьи должны быть указаны условия взаимодействия со складом. Если лидер семьи предоставил неограниченный доступ к складу и забыл снять его, администрация не несёт ответственности за возможные последствия. Жалобы по данному пункту правил принимаются только от лидера семьи.<br><br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=blue]BLUE[/COLOR].<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/yNNSJpc8/2022-12-09-15-49-54.gif[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
