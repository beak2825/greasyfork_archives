...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/485977/DC%20QuickCheck%20Testov%C3%A1n%C3%AD.user.js
// @updateURL https://update.greasyfork.org/scripts/485977/DC%20QuickCheck%20Testov%C3%A1n%C3%AD.meta.js
// ==/UserScript==
          ...
          const loadAllBtn = document.createElement("button");
            ...
            function showLoadingText() {
                if (!loadingText) {
                    ...
                    loadingText.textContent = " (Načítá se...)";
                    loadAllBtn.appendChild(loadingText);
                    isLoading = true;
                }
            }
            ...
            loadAllBtn.addEventListener("click", async function() {
                ...
                try {
                    await Promise.all([clickButtonUntilNotExists(), waitForPageToSettle()]);
                } finally {
                    if (isLoading) {
                        hideLoadingText();
                    }
            ...
            deleteHSBtn.textContent = "HS OFF/ON";
            ...
            deleteHSBtn.addEventListener("click", function() {
                ...
                if (table) {
                    ...
                    deleteHSBtn.textContent = isDeleteMode ? "HS OFF/ON" : "HS OFF/ON";
                }
            });
...
scrollToBottomBtn.className = "custom-button";
scrollToBottomBtn.style.position = "fixed";
scrollToBottomBtn.style.left = "calc(15px + 100px)";
scrollToBottomBtn.style.bottom = "40px";
scrollToBottomBtn.style.padding = '10px 20px';
scrollToBottomBtn.style.backgroundImage = 'linear-gradient(to right, #0000ff, #d30000)';
scrollToBottomBtn.style.border = '2px solid transparent';
scrollToBottomBtn.style.borderRadius = '25px';
scrollToBottomBtn.style.color = 'white';
scrollToBottomBtn.style.fontSize = '16px';
scrollToBottomBtn.style.fontWeight = 'bold';
scrollToBottomBtn.style.textTransform = 'uppercase';
scrollToBottomBtn.style.fontSize = '18'
scrollToBottomBtn.style.cursor = 'pointer';
scrollToBottomBtn.style.boxShadow = '0 4px 6px rgba(0, 0, 0, 0.1)';
scrollToBottomBtn.style.transition = 'border 0.3s, transform 0.2s';
