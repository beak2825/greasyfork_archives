...
// @name         HIT Forker MODIFIED
// @version      1.2.4.3
// @description  Monitors mturk.com for HITs
// @author       ThisPoorGuy (modifications by Rathalos420)
...
// @downloadURL https://update.greasyfork.org/scripts/447973/HIT%20Forker%20MODIFIED.user.js
// @updateURL https://update.greasyfork.org/scripts/447973/HIT%20Forker%20MODIFIED.meta.js
// ==/UserScript==

// Modified by Rathalos420 to default requester links to $0.00 and uncheck "I'm qualified for"
// Modified Line 169 added "0.00"
// Modified Line 170 added "false"
// Modified Line 1058 added "+ searchqual + minrew"
...
minrew = '&filters%5Bmin_reward%5D=0.00';
searchqual = '&filters%5Bqualified=false';
...
function _scrape_new (data, timeis) {
    ...
    for (var i = 0; i < hits.length; i ++) {
        var hit = hits[i],
            ...
            req_link  = DOMPurify.sanitize(hit.requester_url.replace(/\.json/, '') + searchqual + minrew ,config),
