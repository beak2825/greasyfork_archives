...
// @downloadURL https://update.greasyfork.org/scripts/517341/%E7%A8%B3%E5%AE%9A.user.js
// @updateURL https://update.greasyfork.org/scripts/517341/%E7%A8%B3%E5%AE%9A.meta.js
// ==/UserScript==
            ...
            if (window === top) {
                ...
                if (!isMobile) {
                    if (location.host.indexOf("v.qq.com") !== -1) {
                        ...
                        readyPlayerBox("爱奇艺", ["#playerPopup", "#modal-vip-cashier-scope", "div[class^=qy-header-login-pop]", "div[element.style]", "div[class^=covers_cloudCover__Dd-AN ]", "div[class^=toast_toast__xEwzl]"], [],
                                       "#flashbox", null);
