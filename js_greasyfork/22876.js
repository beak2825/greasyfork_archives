...
// @downloadURL https://update.greasyfork.org/scripts/22876/AMCGAming%2013333.user.js
// @updateURL https://update.greasyfork.org/scripts/22876/AMCGAming%2013333.meta.js
// ==/UserScript==

       $(document).ready(function(){

var css = ".barre{width:99%;border:2px solid #F40101;text-align:center;padding-top:10px;padding-bottom:20px;margin-left:1%;margin-right:20%;background-color:#F40101}.lien{width:18%;display:inline-block}.barre a{text-decoration:none;color:#fff;padding-bottom:20px;padding-top:44px}"
