...
// @match        https://steamcommunity.com/market/listings/730/AK-47%20%7C%20Case%20Hardened*
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/383259/AK-47%20%7C%20Case%20Hardened.user.js
// @updateURL https://update.greasyfork.org/scripts/383259/AK-47%20%7C%20Case%20Hardened.meta.js
// ==/UserScript==
...
//
var sed=[28,32,65,122,139,147,189,256,321,341,413,512,519,525,541,555,592,605,610,627,661,695,754,903,950,955,969,996];
function c() {
...
if(seed==sed[j]){
    ...
    document.getElementsByClassName('market_listing_item_name')[i].innerHTML="RARE PATTERN (CS.MONEY GIVES MORE MONEY)";
}
            }
        }
