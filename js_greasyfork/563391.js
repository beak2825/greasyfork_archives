...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/563391/Chief%20Technical%20Specialists.user.js
// @updateURL https://update.greasyfork.org/scripts/563391/Chief%20Technical%20Specialists.meta.js
// ==/UserScript==
...
const Button17 = buttonConfig("Тех 46", 'https://forum.blackrussia.online/forums/Технический-раздел-chelyabinsk.2052/');
const Button16 = buttonConfig("ЖБТ 46", 'https://forum.blackrussia.online/forums/Сервер-№46-chelyabinsk.2051/');
const Button15 = buttonConfig("ЖБИ 46", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2080/');
const Button14 = buttonConfig("Тех 47", 'https://forum.blackrussia.online/forums/Технический-раздел-krasnoyarsk.2094/');
const Button13 = buttonConfig("ЖБТ 47", 'https://forum.blackrussia.online/forums/Сервер-№47-krasnoyarsk.2093/');
const Button12 = buttonConfig("ЖБИ 47", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2122/');
const Button11 = buttonConfig("Тех 48", 'https://forum.blackrussia.online/forums/Технический-раздел-cheboksary.2136/');
const Button10 = buttonConfig("ЖБТ 48", 'https://forum.blackrussia.online/forums/Сервер-№48-cheboksary.2135/');
const Button9 = buttonConfig("ЖБИ 48", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2164/');
const Button8 = buttonConfig("Тех 49", 'https://forum.blackrussia.online/forums/Технический-раздел-khabarovsk.2178/');
const Button7 = buttonConfig("ЖБТ 49", 'https://forum.blackrussia.online/forums/Сервер-№49-khabarovsk.2177/');
const Button1 = buttonConfig("ЖБИ 49", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2206/');
const Button3 = buttonConfig("Тех 50", 'https://forum.blackrussia.online/forums/Технический-раздел-perm.2220/');
const Button2 = buttonConfig("ЖБТ 50", 'https://forum.blackrussia.online/forums/Сервер-№50-perm.2219/');
const Button5 = buttonConfig("ЖБИ 50 ", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2248/');
const Button4 = buttonConfig("ОПС", 'https://forum.blackrussia.online/threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%BE%D0%B2.312571/');
const Button6 = buttonConfig("Форумник", 'https://forum.blackrussia.online/members/alexandr-milton.1059393/');
