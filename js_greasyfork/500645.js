// ==UserScript==
// @name       MURMANSK СКРИПТ ДЛЯ РУК-ВО
...
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/500645/MURMANSK%20%D0%A1%D0%9A%D0%A0%D0%98%D0%9F%D0%A2%20%D0%94%D0%9B%D0%AF%20%D0%A0%D0%A3%D0%9A-%D0%92%D0%9E.user.js
// @updateURL https://update.greasyfork.org/scripts/500645/MURMANSK%20%D0%A1%D0%9A%D0%A0%D0%98%D0%9F%D0%A2%20%D0%94%D0%9B%D0%AF%20%D0%A0%D0%A3%D0%9A-%D0%92%D0%9E.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            title: 'Приветствие',
            content:
            "[CENTER][FONT=Verdana][COLOR=RED]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/FONT][/COLOR]<br><br>"+
            ...
            "[CENTER][FONT=Verdana] Ответ [/FONT][/CENTER] <br>"+
    "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
      '[COLOR=RED][FONT=Verdana]Закрыто.[/COLOR][/FONT][/CENTER]',
  prefix: CLOSE_PREFIX,
            status: false,
        },
        {
            ...
            content:
            "[CENTER][FONT=Verdana][COLOR=RED]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/COLOR]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Отказано, закрыто.[/FONT][/CENTER][/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
            title: 'От 3 лица',
            content:
            "[CENTER][FONT=Verdana][COLOR=RED]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        },
        {
            ...
            content:
            "[CENTER][COLOR=RED][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/COLOR]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "С момента выдачи наказания прошло более 72 часов, жалоба не подлежит рассмотрению.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Отказано,закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Отказано, закрыто.[/FONT][/COLOR][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=#00FA9A]Одобрено, закрыто. [COLOR=RED][/FONT][/CENTER]',
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=red]Отказано, закрыто.[/FONT][COLOR=RED][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
   ...
   },
        {
            ...
            "[CENTER][FONT=Verdana][COLOR=RED]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/COLOR]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Проверив доказательства администратора.<br>"+
            "Было принято решение снять ваше наказание. Наказание будет снято в течении 12-и часов.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[CENTER][FONT=Verdana][COLOR=RED]Отказано, закрыто. [/COLOR][/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            "[CENTER][FONT=Verdana][COLOR=RED]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/COLOR]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Ваш аккаунт был разблокирован на 24 часа.<br>"+
            "Как только вы смените свой никнейм отпишите сюда.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        },
 {
            ...
            "[CENTER][FONT=Verdana][COLOR=RED]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/COLOR]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Обжалование НРП обмана должен писать игрок которого обманули.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Отказано, закрыто [/COLOR][/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=#00FA9A]Одобрено, закрыто.[/FONT][/CENTER]',
            prefix: ACCEPT_PREFIX,
            status: false,
        },
     {
            ...
            "[CENTER][FONT=Verdana][COLOR=RED]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/COLOR]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Обжалование отказано. часов.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            'Отказано, закрыто.[/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
 {
        ...
        },
         {
            ...
            "[CENTER][FONT=Verdana][COLOR=RED]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/COLOR]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Аккаунт игрока был разблокирован на 24ч.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Как только игрок вернет имущество отпишите в данную тему.[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: 123,
        },
        {
