// ==UserScript==
// @name        MouseHunt Autobot Optimised
// @author      Edited by Hackerboi987 (ooiks, devcnn)
// @version    	2.0
// @description A tool to assist hunters.
...
// @grant		unsafeWindow
// @grant		GM_info
// @namespace https://greasyfork.org/users/188409
// @downloadURL https://update.greasyfork.org/scripts/368756/MouseHunt%20Autobot%20Optimised.user.js
// @updateURL https://update.greasyfork.org/scripts/368756/MouseHunt%20Autobot%20Optimised.meta.js
// ==/UserScript==


// == Basic User Preference Settings (Begin) ==
// // The variables in this section contains basic options
// // Reload MouseHunt page manually if editing

// // Delay in sounding the horn (in seconds)
// // Default: 5 - 180
var hornTimeDelayMin = 10;
var hornTimeDelayMax = 25;

// // Bot aggressively by ignoring all safety measures such as checking horn image visiblity before sounding it (true/false)
...
// // Note: Every player has a different trap check timing, set your trap check time here. It will only take effect if enableTrapCheck = true
...
// // Play a notification to notify about KR (true/false)
...
// // The script will pause if the player is at a different location than the location previously indicaed. (true/false)
// // Note: Make sure you set showTimerInPage to true in order to know what is happening.
var pauseAtInvalidLocation = false;

// // Delay after trap selection clicked (in second)
var secWait = 7;

// // Stop arming traps after X number of tries
var armTrapRetry = 3;

// // Maximum number of logs to be saved into sessionStorage
var maxSaveLog = 750;
...
// // The variables in this section contains advance options.
// // Reload MouseHunt page manually after editing.
...
var objBestTrap = {
	weapon : {
		...
		rift : ['Timesplit Dissonance Weapon','Mysteriously unYielding','Multi-Crystal Laser','Focused Crystal Laser','Biomolecular Re-atomizer Trap','Crystal Tower'],
		shadow : ['Chrome Temporal Turbine','Temporal Turbine','Anniversary Reaper\'s Perch','Clockwork Portal Trap','Reaper\'s Perch','Dreaded Totem Trap','Candy Crusher Trap','Clockapult of Time','Clockapult of Winter Past'],
		tactical : ['Chrome Sphynx Wrath','Sphynx Wrath','Anniversary Ambush','Zugzwang\'s Ultimate Move','Zugzwang\'s First Move']
	},
	base : {
		luck : ['Minotaur Base','Clockwork Base','Fissure Base','Rift Base','Attuned Enerchi Induction Base','Dog Jade Base','Monkey Jade Base','Sheep Jade Base','Depth Charge Base','Horse Jade Base','Snake Jade Base','Dragon Jade Base','Eerier Base','Papyrus Base'],
		power : ['Minotaur Base','Clockwork Base','Fissure Base','Golden Tournament Base','Spellbook Base']
	}
};
...
function eventLocationCheck(caller) {
	...
	var temp = "";
    switch (selAlgo){
		case 'Charge Egg 2018 Medium + High':
            checkCharge2018(chargeMedium); break;
        case 'Charge Egg 2018 High':
            checkCharge2018(chargeHigh); break;
...
function checkCharge2018(stopDischargeAt){
	try {
        ...
        console.perror('checkCharge2018',e.message);
    }
}
    ...
    if (showTimerInPage) {
        ...
        if (headerElement) {
            ...
            if (targetPage && aggressiveMode)
				titleElement.innerHTML = "<a href=\"http://devcnn.wordpress.com\" target=\"_blank\"><b>MouseHunt Optimised Autobot (v. " + g_strVersion + " Enhanced Edition)</b></a> - <font color='red'>Aggressive Mode</font>";
			else if (targetPage && browser != 'chrome' && browser != 'opera')
				titleElement.innerHTML = "<a href=\"http://devcnn.wordpress.com\" target=\"_blank\"><b>MouseHunt Optimised AutoBot (v. " + g_strVersion + " Enhanced Edition)</b></a>";
            else
                titleElement.innerHTML = "<a href=\"http://devcnn.wordpress.com\" target=\"_blank\"><b>MouseHunt Optimised AutoBot (v. " + g_strVersion + " Enhanced Edition)</b></a>";
            ...
            if (targetPage) {
                ...
                if (pauseAtInvalidLocation) {
                    // location information will only be displayed when this feature is enabled
                ...
                // if player is currently navigating another page instead of hunter camp
			...
			var clearTrapListStr = '<a id="clearTrapList" style="display:none" name="clearTrapList" title="Click to clear trap list from localStorage" onclick="\
			...
			preferenceHTMLStr += '<a title="Ignores all safety measures such as checking for the Hunter\s Horn before sounding"><b>Aggressive Mode</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
			...
			preferenceHTMLStr += '</select>&nbsp;&nbsp;<a title="Delay before sounding the horn"><b>Delay:</b></a>&emsp;';
			...
			preferenceHTMLStr += '<tr>';
			preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
			preferenceHTMLStr += '<a title="Enable trap check"><b>Trap Check</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
			preferenceHTMLStr += '</td>';
			preferenceHTMLStr += '<td style="height:24px">';
			...
			preferenceHTMLStr += '</select>&nbsp;&nbsp;<a title="Delay before trap check"><b>Delay:</b></a>&emsp;';
			...
			preferenceHTMLStr += '<tr>';
			preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
			preferenceHTMLStr += '<a title="Plays a sound when KR is available"><b>Play KR Notification</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
			preferenceHTMLStr += '</td>';
			preferenceHTMLStr += '<td style="height:24px">';
            ...
            preferenceHTMLStr += '<tr>';
			preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
			preferenceHTMLStr += '<a title="Solve KR automatically"><b>Automatically Solve KR</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
			preferenceHTMLStr += '</td>';
			preferenceHTMLStr += '<td style="height:24px">';
			...
			preferenceHTMLStr += '</select>&nbsp;&nbsp;<a title="Delay before solving KR"><b>Delay:</b></a>&emsp;';
			...
			preferenceHTMLStr += '<tr>';
			preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
			preferenceHTMLStr += '<a title="Save KR image into localStorage"><b>Save KR Image</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
			preferenceHTMLStr += '</td>';
			preferenceHTMLStr += '<td style="height:24px">';
			...
			preferenceHTMLStr += '<tr>';
			preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
			preferenceHTMLStr += '<a title="View saved KR image from localStorage"><b>View KR Image</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
			preferenceHTMLStr += '</td>';
			preferenceHTMLStr += '<td style="height:24px">';
			...
			preferenceHTMLStr += '<tr>';
			preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
			preferenceHTMLStr += '<a title="Script will pause if the hunter is not at the previously set location"><b>Remember Location</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
			preferenceHTMLStr += '</td>';
			preferenceHTMLStr += '<td style="height:24px">';
            ...
            preferenceHTMLStr += '(Changes above this line must be saved before they can take effect) ';
			...
			preferenceHTMLStr += '<tr>';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
            preferenceHTMLStr += '<a title="Automated Map Solver"><b>Map Solver</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            ...
            preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
            preferenceHTMLStr += '<a title="Click refresh to retrieve all uncaught mice"><b>Uncaught Mice</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '<td style="height:24px">';
			...
			preferenceHTMLStr += '<input type="button" id="inputGetMouse" title="Click to Get all uncaught mouse from treasure map" value="Refresh Uncaught Mice List" onclick="onInputGetMouse();">';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';

			preferenceHTMLStr += '<tr id="trSelectedUncaughtMouse" style="display:none;">';
			preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select desired mouse"><b>Selected Mice</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
			preferenceHTMLStr += '<td style="height:24px">';
			...
			preferenceHTMLStr += '<option value="OR">When one of the selected mice is caught</option>';
			preferenceHTMLStr += '<option value="AND">When all of the selected mice are caught</option>';
			preferenceHTMLStr += '</select>';
			preferenceHTMLStr += '</td>';
			preferenceHTMLStr += '</tr>';
            ...
            preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
            preferenceHTMLStr += '<a title="Select trap setup after catch logic is fulfilled"><b>Trap Setup</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="selectWeapon" style="width: 85px" onchange="saveMapHunting();">';
			preferenceHTMLStr += '<option value="Remain">Unchanged</option>';
			preferenceHTMLStr += '</select>';
			preferenceHTMLStr += '<select id="selectBase" style="width: 85px" onchange="saveMapHunting();">';
			preferenceHTMLStr += '<option value="Remain">Unchanged</option>';
			preferenceHTMLStr += '</select>';
			preferenceHTMLStr += '<select id="selectTrinket" style="width: 85px" onchange="saveMapHunting();">';
			preferenceHTMLStr += '<option value="Remain">Unchanged</option>';
			preferenceHTMLStr += '<option value="None">None</option>';
			preferenceHTMLStr += '</select>';
			preferenceHTMLStr += '<select id="selectBait" style="width: 85px" onchange="saveMapHunting();">';
			preferenceHTMLStr += '<option value="Remain">Unchanged</option>';
			preferenceHTMLStr += '<option value="None">None</option>';
			preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
			...
			preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Option to leave map after catch logic is fulfilled"><b>Leave Map After Catching Selected Mice</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
			preferenceHTMLStr += '<td style="height:24px">';
			...
			preferenceHTMLStr += '<tr>';
            preferenceHTMLStr += '<td style="height:24px; text-align:right;">';
            preferenceHTMLStr += '<a title="Specialised automated hunting"><b>Event or Location</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '<td style="height:24px">';
            preferenceHTMLStr += '<select id="eventAlgo" style="width:200px" onChange="window.sessionStorage.setItem(\'eventLocation\', value); showOrHideTr(value);">';
            preferenceHTMLStr += '<option value="None" selected>None</option>';
            preferenceHTMLStr += '<option value="All LG Area">Living Garden Complex</option>';
			preferenceHTMLStr += '<option value="BC/JOD">Balack\'s Cove - Jungle of Dread</option>';
            ...
            preferenceHTMLStr += '<option value="Charge Egg 2018 Medium + High">Charge Egg (Medium + High)</option>';
            preferenceHTMLStr += '<option value="Charge Egg 2018 High">Charge Egg (High)</option>';
			preferenceHTMLStr += '<option value="FG/AR">Forbidden Grove - Acolyte Realm</option>';
			...
			preferenceHTMLStr += '<td style="height:24px">';
			preferenceHTMLStr += '<select id="selectBWRiftWeapon" style="width: 80px;" onchange="saveBWRift();">';
			...
			preferenceHTMLStr += '<option value="Christmas Crystalabra Trap">CCT</option>';
			...
			preferenceHTMLStr += '</select>';
			preferenceHTMLStr += '<select id="selectBWRiftTrinket" style="width: 90px;" onchange="saveBWRift();">';
			preferenceHTMLStr += '<option value="None">None</option>';
			preferenceHTMLStr += '</select>';
			...
			preferenceHTMLStr += '</select>';
			preferenceHTMLStr += '<select id="selectBWRiftActivatePocketWatch" style="width: 80px;" onchange="saveBWRift();">';
			...
			preferenceHTMLStr += '</td>';
			preferenceHTMLStr += '<td style="height:24px">';
			preferenceHTMLStr += '<select id="selectBWRiftWeaponSpecial" style="width: 80px;" onchange="saveBWRift();">';
			...
			preferenceHTMLStr += '<td style="height:24px; text-align:right;"><a title="Select to deactivate tower when Wall is at full HP"><b>Deactivate Tower When HP Full</b></a>&nbsp;&nbsp;:&nbsp;&nbsp;</td>';
			preferenceHTMLStr += '<td style="height:24px">';
			...
			preferenceHTMLStr += '<option value="None">None</option>';
			preferenceHTMLStr += '<option value="Polluted Parmesan">Polluted Parmesan</option>';
			preferenceHTMLStr += '<option value="Terre Ricotta">Terre Ricotta</option>';
			preferenceHTMLStr += '<option value="Magical String">Magical String</option>';
			preferenceHTMLStr += '<option value="Brie String">Brie String</option>';
			preferenceHTMLStr += '<option value="Swiss String">Swiss String</option>';
			preferenceHTMLStr += '<option value="Marble String">Marble String</option>';
            preferenceHTMLStr += '</select>';
            preferenceHTMLStr += '</td>';
            preferenceHTMLStr += '</tr>';
