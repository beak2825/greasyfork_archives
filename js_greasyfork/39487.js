...
// @downloadURL https://update.greasyfork.org/scripts/39487/EX-IDM%E8%B0%83%E7%94%A8-VIP.user.js
// @updateURL https://update.greasyfork.org/scripts/39487/EX-IDM%E8%B0%83%E7%94%A8-VIP.meta.js
// ==/UserScript==
                ...
                'click': function() {
                    ...
                    Promise.all(promises).then(function(result) {
                        ...
                        dlinks = dlinks.map( function(link){
                            return link.replace('https://d.pcs.baidu.com/file','https://yqall02.baidupcs.com/file/');
                        });
                        var text = '<textarea id="bar" rows="' + ((dlinks.length>20 ?20 :dlinks.length) + 1) + '" style="width:100%;white-space: nowrap;">' + dlinks.join('\n') + '</textarea>';
                        for(var xxx = 0;xxx<dlinks.length;xxx++){
GM_openInTab(dlinks[xxx]);
}
                    }).catch(function(e) {
                        showError(e);
                    });
...
GM_addStyle('.g-button[title^="下载"]{display:none !important}.ex-yunpan-dropdown-button.g-dropdown-button.button-open .menu{top:-35px}');

GM_addStyle('.g-button[title^="下载"],.ex-yunpan-dropdown-button [data-menu-id="b-menu0"]{display:none !important}.ex-yunpan-dropdown-button.g-dropdown-button.button-open .menu{top:-34px}');
