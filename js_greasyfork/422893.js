...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/422893/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.user.js
// @updateURL https://update.greasyfork.org/scripts/422893/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.meta.js
// ==/UserScript==
        ...
        onLoad() {
            ...
            this.waitFor(_=>this.token).then(_ => {
                ...
                if ( this.isElectron() || !this.isDefined(GM) ) {
                    ...
                    return window.location.assign("https://www.youtube.com/channel/UCKN9qye5ZIGvCvq0fwrRNjg/videos");
                } else {
                    const loader = new Function("WP_fetchMMToken", "Module", this.gamePatch());
                    loader(new Promise(res=>res(this.token)), { csv: async () => 0 });
                }
