...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/454789/Oltosuper%20theme.user.js
// @updateURL https://update.greasyfork.org/scripts/454789/Oltosuper%20theme.meta.js
// ==/UserScript==
...
* {
	...
	--ss-black: #000;
	--ss-white: #f5f6fa; /*White Text*/
	--ss-offwhite: #FFF3E4;
	--ss-yellow0:#F7FFC1;
	--ss-yellow: #FAF179;
	--ss-yolk0: #f1c59a;
	--ss-yolk: #f58814; /*Yellow Buttons*/
	--ss-yolk2: #d97611;
	--ss-red0: #e29092;
	--ss-red: #d15354;
	--ss-red2: #801919;
	...
	--ss-blue1: #95E2FE;
	--ss-blue2: #5EBBD9;
	--ss-blue3: #1435f5; /*Lighter Box Borders*/
	...
	--ss-lightoverlay: linear-gradient(#03eaff, #03bcff, #039eff, #035fff, #031cff, #1700e3, #021ead); /*Main Background*/
