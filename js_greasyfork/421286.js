...
// @downloadURL https://update.greasyfork.org/scripts/421286/select-search.user.js
// @updateURL https://update.greasyfork.org/scripts/421286/select-search.meta.js
// ==/UserScript==
                    ...
                    value: function () {
                        ...
                        document.addEventListener("mouseup", (function (t) {
                            var n = window.getSelection(),
                                r = n.toString();
                            if (console.log("selectText::", r), 0 === r.length) e.state.show && (function (e, t) {
                                ...
                                a().get("https://kaifa.baidu.com/rest/v1/search?query=".concat(r, "&pageNum=1&pageSize=10")).then((function (t) {
                                    var n = t.data.data.documents.data;
                                    console.log(n), n.length && e.setState({
                                        data: n,
                                        show: !0,
                                        selectedText: r,
                                        modalPosition: {
