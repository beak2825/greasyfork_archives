...
// @require      https://update.greasyfork.org/scripts/469732/1404432/ImageDownloaderLibla.js
// @grant        GM_info
// @grant        GM_xmlhttpRequest
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/469734/NicoMangaDownloader.user.js
// @updateURL https://update.greasyfork.org/scripts/469734/NicoMangaDownloader.meta.js
// ==/UserScript==
...
(async function(axios, JSZip, saveAs, ImageDownloader) {
  ...
  const re = new RegExp(`${window.location.origin}/watch/.*`);
