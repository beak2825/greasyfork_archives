...
// @match        輸入遊戲連結網址
// @grant        
// @downloadURL https://update.greasyfork.org/scripts/38689/%E9%9B%A8%E5%B0%88%E7%94%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/38689/%E9%9B%A8%E5%B0%88%E7%94%A8.meta.js
// ==/UserScript==
...
function qmj_addbtns() {
    var a = ['山坳', '石街','桃花泉', '潭畔草地', '長空棧道','臨淵石台', '千尺幢', '玉女峰', '猢猻愁', '沙丘小洞', '九老洞', '懸根松', '夕陽嶺', '青雲坪', '湖邊','玉壁瀑布','碧水寒潭','懸崖','寒水潭','戈壁','盧崖瀑布','啟母石','無極老姆洞','山溪畔','奇槐坡','小洞天','天梯','雲步橋','觀景台','危崖前','無名山峽谷','天策','賭場','破陣','鱷魚','挖鐵','杭界山','朱果','風泉','殺孽龍','殺盾陣','峨眉','恆山'];
    var b = [];
...
// 外傳1 ------------------------------------------------------------------------------------------------------
		...
		function qmj_addbtns2() {
		    if (ssssButton.innerText == '小功能'){
				    var aaa = ['悟性裝','寶箱3000','通靈','上香','打鳥','蓮花','冰月谷','突破丹禮包','狂暴丹','掌門手諭','投資','煉藥','拼圖'];
			    var bbb = [];
