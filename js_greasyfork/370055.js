...
// @version      1.1(1.04)
// @description  保留底下的recommend栏，因此保留了少量广告。这个脚本主要归功于Azero's CSDN极致去广告。如有侵权，请告知。
// @author       Kulele
// @match        *://blog.csdn.net
// @match        *://blog.csdn.net/*
// @match        *://bbs.csdn.net/*
...
// @match        *://download.csdn.net/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/370055/CSDN%E6%9E%81%E8%87%B4%E5%8E%BB%E5%B9%BF%E5%91%8A_%E6%94%B9%E8%BF%9B.user.js
// @updateURL https://update.greasyfork.org/scripts/370055/CSDN%E6%9E%81%E8%87%B4%E5%8E%BB%E5%B9%BF%E5%91%8A_%E6%94%B9%E8%BF%9B.meta.js
// ==/UserScript==
...
(function () {
    ...
    if (blogcsdn.test(url)) {
        ...
        $($("aside div").first()).remove();
		    ...
		    $(".tool-box").remove();
		    $("#asideNewComments,.edu-promotion,.comment-box,aside").remove();
		    //底部空白，留下,.recommend-box。
