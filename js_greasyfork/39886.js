...
// @run-at      document-end
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/39886/Gems.user.js
// @updateURL https://update.greasyfork.org/scripts/39886/Gems.meta.js
// ==/UserScript==
...
(function() {
    ...
    function getGems(code,i,x){
           var url3 = "http://steamcommunity.com/auction/ajaxgetgoovalueforitemtype/?appid="+code+"&item_type="+i;
           var s = "";
