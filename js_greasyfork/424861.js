// ==UserScript==
// @name                WME Validator Localization for Belgium/NL
// @version             1.1.7.6
// @author		paulvdwyn
// @description         This script localizes WME Validator for Belgium. You also need main package (WME Validator) installed.
// @match               https://editor-beta.waze.com/*editor/*
// @match               https://www.waze.com/*editor/*
// @grant               none
// @run-at              document-start
// @namespace 			https://greasyfork.org/users/7813
// @downloadURL https://update.greasyfork.org/scripts/424861/WME%20Validator%20Localization%20for%20BelgiumNL.user.js
// @updateURL https://update.greasyfork.org/scripts/424861/WME%20Validator%20Localization%20for%20BelgiumNL.meta.js
// ==/UserScript==
window.WME_Validator_Belgium = {
  ".country": "Belgium",
  ".codeISO": "BE",
  ".author": "paulvdwyn",
  ".updated": "2021-04-11",
  ...
  "161.enabled": true,
  "161.params": {
    "solutionEN": "Rename the Major Highway to 'Nnum[ - Nnum]' or 'Nnum - streetname' or 'Nnum > Dir1 / Dir2'",
    "regexp": "!/^(N[1-9]|[1-9][0-9])( - [NS][1-9]+)?(( > [^\\/]+( \\/ [^\\/]+)*)|( - .+))?/$"
  },
  ...
  "162.enabled": true,
  "162.params": {
    "solutionEN": "Rename the Minor Highway to 'Nnum[ - Nnum]' or 'Nnum - streetname' or 'Nnum > Dir1 / Dir2'",
    "regexp": "!/^(N[1-9][0-9][0-9])( - [NS][1-9]+)?(( > [^\\/]+( \\/ [^\\/]+)*)|( - .+))?/$"
  },
