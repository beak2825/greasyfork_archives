...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/483314/Lucky%20Dice%20Refill.user.js
// @updateURL https://update.greasyfork.org/scripts/483314/Lucky%20Dice%20Refill.meta.js
// ==/UserScript==
...
(function() {
    ...
    function clicarBotaoRecarga() {
        const botaoRecarga = document.querySelector('button.sc-imWYAI.pgA-dF.btn'); // Seleciona o botão usando sua classe
        if (botaoRecarga) {
            botaoRecarga.click();
        }
    }
