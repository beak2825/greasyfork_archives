// ==UserScript==
// @name        HIT Scraper WITH EXPORT AND Notifications - Saqfish style --- PRIVATE
...
// @downloadURL https://update.greasyfork.org/scripts/12783/HIT%20Scraper%20WITH%20EXPORT%20AND%20Notifications%20-%20Saqfish%20style%20---%20PRIVATE.user.js
// @updateURL https://update.greasyfork.org/scripts/12783/HIT%20Scraper%20WITH%20EXPORT%20AND%20Notifications%20-%20Saqfish%20style%20---%20PRIVATE.meta.js
// ==/UserScript==
...
var ta2 = setInterval(function(){ DAL2 = []; console.log("DAL cleared");}, 300000);
                ...
                if (!(obj.masters == true && masters_hide.checked) && (ignored && obj.found_this_time) || (!ignored && obj.found_this_time)){
                    ...
                    if (!includelisted && obj.found_this_time && matchOnly.checked){
                        ...
                        if(DAL.indexOf(obj.rid) >= 0){
                            ...
                            var holder2 = obj;
                            var noti2 = new Notification(obj.title +" Found! Hoard it?");                         
...
function show_interface()
{
    ...
    //pandalistspan.appendChild(pandaOnly);
