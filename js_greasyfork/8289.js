...
// @downloadURL https://update.greasyfork.org/scripts/8289/Eliminar%20Mensajes%20de%20Denuncia.user.js
// @updateURL https://update.greasyfork.org/scripts/8289/Eliminar%20Mensajes%20de%20Denuncia.meta.js
// ==/UserScript==
$(document).ready(function () {
  ...
  for (index = 0; index < mensajes.length; ++index) {
    ...
    if (solo.innerHTML.replace(/\s/g, '').substring(0, 8) == 'Extrañás') {
      $.ajax({
