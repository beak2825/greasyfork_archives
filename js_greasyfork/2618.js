...
// @downloadURL https://update.greasyfork.org/scripts/2618/Planetsnu%20improved%20hover%20text.user.js
// @updateURL https://update.greasyfork.org/scripts/2618/Planetsnu%20improved%20hover%20text.meta.js
// ==/UserScript==
            ...
            if (hit.infoturn == 0) {
                ...
                if (hit.temp >= 0 && hit.temp <= 100) {                
                    ...
                    if (planetOwner.raceid == 7) { 
                        ...
                        if (hit.temp > 84) maxPop = Math.floor((20099.9 - (200 * hit.temp)) / 10);                   
                        if (hit.temp < 15) maxPop = Math.floor((299.9 + (200 * hit.temp)) / 10);   
                        // Cols, Rebles, Fascists, Bots
                        if (hit.temp > 80 && (planetOwner.raceid == 4 || planetOwner.raceid == 9 || planetOwner.raceid == 10 || planetOwner.raceid == 11)) maxPop = 60;
                        // Rebels
                        if (hit.temp <= 19 && planetOwner.raceid == 10) maxPop = 90000;
                    }
                    ...
                    var targetGrowth = 1;
                    // Worms!
                    if (hit.nativetype == 5) targetGrowth = 6;
                    // xtal
                    if (planetOwner.raceid == 7) {
                        ...
                        if (hit.temp < 15 || hit.temp > 84) minPop = 0; 
                        if (minPop >= 299) minPop = 0;
                    }
