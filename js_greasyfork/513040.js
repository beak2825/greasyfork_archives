// ==UserScript==
// @name   🌱绎通云|广州理工大学|江西各类学校|广州开放大学成人教育学院|广州华商职业学院|提供机构版本云更新
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @namespace    yty
// @version      1.1
// @description  当前是免费版本，只包含1倍速自动播放，自动下一集等基本功能。广告:付费版本可解锁秒过、自动答题、无人值守，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发工作 QQ 5327216
// @author       网课小帮手
// @include    *://*ytccr.com/*
// @include    *://*beeouc.com/*
// @grant       GM_getValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/513040/%F0%9F%8C%B1%E7%BB%8E%E9%80%9A%E4%BA%91%7C%E5%B9%BF%E5%B7%9E%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%7C%E6%B1%9F%E8%A5%BF%E5%90%84%E7%B1%BB%E5%AD%A6%E6%A0%A1%7C%E5%B9%BF%E5%B7%9E%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%E6%88%90%E4%BA%BA%E6%95%99%E8%82%B2%E5%AD%A6%E9%99%A2%7C%E5%B9%BF%E5%B7%9E%E5%8D%8E%E5%95%86%E8%81%8C%E4%B8%9A%E5%AD%A6%E9%99%A2%7C%E6%8F%90%E4%BE%9B%E6%9C%BA%E6%9E%84%E7%89%88%E6%9C%AC%E4%BA%91%E6%9B%B4%E6%96%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/513040/%F0%9F%8C%B1%E7%BB%8E%E9%80%9A%E4%BA%91%7C%E5%B9%BF%E5%B7%9E%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%7C%E6%B1%9F%E8%A5%BF%E5%90%84%E7%B1%BB%E5%AD%A6%E6%A0%A1%7C%E5%B9%BF%E5%B7%9E%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%E6%88%90%E4%BA%BA%E6%95%99%E8%82%B2%E5%AD%A6%E9%99%A2%7C%E5%B9%BF%E5%B7%9E%E5%8D%8E%E5%95%86%E8%81%8C%E4%B8%9A%E5%AD%A6%E9%99%A2%7C%E6%8F%90%E4%BE%9B%E6%9C%BA%E6%9E%84%E7%89%88%E6%9C%AC%E4%BA%91%E6%9B%B4%E6%96%B0.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = "当前是免费版本，只包含1倍速自动播放，自动下一集等基本功能，如需批量、秒过、答题、自动换课程等高级功能，联系QQ：5327216 - 专业定制各种软件"
    let docUrl = "";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("/learning-details?")) {
                plugMain.page_video();
            } else if (url.endsWith("/learning")) {
                plugMain.showPaidContent(`免费版本不包含自动换课功能，如需使用请安装收费版本`);
            } else if (url.includes("/learning-home?")) {
                plugMain.showPaidContent(`免费版本不包含自动换章节和答题功能，如需使用请安装收费版本`);
        ...
        async page_video() {
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (!location.href.includes("/learning-details?")) {
                        return;
                    }
                    if ($(".details-test-paper:visible").length > 0) {
                        // plugMain.page_videoExam();
                        return;
                    }
                    if ($(".item.cur").find(".icon-wenben").length > 0) {
                        layer.msg("检测到文档内容，10秒后继续");
                        plugMain.pageData.waitTime = 15;
                        setTimeout(() => {
                            let index = $(".item").index($(".item.cur"));
                            if ($(".item").eq(index + 1).length > 0) {
                                $(".item")
                                    .eq(index + 1)
                                    .click();
                                setTimeout(() => {
                                ...
                                //   if (
                                //     i > index &&
                                //     $(el).find(".el-icon-arrow-up").length == 0 &&
                                //     $(el).find(".el-icon-arrow-down").length == 0
                                //   ) {
                                //     $(el).click();
                                //     return false;
                                //   }
                    ...
                    if (plugMain.getElByText($("button"), "下一个活动") != null) {
                        plugMain.getElByText($("button"), "下一个活动").click();
                        return;
                    }
        ...
        async page_viewerforccvideo() {
            ...
            plugMain.showPaidContent("当前是免费版本，收费版本可实现全自动看课换课，无人值守，更有5倍记录学时版本等你付费升级，联系QQ：5327216")
        ...
        firstRun() {
            if (top === window && plugMain.getGMData("showDoc", true)) {
                layer.confirm(
                    freeTips,
                    { icon: 3, title: "首次使用？", btn: ["QQ：5327216 - 付费版本 - 云挂机机构版本 - 批量无人值守哦", "继续使用免费版本"] },
                    function (index) {
                        layer.close(index);
        ...
        async showPaidContent(msg = "此页面为付费内容，免费脚本不包含", withPostfix = true) {
            if (withPostfix) {
                msg += "<span style='font-weight:bold;'>*重要：云挂机批量 QQ：5327216 - 定制各种平台云挂机无人值守 更有机构专属福利</span>"
            }
        ...
        registerMenuCommand() {
            GM_registerMenuCommand("当前是免费版");
            GM_registerMenuCommand("联系脚本客服 QQ：5327216");
        },
        linkAuthor() {
            window.open();
        },
