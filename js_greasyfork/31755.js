...
// @grant        none
// @locale       zh-CN
// @downloadURL https://update.greasyfork.org/scripts/31755/V2ex%20User%20Experience%20Enhance.user.js
// @updateURL https://update.greasyfork.org/scripts/31755/V2ex%20User%20Experience%20Enhance.meta.js
// ==/UserScript==



(function() {
    //<editor-fold desc="修改搜索为雅虎">
    $("#Search form").attr("onsubmit", "return tm_dispatch();");
    var script = (function () {/*
<script>
function tm_dispatch() {
    var q = document.getElementById("q");
    if (q.value != "") {
        var url = 'https://search.yahoo.com/search?p=site:v2ex.com/t%20' + q.value;
