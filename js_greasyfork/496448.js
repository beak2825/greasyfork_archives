// ==UserScript==
// @name         Search beautification for baidu
// @name:zh-CN   Search beautification for baidu
// @namespace    baidu_beautify
// @version      1.0
// @description  百度美化、顶部工具栏毛玻璃效果、底部分页栏悬浮、搜索结果添加边框、搜索结果单列加宽
// @description:zh-CN  百度美化、顶部工具栏毛玻璃效果、底部分页栏悬浮、搜索结果添加边框、搜索结果单列加宽
// @license        MIT
// @author       Xavier Wong & Lee
...
// @downloadURL https://update.greasyfork.org/scripts/496448/Search%20beautification%20for%20baidu.user.js
// @updateURL https://update.greasyfork.org/scripts/496448/Search%20beautification%20for%20baidu.meta.js
// ==/UserScript==
/**
 * 修改指定DOM
 ...
 * 优化搜索页
 */
function searchPageOptimize(){
    $("#head .head_wrapper").css({"margin":"0 120px","width":"auto"})
}
...
function init() {
    ...
    modifyDOM('.head_wrapper', 'margin: 0 120px');
    modifyDOM('.head_wrapper', 'backdrop-filter: blur(10px);');
    modifyDOM('.c-container', 'backdrop-filter: blur(10px);');
    ...
    togglePageOn(isPage);
    GM_addStyle(
        '.cos-row .cos-col:first-child{width:10%!important;}'+
        '.options_2Vntk{width:auto;margin-right:60px;}'+
        '#head .head_wrapper{position: relative;}'+
        '.head_wrapper .s_form {width:60%;min-width:830px;}'+
        '.wrapper_new #u{width:auto; position: absolute;margin-right:100px}'+
