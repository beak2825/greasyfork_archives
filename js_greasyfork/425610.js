...
// @match        http://zombs.io/
// @grant        Ryan Wolf
// @downloadURL https://update.greasyfork.org/scripts/425610/%3C%3E%20Kurt%20%20Java%20Hayalet%20Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/425610/%3C%3E%20Kurt%20%20Java%20Hayalet%20Mod.meta.js
// ==/UserScript==
...
`)
        ...
        Ultimate.menu = Ultimate.createMenu("<h3>Hayalet Mod</h3><div class='menu-grid'><div class='bots'></div><button class='ui-button ui-widget ui-corner-all add-bot'>Bot Oluştur</button><button class='ui-button ui-widget ui-corner-all add-bot2'>Yenile</button><br><button class='ui-button ui-widget ui-corner-all add-bot2'>4 lü Pençe Atağı &</button><button class='ui-button ui-widget ui-corner-all add-bot2'>8 li Kapan Atağı &</button><br><button class='ui-button ui-widget ui-corner-all add-bot2'>Server Doldur &</button><button class='ui-button ui-widget ui-corner-all add-bot2'>Altın Jeneratör &</button><button class='ui-button ui-widget ui-corner-all add-bot2'>Yıkım Modu &</button><br><button class='ui-button ui-widget ui-corner-all add-bot2'>Eşya Fulle</button><button class='ui-button ui-widget ui-corner-all add-bot2'>Kalkan Yükselt</button></div>", "menu")
        _(".hud-top-center").innerHTML += "<button class='ultimate-button'>Hayalet Mod</button>"
