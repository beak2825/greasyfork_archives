...
// @include      *://pthome.net/userdetails.php?*
// @require      https://cdn.staticfile.org/jquery/3.5.1/jquery.min.js
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/433389/PTHOME%E5%8F%91%E7%A7%8D%E7%BB%9F%E8%AE%A1%E5%B7%A5%E5%85%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/433389/PTHOME%E5%8F%91%E7%A7%8D%E7%BB%9F%E8%AE%A1%E5%B7%A5%E5%85%B7.meta.js
// ==/UserScript==
...
(function () {
    'use strict';
    // Your code here...
    var base_api_url = 'https://pthome.net'
        ...
        $('#btn_ana_all').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    var regTitleAll = /全[\d ]+?集/;

                    var tr0=$($(tr[0]).prop("outerHTML"));
                    var postedDate0Str=$(tr0.children()[7]).find('span').attr("title");
                     if (postedDate0Str === undefined)
                            postedDate0Str = $(tr0.children()[7]).text();
                    ...
                    tr.each(function (idx) {
                        ...
                        var postedDateStr = $(ar.children()[7]).find('span').attr("title");
                        if (postedDateStr === undefined)
                            postedDateStr = $(ar.children()[7]).text();
                        ...
                        if ((postedDate.getFullYear() == cursorDate.getFullYear() && postedDate.getMonth() == cursorDate.getMonth())) {
                    ...
                    tr.each(function (idx) {
                        ...
                        if (regTitleAll.test(title.text())) {
                            if ((postedDate.getFullYear() == nowDate.getFullYear() && postedDate.getMonth() == nowDate.getMonth())) {
                                listAll.append($('<li style="margin:5px 0 0 50px;list-style-type:decimal;"><a target="_blank" href="' + title_link + '">' + subTitle.text()+ '<br />' + title_en_text + '</a></li>'));
                                cntAll++;
                            }
                            ...
                            if ((postedDate.getFullYear() == nowDate.getFullYear() && postedDate.getMonth() == nowDate.getMonth())) {
                                list.append($('<li style="margin:5px 0 0 50px;list-style-type:decimal;"><a target="_blank" href="' + title_link + '">' + subTitle.text()+ '<br />' + title_en_text + '</a></li>'));
