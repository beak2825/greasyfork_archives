// ==UserScript==
// @name         .eu / Gym Removed / 75%+
// @version      2.0
// @description  Bootleggers.us/eu Bot
// @include      /^https?:\/\/(www\.)?bootleggers\.(eu)\/.*/
// @grant        none
// @namespace https://greasyfork.org/users/149690
// @downloadURL https://update.greasyfork.org/scripts/32436/eu%20%20Gym%20Removed%20%2075%25%2B.user.js
// @updateURL https://update.greasyfork.org/scripts/32436/eu%20%20Gym%20Removed%20%2075%25%2B.meta.js
// ==/UserScript==
...
try {
    ...
    $(document).ready(function () {
            ...
            $.get("/bootleg.php", function (data) {
                startNewTimerLoad(getTimeLeft(data), "boo");
            });
            //});//*/
                ...
                if ($("td[align='center'][class='header']:contains(prevention)").length || $("td[align='center'][class='header']:contains(protection)").length ||
                    ...
                    if (document.location.href.indexOf(burgUrl) > -1) {
                        if ($(".header:contains(Stolen car)").length) {
                            ...
                            if (carStolen !== "duesenberg" && carStolen !== "beauford1" && carStolen !== "phaeton1" && carStolen !== "chevrolet1" && carStolen !== "stutz1" && carStolen !== "comet1" && carStolen !== "essex1" && carStolen !== "starpegasus1" || carStolen.indexOf(dropCars) > -1) {
                        ...
                        if (gymReady) {
                            if (document.location.href.indexOf(gymUrl) > -1) {
                                ...
                                if (stats[1].level < 40) {
                                    ...
                                    if (stats[0].level < stats[1].level) {
