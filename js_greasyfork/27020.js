// ==UserScript==
// @name        APOLLO :: Collage Building Helper
// @author      Z4ppy
// @namespace   Z4ppy.What.CD
// @description Make it easier to build your collage.
// @include     https://*apollo.rip/torrents.php*
// @include     https://*apollo.rip/collages.php*
// @include     https://*apollo.rip/collage.php*
// @include     https://*apollo.rip/artist.php*
// @include     https://*apollo.rip/bookmarks.php*
// @grant       GM_setValue
// @grant       GM_getValue
...
// @version     1.0.1
// @date        2013-03-05
// @downloadURL https://update.greasyfork.org/scripts/27020/APOLLO%20%3A%3A%20Collage%20Building%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/27020/APOLLO%20%3A%3A%20Collage%20Building%20Helper.meta.js
// ==/UserScript==
...
var URL = new Object();
function parseURL() {
	var URLArr = document.URL.match(/^(https:\/\/(?:ssl\.)?apollo\.rip)\/([\w\/\.]+?)(\?(.*?))?(#.*)?$/);
	URL.Host = URLArr[1]; //protocol + hostname, eg. https://apollo.rip
	URL.Path = URLArr[2];
	URL.Hash = URLArr[5];
...
GM_registerMenuCommand("Apollo.rip :: Collage Building Helper - MathRange checkboxes", function() {
