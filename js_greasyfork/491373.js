...
// @license      MIT
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/491373/%E8%87%AA%E5%8A%A8%E4%B8%8A%E4%BC%A0%E9%82%80%E8%AF%B7%E7%A0%81.user.js
// @updateURL https://update.greasyfork.org/scripts/491373/%E8%87%AA%E5%8A%A8%E4%B8%8A%E4%BC%A0%E9%82%80%E8%AF%B7%E7%A0%81.meta.js
// ==/UserScript==
...
(function () {
     ...
     async function fetchInvite() {
        try {
            let response = await fetch(`${BASE_URL}/invites`, {
                ...
                mode: "cors",
                credentials: "include",
                body: `max_redemptions_allowed=2&expires_at=${encodeURIComponent(await getExpiresAt())}`
            });
    ...
    async function fetchInvites() {
        try {
            let response = await fetch(`${BASE_URL}/u/${username}/invited/pending`, { headers: headers, method: "GET", mode: "cors", credentials: "include" });
            if (!response.ok) {
                throw new Error(`HTTP error! status: ${response.status}`);
            }
