...
// @downloadURL https://update.greasyfork.org/scripts/432730/RaGe%20MoD%20%3E%3A%20%29.user.js
// @updateURL https://update.greasyfork.org/scripts/432730/RaGe%20MoD%20%3E%3A%20%29.meta.js
// ==/UserScript==
...
`;
            ...
            const connectBot = code => {
                ...
                botws.onopen = async () => {
                    ...
                    await wait(100);
                    botws.emit(['sp', [{ name: 'RaGe BoTs', moofoll: '1', skin: "__proto__" }]]);

                    botws.emit(["8", [genRand("By Xx_Fading_Xx")]]);
                    botws.healON = true;
                    setInterval(()=>{
