...
// @author         hateradio
// @version        3.2.0
// @description    This is a cross-browser BBCode helper. It works with both brainwashthemasses.org
// @homepage       https://greasyfork.org/en/scripts/25192-whutpthbbcode
// -updateURL      https://userscripts.org/scripts/source/89544.meta.js
// @icon           https://brainwashthemasses.org/favicon.ico
...
// @downloadURL https://update.greasyfork.org/scripts/25268/WhutBWTMBBCode.user.js
// @updateURL https://update.greasyfork.org/scripts/25268/WhutBWTMBBCode.meta.js
// ==/UserScript==
	...
	WhutBB.Panel = (function () {
		...
		Panel.construct = function () {
			Panel.factory('link', dom.dom('div', {className: 'wbblink' + (WhutBB.user.settings.link ? '' : ' wbbhide') },
				dom.dom('a', {href: WhutBB.config.link, title: 'Version 3.0', txt: 'WhutBWTMBBCode?'})), true);
