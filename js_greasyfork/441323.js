...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/441323/GitHub%20Star%20History.user.js
// @updateURL https://update.greasyfork.org/scripts/441323/GitHub%20Star%20History.meta.js
// ==/UserScript==
...
(function () {
  ...
  let repo = paths[1] + "/" + paths[2];

  let link = document.createElement("a");
  link.href = "https://star-history.com/#" + repo;
  link.className = "btn btn-sm tooltipped tooltipped-s";
  link.title = "Open Star History";
  link.target = "_blank";
  link.rel = "noopener noreferrer";
  link.setAttribute("aria-label", "Open Star History");
  ...
  logo.width = 16;
  logo.height = 16;
  logo.classList.add("v-align-text-bottom");
