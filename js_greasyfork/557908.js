// ==UserScript==
// @name  Скрипт Манжиро KING RUSSIA
...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/557908/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9C%D0%B0%D0%BD%D0%B6%D0%B8%D1%80%D0%BE%20KING%20RUSSIA.user.js
// @updateURL https://update.greasyfork.org/scripts/557908/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9C%D0%B0%D0%BD%D0%B6%D0%B8%D1%80%D0%BE%20KING%20RUSSIA.meta.js
...
(function () {
	...
	const CLOSE_PREFIX = 15; // префикс закрыто
	const OPEN_PREFIX = 2; // префикс открыто
    ...
    },
{
    ...
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR][COLOR=rgb(255,200,0)] King Russia[/color].[/FONT][/size][/CENTER][/B]",
},
{
...

{
  title: '-----------------------------------------------------Техник-----------------------------------------------------'
    ...
    "[B][CENTER][size=14px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#0000ff]Техническая Администрация[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    ...
    },
    {
      ...
      content :
	 	"[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
    '[B][CENTER][FONT=Arial][size=14px]/donate - Проверить зачисления. Если не поможет, свяжитесь в VK - https://vk.com/Kingrussia_help или Telegram - https://t.me/tehKingrussia_bot.[/size][/font][/CENTER]<br><br>' +
    "[B][CENTER][size=14px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#0000ff]Техническая Администрация[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
      prefix: WATCHED_PREFIX,
      status: false,
    },
    {
      ...
      content :
	 	"[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
    '[B][CENTER][FONT=Arial][size=14px]Для решения данной проблемы вам нужно связаться с оператором в любом, удобном для вас виде VK - https://vk.com/Kingrussia_help или Telegram - https://t.me/tehKingrussia_bot.[/size][/font][/CENTER]<br><br>' +
    "[B][CENTER][size=14px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#0000ff]Техническая Администрация[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
      prefix: WATCHED_PREFIX,
      status: false,
    ...
    '[B][CENTER][FONT=Arial][size=14px]Ваше обращение не относится к данному разделу.[/size][/font][/CENTER]<br>' +
    '[B][CENTER][FONT=Arial][size=14px]Если вы хотите обжаловать свое наказание, то вам сюда:[/size][/font][/CENTER]' +
    '[B][CENTER][FONT=Arial][size=14px][URL="https://forum.Kingrussia.online/index.php?forums/42/"] [U] «RED | Обжалования»[/U] [/URL][/size][/font][/CENTER]' +
    '[B][CENTER][FONT=Arial][size=14px][URL="https://forum.Kingrussia.online/index.php?forums/89/"] [U] «GREEN | Обжалования»[/U] [/URL][/size][/font][/CENTER]' +
    '[B][CENTER][FONT=Arial][size=14px][URL="https://forum.Kingrussia.online/index.php?forums/141/"] [U] «BLUE | Обжалования»[/U] [/URL][/size][/font][/CENTER]<br><br>' +
    "[B][CENTER][size=14px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#0000ff]Техническая Администрация[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
      prefix: WATCHED_PREFIX,
      status: false,
...

{
    ...
    content:
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Данное обжалование - дубликат.[/FONT][/size][/CENTER][/B]<br>"+
   	"[B][CENTER][FONT=Arial][size=14px]За повторные жалобы Ваш форумный аккаунт может быть[COLOR=#ff0000] заблокирован.[/COLOR][/FONT][/size][/CENTER]<br>"+
	  "[B][CENTER][FONT=Arial][size=14px]Выношу вердикт - [COLOR=#ff0000]Отказано.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][size=14px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
},
...
},
{
    ...
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[/COLOR][URL='https://forum.Kingrussia.com/index.php?forums/39/'] [U] «Жалобы на администрацию»[/U][/color].[/URL][/FONT][/size][/CENTER]<br><br>" +
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[/COLOR][URL='https://forum.Kingrussia.com/index.php?forums/37/'] [U] «Жалобы на лидеров»[/U][/color].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
 	  "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[/COLOR][URL='https://forum.Kingrussia.com/index.php?forums/113/'] [U] «Обжалование наказаний»[/U][/color].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[URL='https://forum.Kingrussia.com/index.php?forums/37/'] [U] «Жалобы на игроков»[/U].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
 	  "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[/COLOR][URL='https://forum.Kingrussia.com/index.php?forums/2/'] [U] «Технический раздел»[/U][/color].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  content:
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Ваши доказательства не открываются. [/FONT][/size][/CENTER]<br>"+
	  "[B][CENTER][FONT=Arial][size=14px]Выношу вердикт - [COLOR=#ff0000]Отказано.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][size=14px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: UNACCEPT_PREFIX,
...
},
{
    title: 'Отказ (Не по форме)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][Color=#ff0000][/color]Ваша RolePlay биография написана не по форме.[/FONT][/size][/CENTER]<br><br>"+
 	  "[B][CENTER][FONT=Arial][size=14px]Ознакомиться с правилами подачи RolePlay биографией [/COLOR][URL='https://forum.Kingrussia.online/index.php?threads/1087/'] [U]«В данном разделе»[/U][/color][/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Выношу вердикт - [COLOR=#ff0026]Отказано.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: UNACCEPT_PREFIX,
...
},
{
    title: 'Отказ (Мало информации)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][Color=#ff0000][/color]Недостаточное количество RolePlay информации о вашем персонаже.[/FONT][/size][/CENTER]<br><br>"+
 	  "[B][CENTER][FONT=Arial][size=14px]Ознакомиться с правилами подачи RolePlay биографией [URL='https://forum.Kingrussia.online/index.php?threads/1087/'] [U] «В данном разделе»[/U][/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Выношу вердикт - [COLOR=#ff0026]Отказано.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, [COLOR=#ff0026]Команда Проекта[/COLOR] [COLOR=rgb(255,200,0)]King Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: UNACCEPT_PREFIX,
