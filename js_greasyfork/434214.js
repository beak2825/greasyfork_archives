// ==UserScript==
// @name         MiniCRM Telepítői szerződés Gomb
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  ProSec · Beszállítók > Telepítői szerződés
// @author       Vacsati
// @match        https://r3.minicrm.hu/20941/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/434214/MiniCRM%20Telep%C3%ADt%C5%91i%20szerz%C5%91d%C3%A9s%20Gomb.user.js
// @updateURL https://update.greasyfork.org/scripts/434214/MiniCRM%20Telep%C3%ADt%C5%91i%20szerz%C5%91d%C3%A9s%20Gomb.meta.js
// ==/UserScript==

//https://greasyfork.org/hu/scripts/434214-minicrm-telep%C3%ADt%C5%91i-szerz%C5%91d%C3%A9s-gomb
(function() {
    'use strict';
    ...
    function hash_Check(){
        ...
        if(uri[4]=='#Project-32')button_Creator();
    }
    function button_Creator() {
        ...
        var uri = window.location.href.split('/');
        var timer, max=20;
        var copy_Url = "https://www.prosec.hu/php/minicrm_telepitoi.php?q=form&pid="+uri[5];
        ...
        function create_copy_button(){
            ...
            var gomb = '<a href="'+copy_Url+'" target="_blank"><button type="button" class="btn btn-default btn-success btn-sm" style="min-width: 80px;;margin-bottom:4px;">Telepítői</button></a>';
