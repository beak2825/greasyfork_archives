...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/445998/JVChat%20prive.user.js
// @updateURL https://update.greasyfork.org/scripts/445998/JVChat%20prive.meta.js
// ==/UserScript==
...
function parseURL(url) {
    ...
    let regex = /^(.*?)(\?[\w=]*)(&[\w=&#]*)$/i;
    let [_, domain, ids, offsetString] = url.match(regex);
...
function triggerJVChat() {
    ...
    let offsetNumber = (offsetMaxNumber <= 20) ? 1 : offsetMaxNumber - 20;
    
    urlToFetch = parseURL(topicUrl);
    urlToFetch.offsetString = `&offset=${offsetNumber}&folder=0`
    urlToFetch.page = 1;
    urlToFetch.anchor = "";
...
function addJVChatButton(document) {
    ...
    document.head.insertAdjacentHTML("beforeend", css);
    let blocPreRight = document.getElementsByClassName("action-right");
