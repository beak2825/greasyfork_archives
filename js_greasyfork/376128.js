// ==UserScript==
// @name          HWM arts hard
// @description   Текущая прочность (2018.12.06)
...
// @downloadURL https://update.greasyfork.org/scripts/376128/HWM%20arts%20hard.user.js
// @updateURL https://update.greasyfork.org/scripts/376128/HWM%20arts%20hard.meta.js
// ==/UserScript==
...
var text_new_begin =  '<div style="color: #000000; font-size: 9px; padding: 0px; border-color: #eecd59; border-width: 0px; border-style: solid; margin-top: 1px; margin-left: 2px; background-color: #E0C898; position: absolute;z-index: 1;">';
var text_new_begin5 = '<div style="color: #FF0000; font-size: 9px; padding: 0px; border-color: #eecd59; border-width: 0px; border-style: solid; margin-top: 1px; margin-left: 2px; background-color: #E0C898; position: absolute;z-index: 1;">';
...
if(url.indexOf('inventory.php') >= 0) {
	...
	if((typeof arts_c) != 'undefined') {
		...
		document.body.setAttribute('onload',
				...
				' var text_new_begin = \'<div style="color: #000000; font-size: 9px; padding: 0px; border-color: \#eecd59; border-width: 0px; border-style: solid; margin-top: 1px; margin-left: 4px; background-color: \#E0C898; position: absolute;z-index: 1;">\';'+
				' var text_new_end = \'</div>\'; '+
				' var item_hard_regexp = /: (\\d+)\\/(\\d+)/; '+
