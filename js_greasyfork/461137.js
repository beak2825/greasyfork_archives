// ==UserScript==
// @name           OGame Fun: Utilidades B.O.R.G hydrogen
// @namespace      https://greasyfork.org/es/users/385465-nagasis
// @version        1.8.1
// @description    Busca en la base de datos de la galaxia jugadores
// @author         NaGaSiS
// @match          https://hydrogen.spacewar.com.ar/game.php?page=galaxy*
// @include        https://hydrogen.spacewar.com.ar/game.php?page=*
// @grant GM_xmlhttpRequest
// @grant GM_log
// @grant unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/461137/OGame%20Fun%3A%20Utilidades%20BORG%20hydrogen.user.js
// @updateURL https://update.greasyfork.org/scripts/461137/OGame%20Fun%3A%20Utilidades%20BORG%20hydrogen.meta.js
// ==/UserScript==
//https://i.ibb.co/k6NSG4H/ON.png
(function ()
 {

var db = openDatabase("BG", "1", "BORGS: Jugadores", 5*1024*1024);
...
document.head.appendChild(sc);
 ...
 function doit(missionID, planetID) {
     ...
     // ==============================================================================================
     // UTILIDADES MENSAJES CARGAS NECESARIAS
     // =============================================================================================
                 ...
                 if (document.querySelector("#messagestable > tbody").children[j].childElementCount == "4"){
                     ...
                     if (espionaje!= "-1"){
                         ...
                         if(existe != "-1"){
                              ...
                              var cargap = parseInt(total/100000);
                              var cargag = parseInt(total/500000);
                              var formatNumber = {
    ...
    // ==============================================================================================
     ...
     function MenuLib() {
         ...
         this.menuButton_click = function() {
            ...
            //    alert("CLICK");
             //document.location ="https://hydrogen.spacewar.com.ar/game.php?page=galaxy";
