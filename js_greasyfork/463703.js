// ==UserScript==
// @name         Скрипт для Куратор адм || Purple
// @namespace    http://tampermonkey.net/
// @version      2.0
// @description  Скрипт для Куратора
// @author       Timofei_Oleinik
// @match        https://forum.blackrussia.online/index.php?threads/*
// @icon         https://klike.net/uploads/posts/2021-12/1638345168_12.jpg
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/463703/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D0%B0%D0%B4%D0%BC%20%7C%7C%20Purple.user.js
// @updateURL https://update.greasyfork.org/scripts/463703/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D0%B0%D0%B4%D0%BC%20%7C%7C%20Purple.meta.js
// ==/UserScript==
...
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением [COLOR=rgb(255, 0, 0)]Куратор Администрации Timofei_Oleinik [/COLOR][COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B] Ваш аккаунт будет разблокирован на 24 часа для смены NikName, после смены NikName Вы должны будете закрепить в данной теме доказательства. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
    "[CENTER][COLOR=rgb(250, 197, 28)]На рассмотрении[/COLOR]. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением [COLOR=rgb(255, 0, 0)]Куратор Администрации Timofei_Oleinik [/COLOR][COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
    prefix: PINN_PREFIX,
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B] Обжаловать NonRP Обман можно только при возмещении полного ущерба игроку. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
...
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением [COLOR=rgb(255, 0, 0)]Куратор Администрации Timofei_Oleinik [/COLOR][COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
    ...
    {
    title: 'Не возврат ущерба',
	  content:
         '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]http://i.yapx.ru/QqZnC.jpg[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B] У вас было 24 часа на возмещение ущерба, время истекло аккаунт будет заблокирован навсегда. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением [COLOR=rgb(255, 0, 0)]Куратор Администрации Timofei_Oleinik [/COLOR][COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
    prefix: CLOSE_PREFIX,
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]В обжаловании [COLOR=rgb(255, 0, 0)]Отказано[/COLOR].<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением [COLOR=rgb(255, 0, 0)]Куратор Администрации Timofei_Oleinik [/COLOR][COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
    prefix: CLOSE_PREFIX,
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B] Вы ошиблись сервером, напишите обжалование на форуме Вашего сервера. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением [COLOR=rgb(255, 0, 0)]Куратор Администрации Timofei_Oleinik [/COLOR][COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
    prefix: CLOSE_PREFIX,
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Ваше обжалование передано [COLOR=rgb(255, 0, 0)]Специальному Администратору @Sander_Kligan . <br>[COLOR=rgb(255, 255, 255)]Ожидайте ответа в данной теме. Не создавайте повторные темы в противном случае Вы можете получить блокировку форумного аккаунта.[/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][/COLOR][COLOR=rgb(128, 166, 255)]Руководителю Модераторов. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением [COLOR=rgb(255, 0, 0)]Куратор Администрации Timofei_Oleinik [/COLOR][COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
    prefix: PINN_PREFIX,
      status: true,
    },
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(250, 197, 28)]На рассмотрении[/COLOR]. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервера [COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
	       prefix: PINN_PREFIX,
      status: true,
    },
	{
