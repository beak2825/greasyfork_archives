// ==UserScript==
// @name Forum Script for Legends Petr I
// @namespace    https://forum.blackrussia.online
// @version      2.28
// @description  Artem is the best
// @author       Petr_Romanow
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/454032/Forum%20Script%20for%20Legends%20Petr%20I.user.js
// @updateURL https://update.greasyfork.org/scripts/454032/Forum%20Script%20for%20Legends%20Petr%20I.meta.js
// ==/UserScript==
...
(async function () {
    ...
    const buttons = [
        {
            ...
            `[CENTER]      [/CENTER][/FONT][/SIZE][/CENTER][/FONT][/SIZE]<br><br>`+
   ...
   `[SIZE=4][FONT=courier new][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере <SPB> (24)[/COLOR][/FONT][/SIZE][/CENTER]`,
    ...
    {
      title: `ДМ`,
      content: `[SIZE=4][FONT=courier new][CENTER][COLOR${greeting}, уважаемый ${user.mention}[/CENTER]<br>` +
