// ==UserScript==
// @name New.Mango.Booster
// @id New.Mango.Booster
// @version 4.22.4
...
// @downloadURL https://update.greasyfork.org/scripts/438359/NewMangoBooster.user.js
// @updateURL https://update.greasyfork.org/scripts/438359/NewMangoBooster.meta.js
// ==/UserScript==
...
setTimeout(() => {
    ...
    lkButtonButton.addEventListener('click', function insertNameBpmLk() {
        ...
        templateWithName.innerHTML = 
        `<br>С уважением, ${onlyUserName} <br> Команда поддержки MANGO OFFICE`;
        let spanTemplateLk = 
        document.getElementsByClassName('cke_editable_inline')[0];
...
setTimeout(() => {
    ...
    emailButtonButton.addEventListener('click', function insertNameBpmEmail() {
        ...
        const userNameFull = userNameText.split(' ');
        const onlyUserName = userNameFull[1];
        document.querySelector('span[style="font-family:verdana,geneva,sans-serif"]').innerHTML=`<br>С уважением, ${onlyUserName} <br> Команда поддержки MANGO OFFICE`;
    });
}, 9000);
