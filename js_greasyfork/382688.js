...
// @author       xiaoql
// @match        http://10.172.49.3/service/zongbu-newcs-cs/ui/*
// @grant        GM_addStyle
...
// @downloadURL https://update.greasyfork.org/scripts/382688/%E5%A4%A9%E5%AE%AB%E7%94%9F%E4%BA%A7%E7%8E%AF%E5%A2%83%E5%A2%9E%E5%BC%BA.user.js
// @updateURL https://update.greasyfork.org/scripts/382688/%E5%A4%A9%E5%AE%AB%E7%94%9F%E4%BA%A7%E7%8E%AF%E5%A2%83%E5%A2%9E%E5%BC%BA.meta.js
// ==/UserScript==

const g={
    TG_API:'http://10.172.49.3/service/zongbu-newcs-cs/v2/apps?force=true',
    SW_BACKEND_SERVICES:'10.172.32.146:11800',
    SW_AGENT_JAR:"http://10.172.32.145:9003/skywalking/skywalking.tgz",
    DOCKER_PREFIX:'harbor.dcos.xixian.unicom.local/zongbu_newcs_cs/',
    TTY:'http://10.172.49.3/welkin/ttys/taskId?servicename=/zongbu-newcs-cs&containertype=docker'
}
...
function togsConfig(raw) {
    ...
    var dumpParams="-XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/opt/logs/busi/"+raw.env.APP_NAME+"/"+raw.env.APP_NAME+".hprof"
    while(app.cmd.includes(dumpParams)){
        app.cmd = app.cmd.replace(dumpParams," ");
    }
    app.cmd = app.cmd.replace("java ", "java "+dumpParams+" -javaagent:/mnt/mesos/sandbox/skywalking/skywalking-agent.jar ")
    app.env = raw.env;
