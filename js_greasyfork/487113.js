...
// @downloadURL https://update.greasyfork.org/scripts/487113/Ufa%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/487113/Ufa%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1.meta.js
// ==/UserScript==
  (function () {
    'use strict';
  ...
  const buttons = [
      {
        ...
        {      
          title: '_________________________________Жалобы на Лидеров________________________________________',
        },
        {
        ...
        },
        {
          ...
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
          '[CENTER][COLOR=rgb(255, 0, 255)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Вследствие беседы с Лидером было выяснено, что наказание было выдано по ошибке, наказание будет снято.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
        ...
        },
        {
          ...
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
          '[CENTER][COLOR=rgb(255, 0, 255)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша жалоба составлена не по форме. Ознакомьтесь с правилами подачи жалобы - [/I][https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.1166/]*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          '[I][CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman]Отказано, закрыто.[/SIZE][/CENTER][/COLOR][/FONT]',
          prefix: UNACCEPT_PREFIX,
          status: false, 
         },
         {
          ...
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
          '[CENTER][COLOR=rgb(255, 0, 255)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Недостаточно доказательств нарушения со стороны Лидера.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          '[I][CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman]Отказано, закрыто.[/SIZE][/CENTER][/COLOR][/FONT]',
          prefix: UNACCEPT_PREFIX,
          status: false, 
         },
         ...
         },
         {
          ...
          "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4]Главному администратору @Vadim Derkachev[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
          '[I][CENTER][SIZE=4][COLOR=rgb(255, 140, 0)][FONT=times new roman]На рассмотрение...[/SIZE][/CENTER][/COLOR][/FONT]',
          prefix: GA_PREFIX,
          status: true,
