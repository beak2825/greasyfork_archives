...
// @downloadURL https://update.greasyfork.org/scripts/16075/Agar%20Mapa.user.js
// @updateURL https://update.greasyfork.org/scripts/16075/Agar%20Mapa.meta.js
// ==/UserScript==
...
(function() {
    ...
    function miniMapInit() {
        ...
        if ($('#mini-map-wrapper').length === 0){
            var wrapper = $('<div>').attr('id', 'mini-map-wrapper').css({position: 'fixed',zIndex: '1000',bottom: 10,right: 10,width: 250,height: 250});
        ...
        if ($('#mini-map-options').length === 0) {
            ...
            var help_btn = $('<button>')
                ...
                .text('Contacto')
                .on('click', function(e) {
                    window.open('https://www.facebook.com/ElcanijoDeAlcantara');
                    help_btn.blur();
                    return false;
                })
                .appendTo(form_group);
