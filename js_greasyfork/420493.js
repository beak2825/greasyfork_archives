...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/420493/Krunker%20%20Dogeware%20Krunker.user.js
// @updateURL https://update.greasyfork.org/scripts/420493/Krunker%20%20Dogeware%20Krunker.meta.js
// ==/UserScript==
...
class Dogeware {
    ...
    getGuiHtml() {
        ...
        <div class="imageButton <''>YT HERE" onmouseenter="playTick()" onclick="openURL('https://www.youtube.com/watch?v=gEd4i_FGwIM')"><span style='display:inline'></span></div>`
...
function onPageLoad() {
    ...
    window.instructions.innerHTML = `<div id="settHolder"><img src="https://i.imgur.com/krfAACY.png" width="25%"></div><a href='https://www.youtube.com/watch?v=gEd4i_FGwIM' target='_blank.'><div class="imageButton <'>YT HERE"></div></a>`
