// ==UserScript==
// @name         TF Theme (custom 8bit)
// @namespace    http://tampermonkey.net/
// @version      0.46
// @description  Tetris Friends theme for Jstris
// @author       Oki, Eddie, Qapples
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/435108/TF%20Theme%20%28custom%208bit%29.user.js
// @updateURL https://update.greasyfork.org/scripts/435108/TF%20Theme%20%28custom%208bit%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/HqGYC5G.png",36);
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/8bitlock.mp3",abs:1};
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/8bitready.mp3",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/8bitgo.mp3",abs:1,set:0};
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/8bitdied.mp3",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/8bithold.mp3",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/8bitmove.mp3",abs:1,set:0};
    this.comboTones={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/8bitcombo.mp3",abs:1,set:2,duration:2500,spacing:500,cnt:8};
...
customStyle2.innerHTML='.slot span a {color:rgba(255, 255, 255, 100);} .slot span {color:rgba(255, 255, 255, 100);}';
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_tspinsingle.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_tspinmini.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TF_clear1.mp3",       //no sound exists for TF
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_tspindouble.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_clear2.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_tspintriple.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_clear3.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_clear4.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TF_perfectclear.mp3", //no sound exists for TF
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_b2btspin.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/8bit_b2btetris.mp3"
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/TFsong1.mp3",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/TFsong1.mp3"
