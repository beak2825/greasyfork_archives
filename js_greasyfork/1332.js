...
// @author         NoBody
// @include        *.partis.si/*
// @namespace https://greasyfork.org/users/1868
// @downloadURL https://update.greasyfork.org/scripts/1332/Partis%20Admin%20Extended.user.js
// @updateURL https://update.greasyfork.org/scripts/1332/Partis%20Admin%20Extended.meta.js
// ==/UserScript==
            ...
            for (var i = 0; i < allele.length; i++) {  
               	if(allele[i].innerHTML.indexOf("Brišem komentar") != -1) {
                	if(commentid.test(allele[i].getAttribute('id')) || jokeid.test(allele[i].getAttribute('id'))) {
                    	...
                    	var actionnn = '$.post("http://www.partis.si/comment/delete/' + currcomid + '",{offset:\"0\",torrent_id:\"' + torrentid + '\"}); this.style.visibility=\"hidden\"; this.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.setAttribute(\"style\",\"opacity: 0.4;\")';
