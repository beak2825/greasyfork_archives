...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/382751/Neo%20usershop%20auto%20buyer.user.js
// @updateURL https://update.greasyfork.org/scripts/382751/Neo%20usershop%20auto%20buyer.meta.js
// ==/UserScript==
...
function go_buy(mylink,time){
	...
	setTimeout(function() {
       $("table > tbody > tr > td > a > img[width=80]:eq(0)").trigger("click")
...
if(parseInt(cost)<=1000 && parseInt(cost)!=0){
