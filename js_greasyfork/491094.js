...
// @downloadURL https://update.greasyfork.org/scripts/491094/Bazaar%20Auto%20Price.user.js
// @updateURL https://update.greasyfork.org/scripts/491094/Bazaar%20Auto%20Price.meta.js
// ==/UserScript==

let apikey = 'sEZM0SsfWeTL0t9k';
            ...
            if (typeof node.classList !== 'undefined' && node.classList) {
                ...
                if ($(input).size() > 0) {
                    ...
                    $(input).each(function () {
                        ...
                        console.log('Item ID: ' + itemID); // Changed alert to console.log for debugging
