// ==UserScript==
// @name         Pissclones ultimate spammer
// @namespace    http://tampermonkey.net/
// @version      2025-05-08
// @description  Spam the hell out of shitty, low-effort and toxic PPF clones
// @match        https://pixelplanet.fun/
// @match        https://pixmap.fun/
// @match        https://pixelya.fun/
// @match        https://pixuniverse.fun/
// @icon         https://www.google.com/s2/favicons?sz=64&domain=tampermonkey.net
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/535390/Pissclones%20ultimate%20spammer.user.js
// @updateURL https://update.greasyfork.org/scripts/535390/Pissclones%20ultimate%20spammer.meta.js
// ==/UserScript==
...
(function() {
  ...
  panel.innerHTML = `
    ...
    <div class='content'>
      ...
      <input type='number' id='speedInput' value='1000' min='100'/>
  ...
  toggleButton.addEventListener('click', () => {
    if (!spamActive) {
      ...
      spamActive = false;
      toggleButton.textContent = 'Start Spamming';
