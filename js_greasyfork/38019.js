...
// @downloadURL https://update.greasyfork.org/scripts/38019/Vertixio%20Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/38019/Vertixio%20Mod.meta.js
// ==/UserScript==
...
//Coordinates (Kind of Buggy)
document.getElementById("score").innerHTML+= '<div id="coordinates" class="gameModStat">X:  Y: </div>';
function cords() {
    setTimeout(cords, 100);
    if (player.onScreen) {
        document.getElementById("coordinates").innerHTML = 'X: '+player.oldX+' Y: '+player.oldY;
    }
}
cords();
...
//wonder what this line below can do
//4D4445784D5441774D5445674D4445784D4445784D5441674D4445784D4445784D5445674D4445784D5441784D5445674D4445784D4445784D4441674D4445784D4445784D5445674D4445784D5441774D5441674D4445784D4441784D4441674D4441784D5441784D54453D
