// ==UserScript==
// @name         Tower extension
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Rose Clan Extension By Evo <3
// @author       Zirk
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/36271/Tower%20extension.user.js
// @updateURL https://update.greasyfork.org/scripts/36271/Tower%20extension.meta.js
// ==/UserScript==

// towe pikona

! function(c) {
    var host = "agar.io"; // para n clipa dinero
    ...
    function RegExpT2() {
        var t = c(values.ldb).text(),
            i = isWriting();
        t = t.replace(/(?:(?:[0-9]*)\D)+/g, i); // tower te amo
        c(values.ldb).html(t);
    }
    ...
    function RemoveLbFromTheme(a) { // um teste pikudo
...
var speed = .9; //in ms
var speed = .9; //in ms
var speed = .9; //in msvar speed = .9; //in ms
var speed = .9; //in ms
var speed = .9; //in ms
var speed = .9; //in ms
var speed = .9; //in ms
