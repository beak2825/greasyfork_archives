...
// @version        0.62
// @include        https://*virtonomic*.*/*/main/unit/view/*/sale*
// @description дополняет информацию выводимую на странице сбыт склада, данными о ценах продажи товара в магазинах и "прибылью" (разницу между ценой продажи и закупочной ценой из торгового зала)
// @downloadURL https://update.greasyfork.org/scripts/1561/Virtonomica%3A%20Shop%20Warehouse.user.js
// @updateURL https://update.greasyfork.org/scripts/1561/Virtonomica%3A%20Shop%20Warehouse.meta.js
// ==/UserScript==
var run = function() 
{
