...
// @downloadURL https://update.greasyfork.org/scripts/423763/Krunker%20SkidFest.user.js
// @updateURL https://update.greasyfork.org/scripts/423763/Krunker%20SkidFest.meta.js
// ==/UserScript==
            ...
            this.settings = {
                ...
                showSkidBtn: {
                    ...
                    set: (value, init) => {
                        ...
                        if (!this.isDefined(button)) this.createButton("Menu", "https://i.imgur.com/krfAACY.png", this.toggleMenu, value)
