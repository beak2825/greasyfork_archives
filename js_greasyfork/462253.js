// ==UserScript==
// @name         КФ || Magner RP Скрипт 
// @namespace    http://forum.wh7689.web3.maze-host.ru/index.php
// @version      6.7
// @description  КФ|| Magner RP Скрипт
// @author       Tima_Vais
// @match        http://forum.wh7689.web3.maze-host.ru/index.php?threads/*
// @include      http://forum.wh7689.web3.maze-host.ru/index.php?threads/
// @grant        none
// @license      MIT
// @collaborator QuenkM
...
// @downloadURL https://update.greasyfork.org/scripts/462253/%D0%9A%D0%A4%20%7C%7C%20Magner%20RP%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82.user.js
// @updateURL https://update.greasyfork.org/scripts/462253/%D0%9A%D0%A4%20%7C%7C%20Magner%20RP%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82.meta.js
// ==/UserScript==
 
(function () {
  'use strict';
'esversion 6' ;
const  UNACCEPT_PREFIX = 5; // Prefix that will be set when thread closes 
const ACCEPT_PREFIX = 7; // Prefix that will be set when thread accepted
const PIN_PREFIX = 2; // Prefix that will be set when thread pins
const COMMAND_PREFIX = 10; // Prefix that will be set when thread send to project team
const WATCHED_PREFIX = 9;
const CLOSE_PREFIX = 1; // Prefix that will be set when thread closes.
const buttons = [
      {
      title: '|',
      content:
      ...
      },
    {
      ...
      content:
        ...
        "[/LIST]<br><br>" +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на Magner RP[/SIZE][/FONT][/COLOR][COLOR=rgb(0, 255, 255)][FONT=times new roman][SIZE=4]INDIGO[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
