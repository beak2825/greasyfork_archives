...
(function() {
    ...
    const bluePaths = [
        "VVB","WVB","XVB","XUB","YUB","TQF","AVB","SQF","YVB","ZVB","ODG","EUB","HUB","IUB","JUB","LUB","PVB","MUB","QVB","NVB",
        "FAA","GAA","KUB","CTB","XTB","KAA","GTB","MCG","LAA","MAA","NBA","LCG","HTB",
        "JCG","FTB","JTB","OBA","PBA","KTB","LTB","PUB","QUB","BAA","RUB","TCG","SCG","OCG","QCG","PCG","RCG","KBG","MBG","NCG","LBG",
    ...
    function addToggleButton() {
        ...
        Object.assign(btn.style, {
            ...
            cursor: 'pointer',
            display: 'block',
            backgroundImage: 'linear-gradient(to right, #3498db 50%, #e91e63 50%)',
            borderRadius: '12px'
        });

        // Toggle function
        btn.addEventListener('click', () => {
            const isOn = btn.dataset.toggled === "true";
            btn.dataset.toggled = isOn ? "false" : "true";
    ...
    function togglePaths(turnOn) {
        ...
        colorPaths(bluePaths, '#3498db');
        colorPaths(pinkPaths, '#e91e63');
    }
