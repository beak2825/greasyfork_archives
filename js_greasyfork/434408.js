...
// @namespace https://greasyfork.org/users/791860
// @downloadURL https://update.greasyfork.org/scripts/434408/Discord%20Theme%20Changer.user.js
// @updateURL https://update.greasyfork.org/scripts/434408/Discord%20Theme%20Changer.meta.js
// ==/UserScript==
// If u want to change the back ground to ur own go to line 16 background-image: url(imabackground); Change the  url(imabackground); To  url(Ur theme link here); to put ur own theme
(function() {
let css = `
.appMount-3lHmkl {
    background-image: url(imabackground);
