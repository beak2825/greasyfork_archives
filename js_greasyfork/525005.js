...
// @downloadURL https://update.greasyfork.org/scripts/525005/%D0%94%D0%BB%D1%8F%20%D0%BF%D1%80%D0%B8%D0%BC%D0%B0%D1%82%D0%BE%D0%BA%D0%BE%D0%B2%20%D1%81%2049%20%20By%20K%20Stoyn.user.js
// @updateURL https://update.greasyfork.org/scripts/525005/%D0%94%D0%BB%D1%8F%20%D0%BF%D1%80%D0%B8%D0%BC%D0%B0%D1%82%D0%BE%D0%BA%D0%BE%D0%B2%20%D1%81%2049%20%20By%20K%20Stoyn.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
	  title: 'Жб не по форме',
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано. Закрыто.<br>Приятной игры на сервере KHABAROVSK![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	...
	},
    {
	  ...
	  content:
		...
		'[B][CENTER][COLOR=red][ICODE]Закрыто.<br>Приятной игры на сервере KHABAROVSK![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	...
	},
{
    ...
    },
    {
	  ...
	  content:
		...
		'[B][CENTER][COLOR=GREEN][ICODE]Одобрено. Закрыто.<br>Приятной игры на сервере KHABAROVSK![/ICODE][/COLOR][/CENTER][/B]',
	...
	},
    {
     title: 'перемещение в жб на лд',
	  content:
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано.<br>Приятной игры на сервере KHABAROVSK![/ICODE][/COLOR][/CENTER][/B]',
	...
	},
    {
	  ...
	  content:
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=YELLOW][ICODE]На рассмотрении.<br>Приятной игры на сервере KHABAROVSK![/ICODE][/COLOR][/CENTER][/B]',
...
if(prefix == TRANSFER_PREFIX_TR49) {
				moveThread(prefix, 2177); // в жб на техов
			}
if(prefix == TRANSFER_PREFIX_OBJ49) {
				moveThread(prefix, 2207); //  в обж
			}
if(prefix == TRANSFER_PREFIX_ADM49) {
				moveThread(prefix, 2204); //  в жб на адм
			}
if(prefix == TRANSFER_PREFIX_LD49) {
				moveThread(prefix, 2205); //  в жб на лд
			}
if(prefix == TRANSFER_PREFIX_PLAYER49) {
				moveThread(prefix, 2206); // в жб на игроков
			}
}
}
