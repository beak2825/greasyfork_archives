// ==UserScript==
// @name        rw-hosptimer
// @namespace   foxy.rw-hosptimer
// @version     1.0
// @description show tornstats spies on faction wall page and mostly hosp timers
// @author      foxy [2612609]
// @oldauthor   finally [2060206], seintz [2460991] 
// @license     GNU GPLv3
// @run-at      document-end
// @match       https://www.torn.com/factions.php*
// @require     https://update.greasyfork.org/scripts/492409/rw-hosptimer.user.js
// @grant       GM_xmlhttpRequest
// @grant       GM_addStyle
// @connect     tornstats.com
// @downloadURL https://update.greasyfork.org/scripts/492409/rw-hosptimer.user.js
// @updateURL https://update.greasyfork.org/scripts/492409/rw-hosptimer.meta.js
// ==/UserScript==

let manualApiKey = "Your TS API key here";
...
let apiKey = manualApiKey?.length == 16 ? manualApiKey : localStorage["finally.torn.api"];

if (!apiKey) { alert('no apikey set'); return }
