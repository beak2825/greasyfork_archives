// ==UserScript==
// @name        TM Name CN new
// @namespace   trophymanager.cn ——EX
// @description 全部脚本统一汉化 
...
// @downloadURL https://update.greasyfork.org/scripts/439145/TM%20Name%20CN%20new.user.js
// @updateURL https://update.greasyfork.org/scripts/439145/TM%20Name%20CN%20new.meta.js
// ==/UserScript==


var htmlstr=document.getElementsByTagName('html')[0].innerHTML;
htmlstr=htmlstr.replace(/111/g,"111");

//天佑圣西罗
htmlstr=htmlstr.replace(/黄晓东/g,"黄晓东");
htmlstr=htmlstr.replace(/赵顺新/g,"赵顺新");
htmlstr=htmlstr.replace(/万铭岳/g,"万铭岳");
htmlstr=htmlstr.replace(/姜草/g,"姜草");
htmlstr=htmlstr.replace(/曾国盛/g,"曾国盛");
htmlstr=htmlstr.replace(/沈志欢/g,"沈志欢");
htmlstr=htmlstr.replace(/尤恩华/g,"尤恩华");
htmlstr=htmlstr.replace(/陶云翔/g,"陶云翔");
htmlstr=htmlstr.replace(/甘春泉/g,"甘春泉");
htmlstr=htmlstr.replace(/朱涵/g,"朱涵");
htmlstr=htmlstr.replace(/王小平/g,"王小平");
htmlstr=htmlstr.replace(/徐宪平/g,"徐宪平");
htmlstr=htmlstr.replace(/Yu PengZhi /g,"于鹏志");
htmlstr=htmlstr.replace(/田思成/g,"田思成");
htmlstr=htmlstr.replace(/Qin Guo/g,"秦国");
htmlstr=htmlstr.replace(/Cui HuaShao/g,"崔华韶");
htmlstr=htmlstr.replace(/Zhang DaRen/g,"张达仁");
htmlstr=htmlstr.replace(/Gan YuHui /g,"甘玉辉");
htmlstr=htmlstr.replace(/Man JianQun/g,"满建羣");
htmlstr=htmlstr.replace(/Du RuoFei/g,"杜若飞");
htmlstr=htmlstr.replace(/He HaoWei/g,"何浩伟");
htmlstr=htmlstr.replace(/Zhang HongGang/g,"张宏刚");
htmlstr=htmlstr.replace(/Zhangsun ZhiYu/g,"长孙志宇");
htmlstr=htmlstr.replace(/Xin GuanNan/g,"辛冠男");
htmlstr=htmlstr.replace(/Xia GuiWu/g,"夏桂武");
htmlstr=htmlstr.replace(/Li HaiFan/g,"李海帆");
htmlstr=htmlstr.replace(/Zhao ZhengTu/g,"赵正图");
htmlstr=htmlstr.replace(/Huang GuoLong/g,"黄国龙");


//迷弟的小尤文

htmlstr=htmlstr.replace(/Jia JunChuan/g,"贾俊川");
htmlstr=htmlstr.replace(/SiKong ShuRen/g,"思孔舒任");
htmlstr=htmlstr.replace(/Hu XingChi/g,"胡邢驰");
htmlstr=htmlstr.replace(/Zou ZhiXing/g,"邹智刑");
htmlstr=htmlstr.replace(/Jia HuiYu/g,"贾辉宇");
htmlstr=htmlstr.replace(/Zhao LinHu/g,"赵麟虎");



//大桥飞隼F.C

htmlstr=htmlstr.replace(/Zhang EnHua/g,"张恩华");
htmlstr=htmlstr.replace(/Tian ZhenDong/g,"田臻冬");
htmlstr=htmlstr.replace(/Sang FeiHong/g,"桑飞鸿");
htmlstr=htmlstr.replace(/Hao Hui/g,"郝辉");
htmlstr=htmlstr.replace(/Wang ChengDa/g,"王骋炟");
htmlstr=htmlstr.replace(/Xun Baoshan/g,"荀葆杉");
htmlstr=htmlstr.replace(/Peng ZhongYuan/g,"彭钟源");
htmlstr=htmlstr.replace(/Zheng GuanRi/g,"郑冠日");
htmlstr=htmlstr.replace(/ZhuGe PengZhi/g,"诸葛鹏志");
htmlstr=htmlstr.replace(/Yu YuJun/g,"余宇骏");
htmlstr=htmlstr.replace(/Li Zhen/g,"李真");
htmlstr=htmlstr.replace(/Fu XiangZhong/g,"符祥中");
htmlstr=htmlstr.replace(/Zu MinZhi/g,"祖鸣志");
htmlstr=htmlstr.replace(/Guan Hao/g,"管灏");
htmlstr=htmlstr.replace(/He GuoYu/g,"何国羽");
htmlstr=htmlstr.replace(/Shi DaPing/g,"史达平");
htmlstr=htmlstr.replace(/Li JinKang/g,"李晋康");
htmlstr=htmlstr.replace(/Guo KangCheng/g,"郭康承");
htmlstr=htmlstr.replace(/Shi JieXian/g,"史杰贤");
htmlstr=htmlstr.replace(/Zhang GuCheng/g,"张顾城");
...
//taiwan nt
htmlstr=htmlstr.replace(/Chinese Taipe|Taiwan/g,"Chinese Taiwan");
htmlstr=htmlstr.replace(/中华台北/g,"中国台湾");
htmlstr=htmlstr.replace(/Bu Yongshun/g,"蔔永順");
htmlstr=htmlstr.replace(/Sum Gangsheng/g,"蘇崗晟");
htmlstr=htmlstr.replace(/111/g,"111");
htmlstr=htmlstr.replace(/111/g,"111");

htmlstr=htmlstr.replace(/Yau Wanfang/g,"姚萬汸");

htmlstr=htmlstr.replace(/Zhan Jingquo/g,"詹景奎");
htmlstr=htmlstr.replace(/Lai Shing/g,"賴興");
htmlstr=htmlstr.replace(/Ya Peng/g,"亞本");
htmlstr=htmlstr.replace(/Zhao Hangki|赵韩gki/g,"趙航基");
htmlstr=htmlstr.replace(/Xie Siuchung/g,"謝兆忠");
htmlstr=htmlstr.replace(/Cui Pang/g,"崔邦");
htmlstr=htmlstr.replace(/Dung Qin/g,"鄧琴");
htmlstr=htmlstr.replace(/Long Kwangchih/g,"朗光芝");
htmlstr=htmlstr.replace(/Chen Fohian|Chen '16-20' Fohian/g,"陳佛賢");
htmlstr=htmlstr.replace(/Ye '福生' Fusheng|Ye Fusheng/g,"葉福盛");
htmlstr=htmlstr.replace(/Mao Shuai/g,"毛帥");
htmlstr=htmlstr.replace(/Chew Hong/g,"周康");
htmlstr=htmlstr.replace(/Da Xingfu/g,"逹興富");
htmlstr=htmlstr.replace(/Tian Lizhu/g,"田理注");
htmlstr=htmlstr.replace(/Lin Yifu/g,"林逸夫");
htmlstr=htmlstr.replace(/Ni Tsetung/g,"倪澤東");
htmlstr=htmlstr.replace(/Shui Moruo/g,"水莫若");
htmlstr=htmlstr.replace(/Peng Hongliang/g,"彭宏亮");
htmlstr=htmlstr.replace(/Guo Yinxiang/g,"郭銀祥");
htmlstr=htmlstr.replace(/Tsai Youde/g,"蔡有德");
htmlstr=htmlstr.replace(/Mao Jiangun/g,"毛建坤");
htmlstr=htmlstr.replace(/Ma Liang/g,"馬良");
htmlstr=htmlstr.replace(/Dong Lei/g,"董磊");
htmlstr=htmlstr.replace(/Mei Waiho/g,"梅懷浩");
htmlstr=htmlstr.replace(/Siu Shing/g,"蕭成");
htmlstr=htmlstr.replace(/Xiong Tia/g,"熊提亞");
htmlstr=htmlstr.replace(/Loong Dong/g,"龍東");
htmlstr=htmlstr.replace(/Pean Kun/g,"潘坤");
htmlstr=htmlstr.replace(/Qing Yuhsui/g,"秦魚鮭");
htmlstr=htmlstr.replace(/Shan Chiyoung/g,"單基永");
...
htmlstr=htmlstr.replace(/Xuan Yi/g,"袁藝");
htmlstr=htmlstr.replace(/Mei Hanwu/g,"梅汉武");

htmlstr=htmlstr.replace(/Mehdi Bouferma/g,"迈赫迪·布费尔马");

htmlstr=htmlstr.replace(/Du LiangLiang/g,"杜亮亮");
htmlstr=htmlstr.replace(/Wu FangZhuo/g,"吴方卓");
htmlstr=htmlstr.replace(/Qiao XiangLin/g,"乔翔麟");
htmlstr=htmlstr.replace(/Qian ShiQiang/g,"钱十强");
htmlstr=htmlstr.replace(/Kurtis Hightower/g,"库尔蒂斯·海塔尔");
htmlstr=htmlstr.replace(/Wang HuaTian/g,"王华天");

htmlstr=htmlstr.replace(/Jerson Infante/g,"杰森·尹凡特");
htmlstr=htmlstr.replace(/Rowan Bloomfield/g,"罗文·布隆菲尔德");
htmlstr=htmlstr.replace(/Lu Bing/g,"卢冰");
htmlstr=htmlstr.replace(/Mei Wen/g,"梅炆");
htmlstr=htmlstr.replace(/Qian ShengLi/g,"钱胜利");
htmlstr=htmlstr.replace(/111/g,"111");
htmlstr=htmlstr.replace(/111/g,"111");
htmlstr=htmlstr.replace(/Chen QingHe/g,"陈青赫");
htmlstr=htmlstr.replace(/Ethan Hughes/g,"伊坦·休斯");

htmlstr=htmlstr.replace(/Yu ChangQi/g,"于长奇");
htmlstr=htmlstr.replace(/Supiandi Aryanto/g,"苏皮安迪·阿兰托");
htmlstr=htmlstr.replace(/Benitó Szegfű/g,"贝尼托·谢夫");
htmlstr=htmlstr.replace(/Gong HuiMeng/g,"龚辉盟");
htmlstr=htmlstr.replace(/Bakir Cikota/g,"巴基尔西·科塔");

htmlstr=htmlstr.replace(/Liang WeiTao/g,"梁伟涛");
htmlstr=htmlstr.replace(/Sun HuiChuan/g,"孙慧川");
htmlstr=htmlstr.replace(/Gu YaXuan/g,"顾亚轩");
htmlstr=htmlstr.replace(/Liu ZhengTu/g,"刘正图");
htmlstr=htmlstr.replace(/Guo SanSha/g,"郭三沙");
htmlstr=htmlstr.replace(/Lian LiangYu/g,"连良玉");
htmlstr=htmlstr.replace(/Pei MingXuan/g,"裴明轩");
htmlstr=htmlstr.replace(/Wen JingWen/g,"温敬文");
htmlstr=htmlstr.replace(/Wen YiXian/g,"温一贤");
htmlstr=htmlstr.replace(/Zhou YeShan/g,"周叶山");
htmlstr=htmlstr.replace(/Bo JiaYu/g,"柏佳玉");
htmlstr=htmlstr.replace(/He WenQiang/g,"何文强");
htmlstr=htmlstr.replace(/Zheng XiaoDong/g,"郑晓东");
htmlstr=htmlstr.replace(/Lai YiWen/g,"赖怡玟");
htmlstr=htmlstr.replace(/Shi JingXiang/g,"史景祥");
htmlstr=htmlstr.replace(/Pan HaiTao/g,"潘海涛");
htmlstr=htmlstr.replace(/Cai Hang/g,"蔡航");
htmlstr=htmlstr.replace(/Han LingHui/g,"韩陵辉");
htmlstr=htmlstr.replace(/Xu LingPu/g,"徐凌璞");
htmlstr=htmlstr.replace(/Ke JiaJi/g,"柯佳吉");
htmlstr=htmlstr.replace(/Xi JingKai/g,"席静凯");
htmlstr=htmlstr.replace(/Hao ZuQiang/g,"郝祖强");
htmlstr=htmlstr.replace(/SiTu ChenYuan/g,"司徒晨原");
htmlstr=htmlstr.replace(/Fan YouAn/g,"范佑安");
htmlstr=htmlstr.replace(/Sun ChunYu/g,"孙淳宇");

htmlstr=htmlstr.replace(/Xiao RenYing/g,"肖仁英");
htmlstr=htmlstr.replace(/Gu SangChao/g,"顾桑超");
htmlstr=htmlstr.replace(/Lei YuFeng/g,"雷宇峰");
htmlstr=htmlstr.replace(/Niu XueQian/g,"牛学乾");
htmlstr=htmlstr.replace(/Li Yang/g,"李扬");
htmlstr=htmlstr.replace(/Meng ZhengDao/g,"孟正道");
htmlstr=htmlstr.replace(/Zhang DaWei/g,"张达维");
htmlstr=htmlstr.replace(/Dang JianTing/g,"党建廷");
htmlstr=htmlstr.replace(/Li Pu/g,"李璞");
htmlstr=htmlstr.replace(/Chai XiangNan/g,"柴向楠");
htmlstr=htmlstr.replace(/Weng JunTao/g,"文俊涛");
htmlstr=htmlstr.replace(/Hou ZiYi/g,"侯子怡");
htmlstr=htmlstr.replace(/Huo XiaoMa/g,"霍晓马");
htmlstr=htmlstr.replace(/Juan Prieto/g,"胡安·普列托");
htmlstr=htmlstr.replace(/Zong Liang Shi/g,"宗良师");
htmlstr=htmlstr.replace(/Luan XuSheng/g,"栾旭升");
htmlstr=htmlstr.replace(/Tian BaiChuan/g,"田百川");
htmlstr=htmlstr.replace(/Gao YuanQing/g,"高元庆");
htmlstr=htmlstr.replace(/Lin Can/g,"林灿");
htmlstr=htmlstr.replace(/Sebastian Holmén/g,"塞巴斯蒂安·霍尔曼");
htmlstr=htmlstr.replace(/Zhai YueFei/g,"翟跃飞");
htmlstr=htmlstr.replace(/Lu XueFei/g,"陆学飞");
htmlstr=htmlstr.replace(/Jens Meinhard á Lakjuni Hentze/g,"延斯·迈恩哈德·亨茨");
htmlstr=htmlstr.replace(/Mazari Aziz/g,"马扎里· 阿齐兹");
htmlstr=htmlstr.replace(/He Zhi/g,"何志");
htmlstr=htmlstr.replace(/Tamaz Gegelia/g,"塔马兹·盖格里亚");
htmlstr=htmlstr.replace(/Axel van Dijk/g,"阿克塞尔·范·戴克");
htmlstr=htmlstr.replace(/Albert Lebeau/g,"艾伯特·勒博");
htmlstr=htmlstr.replace(/Liang Liang/g,"梁良");
htmlstr=htmlstr.replace(/Manohar Sushant/g,"马诺哈尔·素杉");
htmlstr=htmlstr.replace(/Amirzhan Talgayev/g,"阿米尔詹·塔加耶夫");
htmlstr=htmlstr.replace(/Garfield Barnard/g,"加菲尔德·巴纳德");
htmlstr=htmlstr.replace(/Jacopo Fantauzzi/g,"雅格布·法图齐");
htmlstr=htmlstr.replace(/Igidio Arantes/g,"伊格迪奥·阿兰提斯");
htmlstr=htmlstr.replace(/Luo JiangHua/g,"罗江华");
htmlstr=htmlstr.replace(/Sun Lei/g,"孙磊");
htmlstr=htmlstr.replace(/Jia DeChao/g,"贾德超");
htmlstr=htmlstr.replace(/Miko Annala/g,"米科·安那拉");
htmlstr=htmlstr.replace(/Zachariasz Domański/g,"多曼斯基·扎卡赖亚斯");
htmlstr=htmlstr.replace(/Li FangZhuo/g,"李方卓");
htmlstr=htmlstr.replace(/Leonardo Martini/g,"莱昂纳多·马提尼");
htmlstr=htmlstr.replace(/Yoncho Stoenchev/g,"扬科·斯托埃切夫"); 
htmlstr=htmlstr.replace(/Gocha Chichveishvili/g,"戈查·奇奇维什维利");

htmlstr=htmlstr.replace(/Guo KangCheng/g,"郭康成");
htmlstr=htmlstr.replace(/Ma NingYuan/g,"马宁远");
htmlstr=htmlstr.replace(/Jalendu Punita/g,"亚朗杜·普尼塔");
htmlstr=htmlstr.replace(/Nicola Ghidotti/g,"尼古拉·吉多蒂");
...
htmlstr=htmlstr.replace(/Gui XinZe/g,"桂新泽");
htmlstr=htmlstr.replace(/Huang ZhiXuan/g,"黄智炫");
htmlstr=htmlstr.replace(/Talaat Amin/g,"塔拉特·阿明");
htmlstr=htmlstr.replace(/Nicolas Desmedt/g,"尼古拉·德梅特");
htmlstr=htmlstr.replace(/Xiang You/g,"项佑");
htmlstr=htmlstr.replace(/Chen ZhengYang/g,"陈正阳");
htmlstr=htmlstr.replace(/Bei XiaoRui/g,"贝晓瑞");
htmlstr=htmlstr.replace(/Ling Ang/g,"凌昂");
