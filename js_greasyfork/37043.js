// ==UserScript==
// @name         WebAssign Genius Userscript -- I think this might work 
...
// @downloadURL https://update.greasyfork.org/scripts/37043/WebAssign%20Genius%20Userscript%20--%20I%20think%20this%20might%20work.user.js
// @updateURL https://update.greasyfork.org/scripts/37043/WebAssign%20Genius%20Userscript%20--%20I%20think%20this%20might%20work.meta.js
// ==/UserScript==

var y = document.getElementById('webAssign');
var z = String(y);
localStorage.setItem(y,z);


if ('x' in window === false){
    x = prompt('What is the password?').toUpperCase();
    var ha = x.replace('GENIUS', '')
    localStorage.setItem('x',ha) 
    if (localStorage.getItem(y).includes(localStorage.getItem(x))) {
...
else if (localStorage.getItem(x) !== localStorage.getItem(y)){ 
    alert('Wrong Password')
    x = prompt('What is the password?').toUpperCase();
    var ha = x.replace('GENIUS', '')
    localStorage.setItem('x',ha);
