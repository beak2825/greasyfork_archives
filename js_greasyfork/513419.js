// ==UserScript==
// @name         Кураторы адм/ЗГА/ГА | INDIGO
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/513419/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%B0%D0%B4%D0%BC%D0%97%D0%93%D0%90%D0%93%D0%90%20%7C%20INDIGO.user.js
// @updateURL https://update.greasyfork.org/scripts/513419/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%B0%D0%B4%D0%BC%D0%97%D0%93%D0%90%D0%93%D0%90%20%7C%20INDIGO.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Приятной игры на сервере [Color=#FFFACD]INDIGO.[/COLOR] [/COLOR][/FONT][/CENTER]',
    ...
    },
    {
	  ...
	  content:
		'[CENTER][I][SIZE=4][FONT=Arial][COLOR=#FFFF00]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Ваша жалоба отказана, так как отсутствует ссылка на жалобу. Подайте жалобу повторно с прикрепленной ссылкой на жалобу..[/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][I][FONT=Arial][COLOR=#FF0000][SIZE=4]Закрыто. Приятной игры на нашем сервере. [/COLOR][/FONT][/CENTER]',
	  prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
    ...
    },
  {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=Arial][COLOR=#FFFF00]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Ваша жалоба была передана на рассмотрение Основному Заместителю Главного Администратора по направлению АП. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Ожидайте его ответа.[/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: true,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=Arial][COLOR=#FFFF00]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Вам необходимо обратиться в раздел обжалований чсх - [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.520/']*Тык*[/URL] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=Arial][COLOR=#FF0000][SIZE=4]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,},
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=Arial][COLOR=#FFFF00]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Вы ошиблись разделом.<br>Обратитесь в Технический раздел - [URL='https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB.22/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=Arial][COLOR=#FF0000][SIZE=4]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=Arial][COLOR=#FFFF00]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Ваше наказание было выдано Техническим специалистом, вы можете написать жалобу/обжалование здесь - [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85-%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%BE%D0%B2.490/']*Тык*[/URL] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=Arial][COLOR=#FF0000][SIZE=4]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
