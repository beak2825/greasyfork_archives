...
// @version     1.1
// @downloadURL https://update.greasyfork.org/scripts/6411/imanhua%20Image%20Link.user.js
// @updateURL https://update.greasyfork.org/scripts/6411/imanhua%20Image%20Link.meta.js
// ==/UserScript==
...
function getImageLink() {
	return document.getElementById('comic').src;
}

window.generateLink = function() {
	var mainDiv,newElement;	
	mainDiv = document.getElementById('pagination');
