...
// @run-at          document-end
// @grant           none
// @downloadURL https://update.greasyfork.org/scripts/16689/GPA%27s%20Betting%20Bot.user.js
// @updateURL https://update.greasyfork.org/scripts/16689/GPA%27s%20Betting%20Bot.meta.js
// ==/UserScript==
/* jshint -W097 */
...
function Automated() {
    ...
    menu.innerHTML = '' +
        '<div class="row">' +
            '<div class="col-lg-9">' +
                '<h2>GPA Certified  <small> GPA Betting Bot </small> <i id="automated-theme-switch" class="fa fa-lightbulb-o" style="cursor: pointer;"></i></h2>' +
