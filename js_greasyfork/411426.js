// ==UserScript==
// @name        Esteemed MouseHunt Autobot
// @author      Ayressa, Nevocaine, Gawz, nobodyrandom, Ooi Keng Siang, CnN
// @version    	3.0
// @description Ayressa's revamped MouseHunt botting script! For the lazy noobs
...
// @grant		GM_info
// @run-at		document-end
// @downloadURL https://update.greasyfork.org/scripts/411426/Esteemed%20MouseHunt%20Autobot.user.js
// @updateURL https://update.greasyfork.org/scripts/411426/Esteemed%20MouseHunt%20Autobot.meta.js
// ==/UserScript==
...
var objBestTrap = {
    weapon: {
        ...
        rift: ['Chrome Celestial Dissonance', 'Celestial Dissonance', 'Timesplit Dissonance', 'Mysteriously unYielding Null-Onyx Rampart of Cascading Amperes', 'Christmas Crystalabra', 'Wacky Inflatable Party People', 'Rift Glacier Gatler', 'Multi-Crystal Laser', 'Biomolecular Re-atomizer', 'Focused Crystal Laser', 'Rift Glacier Gatler', 'Crystal Tower'],
    ...
    base: {
        luck: ['Adorned Empyrean Refractor Base', 'Signature Series Denture Base', 'Prestige Base', 'Minotaur Base', 'Fissure Base', 'Rift Base', 'Attuned Enerchi Induction Base', 'Dog Jade Base', 'Monkey Jade Base', 'Sheep Jade Base', 'Depth Charge Base', 'Horse Jade Base', 'Snake Jade Base', 'Dragon Jade Base', 'Eerier Base', 'Papyrus Base'],
        power: ['Adorned Empyrean Refractor Base', 'Signature Series Denture Base', 'Prestige Base', 'Minotaur Base', 'Tidal Base', 'Golden Tournament Base', 'Spellbook Base']
    }
};
        ...
        if (showTimerInPage) {
            ...
            if (headerElement) {
                ...
                */
                ...
                preferenceHTMLStr += '<option value="Rift Glacier Gatler">RGG</option>';
...
function bodyJS() {
    ...
    var objDefaultVRift = {
        master: {
            weapon: new Array(4).fill('Chrome Celestial Dissonance'),
            base: new Array(4).fill('Prestige Base'),
            trinket: new Array(4).fill('Rift Vacuum Charm'),
            bait: new Array(4).fill('Gauntlet String')
        },
        eclipse: {
            weapon: new Array(4).fill('Chrome Celestial Dissonance'),
            base: new Array(4).fill('Prestige Base'),
            trinket: new Array(4).fill('Ultimate Charm'),
            bait: new Array(4).fill('Gauntlet String')
        },
    };
    var objDefaultBWRift = {
