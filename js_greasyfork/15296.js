...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/15296/Theme%20Noel.user.js
// @updateURL https://update.greasyfork.org/scripts/15296/Theme%20Noel.meta.js
// ==/UserScript==
$('#logo img').remove();
$('#logo').append('<a href="https://realitygaming.fr/"><span></span><img src="http://i.imgur.com/Y1mjeUZ.png" width="170" height="120" alt="Logo du forum sur les jeux vidéos RealityGaming"></a>')
 $(document).ready(function(){
                ...
                var css = '#header{background:url(http://image.noelshack.com/fichiers/2014/40/1412102899-header.png) repeat scroll 0 0 #CE0C26;box-shadow:0 5px 5px rgba(0,0,0,.3) inset}#content{border-top:4px solid #10110d;box-shadow:0 -1px 0 rgba(0,0,0,.2)}.profilePage .mast .section.infoBlock h3,.sidebar .section .primaryContent h3,.sidebar .section .secondaryContent h3{padding:4px 7px;margin:-10px -10px 5px;border-bottom:1px solid #D7EDFC;text-shadow:1px 1px rgba(0,0,0,.4)}.nodeList .categoryStrip{font-weight:700;font-size:12px;font-family:Arial,sans-serif;color:#10110d;text-shadow:1px 1px rgba(0,0,0,.2);background:url(styles/realitygaming/images/main/pattern4-ts.png) repeat-x scroll center bottom #CE0C26;padding:5px 10px;margin:0;border-width:1px 1px 0;border-style:solid solid none;border-color:#CE0C26;-moz-border-top-colors:none;-moz-border-right-colors:none;-moz-border-bottom-colors:none;-moz-border-left-colors:none;border-image:none;border-radius:3px;min-height:6px}.profilePage .mast .section.infoBlock h3,.sidebar .section .primaryContent h3,.sidebar .section .secondaryContent h3{font-size:13pt;font-family:"Open sans condensed",Arial,sans-serif;color:#10110d;background:url(styles/realitygaming/images/main/pattern3-ts.png) repeat-x scroll center bottom #CE0C26}.sidebar .section{border:1px solid #CE0C26;border-radius:4px;background:url(http://i.imgur.com/hf3sQnP.jpg)}.footer .pageContent{font-size:11px;color:#A5CAE4;background-color:#CE0C26;margin-right:0;margin-left:0;border-top:4px solid #CE0C26;overflow:hidden;width:100%}.discussionList .sectionHeaders{font-weight:700;font-size:12px;font-family:Arial,sans-serif;color:#10110d;margin:3px auto 0;border-radius:2px 2px 0 0;text-shadow:1px 1px rgba(0,0,0,.2);padding:0;border-top:4px solid #10110d;overflow:hidden;width:100%;background:url(styles/realitygaming/images/main/pattern3-ts.png) repeat-x scroll center bottom #10110d} .sectionMain{font-family:Arial;background-color:#FFF;padding:10px;margin:10px auto;border:1px solid #CE0C26;border-radius:4px}.Menu .sectionFooter{background-color:#CE0C26}.Menu div.primaryContent.menuHeader{color:#FFF!important;text-align:center!important;text-shadow:1px 1px 2px rgba(0,0,0,.6),-1px -1px 2px rgba(0,0,0,.2);color:#FFF!important;background:url(styles/realitygaming/images/main/pattern3-ts.png) repeat-x scroll center bottom #10110d;border:none!important}.subHeading{font-weight:700;font-size:12px;font-family:Arial,sans-serif;color:#10110d;background:url(styles/realitygaming/images/main/pattern3-ts.png) repeat-x scroll center bottom #10110d;padding:5px 10px;margin:3px auto 0;border-radius:2px 2px 0 0;text-shadow:1px 1px rgba(0,0,0,.2)}.sectionFooter{overflow:hidden;font-weight:700;font-size:12px;font-family:Arial,sans-serif;color:#FFF;background:url(styles/realitygaming/images/main/pattern3-ts.png) repeat-x scroll center bottom #CE0C26;padding:5px 10px;margin:3px auto 0;border-radius:2px 2px 0 0;text-shadow:1px 1px rgba(0,0,0,.2)}.button,.callToAction span{background:url(http://i.imgur.com/9qvx5R0.png) no-repeat scroll 2% 98%,url(http://i.imgur.com/7fUPWTv.png) no-repeat scroll 50% 2%,url(http://i.imgur.com/dlDP7Ad.png) no-repeat scroll 98% 2% #CE0C26;transition:all .5s ease 0s;box-shadow:0 1px 3px rgba(0,0,0,.6) inset,0 1px 0 rgba(255,255,255,.1)} .heading,.xenForm .formHeader{font-size:11pt;font-family:"Open sans condensed",Arial,sans-serif;color:#F0F7FC;background:url(styles/realitygaming/images/main/pattern3-ts.png) repeat-x scroll center bottom #CE0C26;padding:5px 10px;margin-bottom:3px;border-bottom:1px solid #176093;border-top-left-radius:5px;border-top-right-radius:5px}';
...
$(document).ready(function(){
                ...
                var css = '.menuVisiteur{position:fixed;top:0;left:50px;-webkit-box-shadow:0px 2px 5px #032A46;-moz-box-shadow:0px 2px 5px #10110d;-khtml-box-shadow:0px 2px 5px #032A46;box-shadow:0px 2px 5px #032A46;position:fixed;z-index:2147;-webkit-border-radius:0px 0px 3px 3px;-moz-border-radius:0px 0px 3px 3px;-khtml-border-radius:0px 0px 3px 3px;border-radius:0px 0px 3px 3px;border-top:none!important;border:1px solid rgb(106,155,179);border:1px solid #FF0000;_border:1px solid rgb(106,155,179);background:#10110d url("styles/realitygaming/images/main/pattern3-ts.png") repeat-x bottom!important;height:30px;line-height:10px;margin-top:-5px}';
...
$(document).ready(function(){
                ...
                var css = '.PageNav a.currentPage{color:#fff;background:url(rgba.php?r=20&g=122&b=191&a=127);background:#FF0000;_filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#7F147ABF,endColorstr=#7F147ABF);border-color: #FF0000;position:relative}';
...
$(document).ready(function(){
    ...
    var css = '.button.primary{background-color: #FF0000;background-image:none;color:white;text-shadow:none}';
...
$(document).ready(function(){
    ...
    var css = '.message .publicControls a.ReplyQuote:hover{text-decoration:none!important;color: #FF0000;}';
...
$(document).ready(function(){
    ...
    var css = '.message .publicControls a.MultiQuoteControl:hover{text-decoration:none!important;color:#FF0000}';
