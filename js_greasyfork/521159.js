(function ($hx_exports, $global, worker_code) {
  ...
  Main.prototype = {
    ...
    onWindowLoaded: function () {
      ...
      this.set_maxShapeCountLimit(500);
      if (this.worker != null) {
        this.worker.terminate();
      }
    ...
    onTargetImageChanged: function () {
      ...
      window.dispatchEvent(new CustomEvent('geometrize.targetImageChanged'));
    },
    ...
    set_running: function (running) {
      ...
      window.dispatchEvent(new CustomEvent('geometrize.changedState'));
      return this.running;
    },
  };
  Math.__name__ = true;
