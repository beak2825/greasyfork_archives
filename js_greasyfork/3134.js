...
// @exclude https://opac.lbs-halle.gbv.de* 

// @version 0.29.20250706211000

// @downloadURL https://update.greasyfork.org/scripts/3134/AutoLink%20TIBUB.user.js
// @updateURL https://update.greasyfork.org/scripts/3134/AutoLink%20TIBUB.meta.js
// ==/UserScript==
...
2025-07-06 / 0.29beta
* Adding ULB Sachsen-Anhalt (graetfully provided by Sven Naumann)
...
* Prepared new update functionality (within Greasemonkey) for new script location at greasyfork.org
...
function registerULB_SachsenAnhalt() {
    GM_setValue("libraryName", "ULB Sachsen-Anhalt");
    alert(GM_getValue("libraryName") + " ausgewählt");
}
GM_registerMenuCommand( "ULB Sachsen-Anhalt", registerULB_SachsenAnhalt); 
...
case 'ULB Sachsen-Anhalt':
    libraryUrlPatternA = "https://opac.lbs-halle.gbv.de/DB=1/LNG=DU/CMD?ACT=SRCHA&PRS=PP%7F&TRM=num+";
    libraryUrlPatternB = "https://opac.lbs-halle.gbv.de/DB=1/LNG=DU/CMD?ACT=SRCHA&IKT=1016&SRT=YOP&TRM=num+";
    libraryName = GM_getValue("libraryName");
    libraryAvailability = /\d+&nbsp;von&nbsp;\d+/;
    libraryShelfmark = /<TD>209A\/\d\d<\/TD><TD>.*?\$a([^$<]*)/i;
    libraryLocation = /<TD>209A\/\d\d<\/TD><TD>.*?\$f([^$<]*)/i;
