...
// @downloadURL https://update.greasyfork.org/scripts/522384/Includes%20%3A%20I18n.user.js
// @updateURL https://update.greasyfork.org/scripts/522384/Includes%20%3A%20I18n.meta.js
// ==/UserScript==
...
var I18n = {
    ...
    get: function (item_str, item, obj, callback) {
        ...
        if (section.length) {
            for (let lang of section) {  // Updated loop
