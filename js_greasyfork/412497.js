...
// @grant          GM_openInTab
// @include        https://www.lerevenu.com*
// @require         http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js
// @downloadURL https://update.greasyfork.org/scripts/412497/LeRevenu.user.js
// @updateURL https://update.greasyfork.org/scripts/412497/LeRevenu.meta.js
// ==/UserScript==
...
function check_BD_version(evt){
    GM_xmlhttpRequest({
		method: 'GET',
		url: 'https://greasyfork.org/scripts/412497/code/412497.meta.js',
		onload: function(responseDetails){
			try{
				...
				if (GM_getValue('BD_Version') < BD_currentVersion){
                    GM_setValue('BD_Version', BD_currentVersion);
                    GM_openInTab('https://greasyfork.org/scripts/412497/code/412497.user.js');
				}
			}
			catch(Err) {}
		}
