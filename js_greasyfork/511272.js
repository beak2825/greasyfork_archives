// ==UserScript==
// @name         SimCompanies-Torn-KICC
// @namespace    http://tampermonkey.net/
// @version      2.0.241010
// @description  Enhancements for SimCompanies web game. Complies with scripting rules of the game.
// @author       MOBIL SUPER (KICC)
// @match        https://www.simcompanies.com/*
// @require      https://s4.zstatic.net/ajax/libs/Chart.js/4.4.0/chart.umd.js
// @require      https://fastly.jsdelivr.net/npm/chartjs-adapter-date-fns@3.0.0/dist/chartjs-adapter-date-fns.bundle.min.js
// @grant        GM_addStyle
// @grant        GM_xmlhttpRequest
// @connect      simcotools.app
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/511272/SimCompanies-Torn-KICC.user.js
// @updateURL https://update.greasyfork.org/scripts/511272/SimCompanies-Torn-KICC.meta.js
// ==/UserScript==
...
(function () {
    ...
    //const CustomProductionTimeInputs = ["9am","10pm","24hr", "48hr"]; // 生产页面，自定义输入生产时间按钮
    const ContractDiscount = 0.97; // 出售商品页面，合同MP价折扣
   ...
   /* function handleProfilePage() {
        const checkElementExist = () => {
            ...
            const selectedElems = document.querySelectorAll('div.css-1kth0o8.et7yomk12 div.css-1156ixp.e1addz3e6 div');
            ...
            if (selectedElems.length > 10) {
                ...
                const board = document.querySelector(`div.css-1kth0o8.et7yomk12 div.css-1156ixp.e1addz3e6`);
...
*/
    function handleProfilePage() {
    const checkElementExist = () => {
        const selectedElems = document.querySelectorAll('div.css-1kth0o8.et7yomk12 div.css-1156ixp.e1addz3e4 div');
        ...
        if (selectedElems.length > 10) {
            ...
            // Set container style to float above `css-1kth0o8.et7yomk12`
            container.style.position = "absolute"; // or "fixed" if you want it to stay at the same position while scrolling
            container.style.top = "60px"; // Adjust as needed
            container.style.left = "0"; // Adjust as needed
            container.style.zIndex = "300"; // Make sure it's above other elements

            const board = document.querySelector('div.css-1kth0o8.et7yomk12 div.css-1156ixp.e1addz3e4');
            board.style.position = "relative"; // Ensure parent element has relative positioning
            board.appendChild(container); // Add the floating container to the board

            // Move the showcase downwards
            const row = document.querySelector(`div.col-md-8 > div.row`);
            const target = row.querySelector(`div.col-sm-12`);
            if (target) {
                target.parentNode.appendChild(target);
    ...
    function landscape_moveGatheringIcons() {
        const icons = document.querySelectorAll("div.css-zhwset");
    ...
    function landscape_removeRush() {
        const banners = document.querySelectorAll(".link-button.css-whw466");
