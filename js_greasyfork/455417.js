// ==UserScript==
// @name    Forum Curators ICE |  for Black Russia
// @name:ru КФ СКРИПТ ДЛЯ ICE | for Black Russia
// @namespace https://forum.blackrussia.online
// @version      0.9
// @description Это короче скрипт, но я его переделал чуть-чуть, пон, да? by R.Yastrebov
// @match   https://forum.blackrussia.online/threads/*
// @include https://forum.blackrussia.online/threads/
// @grant        none
// @license    MIT
// @icon https://emoji.gg/assets/emoji/9372-blurple-boost-level-9.png
// @downloadURL https://update.greasyfork.org/scripts/455417/Forum%20Curators%20ICE%20%7C%20%20for%20Black%20Russia.user.js
// @updateURL https://update.greasyfork.org/scripts/455417/Forum%20Curators%20ICE%20%7C%20%20for%20Black%20Russia.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
    ...
    },
    {
      ...
      content:
        ...
        "[LIST]<br>" +
        "[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]после IC договоренности получить денежные средства и сразу же выйти из игры с целью обмана игрока, или же, договорившись через OOC чат (/n), точно также получить денежные средства и сразу же выйти из игры и тому подобные ситуации.[/SIZE][/FONT][/COLOR]<br><br>" +
    ...
    },
    {
      ...
      content:
        ...
        "[LIST]<br>" +
        "[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Исключение: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]обоюдное согласие обеих сторон.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[/LIST]<br>" +
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
       "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[LIST]<br>" +
        "[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Пример: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]подделка доказательств, искажение информации в свою пользу, предоставление неполной информации о ситуации.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[/LIST]<br>" +
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
        "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[LIST]<br>" +
        "[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Пример: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]игрок объясняет свою невиновность тем, что какой-либо пункт правил недостаточно расписан, но вина очевидна.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[/LIST]<br>" +
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
        "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[LIST]<br>" +
        "[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]зная, что в данный момент игроку может быть выдано наказание за какое-либо нарушение, изменение никнейма или передача своего имущества на другие аккаунты и тому подобное.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]выход игрока из игры не является уходом от наказания.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[/LIST]<br>" +
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
        "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        ...
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER]<br>' +
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][COLOR=rgb(0, 255, 0)]Одобрено, закрыто [/CENTER] <br>' +
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        ...
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]<br>' +
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia] ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Нарушитель будет наказан по пунтку правил: [Color=Red]2.02[/color]. Наносить урон игрокам, которые находятся вне территории воинской части, запрещено | [Color=Red]Jail 30 минут [/color][/CENTER]<br>" +
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Нарушитель будет наказан по пунтку правил: [Color=Red]6.01[/color]. Запрещено наносить урон игрокам без Role Play причины на территории УМВД | [Color=Red]Jail 30 минут [/CENTER]<br>" +
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Нарушитель будет наказан по пунтку правил: [Color=Red]7.01[/color]. Запрещено наносить урон игрокам без Role Play причины на территории ГИБДД | [Color=Red]Jail 30 минут / Warn[/CENTER][/color]<br>" +
        '[COLOR=rgb(0, 255, 0)][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        ...
        '[COLOR=rgb(65, 168, 95)][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I] [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[COLOR=rgb(65, 168, 95)[FONT=Georgia][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
     title: '╴╴╴╴╴╴╴╴╴╴╴╴╴Отказ/отсутвие пункта.╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    },
    {
...
"[CENTER] Внимательно изучите общие правила серверов - [/I][URL='https://forum.blackrussia.online/index.php?threads/Общие-правила-серверов.312571/']*Нажмите сюда*[/URL][/CENTER]<br><br>" +
        '[Color=Red][CENTER][I]Отказано, закрыто.[/I] [/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
{
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Данный игрок уже был наказан по данному пункту правил. Пожалуйста, не создавайте дубликат данной жалобы.[/CENTER]<br>" +
        '[Color=Red][CENTER][I]Отказано, закрыто.[/I] [/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба отказана, т.к в ней нет таймкодов. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений.[/CENTER]<br>" +
        '[Color=Red][CENTER][I]Отказано[/I][/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=Flame][CENTER][I]Ожидайте ответа.[/I][/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia]Приятной игры на [Color=Red]Black Russia [/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: PINN_PREFIX,
      status: false,
    },
    ...
    },
 {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Данные действия никак не наказуемы со стороны администрации. Вы сами назначили его заместителем в семье, следовательно доверились игроку.[/CENTER]" +
        '[Color=Red][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=Flame][CENTER][I]Закрыто[/I][/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      title: 'Док-ва отредактированы/мат в фрапсе/шумы',
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Ваши доказательства отредактированы или в них присутвует ненормативная лексика, либо же есть посторонние шумы на видеозаписи.[/CENTER]" +
        '[Color=Red][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]В случае ответного ДМ нужна видиозапись. Пересоздайте тему и прекрепите видиозапись.[/CENTER]" +
        '[Color=Red][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]'+
        "[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Вы ошиблись разделом, переподайте жалобу в раздел [QUOTE]жалобы на администрацию[/QUOTE].[/CENTER]<br>" +
        '[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]' +
        "[Color=Red][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Вы ошиблись разделом, переподайте жалобу в раздел [QUOTE]жалобы на лидера[/QUOTE].[/CENTER]<br>" +
        '[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]' +
        "[Color=Red][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Вы ошиблись разделом, переподайте жалобу в раздел [QUOTE]жалобы на сотрудников[/QUOTE].[/CENTER]<br>"+
        '[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]' +
        "[Color=Red][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Отсутствуют доказательства на нарушение от игрока.[/CENTER]<br>" +
        '[CENTER][FONT=Georgia][I]Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][CENTER][COLOR=rgb(61, 142, 185)][FONT=Georgia]ICE [/COLOR][/CENTER]' +
        "[Color=Red][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]",
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      title: 'Фотохостинги',
      content:
        '[Color=rgb(148, 0, 211)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из Правила написания RP биографии[/URL].[/CENTER][/FONT]",
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(240, 15, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить неправильное заполнение загловка темы. Ознакомьтесь с правилам подачи [/URL].[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        '[Color=rgb(148, 0, 211)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП ситуация получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из Правила RP ситуаций[/URL][/CENTER][/FONT]",
    ...
    },
    {
      ...
      content:
        '[Color=rgb(148, 0, 211)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП ситуация получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из Правила создания неофициальной RolePlay организации[/URL].[/CENTER][/FONT]",
