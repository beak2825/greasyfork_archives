// ==UserScript==
// @name         Скрипт для Ст.Куратора Администрации Jon_Vinici || Purple
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/456494/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A1%D1%82%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%90%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20Jon_Vinici%20%7C%7C%20Purple.user.js
// @updateURL https://update.greasyfork.org/scripts/456494/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A1%D1%82%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%90%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20Jon_Vinici%20%7C%7C%20Purple.meta.js
// ==/UserScript==
...
const buttons = [
	{
                                        	  title: 'Приветствие',
	  content:
         '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]https://yapx.ru/album/VKgI7[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
...
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Старший Куратор Администрации Jon_Vinici сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
        prefix: PINN_PREFIX,
      status: true,
    },
	{
...
'[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]https://yapx.ru/album/VKgI7[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
        "[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B] Ваше наказание Обажлованию не подлежит,прочтите внимательнее правила подачи Обжалования. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Старший Куратор Администрации Jon_Vinici сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
        prefix: CLOSE_PREFIX,
      status: false,
...
'[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]https://yapx.ru/album/VKgI7[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
        "[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B] У Вас уже есть минимальное наказание. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Старший Куратор Администрации Jon_Vinici сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
        prefix: CLOSE_PREFIX,
      status: false,
...
'[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]https://yapx.ru/album/VKgI7[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
        "[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B] Ранее вам уже было одобрено обжалование и ваше наказание было снижено - повторного обжалования не будет. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Старший Куратор Администрации Jon_Vinici сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
        prefix: CLOSE_PREFIX,
      status: false,
...
'[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]https://yapx.ru/album/VKgI7[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
        "[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]В вашем случае нужно было сразу реагировать на выданное наказание и обращаться в раздел жалоб на администрацию, в настоящий момент срок написания жалобы прошел. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Старший Куратор Администрации Jon_Vinici сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
        prefix: CLOSE_PREFIX,
      status: false,
...
'[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]https://yapx.ru/album/VKgI7[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
        "[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Отсутствуют доказательства - следовательно, рассмотрению не подлежит. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
        "[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/B][/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Старший Куратор Администрации Jon_Vinici сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
        prefix: CLOSE_PREFIX,
...
'[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]https://yapx.ru/album/VKgI7[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
        "[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Ваша жалоба составлена не по форме. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
        "[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/B][/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Старший Куратор Администрации Jon_Vinici сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
...
'[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]https://yapx.ru/album/VKgI7[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
        "[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Доказательства в социальных сетях и т.д. не принимаются. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
        "[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/B][/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Старший Куратор Администрации Jon_Vinici сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
