// ==UserScript==
// @name          Flixtor
// @description	  Flixtor Fixer
// @author        OctopusWrangler
...
// @match       https://*.flixtor.fm/*
// @version       1.0
// @namespace https://greasyfork.org/users/1546404
// @downloadURL https://update.greasyfork.org/scripts/558456/Flixtor.user.js
// @updateURL https://update.greasyfork.org/scripts/558456/Flixtor.meta.js
// ==/UserScript==
...
var blockList = [
// Recommended Body
"flixtor.to###content > div.contentListE:nth-child(2)",
...
"flixtor.to###content > div.d-flex.row.justify-content-center.mb-3.flex-wrap:nth-child(2)",

"flixtor.to###content > div.d-flex.row.p-3.justify-content-center:first-child",

"flixtor.to###content > div.contentListT:nth-child(8)",
...
"flixtor.to###content > div.d-flex.row.p-3.justify-content-center:nth-child(6)",

"flixtor.to###content > h2.text-center.pt-4.text-info.header2:nth-child(5)",

"flixtor.to###content > h2.text-center.pt-4.text-info.header2:nth-child(4)",
