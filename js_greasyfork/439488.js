// ==UserScript==
// @name         For curators or zga | ADM Script
...
// @downloadURL https://update.greasyfork.org/scripts/439488/For%20curators%20or%20zga%20%7C%20ADM%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/439488/For%20curators%20or%20zga%20%7C%20ADM%20Script.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    {
	  title: 'Недостаточно доказательств «ОБЖ»',
	  content:
		'[Color=Red][CENTER][B]{{ greeting }}, уважаемый игрок.[/color][/CENTER][/B]' +
    ...
    {
	  title: 'Жалоба одобрена в сторону игрока <без снятия>',
	  content:
		'[Color=Red][CENTER][B]{{ greeting }}, уважаемый игрок.[/color][/CENTER][/B]' +
