...
// @version      1.0
// @description  该油猴脚本用于 华医网 的辅助看课，脚本功能如下：自动静音播放，自动切换视频，屏蔽课堂问答，自动考试
// @author       脚本喵
...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/549969/%E5%8D%8E%E5%8C%BB%E7%BD%91%E5%88%B7%E8%AF%BE%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/549969/%E5%8D%8E%E5%8C%BB%E7%BD%91%E5%88%B7%E8%AF%BE%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
(function () {
    ...
    advis();
    document.querySelector("span[id='tixing']").innerHTML = "当前网址已适配ヾ(๑╹◡╹)ﾉ&quot";
    if (urlTip == "course_ware_polyv.aspx") { //保利威播放器视频页面
        ...
        console.log("其它情况");
        try {
            document.querySelector("span[id='tixing']").innerHTML = "此页面非视频、考试或未适配<br>";
    ...
    function addinfo() {//插入说明
        ...
        adiv2.innerHTML = '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp继承维护❤❤<br><h3>&nbsp&nbsp&nbsp&nbsp&nbsp刷完视频再切换考试模式，即可连续考试。</h3>';
        adiv2.id = 'jsinfo';
    ...
    <div style="font-size:22px;font-weight:bolder;color:red;">华医网刷课</div>
