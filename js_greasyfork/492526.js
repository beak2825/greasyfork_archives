...
// @version 2
 ...
 // @icon
// @downloadURL https://update.greasyfork.org/scripts/492526/KF_Refrenovs.user.js
// @updateURL https://update.greasyfork.org/scripts/492526/KF_Refrenovs.meta.js
// ==/UserScript==
 (function () {
   'use strict';
     ...
     },
{
  ...
  $(document).ready(() => {
     ...
     addButton('Refrenov 100', 'selectAnswer');
