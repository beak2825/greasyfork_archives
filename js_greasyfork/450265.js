// ==UserScript==
// @name           OGame Fun: Utilidades B.O.R.G ferdinand
// @namespace      https://greasyfork.org/es/users/385465-nagasis
// @version        1.8.1
// @description    Busca en la base de datos de la galaxia jugadores
// @author         NaGaSiS
// @match          https://ferdinand.ogame.fun/game.php?page=galaxy*
// @include        https://ferdinand.ogame.fun/game.php?page=*
// @grant GM_xmlhttpRequest
// @grant GM_log
// @grant unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/450265/OGame%20Fun%3A%20Utilidades%20BORG%20ferdinand.user.js
// @updateURL https://update.greasyfork.org/scripts/450265/OGame%20Fun%3A%20Utilidades%20BORG%20ferdinand.meta.js
// ==/UserScript==
    ...
    // ==============================================================================================
     ...
     function MenuLib() {
         ...
         this.menuButton_click = function() {
            ...
            //    alert("CLICK");
             //document.location ="https://sombrero.ogame.fun/game.php?page=galaxy";
