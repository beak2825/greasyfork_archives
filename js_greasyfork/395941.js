// ==UserScript==
// @name         Harem Heroes Stats (Not Working)
// @namespace    Haremheroes
// @version      0.1.6
// @description  Harem Stats + League stats + Image Viewer(Harem-,Event-Site) (Lightbox).
// @author       KominoStyle
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/395941/Harem%20Heroes%20Stats%20%28Not%20Working%29.user.js
// @updateURL https://update.greasyfork.org/scripts/395941/Harem%20Heroes%20Stats%20%28Not%20Working%29.meta.js
// ==/UserScript==
...
texts.it = {
    ...
    visit_the:'Visita il <a href="../shop.html">Market</a> prima.',
    not_combatible:"Il tuo browser non è compatibile.",
    or_level:"o livello",
    restock:"Rifornimento",
    wiki:"wiki",
    she_is_your:"E tua", //He_is_your:"I tua',
    ...
    remainingBattles: " Restanti lotte da fare",
    remainingAttempts: " Punti battaglia gratuiti"
};
...
if (CurrentPage.indexOf('home') != -1)
{
    ...
    $(eventGirlElementSelector).on('click', async function() {
        ...
        if (baseMargin === null) baseMargin = girlImageDiv.css('margin-top');
...
/*Event CSS + PoP CSS*/
    ...
    sheet.insertRule('.avatar-box img, .event-widget.special-fullscreen-view .widget .rewards-stats .reward img, .pop_left_part img {'
                     + 'cursor: zoom-in; }');
}

//HAREMHEROESSTAT'S Script
...
function ModifyHarem() {
    ...
    */
    ...
    $('#harem_left').append('<div id="CustomBar">'
                            + '<img f="stats" src="https://www.pinclipart.com/picdir/big/85-850772_svg-charts-pie-graphic-library-download-pie-chart.png">'
                            + '</div>'
...
var myeyes = document.querySelector("#scene > div > div.eye");
myeyes.setAttribute('left: 0px');
...
function marketCss(){
    ...
    sheet.insertRule('#inventory .imgMoney {'
                     ...
                     + 'background-image: url("https://hh2.hh-content.com/design/ic_SC.png");'
...
function haremCss(){
    ...
    sheet.insertRule('#harem_right .imgStar, #harem_left .imgStar {'
                     + 'background-image: url("https://hh2.hh-content.com/design_v2/affstar_S.png"); }');

    sheet.insertRule('#harem_right .imgMoney, #harem_left .imgMoney {'
                     + 'background-image: url("https://hh2.hh-content.com/design/ic_SC.png"); }');

    sheet.insertRule('#harem_right .imgKobans, #harem_left .imgKobans {'
                     + 'background-image: url("https://hh2.hh-content.com/design/ic_HC.png"); }');
}
