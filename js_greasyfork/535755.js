// ==UserScript==
// @name         Torn OC Highlighter MR v2 BACKUP PERFECT VERSION ONLY CHANGING TEMP REMOVAL OF RED DIALOG BOX
...
// @downloadURL https://update.greasyfork.org/scripts/535755/Torn%20OC%20Highlighter%20MR%20v2%20BACKUP%20PERFECT%20VERSION%20ONLY%20CHANGING%20TEMP%20REMOVAL%20OF%20RED%20DIALOG%20BOX.user.js
// @updateURL https://update.greasyfork.org/scripts/535755/Torn%20OC%20Highlighter%20MR%20v2%20BACKUP%20PERFECT%20VERSION%20ONLY%20CHANGING%20TEMP%20REMOVAL%20OF%20RED%20DIALOG%20BOX.meta.js
// ==/UserScript==
...
(function() {
    ...
    // --- UI Functions ---
    function showCustomAlert(message) { if (document.getElementById(POPUP_ID)) return; const a = document.createElement('div'); a.id = POPUP_ID; a.innerHTML = message; const c = document.createElement('button'); c.className = 'close-btn'; c.innerHTML = '×'; c.onclick = () => a.remove(); a.appendChild(c); document.body.appendChild(a); }
