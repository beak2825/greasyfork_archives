...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/527968/Own%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/527968/Own%20script.meta.js
// ==/UserScript==
  ...
  const buttons = [
        ...
        },
      {
        ...
        },
        {
          ...
          content:
              `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
              "Ваша тема передана на рассмотрение Руководству Модерации Discord.<br><br>" +
              `Ожидайте ответа.${END_DECOR}`,
          prefix: CP_PREFIX,
          status: true, 
        }, 
