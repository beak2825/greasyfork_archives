...
// @description    This script is for Spanish comments to be used with my other script URComments
...
// @downloadURL https://update.greasyfork.org/scripts/14279/WME%20URComments%20Spanish%20List.user.js
// @updateURL https://update.greasyfork.org/scripts/14279/WME%20URComments%20Spanish%20List.meta.js
// ==/UserScript==
/* Changelog
...
window.UrcommentsSpanishURC_Text[38] = "Deshabilitar el botón \"Terminado\" (\"Done\")"; //"Disable done button"
window.UrcommentsSpanishURC_Text_tooltip[38] = "Deshabilita el botón \"Terminado\" (\"Done\") localizado en la parte inferior de la ventana de URs"; //"Disable the done button at the bottom of the new UR window"
...
"No se recibió información adicional y el reporte será cerrado. Mientras viaje, por favor siéntase bienvenido a reportar cualquier problema que encuentre en el mapa. ¡Gracias!", //Cotero2002
"Solved",
...
"Editor Voluntario Respondiendo - Gracias por tu reporte. La carretera ha sido cerrada.", //Cotero2002 11/20/15
...
"Editor Voluntario Respondiendo - Waze no nos indica su punto de partida o destino final. ¿Podría decirnos el nombre del destino y la dirección con la que está teniendo problemas? ¡Gracias!", //Cotero2002 11/20/15
"Open",
...
"Editor Voluntario Respondiendo - Waze no nos envió información suficiente para arreglar su petición. ¿Podría por favor dejarnos saber qué salió mal con la ruta que Waze le dió? ¿Podría contarnos cuál era su destino y cómo lo introdujo en Waze? ¡Gracias!", //Cotero2002 11/20/15
"Open",

"Recordatorio del cuarto día", //"Reminder message", //do not change (rickzabel)
...
"Séptimo día sin respuesta", //"No reply close message",
...
"El problema no fue claro y los editores voluntarios no recibimos una respuesta, por lo que estamos cerrando este reporte. Mientras viaja, por favor siéntase bienvenido a informar de cualquier problema que encuentre en el mapa. ¡Gracias!", //Cotero2002 11/20/15
"NotIdentified", 
...
"Desafortunadamente, en esta situación, no hay nada malo con el mapa que se pueda ajustar para evitar problemas con la aplicación. Por favor repórtelo a http://j.mp/wazereportarerror", //Carlos Laso
...
"Editor Voluntario Respondiendo - Al parecer su dispositivo tuvo problemas de GPS. Las señales GPS no viajan a través de vehículos o edificios altos. Por favor, asegúrese de que su dispositivo está en algún lugar con una vista despejada del cielo.", //Carlos Laso, Spanish 11/20/2015
"NotIdentified",
...
"Editor Voluntario Respondiendo - Usted puede ayudarnos a mejorar los mapas de Waze reportando de manera lo más detallada posible los problemas que encuentre en el mapa, ¡Gracias!", //Carlos Laso
...
"Editor Voluntario Respondiendo - Nosotros sólo somos capaces de ayudar con los problemas de mapa, deberá informar al departamento de tránsito local. Por favor, siéntase bienvenido a reportar cualquier problema que encuentre em el mapa. ¡Gracias!", //Carlos Laso
"NotIdentified", 
...
"Editor Voluntario Respondiendo -  El objetivo de Waze es llevarlo a su destino por la ruta más rápida posible; sin embargo, no sabe si usted tiene un transponder para el pago de peaje. Por lo tanto, si usted prefiere no tener vías de peaje sugeridas, hay un ajuste en: Configuración> Navegación para evitar carreteras de peaje. ¡Gracias!", //Carlos Laso
"NotIdentified",
...
"Editor Voluntario Respondiendo - Mientras Waze intenta que la ruta a su destino sea de manera eficiente, no sabe si tiene un transponder para el pago de peaje. Lo sentimos mucho decirle que los editores de mapa voluntarios no pueden ser de mucha ayuda aquí. Mientras viaja, por favor siéntase bienvenido a reportar cualquier problema encuentre en el mapa. ¡Gracias! ", //Cotero2002 11/20/15 11/20/2015
"NotIdentified", 
...
"Waze no tiene la habilidad de saber si usted cumple con los criterios para usar un carril HOV. Conducir dentro del carril HOV deberá forzar a Waze a recalcular la ruta. Posteriormente se le debe permitir permanecer en el carril HOV. ¡Gracias!", //Carlos Laso, Cotero2002 11/20/15
"NotIdentified",
...
"Los editores de mapa no pueden eliminar los reportes de condiciones de tráfico. Usted puede ayudar a eliminar los informes de tráfico obsoletos pulsando \"not there\" cuando se le solicite o viajando a través de la intersección a una velocidad normal.", //Cotero2002 11/20/15
"NotIdentified",
...
"No hay problemas con restricciones de giro de la intersección. Los desarrolladores de Waze están trabajando en una solución para este problema, pero no tenemos un tiempo estimado de solución. Por favor, siéntase libre usando el giro señalado hasta que se resuelva el problema. ¡Gracias!", //Carlos Laso
"NotIdentified",
...
"Esta restricción ya está incluida en el mapa, Waze no debe enrutar a través de este giro ilegal. Si Waze siempre te da una ruta a través de un giro restringido, por favor, envíe otro reporte de problema en el mapa en ese momento. ¡Gracias!", //Carlos Laso
...
"Las capacidades de búsqueda y navegación de Waze se limitan a 1000 millas. Cuando se conduce más allá de esa distancia tendrá que seleccionar un destino a menos de 1000 millas como su destino temporal.", // Cotero2002 11/20/15
"NotIdentified", 
...
"Gracias por su respuesta! Esta solicitud será cerrada. Mientras use Waze, por favor siéntase bienvenido a reportar cualquier problema que encuentre en el mapa.", //Carlo laso
...
"El problema no fue claro y los voluntarios de Waze no recibimos una respuesta. Mientras use Waze, por favor siéntase bienvenido a reportar cualquier problema que encuentre en el mapa. ¡Gracias!", //Carlos Laso
...
"Esta característica del agua en particular no es editable por los editores voluntarios. Siéntase en la libertad de reportarlo al grupo de apoyo de Waze en: http://j.mp/SoporteWaze", //Cotero2002 11/20/15
"NotIdentified",
...
"Por favor, borre la memoria caché del texto-a-voz (TTS). En la pantalla de navegación, escriba cc@tts en el campo de búsqueda y pulse Buscar. Usted recibirá un mensaje que el caché TTS ha sido borrado. Su caché TTS será repoblada a medida que utiliza enrutamiento ... ¡Gracias!", //Cotero2002 11/20/15
...
"Editor Voluntario Respondiendo - Las cámaras deben ser reportadas desde la aplicación en o cerca de la ubicación actual utilizando el Reporte> opción Cámara. ¡Gracias!", //Cotero2002 11/20/2015
"NotIdentified",
...
"Sólo un recordatorio: El problema aparenta estar corregido. Por favor, háganos saber si continúa con el problema. Si no tenemos noticias de usted en pocos días vamos a cerrar este reporte. ¡Gracias!", //Cotero2002 11/20/15
...
"Editor Voluntario Respondiendo - Has reportado \"$URD\" y Waze no nos ha enviado la información suficiente para arreglar su petición. ¿Podría por favor hacernos saber lo que salió mal con la ruta Waze te dio? ¿Podría contarnos su destino como la introdujo en Waze? ¡Gracias!", //Carlos Laso
"Open",
...
"Editor Voluntario Respondiendo - Usted reportó un problema cerca de $ SELSEGS, Waze no nos envió información suficiente para arreglar su petición ¿Podría por favor dejarnos saber lo que salió mal en la ruta Waze te dio ¿Podría contarnos su destino tal y como lo introdujo en Waze? ¡Gracias!", //Cotero2002 11/20/15 11/20/2015
"Open",
...
"Editor Voluntario Respondiendo - Waze no nos envió información suficiente para arreglar su petición. ¿Podría por favor dejarnos saber cuál nombre de la calle usted piensa que está mal y lo que debería ser?, ¡Gracias!", //Cotero2002 11/20/15
...
"Editor Voluntario Respondiendo - ¿Podría dejarnos saber con qué giro está teniendo problemas? ¿Podría decirnos su destino tal y como lo introdujo en Waze? ¡Gracias!", //Carlos Laso
"Open",
...
"Editor Voluntario Respondiendo - Waze no nos envió la información suficiente para arreglar su reporte. ¿Podría decirnos su destino tal y como lo introdujo en Waze? ¿Cuál es el problema que tiene con esta dirección? ¡Gracias!", //Carlos Laso, Cotero2002 11/11/15
"Open",
...
"Editor Voluntario Respondiendo - Waze no nos envió la información suficiente para arreglar su reporte. ¿Podría por favor hacernos saber lo que salió mal con la ruta Waze te dio? ¿Podría decirnos su destino tal como lo introdujo en Waze? ¡Gracias!", //Carlos Laso
"Open",
...
"Editor Voluntario Respondiendo - ¿Pudiera usted decirnos tanto como sea posible acerca de la rotonda que crees que falta? ¡Gracias!", //Cotero2002 11/20/15
"Open",
...
"Editor Voluntario Respondiendo - Waze no nos envió la información suficiente para arreglar su reporte. ¿Podría por favor decirnos lo que salió mal? ¿Podría decirnos su destino tal y como lo introdujo en Waze? ¡Gracias!", //Carlos Laso
"Open",
...
"Editor Voluntario Respondiendo - ¿Pudiera por favor dejarnos saber que giro debe o no debe ser permitido y por qué? Por favor, especifique los nombres de las calles en la intersección. ¡Gracias!", // Cotero2002 11/20/15
"Open",
...
"Editor Voluntario Respondiendo - Waze no nos envió información suficiente para arreglar su petición ¿Podría por favor dejarnos saber lo más posible acerca de la salida que falta? ¡Gracias!", //Cotero2002 11/20/15
"Open",
...
"Editor Voluntario Respondiendo - ¿Podría decirnos lo más detallado posible sobre la carretera que considera que falta? ¡Gracias!", //Carlos Laso, Cotero2002 11/20/15 
"Open",
...
"Editor Voluntario respondiendo - ¿Podría decirnos tanto como sea posible acerca del punto de interés que usted cree que falta? ¡Gracias!", //Cotero2002 11/20/15
"Open",
...
"Editor Voluntario Respondiendo - Parece que usted ha seguido la ruta que Waze le sugirió. ¿Podría por favor dejarnos saber lo que salió mal con la ruta Waze le dió? ¿Podría contarnos su destino tal y como lo introdujo en Waze? ¡Gracias!", //Cotero2002 11/20/2015
"Open",
...
"Editor Voluntario Respondiendo - Waze no permite el que nosotros sepamos hacia dónde se dirigía, aunque probablemente fue al lado de un callejón o calle privada. ¿Podría contarnos su destino tal y como lo introdujo en Waze? ¡Gracias!", // Cotero2002 11/20/15
"Open",
...
"Editor Voluntario Respondiendo - ¿Podría por favor dejarnos saber lo siguiente: ¿Qué carretera está cerrada? ¿Entre qué intersecciones está la carretera cerrada? ¿Sabes cuánto tiempo está previsto el cierre de esta carretera? ¡Gracias!", //Carlos Laso, Cotero2002 11/20/2015
"Open",
...
"Hemos hecho algunos cambios en el mapa. Por favor, espere 48 horas para que los cambios se reflejen en el mapa.", //Carlos Laso, Cotero2002 11/20/15
"Open",
...
"Para obtener un resultado actualizado, remueva las localizaciones de su historial de navegación y luego busque la localización nuevamente.", //Cotero2002 11/20/15
"Open",
...
"La búsqueda de resultados en Waze se obtienen de numerosas fuentes. En el campo de búsqueda, en la parte inferior verá las opciones para otros motores de búsqueda. Por favor, intente una opción diferente con otro motor de búsqueda y pudiera obtener la dirección que está buscando.", //Carlos Laso, Cotero2002 11/20/15
"Open",
...
"Por favor, intente estas opciones: Presione icono Waze> Configuración> Opciones avanzadas> Transferencia de datos> Actualizar Mapa De Mi área. Otra opción que usted puede intentar es borrar la memoria caché de aplicaciones de Waze en el gestor de aplicaciones de su teléfono. La última opción es restablecer la aplicación, vaya a la pantalla de navegación y escriba ##@resetapp en el campo de búsqueda y presione búsqueda.", //Carlos Laso
"Open",
...
"Editor Voluntario respondiendo - Tú puedes pavimentar la carretera desde la aplicación pulsando el icono Pin> Error Mapa > Pavimentar > pulse pavimentar. Una vez hecho esto, pulse > Detener pavimentación. Usted puede proporcionar información acerca de la nueva carretera, tales como su nombre pulsando en el icono del Pin> Error Mapa > Falta calle. ¡Gracias! ", // Cotero2002 11/20/15
"Open",
...
"He comenzado el proceso para tener este reporte arreglado. Gracias por tu reporte!", //Carlos Laso
"Open"
];
//end Spanish list
