...
// @grant        GM_info
// @license		 lly
// @downloadURL https://update.greasyfork.org/scripts/436796/mserscript.user.js
// @updateURL https://update.greasyfork.org/scripts/436796/mserscript.meta.js
// ==/UserScript==
...
(function () {
    ...
    function pageOperate() {
        ...
        if (pageurl.indexOf('sales.coinlist.co') >= 0 && pageurl.indexOf('/purchase') >= 0) {
            ...
            pageurl = 'coinlist.co/-option-/new'
        } else if (pageurl.indexOf('pstake-token-sale/arman/residence') >= 0) {
            pageurl = 'coinlist.co/-option--sale/residence'
        } else if (pageurl.indexOf('pstake-token-sale/arman/quiz') >= 0) {
            pageurl = 'coinlist.co/-option--sale/quiz'
        } else if (pageurl.indexOf('pstake-token-sale/arman') >= 0 && $('.js-countdown').length) {
            pageurl = 'coinlist.co/-option-/success'
        }
