// ==UserScript==
// @name        Wanikani Blacklist Filter (for Self-Study Quiz)
// @namespace   rfindley
// @description Blacklist specific items (for Self-Study Quiz)
// @version     1.1.0
...
// @run-at      document-end
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/420050/Wanikani%20Blacklist%20Filter%20%28for%20Self-Study%20Quiz%29.user.js
// @updateURL https://update.greasyfork.org/scripts/420050/Wanikani%20Blacklist%20Filter%20%28for%20Self-Study%20Quiz%29.meta.js
// ==/UserScript==

window.blacklist_filter = {};
...
(function(gobj) {
    ...
    //-------------------------------------------------------------------
    var script_name = 'Blacklist Filter (for Self-Study Quiz)';
    ...
    //===================================================================
    function startup() {
        wkof.ItemData.registry.sources.wk_items.filters.radical_blacklist = {
            label: 'Radical Blacklist',
            type: 'text',
            default:'',
        ...
        wkof.ItemData.registry.sources.wk_items.filters.kanji_blacklist = {
            label: 'Kanji Blacklist',
            type: 'text',
            default:'',
            placeholder: '大, 小',
        ...
        wkof.ItemData.registry.sources.wk_items.filters.vocabulary_blacklist = {
            label: 'Vocabulary Blacklist',
            type: 'text',
            default:'',
            placeholder: '大きい, 小さい',
        ...
        wkof.ItemData.registry.sources.wk_items.filters.kana_vocabulary_blacklist = {
            label: 'Kana Vocabulary Blacklist',
            type: 'text',
            default:'',
            placeholder: 'はい, いいえ',
        ...
        wkof.set_state('blacklist_filter', 'ready');
    }
