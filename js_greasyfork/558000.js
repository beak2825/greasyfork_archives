// ==UserScript==
// @name         myOneJAVOneWeb
// @name:zh-CN   myOneJAVOneWeb 自用版
// @namespace    https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb
// @version      v1.0.7
...
// @grant        GM_info
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/558000/myOneJAVOneWeb.user.js
// @updateURL https://update.greasyfork.org/scripts/558000/myOneJAVOneWeb.meta.js
// ==/UserScript==
(function () {
    'use strict';
    console.clear();
    ...
    class JAV {
        constructor(i) {
            ...
            this.data = {
                车牌信息: { zhushi: '车牌信息类', name: '车牌', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                javlibarary: {
                    zhushi: 'JavLibrary 是一个线上日本成人影片图书馆。',
                    name: 'JavLibrary', bgcolor: '#FAFAD2', color: 'red',
                ...
                javbus: {
                    ...
                    name: 'JavBus', bgcolor: '#FAFAD2', color: 'red',
                ...
                javdb: {
                    ...
                    name: 'JavDB<sup>fc2</sup>', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://javdb.com/favicon.ico',
                    origin: 'https://javdb.com',
                    uri: `/search?q=${this.xiaxian}`
                },
                javtxt: {
                    zhushi: 'JAV档案馆',
                    name: 'JAVTXT', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://javtxt.com/favicon.ico',
                    origin: 'https://javtxt.com',
                    uri: `/search?type=id&q=${this.bango}`
                },
                jav321: {
                ...
                AirAV: {
                    zhushi: '瘋AV 女優av查詢系統,免費,線上看,直播,番號',
                    name: 'Airav', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://avavair3.online/LOGO.ico',
                    origin: 'https://avavair3.online',
                    uri: `/search_result?kw=${this.fanHao}`
                },
                ...
                片商信息: { zhushi: '片商官方发布页', name: '官网', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                s1s1s1: {
                    zhushi: 'トップ | S級女優限定のAVメーカー【S1 NO.1 STYLE (エスワン ナンバーワンスタイル)】公式サイト',
                    name: 'S1', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://s1s1s1.com/favicons/s1/favicon.ico',
                    origin: 'https://s1s1s1.com',
                    uri: `/works/detail/${this.bango}`
                },
                SoftOnDemand: {
                    zhushi: 'SOD（ソフトオンデマンド）',
                    name: 'SOD', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.sod.co.jp/static/information/images/icon/favicon.ico',
                    origin: 'https://ec.sod.co.jp',
                    uri: `/prime/videos/?id=${this.fanHao}`
                },
                Ideapocket: {
                    zhushi: 'トップ | ハイクオリティ・ゴージャス・エロティックのAVメーカー【IDEAPOCKET (アイデアポケット）】公式サイト',
                    name: 'IP社', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://ideapocket.com/favicons/ideapocket/favicon.ico',
                    origin: 'https://ideapocket.com',
                    uri: `/works/detail/${this.bango}`
                },
                PRESTIGE: {
                    zhushi: 'PRESTIGE(プレステージ) アダルトビデオメーカー公式サイト',
                    name: '蚊香社', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.prestige-av.com/img/favicon.ico',
                    origin: 'https://www.prestige-av.com',
                    uri: `/goods?searchText=${this.fanHao}`
                },
                Moodyz: {
                    zhushi: 'トップ | 人気知名度NO.1！アダルトビデオ最強のAVメーカー【MOODYZ(ムーディーズ)】公式サイト',
                    name: 'MOODYZ', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://moodyz.com/favicons/moodyz/favicon.ico',
                    origin: 'https://moodyz.com',
                    uri: `/works/detail/${this.bango}`
                },
                Madonna: {
                    zhushi: 'トップ | 人妻・熟女No.1のAVメーカー【マドンナ】公式サイト',
                    name: 'Madonna', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://madonna-av.com/favicons/madonna/favicon.ico',
                    origin: 'https://madonna-av.com',
                    uri: `/works/detail/${this.bango}`
                },
                Faleno: {
                    zhushi: 'FALENO（ファレノ） | 配信特化型 新世代AVメーカー',
                    name: 'FALENO', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://cdn.faleno.net/top/wp-content/themes/faleno/common/img/favicon.ico',
                    origin: 'https://faleno.jp',
                    uri: `/top/works/${this.bango}`
                },
                Oppai: {
                    zhushi: 'トップページ | AVメーカー【OPPAI（おっぱい）】公式サイト',
                    name: 'OPPAI', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://oppai-av.com/favicons/oppai/favicon.ico',
                    origin: 'https://oppai-av.com',
                    uri: `/works/detail/${this.bango}`
                },
                Kawaii: {
                    zhushi: 'トップ | 美少女だけのAVメーカー【kawaii*】公式サイト',
                    name: 'kawaii', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://kawaiikawaii.jp/favicons/kawaii/favicon.ico',
                    origin: 'https://kawaiikawaii.jp',
                    uri: `/works/detail/${this.bango}`
                },
                Tameikegoro: {
                    zhushi: 'トップ | Ｓ級熟女のAVメーカー【溜池ゴロー】公式サイト',
                    name: '溜池ゴロー', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://tameikegoro.jp/favicons/tameikegoro/favicon.ico',
                    origin: 'https://tameikegoro.jp',
                    uri: `/works/detail/${this.bango}`
                },
                Dahlia: {
                    zhushi: 'DAHLIA（ダリア）| 配信特化型 新世代AVメーカー',
                    name: 'DAHLIA', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://cdn.faleno.net/top/wp-content/themes/dahlia/common/img/favicon.ico',
                    origin: 'https://dahlia-av.jp/',
                    uri: `/works/${this.bango}`
                },
                片商信息第二排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                Indies: {
                    zhushi: '女優やナンパなどオールジャンルアダルトDVDメーカー桃太郎映像出版',
                    name: '桃太郎映像', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.indies-av.co.jp/wp-content/themes/momo_bs4/img/favicon.ico',
                    origin: 'https://www.indies-av.co.jp',
                    uri: `/title/${this.bango}`
                },
                wanz: {
                    zhushi: 'トップ | 極上のエロス作品が揃ったAV総合商社のAVメーカー【WANZ FACTORY(ワンズファクトリー)】公式サイト',
                    name: 'WANZ', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://wanz-factory.com/favicons/wanz-factory/favicon.ico',
                    origin: 'https://wanz-factory.com',
                    uri: `/works/detail/${this.bango}`
                },
                Attackers: {
                    zhushi: 'トップ | 凌辱、背徳のAVメーカー【ATTACKERS（アタッカーズ）】公式サイト',
                    name: 'ATTACKERS', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://attackers.net/favicons/attackers/favicon.ico',
                    origin: 'https://attackers.net',
                    uri: `/works/detail/${this.bango}`
                },
                Dasdas: {
                    zhushi: 'トップ | マニアック フェチのAVメーカー【ダスッ！】公式サイト',
                    name: 'ダスッ！', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://dasdas.jp/favicons/dasdas/favicon.ico',
                    origin: 'https://dasdas.jp',
                    uri: `/works/detail/${this.bango}`
                },
                Honnaka: {
                    zhushi: 'トップ | 全作品、本物中出しのAVメーカー【本中】公式サイト',
                    name: '本中', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://honnaka.jp/favicons/honnaka/favicon.ico',
                    origin: 'https://honnaka.jp',
                    uri: `/works/detail/${this.bango}`
                },
                Mousouzoku: {
                    zhushi: 'トップページ | AVメガサイト [妄想族] 公式アダルトサイト',
                    name: '妄想族', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.mousouzoku-av.com/favicon.ico',
                    origin: 'https://www.mousouzoku-av.com',
                    uri: `/works/detail/${this.bango}`
                },
                Ebody: {
                    zhushi: 'トップ | すべてのボディが史上最強のAVメーカー【E-BODY（イーボディ）】公式サイト',
                    name: 'E-BODY', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://av-e-body.com/favicons/e-body/favicon.ico',
                    origin: 'https://av-e-body.com',
                    uri: `/works/detail/${this.bango}`
                },
                Dandy: {
                    zhushi: 'DANDY & COSMOS',
                    name: 'DANDY', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'http://www.choi-waru.com/favicon.ico',
                    origin: 'http://www.choi-waru.com',
                    uri: `/${this.fanHao}`
                },
                Maxing: {
                    zhushi: 'DVD販売★マキシング',
                    name: 'MAXING', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.maxing.jp/favicon.ico',
                    origin: 'https://www.maxing.jp',
                    uri: `/shop/search_all.html?q=${this.fanHao}`
                },
                Fanza: {
                    zhushi: 'アダルト通販ショッピング - FANZA通販',
                    name: 'FANZA', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.dmm.co.jp/favicon.ico',
                    origin: 'https://www.dmm.co.jp',
                    uri: `/mono/-/search/=/searchstr=${this.bango}`
                },
                mgstage: {
                    zhushi: 'MGS動画＜プレステージ グループ＞アダルト動画配信サイト',
                    name: 'mgstage', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.mgstage.com/favicon.ico',
                    origin: 'https://www.mgstage.com',
                    uri: `/search/cSearch.php?search_word=${this.fanHao}`
                },
                演员信息: { zhushi: '演员信息类，打开后自行在地址栏修改想要搜的演员', name: '演员', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                Xslist: {
                    zhushi: 'Xslist.org - 健康的宅男偶像專題網站',
                    name: 'Xslist <sub>∞</sub>', bgcolor: '#FAFAD2', color: 'red',
                ...
                wikipedia: {
                    ...
                    name: 'wikipedia', bgcolor: '#FAFAD2', color: 'red',
                ...
                演员8: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                演员9: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                演员10: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                演员11: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                演员12: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
/*                磁力种子: { zhushi: '磁力种子类', name: '磁力', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                ...
                skrbtdo: {
                    zhushi: '磁力站点',
                    name: 'skrbtdo', bgcolor: '#FAFAD2', color: 'green',
                ...
                sukebei: {
                    zhushi: '磁力站点',
                    name: 'sukebei', bgcolor: '#FAFAD2', color: 'red',
                ...
                tokyotosho: {
                    zhushi: '磁力站点',
                    name: 'tokyotosho', bgcolor: '#FAFAD2', color: 'green',
                ...
                kitty: {
                    zhushi: '磁力站点',
                    name: 'kitty', bgcolor: '#FAFAD2', color: 'red',
                ...
                btdig: {
                    zhushi: '磁力站点',
                    name: 'btdig', bgcolor: '#FAFAD2', color: 'red',
                ...
                idope: {
                    zhushi: '磁力站点',
                    name: 'idope', bgcolor: '#FAFAD2', color: 'red',
                ...
                u9a9: {
                    zhushi: '磁力站点',
                    name: 'u9a9', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://u9a9.com/favicon.ico',
                    origin: 'https://u9a9.com',
                    uri: `/?type=2&search=${this.fanHao}`
                },
                磁力第二排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                avmans: {
                    zhushi: '磁力站点 由于站点有的加-有的不加，可自行尝试',
                    name: 'avmans<sup>fc2</sup><sub>∞</sub>', bgcolor: '#FAFAD2', color: 'green',
                ...
                yesjav: {
                    zhushi: '磁力站点',
                    name: 'yesjav', bgcolor: '#FAFAD2', color: 'red',
                ...
                zhongzisou: {
                    zhushi: '种子搜',
                    name: 'ZhongZiSou', bgcolor: '#FAFAD2', color: 'green',
                ...
                anidex: {
                    zhushi: '磁力种子',
                    name: 'anidex', bgcolor: '#FAFAD2', color: 'green',
                ...
                javjunkies: {
                    zhushi: '磁力种子',
                    name: 'javjunkies', bgcolor: '#FAFAD2', color: 'green',
                ...
                projectjav: {
                    zhushi: '磁力种子',
                    name: 'projectjav<sup>fc2</sup><sub>∞</sub>', bgcolor: '#FAFAD2', color: 'green',
                ...
                nextjav: {
                    zhushi: '磁力种子',
                    name: 'nextjav', bgcolor: '#FAFAD2', color: 'green',
                ...
                ijavtorrent: {
                    ...
                    name: 'ijavtorrent', bgcolor: '#FAFAD2', color: 'green',
                ...
                jg0: {
                    ...
                    name: 'jg0', bgcolor: '#FAFAD2', color: 'green',
                    ico: 'https://jg0.net/favicon.ico',
                    origin: 'https://jg0.net',
                    uri: `/av_info/zh/?i=${this.buwei}&is=${this.fanHao}`
                },
                磁力第三排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                // https://search.torrends.to/ADN-322
                torrends: {
                    zhushi: 'torrends。',
                    name: 'torrends', bgcolor: '#FAFAD2', color: 'green',
                ...
                btmet: {
                    zhushi: 'btmet。',
                    name: 'btmet', bgcolor: '#FAFAD2', color: 'green',
                ...
                BT1024: {
                    zhushi: '磁力搜索。',
                    name: '1024bt', bgcolor: '#FAFAD2', color: 'green',
                ...
                clmmm: {
                    zhushi: '磁力妹妹。',
                    name: 'clmmm', bgcolor: '#FAFAD2', color: 'green',
                ...
                u3c3: {
                    zhushi: 'u3c3。',
                    name: 'u3c3', bgcolor: '#FAFAD2', color: 'green',
                ...
                souka: {
                    zhushi: 'souka。',
                    name: 'souka', bgcolor: '#FAFAD2', color: 'green',
                ...
                cilido: {
                    ...
                    name: 'duo6', bgcolor: '#FAFAD2', color: 'green',
                ...
                wuqianra: {
                    zhushi: '吴签磁力 右侧有封面图',
                    name: 'wuqianra', bgcolor: '#FAFAD2', color: 'green',
                    ico: 'https://wuqianhu.top/favicon.ico',
                    origin: 'https://wuqianhu.top',
                    uri: `/search?keyword=${this.fanHao}`
                },
                磁力第三排11: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                磁力第三排12: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                ...
                faleno: {
                    ...
                    name: 'faleno<sup>发</sup>', bgcolor: '#FAFAD2', color: 'red',
                ...
                xhamster: {
                    zhushi: 'xhamster',
                    name: 'xhamster', bgcolor: '#FAFAD2', color: 'green',
                ...
                paycalling: {
                    ...
                    name: 'paycalling', bgcolor: '#FAFAD2', color: 'green',
                ...
                r18: {
                    ...
                    name: 'r18', bgcolor: '#FAFAD2', color: 'red',
                ...
                dmm: {
                    zhushi: 'dmm片花',
                    name: 'dmm<sup>日.代</sup>', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.dmm.co.jp/favicon.ico',
                    origin: 'https://www.dmm.co.jp',
                ...
                avpreview: {
                    ...
                    name: 'avpreview', bgcolor: '#FAFAD2', color: 'green',
                ...
                maxjav: {
                    zhushi: 'maxjav',
                    name: 'maxjav', bgcolor: '#FAFAD2', color: 'green',
                ...
                jav9999: {
                    zhushi: 'jav9999',
                    name: 'jav9999', bgcolor: '#FAFAD2', color: 'green',
                ...
                javspyl: {
                    zhushi: 'javspyl推荐片花',
                    name: 'javspyl', bgcolor: '#FAFAD2', color: 'green',
                    ico: '',
                    origin: 'https://javspyl.tk',
                    uri: `/${this.fanHao}`
                },
                 在线观看: { zhushi: '在线观看类', name: '在线', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                mmtv: {
                ...
                在线第二排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                supjav: {
                ...
                在线第三排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                ggjav: {
                ...
                在线第四排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                javfc2: {
                    zhushi: '在线观看',
                ...
                在线第五排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                japanhub: {
                ...
                在线第六排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                javcc: {
                    zhushi: 'javcc 在线观看',
                ...
                在线第七排0: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                huangboav: {
                ...
                在线第八排1: { zhushi: '', name: '', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                porn78: {
                ...
                资讯: { zhushi: '中文简介 资讯等', name: '资讯', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                uuribao: {
                    zhushi: '番号 相关资讯类',
                    name: 'uuribao', bgcolor: '#FAFAD2', color: 'red',
                ...
                uuribao2: {
                    ...
                    name: 'uuribao演员', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://uuribao.net/wp-content/uploads/2021/10/848357745020e39-150x150.jpg',
                    origin: 'https://uuribao.net',
                ...
                xcity: {
                    zhushi: 'xcity ',
                    name: 'xcity', bgcolor: '#FAFAD2', color: 'green',
                ...
                fc2ppv: {
                    zhushi: 'fc2ppv ',
                    name: 'fc2ppv', bgcolor: '#FAFAD2', color: 'green',
                    ico: 'https://fc2ppv.org/storage/1.jpg',
                    origin: 'https://fc2ppv.org',
                    uri: `/search?q=${this.fanHao}`
                },
                资讯第一排6: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                资讯第一排7: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                资讯第一排8: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                资讯第一排9: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                资讯第一排10: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                资讯第一排11: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                大缩略图: { zhushi: '大缩略图', name: '缩图', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                javstore: {
                ...
                memojav: {
                    zhushi: '在线观看 大缩略图  推荐',
                    name: 'memojav', bgcolor: '#FAFAD2', color: 'green',
                ...
                blogjav: {
                    ...
                    name: 'blogjav', bgcolor: '#FAFAD2', color: 'green',
                ...
                javbest: {
                    ...
                    name: 'javbest', bgcolor: '#FAFAD2', color: 'green',
                ...
                maddawgjav: {
                    ...
                    name: 'maddawgjav', bgcolor: '#FAFAD2', color: 'green',
                ...
                t2jav: {
                    zhushi: 't2jav',
                    name: 't2jav<sup>fc2</sup>', bgcolor: '#FAFAD2', color: 'red',
                ...
                xplanet: {
                    zhushi: '3xplanet',
                    name: '3xplanet<sup>fc2</sup>', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://3xplanet.com/wp-content/uploads/2022/09/3xfavicon.png',
                    origin: 'https://3xplanet.com',
                    uri: `/?s=${this.fanHao}`
                },
                大缩略图第一排9: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                大缩略图第一排10: { zhushi: '', name: '', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                大缩略图第一排11: { zhushi: 'HDPoster', name: 'HD Poster', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://awsimgsrc.dmm.co.jp/dig_white/digital/video', uri: `/${this.buwei.toLowerCase()}/${this.buwei.toLowerCase()}ps.jpg` },
                大缩略图第一排12: { zhushi: 'HDCover', name: 'HD Cover', bgcolor: '#FAFAD2', color: '#00a2e8', ico: '', origin: 'https://awsimgsrc.dmm.co.jp/dig_white/digital/video', uri: `/${this.buwei.toLowerCase()}/${this.buwei.toLowerCase()}pl.jpg` },*/
                在线观看: { zhushi: '在线观看类', name: '在线', bgcolor: '', color: '#00a2e8', ico: '', origin: 'https://sleazyfork.org/zh-CN/scripts/494871-myonejavoneweb', uri: `` },
                javtrailers: {
                    zhushi: 'javtrailers预览',
                    name: 'javtrailers预览', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://javtrailers.com/favicon.ico',
                    origin: 'https://javtrailers.com',
                    uri: `/ja/search/${this.fanHao}`
                },
                supjav: {
                    zhushi: 'supjav在线观看',
                    name: 'SUPJAV', bgcolor: '', color: 'red',
                    ico: 'https://supjav.com/favicon.ico',
                    origin: 'https://supjav.com',
                    uri: `/zh/?s=${this.fanHao}`
                },
                evojav: {
                    zhushi: 'evojav在线观看',
                    name: 'Evojav', bgcolor: '', color: 'red',
                    ico: 'https://evojav.pro/favicon.ico',
                    origin: 'https://evojav.pro',
                    uri: `/zh/?s=${this.fanHao}`
                },
                sextb: {
                    zhushi: 'sextb在线观看',
                    name: 'SEXTB', bgcolor: '#FAFAD2', color: 'green',
                    ico: 'https://sextb.net/favicon.ico',
                    origin: 'https://sextb.date',
                    uri: `/search/${this.fanHao}`
                },
                mmtv: {
                    zhushi: '7mmtv在线观看',
               ...
               missav: {
                    zhushi: 'missav 在线观看',
                    name: 'missav', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://missav.ws/favicon.ico',
               ...
               iqqtv: {
                    zhushi: 'iqqtv',
                    name: 'iqqtv', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://iqqtv.net/favicon.ico',
                    origin: 'https://iqqtv.net',
                    uri: `/cn/search.php?kw_type=key&kw=${this.fanHao}`
                },
               google: {
                    zhushi: 'google',
                    name: 'google', bgcolor: '#FAFAD2', color: 'red',
                    ico: 'https://www.google.com/favicon.ico',
                    origin: 'https://www.google.com',
                    uri: `/search?q=${this.fanHao}+jav`
                },
            };
        ...
        create_table(position = 0) {
            ...
            htmlTable += `<tbody><tr><td colspan="${rows-1}" align="left"><a style="padding-left:5px;" href="https://image.memojav.com/image/screenshot/${this.fanHao}.jpg"  onMouseOver="document.getElementById('img_1').style.display = 'block'" target="_blank"><b><font color='green'>查看 大缩略图</font></b></a><img id="img_1" src="https://image.memojav.com/image/screenshot/${this.fanHao}.jpg" style="display:none" onclick="document.getElementById(\'img_1\').style.display=\'none\';">&nbsp;&nbsp;<span style='font-size:9px;font-family:MingLiU;'>车牌信息、演员信息、磁力种子、片花、在线观看、资讯、大缩略图&nbsp;&nbsp;<font color='green'>绿色</font>:免番羽&nbsp;&nbsp;<font color='red'>红色</font>:需番羽&nbsp;&nbsp;直：请直连Direct&nbsp;&nbsp;演员请自行修改</span></td><td style="background-color:none;"><font color='black'>${this.fanHao}</font></td></tr></tbody>`;
    ...
    /* 98堂 */
    if (document.title.indexOf("高清中文字幕") > 0 || document.title.indexOf("亚洲有码原创") > 0 || document.title.indexOf("亚洲无码原创") > 0 || document.title.indexOf("4K原版") > 0 || document.title.indexOf("素人有码系列") > 0 || document.title.indexOf("综合讨论区") > 0 || document.title.indexOf("转帖交流区") > 0 || document.title.indexOf("PPV") > 0 && document.title.indexOf("色花堂") > 0) {
        var regexBango = /([a-zA-Z]{2,12})-?(\d{2,12})/i;
        var regexFC2 = /FC2-?P?P?V?-?_?(\d+)/i;
        if ( regexBango.test(document.getElementById("thread_subject").innerHTML) )
        {
            const bango = document.getElementById("thread_subject").innerHTML.match(regexBango)[0];
            const jav = new JAV(bango);
            document.querySelector("#pgt").innerHTML = jav.create_table(1);
        }
        else if ( regexFC2.test(document.getElementById("thread_subject").innerHTML) )
        {
            const bango = document.getElementById("thread_subject").innerHTML.match(regexFC2)[0];
            const jav = new JAV(bango);
            document.querySelector("#pgt").innerHTML = jav.create_table(1);
        }
