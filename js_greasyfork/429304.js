// ==UserScript==
// @name        EbayReportHellfest
// @description Quick report of hellfest ticket on ebay
// @include     https://www.ebay.fr/itm/*
// @grant       GM_addStyle
// @version 0.0.1.20210713124306
// @namespace https://greasyfork.org/users/793151
// @downloadURL https://update.greasyfork.org/scripts/429304/EbayReportHellfest.user.js
// @updateURL https://update.greasyfork.org/scripts/429304/EbayReportHellfest.meta.js
// ==/UserScript==
...
for (var i = 0; i <= len - 1; i++) {
    ...
    const regex = /https:\/\/contact\.ebay\.fr\/ws\/eBayISAPI\.dll\?ShowCoreAskSellerQuestion&redirect=0&requested=(.*?)&iid=([0-9]*)/gm;
    const str = `https://contact.ebay.fr/ws/eBayISAPI.dll?ShowCoreAskSellerQuestion&redirect=0&requested=matmar2314&iid=283801681720`;
    let m;
    ...
    while ((m = regex.exec(b)) !== null) {
        ...
        m.forEach((match, groupIndex) => {
            ...
            if(groupIndex == 1) vendor_name = match;
            if(groupIndex == 2) product_id = match;
        });
    }
