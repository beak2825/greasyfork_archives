// ==UserScript==
// @name         For guidance by Kokojambo [Кураторы/ЗГА/ГА]
...
// @downloadURL https://update.greasyfork.org/scripts/470662/For%20guidance%20by%20Kokojambo%20%5B%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%D0%97%D0%93%D0%90%D0%93%D0%90%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/470662/For%20guidance%20by%20Kokojambo%20%5B%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%D0%97%D0%93%D0%90%D0%93%D0%90%5D.meta.js
// ==/UserScript==
...
const buttons = [
...

    {
        ...
        content:
        	...
        	'[Color=Magenta][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
	"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
		...
		"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
        '[Color=Magenta][CENTER][B]С уважением администрация Choco .[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
...
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
      ...
      "[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
        "[COLOR=Magenta][CENTER][B]С уважением администрация Choco[/CENTER][/B][/COLOR]",
...
'[Color=white][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]'+
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
	"[CENTER][B][COLOR=Magenta]С уважением администрация Choco [/B][/CENTER][/COLOR]",
      prefix: PIN_PREFIX,
...
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
	...
	"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
		...
		"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
            '[Color=Magenta][CENTER][B]Закрыто.[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
        {
	...
	},
    {
        ...
        "[B][CENTER]Ваш аккаунт будет разблокирован на 24 часа, за это время вам необходимо изменить свой nickname. Доказательства прикрепить в данной теме.[/B][/CENTER]"+
        	"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
        '[B][COLOR=Magenta][CENTER] С уважением администрация Choco [/B][/CENTER][/COLOR]',
        prifix: PIN_PREFIX,
        status: true,
    },
...
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
		'[Color=Magenta][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]',
...
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
	...
	},
    {
	  ...
	  content:
		...
		'[Color=Magenta][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
		"[B][CENTER]Ваша жалоба будет передана Главной Администрации на рассмотрение.[/CENTER][/B]<br><br>" +
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
		'[Color=Magenta][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]',
...
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
	  ...
	  status: true,
	...
	},
       {
        ...
        "[B][CENTER][COLOR=Magenta]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]<br><br>" +
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +		
"[B][CENTER]Запрошу доказательства у данного администратора.[/CENTER][/B]<br><br>" +
"[CENTER] [url=https://postimages.org/][img]https://i.postimg.cc/rmpZT9bX/Pics-Art-07-12-03-23-18.png[/img][/url][/CENTER]" +
        '[Color=Magenta][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]',
	  prefix: PIN_PREFIX,
	  status: true,
