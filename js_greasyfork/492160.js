...
// @name            The Journal Downloader - l'Echo
// @match           https://journal.lecho.be/data/*/reader/reader.html*
// @grant           GM_getValue
// @grant           GM_setValue
...
// @license         Free
// @version         1.0
// @description     Télécharger les pages du journal l'Echo en PDF en un clique
// @run-at          document-end
// @require         https://unpkg.com/pdf-lib@1.17.1/dist/pdf-lib.min.js
// @downloadURL https://update.greasyfork.org/scripts/492160/The%20Journal%20Downloader%20-%20l%27Echo.user.js
// @updateURL https://update.greasyfork.org/scripts/492160/The%20Journal%20Downloader%20-%20l%27Echo.meta.js
// ==/UserScript==
...
createFetchResponseInterceptor(async ({
    ...
    if(url.startsWith('https://mfn-ech-production-api.twipecloud.net/GetDownloadCredentials')){
  ...
  if (url.startsWith('https://mfn-ech-production-api.twipecloud.net/Data/DataService.svc/GetContentPackageInfo')) {
        console.log(data)
        ...
        GM_setValue('name', `l.Echo_${region}_${formattedDate}.pdf`);
      }
  });
})();
