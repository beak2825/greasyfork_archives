...
// @include         https://fb.trophymanager.com/club/*/squad/*
// @license         MIT
// @downloadURL https://update.greasyfork.org/scripts/474803/%E8%AF%A6%E7%BB%86%E8%AF%84%E5%88%86.user.js
// @updateURL https://update.greasyfork.org/scripts/474803/%E8%AF%A6%E7%BB%86%E8%AF%84%E5%88%86.meta.js
// ==/UserScript==
...
$("#player_table tr > .text_fade > div").not(".text_fade_overlay").find("a[player_link]").each(function () {
    ...
    var R5FP2 = -1;
    if (skills.length == 11) {
        R5FP = funFix2(ratingR5 * 1 + allBonus * 1);
    } else {
    ...
    if (fp2 != -1 && fp2 != fp) {
        if (skills.length == 11) {
            R5FP2 = funFix2(ratingR52 * 1 + allBonus * 1);
        } else {
            R5FP2 = funFix2(ratingR52 * 1 + allBonus * 1 + posGain[fp2] * 1 + posKeep[fp2] * 1);
        }
    }
    var color1 = "gray";
    switch (Math.floor((Math.max(R5FP,R5FP2) - 40) / 5)) {
        case 15: color1 = "BlueViolet"; break;
        case 14: color1 = "BlueViolet"; break;//130
        case 13: color1 = "BlueViolet"; break;
        case 121: color1 = "BlueViolet"; break;//120
        case 11: color1 = "BlueViolet"; break;
        case 10: color1 = "BlueViolet"; break;//110
        case 9: color1 = "Purple"; break;
        case 8: color1 = "Purple"; break;//100
        case 7: color1 = "DarkRed"; break;
        case 6: color1 = "DarkRed"; break;//90
        case 5: color1 = "Orange"; break;
        case 4: color1 = "Orange"; break;//80
        case 3: color1 = "Gold"; break;
        case 2: color1 = "Yellow"; break;//70
        case 1: color1 = "Khaki"; break;
        case 0: color1 = "White"; break;//60
    }
    if( R5FP2 != -1){
        R5FP= R5FP + '/' + R5FP2;
    }
    ...
    parent_select.find("td:eq(7)").after('<td style="text-align:center;color:'+color1+';padding: 0 5px 0 5px;">'+R5FP+'</td>');
