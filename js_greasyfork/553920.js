...
// @downloadURL https://update.greasyfork.org/scripts/553920/%D0%A2%D0%95%D0%A1%D0%A2%20%D0%A1%D0%9A%D0%A0%D0%98%D0%9F%D0%A2.user.js
// @updateURL https://update.greasyfork.org/scripts/553920/%D0%A2%D0%95%D0%A1%D0%A2%20%D0%A1%D0%9A%D0%A0%D0%98%D0%9F%D0%A2.meta.js
// ==/UserScript==
 
(function () {
'esversion 6' ;
...
},
{
    ...
    content:
          '[CENTER][FONT=Verdana][SIZE=4][COLOR=#FFD700]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> [COLOR=#D4AF37]{{ user.mention }}[/COLOR].[/SIZE]<br><br>' +
          '[img]https://i.postimg.cc/MTK8CnN1/2c4f6b93a412c9f4348290d4baabdaf9.png[/img]<br><br>' +
          '[SIZE=4][COLOR=#FFA500]▪ Нарушитель будет наказан по пункту правил:[/COLOR][/SIZE][QUOTE][SIZE=4][COLOR=#FF0000]2.55.[/COLOR] [COLOR=#E5E5E5]Запрещено создавать никнейм, повторяющий или похожий на существующие никнеймы игроков или администраторов по их написанию [COLOR=rgb(255, 0, 0)]| Устное замечание + смена игрового никнейма / PermBan.[/COLOR]<br><br>' +
