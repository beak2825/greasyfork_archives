...
// @license MIT
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/449748/Scratch%20Random%20Brute.user.js
// @updateURL https://update.greasyfork.org/scripts/449748/Scratch%20Random%20Brute.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    function genUser() {
        var text = "";
        var possible = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz" + ((containsNumbers) ? "1234567890" : "") + ((contains_) ? "________" : "") + ((containsdash) ? "--------" : "");
