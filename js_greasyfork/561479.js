// ==UserScript==
// @name         Hxdes's Mod Menu (LITE) V1.5
// @namespace    http://tampermonkey.net/
// @version      1.5
// @description  Auto-Builds (Glass/Ram/Meta), 101+ Themes, Dynamic Rainbow Mode, Custom SVG Crosshairs, Numeric HP, and Anti-AFK. Press [R] for Menu.
// @author       Hxdes
...
// @run-at       document-end
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/561479/Hxdes%27s%20Mod%20Menu%20%28LITE%29%20V15.user.js
// @updateURL https://update.greasyfork.org/scripts/561479/Hxdes%27s%20Mod%20Menu%20%28LITE%29%20V15.meta.js
// ==/UserScript==
...
(function() {
    ...
    style.innerHTML = `
        ...
        #afk-top-indicator { left: 50%; transform: translateX(-50%); }
    `;
    ...
    const initMenu = () => {
        ...
        menu.innerHTML = `
            <div id="drag-header" style="text-align:center; font-weight:900; padding:15px; font-size:20px; color:#00b2e1; cursor:move; user-select:none; letter-spacing:2px; background: rgba(0,0,0,0.3); flex-shrink: 0;">HXDES MOD MENU V1.5 (LITE)</div>
            <div style="display:flex; width:100%; flex-shrink: 0;">
                ...
                <button id="tab-afk" class="tab-btn">ANTI-AFK</button>
            ...
            <div id="menu-content" style="padding: 20px; flex: 1; display: flex; flex-direction: column; overflow: hidden;">
                ...
                <div id="pane-afk" style="display: none; flex-direction: column; overflow-y: auto;">
                    <div class="sec-header">HUD Indicators</div>
                    <button id="afk-tog-ui-btn" class="btn-toggle" style="width:100%; margin-bottom:15px;">SHOW ANTI-AFK UI</button>
        ...
        const tabs = { 'tab-main': 'pane-main', 'tab-themes': 'pane-themes', 'tab-afk': 'pane-afk', 'tab-info': 'pane-info' };
        ...
        setTimeout(() => { const overlay = document.createElement('div'); overlay.className = 'hxdes-intro-overlay'; overlay.innerHTML = `<div class="hxdes-text hxdes-welcome">Welcome to Hxdes's Mod Menu (LITE)</div><div class="hxdes-text hxdes-subtext">Press [ R ] to Toggle Menu</div>`; document.body.appendChild(overlay); setTimeout(() => overlay.remove(), 5500); }, 100);
    };
    ...
    window.addEventListener('mousemove', (e) => { mouseX = e.clientX; mouseY = e.clientY; }, true);
