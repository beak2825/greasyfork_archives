...
// @name         Oltosuper Shell Shockers Theme
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/454750/Oltosuper%20Shell%20Shockers%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/454750/Oltosuper%20Shell%20Shockers%20Theme.meta.js
// ==/UserScript==
...
* {
	...
	--ss-black: #000;
	--ss-white: #fcfeff; /*White Text*/
	--ss-offwhite: #FFF3E4;
	--ss-yellow0:#F7FFC1;
	--ss-yellow: #FAF179;
	--ss-yolk0: #f1c59a;
	--ss-yolk: #070807; /*Yellow Buttons*/
	--ss-yolk2: #d97611;
	--ss-red0: #e29092;
	--ss-red: #d15354;
	--ss-red2: #801919;
	...
	--ss-blue1: #95E2FE;
	--ss-blue2: #5EBBD9;
	--ss-blue3: ##070807; /*Lighter Box Borders*/
	--ss-blue4: ##070807; /*Blue Subtitles, Darker Box Borders*/
	--ss-blue5: #0a5771;
	--ss-green0: #87ddbb;
	--ss-green1: #3ebe8d;
	--ss-green2: #2a7256;
	...
	--ss-lightoverlay: linear-gradient(#4efc65, #26ff43, #02fa23, #04d620, #05b51d, #038714); /*Main Background*/
	--ss-lightbackground: linear-gradient(var(--ss-blue1), var(--ss-blue2));
	--ss-blueblend1: linear-gradient(#349ec1, #08ff29); /*Some Box fill colors*/
