...
// @namespace    
// @downloadURL https://update.greasyfork.org/scripts/516162/%E5%BF%85%E5%BA%94%E6%AF%8F%E6%97%A5%E4%BB%BB%E5%8A%A1%E8%84%9A%E6%9C%AC%E5%8F%AF%E5%AE%9A%E6%97%B6%E8%AE%BE%E7%BD%AE.user.js
// @updateURL https://update.greasyfork.org/scripts/516162/%E5%BF%85%E5%BA%94%E6%AF%8F%E6%97%A5%E4%BB%BB%E5%8A%A1%E8%84%9A%E6%9C%AC%E5%8F%AF%E5%AE%9A%E6%97%B6%E8%AE%BE%E7%BD%AE.meta.js
// ==/UserScript==
...
function exec() {
    ...
    function scheduleFunction() {
        const now = new Date();
        const targetHour = 11; // 目标时间的小时（24小时制）
        const targetMinute = 17; // 目标时间的分钟

        // 计算今天的目标时间
        const targetTime = new Date();
        targetTime.setHours(targetHour, targetMinute, 0, 0);

        // 如果目标时间已经过去，则设定为明天的目标时间
        if (now > targetTime) {
        ...
        setTimeout(() => {
            myScheduledFunction();
            // 继续每天触发
            setInterval(myScheduledFunction, 24 * 60 * 60 * 1000); // 每24小时执行
        }, timeout);
    }
// 调用调度函数
    scheduleFunction();
