...
var ADKeywords = ['总结', '[写周报]', '[推广]', '[投资]', '[VXNA]', '[Faucet]', '[PRO]', '[Solana]', '万 0.85 免 5', '万 0.85 免五', '万 0.5 免五', '免 5', '免五', '免七', '生日', '靓号', 'XXL-', 'Pagespy', '老兵', '龟男', '龟龟', '🐢', '女朋友', '老婆', '女方', '岳父' ,'丈母娘'].map(item => item.toLowerCase());
setInterval(() => {
