// ==UserScript==
// @name        Mug Faster, Jump Higher!Melee
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/425360/Mug%20Faster%2C%20Jump%20Higher%21Melee.user.js
// @updateURL https://update.greasyfork.org/scripts/425360/Mug%20Faster%2C%20Jump%20Higher%21Melee.meta.js
// ==/UserScript==
...
(function() {
    ...
    waitForKeyElements('#attacker',() => {
        ...
        let melee_btn = document.getElementById('weapon_melee');
        ...
        melee_btn.addEventListener("click", function() {
            $('#weapon_temp').hide();
        });
