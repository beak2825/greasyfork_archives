...
// @version     1.0.4
// @description 更新间隔抢课
// @original_author      realhuhu
// @updated_author     five20
// @license     MIT
...
// @date       2023/09/10
// @downloadURL https://update.greasyfork.org/scripts/474996/%E4%B8%9C%E5%8D%97%E5%A4%A7%E5%AD%A6%E6%8A%A2%E8%AF%BE%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/474996/%E4%B8%9C%E5%8D%97%E5%A4%A7%E5%AD%A6%E6%8A%A2%E8%AF%BE%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
async  enroll() {
  ...
  const interval = 375; // 请求之间的间隔时间（单位：毫秒）

  let index = 0; // 当前请求的索引

  while (key_list.length>0) {
    if(index===key_list.length)index=0;
    ...
    let type = res.data.code === 200 ? "success" : "warning";
    tip({
      type,
