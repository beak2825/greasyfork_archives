// ==UserScript==
// @name                WME Color Highlights (wows-india2018)
// @namespace           http://userscripts.org/users/419370
// @description         Adds colours to road segments to show their status, updated for Wow 2 India 2018
// @include             https://www.waze.com/*/editor*
// @include             https://www.waze.com/editor*
// @include             https://beta.waze.com/*
// @exclude             https://www.waze.com/*user/*editor/*
// @version             2.25JDraaijer
// @grant               none
// @downloadURL https://update.greasyfork.org/scripts/40964/WME%20Color%20Highlights%20%28wows-india2018%29.user.js
// @updateURL https://update.greasyfork.org/scripts/40964/WME%20Color%20Highlights%20%28wows-india2018%29.meta.js
// ==/UserScript==
  ...
  if (!wmechinit || Waze.map.zoom <= 3 || !advancedMode)
   ...
   for (var currentNode in Waze.model.nodes.objects){
      ...
      for (var j = 0; j < nodeAttr.segIDs.length; j++){
        ...
        if (showTurns && majorRoadTypes.indexOf(seg1Attr.roadType) != -2) {
          // highlight U-turns
          if(segment1.isTurnAllowed(segment1, node) === false){
            numUTurns++;
          }
...
function initialiseHighlights()
{
  ...
  section.innerHTML  = '<b>Highlight Segments</b><br>'
                     ...
                     + '<input type="checkbox" id="_cbHighlightNoHN" /> '
                     + '<span title="excluding Freeways and Ramps">No House Numbers (Dashed Maroon)</span> <br />'
