...
// @updateVersion 13
// @downloadURL https://update.greasyfork.org/scripts/5148/Steam%20Extra%20Profile%20Links.user.js
// @updateURL https://update.greasyfork.org/scripts/5148/Steam%20Extra%20Profile%20Links.meta.js
// ==/UserScript==
...
$(document).ready(function () {
	...
	function extraProfileLinks(xmlPage) {
		...
		var link_02_03 = "<a title=\"TF2Outpost.com Backpack\" href=\"http://www.tf2outpost.com/backpack/" + selProfileSid64 + "\">Backpack</a>";
		var link_02_04 = "<a title=\"TF2Outpost.com Profile\" href=\"http://www.tf2outpost.com/user/" + selProfileSid64 + "\">Profile</a>";
		var link_02_05 = "<a title=\"bazaar.tf Backpack\" href=\"http://bazaar.tf/backpack/" + selProfileSid64 + "\">Backpack</a>";
		var link_02_06 = "<a title=\"bazaar.tf Profile\" href=\"http://bazaar.tf/profiles/" + selProfileSid64 + "\">Profile</a>";
		var link_02_07 = "<a title=\"TF2 Trading Post Profile\" href=\"http://tf2tp.com/user/" + selProfileSid64 + "\">TF2 Trading Post Profile</a>";
		var link_02_08 = "<a title=\"TF2 Backpack Examiner\" href=\"http://www.tf2items.com/profiles/" + selProfileSid64 + "?p=all\">TF2 Backpack Examiner</a>";
		var link_02_09 = "<a title=\"TF2B - TF2\" href=\"http://tf2b.com/tf2/" + selProfileSid64 + "\">TF2</a>";
		var link_02_10 = "<a title=\"TF2B - DOTA2\" href=\"http://tf2b.com/d2/" + selProfileSid64 + "\">DOTA2</a>";
		var link_02_11 = "<a title=\"TF2B - CSGO\" href=\"http://tf2b.com/csgo/" + selProfileSid64 + "\">CSGO</a>";
		var link_02_12 = "<a title=\"TF2B - Portal 2\" href=\"http://tf2b.com/p2/" + selProfileSid64 + "\">Portal 2</a>";
		...
		var link_05_01 = "<a title=\"CSGO Lounge\" href=\"http://csgolounge.com/profile?id=" + selProfileSid64 + "\">CSGO Lounge</a>";
		...
		linkDiv.append($("<div>TF2Outpost: " + link_02_03 + " | " + link_02_04 + "</div>"));
		linkDiv.append($("<div>bazaar.tf: " + link_02_05 + " | " + link_02_06 + "</div>"));
		linkDiv.append($("<div>" + link_02_07 + "</div><div>" + link_02_08 + "</div>"));
		linkDiv.append($("<div>TF2B: " + link_02_09 + " | " + link_02_10 + " | " + link_02_11 + " | " + link_02_12 + "</div>"));
		linkDiv.append($("<div>" + link_01_03 + " | " + link_01_04 + "</div>"));
		linkDiv.append($("<div>" + link_02_13 + " | " + link_05_01 + "</div>"));
		linkDiv.append($("<hr>"));
