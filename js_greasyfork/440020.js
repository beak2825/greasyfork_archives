...
// @description:en   In-game communication in the popular browser game Diep.io
// @version          1.0
// @author           ๖ۣۣۜMist
// @match            https://diep.io/
...
// @grant            none
// @downloadURL https://update.greasyfork.org/scripts/440020/Diepio%20%D0%A7%D0%B0%D1%82.user.js
// @updateURL https://update.greasyfork.org/scripts/440020/Diepio%20%D0%A7%D0%B0%D1%82.meta.js
// ==/UserScript==
...
`;
			...
			if ($("#textInput").is(":visible")) {
				if (open) {
					...
					$("#chat").append(`
                        ...
                        <strong><a style="color: red;" href="https://greasyfork.org/ru/scripts/440020">Главная страница DIEP.io Chat!</a></strong>
						</div>
					`).scrollTop(1000000);
                  open = false;
                };
	...
	$("body").on("keydown", function(e) {
		...
		if (e.key === localStorage.getItem('settings_HideAndShow_menu') && elem != 'message_input') {
		...
		if (e.key === localStorage.getItem('settings_HideAndShow_window') && elem != 'message_input') {
