...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/551418/JMIDIPlayer.user.js
// @updateURL https://update.greasyfork.org/scripts/551418/JMIDIPlayer.meta.js
// ==/UserScript==
...
const styles = `
  .jmidi-player-window {
    ...
    font-size: 14px;
    z-index: 850; /* mpp chat is 900 when active, cursors are 800, piano is 400 */
    display: none;
...
const NPS_BUFFER_SIZE = 1 << 20; // max 1M notes, 4MiB buffer
