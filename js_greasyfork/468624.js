...
// @version      1.0.0
// @description  可自定义学校前缀，长江雨课堂适用，黄河雨课堂需手动点击视频。感谢曦月大佬
// @author       bohong65
// @license      MIT
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/468624/%E8%87%AA%E7%94%A8%E5%88%B7%E8%AF%BE.user.js
// @updateURL https://update.greasyfork.org/scripts/468624/%E8%87%AA%E7%94%A8%E5%88%B7%E8%AF%BE.meta.js
// ==/UserScript==

(function () {
    'use strict';
const fronted = "acgecfd"
//自定义前缀
    // 插入html元素
    const html = `<style>
    .xy_main{
...
<div class="learing-iframe-box">
    ...
    function answerQuestions() {
        ...
        const ansUrl = `https://${fronted}.yuketang.cn/mooc-api/v1/lms/exercise/problem_apply/?term=latest&uv_id=${universityId}`
        ...
        function startLears(arr) {
            ...
            arr.forEach(el => {
                if (isLearArr.find(i => i.id === el.id) === undefined) {
                    ...
                    if (el.leaf_type === 6) {
                        tempIFrame.src = `https://${fronted}.yuketang.cn/pro/lms/${app.$data.sign}/${app.$data.classroom_id}/homework/${el.id}`
                    } else {
                        tempIFrame.src = `https://${fronted}.yuketang.cn/pro/lms/${app.$data.sign}/${app.$data.classroom_id}/video/${el.id}`
                    }
