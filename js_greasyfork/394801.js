...
let css = `
  ...
  BODY, .iogc-GameWindow, .iogc-SidePanel-inner, #outside, .summary, .hmenu, #profile h3 span, P {background-color: transparent!important;}
  ...
  .cf-section.cf-highlight.cf-status-display, .my-8.bg-gradient-gray {background: #2F4550!important;}
  ...
  .iogc-BonusProgress, .summary, .menu2, .iogc-tourny-odd {background-color: #273942!important;}  
...
/*   .iogc-NewButton-white {background: linear-gradient(#F0FFF0, #DCDCDC) repeat scroll 0 0 transparent!important;} */
  ...
  .iogc-SidePanel-inner {border: 2px solid #273942!important;} 
  ...
  .iogc-ChangeTableDialog-tile, .iogc-GameWindow-layout {border-color: #121A1E!important;}
  ...
  .statLine TD, #profile h3 .line {border-color: #273942!important;}
  ...
  DIV[style="border-bottom:2px dotted #ddd;margin:10px 0;"] {border-bottom-color: #273942!important;}
  ...
  DIV[style="border-top:3px solid #CCC"], #forum .header, .iogc-SidePanel-inner, .list-item {border-top-color: #273942!important;}
