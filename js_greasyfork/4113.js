...
// @version       1.1.6
// @downloadURL https://update.greasyfork.org/scripts/4113/KOL%20Consumption%20Tracker.user.js
// @updateURL https://update.greasyfork.org/scripts/4113/KOL%20Consumption%20Tracker.meta.js
// ==/UserScript==
	...
	function buildTickler(build)
	{
		...
		switch (build)
		{
			case 1:
				...
				alert.appendChild(CE('a', 'text|Download new version of ' + SCRIPT_NAME, 'href|https://userscripts-mirror.org/scripts/source/96897.user.js', 'target|_blank'));
			break;
			case 0:
