// ==UserScript==
// @name AudioBookBay hide category: Doctor Who
// @description Hide Doctor Who category
...
// @downloadURL https://update.greasyfork.org/scripts/484548/AudioBookBay%20hide%20category%3A%20Doctor%20Who.user.js
// @updateURL https://update.greasyfork.org/scripts/484548/AudioBookBay%20hide%20category%3A%20Doctor%20Who.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact phrase 'Doctor Who'
    $(".post").has(".postInfo:contains('Doctor Who')").hide();
});
