...
// @downloadURL https://update.greasyfork.org/scripts/18188/InfoCompte_lang.user.js
// @updateURL https://update.greasyfork.org/scripts/18188/InfoCompte_lang.meta.js
// ==/UserScript==
	...
	var infocompte_text = 
	{
		...
		se : {  
			...
			Mines:'Gruvor', Other_structure:'Andrabyggnader', Structure:'Byggnader', 
			Technology:'Teknologi', Fleet:'Flotta', Defense:'Förs', 
			Progression:'Genomsnitt', Moyenne:'Tillvä;xt', Production:'Resursproduktion', 
			Indestructible:'Indestructible', Depuis:'sen', Points:'Poä;ng', 
			level:'level', dispo:'tillg', rank:'rank', VueGe:'Overview', soit:'representerar', 
			BBcode_debut:"Poä;ngdetaljer:", BBcode_debut2:"Totalapoä;ng:", 
			BBcode_mine:"Poä;ngigruvor:", BBcode_bat:"Poä;ngiö;vrigabyggnader:", 
			BBcode_batT:"Totalapoä;ngibyggnader:", BBcode_fin1:"Poä;ngiteknologi:", 
			Bcode_fin2:"Poä;ngiflotta:", BBcode_fin3 : "Poä;ng i fö;rs :", 
			BBcode_fin4 : "Ditt konto har ", BBcode_fin5 : "ofö;rstö;rbara poä,ng", 
			BBcode_fin6 : "Genomsnittlig tillvä;xt : ", Point_day : "Poä;ng per dag", 
			sur_lune:'på;må;ne', en_vol:'flygande', 
			Avertissement :'OBS! Detta kommer reseta allt!', restart : 'Click to restart your progresscount', 
			AffBBcode : 'klicka fö;r att få; BBcode', 
			done :'Klart! Uppdatera sidan!', ICoption : 'InfoCompte\'s instä;llningar', 
			
			options:{ 
			
				Graphiccolours :'Graf fä;rger (fyll i fö;r olika fä;rger i fä;lten)', 
				BatTotal :'Visa totala poä;ngen fö;r byggnader', indestructible :'Visa ofö;rstö;rbara poä;ng', techno :'Visa poä;ngen fö;r teknologi', 
				flottes :'Visa poä,ngen fö;r flottan', Def :'Visa poä;ngen fö;r fö;rset', VaisseauxVol :'Visa procent av flottan i rörelse', 
				pointLune :'Visa poängen för månar', sauterLignePourPourcentageFlotteVol :'Visa allt i samma fält (för flott rörelser och månpoäng)', 
				progression :'Visa tillväxt', PlusieurSurMemeUni :'Tryck i om det är fler än en spelare på samma dator som spelar i samma universum', 
				couleurPoint :'Visa färger i poängen för tillväxt', ProgJours :'Visa tillväxt per dag', ProdJours :'Visa poäng intjänat från gruvor', 
				Techno_utile :"Show technology' details", Point_planete :'Visa investerat punkter på jorden4', Masquer :"Hide the table of InfoCompte by default", 
				progNeg: 'Bad progression\'s color', 
				progPos : 'Good progression\'s color' 
			
			}, 
			
			Save:'Spara Ändringar', valeurdefaut : 'Standard', 
			Manque:'you need to visite these pages :', pas_a_jours :'There is an update available : ', install : 'click to install it', 
			planet_number :'Planet numbers', utile : 'useful', inutile :'useless', BBcode_fin42 :"Your useless technology representing ", 
		...
		fi :  { tag:{}, Mines:'Kaivokset', Other_structure:'Muutrakennukset', Structure:'Rakennukset', Technology:'Teknologia', Fleet:'Laivasto', Defense:'Puolustus', Progression:'Edistyminen', 
		Moyenne:'Keskimääräinen', Production:'Tuotanto', Indestructible:'Tuhoutumattomia', Depuis:'lähtien', Points:'pistettä', construction_time:'Rakennusaika:', 
		level:'taso', dispo:'saatavilla', rank:'Rank', Planet:'Planeetta', soit:'kaikistapisteistä', BBcode_debut:"Pisteet", BBcode_debut2:"Pisteitäyhteensä:", 
		BBcode_mine:"Pisteitäkaivoksissa:", BBcode_bat:"Pisteitämuissarakennuksissa:", BBcode_batT:"Pisteitäkaikissarakennuksissa:", BBcode_fin1:"Pisteitätutkimuksissa:", 
		Bcode_fin2:"Pisteitälaivoissa:", BBcode_fin3:"Pisteitäpuolustuksissa:", BBcode_fin4: "Tililläsi on ", BBcode_fin5 : " tuhoutumattomia pisteitä\n", BBcode_fin6 : "Kehityksen keskiarvo: ", 
		Point_day : "pistettä päivässä", sur_lune:'kuussa', en_vol:'lennossa', Avertissement :'Oletko ma että haluat resetoida pistelaskurin?', restart : 'Paina resetoidaksesi pistelaskurin', 
		AffBBcode : 'Paina saadaksesi BBcodena', done :'Valmis! Päivitä sivu!', ICoption : 'InfoCompten asetukset', options:{ Graphiccolours :'Ympyrädiagrammin värit (täytä värikoodit sektoreiden mukaan)', 
		BatTotal :'Näytä kaikkien rakennuksien pisteet', indestructible :'Näytä tuhoutumattomat pisteet', techno :'Näytä teknologiapisteet', flottes :'Näytä laivastopisteet', Def :'Näytä puolustuspisteet', 
		VaisseauxVol :'Näytä lennossa olevan laivaston prosenttiosuus', pointLune :'Näytä kuiden rakennusten pisteet', 
		sauterLignePourPourcentageFlotteVol :'>Näytä kaikki samalla rivillä (lennossa oleva laivasto ja kuun pisteet)', progression :'>Näytä kehitys', 
		PlusieurSurMemeUni :'Laita täppä jos tällä tietokoneella pelaa useampi henkilö samassa universumissa', couleurPoint :'Näytä edistyminen värillä', 
		ProgJours :'Näytä pisteitä päivässä', ProdJours :'Näytä kaivoksilla saadut pisteet', Techno_utile:"Vis forskning's detaljer", Point_planete :"Vis investerte poeng på planeten", 
		Masquer :"Hide the table of InfoCompte by default", progNeg: 'Bad progression\'s color', progPos : 'Good progression\'s color', Signtxt:'Texte', Signfond:'Background' }, 
		Save:'Tallenna tehdyt muutokset', valeurdefaut : 'Oletusarvot', creeSign:'create a signature with InfoCompte',signature : 'signature'},
		...
		Mines:'Miner', Other_structure:'Andrebygninger', Structure:'Bygning', Technology:'Forskning', Fleet:'Flåte', Defense:'Fors', Progression:'Framgang', Moyenne:'Gjennomsnitt', 
		Production:'Produksjon', Indestructible:'Indestructible', Depuis:'siden', Points:'Poeng', construction_time:'Byggingstid:', rank:'Rang', VueGe:'Oversikt', soit:'representing', 
		BBcode_debut:"Poengdetaljer:", BBcode_debut2:"TotalPoeng:", BBcode_mine:"Poengiminer:", BBcode_bat:"Poengiandrebygninger:", BBcode_batT:"Poengiallebygningane:", 
		BBcode_fin1:"Poengiforskning:", Bcode_fin2:"Poengiflåte:", BBcode_fin3:"Poengifors: ", BBcode_fin4 : "Din konto har ", BBcode_fin5 : "indestructible points", 
		BBcode_fin6 : "Gjennomsnitteleg framgang : ", Point_day : "Poeng per dag", sur_lune:'på måne', en_vol:'flygende', Avertissement :'Er du sikker på å gjennopprette din framgangs COUNT?', 
		restart : 'Tryk her for å gjennopprette framgangsCOUNT', AffBBcode : 'trykk for å få BBC-koden', done :'Gjort! Last inn siden på nytt!', ICoption : 'InfoCompte\'s instillinger', 
		
		options:{ 
		
		Graphiccolours :'Grafikkfarger (sett in nummer på saker du vil ha)', BatTotal :'Vis totalt ant. poeng Bygninger', indestructible :'Vis indestructible points', 
		techno :'Vis forskning poeng', flottes :'Vis flåte poeng', Def :'Vis fors poeng', VaisseauxVol :'Show percentage of fleet in movement', pointLune :'Vis måne poeng', 
		sauterLignePourPourcentageFlotteVol :'Show all in the same line (for fleet movement and moonpoints)', progression :'Vis framgang', 
		PlusieurSurMemeUni :'Fyl inn om der er fleire enn èin spiller i samme universet eller data', couleurPoint :'Show in coulours in fonction of the progress', 
		ProgJours :'Vis framgang per dag', ProdJours :'Vis poeng tjent frå miner', Techno_utile:"Vis forskning's detaljer", Point_planete :"Vis investerte poeng på planeten", 
		Masquer :"Hide the table of InfoCompte by default", progNeg: 'Bad progression\'s color', progPos : 'Good progression\'s color', Signtxt:'Texte', Signfond:'Background'
		
		}, 
		Save:'Save the made modifications', valeurdefaut : 'defaultvalues', Manque:'du må besØ,ke fØ,lgende nettsider :', pas_a_jours :'Det er ein update tilgjengeleg : ', 
		install : 'trykk her for å installere den', utile : 'brukelig', inutile :'ubrukelig', BBcode_fin42 :"Your useless technology representing ", creeSign:'create a signature with InfoCompte',
		signature : 'signature'},
		...
		gr:
      {
		...
		ba : { tag:{}, Mines:'Rudnici', Other_structure:'OstaleZgrade', Structure:'Zgrade', Technology:'Tehnologija', Fleet:'Flota', Defense:'Obrana', Progression:'Napredak', 
		Moyenne:'Prosjecno', Production:'Produkcija', Indestructible:'Neunistivo', Depuis:'od', Points:'Bodovi', construction_time:'Trajanjeizgradnje:', level:'Level', dispo:'postoji', 
		rank:'Mjesto', Planet:'Planeta', soit:'predstavljanje', this_Planet:'OvaPlaneta', BBcode_debut:'Detaljibodova', BBcode_debut2:"Ukupnobodova:", BBcode_mine:"BodoviuRudnicima:", 
		BBcode_bat:"BodoviuOstalimZgradama:", BBcode_batT:"Bodoviuukupnojizgradnji:", BBcode_fin1:"BodoviuTehnologiji : ", Bcode_fin2 : "Bodovi u Floti : ", BBcode_fin3 : "Bodovi u Obrani : ", 
		BBcode_fin4 : "Vas racun ima ", BBcode_fin5 : "neunistivih bodova", BBcode_fin6 : "Prosjecni napredak : ", Point_day : "Bodovi po danu", sur_lune:'na Mjesecu', en_vol:'u letu', 
		Avertissement :'Jeste li sigurni da zelite resetirati vas brojac napretka?', restart : 'Kliknite za resetiranje brojaca napretka', AffBBcode : 'Kliknite za BBcode', 
		done :'Gotovo! Obnovite stranicu!', ICoption : 'InfoStat opcije', options:{ Graphiccolours :'Boje grafikona (popunite brojem ukoliko zelite)', 
		BatTotal :'Prikazi Ukupno Bodovi u Ukupnoj Izgradnji', indestructible :'Prikazi neunistive bodove', techno :'Prikazi Bodove u Tehnologiji', flottes :'Prikazi Bodove u Floti', 
		Def :'Prikazi Bodove u Obrani', VaisseauxVol :'Prikazi postotak flote u pokretu', pointLune :'Prikazi bodove na Mjesecu', 
		sauterLignePourPourcentageFlotteVol :'Prikazi sve u istom redu (za flotu u pokretu i bodove na Mjesecu)', progression :'Prikazi napredak', 
		PlusieurSurMemeUni :'Popunite ako je vise od jednog igraca na istom PC-u ili univerzumu', couleurPoint :'Prikazi u boji u fonction napretka', ProgJours :'Prikazi napredak po danu', 
		ProdJours :'Prikazi bodove dobivene od rudnika', Techno_utile :"Show technology's details", Point_planete :"Show invested points on the planet", 
		Masquer :"Hide the table of InfoCompte by default", progNeg: 'Bad progression\'s color', progPos : 'Good progression\'s color', Signtxt:'Texte', Signfond:'Background' }, 
		Save:'Spremi napravljene preinake', valeurdefaut : 'defaultvalues', creeSign:'create a signature with InfoCompte', Manque:'you need to visite these pages :', 
		pas_a_jours :'There is an update available : ', install : 'click here to install it', 
		utile : 'useful', inutile :'useless', BBcode_fin42 :"Your useless technology representing ", creeSign:'create a signature with InfoCompte',signature : 'signature'},

		br : { tag:{}, Mines:'Minas', Other_structure:'Outrasestruturas', Structure:'Estruturas', Technology:'Tecnologia', Fleet:'Frota', Defense:'Defesa', Progression:'Progresso', Moyenne:'Média', 
		Production:'Produção', Indestructible:'Indestrutivel', Depuis:'Desde', Points:'Pontos', construction_time:'Tempodeconstrução:', level:'Nível', dispo:'Disponivel', rank:'classificação', 
		Planet:'Planeta', soit:'representa', BBcode_debut:"DetalhesdePontuação", BBcode_debut2:"PontuaçãoTotal:", BBcode_mine:"PontosemMinas:", BBcode_bat:"Pontosemoutrasestruturas:", 
		BBcode_batT:"PontuaçãoTotalemEstruturas:", BBcode_fin1:"PontuaçãoemTecnologia:", Bcode_fin2: "Pontuaçao em Frota : ", BBcode_fin3 : "Pontuação em Defesa : ", BBcode_fin4 : "A tua conta tem", 
		BBcode_fin5 : "Pontuação Indestrutivel", BBcode_fin6 : "Média de progresso : ", Point_day : "Pontos por dia", sur_lune:'Na Lua', en_vol:'Em movimento', 
		Avertissement :'Tens a certeza que queres reiniciar a tua contagem de Progresso?', restart : 'Carrega para reiniciar a contagem do teu progresso', AffBBcode : 'Carrega para obteres os BBcode', 
		done :'Concluido! Actualiza a página!', ICoption : "Opções do InfoComplete's", options:{ Graphiccolours :'Graficos (Preenche o numero de casas que quiseres)', 
		BatTotal :'Mostrar pontuação total das estruturas', indestructible :'Mostrar pontuação indestrutivel', techno :'Mostrar pontuação em tecnologia', flottes :'Mostrar pontuação em frota', 
		Def :'Mostrar pontuação em defesa', VaisseauxVol :'Mostrar percentagem de frota em movimento', pointLune :'Mostrar pontuação da lua', 
		sauterLignePourPourcentageFlotteVol :'Mostrar tudo na mesma linha (Para a frota em movimento e para a pontuação da lua)', progression :'Mostrar Progresso', 
		PlusieurSurMemeUni :'Preenche aqui se existirem mais que 1 jogador no mesmo computador e universo', couleurPoint :'Mostrar em cores em função do teu progresso', 
		ProgJours :'Mostrar Progresso Diário', ProdJours :'Mostrar Pontuação ganho em Minas', Techno_utile :"Show technology's details", Point_planete :"Show invested points on the planet", 
		Masquer :"Hide the table of InfoCompte by default", progNeg: 'Bad progression\'s color', progPos : 'Good progression\'s color', Signtxt:'Texte', Signfond:'Background' }, Save:'Gra Configuração', 
		valeurdefaut : 'valores padrão', creeSign:'create a signature with InfoCompte', Manque:'you need to visite these pages :', pas_a_jours :'There is an update available : ', 
		install : 'click here to install it', utile : 'useful', inutile :'useless', BBcode_fin42 :"Your useless technology representing ", creeSign:'create a signature with InfoCompte',
		signature : 'signature'},
		...
		{ 
			...
			tag: 
			{
				...
				lm: 'Lansatoare de rachete',lle: 'Lasere uşoare',llo: 'Lasere grele',gauss: 'Tunuri Gauss',ion: 'Tunuri magnetice',pla: 'Turele de plasmă',pb: 'Scut planetar mic',
				gb: 'Scut planetar mare',mic: 'Rachete Anti-Balistice',mip: 'Rachete Interplanetare'
			}
		},
