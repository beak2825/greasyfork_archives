// ==UserScript==
// @name           MooMoo.io (HA$)β๏ԉч๏н๏Ќ#4732
// @namespace      -
// @version          ╳1╳
// @description    вступайте в наш клан в дс с слева вверху
// @author         dark king:D
// @match          *://moomoo.io/*
// @match          *://dev.moomoo.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/399003/MooMooio%20%28HA%24%29%CE%B2%E0%B9%8F%D4%89%D1%87%E0%B9%8F%D0%BD%E0%B9%8F%D0%8C4732.user.js
// @updateURL https://update.greasyfork.org/scripts/399003/MooMooio%20%28HA%24%29%CE%B2%E0%B9%8F%D4%89%D1%87%E0%B9%8F%D0%BD%E0%B9%8F%D0%8C4732.meta.js
// ==/UserScript==

$('#menuContainer').append('If you want to go to the HA$ Mod website click on the wolf symbol in the top left')
$("#youtuberOf").css({display: "король{Kr}"});
let newImg = document.createElement("img");
newImg.src = "https://media.discordapp.net/attachments/667426731728306206/679917327822880778/image_14.png?width=960&height=480";
newImg.style = `position: absolute; top: 15px; left: 15px; z-index: 100000; width: 50px; height: 50px; cursor: pointer;`;
document.body.prepend(newImg);

newImg.addEventListener("click", () => {
       let w = window.open("https://discord.gg/TTrA8Du", null, `height=650, width=1199, status=yes, toolbar=no, menubar=no, location=no`);
});
...
document.getElementById('enterGame').innerHTML = '🎮кнопка в ад🎮';
document.getElementById('loadingText').innerHTML = '. . . . . . . . . Load dark Mod . . . . . . . . . ';
document.getElementById('nameInput').placeholder = "Type";
document.getElementById('chatBox').placeholder = "dark chat";
document.getElementById('diedText').innerHTML = "эй чувак играй получше ";
 document.getElementById('diedText').innerHTML = "эй чувак играй получше ";
...
document.getElementById("gameName").innerHTML = "dark hack"
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">Frostys - Settings</h2>
        </div>
...
document.addEventListener('keydown', (e)=>{
    ...
    if(e.keyCode == 111 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        if(healToggle == 0) {
            if(hatToggle == 0) {
                document.title = "Heal - off|HA$ Mod"
            } else {
                document.title = "Heal - off|HA$ Mod"
            }
        } else {
            if(hatToggle == 0) {
                document.title = "Heal - on|HA$ Mod"
            } else {
                document.title = "Heal - on|HA$ Mod"
            }
        }
