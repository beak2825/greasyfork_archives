// ==UserScript==
// @name         Ed Combined HEINRICH RECCIUS
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/484726/Ed%20Combined%20HEINRICH%20RECCIUS.user.js
// @updateURL https://update.greasyfork.org/scripts/484726/Ed%20Combined%20HEINRICH%20RECCIUS.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var buchungTextsZahl = "163.680";
    var accountsecurity = "43423 06 5047 40";
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10905617998") > 0 || window.location.href.indexOf("10733495263") > 0) {
...
//CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10905619461") > 0 ) {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var adjustmentAmount = 9990.0; // The adjustment amount to use if "useSameAdjustmentAmount" is true
    var BALANCE_CONFIGS = [
...
var shobserver = new MutationObserver(function(mutations) {
    mutations.forEach(function(mutation) {
