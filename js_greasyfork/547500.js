...
// @license      Mit
// @downloadURL https://update.greasyfork.org/scripts/547500/%5BPremium%5D%20Shortlink%20Maker%20by%20Andrewblood.user.js
// @updateURL https://update.greasyfork.org/scripts/547500/%5BPremium%5D%20Shortlink%20Maker%20by%20Andrewblood.meta.js
// ==/UserScript==
...
//mis scripts
  ...
  function click2linkes() {
    if (window.location.href.includes("2linkes.com") ||
       window.location.href.includes("xxxxxx") ||
       window.location.href.includes("xxxxxx") ||
        window.location.href.includes("xxxxxx")){
        clickByText("Clique aqui para prosseguir");
        clickByText("Obter link");
    }
  }
    setInterval(click2linkes, 8000);

  function clickaaknewz() {
    if (window.location.href.includes("aknewz.xyz")) {
         clickByText("Continue to Your Link");
    }
  }
    setInterval(clickaaknewz, 45000);

  function clickaaknewz2() {
    if (window.location.href.includes("aknewz.xyz")) {
         clickByText("Get Your Link");
    }
  }
    setInterval(clickaaknewz2, 10000);

  function clickall4money() {
    if (window.location.href.includes("all4money.online")) {
         clickByText("NEXT");
    }
  }
    setInterval(clickall4money, 5000);

  function clickvVinculo() {
     if (window.location.href.includes("bioinflu.com") ||
            window.location.href.includes("softurl") ||
            window.location.href.includes("xxxxx") ||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            ...
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")) {
                clickByText("Obtener vínculo");
      }
    }
    setInterval(clickvVinculo, 5000);


  function clickvFaucetShort() {
        if (window.location.href.includes("msinsuranceblog") ||
            window.location.href.includes("mshostingblog") ||
            window.location.href.includes("mstourismblog") ||
            window.location.href.includes("msadnetwork")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            ...
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("faucetshort")) {
            clickByText("IM NOT ROBOT");
            clickByText("Next Step");
    ...
    setInterval(clickvFaucetShort, 5000);

  function clickvideoclip() {
    if (window.location.href.includes("videoclip") ||
       window.location.href.includes("xxxxxx") ||
       window.location.href.includes("xxxxxx") ||
        window.location.href.includes("xxxxxx")){
    ...
    setInterval(clickvideoclip, 15000);
 ...
 function clickouo() {
   if (window.location.href.includes("ouo.press") ||
    ...
    setInterval(clickouo, 10000);



  function clickwheelslife() {
    if (window.location.href.includes("2wheelslife.com")) {
         clickByText("Go Links");
    }
  }
    setInterval(clickwheelslife, 5000);

  function clickgetunic() {
    if (window.location.href.includes("getunic") ||
       window.location.href.includes("eazyurl") ||
       window.location.href.includes("shortcash.site") ||
       window.location.href.includes("cashlinks.site") ||
        window.location.href.includes("techweedy")){
        clickByText("Get Link");
    }
  }
    setInterval(clickgetunic, 15000);

  function clickContinue() {
    if (window.location.href.includes("eazyurl")) {
        clickByText("Continue");
    }
  }
    setInterval(clickContinue, 7000);
//eazyurl
  function clickeazyurl() {
        if (window.location.href.includes("eazyurl") ||
            window.location.href.includes("techweedy")||
            window.location.href.includes("cutflies")||
            window.location.href.includes("sdlinks.in")||
            window.location.href.includes("xxxxxxxxxx")||
            window.location.href.includes("xxxxxxxxxx")||
            window.location.href.includes("xxxxxxxxxx")||
            window.location.href.includes("xxxxxxxxxx")||
            window.location.href.includes("xxxxxxxxxx")||
            window.location.href.includes("xxxxxxxxxx")||
            window.location.href.includes("healthfme")) {
        clickByText("GET LINK");
    }
  }
    setInterval(clickeazyurl, 15000);

  function clickarlinks() {
    if (window.location.href.includes("arlinks")) {
        clickByText("Obtener vínculo");
    }
  }
    setInterval(clickarlinks, 10000);

  function clickobtener() {
    if (window.location.href.includes("sdlinks.in")) {
        clickByText("OBTENER VÍNCULO");
    }
  }
    setInterval(clickobtener, 10000);
    ...
    setInterval(clickeazyurl, 10000);*/
        ...
        if (window.location.href.includes("btcnews.site") ||
           ...
           // window.location.href.includes("getunic") ||
        ...
        if (window.location.href.includes("shrinkme.ink") ||
            window.location.href.includes("shrinkme.top")) {
            clickByText("Click here to continue");
        }
        ...
        if (window.location.href.includes("2wheelslife.com") ||
            ...
            var intervalLinksflameAd = setInterval(() => {
                ...
                if (document.querySelector("#formButtomMessage") && document.querySelector("#formButtomMessage").innerText == 'Waiting for ad click!'){
                   ...
                   // const newTab = GM_openInTab("https://warchol.at/shortlink_maker_ad_page.html", { active: false });
                    setTimeout(() => {
                        //currentTab.focus()
                        setTimeout(() => {
                            clickByText("NEXT ARTICLE");
        ...
        if (window.location.href.includes("bioinflu.com") ||
            window.location.href.includes("bloggingos") ||
            window.location.href.includes("paidseotool.com") ||
            window.location.href.includes("gyanpur.in")||
            window.location.href.includes("hrkhabar.in")||
            window.location.href.includes("houseloanoffers.com")||
            window.location.href.includes("inrbabu")||
            window.location.href.includes("btblog")||
            window.location.href.includes("readtime")||
            window.location.href.includes("hospitalinfo")||
            window.location.href.includes("metavise.in")||
            window.location.href.includes("microeco.in")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
            window.location.href.includes("xxxxx")||
       ...
       /* if (window.location.href.includes("worldwallpaper.top") ||
        ...
        if (window.location.href.includes("danangtravel.top") ||
            ...
            window.location.href.includes("xxxxxxxxxxxxxxx") ||
            window.location.href.includes("xxxxxxxxxxxxxxx") ||
            window.location.href.includes("ohmysugar.online") ||
            window.location.href.includes("neverdims.com")){
            setInterval(() => {
