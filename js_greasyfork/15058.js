...
// @namespace   CnC_TA_CNCOpt_Link_Button
// @author  	Vulcano
// @version     1.7.7.5 (Vulcanion)
// @date        2015-07-25
...
// @grant       unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/15058/CC%3ATA%20CNCOpt%20Link%20Button.user.js
// @updateURL https://update.greasyfork.org/scripts/15058/CC%3ATA%20CNCOpt%20Link%20Button.meta.js
// ==/UserScript==
...
var tbase = null;
try {
    unsafeWindow.__cncopt_version = "1.7.7.4";
    (function () {
        var cncopt_main = function () {
            console.log('C&C:TA CNCOpt Link Button loading ...');
            ...
            function cncopt_create() {
                console.log("C&C:TA CNCOpt Link Button v" + window.__cncopt_version + " loaded");
                var cncopt = {
                    selected_base: null,
                    keymap: {
         ...
         * sync Base object to our cncopt.selected_base variable  */
            ...
            console.log('C&C:TA CNCOpt Link Button loaded successfully !!!');
        }
