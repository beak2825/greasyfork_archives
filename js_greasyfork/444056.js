...
// @downloadURL https://update.greasyfork.org/scripts/444056/Play-With-MPV.user.js
// @updateURL https://update.greasyfork.org/scripts/444056/Play-With-MPV.meta.js
// ==/UserScript==
...
function addListener() {
    ...
    saveButton.onclick = function () {
        ...
        updatePlayButtonVisibility(currentConfig);
        GM_setValue(KEY.config, currentConfig);
...
var websiteList = [{
        ...
        // ✅ https://www.bilibili.com/bangumi/play/ss46555
        name: "B站影视",
        ...
        handler: class Handler extends BaseHandler {
            ...
            async parse() {
                ...
                if (url.startsWith("blob")) {
                    for (
                        let index = 0; index < sessionStorage.key.length; index++
                    ) {
    ...
    },
    {
        ...
        handler: class Handler extends BaseHandler {
            ...
            videoParser() {
                ...
                let url = document
                    .getElementsByTagName("video")[this.index].getElementsByTagName("source")[0].src;
                if (url) {
                    return url;
                }
            }
