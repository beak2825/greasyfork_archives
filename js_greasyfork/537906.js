// ==UserScript==
// @name         Play with VLC Button for scloud.ninja
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/537906/Play%20with%20VLC%20Button%20for%20scloudninja.user.js
// @updateURL https://update.greasyfork.org/scripts/537906/Play%20with%20VLC%20Button%20for%20scloudninja.meta.js
// ==/UserScript==
    ...
    function createVLCButton(url) {
        ...
        button.onclick = () => {
            try {
                ...
                alert('Failed to open VLC. Ensure VLC for Mobile is installed and try again.');
            }
        };
        return button;
    }
