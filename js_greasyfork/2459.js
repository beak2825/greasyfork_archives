...
// @include        http*://*animecubedgaming.com/billy/bvs/billycon-schedule.html*
...
// @version        4.16
// @history        4.16 New domain - animecubedgaming.com - Channel28
// @history        4.15 Ren Po Ken reported that skills 200+ break the script and how to fix it (limit is now 256) - Channel28
// @history        4.14 Now https compatible (Updated by Channel28)
// @history        4.13 Minor typo fix found by Ren Po Ken - Channel28
// @history        4.12 Added Backstage skills and Pet Point to search function autofill - Channel28
// @history        4.11 Minor typo fix suggested by Ren Po Ken - Channel28
...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/2459/BvS%20BillyCon%20Enhancer.user.js
// @updateURL https://update.greasyfork.org/scripts/2459/BvS%20BillyCon%20Enhancer.meta.js
// ==/UserScript==
...
function BillyCon() {
    ...
    var initSchedule = function () {
        ...
        var acOptions = ["Alpha Cancel", "Antidrama", "Artsiness", "Bluff",
                "Chillaxing", "Combat Sewing", "Crossplay", "Cosplay", "Crowdswimming",
                "Dance", "Detect Traps", "Drama", "Flipping Out", "Frame Advantage",
                "GeoSense", "Glomping", "Glowsticking", "Guard Crush", "Hide",
                "Knowledge", "Macking", "Pet Point", "Photography", "Posing",
                "Reputation", "Rocking", "Schmoozing", "Search", "Sense Motive", "Shopping",
                "Silence", "Spot", "Staring", "Tech Punish", "The Angles",
