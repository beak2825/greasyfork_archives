// ==UserScript==
// @name         BRATSK | Скрипт для Руководства
...
// @license 	 none
// @downloadURL
// @downloadURL https://update.greasyfork.org/scripts/493268/BRATSK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/493268/BRATSK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            title: 'Приветствие',
            content:
            "[CENTER][FONT=Tahoma]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/FONT][/CENTER]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "[CENTER][FONT=Tahoma] текст [/FONT][/CENTER]",
        },
        {
            title: 'На рассмотрение',
            content:
            "[CENTER][FONT=Times New Roman][SIZE=5][FONT=Times New Roman]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
        ...
        },
        {
            title: 'Не по форме',
            content:
            "[CENTER][FONT=Times New Roman][SIZE=5]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
        ...
        },
        {
            ...
            content:
            "[CENTER][FONT=Times New Roman][SIZE=5]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]"+
        ...
        },
        {
            ...
            "[CENTER][FONT=Times New Roman][SIZE=5]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
            "Ваша жалоба была рассмотрена и одобрена, в сторону администратора будут приняты меры.<br>"+
        ...
        },
        {
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
            '[COLOR=red]Передано Основному Заместителю ГА[/COLOR][/FONT][/CENTER]',
            prefix: GA_PREFIX,
            status: true,
        },
        {
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
            '[COLOR=orange]Передано Специальному Администратору.[/COLOR][/FONT][/CENTER]',
        ...
        },
        {
            ...
            "[CENTER][FONT=Times New Roman][Size=5]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
            "Вы ошиблись разделом, перенаправляю вашу жалобу в раздел вашего сервера.<br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
            '[COLOR=orange]Передано администрации вашего сервера.[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
        },
        {
            title: 'Беседа с адм V2',
            content:
            "[CENTER][FONT=Times New Roman][Size=5]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
            "Ваша жалоба была рассмотрена и одобрена, в сторону администратора будут приняты меры.<br>"+
            "Приносим извинения за предоставленные неудобства.<br>"+
            "Ваше наказание будет снято/снижено в течении ближайшего времени.<br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/2yQ1zWNs/Picsart-24-04-25-18-50-28-196.png[/img][/url]<br>"+
            '[COLOR=#00FA9A]Одобрено[/COLOR], Закрыто.[/FONT][/CENTER]',
            prefix: ACCEPT_PREFIX,
            status: false,
