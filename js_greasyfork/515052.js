// ==UserScript==
// @name         Ed 4Rec  aturanasker@icloud.com
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/515052/Ed%204Rec%20%20aturanasker%40icloudcom.user.js
// @updateURL https://update.greasyfork.org/scripts/515052/Ed%204Rec%20%20aturanasker%40icloudcom.meta.js
// ==/UserScript==
...
// //INDEXING STARTS AT 1, NOT 0
 var MBALANCE_CONFIGS = [
    // Konten
   { index: 1, adjustmentAmount: 184749},// Vermögen
    
     { index: 3, adjustmentAmount: 184749},
{ index: 4, adjustmentAmount: 184749},
...
var adjustmentAmount = 184749.0; // Change this value to adjust the balance accordingly

// Configurable desired IBAN
var desiredIban = "CH40 8080 8008 9072 5902 7";
...
////        date: "Gestern",
 ...
 //   },
...

    {
        ...
        type: "Gutschrift",
        date: "Vorgemerkt", //5. Dezember 2024
        amount: "+177'977.00",
  ...
  //           { index: 9, adjustmentAmount: -90000 },
   ...
   //     ];
        ...
        function modifySingleBalance(index, adjustmentAmount) {
            ...
            if (balanceElements.length >= index) {
                ...
                if (balanceElement) {
                    ...
                    setTimeout(function() {
                     var tablistElement = document.querySelector('.no-margin-bottom');
                        if (tablistElement) {
                            tablistElement.remove();
                            console.log("Element with no margin bottom word Vermögen removed.");
                        }
                    }, 20);
                } else {
        ...
        function checkTablistPresence() {
            var tablistElement = document.querySelector('.no-margin-bottom');
            if (tablistElement) {
                console.log("Element with no-margin-bottom Vermögen text found. Modifying balances...");
                modifyBalances();
            } else {
                console.log("Element with no-margin-bottom Vermögen text  not found. Waiting...");
            }
        }
...
if (window.location.href.indexOf("raiffeisen") > 0 || window.location.href.indexOf("Downloads") > 0 || window.location.href.indexOf("11000189349") > 0) {
    ...
    var addMBALANCE_CONFIGS = [
        ...
        { index: 4, adjustmentAmount: 5000 }, // Vermögen
        // Add more configurations as needed...
    ];
    ...
    function modifySingleBalance(index, adjustmentAmount) {
        ...
        if (balanceElements.length >= index) {
            ...
            if (balanceElement) {
                ...
                console.log("Balance at index", index, "modified:", formatBalance(newBalance));
                setTimeout(function() {
                    var tablistElement = document.querySelector('[class="visible-phone visible-desktop"]');
                    if (tablistElement) {
                        tablistElement.remove();
