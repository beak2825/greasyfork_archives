...
// @author       taxayd, rrkeleek
// @match        *://*.v2ex.com/*
// @grant GM_setValue
// @grant GM_getValue
// @grant GM_deleteValue
// @namespace https://greasyfork.org/users/95299
// @downloadURL https://update.greasyfork.org/scripts/389576/red%20list.user.js
// @updateURL https://update.greasyfork.org/scripts/389576/red%20list.meta.js
// ==/UserScript==
    ...
    if (path == '/' || path.startsWith('/go/') || path.startsWith('/tag/'))
    {
        ...
        for(let i=0; i<len; i++) {
            ...
            if (cell.children && cell.children[0].classList.contains("topic_content")) {
                ...
                if (redlist.indexOf(username.innerText) >= 0) {
                    cell.style = SHADIAO_BG_CSS + "background-size:contain;";
                }
