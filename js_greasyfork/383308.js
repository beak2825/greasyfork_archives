...
(function() {
    ...
    var userSettings = {"hoverPrices":true,"autoService":true,"autoMarketWithdraw":true,"alwaysDisplayQuickSwitcher":false,"innerCityButton":true};//Default Settings
        ...
        "loadoutsMenu": {
            "data":
                [
                    ...
                    ["button","Export Quickswaps",{"style":[["position","absolute"],["left","30px"]]},exportLoadoutsToJson,[]],
                    ["button","Import Quickswaps",{"style":[["position","absolute"],["left","30px"]]},importLoadoutsFromJson,[]],
        ...
        "loadoutEdit": {
            "data":
                [
                    ...
                    ["p","",[]],
                    ["div","",[],[
                        ["span","Armor",{"style":[["position","absolute"],["left","100px"]]}],
                        ["span","Backpack",{"style":[["position","absolute"],["right","80px"]]}],
                    ]],
                    ["div","",[],[
                        ["div","",[],[
                            ["div","",{"style":[["position","absolute"],["left","100px"]],"className":"slot validSlot silverScriptsSlot armour","id":"armour_0"},[]],
                            ["div","",{"style":[["position","absolute"],["right","100px"]],"className":"slot validSlot silverScriptsSlot backpack","id":"backpack_0"},[]],
                        ]],
                    ]],
                    ["p","",[]],
                    ["p","",[]],
                    ...
                    ["div","",{"style":[["position","absolute"],["width","100%"],["height","176px"]]},[
                        ...
                        ["div","",{"style":[["position","absolute"],["left","100px"],["top","176px"],["width","100%"],["height","44px"]]},[
                            ["div","",{"style":[["position","absolute"],["left","0px"]],"className":"slot validSlot silverScriptsSlot implant","id":"implant_16"},[]],
                            ["div","",{"style":[["position","absolute"],["left","44px"]],"className":"slot validSlot silverScriptsSlot implant","id":"implant_17"},[]],
                            ["div","",{"style":[["position","absolute"],["left","88px"]],"className":"slot validSlot silverScriptsSlot implant","id":"implant_18"},[]],
                            ["div","",{"style":[["position","absolute"],["left","132px"]],"className":"slot validSlot silverScriptsSlot implant","id":"implant_19"},[]],
                        ]],
                    ]],
    ...
    function isAtLocation(location){
        ...
        if(location == "home"){
            if(window.location.href.split("fairview.deadfrontier.com/onlinezombiemmo/index.php")[1] == "" ||
               ...
               window.location.href.split("fairview.deadfrontier.com/onlinezombiemmo/index.php?redirectTo=").length > 1){
                return true;
            }else{
                return false;
            }
    ...
    async function checkForScriptUpdate(){
        ...
        if(needsUpdate && isVersionAfterSkip){
            helpWindowStructure["changelog"]["data"][0][1] = "<b>"+uploadedVersion+"</b><br>";
            //Save the new version changelog into its menu page
            let changelog = history[0]["changelog"];
            if(changelog){
                helpWindowStructure["changelog"]["data"][0][1] += changelog["html"].trim();
            }
    ...
    function checkForRedirects(){
        ...
        const redirectedPage = urlParams.get('redirectTo');
        if(isAtLocation("home") && urlParams.get('redirectTo')){
            unsafeWindow.doPageChange(redirectedPage, 1, false);
        }
    }
    ...
    function addAllAmmoToDatabank(){
        ...
        var ammoTypes = ['32ammo', '35ammo', '357ammo', '38ammo', '40ammo', '45ammo', '50ammo', '55ammo', '20gaugeammo',
                         ...
                         '75rifleammo', '9rifleammo', '127rifleammo', '14rifleammo', 'energycellammo', 'fuelammo',
                         'biomassammo'];
            ...
            unsafeWindow.playSound("outpost");
		        setTimeout(function(){
                    if(isAtLocation("home")){
                        ...
                        window.open("https://fairview.deadfrontier.com/onlinezombiemmo/index.php?redirectTo=21","_self");
                    }
		        }, 1000);
        });
        container.appendChild(button);
