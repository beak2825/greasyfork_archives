// ==UserScript==
// @name         AutoProblem Block Couriers
...
// @license      MIT
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/530324/AutoProblem%20Block%20Couriers.user.js
// @updateURL https://update.greasyfork.org/scripts/530324/AutoProblem%20Block%20Couriers.meta.js
// ==/UserScript==
...
(function () {
  ...
  const problems = [
    {
      id: 530,
      name: 'Блокировка за удержание заказов без выполнения',
      category: 'Monitoring',
      status: 10,
      assignee: 0,
      comment: 'Отключен от заказов клиента за удержание заказов без выполнения'
    },
    {
      id: 258,
      name: 'Прочее (отключение курьеров недельного опоздания)',
      category: 'Monitoring',
      status: 10,
      assignee: 0,
      comment: 'Отключен от заказов клиента из-за систематического опоздания. Для восстановления доступа пишите ВС мониторинг.'
    },
    {
      id: 258,
      name: 'Прочее (Отключение бессрочное)',
      category: 'Monitoring',
      status: 10,
      assignee: 0,
      comment: 'Отключен от заказов клиента из-за систематического опоздания. В совокупности проблем по отключению - блокировка БЕССРОЧНАЯ.'
    }
  ];
  ...
  function createProblemUI() {
    ...
    title.textContent = 'Проблемы для блокировки курьеров';
