...
// @grant        unsafeWindow
// @license      Apache-2.0
// @downloadURL https://update.greasyfork.org/scripts/508092/%E5%A6%82%E6%84%8F%E6%96%87%E6%A1%A3.user.js
// @updateURL https://update.greasyfork.org/scripts/508092/%E5%A6%82%E6%84%8F%E6%96%87%E6%A1%A3.meta.js
// ==/UserScript==
(function() {
	'use strict';
	let MF =
	...
	const btns = [
		new Box('text', '下载进度 0 %'),
		new Box('start', '自动翻页', 'autoPreview()'),
		new Box('stop', '停止翻页', 'stopPreview()'),
		new Box('down', '下载原图', 'executeDownload(2)'),
		new Box('pdf', '下载PDF格式', 'executeDownload(1)')
	]
