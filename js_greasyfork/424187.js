...
// @name         SOFTWARE MOD
// @version      v493
// @description  AUTO BUY HATS AND OP INSTA
// @author       WATERSHEEP
// @include      *://moomoo.io/*
...
// @namespace https://greasyfork.org/users/746946
// @downloadURL https://update.greasyfork.org/scripts/424187/SOFTWARE%20MOD.user.js
// @updateURL https://update.greasyfork.org/scripts/424187/SOFTWARE%20MOD.meta.js
// ==/UserScript==
	...
	, INT = setInterval(() => {
		if(1 == switched) {
			...
			const ye = [{
					...
					, price: 0
					, scale: 120
					, desc: "THIS HACK WILL ONEDAY MATCH THE LEGENDARY RV3"
				}, {
					id: 51
					, name: "Moo Cap"
					, price: 0
