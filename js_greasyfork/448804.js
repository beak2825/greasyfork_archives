...
// @downloadURL https://update.greasyfork.org/scripts/448804/fatih.user.js
// @updateURL https://update.greasyfork.org/scripts/448804/fatih.meta.js
// ==/UserScript==
...
$(document).ready(function(){
    ...
    setInterval(()=>{
        if($(baslik).find(".progress-check-icon").length){
            document.location.href = "https://www.oba.gov.tr/egitim/oynatma/basogretmenlik-egitim-programi-semineri-meb-personeli-283/3104";
        }
