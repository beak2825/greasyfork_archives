...
// @collaborator
// @icon
// @downloadURL https://update.greasyfork.org/scripts/544757/BLACK%20RUSSIA.user.js
// @updateURL https://update.greasyfork.org/scripts/544757/BLACK%20RUSSIA.meta.js
// ==/UserScript==
...
(function () {
    ...
    const START_COLOR_1 = `<font color=#b41414>`
    const START_COLOR_2 = `<font color=#ffffff>`
    const START_COLOR_3 = `<font color=#b41414>`
  ...
  const buttons = [
      {
         title: 'Приветствие',
         content:
         `${START_DECOR + START_COLOR_1}{{ greeting }}!<br><br>` +
