// ==UserScript==0
// @name         Ultra mod (Best mod) (MooMoo.io) Updated
// @namespace    Ultra mod Best Mod by Furiousflames
// @version      Ultra_V.24-(BeTa)
// @description  Controls ( End = Mod Menu|Home = Music Menu|Page Up = Police Hat|Page Down = Animal Hat|Num Lock 1 = Auto Hat|F = 360Hit|Y = Auto Insta Kill|Something = Auto Aleatory Hat|Z = Auto WindMill
// @author       Furiousflames
...
// @downloadURL https://update.greasyfork.org/scripts/437808/Ultra%20mod%20%28Best%20mod%29%20%28MooMooio%29%20Updated.user.js
// @updateURL https://update.greasyfork.org/scripts/437808/Ultra%20mod%20%28Best%20mod%29%20%28MooMooio%29%20Updated.meta.js
// ==/UserScript==
...
if (windowloc == "moomoo.io" || windowloc == "sandbox.moomoo.io" || windowloc == "dev.moomoo.io") {
    ...
    var INT = setInterval(()=>{
        if (switched == 1) {
            ...
            , ezBool = !1
            , ezChat = "==>|How did you die with Ultra mod? *;::;*|<=="
            , irBool = !1
            , cPlayer = !1
            , wLag = !0
            , TankGearKey = 67
...
alert ('Controls ( End = Mod Menu|Home = Music Menu|Page Up = Police Hat|Page Down = Aniaml Hat|Num Lock 1 = Auto Hat|F = 360Hit|Y = Auto Insta Kill|Num Lock 3 = Auto Aleatory Hat|Z = Auto WindMill ). Credits Furiousflames')
            function autohide(){
...
document.getElementById('linksContainer2').innerHTML = 'Controls ( End = Mod Menu|Home = Music Menu|Page Up = Police Hat|Page Down = Animal Hat|Num Lock 1 = Auto Hat|F = 360Hit|Y = Auto Insta Kill|Num Lock 3 = Auto Aleatory Hat|F = Auto WindMill ). Credits Furiousflames';
document.getElementById('gameName').innerHTML = 'U L T R A - Μ Ø Đ';
setInterval(() => {
    setTimeout(() => {
        document.getElementById("gameName").innerHTML = "U"
        setTimeout(() => {
            document.getElementById("gameName").innerHTML = "U L"
            setTimeout(() => {
                document.getElementById("gameName").innerHTML = "ULT"
                setTimeout(() => {
                    document.getElementById("gameName").innerHTML = "U L T R"
                    setTimeout(() => {
                        document.getElementById("gameName").innerHTML = "ULTRA"
                        setTimeout(() => {
                            document.getElementById("gameName").innerHTML = "ULTRA -"
                            setTimeout(() => {
                                document.getElementById("gameName").innerHTML = "U L T R A - M"
                                setTimeout(() => {
                                    document.getElementById("gameName").innerHTML = "ULTRA"
                                    setTimeout(() => {
                                        document.getElementById("gameName").innerHTML = "U L T R A - M O D"
                                        setTimeout(() => {
                                            document.getElementById("gameName").innerHTML = "By Furiousflames"
                                            setTimeout(() => {
                                                document.getElementById("gameName").innerHTML = "ULTRA-MOD"
                                                setTimeout(() => {
                                                    document.getElementById("gameName").innerHTML = "ByFuriousflames"
                                                }, 150);
                                            }, 100);
                                        }, 100);
                                    }, 100);
...
setInterval(() => {
    setTimeout(() => {
        document.getElementById('chatBox').placeholder = "ULTRAMOD";
        setTimeout(() => {
            document.getElementById('chatBox').placeholder = "ULTRAMOD";
            setTimeout(() => {
                document.getElementById('chatBox').placeholder = "ByFuriousflames";
                setTimeout(() => {
...
document.getElementById('loadingText').innerHTML = 'Ultra mod | Loɑding... '
document.getElementById('diedText').innerHTML = ' How you die with Ultra mod? ';
document.getElementById('enterGame').innerHTML = ' Start Game ';
document.getElementById('desktopInstructions').innerHTML = '  By Furiousflames '
...
document.getElementById('nameInput').placeholder = "Ultra mod";
document.getElementById('leaderboard').style.color = "#000000";
document.title = 'U L T R A - Μ Ø Đ';
document.getElementById("leaderboard").append ('By Furiousflames');
...
<div>
<label>Trap Circle : <button id="kTrapCircle" class="i-button i-bold i-right i-inline i-keybind">KeyP</button></label>
</div>
<div>
...
`;
            ...
            const connectBot = code => {
                ...
                botws.onopen = async () => {
                    ...
                    await wait(100);
                    botws.emit(['sp', [{ name: 'Furious', moofoll: '1', skin: "__proto__" }]]);
            ...
            , checkPing = new MutationObserver(function () {
                delay = ping.textContent.split(" ")[1].split(String.fromCharCode(160))[0], (delay = parseInt(delay)) > 100 && wLag &&
                    ...
                    chat("==> PiNg <==>" + delay + "<== By Furiousflames");
            });
