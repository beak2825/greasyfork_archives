// ==UserScript==
// @name        Zendesk Window Title Improved
...
// @grant       none
// @version     1.7.1
// @author      Leo; Original Author: Simon
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/506625/Zendesk%20Window%20Title%20Improved.user.js
// @updateURL https://update.greasyfork.org/scripts/506625/Zendesk%20Window%20Title%20Improved.meta.js
// ==/UserScript==
...
function getTitle() {
    ...
    var tabs = $("div[data-test-id='header-tablist']");
    if (tabs.length === 1) {
