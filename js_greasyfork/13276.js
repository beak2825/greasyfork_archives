...
// @grant          GM_getValue
// @namespace      https://mediatheque.mairie-saintnazaire.fr/
// @description    Script permettant l'enrichissement du catalogue de la Médiathèque de Saint-Nazaire (HIP4+)
// @include        https://mediatheque.mairie-saintnazaire.fr/*
// @version 0.0.1.20190704163427
// @downloadURL https://update.greasyfork.org/scripts/13276/HIP%20Extended.user.js
// @updateURL https://update.greasyfork.org/scripts/13276/HIP%20Extended.meta.js
// ==/UserScript==

/*
Note : ce script est largement inspiré de "Sudoc plus" (http://userscripts-mirror.org/scripts/review/60741) réalisé par Sylvain Machefert (@symac)
*/
...
function permalink() {
	...
	var full_link = 'https://mediatheque.mairie-saintnazaire.fr/uPortal/Initialize?uP_reload_layout=true&uP_tparam=props&uP_sparam=activeTab&activeTab=2&showBrief=true&link=full' + link + '&currentPosition=0&searchTargetId=16';
	
	if ((link != "<Péé")&&(link != "")&&(link != "MOTSCLES")) {
		// Affichage Permalien
		newtd = document.createElement("td");
		newtd.id = 'permalien';
		newtd.innerHTML = '&nbsp;&nbsp;<img src="https://antoinev.alwaysdata.net/link.png"/> <a target="_blank" href="' +full_link+'">Permalien</a><br /><br />';
...
function notice_plus() {
	var serveur='https://antoinev.alwaysdata.net/cover.php?action=couv&isbn=';
	...
	if (responseDetails.responseText != "") {
	    var cover = responseDetails.responseText;
				...
				if (cover != "") {
					...
					newtd.innerHTML = '<center><br /><br /><img border="0" style="box-shadow: 0.5px 0.5px 1px 0.5px;" src="' + cover + '"/><br/><p style="padding-top:2px; margin:0; font-size:0.7em;">source: <a target="_blank" href="https://www.amazon.fr">Amazon</a></p></center>';
