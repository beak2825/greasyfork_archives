...
// @downloadURL https://update.greasyfork.org/scripts/396771/MousePlus.user.js
// @updateURL https://update.greasyfork.org/scripts/396771/MousePlus.meta.js
// ==/UserScript==
/* jshint esversion: 6 */
    ...
    _cfg = {
     ...
     /* Hinter: {
      ...
      text: {         // dragText
        ...
        "6":  {
                name:"searchText",
                arg:["https://liminshequ.com/search?&q=", true, true]
              }
      },
      /*link: {         // drag link
        "6": {name:"openLink",   arg:[]},
    ...
    Fn = {
      ...
      searchText: function(argumentArr, data) {
        GM_openInTab(argumentArr[0] + encodeURIComponent(data.textSelection),
         {
          /*active: argumentArr[1] = "true",
          insert: argumentArr[2] = "false",*/  //跳转到新打开页面
          setParent: false   //makes the browser re-focus the current tab on close.
        });
      },
