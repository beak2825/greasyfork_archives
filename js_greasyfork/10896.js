...
// @description Top and Down buttons everywhere (no Jquery) 在一切页面上根据情况自动添加一个/两个按钮：页面最上方、页面最下方，鼠标悬停的时候，缓缓翻页移动
// @version 1.4
// @author  Max Max
// @license MIT
// @include *
// @run-at  document-end
// @grant   none
// @downloadURL https://update.greasyfork.org/scripts/10896/TopAndDownButtonsEverywhere.user.js
// @updateURL https://update.greasyfork.org/scripts/10896/TopAndDownButtonsEverywhere.meta.js
// ==/UserScript==
