...
// @author       Matvey_Kovalsky, Lorenzo_Moretti
...
// @downloadURL https://update.greasyfork.org/scripts/483292/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/483292/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
...
(function() {
    ...
    const buttons = [
        ...
        },
        {
            ...
            "[CENTER][FONT=verdana][I][COLOR=rgb(0, 255, 0)]Одобрено.[/COLOR][/I][/FONT][/CENTER]<br>",
        ...
        },
        {
	        ...
	        content:
            '[SIZE=4][FONT=Verdana][color=#fff][B][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/CENTER]<br>' +
            "[CENTER][I]Обратитесь в раздел обжалования -> [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.786/']Кликабельно[/URL]<br>" +
        ...
        },
        {
	        ...
	        content:
            '[SIZE=4][FONT=Verdana][color=#fff][B][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/CENTER]<br>' +
            "[CENTER][I]Обратитесь в раздел жалобы на лидеров -> [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.784/']Кликабельно[/URL]<br>" +
            "[COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/I][/CENTER]",
            prefix: ZAKRITO_PREFIX,
            status: false,
        },
        {
	        ...
	        content:
            '[SIZE=4][FONT=Verdana][color=#fff][B][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/CENTER]<br>' +
            "[CENTER][I]Обратитесь в раздел жалобы на администрацию -> [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.783/']Кликабельно[/URL]<br>" +
            "[COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/I][/CENTER]",
            prefix: ZAKRITO_PREFIX,
            status: false,
        },
     ...
     title: '__________________________________________рп биографии__________________________________________',
        },
        {
	        ...
	        content:
            '[SIZE=4][FONT=Verdana][color=#fff][B][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/CENTER]<br>' +
            "[CENTER][I]Ваша РП биография получает статус: Одобрено.[/I][/CENTER]<br>",
            prefix: ODOBRENO_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content:
            '[CENTER][I]Добрый день, уважаемый [USER=655455]<span class="username--moderator">Lorenzo Moretti</span>[/USER].[/I]<br>' +
    ...
    },
    {
        ...
        },
        {
	        ...
	        content:
            '[SIZE=4][FONT=Verdana][color=#fff][B][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/CENTER]<br>' +
            "[CENTER][I]Ваша РП ситуация получает статус: Одобрено.[/I][/CENTER]<br>",
            prefix: ODOBRENO_PREFIX,
            status: false,
        },
        {
