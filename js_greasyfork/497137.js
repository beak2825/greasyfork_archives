 // ==UserScript==
// @name         C0zm1x's Modmenu
// @version      4.0.1
// @namespace    cozmix.straight
// @license      MIT
// @description  A renewed and classic C.AI modmenu
// @author       C0zm1x
...
// @grant        GM_setValue
// @grant        GM_getValue
// @icon         https://cdn.discordapp.com/attachments/1093214581100380231/1247960241786585180/cursed_doppio_image.png?ex=6661ed0b&is=66609b8b&hm=6f275c10ce972d851265c903ff6f869c077200f6ca04677c80e24cd9a7b584ae&
// @downloadURL https://update.greasyfork.org/scripts/497137/C0zm1x%27s%20Modmenu.user.js
// @updateURL https://update.greasyfork.org/scripts/497137/C0zm1x%27s%20Modmenu.meta.js
// ==/UserScript==
...
(function() {
    ...
    const hasAcceptedTOS = GM_getValue('acceptedTOS', false);
    ...
    function showTermsOfServicePopup() {
        ...
        title.textContent = "C0zm1x's Modmenu";
        title.id = 'terms-and-stuff'
        popup.appendChild(title);

        const description = document.createElement('p');
        description.textContent = "By using C0zm1x's Modmenu, you must agree to our Terms of Service and Privacy Policy.";
        ...
        const tosLink = createLink('Terms of Service', 'https://cdn.discordapp.com/attachments/1116542510051897434/1246057018679234772/videoplayback_1.mp4?ex=66619807&is=66604687&hm=46712ebda83ce7aaeb723d10555fa87b8b536a65a3d759f745d12b5a64fff949&');
        const privacyLink = createLink('Privacy Policy', 'https://cdn.discordapp.com/attachments/1093214581100380231/1247962557512159333/Fish_drink_shorts_shortvideo_1.mp4?ex=6661ef33&is=66609db3&hm=ddce0b798f93cc011c710ef83d6460e384a1361a5c07e6efc427a6edbd4f39a2&');
    ...
    if (hasAcceptedTOS) {
        ...
        setTimeout(() => {
            ...
            const modules = [{
                title: 'Read or oil up',
                description: 'This modmenu is renewed so i dont give a darn FUCK about whether if i have a permission to renew it or not cause im not getting a lawsuit.',
                author: 'C0zm1x',
                defaultStatus: true,
                code:                 function() {
                    console.log("what");
                             ...
                             { // NOT YET WORKING ON NEW WEBSITE --- LOW PRIORITY
                                 ...
                                 code: function() {
                                     function replaceImageSrc() {
                                         ...
                                         if (targetImage) {
                                             targetImage.src = 'https://cdn.discordapp.com/attachments/1093214581100380231/1247960347151699998/360_F_529873767_FMwTX8twWRwAI4xtk2X65THeflD7Fp9s.png?ex=6661ed24&is=66609ba4&hm=65f3e7501ba2b7ecdd6e0e8504dd8f96900030ddd8ce1be8ae4d5b19b85a0cea&';
                                         }
                                     }
                             ...
                             {
                                 title: 'Tab Cloaker',
                                 description: 'On god I was on Google!',
                                 author: 'C0zm1x',
                                 defaultStatus: true,
                                 code: function() {
                                     function cloaker() {
            ...
            versionText.innerHTML = 'v4.0.0 &bull; <a href="Free Subscription!" target="_blank">https://cdn.discordapp.com/attachments/1093214581100380231/1247958922623582259/Golf_yourself.mp4?ex=6661ebd1&is=66609a51&hm=8c44db7fa06b118b691d15abe8b2eafb869df490cc6c6d59d5d630d943e722f9&</a> &bull; <strong>Beta Release</strong>'; // This might be pulled from a URL someday
