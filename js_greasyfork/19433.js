...
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/19433/WestFortscom%20Import%20Link.user.js
// @updateURL https://update.greasyfork.org/scripts/19433/WestFortscom%20Import%20Link.meta.js
// ==/UserScript==
  ...
  if (document.getElementById('westforts_js')) { return; }
    ...
    westforts_link.onclick = function(){
      ...
      else
      {
          ...
          westforts_script.setAttribute('src', 'https://www.westforts.com/js/import_userscript.js?'+new Date().getTime());
