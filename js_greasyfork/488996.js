...
// @author       Daniil_Miskin
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license      MIT
// @icon         https://ibb.co/wK7G14s
// @downloadURL https://update.greasyfork.org/scripts/488996/Tech%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/488996/Tech%20Script.meta.js
// ==/UserScript==
...
{
		title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ         ᅠ⠀⠀ ⠀⠀ᅠ ᅠᅠФорумник ᅠᅠ ᅠᅠ⠀⠀⠀ ⠀ᅠ     ᅠ ᅠ     ᅠ ᅠ ᅠ ',
...
},
{
  ...
  "content":
    ...
    '[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][SIZE=15px] Мы заметили, что вы создали обращение, которое дублирует вашу предыдущую тему. Для эффективного рассмотрения просьб и вопросов, пожалуйста, избегайте создания дублирующих тем. Мы уже приняли меры по вашему первому обращению и скоро предоставим ответ.[/SIZE][/FONT][/COLOR][/CENTER]<br>' +
    '[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][SIZE=15px] Благодарим за понимание и сотрудничество.[/SIZE][/FONT][/COLOR][/CENTER]<br>' +
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
...

{
    ...
    "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>" +
    "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][SIZE=15px][CENTER]Уважаемый(ая) {{ user.name }}, добрый день![/CENTER][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
	"[CENTER]Пожалуйста, подтвердите, актуально ли ваше обращение?[/CENTER][/FONT][/SIZE]<br><br>" +
...
},
{
	...
	"content": "[SIZE=4][FONT=Trebuchet MS][CENTER]Здравствуйте, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>" +
"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>" +
	"[CENTER]Пожалуйста, обратитесь в нашу Техническую поддержку для получения помощи:[/CENTER]<br>" +
	"[CENTER]• ВКонтакте: [URL=http://vk.com/br_tech]vk.com/br_tech[/URL][/CENTER]<br>" +
	"[CENTER]• Телеграм: [URL=https://t.me/br_techBot]t.me/br_techBot[/URL][/CENTER]<br>" +
	"[CENTER][I][COLOR=rgb(255, 255, 255)]Вопрос рассмотрен[/COLOR][/I].[/CENTER][/FONT][/SIZE]<br><br>" +
"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]",
	"prefix": WATCHED_PREFIX,
	"status": false
},
...
"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]",
	...
	"status": false
        ...
        {
	"title": "Отвязка чужих привязок",
	"content": "[SIZE=4][FONT=Trebuchet MS][CENTER]Здравствуйте, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>" +
"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>" +
	"[CENTER]Мы рассмотрели ваш запрос относительно отвязки привязок.<br>К сожалению, команда технических специалистов, администрация и другие уполномоченные лица не занимаются изменением привязок или дополнительной безопасности аккаунта.<br>" +
	"Ваша заявка была передана техническому специалисту по логированию для проверки на возможный взлом вашего аккаунта.<br>" +
	"[CENTER][I][COLOR=rgb(255, 255, 255)]Ваш запрос был рассмотрен.[/COLOR][/I][/CENTER][/FONT][/SIZE]<br><br>" +
"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]",
	"prefix": TECHADM_PREFIX,
	"status": true
...
{
	"title": "Ошибка со штрафами",
	"color": "",
	"content": "[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>" +
"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>" +
	"[CENTER]Вы столкнулись с ошибкой, связанной со штрафами. Для её исправления вам необходимо выполнить следующие действия: проезд на красный свет, переезд через сплошную линию и оплата всех штрафов в банке.<br>" +
	"Мы уже знаем о данной проблеме и активно работаем над её устранением.<br><br>" +
	"[CENTER][I][COLOR=rgb(255, 0, 0)]Ваш запрос закрыт.[/COLOR][/I][/CENTER][/FONT][/SIZE]<br><br>" +
"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]",
	"prefix": CLOSE_PREFIX,
	"status": false
}
