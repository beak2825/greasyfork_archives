...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/479411/Ink%20version%20selector.user.js
// @updateURL https://update.greasyfork.org/scripts/479411/Ink%20version%20selector.meta.js
// ==/UserScript==

window.onload = function() {
    fetch("https://tech.octopus.energy/ink-frontend/version.json")
        ...
        .then(data => {
            ...
            data.recentVersions.forEach(function(version) {
