// ==UserScript==
// @name         Creditsgrenze für Missionen
...
// @downloadURL https://update.greasyfork.org/scripts/525236/Creditsgrenze%20f%C3%BCr%20Missionen.user.js
// @updateURL https://update.greasyfork.org/scripts/525236/Creditsgrenze%20f%C3%BCr%20Missionen.meta.js
// ==/UserScript==
...
(async () => {
  ...
  const OWN_MISSION_CREDITS_THRESHOLD_DEFAULT = 1000;
  const ALLIANCE_MISSION_CREDITS_THRESHOLD_STORAGE_KEY = 'alliance_mission_credits_threshold';
  const ALLIANCE_MISSION_CREDITS_THRESHOLD_DEFAULT = 1000;
