...
// @downloadURL https://update.greasyfork.org/scripts/405353/Show%20HP%20bar.user.js
// @updateURL https://update.greasyfork.org/scripts/405353/Show%20HP%20bar.meta.js
// ==/UserScript==
    ...
    function refreshLoop() {
        window.requestAnimationFrame(() => {
            ...
            if (first) {
                ...
                var txt = document.createTextNode("Sector 9");
