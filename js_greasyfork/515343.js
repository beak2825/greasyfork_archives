...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/515343/Nedo%20Auto%20Contest%20Participation%20Script%20with%20adblock.user.js
// @updateURL https://update.greasyfork.org/scripts/515343/Nedo%20Auto%20Contest%20Participation%20Script%20with%20adblock.meta.js
// ==/UserScript==
...
(function() {
    ...
    function cleanUpContestPage() {
        ...
        if (contestBlock) {
            ...
            console.log('Содержимое розыгрыша удалено.');
        } else {
            console.log('Блок розыгрыша не найден.');
        }
    }
