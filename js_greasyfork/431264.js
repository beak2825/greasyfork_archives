...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/431264/EnemyIntel_w24.user.js
// @updateURL https://update.greasyfork.org/scripts/431264/EnemyIntel_w24.meta.js
// ==/UserScript==
...
(function() {
    ...
    const ObservarCidade = new MutationObserver(function() {
        LoadSheet("https://docs.google.com/spreadsheets/d/e/2PACX-1vT-4QT-Opppxs6vTQPLx4vP7UYVEY283JIhDayxSS8aly6VETnRjGrGg3oL0xW28-_3jmBWotCJ4dFZ/pubhtml?gid=1307941942&single=true").then(data => {
            let EnemyTropasInfo;
            ...
            $("#FormLinkIntel").html("<a href='https://docs.google.com/forms/d/e/1FAIpQLScA5DeJpv-NTNwOBtS2PKj1wndw3GNRsxQ0kQ17CeKi7e1_kQ/viewform?entry.2081734940="+$('#citycoords').text()+"' target='_blank'>Open in form</a>");
