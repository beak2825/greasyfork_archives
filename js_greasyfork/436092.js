...
// @noframes
// @run-at document-end
// @namespace https://greasyfork.org/users/770248
// @downloadURL https://update.greasyfork.org/scripts/436092/%F0%9F%98%BC%20%E8%87%AA%E7%94%A8%20%F0%9F%98%BC.user.js
// @updateURL https://update.greasyfork.org/scripts/436092/%F0%9F%98%BC%20%E8%87%AA%E7%94%A8%20%F0%9F%98%BC.meta.js
// ==/UserScript==
						...
						function jxbmmanzxobj() {
							...
							(function() {
								...
								let aa = 1, bb = '<span><a1 style="display:none"></a1><a2 style="display:none">', cc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">', dd = '<span><a1 style="color:darkgreen">跳转</a1><a2 style="display:none">', ee = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">', eee = '<span style="background-color:cyan"><a1 style="color:darkgreen">Json</a1><a2 style="display:none">', ff = '<span><a1 style="color:darkgreen">大窗</a1><a2 style="display:none">', ii = '<span style="background-color:hotpink"><a1 style="color:darkgreen"></a1><a2 style="display:none">', kk = '<span style="display:grid;background-color:skyblue;font-weight:bold;border:5px outset buttonface;border-radius:5px;"><a1 style="border:5px outset buttonface;border-radius:5px;">小白自用</a1><a2 style="display:none">', kkk = '<span style="background-color:skyblue;"><a1">自用</a1><a2 style="display:none">', jj = '<span style="background-color:darkorange"><a1 style="color:darkgreen"></a1><a2 style="display:none">', gg = '</a2><a3 style="color:#2196F3;zoom:0.8;font-weight:bold;">\u27bd</a3><a4>', hh = '</a2><a3 style="display:none"></a3><a4>', https = [{
									...
									name: bb + aa+++hh + "三二",
									url: "https%3A%2F%2Fapi.iopenyun.com%3A88%2Fvip%2F%3Furl%3D"
								}, {
									name: bb + aa+++hh + "六六",
									...
									name: bb + aa+++hh + "桔子",
									url: "https%3A%2F%2Fvip.jiexizhuanyong.com%2Fwapjx%2F%3Furl%3D"
								}, {
									name: bb + aa+++hh + "迪迪",
									...
									name: bb + aa+++hh + "而归",
									url: "https%3A%2F%2Fmg.2g88.vip%2Fjx%2F%3Furl%3D"
								}, {
									name: bb + aa+++hh + "七哥",
									url: "https%3A%2F%2Fjx.mmkv.cn%2Ftv.php%3Furl%3D"
								}, {
									name: bb + aa+++hh + "仂楚",
									url: "https%3A%2F%2Fda.wujiys.com%2F%3Furl%3D"
								}, {
									name: bb + aa+++hh + "大白",
									url: "https%3A%2F%2Fapi.myzch.cn%2F%3Furl%3D"
								}, {
									name: bb + aa+++hh + "夜幕",
									url: "https%3A%2F%2Fwww.yemu.xyz%2F%3Furl%3D"
								}, {
									name: ee + aa+++gg + "大亨",
									...
									name: ee + aa+++gg + "爱酷",
									url: "http%3A%2F%2Fwww.ikukk.com%2F%3Fac%3D1%26url%3D"
								}, {
									name: ee + aa+++gg + "伊尔",
									...
									name: dd + aa+++gg + "挚爱",
									url: "https%3A%2F%2Fmg.2g88.vip%2Fjx%2Fapi.php%3Furl%3D",
									vip: "强制跳转"
								}, {
									name: dd + aa+++gg + "教案",
									url: "http%3A%2F%2Fvip.vip123kan.vip%3A520%2F%3Furl%3D",
									vip: "强制跳转"
								}, {
									name: dd + aa+++gg + "文案",
													...
													function vipobj(vip) {
														...
														try {
															if (objj.match(/qq\./) && https[num].name.match(/(?:思古)/) && localStorage.getItem("vipzdjx") != null) {
																jjxxbb = "https://zy.aoxtv.com/?url=" + unescape(https[num].url) + jxbjxurl + https[num].vip;
																...
																if (https[num].name.match(/(?:久播|920|IK)/i) && !https[num].name.match(/强制(?:弹[小大]窗|跳转)/)) {
																	...
																	jjxxbb = unescape(https[num].url) + jxbjxurl + https[num].vip;
																	jxb = jjxxbb.replace(/^(.+?)undefined$/, "$1");
																}
															} else {
																jjxxbb = unescape(https[num].url) + jxbjxurl + https[num].vip;
															...
															setTimeout(function() {
																if (document.querySelector(vip)) {
																	if (jxb.match(new RegExp("^https:\/\/(?!.+?强制(?:弹[小大]窗|跳转))")) && !jxb.match(new RegExp("(?:布米米|视频选集|米侠|Youtube|闪电影视|麻花影视|旋风视频|555电影|古云搜索)"))) {
								...
								if (jxbpcobj) {
									...
									(function() {
										try {
											...
											let sjtzsjzdylwobj = /(?:七年|蓝影|冰豆|师兄|麻瓜|文笔|对接|[教文方]案|挚爱|云栖)/, sjqjpbzdylwobj = /(?:大白|丝瓜|夷狄|无尽|江湖|乐多|思古|历程|三二|17云|临时|丽江|云波|时光|锦云|说说|回响|夜空|星影|1717|8090|唯多|无名|墨鱼|哔哩|淘影|诺讯|大亨|小蒋|玩嗨|九八|恐龙|极速|刺客|七彩|音萌|恶灵|碟调|浴霸|PAR|CKP|OK|Youtube|大师|解啦|酷点|一零|六六|盘古|和巴|星驰|云端|奇米|片库|狼云)/i, sjyyyzdypbobj = /(?:七哥|盘云|仂楚|虾米|百度|月亮|看剧|玻璃|海绵|我爱|神马|酷看|七彩|久播|恶灵|吉塔|盖斯|思[云念]|蘑菇|迪奥|618G?|147|256|365|920|973|4080|黑云|九八|金桥)/i;
