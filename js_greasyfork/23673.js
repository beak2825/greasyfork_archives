...
// @author       Rejutka Lupex
// @match        http://folding.stanford.edu/nacl/
// @grant        none
// @run-at document-body
// @downloadURL https://update.greasyfork.org/scripts/23673/FAH%20Timeout%20Display%20%28Chrome%2C%20Tampermonkey%29.user.js
// @updateURL https://update.greasyfork.org/scripts/23673/FAH%20Timeout%20Display%20%28Chrome%2C%20Tampermonkey%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (myConsole === null)
    {
        ...
        {
            //This is only supposesd to be called once, but we have to check it here
            //because at the time this script is called there is no body.onLoad yet
