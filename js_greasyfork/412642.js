// ==UserScript==
// @name        FUT21 Web App (Public)
// @version     0.1
// @description FUT21 Web App Sy
// @license     MIT
// @author      Sy
...
// @connect     ea.com
// @connect     futbin.com
// @downloadURL https://update.greasyfork.org/scripts/412642/FUT21%20Web%20App%20%28Public%29.user.js
// @updateURL https://update.greasyfork.org/scripts/412642/FUT21%20Web%20App%20%28Public%29.meta.js
// ==/UserScript==
// ==OpenUserJS==
// @author Sy
// ==/OpenUserJS==
...
exports.browser = exports.SettingsEntry = exports.Settings = exports.Queue = exports.Database = exports.BaseScript = undefined;

var _settings = __webpack_require__(126);

var _settingsEntry = __webpack_require__(329);

var _baseScript = __webpack_require__(330);

var _db = __webpack_require__(89);

var _queue = __webpack_require__(331);

var _browser = __webpack_require__(337);
...
var _logger = __webpack_require__(127);

var _pinEvent = __webpack_require__(128);

var _store = __webpack_require__(332);

var _transferMarket = __webpack_require__(333);

var _club = __webpack_require__(336);

var _utils = __webpack_require__(129);

var _utils2 = _interopRequireDefault(_utils);

var _priceTiers = __webpack_require__(130);
...
var _eventEmitterEs = __webpack_require__(328);
...
var DCESettings = exports.DCESettings = function (_SettingsEntry) {
  _inherits(DCESettings, _SettingsEntry);

  function DCESettings() {
    _classCallCheck(this, DCESettings);

    return _possibleConstructorReturn(this, (DCESettings.__proto__ || Object.getPrototypeOf(DCESettings)).call(this, 'dce-features', 'Enable DCE Features'));
  }

  return DCESettings;
}(_core.SettingsEntry);

DCESettings.id = 'dce-features';
...
var _fut = __webpack_require__(90);

var _dce = __webpack_require__(338);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Configuration
var logMode = true; /* eslint-disable */


if (typeof unsafeWindow.onPageNavigation === "undefined") {
  var textAlert = ["ATTENTION", "", "", "Il faut d'abord installer l'userscript FUT ENHANCED", "https://github.com/Mardaneus86/futwebapp-tampermonkey", "", "", "Remplacer 'window.onPageNavigation' par 'unsafeWindow.onPageNavigation' dans l'userscript du dessus", "", "Remplacer 'window.currentPage' par 'unsafeWindow.currentPage' dans l'userscript du dessus"];
  alert(textAlert.join("\n"));

  window.onPageNavigation = new EAObservable();
  window.currentPage = '';

  UTGameFlowNavigationController.prototype.didPush = function (t) {
    if (t) {
      window.onPageNavigation.notify(t.className);
      window.currentPage = t.className;
      if (logMode) console.log(t.className);
    }
  };
  ...
  window.onPageNavigation = unsafeWindow.onPageNavigation;
  window.currentPage = unsafeWindow.currentPage;
}
...
services.Authentication._oAuthentication.observe(undefined, function () {
  ...
  settings.registerEntry(new _dce.DCESettings());
...
var _global = _interopRequireDefault(__webpack_require__(308));
...
var $export = __webpack_require__(0);
var flattenIntoArray = __webpack_require__(284);
var toObject = __webpack_require__(10);
var toLength = __webpack_require__(6);
var aFunction = __webpack_require__(18);
...
var _settings = __webpack_require__(327);
...
exports.default = function (settings) {
  ...
  var settingsPanel = $('.futsettings-sy #settingspanel-sy');
  ...
  $('.futsettings-toggle-sy').click(function () {
    $('.futsettings-sy').toggle();
  });
};
...
// module
exports.push([module.i, ".futsettings-toggle-sy {\n  position: absolute !important;\n  bottom: 60px;\n  right: 20px;\n  z-index: 999; }\n  .futsettings-toggle-sy ::before {\n    font-family: UltimateTeam-Icons,sans-serif;\n    content: \"\\E056\";\n    font-size: 2rem;\n    color: green; }\n\n.futsettings-sy {\n  position: absolute;\n  top: 112px;\n  bottom: 0;\n  left: 105px;\n  right: 0;\n  background-color: #fff;\n  overflow-y: auto;\n  display: none;\n  z-index: 998;\n  padding: 15px; }\n  .futsettings-sy label {\n    color: black; }\n  .futsettings-sy, .futsettings-sy *, .futsettings-sy *:before, .futsettings-sy *:after {\n    box-sizing: border-box; }\n  .futsettings-sy footer {\n    text-align: center;\n    padding: 15px;\n    color: black; }\n    .futsettings-sy footer hr {\n      border: none;\n      border-bottom: 1px solid #ddd; }\n    .futsettings-sy footer p, .futsettings-sy footer li {\n      font-size: smaller;\n      margin: 10px; }\n  .futsettings-sy .settings-title {\n    color: #183f94;\n    font-size: 2.5em;\n    font-weight: 400;\n    font-family: UltimateTeamCondensed,sans-serif;\n    line-height: 1em;\n    margin-bottom: 0.5rem;\n    text-transform: uppercase;\n    width: 100%; }\n  .futsettings-sy .main-setting label {\n    display: inline-block;\n    padding-bottom: 15px;\n    padding-top: 15px; }\n  .futsettings-sy .feature-settings-empty {\n    display: none; }\n  .futsettings-sy .feature-settings {\n    background-color: #f5f5f5;\n    margin-bottom: 25px;\n    padding: 10px;\n    position: relative; }\n    .futsettings-sy .feature-settings .setting {\n      padding: 10px; }\n      .futsettings-sy .feature-settings .setting input[type=number],\n      .futsettings-sy .feature-settings .setting input[type=text] {\n        background-color: #fff;\n        border: 1px #33314e solid;\n        clear: both;\n        color: #33314e;\n        display: block;\n        font-size: 14px;\n        height: 3.5em;\n        padding: 10px;\n        text-align: left;\n        width: 100%; }\n  .futsettings-sy input[type=checkbox] {\n    display: none; }\n    .futsettings-sy input[type=checkbox] + label {\n      cursor: pointer;\n      position: relative;\n      padding-left: 50px; }\n      .futsettings-sy input[type=checkbox] + label:before {\n        background-color: #ccc;\n        border: 1px solid #999;\n        border-radius: 8px;\n        content: '';\n        height: 16px;\n        left: 0;\n        position: absolute;\n        transition: background-color 300ms ease, border-color 300ms ease;\n        width: 40px; }\n      .futsettings-sy input[type=checkbox] + label:after {\n        background-color: #999;\n        border: 1px solid #999;\n        border-radius: 50%;\n        content: '';\n        height: 22px;\n        left: 0;\n        margin-top: -3px;\n        position: absolute;\n        transform: translateX(0);\n        transition: background-color 300ms ease, border-color 300ms ease, transform 300ms ease;\n        width: 22px; }\n    .futsettings-sy input[type=checkbox]:checked + label:before {\n      background-color: #fc87ac;\n      border-color: #f93b78; }\n    .futsettings-sy input[type=checkbox]:checked + label:after {\n      background-color: #f93b78;\n      border-color: #f93b78;\n      transform: translateX(20px); }\n", ""]);
...
module.exports = "<button class=\"futsettings-toggle-sy standard mini call-to-action\">\n  <span class=btn-text></span>\n</button>\n\n<div class=futsettings-sy>\n  <h1 class=settings-title>FUT 21 WebApp - Sy</h1>\n\n  <!-- settings are injected here automatically -->\n  <div id=settingspanel-sy></div>\n</div>\n";
...
var _mathStatistics = __webpack_require__(334);
...
var _errors = __webpack_require__(335);
...
var Club = exports.Club = function () {
  ...
  _createClass(Club, [{
    ...
    key: "getPlayer",
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(defId) {
        var _this2 = this;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  // Recherche
                  services.Item.searchClub(searchCriteria).observe(_this2, function () {
                    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(obs, res) {
                      var items;
                      return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            ...
                            case 5:
                              ...
                              items = items.filter(function (e) {
                                return !(e.isLoaned() || UTItemEntity.isAlex(e.id) || UTItemEntity.isJim(e.id) || UTItemEntity.isDanny(e.id));
                              });
                              ...
                              _context2.next = 10;
                              return new Club().getPlayerConcept(defId);
    ...
    key: "getPlayerConcept",
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(defId) {
        var _this3 = this;
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  // Recherche
                  services.Item.searchConceptItems(searchCriteria).observe(_this3, function (obs, res) {
                    if (!res.success) {
                      obs.unobserve(this);
                      reject(res.status);
                    } else {
      ...
      function getPlayerConcept(_x6) {
        return _ref4.apply(this, arguments);
      }

      return getPlayerConcept;
    }()
  }]);
...
var _settingsEntry = __webpack_require__(131);

var _dceFutbin = __webpack_require__(339);

/* eslint-disable */

exports.DCESettings = _settingsEntry.DCESettings;


new _dceFutbin.DCEFutbin();
...
var DCEFutbin = exports.DCEFutbin = function (_BaseScript) {
  _inherits(DCEFutbin, _BaseScript);

  function DCEFutbin() {
    _classCallCheck(this, DCEFutbin);

    return _possibleConstructorReturn(this, (DCEFutbin.__proto__ || Object.getPrototypeOf(DCEFutbin)).call(this, _settingsEntry.DCESettings.id));
  }

  _createClass(DCEFutbin, [{
    key: 'activate',
    value: function activate(state) {
      _get(DCEFutbin.prototype.__proto__ || Object.getPrototypeOf(DCEFutbin.prototype), 'activate', this).call(this, state);
      this._show(state.screenId);
    }
  }, {
    key: 'onScreenRequest',
    value: function onScreenRequest(screenId) {
      _get(DCEFutbin.prototype.__proto__ || Object.getPrototypeOf(DCEFutbin.prototype), 'onScreenRequest', this).call(this, screenId);
      this._show(screenId);
    }
  }, {
    key: 'deactivate',
    value: function deactivate(state) {
      _get(DCEFutbin.prototype.__proto__ || Object.getPrototypeOf(DCEFutbin.prototype), 'deactivate', this).call(this, state);
    }
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    if ($('.challenge-content').find('.use-sbc-futbin').length === 0) {
                      futbinSBCButton = '<button class="btn-standard use-sbc-futbin">Utiliser un SBC Futbin</button>';

                      $('.challenge-content').append(futbinSBCButton);

                      $('.use-sbc-futbin').click(function () {
                        DCEFutbin._setSBCPlayers();
                      });
                    }
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var SBCController, squad, club, urlFutBin, players, itemPlayers, k, item;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                SBCController = getAppMain().getRootViewController().getPresentedViewController().getCurrentViewController().getCurrentController()._leftController;
                squad = SBCController._squad;
                club = new _fut.Club();
                urlFutBin = prompt("URL SBC Futbin", "");
                _context2.next = 6;
                return DCEFutbin._getFutBinPlayerIds(urlFutBin);
              ...
              case 6:
                ...
                console.log(players);
                itemPlayers = [];
                _context2.t0 = regeneratorRuntime.keys(players);
              ...
              case 10:
                ...
                _context2.next = 14;
                return club.getPlayer(players[k]);
      ...
      function _setSBCPlayers() {
        return _ref2.apply(this, arguments);
      }

      return _setSBCPlayers;
    }()
  }, {
    key: '_getFutBinPlayerIds',
    value: function _getFutBinPlayerIds(url) {
      ...
      return new Promise(function (resolve) {
        return GM_xmlhttpRequest({
          ...
          onload: function onload(res) {
            ...
            var $cards = $(html).find('.cardetails');

            // On récupère que les emplacements titulaires
            var players = [];
            $cards.each(function (index, card) {
              if ($(card).hasClass('hide') == false) {
                var cardDisplay = $(card).find('a > div');
                var resourceId = parseInt($(cardDisplay).attr('data-resource-id'));
                if (resourceId) players.push(resourceId);
              }
            });
...
// new DCEFutbin(); // eslint-disable-line no-new

/***/ })
/******/ ]);
//# sourceMappingURL=fut-enhancer.user.js.map