...
// @version     0.0.1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/12770/OGARio%20Remake.user.js
// @updateURL https://update.greasyfork.org/scripts/12770/OGARio%20Remake.meta.js
// ==/UserScript==
...
var ogario = function(a, b) {
    ...
    function ia() {
        if (Kc = null, (null != ob || 0 != Qa.length) && (null != ob || eb)) {
            ...
            if (Kc.width = 200 * d, Kc.height = c * d, a.scale(d, d), a.globalAlpha = .4, a.fillStyle = "#000000", a.fillRect(0, 0, 200, c), a.globalAlpha = 1, a.fillStyle = "#2E64FE", d = null, d = J("Rank"), a.font = "30px Ubuntu", a.fillText(d, 100 - a.measureText(d).width / 2, 40), null == ob) {
                for (pc = "", a.font = "20px Ubuntu", c = 0; c < Qa.length; ++c) d = Qa[c].name || J("Unnamed_Huh"), eb || (d = J("Unnamed_Huh")), -1 != La.indexOf(Qa[c].id) ? (Ma[0].name && (d = Ma[0].name), a.fillStyle = "#FF7800") : a.fillStyle = 0 == Qa[c].name.indexOf("ƵŦ✭|") ? "purple" : "white", d = c + 1 + ". " + d, pc += d + "<br>", a.fillText(d, 100 - a.measureText(d).width / 2, 70 + 24 * c);
            ...
            if (-1 != Ba.indexOf("Android")) a.ga && a.ga("send", "event", "MobileRedirect", "PlayStore"), setTimeout(function() {
                ...
                if ("undefined" == typeof console || "undefined" == typeof DataView || "undefined" == typeof WebSocket || null == yc || null == yc.getContext || null == a.localStorage) alert("You browser does not support this game, we recommend you to use Firefox to play this");
                    ...
                    var Fc = 500,
                        ...
                        gd = "#koksy;.( ͡° ͜ʖ ͡°);( ͡° ͜ʖ ͡°).;[pl]ziomek00725;wiktorkox100#ht;☪ℒყℎ™♥;ოﻪรէεгofﻪցﻪг皮;w = friend;w=friends;w = friends;w=team;w = team;ą          ę;szczęść boże;ђ૯૨ѳ;ℜℯḱтɐℜ;ℬấℌọʐ ²¹;ｚｙｒｏｎｉｋ;ρʀøƒ 越;┆♕₭↑ℵǥ♕;ઽℓષઽђ¡૯૨;☢ʍ૯∂¡૮™;ј ฝ ☼ᎯᏝᎮℋᎯ;røŀєx ミ;ρષ૨ρષ૨¡ทα ✴".split(";"),
