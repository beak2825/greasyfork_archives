// ==UserScript==
// @name         WarScript - Player Attack Buttons - 3.7.0 - OLD
...
// @downloadURL https://update.greasyfork.org/scripts/558131/WarScript%20-%20Player%20Attack%20Buttons%20-%20370%20-%20OLD.user.js
// @updateURL https://update.greasyfork.org/scripts/558131/WarScript%20-%20Player%20Attack%20Buttons%20-%20370%20-%20OLD.meta.js
// ==/UserScript==
        ...
        const factionPoll = async () => {
            try {
                ...
                if (data && data.members) {
                    ...
                    logDebug("Faction poll ran, but no data.members object was returned from server.");
                }
            } catch (e) {
    ...
    function initializeUI() {
        ...
        settingsButton.onclick = () => {
            ...
            if (apiKey) {
                ...
                // Populate stats after loading rows
        ...
        document.getElementById('faction-fetch-button').addEventListener('click', async () => {
            ...
            if (data && data.members) {
                ...
                if (Array.isArray(data.members)) {
                    logDebug("Detected ARRAY format from Faction Fetch button.");
                    membersArray = data.members;
                } else {
                    logDebug("Detected OBJECT format from Faction Fetch button.");
                    membersArray = Object.keys(data.members).map(id => data.members[id]);
                }
