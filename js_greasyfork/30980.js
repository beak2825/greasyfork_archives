...
// @downloadURL https://update.greasyfork.org/scripts/30980/Hybrid%20-%20Calls%20Contact%20%28Direct%20Dial%29%202.user.js
// @updateURL https://update.greasyfork.org/scripts/30980/Hybrid%20-%20Calls%20Contact%20%28Direct%20Dial%29%202.meta.js
// ==/UserScript==
...
if ($('li:contains("Call")').length) {
    ...
    createButton('Biz on Voicemail',0,0,2,2,3,'The business is listed on the voicemail but with no information pertaining to the contact');
    number.append('<br>');
    number.append('<br>');
