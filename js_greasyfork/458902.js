// ==UserScript==
// @name         Скрипт для КФ | Space script
// @namespace    https://www.cosmemobile.ru/index.php?threads/
// @version      3.8.9
// @description  Always remember who you are!
// @author       Jezeqy
// @match        https://www.cosmemobile.ru/index.php?threads/
// @include      https://www.cosmemobile.ru/index.php?threads/
// @grant        none
// @license    MIT
// @collaborator Richardsssss
// @icon https://i.ibb.co/ScJ8rVK/Picsart-22-07-15-07-44-27-262.png
// @downloadURL https://update.greasyfork.org/scripts/458902/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%20Space%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/458902/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%20Space%20script.meta.js
// ==/UserScript==
 
(function () {
  'use strict';
const UNodobreno = 4; // Prefix that will be set when thread closes
const odobreno = 8; // Prefix that will be set when thread accepted
...
const buttons = [
   ...
   },
   {
    ...
    },
    {
      ...
      content:
       ...
       "[Color=lightblue] Приятной игры на Space.[/color]<br><br>" +
    ...
    },
 {
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП ситуация получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из [URL='cosmemobile.ru/index.php?threads/Space-Правила-написания-roleplay-ситуации.1967870/']Правил написания RP ситуации[/URL][/CENTER][/FONT]",
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша Неофициальная РП организация получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из [URL='cosmemobile.ru/index.php?threads/Space-Правила-подачи-заявления-на-Неофициальную-rp-организацию.1968426/']Правила создания Неофициальной RolePlay организации.[/URL].[/CENTER][/FONT]",
  ...
  $(document).ready(() => {
    ...
    $('button#accepted').click(() => editThreadData(odobreno, false));
    $('button#Ga').click(() => editThreadData(GA_PREFIX, true));
    $('button#Spec').click(() => editThreadData(SPECY_PREFIX, true));
    $('button#teamProject').click(() => editThreadData(COMMAND_PREFIX, true));
    $('button#unaccept').click(() => editThreadData(UNodobreno, false));
