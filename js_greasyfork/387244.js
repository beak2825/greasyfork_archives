...
// @include     https://*/*
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/387244/HTML5%20Video%20Playback%20Speed%20Control%20Keyboard%20Shortcut.user.js
// @updateURL https://update.greasyfork.org/scripts/387244/HTML5%20Video%20Playback%20Speed%20Control%20Keyboard%20Shortcut.meta.js
// ==/UserScript==
...
(function() {
  ...
  */
  ...
  ele.playbackRate = default_speed;
    ...
    if (ele && ev.ctrlKey && !ev.shiftKey && !ev.altKey) {
      ...
      switch (ev.key) {
        ...
        case "]":
          ...
          break;
        case "\\":
          if ((inp = prompt("Enter playback rate increment/decrement unit.", rate)) === null) return;
          if (isNaN(inp = parseFloat(inp.trim())) || (inp <= 0) || (inp >= 16)) {
            alert("Number must be greater than zero, and less than 16.");
            return;
          }
          rate = inp;
          break;
