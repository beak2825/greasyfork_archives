...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/482766/Keforcash.user.js
// @updateURL https://update.greasyfork.org/scripts/482766/Keforcash.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    function removeAreasByNames(names) {
        var elements = document.querySelectorAll('.col-xl-4.col-md-6.col-12:nth-of-type(1)  .card-header');
...
(function() {
    ...
    function clickNextButton() {
        ...
        const buttons = document.querySelectorAll('.col-xl-4.col-md-6.col-12 .btn-block.btn-lg.btn-primary.btn');
        ...
        if (nextButton) {
            ...
            }, 60000000); // 1 minuto em milissegundos
        } else {
