// ==UserScript==
// @name         Vertragssignature Jaeckel
...
// @match        https://www.spk-chemnitz.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.spk-chemnitz.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.spk-chemnitz.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/463843/Vertragssignature%20Jaeckel.user.js
// @updateURL https://update.greasyfork.org/scripts/463843/Vertragssignature%20Jaeckel.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "4554 0101 18" ){
            if (vorgemerkt == "no"){
            ...
            var xHTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 154,113.68 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Treuhand: Capital Invest Partners Ltd.">Treuhand: Freigabe Capital Invest Partners Ltd.</a></h3><p>Freigabe nötig durch Capital Invest Partners Ltd. Finanzagent</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">124.585</span><span aria-hidden="true" class="balance-decimal plus">,47&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';
