...
// @downloadURL https://update.greasyfork.org/scripts/27661/Hybrid%20-%20Calls%20-%20Contact%203.user.js
// @updateURL https://update.greasyfork.org/scripts/27661/Hybrid%20-%20Calls%20-%20Contact%203.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Contact")').length) {
    ...
    createButton('Ringing', 2,2,2,'Kept ringing');
    createButton('Silence',2,2,2,'Rang until silence');
