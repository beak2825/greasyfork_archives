// ==UserScript==
// @name         NOVOSIBIRSK скрипт для КФ
...
// @downloadURL https://update.greasyfork.org/scripts/471741/NOVOSIBIRSK%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/471741/NOVOSIBIRSK%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба была передана на рассмотрение [/color][Color=red] техническому специалисту. @Apparat_Prezidenta[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба была передана на рассмотрение [/color][Color=red] Главному куратору форума. @Nikita_Scherban[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[COLOR=Blue][CENTER]「Ожидайте ответа ❖ На рассмотрение」[/CENTER][/COLOR]',
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба была передана на рассмотрение [/color][Color=red] Зам. Главного куратора форума. @Ildar_Watson [/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		'[COLOR=Blue][CENTER]「Ожидайте ответа ❖ На рассмотрение」[/CENTER][/COLOR]',
    },
    {
