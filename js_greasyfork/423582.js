// ==UserScript==
// @name         TORN: Any OC Payday
// @namespace    com.tornstuff.ocpayday
// @version      2.0
// @author       DeKleineKobini, edited by MightyGoober
// @description  Easily do a payday after completing an oc.
// @match        https://www.torn.com/factions.php?step=your
// @run-at       document-body
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/423582/TORN%3A%20Any%20OC%20Payday.user.js
// @updateURL https://update.greasyfork.org/scripts/423582/TORN%3A%20Any%20OC%20Payday.meta.js
// ==/UserScript==
...
function handleCrime() {
    ...
    let crimeResult = $(".crime-result .make-wrap:last() > p:eq(0)");
    let crimeResultText = crimeResult.text();
    let cashValue = "0";

    if (crimeResultText.indexOf('$') > -1)
    {
        cashValue = crimeResultText.match(/\$(.*) made/i)[1];
    }
