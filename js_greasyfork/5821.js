// ==UserScript==
// @name       eRp Compact BM (redisigned)
// @description gishae's epic redisigned
// @version    1.0.4e (redesigned)
...
// @downloadURL https://update.greasyfork.org/scripts/5821/eRp%20Compact%20BM%20%28redisigned%29.user.js
// @updateURL https://update.greasyfork.org/scripts/5821/eRp%20Compact%20BM%20%28redisigned%29.meta.js
// ==/UserScript==
...
function letsJQuery() {
  ...
  content.prepend('<div id="myStatBoxL" style="z-index:1; position: absolute; top: 560px; left: 10px; width: 160px; opacity: 0.8;"></div>' + '<div id="myOverBox" style="z-index:1; position: absolute; top: 560px; left: 285px; width: 200px; opacity: 0.8;"></div>');
  content.append('<div id="myStatBoxR" style="z-index:100; position: absolute; top: 590px; left: 590px; width: 160px; opacity: 0.8;"></div>');
    ...
    $j('div#MHPSet').before('<div id="MHP" style="position:relative;top:-380px;width:236px;left:250px;clear:both;padding:3px;margin:5px 0;font-weight:bold;color:#000;text-align:center;z-index:999">' + 'Energy:&nbsp;' + '<input id="multihit_count" style="text-align:right;" type="text" size="3" maxlength="4" value="9999" />' + '&nbsp;X 10&nbsp;' + '<button id="multihit_start">HIT!</button><br />' );
...
console.log ( '1');
      if ( unsafeWindow.globalStop ) {
        ...
        multiHitLoopId = setTimeout("jQuery.fn.multiHIT()", 1*60*9999);
