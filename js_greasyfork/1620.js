// ==UserScript==
// @name           MattsinCredibles Awesome Throne 
// @version        1.1
// @namespace      mmm
// @homepage       ---------------
// @delay 2000
...
// @downloadURL https://update.greasyfork.org/scripts/1620/MattsinCredibles%20Awesome%20Throne.user.js
// @updateURL https://update.greasyfork.org/scripts/1620/MattsinCredibles%20Awesome%20Throne.meta.js
// ==/UserScript==


//var xx= {level: 2}; alert(CM.ThronePanelController.calcRiskBarWidth("upgrade", xx, 0))

var Version = '20140502a_Goat';
...
Tabs.throneSalvage = {
        ...
        init : function (div) {
            ...
            var m = '<Div><DIV  id=trSalvage class=trStat>MATTSIN CREDIBLE</div>';
            m += "<div id='trInfoArea'>";
            m += '</div>';
                                ...
                                uW.g_js_strings ? uW.g_js_strings.throneRoom.rare : "Rare", 
                                        uW.g_js_strings ?uW.g_js_strings.throneRoom.epic : "Epic",
                                                ...
                                                init : function (div){
                                                    ...
                                                    // header stuff
                                                    var m = '<Div id=trfield><DIV id=trUpgrader class=trStat>MATTSIN CREDIBLE</div><TABLE id=trupgrader width=100% height=0% class=trTab>';
                                                    m+= '</table></div>';
