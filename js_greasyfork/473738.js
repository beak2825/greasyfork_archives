// ==UserScript==
// @name         Moscow | Скрипт для Кураторов Форума "Жалобы" [by Maxim_Bryanskiy]
// @namespace    https://forum.blackrussia.online
// @version      7.6
// @description  По вопросам(ВК): https://vk.com/maximdashunin
// @author       Maxim Bryanskiy
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license 	 MIT
// @collaborator none
// @icon  https://i.postimg.cc/rsg21sbV/6973d77e-7327-48a2-8fd2-15c7fa692e99.jpg
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/473738/Moscow%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%22%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B%22%20%5Bby%20Maxim_Bryanskiy%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/473738/Moscow%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%22%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B%22%20%5Bby%20Maxim_Bryanskiy%5D.meta.js
// ==/UserScript==
...
const buttons = [
...

     {
	  ...
	  content:
		...
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF]Ваша жалоба взята на рассмотрение, не создавайте дубликатов и ожидайте ответа от администрации.<br><br>"+
        "[B][CENTER][COLOR=#FFFFFF]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR]<br><br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/1tPzCBPC/download-2.gif[/img][/url]<br>' ,
	  prefix: PIN_PREFIX,
	  status: true,
	},
     {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman] Вашa жалобa составленa не по форме, пожалуйста ознакомьтесь с правилами подачи жалоб.[/FONT]<br><br>"+
		"[CENTER][B][COLOR=RED][FONT=times new roman]| [URL='https://forum.blackrussia.online/index.php?threads/3429394/'][Color=lavender]Правила подачи жалоб[/URL] [COLOR=RED]|[/FONT]<br>"+
	    "[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	...
	},
    {
	  ...
	  content:
		...
		"[B][CENTER][COLOR=lavender]Со стороны игрока не найдены какие либо нарушение, пожалуйста ознакомьтесь с правилами проекта.<br>"+
         "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR]<br><br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
     {
	...
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Вы не предоставили какие либо доказательства о нарушении , прикрепите доказательства загруженные на фото/видео хостинг в следующей жалобе.<br>"+
          "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR]<br><br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Предоставленных доказательств недостаточно для принятия решения, если у вас имеются дополнительные доказательства прикрепите их в следующей жалобе.<br>"+
	    "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR]<br><br>",
	  prefix: UNACCEPT_PREFIX,
	  status: true,
	},
	...
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender][FONT=times new roman]Ваши доказательства не рабочие или же битая ссылка, пожалуйста загрузите на видео/фото хостинге.[/FONT]<br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
	...
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Если видео длится 2х и более минут, вам следует указать таймкоды, в противном случае жалоба будет отказана.<br>"+
	    "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR]<br><br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
	...
	},
   {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба отказана , т.к займ может быть осуществлен только через зачисление игровых ценностей на банковский счет.<br>"+
		 "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR]<br><br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
	...
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender][FONT=times new roman] Вашa жалобa отказана , т.к промокод является системным.[/FONT]<br><br>"+
	    "[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
	...
	},
   {
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]2.04 | [color=lavender] Запрещены любые действия способные привести к помехам в игровом процессе, а также выполнению работ, если они этого не предусматривают и если эти действия выходят за рамки игрового процесса данной работы. | Ban 10 дней / Обнуление аккаунта (при повторном нарушении) [/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Наказание будет выдано в течение 24 часов.<br>"+
	    "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR]<br><br>",
         prefix: ACCEPT_PREFIX,
	  status: false,
    },
  {
	...
	},
    {
	  ...
	  content:
		...
		"[CENTER][COLOR=lavender] Наказание будет выдано в течение 24 часов.<br>"+
		"[B][CENTER][COLOR=lavender][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},
     {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][FONT=times new roman][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B][/FONT]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]2.18  [color=lavender] Запрещен MG (MetaGaming) — использование ООС информации, которую Ваш персонаж никак не мог получить в IC процессе.[color=red]  | Mute 30 минут.[/Spoiler][/FONT]<br>"+
		"[CENTER][COLOR=#FFFFFF][FONT=times new roman] Наказание будет выдано в течение 24 часов.[/FONT]<br>"+
	    "[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]3.03 | [color=lavender] Любые формы оскорблений, издевательств, расизма, дискриминации, религиозной враждебности, сексизма в (IC или OOC) чате запрещены[color=red]  | Mute 30 минут[/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Наказание будет выдано в течение 24 часов.<br>"+
	    "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR]<br><br>",
	  prefix: ACCEPT_PREFIX,
	  status: false,
 ...
 "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>"+
	...
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]3.09 | [color=lavender] Запрещены любые угрозы о наказании игрока со стороны администрации [color=red]  | Mute 30 минут[/Spoiler][/FONT]<br>"+
		"[CENTER][COLOR=#FFFFFF][FONT=times new roman] Наказание будет выдано в течение 24 часов.[/FONT]<br>"+
	    "[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: ACCEPT_PREFIX,
	  status: false,
	...
	},
{
	  ...
	  content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]2.05 | [color=lavender] Запрещены любые OOC обманы и их попытки, а также любые IC обманы с нарушением Role Play правил и логики[color=red]  | Permban[/Spoiler][/FONT]<br>"+
		"[CENTER][COLOR=#FFFFFF][FONT=times new roman] Наказание будет выдано в течение 24 часов.<br>[/FONT]"+
	    "[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]*  [color=lavender] Запрещено редактирование объявлений, не соответствующих ПРО[color=red]  | Mute 30 минут/Ban 7 дней[/Spoiler][/FONT]<br>"+
		"[CENTER][COLOR=#FFFFFF][FONT=times new roman] Наказание будет выдано в течение 24 часов.[/FONT]<br>"+
	    "[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: ACCEPT_PREFIX,
	  status: false,
   ...
   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
	...
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Ваша жалоба была передана Техническому специалисту сервера на рассмотрение[/FONT] <br>"+
        "[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Возможно на рассмотрении жалобы потребуется больше времени. Просьба ожидать ответа и не создавать копий данной темы.[/FONT] <br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>"+
	...
	},
{
	...
	},
	{
	  ...
	  content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров.[/FONT]<br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	...
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=#00FF00][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Вы ошиблись разделом, обратитесь в раздел жалоб на сотрудников данной организации.[/COLOR][/CENTER][/FONT] <br>"+
		"[B][CENTER][COLOR=#FFFFFF][FONT=times new roman]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=#FFFFFF]RU[COLOR=#0000FF]SS[COLOR=#FF0000]IA[/COLOR] [Color=#FF0000]MOSCOW[/COLOR][/FONT]<br><br>",
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
