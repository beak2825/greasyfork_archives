...
// @match        *://*.91huayi.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/455292/%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E8%87%AA%E6%94%B9%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/455292/%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E8%87%AA%E6%94%B9%E7%89%88.meta.js
// ==/UserScript==
...
(function () {
    ...
    function getHuayi() {
        return {
            ...
            doResult: function () {
                var res = document.querySelector("#ctl00 > div.state_container > div.state_cent_box > div.state_tips > p").innerText;
                var dds = document.getElementsByClassName("state_cour_lis");
                ...
                if (res == "考试通过"||res == "考试通过！"||res == "完成项目学习可以申请学分了" ) { //考试通过
                    ...
                    for (var i = 0; i < dds.length; ++i) {
                        qWrong[dds[i].innerText.substring(2).replace(/\s*/g,"")]=i
    ...
    function addinfo(){//插入说明
        ...
        adiv2.innerHTML='说明：<br>1.默认情况下本脚本不调整播放速度，如果你选择了加速，会记录你目前选择的播放速度<br>2.如果你选择倍速播放后，系统提示课程没有听完，请试试1倍速。<br><h3>3.取消自动跳过功能。</h3>';
        adiv2.id='jsinfo';
