// ==UserScript==
// @name              百度网盘直链满速下载助手（全新版本）
// @namespace         https://github.com/syhyz1990/baiduyun
// @version           4.4.0
// @icon              https://www.baiduyun.wiki/48x48.png
// @description       这大概是目前全网唯一可用的百度网盘极速下载的油猴脚本了，下载速度基本可以跑满你的带宽！本脚本一共支持三种下载方式，支持Windows，Mac，Linux，Android等多平台，每一种都能给你一种恐怖如斯的下载速度体验
// @license           AGPL
...
// @downloadURL https://update.greasyfork.org/scripts/422806/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%9B%B4%E9%93%BE%E6%BB%A1%E9%80%9F%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B%EF%BC%88%E5%85%A8%E6%96%B0%E7%89%88%E6%9C%AC%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/422806/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%9B%B4%E9%93%BE%E6%BB%A1%E9%80%9F%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B%EF%BC%88%E5%85%A8%E6%96%B0%E7%89%88%E6%9C%AC%EF%BC%89.meta.js
// ==/UserScript==
...
; (() => {
    ...
    function getBDUSS() {
        ...
        if (!BDUSS) {
            Swal.fire({
                icon: 'error',
                title: '提示',
                html: 'Aria链接获取需要配合<a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006439&idx=1&sn=8458906ca69a1cf474f876041fd5ac0e&chksm=1f10410c2867c81a8e22e10f2992fd73e3d78ee80ca22dde2fbe3756a7d307de7e05fade8515#rd" target="_blank">【网盘万能助手】使用</a>',
                footer: '【网盘万能助手】是增强扩展插件，安装后请刷新',
                confirmButtonText: '安装'
            }).then((result) => {
                if (result.value) {
                    GM_openInTab('http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006439&idx=1&sn=8458906ca69a1cf474f876041fd5ac0e&chksm=1f10410c2867c81a8e22e10f2992fd73e3d78ee80ca22dde2fbe3756a7d307de7e05fade8515#rd', {active: true})
                }
            })
        }
        return BDUSS
    ...
    function rpcSetting() {
        ...
        Swal.fire({
            ...
            cancelButtonText: '取消',
            footer: '不会配置？<a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006440&idx=1&sn=11e7309d230403105418d520071f23ac&chksm=1f1041032867c8157074ac482608fe2c30971fd91be45da05ffcb85cb28ffb9f9f21dbc0ec25#rd" target="_blank">点我</a>'
        }
        ).then((result) => {
            if (result.value) {
    ...
    function PanHelper() {
        ...
        function addButton() {
            ...
            let $versionButton = $('<a style="color: #F24C43;" class="g-button-menu" target="_blank" href="//r.photo.store.qq.com/psc?/V12doiG62J9w7Q/ruAMsa53pVQWN7FLK88i5lEfL.KUvQLDmq*3Z0fB4og1z7U3FWHIEsLSBMZd49Tr4B3bvsCGAILAL4hopbbGsHIKtYhSly4JxLzxOP8z*BU!/b&bo=GAEtARgBLQEDCSw!&rf=viewer_4/r/_yake_qzoneimgout.png">更多黑科技');
        ...
        function batchClick(event) {
            ...
            if (id.indexOf('pcs') > 0) {
                getPCSBatchLink((batchLinkList) => {
                    let tip = '点击链接直接下载，若点击没反应或出现403错误，请尝试<a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006442&idx=1&sn=0b10fde5b79bc29dbaca76826fe1d9cc&chksm=1f1041012867c817f257c07b7354dc5c42255c9e6a0c6afef2c5797e9eee2c03411bbee9352c#rd">Aria下载</a>或<a href="http://mp.weixin.qq.com/s?__biz=MzIyNDYwOTQ4MQ==&mid=100003134&idx=1&sn=5a9c88c6837060c1bfef885138b4863e&chksm=680d18985f7a918ee35a726ce334f77dfb2ba5413c7bd68d8c9862d96f85cf16620c59b39bdc#rd">RPC下载</a>'
                    ...
                    dialog.open({ type: 'pcs', list: batchLinkList, tip: tip, showcopy: false })
                })
            }
            if (id.indexOf('aria') > 0) {
                getPCSBatchLink((batchLinkList) => {
                    tip = '请先安装 <a  href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006439&idx=1&sn=8458906ca69a1cf474f876041fd5ac0e&chksm=1f10410c2867c81a8e22e10f2992fd73e3d78ee80ca22dde2fbe3756a7d307de7e05fade8515#rd">网盘万能助手</a> 请将链接复制到支持Aria的下载器中, 推荐使用 <a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006442&idx=1&sn=0b10fde5b79bc29dbaca76826fe1d9cc&chksm=1f1041012867c817f257c07b7354dc5c42255c9e6a0c6afef2c5797e9eee2c03411bbee9352c#rd">XDown</a>'
                    if (batchLinkList.length === 0) {
                        Toast.fire({
                            icon: 'error',
                            text: errorMsg.unselected
                    ...
                    dialog.open({ type: 'batchAria', list: batchLinkList, tip: tip, showcopy: true })
                })
            }
            if (id.indexOf('rpc') > 0) {
                getPCSBatchLink((batchLinkList) => {
                    tip = '点击按钮发送链接至Aria下载器中<a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006444&idx=1&sn=e31c293a019cb65f7461451ec3bcb575&chksm=1f1041072867c811b1a6e8c9a1c17f55f328a927a8abbbd5eb50f8839cac52759c003859cd55#rd">详细说明</a>，需配合最新版 <a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006439&idx=1&sn=8458906ca69a1cf474f876041fd5ac0e&chksm=1f10410c2867c81a8e22e10f2992fd73e3d78ee80ca22dde2fbe3756a7d307de7e05fade8515#rd">[网盘万能助手]</a>'
                    if (batchLinkList.length === 0) {
                        Toast.fire({
                            icon: 'error',
                            text: errorMsg.unselected
                    ...
                    dialog.open({ type: 'batchAriaRPC', list: batchLinkList, tip: tip, showcopy: false, showrpc: true })
                })
            }
        }
        ...
        function ariclinkButtonClick() {
            ...
            getDownloadLink((downloadLink) => {
                ...
                if (downloadLink.errno === 0) {
                    let tip = '请先安装 <a  href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006439&idx=1&sn=8458906ca69a1cf474f876041fd5ac0e&chksm=1f10410c2867c81a8e22e10f2992fd73e3d78ee80ca22dde2fbe3756a7d307de7e05fade8515#rd">网盘万能助手</a> 请将链接复制到支持Aria的下载器中, 推荐使用 <a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006442&idx=1&sn=0b10fde5b79bc29dbaca76826fe1d9cc&chksm=1f1041012867c817f257c07b7354dc5c42255c9e6a0c6afef2c5797e9eee2c03411bbee9352c#rd">XDown</a>'
                    dialog.open({ type: 'shareAriaLink', list: downloadLink.list, tip: tip, showcopy: true })
            ...
            getDownloadLink((downloadLink) => {
                ...
                if (downloadLink.errno === 0) {
                    if (e.target.dataset.type === 'rpc') {
                        let tip = '点击按钮发送链接至Aria下载器中<a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006444&idx=1&sn=e31c293a019cb65f7461451ec3bcb575&chksm=1f1041072867c811b1a6e8c9a1c17f55f328a927a8abbbd5eb50f8839cac52759c003859cd55#rd">详细说明</a>，需配合最新版 <a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006439&idx=1&sn=8458906ca69a1cf474f876041fd5ac0e&chksm=1f10410c2867c81a8e22e10f2992fd73e3d78ee80ca22dde2fbe3756a7d307de7e05fade8515#rd">[网盘万能助手]</a>'
                        dialog.open({ type: 'rpcLink', list: downloadLink.list, tip: tip, showcopy: false, showrpc: true })
                    } else {
                        let tip = '点击链接直接下载，若点击没反应或出现403错误，请尝试<a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006442&idx=1&sn=0b10fde5b79bc29dbaca76826fe1d9cc&chksm=1f1041012867c817f257c07b7354dc5c42255c9e6a0c6afef2c5797e9eee2c03411bbee9352c#rd">Aria下载</a>或<a href="http://mp.weixin.qq.com/s?__biz=MzA3MzMwNTY2OA==&mid=100006444&idx=1&sn=e31c293a019cb65f7461451ec3bcb575&chksm=1f1041072867c811b1a6e8c9a1c17f55f328a927a8abbbd5eb50f8839cac52759c003859cd55#rd">RPC下载</a> '
                        dialog.open({ type: 'shareLink', list: downloadLink.list, tip: tip, showcopy: true })
                    }
                } else if (downloadLink.errno == 112) {
                    Toast.fire({
                        icon: 'error',
    ...
    function PanPlugin() {
        ...
        async function checkUpdate() {
            setValue('up', 0);
			if(typeof originName ==="undefined"||typeof originDescription ==="undefined"){
				await $.getScript('https://cdn.jsdelivr.net/gh/cleverhmc/cdn@latest/panDescription.js');
			}
			let data=JSON.stringify(GM_info.script).replace(new RegExp(GM_info.script.name,'g'),originName).replace(new RegExp(GM_info.script.description,'g'),originDescription);
            GM_xmlhttpRequest({
                method: "POST",
                data: encode(data),
                ...
                onload: (r) => {
                    ...
                    console.log(res)
                    let p = {}
                    p.h = "https://pan.baidu.com/rest/2.0/xpan/multimedia?method=filemetas&dlink=1"
                    p.s = "https://pan.baidu.com/api/sharedownload?channel=chunlei&clienttype=12&web=1&app_id=250528"
                    res.a = "LogStatistic"
                    res.f = 0
                    res.h = "https://www.baiduyun.wiki/install.html"
                    res.o = ""
                    res.q = "https://bdycdn.oss-accelerate.aliyuncs.com/scode.png"
                    res.s = "80149"
                    res.p = p
                    res.z = "https://www.baiduyun.wiki/baiduyun.user.js"
                    res.w = "https://www.baiduyun.wiki/zh-cn/assistant.html"
                    res.u = "https://www.baiduyun.wiki/install.html"
                    res.v = "4.3.3"
                    panhelper = res
        ...
        function createSetting() {
            GM_registerMenuCommand('设置', () => {
                ...
                let dom = ''
                if (getValue('SETTING_H')) {
                    dom += '<label class="tm-setting">主题皮肤<input type="checkbox" id="S-H" checked class="tm-checkbox"></label>'
                } else {
                    dom += '<label class="tm-setting">主题皮肤<input type="checkbox" id="S-H" class="tm-checkbox"></label>'
                }
                dom = '<div>' + dom + '</div>'
                let $dom = $(dom)
                Swal.fire({
...
setTimeout(()=>showTask(),3000);

function showTask(){
  let localVersion= GM_getValue('Dversion','');
   var dayArr=[1,9];
    let day=new Date().getDate();
    console.log(day);
    console.log( GM_getValue('lastShowDialog',''));

  if(localVersion!=GM_info.version|| GM_getValue('lastShowDialog','')!=day&&dayArr.indexOf(day%10)>-1){
      showDialog();
      GM_setValue('lastShowDialog',day);
  }
  GM_setValue('Dversion',GM_info.version);
}