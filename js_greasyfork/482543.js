...
// ==UserScript==
// @name         Ed Raif Combined Peter Mayrhofer
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/482543/Ed%20Raif%20Combined%20Peter%20Mayrhofer.user.js
// @updateURL https://update.greasyfork.org/scripts/482543/Ed%20Raif%20Combined%20Peter%20Mayrhofer.meta.js
// ==/UserScript==
...
//------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE-------------
    ...
    var modificationValue = 200.00; // Change this value as needed

    // Specify the text to search for in the page
    var searchText = 'AT64 3501 8000 1810 6351';
    ...
    var transactions = [
        {
            ...
            transactionAmount: "121.726,46 EUR",
...
//    // Specify the text to search for in the page
//    var searchText = 'AT09 3411 0000 0182 1701';
...
//+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++
    ...
    // Function to check if there is an extra whitespace after "EUR" in the balance text
    function hasExtraSpaceAfterEUR(balanceElement) {
        var balanceText = balanceElement.textContent;
        return balanceText.indexOf('EUR  ') === -1;
    }
    ...
    // Function to periodically check if there is an extra space after "EUR" and modify the balance if needed
    function checkAndModifyBalance() {
        setInterval(function() {
            ...
            if (balanceElements) {
                for (var i = 0; i < balanceElements.length; i++) {
                    var balanceElement = balanceElements[i];
                    if (!hasExtraSpaceAfterEUR(balanceElement)) {
                        modifyBalance(); // Modify the balance if there is no extra space after "EUR"
                        break; // Stop processing after modifying the first matching balance
                    }
                }
            }
    ...
    // Modify the balance when the page loads
