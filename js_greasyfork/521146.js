// ==UserScript==
// @name         Pyatak for Curator | Modded (68)
// @namespace    https://forum.blackrussia.online/
// @version      6.0.3
// @description  Специально для BlackRussia || GROZNY by A.Pyatak
// @author       A.Pyatak | modded by D.Korneplod
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @match        https://forum.blackrussia.online/forums/*
// @include      https://forum.blackrussia.online/forums/
// @icon         https://i.pinimg.com/originals/f5/ce/07/f5ce07ed4814f23593b4f62f4145227d.jpg
// @grant        none
// @license      MIT
// @supportURL https://vk.com/id524085094
// @downloadURL https://update.greasyfork.org/scripts/521146/Pyatak%20for%20Curator%20%7C%20Modded%20%2868%29.user.js
// @updateURL https://update.greasyfork.org/scripts/521146/Pyatak%20for%20Curator%20%7C%20Modded%20%2868%29.meta.js
// ==/UserScript==
...
(async function () {
    ...
    const buttons = [
     {
            title: `Приветствие`,
            content: `[CENTER][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/CENTER]`,
     },
     {
     ...
     },
     {
            ...
            content:`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый(-ая)[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
     ...
     },
     {
            ...
            content: `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый(-ая)[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`,
	...
	},*/
    {
        title: `В раздел ОБЖ`,
        content:
            `[CENTER][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR]${user.mention}<br><br>`+
    ...
    const buttons2 = [
      ...
      content: `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
    ...
    //   content:
    //     `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый(-ая)[/COLOR] ${user.mention}[/CENTER]<br><br>`+
    ...
    },
    {
      ...
      content:
        `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
    ...
    const buttons3 = [
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER][SIZE=4][FONT=georgia]Ваша жалоба была одобрена, с администратором будет проведена беседа.[/font]<br><br>` +
        ...
        },
        {
            title: `Ошибка от администора (относящиеся к игре)`,
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/SIZE][/CENTER]<br><br>`+
                `[CENTER][SIZE=4][FONT=georgia]Администратор совершил ошибку.<br>` +
                `[SIZE=4][FONT=georgia]Приносим свои извинения за предоставленные неудобства.[/font][/size][/CENTER]<br><br>` +
                `[CENTER][COLOR=rgb(0, 255, 0)]Рассмотрено.[/COLOR][/CENTER]<br>`,
            prefix: WATCHED_PREFIX,
            status: false,
        },
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER][SIZE=4][FONT=georgia]Передаю вашу жалобу - [COLOR=rgb(204, 19, 4)]Главному Администратору[/color][/FONT][/SIZE][/center]<br><br>`+
                `[center][COLOR=rgb(251, 160, 38)]На рассмотрении.[/COLOR][/CENTER]<br>`,
            prefix: GA_PREFIX,
            status: true,
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER][SIZE=4][FONT=georgia]Ваша жалоба перенесена в нужный раздел.[/FONT][/SIZE][/CENTER]<br>`+
                `[CENTER][SIZE=4][FONT=georgia]Ожидайте ответа..[/FONT][/SIZE][/CENTER]<br>`,
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER][SIZE=4][FONT=georgia]После рассмотрения вашей жалобы, было принято решение:[/CENTER]<br>` +
                `[CENTER]Наказание выдано верно![/CENTER]<br><br>` +
                `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE]<br><br>`+
                `[SIZE=4][FONT=georgia]Не увидел доказательств, которые подтверждают нарушение администратора.<br>`+
                `[CENTER][SIZE=4][FONT=georgia]Пожалуйста, прикрепите доказательства к жалобе, которые подтверждают нарушение администратора.<br><br>`+
                `[COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
            prefix: UNACCEPT_PREFIX,
            status:false,
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER][SIZE=4][FONT=georgia]]Жалоба составлена не по форме.[/FONT][/SIZE][/CENTER]<br>` +
                `[CENTER][SIZE=4][FONT=georgia]Внимательно прочитайте правила составления жалобы - [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-администрацию.3429349/']*ТЫК*[/URL][/FONT][/SIZE][/CENTER]<br><br>` +
                `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/CENTER]<br>`,
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
            ...
            content:
            `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR]${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
            `[CENTER][SIZE=4][FONT=georgia]Дело в вашем айпи адресе.[/FONT][/SIZE][/CENTER]<br>` +
            `[CENTER][SIZE=4][FONT=georgia]Попробуйте сменить его на старый с которого вы играли раньше.<br>Смените интернет соединение или же попробуйте использовать впн.[/FONT][/SIZE][/CENTER]<br>` +
            `[CENTER][SIZE=4][FONT=georgia]Ваш аккаунт не в блокировке[/FONT][/SIZE][/CENTER]<br><br>` +
            `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/CENTER]<br>`,
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
            ...
            content: `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
            `[CENTER][SIZE=4][FONT=georgia]С момента выдачи наказания прошло более 48 часов.[/CENTER]<br>` +
            `[CENTER][SIZE=4][FONT=georgia]Рассмотрению не подлежит.[/FONT][/SIZE][/CENTER]<br><br>` +
            `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/CENTER]<br>`,
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
	      ...
	      content:
	      `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
	      `[CENTER][SIZE=4][FONT=georgia]Ваша жалоба была одобрена и будет проведена беседа с администратором.[/FONT][/SIZE][/CENTER]<br>` +
          `[CENTER][SIZE=4][FONT=georgia]Ваше наказание будет снято в течении часа, если оно еще не снято.[/FONT][/SIZE][/CENTER]<br><br>`+
          `[CENTER][COLOR=rgb(0, 255, 0)]Одобрено.[/COLOR][/CENTER]<br>`,
	      prefix: ACCEPT_PREFIX,
	      status: false,
	    },
        {
            title: `Ошибочка адм (наказание)`,
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/SIZE][/CENTER]<br><br>`+
                `[CENTER][SIZE=4][FONT=georgia]Администратор ошибся, наказание будет снято, если оно ещё не снято.<br>` +
                `[SIZE=4][FONT=georgia]Приносим свои извинения за предоставленные неудобства.[/font][/size][/CENTER]<br><br>` +
                `[CENTER][COLOR=rgb(0, 255, 0)]Рассмотрено.[/COLOR][/CENTER]<br>`,
            prefix: WATCHED_PREFIX,
            status: false,
    ...
    },
    {
      ...
      content:
        `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER][SIZE=4][FONT=georgia]Дублирование темы. Если вы дальше будете заниматься данной деятельностью (дублированием тем), то ваш форумный аккаунт будет заблокирован на 3 дня и более.[/FONT][/SIZE][/CENTER]<br><br>` +
        `[CENTER][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/CENTER]`,
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    ...
    $(document).ready(() => {
        ...
        $(`button#vidano_verno`).click(() => pasteContent3(11, threadData, true));
        ...
        $(`button#netopra`).click(() => pasteContent3(12, threadData, true));
        $(`button#forma`).click(() => pasteContent3(13, threadData, true));
        $(`button#ip-adress`).click(() => pasteContent3(14, threadData, true));
        $(`button#48-hours`).click(() => pasteContent3(15, threadData, true));
        $(`button#nekk_vidano`).click(() => pasteContent3(16, threadData, true));
        $(`button#oshibka`).click(() => pasteContent3(17, threadData, true));
