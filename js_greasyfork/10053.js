...
// @downloadURL https://update.greasyfork.org/scripts/10053/exp3000.user.js
// @updateURL https://update.greasyfork.org/scripts/10053/exp3000.meta.js
// ==/UserScript==
/*
	**************************
	****** Informations ******
...
var strFunc = (function(){		
	...
	function afficherTable() {
		...
		var elHTML = document.getElementById("IFC_table_main");     
		var inner = elHTML.innerHTML;
	...
	function afficherOption() {
		var elHTML_3 = document.getElementById("IFC_table_main");     
	...
	function afficher_BBCode() {
		var elHTML_4 = document.getElementById("IFC_table_main");  
	...
	function recuperer_CSSOgame_width() {
		var styleTmp = document.getElementById("IFC_table_main").currentStyle || window.getComputedStyle(document.getElementById("IFC_table_main"), null); // récupéré sur http://javascript.developpez.com/faq/javascript/?page=CSS (FAQ JS) ; multi-naviguateur (d'où l'emploi du ||)
