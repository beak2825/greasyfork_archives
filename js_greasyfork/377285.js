...
// @downloadURL https://update.greasyfork.org/scripts/377285/%E7%94%B5%E8%84%91%E7%AB%AF%E8%A7%86%E9%A2%91%E8%B7%B3%E8%BF%87%E5%B9%BF%E5%91%8A%E5%92%8C%20VIP%20%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/377285/%E7%94%B5%E8%84%91%E7%AB%AF%E8%A7%86%E9%A2%91%E8%B7%B3%E8%BF%87%E5%B9%BF%E5%91%8A%E5%92%8C%20VIP%20%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
...
(function() {
    ...
    var originalInterfaceList = [
     {name:"思古",url:"https://api.bbbbbb.me/jx/?url=","type":"站内"},
     {name:"大表哥",url:"https://jx.biaoge.tv/index.php?url=","type":"站内"},
     {name:"030e",url:"https://030e.com/0302/?url=","type":"站内"},
     {name:"beac",url:"https://beaacc.com/api.php?url=","type":"站内"},
     {name:"金桥",url:"https://jqaaa.com/jx.php?url=","type":"站内"},
     {name:"秒视",url:"https://jx.hsir.top/?url=","type":"站内"},


     {name:"无名",url:"http://www.wmxz.wang/video.php?url=","type":"站外"},
     {name:"百域",url:"http://app.baiyug.cn:2019/vip/index.php?url=","type":"站外"},
     {name:"1717",url:"http://www.1717yun.com/jx/ty.php?url=","type":"站外"},
     {name:"大亨",url:"http://jx.cesms.cn/?url=","type":"站外"},
    ...
    setTimeout(function(){
        ...
        var jiexiDIV = "<div style='display:flex;'><div style='width:180px;padding:10px 0;'><div style='text-align:center;color:#cccccc;line-height:20px;'>站内解析</div>" +
            ...
            "<ul style='margin:0 10px;'>" + outerli + "<div style='clear:both;'></div></ul></div></div>";
        ...
        if (location.href.indexOf("www.iqiyi.com") > -1){
            GMaddStyle(`.fn-iqiyi-jiexi li{color:#cccccc;text-align:center;width:60px;line-height:25px;float:left;border:1px solid gray;border-radius:8px;padding:0 0;margin:4px 8px;}`);
            ...
            GMaddStyle(`.fn-qq-jiexi li{text-align:center;width:60px;line-height:25px;float:left;border:1px solid gray;border-radius:8px;padding:0 0;margin:4px 8px;}`);
            ...
            GMaddStyle(`.fn-youku-jiexi li{color:#cccccc;text-align:center;width:60px;line-height:25px;float:left;border:1px solid gray;border-radius:8px;padding:0 0;margin:4px 8px;}`);
            ...
            GMaddStyle(`.fn-mgtv-jiexi li{color:#cccccc;text-align:center;width:60px;line-height:25px;float:left;border:1px solid gray;border-radius:8px;padding:0 0;margin:4px 8px;}`);
            ...
            GMaddStyle(`.fn-sohu-jiexi li{color:#cccccc;text-align:center;width:60px;line-height:25px;float:left;border:1px solid gray;border-radius:8px;padding:0 0;margin:4px 8px;}`);
            ...
            GMaddStyle(`.fn-le-jiexi li{color:#cccccc;text-align:center;width:60px;line-height:25px;float:left;border:1px solid gray;border-radius:8px;padding:0 0;margin:4px 4px;}`);
            ...
            GMaddStyle(`.fn-tudou-jiexi li{color:#cccccc;text-align:center;width:60px;line-height:25px;float:left;border:1px solid gray;border-radius:8px;padding:0 0;margin:4px 8px;}`);
            ...
            GMaddStyle(`
                       #fn-pptv-jiexi li{width:auto;color:#cccccc;background:0;text-align:center;width:60px;line-height:25px;float:left;border:1px solid gray;border-radius:8px;padding:0 0;margin:4px 8px;}
