...
// @namespace    yeyu
// @version      0.5
// @description  叔叔不约只配女，你懂我
// @author       夜雨
// @match        *://*.shushubuyue.net/*
// @match        *://*.shushubuyue.com/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=shushubuyue.net
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/494327/%E5%8F%94%E5%8F%94%E4%B8%8D%E7%BA%A6%E5%8F%AA%E9%85%8D%E5%A5%B3.user.js
// @updateURL https://update.greasyfork.org/scripts/494327/%E5%8F%94%E5%8F%94%E4%B8%8D%E7%BA%A6%E5%8F%AA%E9%85%8D%E5%A5%B3.meta.js
// ==/UserScript==
...
(function() {
	...
	function init() {
		setInterval(() => {
			...
			if (tabText && typeof tabText == 'string' && tabText.indexOf("生") != -1) {
				firstAuto = true
				//生
				leave()
