// // ==UserScript==
// @name         VLADIKAVKAZ | ADM Script for forum by Tsoi
// @namespace    https://forum.blackrussia.online
// @version      3.1.0
// @description  Скрипт для Руководства сервера Vladikavkaz от Ivan_Tsoi. Предложения что добавить сюда -> vk.com/kirillsokol
// @author       Ivan_Tsoi
...
// @downloadURL https://update.greasyfork.org/scripts/469090/VLADIKAVKAZ%20%7C%20ADM%20Script%20for%20forum%20by%20Tsoi.user.js
// @updateURL https://update.greasyfork.org/scripts/469090/VLADIKAVKAZ%20%7C%20ADM%20Script%20for%20forum%20by%20Tsoi.meta.js
// ==/UserScript==
  (function () {
    'use strict';
  ...
  const buttons = [
      {
        ...
        },
        {
         ...
         },
         {
          ...
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
          '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
          "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратитесь в раздел обжалований наказаний - [/I][URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.1955/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          '[I][CENTER][SIZE=1][COLOR=rgb(255, 0, 0)][ICODE]Закрыто.[/ICODE][/SIZE][/CENTER][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false, 
         },
         ...
         },
		 {
          ...
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
          '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
          "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратитесь жалобы на Технических Специалистов - [/I][URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85-%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%BE%D0%B2.490/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          '[I][CENTER][SIZE=1][COLOR=rgb(255, 0, 0)][ICODE]Закрыто.[/ICODE][/SIZE][/CENTER][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false, 
         },
