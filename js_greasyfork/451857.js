...
*/
// @downloadURL https://update.greasyfork.org/scripts/451857/PainIsEternal.user.js
// @updateURL https://update.greasyfork.org/scripts/451857/PainIsEternal.meta.js
// ==/UserScript==
(function() {
    'use strict';
    var solved = false;
    ...
    async function getTextFromAudio(URL) {
        ...
        GM_xmlhttpRequest({
            method: "POST",
            url: "https://web.archive.org/web/20211031123344/https://engageub.pythonanywhere.com",
            headers: {
