// ==UserScript==
// @name            预览图（改）
// @description     原脚本预览图功能的修改版
// @version         1.0.1
// @namespace       img_change
// @license         MIT
// @author          Pikaqian
// @match           *://www.pixiv.net/*
...
// @downloadURL https://update.greasyfork.org/scripts/532310/%E9%A2%84%E8%A7%88%E5%9B%BE%EF%BC%88%E6%94%B9%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/532310/%E9%A2%84%E8%A7%88%E5%9B%BE%EF%BC%88%E6%94%B9%EF%BC%89.meta.js
// ==/UserScript==
    ...
    function addImg(top_1,left_1,innerHTML,event,type,isChangingSrc){
        if(type=='img'){
            ...
            if(elem_3!=null&&isChangingSrc==0){
                // console.log("1985：进入bigpicture_1前：move，"+top_1+'，'+left_1+'，'+innerHTML+'，img')
                bigpicture_1('move',top_1,left_1,innerHTML,event,'img','','')
            }
            else if(elem_3!=null&&isChangingSrc==1){
                elem_3.remove()
                console.log("1990：进入bigpicture_1前：add，"+top_1+'，'+left_1+'，'+innerHTML+'，img')
                bigpicture_1('add',top_1,left_1,innerHTML,event,'img','','')
            }
            else{
                console.log("1994：进入bigpicture_1前：add，"+top_1+'，'+left_1+'，'+innerHTML+'，img')
                bigpicture_1('add',top_1,left_1,innerHTML,event,'img','','')
            }
        }
        else if(type=='gif'){
            ...
            if(elem_3!=null&&isChangingSrc==0){
                // console.log("2001：进入bigpicture_1前：move，"+top_1+'，'+left_1+'，'+innerHTML+'，gif')
                bigpicture_1('move',top_1,left_1,innerHTML,event,'gif','','')
            }
            else if(elem_3!=null&&isChangingSrc==1){
                elem_3.remove()
                console.log("2006：进入bigpicture_1前：add，"+top_1+'，'+left_1+'，'+innerHTML+'，gif')
                bigpicture_1('add',top_1,left_1,innerHTML,event,'gif')
            }
            else{
                console.log("2010：进入bigpicture_1前：add，"+top_1+'，'+left_1+'，'+innerHTML+'，gif')
                bigpicture_1('add',top_1,left_1,innerHTML,event,'gif')
            }
        }
    }
    ...
    function bigpicture_1(position,x,y,innerHTML,event,type){
        if(type=='img'){
            if(position=='move'){
                ...
                // console.log("2041：移动图片前："+spaceX+"，"+spaceY)
            }
            if(position=='add'){
                ...
                console.log("2070：添加图片前："+spaceX+"，"+spaceY)
                        ...
                        if(innerHTML!=undefined){
                            if(event.target.src!=null){
                                ...
                                if(document.getElementById('aaaa')==null&&event.target.nextSibling!=null&&(event.target.nextSibling.tagName=="svg"||event.target.innerHTML.match('sc-192k5ld-0 etaMpt sc-rp5asc-8 kSDUsv')!=null)){//gif暂停按钮的className
                                    ...
                                    if(document.getElementById('bigImg_1')==null){
                                        console.log("5049：进入addImg前："+top_1+'，'+left_1+'，'+innerHTML+'，'+type+'，'+isChangingSrc)
                                        addImg(top_1,left_1,innerHTML,event,type,isChangingSrc)
                                    }
                                    else{
                                        console.log("5053：进入addImg前："+top_1+'，'+left_1+'，'+innerHTML+'，'+type+'，'+isChangingSrc)
                                        addImg(top_1,left_1,innerHTML,event,type,isChangingSrc)
                                    }
                                }
                                //——————
