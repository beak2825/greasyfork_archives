// ==UserScript==
// @name         TYUMEN | Кураторы форума Black Russia | by A.Grozny
// @namespace    https://forum.blackrussia.online
// @version      1.3
// @description  Для РП Биографии и РП Ситуации
// @author       Alexander_Grozny, Wake_Flyweather
...
// @downloadURL https://update.greasyfork.org/scripts/483178/TYUMEN%20%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Black%20Russia%20%7C%20by%20AGrozny.user.js
// @updateURL https://update.greasyfork.org/scripts/483178/TYUMEN%20%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Black%20Russia%20%7C%20by%20AGrozny.meta.js
// ==/UserScript==
    ...
    },
{
  ...
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - биография одобрена.<br><br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=TYUMEN]TYUMEN[/COLOR].<br><br>"+
...
},
{
  ...
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - биография отказана.<br><br>"+
                ...
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]TYUMEN[/COLOR] [COLOR=TYUMEN]TYUMEN[/COLOR].<br><br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
...
{
   title: '| Дата рождения не полнос.❌️ |',
   content:
     '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/ZRCBYwFP/JVROV-1.png[/img][/url]<br>' +
  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
  "[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
...
},
{
  ...
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - биография отказана.<br><br>"+
                ...
                "[B][CENTER][COLOR=lavender]Внимательно прочитайте правила создания RP - биографии, закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=TYUMEN]TYUMEN[/COLOR].<br><br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/K8ws2zPz/download-5.gif[/img][/url]<br>",
   prefix: UNACCEPT_PREFIX,
...
{
   title: '| Одежда в описании внешн❌️ |',
   content:
     '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/ZRCBYwFP/JVROV-1.png[/img][/url]<br>' +
  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
  "[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
...
},
{
  ...
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - ситуация отказана.<br><br>"+
                "[B][CENTER][COLOR=lavender]Внимательно прочитайте правила RolePlay ситуаций закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=TYUMEN]TYUMEN[/COLOR].<br><br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/K8ws2zPz/download-5.gif[/img][/url]<br>",
   prefix: UNACCEPT_PREFIX,
...
},
{
  ...
  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
  "[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
  "[B][CENTER][COLOR=lavender] Ваша RolePlay ситуация взята на доработку.<br><br>"+
...
},
{
  ...
  "[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - ситуация отказана.<br><br>"+
                "[B][CENTER][Spoiler][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Вы ошиблись с разделом, вам не сюда.[/Spoiler]<br>"+
                "[B][CENTER][COLOR=lavender]Внимательно прочитайте правила RP - ситуации закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=blue]TYUMEN[/COLOR].<br><br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/K8ws2zPz/download-5.gif[/img][/url]<br>",
   prefix: UNACCEPT_PREFIX,
   status: false,
},
{
  ...
  "[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - ситуация отказана.<br><br>"+
                "[B][CENTER][Spoiler][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Причиной тому послужила неправильное оформление RP - ситуации.[/Spoiler]<br>"+
                "[B][CENTER][COLOR=lavender]Внимательно прочитайте правила RP - ситуации закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=blue]TYUMEN[/COLOR].<br><br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/K8ws2zPz/download-5.gif[/img][/url]<br>",
...
},
{
  ...
  "[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - ситуация отказана.<br><br>"+
                "[B][CENTER][Spoiler][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Причиной тому послужили многочисленные грамматические ошибки в RolePlay ситуации.[/Spoiler]<br>"+
                "[B][CENTER][COLOR=lavender]Внимательно прочитайте правила RP - ситуаций, закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=TYUMEN]TYUMEN[/COLOR].<br><br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/K8ws2zPz/download-5.gif[/img][/url]<br>",
   prefix: UNACCEPT_PREFIX,
...
},
{
  ...
  "[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - ситуация отказана.<br><br>"+
                "[B][CENTER][Spoiler][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Причиной тому послужила RP ситуации не имеющие смысловой нагрузки.[/Spoiler]<br>"+
                "[B][CENTER][COLOR=lavender]Внимательно прочитайте правила RP - ситуации закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=blue]TYUMEN[/COLOR].<br><br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/K8ws2zPz/download-5.gif[/img][/url]<br>",
...
},
{
  ...
  "[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
  "[B][CENTER][COLOR=lavender] Ваша RolePlay - ситуация отказана.<br><br>"+
                "[B][CENTER][Spoiler][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Причиной тому послужила nonRP поведение или PG.[/Spoiler]<br>"+
                "[B][CENTER][COLOR=lavender]Внимательно прочитайте правила RP - ситуации закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=blue]TYUMEN[/COLOR].<br><br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
  "[url=https://postimages.org/][img]https://i.postimg.cc/K8ws2zPz/download-5.gif[/img][/url]<br>",
