...
// @downloadURL https://update.greasyfork.org/scripts/507414/WaniKani%20Dashboard%20Cockpit.user.js
// @updateURL https://update.greasyfork.org/scripts/507414/WaniKani%20Dashboard%20Cockpit.meta.js
// ==/UserScript==
...
(function () {
    ...
    function delayedButtonStyling() {
        ...
        $('#dbc_gas .dashboard__lessons-and-reviews-section').css("width", "100%");
    ...
    function createHighlightHotspot(centerX, centerY, outsideRadius, insideRadius, startAngle, endAngle, color, opacity,
        ...
        highlightHotspots.push({
            id: spotId,
            arc: {
                centerX: centerX, centerY: centerY, outsideRadius: outsideRadius, insideRadius: insideRadius,
    ...
    function levelUpAnimationFrame(rectangle, fontSize, text, frame) {
        ...
        var tempFont = {
            color: levelFont.color, opacity: levelFont.opacity, lineWidth: levelFont.lineWidth,
    ...
    function resetGridDefaults(allPassed) {
        ...
        reviewButtonBlock.css("width", "100%");
    ...
    function add_css() {
        $('head').append(
            `<style id="db_cockpit_CSS">
                 ...
                 #dbc_gas {
                     grid-column-start: 1; grid-column-end: 2; grid-row-start: 1; grid-row-end: span 2;
                 }
                 #dbc_currentLevel {
                     grid-column-start: 1; grid-column-end: span 2; grid-row-start: 3; grid-row-end: 4;
                 }
                 #dbc_core {
                     grid-column-start: 2; grid-column-end: span 2; grid-row-start: 1; grid-row-end: span 2; aligh: center; margin: 0 auto;
                 }
                 #dbc_bar60 {
                     grid-column-start: 1; grid-column-end: span 3; grid-row-start: 4; grid-row-end: span 1;
                 }
                 #dbc_cruise {
                     grid-column-start: 4; grid-column-end: 5; grid-row-start: 1; grid-row-end: span 2;
                 }
                 #dbc_forecast {
                     grid-column-start: 3; grid-column-end: span 2; grid-row-start: 3; grid-row-end: span 2;
                 }
