...
// @grant		unsafeWindow
// @grant		GM_info
// @downloadURL https://update.greasyfork.org/scripts/395871/Mousehunt%20Horn%20Tracker.user.js
// @updateURL https://update.greasyfork.org/scripts/395871/Mousehunt%20Horn%20Tracker.meta.js
// ==/UserScript==
...
console.log("debug", objBestTrap.weapon.draconic);
...
function exeScript() {
    ...
    //DEBUG:
    console.plog(user.bait_quantity);
...
function bwRift(){
    ...
    var objDefaultBWRift = {
        ...
        master : {
            weapon : new Array(32).fill('Timesplit Dissonance Weapon'),
...
function VRift(){
    ...
    console.plog("VRift Script running");
    if (mode == 1){
...
function getBaitQuantity() {
    return user.bait_quantity; //document.getElementById('hud_baitQuantity');
    /*     console.log(hudBaitQuantity);
    console.log(parseInt(hudBaitQuantity.textContent));
...
function action() {
    if (isKingReward) {
        ...
        var headerElement = (isNewUI) ? document.getElementById('mousehuntHud').children[1] : document.getElementById('envHeaderImg');
        if (headerElement) {
    ...
    if (showTimerInPage) {
        ...
        if (headerElement) {
            ...
            if (targetPage && aggressiveMode)
                titleElement.innerHTML = "<a href=\"http://devcnn.wordpress.com\" target=\"_blank\"><b>MouseHunt Horn Tracker version " + g_strVersion + " </b></a> - <font color='red'>Aggressive Mode</font>";
            else if (targetPage && browser != 'chrome' && browser != 'opera')
                titleElement.innerHTML = "<a href=\"http://devcnn.wordpress.com\" target=\"_blank\"><b>MouseHunt Horn Tracker version " + g_strVersion + " </b></a> - <font color='red'><b>Pls use Chrome browser for fully working features</b></font>";
            else
                titleElement.innerHTML = "<a href=\"http://devcnn.wordpress.com\" target=\"_blank\"><b>MouseHunt Horn Tracker version " + g_strVersion + " </b></a>";
...
';
            ...
            preferenceHTMLStr += '<option value="VRift">SB Factory 2020</option>';
...
function soundHorn() {
    ...
    console.log(isAtCampPage, "debug: isAtCampPage");
    if (!isAtCampPage) {
        reloadWithMessage("Timer error. Try reload to fix.", true);
...
function CallKRSolver()
{
    ...
    if (debugKR){
        ...
        if(isNewUI){
            img = document.getElementsByClassName('mousehuntPage-puzzle-form-captcha-image')[0].children[0];
            frame.src = img.src.replace(/"/g, "");
        }
        else{
...
function bodyJS(){
    ...
    function onInputResetReload(){
        ...
        else if(strValue == 'VRift') keyName = 'VRift';
