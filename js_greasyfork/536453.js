...
// @run-at      document-end
// @downloadURL https://update.greasyfork.org/scripts/536453/Link%20AI%20Chat%20Assistant.user.js
// @updateURL https://update.greasyfork.org/scripts/536453/Link%20AI%20Chat%20Assistant.meta.js
// ==/UserScript==
...
;(function() {
    ...
    function simulateResponse() {
        ...
        // 简化模拟响应生成
        const mockResponse = `这是对以下内容的模拟回复:\n\n${message}\n\n(这是模拟响应，实际使用时请替换为真实的API调用)`;
        
        setTimeout(() => {
            resultContainer.innerHTML = formatResponse(mockResponse);
        }, 800);
    }
