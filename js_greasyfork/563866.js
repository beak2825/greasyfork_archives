...
// @downloadURL https://update.greasyfork.org/scripts/563866/yangjieqiong.user.js
// @updateURL https://update.greasyfork.org/scripts/563866/yangjieqiong.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "LUO RUXI";
    const NEW_NAME = "YANG JIEQIONG";
    const NEW_BIRTHDAY = "(**1116)";
    const NEW_EXPIRE_DATE = "2033-08-21";
