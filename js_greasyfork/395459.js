...
// @match        王永杰app活动页
// @downloadURL https://update.greasyfork.org/scripts/395459/%E7%8E%8B%E6%B0%B8%E6%9D%B0app%E6%B4%BB%E5%8A%A8%E9%A1%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/395459/%E7%8E%8B%E6%B0%B8%E6%9D%B0app%E6%B4%BB%E5%8A%A8%E9%A1%B5.meta.js
// ==/UserScript==
$(document).ready(function () {
    ...
    function wang(){
        ...
        for (var j = 0; j < id.length; j++) {
            $(".gome_list_table tbody tr td:last-child").eq(j).append(`<a href="javascript:edit_pginfo(` + id[j].replace(/[^0-9]/ig,"") + `, '0')"><i class="splashy-contact_blue_new"></i>超级VIP</a>`)
        }
    }
    setTimeout(function(){
        wang()
