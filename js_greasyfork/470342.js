// ==UserScript==
// @name         TM Compare Others' Players CN
// @namespace    TM Compare Others' Players CN
// @version      1.0.2023070901
// @description  比较其他两个俱乐部的球员 TrophyManager: Allow managers to compare two other clubs' players
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/470342/TM%20Compare%20Others%27%20Players%20CN.user.js
// @updateURL https://update.greasyfork.org/scripts/470342/TM%20Compare%20Others%27%20Players%20CN.meta.js
// ==/UserScript==
...
(function() {
    ...
    var buttonText = (playerId == compareId) ? "已添加" : "添加比较球员";
    var addCompare =
    ...
    if (isDifferent) {
        ...
        var doCompare =
            ...
            "<span class=\"button_border\" style=\"width:168px; padding: 0;\">与<br><ib class=\"flag-img-" + compareCountry + " \"></ib>&nbsp;" + compareName + "比较</span></span>" +
            "</a>";
    ...
    function addPlayerInfo(playerId) {
        ...
        elem.innerHTML = "<span class=\"button_border\" style=\"width:168px; padding: 0;\"><img src=\"/pics/mini_green_check.png\">&nbsp;已添加</span>";
