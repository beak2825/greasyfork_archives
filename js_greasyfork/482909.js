...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/482909/Lucky%20Dice%20Refill%20and%20Bet.user.js
// @updateURL https://update.greasyfork.org/scripts/482909/Lucky%20Dice%20Refill%20and%20Bet.meta.js
// ==/UserScript==
...
(function() {
    ...
    const link = 'https://luckydice.com/pt/app/bonuses';

    // Verifica se o link já foi aberto
    let linkAberto = false;

    // Função para abrir o link na página atual
    function abrirLink() {
        if (!linkAberto) {
            linkAberto = true; // Define como verdadeiro antes de abrir o link
            window.location.href = link;
        }
    }

    // Intervalo de tempo em milissegundos (por exemplo, 1 hora = 3600000 ms)
    const intervalo = 181000; // 3 minuto, altere conforme necessário

    // Chama a função para abrir o link uma vez após um intervalo de tempo
    setTimeout(abrirLink, intervalo);
