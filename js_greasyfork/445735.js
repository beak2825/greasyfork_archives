// ==UserScript==
// @name              115艾薇预览+
// @namespace     https://sleazyfork.org/zh-CN/scripts/445735-115%E8%89%BE%E8%96%87%E9%A2%84%E8%A7%88
// @version           1.6
...
// @downloadURL https://update.greasyfork.org/scripts/445735/115%E8%89%BE%E8%96%87%E9%A2%84%E8%A7%88%2B.user.js
// @updateURL https://update.greasyfork.org/scripts/445735/115%E8%89%BE%E8%96%87%E9%A2%84%E8%A7%88%2B.meta.js
// ==/UserScript==
...
(function() {
    ...
    function getVideoInfo(id){
        ...
        GM_xmlhttpRequest({
            method: "GET",
            url: "https://javdb456.com/search?q="+id+"&f=all",
            onload: xhr => {
    ...
    function getUncensored(id){
        GM_xmlhttpRequest({
            method: "GET",
            url: "https://avsox.click/cn/search/" + id,
            onload: xhr => {
                var xhr_data = $(xhr.responseText);
                if(!(xhr_data.find("div.alert").length)){
