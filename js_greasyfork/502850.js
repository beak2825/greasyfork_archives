// ==UserScript==
// @name Для Руководства администрации сервера NORILSK | 90
// @namespace https://forum.blackrussia.online
// @version 0.0.40
// @description для Анастасии Сергеевны
...
// @downloadURL https://update.greasyfork.org/scripts/502850/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20NORILSK%20%7C%2090.user.js
// @updateURL https://update.greasyfork.org/scripts/502850/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20NORILSK%20%7C%2090.meta.js
// ==/UserScript==
...
(function () {
    ...
    "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
 "Твой текст <br><br>"+
    "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    },
     {
...
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/2BA94F/20/1/4nxpbfgou5ejdwfy4nk7b8qoua.png[/img][/url]",
    ...
    '[SIZE=4][COLOR=#BA55D3][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[CENTER]Вам уже снизили наказание.[/CENTER]<br>"+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
    prefix: UNACCEPT_PREFIX,
    status: false,
    ...
    },
{
    ...
    '[SIZE=4][COLOR=#BA55D3][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[CENTER]Ваше обжалование будет передано [COLOR=rgb(43,108,196)]Руководителю модераторов Forum/Discord[/color][Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/064bf4/20/1/4nopbe6oumej7wr14nxpbfgoudekfwri4np7bmty4nqpb8so1uejmwfy4nepbesou5ekbwr64njy.png[/img][/url]",
prefix: PIN_PREFIX,
    status: true,
    },
    {
 ...
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    '[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/e60a11/20/1/4nj7bg6o1dejfwr74nxpb8gowcopbrgo1uej3wra4nq7bggow8ekfwfy4nepbesou5ekbwfd.png[/img][/url]', 
    prefix: GA_PREFIX,
    status: true,
    },
    {
    ...
    '[SIZE=4][COLOR=#BA55D3][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
      "[CENTER]Ваша жалоба будет передана [COLOR=rgb(204,6,5)]Специальной Администрации[/color].[/CENTER]<br>"+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/c80e2b/20/1/4no7b86o1zekpwra4nepbg6oiuej5wr64nc1bwro4nkpb8goudej5wra4no7besowdejbwfg4ncpbgy.png[/img][/url]",
    prefix: SA_PREFIX,
    status: true,
    },
    {
 ...
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    '[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/f5f00a/20/1/4nppb8souuejbwr74nkpbfjy4nx7begou5ejmwr44ntpbry.png[/img][/url]',
 ...
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    ...
    title: 'На рассмотрении',
    content:
    '[SIZE=4][COLOR=#BA55D3][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+ "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
...
"[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/2BA94F/20/1/4nxpbfgou5ejdwfy4nk7b8qoua.png[/img][/url]<br>"+
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    prefix: ACCEPT_PREFIX,
    status: false,
    },
...
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
 ...
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/4nm7brgoumekbwfm4ntpb8o.png[/img][/url]"+
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    prefix: CLOSE_PREFIX,
    status: false,
    },
...
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    ...
    '[SIZE=4][COLOR=#BA55D3][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[CENTER]Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/Сервер-№90-norilsk.3984/?prefix_id=18']«Жалобы на технических специалистов [COLOR=rgb(59,130,246)]NORILSK[/COLOR]».[/URL][/CENTER]<br>"+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]"+    
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    prefix: UNACCEPT_PREFIX,
    ...
    '[SIZE=4][COLOR=#BA55D3][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[CENTER]Обратитесь со своей проблемой в  [URL='https://forum.blackrussia.online/forums/Технический-раздел-norilsk.3985/']«Технический раздел [COLOR=rgb(59,130,246)]NORILSK[/COLOR]».[/URL][/CENTER]<br>"+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]"+   
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    prefix: UNACCEPT_PREFIX,
...
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    ...
    '[SIZE=4][COLOR=#BA55D3][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[CENTER]С момента получения наказание прошло 72.<br>"+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]"+
"[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(59,130,246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    prefix: UNACCEPT_PREFIX,
...
prefix: GA_PREFIX,
 ...
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Заместителям Главного Администратора[/color] - @Nikolay_Kashtanov @Vanya Donissimo [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>"+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/e90c0c/20/1/4nm7brgouuejmwfb4ntpbggowmejmwr54nznbwru4np7brgo1mej5wr64nj7b8ty4nepbfgouuejtwr74ncpbeqowmekbwro4ntpb8sowdejy.png[/img][/url]",
    prefix: PIN_PREFIX,
    status: true,
    },
    {
 ...
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    "[CENTER]Ваша жалоба будет передана [COLOR=rgb(204,6,5)]Специальной Администрации[/color].[/CENTER]<br>"+
 "[url=https://postimages.org/][img]https://i.postimg.cc/rmP0747d/H07Tj.gif[/img][/url]<br>"+
    '[CENTER][Color=Orange]На рассмотрении.[/Color][/CENTER][/B][/SIZE]<br>'+
    "[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/c80e2b/20/1/4no7b86o1zekpwra4nepbg6oiuej5wr64nc1bwro4nkpb8goudej5wra4no7besowdejbwfg4ncpbgy.png[/img][/url]",
    prefix: SA_PREFIX,
    status: true,
    },
