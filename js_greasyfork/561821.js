...
// @namespace     MuftyPro
// @version       20.0
// @description   Bill Generator with Background Label and Conditional Logo Shift
// @match         https://salsabeelcars.site/index.php/admin/car_edit*
// @grant         none
// @downloadURL https://update.greasyfork.org/scripts/561821/Bill%20Generator%20Sal-Sabeel.user.js
// @updateURL https://update.greasyfork.org/scripts/561821/Bill%20Generator%20Sal-Sabeel.meta.js
// ==/UserScript==
...
(function () {
    ...
    function getAndIncrementSerial() {
        ...
        return "MFTB" + nextSN.toString().padStart(4, '0');
    }

    // Function to create non-clickable label with background
    function createLabel(text, rightOffset, bgColor) {
        ...
        Object.assign(label.style, {
            ...
            borderRadius: "6px 0 0 6px", // Rounded only on the left side to "join" the next button
