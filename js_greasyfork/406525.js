...
// @version     3.28-Forest
// @grant       GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/406525/Amo%20-%20Cheater%20-%20Forest.user.js
// @updateURL https://update.greasyfork.org/scripts/406525/Amo%20-%20Cheater%20-%20Forest.meta.js
// ==/UserScript==
...
NoweMenu.innerHTML = '<table style="text-align: left; width: 960px;" border="0" cellpadding="0" cellspacing="0">'
  				   + '<tbody>'
    			   + '<tr>'
      			   + '<td><div id="statystyki" class="menubutton" style="background: url(http://amorion.pl/gui4/button_off.png);"><img src="gui4/statystyki.png" onmouseover="AlterImgMenu(\'statystyki\', \'gui4/button_on.png\')" onmouseout="AlterImgMenu(\'statystyki\', \'gui4/button_off.png\')" onclick="Link(\'dynamic\', \'stats.php\')"></div></td>'
     			   + '<td><div id="bogactwa" class="menubutton" style="background: url(http://amorion.pl/gui4/button_off.png);"><img src="gui4/bogactwa.png" onmouseover="AlterImgMenu(\'bogactwa\', \'gui4/button_on.png\')" onmouseout="AlterImgMenu(\'bogactwa\', \'gui4/button_off.png\')" onclick="Link(\'dynamic\', \'wealth.php\')"></div></td>'
     			   + '<td><div id="ekwipunek" class="menubutton" style="background: url(http://amorion.pl/gui4/button_off.png);"><img src="gui4/ekwipunek.png" onmouseover="AlterImgMenu(\'ekwipunek\', \'gui4/button_on.png\')" onmouseout="AlterImgMenu(\'ekwipunek\', \'gui4/button_off.png\')" onclick="Link(\'dynamic\', \'inventory.php\')"></div></td>'
     			   + '<td><div id="klan" class="menubutton" style="background: url(http://amorion.pl/gui4/button_off.png);"><img src="gui4/klan.png" onmouseover="AlterImgMenu(\'klan\', \'gui4/button_on.png\')" onmouseout="AlterImgMenu(\'klan\', \'gui4/button_off.png\')" onclick="Link(\'dynamic\', \'klany.php?view=my\')"></div></td>'
     			   + '<td><div id="premium" class="menubutton" style="background: url(http://amorion.pl/gui4/button_off.png);"><img src="gui4/premium.png" onmouseover="AlterImgMenu(\'premium\', \'gui4/button_on.png\')" onmouseout="AlterImgMenu(\'premium\', \'gui4/button_off.png\')" onclick="Link(\'dynamic\', \'premin.php\')"></div></td>'
      			   + '<td><div id="pamietnik" class="menubutton" style="background: url(http://amorion.pl/gui4/button_off.png);"><img src="gui4/pamietnik.png" onmouseover="AlterImgMenu(\'pamietnik\', \'gui4/button_on.png\')" onmouseout="AlterImgMenu(\'pamietnik\', \'gui4/button_off.png\')" onclick="Link(\'dynamic\', \'notatnik.php\')"></div></td>'
     			   + '<td><div id="opcje" class="menubutton" style="background: url(http://amorion.pl/gui4/button_off.png);"><img src="gui4/opcje.png" onmouseover="AlterImgMenu(\'opcje\', \'gui4/button_on.png\')" onmouseout="AlterImgMenu(\'opcje\', \'gui4/button_off.png\')" onclick="Link(\'dynamic\', \'account.php\')"></div></td>'
     			   + '<td><div id="wyloguj" class="menubutton" style="background: url(http://amorion.pl/gui4/button_off.png);"><img src="gui4/wyloguj.png" onmouseover="AlterImgMenu(\'wyloguj\', \'gui4/button_on.png\')" onmouseout="AlterImgMenu(\'wyloguj\', \'gui4/button_off.png\')" onclick="Go(\'logout.php\')"></div></td>'
    			   + '</tr>'
  				   + '</tbody>'
				   + '</table>'
