// ==UserScript==
// @name         Скрипт Кураторов Администрации / KALUGA
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Скрипт для Кураторов администрации
// @author       Santiago Mollars
// @match        https://forum.blackrussia.online/threads/*
// @icon         https://i.pinimg.com/564x/65/8d/d7/658dd779ebe45b78a62f1bb5b918b2a5.jpg
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/514035/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%90%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20%20KALUGA.user.js
// @updateURL https://update.greasyfork.org/scripts/514035/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%90%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20%20KALUGA.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    content:
             ...
             "[B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/B] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>"
    },
    {
               ...
               },
    {
	  ...
	  content:
        ...
        '[B][COLOR=rgb(255, 152, 0)][FONT=verdana][SIZE=4]На рассмотрение.[img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/SIZE][/FONT][/COLOR]<br><br>' +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I] С уважением[/I][/COLOR][/SIZE][/B] [/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
    ...
    },
    {
	  ...
	  content:
        ...
        '[FONT=verdana][SIZE=4][COLOR=rgb(0, 255, 0)]Одобрено, [/COLOR]закрыто. [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/SIZE][/FONT]<br><br>' +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
    ...
    },
    {
	  ...
	  content:
        ...
        '[FONT=verdana][B][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], закрыто. [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/B][/FONT][/SIZE]<br><br>' +
        '[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/B] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>',
               ...
               },
    {
	  ...
	  content:
        ...
        '[FONT=verdana][B][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], закрыто. [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/B][/FONT][/SIZE]<br><br>' +
        '[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/B] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/FONT][/CENTER]<br>',
               ...
               },
    {
	  ...
	  content:
		...
		"[FONT=verdana][B][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], закрыто. [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/B][/FONT][/SIZE]<br><br>"+
        '[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/B] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]',
	  ...
	  content:
        "[CENTER][FONT=verdana][B][SIZE=4]Здравствуйте ува[/SIZE][/B][SIZE=4]жаем[B]ый игрок.[/B][/SIZE]<br><br>" +
        '[SIZE=4][FONT=verdana]Передано [COLOR=rgb(255, 0, 0)]Главному Администратору [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/COLOR].[/FONT][/SIZE]<br>' +
		"<br>"+
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
               ...
               },
    {
	  ...
	  content:
        "[CENTER][FONT=verdana][B][SIZE=4]Здравствуйте ува[/SIZE][/B][SIZE=4]жаем[B]ый игрок.[/B][/SIZE]<br><br>" +
        '[SIZE=4][FONT=verdana]Передано [COLOR=rgb(255, 0, 0)]Заместителям Главного Администратора\[img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/COLOR].[/FONT][/SIZE]<br><br>' +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/B] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
	  ...
	  content:
        "[CENTER][FONT=verdana][B][SIZE=4]Здравствуйте ува[/SIZE][/B][SIZE=4]жаем[B]ый игрок.[/B][/SIZE]<br><br>" +
        "[FONT=verdana]Доказательства в социальной сети. Просьба создать новую жалобу, выложить их на фото или видео платформы [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] ([URL='https://www.youtube.com/']You[COLOR=rgb(255, 0, 0)]Tube[/COLOR][/URL] или [URL='https://www.imgur.com/']Imgur[/URL]) и прикрепить в новой жалобе.[/FONT]<br><br>" +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
	  ...
	  content:
        ...
        '[COLOR=rgb(97, 189, 109)][SIZE=5][ICODE]1. Ваш Nick_Name:<br>2. Nick_Name администратора:<br>3. Дата выдачи/получения наказания:<br>4. Суть жалобы:<br>5. Доказательство: [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/ICODE][/SIZE][/COLOR]<br><br>' +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
	  ...
	  content:
		...
		"[SIZE=4][FONT=verdana][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], закрыто. [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/FONT][/SIZE]"+
        '<br><br>' +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
	  ...
	  content:
        ...
        '[COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/FONT][/SIZE]<br><br>' +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
               ...
               },
    {
	  ...
	  content:
        ...
        '[FONT=verdana][SIZE=4][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [img]https://i.postimg.cc/L5HcNdQf/image.png[/img] [/SIZE]<br><br>' +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации Santiago Mollars.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
