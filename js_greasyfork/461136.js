// ==UserScript==
// @name         GalaxyTool B.O.R.G. hydrogen
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/461136/GalaxyTool%20BORG%20hydrogen.user.js
// @updateURL https://update.greasyfork.org/scripts/461136/GalaxyTool%20BORG%20hydrogen.meta.js
// ==/UserScript==
...
//$("#galaxytableHead > tfoot > tr:nth-child(1) > td").remove();
    ...
    function submit(){
    if (($("[name~='system']")[0].value != 299 || $("[name~='galaxy']")[0].value != 5)) {
        if ($("[name~='system']")[0].value != 299){
            ...
            $("[name~='system']")[0].value = 1;
             ...
             alert("Proceso finalizado, verifica que la vision de galaxia se encuentra en Galaxia 5 y Sistema 299");
        }
