...
// @downloadURL https://update.greasyfork.org/scripts/447865/%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/447865/%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил: 2.01. Запрещено поведение, нарушающее нормы процессов Role Play режима игры | Jail 30 минут [/FONT][/I][/B][/CENTER] " +
                '[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Orange.[/I][/CENTER][/color][/FONT]' +
    ...
    },
    {
      ...
      content:
		...
		'[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Orangen.[/I][/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][FONT=times new roman][CENTER][I]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
	  ...
	  content:
		...
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Orange.[/I][/CENTER][/color][/FONT]' +
