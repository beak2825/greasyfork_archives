// ==UserScript==
// @name        SunDawn: viewport (Responsive Web Design)
// @namespace   dpmeichen@gmail.com
// @description Add <meta name="viewport"content="width=device-width, initial-scale=1"/>. Based on https://github.com/livingston/css3-mediaqueries-js
// @include     http*
// @version     1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/27612/SunDawn%3A%20viewport%20%28Responsive%20Web%20Design%29.user.js
// @updateURL https://update.greasyfork.org/scripts/27612/SunDawn%3A%20viewport%20%28Responsive%20Web%20Design%29.meta.js
// ==/UserScript==
/*
  ...
  var requestText = function (url, fnSuccess, fnFailure) {
    ...
    r.onreadystatechange = function () {
      if (r.readyState === 4 && !done) {
        if (!r.status && location.protocol === 'file:' || (r.status >= 200 && r.status < 300) ||
        r.status === 304 ||
