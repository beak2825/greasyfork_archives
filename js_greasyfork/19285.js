// ==UserScript==
// @name         iIronicBetaServer2
// @namespace    BetaiIronic2
// @version      1.0
// @description  THE BEST BOTS!2
// @author       iIronic2
// @match        http://agar.io/*
// @require      https://cdnjs.cloudflare.com/ajax/libs/socket.io/1.4.5/socket.io.min.js
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/19285/iIronicBetaServer2.user.js
// @updateURL https://update.greasyfork.org/scripts/19285/iIronicBetaServer2.meta.js
// ==/UserScript==
...
setTimeout(function() {
    ...
    var socket = io.connect('ws://www.botstest2-iironicgameryt.c9users.io:8081');
    var canMove = true;
   ...
   socket.on('spawn-count', function(data) {
    ...
    $("#instructions").replaceWith('<br><div class="input-group"><span class="input-group-addon" id="basic-addon1">UUID SEND TO IIRONIC</span><input type="text" value="' + client_uuid + '" readonly class="form-control"</div>');
