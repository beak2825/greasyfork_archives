...
// @include        *://www.npmjs.com/package/*
// @exclude      *localhost*
// @grant        GM_addElement
// @grant        GM_addStyle
// @grant        GM_setClipboard
// @license      GPL License
// @downloadURL https://update.greasyfork.org/scripts/470813/NpmjsUISetting.user.js
// @updateURL https://update.greasyfork.org/scripts/470813/NpmjsUISetting.meta.js
// ==/UserScript==
...
function createElement(tag) {
  ...
  function GM_createElement(tag, options) {
    var _options$idPrefix = options.idPrefix,
      idPrefix = _options$idPrefix === void 0 ? "enjoy_".concat("NpmjsUISetting", "_").concat(tag, "_") : _options$idPrefix,
...
;// CONCATENATED MODULE: ./src/NpmjsUISetting.js
