...
// @downloadURL https://update.greasyfork.org/scripts/491018/%D0%BE%D1%82%20%D1%81%D0%B0%D1%8F%D0%BD%D0%B0%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B0%D1%8F%D0%BD%D1%87%D0%B8%D0%BA%D0%B0%20%D0%B7%D0%B3%D0%BA%D1%84%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/491018/%D0%BE%D1%82%20%D1%81%D0%B0%D1%8F%D0%BD%D0%B0%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B0%D1%8F%D0%BD%D1%87%D0%B8%D0%BA%D0%B0%20%D0%B7%D0%B3%D0%BA%D1%84%D0%B0.meta.js
// ==/UserScript==
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B][/COLOR] [/SIZE][/I][COLOR=rgb(0, 255, 127)][B][SIZE=1]GROZNY[/SIZE][/B][/COLOR]"+
    ...
    },
     {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Ваша РП Биография получает статус<br><br>" +
 " [FONT=georgia] [B][CENTER] ОДОБРЕНО <br>" +
    ...
    status: false, 
     ...
     
	 {
      ...
      content:
		"[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        " [FONT=georgia] [B][CENTER]Ваша РП Биография получает статус<br><br>" +
	" [FONT=georgia] [B][CENTER] ОТКАЗАНО <br>" +	
	...
	" [FONT=georgia] [B][CENTER] ОТКАЗАНО <br>" +	
    ...
    },
	 {
      ...
      content:
        ...
        " [FONT=georgia] [B][CENTER]Ваша РП Биография получает статус<br><br>" +
	" [FONT=georgia] [B][CENTER] ОТКАЗАНО <br>" +	
		" [FONT=georgia] Причиной послужило написание второй Биографии на один игровой аккаунт, что же запрещено правилами написаний РП Биографий<br>" +
           "[CENTER][FONT=GEORGIA]С уважением [COLOR=rgb(0, 255, 0)]Зам Главного Куратора форума [/COLOR][URL='https://vk.com/sayan4ik']Sayan Borisov[/URL][/FONT][/CENTER]<br>",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
    },
