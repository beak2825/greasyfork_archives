...
// @author       Heasleys4hemp [1468764] :: modified by Max_Cohen[512123]
// @include     *.torn.com/userlist.php*
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/398076/PlayerFilter.user.js
// @updateURL https://update.greasyfork.org/scripts/398076/PlayerFilter.meta.js
// ==/UserScript==
       ...
       <div class="wb_content">
        <div class="wb_row">
          ...
          <p>Has</p>
            <ul class="have">
                <li>
                    <input type="checkbox" value="icon3" checked/><span>Donator</span></li>
                <li>
                    <input type="checkbox" value="icon4" checked/><span>Subscriber</span></li>
                <li>
                    <input type="checkbox" value="icon70"/><span>Federal Jail</span></li>
                <li>
                    <input type="checkbox" value="icon77"/><span>Resting in Peace</span></li>
            </ul>
          </div>
        </div>
      </div>
...
function filter() {
    ...
    if (haveList.length < 1) {
        ...
        haveListvar = "ul#iconTray > " + haveList.map(iconName => "li[id^='" + iconName + "']").join();
    }

    console.log(haveListvar);
    ...
    const hider = $("ul#iconTray > li[id^='"+arrList[i]+"']"); //select all li child elements of ul#iconTray if they contain Id
