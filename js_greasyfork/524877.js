// ==UserScript==
// @name         W145 Autofill Buy/Sell with Shortcuts
// @version      1.8
...
// @downloadURL https://update.greasyfork.org/scripts/524877/W145%20Autofill%20BuySell%20with%20Shortcuts.user.js
// @updateURL https://update.greasyfork.org/scripts/524877/W145%20Autofill%20BuySell%20with%20Shortcuts.meta.js
// ==/UserScript==
...
(function() {
    ...
    popup.innerHTML =
        ...
        '<button id="shortcut300Btn">300</button>' +
        '<button id="shortcut350Btn">350</button>' +
        '<button id="shortcut400Btn">400</button><br><br>' +
        '<button id="shortcut450Btn">450</button>' +
        '<button id="shortcut500Btn">500</button>' +
        '<button id="shortcut550Btn">550</button>' +
        '<button id="shortcut600Btn">600</button>' +
        '<button id="shortcut650Btn">650</button>' +
        '<button id="shortcut700Btn">750</button>' +
        '<button id="shortcut750Btn">1000</button><br><br>' +
    ...
    document.getElementById('shortcut300Btn').addEventListener('click', () => setTargetPrice(235));
    document.getElementById('shortcut350Btn').addEventListener('click', () => setTargetPrice(295));
    document.getElementById('shortcut400Btn').addEventListener('click', () => setTargetPrice(360));
    document.getElementById('shortcut450Btn').addEventListener('click', () => setTargetPrice(400));
    document.getElementById('shortcut500Btn').addEventListener('click', () => setTargetPrice(435));
    document.getElementById('shortcut550Btn').addEventListener('click', () => setTargetPrice(460));
    document.getElementById('shortcut600Btn').addEventListener('click', () => setTargetPrice(490));
    document.getElementById('shortcut650Btn').addEventListener('click', () => setTargetPrice(525));
    document.getElementById('shortcut700Btn').addEventListener('click', () => setTargetPrice(545));
    document.getElementById('shortcut750Btn').addEventListener('click', () => setTargetPrice(600));
