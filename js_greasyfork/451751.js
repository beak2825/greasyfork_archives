...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/451751/RC%20Eliminator.user.js
// @updateURL https://update.greasyfork.org/scripts/451751/RC%20Eliminator.meta.js
// ==/UserScript==
'use strict';
        ...
        if (document.querySelector("#dtQuickCodesUp").style.display != "none") {
            if (document.querySelector("#warning-text") === null) {
                ...
                if ($('.utils-display-review-completion-date.text-weight-300.ng-binding').length > 0) {
                    ...
                    if (date === today) {
                        document.querySelector('.summary-text').innerHTML += '<p id="warning-text"> ASIN is classified today. Be careful while choosing the root cause </p>';
