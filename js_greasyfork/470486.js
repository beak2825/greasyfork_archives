...
// @downloadURL https://update.greasyfork.org/scripts/470486/BLACK%20RUSSIA%20TECH.user.js
// @updateURL https://update.greasyfork.org/scripts/470486/BLACK%20RUSSIA%20TECH.meta.js
// ==/UserScript==
...
(function () {
    ...
    },
    {
		...
		'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]Ваше обращение не относится к жалобам на технических специалистов.<br><br>' +
        "[CENTER][B][FONT=times new roman]Пожалуйста, обратитесь в раздел [URL=https://forum.blackrussia.online/forums/Жалобы-на-игроков.1786/']Жалобы на игроков[/URL].[/FONT][/B][/CENTER].<br><br>" +
		'[CENTER][I][COLOR=rgb(139, 0, 0)]Отказано[/COLOR][/I].[/CENTER][/FONT][/SIZE]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
