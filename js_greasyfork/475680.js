// ==UserScript==
// @name           قطار الاصدقاء السريع خاص
// @namespace      s
// @description  Abu Nasser
// @author         5)
// @license        5l
// @contribution 5
...
// @version        2.98
// @downloadURL https://update.greasyfork.org/scripts/475680/%D9%82%D8%B7%D8%A7%D8%B1%20%D8%A7%D9%84%D8%A7%D8%B5%D8%AF%D9%82%D8%A7%D8%A1%20%D8%A7%D9%84%D8%B3%D8%B1%D9%8A%D8%B9%20%D8%AE%D8%A7%D8%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/475680/%D9%82%D8%B7%D8%A7%D8%B1%20%D8%A7%D9%84%D8%A7%D8%B5%D8%AF%D9%82%D8%A7%D8%A1%20%D8%A7%D9%84%D8%B3%D8%B1%D9%8A%D8%B9%20%D8%AE%D8%A7%D8%B5.meta.js
// ==/UserScript==
...
function getRandom ( x ) {
	x = Math.round(x*0.2);
	return x+Math.round(Math.random()*x*0.1);
}
...
function ok () {
	...
	wNr += 1;
	( wNr < $g('twb_multi').value && wNr < 500 ) ? addWave() : wNr = 0;
}
...
function addWave () {
	...
	ajaxRequest(fullName + a2bURL, "POST", sParams, function(ajaxResp) {
		...
		err = $gc('alertxxxxxxxxxxxxxxxxxxxx',bld);
		if( err.length > 0 ) {
