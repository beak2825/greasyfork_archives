// ==UserScript==
// @name         Open Unique Admin Links RU
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/531697/Open%20Unique%20Admin%20Links%20RU.user.js
// @updateURL https://update.greasyfork.org/scripts/531697/Open%20Unique%20Admin%20Links%20RU.meta.js
// ==/UserScript==
...
(function () {
    ...
    function addButton() {
        ...
        const existingButton = document.getElementById('open-admin-links-ru');
        ...
        if (table && !existingButton) {
            ...
            section.innerHTML = `
                <p>
                    <a class="link" href="#" id="open-admin-links">Open unique RU packs in admin area</a>
                </p>`;
        ...
        if (table) {
            ...
            const openNextLink = () => {
                if (index < urls.length) {
                    window.open(urls[index] + '#ToggleRussia', '_blank');
                    index++;
