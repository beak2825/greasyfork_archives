...
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/477889/IITC%20plugin%3A%20Wayfarer%20Planner.user.js
// @updateURL https://update.greasyfork.org/scripts/477889/IITC%20plugin%3A%20Wayfarer%20Planner.meta.js
// ==/UserScript==
...
function wrapper(pluginInfo) {
    ...
    function drawInputPopop(latlng, markerData) {
        ...
        formContent += ` <a href="https://maps.google.com/maps/@${lat},${lng},21z" style="padding:4px; ${align};" target="_blank">Street View</a>`
