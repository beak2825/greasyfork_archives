// ==UserScript==
// @name           YT Subtitle Downloader v40
// @description    Download Subtitles
// @include        https://*youtube.com/*
// @author         InternetNinja
// @copyright      2009 Tim Smart; 2011 gw111zz; 2014~2023 Cheng Zheng; 2024 InternetNinja
// @license        http://www.gnu.org/copyleft/gpl.html
// @require        https://code.jquery.com/jquery-1.12.4.min.js
// @version        40
// @grant          GM_xmlhttpRequest
// @grant          unsafeWindow
// @namespace      https://greasyfork.org/en/users/1408474-internetninjo
// @downloadURL https://update.greasyfork.org/scripts/520194/YT%20Subtitle%20Downloader%20v40.user.js
// @updateURL https://update.greasyfork.org/scripts/520194/YT%20Subtitle%20Downloader%20v40.meta.js
// ==/UserScript==
...
Note:
  Somtimes it may fail to work if jQuery CDN can't be loaded.
  // @require https://code.jquery.com/jquery-1.12.4.min.js
  The solution is to modify this line ⬆️ to a different
  jQuery URL such as these ⬇️
  https://cdn.bootcdn.net/ajax/libs/jquery/1.12.4/jquery.js
  https://cdn.staticfile.org/jquery/1.12.4/jquery.min.js

Update log:

## December 12, 2024：Update v37
   Fixed an issue where the subtitles don't download at all.
*/
...
async function download_subtitle(selector) {
    ...
    if (typeof unsafeWindow.ytplayer !== 'undefined' && unsafeWindow.ytplayer.bootstrapPlayerResponse) {
        var caption = caption_array[selector.selectedIndex - 1]; // Select the appropriate caption
        var result = null;
        var filename = null;

        // If user chooses auto subtitle
        ...
        downloadString(srt, 'text/plain', filename); // Download the subtitle file

        // After download, select first <option>
        selector.options[0].selected = true;
    } else {
        console.error("ytplayer.bootstrapPlayerResponse is not defined");
    }
}
