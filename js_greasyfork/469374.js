// ==UserScript==
// @name   Скрипт Кураторов форума by N.Voennikov
// @name:ru Кураторы Форума 👑
// @description  Suggestions for improving the script write here ---> https://vk.com/makcimka20087
// @description:ru Предложения по улучшению скрипта писать сюда ---> https://vk.com/makcimka20087
// @version 1.6
...
// @grant        none
// @license    MIT
// @supportURL https://vk.com/makcimka20087
// @icon https://emoji.gg/assets/emoji/9372-blurple-boost-level-9.png
// @downloadURL https://update.greasyfork.org/scripts/469374/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20NVoennikov.user.js
// @updateURL https://update.greasyfork.org/scripts/469374/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20NVoennikov.meta.js
// ==/UserScript==
...
"[CENTER][FONT=Georgia][QUOTE] {{ user.mention }} // Суть жалобы [/CENTER][/QUOTE]<br>" +
   ...
   },
   {
    ...
    },
    {
      ...
      content:
        '[Color=rgb(255, 0, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа послужило неправильное заполнение загловка темы.<br>Заголовок RP биографии должен быть оформлен по форме ниже:<br>[QUOTE]RolePlay биография гражданина Имя Фамилия (в родительном падеже) [/QUOTE][/CENTER][/FONT]",
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
