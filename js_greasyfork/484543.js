// ==UserScript==
// @name AudioBookBay hide category: Business
// @description Hide Business category
...
// @downloadURL https://update.greasyfork.org/scripts/484543/AudioBookBay%20hide%20category%3A%20Business.user.js
// @updateURL https://update.greasyfork.org/scripts/484543/AudioBookBay%20hide%20category%3A%20Business.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Business'
    $(".post").has(".postInfo:contains('Business')").hide();
});
