// ==UserScript==
// @name         RDO Inventory Sync
// @namespace    Q 群 248856433
// @version      0.7
// @description  Sync satchel with RDO Collectors Map, modified from Jean's chrome extension
// @author       Jeanropke, 削梨
// @match        https://map.185000.xyz/
// @match        https://rdo.news/map/
// @match        https://socialclub.rockstargames.com/games/rdo/overview
// @icon         https://map.185000.xyz/apple-touch-icon.png
// @license      MIT
// @grant        unsafeWindow
// @grant        GM_setValue
// @grant        GM_getValue
...
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/489493/RDO%20Inventory%20Sync.user.js
// @updateURL https://update.greasyfork.org/scripts/489493/RDO%20Inventory%20Sync.meta.js
// ==/UserScript==
...
(async function () {
  ...
  const pageKey =
    ...
    hostname.includes('185000') ||
    hostname.includes('rdo')
      ? 'map'
      : 'socialclub';
