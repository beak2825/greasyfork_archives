...
// @version      1.70
// @description  提取网页广告链接
// @author       木木
// @match        htt*://*/*
// @require      https://cdn.bootcdn.net/ajax/libs/jquery/3.6.0/jquery.min.js
// @downloadURL https://update.greasyfork.org/scripts/433909/%E7%BD%91%E9%A1%B5%E5%B9%BF%E5%91%8A%E9%93%BE%E6%8E%A5%E6%8F%90%E5%8F%96ajax.user.js
// @updateURL https://update.greasyfork.org/scripts/433909/%E7%BD%91%E9%A1%B5%E5%B9%BF%E5%91%8A%E9%93%BE%E6%8E%A5%E6%8F%90%E5%8F%96ajax.meta.js
// ==/UserScript==
    ...
    function show_adhref(is_onload = 0, is_right = 1) {
        ...
        if (is_send === 1) {
            ...
            ahref_send = unique(ahref_send);
             //向后台发送ajax
            if (ahref_send.join(",")) {
                $.post('https://172.16.100.73:9099/adhref',{ahref:ahref_send.join(","), domain:location.host},function(res){
                    console.log(777,res)
                },'json')
            }
        }
