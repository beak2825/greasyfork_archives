...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/444071/QGTwitterTool.user.js
// @updateURL https://update.greasyfork.org/scripts/444071/QGTwitterTool.meta.js
// ==/UserScript==
...
(function () {
    ...
    let tws = [
        "/sougenco/status/1532326842186620928","/yudainagata/status/1532663527684509697"
    ]
    let gzs = [
        "sougenco","yudainagata","amatonft"
    ...
    e1.initMouseEvent("mousedown",true,true,window,0,
            1100, 800, 1100, 900,false,false,false,false,0,null);
    //let ke = document.createEvent("keydown");
    //var ke = new Event("keypress", {"bubbles":true, "cancelable":false, keyCode: 13});

    //推文自动处理
    async function autotw(a1 = false, a2 = false,a3 = false,a4=false) {
        console.log("开始自动推文出来");
        if (openTw) {

            document.querySelector("#id__2pqeygom8wf > div:nth-child(3) > div > div > div > div")
            await sleep(1000);
            let like = document.querySelector("#react-root > div > div > div.css-1dbjc4n.r-18u37iz.r-13qz1uu.r-417010 > main > div > div > div > div.css-1dbjc4n.r-14lw9ot.r-jxzhtn.r-1ljd8xs.r-13l2t4g.r-1phboty.r-1jgb5lz.r-11wrixw.r-61z16t.r-1ye8kvj.r-13qz1uu.r-184en5c > div > section > div > div > div:nth-child(1) > div > div > div:nth-child(1) > article > div > div > div > div:nth-child(3) > div:nth-child(6) > div > div:nth-child(3) > div > div > div > div")
            if (like && !a1) {
                console.log("推文点喜欢！");
                like.click()
                like.dispatchEvent(e);
                like.dispatchEvent(e1);
                await sleep(1000);
                a1 = true
            }

            let retweet = document.querySelector("#react-root > div > div > div.css-1dbjc4n.r-18u37iz.r-13qz1uu.r-417010 > main > div > div > div > div.css-1dbjc4n.r-14lw9ot.r-jxzhtn.r-1ljd8xs.r-13l2t4g.r-1phboty.r-1jgb5lz.r-11wrixw.r-61z16t.r-1ye8kvj.r-13qz1uu.r-184en5c > div > section > div > div > div:nth-child(1) > div > div > div:nth-child(1) > article > div > div > div > div:nth-child(3) > div:nth-child(6) > div > div:nth-child(2) > div > div > div > div")
            if (retweet && !a2) {
                console.log("推文点转推！");
                retweet.click()
                retweet.dispatchEvent(e);
                retweet.dispatchEvent(e1);
                await sleep(2000);
                a2 = true
            }
