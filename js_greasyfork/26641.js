// ==UserScript==
// @name       Hybrid - Calls - Contact DVTSI
// @version    1.0
// @author	   jawz
...
// @downloadURL https://update.greasyfork.org/scripts/26641/Hybrid%20-%20Calls%20-%20Contact%20DVTSI.user.js
// @updateURL https://update.greasyfork.org/scripts/26641/Hybrid%20-%20Calls%20-%20Contact%20DVTSI.meta.js
// ==/UserScript==

if ($('li:contains("Calls - Contact DVTSI")').length) {
    ...
    var number2 = $('p:contains("Phone:")').text().replace('Phone:','').trim();
    if (!number2.includes("-")) {
    ...
    createButton('DC',1,3,3,3,'Disconnected');
    createButton('Fax',2,3,3,3,'Fax');
    ...
    createButton('Busy',3,2,2,2,'Busy signal');
    createButton('Generic VM',3,2,2,2,'Voicemail with no info.');
    createButton('Personal VM',0,0,2,0,'Personal voicemail');
    createButton('Wrong Contact',0,0,0,1,'');
    createButton('Wrong Addy',0,0,1,0,'');
    createButton('Wrong A&C',0,0,1,1,'');
