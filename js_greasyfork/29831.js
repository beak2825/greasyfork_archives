...
// @downloadURL https://update.greasyfork.org/scripts/29831/bv7_bbc_dark_b.user.js
// @updateURL https://update.greasyfork.org/scripts/29831/bv7_bbc_dark_b.meta.js
// ==/UserScript==
		...
		new (function(){
			...
			class PageCaptcha extends PageBbc {
				init28() {
					...
					/*
					ok = this.ok = 
						(this.nodeCaptchaBadge    = document.body.querySelector('.grecaptcha-badge')) &&
						(this.nodeCaptchaResponse = document.getElementById('g-recaptcha-response')) &&
						this.ok;
					*/
				}
				/*
				showNodeCaptchaResponse() {
					this.nodeCaptchaResponse.setAttribute('style', this.nodeCaptchaResponse.getAttribute('style').replace(/\s*\bdisplay\s*:.+;/, ''));
					this.nodeCaptchaBadge.setAttribute(   'style', this.nodeCaptchaBadge.getAttribute(   'style').replace(/\s*\b(width|height|transition)\s*:.+;/g, '') + 'width:1024px;height:240px;');
					//https://www.google.com/recaptcha/api2/payload?c=03AA7ASh0aycy3aUHt_1J3-Hi5vZJfof5p9oJlMMbKVUienwORCorOmMlYXD8dlBkHqLGzDHN3SeSaa79VsInbQlCRtWScD_QzbIAw2iKNInuO8cj2ndEnOcdF72BHJCve4XXGHrzf7Zbuxn0IB1wZC3dJ8dc9bSiHUmBlm7Qnel0x0AQg6hM7hSuiUU8QHR73B7oiKMGpSf2KL1oXttVo7RBR47D2ygXudQnSMD3wopMRM95tc43iovUOXStPxlQiMUwgR_soQlm2sazVy0f0WOfDuBQXwsj9CBWwCM-EF58h8qGUKjeOH43iFdH9WGR02AvPMUZmDb4mPjhkksW1VDj5lXmdKfgp3PmUn_XQekn6GDAPr2C6wY7YKufdIe1RWqTFZWOax5etZMFFdfrWDvO1A2i54OA2rYn9b94I4sUx4b_B0-Nvqk5l6BqOZVRoJ1Gmn3-mV-FUdAFeevuzlfnjzDCW1veSO2oCn6bTmPX3ndKyTVgJx5JQaz1QDBGoUSY1WZhSAUsr_lERA-SDKPI7iXxnJvsTWrfB0QKAnC31LJQOFsBheRpF0ghKyEn0Wxb8SY7kYLltComFdlpv1KsBZBad1rKjdlFeWujnNareNEApXVOjY2_qr7oMFXGxG4hyUJtmGPc2j3oZ7ZqaGvY-B3-IrsadNr-wHOLFCJnTPrjcSG58P3bWr6FEXkhwQO5sIhpA9gNIYc45VjwTgri7trvBxz241d453JyqG5vAbYdbOF8CmEXb-sAjvFAOvNSce_HlymSg_TiMwSHA5fTOYSI59oVYB-JIR620qYTiFPe5BYLuPD2plzj2EZbFpxaZHe8yKpDSi8NaGzfMyUCzuDhGJ9J9bf74DwfPdKRVGcxF-mUQXhWOzzZgnB2T6epkv1c8wfx6rnjj2yKHcL4thEe3uh-WyY6dC-D04u6gxfVV6d65wKBfK7X2ynHXXI5040tTUuts_UUciwMf-FNd4D8BM-oSP3YtwzkWgiONYUXqvS9j9QMNbhAHsXTqXI_efYGcoNJZE55_oQ56EJixqH_t3Xf-phFDkb4UeIKQECuSUpx2de5EphwiXSu0DC-6joFgfFEu3rwub6cFTjuFX8bdCnV4zL_RcVx079naswH7nLPQT8-_SkGXKU4X3YKFQkaKlFfvDSO-0tuUsJS0iZPxeTEFIs4dh350MBcEMcQ2-sk4irHoLJHpkXpDiKljwDQo9WrTaEI-62PYDEbxMp9UnNDsWL23idJvQYcrlIwQ_hHpmzYhNgOBLImvA9zGhOAKxiovGfdVbZ3ywMzqas4JvdttJpvciIbtmurR_EXKDa_75t1zIcRpt_-tLB6_DLp2_cngr3Mm6TLWAbgHsjnpqHB3BLuAw1x9ci0a0F79G0WafAMoAauutuOPhBUHlYY6uF_J_ot86Dw5V1fIIX878vZPtJp1pvSIot8R37t6p8pxFcIozcN-WfmruV0POfvOKwuu62fbJm-H2oObbuW9ZKWscNbYfD6d3j-GSt7aY_EFeaxcDQIYSDjCHJUXo0YoxiHvT4g8bTsGipAt8hWJFp9sSuh7EKaY4aAKNufi6Ed-LEVEk9xUDlaSPxc5TU9s1UhaC6SMf61O9vS8L0ovWOMCce8DNo61r12lztpDvQRXiXoRFPhJJAnhNtsbRrtaGd04dE-bJ2yA9dgk5G9OXHa1PKn8EgXmCAY5Y9E-GQpNLIA2GybP89kYqMLj_cZy1oVcPbO9UYLI8yiNYl0QYNYzluPG0p4Vb9TXE-iftj9FWiNP8fjH3N7RQaIIyBDfAtMxd8B_-SwjHAgBorbFJQxs_g&k=6LccSjEUAAAAANCPhaM2c-WiRxCZ5CzsjR_vd8uX
				}
				*/
				/*
				setCaptcha(v) {
					//this.nodeCaptchaResponse.value = v;
					this.nodeCaptchaResponse.innerHTML = v;
				}
				*/
				justSubmitCaptcha() {
					this.nodeSubmit.click();
				}
				submitCaptcha(v) {
					/*
					this.showNodeCaptchaResponse();
					this.setCaptcha(v);
					this.justSubmitCaptcha();
					*/
				}
			...
			class ToolBlockTripPageReCaptchaApi2BFrame extends ToolBlockTrip {
				...
				changeStart() {
					super.changeStart();
					if (
						this.app.nodeStart.checked &&
						parseInt(this.nodeCaptchaIndex.value) < parseInt(this.nodeCaptchaLimit.value) &&
						!this.app.nodeDebug.checked
					) this.setPlan(this.planReCapthca2InitAndOldIn);
				}
				*/
				actionReCapthca2InitAndOldIn() {
					this.app.page.init(() => {
						if (!!this.app.page.nodeTryLater) this.setPlan({timeout: 240000 + this.getTimeoutHuman(), action: () => GM_setValue('cmd', 'windowTopLocationReload')});
				...
				actionReCaptcha2OldCheckChange() {
					...
					/*
					let change = this.app.page.nodesCaptchaImgs.length != this.srcs.length;
					for (let i = 0; i < this.app.page.nodesCaptchaImgs.length && !change; i++) change = this.app.page.nodesCaptchaImgs.src != this.srcs[i];
					if (change) this.actionReCapthca2InitAndOldIn();
					else this.actionReCaptcha2OldClickVerify();
					*/
