...
// @description		Zusatzanzeige für Boost Angriffe Vatikan eingefügt. Zusatztool, um eine Übersicht Eurer Kampfwerte in der MotD von „Pennergame“ zu erzeugen. 
// @namespace       https://greasyfork.org/de/scripts/2740-kampfwert-in-der-modt/code
// @author			- Pennereck.de - 
...
// @downloadURL https://update.greasyfork.org/scripts/2740/Kampfwert%20in%20der%20Modt.user.js
// @updateURL https://update.greasyfork.org/scripts/2740/Kampfwert%20in%20der%20Modt.meta.js
// ==/UserScript==


// ***********************************************************************************************
// Version 2.0 Vatikan Anzeige Boost für gewonnen Angriffe hinzugefügt.
// Version 1.8 Vatikan hinzugefügt.
// Version 1.8 @grant Angaben hinzugefügt.
...
// ***********************************************************************************************
var version = "9"; // Updatecheck Versionsangaben für
...
// Vatikan
// ***********************************************************************************************
 else if (location.toString().indexOf("vatikan") != -1 || location.toString().indexOf("vatikan.pennergame.de") != -1) {
	var link = 'http://www.vatikan.pennergame.de';
	var stadt = 'vatikan';
	var tabelle = 'http://www.pennereck.de/admin/vatikan.php';
...
// ***********************************************************************************************
// % im Vatikan ermitteln
// ***********************************************************************************************
	GM_xmlhttpRequest({
	method: 'GET',
	url: link+'/fight/',
	onload: function(bounsatt) {
	var content = bounsatt.responseText;
	var bounsatton = content.split('padding: 3px;">')[2];
	var bounsattoff = (bounsatton != undefined) ? bounsatton.split('% ATT</b></div>')[0].trim() : '';
	var bonus = bounsattoff.charAt(1); 
...
var sOn = content.split('skill_progress_text">')[1];
var sOff = !!sOn  ? sOn.split('</')[0].trim() : '';
// ***********************************************************************************************
// /Skill
// ***********************************************************************************************
...
{
	var updatestatus = "<span style=\"font-size:12px; color:red;\">Update verfügbar! <a href=\"https://greasyfork.org/de/scripts/2740-kampfwert-in-der-modt\" target=\"_new\" title=\"Scipt installieren\"> Update installieren</a></span>";
}
else
{
...
// Im Vatikan berechnen wie hoch der Bonusboost durch gewonnene Angriffe ist. 
var boostkw = kampfwert2/100;
	boostkw = boostkw*bonus;
	if (location.toString().indexOf("vatikan") != -1 || location.toString().indexOf("vatikan.pennergame.de") != -1){
var boostausgabe = '<tr><td align="left">&nbsp;Bonus ATT:</td><td align="left">+'+bonus+'% (+'+boostkw+' KW)</td><td>&nbsp;</td></tr>';
}else {
var boostausgabe = '';
}
...
// Ausgabe in der Modt
// ***********************************************************************************************
document.getElementById('heilung-content').innerHTML='<table style="background-color: #292929;border: thin solid white;-moz-border-radius: 5px;border-radius: 5px " width="300px"><tr><td colspan="3" align="left">GM-Script &quot;Kampfwert&nbsp;in der MotD" (Version:2.0) </td></tr><tr><td width="150">&nbsp;</td><td>&nbsp;</td><td></td></tr><tr><td colspan="2" align="left">Folgende Werte werden übertragen:</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;Name:</td><td align="left">'+name+'</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;Stadt:</td><td align="left">'+stadt+'</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;Kampfwert:</td><td align="left">'+kampfwert2+'</td><td>&nbsp;</td></tr>'+boostausgabe+'<tr><td align="left">&nbsp;Att:</td><td align="left">'+attoff+'</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;Def:</td><td align="left">'+defoff+'</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;Wutstatus:</td><td align="left">'+wutstatus+'</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;Booststatus:</td><td align="left">'+boostoff+'</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;Sammelmarken:</td><td align="left">'+markenoff+'</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;Dex:</td><td align="left">'+dexoff+'</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td align="left">&nbsp;<input target="_self" style="cursor: pointer;" name="kw_senden" type="button" id="kw_senden" value="KW übertragen"/></td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td></td><td>'+updatestatus+' </td><td>&nbsp;</td></tr></table>';
// -----------------------------------------------------
+'</div>'
...
GM_xmlhttpRequest({
		...
		data: encodeURI('kw_name='+nameoff+'&kw_wert='+kampfwert2+'&kw_att='+attoff+'&kw_def='+defoff+'&kw_gangid='+gidoff+'&kw_stadt='+stadt+'&wut='+wut+'&boost='+boost+'&marken='+markenoff+'&dex='+dexoff+'&fightboost='+bonus),
