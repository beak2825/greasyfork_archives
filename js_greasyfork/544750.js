// ==UserScript==
// @name         Кураторы Форума общий скрипт bless russia.
// @namespace    https://forum.blessrussia.online
// @version      1.1
// @description  1.1 - первое, которое вышло в 25 году. В нем наша команда добавила новые цвета и и новые аватарки. Выбирайте нас для основного использования, так как мы заботимся о нашем продукте.
// @author       Z.Tempest
// @match        https://forum.blessrussia.online/index.p*
// @include      https://forum.blessrussia.online/index.p
// @grant        none
// @license    MIT
...
// @downloadURL https://update.greasyfork.org/scripts/544750/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D0%BE%D0%B1%D1%89%D0%B8%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20bless%20russia.user.js
// @updateURL https://update.greasyfork.org/scripts/544750/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D0%BE%D0%B1%D1%89%D0%B8%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20bless%20russia.meta.js
// ==/UserScript==

(function () {
  'use strict';
const UNACCСEPT_PREFIX = 11; // Prefix that will be set when thread closes
const ACCСEPT_PREFIX = 10; // Prefix that will be set when thread accepted
const RESHENO_PREFIX = 13; // Prefix that will be set when solving the problem
const PINN_PREFIX = 2; // Prefix that will be set when thread pins
const GA_PREFIX = 4; // Prefix that will be set when thread send to ga
const COMMAND_PREFIX = 10; // Prefix that will be set when thread send to project team
const WATCHED_PREFIX = 9;
const CLOSE_PREFIX = 1;
const SPECY_PREFIX = 2;
const TEXY_PREFIX = 5;
