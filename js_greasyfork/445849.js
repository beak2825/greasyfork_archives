// ==UserScript==
// @name         AO3: [Wrangling] VBRPF Fandom Assignment Shortcuts
// @description  Adds some shortcuts to assign tags to VBRPF fandoms more quickly.
// @version      1.2
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/445849/AO3%3A%20%5BWrangling%5D%20VBRPF%20Fandom%20Assignment%20Shortcuts.user.js
// @updateURL https://update.greasyfork.org/scripts/445849/AO3%3A%20%5BWrangling%5D%20VBRPF%20Fandom%20Assignment%20Shortcuts.meta.js
// ==/UserScript==
...
(function($) {
    ...
    if (page_url.includes("/wrangle")) {
        ...
        var fandoms_to_add = ["Video Blogging RPF", "Dream SMP", "Origins SMP", "30 Day SMP | Free Trial SMP", "Minecraft (Video Game)", "No Fandom"];
    ...
    // tag edit page
        ...
        suggested_fandoms.push({name: "Origins SMP", url: "/tags/Origins%20SMP/edit", used:false});
