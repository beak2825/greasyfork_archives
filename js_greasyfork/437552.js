...
// @author       нуль Zero
// @license      https://github.com/ZeroModsx/license/raw/main/license.user.js
// @match        *://moomoo.io/*
// @match        *://sandbox.moomoo.io/*
// @match        *://dev.moomoo.io/*
// @grant        noneT
// @icon         https://media1.giphy.com/media/yISqmK6DI8LveKkf7s/giphy.gif?cid=790b7611504a1112a3c9ed8486f417148902960fa1ed86f8&rid=giphy.gif&ct=g
// @downloadURL https://update.greasyfork.org/scripts/437552/Wasted%20Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/437552/Wasted%20Mod.meta.js
// ==/UserScript==
document.getElementById("mainMenu").style.backgroundImage = "url(https://media1.giphy.com/media/yISqmK6DI8LveKkf7s/giphy.gif?cid=790b7611504a1112a3c9ed8486f417148902960fa1ed86f8&rid=giphy.gif&ct=g)";
...
document.addEventListener('keydown', (e)=>{
    ...
    if(e.keyCode == 16 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        setTimeout( () => {
        autosecondary = true;
        doNewSend(["ch", ["Wasted Mod"]]);
        }, 700)
   }
       if(e.keyCode == 8 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        setTimeout( () => {
        doNewSend(["ch", ["Beta Version"]]);
        autosecondary = true;
        }, 1300)
   }
       if(e.keyCode == 8 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        setTimeout( () => {
        doNewSend(["ch", ["By : Zero"]]);
        autosecondary = false;
        autoprimary = true;
        autosecondary = false;
        autoprimary = true;
