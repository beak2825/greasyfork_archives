...
// @downloadURL https://update.greasyfork.org/scripts/468067/YCR.user.js
// @updateURL https://update.greasyfork.org/scripts/468067/YCR.meta.js
// ==/UserScript==
 ...
 function main(url) {
   try {
     let init = function() {
       ...
       jumpLink1 = $(
         '<a class="crack_title" target="_blank" id="crack_jump">丢，讲尼滴（YCR）</a>'
       ).hide();
       jumpLink2 = $(
         '<a class="crack_title" target="_blank" id="crack_jump">播放线路2</a>'
       ).hide();
       copyBtn = $(
         '<div class="crack_title" id="crack_copy">视频解析成功啦YCR</div>'
       ).hide();
