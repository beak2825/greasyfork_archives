// ==UserScript==
// @name         Curator's Team Miami
// @namespace    https://forum.dominexrp.ru/
// @version      1.4.0
// @description  По всем вопросам: https://vk.com/tomasflorence
// @author       Tomas_Florence
// @match        https://forum.dominexrp.ru/threads/*
// @include      https://forum.dominexrp.ru/threads/
// @grant        none
// @license      MIT
// @icon https://imgur.com/a/8PIznAO
// @downloadURL https://update.greasyfork.org/scripts/523383/Curator%27s%20Team%20Miami.user.js
// @updateURL https://update.greasyfork.org/scripts/523383/Curator%27s%20Team%20Miami.meta.js
// ==/UserScript==
...
(function () {
	...
	const buttons = [
          {
          title: 'Предложения по улучшению - @tomasflorence',
          ...
          },
          {
             ...
             "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография получает статус: [/SIZE][/FONT][/I][/COLOR]<br>[COLOR=rgb(152, 251, 152)][I][FONT=times new roman][SIZE=4][ICODE]Одобрено.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Во всех пунктах недостаточно информации.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
{
          ...
          },
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункт 11.2 начинается с 13 лет и заканчивается в 18 лет.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
...
(function () {
	...
	const buttons = [
          ...
          },
          {
           ...
           {
             title: 'PG (Изображение из себя героя)',
             dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR]<br><br>' +
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]2.17[/COLOR]. Запрещен PG (PowerGaming) — присвоение свойств персонажу, не соответствующих реальности, отсутствие страха за свою жизнь [Color=Red]| Jail 30 минут[/B][/COLOR][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           },
           {
             ...
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]2.14[/COLOR]. Запрещен RK (Revenge Kill) — убийство игрока с целью мести, возвращение на место смерти в течение 15-ти минут, а также использование в дальнейшем информации, которая привела Вас к смерти [Color=Red]| Jail 30 минут[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           {
             title: 'Вмешательство в рп процесс (Jail)',
             dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR]<br><br>' +
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]2.51[/COLOR]. Запрещено вмешательство в Role Play процесс с целью помехи и препятствования дальнейшего развития Role Play процесса [Color=Red]| Jail 30 минут[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           },
           {
             ...
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]2.33[/COLOR]. Запрещено пользоваться уязвимостью правил [Color=Red]| Ban 15 дней[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           },
           {
             ...
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]2.34[/COLOR]. Запрещен уход от наказания [Color=Red]| Ban 15 - 30 дней[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           {
             title: 'Перенос из IC в OOC (и наоборот)',
             dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR]<br><br>' +
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]2.36[/COLOR]. Запрещено переносить конфликты из IC в OOC и наоборот [Color=Red]| Warn[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
          ...
          dpstyle: 'oswald: 3px;     color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
           ...
           {
             title: 'Разговор на иностранном языке',
             dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR]<br><br>' +
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]3.01[/COLOR]. Общепризнанный язык сервера — русский. Общение в IC чатах во всех Role Play ситуациях обязательно должно проходить исключительно на русском языке [Color=Red]| Устное замечание / Mute 30 минут[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           {
             title: 'Оскорбление сексуального характера',
             dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR]<br><br>' +
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]3.07[/COLOR]. Запрещены совершенно любые оскорбления или действия, порочащие честь и достоинства, несущие в себе подтекст сексуального характера вне зависимости от чата [Color=Red]| Mute 30 минут[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           },
           {
             ...
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]3.09[/COLOR]. Запрещены любые угрозы о наказании игрока со стороны администрации [Color=Red]| Mute 30 минут[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           {
             title: 'Оск игроков/родных в Voice',
             dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR]<br><br>' +
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]3.15[/COLOR]. Запрещено оскорблять игроков или родных в Voice Chat [Color=Red]| Mute 120 минут / Ban 7 - 15 дней[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           },
           {
             ...
             'Игрок будет наказан по пункту правил:<br><br>' +
             "[QUOTE]" +
             '[Color=Red]3.17[/COLOR]. Запрещена реклама в Voice Chat не связанная с игровым процессом [Color=Red]| Ban 7 - 15 дней[/COLOR][/B][/FONT][/SIZE]' +
             "[/QUOTE]<br><br>" +
             '[CENTER][COLOR=rgb(61, 235, 52)][FONT=times new roman][SIZE=4][ICODE] Одобрено. [/ICODE][/FONT][/SIZE][/COLOR][/CENTER]<br><br>' +
             "[CENTER][FONT=times new roman][SIZE=4][COLOR=rgb(209, 216, 213)][B]Приятной игры на [/B][/COLOR][COLOR=rgb(0, 128, 255)][B]AZURE[/B][/COLOR][COLOR=rgb(209, 216, 213)][B].[/B][/SIZE][/FONT][/CENTER][/COLOR]",
             prefix: ODOBRENO_PREFIX,
           ...
           },
          {
           ...
           },
           {
             ...
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 216, 213)][SIZE=4][FONT=times new roman][B]Вы не обсудили условия сделки.<br>" +
             'Соответственно, жалоба рассмотрению не подлежит.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4] Отказано, закрыто. [/FONT][/SIZE][/COLOR][/CENTER]',
             prefix: OTKAZANO_PREFIX,
             status: false,
           ...
           },
           {
             ...
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 216, 213)][SIZE=4][FONT=times new roman][B]Доказательства должны быть загружены на Imgur, Yapix, ibb.<br>" +
             'Жалоба рассмотрению не подлежит.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4] Отказано, закрыто. [/FONT][/SIZE][/COLOR][/CENTER]',
             prefix: OTKAZANO_PREFIX,
             status: false,
          ...
          },
          {
           ...
           },
           {
             ...
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 216, 213)][SIZE=4][FONT=times new roman][B]Вы ошиблись разделом, вам стоит обратиться в раздел [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.722/']Жалобы на лидеров[/URL][/COLOR].<br><br>" +
             '[COLOR=rgb(255, 0, 0)]Закрыто.[/B][/FONT][/SIZE][/COLOR]',
             prefix: ZAKRITO_PREFIX,
             status: false,
           },
           ...
           },
           {
             ...
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 216, 213)][SIZE=4][FONT=times new roman][B]Вы ошиблись разделом, вам стоит обратиться в раздел [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.724/']Обжалование наказаний[/URL][/COLOR].<br><br>" +
             '[COLOR=rgb(255, 0, 0)]Закрыто.[/B][/FONT][/SIZE][/COLOR]',
             prefix: ZAKRITO_PREFIX,
             status: false,
           },
           {
             ...
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 216, 213)][SIZE=4][FONT=times new roman][B]Вы ошиблись разделом, вам стоит обратиться в [URL='https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-azure.701/']Технический раздел[/URL][/COLOR].<br><br>" +
             '[COLOR=rgb(255, 0, 0)]Закрыто.[/B][/FONT][/SIZE][/COLOR]',
             prefix: ZAKRITO_PREFIX,
             status: false,
           },
