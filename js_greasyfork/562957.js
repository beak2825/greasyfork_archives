// ==UserScript==
// @name         ChatGPT Response Collapse for Quick Navigation
// @namespace    https://mekineer.com
// @version      1.2
// @description  Collapse All button (or Expand All with Shift-click) for ChatGPT responses, so you can easily locate a response.
// @author       John Chi + mekineer and Nova (ChatGPT 5.2 Thinking)
// @match        https://chatgpt.com/*
// @grant        GM_addStyle
// @license      MIT
// @run-at       document-idle
// @downloadURL https://update.greasyfork.org/scripts/562957/ChatGPT%20Response%20Collapse%20for%20Quick%20Navigation.user.js
// @updateURL https://update.greasyfork.org/scripts/562957/ChatGPT%20Response%20Collapse%20for%20Quick%20Navigation.meta.js
// ==/UserScript==
...
// --- 1. 注入基础样式 (V25.0: 恢复渐变和内容上滚) ---
    ...
    /* 统一折叠按钮样式 */
    #collapse-all-button {
        position: fixed; bottom: 0px; right: 20px; z-index: 10000;
...
// --- 2. 核心函数：处理新的/未处理的聊天元素 (V24.0: 精准目标修复) ---
    ...
    function createCollapseAllButton() {
        ...
        // Normal Click = COLLAPSE ALL (existing behavior)
          allResponses.forEach(response => {
            response.style.height = COLLAPSE_HEIGHT;
            response.style.overflow = 'hidden';
            response.classList.add(COLLAPSED_CLASS);
