// ==UserScript==
// @name         Foxlinks styled quotes (condensed)
...
// @grant        GM_addStyle
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/464181/Foxlinks%20styled%20quotes%20%28condensed%29.user.js
// @updateURL https://update.greasyfork.org/scripts/464181/Foxlinks%20styled%20quotes%20%28condensed%29.meta.js
// ==/UserScript==

(function() {
    'use strict';
    GM_addStyle("blockquote { border: var(--MsgTop) 2px solid; margin: 4px; border-radius: 5px; padding: 4px; }");
    GM_addStyle("blockquote > blockquote { margin-left: 0; margin-right: 0; }");
    GM_addStyle("blockquote > blockquote:last-child { margin-bottom: 0; }");
    GM_addStyle("blockquote > p { margin-top: 4px }");
    GM_addStyle("blockquote > p:first-of-type { padding: 0 4px; background-color: var(--MsgTop); border-radius: 3px 3px 0 0; margin: -4px 0 4px -4px; max-width: initial; width: 100%; }");
