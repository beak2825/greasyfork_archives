// ==UserScript==
// @name         LEGACY: Deal aanmaken tools & fixes van Lukas (dit is de originele code van Daan)
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/486288/LEGACY%3A%20Deal%20aanmaken%20tools%20%20fixes%20van%20Lukas%20%28dit%20is%20de%20originele%20code%20van%20Daan%29.user.js
// @updateURL https://update.greasyfork.org/scripts/486288/LEGACY%3A%20Deal%20aanmaken%20tools%20%20fixes%20van%20Lukas%20%28dit%20is%20de%20originele%20code%20van%20Daan%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function checkFlag(flag) {
        const skipFlags = ["c=deal_1", "c=deal_2", "c=reserveer_1", "c=financieel_1"];
        let i = 0;
        let include = true;
    ...
    if (templateModule !== null) {
        templateModule.addEventListener("dblclick", function(e) {
            ...
            if (src.includes('nl.gif')) {
                ...
                country = "be";
            } else if (src.includes('fr.gif')) {
                country = "fr";
            } else if (src.includes('de.gif')) {
                country = "de";
            }

            if (flags_checked.includes(country)) {
                flags_checked.pop(country);
                checked = false;
            } else {
                flags_checked.push(country);
                checked = true;
            }

            check(country, checked);
