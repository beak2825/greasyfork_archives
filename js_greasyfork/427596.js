// ==UserScript==
// @name         WK lesson cherry-picker
// @namespace    alphaxion
// @version      1.1
// @description  Lets you pick which lesson you want to start by adding a button next to new vocab words. Requires WKOF.
// @author       Alphaxion
// @match        https://www.wanikani.com/vocabulary/*
// @run-at       document-end
// @connect      api.wanikani.com
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/427596/WK%20lesson%20cherry-picker.user.js
// @updateURL https://update.greasyfork.org/scripts/427596/WK%20lesson%20cherry-picker.meta.js
// ==/UserScript==
...
(function() {
    ...
    var voc = document.getElementsByClassName("page-header__icon--vocabulary")[0].innerHTML;
    var sub_id;
    var ass_id;
    ...
    function event_learn(ev) {
        GM_xmlhttpRequest({
            method: "GET",
            url: "https://api.wanikani.com/v2/assignments?srs_stages=0&subject_types=vocabulary&levels=" + level,
            headers: {
