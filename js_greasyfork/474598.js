// ==UserScript==
// @name         KURSK скрипт для КФ
// @namespace    https://forum.blackrussia.online
// @version     2.6
// @description  KURSK для КФ
// @author       J.Carters
...
// @downloadURL https://update.greasyfork.org/scripts/474598/KURSK%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/474598/KURSK%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:		"[B][CENTER][COLOR=#ff0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        ...
        '[Color=Orange][CENTER]Ваша жалоба взята на рассмотрение. Ожидайте ответа и не создавайте копии данной темы.[/CENTER][/color]' + '[CENTER]  [/CENTER]',
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][COLOR=Red]Игрок будет наказан[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		'[Color=AQUA][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на KURSK.[/CENTER][/color]' +
    ...
    },
    {
      ...
      title: 'Сторонне ПО',
      content:
		"[CENTER][COLOR=#ff0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Игрок будет наказан по пункту правил:[/CENTER][/COLOR]"+
        "[CENTER][COLOR=RED] 2.22. [/COLOR][COLOR=WHITE] Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками [/color][Color=red] | Ban 15 - 30 дней / PermBan [/COLOR][/CENTER]" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		'[Color=AQUA][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=GREEN][CENTER]✿❯────「Одобрено ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Игрок будет наказан по данному пункту правил: [/CENTER][/COLOR]" +
        "[CENTER][COLOR=RED] 2.51. [/COLOR][COLOR=WHITE] Запрещено вмешательство в Role Play процесс с целью помехи и препятствования дальнейшего развития Role Play процесса [/color][Color=red] | Jail 30 минут [/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		'[Color=AQUA][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=GREEN][CENTER]✿❯────「Одобрено ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: ACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба была передана на рассмотрение [/color][Color=red] Главному Администратору. @Nadezhda_Gray[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[COLOR=Blue][CENTER]「Ожидайте ответа ❖ На рассмотрение」[/CENTER][/COLOR]',
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба была передана на рассмотрение [/color][Color=red] Главному куратору форума. @Jerry Carters[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[COLOR=Blue][CENTER]「Ожидайте ответа ❖ На рассмотрение」[/CENTER][/COLOR]',
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба была передана на рассмотрение [/color][Color=red] Зам. Главного куратора форума.[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		'[COLOR=Blue][CENTER]「Ожидайте ответа ❖ На рассмотрение」[/CENTER][/COLOR]',
    },
    {
    ...
    },
    {
	  ...
	  content:
        ...
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
	...
	},
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]С момента нарушения от игрока прошло более 72 часов.[/COLOR][/CENTER]" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][Color=red]3.6.[/color][color=FFFF00] Прикрепление доказательств обязательно. Примечание: загрузка доказательств в соц. сети (ВКонтакте, instagram) запрещается, доказательства должны быть загружены на фото/видео хостинги (YouTube, Япикс, imgur).[/COLOR][/CENTER]" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]В данных доказательствах отсутствуют условия сделки.[/COLOR][/CENTER]" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]В таких случаях нужен фрапс.[/COLOR][/CENTER]" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[COLOR=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/COLOR]'+
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Неполный фрапс. Загрузите полный фрапс на ютуб.[/COLOR][/CENTER]" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Жалобы от 3-их лиц не принимаются.[/COLOR][/CENTER]" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]В случае ответного ДМ нужен видео-запись. Пересоздайте тему и прикрепите видео-запись.[/COLOR][/CENTER]" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
	...
	},
	{
	  ...
	  content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Доказательства должны быть загружены на Yapx/Imgur/YouTube.[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
	  ...
	  content:
        ...
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на KURSK.[/ICODE][/CENTER][/color]' +
        '[COLOR=GREEN][CENTER]✿❯────「Одобрено ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      ...
      },
    {
	  ...
	  content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша РП ситуация получает статус-[/color][Color=red] Отказано. [/color][Color=#FFFF00]'Причиной отказа могло послужить какое-либо нарушение из Правила RP ситуаций.[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на KURSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
...
title: 'Неофициальная РП организация скопирована',
     ...
     },
    {
     title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴РП биография.╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
	  ...
	  content:
        ...
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на КURSK.[/CENTER][/color]' +
        '[COLOR=GREEN][CENTER]✿❯────「Одобрено ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
    ...
    },
    {
		...
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://forum.blackrussia.online/threads/kursk-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BD%D0%B0%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D1%8F-rp-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.5925178/']с правилами написания RolePlay биографий.[/URL][/CENTER]<br>" +
