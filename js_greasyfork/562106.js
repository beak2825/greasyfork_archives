...
// @version      1.1
// @description  通用版- 极致灵敏的文字复制/全功能快捷键/白瓷UI/自动回车
// @author       Gemini
// @match        *://*/*
// @grant        GM_download
...
// @downloadURL https://update.greasyfork.org/scripts/562106/%E5%9B%BE%E7%89%87%E4%B8%8B%E8%BD%BD%E5%99%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/562106/%E5%9B%BE%E7%89%87%E4%B8%8B%E8%BD%BD%E5%99%A8.meta.js
// ==/UserScript==
...
(function() {
    ...
    // === 1. 状态与常量 ===
    // ==========================================
    // 1. 表情包映射字典 (Weibo/WeChat style -> Unicode)
    // ==========================================
    const EMOJI_MAP = {
        // --- 😀 基础表情 (Faces & Emotions) ---
        '[微笑]': '🙂',
