...
// @downloadURL https://update.greasyfork.org/scripts/6627/MouseHunt%20AutoBot%20Enhanced%20Edition.user.js
// @updateURL https://update.greasyfork.org/scripts/6627/MouseHunt%20AutoBot%20Enhanced%20Edition.meta.js
// ==/UserScript==
...
function embedTimer(targetPage) {
    if (showTimerInPage) {
        ...
        if (headerElement) {
			...
			preferenceHTMLStr += '<option value="Burroughs Rift(Green)" selected>Burroughs Rift(Green)</option>';
