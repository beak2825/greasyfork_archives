...
// @grant        none
// @namespace https://greasyfork.org/users/817437
// @downloadURL https://update.greasyfork.org/scripts/432722/Khan%20Pwn.user.js
// @updateURL https://update.greasyfork.org/scripts/432722/Khan%20Pwn.meta.js
// ==/UserScript==
...
(function () {
    ...
    class Answer {
        ...
        log() {
            ...
            const style = "color: mediumvioletred; -webkit-text-stroke: .5px black; font-size:24px; font-weight:bold;";
    ...
    window.fetch = function () {
        return originalFetch.apply(this, arguments).then((res) => {
            ...
            if (!window.loaded) {
                ...
                console.log("%cCreated by Chris(@officialchrismarcos on ig :^)", "color: white; -webkit-text-stroke: .5px black; font-size:15px; font-weight:bold;");
                window.loaded = true;
            }
