...
// @icon           https://github.com/DylanArens/Grepolis-QT/blob/master/images/eshmcqzu.png?raw=true
// @version        2.59.00
// @resource       HTML2Canvas https://raw.githubusercontent.com/Quackmaster/html2canvas/v0.4/build/html2canvas.js
// @resource       QT_styles https://raw.githubusercontent.com/DylanArens/Grepolis-QT/master/QT_styles.css
// @grant          GM_getValue
// @grant          GM_setValue
...
// @downloadURL https://update.greasyfork.org/scripts/398160/Quack%20Toolsammlung%20%28Fixed%29.user.js
// @updateURL https://update.greasyfork.org/scripts/398160/Quack%20Toolsammlung%20%28Fixed%29.meta.js
// ==/UserScript==
...
function main_script(DATA) {
	...
	QT.Lang = {
		...
		br: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/u6xmafci.png?raw=true'
			},
			reports: {
		...
		cz: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/ctjo8fgu.png?raw=true'
			},
			reports: {
		...
		de: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/xpd69nmj.png?raw=true',
				changelog: 'http://adf.ly/1F7EBy',
				forumlink: 'http://adf.ly/cbQaZ',
				forumlink_addfree: 'http://forum.de.grepolis.com/showthread.php?20742',
				donation_btn: '<a href="http://paypal.me/quacktoolsammlung" target="_blank"><img src="https://www.paypal.com/de_DE/i/btn/btn_donate_LG.gif?raw=true" alt="Spenden"></a>',
		...
		es: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/6lxubx63.png?raw=true',
				donation_btn: '<a href="http://paypal.me/quacktoolsammlung" target="_blank"><img src="https://www.paypal.com/es_ES/i/btn/btn_donate_LG.gif?raw=true" alt="Donar"></a>'
			},
			reports: {
		...
		fr: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/fo8msuwx.png?raw=true',
				donation_btn: '<a href="http://paypal.me/quacktoolsammlung" target="_blank"><img src="https://www.paypal.com/fr_FR/i/btn/btn_donate_LG.gif?raw=true" alt="Donate"></a>'
			},
			reports: {
		...
		gr: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/ki6kli48.png?raw=true'
			},
			reports: {
		...
		hu: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/3k2lqw68.png?raw=true',
			},
			reports: {
		...
		it: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/rxk9hlkk.png?raw=true',
				donation_btn: '<a href="http://paypal.me/quacktoolsammlung" target="_blank"><img src="https://www.paypal.com/it_IT/i/btn/btn_donate_LG.gif?raw=true" alt="Donate"></a>'
			},
			reports: {
		...
		nl: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/bn8q27or.png?raw=true',
				donation_btn: '<a href="http://paypal.me/quacktoolsammlung" target="_blank"><img src="https://www.paypal.com/nl_NL/i/btn/btn_donate_LG.gif?raw=true" alt="Donatie"></a>'
			},
			reports: {
		...
		pl: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/yno6pw5g.png?raw=true',
				donation_btn: '<a href="http://paypal.me/quacktoolsammlung" target="_blank"><img src="https://www.paypal.com/pl_PL/i/btn/btn_donate_LG.gif?raw=true" alt="Donate"></a>'
			},
			reports: {
		...
		pt: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/37p8cy33.png?raw=true',
			},
			reports: {
		...
		ro: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/uqbqdqcf.png?raw=true',
			},
			reports: {
		...
		ru: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/7bsp2aye.png?raw=true',
				donation_btn: '<a href="http://paypal.me/quacktoolsammlung" target="_blank"><img src="https://www.paypal.com/ru_RU/i/btn/btn_donate_LG.gif?raw=true" alt="Donate"></a>'
			},
			reports: {
		...
		en: {
			meta: {
				flag: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/e2nfyth9.png?raw=true',
				changelog: 'http://adf.ly/1F7F0A',
				forumlink: 'http://adf.ly/fJDMD',
				forumlink_addfree: 'http://forum.en.grepolis.com/showthread.php?51999',
				donation_btn: '<a href="http://paypal.me/quacktoolsammlung" target="_blank"><img src="https://www.paypal.com/en_US/i/btn/btn_donate_LG.gif?raw=true" alt="Donate"></a>',
	...
	QT.Images = {
		hotkeys: {
			key: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/dj4uootz.jpg?raw=true',
			city_select: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/nzhgrbzm.png?raw=true?',
			administrator: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/j4kvrnok.png?raw=true',
			captain: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/8r8ty3md.png?raw=true',
			menu: 'https://github.com/DylanArens/Grepolis-QT/blob/master/images/giiagnrp.png?raw=true'
		},
		archer: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/l2xgz8zg.jpg?raw=true",
		attack_ship: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/mvlqonug.jpg?raw=true",
		big_transporter: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/shdrwvx4.jpg?raw=true",
		bireme: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/op3pm7ig.jpg?raw=true",
		calydonian_boar: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/5qr5nmxo.jpg?raw=true",
		catapult: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/gv9r6p24.jpg?raw=true",
		centaur: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/7lytp7ku.jpg?raw=true",
		cerberus: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/58gsjmi9.jpg?raw=true",
		chariot: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/vlfs3fmp.jpg?raw=true",
		colonize_ship: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/zgcvw7q2.jpg?raw=true",
		demolition_ship: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/h3isd3id.jpg?raw=true",
		fury: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/97qhkxxu.jpg?raw=true",
		godsent: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/oc3euuhk.jpg?raw=true",
		griffin: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/lukxwqlc.jpg?raw=true",
		harpy: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/7hl9sx8x.jpg?raw=true",
		hoplite: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/lllk8ef5.jpg?raw=true",
		manticore: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/dz3wluob.jpg?raw=true",
		medusa: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/6qgf9chs.jpg?raw=true",
		militia: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/exvjtpb6.jpg?raw=true",
		minotaur: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/o8a34o3n.jpg?raw=true",
		pegasus: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/e8ovbacv.jpg?raw=true",
		rider: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/39pvt7u6.jpg?raw=true",
		sea_monster: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/hflh35u5.jpg?raw=true",
		slinger: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/jtfdfuk9.jpg?raw=true",
		small_transporter: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/oxgq69a8.jpg?raw=true",
		sword: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/vpaij5z9.jpg?raw=true",
		trireme: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/mdzzpxye.jpg?raw=true",
		zyklop: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/oihz5sop.jpg?raw=true",
		andromeda: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/4jdz5tso.jpg?raw=true",
		atalanta: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/yo6vp8l2.jpg?raw=true",
		cheiron: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/tkpytdq8.jpg?raw=true",
		ferkyon: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/glncylst.jpg?raw=true",
		helen: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/m75fi7pf.jpg?raw=true",
		hercules: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/hnaqid9l.jpg?raw=true",
		leonidas: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/tskyuwpt.jpg?raw=true",
		orpheus: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/hfjeztt4.jpg?raw=true",
		terylea: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/vev4s7z7.jpg?raw=true",
		urephon: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/jfqewwux.jpg?raw=true",
		zuretha: "https://github.com/DylanArens/Grepolis-QT/blob/master/images/o6cf8cya.jpg?raw=true",
	};
	...
	QT.Helper = {
		...
		Inactivity: {
			...
			addDisplay: function (style, playerID) {
				...
				return '<a class="qt_activity" style="display:block; float:left; width:20px; height:12px; text-decoration:none; background:url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/7fwyuv54.gif?raw=true) no-repeat;' + style + '" href="http://polissuche.marco93.de/' + wID + '.html?filter=player_id:' + playerID + currentTownXY + '" target="_blank"><span class="qt_activity_number" style="display:block; margin-top:1px; font-size: 8px; color:#EEDDBB; text-shadow:1px 1px #000000; text-align:center"></span></a>';
			},
			getBG: function (number_days) {
				var bgImage = "https://github.com/DylanArens/Grepolis-QT/blob/master/images/mju99vog.png?raw=true";
				var bgPos = "";
				if (number_days < 2) {
					bgPos = "0 -12px";
		...
		Screenshot: {
			btn_preview: function (element, id, window_type, callback) {
				...
				$("#" + id).css({
					...
					"height": "23px",
					"width": "22px",
					"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/3j8vsimv.png?raw=true)",
			...
			canvasDraw: {
				addElements: function () {
					...
					$("#qt_canvas_toolbar").css({ "position": "absolute", "right": "40px", "margin-top": "-22px", "z-index": "2", "height": "23px", "padding": "0 8px", "background": "url(https://gpde.innogamescdn.com/images/game/border/odd.png?raw=true)" });
					...
					$("#eraser").css({ "background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/5u8ojvzq.png?raw=true)" });
					$("#pencil").css({ "background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/9rjcrqfy.png?raw=true)", "background-position": "0px -23px" });
					$("#arrow").css({ "background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/tapgcj8q.png?raw=true)" });
					$("#rectangel").css({ "background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/xi25lbk7.png?raw=true)" });
					$("#line").css({ "background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/8pyhdwes.png?raw=true)" });
					$("#arc").css({ "background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/eufhyzin.png?raw=true)" });
			...
			open_window: function (title) {
				...
				var wnd = GPWindowMgr.Create(GPWindowMgr.TYPE_QT_REPORTEXPORT) || GPWindowMgr.getOpenFirst(GPWindowMgr.TYPE_QT_REPORTEXPORT); //<img class="qt_transparent" src="http://cdn.grepolis.com/images/transparent.png?raw=true">
				wnd.setTitle(title);
				wnd.setContent(html);
				...
				if (/chrom(e|ium)/.test(navigator.userAgent.toLowerCase())) {
					...
					$("#qt_chrome_info").css({ "top": "8px", "right": "7px", "position": "absolute", "height": "24px", "width": "26px", "background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/cqz59o6t.png?raw=true)", "background-repeat": "no-repeat", "background-position": "0px 0px" });
					$('#qt_chrome_info').mousePopup(new MousePopup(QT.Lang.get("export_window", "chrome")));
				}

				$("#qt_export_info").css({ "top": "8px", "left": "7px", "position": "absolute", "height": "24px", "width": "26px", "background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/3wmopfj5.png?raw=true)", "background-repeat": "no-repeat", "background-position": "0px 0px" });
				$("#qt_export_ajax").css({ "display": "none", "background": "url(https://gpde.innogamescdn.com/images/game/ajax-loader_2.76.gif?raw=true) no-repeat scroll center center rgba(0, 0, 0, 0.5)", "position": "absolute", "width": "100%", "height": "100%", "z-index": "1000" });
					...
					onrendered: function (canvas) {
						...
						image.onload = function () {
							...
							$.ajax({
								...
								data: {
									type: 'base64',
									name: 'quack_toolsammlung.jpg?raw=true',
	...
	QT.Functions = {
		...
		addsettingsbutton: function () {
			...
			if ($(c).find('#quack-toolsammlung').length == 0) {
				$(c[0]).append('<li><img id="quackicon" src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/r2q9fzri.png?raw=true"></img> <a id="quack-toolsammlung" href="#">Quack Toolsammlung</a></li>');
		...
		allianceStatsButtons: function (settings) {
			...
			$(d[0]).append("<a target=_blank href=http://" + mID + ".grepostats.com/world/" + wID + "/alliance/" + b[1] + '><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/kxn3oknc.png?raw=true"></a>');
			if (mID === "de") {
				$(d[0]).append('<a target="_blank" href="http://marekblomkvist.com/quo/' + wID + '/' + b[1] + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/fhkhdsdc.png?raw=true"></a>')
			}
		},
		...
		bbcodes: function (mode) {
			...
			if (mode === "bbcode_intown") {
				...
				var q_buildings_special = {
					"trade_office": "https://github.com/DylanArens/Grepolis-QT/blob/master/images/sivub4fd.png?raw=true",
					"tower": "https://github.com/DylanArens/Grepolis-QT/blob/master/images/wjbtzr8z.png?raw=true",
					"thermal": "https://github.com/DylanArens/Grepolis-QT/blob/master/images/9hzexzo7.png?raw=true",
					"theater": "https://github.com/DylanArens/Grepolis-QT/blob/master/images/daevkl33.png?raw=true",
					"statue": "https://github.com/DylanArens/Grepolis-QT/blob/master/images/67vl4qhs.png?raw=true",
					"oracle": "https://github.com/DylanArens/Grepolis-QT/blob/master/images/7jj7uzgp.png?raw=true",
					"lighthouse": "https://github.com/DylanArens/Grepolis-QT/blob/master/images/xanhmd6w.png?raw=true",
					"library": "https://github.com/DylanArens/Grepolis-QT/blob/master/images/3yl9yvuc.png?raw=true"
				}
				...
				bb_content = "[quote][b]" + QT.Lang.get("bbcode", "building") + " " + QT.Lang.get("bbcode", "in") + " [/b][town]" + parseInt(Game.townId) + "[/town]:\n[font=monospace]" + q_buildings_headline + "\n[img]https://github.com/DylanArens/Grepolis-QT/blob/master/images/vif5htpa.png?raw=true[/img]" + lv_buildings_standard + "[size=8]" + lv_buildings_standard_reihenfolge.slice(0, -1) + "[/size][/font][/quote]";
		...
		city_view_btn: function () {
			...
			$('#ui_box .nui_main_menu .middle .content ul').not("ul li ul").prepend('<li data-option-id="cityview" class="messages main_menu_item first"><span class="content_wrapper"><span class="button_wrapper" style="opacity: 1;"><span class="button"><span class="icon" style="background:url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/vbvnndai.png?raw=true)"></span><span class="indicator" style="display: none;">0</span></span></span><span class="name_wrapper" style="opacity: 1;"><span class="name">' + QT.Lang.get("grepo_mainmenu", "city_view") + '</span></span></span></li>');
			...
			function QT_island_overview() {
				$('#ui_box .nui_main_menu .middle .content ul li[data-option-id=cityview] .icon').css({
					"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/rwe2n26g.png?raw=true) no-repeat",
					"top": "8px",
					"left": "5px"
				});
			...
			function QT_city_overview() {
				$('#ui_box .nui_main_menu .middle .content ul li[data-option-id=cityview] .icon').css({
					"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/vbvnndai.png?raw=true) no-repeat",
					"top": "6px",
					"left": "6px"
				});
		...
		cultureOverview: function () {
			...
			if ($('#qcultureBTN_wrapper').length == 0) {
				...
				$(".qcultureBTN_l, .qcultureBTN_r").css({
					...
					"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/lztu5tha.png?raw=true)"
				});
			...
			islandHeader: function () {
				$('#fto_town_list li').each(function (index) {
					if (this.classList.length == 2) {
						...
						$(this).append(
							'<div class="qcolordivider" style="background-image: url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/wqknyseg.png?raw=true); display: block; height: 24px; margin: -4px -2px;"></div>' +
				...
				$("#fto_town_wrapper .game_header").append('<a href="#" id="q_toggleAutohide" style="top: 6px; right: 5px; position: absolute; height: 11px; width: 17px; background-image: url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/bydwxdus.png?raw=true)"></a>');
			...
			if ($('#forum #postlist').length) {
				...
				if (!$('#qdeletemultipleBTN').length && $('.qdeletecheckbox').length) {
					...
					$(".q_delete").css({
						...
						"height": "23px",
						"width": "22px",
						"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/sz66nazr.png?raw=true)",
						"background-repeat": "no-repeat",
						"background-position": "0px 0px"
					});
					$(".q_delete").hover(
				...
				$('#qdeletemultipleBTN').click(function () {
					...
					if (numberChecked > 0) {
						var deleteconfirmText = "<img style='position: absolute; top:5px;' src='https://github.com/DylanArens/Grepolis-QT/blob/master/images/d7ce2sy6.png?raw=true'><span style='position: absolute; color: #141414; font: 21px TrajanPro; display: inline; letter-spacing: -5px; margin: -14px auto; padding-left: 0px; width: 22px;'><b>" + numberChecked + "</b></span><br/>" + QT.Lang.get("forum", "delete_sure") + "";
		...
		fullscreenmode: function () {
			...
			$('<div id="vb_back" style="position:absolute;cursor:pointer;z-index:1;top:1px;left:50%;border:1px solid #FFCC66;background-color:#2D5487"><img src=https://github.com/DylanArens/Grepolis-QT/blob/master/images/4tnvbg37.png?raw=true></img></div>').appendTo("body");
		...
		hotkeys: function () {
			if (QT.Settings.values.qmenu_settings_hotkey_anzeige) {
				$('<a id="BTN_HK" style="z-index:6;position:absolute;top:3px;left:366px;" href="#"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/88q6ajaa.png?raw=true" style="border-width: 0px" /></a></a>').appendTo('#ui_box');
		...
		islandMessage: function () {
			...
			$(".q_message").css({
				...
				"height": "23px",
				"width": "22px",
				"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/4lhes4y6.png?raw=true)",
				"background-repeat": "no-repeat",
				"background-position": "0px 0px"
			});
			$(".q_message").hover(
		...
		messageExport: function () {
			...
			if ($("#qt_messageExport").is(":visible"))
				return;
			$("DIV#gpwnd_" + wndID + " DIV#message_message_list .game_header:first").append('<div id="qt_messageExport" style="float:right; margin-top:-19px; cursor:pointer;"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true"/></div><div id="qt_messageExportTMP" style="display:none"></div>');
			...
			$("#qt_messageExport").click(function () {
				...
				$("#message_post_container .message_post").each(function (index, element) {
					...
					qt_messageExportTMP.find(".bbcode_awards").replaceWith("[img]https://github.com/DylanArens/Grepolis-QT/blob/master/images/twuzm5vx.png?raw=true[/img]"); //replace awards
					...
					bb_content += '[img]https://github.com/DylanArens/Grepolis-QT/blob/master/images/izczcrte.png?raw=true[/img]\n';
					...
					bb_content += postHTML + "\n";
					bb_content += '[img]https://github.com/DylanArens/Grepolis-QT/blob/master/images/f3i4p5oy.png?raw=true[/img]';
					bb_content += "\n";
				});
		...
		playerGSButton: function (settings) {
			...
			if (!c)
				return;
			var d = $("DIV#gpwnd_" + c.getID() + " DIV#player_buttons ");
			$(d[0]).append("<a target=_blank href=http://" + mID + ".grepostats.com/world/" + wID + "/player/" + b[1] + '><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/kxn3oknc.png?raw=true"></a>')
		},
		...
		qtoolbox: function () {
			...
			if (!QT.Settings.values.grepolistoolkit) {
				...
				$('#qt_gtk_fix').css({
					"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/6zzbzb3l.png?raw=true) no-repeat",
					"position": "absolute",
					"top": "-73px",
					"width": "144px",
					"height": "20px"
				...
				.nui_main_menu .content ul li.last .button_wrapper {background: url("https://gpde.innogamescdn.com/images/game/layout/layout_2.71.png?raw=true") no-repeat scroll -784px -162px rgba(0, 0, 0, 0); width: 20px; height: 18px}\
			...
			$('#qt_mainmenu_top').css({
				"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/duowfxnl.png?raw=true) no-repeat",
				"width": "144px",
				"height": "35px",
				"position": "absolute",
				"margin-top": "-22px"
			...
			$('#qt_border_bottom').css({
				"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/jltfmtqi.png?raw=true) no-repeat center center",
				"width": "144px",
				"height": "14px"
			});
			$('#qtbox_main_btn').css({
				"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/nebf5887.png?raw=true) no-repeat",
				"position": "absolute",
				"top": "14px",
				"left": "60px",
				"width": "20px",
			...
			$('#qt_mainmenu_list').css({
				"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/6waopcew.png?raw=true) repeat-y",
			...
			$("#qtbox_main_btn").hover(
				function () {
					$(this).css({
						"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/ywi4jbg2.png?raw=true)"
					});
				},
				function () {
					$(this).css({
						"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/nebf5887.png?raw=true)"
					});
				});

			var qtbox_main_array = [
				[QT.Lang.get("qtoolbox", "stats"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/vnghthhz.png?raw=true", "",
				[QT.Lang.get("qtoolbox", "grepoworld"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/2txtp9xz.png?raw=true", "",
				[QT.Lang.get("qtoolbox", "player"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/8xgicpg7.png?raw=true", "link_grepoworld_player"],
				[QT.Lang.get("qtoolbox", "alliance"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/4kfl493a.png?raw=true", "link_grepoworld_alliance"]],
				//[QT.Lang.get("qtoolbox", "rankings"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/p2otvkuz.png?raw=true", "link_gs_rankings"],
				[QT.Lang.get("qtoolbox", "grepo_intel"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/u33cb3b8.jpg?raw=true", "",
				[QT.Lang.get("qtoolbox", "track_player"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/8xgicpg7.png?raw=true", "link_gi_player"],
				[QT.Lang.get("qtoolbox", "track_alliance"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/4kfl493a.png?raw=true", "link_gi_alliance"],
				[QT.Lang.get("qtoolbox", "top_killers"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/p2otvkuz.png?raw=true", "link_gi_topkillers"]],
				//[QT.Lang.get("qtoolbox", "grepo_bash"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/x766ldmm.png?raw=true", "link_grepobash"],
				[QT.Lang.get("qtoolbox", "quo"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/fhkhdsdc.png?raw=true", "link_quo"]],
				[QT.Lang.get("qtoolbox", "maps"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/4hbt2ofa.png?raw=true", "",
				[QT.Lang.get("qtoolbox", "grepo_maps"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/4hbt2ofa.png?raw=true", "link_maps_grepomaps"],
				[QT.Lang.get("qtoolbox", "grepo_intel"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/u33cb3b8.jpg?raw=true", "link_maps_grepointel"]],
				[QT.Lang.get("qtoolbox", "townsearches"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/vlnknenk.png?raw=true", "",
				//[QT.Lang.get("qtoolbox", "tonda_polissuche"), "http://polissuche.marco93.de/favicon.ico", "link_polissuche"],
				[QT.Lang.get("qtoolbox", "grepo_finder"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/5c6ak7br.jpg?raw=true", "link_grepofinder"]],
				[QT.Lang.get("qtoolbox", "bb_codes"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true", "",
				[QT.Lang.get("bbcode", "troops"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/a2w2xe8r.png?raw=true", "",
				[QT.Lang.get("qtoolbox", "in_town"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true", "bbcode_intown"],
				[QT.Lang.get("qtoolbox", "from_town"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true", "bbcode_fromtown"]],
				//[QT.Lang.get("qtoolbox","outside"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true", "bbcode_outer"]
				[QT.Lang.get("bbcode", "cities"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/3l6c8vw4.png?raw=true", "",
				[QT.Lang.get("bbcode", "all"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true", "bbcode_cities_all"],
				[QT.Lang.get("bbcode", "active_grp"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true", "bbcode_cities_grp"]],
				[QT.Lang.get("bbcode", "building"), "http://cdn.grepolis.com/images/game/overviews/main_20x20.png?raw=true", "bbcode_buildings"]],
				[QT.Lang.get("qtoolbox", "tools"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/aj92dgb3.png?raw=true", "",
				[QT.Lang.get("qtoolbox", "unit_comparison"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/xli4g4p8.png?raw=true", "unitcomparison"],
				[QT.Lang.get("qtoolbox", "google_docs"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/cbromm2l.png?raw=true", "googledocs"],
				[QT.Lang.get("qtoolbox", "full_screen"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/2erjlsv4.png?raw=true", "fullscreenmode"]],
				[QT.Lang.get("qtoolbox", "stats_scripts"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/rpccjan7.png?raw=true", "statsandscripts"],
				[QT.Lang.get("qtoolbox", "settings"), "https://github.com/DylanArens/Grepolis-QT/blob/master/images/xg4fgyo5.png?raw=true", "scriptmanager"]
			];
			...
			$(".qmenu_arrow_span").css({
				...
				"width": "9px",
				"height": "7px",
				"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/noivoqy4.png?raw=true) no-repeat center center"
			});
			$(".qmenu_window").css({
				"display": "none",
				"position": "absolute",
				...
				"margin-top": "-22px",
				"width": "142px",
				"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/6waopcew.png?raw=true)"
			});
			$(".qmenu_window li").css({
				"margin-left": "9px"
			});
			...
			$(".qmenu_window_first").css({
				...
				"padding": "0",
				"margin": "-2px 0 0 0",
				"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/gxng9w7z.png?raw=true)"
			});
			$(".qmenu_window_last").css({
				...
				"padding": "0",
				"margin": "2px 0 0 0",
				"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/y7dq3n8j.png?raw=true)"
			});
			...
			if (QT.Settings.values.qmenu_settings_buttonbar) {
				$('#qtbox_wrapper').append('<div id="qtbox_buttons_wrapper" style="display: block; position: relative; height: 26px; width: 100%; left: 2px; bottom: 0px; background:url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/wh2uwdro.png?raw=true) no-repeat"></div>');
				$('#ui_box .nui_main_menu .bottom, #ui_box .nui_main_menu .leaves').css({
					"bottom": "-=27px"
				});
				$('#qtbox_buttons_wrapper').append('<a id="qtbox_button1" class="qtbox_button" style="display: block; position: absolute; width: 24px; height: 22px; margin: 1px 0 0 3px;" target="_blank" href="' + QT.Links.grepoworld_player + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/6ai4ye3s.png?raw=true"></a><a id="qtbox_button2" class="qtbox_button" style="display: block; position: absolute; width: 24px; height: 22px; margin: 1px 0 0 29px;" target="_blank" href="' + QT.Links.GrepoIntelPlayer + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/2hr8vbhw.png?raw=true"></a><a id="qtbox_button3" class="qtbox_button" style="display: block; position: absolute; width: 24px; height: 22px; margin: 1px 0 0 55px;" target="_blank" href="' + QT.Links.quo + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/wfe9ficd.png?raw=true"></a><a id="qtbox_button4" class="qtbox_button" style="display: block; position: absolute; width: 24px; height: 22px; margin: 1px 0 0 81px;" target="_blank" href="' + QT.Links.GrepoMaps + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/hdh4farx.png?raw=true"></a><a id="qtbox_button5" class="qtbox_button" style="display: block; position: absolute; width: 24px; height: 22px; margin: 1px 0 0 107px;" target="_blank" href="' + QT.Links.Polissuche + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/5zj4ujmi.png?raw=true"></a>');
				...
				$(".qtbox_button").hover(
					function () {
						$(this).css({
							"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/vyhnznhd.png?raw=true)"
						});
					},
					function () {
						$(this).css({
			...
			*/
			...
			if (QT.Settings.values.qmenu_settings_counter) {
				$('#qtbox_wrapper').append('<div id="qtbox_clock_wrapper" style="display: block; position: relative; height: 21px; left: 2px; width: 100%; background:url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/desspey5.png?raw=true) no-repeat"><a id="qt_clock_clock" style="display: block; position: absolute; height: 17px; background: url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/qqcsqnfm.png?raw=true) no-repeat scroll 0px 2px transparent; margin-left: 5px; width: 127px;" href="#"><span id="qt_clock_span" style="display: block; color: #EEDDBB; font-size: 9px; width: 110px; position: absolute; bottom: 2px; margin-left: 10px;"></span></a></div>');
				$('#ui_box .nui_main_menu .bottom, #ui_box .nui_main_menu .leaves').css({
					"bottom": "-=21px"
				});
		...
		reportsFilter: function () {
			...
			if (!$("#qmenu_berichte_icon_wrapper").is(":visible")) {
				...
				$('<label class="qmenu_berichte_Icon" style="background-image: url(http://cdn.grepolis.com/images/game/unit_overview/filter_24x24.png?raw=true);background-position: 0 0;"><input type="checkbox" id="angriffe" class="qmenu_berichte_checkbox"></label>').appendTo('#qmenu_berichte_icon_wrapper');
				$('<label class="qmenu_berichte_Icon" style="background-image: url(http://cdn.grepolis.com/images/game/unit_overview/filter_24x24.png?raw=true);background-position: -24px 0;"><input type="checkbox" id="unterstützungen" class="qmenu_berichte_checkbox"></label>').appendTo('#qmenu_berichte_icon_wrapper');
				$('<label class="qmenu_berichte_Icon" style="background-image: url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/7hzmc2e7.png?raw=true);"><input type="checkbox" id="zauber" class="qmenu_berichte_checkbox"></label>').appendTo('#qmenu_berichte_icon_wrapper');
				$('<label class="qmenu_berichte_Icon" style="background-image: url(http://cdn.grepolis.com/images/game/unit_overview/filter_24x24.png?raw=true);background-position: -72px 0;"><input type="checkbox" id="spios" class="qmenu_berichte_checkbox"></label>').appendTo('#qmenu_berichte_icon_wrapper');
				$('<label class="qmenu_berichte_Icon" style="background-image: url(http://cdn.grepolis.com/images/game/unit_overview/filter_24x24.png?raw=true);background-position: -96px 0;"><input type="checkbox" id="farm" class="qmenu_berichte_checkbox"></label>').appendTo('#qmenu_berichte_icon_wrapper');
		...
		reportsLosses: function () {
			...
			var report_type = $("DIV#gpwnd_" + c + " DIV#report_arrow img").attr("src").replace(/.*\/([a-z_]*)\.png?raw=true.*/, "$1");
			switch (report_type) {
				case "attack":
				case "take_over":
				case "breach":
					...
					if ($("DIV#gpwnd_" + c + " DIV#resources").length) {
						$("DIV#gpwnd_" + c + " .report_side_attacker_unit").each(function (index, value) {
							...
							if (unitName != "militia" && !unitClass[6] && unitNumber != "-?") {
								...
								var unitPopup = GameData.units[unitName].name + '<div style="margin-top: 5px; margin-bottom:5px; height: 1px; border: none; background: #B48F45"/><img src="http://cdn.grepolis.com/images/game/res/wood.png?raw=true" width="20" height="20"/> ' + AttackUnitsRessources.unit_w + '<br> <img src="http://cdn.grepolis.com/images/game/res/stone.png?raw=true" width="20" height="20"/> ' + AttackUnitsRessources.unit_s + '<br> <img src="http://cdn.grepolis.com/images/game/res/iron.png?raw=true" width="20" height="20"/> ' + AttackUnitsRessources.unit_i + '<br> <img src="http://cdn.grepolis.com/images/game/res/favor.png?raw=true" width="20" height="20"/> ' + AttackUnitsRessources.unit_f + '<br> <img src="http://cdn.grepolis.com/images/game/res/pop.png?raw=true" width="20" height="20"/> ' + AttackUnitsRessources.unit_p;
						...
						$("DIV#gpwnd_" + c + " .report_side_defender_unit").each(function (index, value) {
							...
							if (unitName != "militia" && !unitClass[6] && unitNumber != "-?") {
								...
								var unitPopup = GameData.units[unitName].name + '<div style="margin-top: 5px; margin-bottom:5px; height: 1px; border: none; background: #B48F45"/><img src="http://cdn.grepolis.com/images/game/res/wood.png?raw=true" width="20" height="20"/> ' + DefenseUnitsRessources.unit_w + '<br> <img src="http://cdn.grepolis.com/images/game/res/stone.png?raw=true" width="20" height="20"/> ' + DefenseUnitsRessources.unit_s + '<br> <img src="http://cdn.grepolis.com/images/game/res/iron.png?raw=true" width="20" height="20"/> ' + DefenseUnitsRessources.unit_i + '<br> <img src="http://cdn.grepolis.com/images/game/res/favor.png?raw=true" width="20" height="20"/> ' + DefenseUnitsRessources.unit_f + '<br> <img src="http://cdn.grepolis.com/images/game/res/pop.png?raw=true" width="20" height="20"/> ' + DefenseUnitsRessources.unit_p;
								$("div.report_unit", this).mousePopup(new MousePopup(unitPopup));
							}
						});
		...
		reportExport: function () {
			...
			if ($("DIV#gpwnd_" + d + " .support_report_cities").length > 0) {
				...
				report_type = $("DIV#gpwnd_" + d + " DIV#report_arrow img").attr("src").replace(/.*\/([A-Za-z0-9_.]*)\.png?raw=true.*/, "$1");
		...
		scriptmanager: function () {
			...
			function tab3() {
				...
				HTML_tab3 += '<td width="33%" style="text-align:right"><img style="margin-right: -10px" src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/bl938hld.png?raw=true"></td></tr></tbody></table>';
				HTML_tab3 += '<div style="text-align: justify"><p />This is a fixed version of the original script. Many images did not work because they got removed from the site. I recovered most of them, but not all. This fixed version will be further maintained by Megasmorf (NL)<br /><br />' + QT.Lang.get("settings", "prologue") + '</div>';
		...
		statsandscripts: function () {
			...
			$.each(SAS_HTML, function (a, b) {
				inhalt += '<div id="' + b[0] + '">' + grepoGameBorder + b[0] + '<a class="forum_export" style="float:right" href="#"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true" style="margin-top: -2px; margin-left: 11px;" /></a>' + "</div>" + grepoGameBorderContainer;
				$.each(b[1], function (c, d) {
		...
		tb_activitiesExtra: function () {
			...
			$('<style id="qplusmenustyle" type="text/css">\
																									...
																									.qplusdraghandle {width:100%;height:11px;position:absolute;background:url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/7guz6abs.png?raw=true)}\
																									.qplusback {right:-18px;margin-top:-1px;width:16px;height:12px;position:absolute;background:url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/u6le7bdw.png?raw=true)}\
																									</style>').appendTo('head');
		...
		townStatsButtons: function () {
			...
			for (var e in wndArray) {
				if (wndArray.hasOwnProperty(e)) {
					...
					//$(j[1]).append('<a class="qt_gsbutton" target="_blank" href="http://' + i + ".grepostats.com/world/" + h + "/player/" + g.id + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/kxn3oknc.png?raw=true"></a>');
					//$(j[1]).css("width", "+=25px");
					...
					//l.css("width", "+=26px");
					//l.append('<span class="qt_gsbutton"><a class="qt_gsbutton" target="_blank" href="http://' + i + ".grepostats.com/world/" + h + "/alliance/" + k + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/kxn3oknc.png?raw=true"></a></span>');
					if (mID === "de") {
						l.css("width", "+=26px");
						l.append('<a class="qt_quobutton" target="_blank" href="http://marekblomkvist.com/quo/' + h + '/' + k + '"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/fhkhdsdc.png?raw=true"></a>');
					}
				}
			}
		},
		...
		townTradeImprovement: function () {
			...
			QT.wnd.find(".q_send_cult").css({
				...
				"height": "16px",
				"width": "22px",
				"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/d67gpq9g.png?raw=true)",
				"background-repeat": "no-repeat",
			...
			QT.wnd.find(".q_send_cult_reverse").css({
				...
				"height": "16px",
				"width": "22px",
				"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/p6jyv8gu.png?raw=true)",
				"background-repeat": "no-repeat",
				"background-position": "0px -1px"
			});
			QT.wnd.find(".q_max").css({
				...
				"height": "16px",
				"width": "22px",
				"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/x2pnbew9.png?raw=true)",
				"background-repeat": "no-repeat",
				"background-position": "0px -1px"
			});
		...
		townslist: function () {
			if ($('#town_groups_list a.town_bb').length != 0)
				return;
			$('.content .group_name .name').append('<a class="town_bb" style="position: absolute; display: block; top: 4px; right: 16px;" href="#"><img src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/8tzken7v.png?raw=true" style="height: 15px; width: 17px;" /></a>');
			...
			$('.town_group_town').hover(function () {
				...
				$(".jump_town")
					.css({
						...
						"width": "16px",
						"position": "absolute",
						"background": "url('http://cdn.grepolis.com/images/game/layout/town_list_btns.png?raw=true') repeat scroll -32px 0 transparent"
					})
					.click(function (e) {
						e.stopPropagation();
		...
		transportcalculator: {
			init: function () {
				...
				$("#tr_btn").css({
					...
					"color": "#EEDDBB",
					"padding-left": "3px",
					"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/2mughecu.png?raw=true) no-repeat scroll 0 0 rgba(0, 0, 0, 0)"
				});
				$("#tr_btn_top").css({
					"position": "absolute",
					"height": "6px",
					...
					"bottom": "14px",
					"width": "138px",
					"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/9ol6fg6t.png?raw=true) no-repeat"
				});
				$("#tr_wrapper").css({
					...
					"display": "none",
					"margin-left": "-6px",
					"background": "url(http://zz.cdn.grepolis.com/images/game/layout/layout_units_nav_bg.png?raw=true) repeat scroll 0 0 rgba(0, 0, 0, 0)"
				});
				$(".tr_options").css({
					"background": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/zo8kqb7x.png?raw=true) no-repeat scroll 0 0 rgba(0, 0, 0, 0)",
					"width": "15px",
					"height": "18px",
					"float": "left"
				});
				...
				$(".tr_deactivated").css({
					"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/z474f6rk.png?raw=true)"
				});
			...
			refresh: function () {
				...
				function createHint(Transport_Capacity, Ground_Units_BHP) {
					var textCapacity = '' + QT.Lang.get("transport_calc", "available") + '<br><span style="background: url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/6coe5znl.png?raw=true) repeat scroll 0 0 rgba(0, 0, 0, 0); color: #EEDDBB; font-family: Verdana; font-size: 11px; font-weight: bold; text-shadow: 1px 1px 0 #000000; width:110px; display:inline-block"><b>' + Transport_Capacity + '</b></span>';
					var textUnits = '' + QT.Lang.get("transport_calc", "transportable") + '<br><span style="background: url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/6coe5znl.png?raw=true) repeat scroll 0 0 rgba(0, 0, 0, 0); color: #EEDDBB; font-family: Verdana; font-size: 11px; font-weight: bold; text-shadow: 1px 1px 0 #000000; width:110px; display:inline-block""><b>   ' + Ground_Units_BHP + '</b></span>';
		...
		unitsBeyondView: function () {
			...
			$(".qt_sendback_img").css({
				"width": "18px",
				"height": "16px",
				"background-image": "url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/vyxakj9l.png?raw=true)",
				"background-repeat": "no-repeat",
				"display": "block",
				"float": "left"
			});
...
unsafeWindow.QT_updater = function (changelog, forumlink) {
	setTimeout(function () {
		...
		function showNotice(version) {
			...
			divtest.innerHTML = '<div id="qt_updatebox" style="position:absolute; bottom:0px; left:50%; margin-left:-214px; width:429px; height:69px; z-index:1000; color:#EEDDBB; background-image:url(https://github.com/DylanArens/Grepolis-QT/blob/master/images/8ke6vfq4.png?raw=true)">' +
				'<img id="qt_updatebox_frog" src="https://github.com/DylanArens/Grepolis-QT/blob/master/images/eshmcqzu.png?raw=true" style="position:relative; left:23px; top:4px; float:left"/>' +
