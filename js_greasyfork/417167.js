...
// @namespace    https://github.com/wish5115/github-accelerator
// @version      1.0.0
// @description  GitHub 镜像，github 加速，github zip加速下载
// @author       Wilson
// @license      GPL License
// @match        *://github.com/*
...
// @downloadURL https://update.greasyfork.org/scripts/417167/Github%20%E9%95%9C%E5%83%8F%E8%AE%BF%E9%97%AE%EF%BC%8C%E5%8A%A0%E9%80%9F%E4%B8%8B%E8%BD%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/417167/Github%20%E9%95%9C%E5%83%8F%E8%AE%BF%E9%97%AE%EF%BC%8C%E5%8A%A0%E9%80%9F%E4%B8%8B%E8%BD%BD.meta.js
// ==/UserScript==
...
(function() {
    ...
    <div class="user-alert user-alert-warning" style="display:none;" role="alert">clone、depth命令的插入可手动编辑代码关闭</div>
    <div class="user-alert user-alert-danger" style="display:none;color: #721c24;background-color: #f8d7da;border-color: #f5c6cb;" role="alert">镜像地址请不要登陆自己的账户，造成损失本人概不负责</div>
    ...
    <button type="button" id="zipdown1" data-mirror="${mirror_url1}" class="btn">ZIP</button>
    </div>
    <div class="user-input-group user-mb-3">
    ...
    <button type="button" id="zipdown2" data-mirror="${download_url1}" class="btn">ZIP</button>
    </div>
    <div class="user-input-group user-mb-3">
    <div class="user-input-group-prepend">
    <span class="user-input-group-text" id="inputGroup-sizing-default">快速克隆3:</span>
    </div>
    <input type="text" data-autoselect="" class="user-form-control" aria-describedby="inputGroup-sizing-default" value="git remote set-url origin ${'git@github.com:' + str2.replace('/', '' ,1)}" aria-label="" readonly="" >
    <button type="button" id="quickViewAnthor" class="btn">快速浏览3</button>
    <button type="button" id="zipdown3" data-mirror="${mirror_url3}" class="btn">ZIP</button>
    </div>
    </div>
    </div>
    </div>`;
    ...
    $("#zipdown1,#zipdown2,#zipdown3").on("click", function(){
        window.location.href = $(this).attr("data-mirror") + str3 + "/archive/master.zip";
    });
    // 隐藏面板
