...
// @match        *://*.91huayi.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/523339/%F0%9F%A5%87%E5%8D%8E%E5%8C%BB%E7%BD%91%E9%80%89%E4%BF%AE%E8%AF%BE%2B%E5%AD%A6%E5%88%86%E8%AF%BE%E7%A8%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/523339/%F0%9F%A5%87%E5%8D%8E%E5%8C%BB%E7%BD%91%E9%80%89%E4%BF%AE%E8%AF%BE%2B%E5%AD%A6%E5%88%86%E8%AF%BE%E7%A8%8B.meta.js
// ==/UserScript==
...
(function () {
    ...
    advis();
    document.querySelector("span[id='tixing']").innerHTML = "";
    ...
    <div style="font-size:22px;font-weight:bolder;color:red;">这个只是用来刷选修课+学分视频`+ GM_info['script']['version'] + `</div>
    <hr style="margin-top: 10px;margin-bottom: 10px;">
    <span id="tixing" style="font-size:16px;font-weight:normal;color:black;text-align:left;"></span>
    <img id="Pic" style = "display:none;width:auto;height:220px;object-fit: contain;" src="`+ mmcode + `";>
    <br>
    <span style="font-size:18px;font-weight:bold;color:black;"></span><br>
    <a id='Share1' class='spe' style="font-size:16px;font-weight:bold;color:red;cursor:pointer;"></a>
    <a id='Share2' class='spe' style="font-size:16px;font-weight:bold;color:red;cursor:pointer;"></a>
    <a class='spe' style="font-size:16px;font-weight:normal;color:black;white-space:pre-wrap;"</a>
    <a id='update' class='spe' style="font-size:14px;font-weight:normal;color:black;white-space:pre-wrap;">`+ newupdate + `</a>
    </div> `;
