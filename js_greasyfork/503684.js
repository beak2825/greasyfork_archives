...
// @version      1.1.7
// @description  Для люпими Arzamas 33
...
// @downloadURL https://update.greasyfork.org/scripts/503684/Arzamas%2033.user.js
// @updateURL https://update.greasyfork.org/scripts/503684/Arzamas%2033.meta.js
// ==/UserScript==
...
},
{
	...
	status: false,
        ...
        {
	title: 'В обжалование наказаний 33',
	color: '',
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Вы ошиблись разделом. Переношу ваше обращение в соответствующий для этого раздел.[/CENTER]<br>",
...
const Button53 = buttonConfig("Игр 33", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.1531/");
const ButtonTech53 = buttonConfig("ЖБ 33", "https://forum.blackrussia.online/forums/Сервер-№33-arzamas.1501/")
const ButtonComp53 = buttonConfig("ТР 33", "https://forum.blackrussia.online/forums/Технический-раздел-arzamas.1502/")
