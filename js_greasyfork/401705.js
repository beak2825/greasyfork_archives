...
// @name         cxwk
// @version      0.0.2
// @namespace    LoStregone
// @description  超星自动答题
// @author       LoStregone
// @match        *://*.chaoxing.com/*
// @match        *://*.edu.cn/*
// @connect      123.57.237.151
// @run-at       document-end
// @grant        unsafeWindow
// @grant        GM_xmlhttpRequest
// @grant        GM_setClipboard
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/401705/cxwk.user.js
// @updateURL https://update.greasyfork.org/scripts/401705/cxwk.meta.js
// ==/UserScript==
...
if (url == '/mycourse/studentstudy') {
    ...
    _self.layui.use('layer', function() {
        this.layer.open({content: '拖动进度条、倍速播放、秒过会导致不良记录！', title: 'cxwk提示', btn: '我已知悉', offset: 't', closeBtn: 0});
    });
...
function findAnswer() {
    ...
    GM_xmlhttpRequest({
        method: 'POST',
        url: 'http://123.57.237.151/question',
        headers: {
