// ==UserScript==
// @name         Alchemy Simulator color
// @namespace    http://tampermonkey.net/
// @version      v26.3
// @description  Alchemy Simulator
...
// @require      https://update.greasyfork.org/scripts/541291/1616937/item-data%20v10%20en.js
// @require      https://update.greasyfork.org/scripts/541208/1616568/alchemyDetail%20v10.js
// @require      https://update.greasyfork.org/scripts/541288/1639979/alchemy-calculator%20v26%20EN.js
// @require      https://update.greasyfork.org/scripts/541211/1617022/alchemy-data%20v10.js
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/541293/Alchemy%20Simulator%20color.user.js
// @updateURL https://update.greasyfork.org/scripts/541293/Alchemy%20Simulator%20color.meta.js
// ==/UserScript==
...
`);
    ...
    function addAlchemySimulatorTab() {
        ...
        const observer = new MutationObserver(function(mutations) {
            const currentActionTab = findTabByText('Transmute');
    ...
    function insertSimulatorTab(currentActionTab) {
        ...
        if (badgeSpan) {
            badgeSpan.textContent = 'AlchemySimulator';
            // 清空徽章内容
    ...
    document.addEventListener('mouseup', function() {
        ...
        title.textContent = 'Alchemy Simulator';
        ...
        <div class="container">
            ...
            <div class="price-selector">
                ...
                <div class="catalyst-selector">
                    ...
                    <select id="catalystType">
                        ...
                        <option value="catalyst_of_transmutation">catalyst_of_transmutation</option>
                        <option value="prime_catalyst">prime_catalyst</option>
                    </select>
                </div>
                <div class="catalyst-selector">
                    <label>GuzzlingPouch：</label>
            ...
            <div class="input-row">
                <div class="control-group">
                    <label for="alchemyitem">Cost item</label>
                    <div class="autocomplete"><input type="text" class="alchemy-text" id="alchemyitem" value="Sunstone"></div>
                </div>
                <div class="control-group">
                    <label for="efficiencyRate">efficiency%</label>
                    <input type="number" id="efficiencyRate" placeholder="0-200" min="0" max="200" value="77.7">
                </div>
                <div class="control-group">
                    <label for="simulateTimes">Simulation</label>
                    <input type="number" id="simulateTimes" placeholder="1-1000000" min="1" max="1000000" value="1000">
                </div>
                <div class="control-group">
                    <label for="successRate">Basic rate%</label>
                    <input type="number" id="nonesuccessRate" placeholder="0-100" min="0" max="100" value="50">
                </div>
                <div class="control-group">
                    <label for="successRate">success rate%(+Tea)</label>
            ...
            <table class="output-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 25%;">Drop/Amount</th>
                        <th>TotalPrice</th>
                    </tr>
                </thead>
                <tbody id="outputItems">
                    <tr>
                        <td><div class="autocomplete"><input type="text" class="output-item" value="Star Fragment"></div></td>
                    ...
                    <tr>
                        <td><div class="autocomplete"><input type="text" class="output-item" value="Moonstone"></div></td>
                    ...
                    <tr>
                        <td><div class="autocomplete"><input type="text" class="output-item" value="Sunstone"></div></td>
                    ...
                    <tr>
                        <td><div class="autocomplete"><input type="text" class="output-item" value="Philosopher's Stone"></div></td>
            ...
            <div style="display: flex; justify-content: center; align-items: center; height: 100%; margin-top: 0.3rem;">
                <button class="btn" id="startBtn" style="background: linear-gradient(135deg, #33148c, #381fa2);">Alchemy</button>
                <button class="btn" id="startBtnEQ" style="margin-left: 10px; background: linear-gradient(135deg, #FF8C00, #FFA500);">Recursion</button>
                <button class="btn" id="refreshPricesBtn" style="margin-left: 10px; background: linear-gradient(135deg, #006400, #228B22);">Refresh</button>
                <button class="btn" id="addItemBtn" style="margin-left: 10px; background: linear-gradient(135deg, #4a148c, #7b1fa2);">GetHightValue</button>
                <button class="btn" id="restart" style="margin-left: 10px; background: linear-gradient(135deg, #33148c, #381fa2);">Reset</button>
            </div>
            ...
            <input type="hidden" id="catalystPriceFetcher" value="none">
        </div>
        `;
