...
// @downloadURL https://update.greasyfork.org/scripts/527861/Tech%20Script%20.user.js
// @updateURL https://update.greasyfork.org/scripts/527861/Tech%20Script%20.meta.js
// ==/UserScript==
...

{
    ...
    'Тема передана ЗКТС/КТС 61-65.<br><br>',
    prefix: PIN_PREFIX,
	status: true,
},
        {
...
},
{
	...
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
	"Ваша тема закреплена и ожидает вердикта ЗКТС/КТС 61-65.<br>" +
