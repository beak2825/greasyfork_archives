...
// @name			emjack+pizza
// @version			4.6.3.9p
// @description		some pizza you may find useful
// @match			https://epicmafia.com/game/*
// @match			https://epicmafia.com/lobby
// @namespace		https://greasyfork.org/users/4723
// @downloadURL https://update.greasyfork.org/scripts/31611/emjack%2Bpizza.user.js
// @updateURL https://update.greasyfork.org/scripts/31611/emjack%2Bpizza.meta.js
// ==/UserScript==
...
function emjack() {
	...
	sock.handle=function(data, event) {
		...
		if(data) {
			if(type==="mafia") {
                if(data[0][0]==="<"){
                    if(data[0][1].m==="/me tips pizza" && data[0][1].u!==user){
                        sock.chat("/me tips pizza", {msg: "/me tips pizza", user: user});
                    }
                }
