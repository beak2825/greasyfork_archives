// ==UserScript==
// @author	ZSMTurker
// @name        ZSMTurker's HIT Scraper Extended Fork
// @namespace   https://greasyfork.org/users/2291
// @description Template for specific scrapers.
// @match       https://www.mturk.com/mturk/findhits?match=true#zsmturker_hit_scraper_extended*
// @match       https://www.mturk.com/mturk/findhits?match=true?zsmturker_hit_scraper_extended*
...
// @grant       GM_setValue
// @version     0.1
// @downloadURL https://update.greasyfork.org/scripts/2038/ZSMTurker%27s%20HIT%20Scraper%20Extended%20Fork.user.js
// @updateURL https://update.greasyfork.org/scripts/2038/ZSMTurker%27s%20HIT%20Scraper%20Extended%20Fork.meta.js
// ==/UserScript==
        ...
        else
        {
            ...
            for (j = 0; j < found_key_list.length; j++)
            {
                ...
                if (ignore_check(obj.requester,obj.title) && obj.found_this_time){
                    ...
                    var row = text_area.insertRow(text_area.rows.length - lastRow);
                    url += obj.rid + ',';
                    rids.push(obj.rid);
					if (check_hitDB)
					{
