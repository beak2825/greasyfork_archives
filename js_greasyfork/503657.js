...
// @version      1.1.7
// @description  Для люпими Krasnodar
// @author       V.Rezinka
...
// @downloadURL https://update.greasyfork.org/scripts/503657/Krasnodar.user.js
// @updateURL https://update.greasyfork.org/scripts/503657/Krasnodar.meta.js
// ==/UserScript==
...
},
{
	...
	{
	title: '$$$$$$$$$Для люпими логистов$$$$$$$€€€' 
	},
{
	title: 'Рассмотрение жиес',
	color: '#FF8C00',
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
...
{
	title: 'Ожидайте вердикта руковдства',
	color: '',
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Ваша тема закреплена и ожидает вердикта <u>Руководства Технических специалистов,для выноса окончательного вердикта</u>.<br>" +
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER][SIZE=4][FONT=Verdana]После проверки доказательств и системы логирования вердикт:<br><br>[COLOR=rgb(65, 168, 95)][FONT=verdana]Игрок будет заблокирован[/COLOR]Спасибо за обращение[/CENTER]<br><br>" +
...
title: '$$$$$$$$$передача в разделы$$$$$$$$$$',
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER] Вы ошиблись разделом.Переношу ваше обращение в соответствующий раздел.[/CENTER]<br>",
	prefix: PIN_PREFIXX,
	status: false,
},
        {
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Вы ошиблись ращделом.Переношу ваше обращение в соответствующий раздел.[/CENTER]<br>",
