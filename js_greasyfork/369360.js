...
// @downloadURL https://update.greasyfork.org/scripts/369360/Kasisto%20Banner.user.js
// @updateURL https://update.greasyfork.org/scripts/369360/Kasisto%20Banner.meta.js
// ==/UserScript==
...
$(document).ready(function() {
    if ($("div:contains(Imagine you are interacting with a smart)").length){
        ...
        var input = document.getElementById("altQuestion");
