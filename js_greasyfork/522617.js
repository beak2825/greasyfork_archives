// ==UserScript==
// @name         Farm RPG Meal Timers
// @namespace    duck.wowow
// @version      0.1
// @description  Display meal timers on every page
// @author       Mrs Berry
// @match        https://farmrpg.com/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=farmrpg.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/522617/Farm%20RPG%20Meal%20Timers.user.js
// @updateURL https://update.greasyfork.org/scripts/522617/Farm%20RPG%20Meal%20Timers.meta.js
// ==/UserScript==
...
(function () {
        ...
        countdownElements.forEach((countdown) => {
            ...
            if (itemTitleElement) {
                ...
                if (itemName && countdownTo) {
                    const utcTime = new Date(countdownTo).getTime();
                    countdowns[itemName] = utcTime;
                }
            }
        });
    ...
    function timeRemaining(timestamp) {
        const remainingTime = (timestamp + (1000 * 60 * 60 * 19)) - Date.now();
            ...
            for (const mutation of mutationsList) {
                if (mutation.type === 'attributes' && mutation.attributeName === 'data-page') {
                    ...
                    if (currentPage === 'index-1') {
                        extractCountdowns();
                        countdownInterval = setInterval(extractCountdowns, 1000);
                        setTimeout(displayTimers, 1500);
                    } else {
