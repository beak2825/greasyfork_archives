...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/452389/Dark%20Mode.user.js
// @updateURL https://update.greasyfork.org/scripts/452389/Dark%20Mode.meta.js
// ==/UserScript==
...
class Darkmode {
  constructor(options) {
    ...
    const defaultOptions = {
      ...
      time: '0.3s',
      mixColor: '#fff',
      backgroundColor: '#b9003d',
      buttonColorDark: '#420000',
      buttonColorLight: '#fffff0',
      label: '',
      saveInCookies: true,
