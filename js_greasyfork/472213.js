...
// @version      1.3
// @description  LT智慧D校-学时助手-自动点开课程
// @author       wenyc15
// @match        https://m.campus.chinaunicom.cn/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=chinaunicom.cn
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/472213/LT%E6%99%BA%E6%85%A7D%E6%A0%A1-%E5%AD%A6%E6%97%B6%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/472213/LT%E6%99%BA%E6%85%A7D%E6%A0%A1-%E5%AD%A6%E6%97%B6%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
function courseDetails(){
    ...
    setTimeout(()=>{
        ...
        setInterval(()=>{
            ...
            if(video.paused){
                video.play();
                //document.querySelector('div[class="jw-icon jw-icon-inline jw-button-color jw-reset jw-icon-playback"]').click();
            }}
            let cours = document.querySelectorAll('div[class="planList plan-list learn-sec"]');
             console.log("课程数量",cours.length);
