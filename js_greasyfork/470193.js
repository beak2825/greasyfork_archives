// ==UserScript==
// @name     MAHE Autofill Button for Discharge of SUR005
// @version  1.0
// @grant    none
...
// @downloadURL https://update.greasyfork.org/scripts/470193/MAHE%20Autofill%20Button%20for%20Discharge%20of%20SUR005.user.js
// @updateURL https://update.greasyfork.org/scripts/470193/MAHE%20Autofill%20Button%20for%20Discharge%20of%20SUR005.meta.js
// ==/UserScript==
...
(function() {
  ...
  button.addEventListener('click', function() {
    ...
    if (input1.value == '') {
      input1.value = 'General Physical Examination:\nPR- 86 bpm. BP: 120/80 mm Hg. RR-20/min. SpO2: 98% on room air, afebrile\nBilateral pitting edema present on both legs till knee level.\nNo signs of pallor, icterus, cyanosis, clubbing, koilonychia, lymphadenopathy.\n\nSystemic examination:\nRS- Bilateral normal vesicular breath sounds heard over all areas. No added sounds\nCVS- S1,S2 heard, no murmurs\nCNS- GCS-15/15, HMF- intact\nP/A-soft and non-tender, no organomegaly.\n\nL/E :';
    }
    if (input2.value == '') {
    ...
    if (input4.value == '') {
      input4.value = 'call on 9686676584';
    }
    if (input5.value == '') {
      input5.value = 'DR. BADAREESH. L';
    }
    if (input6.value == '') {
