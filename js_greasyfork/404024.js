// ==UserScript==
// @name	DC - Bullets_alert_fixed
// @author	Ladoria, Lorkah(fix)
// @version	1
// @grant       none
...
// @namespace	InGame
// @downloadURL https://update.greasyfork.org/scripts/404024/DC%20-%20Bullets_alert_fixed.user.js
// @updateURL https://update.greasyfork.org/scripts/404024/DC%20-%20Bullets_alert_fixed.meta.js
// ==/UserScript==
...
$('body').append('<audio id="DC_bullets_low_charger" src="https://bacon-network.net/dreadcast/bip.mp3" type="audio/waw"></audio><audio id="DC_bullets_empty_charger" src="https://bacon-network.net/dreadcast/low_bullet.mp3" type="audio/waw"></audio>');
