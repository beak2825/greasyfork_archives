...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/429904/Super%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/429904/Super%20Script.meta.js
// ==/UserScript==
//fastsplit currently
'esversion: 6';
(function() {
...
function keydown(event) {
    ...
    if (event.keyCode == key) {
        oneSplit()
        setTimeout(freeze, 20)
        setTimeout(freeze, 85)
 
    }
    if (event.keyCode == key2) {
        doubleSplit()
        setTimeout(freeze, 45)
        setTimeout(freeze, 110)
 
    }
    if(event.keyCode == key4){
        tripleSplit()
        setTimeout(freeze, 75)
        setTimeout(freeze, 135)
    }
