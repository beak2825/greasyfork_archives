...
// @namespace    http://mp-cis.com/
// @author       Феликс "GwynnBleiidd" Балясный
// @description	Смена пользователей FaceBook для работы
...
// @version		0.07
// @downloadURL https://update.greasyfork.org/scripts/22841/Facebook%20Switch%20Accounts.user.js
// @updateURL https://update.greasyfork.org/scripts/22841/Facebook%20Switch%20Accounts.meta.js
// ==/UserScript==
...
(function($){
	...
	var useraccount = $.parseJSON(getValue('useraccount', '[{"n":"Профиль","u":"your@domain.com","p":"password"}]') );
	...
	var TIME = {},$FSA = {},FSA = new Object(), fuid_uarr = new Array(),language_select,noLogin = false,fsa_json = {"time":"PM 20h00 18/07/2016","version":version,"new_version":version,"language_select":{"en_us":"English","zh_tw":"\u6B63\u9AD4\u4E2D\u6587","zh_cn":"\u7B80\u4F53\u4E2D\u6587","fr_fr":"Fran\u00E7ais","de_de":"German"}},fblocation = getValue('fblocation', WURL);
	var face_lang = {
	'en_us':{
			'TITLE'					:'[Beta] Switch Accounts',
			'ABOUT'					:'※ Подробнее ※',
			'BTN_ADD_ACCOUNT'		:'Добавить аккаунт',
			'BTN_EDT_ACCOUNT'		:'Редактировать аккаунт',
			'BTN_CLS_ACCOUNT'		:'Удалить все аккаунты',
			'BTN_EXPORT_ACCOUNT'	:'Экспорт',
			'BTN_IMPORT_ACCOUNT'	:'Импорт',
			'BTN_SETTING'			:'Настройки',
			'BTN_OK'				:'OK',
			'BTN_CANCEL'			:'Отмена',
			'ALT_NAMENULL'			:'Вводим имя и пароль',
			'ALT_DELACCOUNT'		:'Удалить',
			'ALT_LOGIN'				:'Соединяем, спасибо за ожидание!',
			'ALT_SWITCHING'			:'Смена, спасибо за ожидание!',
			'ALT_CONFIRM'			:'Точно хочешь %s ?',
			'LAB_USERNICK'			:'Логин',
			'LAB_USERNAME'			:'Mail',
			'LAB_USERPASS'			:'Пароль',
			'LAB_NONEED'			:'(Опционально)',
			'LAB_LANGUAGE'			:'Язык по-умолчанию',
			'LAB_UPDATE'			:'Автоматическое обновление',
			'LAB_EXPORT'			:'Экспорт данных:',
			'LAB_IMPORT'			:'Импорт данных:',
			'LAB_LOGIN_AUTO'		:'Автоподключение',
			'LAB_LOGIN_HOME'		:'Вход в Facebook',
			'LAB_LOCK_PASS'			:'Защита паролем*',
			'BTN_LOCK_PASS'			:'Настройка блокировки*',
			'LAB_DEL'				:'Ликвидировать!',
			'LAB_MOVE'				:'Сдвинуть',
			'LAB_VERSION'			:'Facebook смена аккаунта v%s',
			'LAB_NEW_VERSION'		:'Последняя версия :%s',
			'LAB_NEW_UPLOAD'		:'Последнее обновление：%s',
			'ALT_PLZ_KEYPASS'		:'Введите %s',
			'ALT_PLZ_KEYNEWPASS'	:'и ещё раз %s!',
			'ALT_PLZ_KEYNEWPASS2'	:'и ещё раз %s снова!',
			'ALT_PASS_SETOVER'		:'Выбор %s окончен',
			'ALT_PASS_DIFF'			:'Несостыковка крейсера %s, снова введи!',
			'ALT_ERROR'				:'%s неправильно!',
			'LAB_NEW_UPDATA'		:'Есть обновление О__О',
	        'LAB_CUSTOM_TITLE'      :'Пользовательское название*',
	        'LAB_USE_CUSTOM_TITLE'  :'Настройка заголовка',
	        'LAB_SHOW_NAME'         :'Отображаемое имя'
		},
	'zh_tw':{
			'TITLE'					:'切換帳號',
			'ABOUT'					:'※關於這個程式※',
	...
	if( document.getElementsByTagName('body')[0].className.indexOf('Locale') != -1 ){
		...
		FSA.Methods = {
			...
			About:function(){
				...
				'<div style="width:420px;">Contact Support：<a href="felix@mp-cis.com">felix@mp-cis.com</a><br/>'+
				'<p>Create By GwynnBleiidd <a href="//www.mp-cis.com/benjamin.kloos" traget="_blank">Agency MP-Cis</a></p></div>';
