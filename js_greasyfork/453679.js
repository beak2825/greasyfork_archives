...
// @namespace    xfaucet
// @version      0.1
// @description  Easy xFaucet
// @author       zzz
// @match        https://dropz.xyz/*
// @noframes
// @grant        window.close
// @grant        unsafeWindow
 
// @downloadURL https://update.greasyfork.org/scripts/453679/xFaucet.user.js
// @updateURL https://update.greasyfork.org/scripts/453679/xFaucet.meta.js
// ==/UserScript==
...
(function() {
    ...
    setInterval(function(){
       ...
       // if(window.location.href.includes("dropz.xyz/transactions")){
            unsafeWindow.close();
        }
