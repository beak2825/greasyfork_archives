...
// @match   https://*.plemiona.pl/game.php?screen=overview_villages&screen=am_farm
// @namespace https://greasyfork.org/users/151096
// @author FunnyPocketBook
// @downloadURL https://update.greasyfork.org/scripts/453389/Farmbot.user.js
// @updateURL https://update.greasyfork.org/scripts/453389/Farmbot.meta.js
// ==/UserScript==
...
let val = parseInt(document.querySelector('#content_value > div:nth-child(' + tableNr + ') > div > form:nth-child(' + formChild + ') > table > tbody > ' +
'tr:nth-child(2) > td > input[name="' + unit + '"]'));
if (isNaN(val)) {
val = 0;
}
