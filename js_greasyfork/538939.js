...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/538939/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20Tver.user.js
// @updateURL https://update.greasyfork.org/scripts/538939/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20Tver.meta.js
// ==/UserScript==
...
const buttons = [
{
    ...
    },
    {
      ...
      content:
        ...
        "[I][B][CENTER][FONT=georgia][SIZE=4][COLOR=lavender]Ваша написанная [color=#ff0000]жалоба[/color] взята на [COLOR=#ffff00]рассмотрение[/color], ожидайте ответа и не создавайте [COLOR=#ff0000]тем-дубликатов[/color].[/SIZE][/FONT] <br><br>"+
...
"[img]https://i.postimg.cc/S2yFSD5t/uix-logo-cust.png[/img]",
        ...
        },
    {
      ...
      content:
	"[I][B][CENTER][FONT=georgia][SIZE=4][COLOR=#ffff00]Здравствуйте, уважаемый {{ user.mention }}[/COLOR][/SIZE][/FONT][/CENTER][/B]<br><br>"+
		"[I][B][CENTER][FONT=georgia][SIZE=4]Ваша жалоба передана на рассмотрение ГКФ (Главному Куратору Форума).[/SIZE][/FONT]<br>" +
		'[I][B][CENTER][FONT=georgia][SIZE=4]Не создавайте копии данной темы.[/SIZE][/FONT]<br>' +
		"[I][B][CENTER][FONT=georgia][SIZE=4]В противном случае Вам будет выдана блокировка ФА (Форумного аккаунта).[/SIZE][/FONT]<br><br>"+
...
"[B][CENTER][FONT=georgia][SIZE=4][COLOR=lavender]3.18. [COLOR=#ff0000]Запрещено[/COLOR] политическое и религиозное пропагандирование [COLOR=#ff0000]| Mute 120 минут / Ban 10 дней[/COLOR]<br><br>" +
 "[CENTER][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/CENTER]"+
    ...
    {
   title: 'Не оказал услугу',
   content:
  "[I][B][CENTER][FONT=georgia][SIZE=4][COLOR=#ffff00]Здравствуйте, уважаемый {{ user.mention }}[/COLOR][/SIZE][/FONT][/CENTER][/B]<br><br>"+
 "[B][CENTER][FONT=georgia][SIZE=4][COLOR=lavender][COLOR=#ff0000]С администратором будет проведена беседа[/COLOR] по [COLOR=#ff0000]данному инциденту[/COLOR].[/SIZE][/FONT]<br><br>"+
        "[CENTER][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/CENTER]"+
              "[CENTER][img]https://i.postimg.cc/43WY7jx3/nRMnEsM.gif[/img][/CENTER]",
     prefix: ACCСEPT_PREFIX,
	  status: false,
...
"[CENTER][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/CENTER]"+
 ...
 "[CENTER][img]https://i.postimg.cc/DzwtM9Yy/3-Nx-P1-gif-0e0c6523faa5f31ef44e0b8939199665.gif[/img][/CENTER]",
   ...
   "[CENTER][img]https://i.postimg.cc/DzwtM9Yy/3-Nx-P1-gif-0e0c6523faa5f31ef44e0b8939199665.gif[/img][/CENTER]",
    ...
    {
      title: 'По несущ правилам',
      content:
        "[I][B][CENTER][FONT=georgia][SIZE=4][COLOR=#ffff00]Здравствуйте, уважаемый {{ user.mention }}[/COLOR][/SIZE][/FONT][/CENTER][/B]<br><br>"+
        " [B][CENTER][FONT=georgia][SIZE=4][COLOR=lavender][color=#ff0000]По новым изменениям в правилах проекта от 24.12.2024[/color], наказание выдано не будет.[/COLOR][/SIZE][/FONT]<br>" +
        '[B][CENTER][FONT=georgia][SIZE=4][COLOR=lavender][color=#ff0000]Просим ознакомиться[/color] с последними изменениями правил. [COLOR=#ff0000][/color].[/SIZE][/FONT]<br><br>' +
     "[CENTER][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/CENTER]"+
	 "[CENTER][img]https://i.postimg.cc/DzwtM9Yy/3-Nx-P1-gif-0e0c6523faa5f31ef44e0b8939199665.gif[/img][/CENTER]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
