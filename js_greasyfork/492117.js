...
// @version      5.0
// @description  Load 50 most recent accounts with tracked IP info, individual and bulk ban actions, posts/topics links, custom account loading, COPPA action, and now forum IP indicators with clickable redirection.
// @author
...
// @downloadURL https://update.greasyfork.org/scripts/492117/Find%20New%20Accounts.user.js
// @updateURL https://update.greasyfork.org/scripts/492117/Find%20New%20Accounts.meta.js
// ==/UserScript==
...
(function() {
    ...
    function checkForumIPs() {
        ...
        ipAnchors.forEach(anchor => {
            ...
            indicator.style.cursor = "pointer"; // make it clear it's clickable
            ...
            // and store it, then redirect to the moddog page.
