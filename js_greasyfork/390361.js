...
// @downloadURL https://update.greasyfork.org/scripts/390361/reCAPTCHA%20E%20FARM%20NO%20A.user.js
// @updateURL https://update.greasyfork.org/scripts/390361/reCAPTCHA%20E%20FARM%20NO%20A.meta.js
// ==/UserScript==
...
if (document.URL.indexOf('screen=am_farm') == -1)
	...
	var x				= 1,				// NÃO ALTERAR!
		...
		alteraraldeia   = false,
		altAldTempo		= false,				// Tempo em milesegundos para alternar as aldeias (Use 'true' para aleatório)
    ...
    if (atlPagTempo === "random") {
		altPagTempo = aleatorio(1750000, 1800000);
	}
