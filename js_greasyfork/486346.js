// ==UserScript==
// @name AudioBookBay hide category: Gay
// @description Hide Gay category
...
// @downloadURL https://update.greasyfork.org/scripts/486346/AudioBookBay%20hide%20category%3A%20Gay.user.js
// @updateURL https://update.greasyfork.org/scripts/486346/AudioBookBay%20hide%20category%3A%20Gay.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Gay'
    $(".post").has(".postInfo:contains('Gay')").hide();
});
