// ==UserScript==
// @name         湖南人社-湖南开放大学专业技术教育基地
// @namespace    http://tampermonkey.net/zzzzzzys_湖南开放大学
// @version      1.0.4
// @copyright    zzzzzzys.All Rights Reserved.
// @description  湖南人社-湖南开放大学专业技术教育基地，可无人值守自动化挂机播放,自动跳过弹窗检测，可自动完成所有未完成课程，包括2025、2024年课程！
// @author       zzzzzzys
...
// @license      
// @downloadURL https://update.greasyfork.org/scripts/532183/%E6%B9%96%E5%8D%97%E4%BA%BA%E7%A4%BE-%E6%B9%96%E5%8D%97%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E6%95%99%E8%82%B2%E5%9F%BA%E5%9C%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/532183/%E6%B9%96%E5%8D%97%E4%BA%BA%E7%A4%BE-%E6%B9%96%E5%8D%97%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E6%95%99%E8%82%B2%E5%9F%BA%E5%9C%B0.meta.js
// ==/UserScript==
class Runner {
    constructor() {
        this.runner = null
    ...
    run() {
        ...
        if (url.includes("videoPlayback")) {
            this.runner = new Course("channel-hnsydwpx")
            // this.runner.run()
        } else if (url.includes("mineCourse")) {
            this.runner = new Index("channel-hnsydwpx")
        }
    }
}
...
class Utils {
    ...
    static flag = 'hnsydwpx_VIP'
    static js_Flag = 'hnsydwpx_jsCode'
    static vipText = '高级功能已启用！(湖南开放大学专技)'
    static baseText = '您正在使用基础版本，功能可能存在限制'
    static vipSign = 'hnsydwpx_vipSign'
    ...
    static async validateCode(data) {
        try {
            ...
            if(!value || !value.username || !value.id){
                throw Error("无效的账号信息！")
            }
            data.bindInfo = value.username + "_" + value.id
            data.website = "67eb799855b3373c72e3255a"
            console.log(data);
            // return
