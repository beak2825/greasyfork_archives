// ==UserScript==
// @name        SPB | ГА/ЗГА/Кураторы
// @namespace    https://forum.blackrussia.online/
// @version      1.0.0
// @description  Специально для BlackRussia || SPB by W.Capone/D.Flyweather
// @author       W.Capone/Flyweather | SPB
...
// @downloadURL https://update.greasyfork.org/scripts/490255/SPB%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/490255/SPB%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B.meta.js
// ==/UserScript==
...
(async function () {
    ...
    //         `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на серверае SPB[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
	//  },
    //  {
    ...
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  [user=0]нету пока[/user]<br><br>`+
	...
	},
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  [user=190578]Ruslan_Aodzaki[/user] <br><br>`+
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. .[/COLOR][/CENTER]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
	...
	//   content:
	// 	`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
    //     `[CENTER]Передаю вашу жалобу Главному Администратору — [user=25184]Harvey_Specter[/USER] <br><br>`+
    //     `[COLOR=rgb(251, 160, 38)]На рассмотрении. .[/COLOR][/CENTER]<br>`,
    //   prefix: GA_PREFIX,
	//   status: true,
	// },
