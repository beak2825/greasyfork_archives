// ==UserScript==
// @name         安全微伴 2025-08 可刷课程 (by 浩劫者12345, modified by Houtar)
// @namespace    https://weiban.houtar.me/
// @version      25.8.7.1
// @description  安全微伴, 非自动点击版, 直接调API, 速度快. 可刷课程和考试. 受服务端限制, 每 13 秒只能学习一个课程, 超出这个频率即使返回成功也不会更新学习记录. 多线程同时学习多个课程也没用
// @author       浩劫者12345, modified by Houtar
// @match        https://weiban.mycourse.cn/
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/544879/%E5%AE%89%E5%85%A8%E5%BE%AE%E4%BC%B4%202025-08%20%E5%8F%AF%E5%88%B7%E8%AF%BE%E7%A8%8B%20%28by%20%E6%B5%A9%E5%8A%AB%E8%80%8512345%2C%20modified%20by%20Houtar%29.user.js
// @updateURL https://update.greasyfork.org/scripts/544879/%E5%AE%89%E5%85%A8%E5%BE%AE%E4%BC%B4%202025-08%20%E5%8F%AF%E5%88%B7%E8%AF%BE%E7%A8%8B%20%28by%20%E6%B5%A9%E5%8A%AB%E8%80%8512345%2C%20modified%20by%20Houtar%29.meta.js
// ==/UserScript==
...
(async function () {
        ...
        for (const project of projects) {
            ...
            for (const category of categories) {
                ...
                for (const course of courses) {
                    ...
                    vConsole.log(`       完成学习`);
                    vConsole.log((await finishStudy(course.userCourseId))
                        ? `       成功`
                        : `       失败`
                    )
                }
     ...
     * @returns {Promise<boolean>}
     */
    async function finishStudy(userCourseId) {
        const url = new URL(`https://weiban.mycourse.cn/pharos/usercourse/v2/${userCourseId}.do`);
