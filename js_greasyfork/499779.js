// ==UserScript==
// @name         Кураторы форума by F.Garcia
// @namespace    https://forum.blackrussia.online/
// @version      2.1.1
// @description  Script work in 21.06.2024
// @author       Frank_Garcia
...
// @downloadURL https://update.greasyfork.org/scripts/499779/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20FGarcia.user.js
// @updateURL https://update.greasyfork.org/scripts/499779/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20FGarcia.meta.js
// ==/UserScript==
	...
	const buttons = [
	{
	 ...
	 '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
	   ...
	   },
   	{
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемые игроки [/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Заявки на пост лидерства взяты на рассмотрение, ожидайте. [/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Просьба не писать новые заявки, пока она рассматриваются. [/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          }, 
       {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
            "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]KEMEROVO[/SIZE][/B][/COLOR]",
