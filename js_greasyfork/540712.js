...
// @downloadURL https://update.greasyfork.org/scripts/540712/%E7%9F%A5%E4%B9%8E%E6%89%8B%E6%9C%BA%E7%BD%91%E9%A1%B5%E7%BE%8E%E5%8C%96%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/540712/%E7%9F%A5%E4%B9%8E%E6%89%8B%E6%9C%BA%E7%BD%91%E9%A1%B5%E7%BE%8E%E5%8C%96%E7%89%88.meta.js
// ==/UserScript==
...
(function() {
    ...
    var blockid=[
        ...
        {'.ContentItem.ZVideoItem':3}, //视频
        {'.ZDI.ZDI--FlagFill24':2},    //举报按钮
    ];
    var header = document.querySelector('header.Sticky.AppHeader.css-17rnw55') //顶端header隐藏
    hideparent(header);
    hide(idlist);
    block(blockid); //隐藏初始加载的作者、盐选
    ...
    var str=
        ...
        'div.css-1mgcfmo {width:90% !important;} \n'+    //回答编辑框
        'div.QuestionHeader-content {width:90% !important;} \n'+                     //知乎答案顶栏
        'div.Topstory-container, \n'+               //知乎主页主框
        ...
        'button[aria-label="关闭"] {position: fixed;right:20px;width:50px;top:100px;background-color:#4f4f4f;}; \n'+                           //评论框的关闭按钮
    ...
    function hide(idlist) {
        idlist.forEach(function(ids) {
            ...
            console.log(ids,contentItemActions,11111);
            contentItemActions.forEach(function(element) {
