...
// @connect    				localhost
// @antifeature				payment
// @downloadURL https://update.greasyfork.org/scripts/474334/Apifox%E4%B8%87%E8%83%BD%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/474334/Apifox%E4%B8%87%E8%83%BD%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
\u4E3B\u9875\uFF1A${c.homepage || "\u672A\u77E5\u4E3B\u9875"}`,
    ...
    scripts: {
      console: new Script({
        ...
        onrender({ panel: panel2 }) {
          ...
          this.offConfigChange(state$4.console.listenerIds.logs);
          state$4.console.listenerIds.logs = this.onConfigChange("logs", (logs2) => {
      ...
      appConfigSync: new Script({
        ...
        onrender({ panel: panel2 }) {
          ...
          update();
          this.offConfigChange(state$4.app.listenerIds.sync);
          this.offConfigChange(state$4.app.listenerIds.connected);
          this.offConfigChange(state$4.app.listenerIds.closeSync);
          state$4.app.listenerIds.sync = this.onConfigChange("sync", update);
          state$4.app.listenerIds.connected = this.onConfigChange("connected", update);
          state$4.app.listenerIds.closeSync = this.onConfigChange("closeSync", (closeSync) => {
            if (closeSync) {
              this.cfg.sync = false;
        ...
        async onrender({ panel: panel2 }) {
          ...
          panel2.body.replaceChildren(
            el("div", { className: "card" }, [
              ...
              el("hr"),
              el("div", "\u5F53\u524D\u7248\u672C\uFF1A" + ((_a = $gm.getInfos()) == null ? void 0 : _a.script.version)),
              el("div", "\u811A\u672C\u7BA1\u7406\u5668\uFF1A" + (infos == null ? void 0 : infos.scriptHandler)),
              el("div", [
                "\u811A\u672C\u66F4\u65B0\u94FE\u63A5\uFF1A",
    ...
    scripts: {
      ...
      "gxk-study": new Script({
        ...
        async oncomplete() {
          ...
          this.onConfigChange("volume", (curr) => {
            state$3.study.currentMedia && (state$3.study.currentMedia.volume = curr);
          });
      ...
      "gxk-work": new Script({
        ...
        async onstart() {
          ...
          state$3.work.workInfo = await $app_actions.waitForResponse(url, {
            responseType: "json"
          });
        },
        async oncomplete() {
  ...
  async function watch(options, onended) {
    ...
    const set = async () => {
      ...
      state$3.study.currentMedia = video2;
      if (video2) {
    ...
    video.onpause = async () => {
      if (!(video == null ? void 0 : video.ended) && state$3.study.stop === false) {
        await waitForCaptcha();
        await $.sleep(1e3);
  ...
  function waitForWorkInfo() {
    return new Promise((resolve, reject) => {
      const interval = setInterval(() => {
        if (state$3.work.workInfo) {
          clearInterval(interval);
          resolve(state$3.work.workInfo);
        }
      }, 1e3);
    });
  }
  function gxkWorkAndExam({
    ...
    const allExamParts = ((_e = ((_d = (_c = (_b = (_a = state$3 == null ? void 0 : state$3.work) == null ? void 0 : _a.workInfo) == null ? void 0 : _b.rt) == null ? void 0 : _c.examBase) == null ? void 0 : _d.workExamParts) || []) == null ? void 0 : _e.map((p) => p.questionDtos).flat()) || [];
  ...
  function autoStop(stopTime) {
    var _a, _b;
    clearInterval(state$3.study.stopInterval);
    (_a = state$3.study.stopMessage) == null ? void 0 : _a.remove();
    if (stopTime !== "0") {
      let stopCount = parseFloat(stopTime) * 60 * 60;
      state$3.study.stopInterval = setInterval(() => {
        var _a2;
        if (stopCount > 0) {
      ...
      const val = (_b = [
        ...
        [1, "\u4E00\u5C0F\u65F6\u540E"],
        [2, "\u4E24\u5C0F\u65F6\u540E"]
      ].find((t2) => t2[0].toString() === stopTime)) == null ? void 0 : _b[0];
      const date = new Date();
      date.setMinutes(date.getMinutes() + val * 60);
      state$3.study.stopMessage = $message("info", {
        duration: 0,
      ...
      study: new Script({
        ...
        onrender({ panel: panel2 }) {
          ...
          if (!((_a = CommonProject.scripts.settings.cfg.answererWrappers) == null ? void 0 : _a.length)) {
            ...
            if (state$2.study.answererWrapperUnsetMessage === void 0) {
              state$2.study.answererWrapperUnsetMessage = $message("warn", {
  ...
  function rateHack() {
    ...
    function hack() {
      ...
      if (typeof videojs !== "undefined" && typeof Ext !== "undefined") {
        if (state$2.study.hacked) {
          return;
        }
        state$2.study.hacked = true;
        ...
        if (attachment && searchedJobs.find((job2) => job2.mid === attachment.property.mid) === void 0) {
          ...
          if (media) {
            ...
            if (!CXProject.scripts.study.cfg.enableChapterTest) {
              ...
              const needWorkButNoJob = attachment.job === void 0 && (status == null ? void 0 : status.classList.contains(".testTit_status_complete")) === false;
              if (attachment.job || needWorkButNoJob) {
  ...
  function fixedVideoProgress() {
    if (state$2.study.videojs) {
      const { bar } = domSearch({ bar: ".vjs-control-bar" }, state$2.study.videojs);
      if (bar) {
        bar.style.opacity = "1";
      }
    }
  ...
  const _StudyLock = class {
    constructor() {
      ...
      state$1.study.currentStudyLockId = this.id;
    }
    canStudy() {
      return this.id === state$1.study.currentStudyLockId;
    }
    static getLock() {
    ...
    scripts: {
      ...
      study: new Script({
        ...
        async oncomplete() {
          ...
          CommonProject.scripts.render.methods.pin(this);
          await $.sleep(3e3);
          this.onConfigChange("volume", (v) => state$1.study.currentMedia && (state$1.study.currentMedia.volume = v));
          this.onConfigChange(
            "playbackRate",
            (r) => state$1.study.currentMedia && (state$1.study.currentMedia.playbackRate = parseFloat(r.toString()))
          );
            ...
            if (win) {
              ...
              if (iframe.src.includes("content_video.action") || iframe.src.includes("content_audio.action")) {
                ...
                try {
                  ...
                  state$1.study.currentMedia = media;
  ...
  async function watchMedia(volume2) {
    const media = await waitForMedia();
    media.volume = volume2;
  ...
  async function start() {
    var _a, _b;
    const info = (_b = (_a = $el(".guide")) == null ? void 0 : _a.__vue__) == null ? void 0 : _b.courseList;
  ...
  async function next() {
    var _a, _b, _c;
    const nextObj = (_b = (_a = $el(".guide")) == null ? void 0 : _a.__vue__) == null ? void 0 : _b.nextObj;
    if ((nextObj == null ? void 0 : nextObj.id) !== void 0) {
      (_c = $el(".preOrNext .next .el-link")) == null ? void 0 : _c.click();
    } else {
      $message("success", {
        duration: 0,
        content: "\u5168\u90E8\u4EFB\u52A1\u5DF2\u5B8C\u6210\u3002"
