...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/470379/KURATORKAM.user.js
// @updateURL https://update.greasyfork.org/scripts/470379/KURATORKAM.meta.js
// ==/UserScript==
...
const buttons = [
{
	...
	},
    {
	  ...
	  content:
		...
		'[Color=Red][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B][/FONT]',
	  prefix: PIN_PREFIX,
	  status: true,
	},
	{
	...
	},
	{
	  ...
	  content:
		'[FONT=times new roman][Color=Red][CENTER][B]{{ greeting }}, уважаемый игрок.[/color][/CENTER][/B]' +
		"[CENTER]Ваша жалоба была одобрена. С администратором будет проведена профилактическая беседа по поводу корректной работы на посту администратора.<br>Ваше наказание будет снято в течение 12-ти часов.[/CENTER]<br><br>" +
		'[Color=Red][CENTER][B]Закрыто.[/CENTER][/color][/B][/FONT]',
    ...
    {
	  title: 'Прошло 48 часа <ЖБ>',
	  content:
		'[FONT=times new roman][Color=Red][CENTER][B]{{ greeting }}, уважаемый игрок.[/color][/CENTER][/B]' +
		"[CENTER]С момента выдачи наказания прошло более 48-и часов.[/CENTER]<br><br>" +
		'[Color=Red][CENTER][B]Закрыто.[/CENTER][/color][/B][/FONT]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
		'[FONT=times new roman][FONT=times new roman]{{ greeting }}, уважаемый игрок.[/color][/CENTER]' +
		"[CENTER]Ваша прикреплённая ссылка на доказательства является недействительной.[/CENTER]<br><br>" +
		'[CENTER][Color=Red]Закрыто.[/FONT][/color][/CENTER]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
