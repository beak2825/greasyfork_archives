// ==UserScript==
// @name         Жалобы на админов | Santa_Aelpee & Sova_Evseeva
// @namespace    http://tampermonkey.net/
// @version      1.4
// @description  Скрипт только для Айтач
// @author       Santa_Aelpee
// @match        https://forum.blackrussia.online/threads/*
// @icon         
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/480776/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B%20%D0%BD%D0%B0%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%BE%D0%B2%20%7C%20Santa_Aelpee%20%20Sova_Evseeva.user.js
// @updateURL https://update.greasyfork.org/scripts/480776/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B%20%D0%BD%D0%B0%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%BE%D0%B2%20%7C%20Santa_Aelpee%20%20Sova_Evseeva.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][COLOR=rgb(255, 255, 255)][B]Приятной игры на сервере[/B][/COLOR][/CENTER] ',
    ...
    },
    {
	  ...
	  content:
		'[CENTER][B][COLOR=rgb(255, 255, 0)][FONT=times new roman][SIZE=4]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/SIZE][/FONT][/COLOR][/B]<br><br>' +
		"[COLOR=rgb(255, 255, 255)][B][SIZE=3]Пожалуйста составьте свою жалобу в Технический раздел сервера <br>"+
		"[CENTER][COLOR=RED][B]Отказано, закрыто.[/B][/COLOR][/CENTER] <br>" +
        '[CENTER][COLOR=rgb(255, 255, 255)][B]Приятной игры на сервере[/B][/COLOR][/CENTER] ',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
	},
  {
	  ...
	  content:
		'[CENTER][B][COLOR=rgb(255, 255, 0)][FONT=times new roman][SIZE=4]{{ greeting }}, уважаемый(ая) {{ user.mention }}.[/SIZE][/FONT][/COLOR][/B]<br><br>' +
		"[COLOR=rgb(255, 255, 255)][B][SIZE=3]Вам было выдано наказания Техническим специалистом, вы можете написать жжалобу на него <br>"+
		"[CENTER][COLOR=RED][B]Отказано, закрыто.[/B][/COLOR][/CENTER] <br>" +
        '[CENTER][COLOR=rgb(255, 255, 255)][B]Приятной игры на сервере[/B][/COLOR][/CENTER] ',
        prefix: UNACCСEPT_PREFIX,
	  status: false,
