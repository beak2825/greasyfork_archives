// ==UserScript==
// @name         大麦抢票（pc、移动端浏览器自动下单 禁止用于盈利目的）
// @namespace    版权所属：浅听未来 公众号：攥着小糖 禁止用于盈利目的
// @version      2.0.0
// @description  辅助抢购大麦网门票自动提交订单：只支持网页普通场次、手机浏览器普通场次
// @author       secret11979
// @license      secret11979
...
// @downloadURL https://update.greasyfork.org/scripts/463618/%E5%A4%A7%E9%BA%A6%E6%8A%A2%E7%A5%A8%EF%BC%88pc%E3%80%81%E7%A7%BB%E5%8A%A8%E7%AB%AF%E6%B5%8F%E8%A7%88%E5%99%A8%E8%87%AA%E5%8A%A8%E4%B8%8B%E5%8D%95%20%E7%A6%81%E6%AD%A2%E7%94%A8%E4%BA%8E%E7%9B%88%E5%88%A9%E7%9B%AE%E7%9A%84%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/463618/%E5%A4%A7%E9%BA%A6%E6%8A%A2%E7%A5%A8%EF%BC%88pc%E3%80%81%E7%A7%BB%E5%8A%A8%E7%AB%AF%E6%B5%8F%E8%A7%88%E5%99%A8%E8%87%AA%E5%8A%A8%E4%B8%8B%E5%8D%95%20%E7%A6%81%E6%AD%A2%E7%94%A8%E4%BA%8E%E7%9B%88%E5%88%A9%E7%9B%AE%E7%9A%84%EF%BC%89.meta.js
// ==/UserScript==
...
$(document).ready(function () {
    ...
    if (curr_url.includes("https://excashier.alipay.com/") || curr_url.includes("https://mclient.alipay.com")) {
        alert("恭喜下单成功，可返回或前往APP查看订单，5分钟付款时间");
        sessionStorage.clear();
    }
...
function detail_ui() {
    ...
    var $wx = $(`<div id="wx" class="notice"><p>版权所属：浅听未来 公众号：攥着小糖 禁止用于盈利目的 </p><p>版本： ${version}</p></div>`);
...
function phone_detail_ui() {
    ...
    var $control_container = $("<div id='control_container'></div>");
    var $wx = $(`<div id="wx" class="notice"><p>版权所属：浅听未来 公众号：攥着小糖 禁止用于盈利目的</p><p>版本： ${version}</p></div>`);
    var $eventId = $('<div class="input_wrapper_phone" id="event_input_wrapper">请输入票价前的序号：<input id="event_input" type="text" value="0" ></div>');
    var $number_input = $('<div class="input_wrapper_phone" id="number_input_wrapper">请输入人数：<input id="number_input" type="number" value="2" min="1" max="4"></div>');
    var $start_btn = $('<button id="start_btn">开始抢票</button>');
    var $end_btn = $('<button id="end_btn">停止抢票</button>');
