...
// @downloadURL https://update.greasyfork.org/scripts/456437/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20CHERRY%20%2809%29.user.js
// @updateURL https://update.greasyfork.org/scripts/456437/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20CHERRY%20%2809%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    },
 {
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]В Ваших доказательствах присутствует монтаж.[/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Заместителям Главного Администратора[/color] - @Ronald Kõlman ☭︎ @Michael Tratyu [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>",
    prefix: PIN_PREFIX,
    status: true,
    },
    {
