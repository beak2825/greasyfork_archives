// ==UserScript==
// @name        RW Timer
// @description Hosp timers and spies on RW page! Shoutout cee tee ess and Zalp for hosp timer hint edit.  FORKED Change colour
...
// @author      finally
// @license     no idea
// @downloadURL https://update.greasyfork.org/scripts/562688/RW%20Timer.user.js
// @updateURL https://update.greasyfork.org/scripts/562688/RW%20Timer.meta.js
// ==/UserScript==
...
function updateStatus(id, node) {
	...
	node.finallyHospTimer = setInterval(() => {
        ...
        if (minutes <= 2) { node.style.color = 'black'; } else { node.style.color = 'rgb(255, 122, 77)'; }
