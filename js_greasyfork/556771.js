...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/556771/WME%20QuickStreets.user.js
// @updateURL https://update.greasyfork.org/scripts/556771/WME%20QuickStreets.meta.js
// ==/UserScript==
...
(async () => {
  ...
  `;
    ...
    const insertButtons = async () => {
        ...
        const buttons = [
            { label: 'St20', roadType: 1, speedLimit: 20, lockRank: 2, unpaved: true, btnClass: 'btn-street' },
            { label: 'St20*', roadType: 1, speedLimit: 20, lockRank: 2, cityId: true, unpaved: true, btnClass: 'btn-street' },
            { label: 'St30', roadType: 1, speedLimit: 30, lockRank: 2, unpaved: false, headlights: true, btnClass: 'btn-street' },
            { label: 'St50', roadType: 1, speedLimit: 50, lockRank: 2, unpaved: false, headlights: true, btnClass: 'btn-street' },
            { label: 'St90', roadType: 1, speedLimit: 90, lockRank: 2, cityId: true, unpaved: false, headlights: true, btnClass: 'btn-street' },
            { label: 'PS50', roadType: 2, speedLimit: 50, lockRank: 2, unpaved: false, headlights: true, btnClass: 'btn-ps' },
            { label: 'PS90', roadType: 2, speedLimit: 90, lockRank: 2, cityId: true, unpaved: false, headlights: true, btnClass: 'btn-ps' },
            { label: 'mH50', roadType: 7, speedLimit: 50, lockRank: 2, unpaved: false, headlights: true, btnClass: 'btn-minor' },
            { label: 'mH90', roadType: 7, speedLimit: 90, lockRank: 2, cityId: true, unpaved: false, headlights: true, btnClass: 'btn-minor' },
            { label: 'MH50', roadType: 6, speedLimit: 50, lockRank: 3, unpaved: false, headlights: true, btnClass: 'btn-major' },
            { label: 'MH90', roadType: 6, speedLimit: 90, lockRank: 3, cityId: true, unpaved: false, headlights: true, btnClass: 'btn-major' },
            { label: 'OFF15', roadType: 8, speedLimit: 15, lockRank: 2, unpaved: false, btnClass: 'btn-offroad' },
            { label: 'OFF15*', roadType: 8, speedLimit: 15, lockRank: 2, cityId: true, unpaved: false, btnClass: 'btn-offroad' },
            { label: 'PR30', roadType: 17, speedLimit: 30, lockRank: 2, unpaved: false, btnClass: 'btn-private' },
            { label: 'PLR30', roadType: 20, speedLimit: 30, lockRank: 2, unpaved: false, btnClass: 'btn-parking' },
            { label: 'NS30', roadType: 22, speedLimit: 30, lockRank: 2, unpaved: false, headlights: true, btnClass: 'btn-narrow' }
        ];
