...
// @version      1.1.0C
// @description  e-journals download redirect for NUS students V1.1.0C
...
// @downloadURL https://update.greasyfork.org/scripts/461853/NUS%20e-journals%20download%20redirect.user.js
// @updateURL https://update.greasyfork.org/scripts/461853/NUS%20e-journals%20download%20redirect.meta.js
// ==/UserScript==

function redirectToNUSProxy() {
  const currentUrl = document.location.href;
  const newUrl = currentUrl.replace('www.nature.com', 'www-nature-com.libproxy1.nus.edu.sg')
  ...
  if (currentUrl.includes('pubs.rsc.org')) {
    // Add a delay of 1 milliseconds (0.001 seconds) for pubs.rsc.org
    setTimeout(() => {
