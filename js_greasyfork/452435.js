...
// @version      1.6
// @description  drova 
// @author       moorenishimura
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @icon         https://icons.iconarchive.com/icons/aha-soft/iron-man/48/Ironman-Mask-3-Old-icon.png
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/452435/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93%20%D0%B8%20%D0%97%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93.user.js
// @updateURL https://update.greasyfork.org/scripts/452435/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93%20%D0%B8%20%D0%97%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93.meta.js
// ==/UserScript==
...
(async function () {
    ...
    const buttons = [
        ...
        `Игровой уровень не менее 5-го. <br>`+
  ...
  `Никто из состава администрации не будет просить у вас все различные пароли, пин-коды, информация о привязках и так далее. Не ведитесь на обманы!`,
...

        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br>` +
                ...
                `С уважением,Главный Следящий за ОПГ - Ivan_Gordeev.<br>` +
        ...
        },
        {
            ...
            content:
                ...
                "[CENTER]С уважением,Главный Следящий за ОПГ - Ivan_Gordeev. <br><br>" +
...

        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемые игроки![/CENTER]<br>` +
                `[CENTER] Закрываю заявление на пост лидера на рассмотрение.<br><br>` +
                `Пожалуйста ожидайте результатов от ЗГС ОПГ - Miller_Pyatak.<br><br>` +
                `С уважением,Главный Следящий за ОПГ - Ivan_Gordeev.<br>` +
                `[COLOR=orange]На рассмотрение.[/color] [/CENTER][/FONT][/SIZE]`,
            prefix: PIN_PREFIX,
            status: true,
...

        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br>` +
                ...
                `Пожалуйста ожидайте ответа от ГС ОПГ - @Ivan Gordeev.<br><br>` +
                `С уважением,ЗГС ОПГ - Miller_Pyatak.<br>` +
                `[COLOR=orange]На рассмотрение.[/color] [/CENTER][/FONT][/SIZE]`,
            prefix: PIN_PREFIX,
            status: true,
        },
