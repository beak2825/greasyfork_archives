// ==UserScript==
// @name         Astra Client Autoclicker (PC Only, Custom Hotkeys)
// @namespace    https://greasyfork.org/en/users/your-name
// @version      1.0.0
// @description  PC-only autoclicker for Astra Client with left/right CPS sliders (1–100), assign-any-key toggles, and a neon menu opened with Right Alt.
// @author       You
// @match        https://irv77.github.io/AmplerLauncher/mc/astraclient/*
// @run-at       document-end
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/561768/Astra%20Client%20Autoclicker%20%28PC%20Only%2C%20Custom%20Hotkeys%29.user.js
// @updateURL https://update.greasyfork.org/scripts/561768/Astra%20Client%20Autoclicker%20%28PC%20Only%2C%20Custom%20Hotkeys%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    const KEY_TOGGLE_MENU = "AltRight"; // Right Alt
    ...
    function buildUI() {
        ...
        panel.innerHTML = `
            ...
            <div class="ac-footer">Menu: Right Alt</div>
        `;
