...
// @version 0.44 Rev. 4 
// @description The West Script: Cloth Calculation. 
// @author Bluep, scoobydoo, Dun, Petee [tw-db.info] CrazzzyMan [rank system updated]
...
// @downloadURL https://update.greasyfork.org/scripts/28192/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Bro%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/28192/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Bro%5D.meta.js
// ==/UserScript==
(function (f) {
    ...
    if (isDefined(window.TWDB)) {
        new west.gui.Dialog(TWDB.script.name, '<div class="txcenter"><b><br>Script-ul CloathCalc este instalat de două ori, cu două versiuni lingvistice diferite. Va trebui să dezinstalați una dintre ele pentru script-ul să funcționeze corect!</br></b></div>', west.gui.Dialog.SYS_WARNING).addButton("OK").show();
    } else {
        TWDB = {};
        TWDB.script = new Object({
            ...
            update: "tw-db.info/cache/userscripts/clothcalc/clothcalc_ro.user.js",
        ...
        TWDB.Util = function (e) {
            ...
            var s = function () {
                var e = [], t, n, r = "twdb_" + Character.playerId + "_", i;
            ...
            var o = function () {
                ...
                var t = ["barracks", "bonusdisplay", "bonusjobs", "chathistory", "embackup", "marketreminder", "migration", "msdsettings", "notes", "settings", "statistic"], n = {keys: true}, r = [], i, s, o, u, a, f, l = "twdb_" + Character.playerId + "_", c = TWDB.Cache.load("migration") || {};
                c.itemid = c.itemid || {};
            ...
            var u = function (e) {
                ...
                var t = [], n, r, i = "backup_twdb_" + Character.playerId + "_", s;
        ...
        TWDB.ClothCalc = {
            ...
            checkCache: function () {
                var e = this.checkItems(), t = false, n = this.checkCustom(), r;
                this.gui.cache.children().remove();
                if (e || t || n) {
                    var i = "datele nu sunt actualizate, click pe Update";
                    if (e) {
                        i += " [Inventar]"
                    }
                    if (t) {
                    ...
                    r = jQuery('<div title="datele sunt actualizate" style="position:absolute;top:0px;right:0px;width:20px;height:20px;background: url(' + TWDB.images.iconData + ')no-repeat -20px 0px;" /></div>');
                    this.up2date = true
                }
            ...
            open: function (e, t) {
                ...
                this.gui.job.sort = jQuery('<div style="position:absolute;top:10px;left:0px;height:20px;" />').append('<img src="' + TWDB.images.iconName + '" title=" sortat după nume " alt=" sortat după nume " onclick="javascript:TWDB.ClothCalc.joblist.order(\'name\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconExperience + '" title=" sortat după experienţă " alt=" sortat după experienţă " onclick="javascript:TWDB.ClothCalc.joblist.order(\'experience\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconDollar + '" title=" sortat după salariu " alt=" sortat după salariu " onclick="javascript:TWDB.ClothCalc.joblist.order(\'wages\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconLuck + '" title=" sortat după noroc " alt=" sortat după noroc " onclick="javascript:TWDB.ClothCalc.joblist.order(\'luck1\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconLaborpoints + '" title=" sortat după punctele de muncă " alt=" sortat după punctele de muncă " onclick="javascript:TWDB.ClothCalc.joblist.order(\'laborpoints\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconMoti + '" title=" Sortează după motivaţie " alt=" Sortează după motivaţie " onclick="javascript:TWDB.ClothCalc.joblist.order(\'motivation\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />').append('<img src="' + TWDB.images.iconDanger + '" title=" sortat după pericol " alt=" sortat după pericol " onclick="javascript:TWDB.ClothCalc.joblist.order(\'danger\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />');
                this.gui.job.title = jQuery('<div style="position:absolute;top:37px;left:0px;width:187px;height:19px;font-weight:bold;text-align:center;white-space: nowrap;">Alege munca aici >></div>');
                this.gui.job.mode = jQuery("<div style=\"position:absolute;top:10px;right:30px;width:20px;height:20px;background:url('" + TWDB.images.jobTime + '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:block;" title=" Durata muncii " />');
                this.gui.job.search = jQuery("<div style=\"position:absolute;top:35px;right:50px;width:20px;height:20px;background:url('" + TWDB.images.iconSearch + '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:none;" title=" Găseşte această muncă pe hartă " />');
                ...
                this.gui.job.checkbox.setTooltip("Ascunde muncile pe care nu le poţi face");
                this.gui.job.checkbox.getMainDiv().css({position: "absolute", top: "35px", right: "30px"});
                this.gui.job.button = jQuery('<div style="position:absolute;top:35px;right:4px;width:26px;height:20px;background:url(\'/images/window/character/title_editbtn.jpg\') no-repeat scroll 0 0 transparent;cursor:pointer;" title=" Alege munca aici " />');
                ...
                this.gui.job.calc = $('<div title=" Recompense curente " style="position:absolute;top:60px;width:100px;right:1px;height:30px;display:block;;font-weight:bold;text-align:center;" />');
                ...
                this.gui.custom.title = jQuery('<div style="position:absolute;top:36px;left:0px;width:210px;height:19px;font-weight:bold;text-align:center;">Alege munca aici >></div>');
                this.gui.custom.settings = jQuery('<div title="setări" style="position:absolute;top:35px;right:30px;width:20px;height:20px;background:url(' + TWDB.images.iconSetting + ');cursor:pointer;" />');
                this.gui.custom.settings.click(function () {
                    n.customs.showConfig()
                });
                this.gui.custom.button = jQuery('<div style="position:absolute;top:35px;right:4px;width:26px;height:20px;background:url(\'/images/window/character/title_editbtn.jpg\') no-repeat scroll 0 0 transparent;cursor:pointer;" title=" Alege munca aici " />');
                ...
                this.gui.window = wman.open(this.uid, null, "noreload").setMiniTitle("TWDB Cloth Calc").setTitle("tw-db.info Cloth Calc").addTab("Muncă", "Jobs", o).addTab("Îndemânări selectate", "Custom", o).appendToContentPane(this.gui.job.mainDiv).appendToContentPane(this.gui.custom.mainDiv).appendToContentPane(this.gui.cache).appendToContentPane(this.gui.bag).appendToContentPane(this.gui.copyright);
                this.gui.window.showLoader();
                var u = $('<div title="Salvează poziția " style="width:20px;height:20px;position:absolute;left:0px;top:0px;background:url(\'' + TWDB.images.iconSave + "') no-repeat scroll 0px -20px transparent;cursor:pointer;display:block;\" />").hover(function () {
            ...
            jobs: {
                ...
                switchJob: function (e) {
                    ...
                    var t = this.parent, n = t.calcdata.jobs[e];
                    if (n.gameid !== 0) {
                ...
                mode: function (e) {
                    var t = this, n = 2, r = t.parent.data.jobs.jobs, i;
                    ...
                    try {
                        t.parent.gui.job.mode.unbind("click")
                    } catch (s) {
                    }
                    switch (e) {
                        case 1:
                ...
                _calcStepFormula: function (e, t, n, r, i, s, o, u, a) {
                    var f = Math.ceil((i + 1) / 5), l = Math.min(Math.floor(r / f), 15), c = Math.ceil(o / 25) * .25;
                ...
                addPremium: function (e) {
                    var t = Number(Premium.hasBonus("character")), n = Number(Premium.hasBonus("money")), r = 1, i = 1, s = 1;
                    if (n) {
                        r *= 1.5
                    }
                ...
                calcJob: function (e) {
                    var t = this.parent.calcdata.jobs[e], n = t.difficulty, r = JobList.getJobById(t.gameid), i;
                    t.values = {};
                    t.sp = 0;
                    t.max_sp = 0;
            ...
            joblist: {
                ...
                init: function (e) {
                    ...
                    for (t in e.calcdata.jobs) {
                        ...
                        if (n.gameid !== 0) {
                            var s = JobList.getJobById(n.gameid), o;
                            for (o in s.yields) {
                                if (isNaN(o)) {
                                    continue
                                }
                ...
                open: function (e) {
                    ...
                    jQuery(this.gui.input.getMainDiv()).unbind().keyup(function (e) {
                        t.keyHandler(e)
                    });
                    jQuery(this.gui.input.getField()).unbind().focus(function () {
                        t.gui.result.show()
                    });
                    ...
                    this.gui.button.click(function () {
                        if (t.gui.result.is(":visible")) {
                            ...
                            jQuery(t.gui.input.getField()).focus()
                        }
                    });
                    this.gui.main.show();
                    if (isDefined(e)) {
                        jQuery(this.gui.input.getField()).attr("value", e);
                        this.search(e, true)
                    }
                },
                search: function (e, t) {
                ...
                keyHandler: function (e) {
                    ...
                    if (t === 38 || t === 40) {
                        ...
                        var r = this.elements[this.focused].dom.offset().top, i = jQuery(this.gui.scrollpane.clipPane).offset().top, s;
                        if (r - i > 180 || i - r > 0) {
                            s = (r - i - 90) / 16;
                ...
                order: function (e) {
                    ...
                    var i = this.sort.order, e = this.sort.type, s = this, o = true;
                    if (e === "name") {
                ...
                updateJob: function (e) {
                    var t = this.elements[e], n = TWDB.ClothCalc.jobs.calcJob(t.id), r = n.name;
            ...
            customs: {
                selected: 0, setParent: function (e) {
                    this.parent = e
                }, init: function () {
                    var e, t;
                        ...
                        try {
                            ...
                            switch (t.type) {
                                case"speed":
                                    t.skills = ["ride"];
                                    if (!t.laborpoints) {
                                        var n = t.cloth && t.cloth[1] && t.cloth[1].other && t.cloth[1].other[1] || 0, r = t.boni && t.boni.other && t.boni.other[1] || 0;
                                        r -= n;
                                ...
                                case"regen":
                                    ...
                                    break;
                                case"fort":
                                    var i, s = {}, o = Character.charClass === "soldier" ? Premium.hasBonus("character") ? 1.5 : 1.25 : 1, u = Character.charClass == "worker" ? Premium.hasBonus("character") ? 1.4 : 1.2 : 1, a = (Number(t.boni.other[11]) || 0) + (Number(t.boni.other[17]) || 0), f = (Number(t.boni.other[12]) || 0) + (Number(t.boni.other[18]) || 0);
                                    if (t.para.type === 0) {
                    ...
                    var e = this;
                    var t = jQuery('<div title="editează" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/window/messages/head-icons.png') repeat scroll 0 16px transparent;\" />");
                    var n = jQuery('<div title="şterge" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/icons/delete.png') repeat scroll 0px 0px transparent;\" />");
                    var r = jQuery('<div title="adaugă" style="display:block;margin-top:2px;vertical-align:top;height:20px;width:25px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/window/messages/icons.png') repeat scroll 72px -5px transparent;\" />");
                    var i = jQuery("<div />");
                    ...
                    this.parent.gui.custom.config = new west.gui.Dialog("Îndemânări selectate", i);
                    ...
                    if (e >= 15) {
                        (new UserMessage("prea multe intrări, doar zece sunt permise", UserMessage.TYPE_ERROR)).show()
                    } else {
                        e++;
                        this.editConfig(e)
                    }
                    ...
                    if (typeof t == "undefined") {
                        ...
                        o.append(jQuery("<tr />").append('<td style="vertical-align:middle">Nume:</td>').append(jQuery("<td />").append(this.parent.gui.custom.name.getMainDiv())));
                        o.append(jQuery("<tr />").append('<td style="vertical-align:middle">Cod:</td>').append(jQuery("<td />").append(this.parent.gui.custom.code.getMainDiv())));
                        o.append('<tr><td colspan="2">vă rugăm să mergeţi la TW-db.info pentru a obţine fragmentele de cod pentru a le introduce aici <a href="https://tw-db.info/?strana=calc" target="_blank">tw-db.info Calculator</a></td></tr>');
            ...
            jobSearch: function () {
                ...
                for (var i = 0; i < t.length; i++) {
                    ...
                    u.append(jQuery('<td style="text-align:left;vertical-align:middle">').append(jQuery('<img src="' + TWDB.images.arrow + '" title="Direcţie" style="cursor:pointer;-moz-transform: ' + o + "-webkit-transform:" + o + "-rotat-transform:" + o + "-ms-transform:" + o + "transform:" + o + '" />').click(function (e, t) {
                        return function () {
                            Map.center(e, t)
                        }
                    }(s.x, s.y))));
        ...
        (function ($) {
            ...
            var Loader = function (e) {
                ...
                var h = function () {
                    ...
                    var r = e("<div style='font-family:comic sans ms; font-size:13pt; padding-top:10px; text-align:center;' />").append("Script-ul ClathCalc este un proiect creat de echipa TW-DB.info. El oferă o mulţime de caracteristici şi extensii ce vă va oferi o experienţă de joc îmbunătăţită - economisind timpul şi optimizând câteva din activităţile dumneavoastră. ", n, "Vă mulțumim!");
                    t.setGui(r);
                    if (t.isOutdated()) {
                ...
                t.reset = function (n, s) {
                    try {
                        if (n) {
                            ...
                            var u = e("<div><h2>Ești sigur ca vrei sa-ți resetezi cache-ul? </h2></div>");
            ...
            var Settings = function (e) {
                ...
                var o = function () {
                    ...
                    m.addItem("left", "stânga").addItem("right", "dreapta").addItem("custom", "Poziția salvată ");
                    m.select(String(n["clothPos"]));
                    e("tr.placeholder_clothPos", a).removeClass("placeholder_clothPos").append(e('<td colspan="2" />').append(m.getMainDiv(), "<span>&nbsp;dreapta</span>"));
                ...
                var i = function () {
                    try {
                        ...
                        JobWindow.prototype.getBestWearButton = function () {
                            ...
                            var n = this;
                            return t.append(e('<div class="twdb_bestwear" title="Arată munca in fereastra ClothCalc">').click(function (e) {
            ...
            var Updater = function (e) {
                ...
                var s = function () {
                    ...
                    if (Cache.load("version") && Script.version + " " + Script.revision !== Cache.load("version")) {
                        ...
                        var t = '<div class="txcenter">Script-ul =1= a fost actualizat. Vrei să vezi ce s-a modificat?</div>';
                ...
                var o = function (t, n) {
                    ...
                    var i = '<div class="txcenter">Pentru script =1= este o nouă versiune disponibilă, va rog apăsaţi OK pentru a actualiza scriptul</div>';
            ...
            var Analyser = function ($) {
                ...
                var reset = function (e, t, n) {
                    if (t == true) {
                        ...
                        o.append($('<div style="display:block;" />').append(a.getMainDiv()).append(f.getMainDiv()));
                ...
                var Chest = function (e) {
                    ...
                    t.show = function () {
                        ...
                        for (var r in statistic.chest) {
                            ...
                            n.appendContent(e('<div style="float:left;position:relative;height:61px;width:60px;margin:5px" />').append(s.getMainDiv()));
                            var o = 0;
                            ...
                            n.appendContent('<div style="float:left;position:relative;width:10px;height:' + String((parseInt(o / 10, 10) + 1) * 61 + 10) + "px;background: url(" + Game.cdnURL + '/images/window/report/devider_report.png) repeat-x scroll 0 0 transparent;" />');
                            n.appendContent(u);
                            n.appendContent('<div style="clear:both;position:relative;width:100%;height:10px;display:block;background: url(' + Game.cdnURL + '/images/window/dailyactivity/wood_devider_horiz.png) repeat-x scroll 0 0 transparent;" />')
                        }
                ...
                var showJobs = function () {
                    ...
                    for (var s in r) {
                        ...
                        var c = $('<div class="cell_0 view-rewards view-items" style="width:91px; text-align:left;cursor:pointer;font-size:11px;" ></div>');
                        c.data("sum", o.name);
                        c.data("sum-t", o.name);
                        c.data("avg", o.name);
                        c.data("avg-t", o.name);
                        v.append(c);
                        n.jobs++;
                        var c = $('<div class="cell_1 view-rewards view-items" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.count);
                        ...
                        v.append(c);
                        n.count += u.count;
                        var c = $('<div class="cell_2 view-rewards view-items" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        ...
                        c.data("avg-t", "&Oslash; " + String((u.duration / (3600 * u.count)).round(2)) + " ore");
                        v.append(c);
                        n.duration += u.duration;
                        var c = $('<div class="cell_3 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.experience);
                        c.data("sum-t", String(u.experience));
                        c.data("avg", (u.experience / u.count).round(2));
                        c.data("avg-t", "&Oslash; " + String((u.experience / u.count).round(2)));
                        v.append(c);
                        n.experience += u.experience;
                        var c = $('<div class="cell_4 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.wage);
                        c.data("sum-t", "$" + String(u.wage));
                        c.data("avg", (u.wage / u.count).round(2));
                        c.data("avg-t", "&Oslash; $" + String((u.wage / u.count).round(2)));
                        v.append(c);
                        n.wage += u.wage;
                        var c = $('<div class="cell_5 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.bond);
                        c.data("sum-t", String(u.bond));
                        c.data("avg", (u.bond / u.count * 100).round(2));
                        c.data("avg-t", "&Oslash; " + String((u.bond / u.count * 100).round(2)) + "%");
                        v.append(c);
                        n.bond += u.bond;
                        var c = $('<div class="cell_6 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.motivation);
                        c.data("sum-t", String(u.motivation) + "%");
                        c.data("avg", (u.motivation / u.count).round(2));
                        c.data("avg-t", "&Oslash; " + String((u.motivation / u.count).round(2)) + "%");
                        v.append(c);
                        n.motivation += u.motivation;
                        var c = $('<div class="cell_7 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.injury);
                        c.data("sum-t", String(u.injury));
                        c.data("avg", (u.injury / u.count).round(2));
                        c.data("avg-t", "&Oslash; " + String((u.injury / u.count).round(2)));
                        v.append(c);
                        n.injury += u.injury;
                        var c = $('<div class="cell_8 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.killed);
                        c.data("sum-t", String(u.killed));
                        c.data("avg", (u.killed / u.count * 100).round(2));
                        c.data("avg-t", "&Oslash; " + String((u.killed / u.count * 100).round(2)) + "%");
                        v.append(c);
                        n.killed += u.killed;
                        var c = $('<div class="cell_9 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.products);
                        c.data("sum-t", String(u.products));
                        c.data("avg", (u.products / u.count * 100).round(2));
                        c.data("avg-t", "&Oslash; " + String((u.products / u.count * 100).round(2)) + "% [" + f * 100 + "%]");
                        v.append(c);
                        n.products += u.products;
                        var c = $('<div class="cell_9 view-items" style="width:63px; text-align:center;cursor:pointer;" ></div>');
                        ...
                        c.data("avg", m);
                        v.append(c);
                        var c = $('<div class="cell_10 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.items);
                        c.data("sum-t", String(u.items));
                        c.data("avg", (u.items / u.count * 100).round(2));
                        c.data("avg-t", "&Oslash; " + String((u.items / u.count * 100).round(2)) + "%");
                        v.append(c);
                        n.items += u.items;
                        var c = $('<div class="cell_10 view-items" style="width:390px; text-align:center;cursor:pointer;" ></div>');
                        ...
                        c.data("avg", m);
                        v.append(c);
                        var c = $('<div class="cell_11 view-rewards" style="width:50px; text-align:center;cursor:pointer;" ></div>');
                        c.data("sum", u.luck);
                        c.data("sum-t", "$" + String(u.luck));
                        c.data("avg", (u.luck / u.count).round(2));
                        c.data("avg-t", "&Oslash; $" + String((u.luck / u.count).round(2)));
                        v.append(c);
                        n.luck += u.luck;
                        gui.rows.push(v);
                        v.click(function () {
                    ...
                    gui.footer.append(c);
                    var c = $('<div class="cell_0 view-rewards view-items" style="width:87px; text-align:center;cursor:pointer;color:#444;" ></div>');
                    ...
                    c.data("sum", "&sum;");
                    c.data("sum-t", "schimbă în &Oslash;");
                    c.data("avg", "&Oslash;");
                    c.data("avg-t", "schimbă în &sum;");
                    gui.footer.append(c);
                    var c = $('<div class="cell_1 view-rewards view-items" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.count);
                    c.data("sum-t", n.count);
                    c.data("avg", n.count);
                    c.data("avg-t", n.count);
                    gui.footer.append(c);
                    var c = $('<div class="cell_2 view-rewards view-items" style="width:50px; text-align:center;" ></div>');
                    ...
                    c.data("avg-t", "&Oslash; " + String((n.duration / (3600 * n.count)).round(2)) + "ore");
                    gui.footer.append(c);
                    var c = $('<div class="cell_3 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.experience);
                    c.data("sum-t", String(n.experience));
                    c.data("avg", (n.experience / n.count).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.experience / n.count).round(2)));
                    gui.footer.append(c);
                    var c = $('<div class="cell_4 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.wage);
                    c.data("sum-t", "$" + String(n.wage));
                    c.data("avg", (n.wage / n.count).round(2));
                    c.data("avg-t", "&Oslash; $" + String((n.wage / n.count).round(2)));
                    gui.footer.append(c);
                    var c = $('<div class="cell_5 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.bond);
                    c.data("sum-t", String(n.bond));
                    c.data("avg", (n.bond / n.count * 100).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.bond / n.count * 100).round(2)) + "%");
                    gui.footer.append(c);
                    var c = $('<div class="cell_6 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.motivation);
                    c.data("sum-t", String(n.motivation) + "%");
                    c.data("avg", (n.motivation / n.count).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.motivation / n.count).round(2)) + "%");
                    gui.footer.append(c);
                    var c = $('<div class="cell_7 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.injury);
                    c.data("sum-t", String(n.injury));
                    c.data("avg", (n.injury / n.count).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.injury / n.count).round(2)));
                    gui.footer.append(c);
                    var c = $('<div class="cell_8 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.killed);
                    c.data("sum-t", String(n.killed));
                    c.data("avg", (n.killed / n.count * 100).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.killed / n.count * 100).round(2)) + "%");
                    gui.footer.append(c);
                    var c = $('<div class="cell_9 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.products);
                    c.data("sum-t", String(n.products));
                    c.data("avg", (n.products / n.count * 100).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.products / n.count * 100).round(2)) + "%");
                    gui.footer.append(c);
                    var c = $('<div class="cell_9 view-items" style="width:63px; text-align:center;" ></div>');
                    c.data("sum", n.products);
                    c.data("sum-t", String(n.products));
                    c.data("avg", (n.products / n.count * 100).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.products / n.count * 100).round(2)) + "%");
                    gui.footer.append(c);
                    var c = $('<div class="cell_10 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.items);
                    c.data("sum-t", String(n.items));
                    c.data("avg", (n.items / n.count * 100).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.items / n.count * 100).round(2)) + "%");
                    gui.footer.append(c);
                    var c = $('<div class="cell_10 view-items" style="width:390px; text-align:center;" ></div>');
                    c.data("sum", n.items);
                    c.data("sum-t", String(n.items));
                    c.data("avg", (n.items / n.count * 100).round(2));
                    c.data("avg-t", "&Oslash; " + String((n.items / n.count * 100).round(2)) + "%");
                    gui.footer.append(c);
                    var c = $('<div class="cell_11 view-rewards" style="width:50px; text-align:center;" ></div>');
                    c.data("sum", n.luck);
                    c.data("sum-t", "$" + String(n.luck));
                    c.data("avg", (n.luck / n.count).round(2));
                    c.data("avg-t", "&Oslash; $" + String((n.luck / n.count).round(2)));
                    gui.footer.append(c);
                    var i = $('<div style="margin: 0px 6px 0px 6px;width:680px;" />').append($('<a href="#">Schimbă între recompense şi obiecte găsite</a>').css({
                        marginTop: "-8px",
                        display: "block",
                        textAlign: "center"
                    }).click(function () {
            ...
            var Notes = function (e) {
                ...
                var u = function (t) {
                    ...
                    n.append(e('<div style="margin-left:8px" />').append((new west.gui.Bbcodes(r)).getMainDiv())).append(r.getMainDiv()).append(e('<div style="margin-left:8px" />').append((new west.gui.Button("Salvează".escapeHTML(), function () {
                        o(r.getContent());
                        a(r.getContent())
                ...
                var a = function (t) {
                    ...
                    n.append(e('<div style="margin:8px" />').append(r.getMainDiv())).append(e('<div style="margin-left:8px" />').append((new west.gui.Button("Salvează".escapeHTML(), function () {
                        o(t)
            ...
            var Map = function (e) {
                ...
                var d = function () {
                    ...
                    var n = function () {
                        ...
                        var a = e('<img title="Arată coordonatele pe hartă " src="' + Images.iconCount + '" />').click(function () {
            ...
            var BonusJobs = function (e) {
                ...
                var u = function () {
                    ...
                    TWDB.Util.addCss(t, "minimap");
                    var n = function () {
                        var t = e('<div id="mmap_twdb_bonusjobs" />').append(e('<input title="Arată muncile de aur" type="checkbox" ' + (i.gold ? 'checked="checked"' : "") + " />").change(function () {
                            i.gold = e(this).attr("checked");
                            a()
                        })).append('<div title="Arată muncile de aur" style="background-color:yellow; border:1px solid red;" />').append(e('<input title="Arată muncile de argint" type="checkbox" ' + (i.silver ? 'checked="checked"' : "") + " />").change(function () {
                            i.silver = e(this).attr("checked");
                            a()
                        })).append('<div title="Arată muncile de argint" style="background-color:white; border:1px solid black;" />').append(e('<img title="Munci bonus Exportă" src="' + Images.iconExport + '" />').click(function () {
                            f()
                        })).append(e('<img title="Munci bonus Importă" src="' + Images.iconImport + '" />').click(function () {
                            l()
                        })).append(e('<img title="Munci bonus Resetare" src="' + Images.iconReset2 + '" />').click(function () {
                            c()
                        }));
                ...
                var f = function () {
                    ...
                    var h = e("<div />").css({
                        ...
                        position: "relative",
                        display: "block"
                    }).append(e('<img src="' + Images.iconName + '" title=" sortat după nume "  style="margin:0px 2px 0px 2px;cursor:pointer;" />').click(function () {
                        c("name")
                    })).append(e('<img src="' + Images.iconCount + '" title=" Sortează după ţară " style="margin:0px 2px 0px 2px;cursor:pointer;" />').click(function () {
                        c("country")
                    }));
                    (new west.gui.Dialog("Munci bonus Exportă", e("<div />").append(h).append(a))).addButton("ok").show()
                };
                var l = function () {
                ...
                var c = function (e) {
                    try {
                        if (e) {
                            ...
                            var u = '<div class="txcenter">Munci bonus Resetare</div>';
            ...
            var Chat = function (e) {
                ...
                var g = function (t) {
                    ...
                    m.append('<span style="width:140px;height:15px;display:inline-block;text-align:center;padding: 4px 0px 2px 0px;font-size:11px;">istorie</span>');
            ...
            var SellTip = function (e) {
                ...
                var s = function (e) {
                    ...
                    if (r) {
                        e.divMain.append('<img src="' + Images.iconSell + '" class="TWDBsellTip" title="' + i + '" title=" Nu deţii acest obiect deocamdată " style="position:absolute;bottom:4px;right:0px;width:19px;height:19px;padding:0px;border:0px;margin:0px;" />')
                    }
                };
                return t
            }($);
            ...
            var Collector = function (e) {
                    ...
                    if (Settings.get("collector", true)) {
                        ...
                        GameInject.injectTrader("collector", function (e) {
                            if (t.isNewItem(e.item_id)) {
                                var n = '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" Nu deţii acest obiect deocamdată " ' + ' style="position:absolute;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />';
                                return n
                            }
                            return ""
                        });
                ...
                var s = function (e) {
                    ...
                    if (t.isNewItem(e.obj.item_id)) {
                        e.divMain.append('<img src="' + Images.iconNew + '" class="TWDBcollector" title=" Nu deţii acest obiect deocamdată " style="position:absolute;top:-8px;left:-15px;padding:0px;border:0px;margin:0px;" />')
                    }
                };
                var o = function (e) {
                    if (t.isNewItem(e)) {
                        return '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" Nu deţii acest obiect deocamdată " style="width:18px;height:18px;position:relative;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />'
                    } else {
                        return ""
                    }
                };
            ...
            var BuyTip = function (e) {
                ...
                var f = function (e, t) {
                    ...
                    if (t == "market") {
                        ...
                        return '<img id="TWDBbuyTip' + i + '" src="' + Images["iconStar3"] + '" class="TWDBbuyTip" width="18px" height="18px" title="Se calculeză, vă rog aşteptaţi..." style="padding:0px;border:0px;margin:0px;" />'
                    }
                    if (isDefined(r[n])) {
                        if (t == "shop") {
                            var s = h(n);
                    ...
                    e.divMain.append('<img src="' + Images["iconStar3"] + '" class="TWDBbuyTip" width="25px" height="25px"     title="Se calculeză, vă rog aşteptaţi..."  style="position:absolute;bottom:-8px;right:-5px;padding:0px;border:0px;margin:0px;" />');
                    Worker.add(function (e, t) {
                        return function () {
                            l(t);
                            if (t == "shop") {
            ...
            var Snippets = function ($) {
                ...
                var QuestbookSwitch = function () {
                    try {
                        ...
                        QuestGroupWindowView.showSolvedQuest = function (e) {
                            ...
                            var r = $('<a href="#"> Arată textul de completare </a>').addClass("introshown").click(function () {
                ...
                var enhanceMarketSellDialog = function () {
                    ...
                    MarketWindow.TWDB_touchUpSellDialog = function (n) {
                        ...
                        $("#twdb_msd_desc_cc", r).append($('<div class="tw2gui-iconset tw2gui-icon-save" title="Salvează descrierea pentru viitoarele licitaţii">').click(function () {
                            u("description", $("textarea#auction_description", r).val())
                        }), $('<div class="tw2gui-iconset tw2gui-icon-abort" title="Resetează descrierea">').click(function () {
                            u("description", "");
                            $("textarea#auction_description", r).val("")
                        }));
                        $("#twdb_msd_buy_cc", r).append((new west.gui.Checkbox("", "twdb_msd_buy_fix", o)).setTitle("Foloseşte ca preţ implicit").setValue(2).divMain).append($('<div class="tw2gui_checkbox" title="Setează preţul de cumpărare al obiectului">').append('<span class="invPopup_buyicon" style="height:20px;">').click(function () {
                            $("#market_max_price", r).val(e.price || 1).keyup()
                        })).append("&nbsp;&nbsp;").append((new west.gui.Checkbox("", "twdb_msd_buy_fix", o)).setTitle("Foloseşte ca preţ implicit").setValue(1).divMain).append($('<div class="tw2gui_checkbox" title="Setează preţul de vânzare al obiectului">').append('<span class="invPopup_sellicon" style="height:20px;">').click(function () {
                            $("#market_max_price", r).val(e.sell_price || 1).keyup()
                        }));
                        $("#twdb_msd_bid_cc", r).append((new west.gui.Checkbox("", "twdb_msd_bid_fix", o)).setTitle("Foloseşte ca preţ implicit").setValue(2).divMain).append($('<div class="tw2gui_checkbox" title="Setează preţul de cumpărare al obiectului">').append('<span class="invPopup_buyicon" style="height:20px;">').click(function () {
                            $("#market_min_bid", r).val(e.price || 1).keyup()
                        })).append("&nbsp;&nbsp;").append((new west.gui.Checkbox("", "twdb_msd_bid_fix", o)).setTitle("Foloseşte ca preţ implicit").setValue(1).divMain).append($('<div class="tw2gui_checkbox" title="Setează preţul de vânzare al obiectului">').append('<span class="invPopup_sellicon" style="height:20px;">').click(function () {
                            $("#market_min_bid", r).val(e.sell_price || 1).keyup()
                        }));
                        ...
                        $("#twdb_msd_opt_cc", r).append($('<span class="tw2gui-iconset tw2gui-icon-save" title="Salvează durata şi drepturile pentru viitoarele licitaţii" style="display: inline-block;">').click(function () {
                            u("duration", parseInt($("#market_days", r).data("value"), 10));
                            u("rights", parseInt($("#market_rights", r).data("value"), 10))
                        }), $('<span class="tw2gui-iconset tw2gui-icon-abort" title="Resetează opţiunile" style="display: inline-block;">').click(function () {
                            u("duration", 1);
                        ...
                        var h = $("h4", r), p = $("table#mps_otheroffers", r);
                ...
                var weeklyCrafting = function () {
                    if (w.Character.professionId && w.Character.professionSkill > 599) {
                        var e = function (e) {
                            ...
                            var r = "<div style='text-align:center;'>Puteţi meşteşugi din nou!<br />" + '<div class="item  item_inventory" style="display:inline-block;float:none;"><img class="tw_item item_inventory_img" src="' + n.image + '"></div><br />' + n.name + "</div>";
                            t.init("", function () {
                            ...
                            TitleTicker.setNotifyMessage("Meserie")
                        };
                        var t = function () {
            ...
            var GameInject = function ($) {
                ...
                _self.injectTaskJobs = function () {
                    try {
                        ...
                        TaskJob = function () {
                            ...
                            t.getTitle = function () {
                                return t.__twdb__getTitle() + "PM: " + (this.data.job_points < 0 ? "<b class='text_red'>" : "<b>") + this.data.job_points + "</b><br />"
                            };
                            return t
                        }
                    } catch (t) {
                ...
                _self.addTabOnMarketWindow = function (name, shortname, callback) {
                    var first = false;
                    var current = {};
                    if (MarketWindow.twdb_showTab)current = {
                        fn: MarketWindow.twdb_showTab,
                        name: "MarketWindow.twdb_showTab"
                    }; else current = {fn: MarketWindow.showTab, name: "MarketWindow.showTab"};
                    ...
                    try {
                        ...
                        Inventory.addItems = function (e, t) {
                            ...
                            if (!$("#CC_pin_items").length) {
                                Inventory.DOM.children(".actions").append($('<div id="CC_pin_items" class="tw2gui_iconbutton" />').attr({title: "Comutare mod de fixare".twdb_twiceHTMLUnescape()}).toggleClass("pinact", TWDB.Settings.itemPinningMode === 1))
                            }
                ...
                _self.injectInventoryAddItemDivToInvPinItems = function () {
                    try {
                        ...
                        Inventory.addItemDivToInv = function (e, t) {
                            if (!TWDB.Settings.itemPinningMode && !t)Inventory.__CCPI__addItemDivToInv.apply(this, arguments); else {
                                var n = TWDB.Settings.get("pinnedItems") || [], r = e.getId();
                                ...
                                if (TWDB.Settings.itemPinningMode)i.addClass(n.indexOf(r) < 0 ? "opacity05" : ""); else i.find("img").setDraggable(Inventory.announceDragStart, Inventory.announceDragStop);
                                if (t) {
                ...
                _self.injectTelegramWindowAppendTelegramDisplaySource = function (e) {
                    try {
                        ...
                        TelegramWindow.appendTelegram = function (e, t) {
                            ...
                            }).before($('<div class="telegram-source"><div>BB</div></div>').attr("title", "Schimbă între textul formatat şi textul sursă").click(function () {
                ...
                _self.injectWanderingTraderSellDialog = function () {
                    try {
                        ...
                        west.window.shop.view.__proto__.showSellDialog = function (e) {
                            var t = this.getController(), n = Bag.getItemByItemId(e), r = n.count, i, s;
                    ...
                    n(o, function (t) {
                        ...
                        try {
                            ...
                            if (isDefined(n.error)) {
                                (new UserMessage(Script.url + ": " + n.error, UserMessage.TYPE_ERROR)).show()
                            } else {
                                (new UserMessage(Script.url + ": " + n.message, UserMessage.TYPE_SUCCESS)).show();
                                r = n.data;
                                a.skills = s;
                                a.items = i;
            ...
            var Quests = function (e) {
                ...
                var i = function () {
                    ...
                    var n = function (t) {
                                ...
                                if (isDefined(t.requirements[n])) {
                                    ...
                                    if (isDefined(r.jsInfo) && isDefined(r.jsInfo.id)) {
                                        if (r.jsInfo.type == "inventory_changed") {
                                            ...
                                            if (s) {
                                                e(this).children(".quest_mmaplink").after('<span title="Arată munca in fereastra ClothCalc" class="quest_mmaplink" title="" onclick="javascript:void(Quest.CCopen(\'' + s.name + "','item'))\"><img src=\"" + Images.iconLight + '" /></span>')
                                            }
                                        } else if (r.jsInfo.type == "task-finish-job") {
                                            var o = Jobs.getJobById(r.jsInfo.id);
                                            if (o) {
                                                e(this).children(".quest_mmaplink").after('<span title="Arată munca in fereastra ClothCalc" class="quest_mmaplink" title="" onclick="javascript:void(Quest.CCopen(\'' + o.id + "','job'))\"><img src=\"" + Images.iconLight + '" /></span>')
                                            }
                                        }
                                    }
                                }
                        ...
                        t.el.find(".questRequirementHelp").append('<a target="_blank" title="Arată misiunea pe tw-db.info" href="' + Script.protocol + "://" + Script.url + "/quest_redirect.php?id=" + t.id + '" style="margin-left:10px;"><img src="' + Images.questwiki + '" /></a>')
                    };
                ...
                var s = function () {
                    try {
                        ...
                        QuestWindow.cancelQuest = function (t) {
                            (new west.gui.Dialog("Anulezi misiunea?", "Eşti sigur că vrei să anulezi misiunea?")).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false, {
            ...
            var Customs = function (e) {
                        ...
                        try {
                            ...
                            switch (r.type) {
                                ...
                                case"regen":
                                    ...
                                    break;
                                case"fort":
                                    var s = {}, o = Character.charClass == "soldier" ? Premium.hasBonus("character") ? 1.5 : 1.25 : 1, u = Character.charClass == "worker" ? Premium.hasBonus("character") ? 1.4 : 1.2 : 1, a = (Number(r.boni.other[11]) || 0) + (Number(r.boni.other[17]) || 0), f = (Number(r.boni.other[12]) || 0) + (Number(r.boni.other[18]) || 0);
                                    if (r.para.type == 0) {
                ...
                t.open = function () {
                    ...
                    for (var s in n) {
                        ...
                        var o = n[s];
                        var u = e('<div title="editează" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/window/messages/head-icons.png') repeat scroll 0 16px transparent;\" />").click(function (e) {
                            return function () {
                                c(e)
                            }
                        }(s));
                        var a = e('<div title="şterge" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/icons/delete.png') repeat scroll 0px 0px transparent;\" />").click(function (e) {
                            return function () {
                                f(e)
                            }
                        }(s));
                    ...
                    if (r < 15) {
                        t.append(e('<div title="adaugă" style="display:block;margin-top:2px;vertical-align:top;height:20px;width:25px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/window/messages/icons.png') repeat scroll 72px -5px transparent;\" />").click(function () {
                            l()
                        }))
                    }
                    i = (new west.gui.Dialog("Îndemânări selectate", t)).addButton("ok", function () {
                ...
                var f = function (e) {
                    ...
                    (new west.gui.Dialog("şterge - Îndemânări selectate", "şterge: " + String(n[e].name).escapeHTML() + "?")).addButton("ok", r).addButton("cancel").show()
                };
                var l = function () {
                    var e = 0;
                    for (var t in n) {
                ...
                var c = function (t) {
                    if (isDefined(n[t])) {
                        ...
                        var s = "editează - Îndemânări selectate"
                    } else {
                        var r = "";
                        var i = "";
                        var s = "adaugă - Îndemânări selectate"
                    }
                    ...
                    var f = e('<table width="400px" />').append(e("<tr />").append('<td style="vertical-align:middle">Nume:</td>').append(e("<td />").append(o.getMainDiv()))).append(e("<tr />").append('<td style="vertical-align:middle">Cod:</td>').append(e("<td />").append(u.getMainDiv()))).append(e('<tr><td colspan="2">vă rugăm să mergeţi la TW-db.info pentru a obţine fragmentele de cod pentru a le introduce aici <a href="https://' + Script.url + '/?strana=calc" target="_blank">tw-db.info Calculator</a></td></tr>'));
            ...
            var Forum = function (e) {
                ...
                var r = function () {
                    ...
                    if (Settings.get("forumlastpage", true)) {
                        e("#windows").on("DOMNodeInserted", "iframe", function () {
                ...
                var i = function () {
                    ...
                    if (t.find("#thread_overview").length == 1) {
                        t.find(".row").each(function (t) {
                            ...
                            e(this).find(".cell_3").append('<img src="' + TWDB.images.lastpost + '" style="position:absolute;cursor:pointer;margin-left:3px;" onclick="Forum.openThread(' + r + ", " + n + ')"></img>')
                        })
                    }
                };
                return t
            ...
            var DuelMotivation = function (e) {
                ...
                var m = function (e) {
                    ...
                    d(t + "%", "Motivaţie de duel:&nbsp;" + t + "%", e ? "duelmot_dim" : "")
                };
                var g = function (e) {
                    if (f) {
                        w.clearInterval(f)
                    ...
                    a = "<div style='text-align:center;'>Timp K.O.<br />";
                    if (!c && n > t && !e) {
                        a += "Suspendare pe&nbsp;" + (new Date(n)).toLocaleString() + "<br />";
                    ...
                    u = Math.max(0, u);
                    a += "Protecţie duel până pe&nbsp;" + (new Date(r)).toLocaleString() + "</div>";
            ...
            var Bank = function (e) {
                ...
                var s = function () {
                    ...
                    btn.click(function () {
                        o()
                    }).addMousePopup("Depozitează-ţi banii")
                };
                var o = function () {
                    (new west.gui.Dialog("Depozitează-ţi banii", e("<span class='twdb_banking'>Bani: " + w.Character.money + "</span>"))).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false).addButton("yes", function () {
                        a(1)
                    }).addButton("no").show()
                };
                var u = function () {
                    try {
                        ...
                        if (w.Character.position.x == w.Character.homeTown.x && w.Character.position.y == w.Character.homeTown.y) {
                            if (n) {
                                n = false;
                                (new west.gui.Dialog("Depozitează-ţi banii", e("<span class='twdb_banking'>Ai ajuns în oras. Vrei să-ţi depozitezi banii? <br />Bani: " + w.Character.money + "</span>"))).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false).addButton("yes", function () {
                                    n = true;
            ...
            var Market = function (e) {
                ...
                var o = function () {
                    ...
                    if (Settings.get("marketmap", true)) {
                        GameInject.addTabOnMarketWindow("Harta pieţei", "marketmap", function () {
                            c()
                        });
                ...
                var l = function (e) {
                    ...
                    var i = function (e) {
                        var t = n[e], r = Math.max(t.ends * 1e3 - (new Date).getTime() - t.reminder * 60 * 1e3, 100);
                    ...
                    var u = function (t) {
                        var r = n[t], i = ItemManager.get(r.item), s = new OnGoingEntry;
                        s.init();
                        s.setTooltip("Licitaţie: " + i.name + ", Sfârşit: " + Number(r.ends - (new Date).getTime() / 1e3).getTimeString4Timestamp());
                        s.setImage(e('<img src="' + Images.notiBell + '" />'));
                        WestUi.NotiBar.add(s);
                        TitleTicker.setNotifyMessage("Licitaţie: " + i.name + ", Sfârşit: " + Number(r.ends - (new Date).getTime() / 1e3).getTimeString4Timestamp());
                        AudioController.play(AudioController.SOUND_NEWMSG);
                        o(t)
                    };
                    t.create = function (r, i) {
                        var u = e("<div />").append('<span style="position:relative; width:100%;display:block;">Sfârşitul licitaţiei: ' + r.auction_ends_in.getTimeString4Timestamp() + "</span>"), a = (new west.gui.Textfield("twdb_analyser_last")).maxlength(4).onlyNumeric().setLabel("Aminteşte-mi înainte de sfârşitul licitaţiei: ").setPlaceholder("Minute");
                        u.append(a.getMainDiv());
                        ...
                        var f = (new west.gui.Dialog("Memento pentru piaţă", u)).setIcon(west.gui.Dialog.SYS_QUESTION).setModal(true, false, {
                        ...
                        if (t.exists(r.market_offer_id)) {
                            f.addButton("şterge", function () {
                                o(r.market_offer_id);
                                i.css("opacity", .5)
                            })
                        }
                        f.addButton("cancel", function () {
                        }).show()
                    };
                    return t
                }(e);
                var c = function () {
                    try {
                        ...
                        window.MarketWindow.window.setTitle("Harta pieţei").setSize(840, 655).addClass("premium-buy");
                        var t = -111, s = -1;
                ...
                var h = function (e, t, n, r, s, o, u) {
                    if (!isDefined(i[e])) {
                        i[e] = {
                            ...
                            offers_unend: {},
                            money: 0,
                            distance: window.Map.calcWayTime(window.Character.position, {x: n, y: r}).formatDuration()
                        }
                    }
                    var a = i[e];
                    if (s !== "") {
                ...
                var d = function () {
                    e.ajax({
                        ...
                        success: function (e) {
                            var t = e.msg.search_result;
                            for (var n = 0; n < t.length; n++) {
                                h(t[n].market_town_id, t[n].market_town_name, t[n].market_town_x, t[n].market_town_y, "", "", t[n].current_bid)
                            }
                        }
                    })
                };
                var v = function () {
                    for (var t in i) {
                        ...
                        }).attr({"class": "twdb_mmap_point", id: t, title: s}).click(function (e) {
                            return function () {
                    ...
                    e("<img src='" + to_cdn("images/map/minimap/icons/miniicon_pos.png") + "' />").css({
                        ...
                        width: "16px",
                        height: "16px"
                    }).attr({"class": "mmap_mappoint", id: "mmap_icon_pos", title: "Poziţia ta."}).appendTo(r)
                };
                var m = function () {
                    try {
                        var t = [], r, s, o;
            ...
            var Fort = function ($) {
                ...
                var inject = function () {
                    try {
                        ...
                        newfunction = newfunction.replace(/\.appendToThCell\('head','evaluated',.*,.*\);var list=/g, ".appendToThCell('head','healthpoints','Sortează după viaţă','<span class=\"sort sort-healthpoints\">'+'Lp'+'</span>');var list=");
