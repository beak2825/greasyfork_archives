...
// @grant        all
// @downloadURL https://update.greasyfork.org/scripts/372493/Not%20bloomed%20TM%20-%20V116.user.js
// @updateURL https://update.greasyfork.org/scripts/372493/Not%20bloomed%20TM%20-%20V116.meta.js
// ==/UserScript==
	...
	$("div.player_name > a").each(function(e, player) 
	{
		...
		{ 
			if (xhr.readyState == 4)
			{
                ...
                console.log(Last_Season_Avg_Ti(return_TI((arrary[id_index(resultado.player.player_id,arrary)][1]),resultado.player.skill_index,player_postion(transfer_info_ar,id_index(resultado.player.player_id,arrary))),Season_TI(player_postion(transfer_info_ar,id_index(resultado.player.player_id,arrary)),SI(resultado.player.skill_index),return_wage(resultado.player.wage),19.836),session,parseInt(resultado.player.months),parseInt(resultado.player.player_id),return_wage(resultado.player.wage)) )
