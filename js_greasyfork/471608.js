...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/471608/Script%20by%20King.user.js
// @updateURL https://update.greasyfork.org/scripts/471608/Script%20by%20King.meta.js
// ==/UserScript==
...
`[SIZE=4][FONT=georgia][CENTER][COLOR=black] Приятной игры и времяпровождение  на сервере BLACK (10)[/COLOR][/FONT][/SIZE][/CENTER]`,
 prefix: UNACCEPT_PREFIX,
	...
	},
    {
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба передана Заместителям Главного Администратора —  @Lucas_King  и @Harry Hoi ♡  <br><br>"+
        `[color=orange]На рассмотрении[/color]. <br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=black] Приятной игры и времяпровождение  на сервере BLACK (10)[/COLOR][/FONT][/SIZE][/CENTER]`,
	  prefix: PIN_PREFIX,
	  status: true,
