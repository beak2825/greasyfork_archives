// ==UserScript==
// @name         PPT (Modded)
// @description  Pixel Place Tools (Modded)
// @version      1.6.2
// @author       0vC4
        ...
        let t = timer.setInterval(() => {
            ...
            for (; yi < half+1;) {
                for (; xi < half+1;) {
                    ...
                    if (pixel === 100000 || xi > -innerHalf && xi < innerHalf && yi > -innerHalf && yi < innerHalf) {
                        xi++;
                        continue;
                    }
        ...
        let t = timer.setInterval(() => {
            ...
            for (; yi < half+1;) {
                for (; xi < half+1;) {
                    ...
                    if (pixel === 100000 || xi**2 + yi**2 > half**2 || xi**2 + yi**2 < innerHalf**2) {
                        xi++;
                        continue;
                    }
