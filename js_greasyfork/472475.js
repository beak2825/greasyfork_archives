...
// @grant          unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/472475/bilibili%20BufferTime%20Change.user.js
// @updateURL https://update.greasyfork.org/scripts/472475/bilibili%20BufferTime%20Change.meta.js
// ==/UserScript==
...
(function() {
    ...
    var App = function App() {
        ...
        var defaultBufferTime = 250;
        var _useGmValue2 = useGmValue("bufferTime", defaultBufferTime), bufferTime = _useGmValue2.data, updateBufferTime = _useGmValue2.updateData;
        useGmMenu("設定Buffer時間", (function() {
            var time = prompt("請輸入Buffer時間", bufferTime.toString());
            if (time) {
                if (isNaN(parseInt(time, 10))) {
                    alert("請輸入數字");
                    return;
                }
                var _bufferTime = parseInt(time, 10);
                updateBufferTime(_bufferTime);
            ...
            function changeBuffer(bufferTime) {
                var setBufferInterval = setInterval((function() {
                    if (dashPlayer) {
                        ...
                        console.log("hook set buffer time ".concat(bufferTime));
