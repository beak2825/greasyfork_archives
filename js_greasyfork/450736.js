// ==UserScript==
// @name         BLACK RUSSIA ORANGE  || Скрипт Кураторов форума by S.Haunted
// @namespace    https://forum.blackrussia.online
// @version      1.25
// @description  Специально для BlackRussia || ORANGE
// @author       Stich_Haunted
...
// @downloadURL https://update.greasyfork.org/scripts/450736/BLACK%20RUSSIA%20ORANGE%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20SHaunted.user.js
// @updateURL https://update.greasyfork.org/scripts/450736/BLACK%20RUSSIA%20ORANGE%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20SHaunted.meta.js
// ==/UserScript==
...
const buttons = [
      ...
      },
    {
      ...
      content:
        ...
        "[url=https://postimg.cc/tsD1gpH7][img]https://i.postimg.cc/s2C5wg6P/photo.png[/img][/url]<br><br>" +
        ...
        "[/LIST]<br><br>" +
        "[url=https://postimg.cc/tsD1gpH7][img]https://i.postimg.cc/s2C5wg6P/photo.png[/img][/url]<br><br>" +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA [B][COLOR=rgb(255, 140, 0)][FONT=times new roman]ORANGE[/FONT][/COLOR][/B]<br><br>" +
...
title: 'не на русском в чате',
    ...
    },
    {
      ...
      content:
        ...
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA [B][COLOR=rgb(255, 140, 0)][FONT=times new roman]ORANGE[/FONT][/COLOR][/B][/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[COLOR=rgb(51, 204, 51)][FONT=times new roman][SIZE=4][I]Одобрено.[/I][/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [B][COLOR=rgb(255, 140, 0)][FONT=times new roman]ORANGE[/FONT][/COLOR][/B][/SIZE][/FONT][/COLOR]',
      prefix: PIN_PREFIX,
      status: true,
    },
    {
    ...
    },
    {
      ...
      content:
        ...
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [B][COLOR=rgb(255, 140, 0)][FONT=times new roman]ORANGE[/FONT][/COLOR][/B]<br><br>" +
    ...
    },
    {
     ...
     content:
        ...
        "[FONT=times new roman][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [B][COLOR=rgb(255, 140, 0)][FONT=times new roman]ORANGE[/FONT][/COLOR][/B]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
...
title: 'нонрп обман донат/не донат',
    ...
    },
    {
      ...
      content:
        ...
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [B][COLOR=rgb(255, 140, 0)][FONT=times new roman]ORANGE[/FONT][/COLOR][/B][/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
...
title : 'Копипаст'  ,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' + 
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay организация отказана т.к все Ваши никнеймы должны быть написаны на русском языке. [/COLOR]<br><br>" +
...
title : 'не туда'  ,
  ...
  title : 'не по форме'  ,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' + 
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к все Ваши никнеймы должны быть написаны на русском языке. [/COLOR]<br><br>" +
