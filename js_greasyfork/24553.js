// ==UserScript==
// @name           custom E-Hentai Highlighter
...
// @grant          GM_setValue
// @version        0.5.9
// @downloadURL https://update.greasyfork.org/scripts/24553/custom%20E-Hentai%20Highlighter.user.js
// @updateURL https://update.greasyfork.org/scripts/24553/custom%20E-Hentai%20Highlighter.meta.js
// ==/UserScript==
            ...
            regexes.highlight.forEach(function(data) {
                ...
                if (data.type == 'tag' || data.excludeTags !== null) {
                    tags.forEach(function(tag) {
                        if (excluded) return;
                        if (data.excludeTags !== null && tag.tag.match(data.excludeTags)) {
                            excluded = true;
                            tagKeywords = { };
                            return;
                        }
