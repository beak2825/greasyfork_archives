...
// @downloadURL https://update.greasyfork.org/scripts/6801/Music%20liker%20for%20Beauty.user.js
// @updateURL https://update.greasyfork.org/scripts/6801/Music%20liker%20for%20Beauty.meta.js
// ==/UserScript==
...
var Tits='[点击直接下载] - By Yulei',Tit='title="'+Tits+'" ',Tit_=Tit+' target="_blank"',Sty0=' style="font-weight:bold;font-size:15px;color:gold;background-color:chocolate;"',Sty1='font-weight:bold;color:blueviolet;';
function Log(l){ //调试用
console.log(l);
}
...
Ypen(win.yiting.player.entity.URL||win.yiting.player.entity.Source||win.yiting.player.entity.src);
return false;}
}
...
if (DM('/playlist/')) {
_Q('.J_pop_download').onmouseover=function(){this.title=Tits;this.href=unescape(document['yinyuetaiplayer'].getAttribute('flashvars').match(/VideoUrl=(.*)&v/)[1])};
...
_Q('.J_download').style.color="red";
_Q('.J_download').onmouseover=function(){this.title=Tits;
var vUrl;try {vUrl=_Q('.area').innerHTML.match(/hcVideoUrl : '(.*)'/)[1]}catch(e){vUrl=win.Y.video.videoUrl};
this.href=vUrl;
}
 }
}
