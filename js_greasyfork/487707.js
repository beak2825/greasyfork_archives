...
// @noframes
// @connect *
// @downloadURL https://update.greasyfork.org/scripts/487707/%E5%8E%BB%E9%99%A4NodeJS%E4%B8%87%E7%BB%B4%E5%B9%BF%E5%91%8A.user.js
// @updateURL https://update.greasyfork.org/scripts/487707/%E5%8E%BB%E9%99%A4NodeJS%E4%B8%87%E7%BB%B4%E5%B9%BF%E5%91%8A.meta.js
// ==/UserScript==
...
(function () {
  $(document).ready(function () {
    ...
    const deleteElemnt = () => {
      // 删除广告元素
      const wwas = $(".wwads-horizontal");
      wwas.remove();

      const pagead2 = $("#pagead2");
      pagead2.remove();
    };

    // 每500毫秒(0.5秒)检查一次URL是否发生变化
    setInterval(function () {
      if (location.href !== currentUrl) {
        // 如果URL发生了变化，更新currentUrl，并运行你的代码
        currentUrl = location.href;
        console.log("URL changed to", currentUrl);

        // 删除广告元素
        deleteElemnt();
        // 在这里添加你的URL变化后需要运行的代码
      }
    }, 500);
