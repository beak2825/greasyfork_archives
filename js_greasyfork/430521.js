...
// @downloadURL https://update.greasyfork.org/scripts/430521/WME%20Jay%27s%20custom%20QW%20it%20all.user.js
// @updateURL https://update.greasyfork.org/scripts/430521/WME%20Jay%27s%20custom%20QW%20it%20all.meta.js
// ==/UserScript==
...
function startSidebarFunction() {
    ...
    function showButton() {
        ...
        if (W.selectionManager.getSelectedFeatures()[0].model.type == "segment") {
            $('.selection:first-child').append('<button id="SegmentFunction" class="btn btn-default">Segment function</button>');
        }
    ...
    $('#sidebar').on('click', '#SegmentFunction', function(event) {
