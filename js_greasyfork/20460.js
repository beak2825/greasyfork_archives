$(document).ready(function() {
    ...
    $('#leaderboard-hud h4').html('★Ꭾ☯Ꮭ☯★ ');
    $('title').html('OGARio - POLO')
    ...
    $("#mainPanel").after('<a target="_blank" style="text-align: center" href="https://twitter.com/julipolomolo"><h1>Twitter Polomolo </h1></a>')
    $(".agario-profile-panel").after('<script src="https://apis.google.com/js/platform.js"></script> <div class="agario-panel agario-side-panel vungo-yt-panel" style="margin: 10px 2px; float: right;"><div class="g-ytsubscribe" data-channelid="UC6200t0eZlVv5sYrm3zxB3w" data-layout="full" data-theme="dark" data-count="default"></div></div>')
 ...
 $(document).ready(function() {
    ...
    $('#skin').val(data[2]);
    document.querySelector("#mainPanel").querySelector("div").querySelector("div").lastElementChild.querySelector("img").src = document.getElementById("skin").value;
    $('#overlays').prepend('<style>#lolhi{opacity:0;}#lolhi:hover{opacity:0.95;}</style><div id="lolhi" style="    background: #9c2556; width: 500px; height: 300px; bottom: 35px; right: 35px; position: fixed; border-radius: 15px; box-shadow: 0px 0px 25px 0px #9c2556; padding: 70px; font-weight: 600; color: white; transition: all .10s ">Bienvenidos al clan Polomolo, Extension modificada por Go Team by LuisZ<br>Disfrutarla :)<br><br><br><script src="https://apis.google.com/js/platform.js"></script> <div class="g-ytsubscribe" data-channelid="UCEZ9GpOXwK3-7fgGotPH6Gw" data-layout="full" data-count="default"></div></div>');
});
