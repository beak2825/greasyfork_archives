// ==UserScript==
// @name   🌱【免费版】东奥时代教育+晋中市专业技术人员继续教育|如需自动下一集、自动换课程、验证码识别、考试答题、防掉线高级功能见收费版本：https://doc.zhanyc.cn/pages/0d561d/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.2
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、防掉线、验证码识别、考试答题、全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include   https://*.dongao.com/*
// @include   https://*.dongao.cn/*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/505308/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E4%B8%9C%E5%A5%A5%E6%97%B6%E4%BB%A3%E6%95%99%E8%82%B2%2B%E6%99%8B%E4%B8%AD%E5%B8%82%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E9%AA%8C%E8%AF%81%E7%A0%81%E8%AF%86%E5%88%AB%E3%80%81%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98%E3%80%81%E9%98%B2%E6%8E%89%E7%BA%BF%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpages0d561d.user.js
// @updateURL https://update.greasyfork.org/scripts/505308/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E4%B8%9C%E5%A5%A5%E6%97%B6%E4%BB%A3%E6%95%99%E8%82%B2%2B%E6%99%8B%E4%B8%AD%E5%B8%82%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E9%AA%8C%E8%AF%81%E7%A0%81%E8%AF%86%E5%88%AB%E3%80%81%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98%E3%80%81%E9%98%B2%E6%8E%89%E7%BA%BF%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpages0d561d.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动换课程、验证码识别、全自动无人值守、考试答题、防掉线等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/0d561d/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (plugMain.matchUrl("cwweb/videoShow/video/videoPlay")) {
                if (url.includes("dongao.com")) {
                    plugMain.page_video();
                } else if (url.includes("dongao.cn")) {
                    plugMain.page_video_cn();
                }
            } else if (plugMain.matchUrl("study/u/myStudy")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`)
            } else if (plugMain.matchUrl("cwweb/lecture/lectureList")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`)
            } else if (plugMain.matchUrl("exam/exam/personSelectPaper/goToExam")) {
                plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`)
            } else if (plugMain.matchUrl("/study/u/myCourse")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`)
            }

            if (location.href.indexOf("circleIndexRedirect.do") != -1) {

                let type = plugMain.getUrlParam("type");
                // 使用旧版的授权ID
                switch (type) {
                    case "exam":
                        plugMain.showPaidContent(`免费版本不包含考试答题功能，欢迎使用收费版本，1秒完成答题，分数95+`);
                        break;
                    case "courseCategory4jwu":
                        plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
                        break;
                    case "course":
                        plugMain.showPaidContent(`免费版本不包含考试答题功能，如需使用请安装收费版本`);
                        break;
                    case "liveCourse":
                        plugMain.showPaidContent(`免费版本不包含直播看课功能，如需使用请安装收费版本`);
                        break;
                }
            } else if (location.href.indexOf("viewerforccvideo.do") != -1) {
                plugMain.page_viewerforccvideo();
            } else if (location.href.indexOf("securitySettingsRedirect.do") != -1) {
                plugMain.page_securitySettingsRedirect();
            } else if (location.href.indexOf("myExamAndTestRedirect") != -1) {
                plugMain.page_seeExam();
                plugMain.page_beginExamPage();
            } else if (location.href.indexOf("viewerforicourse") != -1) {
                plugMain.page_viewerforicourse();
            } else if (location.href.indexOf("gsliveCourseRedirect.do") != -1) {
                plugMain.page_gsliveCourseRedirect();
            }
        },
        async page_video_cn() {
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    //   return;
                    // }
                    if (plugMain.getElByText($(".box_head_tip"), "验证", "endsWith") != null) {
                        plugMain.pageData.waitTime = 10;
                        plugMain
                            .confirmRun("监测到验证弹窗，准备刷新页面以跳过验证")
                            .then((a) => {
                                location.reload();
                            });
                        return;
        ...
        async page_video() {
            if (plugMain.pageData.videoIndex != null) return;
            console.log("%c page_video", "background:rgb(255,0,0);color:#fff");
            GM_addValueChangeListener(
                plugMain.getGMKey("isRun"),
                function (name, old_value, new_value, remote) {
                    console.log("isRun", new_value);
                    plugMain.setGMData("isRunCallback", plugMain.now());
                }
            );
            console.log("%c page_video", "background:rgb(0,0,0);color:#fff");
            let timeout = 2;
            let playBtnIsShow = false;
            plugMain.pageData.videoIndex = setInterval(() => {
                console.log("%c page_video run", "background:rgb(0,0,0);color:#fff");

                // if (!plugMain.matchUrl("learncenter/play")) {
                //   return;
                // }
                if (plugMain.pageData.waitTime > 0) {
                    plugMain.pageData.waitTime -= timeout;
                ...
                if (plugMain.isPlayFinish()) {
                    ...
                    location.href = `https://gxpxcwweb.dongao.com/cwweb/lecture/lectureList?cwID=${plugMain.getUrlParam(
                        "cwID"
                    )}&platformCode=jxjydongao`;
                    // window.close();
                    return;
                }
                try {
                    if (unsafeWindow.window.video.paused()) {
                        plugMain.getVideo().play();
                        return;
                    }
                } catch (e) { }
                if (playBtnIsShow == true) {
                    $(".vjs-big-play-button:visible").click();
                }

                playBtnIsShow = $(".vjs-big-play-button:visible").length == 1;
                // $("title").text(playBtnIsShow);
            }, timeout * 1000);
        },
