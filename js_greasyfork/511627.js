// ==UserScript==
// @name         Set Promo Code and Retry for diceblox.com (Check for "nav")
// @namespace    http://tampermonkey.net/
// @version      2.2
// @description  Fetch promo code from Pastebin, stay idle if the code is "nav", and resume once it's changed
// @author       You
// @match        https://diceblox.com/promo/redeem
// @grant        none
// @license mine
// @downloadURL https://update.greasyfork.org/scripts/511627/Set%20Promo%20Code%20and%20Retry%20for%20dicebloxcom%20%28Check%20for%20%22nav%22%29.user.js
// @updateURL https://update.greasyfork.org/scripts/511627/Set%20Promo%20Code%20and%20Retry%20for%20dicebloxcom%20%28Check%20for%20%22nav%22%29.meta.js
// ==/UserScript==

(function() {
    'use strict';

    const pastebinURL = 'https://pastebin.com/raw/VzqXdsZT'; // Pastebin URL for promo code

    // Function to fetch the promo code from Pastebin
    function fetchPromoCode() {
        return fetch(pastebinURL)
    ...
    // Continuously fetch promo code every 5 seconds if it's "nav"
    setInterval(() => {
