// ==UserScript==
// @name Mutiply Roll Booster 2
// @author         Xavier De Guzman
// @namespace      http://tampermonkey.net/
// @version        2.0
// @description    Multiply Roll Booster which is so slow. I never use it. This is good at showing your profit from gambling session.
// @include https://freebitco.in/*
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/418762/Mutiply%20Roll%20Booster%202.user.js
// @updateURL https://update.greasyfork.org/scripts/418762/Mutiply%20Roll%20Booster%202.meta.js
// ==/UserScript==
...
function b0_init() {
	...
	$('#b0_d').append('Min: <input id="n0_min" value="2" style="width:40px"><br>');
