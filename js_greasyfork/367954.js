...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/367954/Yougame%20Free%20legend.user.js
// @updateURL https://update.greasyfork.org/scripts/367954/Yougame%20Free%20legend.meta.js
// ==/UserScript==
	...
	for (var x = 0; x < chco; x++)
	{
        ...
        //{
			if (articles.className == 'userText')
            {
				...
				if (nejj.childNodes[0].innerText == 'edic228')
                {
					nejj.childNodes[0].className = 'style48';
					blocks[i].childNodes[x+4].className = 'yougameLegend';
					blocks[i].childNodes[x+4].innerText = 'Легенда';
                }
				//console.log('baba');
            }
        //}
