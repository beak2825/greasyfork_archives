// ==UserScript==
// @name         VIP video script
// @namespace    lr-toolbox
// @version      0.0.2
// @description  本脚本精选解析线路为大家提供各大视频网站(PC+移动端)视频解析服务，让你省去购买视频VIP费用，同时提供知乎增强(知乎视频下载、去广告、去除侧边栏、关键词屏蔽等会员功能)，全网音乐和有声书免客户端下载(网易云音乐、QQ音乐、酷狗、酷我、虾米、蜻蜓FM、荔枝FM、喜马拉雅等)，视频无水印下载(bilibili、抖音、快手、西瓜、youtube)，自动查券功能，所有功能互不影响，可独立开关。
// @author       举世无双
...
// @connect      gitlab.com
// @downloadURL https://update.greasyfork.org/scripts/490372/VIP%20video%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/490372/VIP%20video%20script.meta.js
// ==/UserScript==
// ==/UserScript==
(function() {
    'use strict';
    ...
    if(isMobile){
        ...
        let playLine = [
            {"name": "1综合","url": "https://jx.jsonplayer.com/player/?url="},
			{"name": "2YT","url": "https://jx.yangtu.top/?url="},
			{"name": "3虾米","url": "https://jx.xmflv.com/?url="},
			{"name": "4夜幕","url": "https://www.yemu.xyz/?url="},
			{"name": "5纯净1","url":"https://im1907.top/?jx="},
			{"name": "6爱豆","url":"https://jx.aidouer.net/?url="},
			{"name": "7mmkv","url":"https://jx.mmkv.cn/tv.php?url="},
			{"name": "8纯净/B站","url":"https://z1.m1907.top/?eps=0&jx="},
			{"name": "9NNXV","url":"https://jx.nnxv.cn/tv.php?url="}
        ];
