// ==UserScript==
// @name         My Script by L.Velietto
// @namespace    https://forum.blackrussia.online
// @version      1.1
// @description  Test_My_Scripts
// @author       Lucik
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @grant        none
// @license      MIT
// @collaborator Velietto
// @icon https://icons.iconarchive.com/icons/google/noto-emoji-people-bodyparts/512/12003-OK-hand-light-skin-tone-icon.png
// @downloadURL https://update.greasyfork.org/scripts/463541/My%20Script%20by%20LVelietto.user.js
// @updateURL https://update.greasyfork.org/scripts/463541/My%20Script%20by%20LVelietto.meta.js
// ==/UserScript==
...
const buttons = [
      ...
      },
    {
      title: 'NICK',
      content:
          "[CENTER][IMG width=900px]https://i.postimg.cc/C1cS2QZ9/12346.png[/IMG]<br>"+
     "[B][CENTER][COLOR=#00FFFF][ICODE]{{ greeting }}, уважаемый {{ user.mention }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        ...
        "[CENTER][IMG width=500px]https://i.postimg.cc/yxyPz24X/4.png[/IMG]<br>"+
    ...
    },
    {
     ...
     "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        ...
        "[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]4.10.[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] Запрещено создавать никнейм, повторяющий или похожий на существующие никнеймы игроков или администраторов по их написанию[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | Устное замечание + смена игрового никнейма / PermBan[/SIZE][/FONT][/COLOR]<br><br>" +
          "[CENTER][IMG width=695px]https://i.postimg.cc/yxyPz24X/4.png[/IMG]<br>"+
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 0, 0)][FONT=times new roman][SIZE=4]BLACK[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
          '[B][CENTER][COLOR=#00FF00][ICODE]Одобрено![/ICODE][/COLOR][/CENTER][/B]',
      prefix: ACCEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
         "[CENTER][IMG width=900px]https://i.postimg.cc/C1cS2QZ9/12346.png[/IMG]<br>"+
       "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в технический раздел - [/I][URL='https://forum.blackrussia.online/index.php?forums/Технический-раздел-black.488/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=900px]https://i.postimg.cc/C1cS2QZ9/12346.png[/IMG]<br>"+
         '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[B][SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к. она скопирована.[/COLOR][/B]<br><br>" +
         "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
         "[CENTER][IMG width=695px]https://i.postimg.cc/yxyPz24X/4.png[/IMG]<br>"+
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 0, 0)]BLACK[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
