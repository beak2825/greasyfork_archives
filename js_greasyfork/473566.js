// ==UserScript==
// @name         BR Purple Личный скрипт (Full)
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/473566/BR%20Purple%20%D0%9B%D0%B8%D1%87%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%28Full%29.user.js
// @updateURL https://update.greasyfork.org/scripts/473566/BR%20Purple%20%D0%9B%D0%B8%D1%87%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%28Full%29.meta.js
// ==/UserScript==
...
const buttons = [
     {
      ...
      content:
               ...
               '[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#FFFF00]Ваша жалоба направляется на рассмотрении...[/COLOR][/B]<br>' +
    ...
    },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        '[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#FFFF00]Игрок будет наказан по данному пункту правил:[B][COLOR=rgb(245, 37, 10)] 2.18.[B][COLOR=#EFEFEF]Запрещен MG (MetaGaming) — использование ООС информации, которую Ваш персонаж никак не мог получить в IC процессе | [B][COLOR=#E25041]Mute 30 минут. [/CENTER][/CENTER] <br>' +
		'[Color=#00FF00][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
        '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]http://i.yapx.ru/QqZnC.jpg[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        '[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#FFFF00]Игрок будет наказан по данному пункту правил:[B][COLOR=rgb(245, 37, 10)] 2.20.[B][COLOR=#EFEFEF] Запрещен Mass DM (Mass DeathMatch) — убийство или нанесение урона без веской IC причины трем игрокам и более | [B][COLOR=#E25041]Warn / Ban 3 - 7 дней. [/CENTER][/CENTER] <br>' +
		'[Color=#00FF00][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
      ...
      content:
        '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]http://i.yapx.ru/QqZnC.jpg[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        '[CENTER][FONT=georgia][SIZE=5][B][I]Игрок будет наказан по пункту правил:[B][COLOR=rgb(245, 37, 10)] 2.22.[B][COLOR=#EFEFEF] Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками | [B][COLOR=#E25041]Ban 15 - 30 дней / PermBan Одобрено, закрыто.[/COLOR][/B]<br>' +
		'[Color=#00FF00][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
        '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]http://i.yapx.ru/QqZnC.jpg[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        '[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#FFFF00]Игрок будет наказан по данному пункту правил:[B][COLOR=rgb(245, 37, 10)]3.10.[B][COLOR=#EFEFEF] Запрещена выдача себя за администратора, если таковым не являетесь | [B][COLOR=#E25041]Ban 7 - 15 + ЧС администрации [/CENTER] <br>' +
		'[Color=#00FF00][CENTER]Одобрено, закрыто.[/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        '[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#EE0000]Ваша жалоба была передана на рассмотрение Главному Администратору @Den_Medvedev. [/CENTER] <br>' +
		'[Color=rgb(3, 252, 244)][CENTER]Ожидайте ответа.[/CENTER][/color]',
      prefix: GA_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        '[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#EE0000]Ваша жалоба была передана на рассмотрение Заместителю Главного Администратора @Timofei_Oleinik. [/CENTER] <br>' +
		'[Color=rgb(3, 252, 244)][CENTER]Ожидайте ответа.[/CENTER][/color]',
      prefix: PINN_PREFIX,
	  status: true,
    },
	...
	},
    {
      ...
      content:
        ...
        '[CENTER][B][COLOR=rgb(245, 37, 10)]Доказательства должны быть предоставлены в хорошем качестве и с полным процессом сделки или нарушения от какого-либо игрока.[/COLOR][/B]<br>' +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    ...
    },
	{
	  ...
	  content:
        '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]http://i.yapx.ru/QqZnC.jpg[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
		"[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#FFFF00]На ваших доказательствах отсутствует /time.[/CENTER][B][COLOR=rgb(245, 37, 10)]" +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
        '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]http://i.yapx.ru/QqZnC.jpg[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        "[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#FFFF00]Нету доказательств.[/CENTER][B][COLOR=rgb(245, 37, 10)]" +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
        '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]http://i.yapx.ru/QqZnC.jpg[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        '[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#FFFF00]Ваши докозательства отредактированы.[/CENTER] <br>' +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
        '[CENTER][B][FONT=trebuchet ms][SIZE=3][IMG]http://i.yapx.ru/QqZnC.jpg[/IMG][/SIZE][/FONT][/B][SIZE=3][FONT=trebuchet ms] [/CENTER]<br>' +
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        '[CENTER][B][FONT=georgia][SIZE=5][B][COLOR=#FFFF00]Вы ошиблись сервером/разделом, переподайте жалобу в нужный раздел.[/CENTER] <br>' +
        '[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
   ...
   },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
        "[CENTER]Ваша Неофициальная RP Организация была проверена, и получает статус: [Color=#00FF00]Одобрено.[/CENTER][/color][/FONT]",
    ...
    },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
       "[CENTER]Ваша РП Организация получает статус: [Color=#EE0000]Отказано.[/color][B][COLOR=rgb(245, 37, 10)]Причина: Мало информации в Биографии.[/CENTER][B][COLOR=rgb(245, 37, 10)]" +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
	  status: false,
         },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
       "[CENTER]Ваша РП Организация получает статус: [Color=#EE0000]Отказано.[/color][B][COLOR=rgb(245, 37, 10)]Причина: Организация скопирована.[/CENTER][B][COLOR=rgb(245, 37, 10)]" +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
	  status: false,
          },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
       "[CENTER]Ваша РП Организация получает статус: [Color=#EE0000]Отказано.[/color][B][COLOR=rgb(245, 37, 10)]Причина: Ошибки в тексте.[/CENTER][B][COLOR=rgb(245, 37, 10)]" +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
	  status: false,
            },
         ...
         },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
          "[CENTER][B][I][FONT=georgia]Активность не была замечена или же вы не предоставили док-ва об активности.Ваша Неофициальная RP Организация закрыта.[/CENTER]",
              prefix: PINN_PREFIX,
	  status: false,
   },
   {
    ...
    },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
       "[CENTER]Ваша РП Ситуация была проверена и получает статус: [Color=#EE0000]Отказано.[/color][B][COLOR=rgb(245, 37, 10)]Причина: Ситуация скопирована.[/CENTER][B][COLOR=rgb(245, 37, 10)]" +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
	  status: false,
        },
    {
          title: 'Банк. Счёт лишний',
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
       "[CENTER]Ваша РП Ситуация была проверена и получает статус: [Color=#EE0000]Отказано.[/color][B][COLOR=rgb(245, 37, 10)]Причина: Пункт `Банковский счёт` лишний.[/CENTER][B][COLOR=rgb(245, 37, 10)]" +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
	  status: false,
          },
    {
      ...
      content:
		'[CENTER][B][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый(- ая) {{ user.mention }}.[/SIZE][/FONT][/B][/CENTER]<br><br>' +
       "[CENTER]Ваша РП Ситуация была проверена и получает статус: [Color=#EE0000]Отказано.[/color][B][COLOR=rgb(245, 37, 10)]Причина: Ошибки в тексте.[/CENTER][B][COLOR=rgb(245, 37, 10)]" +
		'[Color=#EE0000][CENTER]Отказано, закрыто.[/CENTER]<br>' +
        '[CENTER][B][IMG]https://i.postimg.cc/LXK0dYGv/giphy-1.gif[/IMG][/CENTER][/FONT]',
	  status: false,
   },
...
'[COLOR=rgb(10, 247, 10)][B][SIZE=6]Одобрено[/SIZE][/B][/COLOR]<br><br>' +
...
"[COLOR=rgb(163, 143, 132)][B]Ознакомиться с правилами написания RolePlay биографий можно [/B][URL='https://forum.blackrussia.online/index.php?threads/purple-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B9.4887982/'][B]*Тут*[/B][/URL].<br><br>" +
...
"[COLOR=rgb(163, 143, 132)][B]Ознакомиться с правилами написания RolePlay биографий [/B][URL='https://forum.blackrussia.online/index.php?threads/purple-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B9.4887982/'][B]*Тут*[/B][/URL].<br><br>" +
...
'[COLOR=rgb(250, 197, 28)][B]Причина:[COLOR=rgb(255, 255, 255)][B] Название темы не по форме [/B][/COLOR]<br><br>' +
