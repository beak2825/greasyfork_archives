// ==UserScript==
// @name         IchijinshaSpider
// @namespace    https://www.ichijinsha.co.jp
// @version      0.2
// @description  Image spider for www.ichijinsha.co.jp | V0.2 在序号1-9的图片文件名前加上前缀'0'
// @author       DD1969
// @match        https://static.ichijinsha.co.jp/online/u/book/zerosum/*/*/*
...
// @downloadURL https://update.greasyfork.org/scripts/436545/IchijinshaSpider.user.js
// @updateURL https://update.greasyfork.org/scripts/436545/IchijinshaSpider.meta.js
// ==/UserScript==
...
(async function (axios, JSZip, saveAs) {
  ...
  for (let i = 0; i < jsons.length; i++) {
    promises.push(new Promise(async resolve => {
      // 获取图片的json数据
      const json = jsons[i];
      const page = await axios.get(href + json);
      ...
      shuffleImg.src = `${href}data/${page.data.resources.i.src}`;
