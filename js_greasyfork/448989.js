...
// @grant        unsafeWindow
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/448989/SMP.user.js
// @updateURL https://update.greasyfork.org/scripts/448989/SMP.meta.js
// ==/UserScript==
//===== config =====
...
class FactoryChecker
{
    async DoScript()
    {
        ...
        if(currentLocation.pathname.includes(Factory))
        {
            ...
            let countDown = (await _Selector.$("span[id*='time_']", unsafeWindow, false));
