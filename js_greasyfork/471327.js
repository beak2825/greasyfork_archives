// ==UserScript==
// @name         RED | Скрипт для Кураторов форума
// @namespace    https://forum.blackrussia.online
// @version      3.9
// @description  Скрипт для Кураторов Форума, сервер Ufa
// @author       Morty_Moore
// @match        https://forum.whiterussia.online/threads/*
// @include      https://forum.whiterussia.online/threads/
// @grant        none
// @license      MIT
// @collaborator Leo Vichnevskiy
// @icon https://takocode.ru/assets/imgs/avatar.gif
// @downloadURL https://update.greasyfork.org/scripts/471327/RED%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/471327/RED%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.19.[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] Запрещен DM (DeathMatch) — убийство или нанесение урона без веской IC причины[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | Jail 60 минут[/SIZE][/FONT][/COLOR]<br>" +
        "[LIST]<br>" +
        ...
        "[/LIST]<br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[I][FONT=times new roman][COLOR=rgb(209, 213, 216)][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/COLOR]<br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
"[COLOR=rgb(255, 0, 0)][SIZE=4]2.16. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещен SK (Spawn Kill) — убийство или нанесение урона на титульной территории любой фракции / организации, на месте появления игрока, а также на выходе из закрытых интерьеров и около них[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Jail 60 минут / Warn (за два и более убийства) [/SIZE][/COLOR]<br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: ACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=book antiqua]2.14.[/FONT][/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4][FONT=book antiqua] Запрещен RK (Revenge Kill) — убийство игрока с целью мести, возвращение на место смерти в течение 15-ти минут, а также использование в дальнейшем информации, которая привела Вас к смерти[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=book antiqua] | Jail 30 минут[/FONT][/SIZE][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: ACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]2.54. [/COLOR][COLOR=rgb(209, 213, 216)]Запрещено неуважительное обращение, оскорбление, неадекватное поведение, угрозы в любом их проявлении по отношению к администрации [/COLOR][COLOR=rgb(255, 0, 0)]| Mute 180 минут[/COLOR][/SIZE][/FONT]<br><br>" +
        '[LIST]<br><br>' +
        ...
        '[LIST]<br><br>' +
        "[*][FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]Пример: [/COLOR][COLOR=rgb(209, 213, 216)]оскорбление администрации в любой чат, включая репорт подлежит наказанию в виде блокировки доступа к использованию всех видов чатов - [/COLOR][COLOR=rgb(255, 0, 0)] Mute 180 минут[/COLOR][/SIZE][/FONT]<br><br>" +
        "[/LIST]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
	...
	{
      title: 'СМИ в лич. целях',
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту правил для государственных организаций:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]4.04. [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Запрещено редактировать поданные объявления в личных целях заменяя текст объявления на несоответствующий отправленному игроком [/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]| Ban 7 дней + ЧС организации[/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: ACCEPT_PREFIX,
	...
	{
      title: 'NonRP коп (Розыск)',
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил госс. организаций:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]6.02 / 7.02 / 8.02 [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещено выдавать розыск без Role Play причины[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Warn[/SIZE][/COLOR][/FONT]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: ACCEPT_PREFIX,
...
{
      title: 'NonRP коп (права)',
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил госс. организаций:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]7.04. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещено отбирать водительские права во время погони за нарушителем[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Warn[/SIZE][/COLOR][/FONT]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: ACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        ...
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил госс. организаций:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]6.03. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещено nRP поведение[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Jail 60 минут[/SIZE][/COLOR][/FONT]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: ACCEPT_PREFIX,
    ...
    },
	{
      ...
      content:
        ...
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.57.[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] Запрещается брать в долг игровые ценности и не возвращать их.[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4] | Ban 30 дней / permban[/SIZE][/FONT][/COLOR]<br>" +
        "[LIST]<br>" +
    ...
    {
      title: 'Продажа долж.(Каз/СТО)',
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту правил владения Казино/СТО/Ночным клубом:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[FONT=times new roman][SIZE=4][COLOR=rgb(209, 213, 216)][I]Ваша жалоба взята на рассмотрение, ожидайте ответа в данной теме.<br><br>" +
        "Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[COLOR=rgb(255, 165, 0)][FONT=times new roman][SIZE=4][I][CENTER]На рассмотрении.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
      prefix: PIN_PREFIX,
      status: true,
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4]Техническому Специалисту @Maksim Dmiitirev[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4]Главному Администратору @Vadim Derkachev[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
        "[FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 165, 0)][FONT=times new roman][SIZE=4][I][CENTER]На рассмотрении.[/SIZE][/COLOR][/I][/CENTER]',
      prefix: GA_PREFIX,
      status: true,
    },
	{
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 102, 0)][I][FONT=times new roman][SIZE=4]Главному Куратору Форума[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
        "[FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 165, 0)][FONT=times new roman][SIZE=4][I][CENTER]На рассмотрении.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]В таких случаях нужна видеофиксация.[/I][/SIZE][/FONT]<br><br>" +
        "[I][FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]В таких случаях нужна видеофиксация +промотка чата[/I][/SIZE][/FONT]<br><br>" +
        "[I][FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        ...
        "Внимательно изучите общие правила серверов - [URL='https://forum.blackrussia.online/index.php?threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%BE%D0%B2.312571/']*нажмите сюда*[/URL][/I]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Заголовок Вашей жалобы составлен не по форме. Внимательно прочитайте [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.3429394/']*правила подачи жалоб на игроков*[/URL].[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    {
      title: 'Нарушение в создание темы',
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша жалоба составлена с нарушением. Внимательно прочитайте [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.3429394/']*правила подачи жалоб на игроков*[/URL].[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Данный тип жалоб мы не рассматриваем.[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    {
      title: 'Док-ва разорваны на неск. видео',
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Доказательства не должны быть разорваны на отдельные видео. Загрузите полный фрапс на видеохостинг, указав все нужные таймкоды.[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]В вашей жалобе отсутствуют тайм-коды. Создайте новую жалобу, указав все необходимые тайм-коды.[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]В вашей жалобе не открываются доказательства.[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    {
      title: 'Нет пинга(Читы)',
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]В вашей жалобе нету проверки Пинга у игрока. /tab - Находите игрока на которого жалуетесь - Скрин.[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша жалоба составлена от 3-его лица.[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Срок написания жалобы составляет более три дня (72 часа) с момента совершенного нарушения со стороны игрока сервера.[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][CCOLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись сервером.[/I][/FONT][/SIZE]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.1165/']*жалоб на администрацию*.[/URL][/I][/FONT][/SIZE]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[FONT=times new roman][COLOR=rgb(209, 213, 216)][I]Ранее вам уже был дан корректный ответ на подобную жалобу, просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: UNACCEPT_PREFIX,
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей жалобе отсутствует договор сделки, дальнейшему рассмотрению она не подлежит.<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/CENTER]',
    ...
    },
    {
      ...
      content:
         '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]одобрена.[/COLOR][/I][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>'+
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана.[/COLOR]<br><br>" +
    ...
    content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как заголовок оформлен неправильно. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    content:
       '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как она написана от 3-го лица. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как в ней указан некорректный возраст. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    content:
         '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как в ней написано мало информации. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    content:
          '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как персонажу нет 18 лет. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    content:
         '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как она составлена не по форме. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как вы её не дополнили. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как она оформлена неграмотно. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        "[LIST]<br><br>" +
    ...
    },
    {
      title: 'Копипаст',
      content:
        '[COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как она скопирована.[/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
       '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
       '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
       '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана, так как ваш NickName должен быть написан на русском языке. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]одобрена.[/COLOR][/I][/FONT][/SIZE]<br><br>" + 
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана.[/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - Ситуации - [/COLOR][/I][COLOR=rgb(209, 213, 216)][URL='https://forum.blackrussia.online/threads/%E2%80%A2-ufa-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BD%D0%B0%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D1%81%D0%B8%D1%82%D1%83%D0%B0%D1%86%D0%B8%D0%B8.5445549/']*Нажмите сюда*[/URL][/COLOR][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша Неофициальная RolePlay - организация [COLOR=rgb(50, 205, 50)][FONT=times new roman][SIZE=4]одобрена.[/COLOR][/I][/FONT][/SIZE]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша Неофициальная RolePlay - организация [COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]отказана.[/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания Неофициальной RP - Организации - [/COLOR][/I][COLOR=rgb(209, 213, 216)][URL='https://forum.blackrussia.online/threads/%E2%80%A2-ufa-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B7%D0%B0%D1%8F%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F-%D0%BD%D0%B0-%D0%9D%D0%B5%D0%BE%D1%84%D0%B8%D1%86%D0%B8%D0%B0%D0%BB%D1%8C%D0%BD%D1%83%D1%8E-rp-%D0%BE%D1%80%D0%B3%D0%B0%D0%BD%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8E.5445521/']*Нажмите сюда*[/URL][/COLOR][/FONT][/SIZE]<br><br>" +
       '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
       '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 69, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]В вашей Неофициальной RolePlay - организации недостаточно информации.<br><br>" +
        "Даю вам 24 часа на ее дополнение.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[CENTER][IMG]https://i.postimg.cc/W3s0FnbX/1619558447629-2.png[/IMG]<br><br>' +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(0, 255, 255)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(218, 165, 32)][ICODE]Ufa[/ICODE][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: PIN_PREFIX,
