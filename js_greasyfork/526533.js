...
// @author       xile  bb844785535@gmail.com
// @match        *://*/*
// @grant        GM_addStyle
// @grant        GM_xmlhttpRequest
// @connect      api.fanyi.baidu.com
// @connect      raw.githubusercontent.com
// @downloadURL https://update.greasyfork.org/scripts/526533/%E7%BD%91%E9%A1%B5%E8%8B%B1%E8%AF%AD%E9%9A%BE%E8%AF%8D%E8%87%AA%E5%8A%A8%E5%88%92%E8%AF%8D%E7%BF%BB%E8%AF%91.user.js
// @updateURL https://update.greasyfork.org/scripts/526533/%E7%BD%91%E9%A1%B5%E8%8B%B1%E8%AF%AD%E9%9A%BE%E8%AF%8D%E8%87%AA%E5%8A%A8%E5%88%92%E8%AF%8D%E7%BF%BB%E8%AF%91.meta.js
// ==/UserScript==
...
(function() {
    ...
    async function handleWordHover(event) {
        ...
        if (target.dataset.translationFailed === 'true') {
            tooltip.innerHTML = target.textContent;
        ...
        hoverTimeout = setTimeout(async () => {
            ...
            try {
                ...
                const translationHtml = await translationQueue.translateWithCache(word);
                if (translationHtml && translationHtml !== word) {
                    tooltip.innerHTML = translationHtml;
                    // 清除失败标记（如果存在）
        ...
        try {
            ...
            words.forEach(word => {
                ...
                if (difficultWords.includes(word)) {
                    ...
                    // 使用事件捕获确保事件被处理
                    wordSpan.addEventListener('mouseenter', handleWordHover, true);
                    wordSpan.addEventListener('mouseleave', handleWordLeave, true);
                    // 添加触摸事件支持
                    wordSpan.addEventListener('touchstart', handleWordHover, true);
                    wordSpan.addEventListener('touchend', handleWordLeave, true);
