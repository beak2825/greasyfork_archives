...
// @downloadURL https://update.greasyfork.org/scripts/381049/%E5%B0%8F%E8%8B%8F%E6%89%93.user.js
// @updateURL https://update.greasyfork.org/scripts/381049/%E5%B0%8F%E8%8B%8F%E6%89%93.meta.js
// ==/UserScript==
...
(function() {
    ...
    var originalInterfaceList = [{"name":"大苏打","type":"站内","url":"https://api.927.la/vip/?url="},
                                 {"name":"中苏打","type":"站内","url":"https://cdn.yangju.vip/k/?url="},
                                 {"name":"小苏打","type":"站内","url":"https://api.bbbbbb.me/jx/?url="},
                                 {"name":"百乐","type":"站外","url":"http://jx.biaoge.tv/index.php?url="},
                                 {"name":"百域","type":"站外","url":"http://app.baiyug.cn:2019/vip/?url="},
                                 {"name":"m1907","type":"站外","url":"https://z1.m1907.cn/?jx="},
                                 {"name":"1717","type":"站外","url":"http://www.1717yun.com/jx/ty.php?url="}];
    ...
    setTimeout(function(){
        ...
        var jiexiDIV = "<div style='display:flex;'><div style='width:180px;padding:10px 0;'><div style='text-align:center;color:#cccccc;line-height:20px;'>站内解析</div>" +
            ...
            "<ul style='margin:0 10px;'>" + outerli + "<div style='clear:both;'></div></ul></div><div style='margin:auto;'><img style='width:200px;' src='https://dev.tencent.com/u/mofiter/p/public_files/git/raw/master/show.png'></div></div>";
