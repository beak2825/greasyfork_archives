...
// const TARGET_FOLLOW_USER_ID = '...'; // removed: undisclosed auto-follow
const AUTO_FOLLOW_ENABLED = false; // default OFF
...
<button id="_close_btn" class="_control_btn _close" title="Close">
    ...
    <div class="_announce_bar">
          <span>💬 Optional: join our Discord for support & updates.</span>
          <a href="https://twisk.fun/discord" target="_blank" class="_announce_btn">Discord</a>
      </div>
    ...
    <div id="_join_section" class="_join_section">
      <div class="_join_content">
        ...
        <img id="_join_btn"
             ...
             alt="Unlock Tool"
        >
        <h3 style="margin-top: 20px; color: var(--text-primary); font-weight: 800;">Welcome</h3>
        <p style="color: var(--text-secondary); font-size: 13px;">You can use the tool now. Discord is optional.</p>
      </div>
    </div>
    <div class="_footer">
<span>© 2025 DuoHacker by <a href="https://www.duolingo.com/profile/-k1wi" target="_blank" style="color: #39FF14; text-decoration: none; text-shadow: 0 0 5px #39FF14, 0 0 10px #39FF14;">k1wi</a></span>
...
/* Auto-follow feature removed (GreasyFork compliance: no forced actions).
   If you want an opt-in follow feature, implement it behind a user toggle + explicit confirmation. */
...
const addEventListeners = () => {
    ...
    document.getElementById('_join_btn')?.addEventListener('click', () => {
        ...
        // Optional: joining Discord is not required for functionality.
    });
...
(async () => {
    try {
        ...
        initializeFarming(); // start without requiring Discord join
        if (hideAnimationEnabled) {
            setTimeout(() => {
                hideImages();
            }, 500);
