...
// @downloadURL https://update.greasyfork.org/scripts/410137/%E7%BD%91%E6%98%93BUFF%E4%BB%B7%E6%A0%BC%E6%AF%94%E4%BE%8B%28%E6%89%BE%E6%8C%82%E5%88%80%29%E6%8F%92%E4%BB%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/410137/%E7%BD%91%E6%98%93BUFF%E4%BB%B7%E6%A0%BC%E6%AF%94%E4%BE%8B%28%E6%89%BE%E6%8C%82%E5%88%80%29%E6%8F%92%E4%BB%B6.meta.js
// ==/UserScript==
...
(function () {
    ...
    // jQuery Toast - CDN 总是出各种问题，不如直接放在本地
    ...
    window.buffHelperMarkerListScale = async function (items) {
        ...
        async function marketListLoadData(item, good, randomID, secendTry) {
            ...
            if (helper_config.buffSellThreshold >= buff_sell_num) {
                ...
                $(target).after($(HIGHLIGHT_TEMPLATE).text("已忽略（数量）"));
            } else if (helper_config.buffPriceThreshold >= parseFloat(buff_sell_min_price)) {
                $(good).attr("data-buff-sort", Infinity);
                $(target).after($(HIGHLIGHT_TEMPLATE).text("已忽略（价格）"));
            } else {
    ...
    function init() {
        ...
        $("#helper-setting-buffPriceThreshold").val(helper_config.buffPriceThreshold);
