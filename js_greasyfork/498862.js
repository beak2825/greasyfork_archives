// ==UserScript==
// @name              链接智能识别助手
// @namespace         https://github.com/susmouse/urlAI.git
// @version           1.1
// @author            tutrabbit,YouXiaoHou,52fisher
// @description       在“网盘智能识别助手”的基础上添加了识别普通链接的功能
// @license           AGPL-3.0-or -later
// @homepage          https://github.com/susmouse/urlAI.git
// @supportURL        https://github.com/susmouse/urlAI.git
// @match             *://*/*
...
// @downloadURL https://update.greasyfork.org/scripts/498862/%E9%93%BE%E6%8E%A5%E6%99%BA%E8%83%BD%E8%AF%86%E5%88%AB%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/498862/%E9%93%BE%E6%8E%A5%E6%99%BA%E8%83%BD%E8%AF%86%E5%88%AB%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
(function () {
    ...
    let util = {
        clog(c) {
            console.group("%c %c [链接智能识别助手]", `background:url(${GM_info.script.icon}) center center no-repeat;background-size:12px;padding:3px`, "");
            console.log(c);
            console.groupEnd();
        },
    ...
    let main = {
        ...
        parseLink(text = '') {
            ...
            if (text) {
                ...
                // 通用链接识别正则表达式，可供需要自己补充
                let generalLinkReg = /https?:\/\/[^\s")。，；,”]+/g;
                let matches = text.match(generalLinkReg);
