...
// @downloadURL https://update.greasyfork.org/scripts/18574/Kitt.user.js
// @updateURL https://update.greasyfork.org/scripts/18574/Kitt.meta.js
// ==/UserScript==
...
var doublon = '<div class="menu-list"><a href="" onclick="window.open(\'http://kitt.jobillico.com/signalement.php?type=1&amp;crm='+crm+'\', \'_blank\')"><span class="add">'+doubl+'</span></a></div>';
var info = '<div class="menu-list"><a href="" onclick="window.open(\'http://kitt.jobillico.com/signalement.php?type=3&amp;crm='+crm+'\', \'_blank\')"><span class="add">'+mod+'</span></a></div>';
