...
// @downloadURL https://update.greasyfork.org/scripts/406575/MyKirito%20helper%20private.user.js
// @updateURL https://update.greasyfork.org/scripts/406575/MyKirito%20helper%20private.meta.js
// ==/UserScript==
...
//config
var helperConfig = GM_getValue('MyKiritoHelper', { 'yuukiMod': false, 'lisbethMod': false, 'deadMod': false, 'backgroundMOD': false, 'scrolllistMOD':true, 'delay': 300, 'wanted': false, });
var inited = false;
var myK;
var otherK;
...
//以下是webhook網址如果沒更改不要調整

var 通緝17webhook = "https://discordapp.com/api/webhooks/729582208297467956/XSEiYkCgeIloDm4yD_0ro7WdKwUhqzGYIA2LhKivZ10nsxWswM1AuwMZnlkiY2vMG8fS"
var 通緝08webhook = "https://discordapp.com/api/webhooks/729582208297467956/XSEiYkCgeIloDm4yD_0ro7WdKwUhqzGYIA2LhKivZ10nsxWswM1AuwMZnlkiY2vMG8fS"

var 友記全身圖 = "https://i.imgur.com/VWNyCjk.png"

var 死亡圖片 = "https://i.imgur.com/9GBle3E.png"

var 背景圖片網址 = "https://i.imgur.com/dstpJMx.png";
...
//篩選MOD (Sylive 波卡製作) 有問題 窩不知道.jpg
var playerTable;
var allPlayer;
var playerTemp;
    ...
    if(helperConfig.wanted){
       ...
       allPlayer = playerTable.children;
        for(let i = 1 ; i < allPlayer.length ; i++){
            ...
            for(let o = 0 ; o < wantedList.length ; o++){
                if(playerTemp[3].textContent.indexOf(wantedList[o]) >= 0){
                    wanted = true;
                }
            };
            if(!wanted){
...
function init() {
    ...
    tippy(button, {
        ...
        `<p><label><input type="checkbox" id="wanted_mod" ${(helperConfig.wanted)?"checked":""}> 篩選角色(稽查專用)</label></p>`+
        ...
        onShown() {
            if (!inited){
                ...
                document.getElementById("wanted_mod").addEventListener('input', () => { (document.getElementById("wanted_mod").checked) ? helperConfig.wanted = true : helperConfig.wanted = false; });
