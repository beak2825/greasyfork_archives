...
// @name        PTECheat 
// @version     2017.06
// @author      leo7044, modified by Tisi
...
// @downloadURL https://update.greasyfork.org/scripts/30732/PTECheat.user.js
// @updateURL https://update.greasyfork.org/scripts/30732/PTECheat.meta.js
// ==/UserScript==
        ...
        function PTECheatCreate()
        {
            try
            {
                ...
                for (var key in bases)
                {
                    ...
                    /*if (ClientLib.Data.MainData.GetInstance().get_Server().get_WorldId() == 320)
                    {
