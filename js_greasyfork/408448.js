...
// @downloadURL https://update.greasyfork.org/scripts/408448/%E7%95%AA%E7%BB%84%E8%AE%A1%E5%88%92%28bangumi%29%E7%9B%AE%E5%BD%95%E9%A1%B5%E5%A4%9A%E6%A0%87%E7%AD%BE%E7%AD%9B%E9%80%89.user.js
// @updateURL https://update.greasyfork.org/scripts/408448/%E7%95%AA%E7%BB%84%E8%AE%A1%E5%88%92%28bangumi%29%E7%9B%AE%E5%BD%95%E9%A1%B5%E5%A4%9A%E6%A0%87%E7%AD%BE%E7%AD%9B%E9%80%89.meta.js
// ==/UserScript==
...
//max length of a tag from infotip, avoid some crazy long metadata tag
//this makes sure xxxx年xx月xx日 won't be filtered out, as we keep full date as tag
const maxInfoTipTagLength = 12
...
function process(element, isComment){
    ...
    if(isComment){
       ...
       if(year != 0 && month != 0){
           tags = infotip.concat([year+"年",month+"月"])}
       else{
           tags = infotip
       }
