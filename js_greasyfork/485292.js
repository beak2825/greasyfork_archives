...
// @downloadURL https://update.greasyfork.org/scripts/485292/Pistenkov%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/485292/Pistenkov%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.meta.js
// ==/UserScript==
    ...
    content: `[center][font=georgia][size=5][color=rgb(124, 252, 0)]Дополнительные баллы успешно проверены.[/size]<br><br>`+
        ...
        },
         {
            ...
            content:
                ...
                `[SIZE=4][FONT=georgia][CENTER][COLOR=rgb(128, 0, 255)] С уважением Куратор администрации[/COLOR][/FONT][/SIZE][/CENTER]`,
        },
...
<br><br>`+
 ...
 content:
    ...
    {
      title: 'Фиг, Будешь ЗГА получишь скрипт, а пока такой скрипт будет у тебя 😛',
 },
