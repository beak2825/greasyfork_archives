// ==UserScript==
// @name         EarthBound Theme
// @namespace    http://tampermonkey.net/
// @version      0.13
// @description  EarthBound Theme from Nullpomino, adapted for Jstris
// @author       Dan Kruse, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/391892/EarthBound%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/391892/EarthBound%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/rJfSICD.png",32);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/Wa0k7JL.png')";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_lock.wav",abs:1};
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_ready.wav",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_go.wav",abs:1,set:0};
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_died.wav",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_hold.wav",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_move.wav",abs:1,set:0};
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_tspinsingle.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_tspinmini.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_clear1.wav",       //no sound exists for TF
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_tspindouble.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_tspintriple.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_clear4.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_perfectclear.wav", //no sound exists for TF
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_b2b.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_b2b.wav"
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/EB_song1.mp3",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/EB_song1.mp3"
