...
// @description  点击粘贴，点击Input、Textarea编辑框弹图标栏，包括表单提交、空格、换行、退格、粘贴、撤销、重做、全选功能，印象笔记EN-NOTE富文本编辑框，可粘贴自剪切板的内容。
// @author       12style
// @match        http://*/*
// @include      https://*/*
// @include      file:///*
...
// @grant	     GM_info
// @grant        GM_openInTab
// @downloadURL https://update.greasyfork.org/scripts/404914/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E5%85%B7%E2%80%94%E7%82%B9%E5%87%BB%E7%B2%98%E8%B4%B4.user.js
// @updateURL https://update.greasyfork.org/scripts/404914/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E5%85%B7%E2%80%94%E7%82%B9%E5%87%BB%E7%B2%98%E8%B4%B4.meta.js
// ==/UserScript==
...
//        'width:720px!important;' +//宽度换行
    ...
    document.addEventListener('mouseup', function (e) {
        ...
        if (!text && e.target.localName !=='img' && (((document.activeElement.tagName.toLowerCase() === 'input' || document.activeElement.tagName === 'TEXTAREA') && e.target.type !== 'submit' && e.target.type !== 'button' && e.target.type !== 'checkbox') || (document.activeElement.tagName.toLowerCase() === 'en-note' && e.target.localName.toLowerCase() !== 'en-note'))){

            icon.style.top = e.pageY +15 + 'px';//设置鼠标下方距离
            if(e.pageX -70<10)
