...
// @downloadURL https://update.greasyfork.org/scripts/485750/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B%20%D0%BD%D0%B0%20%D0%90%D0%B4%D0%BC%20%D0%B8%20%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/485750/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B%20%D0%BD%D0%B0%20%D0%90%D0%B4%D0%BC%20%D0%B8%20%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F.meta.js
// ==/UserScript==
...
const buttons = [
  ...
  '[CENTER][SIZE=4][I][COLOR=red][FONT=times new roman]Закрыто. [/FONT][/COLOR][/I][/CENTER]',
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]Вы попали на IP читера или злостного нарушителя.[/I][/SIZE][/FONT]<br>" +
        "[I][FONT=times new roman][SIZE=4]Просто смените свой IP адрес и сможете играть, как это сделать посмотрите в интернете..[/SIZE][/FONT][/I][/COLOR]<br><br>" +
  '[CENTER][SIZE=4][I][COLOR=red][FONT=times new roman]Закрыто. [/FONT][/COLOR][/I][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        'Приятной игры на BLACK RUSSIA на сервере Orange.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        '[CENTER][SIZE=4][I][COLOR=red][FONT=times new roman]Закрыто. [/FONT][/COLOR][/I][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    }
