// ==UserScript==
// @name   🌱【免费版】 中国证券投资基金业协会|如需自动下一集、自动换课程等高级功能见收费版本：https://doc.zhanyc.cn/pages/zgzq/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.amac.org.cn/*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/517181/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%20%E4%B8%AD%E5%9B%BD%E8%AF%81%E5%88%B8%E6%8A%95%E8%B5%84%E5%9F%BA%E9%87%91%E4%B8%9A%E5%8D%8F%E4%BC%9A%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpageszgzq.user.js
// @updateURL https://update.greasyfork.org/scripts/517181/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%20%E4%B8%AD%E5%9B%BD%E8%AF%81%E5%88%B8%E6%8A%95%E8%B5%84%E5%9F%BA%E9%87%91%E4%B8%9A%E5%8D%8F%E4%BC%9A%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpageszgzq.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/zgzq/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/index.php")) {
                if (url.includes("a=minecourses0")) {
                    ...
                    if (url.includes("artid=")) plugMain.page_video();

                } else if (url.includes("a=study")) {
                    plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
                } else if (url.includes("a=player")) {
                    plugMain.page_video();
                }
            }
        },
        ...
        async page_videoTop() {
            GM_addValueChangeListener('reloadPage', function (name, old_value, new_value, remote) {
                location.reload();
            })
            GM_addValueChangeListener('updateTitle', function (name, old_value, new_value, remote) {
                $("title").text(new_value.title)
            })
        },
        async page_video() {
            ...
            let timeout = 2;
            if (window === top) {
                await plugMain.waitOf((a) => $(".unit-li").length > 0);
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (!location.href.includes("a=studyDetail") && !location.href.includes('a=player')) {
                        return;
                    }
                    ...
                    let title = `进度：${plugMain.getCurTime().toFixed(0)}/${plugMain
                        .getTotalTime()
                        .toFixed(0)}`;
                    plugMain.setGMData("updateTitle", { time: plugMain.now(), title })
