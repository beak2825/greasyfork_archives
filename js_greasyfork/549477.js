...
// @downloadURL https://update.greasyfork.org/scripts/549477/JIANGYUTING.user.js
// @updateURL https://update.greasyfork.org/scripts/549477/JIANGYUTING.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "LINGYM CAI";
    const NEW_NAME = "JIANG YUTING";
    const NEW_BIRTHDAY = "(**0216)";
    const NEW_EXPIRE_DATE = "2034-03-21";
