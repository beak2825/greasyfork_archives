...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/472381/ChatGPT%E8%87%AA%E5%8A%A8%E6%8E%A5%E4%B8%8A%E6%96%87%E7%BB%A7%E7%BB%AD.user.js
// @updateURL https://update.greasyfork.org/scripts/472381/ChatGPT%E8%87%AA%E5%8A%A8%E6%8E%A5%E4%B8%8A%E6%96%87%E7%BB%A7%E7%BB%AD.meta.js
// ==/UserScript==
    ...
    const observer = new MutationObserver(function(mutations) {
        ...
        if (autoSendFlag) {
            ...
            if (!button || button.querySelector('div').textContent.trim() != "Stop generating") {
                const markdownContainer = document.querySelector('.markdown.prose');
                const lastElement = markdownContainer.lastElementChild;
                if (lastElement && (!/。$/.test(lastElement.textContent.trim()) || /接下来/.test(lastElement.textContent))) {
                    setTimeout(function () {
