// ==UserScript==
// @name         KEMEROVO | Скрипт для ЗГКФ by N.Stuart
// @namespace    https://forum.blackrussia.online/
// @version      3.0
// @description  Скрипт для ответа на жалобы игроков | Black Russia KEMEROVO
// @author       Nikita_Stuart
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license      MIT
// @icon https://icons.iconarchive.com/icons/papirus-team/papirus-apps/48/emerald-theme-manager-icon-icon.png
// @downloadURL https://update.greasyfork.org/scripts/495625/KEMEROVO%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%97%D0%93%D0%9A%D0%A4%20by%20NStuart.user.js
// @updateURL https://update.greasyfork.org/scripts/495625/KEMEROVO%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%97%D0%93%D0%9A%D0%A4%20by%20NStuart.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
       {
        title: 'Приветствие',
        content:
            '[IMG width="998px"]https://i.postimg.cc/D0btkSqL/4890d55ffa506873b57feb833f6c92cc-1.gif[/IMG]<br>' +
            '[CENTER][IMG width="534px"]https://i.postimg.cc/0ymgWkmh/RLwzo.png[/IMG]<br>' +
            '[SIZE=4][B] Доброго времени суток.[/B][/SIZE]<br><br>',
        },
        {
            ...
            '[CENTER][IMG width="534px"]https://i.postimg.cc/0ymgWkmh/RLwzo.png[/IMG]<br>' +
            '[SIZE=4][B] Доброго времени суток.[/B][/SIZE]<br><br>' +
            '[B][SIZE=4]Ваша жалоба взята [COLOR=rgb(255, 240, 0)]на рассмотрение[/COLOR].<br>' +
            'Ожидайте вердикт.[/SIZE][/B]<br><br>' +
            '[SIZE=4][SIZE=4][B][COLOR=rgb(32, 80, 250)]С уважением, Заместитель Главного Куратора форума.[/COLOR][/B][/SIZE][/SIZE][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
          },
          {
            title: 'DeathMatch',
            content:
             '[CENTER][IMG width="428px"]https://i.postimg.cc/cL0pkbqd/N9NgK.png[/IMG][/CENTER]<br>' +
             '[CENTER][I][FONT=]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/FONT][/I][/CENTER]' +
              "[I][CENTER][FONT=]Нарушитель буден наказан по следующему пункту общих правил серверов:[/FONT][/CENTER][/I]<br><br>" +
              "[HR][/HR]" +
              "[I][CENTER][COLOR=rgb(255, 0, 0)][FONT=]2.19.[/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=] Запрещен DM (DeathMatch) — убийство или нанесение урона без веской IC причины[/COLOR][COLOR=rgb(255, 0, 0)] | Jail 60 минут[/FONT][/I][/COLOR][/CENTER]<br>" +
              "[LEFT][I][FONT=][COLOR=rgb(255, 0, 0)]- Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]разрешен ответный DM в целях защиты, обязательно иметь видео доказательство в случае наказания администрации, нанесение урона по транспорту также является нарушением данного пункта правил.[/COLOR][/FONT][/I][/LEFT]<br>" +
              "[LEFT][I][FONT=][COLOR=rgb(255, 0, 0)]- Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]нанесение урона с целью защиты особняка или его территории, а также нанесение урона после ДТП не является веской IC причиной, для войны семей предусмотрено отдельное системное мероприятие.[/COLOR][/FONT][/I][/LEFT]<br>",
          ...
          },
          {
            title: 'Cheat',
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
              ...
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Приятной игры на BLACK RUSSIA KEMEROVO [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4]Role Play[/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              "[CENTER][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.20. [/COLOR][COLOR=rgb(209, 213, 216)]Запрещен Mass DM (Mass DeathMatch) — убийство или нанесение урона без веской IC причины трем игрокам и более[/COLOR][COLOR=rgb(255, 0, 0)] | Warn / Ban 3 - 7 дней[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
          ...
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил госс организаций:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
              "[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=book antiqua]6.01. [/FONT][/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4][FONT=book antiqua]Запрещено наносить урон игрокам без Role Play причины на территории госс.[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=book antiqua] | Ban 7 дней / PermBan [/FONT][/SIZE][/COLOR]<br><br>" +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Приятной игры на BLACK RUSSIA KEMEROVO [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4]Role Play[/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
              '[url=https://postimages.org/][img]https://i.yapx.cc/QY7Mg.gif[/img][/url]',
            prefix: ACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[IMG width="998px"]https://i.postimg.cc/D0btkSqL/4890d55ffa506873b57feb833f6c92cc-1.gif[/IMG]<br>' +
            '[CENTER][IMG width="534px"]https://i.postimg.cc/0ymgWkmh/RLwzo.png[/IMG]<br>' +
            '[SIZE=4][B][SIZE=4] Доброго времени суток.[/SIZE]<br>' +
            'Жалоба [COLOR=rgb(97, 189, 109)]одобрена[/COLOR], игрок получит наказание по следующему пункту общих правил проекта:[/B][/SIZE][/CENTER]<br>' +
            '[HR][/HR]<br>' +
            '[SIZE=4][B][COLOR=rgb(255, 0, 0)]2.19. [/COLOR]Запрещено оскорбление или косвенное упоминание родных вне зависимости от чата (IC или OOC) | [COLOR=rgb(255, 0, 0)]Mute 120 минут / Ban 7 - 15 дней[/COLOR][/B][/SIZE]<br>' +
            '[LIST]<br>' +
            '[*][SIZE=4][B][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] термин «MQ» расценивается, как упоминание родных.[/B][/SIZE]<br>' +
            '[*][SIZE=4][B][COLOR=rgb(255, 0, 0)]Исключение: [/COLOR]если упоминание родных было совершено в ходе Role Play процесса и не содержало в себе прямого или завуалированного оскорбления.[/B][/SIZE]<br>' +
            '[/LIST]<br>' +
            '[HR][/HR]<br><br>' +
            '[CENTER][SIZE=4][B][SIZE=4][SIZE=4][SIZE=4][B][COLOR=rgb(32, 80, 250)]С уважением, Заместитель Главного Куратора форума.[/COLOR][/B][/SIZE][/SIZE][/SIZE][/B][/SIZE][/CENTER]<br>',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
          ...
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]Данный промокод является системным, или был выпущен  разработчиками[/I][/SIZE][/FONT]<br><br>" +
             "[I][FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
          ...
          {
            title: '_________________________________Наказание за NonRp________________________________________'
          },
          {
            title: 'NRP обман',
            content:
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Нарушитель буден наказан по общим правилам ограблений и похищений.[/SIZE][/FONT][/COLOR]<br><br>" +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Приятной игры на BLACK RUSSIA KEMEROVO [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4]Role Play[/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
              '[url=https://postimages.org/][img]https://i.yapx.cc/QY7Mg.gif[/img][/url]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Нарушитель буден наказан по следующему пункту правил государственных структур:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Нарушитель буден наказан по следующему пункту правил государственных структур:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
              "[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]8.06. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещено проводить обыск игрока без Role Play отыгровки.[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Warn[/SIZE][/COLOR][/FONT]<br><br>" +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Приятной игры на BLACK RUSSIA KEMEROVO [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4]Role Play[/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
              '[url=https://postimages.org/][img]https://i.yapx.cc/QY7Mg.gif[/img][/url]',
            prefix: ACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Нарушитель буден наказан по следующему пункту правил нападения на военную часть:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
          ...
          },
          {
           ...
           {
            title: 'NonRp обман донат/не донат',
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Теперь цена всех машин снижена до уровня донатных, в том числе тех, что куплены в салоне или получены из контейнера.[/I][/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
            status: false,
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]На данный момент существует некая техническая проблема, по которой у игрока может не отниматься здоровье.<br>Приносим свои извинения за неудобство[/I][/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             "[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=][I]Закрыто.[/I][/FONT][/SIZE][/COLOR]<br><br>" +
             '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
           },
           {
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][I][FONT=][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 102, 0)][I][FONT=][SIZE=4]Техническому Специалисту[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
             "[FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
            prefix: TEX_PREFIX,
            status: true,
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][I][FONT=][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=][SIZE=4]Главному администратору[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(209, 213, 216)][I][FONT=][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
             "[FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию - [/I][URL='https://forum.blackrussia.online/index.php?forums/Жалобы-на-администрацию.1442/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
              "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
              "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
            ...
            },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров - [/I][URL='https://forum.blackrussia.online/index.php?forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.351/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://sun9-13.userapi.com/c627229/v627229095/1dbf2/niBXXem02v4.jpg[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Вы ошиблись разделом, обратитесь в раздел жалоб на Агентов поддержки - [/I][URL='https://forum.blackrussia.online/index.php?threads/ekb-Жалобы-на-Агентов-Поддержки.4295218/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
              "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
              "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
              '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
             prefix: UNACCEPT_PREFIX,
             status: false,
            },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Обратитесь в раздел на сотрудников фракции. [/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Вы ошиблись разделом, обратитесь в раздел Обжалование наказаний - [/I][URL='https://forum.blackrussia.online/index.php?forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.351/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
            prefix: UNACCEPT_PREFIX,
           ...
           {
            title: '_________________________________Доказательства________________________________________',
           },
           {
            title: 'Недостаточно док-в',
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]Недостаточно доказательств для корректного рассмотрения вашей жалобы.[/I][/SIZE][/FONT]<br><br>" +
             "[I][FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Отсутствуют доказательства - следовательно, рассмотрению не подлежит. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее.[/I][/FONT][/SIZE]<br><br>" +
             "[I][FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]]Ваши доказательства не рабочие или же битая ссылка.[/I][/SIZE][/FONT]<br><br>" +
             "[I][FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]Доказательства были подвергнуты редактированию - следовательно, рассмотрению не подлежит.<br><br>" +
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]Ваша видеозапись обрывается. Загрузите полную видеозапись на видео-хостинг YouTube.<br><br>" +
            "Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
            "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Доказательства в социальных сетях и т.д. не принимаются. Загрузите доказательства на фото-видео хостинги YouTube,Imgur, Yapx и так далее.[/I][/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]В данной ситуации обязательнодолжен быть фрапс(видео фиксация)всех моментов.[/I][/SIZE][/FONT]<br><br>" +
             "[I][FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]Видео фиксация не полная либо же нет условий сделки.[/I][/SIZE][/FONT]<br><br>" +
             "[I][FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]На доказательствах отсутствуют дата и время [/I]([/SIZE][/FONT][FONT=courier new][SIZE=4]/time[/SIZE][/FONT][FONT=][SIZE=4])[I] - следовательно, рассмотрению не подлежит.<br><br>" +
             "Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Ваша жалоба отказана, т.к в ней нету таймкодов. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений.[/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
             "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
             prefix: UNACCEPT_PREFIX,
             status: false,
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]В предоставленных доказательствах отсутствуют условия сделки.[/I][/SIZE][/FONT]<br><br>" +
             "[I][FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]Нарушений со стороны игрока не было замечено.<br><br>" +
           ...
           },
           {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Ваш заголовок составлен не по форме. Внимательно прочтите правила создания темы, прикрепленные в этом разделе.[/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
             "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]Игрок будет наказан по пунтку правил: 4.10. Запрещено создавать никнейм, повторяющий или похожий на существующие никнеймы игроков или администраторов по их написанию | Устное замечание + смена игрового никнейма / PermBan[/I][/SIZE][/FONT]<br><br>" +
             "[I][FONT=][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://i.yapx.cc/QY7Mg.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Ваша жалоба отказана по причине: нельзя писать одну жалобу на двух и белее игроков ( на каждого игрока отдельная жалоба)[/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Ваша жалоба составлена не по форме. Внимательно прочитайте правила подачи жалоб на игроков, закрепленные в этом разделе.[/I][/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
             "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Приятной игры на BLACK RUSSIA KEMEROVO [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4]Role Play[/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Ваша жалоба отказана, т.к нарушитель уже был наказан ранее.[/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
             "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Ваша жалоба отказана, т.к ранее уже был дан ответ.[/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
             "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            status: false,
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Ваша жалоба отказана, т.к с момента нарушения прошло более 72-ух часов.[/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
             "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=][I]Ваша жалоба отказана, т.к она написана от 3-его лица.[/FONT][/SIZE]<br><br>" +
             "[FONT=][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
             "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
             '[url=https://postimages.org/][img]https://s4.hostingkartinok.com/uploads/images/2013/05/1a612be953e1187f103dc4ae3f1d2b32.gif[/img][/url]',
            prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Ваш заголовок составлен не по форме. Внимательно прочтите правила создания темы, прикрепленные в этом разделе.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/CENTER][/B][/COLOR]<br>" +
              '[CENTER][url=https://postimages.org/][img]https://media.discordapp.net/attachments/1115566790790098944/1115572345684381786/standard.gif[/img][/url][/CENTER]',
           prefix: UNACCEPT_PREFIX,
           status: false,
          },
          {
          ...
          },
          {
           ...
           '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
              '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
               "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
              "[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=book antiqua]2.57[/FONT][/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4][FONT=book antiqua] Запрещается брать в долг игровые ценности и не возвращать их.[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]|Ban 30 дней / permban [/FONT][/SIZE][/COLOR]<br><br>"+
              "[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Займ может быть осуществлен только через зачисление игровых ценностей на банковский счет, максимальный срок займа 30 календарных дней, если займ не был возвращен, аккаунт должника блокируется;[/SIZE][/FONT][/COLOR]<br><br>" +
              "[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]При невозврате игровых ценностей общей стоимостью менее 5 миллионов включительно аккаунт будет заблокирован на 30 дней, если более 5 миллионов, аккаунт будет заблокирован навсегда; [/SIZE][/FONT][/COLOR]<br><br>" +
              "[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Жалоба на игрока, который занял игровые ценности и не вернул в срок, подлежит рассмотрению только при наличии подтверждения суммы и условий займа в игровом процессе, меры в отношении должника могут быть приняты только при наличии жалобы и доказательств. Жалоба на должника подается в течение 10 дней после истечения срока займа. Договоры вне игры не будут считаться доказательствами.[/SIZE][/FONT][/COLOR]<br><br>" +
               "[I][COLOR=rgb(209, 213, 216)][FONT=][SIZE=4]Приятной игры на BLACK RUSSIA KEMEROVO [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4]Role Play[/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
            '[url=https://postimages.org/][img]https://i.yapx.cc/QY7Mg.gif[/img][/url]',
            prefix: ACCEPT_PREFIX,
            status: false,
          ...
          {
              title: '____________________________________RolePlay биографии____________________________________________',
          },
          {
           title: 'Одобрена',
           content:
           '[CENTER][SIZE=4][B]{{ greeting }}, уважаемый {{ user.name }}.[/B][/SIZE]<br><br>' +
            "[CENTER][SIZE=4][B]Ваша RolePlay биография одобрена.[/B][/SIZE][/CENTER]<br><br>" +
            "[CENTER][SIZE=4][B]Приятной игры на BLACK RUSSIA KEMEROVO [/B][COLOR=rgb(0, 140, 240)]RolePlay[/COLOR][/SIZE][COLOR=rgb(0, 140, 240)][SIZE=4].[/SIZE][/COLOR][/CENTER]<br><br>" +
            '',
           prefix: ACCEPT_PREFIX,
           status: false,
          },
          {
           ...
           content:
           '[CENTER][IMG width="428px"]https://i.postimg.cc/cL0pkbqd/N9NgK.png[/IMG][/CENTER]<br>' +
            "[CENTER][SIZE=4][B][FONT=][I]{{ greeting }}, уважаемый(-ая) {{ user.name }}.[/I][/FONT][/SIZE][/CENTER]<br>" +
            "[CENTER][SIZE=4][B][FONT=][I]24 часа на доработку вышли.[/I][/FONT][/SIZE][/CENTER]<br>" +
            "[CENTER][SIZE=4][B][FONT=][I]Ваша RolePlay биография [COLOR=rgb(255, 0, 0)]отклонена[/COLOR]. [/I][/FONT][/B][/SIZE][/CENTER]<br><br>" +
            "[CENTER][SIZE=4][B][FONT=][I][COLOR=rgb(255, 240, 0)]Приятного времяпровождения.[/COLOR]. [/I][/FONT][/B][/SIZE][/CENTER]<br>" +
            '',
           prefix: UNACCEPT_PREFIX,
           status: false,
          },
          {
            ...
            content:
            '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
             "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана, Добавьте больше информации в новой RolePlay биографии.[/COLOR]<br><br>" +
           ...
           },
        {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она составлена не по форме. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к вы ее не дополнили. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она оформлена неграмотно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она написана от 3-его лица. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она уже была одобрена. [/COLOR]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
           status: false,
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к вы приписали суперспособности своему персонажу. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к вы ее скопировали у другого человека.[/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к у вас NonRP NickName. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к ваш NickName должен быть написан на русском языке. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          {
           title : 'Дата рождения отличн. с годом'  ,
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к дата рождения не совпадает с возрастом. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к ваша семья расписана не полностью. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к ваша дата рождения расписана не полностью. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            "[FONT=][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]<br><br>" +
            '[url=https://postimages.org/][img]https://img-host.ru/BQB3y.png[/img][/url]',
           prefix: UNACCEPT_PREFIX,
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]В вашей RolePlay - биографии недостаточно информации.<br><br>" +
          ...
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация одобрена.[/COLOR][/I][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
           prefix: ACCEPT_PREFIX,
           status: false,
          },
          {
           ...
           content:
           '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация отказана т.к вы не туда попали. [/COLOR]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
           prefix: UNACCEPT_PREFIX,
           status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация отказана т.к она составлена не по форме. [/COLOR]<br><br>"+
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация отказана. [/COLOR]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]В вашей RolePlay - организации недостаточно информации.<br><br>" +
            "Даю вам 24 часа на ее дополнение.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
           '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: PIN_PREFIX,
          status: true,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация отказана т.к ваш все никнеймы должны быть написаны на русском языке. [/COLOR]<br><br>" +
         ...
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организаций отказана т.к она оформлена неграмотно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация отказана т.к вы ее скопировали у другого человека. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация отказана т.к вы ее не дополнили. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - организация отказана т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         ...
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация одобрена.[/COLOR][/I][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: ACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к вы не туда попали. [/COLOR]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к она составлена не по форме. [/COLOR]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана. [/COLOR]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][FONT=][SIZE=4][I]В вашей RolePlay - ситуации недостаточно информации.<br><br>" +
            "Даю вам 24 часа на ее дополнение.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: PIN_PREFIX,
          status: true,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к ваш все никнеймы должны быть написаны на русском языке. [/COLOR]<br><br>" +
         ...
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к она оформлена неграмотно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к вы ее скопировали у другого человека. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к вы ее не дополнили. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         },
         {
          ...
          content:
          '[COLOR=rgb(0, 255, 127)][FONT=][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA KEMEROVO [/I][/COLOR][I][COLOR=rgb(0, 140, 240)]Role Play[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(0, 140, 240)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
