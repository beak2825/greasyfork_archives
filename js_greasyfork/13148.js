...
// @grant          GM_setValue
// @version        0.5.6.2
// @downloadURL https://update.greasyfork.org/scripts/13148/E-Hentai%20Highlighter-Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/13148/E-Hentai%20Highlighter-Mod.meta.js
// ==/UserScript==
...
var EHH = {
    ...
    init: function() {
        ...
        style.innerHTML = format(
            ...
            '.e-Highlighted, .e-Highlighted a, [id^="ta_"][style*="background"] {  !important; }' +
    ...
    generatePopup: function() {
        ...
        else picker.style.cssText = 'width: 60px';
    ...
    walk: function(root) {
        ...
        targets.forEach(function(target) {
            ...
            target.style.cssText = target.style.cssText.replace(/(background-color|order):.+?;/g,'');
