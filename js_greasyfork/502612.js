// ==UserScript==
// @name   🌱【免费版】【良师在线系列】武汉科技大学|湖北师范大学|付费版本可秒过+答题，如需高级收费版本见文档：https://doc.zhanyc.cn/pages/lszx/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.2
// @description  当前使用的是免费版本，仅包含视频页面全自动播放功能，广告：如需秒过、自动换课程、自动答题、自动考试等高级功能，可购买付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    https://*.ls365.net/*
// @include    https://*.ls365.cn/*
// @include    https://*.ls365.com/*
// @include    https://*.ls365.com.cn/*
// @include    https://*.ynlhxy.com/*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/502612/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E3%80%90%E8%89%AF%E5%B8%88%E5%9C%A8%E7%BA%BF%E7%B3%BB%E5%88%97%E3%80%91%E6%AD%A6%E6%B1%89%E7%A7%91%E6%8A%80%E5%A4%A7%E5%AD%A6%7C%E6%B9%96%E5%8C%97%E5%B8%88%E8%8C%83%E5%A4%A7%E5%AD%A6%7C%E4%BB%98%E8%B4%B9%E7%89%88%E6%9C%AC%E5%8F%AF%E7%A7%92%E8%BF%87%2B%E7%AD%94%E9%A2%98%EF%BC%8C%E5%A6%82%E9%9C%80%E9%AB%98%E7%BA%A7%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccnpageslszx.user.js
// @updateURL https://update.greasyfork.org/scripts/502612/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E3%80%90%E8%89%AF%E5%B8%88%E5%9C%A8%E7%BA%BF%E7%B3%BB%E5%88%97%E3%80%91%E6%AD%A6%E6%B1%89%E7%A7%91%E6%8A%80%E5%A4%A7%E5%AD%A6%7C%E6%B9%96%E5%8C%97%E5%B8%88%E8%8C%83%E5%A4%A7%E5%AD%A6%7C%E4%BB%98%E8%B4%B9%E7%89%88%E6%9C%AC%E5%8F%AF%E7%A7%92%E8%BF%87%2B%E7%AD%94%E9%A2%98%EF%BC%8C%E5%A6%82%E9%9C%80%E9%AB%98%E7%BA%A7%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccnpageslszx.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = "当前使用的是免费版本，仅包含视频页面全自动播放功能，如需秒过、自动换课程、自动答题、自动考试等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/lszx/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (location.href.indexOf("University/course/play") != -1) {
                plugMain.listenerVideoReady();
                plugMain.listenerNextBtn();
            } else if (
                location.href.indexOf("University/User/Student/mycourselist.aspx") !=
                -1 ||
                location.href.includes("University/User/Student/ExaminationQuery.aspx")
            ) {

                plugMain.showPaidContent(`免费版本不包含自动换课程功能，如需使用请安装收费版本`);
            } else if (location.href.indexOf("/Student/dohomework") != -1) {
                plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
            } else if (
                location.href.indexOf("University/User/Student/ViewPaper") != -1
            ) {
                plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
            } else if (location.href.indexOf("Examination/student/examing") != -1) {
                plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
            } else if (location.href.indexOf("User/Student/myhomework.") != -1) {
                plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
            } else if (location.href.indexOf("User/Student/myhomework_after") != -1) {
                plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
            }
        },
        ...
        listenerNextBtn() {
            setInterval(() => {
                if ($("#learnNextSection:visible").length > 0) {
                    $("#learnNextSection:visible")[0].click();
                } else if ($("#tipResult:visible").length > 0) {
                    plugMain.showPaidContent(`免费版本不包含自动换课功能，如需使用请安装收费版本`);
                }
            }, 5000);
        },
        async listenerVideoReady() {
            plugMain.setGMData("closeLJTS", plugMain.now());
            await plugMain.waitOf((a) => $(".percentTags").length > 0);
            await plugMain.waitTimeout(1000);

            plugMain.showPaidContent(`免费版本不包含视频秒过功能，如需使用请安装收费版本`);
            if ($(".percentTags img").not(`[data-full="1"]`).length == 0) {
                plugMain.alertMsg("当前课程已经完成，等待进入下一步")
                plugMain.showPaidContent(`免费版本不包含自动换课功能，如需使用请安装收费版本`);
                return;
            }
            let lastTime = 0;
            let interval = 1500;
            let index2 = setInterval(() => {
            ...
            let index = setInterval(() => {
                ...
                if ($("#iframeHolder").length > 0) {
                    ...
                    plugMain.showPaidContent(`免费版本不包含自动完成文档课程功能，如需使用请安装收费版本`);

                }
                if (plugMain.getVideo().length == 0) {
                    console.log("no video");
                    return;
                }
                if (plugMain.getTotalTime() != 0 && plugMain.getCurTime() == lastTime) {
                    let tempTime = plugMain.getCurTime();
                    setTimeout(() => {
                        if (plugMain.getCurTime() == tempTime) {
                            plugMain.play();
                        }
                    }, 1500);
                }
        ...
        getVideo() {
            return $("video").not("#face-input");
        },
        getCurTime() {
            let res = 0;
            try {
                res = plugMain.getVideo()[0].currentTime;
            } catch (e) {
                console.error(e);
            }
            return res;
        ...
        getTotalTime() {
            let res = 0;
            try {
                res = plugMain.getVideo()[0].duration;
            } catch (e) {
                console.error(e);
            }
            return res;
