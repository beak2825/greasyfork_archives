// ==UserScript==
// @name         FIRE Theme (Shellshock.io)
// @namespace    http://tampermonkey.net/
// @version      0.42
// @description  Become a FLAME!
// @author       Blizzard
...
// @grant        none
// @lisense MIT
// @downloadURL https://update.greasyfork.org/scripts/445134/FIRE%20Theme%20%28Shellshockio%29.user.js
// @updateURL https://update.greasyfork.org/scripts/445134/FIRE%20Theme%20%28Shellshockio%29.meta.js
// ==/UserScript==
...
* {
	...
	--ss-lightoverlay: url("https://media.discordapp.net/attachments/971968138751123476/971988895094964224/kkl.jpg"); /*Main Background*/
	...
	--ss-me-player-bg: url(https://c.tenor.com/AaPeZRxwOuQAAAAM/fire-flames.gif);
...
#logo {
  background-image: url('https://media.discordapp.net/attachments/971968138751123476/971981122516963378/fieee.png');
...
#healthHp {https://pngtree.com/freepng/orange-red-flame-flame-clipart_5566526.html
...
#maskmiddle {
	background: url('https://media.discordapp.net/attachments/971968138751123476/971982663227437086/fire_scope.png') center center no-repeat;
...
.egg_icon {
    ...
    content: url(https://clipart.world/wp-content/uploads/2020/08/flame-png-transparent.png);
}

#killBox::before{
  font-size: 1.4em;
  font-weight: 900;
  content: '🔥YOU BURNED🔥 '!important;
  color: blue;
  }
#killBox h3{
  display:none;
...
#deathBox::before{
  font-size: 1.4em;
  font-weight: 900;
  content: 'YOU GOT 🔥BURNED🔥  BY'!important;
  color: blue;
}
