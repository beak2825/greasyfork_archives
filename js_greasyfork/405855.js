...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/405855/%E5%8E%BB%E4%BD%A0%E5%A4%A7%E7%88%B7%E7%9A%84%E9%97%B2%E9%B1%BC%E5%8F%A3%E4%BB%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/405855/%E5%8E%BB%E4%BD%A0%E5%A4%A7%E7%88%B7%E7%9A%84%E9%97%B2%E9%B1%BC%E5%8F%A3%E4%BB%A4.meta.js
// ==/UserScript==
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["FuckXyCode"] = factory();
	else
		root["FuckXyCode"] = factory();
})(window, function() {
...
/***/ "./node_modules/iclipboard/esm/copy.js":
/*!*********************************************!*\
  !*** ./node_modules/iclipboard/esm/copy.js ***!
  \*********************************************/
...
/***/ "./node_modules/iclipboard/esm/index.js":
/*!**********************************************!*\
  !*** ./node_modules/iclipboard/esm/index.js ***!
  \**********************************************/
/*! exports provided: copy */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _copy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./copy */ "./node_modules/iclipboard/esm/copy.js");
...
/*!**********************!*\
  !*** ./src/Index.ts ***!
  \**********************/
/*! exports provided: FuckXianyuCode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FuckXianyuCode", function() { return FuckXianyuCode; });
/* harmony import */ var iclipboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! iclipboard */ "./node_modules/iclipboard/esm/index.js");
...
var FuckXianyuCode = /** @class */ (function () {
    function FuckXianyuCode() {
        var _this = this;
        this.replaceXianyuCode = function () {
            var text = document.body.innerText;
            var tkl = text.match(/[$|€|¥|₰][A-Za-z0-9]+[$|€|¥|₰]/g);
            tkl && tkl.length > 0 && tkl.forEach(function (x) {
                if (fetch) {
                    fetch("https://jckhj8su.demo.wood-is.top/tkl/tkljm?apikey=ZwuJXDIBef&tkl=" + x).then(function (res) {
                        res.json().then(function (data) {
                            var content = data.content, url = data.url;
                            document.body.innerHTML = document.body.innerHTML.replace(x, "<span title=\"" + content + "\" onclick=\"fuckXyCode.alertXianyuModal('" + url + "')\" style=\"color: red; padding: 0 .5em; font-weight: 500; cursor: pointer;\">" + x + "</span>");
                        });
                    });
                }
            });
        };
        this.alertXianyuModal = function (url) {
            var viewDom = document.getElementById("viewGoods");
        ...
        this.copyUrl = function (url) {
            if (Object(iclipboard__WEBPACK_IMPORTED_MODULE_0__["copy"])(url)) {
        ...
        this.showToast = function (msg, duration) {
            ...
            m.innerHTML = msg;
            m.style.cssText = "box-shadow: 1px 1px 4px rgba(0,0,0,0.5);font-size: .32rem;color: black;background-color: white;padding: 10px 15px;margin: 0 0 0 -60px;border-radius: 4px;position: fixed;    top: 50%;left: 50%;width: 130px;text-align: center;";
        ...
        this.showQrCode = function (url) {
            var qrcodeEle = document.createElement("div");
            qrcodeEle.setAttribute("id", "fkxyQrcode");
            qrcodeEle.innerHTML = "<div style=\"width: 60px; color: white; background: red; cursor: pointer; padding: .5em\" onclick=\"fuckXyCode.closeQrcode()\">\u5173\u95ED</div>";
            qrcodeEle.style.cssText = "position: fixed;bottom: 10em;right: 450px;text-align: center;";
            qrcode__WEBPACK_IMPORTED_MODULE_1___default.a.toCanvas(url, { errorCorrectionLevel: 'L' }, function (err, canvas) {
                if (err)
                    throw err;
                qrcodeEle.appendChild(canvas);
                document.body.appendChild(qrcodeEle);
            });
        };
        this.closeQrcode = function () {
            var _a;
            (_a = document.getElementById("fkxyQrcode")) === null || _a === void 0 ? void 0 : _a.remove();
        };
        this.replaceXianyuCode();
    }
    return FuckXianyuCode;
}());
...
window.fuckXyCode = new FuckXyCode.FuckXianyuCode()