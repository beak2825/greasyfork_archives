// ==UserScript==
// @name         SCRIPT | Быстрый доступ | VERSION = Hellsing - VOLGOGRAD | CONFIGURATION - SUPPORT
// @namespace    http://tampermonkey.net/
// @version      1.01
// @description  Быстрый доступ для форума | Конфигурация: АП
...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/516731/SCRIPT%20%7C%20%D0%91%D1%8B%D1%81%D1%82%D1%80%D1%8B%D0%B9%20%D0%B4%D0%BE%D1%81%D1%82%D1%83%D0%BF%20%7C%20VERSION%20%3D%20Hellsing%20-%20VOLGOGRAD%20%7C%20CONFIGURATION%20-%20SUPPORT.user.js
// @updateURL https://update.greasyfork.org/scripts/516731/SCRIPT%20%7C%20%D0%91%D1%8B%D1%81%D1%82%D1%80%D1%8B%D0%B9%20%D0%B4%D0%BE%D1%81%D1%82%D1%83%D0%BF%20%7C%20VERSION%20%3D%20Hellsing%20-%20VOLGOGRAD%20%7C%20CONFIGURATION%20-%20SUPPORT.meta.js
// ==/UserScript==
...
(function() {
    ...
    const ButtonServerForum = document.createElement("button");
    ...
    const ButtonMarket = document.createElement("button:");
    const ButtonHelpersRazdel = document.createElement("button");

    ButtonServerForum.textContent = "39 сервер";
    ...
    ButtonZayavki.textContent = "Заявки на АП";
    ButtonMarket.textContent = "  Маркет адм  ";
    ButtonHelpersRazdel.textContent = "АП раздел";

    bgButtons.append(ButtonServerForum, ButtonAdmRazdel, ButtonZhbIgroki, ButtonObj, ButtonZhbAdm, ButtonZayavki, ButtonMarket, ButtonHelpersRazdel,);

    const buttons = [ButtonServerForum, ButtonAdmRazdel, ButtonZhbIgroki, ButtonObj, ButtonZhbAdm, ButtonZayavki, ButtonMarket, ButtonHelpersRazdel,];
    ...
    ButtonServerForum.addEventListener("click", () => {
        window.location.href = 'https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9639-volgograd.1759/';
    });
    ...
    ButtonMarket.addEventListener("click", () => {
        window.location.href = "https://forum.blackrussia.online/threads/volgograd-marketplays.10022631/page-199";
    });

    ButtonZayavki.addEventListener("click", () => {
        window.location.href = "https://forum.blackrussia.online/forums/%D0%90%D0%B3%D0%B5%D0%BD%D1%82%D1%8B-%D0%BF%D0%BE%D0%B4%D0%B4%D0%B5%D1%80%D0%B6%D0%BA%D0%B8.3077/?prefix_id=1&last_days=7";
    });

    ButtonHelpersRazdel.addEventListener("click", () => {
        window.location.href = "https://forum.blackrussia.online/forums/%D0%A0%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-%D0%B4%D0%BB%D1%8F-%D0%B0%D0%B3%D0%B5%D0%BD%D1%82%D0%BE%D0%B2-%D0%BF%D0%BE%D0%B4%D0%B4%D0%B5%D1%80%D0%B6%D0%BA%D0%B8.1768/";
    });
