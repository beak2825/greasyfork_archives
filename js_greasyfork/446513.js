...
// @version     1.17 //Modified to include Newsfeed and Mobile by Spacedcake
// @author      -
...
// @grant       GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/446513/Facebook%20Cleaner.user.js
// @updateURL https://update.greasyfork.org/scripts/446513/Facebook%20Cleaner.meta.js
// ==/UserScript==
...
let options = {
  ...
  hideNewsfeedM: true,// Mobile facebook options for m.facebook.com
  hideStoriesM: true,
  hideTopNavWatchM: true
...
function removeOnce() {
  ...
  `;
     let cssNewsfeedM = `
    div[id="MFirstBatch"] { /* News Feed Mobile */
      visibility: hidden !important;
    }
  `;
     let cssStoriesM = `
    div[id="MStoriesTray"] { /* Stories Mobile */
      visibility: hidden !important;
    }
  `;
     let cssTopNavWatchM = `
    div[id="videos_tab_jewel"] { /* Stories Mobile */
      visibility: hidden !important;
    }
  `;
  ...
  if(options.hideNewsfeed) { GM_addStyle(cssNewsfeed); }
  if(options.hideNewsfeedM) { GM_addStyle(cssNewsfeedM); }
  if(options.hideStoriesM) { GM_addStyle(cssStoriesM); }
  if(options.hideTopNavWatchM) { GM_addStyle(cssTopNavWatchM); }
