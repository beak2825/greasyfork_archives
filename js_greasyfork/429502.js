// ==UserScript==
// @name         PUBG 在家领取每日礼包(更改时间)
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  PUBG 绝地求生 网吧活动202107 在家领取每日礼包
// @author       moonrailgun
// @match        *://cafe.playbattlegrounds.com/act/a20210623pubg/nonNetbarIndex*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/429502/PUBG%20%E5%9C%A8%E5%AE%B6%E9%A2%86%E5%8F%96%E6%AF%8F%E6%97%A5%E7%A4%BC%E5%8C%85%28%E6%9B%B4%E6%94%B9%E6%97%B6%E9%97%B4%29.user.js
// @updateURL https://update.greasyfork.org/scripts/429502/PUBG%20%E5%9C%A8%E5%AE%B6%E9%A2%86%E5%8F%96%E6%AF%8F%E6%97%A5%E7%A4%BC%E5%8C%85%28%E6%9B%B4%E6%94%B9%E6%97%B6%E9%97%B4%29.meta.js
// ==/UserScript==
...
$(function() {
    ...
    function getGift(giftId) {
        ...
        $.ajax({
            url: '/act/a20210623pubg/index?ticket',
            type: 'POST',
            dataType: 'json',
            data: { giftId: giftId },
    ...
    function main() {
        fetch(`index`).then(function(response) {
            ...
            var params = html.match(/index?ticket\((\d*?)\)/);
            var giftId = params[1];
