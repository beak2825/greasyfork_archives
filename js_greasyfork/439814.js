// ==UserScript==
// @name         ShonenmagazineSpider
// @namespace    https://pocket.shonenmagazine.com/
// @version      0.1
// @description  Image spider for pocket.shonenmagazine.com
// @author       DD1969
// @match        https://pocket.shonenmagazine.com/episode/*
// @match        https://pocket.shonenmagazine.com/volume/*
// @match        https://pocket.shonenmagazine.com/magazine/*
// @require      https://cdn.jsdelivr.net/npm/axios@0.25.0/dist/axios.min.js
// @require      https://cdn.jsdelivr.net/npm/jszip@3.7.1/dist/jszip.min.js
// @require      https://cdn.jsdelivr.net/npm/file-saver@2.0.5/dist/FileSaver.min.js
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/439814/ShonenmagazineSpider.user.js
// @updateURL https://update.greasyfork.org/scripts/439814/ShonenmagazineSpider.meta.js
// ==/UserScript==
...
(async function (axios, JSZip, saveAs) {
  ...
  document.querySelector('.episode-header').innerHTML += `
    <div class="download-panel" style="display: flex; align-items: center; margin: 0 auto 24px auto; width: 980px;">
      ...
      <button id="dl-btn" style="width: 100px; height: 26px; cursor: pointer; background-color: #eee; border: 1px solid #555; border-radius: 3px;">下载</button>
    </div>
  `;
  ...
  dlBtn.onclick = function () {
    ...
    download(imgSrc.slice(startAt - 1, endAt), title);
  }

  async function download(data, title) {
    const zip = new JSZip();
