...
// @author       LX
// @match        http://www.mf178.cn/customer/life/mytasks*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/368659/%E8%9C%9C%E8%9C%82%E4%BE%A0%EF%BC%88%E7%94%B5%E8%B4%B9%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/368659/%E8%9C%9C%E8%9C%82%E4%BE%A0%EF%BC%88%E7%94%B5%E8%B4%B9%EF%BC%89.meta.js
// ==/UserScript==
...
(function() {
    ...
    var Refresh = function () {
        if(stop == true) {return;}
        // 查询订单……
        $.get('/customer/life/mytasks', function(msg) {
		...
		<div class='row' id='robDiv'>
			<div class='col-xs-3'>
				<select class="form-control" id='amount' name='amount'>
                    <option  value="21">0-100元</option>
                    <option  value="23">100-300元</option>
                    <option  value="1">300-500元</option>
                    <option  value="1">500-1000元</option>
                    <option  value="1">1000元以上</option>
				</select>
			</div>
			<div class='col-xs-2'>
