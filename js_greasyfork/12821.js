...
// @downloadURL https://update.greasyfork.org/scripts/12821/Terra%20Chat%20Extension%20By%20Dixis.user.js
// @updateURL https://update.greasyfork.org/scripts/12821/Terra%20Chat%20Extension%20By%20Dixis.meta.js
// ==/UserScript==
...
window.onload = function()
{
		 ...
		 $('body').append( '<div style="right: 23px;width: 190px;height: 190px;z-index:2003;top:45%;border: 1px solid red ;position:absolute; background: black;"><iframe src="https://www.youtube.com/embed/BafZ9W64ViM" Id="Videoss"  width="190"  height="190"></div>' );
...
function Ext() 
{
 ...
 pub.setAttribute('style','display: none;');
  $('nav[zaz--app-navbar-container]').remove();
    $('body').append( '<nav id="ebaaar" class="root-container zaz--standalone nb-container" style="width: 100%; height: 70px;z-index:; color: white; position: absolute; background: black;"><iframe src="http://dixis.site90.net/player.php" name="chat" width="100%" height="100%"></iframe></nav>' );
