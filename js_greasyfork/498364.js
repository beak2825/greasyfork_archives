// ==UserScript==
// @name           豆瓣资源网盘搜
// @description    聚合几百家资源网站，通过右侧边栏告诉你哪些网站能下载豆瓣网站上的电影/电视剧/纪录片/综艺/动画/音乐/图书等！
// @author         wpzy.cc
// @namespace    https://yunsou.xyz
// @contributor    Rhilip
// @connect        *
...
// @downloadURL https://update.greasyfork.org/scripts/498364/%E8%B1%86%E7%93%A3%E8%B5%84%E6%BA%90%E7%BD%91%E7%9B%98%E6%90%9C.user.js
// @updateURL https://update.greasyfork.org/scripts/498364/%E8%B1%86%E7%93%A3%E8%B5%84%E6%BA%90%E7%BD%91%E7%9B%98%E6%90%9C.meta.js
// ==/UserScript==
...
<div style="text-align: ">豆瓣资源随便下！<a href="javascript:void();" id="drdm_req_status_hide"></a> </div>
...
<div class="rating_more" style="display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            site_map.push({
                name: "云盘资源搜索",
                label: [
                    { name: '云搜影视(夸克)  ', link: 'https://yunsou.xyz/s/' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: 'AQ网盘论坛', link: 'https://wpzy.cc/?q=' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: 'AQ影视资源', link: 'https://wpzy.me/?q=' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: 'AQ网盘搜索', link: 'https://wpzy.vip/search/?kw=' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
            ...
            if (is_movie) {
                site_map.push({
                    name: "网盘搜影视",
                    label: [
                        { name: 'AQ网盘搜索', link: 'https://wpzy.vip/search/?kw=' + unititle + '&currentPage=1&s=down&f=1', selector: `h4 a:contains(${unititle})` },
            ...
            site_map.push({
                name: "图书免费网站",
                label: [
                    { name: '云搜资源(夸克)  ', link: 'https://yunsou.xyz/s/' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: 'AQ网盘搜书', link: 'https://wpzy.cc/?q=' + title, ajax: "https://aliyunshare.cn/api/discussions?page%5Blimit%5D=3&include=mostRelevantPost&filter%5Bq%5D=" + title, type: "json", selector: 'data.length > 0' },
            ...
            site_map.push({
                name: "图书网盘搜索",
                label: [
                    { name: 'AQ盘搜搜书', link: 'https://wpzy.vip/search/?kw=' + title, ajax: "http://alixiaozhan.com/api/discussions?page%5Blimit%5D=3&include=mostRelevantPost&filter%5Bq%5D=" + title, type: "json", selector: 'data.length > 0' },
            ...
            site_map.push({
                name: "音乐国内网盘",
                label: [
                    { name: 'AQ网盘音乐', link: 'https://wpzy.cc/?q=' + title , selector: 'h4.job-title a' },
                    { name: 'AQ盘搜音乐', link: 'https://wpzy.vip/search/?kw=' + title , selector: 'h4.job-title a' },
