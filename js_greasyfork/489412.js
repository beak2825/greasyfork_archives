...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/489412/Archer.user.js
// @updateURL https://update.greasyfork.org/scripts/489412/Archer.meta.js
// ==/UserScript==
	...
	},
{
	  ...
	  content:
		...
		`[CENTER]На рассмотрении.[/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере «PENZA» [/COLOR][/FONT][/SIZE][/CENTER]`,
	     prefix: PIN_PREFIX,
	     status: true,
	       },
     {
	...
	},
    {
	  ...
	  content:
	    "[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток, уважаемый игрок. [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER]С лидером будет проведена строгая беседа.<br><br>" +
		'[B][CENTER][COLOR=red][ICODE]Одобрено.Закрыто.[/ICODE][/COLOR][/CENTER][/B]',
	...
	},
    {
	  ...
	  content:
	    "[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток, уважаемый игрок. [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER]Лидер получит соответствующее наказание.<br><br>" +
		'[B][CENTER][COLOR=red][ICODE]Одобрено.Закрыто.[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},
    {
      title: 'Лидер прав(он крут)',
	  content:
	    "[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток, уважаемый игрок. [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER]Нарушений со стороны лидера нет.<br><br>" +
		'[B][CENTER][COLOR=red][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/B]',
	...
	},
    {
	  ...
	  content:
	    "[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток, уважаемый игрок. [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER]Отсутствуют доказательства.<br><br>" +
		'[B][CENTER][COLOR=red][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
