...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/501665/%E6%95%B0%E6%8D%AE%E5%A1%AB%E5%85%85%E8%84%9A%E6%9C%AC%2B20%E6%95%B0%E6%8D%AE%E5%A1%AB%E5%85%85%E8%AE%B0%E5%BF%86%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/501665/%E6%95%B0%E6%8D%AE%E5%A1%AB%E5%85%85%E8%84%9A%E6%9C%AC%2B20%E6%95%B0%E6%8D%AE%E5%A1%AB%E5%85%85%E8%AE%B0%E5%BF%86%E7%89%88.meta.js
// ==/UserScript==
...
// 布局扶梯定期检验FDformBox 创建一个包含多个小方框和保存按钮的方框
  const formBoxFd = document.createElement('div');
    ...
    <div style="margin-bottom: 2px;">
      <label for="FDinputWB" style="display: inline-block; width: 90px;">维保公司：</label>
      <input type="text" id="FDinputWB" placeholder="" style="width: 80%; margin-left: 1px;">
    </div>
    <div style="margin-bottom: 2px;">
...
//            document.getElementById('1704865734309f666').lastElementChild.innerHTML=DATE1; //;//防爆下次检测日期 span 1704865734309f666
            document.getElementById('17222411351547797').lastElementChild.innerHTML='2026年06月';//DATE2;//下次检验日期
       ...
       // 新按钮点击事件
        ...
        // 每次点击更新点击次数
            ...
            if (clicktoggleButton % 2 === 1) {
                ...
                container.appendChild(formBoxFd);//插入扶梯定检
             ...
             //container.appendChild(textBoxLabel); // 重新插入说明文字
                ...
                formBoxMc.innerHTML = '';
                formBox2.innerHTML = '';
                formBoxMc.appendChild(buttonZtdj);
                ...
                //container.appendChild(formBox3);
                container.appendChild(formBox2);
                container.appendChild(formBox);//插入直梯定检
...
/*document.getElementById('FDsaveButton').addEventListener('click', function() {
    const inputIds = [];
    const elementIds = [];
    saveData(inputIds, elementIds, 2);
    alert('第二组数据保存成功！');
});*/
