...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/543388/Anna%20Remake.user.js
// @updateURL https://update.greasyfork.org/scripts/543388/Anna%20Remake.meta.js
// ==/UserScript==
/*Mod Log
...
document.getElementById("gameName").innerHTML = "Anna Remake"
let changes2 = `<div id="customMenuName"><h3 style="font-size: 50px;" class = "indent">Remaked By Anna</a></div>`;
...
//document.getElementById("loadingText").innerHTML = "Anna Remake Loading";
document.getElementById("diedText").innerHTML = "Skill Issue";
document.getElementById("diedText").style.color = "#ffffff";
document.title = " Anna Remake";
document.getElementById("leaderboard").append("Anna Remake");
...
<div class="menu" id="T-menu">
        <span class="nameblock">Anna Remake</span><br>
