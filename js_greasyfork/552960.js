// ==UserScript==
// @name 05 ORANGE | Скрипт для Кураторов Форума [Телефон]
...
// @description nane
// @downloadURL https://update.greasyfork.org/scripts/552960/05%20ORANGE%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%5B%D0%A2%D0%B5%D0%BB%D0%B5%D1%84%D0%BE%D0%BD%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/552960/05%20ORANGE%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%5B%D0%A2%D0%B5%D0%BB%D0%B5%D1%84%D0%BE%D0%BD%5D.meta.js
// ==/UserScript==
 
(function () {
'esversion 6' ;
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'При составлении жалобы, Вы ошиблись сервером.<br>Подайте жалобу в раздел Вашего сервера.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.03. Любые формы оскорблений, издевательств, расизма, дискриминации, религиозной враждебности, сексизма в OOC чате запрещены | [COLOR=rgb(255, 0, 0)]Mute 30 минут. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.04. Запрещено оскорбление или косвенное упоминание родных вне зависимости от чата (IC или OOC) | [COLOR=rgb(255, 0, 0)]Mute 120 минут / Ban 7 - 15 дней. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.05. Запрещен флуд — 3 и более повторяющихся сообщений от одного и того же игрока | [COLOR=rgb(255, 0, 0)]Mute 30 минут. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.06. Запрещено злоупотребление знаков препинания и прочих символов | [COLOR=rgb(255, 0, 0)]Mute 30 минут. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.08. Запрещены любые формы «слива» посредством использования глобальных чатов | [COLOR=rgb(255, 0, 0)]PermBan. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.10. Запрещена выдача себя за администратора, если таковым не являетесь | [COLOR=rgb(255, 0, 0)]Ban 7 - 15. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.11. Запрещено введение игроков проекта в заблуждение путем злоупотребления командами | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.14. Запрещено включать музыку в Voice Chat | [COLOR=rgb(255, 0, 0)]Mute 60 минут. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.16. Запрещено создавать посторонние шумы или звуки | [COLOR=rgb(255, 0, 0)]Mute 30 минут. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.18. Запрещено политическое и религиозное пропагандирование, а также провокация игроков к конфликтам, коллективному флуду или беспорядкам в любом из чатов | [COLOR=rgb(255, 0, 0)]Mute 120 минут / Ban 10 дней. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.19. Запрещено использование любого софта для изменения голоса | [COLOR=rgb(255, 0, 0)]Mute 60 минут. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.20. Запрещено использование транслита в любом из чатов | [COLOR=rgb(255, 0, 0)]Mute 30 минут. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.22. Запрещено публиковать любые объявления в помещениях государственных организаций вне зависимости от чата (IC или OOC) | [COLOR=rgb(255, 0, 0)]Mute 30 минут. [/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]3.23. Запрещено использование нецензурных слов, в том числе завуалированных и литературных в VIP чате | [COLOR=rgb(255, 0, 0)]Mute 30 минут. [/QUOTE][/COLOR]<br><br>'+
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          ...
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.22. Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan.[/QUOTE][/COLOR]<br><br>' +
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.01. Запрещено поведение, нарушающее нормы процессов Role Play режима игры | [COLOR=rgb(255, 0, 0)]Jail 30 минут.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан исходя из основных правил государственных организаций по пункту правил:[QUOTE] 4.01. Запрещено редактирование объявлений, не соответствующих ПРО [Color=Red]| Mute 30 минут[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан исходя из основных правил государственных организаций по пункту правил:[QUOTE] 4.02. Запрещено проведение эфиров, не соответствующих Role Play правилам и логике [Color=Red]| Mute 30 минут[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан исходя из основных правил государственных организаций по пункту правил:[QUOTE] 3.01. Запрещено оказывать услуги адвоката на территории ФСИН находясь вне комнаты свиданий [Color=Red]| Warn[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},              
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.02. Запрещено целенаправленно уходить от Role Play процесса всеразличными способами | [COLOR=rgb(255, 0, 0)]Jail 30 минут / Warn.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.05.Запрещены любые OOC обманы и их попытки, а также любые IC обманы с нарушением Role Play правил и логики | [COLOR=rgb(255, 0, 0)]PermBan.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.08. Запрещена любая форма аморальных действий сексуального характера в сторону игроков | [COLOR=rgb(255, 0, 0)]Jail 30 минут / Warn.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.10. Запрещено в любой форме обманывать в /do, даже если это в дальнейшем негативно скажется на Вашем игровом персонаже | [COLOR=rgb(255, 0, 0)]Jail 30 минут / Warn[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.11. Запрещено использование рабочего или фракционного транспорта в личных целях | [COLOR=rgb(255, 0, 0)]Jail 30 минут.[/QUOTE][/COLOR]<br><br>' +
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.13. Запрещен DB (DriveBy) — намеренное убийство / нанесение урона без веской IC причины на любом виде транспорта | [COLOR=rgb(255, 0, 0)]Jail 60 минут.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br>    {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.15. Запрещен TK (Team Kill) — убийство члена своей или союзной фракции, организации без наличия какой-либо IC причины | [COLOR=rgb(255, 0, 0)]Jail 60 минут / Warn (за два и более убийства).[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.18. Запрещен MG (MetaGaming) — использование ООС информации, которую Ваш персонаж никак не мог получить в IC процессе | [COLOR=rgb(255, 0, 0)]Mute 30 минут.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.19. Запрещен DM (DeathMatch) — убийство или нанесение урона без веской IC причины | [COLOR=rgb(255, 0, 0)]Jail 60 минут.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.20. Запрещен Mass DM (Mass DeathMatch) — убийство или нанесение урона без веской IC причины трем игрокам и более | [COLOR=rgb(255, 0, 0)]Warn / Ban 3 - 7 дней.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.23. Запрещено скрывать от администрации баги системы, а также распространять их игрокам | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.24. Запрещено скрывать от администрации нарушителей или злоумышленников | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan + ЧС проекта.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.25. Запрещены попытки или действия, которые могут навредить репутации проекта | [COLOR=rgb(255, 0, 0)]PermBan + ЧС проекта.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.26. Запрещено намеренно наносить вред ресурсам проекта (игровые серверы, форум, официальные Discord-серверы и так далее) | [COLOR=rgb(255, 0, 0)]PermBan + ЧС проекта.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.31. Запрещено рекламировать на серверах любые проекты, серверы, сайты, сторонние Discord-серверы, YouTube каналы и тому подобное | [COLOR=rgb(255, 0, 0)]Ban 7 дней / PermBan.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.32. Запрещено введение в заблуждение, обман администрации на всех ресурсах проекта | [COLOR=rgb(255, 0, 0)]Ban 7 - 15 дней.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.33. Запрещено пользоваться уязвимостью правил | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.35. На игровых серверах запрещено устраивать IC и OOC конфликты на почве разногласия о национальности и / или религии совершенно в любом формате | [COLOR=rgb(255, 0, 0)]Mute 120 минут / Ban 7 дней.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.37. Запрещены OOC угрозы, в том числе и завуалированные | [COLOR=rgb(255, 0, 0)]Mute 120 минут / Ban 7-15 дней.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.38. Запрещено распространять личную информацию игроков и их родственников | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan +ЧС проекта.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.03. Запрещён NonRP Drive — вождение любого транспортного средства в невозможных для него условиях, а также вождение в неправдоподобной манере | [COLOR=rgb(255, 0, 0)]Jail 30 минут.[/QUOTE][/COLOR]<br><br>' +
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.47. Запрещено ездить по полям на грузовом транспорте, инкассаторских машинах (работа дальнобойщика, инкассатора) | [COLOR=rgb(255, 0, 0)]Jail 60 минут.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.50. Запрещены задержания, аресты, а также любые действия со стороны игроков, состоящих во фракциях в интерьере аукциона, казино, а также во время системных мероприятий | [COLOR=rgb(255, 0, 0)]Ban 7 - 15 дней + увольнение из организации.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.52. Запрещено располагать аксессуары на теле персонажа, нарушая нормы морали и этики, увеличивать аксессуары до слишком большого размера. | [COLOR=rgb(255, 0, 0)]При первом нарушении - обнуление аксессуаров, при повторном нарушении - обнуление аксессуаров + JAIL 30 минут.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.54. Запрещено неуважительное обращение, оскорбление, неадекватное поведение, угрозы в любом их проявлении по отношению к администрации | [COLOR=rgb(255, 0, 0)]Mute 180 минут.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан по пункту правил:[QUOTE]2.55. Запрещается багоюз связанный с анимацией в любых проявлениях. | [COLOR=rgb(255, 0, 0)]Jail 120 минут.[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
},
{
    ...
    content:
          '[CENTER][SIZE=4][FONT=Verdana][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          'Нарушитель будет наказан исходя  из правил нападания на военную часть по пункту:[QUOTE]2. За нарушение правил нападения на Военную Часть выдаётся предупреждение | [COLOR=rgb(255, 0, 0)]Jail 30 минут (NonRP нападение) / Warn (Для сотрудников ОПГ)[/QUOTE][/COLOR]<br><br>' +
          '[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>' +
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR]<br>' +
          'С уважением, администрация сервера![/FONT][/SIZE][/CENTER]',
...
// addButton('Тех. спецу', 'tech');
	addButton('На рассмотрении', 'pin', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 140, 0, 0.8);');
    addButton('Отказано', 'unaccept', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 0, 0, 0.8);')
    addButton('Одобрено', 'accepted', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(0, 255, 0, 0.8);')
	addAnswers();
 
