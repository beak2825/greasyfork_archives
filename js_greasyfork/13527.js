...
// -- FOOLSLIDE NSFW END
// @require https://greasyfork.org/scripts/692-manga-loader/code/Manga%20Loader.user.js?27
// @downloadURL https://update.greasyfork.org/scripts/13527/Manga%20Loader%20NSFW.user.js
// @updateURL https://update.greasyfork.org/scripts/13527/Manga%20Loader%20NSFW.meta.js
// ==/UserScript==
...
var nsfwimp = [{
  ...
  pages: function(url, num, cb, ex) {
    cb('http://static.hentaicdn.com/hentai' + W.rff_imageList[num - 1], num);
  }
}, {
  name: 'hentai.ms',
