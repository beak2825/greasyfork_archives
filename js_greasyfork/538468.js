// ==UserScript==
// @name         Blacket Orange Theme
// @version      1.0.0
// @description  Orange theme for Blacket!
...
// @downloadURL https://update.greasyfork.org/scripts/538468/Blacket%20Orange%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/538468/Blacket%20Orange%20Theme.meta.js
// ==/UserScript==

(async () => {
    setTimeout(() => {
        console.log(
            "%c[blacket orange theme] loaded!",
            "color: #fff; padding: 10px; border-radius: 5px; font-size: 20px; font-weight: bold; text-shadow: 0px 0px 10px #c46a1a;"
        );
    }, 1000);
