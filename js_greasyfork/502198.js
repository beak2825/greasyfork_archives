...
// @downloadURL https://update.greasyfork.org/scripts/502198/%D0%97%D0%93%D0%90.user.js
// @updateURL https://update.greasyfork.org/scripts/502198/%D0%97%D0%93%D0%90.meta.js
// ==/UserScript==
...
`[FONT=verdana][SIZE=4][COLOR=red] Закрыто.[/COLOR][/SIZE][/FONT][/SIZE][/FONT]`,
        ...
        Status:false,
	      ...
	      {
         title: `Га`,
    content: `[CENTER][IMG alt="T09X7vGR7SVftknVZIboJlX4evuv0_s1VG4zaND9-lVzYlKlq4zt9nKm1aORMh_ZByGdyUo3D_AYJkxVPGThVj4nDofZhteNvJwR6lnQ0qupAUHSJw3mPeV74QrPaN2kvBBFS17O"]https://lh4.googleusercontent.com/T09X7vGR7SVftknVZIboJlX4evuv0_s1VG4zaND9-lVzYlKlq4zt9nKm1aORMh_ZByGdyUo3D_AYJkxVPGThVj4nDofZhteNvJwR6lnQ0qupAUHSJw3mPeV74QrPaN2kvBBFS17O[/IMG]<br>` +
                `[QUOTE][CENTER][COLOR=rgb(255, 255, 0)][SIZE=4][FONT=courier new]Приветствую, уважаемый(ая) [/FONT][/SIZE][/COLOR][COLOR=rgb(220, 220, 220)][SIZE=4][FONT=courier new]${user.mention}[/FONT][/SIZE][/COLOR][/CENTER][/QUOTE]<br><br>`+
		`[COLOR=rgb(255, 0, 255)][SIZE=4][FONT=courier new]Ваше обжалование передано [COLOR=rgb(255, 0, 0)]Главному Администратору[/COLOR]<br><br>`+
        `[CENTER][COLOR=rgb(255, 255, 0)][ICODE]На рассмотрении.[/ICODE][/COLOR]<br>` +

`[URL='https://forum.blackrussia.online/redirect?to=aHR0cHM6Ly9wb3N0aW1hZ2VzLm9yZy8='][IMG width="998px"]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG][/URL]`,
    prefix: GA_PREFIX,
	  status: true,
    },
        {
...
`[FONT=verdana][SIZE=4][COLOR=red] Закрыто.[/COLOR][/SIZE][/FONT][/SIZE][/FONT]`,
    ...
    },
    {
        title: `Тех раздел ЖБ`,
        content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
        `Обратитесь в раздел «Жалобы на Технических Специалистов» — [URL='https://forum.blackrussia.online/forums/Сервер-№18-aqua.1199/']*Кликабельно*[/URL]<br>`+
        `[color=red]Закрыто.`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
        title: `Ошб сервера`,
        content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
        `Обратитесь в раздел «Обжалование наказаний» своего сервера. На текущий момент, обжалование составлено на сервере AQUA [18].<br>`+
        `[color=red]Закрыто.`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    ...
    },
    {
        ...
        },
        {
            ...
            `Иногда решение/рассмотрение подобных обращений требует больше времени чем 2 дня. Настоятельно рекомендуем вам не создавать темы с подобным содержанием. Ответ будет дан в данной теме, как только это будет возможно.<br><br>`+
            `[color=orange] На рассмотрении.`,
        ...
        {
            title: `Роспись`,
            content: `[IMG]	https://vk.com/sticker/1-101478-512b[/IMG]`,
