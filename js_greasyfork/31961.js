...
// @license     MIT License
// @downloadURL https://update.greasyfork.org/scripts/31961/WoTStatScript%20Lite.user.js
// @updateURL https://update.greasyfork.org/scripts/31961/WoTStatScript%20Lite.meta.js
// ==/UserScript==
// jshint
...
(function() {
    ...
    var sc = {
            ...
            loc: [ // localization
                ...
                {i:37, en: "Total Vehicles", ru: "Общее количество танков", cs: "Celkem vozidel", de: "Alle Fahrzeuge", fr: "Nombre total de véhicules", pl: "Całkowita liczba pojazdów", es: "Total de vehículos", tr: "Toplam Araçlar"},
                ...
                {i:87, en: "Maximum Destroyed in a Battle", ru: "Максимально уничтожено за бой", cs: "Nejvíce" +
                " zničení v bitvě", de: "Maximum Destroyed in a Battle", fr: "Nb de chars détruits maximum", pl: "Największa liczba zniszczonych czołgów w bitwie", es:"Maximum Destroyed in a Battle", tr: "Maximum Destroyed in a Battle"},
                ...
                {i:134, en: "Reload Tankopedia", ru: "Перезагрузить Танкопедию", cs: "Obnov Tankopedii", de: "Reload Tankopedia", fr: "Reload Tankopedia", pl: "Przeładuj dane z Tankopedii", es: "Reload Tankopedia", tr: "Reload Tankopedia"},
                ...
                {i:144, en: "Clean Script Database", ru: "Очистить базу скрипта", cs: "Vyčisti db scriptu", de: "Clean Script Database", fr: "Nettoyer la base de données du script", pl: "Wyczyść bazę skryptu", es: "Clean Script Database", tr: "Clean Script Database"},
                {i:145, en: "No Random Battles", ru: "Без рандомных боев", cs: "Žádné náhodné bitvy", de: "No Random Battles", fr: "No Random Battles", pl: "No Random Battles", es: "No Random Battles", tr: "No Random Battles"},
                {i:146, en: "Marks of Excellence", ru: "Отличительные отметки", cs: "Vítězné znaky ", de: "Marks of Excellence", fr: "Marks of Excellence", pl: "Marks of Excellence", es: "Marks of Excellence", tr: "Marks of Excellence"},
                {i:147, en: "Debug Script", ru: "Отладка скрипта", cs: "Ladění skriptu", de: "Debug Script", fr: "Debug Script", pl: "Debug Script", es: "Debug Script", tr: "Debug Script"},
                ...
                {i:150, en: "3 Marks", ru: "3 Отметки", cs: "3 Marks", de: "3 Marks", fr: "3 Marks", pl: "3 Marks", es: "3 Marks", tr: "3 Marks"},
                {i:151, en: "2 Marks", ru: "2 Отметки", cs: "2 Marks", de: "2 Marks", fr: "2 Marks", pl: "2 Marks", es: "2 Marks", tr: "2 Marks"},
                {i:152, en: "1 Mark", ru: "1 Отметки", cs: "1 Mark", de: "1 Mark", fr: "1 Mark", pl: "1 Mark", es: "1 Mark", tr: "1 Mark"},
                {i:153, en: "No Marks", ru: "Без отметок", cs: "No Marks", de: "No Marks", fr: "No Marks", pl: "No Marks", es: "No Marks", tr: "No Marks"}
        ...
        s = { // variable for statistics
            ...
            h: {}, // hex colours
            m: [{c:0,p:0},{c:0,p:0},{c:0,p:0},{c:0,p:0}], // marks of excellence
            n: {china:{b:0,bd:0,wn8:0,wn9:0},czech:{b:0,bd:0,wn8:0,wn9:0},france:{b:0,bd:0,wn8:0,wn9:0},germany:{b:0,bd:0,wn8:0,wn9:0},japan:{b:0,bd:0,wn8:0,wn9:0},sweden:{b:0,bd:0,wn8:0,wn9:0},uk:{b:0,bd:0,wn8:0,wn9:0},usa:{b:0,bd:0,wn8:0,wn9:0},ussr:{b:0,bd:0,wn8:0,wn9:0}}, // nations
        ...
        sf = { // script functions
            statCalc: function () { // statCalc function
                ...
                s.l = {
                    ...
                    clip: sc.loc[71]+" "+wg.name+": \n"+sc.loc[72]+" "+s.r.battles+" \nWR: "+s.a.wins.toFixed(2)+" \nWN8: "+s.f.wn8.rat.toFixed(0)+" \nWN7: "+s.f.wn7.rat.toFixed(0)+" \nEff: "+s.f.eff.rat.toFixed(0)
                };
            },
    ...
    if (tableBattles > 0 && Object.keys(sc.stats).length !== 0) {
        ...
        styleText = styleText.concat([
            ...
            ".b-logo {height: 165px; width: 275px; top: 66px;}",
            // container wrapper
            ...
            ".b-vehicles-wrpr .b-armory-wrapper {height: inherit; margin: 0; padding: 0; width: 125px;}",
            ...
            ".b-vehicles-wrpr .b-name-vehicle {color: #BBB7AC; display: table-cell; height: inherit; vertical-align: middle; width: 255px; max-width: 255px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;}",
        ...
        persDataTable.appendChild(sf.elem("tbody", "t-ratings-info", "<tr><th colspan='2'><a" +
        ...
        for (var _vt=0, _vt_len = vehTypes.length; _vt<_vt_len; ++_vt) {
            ...
            if (vehicleSubs.length === 0 || (vehicleGroup == "miss" && !sc.debug)) {
                ...
                var vehicleFragment = d.createDocumentFragment(),
                    vehicleCategoryHead = sf.elem("tbody", "", "<tr class='t-profile_tankstype no-sort'><td class='t-profile_head' colspan='3'><span class='b-tankstype-ico b-tankstype-ico__"+vehTypes[_vt][0].toLowerCase()+"'></span><span class='b-tankstype-text'><span>"+vehTypes[_vt][1]+"</span><span class='b-armory-col'>"+vehicleSubs.length+"</span></span></td><td class='b-display-none'></td><td class='b-display-none'></td><td class='t-profile_center'>"+sf.format(s.s[vehicleGroup].bd,2)+"</td><td class='t-profile_center'>"+sf.color((s.s[vehicleGroup].w/s.s[vehicleGroup].bd)*100, "wr", 2, "%")+"</td><td class='t-profile_center'>"+sf.color(s.s[vehicleGroup].wn8,"wn8",0,"","f")+"</td><td class='t-profile_center'>"+sf.color(s.s[vehicleGroup].wn9,"wn9",0,"","f")+"</td><td class='t-profile_center'>&#9776;</td><td class='t-profile_center'>&#9776;</td><td class='t-profile_center'>"+s.s[vehicleGroup].bg+"</td><td class='t-profile_center'>"+s.s[vehicleGroup].m+"</td></tr>"),
