...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/32165/CWMobileTamp.user.js
// @updateURL https://update.greasyfork.org/scripts/32165/CWMobileTamp.meta.js
// ==/UserScript==
...
(function() {
    ...
    //if(searchtype.includes('for this keyword in bing.com')){var searchw = window.open('http://www.bing.com/search?q='+searchterm, "searcher", "width=600,height=800");}
    ...
    //if(searchtype.includes('for this keyword in google.com')){var searchw = window.open('https://www.google.com/search?q='+searchterm, "searcher", "width=600,height=800");}
    ...
    //if(searchtype.includes('for this keyword in yahoo.com')){var searchw = window.open('https://search.yahoo.com/search;?p='+searchterm, "searcher", "width=600,height=800");}
