...
// @downloadURL https://update.greasyfork.org/scripts/488340/Ajustar%20ataque.user.js
// @updateURL https://update.greasyfork.org/scripts/488340/Ajustar%20ataque.meta.js
// ==/UserScript==
            ...
            if (!indicador || indicador.length < movimientos.children.length){
                ...
                if (tiempoInfo == horaAjuste){
                    ...
                    textoElemento.style.cssText = "margin-left: 0.3em; font-size: 1.3em; color: white; background-color: green; padding: 5px; text-align: center; margin-bottom: 5px; display: flex; align-items: center;";
                                        ...
                                        // Te la juegas bastante mas, solo en caso de emergencia
                    ///////////////////////////////////
                    // Dentro de tu bucle for, cuando defines el setTimeout...
