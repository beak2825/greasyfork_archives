...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/536880/ARZAMAS%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/536880/ARZAMAS%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.meta.js
// ==/UserScript==
    ...
    },
{
  ...
  status: true
},
    {
      title: 'НЕТ ДОКВ',
      content:
        "[CENTER][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms][SIZE=4]Доброго времени суток.[/FONT][/COLOR]<br><br>"+
        "В теме отсутствуют доказательства<br><br>"+
        "[COLOR=rgb(255, 0, 0)][FONT=trebuchet ms][SIZE=4]Отказано. Закрыто[/FONT][/COLOR]<br><br>"+
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ARZAMAS[/COLOR][/CENTER]",
    ...
    },
    {
        title: 'ОТ 3 ЛИЦ',
        content:
        "[CENTER][FONT=trebuchet ms][COLOR=rgb(255, 0, 0)]Доброго времени суток.[/COLOR]<br><br>"+
    ...
    },
    {
        title: 'НЕПОФОРМЕ',
        content:
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Доброго времени суток.[/FONT][/COLOR]<br><br>"+
    ...
    },
    {
        title: 'ДОКВА РЕДАК',
        content:
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Доброго времени суток.[/FONT][/COLOR][/SIZE]<br><br>"+
        ...
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ARZAMAS[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    },
    {
        ...
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ARZAMAS[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    },
    {
        ...
        "[COLOR=rgb(255, 0, 0)]Отказано. Закрыто[/COLOR]<br><br>"+
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ARZAMAS[/COLOR][/SIZE][/FONT][/CENTER]<br><br>",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    },
    {
        title: 'УЖЕ НАКАЗАН',
        content:
        "[CENTER][FONT=trebuchet ms][COLOR=rgb(255, 0, 0)][SIZE=4]Доброго времени суток..[/SIZE][/COLOR][/FONT]<br><br>"+
    ...
    },
    {
        ...
        content:
        "[CENTER][FONT=trebuchet ms][COLOR=rgb(255, 0, 0)][SIZE=4]Доброго времени суток..[/SIZE][/COLOR]<br><br>"+
    ...
    },
    {
        ...
        "Создайте новую RolePlay ситуацию руководствуясь правилами подачи - [URL='https://forum.blackrussia.online/index.php?threads/ARZAMAS-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BD%D0%B0%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D1%81%D0%B8%D1%82%D1%83%D0%B0%D1%86%D0%B8%D0%B8.3137988/']*ссылка*[/URL]<br><br>"+
        "[COLOR=rgb(255, 0, 0)]Отказано. Закрыто[/COLOR]<br><br>"+
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ARZAMAS[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
