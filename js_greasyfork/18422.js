...
// @downloadURL https://update.greasyfork.org/scripts/18422/Virtonomica%3AKvala_info.user.js
// @updateURL https://update.greasyfork.org/scripts/18422/Virtonomica%3AKvala_info.meta.js
// ==/UserScript==
...
var run = function() {
   ...
   /**
   * записать данные в локально хранилище, с проверкой ошибок
   */
   ...
   function getFromStorage(obj, id_shop)
   {
	...
	my_header+= "<th> <th help='Текущий опыт и его рост'>Опыт";
