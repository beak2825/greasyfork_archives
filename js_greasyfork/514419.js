...
// @version      2.0.0
// @description  Select and unselect items in Item Market with Add/Remove zero functionality
// @author       Upsilon
// @match        https://www.torn.com/page.php?sid=ItemMarket*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=torn.com
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/514419/UpsItemSelector%20-%20Heart.user.js
// @updateURL https://update.greasyfork.org/scripts/514419/UpsItemSelector%20-%20Heart.meta.js
// ==/UserScript==
...
(function () {
    ...
    function createButton(text, onClick, id) {
        ...
        button.classList.add("ups-market-button");
        return button;
    }

    function modifyPrice(up) {
        waitForElm(".itemRow___Mf7bO").then(() => {
            let itemRows = document.getElementsByClassName('itemRow___Mf7bO');
            for (let itemRow of itemRows) {
                ...
                if (inputMoney) {
                    ...
                    if (up) inputMoney.value = price * 10;
                    else if (inputMoney.value.endsWith('0')) inputMoney.value = price / 10;
    ...
    #btnAdd {
        font-size: 16px; /* Make the Add 0 button bigger */
        padding: 12px 16px; /* Adjust padding for a larger button */
        background-color: #4caf50; /* Optional: Change color for Add 0 button */
    }
