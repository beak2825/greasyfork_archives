...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/495151/Ed%20WM%20Volks%20Roman%20Kosiba.user.js
// @updateURL https://update.greasyfork.org/scripts/495151/Ed%20WM%20Volks%20Roman%20Kosiba.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  24000},
        { index: 3, adjustmentAmount: 24000},
        { index: 4, adjustmentAmount: 24000},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE50 7539 0000";
    var targetTextContent2 = " 0003 2304 06";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 24000.0; // Adjust the amount as needed
