// ==UserScript==
// @name        Uber Memsource project creation tweak
// @version      2.4
...
// @grant        none
// @namespace none
// @downloadURL https://update.greasyfork.org/scripts/368069/Uber%20Memsource%20project%20creation%20tweak.user.js
// @updateURL https://update.greasyfork.org/scripts/368069/Uber%20Memsource%20project%20creation%20tweak.meta.js
// ==/UserScript==
...
var workflows = [
    ...
    {"Type":"TR", "Tooltip": "", "URGs": ["URG6","URG12","URG24"]},
];
...
var checkboxes = [
    {"Type":"COVID", "Tooltip": "COVID virus contents only"},
    {"Type":"URG2", "Tooltip": "URG2 specific for COVID virus contents only"},
    {"Type":"TEST", "Tooltip": "Bypass WL connector; WL will not work in the translation project"},
   // {"Type":"M-TEST", "Tooltip": "Remove project from RWS production view"},
    {"Type":"Transcreation", "Tooltip": ""},
    {"Type":"DTP", "Tooltip": "DTP tooltip"},
    {"Type":"L10nFix", "Tooltip": "L10nFix tooltip"},
   // {"Type":"nochargeWL", "Tooltip": "WL tooltip without charge"},
   // {"Type":"nochargeRWS", "Tooltip": "RWS tooltip without charge"},
];
