...
// @downloadURL https://update.greasyfork.org/scripts/495847/personal%20test%20script3.user.js
// @updateURL https://update.greasyfork.org/scripts/495847/personal%20test%20script3.meta.js
// ==/UserScript==
...
function createSummaryInfo() {
    var newDiv = $('<div>')
		...
		.html('<span id="top"><p id="name">' + itemName + '</p><p id="price">Lowest:  <i>' + lowestPrice.toLocaleString() + ' NP</i></p></span><span id="bottom"><p id="qty">Total Available: <strong><u>' + shopQtyTtl +
					'</u></strong></p><p id="searches">You have <strong>'+searchCount+ '</strong> searches left.</p></span><img height ="215px" src="https://i.imgur.com/OsayYEW.png">');
