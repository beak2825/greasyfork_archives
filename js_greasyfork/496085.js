...
// @author      wray-lee
// @license     GPL-V3
// @description 斗鱼快手直播保留评论
// @downloadURL https://update.greasyfork.org/scripts/496085/%E5%8F%AA%E4%BF%9D%E5%AD%98%E5%BC%B9%E5%B9%95.user.js
// @updateURL https://update.greasyfork.org/scripts/496085/%E5%8F%AA%E4%BF%9D%E5%AD%98%E5%BC%B9%E5%B9%95.meta.js
// ==/UserScript==
function removePlayerDouyu() {
...
//斗鱼专题活动直播间
   ...
   css += '.layout-Player-main{display: none !important;}';
   css += '.layout-Player-aside{width: 100vw !important;}';
...
function removePlayerKs() {
  var css = '{display:none !important;height:0 !important}';
  css += '.player-wrapper{display: none !important;}'
  css += '.foot{display: none !important;}'
  css += '.gift-stack{display: none !important;}'
  css += '.fold-message{display: none !important;}'
  css += '.sidebar{width: 100vw !important;}'
  css += '.box-boder{width: 95vw !important;}'
  loadStyle(css)
  function loadStyle(css) {
     var style = document.createElement('style');
     style.type = 'text/css';
...
(function () {
  function main() {
    GM_registerMenuCommand('Douyu: only retain the comments', removePlayerDouyu);
    GM_registerMenuCommand('Kuaishou: only retain the comments', removePlayerKs);
  }
