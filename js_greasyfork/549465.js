...
// @downloadURL https://update.greasyfork.org/scripts/549465/tangxiong.user.js
// @updateURL https://update.greasyfork.org/scripts/549465/tangxiong.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "ZHANG YANYAN";
    const NEW_NAME = "TANG QIONG";
    const NEW_BIRTHDAY = "(**0705)";
    const NEW_EXPIRE_DATE = "2028-07-30";
