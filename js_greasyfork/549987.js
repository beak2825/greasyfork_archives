...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/549987/Chief%20Technical%20Specialists.user.js
// @updateURL https://update.greasyfork.org/scripts/549987/Chief%20Technical%20Specialists.meta.js
// ==/UserScript==
...
const Button16 = buttonConfig("ЖБ ТЕХ | 76", 'https://forum.blackrussia.online/forums/Сервер-№76-chita.3393/');
const Button17 = buttonConfig("ЖБ ТЕХ | 77", 'https://forum.blackrussia.online/forums/Сервер-№77-kostroma.3428/');
const Button18 = buttonConfig("ЖБ ТЕХ | 78", 'https://forum.blackrussia.online/forums/Сервер-№78-vladimir.3463/');
const Button19 = buttonConfig("ЖБ ТЕХ | 79", 'https://forum.blackrussia.online/forums/Сервер-№79-kaluga.3498/');
const Button20 = buttonConfig("ЖБ ТЕХ | 80", 'https://forum.blackrussia.online/forums/Сервер-№80-novgorod.3533/');
const ButtonTech16 = buttonConfig("ТР | 76", 'https://forum.blackrussia.online/forums/Технический-раздел-chita.3394/');
const ButtonTech17 = buttonConfig("ТР | 77", 'https://forum.blackrussia.online/forums/Технический-раздел-kostroma.3429/');
const ButtonTech18 = buttonConfig("ТР | 78", 'https://forum.blackrussia.online/forums/Технический-раздел-vladimir.3464/');
const ButtonTech19 = buttonConfig("ТР | 79", 'https://forum.blackrussia.online/forums/Технический-раздел-kaluga.3499/');
const ButtonTech20 = buttonConfig("ТР | 80", 'https://forum.blackrussia.online/forums/Технический-раздел-novgorod.3535/');
const ButtonComp16 = buttonConfig("ЖБ ИГР | 76", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.3414/');
const ButtonComp17 = buttonConfig("ЖБ ИГР | 77", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.3449/');
const ButtonComp18 = buttonConfig("ЖБ ИГР | 78", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.3484/');
const ButtonComp19 = buttonConfig("ЖБ ИГР | 79", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.3519/');
const ButtonComp20 = buttonConfig("ЖБ ИГР | 80", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.3555/');
