// ==UserScript==
// @name AudioBookBay hide category: Radio Productions
// @description Hide Radio Productions category
...
// @downloadURL https://update.greasyfork.org/scripts/484568/AudioBookBay%20hide%20category%3A%20Radio%20Productions.user.js
// @updateURL https://update.greasyfork.org/scripts/484568/AudioBookBay%20hide%20category%3A%20Radio%20Productions.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact phrase 'Radio Productions'
    $(".post").has(".postInfo:contains('Radio Productions')").hide();
});
