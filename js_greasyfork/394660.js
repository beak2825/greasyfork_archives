...
// @version     1.0.10
// @downloadURL https://update.greasyfork.org/scripts/394660/GN_Market.user.js
// @updateURL https://update.greasyfork.org/scripts/394660/GN_Market.meta.js
// ==/UserScript==
...
function save_settings(){
  ...
  if(isNaN(min_lvl) || min_lvl < 1 || min_lvl > 22)
    errors.push('Мин. уровень должен лежать между 1 и 22');

  if(isNaN(max_lvl) || max_lvl < 1 || max_lvl > 22)
    errors.push('Макс. уровень должен лежать между 1 и 22');
