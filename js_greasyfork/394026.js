...
// @match        http://oib.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/394026/Macro_To_Win%2BBots.user.js
// @updateURL https://update.greasyfork.org/scripts/394026/Macro_To_Win%2BBots.meta.js
// ==/UserScript==
// ---------- KEYS ----------
...
(function() {
    ...
    function getplayercount()
    {
        ...
        if (friendbots == 1)
        {
            ...
            {
                if (players()[l].friend == 0 && players()[l].nickname == "<>FL3X<>©")
                {
                    players()[l].friend = 1;
        ...
        else
        {
            ...
            {
                if (players()[l2].friend == 1 && players()[l2].nickname == "<>FL3X<>©")
                {
                    players()[l2].friend = 0;
        ...
        for (var i = 0; i < bots.length; i++)
        {
            if (bots[i].opened == 1 && bots[i].readyState == 1)
            {
                ...
                for (var e = 0; e < players().length; e++)
                {
                    ...
                    {
                        if (botplayers[i][e].name == "<>FL3X<>©" || botplayers[i][e].name == "<>FL3X<>©")
                        {
    ...
    function deathbybots()
    {
        ...
        if (playerz < 30 && bots.length < 30)
        {
            try
            {
                ...
                {
                    bots[bots.length - 1].send(JSON.stringify(["<>FL3X<>©", Math.round(Math.random()*5), Math.round(Math.random()*5), botclass, 0, 0, Object.entries(lapas[2])[21][1]]));
