...
// @downloadURL https://update.greasyfork.org/scripts/539426/%D0%A1%D0%BA%D1%80%D0%B8%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D0%A1%20TVER.user.js
// @updateURL https://update.greasyfork.org/scripts/539426/%D0%A1%D0%BA%D1%80%D0%B8%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D0%A1%20TVER.meta.js
// ==/UserScript==
...
"[SIZE=4][FONT=Times New Roman][COLOR=#FF1493][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>"+
         ...
         },
        {
            ...
            '[CENTER][url=https://postimg.cc/18bVwz6h][img]https://i.postimg.cc/DmVFhZ8S/IMG-0268.jpg[/img][/url]<br>' +
"[SIZE=4][FONT=Times New Roman][COLOR=#FF1493][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>"+
            "[CENTER]Ваша жалоба была передана [COLOR=#1E90FF]Руководству Модерации[/COLOR].<br>Просьба ожидать ответа в данной теме, и не создавать новых.<br><br>"+
            "[CENTER][COLOR=#FF8C00]На рассмотрении..[/COLOR]<br><br>"+
            '[CENTER]Приятного времяпровождения на сервере [COLOR=#00BFFF]TVER[/COLOR][/CENTER]',
            prefix: SPEC_PREFIX,
            status: true,
...
"[SIZE=4][FONT=Times New Roman][COLOR=#FF1493][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>"+
      ...
      title: '-------------------------------------------------------------------ОТКАЗ ЖАЛОБЫ-------------------------------------------------------------------',
	},
        {
            ...
            '[CENTER][url=https://postimg.cc/18bVwz6h][img]https://i.postimg.cc/DmVFhZ8S/IMG-0268.jpg[/img][/url]<br>' +
"[SIZE=4][FONT=Times New Roman][COLOR=#FF1493][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>"+
            "[CENTER]Вам стоит обратиться в раздел жалоб на технических специалистов.<br><br>"+
...
"[SIZE=4][FONT=Times New Roman][COLOR=#FF1493][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>"+
         ...
         },
        {
            ...
            '[CENTER][url=https://postimg.cc/18bVwz6h][img]https://i.postimg.cc/DmVFhZ8S/IMG-0268.jpg[/img][/url]<br>' +
"[SIZE=4][FONT=Times New Roman][COLOR=#FF1493][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>"+
            "[CENTER]С данной просьбой вам нужно обратится в раздел жалоб на технических специалистов.<br><br>"+
            "[CENTER][COLOR=#FF0000]Отказано[/COLOR]. Закрыто.<br><br>"+
            '[CENTER]Приятного времяпровождения на сервере [COLOR=#00BFFF]TVER[/COLOR][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false
