...
// @downloadURL https://update.greasyfork.org/scripts/563871/yanyuhui.user.js
// @updateURL https://update.greasyfork.org/scripts/563871/yanyuhui.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "PAN ZHANG";
    const NEW_NAME = "YAN YUHUI";
    const NEW_BIRTHDAY = "(**1211)";
    const NEW_EXPIRE_DATE = "2036-01-05";
