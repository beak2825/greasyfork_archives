...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/451953/Forum%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/451953/Forum%20Script.meta.js
// ==/UserScript==
...
(async function () {
 ...
 prefix: UNACCEPT_PREFIX,
	...
	},
	{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба передана Главной Администрации —  @Harvey Specter @Vladimir_Konyukhov @Arseniy_Sarumyan  <br><br>"+
        `На рассмотрении. `,
      prefix: GA_PREFIX,
	  status: true,
	},
