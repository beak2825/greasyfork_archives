// ==UserScript==
// @name        Hybrid - Check whether two places are the same v2
// @version     1.0
// @author      jawz
...
// @downloadURL https://update.greasyfork.org/scripts/25848/Hybrid%20-%20Check%20whether%20two%20places%20are%20the%20same%20v2.user.js
// @updateURL https://update.greasyfork.org/scripts/25848/Hybrid%20-%20Check%20whether%20two%20places%20are%20the%20same%20v2.meta.js
// ==/UserScript==

if ($('li:contains("Check whether two places are the same")').length) {
    var API = 'AIzaSyAsoTCW8Aoh8P7fqfo-_fPMAs1wVXbeTeY';
