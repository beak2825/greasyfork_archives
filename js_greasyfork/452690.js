...
// @connect      gitee.com
// @downloadURL https://update.greasyfork.org/scripts/452690/Tbot.user.js
// @updateURL https://update.greasyfork.org/scripts/452690/Tbot.meta.js
// ==/UserScript==

(function() {
    'use strict';
    GM_xmlhttpRequest({
        url: 'https://gitee.com/hsrain/ink/raw/master/wlist.json',
        method : "GET",
    ...
    //
    GM_xmlhttpRequest({
        url: 'https://gitee.com/hsrain/ink/raw/master/blist.json',
        method : "GET",
        onload : function(data){
        var json = JSON.parse(data.responseText);
    ...
    //
    GM_xmlhttpRequest({
        url: 'https://gitee.com/hsrain/ink/raw/master/sensitive.txt',
        method : "GET",
        onload : function(data){
    ...
    var keyword = new RegExp("wen|"+GM_getValue('sensitive'));
    //
