...
// @downloadURL https://update.greasyfork.org/scripts/30030/Super_preloaderPlus_one.user.js
// @updateURL https://update.greasyfork.org/scripts/30030/Super_preloaderPlus_one.meta.js
// ==/UserScript==
...
var SITEINFO=[
    ...
    {name: '手機百度百科',
        ...
        nextLink: '//div[@class="pages"]/a[text()="下一頁"] | //div[@class="page"]/p[@class="next"]/a[text()="下頁"] | //table[@class="table next"]//a[text()="下頁"] | //a[@class="m-rm-5" and text()="餘下全文"]',
        autopager: {
    ...
    {name: '手機網易網',
        ...
        nextLink: ['//a[text()="餘下全文"]', '//a[text()="下頁"]'],
        autopager: {
            pageElement: '//div[@class="content"]',
            // separator: false,
    ...
    {name: '手機鳳凰網',
        ...
        exampleUrl: 'http://3g.163.com/news/13/0914/04/98N4CSHI0001124J.html',
        nextLink: ['//a[text()="餘下全文"]', '//a[text()="下一頁"]'],
        autopager: {
    ...
    div.innerHTML = '\
        <div>Super_preloaderPlus_one 設置</div>\
            <ul>\
                ...
                <li title="下一頁的鏈接設置成在新標籤頁打開"><input type="checkbox" id="sp-prefs-forceTargetWindow" /> 新標籤打開鏈接</li>\
