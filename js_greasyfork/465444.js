...
// @compatible     edge
// @compatible     chrome
// @downloadURL https://update.greasyfork.org/scripts/465444/Exhentai%E5%85%AC%E5%85%B1%E8%B4%A6%E5%8F%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/465444/Exhentai%E5%85%AC%E5%85%B1%E8%B4%A6%E5%8F%B7.meta.js
// ==/UserScript==
(function(){
    'use strict';
    ...
    if (location.host == 'exhentai.org' && document.cookie.split(';').length < 3) {
        ...
        img.src = "https://github.com/Mpigest/Exhentai-Shared-Account/blob/master/picture/background.jpg?raw=true";
        ...
        function CLCcookie() {
            ...
            for (var i = 0; i < cookies.length; i++) {
                ...
                document.cookie = name + '=;expires=Thu, 01 May 2001 00:00:00 UTC;domain=' + topLevelDomain + ';path=/';
                document.cookie = name + '=;expires=Thu, 01 May 2001 00:00:00 UTC;path=/';
            }
