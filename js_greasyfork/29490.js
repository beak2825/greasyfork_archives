// ==UserScript==
// @name         格线+背景灰完美版OK-05-18
// @namespace    http://tampermonkey.net/
// @version      2017051016
// @description  格线+背景灰完美版
// @author       You
...
// @match        https://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/29490/%E6%A0%BC%E7%BA%BF%2B%E8%83%8C%E6%99%AF%E7%81%B0%E5%AE%8C%E7%BE%8E%E7%89%88OK-05-18.user.js
// @updateURL https://update.greasyfork.org/scripts/29490/%E6%A0%BC%E7%BA%BF%2B%E8%83%8C%E6%99%AF%E7%81%B0%E5%AE%8C%E7%BE%8E%E7%89%88OK-05-18.meta.js
// ==/UserScript==
(function() {var css = [
	"/* Basic fonts and color scheme. */",
"html,body{background-image:url(http://source.wwqk.net/b.png)!important;background-color:#f6f6f6!important;font-family:'Microsoft Yahei', sans-serif !important;}",  
...
"div#map,div#imgview{background-image:url(https://pbs.twimg.com/media/C-TAtJIV0AA3mx-.jpg:large)!important;}",
 /*推特宽屏设置*/" .gb_ka,.ProfilePage,.global-nav .search-input,.S_bg2, blockquote, .W_btn_b, .W_input, .SW_fun_bg{background-color:transparent!important;}",/*二级页面页头背景色透明化*/
" input{box-shadow: 0px 0px 40px #3c78d8!important;}",/*黑色背景下发光*/
".stream-item:not(.no-header-background-module),  .dashboard.dashboard-right{box-shadow: 0px 0px 40px #fff!important;}",/*黑色背景下发光*/
".content-main {",
"    padding-left:0.2em;",
...
".DashboardProfileCard{border-top:hidden!important;border-color:#bcb9b9!important;}",/*新增 信息卡框线颜色改变*/
...
"._82fo9, ._cag6k, ._gs7sp, ._h2d1o, ._mbp5e, ._s6b3o{background-color:rgba(0, 0, 0,0.4)!important;box-shadow: 0px 0px 80px #000!important;}",/*新增页面信息流发光效果*/
...
/*知乎搜索下拉背景色不透明,宽度自动背景灰*/
".ac-renderer {width: auto!important;background-color:#f6f6f6!important;}",
].join("\n");
