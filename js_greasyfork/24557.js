// ==UserScript==
// @version       1
// @name          C&C:TA CNCOpt Link Button (unxix base_dev)
...
// @grant         unsafeWindow
// @contributor   spying (RIP BI pack M16)
// @contributor   PythEch (http://http://userscripts.org/users/220246)
// @contributor   jerbri (http://userscripts.org/users/507954)
// @downloadURL https://update.greasyfork.org/scripts/24557/CC%3ATA%20CNCOpt%20Link%20Button%20%28unxix%20base_dev%29.user.js
// @updateURL https://update.greasyfork.org/scripts/24557/CC%3ATA%20CNCOpt%20Link%20Button%20%28unxix%20base_dev%29.meta.js
// ==/UserScript==
/* 
        ...
        var cncopt = {
          ...
          make_sharelink: function (baseUrl) {
            try {
			  ...
			  link += city.get_Name()+"("+city.get_PosX()+"-"+city.get_PosY()+")("+pName+")("+pAName+")"+"|";
              defense_units = []
              for (var i = 0; i < 20; ++i) {
                var col = [];
                for (var j = 0; j < 9; ++j) {
              ...
              var d = new Date();
                ...
                var h = d.getDate();
                var date = j+"."+m+" a "+h+"h";
              var link5 =  "&ally="+nomalliance+"|"+serverName+"|"+nomjoueur+"|"+date  ;
