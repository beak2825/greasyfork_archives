// ==UserScript==
// @name				Virus_console_1.3
// @run-at			    document-start
// @version		     	1.3
// @description     	kogama console by exnonull edited allot by Viruster
// @author		     	Viruster
...
// @downloadURL https://update.greasyfork.org/scripts/440101/Virus_console_13.user.js
// @updateURL https://update.greasyfork.org/scripts/440101/Virus_console_13.meta.js
// ==/UserScript==
 
/*sniffers*/
alert("Virus_console_1.3")
alert("thanks for using my console")
...
setTimeout(kc.autofire(), 1);},
    ...
    el=make('div');
    el.id='console_head';
    el.innerHTML='KoGaMa Cheat Console by Viruster';
    el.style=`
		width:100%;height:10%;
    ...
    kcc.ws.send(new Uint8Array(spammer6))
            break;
                case '*':
    var spamEncoder = new TextEncoder();
                var spamCode = spamEncoder.encode('<color=#000000>===virus console===</color>');
                var spamCode2 = spamEncoder.encode('<color=#0101DF>===virus console===</color>');
                var spamCode3 = spamEncoder.encode('<color=red>===virus console===</color>');
                var spamCode4 = spamEncoder.encode('<color=#01DF01>===virus console===</color>');
                var spamCode5 = spamEncoder.encode('<color=#D7DF01>===virus console===</color>');
                var spamCode6 = spamEncoder.encode('<color=#FFFFFF>===virus console===</color>');
                var spamCode7 = spamEncoder.encode('<color=#000000>===virus console===</color>');
                var spamCode8 = spamEncoder.encode('<color=#0101DF>===virus console===</color>');
                var spamCode9 = spamEncoder.encode('<color=red>===virus console===</color>');
                var spamCode10 = spamEncoder.encode('<color=#01DF01>===virus console===</color>');
                var spamCode11 = spamEncoder.encode('<color=#D7DF01>===virus console===</color>');
                var spamCode12 = spamEncoder.encode('<color=#FFFFFF>===virus console===</color>');
                var spamCode13 = spamEncoder.encode('<color=#000000>===virus console===</color>');
                var spamCode14 = spamEncoder.encode('<color=#0101DF>===virus console===</color>');
                var spamCode15 = spamEncoder.encode('<color=red>===virus console===</color>');
                var spamCode16 = spamEncoder.encode('<color=#01DF01>===virus console===</color>');
                var spamCode17 = spamEncoder.encode('<color=#D7DF01>===virus console===</color>');
                var spamCode18 = spamEncoder.encode('<color=#FFFFFF>===virus console===</color>');
    var spamLength = spamCode.length
    var spamLength2 = spamCode2.length
    var spamLength3 = spamCode3.length
    var spamLength4 = spamCode4.length
...
//Thanks for installing my Virus-console_1.2!