...
// @version        1.6.2
// @downloadURL https://update.greasyfork.org/scripts/380894/Enhanced%20word%20highlight.user.js
// @updateURL https://update.greasyfork.org/scripts/380894/Enhanced%20word%20highlight.meta.js
// ==/UserScript==
...
// #### Config I #### --------------------------{{
	...
	urlArr[7] = ['cnki',	 'keyValue=',	 'kns.cnki.net'];
...
//			'#' + PRE + '_word_inputs_list > li > label > input[type=image]{vertical-align:top;padding:0;height:12px;}',
	...
	function get_KW_from_URL(urlsearch, _e) {
		...
		if (urlArr[_e][0] =='Baidu' && urlsearch.indexOf('ie=utf-8') == -1 && urlsearch.indexOf('ie=UTF-8') == -1) kwtmp = urlDecode(KW);  // 如果是百度且非utf-8  //2017-5-27百度似乎已经主用utf-8  //20170922 helloBibo 增加了“&& urlsearch.indexOf('ie=UTF-8') == -1”
