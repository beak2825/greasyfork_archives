// ==UserScript==
// @name   🌱【免费版】广东二师在线|如需自动下一集、自动换课程等高级功能见收费版本：https://doc.zhanyc.cn/pages/gdeszx/
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/521204/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%B9%BF%E4%B8%9C%E4%BA%8C%E5%B8%88%E5%9C%A8%E7%BA%BF%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesgdeszx.user.js
// @updateURL https://update.greasyfork.org/scripts/521204/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%B9%BF%E4%B8%9C%E4%BA%8C%E5%B8%88%E5%9C%A8%E7%BA%BF%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesgdeszx.meta.js
// ==/UserScript==
(function () {
    ...
    let docUrl = "https://doc.zhanyc.cn/pages/gdeszx/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (/\/study\/[0-9a-zA-Z]+\/activity/.test(url)) {
                plugMain.page_video();
            } else if (url.includes("/my/course/list")) {
        ...
        async page_video() {
            ...
            await plugMain.waitOf(a => $('.item4:visible').length > 0)
            await plugMain.waitTimeout(1000)
            let $el = null
            $('.item4:visible').each((i, el) => {
                if ($(el).find(".icon-icon_finish_R:visible").length == 0) {
                    $el = $(el)
                    return false
                }
            })
            if ($el == null) {
                plugMain.confirmRun("学习完成，前往列表页面").then(a => {
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if ($(".item4.active").find('.icon-icon_finish_R:visible').length > 0) {
                        plugMain.pageData.waitTime = 30
                        plugMain.alertMsg('当前视频完成')
                        return
                    }
