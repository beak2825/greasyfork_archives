// ==UserScript==
// @name         Nightmare AutoClicker Dual + Freeze (Simple MouseEvent Engine)
// @namespace    https://greasyfork.org/users/notnightmare
// @version      1.1
// @description  Dual left/right autoclicker with simple MouseEvent clicks (cps-test compatible), real cursor tracking, mouse/keyboard hotkeys, toggle/hold modes, and global freeze. Disabled on Discord.
// @author       NotNightmare
// @match        *://*/*
// @exclude      *://discord.com/*
// @exclude      *://*.discord.com/*
// @run-at       document-end
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/562042/Nightmare%20AutoClicker%20Dual%20%2B%20Freeze%20%28Simple%20MouseEvent%20Engine%29.user.js
// @updateURL https://update.greasyfork.org/scripts/562042/Nightmare%20AutoClicker%20Dual%20%2B%20Freeze%20%28Simple%20MouseEvent%20Engine%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    // ---- Settings + state ----
    var STORAGE_KEY = "nn_dual_autoclicker_settings_v2_simple_mouse";
    ...
    // ---- Core autoclick logic (SIMPLE MouseEvent engine) ----
    ...
    function simpleMouseDown(target, buttonCode) {
        // cps-test.org and many sites accept this ultra-simple event
        // We ignore buttonCode here to keep the event minimal and widely compatible
        try {
    ...
    function normalizeKey(e) {
        // Mouse buttons mapped as keys for binding
        if (e.type === "mousedown") {
    ...
    // Menu created lazily, opened with menu hotkey (default "m")
