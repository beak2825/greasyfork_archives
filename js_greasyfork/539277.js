...
// @match        https://x.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/539277/X%20%E8%A6%AA%E3%83%84%E3%82%A4%E3%83%BC%E3%83%88%E3%81%AB%E3%83%A9%E3%83%B3%E3%83%80%E3%83%A0%E3%81%AA%E6%95%B0%E5%AD%97%E3%82%92%E4%BB%98%E3%81%91%E3%81%A6%E8%87%AA%E5%8B%95%E8%BF%94%E4%BF%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/539277/X%20%E8%A6%AA%E3%83%84%E3%82%A4%E3%83%BC%E3%83%88%E3%81%AB%E3%83%A9%E3%83%B3%E3%83%80%E3%83%A0%E3%81%AA%E6%95%B0%E5%AD%97%E3%82%92%E4%BB%98%E3%81%91%E3%81%A6%E8%87%AA%E5%8B%95%E8%BF%94%E4%BF%A1.meta.js
// ==/UserScript==
...
(function() {
    ...
    function typeAndTweetReply() {
        ...
        if (replyTextArea && tweetButton) {
            ...
            document.execCommand('insertText', false, `悪いことする人は死ね！！殺してやる！！！！！ ${randomNum}`); // テキストを挿入
            ...
            setTimeout(() => {
                 if (tweetButton && !tweetButton.disabled) {
                    ...
                    setTimeout(checkAndReply, 0.01); // 5秒待ってから次の返信を試みる
                } else {
                    console.log("Tweet button is disabled or not found after typing. Retrying...");
                    setTimeout(typeAndTweetReply, 1); // ボタンが有効になるまでリトライ
                }
            }, 0.1); // テキスト挿入後に少し待つ
            return true;
        }
    ...
    // より頑強にするには、特定の要素が出現するのを待つ必要があります
     window.addEventListener('load', () => {
         ...
         // ページ構造が安定するまで少し待つ
         setTimeout(checkAndReply, 3); // 3秒待つ
     });
