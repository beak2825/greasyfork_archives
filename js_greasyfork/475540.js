// ==UserScript==
// @name         Sunset City | Discord Theme
// @namespace    http://tampermonkey.net/
// @version      2.2
// @description  A cool Discord Theme with better appearance and added animations that ACTUALLY WORKS without breaking or lagging the site.
// @author       Derpman
// @match        https://discord.com/*
// @icon         https://media.discordapp.net/attachments/967147505399771246/1152785485421367386/image.png?width=1024&height=386
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/475540/Sunset%20City%20%7C%20Discord%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/475540/Sunset%20City%20%7C%20Discord%20Theme.meta.js
// ==/UserScript==

// Define the CSS styles as a string
const cssStyles = `/*---------------------------------------- BACKGROUND ----------------------------------------*/
 body {
    background: url("https://media.discordapp.net/attachments/967147505399771246/1152785485421367386/image.png?width=1024&height=386");
...
/* MESSAGE BOX */
 .theme-light .quickMessage-1yeL4E, .theme-dark .quickMessage-1yeL4E {
    background-color: rgba(40, 40, 40, .4);
    border-radius: 15px;
    margin-top: 5px;
    -webkit-box-shadow: 0px 0px 2px 1px rgba(0, 0, 0, 0.4);
...
/* GRADIANT REMOVAL ON GAME SCROLL */
 .gradientOverlayRight-3vMuS8, .gradientOverlayLeft-3w159C {
    left: -1000px
}
...
/* FRIENDS TAB */
 .theme-light .container-1D34oG, .theme-dark .container-1D34oG {
    background-color: rgba(0, 0, 0, 0);
}
...
.theme-dark .wrapper-Lii66c, .theme-light .wrapper-Lii66c {
    background-color: #202225;
    border: 0px solid #e3e5e8;
}
...
.theme-light .separator-2c4hi3, .theme-dark .separator-2c4hi3 {
    background-color: #f7f7f78f;
}
.theme-dark .wrapper-9ppXpy, .theme-light .wrapper-9ppXpy {
...
/* BOTTOM WHITE BACKGROUND REMOVAL */
 .theme-light .bodyInner-245q0L, .theme-light .footer-1fjuF6 {
    background-color: rgba(0, 0, 0, 0);
}
/* BODY TEXT COLOR FIX */
 .theme-light .bodyInner-245q0L, .theme-light .footer-1fjuF6 {
...
.theme-light .autocompleteArrow-Zxoy9H, .theme-light .autocompleteHeaderBackground-30T70q {
    border-radius: 15px;
}
...
/* TEXTBOX TEXT COLOR CHANGE (MESSAGE) */
 .theme-light .quickMessage-1yeL4E::-webkit-input-placeholder, .theme-dark .quickMessage-1yeL4E::-webkit-input-placeholder {
...
/* MAKE (MESSAGE) TRANSPARENT WHEN CLICKED */
 .theme-light .quickMessage-1yeL4E:focus::placeholder, .theme-dark .quickMessage-1yeL4E:focus::placeholder {
...
/* BACKGROUND */
 .contextMenu-HLZMGh {
    background-image: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url("https://cdn.discordapp.com/attachments/892075644668739674/921063318700036156/707055.jpeg");
...
/* BAN/KICK BUTTONS NO HOVER */
 .itemBase-tz5SeC.danger-2dXSTE:nth-child(1), .itemBase-tz5SeC.danger-2dXSTE:nth-child(2) {
    background-color: rgba(64, 68, 75, 1);
    border: 2px solid rgba(13, 13, 15, .29);
    border-radius: 15px;
}
/* BAN/KICK BUTTONS HOVER */
 .itemBase-tz5SeC.danger-2dXSTE:nth-child(1):hover, .itemBase-tz5SeC.danger-2dXSTE:nth-child(2):hover {
...
.editor-H2NA06 {
background-color: #6d387250;
  opacity: 0.9;
}
/* bottom left corner user box */
.container-YkUktl {
  border-radius: 12px;
  opacity: 0.75;
    transition: .1s;
}
.container-YkUktl:hover {
  opacity: 1;
}
.attachButton-_ACFSu {
background-color: transparent;
}
/* text box or message box */
.scrollableContainer-15eg7h {
background-color: #6d387250;
}
/* server pane on left */
.scroller-3X7KbA {
background-color: #6d38728e;
  opacity: 0.9;
  border-radius: 10px;
}
.title-31SJ6t {
...
/* embeds */
.grid-1aWVsE {
background-color: #6d3872a9;
  border-radius: 10px;
}
/* slash command box or just box*/
.autocompleteInner-y1mjDl {
  background-color: rgba(109, 56, 114, 0.322);
}
.wrapper-1NNaWG{
  background-color: transparent;
  opacity: 1;
...
/* leaving discord dialog */
.content-1OG56Q {
  background-color: #712a77a9;
}
/*leaving discord dialog bottom*/
.horizontalReverse-60Katr {
  background-color: #712a77a9;
}
/* current server channel selected button color */
.modeSelected-3DmyhH .link-1_kTxV {
background-color: #6d3872a9;
}
/* friends list animiation */
.channel-1Shao0 .link-39sEB3 {
transition: .5s;
border-radius: 10px;
  background-color:#ffffff04;
}
/* user bio name etc background color */
.userPopoutOverlayBackground-3A0Pcz {
  background-color: #40404181;
}
/* role color*/
.role-2TIOKu {
...
.option-Uc12mm {
  background-color: #6d3872e8;
  transition: .2s;
}
.option-Uc12mm:hover {
  background-color: #532557e8;
}
/*dropdown menu background in general*/
.popout-15UxD6 {
  background-color: #6d3872dc;
}
/*fix rectangle around slash command in text box*/
.editor-H2NA06 {
  background-color: transparent;
}`;
...
// Set the style element's type to "text/css"
