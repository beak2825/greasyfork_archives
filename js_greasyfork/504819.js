...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/504819/%EB%91%98%ED%81%AC%EB%A6%BD%ED%8A%B8%20-%20%ED%8B%B0%EB%A7%812.user.js
// @updateURL https://update.greasyfork.org/scripts/504819/%EB%91%98%ED%81%AC%EB%A6%BD%ED%8A%B8%20-%20%ED%8B%B0%EB%A7%812.meta.js
// ==/UserScript==
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
            ...
            for (let i = 0; i < dates.length; i++) {
                if (dates[i].querySelector('a')) {
                    if (count === index) {
                        ...
                        setTimeout(() =>{reserveNext();},50);  // reserveNext() 함수 호출
        ...
        function handleF6() {
                ...
                const link = document.querySelector('a[ng-click="right.next()"]');
                if (link) {
                    link.click(); // 링크 클릭
