...
// @version      3.22
// @description  Revamped Blossom V2. Compatible with v45.0 and up.
// @author       ThatOneGuySS
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/480783/Blossom%20V3.user.js
// @updateURL https://update.greasyfork.org/scripts/480783/Blossom%20V3.meta.js
// ==/UserScript==
...
:root {
    ...
    --ss-lightoverlay: url(https://raw.githubusercontent.com/Foggier01/Blossom-V3-Fix-by-Foggier/main/MryoShellBG.jpg);
...
#best_streak_container h1 {
    ...
    padding-left: 1.25em;
    padding-top: 0em;
    background-image: url(https://raw.githubusercontent.com/Foggier01/Blossom-V3-Fix-by-Foggier/main/MyroStreak.png);
...
#killBox::before{
    font-size: 1em;
    font-weight: 900;
    content: 'YOU BLOSSOMED'!important;
    color: #f9b5b5;
}
...
#deathBox::before{
    font-size: 1em;
    font-weight: 900;
    content: 'YOU WERE BLOSSOMED BY'!important;
    color: #f9b5b5;
}
...
#hardBoiledShieldFill {
  content: url('https://raw.githubusercontent.com/Foggier01/Blossom-V3-Fix-by-Foggier/main/MyroShield.png');
}
...
.ss_field, .firebaseui-input {
    ...
    box-shadow: inset 0.3em .3em .03em rgb(0, 0, 0, 0.3) !important;
...
.play-panel-panels {
    ...
    color: var(--ss-white);
    background-image: var(--ss-lightoverlay) !important;
    border: var(--ss-common-border-width) solid var(--ss-blue5);
}
