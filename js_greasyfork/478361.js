...
// @downloadURL https://update.greasyfork.org/scripts/478361/v2.user.js
// @updateURL https://update.greasyfork.org/scripts/478361/v2.meta.js
// ==/UserScript==
...
(() => {
  ...
  var AimbotModule = class extends ToggleModule {
    ...
    onTick() {
      ...
      const opponents = this.state.getOtherPlayers() // Survival
        //const opponents = this.state.getOpponents(); // Normal
...
var ESPModule = class extends ToggleModule {
    constructor() {
      super(
        "V",
        "ESP",
        "Make other players visible through walls.",
        ["Off", "On"]
      );
    }
    ...
    update() {
      ...
      for (const player of players) {
        ...
        if (playerBox) {
            console.log(this)
            playerBox.renderOrder = 1e6;
            playerBox.material.depthTest = false;
        }
      }
    }
};
    ...
    var newModule = class extends ToggleModule {
    constructor() {
      super(
        "O",
        "XRAY",
    ...
    onModeChange() {
      ...
      if (this.isEnabled()) {
          ...
          this.state.scene.children[4].children[100].material.depthTest = false
                  //this.state.scene.autoUpdate = false;
      } else {
          this.state.scene.children[4].children[100].material.depthTest = true
  ...
  var VoxiomScript = class extends Script {
    ...
    constructor() {
      super(
        ...
        [new AimbotModule(), new ESPModule(), new newModule()],
        new VoxiomState(),
        "N",
        { right: "0", bottom: "50%" }
      );
