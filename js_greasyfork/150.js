...
// @namespace https://greasyfork.org/scripts/150
// @downloadURL https://update.greasyfork.org/scripts/150/tieba_faceText.user.js
// @updateURL https://update.greasyfork.org/scripts/150/tieba_faceText.meta.js
// ==/UserScript==
...
replyCss += "#newEditDiv{border: 1px solid gray; width:612px; z-index:10002; background-color:#EEEEEE; padding:20px; position:fixed; left:200px; bottom:80px;} #newEditDiv *:not(.pageTitle),#faceTextDiv *{font-size:12px !important;}";
