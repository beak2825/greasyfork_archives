// ==UserScript==
// @name         FreeCardano.com (Pescador de Cripto)
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/410976/FreeCardanocom%20%28Pescador%20de%20Cripto%29.user.js
// @updateURL https://update.greasyfork.org/scripts/410976/FreeCardanocom%20%28Pescador%20de%20Cripto%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function freecardano_com(){
        ...
        if (window.location.href.indexOf("freecardano.com/free") > -1) {
            setInterval(function(){
                window.history.go(0);
            },300000);
        }
    ...
    function open(){
        if (window.location.href.indexOf("pescadordecripto.com/dashboard") > -1) {
            window.open("https://freecardano.com/free", "FreeCardano","width=10,height=10,left=-3000,top=-3000");
        }
    ...
    if (window.location.href.indexOf("pescadordecripto.com/dashboard") > -1) {
        ...
        a.id = 'freecardano-com';
        a.className = 'faucet-link faucet-active';
        a.innerHTML = 'FREECARDANO.COM';
    ...
    if (window.location.href.indexOf("pescadordecripto.com/install") > -1) {
        document.getElementById('freecardano-com').classList.add("faucet-active");
    }
})();