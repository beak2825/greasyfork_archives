...
// @downloadURL https://update.greasyfork.org/scripts/413026/VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91.user.js
// @updateURL https://update.greasyfork.org/scripts/413026/VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91.meta.js
// ==/UserScript==
			...
			if (window.location.href.match(/\.163\..+?\/store/)) {} else {
				try {
					if (!document.querySelector("\u6c5f\u5c0f\u767d")) {
						document.body.appendChild(document.createElement("MS"));
						try {
					...
					function jxbvipobj() {
									...
									(function() {
										...
										let zdbfdsq = setInterval(function() {
											...
											if (zdbfaobj) {
												...
												log("%cMS--01-H5视频自动播放", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
												...
												log("%cMS--02-视频自动播放", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
												clearInterval(zdbfdsq);
												return false
											}++zdbf;
											if (zdbf > 25) {
						...
						function jxqzsxobj() {
							try {
								if (document.querySelector("iframe#MS")) {
									document.querySelector("div#MS").innerHTML = '<img id="MS" src="https://api.btstu.cn/sjbz/zsy.php" marginwidth="0" marginheight="0" width="100%" height="100%" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;">';
								} else if (document.querySelector("img#MS")) {} else {
									if (!document.querySelector("jxbvideo") && !document.querySelector("\u6c5f\u5c0f\u767d\u662f\u6211")) {
										document.body.appendChild(document.createElement("MS是我"));
										try {
											if (document.querySelector("div#MS>iframe#MS")) {} else if (document.querySelector("div#MS>img#MS")) {} else {
												(function() {
													try {
						...
						if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:pgso|o8tv|ak1080|miao101|douyin|kuaishou|douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|qq|xiami|migu|ximalaya|app-echo|1ting|lrts|haokan|baidu|wbdy|web3v|9ku)\./)) {
						...
						if (jxjkobj || objj.match(/m1907\./) || obj.match(/&autoplay=1&metareferer=/)) {
							...
							document.body.appendChild(document.createElement("MS电脑网页"));
							function jxbjkspbfjsobj() {
								(function() {
									if (!document.querySelector("\u6c5f\u5c0f\u767d\u76d1\u63a7\u89c6\u9891\u64ad\u653e\u7ed3\u675f")) {
										document.body.appendChild(document.createElement("MS监控视频播放结束"));
										try {
											if (document.querySelector('video')) {
							...
							if (obj.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|vku\.youku\.com\/live\/)/)) {
								...
								cssobj('#MS{position:relative!important;}div[class^="globallogin"]{z-index:2000000000!important;}[class^="pop-operates"],[id^="pop-operates"]');
							...
							} else if (obj.match(/^https?:\/\/www\.ak1080\.com\/(?:vodsearch|voddetail|vodplay)\//)) {
								if (obj.match(/\/vodplay\//)) {
									jxqtwzobj();
									jxzdqpobj();
									zdbt();
									cssobj('[color*="red"],div.maomibtn li#ckkjjjobjli,div.maomibtn a.maomi+ul>li:not([style]):not([id])');
								} else {}
								setTimeout(() => {
							...
							document.body.appendChild(document.createElement("MS手机网页"));
							var sjpdpthyobj;
						...
						function jxbmmanzxobj() {
							...
							if (obj.match(/^https?:\/\/(?:www\.wbdy\.tv|www\.ikukk\.com)\//)) {
								if (obj.match(/^https?:\/\/[^\/]+?\/$/)) {} else {
									...
									if (obj.match(/\/index.php\?m=vod-search/)) {
										...
										if (document.querySelector("MS电脑网页")) {
							...
							(function() {
								document.body.appendChild(document.createElement("我是MS生活很简单"));
								let aa = 1, bb = '<span><a1 style="display:none"></a1><a2 style="display:none">', cc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">', dd = '<span><a1 style="color:darkgreen">跳转</a1><a2 style="display:none">', ee = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">', eee = '<span style="background-color:cyan"><a1 style="color:darkgreen">Json</a1><a2 style="display:none">', ff = '<span><a1 style="color:darkgreen">大窗</a1><a2 style="display:none">', ii = '<span style="background-color:hotpink"><a1 style="color:darkgreen"></a1><a2 style="display:none">', kk = '<span style="display:grid;background-color:skyblue;font-weight:bold;border:5px outset buttonface;border-radius:5px;"><a1 style="border:5px outset buttonface;border-radius:5px;">小白自用</a1><a2 style="display:none">', jj = '<span style="background-color:darkorange"><a1 style="color:darkgreen"></a1><a2 style="display:none">', gg = '</a2><a3 style="color:#2196F3;zoom:0.8;font-weight:bold;">\u27bd</a3><a4>', hh = '</a2><a3 style="display:none"></a3><a4>', https = [{
									...
									name: bb + aa+++hh + "四看",
									url: "https%3A%2F%2Fbak.ojbkjx.com%2F%3Furl%3D"
								}, {
									name: bb + aa+++hh + "尊享",
									url: "aHR0cHM6Ly9wbGF5ZXIubWFxcS5jbi8/dXJsPQ=="
								}, {
									name: bb + aa+++hh + "福星",
									...
									name: bb + aa+++hh + "云海",
									url: "https%3A%2F%2Fvip.donggou.vip%2F%3Furl%3D"
								}, {
									name: bb + aa+++hh + "思云",
									url: "aHR0cHM6Ly92aXAuYXAycC5jbi8/dXJsPQ=="
								}, {
									name: bb + aa+++hh + "漂流",
									url: "https%3A%2F%2Fwww.playm3u8.cn%2Fjiexi.php%3Furl%3D"
								}, {
									name: ee + aa+++gg + "达人",
									url: "aHR0cDovL3ZpcDEyM2thbi52aXA6NTIwL20zdTgucGhwP3VybD0="
								}, {
									name: ee + aa+++gg + "盒子",
									url: "http://jx5.178du.com/p1/?url="
								}, {
									name: ee + aa+++gg + "碟调",
									url: "http://jx.zhiaiyy.top/?url="
								}, {
									name: ee + aa+++gg + "17云",
										...
										if (jxbpcobj) {} else {
											...
											httpsvipli.onclick = function() {
												try {
													...
													let tctha = '<div id="MS" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"><img id="MS" src="https://api.btstu.cn/sjbz/" marginwidth="0" marginheight="0" width="100%" height="100%" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"></img></div>';
													let tcthb = '<div id="MS" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"><img id="MS" src="' + jxbimg + '" marginwidth="0" marginheight="0" width="100%" height="100%" style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"></img></div>';
													function jxbjxqzbsobj() {
														jxqzsxobj();
														if ((objj.match(/qq\./) && https[num].name.match(/(?:思古)/) || https[num].name.match(/(?:久播|920|IK)/i))) {
															try {
																window.open(jjxxcc + atob(https[num].url.replace(/^[^:\/]*?(https?:\/\/)/igm, "$1").replace(/%20/gm, "").replace(/\s{1,}/gm, "")) + jxbjxurl, "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left=" + (screen.availWidth - 1050) / 2 + ",top=" + (screen.availHeight - 600) / 2);
															} catch (err) {
																window.open(jjxxcc + unescape(https[num].url.replace(/^[^:\/]*?(https?:\/\/)/igm, "$1").replace(/%20/gm, "").replace(/\s{1,}/gm, "")) + jxbjxurl, "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left=" + (screen.availWidth - 1050) / 2 + ",top=" + (screen.availHeight - 600) / 2);
															}
														} else {
															try {
																window.open(atob(https[num].url.replace(/^[^:\/]*?(https?:\/\/)/igm, "$1").replace(/%20/gm, "").replace(/\s{1,}/gm, "")) + jxbjxurl, "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left=" + (screen.availWidth - 1050) / 2 + ",top=" + (screen.availHeight - 600) / 2);
															} catch (err) {
																window.open(unescape(https[num].url.replace(/^[^:\/]*?(https?:\/\/)/igm, "$1").replace(/%20/gm, "").replace(/\s{1,}/gm, "")) + jxbjxurl, "bkmk_popup", "allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left=" + (screen.availWidth - 1050) / 2 + ",top=" + (screen.availHeight - 600) / 2);
															}
														}
													};
													try {
														if (document.querySelector("div#MS") != null) {
															zdydssjobj = '123';
														} else {
															zdydssjobj = '3456';
														}
														...
														if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
															try {
																if (!document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111")) {
																	document.body.appendChild(document.createElement("MS电脑"));
																	if (localStorage.getItem("jxzdqp") == '1') {
																		function qpobj(quanping) {
																			try {
																...
																} else {} if (document.querySelector('div#MS')) {
																	pczdydssjobj = '123';
															...
															if (objj.indexOf('youku') > 0) {
																...
																if (obj.indexOf('mgtv.com/b/') > 0) {
																	...
																	if (!document.querySelector("#MS") && document.querySelector("ul.v-lists")) {
															...
															try {
																if (document.querySelector('div#MS')) {
																	sjzdydssjobj = '123';
																} else if (localStorage.getItem("vipzdjx") == '0') {
																	sjzdydssjobj = '123';
													...
													function vipobj(vip) {
														...
														try {
															...
															setTimeout(function() {
																...
																try {
																	window.scrollTo(0, document.querySelector("div#MS").offsetTop);
																} catch (err) {}
															}, 123);
														} catch (err) {}
														if (!document.querySelector("\u6211\u662f\u6c5f\u5c0f\u767d")) {
															document.body.appendChild(document.createElement("我是MS"));
															(function() {
																try {
																	let zdjkhttpsjk_counter = 0;
																	let zdjkhttpsjk_jiankong = setInterval(function() {
															...
															setTimeout(function() {
																try {
																	if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
																		try {
																			if (document.querySelector("img#MS") && !jxb.match(new RegExp("视频选集"))) {
																				try {
																					GM_setValue('视频自动全屏', '关闭');
																				} catch (err) {}
																			} else if (document.querySelector("iframe#MS") && GM_getValue('视频自动全屏').match(/^\s*?开启\s*?$/) && !GM_getValue('视频自动全屏').match(/^\s*?关闭\s*?$/) && !jxb.match(new RegExp("视频选集"))) {
																				try {
																					qpobj(document.querySelector('iframe#MS'));
																					setTimeout(function() {
																						qpobj(document.querySelector('iframe#MS'));
																					}, 1234);
																					setTimeout(function() {
																					...
																					pcspzdqpaobj = setInterval(function() {
																						if (document.querySelector("iframe#MS").offsetWidth == document.body.offsetWidth) {
								...
								if (jxbpcobj) {
									...
									try {
										...
										try {
											...
											let sjtzsjzdylwobj = /(?:七年|蓝影|冰豆|师兄|麻瓜|文笔|[教文方]案|挚爱|云栖)/, sjqjpbzdylwobj = /(?:猪蹄|大白|丝瓜|夷狄|无尽|江湖|乐多|思古|历程|三二|17云|临时|丽江|云波|时光|锦云|说说|回响|夜空|星影|1717|8090|唯多|无名|墨鱼|哔哩|淘影|诺讯|大亨|小蒋|玩嗨|九八|恐龙|福星|漂流|极速|刺客|七彩|音萌|恶灵|碟调|浴霸|PAR|CKP|OK|Youtube|大师|解啦|酷点|一零|六六|盘古|和巴|星驰|云端|奇米|片库|狼云|透明无接口)/i, sjyyyzdypbobj = /(?:扫描|夜幕|久已|七哥|虾米|百度|月亮|看剧|玻璃|海绵|我爱|神马|酷看|七彩|久播|恶灵|吉塔|盖斯|思[云念]|蘑菇|迪奥|618G?|147|256|365|920|973|4080|黑云|九八|金桥)/i;
							...
							setTimeout(function() {
								if (document.querySelector("#MS") == null) {
									if (!obj.match(/^https?:\/\/(?:3g|m)\./) && (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null)) {
										if (objj.match(/mgtv/)) {
											setTimeout(function() {
						...
						function zdbt() {
							if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
								if (document.querySelector("\u6c5f\u5c0f\u767d\u6807\u9898") != null) {
									...
									document.body.appendChild(document.createElement("MS标题"));
								} else {
									document.body.appendChild(document.createElement("MS标题"));
								}
								if (document.querySelector("\u6c5f\u5c0f\u767d\u6807\u9898") != null) {
						...
						function zddjobj() {
							if (!document.querySelector("\u6c5f\u5c0f\u767d\u81ea\u52a8\u70b9\u51fb\u63a5\u53e3")) {
								document.body.appendChild(document.createElement("MS自动点击接口"));
								try {
									if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) {
										try {
											GM_setValue('视频自动全屏', '开启');
								...
								if (localStorage.getItem("vipzdjx") == '0') {} else {
									...
									if (obj.match(/^https?:\/\/m\.mgtv\./)) {} else {
										setTimeout(function() {
											if (document.querySelector("div#MS>iframe#MS")) {
												return false;
											} else if (document.querySelector("div#MS>img#MS")) {
												return false;
											} else {
												try {
													document.querySelector("jiangxiaobai").remove();
								...
								function panduanshebeiobj() {
									...
									function zdpddyobj() {
										if (!document.querySelector("\u6c5f\u5c0f\u767d\u81ea\u52a8\u5224\u65ad\u591a\u4f59")) {
											document.body.appendChild(document.createElement("MS自动判断多余"));
										} else {}
									}; if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") !== null) {
										function dnzdpdobj() {
											if (!document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u81ea\u52a8\u5224\u65ad")) {
												document.body.appendChild(document.createElement("MS电脑自动判断"));
											} else {}
										};
										...
										function jiangxiaobaiviphyzdpd() {
											if (obj.match(/&autoplay=1&metareferer=/)) {
																...
																setTimeout(function() {
																	if (document.querySelector("video").currentTime > 0) {} else {
																		if (!document.querySelector("\u6c5f\u5c0f\u767d\u5168\u5c4f")) {
																			document.body.appendChild(document.createElement("MS全屏"));
																		} else {}
																		alert('此接口暂时无法解析，请自行更换 接口');
																		window.close();
																	}
											...
											} if (!document.querySelector('div#MS') && document.querySelector("jiangxiaobai") && !document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u81ea\u52a8\u5224\u65ad") && ((mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 1 || vipzdjx == 2))) {
													...
													try {
														if (obj.match(/^https?:\/\/v(?:-wb)?\.youku\.com\/v_show\/id_/)) {
															if ($("#toast_text:contains('试看')")[0] || $("#toast_text:contains('完整')")[0] || $("#toast_text:contains('购买')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-优酷会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($("#vip_limit_content:contains('试看')")[0] || $("#vip_limit_content:contains('完整')")[0] || $("#vip_limit_content:contains('购买')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-优酷会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-优酷会员自动解析-03-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																...
																if ($("div.drm-error-layer div.note_normal_tit:contains('版权'):contains('加密'):contains('不支持')")[0] && document.querySelector('div.preplay-layer>img[src*="/"]') && $("div.note_error_item_title:contains('换'):contains('浏览器')")[0]) {
																	...
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%cMS-电脑-优酷会员自动解析-04-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																} else {}
															} else {}
														} else if (obj.match(/^https?:\/\/[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)/)) {
															if ($("div.information-tips:contains('看'):contains('会员')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-土豆会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($("div.vip_info:contains('看'):contains('会员')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-土豆会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
															...
															if (localStorage.getItem("ymyypdobj") == '0') {
																if ((((!document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl]') && document.querySelector('[class*="item"][class$=" current"]:not([tabindex]) i[class="mark_v"]>img[src*="_vip"]:not([alt])[src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])')) || (document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl] i[class="mark_v"]>img[src*="_vip"][alt][src$=".png"]:not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*=".png/"])') && document.querySelector('[class*="item"][class$=" current"]:not([tabindex]) i[class="mark_v"]>img[src*="_vip"][src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])')) || document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl] i[class="mark_v"]>img[src*="_vip"]:not([alt])[src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])')) && document.querySelector("video") != null) && !$("txpdiv.txp_ad_inner txpdiv.txp_ad_control txpdiv.txp_ad_skip_text:contains('关闭'):contains('广告')")[0]) {
																	...
																	document.querySelector("jiangxiaobai").remove();
																	log("%cMS-电脑-腾讯会员自动解析-00-a-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																}
															} else {}
															if ($("txpdiv.txp_alert_info:contains('试看')")[0] && $("txpdiv.txp_alert_info txpdiv:contains('会员')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($("div.wrapper.mod_vip_popup:contains('会员'):contains('看')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-03-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-04-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($('[data-role*="ui-error"]:contains("版权"):contains("加密"):contains("不支持"):contains("播放")')[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-05-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($(".content h1:contains('会员'):contains('超前'):contains('点播')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-06-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($('txpdiv[data-role*="tips"][data-role*="text"]:contains("试看"):contains("分钟")')[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-07-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($('[data-role*="txp-ui-tips"]:contains("版权"):contains("购买")')[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-08-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($('[data-role^="txp-ui-tips"]:contains("会员"):contains("看")')[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-腾讯会员自动解析-09-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
																...
																if ((mgzdgq == 1 || mgzdgq == 2) && document.querySelector(".m-player-h5-new .u-control-clarity .btn") && document.querySelector(".m-player-h5-new .u-control-clarity .btn").innerText.match(/^\s*?自动/) && vipzdjx != 1 && !document.querySelector("\u6211\u662f\u7535\u8111\u8292\u679c")) {
																	if (mgzdgq == 1) {
																		if (document.querySelector('a[data-name="超清"][data-purview="true"]')) {
																			...
																			log("%cMS-电脑-芒果自动选择超清-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																			...
																			log("%cMS-电脑-芒果自动选择高清-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																		} else {}
																	} else if (mgzdgq == 2) {
																		if (document.querySelector('a[data-name="高清"][data-purview="true"]')) {
																			dnmgqxdpdobj();
																			document.querySelector('a[data-name="高清"][data-purview="true"]').click();
																			log("%cMS-电脑-芒果自动选择高清-03-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																		} else {}
																	}
																} else {}
															} catch (err) {}
															if (vipzdjx == 2 && obj.match(/^https?:\/\/(?:ww)?w\.mgtv\.com\/b\//)) {
																if ($("div.control-tips-line>p:contains('费'):contains('看')")[0]) {
																	...
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%cMS-电脑-芒果TV会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																	...
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%cMS-电脑-芒果TV会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																	...
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%cMS-电脑-芒果TV会员自动解析-03-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																} else if ($("mango-control-tip p:contains('看'):contains('分钟')")[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%cMS-电脑-芒果TV会员自动解析-04-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																} else if ($(".m-player-paytips-wrapper div.m-player-paytips-title:contains('会员'):contains('看')")[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%cMS-电脑-芒果TV会员自动解析-05-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																} else if ($("mango-center-state-payment:contains('购买')")[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%cMS-电脑-芒果TV会员自动解析-06-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																} else if ($("mango-control-tip:contains('完整')")[0]) {
																	dnzdpdobj();
																	zdztsp();
																	document.querySelector("jiangxiaobai").remove();
																	zddjobj();
																	log("%cMS-电脑-芒果TV会员自动解析-07-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																} else {}
															} else {}
															...
															if (localStorage.getItem("ymyypdobj") == '0') {
																if ((document.querySelector('ul>li[class*="item"][class$=" selected"] img[src*="/vip"][src$=".png"]:not([src*=".png/"])[srcset*="/vip"][srcset*=".png"]:not([srcset*=".png/"])') || document.querySelector('ul>li[class*="item"][class$=" selected"] img[src*="/VIP"][src$=".png"]:not([src*=".png/"])[srcset*="/VIP"][srcset*=".png"]:not([srcset*=".png/"])')) && document.querySelector('[tabindex="-1"][data-player-hook]>video[src^="blob:http"]')) {
																	...
																	setTimeout(function() {
																		...
																		document.querySelector("jiangxiaobai").remove();
																		zddjobj();
																		log("%cMS-电脑-爱奇艺会员自动解析-00-a-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																	}, 2345);
																	...
																	setTimeout(function() {
																		...
																		document.querySelector("jiangxiaobai").remove();
																		zddjobj();
																		log("%cMS-电脑-爱奇艺会员自动解析-00-b-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																	}, 2345);
																}
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-爱奇艺会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-爱奇艺会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-爱奇艺会员自动解析-03-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($("iqpspan:contains('试看')")[0] || $("iqpspan:contains('完整')")[0] || $("iqpspan:contains('开通')")[0] || $("iqpspan:contains('购买')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-爱奇艺会员自动解析-04-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($('[data-player-hook*="error"]:contains("不支持"):contains("请")')[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-爱奇艺会员自动解析-05-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
														} else if (obj.match(/^https?:\/\/tv\.sohu\.com\/v\//)) {
															if (!$("#player_vipTips:contains('以上画质')")[0] && $("#player_vipTips p:contains('会员'):contains('看')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-搜狐电视会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
														} else if (obj.match(/^https?:\/\/film\.sohu\.com\/album\//)) {
															if ($("div.x-dash-tip-panel>span:contains('看'):contains('分钟')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-搜狐电影会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($('[class="x-tip-btn x-tip-vip"]:contains("购买")')[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-搜狐电影会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
														} else if (obj.match(/^https?:\/\/www\.le\.com\/ptv\/vplay\//)) {
															if ($("div.playbox_vip_tip_bg.j-vipTip:contains('会员'):contains('看')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-乐视会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($("div.hv_tip1.js-tip:contains('看'):contains('会员')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-乐视会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
														} else if (obj.match(/^https?:\/\/v\.pptv\.com\/show\//)) {
															if ($('[class*="tips-content"]:contains("费"):contains("看")')[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-PPTV会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($('[class*="buyGuidance"]:contains("费"):contains("看")')[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-PPTV会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
														} else if (obj.match(/^https?:\/\/vip\.1905\.com\/play\//)) {
															if ($("div.sb-toggle-card.card-pay.card-active:contains('费')")[0] && $("div.pay-mod-notlogin>div.notlogin-login:contains('会员'):contains('看')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-1905会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-1905会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-1905会员自动解析-03-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
														} else if (obj.match(/^https?:\/\/www\.wasu\.cn\/.+?\/show\/id\//)) {
															if ($("#flashContent ws-tipinfo:contains('费'):contains('看')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-华数TV会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
														} else if (obj.match(/^https?:\/\/www\.bilibili\.com\/bangumi\/play\//)) {
															if ($("#player_mask_module div.twp-title:contains('会员'):contains('看')")[0] && $("#player_mask_module div.twp-btns:contains('会员')")[0]) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-哔哩哔哩会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($(".bilibili-player-video-toast-item .video-float-hint-text:contains('会员'):contains('看')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-哔哩哔哩会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($(".mask-info:contains('地区'):contains('无法')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-哔哩哔哩会员自动解析-03-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else if ($(".twp-title:contains('会员')")[0]) {
																dnzdpdobj();
																zdztsp();
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-哔哩哔哩会员自动解析-04-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
															...
															if (document.querySelector('li[class="single-p active"][data-href] span').innerText.match(/^\s*?(?:vip|付费|抢鲜)\s*?$/i)) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-AcFun会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
															...
															if ($('[class$="__gold"]:contains("完整")')[0] && document.querySelector("div.payBtn")) {
																...
																document.querySelector("jiangxiaobai").remove();
																zddjobj();
																log("%cMS-电脑-西瓜视频会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
															} else {}
														} else {}
													} catch (err) {}
												}
												if (vipzdjx == 1) {
													...
													setTimeout(function() {
														...
														document.querySelector("jiangxiaobai").remove();
														zddjobj();
														log("%cMS-电脑全局自动解析-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
													}, 2345);
												} else {}
											} else {}
										}
										...
										function sjzdpdobj() {
											if (!document.querySelector("\u6c5f\u5c0f\u767d\u624b\u673a\u81ea\u52a8\u5224\u65ad")) {
												document.body.appendChild(document.createElement("MS手机自动判断"));
											} else {}
										};
										function jiangxiaobaiviphyzdpd(ele) {
											...
											} else {} if (!document.querySelector('div#MS') && document.querySelector("jiangxiaobai") && !document.querySelector("\u6c5f\u5c0f\u767d\u624b\u673a\u81ea\u52a8\u5224\u65ad")) {
												if (vipzdjx == 1) {
													if (obj.match(/^https?:\/\/m\.mgtv\.com\/b\//)) {
														if ($('[class*="box"]:contains("费"):contains("看")')[0]) {
															...
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%cMS-手机-芒果TV会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
														} else if ($('[class*="error"]:contains("版权"):contains("限制")')[0]) {
															sjzdpdobj();
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%cMS-手机-芒果TV会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
														} else {}
													} else if (obj.match(/^https?:\/\/m\.pptv\.com\/show\//)) {
														if ($('[class*="tip"]:contains("看"):contains("费")')[0]) {
															...
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%cMS-手机-PPTV会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
														} else if ($('[class*="info"]>[class*="title"] i[class*="icon"]:contains("VIP")')[0] && $('[id*="play-complete-"]:contains("看"):contains("完整")')[0]) {
															sjzdpdobj();
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%cMS-手机-PPTV会员自动解析-02-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
														} else {}
													} else if (obj.match(/^https?:\/\/www\.wasu\.cn\/.+?\/show\/id\//)) {
														if ($('a>p:contains("费"):contains("看")')[0]) {
															...
															document.querySelector("jiangxiaobai").remove();
															zddjobj();
															log("%cMS-手机-华数会员自动解析-01-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
														} else {}
													} else {}
												} else if (vipzdjx == 2) {
													sjzdpdobj();
								...
								if (window.location.href.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|m\.youku\.com\/.+?\/id_|[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)|v\.qq\.com\/(?:x\/cover|variety\/p\/topic)\/|(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)|w(?:ww)?\.mgtv\.com\/(?:b|act)\/|m\.mgtv\.com\/b\/|www\.iqiyi\.com\/(?:[awv]_|kszt\/)|tw\.iqiyi\.com\/v_|m\.iqiyi\.com\/v_|tv\.sohu\.com\/v\/|film\.sohu\.com\/album\/|m\.tv\.sohu\.com\/(?:v|phone_play_film\?aid=)|www\.le\.com\/ptv\/vplay\/|m\.le\.com\/vplay_|v\.pptv\.com\/show\/|m\.pptv\.com\/show\/|vip\.1905\.com\/play\/|www\.wasu\.cn\/.+?\/show\/id\/|www\.bilibili\.com\/bangumi\/play\/|m\.bilibili\.com\/bangumi\/play\/|www\.acfun\.cn\/bangumi\/|m\.acfun\.cn\/v\/|www\.fun\.tv\/vplay\/g-|www\.ixigua\.com\/\d{10,})/) && !(window.location.href.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/(?:a_|kszt\/)/) && document.title.match(new RegExp("在线观看"))) && !(window.location.href.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/v_/) && document.title.match(new RegExp("名师课堂")))) {
									...
									(function() {
										try {
											...
											document.addEventListener('visibilitychange', function() {
												let videoaobj = document.querySelector("video"), videobobj = document.querySelector('div#MS');
										...
										function sddja() {
											if (pcliwaiobj || ttbkjjliobj) {
												if (pcliwaiobj) {
													(function() {
														try {
															if (document.querySelector("iframe#MS") && !objj.match('ixigua\.')) {
																try {
																	if (!document.querySelector("img#MS")) {
																		try {
																			qpobj(document.querySelector('iframe#MS'));
																		} catch (err) {}
																	} else {}
																...
																$(function() {
																	...
																	var qjsdjk_jiankong = setInterval(function() {
																		...
																		if (qjsdjk_btn) {
																			jxqzsxobjzdbtobj();
																			zddjjk();
																			if (!document.querySelector("img#MS") && !objj.match('ixigua\.')) {
																				(function() {
																					try {
																						let sdjxyywzdqp_counter = 0;
																						let sdjxyywzdqp_jiankong = setInterval(function() {
																							let sdjxyywzdqp_btn = document.querySelector("iframe#MS");
																							if (sdjxyywzdqp_btn) {
																								try {
																									qpobj(document.querySelector('iframe#MS'))
																								} catch (err) {}
										...
										function ptsphzh() {
											if ((pcliwaiobj && !jxbpclwobj) || objj.match('(?:bilibili|acfun)')) {
												(function() {
													try {
														(async() => {
															const videos = Array.from(!document.querySelector("#MS") && document.querySelectorAll('video')).filter(video => video.readyState != 0).filter(video => video.disablePictureInPicture == false).sort((v1, v2) => {
											...
											if (pcliwaiobj && !objj.match('ixigua\.')) {
												(function() {
													try {
														...
														const sjjkslobjb = document.querySelectorAll("#httpsvipul>li");
														let arrb = [], arrbhttpsjk;
														for (let sjjkslobjbi = 0; sjjkslobjbi < sjjkslobjb.length; sjjkslobjbi++) {
															if ((sjjkslobjb[sjjkslobjbi].style.display != 'none') && (sjjkslobjb[sjjkslobjbi].querySelector('a1').innerText.match(/^\s*?[小大]窗\s*?$/))) {
																arrb.push(sjjkslobjb[sjjkslobjbi].querySelector('a2').innerText)
															}
														};
														...
														document.querySelector("ul#httpsvipul>li:nth-child(" + arrbhttpsjk + ")>span").style.backgroundImage = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=)";
											...
											if (pcliwaiobj && !objj.match('ixigua\.')) {
												(function() {
													try {
														...
														const sjjkslobja = document.querySelectorAll("#httpsvipul>li");
														let arra = [], arrahttpsjk;
														for (let sjjkslobjai = 0; sjjkslobjai < sjjkslobja.length; sjjkslobjai++) {
															if ((sjjkslobja[sjjkslobjai].style.display != 'none') && (sjjkslobja[sjjkslobjai].querySelector('a1').innerText == "")) {
																arra.push(sjjkslobja[sjjkslobjai].querySelector('a2').innerText)
															}
														};
														...
														document.querySelector("ul#httpsvipul>li:nth-child(" + arrahttpsjk + ")>span").style.backgroundImage = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=)";
