// ==UserScript==
// @name         ExP Old.Ogarul.io
// @namespace    http://tampermonkey.net
// @version      0.9
// @description  Edited by Vega.
// @author       Edited by Vega.
// @match        http://old.ogarul.io/*
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/24383/ExP%20OldOgarulio.user.js
// @updateURL https://update.greasyfork.org/scripts/24383/ExP%20OldOgarulio.meta.js
// ==/UserScript==
...
var Dingus = false;
var imlost = 25;
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_e'> Press <b>A</b> or <b>4</b> to split 4x</span></span></center>";
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> Edited by <b>Vega</b>. Have Fun!</span></span></center>";
load();
function load() {
...
function keydown(event) {
    ...
    if (event.keyCode == 71 || event.keyCode == 52) { //( ͡° ͜ʖ ͡°)
        ilikedick();
