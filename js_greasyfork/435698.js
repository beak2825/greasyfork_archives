...
// @downloadURL https://update.greasyfork.org/scripts/463907/%E5%85%A8%E7%BD%91VIP%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90%E6%92%AD%E6%94%BE%E5%99%A8%28%E5%B7%B2%E9%80%82%E9%85%8D%E6%89%8B%E6%9C%BA%29.user.js
// @updateURL https://update.greasyfork.org/scripts/463907/%E5%85%A8%E7%BD%91VIP%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90%E6%92%AD%E6%94%BE%E5%99%A8%28%E5%B7%B2%E9%80%82%E9%85%8D%E6%89%8B%E6%9C%BA%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    (async function () {
            ...
            if (window === top) {
                ...
                */
                settings.NoAD解析 = {    // TODO by 17kyun.com/api.php?url=    // TODO by tv.hzwdd.cn
                    ...
                    "每日解析": "https://jx.mr1j.com/vip/?h2url=" || "https://video.qianyicp.com/player/index.php?url=",    // TODO 腾讯 爱奇艺 优酷 (搜狐) 芒果 (pptv) (咪咕) (乐视) (CCTV)
                    ...
                    // "久播解析": "https://jx.jiubojx.com/vip/?url=" || "https://www.qianyicp.com/vip/vip_g.php?url=",
                    // _4K解析: "https://vip.jx4k.com/vip/?url=",    // TODO 已失效
                ...
                settings.AD解析 = {    // TODO (有赌博广告，请勿相信，这么简单的骗术不会有人上当吧)
                    ...
                    "JY解析": "https://jx.playerjy.com/?ads=0&url=",    // TODO 腾讯
                ...
                settings.Default解析 = {      // 配置优先解析源
                    ...
                    "咪咕视频": {
                        "电脑端": [settings.NoAD解析["每日解析"], settings.AD解析["JY解析"], settings.AD解析["TV解析"]],
                        "手机端": []
                    },
                    "乐视TV": {
                        "电脑端": [settings.NoAD解析["每日解析"], settings.AD解析["JY解析"], settings.AD解析["TV解析"]],
                    ...
                    "搜狐视频": {
                        "电脑端": [settings.NoAD解析["每日解析"], settings.NoAD解析["夜幕解析"]],
                    ...
                    "PPTV": {
                        "电脑端": [settings.NoAD解析["每日解析"], settings.NoAD解析["OK解析"]],
                        "手机端": [settings.NoAD解析["OK解析"]]
                    },
                    "1905电影网": {
        ...
        // 浏览器功能包
        await require(location.protocol + "//greasyfork.org/scripts/452253/code/user.js");
        // 自用算法包
        await require(location.protocol + "//greasyfork.org/scripts/453383/code/user.js");
        ready(function () {
                ...
                if (!isMobile) {
                    if (location.host.indexOf("v.qq.com") !== -1) {
                        ...
                        // doElement("div.side-cont.tvg", function () {
                            // return
                        readyPlayerBox("爱奇艺", ["#playerPopup", "#modal-vip-cashier-scope", "div[class^=qy-header-login-pop]"], settings.Default解析["爱奇艺"]["电脑端"],
    ...
    async function require(url) {
        ...
        try {
            ...
            let nameKey = window.name;
            // await 等待完成或window.name会莫名其妙被清空
            await (function () {
