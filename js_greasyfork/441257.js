...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/441257/Old%201%20Key%20Finesse.user.js
// @updateURL https://update.greasyfork.org/scripts/441257/Old%201%20Key%20Finesse.meta.js
// ==/UserScript==
...
(function() {
    ...
    ****************/
    ...
    // (case sensitive)
    var expectedUsername = "Justin1KF"
    ...
    ****************/
    ...
    if (expectedUsername != "") {
        ...
        var username = navbarRight[navbarRight.length-1].innerText.split(' ')[0];
 
        if (username == "Register") { // guest
            if (!runWhenGuest) {
                console.log("1KF disabled; runWhenGuest is false");
                return;
            }
        }
