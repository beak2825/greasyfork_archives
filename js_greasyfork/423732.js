...
// @downloadURL https://update.greasyfork.org/scripts/423732/Krunker%20SkidFest.user.js
// @updateURL https://update.greasyfork.org/scripts/423732/Krunker%20SkidFest.meta.js
// ==/UserScript==
...
(function(skidStr, CRC2d, skid) {
    ...
    class Skid {
        ...
        createSettings() {
            ...
            this.settings = {
                ...
                showSkidBtn: {
                    ...
                    set: (value, init) => {
                        ...
                        if (!this.isDefined(button)) this.createButton("5k1D", "https://i.imgur.com/krfAACY.png", this.toggleMenu, value)
            ...
            menu.gen = _ => {
                var tmpHTML = `<div style='text-align:center'> <a onclick='window.open("https://www.youtube.com/channel/UCKN9qye5ZIGvCvq0fwrRNjg")' class='menuLink'>SkidFest Settings</center></a> <hr> </div>`;
        ...
        iframe() {
			...
			//request.open('GET', 'https://www.youtube.com/channel/UCKN9qye5ZIGvCvq0fwrRNjg', false);
			//request.send(null);
