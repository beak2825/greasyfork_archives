// ==UserScript==
// @name         GRCRTools ANTI SPAM OFF
// @author       Potusek & Anpu & marius81
...
// @namespace https://greasyfork.org/users/562836
// @downloadURL https://update.greasyfork.org/scripts/403339/GRCRTools%20ANTI%20SPAM%20OFF.user.js
// @updateURL https://update.greasyfork.org/scripts/403339/GRCRTools%20ANTI%20SPAM%20OFF.meta.js
// ==/UserScript==
        ...
        f.iron, f.power = -1 < c.url.indexOf("decrease_build_time_with_favor") ? 400 : 0, RepConv.Debug && console.log(f)), $.each(Layout.wnd.getAllOpen(), function(c, d) {
          ...
          switch(c.getController()) {
            ...
            case "wonders":
              ...
              RepConv.Debug && console.log(d);
              try {
                RepConv.settings[RepConv.Cookie + "_wonder_trade"] && 0 < d && (WorldWonders.spinners.wood.setValue(d / 3), WorldWonders.spinners.stone.setValue(d / 3), WorldWonders.spinners.iron.setValue(d / 3));
              } catch (Ia) {
              }
              va(c);
              break;
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    ...
    $.Observer(require("data/events").attack.incoming).subscribe("GameEvents.grcrt.attackIncomming", function(a, b) {
      setTimeout(function(){da(b.count);},60000);
    });
