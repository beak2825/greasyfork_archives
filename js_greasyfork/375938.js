...
// @downloadURL https://update.greasyfork.org/scripts/375938/Popup%20Search.user.js
// @updateURL https://update.greasyfork.org/scripts/375938/Popup%20Search.meta.js
// ==/UserScript==
...
PopupInit = function () {
  ...
  $('#ShowUpBox').remove();
  EngineList = "<a id='transBtn'> <img title='翻译' src='" + popData.icons.translateIcon + "' /> </a> <a id='copy_btn'> <img title='Copy' src='" + popData.icons.copyIcon + "' /> </a>";
  ref = popData.engines;
