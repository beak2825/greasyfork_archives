...
// @downloadURL https://update.greasyfork.org/scripts/36194/Logtime%20Plus.user.js
// @updateURL https://update.greasyfork.org/scripts/36194/Logtime%20Plus.meta.js
// ==/UserScript==
        ...
        <feMergeNode in=\"SourceGraphic\"/>\
                ...
                for(var i = 0; i <= max; i++) {
                  ...
                  if ( texts[i].firstChild )
                     console.log( "TG = " + texts[i].firstChild.tagName);
                  if (texts[i].tagName == 'g' && texts[i].firstChild && texts[i].firstChild.tagName == 'rect')
                  {
                    ...
                    console.log("ppt = " + n +" pp ="+kmatch);
                    if (texts[i].childNodes[1])
                    sum = mois_j[n+kmatch - 1][texts[i].childNodes[1].innerHTML];
                    
                    console.log('en x =' + texts[i].childNodes[0].getAttribute('x'));
                    texts[i].setAttribute("hoursum", minTommss(sum));
                    texts[i].setAttribute("x", texts[i].childNodes[0].getAttribute('x') );
                    texts[i].setAttribute("y", texts[i].childNodes[0].getAttribute('y') );
                  ...
                  if ( oldx == 726.5 || oldx == 264.5 || oldx == 572.5 || oldx == 418.5 ||  match || last)
                    {
