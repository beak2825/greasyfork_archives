...
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/468676/%D0%96%D0%B1%20%D0%B4%D0%BB%D1%8F%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%BE%D0%B2%2020.user.js
// @updateURL https://update.greasyfork.org/scripts/468676/%D0%96%D0%B1%20%D0%B4%D0%BB%D1%8F%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%BE%D0%B2%2020.meta.js
// ==/UserScript==
...
(function () {
    ...
    },
    {
      ...
      content:
        '[CENTER][SIZE=4][FONT=times new roman][COLOR=rgb(255, 0, 0)]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE]<br><br>' +
        "[SIZE=4][COLOR=rgb(209, 213, 216)][FONT=times new roman]Ваша жалоба передана руководству сервера.[/FONT][/COLOR][/SIZE]<br>" +
        '[SIZE=4][FONT=times new roman][COLOR=rgb(209, 213, 216)]Не нужно создавать копии этой жалобы, ожидайте ответа в этой теме.[/COLOR][/FONT][/SIZE][/CENTER]',
      prefix: PIN_PREFIX,
      status: true,
      color: "orange"
    ...
    },
    {
      ...
      content:
        ...
        "[COLOR=rgb(209, 213, 216)]Приятной игры на [/COLOR][COLOR=rgb(209, 213, 216)]BLACK RUSSIA Penza.<br>" +
    ...
    },
    {
      ...
      content:
        ...
        "Приятной игры на BLACK RUSSIA Penza.[/SIZE][/COLOR][/FONT]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]{{ greeting }}, уважаемый игрок.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Срок написания жалобы - 48 часов с момента выдачи наказания.[/SIZE][/FONT]<br>" +
    ...
    function buttonsMarkup(buttons) {
        return `<div class="select_answer">${buttons
            ...
            `rippleButton" style=" color:${btn.color};margin:5px;font-weight: bold"><span class="button-text">${btn.title}</span></button>`,
        )
            .join('')}</div>`;
    }
