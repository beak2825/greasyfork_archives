...
setTimeout(function () {
    if(typeof(acTB) == "undefined"){
        ...
        (function(){
            ...
            function loadSC(){
                // 搜索的时候增加优惠信息
                addStyle(".copon-search-list{cursor:pointer;background:url() no-repeat;display:inline-block;position:absolute;top:0;right:0;font-size:14px;color:#f95d50 !important;height:23px;padding: 0 8px 0 8px;background-size: 100% 100%;text-align:center;text-decoration:none!important;z-index:1;}");
            ...
            addStyle(".ac-btn:hover,.tm-detailGo-btn:hover{color: #f95d50!important;}.acMobileQRPanel{display:grid;}.ac-hide{display:none;}.coupon-gobtn:hover{background-color:black!important;}");
            ...
            if(location.href.indexOf("item.taobao.com") + location.href.indexOf("detail.tmall.com") >= 0) {
                    ...
                    var tt = setInterval(function () {
                        ...
                        if (node != null) {
                            ...
                            if (result.retcode == 0 && result.data && result.data.couponAmount != 0) {
                                ...
                                node.setAttribute("style", "font-size: 16px;color:#B5621B");
                            }
                ...
                AutoStart(100, ".tb-sku, .tb-action", function () {
                    ...
                    insNode.style = "font-size: 16px;font-weight: bold;font-family:microsoft yahei;position:relative;";
                    var htmlText = "<span class='acBuyScriptCoupon ac-btn' data-url='javascript:void(0);' onclick='openUrl(this);' style='color: #B3641B;cursor:pointer;'>正在查找优惠券...</span>";

                    // htmlText += "<span><img class='acMobileQRCode' src='data:image/jpg;base64,/9j/4QMZR'></span>";
                    htmlText += `<span class='acMobileQRPanel ac-hide' style='position: absolute;left: 0;top: 3rem;z-index: 100002;background-color: white;border:1px solid RoyalBlue;'>
