...
// @description  Autobreak-trap, Autoheal, Hat macros, Anti-trkap, AutoPush & more!
// @version      FINAL
...
// @downloadURL https://update.greasyfork.org/scripts/541428/SploMod%20-%20The%20best%20hack%20of%202024%20NIGGA%20NIGHTMARE%20WAS%20SO%20MAD%20BECAUSE%20I%20FIXED%20SPLOMOD%20BAHBAHBAHBABAHBH.user.js
// @updateURL https://update.greasyfork.org/scripts/541428/SploMod%20-%20The%20best%20hack%20of%202024%20NIGGA%20NIGHTMARE%20WAS%20SO%20MAD%20BECAUSE%20I%20FIXED%20SPLOMOD%20BAHBAHBAHBABAHBH.meta.js
// ==/UserScript==
 ...
 static quad(id, angle = 0) {
    ...
    if (trap) {
        ...
        if (spikes.length) {
            ...
            let angle = getAngle(enemy, spike); // Calculate the angle
            ...
            angle = () => {
                ...
                if (distance > 100) {
                    ...
                    // Send the angle as a long floating-point number
                    Sploop.chat(`${angle}`); // Send the angle directly
