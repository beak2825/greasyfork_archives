// ==UserScript==
// @name         Town Star Auto-Sell Updated
...
// @downloadURL https://update.greasyfork.org/scripts/431066/Town%20Star%20Auto-Sell%20Updated.user.js
// @updateURL https://update.greasyfork.org/scripts/431066/Town%20Star%20Auto-Sell%20Updated.meta.js
// ==/UserScript==

(function() {
    'use strict';
	// keepAmt is the amount that you do not want to sell
	// sellMin is the minimum amount you must have before you sell
	//    setting a sellMin of 100 will ensure that you only sell in batches of 100 (i.e. using the Freight Pier)
    const craftedItems = [
        //{item: 'Crude_Oil', keepAmt: 10, sellMin: 0},
        //{item: 'Petroleum', keepAmt: 2, sellMin: 0},
        //{item: 'Gasoline', keepAmt: 10, sellMin: 0},
        //
        //{item: 'Water_Drum', keepAmt: 0, sellMin: 0},
        //{item: 'Energy', keepAmt: 0, sellMin: 0},
        //
        //{item: 'Wheat', keepAmt: 10, sellMin: 0},
        //{item: 'Feed', keepAmt: 0, sellMin: 0},
        //{item: 'Wool', keepAmt: 0, sellMin: 0},
        //{item: 'Wool_Yarn', keepAmt: 0, sellMin: 0},
        //{item: 'Cotton', keepAmt: 10, sellMin: 0},
        //{item: 'Cotton_Yarn', keepAmt: 0, sellMin: 0},
        //{item: 'Uniforms', keepAmt: 0, sellMin: 0},
        //
        //{item: 'Wood', keepAmt: 20, sellMin: 0},
        {item: 'Lumber', keepAmt: 0, sellMin: 100},
        //{item: 'Chromium', keepAmt: 0, sellMin: 0},
        //{item: 'Iron', keepAmt: 5, sellMin: 0},
        //{item: 'Steel', keepAmt: 0, sellMin: 0},
        //{item: 'Blue_Steel', keepAmt: 0, sellMin: 0},
    ]
