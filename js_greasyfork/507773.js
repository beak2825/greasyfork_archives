...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/507773/RankedUps%20-%20Heart.user.js
// @updateURL https://update.greasyfork.org/scripts/507773/RankedUps%20-%20Heart.meta.js
// ==/UserScript==
...
(function () {
  ...
  .styled-button:hover {
    ...
    function heartSorting() {
        ...
        sortedItems["red"].sort((a, b) => b.price - a.price);;
        sortedItems["orange"].sort((a, b) => b.price - a.price);;
        sortedItems["revitalize"].sort((a, b) => b.price - a.price);;
        sortedItems["warlord"].sort((a, b) => b.price - a.price);;
    ...
    if (location.href.startsWith("https://www.torn.com/bazaar.php?") || location.href.startsWith("https://www.torn.com/bazaar.php#/")) {
        waitForElm('.wrapper').then((wrapper) => {
