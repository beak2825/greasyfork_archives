...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/485458/1Starblastio%20auto%20gg.user.js
// @updateURL https://update.greasyfork.org/scripts/485458/1Starblastio%20auto%20gg.meta.js
// ==/UserScript==
...
function injector(sbCode) {
  ...
  class foo{bar(){let x = Object.values(window.module.exports.settings).find(v => v.mode); let y = Object.values(x).find(v => v.socket).socket; y.send(JSON.stringify({name: "say",data: `GGGGG`}));};};
  var gg = new foo()
  window.gg = new foo()
