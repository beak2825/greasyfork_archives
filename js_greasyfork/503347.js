...
// @version      2024.07.24
// @description  Restores the old watch layout from before 2019 (works better with both 2016-2020 UI scripts and Proper Description script to be installed.)
...
// @downloadURL https://update.greasyfork.org/scripts/503347/Watch9%20Reconstruct%20%28modified%29.user.js
// @updateURL https://update.greasyfork.org/scripts/503347/Watch9%20Reconstruct%20%28modified%29.meta.js
// ==/UserScript==
...
document.addEventListener("DOMContentLoaded", function tmp() {
    ...
    div#owner.item.style-scope.ytd-watch-metadata, div#bottom-row.style-scope.ytd-watch-metadata {
    ...
    ytd-watch-metadata #top-row > #info > * {
    display: none !important;
    }
    ...
    ytd-video-primary-info-renderer.style-scope.ytd-watch-flexy {
    ...
    div#container.style-scope.ytd-video-primary-info-renderer ytd-badge-supported-renderer,
    a.yt-simple-endpoint.style-scope.ytd-video-primary-info-renderer {
    display: none
    }
