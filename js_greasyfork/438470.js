...
I18N.zh = {
    "title": { // 标题翻译
        "static": { // 静态翻译
            ...
            "Enable two-factor authentication": "开启双重身份验证",
    ...
    "pubilc": { // 公共区域翻译
        "static": { // 静态翻译
            ...
            "Reference an issue, pull request or discussion": "引用问题，请求代码合并或讨论",
            "Reference an issue, pull request, or discussion": "引用问题，请求代码合并或讨论",
            "Reference an issue or pull request": "引用问题或请求代码合并",
            "Insert a reply": "插入回复",
            ...
            "Duplicate issue": "重复问题",
            // "Duplicate of #": "重复 #",
            "Duplicate pull request": "重复请求代码合并",
            // "Duplicate of #": "重复 #",
            "Create a new saved reply…": "创建新快捷回复…",

            "Close issue": "关闭问题", // issue页 评论框
            "Close with comment": "评论并关闭问题", // issue页 评论框
            "Close pull request": "关闭请求代码合并", // pull页 评论框
            "Comment": "评论",
            ...
            "Reopen pull request": "重新打开请求代码合并", //具体请求代码合并
            ...
            // 命令面板
                ...
                "Clear": "清除",
                "Type": "类型",
                "for issues and pull requests,": "问题和请求代码合并，",
                "for issues, pull requests, and projects,": "问题、请求代码合并和项目，",
                "for files, and": "文件，",
                "for commands, and": "命令，",
                "for commands": "命令，",
                "for help": "帮助",
                ...
                // # 模式
                "Search issues and pull requests": "搜索问题和请求代码合并",
                "Search issues, pull requests, discussions, and projects": "搜索问题、请求代码合并、讨论和项目",
                "Issues, pull requests, and discussions": "问题、请求代码合并和讨论",
                ...
                "Modes": "模式",
                "Search for": "搜索",
                "issues, pull requests, discussions,": "问题、请求代码合并、讨论",
                ...
                "Use filters in issues, pull requests, discussions, and projects": "在问题题、请求代码合并、讨论和项目中使用过滤器",
                "Search your issues, pull requests, and discussions": "搜索您的问题、请求代码合并和讨论",
                "Filter to pull requests": "筛选请求代码合并",
                "Filter to issues": "筛选问题",
                "Filter to discussions": "筛选讨论",
                "Filter to projects": "筛选项目",
                "Filter to open issues, pull requests, and discussions": "筛选打开的问题、请求代码合并和讨论",

            "Owns this repository": "拥有这个仓库",
            "Left a review": "留下了一个评论",

            "Opened this pull request": "打开了此请求代码合并",
    ...
    "page-dashboard": { // 已登录的首页
        "static": { // 静态翻译
            ...
            "write comments, and open a pull request.": "写评论，并创建一个请求代码合并。(教程内容就不翻译了...)",
           ...
           //
            ...
            "Go to your pull requests": "跳转到您的请求代码合并",
        },
        "regexp": [ // 正则翻译
    ...
    "page-profile": { // 个人首页
        "static": { // 静态翻译
            ...
            // 概述标签卡 即主页 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                "Created a pull request in": "创建一个请求代码合并在",
                "First repository": "第一个仓库",
                "First pull request": "第一次请求代码合并",
                "First issue": "第一次问题",
                "Opened their first issue on GitHub in": "打开了他们第一个问题",
                "Opened their first pull request on GitHub in": "打开了他们第一个问题",
            ...
            // 项目标签卡 ?tab=projects >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                "Built like a spreadsheet, project tables give you a live canvas to filter, sort, and group issues and pull requests. Tailor them to your needs with custom fields and saved views.": "构建像电子表格一样的项目表，给您一个实时的画布来对问题和请求代码合并进行筛选、排序和分组。通过自定义字段和保存的视图，使它们符合您的需要。",
        ...
        "regexp": [ // 正则翻译
            ...
            [/Opened (\d+) pull requests? in (\d+) repositor(y|ies)/, "在 $2 个仓库中打开了 $1 个请求代码合并"],
            [/Opened (\d+) other pull requests? in (\d+) repositor(y|ies)/, "在 $2 个其他仓库中打开了 $1 个请求代码合并"],
            [/Opened (\d+) issues? in (\d+) repositor(y|ies)/, "在 $2 个仓库中打开了 $1 个问题"],
            [/Opened (\d+) other issues? in (\d+) repositor(y|ies)/, "在 $2 个其他仓库中打开了 $1 个其他问题"],
            [/Reviewed (\d+) pull requests? in (\d+) repositor(y|ies)/, "在 $2 个仓库中审查了 $1 个请求代码合并"],
        ...
        "static": { // 静态翻译
            ...
            // Account settings 帐户设置 https://github.com/settings/admin
                ...
                "account? We won’t charge your payment information anymore.": "帐户吗？我们不会再收取您的付款信息。",
                    ...
                    "We will": "我们将",
                    ", along with all of your forks, wikis, issues, pull requests, and GitHub Pages sites.": "以及您所有的复刻、Wiki、问题、请求代码合并和 GitHub Pages 站点。",
            ...
            // Appearance 外观 https://github.com/settings/appearance
                ...
                "Font preference for plain text editors that support Markdown styling (e.g. pull request and issue descriptions, comments.)": "支持 Markdown 样式的纯文本编辑器的字体首选项（例如请求代码合并和问题描述、评论。）",
            ...
            // Emails 电子邮箱 https://github.com/settings/emails
                ...
                "This email address is the default used for GitHub notifications, i.e., replies to issues, pull requests, etc.": "该电子邮箱默认用于 GitHub 的通知，即对问题和请求代码合并的回复，等等。",
            ...
            // Notification center 通知 https://github.com/settings/notifications
                ...
                "Comments on Issues and Pull Requests": "关于问题和请求代码合并的评论",
                "Pull Request reviews": "请求代码合并审核",
                "Pull Request pushes": "请求代码合并推送",
            ...
            // Blocked users 黑名单 https://github.com/settings/blocked_users
                ...
                "opening or commenting on issues or pull requests": "打开或评论问题或请求代码合并",
            ...
            // Interaction limits 互动限制 https://github.com/settings/interaction_limits
                ...
                "Temporarily restrict which external users can interact with your repositories (comment, open issues, or create pull requests) for a configurable period of time.": "在配置的时间段内，可临时限制哪些外部用户与您的仓库互动（评论、打开问题或创建请求代码合并）。",
            ...
            // Code review limits 代码审查限制 https://github.com/settings/code_review_limits
                "Restrict users who are permitted to approve or request changes on pull requests in your public repositories.": "限制那些有权批准或请求更改公共仓库中请求代码合并的用户。",
                ...
                "Code review limits are currently managed individually for all repositories. Enable limits to permit only users who have explicitly been granted access to each repository to submit reviews that \"approve\" or \"request changes\". Remove limits to allow all users to submit pull request reviews. All users able to submit comment pull request reviews will continue to be able to do so.": "目前，所有仓库代码审查限制都是单独管理的。启用限制，只允许明确授予每个仓库访问权的用户提交 “批准” 或 “请求更改” 的审查。删除限制，允许所有用户提交请求代码合并审查。所有能够提交评论请求代码合并审查的用户将继续能够这样做。",
            ...
            // 管理双重身份验证 https://github.com/settings/two_factor_authentication/configure
                ...
                // 安全密钥
                "Security keys can be used as your second factor of authentication instead of a verification code.": "安全密钥可用作您的第二个验证步骤，而不是验证码。",
    ...
    "settings/apps": {
        "static": { // 静态翻译
            ...
            // 注册 GitHub 应用程序 https://github.com/settings/apps/new
                ...
                "Pull requests": "请求代码合并",
                "Pull requests and related comments, assignees, labels, milestones, and merges.": "请求代码合并及相关评论、受让人、标签、里程碑和合并。",
                "Webhooks": "Web 钩子",
    ...
    "repository": { // 仓库页面
        "static": { // 静态翻译
            ...
            // 仓库页面 /<user-name>/<repo-name>/
                ...
                "Author": "作者",
                    ...
                    "You are the author of this pull request.": "您是这个请求代码合并的作者。", // 请求代码合并
                    "This user is the author of this pull request.": "该用户是这个请求代码合并的作者。",// 请求代码合并
                "Member": "成员",
                ...
                // 键盘快捷键
                    ...
                    "Pull request list": "请求代码合并列表",
                    "Pull request - Conversation tab": "请求代码合并 - 对话标签卡",
                    "Submit comment and close or open pull request":"提交评论和关闭或打开请求代码合并",
                    ...
                    "Pull request - Files changed tab": "请求代码合并 - 文件更改标签卡",
                ...
                "Contribute": "贡献",
                    ...
                    "Open a pull request to contribute your changes upstream.": "打开请求代码合并以向上游贡献您的更改。",
                    "Open pull request": "打开请求代码合并",
                ...
                "Fetch upstream": "获取上游",
                    ...
                    "Open a pull request to fetch upstream and review changes or resolve conflicts.": "打开请求代码合并去获取上游并查看更改或解决冲突。",
            ...
            // 问题标签卡 issues 页面 /<user-name>/<repo-name>/issues
                // 欢迎信息
                "Welcome to issues!": "欢迎关注问题！",
                "Issues are used to track todos, bugs, feature requests, and more. As issues are created, they’ll appear here in a searchable and filterable list. To get started, you should": "问题用于跟踪待办事项、错误、功能请求等。创建问题后，它们将出现在可搜索和可过滤的列表中。要开始，您应该",
                "create an issue": "创建问题",

                "Label issues and pull requests for new contributors": "标记新贡献者的问题和请求代码合并",
                ...
                "If you have a bug or an idea, browse the open issues before opening a new one. You can also take a look at the": "如果您发现一个错误或有任何想法，请在打开新问题之前浏览未解决的问题。你也可以看看",
                ...
                "Filters": "筛选",
                    // 筛选下拉菜单
                    "Filter Issues": "筛选问题",
                    "Open issues and pull requests": "打开的问题和请求代码合并",
                    "Your issues": "您提出的问题",
                    "Your pull requests": "您的请求代码合并",
                ...
                "Assignee": "受理人",
                    ...
                    "Requested changes must be addressed to merge this pull request.": "要合并这个请求代码合并，必须先解决所要求的更改。",
                ...
                "was closed": "关闭于",
                "Approved": "已批准",
                "Review required": "需要审查", // 请求代码合并 页面状态词
            ...
            // 某条具体的问题 /<user-name>/<repo-name>/issues/<id> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                "marked this pull request as draft": "将此请求代码合并标记为草案",
                "marked this pull request as ready for review": "将此请求代码合并标记为可供审查",
                ...
                "Linked pull requests": "关联的请求代码合并",
                    "Successfully merging a pull request may close this issue.": "成功合并一个请求代码合并可能会关闭此问题。",
                    // 下拉
                    "Link a pull request from this repository": "关联来自此仓库的请求代码合并",

                    "linked a pull request that will": "关联一个请求代码合并, 将会",
                    "close": "关闭",
                    "this issue": "这个问题",

                "Lock conversation": "锁定对话",
                    "Lock conversation on this issue": "锁定关于此问题的对话",
                    "Other users": "其他用户",
                ...
                "Unlock conversation": "解锁对话",
                    "Unlock conversation on this issue": "解锁关于此问题的对话",
                    "Everyone": "任何人",
                ...
                "Transfer issue": "转移问题",
                    ...
                    "Transfer this issue": "转移问题",
                        "Labels, milestones, and repository projects assigned to this issue will not transfer to the new location": "分配给此问题的标签、里程碑和仓库项目不会转移到新位置",
                    "Choose a repository": "选择仓库",
                    "Find a repository": "搜索仓库",
                    "Warning!": "警告！",
                    "Transferring an issue does not scrub any issue content. Content such as text references to other issues, pull requests, projects, teams will remain in this issue's descriptions and comments. However, issue editing history will be removed.": "转移问题不会清除任何问题内容。诸如对其他问题、请求代码合并、项目、团队的文本引用等内容将保留在此问题的描述和评论中。但是，问题编辑历史将被删除。",
                ...
                "Delete issue": "删除问题",
                    ...
                    "Only administrators can delete issues": "只有管理员可以删除问题",
            ...
            // 请求代码合并 标签卡 /<user-name>/<repo-name>/pulls >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                // 欢迎信息
                "Welcome to pull requests!": "欢迎使用请求代码合并！",
                "Pull requests help you collaborate on code with other people. As pull requests are created, they’ll appear here in a searchable and filterable list. To get started, you should": "请求代码合并可帮助您与其他人协作处理代码。创建请求代码合并后，它们将出现在可搜索和可过滤的列表中。要开始，您应该",
                "create a pull request": "创建请求代码合并",

                // [/First time contributing to ([^ ]+)?/, "首次为 $1 做贡献？"], // /pulls
                "If you know how to fix an": "如果您知道如何修复一个",
                "issue": "问题",
                ", consider opening a pull request for it.": "，可考虑为它打开一个请求代码合并。",
                "You can read this repository’s": "您可以阅读该仓库的",
                "to learn how to open a good pull request.": "，去学习如何打开一个好的请求代码合并。",

                "New pull request": "发起请求代码合并",
                ...
                "Reviews": "审查",
                    ...
                    // 筛选结果
                    "There aren’t any open pull requests.": "暂无请求代码合并。",

            // 某条具体的请求代码合并 /<user-name>/<repo-name>/pull/<id> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                "Reviewers": "审查人",
                    ...
                    "At least 1 approving review is required to merge this pull request.": "至少需要 1 次批准审查才能合并此请求代码合并。",
                    "Still in progress?": "仍在进行中吗？",
                    "Convert to draft": "设置为草案",
                    // 下拉
                    "Request up to 15 reviewers": "最多请求 15 个审查人",
                    // [/approved these changes/, "批准这些更改"], // 具体的请求代码合并 审查人
                ...
                "Assignees": "受理人",
                    ...
                    "Assign up to 10 people to this pull request": "最多指定 10 人", // 请求代码合并
                ...
                // "Labels": "标签",
                    ...
                    "Apply labels to this pull request": "应用标签", // 请求代码合并
                    "Edit labels": "编辑标签",
                ...
                "Linked issues": "关联的问题",
                    "Successfully merging this pull request may close these issues.": "成功合并此请求代码合并可能会关闭这些问题。",
                    // 下拉
                ...
                "You’re receiving notifications because you are watching pull requests on this repository.": "您收到通知是因为您正在关注此仓库上的请求代码合并。",

                    // 通知设置对话框
                    "Notification settings": "通知设置",
                    "Not subscribed": "未订阅",
                        "Only receive notifications from this pull request when you have participated or have been @mentioned.": "只有在您参与或被 @您时才会收到来自此请求代码合并的通知。",
                        "Only receive notifications from this issue when you have participated or have been @mentioned.": "只有在您参与或被 @您时才会收到来自此问题的通知。", // 问题页面
                    "Subscribed": "订阅",
                        "Receive all notifications from this pull request.": "接收来自此请求代码合并的所有通知。",
                    ...
                    // 请求代码合并
                        "Receive a notification when this pull request has been merged.": "当请求代码合并被合并时，收到通知。",
                        "Receive a notification when this pull request has been closed.": "当请求代码合并被关闭时，收到通知。",
                        "Receive a notification when this pull request has been reopened.": "当请求代码合并被重新打开时，收到通知。",

                "Allow edits by maintainers": "允许维护者进行编辑",
                    "If checked,": "如果选中，",
                    // [/users with write access to ([^ ]+) can add new commits/, "对 $1 具有写权限的用户可以添加新的提交"], // 具体请求代码合并
                    "to your": "到您的",
                ...
                "mentioned this pull request": "提及这个请求代码合并",
                "dismissed": "忽略",
                "\’s": "的",
                "stale review": "陈旧审查",
                "via": "通过",
                ...
                // 请求代码合并状态
                "This pull request is still a work in progress": "此请求代码合并仍在进行中",
                "This pull request can be automatically merged by project collaborators": "此请求代码合并可以由项目协作者自动合并",
                    "Only those with": "只有对此仓库具有",
                    "write access": "写入访问权限",
                    "to this repository can merge pull requests.": "的才可合并请求代码合并。",
                    "to this repository can mark a draft pull request as ready for review.": "的才可将请求代码合并草案标记为可供审查。",
                ...
                "This branch has no conflicts with the base branch when rebasing": "该分支基变时与基础分支没有冲突。",
                    ...
                    "You’re not": "您无",
                    "authorized": "权限",
                    "to merge this pull request.": "合并此请求代码合并。",

                "Merge pull request": "合并请求代码合并",
                // 合并请求代码合并 按钮下拉
                ...
                "Hide details": "隐藏详情",
                "Revert": "还原",
                    "Create a new pull request to revert these changes": "创建一个新的请求代码合并以恢复这些更改",
                "Closed with unmerged commits": "已关闭未合并的提交",

                "Pull request successfully merged and closed": "请求代码合并已成功合并并关闭",
                "Delete branch": "删除分支",
                "Restore branch": "恢复分支",

                "Pull request closed": "请求代码合并已关闭",
                "This pull request is closed, but the": "此请求代码合并已关闭，但是",
            ...
            // 更改的文件 标签卡 /<user-name>/<repo-name>/pull/<id>/files
                ...
                "changes": "更改",
                    ...
                    "Approve": "批准",
                        ...
                        "Pull request authors can’t approve their own pull request": "请求代码合并作者无法批准自己的请求代码合并",
                        "Only users with explicit access to this repository may approve pull requests": "只有对这个仓库有明确访问权限的用户才能批准请求代码合并",
                    "Request changes": "请求更改",
                        "Submit feedback suggesting changes.": "请求更改，并提出更改意见。",
                        "Pull request authors can’t request changes on their own pull request": "请求代码合并作者不能在自己的请求代码合并上请求更改",
                        "Only users with explicit access to this repository may request changes to pull requests": "只有对这个仓库有明确访问权限的用户才能请求更改请求代码合并",
                    "Submit review": "提交审查",
            ...
            // 新建文件页面 /<user-name>/<repo-name>/new/<branch>
                ...
                "for you to commit your proposed changes to. Submitting a change will write it to a new branch in your fork, so you can send a pull request.": "供您提交建议的更改。提交更改会将其写入复刻中的新分支，这样您就可以发送请求代码合并。",
                ...
                // 提交框
                    ...
                    "Create a": "创建",
                    "new branch": "新分支",
                    "for this commit and start a pull request.": "为这个提交，并且发起一个请求代码合并。",
                    "Learn more about pull requests.": "了解更多关于请求代码合并的信息。",
            ...
            "Compare & pull request": "比较 & 请求代码合并",
            ...
            //// 直接提交请求代码合并
            "Open a pull request": "新建一个请求代码合并",
            ...
            "Don’t worry, you can still create the pull request.": "别担心，您仍然可以创建请求代码合并。",
            "Able to merge.": "可被合并。",
            "Can’t automatically merge.": "无法自动合并。",
            "These branches can be automatically merged.": "该分支可被自动合并。",

            "View pull request": "查看请求代码合并", //存在请求代码合并时
            ...
            // 创建请求代码合并 按钮下拉
            "Open a pull request that is ready for review": "打开一个请求代码合并，以供审查",
            "Create draft pull request": "创建请求代码合并草案",
            "Cannot be merged until marked ready for review": "在标记为可供审查之前，不能合并",
            "Draft pull request": "请求代码合并草案",
            ...
            "Learn about pull requests": "了解请求代码合并",
            ...
            // 分支页面 branches  /<user-name>/<repo-name>/branches
                ...
                "Updated": "更新",
                    ...
                    "Renaming this branch:": "重命名此分支：",
                        // 该分支存在来自其他分支的请求代码合并时
                            "Will update": "将更新",
                            "pull request targeting this branch.": "个针对该分支的请求代码合并。",

                        // 该分支存在用于其他分支的请求代码合并时
                            "Will close": "将关闭",
                            "open pull request for this branch.": "个该分支的请求代码合并。",
            ...
            // 创建发行版 /releases/new 和 编辑发行版 /releases/edit/<tag>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                "Select a valid tag to automatically add the markdown for all the merged pull requests from this diff and contributors of this release": "选择一个有效的标签，自动为来自此差异和此发行版贡献者的所有已合并请求代码合并，添加说明。",
                "Automatically add the markdown for all the merged pull requests from this diff and contributors of this release": "自动为来自此差异和此发行版贡献者的所有已合并请求代码合并，添加说明。",
            ...
            // 统计 /<user-name>/<repo-name>/pulse
                "Period:": "周期：",
                    ...
                    "1 week": "1 周",
                    "1 month": "1 个月",
                "Active Pull Request": "活跃的请求代码合并",
                "Active Pull Requests": "活跃的请求代码合并",
                "Active Issue": "活跃的问题",
                "Active Issues": "活跃的问题",
                "Merged Pull Request": "合并的请求代码合并",
                "Merged Pull Requests": "合并的请求代码合并",
                "Open Pull Request": "打开的请求代码合并",
                "Open Pull Requests": "打开的请求代码合并",
                "Closed Issue": "关闭的问题",
                "Closed Issues": "关闭的问题",
                "New Issue": "新问题",
                "New Issues": "新问题",
                ...
                "published": "发布",
                "Pull request merged by": "个请求代码合并已合并由",
                "Pull requests merged by": "个请求代码合并已合并由",
                "Pull request opened by": "个请求代码合并打开由",
                "Pull requests opened by": "个请求代码合并打开由",
                ...
                "person": "人",
                "people": "人",
                "Sometimes conversations happen on old items that aren’t yet closed. Here is a list of all the Issues and Pull Requests with unresolved conversations.": "有时会针对尚未关闭的旧项目进行讨论。以下是所有未解决的讨论的问题和请求代码合并的列表。",
            ...
            // 社区 /<user-name>/<repo-name>/community
                "Community profile": "社区简介",
                ...
                "Pull request template": "请求代码合并模板",
            ...
            // 依赖关系图 - 依赖机器人 /network/updates
                ...
                "Dependabot creates pull requests to keep your dependencies up-to-date.": "Dependabot 创建请求代码合并以保持您的依赖项是最新的。",
            ...
            // 某个讨论页面 /<user-name>/<repo-name>/discussions/<id>
                ...
                "Convert issues": "转换为问题",
                // [/Convert (\d+) issues? to discussions?/, "将 $1 个问题转换为讨论"], // 标签页面
                // [/Are you sure you want to convert (\d+) issues? with the following label to discussions?/, "您确定要将带有以下标签的 2 个问题转换为讨论吗？"], // 标签页面
                // "What happens when an issue is converted into a discussion:": "将问题转化为讨论时，会发生什么：",
                ...
                "Future issues with this label will not be automatically converted into discussions.": "今后带有此标签的问题并不会自动转化为讨论。",
                "I understand, convert these issues to discussions.": "我明白了，依然把这些问题转化为讨论。",
                // 顶部提醒
                // [/Open issues with label \'([^ ]+)\' are being converted to discussions./, "带有 “$1” 标签的打开问题正在被转换为讨论。"], // 标签页面
            ...
            // 标签页面 /<user-name>/<repo-name>/labels
                ...
                "dependencies": "依赖性",
                    "Pull requests that update a dependency file": "更新一个依赖文件的请求代码合并",
                "documentation": "文档",
                    "Improvements or additions to documentation": "文档的改进或补充",
                "duplicate": "重复",
                    "This issue or pull request already exists": "这个问题或请求代码合并已经存在",
                "enhancement": "增强",
                ...
                // [/open issues? and pull requests?/, "个打开的问题和请求代码合并"], // 标签页面
                // [/open issues? or pull requests?/, "个打开的问题或请求代码合并"], // 标签页面

            // 里程碑页面 /<user-name>/<repo-name>/milestones
                "You haven’t created any Milestones.": "您尚未创建任何里程碑。",
                "Use Milestones to create collections of Issues and Pull Requests for a particular release or project.": "使用里程碑为特定版本或项目创建问题和请求代码合并的集合。",
            ...
            // 新建里程碑页面 /<user-name>/<repo-name>/milestones/new
                "New milestone": "新建里程牌",
                "Create a new milestone to help organize your issues and pull requests. Learn more about": "创建一个新的里程碑来帮助组织您的问题和请求代码合并。了解更多关于",
            ...
            // 新建操作 /<user-name>/<repo-name>/actions/new
                ...
                "Build, test, and deploy your code. Make code reviews, branch management, and issue triaging work the way you want. Select a workflow template to get started.": "构建、测试和部署您的代码。以您想要的方式进行代码审查、分支管理和问题分类。选择一个工作流模板以开始使用。",
                "Skip this and": "跳过并",
                "set up a workflow yourself": "建立工作流程",

                "Workflows made for your repository": "为您的仓库设置工作流程",
                "Suggested": "推荐的",
            ...
            // /contribute
                ...
                "Once its maintainers label issues and pull requests for new contributors, they will begin to appear here.": "一旦它的维护者为新的贡献者标记了问题和请求代码合并，它们就会开始出现在这里。",
        ...
        "regexp": [ // 正则翻译
            ...
            [/(\d+) of (\d+) tasks?/, "$1 / $2 个任务"],
            [/(\d+) tasks?/, "$1 个任务"],
            [/This issue will close once commit ([^ ]+) is merged into the \'([^ ]+)\' branch./, "一旦提交 $1 被合并到 '$2' 分支，这个问题就会关闭。"],
            [/This issue will close when (\d+) is merged/, "这个问题将在 $1 合并后关闭"],
            ...
            // 具体请求代码合并 /<user-name>/<repo-name>/pull/<id>
            [/([\d,]+) participants?/, "$1 位参与者"],
            [/([^ ]+) left review comments/, "$1 发表了审查评论"],
            [/users with write access to ([^ ]+) can add new commits/, "对 $1 具有写权限的用户可以添加新的提交"],
            [/The ([^ ]+) branch has been deleted./, "$1 分支已被删除。"], // 具体请求代码合并 重新打开请求代码合并
            [/merged (\d+) commits? into/, "已合并 $1 个提交到"],
            [/The (\d+) commits? from this branch will be added to the base branch./, "该分支的 $1 个提交将合并到基本分支中。"],
            [/The (\d+) commits? from this branch will be rebased and added to the base branch./, "该分支的 $1 个提交将变基合并到基础分支中。"],
            [/added a commit to ([^ ]+) that referenced this issue/, "为 $1 添加了引用这个问题的提交"],
            [/Awaiting requested review from ([^ ]+)/, "正在等待 $1 审查请求"], // 具体的请求代码合并 审查人
            [/([^ ]+) requested changes/, "$1 请求更改"], // 具体的请求代码合并 审查人
            [/([^ ]+) approved these changes/, "$1 批准这些更改"], // 具体的请求代码合并 审查人
            // [/Commits on (.+)/, "提交于 $1"],
            ...
            [/(\d+) hidden items/,"$1 条隐藏信息"], //问题页 评论太多 需要点击载入
            [/(\d+) Draft/,"$1 草案"],// 安全建议页
            ...
            [/(\d+) review approvals?/, "$1 次审查批准"],// 请求代码合并页 "已批准' 浮动提示
            [/Joined/,"加入于"], // 追星者，关注者页面
            [/You’re making changes in a project you don’t have write access to. Submitting a change will write it to a new branch in your fork ([^ ]+), so you can send a pull request./, "您正在对没有写入权限的项目进行更改。提交更改会将其写入您的复刻 $1 中的新分支，这样您就可以发送请求代码合并。"], // 新建, 编辑文件页面
            ...
            [/Convert (\d+) issues? to (a |)discussions?/, "将 $1 个问题转换为讨论"], // 标签页面?
            [/Are you sure you want to convert (\d+) issues? with the following label to (a |)discussions?\?/, "您确定要将带有以下标签的 $1 个问题转换为讨论吗？"], // 标签页面
            [/Open issues? with label \'([^ ]+)\' are being converted to discussions./, "带有 “$1” 标签的打开问题正在被转换为讨论。"], // 标签页面
            // [/Closed issues? with label \'([^ ]+)\' are being converted to discussions./, "带有 “$1” 标签的已关闭问题正在被转换为讨论。"], // 标签页面
            [/open issues? and pull requests?/, "个打开的问题和请求代码合并"], // 标签页面
            [/open issues? or pull requests?/, "个打开的问题或请求代码合并"], // 标签页面
    ...
    "repository/settings": { // 仓库设置页面 /<user-name>/<repo-name>/settings
        "static": { // 静态翻译
            ...
            // 设置页面 /<user-name>/<repo-name>/settings ====================================
                ...
                "When merging pull requests, you can allow any combination of merge commits, squashing, or rebasing. At least one option must be enabled. If you have linear history requirement enabled on any protected branch, you must enable squashing or rebasing.": "当合并请求代码合并时，您可以允许合并提交、压缩或变基的任意组合。必须至少启用一个选项。如果您在任何受保护分支上启用了线性历史要求，则必须启用压缩或变基。",
                ...
                "You can allow setting pull requests to merge automatically once all required reviews and status checks have passed.": "一旦所有必需的审查和状态检查都通过，您可以允许设置请求代码合并自动合并。",
                ...
                "After pull requests are merged, you can have head branches deleted automatically.": "合并请求代码合并后，您可以自动删除头部分支。",
                ...
                "To understand admin access, teams, issue assignments, and redirects after a repository is transferred, see": "要了解仓库转让后的管理员访问、团队、问题分配和重定向，请参阅",
                ...
                "for issues and PRs": "关于问题和请求代码合并",
                ...
                "Closing all open issues and pull requests": "关闭所有打开的问题和请求代码合并",
                ...
                "repository, wiki, issues, comments, packages, secrets, workflow runs, and remove all collaborator associations.": "仓库、Wiki、问题、评论、软件包、密钥、工作流程，并删除所有协作者关联。",
            ...
            // 分支管理页面 /<user-name>/<repo-name>/settings/branches====================================
                "Default branch": "默认分支",
                "The default branch is considered the “base” branch in your repository, against which all pull requests and code commits are automatically made, unless you specify a different branch.": "默认分支被认为是仓库中的 “基础” 分支，所有的请求代码合并和代码提交都是针对该分支进行的，除非您指定一个不同的分支。",
                "Rename branch": "重命名分支",
                    // 重命名分支对话框
                ...
                "Switch to another branch": "切换到另一分支",
                    ...
                    "can have unintended consequences that can affect new pull requests and clones.": "可能会产生意想不到的后果，影响新的请求代码合并和克隆。",
            ...
            // 新建分支保护规则 页面 /<user-name>/<repo-name>/settings/branch_protection_rules/new====================================
                ...
                "Require a pull request before merging": "要求在合并前提交请求代码合并",
                "When enabled, all commits must be made to a non-protected branch and submitted via a pull request before they can be merged into a branch that matches this rule.": "启用后，所有提交都必须提交到不受保护的分支，并通过请求代码合并提交，然后才能将它们合并到与此规则匹配的分支中。",
                    "Require approvals": "需要批准",
                    "When enabled, pull requests targeting a matching branch require a number of approvals and no changes requested before they can be merged.": "启用后，针对匹配分支的请求代码合并需要经过多次批准，并且在合并之前不需要更改。",
                    "Required number of approvals before merging:": "合并前所需的审批数量：",
                    "Dismiss stale pull request approvals when new commits are pushed": "当新的提交被推送时，撤销陈旧的请求代码合并审批",
                    "New reviewable commits pushed to a matching branch will dismiss pull request review approvals.": "推送到匹配分支的新的可审查提交将撤销请求代码合并的审查批准。",
                        "Require review from Code Owners": "要求代码所有者的审查",
                        "Require an approved review in pull requests including files with a designated code owner.": "要求在请求代码合并中进行批准审查，包括有指定代码所有者的文件。",
                    ...
                    "This ensures pull requests targeting a matching branch have been tested with the latest code. This setting will not take effect unless at least one status check is enabled (see below).": "这可确保针对匹配分支的请求代码合并已使用最新的代码进行了测试。除非启用了至少一个状态检查，否则这个设置不会生效（见下文）。",
                ...
                "When enabled, all conversations on code must be resolved before a pull request can be merged into a branch that matches this rule.": "启用后，必须先解决所有有关代码的对话，然后才能将请求代码合并合并到与此规则匹配的分支中。",
            ...
            // 添加钩子 页面 /<user-name>/<repo-name>/settings/hooks/new ====================================
                ...
                "Which events would you like to trigger this webhook?": "您希望哪些事件触发此 Web 钩子？",
                    ...
                    "Let me select individual events.": "让我选择单个事件。",
                        ...
                        // "": "问题",
                        "Issue opened, edited, deleted, transferred, pinned, unpinned, closed, reopened, assigned, unassigned, labeled, unlabeled, milestoned, demilestoned, locked, or unlocked.": "问题的打开、编辑、删除、转移、钉住、取消钉住、关闭、重新打开、分配、未分配、标记、未标记、密闭、去密闭、锁定或解锁。",
                        // "": "标签",
                        ...
                        "Pull request review comments": "请求代码合并的审查评论",
                        "Pull request diff comment created, edited, or deleted.": "请求代码合并差异评论的创建、编辑或删除。",
                        "Pull request review threads": "请求代码合并的审查线程",
                        "A pull request review thread was resolved or unresolved.": "请求代码合并审查线程的解决或未解决。",
                        "Pull request reviews": "请求代码合并审查",
                        "Pull request review submitted, edited, or dismissed.": "请求代码合并审查的提交、编辑或忽略。",
                        // "": "请求代码合并",
                        "Pull request opened, closed, reopened, edited, assigned, unassigned, review requested, review request removed, labeled, unlabeled, synchronized, ready for review, converted to draft, locked, unlocked, auto merge enabled, auto merge disabled, milestoned, or demilestoned.": "请求代码合并的打开、关闭、重新打开、编辑、分配、未分配、审查请求、审查请求的删除、标记、未标记、同步、准备审查、转换为草稿、锁定、解锁、启用自动合并、禁用自动合并、里程碑或取消里程碑。",
                        "Pushes": "推送",
            ...
            // 操作页面 /<user-name>/<repo-name>/settings/actions
                ...
                "Fork pull request workflows": "复刻请求代码合并工作流程",
                    "Run workflows from fork pull requests": "从复刻请求代码合并运行工作流程",
                        "This tells Actions to run workflows from pull requests originating from repository forks. Note that doing so will give maintainers of those forks the ability to use tokens with read permissions on the source repository.": "这告诉 Actions 运行工作流程，来自仓库复刻的请求代码合并。请注意，这样做将使这些复刻的维护者有能力在源码库上使用具有读取权限的令牌。",
                    "Send write tokens to workflows from fork pull requests.": "从复刻请求代码合并，发送可写令牌到工作流程",
                        "This tells Actions to send tokens with": "这告诉 Actions 发送令牌",
                        "write": "写入",
                        "permissions to workflows from pull requests originating from repository forks. Note that doing so will give maintainers of those forks": "权限到工作流程，来自仓库复刻的请求代码合并。请注意，这样做将授予这些复刻的维护者",
                        "permissions against the source repository.": "权限，针对源仓库。",
                    "Send secrets to workflows from fork pull requests.": "从复刻请求代码合并，发送机密到工作流程",
                        "This tells Actions to send repository secrets to workflows from pull requests originating from repository forks.": "这告诉 Actions 发送仓库机密到工作流程，来自仓库复刻的请求代码合并。",

                "Fork pull request workflows from outside collaborators": "从外部协作者，复刻请求代码合并工作流程",
                    "Choose which subset of outside collaborators will require approval to run workflows on their pull requests.": "选择哪些外部协作者的子集需要批准才能对他们的请求代码合并运行工作流程。",
                ...
                "Require approval for all outside collaborators": "要求对所有外部协作者进行审批",
                    "All outside collaborators will always require approval to run workflows on their pull requests.": "所有外部协作者将始终需要批准才能在他们的请求代码合并上运行工作流程。",
            ...
            // 操作机密 /<user-name>/<repo-name>/settings/secrets/actions
                ...
                "Secrets are not passed to workflows that are triggered by a pull request from a fork.": "机密不会传递给来自复刻的请求代码合并触发的工作流程。",
            ...
            // 同全局
                "Temporary interaction limits": "临时互动限制",
                "Temporarily restrict which external users can interact with your repository (comment, open issues, or create pull requests) for a configurable period of time.": "在配置的时间段内，可临时限制哪些外部用户与您的仓库互动（评论、打开问题或创建请求代码合并）。",
                "This may be used to force a \"cool-down\" period during heated discussions or prevent unwanted interactions.": "可用于在激烈讨论期间，强制进入 “冷静” 期或防止不必要的互动。",
    ...
    "notifications/subscriptions": { //订阅的仓库页面
        "static": { // 静态翻译
            ...
            "Reason": "原因",
                ...
                "Assign": "分配",
                "You were assigned to the Issue/PR.": "您被分配到问题/请求代码合并。",
                "Author": "作者",
                "You created the thread.": "您创造了这个话题。",
                "Comment": "评论",
                "You commented on the thread.": "您评论了这个话题。",
                "Manual": "手动",
                "You subscribed to the thread (via an Issue or Pull Request).": "您订阅了该主题（通过问题或请求代码合并）。",
                "Mention": "提及",
                "You were specifically @mentioned in the content.": "在内容中特别 @您。",
                "Review Requested": "请求审查",
                "You were requested for review.": "您被要求进行审查。",
                "State Change": "状态变化",
                "You changed the thread state (for example, closing an Issue or merging a Pull Request).": "您更改了话题状态（例如，关闭问题或合并请求代码合并）。",
                "Team Mention": "提及团队",
    ...
    "issues": { // 问题页面
        ...
        "regexp": [ // 正则翻译
            ...
            [/([\d,]+) linked issues?/, "$1 个关联问题"],
            [/([\d,]+) linked pull requests?/, "$1 个关联请求代码合并"],
            [/(\d+) \/ (\d+) checks? OK/, "$1 / $2 检查 OK"], // 对勾 的提醒 /pulls
            [/Assigned to ([^ ]+)/, "分配给 $1"],
            [/Updated/, "更新于"],
            [/#(\d+) opened/, "#$1 打开于"],
    ...
    "marketplace": { // 应用商店
        ...
        "regexp": [ // 正则翻译
            ...
            // /marketplace/travis-ci/order/MDIyOk1hcmtldHBsYWNlTGlzdGluZ1BsYW43MA==?account=maboloshi
            [/By clicking "Issue plan changes", you are agreeing to ([^ ]+)’s/, "点击 “问题计划更改”，您同意 $1 的"],
    ...
    "orgs/settings": { // 组织 - 设置页面
        "static": { // 静态翻译
            ...
            // Interaction limits 互动限制 /organizations/<org-login>/settings/interaction_limits
                "Temporary interaction limits": "临时互动限制",
                "Temporarily restrict which external users can interact with your repositories (comment, open issues, or create pull requests) for a configurable period of time. Users who are members of this organization will not be affected by these limits.": "在配置的时间段内，可临时限制哪些外部用户与您的仓库互动（评论、打开问题或创建请求代码合并）。作为该组织成员的用户将不受这些限制的影响。",
                "This may be used to force a \"cool-down\" period during heated discussions or prevent unwanted interactions.": "可用于在激烈讨论期间，强制进入 “冷静” 期或防止不必要的互动。",
    ...
    "projects": { // 项目页面(含仓库项目)
        "static": { // 静态翻译
              ...
              //同 仓库 新建项目页面  /<user-name>/<repo-name>/projects/new
                ...
                "Template:": "模板：",
                    ...
                    "Automated kanban": "自动化看板",
                        "Kanban-style board with built-in triggers to automatically move issues and pull requests across To do, In progress and Done columns.": "带有内置触发器的风格看板，可以自动将问题和请求代码合并移到待办、进行中和已完成栏目中。",
                    "Automated kanban with reviews": "带审查的自动看板",
                        "Everything included in the Automated kanban template with additional triggers for pull request reviews.": "除了包含自动化看板模板中的所有内容，还有请求代码合并审查的额外触发器。",
                    "Bug triage": "BUG 分类",
            ...
            // 仓库 项目页面  /<user-name>/<repo-name>/projects >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                ...
                "Organize your issues with project boards": "使用项目板组织您的问题",
                ...
                "Sort tasks": "排序任务",
                "Add issues and pull requests to your board and prioritize them alongside note cards containing ideas or task lists.": "将问题和请求代码合并添加到您的看板中，并将它们与包含想法或任务清单的笔记卡一起进行优先排序。",
            ...
            // https://github.com/users/maboloshi/projects/<id>
                // 键盘快捷键
                    "Project card shortcuts": "项目卡快捷键",
                        "Open the issue or pull request associated with the focused card in the sidebar": "聚焦卡片的侧边栏中打开相关联的问题或请求代码合并",
                    "Moving a card": "移动卡片",
                ...
                "Add column": "添加栏目",
                    ...
                    "Preset:": "预设：",
                        ...
                        "To do": "待办",
                            ...
                            "Move pull requests here when…": "当…时，将请求代码合并移到此处",
                                "Pull requests will automatically move here when added to this project.": "添加到此项目时，请求代码合并将自动移至此处。",
                                "If a closed pull request in this project reopens, it will automatically move here.": "如果此项目中已关闭的请求代码合并重新打开，它将自动移至此处。",
                        "In progress": "进行中",
                            "Actively being worked on": "正在积极开展工作",
                            "Approved by reviewer": "由审查人批准",
                            "Pull requests in this project will automatically move here when they meet the minimum number of required approving reviews. Recommended when another column has the": "当该项目中的请求代码合并达到所需的最低批准审查数量时，将自动移至此处。当另一栏启用了 “",
                            "automation enabled.": "” 的自动化功能时推荐使用。",
                            "Pending approval by reviewer": "由审查人待批准",
                            "Pull requests in this project will automatically move here when a reviewer requests changes, or it no longer meets the minimum number of required approving reviews. Recommended when another column has the": "当审查人请求更改或不再满足所需的最小批准审查数时，此项目中的请求代码合并将自动移至此处。当另一栏目启用了 “",
                        "Done": "已完成",
                            ...
                            "Merged": "已合并",
                                "If an open pull request in this project is merged, it will automatically move here.": "如果该项目中的一个打开的请求代码合并被合并，它将自动转移到这里。",
                            "Closed with unmerged commits": "已关闭的未合并的提交",
                                "If an open pull request in this project is closed with unmerged commits, it will automatically move here.": "如果该项目中的一个打开的请求代码合并因未合并提交而关闭，它将自动移到这里。",
                    "Create column": "创建栏目",
            ...
            // https://github.com/users/maboloshi/projects/3?add_cards_query=is%3Aopen
                ...
                "Pull Request closed without merge": "请求代码合并关闭而不合并",
                "Pull Request merged": "合并请求代码合并",
                "Issue closed": "问题已关闭",
                "Pull Request reopened": "请求代码合并已重新打开",
                "Issue reopened": "问题已重新打开",
                "Pull Request pending card added": "添加了请求代码合并待办卡",
