...
// @grant        GM_getValue
// @grant        GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/406375/%E5%85%B6%E4%B9%90%E7%AE%80%E6%98%93%E6%B8%90%E5%8F%98%E5%AD%97%E5%8A%9F%E8%83%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/406375/%E5%85%B6%E4%B9%90%E7%AE%80%E6%98%93%E6%B8%90%E5%8F%98%E5%AD%97%E5%8A%9F%E8%83%BD.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    btn.setAttribute('style', 'padding: 1px 10px 0 10px;margin-left: 0;border: 0!important;background-image: -webkit-linear-gradient(top,transparent 0%,rgba(0,0,0,0.1) 100%)!important;transition: background-color .3s,box-shadow .3s;text-decoration: none!important;box-shadow: inset 0 -1px 0 0 rgba(0,0,0,.3),0 6px 0 -3px rgba(0,0,0,.15)!important;font-size: 100%!important;font-weight: 400!important;text-shadow: none!important;border-radius: 0!important;background-color: #43a6e3;');
    ...
    btn_float.setAttribute('style', 'height: 28px;float: left;padding: 1px 10px 0 10px;margin-left: 0;border: 0!important;background-image: -webkit-linear-gradient(top,transparent 0%,rgba(0,0,0,0.1) 100%)!important;transition: background-color .3s,box-shadow .3s;text-decoration: none!important;box-shadow: inset 0 -1px 0 0 rgba(0,0,0,.3),0 6px 0 -3px rgba(0,0,0,.15)!important;font-size: 100%!important;font-weight: 400!important;text-shadow: none!important;border-radius: 0!important;background-color: #43a6e3;');
    ...
    btn_mobile_reply.addEventListener('click',
                                      function() {
        modMsg('needmessage');
    },
                                      false);
