...
// @include *://mas.to/*
// @include https://mastodon*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=mas.to
// @downloadURL https://update.greasyfork.org/scripts/454658/Mastodon%20-%20Cyberpunk%20Neon.user.js
// @updateURL https://update.greasyfork.org/scripts/454658/Mastodon%20-%20Cyberpunk%20Neon.meta.js
// ==/UserScript==
...
/* 1. Main elements*/
html {
    scrollbar-color: #0abdc6 transparent !important;
}
.ui {
    background: #000b1e;
}
...
.account__section-headline a.active::after, .account__section-headline a.active::before, .account__section-headline button.active::after, .account__section-headline button.active::before, .notification__filter-bar a.active::after, .notification__filter-bar a.active::before, .notification__filter-bar button.active::after, .notification__filter-bar button.active::before {
    border-color: transparent transparent #0abdc6;
}
