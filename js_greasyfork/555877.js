// ==UserScript==
// @name         CRYSTAL's CLAWS Bank Request
// @version      1.0
...
// @description  CLAWS Bank Request
// @namespace https://greasyfork.org/users/1514317
// @downloadURL https://update.greasyfork.org/scripts/555877/CRYSTAL%27s%20CLAWS%20Bank%20Request.user.js
// @updateURL https://update.greasyfork.org/scripts/555877/CRYSTAL%27s%20CLAWS%20Bank%20Request.meta.js
// ==/UserScript==

(function () {
  'use strict';

  const WEB_APP_URL = "https://script.google.com/macros/s/AKfycbytwq3zU75Jgo4k7fDHl-I_vY3MVXmN23jLx7Z-93N0Fp1Ibzy5P7T3avCali0HGlACmQ/exec";
  ...
  GM_addStyle(`
    ...
    /* heading */
    #faction-req-wrap .heading { color:#8FBC8B; font-weight:700; text-align:center; font-size:12px; margin:0 0 6px 0; }
    ...
    #faction-req-request { width:100%; padding:6px; border-radius:6px; border:none; background:#8FBC8B; color:#fff; font-weight:700; font-size:12px; cursor:pointer; box-sizing:border-box; }
    /* response line */
...
<li class="server-info" id="faction-req-wrap">
  <div class="heading">CLAWS Bank Request</div>
  ...
  <button id="faction-req-request">Request</button>
    ...
    async function doCheckBalance(showErrors = true) {
      ...
      try {
        ...
        if (!res || !res.success) {
          if (showErrors) showMessage(res && res.message ? res.message : 'Member not found in CLAWS.', false);
