...
// @downloadURL https://update.greasyfork.org/scripts/458340/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98%E4%BF%AE%E6%94%B9%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/458340/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98%E4%BF%AE%E6%94%B9%E7%89%88.meta.js
// ==/UserScript==
...
(function() {
    ...
    obj.dPlayerSupport = function (callback) {
        var urlArr = [
            [
                "https://cdn.staticfile.org/hls.js/1.2.4/hls.min.js",
                "https://cdn.staticfile.org/dplayer/1.27.0/DPlayer.min.js",
            ],
            [
                "https://cdn.bootcdn.net/ajax/libs/hls.js/1.2.4/hls.min.js",
                "https://cdn.bootcdn.net/ajax/libs/dplayer/1.27.0/DPlayer.min.js",
            ],
            [
            ...
            if (player.prevVideo) {
                ...
                if (!paused) {
                    ...
                    obj.isAppreciation(function (data) {
                        data || player.contextmenu.show(player.container.offsetWidth / 0, player.container.offsetHeight / 0);
                    });
                }
