// ==UserScript==
// @name         SigMod Client (Macros) - [BETA]
// @version      8.2.1
// @description  The best mod you can find for Sigmally: Macros, tag system (minimap, chat), FPS boost, color mod, custom skins, save names, themes and more!
// @author       Cursed
// @match        *://sigmally.com/*
...
// @downloadURL https://update.greasyfork.org/scripts/482378/SigMod%20Client%20%28Macros%29%20-%20%5BBETA%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/482378/SigMod%20Client%20%28Macros%29%20-%20%5BBETA%5D.meta.js
// ==/UserScript==
...
(function() {
    ...
    class modClient {
        ...
        onClose(event) {
            ...
            message.innerHTML = `
                <img src="https://i.ibb.co/ftTwZP0/Error.png" width="38" draggable="false">
                <span class="text" style="color: #000; user-select: auto;">You Disconnected from the SigMod <a href="https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API" target="_blank">WebSocket</a>. Error code: ${event.code}. Please refresh the page.</span>
        ...
        game() {
            ...
            CanvasRenderingContext2D.prototype.fillText = function (text, x, y) {
                ...
                if (text.includes("Score") && _getScore) {
                    ...
                    document.getElementById("t-myScore").textContent = `Your score: ${lastScore}`;
                }
                    ...
                    <div class="mod_menu_inner">
                        ...
                        <div class="mod_menu_content">
                            ...
                            <div class="mod_tab scroll" id="mod_macros" style="display: none">
                                    ...
                                    <div class="macros_wrapper">
                                        <span>Advanced Keybinding options</span>
...
`, 'background-color: black; color: green')
        ...
        showTournament(data) {
            ...
            const blueTeamHTML = users[0].map(user => `
                <div class="t_profile">
            ...
            const redTeamHTML = users[1].map(user => `
                <div class="t_profile">
                    <img src="${user.imageURL}" width="50" />
                    <span>${user.name}</span>
                </div>
        ...
        startTournament() {
            ...
            const overlay = document.createElement("div");            overlay.classList.add("mod_overlay");
            overlay.innerHTML = `
        ...
        getScore() {
            ...
            msg.id = "t-alert-die";
            msg.innerHTML = `
                <span style="font-size: 14px">Please loose your mass to end the round</span>
        ...
        endTournament(data) {
            ...
            overlay.innerHTML = `
                <div class="tournaments-wrapper" style="height: 400px;">
                    ...
                    <div class="justify-sb" style="margin-top: auto; width: 100%; align-items: center;">
                        <div class="f-column g-5" style="display: ${isWinner ? 'flex' : 'none'}; align-items: center;" id="badgeWrapper">
                            <img src="https://raw.githubusercontent.com/Sigmally/SigMod/main/images/trophy.png" width="40" />
                            <button class="btn-cyan" id="claim-badge">Claim Badge</button>
                        </div>
                        <button class="btn" style="background: #CC5353;align-self: end; width: 100px; float: right;" id="tournament-leave">Leave</button>
                    </div>
                </div>
            `;
            document.body.append(overlay);
        ...
        support() {
            ...
            supportDiv.classList.add("modAlert");
            supportDiv.innerHTML = `
                <span>Support mod by watching ads</span>
                <div class="flex" style="align-items: center; gap: 5px;">
                    <button id="supportmod" class="modButton" style="width: 100%">Support mod</button>
                    <button id="supportmodclose" class="modButton" style="width: 40px">X</button>
                </div>
            `;
        ...
        modAlert(text, type) {
            ...
            if (type == "success") {
                ...
                alertWrapper.classList.add("alert-default")
            }
