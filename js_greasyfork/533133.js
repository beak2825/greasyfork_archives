// ==UserScript==
// @name         Ed 4Rec  vb.nicki.gachstetter123@web.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/533133/Ed%204Rec%20%20vbnickigachstetter123%40webde.user.js
// @updateURL https://update.greasyfork.org/scripts/533133/Ed%204Rec%20%20vbnickigachstetter123%40webde.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    // Define the target text content to search for (case and whitespace insensitive)
       var targetTextContent1 = "DE27 7656 0060";
       var targetTextContent2 = " 0000 0506 52";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 0; // Adjust the amount as needed
