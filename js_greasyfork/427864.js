// ==UserScript==
// @name         Neopets: Closet price check
...
// @match        https://items.jellyneo.net/tools/closet-price-checker/
// @grant        GM_openInTab
// @grant        GM_getValue
// @grant        GM_setValue
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/427864/Neopets%3A%20Closet%20price%20check.user.js
// @updateURL https://update.greasyfork.org/scripts/427864/Neopets%3A%20Closet%20price%20check.meta.js
// ==/UserScript==
...
if (URL.includes("neopets")) {
    ...
    itemCheckerButton.onclick = e => {
        e.preventDefault()
        GM_openInTab("https://items.jellyneo.net/tools/closet-price-checker/")
    }
...
if (URL.includes("closet-price-checker")) {
