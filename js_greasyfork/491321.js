...
// @downloadURL https://update.greasyfork.org/scripts/491321/%D0%9B%D0%B5%D0%BC%D0%BE%D0%BD%D1%82%D0%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/491321/%D0%9B%D0%B5%D0%BC%D0%BE%D0%BD%D1%82%D0%B5.meta.js
// ==/UserScript==
	...
	},
{
		title: 'ЛС форума',
		content:
		'[SIZE=4][FONT=Veranda][CENTER]Приветствую, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]Написал вам в личные сообщения форума, ожидаю обратной связи.[/CENTER][/FONT]',
         prefix: PIN_PREFIX,
		status: true,
	},
	{
	...
	},
{
		...
		content:
		'[SIZE=4][FONT=Courier new][CENTER]Приветствую, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		"[CENTER]Ваши доказательства не работают, пожалуйста создайте новую тему - приложив доказательства с фото-хостинга<br>[URL='https://yapx.ru/']yapx.ru[/URL],<br>[URL='https://imgur.com/']imgur.com[/URL],<br>[URL='https://www.youtube.com/']youtube.com[/URL],<br>[URL='https://imgbb.com']ImgBB.com[/URL]<br>(все кликабельно).<br>" +
		'[CENTER][I][COLOR=rgb(255, 255, 255)]Закрыто[/COLOR][/I].[/CENTER][/FONT][/SIZE]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
{
		title: 'Жалоба за Махинации(Взлом)',
		content:
		'[CENTER]Доброго времени суток, уважаемый(ая) {{ user.mention }}.<br><br>' +
		"[CENTER] К техническому специалисту поступило обращение от игрока, то-что его игровой аккаунт подвергся взлому. После восстановления доступа к игровому аккаунту, игрок обнаружил, то-что его игровое имущество в виде Игровой Валюты пропало. После проверки системы логирования Техническим специалистом, выяснилось, то-что данная игровая валюта во время взлома была переведена на ваш твинк аккаунт - NickName. Думаете это совпадение? Ваш интернет протокол (IP) абсолютно схож с (IP) взломщика. " +
		'[CENTER]Игровые аккаунты обжалованию/апелляции не подлежат.[/CENTER]<br>' +
        '[CENTER][COLOR=rgb(255, 0, 0)]Отказано | Закрыто.[/COLOR][/CENTER]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
