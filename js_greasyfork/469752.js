...
// @downloadURL https://update.greasyfork.org/scripts/469752/Blog24me%20Faucet%20Rotator.user.js
// @updateURL https://update.greasyfork.org/scripts/469752/Blog24me%20Faucet%20Rotator.meta.js
// ==/UserScript==


//INSTALL THE SCRIPT AND HCAPTCHA SOLVER AND Solver - Letters with red lines
//EDIT LINE 32 WITH YOUR FAUCETPAY EMAIL ADDRESS
//THEN GOTO https://blog24.me/coin/?r=250 AND LEAVE THE TAB OPEN
...
(function() {
    ...
    const mail = "YOUR_FAUCETPAY-EMAIL" //EDIT WITH YOUR FAUCETPAY EMAIL ADDRESS
    ...
    var websiteData = [
        ...
        {url : "https://blog24.me/coin/faucet/currency/bnb", regex: "bnb"},
        {url : "https://blog24.me/coin/faucet/currency/bch", regex: "bch"},
        {url : "https://blog24.me/coin/faucet/currency/doge", regex: "doge"},
        {url : "https://blog24.me/coin/faucet/currency/ltc", regex: "ltc"},
        {url : "https://blog24.me/coin/faucet/currency/sol", regex: "sol"},
        {url : "https://blog24.me/coin/faucet/currency/trx", regex: "trx"},
        {url : "https://blog24.me/coin/faucet/currency/zec", regex: "zec"},
        {url : "https://blog24.me/coin/faucet/currency/fey", regex: "fey"},
        {url : "https://blog24.me/coin/faucet/currency/xrp", regex: "xrp"},
        {url : "https://blog24.me/coin/faucet/currency/matic", regex: "matic"},
        {url : "https://blog24.me/coin/faucet/currency/usdt", regex: "usdt"},
        {url : "https://blog24.me/coin/faucet/currency/btc", regex: "btc"},
        {url : "https://blog24.me/coin/faucet/currency/dgb", regex: "dgb"},
        {url : "https://blog24.me/coin/faucet/currency/dash", regex: "dash"},
        {url : "https://blog24.me/coin/faucet/currency/eth", regex: "eth"},
    ...
    var websiteMap = [
                       ...
                       {website : ["blog24.me"],
                       captchaButtonSubmitSelector: ["#subbutt",".btn.btn-primary.w-md","#subbutt","body > div.content > div > div > div > div > div > form > div > button","form button[type=submit]"],
...
(function()
{
 ...
 setTimeout(function login(){
    ...
    if (window.location.href == "https://blog24.me/coin" || window.location.href == "https://blog24.me/coin/") {
    window.location.replace("https://blog24.me/coin/?r=250")
    clearInterval(ref)
    }}, 500);

     setTimeout(function() {
    if (window.location.href == "https://blog24.me/coin/?r=250" || window.location.href == "https://blog24.me/coin/#loaded") {
   document.querySelector("#collapseTwo > div > a:nth-child(2)").click();
    }}, 10000)
