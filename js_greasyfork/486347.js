// ==UserScript==
// @name AudioBookBay hide category: Military
// @description Hide Military category
...
// @downloadURL https://update.greasyfork.org/scripts/486347/AudioBookBay%20hide%20category%3A%20Military.user.js
// @updateURL https://update.greasyfork.org/scripts/486347/AudioBookBay%20hide%20category%3A%20Military.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Military'
    $(".post").has(".postInfo:contains('Military')").hide();
});
