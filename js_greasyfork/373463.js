...
// @downloadURL https://update.greasyfork.org/scripts/373463/WME%20Mojones.user.js
// @updateURL https://update.greasyfork.org/scripts/373463/WME%20Mojones.meta.js
// ==/UserScript==
...
function initMapRaidOverlay() {
	...
	createLayerToggler(document.getElementById('layer-switcher-group_display').parentNode.parentNode, localStorage.MapRaidArgentinaVisible == "true", 'Mojones', function(checked) {
		localStorage.MapRaidArgentinaVisible = checked;
		mapLayer.setVisibility(checked);
	});

	mapLayer = new OL.Layer.Vector("Mojones", {
		uniqueName: "__Mojones"
	});
	...
	areaJumperRegion.label = 'Mojones (Bs As La Plata)';
