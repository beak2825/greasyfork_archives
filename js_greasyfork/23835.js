...
// @downloadURL https://update.greasyfork.org/scripts/23835/Hybrid%20-%20Match%20info.user.js
// @updateURL https://update.greasyfork.org/scripts/23835/Hybrid%20-%20Match%20info.meta.js
// ==/UserScript==

if ($('li:contains("Match info")').length) {
    var div = [], arrA = [], arrB = [],
        color = '#80ff80';
