...
// @version    0.4.7
// @description  Помогает визуально увидеть популярность той или иной раздачи.
// @include    *://rutor.info/*
// @include    *://rutor.is/*
// @include    *://6tor.org/*
...
// @grant       GM_addStyle
//
// @downloadURL https://update.greasyfork.org/scripts/368333/RuTororg%20seed%20graph.user.js
// @updateURL https://update.greasyfork.org/scripts/368333/RuTororg%20seed%20graph.meta.js
// ==/UserScript==
...
//
// v0.3.5
//	- Исправления в связи с изменениями на сайте
//
// v0.3.3
// 	- Смена маски скрипта так, чтоб он срабатывал как для домена с www, так и для альтернативного сервера alt.rutor.org
//
// v0.3
...
GM_addStyle('#qmegas_settings { width: 400px; height: 260px; position: fixed; left: 0; top: 0; background-color: #fff; border: 1px solid #a00; }');
...
function RutorScript()
{
	...
	this.loadSettings = function()
	{
		this.settings = {
			...
			netflix_color: GM_getValue('netflix_color', '#ddd5e2'),
		};
	}
	...
	this.markLines = function()
	{
		...
		$('tr.gai, tr.tum').each(function(){
		    ...
		    if (obj.settings.mark_ipad && ((sp1a.innerHTML.indexOf('iPad') !== -1) || (sp1a.innerHTML.indexOf('КПК') !== -1)))
            ...
            if (obj.settings.mark_netflix && (sp1a.innerHTML.indexOf('Netflix') !== -1))
