// ==UserScript==
// @name         ARKHANGELSK | Био и Жалобы
// @namespace    https://forum.blackrussia.online
// @version     5.0
// @description  Архангельск скриптик
// @author       Roman MiLitao
...
// @downloadURL https://update.greasyfork.org/scripts/541107/ARKHANGELSK%20%7C%20%D0%91%D0%B8%D0%BE%20%D0%B8%20%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/541107/ARKHANGELSK%20%7C%20%D0%91%D0%B8%D0%BE%20%D0%B8%20%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][COLOR=orange]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		'[Color=AQUA][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на ARKHANGELSK.[/CENTER][/color]' +
    ...
    },
    {
	  ...
	  content:
        ...
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на ARKHANGELSK.[/CENTER][/color]' +
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Вы ошиблись разделом.<br>Обратитесь в раздел [URL='https://fo.blackrussia.online/index.php?fos/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.1570/']Жалобы на администрацию[/URL].[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на ARKHANGELSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Вы ошиблись разделом.<br>Обратитесь в раздел [URL='https://fo.blackrussia.online/index.php?fos/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.1573/']Обжалование наказаний[/URL].[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на ARKHANGELSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба составлена не по форме.<br>Убедительная просьба ознакомиться [URL='https://fo.blackrussia.online/index.php?threads/3429394/']с правилами подачи жалоб на игроков[/URL].[/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на ARKHANGELSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
	...
	},
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Заголовок вашей жалобы составлен не по форме. Убедительная просьба ознакомиться [URL='https://fo.blackrussia.online/index.php?threads/3429394/']с правилами подачи жалоб на игроков[/URL].[/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Приятной игры на ARKHANGELSK.[/CENTER][/color]' +
        '[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: UNACCСEPT_PREFIX,
    ...
    },
    {
	  ...
	  content:
        ...
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на ARKHANGELSK.[/ICODE][/CENTER][/color]' +
        '[COLOR=GREEN][CENTER]✿❯────「Одобрено ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
     ...
     },
    {
	  ...
	  content:
		...
		"[CENTER][COLOR=#FFFF00][ICODE]Ваша РП ситуация получает статус-Отказано.'Причиной отказа могло послужить какое-либо нарушение из Правила создания неофицальной RolePlay организации./ICODE][/COLOR][/CENTER]<br>" +
		 '[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на ArkhangelskK.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/VNTPGQsQ/image2-3-1-1-1-10.gif[/img][/url]<br>',
...
title: 'Неофициальная РП организация скопирована',
    ...
    },
    {
        ...
        "[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://fo.a.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.3500136/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
    ...
    },
    {
        ...
        "[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://forussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.3500136/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
		'[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		'[COLOR=RED][CENTER]✿❯────「Отказано ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
        ...
        "[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://fo.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BDD0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.3500136/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
    ...
    },
    {
        ...
        "[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://fo.bla.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.3500136/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
    ...
    },
    {
        ...
        "[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://fo.b.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.3500136/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
    ...
    },
    {
        ...
        "[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://fo./index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.3500136/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
    ...
    },
    {
        ...
        "[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://fo.blackruia.one/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.3500136/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
