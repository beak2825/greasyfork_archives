// ==UserScript==
// @name         YouTube - Add Watch on yewtu.be button to each video
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Add "yewtu.be" button YouTube videos
// @author       cam
// @match        https://www.youtube.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/521319/YouTube%20-%20Add%20Watch%20on%20yewtube%20button%20to%20each%20video.user.js
// @updateURL https://update.greasyfork.org/scripts/521319/YouTube%20-%20Add%20Watch%20on%20yewtube%20button%20to%20each%20video.meta.js
// ==/UserScript==
...
(function() {
    ...
    function replaceYouTubeURL(url) {
        return url.replace('www.youtube.com', 'yewtu.be');
    }
    ...
    const existingVideos = document.querySelectorAll('.style-scope.ytd-rich-item-renderer');
