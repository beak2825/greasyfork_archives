(function() {
	...
	css += [
		"/* Visual SVN custom styles */",
		"#content {width:100% !important;}",
		"tr.removed {background-color: #460000 !important}",
		"tr.added {background-color: #002700 !important}",
		"span.modified-file:before {background-color: blue !important}",
		"span.added-file:before {background-color: green !important}",
		"span.deleted-file:before {background-color: red !important}",
		"a.button {background-image: none !important; background-color: black !important, color: silver !important}",
		"}"
	].join("\n");

	css += [
		"/* Styles from midnigth surfing */",
