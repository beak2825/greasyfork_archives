...
// @grant          GM_getValue
// @grant          GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/4204/Porko%20Solver.user.js
// @updateURL https://update.greasyfork.org/scripts/4204/Porko%20Solver.meta.js
// ==/UserScript==

//Version 1.41
// - add @grant, change GM_log to console.log
//Version 1.4
...
function playAgain() {
    ...
    if (s) {
        ...
        if (x) {
            ...
            GM_setValue('repeatgame',0);
            GM_setValue('repeatinggame',0);
            console.log('lost sync, giving up');
        }
    }
}
