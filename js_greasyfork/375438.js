// ==UserScript==
// @name         Baidu首页增加Bing壁纸
// @namespace    http://zhangbohun.github.io/2015/05/20/Bing%E5%A3%81%E7%BA%B8%E4%B8%8B%E8%BD%BD%E5%99%A8/
// @version      0.2.7.6
// @description  Baidu首页增加Bing壁纸（需要关闭百度自带壁纸）
// @author       zhangbohun
// @match   	 *://www.baidu.com/
...
// @downloadURL https://update.greasyfork.org/scripts/375438/Baidu%E9%A6%96%E9%A1%B5%E5%A2%9E%E5%8A%A0Bing%E5%A3%81%E7%BA%B8.user.js
// @updateURL https://update.greasyfork.org/scripts/375438/Baidu%E9%A6%96%E9%A1%B5%E5%A2%9E%E5%8A%A0Bing%E5%A3%81%E7%BA%B8.meta.js
// ==/UserScript==
'use strict';
...
function setbackground(url, theme) {
    ...
    link.rel = 'stylesheet';
    link.href = 'https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superplus/css/skin_opacity' + 50 + '.css';//导航框透明度
    ...
    if (document.querySelector('.user-name') !== null) {
        ...
        document.querySelector('#s_main').style.background='rgba(255,255,255,.6)';
        //显示图片说明
        document.querySelector('#s_menu_mine').click();
		document.querySelector('#s_menus_wrapper').innerHTML = '&nbsp;&nbsp;&nbsp;今日壁纸主题： <b>&nbsp;&nbsp;' + theme + '</b>';
		document.querySelector('#s_menus_wrapper').style.color='#000';
		//document.querySelector('.s-block-container').style.paddingTop='0';
        //隐藏无用信息
...
window.onload = function () {
	...
	nextDayDate.setSeconds(5);
	setTimeout (function(){ if(localStorage.date != new Date().getDate()) {window.location.reload(); }},nextDayDate-date);
     ...
     */
    var icons =  document.querySelector("#u1");
    ...
    iframe.onload = function () {
        ...
        var rili = $("#content_left .result-op", iframe.contentDocument);
        rili.after("<br/><br/>");
        $("#head,.head_nums_cont_outer", iframe.contentDocument).hide();
        $("#searchTag", iframe.contentDocument).hide();
        iframe.setAttribute("scrolling", "no");
        ...
        if (today[0]&&today[0].classList.contains("op-calendar-pc-table-festival")) {
