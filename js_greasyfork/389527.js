...
// @downloadURL https://update.greasyfork.org/scripts/389527/KaniWani%20audio.user.js
// @updateURL https://update.greasyfork.org/scripts/389527/KaniWani%20audio.meta.js
// ==/UserScript==
...
function onCorrectAnswerObserver(f){
    ...
    var observer = new MutationObserver(function() {
        ...
        if (target && window.getComputedStyle(target).backgroundColor === 'rgb(127, 212, 104)') {
            // Answer was correct!
            f();
        }
    });
