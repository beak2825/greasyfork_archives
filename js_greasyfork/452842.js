...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/452842/Teleparty%20Chat%20Unlocker.user.js
// @updateURL https://update.greasyfork.org/scripts/452842/Teleparty%20Chat%20Unlocker.meta.js
// ==/UserScript==
...
let injectionInterval = setInterval(() => {
    if (document.getElementById("function-user")) {
        if (document.getElementById("function-user").children[0].innerHTML.includes("Unlock")) {
            return;
        } else {
            inject();
