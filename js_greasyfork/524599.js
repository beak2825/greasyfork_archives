// ==UserScript==
// @name         Autofill Buy/Sell Personal
// @version      1.8
...
// @downloadURL https://update.greasyfork.org/scripts/524599/Autofill%20BuySell%20Personal.user.js
// @updateURL https://update.greasyfork.org/scripts/524599/Autofill%20BuySell%20Personal.meta.js
// ==/UserScript==
...
(function() {
    ...
    popup.innerHTML =
        ...
        '<button id="shortcut325Btn">325</button>' +
        '<button id="shortcut350Btn">350</button><br><br>' +
        '<button id="shortcut375Btn">375</button>' +
        '<button id="shortcut400Btn">400</button>' +
        '<button id="shortcut425Btn">425</button>' +
        '<button id="shortcut450Btn">450</button>' +
        '<button id="shortcut475Btn">475</button>' +
        '<button id="shortcut500Btn">500</button>' +
        '<button id="shortcut550Btn">550</button><br><br>' +
    ...
    document.getElementById('shortcut325Btn').addEventListener('click', () => setTargetPrice(250));
    document.getElementById('shortcut350Btn').addEventListener('click', () => setTargetPrice(295));
    document.getElementById('shortcut375Btn').addEventListener('click', () => setTargetPrice(330));
    document.getElementById('shortcut400Btn').addEventListener('click', () => setTargetPrice(360));
    document.getElementById('shortcut425Btn').addEventListener('click', () => setTargetPrice(380));
    document.getElementById('shortcut450Btn').addEventListener('click', () => setTargetPrice(400));
    document.getElementById('shortcut475Btn').addEventListener('click', () => setTargetPrice(420));
    document.getElementById('shortcut500Btn').addEventListener('click', () => setTargetPrice(440));
    document.getElementById('shortcut550Btn').addEventListener('click', () => setTargetPrice(470));
