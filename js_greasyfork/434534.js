...
// @description    Помощник ГО (версия от 2025.09.17)
...
// @license        MIT
// @downloadURL https://update.greasyfork.org/scripts/434534/HWM%20GO%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/434534/HWM%20GO%20Helper.meta.js
// ==/UserScript==
...
var max_exp          = 0;
var version          = "6.361.1 (2025.09.17)";
var url_cur          = location.href;
var url_home         = "home.php";
var url_map          = "map.php";
var url_war          = "group_wars.php";
var str_url          = "https://greasyfork.org/ru/scripts/434534-hwm-go-helper";
...
function settings_list()
{
  ...
  for (var key in mob_rus_exp) { //перебор существ из базы и выводим чекбоксы с именем существа
    ...
    if (pic_enable) s_pic_out = '<tr><td><div class="cre_creature"><img width="60" height="50" border="0" src="https://dcdn.heroeswm.ru/i/portraits/'+mob_rus_exp[$ustring(key)][2]+'anip33.png"> <img class="cre_mon_image2" width="60" height="50" border="0" src="https://dcdn.heroeswm.ru/i/army_html/frame_lvl1_120x100_woa.png?v=1"></td>';//выводим картинку
...
function settings_go()
{
  ...
  //Выбор пропусков str_skip_select_3
	...
	'<label>'+str_skip_no_half+'<img width="16" height="16" border="0" title="Бриллианты" src="https://dcdn.heroeswm.ru/i/r/48/diamonds.png">'+
...
var mob_rus_exp = {   //Cтруктура:[опыт,HP,код,птица]
  ...
  "Адские реаниматоры":[43,27,"reanimatorup",0],
  "Адские троглодиты":[7,6,"troglodyteup",0],
  "Айсберговые элементали":[50,90,"iceelb",1],
  "Алмазные големы":[110,60,"diamondgolem",0],
  "Алмасты":[400,290,"yetiup",0],
  ...
  "Воины ярости":[42,30,"battlerager",0],
  ...
  "Громоглавы":[14,10,"axegnom",0],
  "Гунны":[60,33,"nomadup",0],
  "Дезертиры":[40,25,"deserter",0],
  ...
  "Мобильные баллисты":[100,65,"cbal",0],
  "Молотобойцы":[12,9,"gnomon",0],
  "Монахи":[101,54,"priest",0],
  "Морские волки":[30,25,"ppirate",0],
  ...
  "Никсы":[110,80,"reptiloid",0],
  "Никсы-воины":[180,90,"reptiloidup",0],
  "Нимфы":[20,6,"dryad_",1],
  "Обречённые бомбардиры":[208,76,"pushkarup",0],
  ...
  "Одноногие пираты":[55,30,"ppirateup",0],
  ...
  "Пожиратели плоти":[130,70,"hungerplant",0],
  ...
  "Скорпикоры":[140,80,"manticoreup",1],
  "Скорпионы":[6,4,"scorp",0],
  "Слуги Анубиса":[350,160,"anubis",0],
  "Служители оазисов":[110,70,"krokodil",0],
  "Снежные воины":[35,27,"chuvak",0],
  "Снежные волки":[70,50,"snowwolf",0],
  "Снежные монстры":[400,350,"snowmonster",0],
  ...
  "Чародеи-ренегаты":[6,8,"outlawup",0],
  "Чемпионы":[252,100,"champion",0],
  "Черные вдовы":[40,14,"blackwidow",0],
  ...
  "Ямабуси Тэнгу":[100,60,"tenguup",1],
  "Ярлы":[162,120,"flamelord",0]
//*************** Новогодние существа ***************
//  "Злой бык 2021":[69,71,"bull2021",0],
