...
// @downloadURL https://update.greasyfork.org/scripts/39903/%E5%8F%AF%E6%A8%82%E4%BF%AE%E6%94%B9%20%E8%87%AA%E5%8B%95%E8%A3%9C%20%E5%8F%AB%E6%AE%BA.user.js
// @updateURL https://update.greasyfork.org/scripts/39903/%E5%8F%AF%E6%A8%82%E4%BF%AE%E6%94%B9%20%E8%87%AA%E5%8B%95%E8%A3%9C%20%E5%8F%AB%E6%AE%BA.meta.js
// ==/UserScript==
   ...
   var bm = 0,
    ...
    function QiXiaTalkFunc() {
        // if (userqu == 15 || userqu == 47 || userqu == 51 || userqu == 56 || userqu == 57 || userqu == 64 || userqu == 66 || userqu == 68) {
            var a = prompt("請輸入撩奇俠順序（中文分號隔開）", "步驚鴻；郭濟；火雲邪神；浪喚雨；逆風舞；王蓉；風南；李宇飛；龐統；吳縝；狐蒼雁；風行騅；護竺；玄月研；狼居胥；烈九州；穆妙羽；宇文無敵；李玄霸；八部龍將；風無痕；厲滄若；夏岳卿；妙無心；巫夜姬");
            qxList = a.split("；");
            qxOrder = 0;
