// ==UserScript==
// @name         FF Scouter V2 edited version by D1pl0753
// @namespace    Violentmonkey Scripts
// @match        https://www.torn.com/*
// @version      2.64
// @author       rDacted, Weav3r, xentac, (small edit by D1pl0753)
...
// @license      GPL-3.0
// @downloadURL https://update.greasyfork.org/scripts/558258/FF%20Scouter%20V2%20edited%20version%20by%20D1pl0753.user.js
// @updateURL https://update.greasyfork.org/scripts/558258/FF%20Scouter%20V2%20edited%20version%20by%20D1pl0753.meta.js
// ==/UserScript==

const FF_VERSION = "2.63";
            ...
            ff_response.forEach((result) => {
              if (result && result.player_id) {
                if (result.fair_fight === null) {
                  ...
                  // Also save to localStorage for other scripts
                  localStorage.setItem("ffscouterv2-" + result.player_id, JSON.stringify(cacheObj));
                } else {
                  let cacheObj = {
