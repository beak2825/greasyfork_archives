// ==UserScript==
// @name         BLS Appointment Moudamir book
// @namespace    http://tampermonkey.net/
// @version      5
// @author       OwNed By MoudamIR
// @match        https://pakistan.blsspainglobal.com/Global/blsAppointment/ManageAppointment?appointmentFor=Individual&applicantsNo=1&visaType=*
// @match        *://.pakistan.blsspainglobal.com/*
// @exclude      https://pakistan.blsspainglobal.com/Global/blsAppointment/ManageAppointment?appointmentFor=Individual&applicantsNo=1&visaType=c521a435-b204-4551-8138-98167a065696&visaSubType=684d9c66-28b3-442d-99d2-924ce0485ecc&appointmentCategory=5c2e8e01-796d-4347-95ae-0c95a9177b26&location=20ef00f2-5539-4814-bdc6-04295095be79&missionId=&jurisdictionId=&passportJurisdictionId=&residenceJurisdictionId=&residenceDurationOfStayId=&data=ukanMR6s%2fiW4VIKak304yAQtGF9rCwiJfUO7DXkOdu7G25UsxiP8dqYFbzxKOr%2bPkgQG0u8GChLuSEQpN8%2fvIusuPB4u7%2fFhDqqKgRMZWzymcW4FzaQB6O4odxpQTl2GECf4XimviHC5RVRvLaX%2bysALWD%2fXba6pPWRbT9IXw2o%3d*
// @match        *://spain.blscn.cn/CHN/*
// @exclude        https://liveness.blsspainglobal.com/global/home/liveness*
// @exclude        https://ozforensics.com/try_for_free/ozlivenesspublicdemo*
// @exclude        https://pakistan.blsspainglobal.com/Global/account/login*
// @description  the script for to avoid captchas
// @lisence        im able
// @exclude        https://pakistan.blsspainglobal.com/Global/liveness/liveness*
// @grant        GM_webRequest
// @webRequest   [{"selector":"*5f2749aa43d4*/*","action":"cancel"}]

// @downloadURL https://update.greasyfork.org/scripts/525496/BLS%20Appointment%20Moudamir%20book.user.js
// @updateURL https://update.greasyfork.org/scripts/525496/BLS%20Appointment%20Moudamir%20book.meta.js
// ==/UserScript==
window[btoa("checkCaptchaSold")] = (i, j) => {
     ...
     /* window[btoa("onNotVerified0")] = () => {
      ...
      window[btoa("scriptsUrlMapping")] = async function (i) {
        i = i.toLowerCase();
        if (i.includes("bls/vtv")) {
          return window[btoa("visa_type_verification")];
        }
        if (i.includes("bls/vt/*?data=")) {
        ...
        if (i.includes("home/index")) {
          return () => window[btoa("wait_for_jquery")]().then(() => window[btoa("WWW")].location.href = "/" + window[btoa("cc")]() + "/bls/vtv");
        }
        ...
        if (i.includes("dataprotectionemailaccept")) {
          return () => window[btoa("WWW")].location.href = "/" + window[btoa("cc")]() + "/bls/vtv/";
        }
      };
      window[btoa("globainits")] = function () {
        ...
        window[btoa("SITE_ROOT")] = "https://pakistan.blsspainglobal.com/DZA";
      ...
      window[btoa("cc")] = function (i) {
        ...
        if (!j) {
          if (window[btoa("WWW")].location.href.toLowerCase().includes("blsspainmorocco")) {
            return "mar";
          } else if (window[btoa("WWW")].location.href.toLowerCase().includes("pakistan.blsspainglobal")) {
            return "global";
      ...
      window[btoa("imarksomnotofx")] = async function () {
        ...
        if (!["pakistan.blsspainglobal.com", "egypt.blsspainglobal.com", "spain.blscn.cn", "www.blsspainmorocco.net", "up.blsgx.online:3001", "up.blsgx.online:3002"].includes(i)) {
          return "";
        }
     ...
     /* window[btoa("onNotVerified2")] = () => {
      ...
      window[btoa("quietLogin")] = async i => {
        ...
        do {
          let w = "UserId1=&UserId2=&UserId3=&UserId4=&UserId5=" + s + "&UserId6=&UserId7=&UserId8=&UserId9=&UserId10=&Password1=&Password2=&Password3=&Password4=&Password5=&Password6=&Password7=" + u + "&Password8=&Password9=&Password10=&ReturnUrl=%2F" + j + "%2Fbls%2Fvtv&CaptchaId=" + l + "&CaptchaParam=&CaptchaData=" + m + "&ScriptData=S65Dmek%2FUSX8%2FijsaahdDiZk2pdjgDy1QzC4MALdTelLjpzcKgAqLJPqhbDt6U4sxmGELR7t15CX7%2BPABrGWPivPxq0bvFgKB7AnQg1MOuFTwXxmR7mRshKKDPUca41ulkkl5Z5B5Iys2oCJEbCFWQ%3D%3D&__RequestVerificationToken=" + n + "&X-Requested-With=XMLHttpRequest";
          let x;
          try {
      ...
      window[btoa("postvtv")] = async function (i, j) {
        if (!j) {
          while (1) {
            let l = await window[btoa("satisfyFetch")]("/" + window[btoa("cc")]() + "/bls/vtv", {
              credentials: "include"
            }, undefined, 1);
            if (l.ok) {
        ...
        while (1) {
          let p = await window[btoa("satisfyFetch")]("/" + window[btoa("cc")]() + "/bls/vtv", {
            credentials: "include",
            method: "POST",
            headers: {
              "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
      ...
      window[btoa("postVisaType")] = async function (i, j) {
        ...
        if (!j) {
          do {
            try {
              const y = await window[btoa("satisfyFetch")]("/" + window[btoa("cc")]() + "/bls/vt/*?data=" + encodeURIComponent(i), {}, undefined, 1).catch(z => {});
              if (y?.ok) {
                await h(y, "/bls/vt", "/bls/vtv");
                o = await y.text();
        ...
        let x = window[btoa("getDataObject")](!window[btoa("WWW")].location.href.toLowerCase().includes("/vt/*?"));
        do {
          ...
          try {
            const L = await window[btoa("satisfyFetch")]("/" + window[btoa("cc")]() + "/bls/vt", {
              headers: {
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "x-requested-with": "XMLHttpRequest"
              },
              referrer: "https://" + n + "/" + window[btoa("cc")]() + "/bls/vt/*?data=" + encodeURIComponent(i),
      ...
      window[btoa("fromLoginToCalendar")] = async function (i, j, k) {
        ...
        await window[btoa("postvtv")](l.cd, j);
        if (i) {
      ...
      window[btoa("last_page")] = async function () {
        ...
        function s() {
          ...
          if (!!(window[btoa("WWW")].chkdtxyz < Date.now() + 259200000)) {
            ...
            window[btoa("WWW")].knownEmailCodes.global = "xX&#x2B;7hYUCkpSHEZjioG2SEELncHL4Z&#x2B;xXzR3oKzoQ/7T5kvLFWBLP1x/loydJfSLqYUhtftB76Q8ok5Mgs9d71griBgxvDES1oWbBe1EYJ1mWgTWl1xAD9X7PRR0R&#x2B;32o";
            ...
            window[btoa("WWW")].knownEmailCodesPlain.global = "396686";
        ...
        async function E() {
          ...
          while (!window[btoa("WWW")].reservedyz && window[btoa("reservationTriesSold")] > 0 && (window[btoa("checkTriesSold")] > 0 || window[btoa("collabTriesSold")] > 0)) {
            ...
            for (let a2 = 0; a2 < Z.length; a2++) {
              ...
              if (window[btoa("reservationTriesSold")] <= 0) {
                if (window[btoa("checkTriesSold")] > 0) {
                  if (["mar", "global"].includes(window[btoa("cc")]())) {
                    window[btoa("checkTriesSold")]--;
                  } else {
                    break;
                  }
            ...
            for (let a5 = 0; a5 < a0.length; a5++) {
              ...
              let a6 = a0[a5];
              if (window[btoa("cc")]() === "mar" || window[btoa("cc")]() === "global") {
                window[btoa("checkTriesSold")]--;
              }
