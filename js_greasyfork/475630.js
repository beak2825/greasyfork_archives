    ...
    // ==UserScript==
    // @name         Azure | Скрипт Для Жалоб на лидеров
    // @namespace    https://greasyfork.org/ru/scripts/474883-azure-%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82-%D0%B4%D0%BB%D1%8F-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1
    // @version      4.01
    // @description  Скрипт для упрощения работы с жалобами
    // @author       R.Imanaliev reworked in Junior_Grand
    // @match        https://forum.blackrussia.online/threads/*
    // @include      https://forum.blackrussia.online/threads/
    // @icon         https://icons.iconarchive.com/icons/elegantthemes/beautiful-flat/256/Dev-icon.png
    // @grant        none
    // @license      none
// @downloadURL https://update.greasyfork.org/scripts/475630/Azure%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%94%D0%BB%D1%8F%20%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%20%D0%BD%D0%B0%20%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/475630/Azure%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%94%D0%BB%D1%8F%20%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%20%D0%BD%D0%B0%20%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.meta.js
    // ==/UserScript==
    ...
    (function () {
        ...
        const TEX_PREFIX = 13; // Префикс "Техническому Администратору"
        ...
        },
        {
          ...
          content: '[HEADING=2][CENTER][FONT=times new roman][SIZE=4][I][B]Здравствуйте. Ваша жалоба взята на [/B][/I][/SIZE][COLOR=rgb(251, 160, 38)][SIZE=4][I][B]рассмотрение[/B][/I][/SIZE][/COLOR][SIZE=4][I][B].[/B][/I][/SIZE][/FONT][/CENTER][/HEADING] [HEADING=2][CENTER][SIZE=4][FONT=times new roman][I][B][/B][/I][/FONT][/SIZE][/CENTER][/HEADING] [HEADING=2][CENTER][SIZE=4][FONT=times new roman][B][I]Ожидайте ответа....[/I][/B][/FONT][/SIZE][/CENTER][/HEADING]',
          prefix: PIN_PREFIX,
        },
        {
           title: 'Нет в логах',
          content:
            ...
            '[Color=Red][CENTER]Отказано, закрыто.[/CENTER][/I][/color][/FONT]',
          prefix: UNACCСEPT_PREFIX,
          status: false,
        },
        {
        ...
        {
          title: 'Помеха Рп процессу(2.04)',
          content:
            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
            "[CENTER]Нарушитель будет наказан по данному пункту правил:[Color=Red]2.02[/COLOR]. Запрещены любые действия способные привести к помехам в игровом процессе, а также выполнению работ, если они этого не предусматривают и если эти действия выходят за рамки игрового процесса данной работы. | [Color=Red]Ban 10 дней / [Color=Orange]Обнуление аккаунта (при повторном нарушении).[/color][/color][/CENTER]<br>" +
            '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
            "[CENTER] Приятной игры на [Color=Red]Black Russia [/I][/CENTER][/color][/FONT]",
          prefix: ACCСEPT_PREFIX,
          status: false,
        ...
        {
          title: 'Помеха РП процессу(Джаил 30 минут)',
          content:
            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        ...
        },
        {
          ...
          content:
            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
            "[CENTER]Нарушитель будет наказан по пунтку правил: [Color=Red]9.01[/color]. Запрещено наносить урон игрокам без Role Play причины на территории ФСИН | [Color=Red]Warn[/color][/CENTER]<br>" +
            '[Color=Lime][CENTER]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]',
          prefix: ACCСEPT_PREFIX,
          status: false,
        },
        ...
        $(document).ready(() => {
            ...
            addButton('Быстрые ответы', 'selectAnswer3');
