...
// @grant	GM_getValue
// @grant	GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/31412/Page%20Scroll%20Marker.user.js
// @updateURL https://update.greasyfork.org/scripts/31412/Page%20Scroll%20Marker.meta.js
// ==/UserScript==

(function () {
  if (document.designMode == 'on' || document.body instanceof HTMLFrameSetElement || document.URL.indexOf(location.protocol) !== 0) return;

  var generalName = GM_info.script.name;
  var containerID = GM_info.script.namespace.concat(generalName).replace(/\W/g, '');
  ...
  document.addEventListener('resize', function (e) {
    for (var sf in ScrollNode.instances) {
      ScrollNode.instances[sf].update();
    }
  }, true);
