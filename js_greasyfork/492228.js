// ==UserScript==
// @name Google Search Classic Navbar Red
// @version 0.3.2
// @author yakisova41
// @license MIT
...
// @description:ja Google検索の上のメニューを従来のデザインに無理やり戻します。
// @icon data:image/png;base64,
// @downloadURL https://update.greasyfork.org/scripts/492228/Google%20Search%20Classic%20Navbar%20Red.user.js
// @updateURL https://update.greasyfork.org/scripts/492228/Google%20Search%20Classic%20Navbar%20Red.meta.js
// ==/UserScript==
...
function registerNavItems(itemsDom) {
  itemsDom.appendTbmActiveItem(
    ...
    itemsDom.createItemElem(
      translate("Web"),
      getIconSvgElement(paths.Web),
      true,
      createAllUrl()
    ),
    itemsDom.createItemElem(
      translate("Web"),
      getIconSvgElement(enablePaths.Web),
      false
    )
  );
  itemsDom.appendTbmActiveItem(
    ...
    const styles = {
      dark: `
        :root {
          ...
          --classic-google-nav-bar-primary:#fa7d6e;
        }
      `,
      right: `
        :root {
          --classic-google-nav-bar-text:#202124;
          --classic-google-nav-bar-primary:#dd4b39;
        }
      `
    };
    return styles[theme];
...
function getElement(selectorsList) {
  let returnElem = null;
...
function setUniqueSelector(navbar) {
  if (navbar !== null) {
...
var exportedTrustedPolicy = trustedPolicy;
