...
// @downloadURL https://update.greasyfork.org/scripts/499137/Script%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Arzamas%20%7C%20by%20lorenzikk.user.js
// @updateURL https://update.greasyfork.org/scripts/499137/Script%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Arzamas%20%7C%20by%20lorenzikk.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
 {
            title: 'Приветствие',
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
            ...
            style: 'border-radius: 25px; background: #008000; font-family: JetBrains Mono',
              ...
              {
            title: 'Покупка / Продажа Слотов в семью',
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER][FONT=Georgia][I][B]Покупка / Продажа слотов в семью за игровую валюту строго запрещена. <br> Ваш аккаунт и аккаунта игрока будут заблокированы по пункту правил: [Color=Red]2.28[/COLOR]. Запрещена покупка/продажа внутриигровой валюты за реальные деньги в любом виде | [Color=Red]PermBan с обнулением аккаунта + ЧС проекта.[/color][/FONT][/I][/B][/CENTER]<br><br>" +
                "[CENTER][FONT=Georgia][I][B][Color=Red]Примечание:[/COLOR] любые попытки купить или продать внутриигровую валюту, интересоваться этим у других игроков или обсуждать это – наказуемо.[/FONT][/I][/B][/CENTER]<br>" +
                "[CENTER][FONT=Georgia][I][B][Color=Red]Примечание:[/COLOR] нельзя обменивать донат валюту (например, рубли, пополненные через сайт) на игровые ценности и наоборот. [/FONT][/I][/B][/CENTER]<br>" +
                "[CENTER][FONT=Georgia][I][B][Color=Red]Пример:[/COLOR] пополнение донат-счёта другого игрока в обмен на игровую валюту или другие ценности запрещено. [/FONT][/I][/B][/CENTER]<br>" +
                "[CENTER][FONT=Georgia][I][B][Color=Red]Примечание:[/COLOR] продавать или обменивать игровые ценности, которые были куплены за донат-валюту, не запрещено. [/FONT][/I][/B][/CENTER]<br>" +
                "[CENTER][FONT=Georgia][I][B][Color=Red]Исключение:[/COLOR] покупка игровой валюты или ценностей через официальный сайт разрешена. [/FONT][/I][/B][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Рассмотрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            title: 'РК',
            content:
              '[Color=rgb(0, 255, 255)][FONT=Georgia][CENTER][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/color][/CENTER]<br>' +
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]1.07[/color]. Всем сотрудникам государственных организаций запрещено выполнять работы где-либо в форме, принадлежащей своей фракции | [Color=Red]Jail 30 минут[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]1.13[/color]. Запрещено находиться в форме внутри казино, участвовать в битве за контейнеры, участвовать в захвате семейного контейнера, находится на Б/У рынке с целью покупки / продажи авто, а также устраиваться на сторонние работы в форме фракции | [Color=Red]Jail 30 минут[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]2.02[/color]. Наносить урон игрокам, которые находятся вне территории воинской части, запрещено | [Color=Red]Jail 30 минут / Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]6.01[/color]. Запрещено наносить урон игрокам без Role Play причины на территории УМВД | [Color=Red]Jail 30 минут / Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]6.03[/color]. Запрещено оказывать задержание без Role Play отыгровки | [Color=Red]Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]6.04[/color]. Запрещено nRP поведение | [Color=Red]Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]7.01[/color]. Запрещено наносить урон игрокам без Role Play причины на территории ГИБДД | [Color=Red]Jail 30[/color] минут / Warn[/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]7.03[/color]. Запрещено оказывать задержание без Role Play отыгровки | [Color=Red]Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]7.05[/color]. Запрещено отбирать водительские права во время погони за нарушителем | [Color=Red]Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]8.01[/color]. Запрещено наносить урон игрокам без Role Play причины на территории ФСБ | [Color=Red]Jail 30 минут / Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]8.03[/color]. Запрещено оказывать задержание без Role Play отыгровки | [Color=Red]Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]9.01[/color]. Запрещено наносить урон игрокам без Role Play причины на территории ФСИН | [Color=Red]Jail 30 минут / Warn[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: За нарушение правил нападения на [Color=Orange]Войсковую Часть[/color] выдаётся предупреждение | [Color=Red]Jail 30 минут (NonRP нападение) / Warn (Для сотрудников ОПГ)[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Нарушитель будет наказан по пункту правил: Нападение на [Color=Orange]военную часть[/color] разрешено только через блокпост КПП с последовательностью взлома | [Color=Red]Warn NonRP В/Ч[/color][/CENTER]<br>" +
                '[Color=rgb(0, 255, 127)][CENTER]Одобрено, закрыто.[/color]<br>' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: ACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                ...
                '[CENTER]По крайней мере Ваши действия и слова нарушают правила данной площадки, а так же правила подачи жалоб.[/CENTER]<br>' +
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]В вашей жалобе недостаточно доказательств о нарушении со стороны игрока.[/CENTER]<br>" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Недостаточно доказательств на слив склада',
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]В таких случаях нужно включить видеозапись и показать, что вы являетесь лидером, какие ограничения на взятие патронов, а также сам слив от игрока.[/CENTER]<br>" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Предоставленные вами доказательства в жалобе имеют плохое качество. Трудно что-то разобрать.[/CENTER]<br>" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
         {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER][FONT=Georgia][I]Ваша жалоба составлена не по форме. Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.3429394/']правилами подачи жалоб на игроков[/URL].[/CENTER]" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
         {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Доступ к вашим доказательствам закрыт.<br>[url=https://postimages.org/][img]https://i.postimg.cc/8C2PPQdd/150.png[/img][/url].[/CENTER]<br>" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Ваша жалоба отказана, т.к в ней нету тайм-кодов. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений.[/CENTER]<br>" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER][B][I][FONT=Georgia]Прикрепление доказательств обязательно. <br>" +
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER][B][I][FONT=Georgia]На Ваших доказательствах видно, что они отредактированы.[/CENTER]" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER][B][I][FONT=Georgia]Вы ошиблись разделом / сервером, перепадайте вашу жалобу в нужный раздел/сервер.[/CENTER]" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Обратитесь в жб на сотрудников',
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER][B][I][FONT=Georgia]Вы ошиблись разделом, перепадайте свою жалобу в раздел жалоб на сотрудников организации.[/CENTER]" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Ваши доказательства не рабочие/обрезанные, предоставьте стандартные доказательства.[/CENTER]<br>" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
       {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                '[CENTER]Ваша тема передана на рассмотрение Главному куратору форума/Заместителю главного куратора форума.<br>Часто рассмотрение темы может занять определенное время.<br>[CENTER][COLOR=rgb(255, 255, 0)]На рассмотрении[/COLOR][/CENTER][/FONT]',
            prefix: PINN_PREFIX,
            status: true,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Ваша жалоба была передана техническому специалисту.<br>[COLOR=rgb(255, 255, 0)]На рассмотрении.[/COLOR][/CENTER]<br>" +
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
       {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]У вас указан Non RolePlay ник.[/CENTER]<br>" +
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER] В биографии должны присутствовать фотографии и иные материалы, относящиеся к истории вашего персонажа. [/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]У вас различия в поле, в пункте 'Пол' указано одно, а биография написана от другого пола.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Ваша РП биография составлена не по форме.<br>Форма подачи:<br>[CODE]Имя и фамилия персонажа: Укажите полное имя (можно придумать необычное, но реалистичное).<br>Пол: Мужской / Женский.<br>Возраст: Реалистичный возраст, соответствующий опыту и занятиям персонажа.<br>Национальность: Укажите страну или народ, к которому принадлежит персонаж.<br>Образование: Опишите, где и чему учился персонаж: школа, колледж, университет, курсы или самообразование.<br>Описание внешности: Рост, телосложение, цвет волос, глаз, особенности (шрамы, татуировки, манера одеваться).<br>Характер: Опишите сильные и слабые стороны, темперамент, привычки.<br>Пример: общительный и открытый, но быстро вспыхивает; спокойный и расчётливый, склонен к упрямству.<br>Детство: Кратко опишите семью, условия жизни, важные события в ранние годы (бедность, переезд, утрата, дружба).<br>Настоящее время: Чем персонаж занимается сейчас: работа, место жительства, социальный статус, круг общения.<br>Итог: Опишите, какие качества и цели сформировались у персонажа после всех событий. Это подводит итог всей биографии.[/CODE][/CENTER]<br>" +
                '[Color=Red][CENTER]Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
         {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]У вас не совпадает место рождения.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]При написании биографии вы должны определиться от какого лица будет ваша RolePlay биография. То есть, если вы начали писать биографию от первого лица, то вы должны продолжить писать от первого лица.<br>Аналогично с третьим лицом.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
       {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Ваша RolePlay биография имеет большое количество грамматических / орфографических ошибок.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
...
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]В вашей RolePlay биографии мало информации.<br>Минимальный объём RP биографии — 200 слов, максимальный — 600.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]В вашей RolePlay биографии неправильно указан заголовок<br>Заголовок должен быть в формате 'Биография | Nick_Name'.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
        ...
        },
{
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Georgia][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]В биографии не должно быть логических противоречий.<br>Пример: в пункте «Возраст» вы указываете, что вам 16 лет, а дальше описываете, что окончили университет, открыли свой бизнес и зарабатываете миллионы рублей.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
