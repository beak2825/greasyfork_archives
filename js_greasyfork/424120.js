// ==UserScript==
// @name         </> Kurt & Java 9 Tuzak Ve Oyun Yenileyici
...
// @match        zombs.io
// @grant        Ryan Wolf
// @downloadURL https://update.greasyfork.org/scripts/424120/%3C%3E%20Kurt%20%20Java%209%20Tuzak%20Ve%20Oyun%20Yenileyici.user.js
// @updateURL https://update.greasyfork.org/scripts/424120/%3C%3E%20Kurt%20%20Java%209%20Tuzak%20Ve%20Oyun%20Yenileyici.meta.js
// ==/UserScript==
...
function placeWall(x, y) {
    game.network.sendRpc({name: 'MakeBuilding', x: x, y: y, type: "SlowTrap", yaw: 0});
}

document.addEventListener('mousemove', e => {
    mousePs = {x: e.clientX, y: e.clientY};
    if (shouldBuildWalls && game.inputManager.mouseDown && game.ui.components.PlacementOverlay.buildingId == "SlowTrap") {
        var buildingSchema = game.ui.getBuildingSchema();
        var schemaData = buildingSchema.SlowTrap;
