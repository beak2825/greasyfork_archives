...
// @downloadURL https://update.greasyfork.org/scripts/410826/N-H%20and%20H-Nexus%20QoL.user.js
// @updateURL https://update.greasyfork.org/scripts/410826/N-H%20and%20H-Nexus%20QoL.meta.js
// ==/UserScript==
// jshint esversion: 6
...
- update localstorage when visit g
*/
...
function main() {
    ...
    if (window.location.host == "nhentai.net") {
        if (window.location.pathname.substring(0,3) == "/g/" && (window.location.pathname.match(/\//g) || []).length===3) {
            ...
            window.localStorage.setItem(g_key, JSON.stringify(g));
