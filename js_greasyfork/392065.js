...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/392065/New%20Userscript.user.js
// @updateURL https://update.greasyfork.org/scripts/392065/New%20Userscript.meta.js
// ==/UserScript==
...
(function() {
    ...
    var token = setInterval(function(){
       ...
       if(frame.readyState == "complete")
       {
           ...
           frame.getElementsByClassName("empty")[17].parentElement.click();
           ...
           frame.getElementsByClassName("empty")[86].parentElement.click();

           frame.getElementsByClassName("empty")[92].parentElement.click();

           frame.getElementsByClassName("empty")[93].parentElement.click();
