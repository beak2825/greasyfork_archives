...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/546823/%D0%B4%D0%BB%D1%8F%20%D1%80%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%B0%D0%B4%D0%BC%20WR.user.js
// @updateURL https://update.greasyfork.org/scripts/546823/%D0%B4%D0%BB%D1%8F%20%D1%80%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%B0%D0%B4%D0%BC%20WR.meta.js
// ==/UserScript==
        ...
        const buttonsData = [
            {
                ...
                text: 'Жб на рассмотрении',
                responseText: `[CENTER][FONT=georgia][COLOR=rgb(255, 0, 0)]Здравствуйте, уважаемый[/COLOR] {authorName}.

Ваша [COLOR=rgb(255, 255, 0)]жалоба[/COLOR] взята [COLOR=rgb(251, 160, 38)]на рассмотрение[/COLOR].
Ожидайте ответа от администрации, и [COLOR=rgb(255, 0, 0)]не создавайте копии[/COLOR] данной жалобы.

С уважением, [COLOR=rgb(0, 255, 0)]Главная Администрация GREEN[/COLOR].[/FONT]
[/CENTER]`
            },
            {
...
Ваша [COLOR=rgb(255, 255, 0)]жалоба[/COLOR] передана [COLOR=rgb(255, 0, 0)]Главной администрации сервера[/COLOR].
Ожидайте ответа от администрации, и [COLOR=rgb(251, 160, 38)]не создавайте копии[/COLOR] данной жалобы.
...
Ваша [COLOR=rgb(255, 255, 0)]жалоба[/COLOR] получает статус «[COLOR=rgb(255, 0, 0)]Отказано[/COLOR]».
Ваша жалоба составлена не по форме, пожалуйста, ознакомьтесь с закреплённой темой в данном разделе
...
[COLOR=rgb(255, 0, 0)]Ожидайте ответа[/COLOR].[/FONT][/CENTER]`
    ...
    // Функция для вставки текста ответа и автоматической отправки
        ...
        if (messageField) {
            ...
            setTimeout(() => {
                ...
                if (submitButton) {
                    ...
                    // Если кнопка не найдена, пробуем отправить форму программно
