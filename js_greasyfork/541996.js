// ==UserScript==
// @name        百度网盘破解SVIP&&倍速播放&&文稿字幕-本地修改
...
// @downloadURL https://update.greasyfork.org/scripts/541996/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%A0%B4%E8%A7%A3SVIP%E5%80%8D%E9%80%9F%E6%92%AD%E6%94%BE%E6%96%87%E7%A8%BF%E5%AD%97%E5%B9%95-%E6%9C%AC%E5%9C%B0%E4%BF%AE%E6%94%B9.user.js
// @updateURL https://update.greasyfork.org/scripts/541996/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%A0%B4%E8%A7%A3SVIP%E5%80%8D%E9%80%9F%E6%92%AD%E6%94%BE%E6%96%87%E7%A8%BF%E5%AD%97%E5%B9%95-%E6%9C%AC%E5%9C%B0%E4%BF%AE%E6%94%B9.meta.js
// ==/UserScript==
...
<div class="vjs-play-progress vjs-slider-bar" aria-hidden="true" style="width: 0%;"><div class="vjs-time-tooltip" aria-hidden="true" style="right: -18.5px;">0:00</div></div>
  ...
  return handleMouseDown
      ...
      let rewindBtn = createButton('←5s', e => {
        if (video.currentTime - 5 >= 0) {
          video.currentTime -= 5;
        } else {
          video.currentTime = 0;
      ...
      let forwardBtn = createButton('5s→', e => {
        if (video.currentTime + 5 < video.duration) {
          video.currentTime += 5;
        } else {
          video.currentTime = video.duration;
