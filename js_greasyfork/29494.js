// ==UserScript==
// @name         VIP视频在线解析
// @namespace    http://38um.cn/
// @version      1.3.1.2
// @description  在视频标题旁上显示“vip在线解析”按钮，在线播放vip视频；支持优酷vip，腾讯vip，爱奇艺vip，芒果vip，乐视vip等常用视频...
// @author       ifkdy
...
// @run-at       document-end
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/29494/VIP%E8%A7%86%E9%A2%91%E5%9C%A8%E7%BA%BF%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/29494/VIP%E8%A7%86%E9%A2%91%E5%9C%A8%E7%BA%BF%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
// *://*.lamian.tv/video/av/*
(function() {
    'use strict';
...
//  var reLaMian = /lamian/i;
    var reIFKDY = /ifkdy/i;
    var vipBtn = '<a id="ifkdyVipBtn" style="cursor:pointer;text-decoration:none;color:red;padding:0 5px;border:1px solid red;">vip在线解析</a>';
    // 优酷
...
//  }
    $('#ifkdyVipBtn').on('click',function(){
        ...
        window.location.href = 'http://38um.cn/v/?url=' + curPlaySite;
    });
})();