// ==UserScript==
// @name         媒体资源嗅探及下载(去广告纯净版)
// @namespace    http://tampermonkey.net/
// @version      1.987.ManualAndXFix
// @license      MIT
// @description  功能包含：1、自动嗅探页面上的视频、音频资源，列出链接，并提供播放、复制和下载功能（提供 mp3、mp4 和 m3u8 资源下载）；2、录屏；3、解除页面复制限制。已去除广告和推广弹窗，修复推特音频缺失问题，新增手动嗅探及X视频合并功能。
// @author       waterhuo & Modified
// @match        https://*/*
// @match        http://*/*
// @icon         data:image/jpeg;base64,
...
// @grant        GM_webRequest
// @connect      *
// @downloadURL https://update.greasyfork.org/scripts/560189/%E5%AA%92%E4%BD%93%E8%B5%84%E6%BA%90%E5%97%85%E6%8E%A2%E5%8F%8A%E4%B8%8B%E8%BD%BD%28%E5%8E%BB%E5%B9%BF%E5%91%8A%E7%BA%AF%E5%87%80%E7%89%88%29.user.js
// @updateURL https://update.greasyfork.org/scripts/560189/%E5%AA%92%E4%BD%93%E8%B5%84%E6%BA%90%E5%97%85%E6%8E%A2%E5%8F%8A%E4%B8%8B%E8%BD%BD%28%E5%8E%BB%E5%B9%BF%E5%91%8A%E7%BA%AF%E5%87%80%E7%89%88%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    set['ffmpeg_n'] = 1    // 【已修改】默认为1。开启视频转码，有助于解决推特/M3U8视频合并问题
    set['ad_n']     = 1    // 默认会在下载m3u8视频时自动过滤其中夹杂的广告
    set['checked_n']= 1    // 默认解除特殊网站对文本选中的限制

    // --- X/Twitter 视频拦截 Hook (优先执行) ---
    // 解决 X 视频音画分离问题，直接从 API 获取 MP4
            ...
            if(typeof obj === 'object'){
                if(obj.variants && Array.isArray(obj.variants)){
                    ...
                    if(mp4s.length > 0){
                        ...
                        var best = mp4s[0];
                        if(best && best.url){
                           addUrl(best.url, "Twitter Video (MP4 Combined)");
                        }
                    }
                }
                for(var key in obj){
...
// 【修改点1】：在 Allurl div 中加入了 ManualSniff 按钮
$("body").attr("id","Top")
...
$("#ManualSniff").click(function(){
    layer.msg("正在执行深度手动嗅探...");
    // 1. 扫描 Performance Resource 缓存
    var scripts = performance.getEntriesByType("resource");
    scripts.forEach(function (x) {
         var z = x.name;
         if( (/m3u8/i.test(z) && !/\.ts/i.test(z.replaceAll(/\?.*/g,''))) || /mp4\??.*/i.test(z) || /\.ogg\??.*/i.test(z) || /.*\.m4a\??.*/i.test(z) || /.*\.mp3\??.*/i.test(z) ){
             addUrl(z, document.title);
         }
    });

    // 2. 扫描 DOM 元素 (Video/Audio/Source)
    $("video, audio").each(function () {
         var src = $(this).attr('src');
         if(src && src.trim() !== "") addUrl(src, document.title);
         $(this).find("source").each(function(){
             var sSrc = $(this).attr('src');
             if(sSrc && sSrc.trim() !== "") addUrl(sSrc, document.title);
         });
    });
    console.log("手动嗅探完成");
});
...
case 'x.com':
case 'twitter.com':
// 已使用新的 API 拦截方式处理 X 视频，此处仅保留原有逻辑防止冲突
break;
case 'www.iwara.tv':
