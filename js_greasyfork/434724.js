// ==UserScript==
// @name         4x Multibox by CyRuler copie
// @namespace    -
// @version      1.0
...
// @downloadURL https://update.greasyfork.org/scripts/434724/4x%20Multibox%20by%20CyRuler%20copie.user.js
// @updateURL https://update.greasyfork.org/scripts/434724/4x%20Multibox%20by%20CyRuler%20copie.meta.js
// ==/UserScript==
...
let handleMessage = function(e) {
    ...
    if (item == "ch") {
        if ((data[2].toLocaleLowerCase()).split(' ')[0] == '!bye' && data[1] == myPlayer.id) {
            crashing = true;
        }
        ...
        if (data[2].toLocaleLowerCase() == '!go' && data[1] == myPlayer.id) {
            ffs = true;
        }
...
WebSocket.prototype.send = function(m) {
    ...
    if (!closed) {
        ...
        if (msgpack5.decode(m)[0] == "ch") {
            this.oldSend(m);
            if (msgpack5.decode(m)[1][0].toLocaleLowerCase() !== '!f' && msgpack5.decode(m)[1][0].toLocaleLowerCase() !== '!fs' && msgpack5.decode(m)[1][0].toLocaleLowerCase().split(" ")[0] !== '!join' && msgpack5.decode(m)[1][0].toLocaleLowerCase().split(" ")[0] !== '!leave' && msgpack5.decode(m)[1][0].toLocaleLowerCase().split(" ")[0] !== '!bye') {
