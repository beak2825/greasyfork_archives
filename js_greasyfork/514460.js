...
// @license MIT
// @version      0.1.3
// @downloadURL https://update.greasyfork.org/scripts/514460/xhs-pgy%20%E9%A1%B5%E9%9D%A2hook%20%E4%B8%93%E4%B8%9A%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/514460/xhs-pgy%20%E9%A1%B5%E9%9D%A2hook%20%E4%B8%93%E4%B8%9A%E7%89%88.meta.js
// ==/UserScript==
...
(function () {
    ...
    XMLHttpRequest.prototype.send = function (data) {
        ...
        if (this._customUrl.includes('api/solar/cooperator/blogger/v2')) {
            ...
            _page = v2_data['pageNum'];
            if (_page == 1) {
                globalCsvData = "";
                page_list = [];
            }
            let total_count = v2_data['pageSize'];
            ...
            this.addEventListener('load', function () {
                ...
                try {
                    ...
                    if (response.data && response.data.kols) {
                        ...
                        if (listCopy.length) {
                            let pages = Math.ceil(response.data['total'] / total_count);
    ...
    downloadButton.addEventListener('click', function () {
        ...
        if (numberInput.value !== 0) {
            const interval = setInterval(() => {
                const nextPageButton = document.querySelectorAll('.d-pagination-page.d-pagination-page-default.--color-bg-fill-light.--color-text-paragraph.d-clickable');
                if (nextPageButton && clickCount < numberInput.value) {
                    nextPageButton[nextPageButton.length - 1].querySelector('span').click();
                    clickCount++;
