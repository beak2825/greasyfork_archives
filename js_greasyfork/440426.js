// ==UserScript==
// @name        AcFun弹幕下载
// @name:zh-CN  AcFun 弹幕 下载
// @name:zh-TW  AcFun弹 幕 下 载
// @namespace   
// @description AcFun 弹幕 下载
// @description:zh-TW  AcFun弹幕下载
// @description:zh-CN AcFun弹幕下载
...
// @downloadURL https://update.greasyfork.org/scripts/440426/AcFun%E5%BC%B9%E5%B9%95%E4%B8%8B%E8%BD%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/440426/AcFun%E5%BC%B9%E5%B9%95%E4%B8%8B%E8%BD%BD.meta.js
// ==/UserScript==
...
var requestDanmaku = function (vid, page, callback) {
    var f = new FormData()
    f.set('resourceId',27324154)
    f.set('resourceType',9)
    f.set('enableAdvanced',true)
    f.set('pcursor',page)
    f.set('count',200)
    f.set('sortType',1)
    f.set('asc',false)
  GM_xmlhttpRequest({
    ...
    url: '/rest/pc-direct/new-danmaku/list',
      /*data:{
        resourceId: 27324154,
        resourceType: 9,
        enableAdvanced: true,
    ...
    'onload': function (resp) {
      ...
      try {
        ...
        data = data.danmakus.reduce(function (x, y) { return x.concat(y); }, []);
      } catch (e) { data = null; }
...
var mina = function (vid, danmaku) {
  ...
  danmaku = danmaku.map(function (line) {
    ...
    return {
      ...
      'time': line.position,
      'color': 'FFFFFF',
      'mode': [undefined, 'R2L', undefined, undefined, 'BOTTOM', 'TOP'][mode],
      'size': size,
      'bottom': false,
