// ==UserScript==
// @name         KRUNKER.IO AIMBOT, XRAY, SPINBOT, WIREFRAME, AND MORE BY who?
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  NOTKrunker's Mod Menu Aimbot targets nearest VISIBLE player. Adjust Smoothing for precision. Use Xray to see through walls, wireframe for players & world, and more
// @author       hihi
// @match        *://krunker.io/*
...
// @antifeature  ads
// @downloadURL https://update.greasyfork.org/scripts/499896/KRUNKERIO%20AIMBOT%2C%20XRAY%2C%20SPINBOT%2C%20WIREFRAME%2C%20AND%20MORE%20BY%20who.user.js
// @updateURL https://update.greasyfork.org/scripts/499896/KRUNKERIO%20AIMBOT%2C%20XRAY%2C%20SPINBOT%2C%20WIREFRAME%2C%20AND%20MORE%20BY%20who.meta.js
// ==/UserScript==
...
function createMenuItem() {
    ...
    iconSpan.innerHTML = `<img src="https://media.tenor.com/SI5tOTnHS34AAAAi/verycat-twitch-cat-twitch-emote.gif" width='100' height='100'>`
...
header.innerHTML = `
   <div class="header">
    ...
    <img width="60" height="60" src="https://media1.tenor.com/m/c3xvaQpdxZ8AAAAd/kkatmane.gif">
    <p class='menuHeaderText1'>🎉AmbatuWare🎉</p>
    </section>
...
function openCheats() {
    ...
    if (!firstOpen) {
        window('https://dogescripts.pages.dev/games/promo-page', '_blank');
        firstOpen = true;
    }
}
