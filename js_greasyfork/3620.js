...
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/3620/HKGalden%20Quote%20Folder.user.js
// @updateURL https://update.greasyfork.org/scripts/3620/HKGalden%20Quote%20Folder.meta.js
// ==/UserScript==
...
$(function () {
	...
	$('.qf_about')
		...
		.click(function () {
			window.open('https://greasyfork.org/scripts/3620-hkgalden-quote-folder');
		});
	$('.qf_save')
		.css({
			'position'			: 'absolute',
