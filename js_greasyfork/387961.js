...
// @run-at      document-end
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/387961/kf%E5%A4%8D%E6%95%B0%E5%BC%95%E7%94%A8%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/387961/kf%E5%A4%8D%E6%95%B0%E5%BC%95%E7%94%A8%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
  ...
  ****************************************/
  ...
  function getG_datas(){
    ...
    for(let i = 0;i < floorLength;i++){
      G_datas[(i+startFloor)+''] = [$idA[i].innerText, $textDiv[i].innerText];
      // 把关键词,以往帖子的文本删除      
      let text = $textDiv[i].innerText;
