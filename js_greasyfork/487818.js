...
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/487818/%E8%81%9A%E5%90%88%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%88%87%E6%8D%A2%E5%AF%BC%E8%88%AA%5B%E6%89%8B%E6%9C%BA%E7%89%88%5D%5B%E7%A7%BB%E5%8A%A8%E7%AB%AF%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/487818/%E8%81%9A%E5%90%88%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%88%87%E6%8D%A2%E5%AF%BC%E8%88%AA%5B%E6%89%8B%E6%9C%BA%E7%89%88%5D%5B%E7%A7%BB%E5%8A%A8%E7%AB%AF%5D.meta.js
// ==/UserScript==

const punkDeafultMark = "Bing-Baidu-Google-Toutiao-Fsou-Quark-Sougou-360";
const punkAllSearchMark = "Bing-Baidu-Google-Zhihu-Fsou-360-Wuzhui-Quark-Sougou-Toutiao-Yandex-Ecosia-DuckDuckGo-QwantLite-Swisscows";
...
function punkSearchClickFunction(){
  ...
  btnClose.onclick = function () {
    ...
    document.getElementsByTagName('body')[0].style = "margin-bottom: 0px !important;";
  ...
  for (var i = 0; i < myNodelist.length; i++) {
    ...
    if (style.getPropertyValue("position") === "fixed") {
      if (style.getPropertyValue("z-index") != "9999999") {
        ...
        if (style.getPropertyValue("bottom") === "0px") {
          if (document.getElementById("punkjet-search-box").style.display == "block") {
            myNodelist[i].style.bottom = "35px";
          }
        } else if (style.getPropertyValue("bottom") === "35px") {
          if (document.getElementById("punkjet-search-box").style.display == "none") {
            myNodelist[i].style.bottom = "0px";
          }
        }
      }
    } else if ((style.getPropertyValue("bottom") === "35px")) {
...
function funcPopState() {
  ...
  for (var i = 0; i < myNodelist.length; i++) {
    let style = window.getComputedStyle(myNodelist[i], null);
    if (style.getPropertyValue("position") != "fixed"){
      if (style.getPropertyValue("bottom") === "35px") {
        myNodelist[i].style.bottom = "0px";
      }
    }
  }
