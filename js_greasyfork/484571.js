// ==UserScript==
// @name AudioBookBay hide category: Sci-Fi
// @description Hide Sci-Fi category
...
// @downloadURL https://update.greasyfork.org/scripts/484571/AudioBookBay%20hide%20category%3A%20Sci-Fi.user.js
// @updateURL https://update.greasyfork.org/scripts/484571/AudioBookBay%20hide%20category%3A%20Sci-Fi.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Sci-Fi'
    $(".post").has(".postInfo:contains('Sci-Fi')").hide();
});
