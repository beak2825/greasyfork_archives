// ==UserScript==
// @name bilibili时间线筛选——分组查看b站动态（布局优化，修复失效，原脚本作者hi94740）
// @namespace klingeling
// @author klingeling
// @version 2.0.3.1
// @license MIT
// @description 这个脚本能帮你通过关注分组筛选b站时间线上的动态 （布局优化，排除展示番剧，避免无人直播时失效）
...
// @downloadURL https://update.greasyfork.org/scripts/541882/bilibili%E6%97%B6%E9%97%B4%E7%BA%BF%E7%AD%9B%E9%80%89%E2%80%94%E2%80%94%E5%88%86%E7%BB%84%E6%9F%A5%E7%9C%8Bb%E7%AB%99%E5%8A%A8%E6%80%81%EF%BC%88%E5%B8%83%E5%B1%80%E4%BC%98%E5%8C%96%EF%BC%8C%E4%BF%AE%E5%A4%8D%E5%A4%B1%E6%95%88%EF%BC%8C%E5%8E%9F%E8%84%9A%E6%9C%AC%E4%BD%9C%E8%80%85hi94740%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/541882/bilibili%E6%97%B6%E9%97%B4%E7%BA%BF%E7%AD%9B%E9%80%89%E2%80%94%E2%80%94%E5%88%86%E7%BB%84%E6%9F%A5%E7%9C%8Bb%E7%AB%99%E5%8A%A8%E6%80%81%EF%BC%88%E5%B8%83%E5%B1%80%E4%BC%98%E5%8C%96%EF%BC%8C%E4%BF%AE%E5%A4%8D%E5%A4%B1%E6%95%88%EF%BC%8C%E5%8E%9F%E8%84%9A%E6%9C%AC%E4%BD%9C%E8%80%85hi94740%EF%BC%89.meta.js
// ==/UserScript==
...
if (document.URL == "https://t.bilibili.com/" || document.URL.startsWith("https://t.bilibili.com/?")) {
  ...
  function filterWorker() {
    $(".bili-dyn-item").toArray().forEach(c => {
      ...
      // console.log('【klingeling】author:' + author.label)
      if (!(selectedUp.some(up => up.mid == author.mid))) $(c)[0].hidden = true
    })
    loadMoreDynamics()
    autoPadding()
  }
  ...
  Promise.all([
    ...
    new Promise(res => {
      ...
      Vue.use(vant.Tabs)
      let siid = setInterval(function () {
        if ($(".bili-dyn-up-list").length == 1 && $(".bili-dyn-my-info").length == 1) {
          clearInterval(siid)
          res()
        }
      })
    }).then(function () {
      $(".bili-dyn-up-list").after('<div id="btf-tab-area"><div id="btf-tab"></div></div>')
      $(".bili-dyn-my-info").after('<div id="btf-bwlist-area" style="padding-top:8px"><div id="btf-bwlist"></div></div>')
      $("#btf-tab-area")[0].hidden = true
      $("#btf-bwlist-area")[0].hidden = true
      autoPadding()
