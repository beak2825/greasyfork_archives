...
// @downloadURL https://update.greasyfork.org/scripts/402965/w21-exportworld-alliance.user.js
// @updateURL https://update.greasyfork.org/scripts/402965/w21-exportworld-alliance.meta.js
// ==/UserScript==
/* jshint esversion:6 */
...
(function() {
    ...
    // filter
    var ennemy = "Full Blown Sparkles".toUpperCase();
    ...
    btnExport.on('click', () => {
        $.post( "includes/gR.php", (data) => {
            ...
            tmp.forEach(player => {
                ...
                if (player[4].toUpperCase() == ennemy) {
