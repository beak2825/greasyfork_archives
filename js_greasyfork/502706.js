// ==UserScript==
// @name         For guidance kokojambo
// @namespace    https://forum.blackrussia.online
// @version      0.25
// @description  Always remember who you are!
// @author       kokojambo GA 22
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license 	 MIT
// @collaborator kokojambo
// @icon https://icons.iconarchive.com/icons/papirus-team/papirus-apps/48/emerald-theme-manager-icon-icon.png
// @downloadURL https://update.greasyfork.org/scripts/502706/For%20guidance%20kokojambo.user.js
// @updateURL https://update.greasyfork.org/scripts/502706/For%20guidance%20kokojambo.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    {
	  title: '_____________________________________________ღ Рассмотрение ღ_____________________________________________ ',
	},
     {
    ...
    {
	  title: '_____________________________________________ღ Отказ ღ_____________________________________________ ',
	},
    {
	  title: 'В ЖБ на техов',
	  content:
    ...
    {
	  title: 'Недостаточно док-в (нет скрина бана)',
	  content:
		'[Color=Magenta][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
    ...
    {
	  title: '_____________________________________________ღ Одобрено ღ_____________________________________________ ',
	},
	{
