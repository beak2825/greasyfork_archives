// ==UserScript==
// @name          56 Кураторы Форума
// @namespace    https://forum.blackrussia.online
// @version      0.5
// @description  curators family
// @author       tochno ne santa
...
// @downloadURL https://update.greasyfork.org/scripts/492921/56%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/492921/56%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
...
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
    "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4] Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]2.57.[/COLOR][COLOR=rgb(209, 213, 216)][/COLOR] Запрещается брать в долг игровые ценности и не возвращать их.[COLOR=rgb(255, 0, 0)] | Ban 30 дней / permban[/COLOR]<br><br>Примечание: при невозврате игровых ценностей общей стоимостью менее 5 миллионов включительно аккаунт будет заблокирован на 30 дней, если более 5 миллионов, аккаунт будет заблокирован навсегда;[/SIZE][/FONT]<br><br>" +
"[B][CENTER][B][COLOR=lime][ICODE]Одобрено[/ICODE][/COLOR][/B]<br><br>"+
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B][/CENTER]<br>",
prefix: ACCEPT_PREFIX,
status: false,
...
'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR]<br>' +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
    "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I] В  доказательствах нет условий сделки, жалоба рассмотрению не подлежит.[/I][/SIZE][/FONT]<br><br>" +
"[I][FONT=times new roman][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/I][/COLOR]<br><br>" +
"[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/B]<br><br>" +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/CENTER][/B]<br><br>" ,
prefix: UNACCEPT_PREFIX,
...
"[B][CENTER][COLOR=rgb(209, 213, 216)]Пожалуйста не создавайте дубликатов. Ожидайте ответа.[/COLOR][/B]<br>"+
    ...
    
	{
	  ...
	  content:
		...
		'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR]<br>' +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
		"[B][CENTER]Ваша жалоба была передана Техническому специалисту сервера. @Andrusha_Aelpee Ожидайте ответа.<br>"+
