// ==UserScript==
// @name         PDA Booking Helper
// @namespace    https://github.com/jsnfwlr/missionmotorcycle
// @version      0.1.1
// @description  Get a booking at one of the WA DOT Centers.
// @author       jsnfwlr <jason@jsnfwlr.com>
// @match        https://online.transport.wa.gov.au/pdabooking/manage/wicket/page*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/432816/PDA%20Booking%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/432816/PDA%20Booking%20Helper.meta.js
// ==/UserScript==
//
...
// booking. Script adapted slightly for personal use only.
...
(function () {
	...
	function addMissionDialog () {
		...
		let dialog = "<div style='position: fixed; top: 0; right: 0; width: 100%; background: #dedede;' id='missionBooking'>" +
			"<span class='section-title' style='margin: 0'>PDA Booking Helper</span>" +
			...
			" no earlier than " +
			"<input type='text' id='missionHour' value='8' style='width: 3em' />:<input type='text' id='missionMinute' value='00' style='width: 3em' /> <select id='missionNoon'><option value='AM'>AM</option><option value='PM'>PM</option></select>" +
			"</div>" +
