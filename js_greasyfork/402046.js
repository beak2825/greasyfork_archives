...
// @require https://greasyfork.org/scripts/402045-jquery-timeago/code/jquerytimeago.js?version=798143
// @downloadURL https://update.greasyfork.org/scripts/402046/osuplus%20by%20seneaL.user.js
// @updateURL https://update.greasyfork.org/scripts/402046/osuplus%20by%20seneaL.meta.js
// ==/UserScript==
/* jshint esversion: 6 */
(() => {
    "use strict";
    ...
    //https://i.imgur.com/87WeqCL.png
        ...
        findUsersImg = "data:image/png;base64,",
        leaderboardImg = "data:image/png;base64,",
        modIconImgs = {
          
            "V2": 'data:image/png;base64,',            
...
#osuplusModal {position:fixed; width:600px; z-index:20000; top:30px; background: #3d2932;
margin-left:-300px; left:50%; border-radius:10px; padding:15px;}
.osuplusModalClose {position:absolute; right:15px; top:15px; background: #382e32;}
...
.settingOption {text-align:right;} #osuplusFindUsersBtn {background:rgba(0,0,0,0.2) url(${findUsersImg}) no-repeat 5px 10px; position:fixed; width:42px; height:47px; right:30px; cursor:pointer; z-index:10000;}
#osuplusModalOverlayUsers {position:fixed; top:0px; width:100%; height:100%; z-index:19999; background:rgba(0,0,0,0.5);}
#osuplusModalUsers {position:fixed; width:600px; z-index:20000; top:30px; background: #3d2932;
margin-left:-300px; left:50%; border-radius:10px; padding:15px;}
.osuplusModalCloseUsers {position:absolute; right:15px; top:15px;}
#usersArea {height: 170px; width: 550px; top: 10px; resize: none; background: #382e32}
#osuplusEditLeaderboardBtn {background:rgba(0,0,0,0.2) url(${leaderboardImg}) no-repeat 5px 10px; position:fixed; width:42px; height:47px; right:130px; cursor:pointer; z-index:10000;}
#osuplusModalOverlayLeaderboard {position:fixed; top:0px; width:100%; height:100%; z-index:19999; background:rgba(0,0,0,0.5);}
#osuplusModalLeaderboard {position:fixed; width:600px; z-index:20000; top:30px; background: #3d2932;
margin-left:-300px; left:50%; border-radius:10px; padding:15px;}
.osuplusModalCloseLeaderboard {position:absolute; right:15px; top:15px;}
#enemyArea {height: 210px; width: 550px; top: 10px; resize: none; background: #382e32;}`

            ));
        }

        $(document.body).prepend("<div id='osuplusSettingsBtn'></div>");
        $(document.body).prepend("<div id='osuplusFindUsersBtn'></div>");
        $(document.body).prepend("<div id='osuplusEditLeaderboardBtn'></div>");
...
<label><input type='checkbox' id='show-apikey'>Show</label>`)
          ...
          $("<div id='osuplusModalOverlayUsers' style='display:none;'></div>"),
          $("<div id='osuplusModalUsers' style='display:none;'></div>").append(
                "<h1>osuplus leaderboard</h1>",
                "<button class='osuplusModalCloseUsers'>x</button>",
                $("<div class='osuplusSettingsContent'>").append(
                    $("<div>").append(
                        "<h2>General</h2>",
                        $("<table class='osuplusSettingsTable' width='100%'>").append(
                            makeSettingRow("Show the user id instead of username", null, makeCheckboxOption("userID")),
                            makeSettingRow("Select Country", null, `<select id="country">
...
<option value="ER"> Eritrea</option>
                            ...
                            makeSettingRow("Custom number of players (default 100)",  null, `<input type='text' id="countPlayer" name='countPlayer' value='100'>`)
                        )
                    ),
                  $("<div>").append(
                        "<h2>Top Users</h2>",
                  "<textarea readonly name=users id=usersArea></textarea>")
                ),
                $("<div id='usersLoad'>Items in 'Top Users': 0</div>"),
                $("<button id='osuplusSettingsSaveBtn'>Get Top Users</button>").click(async function () {
                    $("#usersLoad").show();
                    var users = [];
                    GMX.setValue("#settings-userID", $("#userID").val());
                    var country = $("#country").val();
                    var top = $("#countPlayer").val();
                    var pages = Number((Number(top) / 50).toFixed(0)) + 1;
                    var numbers = [];
                    var count = 0;
                    ...
                    for (const item of numbers) {
                      await sleep(1000);
                      await GetPage(`https://osu.ppy.sh/rankings/osu/performance?country=${country}&page=${item}#scores`, function (response) {
                      $(response).find(".ranking-page-table__user-link-text.js-usercard").each(async function (index, element) {
                        await sleep(1000);
                        if ($("#settings-userID").is(':checked')) {
                          if (count == top) return false;
                          users.push($(element).context.href.split("users/")[1].replace(/\/osu/g, '').trim());
                          count++;
                        } else {
                          if (count == top) return false;
                          users.push($(element).context.textContent.replace(/ +/g, ' ').trim());
                          count++;
                        }
                        $("#usersLoad").text(`Items in 'Top Users': ${count}`);
                        document.getElementById('usersArea').value = users;
                      });
          ...
          $("<div id='osuplusModalOverlayLeaderboard' style='display:none;'></div>"),
            $("<div id='osuplusModalLeaderboard' style='display:none;'></div>").append(
                "<h1>osuplus leaderboard settings</h1>",
                "<button class='osuplusModalCloseLeaderboard'>x</button>",
                $("<div class='osuplusSettingsContent'>").append(
                    $("<div>").append(
                        "<h2>Leaderboard Color Picker</h2>",
                        $("<table class='osuplusSettingsTable' width='100%'>").append(
                          makeSettingRow("Your Friends Color", null, `<input type="color" value='${settings.friendsColor}' id="colorWellFriends">`),
                          makeSettingRow("Your Enemy Color", null, `<input type="color" value='${settings.enemyColor}' id="colorWellEnemy">`), 
                          makeSettingRow("Your Color", null, `<input type="color" value='${settings.myColor}' id="myColor">`)
                        ), 
                    ),
                  $("<div>").append(
                        "<h2>Enemy Users</h2>",
                  `<textarea name=users id=enemyArea>${settings.enemy.join(' ')}</textarea>`)
                ),
              
                $("<button id='osuplusSettingsSaveBtn'>Save</button>").click(function () {
                    GMX.setValue("friendsColor", $("#colorWellFriends").val());
                    GMX.setValue("enemyColor", $("#colorWellEnemy").val());
                    GMX.setValue("myColor", $("#myColor").val());
                    var enemys = $("#enemyArea").val().split(' ');
                    GMX.setValue("enemy", enemys);
                })
            ),
       ...
       function openModalUsers() {
            $("#osuplusModalUsers, #osuplusModalOverlayUsers").fadeIn(200);
        }
      
      function closeModalUsers() {
            $("#osuplusModalOverlayUsers, #osuplusModalUsers").fadeOut(200);
        }
      
      function openModalLeaderboard(){
        $("#osuplusModalOverlayLeaderboard, #osuplusModalLeaderboard").fadeIn(200);
      }
      
      function closeModalLeaderboard(){
        $("#osuplusModalOverlayLeaderboard, #osuplusModalLeaderboard").fadeOut(200);
      }
      
        $("#osuplusEditLeaderboardBtn").click(openModalLeaderboard);
        $("#osuplusSettingsBtn").click(openModal);
        $("#osuplusFindUsersBtn").click(openModalUsers);
        $(".osuplusModalCloseUsers").click(closeModalUsers);
        $(".osuplusModalCloseLeaderboard").click(closeModalLeaderboard);
        ...
        function init() {
            setInterval(function () {
                if (currentBody != document.body) {
                    ...
                    const flags = document.getElementsByClassName("flag-country");
                    for (var i = 0; i < flags.length; i++) {
                      if (flags[i].title === `Belarus`) {
                        flags[i].style.backgroundImage="url('https://osu.gatari.pw/static/images/flags/BY.png')";
                        flags[i].style.borderRadius = '2px';
                      }
                    }
...
<div class="beatmapset-panel__shadow"></div>
    ...
    function osuplusNewPpRanking() {
        ...
        GetPage("https://old.ppy.sh/p/friends", function (response) {
            ...
            $(response).find(".paddingboth").children("div").each(function (index, element) {
                friends.push(Number($(element).attr("user_id")));
            });
        });
        ...
        function addCss() {
            $(document.head).append($("<style></style>").html(`{margin: 0; padding: 0;}
		.topscore a {
			display: block;
		}
    ...
    border-radius: 50%;
        ...
        function init() {
            ...
            if (settings.rankingVisible) {
              ...
              //console.log($(".ranking-page-table__user-link-text js-usercard a").eq(1).cookie);
                //Get player list
              ...
              /*
                GetPage("https://osu.ppy.sh/rankings/osu/country?page=4#scores", function (response) {
                  $(response).find(".flag-country").each(function (index, element) {
                    console.log($(element).context.style["background-image"].split("flags/")[1].slice(0, -6));
                           //console.log($(element).context.textContent.replace(/ +/g, ' ').trim());
                        });
                        });
                        */
                var funs = [];
                ...
                playerList.each(function (index, id) {
                    funs.push(function (donecb) {
                        getUser({ u: id, m: mode, type: "id" }, function (response) {
                            getUserBest({ u: id, m: mode, type: "id", limit: 1 }, function (scores) {
                                getBeatmapsCache({ b: scores[0].beatmap_id, m: mode, a: 1 }, function (beatmap) {
                                    beatmapsBG[index] = beatmap[0].beatmapset_id;
                                    playerScore[index] = scores[0];
                                    playerInfo[index] = response[0];
                                    donecb();
                                });
                            });
                ...
                doManyFunc(funs, function () {
                    ...
                    tableLoadingNotice.hide();
                    var me = $(".simple-menu__header.simple-menu__header--link.js-current-user-cover")[0].href.split("users/")[1];
                    var friendsS;
                    //Add new header
                    var newHeader = isGlobal ? "Country" : "Global";
                    $(".ranking-page-table__heading--main").before(`<th class='ranking-page-table__heading'>${newHeader}</th>`);
                    var friends = [];
                    GetPage("https://osu.ppy.sh/home/friends", function (response) {                      
                      //console.log($(response).find(".js-current-user").prevObject[91].innerText)
                      
                      var obj = JSON.parse($(response).find(".user-card-brick__background-container").prevObject[91].innerText);
                      for (var i = 0; i < obj.length; i++) {
                        var user = {
                          id: obj[i].id,
                          online: obj[i].is_online
                        }
                        friends.push(user);
                      }
                            ...
                            for (var i = 0; i < friends.length; i++) {
                                if (Number(friends[i].id) == Number(playerInfo[index].user_id)) {
                                    $(`tbody tr:eq( ${index} )`).css("background", settings.friendsColor); //#96456e
                                  if (friends[i].online) {
                                row = $(row)
                                row.find(".ranking-page-table__user-link-text").after(`<img class="avatar-leaderboard" src=https://a.ppy.sh/${playerInfo[index].user_id} style="border: 3px solid green;">`)
                              } else {
                                row = $(row)
                                row.find(".ranking-page-table__user-link-text").after(`<img class="avatar-leaderboard" src=https://a.ppy.sh/${playerInfo[index].user_id} style="border: 3px solid gray;">`)
                              }
                            }
                            }
                          
                            for (var i = 0; i < settings.enemy.length; i++) {
                                if (Number(settings.enemy[i]) == Number(playerInfo[index].user_id)) {
                                    $(`tbody tr:eq( ${index} )`).css("background", settings.enemyColor); //#c74040
                                }
                            }
                            row = $(row)
                            ...
                            if (playerInfo[index].user_id == me) {
                                $(`tbody tr:eq( ${index} )`).css("background", settings.myColor); //#5a476e
                            }
                            //console.log(`${playerInfo[index].user_id}`);
                            //console.log($(".ranking-page-table__user-link-text js-usercard").eq(index));
                            let topScore = playerScore[index].pp;
                            //row.find(".ranking-page-table__user-link-text").after(`<span class="flag-country" style="background-image: url('https://a.ppy.sh/${playerInfo[index].user_id}'); height: 30px; width: 30px; left: +15px;"></span>`)
                              if (row.find(".avatar-leaderboard")[0] == undefined) {
                                row.find(".ranking-page-table__user-link-text").after(`<img class="avatar-leaderboard" src=https://a.ppy.sh/${playerInfo[index].user_id}>`)
                              }
                                                row.find(".ranking-page-table__user-link").after(
                               `<th class='topscore'><a href="https://osu.ppy.sh/b/${playerScore[index].beatmap_id}">${moment(playerScore[index].date).fromNow()} | ${Number(topScore).toFixed(0)} pp<img src="https://assets.ppy.sh/beatmaps/${beatmapsBG[index]}/covers/cover.jpg"></a></th>`);
                        });
...
<dd class="profile-stats__value">${commarise(c50)} (${(100 * c50 / ctotal).toFixed(2)}%)</dd></dl>`
        ...
        function addRecent() {
            ...
            getUserRecent({ u: jsonUser.id, m: gameMode, limit: 50, type: "id" }, function (response) {
                ...
                userRecent.forEach(function (play) {
                  console.log(getMods(play.enabled_mods))
                    var modstr = getMods(play.enabled_mods),
                        acc = calcAcc(play, gameMode),
                        dateset = new Date(play.date.replace(' ', 'T') + "+0000"), // dates from API in GMT+0
...
<td class='${cellClass}'>${userhref}</td>
...
<td class="beatmap-scoreboard-table__play-detail-menu"></td>
        ...
        function updateScoresTable(callback) {
            ...
            for (var i = 0; i < scoresResult.length; i++) {
              ...
              var tableRow = makeScoreTableRow(scoresResult[i], i+1, greyedout);
                tableRows[i] = tableRow;
