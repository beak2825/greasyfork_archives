// ==UserScript==
// @name         不学习何以强国-（自用改编版本，本人非作者，转载自他人）
...
// @grant        GM_openInTab
// @downloadURL https://update.greasyfork.org/scripts/462194/%E4%B8%8D%E5%AD%A6%E4%B9%A0%E4%BD%95%E4%BB%A5%E5%BC%BA%E5%9B%BD-%EF%BC%88%E8%87%AA%E7%94%A8%E6%94%B9%E7%BC%96%E7%89%88%E6%9C%AC%EF%BC%8C%E6%9C%AC%E4%BA%BA%E9%9D%9E%E4%BD%9C%E8%80%85%EF%BC%8C%E8%BD%AC%E8%BD%BD%E8%87%AA%E4%BB%96%E4%BA%BA%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/462194/%E4%B8%8D%E5%AD%A6%E4%B9%A0%E4%BD%95%E4%BB%A5%E5%BC%BA%E5%9B%BD-%EF%BC%88%E8%87%AA%E7%94%A8%E6%94%B9%E7%BC%96%E7%89%88%E6%9C%AC%EF%BC%8C%E6%9C%AC%E4%BA%BA%E9%9D%9E%E4%BD%9C%E8%80%85%EF%BC%8C%E8%BD%AC%E8%BD%BD%E8%87%AA%E4%BB%96%E4%BA%BA%EF%BC%89.meta.js
// ==/UserScript==
...
//姓名获取API
const NameUrl = "https://pc-api.xuexi.cn/open/api/user/info";
//获取当前日期
...
async function start() {
    ...
    if (loggedBox && loggedBox.innerText) {
        ...
        name = await getName()
        taskProgress1 = await getToday();
        let temp3 = parseInt(taskProgress1[0].currentScore + taskProgress1[1].currentScore + taskProgress1[2].currentScore + taskProgress1[3].currentScore+ taskProgress1[4].currentScore+ taskProgress1[5].currentScore)
        console.log(`https://www.pushplus.plus/send?token=a2e3a33183b54bdf9a28b2b732355c0f&title=学习提醒&content=${name}学完了,一共获得${temp3}分。&template=html`)
        send_over(name,temp3);
        if (settings.ShowMenu) {
            showMenu()
        }
    } else {
...
function send_over(name,score){
var url = `https://www.pushplus.plus/send?token=a2e3a33183b54bdf9a28b2b732355c0f&title=学习提醒&content=${name}学完了,一共获得${score}分。&template=html`
