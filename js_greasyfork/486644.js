// ==UserScript==
// @name         BARNAUL | Скрипт КФ/КА R.Kligan
...
// @downloadURL https://update.greasyfork.org/scripts/486644/BARNAUL%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D0%A4%D0%9A%D0%90%20RKligan.user.js
// @updateURL https://update.greasyfork.org/scripts/486644/BARNAUL%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D0%A4%D0%9A%D0%90%20RKligan.meta.js
// ==/UserScript==
...
},
{
	  ...
	  content:
        ...
        "[B][CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/color] | [COLOR=rgb(255, 0, 0)]Закрыто[/CENTER]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#797cc7]BARNAUL(69)[/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img][/url]<br>",
	prefix: ACCСEPT_PREFIX,
            status: false,
...
},
{
      ...
      content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/brtvQFHp/footer-barnaul-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=yellow][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=times new roman][SIZE=4][COLOR=lavender]Ваша жалоба была [COLOR=#00FF00]Одобрена[/COLOR], так как в следствии беседы с администратором, было выяснено, наказание было выдано по ошибке.<br>С администратором будет проведена профилактическая беседа.[SIZE=4]<br><br>"+
		"[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи жалоб на администрацию, закрепленные в разделе правил сервера.<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#797cc7]BARNAUL(69)[/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img][/url]<br>",
      prefix: ACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/brtvQFHp/footer-barnaul-1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=yellow][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][B][CENTER][FONT=times new roman][SIZE=4][COLOR=lavender] Ваша жалоба [COLOR=#FF0000]Отказана[/COLOR], так как доказательств на нарушение от данного игрока  отредактированы.[SIZE=4]<br><br>"+
 	    '[B][CENTER][COLOR=red][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/B]<br><br>'+
        "[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи жалоб на администрацию, закрепленные в разделе правил сервера.<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#797cc7]BARNAUL(69)[/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img][/url]<br>",
...
},
{
      ...
      content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/brtvQFHp/footer-barnaul-1.png[/img][/url]<br>' +
		'[B][CENTER][COLOR=yellow][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>'+
		'[B][CENTER][FONT=times new roman][SIZE=4][COLOR=lavender]Ваша жалоба была передана [COLOR=red]Заместителю Специального Администратора[/COLOR] Ожидайте ответа, пожалуйста не создавайте дубликатов данной темы.[SIZE=4]<br><br>'+
        '[B][CENTER][COLOR=yellow][ICODE]На рассмотрении[/ICODE][/COLOR][/CENTER][/B]<br><br>'+
        "[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи жалоб на администрацию, закрепленные в разделе правил сервера.<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#797cc7]BARNAUL(69)[/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img][/url]<br>",
...
},
{
      ...
      content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/brtvQFHp/footer-barnaul-1.png[/img][/url]<br>' +
		'[B][CENTER][COLOR=yellow][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>'+
		'[B][CENTER][FONT=times new roman][SIZE=4][COLOR=lavender]Ваша жалоба была передана [COLOR=red]Главному Администратору[/COLOR] —  @Santa_Aelpee. Ожидайте ответа.[SIZE=4]<br><br>'+
        '[B][CENTER][COLOR=yellow][ICODE]На рассмотрении[/ICODE][/COLOR][/CENTER][/B]<br><br>'+
        "[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи жалоб на администрацию, закрепленные в разделе правил сервера.<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#797cc7]BARNAUL(69)[/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img][/url]<br>",
...
},
{
      ...
      content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/brtvQFHp/footer-barnaul-1.png[/img][/url]<br>' +
		'[B][CENTER][COLOR=yellow][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>'+
		'[B][CENTER][FONT=times new roman][SIZE=4][COLOR=lavender]Ваша жалоба была передана [COLOR=red]Заместителю Главного Администратора[/COLOR] —  @Evgeniy Yurievich ♡. Ожидайте ответа.[SIZE=4]<br><br>'+
        '[B][CENTER][COLOR=yellow][ICODE]На рассмотрении[/ICODE][/COLOR][/CENTER][/B]<br><br>'+
        "[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи жалоб на администрацию, закрепленные в разделе правил сервера.<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#797cc7]BARNAUL(69)[/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img][/url]<br>",
...
},
{
      ...
      content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/brtvQFHp/footer-barnaul-1.png[/img][/url]<br>' +
		'[B][CENTER][COLOR=yellow][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>'+
		'[B][CENTER][FONT=times new roman][SIZE=4][COLOR=lavender]Ваша жалоба была передана [COLOR=red]Заместителю Главного Администратора[/COLOR] —  @Sova_Evseeva. Ожидайте ответа.[SIZE=4]<br><br>'+
        '[B][CENTER][COLOR=yellow][ICODE]На рассмотрении[/ICODE][/COLOR][/CENTER][/B]<br><br>'+
        "[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи жалоб на администрацию, закрепленные в разделе правил сервера.<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#797cc7]BARNAUL(69)[/COLOR]<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img][/url]<br>",
