// ==UserScript==
// @name   🌱【免费版】正承教育|正在学平台|上海理工大学|上海商学院|如需自动下一集、自动换课程、作业答题等高级功能见收费版本：https://doc.zhanyc.cn/pages/zzx/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、作业答题、全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.o-learn.cn/*
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/519825/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%AD%A3%E6%89%BF%E6%95%99%E8%82%B2%7C%E6%AD%A3%E5%9C%A8%E5%AD%A6%E5%B9%B3%E5%8F%B0%7C%E4%B8%8A%E6%B5%B7%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%7C%E4%B8%8A%E6%B5%B7%E5%95%86%E5%AD%A6%E9%99%A2%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E4%BD%9C%E4%B8%9A%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpageszzx.user.js
// @updateURL https://update.greasyfork.org/scripts/519825/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%AD%A3%E6%89%BF%E6%95%99%E8%82%B2%7C%E6%AD%A3%E5%9C%A8%E5%AD%A6%E5%B9%B3%E5%8F%B0%7C%E4%B8%8A%E6%B5%B7%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%7C%E4%B8%8A%E6%B5%B7%E5%95%86%E5%AD%A6%E9%99%A2%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E4%BD%9C%E4%B8%9A%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpageszzx.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、秒过、考试答题、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/zzx/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/user/student/course/") && url.includes("/topic/")) {
                plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
            } else if (url.includes("/space/topic")) {
                plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
            } else if (
                url.includes("/user/student/course/") &&
                url.includes("/learn/")
            ) {
                plugMain.page_video();
            } else if (url.includes("/space/overview/home")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/space/doc")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/office/p/")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("polyvPlayBack")) {
                plugMain.showPaidContent(`免费版本不包含自动看回播功能，如需使用请安装收费版本`);
            }
            plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
        ...
        async page_video() {
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if ($(".student-learn-topic-slot:visible").length > 0) {
                        plugMain.pageData.waitTime = 10
                        plugMain.confirmRun("无内容，3秒后下一步").then(a => {
                            plugMain.nextVideo(0)
                        })
                    }
                    if ($(".nav-btn").length > 0) {
                        isDev && console.log('isVideoPage');
                        plugMain.setGMData('isVideoPage', plugMain.now())
                    }

                    if ($(".student-learn-text-slot:visible").length > 0) {
                        plugMain.pageData.waitTime = 10
                        plugMain.confirmRun("无内容，3秒后下一步").then(a => {
                            plugMain.nextVideo(0)
                        })
                    ...
                    if (!plugMain.getVideo()) {
                        ...
                        noVideoCount--;
                        if (noVideoCount <= 0) {
                            plugMain.pageData.waitTime = 60;
                            plugMain.confirmRun("准备前往列表页面").then((a) => {
                                let url = plugMain.getGMData("listUrl", "/");
                    ...
                    try {
                        if ($(".video-hint").text().match(/.*应达到 (.*)，当前已观看 (.*)。/).length >= 3) {
                            var arr = $(".video-hint").text().match(/.*应达到 (.*)，当前已观看 (.*)。/)
                            if (plugMain.timeStringToSeconds(arr[1]) < plugMain.timeStringToSeconds(arr[2])) {
                                plugMain.nextVideo()
                                plugMain.pageData.waitTime = 20
                                plugMain.pageData.lastFinishTime = plugMain.now();
                                return
                            }
                        }
                    } catch (e) { }
                    ...
                    if ($(".pv-select-option-active[data-rate]").text().trim().replace('x', '') != bs) {
                        $(".media-player-container")[0].__vue__.updateVideoSpeed(bs)
                    }
                } catch (e) {
