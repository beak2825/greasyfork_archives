...
// @downloadURL https://update.greasyfork.org/scripts/3932/RatingR2.user.js
// @updateURL https://update.greasyfork.org/scripts/3932/RatingR2.meta.js
// ==/UserScript==
...
if (location.href.indexOf("/players/") != -1){
	...
	function siSearch (gettr) {
		for (var i = 0; i < gettr.length; i++){
			if (gettr[i].innerHTML.indexOf("უნარების ინდექსი") > 0) return i;
