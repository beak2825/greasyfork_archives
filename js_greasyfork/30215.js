...
// @author  chippa
// @downloadURL https://update.greasyfork.org/scripts/30215/marketShareHelperEZ.user.js
// @updateURL https://update.greasyfork.org/scripts/30215/marketShareHelperEZ.meta.js
// ==/UserScript==
var run = function () {
  // getter
...
'Эль-Махалла-эль-Кубра':'424899/424900/424908'
    ...
    $tbody.children('tr.product_row').each(function () {
      ...
      var something = '0|0|0'.split('|');
      var marketPortion = something[0];
      var profit = something[1];
      var totalMarket = something[2];
      if (marketPortion > 0.5)
      {
        $tr.children('td:eq(4)').append('<br><span class=1ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.01) + '\')">1%</span>&nbsp; <span class=2ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.02) + '\')">2%</span>&nbsp; <span class=5ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.05) + '\')">5%</span>&nbsp; <span class=10ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.1) + '\')">10%</span>&nbsp; <span class=15ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.15) + '\')">15%</span><br><br> <span class=25ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.25 - 1) + '\')">25%</span>&nbsp; <span class=33ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.333) + '\')">33%</span>&nbsp; <span class=48ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.48) + '\')">48%</span>&nbsp; <span class=50ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.5 - 1) + '\')">50%</span><br><br> <span class=75ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 0.75) + '\')">75%</span>&nbsp; <span class=100ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 1) + '\')">100%</span>&nbsp; <span class=120ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 1.2) + '\')">120%</span>&nbsp; <span class=150ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 1.5) + '\')">150%</span><br><br> <span class=200ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
        + Math.floor(totalMarket * 2) + '\')">200%</span>&nbsp;                                     '
        );
      } else {
        ...
        var link = 'https://virtonomica.ru/api/' + currentRealm + '/main/marketing/report/retail/metrics?tpl=marketing%2Freport%2Fretail%2Fmetrics&app=adapter_vrt&format=json&product_id=' + thisid + '&geo=' + CityId + '&wrap=0';
        var $td3 = $tr.children('td:eq(0)');
        var $td4 = $td3.text().split('\n');
        var $stock = $td4[2].trim().replace('Количество', '').replace(' ', '').replace(' ', '').replace(' ', '').replace(' ', '') * 1;
        var $sold = $td4[6].trim().replace('Продано', '').replace(' ', '').replace(' ', '').replace(' ', '').replace(' ', '') * 1;
          if($stock == 0 && $sold == 0) {$sold = 5;}
        $.get(link, function (data) {
          if (data.local_market_size == null) {
            var obj = JSON.parse(data);
            var totalMarket2 = obj.local_market_size;
          } else {
            var totalMarket2 = data.local_market_size;
          }
          //            console.log('product - ' + thisid + '| volume: ' + totalMarket2);

          $tr.children('td:eq(4)').append('<br><span class=05ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.005) + '\')">0.5%</span>&nbsp; <span class=1ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.01) + '\')">1%</span>&nbsp; <span class=2ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.02) + '\')">2%</span>&nbsp; <span class=5ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.05) + '\')">5%</span>&nbsp; <span class=10ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.1) + '\')">10%</span>&nbsp; <span class=15ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.15) + '\')">15%</span>&nbsp; <span class=25ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.25 - 1) + '\')">25%</span><br><br> <span class=33ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.333) + '\')">33%</span>&nbsp; <span class=48ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.48) + '\')">48%</span>&nbsp; <span class=50ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.5 - 1) + '\')">50%</span>&nbsp; <span class=75ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 0.75) + '\')">75%</span><br><br> <span class=100ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 1) + '\')">100%</span>&nbsp; <span class=120ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 1.2) + '\')">120%</span>&nbsp; <span class=150ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 1.5) + '\')">150%</span>&nbsp; <span class=200ex style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(totalMarket2 * 2) + '\')">200%</span>&nbsp; <br><br><span class=x10 style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(($sold)) + '\')">X1</span>&nbsp; <span class=x25 style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(($sold * 2.5) - $stock) + '\')">X2.5</span>&nbsp; <span class=x30 style="border-bottom: 1px dashed #0184D0; color: #0184D0; cursor: pointer;text-decoration: none;" onclick="$(this).parent().children(\'input\').val(\''
          + Math.floor(($sold * 3) - $stock) + '\')">X3.0</span>&nbsp;                                     '
          );
    ...
    if (window.location.href.indexOf('supply') > - 1) {
      $tbody.parent().before('<div>Со всеми отображенными: <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'0.5%\' onClick=\'$(".05ex").click();\'>0.5%</span><span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'1%\' onClick=\'$(".1ex").click();\'>1%</span><span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'2%\' onClick=\'$(".2ex").click();\'>2%</span><span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'5%\' onClick=\'$(".5ex").click();\'>5%</span><span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'10%\' onClick=\'$(".10ex").click();\'>10%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'15%\' onClick=\'$(".15ex").click();\'>15%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'25%\' onClick=\'$(".25ex").click();\'>25%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'33%\' onClick=\'$(".33ex").click();\'>33%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'48%\' onClick=\'$(".48ex").click();\'>48%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'50%\' onClick=\'$(".50ex").click();\'>50%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'75%\' onClick=\'$(".75ex").click();\'>75%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'100%\' onClick=\'$(".100ex").click();\'>100%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'120%\' onClick=\'$(".120ex").click();\'>120%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'150%\' onClick=\'$(".150ex").click();\'>150%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'200%\' onClick=\'$(".200ex").click();\'>200%</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'X2.5\' onClick=\'$(".x10").click();\'>X1</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'X2.5\' onClick=\'$(".x25").click();\'>X2.5</span> <span style="font-size:75%;margin:1px; padding:1px; border:1px solid #2222ff; border-radius:3px; cursor:pointer" title=\'X3.0\' onClick=\'$(".x30").click();\'>X3</span> </div>'
      );
    };
  });
}
