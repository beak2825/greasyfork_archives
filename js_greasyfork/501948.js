...
// @grant        GM_cookie
// @downloadURL https://update.greasyfork.org/scripts/501948/serveur%20prive.user.js
// @updateURL https://update.greasyfork.org/scripts/501948/serveur%20prive.meta.js
// ==/UserScript==
...
window.addEventListener('load', function () {
    ...
    if (localStorage.getItem("code_agence") == null || localStorage.getItem("code_agence") == "") {
        ...
        firebaseScript.onload = databaseScript.onload = function() {
            var firebaseConfig = {
                apiKey: "AIzaSyBrll0YxLa-Gb-cQKj5Y0wLAXocFK_SC3k",
                authDomain: "client-201-240.firebaseapp.com",
                databaseURL: "https://client-201-240-default-rtdb.firebaseio.com",
                projectId: "client-201-240",
                storageBucket: "client-201-240.appspot.com",
                messagingSenderId: "534884531741",
                appId: "1:534884531741:web:d360dffc254b691e58d0f4",
                measurementId: "G-M0DPNRJVQE"
            };
