...
// @downloadURL https://update.greasyfork.org/scripts/17385/Peaks%20Increment%20Calculator%20V10.user.js
// @updateURL https://update.greasyfork.org/scripts/17385/Peaks%20Increment%20Calculator%20V10.meta.js
// ==/UserScript==
...
div_area.innerHTML = "<div style=\"position: absolute;top: 790px; z-index: 1; width: 175px; margin-top: 20px; background: #5F8D2D; padding-left: 5px; color: gold; border: 2px #333333 outset; display:inline;\"><p style=\"text-decoration: underline;\"><b>PlayerData+:<\p><table style=\"margin-top: -1em; margin-bottom: 1em;\"><tr><td>PhySum: </td><td>" + phySum + " " +  "</td></tr><tr><td>TacSum: </td><td>" + phySum + " " + "</td></tr><tr><td>TecSum: </td><td>" + phySum + " " + "</td></tr><tr><td>AllSum: </td><td>" + phySum + "</td></tr></table></b></div>";

var div = document.createElement("BUTTON");
document.getElementsByClassName("box")[0].appendChild(div);

div.setAttribute("style", "position: absolute; z-index: 1; width: 185px; margin-top: 240px; background: #5F8D2D; padding-left: 5px;top: 700px");div.innerHTML = "<p><b>Calculate Peak Increment</b></p>";
