...
// @downloadURL https://update.greasyfork.org/scripts/467797/2.user.js
// @updateURL https://update.greasyfork.org/scripts/467797/2.meta.js
// ==/UserScript==
...
["不是滿等幸鍛", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjE2ODIwLCJ2Ijo1LCJyIjo1LCJpYXQiOjE2ODU4MDEwODYsImV4cCI6MTcwMTM1MzA4Nn0.cAFGFxjj84QDNiJy21newRoA-vHwC_YmkmlzQGdgxnA"],
            ...
            function showSwitchAccount(){
                ...
                document.querySelector("#reset-settings-btn").ondblclick = () => {
            ...
            function itemApplyFilter(itemName, config) {
                /*
                    ...
                    const filter = [
                        {
                            color: "#FF0000",
                            sound: "https://cdn.discordapp.com/attachments/1067695191051477072/1088730578641244190/XXXXX.mp3",
                            volume: 0.1,
                            items: ["蜂蜜", "龜殼花牙"]
                        },
                        {
                            color: "#FF2200",
                            sound: "https://cdn.discordapp.com/attachments/1067695191051477072/1088732632013099018/XXXX.mp3",
                            volume: 0.1,
                            items: ["S級兔皮"]
                        }
                    ]
                    ...
                    color的 "" 裡面放色碼
                    sound的 "" 裡面放音效網址 (可上傳至DC再複製網址進去)
                    volume填 0 ~ 1 = 聲音0%~100% ex: 0.01 0.02 0.5 0.8 0.99
                    將要匹配的物品放到""裡面 複數個請用逗號隔開 ex: ["第一個物品", "第二個物品"]
