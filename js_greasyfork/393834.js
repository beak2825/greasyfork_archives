...
function AddUsers()
{
    profiles = document.querySelectorAll('button[data-control-name="people_connect"]');
    for (var i = 0; i < profiles.length; i++){
        profiles[i].click();
         Sleep(200);
    }
    profiles = document.querySelectorAll('button[data-control-name="invite"]');
...
{
    console.log($_GET('LinkedBot'));
    if (confirm("Enable LinkedIn bot?"))
        window.open("https://www.linkedin.com/mynetwork/?LinkedBot=true", '_blank');
}