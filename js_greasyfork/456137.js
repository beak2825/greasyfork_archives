...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/456137/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%7C%20Purple.user.js
// @updateURL https://update.greasyfork.org/scripts/456137/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%7C%20Purple.meta.js
// ==/UserScript==
...
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
       prefix: PINN_PREFIX,
      status: true,
    },
	{
...
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Админимстрация сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
         prefix: CLOSE_PREFIX,
      status: false,
    },
	{
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], закрыто. [/B][/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервере Purple.[/B][/FONT][/SIZE][/RIGHT]',
         prefix: CLOSE_PREFIX,
      status: false,
    },
	{
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B] Ваше наказание Обажлованию не подлежит,прочтите внимательнее праивла подачи Обжалования. [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
                "[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/B][/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервера Purple.[/B][/FONT][/SIZE][/RIGHT]',
	      prefix: CLOSE_PREFIX,
