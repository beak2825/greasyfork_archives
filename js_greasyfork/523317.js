...
// @downloadURL https://update.greasyfork.org/scripts/523317/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80%20Penza.user.js
// @updateURL https://update.greasyfork.org/scripts/523317/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80%20Penza.meta.js
// ==/UserScript==
(function () {
'esversion 6' ;
const FAIL_PREFIX = 4;
...
const SA_PREFIX = 11;
const CP_PREFIX = 10;
     const string = "https://vk.com/id472933284"
const buttons = [
  {
   ...
   dpstyle: 'oswald: 3px;     color: #fff; background: #20B2AA; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #20B2AA',
	...
	},
    {
	  ...
	  content:
        ...
        "[CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
		"[CENTER]Отказано, закрыто.[/CENTER][/FONT][/SIZE]" +
		'[CENTER][FONT=Georgia][COLOR=rgb(32, 178, 170)][SIZE=4]Приятной игры на сервере Penza (54)[/COLOR]<br>',
	  prefix: FAIL_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
        ...
        "[CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
		"[CENTER]Отказано, закрыто.[/CENTER][/FONT][/SIZE]" +
		'[CENTER][COLOR=rgb(32, 178, 170)][SIZE=4][FONT=georgia]Приятной игры на сервере Penza (54)[/FONT][/SIZE][/COLOR][/CENTER]',
	  prefix: FAIL_PREFIX,
	  status: false,
	},
    {
