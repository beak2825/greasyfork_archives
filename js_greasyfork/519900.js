...
// @downloadURL https://update.greasyfork.org/scripts/519900/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20C%20Stoyn.user.js
// @updateURL https://update.greasyfork.org/scripts/519900/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20C%20Stoyn.meta.js
// ==/UserScript==
...
(function() {
    ...
    const buttons = [
        ...
        },
        {
            ...
            content:
                ...
                "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]5. Причина отсутствия: [/I][/SIZE][COLOR=rgb(255, 0, 0)][SIZE=4][I]Причина[/I][/SIZE][/COLOR][/FONT][/COLOR]<br>" +
                "[IMG]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG][/CENTER]",
        },
        {
            title: 'Повышение',
        ...
        },
        {
            ...
            content:
                ...
                "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]4. Примерная дата когда давали долг: [/I][/SIZE][COLOR=rgb(255, 0, 0)][SIZE=4][I]01.01.2024[/I][/SIZE][/COLOR][/FONT][/COLOR]<br>" +
                "[IMG]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG][/CENTER]",
        },
        {
            title: 'Снятие выга',
            content:
                ...
                "[SPOILER]" +
                "[IMG]https://vk.com/sticker/1-73087-256b[/IMG]<br>" +
        ...
        },
        {
            ...
            content:
                ...
                "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]5. Причина неактива: [/I][/SIZE][COLOR=rgb(255, 0, 0)][SIZE=4][I]Причина[/I][/SIZE][/COLOR][/FONT][/COLOR]<br>" +
                "[IMG]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG][/CENTER]",
        },
        {
            title: '-----------------------------------------------------------------------Одобрения-----------------------------------------------------------------------',
        },
        {
            ...
            content:
                ...
                "[CENTER][COLOR=#4caf50][I][B][FONT=georgia][SIZE=4]Одобрено![/SIZE][/FONT][/I][/B][/COLOR][/CENTER]",
        ...
        },
        {
            ...
            content:
                ...
                "[COLOR=#4caf50][I][B][FONT=georgia][SIZE=4]Одобрено![/SIZE][/FONT][/B][/I][/COLOR][/CENTER]",
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content:
                ...
                "[IMG]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
                "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA .[/SIZE][/FONT][/COLOR][/I]<br>" +
                "[COLOR=#ff9800][I][B][FONT=georgia][SIZE=4]На рассмотрении![/SIZE][/FONT][/B][/I][/COLOR][/CENTER]",
            prefix: TEX_PREFIX,
            status: true,
        },
        {
    ...
    $(document).ready(() => {
        ...
        $('button#unaccept').click(() => editThreadData(CLOSE_PREFIX, false));
        ...
        $('.p-body').before(
            `<style>
                .p-body {
                    background-image: url(https://i.postimg.cc/RFXt9x9G/img1-akspic-ru-voda-gora-gidroresursy-rastenie-oblako-4096x2340.jpg);
