...
// @license      Bleyzov
// @downloadURL https://update.greasyfork.org/scripts/501802/Theme%20%20Font%20Changer.user.js
// @updateURL https://update.greasyfork.org/scripts/501802/Theme%20%20Font%20Changer.meta.js
// ==/UserScript==
(function () {
    'use strict';
    ...
    function applyTextGradient() {
        ...
        textGradient.textContent = `
                ...
                .td-player-name[data-v-2d76ca92] a[data-v-2d76ca92] {
                    background: linear-gradient(45deg, #676767f00, #ff4400, #676767f00);
                    background-size: 150% 150%;
                    animation: gradientCategory 5s linear infinite;
                    color: transparent !important;
                    -webkit-background-clip: text;
        ...
        pseudoClasses.textContent = `
                ...
                /* Style Button CSS + Pseudo Classes */
                    .style-button {
                        ...
                        border: 3px solid #676767fff;
                        border-radius: 10px;
                        box-shadow: 0px 0px 10px #676767fff;
                        width: 10%;
                ...
                input[type=range]::-webkit-slider-thumb:hover {
                    background: #444444;
                    border: 1px solid #676767fff;
                    box-shadow: 0px 0px 2px #212121000;
                    border-radius: 15px;
                    cursor: pointer;
                    width: 20px;
                    height: 40px;
                ...
                input[type="color"] {
                    -webkit-appearance: none;
                    border: 2px solid #676767fff;
                    background: #212121;
                    border-radius: 20px;
                    overflow: hidden;
                    outline: none;
                    cursor: pointer;
                    box-shadow: 0px 0px 5px #676767fff;
                    transition-duration: 0.5s;
                }
                input[type="color"]:hover {
                    -webkit-appearance: none;
                    ...
                    outline: none;
                    cursor: pointer;
                    box-shadow: 0px 0px 10px 2px #676767fff;
                }
    ...
    function applyBodyStyle() {
        ...
        #log-table[data-v-2d76ca92] .first-row[data-v-2d76ca92] td[data-v-2d76ca92] {
            ...
            background: #2f2f2f;
            color: #676767;
            text-shadow: 0px 0px 2px #676767;
        }
        ...
        .bi-sort-down::before {
            color: #DB2424;
            text-shadow: 0px 0px 2px #DB2424;
        }
        ...
        #loading-overlay-heading[data-v-173ec149] {
            ...
            background: linear-gradient(90deg, #676767fff, #444444, #676767fff);
            background-size: 150% 150%;
