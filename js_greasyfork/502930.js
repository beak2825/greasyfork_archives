...
// @downloadURL https://update.greasyfork.org/scripts/502930/pixels%20vip%20apiary.user.js
// @updateURL https://update.greasyfork.org/scripts/502930/pixels%20vip%20apiary.meta.js
// ==/UserScript==
  ...
  */
        ...
        let interval = setInterval(() => {
            ...
            if (unsafeWindow.spacepack) {
                ...
                let position_y = 0
                let orders = []
                let apiary_map = ['pixelsNFTFarm-1629','pixelsNFTFarm-2655', 'pixelsNFTFarm-2072','pixelsNFTFarm-2074','pixelsNFTFarm-2780','pixelsNFTFarm-2781','pixelsNFTFarm-2782','pixelsNFTFarm-2784']
                let apiary_time = {}
                let ElementsName = []
                let cur_coins = 0
                ...
                let sell_info = ["Popberry", "Grainbow", "Queen Bee", "Honey", "Wax"]
                        ...
                        if(state.id.includes("terravilla")){
                            ...
                            if (queenbee<4&&cur_coins>1000){
                                ...
                                while(!apiary_time_bool){
                                    ...
                                    if (apiary_time_bool){
                                        ...
                                        console.log(apiary_time,new Date().getTime())
                                        await sleep(30000)
                                    }
                                }
                            ...
                            for (const [key,value] of playSchemaSerializer.state.entities.$items) {
                                if (value.entity === 'ent_saunarocks_charger') {
                                    if (value.generic.displayInfo.utcTarget === 0&&mapId.includes('SaunaInterior')){
