...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/472072/Script%20by%20Pistenkov.user.js
// @updateURL https://update.greasyfork.org/scripts/472072/Script%20by%20Pistenkov.meta.js
// ==/UserScript==
...
(async function () {
 ...
 prefix: UNACCEPT_PREFIX,
	...
	},
    {
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба передана Заместителям Главного Администратора —  @Lucas_King  и @Dmitry Anatolyevic   <br><br>"+
        `[color=orange]На рассмотрении[/color]. <br><br>`+
        `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffa500] Приятной игры и времяпровождение  на сервере ROSTOV (29)[/COLOR][/FONT][/SIZE][/CENTER]`,
	  prefix: PIN_PREFIX,
	  status: true,
        ...
        },
{
        ...
        },
        {
            title: 'Не по форме',
            content:
            ` [CENTER][SIZE=4][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
	  ...
	  status: false,
	},
        {
            ...
            content:
            ` [CENTER][SIZE=4][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
            "[B][CENTER][COLOR=lavender]Данное нарушение не подлежит обжалованию, в обжаловании отказано.<br>"+
             '[CENTER][FONT=Verdana][COLOR=RED]Отказано[/COLOR], Закрыто.[/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
            ...
            content:
            ` [CENTER][SIZE=4][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
            "[B][CENTER][COLOR=lavender]Администрация сервера не готова снизить вам наказание.<br>"+
             '[CENTER][FONT=Verdana][COLOR=RED]Отказано[/COLOR], Закрыто.[/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
            ...
            content:
            ` [CENTER][SIZE=4][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
            "[B][CENTER][COLOR=lavender]Ваше обжалование взято на рассмотрение.<br>"+
            '[CENTER][FONT=Verdana][COLOR=orange]На рассмотрение[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
        },
        {
      ...
      status: true,
        ...
        },
        {
           ...
           "[B][CENTER][COLOR=lavender]Обжалование одобрено, ваше наказание будет снято/снижено в течение 24-ех часов.<br>"+
            ' [CENTER][FONT=Verdana][COLOR=#00FA9A]Одобрено[/COLOR], Закрыто.[/FONT][/CENTER]',
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content:
            ` [CENTER][SIZE=4][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
           "[B][CENTER][COLOR=lavender]Обжалование передано Главному Администратору.<br>"+
           "[B][CENTER][COLOR=lavender]Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            '[CENTER][FONT=Verdana][COLOR=orange]На рассмотрение[/COLOR][/FONT][/CENTER]',
            prefix: GA_PREFIX,
            status: true,
        },
        ...
        },
        {
            ...
            content:
            ` [CENTER][SIZE=4][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
           "[B][CENTER][COLOR=lavender]Если вы не согласны с выданным наказанием, то напишите жалобу в раздел Жалобы на Администрацию.<br>"+
