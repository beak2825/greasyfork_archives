...
// @icon         https://www.chiphell.com/static/image/common/logo.png
...
// @run-at       document-end
// @namespace    https://greasyfork.org/zh-CN/scripts/414708
// @downloadURL https://update.greasyfork.org/scripts/414708/Chiphell%E8%87%AA%E5%8A%A8%E6%97%A0%E7%BC%9D%E7%BF%BB%E9%A1%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/414708/Chiphell%E8%87%AA%E5%8A%A8%E6%97%A0%E7%BC%9D%E7%BF%BB%E9%A1%B5.meta.js
// ==/UserScript==

(function() {
    var menu_thread_pageLoading = GM_getValue('xin2_menu_thread_pageLoading');
    ...
    function registerMenuCommand() {
        ...
        if (menu_feedBack_ID){ // 如果反馈菜单ID不是 null，则删除所有脚本菜单
            ...
            menu_thread_pageLoading = GM_getValue('xin2_menu_thread_pageLoading');
        }

        if (menu_thread_pageLoading){menu_thread_pageLoading_ = "√";}else{menu_thread_pageLoading_ = "×";}

        menu_thread_pageLoading_ID = GM_registerMenuCommand(`[ ${menu_thread_pageLoading_} ] 帖子内自动翻页`, function(){menu_switch(menu_thread_pageLoading,'xin2_menu_thread_pageLoading','帖子内自动翻页')});
        menu_feedBack_ID = GM_registerMenuCommand('反馈 & 建议', function () {window.GM_openInTab('https://greasyfork.org/zh-CN/scripts/414708-chiphell自动无缝翻页/feedback', {active: true,insert: true,setParent: true});});
    }
