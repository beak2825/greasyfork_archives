...
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/468653/Azure%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/468653/Azure%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "С момента выдачи наказания прошло более 48-ми часов.<br>"+
            '[COLOR=RED]Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
