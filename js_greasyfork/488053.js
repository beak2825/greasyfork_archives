...
// @grant        GM_addStyle
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/488053/TP%20Overhaul.user.js
// @updateURL https://update.greasyfork.org/scripts/488053/TP%20Overhaul.meta.js
// ==/UserScript==
...
<div class="tpo_profile_card">
    ...
    <div class="tpo_profile_action">
        <button class="tpo_svg_button" onclick="nav.getMessagerie().newMessage('${name}')">
