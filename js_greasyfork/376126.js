...
// @exclude     /.+art_type=thief_paper.*/
// @version     1.0.9
// @downloadURL https://update.greasyfork.org/scripts/376126/GN_Market.user.js
// @updateURL https://update.greasyfork.org/scripts/376126/GN_Market.meta.js
// ==/UserScript==
...
function backup_categories(){
  ...
  for(var i = 0; i < marks.length; ++i){
    ...
    categories.push({ mark: mark, closed: window['a2_' + mark], opened: window['a_' + mark]});
  }
}
...
function save_settings(){
  ...
  if(isNaN(min_lvl) || min_lvl < 1 || min_lvl > 21)
    errors.push('Мин. уровень должен лежать между 1 и 21');
  
  if(isNaN(max_lvl) || max_lvl < 1 || max_lvl > 21)
    errors.push('Макс. уровень должен лежать между 1 и 21');
