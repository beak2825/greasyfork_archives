// ==UserScript==
// @name         ASTRAKHAN | Скрипт для КФ
// @namespace    https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9675-astrakhan.3360/
// @version      1.6.1
// @description  обитель darkness
// @author       darkness
...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/523055/ASTRAKHAN%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/523055/ASTRAKHAN%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
        ...
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=trebuchet ms]Приветствую[/FONT][/COLOR]<br><br>"+
        "[FONT=trebuchet ms]Игрок будет наказан по следующему пункту:<br><br>"+
        "[QUOTE][COLOR=rgb(255, 0, 0)]3.18. [/COLOR]Запрещено включать музыку в Voice Chat[COLOR=rgb(255, 0, 0)]| Mute 60 минут[/COLOR][/QUOTE]<br>"+
        "[COLOR=rgb(255, 0, 0)]Одобрено. Закрыто[/COLOR][/FONT][/SIZE]<br><br>"+
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]KRASNODAR[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: ACCEPT_PREFIX,
        status: false
