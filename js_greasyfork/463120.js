...
// @downloadURL https://update.greasyfork.org/scripts/463120/%E9%97%AE%E5%8D%B7%E6%98%9F_JQuery.user.js
// @updateURL https://update.greasyfork.org/scripts/463120/%E9%97%AE%E5%8D%B7%E6%98%9F_JQuery.meta.js
// ==/UserScript==
...
(function () {
    ...
    function judgeType()
    {
        ...
        {
            //单选
            var sigle_c = $(".div_question"+"ulradiocheck");
            ...
            else if (sigle_i)
            {
                ...
                {
                    if ($("textarea")[j].id == ("q" + config[j].id))
                    {
