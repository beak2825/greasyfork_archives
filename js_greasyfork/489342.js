// ==UserScript==
// @name            open osm editor
// @description     Adds a small button in footer toolbar to open osm in the same coords you are.
...
// @downloadURL https://update.greasyfork.org/scripts/489342/open%20osm%20editor.user.js
// @updateURL https://update.greasyfork.org/scripts/489342/open%20osm%20editor.meta.js
// ==/UserScript==
...
(function() {
    ...
    function generateURL() {
        ...
        return `https://www.openstreetmap.org/edit#map=17/${lat}/${lon}`;
    }
    function openRT() {
    ...
    function init_OPEN_REPORTING_TOOL() {
        try {
            ...
            if (toolbarWrap !== null) {
              ...
              //toolbarWrap.insertAdjacentHTML('afterend', '<div class="WazeControlORT" id="WME_ORT" style="margin:0 5px;"><a href="#" id="btn-openrt">REPORT</a></div>');
                toolbarWrap.insertAdjacentHTML('afterend', '<div class="WazeControlORT" id="WME_ORT" style="margin:0 5px;"><a href="#" id="btn-openrt"><strong>osm</strong></a></div>');
