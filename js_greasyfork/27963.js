...
// @downloadURL https://update.greasyfork.org/scripts/27963/Hybrid%20-%20Calls%20-%20Mailing%20Address%20%28With%20B%29.user.js
// @updateURL https://update.greasyfork.org/scripts/27963/Hybrid%20-%20Calls%20-%20Mailing%20Address%20%28With%20B%29.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Mailing Address")').length) {
    ...
    createButton('DC', 2,2,2,'Disconnected Message');
    ...
    createButton('Busy', 2,2,2,'"Fast" Busy Signal'); //3
