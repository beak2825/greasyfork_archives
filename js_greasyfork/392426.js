...
// @version     0.21a
// @grant       none
// @description 对现有的txt阅读的脚本背景进行修改，对文字匹配方式修改
// @downloadURL https://update.greasyfork.org/scripts/392426/txt%20reader.user.js
// @updateURL https://update.greasyfork.org/scripts/392426/txt%20reader.meta.js
// ==/UserScript==
...
document.body.style.background = "url('http://qidian.gtimg.com/qd/images/read.qidian.com/theme/body_theme1_bg_2x.0.3.png')";
...
pageLayout.style.width = "99.99%";
pageLayout.style.borderLeft = "0";
...
index_containter.style.position="fixed";
index_containter.style.background="#333"
index_containter.style.width = "19%";
...
text_containter.style.cssFloat = "right";
text_containter.style.width = "80%";
...
//定义章节匹配正则
var sectionRex0 = new RegExp("^\s*[第卷][0123456789一二三四五六七八九十零〇百千两]*[章回部节集卷]");
var sectionRex1 = new RegExp("^\s*[第卷][0123456789一二三四五六七八九十零〇百千两]*[章回部节集卷].*");
