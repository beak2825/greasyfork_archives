...
// @iconURL       https://i.imgur.com/krfAACY.png
...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/422940/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.user.js
// @updateURL https://update.greasyfork.org/scripts/422940/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.meta.js
// ==/UserScript==
    ...
    class Dogeware {
        ...
        onLoad() {
            ...
            this.waitFor(_=>this.token).then(_ => {
                ...
                if ( this.isElectron() || !this.isDefined(GM) ) {
                    ...
                    alert("This Script Needs Updating by Krunker Extra, visit Krunker Extra On YouTube");
                    return window.location.assign("https://www.youtube.com/channel/UCKN9qye5ZIGvCvq0fwrRNjg");
                } else {
                    const loader = new Function("WP_fetchMMToken", "Module", this.gamePatch());
                    loader(new Promise(res=>res(this.token)), { csv: async () => 0 });
                }
        ...
        initGUI() {
            function createButton(name, iconURL, fn) {
                ...
                menuItemIcon.style.backgroundImage = `url("https://i.imgur.com/krfAACY.png")`
...
<img src="https://i.imgur.com/krfAACY.png" width="90%">
<div class="imageButton YouTube Here" onmouseenter="playTick()" onclick="openURL('https://www.youtube.com/channel/UCKN9qye5ZIGvCvq0fwrRNjg')"><span style='display:inline'></span></div>`
