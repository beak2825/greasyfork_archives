// ==UserScript==
// @name        MTurk Great HIT Export zingys version
...
// @downloadURL https://update.greasyfork.org/scripts/4432/MTurk%20Great%20HIT%20Export%20zingys%20version.user.js
// @updateURL https://update.greasyfork.org/scripts/4432/MTurk%20Great%20HIT%20Export%20zingys%20version.meta.js
// ==/UserScript==
...
(function () {
    ...
    DEFAULT_TEMPLATE = '[table][tr][td][b]Title:[/b] [url={link}][COLOR=#9A2EFE]{title}[/COLOR][/url]\n';
    DEFAULT_TEMPLATE += '[b]Requester:[/b] [url=https://www.mturk.com/mturk/searchbar?selectedSearchType=hitgroups&requesterId={requesterId}][COLOR=#9A2EFE]{requester}[/COLOR][/url]';
    DEFAULT_TEMPLATE += ' [{requesterId}] ([url='+TO_BASE+'{requesterId}][COLOR=#9A2EFE]TO[/COLOR][/url])';
