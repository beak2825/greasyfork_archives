// ==UserScript==
// @name         Overlay NE Buffalo County
// @namespace    https://greasyfork.org/users/45389
// @version      0.4.4.002
// @description  Adds a layer to display Parcel info for Buffalo County Nebraska
// @author       MapOMatic
...
// @downloadURL https://update.greasyfork.org/scripts/38169/Overlay%20NE%20Buffalo%20County.user.js
// @updateURL https://update.greasyfork.org/scripts/38169/Overlay%20NE%20Buffalo%20County.meta.js
// ==/UserScript==
...
(function() {
    ...
    var _settingsStoreName = 'wme_NE_Buffalo_Co-Parcel';
    ...
    function log(message, level) {
        if (message && (!level || (level <= _debugLevel))) {
            console.log('NE Buffalo Co parcel: ', message);
        }
    }
    ...
    function getUrl(extent, zoom) {
        ...
        var url = 'https://gis3.gisworkshop.com/arcgis/rest/services/Buffalo_County_NE_Assessor/MapServer/3/query?geometry=' + encodeURIComponent(geometryStr);
        ...
        if (_mapLayer !== null) {
            ...
            for (var i=0;i<_mapLayer.features.length;i++){
                ...
                if(feature.geometry.containsPoint(mapCenter)) {
                    ...
                    url = 'https://report.gisworkshop.com/report.ashx?county=buffalo&id=' + num + '&type=assessor&subs=true&format=html';
    ...
    function initLayer(){
        ...
        _mapLayer = new OpenLayers.Layer.Vector("Overlay NE Buffalo Co Parcels", {
            uniqueName: "__WMENEbuffalocopar",
        ...
        WazeWrap.Interface.AddLayerCheckbox("overlay", "NE Buffalo Co Parcel", _settings.layerVisible, onLayerToggleChanged);
    }
