...
// @downloadURL https://update.greasyfork.org/scripts/486643/Pistenkov%20%D0%B4%D0%BB%D1%8F%20%D0%97%D0%93%D0%90.user.js
// @updateURL https://update.greasyfork.org/scripts/486643/Pistenkov%20%D0%B4%D0%BB%D1%8F%20%D0%97%D0%93%D0%90.meta.js
// ==/UserScript==
...
`;
    ...
    const buttons = [
        ...
        `[color=red]Примечание:[/color] Удачного отдыха от игры на сервере [color=#ffa500]ROSTOV[/color]<br>` +
          `[SIZE=4][FONT=georgia][CENTER][COLOR=rgb(216, 0, 0)] С уважением Заместитель Главного администратора[/COLOR][/FONT][/SIZE][/CENTER]`,
    },
    {
        ...
        },
  {
	...
	},
	{
	  ...
	  content:
        ...
        `[SIZE=4][FONT=georgia][CENTER][COLOR=rgb(216, 0, 0)] С уважением Заместитель Главного администратора[/COLOR][/FONT][/CENTER]`,
	   prefix: PINN_PREFIX,
	  status: false,
         style: 'flex-grow: 1; border-radius: 25px; font-family: JetBrains Mono',
	},
 ...
 content:
	 ...
	 content:
      ...
      status: true,
    ...
    },
        {
            ...
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый игрок.<br><br>"+
            "Обжалование передано Главному Администратору. —  @Ilya_Zubachenkov <br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            `[SIZE=4][FONT=georgia][CENTER][COLOR=rgb(216, 0, 0)] С уважением Заместитель Главного администратора[/COLOR][/FONT][/SIZE][/CENTER]`,
            prefix: GA_PREFIX,
            status: true,
               ...
               },
    {
      ...
      status: false,
         ...
         {
      title: ' Найти игрока в соц сетях',
		 content:
                "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый игрок.<br><br>"+
        "[B][CENTER][COLOR=lavender]Найдите данного игрока в соц сетях и договоритесь о возрате имущества.<br>"+
        `[SIZE=4][FONT=georgia][CENTER][COLOR=rgb(216, 0, 0)] С уважением Заместитель Главного администратора[/COLOR][/FONT][/SIZE][/CENTER]`,
