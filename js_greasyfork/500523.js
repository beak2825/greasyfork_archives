// ==UserScript==
// @name         Скрипт для модераторов форума
...
// @license 	 none
// @copyright 2023,
// @downloadURL https://update.greasyfork.org/scripts/500523/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B4%D0%B5%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/500523/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B4%D0%B5%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
...
(function () {
    ...
    const START_DECOR = `<div style="text-align: center"><span style="font-family: 'Courier New';font-size: 14px">`
  ...
  const buttons = [
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Передаю Вашу жалобу Заместителю Главного Администратора [USER=48680]@Devid Diev[/USER].<br><br>` +
          `Ожидайте ответа.${END_DECOR}`,
          prefix: WAIT_PREFIX,
          status: true,
          move: 0,
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Передаю Вашу жалобу Главному Администратору @Ricardo_Vendetta.<br><br>` +
          `Ожидайте ответа.${END_DECOR}`,
          prefix: HA_PREFIX,
          status: true,
          move: 0,
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Обратитесь в раздел жалоб на администрацию → *[URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.2120/']Кликабельно[/URL]*<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Обратитесь в раздел жалоб на технических специалистов → *[URL='https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9647-krasnoyarsk.2093/']Кликабельно[/URL]*.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Обратитесь в технический раздел для решения Вашей проблемы → *[URL='https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-krasnoyarsk.2094/']Кликабельно[/URL]*.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      ...
      {
          title: 'Фрапс неполный',
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Ваши видеодоказательства не раскрывают полной сути ситуации.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
