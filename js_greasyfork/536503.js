// ==UserScript==
// @name   🌱【免费版】广西公需课|广西专业技术人员继续教育信息管理系统|如需考试答题等高级功能见收费版本：http://doc.zhanyc.cn/pages/gxgxk/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.0
// @description  当前是免费版本，只包含了自动换课、视频页面自动播放、解除播放暂停限制功能。如需考试答题功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/536503/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%B9%BF%E8%A5%BF%E5%85%AC%E9%9C%80%E8%AF%BE%7C%E5%B9%BF%E8%A5%BF%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E4%BF%A1%E6%81%AF%E7%AE%A1%E7%90%86%E7%B3%BB%E7%BB%9F%7C%E5%A6%82%E9%9C%80%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttp%3Adoczhanyccnpagesgxgxk.user.js
// @updateURL https://update.greasyfork.org/scripts/536503/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%B9%BF%E8%A5%BF%E5%85%AC%E9%9C%80%E8%AF%BE%7C%E5%B9%BF%E8%A5%BF%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E4%BF%A1%E6%81%AF%E7%AE%A1%E7%90%86%E7%B3%BB%E7%BB%9F%7C%E5%A6%82%E9%9C%80%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttp%3Adoczhanyccnpagesgxgxk.meta.js
// ==/UserScript==
(function () {
    let $jq = $;
    unsafeWindow.$jq = $;
    ...
    let freeTips = "当前是免费版本，只包含了自动换课、视频页面自动播放、解除播放暂停限制功能。如需考试答题功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/gxgxk/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/study/watch".toLocaleLowerCase())) {
                plugMain.page_video();
            } else if (url.includes("/study/study/class/detail".toLocaleLowerCase())) {
                plugMain.page_list();
            } else if (url.includes("/study/exam/exam".toLocaleLowerCase())) {
        ...
        async page_video() {
            ...
            // await plugMain.waitOf(a => $(".item").length > 0)
            // await plugMain.waitTimeout(1000)
            // let $el = null
            // $(".item").each((i, el) => {
            //   if ($(el).find('.ro-finish').text().trim() == '已学完') {
            //     return true
            //   }
            //   $el = $(el)
            //   return false
            ...
            // }
            // $el.click()
            // await plugMain.waitOf(a => plugMain.getElByText($(`[aria-label="视频播放"] button`), "确 定") != null).then(a => {
            //   plugMain.getElByText($(`[aria-label="视频播放"] button`), "确 定").click()
            // })
            ...
            setTimeout(async () => {
                ...
                if (plugMain.getCurTime() == time) {
                    plugMain.confirmRun("貌似卡住了，3秒后刷新页面").then(a => {
                        location.reload()
                    })
                }
            }, 60 * 1000);
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if ($("xg-start.xgplayer-start:visible").length > 0) {
                        $("xg-start.xgplayer-start:visible").click()
                        return;
                    }
