...
// @downloadURL https://update.greasyfork.org/scripts/392601/OGame%20Fun%3A%20Spica%20BORG.user.js
// @updateURL https://update.greasyfork.org/scripts/392601/OGame%20Fun%3A%20Spica%20BORG.meta.js
// ==/UserScript==
    ...
    // ==============================================================================================
     ...
     function MenuLib() {
         ...
         this.menuButton_click = function() {
            ...
            //    alert("CLICK");
             //document.location ="https://spica.ogame.fun/game.php?page=galaxy";
