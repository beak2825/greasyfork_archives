// ==UserScript==
// @name         Gaminginfos Faucet Rotator
// @namespace    Earn Free Coin Instantly
// @version      1.0
// @description  Earn Free Coin Instantly
// @author       lotocamion
// @match        https://gaminginfos.com/*
// @connect      gaminginfos.com
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_xmlhttpRequest
// @antifeature  referral-link
// @downloadURL https://update.greasyfork.org/scripts/469919/Gaminginfos%20Faucet%20Rotator.user.js
// @updateURL https://update.greasyfork.org/scripts/469919/Gaminginfos%20Faucet%20Rotator.meta.js
// ==/UserScript==


//INSTALL THE SCRIPT AND HCAPTCHA SOLVER AND Solver - Letters with red lines
//EDIT LINE 32 WITH YOUR FAUCETPAY EMAIL ADDRESS
//THEN GOTO https://gaminginfos.com/coin/?r=125 AND LEAVE THE TAB OPEN


//Solver - Letters with red lines LINK => https://greasyfork.org/en/scripts/461583-solver-letters-with-red-lines
...
(function() {
    ...
    const mail = "YOUR_FAUCETPAY_EMAIL" //EDIT WITH YOUR FAUCETPAY EMAIL ADDRESS



    var websiteData = [

        {url : "https://gaminginfos.com/coin/faucet/currency/btc", regex: "btc"},
        {url : "https://gaminginfos.com/coin/faucet/currency/bnb", regex: "bnb"},
        {url : "https://gaminginfos.com/coin/faucet/currency/bch", regex: "bch"},
        {url : "https://gaminginfos.com/coin/faucet/currency/doge", regex: "doge"},
        {url : "https://gaminginfos.com/coin/faucet/currency/ltc", regex: "ltc"},
        {url : "https://gaminginfos.com/coin/faucet/currency/sol", regex: "sol"},
        {url : "https://gaminginfos.com/coin/faucet/currency/trx", regex: "trx"},
        {url : "https://gaminginfos.com/coin/faucet/currency/zec", regex: "zec"},
        {url : "https://gaminginfos.com/coin/faucet/currency/fey", regex: "fey"},
        {url : "https://gaminginfos.com/coin/faucet/currency/xrp", regex: "xrp"},
        {url : "https://gaminginfos.com/coin/faucet/currency/matic", regex: "matic"},
        {url : "https://gaminginfos.com/coin/faucet/currency/usdt", regex: "usdt"},
        {url : "https://gaminginfos.com/coin/faucet/currency/dgb", regex: "dgb"},
        {url : "https://gaminginfos.com/coin/faucet/currency/dash", regex: "dash"},
        {url : "https://gaminginfos.com/coin/faucet/currency/eth", regex: "eth"},
    ...
    var websiteMap = [
                       ...
                       {website : ["gaminginfos.com"],
                       captchaButtonSubmitSelector: ["#fauform","line","#subbutt",".btn.btn-primary.w-md","#subbutt","body > div.content > div > div > div > div > div > form > div > button","form button[type=submit]"],
                        allMessageSelectors: ["h5","div","#outer_6 > div.hbagency_space_34586",".hbagency_space_34586","span","h2","swal2-title",".alert.alert-danger.text-center",".alert.alert-warning",".alert.alert-success",".alert.alert-danger",".swal2-html-container",".next-button.lh-1.mb-1.font-weight-bold",".fas.fa-sync.fa-spin"],
                       successMessageSelectors: [".alert.alert-success"],
                       messagesToCheckBeforeMovingToNextUrl: ["Go Claim","Empty","Daily claim limit","please comeback again tomorrow","Please wait","has been sent to your FaucetPay","API Key used","Safety Limit reached","The faucet does not have sufficient funds for this transaction","insufficient","you have reached", "tomorrow","wrong order", "locked", "was sent to your", "You have to wait","Login not valid","You have already claimed","claimed successfully","Claim not Valid","rate limited"],
    ...
    (function()
{
 ...
 setTimeout(function login(){
    if (document.querySelector("#InputEmail")&& document.querySelector("#InputEmail").value !== mail) {
    document.querySelector("#InputEmail").value = mail
    setTimeout(function() {
    ...
    if (window.location.href == "https://gaminginfos.com/coin" || window.location.href == "https://gaminginfos.com/coin/") {
    window.location.replace("https://gaminginfos.com/coin/?r=125")
    clearInterval(ref)
    }}, 500);

    setInterval(function() {
    if (window.location.href == "https://gaminginfos.com/coin/?r=125") {
   document.querySelector("body > header:nth-child(25) > nav:nth-child(1) > div:nth-child(1) > div:nth-child(3) > ul:nth-child(1) > li:nth-child(2) > div:nth-child(2) > a:nth-child(1)").click();
    }}, 10000)
