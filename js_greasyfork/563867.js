...
// @downloadURL https://update.greasyfork.org/scripts/563867/xileili.user.js
// @updateURL https://update.greasyfork.org/scripts/563867/xileili.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "YANJUN HUANG";
    const NEW_NAME = "XILEI LI";
    const NEW_BIRTHDAY = "(**0821)";
    const NEW_EXPIRE_DATE = "2034-11-07";
