// ==UserScript==
// @name   🌱【免费版】汕头大学自动看课脚本|如需自动下一集、自动换课程、自动答题等高级功能见收费版本：https://doc.zhanyc.cn/pages/stdx/
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/512017/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%B1%95%E5%A4%B4%E5%A4%A7%E5%AD%A6%E8%87%AA%E5%8A%A8%E7%9C%8B%E8%AF%BE%E8%84%9A%E6%9C%AC%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesstdx.user.js
// @updateURL https://update.greasyfork.org/scripts/512017/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%B1%95%E5%A4%B4%E5%A4%A7%E5%AD%A6%E8%87%AA%E5%8A%A8%E7%9C%8B%E8%AF%BE%E8%84%9A%E6%9C%AC%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesstdx.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需如需自动下一集、自动换课程、自动答题、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/stdx/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("/jp_wiki_study")) {
                plugMain.page_video();
            } else if (url.includes("/mycourse.php")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("wiki_study_iframe_kt.php")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("studycenter_zy")) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
            } else if (url.includes("wiki_exam_zy")) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
            } else if (url.includes("studycenter_cy")) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
            } else if (url.includes("wiki_exam_cy")) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
            } else if (url.includes("wk_exam_examination.php")) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
            } else if (url.includes("wk_exam_examination_bukao.php")) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
            }
        ...
        async page_video() {
            ...
            let timeout = 2;
            if (plugMain.pageData.video.qaIndex == null) {
                plugMain.pageData.video.qaIndex = GM_addValueChangeListener(
                    "qaFinish",
                    function (name, old_value, new_value, remote) {
                        plugMain.getElByText($("a"), "我已完成答题")[0].click();
                    }
                );
            }
            await plugMain.waitOf((a) => $("ul.list>li").length > 0);
            let $item = null;
            $("ul.list>li").each((i, el) => {
                let $finishItem = $(el).find('a>span[style="color:#00A600;"]');
            ...
            if ($item == null) {
                plugMain.setCurVideoFinish();
                plugMain.confirmRun("当前课程视频已经完成，3秒后进入课程列表").then((a) => {
                    plugMain.toCoursePage();
                });
                return;
            } else {
                if ($item.find('i.si-control-play').length == 0) {
                    $item.find("a")[0].click()
                }
            }
                ...
                try {
                    ...
                    if (
                        ...
                        zfk
                            ...
                            .parents(".layui-layer-dialog")
                            .find("a.layui-layer-btn0")[0]
                            .click();
                    }
                    ...
                    if (!isPlay) {
                        if (!isFinish) {
                            if ($("#tcaptcha_transform>visible").length == 0) {
                                plugMain.play();
                            }
                        }
                    }
