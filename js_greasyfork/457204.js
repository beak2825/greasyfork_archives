...
(function() {
   ...
   var websiteData = [
        ...
        {url : "https://dogemate.com/ptc", login: "", password: ""},
        {url : "https://coinpot.in/ptc", login: "", password: ""},
        {url : "https://bits.re/ptc", login: "", password: ""},
    ...
    var websiteMap = [
        ...
        {
            website: "dogemate.com",
            defaultButtonSelectors: [".card-footer.text-center .btn.btn-gradient-03.btn-block.ripples"],
            loginSelectors: ["input[type=text]", "input[type=password]", "button[type=submit]"],
            allMessageSelectors: [".row.justify-content-center"],
            messagesToCheckBeforeMovingToNextUrl: ["Not Have Enough Active PTC Ads"],
            additionalFunctions: dogemate,
            timeoutbeforeMovingToNextUrl: 80000
        },

        {
            website: "bits.re",
            defaultButtonSelectors: [".card-body .btn.btn-primary.btn-style-light.flex-grow-1.m-l-xxs"],
            loginSelectors: ["input[type=text]", "input[type=password]", "button[type=submit]"],
            allMessageSelectors: [".alert.alert-warning.text-center"],
            messagesToCheckBeforeMovingToNextUrl: ["There is PTC Ad left"],
            additionalFunctions: bits,
            timeoutbeforeMovingToNextUrl: 80000
        },

        {
            website: ["coinpot.in"],
            defaultButtonSelectors: [".card-btn .btn.bgc.w-100"],
            loginSelectors: ["input[type=text]", "input[type=password]", "button[type=submit]"],
            allMessageSelectors: [".alert.alert-info.text-center"],
            messagesToCheckBeforeMovingToNextUrl: ["You claimed all the ptc ads. Please check here tomorrow again. Also you can find more ptc ads at these offerwalls. "],
    ...
    function dogemate() {
        ...
        if(document.querySelector("body").innerText.includes("This ad does not exist or has expired")){
            window.location.href = "https://dogemate.com/ptc/";
        }
    ...
    function mad() {
        ...
        if(document.querySelector("body").innerText.includes("This ad does not exist or has expired")){
            window.location.href = ["https://coinpayz.xyz/ptc/","https://coinpot.in/ptc/"];
        }
