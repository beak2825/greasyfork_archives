...
// @version        1.0.5
// @downloadURL https://update.greasyfork.org/scripts/14173/ogame%20highscore%20improved.user.js
// @updateURL https://update.greasyfork.org/scripts/14173/ogame%20highscore%20improved.meta.js
// ==/UserScript==
		...
		if (sendMessage.length > 0)
		{
			...
			if (sendMessageLinks.length > 0)
			{
				...
				//var result = expr.exec(sendMessageLinks[0].getAttribute('href'));
                                var result =sendMessageLinks[0].getAttribute('data-playerid');
