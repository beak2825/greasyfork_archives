...
// @name          hwmInventory
// @version       1.2.1
// @description   Replaces tabs in inventory
...
// @downloadURL https://update.greasyfork.org/scripts/372544/hwmInventory.user.js
// @updateURL https://update.greasyfork.org/scripts/372544/hwmInventory.meta.js
// ==/UserScript==
...
var idCat = 1;
function show_arts_by_cat_GM(cat, r) {
    idCat = r;
    //pre(cat, r);
    if(r>1 && r<6) {
...
unsafeWindow.show_arts_by_cat  = exportFunction (show_arts_by_cat_GM, unsafeWindow);
