...
// @downloadURL https://update.greasyfork.org/scripts/406048/Bilibili%20Live%20Tasks%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/406048/Bilibili%20Live%20Tasks%20Helper.meta.js
// ==/UserScript==
...
(async function (vue, hotkeys, _, pinia$1, CryptoJS, luxon, ElementPlusIconsVue, ElementPlus, vueDraggablePlus) {
  ...
  importCSS(" #aside-el-menu[data-v-db397d59]:not(.el-menu--collapse){width:150px}.title[data-v-848fd8cc]{display:flex;align-items:baseline;padding-left:20px}.header-big-text[data-v-848fd8cc]{align-self:unset;font-size:var(--big-text-size)}.header-small-text[data-v-848fd8cc]{align-self:unset;margin-left:10px;font-size:var(--small-text-size);--small-text-size: 18px}.collapse-btn[data-v-848fd8cc]{float:left;display:flex;align-items:center;justify-content:center;height:100%;cursor:pointer}.avatar-wrap[data-v-40ee26ea]{width:80px;height:80px}.avatar[data-v-40ee26ea]{display:flex;align-items:center;justify-content:center;border-radius:50%}.label-text[data-v-0ed6e292]{line-height:32px;color:var(--el-text-color-primary)}.base[data-v-1b4fc029]{position:absolute;z-index:1003;background-color:var(--el-bg-color)}.header[data-v-1b4fc029]{position:relative;box-sizing:border-box;display:flex;align-items:center;width:100%;height:60px;font-size:var(--big-text-size);border-bottom:1px solid #e3e5e7;--big-text-size: 25px}.aside[data-v-1b4fc029]{width:auto}.main[data-v-1b4fc029]{padding:0}.panel-main[data-v-1b4fc029]{padding:calc(var(--el-main-padding) * .625) var(--el-main-padding)}.fade-enter-active[data-v-1b4fc029]{animation:fade-in linear .2s}.info-icon[data-v-02b5bf3e]{font-size:var(--el-font-size-base);cursor:pointer}.status-icon[data-v-16fb8116]{font-size:var(--el-font-size-base)}.done[data-v-16fb8116]{color:#1ab059}.done.is-hovered[data-v-16fb8116]{color:#409eff;cursor:pointer}.error[data-v-16fb8116]{color:#ff6464}.icon-fade-enter-active[data-v-16fb8116],.icon-fade-leave-active[data-v-16fb8116]{transition:all .15s ease}.icon-fade-enter-from[data-v-16fb8116],.icon-fade-leave-to[data-v-16fb8116]{opacity:0;transform:scale(.8) rotate(90deg)} ");
...
(...args) => vue.unref(uiStore).changeCollapse && vue.unref(uiStore).changeCollapse(...args))
  ...
  const LiveTasks = _export_sfc(_sfc_main$9, [["__scopeId", "data-v-40ee26ea"]]);
              ...
              vue.createVNode(_component_el_space, { wrap: "" }, {
                default: vue.withCtx(() => [
                  ...
                  vue.createVNode(_component_TaskStatus, {
                    ...
                    onClick: vue.unref(reset).groupSign
                  }, null, 8, ["status", "onClick"])
                ]),
                _: 1
              })
  ...
  const App = _export_sfc(_sfc_main$3, [["__scopeId", "data-v-1b4fc029"]]);
  ...
  const baseCss = ".blth-btn{z-index:1;padding:5px;margin-inline-start:5px;margin-left:15px;font-size:small;line-height:10px;color:#fff;cursor:pointer;background-color:#23ade5;border:none;border-radius:4px;box-shadow:0 0 2px #00000075}.blth-btn:hover{background-color:#1097cc}.blth-btn:hover:active{position:relative;top:1px;background-color:#0e86b6}.el-message-box ul,ol{padding-left:1em!important}.el-message-box ul{list-style:initial!important}.el-message-box ol{list-style:decimal!important}@media screen and (width >= 1930px){html[lab-style*=adaptive] .base{zoom:.9375}}@media screen and (width >= 2058px){html[lab-style*=adaptive] .base{zoom:.75}}@media screen and (width >= 2570px){html[lab-style*=adaptive] .base{zoom:calc(2 / 3)}}@media screen and (width >= 3210px){html[lab-style*=adaptive] .base{zoom:.5}}@media screen and (width >= 3850px){html[lab-style*=adaptive] .base{zoom:.46875}}";
  importCSS(baseCss);
