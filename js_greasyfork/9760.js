...
// @downloadURL https://update.greasyfork.org/scripts/9760/RatingR2-sezon41.user.js
// @updateURL https://update.greasyfork.org/scripts/9760/RatingR2-sezon41.meta.js
// ==/UserScript==
...
if (location.href.indexOf("/players/") != -1){
	...
	function seasonTI (playerID, gettr, SI) {
		...
		if (wage == 27000 || wage == 30000 || (playerID > 106267903 && count == 0)) {	// S40 player ID  
			sitd.innerHTML = "---";
		}
		else {
		...
		if (((wage > 27000 && wage != 30000 && playerID > 105990513) || (wage > 30000 && playerID > 107058866)) && age < ageMax) {	//  player ID 
			wage_rate = 23.75*0.9;
			if (playerID > 107058866) wage_rate = 23.75;
