...
// @description  RT
// @author       Pidanmeng
// @match        https://uigradients.com/*
// @require      http://code.jquery.com/jquery-1.11.0.min.js
// @include      https://uigradients.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/40570/uiGradientsPro.user.js
// @updateURL https://update.greasyfork.org/scripts/40570/uiGradientsPro.meta.js
// ==/UserScript==
...
(function ($) {
    ...
    var changeOp=function(val){var op=1-val/100;$('.display').css('opacity',op);};

    var b = document.createElement('div');
	b.setAttribute('class', 'actionbar__section');
    b.innerHTML='<span style="display:inline-block">Blend with bg:</span><input type="range" style="vertical-align:middle;" max="100" min="0" value="0" ">';
    b.oninput=function(val){val=$('input')[1].value; var op=1-val/100;$('.display').css('opacity',op);};
    $('.actionbar')[0].insertBefore(b, $('.actionbar__section')[3]);

    var c = document.createElement('div');
	c.setAttribute('class', 'actionbar__section');
    c.innerHTML='<span style="display:inline-block">hue rotate:</span><input type="range" style="vertical-align:middle;" max="360" min="0" value="0" ">';
    c.oninput=function(val){val=$('input')[0].value; var hue='hue-rotate('+val+'deg)';$('.display').css('filter',hue);};
    $('.actionbar')[0].insertBefore(c, $('.actionbar__section')[3]);
