...
// @match        *://agma.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/391142/Miracle%20Scripts.user.js
// @updateURL https://update.greasyfork.org/scripts/391142/Miracle%20Scripts.meta.js
// ==/UserScript==
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.miracleScripts = {
    ...
    news: 'Thanks for still using Miracle Script! This script is now more than 5 years old and has almost 60000 downloads. Thanks everyone 🤗',
...
63: 'Elf hat',
    ...
    config: function() {
      ...
      if (settings.showNewsFeed) {
            let defaultNews = 'NEWS:1. Pickpocket fixed. 2. Goldblock available again. 3. +Other fixes)';
            let newsElement = document.querySelector('#cnt_panel .navbar p.text-center');
            if (newsElement.innerText.indexOf(defaultNews) > 0) {
                newsElement.style.marginBottom = '20px';
                newsElement.style.padding = '10px';
                newsElement.style.backgroundColor = 'rgba(0, 0, 0, 0.5)';
                newsElement.innerHTML = self.news;

                const metaElement = document.createElement("div");
                metaElement.setAttribute('titel', "Powered by Miracle Script");
                metaElement.innerText = 'AGMA News';
                newsElement.parentNode.prepend(metaElement);
                metaElement.style.backgroundColor = '#B5B9C0';
                metaElement.style.color = 'black';
            }
      }
