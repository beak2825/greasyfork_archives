// ==UserScript==
// @name   🌱【免费版】乡村医生线上理论学习培训平台|新疆生产建设兵团卫生专业技术人员法律法规知识培训服务平台|不含秒过无人值守高级功能见收费版本
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.3
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、秒过、题库答题、全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.wentaionline.com/*
// @include    *://*.xjyxjyw.com/*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/512023/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E4%B9%A1%E6%9D%91%E5%8C%BB%E7%94%9F%E7%BA%BF%E4%B8%8A%E7%90%86%E8%AE%BA%E5%AD%A6%E4%B9%A0%E5%9F%B9%E8%AE%AD%E5%B9%B3%E5%8F%B0%7C%E6%96%B0%E7%96%86%E7%94%9F%E4%BA%A7%E5%BB%BA%E8%AE%BE%E5%85%B5%E5%9B%A2%E5%8D%AB%E7%94%9F%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E6%B3%95%E5%BE%8B%E6%B3%95%E8%A7%84%E7%9F%A5%E8%AF%86%E5%9F%B9%E8%AE%AD%E6%9C%8D%E5%8A%A1%E5%B9%B3%E5%8F%B0%7C%E4%B8%8D%E5%90%AB%E7%A7%92%E8%BF%87%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/512023/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E4%B9%A1%E6%9D%91%E5%8C%BB%E7%94%9F%E7%BA%BF%E4%B8%8A%E7%90%86%E8%AE%BA%E5%AD%A6%E4%B9%A0%E5%9F%B9%E8%AE%AD%E5%B9%B3%E5%8F%B0%7C%E6%96%B0%E7%96%86%E7%94%9F%E4%BA%A7%E5%BB%BA%E8%AE%BE%E5%85%B5%E5%9B%A2%E5%8D%AB%E7%94%9F%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E6%B3%95%E5%BE%8B%E6%B3%95%E8%A7%84%E7%9F%A5%E8%AF%86%E5%9F%B9%E8%AE%AD%E6%9C%8D%E5%8A%A1%E5%B9%B3%E5%8F%B0%7C%E4%B8%8D%E5%90%AB%E7%A7%92%E8%BF%87%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、秒过、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/xjbtfg/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("/flfg/a/tra/traCsTheory/play")) {
                plugMain.page_video();
            } else if (url.includes("/tra/traCsTheory/") && url.includes("?repage")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/traQuestion/paper")) {
                plugMain.showPaidContent(`免费版本不包含答题功能，如需使用请安装收费版本`);
            } else if (url.includes("/flfg/a/tra/traCsTheory/list")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            }
        ...
        async page_video() {
            ...
            await plugMain.waitOf((a) => $("#agree_btn").length > 0);
            await plugMain.waitTimeout(1000);
            var qio = unsafeWindow.localStorage.getItem(ll);
            if (unsafeWindow.questionIsOk || (qio != null && qio == 1)) {
                layer.msg("当前课程已经可以考试了");
                // plugMain.nextVideo(false);
                plugMain.confirmRun("3秒后进入考试").then((a) => {
                    $("#agree_btn").click();
                });
                return;
            }
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (config.mg == "1" && plugMain.getTotalTime() - plugMain.getCurTime() > 5) {
                        plugMain.pageData.waitTime = 5;
                        plugMain.setStep(-5);
                        return;
                    }
                    if ($(".pv-quality-btn").text().trim() != "流畅") {
                        $(`div[qt="流畅"]`).click();
                    }
                } catch (e) {
