...
// @grant       GM_setValue
// @grant       GM_getValue
// @description Hasan Supreme Bot
// @downloadURL https://update.greasyfork.org/scripts/33406/Hasan.user.js
// @updateURL https://update.greasyfork.org/scripts/33406/Hasan.meta.js
// ==/UserScript==
...
if (location.href.match(/shop/i)) {
	...
	$(".logo > a:nth-child(1)").after('<span id="settingsUsc">Change your credentials | Made By Hasan</span>');
