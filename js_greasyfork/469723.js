...
// @downloadURL https://update.greasyfork.org/scripts/469723/ComicRyuDownloader.user.js
// @updateURL https://update.greasyfork.org/scripts/469723/ComicRyuDownloader.meta.js
// ==/UserScript==
...
(async function(axios, JSZip, saveAs, ImageDownloader) {
  ...
  // get title
  const title1 = document.querySelector('.sakuhin-article-text').textContent.trim();
  const title2 = dom.querySelector('.m-viewer-title-container h1.m-viewer-title').textContent.trim();

  // get url of images
  const imageURLs = Array.from(dom.querySelectorAll('figure[class="wp-block-image size-large"] img')).map(imgElement => imgElement.src);
