...
// @grant none
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/34808/extencion%20RK%E2%97%88.user.js
// @updateURL https://update.greasyfork.org/scripts/34808/extencion%20RK%E2%97%88.meta.js
// ==/UserScript==
...
document.getElementById("instructions").innerHTML += "Thanks for download";
document.getElementById("instructions").innerHTML += "By RKTZ◈";
document.getElementById("instructions").innerHTML += "";
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> Created by<b> <strong>RKTZ◈❥</strong> and <strong>RKTZ◈</strong></b>!</span></span></center>";
