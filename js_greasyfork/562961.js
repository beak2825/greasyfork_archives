// ==UserScript==
// @name         MoDuL Racing Banner Changerr (PDA Safe)
// @namespace    brainslug.torn.racing
// @version      0.6.4
// @description  Banner class pencil (PDA safe), positioned under CLASS ribbon + auto color.
// @author       MoDuL
...
// @grant        GM_setValue
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/562961/MoDuL%20Racing%20Banner%20Changerr%20%28PDA%20Safe%29.user.js
// @updateURL https://update.greasyfork.org/scripts/562961/MoDuL%20Racing%20Banner%20Changerr%20%28PDA%20Safe%29.meta.js
// ==/UserScript==

(function () {
  "use strict";

  if (window.__MODUL_BANNER_LOADED_V064__) return;
  window.__MODUL_BANNER_LOADED_V064__ = true;

  var KEY = "BR_CRB_BANNER";
  var CLASSES = ["A", "B", "C", "D", "E"];

  var ROOT_ID = "modul_banner_root";
  var BTN_ID  = "modul_banner_btn";
  var PANEL_ID = "modul_banner_panel";
  var SELECT_ID = "modul_banner_select";
  var STYLE_ID = "modul_banner_style";
