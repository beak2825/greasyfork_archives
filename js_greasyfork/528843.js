...
// @downloadURL https://update.greasyfork.org/scripts/528843/%E8%B1%86%E7%93%A3-%E8%B5%84%E6%BA%90%E4%B8%8B%E8%BD%BD%E5%B7%A5%E5%85%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/528843/%E8%B1%86%E7%93%A3-%E8%B5%84%E6%BA%90%E4%B8%8B%E8%BD%BD%E5%B7%A5%E5%85%B7.meta.js
// ==/UserScript==
...
$(document).ready(function () {
    ...
    if (douban_id) {
        ...
        $("#content div.aside").prepend(`<div id='drdm_sites'></div>`);
        ...
        if (location.host === "movie.douban.com") {
            ...
            let yts_title = eng_title.replace(/[ ]/g,"-").toLowerCase()
...
<div class="rating_more" style="display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            site_map.push({
                name: "片源下载",
                label: [
                    { name: 'RARBG', link: 'https://rargb.to/torrents.php?search=' + ywm, selector: 'table.lista2t tr.lista2' },
                    { name: 'YTS', link: 'https://yts.mx/movies/' + yts_title.trim() + '-' + year.trim()},
                    { name: '   ', link: ' '},
                    { name: '🏴‍☠️海盗湾', link: 'https://thepiratebay.org/search.php?q=' + ywm + '&all=on&search=Pirate+Search&page=0&orderby=' },
                    { name: '迅雷影天堂', link: 'https://www.xl720.com/?s=' + unititle, selector: '#content h3.entry-title' },
//                    { name: 'WebHD', link: 'https://webhd.cc/search/' + unititle, selector: 'table.lista2t tr.lista2' },
//                    { name: 'TorGal', link: 'https://tgx.rs/torrents.php?search=' + jingzhun, selector: '#click' },
            ...
            if (!(is_mandarine) || (is_mandarine && is_otherlan)) {
                site_map.push({
                    name: "字幕和剧本",
                    label: [
                        { name: 'SubHD', link: 'https://subhd.tv/search/' + unititle, selector: ".position-relative .float-start" },
                        { name: '伪射手', link: 'http://assrt.net/sub/?searchword=' + unititle, selector: "#resultsdiv a.introtitle" },
                        { name: '   ', link: ' '},
                        { name: '英文剧本', link: 'https://subslikescript.com/search?q=' + eng_title_clean, selector: "table.tabel tr" },
                        { name: 'Addic7ed', link: 'http://www.addic7ed.com/srch.php?search=' + eng_title_clean + year, selector: "table.tabel tr" },
//                        { name: 'Subscene', link: 'https://subscene.com/subtitles/searchbytitle', selector: "div.search-result div.title", selector_need_login: "h1 span:contains('Checking your browser')" },
//                        { name: 'YIFY', link: 'https://ww2.yifysubtitles.ws/' + eng_title_clean, selector: "div.col-sm-12 div.col-xs-12" },
//                        { name: 'r3sub', link: 'https://r3sub.com/search.php?s=' + ywm, selector: "div.col-sm-8.col-md-9.col-lg-8 div.movie.movie--preview.ddd" },
//                        { name: 'OpenSub', link: 'https://www.opensubtitles.org/zh/search/sublanguageid-chi,zht,zhe,eng/imdbid-' + ywm, selector: "#search_results tr.change", selector_need_login: "#recaptcha2" },
                    ]
                });
            }
//            site_map.push({
            ...
            if (has_imdb) {
                site_map.push({
                    ...
                    label: [
                        ...
                        { name: 'PirateBay', link: 'https://piratebay.live/search/' + ywm, selector: '#searchResult div.detName' },
                    ]
                });
            }
