// ==UserScript==
// @name    FC | FoX Factory | A.Tramp
// @name:ru КФ | FoX Factory | A.Tramp
// @name:uk КФ | FoX Factory | A.Tramp
// @version 1.1
// @description  For installation help, suggestions for improvements and questions, please contact the current chief curator of the Family Forum.
// @description:ru За помощью с установкой, предложениями по улучшению и вопросами обращаться к действующему Главному Куратору Форума семьи.
// @description:uk За допомогою з установкою, пропозиціями щодо поліпшення і питаннями звертатися до діючого Головного Куратора Форуму семьи.
// @namespace https://whg22857.vkweb.su
// @match       https://whg22857.vkweb.su/index.php*
// @include      https://whg22857.vkweb.su/index.php
// @grant        none
// @license    MIT
// @supportURL https://vk.com/fabrika_lis
// @icon https://emoji.gg/assets/emoji/9372-blurple-boost-level-9.png
// @downloadURL https://update.greasyfork.org/scripts/494827/FC%20%7C%20FoX%20Factory%20%7C%20ATramp.user.js
// @updateURL https://update.greasyfork.org/scripts/494827/FC%20%7C%20FoX%20Factory%20%7C%20ATramp.meta.js
// ==/UserScript==
(function () {
  'use strict';
