// ==UserScript==
// @name         SilverHawkTheme (Shellshock.io)
// @namespace    http://tampermonkey.net/
// @version      0.42
// @description  Become a Hawk with my first theme
// @author       SilverHawk
...
// @grant        none
// @lisense MIT  none
// @downloadURL https://update.greasyfork.org/scripts/465990/SilverHawkTheme%20%28Shellshockio%29.user.js
// @updateURL https://update.greasyfork.org/scripts/465990/SilverHawkTheme%20%28Shellshockio%29.meta.js
// ==/UserScript==
...
* {
	...
	--ss-blue1: yellow;
	--ss-blue2: yellow;
	--ss-blue3: aqua; /*Lighter Box Borders*/
	...
	--ss-lightoverlay: url("https://cdn.discordapp.com/attachments/1104426900765548554/1104567960229658694/SilverHawkTheme.png");/*Main Background*/
    ...
    --ss-me-player-bg: url("https://cdn.discordapp.com/attachments/1104426900765548554/1106026081145860147/SilverHawkTheme_1.png")
}
...
#maskmiddle {
	background: url('https://cdn.discordapp.com/attachments/1104500998879334521/1104501127522811955/shs-custom-scope-02-back.png') center center no-repeat;
...
.playerSlot--icons .vip-egg {
  ...
  content: url('https://cdn.discordapp.com/attachments/1104500998879334521/1104501160544583780/vip.png') !important;
  max-height: 1.3em;
  max-width: 1.3em;
}
...
#best_streak_container h1 {
    ...
    background-image: url('https://cdn.discordapp.com/attachments/1104426900765548554/1104472684152246342/hw4498r_1.png');
...
#deathBox::before{
  font-size: 1.4em;
  font-weight: 900;
  content: 'YOU GOT PECKED BY'!important;
  color: yellow;
}
