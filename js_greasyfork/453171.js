// ==UserScript==
//
// @name         IMDb Scout Mod - CL Version
// @version      1.15
// @namespace    https://www.cinelounge.org
// @description  Fork d'IMDb Scout Mod pour CL
// @icon         https://www.cinelounge.org/images/logot.png
// @license      MIT
// @forkVersion  17.6.2
//
// @homepage     https://www.cinelounge.org/
//
// @compatible   firefox
// @compatible   opera
// @compatible   chrome
...
//
// @include      http://localhost/CLNG/Film/*
// @include      https://www.cinelounge.org/Film/*
//
...
// @noframes
//
// @downloadURL https://update.greasyfork.org/scripts/453171/IMDb%20Scout%20Mod%20-%20CL%20Version.user.js
// @updateURL https://update.greasyfork.org/scripts/453171/IMDb%20Scout%20Mod%20-%20CL%20Version.meta.js
// ==/UserScript==
//
/*=========================  IMDb Scout Mod Version History  ==================================
...
(function(root) {
    ...
    // Break CL code Cinélounge CineLounge
...
var public_sites = [
  ...
  {   'name': '1337x',
      ...
      'searchUrl': 'https://1337x.to/category-search/%search_string_orig%/Movies/1/',
      'matchRegex': /No results were returned/},
  {   'name': '1337x',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://1337x.to/category-search/%search_string_orig%/TV/1/',
      'matchRegex': /No results were returned/,
      'TV': true},
  {   'name': '3Dsbs4u',
      ...
      'both': true},
  {   'name': 'AllYouLike',
      'icon': 'https://www.allyoulike.com/wp-content/uploads/2019/10/cropped-AYLFaviconLogo-32x32.gif',
  ...
  {   'name': 'ArenaBG',
      ...
      'TV': true},
  {   'name': 'ATorrents',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://atorrents.com/search/%search_string%',
      'matchRegex': /class="magnet"/,
      'positiveMatch': true,
      'both': true},
  {   'name': 'AXEL torrents (BG)',
      'icon': 'data:image/ico;base64,',
  ...
  {   'name': 'CineCalidad',
      ...
      'both': true},
  {   'name': 'Comando4K',
      'icon': 'https://comandofilmes4khd.net//wp-content/themes/comando4ktorrents/images/favicon.ico',
      'searchUrl': 'https://comandofilmes4khd.net/?s=%tt%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
  ...
  {   'name': 'Hawkmenblues',
      ...
      'matchRegex': /Nothing Found/},
  {   'name': 'HD4fun',
      'icon': 'https://hd4fun.com/wp-includes/images/favicon.ico',
  ...
  {   'name': 'KZ',
      ...
      'TV': true},
  {   'name': 'Lapumia',
      'icon': 'https://lapumia.org/wp-content/themes/TDF/img/favicon-32x32.png',
      'searchUrl': 'https://lapumia.org/?s=%tt%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': /0 resultados/,
      'both': true},
  {   'name': 'LimeTor',
  ...
  {   'name': 'PSArips',
      ...
      'searchUrl': 'https://psa.pm/?s=%tt%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': /try another search/},
  {   'name': 'PSArips',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://psa.pm/?s=%search_string%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': /try another search/,
      'TV': true},
  {   'name': 'PuZo',
  ...
  {   'name': 'RareFilm',
      ...
      'both': true},
  {   'name': 'RareFilmm',
      'icon': 'https://rarefilmm.com/wp-content/uploads/2017/07/cropped-rrficon2-32x32.png',
  ...
  {   'name': 'RMZ',
      ...
      'searchUrl': 'https://rmz.cr/search/%search_string_orig%/titles/exact/m',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': /No movy available/},
  {   'name': 'RMZ',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://rmz.cr/search/%search_string_orig%/titles/exact/s',
      'loggedOutRegex': /Cloudflare|Ray ID/,
...
var private_sites = [
  ...
  {   'name': 'LM-5z',
      ...
      'both': true},
  {   'name': 'Locadora',
      'searchUrl': 'https://locadora.xyz/torrents?imdbId=%nott%',
      'loggedOutRegex': /Cloudflare|Esqueceu Sua Senha|Service Unavailable/,
      'matchRegex': /torrent-listings-no-result/,
      'both': true},
  {   'name': 'Locadora-Req',
      'searchUrl': 'https://locadora.xyz/requests?unfilled=1&tmdbId=%tmdbid%',
      'loggedOutRegex': /Cloudflare|Esqueceu Sua Senha|Service Unavailable/,
      'matchRegex': /label-danger/,
      'positiveMatch': true,
      'both': true},
...
var chinese_sites = [
  {   'name': 'BD-film',
      ...
      'searchUrl': 'https://www.bd2020.co/search.jspx?q=%tt%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': />0 条</,
      'both': true},
  {   'name': 'BT4G',
...
var french_sites = [
  ...
  {   'name': 'Cpasbien',
      ...
      'searchUrl': 'https://cpasbien.tw/search_torrent/films/%search_string%.html',
      'loggedOutRegex': /Cloudflare|Ray ID/,
  ...
  {   'name': 'HD-O-Req',
      ...
      'both': true},
  {   'name': 'LimitOfEden',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'http://www.limit-of-eden.com/wqreyt/wikis-search.php?search="%search_string_orig%"&incldead=0&freeleech=0&highspeed=0&lang=0&sort=id&order=desc&c4=1&c99=1&c104=1&c105=1&c48=1&c92=1&c95=1&c79=1&c1=1&c2=1&c55=1&c35=1&c84=1&c98=1&c93=1&c106=1&c100=1&c82=1&c47=1&c78=1&c94=1&c52=1&c28=1&c91=1&c90=1&c102=1&c101=1',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': /Aucun wiki trouvé/},
  {   'name': 'LimitOfEden',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'http://www.limit-of-eden.com/wqreyt/wikis-search.php?search="%search_string_orig%"&incldead=0&freeleech=0&highspeed=0&lang=0&sort=id&order=desc&c107=1&c51=1&c7=1&c6=1&c85=1&c89=1&c41=1&c5=1&c64=1&c28=1&c91=1&c90=1&c102=1&c101=1',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': /Aucun wiki trouvé/,
      'TV': true},
  {   'name': 'Sharewood',
  ...
  {   'name': 'TCTG',
      ...
      'TV': true},
  {   'name': 'Tor911',
      'icon': 'https://www.torrent911.cc/themes/default/img/favicon.ico',
      'searchUrl': 'https://www.torrent911.cc/recherche/%search_string_orig%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
  ...
  {   'name': 'YGG',
      ...
      'searchUrl': 'https://www5.yggtorrent.la/engine/search?name=%search_string_orig%&category=2145&sub_category=all&do=search',
      'loggedOutRegex': /Ray ID|security check to access/,
      'matchRegex': 'Aucun résultat',
      'both': true}
];
...
var german_sites = [
  ...
  {   'name': 'JME-Req',
      ...
      'both': true},
  {   'name': 'MaDsRevolution',
      'icon': 'https://madsrevolution.net/static/styles/public/favicon.ico',
...
var icon_sites_main = [
  ...
  {   'name': 'AlloCiné (FR)',
      ...
      'searchUrl': 'https://www.allocine.fr/rechercher/?q=%search_string%',
      'showByDefault': false},
  {   'name': 'Amazon',
  ...
  {   'name': 'Flick Metrix',
      ...
      'showByDefault': false},
  {   'name': 'Google',
      'searchUrl': 'https://www.google.com/search?q=%search_string%+%search_string_orig%'},
  {   'name': 'Google Scholar',
  ...
  {   'name': 'JustWatch',
      ...
      'searchUrl': 'https://www.justwatch.com/fr/recherche?q=%search_string%',
      'showByDefault': false},
  {   'name': 'КиноПоиск (RU)',
  ...
  {   'name': 'SensCritique (FR)',
      'searchUrl': 'https://www.senscritique.com/search?filters%5B0%5D%5Bidentifier%5D=universe&filters%5B0%5D%5Bvalue%5D=Films&query=%search_string%&size=16',
      'showByDefault': false},
  {   'name': 'Simkl',
  ...
  {   'name': 'Wikipedia',
      ...
      'searchUrl': 'https://fr.wikipedia.org/w/index.php?search=%search_string%&go=Go'},
  {   'name': 'Wikipedia Links Search',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://fr.wikipedia.org/w/index.php?target=https%3A%2F%2Fwww.imdb.com%2Ftitle%2F%tt%&title=Special%3ALinkSearch',
      'showByDefault': false},
  {   'name': 'WhatsOnMubi',
  ...
  {   'name': 'YouTube',
      ...
      'searchUrl': 'https://www.youtube.com/results?search_query="%search_string%"+trailer'}
];
...
function addLink(elem, site_name, target, site, state, scout_tick, post_data) {
  ...
  if (getPageSetting('use_mod_icons') && getPageSetting('call_http_mod')) {
    ...
    (!GM_config.get('one_line') && !onSearchPage) ? icon.css({'border-width': '0px',        'border-style': 'solid', 'border-radius': '6px', 'margin': '1px 0px 2px'})
                                                  : icon.css({'border-width': border_width, 'border-style': 'solid', 'border-radius': '6px', 'margin': '1px 0px 2px'});
    if (state == 'error' || state == 'logged_out') {
      (getPageSetting('highlight_sites').split(',').includes(site['name'])) ? icon.css('border-color', 'rgb(180,0,0)')
                                                                            : icon.css('border-color', 'rgb(180,0,0)');
    } else if (state == 'missing') {
      (getPageSetting('highlight_sites').split(',').includes(site['name'])) ? icon.css('border-color', 'rgb(230,200,100)')
                                                                            : icon.css('border-color', 'rgb(230,200,100)');
    } else if (state == 'found') {
      (getPageSetting('highlight_sites').split(',').includes(site['name'])) ? icon.css('border-color', 'rgb(60,190,250)')
                                                                            : icon.css('border-color', 'rgb(0,220,0)');
    ...
    icon = getFavicon(site);
    icon.css({'border-width': '0px', 'border-style': 'solid', 'border-radius': '6px', 'margin': '1px 0px 2px'});
    (getPageSetting('highlight_sites').split(',').includes(site['name'])) ? icon.css('border-color', 'rgb(60,190,250)')
                                                                            : icon.css('border-color', 'rgb(0,220,0)');
    if ((site['name']).match('-Req')) icon.css('border-color', 'rgb(50,50,200)');
    link.append(icon);
...
function displayButton() {
  var p = $('<span />').attr('id', 'imdbscout_button');
    p.append(' ');
  p.append($('<a><span class="btn-icon"><i class="fa fa-download text-deep-pink"></i> </span><span class="text-dark-gray text-small">Téléchargement et raccourcis&nbsp;</span></a>').addClass('btn-expand').click(function() {
    if (onSearchPage) {
      performSearch();
    } else {
      performPage();
  ...
  if (onSearchPage) {
    $('#sidebar').prepend(p);
  } else if ($('.IMDbAnchor').length) {
    $('.IMDbAnchor:eq(0)').append(p);
  // reference
...
function getIconsLinkArea() {
  ...
  var p = $('<div />').attr('id', 'imdbscout_iconsheader').css({
    'padding': pad,
    'padding': '4px 10px',
    'margin-top': '10px',
  ...
  p.append('<span class="text-13px">Raccourcis</span><br>');
  const hr = $('<hr />').css({'margin-top':'7px', 'margin-bottom':'7px', 'color':'#0d0d0d' });
  if ($('.ipc-page-section').length) {
    $('#ScoutLink:eq(0)').append(p);
  // reference
...
function getLinkArea() {
  ...
  var p = $('<div />').append(GM_config.get('imdbscoutmod_header_text')).attr('id', 'imdbscout_header').css({
    'padding': '4px 10px',
  ...
  p.addClass('text-center');
  p.append('<span class="text-13px">Téléchargement</span><br>');
  $.each(valid_states, function(i, name) {
...
async function buttonBuilder(imdbid, radarr_url, radarr_apikey) {
  ...
  button.prop("href", "http://localhost:7878/add/new?term=imdb%3A" + imdbid);
  if (exists) {
