...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/427918/Showdown%20Translation.user.js
// @updateURL https://update.greasyfork.org/scripts/427918/Showdown%20Translation.meta.js
// ==/UserScript==
var translations = {
    "OK": "确认",
    "Yes": "是",
    ...
    "New Box": "新的箱子",
    "search teams": "搜索队伍",
    "Yes, my day was pretty good": "是的，我今天过得很好",
    ...
    "Sp. Atk fell!": "的特攻下降了!",
    "Sp. Atk rose!": "的特攻提升了!",
    "Sp. Atk fell harshly!": "的特攻大幅下降了!",
    "Sp. Atk rose sharply!": "的特攻大幅提升了!",
    "Sp. Atk fell severely!": "的特攻巨幅下降了!",
    "Sp. Atk rose drastically!": "的特攻巨幅提升了!",
    "Sp. Def fell!": "的特防下降了!",
    "Sp. Def rose!": "的特防提升了!",
    "Sp. Def fell harshly!": "的特防大幅下降了!",
    "Sp. Def rose sharply!": "的特防大幅提升了!",
    "Sp. Def fell severely!": "的特防巨幅下降了!",
    "Sp. Def rose drastically!": "的特防巨幅提升了!",
    "Speed fell!": "的速度下降了!",
    "Speed rose!": "的速度提升了!",
...
var t = function (originalStr) {
    ...
    //     return "战斗机计时器已经开启：玩家若不行动则在时间耗尽后会输掉比赛。（由"+RegExp.$1+"发起）";
    // }
