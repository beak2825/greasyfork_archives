// ==UserScript==
// @name         Blacket Red Theme
// @version      1.0.0
// @description  Red theme for Blacket!
...
// @downloadURL https://update.greasyfork.org/scripts/538467/Blacket%20Red%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/538467/Blacket%20Red%20Theme.meta.js
// ==/UserScript==

(async () => {
    setTimeout(() => {
        console.log(
            "%c[blacket red theme] loaded!",
            "color: #fff; padding: 10px; border-radius: 5px; font-size: 20px; font-weight: bold; text-shadow: 0px 0px 10px #c41a1a;"
        );
    }, 1000);
