...
// @downloadURL https://update.greasyfork.org/scripts/471410/template-manager.user.js
// @updateURL https://update.greasyfork.org/scripts/471410/template-manager.meta.js
// ==/UserScript==
...
`;
    ...
    class Settings {
        ...
        populateToolsWrapper() {
          this.toolsWrapper.className = 'toolsWrapper';
