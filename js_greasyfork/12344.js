...
// @description  show SI and REREC in TM Player page
// @match      *trophymanager.com/players/
// @match      *trophymanager.com/players
// @require http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js
// @downloadURL https://update.greasyfork.org/scripts/12344/TM%20test.user.js
// @updateURL https://update.greasyfork.org/scripts/12344/TM%20test.meta.js
// ==/UserScript==
...
$(function(){
    ...
    $("[id^='filter_']").click(function(){
    	showSI();
                ...
                function showSI(){
        $("#sq th.name, #sq div.name").css("width", "200px");
        $("#sq div.position").css("width","90px");
        ...
        if($.browser.mozilla){
            $("#sq > table > tbody > tr:not(.header):not(:has(td.splitter))").each(function(){
                ...
                $(this).find("div.skill").each(function(){
                    ...
                    if(isNaN(skill)){
                    	skill = parseInt($(this).find("img").attr("star"));
                    }
                ...
                var si = parseInt(Math.pow((skills / 1), newPow) / newDiv);  
            ...
            $("#sq > table > tbody > tr:not(.header):not(:has(td.splitter))").each(function(){
                ...
                if(recSkills == 0){
                    ...
                    /*
                    if (recSkills2 == 0){
                		$(this).append("<div style='text-align:center;'>" + si + "<br />" + recSkills.toFixed(2).toString() + "</div>");
                    } else {
                        $(this).append("<div style='text-align:center;'>" + si + "<br />" + recSkills.toFixed(2).toString() + "| " + recSkills2.toFixed(2).toString() + "</div>");
                    }
                    */
                    
                    if (recSkills2 == 0){
                		$(this).append("<td style='text-align:center;'>" + si + "<br />" + recSkills.toFixed(2).toString() + "</td>");
                    } else {
                    	$(this).append("<td style='text-align:center;'>" + si + "<br />(1) " + recSkills.toFixed(2).toString() + "<br />(2) " + recSkills2.toFixed(2).toString() + "</div>");
                    }
                }
            });
        } else {
