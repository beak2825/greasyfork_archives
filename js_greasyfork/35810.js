// ==UserScript==
// @name         風
// @namespace    http://swordman-s1.yytou.com/?id=4278980&time=1512920545299&key=53d9dd1b6161f11b3be4769dfcd1aaf9&s_line=1&game_skin=2&arg=4277111
// @version      2.1
// @description  try to take over the world!
// @author       MARBO&jj
// @match        http://swordman-s1.yytou.com/?id=4278980&time=1512920545299&key=53d9dd1b6161f11b3be4769dfcd1aaf9&s_line=1&game_skin=2&arg=4277111
// @grant        http://swordman-s1.yytou.com/?id=4278980&time=1512920545299&key=53d9dd1b6161f11b3be4769dfcd1aaf9&s_line=1&game_skin=2&arg=4277111
// @downloadURL https://update.greasyfork.org/scripts/35810/%E9%A2%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/35810/%E9%A2%A8.meta.js
// ==/UserScript==
...
function BiShi2Func(){
    if(BiShi2Button.innerText  == '切小號'){
        var Swordsman2_targetName = prompt("請輸入小號名","鷹京泰場");
        fightSwordsman2Func();
	...
	// 小功能 ------------------------------------------------------------------------------------------------------
		...
		function qmj_addbtns2() {
		    if (ssssButton.innerText == '小功能'){
			    var aaa = ['悟性裝','寶箱3000','通靈','上香','打鳥','蓮花','冰月谷','突破丹禮包'];
			    var bbb = [];
...
var pozhaoInButton = document.createElement('button')
		...
		var zhaoshuLength = 0
		var dani = ['擊你','使出','揮舞','一式','面目','腳下一轉','縱身躍起', '直取你', '卷你', '對著你', '朝你', '向你', '往你', '纏繞上了你', '撲你', '將你', '往而你掃蕩而去', '你的破綻', '你的對攻無法擊破', '你這一招並未奏效', '你一不留神，招式被', '斬你', '對准你', '從你眼前晃過', '手中', '躍向半空', '狂喝一聲', '突然轉身', '深吸一口氣', '猛然斷喝', '怒提內力', '縱空飛離', '取你', '誓要你', '你面對這一劍竟然無可奈何', '你只好放棄', '取你', '將招式連成一片，令你眼花繚亂！ ']
		function killpozhao () {
