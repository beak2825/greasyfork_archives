// ==UserScript==
// @name        Reddit Infinite Scrollings
// @namespace   darkred
// @author      darkred
...
// @downloadURL https://update.greasyfork.org/scripts/28458/Reddit%20Infinite%20Scrollings.user.js
// @updateURL https://update.greasyfork.org/scripts/28458/Reddit%20Infinite%20Scrollings.meta.js
// ==/UserScript==
...
if (/(.*comments.*)/.test(document.location)) {
  $(window).scroll(function () {
    if ($(window).scrollTop() + $(window).height() > $(document).height() - 100) {
      // console.log('bottom!');
      var element = unsafeWindow.document.getElementsByClassName('morechomments');
