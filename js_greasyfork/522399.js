...
// @icon         https://i.postimg.cc/XvMd0sBh/f4d83f3055f0af4bf783190fb8527518.jpg
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/522399/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%20%D0%9A%D0%A4%20by%20Ensemble%20Mansory.user.js
// @updateURL https://update.greasyfork.org/scripts/522399/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%20%D0%9A%D0%A4%20by%20Ensemble%20Mansory.meta.js
// ==/UserScript==
...
const buttons = [
	{
	  ...
	  content:
		...
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Аа <br><br>"+
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
...
},
{
	  ...
	  content:
		...
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
        "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE][FONT=times new roman][Color=#ff0000]2.57.[/color] Запрещается брать в долг игровые ценности и не возвращать их. [Color=#ff0000]| Ban 30 дней / permban[/color].[/COLOR]<br><br>" +
        ...
        "[FONT=times new roman][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]при невозврате игровых ценностей общей стоимостью менее 5 миллионов включительно аккаунт будет заблокирован на 30 дней, если более 5 миллионов, аккаунт будет заблокирован навсегда;[/COLOR][/SIZE][/FONT][/CENTER]<br><br>"+
...
},
{
	  ...
	  content:
		...
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE][FONT=times new roman][Color=#ff0000]2.28.[/color] Запрещена покупка/продажа внутриигровой валюты в любых ее проявлениях за реальные деньги [Color=#ff0000]| PermBan с обнулением аккаунта + ЧС проекта[/color].[/COLOR]<br><br>"+
                "[FONT=times new roman][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]любые попытки покупки/продажи, попытки поинтересоваться о ней у другого игрока и прочее - наказуемы.[/COLOR][/SIZE][/FONT]<br>" +
                "[FONT=times new roman][SIZE=4][COLOR=rgb(255, 0, 0)]Исключение: [/COLOR][COLOR=rgb(209, 213, 216)]официальная покупка через сайт.[/COLOR][/SIZE][/FONT][/CENTER]<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE][FONT=times new roman][Color=#ff0000]2.32.[/color] Запрещено введение в заблуждение, обман администрации на всех ресурсах проекта [Color=#ff0000]| Ban 7 - 15 дней[/color].[/COLOR]<br><br>"+
                "[FONT=times new roman][SIZE=4][COLOR=rgb(255, 0, 0)]Пример: [/COLOR][COLOR=rgb(209, 213, 216)]подделка доказательств, искажение информации в свою пользу, оскорбление администрации в репорт, обвинение администраторов без доказательств и т.д.[/COLOR][/SIZE][/FONT][/CENTER]<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE][FONT=times new roman][Color=#ff0000]3.01.[/color] Общепризнанный язык сервера — русский. Общение в IC чатах во всех Role Play ситуациях обязательно должно проходить исключительно на русском языке [Color=#ff0000]| Устное замечание / Mute 30 минут[/color].[/COLOR][/CENTER]<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE][FONT=times new roman][Color=#ff0000]3.04.[/color] Запрещено оскорбление или косвенное упоминание родных вне зависимости от чата [Color=#ff0000]| Mute 120 минут / Ban 7 - 15 дней[/color].[/COLOR]<br><br>"+
                ...
                "[FONT=times new roman][SIZE=4][COLOR=rgb(255, 0, 0)]Исключение: [/COLOR][COLOR=rgb(209, 213, 216)]если упоминание родных было совершено в ходе Role Play процесса и не содержало в себе прямого или завуалированного оскорбления.[/COLOR][/SIZE][/FONT][/CENTER]<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE][FONT=times new roman][Color=#ff0000]3.10.[/color] Запрещена выдача себя за администратора, если таковым не являетесь [Color=#ff0000]| Ban 7 - 15 + ЧС администрации[/color].[/COLOR][/CENTER]<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба взята на [COLOR=#ffff00]рассмотрение [/COLOR][COLOR=#0000ff]Главному Куратору Форума[/COLOR][COLOR=WHITE], пожалуйста ожидайте ответа.<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
        prefix: PINN_PREFIX,
	  status: true,
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=#0000ff]Техническому специалисту[/COLOR], пожалуйста ожидайте ответа.<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
        prefix: TEXY_PREFIX,
	  status: true,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=#ff0000]Главному администратору[/COLOR],иногда рассмотрение подобных жалоб может занять более 2ух дней,убедительная просьба ожидать ответа. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
	  prefix: GA_PREFIX,
	  status: true,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Дублирование темы. Если вы дальше будете заниматься данной деятельностью (Дублирование тем),то ваш Форумный аккаунт будет заблокирован. <br><br>"+
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]В системе логирования не было обнаружено каких либо нарушений со стороны игрока. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=RED]Закрыто.[/COLOR][/CENTER]<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Ваша жалоба нарушает правила подачи жалоб на игроков. В жалобах запрещается: 2.1. нецензурная брань; 2.2. флуд; 2.3. неадекватное поведение; 2.4. обман администрации, клевета на администрацию; 2.5. сообщение от 3-его лица; 2.6. сообщения не по теме (Offtop).<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.3429394/']Правилами подачи жалоб на игроков *кликабельно*[/URL][/COLOR][/CENTER]<br><br>"+
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Ваща жалоба от 3-го лица. Жалоба должна быть составлена участником ситуации.<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=RED]Закрыто.[/COLOR][/CENTER]<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для Министерства Обороны:<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE][FONT=times new roman][Color=#ff0000]2.02.[/color] Наносить урон игрокам, которые находятся вне территории воинской части, запрещено [Color=#ff0000]| предупреждение (Warn) выдается только в случае Mass DM[/color].[/COLOR]<br><br>"+
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как нарушений со стороны данного игрока не было найдено. <br><br>"+
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR] так как Семейный слот - не является элементом рыночных отношений. Системно его передача, покупка напрямую другим игрокам не предусмотрена. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как доказательств на нарушение от данного игрока  недостаточно. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как доказательств на нарушение от данного игрока  отсутствуют. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как доказательств на нарушение от данного игрока  отредактированы. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как слив семьи никак не относится к правилам проекта, то есть если Лидер семьи дал игроку роль заместителя, то только он за это и отвечает, Администрация сервера не несет за это ответственность. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как ваша жалоба составлена не по форме. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как заголовок вашей жалобы составлен не по форме. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как на ваших доказательствах отсутствует /time.  <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как отсутствует time коды. Если видео длится больше 3-ех минут - Вы должны указать time коды нарушений. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как с момента совершенного нарушения со стороны игрока прошло более 72 часов. Срок написания жалобы составляет три дня (72 часа) с момента совершенного нарушения со стороны игрока сервера.<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как доказательства загружены в соц. сетях. Загрузка доказательств в соц. сети (ВКонтакте, instagram) запрещается, доказательства должны быть загружены на фото/видео хостинги (YouTube, Япикс, imgur). <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как в Ваших доказательствах отсутствуют условия сделки. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как доказательств недостаточно. В данной ситуации необходим фрапс(запись экрана). <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как нужен фрапс + промотка чата. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как видео-доказательство обрывается. Загрузите полную видеозапись на видео-хостинг YouTube. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как ваши доказательства не открываются. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как Ваша жалоба написана от 3-го лица. Жалоба от третьего лица не принимается (жалоба должна быть подана участником ситуации). <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как вы ошиблись сервером, перенаправляю  вашу жалобу на нужный сервер. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
...
},
{
...
},
  {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша RolePlay Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило - Биография скопирована/украдена. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
...
},
  {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило - Неправильное написание заголовка биографии. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
...
},
  {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило - Написание Биографии от 1-го лица. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
...
},
  {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило - Возраст не совпадает с датой рождения. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
...
},
  {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило - Возраст слишком мал. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
...
},
  {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило написание биографии не по форме подачи.<br><br>"+
        "[FONT=times new roman][SIZE=4]Пожалуйста, для более оперативного рассмотрения вашей биографии создайте новую тему, заполнив данную форму:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4][QUOTE]Имя Фамилия:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Пол:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Национальность:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Возраст:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Дата и место рождения:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Семья:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Место текущего проживания:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Описание внешности:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Особенности характера:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Детство:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Юность и взрослая жизнь:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Настоящее время:[CENTER]<br>"+
        "[FONT=times new roman][SIZE=4]Хобби:[/QUOTE][CENTER]<br>"+
        "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
},
  {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило большое количество ошибок. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
...
},
 {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило - у вас nRP Nick_Name <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
 ...
 },
 {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило большое количество пунктуационных ошибок. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
