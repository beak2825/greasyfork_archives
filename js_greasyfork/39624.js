...
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/39624/Moore%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/39624/Moore%20script.meta.js
// ==/UserScript==

$(document).ready(function() {
    if(!$('p:contains("Search the web to get the web domain name for the given company")').eq(0).text().trim()) return;
//Hides stuff
...
//Grabs company name
    ...
    console.log(company);
    $('input.form-control').val(company);
    var links = ["","",""];
...
//Creates website buttons + autofills box
            ...
            //document.getElementById(".form-control").val = links[0];
             $('input.form-control').val(links[0]);
            ...
            $('#b2').click(function(){
                $('input.form-control').val(links[1]);
                document.querySelector(`[type="submit"]`).click();
            });
            $('#b3').click(function(){
                $('input.form-control').val(links[2]);
                document.querySelector(`[type="submit"]`).click();
            });
