// ==UserScript==
// @name         Slay.one Aimbot
// @namespace    https://greasyfork.org/en/users/662330-zertalious
// @version      0.0.4
// @description  Aimbot and ESP for slay.one. Locks the aim to the nearest player and shows lines between nearby players. Removes ceilings from buildings and let's you see inside them too.
// @author       ESB (Heroe)
// @match        *://slay.one/beta/
// @match        *://slay.one/
// @license MIT
...
// @antifeature  ads
// @downloadURL https://update.greasyfork.org/scripts/462646/Slayone%20Aimbot.user.js
// @updateURL https://update.greasyfork.org/scripts/462646/Slayone%20Aimbot.meta.js
// ==/UserScript==
