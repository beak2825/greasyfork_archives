...
// @name         B站合集弹幕下载
// @version      0.3
// @description  1.下载B站合集弹幕 2.在页面左侧添加了合并合集弹幕功能
// @author       DeltaFlyer
// @copyright    2022, DeltaFlyer(https://github.com/DeltaFlyerW)
// @license      MIT
...
// @downloadURL https://update.greasyfork.org/scripts/473025/B%E7%AB%99%E5%90%88%E9%9B%86%E5%BC%B9%E5%B9%95%E4%B8%8B%E8%BD%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/473025/B%E7%AB%99%E5%90%88%E9%9B%86%E5%BC%B9%E5%B9%95%E4%B8%8B%E8%BD%BD.meta.js
// ==/UserScript==
...
Object.defineProperty(window, 'webpackJsonpwebpackLogReporter', {
    get() {
        return null
    },
    set(v) {
...
// Define a new Object.defineProperty method with the hook
Object.defineProperty = function (obj, prop, descriptor) {
    // Check if the property being defined is 'onerror'
    if (prop === 'onerror') {
        throw new Error("Cannot define 'onerror' property.");
    }

    // Call the original Object.defineProperty method
...
async function xhrGet(url) {
    try {
        ...
        const response = await fetch(url, {
            method: 'GET',
            credentials: 'include', // To include credentials (cookies) in the request
        });
...
let [allDanmaku, allProtobufDanmu, danmuObject2XML] = (function () {
    !function (z) {
        var y = {
            1: [function (p, w) {
                ...
                h.encode = function (e, d, a) {
                    ...
                    return q && (k[l++] = m[b], k[l++] = 61, 1 === q && (k[l++] = 61)), c ? (l && c.push(String.fromCharCode.apply(String, k.slice(0, l))),
                        c.join("")) : String.fromCharCode.apply(String, k.slice(0, l))
                };
                ...
                function h(a) {
                    return "undefined" != typeof Float32Array ? function () {
                        ...
                        function c(k, l, q) {
                            ...
                            l = q >>> 23 & 255;
                            q &= 8388607;
                            return 255 === l ? q ? NaN : 1 / 0 * k : 0 === l ?
                                1.401298464324817E-45 * k * q : k * Math.pow(2, l - 150) * (q + 8388608)
                        }
                        ...
                        function k(v, g) {
                            return f[0] = v[g], f[1] = v[g +
                            1], f[2] = v[g + 2], f[3] = v[g + 3], f[4] = v[g + 4], f[5] = v[g + 5], f[6] = v[g + 6], f[7] = v[g + 7], q[0]
                        }
                        ...
                        function b(k, l, q, f, u, v) {
                            var g = 0 > f ? 1 : 0;
                            if (g && (f = -f), 0 === f) k(0, u, v + l), k(0 < 1 / f ? 0 : 2147483648, u, v + q); else if (isNaN(f)) k(0, u, v + l), k(2146959360,
                                u, v + q); else if (1.7976931348623157E308 < f) k(0, u, v + l), k((g << 31 | 2146435072) >>> 0, u, v + q); else if (2.2250738585072014E-308 > f) k((f /= 4.9E-324) >>> 0, u, v + l), k((g << 31 | f / 4294967296) >>> 0, u, v + q); else {
                        ...
                        function c(k, l, q, f, u) {
                            ...
                            return 2047 === q ? l ? NaN : 1 / 0 * k : 0 === q ? 4.9E-324 * k * l : k * Math.pow(2,
                                q - 1075) * (l + 4503599627370496)
                        }
                ...
                function n() {
                    ...
                    if (!(4 < this.len - this.pos)) {
                        ...
                        return f.lo = (f.lo | (127 & this.buf[this.pos++]) <<
                            7 * u) >>> 0, f
                    }
                ...
                m.prototype.uint32 = (l = 4294967295, function () {
                    ...
                    if ((this.pos += 5) > this.len) throw this.pos =
                        this.len, h(this, 10);
                    return l
                });
                ...
                m.prototype["float"] = function () {
                    if (this.pos + 4 > this.len) throw h(this, 4);
                    var f = b["float"].readFloatLE(this.buf,
                        this.pos);
                    return this.pos += 4, f
                };
                ...
                w.exports = h;
                var m = p(15);
                ((h.prototype = Object.create(m.EventEmitter.prototype)).constructor = h).prototype.rpcCall = function k(e,
                                                                                                                         d, a, b, c) {
                ...
                h.prototype.toHash = function () {
                    return String.fromCharCode(255 & this.lo, this.lo >>> 8 & 255, this.lo >>> 16 & 255, this.lo >>> 24, 255 & this.hi, this.hi >>> 8 & 255, this.hi >>>
                        16 & 255, this.hi >>> 24)
                };
                ...
                h.oneOfSetter = function (e) {
                    return function (d) {
                        for (var a = 0; a < e.length; ++a) e[a] !== d &&
                        delete this[e[a]]
                    }
                };
                ...
                e.prototype["float"] = function (g) {
                    return this.e(l["float"].writeFloatLE,
                        4, g)
                };
                ...
                e.prototype.fork = function () {
                    return this.states =
                        new n(this), this.head = this.tail = new h(m, 0, 0), this.len = 0, this
                };
                ...
                e.prototype.finish = function () {
                    for (var g = this.head.next, t = this.constructor.alloc(this.len),
                             x = 0; g;) g.fn(g.val, t, x), x += g.len, g = g.next;
                    return t
                };
                e.n = function (g) {
                    k = g
                ...
                var a = d && d.prototype instanceof Uint8Array && "set" === d.prototype.set.name ? function (b, c, k) {
                    ...
                    if (b.copy) b.copy(c, k, 0, b.length); else for (var l =
                        0; l < b.length;) c[k++] = b[l++]
                };
                        ...
                        n.v1 = function () {
                            ...
                            e.DmWebViewReply = function () {
                                ...
                                d.encode = function (a, b) {
                                    ...
                                    null != a.flag &&
                                    Object.hasOwnProperty.call(a, "flag") && p.bilibili.community.service.dm.v1.DanmakuFlagConfig.encode(a.flag, b.uint32(42).fork()).ldelim();
                                ...
                                d.toObject = function (a, b) {
                                    ...
                                    null != a.dmSge && a.hasOwnProperty("dmSge") && (c.dmSge = p.bilibili.community.service.dm.v1.DmSegConfig.toObject(a.dmSge,
                                        b));
                            ...
                            e.DmSegConfig = function () {
                                ...
                                d.prototype.pageSize =
                                    r.Long ? r.Long.fromBits(0, 0, !1) : 0;
                                ...
                                d.decode = function (a, b) {
                                    a instanceof y || (a = y.create(a));
                                    for (var c = void 0 === b ? a.len : a.pos + b,
                                             k = new p.bilibili.community.service.dm.v1.DmSegConfig; a.pos < c;) {
                                        var l = a.uint32();
                                        switch (l >>> 3) {
                                            case 1:
                                                k.pageSize = a.int64();
                                ...
                                d.verify = function (a) {
                                    return "object" !== typeof a || null === a ? "object expected" : null == a.pageSize || !a.hasOwnProperty("pageSize") || r.isInteger(a.pageSize) || a.pageSize && r.isInteger(a.pageSize.low) && r.isInteger(a.pageSize.high) ?
                                        null == a.total || !a.hasOwnProperty("total") || r.isInteger(a.total) || a.total && r.isInteger(a.total.low) && r.isInteger(a.total.high) ? null : "total: integer|Long expected" : "pageSize: integer|Long expected"
                                };
                                d.fromObject = function (a) {
                                    ...
                                    null != a.pageSize && (r.Long ? (b.pageSize = r.Long.fromValue(a.pageSize)).unsigned = !1 : "string" === typeof a.pageSize ? b.pageSize = parseInt(a.pageSize, 10) : "number" ===
                                    typeof a.pageSize ? b.pageSize = a.pageSize : "object" === typeof a.pageSize && (b.pageSize = (new r.LongBits(a.pageSize.low >>> 0, a.pageSize.high >>> 0)).toNumber()));
                                ...
                                d.toObject = function (a, b) {
                                    ...
                                    null != a.pageSize && a.hasOwnProperty("pageSize") && (c.pageSize = "number" === typeof a.pageSize ? b.longs === String ? String(a.pageSize) : a.pageSize : b.longs === String ? r.Long.prototype.toString.call(a.pageSize) : b.longs === Number ? (new r.LongBits(a.pageSize.low >>>
                                        0, a.pageSize.high >>> 0)).toNumber() : a.pageSize);
                            ...
                            e.DanmakuFlagConfig = function () {
                                function d(a) {
                                    if (a) for (var b = Object.keys(a), c = 0; c <
                                    b.length; ++c) null != a[b[c]] && (this[b[c]] = a[b[c]])
                                }
                                ...
                                d.verify = function (a) {
                                    ...
                                    null === a ? "object expected" : null != a.recFlag && a.hasOwnProperty("recFlag") && !r.isInteger(a.recFlag) ? "recFlag: integer expected" : null != a.recText && a.hasOwnProperty("recText") && !r.isString(a.recText) ? "recText: string expected" : null != a.recSwitch && a.hasOwnProperty("recSwitch") && !r.isInteger(a.recSwitch) ? "recSwitch: integer expected" : null
                                };
                                d.fromObject = function (a) {
                                    ...
                                    null !=
                                    a.recFlag && (b.recFlag = a.recFlag | 0);
                            ...
                            e.DanmakuElem = function () {
                                ...
                                d.verify = function (a) {
                                    ...
                                    a.hasOwnProperty("idStr") && !r.isString(a.idStr) ? "idStr: string expected" : null : "ctime: integer|Long expected" : "id: integer|Long expected"
                                };
                                d.fromObject = function (a) {
                                    ...
                                    null != a.id && (r.Long ? (b.id = r.Long.fromValue(a.id)).unsigned = !1 : "string" === typeof a.id ? b.id = parseInt(a.id, 10) : "number" === typeof a.id ? b.id = a.id : "object" === typeof a.id && (b.id = (new r.LongBits(a.id.low >>> 0, a.id.high >>>
                                        0)).toNumber()));
                                    ...
                                    null != a.ctime && (r.Long ? (b.ctime = r.Long.fromValue(a.ctime)).unsigned = !1 : "string" === typeof a.ctime ? b.ctime = parseInt(a.ctime, 10) : "number" === typeof a.ctime ? b.ctime = a.ctime : "object" === typeof a.ctime && (b.ctime = (new r.LongBits(a.ctime.low >>>
                                        0, a.ctime.high >>> 0)).toNumber()));
                                ...
                                d.toObject = function (a, b) {
                                    ...
                                    if (b.defaults) {
                                        ...
                                        c.midHash = "";
                                        c.content = "";
                                        r.Long ? (k = new r.Long(0, 0, !1), c.ctime =
                                            b.longs === String ? k.toString() : b.longs === Number ? k.toNumber() : k) : c.ctime = b.longs === String ? "0" : 0;
                                        c.weight = 0;
                                        c.action = "";
                                        c.pool = 0;
                                        c.idStr = ""
                                    ...
                                    null !=
                                    a.fontsize && a.hasOwnProperty("fontsize") && (c.fontsize = a.fontsize);
                                    ...
                                    null != a.ctime && a.hasOwnProperty("ctime") && (c.ctime = "number" === typeof a.ctime ? b.longs === String ? String(a.ctime) : a.ctime : b.longs === String ? r.Long.prototype.toString.call(a.ctime) : b.longs === Number ? (new r.LongBits(a.ctime.low >>> 0, a.ctime.high >>>
                                        0)).toNumber() : a.ctime);
    ...
    async function loadProtoDanmu(url, timeout = null, header = null) {
        let retry = 0;
        while (true) {
            try {
                const options = {
                ...
                if (response.status === 200) {
                    const lpdanmuBuffer = await response.arrayBuffer();
                    let lpdanmu = proto_seg.decode(new Uint8Array(lpdanmuBuffer));
                    lpdanmu.elems.forEach((e) => {
                        if (!e.progress) e.progress = 0;
                    });
                    return lpdanmu.elems;
            ...
            if (retry > 5) break
            console.log('retry=', retry, ', sleep for ', time, ' s');
    ...
    function savedanmuStandalone(ldanmu, info = null) {
        ...
        if ((info !== null)) {
            head += '<info>' + htmlEscape(JSON.stringify(info)) + '</info>';
        }
    ...
    function danmuObject2XML(ldanmu) {
        for (let i = 0, length = ldanmu.length; i < length; i++) {
            let danmu = ldanmu[i]
            ldanmu[i] = `<d p="${(danmu.progress ? danmu.progress : 0) / 1000},${danmu.mode},${danmu.fontsize},${danmu.color},${danmu.ctime},${0},${danmu.midHash},${danmu.idStr}">${htmlEscape(danmu.content)}</d>`
        }
        return ldanmu
    }

    async function commentDanmu(cid) {
        let sdanmu = await xhrGet('https://comment.bilibili.com/' + cid + '.xml')
        let ndanmu = Number(/<maxlimit>(.*?)</.exec(sdanmu)[1])
        let ldanmu = xml2danmu(sdanmu)
        return [ldanmu, ndanmu]
    }

    async function moreHistory(cid, ndanmu) {
        let date = new Date();
        ...
        while (true) {
            ...
            if (firstdate === 0 || ldanmu.length >= ndanmu * 0.5) {
    ...
    async function allProtobufDanmuXml(cid, title, ndanmu) {
        let ldanmu = savedanmuStandalone(danmuObject2XML(allProtobufDanmu(cid, poolSize2Duration(ndanmu))))
        downloadFile(validateTitle(title) + '.xml', ldanmu)
    }

    return [
        async function allDanmaku(cid, duration) {
            let [ldanmu, ndanmu] = await commentDanmu(cid)
            if (ldanmu.length > ndanmu * 0.5 || duration > 5400) {
                let aldanmu = await moreHistory(cid, ndanmu)
                mergeDanmu(ldanmu, aldanmu)
            }
            return ldanmu
        },
        allProtobufDanmuXml,
...
async function readFiles(fileInputElem) {
    ...
    const selectedFiles = fileInputElem.files;
    const fileContents = {};

    for (let i = 0; i < selectedFiles.length; i++) {
        const file = selectedFiles[i];
        fileContents[file.name] = await readFileAsText(file);
    }

    return fileContents;
}

function sortWindowsFileStyle(strList) {
    // Custom sorting function for Windows file style
    const compare = (a, b) => {
        // Check if both strings start with a number
...
function buildArchive(dirName, zipName, contentDict) {
    let zip = new JSZip();
    let folder = zip.folder(dirName)
    for (let file of Object.keys(contentDict)) {
        let content = contentDict[file]
    ...
    zip.generateAsync({
        ...
        downloadFile(zipName + '.zip', content);
    });
}

async function downloadCompilation(callback) {
    try {
        let i = 0
        let fileDict = {}
        for (let episode of window.__INITIAL_STATE__.sections[0]['episodes']) {
            let promise = sleep(1000)
            let title = episode.arc.title
            let duration = episode.arc.duration
            let cid = episode.cid
            let ldanmu = danmuObject2XML(await allDanmaku(cid, duration))
            await promise
            episode.duration = duration
            episode.title = title
            episode.episodeIndex = i
            i += 1
            callback(i)
            fileDict[episode.episodeIndex + ' ' + episode.title + '.xml'] = saveDanmuStandalone(ldanmu, episode)
        }
        buildArchive(window.__INITIAL_STATE__.sectionsInfo.title, window.__INITIAL_STATE__.sectionsInfo.title,
            fileDict)
        callback("下载完成")
    } catch (e) {
        console.error(e, e.stack)
...
async function mergeCollection(callback) {
    try {
        let i = 0
        let offset = 0
        let aldanmu = []
        for (let episode of window.__INITIAL_STATE__.sections[0]['episodes']) {
            ...
            let duration = episode.arc.duration
            let cid = episode.cid
            let ldanmu = await allDanmaku(cid, duration)
            await promise
            episode.duration = duration
            episode.title = title
            episode.episodeIndex = i
            ...
            ldanmu.forEach((d) => {
                d.progress += offset * 1000
            })
            aldanmu = aldanmu.concat(ldanmu)
            offset += duration
        }
        downloadFile(window.__INITIAL_STATE__.sectionsInfo.title + '.xml',
            saveDanmuStandalone(danmuObject2XML(aldanmu), window.__INITIAL_STATE__.sections))
        callback("完成")
    } catch (e) {
        console.error(e, e.stack)
    }
...
async function downloadMultiPart(callback) {
    let aid = __INITIAL_STATE__.aid
    let response = await (fetch(`https://api.bilibili.com/x/player/pagelist?aid=${aid}&jsonp=jsonp`))
    let pageData = await response.json()
    let fileDict = {}
    for (let episode of pageData['data']) {
        let promise = sleep(1000)
        let title = episode.part
        let duration = episode.duration
        let cid = episode.cid
        let ldanmu = danmuObject2XML(await allDanmaku(cid, duration))
        episode.title = title
        episode.episodeIndex = episode.page
        callback(episode.title)
        fileDict[episode.episodeIndex + ' ' + episode.title + '.xml'] = saveDanmuStandalone(ldanmu, episode)
        await promise
    }
    let videoTitle = "av" + aid + ' ' + __INITIAL_STATE__.videoData.title
    buildArchive(videoTitle, videoTitle, fileDict)
    callback("下载完成")
}

async function mergeMultiPart(callback) {
    let aid = __INITIAL_STATE__.aid
    let response = await (fetch(`https://api.bilibili.com/x/player/pagelist?aid=${aid}&jsonp=jsonp`))
    let pageData = await response.json()
    let fileDict = {}
    ...
    for (let episode of pageData['data']) {
        ...
        episode.episodeIndex = episode.page
        callback(episode.title)
        ldanmu.forEach(d => d.progress += offset * 1000)
        offset += duration
        aldanmu = aldanmu.concat(ldanmu)
        await promise
    }
    let text = saveDanmuStandalone(danmuObject2XML(aldanmu),
        {videoData: __INITIAL_STATE__.videoData, pageData})
    let videoTitle = "av" + aid + ' ' + __INITIAL_STATE__.videoData.title
    downloadFile(videoTitle + '.xml', text)
    callback("下载完成")
}


function loadDanmuStandalone(fstr) {
    // Extract chatid using regular expression
    const cidMatch = fstr.match(/<chatid>(.*?)<\/chatid>/);
    const cid = cidMatch ? cidMatch[1] : null;

    // Extract list of danmu using regular expression
    const danmuList = fstr.match(/<d p=".*?<\/d>/g) || [];
    const ldanmu = danmuList.map((danmu) => danmu.trim());

    // Extract info using regular expression and JSON parsing
    const infoMatch = fstr.match(/<info>(.*?)<\/info>/);
    const info = infoMatch ? JSON.parse(xmlunEscape(infoMatch[1])) : {};

    return [ldanmu, cid, info];
}

function saveDanmuStandalone(ldanmu, info = null) {
    let head = `<?xml version="1.0" encoding="UTF-8"?><i><chatserver>chat.bilibili.com</chatserver><chatid>0</chatid>` +
        `<mission>0</mission><maxlimit>0</maxlimit>` +
        `<state>0</state><real_name>0</real_name><source>DF</source>`;
    const end = '</i>';
    ...
    if (info !== null) {
        ...
        head += `<info>${escapeXml(infoStr)}</info>`;
    }

    return head + ldanmu.join('') + end;
}

function findMaxCommonStart(strings) {
    if (!Array.isArray(strings) || strings.length === 0) {
        return '';
    }

    let maxCommonStart = strings[0];
    for (let i = 1; i < strings.length; i++) {
        const currentStr = strings[i];
        let j = 0;
        while (j < maxCommonStart.length && j < currentStr.length && maxCommonStart[j] === currentStr[j]) {
            j++;
        }
        maxCommonStart = maxCommonStart.slice(0, j);
    }

    return maxCommonStart;
}

async function onMergeFiles(fileInputElem) {
    let fileDict = await readFiles(fileInputElem)
    console.log(fileDict)
    let fileList = Object.keys(fileDict)
    fileList = sortWindowsFileStyle(fileList)
    let danmuList = []
    let offset = 0
    let info = {"files": []}
    let titles = []
    for (let file of fileList) {
        let result = loadDanmuStandalone(fileDict[file])
        console.log(result)
        for (let danmu of result[0]) {
            let end = danmu.indexOf(",")
            let pos = Number(danmu.slice(6, end))
            pos += offset
            danmuList.push("<d p=\"" + pos + danmu.slice(end))
        }
        offset += result[2].duration
        info.files.push([file, result[2]])
        titles.push(result[2].title)
    }
    let content = saveDanmuStandalone(danmuList, info)
    let fileName = findMaxCommonStart(titles)
    if (fileName.length === 0) {
        fileName = 'merge'
    }
    downloadFile(fileName + '.xml', content)
}
...
`
        ...
        return document.body.querySelector('[class="sidebar"]')
    }
...
`
    ...
    async function main() {
        ...
        let htmlText = `
                        <div title="拼接合集弹幕" class="dfex-merge"><i class="be-icon" style="--size:26px;">
                            <div class="custom-icon">
                               ` +
            `<svg  viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <title>merge-solid</title>
  <g id="Layer_2" data-name="Layer 2">
    ...
    (function mergeButton() {
        let button = sideBar.querySelector('[class="dfex-merge"]')

        function handle() {
            let html = `<label for="dfex-merge-input">请选择XML弹幕文件:</label>
<input type="file" accept="application/xml" id="dfex-merge-input" multiple>
<p  id="dfex-merge-result"></p>`
            let popup = popupWindow()

            popup.center.innerHTML = html
            let input = popup.center.querySelector('[id="dfex-merge-input"]')
            input.addEventListener('change', (event) => {
                ...
                reader.onload = async (event) => {
                    ...
                    popup.center.querySelector('[id="dfex-merge-result"]').textContent = '\n' + `从文件中读取到${ldanmu.length}条弹幕\n`
                };
                reader.readAsText(file);
            });

            let bottomHtml = `
                    <style>#dfex-merge-process {
                        position: absolute;
                        right: 8px;
                        bottom: 8px;
                        outline: none;
                    ...
                    <input type="button" value="合并合集弹幕" id="dfex-merge-process" title="按弹幕文件中的视频时长精确合并弹幕"/>
                    `

            popup.insertAdjacentHTML('beforeend', bottomHtml)
            popup.querySelector('[id="dfex-merge-process"]').addEventListener('click', (event) => {
                try {
                    onMergeFiles(input)
                } catch (e) {
                    console.error(e, e.stack)
...
async function main() {
    console.log("DownloadCompilationUtil running!!")
    let i = 0
    let elem = null
    await sleep(2000)
    while (true) {
        i += 1
        if (document.querySelector("#comment > div > div > div > div.reply-header > div > ul > li.nav-sort.hot > div.hot-sort") !== null) {
            elem = document.querySelector('.second-line_right')
            if (elem !== null) {
                console.log("elem", elem)
                elem.insertAdjacentHTML('beforebegin', elem.outerHTML + elem.outerHTML)
                let downloadButton = document.querySelectorAll('.second-line_right')[0]
                downloadButton.innerText = "下载弹幕"
                downloadButton.addEventListener("click", function () {
                    if (downloadButton.innerText === "下载弹幕") {
                        downloadButton.innerText = "下载中"
                        downloadCompilation(function (text) {
                            downloadButton.innerText = text
                        })
                    }
                })
                let mergeButton = document.querySelectorAll('.second-line_right')[1]
                mergeButton.innerText = "拼接"
                mergeButton.setAttribute("style", "width:40px")

                mergeButton.addEventListener("click", function () {
                    if (downloadButton.innerText === "下载弹幕") {
                        downloadButton.innerText = "下载中"

                        mergeCollection(function (text) {
                            downloadButton.innerText = text
                        })
                    }
                })
                await biliEvolvedPlugin()
            } else {
                let elem = document.querySelector("#multi_page > div.head-con > div.head-right")
                if (elem) {
                    elem.insertAdjacentHTML("afterbegin",
                        '<span class="next-button"><span class="txt">下载弹幕</span></span>' +
                        '<span class="next-button"><span class="txt">拼接</span></span>')
                    let downloadButton = elem.querySelectorAll(".next-button")[0]
                    downloadButton.addEventListener("click", function () {
                        if (downloadButton.innerText === "下载弹幕") {
                            downloadButton.innerText = "下载中"
                            downloadMultiPart(function (text) {
                                downloadButton.innerText = text
                            })
                        }
                    })
                    let mergeButton = elem.querySelectorAll(".next-button")[1]
                    mergeButton.addEventListener("click", function () {
                        if (downloadButton.innerText === "下载弹幕") {
                            downloadButton.innerText = "下载中"
                            mergeMultiPart(function (text) {
                                downloadButton.innerText = text
                            })
                        }
                    })
