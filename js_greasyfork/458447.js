...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/458447/BLACK%20RUSSIA%20GROZNY%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%A5%D0%97%D0%93%D0%A1%D0%A5%D0%A1%D0%A5.user.js
// @updateURL https://update.greasyfork.org/scripts/458447/BLACK%20RUSSIA%20GROZNY%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%A5%D0%97%D0%93%D0%A1%D0%A5%D0%A1%D0%A5.meta.js
// ==/UserScript==
    ...
    const buttons = [

        {
         ...
         `[COLOR=rgb(153, 204, 0)][B][FONT=times new roman][SIZE=4][I][U]ФОРМА ПОДАЧИ ЗАЯВЛЕНИЯ:[/U][/I][/SIZE][/FONT][/B][/COLOR]<br>`+
            ...
            `[SIZE=4][FONT=times new roman][B]Основной ЗГА —[URL='https://vk.com/id558869279']*КЛИК*[/URL][/FONT][/SIZE][/B]<br>`+
            `[SIZE=4][FONT=times new roman][B]Заместитель ГА — [URL='https://vk.com/id659131672']*КЛИК*[/URL][/B][/FONT][/SIZE]<br>`+
            `[SIZE=4][FONT=times new roman][B]Куратор Администрации — [URL='https://vk.com/id703924294']*КЛИК*[/URL][/B][/FONT][/SIZE]<br>`+
            `[SIZE=4][FONT=times new roman][B]Куратор Администрации — [URL='https://vk.com/id586726007']*КЛИК*[/URL][/B][/FONT][/SIZE]<br>`+
            `[SIZE=4][FONT=times new roman][B]Главный Следящий за АП — [URL='https://vk.com/id592217977']*КЛИК*[/URL][/B][/FONT][/SIZE]<br>`+
            `[SIZE=4][FONT=times new roman][B]Заместитель Главного Следящего за АП — [URL='https://vk.com/id615576235']*КЛИК*[/URL][/B][/FONT][/SIZE][/COLOR]<br>`+
            `    <br>`+
        ...
        },
        {
            ...
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[CENTER]Ваша заявка на дополнительные баллы [COLOR=lightgreen]одобрено[/color].[/I][/CENTER]`,
        },
        {
            title: `Доп. баллы отказано`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[CENTER]Ваша заявка на дополнительные баллы [COLOR=red]отказана[/color].[/I][/CENTER]`,
        },
        {
            title: `Отдых одобрено`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[CENTER]Ваша заявка на отдых [COLOR=lightgreen]одобрена[/color].[/I][/CENTER]`,
        },
        {
            title: `Отдых отказано`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[CENTER]Ваша заявка на отдых [COLOR=red]отказана[/color].[/I][/CENTER]`,
        },
        {
            title: `Обменник одобрено | Рулетка`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`+
            `[FONT=times new roman][COLOR=rgb(84, 172, 210)][SIZE=4][I]После прокрутки вам будет отправлен фрапс с результатами.[/I][/SIZE][/FONT][/COLOR][/CENTER]`,
        },
        {
            title: `Обменник отказано | Рулетка`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(209, 72, 65)]"отказано"[/COLOR].[/SIZE][/FONT]<br>`+
            `[FONT=times new roman][SIZE=4][COLOR=rgb(84, 172, 210)]У вас нету такого количества баллов для прокрутки.[/I][/COLOR][/SIZE][/FONT][/CENTER]`,
        },
        {
            title: `Обменник одобрено | Смена имени ФА`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`+
            `[SIZE=4][FONT=times new roman][COLOR=rgb(84, 172, 210)][I]Имя сменят в ближайшее время.[/COLOR][/FONT][/SIZE][/I][/CENTER]`,
        },
        {
            title: `Обменник отказано | Смена имени ФА`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(209, 72, 65)]"отказано"[/COLOR].[/SIZE][/FONT]<br>`+
            `[FONT=times new roman][SIZE=4][I][COLOR=rgb(84, 172, 210)]У вас нету такого количества баллов для смена имени ФА.[/I][/COLOR][/SIZE][/FONT][/CENTER]`,
        },
         {
            title: `Обменник одобрено | Смена статуса ФА`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`+
            `[SIZE=4][FONT=times new roman][COLOR=rgb(84, 172, 210)][I]Статус сменят в ближайшее время.[/COLOR][/FONT][/SIZE][/I][/CENTER]`,
        },
        {
            title: `Обменник отказано | Смена статуса ФА`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(209, 72, 65)]"отказано"[/COLOR].[/SIZE][/FONT]<br>`+
            `[FONT=times new roman][SIZE=4][COLOR=rgb(84, 172, 210)]У вас нету такого количества баллов для смена статуса ФА.[/I][/COLOR][/SIZE][/FONT][/CENTER]`,
        },
        {
            title: `Обменник одобрено | Смена имени игра`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`+
            `[COLOR=rgb(84, 172, 210)][SIZE=4][FONT=times new roman]Старшие Хелперы свяжутся с вами в ближайшее время.[/I][/FONT][/SIZE][/COLOR][/CENTER]`,
        },
        {
            title: `Обменник отказано | Смена имени игра`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(209, 72, 65)]"отказано"[/COLOR].[/SIZE][/FONT]<br>`+
            `[FONT=times new roman][SIZE=4][COLOR=rgb(84, 172, 210)]У вас нету такого количества баллов для смена имени в игре.[/I][/COLOR][/SIZE][/FONT][/CENTER]`,
        },
        {
            title: `Обменник | Ошибка темой`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(209, 72, 65)]"отказано"[/COLOR].[/SIZE][/FONT]<br>`+
            `[COLOR=rgb(84, 172, 210)][FONT=times new roman][SIZE=4]Наказания снимаются в данной теме - [URL='https://forum.blackrussia.online/index.php?threads/grozny-%D0%97%D0%B0%D1%8F%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0-%D1%81%D0%BD%D1%8F%D1%82%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.3975758/']*тык*[/URL][/I][/SIZE][/FONT][/COLOR][/CENTER]`,
        },
        {
            title: `Снятие преда | Одобрено`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`+
            `[COLOR=rgb(84, 172, 210)][SIZE=4][FONT=times new roman]Снял вам предупреждение за перенормы.[/I][/FONT][/SIZE][/COLOR][/CENTER]`,
        },
        {
            title: `Снятие преда баллы | Одобрено`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`+
            `[COLOR=rgb(84, 172, 210)][SIZE=4][FONT=times new roman]Снял вам предупреждение за баллы.[/I][/FONT][/SIZE][/COLOR][/CENTER]`,
        },
        {
        ...
        },
        {
            ...
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`+
            `[COLOR=rgb(84, 172, 210)][SIZE=4][FONT=times new roman]Снял вам выговор за перенормы.[/I][/FONT][/SIZE][/COLOR][/CENTER]`,
        },
        {
            title: `Снятие выга баллы | Одобрено`,
            content: `[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman][I]Доброго времени суток, уважаемый[/FONT][/COLOR] *ТЕГНУТЬ* [/SIZE]<br><br>` +
            `[FONT=times new roman][SIZE=4]Ваша заявка получает статус [COLOR=rgb(97, 189, 109)]"одобрено"[/COLOR].[/SIZE][/FONT]<br>`+
            `[COLOR=rgb(84, 172, 210)][SIZE=4][FONT=times new roman]Снял вам выговор за баллы.[/I][/FONT][/SIZE][/COLOR][/CENTER]`,
        },
        {
