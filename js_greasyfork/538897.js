// ==UserScript==
// @name                      【文库下载】你能看见多少我能下载多少&下载公开免费的PPT、PDF、DOC、TXT等文件
...
// @grant                     unsafeWindow
// @license                   Apache-2.0
// @website                   https://soujiaoben.org/#/pages/list/detail?id=486211&host=greasyfork
// @downloadURL https://update.greasyfork.org/scripts/538897/%E3%80%90%E6%96%87%E5%BA%93%E4%B8%8B%E8%BD%BD%E3%80%91%E4%BD%A0%E8%83%BD%E7%9C%8B%E8%A7%81%E5%A4%9A%E5%B0%91%E6%88%91%E8%83%BD%E4%B8%8B%E8%BD%BD%E5%A4%9A%E5%B0%91%E4%B8%8B%E8%BD%BD%E5%85%AC%E5%BC%80%E5%85%8D%E8%B4%B9%E7%9A%84PPT%E3%80%81PDF%E3%80%81DOC%E3%80%81TXT%E7%AD%89%E6%96%87%E4%BB%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/538897/%E3%80%90%E6%96%87%E5%BA%93%E4%B8%8B%E8%BD%BD%E3%80%91%E4%BD%A0%E8%83%BD%E7%9C%8B%E8%A7%81%E5%A4%9A%E5%B0%91%E6%88%91%E8%83%BD%E4%B8%8B%E8%BD%BD%E5%A4%9A%E5%B0%91%E4%B8%8B%E8%BD%BD%E5%85%AC%E5%BC%80%E5%85%8D%E8%B4%B9%E7%9A%84PPT%E3%80%81PDF%E3%80%81DOC%E3%80%81TXT%E7%AD%89%E6%96%87%E4%BB%B6.meta.js
// ==/UserScript==
...
(function() {
	...
	function generateRandomString() {
		...
		for (let i = 0; i < factor; i++) {
			result += characters.charAt(Math.floor(Math.random() * charactersLength)) + "_";
		}
		return result;
	}
	...
	unsafeWindow.setTimeout = function(callback, delay, ...args) {
		...
		if (toStr && (toStr.includes('revokeObjectURL') || toStr.includes('el.style.display'))) return true;
	...
	class Utility {
		...
		gui(boxs) {
			const box = this.createEl(prefix + boxId, 'p');
			for (let x in boxs) {
				let item = boxs[x];
				if (!item.id) continue;
