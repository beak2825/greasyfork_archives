...
// @description The Lifeboat News - add-on to improve the usability of the board 
// @include     http://members5.boardhost.com/xxxxx/
// @include     http://members5.boardhost.com/xxxxx/index*
// @include     http://members5.boardhost.com/xxxxx/thread*
// @include     http://members5.boardhost.com/xxxxx/msg*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @downloadURL https://update.greasyfork.org/scripts/16576/xxxxx.user.js
// @updateURL https://update.greasyfork.org/scripts/16576/xxxxx.meta.js
// ==/UserScript==
...
var indexPage = (url == "http://members5.boardhost.com/xxxxx/" || url.substr(0,41) == "http://members5.boardhost.com/xxxxx/index");
var threadPage = (url.substr(0,42) == "http://members5.boardhost.com/xxxxx/thread");
var msgPage = (url.substr(0,39) == "http://members5.boardhost.com/xxxxx/msg");
...
$(document).ready(function() { 
  ...
  '<p><b>xxxxx script v4.2 options</b> | <a href="http://thinkingoutquiet.wordpress.com/mlmb-add-on/" target="_blank">see website for details</a></p><hr>' +
