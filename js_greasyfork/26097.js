...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/26097/IP%20Hunter%20by%20Yaj%20of%20VPN5.user.js
// @updateURL https://update.greasyfork.org/scripts/26097/IP%20Hunter%20by%20Yaj%20of%20VPN5.meta.js
// ==/UserScript==
        ...
        t("Scanning..."), getAjaxData("api/monitoring/status", function(a) {
            ...
            if ("response" == o.type) {
                ...
                i && "" !== i ? (console.info("Current IP: ", i), t("Current IP: " + i), s.split(";").forEach(function(e, a) {
                    !i.startsWith(e) || i.startsWith("10.116") && i.startsWith("100.116") || (r = !0, t("Matched with pattern: " + e)), a + 1 === s.split(";").length && (r ? (t("IP (" + i + ") is valid."), t("Edited by: Yaj of VPN5"), t("Hunting successful connect to VPN5 now!!")) : (t("Reconnecting..."), n()))
                })) : setTimeout(function() {
                    e()
                }, 3e3)
            }
