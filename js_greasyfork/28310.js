...
// @downloadURL https://update.greasyfork.org/scripts/28310/Hybrid%20-%20Calls%20-%20Contact%202218.user.js
// @updateURL https://update.greasyfork.org/scripts/28310/Hybrid%20-%20Calls%20-%20Contact%202218.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Contact")').length) {
    ...
    createButton('DC',1,2,3,2,'Disconnected- this number is not in service. ');
    createButton('DC - Directory',1,2,3,2,'Disconnected - Directory assistance offered');
    createButton('DC - Fast Busy',1,2,3,2,'Disconnected - fast busy');
