// ==UserScript==
// @name         B站之神赵怡宁
// @namespace    https://h7ml.cn
// @version      99.99.99
// @description  B站首页显示赵怡宁专区！
// @author       h7ml <h7ml@qq.com>
// @match        https://www.bilibili.com/*
// @icon         https://h7ml.cn/logo.png
// @grant        GM_addStyle
// @grant        GM_setValue
// @grant        GM_getValue
// @license      MIT

// @downloadURL https://update.greasyfork.org/scripts/447242/B%E7%AB%99%E4%B9%8B%E7%A5%9E%E8%B5%B5%E6%80%A1%E5%AE%81.user.js
// @updateURL https://update.greasyfork.org/scripts/447242/B%E7%AB%99%E4%B9%8B%E7%A5%9E%E8%B5%B5%E6%80%A1%E5%AE%81.meta.js
// ==/UserScript==
;(function () {
  'use strict'
  GM_addStyle()
  ...
  const USERS = [
    {
      key_words: '赵怡宁',
      channel_id: 363612830,
      avatar:
        'https://i2.hdslb.com/bfs/face/8c4d71cdacb8a2cc111711d4b3ce6be8f060a0a0.jpg@240w_240h_1c_1s.webp',
    },
  ]
  ...
  <div class="bili-video-card__wrap __scale-wrap"><a href="//www.bilibili.com/video/${
    item.bvid
  }" target="_blank"
        ...
        <div class="bili-video-card__mask">
          <div class="bili-video-card__stats">
            <div class="bili-video-card__stats--left"><span class="bili-video-card__stats--item"><svg
                ...
                </svg><span class="bili-video-card__stats--text">${bigNumber(
                  item.play
                )}</span></span><span
                class="bili-video-card__stats--item"><svg class="bili-video-card__stats--icon">
                  <use xlink:href="#widget-video-danmaku"></use>
                </svg><span class="bili-video-card__stats--text">${
                  item.comment
                }</span></span></div><span
              class="bili-video-card__stats__duration">${timeFormat(
                item.length
              )}</span>
          </div>
        </div>
    ...
    <div class="bili-video-card__info __scale-disable">
      <div class="bili-video-card__info--right">
        <h3 class="bili-video-card__info--tit" title="${title}"><a href="//www.bilibili.com/video/${
        item.bvid
      }"
        ...
        <div class="bili-video-card__info--bottom">
          <a class="bili-video-card__info--owner" href="//space.bilibili.com/${
            ...
            </svg><span class="bili-video-card__info--author">${
              item.author
            }</span><span
            class="bili-video-card__info--date">· ${timeago(
              item.created
            )}</span></a>
        </div>
      </div>
  ...
  <div class="variety-area">
    <div class="area-header">
      <div class="left"><a id="${USERS[currentUserIndex].key_words}" class="the-world area-anchor" data-id="6"></a>
        ...
        <a class="title" href="https://space.bilibili.com/${USERS[currentUserIndex].channel_id}/video"
