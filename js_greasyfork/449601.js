...
// @downloadURL https://update.greasyfork.org/scripts/449601/PEPE%20SCRIPT.user.js
// @updateURL https://update.greasyfork.org/scripts/449601/PEPE%20SCRIPT.meta.js
// ==/UserScript==
let AUTHOR = "PEPE"
...
document.getElementById('linksContainer2').innerHTML = ' PEPE ' ;
document.getElementById('gameName').innerHTML = '🐸PEPE MOD🐸';
document.getElementById('loadingText').innerHTML = ' PEPE LOADING🐸 '
document.getElementById('diedText').innerHTML = "frogs u satisfied";
document.getElementById('diedText').style.color = "#33FF33";
document.title = ' PEPE🐸 ';
document.getElementById("leaderboard").append ('RAINBOW');
        ...
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 style="font-size: 17px;">PEPE MOD MENU🐸 </h2>
                </div>
