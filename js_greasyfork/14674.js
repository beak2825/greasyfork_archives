// ==UserScript==
// @name                WME Validator Virginia Localization 2
// @version             0.2.6
...
// @downloadURL https://update.greasyfork.org/scripts/14674/WME%20Validator%20Virginia%20Localization%202.user.js
// @updateURL https://update.greasyfork.org/scripts/14674/WME%20Validator%20Virginia%20Localization%202.meta.js
// ==/UserScript==
//

/*
 * 0.2.6 - update to new WME format
 */
...
window.WME_Validator_United_States = {
  ...
  ".author": "subs5",
  ".updated": "2017-04-8",
  ".link": "https://greasyfork.org/en/scripts/6859-wme-validator-virginia-localization-2",
/*
...
*/
  ...
  "129.params": {
    ...
    "regexp": "/Virginia:.*(?:State Hwy |State Rd |State Rte |VA |VA- |VA Hwy |VA-Hwy |Co Rd |V A |SH-)(?:[1-5]{0,1}[1-9]{0,2})#/i"
  },
  "129.solutionLink": "W:Virginia#Major_roads",
  ...
  "135.title": "Not VA State",
  "135.problem.en": "The segment matched custom conditions",
  "135.problem": "Incorrect State Name - State name should be Virginia (are you in Virginia?)",
  ...
  "136.params": {
    ...
    "problemEN": "All primary routes numbered < 600 and 785 and 895 named SR-### in Virginia",
  ...
  "136.title": "Wrong name on Virginia Primary Route",
  "136.problem.en": "The segment matched custom conditions",
  "136.problem": "All primary routes numbered < 600 and 785 and 895 named SR-### in Virginia",
  "136.solution.en": "Solve the issue",
  "136.solution": "Change name to SR-###",
  "137.enabled": true,
  "137.params": {
    "titleEN": "Wrong name on Virginia Secondary Route",
    "problemEN": "All primary routes numbered > 600 NOT 785 and 895 named VA-### in Virginia",
    "solutionEN": "Change name to VA-###",
    "template": "${state}:##${street}##${altStreet[0]}##${altStreet[1]}##${altStreet[2]}##${altStreet[3]}##${altStreet[4]}##${altStreet[5]}##${altStreet[6]}##${altStreet[7]}##${altStreet[8]}##${altStreet[9]}",
    "regexp": "/^Virginia:.*(?:State Hwy |State Rd |State Rte |SR |SR- |VA Hwy |Co Rd |VA-Hwy |V A |SH-)(?:(?:[6-9][1-9]{2,})|(?:[1-9]{4,}))#/i"
  },
  "137.solutionLink": "W:Virginia#Roads",
  "137.title.en": "Custom check",
  "137.title": "Wrong name on Virginia Secondary Route",
  "137.problem.en": "The segment matched custom conditions",
  "137.problem": "All primary routes numbered > 600 NOT 785 and 895 named VA-### in Virginia",
  "137.solution.en": "Solve the issue",
  "137.solution": "Change name to VA-###",
  "139.enabled": true,
  "139.params": {
