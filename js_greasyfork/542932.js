// ==UserScript==
// @name         Mousehunt Draconic Depths Script (Cypher)
// @namespace    http://tampermonkey.net/
// @version      0.13
// @description  Autobot for Mousehunt Draconic Depths
// @author       Cypher
// @match        https://www.mousehuntgame.com/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=mousehuntgame.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/542932/Mousehunt%20Draconic%20Depths%20Script%20%28Cypher%29.user.js
// @updateURL https://update.greasyfork.org/scripts/542932/Mousehunt%20Draconic%20Depths%20Script%20%28Cypher%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    setInterval(async function(){
        ...
        if (title && title.textContent == "Crucible Forge") {
            const fireCheeseNum = Number(document.querySelector('button[title="Fiery Fontina Cheese"]').textContent)
            const iceCheeseNum = Number(document.querySelector('button[title="Icy Isabirra Cheese"]').textContent)
            const poisonCheeseNum = Number(document.querySelector('button[title="Poisonous Provolone Cheese"]').textContent)
            ...
            //Cavern Selection Logic based on minimum cheese
            let minCheese = Math.min(fireCheeseNum, iceCheeseNum, poisonCheeseNum)

            //Cavern Selection Logic based on most droids present
            ...
            */
            ...
            } else if (iceCheeseNum === minCheese) {
                rerollType = 'ice';
                while (true) {
            ...
            } else if (fireCheeseNum === minCheese) {
                rerollType = 'fire';
                while (maxLength != 3) {
        ...
        if (document.querySelector('.draconicDepthsCavernView__cavernName').textContent.includes('Abyssal')){
            ...
            else if (cavernName.includes('Flame')) {
                if (!fireCheese.classList.contains('active')) {
                    fireCheese.click();
                }
            }
        ...
        //In Cavern Elemental Run
        if (document.querySelector('.draconicDepthsCavernView__cavernName').textContent.includes('Elemental')){
