...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/36266/LoultFarm.user.js
// @updateURL https://update.greasyfork.org/scripts/36266/LoultFarm.meta.js
// ==/UserScript==
...
if( jsonObject.users[i].params.you === true) {
    ...
    if (jsonObject.users[i].params.name=="Skelenox" ) { console.log("défoncé") ; }
