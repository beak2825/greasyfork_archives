...
// @author      finally
// @downloadURL https://update.greasyfork.org/scripts/534098/Faction%20Wall%20Battlestats.user.js
// @updateURL https://update.greasyfork.org/scripts/534098/Faction%20Wall%20Battlestats.meta.js
// ==/UserScript==
...
function updateHospTimers(){
	for (let i = 0, n = hospNodes.length; i < n; i++) {
        ...
        if (totalSeconds <= 600)
            node.textContent = `Â«${hours.toString().padLeft(2, "0")}:${minutes.toString().padLeft(2, "0")}:${seconds.toString().padLeft(2, "0")}Â»`;
        else
