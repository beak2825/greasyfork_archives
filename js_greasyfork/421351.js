...
// @downloadURL https://update.greasyfork.org/scripts/421351/%E5%B0%8F%E9%91%AB%E4%BD%9C%E4%B8%9A%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/421351/%E5%B0%8F%E9%91%AB%E4%BD%9C%E4%B8%9A%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
"use strict";
const VERSION = "5.3.4"
...
if (window.Noty === undefined) {
	jsl.push(loadJs('https://files.yxm.pl/noty_3.2.0.min.js'))
	count += 1
}
if (window.Vue === undefined) {
	jsl.push(loadJs('https://files.yxm.pl/vue_2_6_14.min.js'))
	count += 1
}
if (window.moment === undefined) {
	jsl.push(loadJs('https://files.yxm.pl/moment_2.29.4_with-locales.min.js'))
	count += 1
}
if (window.jQuery === undefined || count === 3) jsl.push(loadJs('https://files.yxm.pl/jquery_3.5.1.min.js'))
if (window.Viewer === undefined) jsl.push(loadJs('https://files.yxm.pl/viewerjs_1.11.1.min.js'))
Promise.allSettled(jsl).then(main)
function main() {
	fetchWithCache('https://files.yxm.pl/noty_3.2.0.css').then(res => res.text()).then(res => {
		addGlobalStyle(res)
	})
	fetchWithCache('https://files.yxm.pl/viewerjs_1.11.1.min.css').then(res => res.text()).then(res => {
		addGlobalStyle(res)
	})
  ...
  margin: auto;
	...
	fetch('https://xkhelper.youxam.com/script.user.js').then(res => res.text()).then(res => {
