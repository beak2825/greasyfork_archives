...
// @match *://*/*
// @downloadURL https://update.greasyfork.org/scripts/419363/%E5%85%A8%E5%B1%80%E5%BE%AE%E8%BD%AF%E9%9B%85%E9%BB%91.user.js
// @updateURL https://update.greasyfork.org/scripts/419363/%E5%85%A8%E5%B1%80%E5%BE%AE%E8%BD%AF%E9%9B%85%E9%BB%91.meta.js
// ==/UserScript==
...
body {
  font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', '方正兰亭黑_GB18030',
    '方正兰亭黑_GBK', system-ui, ui-sans-serif, sans-serif, 'Apple Color Emoji',
...
html:lang(ja) body {
  font-family: 'Yu Gothic UI', 'Yu Gothic', system-ui, ui-sans-serif, sans-serif,
...
html:lang(ko) body {
  font-family: 'Malgun Gothic', system-ui, ui-sans-serif, sans-serif,
    'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji',
    emoji;
}
html:lang(ko) pre {
...
if ((location.hostname === "baidu.com" || location.hostname.endsWith(".baidu.com")) || new RegExp("^(?:https://www\\.baidu\\.com/(s|#)?.*)\$").test(location.href)) {
  css += `
    * {
      font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', '方正兰亭黑_GB18030',
        '方正兰亭黑_GBK', system-ui, ui-sans-serif, sans-serif,
