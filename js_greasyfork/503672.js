...
// @name:uk КФ | VLADIMIR  |
// @version 2.6
// @description  For installation help, suggestions for improvements and questions, please contact the current chief curator of the server forum.
// @description:ru За помощью с установкой, предложениями по улучшению и вопросами обращаться к действующему Главному Куратору Форума сервера.
// @description:uk За допомогою з установкою, пропозиціями щодо поліпшення і питаннями звертатися до діючого Головного Куратора Форуму сервера.
...
// @downloadURL https://update.greasyfork.org/scripts/503672/FC%20%7C%20VLADIMIR%20%20%7C.user.js
// @updateURL https://update.greasyfork.org/scripts/503672/FC%20%7C%20VLADIMIR%20%20%7C.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(255, 198, 180)][SIZE=4][FONT=courier new]Vladimir(78)[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new][/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
    ...
    },
    {
      ...
      content:
        ...
        "Причиной отказа могло послужить какое-либо нарушение из [URL='https://forum.blackrussia.online/threads/vladimir-%D0%A4%D0%BE%D1%80%D0%BC%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9543079/'][Color=Red][U]Правил написания RP биографий[/U][/color][/URL].[/I][/CENTER][/FONT]",
    ...
    },
    {
      ...
      content:
        ...
        "С формой подачи Вы можете ознакомиться здесь - [URL='https://forum.blackrussia.online/threads/vladimir-%D0%A4%D0%BE%D1%80%D0%BC%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9543079/'][Color=Red][U]Правил написания RP биографий[/U][/color][/URL].[/I][/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
