...
// @version 0.2
// @description Специально для технического отдела
// @author absolute skywhywalker
...
// @downloadURL https://update.greasyfork.org/scripts/460466/Technical%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/460466/Technical%20Helper.meta.js
// ==/UserScript==
...
(function () {
	...
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]Ваша тема взята на рассмотрение, ожидайте ответ в ближайшее время<br>Часто рассмотрение темы может занять определенное время.<br>[CENTER]На рассмотрении[/CENTER][/FONT][/SIZE]',
		prefix: PIN_PREFIX,
		status: true,
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		"[CENTER]Ваша тема закреплена и ожидает вердикта Куратора Технических специалистов @Domenico DeMora<br>" +
		'[CENTER]<u>Создавать подобные темы не нужно</u>.<br>[CENTER]На рассмотрении[/CENTER][/FONT][/SIZE]',
		prefix: PIN_PREFIX,
		status: true,
	},
	{
	...
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]Произошла ошибка, будете разблокированы.[/CENTER]<br>'+
	...
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		"[CENTER]Проверив вашу историю наказаний, было принято решение о снижении срока блокировки аккаунта.<br>Будьте аккуратнее в следующие разы, ведь на встречу пойти мы врят-ли сможем.<br>" +
		'[CENTER][CENTER]Закрыто.[/CENTER][/FONT][/SIZE]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
	...
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		"[CENTER]После проверки доказательств и системы логирования вердикт:<br>[COLOR=rgb(65, 168, 95)][FONT=verdana]Игрок будет заблокирован[/FONT][/COLOR][/CENTER]<br><br>" +
		"[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]",
	},
	{
	...
	},
	{
		...
		'[CENTER]Отказано[/COLOR].[/FONT][/SIZE]',
		prefix: UNACCEPT_PREFIX,
		status: false,
	},
	{
	...
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]Если вы выставили свои вещи на аукцион а их никто не купил, то воспользуйтесь командой [COLOR=rgb(251, 160, 38)]/reward[/COLOR]<br> В случае отсутствии вещей там, приложите скриншоты с + /time в новой теме<br>[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
	...
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		"[CENTER]Вы получили наказание от администратора своего сервера.<br> Для его снижения/обжалования обратитесь в раздел<br><<Обжалования>> вашего сервера.<br>Форма подачи темы - [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-заявки-на-обжалование-наказания.3429398/']тык[/URL]" +
		'[[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
		...
		"[CENTER]📹 Включение продемонстрировано на видео: https://youtu.be/Wft0j69b9dk<br>[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]",
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]Если вы были кикнуты из игры за "Подозрительное ПО"<br>Это могло произойти по одной из причин:<br><b>Вы полностью не остановились на метке для разгрузки/загрузки на работе дальнобойщика</b><br>При стрельбе вы постоянно нажимали на кнопку стрельбы.<br>Старайтесь избегать данных действий.<br>[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
	...
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]В скором времени будете выпущены, ожидайте.[/CENTER][/FONT][/SIZE]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
	...
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]Ваша тема не относится к технической проблеме, если вы хотите предложить изменения в игровом моде - обратитесь в раздел <br> [URL="https://forum.blackrussia.online/index.php?categories/Предложения-по-улучшению.656/"] Предложения по улучшению → нажмите сюда[/URL].<br>[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]' ,
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER] Для активации какой либо прошивки необходимо поставить все детали данного типа "SPORT" "SPORT+" и т.п.<br>[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
		...
		content:
		'[SIZE=4][FONT=Trebuchet MS][CENTER]Доброе время суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		"[CENTER]Если вы хотите изменить статус на форуме или Имя, то обратитесь в данную тему - [URL='https://forum.blackrussia.online/index.php?threads/Смена-имени-статуса-форумного-аккаунта-lime.4083573/\']клик[/URL]<br>[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]",
		prefix: CLOSE_PREFIX,
		status: false,
	},
{
