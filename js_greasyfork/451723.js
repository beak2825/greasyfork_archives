...
// @downloadURL https://update.greasyfork.org/scripts/451723/%E5%A4%A7%E9%BA%A6%E6%8A%A2%E7%A5%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/451723/%E5%A4%A7%E9%BA%A6%E6%8A%A2%E7%A5%A8.meta.js
// ==/UserScript==
// @license MIT
...
function detail_ui() {
    ...
    var $wx = $(`<div id="wx" class="notice"><p>陈鸿宇fighting！ </p><p>版本： ${version}</p></div>`);
...
function detail_seat_ui() {
    ...
    var $wx = $(`<div id="wx" class="notice">陈鸿宇fighting </p><p>版本： ${version}</p></div>`);
    var $number_input = $('<div class="input_wrapper" id="number_input_wrapper">请输入人数：<input id="number_input" type="number" value="1" min="1" max="6"></div>');
    var $start_btn = $('<button id="start_btn">开始抢票</button>');
    var $end_btn = $('<button id="end_btn">停止抢票</button>');
    var $notice = $('<div id="notice" class="notice"><h3>使用步骤</h3><p>1.登录，填写购票人信息</p><p>2.选择场次->价格->填写人数</p><p>3.点击‘开始抢票’</p></div>');
