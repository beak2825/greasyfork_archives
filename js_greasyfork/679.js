...
// @description Protect page with code, and add confirmation boxes to quickcues
// @namespace   dnk-tms
// @include     http://10.86.210.8:9000/tms/*
// @version     1.8.18
// @downloadURL https://update.greasyfork.org/scripts/679/BlockTMS%20%20Confirm%20Cue.user.js
// @updateURL https://update.greasyfork.org/scripts/679/BlockTMS%20%20Confirm%20Cue.meta.js
// ==/UserScript==
...
document.onkeypress=function(e){
	...
	if(keypresslevel==0){
		if(e.charCode==49)keypresslevel=1;
		else keypresslevel=0;}
	else if(keypresslevel==1){
		if(e.charCode==54)keypresslevel=2;
		else keypresslevel=0;}
	else if(keypresslevel==2){
		if(e.charCode==56)keypresslevel=3;
		else keypresslevel=0;}
