...
(() => {
    ...
    const cdn = 'https://cdnjs.cloudflare.com/ajax/libs/prism/1.30.0';
    const resoruces = {
    ...
    const cssAdd = () =>`
        ...
        --token-color-atrule: #700d0d;
        --token-stylus-selector: #1373bb;
        --token-stylus-variable: #0d10cd;
        --token-stylus-unit: #d1939e;
        }
        ...
        --token-color-atrule: #cc66ce;
        --token-stylus-selector: #96c7ec;
        --token-stylus-variable: #fff;
        --token-stylus-unit: #cfb9d7;
        ...
        .language-stylus .token.variable {
            color: #0d10cd;
            color: var(--token-stylus-variable);
        }

        .language-stylus .token.selector{
            color: #1373bb;
            color: var(--token-stylus-selector);
        }
        ...
        code.language-stylus .token.atrule, 
        code.language-stylus .token.attr-value, 
        code.language-stylus .token.keyword,
        code.language-stylus .token.punctuation,
        code.language-stylus .token.function {
            color: #700d0d;
        ...
        code.language-stylus .property-declaration .operator {
            color: inherit;
        }

        code.language-stylus .token.unit {
            color: var(--token-stylus-unit);
        }
