...
// @grant        GM_addStyle
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/454853/cdsn%E6%A0%87%E9%A2%98%E4%BC%98%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/454853/cdsn%E6%A0%87%E9%A2%98%E4%BC%98%E5%8C%96.meta.js
// ==/UserScript==
...
(function() {
	...
	window.onload = function(){
			...
			if(url.indexOf('csdn') != -1){
                //流量券
				GM_addStyle('.is-traffic-bubblebox {display:none !important}');
				//右侧广告
				GM_addStyle('.tip-box {display:none !important}');
				//小红点
				GM_addStyle('.toolbar-msg-count {display:none !important}');
				GM_addStyle('#asideWriteGuide {display:none !important}');
				
				GM_addStyle('#tool-QRcode {display:none !important}');
				GM_addStyle('#is-traffic {display:none !important}');
				GM_addStyle('.activity-swiper-box-act {display:none !important}');
