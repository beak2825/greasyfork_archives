// ==UserScript==
// @name        Youtube Downloader - Uses MyVid.download
// @namespace   https://distillvideo.com/
// @version     1.4
// @date        2018-9-26
// @description Yes I DID steal the code from https://greasyfork.org/en/scripts/372599-the-best-youtube-downloader-download-video-mp4-avi-mp3-hd-1080p-2k-4k-8k-2018/code , this website loads way faster. Download any video and music (audio) from Youtube.
// @author      not me
// @copyright   2018, DistillVideo.com
// @homepage    https://myvid.download
...
// @match      none
// @downloadURL https://update.greasyfork.org/scripts/392239/Youtube%20Downloader%20-%20Uses%20MyViddownload.user.js
// @updateURL https://update.greasyfork.org/scripts/392239/Youtube%20Downloader%20-%20Uses%20MyViddownload.meta.js
// ==/UserScript==
...
function AddhtmlDV() {
    if (document.getElementById("watch7-subscription-container")) {
        ...
        button += "<a href=\"https://myvid.download/?url=" + window.location.href + "\" title=\"Download this video\" target=\"_blank\"" +
...
function Addytpolymer() {
    ...
    addButton.href = "https://myvid.download/?url=" + window.location.href;
