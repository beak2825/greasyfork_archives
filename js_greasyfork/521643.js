// ==UserScript==
// @name   🌱【免费版】甘肃药师网-专业科目|如需自动下一集、自动换课程、等高级功能见收费版本：https://doc.zhanyc.cn/pages/gsysw/
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/521643/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E7%94%98%E8%82%83%E8%8D%AF%E5%B8%88%E7%BD%91-%E4%B8%93%E4%B8%9A%E7%A7%91%E7%9B%AE%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesgsysw.user.js
// @updateURL https://update.greasyfork.org/scripts/521643/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E7%94%98%E8%82%83%E8%8D%AF%E5%B8%88%E7%BD%91-%E4%B8%93%E4%B8%9A%E7%A7%91%E7%9B%AE%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesgsysw.meta.js
// ==/UserScript==
(function () {
    let $jq = $;
    unsafeWindow.$jq = $;
    ...
    let docUrl = "https://doc.zhanyc.cn/pages/gsysw/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("/admin/adminkc.aspx")) {
                plugMain.page_list();
        ...
        async page_list() {
            ...
            await plugMain.waitOf((a) => $(`a[href^="javascript:play"]`).length > 0);
            let $el = null;

            let curId = -1
            $(`a[href^="javascript:play"]`).each((i, el) => {
                let href = $(el).attr('href')
                let arr = href.replace(/'/g, '').split(',')
                let id = arr[1]
                if ($el == null) {
                    curId = id
                    $el = $(el);
            ...
            if ($el == null) {
                plugMain.confirmRun("3秒后前往公需课").then(a => {
                    $(`img[src$="/images/gxk.png"]`).parent()[0].click()
                })
                return;
            }
            ...
            plugMain.confirmRun("3秒后执行下一步", 3000).then((a) => {
                eval($el.attr('href'));
                plugMain.pageData.curVideoId = curId
