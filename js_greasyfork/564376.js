// ==UserScript==
// @name         Black Russia CHIEF Scirpt Enhanced
// @namespace    https://forum.blackrussia.online/
// @version      3.2.0
// @description  Скрипт для Руководства сервера | Black Russia с AI проверкой обжалований
...
// @downloadURL https://update.greasyfork.org/scripts/564376/Black%20Russia%20CHIEF%20Scirpt%20Enhanced.user.js
// @updateURL https://update.greasyfork.org/scripts/564376/Black%20Russia%20CHIEF%20Scirpt%20Enhanced.meta.js
// ==/UserScript==
...
(function () {
    ...
    const CONTACT_INFO = '\n\n[CENTER][SIZE=3][COLOR=#FF6B6B]Связь со мной VK - https://vk.com/id496891901[/COLOR][/SIZE][/CENTER]';

    const buttons = [
        {
            title: 'Приветствие',
            content: '[SIZE=4][FONT=courier new][CENTER]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' + '[CENTER] [/CENTER][/FONT][/SIZE]' + CONTACT_INFO,
        },
        {
            ...
            content: '[SIZE=4][FONT=courier new][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER]Приятной игры на нашем сервере.[/CENTER][/FONT][/SIZE]' + CONTACT_INFO,
            prefix: PIN_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=courier new][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER]Отказано, закрыто.[/CENTER][/FONT][/SIZE]' + CONTACT_INFO,
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=courier new][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER]Приятной игры на нашем сервере.[/CENTER]<br><br>' +
                     '[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]' + CONTACT_INFO,
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=courier new][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER]Приятной игры на нашем сервере.[/CENTER]<br><br>' +
                     '[CENTER]Отказано.[/CENTER][/FONT][/SIZE]' + CONTACT_INFO,
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=courier new][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER]Приятной игры на нашем сервере.[/CENTER]' + CONTACT_INFO,
            prefix: WATCHED_PREFIX,
            status: false,
        },
        {
        ...
        {
            title: 'Приветствие',
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' + '[CENTER]                       [/CENTER][/FONT][/SIZE]' + CONTACT_INFO,
        },
        {
            title: 'Отправить на рассмотрение',
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=Orange]Ожидайте ответа.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: PIN_PREFIX,
            status: true,
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=Red]Отказано, закрыто.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=Orange]Ожидаю вашего ответа.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: PIN_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     '[CENTER]Восстановите пароль через группу в ВК и пересоздайте жалобу. Также приложите скриншот из ВК, что вы изменили пароль, но не забудьте замазать сам пароль.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=Green]Одобрено.[/CENTER][/FONT][/SIZE][/color]<br><br>' + CONTACT_INFO,
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER] {{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=Red]Закрыто.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=#AEF359]Одобрено.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=green]Одобрено.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=Red]Отказано.[/CENTER][/FONT][/color][/SIZE]' + CONTACT_INFO,
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=Red]Отказано.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER]Вы должны прислать видео доказательство возврата имущества в данную тему.[/CENTER][/FONT][/SIZE]' + CONTACT_INFO,
            prefix: PIN_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
            ...
            content: '[SIZE=4][FONT=book antiqua][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br><br>' +
                     ...
                     '[CENTER][Color=#ED7014]Ожидайте ответа.[/CENTER][/FONT][/SIZE][/color]' + CONTACT_INFO,
            prefix: PIN_PREFIX,
            status: true,
        },
        {
    ...
    // Правила для проверки обжалований
    const appealRules = {
        requiredFields: [
            'Ваш Nick_Name:',
            'Nick_Name администратора:',
            'Дата выдачи/получения наказания:',
            'Суть заявки:',
            'Доказательство:'
        ],
        forbiddenKeywords: [
            'слив', 'продажа', 'махинации', 'багоюз', 'чит', 'читер', 'читы',
            'продам', 'куплю', 'передача аккаунта', 'bug', 'exploit'
        ],
        forbiddenViolations: [
            'различные формы "слива"',
            'продажа игровой валюты',
            'махинации',
            'целенаправленный багоюз',
            'продажа, передача аккаунта',
            'сокрытие ошибок, багов системы',
            'использование стороннего программного обеспечения',
            'распространение конфиденциальной информации',
            'обман администрации'
        ],
        titlePattern: /\|/,
        proofHosts: ['youtube.com', 'youtu.be', 'imgur.com', 'япикс', 'yapix', 'discord.com', 'discord.gg']
    };
    ...
    $(document).ready(() => {
        ...
        addButton('Проверить обжалование', 'checkAppeal');
        ...
        $('button#checkAppeal').click(() => checkAppealForm());
    ...
    // Функция для проверки обжалования
    function checkAppealForm() {
        const threadContent = $('.bbWrapper').text();
        const threadTitle = $('.p-title-value').text().trim();
        const errors = [];
        const warnings = [];
        
        // Проверка названия темы
        if (!appealRules.titlePattern.test(threadTitle)) {
            errors.push('Название темы должно содержать символ "|" (Пример: "Nick_Name | Массовый DM")');
        }
        
        // Проверка обязательных полей
        appealRules.requiredFields.forEach(field => {
            if (!threadContent.includes(field)) {
                errors.push(`Отсутствует обязательное поле: ${field}`);
            }
        });
        
        // Проверка на запрещенные нарушения
        appealRules.forbiddenViolations.forEach(violation => {
            if (threadContent.toLowerCase().includes(violation.toLowerCase())) {
                warnings.push(`Нарушение не подлежит обжалованию: ${violation}`);
            }
        });
        
        // Проверка запрещенных ключевых слов
        appealRules.forbiddenKeywords.forEach(keyword => {
            if (threadContent.toLowerCase().includes(keyword.toLowerCase())) {
                warnings.push(`Обнаружено подозрительное слово: ${keyword}`);
            }
        });
        
        // Проверка доказательств
        const hasProof = threadContent.includes('http://') || threadContent.includes('https://');
        if (!hasProof) {
            errors.push('Отсутствуют ссылки на доказательства');
        } else {
            let hasValidProof = false;
            appealRules.proofHosts.forEach(host => {
                if (threadContent.toLowerCase().includes(host.toLowerCase())) {
                    hasValidProof = true;
                }
            });
            if (!hasValidProof) {
                warnings.push('Доказательства могут быть загружены на неподходящий хостинг. Рекомендуется: YouTube, Япикс, Imgur');
            }
        }
        
        // Проверка на оскорбительную лексику
        const swearWords = ['идиот', 'дурак', 'тупой', 'мудак', 'сука', 'блять', 'пиздец', 'ахуеть'];
        swearWords.forEach(word => {
            if (threadContent.toLowerCase().includes(word)) {
                warnings.push('Обнаружена нецензурная лексика в тексте');
            }
        });
        
        // Создание отчета
        let report = '[SIZE=4][FONT=book antiqua][CENTER][B]АВТОМАТИЧЕСКАЯ ПРОВЕРКА ОБЖАЛОВАНИЯ[/B][/CENTER][/FONT][/SIZE]\n\n';
        
        if (errors.length > 0) {
            report += '[COLOR=#FF0000][B]КРИТИЧЕСКИЕ ОШИБКИ:[/B][/COLOR]\n';
        ...
        if (warnings.length > 0) {
            report += '[COLOR=#FFA500][B]ПРЕДУПРЕЖДЕНИЯ:[/B][/COLOR]\n';
        ...
        if (errors.length === 0 && warnings.length === 0) {
            report += '[COLOR=#00FF00][B]✓ Обжалование соответствует основным требованиям[/B][/COLOR]\n\n';
        }
        
        report += '[COLOR=#4169E1][B]РЕКОМЕНДАЦИИ:[/B][/COLOR]\n';
        report += '1. Проверьте наличие всех обязательных полей\n';
        report += '2. Убедитесь, что доказательства загружены на разрешенные хостинги\n';
        report += '3. Проверьте, не содержит ли нарушение запрещенные пункты правил\n';
        report += '4. Убедитесь, что тема оформлена корректно\n\n';
        
        report += CONTACT_INFO;
        
        // Вставка отчета в поле ответа
        if ($('.fr-element.fr-view p').text() === '') $('.fr-element.fr-view p').empty();
        $('span.fr-placeholder').empty();
        $('div.fr-element.fr-view p').append(report);
