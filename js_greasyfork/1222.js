...
// @author         Demin
// @namespace      Demin
// @description    Отображает стоимость боя и ОА в магазине и инфе арта, переплаты за покупку и аренду, добавляет быстрые ссылки на рынок (by Demin)
...
// @downloadURL https://update.greasyfork.org/scripts/1222/hwm_shop.user.js
// @updateURL https://update.greasyfork.org/scripts/1222/hwm_shop.meta.js
// ==/UserScript==
...
var script_name = "hwm_shop: Отображает стоимость боя и ОА в магазине и инфе арта, переплаты за покупку и аренду, добавляет быстрые ссылки на рынок (by Demin)";
...
var shop_hide_arts = GM_getValue( "92569_shop_hide_arts", '1' );
var shop_change_sections = GM_getValue( "92569_shop_change_sections", '1' );
...
var seard = "Cost:";
var shop = "buy on market";
var text0_title = 'Overpayment for buying art in the store (if you take the number to get the price of the plant), ie how much you can save if you walk around the map.';
var text1 = '<b>Cost per battle:</b> ';
var text1_title = 'Price for one fight (minimum when buying art from the factory).\nAP price (the minimum price for the fight).\n\nIn brackets (if any) - overpayment for one fight when buying in a store (if we get the numbers add up the cost of the battle when buying in a store), ie how much you overpay for 1 fight, buying art in the store.';
var text2 = '&nbsp;&nbsp;Overpay: per battle ';
var text2_title = 'Overpayment for rent on 1 battle and overpayment for the entire Prochko. In brackets - the percentage appreciation of the price for the fight, exceeding the cost of their own battle artifacts.';
var text3 = ' all durability ';

var s_text1 = 'Hide artifacts';
var s_text1_title = 'Collapses the arts in the store that are not ("Amount in stock: 0").\nClick on the field with the name of art hidden information unfolds.';
var s_text2 = 'Change sections';
var s_text2_title = 'Adds quick links menu:\n- artifact lease (transition in one click),\n- enchanted artifact lease (transition in one click).';
var s_author = 'Script author';
...
var seard = "\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C:";
var shop = "поиск на рынке";
var text0_title = 'Переплата за покупку арта в магазине (если числа отнять получим цену завода), т.е. сколько можно сэкономить если прогуляться по карте.';
var text1 = '<b>\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C 1 \u0431\u043E\u044F:</b> ';
var text1_title = 'Цена за 1 бой (минимальная, при покупке арта с завода).\nЦена ОА (от минимальной цены за бой).\n\nВ скобках (если есть) - переплата за 1 бой при покупке в магазине (если числа сложить получим стоимость боя при покупке в магазине), т.е. сколько вы переплатите за 1 бой, купив арт в магазине.';
var text2 = '&nbsp;&nbsp;\u041F\u0435\u0440\u0435\u043F\u043B\u0430\u0442\u0430: \u0437\u0430 \u0431\u043E\u0439 ';
var text2_title = 'Переплата за аренду на 1 бой и переплата за всю прочку. В скобках - процент удорожания цены за бой, превышающий стоимость боя собственных артефактов.';
var text3 = ' \u0437\u0430 \u0432\u0441\u044E \u043F\u0440\u043E\u0447\u043A\u0443 ';

var s_text1 = '\u0421\u043A\u0440\u044B\u0432\u0430\u0442\u044C \u0430\u0440\u0442\u0435\u0444\u0430\u043A\u0442\u044B';
var s_text1_title = 'Сворачивает арты в магазине, которых нет ("Доступно для продажи: 0").\nКликом по полю с названием арта скрытая информация разворачивается.';
var s_text2 = '\u0418\u0437\u043C\u0435\u043D\u044F\u0442\u044C \u0440\u0430\u0437\u0434\u0435\u043B\u044B';
var s_text2_title = 'Добавляет быстрые ссылки в меню:\n- на аренду категории артов (переход за один клик),\n- на аренду модифицированных артов (переход за один клик).';
...
while ( ai.tagName != 'TR' ) { ai = ai.parentNode; }
...
if ( ai.innerHTML.indexOf(seard)!=-1 ) {
	var bt = document.createElement('span');
	bt.title = text1_title;
	bt.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+text1+arts_cost_proch +
		( now_art[5] == 0 ? ( '&nbsp;&nbsp;<font color="gray">(+'+(now_art[4]/now_art[3]-Number(arts_cost_proch)).toFixed(2)+')</font>' ) : '' ) +
	...
	if ( /<font color=.?red.?>/.exec(ai.innerHTML) ) { aj = ai.lastChild.childNodes[j+2]; } else { aj = ai.lastChild.childNodes[j+1]; }
	aj.parentNode.insertBefore(bt, aj.nextSibling);
}
...
if ( ai.innerHTML.indexOf(seard)!=-1 ) {
	...
	if ( aj.parentNode.nextSibling.innerHTML.match('&nbsp;') ) {
		...
		bt = aj.parentNode.cloneNode(true);
		aj.parentNode.parentNode.appendChild(bt);
...
bt.innerHTML = '&nbsp;'+s_author+': <a href="pl_info.php?id=15091">Demin</a> <a href="javascript:void(0);" id="open_transfer_id">?</a><br>';
...
if ( !link_help ) { link_help = document.querySelector("li > a[href*='shop.php?cat=weapon']"); }
...
for ( var i=0; i<arts_id_array.length; i++ ) {
	...
	while ( temp_node.tagName != 'TR' ) { temp_node = temp_node.parentNode; }
...
GM_setValue( "92569_shop_hide_arts", shop_hide_arts );
shop_hide_f();
}
...
GM_setValue( "92569_shop_change_sections", shop_change_sections );
}
