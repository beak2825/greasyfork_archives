...
// @version      2.3
// @description  По вопросам(ВК): https://vk.com/h_rodgers
// @author       Henry_Rodgers
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @grant        none
// @license 	 MIT
// @collaborator none
// @icon  https://upload.wikimedia.org/wikipedia/commons/3/33/Coat_of_Arms_of_Saratov_oblast/128/4080/4080314.png
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/467165/SARATOV%20%7C%20%D0%A1%D0%9A%D0%A0%D0%98%D0%9F%D0%A2.user.js
// @updateURL https://update.greasyfork.org/scripts/467165/SARATOV%20%7C%20%D0%A1%D0%9A%D0%A0%D0%98%D0%9F%D0%A2.meta.js
// ==/UserScript==
...
const buttons = [
     ...
     {
      title: '_________________________________> Раздел Жалобы на игроков <_________________________________',
       },
      {
     ...
     {
	  title: '_________________________________> Причины отказов <_________________________________',
	},
    {
	  title: '| Нет нарушений |',
	  content:
	...
	},
   {
	...
	},
     {
      ...
      {
	  title: '_________________________________> RP Нарушения <_________________________________',
	},
   {
	  title: '| DM |',
	  content:
	...
	},
{
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
     ...
     {
	  title: '_________________________________ NonRP нарушения _________________________________',
	},
      {
	...
	},
{
   ...
   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url]<br>' +
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
	 ...
	 {
	  title: '_________________________________> NickName <_________________________________',
	},
    	{
	  title: '| NickName Оск |',
	  content:
     ...
     {
	  title: '_________________________________> Передать жалобу <_________________________________',
	},
     {
	...
	},
{
    ...
    {
          title: '_________________________________> В другой раздел <_________________________________',
	},
    {
    ...
    {
      title: '_________________________________> RolePlay биографии <_________________________________',
    },
	{
	  title: '| Одобрено |',
	  content:
    ...
    {
      title: 'Не тот возраст в детстве/юности/взрослой жизни',
      content:
		'[Color=Red][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>'+
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причина: Ознакомьтесь с правилами создания биографии. Пункт 11.1 начинается с самого рождения и заканчивается в 12 лет. Пункт 11.2 начинается с 13 лет и заканчивается в 17 лет. Пункт 11.3 начинается с 18 лет. | [Color=Cyan]Saratov[/CENTER][/FONT]",
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
 {
      ...
      content:
		'[Color=Red][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причина: Ознакомьтесь с правилами создания биографии. У вас слишком мало информации про учёбу/личную жизнь/карьеру. | [Color=Cyan]Saratov[/CENTER][/FONT]",
       prefix: UNACCEPT_PREFIX,
	   status: false,
    },
    {
          title: ' _________________________________> RolePlay ситуации <_________________________________'
    },
    	{
	  title: '| Одобрено |',
	  content:
 ...
 "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=#00BFFF]SARATOV[/COLOR].<br><br>"+
    ...
    {
      title: '_________________________________> Неоф. RolePlay организации <_________________________________'
    },
    {
	  title: '| Одобрено |',
	  content:
