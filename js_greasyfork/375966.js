// ==UserScript==
// @name           trakt.tv grid++ IMDb, MetaCritic & RottenTomatoes movie ratings + links
...
// @version        2.2.3
//
// @downloadURL https://update.greasyfork.org/scripts/375966/trakttv%20grid%2B%2B%20IMDb%2C%20MetaCritic%20%20RottenTomatoes%20movie%20ratings%20%2B%20links.user.js
// @updateURL https://update.greasyfork.org/scripts/375966/trakttv%20grid%2B%2B%20IMDb%2C%20MetaCritic%20%20RottenTomatoes%20movie%20ratings%20%2B%20links.meta.js
// ==/UserScript==


/*==================NOTE - REPLACE the eight @ symbols on the line below (line 22) with your API from www.omdbapi.com   (its free) ====================*/
                        ...
                        GM_xmlhttpRequest({
                            ...
                            onload: function (json) {
								...
								/*console.log('============================' + res.tomatoRating);*/
                                    $(imdb).find('span.value').html('<a href="http://www.imdb.com/title/' + res.imdbID + '" target="_blank"><font color="#555"><font color="#F6F68B">' + res.imdbRating + '</a>');
                                }
