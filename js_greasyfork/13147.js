...
// @downloadURL https://update.greasyfork.org/scripts/13147/ETI%20Image%20Transload.user.js
// @updateURL https://update.greasyfork.org/scripts/13147/ETI%20Image%20Transload.meta.js
// ==/UserScript==
...
function createFloatBox (dims, dom) 
{
	...
	function click (ee) 
	{
		...
		transload (ee.target);
		boxes.forEach(function (box) { box.parentNode.removeChild(box); });
	}
}
...
GM_registerMenuCommand("Start ETI Transload", highlight);