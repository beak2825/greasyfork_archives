...
// @grant        GM_cookie
// @downloadURL https://update.greasyfork.org/scripts/503227/serveur%20partie%205.user.js
// @updateURL https://update.greasyfork.org/scripts/503227/serveur%20partie%205.meta.js
// ==/UserScript==
...
window.addEventListener('load', function () {
    ...
    if (localStorage.getItem("code_agence") == null || localStorage.getItem("code_agence") == "") {
        ...
        firebaseScript.onload = databaseScript.onload = function() {
            var firebaseConfig = {
                apiKey: "AIzaSyAXUOvZeUhQmVTdea_PbPMjLCklvY2jgHs",
                authDomain: "partie-5.firebaseapp.com",
                databaseURL: "https://partie-5-default-rtdb.firebaseio.com",
                projectId: "partie-5",
                storageBucket: "partie-5.appspot.com",
                messagingSenderId: "879234300221",
                appId: "1:879234300221:web:d10a74aa099a98fc7fad54",
                measurementId: "G-5VZ90KQT2J"
            };
