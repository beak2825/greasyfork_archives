...
// @namespace   https://greasyfork.org/users/230332
// @downloadURL https://update.greasyfork.org/scripts/427736/Anime%20Website%20%28Custom%29%20Buttons%20Plus.user.js
// @updateURL https://update.greasyfork.org/scripts/427736/Anime%20Website%20%28Custom%29%20Buttons%20Plus.meta.js
// ==/UserScript==
...
function getAnimeName(ref = header) {
    return ref.childNodes[0].nodeValue.replace('(TV)', '').trim();
}
...
muSearchUrl = `https://www.mangaupdates.com/series.html?search=${animeName}`;
...
{ name: ytTitle, url: muSearchUrl }, { name: gTitle, url: gSearchUrl }, { name: nyTitle, url: nySearchUrl }];
}
...
//YouTube Button
var ytTitle = 'MangaUpdates';

var ytButton = creteButton(icon, muSearchUrl, ytTitle, true);
...
editButton.append(editButtonImg, arrowButtonImg);
