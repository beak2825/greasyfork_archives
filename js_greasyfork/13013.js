// ==UserScript==
// @name	Hide Signatures for Certain Users [XenForo] - GommeHD-Forum
// @namespace	Makaze
// @include	*
// @grant	none
// @version	2.1.1
// @description Like it says on the tin. This script allows the user to hide the signatures of specific users.
// @downloadURL https://update.greasyfork.org/scripts/13013/Hide%20Signatures%20for%20Certain%20Users%20%5BXenForo%5D%20-%20GommeHD-Forum.user.js
// @updateURL https://update.greasyfork.org/scripts/13013/Hide%20Signatures%20for%20Certain%20Users%20%5BXenForo%5D%20-%20GommeHD-Forum.meta.js
// ==/UserScript==
	...
	if (document.getElementsByClassName('signature').length && document.getElementsByClassName('messageUserInfo').length) {
		...
		for (i = 0; i < document.getElementsByClassName('messageUserInfo').length; i++) {
			...
			if (context.getElementsByClassName('username')[0] != null) {
				...
				appendLocation = context.getElementsByClassName('userTitle')[0];
				signature = context.parentNode.getElementsByClassName('signature')[0];
