// ==UserScript==
// @name         上海市中职校计算机应用专业教育质量监测理论考试 自动答题_仅快捷键
...
// @connect      gitee.com
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/453843/%E4%B8%8A%E6%B5%B7%E5%B8%82%E4%B8%AD%E8%81%8C%E6%A0%A1%E8%AE%A1%E7%AE%97%E6%9C%BA%E5%BA%94%E7%94%A8%E4%B8%93%E4%B8%9A%E6%95%99%E8%82%B2%E8%B4%A8%E9%87%8F%E7%9B%91%E6%B5%8B%E7%90%86%E8%AE%BA%E8%80%83%E8%AF%95%20%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98_%E4%BB%85%E5%BF%AB%E6%8D%B7%E9%94%AE.user.js
// @updateURL https://update.greasyfork.org/scripts/453843/%E4%B8%8A%E6%B5%B7%E5%B8%82%E4%B8%AD%E8%81%8C%E6%A0%A1%E8%AE%A1%E7%AE%97%E6%9C%BA%E5%BA%94%E7%94%A8%E4%B8%93%E4%B8%9A%E6%95%99%E8%82%B2%E8%B4%A8%E9%87%8F%E7%9B%91%E6%B5%8B%E7%90%86%E8%AE%BA%E8%80%83%E8%AF%95%20%E8%87%AA%E5%8A%A8%E7%AD%94%E9%A2%98_%E4%BB%85%E5%BF%AB%E6%8D%B7%E9%94%AE.meta.js
// ==/UserScript==
(function () {
    ...
    let res = {
        ...
        tab_wrap.forEach(e => {
            ...
            function get_index(para) {
                function lfn(num) {
                    return parseInt($('.timu-text').text().split('/')[0]) + num;
                }
                let p_index;
                switch (para) {
                    case 'left':
                ...
                let tab_wrap = $('.list-w a').get();
                tab_wrap.forEach(e => {
                    e.className = e.className.replace(/_current/g, '');
                    if ($(e).data('index') == p_index - 1) {
                        e.className += ' _current';
                        e.click();
                    }
                });
            }
            ...
            switch (e.keyCode) {
                case 74:
                    /* left */
                    // document.querySelector("button.left.gl.pre").click();
                    get_index('right');
                    break;
                case 76:
                    /* right */
                    // document.querySelector("button.left.gl.next").click();
                    get_index('left');
                    break;
                case 73:
                    /* up */
