...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/451959/Bilibili%E8%AF%9D%E9%A2%98%E6%A0%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/451959/Bilibili%E8%AF%9D%E9%A2%98%E6%A0%8F.meta.js
// ==/UserScript==
...
(function() {
    ...
    async function getTopicLatest(topic_id) {
        let resp = await fetch(`https://api.bilibili.com/x/polymer/web-dynamic/v1/feed/topic?topic_id=${topic_id}&sort_by=3&offset=&page_size=20&source=Web`, {
            "referrerPolicy": "strict-origin-when-cross-origin",
            "body": null,
            "method": "GET",
            "mode": "cors",
