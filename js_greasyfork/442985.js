...
// @downloadURL https://update.greasyfork.org/scripts/442985/CSGO%E9%A5%B0%E5%93%81%E4%BB%B7%E6%A0%BC%E5%AF%B9%E6%AF%94%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/442985/CSGO%E9%A5%B0%E5%93%81%E4%BB%B7%E6%A0%BC%E5%AF%B9%E6%AF%94%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
function addC5(c5URL, li, itemName) {
    GM_xmlhttpRequest({
        method: 'GET',
        url: c5URL,
		cookie:"C5Lang=zh; device_id=a891335d61756a5ae39b6ba636d0fe09; __jsluid_s=edb08e6ad7572628a53e46093c9e0a2c; C5SessionID=r089thmpf4cqt21gvq098dp458; C5Sate=a361f40e088ebef49f415b500b0b69bb321b716fa%3A4%3A%7Bi%3A0%3Bs%3A9%3A%22560578780%22%3Bi%3A1%3Bs%3A11%3A%2218735969291%22%3Bi%3A2%3Bi%3A604800%3Bi%3A3%3Ba%3A0%3A%7B%7D%7D; C5Machines=b1eUZfwoSM5VGh9aXrlJSw%3D%3D; C5Token=62500d2b8dd62; C5Login=560578780; ZBTToken=171edb0c6f113b9034bac940deffe009_560578780_1649413419; c5IsBindPhone=1; c5user=18735969291; C5Appid=730",
        ...
        onload: function (response) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (Trim(name) == Trim(itemName)) {
                    ...
                    var sum = $(items[i]).find('div.stock').text().trim();
