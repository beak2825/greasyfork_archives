// ==UserScript==
// @name         Спец заказ для Руководства ULYANOVSK
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/523245/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20ULYANOVSK.user.js
// @updateURL https://update.greasyfork.org/scripts/523245/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20ULYANOVSK.meta.js
// ==/UserScript==
	...
	},
{
	...
	},
     {
	  ...
	  content:
		...
		`[CENTER][COLOR=#ff9800]На рассмотрении[/COLOR].[/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK» [/COLOR][/FONT][/SIZE][/CENTER]`,
	     prefix: PIN_PREFIX,
	     status: true,
	       },
	...
	},
{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба была [COLOR=#00ff00]одобрена[/COLOR] и будет проведена беседа с администратором.<br>CENTER]<br>" +
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK»[/COLOR][/FONT][/SIZE][/CENTER]`,
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},
