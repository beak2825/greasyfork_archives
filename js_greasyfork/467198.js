...
// @version     1.0.7
// @author      diwangge
// @description DZ论坛专用的回复表情, 插图扩展插件, 在发帖时快速输入自定义表情
...
// @license     MIT
// @run-at      document-end
// @downloadURL https://update.greasyfork.org/scripts/467198/%E5%B8%9D%E7%8E%8B%E5%93%A5%E8%AE%BA%E5%9D%9B%E8%A1%A8%E6%83%85%E5%A2%9E%E5%BC%BA%E6%8F%92%E4%BB%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/467198/%E5%B8%9D%E7%8E%8B%E5%93%A5%E8%AE%BA%E5%9D%9B%E8%A1%A8%E6%83%85%E5%A2%9E%E5%BC%BA%E6%8F%92%E4%BB%B6.meta.js
// ==/UserScript==
    ...
    var Emotion = reserveData(2), app = reserveData(0), targetTextarea = document.getElementsByTagName("textarea").item(0), reserveData = [ {
        ...
        groupEmotions: [ {
            itemAddress: app.loadEmotions({
                startPos: 1,
                arrLength: 97,
                strPrefix: "https://8888a.cn/bq/dwg (",
                strSuffix: ").gif",
                leadingZero: !1
            }),
            itemDescription: []
        ...
        groupEmotions: [ {
            itemAddress: app.loadEmotions({
                startPos: 1,
                arrLength: 49,
                strPrefix: "https://8888a.cn/jt/dwg (",
                strSuffix: ").jpg",
                leadingZero: !1
            }),
            itemDescription: []
        ...
        stageView: "#eddie32stage {height: 500px; padding: 3px 3px; overflow-x: auto; margin-top:4px;margin-bottom:4px; border:1px solid #ff4351; position:relative; z-index:200; display: none; } #eddie32stage span { cursor: pointer }",
        ...
        imageLink: ".Ems { cursor: pointer; width: 90px; height: 90px; display: inline-block; z-index: 400;  }",
