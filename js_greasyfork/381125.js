...
// @namespace https://greasyfork.org/users/287447
// @downloadURL https://update.greasyfork.org/scripts/381125/Choo.user.js
// @updateURL https://update.greasyfork.org/scripts/381125/Choo.meta.js
// ==/UserScript==
...
else if( domain.startsWith('www.google.') && getParameterByName('regularQ'))
{
    ...
    if(getParameterByName('tokenize') == null)
    {
        ...
        aLink.setAttribute('id', 'btnQues');
        aLink.appendChild(document.createTextNode("QUESTION OPTION"));
        aLink.style.cssText = 'display:block; margin-bottom: .4em; color:white; background-color: #5e79d1; padding: 10px 10px; border-radius: 4px; text-decoration: none; cursor:pointer;';
        buttContainer.appendChild(aLink);

        $('#btnQues').on( 'click', e => {searchOptionFloat('',opt,true);});
