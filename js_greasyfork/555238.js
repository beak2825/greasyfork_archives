// ==UserScript==
// @name         Papanads PF ADV menus (inventory + display + market + page-scrape)
// @namespace    https://torn.com/
// @version      6.4
// @description  Plushie/flower helper anywhere. Full UI like mobile version (goals, themes, market, glowing tabs) but fixed position, no dragging.
// @author       you
// @license      MIT
...
// @downloadURL https://update.greasyfork.org/scripts/555238/Papanads%20PF%20ADV%20menus%20%28inventory%20%2B%20display%20%2B%20market%20%2B%20page-scrape%29.user.js
// @updateURL https://update.greasyfork.org/scripts/555238/Papanads%20PF%20ADV%20menus%20%28inventory%20%2B%20display%20%2B%20market%20%2B%20page-scrape%29.meta.js
// ==/UserScript==

(function () {
  'use strict';
  console.log('[PF] userscript (fixed) loaded');
  ...
  function renderCurrent() {
    ...
    // fixed panel: no need to reposition
  }
  ...
  function renderSettings() {
    ...
    content.innerHTML = `
      <div class="pf-settings-block">
        ...
        <div class="pf-settings-note">Fixed version (no dragging).</div>
  ...
  // =========================
  // STYLES (same as draggable, but fixed position)
  // =========================
  function addStyles() {
    const css = `
