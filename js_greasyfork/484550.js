// ==UserScript==
// @name AudioBookBay hide category: Fantasy
// @description Hide Fantasy category
...
// @downloadURL https://update.greasyfork.org/scripts/484550/AudioBookBay%20hide%20category%3A%20Fantasy.user.js
// @updateURL https://update.greasyfork.org/scripts/484550/AudioBookBay%20hide%20category%3A%20Fantasy.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Fantasy'
    $(".post").has(".postInfo:contains('Fantasy')").hide();
});
