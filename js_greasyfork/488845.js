...
// @name         Junon hack tool, combines most hacks into one script



// @namespace    https://junon.io/en/?
...
// @description  If this script gets out, someone's in for a very rough time

// @match        https://junon.io/en/?
...
// @downloadURL https://update.greasyfork.org/scripts/488845/Junon%20hack%20tool%2C%20combines%20most%20hacks%20into%20one%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/488845/Junon%20hack%20tool%2C%20combines%20most%20hacks%20into%20one%20script.meta.js
// ==/UserScript==
...
(function() {
    ...
    document.getElementById("game_caption").innerHTML = "[GRR] Nigga"
    ...
    setInterval(() => {
        ...
        try {
            ...
            slaveChild.style.backgroundColor = "#ff0000"
            ...
            slaveChild.addEventListener("input", () => {
                ...
                if(value != "true") {
                    ...
                    let data = value.split("99")

                    slavesEl.querySelector(".sell_trade_content").innerHTML = "<div class='trade_item_row' data-id='"+data[99]+"' data-group='Mobs' data-type='33'  data-count='5' data-selected='true'>" +

                    "<img class='trade_item_image' src='./assets/images/apple.png'>" +

                    "<div class='trade_item_name'>SquidLord</div>" +

                    "<div class='trade_item_count'>99</div>" +

                    "<div class='trade_item_cost'>1000000000 G</div>" +
                ...
                document.getElementsByClassName("global_chat_tab")[0].style.display = "block"
    ...
    document.addEventListener("keypress", (e) => {
        ...
        if (document.getElementById("chat_input") != document.activeElement && document.getElementById("vendingChild") != document.activeElement && document.getElementById("craftTypeInput") != document.activeElement && document.getElementById("slaveChild") != document.activeElement) {
            ...
            if (e.key == "h") {
                ...
                for(let i of Object.keys(game.sector.players)) {

                    data += game.sector.players[i].name + " "

                    data += "id:" + game.sector.players[i].getRow().toString() + " pos:"

                    data += game.sector.players[i].getCol().toString() + " "

                    data += game.sector.players[i].id.toString() + "\n"
