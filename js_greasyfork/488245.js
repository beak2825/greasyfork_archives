// ==UserScript==
// @name Для Руководства CHERRY (09)
// @namespace https://forum.blackrussia.online
// @version 0.4.9
// @description kye
// @author Maksim_Vitalievich & arefuer
...
// @downloadURL https://update.greasyfork.org/scripts/488245/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20CHERRY%20%2809%29.user.js
// @updateURL https://update.greasyfork.org/scripts/488245/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20CHERRY%20%2809%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба составлена не по форме. Ознакомьтесь с [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-администрацию.3429349/'][COLOR=rgb(255,0,0)]«правилами подачи жалоб на администрацию».[/color][/URL] <br>В названии темы необходимо написать: “Nick_Name администратора | Суть жалобы“. [/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]С момента получения наказание прошло 72 часа.[/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Главному Администратору[/color] - @Liana_Mironova [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>",
    prefix: GA_PREFIX,
    status: true,
    },
    {
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Заместителям Главного Администратора[/color] - @Ronald Kõlman ☭︎ @Vanya Donissimo [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>",
    prefix: PIN_PREFIX,
    status: true,
    },
    {
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [COLOR=rgb(204,6,5)]Специальной Администрации[/color] - @Sander_Kligan, @Clarence Crown, @Dmitry Dmitrich, @Myron_Capone[/CENTER]<br><br>"+
    '[CENTER][Color=Orange]На рассмотрении.[/Color][/CENTER][/B][/SIZE]',
    prefix: SA_PREFIX,
    status: true,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваше обжалование составлено не по форме. В названии темы необходимо написать: “Nick_Name администратора | Суть жалобы“. Ознакомьтесь с [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-заявки-на-обжалование-на%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D1%8F.3429398/'][COLOR=rgb(255,0,0)]«Правила подачи заявки на обжалование наказания».[/color][/URL][/CENTER]<br><br>"+
    '[CENTER][COLOR=RED]Отказано[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
