// ==UserScript==
// @name Кураторам Форума
// @name:ru Кураторы Форума | Saratov
// @name:uk Куратори форуму | Saratov
// @description  Suggestions for improving the script write here ---> https://vk.com/ilyukha_stoned
// @description:ru Предложения по улучшению скрипта писать сюда ---> https://vk.com/ilyukha_stoned
// @description:uk Пропозиції щодо покращення скрипту писати сюди ---> https://vk.com/ilyukha_stoned
// @version 1.7
...
// @grant        none
// @license    MIT
// @supportURL https://vk.com/ilyukha_stoned
// @icon https://emoji.gg/assets/emoji/9372-blurple-boost-level-9.png
// @downloadURL https://update.greasyfork.org/scripts/466435/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%D0%BC%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/466435/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%D0%BC%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
...
const buttons = [
 ...
 title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴Правила Role Play процесса ╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    },
    {
      ...
      content:
        ...
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(222, 143, 255)][SIZE=4][FONT=courier new]Saratov[/FONT][/SIZE][/COLOR][COLOR=rgb(222, 143, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
    ...
    },
    {
      ...
      content:
        '[Color=rgb[222, 143,255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба была передана на рассмотрение Команде Проекта.[/CENTER]<br><br>" +
        '[Color=Flame][CENTER]Ожидайте ответа.[/I][/CENTER][/color][/FONT]',
    ...
    },
    {
      ...
      content:
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Недостаточно доказательств на нарушение от данного игрока. Доказательства должны быть предоставлены в хорошем качестве и с полным процессом сделки или нарушения от какого-либо игрока.[/CENTER]<br><br>" +"[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(222, 143, 255)][SIZE=4][FONT=courier new]Saratov[/FONT][/SIZE][/COLOR][COLOR=rgb(222, 143, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        "[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(222, 143, 255)][SIZE=4][FONT=courier new]Saratov[/FONT][/SIZE][/COLOR][COLOR=rgb(222, 143, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        '[CENTER][B][COLOR=rgb(255, 0, 0)]✿❯────「[SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman]Отказано. ❖  Закрыто.[/FONT][/COLOR][/SIZE]」────❮✿ [/COLOR][/B] [/CENTER]',
      prefix: UNACCСEPT_PREFIX,
      status: false,
 ...
 $(document).ready(() => {
    ...
    addButton('Тех.Спец', 'Spec');
    addButton('Команде Проекта', 'teamProject');
    addButton('Главному Администратору', 'GA');
    addButton('Menu by Gubernov', 'selectAnswer');
 
    // Поиск информации о теме
    const threadData = getThreadData();
 
    $('button#pin').click(() => editThreadData(PINN_PREFIX, true));
    $('button#accepted').click(() => editThreadData(ACCEPTED_PREFIX, false));
    $('button#unaccept').click(() => editThreadData(UNACCEPT_PREFIX, false));
    $('button#Texy').click(() => editThreadData(TEXY_PREFIX, true));
    $('button#teamProject').click(() => editThreadData(COMMAND_PREFIX, true));
    $('buttno#GA').click(() => editThreadData(GA_PREFIX, true));
