 // ==UserScript==
// @name         MOOMOO.IO MOD!! WORKING! MOD, OP INSTA, AND MORE!
// @namespace    BEST PVP MOD
// @version      10
// @description  [G] For Spike + BoostPad, [N] For 1 Windmills, [O] For 5 Windmills, [H] For Turrets [F] For BoostPad, [V] For Spike, [P] For 4 Walls, [B] for Active/Unactive Auto Hat and [M] For 4 Spikes, [T] for Active/Unactive AutoHeal, [Z] for Insta-Kill and [I] for 4 Trap or BoostPad !
// @author       Bapobursky
// @match        *://moomoo.io/*
// @match        *://dev.moomoo.io/
...
// @downloadURL https://update.greasyfork.org/scripts/421589/MOOMOOIO%20MOD%21%21%20WORKING%21%20MOD%2C%20OP%20INSTA%2C%20AND%20MORE%21.user.js
// @updateURL https://update.greasyfork.org/scripts/421589/MOOMOOIO%20MOD%21%21%20WORKING%21%20MOD%2C%20OP%20INSTA%2C%20AND%20MORE%21.meta.js
// ==/UserScript==
(function() {
	'use strict';
...
document.getElementById('linksContainer2').innerHTML = '[G] For Spike + BoostPad, [N] For 1 Windmills, [O] For 5 Windmills, [H] For Turrets [F] For BoostPad, [V] For Spike, [P] For 4 Walls, [B] for Active/Unactive Auto Hat and [M] For 4 Spikes, [T] for Active/Unactive AutoHeal, [Z] for Insta-Kill and [I] for 4 Trap or BoostPad !';
