...
// @downloadURL https://update.greasyfork.org/scripts/34181/My%20Match%20Analyzer.user.js
// @updateURL https://update.greasyfork.org/scripts/34181/My%20Match%20Analyzer.meta.js
// ==/UserScript==
...
function clickAnalyze()
{
	...
	else
	{
		...
		myform.action = "https://www.mymatchanalyzer.com/mma/report.php";
		myform.submit();
	}
}
...
function clickSave()
{
    ...
    {
		myform = document.getElementById("mma_form");
		myform.action = "https://www.mymatchanalyzer.com/mma/savereport.php";
		myform.submit();
	}
}
...
window.addEventListener('load', function (e)
{
	...
	var fileref=document.createElement('script');
	fileref.setAttribute("type","text/javascript");
	fileref.setAttribute("src", "https://www.mymatchanalyzer.com/mma/json2.js");

	document.getElementsByTagName("head")[0].appendChild(fileref);

	loadJS("https://mymatchanalyzer.com/mma/json2.js");

	addCss(".mma_big { height: 30px; width: 400px; background: url(https://www.mymatchanalyzer.com/mma/scr_back.png); position: fixed; bottom: 0px; left: 10px; z-index: 10;}");
	addCss(".mma_analyze { left: 200px; top: 5px; height: 20px; position: relative; width: 60px; float: left; background: url(https://www.mymatchanalyzer.com/mma/analyze.png); }");
	addCss(".mma_analyze:hover { background: url(https://www.mymatchanalyzer.com/mma/analyze_hover.png); cursor: pointer; }");
	addCss(".mma_saverep { left: 220px; top: 5px; height: 20px; position: relative; width: 100px; float: left; background: url(https://www.mymatchanalyzer.com/mma/saverep.png); }");
	addCss(".mma_saverep:hover { background: url(https://www.mymatchanalyzer.com/mma/saverep_hover.png); cursor: pointer; }");
