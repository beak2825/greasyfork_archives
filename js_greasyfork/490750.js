...
// @match        http://207.211.161.235:5678/*
// @match        https://n8n.dudoo.top/*
// @match        https://n8nt.dudoo.top/*
// @match        http://217.142.253.17:5678/*
// @match        http://127.0.0.1:5678/*
// @require https://unpkg.com/xhook@latest/dist/xhook.min.js
// @require https://unpkg.com/lodash@4.17.21/lodash.min.js
// @icon         https://www.google.com/s2/favicons?sz=64&domain=undefined.localhost
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/490750/n8n%20%E4%B8%AD%E6%96%87%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/490750/n8n%20%E4%B8%AD%E6%96%87%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==

(function () {
	'use strict';

	const scripts = document.querySelectorAll('link[href*="/assets/_MapCache"]');
    console.log(scripts,1234)

	scripts.forEach(script => {
		const fullUrl = script.href;
    ...
    function getFieldsWithObjectContainingSetLocaleMessage(instance) {
      ...
      for (const prop of properties) {
        ...
        if (value !== null && typeof value === 'function' && value.name === 'useI18n') {
           if (value().setLocaleMessage) {
              result = value()
              break;
           }
    ...
    const i18n = getFieldsWithObjectContainingSetLocaleMessage(module);
      ...
      ...{
        ...
        "insights.banner.title.averageRunTime": "平均运行时间",
         ...
         "generic.archiveWorkflowError": "归档工作流时出错",
  "generic.unarchiveWorkflowError": "取消归档工作流时出错",
  "generic.officialNode.tooltip": "这是由 {author} 维护的官方节点",
  "generic.shortcutHint": "或按下",
  "generic.upgradeToEnterprise": "升级到企业版",
  "auth.roles.default": "默认",
  "aiAssistant.n8nAi": "n8n AI 助手",
  "aiAssistant.builder.name": "构建器",
  "aiAssistant.builder.mode": "AI 构建器",
  "aiAssistant.builder.placeholder": "你想要自动化什么？",
  "aiAssistant.builder.generateNew": "生成新工作流",
  "aiAssistant.builder.buildWorkflow": "构建工作流",
  "aiAssistant.builder.newWorkflowNotice": "创建的工作流将添加到编辑器中",
  "aiAssistant.builder.feedbackPrompt": "这个工作流有帮助吗？",
  "aiAssistant.builder.invalidPrompt": "提示验证失败。请尝试更清晰地描述你的工作流需求及支持的集成内容。",
  "dataMapping.schemaView.emptySchema": "没有字段 - 项目存在，但为空",
  "dataMapping.schemaView.emptySchemaWithBinary": "仅包含二进制数据。请使用“二进制”选项卡查看",
  "dataMapping.schemaView.executeSchema": "点击 {link} 查看数据结构",
  "error.entityNotFound.title": "{entity} 未找到",
  "error.entityNotFound.text": "我们无法找到你正在查找的 {entity}。请确保链接正确。",
  "error.entityNotFound.action": "返回概览页",
  "error.entityUnAuthorized.title": "你需要权限",
  "error.entityUnAuthorized.content": "你没有权限查看此 {entity}。请联系分享此链接的人请求访问权限。",
  ...
  "executionsList.showMessage.retryWaiting.title": "等待重试",
  "executionsList.showMessage.retryCrashed.title": "重试时崩溃",
  "executionsList.showMessage.retryCanceled.title": "重试已取消",
  "executionsList.showMessage.retryRunning.title": "重试执行中",
  "executionsList.debug.paywall.title": "升级以使用编辑器调试功能",
   "executionsList.debug.paywall.subContent": "该功能在我们的 Cloud 计划、企业版和",
 ...
 "fromAiParametersModal.description": "提供通常来自 “{parentNodeName}” 节点的数据",
  ...
  "forgotPassword.oidcUserPasswordResetUnavailable": "请联系你的 OIDC 管理员以重置密码",
  "folders.rename.placeholder": "输入新文件夹名称",
  "folders.move.modal.folder.count": "{count} 个文件夹",
  "folders.move.modal.workflow.count": "{count} 个工作流",
  ...
  "folders.move.modal.message.usedCredentials.workflow": "还需共享此工作流所使用的 {usedCredentials}，以确保其正常运行",
  "folders.move.modal.message.usedCredentials.folder": "还需共享这些工作流使用的 {usedCredentials}，以确保它们正常运行",
  "folders.move.modal.message.usedCredentials.warning": "如果你选择不共享凭据，工作流可能无法正确执行。",
  "folders.move.success.messageNoAccess": "<b>{folderName}</b> 已移动至 <b>{newFolderName}</b>，其中包含所有工作流和子文件夹。",
  "folders.move.workflow.success.messageNoAccess": "<b>{workflowName}</b> 已移动至 <b>{newFolderName}</b>。",
  "genericHelpers.hrsShort": "小时",
  "logs.overview.body.summaryText.for": "{status}，用时 {time}",
  "logs.overview.body.summaryText.in": "{status}，耗时 {time}",
  "logs.overview.body.run": "执行步骤",
  "logs.overview.body.open": "打开...",
  "logs.overview.body.toggleRow": "展开/折叠行",
  "logs.details.header.actions.input": "输入",
  "logs.details.header.actions.output": "输出",
  "logs.details.body.itemCount": "{count} 项",
  "logs.details.body.multipleInputs": "有多个输入。通过 {button} 查看",
  "logs.details.body.multipleInputs.openingTheNode": "打开节点",
  "mainSidebar.confirmMessage.workflowArchive.cancelButtonText": "",
  "mainSidebar.confirmMessage.workflowArchive.confirmButtonText": "是的，归档",
  "mainSidebar.confirmMessage.workflowArchive.headline": "归档工作流？",
  "mainSidebar.confirmMessage.workflowArchive.message": "你确定要归档“{workflowName}”吗？",
  "mainSidebar.showMessage.handleArchive.title": "工作流“{workflowName}”已归档",
  "mainSidebar.showMessage.handleUnarchive.title": "工作流“{workflowName}”已取消归档",
  "menuActions.archive": "归档",
  "menuActions.unarchive": "取消归档",
  "ndv.input.fromAI": "来自 AI",
 "ndv.output.githubNodeWaitingForWebhook": "当以下 Webhook URL 被调用时，执行将继续：",
  "ndv.output.waitNodeWaiting.title": "等待输入",
  "ndv.output.waitNodeWaiting.description.webhook": "当接收到 Webhook 时，执行将继续：",
  "ndv.output.waitNodeWaiting.description.form": "当表单提交时，执行将继续：",
  "ndv.output.waitNodeWaiting.description.timer": "当等待时间结束时，执行将继续",
  "nodeCreator.categoryNames.moreFromCommunity": "来自社区的更多内容",
  "nodeCreator.ragStarterTemplate.openTemplateItem.title": "RAG 入门模板",
  "nodeCreator.ragStarterTemplate.openTemplateItem.description": "在 n8n 中体验向量数据库的使用",
  "nodeCreator.nodeItem.deprecated": "已弃用",
  "nodeSettings.communityNodeDetails.title": "节点详情",
  "nodeView.runButtonText.from": "来自 {nodeName}",
  "nodeView.showMessage.ndvUrl.missingNodes.title": "未找到节点",
  "nodeView.showMessage.ndvUrl.missingNodes.content": "URL 中引用了一个未知节点。可能该节点已被删除？",
  "contextMenu.extract": "转换为子工作流 | 将 {count} 个节点转换为子工作流",
  "contextMenu.openSubworkflow": "前往子工作流",
  "nodeWebhooks.clickToCopyWebhookUrls.mcpTrigger": "点击复制 MCP URL",
  "nodeWebhooks.clickToDisplayWebhookUrls.mcpTrigger": "点击显示 MCP URL",
  "nodeWebhooks.clickToHideWebhookUrls.mcpTrigger": "点击隐藏 MCP URL",
  "nodeWebhooks.showMessage.title.mcpTrigger": "MCP URL 已复制",
  "nodeWebhooks.webhookUrls.mcpTrigger": "MCP URL",
  "parameterInput.selectedWorkflowIsArchived": "所选工作流已归档",
  "parameterInputList.callout.dismiss.confirm.text": "你确定要永久隐藏此项吗？",
  ...
  "renameAction.emptyName.message": "请输入名称，或按下 'esc' 返回原名称",
  "renameAction.emptyName.title": "缺少名称",
  "renameAction.invalidName.title": "名称无效",
  "resourceLocator.mode.list.addNewResource.vectorStoreInMemory": "创建键 '{resourceName}'",
  "resourceLocator.placeholder.searchOrCreate": "搜索或创建...",
  "resourceLocator.placeholder.search": "搜索...",
  "runData.rendered": "已渲染",
  "runData.panel.actions.sync": "与画布同步选中项",
  "settings.communityNodes.empty.verified.only.title": "使用已验证的社区节点增强你的工作流",
  "settings.communityNodes.empty.verified.only.description": "你可以直接从节点面板安装由社区和合作伙伴构建并由 n8n 验证的节点包。已安装的包将显示在此处。",
  "settings.personal.role.tooltip.default": "新用户的默认角色",
  "settings.personal.role.tooltip.member": "创建和管理自己的工作流和凭据",
  "settings.personal.role.tooltip.admin": "全面管理工作流、标签、凭据、项目、用户等",
  "settings.personal.role.tooltip.owner": "管理所有内容{cloudAccess}",
  "settings.personal.role.tooltip.cloud": " 并访问 Cloud 仪表盘",
  "settings.api.scopes.upgrade": "{link} 以解锁修改 API Key 权限的功能",
  "settings.api.scopes.upgrade.link": "升级",
  "settings.log-streaming.eventGroup.n8n.runner": "运行任务",
  "settings.log-streaming.eventGroup.n8n.runner.info": "当任务运行器请求执行 Code 节点以及返回结果时，将发送事件",
  "settings.log-streaming.eventGroup.n8n.queue": "队列事件",
 "settings.log-streaming.eventGroup.n8n.queue.info": "当发生队列相关事件（如入队、出队、完成、失败或卡顿）时，将发送事件",
  "settings.api.scopes.placeholder": "请选择",
  "settings.api.scopes.selectAll": "全选",
  "settings.api.scopes.label": "作用域",
  "settings.sourceControl.button.pull.forbidden": "仅实例所有者或管理员可以拉取更改",
  "settings.sourceControl.button.push.forbidden": "你无法从受保护的实例推送更改",
  "workflowActivator.thisWorkflowIsArchived": "此工作流已归档，无法被激活",
  "workflowExtraction.error.failure": "子工作流转换失败",
  "workflowExtraction.error.selectionGraph.inputEdgeToNonRoot": "非输入节点 “{node}” 与当前选择之外的节点连接。",
  "workflowExtraction.error.selectionGraph.outputEdgeFromNonLeaf": "非输出节点 “{node}” 与当前选择之外的节点连接。",
  "workflowExtraction.error.selectionGraph.multipleInputNodes": "多个节点 [{nodes}] 有来自选择范围外的输入。",
  "workflowExtraction.error.selectionGraph.multipleOutputNodes": "多个节点 [{nodes}] 有输出连接至选择范围外。",
  "workflowExtraction.error.selectionGraph.noContinuousPathFromRootToLeaf": "起始节点 “{start}” 没有到达结束节点 “{end}” 的路径。",
  "workflowExtraction.error.selectionGraph.listHeader": "由于以下错误，所选内容无效：<br><br>{body}<br><br><a href=\'https://docs.n8n.io/workflows/subworkflow-conversion/\' target=\'_blank\'>查看文档</a> 了解更多信息。",
  "workflowExtraction.error.inputNodeHasMultipleInputBranches": "起始节点 “{node}” 有多个输入分支，子工作流不支持这种结构。",
  "workflowExtraction.error.outputNodeHasMultipleOutputBranches": "结束节点 “{node}” 有多个输出分支，子工作流不支持这种结构。",
  ...
  "workflowExtraction.success.title": "已创建子工作流",
  "workflowExtraction.success.message": "<a href=\'{url}\' target=\'_blank\'>在新标签页中打开</a>",
  ...
  "workflows.filters.showArchived": "显示已归档的工作流",
  "workflows.filters.active.shortText": "已应用筛选器。",
  "workflows.empty.shared-with-me": "没有 {resource} 与你共享",
  "workflows.empty.shared-with-me.link": "<a href=\'#\'>返回个人空间</a>",
  "workflows.deactivated": "工作流已停用",
  "settings.sso.settings.ips.url.invalid": "身份提供商元数据 URL 无效",
  "settings.oidc.confirmMessage.beforeSaveForm.headline": "你确定要禁用 OIDC 登录吗？",
  "settings.oidc.confirmMessage.beforeSaveForm.message": "如果禁用，所有 OIDC 用户将被转换为邮箱用户。",
  "projects.header.overview.subtitle": "你可访问的所有工作流、凭据和执行记录",
  "projects.header.shared.title": "共享给你",
  "projects.header.personal.subtitle": "你拥有的工作流和凭据",
  "projects.header.shared.subtitle": "其他用户与您共享的工作流和凭据",
  "projects.menu.shared": "共享给你",
  "projects.settings.description": "项目描述",
  "projects.settings.delete.message.empty": "此项目中没有工作流或凭据。",
  "evaluation.listRuns.status.new": "新建",
  "evaluation.listRuns.status.running": "运行中",
  "evaluation.listRuns.status.evaluating": "评估中",
  ...
  "evaluation.listRuns.runListHeader": "所有运行记录",
  "evaluation.listRuns.testCasesListHeader": "第 {index} 次运行",
  "evaluation.listRuns.runNumber": "运行次数",
  "evaluation.listRuns.runDate": "运行日期",
  "evaluation.listRuns.runStatus": "运行状态",
  "evaluation.listRuns.noRuns": "没有测试运行",
  "evaluation.listRuns.pastRuns.total": "无运行记录 | 所有运行 | 所有运行",
  "evaluation.listRuns.noRuns.description": "运行测试以在此查看结果",
  "evaluation.listRuns.deleteRuns": "无可删除运行记录 | 删除 {count} 条运行记录 | 删除 {count} 条运行记录",
  "evaluation.listRuns.noRuns.button": "运行测试",
  "evaluation.listRuns.toast.error.fetchTestCases": "加载运行详情失败",
  "evaluation.listRuns.error.testCasesNotFound": "数据集中未找到匹配行{description}",
  "evaluation.listRuns.error.testCasesNotFound.description": "请检查评估触发器中设置的筛选或限制条件",
  "evaluation.listRuns.error.executionInterrupted": "测试运行被中断",
  "evaluation.listRuns.error.unknownError": "执行出错{description}",
  "evaluation.listRuns.error.cantFetchTestRuns": "无法获取测试运行",
  "evaluation.listRuns.error.cantStartTestRun": "无法启动测试运行",
  "evaluation.listRuns.error.unknownError.description": "点击查看更多详情",
  "evaluation.listRuns.error.evaluationTriggerNotFound": "缺少评估触发器",
  ...
  "evaluation.listRuns.error.setOutputsNodeNotFound": "工作流中没有“设置输出”节点",
  ...
  "evaluation.listRuns.error.cantFetchTestCases": "无法获取测试用例{description}",
  "evaluation.listRuns.error.cantFetchTestCases.description": "请检查评估触发器中 Google 表格的设置",
  "evaluation.runDetail.ranAt": "运行于",
  "evaluation.runDetail.testCase": "测试用例",
  "evaluation.runDetail.testCase.id": "测试用例 ID",
  "evaluation.runDetail.testCase.status": "测试用例状态",
  "evaluation.runDetail.totalCases": "用例总数",
  "evaluation.runDetail.error.mockedNodeMissing": "基准执行中不存在模拟节点的输出。{link}",
  "evaluation.runDetail.error.mockedNodeMissing.solution": "修复测试配置",
  "evaluation.runDetail.error.executionFailed": "工作流执行失败",
  "evaluation.runDetail.error.executionFailed.solution": "查看执行记录",
  "evaluation.runDetail.error.datasetTriggerNotFound": "工作流中不存在数据集触发器。{link}",
  "evaluation.runDetail.error.datasetTriggerNotFound.solution": "查看工作流",
  "evaluation.runDetail.error.invalidMetrics": "评估指标节点返回了无效值。仅支持数字类型。查看工作流。{link}",
  "evaluation.runDetail.error.invalidMetrics.solution": "查看工作流",
  "evaluation.runDetail.error.unknownError": "发生未知错误",
  "evaluation.runDetail.error.unknownError.solution": "查看执行记录",
  "evaluation.runDetail.error.noMetricsCollected": "未执行“设置指标”节点",
  "evaluation.runDetail.error.partialCasesFailed": "完成但存在错误",
  ...
  "evaluation.deleteTest.warning": "该测试及所有相关运行记录将被删除，此操作无法撤销",
  "evaluation.testIsRunning": "测试正在运行，请等待其完成",
  "evaluation.completeConfig": "请完成以下配置以运行测试：",
  "evaluation.configError.noEvaluationTag": "未设置评估标签",
  "evaluation.configError.noExecutionsAddedToTag": "此标签下未添加任何执行记录",
  "evaluation.configError.noEvaluationWorkflow": "未设置评估工作流",
  "evaluation.configError.noMetrics": "未设置指标",
  "evaluation.workflowInput.subworkflowName": "{name} 的评估工作流",
  "evaluation.workflowInput.subworkflowName.default": "我的评估子工作流",
  "evaluation.executions.addTo": "添加到测试",
  "evaluation.executions.addTo.new": "添加到新测试",
  ...
  "evaluation.executions.removedFrom": "已从“{name}”中移除执行记录",
  "evaluation.executions.toast.addedTo": "返回“{name}”",
  "evaluation.executions.tooltip.addTo": "添加到新测试",
  "evaluation.executions.tooltip.noExecutions": "评估执行记录无法添加到测试中",
  "evaluation.executions.tooltip.onlySuccess": "仅成功的执行记录可添加到测试中",
  "evaluation.workflow.createNew": "创建新的评估工作流",
  "evaluation.workflow.createNew.or": "或使用现有的评估子工作流",
  "evaluation.executions.toast.addedTo.title": "执行记录已添加到测试",
  "evaluation.executions.toast.closeTab": "关闭此标签页",
  "evaluation.executions.toast.removedFrom.title": "执行记录已从测试中移除",
  "evaluations.paywall.title": "注册以启用评估功能",
  "evaluations.paywall.description": "注册你的社区版实例以解锁评估功能",
  "evaluations.paywall.cta": "注册实例",
  "evaluations.setupWizard.title": "通过多个输入测试你的 AI 工作流",
  "evaluations.setupWizard.description": "评估通过测试数据集衡量性能",
  "evaluations.setupWizard.moreInfo": "了解更多",
  "evaluations.setupWizard.stepHeader.optional": "可选",
  "evaluations.setupWizard.step1.title": "连接测试数据集",
  "evaluations.setupWizard.step1.item1": "使用 Google 表格，每行一个输入",
  "evaluations.setupWizard.step1.item2": "将评估触发器添加到你的工作流并连接",
  "evaluations.setupWizard.step1.button": "添加评估触发器",
  "evaluations.setupWizard.step2.title": "将工作流输出写回数据集",
  "evaluations.setupWizard.step2.item1": "添加“设置输出”操作，将每个输出记录到 Google 表格",
  "evaluations.setupWizard.step2.button": "添加“设置输出”节点",
  "evaluations.setupWizard.step3.title": "设置质量评分",
  "evaluations.setupWizard.step3.item1": "计算评分，例如通过对比预期输出与实际输出",
  "evaluations.setupWizard.step3.item2": "添加“设置指标”操作记录得分",
  "evaluations.setupWizard.step3.button": "添加“设置指标”节点",
  "evaluations.setupWizard.step3.skip": "跳过",
  "evaluations.setupWizard.step3.notice": "你的当前套餐仅支持一个工作流的自定义指标。{link}",
  "evaluations.setupWizard.step3.notice.link": "查看套餐",
  "evaluations.setupWizard.step4.title": "运行评估",
  "evaluations.setupWizard.step4.button": "开始评估",
  "evaluations.setupWizard.step4.altButton": "在编辑器中运行",
  "evaluations.setupWizard.limitReached": "已达使用上限。你的套餐仅支持一个工作流的自定义指标。可升级套餐以获取无限使用，或删除已有评估运行的工作流。",
  "insights.heading": "洞察",
 "insights.lastNDays": "最近 {count} 天",
  "insights.lastNHours": "最近 {count} 小时",
  "insights.months": "{count} 个月",
  "insights.oneYear": "一年",
  "insights.banner.noData.tooltip": "手动执行不会被统计。升级后数据可能最多需要 24 小时更新。{link}",
  "insights.banner.noData.tooltip.link": "了解更多",
  "insights.banner.noData.tooltip.link.url": "https://docs.n8n.io/insights/",
  "insights.banner.title.timeSavedDailyAverage": "每天节省的时间（平均）",
  "insights.dashboard.table.projectName": "项目名称",
  "insights.dashboard.table.estimate": "估算值",
  "insights.dashboard.title": "洞察",
  "insights.dashboard.paywall.cta": "升级",
  "insights.dashboard.paywall.title": "升级以访问更详细的洞察",
  "insights.dashboard.paywall.description": "获取更精细的每个工作流洞察，以及按时间段划分的生产执行图表。",
  "insights.banner.title.timeSaved.tooltip": "从你设置的每次执行节省的时间估算中，计算出的总节省时间",
  "insights.banner.failureRate.deviation.tooltip": "与上一周期相比的百分比变化",
  "insights.chart.failed": "失败",
  "insights.chart.succeeded": "成功",
  "insights.chart.loading": "正在加载数据",
  "communityNodesDocsLink.link.title": "打开社区节点文档",
  "communityNodesDocsLink.title": "文档",
  "communityNodeItem.node.hint": "安装此节点以开始使用",
  "communityNodeItem.actions.hint": "安装此节点以使用操作",
  "communityNodeItem.label": "添加到工作流",
  "communityNodeDetails.installed": "已安装",
  "communityNodeDetails.install": "安装节点",
  "communityNodeInfo.approved": "此社区节点已由 n8n 审核并通过",
  "communityNodeInfo.officialApproved": "此节点已由 n8n 审核并通过",
  "communityNodeInfo.approved.label": "已验证",
  "communityNodeInfo.unverified": "此社区节点是通过 npm 添加的，尚未由 n8n 验证",
  "communityNodeInfo.unverified.label": "通过 npm",
  "communityNodeInfo.downloads": "{downloads} 次下载",
  "communityNodeInfo.publishedBy": "由 {publisherName} 发布",
  "communityNodeInfo.contact.admin": "请联系管理员安装此社区节点：",
  "insights.upgradeModal.button.dismiss": "稍后再说",
  "insights.upgradeModal.button.upgrade": "立即升级",
  "insights.upgradeModal.content": "查看此时间范围需要企业版计划。升级到 Enterprise 以解锁高级功能。",
  "insights.upgradeModal.perks.0": "查看最长一年的历史洞察记录",
  "insights.upgradeModal.perks.1": "以小时为单位查看过去 24 小时内的趋势",
  "insights.upgradeModal.perks.2": "深入了解工作流随时间的趋势",
  "insights.upgradeModal.title": "升级到 Enterprise",
   "generic.retry": "重试",
  ...
  "formInput.validator.maxCharactersRequired": "最多允许 {maximum} 个字符",
  ...
  "assistantChat.builder.thumbsDown": "无帮助",
  "assistantChat.builder.feedbackPlaceholder": "告诉我们你的使用体验",
  "assistantChat.builder.success": "感谢你的反馈！",
  "assistantChat.builder.submit": "提交反馈",
  "assistantChat.builder.workflowGenerated1": "你的工作流已成功创建！",
  "assistantChat.builder.workflowGenerated2": "测试前请先修复缺失的凭据。",
  ...
  "auth.changePassword.passwordsMustMatchError": "密码必须一致",
  "generic.credentials": "凭据",
  "aiAssistant.tooltip": "咨询助手",
  "codeNodeEditor.askAi.generationFailedWithReason": "代码生成失败，错误：{error}。请几分钟后重试",
  "dataMapping.tableView.columnCollapsing": "折叠行",
  "dataMapping.tableView.columnCollapsing.tooltip": "折叠行（以便比较此列中的值）",
  "mainSidebar.whatsNew": "新功能",
  "mainSidebar.whatsNew.fullChangelog": "完整更新日志",
  "ndv.close.tooltip": "数据已保存，可安全关闭",
  "ndv.input.noOutputData.v2.title": "无输入数据",
  "ndv.input.noOutputData.v2.description": "{link}查看输入数据",
  "ndv.input.noOutputData.v2.action": "执行前面的节点",
  "ndv.input.noOutputData.v2.tooltip": "从最早未执行的节点开始，或已执行但之后被修改的节点",
  "ndv.input.notConnected.v2.title": "未连接输入",
  "ndv.input.notConnected.v2.description": "只有将此节点连接到另一个节点，它才能接收输入数据。{link}",
  "ndv.output.noOutputData.v2.title": "无输出数据",
  "ndv.output.noOutputData.v2.description": "{link}查看输出数据",
  ...
  "nodeView.templateLink": "或从模板开始",
  "nodeView.focusPanel.title": "焦点",
  "nodeView.focusPanel.noParameters": "无聚焦的参数。通过点击节点详情视图中的操作下拉菜单来聚焦参数。",
  "nodeView.focusPanel.missingParameter": "此参数在节点上已不再可见。可能是相关参数已更改，导致此参数被移除。",
  "nodeView.showError.openExecution.node": "打开执行中的节点时出现问题",
  "nodeView.expandAllNodes": "展开所有节点",
  "nodeView.collapseAllNodes": "折叠所有节点",
  "parameterInput.focusParameter": "聚焦参数",
  "settings.communityNodes.confirmModal.update.warning": "此版本未经过n8n验证，可能包含破坏性更改或错误。",
  "settings.users.search.placeholder": "按名称或电子邮件搜索",
  "settings.users.passwordResetLinkError": "无法获取密码重置链接",
  "settings.users.userNotFound": "未找到用户",
  "settings.users.table.update.error": "更新表格失败",
  "settings.users.table.header.user": "@:_reusableBaseText.user",
  "settings.users.table.header.accountType": "账户类型",
  "settings.users.table.header.2fa": "双重认证",
  "settings.users.table.header.lastActive": "最后活跃时间",
  ...
  "settings.users.table.row.role.description.admin": "对所有工作流、凭据、项目、用户等拥有完全访问权限",
  "settings.users.table.row.role.description.member": "管理和创建自己的工作流及凭据",
  ...
  "settings.sourceControl.modals.push.projectAdmin.callout": "如果您想从个人空间推送工作流，请先将它们移至项目中。",
  "workflows.empty.startWithTemplate": "从模板开始",
  "settings.personal.mfa.enforced": "此实例的设置<strong>要求您设置双重认证</strong>。请启用它以继续在此实例中工作。",
  "settings.personal.mfa.enforce.message": "对该实例上的所有用户强制启用双重认证。",
  "settings.personal.mfa.enforce.unlicensed_tooltip": "升级计划后，您可以对该实例上的所有用户强制启用双重认证。{action}",
  "settings.personal.mfa.enforce.unlicensed_tooltip.link": "查看计划",
  "settings.personal.mfa.enforce.title": "强制双重认证",
  "settings.personal.mfa.enforce.error": "无法对所有用户强制启用双重认证",
  "settings.personal.mfa.enforce.enabled.title": "已强制双重认证",
  "settings.personal.mfa.enforce.enabled.message": "现在该实例上的所有用户都需要进行双重认证。",
  "whatsNew.versionsBehind": "落后{count}个版本 | 落后{count}个版本",
  "whatsNew.update": "更新",
  "whatsNew.updateAvailable": "您当前使用的是{currentVersion}版本。更新到{latestVersion}版本，即可获得{count}个版本的新功能、改进和修复。查看更改内容",
  "whatsNew.updateAvailable.changelogLink": "完整更新日志",
  "generic.clear": "清除",
  "generic.startNow": "立即开始",
  "generic.unknownError": "发生未知错误",
  "generic.never": "从不",
  "aiAssistant.builder.workflowParsingError.title": "无法插入工作流",
  "aiAssistant.builder.workflowParsingError.content": "AI 返回的工作流无法解析。请重试。",
  "aiAssistant.builder.canvasPrompt.buildWorkflow": "创建工作流",
  "aiAssistant.builder.canvasPrompt.title": "你想自动化什么？",
  "aiAssistant.builder.canvasPrompt.confirmTitle": "替换当前提示？",
  "aiAssistant.builder.canvasPrompt.confirmMessage": "这将替换你当前的提示。确定吗？",
  ...
  "aiAssistant.thinkingSteps.runningTools": "正在运行工具...",
  "aiAssistant.thinkingSteps.processingResults": "正在处理结果...",
  "ndv.input.noOutputData.embeddedNdv.link": "执行前置节点",
  "ndv.input.noOutputData.embeddedNdv.description": "在此使用它们的数据 {link}",
  "node.settings.continuesOnError": "即使节点失败也会继续执行",
  "node.settings.continuesOnError.title": "失败后继续",
  "node.settings.retriesOnFailure": "此节点失败时将自动重试",
  "node.settings.executeOnce": "无论有多少输入项，此节点只执行一次",
  "node.settings.alwaysOutputData": "如果通常没有返回内容，此节点将输出一个空项",
  "nodeCreator.preBuiltAgents.title": "预构建代理",
  "nodeCreator.preBuiltAgents.description": "使用现成的代理更快上手",
  "nodeSettings.parametersShort": "参数",
  "nodeSettings.action": "操作",
  "nodeSettings.credential": "认证",
  "nodeView.focusPanel.noExecutionData": "执行前置节点以启用自动补全",
  "nodeView.focusPanel.noParameters.title": "在此显示节点参数，方便迭代",
  "nodeView.focusPanel.noParameters.subtitle": "例如，让提示始终可见，这样可以在调整时运行工作流",
  "nodeView.enterZoomMode": "进入缩放模式",
  "nodeView.leaveZoomMode": "退出缩放模式",
  "prompts.npsSurvey.feedbackQuestionTitle": "谢谢！你为什么选择这个分数？",
  "settings.communityNodes.confirmModal.uninstall.description": "卸载该包将移除其中包含的所有节点。以下工作流将受到影响：",
  "settings.communityNodes.confirmModal.noWorkflowsUsingNodes": "此包中的节点未在任何工作流中使用",
  "settings.communityNodes.confirmModal.includedNodes": "包包含：{nodes}",
  "settings.communityNodes.confirmModal.cancel": "取消",
  "settings.users.count": "{count} 个用户",
  "userActivity.daysAgo": "{count} 天前",
  "userActivity.lastTime": "上次 {time}",
  "userActivity.today": "今天",
  "userActivity.yesterday": "昨天",
  "ndv.nodeHints.disabled": "此节点已禁用，仅会传递输入",
  "ndv.nodeHints.alwaysOutputData": "如果通常没有返回内容，此节点将输出一个空项",
  "ndv.nodeHints.alwaysOutputData.short": "如果没有返回内容则输出一个空项",
  "ndv.nodeHints.executeOnce": "无论有多少输入项，此节点只执行一次",
  "ndv.nodeHints.executeOnce.short": "只执行一次，无论输入多少",
  "ndv.nodeHints.retryOnFail": "此节点失败时将自动重试",
  "ndv.nodeHints.retryOnFail.short": "失败时自动重试",
  "ndv.nodeHints.continueOnError": "即使节点失败也会继续执行",
  "ndv.nodeHints.continueOnError.short": "失败时继续执行",
  ...
  "workflowProductionChecklist.ignoreAllConfirmation.description": "关闭后，将在所有工作流中忽略这些建议",
  "workflowProductionChecklist.ignoreAllConfirmation.confirm": "对所有工作流忽略",
  "workflowProductionChecklist.turnOffWorkflowSuggestions": "对所有工作流忽略",
  "workflowProductionChecklist.evaluations.title": "测试 AI 步骤的可靠性",
  "workflowProductionChecklist.evaluations.description": "使用评估来检查在不同输入下的表现。",
  "workflowProductionChecklist.errorWorkflow.title": "设置错误通知",
  "workflowProductionChecklist.errorWorkflow.description": "通过设置错误工作流自定义通知方式",
  "workflowProductionChecklist.timeSaved.title": "跟踪节省的时间",
  "workflowProductionChecklist.timeSaved.description": "配置每次运行节省的时间，用于统计减少的人工工作。",
  "workflowSettings.name": "工作流名称",
  "workflowSettings.executionTimeout": "工作流超时",
  ...
  "workflows.templateRecoV2.loadingTemplates": "正在加载模板...",
  "workflows.templateRecoV2.useTemplate": "使用模板",
  "workflows.templateRecoV2.exploreTemplates": "或探索模板，快速获取灵感和学习：",
  "workflows.ai.starter.collection.callout": "学习如何在 n8n 中构建 AI 代理",
  "workflows.ai.starter.collection.card": "学习如何构建 AI 代理",
  "workflows.ai.starter.collection.folder.name": "🎁 n8n 基础：学习如何在 n8n 中构建代理",
  "workflows.ai.starter.collection.error": "加载 AI 代理入门合集出错，请稍后重试。",
  "workflows.readyToRunWorkflows.card": "尝试一个工作流 - 无需设置",
  "workflows.readyToRunWorkflows.card2": "运行一个工作流",
  "workflows.readyToRunWorkflows.card3": "查看 n8n 实际运行效果",
  "workflows.readyToRunWorkflows.callout": "查看 n8n 实际运行效果 - 无需设置",
  "workflows.readyToRunWorkflows.callout2": "运行一个工作流",
  "workflows.readyToRunWorkflows.callout3": "查看 n8n 实际运行效果",
  "workflows.readyToRunWorkflows.cta": "运行一个工作流",
  "workflows.readyToRunWorkflows.folder.name": "🚀 即开即用的工作流",
  "workflows.readyToRunWorkflows.error": "加载 n8n 合集出错，请稍后重试。",
  "workflows.archivedOnly.hint": "已归档的工作流在此视图中被隐藏。{link}",
  "workflows.archivedOnly.hint.link": "更新筛选条件",
  "dataStore.empty.label": "你还没有任何数据存储",
  "dataStore.empty.description": "创建项目数据存储后，它们将显示在此处",
  "dataStore.empty.button.label": "在“{projectName}”中创建数据存储",
  "dataStore.card.size": "{size}MB",
  "dataStore.card.column.count": "{count} 列",
  "dataStore.card.row.count": "{count} 条记录",
  "dataStore.sort.lastUpdated": "按最后更新时间排序",
  "dataStore.sort.lastCreated": "按创建时间排序",
  "dataStore.sort.nameAsc": "按名称排序 (A-Z)",
  "dataStore.sort.nameDesc": "按名称排序 (Z-A)",
  "dataStore.search.placeholder": "搜索",
  "dataStore.error.fetching": "加载数据存储出错",
  "dataStore.add.title": "创建数据存储",
  "dataStore.add.description": "设置一个新的数据存储来组织和管理你的数据。",
  "dataStore.add.button.label": "创建数据存储",
  "dataStore.add.input.name.label": "数据存储名称",
  "dataStore.add.input.name.placeholder": "输入数据存储名称",
  "dataStore.add.error": "创建数据存储出错",
  "dataStore.delete.confirm.title": "删除数据存储",
  "dataStore.delete.confirm.message": "确定要删除数据存储“{name}”吗？此操作无法撤销。",
  "dataStore.delete.error": "删除数据存储出错",
  "dataStore.rename.error": "重命名数据存储出错",
  "dataStore.getDetails.error": "获取数据存储详情出错",
  "dataStore.notFound": "未找到数据存储",
  "dataStore.noColumns.heading": "尚无列",
  "dataStore.noColumns.description": "添加列以开始在此数据存储中保存数据。",
  "dataStore.noColumns.button.label": "添加第一列",
  "dataStore.addColumn.label": "添加列",
  "dataStore.addColumn.nameInput.label": "@:_reusableBaseText.name",
  "dataStore.addColumn.nameInput.placeholder": "输入列名",
  "dataStore.addColumn.typeInput.label": "@:_reusableBaseText.type",
  "dataStore.addColumn.error": "添加列出错",
  "dataStore.addColumn.invalidName.error": "无效的列名",
  "dataStore.addColumn.invalidName.description": "列名只能包含字母、数字，且不能以短横线开头",
  "settings.personal.mfa.enforce.disabled.title": "不再强制启用两步验证",
  "settings.personal.mfa.enforce.disabled.message": "使用邮箱和密码登录的用户，不再强制启用双因素认证。",
  "evaluation.listRuns.allTestCases": "所有测试用例 | 所有测试用例 ({count})",
  "evaluation.listRuns.error.cantStopTestRun": "无法停止测试运行",
  "evaluation.runDetail.notice.useSetInputs": "提示：在工作流中添加评估节点的“设置输入”操作，可以在此显示数据集中的输入列",
  "evaluation.stopTest": "停止测试",
  "evaluations.readOnlyNotice": "只读模式下无法创建评估。请在开发环境中构建你的评估。",
  "insights.dashboard.table.title": "按工作流分解",
  "communityNodeUpdateInfo.available": "有新的节点包版本可用",
  "workflowDiff.changes": "更改",
  ...
  "workflowDiff.noChanges": "无更改",
  "workflowDiff.deletedWorkflow": "缺失的工作流",
  "workflowDiff.deletedWorkflow.database": "数据库中不存在此工作流",
  "workflowDiff.deletedWorkflow.remote": "远程不存在此工作流",
  "workflowDiff.newWorkflow": "新工作流",
  "workflowDiff.newWorkflow.database": "该工作流将在数据库中创建",
  "workflowDiff.newWorkflow.remote": "该工作流将在远程创建",
  "generic.saving": "正在保存",
  "generic.list.clearSelection": "清除选择",
  "generic.list.selected": "已选择 {count} 行：",
  "about.thirdPartyLicenses": "第三方许可证",
  "about.thirdPartyLicensesLink": "查看所有第三方许可证",
  "about.thirdPartyLicenses.downloadError": "下载第三方许可证文件失败",
  "aiAssistant.builder.plan.intro": "您要继续执行此计划吗？",
  "aiAssistant.builder.plan.approve": "批准计划",
  "aiAssistant.builder.plan.reject": "请求修改",
  "aiAssistant.builder.plan.whatToChange": "您想修改什么？",
  "workflows.empty.preBuiltAgents": "尝试使用预建代理",
  "workflows.preBuiltAgents.callout": "使用我们的",
  "workflows.preBuiltAgents.linkText": "预建代理",
  "dataStore.moveColumn.error": "移动列时出错",
  "dataStore.deleteColumn.error": "删除列时出错",
  "dataStore.deleteColumn.confirm.title": "删除列",
  "dataStore.deleteColumn.confirm.message": "确定要删除 \\"{name}\\" 列吗？此操作无法撤销。",
  "dataStore.fetchContent.error": "获取数据存储内容时出错",
  "dataStore.addRow.label": "添加行",
  "dataStore.addRow.error": "添加行时出错",
  "dataStore.updateRow.error": "更新行时出错",
  "dataStore.deleteRows.title": "删除行",
  "dataStore.deleteRows.confirmation": "确定要删除 {count} 行吗？",
  "dataStore.deleteRows.success": "行已成功删除",
  "dataStore.deleteRows.error": "删除行时出错",
  "settings.sso.settings.save.error_oidc": "保存 OIDC SSO 配置时出错",
  "projects.header.overview.subtitleWithDataTables": "您有权访问的所有工作流、凭据和数据表",
  "projects.header.personal.subtitleWithDataTables": "您拥有的工作流、凭据和数据表",
  "workflowDiff.compare": "比较版本",
  "preBuiltAgentTemplates.title": "预建代理",
  "preBuiltAgentTemplates.tutorials": "教程模板",
  "preBuiltAgentTemplates.viewAllLink": "查看所有模板",
    "generic.clear": "清除",
  "generic.betaProper": "测试版",
  "generic.error.subworkflowCreationFailed": "创建子工作流失败",
  "generic.startNow": "立即开始",
  "generic.saving": "保存中",
  "generic.name": "名称",
  "generic.update": "更新",
  ...
  "generic.never": "从不",
  "generic.list.clearSelection": "清除选择",
  "generic.list.selected": "{count} 行已选",
  "generic.project": "项目",
  "generic.your": "您的",
  ...
  "auth.confirmPassword.confirmPasswordToChangeEmail": "请确认您的密码以更改邮箱地址。",
  "aiAssistant.tabs.ask": "提问",
  "aiAssistant.tabs.build": "构建",
  "aiAssistant.builder.assistantPlaceholder": "您想要修改或添加什么？",
  "aiAssistant.builder.characterLimit": "已达到 {limit} 字符限制",
  "aiAssistant.builder.workflowParsingError.title": "无法插入工作流",
  "aiAssistant.builder.workflowParsingError.content": "AI 返回的工作流无法解析。请重试。",
  "aiAssistant.builder.canvasPrompt.title": "您想自动化什么？",
  "aiAssistant.builder.canvasPrompt.confirmTitle": "替换当前提示？",
  "aiAssistant.builder.canvasPrompt.confirmMessage": "这将替换您当前的提示。确定吗？",
  "aiAssistant.builder.canvasPrompt.confirmButton": "替换",
  "aiAssistant.builder.canvasPrompt.cancelButton": "取消",
  "aiAssistant.builder.canvasPrompt.startManually.title": "手动开始",
  "aiAssistant.builder.canvasPrompt.startManually.subTitle": "添加第一个节点",
  "aiAssistant.builder.streamAbortedMessage": "[任务已中止]",
  "aiAssistant.builder.executeMessage.description": "在执行工作流前完成以下步骤：",
  "aiAssistant.builder.executeMessage.noIssues": "您的工作流已准备就绪，可以执行",
  "aiAssistant.builder.executeMessage.validationTooltip": "请先完成上述步骤再执行",
  "aiAssistant.builder.executeMessage.execute": "执行并优化",
  "aiAssistant.builder.executeMessage.noExecutionData": "无法启动工作流执行。请重试。",
  "aiAssistant.builder.executeMessage.executionSuccess": "工作流执行成功。",
  "aiAssistant.builder.executeMessage.executionFailedOnNode": "工作流在节点 \\"{nodeName}\\" 执行失败：{errorMessage}",
  "aiAssistant.builder.executeMessage.executionFailed": "工作流执行失败：{errorMessage}",
  "aiAssistant.builder.toast.title": "发送聊天消息以启动执行",
  "aiAssistant.builder.toast.description": "请在聊天面板中发送消息以启动工作流执行",
  "aiAssistant.tooltip": "向助手提问",
  "codeNodeEditor.askAi.generationFailedWithReason": "代码生成失败，错误为：{error}。请几分钟后重试。",
  "communityNodeFooter.legacy": "旧版",
  "communityNodeFooter.manage": "管理",
  "communityNodeFooter.reportIssue": "报告问题",
  "dataMapping.tableView.columnCollapsing": "收起行",
  "dataMapping.tableView.columnCollapsing.tooltip": "收起行（以便比较此列中的值）",
  "experiments.personalizedTemplatesV3.browseAllTemplates": "浏览我们的模板库",
  "experiments.personalizedTemplatesV3.couldntFind": "需要其他内容？",
  "experiments.personalizedTemplatesV3.exploreTemplates": "使用 HubSpot 工作流开始：",
  "experiments.personalizedTemplatesV3.loadingTemplates": "正在加载推荐...",
  "experiments.personalizedTemplatesV3.recommendationTooltip": "使用这些工作流加快您的自动化进程",
  ...
  "ndv.input.noOutputData.v2.tooltip": "从最早未执行或已修改的已执行节点开始执行",
  "ndv.input.noOutputData.embeddedNdv.link": "执行前置节点",
  "ndv.input.noOutputData.embeddedNdv.description": "{link} 以在此处使用其数据",
  "ndv.input.notConnected.v2.title": "未连接输入",
  "ndv.input.notConnected.v2.description": "只有连接到其他节点时，此节点才能接收输入数据。{link}",
  "ndv.output.itemsTotal": "共 {count} 项",
  "ndv.output.noOutputData.v2.title": "无输出数据",
  "ndv.output.noOutputData.v2.description": "{link} 查看输出数据",
  "ndv.output.noOutputData.v2.action": "测试此步骤",
  "ndv.output.noOutputData.trigger.title": "无触发器输出",
  "ndv.output.noOutputData.trigger.action": "测试此触发器",
  "ndv.title.rename.placeholder": "输入新名称...",
  "node.settings.continuesOnError": "即使节点失败，执行也会继续",
  "node.settings.continuesOnError.title": "失败时继续",
  "node.settings.retriesOnFailure": "此节点在失败时将自动重试",
  "node.settings.executeOnce": "此节点仅执行一次，无论输入项目有多少",
  "node.settings.alwaysOutputData": "如果通常不返回任何内容，此节点将输出一个空项目",
  "nodeCreator.nodeItem.beta": "测试版",
  "nodeCreator.preBuiltAgents.title": "预建代理",
  "nodeCreator.preBuiltAgents.description": "使用现成的代理更快地开始",
  "nodeSettings.parametersShort": "参数",
  "nodeSettings.action": "操作",
  "nodeSettings.credential": "认证",
  "nodeView.openFocusPanel": "打开聚焦面板",
  "nodeView.templateLink": "或从模板开始",
  "nodeView.focusPanel.noExecutionData": "执行前置节点以启用自动补全",
  "nodeView.focusPanel.noParameters.title": "在此处显示一个节点参数以便轻松迭代",
  "nodeView.focusPanel.noParameters.subtitle": "例如，始终显示您的提示，以便在调整时运行工作流",
  "nodeView.focusPanel.v2.noParameters.title": "选择一个节点在此处编辑",
  "nodeView.focusPanel.v2.noParameters.subtitle": "或者点击其旁边的按钮，显示您想迭代的单个节点参数：",
  "nodeView.focusPanel.missingParameter": "此参数在节点上不再可见。可能是相关参数被更改，导致此参数被移除。",
  "nodeView.showError.openExecution.node": "打开执行中的节点时出现问题",
  "nodeView.expandAllNodes": "展开所有节点",
  "nodeView.collapseAllNodes": "收起所有节点",
  "nodeView.enterZoomMode": "进入缩放模式",
  "nodeView.leaveZoomMode": "退出缩放模式",
  "parameterInput.focusParameter": "聚焦参数",
  "prompts.npsSurvey.feedbackQuestionTitle": "谢谢！您为什么选择这个评分？",
  "resourceLocator.dataTable.createNew": "创建新数据表",
  "runData.executionStatus.canceled": "执行已取消",
  "settings.communityNodes.confirmModal.uninstall.description": "卸载此包将删除该包中所有节点的实例。以下工作流将受到影响：",
  "settings.communityNodes.confirmModal.noWorkflowsUsingNodes": "此包的节点未在任何工作流中使用",
  "settings.communityNodes.confirmModal.includedNodes": "包包含：{nodes}",
  "settings.communityNodes.confirmModal.update.warning": "此版本未经 n8n 验证，可能包含破坏性更改或错误。",
  "settings.communityNodes.confirmModal.cancel": "取消",
  "settings.mcp": "MCP 访问权限",
  "settings.mcp.toggle.label": "启用 MCP",
  "settings.mcp.toggle.description": "允许访问此 n8n 实例的 MCP",
  "settings.mcp.available.workflows.heading": "可用工作流",
  "settings.mcp.connection.info.heading": "如何连接",
  "settings.mcp.workflows.table.action.removeMCPAccess": "移除 MCP 访问权限",
  "settings.mcp.empty.title": "无可用的 MCP 工作流",
  "settings.mcp.empty.description": "在每个工作流的设置中启用 MCP 访问权限，即可在此处看到它们。",
  "settings.mcp.toggle.disabled.tooltip": "仅实例所有者可更改此设置",
  "settings.mcp.instructions.enableAccess": "在至少一个工作流的设置中启用工作流访问权限",
  "settings.mcp.instructions.serverUrl": "服务器 URL",
  "settings.mcp.instructions.apiKey.part1": "创建一个",
  "settings.mcp.instructions.apiKey.part2": "无需作用域，MCP 使用您的角色进行授权",
  "settings.mcp.instructions.json": "或在您的 'mcp.json' 文件中使用以下代码",
  "settings.mcp.instructions.docs.part1": "有关更详细的说明和示例，请查看",
  "settings.mcp.instructions.docs.part2": "我们的文档",
  "settings.users.count": "{count} 个用户",
  "settings.users.search.placeholder": "按名称或邮箱搜索",
  "settings.users.passwordResetLinkError": "无法获取密码重置链接",
  "settings.users.userNotFound": "用户未找到",
  "settings.users.table.update.error": "更新表格失败",
  "settings.users.table.header.user": "用户",
  "settings.users.table.header.accountType": "账户类型",
  "settings.users.table.header.2fa": "双重验证 (2FA)",
  "settings.users.table.header.lastActive": "最后活跃时间",
  "settings.users.table.row.allProjects": "所有项目",
  "settings.users.table.row.personalProject": "个人项目",
  "settings.users.table.row.deleteUser": "移除用户",
  "settings.users.table.row.role.description.admin": "完全访问所有工作流、凭据、项目、用户等",
  "settings.users.table.row.role.description.member": "管理和创建自己的工作流及凭据",
  ...
  "settings.sourceControl.modals.push.filter": "已应用过滤器。显示 {count} 个 {entity}。",
  "settings.sourceControl.modals.push.projectAdmin.callout": "如需推送个人空间中的工作流，请先将其移至项目。",
  ...
  "settings.sourceControl.sshRepoUrlPlaceholder": "git{'@'}github.com:用户/仓库.git",
  "settings.sourceControl.httpsRepoUrlPlaceholder": "https://github.com/用户/仓库.git",
  "settings.sourceControl.sshFormatNotice": "使用 SSH 格式：git{'@'}github.com:用户/仓库.git",
  "settings.sourceControl.httpsFormatNotice": "使用 HTTPS 格式：https://github.com/用户/仓库.git",
  "settings.sourceControl.httpsUsername": "用户名",
  "settings.sourceControl.httpsUsernamePlaceholder": "输入您的 GitHub 用户名",
  ...
  "settings.sourceControl.httpsWarningNotice": "{strong} 如需在 GitHub 上创建：前往 设置 → 开发者设置 → 个人访问令牌 → 令牌（经典版）。所需作用域：{repo}（私有仓库）或 {publicRepo}（公有仓库）。也支持其他平台。",
  ...
  "ndv.nodeHints.disabled": "此节点已禁用，将直接传递输入数据",
  "ndv.nodeHints.alwaysOutputData": "如果通常不返回任何内容，此节点将输出一个空项目",
  "ndv.nodeHints.alwaysOutputData.short": "在无正常返回时输出空项目",
  "ndv.nodeHints.executeOnce": "此节点仅执行一次，无论输入项目有多少",
  "ndv.nodeHints.executeOnce.short": "无论输入多少项目，仅执行一次",
  "ndv.nodeHints.retryOnFail": "此节点在失败时将自动重试",
  "ndv.nodeHints.retryOnFail.short": "失败时自动重试",
  "ndv.nodeHints.continueOnError": "即使节点失败，执行也会继续",
  "ndv.nodeHints.continueOnError.short": "即使节点失败也继续执行",
  "workflowProductionChecklist.title": "生产环境检查清单",
  "workflowProductionChecklist.readOnlyNotice": "只读环境。请在开发环境中更新这些项目并推送更改。",
  "workflowProductionChecklist.ignoreAllConfirmation.title": "全局忽略建议操作",
  "workflowProductionChecklist.ignoreAllConfirmation.description": "关闭此选项后，这些建议将从所有工作流中消失",
  "workflowProductionChecklist.ignoreAllConfirmation.confirm": "对所有工作流忽略",
  "workflowProductionChecklist.turnOffWorkflowSuggestions": "对所有工作流忽略",
  "workflowProductionChecklist.evaluations.title": "测试 AI 步骤的可靠性",
  "workflowProductionChecklist.evaluations.description": "使用评估功能检查在各种输入下的性能表现。",
  "workflowProductionChecklist.errorWorkflow.title": "设置错误通知",
  "workflowProductionChecklist.errorWorkflow.description": "通过设置错误工作流，自定义您接收通知的方式。",
  "workflowProductionChecklist.timeSaved.title": "跟踪节省的时间",
  "workflowProductionChecklist.timeSaved.description": "配置每次运行节省的时间，以追踪其替代的手动工作量。",
  "workflowSettings.name": "工作流名称",
  "workflowSettings.executionTimeout": "工作流超时",
  "workflowSettings.tags": "标签",
  "workflowSettings.availableInMCP": "在 MCP 中可用",
  "workflowSettings.availableInMCP.tooltip": "通过 n8n MCP 使此工作流对 AI 代理可见",
  "workflowSettings.toggleMCP.error.title": "更新 MCP 设置时出错",
  "workflowSettings.toggleMCP.notFoundError": "未找到工作流",
  "workflows.item.availableInMCP": "在 MCP 中可用",
  "workflows.item.enableMCPAccess": "启用 MCP 访问权限",
  "workflows.item.disableMCPAccess": "移除 MCP 访问权限",
  "workflows.itemSuggestion.try": "尝试模板",
  "workflows.templateRecoV2.starterTemplates": "入门模板",
  "workflows.templateRecoV2.seeMoreStarterTemplates": "查看更多入门模板",
  "workflows.templateRecoV2.popularTemplates": "热门模板",
  ...
  "workflows.templateRecoV2.loadingTemplates": "正在加载模板...",
  "workflows.templateRecoV2.useTemplate": "使用模板",
  "workflows.templateRecoV2.exploreTemplates": "或浏览模板以获取灵感并快速学习：",
  "workflows.empty.startWithTemplate": "从模板开始",
  "workflows.empty.preBuiltAgents": "尝试预建代理",
  "workflows.empty.readyToRunV2": "尝试一个 AI 工作流",
  "workflows.ai.starter.collection.callout": "学习如何在 n8n 中构建 AI 代理",
  "workflows.ai.starter.collection.card": "学习如何构建 AI 代理",
  "workflows.ai.starter.collection.folder.name": "🎁 n8n 基础：学习如何在 n8n 中构建代理",
  "workflows.ai.starter.collection.error": "加载 AI 代理入门集合时出错。请稍后重试。",
  "workflows.readyToRunWorkflows.card": "尝试一个工作流 - 无需设置",
  "workflows.readyToRunWorkflows.card2": "运行一个工作流",
  "workflows.readyToRunWorkflows.card3": "查看 n8n 的实际效果",
  "workflows.readyToRunWorkflows.callout": "查看 n8n 的实际效果 - 无需设置",
  "workflows.readyToRunWorkflows.callout2": "运行一个工作流",
  "workflows.readyToRunWorkflows.callout3": "查看 n8n 的实际效果",
  "workflows.readyToRunWorkflows.cta": "运行一个工作流",
  "workflows.readyToRunWorkflows.folder.name": "🚀 即开即用的工作流",
  "workflows.readyToRunWorkflows.error": "加载 n8n 集合时出错。请稍后重试。",
  "workflows.archivedOnly.hint": "已归档的工作流在此视图中被隐藏。{link}",
  "workflows.archivedOnly.hint.link": "更新筛选条件",
  "workflows.preBuiltAgents.callout": "使用我们的",
  "workflows.preBuiltAgents.linkText": "预建代理",
  "dataStore.dataStores": "数据表",
  "dataStore.empty.label": "您还没有任何数据表",
  "dataStore.empty.description": "使用数据表来持久化执行结果、在工作流之间共享数据，并为评估跟踪指标。",
  "dataStore.card.size": "{size}MB",
  "dataStore.card.column.count": "{count} 列",
  "dataStore.card.row.count": "{count} 条记录",
  "dataStore.sort.lastUpdated": "按最后更新时间排序",
  ...
  "dataStore.sort.nameDesc": "按名称排序 (Z-A)",
  "dataStore.search.placeholder": "搜索",
  "dataStore.error.fetching": "加载数据表时出错",
  "dataStore.add.title": "创建新数据表",
  "dataStore.add.button.label": "创建数据表",
  "dataStore.add.input.name.label": "数据表名称",
  "dataStore.add.input.name.placeholder": "输入数据表名称",
  "dataStore.add.error": "创建数据表时出错",
  "dataStore.delete.confirm.title": "删除数据表",
  "dataStore.delete.confirm.message": "您确定要删除数据表 '{name}' 吗？此操作无法撤销。",
  "dataStore.delete.error": "删除数据表时出错",
  "dataStore.rename.error": "重命名数据表时出错",
  "dataStore.getDetails.error": "获取数据表详情时出错",
  "dataStore.notFound": "未找到数据表",
  "dataStore.noColumns.heading": "尚无列",
  "dataStore.noColumns.description": "添加列以开始在此数据表中存储数据。",
  "dataStore.noColumns.button.label": "添加首列",
  "dataStore.addColumn.label": "添加列",
  "dataStore.addColumn.nameInput.label": "名称",
  "dataStore.addColumn.nameInput.placeholder": "输入列名称",
  "dataStore.addColumn.typeInput.label": "类型",
  "dataStore.addColumn.error": "添加列时出错",
  "dataStore.addColumn.alreadyExistsError": "该列已存在",
  "dataStore.addColumn.alreadyExistsDescription": "列名已存在，请选择其他名称",
  "dataStore.moveColumn.error": "移动列时出错",
  "dataStore.deleteColumn.error": "删除列时出错",
  "dataStore.deleteColumn.confirm.title": "删除列",
  "dataStore.deleteColumn.confirm.message": "您确定要删除列 '{name}' 吗？此操作无法撤销。",
  "dataStore.addColumn.invalidName.error": "无效的列名",
  "dataStore.addColumn.invalidName.description": "列名必须以字母开头，且只能包含字母、数字或下划线",
  "dataStore.fetchContent.error": "获取数据存储内容时出错",
  "dataStore.addRow.label": "添加行",
  "dataStore.addRow.error": "添加行时出错",
  "dataStore.updateRow.error": "更新行时出错",
  "dataStore.deleteRows.title": "删除行",
  "dataStore.deleteRows.confirmation": "您确定要删除 {count} 行吗？",
  "dataStore.deleteRows.error": "删除行时出错",
  "dataStore.banner.storageLimitWarning.message": "数据表存储已使用 {usage}。请删除数据以避免错误",
  "dataStore.banner.storageLimitError.message": "数据表存储已使用 {usage}，操作可能会失败。请删除数据以避免错误",
  "dataStore.error.tableNotInitialized": "表未初始化",
  "dataStore.noRows": "无行数据",
  "dataStore.filters.isNull": "为空",
  "dataStore.filters.isNotNull": "不为空",
  "dataStore.filters.isEmpty": "为空值",
  "dataStore.filters.isNotEmpty": "不为空值",
  "dataStore.filters.between": "介于",
  "dataStore.filters.true": "为真",
  "dataStore.filters.false": "为假",
  "dataStore.filters.greaterThan": "大于",
  "dataStore.filters.greaterThanOrEqual": "大于或等于",
  "dataStore.filters.lessThan": "小于",
  "dataStore.filters.lessThanOrEqual": "小于或等于",
  "settings.sso.settings.oidc.prompt.none": "无（静默认证）",
  "settings.sso.settings.oidc.prompt.login": "登录（强制用户登录）",
  "settings.sso.settings.oidc.prompt.consent": "同意（询问用户是否同意）",
  "settings.sso.settings.oidc.prompt.select_account": "选择账户（允许用户选择账户）",
  "settings.sso.settings.oidc.prompt.create": "创建（要求 OP 首先显示注册页面）",
  "settings.sso.settings.save.error_oidc": "保存 OIDC SSO 配置时出错",
  "projects.header.overview.subtitleWithDataTables": "所有您有权访问的工作流、凭据和数据表",
  "projects.header.personal.subtitleWithDataTables": "您拥有的工作流、凭据和数据表",
  "projects.settings.info": "项目信息",
  "projects.settings.table.header.user": "用户",
  "projects.settings.table.header.role": "角色",
  "projects.settings.table.row.removeUser": "移除用户",
  "projects.settings.role.admin.description": "可编辑工作流、凭据和项目设置",
  "projects.settings.role.editor.description": "可编辑工作流和凭据",
  "projects.settings.role.viewer.description": "可查看工作流和执行记录",
  "projects.settings.role.personalOwner": "所有者",
  "projects.settings.members.search.placeholder": "搜索成员...",
  "projects.settings.memberRole.updated.title": "成员角色已成功更新",
  "projects.settings.memberRole.update.error.title": "更新成员角色时发生错误",
  "projects.settings.member.removed.title": "成员已成功移除",
  "projects.settings.member.remove.error.title": "移除成员时发生错误",
  "projects.settings.member.added.title": "成员已成功添加",
  "settings.personal.mfa.enforced": "此实例的设置<strong>要求您设置双重验证 (2FA)</strong>。请启用它以继续在此实例中工作。",
  "settings.personal.mfa.enforce.message": "对通过邮箱和密码登录此实例的所有用户强制启用双重验证 (2FA)。",
  "settings.personal.mfa.enforce.unlicensed_tooltip": "升级您的计划后，您可以对此实例上通过邮箱和密码登录的所有用户强制启用双重验证 (2FA)。{action}",
  "settings.personal.mfa.enforce.unlicensed_tooltip.link": "查看计划",
  "settings.personal.mfa.enforce.title": "强制启用双重验证",
  "settings.personal.mfa.enforce.error": "无法为所有用户强制启用双重验证 (2FA)",
  "settings.personal.mfa.enforce.enabled.title": "已强制启用 2FA",
  "settings.personal.mfa.enforce.enabled.message": "现在，对此实例上通过邮箱和密码登录的所有用户，强制要求启用双重验证 (2FA)。",
  "settings.personal.mfa.enforce.disabled.title": "2FA 不再强制启用",
  "settings.personal.mfa.enforce.disabled.message": "不再强制要求此实例上通过邮箱和密码登录的用户启用双重验证 (2FA)。",
  "type.binary": "二进制数据",
  "assignment.binaryData.placeholder": "二进制输入的名称（或引用它的表达式）",
  "evaluation.listRuns.allTestCases": "所有测试用例 ({count})",
  "evaluation.listRuns.error.cantStopTestRun": "无法停止测试运行",
  "evaluation.runDetail.notice.useSetInputs": "提示：通过在工作流中添加评估节点的“设置输入”操作，将数据集中的输入列显示在此处",
  "evaluation.stopTest": "停止测试",
  "evaluations.readOnlyNotice": "无法在只读模式下构建评估。请在您的开发环境中构建评估。",
  "insights.dashboard.table.title": "按工作流细分",
  "insights.dashboard.search.placeholder": "所有项目",
  "communityNodeUpdateInfo.available": "有新的节点包版本可用",
  "whatsNew.versionsBehind": "{count} 个版本落后",
  "whatsNew.update": "更新",
  "whatsNew.updateNudgeTooltip": "只有所有者可以执行更新",
  "whatsNew.updateAvailable": "您当前使用的是版本 {currentVersion}。更新至 {latestVersion} 以获取 {count} 个版本的新功能、改进和修复。查看变更内容",
  "whatsNew.updateAvailable.changelogLink": "完整更新日志",
  "workflowDiff.changes": "变更",
  "workflowDiff.nodes": "节点",
  "workflowDiff.connectors": "连接器",
  "workflowDiff.compare": "比较版本",
  "workflowDiff.settings": "设置",
  "workflowDiff.local": "本地",
  "workflowDiff.remote": "远程 ({branchName})",
  "workflowDiff.noChanges": "无变更",
  "workflowDiff.deletedWorkflow": "缺失的工作流",
  "workflowDiff.deletedWorkflow.database": "该工作流在数据库中不存在",
  "workflowDiff.deletedWorkflow.remote": "该工作流在远程不存在",
  "workflowDiff.newWorkflow": "新工作流",
  "workflowDiff.newWorkflow.database": "该工作流将在数据库中创建",
  "workflowDiff.newWorkflow.remote": "该工作流将在远程创建",
  "preBuiltAgentTemplates.title": "预建代理",
  ...
  "generic.copied": "已复制",
  "aiAssistant.builder.canvasPrompt.buildWithAI": "用 AI 构建",
  "aiAssistant.builder.executeMessage.fillParameter": "更新“{label}”参数",
  "codeNodeEditor.completer.$vars.varName.global": "为此 n8n 实例定义的全局变量。所有变量均解析为字符串。",
  "codeNodeEditor.completer.$vars.varName.global.overridden": "此全局变量已被项目 {projectName} 的变量覆盖。所有变量均解析为字符串。",
  "codeNodeEditor.completer.$vars.varName.project": "在 {projectName} 项目中定义的项目变量。所有变量均解析为字符串。",
  "codeNodeEditor.completer.section.variable.project": "项目变量",
  "codeNodeEditor.completer.section.variable.global": "全局变量",
  "mcp.workflowNotEligable.description": "只有处于激活状态且由 Webhook 触发的工作流才能通过 MCP 访问",
  "contextMenu.replace": "替换",
  "settings.mcp.toggle.error": "更新 MCP 访问权限时出错",
  "settings.mcp.instructions.apiKey.label": "访问令牌",
  "settings.mcp.instructions.rotateKey.tooltip": "生成新令牌。<br/>当前令牌将被自动撤销。",
  "settings.mcp.instructions.apiKey.tip": "将此用作授权令牌。在不同客户端中可能名称不同",
  "settings.mcp.newKey.notice": "请务必立即复制您的访问令牌。您将无法再次查看或复制它！",
  "settings.mcp.error.fetching.apiKey": "获取访问令牌时出错",
  "settings.mcp.error.rotating.apiKey": "生成新访问令牌时出错",
  "variables.table.scope": "作用域",
  "variables.table.scope.global": "全局",
  "variables.editing.key.error.regex": "此字段只能包含字母、数字和下划线",
  "variables.delete.successful.message": "变量 {variableName} 已删除",
  "variables.modal.title.create": "新建变量",
  "variables.modal.title.edit": "编辑变量",
  "variables.modal.key.label": "键",
  "variables.modal.value.label": "值",
  "variables.modal.scope.label": "作用域",
  "variables.modal.scope.global": "全局",
  "variables.modal.scope.all": "全部",
  "variables.modal.button.cancel": "取消",
  "variables.modal.button.save": "保存",
  "variables.modal.error.keyExistsInProject": "此键已存在于该项目中",
  "variables.modal.warning.globalKeyExists": "相同的键已存在于全局作用域中。此变量将在项目内覆盖全局变量",
  "dataTable.dataTables": "数据表",
  "dataTable.empty.label": "您还没有任何数据表",
  "dataTable.empty.description": "使用数据表来持久化执行结果、在工作流之间共享数据，并跟踪指标用于评估。",
  "dataTable.card.size": "{size}MB",
  "dataTable.card.column.count": "{count} 列",
  "dataTable.add.title": "创建新数据表",
  "dataTable.add.button.label": "创建数据表",
  ...
  "dataTable.deleteRows.confirmation": "确定要删除 {count} 行吗？",
  "dataTable.deleteRows.error": "删除行时出错",
  "dataTable.banner.storageLimitWarning.message": "已使用 {usage} 的数据表存储空间。请删除数据以避免错误",
  "dataTable.banner.storageLimitError.message": "已使用 {usage} 的数据表存储空间，操作可能会失败。请删除数据以避免错误",
  "dataTable.error.tableNotInitialized": "表未初始化",
  "dataTable.noRows": "无行",
  "dataTable.filters.isNull": "为空",
  "dataTable.filters.isNotNull": "不为空",
  "dataTable.filters.isEmpty": "为空值",
  "dataTable.filters.isNotEmpty": "不为空值",
  "dataTable.filters.between": "介于之间",
  "dataTable.filters.true": "真",
  "dataTable.filters.false": "假",
  ...
  "dataTable.addColumn.systemColumnDescription": "这是系统列，请选择其他名称",
  "dataTable.addColumn.testingColumnDescription": "此列用于测试，请选择其他名称",
  "projects.settings.role.upgrade.tooltip": "升级到专业版或企业版以分配编辑者和查看者角色",
  "commandBar.placeholder": "输入命令...",
  "commandBar.noResults": "未找到结果",
  "commandBar.sections.nodes": "节点",
  "commandBar.sections.workflow": "工作流",
  "commandBar.sections.workflows": "工作流",
  "commandBar.sections.credentials": "凭据",
  "commandBar.sections.dataTables": "数据表",
  "commandBar.sections.templates": "模板",
  ...
  "commandBar.workflow.test": "测试工作流",
  ...
  "commandBar.workflow.tidyUp": "整理工作流",
  ...
  "commandBar.workflows.searchPlaceholder": "按工作流名称或节点类型搜索...",
  "commandBar.workflows.prefixPersonal": "[个人] > ",
  "commandBar.workflows.prefixProject": "[{projectName}] > ",
  "commandBar.workflows.openPrefixPersonal": "打开工作流 > [个人] > ",
  "commandBar.workflows.openPrefixProject": "打开工作流 > [{projectName}] > ",
  "commandBar.workflows.unnamed": "(未命名工作流)",
  "commandBar.credentials.create": "在 {projectName} 中创建凭据",
  "commandBar.credentials.open": "打开凭据",
  "commandBar.credentials.searchPlaceholder": "按凭据名称搜索...",
  "commandBar.credentials.prefixPersonal": "[个人] > ",
  "commandBar.credentials.prefixProject": "[{projectName}] > ",
  "commandBar.credentials.openPrefixPersonal": "打开凭据 > [个人] > ",
  "commandBar.credentials.openPrefixProject": "打开凭据 > [{projectName}] > ",
  "commandBar.credentials.unnamed": "(未命名凭据)",
  ...
  "commandBar.dataTables.prefixPersonal": "[个人] > ",
  "commandBar.dataTables.prefixProject": "[{projectName}] > ",
  "commandBar.dataTables.openPrefixPersonal": "打开数据表 > [个人] > ",
  "commandBar.dataTables.openPrefixProject": "打开数据表 > [{projectName}] > ",
  "commandBar.dataTables.unnamed": "(未命名数据表)",
  "commandBar.templates.import": "导入模板",
  "commandBar.templates.importWithPrefix": "导入模板 > {templateName}",
  "commandBar.demo.availableEverywhere": "此功能处处可用",
   "generic.allow": "允许",
    "generic.deny": "拒绝",
    ...
    "generic.projects": "项目",
    "chatHub.agent.customAgents": "自定义智能体",
    "chatHub.agent.newAgent": "新建智能体",
    "chatHub.agent.editor.title.new": "新建智能体",
    "chatHub.agent.editor.title.edit": "编辑智能体",
    "chatHub.agent.editor.name.label": "名称",
    "chatHub.agent.editor.name.placeholder": "请输入智能体名称",
    "chatHub.agent.editor.description.label": "描述",
    "chatHub.agent.editor.description.placeholder": "请输入智能体描述（可选）",
    "chatHub.agent.editor.systemPrompt.label": "系统提示",
    "chatHub.agent.editor.systemPrompt.placeholder": "请输入系统提示",
    "chatHub.agent.editor.model.label": "模型",
    "chatHub.agent.editor.loading": "正在加载智能体……",
    "chatHub.agent.editor.saving": "保存中……",
    "chatHub.agent.editor.save": "保存",
    "chatHub.agent.editor.cancel": "取消",
    "chatHub.agent.editor.delete": "删除",
    "chatHub.agent.editor.deleting": "删除中……",
    "chatHub.agent.editor.delete.confirm.title": "删除智能体",
    "chatHub.agent.editor.delete.confirm.message": "确定要删除此智能体吗？此操作无法撤销。",
    "chatHub.agent.editor.delete.confirm.button": "删除",
    "chatHub.agent.editor.delete.cancel.button": "取消",
    "chatHub.agent.editor.error.load": "加载智能体失败",
    "chatHub.agent.editor.error.save": "保存智能体失败",
    "chatHub.agent.editor.error.delete": "删除智能体失败",
    "chatHub.agent.editor.success.create": "智能体创建成功",
    "chatHub.agent.editor.success.update": "智能体更新成功",
    "chatHub.agent.editor.success.delete": "智能体删除成功",
    "dataMapping.schemaView.previewLastExecution": "以下字段来自上次成功执行的结果。点击 {execute} 刷新。",
    "dataMapping.schemaView.previewLastExecution.executePreviousNodes": "执行节点",
    "dataMapping.schemaView.preview.executeNode": "执行该节点",
    "experiments.templatesDataQuality.modalTitle": "精选模板",
    "executionAnnotationView.vote.up": "点赞",
    "executionAnnotationView.vote.down": "点踩",
    "executionAnnotationView.vote.removeUp": "取消点赞",
    "executionAnnotationView.vote.removeDown": "取消点踩",
    "workflow.description.tooltip": "编辑工作流描述",
    "workflow.description.placeholder": "描述此工作流的目的和功能",
    "workflow.description.placeholder.mcp": "这将帮助 MCP 客户端了解何时应使用此工作流",
    "workflow.description.placeholder.mcp.webhook": "请包含有关预期 webhook 输入的详细信息（有效载荷格式以及是否应作为请求正文或 URL 参数发送）",
    "workflow.description.error.title": "更新工作流描述时出现问题",
    "mcp.instanceLevelAccessDisabled.description": "实例级别的 MCP 访问已禁用。启用后才能允许工作流级别访问。",
    "mcp.workflowDeactivated.title": "MCP 访问已禁用",
    "mcp.productionCheklist.title": "启用 MCP 访问",
    "mcp.productionCheklist.description": "允许 MCP 客户端访问此工作流",
    "mcp.workflowDeactivated.message": "由于此工作流已停用，MCP 访问已被禁用。",
    "ndv.output.logs.tooMuchData.message": "{inOut} 包含 {size} MB 的数据。显示它可能会暂时拖慢您的浏览器。",
    "node.install-to-use": "安装此包以使用该节点",
    "nodeCredentials.autoAssigned.message": "已将此凭据添加到其他 {count} 个节点",
    "nodeSettings.communityNodeUnknown.title.preview": "详细节点信息不可用",
    ...
    "oauth.consentView.title": "OAuth 访问授权",
    "oauth.consentView.heading": "{clientName} 请求访问您的 n8n 实例",
    ...
    "oauth.consentView.readMore": "在此处<a href='{docsUrl}' target='_blank'>阅读更多</a>",
    "oauth.consentView.error.deny": "拒绝访问时出错",
    "oauth.consentView.error.allow": "允许访问时出错",
    "oauth.consentView.error.fetchDetails": "获取客户端详情时出错",
    "oauth.consentView.success.title": "成功",
    "oauth.consentView.success.description": "您将很快被重定向回客户端。",
    "projectRoles.manageRoles.paywall.title": "仅限企业版可用",
    "projectRoles.manageRoles.paywall.text": "创建具有细粒度权限的自定义角色，精确控制团队成员在项目中的操作权限。",
    "projectRoles.project:read": "查看",
    "projectRoles.project:read.tooltip": "查看项目名称、图标、描述，并可在项目内导航",
    "projectRoles.project:update": "编辑",
    "projectRoles.project:update.tooltip": "编辑项目详情并管理用户",
    "projectRoles.project:delete": "删除",
    "projectRoles.project:delete.tooltip": "删除整个项目及其所有内容",
    "projectRoles.folder:read": "查看",
    "projectRoles.folder:read.tooltip": "查看项目内的文件夹和子文件夹",
    "projectRoles.folder:update": "编辑",
    "projectRoles.folder:update.tooltip": "重命名文件夹、在文件夹之间移动工作流，以及更改父文件夹",
    "projectRoles.folder:create": "创建",
    "projectRoles.folder:create.tooltip": "创建新文件夹或子文件夹",
    "projectRoles.folder:move": "转移",
    "projectRoles.folder:move.tooltip": "将文件夹及其工作流移至另一个项目",
    "projectRoles.folder:delete": "删除",
    "projectRoles.folder:delete.tooltip": "删除空文件夹。若非空，请进一步操作",
    ...
    "projectRoles.workflow:update.tooltip": "编辑工作流内容、激活/停用及执行工作流",
    "projectRoles.workflow:create": "创建",
    "projectRoles.workflow:create.tooltip": "创建工作流",
    "projectRoles.workflow:share": "共享",
    "projectRoles.workflow:move": "转移",
    "projectRoles.workflow:move.tooltip": "将工作流转移到另一个项目",
    "projectRoles.workflow:delete": "删除",
    "projectRoles.workflow:delete.tooltip": "删除工作流",
    "projectRoles.credential:read": "查看",
    "projectRoles.credential:read.tooltip": "查看凭据详情（密钥已隐藏）并在工作流中使用",
    ...
    "projectRoles.credential:share": "共享",
    "projectRoles.credential:share.tooltip": "与其他项目或用户共享凭据",
    "projectRoles.credential:move": "转移",
    "projectRoles.credential:move.tooltip": "将凭据移至另一个项目",
    "projectRoles.credential:delete": "删除",
    "projectRoles.credential:delete.tooltip": "删除凭据",
    "projectRoles.dataTable:read": "查看",
    "projectRoles.dataTable:read.tooltip": "查看数据表结构（列、名称）和元数据",
    "projectRoles.dataTable:update": "编辑",
    "projectRoles.dataTable:update.tooltip": "修改数据表结构/列",
    "projectRoles.dataTable:create": "创建",
    "projectRoles.dataTable:create.tooltip": "创建新数据表",
    "projectRoles.dataTable:delete": "删除",
    "projectRoles.dataTable:delete.tooltip": "删除数据表",
    "projectRoles.dataTable:readRow": "查看行",
    "projectRoles.dataTable:readRow.tooltip": "查看数据表行数据",
    "projectRoles.dataTable:writeRow": "编辑行",
    "projectRoles.dataTable:writeRow.tooltip": "修改数据表行数据",
    "projectRoles.projectVariable:read": "查看",
    "projectRoles.projectVariable:read.tooltip": "查看项目变量值并在工作流中使用",
    "projectRoles.projectVariable:update": "编辑",
    "projectRoles.projectVariable:update.tooltip": "修改现有项目变量",
    "projectRoles.projectVariable:create": "创建",
    "projectRoles.projectVariable:create.tooltip": "创建新项目变量",
    ...
    "projectRoles.sourceControl.table.lastEdited": "最后编辑时间",
    "projectRoles.backToRoleList": "返回角色列表",
    "projectRoles.newRole": "新建角色",
    ...
    "projectRoles.editor": "编辑者",
    "projectRoles.viewer": "查看者",
    "projectRoles.type.project": "项目",
    "projectRoles.type.folder": "文件夹",
    "projectRoles.type.workflow": "工作流",
    "projectRoles.type.credential": "凭据",
    "projectRoles.type.sourceControl": "源代码控制",
    "projectRoles.type.dataTable": "数据表",
    ...
    "projectRoles.action.delete.text": "确定要永久删除“{roleName}”吗？此操作无法撤销。",
    "projectRoles.action.delete.warning": "删除角色是永久性的，无法撤销。",
    "projectRoles.action.delete.useWarning": "在将此角色分配给 {count} 位用户时，您无法删除它。请先从所有用户中取消分配。",
    "projectRoles.dangerZone": "危险区域",
    "projectRoles.action.duplicate": "复制",
    "projectRoles.action.duplicate.name": "{roleName} 的副本",
    "projectRoles.action.duplicate.success": "角色“{roleName}”已成功复制为“{roleDuplicateName}”",
    "projectRoles.action.duplicate.error": "复制角色时出错",
    ...
    "projectRoles.action.update.title": "为 {count} 位用户更新角色？",
    "projectRoles.action.update.text": "这些更改将立即影响拥有此角色的所有 {count} 位用户。确定要继续吗？",
    "runData.pinData.insertedExecutionData": "💡 已插入上次成功执行的数据。您可以按需编辑。",
    "settings.mcp.instructions.tabs.oauth": "OAuth",
    "settings.mcp.instructions.tabs.apiKey": "访问令牌",
    "settings.mcp.error.fetching.oAuthClients": "获取 OAuth 客户端列表时出错",
    "settings.mcp.oAuthClients.heading": "已连接的 OAuth 客户端",
    "settings.mcp.oAuthClients.table.clientName": "客户端名称",
    "settings.mcp.oAuthClients.table.connectedAt": "连接时间",
    "settings.mcp.oAuthClients.table.lastUsedAt": "最后使用时间",
    "settings.mcp.oAuthClients.table.action.revokeAccess": "撤销访问权限",
    "settings.mcp.oAuthClients.revoke.success.title": "访问权限已撤销",
    "settings.mcp.oAuthClients.revoke.success.message": "客户端 {name} 的访问权限已被撤销",
    "settings.mcp.oAuthClients.revoke.error": "撤销客户端访问权限时出错",
    "settings.mcp.oAuthClients.table.empty.title": "未连接任何 OAuth 客户端",
    "settings.mcp.refresh.tooltip": "刷新列表",
    "settings.mcp.workflowsTable.workflow": "工作流",
    "settings.projectRoles": "项目角色",
    "settings.usageAndPlan.dialog.eula.title": "需要确认",
    "settings.usageAndPlan.dialog.eula.description": "要激活您的许可证，请审阅并接受我们的最终用户许可协议（EULA）。阅读条款后，请勾选下方复选框以确认同意并继续。",
    "settings.usageAndPlan.dialog.eula.checkbox.label": "接受",
    "settings.usageAndPlan.dialog.eula.link.text": "EULA 条款",
    ...
    "settings.provisioning.title": "配置",
    "settings.provisioning.description": "配置用户配置设置并管理自动化用户生命周期管理。",
    "settings.provisioning.loadError": "加载配置失败",
    "settings.provisioning.saveError": "保存配置失败",
    "settings.provisioning.saveSuccess": "配置已保存",
    "settings.provisioning.saveSuccessMessage": "配置已成功更新。",
    "settings.provisioning.save": "保存配置",
    "settings.provisioning.scopesName": "作用域名称",
    "settings.provisioning.scopesName.placeholder": "请输入作用域名称",
    "settings.provisioning.scopesName.help": "用于配置的作用域名称，OAuth 流程中将请求此作用域",
    "settings.provisioning.scopesInstanceRoleClaimName": "实例角色声明名称",
    "settings.provisioning.scopesInstanceRoleClaimName.placeholder": "请输入实例角色声明名称",
    "settings.provisioning.scopesInstanceRoleClaimName.help": "用于从 OAuth 配置实例角色的声明名称。对于 SAML / LDAP，这将是检查的属性名称。",
    "settings.provisioning.scopesProjectsRolesClaimName": "项目角色声明名称",
    "settings.provisioning.scopesProjectsRolesClaimName.placeholder": "请输入项目角色声明名称",
    "settings.provisioning.scopesProjectsRolesClaimName.help": "用于从 OAuth 配置项目及其角色的声明名称。对于 SAML / LDAP，这将是检查的属性名称。",
    "settings.provisioning.toggle": "配置实例和项目角色",
    "settings.provisioning.toggle.help": "项目访问权限只能在外部提供商中定义。一旦用户登录，n8n 中配置但未在提供商中定义的任何现有项目访问权限将被移除。",
    "settings.provisioningConfirmDialog.title": "启用即时配置（JIT）",
    "settings.provisioningConfirmDialog.breakingChangeDescription.firstLine": "启用即时配置后，您的外部 SSO 提供商将成为 n8n 中所有实例和项目角色的唯一权威来源。",
    "settings.provisioningConfirmDialog.breakingChangeDescription.list.one": "如果您的 SSO 提供商未为某成员指定角色，我们将自动分配默认角色：global:member。",
    "settings.provisioningConfirmDialog.breakingChangeDescription.list.two": "用户通过 SSO 登录后，n8n 中现有的所有实例和项目角色将被 SSO 提供商中定义的角色替换。",
    "settings.provisioningConfirmDialog.breakingChangeRequiredSteps": "为帮助您将当前访问设置迁移到 SSO 提供商，请下载以下两个 CSV 文件。启用 JIT 前必须完成此步骤。",
    "settings.provisioningConfirmDialog.button.confirm": "激活 JIT",
    "settings.provisioningConfirmDialog.button.cancel": "取消",
    "settings.provisioningConfirmDialog.button.generateCsvExport": "生成访问设置 CSV 导出",
    "settings.provisioningConfirmDialog.button.downloadProjectRolesCsv": "下载现有项目访问设置 CSV",
    "settings.provisioningConfirmDialog.button.downloadInstanceRolesCsv": "下载现有实例角色设置 CSV",
    "workflowSettings.showError.fetchSettings.title": "获取设置时出现问题",
    "workflows.templatesDataQuality.loadingTemplates": "正在加载模板……",
    ...
    "dataTable.empty.button.disabled.tooltip": "您在项目中的当前角色不允许创建数据表",
    "commandBar.sections.recent": "最近",
    "commandBar.sections.execution": "执行",
    "commandBar.sections.executions": "执行记录",
    ...
    "commandBar.workflow.keywords.archive": "归档",
    "commandBar.workflow.keywords.delete": "删除",
    "commandBar.workflow.keywords.unarchive": "取消归档",
    "commandBar.workflow.keywords.restore": "恢复",
    "commandBar.executions.open": "打开执行记录",
  ...
  "chatHub.tools.editor.credential.new": "新建",
  "chatHub.tools.editor.selectedCount": "已选择 {count} 个工具 | 已选择 {count} 个工具",
  "chatHub.tools.editor.confirm": "确认",
  "chatHub.tools.editor.cancel": "取消",
  "chatHub.credentials.selector.title": "选择 {provider} 凭据",
  ...
  "mcp.productionChecklist.title": "启用 MCP 访问",
  "mcp.productionChecklist.workflow.description": "允许 MCP 客户端访问此工作流",
  "mcp.productionChecklist.instance.description": "启用实例级 MCP 访问，以允许 MCP 客户端访问工作流。",
  "ndv.tooMuchData.message": "这可能会暂时减慢您的浏览器速度。",
  "ndv.tooMuchData.showDataAnyway": "显示数据",
  "ndv.tooMuchData.title": "是否显示 {size} MB 的数据？",
  "oauth.consentView.action.executeWorkflows": "代表您执行工作流",
  "settings.mcp.toggle.disabled.notice": "让 Claude、Lovable 等 MCP 客户端发现并执行您的 n8n 工作流。",
  "settings.chatHub": "聊天",
  "settings.chatHub.providers.fetching.error": "获取聊天提供方设置时出错",
  "settings.chatHub.providers.updated.success": "聊天提供方设置已更新",
  "settings.chatHub.providers.updated.error": "更新聊天提供方设置时出错",
  "settings.chatHub.providers.table.provider": "提供方",
  "settings.chatHub.providers.table.models": "模型",
  "settings.chatHub.providers.table.createdAt": "创建时间",
  "settings.chatHub.providers.table.updatedAt": "最后编辑",
  "settings.chatHub.providers.table.action.editProvider": "编辑提供方",
  "settings.chatHub.providers.table.action.editProvider.disabled": "只有实例管理员和所有者可以编辑聊天提供方。",
  "settings.chatHub.providers.table.title": "提供方",
  "settings.chatHub.providers.table.refresh.tooltip": "刷新列表",
  "settings.chatHub.providers.table.addProvider.button": "添加提供方",
  "settings.chatHub.providers.table.empty.title": "未配置聊天提供方",
  "settings.chatHub.providers.table.empty.description": "配置聊天提供方可限制可用的模型和凭据。",
  ...
  "settings.chatHub.providers.modal.edit.enabled.tooltip": "禁用后，此提供方的模型将无法在聊天中使用。",
  "settings.chatHub.providers.modal.edit.credential.label": "默认凭据",
  "settings.chatHub.providers.modal.edit.credential.clearButton": "清除选择",
  "settings.chatHub.providers.modal.edit.limitModels.label": "限制模型",
  "settings.chatHub.providers.modal.edit.limitModels.tooltip": "启用后，仅所选模型可在聊天中使用。",
  ...
  "settings.chatHub.providers.table.models.allModels": "全部模型",
  "settings.chatHub.providers.table.models.noModels": "无模型",
  "settings.chatHub.providers.table.models.more": "及其他 {count} 个",
  "settings.provisioningConfirmDialog.enable.title": "启用用户角色自动配置",
  "settings.provisioningConfirmDialog.disable.title": "仅在 n8n 中管理用户角色",
  "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partOne": "您的 SSO 提供方将控制 n8n 中的所有用户角色。",
  "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partOne.withProjectRoles": "您的 SSO 提供方将控制 n8n 中的所有用户和项目角色。",
  "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partTwo": "未由 SSO 提供方分配的角色将默认设为 global:member。",
  "settings.provisioningConfirmDialog.breakingChangeDescription.secondLine": "<b>启用前：</b>请下载并检查下方当前的访问设置，确保您的 SSO 提供方已正确配置。",
  "settings.provisioningConfirmDialog.disable.description": "您正在将实例角色管理从 SSO 切换回 n8n。",
  "settings.provisioningConfirmDialog.enable.checkbox": "我已下载并审核了 CSV 导出文件。我的 SSO 提供方已正确配置，可控制此 n8n 实例上的用户角色。",
  "settings.provisioningConfirmDialog.disable.checkbox": "我确认不再从我的 SSO 提供方自动配置用户角色。",
  ...
  "settings.provisioningInstanceRolesHandledBySsoProvider.description": "用户管理和实例角色由您的 SSO 提供方控制。请联系您的 n8n 实例所有者或管理员进行更改。",
  "settings.provisioningProjectRolesHandledBySsoProvider.description": "用户管理和项目角色由您的 SSO 提供方控制。请联系您的 n8n 实例所有者或管理员进行更改。",
  "settings.migrationReport": "迁移报告",
  "settings.migrationReport.title": "版本 2.0.0 兼容性报告",
  "settings.migrationReport.description": "您的 {totalCount} 个工作流中已有 {compatibleCount} 个与版本 2.0.0 兼容。请查看以下详情，了解并解决任何兼容性问题。有关所有重大变更的更多信息，请参阅我们的",
  ...
  "settings.migrationReport.workflowTooltip.critical": "受影响的工作流在更新后将无法运行。您需要更新或替换受影响的节点。",
  "settings.migrationReport.workflowTooltip.medium": "工作流可能仍能运行，但可能产生错误结果。请在更新前审查并测试。",
  "settings.migrationReport.workflowTooltip.low": "在特定情况下行为可能略有变化。大多数工作流仍将按预期正常运行。",
  "settings.migrationReport.instanceTooltip.critical": "此问题很可能导致实例在更新后无法启动或正常工作。必须在继续前修复。",
  "settings.migrationReport.instanceTooltip.medium": "这可能会影响性能、兼容性或连接的服务。如与您的设置相关，请审查并修复。",
  "settings.migrationReport.instanceTooltip.low": "轻微的配置变更。不会阻止更新，但可能导致行为上的细微变化。",
  "settings.migrationReport.emptyWorkflowIssues.title": "未检测到工作流问题",
  "settings.migrationReport.emptyWorkflowIssues.description": "您的工作流完全兼容版本 2.0.0。一切就绪！",
  "settings.migrationReport.emptyInstanceIssues.title": "未检测到实例问题",
  "settings.migrationReport.emptyInstanceIssues.description": "您的实例完全兼容版本 2.0.0。一切就绪！",
  "settings.migrationReport.documentation": "文档",
  "settings.migrationReport.workflowsCount": "{count} 个工作流 | {count} 个工作流",
  "settings.migrationReport.detail.affectedTag": "{count} 个受影响",
  "settings.migrationReport.detail.table.name": "名称",
  "settings.migrationReport.detail.table.issue": "问题",
  "settings.migrationReport.detail.table.active": "活跃",
  "settings.migrationReport.detail.table.deactivated": "已停用",
  "settings.migrationReport.detail.table.nodeAffected": "受影响的节点",
  "settings.migrationReport.detail.table.numberOfExecutions": "执行次数",
  "settings.migrationReport.detail.table.lastExecuted": "最后执行时间",
  "settings.migrationReport.detail.table.lastUpdated": "最后更新时间",
  "settings.migrationReport.detail.table.never": "从未",
  ...
  "settings.migrationReport.detail.filter.status.active": "活跃",
  "settings.migrationReport.detail.filter.status.deactivated": "已停用",
  "ndv.render.text": "文本",
  "ndv.render.html": "HTML",
  "ndv.render.markdown": "Markdown",
  "workflowHistory.button.tooltip": "工作流历史记录，用于查看和恢复之前版本的工作流",
  "workflows.empty.readyToRun": "尝试一个 AI 工作流",
  "dataTable.add.fromScratch": "从头开始",
  "dataTable.add.importCsv": "导入 CSV",
  "dataTable.upload.uploading": "正在上传并处理 CSV 文件……",
  "dataTable.upload.selectFile": "等待文件选择……",
  "dataTable.upload.dropOrClick": "将文件拖至此处或点击上传",
  "dataTable.upload.csvOnly": "仅支持 CSV 文件",
  "dataTable.upload.hasHeaders": "我的 CSV 文件包含标题行",
  "dataTable.upload.uploadButton": "上传 CSV",
  "dataTable.upload.success": "“{fileName}” 已成功上传。我们找到了 {columnCount} 列和 {rowCount} 行 | “{fileName}” 已成功上传。我们找到了 {columnCount} 列和 {rowCount} 行",
  "dataTable.upload.error": "上传 CSV 文件时出错",
  "dataTable.import.columnsFound": "找到的列",
  "dataTable.import.columnName": "列名",
  "dataTable.import.columnsDescription": "检查并调整从 CSV 文件中识别出的列名和类型",
  "dataTable.import.columnType": "数据类型",
  "dataTable.import.columnNamePlaceholder": "输入列名",
  "dataTable.import.duplicateColumnName": "列名必须唯一",
  "dataTable.import.systemColumnName": "{columnName} 是保留列",
  "dataTable.import.invalidColumnName": "仅允许字母、非开头数字和下划线",
  "dataTable.download.csv": "下载 CSV",
  "dataTable.download.error": "下载数据表失败",
  "dataTable.search.dateSearchInfo": "日期搜索使用 UTC 格式，而表格中显示的是您本地时区的日期",
  "settings.ldap.form.enforceEmailUniqueness.label": "强制邮箱唯一性",
  "settings.ldap.form.enforceEmailUniqueness.tooltip": "如果多个 LDAP 账户使用相同邮箱，则阻止登录，防止账户关联攻击。",
  "settings.sso.settings.userRoleProvisioning.label": "用户角色自动配置",
  "settings.sso.settings.userRoleProvisioning.help": "从您的 SSO 提供方管理实例和项目角色。",
  "settings.sso.settings.userRoleProvisioning.help.linkText": "文档链接",
  "settings.sso.settings.userRoleProvisioning.option.disabled.label": "在 n8n 中管理",
  ...
  "settings.sso.settings.save.testConnection.title": "测试并激活 SAML SSO",
  "settings.sso.settings.save.testConnection.message": "您即将通过 SAML 激活 SSO。请先测试您的 SAML SSO 设置再继续。",
  "settings.sso.settings.save.testConnection.test": "测试设置",
  "settings.sso.settings.save.confirmTestConnection.title": "确认连接测试成功",
  "settings.sso.settings.save.confirmTestConnection.message": "连接测试是否成功？确认后将通过 SAML 激活 SSO。",
  ...
  "settings.sso.confirmMessage.beforeSaveForm.message": "如果这样做，所有 {protocol} 用户将被转换为邮箱用户。",
  ...
  "communityPlusModal.features.debugging.description": "轻松修复任何出错的工作流执行，然后重新运行",
  "communityPlusModal.features.execution.title": "执行搜索与标签",
  "communityPlusModal.features.execution.description": "搜索并整理过往工作流执行记录，便于回顾",
  "communityPlusModal.features.folders.title": "文件夹",
  "communityPlusModal.features.folders.description": "以嵌套文件夹结构组织您的工作流",
  "insights.banner.queueMode.warning": "我们发现并修复了一个问题：队列模式用户的洞察执行次数被重复计算。",
...
function createUniqueKey(obj, keys) {
...
function convertNodeToAiTool(item) {
    ...
    if (isFullDescription(item)) {
        item.name += 'Tool';
        item.inputs = [];
        item.outputs = ['ai_tool'];
        item.displayName += ' Tool';
        delete item.usableAsTool;

        const hasResource = item.properties.some((prop) => prop.name === 'resource');
        const hasOperation = item.properties.some((prop) => prop.name === 'operation');

        if (!item.properties.map((prop) => prop.name).includes('toolDescription')) {
            ...
            item.properties.unshift(descProp);
            ...
            if (hasResource || hasOperation) {
                item.properties.unshift(descriptionType);
    ...
    const resources = item.codex?.resources?? {};

    item.codex = {
        categories: ['AI'],
        subcategories: {
            AI: ['Tools'],
            Tools: item.codex?.subcategories?.Tools?? ['Other Tools'],
        },
        resources,
    };
    return item;
...
xhook.after(async function(request, response, callback) {
  ...
  if (request.url.includes('types/nodes.json')) {
    try {
        const a = JSON.parse(response.data)
        // console.log(a)
        //console.log(a.map(it => it.name), a[537])
        let replaceData = {}
        const keysToMatch = ['name', 'version'];
        const sourceData = _.keyBy(JSON.parse(response.data), obj => createUniqueKey(obj, keysToMatch));
        const flag = await isLinkAccessible('https://cdn.jsdelivr.net/gh/webcpy/yhtest@dev-1.122.3/n8n-nodes-base.json')
        if (flag) {

            let externalData = await fetchExternalData('https://cdn.jsdelivr.net/gh/webcpy/yhtest@dev-1.122.3/n8n-nodes-base.json');
            const aiData = await fetchExternalData('https://cdn.jsdelivr.net/gh/webcpy/yhtest@dev-1.122.3/n8n-nodes-langchain.json');
            // let externalData = await fetchExternalData('http://127.0.0.1:3001/node-cn-1.114.json');
            // const aiData = await fetchExternalData('http://127.0.0.1:3001/node-base-ai.json');
            let tools = []
            tools = JSON.parse(externalData).filter((nodeType) => nodeType.usableAsTool).map(it => {
                const item = typeof it.usableAsTool === 'object'
					? ({
							..._.cloneDeep(it),
							...it.usableAsTool?.replacements,
						})
					: _.cloneDeep(it);
                return convertNodeToAiTool(item)

            })
            replaceData = _.keyBy(JSON.parse(externalData).concat(JSON.parse(aiData)).concat(tools), obj => createUniqueKey(obj, keysToMatch));
        }
        const mergedArray = _.mergeWith(sourceData, replaceData, (objValue, srcValue) => {
          return _.merge({}, objValue, srcValue);
        });

        response.text = JSON.stringify(_.values(mergedArray));
    } catch(e) {
        console.error('获取或处理外部数据失败:', e);
    }
  }
