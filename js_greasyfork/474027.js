// ==UserScript==
// @name         Black Russia Скрипт by Vladislav_Harada
...
// @downloadURL https://update.greasyfork.org/scripts/474027/Black%20Russia%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20Vladislav_Harada.user.js
// @updateURL https://update.greasyfork.org/scripts/474027/Black%20Russia%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20Vladislav_Harada.meta.js
// ==/UserScript==
...
`[FONT=georgia] [[COLOR=red] Примечание: [/COLOR] После одобрение, с вами свяжится Старшая Администрация. Вам будет необходимо добавить представителя старшей администрации в друзья, после вас добавят в специальную беседу.<br>`+
  `Никто из состава администрации не будет просить у вас все различные пароли, пин-коды, информация о привязках и так далее. Не ведитесь на обманы!`,
    ...
    {
     title: '-----------------------------------------------------БЕЗ ОПР. ПУНКТА by V.Harada-----------------------------------------------------',
     },
     {
      title: 'Не по форме',
      content:
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FRb3z3Xw/RLwzo.png[/img][/url]<br>' +
'[CENTER][COLOR=violet][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[CENTER][B][I]Ваша видеозапись записана не полностью. Загрузите полную видеозапись на видео-хостинг YouTube.[/B][/CENTER]<br><br>' +
'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
          status: false,
    },
...
'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
    ...
    {
     title: '----------------------------------------Основные правила игры by V.Harada----------------------------------------',
    },
    {
...
'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
    ...
    {
     title: '-----------------------------------------------------Правила ГОСС by V.Harada----------------------------------------------',
    },
    {
	  title: 'нРП ГОСС',
	  content:
