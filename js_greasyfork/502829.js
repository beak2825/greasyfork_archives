...
(function() {
  ...
  function get_msg_context() {
    ...
    //  let mainScreen = document.querySelector("body > div.flex.min-h-screen.w-full > div > div.flex.h-screen") ;
    // let mainConversation = document.querySelector("body > div.flex.min-h-screen.w-full > div > div.flex.h-screen") ;
    let mainConversation = document.querySelector("body > div.flex.min-h-screen.w-full > div.min-h-full.w-full.min-w-0.flex-1 > div > div.h-screen.flex.flex-col.overflow-hidden > div > div")
