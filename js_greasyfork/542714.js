// ==UserScript==
// @name         Спец заказ для ИВАНА
// @namespace    https://forum.blackrussia.online
// @version      1.0.4
// @description  by Dimitry_Walter
// @author       Dimitry_Walter
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @icon         https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/LEGO_logo.svg/640px-LEGO_logo.svg.png
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/542714/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%D0%98%D0%92%D0%90%D0%9D%D0%90.user.js
// @updateURL https://update.greasyfork.org/scripts/542714/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%D0%98%D0%92%D0%90%D0%9D%D0%90.meta.js
// ==/UserScript==
    ...
    const buttons = [
        {
            ...
            content:
                ...
                `[CENTER]      [/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK» [/COLOR][/FONT][/SIZE][/CENTER]`,
        },
        {
        title: '----------  Жалоба на адм  ------------------------------------------------------------------------------------------------------------------------',
        },
         {
            ...
            `[CENTER] [COLOR=#ff0000]Отказано[/COLOR],закрыто. [/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK» [/COLOR][/FONT][/SIZE][/CENTER]`,
	...
	},
{
       ...
       " С момента выдачи наказание прошло более 48-ми часов, жалоба не подлежит рассмотрению.<br><br>"+
        `[COLOR=#ff0000]Отказано[/COLOR], закрыто.[/FONT][/SIZE][/CENTER]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK»[/COLOR][/FONT][/SIZE][/CENTER]`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    },
     {
	  ...
	  content:
        ...
        `[COLOR=#ff0000]Отказано[/COLOR],закрыто! [/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK» [/COLOR][/FONT][/SIZE][/CENTER]`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
     {
	  ...
	  content:
		`[CENTER][COLOR=rgb(250, 197, 28)][I][FONT=times new roman][SIZE=5]На рассмотрение [/SIZE][/FONT][/I][/COLOR][/CENTER]<br>`,
	     prefix: PIN_PREFIX,
	     status: true,
	       },
           {
           ...
           },
           {
		    ...
		    `[CENTER][COLOR=#ff0000]Отказано[/COLOR], закрыто.[/CENTER][/FONT]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере ««ULYANOVSK»[/COLOR][/FONT][/SIZE][/CENTER]`,
            prefix: UNACCEPT_PREFIX,
            status:false,
           },
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба была [COLOR=#00ff00]одобрена[/COLOR] и будет проведена беседа с администратором.<br>Ваше наказание будет снято.[/CENTER]<br>" +
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK»[/COLOR][/FONT][/SIZE][/CENTER]`,
	...
	},
{
	  ...
	  content:
		`[CENTER][SIZE=5][FONT=times new roman][I]Здравствуйте уважаемый игрок.<br>`+
        `Благодарим за ваше обращение, <br> Приносим свои извинения за инцидент,<br>`+
`с администратором [COLOR=rgb(184, 49, 47)]будут проведены нужные работы[/COLOR][COLOR=rgb(255, 255, 255)].[/COLOR][/I][/FONT][/SIZE]<br>`+
`[SIZE=4][COLOR=rgb(147, 101, 184)][FONT=times new roman][I][FONT=verdana]Наказание будет снято если еще действительно.[/FONT][/I][/FONT][/COLOR][/SIZE][COLOR=rgb(147, 101, 184)][/COLOR]<br>`+
`[SIZE=5][FONT=times new roman][I][COLOR=rgb(97, 189, 109)]Одобрено[/COLOR][COLOR=rgb(255, 255, 255)].[/COLOR][/I][/FONT][/SIZE][/CENTER]<br>`,
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},
{
	  title: `Админ прав`,
	  content:
		`[CENTER][COLOR=rgb(255, 255, 255)][SIZE=5][FONT=times new roman][I]Здравствуйте уважаемый игрок,[/I][/FONT][/SIZE][/COLOR]<br><br><br>` +
        `[I][FONT=times new roman][SIZE=4]Администратор предоставил доказательства - наказание было выдано верно.<br>`+
        `Благодарим за ваше обращение, [/SIZE][COLOR=rgb(184, 49, 47)][SIZE=5]Закрыто.[/SIZE][/COLOR][/FONT][/I][/CENTER]<br>`+
        `[RIGHT][COLOR=rgb(184, 49, 47)][SIZE=5][FONT=courier new][I]George W.[/I][/FONT][/SIZE][/COLOR][/RIGHT]<br>`,
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба была [COLOR=#00ff00]одобрена[/COLOR], администратор будет снят.<br>CENTER]<br>" +
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK»[/COLOR][/FONT][/SIZE][/CENTER]`,
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},
        ...
        },
{
        ...
        `[SIZE=4][FONT=georgia][COLOR=#ff0000]Отказано[/COLOR],[S] закрыто.[/S][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK»[/COLOR][/FONT][/SIZE][/CENTER]`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    ...
    },
{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}.[/CENTER]<br>` +
		"[CENTER]Ваше обжалование передано [COLOR=#ff0000]специальной администрации[/COLOR].[/CENTER]<br>" +
		`[CENTER][COLOR=#ff9800]На рассмотрении[/COLOR].[/CENTER][/FONT][/SIZE]`,
	...
	},
{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба/обжалование передана/передано [COLOR=#ff0000] Главному Администратору [/COLOR]  <br><br>"+
        `[COLOR=#ff9800]На рассмотрении[/COLOR]. <br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=#ffffff] Приятной игры и времяпровождение  на сервере «ULYANOVSK»[/COLOR][/FONT][/SIZE][/CENTER]`,
	  prefix: GA_PREFIX,
	  status: true,
	},
...
{
	  title: `[COLOR=#ff9800]На рассмотрении[/COLOR]`,
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}.[/CENTER]<br>` +
