...
// @description torn mug helper
// @namespace https://greasyfork.org/users/1407401
// @downloadURL https://update.greasyfork.org/scripts/532083/PokerMugHelper.user.js
// @updateURL https://update.greasyfork.org/scripts/532083/PokerMugHelper.meta.js
// ==/UserScript==
    ...
    try {
      const response = await fetch(
        `https://api.torn.com/v2/user?selections=profile,personalstats&id=${player.playerId}&cat=all`,
        {
          method: 'GET',
          headers: {
            Authorization: 'ApiKey waAe2SEemsHufWcJ'
          }
        }
      )
