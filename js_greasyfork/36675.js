...
// @copyright     2017-20123, MeanCloud
// @run-at        document-end
// @downloadURL https://update.greasyfork.org/scripts/36675/Eternity%20Tower%20Audio%20Immersion.user.js
// @updateURL https://update.greasyfork.org/scripts/36675/Eternity%20Tower%20Audio%20Immersion.meta.js
// ==/UserScript==


////////////////////////////////////////////////////////////////
////////////// ** SCRIPT GLOBAL INITIALIZATION ** //////////////
function startup() { ET_AudioImmersionMod(); }
////////////////////////////////////////////////////////////////


ET_AudioImmersionMod = function()
{
    try
    {
        audioBattleBG = new Audio('http://www.mean.cloud/EternityTower/audio/little_robot_sound_factory_Ambience_Hell_02.mp3');
        //audioBattleBG = new Audio('http://www.mean.cloud/EternityTower/audio/Bog-Creatures-On-the-Move_Looping.mp3');
        //audioBattleBG = new Audio('http://www.mean.cloud/EternityTower/audio/Tower-Defense_Looping.mp3');
        //audioBattleBG = new Audio('http://www.mean.cloud/EternityTower/audio/Ancient-Troops-Amassing.mp3');
        audioBattleBG.loop = true;
        audioBattleBG.volume = 0.15;

        audioBecameDemon = new Audio('http://www.mean.cloud/EternityTower/audio/zapsplat_sound_design_dark_cinematic_hit_007_12691.mp3');
        audioBattleLost = new Audio('http://www.mean.cloud/EternityTower/audio/zapsplat_horror_descending_dark_harp_drone_12668.mp3');
        audioBattleWon = new Audio('http://www.mean.cloud/EternityTower/audio/multimedia_game_musical_success_complete_orchestral_horns_001.mp3');
    }
    catch (err) { }

    ET.MCMF.Loaded(function()
    {
        ET.MCMF.EventSubscribe("combatStart", function()
        {
            try { audioBattleBG.fastSeek(0); } catch (err) { }
            try { currentTime = 0; } catch (err) { }
            audioBattleBG.play();
        });

        ET.MCMF.EventSubscribe("combatEnd", function()
        {
            audioBattleBG.pause();
        });

        ET.MCMF.EventSubscribe("combat:buffDemon", function()
        {
            audioBecameDemon.play();
        });

        ET.MCMF.EventSubscribe("combatWon", function()
        {
            audioBattleWon.play();
        });

        ET.MCMF.EventSubscribe("combatLost", function()
        {
            audioBattleLost.play();
        });
    });
}
