// ==UserScript==
// @name         HideMyName Free Proxy exporter (JSON)
// @namespace    org.thorlancaster.hidemynameexporter
// @version      1.0
// @description  Export proxies from HideMyName into a JSON file. Premium membership NOT required.
// @author       Thor Lancaster
// @match        https://hidemy.name/en/proxy-list/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/405040/HideMyName%20Free%20Proxy%20exporter%20%28JSON%29.user.js
// @updateURL https://update.greasyfork.org/scripts/405040/HideMyName%20Free%20Proxy%20exporter%20%28JSON%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    var helpText =
        ...
        "<li>When finished, click \"Export JSON\"</li><li>Remember to clear pages when done to prevent old, possibly expired proxies.</li></ol>";
    // Utility Functions
    ...
    var createUIPane = function(){
        ...
        ////////
        var title = DCE("div");
        title.innerHTML = "JSON Proxy<br/>Exporter<br/>";
        var ts = title.style;
        ts.fontSize = "1.5em";
        ts.padding = "0.3em";
    ...
    var addThisPage = function(){
        ...
        for(var x = 0; x < rows.length; x++){
            ...
            var value = {};
            value.port = tds[1].innerText;
            value.location = tds[2].innerText;
            value.speed = tds[3].innerText;
            value.type = tds[4].innerText.toUpperCase();
            value.anonymity = tds[5].innerText.toUpperCase();

            Object.defineProperty(fpeDatabase, ip, {
                value: value,
                writable: true,
                enumerable: true
            });
    ...
    var exportJSON = function(){
        ...
        if(fpeDatabase != null){
            showMessageBox("JSON Output", "<pre>" + JSON.stringify(fpeDatabase, undefined, 2) + "</pre>");
        } else {
