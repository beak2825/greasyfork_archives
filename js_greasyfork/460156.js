...
// @downloadURL https://update.greasyfork.org/scripts/460156/%E8%99%BE%E7%B1%B3%E8%A7%A3%E6%9E%90%20%20v6.user.js
// @updateURL https://update.greasyfork.org/scripts/460156/%E8%99%BE%E7%B1%B3%E8%A7%A3%E6%9E%90%20%20v6.meta.js
// ==/UserScript==
        ...
        function playVideoFunc(){
            ...
            document.querySelector('#zhmlogo').addEventListener('click',function(){
                ...
                if(jxVideoWeb.length == 0){
                    ...
                    console.log(videoSelect);return;
                         ...
                         switch(type){
                             ...
                             case 'video':
                                 ...
                                 if(zhmLogoDrag.offsetTop==sedownTop && web.length > 0 && zhmLogoDrag.offsetTop>0 && window.innerHeight > height){
                                    ...
                                    location.href=`${zhmApiUrl}jxjx.php?lrspm=271888661&zhm_jx=${location.href}`;
        ...
        class CouponClass extends BaseClass{
            ...
            jd(){
                setTimeout(()=>{
                    ...
                    this.request('get',`https://img.typechrome.com/index_jd_new.php?goods_id=${jdGoodsId[1]}`).then((result)=>{
        ...
        `
            ...
            getCouponInfo(node,className){
                ...
                setTimeout(()=>{
                    ...
                    this.request('get',`https://img.typechrome.com/index_new.php?goods_id=${goods_id}`).then((result)=>{
                    ...
                    if(e.target.innerText == '下载'){
                        ...
                        function getVideo(dom){
                            ...
                            if(dom.querySelector('video')){
                                ...
                                videoDom = dom.querySelector('video');

                            }else{

                                getVideo(dom.parentNode);
                            }
                         }

                         getVideo(e.target.parentNode);

                         let videoName = new Date().getTime()+'.mp4';

                         BaseClass.LR_download(videoDom.src,videoName);
...
*/
        ...
        function playVideoFunc(){
            ...
            //循环判断是否在播放页，是则执行下面
            let jxVideoData = [
                {funcName:"playVideo", node:".player__container" ,match:/https:\/\/v.qq.com\/x\/cover\/[a-zA-Z0-9]+.html/,areaClassName:'episode-list-rect__list',name:'qqPC'},
                {funcName:"playVideo", node:"#player-container" ,match:/https:\/\/v.qq.com\/x\/cover\/[a-zA-Z0-9]+\/[a-zA-Z0-9]+.html/,areaClassName:'episode-list-rect__list',name:'qqPC'},
                ...
                {funcName:"playVideo", node:"#player_module",nodeType:'id',match:/www\.bilibili\.com\/bangumi/,areaClassName:'list-wrapper'},
    ...
    let baidu = {
        ...
        _getSurl() {
                ...
                if(reg.test(location.href)){
                    //console.log(location.href.match(reg)[0],'reg');
