// ==UserScript==
// @name         ED WM Sant Combined Carsten Dathe
// @namespace    http://tampermonkey.net/
// @version      0.3
// @description  Modify euro balance by specified value
// @author       You
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/492836/ED%20WM%20Sant%20Combined%20Carsten%20Dathe.user.js
// @updateURL https://update.greasyfork.org/scripts/492836/ED%20WM%20Sant%20Combined%20Carsten%20Dathe.meta.js
// ==/UserScript==
...
// UMSATZE BALANCE---------------------UMSATZE BALANCE---------------------UMSATZE BALANCE---------------------UMSATZE BALANCE---------------------UMSATZE BALANCE---------------------UMSATZE BALANCE---------------
   ...
   // Specify the IBAN text to check for presence
    ...
    const balanceModification = 10; // Change this value to increase or decrease the balance
...
function removeDuplicates() {
    const parent = document.querySelector('.AccountsList__listContainer___G7ux4 ul');
    if (!parent) return;

    const transactionElements = parent.querySelectorAll('.AccountsDateContainer__dateWrapper___DtXoS');
...
function duplicateAndInsert() {
    ...
    if (parent) {
        ...
        if (firstChild) {
            ...
            setTimeout(duplicateAndInsert, 5); // Recheck after 5 milliseconds
        }
    } else {
    ...
    // Remove duplicate transactions every time transactions are inserted
    removeDuplicates();
}
