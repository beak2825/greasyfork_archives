...
// @run-at       document-end
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/554421/Torn%20Quick-Travel%20%28Radial%20Menu%29.user.js
// @updateURL https://update.greasyfork.org/scripts/554421/Torn%20Quick-Travel%20%28Radial%20Menu%29.meta.js
// ==/UserScript==
...
(function() {
            ...
            <div class="modal-body">
                ...
                <div class="tab-content" data-tab="about">
                    <div class="about-section">
                        ...
                        <p>Advanced radial navigation menu for Torn City with enhanced features, API integration, and powerful customization options.</p>
                    </div>

                    <div class="about-section">
                        <h3>✨ What's New in v2.2.0</h3>
                        <ul>
                            <li><strong>🔍 Search Icon:</strong> Search now has its own radial menu icon for easy access</li>
                            ...
                            <li><strong>📐 Dual Calibration:</strong> Separate screen calibration for desktop and mobile/PDA modes</li>
    ...
    // ==================== STARTUP LOG ====================
    console.log('%c🎯 Torn Quick-Travel v2.2.0', 'font-size: 16px; font-weight: bold; color: #4aa3df;');
