// ==UserScript==
// @name         Revolver Modified by NurboTurbo
// @namespace    none
// @version      v2
// @description  Turbo mod
// @author       Nurbo
// @license      MIT
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/499268/Revolver%20Modified%20by%20NurboTurbo.user.js
// @updateURL https://update.greasyfork.org/scripts/499268/Revolver%20Modified%20by%20NurboTurbo.meta.js
// ==/UserScript==
...
document.getElementById('chatBox').innerHTML = 'dont be shy * them /';
document.getElementById('gameName').innerHTML = '';

	document.getElementById('gameName').innerHTML = 'Loading_Game';

		document.getElementById('gameName').innerHTML = 'Turbo Mod';
...
document.getElementById("gameName").innerHTML = "Turbomod by Nurbo";
let changes2 = `<div id="customMenuName"><h3 style="font-size: 50px;" class = "indent">   n - auto triple mills
    v - spike
    f - trap
    h - double turrets
    space - perfect spiketick
    shift - autobreaker
    right ckick - normal insta
    c - reverse insta
    , - boost tick
    y - 1 tick
    b - bulltick</a></div>`;
...
//document.getElementById("loadingText").innerHTML = "Turbo Loading";
document.getElementById("diedText").innerHTML = "Died";
document.getElementById("diedText").style.color = "#FFFFFF";
document.title = " Turbomod by Nurbo";
document.getElementById("leaderboard").append("Turbomod by Nurbo");
...
document.getElementById('promoImgHolder').innerHTML =
  ...
  } .menuButton:hover { transform: scale(1.11); box-shadow: 0 0 20px #db6c1d;
  } #linksContainer2 { background: #ccc; border-top: 5px solid; border-image: linear-gradient(to right,#db6c1d,##db6c1d) 1 1 0 0; height: 18px; top: 0%; color: #db6c1d; transition: 0.3s;
  } #linksContainer2:hover { background: #ccc; box-shadow: 0 0 20px #db6c1d;
  } #top-wrap-right { color: #db6c1d;
  ...
  } input:checked[type="checkbox"] { background: #db6c1d;
  ...
  } .menuCard { background-color: #181818; border-top: 5px solid; border-image: linear-gradient(to right,#db6c1d,#303030) 1 0 0 0; color: #db6c1d margin-top:0px; border-radius: 0px; border-bottom: 0px solid red; transition: all 1s; transform: scale(1); box-shadow: 0px 0px #db6c1d; transform: translateX(0px);
  } .menuCard:hover { transform: scale(1.05); box-shadow: 0 0 20px #db6c1d;
  ...
  - Created Chimken mod, devlopment beings<br>
...
const spikePlacerC = repeater(67,() => {place(spikeType);},50);
const placers = [boostPlacer, spikePlacer,spikePlacerC];
let prevCount = 0;
        ...
        if (mutation.target.id === "killCounter") {
            ...
            if (count > prevCount) {
                ...
                setTimeout(()=>{
                    ...
                    doNewSend(["6", ["Turbomod"]]);
                },500);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod b"]]);
                },4500);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by"]]);
                },5000);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by N"]]);
                },5500);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nu"]]);
                },6000);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nur"]]);
                },6500);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nurb"]]);
                },7000);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nurbo"]]);
                },7500);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nurbo T"]]);
                },8000);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nurbo Tu"]]);
                },8500);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nurbo Tur"]]);
                },9000);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nurbo Turb"]]);
                },9500);setTimeout(()=>{
                    doNewSend(["6", ["Turbomod by Nurbo Turbo"]]);
                },10000);
                prevCount = count;
            }
        }
...
$("body").after(`
  <div id="infomenu">
  <hr>
  <div class="nameblock">Revolver modv2</div>
  <hr>
  <ul>
  ...
  <hr>
  <div class="nameblock">Revolver mov2:</div>
  <hr>
  ...
  ::-webkit-scrollbar-button {  background-color: ##db6c1d; }
