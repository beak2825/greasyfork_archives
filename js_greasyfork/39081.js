...
// @downloadURL https://update.greasyfork.org/scripts/39081/%E5%8D%83%E9%96%80%E9%A2%A8%E5%B0%88%E7%94%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/39081/%E5%8D%83%E9%96%80%E9%A2%A8%E5%B0%88%E7%94%A8.meta.js
// ==/UserScript==
...
function killTianJianTargetFunc(){
	...
	if (killTianJianTargetButton.innerText == '殺天劍'){
	    mySkillLists=prompt("請輸入連續單放出招技能:","孔雀翎");
...
// 外傳1 ------------------------------------------------------------------------------------------------------
		...
		function qmj_addbtns2() {
		    if (ssssButton.innerText == '小功能'){
				    var aaa = ['悟性裝','寶箱3000','通靈','上香','打鳥','蓮花','冰月谷','突破丹禮包','狂暴丹','掌門手諭','投資','煉藥','拼圖','簽到','禦寒衣','刻刀'];
			    var bbb = [];
