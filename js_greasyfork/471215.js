...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/471215/%E8%87%AA%E7%94%A8chatgpt%E8%87%AA%E5%8A%A8%E5%AE%8C%E5%96%84.user.js
// @updateURL https://update.greasyfork.org/scripts/471215/%E8%87%AA%E7%94%A8chatgpt%E8%87%AA%E5%8A%A8%E5%AE%8C%E5%96%84.meta.js
// ==/UserScript==
...
(function() {
    ...
    (function generateCheckbox() {
        ...
        const label = document.createTextNode('中断后自动发送“请继续帮我按要求分别写文章，然后把改进后的文章放进代码块里”');
        ...
        if(autoSendFlag) {
            ...
            if (!button || button.querySelector('div').textContent.trim() != "Stop generating") {
                ...
                if (lastParagraph && !lastParagraph.parentNode.classList.contains('result-streaming') && !/\。$/.test(lastParagraph.textContent.trim())) {
                    setTimeout(function () {
                        // 找到 textarea 元素，并填充内容为 "请继续帮我按要求分别写文章，然后把改进后的文章放进代码块里"
                        const textarea = document.querySelector('textarea');
                        textarea.value = '请继续帮我按要求分别写文章，然后把改进后的文章放进代码块里';
