...
// @version     1.3
// @downloadURL https://update.greasyfork.org/scripts/5885/steamgiftscom%20thank%20filter.user.js
// @updateURL https://update.greasyfork.org/scripts/5885/steamgiftscom%20thank%20filter.meta.js
// ==/UserScript==
...
$('.comment_body:not(.child_container *)').each(function() {
	...
	text = text.replace(RegExp(creator.replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1") + "$"), "")
