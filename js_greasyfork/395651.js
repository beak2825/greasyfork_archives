...
// @description    ニコニコ動画の速くて軽い動画プレイヤー-個人用改造済みエディション
...
// @downloadURL https://update.greasyfork.org/scripts/395651/ZenzaWatch-lei.user.js
// @updateURL https://update.greasyfork.org/scripts/395651/ZenzaWatch-lei.meta.js
// ==/UserScript==
      ...
      <div class="menuItemContainer rightTop">
        <div class="scalingUI">
          <div class="command menuButton zenzaTweetButton" data-command="tweet">
            <div class="tooltip">ノート</div>
            <div class="menuButtonInner">M</div>
          </div>
  ...
  `);
    ...
    _.assign(HoverMenu.prototype, {
      ...
      _onHoverEnd: function(e) {
        ...
        this._query = ZenzaWatch.util.parseWatchQuery(($target[0].search || '').substr(1));
