...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471952/Hotpotai%20Unlimiter.user.js
// @updateURL https://update.greasyfork.org/scripts/471952/Hotpotai%20Unlimiter.meta.js
// ==/UserScript==
...
(function() {
    ...
    $('.characterCounterBox').remove();

    const MaxPromptLength = 999999;
    ...
    $('.seedTextBox textarea').on('input', function() {
        let charsLeft = getCharsLeft();
        $('.characterCounterBox').text(charsLeft);
        if (charsLeft < 0) {
            let text = $(this).val();
            $(this).val(text.slice(0, MaxPromptLength));
        }
    });
})();