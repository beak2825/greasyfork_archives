...
// @downloadURL https://update.greasyfork.org/scripts/13869/Colombian%20WME%20Closure%20Sheet%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/13869/Colombian%20WME%20Closure%20Sheet%20Helper.meta.js
// ==/UserScript==

var wmecsh_version = "0.0.7";
...
function clickedClosureSheetHelper(event)
{
    ...
    for(var k in endobj)
    {
        ...
        ends += idss + "\t" + plink + idss + "\t" + cityname + "\t" + thisUser.userName + "\n";
        alls += ends;
    }
