...
// @noframes
//
// @downloadURL https://update.greasyfork.org/scripts/439452/Discogs%20Scout.user.js
// @updateURL https://update.greasyfork.org/scripts/439452/Discogs%20Scout.meta.js
// ==/UserScript==
/*
//==============================================================================
//                         Version History:
...
2.7     -    Adjusted "large covers" notification.
...
var icon_sites = [
  ...
  {   'name': 'Last.fm',
      ...
      'bar': 1},
  {   'name': 'Mora (JP)',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://mora.jp/search/album?keyWord=%band%+%release%',
      'bar': 1},
  {   'name': 'MusicBrainz',
  ...
  {   'name': 'Tidal',
      ...
      'bar': 1},
  {   'name': 'Tower (JP)',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://tower.jp/search/advanced/item/search?artistName=%band%&titleName=%release%',
      'bar': 1},
  {   'name': 'TPB-Proxy',
...
function startObserver() {
  console.log('Discogs Scout (Initialization): Starting Observer.');
...
function startDiscogsScout() {
  ...
  if (Boolean(location.href.match('/image')) || Boolean(location.href.match('/history'))) {
    ...
    return;
      ...
      if (!GM_config.get('run_artistpages') && !onReleasePage) {
        console.log("Discogs Scout: Not starting. [Report it if you think that it should start here!]");
        return;
      } else {
...
if (document.readyState !== 'loading') {
    console.log('Discogs Scout (Initialization): Document is already ready.');
    if (onReleasePage) {
      startObserver();
    } else {
      startDiscogsScout();
    ...
    console.log('Discogs Scout (Initialization): Waiting for "DOMContentLoaded" event.');
    if (onReleasePage) {
