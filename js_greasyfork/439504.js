...
`;
    ...
    <br>
    Select a mod:<br><br>
    <button class="modBtn" id="superModLoad">SuperMod</button>
    <button class="modBtn" id="xwareLoad">X-Ware</button>
    <button class="modBtn" id="quasarLoad">Quasar (Latest)</button>
    <button class="modBtn" id="justMod">JustMod</button>
    <button class="modBtn" id="nextGenLoad">NextGen Mod</button>
    </center></div>
    <style>
    #overlay {
