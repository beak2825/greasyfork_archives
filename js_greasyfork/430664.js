...
// @name       and9702
// @namespace and970
// @description  update to use on mobile with 80% zoom since I can't use hotkeys or private script with bookmarklets
// @noframes
// @grant GM_getValue
// @grant GM_setValue
...
// -- FOOLSLIDE END
// @version 0.0.1.20241112031213
// @downloadURL https://update.greasyfork.org/scripts/430664/and9702.user.js
// @updateURL https://update.greasyfork.org/scripts/430664/and9702.meta.js
// ==/UserScript==
...
// Function to determine the scroll amount based on orientation
function getScrollAmount() {
    return window.innerHeight > window.innerWidth ? 400 : 250;
}

// Listener to capture the start of a touch
document.addEventListener('touchstart', function(e) {
    touchStartY = e.changedTouches[0].screenY;
}, false);

// Listener to capture the end of a touch
document.addEventListener('touchend', function(e) {
    touchEndY = e.changedTouches[0].screenY;
    // Check if the touch was a tap (i.e., start and end positions are close)
    if (Math.abs(touchStartY - touchEndY) < 10) { // Adjust for sensitivity
        var scrollAmount = getScrollAmount(); // Get the scroll amount based on orientation
        
        // Perform the scroll for a tap
        window.scrollBy({
            top: scrollAmount,
