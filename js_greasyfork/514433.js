...
// @version      1.19
// @description  Жб/Обж by Frog // by Kseniya_Frog
// @author       Kseniya_Frog
...
// @downloadURL https://update.greasyfork.org/scripts/514433/%D0%96%D0%B1%D0%9E%D0%B1%D0%B6%20by%20Frog.user.js
// @updateURL https://update.greasyfork.org/scripts/514433/%D0%96%D0%B1%D0%9E%D0%B1%D0%B6%20by%20Frog.meta.js
// ==/UserScript==
...
const buttons = [
	...
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Суть вашего обращения не совсем понятна. Просьба уточнить в следующей теме вы признаете свою вину и хотите сократить срок наказания или вы не категорически не согласны и хотите, что бы бан сняли, так как вы ничего не нарушали.<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано. Закрыто[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	...
	},
    {
	  ...
	  content:
        ...
        "[B][CENTER][COLOR=lavender]Просим вас в будущем соблюдать правила проекта, чтобы избежать подобных ситуаций. <br> Пожалуйста, помните; Оформленная заявка на обжалование не означает гарантированного одобрения со стороны руководства сервера.<br>"+
