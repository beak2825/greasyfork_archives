// ==UserScript==
// @name        HS panda and push notification
...
// @downloadURL https://update.greasyfork.org/scripts/12801/HS%20panda%20and%20push%20notification.user.js
// @updateURL https://update.greasyfork.org/scripts/12801/HS%20panda%20and%20push%20notification.meta.js
// ==/UserScript==
...
function Push(text){
    //PUT YOU'RE TOKEN HERE
    var token = "QjxPkWo0tKvUuDIZQfik5QqRgkNeOMbs";
    $.ajax({  
...
var ta = setInterval(function(){ DAL = []; console.log("DAL cleared");}, 50000);
var ta = setInterval(function(){ DAL2 = []; console.log("DAL cleared");}, 100000);
        ...
        else
        {
            ...
            for (var j = 0; j < found_key_list.length; j++)
            {
                ...
                if (!(obj.masters == true && masters_hide.checked) && (ignored && obj.found_this_time) || (!ignored && obj.found_this_time)){
                    ...
                    else if (!includelisted && obj.found_this_time && matchOnly.checked){
                    ...
                    var objarray = [];
                    if (!pandalisted && obj.found_this_time && pandaOnly.checked){
