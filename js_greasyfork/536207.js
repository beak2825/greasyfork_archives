// ==UserScript==
// @name         YouTube Recommendations be Gone: Cleaner YouTube-mobile
// @name:zh-CN   干净油管：Youtube 去推荐（YouTube Recommendations be Gone-mobile）
// @version      1.3.20
// @description  Youtube homepage and recommendations are a waste of time and addictive. We will try to remove homepage and as many recommendations as possible to give you a cleaner youtube, so you can focus on your own subscriptions.
// @description:zh-cn YouTube主页极具上瘾性，刷主页和推荐完全是在浪费时间。本脚本将你重定向到你自己的订阅内容并屏蔽其他推荐入口，这样你就可以专注于你自己的订阅内容。
// @author       benderbd42
...
// @supportURL   https://greasyfork.org/scripts/475942-youtube-recommendations-be-gone-cleaner-youtube/feedback
// @downloadURL https://update.greasyfork.org/scripts/536207/YouTube%20Recommendations%20be%20Gone%3A%20Cleaner%20YouTube-mobile.user.js
// @updateURL https://update.greasyfork.org/scripts/536207/YouTube%20Recommendations%20be%20Gone%3A%20Cleaner%20YouTube-mobile.meta.js
// ==/UserScript==
...
(function() {
  ...
  `);
    ...
    function hideRelatedVideos() {
        ...
        var relatedVideos = document.querySelectorAll("ytm-video-with-context-renderer").forEach(el => el.remove());
		var relatedVideos2 = document.querySelectorAll("ytm-continuation-item-renderer").forEach(el2 => el2.remove());
		var relatedVideos3 = document.querySelectorAll(".spinner").forEach(el => el.remove());
        var endVideoContent = document.querySelector('div.ytm-reel-shelf-renderer')
		var endVideoContent2 = document.querySelector("ytm-reel-shelf-renderer")
