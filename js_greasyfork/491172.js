...
// @grant        GM_setValue
// @run-at 		 document-end
// @downloadURL https://update.greasyfork.org/scripts/491172/Easy%20Easter%20%28PDA%29.user.js
// @updateURL https://update.greasyfork.org/scripts/491172/Easy%20Easter%20%28PDA%29.meta.js
// ==/UserScript==
...
(async () => {
	...
	async function checkForEggs() {
		...
		if (eggs.length) {
			const shouldMakeEasyMode = confirm(
				`${eggs.length} egg${eggs.length > 1 ? "s" : ""} detected on the current page! ` +
					"Do you want to enable easy mode? \n" +
					"Warning: this may decrease the number of spawns you receive, use at your own risk."
			);
	...
	function addNavigator() {
		...
		function addButton(index, onclick) {
			$("<button>", { id: "kw--egg-navigator", text: `Next Page: ${++index}` })
				.on("click", onclick)
...
function getAllLinks() {
	...
	return [
		...
		"loader.php?sid=slots",
		"loader.php?sid=slotsLastRolls",
		"loader.php?sid=viewSlotsStats",
		"loader.php?sid=roulette",
		"loader.php?sid=rouletteLastSpins",
		"loader.php?sid=rouletteStatistics",
		"loader.php?sid=highlow",
		"loader.php?sid=viewHighLowLastGames",
		"loader.php?sid=viewHighLowStats",
		"loader.php?sid=keno",
		"loader.php?sid=craps",
		"loader.php?sid=crapsLastRolls",
		"loader.php?sid=crapsLastRolls",
		"loader.php?sid=viewCrapsStats",
		"loader.php?sid=lottery",
		"loader.php?sid=viewLotteryUserStats",
		"loader.php?sid=viewLotteryStats",
		"loader.php?sid=blackjack",
		"loader.php?sid=viewBlackjackLastGames",
		"loader.php?sid=viewBlackjackStats",
