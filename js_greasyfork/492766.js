// ==UserScript==
// @name         BLACK RUSSIA PINK  || Скрипт для Руководства.
// @namespace    https://forum.blackrussia.online
// @version      1.38
// @description  Специально для BlackRussia || PINK by A.Hayes
// @author       Artyom_Hayes
...
// @downloadURL https://update.greasyfork.org/scripts/492766/BLACK%20RUSSIA%20PINK%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/492766/BLACK%20RUSSIA%20PINK%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.meta.js
// ==/UserScript==
...
status: false,
},
        {
             title:' С Форума ',
           content:
           "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE],  {{ user.mention }}.<br><br>"+
            "На вас была написана жалоба, в которой приложены необходимые доказательства для вашего наказания.<br><br>"+
           "[COLOR=WHITE]Наказание выдано верно. Нарушений со стороны администрации не обнаружил. Нужно было думать о последствиях.<br><br>"+
 "[FONT=courier new][B][CENTER][COLOR=WHITE]С уважением, [/COLOR][COLOR=RED]Заместитель главного администратора[/COLOR] - [COLOR=PURPLE] [I] Artyom_Hayes.<br>"+
        ...
        },
        {
            title: 'Не тот сервер ',
            content:
            "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE], {{ user.mention }}.[/FONT][/CENTER]<br><br>"+
  ...
  {
            title: 'ошибка адм причина тот ',
            content:
            "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE], {{ user.mention }}.[/FONT][/CENTER]<br><br>"+
            "[CENTER] [I] [SIZE=4][FONT=times new roman]Администратор ошибся в указании причины на момент блокировки вашего аккаунта.Причина будет заменена.Наказание останется прежним. <br><br>"+
            "[CENTER][FONT=times new roman][I] [SIZE=4] [COLOR=YELLOW]Рассмотрено.. [/FONT][/CENTER]",
        ...
        },
 {
            ...
            "Недостаточно доказательств для корректного рассмотрения вашего обращения. <br>"+
        ...
        },
        {
            ...
            "Доказательства являются подделанными, Форумный аккаунт будет заблокирован."+
            '[COLOR=RED][I] [SIZE=4][FONT=times new roman]Отказано[/COLOR] [COLOR=WHITE]/[COLOR=WHITE]/ [COLOR=RED]Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        ...
        },
        {
            ...
            "Представленные доказательства выше были отредактирован, подобные жалобы рассмотрению не подлежат.<br><br>"+            '[COLOR=red][I] [SIZE=4][FONT=times new roman]Отказано[/COLOR] [COLOR=WHITE]/[COLOR=WHITE]/ [COLOR=RED]Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
       ...
       '[COLOR=RED][I] [SIZE=4][FONT=times new roman]Отказано[/COLOR] [COLOR=WHITE]/[COLOR=WHITE]/ [COLOR=RED]Закрыто.[/FONT][/CENTER]',
        ...
        },
        {
            ...
            "В вашей жалобе отсутствуют доказательства для рассмотра. <br>"+       "Прикрепите доказательсва в хорошем качестве на разрешенных платформах.(Yapx/Imgur/YouTube/ImgBB)<br><br>"+
            '[COLOR=RED][I] [SIZE=4][FONT=times new roman]Отказано[/COLOR] [COLOR=WHITE]/[COLOR=WHITE]/ [COLOR=RED]Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        ...
        },
 {
            ...
            "После проверки было принято решение перебанить ваш аккаунт по причине взлома. Для разблокировки своего аккаунта создайте новую тему в разделе Обжалование наказаний и укажите все имеющиеся привязки..<br><br>"+
            '[COLOR=red][I] [SIZE=4][FONT=times new roman]Отказано[/COLOR] [COLOR=WHITE]/[COLOR=WHITE]/ [COLOR=RED]Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
         },
    ...
    {
      title: 'Название темы',
      content: "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE],  {{ user.mention }}.<br><br>"+
   ...
   title: '---------------------------------------------------------------> Наказаний адм <---------------------------------------------------------------',
   },
    {
      ...
      content: '[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE], {{ user.mention }}![/CENTER]<br><br>' +
        "[CENTER][I] [SIZE=4][FONT=times new roman]Ваша жалоба была одобрена. Будет выдано соответсвущие наказание.<br>" +
 ...
 {
            title: 'другая привязка',
            content:
            "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE],  {{ user.mention }}.<br><br>"+

            "В обжаловании отказано, так как присутствует посторонняя привязка.<br><br>"+
...
{
            title: '48 часов,не подлежит обжалованию',
            content:
              "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE],  {{ user.mention }}.<br><br>"+
        "[CENTER][I] [SIZE=4][FONT=times new roman]С момента выдачи наказания прошло более 48-ми часов.<br>"+
        "Данное нарушение не подлежит обжалованию [/FONT]<br><br>"+
       '[COLOR=RED][I] [SIZE=4][FONT=times new roman]Отказано[/COLOR] [COLOR=WHITE]/[COLOR=WHITE]/ [COLOR=RED]Закрыто.[/FONT][/CENTER]',
        prefix: UNACCEPT_PREFIX,
            status: false,
        },
{
            title: '48 часов,отказ в обжалование',
            content:
              "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE],  {{ user.mention }}.<br><br>"+
        "[CENTER][I] [SIZE=4][FONT=times new roman]С момента выдачи наказания прошло более 48-ми часов.<br>"+
        "В обжалование отказано  [/FONT]<br><br>"+
             "[FONT=courier new][B][CENTER][COLOR=WHITE]С уважением, [/COLOR][COLOR=RED]Заместитель главного администратора[/COLOR] - [COLOR=PURPLE] [I] Artyom_Hayes.<br>"+
       '[COLOR=RED][I] [SIZE=4][FONT=times new roman]Отказано[/COLOR] [COLOR=WHITE]/[COLOR=WHITE]/ [COLOR=RED]Закрыто.[/FONT][/CENTER]',
        prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            "Вам было выдано минимальное наказание, обжалованию не подлежит.<br><br>"+
        ...
        },
  {
            ...
            "Обжалование передана [COLOR=RED] Специальной Администрации.<br>"+
            "[COLOR=WHITE]Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br><br>"+
            '[COLOR=WHITE][I][COLOR=RED]Передано Специальному Администратору.[/COLOR][/FONT][/CENTER]',
            prefix: SPECIAL_PREFIX,
            status: true,
        },
        {
            ...
            "Обжалование передано [COLOR=RED]Главному Администратору.<br><br>"+
        ...
        },
{
            ...
            "Укажите список привязок на аккаунте (ссылки), а именно ВК,ТГ,Почта, а так же укажите примерную дату регистрации аккаунта, страну и город, в котором регистрировался аккаунт. У вас есть 24 часа на ответ..<br><br>"+
    ...
    },
{
	  ...
	  content:
        ...
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=4]В обжаловании отказано.[/FONT][/COLOR][CENTER] "+
    "После проведения тщательной проверки системы логирования на вашем аккаунте не было обнаружено признаков взлома или подозрительной активности. Все действия соответствуют обычной пользовательской активности."+
"Рекомендуем вам не передавать данные от аккаунта третьим лицам и соблюдать правила безопасности:"+ 
"Не сообщайте пароль другим игрокам"+
" Не переходите по подозрительным ссылкам"+
" Используйте сложный и уникальный пароль"+
"В случае возникновения дополнительных вопросов вы всегда можете обратиться в техническую поддержку через соответствующий раздел" +
    ...
    
   {
      ...
      title: 'Разблокировка возможна нрп обман',
	  content:
		"[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE],  {{ user.mention }}.<br><br>"+
     ...
     },
 {
	  ...
	  content:
		"[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE],  {{ user.mention }}.<br><br"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=4]Если вы хотите обжаловать наказание за НонРП обман,тогда вы должны сами связаться с человеком, которого обманули."+
     "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=4]  После чего он должен написать на вас обжалование прикрепив доказательства договора о возврате имущества, ссылку на жалобу которую писал на вас, скриншот окна блокировки обманувшего, ссылки на ВК обеих сторон."+
"[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=4]По другому вы никак не сможете обжаловать наказание за НонРП обман."+
"[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=4]Возврат производиться без моральной компенсации.[/FONT][/COLOR][CENTER] <br><br>" +
 ...
 {
            title: 'Ответственность за действия ',
            content:
            "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE], {{ user.mention }}.<br><br>"+

            "Ответственность за действия на аккаунте несёт исключительно владелец этого аккаунта. В обжаловании отказано. <br>"+
  ...
  },
      {
            ...
            "Зайдите в игру и сделайте скрин окна с баном после чего, заново напишите Обжалование наказаний.<br><br>"+
            '[COLOR=RED][I] [SIZE=4][FONT=times new roman]Отказано[/COLOR] [COLOR=WHITE]/[COLOR=WHITE]/ [COLOR=RED]Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            '[COLOR=RED][I] [SIZE=4][FONT=times new roman] На рассмотрение ',
            prefix: PIN_PREFIX,
            status: true,
},
        {
                         ...
                         {
       title: 'ваш Аккаунт разблокирован 24ч вернуть',
	  content:
		"[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE], {{ user.mention }}.<br><br>"+
        ...
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=4][COLOR=RED][B]ВАЖНО:[COLOR=#FFFFFF]Также не пытайтесь, передавать имущество на твинк аккаунты, за вашим аккаунтом ведется наблюдение.[/FONT][/COLOR][CENTER] <br>" +
  ...
  },
    {
     title: '---------------------------------------------------------------> ТЕМЫ ДЛЯ  <---------------------------------------------------------------',
        ...
        {
            title: 'не относится к предназначению данного раздела',
            content:
            "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE], {{ user.mention }}.<br><br>"+

            "Ваше сообщение никоим образом не относится к предназначению данного раздела.<br><br>"+
