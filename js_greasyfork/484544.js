// ==UserScript==
// @name AudioBookBay hide category: Computer
// @description Hide Computer category
...
// @downloadURL https://update.greasyfork.org/scripts/484544/AudioBookBay%20hide%20category%3A%20Computer.user.js
// @updateURL https://update.greasyfork.org/scripts/484544/AudioBookBay%20hide%20category%3A%20Computer.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Computer'
    $(".post").has(".postInfo:contains('Computer')").hide();
});
