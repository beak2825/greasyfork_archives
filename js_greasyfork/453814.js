...
// @name         FuckDangQi
// @version      2.3.1
// @description  党旗飘飘学习平台刷课工具
// @author       FuckDangQiPiaoPiao
// @namespace    rhythmlian.cn
// @match        https://dangqipiaopiao.cup.edu.cn/zsdy/*
// @match        https://dangqipiaopiao.cup.edu.cn/jjfz/*
...
// @downloadURL https://update.greasyfork.org/scripts/453814/FuckDangQi.user.js
// @updateURL https://update.greasyfork.org/scripts/453814/FuckDangQi.meta.js
// ==/UserScript==
...
let $$ = top.jQuery;
//console.log(url)
if (url == "/zsdy/play" && settings.class) {
    //console.log("测试")
