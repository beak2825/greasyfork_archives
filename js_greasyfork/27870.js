// ==UserScript==
// @name	自己改的平滑的滚动到顶部/底部Add button for Smooth Scroll to the top / bottom
// @author	burningall
...
// @downloadURL https://update.greasyfork.org/scripts/27870/%E8%87%AA%E5%B7%B1%E6%94%B9%E7%9A%84%E5%B9%B3%E6%BB%91%E7%9A%84%E6%BB%9A%E5%8A%A8%E5%88%B0%E9%A1%B6%E9%83%A8%E5%BA%95%E9%83%A8Add%20button%20for%20Smooth%20Scroll%20to%20the%20top%20%20bottom.user.js
// @updateURL https://update.greasyfork.org/scripts/27870/%E8%87%AA%E5%B7%B1%E6%94%B9%E7%9A%84%E5%B9%B3%E6%BB%91%E7%9A%84%E6%BB%9A%E5%8A%A8%E5%88%B0%E9%A1%B6%E9%83%A8%E5%BA%95%E9%83%A8Add%20button%20for%20Smooth%20Scroll%20to%20the%20top%20%20bottom.meta.js
// ==/UserScript==
...
.sroll-btn-troy{\
	...
	box-shadow:2px 2px 40px 2px #20B2AA !important;\
...
function scroll(obj, dir) { //obj随意，dir>0往上滚，dir<0往下滚
	...
	obj.timerScroll = setInterval(function() {
		var position;
		if (dir > 0) { //往上滚动
			var speed = (getSize('scrollTop') / 1) + 10;
			...
			var speed = ((getSize('scrollHeight') - getSize('scrollTop')) / 2) + 10;
			position = getSize('scrollTop') + speed;
			if (position + getSize('clientHeight') >= getSize('scrollHeight')) { //如果滚到底部
...
addEvent(document, '11111111111dblclick', function(event) { //双击进入阅读模式
...
addEvent(document, '111111111111click', function() { //单击退出阅读模式
	if ($('percent')) {
		clearInterval(document.readMode);
		$('percent').style.display = "none";
	}
