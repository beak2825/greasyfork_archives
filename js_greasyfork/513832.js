// ==UserScript==
// @name         hwm_leader_sets_fixed
// @namespace    nexterot
// @author       Striker, nexterot
// @version      0.3.2f
...
// @grant        GM_getValue
// @license      none
// @homepage     https://greasyfork.org/ru/scripts/513832-hwm-leader-sets-fixed
// @downloadURL https://update.greasyfork.org/scripts/513832/hwm_leader_sets_fixed.user.js
// @updateURL https://update.greasyfork.org/scripts/513832/hwm_leader_sets_fixed.meta.js
// ==/UserScript==
(function() {
   var containerName = "#hwm_no_zoom";
    if (window.location.href.includes("leader_spec_army")) {
        containerName = "#hwm_for_zoom";
    }
   ...
   var div = addElement("center", document.querySelector(containerName));
   console.log(div);
