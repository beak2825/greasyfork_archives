...
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/491525/backpack%20tool.user.js
// @updateURL https://update.greasyfork.org/scripts/491525/backpack%20tool.meta.js
// ==/UserScript==
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("div", {
          class: vue.normalizeClass(["backpack-tool transition grid gap-2 text-sm text-white bg-base-700 p-2 rounded relative", { "-translate-y-[90%]": expand.value }]),
