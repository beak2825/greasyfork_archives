// ==UserScript==
// @name         (Modified with add pages) Heasley's Egg Navigator
// @namespace    egg.traverse
// @version      1.5.2
// @description  Traverse every page in Torn in search for eggs
// @author       Heasleys4hemp [1468764] Mod by SlikSteel [3143713]
...
// @downloadURL https://update.greasyfork.org/scripts/533681/%28Modified%20with%20add%20pages%29%20Heasley%27s%20Egg%20Navigator.user.js
// @updateURL https://update.greasyfork.org/scripts/533681/%28Modified%20with%20add%20pages%29%20Heasley%27s%20Egg%20Navigator.meta.js
// ==/UserScript==
'use strict';
...
const EVERY_LINK = ["", "index.php","page.php?sid=ammo","page.php?sid=factionWarfare#/ranked","factions.php?step=your&type=12#/tab=controls&option=members","factions.php?step=your&type=5#/tab=territory","factions.php?step=your&type=12#/tab=rank","forums.php#/p=threads&f=67&t=16326854&b=0&a=0","city.php","jobs.php","gym.php","properties.php","page.php?sid=education",
                    "crimes.php","loader.php?sid=missions","personalstats.php?ID=3143713&stats=useractivity&from=1%20month","newspaper.php","jailview.php","hospitalview.php",
                    "casino.php","page.php?sid=education&category=4&course=35","page.php?sid=hof","factions.php","competition.php","page.php?sid=list&type=friends",
                    "page.php?sid=list&type=enemies","page.php?sid=education&category=1&course=1","page.php?sid=list&type=targets","messages.php","page.php?sid=events","awards.php","points.php","rules.php",
                    "staff.php","credits.php","dump.php#/trash","citystats.php","committee.php","bank.php","donator.php","messages.php#/p=ignorelist","item.php",
                    "page.php?sid=stocks","fans.php","museum.php","loader.php?sid=racing","church.php",
                    "dump.php","loan.php","page.php?sid=travel","joblisting.php","messages.php#/p=outbox","amarket.php","page.php?sid=education&category=9&course=87","bigalgunshop.php","shops.php?step=bitsnbobs",
                    "shops.php?step=cyberforce","shops.php?step=docks","page.php?sid=education&category=6&course=53","shops.php?step=jewelry",
                    "shops.php?step=nikeh","page.php?sid=report#/add","shops.php?step=pawnshop","shops.php?step=pharmacy","pmarket.php",
                    ...
                    "calendar.php","token_shop.php","freebies.php","bringafriend.php","messages.php#/p=saved","comics.php","archives.php","joblist.php",
                    "newspaper_class.php","personals.php","profiles.php?XID=3143713","page.php?sid=education&category=11&course=103","page.php?sid=education&category=12&course=112","newspaper.php#/archive",
                    "profiles.php?XID=1",
                    "bounties.php","page.php?sid=education&category=2&course=14","forums.php#!p=forums&f=999&b=1&a=48809","page.php?sid=education&category=8&course=71","usersonline.php","joblist.php?step=search#!p=corpinfo&ID=79286","page.php?sid=log","page.php?sid=ammo","playerreport.php",
                    "loader.php?sid=itemsMods","displaycase.php","page.php?sid=education&category=10&course=89","trade.php",
                    "crimes.php?step=criminalrecords","awards.php#/merits","awards.php#/medals","page.php?sid=factionWarfare#/dirty-bombs",
                    ...
                    "properties.php?step=rentalmarket","pmarket.php","properties.php?step=sellingmarket","forums.php",
                    "page.php?sid=slots",
                    "page.php?sid=roulette","page.php?sid=education&category=3&course=22","page.php?sid=education&category=5&course=51","page.php?sid=highlow","page.php?sid=keno","page.php?sid=craps",
