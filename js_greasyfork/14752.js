...
// @version     1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/14752/Facebook%20Hide%20Posts.user.js
// @updateURL https://update.greasyfork.org/scripts/14752/Facebook%20Hide%20Posts.meta.js
// ==/UserScript==
...
if (true) {
            ...
            function InfoAbsoluteDivClass(OPTIONS) {
                    ...
                    this.appendToDocument = function(){
                           $('head').append("<style>" + getInfoDivStyle() + "</style>");
                            var div = '<div id="'+ INFO_DIV_CLASS.getId() + '">&nbsp;</div>';
  ...
  */
    function MutationObserverClass(OPTIONS){
            ...
            this.observeAddedNodesIn = function(selector, mutationAddedNodesCallback){  
                   function addedNodesHandler(mutationRecords) {      
                      ...
                      var OBS    = new MO (addedNodesHandler);
                      var nodes  = $(selector);
     ...
     * Miscellaneous tools
     * APPLICATION INDEPENDENT CLASS 
     * DEPENDENT ON LIBRARIES: jQuery
     */
    function DominikToolsClass(OPTIONS){
            "use strict";
            if(typeof $ == "undefined"){
                    throw "jQuery library not found!!";
                    return;
            ...
            this.date = {
                       ...
                       *  
                       * Example usage: 
                       * parseDateDDMMYYYY("25-03-2011").getTime(); 
                       */
                    ...
                    /**
                     * Returns date in format: DD-MM-YYYY (with leading zeros) 
                     */
                    DDMMYYYYFromMicrotime: function(microtime){
                                    var date = new Date(microtime*1000);
                                    //slice gives last 2 characters of the string
    ...
    function facebookTools(OPTIONS){
        ...
        /* @var FACEBOOK_TOOLS facebookTools */
        var FACEBOOK_TOOLS = this;
