...
(function() {
   ...
   var websiteData = [
        ...
        {url : "https://gwaher.com/ptc", login: "", password: ""},
        {url : "https://earnsato.com/user/ptc", login: "", password: ""},
    ...
    var websiteMap = [{
            ...
            website: "claimsatoshi.xyz",
            defaultButtonSelectors: [".card.claim-card .btn.btn-one.bg-dark.btn-block"],
        ...
        {
            website: ["earnsato.com"],
            defaultButtonSelectors: [".card-body.p-4 .btn.fs--12px.px-sm-3.px-2.py-1.btn--base.mt-2"],
