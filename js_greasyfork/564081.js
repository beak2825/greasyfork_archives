...
// @name         APM
// @version      1.0.3
// @author       ABC, Ray Adams, XComhghall
...
// @license      GPL-3.0
// @downloadURL https://update.greasyfork.org/scripts/564081/APM.user.js
// @updateURL https://update.greasyfork.org/scripts/564081/APM.meta.js
// ==/UserScript==

// https://gist.githubusercontent.com/ARC3432/2ed6a7966ca96f1a54028054ce235677/raw/3a6cbe3f1c8042ee598b0b5b67a65f1cf978057b/APM.js
// @downloadURL https://update.greasyfork.org/scripts/463715/APM.user.js
// @updateURL https://update.greasyfork.org/scripts/463715/APM.meta.js
                    ...
                    this.addEventListener = function(type, cb, pro=false) {
                        ...
                        if (type === 'message') {
                            adv.call(this, 'message', (event) => {
                                const decoded = coder.decode(new Uint8Array(event.data));

                                if (decoded) {
                                    this.msgHooks.forEach(hook => {
                                        hook(decoded);
                                    });
                                }
