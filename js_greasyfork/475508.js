...
// @version      0.2
// @license      MIT
// @description  Чекер просмотренных ссылок
// @author       4pda
...
// @include      *
// @downloadURL https://update.greasyfork.org/scripts/475508/Visited%20Links.user.js
// @updateURL https://update.greasyfork.org/scripts/475508/Visited%20Links.meta.js
// ==/UserScript==
    ...
    var MarkLink = function() {
        ...
        $("a").each(function() {
            ...
            if(link && !IsMarked($(this).children().first().text()) && !$(this).text().trim().match(filter)) {
                $(this).prepend("<div class='linkcheck' style='color:red;font-weight:bold;display:inline-block;'>" + (link==this.href?tag1:tag2) + "&nbsp;&nbsp;</div>");
            }
        });
    };
