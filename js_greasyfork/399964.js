...
// @namespace https://greasyfork.org/users/477084
// @downloadURL https://update.greasyfork.org/scripts/399964/Schedule%20Dumper.user.js
// @updateURL https://update.greasyfork.org/scripts/399964/Schedule%20Dumper.meta.js
// ==/UserScript==
    ...
    let promises = $.map(subjectList, subject =>
        new Promise((res, rej) => {
            GM.xmlHttpRequest({
                ...
                onerror: resp => {
                    console.warn(resp);
                    rej(`Failed to fetch data for subject: ${subject.name}, please check log for more detail.`);
                },
                ontimeout: resp => {
                    console.warn(resp);
                    rej(`Failed to fetch data for subject: ${subject.name}, please check log for more detail.`);
