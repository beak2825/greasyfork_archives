// ==UserScript==
// @name         Simon Gota Extension
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  My Extension - Simon
// @author       Simon
...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/25693/Simon%20Gota%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/25693/Simon%20Gota%20Extension.meta.js
// ==/UserScript==
...
function keydown(event) {
    ...
    if (event.keyCode == 69 || event.keyCode == 1) { //( ͡° ͜ʖ ͡°)
        ilikedick();
        setTimeout(ilikedick, imlost);
        setTimeout(ilikedick, imlost*2);
        setTimeout(ilikedick, imlost*3);
    } // Triplesplit
    if (event.keyCode == 1 || event.keyCode == 1) {
        ilikedick();
        setTimeout(ilikedick, imlost);
        setTimeout(ilikedick, imlost*2);
    } // Doublesplit
