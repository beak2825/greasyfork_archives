...
$(document).ready(function() {
    ...
    if (1) {
        if ($("#zhe_nav").length > 0) {} else {
            ...
            if (1||(vurl.indexOf("weibo.com") > 0 || vurl.indexOf("music.163.com") >= 0 || vurl.indexOf("kugou.com") >= 0 || vurl.indexOf("ximalaya.com") >= 0 || vurl.indexOf("qingting.fm") >= 0 || vurl.indexOf("kuaishou.com") >= 0 || vurl.indexOf("douyin.com") >= 0)) {
                ...
                $('body').on('click', '[data-cat=gogob]', function() {
                    ...
                    if (location.href.indexOf("weibo.com") >= 0) {
                        var kuaishouzcvs = 0;
                        if (location.href.indexOf("/tv/show/") >= 0) {
                            kuaishouzcvs = 1;
                            var musicname = "";
                            if ($("div:regex(class, Detail_tith3_\\w+)").length > 0) {
                                musicname = $("div:regex(class, Detail_tith3_\\w+)").text();
                            }
                            /*
                            var oid = /(\d+:\d+)/g.exec(location.href)[1];
                            GM_xmlhttpRequest({
                                type:"GET",
                                url:"https://m.weibo.cn/s/video/object",
                                data:{object_id:oid},
                                success: function(ret){
                                GM_download({
                                    url: ret.data.object.stream.hd_url,
                                    name: musicname,
                                    saveAs: true,
                                    onerror: function() {
                    ...
                    if (location.href.indexOf("music.163.com") > 0) {
                        ...
                        if (location.href.indexOf("song?id=") > 0) {
                            wy163zcvs = 1;
                            GM_openInTab("https://www.sinsyth.com/yyjx/?url=" + encodeURIComponent(location.href), {
                                active: !0
                            });
                        }
                        ...
                        if (location.href.indexOf("163.com/#/mv?id=") > 0 || location.href.indexOf("163.com/#/video?id=") > 0) {
                            ...
                            if ($("#g_iframe").length > 0) {
                                ...
                                if (musicurl.indexOf("blob:") >= 0) {
                                    swal("该视频地址已经被加密，若解析成功稍后几秒即可下载,如果不能下载请换个MV地址再下载。目前还支持QQ音乐MV下载");
                                    return
                                }
                            ...
                            if ($("video").attr("src")) {
                                if ($("video").attr("src").indexOf("blob:") >= 0) {
                                    ...
                                    swal({
                                        ...
                                        if (willDelete) {
                                            GM_openInTab('http://q.dadiyouhui.cn/url/music', {
                                                active: !0
                                            });
                                        }
                                    })
