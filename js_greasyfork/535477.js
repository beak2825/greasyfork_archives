// ==UserScript==
// @name         Free Google Japan
// @namespace    Free Google
// @version      1.0.2
// @description  always set the google search region to Japan
// @author       DumbGPT
// @match        *://*.google.com/*
// @match        *://*.google.co.kr/*
// @match        *://*.google.co.jp/*
...
// @downloadURL https://update.greasyfork.org/scripts/535477/Free%20Google%20Japan.user.js
// @updateURL https://update.greasyfork.org/scripts/535477/Free%20Google%20Japan.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    function modifyURL() {
        ...
        const hasGlParam = url.searchParams.has('gl') && url.searchParams.get('gl') === 'JP';
    ...
    function setCookies() {
        ...
        document.cookie = "PREF=gl=JP:safe=off; expires=Fri, 31 Dec 2030 23:59:59 GMT; path=/; domain=.google.com";
        document.cookie = "NID=; path=/; domain=.google.com";
        
        const domain = window.location.hostname;
        document.cookie = `PREF=gl=JP:safe=off; expires=Fri, 31 Dec 2030 23:59:59 GMT; path=/; domain=${domain}`;
        
        try {
            localStorage.setItem('google_settings_gl', 'JP');
        ...
        if (window.location.href.includes('/preferences') || window.location.href.includes('/setprefs')) {
            ...
            regionSelects.forEach(select => {
                for (let i = 0; i < select.options.length; i++) {
                    if (select.options[i].value === 'countryJP' || select.options[i].value === 'JP') {
