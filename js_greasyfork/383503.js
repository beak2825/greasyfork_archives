...
// @grant          GM_log
// @grant          GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/383503/BvS_Daily%20%28Non-ES6%29.user.js
// @updateURL https://update.greasyfork.org/scripts/383503/BvS_Daily%20%28Non-ES6%29.meta.js
// ==/UserScript==

// ** NOTE ** - This version does NOT use ES6 features. For the other version please visit
//		https://greasyfork.org/en/scripts/2508-bvs-daily
...
function GoPage(strPageName)
{
    ...
    // Linked from village
    marketplace:    new objPage(function() {FormSubmit('market');},    'village', function() {return LocationTest('/bvs/villagemarketplace.html');}),
    tattoo:         new objPage(function() {FormSubmit('tatstime');},  'village', function() {return LocationTest('/bvs/villagetattoo.html');}),
    ...
    breakfast:      new objPage(function() {FormSubmit('dobreakfast');}, 'main', function(){return LocationTest('/bvs/breakfast.html');}),
