...
// @version     3.28-Brown
// @grant       GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/406531/Amo%20-%20Cheater%20-%20Brown.user.js
// @updateURL https://update.greasyfork.org/scripts/406531/Amo%20-%20Cheater%20-%20Brown.meta.js
// ==/UserScript==
...
NoweMenu.innerHTML = '<table style="text-align: left; width: 960px;" border="0" cellpadding="0" cellspacing="0">'
  				   + '<tbody>'
    			   + '<tr>'
      			   + '<td><div id="statystyki" class="menubutton" style="background: url(http://amorion.pl/gui3/button_off.png);"><img src="gui3/statystyki.png" onmouseover="AlterImgMenu(\'statystyki\', \'gui3/button_on.png\')" onmouseout="AlterImgMenu(\'statystyki\', \'gui3/button_off.png\')" onclick="Link(\'dynamic\', \'stats.php\')"></div></td>'
     			   + '<td><div id="bogactwa" class="menubutton"><img src="gui3/bogactwa.png" onmouseover="AlterImgMenu(\'bogactwa\', \'gui3/button_on.png\')" onmouseout="AlterImgMenu(\'bogactwa\', \'gui3/button_off.png\')" onclick="Link(\'dynamic\', \'wealth.php\')"></div></td>'
     			   + '<td><div id="ekwipunek" class="menubutton"><img src="gui3/ekwipunek.png" onmouseover="AlterImgMenu(\'ekwipunek\', \'gui3/button_on.png\')" onmouseout="AlterImgMenu(\'ekwipunek\', \'gui3/button_off.png\')" onclick="Link(\'dynamic\', \'inventory.php\')"></div></td>'
      			   + '<td><div id="klan" class="menubutton"><img src="gui3/klan.png" onmouseover="AlterImgMenu(\'klan\', \'gui3/button_on.png\')" onmouseout="AlterImgMenu(\'klan\', \'gui3/button_off.png\')" onclick="Link(\'dynamic\', \'klany.php?view=my\')"></div></td>'
      			   + '<td><div id="premium" class="menubutton"><img src="gui3/premium.png" onmouseover="AlterImgMenu(\'premium\', \'gui3/button_on.png\')" onmouseout="AlterImgMenu(\'premium\', \'gui3/button_off.png\')" onclick="Link(\'dynamic\', \'premin.php\')"></div></td>'
     			   + '<td><div id="pamietnik" class="menubutton"><img src="gui3/pamietnik.png" onmouseover="AlterImgMenu(\'pamietnik\', \'gui3/button_on.png\')" onmouseout="AlterImgMenu(\'pamietnik\', \'gui3/button_off.png\')" onclick="Link(\'dynamic\', \'notatnik.php\')"></div></td>'
     			   + '<td><div id="opcje" class="menubutton"><img src="gui3/opcje.png" onmouseover="AlterImgMenu(\'opcje\', \'gui3/button_on.png\')" onmouseout="AlterImgMenu(\'opcje\', \'gui3/button_off.png\')" onclick="Link(\'dynamic\', \'account.php\')"></div></td>'
      			   + '<td><div id="wyloguj" class="menubutton"><img src="gui3/wyloguj.png" onmouseover="AlterImgMenu(\'wyloguj\', \'gui3/button_on.png\')" onmouseout="AlterImgMenu(\'wyloguj\', \'gui3/button_off.png\')" onclick="Go(\'logout.php?did=403\')"></div></td>'
    			   + '</tr>'
  				   + '</tbody>'
				   + '</table>'
