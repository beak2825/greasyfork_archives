...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/451491/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%81%D1%82%D0%B0%D1%80%D1%88%D0%B5%D0%B9%20%D0%B0%D0%B4%D0%BC%28%D0%BE%D1%82%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%29%20%D0%B4%D0%BB%D1%8F%20KAZAN.user.js
// @updateURL https://update.greasyfork.org/scripts/451491/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%81%D1%82%D0%B0%D1%80%D1%88%D0%B5%D0%B9%20%D0%B0%D0%B4%D0%BC%28%D0%BE%D1%82%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%29%20%D0%B4%D0%BB%D1%8F%20KAZAN.meta.js
// ==/UserScript==
...
(async function () {
    ...
    const buttons = [
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба передана Зам.Главной Администрации —  @Rodrigo Osuna @Joseph Markelov  <br><br>"+
        `На рассмотрении. `,
      prefix: PIN_PREFIX,
	  status: true,
    },
	{
	  ...
	  status: true,
        ...
        content: `[CENTER][SIZE=5][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
        "Ваша жалоба передана - Специальному Администратору и его заместителю. @Sander_Kligan , @Clarence Crown[/FONT] [COLOR=rgb(251, 160, 38)][FONT=georgia]<br>"+
     ...
     },
 {
        ...
        },
  {
	...
	},
	{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Внимательно ознакомившись с вашим обжалованием, было решено, что вам нужно обратить ся в раздел жалоб на администрацию.<br><br>" +
