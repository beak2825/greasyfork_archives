...
// @license      GNU GPLv3
// @downloadURL https://update.greasyfork.org/scripts/477208/Anti-post%20ou%20cancer.user.js
// @updateURL https://update.greasyfork.org/scripts/477208/Anti-post%20ou%20cancer.meta.js
// ==/UserScript==
...
function requete(place) {
    ...
    req.onload = function() {
        if (req.status === 200) {
            ...
            const hasCancer = /cancer|post ou/.test(content);
            if (hasCancer) {
