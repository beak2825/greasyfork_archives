// ==UserScript==
// @name         Johan_Inject2Download
// @namespace    https://greasyfork.org/en/users/126569-johan-badenhorst
// @version      0.2.6.1
// @description  SimpleMediaDownloadScript
// @author       JohanB1982
// @include      *
// @include      *://*
// @include      *://*/*
...
// @downloadURL https://update.greasyfork.org/scripts/32306/Johan_Inject2Download.user.js
// @updateURL https://update.greasyfork.org/scripts/32306/Johan_Inject2Download.meta.js
// ==/UserScript==
				...
				if (arguments.length > 0 && arguments[0] === "setMedia") {
					if (arguments.length > 1) {
						if (typeof arguments[1] === "object") {
							for (var i in arguments[1]) {     if (!arguments[1].hasOwnProperty(i)) continue;
								if (i === "title" ||
									i === "duration" ||
									i === "track" /* for now */ ||
									i === "artist" ||
