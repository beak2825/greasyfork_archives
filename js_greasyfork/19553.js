// ==UserScript==
// @name         mTurk Dark Theme
// @namespace    http://kadauchi.com/
// @homepage     https://userstyles.org/styles/127483
// @version      1.3.1
// @description  Changes mTurk to a dark theme.
// @author       Kadauchi
// @icon         http://kadauchi.com/avatar.jpg
// @match      https://www.mturk.com/*
// @grant        GM_log
// @downloadURL https://update.greasyfork.org/scripts/19553/mTurk%20Dark%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/19553/mTurk%20Dark%20Theme.meta.js
// ==/UserScript==

(function() {var css = "";
if (false || (new RegExp("^https:\\/\\/www.mturk.com\\/mturk\\/((?!hit_scraper).)*$")).test(document.location.href))
	css += [
		"/***********************/",
		"/****** All pages ******/",
		"/***********************/",
		...
		"b[style=\"display:block;color:#CC6600\"],",
		"span[style*=\"color:#CC6600\"]",
		"{",
		"    color : #336699 !important;",
		"}",
		"",
		".capsule_field_title > a",
		"{",
		"    color : #336699;",
		"}",
		"",
		...
		"    background   : url(http://i.imgur.com/yVfbmzX.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Active HITs Image */",
		...
		"    padding-left : 89px                                          !important;",
		"    padding-top  : 32px                                          !important;",
		"    background   : url(http://i.imgur.com/h2Z2yCP.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Inactive Dashboard Image */",
		...
		"    padding-top  : 32px                                          !important;",
		"    background   : url(http://i.imgur.com/3SdK494.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Active Dashboard Image */",
		...
		"    padding-left : 114px                                         !important;",
		"    padding-top  : 32px                                          !important;",
		"    background   : url(http://i.imgur.com/SB6IXnz.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Inactive Qualification Image */",
		...
		"    padding-left : 114px                                         !important;",
		"    padding-top  : 32px                                          !important;",
		"    background   : url(http://i.imgur.com/cHrGGGf.gif) no-repeat !important;",
		"}",
		"    ",
		"/* Replace Active Qualification Image */",
		...
		"    padding-left : 114px                                         !important;",
		"    padding-top  : 32px                                          !important;",
		"    background   : url(http://i.imgur.com/WwhAoPp.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Go Image */",
		...
		"    background   : url(http://i.imgur.com/jQIJDc3.png) no-repeat !important;",
		"}",
		"",
		"",
		"/* Replace Accept HIT Image */",
		"input[src=\"/media/accept_hit.gif\"]",
		"{",
		"    height        : 0;",
		"    width         : 0;",
		"    border        : 0;",
		...
		"    background    : url(https://i.imgur.com/ecGi7kQ.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Skip HIT Image */",
		"img[src=\"/media/skip_hit.gif\"]",
		"{",
		"    height        : 0;",
		"    width         : 0;",
		"    border        : 0; ",
		...
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/ZI4FvxD.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Return HIT Image */",
		"img[src=\"/media/return_hit.gif\"]",
		"{",
		"    height        : 0;",
		"    width         : 0;",
		"    border        : 0; ",
		...
		"    padding-left  : 82px                                          !important;",
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/dsfsa0t.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Submit Image */",
		"input[src=\"/media/submit_hit.gif\"]",
		"{",
		"    height        : 0;",
		"    width         : 0;",
		"    border        : 0;",
		...
		"    padding-left  : 82px                                          !important;",
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/MLUysNT.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Disabled Submit Image */",
		"img[src=\"/media/submit_hit_disabled.gif\"]",
		"{",
		"    height        : 0;",
		"    width         : 0;",
		"    border        : 0;",
		...
		"    padding-left  : 82px                                          !important;",
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/7h9cqz7.gif) no-repeat !important;",
		"}",
		"",
		"/* Replace Continue Image */",
		"#continueTransferButton,",
		"img[src=\"/media/continue.gif\"],",
		"input[src=\"/media/continue.gif\"]",
		"{",
		"    height        : 0;",
		"    width         : 0;",
		"    border        : 0;",
		...
		"    padding-left  : 82px                                          !important;",
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/ak2fZaH.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Left Double Image */",
		...
		"    background    : url(http://i.imgur.com/P6qZax2.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Left Single Image */",
		...
		"    padding-left  : 16px                                          !important;",
		"    padding-top   : 11px                                          !important;",
		"    background    : url(http://i.imgur.com/UNLhxfp.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Left Double Image */",
		...
		"    padding-left  : 16px                                          !important;",
		"    padding-top   : 11px                                          !important;",
		"    background    : url(http://i.imgur.com/jnmxjA3.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Left Single Image */",
		...
		"    padding-left  : 16px                                          !important;",
		"    padding-top   : 11px                                          !important;",
		"    background    : url(http://i.imgur.com/PWz1wLa.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Non-HIt Submit Image */",
		"input[src=\"/media/submit.gif\"]",
		"{",
		"    width         : 0;",
		"    height        : 0;",
		"    border        : 0;",
		...
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/ztrnqPr.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Yes Image */",
		"input[src=\"/media/yes.gif\"]",
		"{",
		"    width         : 0;",
		"    height        : 0;",
		"    border        : 0;",
		...
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/pcnmC71.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Yes Image */",
		"input[src=\"/media/no.gif\"]",
		"{",
		"    width         : 0;",
		"    height        : 0;",
		"    border        : 0;",
		"    padding-left  : 40px                                          !important;",
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/vMW7ji9.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Confirm Transfer Image */",
		"input[src=\"/media/confirm_transfer.png\"]",
		"{",
		"    width         : 0;",
		"    height        : 0;",
		"    border        : 0;",
		...
		"    background    : url(http://i.imgur.com/R74oHyt.png) no-repeat !important;",
		"}",
		"",
		"/* Replace Cancel Image */",
		"img[src=\"/media/cancel-secondary.png\"]",
		"{",
		"    width         : 0;",
		"    height        : 0;",
		"    border        : 0;",
		...
		"    padding-top   : 22px                                          !important;",
		"    background    : url(http://i.imgur.com/DycCiCw.png) no-repeat !important;",
		"}",
		"",
		"",
		"/****** Hide Elements ******/",
...
if (false || (new RegExp("^https:\\/\\/www.mturk.com\\/mturk\\/((?!hit_scraper|dashboard|transferearnings|last_hits_previewed).)*$")).test(document.location.href))
	css += [
		"iframe ",
		"{",
		...
		"",
		"/* TM Restyling */",
		"div.watcher_button > a ",
		"{",
		"    color : #000000 !important;",
		"}",
		"",
		"/* Great HIT Export and CH Block Using HIT Scraper\'s Blocklist */",
		"a.capsulelink ~ button",
		"{",
		"    color        : #336699 !important;",
...
if (false || (document.location.href.indexOf("https://www.mturk.com/mturk/dashboard") == 0) || (document.location.href.indexOf("https://www.mturk.com/mturk/status") == 0))
	css += [
		"/***********************/",
		"/****** Dashboard ******/",
		"/***********************/",
		...
		"body > #content_container > table[cellspacing=\"0\"] > tbody > tr > td  /* TM */",
		"{",
		"    background-color : #0D0D0D;",
		...
		"",
		"body > table > tbody > tr,",
		"body > #content_container > table > tbody > tr /* TM */",
		"{",
		"    border-color     : #FFFFFF;",
		"    border-width     : 1px;",
		"    border-style     : solid;    ",
		...
		"tr.metrics-table-header-row ~ div.odd:nth-child(odd),  /* Mturk Dashboard */",
		"tr.metrics-table-header-row ~ div.even:nth-child(odd)  /* Mturk Dashboard */",
		"{",
		"    background-color: #1A1A1A;",
		"}",
		"",
		...
		"tr.metrics-table-header-row ~ div.odd:nth-child(even),   /* Mturk Dashboard  */",
		"tr.metrics-table-header-row ~ div.even:nth-child(even),  /* Mturk Dashboard  */",
		"tr.metrics-table-header-row + tr > td                    /* MTurk QualSorter */",
		"{",
		...
		"span[style=\"color:blue;font-family:arial;font-size:10px;\"],  /* MTurk HIT Database Mk.II */",
		"span[style=\"color: blue; font-size: 10px; cursor: pointer; float: right;\"]  /* Mturk Dashboard */",
		"{",
		"    color : #9BAED2 !important;",
		"}",
		"",
		...
		"}",
		"",
		"table#hdbControlPanel > tbody > tr[height=\"25px\"] > td",
		"{",
		"    background-color : #0D0D0D !important;",
		"}",
		"",
		...
		"",
		"",
		"table#hdbResultsTable > tbody > tr > td",
		"{",
		"    color            : #FFFFFF !important;",
...
if (false || (document.location.href.indexOf("https://www.mturk.com/mturk/viewhits?last_hits_previewed") == 0))
	css += [
		"/* Hide Elements */",
		"img[src=\"https://images-na.ssl-images-amazon.com/images/G/01/webservices/mechanical-turk/logoAI3.gif\"],                   /* top left \"amazonmechanicalturk\" image  */",
		"img[src=\"https://images-na.ssl-images-amazon.com/images/G/01/webservices/mechanical-turk/an_amazon_company-medium.gif\"],  /* bottom right \"an amazon company\" image */",
		"img[src=\"/media/top_left_corner.gif\"],      /* top left corner HIT capsule image     */",
		"img[src=\"/media/bottom_left_corner.gif\"],   /* bottom left corner HIT capsule image  */",
		"img[src=\"/media/top_right_corner.gif\"],     /* top right corner HIT capsule image    */",
		"img[src=\"/media/bottom_right_corner.gif\"]  /* bottom right corner HIT capsule image */",
		"{",
		...
		"a.capsulelink,",
		"td.capsule_field_text,",
		"table[cellspacing=\"5\"] > tbody > tr:first-child,",
...
if (false || (document.location.href.indexOf("https://www.mturk.com/mturk/") == 0))
	css += [
		"/****************/",
		"/****** TM ******/",
		"/****************/",
		...
		"}",
		"",
		"#dispatcher .watcher .details ",
		"{",
		"    background-color: #262626 !important;",
		"}",
		"",
		"#dispatcher .watcher.running .details",
		"{",
		"    background-color: #333333 !important;",
		"}",
		"",
		"#dispatcher .watcher.updated",
		"{",
		"    background-color: #666666 !important;",
		"}",
		"",
		"#dispatcher .watcher .details.updated",
		"{",
		"    background-color: #336699 !important;",
		"}",
		"",
		...
		"",
		"div#details_panel,",
		"div#details_panel > div, ",
		"div#details_panel > div >div",
		"{",
		"    color            : #FFFFFF !important;",
		"    background-color : #0D0D0D !important;",
		"}",
		"",
		"",
		"div#add_watcher_form,",
		"div#watcher_container",
		"{",
		"    color            : #FFFFFF !important;",
		"    background-color : #0D0D0D !important;",
		"}",
		"",
		"div#add_watcher_form > h3",
		"{",
		...
		"a.hit_link:visited",
		"{",
		"    background-color : #B8A7C3 !important;",
		"}",
		"",
		"a.mute:hover,",
		"a.hit_link:hover",
		...
		"}",
		"",
		"#settingsDialog .on_off.on span:nth-child(1)",
		"{",
		"    color: #FFFFFF;",
		"    background-color: #336699;",
		"}",
		"",
		"#settingsDialog .on_off span:nth-child(2) ",
		"{",
		"    color: #FFFFFF;",
		"    background-color: #336699;",
		"}",
		"",
		"#settingsDialog .on_off.on span",
		"{",
		"    color: #FFFFFF !important;",
		"}",
		"",
		"#settingsDialog .on_off span",
		"{",
		"    color: #FFFFFF;",
		"}",
		"",
		...
		"",
		"/* Edit */",
		"img[src=\"https://i.imgur.com/peEhuHZ.png\"]",
		"{",
		"    width         : 0 !important;",
		"    height        : 0 !important;",
		"    border        : 0 !important;",
		...
		"    background    : url(http://i.imgur.com/P1lIyc9.png) no-repeat !important;",
		"}",
		"",
		"img[src=\"https://i.imgur.com/5snaSxU.png\"]",
		"{",
		"    width         : 0 !important;",
		"    height        : 0 !important;",
		"    border        : 0 !important;",
		"    padding-left  : 16px                                          !important;",
		"    padding-top   : 16px                                          !important;",
		"    background    : url(http://i.imgur.com/Vyvjoxc.png) no-repeat !important;",
		"}"
	].join("\n");
if (false || (document.location.href.indexOf("https://www.mturk.com/mturk/transferearnings") == 0) || (document.location.href.indexOf("https://www.mturk.com/mturk/requesttransferearnings") == 0))
	css += [
		...
		"",
		"/****** Changes link colors ******/",
		"a[href*=\".amazon.com\"]:link",
		"{",
		"    color : #9BAED2 !important;",
		"}",
		"",
		"a[href*=\".amazon.com\"]:visited",
		"{",
		"    color : #B8A7C3 !important;",
		"}",
		"",
...
if (false || (document.location.href.indexOf("https://www.mturk.com/mturk/youraccount") == 0))
	css += [
...
if (false || (document.location.href.indexOf("https://www.mturk.com/mturk/help") == 0) || (document.location.href.indexOf("https://www.mturk.com/mturk/contact") == 0))
	css += [
		"div.black_text",
		"{",
		" color : #FFFFFF !important;   ",
		...
		"}",
		"",
		"div.contactus input[type=\"submit\"][value=\"Submit\"]",
		"{",
		"    font             : bold 12px verdana, arial, sans-serif;",
		"    color            : #336699 !important;",
		"    border-color     : #262626 !important;",
...
if (false || (document.location.href.indexOf("https://www.mturk.com/mturk/welcome") == 0))
	css += [
		".basefontsize",
		"{",
		"    color : #FFFFFF !important;",
