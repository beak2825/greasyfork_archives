...
// @include	
http://www.marsmissionwiki.wikifoundry.com/thread*
// @include			http://www.marsmissionwiki.wikifoundry.com/forum/*
// @include			http://www.marsmissionwiki.wikifoundry.com/forum
// @include			http://www.marsmissionwiki.wikifoundry.com/account/*/thread/*
// @include			http://www.marsmissionwiki.wikifoundry.com/photo/*/thread/*
// @include			http://www.marsmissionwiki.wikifoundry.com/video/*/thread/*
...
// @downloadURL https://update.greasyfork.org/scripts/9918/UnTaint%20-%20Wiki%20Improvement%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/9918/UnTaint%20-%20Wiki%20Improvement%20Script.meta.js
// ==/UserScript==
// =============================================================================
		...
		if (textElement)
		{
			...
			{	
				...
				if(input.substr != undefined && input.substr(0, 20) == "<thread><posts><post") // are we posting a new post ?
				{
					...
					// Dirtiest array in western hemisphere ;)
					touncensor = ['asshole', 'bitch', 'cunt', 'fuck', 'shit', 'whore', 'pussy', 'damn[^a-z]', 'hell[^a-z]', 'tit[^a-rt-z]', 'cock[^a-rt-z]', 'cum[^a-z]'];
					
					input = input.replace(new RegExp(touncensor.join('|'), 'gi'), function(str) {
...
try {
	...
	if (utpanel)
	{
		// SE: Inner components of the navigation panel
		utpanel.innerHTML=''
