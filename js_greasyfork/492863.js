...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/492863/Omarleboss%20%F0%9F%94%A5.user.js
// @updateURL https://update.greasyfork.org/scripts/492863/Omarleboss%20%F0%9F%94%A5.meta.js
// ==/UserScript==
/*Mod Log
    V1 - Created Omarleboss 🔥 mod, devlopment beings
...
document.getElementById("gameName").innerHTML = "Omarleboss 🔥";
let changes2 = `<div id="customMenuName"><h3 style="font-size: 50px;" class = "indent">By Omarleboss </a></div>`;
...
//document.getElementById("loadingText").innerHTML = "DD.HACK Loading";
document.getElementById("diedText").innerHTML = "Omarleboss 🔥 :C";
document.getElementById("diedText").style.color = "#ffffff";
document.title = " Omarleboss 🔥";
document.getElementById("leaderboard").append("Omarleboss 🔥");
...
document.getElementById('promoImgHolder').innerHTML =
  ...
  - Created Omarleboss 🔥 mod, devlopment beings<br>
...
function handleMessage(m) {
    ...
    /*if(item == "P"){
      setTimeout(() => {
          doNewSend(["M", [{name: "Omarleboss 🔥
          -" + "",moofoll: 1,skin: "#cc5151"}]]);
      }, 200);
      }*/
...
const handleMutations = (mutationsList) => {
    for (const mutation of mutationsList) {
        if (mutation.target.id === "killCounter") {
            ...
            if (count > prevCount) {
                doNewSend(["6", ["Omarleboss 🔥 MOD v2 - autoGG"]]);
                setTimeout(()=>{
                    doNewSend(["6", ["+1 kill"]]);
                },650);
                prevCount = count;
...
$("body").after(`
  <div id="infomenu">
  <hr>
  <div class="nameblock">Omarleboss 🔥Mod v2</div>
  <hr>
  <ul>
