...
// @uso:script		378527
// @scriptsource	https://greasyfork.org/zh-CN/scripts/378527-googlemonkeyr-modified-by-rampagex
// @scriptsource	https://greasyfork.org/zh-CN/scripts/378527-googlemonkeyr-modified-by-rampagex/code/GoogleMonkeyR%20(modified%20by%20rampagex).user.js
/* StartHistory
1.7.3.23 by Izzy
Google site changes:
* #GTR -> #search
...
1.7.3.22 by rampageX
hide new related search

1.7.3.21 by Cook Wu
Get the video and image thumbnail after autoloading back

1.7.3.20 by Cook Wu
try to fix bug images after autoloading again, may be only effective on chrome

1.7.3.19 by Cook Wu
fix bug images after autoloading page > 1, remove site preview and favicon for image search results

1.7.3.18 by Cook Wu
add the option to hide the extra search results like videos, images but not appbar

1.7.3.17 by Cook Wu
modify to show more hidden results

1.7.3.16 by Cook Wu
remove igoogle specific content

1.7.3.15 by Cook Wu
GoogleMonkeyR settings link is back

1.7.3.14 by Cook Wu
fix the bug of numbered list

1.7.3.13 by Cook Wu
fix the bug of open link in a new tab

EndHistory */
// @downloadURL https://update.greasyfork.org/scripts/378527/GoogleMonkeyR%20%28modified%20by%20rampageX%29.user.js
// @updateURL https://update.greasyfork.org/scripts/378527/GoogleMonkeyR%20%28modified%20by%20rampageX%29.meta.js
// ==/UserScript==
...
(function () {
    var UIL =
    {
        ...
        processPage: function (pageType) {
            if (pageType !== null) {
                ...
                if (typeof (this[pageProcessor]) == "function") {
                    ...
                    this.showExtraResults = UIL.Config.getShowExtraResults();
        ...
        searchPageProcessor: function () {
            ...
            var style = ''
            style += ("#cnt.singleton #center_col, #cnt #center_col, #cnt.singleton #foot, #cnt #foot, .mw {width:auto !important; max-width:100% !important;} #rhs {left:auto !important; position:absolute}#botstuff .sp_cnt,#botstuff .ssp, #ires{display:none} .s{max-width:98%!important;} .vshid{display:inline} .ab_dropdown ul{list-style:none} #search *{white-space:normal!important} #search{border-spacing:5px} #rcnt .col:nth-of-type(3){width:100%!important} #rcnt .col:nth-of-type(4){float: none; right: 0px; top: -140px; width:100% !important}");
            ...
            style += ("div.col {width: 100% !important;} #rso .srg {column-count: " + this.numColumns +";}");
            ...
            if (this.numColumns > 1) {
                ...
                bkWMgdWidth = 'auto'; /* Izzy */
                style += ("#cnt.singleton #center_col, #cnt.singleton #foot, #cnt #foot, .mw {margin-left:0 !important;}div.bkWMgd{max-width:" + bkWMgdWidth + " !important}");
            }
            ...
            if (this.searchesRelatedTo) {
                style += (".bkWMgd .kno-kp {display:none;} #center_col #extrares.med{display:none;} #botstuff #brs{display:none;} #topstuff .tqref{display:none;}");
            }
            ...
            style += ("#search li.g, #search div.g { margin-top: 0.15em !important; margin-right: 0.25em !important; margin-bottom: 0.15em !important; margin-left: 0.25em; -moz-border-radius: 10px; border-radius: 10px; " + BGBorder + " " + hue + " ! important; padding: 0.5em ! important; } li.g {list-style:none outside none;" + imagePreview + "};");
        ...
        imagePageProcessor: function () {
            ...
            if (this.searchesRelatedTo) {
                style += (".bkWMgd{display:none;} #center_col #extrares.med{display:none;} #botstuff #brs{display:none;} #topstuff .tqref{display:none;}");
            }

            if (this.showExtraResults) {
                style += ("#appbar{display:none !important;}");
            }
        ...
        insertEndText: function () {
            ...
            var elem = document.buildElement('table', {
                id: "endtext", width: "100%", cellspacing: "2", cellpadding: "0", border: "0", "class": "t bt",
                style: "font-weight:bold;text-decoration:blink"
        ...
        buildResultTable: function () {
            ...
            var div = document.getElementByXPath("//div/div[@class='g']/parent::div | //div[@id='rso']/div/div | //div[@id='res']/span[@id='search'] | //g-section-with-header");
            if (div) {
                ...
                if (this.showExtraResults) {
                    if (document.getElementById('appbar')) {
                        document.getElementById('appbar').outerHTML = "";
                    }
                    var list = document.getElementsByXPath("//div[@class='g' and not(@id='imagebox_bigimages')]");
                }
                else {
                    var multipleCheck = document.getElementByXPath("//*[@id='rso']/div[2]");
                    var list = multipleCheck ? document.getElementsByXPath("//*[@id='rso']/div/div[@class='srg']/div[@class='g'] | //*[@id='rso']/div[not(*[contains(@class, 'srg')])]") : document.getElementsByXPath("//div[@class='g']");
                }
        ...
        resultsToTable: function (list, i, resLength, initial) {
            var link = list[i], div;
            // console.log(link);
            if (this.numResults && (div = document.getElementByXPath(".//div/div/a", link))) {
                // console.log(div)
            ...
            var a = document.getElementByXPath(".//div[contains(@class,'r')]/a", link);
            var imageboxBigimages = document.getElementByXPath(".//div[contains(@id, 'imagebox_bigimages')]", link);
            if (imageboxBigimages) {
                Array.from(document.getElementsByClassName('tHqoQ rg_meta notranslate', link)).forEach(function (element) {
                    element.outerHTML = "";
                });
                Array.from(document.getElementsByClassName('vsqVBf rg_el ivg-i', link)).forEach(function (element) {
                    element.style = "display:inline-block;width:auto !important;height:auto !important;margin-left:5px;margin-right:5px;";
                });
                Array.from(document.getElementsByTagName('g-img', link)).forEach(function (element) {
                    element.style = "";
                });
                Array.from(document.getElementsByClassName('rISBZc M4dUYb', link)).forEach(function (element) {
                    element.style = "";
                });
            }
            Array.from(document.getElementsByClassName('tHqoQ rg_meta notranslate', link)).forEach(function (element) {
            ...
            if (a) {
                ...
                if (this.imagePreview && isImage) {
                    ...
                    sl = sl[1] || sl[2];
                    bs = bs[1] || bs[2] || bs[3];
                    var img = document.buildElement('img', {
                        align: 'left', src: window.location.protocol + "//" + sl + ".searchpreview.de/preview?s=" + bs + "&ra=1",
        ...
        processResults: function (responseText) {
            ...
            var imageRegex = /var _image_src='(\S+)';/gm;
            var imageIdRegex = /var _image_ids=\['(\S+)'\];/gm;
            var imageResult;
            var imageIdResult;
            while ((imageResult = imageRegex.exec(responseText)) !== null) {
                imageIdResult = imageIdRegex.exec(responseText);

                if (imageResult.index === imageRegex.lastIndex) {
                    imageRegex.lastIndex++;
                }
                if (imageIdResult.index === imageIdRegex.lastIndex) {
                    imageIdRegex.lastIndex++;
                }
                var tempElement = document.getElementByXPath(".//img[@id='" + imageIdResult[1] + "']", nextResult);
                if (tempElement) {
                    tempElement.src = eval('"' + imageResult[1] + '"');
                }
            }
            ...
            if (this.showExtraResults) {
                var list = document.getElementsByXPath("//div[@class='g' and not(@id='imagebox_bigimages')]", nextResult);
                if (document.getElementById('appbar', nextResult)) {
                    document.getElementById('appbar', nextResult).outerHTML = "";
                }
            }
            else {
                var multipleCheck = document.getElementByXPath("//*[@id='rso']/div[2]", nextResult);
                var list = multipleCheck ? document.getElementsByXPath("//*[@id='rso']/div/div[@class='srg']/div[@class='g'] | //*[@id='rso']/div[not(*[contains(@class, 'srg')])]", nextResult) : document.getElementsByXPath("//div[@class='g']", nextResult);
            }
        ...
        registerControls: function () {
            ...
            var controls = document.getElementByXPath("//*[@id='ab_options']");
            var liclass = 'hdtb-mitem';
            ...
            if (controls && !link) {
                ...
                var li = document.buildElement('g-header-menu', { 'class': liclass });
    ...
    UIL.Config =
        {
            ...
            getShowExtraResults: function () {
                return this._getBooleanConfig("showExtraResults", false);
            },

            setShowExtraResults: function (showExtraResults) {
                GM_setValue("showExtraResults", showExtraResults);
            },
    ...
    UIL.UI =
        {
                ...
                var refresh = document.buildElement('iframe',
                    {
                        ...
                        src: UIL.RES.REFRESH_HTML
                    }, '', 'load', this.refreshDocumentLoadHandler.bind(this));
            ...
            preferencesDocumentLoadHandler: function () {
                ...
                form.elements.namedItem("showextraresults").checked = UIL.Config.getShowExtraResults();
            ...
            updateLink: function (update) {
                ...
                if (update) {
                    ...
                    if (BrowserDetect.csQuery) {
                        ...
                        link.setAttribute("href", "https://greasyfork.org/zh-TW/scripts/373206-googlemonkeyr-modified-by-cook-wu");
                    ...
                    var link2 = document.buildElement('a', {
                        href: "http://" + location.hostname + "/preferences",
                        target: '_parent', title: ' your Google preferences '
                    }, 'prefs');
            ...
            historyShow: function (e) {
                ...
                var history = document.buildElement("iframe", {
                    src: UIL.RES.HISTORY_HTML,
                    style: "position:fixed;top:5%;left:0px;right:0px;border:none;height:100%;width:100%;overflow:hidden;z-index:10001"
                },
            ...
            preferencesSaveConfigurationHandler: function () {
                ...
                UIL.Config.setShowExtraResults(form.elements.namedItem("showextraresults").checked);
