...
// @grant        window.focus
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/30083/Gamdom%20Utils.user.js
// @updateURL https://update.greasyfork.org/scripts/30083/Gamdom%20Utils.meta.js
// ==/UserScript==
    ...
    function ck(n = 1) {
        ...
        function replaceFunctions() {
            ...
            p.$rainReward[0] = function(...arg) {
                ...
                // ck(5 * cn / 100 / 2);
                console.log('[!] You have received ' + coins.toString() + ' Coins from the rain!');
