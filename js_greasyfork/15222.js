...
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/15222/IMDb%20Tomatoes.user.js
// @updateURL https://update.greasyfork.org/scripts/15222/IMDb%20Tomatoes.meta.js
// ==/UserScript==
...
async function getIMDbMetadata (imdbId, rtType) {
    ...
    const cast = get(main, 'castV2.*.credits.*.name.nameText.text', [])
