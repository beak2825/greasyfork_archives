...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/555431/%D0%97%D0%9A%D0%A2%D0%A1%2056-60.user.js
// @updateURL https://update.greasyfork.org/scripts/555431/%D0%97%D0%9A%D0%A2%D0%A1%2056-60.meta.js
// ==/UserScript==
  ...
  const COMMAND_PREFIX1 = 45; // префикс команде проекта
	...
	const NO_PREFIX = 0; // префикс отсутствует
       const TRANSFER_PREFIX1 = 20; //  префикс передачи админам 56
  const TRANSFER_PREFIX2 = 21; //  префикс передачи в обжалования 56
  const TRANSFER_PREFIX3 = 22; //  префикс передачи в жб на игроков 56
  const TRANSFER_PREFIX4 = 23; //  префикс передачи в тех раздел 56
  const TRANSFER_PREFIX5 = 24; //  префикс передачи в жб на тех 56
  const TRANSFER_PREFIX6 = 25; //  префикс передачи админам 57
  const TRANSFER_PREFIX7 = 26; //  префикс передачи в обжалования 57
  const TRANSFER_PREFIX8 = 27; //  префикс передачи в жб на игроков 57
  const TRANSFER_PREFIX9 = 28; //  префикс передачи в тех раздел 57
  const TRANSFER_PREFIX10 = 29; //  префикс передачи в жб на тех 57
  const TRANSFER_PREFIX11 = 30; //  префикс передачи админам 58
  const TRANSFER_PREFIX12 = 31; //  префикс передачи в обжалования 58
  const TRANSFER_PREFIX13 = 32; //  префикс передачи в жб на игроков 58
  const TRANSFER_PREFIX14 = 33; //  префикс передачи в тех раздел 58
  const TRANSFER_PREFIX15 = 34; //  префикс передачи в жб на тех 58
  const TRANSFER_PREFIX16 = 35; //  префикс передачи админам 59
  const TRANSFER_PREFIX17 = 36; //  префикс передачи в обжалования 59
  const TRANSFER_PREFIX18 = 37; //  префикс передачи в жб на игроков 59
  const TRANSFER_PREFIX19 = 38; //  префикс передачи в тех раздел 59
  const TRANSFER_PREFIX20 = 39; //  префикс передачи в жб на тех 59
  const TRANSFER_PREFIX21 = 40; //  префикс передачи админам 60
  const TRANSFER_PREFIX22 = 41; //  префикс передачи в обжалования 60
  const TRANSFER_PREFIX23 = 42; //  префикс передачи в жб на игроков 60
  const TRANSFER_PREFIX24 = 43; //  префикс передачи в тех раздел 60
  const TRANSFER_PREFIX25 = 44; //  префикс передачи в жб на тех 60
	const buttons = [
    ...
    },
{
  ...
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Технический раздел"[/COLOR] сервера ARKHANGELSK[/center]',
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>" +
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на технических специалистов"[/COLOR] сервера ARKHANGELSK[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на администрацию"[/COLOR] сервера ARKHANGELSK[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на игроков"[/COLOR] сервера ARKHANGELSK[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Обжалование наказаний"[/COLOR] сервера ARKHANGELSK[/center]',
    ...
    },
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Технический раздел"[/COLOR] сервера ORENBURG[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на технических специалистов"[/COLOR] сервера ORENBURG[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на администрацию"[/COLOR] сервера ORENBURG[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на игроков"[/COLOR] сервера ORENBURG[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>" +
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Обжалование наказаний"[/COLOR] сервера ORENBURG][/center]',
    ...
    },
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Технический раздел"[/COLOR] сервера KIROV[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на технических специалистов"[/COLOR] сервера KIROV[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на администрацию"[/COLOR] сервера KIROV[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на игроков"[/COLOR] сервера KIROV[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Обжалование наказаний"[/COLOR] сервера KIROV[/center]',
    ...
    },
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Технический раздел"[/COLOR] сервера KEMEROVO[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на технических специалистов"[/COLOR] сервера KEMEROVO[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на администрацию"[/COLOR] сервера KEMEROVO[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на игроков"[/COLOR] сервера KEMEROVO[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Обжалование наказаний"[/COLOR] сервера KEMEROVO[/center]',
    ...
    },
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Технический раздел"[/COLOR] сервера TUYMEN. [/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на технических специалистов"[/COLOR] сервера TUYMEN.[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на администрацию"[/COLOR] сервера TUYMEN.[/center]',
...
},
{
  ...
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Жалобы на игроков"[/COLOR] сервера TUYMEN[/center]',
	prefix: TRANSFER_PREFIX23,
	status: false,
},
{
  title: 'Перенаправление в ОБЖ Адм 60',
	content:
  "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
  "[COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]Доброго времени суток, уважаемый(-ая) {{ user.mention }}[/CENTER]<br><br>" +
	'[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px]Вы ошиблись разделом. Переношу вашу тему в раздел [COLOR=rgb(255,207,64)]"Обжалование наказаний"[/COLOR] сервера TUYMEN[/center]',
...
const Button16 = buttonConfig("ЖБ ТЕХ56", 'https://forum.blackrussia.online/forums/Сервер-№56-arkhangelsk.2471/');
const Button17 = buttonConfig("ЖБ ТЕХ57", 'https://forum.blackrussia.online/forums/Сервер-№57-orenburg.2513/');
const Button18 = buttonConfig("ЖБ ТЕХ58", 'https://forum.blackrussia.online/forums/Сервер-№58-kirov.2515/');
const Button19 = buttonConfig("ЖБ ТЕХ59", 'https://forum.blackrussia.online/forums/Сервер-№59-kemerovo.2597/');
const Button20 = buttonConfig("ЖБ ТЕХ60", 'https://forum.blackrussia.online/forums/Сервер-№60-tuymen.2640/');
const ButtonTech16 = buttonConfig("ТР56", 'https://forum.blackrussia.online/forums/Технический-раздел-arkhangelsk.2472/');
const ButtonTech17 = buttonConfig("ТР57", 'https://forum.blackrussia.online/forums/Технический-раздел-orenburg.2514/');
const ButtonTech18 = buttonConfig("ТР58", 'https://forum.blackrussia.online/forums/Технический-раздел-kirov.2516/');
const ButtonTech19 = buttonConfig("ТР59", 'https://forum.blackrussia.online/forums/Технический-раздел-kemerovo.2598/');
const ButtonTech20 = buttonConfig("ТР60", 'https://forum.blackrussia.online/forums/Технический-раздел-tyumen.2639/');
const ButtonComp16 = buttonConfig("ЖБ ИГР56", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2500/');
const ButtonComp17 = buttonConfig("ЖБ ИГР57", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2545/');
const ButtonComp18 = buttonConfig("ЖБ ИГР58", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2584/');
const ButtonComp19 = buttonConfig("ЖБ ИГР59", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2626/');
const ButtonComp20 = buttonConfig("ЖБ ИГР60", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2663/');
const ButtonComp111 = buttonConfig("ОПС", "https://forum.blackrussia.online/threads/Общие-правила-серверов.312571/")

bgButtons.append(Button16); // ЖБ ТЕХ56
bgButtons.append(Button17); // ЖБ ТЕХ57
bgButtons.append(Button18); // ЖБ ТЕХ58
bgButtons.append(Button19); // ЖБ ТЕХ59
bgButtons.append(Button20); // ЖБ ТЕХ60
bgButtons.append(ButtonTech16); // ТР56
bgButtons.append(ButtonTech17); // ТР57
bgButtons.append(ButtonTech18); // ТР58
bgButtons.append(ButtonTech19); // ТР59
bgButtons.append(ButtonTech20); // ТР60
bgButtons.append(ButtonComp16); // ЖБ ИГР56
bgButtons.append(ButtonComp17); // ЖБ ИГР57
bgButtons.append(ButtonComp18); // ЖБ ИГР58
bgButtons.append(ButtonComp19); // ЖБ ИГР59
bgButtons.append(ButtonComp20); // ЖБ ИГР60
