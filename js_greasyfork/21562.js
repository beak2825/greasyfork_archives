...
// @downloadURL https://update.greasyfork.org/scripts/21562/hoangquyencs%20VOZ.user.js
// @updateURL https://update.greasyfork.org/scripts/21562/hoangquyencs%20VOZ.meta.js
// ==/UserScript==
...
function FollowThread_bg() {
    var timeoutId = null, timeout = 6e4, storageHelper = null, db = null, link = {subscribedThreads: "https://vozforums.com/subscription.php?do=viewsubscription"};
...
function QuoteNoti_bg() {
    var timeoutId = null, timeout = 6e4, url = "https://vozforums.com/search.php", localStorage = null, formData;
    formData = {
        "do": "process",
        quicksearch: 1,
        childforums: 1,
...
$(function() {
        ...
        $("#threadslist").waitUntilExists(function() {
            var f35          = $("#f35"),
                ...
                ThreadVM = function (id) {
                    ...
                    self.href      = ko.observable("https://vozforums.com/showthread.php?t=" + self.id);
    ...
    function AddToIgnore() {
        $(".vbmenu_popup[id^='postmenu_']").each(function() {
            ...
            var ignoreRow = $("<tr>" + "<td class='vbmenu_option vbmenu_option_alink'>" + "<a target='_blank' href='https://vozforums.com/profile.php?do=addlist&userlist=ignore&u=" + uid + "' title='Mở trong tab mới'>Add to ignore list</a>" + "</td>" + "</tr>");
    ...
    function Emo(xlocalStorage) {
        ...
        function smilieList() {
            ...
            for (var i = 0; i < list.length; i++) {
                ...
                if (smilie.src.indexOf('imgur') === -1) smilie.src = "https://vozforums.com" + smilie.src;
                smilie.clickNum = 0;
            }
            return list;
        }
    ...
    function show_f17_link() {
        var f17 = '<div class="navbar"><a href="forumdisplay.php?f=17"><strong>Chuyện trò linh tinh™</strong></a> (Quick link Voz Love)</div><div class="navbar"><a href="forumdisplay.php?f=33"><strong>Điểm báo™</strong></a> (Quick link Voz Love)</div>';
        $(".page > div > table:first-of-type").before(f17);
        /*var bongda = '<div class="navbar"><a href="https://vozforums.com/showthread.php?goto=newpost&t=4264077"><strong>Bóng đá</strong></a> (Quick link Voz Love)</div>';
    ...
    (function() {
        ...
        settings_VM = {
            settings_options: [{"id": "settings_option_st", "name": "Theo dõi các thread được subscribed (≤ 20)"}, {"id": "settings_option_qn", "name": "Nhận thông báo khi post được quote"}, {"id": "settings_option_sl", "name": "Smile list (Hiện tất cả icon smile của Voz)"}, {"id": "settings_option_qq", "name": "Quote nhanh 1 hay nhiều post"}, {"id": "settings_option_fpp", "name": "Nút 'Capture' để chụp nhanh 1 post"}, {"id": "settings_option_qil", "name": "Hiện link ignore khi click vào username"}, {"id": "settings_option_np", "name": "Chuyển nút 'Go to new post' về cuối (forumdisplay)"}, {"id": "settings_option_rs", "name": "Size ảnh sau khi resize (lazy load) <span id='wrap_resize_choices' data-bind='stopBinding: true'></span>"}, {"id": "settings_option_hs", "name": "Chỉ hiện thanh setting khi rê chuột vào"}, {"id": "settings_option_da", "name": "Enable autoplay và loop video HTML5"}, {"id": "settings_option_rb", "name": "Tạo chữ với hiệu ứng Rainbow <span id='wrap_rainbow_choices' data-bind='stopBinding: true'></span>"}, {"id": "settings_option_bb", "name": "Banh bím<span id='settings_option_bb_img' class='inlineimg'></span>"}, {"id": "settings_option_help", "name": "<a href='javascript:;' title='Click to download' id='download_help'>Download file hướng dẫn chức năng</a>"}],
