// ==UserScript==
// @name         Apt-linker
// @namespace    http://ferk.gitlab.io/userscripts
// @version      1.2
// @description  Turns "apt-get install" lines into "apt://" apturl links
// @author       Ferk
// @grant        none
// @downloadUrl  https://ferk.gitlab.io/userscripts/apt-linker.user.js
// @updateUrl    https://ferk.gitlab.io/userscripts/apt-linker.user.js
// @icon         https://ferk.gitlab.io/userscripts/apt-linker.user.png
// @run-at       document-end
// @include      *
// @downloadURL https://update.greasyfork.org/scripts/422491/Apt-linker.user.js
// @updateURL https://update.greasyfork.org/scripts/422491/Apt-linker.meta.js
// ==/UserScript==

// Turns "apt-get install" lines into clickable apturl links for
// installing Ubuntu and Debian GNU/Linux packages This extension is
// intended to ease the life of Ubuntu/Debian users who browse the
// Internet searching for software, tutorials, etc.
//
// Apt: urls are a way to install packages by using a protocol handler to
// read the list of packages to install.
//
// This extension will turn lines of text describing commands for
// installation into clickable links that allow you to install the
// packages with just 2 clicks.
//
// More info about AptUrl can be found here:
