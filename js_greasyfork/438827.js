...
// @downloadURL https://update.greasyfork.org/scripts/438827/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%9B%B4%E6%8E%A5%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B%E5%A2%9E%E5%BC%BA%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/438827/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%9B%B4%E6%8E%A5%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B%E5%A2%9E%E5%BC%BA%E7%89%88.meta.js
// ==/UserScript==
...
(function() {
    'use strict';
    var errmsg_1='浏览器navigator属性修改失败，自动尝试方案2。';
    var errmsg_2='无法修改浏览器navigator，这将影响屏蔽功能。';
    ...
    function clearPage(){
        ...
        clearcss.innerHTML = ".appDownload,.no-result-file-twocode,.banner-active,.welcome-mask,.welcome-box,.user-level,.side-lalldownload,.vip-notice,.vip-privilege,.app-center,.app-download,.coupon-banner-active,#web-right-view,.ad-platform-tips,.union-hot,.sicon>em{display:none !important;width:0px;height:0px;}";  
        clearcss.innerHTML += ".share-person-username{height:17px !important;}"; 
        ...
        function EditElement(){
            if((pathname.indexOf('/s/')>-1||pathname.indexOf('/share/')>-1)&&window.yunData.FILEINFO){
                ...
                if(window.yunData.FILEINFO[0].md5){
                    ...
                    console.log('无法获取分享文件的md5');
                }
                $('.file-name').html(ret);
            }else{
                console.log('无法获取分享文件的info');
            }
        }
    }
})();