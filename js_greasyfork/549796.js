...
// @require      https://cdn.jsdelivr.net/npm/vue@3.4.14/dist/vue.global.prod.js
// @require      https://cdn.jsdelivr.net/npm/@iconify/iconify@3.1.0/dist/iconify.min.js
// @grant        GM_addStyle
// @grant        GM_notification
// @grant        GM_openInTab
// @grant        GM_registerMenuCommand
// @downloadURL https://update.greasyfork.org/scripts/549796/V2Next-Mobile.user.js
// @updateURL https://update.greasyfork.org/scripts/549796/V2Next-Mobile.meta.js
// ==/UserScript==
  ...
  function run() {
    ...
    window.parse = {
      ...
      parseReplyContent(str) {
        ...
        let res2 = [...has];
        if (res2.length > 0) { // 这里从 length === 1 改为 > 0 即可
          res2.map((item) => {
            getUsername(item[1]);
          });
        }
