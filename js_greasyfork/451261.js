// ==UserScript==
// @name         新·三相之力指示器加帕清姬识别
// @namespace    mhy,tx,yj,vtb
// @version      0.37.1
// @description  B站评论区自动标注三相玩家，依据是动态里是否有三相相关内容（基于原神指示器和原三相一些小的修改）（v圈识别加入帕清姬）建议非帕清姬使用原三相之力脚本，因为这就略微改一下，而且查帕清姬你也查不出来什么
//关注真白花音谢谢喵~
// @author       眞白かのん's3^7=21（改）xulaupuz&nightswan（原）
...
// @license MIT
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/451261/%E6%96%B0%C2%B7%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B%E6%8C%87%E7%A4%BA%E5%99%A8%E5%8A%A0%E5%B8%95%E6%B8%85%E5%A7%AC%E8%AF%86%E5%88%AB.user.js
// @updateURL https://update.greasyfork.org/scripts/451261/%E6%96%B0%C2%B7%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B%E6%8C%87%E7%A4%BA%E5%99%A8%E5%8A%A0%E5%B8%95%E6%B8%85%E5%A7%AC%E8%AF%86%E5%88%AB.meta.js
// ==/UserScript==
...
(function () {
    ...
    const tag_pqj_Inner = "<b style='color: #946845'>" + tag_pqj + "</b>"
                ...
                GM_xmlhttpRequest({
                    ...
                    onload: function (res) {
                        if (res.status === 200) {
                            ...
                            unknown.delete(pid)
                            //vtuber
                            if (bshow && (st.includes(keyword_jxt) || st.includes(keyword_ccj) || st.includes(keyword_gcb)|| st.includes(keyword_pqj))) {
                                ...
                                //添加菜标签
                                if (st.includes(keyword_pqj)) {
                                    c.innerHTML += tag_pqj_Inner
                                    pqj.add(pid)
                                } else {
                                    no_pqj.add(pid)
                                }
