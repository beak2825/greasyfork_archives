...
// @include        *apps.facebook.com/gloryofrome/?s=*
// @include        *.ryrome.com*
...
// @grant		GM_info
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/463014/MiracleGOR.user.js
// @updateURL https://update.greasyfork.org/scripts/463014/MiracleGOR.meta.js
// ==/UserScript==

(function() {
var Version = '2.0.0';
var Autore = 'Tiestoale/Virmagnus';
var ScriptName = 'MiracleGOR';
var miseajour = ScriptName + ' ' + Version + ' - by ' + Autore;
var sitesupport = "https://gamespowerita.com";
...
var SWF_PLAYER_URL = "https://gamespowerita.com/Tools/GoR/Plugins/Allarmi/miniplayer.swf";
var SWF_ALARM_URL = "https://gamespowerita.com/Tools/GoR/Plugins/Allarmi/alarmplayer.swf";
var URL_CASTLE_BUT = "https://gamespowerita.com/Tools/GoR/Plugins/Castelli/CastNotSel.png";
var URL_CASTLE_BUT_SEL = "https://gamespowerita.com/Tools/GoR/Plugins/Castelli/CastSel.png";
...
var DEFAULT_ALERT_SOUND_URL = 'https://gamespowerita.com/Tools/GoR/Plugins/Allarmi/RedAlert.mp3';
...
var Options = {
	...
	alertSound			:	{
  	...
  	Chuchoenabled		:	true,
  	urlChucho			:	'https://www.universal-soundbank.com/mp3/sounds/735.mp3',
  	Attackenabled		:	true,
  	urlAttack			:	'https://www.universal-soundbank.com/mp3/sounds/217.mp3', 
  	Spyenabled			:	true,
  	urlSpy				:	'https://www.universal-soundbank.com/mp3/sounds/2376.mp3', 
  	HelpRequest			:	true,
  	DeleteRequest		:	false,
  	DeleteRules			:	false,
  	maxIdlePop			:	true,
...
function facebookInstance() {
  function setWide() {
    ...
    var contentCol = document.querySelector('#contentCol');
    if (contentCol) {
      contentCol.style.width = '100%';
      contentCol.style.margin = '0px';
      contentCol.style.paddingTop = '5px';
    }
    ...
    var bottomContent = document.querySelector('#bottomContent');
    if (bottomContent) {
      bottomContent.style.padding = "0px 0px 12px 0px";
    }
    ...
    var pageletCanvasContent = document.querySelector('#pagelet_canvas_content');
    if (pageletCanvasContent) {
      pageletCanvasContent.style.width = '100%';
    }
...
//   ['ImpExp', 'Imp-Exp']
  ...
  var m = '.xtab {padding: 2px; border:none; background:none; white-space:nowrap;}';
      m+= '.sc1 { background:url("https://gamespowerita.com/Tools/GoR/Plugins/Avatar/Tiestoale.png") no-repeat scroll 0px 0 transparent !important; }';
      m+= '.merdaccia { background:url("https://gamespowerita.com/Tools/GoR/Plugins/Avatar/Cacca1.png") no-repeat scroll 0px 0 transparent !important;}';
      m+= '.scThy { background:url("https://gamespowerita.com/Tools/GoR/Plugins/Avatar/Thyrus1.jpg") no-repeat scroll 0px 0 transparent !important;}';
	  ...
	  m+= '.matTabNotSel span { background: url("https://kabam1-a.akamaihd.net/gloryofrome/common/img/gor/progress_engagement/socialtab_up.png") no-repeat scroll left 0 transparent;    display: inline-block;    height: 16px;    padding: 1px 2px 0 7px; text-decoration: none;   }';
	  m+= '.matTabSel { color : black; font: bold 11px Georgia; white-space: nowrap; cursur:pointer; padding:0 0px 0 0;height: 17px;   }';
	  m+= '.matTabSel span { background: url("https://kabam1-a.akamaihd.net/gloryofrome/common/img/gor/progress_engagement/socialtab_down.png") no-repeat scroll left top transparent; display: inline-block;    height: 16px;    padding: 1px 2px 0 7px; text-decoration: none;   }';
...
var ChatStuff = {
  ...
  setEnable : function (tf){
   ...
   gotPlayerDetail : function (rslt){
      ...
      if(c){
      window.open('https://www.facebook.com/profile.php?id='+u.fbuid)
      }
  },
        ...
        if (rpt.side0Name===undefined) {
  	   ...
  	   style=' style="background-color:#99EF99;padding:2px;"';
          ...
          if (rpt.marchType == 3 && rpt.TypeName=="Ent") {
           ...
           m+='<img onclick="getReport('+rpt.reportUnixTime+','+ rpt.marchReportId +','+rpt.side0TileType +',\''+rpt.TypeName+'\',\''+rpt.side1Name.replace(/\'/g,"_")+'\',\''+ rpt.side1XCoord +','+ rpt.side1YCoord +'\',\''+rpt.side0Name.replace(/\'/g,"_")+'\',\''+ rpt.side0XCoord +','+ rpt.side0YCoord +'\');" border=0 src="https://cdn1.iconfinder.com/data/icons/woothemesiconset/16/search_button.png">';
          }
          m+='&nbsp;</td>\
  ...
  show : function (){
    ...
    for (var c=0; c<Cities.numCities; c++){
             ...
             city.c.wilderness().each(function(wild)
	    {
	     ...
	     <a onclick="this.style.display=\'none\';setTimeout (function (){Castle.abandonWild('+wild.id+');setTimeout(function() { BOTerres() },1000); },500);return false;"><img src="https://cdn1.iconfinder.com/data/icons/musthave/16/Remove.png" border=0></a></td><td align=left>'+wild.name +'</td>\
      ...
      ById('TransportTroop').value = 'u9';
        ...
        e_tradeRoutes: function(){
     	...
     	paintTradeRoutes: function(){
             ...
             if (r[i].ship_Food) m += '<TR><TD></td><TD align=center><img src="https://cdn1.kingdomsofcamelot.com/fb/e2/src/img/food_30.png"></td><TD>'+uW.arStrings.Common.Target+': '+ addCommas(r[i].target_Food) +'</td>';
     				if (r[i].ship_Wood) m += '<TR><TD></td><TD align=center><img src="https://cdn1.kingdomsofcamelot.com/fb/e2/src/img/wood_30.png"></td><TD>'+uW.arStrings.Common.Target+': '+ addCommas(r[i].target_Wood) +'</td>';
     				if (r[i].ship_Stone) m += '<TR><TD></td><TD align=center><img src="https://cdn1.kingdomsofcamelot.com/fb/e2/src/img/stone_30.png"></td><TD>'+uW.arStrings.Common.Target+': '+ addCommas(r[i].target_Stone) +'</td>';
     				if (r[i].ship_Ore) m += '<TR><TD></td><TD align=center><img src="https://cdn1.kingdomsofcamelot.com/fb/e2/src/img/iron_30.png"></td><TD>'+uW.arStrings.Common.Target+': '+ addCommas(r[i].target_Ore) +'</td>';
     				if (r[i].ship_Gold) m += '<TR><TD></td><TD align=center><img src="https://cdn1.kingdomsofcamelot.com/fb/e2/src/img/gold_30.png"></td><TD>'+uW.arStrings.Common.Target+': '+ addCommas(r[i].target_Gold) +'</td>';
            }
     	     m +='</table>';
...
my.News = {
  ...
  init : function (){
    ...
    if (parseInt(Options.Lingua) != 0) {
		GM_xmlhttpRequest({
			method: 'GET',
			url: 'https://gamespowerita.com/Tools/GoR/Plugins/News/GoRNews.txt',
			headers: {
...
my.BoTTols = {
  ...
  show : function (){
    ...
    t.cont.innerHTML = '<CENTER><iframe src="https://gamespowerita.com" width="750" height="690" id="BOFrame" border=0></iframe><BR></center>'; 
 	} catch (e) {
        t.cont.innerHTML = '<PRE>'+ e.name +' : '+ e.message +'</pre>';  
      }      
  },
...
my.scanmap = {
  ...
  show : function (){
    ...
    t.cont.innerHTML = '<CENTER><iframe src="https://www.gptscanmap.com" width="780px" height="650px" id="BOFrame" border=0></iframe><BR></center>'; 
 	} catch (e) {
        t.cont.innerHTML = '<PRE>'+ e.name +' : '+ e.message +'</pre>';  
      }      
  },
  ...
  ResAllianceInfo : function (rslt){
    ...
    _addTab: function(Name,Might,LastLogin,Position,dip,Cities,avatar,dateJoined,Id){
      ...
      //       row.style.backgroundColor = Font;
             ...
             row.insertCell(9).innerHTML = '<img src="https://icons.iconarchive.com/icons/awicons/vista-artistic/16/delete-icon.png" onclick="RemoveMember('+Id+')" alt="'+uW.arStrings.NeighborsPage.Remove+'" />';
          },     
    _addTabHeader: function() {
    var t = my.Manager;
...
my.Options = {
  ...
  show : function (){
	...
	<TR><TD><INPUT id=BOSpyEnable type=checkbox '+ (Options.Spyenabled?'CHECKED ':'') +'/></td><TD>'+translate('Enable audio in case of SCOUT (Alliance)')+'</td></tr>\
        ...
        <TR><TD>&nbsp;</td><TD><br>'+translate('Table of colors')+' <INPUT id=ColHelp type=submit value="'+translate('Open')+'" onclick=window.open("https://bastnt.free.fr/palette.html");></td></tr>\
    ...
    ById('CollectNow').addEventListener ('click', function (){
     ...
     ById('BOChuchoEnable').addEventListener ('click', function (){
       ...
       ById('BOurlChucho').addEventListener ('change', function (){
               if (ById('BOurlChucho').value=="") ById('BOurlChucho').value="https://www.universal-soundbank.com/mp3/sounds/684.mp3";
     ...
     ById('BOSpyEnable').addEventListener ('click', function (){
      ...
      ById('BOurlAttack').addEventListener ('change', function (){
               if (ById('BOurlAttack').value=="") ById('BOurlAttack').value="https://www.universal-soundbank.com/mp3/sounds/217.mp3";
                 Options.urlAttack = ById('BOurlAttack').value;
                  saveOptions();
     }, false); 
     ById('BOurlSpy').addEventListener ('change', function (){
               if (ById('BOurlSpy').value=="") ById('BOurlSpy').value="https://www.universal-soundbank.com/mp3/sounds/2376.mp3";
 ...
 eventSubmit : function (){
  ...
  fetchPlayerStatus : function (uidArray, notify){
   ...
   gotPlayerDetail : function (rslt, span){
      ...
      span.innerHTML = m + p.join (', ') +'</td></tr><tr><td></td><td>Facebook : <a href=https://www.facebook.com/profile.php?id='+u.fbuid+' target=_blank>'+uW.arStrings.ModalTitle.Profile+'</a></td></tr></table>';
  },
...
function AddMainTabLink(text, eventListener, mouseListener) {
  ...
  if(tabs) {  
		...
		for (var i = 0; i < col_wrapper.length; i++) {
    		if (Options.HideTab && (col_wrapper[i].href.indexOf("forumdisplay.php?11-Glory-of-Rome") >= 0 || col_wrapper[i].href.indexOf("salesforce/help") >= 0 || col_wrapper[i].href == "https://www.facebook.com/apps/application.php?id=140956165916773" || col_wrapper[i].href == "https://apps.facebook.com/gloryofrome/")) {
...
function CheckUpdates ()
{
	...
	(
		{
			method	:	"GET",
			url		:	"https://gamespowerita.com/Tools/GoR/bottols.user.js",
			onload	: 
				function (a)
				{
