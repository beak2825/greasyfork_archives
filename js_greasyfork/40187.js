...
// @namespace    felix-douban-movie
// @description    网页信息增强，并入IMDB评分系统, 提供在线观看便捷链接，提供资源提供站点哦便捷链接。美化界面。在原版基础上增加各个链接地址的查询结果
...
// @connect        ttmeiju.vip
// @connect        gaoqing.la
// @connect        pianyuan.net
// @connect        gaoqingkong.com
// @connect        btmyi.com
// @connect        rarbg.is
// @connect        hanhanfilm.com
// @connect        gagays.xyz
// @connect        bt.acg.gg
...
if (!document.getElementById("seBwhA") && document.title.indexOf('豆瓣') !== -1) {
    ...
    if (location.href.startsWith('https://movie.douban.com/subject/')) {
        ...
        $(document).ready(function() {
            ...
            var site_offline, site_online, site_sub, update_site_offline_sites, update_site_online_sites, update_site_sub_sites;
            ...
            update_site_offline_sites = function(title, en) {
                ...
                if (en) {
                    site_offline_sites = {
                        ...
                        'rarbg': 'http://rarbg.is/torrents.php?search=' + title
                    };
                } else {
                    site_offline_sites = {
                        '百度盘': "http://pansou.com/?q=" + title,
                        '龙部落': 'http://www.lbldy.com/search/' + title,
                        '嘎嘎影视': "http://www.gagays.xyz/movie/search?req%5Bkw%5D=" + title,
                        '天天看电影': 'http://www.xbdmov.com/index.php?m=vod-search&wd=' + title,
                        '天天美剧': 'http://www.ttmeiju.vip/index.php/search/index.html?keyword=' + title + '&range=0',
                        '电影首发站': 'http://www.dysfz.cc/key/' + title+'/',
                        '电影街': 'https://moviejie.net/search/q_' + title,
                        ...
                        "MiniMP4": "http://www.minimp4.com/search?q=" + title,
                        ...
                        "BT蚂蚁": "http://www.btmyi.com/search.html?kw=" + title,
                        "字幕组": "http://www.zimuzu.tv/search?keyword=" + title+'&type=resource',
                        "磁力猫": "http://www.cilimao.me/search?word=" + title + "&resourceType=1",
                        '磁力站': 'http://oabt004.com/index/index?c=&k=' + title,
                        'RARBT': 'http://www.rarbt.com/index.php/search/index.html?search=' + title,
                        "憨憨电影": "https://www.hanhanfilm.com/search/keyword?q=" + title,
                        ...
                        "逛电驴": "http://verycd.gdajie.com/find.htm?keyword=" + title ,
                        "Torrentseeker": "https://torrentseeker.com/search.php?q=" + title
                    };
                }
            ...
            site = $('div.aside a[data-host$=\'xbdmov.com\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'dysfz.cc\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'moviejie.net\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'pniao.com\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'minimp4.com\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
                getDoc(site_href, meta, function(doc, resp, meta) {
                    var lists;
                    site = meta['site'];
                    lists = $('.result-item p.movie-name', doc);
                    if (lists.length === 0) {
                        site.addClass('disabled');
                        return;
                    } else{
            ...
            site = $('div.aside a[data-host$=\'bttt.la\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'btba.com.cn\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'btbtt.co\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'zimuzu.tv\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'cilimao.me\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
                getDoc(site_href, meta, function(doc, resp, meta) {
                    var lists;
                    site = meta['site'];
                    lists = $('#Search__content_left___2MajJ div.Search__result___2S94i', doc);
                    if (lists.length === 0) {
                        site.addClass('disabled');
                        return;
                    } else{
            ...
            site = $('div.aside a[data-host$=\'oabt004.com\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
                getDoc(site_href, meta, function(doc, resp, meta) {
                    var lists;
                    site = meta['site'];
                    lists = $('.link-list-wrapper ul.link-list', doc);
                    if (lists.length === 0) {
                        site.addClass('disabled');
                        return;
                    } else{
            ...
            site = $('div.aside a[data-host$=\'rarbt.com\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'ttmeiju.vip\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
                getDoc(site_href, meta, function(doc, resp, meta) {
                    var lists;
                    site = meta['site'];
                    lists = $('table.latesttable .tr', doc);
                    if (lists.length <=1) {
                        site.addClass('disabled');
                        return;
                    } else{
            ...
            site = $('div.aside a[data-host$=\'gaoqing.la\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'pianyuan.net\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'gaoqingkong.com\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'btmyi.com\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
                getDoc(site_href, meta, function(doc, resp, meta) {
                    var lists;
                    site = meta['site'];
                    lists = $('.col-md-8 div.panel-default', doc);
                    if (lists.length === 0) {
                        site.addClass('disabled');
                        return;
                    } else{
            ...
            site = $('div.aside a[data-host$=\'rarbg.is\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'hanhanfilm.com\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'gagays.xyz\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
                getDoc(site_href, meta, function(doc, resp, meta) {
                    var i, l, links, lists;
                    site = meta['site'];
                    lists = $('.movie-res-list-large li', doc);
                    if (lists.length === 0) {
                        site.addClass('disabled');
                        return;
                    } else{
            ...
            site = $('div.aside a[data-host$=\'bt.acg.gg\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
            ...
            site = $('div.aside a[data-host$=\'share.dmhy.org\']');
            if (site) {
                site_href = site.attr('href');
                meta = new Array;
                meta['site'] = site;
                getDoc(site_href, meta, function(doc, resp, meta) {
                    var lists;
                    site = meta['site'];
                    lists = $('.tablesorter tbody tr', doc);
                    if (lists.length === 0) {
                        site.addClass('disabled');
                        return;
                    } else{
