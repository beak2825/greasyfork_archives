// ==UserScript==
// @name   🌱【免费版】柠檬文才学堂|学历帮|广州南方学院|如需秒过、答题、自动换课、无人值守等高级收费版本见文档：https://doc.zhanyc.cn/pages/nmwcxt/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制、自动下一集功能。如需秒过、答题、自动换课、无人值守等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/506202/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%9F%A0%E6%AA%AC%E6%96%87%E6%89%8D%E5%AD%A6%E5%A0%82%7C%E5%AD%A6%E5%8E%86%E5%B8%AE%7C%E5%B9%BF%E5%B7%9E%E5%8D%97%E6%96%B9%E5%AD%A6%E9%99%A2%7C%E5%A6%82%E9%9C%80%E7%A7%92%E8%BF%87%E3%80%81%E7%AD%94%E9%A2%98%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E3%80%81%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccnpagesnmwcxt.user.js
// @updateURL https://update.greasyfork.org/scripts/506202/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%9F%A0%E6%AA%AC%E6%96%87%E6%89%8D%E5%AD%A6%E5%A0%82%7C%E5%AD%A6%E5%8E%86%E5%B8%AE%7C%E5%B9%BF%E5%B7%9E%E5%8D%97%E6%96%B9%E5%AD%A6%E9%99%A2%7C%E5%A6%82%E9%9C%80%E7%A7%92%E8%BF%87%E3%80%81%E7%AD%94%E9%A2%98%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E3%80%81%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccnpagesnmwcxt.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制、自动下一集功能。如需秒过、答题、自动换课、无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/nmwcxt/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("web/video/player")) {
                plugMain.page_video();
            } else if (url.includes("/console/templates/normal/")) {
                plugMain.page_normal();
            } else if (url.includes("/apply/studyOnline/index.html")) {
                plugMain.page_list();
            } else if (url.includes("/course/learning/learn_course.jsp")) {
                plugMain.page_course();
            } else if (
                url.includes("/courseware/index.html") ||
                url.includes("/coursewareXBSF/index.html?")
            ) {
                plugMain.page_video()
                plugMain.page_courseware();
            } else if (url.includes("/course/learning/learn_notice.jsp")) {
                plugMain.page_learn_notice();
            } else if (url.includes("/learning/learn_homework.jsp")) {
                plugMain.page_learn_homework();
            } else if (url.includes("/exam/portal/exam_info.jsp")) {
                plugMain.page_exam_info();
            } else if (url.includes("/exam/portal/view_answer.jsp")) {
                plugMain.page_view_answer();
            } else if (url.includes("/exam/portal/exam.jsp")) {
                plugMain.page_exam();
            } else if (url.includes("/separation/exam/index.html")) {
                plugMain.page_ks();
            }
        },
        async page_normal() {
            await zfk.waitOf((a) => zfk.getElByText($("a"), "在线课程学习") != null);
            await zfk.waitTimeout(1000);
            zfk.confirmRun().then((a) => {
                zfk.getElByText($("a"), "在线课程学习")[0].click();
            });
        },
        async page_video() {
        ...
        async page_exam_info() {
            plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
        },
        async page_learn_homework() {

            plugMain.showPaidContent(`免费版本不包含自动答题功能，如需使用请安装收费版本`);
        },
        async page_learn_notice() {
        },
        async page_courseware() {
            console.log("%c page_courseware", "background:rgb(0,0,0);color:#fff");
            await plugMain.waitOf((a) => $("#backBtn").length > 0);
        ...
        async page_course() {
            ...
            await plugMain.waitOf((a) => $(".scorm").length > 0);
            await plugMain.waitTimeout(1000);

            if ($(".scorm.notattempt,.scorm.incomplete").length == 0) {
                // plugMain.confirmRun("3秒后执行测试").then((a) => {
                //   plugMain.getElByText($("a"), "作业和测验")[0].click();
                // });
                plugMain.alert("视频课程完成")
                plugMain.showPaidContent(`免费版本不包含自动换课功能，如需使用请安装收费版本`);

                return;
            }
            // $(".scorm.notattempt").eq(0).next()[0].click();
            plugMain.confirmRun("3秒后进入下一集", 3000).then((a) => {
                $(".scorm.notattempt,.scorm.incomplete").eq(0).next()[0].click();
            });
        },
        async page_list() {
        ...
        async page_ks() {
            ...
            plugMain.showPaidContent(`免费版本不包含自动考试功能，如需使用请安装收费版本`);
        },
        checkVideoPlay() {
