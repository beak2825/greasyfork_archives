// ==UserScript==
// @name            HDTime一键认领
// @name:en         HDTime torrents claim
// @namespace       http://hdtime.org/
// @version         0.0.4
// @description     一键认领
// @description:en  one key claim all the seeding torrents in HDTime.
// @author          Kesa
// @match           https://hdtime.org/userdetails.php?id=*
// @license         MIT
// @grant           unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/469883/HDTime%E4%B8%80%E9%94%AE%E8%AE%A4%E9%A2%86.user.js
// @updateURL https://update.greasyfork.org/scripts/469883/HDTime%E4%B8%80%E9%94%AE%E8%AE%A4%E9%A2%86.meta.js
// ==/UserScript==
  ...
  unsafeWindow.ClassificationClaimTorrents = async function (element, maxClaim) {
    ...
    for (const el of element) {
      ...
      if (claimId > 0) {
        ...
        xhr.open('POST', 'https://hdtime.org/ajax.php', true);
