...
// @downloadURL https://update.greasyfork.org/scripts/446305/52%E6%95%99%E8%82%B2%E7%9B%98.user.js
// @updateURL https://update.greasyfork.org/scripts/446305/52%E6%95%99%E8%82%B2%E7%9B%98.meta.js
// ==/UserScript==
 ...
 (function () {
        ...
        document.querySelector("#priate_script_div").onclick = function () {
            ...
            // alert(setting3.sss)
             ...
             var x = b[0].split("'")[1]
             var y = b[1].split("'")[1]
            window.open("https://jiaoyupan.com/plugin.php?id=threed_attach:downld&aid=" + x + "&formhash=" + y,
                "_blank");
        }
