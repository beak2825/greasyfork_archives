...
// @include     https://**/*
// @license ZYY
// @downloadURL https://update.greasyfork.org/scripts/473922/%E9%97%AE%E5%8D%B7%E6%98%9F%E8%87%AA%E5%8A%A8%E5%8C%96%E5%A1%AB%E5%86%99---%E5%9F%BA%E7%A1%80%E6%95%99%E6%9D%90%EF%BC%88%E6%B5%8B%E8%AF%95%E9%97%AE%E5%8D%B7002%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/473922/%E9%97%AE%E5%8D%B7%E6%98%9F%E8%87%AA%E5%8A%A8%E5%8C%96%E5%A1%AB%E5%86%99---%E5%9F%BA%E7%A1%80%E6%95%99%E6%9D%90%EF%BC%88%E6%B5%8B%E8%AF%95%E9%97%AE%E5%8D%B7002%EF%BC%89.meta.js
// ==/UserScript==
...
(function() {
    ...
    var wenjuan_url = 'https://www.wjx.cn/vj/OIdRfIc.aspx';
    ...
    //6
    //填空题模板（多个答案，可定制比例）
    tiankong_list = ['3000','5000','200000'];
    bili = [33,33,34];
    document.querySelector('#q6').value=tiankong_list[danxuan(bili)]
    //7
    ops = lists[ccc].querySelectorAll('li')
    ccc+=1
    bili = [70,30];
    ...
    ops = lists[ccc].querySelectorAll('li');
    ccc+=1;
    bili = [10,10,10,10,10,10,10,10,20,0];
    ...
    //12
    //填空题模板（多个答案，可定制比例）
    tiankong_list = ['185','190','150'];
    bili = [33,33,34];
    document.querySelector('#q12').value=tiankong_list[danxuan(bili)]

    //13
    //填空题模板（多个答案，可定制比例）
    tiankong_list = ['0','1','150'];
    bili = [33,33,34];
    document.querySelector('#q13').value=tiankong_list[danxuan(bili)]

    // 14
    //单选的量表题模板
    liangbiao_lists = document.querySelectorAll('#div14 tbody tr')
    liangbiao_index=0
    //14-1
    ...
    //15多选的量表题模板
    liangbiao_lists = document.querySelectorAll('#div15 tbody tr')
    liangbiao_index=0
    //15-1
    ops = liangbiao_lists[liangbiao_index].querySelectorAll('td')
    liangbiao_index+=1
