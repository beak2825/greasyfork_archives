...
// @downloadURL https://update.greasyfork.org/scripts/446358/Instagram%202014.user.js
// @updateURL https://update.greasyfork.org/scripts/446358/Instagram%202014.meta.js
// ==/UserScript==

(function() {
let css = "";
if ((location.hostname === "www.instagram.com" || location.hostname.endsWith(".www.instagram.com"))) {
  css += `
      /*global*/
      /*
      CLASS REFERENCE:
      
      .xfex06f>.xeuugli.x1nhvcw1:first-child = FOLLOW PARENT || margin-left:8px
      .xvbhtw8[style] = NAVBAR BODY || background-color: rgb(var(--ig-primary-background));
      .x1o5bo1o = HEADER TRANSFORM HOVER || transform: scale(105%);
      .x1ueewp2 = HEADER TRANSFORM ACTIVE || transform: scale(95%);
      .x40hh3e = PROFILE POST COUNT || col gap 16;
      .xmn8rco = PROFILE GAP || margin-left:20px;
      .x14iifvp = PROfile GAP 2 (comments) || margin-right:18px;
      .x11hdxyr.x11hdxyr = NAV PADDING || padding-bottom:12px;
      .x9k3k5o.x9k3k5o = NAV PADDING || padding-top:12px;
      .xz9dl7a = NAV PADDING SEARCH OPEN || padding-top:12px;
      .xeusxvb, .x18nykt9, .x14yjl9h, .xww2gxu = PFP RADIUS || border-radius:50%;
      ._acat = FOLLOWING BUTTON BG || background-color: ig-secondary-button-background
      .x1aavi5t = STANDARD BUTTON BG || background-color:ig-secondary-button-background
      .xs83m0k = PROFILE TITLE || flex-shrink: 1
      .x6s0dn4 = PROFILE TITLE || align-items: center
      .x1ys307a = SEARCH BOX || margin-right:16px;
      ._aatp = TOP RIGHT ICON IN PHOTOS, ALONE || {LARGE LIST}
      .xhk4uv = POST (FRESH) MAIN BORDER ||     border-left-color: rgb(var(--ig-elevated-separator));
      .x1xmf6yo = COMMENT (FRESH) TOOLS || margin-top:0;
      ._aaql = DETERMINE SPACING OF DATE ON SMOOTH LOAD POST || {LARGE LIST}
      .x6bx242 = HOME SIDEBAR || width:feedsidebar
      .x4giqqa = modals popup || modal-border-radius bottom left
      .xy80clv = messages emoji || padding left 1
      ._abh0 = live chat body || bgcolor, border-radius, width
      ._aacx = primary text color || text color
      .x14snt5h = scale || transform scale 1.05
      .x1jplu5e = scale || transform scale 0.95
      .xcdnw81 = opacity || opacity 0.5
      */
  ...
  @font-face {
    ...
    font-style: normal; }
      ...
      body, html {
          --nav-narrow-width: auto;
          --nav-medium-width: auto;
          --nav-wide-width: auto;
          --ig-hover-overlay:transparent;
          --ig-primary-background:212, 212, 212;
          --search-modal-top-offset:0;
          --font-family-system: 'proxima-nova','Helvetica Neue',Arial,Helvetica,sans-serif;
          --media-info:400px;
          background-image:url("https://www.instagram.com/static/images/shared/noise-1.png/789f92631216.png");
      ...
      .x14snt5h:hover, .x1jplu5e:active, .xcdnw81:active {
          transform: none;
          opacity: 1;
      }
      .x11hdxyr.x11hdxyr, .x9k3k5o.x9k3k5o {
          padding-top:0;
          padding-bottom:0;
      }
      .xeusxvb, .x18nykt9, .x14yjl9h, .xww2gxu {
          border-radius:4px
      }
      .xeusxvb:after {
          content:none;
      ...
      .xvbhtw8[style] > div:last-child {
          width:100%;
          height:auto
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] {
          height:auto;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child {
          width:100%;;
          height: 43px;
      ...
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div {
          width: 1024px;
          margin: 0 auto;
          display: flex;
          flex-direction:row;
      ...
      /*top right buttons*/
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div > div > div > div:has([href*="https://www.threads.net/"]) {
          display:none 
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div {
          display:flex;
          justify-content:end;
          height:44px;
          padding:0;
      ...
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div > div {
          padding:0;
          height:44px;
          margin:0;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div > div > div > div div ~ div[style^="opacity;"], .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div > div > div > div div ~ div[style^="opacity"] {
          display:none
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div > div a[href] > div {
          padding:0 14px;
          margin:0;
          height:44px;
          align-items:center;
      ...
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div > div:not(:nth-child(2)):not([class]) {
          border-right: 1px solid #06365f;
          border-right-color: rgba(0, 0, 0, 0.1);
          box-shadow: inset 1px 0 0 rgb(255 255 255 / 10%);
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div > div:not(:nth-child(2)):not([class]):hover {
          background: rgba(255, 255, 255, 0.1);
          border-right-color: rgba(0, 0, 0, 0.15);
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div > div:not(:nth-child(2)):not([class]):active, .xnz67gz {
          opacity: 1;
          box-shadow: -1px 0 0 rgb(255 255 255 / 15%), inset 0 0 1px rgb(6 54 95 / 40%), inset 1px 0 1px rgb(6 54 95 / 40%);
          border-left: none;
          background-color: #1c5380;
          background-color: rgba(6, 54, 95, 0.35);
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div:nth-child(2) > div a[href] svg {
      ...
      a[href] svg[aria-label="Messages"], a[href] svg[aria-label="Direct"], svg:has(>[points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334"]) {
          background-position: -2px -176px;
      }
      a[href] svg[aria-label="Explore"], svg:has(>[points="13.941 13.953 7.581 16.424 10.06 10.056 16.42 7.585 13.941 13.953"]) {
          background-position: -162px -140px;
      }
      a[href] svg[aria-label="Home"], svg:has(>[d="M22 23h-6.001a1 1 0 0 1-1-1v-5.455a2.997 2.997 0 1 0-5.993 0V22a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V11.543a1.002 1.002 0 0 1 .31-.724l10-9.543a1.001 1.001 0 0 1 1.38 0l10 9.543a1.002 1.002 0 0 1 .31.724V22a1 1 0 0 1-1 1Z"]) {
          background-position: -1px -140px;
      }
      a[href] svg[aria-label="Reels"] {
      ...
      /*cancer*/
      span[aria-describedby]:has([aria-label="Also from Meta"]) {
          display:none!important
      }
      /*more menu*/
      span[aria-describedby]:has([aria-label="Settings"]),
      span[aria-describedby]:has(stroke[y1="20"][y2="20"]) {
          position:absolute;
          right:0;
          width:min-content;
          top:0
      }
      svg[aria-label="Settings"], [aria-label="More options"],
      svg[aria-label]:has(stroke[y1="20"][y2="20"]) {
          background-image:var(--setting);
          fill:none;
          color:transparent;
      }
      [aria-label="More options"] { /*0 for light, 34 for dark*/
          background-position:-34px -490px;
      }
      .x9k3k5o.x9k3k5o span {
          color:#fff;
          text-shadow:0 1px 0 rgba(3,27,47,.5);
          font-size:14px;
          line-height:normal;
      }
      .x9k3k5o.x9k3k5o:has([aria-label="Settings"]), .xz9dl7a:has([aria-label="Settings"]) {
          margin:0;
          padding-top:9px;
          padding-bottom:9px;
          box-shadow:inset 1px 0 0 rgb(255 255 255 / 10%);
      ...
      .x9k3k5o.x9k3k5o:hover:has([aria-label="Settings"]), .xz9dl7a:hover:has([aria-label="Settings"]) {
          background:rgba(255, 255, 255, 0.1)
      }
      .x9k3k5o.x9k3k5o:active:has([aria-label="Settings"]), .xz9dl7a:active:has([aria-label="Settings"]) {
          background:rgba(6, 54, 95, 0.35)
      }
      /*more menu popup*/
      .xm80bdy[style^="position"] {
          bottom:0;
          transform:none!important;
          right:0;
          left:initial;
      ...
      .xm80bdy[style^="position"] > div > div > div > div > div {
          border-radius:0;
      }
      .xm80bdy[style^="position"] > div > div > div > div > div > div {
          width:200px
      }
      .xm80bdy[style^="position"] > div > div > div > div > div > div > div > div > div {
          padding:0;   
      }
      .xm80bdy[style^="position"] > div > div > div > div > div > div > div > div > div > a, .xm80bdy[style^="position"] > div > div > div > div > div > div > div > div > div > div {
          background:#f5f5f5;
          border-top: 1px solid #f6f6f6;
          border-bottom:1px solid #ddd
      }
      .xm80bdy[style^="position"] .xp7jhwk { /*separators on MORE dropdown*/
          display:none
      }
      /*search*/
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div > div:nth-child(2) {
          order:-1;
          margin-right:64px
      }
      
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div > div:nth-child(2) a[href="#"] > div {
          background: rgba(6, 54, 95, 0.35);
          height: 36px;
          margin-top: 4px;
          width: 260px;
      ...
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div > div > div > div:nth-child(2) a[href="#"] > div {
          padding:0 8px
      }
      
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div > div > div > div:nth-child(2) a[href="#"] > div:before {
          content:"Search";
      ...
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div > div > div > div:nth-child(2) a[href="#"] > div > div:not([class]) > div {
          display:none
      }
      /*search popup.. the last child thing is where it splits from search popup to header*/
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child  > div {
          left:0;
          right:auto;
          margin:0 auto;
          width:100%;
      ...
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child > div  > div {
          margin:auto;
          border-radius:0;
          background:none;
          box-shadow:none;
          ...
          padding:0;
          overflow-y:visible;
          height:auto; /*massively important*/;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child > div > div > div > div {
          pointer-events:visible;
          overflow-y:auto;
          border-radius:0;
          margin-left:auto;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child > div > div > div > div[style] {
          pointer-events:visible;
          overflow-y:visible;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child > div > div > div > div > div {
          opacity:1!important;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child > div > div > div > div:first-child:not([style]) { /*search title text*/
          display:none
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class]  .x1ys307a { /*REAL sbox*/
          margin:0 auto;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class]  .x1ys307a > div > div {
          margin:0
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class]  .x1ys307a input[class] {
      ...
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class]  .x1ys307a input[class]::placeholder {
          color:#fff;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class]  .x1ys307a input[class] ~ div[style="cursor: pointer;"] { /*close*/
          top:22px
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class]  .x1ys307a input[class] ~ div:not([style="cursor: pointer;"]) {
          display:none
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] .x1ys307a ~ hr { /*bar*/
          display:none
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] .x1ys307a ~ div {
          background:#fff;
      ...
      /*suggests*/
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] .x1ys307a ~  div ul {
          margin:0
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] .x1ys307a ~  div ul > a {
          border-top: 1px solid #f6f6f6;
          border-bottom: 1px solid #ddd;
          padding:0
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] .x1ys307a ~  div ul > a > div {
          padding:4px 8px;  
      ...
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] .x1ys307a ~  div ul > a > div:hover {
          background:linear-gradient(#eee,#f5f5f5);
          box-shadow: inset 0 1px 0 rgba(255,255,255,0.9);
          border:1px solid #eee;
      }
      /*non user suggests*/
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] .x1ys307a ~ div [href^="/explore/search/keyword/"] > div { 
          padding:10px 14px
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] .x1ys307a ~ div [href^="/explore/search/keyword/"] > div > div > div > div:first-child {
          display:none
      }
      
      
      i[data-visualcompletion="css-img"][class], [aria-label="Instagram"], [height="29"][width="103"][aria-label] { /*wordmark*/
          background: url(/static/images/shared/shared-assets.png/e77fa4dda1ec.png) no-repeat 0 0;
          color: transparent;
          fill:transparent;
          height:29px;
          width:103px;
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child > div > div > div > div[style] >a[href="/"] { /*link*/
          max-width:120px;
          display:block;
      }
      /***notifications**/
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child[style] > div > div:not([style]) {
          background:#fff
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child[style] > div > div:not([style]) > div > div > div:first-child {
          display:none
      }
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ div:last-child[style] > div > div:not([style]) > div > div > div {
          margin:0;
      }
      /***new notifications**/
      .xvbhtw8[style] > div:last-child div[tabindex] > div[class] > div:first-child ~ [data-visualcompletion="ignore-dynamic"] > div > div > div {
          /*this has the width 425*/
          background:#fff;
          border-radius: 0;
          height:auto;
          float:right;
      ...
      /*HEADER*/
      main[role="main"] > div > div > header[class] {
          ...
          background: #eee linear-gradient(rgba(255,255,255,.8), transparent 200px);
          position: relative;
          box-sizing:border-box;
          min-width:1024px
      }
      main[role="main"] > div > div > header[class] > div:first-child {
          width:100%;
          display:inline-block;
          margin-top:15px
      } /*most profile data*/
      
      main[role="main"] > div > div > header[class] > div:first-child > section {
          display: inline-block;
          vertical-align: top;
          width: 816px
      }
      main[role="main"] > div > div > header[class] > div:first-child > section:first-child {
          padding: 5px 5px 0px 5px;
          box-shadow: 0 0 1px rgb(0 0 0 / 10%), 0 1px 5px rgb(0 0 0 / 15%);
          background: #fff;
          border-radius: 4px;
          height: 127px;
      ...
      main[role="main"] > div > div > header[class] > div:first-child > section:first-child canvas {
          max-width:125px;
          max-height:125px;
          z-index:2;
      }
      
      main[role="main"] > div > div > header[class] > div:first-child > section:first-child [style="height: 150px; width: 150px;"] {
          max-width:110px;
          max-height:110px;
      }
      
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div {
          margin: 0;
          row-gap: 0;
          height: auto;
      } /*most profile data not pfp*/
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div:nth-child(2) {
          
          max-width:550px; /*just to fix overlap with follow count*/
      }
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div h2 {
          color:#111;
          font-size:23px;
      ...
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div [style="--x-width: 34px;"] {
          width: auto!important;
          margin-left:20px;
      } /*stupid buttons*/
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div [style="--x-width: 34px;"] [role="button"] {
          padding: 0;
          display:flex;
          width: auto!important
      }
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child .custom-btn {
          margin-top: 0!important;
      }
      
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:last-child:not(:first-child) {
          position: absolute;
          right: -5px;
          top: 150%;
          background: #dddddd url(http://web.archive.org/web/20140228232303///d36xtkk24g8jdx.cloudfront.net/bluebar/4bcc94f/images/bg/white-gradient-100px.png) repeat-x 50% 50%;
      ...
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:last-child:not(:first-child) > div {
          float: left;
          display: inline;
          min-width: 64px;
          height: 30px;
      ...
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:last-child:not(:first-child) > div:first-child {
          box-shadow: none;
          border: none;
      }
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:last-child:not(:first-child) > div span {
          display: block;
          text-align: center;
          color: #999;
          font-weight: bold;
      ...
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:last-child:not(:first-child) > div span > span {
          color: #333;
          font-size: 16px;
          text-align: center;
      }
      
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:first-child {
          margin:0;
          color: #666;
          font-size: 14px;
          line-height: 20px;
      ...
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:first-child span, main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:first-child div {
          color: inherit;
          font: inherit;
      }
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:first-child a {
          font: inherit;
          color: #3f729b;
          -webkit-tap-highlight-color:rgba(63, 114, 155, 0.3);
      } /*bio*/
      
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:nth-child(2) {
          margin-bottom: 0;
          margin-top:6px;
          float:left;
          display:block;
      ...
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > div:nth-child(2) span {
          font: inherit;
          color: inherit;
      } /*real name*/
      
      main[role="main"] > div > div > header[class] > div:first-child > section:last-child > div > a span {
          color: #666;
      }
      
      
      header[class] > section.x14vqqas {
          position: absolute;
          top: 140px;
          left:30px;
          margin: 0;
      ...
      header[class] > section.x14vqqas > div {
          padding: 0;
      }
      header[class] > section.x14vqqas > div > div > div > div {
          display:block;
      } /*buttons*/
      
      header[class] > section.x14vqqas > div > div > div > div > div:last-child:not(:first-child) {
          display: none;
      } /*follow suggests*/
      
      
      
      main[role="main"] > div > div > header[class] > section:nth-child(4), main[role="main"] > div > div > header[class] > section:nth-child(4) > div > div {
          margin: 15px -8px -10px -8px;
      }
      main[role="main"] > div > div > header[class] > section:nth-child(4) > div > div li._acaz div.x1m56yxe.x889kno {
          padding: 5px 5px 0px 5px;
          box-shadow: 0 0 1px rgb(0 0 0 / 10%), 0 1px 5px rgb(0 0 0 / 15%);
          background: #fff;
          border-radius: 4px;
      ...
      main[role="main"] > div > div > header[class] > section:nth-child(4) > div > div canvas {
          display: none
      }
      main[role="main"] > div > div > header[class] > section:nth-child(4) > div > div .xqy66fx span {
          color: inherit;
      }
      main[role="main"] > div > div > header[class] > section:nth-child(4) > div > div .xqy66fx {
          padding-top:4px;
          padding-bottom:4px;
          max-width:73px;
          color: #666;
      ...
      main[role="main"] > div > div > header[class] > section:nth-child(5) {
          display: none
      } /*nothing gap*/
      ...
      /*message styling*/
      header[class] > section.x14vqqas > div > div > div > div [role="button"] {
          font-weight:bold;
          line-height:14px;
          color:#111;
          background-color: #f9fafb;
          background-image: linear-gradient(#f9fafb,#eef1f4);
          background-position: 50% 50%;
          text-shadow:0 1px 0 rgba(255,255,255,.2);   
          border: 1px solid #c6daec;
          border-radius:4px;
          box-shadow: 0 1px 1px rgba(0,0,0,.08), inset 1px 0 0 rgba(255,255,255,.05), inset -1px 0 0 rgba(255,255,255,.05), inset 0 1px 0 rgba(255,255,255,.2);
          font-size: 14px;
      ...
      div.xfex06f>.xeuugli.x1nhvcw1:first-child > button[type] {
          border-radius:3px;
          padding: 5px 6px 6px!important; /*forced by acan*/
          background:#6f97b6 linear-gradient(#6f97b6,#3f729b);
      ...
      div.xfex06f>.xeuugli.x1nhvcw1:first-child > button[type]:hover {
          background-color:#eee
      }
      div.xfex06f>.xeuugli.x1nhvcw1:first-child > button[class][type]:not([disabled]):active {
          border-color: #133856;
          background: #3c6d94;
          box-shadow: inset 0 1px 1px rgba(0,0,0,.15), inset 0 0 1px rgba(0,0,0,.15), 0 1px 0 rgba(255,255,255,.8);
          color: rgba(255,255,255,.8);
          text-shadow: 0 1px 0 rgba(0,0,0,.3);
          opacity:1
      }
      div.xfex06f>.xeuugli.x1nhvcw1:first-child > button[type] div, div.xfex06f>.xeuugli.x1nhvcw1:first-child > button[type] svg {
          font:inherit;
          line-height:1;
          padding:0;
          color:inherit;
      ...
      div.xfex06f>.xeuugli.x1nhvcw1:first-child > button[type] svg {
          display: none
      }
      div.xfex06f>.xeuugli.x1nhvcw1:first-child > button[type]:has(div:first-child:not(:last-child)) {
          background-image: -webkit-linear-gradient(top, #47bc60, #39a64e);
          border: 1px solid #329345;
      }
      div.xfex06f>.xeuugli.x1nhvcw1:first-child > button[type]:has(div:first-child:not(:last-child)):not([disabled]):active {
          text-shadow: 0 1px 0 rgb(0 0 0 / 30%);
          background: #369e4a;
          border-color: #256d33;
      }
      /*posts header*/
      main[role="main"] > div > div > header[class] ~ .html-div {
          background: #ececec;
      ...
      main[role="main"] > div > div > header[class] ~ .html-div > div {
          border: 0;
          width: auto;
          flex: 0;
          gap: 0;
      ...
      main[role="main"] > div > div > header[class] ~ .html-div > div > div {
          width: auto;
          flex-shrink: initial!important;
          flex-grow: initial!important;
          height: 100%;
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a {
          margin:0;
          border: 0;
      ...
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a:hover {
          background-color:#ddd
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a:first-child {
          border-left: 1px solid #ccc;
      }
      /*main[role="main"] > div > div > header[class] ~ .html-div > div > div > a > div {
          flex-direction:column
      }*/
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[href]:after {
          content:"Posts"
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[href$="/reels/"]:after {
          content:"Reels"
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[href$="/tagged/"]:after {
          content:"Tagged"
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div a {
          color:#ababab;
          text-transform:capitalize;
          letter-spacing:0;
          margin:0;
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div a:hover:after {
          color:#666;
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div a[aria-selected="true"]:after {
          color:#2373b4
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div a[aria-selected="true"]:hover:after {
          color:#085ea5
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div a svg {
          background:var(--posthead);
          width:35px;
          height:44px;
          fill:none;
          color:transparent;
      ...
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a:hover svg {
          background-position-x:-60px
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[aria-selected="true"] svg {
          background-position-x:-114px
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[aria-selected="true"]:hover svg {
          background-position-x: -167px;
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[href*="tagged"] svg {
          background-position-y:-303px
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[href*="reels"] svg {
          background-position-y:-225px
      }
      main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[href*="guides"] svg, main[role="main"] > div > div > header[class] ~ .html-div > div > div > a[href*="saved"] svg {
      ...
      main[role="main"] > div > div > header[class] ~ .html-div ~ div > article, main[role="main"] > div > div > header[class] ~ .html-div ~ div > div[style="width: 100%;"] {
          box-shadow: 0 1px 1px rgba(0,0,0,.24), 0 1px 5px rgba(0,0,0,.05);
          padding:10px 10px 0 10px;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] img {
          filter:brightness(0.9)
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div:hover img {
          filter:brightness(1)
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div {
          margin:0;
          padding:7px 0 23px 0;
          height:204px;
          height:225px; /*big picture mode*/
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div:after {
          display: block;
          height: 1px;
          position: absolute;
          bottom: -1px;
      ...
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div {
          position: relative;
          margin: 0 20px 10px;
          box-shadow: 0 1px 0 rgba(255,255,255,0.4), 0 1px 0 1px rgba(255,255,255,0.1);
          margin: 0 10px 10px; /*big picture mode*/
          
      }
      
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a {
          position: absolute;
          top: 25px;
          left: 12px;
          bottom: 0px;
          margin: -5px;
          padding: 5px;
          background: rgba(204, 204, 204, 0.8) linear-gradient(rgba(255,255,255,.9), rgba(255,255,255,.8) 500px);
          box-shadow: 0 0 0 1px rgba(0,0,0,.04), 0 1px 5px rgba(0,0,0,0.1);
          transition: all 0.15s ease-out 0.1s;
          width:211px;
          box-sizing:content-box
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a { /*"211" is for reels, 270 is for posts*/
          width:140px;
          width:160px; /*big picture mode*/

      }
      ._aagv {
          padding-bottom:100%!important
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a > div[class]:first-child {
          background:none;

          height: 100%;
          overflow:hidden;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a > div[style^="background-image: url"] { /*reel thumb fix*/
          padding:0!important;
          height:100%;
          width:auto!important;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a:not(:hover) > div[style^="background-image: url"] {
          filter:brightness(.9)
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div:hover a {
          margin: -28px -12px;
          padding: 28px 12px;
          transition-delay: 0s;
      ...
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a [style^="background:"] { /*hide ugly blur*/
          background:none!important;
          height:20px;
          bottom:4px;
          top:auto;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a:not(:hover) [style^="background:"] {
          display:none;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] a [style^="background:"] li { /*south text*/
          font-size:13px;
          color:#999;
      ...
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] a [style^="background:"] li span {
          font:inherit;
          line-height:inherit!important;
          color:inherit;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] a [style^="background:"] li > span:last-child {
          background: url(data:image/png;base64,) no-repeat 3px -96px;
          margin:0 2px 0 0
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] a [style^="background:"] li:last-child > span:last-child {
          background-position: 3px 4px;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] a [style^="background:"] li:first-child {
          margin-right:6px
      }
          /*top text*/
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a:not(:hover) ._aatp {
          display:none
      }
      main[role="main"] > div > .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a ._aatp > div {
          margin:0 auto
      }
      main[role="main"] > div > .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a ._aatp > div svg {
          display:none
      }
      main[role="main"] > div > .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a ._aatp > div:has(svg[aria-label]):before {
          content:"";
          font-size: 12px;
          font-weight: 700;
          color: #777;
      ...
      main[role="main"] > div > .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a ._aatp > div:has(svg[aria-label="Carousel"]):before {
          content:"Multi Post"
      }
      main[role="main"] > div > .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a ._aatp > div:has(svg[aria-label="Pinned post icon"]):before {
          content:"Pinned"
      }
      main[role="main"] > div > .html-div ~ div div[style^="display: flex; flex-direction"] > div > div > a ._aatp > div:has(svg[aria-label="Clip"]):before {
          content:"Video"
      }
          /*reel view*/
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a:hover > div[style^="background-image: url"] ~ div > div:last-child {
          display:block
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a:hover > div[style^="background-image: url"] ~ div > div:last-child > div {
          top:0;
          bottom:auto;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a:hover > div[style^="background-image: url"] ~ div > div:last-child > div > div {
          justify-content:center;
          display:flex;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a:hover > div[style^="background-image: url"] ~ div > div:last-child > div > div > div {
         margin:0;
      }
      main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a:hover > div[style^="background-image: url"] ~ div > div:last-child > div > div > div svg, main[role="main"] > div > div > header[class] ~ .html-div ~ div div[style^="display: flex; flex-direction"] > div > div a:hover > div[style^="background-image: url"] ~ div > div:last-child > div > div > div span {
          color: #777;
          fill:#777;
          text-shadow: 0 1px 0 rgba(255,255,255,.8);
          font-size:12px;
      ...
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] {
          height:700px;
          max-height:700px!important;
          background:#c9c9c9
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:first-child {
          background:linear-gradient(#4d5055,#2f3437);
          border:1px solid #000;
          border-bottom:0
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:first-child h1 { /*FOLLOWERS */
          color:#eee; 
          font-weight:bold;
          text-transform:uppercase;
          font-size:18px;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:first-child > div {
          height:39px;
          border-bottom:0;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:first-child > div > div:last-child { /*X close*/
          border-left:1px solid #000;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:first-child > div > div:last-child svg, .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:first-child > div > div div {
          color:#fff
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(2), .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-child(2) {
          background:linear-gradient(#212727,#292a2c);
          border:1px solid #000;
          border-radius:0;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-child(2):nth-last-child(3) {
          border-bottom:0;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-child(2) [style="cursor: pointer;"] {
          border-bottom:3px solid transparent;
          opacity:1;
          color:#eee
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-child(2) [style="cursor: pointer;"] span {
          color:inherit;
          font-weight:bold;
          text-transform:uppercase;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-child(2) [style="cursor: pointer;"]._acby {
          border-color:#6BA372;
          color:#6BA372
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(2) div {
          border-radius:0;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(2) input ~ div, .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-child(2) input {
          background:#4d5055;
          border-radius:0;
          color:#fff;
          fill:#fff;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(1) > div[style="height: auto; overflow: hidden auto;"] {
          background:#fff;
          margin:10px 8px;
          border-radius:4px;
          box-shadow:0 0 5px rgba(0,0,0,.1)
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(1) > div[style="height: auto; overflow: hidden auto;"] > div > div {
          border-bottom:1px solid #d8d8d8;
          border-top:1px solid #ebebeb
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(1) ._asw_  {
          border-radius:3px;
          padding: 5px 6px 6px!important; /*forced by acan*/
          background:#6f97b6 linear-gradient(#6f97b6,#3f729b);
          border:1px solid #1c5380;
      ...
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(1) ._asw_:active {
          border-color: #133856;
          background: #3c6d94;
          box-shadow: inset 0 1px 1px rgba(0,0,0,.15), inset 0 0 1px rgba(0,0,0,.15), 0 1px 0 rgba(255,255,255,.8);
          color: rgba(255,255,255,.8);
      ...
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(1) ._aswv {
          background-image: -webkit-linear-gradient(top, #47bc60, #39a64e);
          border: 1px solid #329345;
          color:#fff;
          border-radius:4px;
      }
      .x4giqqa [style="--x-maxHeight: 400px; --x-minHeight: 200px;"] > div:nth-last-child(1) ._aswv:active {
          text-shadow: 0 1px 0 rgb(0 0 0 / 30%);
          background: #369e4a;
          border-color: #256d33;
          opacity:1
      ...
      /**************************POST (FRESH)*/
      main[role="main"] > div > div[style*='max-width'] {
      ...
      main > div > div > .xhk4uv > div:first-child {
          border:0;
          background:#eee;
          min-height:612px;
      }
      main > div > div > .xhk4uv > div:last-child {
          border-left:1px solid rgba(0,0,0,.2);
      }
      main > div > div > .xhk4uv > div:last-child > div {
          background:#f8f8f8;
          border-radius:0 3px 3px 0
      }
      /*heading*/
      main > div > div > .xhk4uv > div:last-child > div > div:first-child { 
          background:#fefefe;
          border-bottom:1px solid #ddd;
          box-shadow:0 1px 1px rgba(0,0,0,.06);
          border-radius:0 3px 0 0;
          order:-2;
          padding:12px 8px 36px 24px /*normally 12*/;
      }
      .xhk4uv > div:last-child > div > div:first-child:has(img) {
          padding-left:12px;
      }
      .xhk4uv > div:last-child > div > div:first-child > div:first-child > div:first-child *:has(img) {
      ...
      .xhk4uv > div:last-child > div > div:first-child > div:first-child > div:first-child span ~ div {
          display:none
      }
      .xhk4uv > div:last-child > div > div:first-child > div {
          align-items:start;
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div {
          margin:0;
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div:last-child { /*more menu*/
          display:none
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div {
          justify-content:space-between;
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div > div:not([class]) span {
          color:#3f729b;
          -webkit-tap-highlight-color: rgba(63,114,155,.3);
          font-size: 18px;
          font-weight: 700;
          white-space:nowrap;
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div > div:not([class]) span > div:nth-last-of-type(2) span { /*multi user posts*/
          max-width:95px;
          overflow:hidden;
          text-overflow:ellipsis;
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div > div:not([class]) a:hover span {
          text-decoration:underline;
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div > div[class] > span { /*dot*/
          display:none
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div > div[class] > div { /*follo*/
          padding: 4px 6px 5px;
          border: 1px solid #1c5380;
          background-image: linear-gradient(#6f97b6,#3f729b);
          background-position: 50% 50%;
          text-shadow: 0 1px 1px #1c5380;
      ...
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div > div[class] > div:active {
          box-shadow: inset 0 1px 1px rgba(0,0,0,.15), inset 0 0 1px rgba(0,0,0,.15), 0 1px 0 rgba(255,255,255,.8);
          background:#3c6d94;
          border-color:#133856
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div ~ div { /*location*/
          margin-top:22px;
          margin-bottom:-22px
      }
      .xhk4uv > div:last-child > div > div:first-child > div > div > div > div ~ div span a {
          font-size:14px;
          color:#222;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr { /*line*/
          display:none
      }
      /*like counts box*/
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div { 
          order:-1;
          padding:0;
          border-top:0;
          border-bottom:1px solid #ddd;
      ...
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:last-child { /*time*/
          position:absolute;
          top:38px;
          left:24px; 
          margin:0;
      }
      .xhk4uv:has(> div:last-child > div > div:first-child img) > div:last-child > div > div:first-child ~ hr+div+div > div:last-child {
          left:64px
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:last-child div, .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:last-child div time {
          text-transform:none;
          color: #81868a;
          font-weight: 600;
          font-size:14px;
      ...
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:last-child time, .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:last-child time {
          letter-spacing:0;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > section { /*like count*/
          margin:0;
          padding:11px 12px 12px 36px;
          background:var(--hearts) no-repeat -92px 13px;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > section span {
          color:#aaa;
          text-shadow:0 1px 0 rgba(255,255,255,.8);
          font-size:14px;
          line-height:16px;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child { /*like buttons*/
          position:absolute;
          bottom:8px;
          left:8px;
          display:inline-block;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div:first-child > :not(span[class]) { /*reply,share*/
          display:none
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div:first-child > span {
          margin:0;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div > span > div, .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div:last-child > div > div > div > div:first-child {
          padding:5px;
      ...
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div > span > div:active, .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div:last-child > div > div > div > div:first-child:active {
          border-color: #c6c6c6;
          background: #e9e9e9;
          box-shadow: inset 0 1px 1px rgba(0,0,0,.08), inset 0 0 1px rgba(0,0,0,.08), 0 1px 0 rgba(255,255,255,.9);
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div:last-child {
          position:absolute;
          left:339px;
          top:0;
          z-index:2
      }
      .xhk4uv:has(textarea ~ div) > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div:last-child > div > div > div > div:first-child { /*emoji button hidden*/
          z-index:-1;
          visibility:hidden;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div > span > div svg {
          background:var(--hearts) -6px -4px;
          fill:transparent
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div+div > div:first-child > div > span > div svg[color="rgb(255, 48, 64)"] {
          background-position-x:-54px
      }
      /*comments*/
      
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div > div > div > div > div {
          padding:0;
          margin-bottom:8px
      }
      a[style="height: 32px; width: 32px;"] {
          box-shadow:inset 0 0 0 1px rgba(0,0,0,.3)
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div a[style="height: 32px; width: 32px;"] {
          margin-top:4px
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div div:not([class]) div:nth-child(2) a[href] span { /*name*/
          color:#3f729b;
          font-size:14px;
          line-height:20px;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div div:not([class]) div:nth-child(2) a[href]:hover span {
          text-decoration:underline;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div div:not([class]) div:nth-child(2) div:nth-child(1) div div div:nth-child(2) span { /*body text*/
          color:#222;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div .x1xmf6yo {
          margin-top:4px;
      }
      .xhk4uv > div:last-child > div > div:first-child ~ hr+div > div > div > div[class] span { /*view replies*/
          color:#3f729b
      }
      /*comment bx*/
      .xhk4uv > div:last-child > div > div:last-child {
          background:#fefefe;
          box-shadow:0 -1px 1px rgba(0,0,0,.06);
          border-radius: 0 0 3px 0;
          margin:0;
      }
      .xhk4uv > div:last-child > div > div:last-child > section {
          position:static;
      }
      .xhk4uv > div:last-child > div > div:last-child > section > div {
          border-radius:0;
          background:none;
          padding:0;
      }
      .xhk4uv > div:last-child > div > div:last-child > section > div > span { /*icon*/
          display:none
      }
      .xhk4uv > div:last-child > div > div:last-child > section form {
          border-radius:0;
          background:none;
          padding:0;
          margin-left:60px
      }
      .xhk4uv > div:last-child > div > div:last-child > section form textarea {
      ...
      .xhk4uv > div:last-child > div > div:last-child > section form textarea::-webkit-scrollbar {
          width:0;
      }
      .xhk4uv > div:last-child > div > div:last-child > section form textarea ~ div[class] {
          margin-right:0
      }
      .xhk4uv > div:last-child > div > div:last-child > section form > div > div {
          border: 1px solid #d6d6d6;
          background-image: -webkit-linear-gradient(top,#fafafa,#eee);
          text-shadow: 0 1px 0 rgba(255,255,255,.6);
          box-shadow: 0 1px 1px rgba(0,0,0,.08), inset 1px 0 0 rgba(255,255,255,.05), inset -1px 0 0 rgba(255,255,255,.05), inset 0 1px 0 rgba(255,255,255,.2);
      ...
      .xhk4uv > div:last-child > div > div:last-child > section form > div > div:active {
          background:#e9e9e9;
          border-color:#c6c6c6;
          box-shadow:inset 0 1px 1px rgba(0,0,0,.08), inset 0 0 1px rgba(0,0,0,.08), 0 1px 0 rgba(255,255,255,.9);
      }
      .xhk4uv > div:last-child > div > div:last-child > section form > div > div > div {
          width:100%;
          height:100%;
          display:block;
          line-height:24px;
      ...
      article._aatg > div > div:first-child {
          border:0;
          /*background:#eee;*/ /*kinda ugly*/
      }
      article._aatg > div > div:last-child {
          max-width:400px;
          min-width:400px;
      }
      article._aatg > div > div:last-child canvas {
          display:none;
      }
      article._aatg > div > div:last-child > div > div > div[class] {
          border-left:1px solid rgba(0,0,0,.2);
      }
      article._aatg > div > div:last-child > div > div {
          background:#f8f8f8;
      }
      /*heading 2*/
      article._aatg > div > div:last-child > div > div > div[class]:first-child {
          background:#fefefe;
          border-bottom:1px solid #ddd;
          box-shadow:0 1px 1px rgba(0,0,0,.06);
          border-radius:0 3px 0 0;
      ...
      article._aatg > div > div:last-child > div > div > div[class]:first-child > div {
          align-items:start;
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header {
          padding:0;
          align-items:start;
          max-width:none;
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header [style="height: 32px; width: 32px;"] {
          height:40px!important;
          width:40px!important;
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] { /*names*/
          margin-left:12px;
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] > div > div > div {
          margin:0;
          padding:0;
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] > div > div > div span a {
          color:#3f729b;
          -webkit-tap-highlight-color: rgba(63,114,155,.3);
          font-size: 18px;
          font-weight: 700;
      ...
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] > div:first-child {
          justify-content:space-between;
          width:100%;
          align-items:start;
          min-height:29px;
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] > div:first-child > div:not(:first-child) > div { /*follo button*/
          display:none
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] > div:first-child > div > button {
      ...
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] > div:first-child > div > button:active, article._aatg > div > div:last-child > div > div > div[class]:first-child header ~ div > div > div:active {
          box-shadow: inset 0 1px 1px rgba(0,0,0,.15), inset 0 0 1px rgba(0,0,0,.15), 0 1px 0 rgba(255,255,255,.8);
          background:#3c6d94;
          border-color:#133856
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header ~ div {
          padding:0;
          height:100%;
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header ~ div > div > div { /*down arrow follow*/
          border: 1px solid #1c5380;
          background-image: linear-gradient(#6f97b6,#3f729b);
          background-position: 50% 50%;
          text-shadow: 0 1px 1px #1c5380;
      ...
      article._aatg > div > div:last-child > div > div > div[class]:first-child header ~ div > div > div:active {
          background:#3c6d94;
          border-color:#133856
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header:has(>div>div>div+div) ~ div > div > div { /*down arrow alone*/
          border-radius:0 4px 4px 0;
          padding-left:1px;
      }
      /*date*/
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(4) {
          position:absolute;
          top:-36px;
          left:64px;
          padding:0;
      ...
      article._aatg > div > div:last-child > div > div:has(._aaql a) > div[class] > div:nth-child(4) {
          top:-52px
      }
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(4) > div > div, article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(4) > div > div time {
          text-transform:none;
          color: #81868a;
          font-weight: 600;
          font-size:14px;
      ...
      /*location 2*/
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] > div:last-child {
          padding:0;
          position:static;
          margin-top:17px
      }
      article._aatg > div > div:last-child > div > div > div[class]:first-child header > div[class] > div:last-child span {
          font-size:12px;
          color:#222;
          font-family:inherit;
      }
      /*like count box 2*/
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(2) {
          order:-1;
          padding:0;
          border-top:0;
          border-bottom:1px solid #ddd;
      ...
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(2) > div {
          margin:0;
          padding:11px 12px 12px 36px;
          background:var(--hearts) no-repeat -92px 13px;
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(2) > div > div:first-child [aria-disabled], article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(2) > div > div:first-child [aria-disabled] > span { /*liked by icon*/
          width:16px!important;
          height:16px!important;
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(2) span {
          color:#aaa;
          text-shadow:0 1px 0 rgba(255,255,255,.8);
          font-size:14px;
          line-height:16px;
      ...
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(2) span > span > div { /*very specific*/
          display:inline;
      }
      /*comment*/
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(3) a {
          color:#3f729b;
          opacity:1!important;
      }
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(3) a:hover {
          text-decoration:underline;
      }
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(3) ul {
          margin-bottom:8px;
      }
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(3) ul li {
          margin:0;
          padding:0;
      }
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(3) ul > li > ul {
          margin-top:2px;
          margin-bottom:10px;
      }
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(3) h3 {
          align-items:start;
      }
      .x14iifvp:not([aria-disabled]) {
          top:4px;
          margin-right:8px;
          outline:1px solid rgba(223, 183, 183, .75)
      }
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(3) ul [aria-disabled] {
          top:4px;
          margin-right:8px;
      }
      
      article._aatg > div > div:last-child > div > div > div[class] > div:nth-child(3) ul [aria-disabled] a {
          box-shadow:inset 0 0 0 1px rgba(0,0,0,.3);
          border-radius:2px;
      }
      /*comment box*/
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) {
          margin:0;
          padding:0;
          position:absolute;
          bottom:8px;
      ...
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:nth-child(2),article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) >span:nth-child(3):not(:last-child) { /*reply, share 2*/
          display:none;
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:first-child {
          margin:0;
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:last-child > div > div > div:first-child {
          padding:0;
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:last-child {
          margin:0;
          left:338px;
          position:absolute;
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:first-child > div, article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:last-child > div > div > div:first-child > div:first-child {
          padding:5px;
          border: 1px solid #d6d6d6;
          background-image: -webkit-linear-gradient(top,#fafafa,#eee);
          text-shadow: 0 1px 0 rgba(255,255,255,.6);
      ...
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:first-child > div:active, article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:last-child > div > div > div:first-child > div:first-child:active {
          background:#e9e9e9;
          border-color:#c6c6c6;
          box-shadow:inset 0 1px 1px rgba(0,0,0,.08), inset 0 0 1px rgba(0,0,0,.08), 0 1px 0 rgba(255,255,255,.9);
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:first-child > div svg {
          background:var(--hearts) -6px -4px;
          fill:transparent
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:first-child > div svg[color="rgb(255, 48, 64)"] {
          background-position-x:-54px
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:first-child > div > div {
          padding:0;
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:last-child > div > div > div:first-child > div:first-child ~ a { /*this is for a download extension*/
          position:absolute;
          bottom:40px;
          right:0
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:nth-child(1) > span:last-child > div > div > div:first-child > div:first-child ~ a+a {
          right:30px
      }
      
      /*comment bx 2*/
      article._aatg > div > div:last-child > div > div > div[class] > section:last-child {
          /*background: #fefefe;*/
          box-shadow: 0 -1px 1px rgba(0,0,0,.06);
          border-radius: 0 0 3px 0;
          margin: 0;
      ...
      article._aatg > div > div:last-child > div > div > div[class] > section:last-child form > div > div:first-child { /*emo*/
          order:2;
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:last-child form > div > div {
          padding:5px;
          border: 1px solid #d6d6d6;
          background-image: -webkit-linear-gradient(top,#fafafa,#eee);
          text-shadow: 0 1px 0 rgba(255,255,255,.6);
      ...
      article._aatg > div > div:last-child > div > div > div[class] > section:last-child form textarea { /*bx butts*/
          box-shadow: inset 0 1px 1px rgba(0,0,0,.05);
          border: 1px solid #ccc;
          border-radius: 3px;
          padding: 10px 9px 9px;
      ...
      article._aatg > div > div:last-child > div > div > div[class] > section:last-child form:has(:not([aria-disabled="true"])) > div > div  {/*moves up emoji*/
          z-index:3
      }
      article._aatg > div > div:last-child > div > div > div[class] > section:last-child form:has([aria-disabled="true"]) > div > div { 
          z-index:-1
      }
      
      article._aatg > div > div:last-child > div > div > div[class] > section:last-child form div:has(>[aria-disabled="true"]) { /*hide post button*/
          width:0;
          padding:0;
          user-select:none;
          opacity:0!important;
      ...
      /**************************HOME*/
      section main:has(.xmnaoh6) {
          max-width:1024px;
          margin:0 auto;
          margin-top:50px
      }
      main > div > :is(:is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]),[style="max-width: 630px; width: 100%;"]) > div > div {
          background: #DEDFE1 url("https://www.instagram.com/static/images/shared/noise-1.png/789f92631216.png");
          padding: 10px 30px;
      ...
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) > div > div:first-child { /*story*/
          border-bottom: 1px solid #d9d9d9;
          background: #eee;
          margin-bottom:0;
      }
      ...
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) > div > div:first-child > div > div > div {
          height: 110px;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) > div > div:first-child > div > div > div > div > div {
          background:none;
          padding:0;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) > div > div:first-child > div > div ul > li button > div:first-child {
          padding: 5px;
          border: 1px solid #C3C3C3;
          background: #FAFAFA;
          box-shadow: 0 1px 1px rgba(0, 0, 0, 24%), 0 1px 5px rgba(0, 0, 0, 5%);
          border-radius: 4px;
          margin:0;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) > div > div:first-child > div > div ul > li button > div:first-child canvas {
          display:none
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) > div > div:first-child > div > div ul > li button:has(._aacx) > div:first-child {
          background:#ffe2e7;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) > div > div:first-child > div > div ul > li button:has(._aacx) > div:last-child div {
          text-shadow:0 1px 0 rgba(255,255,255,.2);
          font-weight:bold;
          padding:0;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) > div > div > div[style^="--x-maxWidth:"] { /*post*/
          width:514px!important;
          padding-bottom:0!important;
      }
  /*     [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(2)) {
          display:none;
      } */
      [style^="--x-maxWidth:"] > div > div {
          padding-bottom:0!important;
      }
      [style^="--x-maxWidth:"] [style="width: 468px;"] {
          width:514px!important
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div {
          padding:0;
          box-shadow:0 0 5px rgba(0,0,0,.1);
          border-radius:4px;
          border:0;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child { /*name*/
          position:absolute;
          left:-235px;
          padding:0;
          width:180px
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:first-child { /*ico*/
          order:2;
          margin:0
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:first-child canvas {
          display:none
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:first-child [style="height: 32px; width: 32px;"] {
          width:40px!important;
          height:40px!important;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:first-child a {
          width:40px!important;
          height:40px!important
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:nth-child(2) > div > div {
          flex-direction:column;
          align-items:end;
          margin-right:8px;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:nth-child(2) > div > div > div:first-child a span { /*name*/
          color:#222;
          text-shadow:0 1px 0 rgba(255,255,255,.2);   
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:nth-child(2) > div > div > div:nth-child(2) {
          margin-right:12px;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:nth-child(2) > div > div > div > span {
          visibility:hidden;
          width:0;
          margin:0;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:nth-child(2) > div > div > div:last-child time:after {
          content:" ("attr(title)")"
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:nth-child(2) > div > div > div:last-child time {
          text-shadow:0 1px 0 rgba(255,255,255,.2);   
          font-weight:bold;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:nth-child(3) { /*moreeoption*/
          position:absolute;
          top:15px;
          right:38px;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:first-child > div > div:nth-child(3) svg {
          background-position-x:6px
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(2) {
          border-radius:4px 4px 0 0;
          border:0;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(2) img {
          box-shadow:inset 0 0 31px rgba(0,0,0,1)
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) {
          background:#fafafa;
      ...
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > section:first-child { /*buttrow*/
          border-bottom:1px solid #ddd;
          margin:0;
          background:#fff linear-gradient(rgba(200,200,200,.1),rgba(200,200,200,.2))
      }
      
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > section:first-child > div:first-child > span {
          margin:0;
      }
      ...
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > section:first-child > div:first-child > span > div svg[color="rgb(255, 48, 64)"], html body svg:has([d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"]) {
          background-position-x:-57.5px!important
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > section:nth-child(2) /*liked*/ {
          position:absolute;
          top:0;
          left:100px;
      }
      ...
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > section:nth-child(2) > div > div { /*liked by*/
          height:40px;
          justify-content:center;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > section:nth-child(2) > div > div >span {
          color:#666
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > section:nth-child(2) > div > div a span {
          color:#3F729B;
      }
      
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:not(:first-child) {
          padding-left:12px;
          padding-right:12px;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:not(:first-child) a[href], [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:not(:first-child) a[href] span {
          color:#3F729B
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:nth-last-child(2) { /*view all comments*/
          border-bottom:1px solid #e6d6e6;
          padding-bottom:6px;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:nth-last-child(2):empty {
          display:none
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:last-child { /*textbox*/
          padding:12px;
          margin:0;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:last-child form {
          border:1px solid #d8d8d8;
          background:#fbfbfb;
          border-radius:2px;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:last-child form textarea {
          background:none;
          padding:6px 9px;
      }
      [style^="--x-maxWidth:"] > div:is(:nth-child(1),:nth-child(3)) > div[style] > article > div > div:nth-child(3) > div > div > div:last-child form textarea::placeholder {
          color:#949595
      }
      /*all caught up*/
      [style^="--x-maxWidth:"] > div > div > article ~ div:first-of-type {
          width:574px;
          margin-left:-30px;
          background:#eee linear-gradient(rgba(200,200,200,.1),rgba(200,200,200,.2));
      }
      [style^="--x-maxWidth:"] > div > div > article ~ div:first-of-type > div > div:first-child {
          /*display:none*/
      }
      [style^="--x-maxWidth:"] > div > div > article ~ div:first-of-type > div a {
          width:100%;
          text-align:center;
          padding-top:20px
      }
      [style^="--x-maxWidth:"] > div > div > article ~ div+div ~ article:not(:hover) {
          filter:grayscale(1)
      }
      /**home sidebar**/
      .x6bx242 {
          padding:0;
          --feed-sidebar-width:260px;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div {
          background:#dadada url("https://www.instagram.com/static/images/shared/noise-1.png/789f92631216.png");
          box-shadow:0 0 2px rgba(0,0,0,.3);
          margin-top:16px;
          flex:1;
          display:flex;
      ...
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div {
          margin-top:0px;
          width:260px;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div {
          padding:8px 12px;
          margin:0;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div {
          margin:0;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div > div {
          background:none;
          width:100%;
          margin:0;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div > div > div {
          margin:0;
          padding:0;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div > div > div > div > div > div > div { /*self ppf*/
          margin-right:0
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div > div > div > div > div > div > div > div {
          padding-left:0;
          padding-right:0;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div > div > div > div > div > div > div > div > div > div > div > div { /*other pfp*/
          margin-right:0px;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div > div > div > div > div > div > div > div > div > div > div:nth-child(2) > div {
          margin-left:5px;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div > div > div > div > div > div > div > div > div > div > div > div span {
          text-shadow:0 1px 0 rgba(255,255,255,.2);
          color:#222;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div > div > div > div > div > div > div > div > div > div > div > div > div > div > div span > span {
          color:rgb(115, 115, 115);
          text-shadow:0 1px 0 rgba(255,255,255,.2);
          font-size:12px;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div button[class], main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div button[class]:hover { /*follow sidebar buttons*/
          padding: 4px 6px 5px!important;
          border: 1px solid #1c5380;
          background-image: linear-gradient(#6f97b6,#3f729b);
          background-position: 50% 50%;
      ...
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div button:active {
          background:#3c6d94;
          border-color:#133856
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div button span {
          color:inherit;
      }
      main > div > :is([style="max-width:630px;width:100%"],[style="max-width: 630px; width: 100%;"]) ~ div [href="/explore/people/"] > span {
          padding-right:3px;
          color:#3f729b
      }
      /**************************FOOTER*/
      ...
      footer > div[class] > div > div > div {
          margin:0;
          padding:8px 6px;
      }
      footer > div[class] > div > div > div a span {
          color:rgba(63,114,155);
          font-weight:700;
      }
      /**************************LIVE*/
      div._abh0 {
      ...
      div._abh0 > header ~ section > div > div > div > div {
          margin:0;
      }
...
if (location.href.startsWith("https://www.instagram.com/direct") || location.href.startsWith("https://www.instagram.com/p/")) {
  css += `
      /**************************direct messages dms*/
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div {
          background:none;
      }
      .xs83m0k.x6s0dn4 .xjbqb8w {
          position:relative;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div > div > div[aria-label] {
          background:none;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div[style="--x-height: 100vh; --x-width: 100%;"] {
      ...
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div {
          padding-right: 0;
          border-left: 1px solid #c3cfd9;
          border-right: 1px solid #c3cfd9;
          box-shadow: 0 1px 0px rgba(0, 0, 0, 0.05);
          background:#f7f7f7 url("https://www.instagram.com/static/images/bg/blue-noisy.jpg/2dcca060b7f9.jpg") repeat 50% 50%;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div {
          background: none;
      }
      /*messages header*/
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div[aria-label] > div > div:first-child {
          background: none;
          padding: 0;
          min-height: 60px;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div[aria-label] > div > div:first-child > div > div:first-child { 
      ...
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div[aria-label] > div > div:first-child > div > div:first-child [role="button"] {
          position:absolute;
          right:0;
          top:10px;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div > div:first-child :is(span,svg) {
          color:#eee;
          fill:#eee;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div > div:nth-child(2) {
          background: #212727;
      }
      [data-pagelet="IGDThreadList"] > div:first-child, [data-pagelet="IGDThreadList"] > div:nth-child(2) {
          padding:0;
          background:linear-gradient(#212727,#292a2c);
          min-width:388px;
          margin: 0;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div[aria-label] > div > div:nth-child(3), div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div[aria-label] > div > div:nth-child(3) label { 
          /*search bar apparently*/
          background:#222;
          border-radius:0;
          
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div[aria-label] > div > div:nth-child(3) div {
          padding: 0;
          border: 0;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div[aria-label] > div > div:nth-child(3) input {
          background: none;
          color:#fff;
          box-shadow: none;
          border-radius: 0;
      }
      /*data-pagelet="IGDThreadList"] > div:nth-child(2) a, [data-pagelet="IGDThreadList"] > div:nth-child(2) div {
          text-transform:uppercase;
          color:#eee;
          font-size:16px;
      ...
      [data-pagelet="IGDThreadList"] > div:nth-child(2) a>span, [data-pagelet="IGDThreadList"] > div:nth-child(2) div>h1 {
          color: inherit;
          line-height:30px;
          font-size: inherit;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div:nth-child(2) h1 {
          color:#6BA372;
          border-color:#6BA372;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div:nth-child(2) [href="/direct/requests/"] {
          width:50%
      }*/
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div:nth-child(2) [href="/direct/requests/"] span {
          font-size:16px;
          line-height:30px!important;
          vertical-align:middle;
          text-align:center;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div:first-child:has([aria-label="Back"]) {
          padding:0;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div:first-child:has([aria-label="Back"]) > div > div:first-child {
          height:auto;
          min-height:40px;
          padding:0;
          border-bottom:1px solid #000;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] > div > div:first-child:has([aria-label="Back"]) > div > div:first-child > div > div:first-child {
          padding:0 12px;
          border-right:1px solid #000;
          height:40px;
      }
      [data-pagelet="IGDThreadList"] > div:last-child { /*main list*/
          padding-right: 0;
          background-color: #f7f7f7;
          box-shadow: 0 1px 0px rgba(0, 0, 0, 0.05);
          border-top:1px solid #c3cfd9
      }
      [data-pagelet="IGDThreadList"] > div:last-child div[role="button"] {
          color: #3f729b;
          padding: 9px 5px 10px 15px;
          border-bottom: 1px solid #c3cfd9;
          background: linear-gradient(#fefefe,#fbfbfb)
      }
      [data-pagelet="IGDThreadList"] > div:last-child div[role="button"] > div {
          padding:0
      }
      [data-pagelet="IGDThreadList"] > div:last-child div[role="button"] > div > div:first-child > div:first-child > div:first-child {
          max-width:40px;
          max-height: 40px;
      }
      [data-pagelet="IGDThreadList"] > div:last-child div[role="button"][tabindex="0"] {
          background: #f1f2f4;
          border-bottom-color: #c3cfd9;
      }
      [data-pagelet="IGDThreadList"] > div:last-child div[role="button"] span {
          --ig-primary-text:#3f729b;
          font-weight:bold;
      }
      [data-pagelet="IGDThreadList"] [style="height: 56px; width: 56px;"] { /*pfp*/
          height:40px!important;
          width:40px!important;
          margin-right:-12px /*parent is padding right 12*/
      }
      
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div > div div {
          --messenger-card-background:#fff;
          --ig-primary-background:#fff;
          
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div > div > div > div > div > div > div > div {
          height:auto;
          min-height:0;
          background:#fff
      ...
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div > div > div > div > div > div > div > div [style="height: 44px; width: 44px;"] {
          display:none
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div > div > div > div > div > div > div > div > div > div:last-child:not([role]) { /*name*/
         /* align-items:center;*/
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div > div > div > div > div > div > div:first-child > div > div:last-child svg {
          color:#226094;
          fill:#226094 /*top icons*/
      }

      div[class] {
          --mwp-message-list-image-radius:0
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div .xy80clv {
          background: #fefefe;
          box-shadow: 0 -1px 1px rgba(0,0,0,.06);
          border:0;
      ...
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div .xy80clv > div > div:nth-child(2) [contenteditable="true"] {
          box-shadow: inset 0 1px 1px rgba(0,0,0,.05);
          border: 1px solid #ccc;
          border-radius: 3px;
          padding: 10px 9px 9px;
      ...
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div .xy80clv > div > div:nth-child(2) [contenteditable="true"] ~ div {
          padding:10px 9px 9px;
          margin:7px 0;
          cursor:text;
      }
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div div[aria-label="Choose an emoji"], div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div div[aria-label="Choose an emoji"] ~ div > div[role="button"] {
          padding: 5px;
          border: 1px solid #d6d6d6;
          background-image: -webkit-linear-gradient(top,#fafafa,#eee);
          text-shadow: 0 1px 0 rgba(255,255,255,.6);
      ...
      div[style*="--card-background: rgb(var(--ig-primary-background)); --comment-background: rgb(var(--ig-highlight-background));"] > div > div > div:first-child > div > div[aria-label] ~ div div[aria-label="Choose an emoji"] ~ div > div[role="button"] {
          margin-left:8px;
      }
