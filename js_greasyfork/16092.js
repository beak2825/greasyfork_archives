...
// @downloadURL https://update.greasyfork.org/scripts/16092/%E2%84%8D%E2%82%A3.user.js
// @updateURL https://update.greasyfork.org/scripts/16092/%E2%84%8D%E2%82%A3.meta.js
// ==/UserScript==
...
(function() {
    ...
    function letsJQuery($) {
        ...
        $("h2.title").replaceWith('<h2 class="title">ℍ₣</h2>');
        // Leaderboard's name
        $("span.title").replaceWith('<span class="title">ℍ₣</span>');
