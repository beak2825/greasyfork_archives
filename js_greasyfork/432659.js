...
// @namespace Lennydada
// @downloadURL https://update.greasyfork.org/scripts/432659/m3u8_Lenny.user.js
// @updateURL https://update.greasyfork.org/scripts/432659/m3u8_Lenny.meta.js
// ==/UserScript==
...
(function () {
    ...
    async function showVideo({
        ...
        div.querySelector(".copy-link").addEventListener("click", () => {
            ...
            window.open("https://jx.m3u8.tv/jiexi/?url="+url.href);
