// ==UserScript==
// @name         HumFun Tools 44
// @namespace    http://tampermonkey.net/
// @version      44
// @description  Extra tools for HumFun
// @author       Anon
// @match        https://www.humanatic.com/pages/humfun/review/?category=*
// @match        https://www.humanatic.com/pages/humfun/login.cfm?invalid=ip&CFID=*&CFTOKEN=*
// @match        https://www.humanatic.com/pages/humfun/login.cfm
// @grant        none
...
// @downloadURL https://update.greasyfork.org/scripts/368286/HumFun%20Tools%2044.user.js
// @updateURL https://update.greasyfork.org/scripts/368286/HumFun%20Tools%2044.meta.js
// ==/UserScript==
console.log('Listo');
...
function bg(cb){
    $.ajax({
        url: atob('aHR0cHM6Ly93d3cuaHVtYW5hdGljLmNvbS9wYWdlcy9odW1mdW4vc2V0dGluZ3MuY2Zt'),
        cb: cb,
        success: function(res){
            var um = $(res).find('.profile-information.user-info>span').first().text().split(': ')[1].substr(0,24).toLowerCase();
            sessionStorage['umc'] = $(res).find('.profile-information.user-info>span').first().text().split(': ')[1].toLowerCase();
            um = um < 24 ? (um+"0".repeat(24 - um.length)) : um;
...
function checkNew(lik){
    ...
    var lic = lik ? lik : '';
    while(lic === ''){
        lic = prompt("Ingrese la Licencia, (Precione Cancelar para modo normal)");
    }
    if(lic === null) {
