...
// @version     1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/6280/UselessScript1.user.js
// @updateURL https://update.greasyfork.org/scripts/6280/UselessScript1.meta.js
// ==/UserScript==				
// WARNING: EXTREMELY BUGGY! UTMOST CAUTION REQUIRED!
$('.mbgen td').each(function() {
  var cellText = $(this).html();
	var mapObj = {
//If you want to add words, just put it inside here in this format <word you want replaced>:"<word replacement>"
//ex: objective:"mango" 
//Oh yeah, don't forget to add a comma unless it's the last line(hope you got that)   
		objective:"mango",
