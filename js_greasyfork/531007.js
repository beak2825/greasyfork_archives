// ==UserScript==
// @name         Orenburg | Скрипт для Руководства
// @namespace    https://greasyfork.org/ru/users/1032828-crystalby
// @version      0.11
// @description  Скрипт для ГА/ЗГА.
// @author       pootapoff
...
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/531007/Orenburg%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/531007/Orenburg%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            title: 'Приветствие',
            content:
            "[CENTER][FONT=Georgia][COLOR=rgb(255, 0, 255)]Доброго времени суток, уважаемый игрок.[/FONT]<br><br>"+
            "[url=https://i.postimg.cc/P5zSrgJ9/image.png][img]https://i.postimg.cc/P5zSrgJ9/image.png[/img][/url]<br><br>"+
            "[FONT=Georgia] текст [/COLOR][/FONT][/CENTER]",
        },
        {
            title: 'Запросил док-ва',
            content:
            "[CENTER][FONT=Georgia][COLOR=rgb(248, 0, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Запросил доказательства у администратора.<br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 215, 0)]На рассмотрении.[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(248, 0, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Ваша жалоба составлена не по форме, ознакомьтесь с правилами подачи жалоб : [URL='https://forum.blackrussia.online/forums/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1.202/']*Кликабельно*[/URL]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 255, 0)]Отказано[/COLOR],[COLOR=rgb(255, 0, 0)] Закрыто.[/COLOR][/FONT][/CENTER]',
        ...
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(248, 0, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Данный игрок не является администратором.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(248, 0, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "В данной ситуации обязательно должен быть фрапс(видеофиксация) всех моментов, в противном случае жалоба будет отказана.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 255, 0)]Отказано[/COLOR],[COLOR=rgb(255, 0, 0)] Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(248, 0, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Представленные доказательства выше были отредактированы, подобные жалобы рассмотрению не подлежат.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 255, 0)]Отказано[/COLOR],[COLOR=rgb(255, 0, 0)] Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(248, 0, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Недостаточно доказательств для корректного рассмотра жалобы.<br><br>"+
            "Загрузите скриншот с выданным наказанием от Администрации ( с /time ).<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 255, 0)]Отказано[/COLOR],[COLOR=rgb(255, 0, 0)] Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        },
        {
            ...
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(0, 255, 0)Одобрено[/COLOR],[COLOR=rgb(255, 0, 0)] Закрыто.[/COLOR][/FONT][/CENTER]',
        ...
        },
        {
            ...
            "Приносим извинения за предоставленные неудобства.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 215, 0)]Одобрено[/COLOR],[COLOR=rgb(255, 0, 0)] Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 0, 0)]Передано Главному Администратору[/COLOR][/FONT][/CENTER]',
            prefix: GA_PREFIX,
            status: true,
        },
        {
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 0, 0)]Передано Главной Администрации [/COLOR][/FONT][/CENTER]',
            prefix: GA_PREFIX,
            status: true,
        },
        {
            ...
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 0, 0)]Передано Специальному Администратору.[/COLOR][/FONT][/CENTER]',
        ...
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(248, 0, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Вам было выдано наказания Техническим специалистом, вы можете написать жалобу здесь : [URL='https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9657-orenburg.2513/']*Нажмите сюда*[/URL]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 255, 0)]Отказано[/COLOR],[COLOR=rgb(255, 0, 0)] Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        },
        {
            title: 'Не по форме',
            content:
            "[CENTER][FONT=Georgia][COLOR=rgb(0, 255, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
        ...
        },
        {
            ...
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 0, 0)] Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(0, 255, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Администрация не готова снизить вам наказание.<br><br>"+
        ...
        },
        {
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 255, 0)]На рассмотрении[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(0, 255, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Ваше обжалование получает статус «Одобрено». <br><br>"+
            "Наказание будет снято. <br><br>"+
            "Больше не нарушайте <br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(0, 255, 0)]Одобрено[/COLOR],[COLOR=rgb(255, 0, 0)] Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(0, 255, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Ваше обжалование передано Главному Администратору.<br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(0, 255, 0)]С уважением, Основной Заместитель Главного Администратора[/COLOR][/FONT][/CENTER]',
            prefix: GA_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(0, 255, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Если вы не согласны с выданным наказанием, то напишите жалобу в раздел Жалобы на Администрацию.<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 0, 0)] Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
{
            ...
            "[CENTER][FONT=Georgia][COLOR=rgb(0, 255, 0)]Доброго времени суток, уважаемый игрок.[/COLOR]<br><br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            "Ваш аккаунт будет разблокирован на 24 часа, за это время вам необходимо изменить свой nickname. Доказательства прикрепить в данной теме..<br<br>"+
            "[url=https://i.postimg.cc/ZYLvn4c3/20250215-090101.png][img]https://i.postimg.cc/ZYLvn4c3/20250215-090101.png[/img][/url]<br><br>"+
            '[COLOR=rgb(255, 215, 0)]С уважением, Основной Заместитель Главного Администратора[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
        },
    ];
