// ==UserScript==
// @name         Anti-adblocker prensa Española
...
// @downloadURL https://update.greasyfork.org/scripts/440495/Anti-adblocker%20prensa%20Espa%C3%B1ola.user.js
// @updateURL https://update.greasyfork.org/scripts/440495/Anti-adblocker%20prensa%20Espa%C3%B1ola.meta.js
// ==/UserScript==
 
/* jshint esversion: 6 */

// Basado en el script de Alejandro Molero (https://greasyfork.org/es/scripts/412184-anti-adblocker-prensa-espa%C3%B1ola)
...
(function() {
  ...
  const $ = jQuery || window.$;
    ...
    switch(domainName) {
        ...
        case 'larioja.com': removeAddsAbc(); vocentoShowImages(); break;
        case 'laverdad.es': removeAddsAbc(); vocentoShowImages(); break;
        case 'diariosur.es': removeAddsAbc(); vocentoShowImages(); break;
        ...
        case 'elcorreo.com':
        case 'elnortedecastilla.es': vocentoShowImages(); break;
