// ==UserScript==
// @version       1.7.6
// @name          C&C:TA CNCOpt Link Button V2
...
// @downloadURL https://update.greasyfork.org/scripts/13234/CC%3ATA%20CNCOpt%20Link%20Button%20V2.user.js
// @updateURL https://update.greasyfork.org/scripts/13234/CC%3ATA%20CNCOpt%20Link%20Button%20V2.meta.js
// ==/UserScript==
/* 
        ...
        var cncopt = {
          ...
          make_sharelink: function () {
            try {
              ...
              switch (city.IsNPC() ? own_city.get_CityFaction() : city.get_CityFaction()) {
                case 1:
                  /* GDI */
                  link += "G|";
                  break;
              ...
              var offense_unit_list = getOffenseUnits(city.IsNPC() ? own_city : city);
              ...
              for (var i in this) {
                try {
                  if (this[i] && this[i].basename == "Composite") {
                    var link = new qx.ui.form.Button("Freaks Special App", "http://cncopt.com/favicon.ico");
