...
// @version     1.0
// @author      jside
// @description saves passwords to local storage skips future login form by modifing accesses request
// @downloadURL https://update.greasyfork.org/scripts/458429/auto%20login%20-%20taskcardsde.user.js
// @updateURL https://update.greasyfork.org/scripts/458429/auto%20login%20-%20taskcardsde.meta.js
// ==/UserScript==
...
unsafeWindow.fetch = async (...args) => { // replace window.fetch function
  ...
  if (resource.endsWith("/accesses")) {
    ...
    let pass = JSON.parse(config.body).password; // get supplie pass
