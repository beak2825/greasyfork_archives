...
// @grant        GM_cookie
// @downloadURL https://update.greasyfork.org/scripts/541501/Gartic%20Anonimbiri%20Bot%20Panel.user.js
// @updateURL https://update.greasyfork.org/scripts/541501/Gartic%20Anonimbiri%20Bot%20Panel.meta.js
// ==/UserScript==
...
(function() {
    ...
    const log = (msg, error = false) => {
        console.log(`%c[anonimbiri] ${msg}`, `color:${error ? '#1589FF' : '#1589FF'};font-weight:bold;font-family:monospace;background:#1a1a2e;padding:2px 4px;border-radius:3px`);
    };
    ...
    document.documentElement.innerHTML = `
        <style>
            ...
            :root { --c-primary: #1589FF; --c-primary-dark: #1589FF; --c-grad: linear-gradient(45deg, var(--c-primary-dark), var(--c-primary)); --transition-speed: 0.2s; }

            * { margin: 0; padding: 0; box-sizing: border-box; }

            body { font-family: 'Poppins', sans-serif; background: linear-gradient(135deg, #36454F 0%, #36454F 50%, #36454F 100%); color: #36454F; min-height: 100vh; overflow-x: hidden; }
            ...
            * { scrollbar-width: thin; scrollbar-color: var(--c-primary-dark) rgba(255, 255, 255, 0.1); }
            ...
            .kick-btn { background: linear-gradient(45deg, #1589FF, #1589FF); border: none; padding: 8px 12px; border-radius: 8px; color: white; cursor: pointer; font-size: 0.8rem; transition: all var(--transition-speed) ease; }
            ...
            .form-input { width: 100%; padding: 12px 16px; background: rgba(0, 0, 0, 0.4); border: 1px solid rgba(255, 182, 193, 0.3); border-radius: 10px; color: #1589FF; font-size: 1rem; transition: all var(--transition-speed) ease; font-family: 'Poppins', sans-serif; }
            ...
            .number-input { width: 100%; padding: 12px 50px 12px 16px; background: rgba(0, 0, 0, 0.4); border: 1px solid rgba(255, 182, 193, 0.3); border-radius: 10px; color: #1589FF; font-size: 1rem; transition: all var(--transition-speed) ease; font-family: 'Poppins', sans-serif; -moz-appearance: textfield; }
            ...
            .console-line { margin-bottom: 5px; color: #1589FF; word-break: break-all; }
        ...
        <div class="container">
            <div class="mascot-sidebar">
                <img src="https://r.resimlink.com/ZEIwLClk.png" alt="Kawaii Mascot" class="mascot-image">
