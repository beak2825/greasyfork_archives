// ==UserScript==
// @name         TMVN Home HeadToHead (CN beta)
...
// @match        *trophymanager.com/home/
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/426390/TMVN%20Home%20HeadToHead%20%28CN%20beta%29.user.js
// @updateURL https://update.greasyfork.org/scripts/426390/TMVN%20Home%20HeadToHead%20%28CN%20beta%29.meta.js
// ==/UserScript==
...
(function () {
	...
	const MATCH_TYPE = {
		...
		INTER_CUP: '<label style="color:Black;">International 足协杯</label>',
	...
	function checkHeadToHead() {
		...
		if (noMatchFound) {
			headToHead_content += '<tr><td><span style="color:' + APPLICATION_COLOR.TITLE + ';">无记录!</span></td></tr>';
		} else {
