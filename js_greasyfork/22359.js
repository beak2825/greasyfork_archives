...
// @include       *tny.cz/*
// @include       *tinypaste.*/*
// @downloadURL https://update.greasyfork.org/scripts/22359/Ads%20Skipper.user.js
// @updateURL https://update.greasyfork.org/scripts/22359/Ads%20Skipper.meta.js
// ==/UserScript==
...
(function () {
    ...
    var list = {
        ...
        jack: {
            host: ["tr5.in", "adjoin.me", "adblue.us", "1ly.us", "wwy.me", "iiiii.in", "ushorten.me", "short.pk", "tey.me", "fly2url.com", "pea.bz", "bih.cc", "imi.us.tc", "weeurl.co.uk", "shortit.in", "adcrun.ch", "sk.gy", "adjoin.me", "1ly.us", "mo.vc", "4ks.net", "youlinking.com", "qurlt.com", "take-a.com", "filesko.com", "zpoz.net", "pp.nu", "mhz.me", "adsbrite.net", "gr8s.us", "link.tl", "link.tl/fly/go.php?to", "adtwixt.com", "ssl.gs"],
            fn: function () {
                remove('iframe');
                x = /eval.*/;
                ...
                if (v) {
                    var i = "function check(){" + v[0] + " function(rr){var jj = eval('(' + rr + ')');if(jj.message){clearInterval(ii);top.location.href=jj.message.url;}})}var ii = setInterval('check();', 1000)";
                    append('script', i);
                    document.title = "Zaharyas Skip Bot...";
                } else {
