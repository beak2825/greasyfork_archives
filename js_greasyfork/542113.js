// ==UserScript==
// @name         Crosspost from Fiicen
// @namespace    https://lit.link/toracatman
// @version      2025-07-11
// @description  Fiicen から 他の SNS に 半自動的に 同時投稿します。
// @author       トラネコマン
// @match        https://fiicen.jp/*
// @icon         data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/542113/Crosspost%20from%20Fiicen.user.js
// @updateURL https://update.greasyfork.org/scripts/542113/Crosspost%20from%20Fiicen.meta.js
// ==/UserScript==

function getCircleText() {
    return document.querySelector('textarea[name="text"]').value;
}
...
setInterval(() => {
    //ツールバーの取得
    let pollbtn = document.querySelector('button[title="投票"]');
    if (pollbtn == null) return;
    let toolbarlist = pollbtn.parentNode;
    let toolbar = toolbarlist.parentNode;
    ...
    toolbar2.classList.add("flex-wrap");

    //ボタンの取得
    let btn = pollbtn.cloneNode(true);
    ...
    if (btn_substitute) {
        ...
        newBtn.innerHTML = '<span style="font-size: 20px; font-weight: bold; line-height: 1; vertical-align: bottom;">代</span>';
