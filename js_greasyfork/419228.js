// ==UserScript==
// @name         HWM Repair Assistant
// @namespace    https://greasyfork.org/ru/scripts/419228-hwm-repair-assistant
// @version      0.3
// @description  Помощник для ремонта через новый интерфейс
// @author       achepta (created by Небылица)
// @include      /^https{0,1}:\/\/((www|qrator)\.heroeswm\.ru|178\.248\.235\.15)\/(art_transfer|pl_transfers)\.php/
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/419228/HWM%20Repair%20Assistant.user.js
// @updateURL https://update.greasyfork.org/scripts/419228/HWM%20Repair%20Assistant.meta.js
// ==/UserScript==
