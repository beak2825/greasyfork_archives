...
// @version      0.27
// @description  Play audio in KaniWani upon Modification of script so audio is played on right and wrong answers.
// @author       voithos
// @match        *://*.kaniwani.com/*
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/428400/KaniWani%20audio.user.js
// @updateURL https://update.greasyfork.org/scripts/428400/KaniWani%20audio.meta.js
// ==/UserScript==


// Based on original version by CometZero:
// https://greasyfork.org/en/scripts/25373-kaniwani-audio
// It plays audio on wrong answers too
...
function onCorrectAnswerObserver(f){
    ...
    var observer = new MutationObserver(function() {
        ...
        if (target && (window.getComputedStyle(target).backgroundColor === 'rgb(127, 212, 104)' || !(window.getComputedStyle(target).backgroundColor === 'rgb(255, 255, 255)')) ) {
            // Answer was correct!
            f();
        }
    });
