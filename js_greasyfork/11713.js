// ==UserScript==
// @name        HIT Scraper WITH EXPORT Modified
...
// @downloadURL https://update.greasyfork.org/scripts/11713/HIT%20Scraper%20WITH%20EXPORT%20Modified.user.js
// @updateURL https://update.greasyfork.org/scripts/11713/HIT%20Scraper%20WITH%20EXPORT%20Modified.meta.js
// ==/UserScript==
...
var cucolors = { "highlight"   :'#FFDFFF',  "background" :'#DFDFDF',  "accent"      :'#A800A8',   "bodytable" :'#000000',  "cpBackground"  :'#DFDFDF',
                "highTO"       :'#DFFFFF',  "goodTO"     :'#DFFFDF',  "averageTO"   :'#FFEEDD',   "lowTO"     :'#DFAAAA',  "poorTO"        :'#FFAAAA',
                "hitDB"        :'#FFAAFF',  "nohitDB"    :'#AFAFAF',  "unqualified" :'#AFAFAF',   "reqmaster" :'#FFAFFF',  "nomaster"      :'#AFAFAF',
                "defaultText"  :'#A800A8',  "inputText"  :'#000000',  "secondText"  :'#A800A8',   "link"      :'#0000FF',  "vlink"         :'#800080',
                "noTO"         :'#D3D3D3',  "export"     :'#000000',  "hover"       :'#AAAAAA'
               }; // custom default
...
HITStorage.indexedDB.checkTitle = function(title,button) {
    var request = indexedDB.open("HITDB_TESTING", v);
...
css += ".cpInput_thCustom {color: "+ucucolors.inputText+"; border: 1px solid; text-align: center;}\n";
css += ".cpButtons_thCustom {border: 2px outset buttonface;}\n";
...
css += ".toNone_thCustom {background: "+ucucolors.noTO+";}\n";
css += ".toHigh_thCustom {background: "+ucucolors.highTO+";}\n";
css += ".toGood_thCustom {background: "+ucucolors.goodTO+";}\n";
css += ".toAverage_thCustom {background: "+ucucolors.averageTO+";}\n";
css += ".toLow_thCustom {background: "+ucucolors.lowTO+";}\n";
css += ".toPoor_thCustom {background: "+ucucolors.poorTO+";}\n";
...
css += ".toBlockedRow {display:none;} .toBlockedRowOff td {border-left: 2px solid #FF0000;}\n";
