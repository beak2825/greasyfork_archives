// ==UserScript==
// @name    Forum Curators (Mod)  | Kolkov
// @name:ru Кураторы Форума Модификация | Kolkov
// @name:uk Куратори форуму | Kolkov
// @description  Suggestions for improving the script write here ---> https://vk.com/dreamer_0612
// @description:ru Предложения по улучшению скрипта писать сюда ---> https://vk.com/dreamer_0612
// @description:uk Пропозиції щодо покращення скрипту писати сюди ---> https://vk.com/dreamer_0612
// @version 3.4.7
...
// @downloadURL https://update.greasyfork.org/scripts/462978/Forum%20Curators%20%28Mod%29%20%20%7C%20Kolkov.user.js
// @updateURL https://update.greasyfork.org/scripts/462978/Forum%20Curators%20%28Mod%29%20%20%7C%20Kolkov.meta.js
// ==/UserScript==
    ...
    },
      {
        ...
        content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
          "[CENTER]Ваша тема не относится к разделу 'Жалобы на игроков'.[/CENTER]<br>" +
