// ==UserScript==
// @name         Vanilla Extension By Gum
// @namespace    http://tampermonkey.net/
// @version      0.9
// @description  Sets show mass and dark theme to true, provides a tricksplit with T or 4, triplesplit with Y, doublesplit with G or Q, faster feeding with E, and split with 1
// @author       Gum + Klelek
...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/22009/Vanilla%20Extension%20By%20Gum.user.js
// @updateURL https://update.greasyfork.org/scripts/22009/Vanilla%20Extension%20By%20Gum.meta.js
// ==/UserScript==
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_3'> Press <b>Y</b> to split 3x</span></span></center>";
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_d'> Press <b>G</b> or <b>Q</b> to split 2x</span></span></center>";
