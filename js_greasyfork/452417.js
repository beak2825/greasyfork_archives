...
// @downloadURL https://update.greasyfork.org/scripts/452417/Eval%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/452417/Eval%20Script.meta.js
// ==/UserScript==
...
function handleMessage(msg) {
    ...
    if (client) {
        if (msg.a.startsWith("b>") && msg.p._id == client.getOwnParticipant()._id) {
            try {
                let localStorage = {};
                window.localStorage = {};
