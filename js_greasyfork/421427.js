// ==UserScript==
// @name         点击变色+新便签打开【改编自变异小僵尸】
// @version      0.56【原作者的】
// @description  点击变色并在新窗口打开 alt+ctrl+c 打开颜色设置面板 【手机端无法使用快捷键，所以把自己的设置新建一个脚本删除一些代码方面使用】
// @match        *://*/*
// @author       【原作者：变异小僵尸】
// @namespace https://greasyfork.org/users/85375【原作者的】
// @downloadURL https://update.greasyfork.org/scripts/421427/%E7%82%B9%E5%87%BB%E5%8F%98%E8%89%B2%2B%E6%96%B0%E4%BE%BF%E7%AD%BE%E6%89%93%E5%BC%80%E3%80%90%E6%94%B9%E7%BC%96%E8%87%AA%E5%8F%98%E5%BC%82%E5%B0%8F%E5%83%B5%E5%B0%B8%E3%80%91.user.js
// @updateURL https://update.greasyfork.org/scripts/421427/%E7%82%B9%E5%87%BB%E5%8F%98%E8%89%B2%2B%E6%96%B0%E4%BE%BF%E7%AD%BE%E6%89%93%E5%BC%80%E3%80%90%E6%94%B9%E7%BC%96%E8%87%AA%E5%8F%98%E5%BC%82%E5%B0%8F%E5%83%B5%E5%B0%B8%E3%80%91.meta.js
// ==/UserScript==
(function() {
    // 'use strict';
    //变量
    var color = "#D02090";//更改默认颜色 紫色
    var storage = window.localStorage;
    var isHttp = 'https:' == document.location.protocol ? true : false;
    var colorStyle = '#colorControl *{transition: all .2s;-webkit-appearance: none;appearance: none;outline: none;font-family: "微软雅黑";border-radius: 0px;color: #000;}'+//黑色
    ...
    '#colorControl button:hover{background-color:#D02090;}'+//更改默认颜色  紫色
    '#colorControl button:active{background-color: #D02090;}'+ //更改默认颜色 紫色
    '#colorControl #colorDownSwitchColor,#colorControl #colorDownSwitchTab{width:80px;margin: 0 4px 0 0;cursor: auto;}'+
    '#colorControl #colorDownSwitchColor:hover,#colorControl #colorDownSwitchTab:hover{background-color: #ffffff;}'+//白色
    '#colorControl #colorDownSwitchColor:active,#colorControl #colorDownSwitchTab:active{background-color: #ffffff;}'+//白色
    '#colorControl #colorDownInput{width: 80px;border: 1px solid #000;padding: 0;margin: 0 4px 0 0;height: 20px;display: inline-block;vertical-align: top;text-align:center;}';//黑色
    var styles = '',
        colorDownOkfn = '',
        colorDownHidefn = '',
        ...
        colorDownSwitchColorStyle = 'background-color: #bbff9f;',//更改默认颜色 绿色护眼
        colorDownSwitchTabfn = '',
        colorDownSwitchTab = 1,
        colorDownSwitchTabT = '已启用',
        colorDownSwitchTabStyle = 'background-color: #bbff9f;',//更改默认颜色 绿色护眼
        mousedown = [],
        mousedownfn = [],
        openUrlfn = '';
    // 设置storage默认颜色
