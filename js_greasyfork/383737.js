// ==UserScript==
// @name         智能划词翻译 For Mobile(修改)
// @namespace    http://tampermonkey.net/
// @version      1.2
// @description  适配移动端的划词翻译,自动切换谷歌翻译和有道词典
// @author       田雨菲
// @match        http://*/*
// @include      https://*/*
// @run-at document-end
...
// @downloadURL https://update.greasyfork.org/scripts/383737/%E6%99%BA%E8%83%BD%E5%88%92%E8%AF%8D%E7%BF%BB%E8%AF%91%20For%20Mobile%28%E4%BF%AE%E6%94%B9%29.user.js
// @updateURL https://update.greasyfork.org/scripts/383737/%E6%99%BA%E8%83%BD%E5%88%92%E8%AF%8D%E7%BF%BB%E8%AF%91%20For%20Mobile%28%E4%BF%AE%E6%94%B9%29.meta.js
// ==/UserScript==
//
//———修改说明：———
//原版的有道词典链接失效，修改了一下
...
(function () {
    ...
    'width:' + iconSize + 'px;' +
    'height:' + iconSize + 'px;' +
    'margin:' + iconSize / 6 + 'px!important;' +
    'user-select: none;' +
    '-webkit-user-select: none;' +
    'pointer-events: none;' +
    '';
    icon.innerHTML = '' +
    '<svg href="javascript:void(0)" style="' + iconStyle + '" "width="'+iconSize+'" height="'+iconSize+'" viewBox="0 0 768 768">' +
    ...
    'width:' + (iconSize + iconSize / 3) + 'px!important;' +
    'height:' + (iconSize + iconSize / 3) + 'px!important;' +
    'display:none!important;' +
    'background:#fff!important;' +
    'border-radius:' + (2 * iconSize / 3) + 'px!important;' +
    ...
    window.addEventListener("load", function(event) {
        ...
        var iconSize = Math.round(24 * zoom) * 2;
        translationTestSize = Math.round(16 * zoom);
        iconStyle = '' +
        'width:' + iconSize + 'px;' +
        'height:' + iconSize + 'px;' +
        'margin:' + iconSize / 6 + 'px!important;' +
    ...
    document.addEventListener('click', function (e) {
        if (e.target == icon || (e.target.parentNode && e.target.parentNode == icon) || (e.target.parentNode.parentNode && e.target.parentNode.parentNode == icon)) {// 点击了翻译图标
            ...
            if (text) {
                ...
                container.style.maxHeight = document.body.clientHeight + 'px';
                container.style.maxWidth = document.body.clientWidth + 'px';
    ...
    var server = {
        ...
        container: function () {
            ...
            div.setAttribute('style', '' +
                'display:none!important;' +
                'position:fixed!important;' +
                'font-size:' + translationTestSize + 'px!important;' +
