...
// @match        *://gym-443.webvpn.sysu.edu.cn/*
// @run-at       document-end
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/517075/sysu-gym.user.js
// @updateURL https://update.greasyfork.org/scripts/517075/sysu-gym.meta.js
// ==/UserScript==
...
(function () {
    ...
    // 网址正则
    var reg_product = /[http|https]*?:\/\/[gym\-443.webvpn|gym]*?.sysu.edu.cn\/product\/show.html\?id=(\d+)/;
    var reg_order = /[http|https]*?:\/\/[gym\-443.webvpn|gym]*?.sysu.edu.cn\/order\/show.html\?id=(\d+)/;
    // 特定类型的场地预定才可用
    var button = $('#reserve');
                ...
                unsafeWindow.AjaxPost('/order/book', param1, function (o) {
                    ...
                    if (o.result == '1') {
                        ...
                        if (val == "0") {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "http://" + host + "/pay/account/topay.html",
                                data: dataPay,
                                success: function () {
                                    window.location.href = cu('/order/myorder_view') + '?id=' + o.object.orderid
                                },
