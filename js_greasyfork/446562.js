// ==UserScript==
// @name         Мастер Тетриса Theme
// @namespace    http://tampermonkey.net/
// @version      0.47
// @description  Мастер Тетриса theme for Jstris
// @author       Oki, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/446562/%D0%9C%D0%B0%D1%81%D1%82%D0%B5%D1%80%20%D0%A2%D0%B5%D1%82%D1%80%D0%B8%D1%81%D0%B0%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/446562/%D0%9C%D0%B0%D1%81%D1%82%D0%B5%D1%80%20%D0%A2%D0%B5%D1%82%D1%80%D0%B8%D1%81%D0%B0%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/vTTD9vT.png",36);
        loadGhostSkin("https://i.imgur.com/mjUsUAh.png",36);
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_lock.wav",abs:1};
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/mastertetris_ready.mp3",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/mastertetris_go.mp3",abs:1,set:0};
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_died.wav",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_hold.wav",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_move.wav",abs:1,set:0};
    this.comboTones={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/TBcombo.mp3",abs:1,set:2,duration:1000,spacing:500,cnt:20};
...
function atGameStart() {
    ...
    img.onload = function(){
        ...
        bgctx.drawImage(img,35,43,472,553*(608/518)); // Or at whatever offset you like
    };
    img.src = "https://i.imgur.com/qFxKDuE.png";
...
queueCopy0.style.transform="scale(0.7,0.7) translate(-25px, 58px)"
queueCopy1.style.transform = "scale(.7,.7) translate(-25px, 55px)"
queueCopy2.style.transform = "scale(0.7,0.7) translate(-25px, 47px)"
queueCopy3.style.transform = "scale(0.7,0.7) translate(-25px, 47px)"
queueCopy4.style.transform = "scale(0.7,0.7) translate(-25px, 47px)"
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_tspinsingle.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_tspinmini.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_clear1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_tspindouble.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_tspintriple.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_clear4.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_perfectclear.wav",   //no sound exists for TB
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_tspindouble.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_clear4.wav"
];
...
Game['rotationSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_rotate.mp3", //rotate left
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_rotate.mp3", //rotate right
"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_rotate.mp3" //rotate 180°
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/master%20tetris%20music.mp3",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/master%20tetris%20music.mp3"
