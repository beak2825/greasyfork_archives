// ==UserScript==
// @name        HellBots
// @namespace    HellBladePlay
// @version      1.0.1
// @description  Best agar.io bots!!!
// @author       HellBladePlay
// @match        http://agar.io/*
// @require      https://cdnjs.cloudflare.com/ajax/libs/socket.io/1.4.5/socket.io.min.js
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/18706/HellBots.user.js
// @updateURL https://update.greasyfork.org/scripts/18706/HellBots.meta.js
// ==/UserScript==
...
setTimeout(function() {
    ...
    $( "#canvas" ).after( "<div style='background-color: #000000; -moz-opacity: 0.8; -khtml-opacity: 0.8; opacity: 0.8; filter: alpha(opacity=80); zoom: 1; width: 205px; top: 10px; left: 10px; display: block; position: absolute; text-align: left; font-size: 15px; color: #ffffff; padding: 5px; font-family: Ubuntu;'> <div style='color:#ffffff; font-size: 20px; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 0px;'>HellBots: <a id='minionCount' >offline</a> </div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 0px;'><br>-------------------------------</div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>[A] Split bots</div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>[D] Bot feed</div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>[Q] Move to mouse: <a id='ismoveToMouse' >On</a> </div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 0px;'><br>[F] Stop move: <a id='isStopMove' >Off</a> </div>" );
