...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471367/rplace%202023%20Lockard%20Overlay.user.js
// @updateURL https://update.greasyfork.org/scripts/471367/rplace%202023%20Lockard%20Overlay.meta.js
// ==/UserScript==
...
if (window.top !== window.self) {
  addEventListener('load', () => {
    ...
    const loadOverlay = () => {
      ...
      const url = "https://i.ibb.co/rw6XdXh/overlay.png";
      const x = 0;
      const y = 0;
      const width = 1000;
      const height = 1000;
