// ==UserScript==
// @name         Для Кураторов Форума|Belgorod
// @namespace    https://black-russia-online.vkweb.su/index.php
// @description Comfort moderation
// @version      1.8.4
// @author       Wilson
// @match        https://black-russia-online.vkweb.su/index.php*
// @include      
https://black-russia-online.vkweb.su/index.php
// @grant        none
// @license    MIT
// @collaborator Wilson
// @icon https://icons.iconarchive.com/icons/goescat/macaron/64/telegram-icon.png
// @downloadURL https://update.greasyfork.org/scripts/514517/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%7CBelgorod.user.js
// @updateURL https://update.greasyfork.org/scripts/514517/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%7CBelgorod.meta.js
// ==/UserScript==
...
const buttons = [
   ...
   { title: 'Помеха ИП',
    ...
    { title: 'Невозврат долга',
      content:
		'[CENTER][B][COLOR=rgb(255, 255, 0)][SIZE=3]Доброго времени суток, {{ user.mention }}.[/SIZE][/COLOR]<br><br>' +
        "[CENTER]Игрок будет[COLOR=#ff0000] наказан [/COLOR]по данному пункту правил:<br>2.57. Запрещается брать в долг игровые ценности и не возвращать их. [Color=#ff0000]| Ban 30 дней / permban [/COLOR] [/CENTER]<br>" +
    '[LIST]<br><br>' +
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] займ может быть осуществлен только через зачисление игровых ценностей на банковский счет, максимальный срок займа 30 календарных дней, если займ не был возвращен, аккаунт должника блокируется;[/SIZE]<br><br>" +
        "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] при невозврате игровых ценностей общей стоимостью менее 5 миллионов включительно аккаунт будет заблокирован на 30 дней, если более 5 миллионов, аккаунт будет заблокирован навсегда;[/SIZE]<br><br>" +
       "[CENTER][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание:[/COLOR] жалоба на игрока, который занял игровые ценности и не вернул в срок, подлежит рассмотрению только при наличии подтверждения суммы и условий займа в игровом процессе, меры в отношении должника могут быть приняты только при наличии жалобы и доказательств. Жалоба на должника подается в течение 10 дней после истечения срока займа. Договоры вне игры не будут считаться доказательствами.[/SIZE]<br><br>" +
        "[CENTER][/LIST]<br><br>" +
...
title: 'Доква отредактированы',
 ...
 title: 'ГС ГОСС/ЗГС',
    ...
    },
    {
      ...
      content:
		'[CENTER][B][COLOR=rgb(255, 255, 0)][SIZE=3]Доброго времени суток, {{ user.mention }}.[/SIZE][/COLOR]<br><br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить создание биографии от 1го лица.[/CENTER]",
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
title: 'Заголовок темы',
    ...
    },
    {
      ...
      content:
		'[CENTER][B][COLOR=rgb(255, 255, 0)][SIZE=3]Доброго времени суток,  {{ user.mention }}.[/SIZE][/COLOR]<br><br>' +
        "[CENTER]Вы ошиблись разделом <br>Напишите в нужный раздел.[/CENTER]",
      prefix:UNACCEPT_PREFIX,
	  status: false,
    },
    {
