...
// @downloadURL https://update.greasyfork.org/scripts/563712/yangjie.user.js
// @updateURL https://update.greasyfork.org/scripts/563712/yangjie.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "SULAIMAN MUBARAK ABUBAKAR";
    const NEW_NAME = "YANG JIE";
    const NEW_BIRTHDAY = "(**0628)";
    const NEW_EXPIRE_DATE = "2035-12-07";
