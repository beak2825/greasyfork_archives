// ==UserScript==
// @name         Account Creator for UFS.PT [o2.pl]
// @namespace    http://tampermonkey.net/
// @version      0.1
// @author       Infinity
// @match        https://poczta.o2.pl/rejestracja/
// @require      https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js
// @description  Account Creator for UFS.PT
// @downloadURL https://update.greasyfork.org/scripts/404810/Account%20Creator%20for%20UFSPT%20%5Bo2pl%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/404810/Account%20Creator%20for%20UFSPT%20%5Bo2pl%5D.meta.js
// ==/UserScript==
...
$(document).ready(function ()
{
  ...
  $('#home').click(function() {
    window.location.replace("https://poczta.o2.pl/rejestracja/");
  });
  ...
  function testy() {
      ...
      void function(){
          ...
          document.getElementsByTagName("input")[0].focus();
          onet_konta=window.open ('','wp_konta','scrollbars=1,width=360,height=400');
          onet_konta.document.write('L: ' + name.toLowerCase()+'.'+sname.toLowerCase()+mail.toLowerCase() + '@o2.pl<br />P: ' + pwd+temp + '<br /><br />');}();
  }
  function instrukcja() {
          alert("1. Wykonać skrypt.\r\n2. Kliknąć na pole do wpisywania imienia.\r\n3. Wciskać klawisz TAB, aż do wybrania captchy.\r\n4. Rozwiazać captchę.\r\n5. Kliknąć w przycisk \"Załóż konto\".\r\n6. Konto zostało poprawnie założone, jeśli po zatwierdzeniu formularza pojawi sie tekst \"Twoje konto w Poczcie o2 zostało założone!\".")
  }
});