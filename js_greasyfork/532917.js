// ==UserScript==
// @name         Для крутышей с 51 / By K. Stoyn
...
// @icon https://i.postimg.cc/0jZc0sDq/66f1cdf962643a120083158e75f5c854.jpg
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/532917/%D0%94%D0%BB%D1%8F%20%D0%BA%D1%80%D1%83%D1%82%D1%8B%D1%88%D0%B5%D0%B9%20%D1%81%2051%20%20By%20K%20Stoyn.user.js
// @updateURL https://update.greasyfork.org/scripts/532917/%D0%94%D0%BB%D1%8F%20%D0%BA%D1%80%D1%83%D1%82%D1%8B%D1%88%D0%B5%D0%B9%20%D1%81%2051%20%20By%20K%20Stoyn.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
	  title: 'Жб на рассмотрение ',
       dpstyle: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #ff6600; width: 30%',
   content:
   ...
   content:
    ...
    {
	  title: 'Ошибка, жб ГА',
       dpstyle: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #ff6600; width: 30%',    content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
    ...
    },
    {
	  title: 'Жб не по форме',
       dpstyle: 'oswald: 3px; color: #ff0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #ff0000; width: 30%',
   content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url].<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано. Закрыто.<br>Приятной игры на сервере TULA![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
 ...
 content:
	...
	},
    {
	  title: 'Ответ дм (нужен фрапс)',
       dpstyle: 'oswald: 3px; color: #ff0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #ff0000; width: 30%',    content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
		...
		'[B][CENTER][COLOR=red][ICODE]Закрыто.<br>Приятной игры на сервере TULA![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	...
	},
{
        ...
        dpstyle: 'oswald: 3px; color: #8B0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.12),0 2px 2px 0 rgba(0,0,0,0.14),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #8B0000; width: 96%',
    },
    {
	  title: 'ДМ',
       dpstyle: 'oswald: 3px; color: #8B0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #8B0000; width: 30%',    content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
    ...
    },
    {
	  title: 'Наказание по ошибке',
       dpstyle: 'oswald: 3px; color: #00FF00; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #00FF00; width: 30%',    content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
		...
		'[B][CENTER][COLOR=GREEN][ICODE]Одобрено. Закрыто.<br>Приятной игры на сервере TULA![/ICODE][/COLOR][/CENTER][/B]',
    ...
    {
	  title: 'Снижено до бан 3',
       dpstyle: 'oswald: 3px; color: #00FF00; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #00FF00; width: 30%',    content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
		"[B][CENTER][COLOR=lavender]Наказание будет снижено до блокировки аккаунта на 3 дня.<br>"+
        "[B][CENTER][COLOR=lavender]Впредь больше не нарушайте, а так же ознакомьтесь с правилами проекта .<br> [URL='https://forum.blackrussia.online/index.php?threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%BE%D0%B2.312571/']*Нажмите сюда*[/URL]<br>"+
		'[B][CENTER][COLOR=green][ICODE]Одобрено. Закрыто.<br>Приятной игры на сервере TULA![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	  status: false,
    ...
    {
	  title: 'Снижено до бан 5',
       dpstyle: 'oswald: 3px; color: #00FF00; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #00FF00; width: 30%',    content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
		"[B][CENTER][COLOR=lavender]Наказание будет снижено до блокировки аккаунта на 5 дней.<br>"+
        "[B][CENTER][COLOR=lavender]Впредь больше не нарушайте, а так же ознакомьтесь с правилами проекта .<br> [URL='https://forum.blackrussia.online/index.php?threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%BE%D0%B2.312571/']*Нажмите сюда*[/URL]<br>"+
		'[B][CENTER][COLOR=green][ICODE]Одобрено. Закрыто.<br>Приятной игры на сервере TULA![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	  status: false,
    ...
    },
    {
      title: 'перемещение в жб на игроков',
       dpstyle: 'oswald: 3px; color: #9966FF; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #9966FF; width: 30%',    content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url].<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
	...
	},
    {
     title: 'перемещение в жб на лд',
       dpstyle: 'oswald: 3px; color: #9966FF; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #9966FF; width: 30%',    content:
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано.<br>Приятной игры на сервере TULA![/ICODE][/COLOR][/CENTER][/B]',
	...
	},
    {
	  title: 'Перенос жб тех',
       dpstyle: 'oswald: 3px; color: #9966FF; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #9966FF; width: 30%',    content:
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=YELLOW][ICODE]Приятной игры на сервере TULA![/ICODE][/COLOR][/CENTER][/B]',
    ...
    },
    {
	  title: 'Нрп обман (договоритесь)',
       dpstyle: 'oswald: 3px; color: #99FFFF; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #99FFFF; width: 30%',    content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
		"[B][CENTER][COLOR=lavender] Для обжалования вашего наказания вам необходимо достичь соглашения с пострадавшей стороной о возврате имущества. После этого пострадавший игрок должен подать обжалование с аккаунта, с которого он писал предыдущее обращение, после которого вы получили бан.<br>"+
        "[B][CENTER][COLOR=lavender]В доказательства требуется предоставить вашу с ним перкписку в соц сети, на которой будут видны условия сделки, а так же окно вашего бана.<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано. Закрыто.<br>Приятной игры на сервере TULA![/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	  title: 'Нрп обман (разбан 24ч)',
       dpstyle: 'oswald: 3px; color: #99FFFF; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #99FFFF; width: 30%',    content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B].<br><br>"+
		"[B][CENTER][COLOR=lavender]Аккаунт игрока, совершившего обман, разблокирован на 24 часа, чтобы он мог вернуть вам украденное. Пожалуйста, получите своё имущество обратно и предоставьте сюда фрапс , на котором будет видно, как вы получили имущество и притензий не имеете. <br>"+
        "[B][CENTER][COLOR=lavender]Любые попытки передать что-либо кому-то другому будут расценены как махинации, и все участвующие аккаунты будут немедленно заблокированы.<br>"+
...
if(prefix == TRANSFER_PREFIX_TR49) {
				moveThread(prefix, 2261); // в жб на техов
			}
if(prefix == TRANSFER_PREFIX_OBJ49) {
				moveThread(prefix, 2291); //  в обж
			}
if(prefix == TRANSFER_PREFIX_ADM49) {
				moveThread(prefix, 2288); //  в жб на адм
			}
if(prefix == TRANSFER_PREFIX_LD49) {
				moveThread(prefix, 2289); //  в жб на лд
			}
if(prefix == TRANSFER_PREFIX_PLAYER49) {
				moveThread(prefix, 2290); // в жб на игроков
			}
}
}
