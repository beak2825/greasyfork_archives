...
// @version 0.0.1.20170825194240
// @downloadURL https://update.greasyfork.org/scripts/32601/Neopets%20-%20Cliffhanger%20Autoplayer.user.js
// @updateURL https://update.greasyfork.org/scripts/32601/Neopets%20-%20Cliffhanger%20Autoplayer.meta.js
// ==/UserScript==

// this is a modified version of the script located at http://userscripts.org/scripts/show/6969
if(document.URL.indexOf("games/cliffhanger/cliffhanger.phtml?game=true&gip=") != -1) {
	$("input[name='game_skill']")[2].checked=true;
}
try {
...
if (possible.length==1) {
	...
	setTimeout(function(){solvesubmit.click();},wait);
} else {
	alert(possible.join('\n'));
}
