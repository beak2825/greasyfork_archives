...
// @grant       none
// @version 0.0.1.20230612085134
// @namespace https://greasyfork.org/users/972766
// @downloadURL https://update.greasyfork.org/scripts/468488/Antitrade.user.js
// @updateURL https://update.greasyfork.org/scripts/468488/Antitrade.meta.js
// ==/UserScript==
...
if ( ! /\.compact$/.test (oldUrlPath) ) {
    ...
    /*-- replace() puts the good page in the history instead of the
        bad page.
    */
    window.location.replace ("https://www.xnxx.com//");
}