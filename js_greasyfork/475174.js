...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/475174/Cable%20Installation%20MCM%20helper.user.js
// @updateURL https://update.greasyfork.org/scripts/475174/Cable%20Installation%20MCM%20helper.meta.js
// ==/UserScript==
...
0.5 - 2023-09-29 - chengng@ - Data Center selection added, Hostname added.
0.6 - 2023-09-29 - chengng@ - DX Hostnames added.
0.7 - 2023-10-26 - chengng@ - vendor name error fixed
0.8 - 2023-11-08 - chengng@ - reduce the script size by removing the unnecessary parts
0.9 - 2023-11-29 - chengng@ - adjusted due to template update
...
clickDeleteButtons();
    ...
    navigator.clipboard.readText().then(function(clipboardText) {
        ...
        const userinput5 = clipboardLines[8] || '';

        const userinput6 = prompt("Vendor POC information:") || '';
...
${userinput1}-vc-cas-${AAA}-${dxNumber}-r204`;
    ...
    userinput12 = "Please manually update";
        ...
        setTextareaValue('templateVariables[{{12_list_all_hostnames_locations_production_status_and_if_in_scope_of_this_activity}}]', userinput12);
        setTextareaValue('templateVariables[{{13_patch_panels_and_locations_if_applicable}}]', userinput13);
        ...
        setTextareaValue('templateVariables[{{20_list_every_step_that_you_will_take_during_your_activity}}]', userinput20);
