...
// @grant        GM_openInTab
// @license      ISC
// @description  ALL IN ONE BYPASSSER 😁
...
// @downloadURL https://update.greasyfork.org/scripts/486959/IQOOZ%20BYPASSER.user.js
// @updateURL https://update.greasyfork.org/scripts/486959/IQOOZ%20BYPASSER.meta.js
// ==/UserScript==
...
async function codex() {
    ...
    try {
        while (stagesCompleted < stages.length) {
            ...
            notification(`${stagesCompleted + 1}/${stages.length} stages completed`, 3000);
...
async function fluxus() {
    ...
    try {
        ...
        document.getElementById('noUserscript').innerHTML = '<h1>You Have Been Banned</h1>';
        handleError(new Error('You Have Been Banned'), 'fluxus');
    }
}
