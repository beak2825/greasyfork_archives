...
// @version 2.5
// @description Полный cкрипт для КФ
// @author Danya_Zhukov
// @match https://forum.blackrussia.online/*
// @icon https://i.postimg.cc/y6cNdSqT/faaf.jpg
// @grant none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/559981/C%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20FULL%20%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/559981/C%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20FULL%20%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
},
{
 ...
 "[B][CENTER][[COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба передана на рассмотрение [COLOR=blue]Главному Куратору Форума.[/COLOR]<br><br>"+
 "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Ожидайте ответа в данной теме. Не создавайте повторные темы в противном случае Вы можете получить блокировку форумного аккаунта.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
 TotlePhotoTxt1 +
TotleEnd,
 prefix: NARASSMOTRENIIRP_PREFIX,
...
},
{
 ...
 "[B][CENTER][[COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба передана на рассмотрение [COLOR=blue]Техническому Специалисту.[/COLOR]<br><br>"+
 "[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=courier new]Ожидайте ответа в данной теме. Не создавайте повторные темы в противном случае Вы можете получить блокировку форумного аккаунта.[/FONT][/COLOR][/SIZE][/CENTER][/B]<br>"+
 TotlePhotoTxt1 +
TotleEnd,
 prefix: TEXY_PREFIX,
...
{
    title: '| 2.07 AFK no ESC |',
 content:
 "[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
 "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]2.07.[/color] Запрещено нахождение в AFK без включенного ESC, создавая помеху другим игрокам [Color=#ff0000]| Kick[/color].[/COLOR]<br><br>" +
 TotlePhotoTxt1 +
TotleEnd,
 prefix: ACCСEPT_PREFIX,
 status: false,
...
{
 title: '| 2.09 Слив склада фракции/семьи |',
 content:
 "[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
...
{
 title: '| 2.12 Помеха работе блогеров |',
 content:
 "[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
...
},
{
 ...
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
 "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]2.13.[/color] Запрещен RK (Revenge Kill) — убийство игрока с целью мести, возвращение на место смерти в течение 15-ти минут, а также использование в дальнейшем информации, которая привела Вас к смерти [Color=#ff0000]| Jail 30 минут[/color].[/COLOR]<br><br>" +
 TotlePhotoTxt1 +
TotleEnd,
 prefix: ACCСEPT_PREFIX,
 status: false,
...
{
 title: '| 2.23 Скрытие ошибок системы |',
 content:
 "[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
...
{
 title: '| 2.37 OOC угрозы/о наказании от АДМ |',
 content:
 "[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
...
{
    title: '| 4.03 Передача аккаунта (ППВ) |',
 content:
 "[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
...
{
    title: '| 4.04 Мультиаккаунт |',
 content:
 "[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
 "[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
 "[B][CENTER][COLOR=white][FONT=courier new][Color=#ff0000]4.09.[/color] Запрещено регистрировать более трёх игровых аккаунтов на сервере [Color=#ff0000]| PermBan[/color].[/COLOR]<br><br>" +
 TotleEnd,
 prefix: ACCСEPT_PREFIX,
 status: false,
},
...
},
{
	  ...
	  TotlePhotoTxt1 +
		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как никнейм в доказательствах и в форме не совпадают. <br><br>"+
...
},
{
    title: '| Чат не логируется |',
	  ...
	  TotlePhotoTxt1 +
		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как данный чат не логируется.<br>"+
               TotlePhotoTxt1 +
		TotleEnd,
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
},
{
    ...
    title: '| Док-ва обрезаны |',
	  content:
	   TotlePhotoTxt1 +
		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как ваши доказательства обрезаны. <br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
              TotlePhotoTxt1 +
			TotleEnd,
       prefix: UNACCСEPT_PREFIX,
...
"[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило - Неправильное написание заголовка биографии. <br>"+
 ...
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужила - Биография не по форме (Вся информация в биографии является IC. Запрещено проявление в ней OOC). <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
...
"[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило - Биография нечитабельна или содержать грамматические или орфографические ошибки. <br>"+
 ...
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
"[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило - Шрифт биографии должен быть Times New Roman либо Verdana, минимальный размер — 15. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
 ...
 TotlePhotoTxt1 +
  ...
  {
      title: '| Био отказ (недостаточно фоток) |',
	  content:
	   		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило - Недостаточно фотографий и иных материалов, относящихся к истории вашего персонажа. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
  ...
  {
      title: '| Био отказ (фотки не открываются) |',
	  content:
	   		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило - Фотографии, относящиеся к истории вашего персонажа не открываются. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
...
},
{
 ...
 TotlePhotoTxt1 +
  ...
  {
      title: '| Био отказ (некоррект. национальность) |',
	  content:
		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило - некорректное написание национальности. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
  ...
  {
      title: '| Био отказ (некоррект. образование) |',
	  content:
		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило - некорректное написание образования. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
...
"[B][CENTER][COLOR=white][FONT=courier new]Причиной послужило - Несоответствие шрифта или размера текста в вашей биографии <br>"+
  ...
  {
                	  title: '| Био на дороботку (не читабельна, ошибки) |',
	  content:
	  		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=yellow]На доработке[/COLOR]<br><br>"+
"[B][CENTER][COLOR=white][FONT=courier new]Причиной послужило - Биография нечитабельна или содержать грамматические или орфографические ошибки. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]На внесение изменений дается 24 часа, в противном случаи Биография будет отказана<br><br>"+
               TotlePhotoTxt1 +
			TotleEnd,
