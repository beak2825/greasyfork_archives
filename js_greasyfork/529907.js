...
// @updateURL
// @downloadURL
// @downloadURL https://update.greasyfork.org/scripts/529907/%D0%94%D0%BB%D1%8F%20Logs%2053%20and%20Forum%2054.user.js
// @updateURL https://update.greasyfork.org/scripts/529907/%D0%94%D0%BB%D1%8F%20Logs%2053%20and%20Forum%2054.meta.js
// ==/UserScript==
  ...
  const TRANSFER_PREFIX_TECHRAZDEL53 = 20; // перенос в тех раздел 53
  const TRANSFER_PREFIX_OBJ53 = 21; // перенос в обжалования наказаний(адм) 53
  const TRANSFER_PREFIX_ADM53 = 22; // перенос в жб на адм 53
  const TRANSFER_PREFIX_PLAYER53 = 23; // перенос в жб на игроков 53
  const TRANSFER_PREFIX_JBTECH54 = 24; // перенос в жб на техов 54
	...
	'[CENTER][COLOR=rgb(255, 255, 0)] Префикс [/COLOR][/CENTER][/FONT][/SIZE]',
        ...
        {
	title: 'ᅠ ᅠᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠᅠ ᅠ ᅠ  Перенос тем ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠᅠ ᅠ ᅠ ᅠᅠ ᅠ',
	color: 'oswald: 3px; color: #FFFF00; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 3px solid #FFFF00; width: 96%',
	},
{
	title: 'В тех.раздел 53',
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER] Вы ошиблись разделом при создании темы. Перемещаю вашу тему в «Технический раздел»<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(255, 255, 0)]Ожидайте ответа. Тему повторно создавать НЕ нужно.[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TRANSFER_PREFIX_TECHRAZDEL53,
	status: open,
},
{
	title: 'В обж наказаний 53',
	color: 'oswald: 3px; color: #ff0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER] Вы ошиблись разделом при создании темы. Перемещаю вашу тему в раздел «Обжалования наказаний»<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(255, 255, 0)]Ожидайте ответа. Тему повторно создавать НЕ нужно.[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TRANSFER_PREFIX_OBJ53,
	status: open,
},
{
	title: 'В жб на адм 53',
	color: 'oswald: 3px; color: #ff0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER] Вы ошиблись разделом при создании темы. Перемещаю вашу тему в раздел «Жалобы на администрацию»<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(255, 255, 0)]Ожидайте ответа. Тему повторно создавать НЕ нужно.[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TRANSFER_PREFIX_ADM53,
	status: open,
},
{
	title: 'В жб на игроков 53',
	color: 'oswald: 3px; color: #ff0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER] Вы ошиблись разделом при создании темы. Перемещаю вашу тему в раздел «Жалобы на игроков»<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(255, 255, 0)]Ожидайте ответа. Тему повторно создавать НЕ нужно.[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TRANSFER_PREFIX_PLAYER53,
	status: open,
},
{
	title: 'В жб на тех 54',
	color: 'oswald: 3px; color: #ff0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER] Вы ошиблись разделом при создании темы. Перемещаю вашу тему в раздел «Жалобы на тех. специалистов»<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(255, 255, 0)]Ожидайте ответа. Тему повторно создавать НЕ нужно.[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TRANSFER_PREFIX_JBTECH54,
	status: open,
},
{
	title: 'Тестерам',
...
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
    "[CENTER]Ваш аккаунт был взломан.<br>Мне нужно уточнить некоторые детали.<br><br>" +
    '[CENTER]1. Укажите ваш Telegram ID, если ваш игровой аккаунт был привязан к Telegram. Узнать его можно здесь: https://t.me/getmyid_bot<br>2. Укажите ваш оригинальный ID страницы ВКонтакте, которая привязана к аккаунту (взять его можно через данный сайт - https://regvk.com/)<br>3. Укажите почту, которая привязана к аккаунту<br><br><br>И прикрепите скриншот, где вы сбросили пароль от аккаунта. Обязательно замазать пароль.<br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(255, 255, 0)]Тема закреплена и находится на рассмотрении.[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TECHADM_PREFIX,
	status: true,
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER] После дополнительной тщательной проверки информации с помощью системы логирования было принято решение о снятии вашего наказания. <br>Приношу искренние извинения за вызванные неудобства и беспокойство.<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER]Приложите окно блокировки, можно воспользоваться фото хостингами написанными ниже.<br><br>[URL='https://yapx.ru/']yapx.ru[/URL],<br>[URL='https://imgur.com/']imgur.com[/URL],<br>[URL='https://imgbb.com']ImgBB.com[/URL]<br>(все кликабетильно).<br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][CENTER][COLOR=rgb(255, 255, 0)]Тема закреплена и находится на рассмотрении.[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TECHADM_PREFIX,
	status: true,
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER]Доказательства не принимаются в социальных сетях.<br>Загрузите доказательства на разрешенный фото/видео хостинг.<br><br>[URL='https://yapx.ru/']yapx.ru[/URL],<br>[URL='https://imgur.com/']imgur.com[/URL],<br>[URL='https://www.youtube.com/']youtube.com[/URL],<br>[URL='https://imgbb.com']ImgBB.com[/URL]<br>(все кликабетильно).<br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(255, 255, 0)]Тема закреплена и находится на рассмотрении.[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TECHADM_PREFIX,
	status: true,
...
},
{
	...
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(255, 255, 0)] Передано руководству для окончательного ответа. [/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: PIN_PREFIX,
	status: true,
},
    {
	title: 'Ожидайте в предыдущей',
	color: 'oswald: 3px; color: #FF0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER] [COLOR=rgb(209, 213, 216)]Пожалуйста, ожидайте ответа в предыдущей созданой вами теме/жалобе.[/COLOR]<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
},
{
	...
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER][SIZE=4][FONT=trebuchet ms][I][COLOR=green]Рассмотрено[/COLOR][/FONT][/CENTER]",
},
{
...
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER]Ваше обращение не относится к техническому разделу.<br> Пожалуйста ознакомьтесь с правилами данного раздела: [URL='https://forum.blackrussia.online/forums/Информация-для-игроков.231/']клик[/URL] <br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(139, 0, 0)]Отказано[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: UNACCEPT_PREFIX,
	status: false,
...
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
    '[CENTER]Просьба обратиться в техническую поддержку Black Russia для консультации.<br>Telegram —  https://t.me/br_techBot<br>Вконтакте — https://vk.com/br_tech<br>' +
    '[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][I]Решено[/I][/CENTER][/FONT][/SIZE]',
    prefix: DECIDED_PREFIX,
    status: false,
...
},
{
  ...
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIX_TECHRAZDEL53, false));
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIX_OBJ53, false));
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIX_ADM53, false));
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIX_PLAYER53, false));
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIX_JBTECH54, false));
...
if(prefix == TRANSFER_PREFIX_TECHRAZDEL53) {
				moveThread(prefix, 2346);
			}
if(prefix == TRANSFER_PREFIX_OBJ53) {
				moveThread(prefix, 2375);
			}
if(prefix == TRANSFER_PREFIX_ADM53) {
				moveThread(prefix, 2372);
			}
if(prefix == TRANSFER_PREFIX_PLAYER53) {
				moveThread(prefix, 2374);
			}
if(prefix == TRANSFER_PREFIX_JBTECH54) {
				moveThread(prefix, 2387);
			}
	}
	}
...
const Button53 = buttonConfig("Жб игр 53", 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2374/');
...
const ButtonComp53 = buttonConfig("Жб тех 53", "https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9653-murmansk.2345/")
...
const ButtonPravila = buttonConfig("Правила", "https://forum.blackrussia.online/threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%BE%D0%B2.312571/")

bgButtons.append(Button53);
bgButtons.append(ButtonTech53);
bgButtons.append(ButtonComp53);
bgButtons.append(ButtonTech54);
bgButtons.append(ButtonPravila);
