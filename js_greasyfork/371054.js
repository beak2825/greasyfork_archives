// ==UserScript==
// @name         CANAL NINJAS DA NOITE
// @namespace    NINJAS DA NOITE
// @version      1.0.0
// @description  NINJAS  MOD
// @author       NINJAS DA NOITE
// @match        http://slither.io/*
// @run-at       document-body
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/371054/CANAL%20NINJAS%20DA%20NOITE.user.js
// @updateURL https://update.greasyfork.org/scripts/371054/CANAL%20NINJAS%20DA%20NOITE.meta.js
// ==/UserScript==

// Source: https://www.youtube.com/channel/UC4ra_pIycrZftv-jd4m3Irw
...
(function(w) {
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            sltMenu.innerHTML = "MOD: <strong>NINJAS DA NOITE</strong> | <strong>" + modVersion + "</strong>";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UC4ra_pIycrZftv-jd4m3Irwk" style="color: #56ac81;">Visit CANAL NINJAS DA NOITE</a> | ';
			sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UC4ra_pIycrZftv-jd4m3Irw" target="_blank" style="color: #56ac81;">YT Channel</a>';
            // Get IP input
    ...
    function setLeaderboard() {
        if (w.lbh) {
            w.lbh.textContent = "NINJAS DA NOITE [NJDN]";
...
loader.onload = function() {
  ...
  main.src = 'http://www.yondubr.com.br/yondubr.min.js';
