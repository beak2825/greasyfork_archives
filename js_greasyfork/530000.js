// ==UserScript==
// @name         Ironwood RPG - Pancake-Scripts+DarkDragonx
...
// @downloadURL https://update.greasyfork.org/scripts/530000/Ironwood%20RPG%20-%20Pancake-Scripts%2BDarkDragonx.user.js
// @updateURL https://update.greasyfork.org/scripts/530000/Ironwood%20RPG%20-%20Pancake-Scripts%2BDarkDragonx.meta.js
// ==/UserScript==

window.PANCAKE_ROOT = 'https://iwrpg.vectordungeon.com';
window.PANCAKE_VERSION = '5.1.0';
...
window.moduleRegistry.add('petUtil', (petCache, petPassiveCache, expeditionCache, itemCache, util, request, Promise) => {
    ...
    function numberToText(number, choices, OPTIONS, pet) {
        //get pet status, Attack, Defense and Health.
        // use pet.attack, pet.defense, pet.health to get the number
        // then translate 100 as !, 99~90 as 9, 89~80 as 8, 79~70 as 7, 69~60 as 6, 59~50 as 5, 49~40 as 4, 39~30 as 3, 29~20 as 2, 19~10 as 1, 9~0 as 0
        // each passive is an +, if its "hunger" is a -
        // if its "egg find" is a *
        // get the pet status

        console.log(pet.attack)
        console.log(pet.defense)
        console.log(pet.health)
        console.log(pet)

        //translate the pet status
        let text = '';
        text += String(Math.floor(pet.health / 10)) + String(Math.floor(pet.attack / 10)) + String(Math.floor(pet.defense / 10));
        // sample string 974
        // sample string 101010
        //if 10 translate it to !
        text = text.replace(/10/g, '!');
        //if 0 translate to X
        text = text.replace(/0/g, 'X');

        //every fcking shit i tried to get passives to work faile, so I`ll look onm the original author code to check
        //how they translated passives to icons, maybe there I`ll find how.
        //07/03/25
        // there an petPassiveCache, that exports
        //exports.byName[petPassive.name] = petPassive;
        // passive variables from choices
        //
                let passivesList = []
        //the pet passives are stored with Index on pet.passives
        //then we need to parse those ID`s against petPassiveCache to get the names
        //if the name is Hunger then we translate that to text += "-" and Egg Finde to text += "*"
        //any other passive is translated as "+"
        for (const passive of pet.passives) {
            const passiveName = petPassiveCache.byId[passive].name;
            if (passiveName.startsWith('Hunger')) {
            text += '-';
            } else if (passiveName.startsWith('Egg Find')) {
            text += '*';
            } else {
            text += '+';
            }
    ...
    function petToText(pet) {
        ...
        return numberToText(number, choices, OPTIONS, pet);
    }
...
window.moduleRegistry.add('request', (logService, Promise) => {
    ...
    request.listDrops = () => requestWithFallback('[{"id":232252,"action":-2010,"item":2,"type":"GUARANTEED","chance":1,"amount":1},{"id":232253,"action":-2011,"item":2,"type":"GUARANTEED","chance":1,"amount":2},{"id":232254,"action":-2012,"item":2,"type":"GUARANTEED","chance":1,"amount":3},{"id":232255,"action":-2013,"item":2,"type":"GUARANTEED","chance":1,"amount":4},{"id":232256,"action":-2014,"item":2,"type":"GUARANTEED","chance":1,"amount":5},{"id":232257,"action":-2015,"item":2,"type":"GUARANTEED","chance":1,"amount":6},{"id":232258,"action":-2016,"item":2,"type":"GUARANTEED","chance":1,"amount":7},{"id":232259,"action":-2017,"item":2,"type":"GUARANTEED","chance":1,"amount":8},{"id":232260,"action":-7300,"item":7,"type":"GUARANTEED","chance":1,"amount":20},{"id":232261,"action":-7301,"item":7,"type":"GUARANTEED","chance":1,"amount":40},{"id":232262,"action":-7302,"item":7,"type":"GUARANTEED","chance":1,"amount":60},{"id":232263,"action":-7303,"item":7,"type":"GUARANTEED","chance":1,"amount":80},{"id":232264,"action":-7304,"item":7,"type":"GUARANTEED","chance":1,"amount":100},{"id":232265,"action":-7323,"item":7,"type":"GUARANTEED","chance":1,"amount":120},{"id":232266,"action":-7324,"item":7,"type":"GUARANTEED","chance":1,"amount":140},{"id":232267,"action":-7347,"item":7,"type":"GUARANTEED","chance":1,"amount":160},{"id":232268,"action":-7400,"item":7,"type":"GUARANTEED","chance":1,"amount":2},{"id":232269,"action":-7405,"item":7,"type":"GUARANTEED","chance":1,"amount":4},{"id":232270,"action":-7406,"item":7,"type":"GUARANTEED","chance":1,"amount":6},{"id":232271,"action":-7407,"item":7,"type":"GUARANTEED","chance":1,"amount":8},{"id":232272,"action":-7408,"item":7,"type":"GUARANTEED","chance":1,"amount":10},{"id":232273,"action":-7409,"item":7,"type":"GUARANTEED","chance":1,"amount":12},{"id":232274,"action":-7410,"item":7,"type":"GUARANTEED","chance":1,"amount":14},{"id":232275,"action":-7411,"item":7,"type":"GUARANTEED","chance":1,"amount":16},{"id":232276,"action":-5030,"item":5,"type":"GUARANTEED","chance":1,"amount":50},{"id":232277,"action":-5031,"item":5,"type":"GUARANTEED","chance":1,"amount":100},{"id":232278,"action":-5032,"item":5,"type":"GUARANTEED","chance":1,"amount":150},{"id":232279,"action":-5033,"item":5,"type":"GUARANTEED","chance":1,"amount":200},{"id":232280,"action":-5034,"item":5,"type":"GUARANTEED","chance":1,"amount":300},{"id":232281,"action":-5035,"item":5,"type":"GUARANTEED","chance":1,"amount":250},{"id":232282,"action":-5036,"item":5,"type":"GUARANTEED","chance":1,"amount":350},{"id":232283,"action":-5037,"item":5,"type":"GUARANTEED","chance":1,"amount":400},{"id":232284,"action":-6305,"item":6,"type":"GUARANTEED","chance":1,"amount":1},{"id":232285,"action":-6308,"item":6,"type":"GUARANTEED","chance":1,"amount":2},{"id":232286,"action":-6311,"item":6,"type":"GUARANTEED","chance":1,"amount":3},{"id":232287,"action":-6314,"item":6,"type":"GUARANTEED","chance":1,"amount":4},{"id":232288,"action":-6317,"item":6,"type":"GUARANTEED","chance":1,"amount":5},{"id":232289,"action":-6320,"item":6,"type":"GUARANTEED","chance":1,"amount":6},{"id":232290,"action":-6325,"item":6,"type":"GUARANTEED","chance":1,"amount":7},{"id":232291,"action":-6342,"item":6,"type":"GUARANTEED","chance":1,"amount":8},{"id":232292,"action":-9100,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232293,"action":-9101,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232294,"action":-9102,"item":9,"type":"GUARANTEED","chance":1,"amount":3},{"id":232295,"action":-9103,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232296,"action":-9104,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232297,"action":-9110,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232298,"action":-9111,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232299,"action":-9112,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232300,"action":-9113,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232301,"action":-9114,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232302,"action":-9120,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232303,"action":-9121,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232304,"action":-9122,"item":9,"type":"GUARANTEED","chance":1,"amount":9},{"id":232305,"action":-9123,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232306,"action":-9124,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232307,"action":-9130,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232308,"action":-9131,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232309,"action":-9132,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232310,"action":-9133,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232311,"action":-9134,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232312,"action":-9140,"item":9,"type":"GUARANTEED","chance":1,"amount":15},{"id":232313,"action":-9141,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232314,"action":-9142,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232315,"action":-9143,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232316,"action":-9144,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232317,"action":-9150,"item":9,"type":"GUARANTEED","chance":1,"amount":18},{"id":232318,"action":-9151,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232319,"action":-9152,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232320,"action":-9153,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232321,"action":-9154,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232322,"action":-9160,"item":9,"type":"GUARANTEED","chance":1,"amount":21},{"id":232323,"action":-9161,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232324,"action":-9162,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232325,"action":-9163,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232326,"action":-9164,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232327,"action":-9170,"item":9,"type":"GUARANTEED","chance":1,"amount":24},{"id":232328,"action":-9171,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232329,"action":-9172,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232330,"action":-9173,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232331,"action":-9174,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232332,"action":-9200,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232333,"action":-9201,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232334,"action":-9202,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232335,"action":-9203,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232336,"action":-9204,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232337,"action":-9205,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232338,"action":-9206,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232339,"action":-9207,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232340,"action":-9208,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232341,"action":-9209,"item":9,"type":"GUARANTEED","chance":1,"amount":2},{"id":232342,"action":-9210,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232343,"action":-9211,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232344,"action":-9212,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232345,"action":-9213,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232346,"action":-9214,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232347,"action":-9215,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232348,"action":-9216,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232349,"action":-9217,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232350,"action":-9218,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232351,"action":-9219,"item":9,"type":"GUARANTEED","chance":1,"amount":4},{"id":232352,"action":-9220,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232353,"action":-9221,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232354,"action":-9222,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232355,"action":-9223,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232356,"action":-9224,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232357,"action":-9225,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232358,"action":-9226,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232359,"action":-9227,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232360,"action":-9228,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232361,"action":-9229,"item":9,"type":"GUARANTEED","chance":1,"amount":6},{"id":232362,"action":-9230,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232363,"action":-9231,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232364,"action":-9232,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232365,"action":-9233,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232366,"action":-9234,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232367,"action":-9235,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232368,"action":-9236,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232369,"action":-9237,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232370,"action":-9238,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232371,"action":-9239,"item":9,"type":"GUARANTEED","chance":1,"amount":8},{"id":232372,"action":-9240,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232373,"action":-9241,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232374,"action":-9242,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232375,"action":-9243,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232376,"action":-9244,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232377,"action":-9245,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232378,"action":-9246,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232379,"action":-9247,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232380,"action":-9248,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232381,"action":-9249,"item":9,"type":"GUARANTEED","chance":1,"amount":10},{"id":232382,"action":-9260,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232383,"action":-9261,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232384,"action":-9262,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232385,"action":-9263,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232386,"action":-9264,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232387,"action":-9265,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232388,"action":-9266,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232389,"action":-9267,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232390,"action":-9268,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232391,"action":-9269,"item":9,"type":"GUARANTEED","chance":1,"amount":12},{"id":232392,"action":-9270,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232393,"action":-9271,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232394,"action":-9272,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232395,"action":-9273,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232396,"action":-9274,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232397,"action":-9275,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232398,"action":-9276,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232399,"action":-9277,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232400,"action":-9278,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232401,"action":-9279,"item":9,"type":"GUARANTEED","chance":1,"amount":14},{"id":232402,"action":-9280,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232403,"action":-9281,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232404,"action":-9282,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232405,"action":-9283,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232406,"action":-9284,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232407,"action":-9285,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232408,"action":-9286,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232409,"action":-9287,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":232410,"action":-9288,"item":9,"type":"GUARANTEED","chance":1,"amount":16},{"id":
amount":1},{"id":298421,"action":748,"item":703,"amount":1},{"id":298422,"action":1020,"item":403,"amount":1},{"id":298423,"action":1022,"item":403,"amount":1},{"id":298424,"action":1023,"item":403,"amount":1},{"id":298425,"action":1024,"item":403,"amount":1},{"id":298426,"action":1025,"item":403,"amount":1},{"id":298427,"action":1030,"item":404,"amount":1},{"id":298428,"action":1030,"item":7,"amount":3},{"id":298429,"action":1031,"item":404,"amount":1},{"id":298430,"action":1031,"item":7,"amount":4},{"id":298431,"action":1032,"item":404,"amount":1},{"id":298432,"action":1032,"item":7,"amount":5},{"id":298433,"action":1033,"item":404,"amount":1},{"id":298434,"action":1033,"item":7,"amount":6},{"id":298435,"action":1034,"item":404,"amount":1},{"id":298436,"action":1034,"item":7,"amount":7},{"id":298437,"action":1035,"item":404,"amount":1},{"id":298438,"action":1035,"item":7,"amount":3},{"id":298439,"action":1036,"item":404,"amount":1},{"id":298440,"action":1036,"item":7,"amount":4},{"id":298441,"action":1037,"item":404,"amount":1},{"id":298442,"action":1037,"item":7,"amount":5},{"id":298443,"action":1038,"item":404,"amount":1},{"id":298444,"action":1038,"item":7,"amount":6},{"id":298445,"action":1039,"item":404,"amount":1},{"id":298446,"action":1039,"item":7,"amount":7},{"id":298447,"action":1040,"item":404,"amount":1},{"id":298448,"action":1040,"item":7,"amount":8},{"id":298449,"action":1041,"item":404,"amount":1},{"id":298450,"action":1041,"item":7,"amount":8},{"id":298451,"action":10201,"item":403,"amount":1}]', 'public/list/ingredient');
    request.listItems = () => requestWithFallback('[{"item":{"id":-2,"name":"Health","image":"","skill":"Defense","tier":0,"attributes":{}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{},"bySkill":{}}},{"item":{"id":1,"name":"Coins","image":"items/coin-stack.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":2,"name":"Charcoal","image":"items/charcoal.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":3,"name":"Stardust","image":"items/stardust.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":4,"name":"Ancient Tome","image":"items/ancient-tome.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":5,"name":"Arcane Powder","image":"items/arcane-powder.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":6,"name":"Pet Snacks","image":"items/pet-snacks.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":7,"name":"Compost","image":"items/compost.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":8,"name":"Pearls","image":"items/pearl.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":9,"name":"Metal Parts","image":"items/metal-parts.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":10,"name":"Pine Log","image":"items/wood-pine.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2,"BUY_PRICE":0}},"charcoal":1,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":11,"name":"Spruce Log","image":"items/wood-spruce.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4,"BUY_PRICE":0}},"charcoal":2,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":12,"name":"Birch Log","image":"items/wood-birch.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6,"BUY_PRICE":0}},"charcoal":3,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":13,"name":"Teak Log","image":"items/wood-teak.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":4,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":14,"name":"Mahogany Log","image":"items/wood-mahogany.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":10,"BUY_PRICE":0}},"charcoal":5,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":15,"name":"Ironbark Log","image":"items/wood-ironbark.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":12,"BUY_PRICE":0}},"charcoal":6,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":16,"name":"Redwood Log","image":"items/wood-redwood.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":7,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":17,"name":"Ancient Log","image":"items/wood-ancient.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":8,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":20,"name":"Copper Ore","image":"items/rock-copper.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":21,"name":"Iron Ore","image":"items/rock-iron.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":22,"name":"Silver Ore","image":"items/rock-silver.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":23,"name":"Gold Ore","image":"items/rock-gold.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":24,"name":"Cobalt Ore","image":"items/rock-cobalt.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":10,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":26,"name":"Obsidian Ore","image":"items/rock-obsidian.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":12,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":27,"name":"Astral Ore","image":"items/rock-astral.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":28,"name":"Infernal Ore","image":"items/rock-infernal.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":30,"name":"Ruby","image":"items/gem-ruby.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":100,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":50,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":31,"name":"Topaz","image":"items/gem-topaz.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":200,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":100,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":32,"name":"Emerald","image":"items/gem-emerald.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":300,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":150,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":33,"name":"Amethyst","image":"items/gem-amethyst.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":400,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":200,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":34,"name":"Diamond","image":"items/gem-diamond.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":600,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":300,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":35,"name":"Citrine","image":"items/gem-citrine.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":500,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":250,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":36,"name":"Moonstone","image":"items/gem-moonstone.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":700,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":350,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":37,"name":"Onyx","image":"items/gem-onyx.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":800,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":400,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":40,"name":"Copper Bar","image":"items/bar-copper.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":41,"name":"Iron Bar","image":"items/bar-iron.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":42,"name":"Silver Bar","image":"items/bar-silver.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":24,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":43,"name":"Gold Bar","image":"items/bar-gold.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":44,"name":"Cobalt Bar","image":"items/bar-cobalt.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":45,"name":"Obsidian Bar","image":"items/bar-obsidian.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":46,"name":"Astral Bar","image":"items/bar-astral.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":56,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":47,"name":"Infernal Bar","image":"items/bar-infernal.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":50,"name":"Mountain Gem","image":"items/relic-ruby.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":51,"name":"Forest Gem","image":"items/relic-emerald.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":52,"name":"Ocean Gem","image":"items/relic-diamond.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":53,"name":"Mountain Scroll","image":"items/relic-scroll.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":54,"name":"Forest Scroll","image":"items/relic-scroll.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":55,"name":"Ocean Scroll","image":"items/relic-scroll.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":56,"name":"Jade Piece","image":"items/idol-jade.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":57,"name":"Stone Piece","image":"items/idol-stone.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":58,"name":"Bone Piece","image":"items/idol-bone.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":60,"name":"Copper Arrow","image":"items/arrow-copper.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":2,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":61,"name":"Iron Arrow","image":"items/arrow-iron.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":4,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":62,"name":"Silver Arrow","image":"items/arrow-silver.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":6,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":63,"name":"Gold Arrow","image":"items/arrow-gold.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":64,"name":"Cobalt Arrow","image":"items/arrow-cobalt.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":10,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":65,"name":"Obsidian Arrow","image":"items/arrow-obsidian.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":12,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":66,"name":"Astral Arrow","image":"items/arrow-astral.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":67,"name":"Infernal Arrow","image":"items/arrow-infernal.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":70,"name":"Ruby Essence","image":"items/essence-ruby.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":71,"name":"Topaz Essence","image":"items/essence-topaz.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":72,"name":"Emerald Essence","image":"items/essence-emerald.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":24,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":73,"name":"Amethyst Essence","image":"items/essence-amethyst.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":74,"name":"Citrine Essence","image":"items/essence-citrine.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":75,"name":"Diamond Essence","image":"items/essence-diamond.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":76,"name":"Moonstone Essence","image":"items/essence-moonstone.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":56,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":77,"name":"Onyx Essence","image":"items/essence-onyx.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":80,"name":"Dungeon Key 25","image":"items/key-emerald.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":216,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":81,"name":"Dungeon Key 40","image":"items/key-amethyst.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":288,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":82,"name":"Dungeon Key 55","image":"items/key-citrine.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":360,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":83,"name":"Dungeon Key 70","image":"items/key-diamond.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":432,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":84,"name":"Dungeon Key 85","image":"items/key-moonstone.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":504,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":85,"name":"Dungeon Key 100","image":"items/key-onyx.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":576,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":100,"name":"Copper Helmet","image":"items/armor-copper-helmet.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ARMOUR":2,"HEALTH":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"HEALTH":6,"ARMOUR":2,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":101,"name":"Copper Boots","image":"items/armor-copper-boots.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ARMOUR":2,"HEALTH":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"HEALTH":6,"ARMOUR":2,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":102,"name":"Copper Body","image":"items/armor-copper-body.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":24,"BUY_PRICE":500,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":3,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":103,"name":"Copper Gloves","image":"items/armor-copper-gloves.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ARMOUR":2,"HEALTH":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"HEALTH":6,"ARMOUR":2,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":104,"name":"Copper Shield","image":"items/armor-copper-shield.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ARMOUR":2,"HEALTH":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"HEALTH":6,"ARMOUR":2,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":110,"name":"Iron Helmet","image":"items/armor-iron-helmet.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":111,"name":"Iron Boots","image":"items/armor-iron-boots.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":112,"name":"Iron Body","image":"items/armor-iron-body.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":113,"name":"Iron Gloves","image":"items/armor-iron-gloves.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":114,"name":"Iron Shield","image":"items/armor-iron-shield.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":120,"name":"Silver Helmet","image":"items/armor-silver-helmet.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":121,"name":"Silver Boots","image":"items/armor-silver-boots.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":122,"name":"Silver Body","image":"items/armor-silver-body.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":72,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":9,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":123,"name":"Silver Gloves","image":"items/armor-silver-gloves.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":124,"name":"Silver Shield","image":"items/armor-silver-shield.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":130,"name":"Gold Helmet","image":"items/armor-gold-helmet.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":131,"name":"Gold Boots","image":"items/armor-gold-boots.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":132,"name":"Gold Body","image":"items/armor-gold-body.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":133,"name":"Gold Gloves","image":"items/armor-gold-gloves.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":134,"name":"Gold Shield","image":"items/armor-gold-shield.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":140,"name":"Cobalt Body","image":"items/armor-cobalt-body.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":120,"BUY_PRICE":0,"ARMOUR":20,"HEALTH":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":15,"stats":{"global":{"HEALTH":60,"ARMOUR":20,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":141,"name":"Cobalt Boots","image":"items/armor-cobalt-boots.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":142,"name":"Cobalt Helmet","image":"items/armor-cobalt-helmet.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":143,"name":"Cobalt Gloves","image":"items/armor-cobalt-gloves.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":144,"name":"Cobalt Shield","image":"items/armor-cobalt-shield.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":150,"name":"Obsidian Body","image":"items/armor-obsidian-body.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":144,"BUY_PRICE":0,"ARMOUR":24,"HEALTH":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":18,"stats":{"global":{"HEALTH":72,"ARMOUR":24,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":151,"name":"Obsidian Boots","image":"items/armor-obsidian-boots.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":152,"name":"Obsidian Helmet","image":"items/armor-obsidian-helmet.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":153,"name":"Obsidian Gloves","image":"items/armor-obsidian-gloves.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":154,"name":"Obsidian Shield","image":"items/armor-obsidian-shield.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":160,"name":"Astral Body","image":"items/armor-astral-body.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":168,"BUY_PRICE":0,"ARMOUR":28,"HEALTH":84}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":21,"stats":{"global":{"HEALTH":84,"ARMOUR":28,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":161,"name":"Astral Boots","image":"items/armor-astral-boots.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":162,"name":"Astral Helmet","image":"items/armor-astral-helmet.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":163,"name":"Astral Gloves","image":"items/armor-astral-gloves.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":164,"name":"Astral Shield","image":"items/armor-astral-shield.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":170,"name":"Infernal Body","image":"items/armor-infernal-body.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":192,"BUY_PRICE":0,"ARMOUR":32,"HEALTH":96}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":24,"stats":{"global":{"HEALTH":96,"ARMOUR":32,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":171,"name":"Infernal Boots","image":"items/armor-infernal-boots.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":172,"name":"Infernal Helmet","image":"items/armor-infernal-helmet.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":173,"name":"Infernal Gloves","image":"items/armor-infernal-gloves.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":174,"name":"Infernal Shield","image":"items/armor-infernal-shield.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":200,"name":"Copper Pickaxe","image":"items/pickaxe-copper.png","skill":"Mining","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"SKILL_SPEED":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":6}}}},{"item":{"id":201,"name":"Copper Hatchet","image":"items/hatchet-copper.png","skill":"Woodcutting","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"SKILL_SPEED":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":6}}}},{"item":{"id":202,"name":"Copper Sword","image":"items/sword-copper.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ATTACK_SPEED":5,"DAMAGE":24,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":6,"DAMAGE":24,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":203,"name":"Copper Hammer","image":"items/hammer-copper.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ATTACK_SPEED":5,"DAMAGE":24,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":6,"DAMAGE":24,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":204,"name":"Copper Rod","image":"items/tool-copper-rod.png","skill":"Fishing","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"SKILL_SPEED":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":6}}}},{"item":{"id":205,"name":"Copper Spade","image":"items/tool-copper-spade.png","skill":"Farming","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"SKILL_SPEED":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":6}}}},{"item":{"id":206,"name":"Copper Bow","image":"items/bow-copper.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":24,"FOREST_DAMAGE":15,"COMBAT_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":6,"DAMAGE":24,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":207,"name":"Copper Spear","image":"items/spear-copper.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":24,"OCEAN_BLOCK":15,"COMBAT_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":6,"DAMAGE":24,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":208,"name":"Copper Scythe","image":"items/scythe-copper.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":24,"OCEAN_DAMAGE":15,"COMBAT_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":6,"DAMAGE":24,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":209,"name":"Copper Boomerang","image":"items/boomerang-copper.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":250,"ATTACK_SPEED":5,"DAMAGE":24,"FOREST_BLOCK":15,"COMBAT_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":2,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":6,"DAMAGE":24,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":210,"name":"Iron Pickaxe","image":"items/pickaxe-iron.png","skill":"Mining","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"SKILL_SPEED":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":12}}}},{"item":{"id":211,"name":"Iron Hatchet","image":"items/hatchet-iron.png","skill":"Woodcutting","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"SKILL_SPEED":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":12}}}},{"item":{"id":212,"name":"Iron Sword","image":"items/sword-iron.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":48,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":213,"name":"Iron Hammer","image":"items/hammer-iron.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":48,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":214,"name":"Iron Rod","image":"items/tool-iron-rod.png","skill":"Fishing","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"SKILL_SPEED":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":12}}}},{"item":{"id":215,"name":"Iron Spade","image":"items/tool-iron-spade.png","skill":"Farming","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"SKILL_SPEED":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":12}}}},{"item":{"id":216,"name":"Iron Bow","image":"items/bow-iron.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":48,"FOREST_DAMAGE":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":217,"name":"Iron Spear","image":"items/spear-iron.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":48,"OCEAN_BLOCK":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":218,"name":"Iron Scythe","image":"items/scythe-iron.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":48,"OCEAN_DAMAGE":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":219,"name":"Iron Boomerang","image":"items/boomerang-iron.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":48,"FOREST_BLOCK":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":4,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":220,"name":"Silver Pickaxe","image":"items/pickaxe-silver.png","skill":"Mining","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"SKILL_SPEED":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":18}}}},{"item":{"id":221,"name":"Silver Hatchet","image":"items/hatchet-silver.png","skill":"Woodcutting","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"SKILL_SPEED":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":18}}}},{"item":{"id":222,"name":"Silver Sword","image":"items/sword-silver.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":72,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":223,"name":"Silver Hammer","image":"items/hammer-silver.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":72,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":224,"name":"Silver Rod","image":"items/tool-silver-rod.png","skill":"Fishing","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"SKILL_SPEED":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":18}}}},{"item":{"id":225,"name":"Silver Spade","image":"items/tool-silver-spade.png","skill":"Farming","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"SKILL_SPEED":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":18}}}},{"item":{"id":226,"name":"Silver Bow","image":"items/bow-silver.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":72,"FOREST_DAMAGE":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":227,"name":"Silver Spear","image":"items/spear-silver.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":72,"OCEAN_BLOCK":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":228,"name":"Silver Scythe","image":"items/scythe-silver.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":72,"OCEAN_DAMAGE":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":229,"name":"Silver Boomerang","image":"items/boomerang-silver.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":48,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":72,"FOREST_BLOCK":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":6,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":230,"name":"Gold Pickaxe","image":"items/pickaxe-gold.png","skill":"Mining","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"SKILL_SPEED":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":24}}}},{"item":{"id":231,"name":"Gold Hatchet","image":"items/hatchet-gold.png","skill":"Woodcutting","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"SKILL_SPEED":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":24}}}},{"item":{"id":232,"name":"Gold Sword","image":"items/sword-gold.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":96,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":233,"name":"Gold Hammer","image":"items/hammer-gold.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":96,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":234,"name":"Gold Rod","image":"items/tool-gold-rod.png","skill":"Fishing","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"SKILL_SPEED":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":24}}}},{"item":{"id":235,"name":"Gold Spade","image":"items/tool-gold-spade.png","skill":"Farming","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"SKILL_SPEED":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":24}}}},{"item":{"id":236,"name":"Gold Bow","image":"items/bow-gold.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":96,"FOREST_DAMAGE":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":237,"name":"Gold Spear","image":"items/spear-gold.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":96,"OCEAN_BLOCK":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":238,"name":"Gold Scythe","image":"items/scythe-gold.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":96,"OCEAN_DAMAGE":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":239,"name":"Gold Boomerang","image":"items/boomerang-gold.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":96,"FOREST_BLOCK":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":8,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":240,"name":"Cobalt Pickaxe","image":"items/pickaxe-cobalt.png","skill":"Mining","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"SKILL_SPEED":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":30}}}},{"item":{"id":241,"name":"Cobalt Hatchet","image":"items/hatchet-cobalt.png","skill":"Woodcutting","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"SKILL_SPEED":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":30}}}},{"item":{"id":242,"name":"Cobalt Sword","image":"items/sword-cobalt.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":120,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":243,"name":"Cobalt Hammer","image":"items/hammer-cobalt.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":120,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":244,"name":"Cobalt Rod","image":"items/tool-cobalt-rod.png","skill":"Fishing","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"SKILL_SPEED":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":30}}}},{"item":{"id":245,"name":"Cobalt Spade","image":"items/tool-cobalt-spade.png","skill":"Farming","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"SKILL_SPEED":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":30}}}},{"item":{"id":246,"name":"Cobalt Bow","image":"items/bow-cobalt.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":120,"FOREST_DAMAGE":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":247,"name":"Cobalt Spear","image":"items/spear-cobalt.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":120,"OCEAN_BLOCK":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":248,"name":"Cobalt Scythe","image":"items/scythe-cobalt.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":120,"OCEAN_DAMAGE":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":249,"name":"Cobalt Boomerang","image":"items/boomerang-cobalt.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":80,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":120,"FOREST_BLOCK":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":10,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":260,"name":"Obsidian Pickaxe","image":"items/pickaxe-obsidian.png","skill":"Mining","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"SKILL_SPEED":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":36}}}},{"item":{"id":261,"name":"Obsidian Hatchet","image":"items/hatchet-obsidian.png","skill":"Woodcutting","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"SKILL_SPEED":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":36}}}},{"item":{"id":262,"name":"Obsidian Sword","image":"items/sword-obsidian.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":144,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":263,"name":"Obsidian Hammer","image":"items/hammer-obsidian.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":144,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":264,"name":"Obsidian Rod","image":"items/tool-obsidian-rod.png","skill":"Fishing","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"SKILL_SPEED":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":36}}}},{"item":{"id":265,"name":"Obsidian Spade","image":"items/tool-obsidian-spade.png","skill":"Farming","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"SKILL_SPEED":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":36}}}},{"item":{"id":266,"name":"Obsidian Bow","image":"items/bow-obsidian.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":144,"FOREST_DAMAGE":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":267,"name":"Obsidian Spear","image":"items/spear-obsidian.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":144,"OCEAN_BLOCK":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":268,"name":"Obsidian Scythe","image":"items/scythe-obsidian.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":144,"OCEAN_DAMAGE":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":269,"name":"Obsidian Boomerang","image":"items/boomerang-obsidian.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":144,"FOREST_BLOCK":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":12,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":270,"name":"Astral Pickaxe","image":"items/pickaxe-astral.png","skill":"Mining","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"SKILL_SPEED":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":42}}}},{"item":{"id":271,"name":"Astral Hatchet","image":"items/hatchet-astral.png","skill":"Woodcutting","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"SKILL_SPEED":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":42}}}},{"item":{"id":272,"name":"Astral Sword","image":"items/sword-astral.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":168,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":273,"name":"Astral Hammer","image":"items/hammer-astral.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":168,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":274,"name":"Astral Rod","image":"items/tool-astral-rod.png","skill":"Fishing","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"SKILL_SPEED":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":42}}}},{"item":{"id":275,"name":"Astral Spade","image":"items/tool-astral-spade.png","skill":"Farming","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"SKILL_SPEED":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":42}}}},{"item":{"id":276,"name":"Astral Bow","image":"items/bow-astral.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":168,"FOREST_DAMAGE":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":277,"name":"Astral Spear","image":"items/spear-astral.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":168,"OCEAN_BLOCK":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":278,"name":"Astral Scythe","image":"items/scythe-astral.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":168,"OCEAN_DAMAGE":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":279,"name":"Astral Boomerang","image":"items/boomerang-astral.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":112,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":168,"FOREST_BLOCK":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":14,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":280,"name":"Infernal Pickaxe","image":"items/pickaxe-infernal.png","skill":"Mining","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"SKILL_SPEED":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":48}}}},{"item":{"id":281,"name":"Infernal Hatchet","image":"items/hatchet-infernal.png","skill":"Woodcutting","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"SKILL_SPEED":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":48}}}},{"item":{"id":282,"name":"Infernal Sword","image":"items/sword-infernal.png","skill":"OneHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":192,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":283,"name":"Infernal Hammer","image":"items/hammer-infernal.png","skill":"OneHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":192,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":284,"name":"Infernal Rod","image":"items/tool-infernal-rod.png","skill":"Fishing","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"SKILL_SPEED":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":48}}}},{"item":{"id":285,"name":"Infernal Spade","image":"items/tool-infernal-spade.png","skill":"Farming","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"SKILL_SPEED":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":48}}}},{"item":{"id":286,"name":"Infernal Bow","image":"items/bow-infernal.png","skill":"Ranged","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":192,"FOREST_DAMAGE":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":287,"name":"Infernal Spear","image":"items/spear-infernal.png","skill":"TwoHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":192,"OCEAN_BLOCK":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":288,"name":"Infernal Scythe","image":"items/scythe-infernal.png","skill":"TwoHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":192,"OCEAN_DAMAGE":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":289,"name":"Infernal Boomerang","image":"items/boomerang-infernal.png","skill":"Ranged","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":192,"FOREST_BLOCK":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":16,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":300,"name":"Apple","image":"items/food-apple.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4,"BUY_PRICE":0}},"charcoal":0,"compost":20,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":301,"name":"Grapes","image":"items/food-grapes.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":40,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":302,"name":"Cherry","image":"items/food-cherry.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":12,"BUY_PRICE":0}},"charcoal":0,"compost":60,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":303,"name":"Green Apple","image":"items/food-green-apple.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":0,"compost":80,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":304,"name":"Blackcurrant","image":"items/food-blackcurrant.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":20,"BUY_PRICE":0}},"charcoal":0,"compost":100,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":305,"name":"Raw Shrimp","image":"items/raw-shrimp.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":1,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":306,"name":"Cooked Shrimp","image":"items/food-cooked-shrimp.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":10,"BUY_PRICE":0,"HEAL":20}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":20,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":307,"name":"Burnt Shrimp","image":"items/burnt-shrimp.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":2,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":308,"name":"Raw Cod","image":"items/raw-cod.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":2,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":309,"name":"Cooked Cod","image":"items/food-cooked-cod.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":18,"BUY_PRICE":0,"HEAL":40}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":40,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":310,"name":"Burnt Cod","image":"items/burnt-cod.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":4,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":311,"name":"Raw Salmon","image":"items/raw-salmon.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":3,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":312,"name":"Cooked Salmon","image":"items/food-cooked-salmon.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":26,"BUY_PRICE":0,"HEAL":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":60,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":313,"name":"Burnt Salmon","image":"items/burnt-salmon.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":6,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":314,"name":"Raw Bass","image":"items/raw-bass.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":10,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":4,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":315,"name":"Cooked Bass","image":"items/food-cooked-bass.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":34,"BUY_PRICE":0,"HEAL":80}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":80,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":316,"name":"Burnt Bass","image":"items/burnt-bass.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":317,"name":"Raw Lobster","image":"items/raw-lobster.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":12,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":5,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":318,"name":"Cooked Lobster","image":"items/food-cooked-lobster.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":42,"BUY_PRICE":0,"HEAL":100}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":100,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":319,"name":"Burnt Lobster","image":"items/burnt-lobster.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":10,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":320,"name":"Raw Swordfish","image":"items/raw-swordfish.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":6,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":321,"name":"Cooked Swordfish","image":"items/food-cooked-swordfish.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":50,"BUY_PRICE":0,"HEAL":120}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":120,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":322,"name":"Burnt Swordfish","image":"items/burnt-swordfish.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":12,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":323,"name":"Raspberry","image":"items/food-raspberry.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":24,"BUY_PRICE":0}},"charcoal":0,"compost":120,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":324,"name":"Blueberry","image":"items/food-blueberry.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28,"BUY_PRICE":0}},"charcoal":0,"compost":140,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":325,"name":"Raw Shark","image":"items/raw-shark.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":7,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":326,"name":"Cooked Shark","image":"items/food-cooked-shark.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":58,"BUY_PRICE":0,"HEAL":140}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":140,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":327,"name":"Burnt Shark","image":"items/burnt-shark.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":328,"name":"Shrimp Pie","image":"items/pie-shrimp.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":0,"HEAL":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":30,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":329,"name":"Cod Pie","image":"items/pie-cod.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28,"BUY_PRICE":0,"HEAL":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":60,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":330,"name":"Salmon Pie","image":"items/pie-salmon.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40,"BUY_PRICE":0,"HEAL":90}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":90,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":331,"name":"Bass Pie","image":"items/pie-bass.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":52,"BUY_PRICE":0,"HEAL":120}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":120,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":332,"name":"Lobster Pie","image":"items/pie-lobster.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64,"BUY_PRICE":0,"HEAL":150}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":150,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":333,"name":"Swordfish Pie","image":"items/pie-swordfish.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":76,"BUY_PRICE":0,"HEAL":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":180,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":334,"name":"Shark Pie","image":"items/pie-shark.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88,"BUY_PRICE":0,"HEAL":210}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":210,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":335,"name":"Burnt Shrimp Pie","image":"items/pie-burnt-shrimp.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":336,"name":"Burnt Cod Pie","image":"items/pie-burnt-cod.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":337,"name":"Burnt Salmon Pie","image":"items/pie-burnt-salmon.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":20,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":338,"name":"Burnt Bass Pie","image":"items/pie-burnt-bass.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":26,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":339,"name":"Burnt Lobster Pie","image":"items/pie-burnt-lobster.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":32,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":340,"name":"Burnt Swordfish Pie","image":"items/pie-burnt-swordfish.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":38,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":341,"name":"Burnt Shark Pie","image":"items/pie-burnt-shark.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":44,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":342,"name":"Raw King Crab","image":"items/raw-king-crab.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":18,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":8,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":343,"name":"Cooked King Crab","image":"items/food-cooked-king-crab.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":66,"BUY_PRICE":0,"HEAL":160}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":160,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":344,"name":"Burnt King Crab","image":"items/burnt-king-crab.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":345,"name":"King Crab Pie","image":"items/pie-king-crab.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":100,"BUY_PRICE":0,"HEAL":240}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":240,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":346,"name":"Burnt King Crab Pie","image":"items/pie-burnt-king-crab.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":50,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":347,"name":"Banana","image":"items/food-banana.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0}},"charcoal":0,"compost":160,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":350,"name":"Peony","image":"items/flower-peony.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":351,"name":"Tulip","image":"items/flower-tulip.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":10,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":352,"name":"Rose","image":"items/flower-rose.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":353,"name":"Daisy","image":"items/flower-daisy.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":18,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":354,"name":"Lilac","image":"items/flower-lilac.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":22,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":355,"name":"Hyacinth","image":"items/flower-hyacinth.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":26,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":356,"name":"Nemesia","image":"items/flower-nemesia.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":30,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":357,"name":"Snapdragon","image":"items/flower-snapdragon.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":34,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":360,"name":"Potato","image":"items/food-potato.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":361,"name":"Radish","image":"items/food-radish.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":10,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":362,"name":"Onion","image":"items/food-onion.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":363,"name":"Carrot","image":"items/food-carrot.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":18,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":364,"name":"Tomato","image":"items/food-tomato.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":22,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":365,"name":"Corn","image":"items/food-corn.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":26,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":366,"name":"Pumpkin","image":"items/food-pumpkin.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":30,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":367,"name":"Chilli","image":"items/food-chilli.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":34,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":400,"name":"Bone","image":"items/bone.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2,"BUY_PRICE":0}},"charcoal":0,"compost":2,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":401,"name":"Clam","image":"items/clam.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":2,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":402,"name":"Starfish","image":"items/starfish.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":2,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":403,"name":"Fishing Bait","image":"items/fishing-bait.png","skill":"Fishing","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":404,"name":"Seeds","image":"items/seeds.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":405,"name":"Fang","image":"items/fang.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4,"BUY_PRICE":0}},"charcoal":0,"compost":4,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":406,"name":"Medium Bone","image":"items/medium-bone.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6,"BUY_PRICE":0}},"charcoal":0,"compost":6,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":407,"name":"Medium Fang","image":"items/medium-fang.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8,"BUY_PRICE":0}},"charcoal":0,"compost":8,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":408,"name":"Large Bone","image":"items/large-bone.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":10,"BUY_PRICE":0}},"charcoal":0,"compost":10,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":409,"name":"Large Fang","image":"items/large-fang.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":12,"BUY_PRICE":0}},"charcoal":0,"compost":12,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":410,"name":"Giant Bone","image":"items/giant-bone.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":14,"BUY_PRICE":0}},"charcoal":0,"compost":14,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":411,"name":"Giant Fang","image":"items/giant-fang.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16,"BUY_PRICE":0}},"charcoal":0,"compost":16,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":502,"name":"Silver Dagger","image":"items/dagger-silver.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"DUNGEON_DAMAGE":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_DAMAGE":1,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":503,"name":"Gold Dagger","image":"items/dagger-gold.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"DUNGEON_DAMAGE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_DAMAGE":2,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":504,"name":"Cobalt Dagger","image":"items/dagger-cobalt.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"DUNGEON_DAMAGE":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_DAMAGE":3,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":505,"name":"Obsidian Dagger","image":"items/dagger-obsidian.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"DUNGEON_DAMAGE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_DAMAGE":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":506,"name":"Astral Dagger","image":"items/dagger-astral.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"DUNGEON_DAMAGE":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_DAMAGE":5,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":507,"name":"Infernal Dagger","image":"items/dagger-infernal.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"DUNGEON_DAMAGE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_DAMAGE":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":508,"name":"Perfect Infernal Dagger","image":"items/dagger-infernal.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"DUNGEON_DAMAGE":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_DAMAGE":7,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":510,"name":"Petty Mountain Block Rune","image":"items/rune-petty-block.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"MOUNTAIN_BLOCK":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":1,"Smelting":1,"Smithing":1,"OneHanded":1,"Defense":1}}}},{"item":{"id":511,"name":"Petty Forest Block Rune","image":"items/rune-petty-crit.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"FOREST_BLOCK":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":1,"Alchemy":1,"Woodcutting":1,"Defense":1,"Farming":1}}}},{"item":{"id":512,"name":"Petty Ocean Block Rune","image":"items/rune-petty-parry.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"OCEAN_BLOCK":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":1,"Enchanting":1,"Cooking":1,"Fishing":1,"Defense":1}}}},{"item":{"id":513,"name":"Petty Ocean Damage Rune","image":"items/rune-petty-bleed.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"OCEAN_DAMAGE":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":1,"Enchanting":1,"Cooking":1,"Fishing":1,"Defense":1}}}},{"item":{"id":514,"name":"Petty Mountain Damage Rune","image":"items/rune-petty-stun.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"MOUNTAIN_DAMAGE":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":1,"Smelting":1,"Smithing":1,"OneHanded":1,"Defense":1}}}},{"item":{"id":515,"name":"Petty Forest Damage Rune","image":"items/rune-petty-damage.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"FOREST_DAMAGE":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":1,"Alchemy":1,"Woodcutting":1,"Defense":1,"Farming":1}}}},{"item":{"id":516,"name":"Petty Woodcutting Rune","image":"items/rune-petty-gathering.png","skill":"Woodcutting","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Woodcutting":1}}}},{"item":{"id":517,"name":"Petty Fishing Rune","image":"items/rune-petty-gathering.png","skill":"Fishing","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Fishing":1}}}},{"item":{"id":518,"name":"Petty Mining Rune","image":"items/rune-petty-gathering.png","skill":"Mining","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Mining":1}}}},{"item":{"id":519,"name":"Petty Farming Rune","image":"items/rune-petty-gathering.png","skill":"Farming","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Farming":1}}}},{"item":{"id":520,"name":"Lesser Mountain Block Rune","image":"items/rune-lesser-block.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"MOUNTAIN_BLOCK":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":2,"Smelting":2,"Smithing":2,"OneHanded":2,"Defense":2}}}},{"item":{"id":521,"name":"Lesser Forest Block Rune","image":"items/rune-lesser-crit.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"FOREST_BLOCK":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":2,"Alchemy":2,"Woodcutting":2,"Defense":2,"Farming":2}}}},{"item":{"id":522,"name":"Lesser Ocean Block Rune","image":"items/rune-lesser-parry.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"OCEAN_BLOCK":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":2,"Enchanting":2,"Cooking":2,"Fishing":2,"Defense":2}}}},{"item":{"id":523,"name":"Lesser Ocean Damage Rune","image":"items/rune-lesser-bleed.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"OCEAN_DAMAGE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":2,"Enchanting":2,"Cooking":2,"Fishing":2,"Defense":2}}}},{"item":{"id":524,"name":"Lesser Mountain Damage Rune","image":"items/rune-lesser-stun.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"MOUNTAIN_DAMAGE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":2,"Smelting":2,"Smithing":2,"OneHanded":2,"Defense":2}}}},{"item":{"id":525,"name":"Lesser Forest Damage Rune","image":"items/rune-lesser-damage.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"FOREST_DAMAGE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":2,"Alchemy":2,"Woodcutting":2,"Defense":2,"Farming":2}}}},{"item":{"id":526,"name":"Lesser Woodcutting Rune","image":"items/rune-lesser-gathering.png","skill":"Woodcutting","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Woodcutting":2}}}},{"item":{"id":527,"name":"Lesser Fishing Rune","image":"items/rune-lesser-gathering.png","skill":"Fishing","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Fishing":2}}}},{"item":{"id":528,"name":"Lesser Mining Rune","image":"items/rune-lesser-gathering.png","skill":"Mining","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Mining":2}}}},{"item":{"id":529,"name":"Lesser Farming Rune","image":"items/rune-lesser-gathering.png","skill":"Farming","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Farming":2}}}},{"item":{"id":530,"name":"Common Mountain Block Rune","image":"items/rune-common-block.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"MOUNTAIN_BLOCK":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":3,"Smelting":3,"Smithing":3,"OneHanded":3,"Defense":3}}}},{"item":{"id":531,"name":"Common Forest Block Rune","image":"items/rune-common-crit.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"FOREST_BLOCK":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":3,"Alchemy":3,"Woodcutting":3,"Defense":3,"Farming":3}}}},{"item":{"id":532,"name":"Common Ocean Block Rune","image":"items/rune-common-parry.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"OCEAN_BLOCK":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":3,"Enchanting":3,"Cooking":3,"Fishing":3,"Defense":3}}}},{"item":{"id":533,"name":"Common Ocean Damage Rune","image":"items/rune-common-bleed.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"OCEAN_DAMAGE":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":3,"Enchanting":3,"Cooking":3,"Fishing":3,"Defense":3}}}},{"item":{"id":534,"name":"Common Mountain Damage Rune","image":"items/rune-common-stun.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"MOUNTAIN_DAMAGE":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":3,"Smelting":3,"Smithing":3,"OneHanded":3,"Defense":3}}}},{"item":{"id":535,"name":"Common Forest Damage Rune","image":"items/rune-common-damage.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"FOREST_DAMAGE":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":3,"Alchemy":3,"Woodcutting":3,"Defense":3,"Farming":3}}}},{"item":{"id":536,"name":"Common Woodcutting Rune","image":"items/rune-common-gathering.png","skill":"Woodcutting","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Woodcutting":3}}}},{"item":{"id":537,"name":"Common Fishing Rune","image":"items/rune-common-gathering.png","skill":"Fishing","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Fishing":3}}}},{"item":{"id":538,"name":"Common Mining Rune","image":"items/rune-common-gathering.png","skill":"Mining","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Mining":3}}}},{"item":{"id":539,"name":"Common Farming Rune","image":"items/rune-common-gathering.png","skill":"Farming","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Farming":3}}}},{"item":{"id":540,"name":"Uncommon Mountain Block Rune","image":"items/rune-uncommon-block.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"MOUNTAIN_BLOCK":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":4,"Smelting":4,"Smithing":4,"OneHanded":4,"Defense":4}}}},{"item":{"id":541,"name":"Uncommon Forest Block Rune","image":"items/rune-uncommon-crit.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"FOREST_BLOCK":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":4,"Alchemy":4,"Woodcutting":4,"Defense":4,"Farming":4}}}},{"item":{"id":542,"name":"Uncommon Ocean Block Rune","image":"items/rune-uncommon-parry.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"OCEAN_BLOCK":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":4,"Enchanting":4,"Cooking":4,"Fishing":4,"Defense":4}}}},{"item":{"id":543,"name":"Uncommon Ocean Damage Rune","image":"items/rune-uncommon-bleed.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"OCEAN_DAMAGE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":4,"Enchanting":4,"Cooking":4,"Fishing":4,"Defense":4}}}},{"item":{"id":544,"name":"Uncommon Mountain Damage Rune","image":"items/rune-uncommon-stun.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"MOUNTAIN_DAMAGE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":4,"Smelting":4,"Smithing":4,"OneHanded":4,"Defense":4}}}},{"item":{"id":545,"name":"Uncommon Forest Damage Rune","image":"items/rune-uncommon-damage.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"FOREST_DAMAGE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":4,"Alchemy":4,"Woodcutting":4,"Defense":4,"Farming":4}}}},{"item":{"id":546,"name":"Uncommon Woodcutting Rune","image":"items/rune-uncommon-gathering.png","skill":"Woodcutting","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Woodcutting":4}}}},{"item":{"id":547,"name":"Uncommon Fishing Rune","image":"items/rune-uncommon-gathering.png","skill":"Fishing","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Fishing":4}}}},{"item":{"id":548,"name":"Uncommon Mining Rune","image":"items/rune-uncommon-gathering.png","skill":"Mining","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Mining":4}}}},{"item":{"id":549,"name":"Uncommon Farming Rune","image":"items/rune-uncommon-gathering.png","skill":"Farming","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Farming":4}}}},{"item":{"id":550,"name":"Greater Mountain Block Rune","image":"items/rune-greater-block.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"MOUNTAIN_BLOCK":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":5,"Smelting":5,"Smithing":5,"OneHanded":5,"Defense":5}}}},{"item":{"id":551,"name":"Greater Forest Block Rune","image":"items/rune-greater-crit.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"FOREST_BLOCK":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":5,"Alchemy":5,"Woodcutting":5,"Defense":5,"Farming":5}}}},{"item":{"id":552,"name":"Greater Ocean Block Rune","image":"items/rune-greater-parry.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"OCEAN_BLOCK":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":5,"Enchanting":5,"Cooking":5,"Fishing":5,"Defense":5}}}},{"item":{"id":553,"name":"Greater Ocean Damage Rune","image":"items/rune-greater-bleed.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"OCEAN_DAMAGE":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":5,"Enchanting":5,"Cooking":5,"Fishing":5,"Defense":5}}}},{"item":{"id":554,"name":"Greater Mountain Damage Rune","image":"items/rune-greater-stun.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"MOUNTAIN_DAMAGE":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":5,"Smelting":5,"Smithing":5,"OneHanded":5,"Defense":5}}}},{"item":{"id":555,"name":"Greater Forest Damage Rune","image":"items/rune-greater-damage.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"FOREST_DAMAGE":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":5,"Alchemy":5,"Woodcutting":5,"Defense":5,"Farming":5}}}},{"item":{"id":556,"name":"Greater Woodcutting Rune","image":"items/rune-greater-gathering.png","skill":"Woodcutting","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Woodcutting":5}}}},{"item":{"id":557,"name":"Greater Fishing Rune","image":"items/rune-greater-gathering.png","skill":"Fishing","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Fishing":5}}}},{"item":{"id":558,"name":"Greater Mining Rune","image":"items/rune-greater-gathering.png","skill":"Mining","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Mining":5}}}},{"item":{"id":559,"name":"Greater Farming Rune","image":"items/rune-greater-gathering.png","skill":"Farming","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Farming":5}}}},{"item":{"id":560,"name":"Petty One-handed Rune","image":"items/rune-petty-combat.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"OneHanded":1}}}},{"item":{"id":561,"name":"Petty Two-handed Rune","image":"items/rune-petty-combat.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"TwoHanded":1}}}},{"item":{"id":562,"name":"Petty Ranged Rune","image":"items/rune-petty-combat.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Ranged":1}}}},{"item":{"id":563,"name":"Petty Defense Rune","image":"items/rune-petty-combat.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Defense":1}}}},{"item":{"id":564,"name":"Lesser One-handed Rune","image":"items/rune-lesser-combat.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"OneHanded":2}}}},{"item":{"id":565,"name":"Lesser Two-handed Rune","image":"items/rune-lesser-combat.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"TwoHanded":2}}}},{"item":{"id":566,"name":"Lesser Ranged Rune","image":"items/rune-lesser-combat.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Ranged":2}}}},{"item":{"id":567,"name":"Lesser Defense Rune","image":"items/rune-lesser-combat.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Defense":2}}}},{"item":{"id":568,"name":"Common One-handed Rune","image":"items/rune-common-combat.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"OneHanded":3}}}},{"item":{"id":569,"name":"Common Two-handed Rune","image":"items/rune-common-combat.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"TwoHanded":3}}}},{"item":{"id":570,"name":"Common Ranged Rune","image":"items/rune-common-combat.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Ranged":3}}}},{"item":{"id":571,"name":"Common Defense Rune","image":"items/rune-common-combat.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Defense":3}}}},{"item":{"id":572,"name":"Uncommon One-handed Rune","image":"items/rune-uncommon-combat.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"OneHanded":4}}}},{"item":{"id":573,"name":"Uncommon Two-handed Rune","image":"items/rune-uncommon-combat.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"TwoHanded":4}}}},{"item":{"id":574,"name":"Uncommon Ranged Rune","image":"items/rune-uncommon-combat.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Ranged":4}}}},{"item":{"id":575,"name":"Uncommon Defense Rune","image":"items/rune-uncommon-combat.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Defense":4}}}},{"item":{"id":576,"name":"Greater One-handed Rune","image":"items/rune-greater-combat.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"OneHanded":5}}}},{"item":{"id":577,"name":"Greater Two-handed Rune","image":"items/rune-greater-combat.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"TwoHanded":5}}}},{"item":{"id":578,"name":"Greater Ranged Rune","image":"items/rune-greater-combat.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Ranged":5}}}},{"item":{"id":579,"name":"Greater Defense Rune","image":"items/rune-greater-combat.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Defense":5}}}},{"item":{"id":580,"name":"Grand Mountain Block Rune","image":"items/rune-grand-block.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"MOUNTAIN_BLOCK":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":6,"Smelting":6,"Smithing":6,"OneHanded":6,"Defense":6}}}},{"item":{"id":581,"name":"Grand Forest Block Rune","image":"items/rune-grand-crit.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"FOREST_BLOCK":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":6,"Alchemy":6,"Woodcutting":6,"Defense":6,"Farming":6}}}},{"item":{"id":582,"name":"Grand Ocean Block Rune","image":"items/rune-grand-parry.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"OCEAN_BLOCK":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":6,"Enchanting":6,"Cooking":6,"Fishing":6,"Defense":6}}}},{"item":{"id":583,"name":"Grand Ocean Damage Rune","image":"items/rune-grand-bleed.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"OCEAN_DAMAGE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":6,"Enchanting":6,"Cooking":6,"Fishing":6,"Defense":6}}}},{"item":{"id":584,"name":"Grand Mountain Damage Rune","image":"items/rune-grand-stun.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"MOUNTAIN_DAMAGE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":6,"Smelting":6,"Smithing":6,"OneHanded":6,"Defense":6}}}},{"item":{"id":585,"name":"Grand Forest Damage Rune","image":"items/rune-grand-damage.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"FOREST_DAMAGE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":6,"Alchemy":6,"Woodcutting":6,"Defense":6,"Farming":6}}}},{"item":{"id":586,"name":"Grand Woodcutting Rune","image":"items/rune-grand-gathering.png","skill":"Woodcutting","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Woodcutting":6}}}},{"item":{"id":587,"name":"Grand Fishing Rune","image":"items/rune-grand-gathering.png","skill":"Fishing","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Fishing":6}}}},{"item":{"id":588,"name":"Grand Mining Rune","image":"items/rune-grand-gathering.png","skill":"Mining","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Mining":6}}}},{"item":{"id":589,"name":"Grand Farming Rune","image":"items/rune-grand-gathering.png","skill":"Farming","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Farming":6}}}},{"item":{"id":590,"name":"Grand One-handed Rune","image":"items/rune-grand-combat.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"OneHanded":6}}}},{"item":{"id":591,"name":"Grand Two-handed Rune","image":"items/rune-grand-combat.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"TwoHanded":6}}}},{"item":{"id":592,"name":"Grand Ranged Rune","image":"items/rune-grand-combat.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Ranged":6}}}},{"item":{"id":593,"name":"Grand Defense Rune","image":"items/rune-grand-combat.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Defense":6}}}},{"item":{"id":594,"name":"Supreme Mountain Block Rune","image":"items/rune-supreme-block.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"MOUNTAIN_BLOCK":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":7,"Smelting":7,"Smithing":7,"OneHanded":7,"Defense":7}}}},{"item":{"id":595,"name":"Supreme Forest Block Rune","image":"items/rune-supreme-crit.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"FOREST_BLOCK":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":7,"Alchemy":7,"Woodcutting":7,"Defense":7,"Farming":7}}}},{"item":{"id":596,"name":"Supreme Ocean Block Rune","image":"items/rune-supreme-parry.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"OCEAN_BLOCK":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":7,"Enchanting":7,"Cooking":7,"Fishing":7,"Defense":7}}}},{"item":{"id":597,"name":"Supreme Ocean Damage Rune","image":"items/rune-supreme-bleed.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"OCEAN_DAMAGE":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":7,"Enchanting":7,"Cooking":7,"Fishing":7,"Defense":7}}}},{"item":{"id":598,"name":"Supreme Mountain Damage Rune","image":"items/rune-supreme-stun.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"MOUNTAIN_DAMAGE":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":7,"Smelting":7,"Smithing":7,"OneHanded":7,"Defense":7}}}},{"item":{"id":599,"name":"Supreme Forest Damage Rune","image":"items/rune-supreme-damage.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"FOREST_DAMAGE":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":7,"Alchemy":7,"Woodcutting":7,"Defense":7,"Farming":7}}}},{"item":{"id":600,"name":"Supreme Woodcutting Rune","image":"items/rune-supreme-gathering.png","skill":"Woodcutting","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Woodcutting":7}}}},{"item":{"id":601,"name":"Supreme Fishing Rune","image":"items/rune-supreme-gathering.png","skill":"Fishing","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Fishing":7}}}},{"item":{"id":602,"name":"Supreme Mining Rune","image":"items/rune-supreme-gathering.png","skill":"Mining","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Mining":7}}}},{"item":{"id":603,"name":"Supreme Farming Rune","image":"items/rune-supreme-gathering.png","skill":"Farming","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Farming":7}}}},{"item":{"id":604,"name":"Supreme One-handed Rune","image":"items/rune-supreme-combat.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":192000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"OneHanded":7}}}},{"item":{"id":605,"name":"Supreme Two-handed Rune","image":"items/rune-supreme-combat.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":192000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"TwoHanded":7}}}},{"item":{"id":606,"name":"Supreme Ranged Rune","image":"items/rune-supreme-combat.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":192000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Ranged":7}}}},{"item":{"id":607,"name":"Supreme Defense Rune","image":"items/rune-supreme-combat.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":192000,"BUY_PRICE":0,"SPECIFIC_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"Defense":7}}}},{"item":{"id":610,"name":"Smelter Blueprint 1","image":"items/blueprint.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":611,"name":"Smelter Blueprint 2","image":"items/blueprint.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":612,"name":"Smelter Blueprint 3","image":"items/blueprint.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":613,"name":"Smelter Blueprint 4","image":"items/blueprint.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":614,"name":"Smelter Blueprint 5","image":"items/blueprint.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":615,"name":"Smelter Blueprint 6","image":"items/blueprint.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":620,"name":"Spit Roast Blueprint 1","image":"items/blueprint.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":621,"name":"Spit Roast Blueprint 2","image":"items/blueprint.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":622,"name":"Spit Roast Blueprint 3","image":"items/blueprint.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":623,"name":"Spit Roast Blueprint 4","image":"items/blueprint.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":624,"name":"Spit Roast Blueprint 5","image":"items/blueprint.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":625,"name":"Spit Roast Blueprint 6","image":"items/blueprint.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":630,"name":"Cauldron Blueprint 1","image":"items/blueprint.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":631,"name":"Cauldron Blueprint 2","image":"items/blueprint.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":632,"name":"Cauldron Blueprint 3","image":"items/blueprint.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":633,"name":"Cauldron Blueprint 4","image":"items/blueprint.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":634,"name":"Cauldron Blueprint 5","image":"items/blueprint.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":635,"name":"Cauldron Blueprint 6","image":"items/blueprint.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":640,"name":"Kiln Blueprint 1","image":"items/blueprint.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":641,"name":"Kiln Blueprint 2","image":"items/blueprint.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":642,"name":"Kiln Blueprint 3","image":"items/blueprint.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":643,"name":"Kiln Blueprint 4","image":"items/blueprint.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":644,"name":"Kiln Blueprint 5","image":"items/blueprint.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":645,"name":"Kiln Blueprint 6","image":"items/blueprint.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"LEVEL":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":703,"name":"Vial","image":"items/vial.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":710,"name":"Health Potion","image":"items/potion-health.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":42,"BUY_PRICE":0,"HEALTH_PERCENT":6,"FOOD_EFFECT":6,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH_PERCENT":6,"FOOD_EFFECT":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":711,"name":"Gather XP Potion","image":"items/potion-gather-efficiency.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":62,"BUY_PRICE":0,"DURATION":180,"DOUBLE_GATHER_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":12,"Woodcutting":12,"Fishing":12,"Farming":12}}}},{"item":{"id":712,"name":"Craft XP Potion","image":"items/potion-craft-efficiency.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":62,"BUY_PRICE":0,"DURATION":180,"DOUBLE_CRAFT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":12,"Cooking":12,"Alchemy":12,"Smelting":12,"Smithing":12}}}},{"item":{"id":713,"name":"Gather Level Potion","image":"items/potion-gather-level.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":42,"BUY_PRICE":0,"BONUS_LEVEL":3,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BONUS_LEVEL":{"Mining":3,"Woodcutting":3,"Fishing":3,"Farming":3}}}},{"item":{"id":714,"name":"Craft Level Potion","image":"items/potion-craft-level.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":42,"BUY_PRICE":0,"BONUS_LEVEL":3,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BONUS_LEVEL":{"Enchanting":3,"Cooking":3,"Alchemy":3,"Smelting":3,"Smithing":3}}}},{"item":{"id":715,"name":"Combat XP Potion","image":"items/potion-combat-efficiency.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":62,"BUY_PRICE":0,"DURATION":180,"DOUBLE_COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":12,"TwoHanded":12,"OneHanded":12,"Defense":12}}}},{"item":{"id":716,"name":"Combat Loot Potion","image":"items/potion-combat-loot.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":52,"BUY_PRICE":0,"DURATION":180,"DOUBLE_COMBAT_DROP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_DROP_PERCENT":{"Ranged":12,"TwoHanded":12,"OneHanded":12,"Defense":12}}}},{"item":{"id":717,"name":"Multi Craft Potion","image":"items/potion-preservation.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":52,"BUY_PRICE":0,"DURATION":180,"MULTICRAFT":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"MULTICRAFT":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":718,"name":"Gather Yield Potion","image":"items/potion-gather-yield.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":52,"BUY_PRICE":0,"DURATION":180,"DOUBLE_GATHER_DROP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_DROP_PERCENT":{"Mining":12,"Woodcutting":12,"Fishing":12,"Farming":12}}}},{"item":{"id":720,"name":"Super Health Potion","image":"items/potion-super-health.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":62,"BUY_PRICE":0,"HEALTH_PERCENT":9,"FOOD_EFFECT":9,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH_PERCENT":9,"FOOD_EFFECT":9,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":721,"name":"Super Gather XP Potion","image":"items/potion-super-gather-efficiency.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":82,"BUY_PRICE":0,"DURATION":180,"DOUBLE_GATHER_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":18,"Woodcutting":18,"Fishing":18,"Farming":18}}}},{"item":{"id":722,"name":"Super Craft XP Potion","image":"items/potion-super-craft-efficiency.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":82,"BUY_PRICE":0,"DURATION":180,"DOUBLE_CRAFT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":18,"Cooking":18,"Alchemy":18,"Smelting":18,"Smithing":18}}}},{"item":{"id":723,"name":"Super Gather Level Potion","image":"items/potion-super-gather-level.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":62,"BUY_PRICE":0,"BONUS_LEVEL":4,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BONUS_LEVEL":{"Mining":4,"Woodcutting":4,"Fishing":4,"Farming":4}}}},{"item":{"id":724,"name":"Super Craft Level Potion","image":"items/potion-super-craft-level.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":62,"BUY_PRICE":0,"BONUS_LEVEL":4,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BONUS_LEVEL":{"Enchanting":4,"Cooking":4,"Alchemy":4,"Smelting":4,"Smithing":4}}}},{"item":{"id":725,"name":"Super Combat XP Potion","image":"items/potion-super-combat-efficiency.png","skill":null,"tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":82,"BUY_PRICE":0,"DURATION":180,"DOUBLE_COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":18,"TwoHanded":18,"OneHanded":18,"Defense":18}}}},{"item":{"id":726,"name":"Super Combat Loot Potion","image":"items/potion-super-combat-loot.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":72,"BUY_PRICE":0,"DURATION":180,"DOUBLE_COMBAT_DROP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_DROP_PERCENT":{"Ranged":18,"TwoHanded":18,"OneHanded":18,"Defense":18}}}},{"item":{"id":727,"name":"Super Multi Craft Potion","image":"items/potion-super-preservation.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":72,"BUY_PRICE":0,"DURATION":180,"MULTICRAFT":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"MULTICRAFT":18,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":728,"name":"Super Gather Yield Potion","image":"items/potion-super-gather-yield.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":72,"BUY_PRICE":0,"DURATION":180,"DOUBLE_GATHER_DROP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_DROP_PERCENT":{"Mining":18,"Woodcutting":18,"Fishing":18,"Farming":18}}}},{"item":{"id":740,"name":"Divine Health Potion","image":"items/potion-divine-health.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":176,"BUY_PRICE":0,"HEALTH_PERCENT":12,"FOOD_EFFECT":12,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH_PERCENT":12,"FOOD_EFFECT":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":741,"name":"Divine Gather XP Potion","image":"items/potion-divine-gather-efficiency.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":252,"BUY_PRICE":0,"DURATION":180,"DOUBLE_GATHER_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":24,"Woodcutting":24,"Fishing":24,"Farming":24}}}},{"item":{"id":742,"name":"Divine Craft XP Potion","image":"items/potion-divine-craft-efficiency.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":252,"BUY_PRICE":0,"DURATION":180,"DOUBLE_CRAFT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":24,"Cooking":24,"Alchemy":24,"Smelting":24,"Smithing":24}}}},{"item":{"id":743,"name":"Divine Gather Level Potion","image":"items/potion-divine-gather-level.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":176,"BUY_PRICE":0,"BONUS_LEVEL":5,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BONUS_LEVEL":{"Mining":5,"Woodcutting":5,"Fishing":5,"Farming":5}}}},{"item":{"id":744,"name":"Divine Craft Level Potion","image":"items/potion-divine-craft-level.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":176,"BUY_PRICE":0,"BONUS_LEVEL":5,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BONUS_LEVEL":{"Enchanting":5,"Cooking":5,"Alchemy":5,"Smelting":5,"Smithing":5}}}},{"item":{"id":745,"name":"Divine Combat XP Potion","image":"items/potion-divine-combat-efficiency.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":252,"BUY_PRICE":0,"DURATION":180,"DOUBLE_COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":24,"TwoHanded":24,"OneHanded":24,"Defense":24}}}},{"item":{"id":746,"name":"Divine Combat Loot Potion","image":"items/potion-divine-combat-loot.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":214,"BUY_PRICE":0,"DURATION":180,"DOUBLE_COMBAT_DROP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_DROP_PERCENT":{"Ranged":24,"TwoHanded":24,"OneHanded":24,"Defense":24}}}},{"item":{"id":747,"name":"Divine Multi Craft Potion","image":"items/potion-divine-preservation.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":214,"BUY_PRICE":0,"DURATION":180,"MULTICRAFT":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"MULTICRAFT":24,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":748,"name":"Divine Gather Yield Potion","image":"items/potion-divine-gather-yield.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":214,"BUY_PRICE":0,"DURATION":180,"DOUBLE_GATHER_DROP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_DROP_PERCENT":{"Mining":24,"Woodcutting":24,"Fishing":24,"Farming":24}}}},{"item":{"id":760,"name":"Basic Health Potion","image":"items/potion-basic-health.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":12,"BUY_PRICE":0,"HEALTH_PERCENT":3,"FOOD_EFFECT":3,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH_PERCENT":3,"FOOD_EFFECT":3,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":761,"name":"Basic Gather XP Potion","image":"items/potion-basic-gather-efficiency.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":42,"BUY_PRICE":0,"DURATION":180,"DOUBLE_GATHER_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":6,"Woodcutting":6,"Fishing":6,"Farming":6}}}},{"item":{"id":762,"name":"Basic Craft XP Potion","image":"items/potion-basic-craft-efficiency.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":42,"BUY_PRICE":0,"DURATION":180,"DOUBLE_CRAFT_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":6,"Cooking":6,"Alchemy":6,"Smelting":6,"Smithing":6}}}},{"item":{"id":763,"name":"Basic Gather Level Potion","image":"items/potion-basic-gather-level.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":22,"BUY_PRICE":0,"BONUS_LEVEL":2,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BONUS_LEVEL":{"Mining":2,"Woodcutting":2,"Fishing":2,"Farming":2}}}},{"item":{"id":764,"name":"Basic Craft Level Potion","image":"items/potion-basic-craft-level.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":22,"BUY_PRICE":0,"BONUS_LEVEL":2,"DURATION":180}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"BONUS_LEVEL":{"Enchanting":2,"Cooking":2,"Alchemy":2,"Smelting":2,"Smithing":2}}}},{"item":{"id":765,"name":"Basic Combat XP Potion","image":"items/potion-basic-combat-efficiency.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":42,"BUY_PRICE":0,"DURATION":180,"DOUBLE_COMBAT_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":6,"TwoHanded":6,"OneHanded":6,"Defense":6}}}},{"item":{"id":766,"name":"Basic Combat Loot Potion","image":"items/potion-basic-combat-loot.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"DURATION":180,"DOUBLE_COMBAT_DROP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_DROP_PERCENT":{"Ranged":6,"TwoHanded":6,"OneHanded":6,"Defense":6}}}},{"item":{"id":767,"name":"Basic Multi Craft Potion","image":"items/potion-basic-preservation.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"DURATION":180,"MULTICRAFT":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"MULTICRAFT":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":768,"name":"Basic Gather Yield Potion","image":"items/potion-basic-gather-yield.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32,"BUY_PRICE":0,"DURATION":180,"DOUBLE_GATHER_DROP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_DROP_PERCENT":{"Mining":6,"Woodcutting":6,"Fishing":6,"Farming":6}}}},{"item":{"id":800,"name":"Ruby Loot Amulet","image":"items/amulet-loot-ruby.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"DOUBLE_GATHER_DROP":1,"DOUBLE_COMBAT_DROP":1,"CRAFT_PRESERVATION_CHANCE":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"PRESERVATION_PERCENT":{"Enchanting":1,"Cooking":1,"Alchemy":1,"Smelting":1,"Smithing":1},"DOUBLE_DROP_PERCENT":{"Ranged":1,"Mining":1,"TwoHanded":1,"OneHanded":1,"Woodcutting":1,"Fishing":1,"Defense":1,"Farming":1}}}},{"item":{"id":801,"name":"Topaz Loot Amulet","image":"items/amulet-loot-topaz.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"DOUBLE_GATHER_DROP":2,"DOUBLE_COMBAT_DROP":2,"CRAFT_PRESERVATION_CHANCE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"PRESERVATION_PERCENT":{"Enchanting":2,"Cooking":2,"Alchemy":2,"Smelting":2,"Smithing":2},"DOUBLE_DROP_PERCENT":{"Ranged":2,"Mining":2,"TwoHanded":2,"OneHanded":2,"Woodcutting":2,"Fishing":2,"Defense":2,"Farming":2}}}},{"item":{"id":802,"name":"Emerald Loot Amulet","image":"items/amulet-loot-emerald.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"DOUBLE_GATHER_DROP":3,"DOUBLE_COMBAT_DROP":3,"CRAFT_PRESERVATION_CHANCE":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"PRESERVATION_PERCENT":{"Enchanting":3,"Cooking":3,"Alchemy":3,"Smelting":3,"Smithing":3},"DOUBLE_DROP_PERCENT":{"Ranged":3,"Mining":3,"TwoHanded":3,"OneHanded":3,"Woodcutting":3,"Fishing":3,"Defense":3,"Farming":3}}}},{"item":{"id":803,"name":"Amethyst Loot Amulet","image":"items/amulet-loot-amethyst.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64000,"BUY_PRICE":0,"DOUBLE_GATHER_DROP":4,"DOUBLE_COMBAT_DROP":4,"CRAFT_PRESERVATION_CHANCE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"PRESERVATION_PERCENT":{"Enchanting":4,"Cooking":4,"Alchemy":4,"Smelting":4,"Smithing":4},"DOUBLE_DROP_PERCENT":{"Ranged":4,"Mining":4,"TwoHanded":4,"OneHanded":4,"Woodcutting":4,"Fishing":4,"Defense":4,"Farming":4}}}},{"item":{"id":804,"name":"Citrine Loot Amulet","image":"items/amulet-loot-citrine.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128000,"BUY_PRICE":0,"DOUBLE_GATHER_DROP":5,"DOUBLE_COMBAT_DROP":5,"CRAFT_PRESERVATION_CHANCE":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"PRESERVATION_PERCENT":{"Enchanting":5,"Cooking":5,"Alchemy":5,"Smelting":5,"Smithing":5},"DOUBLE_DROP_PERCENT":{"Ranged":5,"Mining":5,"TwoHanded":5,"OneHanded":5,"Woodcutting":5,"Fishing":5,"Defense":5,"Farming":5}}}},{"item":{"id":805,"name":"Diamond Loot Amulet","image":"items/amulet-loot-diamond.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":256000,"BUY_PRICE":0,"DOUBLE_GATHER_DROP":6,"DOUBLE_COMBAT_DROP":6,"CRAFT_PRESERVATION_CHANCE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"PRESERVATION_PERCENT":{"Enchanting":6,"Cooking":6,"Alchemy":6,"Smelting":6,"Smithing":6},"DOUBLE_DROP_PERCENT":{"Ranged":6,"Mining":6,"TwoHanded":6,"OneHanded":6,"Woodcutting":6,"Fishing":6,"Defense":6,"Farming":6}}}},{"item":{"id":806,"name":"Moonstone Loot Amulet","image":"items/amulet-loot-moonstone.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":768000,"BUY_PRICE":0,"DOUBLE_GATHER_DROP":7,"DOUBLE_COMBAT_DROP":7,"CRAFT_PRESERVATION_CHANCE":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"PRESERVATION_PERCENT":{"Enchanting":7,"Cooking":7,"Alchemy":7,"Smelting":7,"Smithing":7},"DOUBLE_DROP_PERCENT":{"Ranged":7,"Mining":7,"TwoHanded":7,"OneHanded":7,"Woodcutting":7,"Fishing":7,"Defense":7,"Farming":7}}}},{"item":{"id":810,"name":"Ruby Efficiency Ring","image":"items/ring-efficiency-ruby.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"All":1}}}},{"item":{"id":811,"name":"Topaz Efficiency Ring","image":"items/ring-efficiency-topaz.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"All":2}}}},{"item":{"id":812,"name":"Emerald Efficiency Ring","image":"items/ring-efficiency-emerald.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"All":3}}}},{"item":{"id":813,"name":"Amethyst Efficiency Ring","image":"items/ring-efficiency-amethyst.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64000,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"All":4}}}},{"item":{"id":814,"name":"Citrine Efficiency Ring","image":"items/ring-efficiency-citrine.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":128000,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"All":5}}}},{"item":{"id":815,"name":"Diamond Efficiency Ring","image":"items/ring-efficiency-diamond.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":256000,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"All":6}}}},{"item":{"id":816,"name":"Moonstone Efficiency Ring","image":"items/ring-efficiency-moonstone.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":768000,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"EFFICIENCY_PERCENT":{"All":7}}}},{"item":{"id":820,"name":"Ruby Wisdom Bracelet","image":"items/bracelet-wisdom-ruby.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"ALL_SKILL_EXP":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"All":1}}}},{"item":{"id":821,"name":"Topaz Wisdom Bracelet","image":"items/bracelet-wisdom-topaz.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"ALL_SKILL_EXP":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"All":2}}}},{"item":{"id":822,"name":"Emerald Wisdom Bracelet","image":"items/bracelet-wisdom-emerald.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"ALL_SKILL_EXP":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"All":3}}}},{"item":{"id":823,"name":"Amethyst Wisdom Bracelet","image":"items/bracelet-wisdom-amethyst.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"ALL_SKILL_EXP":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"All":4}}}},{"item":{"id":824,"name":"Citrine Wisdom Bracelet","image":"items/bracelet-wisdom-citrine.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"ALL_SKILL_EXP":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"All":5}}}},{"item":{"id":825,"name":"Diamond Wisdom Bracelet","image":"items/bracelet-wisdom-diamond.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":64000,"BUY_PRICE":0,"ALL_SKILL_EXP":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"All":6}}}},{"item":{"id":826,"name":"Moonstone Wisdom Bracelet","image":"items/bracelet-wisdom-moonstone.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":192000,"BUY_PRICE":0,"ALL_SKILL_EXP":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"DOUBLE_EXP_PERCENT":{"All":7}}}},{"item":{"id":900,"name":"Celebration Cake","image":"items/event-celebration-cake.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"HEAL":1000}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEAL":1000,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1000,"name":"Dungeon Map 25","image":"items/map-dungeon.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":100000,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1001,"name":"Dungeon Map 40","image":"items/map-dungeon.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":200000,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1002,"name":"Dungeon Map 55","image":"items/map-dungeon.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":300000,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1003,"name":"Dungeon Map 70","image":"items/map-dungeon.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":400000,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1004,"name":"Dungeon Map 85","image":"items/map-dungeon.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":500000,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1005,"name":"Dungeon Map 100","image":"items/map-dungeon.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":600000,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1010,"name":"Iron Chest","image":"items/chest-iron.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1011,"name":"Enhanced Iron Chest","image":"items/chest-iron.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1012,"name":"Silver Chest","image":"items/chest-silver.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1013,"name":"Enhanced Silver Chest","image":"items/chest-silver.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1014,"name":"Gold Chest","image":"items/chest-gold.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1015,"name":"Enhanced Gold Chest","image":"items/chest-gold.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1020,"name":"Challenge Scroll","image":"items/challenge-scroll.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1030,"name":"Small Egg","image":"items/egg-small.png","skill":"Taming","tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":100,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1031,"name":"Medium Egg","image":"items/egg-medium.png","skill":"Taming","tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":200,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1032,"name":"Large Egg","image":"items/egg-large.png","skill":"Taming","tier":0,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":300,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1050,"name":"Silver Telescope","image":"items/telescope-silver.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"DUNGEON_BLOCK":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_BLOCK":1,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1052,"name":"Gold Telescope","image":"items/telescope-gold.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"DUNGEON_BLOCK":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_BLOCK":2,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1053,"name":"Cobalt Telescope","image":"items/telescope-cobalt.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"DUNGEON_BLOCK":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_BLOCK":3,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1054,"name":"Obsidian Telescope","image":"items/telescope-obsidian.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"DUNGEON_BLOCK":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_BLOCK":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1055,"name":"Astral Telescope","image":"items/telescope-astral.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"DUNGEON_BLOCK":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_BLOCK":5,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1056,"name":"Infernal Telescope","image":"items/telescope-infernal.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"DUNGEON_BLOCK":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_BLOCK":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1057,"name":"Perfect Infernal Telescope","image":"items/telescope-infernal.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"DUNGEON_BLOCK":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"DUNGEON_BLOCK":7,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1060,"name":"Silver Lantern","image":"items/lantern-silver.png","skill":null,"tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1000,"BUY_PRICE":0,"KEY_PRESERVATION_CHANCE":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1061,"name":"Gold Lantern","image":"items/lantern-gold.png","skill":null,"tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2000,"BUY_PRICE":0,"KEY_PRESERVATION_CHANCE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1062,"name":"Cobalt Lantern","image":"items/lantern-cobalt.png","skill":null,"tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4000,"BUY_PRICE":0,"KEY_PRESERVATION_CHANCE":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1063,"name":"Obsidian Lantern","image":"items/lantern-obsidian.png","skill":null,"tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8000,"BUY_PRICE":0,"KEY_PRESERVATION_CHANCE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1064,"name":"Astral Lantern","image":"items/lantern-astral.png","skill":null,"tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16000,"BUY_PRICE":0,"KEY_PRESERVATION_CHANCE":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1065,"name":"Infernal Lantern","image":"items/lantern-infernal.png","skill":null,"tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":32000,"BUY_PRICE":0,"KEY_PRESERVATION_CHANCE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1066,"name":"Perfect Infernal Lantern","image":"items/lantern-infernal.png","skill":null,"tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":96000,"BUY_PRICE":0,"KEY_PRESERVATION_CHANCE":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":1100,"name":"Savage Looting Tome 1","image":"items/tome-one-savage-looting.png","skill":"Enchanting","tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_COMBAT_EXP":1,"CARVE_CHANCE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"CARVE_CHANCE":2,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":1,"TwoHanded":1,"OneHanded":1,"Defense":1}}}},{"item":{"id":1101,"name":"Bountiful Harvest Tome 1","image":"items/tome-one-bountiful-harvest.png","skill":"Enchanting","tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_GATHER_EXP":1,"TIER_VARIETY_CHANCE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"TIER_VARIETY_CHANCE":2,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":1,"Woodcutting":1,"Fishing":1,"Farming":1}}}},{"item":{"id":1102,"name":"Opulent Crafting Tome 1","image":"items/tome-one-opulent-crafting.png","skill":"Enchanting","tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_CRAFT_EXP":1,"OPULENT_CHANCE":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"OPULENT_CHANCE":2,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":1,"Cooking":1,"Alchemy":1,"Smelting":1,"Smithing":1}}}},{"item":{"id":1104,"name":"Insatiable Power Tome 1","image":"items/tome-one-insatiable-power.png","skill":"Enchanting","tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":1,"PASSIVE_FOOD_CONSUMPTION":1}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"PASSIVE_FOOD_CONSUMPTION":1,"UNTRADEABLE":1},"bySkill":{"EFFICIENCY_PERCENT":{"All":1}}}},{"item":{"id":1105,"name":"Potent Concoction Tome 1","image":"items/tome-one-potent-concoction.png","skill":"Enchanting","tier":1,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"INCREASED_POTION_EFFECT":6,"DECREASED_POTION_DURATION":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"INCREASED_POTION_EFFECT":6,"DECREASED_POTION_DURATION":6,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1110,"name":"Savage Looting Tome 2","image":"items/tome-two-savage-looting.png","skill":"Enchanting","tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_COMBAT_EXP":2,"CARVE_CHANCE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"CARVE_CHANCE":4,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":2,"TwoHanded":2,"OneHanded":2,"Defense":2}}}},{"item":{"id":1111,"name":"Bountiful Harvest Tome 2","image":"items/tome-two-bountiful-harvest.png","skill":"Enchanting","tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_GATHER_EXP":2,"TIER_VARIETY_CHANCE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"TIER_VARIETY_CHANCE":4,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":2,"Woodcutting":2,"Fishing":2,"Farming":2}}}},{"item":{"id":1112,"name":"Opulent Crafting Tome 2","image":"items/tome-two-opulent-crafting.png","skill":"Enchanting","tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_CRAFT_EXP":2,"OPULENT_CHANCE":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"OPULENT_CHANCE":4,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":2,"Cooking":2,"Alchemy":2,"Smelting":2,"Smithing":2}}}},{"item":{"id":1114,"name":"Insatiable Power Tome 2","image":"items/tome-two-insatiable-power.png","skill":"Enchanting","tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":2,"PASSIVE_FOOD_CONSUMPTION":2}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"PASSIVE_FOOD_CONSUMPTION":2,"UNTRADEABLE":1},"bySkill":{"EFFICIENCY_PERCENT":{"All":2}}}},{"item":{"id":1115,"name":"Potent Concoction Tome 2","image":"items/tome-two-potent-concoction.png","skill":"Enchanting","tier":2,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"INCREASED_POTION_EFFECT":12,"DECREASED_POTION_DURATION":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"INCREASED_POTION_EFFECT":12,"DECREASED_POTION_DURATION":12,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1120,"name":"Savage Looting Tome 3","image":"items/tome-three-savage-looting.png","skill":"Enchanting","tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_COMBAT_EXP":3,"CARVE_CHANCE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"CARVE_CHANCE":6,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":3,"TwoHanded":3,"OneHanded":3,"Defense":3}}}},{"item":{"id":1121,"name":"Bountiful Harvest Tome 3","image":"items/tome-three-bountiful-harvest.png","skill":"Enchanting","tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_GATHER_EXP":3,"TIER_VARIETY_CHANCE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"TIER_VARIETY_CHANCE":6,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":3,"Woodcutting":3,"Fishing":3,"Farming":3}}}},{"item":{"id":1122,"name":"Opulent Crafting Tome 3","image":"items/tome-three-opulent-crafting.png","skill":"Enchanting","tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_CRAFT_EXP":3,"OPULENT_CHANCE":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"OPULENT_CHANCE":6,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":3,"Cooking":3,"Alchemy":3,"Smelting":3,"Smithing":3}}}},{"item":{"id":1124,"name":"Insatiable Power Tome 3","image":"items/tome-three-insatiable-power.png","skill":"Enchanting","tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":3,"PASSIVE_FOOD_CONSUMPTION":3}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"PASSIVE_FOOD_CONSUMPTION":3,"UNTRADEABLE":1},"bySkill":{"EFFICIENCY_PERCENT":{"All":3}}}},{"item":{"id":1125,"name":"Potent Concoction Tome 3","image":"items/tome-three-potent-concoction.png","skill":"Enchanting","tier":3,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"INCREASED_POTION_EFFECT":18,"DECREASED_POTION_DURATION":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"INCREASED_POTION_EFFECT":18,"DECREASED_POTION_DURATION":18,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1130,"name":"Savage Looting Tome 4","image":"items/tome-four-savage-looting.png","skill":"Enchanting","tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_COMBAT_EXP":4,"CARVE_CHANCE":8}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"CARVE_CHANCE":8,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":4,"TwoHanded":4,"OneHanded":4,"Defense":4}}}},{"item":{"id":1131,"name":"Bountiful Harvest Tome 4","image":"items/tome-four-bountiful-harvest.png","skill":"Enchanting","tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_GATHER_EXP":4,"TIER_VARIETY_CHANCE":8}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"TIER_VARIETY_CHANCE":8,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":4,"Woodcutting":4,"Fishing":4,"Farming":4}}}},{"item":{"id":1132,"name":"Opulent Crafting Tome 4","image":"items/tome-four-opulent-crafting.png","skill":"Enchanting","tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_CRAFT_EXP":4,"OPULENT_CHANCE":8}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"OPULENT_CHANCE":8,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":4,"Cooking":4,"Alchemy":4,"Smelting":4,"Smithing":4}}}},{"item":{"id":1134,"name":"Insatiable Power Tome 4","image":"items/tome-four-insatiable-power.png","skill":"Enchanting","tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":4,"PASSIVE_FOOD_CONSUMPTION":4}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"PASSIVE_FOOD_CONSUMPTION":4,"UNTRADEABLE":1},"bySkill":{"EFFICIENCY_PERCENT":{"All":4}}}},{"item":{"id":1135,"name":"Potent Concoction Tome 4","image":"items/tome-four-potent-concoction.png","skill":"Enchanting","tier":4,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"INCREASED_POTION_EFFECT":24,"DECREASED_POTION_DURATION":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"INCREASED_POTION_EFFECT":24,"DECREASED_POTION_DURATION":24,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1140,"name":"Savage Looting Tome 5","image":"items/tome-five-savage-looting.png","skill":"Enchanting","tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_COMBAT_EXP":5,"CARVE_CHANCE":10}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"CARVE_CHANCE":10,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":5,"TwoHanded":5,"OneHanded":5,"Defense":5}}}},{"item":{"id":1141,"name":"Bountiful Harvest Tome 5","image":"items/tome-five-bountiful-harvest.png","skill":"Enchanting","tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_GATHER_EXP":5,"TIER_VARIETY_CHANCE":10}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"TIER_VARIETY_CHANCE":10,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":5,"Woodcutting":5,"Fishing":5,"Farming":5}}}},{"item":{"id":1142,"name":"Opulent Crafting Tome 5","image":"items/tome-five-opulent-crafting.png","skill":"Enchanting","tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_CRAFT_EXP":5,"OPULENT_CHANCE":10}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"OPULENT_CHANCE":10,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":5,"Cooking":5,"Alchemy":5,"Smelting":5,"Smithing":5}}}},{"item":{"id":1144,"name":"Insatiable Power Tome 5","image":"items/tome-five-insatiable-power.png","skill":"Enchanting","tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":5,"PASSIVE_FOOD_CONSUMPTION":5}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"PASSIVE_FOOD_CONSUMPTION":5,"UNTRADEABLE":1},"bySkill":{"EFFICIENCY_PERCENT":{"All":5}}}},{"item":{"id":1145,"name":"Potent Concoction Tome 5","image":"items/tome-five-potent-concoction.png","skill":"Enchanting","tier":5,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"INCREASED_POTION_EFFECT":30,"DECREASED_POTION_DURATION":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"INCREASED_POTION_EFFECT":30,"DECREASED_POTION_DURATION":30,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1150,"name":"Savage Looting Tome 6","image":"items/tome-six-savage-looting.png","skill":"Enchanting","tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_COMBAT_EXP":6,"CARVE_CHANCE":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"CARVE_CHANCE":12,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":6,"TwoHanded":6,"OneHanded":6,"Defense":6}}}},{"item":{"id":1151,"name":"Bountiful Harvest Tome 6","image":"items/tome-six-bountiful-harvest.png","skill":"Enchanting","tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_GATHER_EXP":6,"TIER_VARIETY_CHANCE":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"TIER_VARIETY_CHANCE":12,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":6,"Woodcutting":6,"Fishing":6,"Farming":6}}}},{"item":{"id":1152,"name":"Opulent Crafting Tome 6","image":"items/tome-six-opulent-crafting.png","skill":"Enchanting","tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_CRAFT_EXP":6,"OPULENT_CHANCE":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"OPULENT_CHANCE":12,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":6,"Cooking":6,"Alchemy":6,"Smelting":6,"Smithing":6}}}},{"item":{"id":1154,"name":"Insatiable Power Tome 6","image":"items/tome-six-insatiable-power.png","skill":"Enchanting","tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":6,"PASSIVE_FOOD_CONSUMPTION":6}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"PASSIVE_FOOD_CONSUMPTION":6,"UNTRADEABLE":1},"bySkill":{"EFFICIENCY_PERCENT":{"All":6}}}},{"item":{"id":1155,"name":"Potent Concoction Tome 6","image":"items/tome-six-potent-concoction.png","skill":"Enchanting","tier":6,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"INCREASED_POTION_EFFECT":36,"DECREASED_POTION_DURATION":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"INCREASED_POTION_EFFECT":36,"DECREASED_POTION_DURATION":36,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1160,"name":"Savage Looting Tome 7","image":"items/tome-seven-savage-looting.png","skill":"Enchanting","tier":7,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_COMBAT_EXP":7,"CARVE_CHANCE":14}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"CARVE_CHANCE":14,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":7,"TwoHanded":7,"OneHanded":7,"Defense":7}}}},{"item":{"id":1161,"name":"Bountiful Harvest Tome 7","image":"items/tome-seven-bountiful-harvest.png","skill":"Enchanting","tier":7,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_GATHER_EXP":7,"TIER_VARIETY_CHANCE":14}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"TIER_VARIETY_CHANCE":14,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":7,"Woodcutting":7,"Fishing":7,"Farming":7}}}},{"item":{"id":1162,"name":"Opulent Crafting Tome 7","image":"items/tome-seven-opulent-crafting.png","skill":"Enchanting","tier":7,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_CRAFT_EXP":7,"OPULENT_CHANCE":14}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"OPULENT_CHANCE":14,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":7,"Cooking":7,"Alchemy":7,"Smelting":7,"Smithing":7}}}},{"item":{"id":1164,"name":"Insatiable Power Tome 7","image":"items/tome-seven-insatiable-power.png","skill":"Enchanting","tier":7,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":7,"PASSIVE_FOOD_CONSUMPTION":7}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"PASSIVE_FOOD_CONSUMPTION":7,"UNTRADEABLE":1},"bySkill":{"EFFICIENCY_PERCENT":{"All":7}}}},{"item":{"id":1165,"name":"Potent Concoction Tome 7","image":"items/tome-seven-potent-concoction.png","skill":"Enchanting","tier":7,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"INCREASED_POTION_EFFECT":42,"DECREASED_POTION_DURATION":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"INCREASED_POTION_EFFECT":42,"DECREASED_POTION_DURATION":42,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1170,"name":"Savage Looting Tome 8","image":"items/tome-eight-savage-looting.png","skill":"Enchanting","tier":8,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_COMBAT_EXP":8,"CARVE_CHANCE":16}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"CARVE_CHANCE":16,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Ranged":8,"TwoHanded":8,"OneHanded":8,"Defense":8}}}},{"item":{"id":1171,"name":"Bountiful Harvest Tome 8","image":"items/tome-eight-bountiful-harvest.png","skill":"Enchanting","tier":8,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_GATHER_EXP":8,"TIER_VARIETY_CHANCE":16}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"TIER_VARIETY_CHANCE":16,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Mining":8,"Woodcutting":8,"Fishing":8,"Farming":8}}}},{"item":{"id":1172,"name":"Opulent Crafting Tome 8","image":"items/tome-eight-opulent-crafting.png","skill":"Enchanting","tier":8,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"DOUBLE_CRAFT_EXP":8,"OPULENT_CHANCE":16}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"OPULENT_CHANCE":16,"UNTRADEABLE":1},"bySkill":{"DOUBLE_EXP_PERCENT":{"Enchanting":8,"Cooking":8,"Alchemy":8,"Smelting":8,"Smithing":8}}}},{"item":{"id":1174,"name":"Insatiable Power Tome 8","image":"items/tome-eight-insatiable-power.png","skill":"Enchanting","tier":8,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"ALL_SKILL_EFFICIENCY":8,"PASSIVE_FOOD_CONSUMPTION":8}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"PASSIVE_FOOD_CONSUMPTION":8,"UNTRADEABLE":1},"bySkill":{"EFFICIENCY_PERCENT":{"All":8}}}},{"item":{"id":1175,"name":"Potent Concoction Tome 8","image":"items/tome-eight-potent-concoction.png","skill":"Enchanting","tier":8,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0,"INCREASED_POTION_EFFECT":48,"DECREASED_POTION_DURATION":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"INCREASED_POTION_EFFECT":48,"DECREASED_POTION_DURATION":48,"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1500,"name":"Taming Mark","image":"marks/taming.png","skill":"Taming","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1501,"name":"Woodcutting Mark","image":"marks/woodcutting.png","skill":"Woodcutting","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1502,"name":"Mining Mark","image":"marks/mining.png","skill":"Mining","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1503,"name":"Smelting Mark","image":"marks/smelting.png","skill":"Smelting","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1504,"name":"Smithing Mark","image":"marks/smithing.png","skill":"Smithing","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1505,"name":"Enchanting Mark","image":"marks/enchanting.png","skill":"Enchanting","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1506,"name":"Farming Mark","image":"marks/farming.png","skill":"Farming","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1507,"name":"Alchemy Mark","image":"marks/alchemy.png","skill":"Alchemy","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1508,"name":"Fishing Mark","image":"marks/fishing.png","skill":"Fishing","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1509,"name":"Cooking Mark","image":"marks/cooking.png","skill":"Cooking","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1510,"name":"One-Handed Mark","image":"marks/one-handed.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1511,"name":"Two-Handed Mark","image":"marks/two-handed.png","skill":null,"tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1512,"name":"Ranged Mark","image":"marks/ranged.png","skill":"Ranged","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":1513,"name":"Defense Mark","image":"marks/defense.png","skill":"Defense","tier":0,"attributes":{"UNTRADEABLE":true,"SELL_PRICE":1,"BUY_PRICE":0}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":1},"bySkill":{}}},{"item":{"id":2000,"name":"Superior Copper Helmet","image":"items/armor-copper-helmet.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ARMOUR":3,"HEALTH":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":9,"ARMOUR":3,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2001,"name":"Superior Copper Boots","image":"items/armor-copper-boots.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ARMOUR":3,"HEALTH":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":9,"ARMOUR":3,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2002,"name":"Superior Copper Body","image":"items/armor-copper-body.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2400,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2003,"name":"Superior Copper Gloves","image":"items/armor-copper-gloves.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ARMOUR":3,"HEALTH":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":9,"ARMOUR":3,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2004,"name":"Superior Copper Shield","image":"items/armor-copper-shield.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ARMOUR":3,"HEALTH":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":9,"ARMOUR":3,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2005,"name":"Superior Iron Helmet","image":"items/armor-iron-helmet.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2006,"name":"Superior Iron Boots","image":"items/armor-iron-boots.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2007,"name":"Superior Iron Body","image":"items/armor-iron-body.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":25200,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2008,"name":"Superior Iron Gloves","image":"items/armor-iron-gloves.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2009,"name":"Superior Iron Shield","image":"items/armor-iron-shield.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ARMOUR":6,"HEALTH":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":18,"ARMOUR":6,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2010,"name":"Superior Silver Helmet","image":"items/armor-silver-helmet.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ARMOUR":9,"HEALTH":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":27,"ARMOUR":9,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2011,"name":"Superior Silver Boots","image":"items/armor-silver-boots.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ARMOUR":9,"HEALTH":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":27,"ARMOUR":9,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2012,"name":"Superior Silver Body","image":"items/armor-silver-body.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":133200,"BUY_PRICE":0,"ARMOUR":18,"HEALTH":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":54,"ARMOUR":18,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2013,"name":"Superior Silver Gloves","image":"items/armor-silver-gloves.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ARMOUR":9,"HEALTH":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":27,"ARMOUR":9,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2014,"name":"Superior Silver Shield","image":"items/armor-silver-shield.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ARMOUR":9,"HEALTH":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":27,"ARMOUR":9,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2015,"name":"Superior Gold Helmet","image":"items/armor-gold-helmet.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2016,"name":"Superior Gold Boots","image":"items/armor-gold-boots.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2017,"name":"Superior Gold Body","image":"items/armor-gold-body.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":457200,"BUY_PRICE":0,"ARMOUR":24,"HEALTH":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":72,"ARMOUR":24,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2018,"name":"Superior Gold Gloves","image":"items/armor-gold-gloves.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2019,"name":"Superior Gold Shield","image":"items/armor-gold-shield.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ARMOUR":12,"HEALTH":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":36,"ARMOUR":12,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2020,"name":"Superior Cobalt Body","image":"items/armor-cobalt-body.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1177200,"BUY_PRICE":0,"ARMOUR":30,"HEALTH":90}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":90,"ARMOUR":30,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2021,"name":"Superior Cobalt Boots","image":"items/armor-cobalt-boots.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ARMOUR":15,"HEALTH":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":45,"ARMOUR":15,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2022,"name":"Superior Cobalt Helmet","image":"items/armor-cobalt-helmet.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ARMOUR":15,"HEALTH":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":45,"ARMOUR":15,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2023,"name":"Superior Cobalt Gloves","image":"items/armor-cobalt-gloves.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ARMOUR":15,"HEALTH":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":45,"ARMOUR":15,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2024,"name":"Superior Cobalt Shield","image":"items/armor-cobalt-shield.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ARMOUR":15,"HEALTH":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":45,"ARMOUR":15,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2025,"name":"Superior Obsidian Body","image":"items/armor-obsidian-body.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2485200,"BUY_PRICE":0,"ARMOUR":36,"HEALTH":108}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":108,"ARMOUR":36,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2026,"name":"Superior Obsidian Boots","image":"items/armor-obsidian-boots.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ARMOUR":18,"HEALTH":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":54,"ARMOUR":18,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2027,"name":"Superior Obsidian Helmet","image":"items/armor-obsidian-helmet.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ARMOUR":18,"HEALTH":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":54,"ARMOUR":18,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2028,"name":"Superior Obsidian Gloves","image":"items/armor-obsidian-gloves.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ARMOUR":18,"HEALTH":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":54,"ARMOUR":18,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2029,"name":"Superior Obsidian Shield","image":"items/armor-obsidian-shield.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ARMOUR":18,"HEALTH":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":54,"ARMOUR":18,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2030,"name":"Superior Copper Hammer","image":"items/hammer-copper.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":36,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":9,"DAMAGE":36,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2031,"name":"Superior Copper Hatchet","image":"items/hatchet-copper.png","skill":"Woodcutting","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"SKILL_SPEED":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":9}}}},{"item":{"id":2032,"name":"Superior Copper Sword","image":"items/sword-copper.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":36,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":9,"DAMAGE":36,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2033,"name":"Superior Copper Rod","image":"items/tool-copper-rod.png","skill":"Fishing","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"SKILL_SPEED":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":9}}}},{"item":{"id":2034,"name":"Superior Copper Pickaxe","image":"items/pickaxe-copper.png","skill":"Mining","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"SKILL_SPEED":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":9}}}},{"item":{"id":2035,"name":"Superior Copper Spade","image":"items/tool-copper-spade.png","skill":"Farming","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"SKILL_SPEED":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":9}}}},{"item":{"id":2036,"name":"Superior Iron Hammer","image":"items/hammer-iron.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":72,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2037,"name":"Superior Iron Hatchet","image":"items/hatchet-iron.png","skill":"Woodcutting","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"SKILL_SPEED":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":18}}}},{"item":{"id":2038,"name":"Superior Iron Sword","image":"items/sword-iron.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":72,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2039,"name":"Superior Iron Rod","image":"items/tool-iron-rod.png","skill":"Fishing","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"SKILL_SPEED":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":18}}}},{"item":{"id":2040,"name":"Superior Iron Pickaxe","image":"items/pickaxe-iron.png","skill":"Mining","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"SKILL_SPEED":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":18}}}},{"item":{"id":2041,"name":"Superior Iron Spade","image":"items/tool-iron-spade.png","skill":"Farming","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"SKILL_SPEED":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":18}}}},{"item":{"id":2042,"name":"Superior Silver Hammer","image":"items/hammer-silver.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":108,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":27,"DAMAGE":108,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2043,"name":"Superior Silver Hatchet","image":"items/hatchet-silver.png","skill":"Woodcutting","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"SKILL_SPEED":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":27}}}},{"item":{"id":2044,"name":"Superior Silver Sword","image":"items/sword-silver.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":108,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":27,"DAMAGE":108,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2045,"name":"Superior Silver Rod","image":"items/tool-silver-rod.png","skill":"Fishing","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"SKILL_SPEED":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":27}}}},{"item":{"id":2046,"name":"Superior Silver Pickaxe","image":"items/pickaxe-silver.png","skill":"Mining","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"SKILL_SPEED":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":27}}}},{"item":{"id":2047,"name":"Superior Silver Spade","image":"items/tool-silver-spade.png","skill":"Farming","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"SKILL_SPEED":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":27}}}},{"item":{"id":2048,"name":"Superior Gold Hammer","image":"items/hammer-gold.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":144,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2049,"name":"Superior Gold Hatchet","image":"items/hatchet-gold.png","skill":"Woodcutting","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"SKILL_SPEED":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":36}}}},{"item":{"id":2050,"name":"Superior Gold Sword","image":"items/sword-gold.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":144,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2051,"name":"Superior Gold Rod","image":"items/tool-gold-rod.png","skill":"Fishing","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"SKILL_SPEED":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":36}}}},{"item":{"id":2052,"name":"Superior Gold Pickaxe","image":"items/pickaxe-gold.png","skill":"Mining","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"SKILL_SPEED":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":36}}}},{"item":{"id":2053,"name":"Superior Gold Spade","image":"items/tool-gold-spade.png","skill":"Farming","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"SKILL_SPEED":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":36}}}},{"item":{"id":2054,"name":"Superior Cobalt Hammer","image":"items/hammer-cobalt.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":180,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":45,"DAMAGE":180,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2055,"name":"Superior Cobalt Hatchet","image":"items/hatchet-cobalt.png","skill":"Woodcutting","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"SKILL_SPEED":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":45}}}},{"item":{"id":2056,"name":"Superior Cobalt Sword","image":"items/sword-cobalt.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":180,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":45,"DAMAGE":180,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2057,"name":"Superior Cobalt Rod","image":"items/tool-cobalt-rod.png","skill":"Fishing","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"SKILL_SPEED":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":45}}}},{"item":{"id":2058,"name":"Superior Cobalt Pickaxe","image":"items/pickaxe-cobalt.png","skill":"Mining","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"SKILL_SPEED":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":45}}}},{"item":{"id":2059,"name":"Superior Cobalt Spade","image":"items/tool-cobalt-spade.png","skill":"Farming","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"SKILL_SPEED":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":45}}}},{"item":{"id":2060,"name":"Superior Obsidian Hammer","image":"items/hammer-obsidian.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":216,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":54,"DAMAGE":216,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2061,"name":"Superior Obsidian Hatchet","image":"items/hatchet-obsidian.png","skill":"Woodcutting","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"SKILL_SPEED":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":54}}}},{"item":{"id":2062,"name":"Superior Obsidian Sword","image":"items/sword-obsidian.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":216,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":54,"DAMAGE":216,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2063,"name":"Superior Obsidian Rod","image":"items/tool-obsidian-rod.png","skill":"Fishing","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"SKILL_SPEED":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":54}}}},{"item":{"id":2064,"name":"Superior Obsidian Pickaxe","image":"items/pickaxe-obsidian.png","skill":"Mining","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"SKILL_SPEED":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":54}}}},{"item":{"id":2065,"name":"Superior Obsidian Spade","image":"items/tool-obsidian-spade.png","skill":"Farming","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"SKILL_SPEED":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":54}}}},{"item":{"id":2066,"name":"Superior Copper Bow","image":"items/bow-copper.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":36,"FOREST_DAMAGE":15,"COMBAT_EXP":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":9,"DAMAGE":36,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2067,"name":"Superior Iron Bow","image":"items/bow-iron.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":72,"FOREST_DAMAGE":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2068,"name":"Superior Silver Bow","image":"items/bow-silver.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":108,"FOREST_DAMAGE":15,"COMBAT_EXP":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":27,"DAMAGE":108,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2069,"name":"Superior Gold Bow","image":"items/bow-gold.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":144,"FOREST_DAMAGE":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2070,"name":"Superior Cobalt Bow","image":"items/bow-cobalt.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":180,"FOREST_DAMAGE":15,"COMBAT_EXP":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":45,"DAMAGE":180,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2071,"name":"Superior Obsidian Bow","image":"items/bow-obsidian.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":216,"FOREST_DAMAGE":15,"COMBAT_EXP":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":54,"DAMAGE":216,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2072,"name":"Superior Astral Bow","image":"items/bow-astral.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":252,"FOREST_DAMAGE":15,"COMBAT_EXP":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":63,"DAMAGE":252,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2073,"name":"Superior Astral Hammer","image":"items/hammer-astral.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":252,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":63,"DAMAGE":252,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2074,"name":"Superior Astral Hatchet","image":"items/hatchet-astral.png","skill":"Woodcutting","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"SKILL_SPEED":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":63}}}},{"item":{"id":2075,"name":"Superior Astral Sword","image":"items/sword-astral.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":252,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":63,"DAMAGE":252,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2076,"name":"Superior Astral Rod","image":"items/tool-astral-rod.png","skill":"Fishing","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"SKILL_SPEED":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":63}}}},{"item":{"id":2077,"name":"Superior Astral Pickaxe","image":"items/pickaxe-astral.png","skill":"Mining","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"SKILL_SPEED":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":63}}}},{"item":{"id":2078,"name":"Superior Astral Spade","image":"items/tool-astral-spade.png","skill":"Farming","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"SKILL_SPEED":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":63}}}},{"item":{"id":2079,"name":"Superior Astral Body","image":"items/armor-astral-body.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4621200,"BUY_PRICE":0,"ARMOUR":42,"HEALTH":126}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":126,"ARMOUR":42,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2080,"name":"Superior Astral Boots","image":"items/armor-astral-boots.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ARMOUR":21,"HEALTH":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":63,"ARMOUR":21,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2081,"name":"Superior Astral Helmet","image":"items/armor-astral-helmet.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ARMOUR":21,"HEALTH":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":63,"ARMOUR":21,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2082,"name":"Superior Astral Gloves","image":"items/armor-astral-gloves.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ARMOUR":21,"HEALTH":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":63,"ARMOUR":21,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2083,"name":"Superior Astral Shield","image":"items/armor-astral-shield.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ARMOUR":21,"HEALTH":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":63,"ARMOUR":21,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2084,"name":"Superior Copper Spear","image":"items/spear-copper.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":36,"OCEAN_BLOCK":15,"COMBAT_EXP":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":9,"DAMAGE":36,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2085,"name":"Superior Iron Spear","image":"items/spear-iron.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":72,"OCEAN_BLOCK":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2086,"name":"Superior Silver Spear","image":"items/spear-silver.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":108,"OCEAN_BLOCK":15,"COMBAT_EXP":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":27,"DAMAGE":108,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2087,"name":"Superior Gold Spear","image":"items/spear-gold.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":144,"OCEAN_BLOCK":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2088,"name":"Superior Cobalt Spear","image":"items/spear-cobalt.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":180,"OCEAN_BLOCK":15,"COMBAT_EXP":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":45,"DAMAGE":180,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2089,"name":"Superior Obsidian Spear","image":"items/spear-obsidian.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":216,"OCEAN_BLOCK":15,"COMBAT_EXP":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":54,"DAMAGE":216,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2090,"name":"Superior Astral Spear","image":"items/spear-astral.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":252,"OCEAN_BLOCK":15,"COMBAT_EXP":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":63,"DAMAGE":252,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2091,"name":"Superior Copper Scythe","image":"items/scythe-copper.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":36,"OCEAN_DAMAGE":15,"COMBAT_EXP":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":9,"DAMAGE":36,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2092,"name":"Superior Iron Scythe","image":"items/scythe-iron.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":72,"OCEAN_DAMAGE":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2093,"name":"Superior Silver Scythe","image":"items/scythe-silver.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":108,"OCEAN_DAMAGE":15,"COMBAT_EXP":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":27,"DAMAGE":108,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2094,"name":"Superior Gold Scythe","image":"items/scythe-gold.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":144,"OCEAN_DAMAGE":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2095,"name":"Superior Cobalt Scythe","image":"items/scythe-cobalt.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":180,"OCEAN_DAMAGE":15,"COMBAT_EXP":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":45,"DAMAGE":180,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2096,"name":"Superior Obsidian Scythe","image":"items/scythe-obsidian.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":216,"OCEAN_DAMAGE":15,"COMBAT_EXP":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":54,"DAMAGE":216,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2097,"name":"Superior Astral Scythe","image":"items/scythe-astral.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":252,"OCEAN_DAMAGE":15,"COMBAT_EXP":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":63,"DAMAGE":252,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2098,"name":"Superior Copper Boomerang","image":"items/boomerang-copper.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1600,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":36,"FOREST_BLOCK":15,"COMBAT_EXP":9}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":9,"DAMAGE":36,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2099,"name":"Superior Iron Boomerang","image":"items/boomerang-iron.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":16800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":72,"FOREST_BLOCK":15,"COMBAT_EXP":18}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":18,"DAMAGE":72,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2100,"name":"Superior Silver Boomerang","image":"items/boomerang-silver.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":88800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":108,"FOREST_BLOCK":15,"COMBAT_EXP":27}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":27,"DAMAGE":108,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2101,"name":"Superior Gold Boomerang","image":"items/boomerang-gold.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":304800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":144,"FOREST_BLOCK":15,"COMBAT_EXP":36}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":36,"DAMAGE":144,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2102,"name":"Superior Cobalt Boomerang","image":"items/boomerang-cobalt.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":784800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":180,"FOREST_BLOCK":15,"COMBAT_EXP":45}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":45,"DAMAGE":180,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2103,"name":"Superior Obsidian Boomerang","image":"items/boomerang-obsidian.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1656800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":216,"FOREST_BLOCK":15,"COMBAT_EXP":54}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":54,"DAMAGE":216,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2104,"name":"Superior Astral Boomerang","image":"items/boomerang-astral.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3080800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":252,"FOREST_BLOCK":15,"COMBAT_EXP":63}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":63,"DAMAGE":252,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2105,"name":"Superior Infernal Bow","image":"items/bow-infernal.png","skill":"Ranged","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":288,"FOREST_DAMAGE":15,"COMBAT_EXP":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":72,"DAMAGE":288,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2106,"name":"Superior Infernal Hammer","image":"items/hammer-infernal.png","skill":"OneHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":288,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":72,"DAMAGE":288,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2107,"name":"Superior Infernal Hatchet","image":"items/hatchet-infernal.png","skill":"Woodcutting","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"SKILL_SPEED":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":72}}}},{"item":{"id":2108,"name":"Superior Infernal Sword","image":"items/sword-infernal.png","skill":"OneHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":288,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":72,"DAMAGE":288,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2109,"name":"Superior Infernal Rod","image":"items/tool-infernal-rod.png","skill":"Fishing","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"SKILL_SPEED":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":72}}}},{"item":{"id":2110,"name":"Superior Infernal Pickaxe","image":"items/pickaxe-infernal.png","skill":"Mining","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"SKILL_SPEED":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":72}}}},{"item":{"id":2111,"name":"Superior Infernal Spade","image":"items/tool-infernal-spade.png","skill":"Farming","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"SKILL_SPEED":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":72}}}},{"item":{"id":2112,"name":"Superior Infernal Body","image":"items/armor-infernal-body.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":8161200,"BUY_PRICE":0,"ARMOUR":48,"HEALTH":144}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":144,"ARMOUR":48,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2113,"name":"Superior Infernal Boots","image":"items/armor-infernal-boots.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ARMOUR":24,"HEALTH":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":72,"ARMOUR":24,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2114,"name":"Superior Infernal Helmet","image":"items/armor-infernal-helmet.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ARMOUR":24,"HEALTH":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":72,"ARMOUR":24,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2115,"name":"Superior Infernal Gloves","image":"items/armor-infernal-gloves.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ARMOUR":24,"HEALTH":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":72,"ARMOUR":24,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2116,"name":"Superior Infernal Shield","image":"items/armor-infernal-shield.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ARMOUR":24,"HEALTH":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":72,"ARMOUR":24,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2117,"name":"Superior Infernal Spear","image":"items/spear-infernal.png","skill":"TwoHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":288,"OCEAN_BLOCK":15,"COMBAT_EXP":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":72,"DAMAGE":288,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2118,"name":"Superior Infernal Scythe","image":"items/scythe-infernal.png","skill":"TwoHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":288,"OCEAN_DAMAGE":15,"COMBAT_EXP":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":72,"DAMAGE":288,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2119,"name":"Superior Infernal Boomerang","image":"items/boomerang-infernal.png","skill":"Ranged","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":288,"FOREST_BLOCK":15,"COMBAT_EXP":72}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":72,"DAMAGE":288,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2400,"name":"Exquisite Copper Helmet","image":"items/armor-copper-helmet.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2401,"name":"Exquisite Copper Boots","image":"items/armor-copper-boots.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2402,"name":"Exquisite Copper Body","image":"items/armor-copper-body.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2403,"name":"Exquisite Copper Gloves","image":"items/armor-copper-gloves.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2404,"name":"Exquisite Copper Shield","image":"items/armor-copper-shield.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ARMOUR":4,"HEALTH":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":12,"ARMOUR":4,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2405,"name":"Exquisite Iron Helmet","image":"items/armor-iron-helmet.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ARMOUR":7,"HEALTH":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":21,"ARMOUR":7,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2406,"name":"Exquisite Iron Boots","image":"items/armor-iron-boots.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ARMOUR":7,"HEALTH":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":21,"ARMOUR":7,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2407,"name":"Exquisite Iron Body","image":"items/armor-iron-body.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":43200,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2408,"name":"Exquisite Iron Gloves","image":"items/armor-iron-gloves.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ARMOUR":7,"HEALTH":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":21,"ARMOUR":7,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2409,"name":"Exquisite Iron Shield","image":"items/armor-iron-shield.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ARMOUR":7,"HEALTH":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":21,"ARMOUR":7,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2410,"name":"Exquisite Silver Helmet","image":"items/armor-silver-helmet.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2411,"name":"Exquisite Silver Boots","image":"items/armor-silver-boots.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2412,"name":"Exquisite Silver Body","image":"items/armor-silver-body.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":205200,"BUY_PRICE":0,"ARMOUR":20,"HEALTH":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":60,"ARMOUR":20,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2413,"name":"Exquisite Silver Gloves","image":"items/armor-silver-gloves.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2414,"name":"Exquisite Silver Shield","image":"items/armor-silver-shield.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2415,"name":"Exquisite Gold Helmet","image":"items/armor-gold-helmet.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ARMOUR":13,"HEALTH":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":39,"ARMOUR":13,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2416,"name":"Exquisite Gold Boots","image":"items/armor-gold-boots.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ARMOUR":13,"HEALTH":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":39,"ARMOUR":13,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2417,"name":"Exquisite Gold Body","image":"items/armor-gold-body.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":637200,"BUY_PRICE":0,"ARMOUR":26,"HEALTH":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":78,"ARMOUR":26,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2418,"name":"Exquisite Gold Gloves","image":"items/armor-gold-gloves.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ARMOUR":13,"HEALTH":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":39,"ARMOUR":13,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2419,"name":"Exquisite Gold Shield","image":"items/armor-gold-shield.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ARMOUR":13,"HEALTH":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":39,"ARMOUR":13,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2420,"name":"Exquisite Cobalt Body","image":"items/armor-cobalt-body.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1537200,"BUY_PRICE":0,"ARMOUR":32,"HEALTH":96}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":96,"ARMOUR":32,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2421,"name":"Exquisite Cobalt Boots","image":"items/armor-cobalt-boots.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2422,"name":"Exquisite Cobalt Helmet","image":"items/armor-cobalt-helmet.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2423,"name":"Exquisite Cobalt Gloves","image":"items/armor-cobalt-gloves.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2424,"name":"Exquisite Cobalt Shield","image":"items/armor-cobalt-shield.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2425,"name":"Exquisite Obsidian Body","image":"items/armor-obsidian-body.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3073200,"BUY_PRICE":0,"ARMOUR":38,"HEALTH":114}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":114,"ARMOUR":38,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2426,"name":"Exquisite Obsidian Boots","image":"items/armor-obsidian-boots.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ARMOUR":19,"HEALTH":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":57,"ARMOUR":19,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2427,"name":"Exquisite Obsidian Helmet","image":"items/armor-obsidian-helmet.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ARMOUR":19,"HEALTH":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":57,"ARMOUR":19,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2428,"name":"Exquisite Obsidian Gloves","image":"items/armor-obsidian-gloves.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ARMOUR":19,"HEALTH":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":57,"ARMOUR":19,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2429,"name":"Exquisite Obsidian Shield","image":"items/armor-obsidian-shield.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ARMOUR":19,"HEALTH":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":57,"ARMOUR":19,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2430,"name":"Exquisite Copper Hammer","image":"items/hammer-copper.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":48,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2431,"name":"Exquisite Copper Hatchet","image":"items/hatchet-copper.png","skill":"Woodcutting","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"SKILL_SPEED":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":12}}}},{"item":{"id":2432,"name":"Exquisite Copper Sword","image":"items/sword-copper.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":48,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2433,"name":"Exquisite Copper Rod","image":"items/tool-copper-rod.png","skill":"Fishing","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"SKILL_SPEED":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":12}}}},{"item":{"id":2434,"name":"Exquisite Copper Pickaxe","image":"items/pickaxe-copper.png","skill":"Mining","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"SKILL_SPEED":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":12}}}},{"item":{"id":2435,"name":"Exquisite Copper Spade","image":"items/tool-copper-spade.png","skill":"Farming","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"SKILL_SPEED":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":12}}}},{"item":{"id":2436,"name":"Exquisite Iron Hammer","image":"items/hammer-iron.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":84,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":21,"DAMAGE":84,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2437,"name":"Exquisite Iron Hatchet","image":"items/hatchet-iron.png","skill":"Woodcutting","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"SKILL_SPEED":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":21}}}},{"item":{"id":2438,"name":"Exquisite Iron Sword","image":"items/sword-iron.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":84,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":21,"DAMAGE":84,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2439,"name":"Exquisite Iron Rod","image":"items/tool-iron-rod.png","skill":"Fishing","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"SKILL_SPEED":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":21}}}},{"item":{"id":2440,"name":"Exquisite Iron Pickaxe","image":"items/pickaxe-iron.png","skill":"Mining","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"SKILL_SPEED":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":21}}}},{"item":{"id":2441,"name":"Exquisite Iron Spade","image":"items/tool-iron-spade.png","skill":"Farming","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"SKILL_SPEED":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":21}}}},{"item":{"id":2442,"name":"Exquisite Silver Hammer","image":"items/hammer-silver.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":120,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2443,"name":"Exquisite Silver Hatchet","image":"items/hatchet-silver.png","skill":"Woodcutting","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"SKILL_SPEED":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":30}}}},{"item":{"id":2444,"name":"Exquisite Silver Sword","image":"items/sword-silver.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":120,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2445,"name":"Exquisite Silver Rod","image":"items/tool-silver-rod.png","skill":"Fishing","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"SKILL_SPEED":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":30}}}},{"item":{"id":2446,"name":"Exquisite Silver Pickaxe","image":"items/pickaxe-silver.png","skill":"Mining","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"SKILL_SPEED":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":30}}}},{"item":{"id":2447,"name":"Exquisite Silver Spade","image":"items/tool-silver-spade.png","skill":"Farming","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"SKILL_SPEED":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":30}}}},{"item":{"id":2448,"name":"Exquisite Gold Hammer","image":"items/hammer-gold.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":156,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":39,"DAMAGE":156,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2449,"name":"Exquisite Gold Hatchet","image":"items/hatchet-gold.png","skill":"Woodcutting","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"SKILL_SPEED":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":39}}}},{"item":{"id":2450,"name":"Exquisite Gold Sword","image":"items/sword-gold.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":156,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":39,"DAMAGE":156,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2451,"name":"Exquisite Gold Rod","image":"items/tool-gold-rod.png","skill":"Fishing","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"SKILL_SPEED":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":39}}}},{"item":{"id":2452,"name":"Exquisite Gold Pickaxe","image":"items/pickaxe-gold.png","skill":"Mining","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"SKILL_SPEED":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":39}}}},{"item":{"id":2453,"name":"Exquisite Gold Spade","image":"items/tool-gold-spade.png","skill":"Farming","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"SKILL_SPEED":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":39}}}},{"item":{"id":2454,"name":"Exquisite Cobalt Hammer","image":"items/hammer-cobalt.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":192,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2455,"name":"Exquisite Cobalt Hatchet","image":"items/hatchet-cobalt.png","skill":"Woodcutting","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"SKILL_SPEED":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":48}}}},{"item":{"id":2456,"name":"Exquisite Cobalt Sword","image":"items/sword-cobalt.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":192,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2457,"name":"Exquisite Cobalt Rod","image":"items/tool-cobalt-rod.png","skill":"Fishing","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"SKILL_SPEED":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":48}}}},{"item":{"id":2458,"name":"Exquisite Cobalt Pickaxe","image":"items/pickaxe-cobalt.png","skill":"Mining","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"SKILL_SPEED":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":48}}}},{"item":{"id":2459,"name":"Exquisite Cobalt Spade","image":"items/tool-cobalt-spade.png","skill":"Farming","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"SKILL_SPEED":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":48}}}},{"item":{"id":2460,"name":"Exquisite Obsidian Hammer","image":"items/hammer-obsidian.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":228,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":57,"DAMAGE":228,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2461,"name":"Exquisite Obsidian Hatchet","image":"items/hatchet-obsidian.png","skill":"Woodcutting","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"SKILL_SPEED":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":57}}}},{"item":{"id":2462,"name":"Exquisite Obsidian Sword","image":"items/sword-obsidian.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":228,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":57,"DAMAGE":228,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2463,"name":"Exquisite Obsidian Rod","image":"items/tool-obsidian-rod.png","skill":"Fishing","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"SKILL_SPEED":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":57}}}},{"item":{"id":2464,"name":"Exquisite Obsidian Pickaxe","image":"items/pickaxe-obsidian.png","skill":"Mining","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"SKILL_SPEED":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":57}}}},{"item":{"id":2465,"name":"Exquisite Obsidian Spade","image":"items/tool-obsidian-spade.png","skill":"Farming","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"SKILL_SPEED":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":57}}}},{"item":{"id":2466,"name":"Exquisite Copper Bow","image":"items/bow-copper.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":48,"FOREST_DAMAGE":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2467,"name":"Exquisite Iron Bow","image":"items/bow-iron.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":84,"FOREST_DAMAGE":15,"COMBAT_EXP":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":21,"DAMAGE":84,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2468,"name":"Exquisite Silver Bow","image":"items/bow-silver.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":120,"FOREST_DAMAGE":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2469,"name":"Exquisite Gold Bow","image":"items/bow-gold.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":156,"FOREST_DAMAGE":15,"COMBAT_EXP":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":39,"DAMAGE":156,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2470,"name":"Exquisite Cobalt Bow","image":"items/bow-cobalt.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":192,"FOREST_DAMAGE":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2471,"name":"Exquisite Obsidian Bow","image":"items/bow-obsidian.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":228,"FOREST_DAMAGE":15,"COMBAT_EXP":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":57,"DAMAGE":228,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2472,"name":"Exquisite Astral Bow","image":"items/bow-astral.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":264,"FOREST_DAMAGE":15,"COMBAT_EXP":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":66,"DAMAGE":264,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2473,"name":"Exquisite Astral Hammer","image":"items/hammer-astral.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":264,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":66,"DAMAGE":264,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2474,"name":"Exquisite Astral Hatchet","image":"items/hatchet-astral.png","skill":"Woodcutting","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"SKILL_SPEED":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":66}}}},{"item":{"id":2475,"name":"Exquisite Astral Sword","image":"items/sword-astral.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":264,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":66,"DAMAGE":264,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2476,"name":"Exquisite Astral Rod","image":"items/tool-astral-rod.png","skill":"Fishing","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"SKILL_SPEED":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":66}}}},{"item":{"id":2477,"name":"Exquisite Astral Pickaxe","image":"items/pickaxe-astral.png","skill":"Mining","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"SKILL_SPEED":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":66}}}},{"item":{"id":2478,"name":"Exquisite Astral Spade","image":"items/tool-astral-spade.png","skill":"Farming","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"SKILL_SPEED":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":66}}}},{"item":{"id":2479,"name":"Exquisite Astral Body","image":"items/armor-astral-body.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":5581200,"BUY_PRICE":0,"ARMOUR":44,"HEALTH":132}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":132,"ARMOUR":44,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2480,"name":"Exquisite Astral Boots","image":"items/armor-astral-boots.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ARMOUR":22,"HEALTH":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":66,"ARMOUR":22,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2481,"name":"Exquisite Astral Helmet","image":"items/armor-astral-helmet.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ARMOUR":22,"HEALTH":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":66,"ARMOUR":22,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2482,"name":"Exquisite Astral Gloves","image":"items/armor-astral-gloves.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ARMOUR":22,"HEALTH":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":66,"ARMOUR":22,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2483,"name":"Exquisite Astral Shield","image":"items/armor-astral-shield.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ARMOUR":22,"HEALTH":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":66,"ARMOUR":22,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2484,"name":"Exquisite Copper Spear","image":"items/spear-copper.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":48,"OCEAN_BLOCK":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2485,"name":"Exquisite Iron Spear","image":"items/spear-iron.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":84,"OCEAN_BLOCK":15,"COMBAT_EXP":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":21,"DAMAGE":84,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2486,"name":"Exquisite Silver Spear","image":"items/spear-silver.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":120,"OCEAN_BLOCK":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2487,"name":"Exquisite Gold Spear","image":"items/spear-gold.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":156,"OCEAN_BLOCK":15,"COMBAT_EXP":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":39,"DAMAGE":156,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2488,"name":"Exquisite Cobalt Spear","image":"items/spear-cobalt.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":192,"OCEAN_BLOCK":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2489,"name":"Exquisite Obsidian Spear","image":"items/spear-obsidian.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":228,"OCEAN_BLOCK":15,"COMBAT_EXP":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":57,"DAMAGE":228,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2490,"name":"Exquisite Astral Spear","image":"items/spear-astral.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":264,"OCEAN_BLOCK":15,"COMBAT_EXP":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":66,"DAMAGE":264,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2491,"name":"Exquisite Copper Scythe","image":"items/scythe-copper.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":48,"OCEAN_DAMAGE":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2492,"name":"Exquisite Iron Scythe","image":"items/scythe-iron.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":84,"OCEAN_DAMAGE":15,"COMBAT_EXP":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":21,"DAMAGE":84,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2493,"name":"Exquisite Silver Scythe","image":"items/scythe-silver.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":120,"OCEAN_DAMAGE":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2494,"name":"Exquisite Gold Scythe","image":"items/scythe-gold.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":156,"OCEAN_DAMAGE":15,"COMBAT_EXP":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":39,"DAMAGE":156,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2495,"name":"Exquisite Cobalt Scythe","image":"items/scythe-cobalt.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":192,"OCEAN_DAMAGE":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2496,"name":"Exquisite Obsidian Scythe","image":"items/scythe-obsidian.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":228,"OCEAN_DAMAGE":15,"COMBAT_EXP":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":57,"DAMAGE":228,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2497,"name":"Exquisite Astral Scythe","image":"items/scythe-astral.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":264,"OCEAN_DAMAGE":15,"COMBAT_EXP":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":66,"DAMAGE":264,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2498,"name":"Exquisite Copper Boomerang","image":"items/boomerang-copper.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3200,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":48,"FOREST_BLOCK":15,"COMBAT_EXP":12}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":12,"DAMAGE":48,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2499,"name":"Exquisite Iron Boomerang","image":"items/boomerang-iron.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":28800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":84,"FOREST_BLOCK":15,"COMBAT_EXP":21}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":21,"DAMAGE":84,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2500,"name":"Exquisite Silver Boomerang","image":"items/boomerang-silver.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":136800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":120,"FOREST_BLOCK":15,"COMBAT_EXP":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":30,"DAMAGE":120,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2501,"name":"Exquisite Gold Boomerang","image":"items/boomerang-gold.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":424800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":156,"FOREST_BLOCK":15,"COMBAT_EXP":39}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":39,"DAMAGE":156,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2502,"name":"Exquisite Cobalt Boomerang","image":"items/boomerang-cobalt.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1024800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":192,"FOREST_BLOCK":15,"COMBAT_EXP":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":48,"DAMAGE":192,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2503,"name":"Exquisite Obsidian Boomerang","image":"items/boomerang-obsidian.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2048800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":228,"FOREST_BLOCK":15,"COMBAT_EXP":57}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":57,"DAMAGE":228,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2504,"name":"Exquisite Astral Boomerang","image":"items/boomerang-astral.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3720800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":264,"FOREST_BLOCK":15,"COMBAT_EXP":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":66,"DAMAGE":264,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2505,"name":"Exquisite Infernal Bow","image":"items/bow-infernal.png","skill":"Ranged","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":300,"FOREST_DAMAGE":15,"COMBAT_EXP":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":75,"DAMAGE":300,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2506,"name":"Exquisite Infernal Hammer","image":"items/hammer-infernal.png","skill":"OneHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":300,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":75,"DAMAGE":300,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2507,"name":"Exquisite Infernal Hatchet","image":"items/hatchet-infernal.png","skill":"Woodcutting","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"SKILL_SPEED":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":75}}}},{"item":{"id":2508,"name":"Exquisite Infernal Sword","image":"items/sword-infernal.png","skill":"OneHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":300,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":75,"DAMAGE":300,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2509,"name":"Exquisite Infernal Rod","image":"items/tool-infernal-rod.png","skill":"Fishing","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"SKILL_SPEED":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":75}}}},{"item":{"id":2510,"name":"Exquisite Infernal Pickaxe","image":"items/pickaxe-infernal.png","skill":"Mining","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"SKILL_SPEED":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":75}}}},{"item":{"id":2511,"name":"Exquisite Infernal Spade","image":"items/tool-infernal-spade.png","skill":"Farming","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"SKILL_SPEED":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":75}}}},{"item":{"id":2512,"name":"Exquisite Infernal Body","image":"items/armor-infernal-body.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":9781200,"BUY_PRICE":0,"ARMOUR":50,"HEALTH":150}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":150,"ARMOUR":50,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2513,"name":"Exquisite Infernal Boots","image":"items/armor-infernal-boots.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ARMOUR":25,"HEALTH":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":75,"ARMOUR":25,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2514,"name":"Exquisite Infernal Helmet","image":"items/armor-infernal-helmet.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ARMOUR":25,"HEALTH":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":75,"ARMOUR":25,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2515,"name":"Exquisite Infernal Gloves","image":"items/armor-infernal-gloves.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ARMOUR":25,"HEALTH":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":75,"ARMOUR":25,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2516,"name":"Exquisite Infernal Shield","image":"items/armor-infernal-shield.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ARMOUR":25,"HEALTH":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":75,"ARMOUR":25,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2517,"name":"Exquisite Infernal Spear","image":"items/spear-infernal.png","skill":"TwoHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":300,"OCEAN_BLOCK":15,"COMBAT_EXP":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":75,"DAMAGE":300,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2518,"name":"Exquisite Infernal Scythe","image":"items/scythe-infernal.png","skill":"TwoHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":300,"OCEAN_DAMAGE":15,"COMBAT_EXP":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":75,"DAMAGE":300,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2519,"name":"Exquisite Infernal Boomerang","image":"items/boomerang-infernal.png","skill":"Ranged","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6520800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":300,"FOREST_BLOCK":15,"COMBAT_EXP":75}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":75,"DAMAGE":300,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2800,"name":"Perfect Copper Helmet","image":"items/armor-copper-helmet.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ARMOUR":5,"HEALTH":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":15,"ARMOUR":5,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2801,"name":"Perfect Copper Boots","image":"items/armor-copper-boots.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ARMOUR":5,"HEALTH":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":15,"ARMOUR":5,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2802,"name":"Perfect Copper Body","image":"items/armor-copper-body.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7200,"BUY_PRICE":0,"ARMOUR":10,"HEALTH":30}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":30,"ARMOUR":10,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2803,"name":"Perfect Copper Gloves","image":"items/armor-copper-gloves.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ARMOUR":5,"HEALTH":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":15,"ARMOUR":5,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2804,"name":"Perfect Copper Shield","image":"items/armor-copper-shield.png","skill":"Defense","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ARMOUR":5,"HEALTH":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":15,"ARMOUR":5,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2805,"name":"Perfect Iron Helmet","image":"items/armor-iron-helmet.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2806,"name":"Perfect Iron Boots","image":"items/armor-iron-boots.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2807,"name":"Perfect Iron Body","image":"items/armor-iron-body.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":61200,"BUY_PRICE":0,"ARMOUR":16,"HEALTH":48}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":48,"ARMOUR":16,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2808,"name":"Perfect Iron Gloves","image":"items/armor-iron-gloves.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2809,"name":"Perfect Iron Shield","image":"items/armor-iron-shield.png","skill":"Defense","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ARMOUR":8,"HEALTH":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":24,"ARMOUR":8,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2810,"name":"Perfect Silver Helmet","image":"items/armor-silver-helmet.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ARMOUR":11,"HEALTH":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":33,"ARMOUR":11,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2811,"name":"Perfect Silver Boots","image":"items/armor-silver-boots.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ARMOUR":11,"HEALTH":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":33,"ARMOUR":11,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2812,"name":"Perfect Silver Body","image":"items/armor-silver-body.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":277200,"BUY_PRICE":0,"ARMOUR":22,"HEALTH":66}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":66,"ARMOUR":22,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2813,"name":"Perfect Silver Gloves","image":"items/armor-silver-gloves.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ARMOUR":11,"HEALTH":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":33,"ARMOUR":11,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2814,"name":"Perfect Silver Shield","image":"items/armor-silver-shield.png","skill":"Defense","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ARMOUR":11,"HEALTH":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":33,"ARMOUR":11,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2815,"name":"Perfect Gold Helmet","image":"items/armor-gold-helmet.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2816,"name":"Perfect Gold Boots","image":"items/armor-gold-boots.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2817,"name":"Perfect Gold Body","image":"items/armor-gold-body.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":817200,"BUY_PRICE":0,"ARMOUR":28,"HEALTH":84}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":84,"ARMOUR":28,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2818,"name":"Perfect Gold Gloves","image":"items/armor-gold-gloves.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2819,"name":"Perfect Gold Shield","image":"items/armor-gold-shield.png","skill":"Defense","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ARMOUR":14,"HEALTH":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":42,"ARMOUR":14,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2820,"name":"Perfect Cobalt Body","image":"items/armor-cobalt-body.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1897200,"BUY_PRICE":0,"ARMOUR":34,"HEALTH":102}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":102,"ARMOUR":34,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2821,"name":"Perfect Cobalt Boots","image":"items/armor-cobalt-boots.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ARMOUR":17,"HEALTH":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":51,"ARMOUR":17,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2822,"name":"Perfect Cobalt Helmet","image":"items/armor-cobalt-helmet.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ARMOUR":17,"HEALTH":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":51,"ARMOUR":17,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2823,"name":"Perfect Cobalt Gloves","image":"items/armor-cobalt-gloves.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ARMOUR":17,"HEALTH":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":51,"ARMOUR":17,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2824,"name":"Perfect Cobalt Shield","image":"items/armor-cobalt-shield.png","skill":"Defense","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ARMOUR":17,"HEALTH":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":51,"ARMOUR":17,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2825,"name":"Perfect Obsidian Body","image":"items/armor-obsidian-body.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":3661200,"BUY_PRICE":0,"ARMOUR":40,"HEALTH":120}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":120,"ARMOUR":40,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2826,"name":"Perfect Obsidian Boots","image":"items/armor-obsidian-boots.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ARMOUR":20,"HEALTH":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":60,"ARMOUR":20,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2827,"name":"Perfect Obsidian Helmet","image":"items/armor-obsidian-helmet.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ARMOUR":20,"HEALTH":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":60,"ARMOUR":20,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2828,"name":"Perfect Obsidian Gloves","image":"items/armor-obsidian-gloves.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ARMOUR":20,"HEALTH":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":60,"ARMOUR":20,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2829,"name":"Perfect Obsidian Shield","image":"items/armor-obsidian-shield.png","skill":"Defense","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ARMOUR":20,"HEALTH":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":60,"ARMOUR":20,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2830,"name":"Perfect Copper Hammer","image":"items/hammer-copper.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":60,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":15,"DAMAGE":60,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2831,"name":"Perfect Copper Hatchet","image":"items/hatchet-copper.png","skill":"Woodcutting","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"SKILL_SPEED":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":15}}}},{"item":{"id":2832,"name":"Perfect Copper Sword","image":"items/sword-copper.png","skill":"OneHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":60,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":15,"DAMAGE":60,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2833,"name":"Perfect Copper Rod","image":"items/tool-copper-rod.png","skill":"Fishing","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"SKILL_SPEED":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":15}}}},{"item":{"id":2834,"name":"Perfect Copper Pickaxe","image":"items/pickaxe-copper.png","skill":"Mining","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"SKILL_SPEED":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":15}}}},{"item":{"id":2835,"name":"Perfect Copper Spade","image":"items/tool-copper-spade.png","skill":"Farming","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"SKILL_SPEED":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":15}}}},{"item":{"id":2836,"name":"Perfect Iron Hammer","image":"items/hammer-iron.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":96,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2837,"name":"Perfect Iron Hatchet","image":"items/hatchet-iron.png","skill":"Woodcutting","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"SKILL_SPEED":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":24}}}},{"item":{"id":2838,"name":"Perfect Iron Sword","image":"items/sword-iron.png","skill":"OneHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":96,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2839,"name":"Perfect Iron Rod","image":"items/tool-iron-rod.png","skill":"Fishing","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"SKILL_SPEED":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":24}}}},{"item":{"id":2840,"name":"Perfect Iron Pickaxe","image":"items/pickaxe-iron.png","skill":"Mining","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"SKILL_SPEED":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":24}}}},{"item":{"id":2841,"name":"Perfect Iron Spade","image":"items/tool-iron-spade.png","skill":"Farming","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"SKILL_SPEED":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":24}}}},{"item":{"id":2842,"name":"Perfect Silver Hammer","image":"items/hammer-silver.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":132,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":33,"DAMAGE":132,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2843,"name":"Perfect Silver Hatchet","image":"items/hatchet-silver.png","skill":"Woodcutting","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"SKILL_SPEED":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":33}}}},{"item":{"id":2844,"name":"Perfect Silver Sword","image":"items/sword-silver.png","skill":"OneHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":132,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":33,"DAMAGE":132,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2845,"name":"Perfect Silver Rod","image":"items/tool-silver-rod.png","skill":"Fishing","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"SKILL_SPEED":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":33}}}},{"item":{"id":2846,"name":"Perfect Silver Pickaxe","image":"items/pickaxe-silver.png","skill":"Mining","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"SKILL_SPEED":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":33}}}},{"item":{"id":2847,"name":"Perfect Silver Spade","image":"items/tool-silver-spade.png","skill":"Farming","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"SKILL_SPEED":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":33}}}},{"item":{"id":2848,"name":"Perfect Gold Hammer","image":"items/hammer-gold.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":168,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2849,"name":"Perfect Gold Hatchet","image":"items/hatchet-gold.png","skill":"Woodcutting","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"SKILL_SPEED":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":42}}}},{"item":{"id":2850,"name":"Perfect Gold Sword","image":"items/sword-gold.png","skill":"OneHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":168,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2851,"name":"Perfect Gold Rod","image":"items/tool-gold-rod.png","skill":"Fishing","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"SKILL_SPEED":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":42}}}},{"item":{"id":2852,"name":"Perfect Gold Pickaxe","image":"items/pickaxe-gold.png","skill":"Mining","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"SKILL_SPEED":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":42}}}},{"item":{"id":2853,"name":"Perfect Gold Spade","image":"items/tool-gold-spade.png","skill":"Farming","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"SKILL_SPEED":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":42}}}},{"item":{"id":2854,"name":"Perfect Cobalt Hammer","image":"items/hammer-cobalt.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":204,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":51,"DAMAGE":204,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2855,"name":"Perfect Cobalt Hatchet","image":"items/hatchet-cobalt.png","skill":"Woodcutting","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"SKILL_SPEED":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":51}}}},{"item":{"id":2856,"name":"Perfect Cobalt Sword","image":"items/sword-cobalt.png","skill":"OneHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":204,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":51,"DAMAGE":204,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2857,"name":"Perfect Cobalt Rod","image":"items/tool-cobalt-rod.png","skill":"Fishing","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"SKILL_SPEED":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":51}}}},{"item":{"id":2858,"name":"Perfect Cobalt Pickaxe","image":"items/pickaxe-cobalt.png","skill":"Mining","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"SKILL_SPEED":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":51}}}},{"item":{"id":2859,"name":"Perfect Cobalt Spade","image":"items/tool-cobalt-spade.png","skill":"Farming","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"SKILL_SPEED":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":51}}}},{"item":{"id":2860,"name":"Perfect Obsidian Hammer","image":"items/hammer-obsidian.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":240,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":60,"DAMAGE":240,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2861,"name":"Perfect Obsidian Hatchet","image":"items/hatchet-obsidian.png","skill":"Woodcutting","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"SKILL_SPEED":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":60}}}},{"item":{"id":2862,"name":"Perfect Obsidian Sword","image":"items/sword-obsidian.png","skill":"OneHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":240,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":60,"DAMAGE":240,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2863,"name":"Perfect Obsidian Rod","image":"items/tool-obsidian-rod.png","skill":"Fishing","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"SKILL_SPEED":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":60}}}},{"item":{"id":2864,"name":"Perfect Obsidian Pickaxe","image":"items/pickaxe-obsidian.png","skill":"Mining","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"SKILL_SPEED":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":60}}}},{"item":{"id":2865,"name":"Perfect Obsidian Spade","image":"items/tool-obsidian-spade.png","skill":"Farming","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"SKILL_SPEED":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":60}}}},{"item":{"id":2866,"name":"Perfect Copper Bow","image":"items/bow-copper.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":60,"FOREST_DAMAGE":15,"COMBAT_EXP":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":15,"DAMAGE":60,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2867,"name":"Perfect Iron Bow","image":"items/bow-iron.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":96,"FOREST_DAMAGE":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2868,"name":"Perfect Silver Bow","image":"items/bow-silver.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":132,"FOREST_DAMAGE":15,"COMBAT_EXP":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":33,"DAMAGE":132,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2869,"name":"Perfect Gold Bow","image":"items/bow-gold.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":168,"FOREST_DAMAGE":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2870,"name":"Perfect Cobalt Bow","image":"items/bow-cobalt.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":204,"FOREST_DAMAGE":15,"COMBAT_EXP":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":51,"DAMAGE":204,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2871,"name":"Perfect Obsidian Bow","image":"items/bow-obsidian.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":240,"FOREST_DAMAGE":15,"COMBAT_EXP":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":60,"DAMAGE":240,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2872,"name":"Perfect Astral Bow","image":"items/bow-astral.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":276,"FOREST_DAMAGE":15,"COMBAT_EXP":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":69,"DAMAGE":276,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2873,"name":"Perfect Astral Hammer","image":"items/hammer-astral.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":276,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":69,"DAMAGE":276,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2874,"name":"Perfect Astral Hatchet","image":"items/hatchet-astral.png","skill":"Woodcutting","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"SKILL_SPEED":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":69}}}},{"item":{"id":2875,"name":"Perfect Astral Sword","image":"items/sword-astral.png","skill":"OneHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":276,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":69,"DAMAGE":276,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2876,"name":"Perfect Astral Rod","image":"items/tool-astral-rod.png","skill":"Fishing","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"SKILL_SPEED":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":69}}}},{"item":{"id":2877,"name":"Perfect Astral Pickaxe","image":"items/pickaxe-astral.png","skill":"Mining","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"SKILL_SPEED":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":69}}}},{"item":{"id":2878,"name":"Perfect Astral Spade","image":"items/tool-astral-spade.png","skill":"Farming","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"SKILL_SPEED":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":69}}}},{"item":{"id":2879,"name":"Perfect Astral Body","image":"items/armor-astral-body.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":6541200,"BUY_PRICE":0,"ARMOUR":46,"HEALTH":138}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":138,"ARMOUR":46,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2880,"name":"Perfect Astral Boots","image":"items/armor-astral-boots.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ARMOUR":23,"HEALTH":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":69,"ARMOUR":23,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2881,"name":"Perfect Astral Helmet","image":"items/armor-astral-helmet.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ARMOUR":23,"HEALTH":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":69,"ARMOUR":23,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2882,"name":"Perfect Astral Gloves","image":"items/armor-astral-gloves.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ARMOUR":23,"HEALTH":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":69,"ARMOUR":23,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2883,"name":"Perfect Astral Shield","image":"items/armor-astral-shield.png","skill":"Defense","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ARMOUR":23,"HEALTH":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":69,"ARMOUR":23,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2884,"name":"Perfect Copper Spear","image":"items/spear-copper.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":60,"OCEAN_BLOCK":15,"COMBAT_EXP":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":15,"DAMAGE":60,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2885,"name":"Perfect Iron Spear","image":"items/spear-iron.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":96,"OCEAN_BLOCK":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2886,"name":"Perfect Silver Spear","image":"items/spear-silver.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":132,"OCEAN_BLOCK":15,"COMBAT_EXP":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":33,"DAMAGE":132,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2887,"name":"Perfect Gold Spear","image":"items/spear-gold.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":168,"OCEAN_BLOCK":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2888,"name":"Perfect Cobalt Spear","image":"items/spear-cobalt.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":204,"OCEAN_BLOCK":15,"COMBAT_EXP":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":51,"DAMAGE":204,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2889,"name":"Perfect Obsidian Spear","image":"items/spear-obsidian.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":240,"OCEAN_BLOCK":15,"COMBAT_EXP":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":60,"DAMAGE":240,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2890,"name":"Perfect Astral Spear","image":"items/spear-astral.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":276,"OCEAN_BLOCK":15,"COMBAT_EXP":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":69,"DAMAGE":276,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2891,"name":"Perfect Copper Scythe","image":"items/scythe-copper.png","skill":"TwoHanded","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":60,"OCEAN_DAMAGE":15,"COMBAT_EXP":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":15,"DAMAGE":60,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2892,"name":"Perfect Iron Scythe","image":"items/scythe-iron.png","skill":"TwoHanded","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":96,"OCEAN_DAMAGE":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2893,"name":"Perfect Silver Scythe","image":"items/scythe-silver.png","skill":"TwoHanded","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":132,"OCEAN_DAMAGE":15,"COMBAT_EXP":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":33,"DAMAGE":132,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2894,"name":"Perfect Gold Scythe","image":"items/scythe-gold.png","skill":"TwoHanded","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":168,"OCEAN_DAMAGE":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2895,"name":"Perfect Cobalt Scythe","image":"items/scythe-cobalt.png","skill":"TwoHanded","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":204,"OCEAN_DAMAGE":15,"COMBAT_EXP":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":51,"DAMAGE":204,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2896,"name":"Perfect Obsidian Scythe","image":"items/scythe-obsidian.png","skill":"TwoHanded","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":240,"OCEAN_DAMAGE":15,"COMBAT_EXP":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":60,"DAMAGE":240,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2897,"name":"Perfect Astral Scythe","image":"items/scythe-astral.png","skill":"TwoHanded","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":276,"OCEAN_DAMAGE":15,"COMBAT_EXP":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":69,"DAMAGE":276,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2898,"name":"Perfect Copper Boomerang","image":"items/boomerang-copper.png","skill":"Ranged","tier":1,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":60,"FOREST_BLOCK":15,"COMBAT_EXP":15}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":15,"DAMAGE":60,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2899,"name":"Perfect Iron Boomerang","image":"items/boomerang-iron.png","skill":"Ranged","tier":2,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":40800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":96,"FOREST_BLOCK":15,"COMBAT_EXP":24}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":24,"DAMAGE":96,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2900,"name":"Perfect Silver Boomerang","image":"items/boomerang-silver.png","skill":"Ranged","tier":3,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":184800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":132,"FOREST_BLOCK":15,"COMBAT_EXP":33}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":33,"DAMAGE":132,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2901,"name":"Perfect Gold Boomerang","image":"items/boomerang-gold.png","skill":"Ranged","tier":4,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":544800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":168,"FOREST_BLOCK":15,"COMBAT_EXP":42}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":42,"DAMAGE":168,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2902,"name":"Perfect Cobalt Boomerang","image":"items/boomerang-cobalt.png","skill":"Ranged","tier":5,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":1264800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":204,"FOREST_BLOCK":15,"COMBAT_EXP":51}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":51,"DAMAGE":204,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2903,"name":"Perfect Obsidian Boomerang","image":"items/boomerang-obsidian.png","skill":"Ranged","tier":6,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":2440800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":240,"FOREST_BLOCK":15,"COMBAT_EXP":60}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":60,"DAMAGE":240,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2904,"name":"Perfect Astral Boomerang","image":"items/boomerang-astral.png","skill":"Ranged","tier":7,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":4360800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":276,"FOREST_BLOCK":15,"COMBAT_EXP":69}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":69,"DAMAGE":276,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2905,"name":"Perfect Infernal Bow","image":"items/bow-infernal.png","skill":"Ranged","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":312,"FOREST_DAMAGE":15,"COMBAT_EXP":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":78,"DAMAGE":312,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}},{"item":{"id":2906,"name":"Perfect Infernal Hammer","image":"items/hammer-infernal.png","skill":"OneHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":312,"MOUNTAIN_BLOCK":15,"COMBAT_EXP":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":78,"DAMAGE":312,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2907,"name":"Perfect Infernal Hatchet","image":"items/hatchet-infernal.png","skill":"Woodcutting","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"SKILL_SPEED":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Woodcutting":78}}}},{"item":{"id":2908,"name":"Perfect Infernal Sword","image":"items/sword-infernal.png","skill":"OneHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":312,"MOUNTAIN_DAMAGE":15,"COMBAT_EXP":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":78,"DAMAGE":312,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"Mining":15,"Smelting":15,"Smithing":15,"OneHanded":15,"Defense":15}}}},{"item":{"id":2909,"name":"Perfect Infernal Rod","image":"items/tool-infernal-rod.png","skill":"Fishing","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"SKILL_SPEED":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Fishing":78}}}},{"item":{"id":2910,"name":"Perfect Infernal Pickaxe","image":"items/pickaxe-infernal.png","skill":"Mining","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"SKILL_SPEED":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Mining":78}}}},{"item":{"id":2911,"name":"Perfect Infernal Spade","image":"items/tool-infernal-spade.png","skill":"Farming","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"SKILL_SPEED":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"UNTRADEABLE":0},"bySkill":{"SKILL_SPEED":{"Farming":78}}}},{"item":{"id":2912,"name":"Perfect Infernal Body","image":"items/armor-infernal-body.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":11401200,"BUY_PRICE":0,"ARMOUR":52,"HEALTH":156}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":156,"ARMOUR":52,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2913,"name":"Perfect Infernal Boots","image":"items/armor-infernal-boots.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ARMOUR":26,"HEALTH":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":78,"ARMOUR":26,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2914,"name":"Perfect Infernal Helmet","image":"items/armor-infernal-helmet.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ARMOUR":26,"HEALTH":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":78,"ARMOUR":26,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2915,"name":"Perfect Infernal Gloves","image":"items/armor-infernal-gloves.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ARMOUR":26,"HEALTH":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":78,"ARMOUR":26,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2916,"name":"Perfect Infernal Shield","image":"items/armor-infernal-shield.png","skill":"Defense","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ARMOUR":26,"HEALTH":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"HEALTH":78,"ARMOUR":26,"UNTRADEABLE":0},"bySkill":{}}},{"item":{"id":2917,"name":"Perfect Infernal Spear","image":"items/spear-infernal.png","skill":"TwoHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":312,"OCEAN_BLOCK":15,"COMBAT_EXP":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":78,"DAMAGE":312,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2918,"name":"Perfect Infernal Scythe","image":"items/scythe-infernal.png","skill":"TwoHanded","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ATTACK_SPEED":5,"TWO_HANDED":true,"DAMAGE":312,"OCEAN_DAMAGE":15,"COMBAT_EXP":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":78,"DAMAGE":312,"UNTRADEABLE":0},"bySkill":{"DAMAGE_PERCENT":{"TwoHanded":15,"Enchanting":15,"Cooking":15,"Fishing":15,"Defense":15}}}},{"item":{"id":2919,"name":"Perfect Infernal Boomerang","image":"items/boomerang-infernal.png","skill":"Ranged","tier":8,"attributes":{"UNTRADEABLE":false,"SELL_PRICE":7600800,"BUY_PRICE":0,"ATTACK_SPEED":5,"DAMAGE":312,"FOREST_BLOCK":15,"COMBAT_EXP":78}},"charcoal":0,"compost":0,"arcanePowder":0,"petSnacks":0,"metalParts":0,"stats":{"global":{"ATTACK_SPEED":2.5,"COMBAT_EXP":78,"DAMAGE":312,"UNTRADEABLE":0},"bySkill":{"BLOCK_PERCENT":{"Ranged":15,"Alchemy":15,"Woodcutting":15,"Defense":15,"Farming":15}}}}]', 'public/list/item');
    request.listItemAttributes = () => requestWithFallback('[{"image":"/assets/misc/market.png","name":"Untradeable","technicalName":"UNTRADEABLE"},{"image":"/assets/misc/coin.png","name":"Sell Price","technicalName":"SELL_PRICE"},{"image":"/assets/misc/merchant.png","name":"Buy Price","technicalName":"BUY_PRICE"},{"image":"https://cdn-icons-png.flaticon.com/512/9742/9742828.png","name":"Level","technicalName":"LEVEL"},{"image":"https://cdn-icons-png.flaticon.com/512/3563/3563395.png","name":"Speed","technicalName":"SKILL_SPEED"},{"image":"https://cdn-icons-png.flaticon.com/512/3563/3563395.png","name":"Speed","technicalName":"ATTACK_SPEED"},{"image":"https://cdn-icons-png.flaticon.com/512/2842/2842219.png","name":"Two Handed","technicalName":"TWO_HANDED"},{"image":"https://cdn-icons-png.flaticon.com/512/9743/9743017.png","name":"Damage","technicalName":"DAMAGE"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Forest Damage","technicalName":"FOREST_DAMAGE"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Mountain Damage","technicalName":"MOUNTAIN_DAMAGE"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Ocean Damage","technicalName":"OCEAN_DAMAGE"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Dungeon Damage","technicalName":"DUNGEON_DAMAGE"},{"image":"https://cdn-icons-png.flaticon.com/512/2592/2592488.png","name":"Armour","technicalName":"ARMOUR"},{"image":"https://cdn-icons-png.flaticon.com/512/2589/2589054.png","name":"Health","technicalName":"HEALTH"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Percent Health","technicalName":"HEALTH_PERCENT"},{"image":"https://cdn-icons-png.flaticon.com/512/1635/1635524.png","name":"Heal","technicalName":"HEAL"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Forest Block Chance","technicalName":"FOREST_BLOCK"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Mountain Block Chance","technicalName":"MOUNTAIN_BLOCK"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Ocean Block Chance","technicalName":"OCEAN_BLOCK"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Dungeon Block Chance","technicalName":"DUNGEON_BLOCK"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Food Effect","technicalName":"FOOD_EFFECT"},{"image":"https://cdn-icons-png.flaticon.com/512/724/724811.png","name":"Bonus Level","technicalName":"BONUS_LEVEL"},{"image":"https://cdn-icons-png.flaticon.com/512/5448/5448211.png","name":"Duration","technicalName":"DURATION"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Base Combat Exp","technicalName":"COMBAT_EXP"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Gather Exp","technicalName":"DOUBLE_GATHER_EXP"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Crafting Exp","technicalName":"DOUBLE_CRAFT_EXP"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Combat Exp","technicalName":"DOUBLE_COMBAT_EXP"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Gather Loot","technicalName":"DOUBLE_GATHER_DROP"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Combat Loot","technicalName":"DOUBLE_COMBAT_DROP"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Crafting Preservation","technicalName":"CRAFT_PRESERVATION_CHANCE"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Key Preservation Chance","technicalName":"KEY_PRESERVATION_CHANCE"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Skill Efficiency","technicalName":"SPECIFIC_SKILL_EFFICIENCY"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Global Efficiency","technicalName":"ALL_SKILL_EFFICIENCY"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Global Exp","technicalName":"ALL_SKILL_EXP"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Opulent chance","technicalName":"OPULENT_CHANCE"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Tier variety chance","technicalName":"TIER_VARIETY_CHANCE"},{"image":"https://img.icons8.com/?size=48&id=12869&format=png","name":"Passive food consumption","technicalName":"PASSIVE_FOOD_CONSUMPTION"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Potion effect increase","technicalName":"INCREASED_POTION_EFFECT"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Potion duration decrease","technicalName":"DECREASED_POTION_DURATION"},{"image":"https://img.icons8.com/?size=48&id=51821&format=png","name":"Bone carve chance","technicalName":"CARVE_CHANCE"},{"image":"https://cdn-icons-png.flaticon.com/512/3012/3012388.png","name":"Multi Craft","technicalName":"MULTICRAFT"}]', 'public/list/itemAttribute');
    request.listMonsters = () => requestWithFallback('[{"id":1,"name":"Red Frog","image":"monsters/red-frog.png","attackStyle":"TwoHanded","level":10,"health":500,"attack":10,"armour":0,"speed":2.5},{"id":2,"name":"Leaf Hopper","image":"monsters/leaf-hopper.png","attackStyle":"TwoHanded","level":55,"health":1100,"attack":40,"armour":0,"speed":2},{"id":3,"name":"Snake","image":"monsters/black-snake.png","attackStyle":"Ranged","level":1,"health":300,"attack":5,"armour":0,"speed":3},{"id":4,"name":"Skeleton","image":"monsters/skeleton.png","attackStyle":"Ranged","level":10,"health":500,"attack":10,"armour":0,"speed":2.5},{"id":5,"name":"Tree Stump","image":"monsters/tree-stump.png","attackStyle":"TwoHanded","level":70,"health":1300,"attack":60,"armour":0,"speed":2},{"id":6,"name":"Ogre","image":"monsters/ogre.png","attackStyle":"Ranged","level":55,"health":1100,"attack":40,"armour":0,"speed":2},{"id":7,"name":"Goblin","image":"monsters/goblin.png","attackStyle":"Ranged","level":25,"health":700,"attack":15,"armour":0,"speed":2},{"id":8,"name":"Snail","image":"monsters/snail.png","attackStyle":"TwoHanded","level":1,"health":300,"attack":5,"armour":0,"speed":3},{"id":9,"name":"Green Slime","image":"monsters/green-slime.png","attackStyle":"TwoHanded","level":25,"health":700,"attack":15,"armour":0,"speed":2},{"id":10,"name":"Venus Flytrap","image":"monsters/venus-flytrap.png","attackStyle":"TwoHanded","level":85,"health":1500,"attack":90,"armour":0,"speed":2},{"id":11,"name":"Grey Wolf","image":"monsters/grey-wolf.png","attackStyle":"Ranged","level":70,"health":1300,"attack":60,"armour":0,"speed":2},{"id":12,"name":"Lady Beetle","image":"monsters/lady-beetle.png","attackStyle":"TwoHanded","level":40,"health":900,"attack":25,"armour":0,"speed":2},{"id":15,"name":"Goblin Chief","image":"monsters/goblin-chief.png","attackStyle":"Ranged","level":40,"health":900,"attack":25,"armour":0,"speed":2},{"id":17,"name":"Sea Jelly","image":"monsters/sea-jelly.png","attackStyle":"OneHanded","level":1,"health":300,"attack":5,"armour":0,"speed":3},{"id":18,"name":"Blue Slime","image":"monsters/blue-slime.png","attackStyle":"OneHanded","level":25,"health":700,"attack":15,"armour":0,"speed":2},{"id":19,"name":"Jellyfish","image":"monsters/jellyfish.png","attackStyle":"OneHanded","level":70,"health":1300,"attack":60,"armour":0,"speed":2},{"id":20,"name":"Ice Fairy","image":"monsters/ice-fairy.png","attackStyle":"OneHanded","level":40,"health":900,"attack":25,"armour":0,"speed":2},{"id":21,"name":"Hermit Crab","image":"monsters/hermit-crab.png","attackStyle":"OneHanded","level":10,"health":500,"attack":10,"armour":0,"speed":2.5},{"id":22,"name":"Coral Snail","image":"monsters/coral-snail.png","attackStyle":"OneHanded","level":55,"health":1100,"attack":40,"armour":0,"speed":2},{"id":23,"name":"Rock Dweller","image":"monsters/rock-dweller.png","attackStyle":"OneHanded","level":85,"health":1500,"attack":90,"armour":0,"speed":2},{"id":24,"name":"Griffin","image":"monsters/griffin.png","attackStyle":"Ranged","level":85,"health":1500,"attack":90,"armour":0,"speed":2},{"id":25,"name":"Treant","image":"monsters/treant.png","attackStyle":"TwoHanded","level":100,"health":1700,"attack":140,"armour":0,"speed":2},{"id":26,"name":"Efreet","image":"monsters/efreet.png","attackStyle":"Ranged","level":100,"health":1700,"attack":140,"armour":0,"speed":2},{"id":27,"name":"Frost Wolf","image":"monsters/frost-wolf.png","attackStyle":"OneHanded","level":100,"health":1700,"attack":140,"armour":0,"speed":2},{"id":200,"name":"Enraged Green Slime","image":"monsters/green-slime.png","attackStyle":"TwoHanded","level":25,"health":700,"attack":25,"armour":0,"speed":2},{"id":201,"name":"Lady Bettle the Beetle","image":"monsters/lady-beetle.png","attackStyle":"TwoHanded","level":40,"health":900,"attack":35,"armour":0,"speed":2},{"id":202,"name":"Enraged Leaf Hopper","image":"monsters/leaf-hopper.png","attackStyle":"TwoHanded","level":55,"health":1100,"attack":55,"armour":0,"speed":2},{"id":203,"name":"Enraged Tree Stump","image":"monsters/tree-stump.png","attackStyle":"TwoHanded","level":70,"health":1300,"attack":75,"armour":0,"speed":2},{"id":204,"name":"Enraged Venus Flytrap","image":"monsters/venus-flytrap.png","attackStyle":"TwoHanded","level":85,"health":1500,"attack":110,"armour":0,"speed":2},{"id":205,"name":"Enraged Treant","image":"monsters/treant.png","attackStyle":"TwoHanded","level":100,"health":1700,"attack":155,"armour":0,"speed":2},{"id":210,"name":"Enraged Goblin","image":"monsters/goblin.png","attackStyle":"Ranged","level":25,"health":700,"attack":25,"armour":0,"speed":2},{"id":211,"name":"Enraged Goblin Chief","image":"monsters/goblin-chief.png","attackStyle":"Ranged","level":40,"health":900,"attack":35,"armour":0,"speed":2},{"id":212,"name":"Enraged Ogre","image":"monsters/ogre.png","attackStyle":"Ranged","level":55,"health":1100,"attack":55,"armour":0,"speed":2},{"id":213,"name":"Enraged Grey Wolf","image":"monsters/grey-wolf.png","attackStyle":"Ranged","level":70,"health":1300,"attack":75,"armour":0,"speed":2},{"id":214,"name":"Enraged Griffin","image":"monsters/griffin.png","attackStyle":"Ranged","level":85,"health":1500,"attack":110,"armour":0,"speed":2},{"id":215,"name":"Enraged Efreet","image":"monsters/efreet.png","attackStyle":"Ranged","level":100,"health":1700,"attack":155,"armour":0,"speed":2},{"id":220,"name":"Enraged Blue Slime","image":"monsters/blue-slime.png","attackStyle":"OneHanded","level":25,"health":700,"attack":25,"armour":0,"speed":2},{"id":221,"name":"Enraged Ice Fairy","image":"monsters/ice-fairy.png","attackStyle":"OneHanded","level":40,"health":900,"attack":35,"armour":0,"speed":2},{"id":222,"name":"Enraged Coral Snail","image":"monsters/coral-snail.png","attackStyle":"OneHanded","level":55,"health":1100,"attack":55,"armour":0,"speed":2},{"id":223,"name":"Enraged Jellyfish","image":"monsters/jellyfish.png","attackStyle":"OneHanded","level":70,"health":1300,"attack":75,"armour":0,"speed":2},{"id":224,"name":"Enraged Rock Dweller","image":"monsters/rock-dweller.png","attackStyle":"OneHanded","level":85,"health":1500,"attack":110,"armour":0,"speed":2},{"id":225,"name":"Enraged Frost Wolf","image":"monsters/frost-wolf.png","attackStyle":"OneHanded","level":100,"health":1700,"attack":155,"armour":0,"speed":2},{"id":100,"name":"Dungeon Icicle","image":"monsters/icicle.png","attackStyle":null,"level":25,"health":900,"attack":25,"armour":0,"speed":2},{"id":101,"name":"Dungeon Ice Serpent","image":"monsters/ice-serpent.png","attackStyle":null,"level":25,"health":900,"attack":25,"armour":0,"speed":2},{"id":102,"name":"Dungeon Ice Fairy","image":"monsters/ice-fairy.png","attackStyle":null,"level":25,"health":900,"attack":25,"armour":0,"speed":2},{"id":103,"name":"Dungeon Hermit Crab","image":"monsters/hermit-crab.png","attackStyle":null,"level":55,"health":1300,"attack":60,"armour":0,"speed":2},{"id":104,"name":"Dungeon Sea Snail","image":"monsters/sea-snail.png","attackStyle":null,"level":55,"health":1300,"attack":60,"armour":0,"speed":2},{"id":105,"name":"Dungeon Rock Dweller","image":"monsters/rock-dweller.png","attackStyle":null,"level":55,"health":1300,"attack":60,"armour":0,"speed":2},{"id":106,"name":"Dungeon Grey Wolf","image":"monsters/grey-wolf.png","attackStyle":null,"level":70,"health":1500,"attack":90,"armour":0,"speed":2},{"id":107,"name":"Dungeon Ogre","image":"monsters/ogre.png","attackStyle":null,"level":70,"health":1500,"attack":90,"armour":0,"speed":2},{"id":108,"name":"Dungeon Cyclops","image":"monsters/cyclops.png","attackStyle":null,"level":70,"health":1500,"attack":90,"armour":0,"speed":2},{"id":109,"name":"Dungeon Ghoul","image":"monsters/ghoul.png","attackStyle":null,"level":40,"health":1100,"attack":40,"armour":0,"speed":2},{"id":110,"name":"Dungeon Spectre","image":"monsters/spectre.png","attackStyle":null,"level":40,"health":1100,"attack":40,"armour":0,"speed":2},{"id":111,"name":"Dungeon Skeleton","image":"monsters/skeleton.png","attackStyle":null,"level":40,"health":1100,"attack":40,"armour":0,"speed":2},{"id":112,"name":"Dungeon Red Imp","image":"monsters/red-imp.png","attackStyle":null,"level":85,"health":1700,"attack":140,"armour":0,"speed":2},{"id":113,"name":"Dungeon Efreet","image":"monsters/efreet.png","attackStyle":null,"level":85,"health":1700,"attack":140,"armour":0,"speed":2},{"id":114,"name":"Dungeon Cerberus","image":"monsters/cerberus.png","attackStyle":null,"level":85,"health":1700,"attack":140,"armour":0,"speed":2},{"id":115,"name":"Dungeon Mimic","image":"monsters/mimic.png","attackStyle":null,"level":100,"health":1900,"attack":225,"armour":0,"speed":2},{"id":116,"name":"Dungeon Genie","image":"monsters/genie.png","attackStyle":null,"level":100,"health":1900,"attack":225,"armour":0,"speed":2},{"id":117,"name":"Dungeon Wizard","image":"monsters/wizard.png","attackStyle":null,"level":100,"health":1900,"attack":225,"armour":0,"speed":2}]', 'public/list/monster');
    ...
    request.listStructures = () => requestWithFallback('[{"id":1,"name":"Cooking Pot","regular":{"global":{},"bySkill":{"SKILL_SPEED":{"Cooking":9}}},"enchant":{"global":{},"bySkill":{"EFFICIENCY_PERCENT":{"Cooking":1}}}},{"id":2,"name":"Furnace","regular":{"global":{},"bySkill":{"SKILL_SPEED":{"Smelting":9}}},"enchant":{"global":{},"bySkill":{"EFFICIENCY_PERCENT":{"Smelting":1}}}},{"id":4,"name":"Anvil","regular":{"global":{},"bySkill":{"SKILL_SPEED":{"Smithing":9}}},"enchant":{"global":{},"bySkill":{"EFFICIENCY_PERCENT":{"Smithing":1}}}},{"id":5,"name":"Enchanting Table","regular":{"global":{},"bySkill":{"SKILL_SPEED":{"Enchanting":9}}},"enchant":{"global":{},"bySkill":{"EFFICIENCY_PERCENT":{"Enchanting":1}}}},{"id":6,"name":"Alchemy Lab","regular":{"global":{},"bySkill":{"SKILL_SPEED":{"Alchemy":9}}},"enchant":{"global":{},"bySkill":{"EFFICIENCY_PERCENT":{"Alchemy":1}}}},{"id":7,"name":"Smelter","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":8,"name":"Spit Roast","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":9,"name":"Cauldron","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":10,"name":"Kiln","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":1001,"name":"Guild Hall","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":1002,"name":"Guild Library","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":1003,"name":"Guild Bank","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":1004,"name":"Guild Storehouse","regular":{"global":{},"bySkill":{"EFFICIENCY_PERCENT":{"Mining":1,"Woodcutting":1,"Fishing":1,"Farming":1}}},"enchant":{"global":{},"bySkill":{}}},{"id":1005,"name":"Guild Workshop","regular":{"global":{},"bySkill":{"EFFICIENCY_PERCENT":{"Enchanting":1,"Cooking":1,"Alchemy":1,"Smelting":1,"Smithing":1}}},"enchant":{"global":{},"bySkill":{}}},{"id":1006,"name":"Guild Armoury","regular":{"global":{},"bySkill":{"EFFICIENCY_PERCENT":{"Ranged":1,"TwoHanded":1,"OneHanded":1,"Defense":1}}},"enchant":{"global":{},"bySkill":{}}},{"id":1007,"name":"Guild Event Hall","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":2001,"name":"Pet Barn","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}},{"id":2002,"name":"Pet Training Grounds","regular":{"global":{},"bySkill":{}},"enchant":{"global":{},"bySkill":{}}}]', 'public/list/structure');
...
window.moduleRegistry.add('marketPriceButtons', (configuration, util, elementWatcher, colorMapper) => {
    ...
    async function addPriceButtons(type) {
        ...
        // Botão "better": ajustado para funcionar de acordo com o tipo
        const betterButton = createButton('better', () => {
            if (type === 'order') {
                // Para "order", adiciona 1 ao maior valor de mercado
                return findPrice('Market Highest') + 1;
            } else if (type === 'sell') {
                // Para "sell", subtrai 1 do menor valor de mercado
                return findPrice('Market Lowest') - 1;
            }
        }, priceRowInput);
        buttonsContainer.append(betterButton);
