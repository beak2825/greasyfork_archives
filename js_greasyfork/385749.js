...
// @downloadURL https://update.greasyfork.org/scripts/385749/For%20Lune%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/385749/For%20Lune%20Script.meta.js
// ==/UserScript==
...
// Cosmetics //
///////////////
GM_addStyle('#logo {background-image: url("https://cdn.discordapp.com/attachments/426002425133006848/588349230842642433/20190612_154936.JPG");}');
...
$('#server-tab-eu').text('for Lune');
$("#server-tab-eu").css({
    "color":"green"
});
$('#server-tab-na').text('not for Lune');
$("#server-tab-na").css({
    "color":"orange"
});
$('#server-tab-ap').text('for Arrow');
$("#server-tab-ap").css({
    "color":"red"
});

$('#btn-play').text('Lune Rekt Noobs');
$('#btn-servers').text('Noob Rooms');
$('#profile-clan-membership').text('Lune Queen <3');
$(".main-bottom-left").append('<a id="APEX D." href="https://discord.gg/X6HTueA" target="_blank">Lune <3</a>');
$("#umdiscord").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "#fff",
...
$("#main-content").append('<a id="umroster" href="https://www.youtube.com/channel/UC4W8B1ZuARBq3juAHsNd9-Q" target="_blank">My Queens Channel</a>');
$("#umroster").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "#fff",
...
console.log("%cLUNE<3 Script is enabled. Message Arrow(Arrow#3144) on discord for needed help.", "font-size: 25px; font-weight: bold; background: red; color: white; padding: 10px; border: solid 2px orange;");
