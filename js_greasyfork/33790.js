...
// @downloadURL https://update.greasyfork.org/scripts/33790/Hide%20Today%202.user.js
// @updateURL https://update.greasyfork.org/scripts/33790/Hide%20Today%202.meta.js
// ==/UserScript==
...
if ($('li:contains("2771")').length) {
    ...
    number.append('<br>');
    createButton('Limited', 0,1);
    number.append('<br>');
    createButton('Not a Restaurant', 0,0);
    number.append('<br>');
