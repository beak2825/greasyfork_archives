...
// @author       Veronika Grasso
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license      MIT
// @collaborator Veronika
// @icon https://takocode.ru/assets/imgs/avatar.gif
// @downloadURL https://update.greasyfork.org/scripts/484902/Sochi%20%7C%20Forum%20Curators%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/484902/Sochi%20%7C%20Forum%20Curators%20Script.meta.js
// ==/UserScript==
...
"[COLOR=rgb(255, 0, 0)][SIZE=4]2.16. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещен SK (Spawn Kill) — убийство или нанесение урона на титульной территории любой фракции / организации, на месте появления игрока, а также на выходе из закрытых интерьеров и около них[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Jail 60 минут / Warn (за два и более убийства) [/SIZE][/COLOR]<br>" +
    ...
    },
 {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[FONT=times new roman][COLOR=rgb(209, 213, 216)][I]В вашем случае возможен рассинхрон.<br>" +
        "Приятной игры на BLACK RUSSIA RolePlay.[/I][/COLOR][/FONT]<br>" +
        '[I][FONT=times new roman][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/I][/SIZE][/CENTER]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    {
      title: 'Не указал таймкоды после 24 часов',
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[FONT=times new roman][COLOR=rgb(209, 213, 216)][I]Вы не указали таймкоды в течении 24 часов.<br>" +
        "Приятной игры на BLACK RUSSIA RolePlay.[/I][/COLOR][/FONT]<br>" +
        '[I][FONT=times new roman][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/I][/SIZE][/CENTER]',
      prefix: UNACCEPT_PREFIX,
      status: false,
...
$(document).ready(() => {
    ...
    $(`button#selectAnswer`).click(() => {
        XF.alert(buttonsMarkup(buttons), null, 'Выберите вердикт by @kirillsokol | Veronika_Grasso + Vladislav_Cromwel =  ❤️ 💋');
