...
// @downloadURL https://update.greasyfork.org/scripts/563992/zhangyihan.user.js
// @updateURL https://update.greasyfork.org/scripts/563992/zhangyihan.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "LEIYA XU";
    const NEW_NAME = "ZHANG YIHAN";
    const NEW_BIRTHDAY = "(**1010)";
    const NEW_EXPIRE_DATE = "2034-07-17";
