...
// @downloadURL https://update.greasyfork.org/scripts/455189/%E6%B1%87%E6%89%8D_%E6%8F%90%E9%97%AE%E5%B0%8F%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/455189/%E6%B1%87%E6%89%8D_%E6%8F%90%E9%97%AE%E5%B0%8F%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
(function () {
  ...
  if (window.location.href.indexOf("ask") != -1) {
    ...
    //描述预填充
    const preFillContent = ['客户QQ号', '现象', '详情', '复现', '主要疑问', '已参考的文档', 'JAR包版本', '相关插件', '运行环境', '日志'].map(e => `<p>【${e}】：</p>`).join('');
    ...
    function radioOptionCallback4target(event) {
      ...
      if (value == "普通版") {
        ...
        $('#question-form > div.page-title > h1').append('<a name="my-link" target="_blank" href="https://kms.fineres.com/pages/viewpage.action?pageId=442176802">&nbsp;&nbsp;&nbsp;&nbsp;请熟读问答规范</a>')
...
`;
  ...
  window.addCss(`div[id^=comments-link-] { display: none;}`);
