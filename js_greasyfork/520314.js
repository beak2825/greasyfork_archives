...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/520314/%D0%94%D0%BB%D1%8F%20%D0%97%D0%B0%D1%85%D0%B0%D1%80%D0%B0%20%7C%20KHABAROVSK.user.js
// @updateURL https://update.greasyfork.org/scripts/520314/%D0%94%D0%BB%D1%8F%20%D0%97%D0%B0%D1%85%D0%B0%D1%80%D0%B0%20%7C%20KHABAROVSK.meta.js
// ==/UserScript==
...
(function () {
  ...
  "[B][CENTER][FONT=Verdana][SIZE=3][COLOR=lavender] Ваша заявка для постановления на должность [COLOR=#2C82C9] Рядового [/COLOR] получает статус [COLOR=GREEN]одобрено[/COLOR][/SIZE][/FONT]"+
    "[B][CENTER][COLOR=lavender][FONT=Verdana][Color=WHITE]Когда будете в игре подходите к нашему зданию и позвоните нам[/FONT][/B][/CENTER][/COLOR]" +
                "[SIZE=4][B][CENTER][COLOR=white][FONT=Verdana] C уважением подполковник ФСБ Zahar_Moretti. [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua] [/FONT][/COLOR][/SIZE][/CENTER][/B]"+
