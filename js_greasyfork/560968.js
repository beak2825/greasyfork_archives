// ==UserScript==
// @name         Stremio Web Skip Intro (Official Web Port)
// @namespace    http://tampermonkey.net/
// @version      1.1.0
// @description  Porting Skip Intro plugin to official Stremio Web from Stremio Enhanced
// @author       shugi12345 and RehanDilawar (Adapted for UserScript)
// @match        https://web.stremio.com/*
// @match        https://web.strem.io/*
// @license MIT
// @icon         https://web.stremio.com/images/stremio_symbol.png
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/560968/Stremio%20Web%20Skip%20Intro%20%28Official%20Web%20Port%29.user.js
// @updateURL https://update.greasyfork.org/scripts/560968/Stremio%20Web%20Skip%20Intro%20%28Official%20Web%20Port%29.meta.js
// ==/UserScript==
...
(function () {
  ...
  function addSetupButton(iconBar) {
    ...
    Object.assign(icon, {
      src: "https://pic.onlinewebfonts.com/thumbnails/icons_464077.svg",
  ...
  async function showSkipButton() {
    ...
    const icon = document.createElement("img");
    icon.src = "https://uxwing.com/wp-content/themes/uxwing/download/controller-and-music/skip-icon.svg";
    icon.alt = "Skip icon";
