...
// @grant        Ryan Wolf
// @downloadURL https://update.greasyfork.org/scripts/429864/%3C%3E%20Kurt%20Mod%20-%205x5%20Duvar.user.js
// @updateURL https://update.greasyfork.org/scripts/429864/%3C%3E%20Kurt%20Mod%20-%205x5%20Duvar.meta.js
// ==/UserScript==
...
game.network.addRpcHandler("ReceiveChatMessage", e => {
   if (e.uid == game.world.myUid) {
    ...
    // Her Hangi Bir Base de 25 li Duvar Koyabilirsiniz Odununuzun Olması Yeterli
let mousePs = {};
