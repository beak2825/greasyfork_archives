// ==UserScript==
// @name          Modern HF - RipTide
// @namespace     http://hackforums.net/member.php?action=profile&uid=2991977
// @version       1.4
// @description   Revamp of hackforums flat theme
// @include       http://www.hackforums.net/*
// @include       http://hackforums.net/*
// @author        Nuance
// @require       https://code.jquery.com/jquery-2.1.4.min.js
// @require       https://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.8.0/highlight.min.js
// @resource      MainCSS https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/style2.6.css
// @resource      HLCSS https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/monokai.css 
// @grant         GM_addStyle
// @grant         GM_setValue
// @grant         GM_getValue
// @grant         GM_getResourceText
// @run-at        document-start
// @downloadURL https://update.greasyfork.org/scripts/20328/Modern%20HF%20-%20RipTide.user.js
// @updateURL https://update.greasyfork.org/scripts/20328/Modern%20HF%20-%20RipTide.meta.js
// ==/UserScript==
...
$(document).ready(function () {
    ...
    $('img[src$="http://hackforums.net/images/modern_bl/dot_folder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/dot_folder.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_hotfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/dot_hotfolder.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_hotlockfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/lock.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_lockfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/lock.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_newfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/dot_newfolder.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_newhotfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/dot_newhotfolder.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_newhotlockfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/lock.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_newlockfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/lock.png');
    $('img[src$="http://hackforums.net/images/modern_bl/folder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/folder.png');
    $('img[src$="http://hackforums.net/images/modern_bl/hotfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/hotfolder.png');
    $('img[src$="http://hackforums.net/images/modern_bl/hotlockfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/lock.png');
    $('img[src$="http://hackforums.net/images/modern_bl/lockfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/lock.png');
    $('img[src$="http://hackforums.net/images/modern_bl/newfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/newfolder.png');
    $('img[src$="http://hackforums.net/images/modern_bl/newhotfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/newhotfolder.png');
    $('img[src$="http://hackforums.net/images/modern_bl/newhotlockfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/lock.png');
    $('img[src$="http://hackforums.net/images/modern_bl/newlockfolder.gif"]').attr('src', 'https://df0b9a8aeab356f4cebe679949c0b6938d654bbe.googledrive.com/host/0Bww6QW9u8-HjdjNBUnM4dFdaYlE/icons/lock.png');
    ...
    $('a[href="http://hackforums.net/member.php?action=profile&uid=2991977"] > span[class^="largetext"]').append('<img title="Theme Dev" src="http://icons.iconarchive.com/icons/glyphish/glyphish/24/21-skull-icon.png" style="position: relative;top: 3px;left: 3px;"/>');
