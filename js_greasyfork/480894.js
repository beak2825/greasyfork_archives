// ==UserScript==
// @name         1206query_title恶劣正式标注版
// @namespace    http://tampermonkey.net/
// @version      6.0
// @description  1206query_title恶劣
// @author       Nex
...
// @license      Nex
// @connect      *
// @downloadURL https://update.greasyfork.org/scripts/480894/1206query_title%E6%81%B6%E5%8A%A3%E6%AD%A3%E5%BC%8F%E6%A0%87%E6%B3%A8%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/480894/1206query_title%E6%81%B6%E5%8A%A3%E6%AD%A3%E5%BC%8F%E6%A0%87%E6%B3%A8%E7%89%88.meta.js
// ==/UserScript==
...
(function() {
	...
	setTimeout(() => {
		...
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(0).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(0).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(1).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(1).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(2).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(2).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(3).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(3).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(4).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(4).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(5).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(5).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(6).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(6).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(7).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(7).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(8).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(8).text();
			window.open(url, '_blank');
		})
		$(".ant-col.ant-col-21.title_key___T6Yvm").eq(9).click(()=>{
			let url ='http://discover.sm.cn/2/#/auxiliary/engine_diff?q='+$(".ant-col.ant-col-21.title_key___T6Yvm").eq(9).text();
			window.open(url, '_blank');
		})
		//title
