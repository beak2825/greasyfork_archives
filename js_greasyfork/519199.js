...
// @downloadURL https://update.greasyfork.org/scripts/519199/Bflip%20Auto%20Rain.user.js
// @updateURL https://update.greasyfork.org/scripts/519199/Bflip%20Auto%20Rain.meta.js
// ==/UserScript==
...
window.addEventListener('load', () => {
    ...
    setInterval(async () => {
        let data = await (await fetch('https://api.bflip.com/chat/history')).json();
