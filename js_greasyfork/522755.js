...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/522755/Hunter%20Stumblechat%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/522755/Hunter%20Stumblechat%20Script.meta.js
// ==/UserScript==
let webSocket;
...
function isUserBanned(username) {
    ...
    const allowList = storedBans ? JSON.parse(storedBans) : [];

    console.log("Allow List:", allowList);

    // Check if the username is in the allow list
    const isAllowed = allowList.includes(username);
...
function createBanListDiv(banList) {
    ...
    fileInput.addEventListener("change", (event) => {
        ...
        reader.onload = (e) => {
            ...
            // Update ban list with the imported bans
