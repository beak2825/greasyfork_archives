...
// @version        4.3
// @include        https://subeta.net/quests.php/library*
// @include        https://subeta.net/quests.php/saggitarius*
// @include        https://subeta.net/quests.php/wizard*
// @include        https://subeta.net/quests.php/cursed*
// @include        https://subeta.net/quests.php/carl*
// @include        https://subeta.net/quests.php/maleria*
// @include        https://subeta.net/quests.php/pete*
// @include        https://subeta.net/quests.php/quentin*
// @include        https://subeta.net/quests.php/cinthia*
// @include        https://subeta.net/quests.php/lumicrypt*
// @require		   http://code.jquery.com/jquery-1.11.0.min.js
// @description    quester
// @run-at         document-end
// @downloadURL https://update.greasyfork.org/scripts/376232/Subeta%20Quester.user.js
// @updateURL https://update.greasyfork.org/scripts/376232/Subeta%20Quester.meta.js
// ==/UserScript==
...
var q;
if (window.location.href.toString().indexOf('quests.php/carl') > -1)
    q = new Quest('http://subeta.net/quests.php/carl', 1, 0, new Array(60000, 60000, 60000, 60000));
else if (window.location.href.toString().indexOf('quests.php/quentin') > -1)
    ...
    q = new Quest('http://subeta.net/quests.php/cinthia', 1, 0, new Array(50000, 50000, 50000, 50000));
      ...
      q = new Quest('http://subeta.net/quests.php/cursed', 1, 0, new Array(60000, 60000, 60000, 60000));
        ...
        q = new Quest('http://subeta.net/quests.php/library', 1, 0, new Array(50000, 50000, 50000, 50000));
else if (window.location.href.toString().indexOf('quests.php/library') > -1)
        q = new Quest('http://subeta.net/quests.php/lumicrypt', 1, 0, new Array(50000, 50000, 50000, 50000));
else if (window.location.href.toString().indexOf('quests.php/lumicrypt') > -1)
     q = new Quest('http://subeta.net/quests.php/lumicrypt', 1, 0, new Array(50000, 50000, 50000, 50000));
else if (window.location.href.toString().indexOf('quests.php/cursed') > -1)
{
    q = new Quest('http://subeta.net/quests.php/cursed', 1, 0, new Array(60000, 60000, 60000, 60000));
    ...
    q = new Quest('http://subeta.net/quests.php/library', 0, 0, new Array(50000, 80000, 100000, 200000));
else if (window.location.href.toString().indexOf('quests.php/sarah') > -1)
    q = new Quest('http://subeta.net/quests.php/sarah', 0, 0, new Array(20000, 20000, 20000, 20000));
...
if (html.indexOf(q.qData.btnStart) > -1) {
    ...
    if (html.indexOf('explore/carl.php') > -1)
        window.location.href = 'http://subeta.net/explore/carl.php';
    else
