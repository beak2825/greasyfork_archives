// ==UserScript==
// @name         shopline店铺api获取---payChannelInfo数据对比
// @namespace    http://tampermonkey.net/
// @version      2.8.7
// @description  shopline店铺api获取对比java和go服务响应
// @author       skyhuang
// @match        https://*.myshopline.com/*
// @match        https://*.myshoplinestg.com/*
// @include      https://*.myshopline.com/leproxy/api/trade/center/settle/main-site/detail
// @include      https://*.myshoplinestg.com/leproxy/api/trade/center/settle/main-site/detail
// @icon         data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==
// @license      AGPL License
// @grant        GM_xmlhttpRequest
// @connect      us-store.myshopline.com
// @downloadURL https://update.greasyfork.org/scripts/539470/shopline%E5%BA%97%E9%93%BAapi%E8%8E%B7%E5%8F%96---payChannelInfo%E6%95%B0%E6%8D%AE%E5%AF%B9%E6%AF%94.user.js
// @updateURL https://update.greasyfork.org/scripts/539470/shopline%E5%BA%97%E9%93%BAapi%E8%8E%B7%E5%8F%96---payChannelInfo%E6%95%B0%E6%8D%AE%E5%AF%B9%E6%AF%94.meta.js
// ==/UserScript==
    ...
    $(() => { 
        ...
        function addXMLRequestCallback(callback){
         ...
         function copy_request(xhr,response) {
            ...
            newXHR.setRequestHeader('Java-Server', true);
            ...
            newXHR.onload = function () {
                if (newXHR.status === 200) {
                    ...
                    // 这里添加你的响应对比逻辑
                    const result = compareObject(response_2['data']['payChannelInfo'],response['data']['payChannelInfo']);
                    console.log("payChannelInfo对比结果1: （tips:数组对象打印出来的null或{}是表示对比通过!!!", result);
                    console.log("payChannelInfo对比结果2: ",JSON.stringify(result));
                }
            };
    ...
    return resultObj
        ...
        addXMLRequestCallback( function( xhr ) {
            ...
            if ( xhr.readyState == 4 && xhr.status == 200 ) {
                if (xhr.responseURL.endsWith('/leproxy/api/trade/center/settle/main-site/detail')) {
