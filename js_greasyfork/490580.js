// ==UserScript==
// @name         🥇使用教程：直接打开章节会自动学习·超星/学习通网课小助手|修复视频播放|自动跳转任务点|
// @namespace    助手
// @version      4.2.11
// @author       助手
// @description  🏆使用教程：直接打开章节会自动学习 🥇
// @license      MIT
...
(function (vue, pinia, rxjs, md5, ElementPlus) {
  ...
  const useConfigStore = pinia.defineStore("configStore", {
    state: () => {
      ...
      const defaultConfig = {
        ...
        platformParams: {
          cx: {
            name: "超星网课助手Q群:808911108(群里有刷课软件分享）",
            parts: [
              {
                name: "章节设置",
                params: [
  ...
  const _hoisted_1$2 = /* @__PURE__ */ vue.createTextVNode("代看地址：yy.ffw-k.sbsQ群:808911108(群里有刷课软件分享）");
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createVNode(_component_el_input, {
            ...
            placeholder: "复制地址yy.ffw-k.sbs到浏览器即可QQ群924255206群里不定时发刷课软件"
          }, {
            prepend: vue.withCtx(() => [
          ...
          vue.withDirectives(vue.createElementVNode("div", null, [
            vue.createVNode(_component_el_empty, { description: "复制地址yy.ffw-k.sbs到浏览器即可Q群不定时发刷课软件" })
          ], 512), [
            [vue.vShow, !__props.questionList.length]
          ])
        ], 64);
  ...
  const _hoisted_3 = /* @__PURE__ */ vue.createElementVNode("a", null , "http://yy.ffw-k.sbs", -1);
  const _hoisted_4 = [
    _hoisted_2$1,
    _hoisted_3
  ];
        ...
        if (this.questions.length) {
          ...
          for (const [index, question] of this.questions.entries()) {
            ...
            if (answerData.code === 200) {
              ...
              question.answer[0] = answerData.msg + '<a style="font-weight: bold">或关注公众号“高校工具箱”</a>';
            }
              ...
              vue.createElementVNode("div", {
                ...
                vue.withDirectives(vue.createElementVNode("div", _hoisted_2, [
                  ...
                  isShow.value && !vue.unref(configStore).isMinus ? (vue.openBlock(), vue.createBlock(_component_el_tooltip, {
                    ...
                    effect: "dark",
                    placement: "top-start",
                    content: "<span>注意事项：<br/>请尽量使用新版，不要使用旧版。有人脸建议代看地址ffxc.2025ffwk.sbs<br/></span>",
                    "raw-content": ""
                  }, {
                    default: vue.withCtx(() => [
