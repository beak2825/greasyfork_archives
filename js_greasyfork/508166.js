// ==UserScript==
// @name         Скрипт для Руководства
// @namespace    https://forum.blackrussia.online
// @version      0.1
// @description  Скрипт для упрощения работы ГА/ЗГА/Кураторов администрации.
// @author       Madi_Stoyn Связь > https://vk.com/id728345994
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @icon         https://icons.iconarchive.com/icons/papirus-team/papirus-apps/48/emerald-theme-manager-icon-icon.png
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/508166/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/508166/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=#00FF00]Рассмотрено[/COLOR][/FONT][/CENTER]',
        ...
        },
        {
            ...
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Жалоба с неуважением к администрации не будет рассмотрена.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Отказано, Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=#00FF00]Одобрено[/COLOR], Закрыто.[/FONT][/CENTER]',
        ...
        },
        {
            ...
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            " Жалоба передана Основному Заместителю Главного Администратора.<br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
    ...
    $(document).ready(() => {
        ...
        addButton('Меню', 'selectAnswer', 'border-radius: 13px; background: #00ffff; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000; color: #000; ');
        addButton('На рассмотрение', 'pin', 'border-radius: 13px; background: #FFA500; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000;');
        addButton('Одобрить', 'accepted', 'border-radius: 13px; background: #00FF00; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000;');
        addButton('Отказать', 'unaccept', 'border-radius: 13px; background: #FF0000; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000;');
        addButton('Рассмотрено', 'watched', 'border-radius: 13px; background: #00FF00; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000;');
        addButton('Закрыть', 'closed', 'border-radius: 13px; background: #FF0000; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000;');
        addButton('КП', 'teamProject', 'border-radius: 13px; background: #FFFF00; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000; color: #000; ');
        addButton ('Спецу', 'specialAdmin', 'border-radius: 13px; background: #FF0000; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000;');
        addButton ('ГА', 'mainAdmin', 'border-radius: 13px; background: #FF0000; margin-right: 3px; margin-left: 3px; margin-top: 2px; margin-bottom: 2px; border: 2px; border-color: #000; color: #fff; ');
