// ==UserScript==
// @name           百度谷歌跳转
// @author         NLF&锐经(修改) ZY二次修改
// @description    方便的在各个搜索引擎之间跳转
// @license        everyone
// @version        1.1.2
// @created        2020-12-22
// @lastUpdated    2023-7-4
// @grant          none
// @run-at         document-start
// @namespace      https://greasyfork.org/zh-CN/users/205004-zy-g
// @homepage       https://greasyfork.org/zh-CN/users/205004-zy-g
// @include        *google*
// @include        *baidu.com*
// @downloadURL https://update.greasyfork.org/scripts/461484/%E7%99%BE%E5%BA%A6%E8%B0%B7%E6%AD%8C%E8%B7%B3%E8%BD%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/461484/%E7%99%BE%E5%BA%A6%E8%B0%B7%E6%AD%8C%E8%B7%B3%E8%BD%AC.meta.js
// ==/UserScript==
...
(function () {
	...
	/* 					keyword: function () {
			...
			engineList.web[0] = {
				...
				// 搜索引擎的站点图标
				favicon: 'data:image/png;base64,',
