...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/469868/SALE_AI_1.user.js
// @updateURL https://update.greasyfork.org/scripts/469868/SALE_AI_1.meta.js
// ==/UserScript==
                    ...
                    try{
                        if(event.data.byteLength>100 && start){
                            ...
                            // if(res.data['msgContent']){
                                ...
                                var da = {"accId":accID,"pwd":pwd,"stamp":stamp,"bind":bindACC,"agentId":agentId,"botWxid":res.data['botWxid'],"contactId":res.data['contactId'],"senderWxId":res.data['senderWxId'],"msgContent":res.data['msgContent'],"msgId":res.data['msgId'],"msgType":res.data['msgType'],"nickName":nickName,"groupName":groupName,"lsw":lsw,"odata":str}
                                // var da = res.data;
                                // da['accId'] = accID;
                                // da['pwd'] = pwd;
                                // da['stamp'] = stamp;
