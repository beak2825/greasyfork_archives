// ==UserScript==
// @name   🌱【免费版】学习公社|江西省智慧教育平台|中小学党校|如需自动看课换课无人值守等高级功能见收费版本：https://doc.zhanyc.cn/pages/xxgscj
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.5
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、自动换大类、全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.ttcdw.cn/*
// @include    *://*.jx.smartedu.cn/*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/503754/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%AD%A6%E4%B9%A0%E5%85%AC%E7%A4%BE%7C%E6%B1%9F%E8%A5%BF%E7%9C%81%E6%99%BA%E6%85%A7%E6%95%99%E8%82%B2%E5%B9%B3%E5%8F%B0%7C%E4%B8%AD%E5%B0%8F%E5%AD%A6%E5%85%9A%E6%A0%A1%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E7%9C%8B%E8%AF%BE%E6%8D%A2%E8%AF%BE%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxxgscj.user.js
// @updateURL https://update.greasyfork.org/scripts/503754/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%AD%A6%E4%B9%A0%E5%85%AC%E7%A4%BE%7C%E6%B1%9F%E8%A5%BF%E7%9C%81%E6%99%BA%E6%85%A7%E6%95%99%E8%82%B2%E5%B9%B3%E5%8F%B0%7C%E4%B8%AD%E5%B0%8F%E5%AD%A6%E5%85%9A%E6%A0%A1%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E7%9C%8B%E8%AF%BE%E6%8D%A2%E8%AF%BE%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxxgscj.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、自动换大类、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/xxgscj/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("p/course/v/")) {
                plugMain.page_video();
            } else if (url.includes("projectCenter/myClassroom/")) {
                plugMain.showPaidContent(`免费版本不包含自动下一集、自动换课程、自动换大类、全自动无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/study/projectCenter/projectIndex/")) {
                plugMain.showPaidContent(`免费版本不包含自动下一集、自动换课程、自动换大类、全自动无人值守功能，如需使用请安装收费版本`);
            } else if (/myClassroom\/\d+\/center\/\d+/.test(url)) {
                plugMain.showPaidContent(`免费版本不包含自动下一集、自动换课程、自动换大类、全自动无人值守功能，如需使用请安装收费版本`);
            }
        ...
        async page_video() {
            ...
            await plugMain.waitOf((a) => $(".course-info .video-title").length > 0);
            await plugMain.waitTimeout(2000);
            $(".video-title .four").each((i, el) => {
                if ($(el).text().trim() != "100%") {
                    $(el).click();
                    return false;
                }
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if ($("#comfirmClock:visible").length > 0) {
                        $("#comfirmClock:visible").click();
                        return;
                    }
