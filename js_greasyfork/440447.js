...
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/440447/NGA%20%E5%A4%9C%E9%97%B4%E6%A8%A1%E5%BC%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/440447/NGA%20%E5%A4%9C%E9%97%B4%E6%A8%A1%E5%BC%8F.meta.js
// ==/UserScript==
...
(function() {
  ...
  /* 正文引用 */
  .quote {background:var(--backGround1) !important;border:0px; padding: 0.3em 0.3em}
  /* 贴条 */
  .comment_c_1, .comment_c_2 {border: 0em !important;background:var(--backGround1) !important;}

  /* 搜索页,首页 */
  #indexblock, .catetitle, .contentBlock, .catenew .b2, .catenew .b3, .catenew .b4, .catenew {background-color: var(--backGround1) !important;}
  .catenew {border:0px solid; box-shadow: 0 0 15px -3px black !important; padding:0;margin:8px 0 0 0;}
  #sub_forums {background-color: var(--backGround1) !important;border: 1px solid var(--backGround1) !important;}
  .headline  {display: none !important;}  /* 隐藏首页图片 */
