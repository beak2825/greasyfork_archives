...
// @downloadURL https://update.greasyfork.org/scripts/449952/KF%20SKRIPT%20%7C%20Moscow%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/449952/KF%20SKRIPT%20%7C%20Moscow%20script.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        '[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Вам даётся 24 часа на дополнение пункта Юность и взрослая жизнь[/CENTER]",
      prefix: NARASSMOTRENIIBIO_PREFIX,
    },
    {
      ...
      content:
        '[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Вам даётся 24 часа на дополнение пункта Настоящее время[/CENTER]",
      prefix: NARASSMOTRENIIBIO_PREFIX,
    },
    {
      ...
      content:
        '[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Вам даётся 24 часа на дополнение пункта Хобби[/CENTER]",
      prefix: NARASSMOTRENIIBIO_PREFIX,
    },
    {
    ...
    {
      title: 'био отказ не от 3-го лица',
      content:
        '[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа послужило - Биография должна быть написана от третьего лица персонажа.[/I][/FONT][/CENTER]." ,
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
