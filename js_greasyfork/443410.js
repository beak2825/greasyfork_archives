...
// @name         Oldman_Crypto
// @name:zh-CN   老男人解密助手
// @namespace    https://bbs.oldmanemu.net
// @version      0.0.1
// @description  快速加解密评测文本
// @description:zh-CN  快速加解密评测文本
// @author       panndora
// @match        *://bbs.oldmanemu.net/*
...
// @connect      bbs.oldmanemu.net
// @license      AGPL-3.0
// @icon         https://bbs.oldmanemu.net/upload/avatar/000/22765.png
// @grant        GM_xmlhttpRequest
// @grant        GM_setClipboard
// @downloadURL https://update.greasyfork.org/scripts/443410/Oldman_Crypto.user.js
// @updateURL https://update.greasyfork.org/scripts/443410/Oldman_Crypto.meta.js
// ==/UserScript==

// 说明,该脚本是为steam上的密语所编写,版权归原作者Chr_所有,我只是把有效过滤元素与match修改成老男人论坛而已.
// 使用方法是选中密语,菜单出现. 然后点击需要的解密方案,浏览器右边出现解密面板.
...
function addPanel() {
    ...
    let lblUrl = genA('Panndora', 'overpan@foxmail.com');
    let lblFeed = genA('[反馈]', 'https://bbs.oldmanemu.net/thread-16255.htm');
...
function toolbarCallback(mode) {
    ...
    if (bm.value == 'encode') {
        o.value = str;
        encode();
        // 尝试取消选中,反正窗口都打开了. 如果这里不解除框选的话,在任何地方点鼠标都会出来菜单,还可能会重叠.
