// ==UserScript==
// @name         Super Kirby Clash Theme
// @namespace    http://tampermonkey.net/
// @version      0.20
// @description  T99's Super Kirby Clash theme for Jstris
// @author       Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT

// @downloadURL https://update.greasyfork.org/scripts/390357/Super%20Kirby%20Clash%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/390357/Super%20Kirby%20Clash%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/3RcauDs.png",48);
        loadGhostSkin("https://i.imgur.com/9doYRHT.png",48);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/rHTGR0B.png')";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_lock.wav",abs:1};
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/t99ready.wav",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_go.wav",abs:1,set:0};
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_died.wav",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/t99hold.wav",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_move.wav",abs:1,set:0};
...
function atGameStart() {
    ...
    img.src = "https://i.imgur.com/jhBhXOg.png";
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_tspinsingle.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_tspinsingle.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_clear1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_tspindouble.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_tspintriple.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_clear4.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_clear5.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/t99_perfectclear.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_b2btspin.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_b2btetris.mp3"
];
...
Game['rotationSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_rotate.wav", //rotate left
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_rotate.wav", //rotate right
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirby_rotate.wav" //rotate 180°
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirbysong1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirbysong2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Kirbysong3.wav"
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/Kirbysong1.wav"
