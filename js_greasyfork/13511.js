...
// @icon                data:image/png;base64,
// @downloadURL https://update.greasyfork.org/scripts/13511/WME%20Validator%20Localization%20for%20California.user.js
// @updateURL https://update.greasyfork.org/scripts/13511/WME%20Validator%20Localization%20for%20California.meta.js
// ==/UserScript==
//
/*
Updated for US English language compatibility
*/
...
window.WME_Validator_United_States = {
  ...
  ".author": "xanderb",
  ".updated": "2017-03-30",
  ".link": "https://greasyfork.org/en/scripts/13511-wme-validator-localization-for-california",
  ".lng": "EN-US",
  ...
  "130.params": {
    ...
    "problemEN": "California uses SR-xx or CA-xx for state and US-xx for national highway names",
    "solutionEN": "Rename the Street or Alt Street",
    "template": "${street}#${altStreet[#]}",
    "regexp": "/.*(Ca (Hwy|Rte) |St(ate)? ([Hh](WY|wy|ighway)|R(ou)?te|R(oa)?d) |SH-|(SR|CA)=|^R(ou)?te |St(ate)? R(ou)?te-|U.?[Ss].? [Hh](WY|wy|ighway))/"
  },
  "130.solutionLink": "W:Highway_naming/USA",
  "130.title.en": "Custom check",
  "130.title": "Incorrect State Highway",
  "130.problem.en": "The segment matched custom conditions",
  "130.problem": "California uses SR-xx or CA-xx for state and US-xx for national highway names",
  "130.solution.en": "Solve the issue",
  "130.solution": "Rename the Street or Alt Street",
  "131.enabled": true,
  "131.params": {
  ...
  "131.solutionLink": "W:Abbreviations_and_acronyms#Standard_suffix_abbreviations/USA",
  ...
  "132.params": {
    ...
    "regexp": "/^California:.*(Cs-|CS-|Co(unty)? ([Hh](WY|wy|ighway)|R(ou)?te|R(oa)?d)( |-) |Cr-|C[Hh]-)/"
  },
  ...
  "133.params": {
    ...
    "regexp": "/^[1-9][^2-5]:.*#((State Hwy |State Rte |SR-|SH-|CA-|IL-|IN-|K-|LA-|M-|MA-|MO-|MS-|NC-|ND-|NJ-|NV-|NY-|SC-|SD-|TN-|VT-|WV-|WIS-)[0-9]+( ALT| BYP| CONN| TRUCK| Scenic| [NSWE])*|(US Hwy |US-)[0-9]+( BUS| LOOP| SPUR)+( [NSWE])?)@/i"
  },
  ...
  "135.enabled": true,
  "135.params": {
    "titleEN": "Not California",
    "problem": "The segment is assigned to another state",
    "solutionEN": "Make sure you are editing in CA and change it",
    "template": "${state}",
    "regexp": "!/California/"
  },
  "135.solutionLink": "W:Creating_and_editing_road_segments#Address_Properties",
  "135.title.en": "Custom check",
  "135.title": "Not California",
  "135.problem.en": "The segment matched custom conditions",
  "135.problem": "The segment is assigned to another state",
  "135.solution.en": "Solve the issue",
  "135.solution": "Make sure you are editing in CA and change it",
  "136.enabled": true,
  "136.params": {
  ...
  "137.title": "Invalid Interstate Name",
  "137.problem.en": "The segment matched custom conditions",
  "137.problem": "There seems to be an extra space there",
  "137.solution.en": "Solve the issue",
  "137.solution": "Remove the extra space in the name",
  "138.enabled": true,
  "138.params": {
  ...
  "138.title": "The legendary Portola Valley smudge",
  "138.problem.en": "The segment matched custom conditions",
  "138.problem": "Portola Valley is on segments that it should not be",
  "138.solution.en": "Solve the issue",
  "138.solution": "Check to make sure you are not actually in Portola Valley and remove the incorrect City Name",
  "139.enabled": true,
  "139.params": {
