...
// @version         0.5.6
// @description     球队概览中显示详细信息  Adds months, routine, ASI, RERECb and RatingR5 to the "club" page
...
// @include         https://fb.trophymanager.com/club/*/squad/*
// @license         MIT
// @downloadURL https://update.greasyfork.org/scripts/377185/TM%20Super%20Detailed%20Club%20Page%20CN.user.js
// @updateURL https://update.greasyfork.org/scripts/377185/TM%20Super%20Detailed%20Club%20Page%20CN.meta.js
// ==/UserScript==
...
$("#player_table tr:eq(0) th:eq(4)").after('<th align="center" title="经验(属性加成)"><b>经验</b></td>');
$("#player_table tr:eq(0) th:eq(5)").after('<th align="center"><b>SI</b></td>');
$("#player_table tr:eq(0) th:eq(7)").text('评星');
$("#player_table tr:eq(0) th:eq(7)").after('<th align="center"><b>RatingR5</b></td>');
$("#player_table tr > .text_fade > div").not(".text_fade_overlay").find("a[player_link]").each(function(){
    ...
    var RECname = "<div style='color:gold;'>评星</div>";
...
$("#player_table").find("tr > th:eq(10)").parent().after("<tr><th class='align_center'>#</th><th style='padding: 0px 0px 0px 5px;'>姓名</th><th class='align_center'>年龄</th><th class='align_center'>位置</th><th></th><th class='align_center' title='经验(属性加成)'><b>经验</b></th><th class='align_center'><b>SI</b></th><th class='align_center'>评星</th><th class='align_center'><b>RatingR5</b></th><th></th></tr>");
$(".column3_a").find(".box_body > div > p:first").before("<p>身价总计: "+addCommas(Math.round(valoretotale))+"<br>工资总计: "+addCommas(wagetotale)+"</p>");