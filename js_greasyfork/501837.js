// ==UserScript==
// @name         BLACK RUSSIA VLADIVOSTOK  || Скрипт Кураторов форума  by. J.Scaletta
// @namespace    https://forum.blackrussia.online
// @version      1.3.2
// @description  Специально для BlackRussia || VLADIVOSTOK
// @author       BlackRussia
...
// @downloadURL https://update.greasyfork.org/scripts/501837/BLACK%20RUSSIA%20VLADIVOSTOK%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%20by%20JScaletta.user.js
// @updateURL https://update.greasyfork.org/scripts/501837/BLACK%20RUSSIA%20VLADIVOSTOK%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%20by%20JScaletta.meta.js
// ==/UserScript==
...
const buttons = [
      ...
      title: '|',
      content:
        '[SIZE=4][COLOR=rgb(0, 255, 255)][FONT=courier new]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR][/SIZE]',
      },
    {
      title: 'DM',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR]<br><br>" +
        ...
        "[/LIST]<br><br>" +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Приятной игры на BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 255, 255)][FONT=courier new][SIZE=4]VLADIVOSTOK[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(51, 204, 51)][FONT=courier new][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR]',
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Вы обратились не в тот раздел, обратитесь в раздел для жалоб на сотрудников. [/SIZE][/FONT][/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Приятной игры на BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 255, 255)][FONT=courier new][SIZE=4]VLADIVOSTOK[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR]',
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR]<br><br>" +
        "[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.34.[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4]Запрещен уход от наказания[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]| Ban 15 - 30 дней (суммируется к общему наказанию дополнительно) [/SIZE][/FONT][/COLOR]<br><br>" +
        "[*][FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]Зная, что в данный момент игроку может быть выдано наказание за какое-либо нарушение, изменение никнейма или передача своего имущества на другие аккаунты и тому подобное.[/COLOR][/SIZE][/FONT]<br><br>" +
        "[*][FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]выход игрока из игры не является уходом от наказания.[/COLOR][/SIZE][/FONT]<br><br>" +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Приятной игры на BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 255, 255)][FONT=courier new][SIZE=4]VLADIVOSTOK[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(51, 204, 51)][FONT=courier new][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
...
title: 'не на русском в чате',
    ...
    },
    {
     ...
     content:
        ...
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Нарушитель будет наказан по следующему пункту строгих правил серверов:[/SIZE][/FONT][/COLOR] <br><br>" +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Нарушитель будет наказан по следующему пункту правил нападения на военную часть:[/SIZE][/FONT][/COLOR]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Нарушитель будет наказан по общим правилам ограблений и похищений.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Приятной игры на BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 255, 255)][FONT=courier new][SIZE=4]VLADIVOSTOK[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(51, 204, 51)][FONT=courier new][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
     title: 'Системные отыгровки',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Системных отыгровок достаточно при задержании.[/SIZE][/FONT]<br><br>" +
        ...
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Нарушитель будет наказан по следующему пункту правил государственных структур:[/SIZE][/FONT][/COLOR]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Ваша жалоба взята на рассмотрение, ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: PIN_PREFIX,
      status: true,
    },
    {
      title: '_________________________________передача жалобы________________________________________',
    },
    {
      title: 'Тех. спецу',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/COLOR][COLOR=rgb(255, 102, 0)][FONT=courier new][SIZE=4]Техническому Специалисту[/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: TEX_PREFIX,
      status: true,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/COLOR][COLOR=rgb(255, 102, 0)][FONT=courier new][SIZE=4]Главному Администратору[/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 13)][FONT=courier new][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: GA_PREFIX,
      status: true,
    ...
    {
      title: '_________________________________Отказ жалоб________________________________________',
    },
    {
      title: 'Недостаточно док-в',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Недостаточно доказательств для корректного рассмотрения вашей жалобы.[/SIZE][/FONT]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Недостаточно доказательств. Для корректного рассмотрения вашей жалобы требуются видео-доказательства.[/SIZE][/FONT]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Отсутствуют доказательства - следовательно, рассмотрению не подлежит. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new] Nick_Name игрока поданной жалобы не соответствует тому который предоставлен в ваших доказательствах.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Доказательства в социальных сетях и т.д. не принимаются. Загрузите доказательства на фото-видео хостинги YouTube,Imgur, Yapx и так далее.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Нарушений со стороны игрока не было замечено.<br><br>" +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]На доказательствах отсутствуют дата и время ([/SIZE][/FONT][FONT=courier new][SIZE=4]/time[/SIZE][/FONT][FONT=courier new][SIZE=4]) - следовательно, рассмотрению не подлежит.<br><br>" +
        "Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Доказательства были подвергнуты редактированию - следовательно, рассмотрению не подлежит.<br><br>" +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]Ваша видеозапись обрывается. Загрузите полную видеозапись на видео-хостинг YouTube.<br><br>" +
        "Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        ...
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваш заголовок составлен не по форме. Внимательно прочтите правила создания темы, прикрепленные в этом разделе.[/FONT][/SIZE]<br><br>" +
        ...
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваша жалоба отказана, т.к в ней нету таймкодов. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
     prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE ][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваша жалоба отказана, т.к с момента нарушения прошло более 72-ух часов.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
     prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваша жалоба отказана, т.к она написана от 3-его лица.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
     prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваша жалоба отказана, т.к ранее уже был дан ответ.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваша жалоба отказана, т.к нарушитель уже был наказан ранее.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваша жалоба составлена не по форме. Внимательно прочитайте правила подачи жалоб на игроков, закрепленные в этом разделе.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]В ваших доказательствах не было оговорено условий сделки или в них не было дополнительных условий о сделке.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваши доказательства не рабочие или же не работает ссылка.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Займ может быть осуществлен только через зачисление игровых ценностей на банковский счет.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Донат ровно как и невнутриигровые вещи не могут быть предметом сделки в игре.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]С момента создания ваших доказательств прошло более 3-х дней.[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Данное текстовое сообщения игрока не найдено в базе данных сервера[/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br> <br>" +
        "[FONT=courier new][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]' ,
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Вы ошиблись сервером, перемещаю вашу тему на нужный сервер...[/FONT][/SIZE]<br><br>" +
    ...
    },
     {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию - [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.1994/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
     {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Вы ошиблись разделом, обратитесь в раздел жалоб на игроков- [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.1996/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
     {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров- [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.1995/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
     {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Вы ошиблись разделом, обратитесь в раздел обжалование наказаний- [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.1997/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
     {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Вы ошиблись разделом, обратитесь в раздел Неофициальные RP организации- [URL='https://forum.blackrussia.online/forums/%D0%9D%D0%B5%D0%BE%D1%84%D0%B8%D1%86%D0%B8%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5-rp-%D0%BE%D1%80%D0%B3%D0%B0%D0%BD%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D0%B8.1973/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
     {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Вы ошиблись разделом, обратитесь в раздел РП ситуации- [URL='https://forum.blackrussia.online/forums/%D0%A0%D0%9F-%D1%81%D0%B8%D1%82%D1%83%D0%B0%D1%86%D0%B8%D0%B8.1975/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
     {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Вы ошиблись разделом, обратитесь в раздел РП биографии - [URL='https://forum.blackrussia.online/forums/%D0%A0%D0%9F-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.1976/']*Нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
        "[FONT=courier new][SIZE=4]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=courier new]Отказано.[/FONT][/SIZE][/COLOR]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография одобрена.[/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана.[/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      title: 'недостаточно инфы внеш',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана, т.к. недостаточно информации о внешности.[/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    {
      title: 'недостаточно инфы характера',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана, т.к. недостаточно информации о характере.[/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    {
      title: 'недост инфы о детстве',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана, т.к. в пункте детство недостаточно информации.[/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    {
      title: 'недост инфы о юности',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана, т.к. в пункте юность недостаточно информации.[/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    {
      title: 'недост инфы о взрослости',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана, т.к. в пункте взсрослая жизнь недостаточно информации.[/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/SIZE][/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана, т.к в ней нет логики или не соответствует логике реальной жизни.[/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она составлена не по форме. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к вы ее не дополнили. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к в ней недостаточно информации. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она оформлена неграмотно. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
       prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она написана от 3-его лица. [/COLOR]<br><br>" +
         "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к она уже была одобрена. [/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к вы приписали суперспособности своему персонажу. [/COLOR]<br><br>" +
  "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
     prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к вы скопировали её у другого игрока. [/COLOR]<br><br>" +
  "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
     prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к у вас NonRP NickName. [/COLOR]<br><br>" +
         "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к ваш NickName должен быть написан на русском языке. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к дата рождения не совпадает с возрастом. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана, т.к в пункте Внешность не может быть логически одежды. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
       prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к ваша семья расписана не полностью или не соответствует семейным нормам логике. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к ваша дата рождения и местом рождения расписана не полностью. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]В вашей RolePlay - биографии недостаточно информации.<br><br>" +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша неофициальная RP организация одобрена.[/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша неофициальная RP организация отказана т.к она составлена не по форме. [/COLOR]<br><br>"+
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
     prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша неофициальная RP организация отказана. [/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
     prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]В вашей неофициальной RP организации недостаточно информации.<br><br>" +
        "Даю вам 24 часа на ее дополнение.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: PIN_PREFIX,
      status: true,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша неофициальная RP организация отказана т.к ваш все никнеймы должны быть написаны на русском языке. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша неофициальная RP организаций отказана т.к она оформлена неграмотно. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
       prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша неофициальная RP организация отказана т.к вы ее скопировали у другого человека. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша Rнеофициальная RP организация отказана т.к вы ее не дополнили. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша неофициальная RP организация отказана т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - организаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=courier new]Ваша неофициальная RP организация была закрыта по следующему пункту правил:[/FONT][/SIZE]<br><br>" +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация одобрена.[/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
  ...
  title : 'не по форме',
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к она составлена не по форме. [/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана. [/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
     prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     title: 'На доработке',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[COLOR=rgb(209, 213, 216)][FONT=courier new][SIZE=4]В вашей RolePlay - ситуации недостаточно информации.<br><br>" +
        "Даю вам 24 часа на ее дополнение.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: PIN_PREFIX,
      status: true,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к ваш все никнеймы должны быть написаны на русском языке. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
     ...
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к она оформлена неграмотно. [/COLOR]<br><br>" +
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
       prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RP ситуация отказана т.к вы ее скопировали у другого человека. [/COLOR]<br><br>" +
       "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP ситуаций, закрепленные в данном разделе. [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к вы ее не дополнили. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=courier new][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/FONT][/COLOR]<br><br>' +
        "[SIZE=4][FONT=courier new][COLOR=rgb(209, 213, 216)]Ваша RolePlay - ситуация отказана т.к заголовок оформлен неправильно. [/COLOR]<br><br>" +
          "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - ситуаций закрепленные в данном разделе [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [/COLOR][COLOR=rgb(0, 255, 255)]VLADIVOSTOK[/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4].[/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
