...
// @downloadURL https://update.greasyfork.org/scripts/374903/ComicRead.user.js
// @updateURL https://update.greasyfork.org/scripts/374903/ComicRead.meta.js
// ==/UserScript==
    ...
    case 'hdoujin.org':
      {
        ...
        if (!reRes || !clearance) throw new Error(helper.t('site.changed_load_failed'));
        const [, id, key] = reRes;
