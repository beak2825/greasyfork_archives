// ==UserScript==
// @name         NOVOSIBIRSK для КФ | M.Grozny
// @namespace    https://forum.blackrussia.online
// @version      1.70
// @description  Скрипт для Модераторов Форума | Black Russia BLUE by L.Vishnevsky
// @author       Muhamad
...
// @downloadURL https://update.greasyfork.org/scripts/458552/NOVOSIBIRSK%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%20MGrozny.user.js
// @updateURL https://update.greasyfork.org/scripts/458552/NOVOSIBIRSK%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%20MGrozny.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил: 2.01. Запрещено поведение, нарушающее нормы процессов Role Play режима игры | Jail 30 минут [/FONT][/I][/B][/CENTER] " +
                '[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на NOVOSIBIRSK.[/I][/CENTER][/color][/FONT]' +
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба была передана на рассмотрение техническому специалисту.@Orchid_Malevolence[/CENTER]<br>" +
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пунтку правил: 6.03. Запрещено nRP поведение | Warn[/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на NOVOSIBIRSK.[/I][/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][FONT=times new roman][CENTER][I]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    ...
    },
    {
	  ...
	  content:
		...
		'[Color=DeepSkyBlue][CENTER]Приятной игры на NOVOSIBIRSK.[/I][/CENTER][/color][/FONT]' +
