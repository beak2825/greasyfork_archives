...
// @description    Показывает статус захвата территорий кланами
// @version        0.1
// @encoding 	   utf-8
...
// @downloadURL https://update.greasyfork.org/scripts/10225/hwm_map_status.user.js
// @updateURL https://update.greasyfork.org/scripts/10225/hwm_map_status.meta.js
// ==/UserScript==
...
pushed = terr.push(new Object);
terr[pushed-1].num = 25;
terr[pushed-1].name = 'East Island';

pushed = terr.push(new Object);
terr[pushed-1].num = 26;
terr[pushed-1].name = 'The Wilderness';

pushed = terr.push(new Object);
terr[pushed-1].num = 27;
terr[pushed-1].name = 'Sublime Arbor';
}
...
for (var i in arr2) {
	...
	sub_state.regionName = ( terr[terrNum-2] ? terr[terrNum-2].name : terrNum ) +'-<b>'+sides[sideNum]+'</b>'+subSubNum;
...
parent = e2.snapshotItem(e2.snapshotLength-1).parentNode;
...
tr.innerHTML = "<TD colspan=3><B>Наши сектора</B></TD>";
...
tr = document.createElement('TR');
tr.innerHTML = "<TD colspan=3><A HREF=\"http://www.heroeswm.ru/mwlog.php\"><B>Свободные сектора</B></A></TD>";
tbody.appendChild(tr);
...
tr = document.createElement('TR');
tr.innerHTML = "<TD colspan=3><B>Отслеживаемые сектора</B></TD>";
tbody.appendChild(tr);
