...
// @downloadURL https://update.greasyfork.org/scripts/549412/LEE.user.js
// @updateURL https://update.greasyfork.org/scripts/549412/LEE.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "LEE JIA SIOU";
    const NEW_NAME = "LEE CHIA CHENG";
    const NEW_BIRTHDAY = "(**0606)";
    const NEW_EXPIRE_DATE = "2033-05-31";
