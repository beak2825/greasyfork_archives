// ==UserScript==
// @name         Ed WM  VB JOHANN ANGSTENBERGER
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/500278/Ed%20WM%20%20VB%20JOHANN%20ANGSTENBERGER.user.js
// @updateURL https://update.greasyfork.org/scripts/500278/Ed%20WM%20%20VB%20JOHANN%20ANGSTENBERGER.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  12600},
        { index: 1, adjustmentAmount: 12600},
        { index: 2, adjustmentAmount: 0},
        { index: 3, adjustmentAmount: 12600 },
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE47 6149 0150";
    var targetTextContent2 = " 0379 8856 03";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 12600.0; // Adjust the amount as needed
 ...
 //       },
    {
       ...
       },
      {
            ...
            description: 'Freigabe nötig. A. Graf meldet sich.',
            amount: '167.171,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
