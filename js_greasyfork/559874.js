// ==UserScript==
// @name         YouTube Pre-October 2024 UI
// @version      2026.01.07
// @description  This userscript reverts UI changes prior to October 22nd, 2024 before the bolder sidebar icons and pink stuffs.
...
// @allFrames    true
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/559874/YouTube%20Pre-October%202024%20UI.user.js
// @updateURL https://update.greasyfork.org/scripts/559874/YouTube%20Pre-October%202024%20UI.meta.js
// ==/UserScript==
...
const flagsToAssign = {
  // Flags - Disable both 'watch grid' and 'new sizing'
...
(function() {
let css = `
/* CSS - Revert UI elements before late 2024 changes */
...
div#end.style-scope.ytd-masthead .yt-spec-button-shape-next--size-m[aria-label="Create"]:hover { background-color: var(--yt-spec-10-percent-layer) !important }
...
ytd-feed-filter-chip-bar-renderer[frosted-glass] #left-arrow-button.ytd-feed-filter-chip-bar-renderer, ytd-feed-filter-chip-bar-renderer[frosted-glass] #right-arrow-button.ytd-feed-filter-chip-bar-renderer { background-color: var(--yt-spec-base-background) !important }
ytd-feed-filter-chip-bar-renderer[frosted-glass] #left-arrow.ytd-feed-filter-chip-bar-renderer:after { background: linear-gradient(to right, var(--yt-spec-base-background) 20%, rgba(255, 255, 255, 0) 80%) !important }
ytd-feed-filter-chip-bar-renderer[frosted-glass] #right-arrow.ytd-feed-filter-chip-bar-renderer:before { background: linear-gradient(to left, var(--yt-spec-base-background) 20%, rgba(255, 255, 255, 0) 80%) !important }
ytd-masthead[frosted-glass=with-chipbar] #background.ytd-masthead, ytd-masthead[frosted-glass=without-chipbar] #background.ytd-masthead, ytd-app[frosted-glass-mode=with-chipbar] #frosted-glass.ytd-app, ytd-app[frosted-glass-mode=without-chipbar] #frosted-glass.ytd-app { background: var(--yt-spec-base-background) !important; backdrop-filter: none !important }
.ytSuggestionComponentRoundedSuggestion { height: 36px !important; border-radius: 0 !important; margin: 0 !important }
...
.ytSuggestionComponentThumbnailContainer, .ytSuggestionComponentvisualSuggestThumbnail { display: none !important }
...
ytd-watch-metadata[action-buttons-update-owner-width] #owner.ytd-watch-metadata { min-width: calc(50% - 6px) !important; max-width: calc(50% - 6px) !important; margin-right: 12px !important }
ytd-watch-metadata[actions-on-separate-line] #owner.ytd-watch-metadata { max-width: 100% !important }

/* CSS - Revert pre-2025 video player sizing + List view fixs */
...
h1.ytd-watch-metadata { font-size: 2rem !important; line-height: 2.8rem !important }
ytd-comments-header-renderer[compact-header] #title.ytd-comments-header-renderer { margin-bottom: 24px !important }
ytd-comments-header-renderer[modern-typography][compact-header] .count-text.ytd-comments-header-renderer { font-size: 2rem !important; line-height: 2.8rem !important; font-weight: 700 !important; max-height: 2.8rem !important; display: flex !important; flex-direction: row-reverse !important }
[compact-header] .count-text.ytd-comments-header-renderer { display: flex !important; flex-direction: row-reverse !important }
[compact-header] .count-text.ytd-comments-header-renderer span { margin-right: 6px !important }
...
/* CSS- Revert SVG icons before late 2024 changes */
/* youtube logo */
...
d: path("M18 4v15.06l-5.42-3.87-.58-.42-.58.42L6 19.06V4h12m1-1H5v18l7-5 7 5V3z")
}
/* queue */
...
// Extra codes to be added (OldYTPlayer + Video Resize Fix)
/* jshint esversion:8 */
