// ==UserScript==
// @name         My Zipline Uploader
// @namespace    *://*/*
// @version      1.0
// @description  Upload files to your Zipline instance with URL history, timestamps, minimize support, middle-click to open in new tab without shifting focus.
// @author       heapsofjoy
// @match        *://*/*
// @grant        GM_addStyle
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/522731/My%20Zipline%20Uploader.user.js
// @updateURL https://update.greasyfork.org/scripts/522731/My%20Zipline%20Uploader.meta.js
// ==/UserScript==
...
function uploadFile(file) {
    ...
    formData.append('file', file); // Use "file" as the form key per your ShareX config

    fetch('https://YOURZIPLINEINSTANCE.COM/api/upload', {
        method: 'POST',
        headers: {
