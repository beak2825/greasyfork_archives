...
// @namespace
// @version      1.3.7
// @description  Мой скриптик, надеюсь вам понравиться, Нашли какой-то баг пишите в вк: https://vk.com/serdeiavdeev
// @author       Sergey_Medvedev
// @match        https://forum.wh26482.web2.maze-tech.ru/index.php*
// @grant        none
// @license 	 MIT
// @collaborator Quenk269
// @icon https://icons.iconarchive.com/icons/papirus-team/papirus-apps/48/emerald-theme-manager-icon-icon.png
// @updateURL
// @namespace https://greasyfork.org/users/1124362
// @downloadURL https://update.greasyfork.org/scripts/545441/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%80%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/545441/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%80%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0.meta.js
// ==/UserScript==
...
(function () {
  'use strict';
    ...
    title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴доки╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
      ...
      title: 'запрошу доки',
      content:
		'[CENTER][SIZE=4][FONT=Courier New][COLOR=#ffffff]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE] <br><br>' +
        "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        '[CENTER][FONT=Courier New][COLOR=orange][SIZE=4]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: true,
    },
    {
    ...
    },
    {
      ...
      content:
        ...
        "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        '[CENTER][FONT=Courier New][COLOR=#ffffff][SIZE=4]Приятной игры на сервере. [/COLOR][/FONT][/CENTER]',
    ...
    },
    {
      title: 'не по форме',
      content:
		'[CENTER][B][SIZE=4][FONT=Courier New][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE]<br><br>' +
        "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        "[FONT=Courier New][SIZE=4]Ваша жалоба составлена не по форме.<br>Убедительная просьба ознакомиться с правилами подачи жалоб - [URL= https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Правила-подачи-жалоб.15/]*Тык*[/URL] [/FONT][CENTER] <br>" +
        "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#ffffff]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFff][SIZE=5]Ваше обжалование было передано на рассмотрение Заместителю Главного Администратора по направлению ГОС и ОПГ. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=orange][SIZE=5]Ожидайте его ответа.[/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#ffffff]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFff][SIZE=5]Ваше обжалование было передано на рассмотрение Заместителю Главного Администратора. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=orange][SIZE=5]Ожидайте его ответа.[/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: true,
    },
    {title: 'для га',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFff]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFff][SIZE=5]Ваше обжалование было передано на рассмотрение Главному Администратору. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=orange][SIZE=5]Ожидайте его ответа.[/COLOR][/FONT][/CENTER]',
      prefix: GA_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFff]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFff][SIZE=5]Ваше обжалование было передано на рассмотрение [Color=#1E90FF]Руководителю Модерации Дискорда.[/COLOR] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=orange][SIZE=5]Ожидайте его ответа.[/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFff]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFff][SIZE=5]Ваше обжалование было передано на рассмотрение  [COLOR=red] Специальной Администрации. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=orange][SIZE=5]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: SPECY_PREFIX,
	  status: true,
    },
    {
    ...
    },
    {
      ...
      content:
	 "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Если вы не согласны с выданным наказанием, то обратитесь в раздел Жалоб на Администрацию - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Жалобы-на-администрацию.19/']*Тык*[/URL] [/COLOR][/FONT][/CENTER] <br>" +
    ...
    },
    {
      ...
      content:
		 "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Данный игрок не является администратором.<br>Обратитесь в раздел Жалоб на игроков - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Жалобы-на-игроков-не-сост-в-организациях.22/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FF0000][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
    },
    {
      ...
      content:
        "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Данный игрок является лидером.<br>Обратитесь в раздел Жалоб на лидеров - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Жалобы-на-лидеров-заместителей.20/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FF0000][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
    },
    {
      ...
      content:
		 "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Внимательно ознакомившись с вашей жалобой, было решено, что вам нужно обраться в раздел Обжалований наказаний - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Обжалование-наказания.52/']*Тык*[/URL] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FF0000][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
    prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
...
{
      title: 'в жб на МВД/ФСБ',
      content:
        "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Данный игрок является сотрудником МВД/ФСБм.<br>Обратитесь в раздел Жалоб на МВД/ФСБ - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Жалобы-на-сотрудников-МВД-ФСБ.21/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FF0000][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
...
{
      title: 'в жб на сотрудников гос.структур',
      content:
        "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Данный игрок является сотрудником гос. организации.<br>Обратитесь в раздел Жалоб на сотрудников гос. организаций - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Жалобы-на-сотрудников-МВД-ФСБ.21/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FF0000][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
...
{
      title: 'в жб на Крим орг',
      content:
        "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Данный игрок является сотрудником ОПГ - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Жалобы-на-игроков-сост-в-криминальных-структурах.24/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FF0000][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
    },
    {
      ...
      content:
		 "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Вы ошиблись разделом.<br>Обратитесь в Технический раздел - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Технический-раздел.4/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FF0000][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
    },
    {
      ...
      content:
		 "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Вам было выдано наказания Техническим специалистом, вы можете написать жалобу/обжалование здесь - [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Жалобы-на-технических-специалистов.6/']*Тык*[/URL] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FF0000][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
     prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
    },
    {
        ...
        },
        {
            ...
            "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая).<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Ваше обжалование составлено не по форме, пожалуйста ознакомьтесь с правилами подачи обжалований : [URL='https://forum.wh26482.web2.maze-tech.ru/index.php?forums/Правила-подачи-жалоб.15/']*Нажмите сюда*[/URL]<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        },
        {
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=orange]На рассмотрение[COLOR=orange][/FONT][/CENTER]',
           prefix: PIN_PREFIX,
         prefix: CLOSE_PREFIX,
         status: false,
        },
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Ваше наказание уже было обжаловано, повторного обжалования не будет. [/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=RED][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
	  ...
	  content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Вы ошиблись сервером. <br>Подайте обжалование в разделе вашего сервера.[/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=RED][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
	  prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Ваше наказание будет снижено до 30 дней блокировки аккаунта. [/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=RED][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Ваше наказание будет снижено до 15 дней блокировки аккаунта. [/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=RED][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: RASSMOTENO_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Ваше наказание будет снижено до 7 дней блокировки аккаунта. [/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=RED][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: RASSMOTENO_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Ваше наказание будет полностью снято. [/FONT][/COLOR][CENTER] <br>" +
         '[CENTER][FONT=Courier New][COLOR=#FFFFFF][SIZE=4]Приятной игры на сервере. [/COLOR][/FONT][/CENTER]',
      prefix: RASSMOTENO_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFff]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFff][SIZE=5]Вы вынесены из черного списка лидеров. [/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][FONT=Courier New][COLOR=#FFFFFF][SIZE=4]Приятной игры на сервере. [/COLOR][/FONT][/CENTER]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFff]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFff][SIZE=5]Вам дается 24 часа что бы сменить NickName, после смены обязательно прикрепите скриншот с /time. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=gold][SIZE=5]На рассмотрении[/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: 123,
    },
     {title: 'НРП развод',
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Игрок разблокирован на 24 часа, когда вам вернут имущество обязательно отпишите в эту тему. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=gold][SIZE=5]На рассмотрении[/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: 123,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFff][SIZE=5]Вы обманули данного игрока и сейчас пишите обжалование с подставной перепиской. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=red][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Игрок которого вы обманули должен сам написать обжалование. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=red][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFFFF]{{ greeting }}, уважаемый.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFFFF][SIZE=5]Нет скриншота договора о возврате имущества. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=red][SIZE=5]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    }
