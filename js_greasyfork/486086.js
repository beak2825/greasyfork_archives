// ==UserScript==
// @name         Скрипт для Космоса
// @namespace    http://tampermonkey.net/
// @version      1.0.1
// @description  Скрипт для Космоса, по вопросам писать в вк @michael.angels
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/486086/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%BE%D1%81%D0%BC%D0%BE%D1%81%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/486086/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%BE%D1%81%D0%BC%D0%BE%D1%81%D0%B0.meta.js
// ==/UserScript==
...
(function () {
...
},
    {
	 ...
	 content:
        ...
        "[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]{{greeting}}, уважаемый сотрудник. [/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/COLOR][/CENTER][/B]"+
        ...
        },
{
    ...
    content:
		...
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]{{greeting}}, уважаемый представитель. [/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/COLOR][/CENTER][/B]<br><br>"+
...
},
{
      ...
      title: 'Отсутствуют док-ва',
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][COLOR=YELLOW][CENTER][ICODE]{{ greeting }}, уважаемый представитель. [/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/ICODE].[/CENTER][/I][/COLOR][/SIZE][/FONT][/COLOR]<br><br>' +
	  ...
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Доброго времени суток, уважаемый представитель. [/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/COLOR][/CENTER][/B]<br><br>"+
	  ...
	  status: false,
        ...
        },
        {
            title: '| Выговор |',
            content:
            "[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavander]{{greeting}},уважаемый подопечный. [/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/B][/CENTER][/FONT][/SIZE][/COLOR]<br><br>"+
        ...
        },
          {
            title: '| Пред |',
            content:
            "[B][CENTER][FONT=times new roman][SIZE=3][COLOR=lavander]{{greeting}},уважаемый подопечный. [/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/B][/CENTER][/FONT][/SIZE][/COLOR]<br><br>"+
        ...
        },
        {
            title: '| Устный пред |',
            content:
            "[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavander]{{greeting}},уважаемый подопечный. [/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/B][/CENTER][/FONT][/SIZE][/COLOR]<br><br>"+
                        "[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavander]Ваша жалоба на сотрудника получает статус [COLOR=GREEN][ICODE]Одобрено[/ICODE][/COLOR][/B][/CENTER][/FONT][/SIZE]<br><br>"+
        ...
        },
          {
        ...
        },
           {
            ...
            content:
            "[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavander]{{greeting}},уважаемый сотрудник. [/COLOR][COLOR=lavander]Я являюсь лидером организации [COLOR=ORANGE]Kosmos_Extazii[/B][/CENTER][/FONT][/SIZE][/COLOR]<br><br>"+
