...
// @name       				星阵科技LJ
// @version    				4.9.12
// @description				just do what you wanna do,and be what you wanna be
// @author     				enncy
// @license    				MIT
// @match      				*://*.zhihuishu.com/*
// @match      				*://*.chaoxing.com/*
...
// @connect    				127.0.0.1
// @antifeature				payment
// @downloadURL https://update.greasyfork.org/scripts/494935/%E6%98%9F%E9%98%B5%E7%A7%91%E6%8A%80LJ.user.js
// @updateURL https://update.greasyfork.org/scripts/494935/%E6%98%9F%E9%98%B5%E7%A7%91%E6%8A%80LJ.meta.js
// ==/UserScript==
...
\u4E3B\u9875\uFF1A${c.homepage || "\u672A\u77E5\u4E3B\u9875"}`,
    ...
    scripts: {
      ...
      "gxk-study": new lib.Script({
        ...
        onrender({ panel }) {
          panel.body.replaceChildren(
            ...
            lib.$ui.button("\u23F0\u68C0\u6D4B\u662F\u5426\u9700\u8981\u89C4\u5F8B\u5B66\u4E60", {}, (btn) => {
              ...
              btn.onclick = () => {
                var _a;
                (_a = lib.$el(".iconbaizhoumoshi-xueqianbidu")) == null ? void 0 : _a.click();
                setTimeout(() => {
                  var _a2;
                  const pmd = lib.$el(".preschool-Mustread-div");
                  if (pmd) {
                    ...
                    lib.$modal.alert({ content: "\u68C0\u6D4B\u5931\u8D25\uFF0C\u8BF7\u786E\u8BA4\u5728\u89C6\u9891\u5B66\u4E60\u9875\u9762\u4F7F\u7528\u6B64\u6309\u94AE\u3002" });
                  }
                }, 100);
              };
            }),
        ...
        async oncomplete() {
          CommonProject.scripts.render.methods.pin(this);
          setTimeout(() => {
            if (lib.$$el(".clearfix.video").length === 0) {
              finish();
            }
          }, 10 * 1e3);
          const waitForVideoList = () => {
            return new Promise((resolve, reject) => {
              if (lib.$$el(".clearfix.video").length > 1) {
                resolve();
              } else {
                setTimeout(() => {
          ...
          const closeTestDialog = async () => {
            ...
            const items = lib.$$el("#playTopic-dialog .topic .el-pager .number");
            if (items.length) {
          ...
          const recordStudyTimeLoop = () => {
            var _a;
            this.methods.increaseStudyTime(((_a = lib.$el(".source-name")) == null ? void 0 : _a.innerText) || "\u65E0\u540D\u79F0", this.cfg.playbackRate);
  ...
  async function watch(remotePage, options, onended) {
    await waitForMedia();
    const set = async () => {
  ...
  async function switchLine(remotePage, definition2 = "line1bq") {
  ...
  async function switchPlaybackRate(remotePage, playbackRate2) {
    const controlsBar = lib.$el(".controlsBar");
    const sl = lib.$el(".speedList");
    if (controlsBar && sl) {
      controlsBar.style.display = "block";
      sl.style.display = "block";
      await remotePage.click(`.speedList [rate="${playbackRate2 === 1 ? "1.0" : playbackRate2}"]`);
    }
  }
    ...
    const next2 = async () => {
      ...
      if (CXAnalyses.isInFinalChapter()) {
        ...
        if (opts.backToFirstWhenFinish) {
          ...
          setTimeout(() => {
            var _a3;
            (_a3 = top == null ? void 0 : top.document.querySelector(".posCatalog_name")) == null ? void 0 : _a3.click();
          }, 10 * 1e3);
        ...
        if (curChapterId && curCourseId && curClazzId) {
          ...
          (_a2 = lib.$gm.unsafeWindow.top) == null ? void 0 : _a2.PCount.next(
  ...
  async function chapterTestTask(frame, {
    ...
    if (answererWrappers === void 0 || answererWrappers.length === 0) {
      const msg2 = "\u68C0\u6D4B\u5230\u9898\u5E93\u914D\u7F6E\u4E3A\u7A7A\uFF0C\u65E0\u6CD5\u81EA\u52A8\u7B54\u9898\uFF0C\u8BF7\u524D\u5F80 \u201C\u901A\u7528-\u5168\u5C40\u8BBE\u7F6E\u201D \u9875\u9762\u8FDB\u884C\u914D\u7F6E\u3002";
      lib.$message.error({ content: msg2 });
      return $console.warn(msg2);
    }
    lib.$message.info({
  ...
  function waitForFaceRecognition() {
    ...
    return new Promise((resolve) => {
      const interval = setInterval(() => {
        const face = lib.$el("#fcqrimg", top == null ? void 0 : top.document);
        if (face) {
          if (!notified) {
            notified = true;
...
if (
	...
	const open = confirm(
		`此脚本不支持当前的脚本管理器（${GM_info.scriptHandler}）。` +
			'请下载指定的脚本管理器，例如 “Scriptcat 脚本猫” 或者 “Tampermonkey 油猴”'
	);
