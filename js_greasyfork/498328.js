// ==UserScript==
// @name         IQRPG Personnel Companion
// @namespace    https://www.iqrpg.com/
// @version      0.2.0
// @author       Tempest
// @description  QoL enhancement for IQRPG Personnel
...
// @license      unlicense
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/498328/IQRPG%20Personnel%20Companion.user.js
// @updateURL https://update.greasyfork.org/scripts/498328/IQRPG%20Personnel%20Companion.meta.js
// ==/UserScript==
            ...
            if(e.response && !loadPersonnelOnce) {
                ...
                for(let i = 0; i < personnel.length; i += 1) {
                    ...
                    for(let j = 0; j < bonuses.length; j += 1 ) {
                         ...
                         */
                        if(bonusText.includes('Level')) {
                            let _bonusLevel = bonusText.replace(":", "");
                            _bonusLevel = _bonusLevel.replace("Level ", "");
