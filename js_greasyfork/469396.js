...
// @downloadURL https://update.greasyfork.org/scripts/469396/MooMooio%20%5Bsimple%20Hat%20Macro%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/469396/MooMooio%20%5Bsimple%20Hat%20Macro%5D.meta.js
// ==/UserScript==
...
document.addEventListener('keydown', function(e) {
    if (e.keyCode == 66 && document.activeElement.id.toLowerCase() !== 'chatbox') { // G for Solider
        Hat(6);
    }
    if (e.keyCode == 27 && document.activeElement.id.toLowerCase() !== 'chatbox') { // ESC for uneuip hat
        Hat(0);
    }
    if (e.keyCode == 71 && document.activeElement.id.toLowerCase() !== 'chatbox') { // Y for Turret gear
        Hat(53);
    }
    ...
    if (e.keyCode == 89 && document.activeElement.id.toLowerCase() !== 'chatbox') { // U for samurai
        Hat(20);
    }
});
