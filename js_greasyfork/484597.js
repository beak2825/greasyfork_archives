...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/484597/Open%20GM%20Links.user.js
// @updateURL https://update.greasyfork.org/scripts/484597/Open%20GM%20Links.meta.js
// ==/UserScript==
...
for (let i = 0; i < hf.innerHTML/2; i++) {
                ...
                a.innerHTML = "click GM";
                                console.log(i);
                                if (document.getElementsByClassName('list_row list_odd  list_row_compact')[i].children[10].innerHTML.length >= 4 && document.getElementsByClassName('list_row list_odd  list_row_compact')[i].children[10].innerHTML.length <=7) {
                                                console.log(document.getElementsByClassName('list_row list_odd  list_row_compact')[i].children[10].innerHTML);
                                    a.target= '_blank';
                                    a.href = "https://help.globalmed.com/hc/en-us/requests/" + document.getElementsByClassName('list_row list_odd  list_row_compact')[i].children[10].innerHTML;
...
for (let i = 0; i < hf.innerHTML/2; i++) {
    ...
    var a = document.createElement('a');
                                a.innerHTML = "click GM";
                                              console.log(i);
    console.log(document.getElementsByClassName('list_row list_even  list_row_compact')[i].children[10].innerHTML);
                if (document.getElementsByClassName('list_row list_even  list_row_compact')[i].children[10].innerHTML.length >= 4 && document.getElementsByClassName('list_row list_even  list_row_compact')[i].children[10].innerHTML.length <=7) {
                                                                console.log(document.getElementsByClassName('list_row list_even  list_row_compact')[i].children[10].innerHTML);
                    a.target= '_blank';
                    a.href = "https://help.globalmed.com/hc/en-us/requests/"+ document.getElementsByClassName('list_row list_even  list_row_compact')[i].children[10].innerHTML;
                                                                console.log(i + "" + a.href);
                                                                console.log(document.getElementsByClassName('list_row list_odd  list_row_compact')[i]);
