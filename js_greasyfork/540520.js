// ==UserScript==
// @name         Bless Russia | BLUE Chief script
...
// @downloadURL https://update.greasyfork.org/scripts/540520/Bless%20Russia%20%7C%20BLUE%20Chief%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/540520/Bless%20Russia%20%7C%20BLUE%20Chief%20script.meta.js
// ==/UserScript==
...
(function () {
  ...
  '[CENTER][size=15px][font=Arial]Ваша жалоба получает Статус: [Color=rgb(255, 155 ,0)]На рассмотрении.[/color][/size][/font][/CENTER]<br>' +
  '[CENTER][size=15px][font=Arial]Ожидайте ответа, не нужно создать дубликаты на данную тему![/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращеие.[/size][/font][/CENTER]<br>' +
  '[CENTER][size=15px][font=Arial]С уважением, старшая администрация [COLOR=rgb(255,200,0)]Bless Russia[/color] сервер [Color=rgb(0, 0 ,255)]Blue.[/size][/font][/CENTER]',
        prefix: PIN_PREFIX,
      status: true,
      },
      {
  ...
  '[CENTER][size=15px][font=Arial]С уважением, старшая администрация [COLOR=rgb(255,200,0)]Bless Russia[/color] сервер [Color=rgb(0, 0 ,255)]Blue.[/size][/font][/CENTER]',
      ...
      },
    {
        ...
        content:
  '[CENTER][size=15px][font=Arial][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(51, 255, 0)] {{ user.mention }}[/color].[/size][/font][/CENTER]' +
  '[CENTER][size=15px][font=Arial]Ваше обжалование получает Статус: [Color=rgb(255,0,0)]Отказано.[/color][/size][/font][/CENTER]<br>' +
  '[CENTER][size=15px][font=Arial]Взломанные аккаунты не подлежат восстановлению.[/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>' +
  '[CENTER][size=15px][font=Arial]С уважением, старшая администрация [COLOR=rgb(255,200,0)]Bless Russia[/color] сервер [Color=rgb(255, 0 ,0)]Red.[/size][/font][/CENTER]',
        prefix: UNACCEPT_PREFIX,
      status: false,
      },
{
        ...
        content:
  '[CENTER][size=15px][font=Arial][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(51, 255, 0)] {{ user.mention }}[/color].[/size][/font][/CENTER]' +
  '[CENTER][size=15px][font=Arial]Ваша жалоба получает Статус: [Color=rgb(60,250,0)]Одобрено.[/color][/size][/font][/CENTER]<br>' +
  '[CENTER][size=15px][font=Arial]Администратор ошибся ID. Наказание снято, приношу свои извинения.[/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>' +
  '[CENTER][size=15px][font=Arial]С уважением, старшая администрация [COLOR=rgb(255,200,0)]Bless Russia[/color] сервер [Color=rgb(0, 0 ,255)]Blue.[/size][/font][/CENTER]',
  ...
  '[CENTER][size=15px][font=Arial]С уважением, старшая администрация [COLOR=rgb(255,200,0)]Bless Russia[/color] сервер [Color=rgb(0, 0 ,255)]Blue.[/size][/font][/CENTER]',
      ...
      },
      {
        ...
        content:
  '[CENTER][size=15px][font=Arial][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(51, 255, 0)] {{ user.mention }}[/color].[/size][/font][/CENTER]' +
  '[CENTER][size=15px][font=Arial]Запросил доказательства у администратора[/color][/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>' +
  '[CENTER][size=15px][font=Arial]С уважением, старшая администрация [COLOR=rgb(255,200,0)]Bless Russia[/color] сервер [Color=rgb(0, 0 ,255)]Blue.[/size][/font][/CENTER]',
        prefix: WATCHED_PREFIX,
      status: true,
...
$(document).ready(() => {
  ...
  function addButton(name, id) {
    $('.button--icon--reply').before(
      `<button type="button" class="button rippleButton" id="${id}" style="border-radius: 7px; margin-right: 5px; color: #000; background: #0f0fff; border: 1px solid;">${name}</button>`,
    );
  }
