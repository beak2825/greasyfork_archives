...
// @version     0.1.0
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/387828/RemoveAVSiteAD.user.js
// @updateURL https://update.greasyfork.org/scripts/387828/RemoveAVSiteAD.meta.js
// ==/UserScript==
...
if (/imgseeds.com|imgcandy.net|imgban.com|imgicy.com|picmoza.com/.test(location.hostname)) {
  var continuetoimage = document.querySelector("#continuetoimage input[type='submit']");
  if (continuetoimage) { continuetoimage.click(); }

  var image = document.querySelector("img.centred");
  if (image) { window.open(image.src, "_self"); }
