...
// @downloadURL https://update.greasyfork.org/scripts/19522/qzone%20auto%20login%28mobile%29.user.js
// @updateURL https://update.greasyfork.org/scripts/19522/qzone%20auto%20login%28mobile%29.meta.js
// ==/UserScript==
...
try {
	...
	var config0 = {
	  data: [
		{user: '571', pwd: '37854'}, {user: '240954', pwd: 'a8'}, {user: '1141', pwd: '15'}
	  ],
	  userTag: '#u',
	  pwdTag: '#p',
	  submitTag: '#go',
	...
	var autoLogin = {
	  ...
	  getJQ: function() {
		/* habit 只能手动引入外部js库 */
		//javascript:void((function () {typeof _loadJS_ != 'undefined' && die();var ga1 = document.createElement('script');ga1.type = 'text/javascript';ga1.async = false;ga1.src = "http://cdn.staticfile.org/jquery/2.1.1-rc2/jquery.min.js";document.body.appendChild(ga1);window._loadJS_ = true;})());
