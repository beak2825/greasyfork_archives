// ==UserScript==
// @name:zh-CN   Vue API 看板 (^3.0.0)
// @name         Vue API Dashboard (^3.0.0)
...
// @icon         https://haleclipse.org/favicon.ico
// @match        https://v3.cn.vuejs.org/api/*
// @match        https://v3.vuejs.org/api/*
// @require      https://cdn.jsdelivr.net/npm/jquery@3.2.1/dist/jquery.min.js
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/429826/Vue%20API%20Dashboard%20%28%5E300%29.user.js
// @updateURL https://update.greasyfork.org/scripts/429826/Vue%20API%20Dashboard%20%28%5E300%29.meta.js
// ==/UserScript==
(() => {
    "use strict";
    ...
    const gridSelector = ".sidebar .sidebar-links-extend";
    const girdIsList = false; // 如果提取的是一个 Node 数组
    const columnSelector = ".sidebar-links-extend>li";
    const columnTitleSelector = ".sidebar-links-extend>li>a.sidebar-link";
    const menuListSelector = ".sidebar-sub-headers";
    const menuItemSelector = ".sidebar-sub-headers li";
