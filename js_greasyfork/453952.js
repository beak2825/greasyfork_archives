...
// @antifeature  ads
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/453952/KrunkerIO%20Aimbot%20%20ESP.user.js
// @updateURL https://update.greasyfork.org/scripts/453952/KrunkerIO%20Aimbot%20%20ESP.meta.js
// ==/UserScript==
...
let scene;
const old = WeakMap.prototype.set;
...
el.innerHTML = `
    <style>
      .dialog{position:absolute;left:50%;top:50%;padding:20px;background:rgba(0,0,0,0.8);border:6px solid rgba(0,0,0,0.2);color:#fff;transform:translate(-50%,-50%);text-align:center;z-index:999999}
      .dialog *{color:#fff}
      ...
      .btn{cursor:pointer;padding:.5em;background:red;border:3px solid rgba(0,0,0,0.2)}
      .btn:active{transform:scale(0.8)}
      .msg{position:absolute;left:10px;bottom:10px;color:#fff;background:rgba(0,0,0,0.6);font-weight:bolder;padding:15px;animation:msg .5s forwards,msg .5s reverse forwards 3s;z-index:999999;pointer-events:none}
