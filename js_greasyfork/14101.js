...
// @grant          unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/14101/killBDMusicBox_Ad.user.js
// @updateURL https://update.greasyfork.org/scripts/14101/killBDMusicBox_Ad.meta.js
// ==/UserScript==
"use strict";
if (top === self) {
	let r = /(?:^|\W|_)ad(?:$|\W|_)/,
