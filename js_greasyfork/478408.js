...
// @downloadURL https://update.greasyfork.org/scripts/478408/FutabanetDownloader.user.js
// @updateURL https://update.greasyfork.org/scripts/478408/FutabanetDownloader.meta.js
// ==/UserScript==
...
(async function (axios, JSZip, saveAs, ImageDownloader, SpeedReaderTools) {
  ...
  ImageDownloader.init({
    ...
    getImagePromises,
    title: document.title.split('|').shift().replace('公式-', '').trim()
  });
