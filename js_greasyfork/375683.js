...
// @name        WOP Bot
// @version     1
// @author      jBOT, then Anon_guy and Bop It Freak
// @description Relatively smart robot-controller engine for OurWorldOfPixels, with batteries and robots included!
// @include     https://ourworldofpixels.com/*
// @run-at      document-end
// @grant       none
// @namespace https://greasyfork.org/users/233571
// @downloadURL https://update.greasyfork.org/scripts/375683/WOP%20Bot.user.js
// @updateURL https://update.greasyfork.org/scripts/375683/WOP%20Bot.meta.js
// ==/UserScript==
...
var BOTS = 8;//10;//9;//15;//19;//3;//2;//13;//14;//3;//29;//9;//2;//15;//29//2;//15;
...
var BUTTONS = [{
		...
		title: "connects bot when chaptcha is enabled"
	}, {
        value: "stop",
        call: function() {
            bots.stop = true;
...
function listUpdate() {
    if (list && OWOP) {
        ...
        for (var p in pple) {
            ...
            pstr = pid + " x:" + pos.x + " y:" + pos.y;
            itm = document.createElement("span");
            itm.id = pid;
            if (selected == pid)
                itm.innerHTML += "<font color='#0F0'>" + pstr + "</font>";
            else itm.innerHTML = pstr;
            list.appendChild(itm);
            list.insertAdjacentHTML('beforeend', "<br>");
        }
        list.insertAdjacentHTML('beforeend', "<font color='#F00'>" + protocol.id + " x:" +
...
cz_flag.width = 16;
cz_flag.height = 11;
var creep_img = [159, 204, 165, 255, 159, 204, 165, 255, 54, 197, 70, 255, 54, 197, 70, 255, 130, 203, 131, 255, 130, 203, 131, 255, 147, 193, 140, 255, 147, 193, 140, 255, 95, 224, 95, 255, 95, 224, 95, 255, 93, 220, 111, 255, 93, 220, 111, 255, 159, 204, 165, 255, 159, 204, 165, 255, 69, 148, 45, 255, 69, 148, 45, 255, 159, 204, 165, 255, 159, 204, 165, 255, 54, 197, 70, 255, 54, 197, 70, 255, 130, 203, 131, 255, 130, 203, 131, 255, 147, 193, 140, 255, 147, 193, 140, 255, 95, 224, 95, 255, 95, 224, 95, 255, 93, 220, 111, 255, 93, 220, 111, 255, 159, 204, 165, 255, 159, 204, 165, 255, 69, 148, 45, 255, 69, 148, 45, 255, 69, 148, 45, 255, 69, 148, 45, 255, 102, 136, 96, 255, 102, 136, 96, 255, 6, 147, 8, 255, 6, 147, 8, 255, 56, 197, 70, 255, 56, 197, 70, 255, 68, 128, 68, 255, 68, 128, 68, 255, 93, 220, 111, 255, 93, 220, 111, 255, 14, 113, 13, 255, 14, 113, 13, 255, 210, 210, 210, 255, 210, 210, 210, 255, 69, 148, 45, 255, 69, 148, 45, 255, 102, 136, 96, 255, 102, 136, 96, 255, 6, 147, 8, 255, 6, 147, 8, 255, 56, 197, 70, 255, 56, 197, 70, 255, 68, 128, 68, 255, 68, 128, 68, 255, 93, 220, 111, 255, 93, 220, 111, 255, 14, 113, 13, 255, 14, 113, 13, 255, 210, 210, 210, 255, 210, 210, 210, 255, 56, 197, 70, 255, 56, 197, 70, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 159, 204, 165, 255, 159, 204, 165, 255, 70, 213, 26, 255, 70, 213, 26, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 220, 220, 220, 255, 220, 220, 220, 255, 56, 197, 70, 255, 56, 197, 70, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 159, 204, 165, 255, 159, 204, 165, 255, 70, 213, 26, 255, 70, 213, 26, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 220, 220, 220, 255, 220, 220, 220, 255, 8, 186, 9, 255, 8, 186, 9, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 55, 162, 29, 255, 55, 162, 29, 255, 14, 113, 13, 255, 14, 113, 13, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 82, 229, 77, 255, 82, 229, 77, 255, 8, 186, 9, 255, 8, 186, 9, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 55, 162, 29, 255, 55, 162, 29, 255, 14, 113, 13, 255, 14, 113, 13, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 82, 229, 77, 255, 82, 229, 77, 255, 82, 229, 77, 255, 82, 229, 77, 255, 56, 197, 70, 255, 56, 197, 70, 255, 96, 225, 96, 255, 96, 225, 96, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 194, 211, 197, 255, 194, 211, 197, 255, 96, 225, 96, 255, 96, 225, 96, 255, 56, 197, 70, 255, 56, 197, 70, 255, 82, 229, 77, 255, 82, 229, 77, 255, 56, 197, 70, 255, 56, 197, 70, 255, 96, 225, 96, 255, 96, 225, 96, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 194, 211, 197, 255, 194, 211, 197, 255, 96, 225, 96, 255, 96, 225, 96, 255, 56, 197, 70, 255, 56, 197, 70, 255, 149, 192, 141, 255, 149, 192, 141, 255, 69, 148, 45, 255, 69, 148, 45, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 102, 136, 96, 255, 102, 136, 96, 255, 173, 204, 177, 255, 173, 204, 177, 255, 149, 192, 141, 255, 149, 192, 141, 255, 69, 148, 45, 255, 69, 148, 45, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 102, 136, 96, 255, 102, 136, 96, 255, 173, 204, 177, 255, 173, 204, 177, 255, 187, 227, 192, 255, 187, 227, 192, 255, 92, 158, 87, 255, 92, 158, 87, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 158, 240, 158, 255, 158, 240, 158, 255, 67, 148, 45, 255, 67, 148, 45, 255, 187, 227, 192, 255, 187, 227, 192, 255, 92, 158, 87, 255, 92, 158, 87, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 158, 240, 158, 255, 158, 240, 158, 255, 67, 148, 45, 255, 67, 148, 45, 255, 55, 164, 26, 255, 55, 164, 26, 255, 159, 204, 165, 255, 159, 204, 165, 255, 0, 0, 0, 255, 0, 0, 0, 255, 137, 224, 126, 255, 137, 224, 126, 255, 187, 227, 192, 255, 187, 227, 192, 255, 0, 0, 0, 255, 0, 0, 0, 255, 56, 197, 70, 255, 56, 197, 70, 255, 84, 205, 101, 255, 84, 205, 101, 255, 55, 164, 26, 255, 55, 164, 26, 255, 159, 204, 165, 255, 159, 204, 165, 255, 0, 0, 0, 255, 0, 0, 0, 255, 137, 224, 126, 255, 137, 224, 126, 255, 187, 227, 192, 255, 187, 227, 192, 255, 0, 0, 0, 255, 0, 0, 0, 255, 56, 197, 70, 255, 56, 197, 70, 255, 84, 205, 101, 255, 84, 205, 101, 255];
creep_img.width = 16;
creep_img.height = 16;
...
var DELAY = Math.ceil(4 + (MOD?65:130) / BOTS); //max is allowed 200pixels/4s (1px/125ms), for mods 200pixels/2s (1px/62.5ms)
var inter, f = 0;
bots.busy = false;
bots.online = false;
bots.job = "";
...
bots.follow = function(id) {
    ...
    while (i--)
        if (this[i] && !this.busy) {
            a = BOTSLICE * i + f;
          this[i].pos.x = pos.x + (Math.cos(12 * Math.PI / BOTS * i + f) * 8);
            this[i].pos.y = pos.y + (Math.sin(2 * Math.PI / BOTS * i + f) * 8);
        }
    f = (f + FOLLOWADD) % PI2;
}.bind(bots);
...
function Bot(idx) {
    ...
    that.options = {
      ...
      //"ws://ourworldofpixels.com:13375/"
        ...
        netUpdateSpeed: 100 // How many times per second to send updates to server
    };
    that.pos = {
        x: 0,
        y: 0,
...
var listInt = setInterval(listUpdate, 200);
