...
// @downloadURL https://update.greasyfork.org/scripts/375558/wsmud_pluginss_007.user.js
// @updateURL https://update.greasyfork.org/scripts/375558/wsmud_pluginss_007.meta.js
// ==/UserScript==

(function () {
    'use strict';
    var updateinfo = "增加自动施法开关设置";
    ...
    var place = {
        ...
        "扬州城-帮派-练功": "jh fam 0 start;go south;go south;go east;go east;go east;go north",
        ...
        "副本-温府": "jh fb 10 start1;cr cd/wen/damen;go north;climb tree;go north;",
        "扬州城-大门-练功": "jh fam 0 start;go west;go west;go north;go enter;go west;",
        "武道塔": "jh fam 8 start"
    };
    var drop_list = [];
    var fenjie_list = [];
    ...
    function messageClear() {$(".WG_log pre").html("");}
    var log_line = 0;
    function messageAppend(m, t = 0) {
        100 < log_line && (log_line = 0, $(".WG_log pre").empty());
        var ap = m + "\n";
        if (t == 1) {ap = "<hiy>" + ap + "</hiy>";
        }
        else if (t == 2) {ap = "<hig>" + ap + "</hig>";
        }
        else if (t == 3) {ap = "<hiw>" + ap + "</hiw>";
        }
    ...
    var sm_array = {
        ...
        '少林': {place: "少林派-广场",npc: "少林寺第四十代弟子 清乐比丘"},
        '逍遥': {place: "逍遥派-青草坪",npc: "聪辩老人 苏星河"},
        '丐帮': {place: "丐帮-树洞下",npc: "丐帮七袋弟子 左全"},
        '峨眉': {place: "峨眉派-庙门",npc: "峨嵋派第五代弟子 苏梦清"},
        '武馆': {place: "扬州城-扬州武馆",npc: "武馆教习"},
    };
    var WG = {
        sm_state: -1,
        sm_item: null,
...
<span class='zdy-item kill_all'>杀(E))</span>
<span class='zdy-item get_all'>拾(R)</span>
<span class='zdy-item sell_all'>清(T)</span>
<span class='zdy-item drop_all'>丢(d)</span>
<span class='zdy-item xue_all'>学(X)</span>
<span class='zdy-item zdwk'>挖(Y)</span>
...
`;
            ...
            unauto_skills = GM_getValue(role + "_unauto_skills", unauto_skills);
            ...
            $(".drop_all").on("click", WG.drop_all);
            $(".xue_all").on("click", WG.xue_all);
...
插件版本: ${GM_info.script.version}
        ...
        clean_all: function () {
         ...
         drop_all: function () {
             ...
             messageAppend("<hio>悟空告诉你,到了安全地方可以丢定西 </hio>" );
        },
        xue_all: function () {
            //练习到多少等级 unauto_skills  11.30待完善，先手动1400
           //  $('#unauto_skills').val(unauto_skills);
           // $('#unauto_skills').focusout(function () {
           //     unauto_skills = $('#unauto_skills').val();
            //    GM_setValue(role + "unauto_skills", unauto_skills);
           // });
             WG.Send("stopstate"); //先停止手上的事情
             //进入练功房
             if (!WG.at("扬州城-大门-练功")){
                WG.go("扬州城-大门-练功");
          setTimeout(() => {
              var unauto_skills = "1400";
          // KEY.do_command("skills");//动作打开技能
             WG.Send("lianxi sword 1400");//命中练习基本剑法
             WG.Send("lianxi blade 1400");//命中练习基本刀法
             WG.Send("lianxi unarmed 1400");//练习基本拳脚
             WG.Send("lianxi whip 1400");//命中练习基本鞭法
             WG.Send("lianxi throwing 1400");//命中练习基础暗器
             WG.Send("lianxi force 1000" );//练习基本内功
             WG.Send("lianxi dodge 1000");//练习基础轻功
             WG.Send("lianxi parry 1400");//练习基本招架
             WG.Send("lianxi staff 1400");//练习基本杖法
             WG.Send("lianxi club 1400");//练习基本棍法
            }, 500)
            ...
            messageAppend("<hio>悟空告诉你,请开始自己练习</hio>" );
        },
        ...
        wudao_auto: function () {
            //创建定时器
            if (timer == 0) { timer = setInterval(WG.wudao_auto, 2000);}
            if (!WG.at("武道塔")) {
                //进入武道塔
                WG.go("武道塔");
                WG.ask("守门人", 1);
...
<span><label for ="unauto_skills" >练习到多少等级： </label><input style='width:80px' type="text" id="unauto_skills" name="unauto_skills" value="">
</span>
    ...
    $(document).ready(function () {
        ...
        $.contextMenu({
            ...
            items: {
                "关闭自动": {
                    name: "关闭自动",
                    visible: function (key, opt) { return timer != 0;},
                ...
                "自动": {
                    ...
                    "items": {
                        "自动打坐学习": {
                            name: "自动打坐学习",
                            callback: function (key, opt) { WG.xue_auto();},
                        },
                        "自动武道": {
                            name: "自动武道",
                            callback: function (key, opt) {WG.wudao_auto();},
                        },
                        "自动小树林": {
                            name: "自动小树林",
                            callback: function (key, opt) {WG.grove_auto();}
                        },
                          "自动温府": {
                            name: "自动温府",
                            callback: function (key, opt) {WG.grovewen_auto();}
                        },
                        "自动整理并清包": {
                            name: "自动整理并清包",
                            callback: function (key, opt) { WG.sell_all();}
                        },
                        "自动比试": {
                            name: "自动比试",
                            visible: function (key, opt) {return Helper.fight_listener == undefined;},
                        ...
                        "自动使用道具": {name: "自动使用道具",callback: function (key, opt) {Helper.auto_useitem();},},
                    },
                },
                "换装设置": {
                    name: "换装设置",
                    "items": {
                        "xx0": {name: "套装1设定或装备",callback: function (key, opt) {Helper.eqhelper(1);},},
                        "xx1": {name: "清除套装1设置",callback: function (key, opt) {Helper.eqhelperdel(1);},},
                        "yy0": {name: "套装2设定或装备",callback: function (key, opt) {Helper.eqhelper(2);},},
                        "yy1": {name: "清除套装2设置",callback: function (key, opt) {Helper.eqhelperdel(2);},},
                        "zz0": {name: "套装3设定或装备",callback: function (key, opt) {Helper.eqhelper(3);},},
                        "zz1": {name: "清除套装3设置",callback: function (key, opt) {Helper.eqhelperdel(3);},},
                        "uneq": {name: "取消所有装备",callback: function (key, opt) {Helper.uneqall();},},
                    }
                },
                "手动喜宴": {
                    name: "手动喜宴",callback: function (key, opt) {Helper.xiyan();},
                },
                "快捷传送": {
                    name: "常用地点",
                    "items": {
                        ...
                        "mp3": {name: "帮派",callback: function (key, opt) {WG.go("扬州城-帮派");},},
                ...
                "门派传送": {
                    name: "门派传送",
                    "items": {
                        "mp0": {name: "武当",callback: function (key, opt) {WG.go("武当派-广场");},},
                        "mp1": {name: "少林",callback: function (key, opt) {WG.go("少林派-广场");},},
                        "mp2": {name: "华山",callback: function (key, opt) {WG.go("华山派-镇岳宫");},},
                        "mp3": {name: "峨眉",callback: function (key, opt) {WG.go("峨眉派-金顶")},},
                        "mp4": {name: "逍遥",callback: function (key, opt) {WG.go("逍遥派-青草坪");},},
                        "mp5": {name: "丐帮",callback: function (key, opt) {WG.go("丐帮-树洞内部");},},
                        "mp6": {name: "武馆",callback: function (key, opt) { WG.go("扬州城-扬州武馆");},}
                    },
                },
                "打开仓库": {name: "打开仓库",callback: function (key, opt) {WG.go("仓库");},},
                "更新ID": {
                    name: "更新ID",
                ...
                "计算器": {name: "计算器",callback: function (key, opt) {WG.calc();},},
                "打开面板": {
                    name: "打开面板",
                    visible: function (key, opt) {return $('.WG_log').css('display') == 'none';},
                    callback: function (key, opt) {WG.showhideborad();},
                },
                "关闭面板": {
                    name: "关闭面板",
                    visible: function (key, opt) {return $('.WG_log').css('display') != 'none';},
