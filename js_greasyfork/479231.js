...
// @license      MIT
// @connect      *
// @downloadURL https://update.greasyfork.org/scripts/479231/1114AE%E6%A8%A1%E5%9E%8B%E8%80%83%E8%AF%95%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/479231/1114AE%E6%A8%A1%E5%9E%8B%E8%80%83%E8%AF%95%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
(function() {
	...
	function getBasicInfor() {
		url_query = document.querySelector(
			"#root > div > div > div > div > div > div.right___3YXGN > div.ant-card.ant-card-bordered > div > div:nth-child(1)"
		).innerText;
		url_title = document.querySelector(
			"#root > div > div > div > div > div > div.right___3YXGN > div.ant-card.ant-card-bordered > div > div:nth-child(2)"
		).innerText;
		url_url = document.querySelector(
			"#root > div > div > div > div > div > div.right___3YXGN > div.ant-card.ant-card-bordered > div > div:nth-child(3)"
		).innerText;
		url_body = document.querySelector(
			"#root > div > div > div > div > div > div.right___3YXGN > div.ant-card.ant-card-bordered > div > div:nth-child(4) > div"
			).innerText
