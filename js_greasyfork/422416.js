...
// @downloadURL https://update.greasyfork.org/scripts/422416/find%20mag.user.js
// @updateURL https://update.greasyfork.org/scripts/422416/find%20mag.meta.js
// ==/UserScript==
                ...
                if (codes) {
                    ...
                    for (const code of codes) {
                        proArr.push(new Promise(resolve => {
                            GM_xmlhttpRequest({
                                method: 'GET',
                                url: "https://btsow.cam/search/" + code,
                                onload: function (responseDetails) {
                                    var responseData = responseDetails.response;
                                    var magnet = responseData.match(/hash\/([0-9a-zA-Z]{40,})/)[1];
                                    if (magnet != null) {
