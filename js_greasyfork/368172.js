...
// @description		根据原作者ywzhaiqi&&NLF版本修改，原版地址:https://github.com/ywzhaiqi
// @iconURL			http://p8fvixyr8.bkt.clouddn.com/images/icon/superPreloader.ico
// @author       Richard He
// @version			0.1
...
// @downloadURL https://update.greasyfork.org/scripts/368172/superPreloader.user.js
// @updateURL https://update.greasyfork.org/scripts/368172/superPreloader.meta.js
// ==/UserScript==
...
var SITEINFO=[
    ...
    {name: '中国新闻网',
        ...
        autopager:{
            pageElement:'//div[@class="main-list"] | //div[@class="hd_photo"]',
            relatedObj: true,
    ...
    {name: 'FT中文网',
        ...
        nextLink: '//div[@class="pagination-inner"]/a[text()="余下全文"]',
        autopager: {
            pageElement: '//div[@class="story-body"]',
        }
    },
    {name: '汽车之家论坛帖子和列表',
    ...
    {name: '抢了个便宜 | 高性价比正品低价商品推荐网',
        ...
        nextLink: '//a[text()="下页"]',
        autopager: {
            pageElement: 'id("home-left")//div[starts-with(@id,"post-")]',
				relatedObj:true,
    ...
    {name: 'meituba.com',
        url: '^http://www\\.meituba\\.com/.+/.+\\.html',
        nextLink: '//a[text()="下一页"]',
         pageElement: '//div[@class="photo"]/a',
         exampleUrl: 'http://www.meituba.com/xinggan/67444.html',
    },
    {name: 'tupianzj.com',
        url: '^http://www\\.tupianzj\\.com/.+/.+/.+\\.html',
        nextLink: '//a[text()="下一页"]',
         pageElement: '//div[@class="pictu900"]',
         exampleUrl: 'http://www.meituba.com/xinggan/67444.html',
    },
    {name: '27270.com',
        url: '^http://www\\.27270\\.com/.+/.+/.+/.+\\.html',
        nextLink: '//a[text()="下一页"]',
         pageElement: '//div[@class="articleV4Body"]',
         exampleUrl: 'http://www.meituba.com/xinggan/67444.html',
    },
    {name: 'mm131.com',
        url: '^http://www\\.mm131\\.com/.+/.+\\.html',
        nextLink: '//a[text()="下一页"]',
         pageElement: '//div[@class="content-pic"]/a/img',
         exampleUrl: 'http://www.meituba.com/xinggan/67444.html',
    },
    {name: '99retu.com',
        url: '^http://www\\.qqretu\\.com/.+/.+\\.html',
        nextLink: '//a[text()="下一页"]',
         pageElement: 'id("articleV3Body2")',
         exampleUrl: 'http://www.meituba.com/xinggan/67444.html',
    },
    {name: 'jipintu.com',
        url: '^http://www\\.jipintu\\.com/.+/.+\\.html',
        nextLink: '//a[text()="下一页"]',
         pageElement: '//div[@class="pbox_sub"]',
         exampleUrl: 'http://www.meituba.com/xinggan/67444.html',
    },
    // === 壁纸、素材、icon
    {name: '桌酷壁纸',
    ...
    function autopager(SSS, floatWO) {
        ...
        function createSep(lastUrl, currentUrl, nextUrl) {
            ...
            if (SSS.a_separator) {
                ...
                var pageStr = '第 <span class="pageNum">' + curNumber + '</span> 页' +
...
function getRalativePageStr(lastUrl, currentUrl, nextUrl) {
    ...
    if (realPageSiteMatch) { //如果匹配就显示实际网页信息
        if (ralativePageNumarray[1] - ralativePageNumarray[0] > 1) { //一般是搜索引擎的第xx - xx项……
            ralativePageStr = ' [ 第 <span class="pageNum">' + ralativePageNumarray[0] + ' - ' + ralativePageNumarray[1] + '</span> 项 ]';
        } else if ((ralativePageNumarray[1] - ralativePageNumarray[0]) === 1) { //一般的翻页数，差值应该是1
            ralativePageStr = ' [ 第 <span class="pageNum">' + ralativePageNumarray[0] + '</span> 页 ]';
        } else if ((ralativePageNumarray[0] === 0 && ralativePageNumarray[1]) === 0) { //找不到的话……
            ralativePageStr = ' [ <font color="red">网页结束</font> ]';
        }
    } else {
        ralativePageStr = '';
    }
