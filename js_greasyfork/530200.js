...
// @version      2024-10-27
// @description  Free & unlimited ressources
// @author       You
// @match        https://littlebigsnake.com/*
// @icon         data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==
// @grant        GM_addStyle
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/530200/Mod%20Menu.user.js
// @updateURL https://update.greasyfork.org/scripts/530200/Mod%20Menu.meta.js
// ==/UserScript==
    ...
    function initialize() {
        ...
        document.body.insertAdjacentHTML('beforeend', `
            <div id="custom-menu" class="custom-menu">
                <h2 class="menu-title">Game Options</h2>
                <div class="option">
                    <span>Zoom View</span>
                    <div style="width: 300px;">
                        <input type="range" id="zoomSlider" class="zoom-slider" min="50" max="300" value="100">
                        <div id="zoomValue" style="color: #; text-align: center;">100%</div>
                    </div>
                </div>
                <div class="option">
            ...
            <button id="menuToggle" class="menu-toggle-btn">Mod Menu</button>
        `);
