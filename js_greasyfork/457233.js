// ==UserScript==
// @name         Для Mitsuhiro_Miyake
// @namespace    https://forum.blackrussia.online
// @version      1.1
// @description  Для Алексея
// @author     Jesus White
...
// @downloadURL https://update.greasyfork.org/scripts/457233/%D0%94%D0%BB%D1%8F%20Mitsuhiro_Miyake.user.js
// @updateURL https://update.greasyfork.org/scripts/457233/%D0%94%D0%BB%D1%8F%20Mitsuhiro_Miyake.meta.js
// ==/UserScript==
...
'[RIGHT][B][FONT=trebuchet ms][SIZE=3]- [COLOR=rgb(225, 25, 25)]Mitsuhiro_Miyake[/COLOR].[/SIZE][/FONT][/B][/RIGHT]',
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Жалоба составлена не по форме или же не соответствует правилам подачи. Ознакомится - [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-администрацию.193340/']Кликабельно[/URL].<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR]. [/B][/FONT][/SIZE][/CENTER]<br>" +
                        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=CRIMSON]CRIMSON[/COLOR].<br><br>"+
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B][SIZE=3][FONT=trebuchet ms][B]Вы получили наказание от Технического Специалиста нашего сервера, обратитесь в соответствующий раздел. Раздел - [URL='https://forum.blackrussia.online/index.php?forums/Сервер-№10-black.1191/']Кликабельно[/URL].<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR]. [/B][/FONT][/SIZE][/CENTER]<br>" +
                        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=CRIMSON]CRIMSON[/COLOR].<br><br>"+
