...
// @include     https://*virtonomic*.*/*/main/company/view/*/unit_list/shop
// @include     https://*virtonomic*.*/*/main/company/view/*/unit_list/service
// @version     0.12
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/1534/Virtonomica%3A%D0%A1%D0%BD%D0%B0%D0%B1%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/1534/Virtonomica%3A%D0%A1%D0%BD%D0%B0%D0%B1%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5.meta.js
// ==/UserScript==
var run = function() {
   ...
   $("#set_1_1").click(function(){
	...
	for(var i=0; i<tr.length; i++){
	   ...
	   var link = $(".pseudolink", row).eq(0);
           var str = $.trim( link.text() ).replace("Требуется: ", '').replace(" ", '').replace(" ", '').replace(" ", '').replace(" ", '');
           //console.log( str );
