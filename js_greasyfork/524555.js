...
// @icon         https://i.postimg.cc/DfPxd1H4/761748537d7b8982d68489b28f29147a.jpg
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/524555/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20ensemble%20mansory.user.js
// @updateURL https://update.greasyfork.org/scripts/524555/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20ensemble%20mansory.meta.js
// ==/UserScript==
...
{
	  title: '__________________________________________Правила RolePlay процесса__________________________________________'
},
{
...
{
	  title: '__________________________________________Правила чата__________________________________________'
},
{
...
{
	  title: '__________________________________________На рассмотрение__________________________________________'
},
{
...
},
{
	  ...
	  content:
		...
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=#0000ff]Техническому специалисту[/COLOR], пожалуйста ожидайте ответа.<br><br>"+
                "[FONT=times new roman][SIZE=4]Порой рассмотрение подобных жалоб может занять больше двух дней, убедительная просьба не создавать копии данной темы.[CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
        prefix: TEXY_PREFIX,
	  status: false,
},
...
{
	  title: '__________________________________________NickName__________________________________________'
},
{
	  title: '| NonRP Nik |',
	  content:
...
{
	  title: '__________________________________________В другой раздел__________________________________________'
},
{
	  title: '| В жб на адм |',
	  content:
...
{
	  title: '__________________________________________ЗАКРЫТИЕ ЖАЛОБЫ__________________________________________'
},
{
	  title: '| Дубликат |',
	  content:
...
{
	  title: '__________________________________________Правила госс. структур__________________________________________'
},
{
...
{
	  title: '__________________________________________Отказ жалобы__________________________________________'
},
{
...
},
{
  ...
  {
    	  title: '__________________________________________RolePlay Биографии__________________________________________'
},
{
        	  title: '| Био одобрена |',
	  content:
