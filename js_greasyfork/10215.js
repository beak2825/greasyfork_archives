...
// @run-at 		document-end
// @downloadURL https://update.greasyfork.org/scripts/10215/Mirkohelper%20-%20NEW.user.js
// @updateURL https://update.greasyfork.org/scripts/10215/Mirkohelper%20-%20NEW.meta.js
// ==/UserScript==
...
function main() {
    ...
    */
	//DA JOB
    //usuwa Maciejowy helper w komentarzach - komoszek
    $("body").hover(function(){
        $('div.grid-main div.ddC div.dropdown table').remove();
        $('div#mirkohelper').remove();
        ...
        $('div#mirkohelper').append('<span class="mirkoFooter"><a class="color" href="http://www.wykop.pl/dodatki/pokaz/291/" title="Strona MirkoHelpera" target="_blank">MirkoHelper</a> by <a class="color" href="http://www.wykop.pl/ludzie/Osael/" target="_blank" title="( ͡° ͜ʖ ͡°) usuń konto">@osael</a><br /><a class="color" href="http://www.wykop.pl/dodatki/pokaz/291/" title="Strona MirkoHelpera" target="_blank">Edited</a> by <a class="color" href="http://www.wykop.pl/ludzie/Komoszek/" target="_blank" title="( ͡° ͜ʖ ͡°) usuń konto">@Komoszek</a></span>');   
    ...
    if(window.location.href.indexOf("ulubione") <0) {
        ...
        $('div.grid-main div.ddC div.dropdown table').remove();
         ...
         if(document.getElementById("mirkohelper") == null) //Sprawdza czy już nie został mirkohelper wstawiony  - komoszek
{
           $('div.grid-main div.ddC div.dropdown').prepend('<div id="mirkohelper" class="summary"></div>');
        $('div#mirkohelper').append('<div id="mirki">'+ MirkoSmieszki +'</div>');
        $('div#mirkohelper').append('<div id="mirkiusr" class="bgfff rel">'+ MirkoSmieszkiusr +'</div>');
