...
// @downloadURL https://update.greasyfork.org/scripts/502822/Khan%20Academy%20Hack.user.js
// @updateURL https://update.greasyfork.org/scripts/502822/Khan%20Academy%20Hack.meta.js
// ==/UserScript==
...
<button class="main" id="accordian">=</button>
    <div class="main" id="box2">
        <center><p class="pdark" id="pdark"> Krakdemy V2 </p></center>
        <button onclick="location.reload()" class="inputans">Resetar lista</button>
        <br>
        ...
        <section class="toggleclass"><label>Tecla F esconde o menu</label></section>
        <section class="toggleclass"><label>Patch 21e58d6m8a24</label></section>
    </div>
</div>
