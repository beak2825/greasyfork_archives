...
// @version      0.1
// @description  获取 gtimg.com 验证码网站返回的 ticket
// @author       nao
// @match        https://*.captcha.gtimg.com/*
// @grant        GM_setClipboard
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/474402/ticket%20get.user.js
// @updateURL https://update.greasyfork.org/scripts/474402/ticket%20get.meta.js
// ==/UserScript==

(function () {
    'use strict';
    // copy https://scriptcat.org/lib/637/1.3.2/ajaxHooker.js
    ...
    ajaxHooker.hook(request => {
        request.response = value => {
            let json = JSON.parse(value.responseText);
            if (json.errorCode == "0") {
                alert('已经复制到剪切版');
                GM_setClipboard(json.ticket, 'text/plain');
            };
        };
    });
})();