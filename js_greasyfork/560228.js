// ==UserScript==
// @name Для Руководства || by F Angel || Special for Xayn || Patch 8.8.8.0
...
// @downloadURL https://update.greasyfork.org/scripts/560228/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%7C%7C%20by%20F%20Angel%20%7C%7C%20Special%20for%20Xayn%20%7C%7C%20Patch%208880.user.js
// @updateURL https://update.greasyfork.org/scripts/560228/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%7C%7C%20by%20F%20Angel%20%7C%7C%20Special%20for%20Xayn%20%7C%7C%20Patch%208880.meta.js
// ==/UserScript==
...
(function () {
    ...
    title: 'СВОЙ ОТВЕТ',
    content:
    '[COLOR=rgb(210, 180, 140)][SIZE=4][FONT=georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}<br>[/Color]'+
    "Твой текст <br><br>"+
     "[COLOR=rgb(210, 180, 140)]Приятной игры и времяпровождение на сервере [/Color][COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/FONT][/CENTER][/B][/SIZE]"+
         "<br>[CENTER][/CENTER]",
    },
    {
    ...
    '[COLOR=rgb(210, 180, 140)]Приятной игры и времяпровождение на сервере [/Color][COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/CENTER][/B][/SIZE]'+
         "<br>[CENTER][/CENTER]",
...
'[COLOR=rgb(210, 180, 140)]Приятной игры и времяпровождение на сервере [/Color][COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/CENTER][/B][/SIZE]'+
    ...
    content:
     '[COLOR=rgb(210, 180, 140)][SIZE=4][FONT=georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}<br>[/Color]'+
    "[CENTER]Обратитесь со своей проблемов в  [URL='https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-norilsk.3985/']«Технический раздел [COLOR=rgb(174, 212, 246)]NORILSK[/color]».[/URL][/CENTER]<br><br>"+
    '[COLOR=rgb(210, 180, 140)]Приятной игры и времяпровождение на сервере [/Color][COLOR=rgb(174, 212, 246)]NORILSK[/COLOR].[/CENTER][/B][/SIZE]'+
         "<br>[CENTER][/CENTER]",
    prefix: UNACCEPT_PREFIX,
    status: false,
    ...
    content:
     '[COLOR=rgb(210, 180, 140)][SIZE=4][FONT=georgia][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}<br>[/Color]'+
    "[CENTER]Ваша жалоба будет передана [COLOR=rgb(204,6,5)]Специальной Администрации[/color] - @Sander_Kligan, @Clarence Crown, @Dmitry Dmitrich, @Myron_Capone, @Liana_Mironova,@Gleb Xovirs, @Candy_Rotmans @Serega Forestry .[/CENTER]<br><br>"+
    '[CENTER][Color=Orange]На рассмотрении.[/Color][/CENTER][/B][/SIZE]'+
         "<br>[CENTER][/CENTER]",
    prefix: SA_PREFIX,
    status: true,
