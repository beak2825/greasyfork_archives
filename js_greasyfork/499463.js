...
// @downloadURL https://update.greasyfork.org/scripts/499463/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20ASkay%20and%20AZobnin%20and%20DThomson.user.js
// @updateURL https://update.greasyfork.org/scripts/499463/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20ASkay%20and%20AZobnin%20and%20DThomson.meta.js
// ==/UserScript==
(function() {
    'use strict';
...
{
      title: 'Био состав не по форме',
      content:
         '[Color=rgb(255, 0, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
"[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>" +
"Причиной могло стать составлено не по форме.[/CENTER][/FONT]",
prefix: UNACCEPT_PREFIX,
status: false,
},
{
    ...
    content:
'[Color=rgb(255, 0, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
"[CENTER] Ваша RolePlay Биография получает статус: [color=Red]Отказано.[/color]<br>" +
"Причиной отказа стало отсуствие дат рождения.",
prefix: UNACCEPT_PREFIX,
status: false,
},
{
