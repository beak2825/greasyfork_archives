// ==UserScript==
// @name AudioBookBay hide category: Adventure
// @description Hide Adventure category
...
// @downloadURL https://update.greasyfork.org/scripts/484541/AudioBookBay%20hide%20category%3A%20Adventure.user.js
// @updateURL https://update.greasyfork.org/scripts/484541/AudioBookBay%20hide%20category%3A%20Adventure.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Adventure'
    $(".post").has(".postInfo:contains('Adventure')").hide();
});
