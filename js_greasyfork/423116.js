...
// @include http://nothing/add-sites-via-menu/
...
// @downloadURL https://update.greasyfork.org/scripts/423116/Wurzelimperium%20Anbauhelfer.user.js
// @updateURL https://update.greasyfork.org/scripts/423116/Wurzelimperium%20Anbauhelfer.meta.js
// ==/UserScript==
...
function checkUpdate(response) {
	if (response) {
		...
		if (newer(version, newVersion) && confirm("Eine neue Version des Anbauhelfers ist verfügbar. (" + version + "->" + newVersion + ") Änderungen: " + changes + "\nJetzt herunterladen?")) {
			self.location.href = "https://userscripts-mirror.org/scripts/source/168137.user.js";
		}
	} else {
		GM_xmlhttpRequest({
			method: "GET",
			url: "https://userscripts-mirror.org/scripts/source/119724.meta.js",
