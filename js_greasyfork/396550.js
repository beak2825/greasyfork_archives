...
// @namespace    特長是特長
// @version      0
// @description  2 mask thx
// @author       Fui & lihkg 特長是特長
// @match        https://www.amazon.co.jp/gp/offer-listing/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/396550/MonMask2800.user.js
// @updateURL https://update.greasyfork.org/scripts/396550/MonMask2800.meta.js
// ==/UserScript==
...
(async function() {
    ...
    if (seller.nodeName == 'IMG' && seller.alt == 'Amazon.co.jp'){
        document.body.style.background = "lightgreen";
        beep();
        document.querySelector('input[class="a-button-input"]').click();
