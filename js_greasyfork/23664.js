// ==UserScript==
// @name        Newest VPS | SSD
// @namespace    PolarsBots.Tk | SSD
// @version      V4.2
// @description  PolarsBots.Tk
// @author       Polar | G
// @match       *.gota.io/*
// @match       *.agariohub.net/*
// @match       *.agarserv.com/*
...
// @downloadURL https://update.greasyfork.org/scripts/23664/Newest%20VPS%20%7C%20SSD.user.js
// @updateURL https://update.greasyfork.org/scripts/23664/Newest%20VPS%20%7C%20SSD.meta.js
// ==/UserScript==
setTimeout(function() {
    ...
    var socket = io.connect('ws://107.182.236.69:8081');
    var canMove = true;
