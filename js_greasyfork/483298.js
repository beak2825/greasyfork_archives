// ==UserScript==
// @name         Missions' Tasks & Hints
// @namespace    tpda
// @version      1.0
// @description  Adds a more precise task description and a hint for (Duke) missions. Code was modified from TornTools repo https://github.com/Mephiles/torntools_extension/blob/master/extension/scripts/features/mission-hints/ttMissionHints.js
// @author       Unpsofable [2754164]
// @match        https://www.torn.com/loader.php?sid=missions
// @downloadURL https://update.greasyfork.org/scripts/483298/Missions%27%20Tasks%20%20Hints.user.js
// @updateURL https://update.greasyfork.org/scripts/483298/Missions%27%20Tasks%20%20Hints.meta.js
// ==/UserScript==
...
function missionsContainerUpdated() {
    ...
    for (const context of document.querySelectorAll(".giver-cont-wrap > div[id^=mission]:not(.tpda-modified)")) {
        ...
        let mission_info = '';
        if (hint) {
            mission_info = "<div class=\"tpda-mission-information\"><h6 class=\"tpda-mission-title\">Mission Information</h6><span><b>Task: </b>" + task + "</span><br><span><b>Hint: </b>" + hint + "</span></div>";
        }
        else {
            mission_info = "<div class=\"tpda-mission-information\"><h6 class=\"tpda-mission-title\">Mission Information</h6><span><b>Task: </b>" + task +"</span></div>";
        }

			context.querySelector(".max-height-fix").innerHTML += mission_info;
			context.classList.add("tpda-modified");
		}
...
GM_addStyle(`
.tpda-mission-information {
	margin-top: 16px;
}

.tpda-mission-information > span {
	display: block;
}
