...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/472127/VORONEZH%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%5Bby%20Roma_Clever%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/472127/VORONEZH%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%5Bby%20Roma_Clever%5D.meta.js
// ==/UserScript==
...
const buttons = [
      {
	  title: '| ___________________________Раздел Жалобы на игроков___________________________ |',
      },
     { title: 'Приветствие',
      content:
     ...
     },
     {
      ...
      {
	  title: '| ____________________________________ОТКАЗЫ____________________________________ |',
	},
    {
	  title: '| Не по форме |',
	  content:
    ...
    {
        title: '_________________________________________Доказательства__________________________________________',
           },
    {
	...
	},
  {
	  ...
	  content:
		"[B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Предоставленные доказательства недостаточно для принятия решения или не корректны, если у вас имеются дополнительные доказательства, то прикрепите их, создав новую тему.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
