...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/537209/Torn%20Direct%20Revive%20Request%20with%20ID%20Input.user.js
// @updateURL https://update.greasyfork.org/scripts/537209/Torn%20Direct%20Revive%20Request%20with%20ID%20Input.meta.js
// ==/UserScript==

(function() {
    'use strict';

    const REVIVER_ID = "3491213"; // 🔹 Replace with the reviver's Torn ID
    ...
    function injectApiKeyManagementButton() {
        ...
        btn.title = "Click to set, change, or delete your Torn API key";
        btn.style.position = "fixed";
        btn.style.top = "10px";     // Changed from bottom to top
        btn.style.right = "10px";
        btn.style.zIndex = "10000"; // Very high z-index to avoid hiding
