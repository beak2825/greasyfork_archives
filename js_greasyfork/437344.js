// ==UserScript==
// @name         SURVIV.IO HACK MAP+
// @namespace    https://hết_cập_nhập
// @version      1.1.1
// @license MIT
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/437344/SURVIVIO%20HACK%20MAP%2B.user.js
// @updateURL https://update.greasyfork.org/scripts/437344/SURVIVIO%20HACK%20MAP%2B.meta.js
// ==/UserScript==
...
Object.keys(obstacles).forEach(function(key2) {
    ...
    if(key2.match(/container_06/g)) {
        obstacles[key2].map.color = 0xe3e309;
        for(var ceilC6Img in obstacles[key2].ceiling.imgs) {
            obstacles[key2].ceiling.imgs[ceilC6Img].alpha = .5
        }
    } else if(obstacles[key2].type === "building") {
        for(var ceilImg in obstacles[key2].ceiling.imgs) {
            obstacles[key2].ceiling.imgs[ceilImg].alpha = .5
        }
    }
})
Object.keys(obstacles).forEach(function(key3) {
    if(key3.match(/barrel_01b/g)) {
        ...
        obstacles[key3].map.color = 0xffffff;
        obstacles[key3].map.scale = 5;
