// @aurhor — Kizaru_Saint
// @authorvk — @swedesdart_rus
// для чего? — Для КФ.
// ==UserScript==
// @name         Script forum for BLUE / Saint
// @namespace    https://forum.blackrussia.online
// @version      1.72
// @description  Скрипт для Модераторов Форума | Black Russia BLUE by K.Saint
// @author       Kizaru_Saint
...
// @downloadURL https://update.greasyfork.org/scripts/454471/Script%20forum%20for%20BLUE%20%20Saint.user.js
// @updateURL https://update.greasyfork.org/scripts/454471/Script%20forum%20for%20BLUE%20%20Saint.meta.js
// ==/UserScript==
// переменная "user" отвечает за ник админа.
...
const user = "Кизару Сэинта";
const tex = "@Danil_Saparov"

const buttons = [
     {
     title: 'Обход системы', 
     content: '[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по данному пункту правил:<br>Запрещено обходить систему любыми способами || Ban 15 - 30 | PermBan [/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на сервере BLUE от Kizaru_Saint. ❤.[/I][/CENTER][/color][/FONT]' +
     ...
     {
      title: 'Передано ТЕХУ',
      content: '[FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.mention }}![/CENTER]<br>' + '[CENTER] Ваша жалоба была передана техническому специалисту. [/CENTER][/FONT]',
    },
     {
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по данному пункту правил:<br>2.32. Запрещено введение в заблуждение, обман, оскорбление, неконструктивная критика администрации на всех ресурсах проекта | Ban 7 - 15 дней [/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на сервере BLUE от Kizaru_Saint. ❤.[/I][/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][FONT=times new roman][CENTER][I]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    ...
    {
     title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴Отсутствие пункта жалоб/нарушение правил╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    },
    {
	  ...
	  content:
		...
		'[Color=DeepSkyBlue][CENTER]Приятной игры на сервере BLUE от Kizaru_Saint. ❤.[/I][/CENTER][/color][/FONT]' +
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из [URL='https://forum.blackrussia.online/index.php?threads/blue-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.1139539/']Правила написания RP биографии[/URL].[/CENTER][/FONT]",
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить неправильное заполнение заголовка темы. Ознакомьтесь с правилам подачи в ---> [URL='https://forum.blackrussia.online/index.php?threads/blue-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.1139539/']Правила написания RP биографии[/URL].[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП ситуация получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из [URL='https://forum.blackrussia.online/index.php?threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-role-play-%D1%81%D0%B8%D1%82%D1%83%D0%B0%D1%86%D0%B8%D0%B8.463789/']Правила RP ситуаций | CHILLI[/URL][/CENTER][/FONT]",
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП ситуация получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB%D0%B0-%D0%9D%D0%B5%D0%BE%D1%84%D0%B8%D1%86%D0%B8%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5-rp-%D0%BE%D1%80%D0%B3%D0%B0%D0%BD%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D0%B8.39469/']Chilli | Правила создания неофициальной RolePlay организации[/URL].[/CENTER][/FONT]",
