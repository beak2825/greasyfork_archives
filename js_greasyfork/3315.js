...
// @downloadURL https://update.greasyfork.org/scripts/3315/MouseHunt%20AutoBot.user.js
// @updateURL https://update.greasyfork.org/scripts/3315/MouseHunt%20AutoBot.meta.js
// ==/UserScript==
...
function playKingRewardSound()
{
	if (isKingWarningSound)
	{
		...
		if (browser == "chrome")
		{
			...
			if (fbPlatform)
			{
				var footElement = document.getElementById("fb-root");
				footElement.appendChild(kingSound);
				footElement = null;
			}
