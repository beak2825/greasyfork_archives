// ==UserScript==
// @name         For guidance by Kokojambo gly Seledka
...
// @downloadURL https://update.greasyfork.org/scripts/483992/For%20guidance%20by%20Kokojambo%20gly%20Seledka.user.js
// @updateURL https://update.greasyfork.org/scripts/483992/For%20guidance%20by%20Kokojambo%20gly%20Seledka.meta.js
// ==/UserScript==
...
const buttons = [
...

    {
        ...
        content:
        	...
        	"[B][CENTER][COLOR=Red][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]"+
        ...
        '[Color=Red][CENTER][B]С уважением Главный Администратор сервера KHABAROVSK .[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	...
	},
    {
	  ...
	  '[Color=Red][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
        ...
        "[COLOR=Red][CENTER][B]С уважением Главный Администратор сервера KHABAROVSK[/CENTER][/B][/COLOR]",
...
'[Color=Red][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]'+
	...
	"[CENTER][B][COLOR=Red]С уважением Главный Администратор сервера KHABAROVSK [/B][/CENTER][/COLOR]",
      prefix: PIN_PREFIX,
...
"[CENTER][/CENTER]"+
	...
	},
    {
        ...
        '[B][COLOR=Red][CENTER] С уважением Главный Администратор сервера KHABAROVSK [/B][/CENTER][/COLOR]',
        prifix: PIN_PREFIX,
        status: true,
    },
