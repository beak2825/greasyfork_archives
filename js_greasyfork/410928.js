// ==UserScript==
// @name                WME Route Speeds (MapOMatic fork) penalty hack
// @description         Shows segment speeds in a route.
// @include             /^https:\/\/(www|beta)\.waze\.com\/(?!user\/)(.{2,6}\/)?editor\/?.*$/
// @version             2020.09.06.001.tm.phack
// @grant               none
...
// @downloadURL https://update.greasyfork.org/scripts/410928/WME%20Route%20Speeds%20%28MapOMatic%20fork%29%20penalty%20hack.user.js
// @updateURL https://update.greasyfork.org/scripts/410928/WME%20Route%20Speeds%20%28MapOMatic%20fork%29%20penalty%20hack.meta.js
// ==/UserScript==
...
/* eslint-disable */
/*Version history:
 * 2020.09.06.001.tm.phack
 *  - Quick hack to display penalty amounts on segments - some stuff will break 
 * 2020.07.27.001
...
(function () {
	...
	function createRouteFeatures(id, routewsp, routeodc) {
		...
		var odctime = 0;
		if (routespeedsoption7) odctime = routeodc[odc].penalty;
			...
			success: function (json) {
				if (json.error !== undefined) {
					...
					if (json.alternatives !== undefined) {
						...
						var sortByField = (routespeedsoption13 === 2) ? "length" : routespeedsoption7 ? "penalty" : "crossTimeWithoutRealTime";
