...
// @include        https://178.248.235.15/forum*
// @include        https://209.200.152.144/forum*
// @include        https://*lordswm.com/forum*
// @downloadURL https://update.greasyfork.org/scripts/516851/hwm_forum_spam_filter.user.js
// @updateURL https://update.greasyfork.org/scripts/516851/hwm_forum_spam_filter.meta.js
// ==/UserScript==
...
if ( !GM_getValue( "nicks" ) ) GM_setValue( "nicks" , '{"349882":["ThoR"]}' );
...
if ( add_plus.parentNode.nextSibling.nextSibling.querySelector("a[href*='forum_messages.php?tid=']") ) {
	...
	add_plus_a.innerHTML = ' &radic;';
        add_plus_a.style.cursor = "pointer";
...
if ( add_sett.parentNode.nextSibling.nextSibling.querySelector("a[href*='forum_messages.php?tid=']") ) {
    ...
    add_sett_a.style.cursor = "pointer";
