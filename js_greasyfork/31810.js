...
// @downloadURL https://update.greasyfork.org/scripts/31810/Contact%20Accuracy.user.js
// @updateURL https://update.greasyfork.org/scripts/31810/Contact%20Accuracy.meta.js
// ==/UserScript==
...
if ($('li:contains("2664-68")').length) {
    ...
    question2[4] = $('div[class="item-response order-3"]').find('input').eq(4);
    question2[5] = $('div[class="item-response order-3"]').find('input').eq(5);
    ...
    number.append('<br>');
     ...
     //Answers//
    createButton('Yes', 0,0,2);
    createButton('No', 1,0,2,'Google search bar');
