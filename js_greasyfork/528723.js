// ==UserScript==
// @name   🌱【免费版】亿学宝|亿学宝云|如需自动下一集、自动换课程、自动作业等高级功能见收费版本：http://doc.zhanyc.cn/pages/yxt/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.2
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、自动作业等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.yxbyun.com/*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/528723/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E4%BA%BF%E5%AD%A6%E5%AE%9D%7C%E4%BA%BF%E5%AD%A6%E5%AE%9D%E4%BA%91%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E8%87%AA%E5%8A%A8%E4%BD%9C%E4%B8%9A%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttp%3Adoczhanyccnpagesyxt.user.js
// @updateURL https://update.greasyfork.org/scripts/528723/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E4%BA%BF%E5%AD%A6%E5%AE%9D%7C%E4%BA%BF%E5%AD%A6%E5%AE%9D%E4%BA%91%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E8%87%AA%E5%8A%A8%E4%BD%9C%E4%B8%9A%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttp%3Adoczhanyccnpagesyxt.meta.js
// ==/UserScript==
(function () {
    let $jq = $;
    unsafeWindow.$jq = $;
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、自动作业等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/yxt/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/watchCourse?")) {
                plugMain.page_video();
            } else if (url.includes("#/academicAffairsCenter")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/startHomework?")) {
                plugMain.showPaidContent(`免费版本不包含作业答题功能，如需使用请安装收费版本`);
            } else if (url.includes("/homework?")) {

                plugMain.showPaidContent(`免费版本不包含作业答题功能，如需使用请安装收费版本`);
            } else if (url.includes("#/courseCenter")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("#/courseInfo")) {
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (isFinish) {
                        ...
                        if ($(".course_list .item:last").is(".current")) {
                            zfk
                                .confirmRun("视频即将播放完毕，10秒后返回列表页面", 10 * 1000)
                                .then((a) => {
