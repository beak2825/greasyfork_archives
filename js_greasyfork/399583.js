...
// @version      1.81
// @description  Discuz自动回复按钮，可自选回复语句。修改自https://greasyfork.org/zh-CN/scripts/4635-discuz%E9%9A%90%E8%97%8F%E8%B4%B4%E8%87%AA%E5%8A%A8%E5%9B%9E%E5%A4%8D-%E5%88%B7%E6%96%B0   使用https://github.com/cnwhy/GBK.js 进行GBK转码
// @author       mumulu
// @license      GPL License
// @include      http*forum.php?*
// @include      http*thread*.html

// @downloadURL https://update.greasyfork.org/scripts/399583/Discuz%E8%87%AA%E5%8A%A8%E5%9B%9E%E5%A4%8D.user.js
// @updateURL https://update.greasyfork.org/scripts/399583/Discuz%E8%87%AA%E5%8A%A8%E5%9B%9E%E5%A4%8D.meta.js
// ==/UserScript==
  ...
  function GBKfunction() {
    ...
    var Fn_unzip = function unZip() {
      return arguments[0]
        ...
        .replace(/\x23/g, "###")
        .replace(/([\x26-\x7e]{2})\x21([\x26-\x7e\x23]+)(?:\x20|$)/g, function(
          all,
          hd,
          dt
        ) {
