...
// @name        琉神转--由帅气的CJJ开发
// @name:en     HacgGodTurn
// @name:zh-TW  琉神轉——由帅气的CJJ开发
// @name:ja     琉璃神社工具セット——イケメンのCJJの開発
// @namespace   hoothin
...
// @author      hoothin
// @iconlude    https://www.liuli.pw/favicon.ico
// @icon        https://i.loli.net/2019/02/23/5c713953c206a.jpg
...
// @downloadURL https://update.greasyfork.org/scripts/378197/%E7%90%89%E7%A5%9E%E8%BD%AC--%E7%94%B1%E5%B8%85%E6%B0%94%E7%9A%84CJJ%E5%BC%80%E5%8F%91.user.js
// @updateURL https://update.greasyfork.org/scripts/378197/%E7%90%89%E7%A5%9E%E8%BD%AC--%E7%94%B1%E5%B8%85%E6%B0%94%E7%9A%84CJJ%E5%BC%80%E5%8F%91.meta.js
// ==/UserScript==
/*
通用快捷键：
...
(function(){
    ...
    if((!curSite || !curSite.hideOd) && !frameElement){
        ...
        oD_text.placeholder="CMY，你又开始了.小心肾呀";
        ...
        oD_button.onclick=function (){
            ...
            if(oD_hash===""){
                alert("CMY，你又开始了.小心肾呀！                                                           请输入hash值、网盘或Base64密文.不要乱打~你个笨蛋呀，蠢");
                ...
                if(!regObj.btih.test(oD_hash)){
                    ...
                    oD_link.textContent="磁力链接【CMY，你的肾要小心呦！】";
    ...
    if(!hasViewed){
        var notificationDetails = {
            ...
            onclick: function() {
                //window.open("https://sleazyfork.org/scripts/23316");
            }
        };
