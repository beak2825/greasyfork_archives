...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/476646/m18.user.js
// @updateURL https://update.greasyfork.org/scripts/476646/m18.meta.js
// ==/UserScript==
...
(function() {
    ...
    function calculateMinesResult() {
        ...
        for (i = 0; i < mines; i++) {
            ...
            // Adiciona uma condição para evitar que a posição 17 tenha uma mina
            if (number !== 17) {
        ...
        // Por exemplo, você pode mostrar uma mensagem se a posição 17 não tiver uma mina
        if (deck.indexOf(17) === -1) {
            alert("Parabéns! A posição 17 não possui uma mina.");
        }
