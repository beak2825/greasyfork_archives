...
// @downloadURL https://update.greasyfork.org/scripts/493442/ttTranslator%20for%20Whatsapp.user.js
// @updateURL https://update.greasyfork.org/scripts/493442/ttTranslator%20for%20Whatsapp.meta.js
// ==/UserScript==
...
(function() {
    ...
    *************************************************************/
    ...
    +'<div style="margin-top:10px;margin-right:30px;margin-left:20px;"><input type="text" id="originalTextInput" placeholder="Type your message and press Enter to send the translated message" style="width:100%;border:0px;height:30px;border-radius:8px;padding:6px;"/></div>'
   ...
   function listenToChat() {
       ...
       var last_msg = $(".selectable-text").last().text();
       console.log("最新一条消息: \n" + last_msg);
       setInterval(function() {
           var new_msg = $(".selectable-text").last().text();
           if (new_msg !== last_msg) {
