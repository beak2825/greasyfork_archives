// ==UserScript==
// @name         ThatOneGuySS' Shell Shockers Theme
// @namespace    http://greasyfork.org/
// @version      1.9
// @description  ThatOneGuy's official theme for Shell Shockers (v45.0 and up)
// @author       ThatOneGuySS
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/462581/ThatOneGuySS%27%20Shell%20Shockers%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/462581/ThatOneGuySS%27%20Shell%20Shockers%20Theme.meta.js
// ==/UserScript==

(function () {
    const addScript = () => {
        document.title="youtube.com/thatoneguyss"
...
.weapon_img:hover, #weapon_select .weapon_selected {
    border: var(--ss-common-border-width) solid #ff0000;
...
.btn_green {
    background: radial-gradient(#ffffff, #858585, #000000);
...
#weapon_select .weapon_disabled {
    background-image: url('https://emptyImageMaker.com/');
    fill: var(--ss-blue1);
...
#inGameUI {
    ...
    border: var(--ss-common-border-width) solid #561212;
}
#inGameUI .title {
    font-size: .4em;
    color: #0000;
...
.tutorial-keyboard {
    width: 19em;
    opacity: 1;
    content: url(https://lh3.google.com/u/0/d/1KA67a5GEuSDv6S3MvPGVTjFIp3ATo_HH=w1308-h945-iv1);
}
.tutorial-mouse {
    width: 7em;
    opacity: 1;
    content: url(https://lh3.google.com/u/0/d/1zX_6BQB1To3TWT-UWsD0LI-veQtcjUH9=w1308-h945-iv1);
}
.tutorial-egg {
    width: 5em;
    opacity: 1;
    content: url(https://lh3.google.com/u/0/d/1b35cOEhD75GKit0v96HlTMhlQduAh2ma=w1308-h945-iv1);
}
...
.tutorial-list li {
    ...
    background-image: url(https://lh3.google.com/u/0/d/1LzydH9TlMFbCBH1MxA1RwsksqGPVkzbT=w1308-h945-iv1);
    font-size: 90%;
}
#best_streak_container h1 {
    ...
    padding-left: 1.25em;
    padding-top: 0em;
    background-image: url(https://lh3.google.com/u/0/d/1ZImxpOhFiciQwmfTwsqtL1TJk-S0PavS=w1308-h945-iv1);
...
#maskmiddle {
	background: url(https://lh3.google.com/u/0/d/1WpH9BfTW5X-omV3It8VKRC3Hti4IQLba=w1308-h945-iv1) center center no-repeat;
	background-size: contain;
	width: 100vh;
	height: 100vh;
}
...
#hardBoiledShieldFill {
  content: url('https://lh3.google.com/u/0/d/1jY944SWvkMe4DaZcrPDJD4cvPcd73qvt=w1308-h945-iv1');
}
.player-challenges-container {
    width: 100%;
    background: rgb(0, 192, 255);
    background: linear-gradient(225deg, rgb(0 0 0) 0%, var(--ss-blue4) 100%);
}
...
#stamp-controls .button {
    ...
    border-radius: var(--ss-space-md);
    cursor: pointer;
    box-shadow: var(--ss-box-shadow-1), var(--ss-btn-dark-bevel) #000, var(--ss-btn-light-bevel);
}
