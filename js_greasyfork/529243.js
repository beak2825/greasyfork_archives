// ==UserScript==
// @name        Smooth scroll geoguessr map
// @match       https://openguessr.com/*
// @grant       none
// @version     1.0
// @author      ItsPi3141
// @description Makes the leaflet map in openguessr scroll more smoothly
// @run-at      document-start
// @license     MIT
// @namespace https://greasyfork.org/users/1334015
// @downloadURL https://update.greasyfork.org/scripts/529243/Smooth%20scroll%20geoguessr%20map.user.js
// @updateURL https://update.greasyfork.org/scripts/529243/Smooth%20scroll%20geoguessr%20map.meta.js
// ==/UserScript==

let injected = false;
const originalFunctionCall = Function.prototype.call;
Function.prototype.call = function (...args) {
	if (!injected && args[0]?._leaflet_id) {
		inject();
		applyStyles();
		injected = true;
	}
...
const applyStyles = () => {
	...
	styles.innerHTML = `.leaflet-zoom-animated {
    transition: 0.1s transform ease-out;
  }
  .leaflet-layer :is([style*='z-index: 17']) {
    opacity: 0 !important;
  }`;
