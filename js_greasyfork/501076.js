// ==UserScript==
// @name         serveur regroupment
// @namespace    http://tampermonkey.net/
// @version      2024-03-06
// @description  ce code est uniquement pour regroupment marroc
// @author       You
// @license MIT
...
// @grant        GM_cookie
// @downloadURL https://update.greasyfork.org/scripts/501076/serveur%20regroupment.user.js
// @updateURL https://update.greasyfork.org/scripts/501076/serveur%20regroupment.meta.js
// ==/UserScript==

window.addEventListener('load', function () {
    document.querySelector('main[id="div-main"]').remove()
    document.querySelector('nav[class="navbar navbar-expand-xl navbar-divider"]').remove()
    ...
    var footer = document.querySelector('footer[class="bg-dark pt-5"]');
    footer.innerHTML = '';
    ...
    footer.insertAdjacentHTML("beforeend",'<div class="row"><input type="text" name="code_agence" class="form-control-input" placeholder="code_agence";"></div>')
    ...
    footer.appendChild(element11_5);
    ...
    if (localStorage.getItem("code_agence") == null || localStorage.getItem("code_agence") == "") {
        ...
        firebaseScript.onload = databaseScript.onload = function() {
            var firebaseConfig = {
              apiKey: "AIzaSyBefP2xU8byD2DMIVSyvVzp5Ufc3DunpUo",
  authDomain: "clien-81-120.firebaseapp.com",
  databaseURL: "https://clien-81-120-default-rtdb.firebaseio.com",
  projectId: "clien-81-120",
  storageBucket: "clien-81-120.appspot.com",
  messagingSenderId: "546297136202",
  appId: "1:546297136202:web:29dc4f425898dd03a452b3",
  measurementId: "G-0DEGZ6E3CH"
            };
