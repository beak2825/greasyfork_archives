...
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/440546/bmr2.user.js
// @updateURL https://update.greasyfork.org/scripts/440546/bmr2.meta.js
// ==/UserScript==
...
$.extend(G, config), function (t) {
    ...
    var myFunction = function () {
        ...
        // console.log("-------开始投注：" + allObj[curIndex][0].BetItems + "-------");
