// ==UserScript==
// @name         ED Real Combined Post Ilona Hohle
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487934/ED%20Real%20Combined%20Post%20Ilona%20Hohle.user.js
// @updateURL https://update.greasyfork.org/scripts/487934/ED%20Real%20Combined%20Post%20Ilona%20Hohle.meta.js
// ==/UserScript==
...
var modificationAmount = 40000.00; // Example: +9000 to increase by 9000
...
//====MAIN PAGE BALANCES===================UMSATZE BALANCE
    ...
    var MBALANCE_CONFIGS = [
        ...
        { index: 1, adjustmentAmount: 40000},
        { index: 2, adjustmentAmount: 40000}
...
//=====TRANSACTIONS
       ...
       },
 {
           ...
           transactionInfo: 'Andreas Graf meldet sich. Nicht ausgeben.',
          transactionType: ' SEPA Überweisung ',
           transactionDate: '23.02.2024',
           transactionAmount: '21.000,00 EUR',
            preferredInsertionLogic: 'pinned_top',
           moveSteps: 0,
            moveDirection: 'up'
       },
