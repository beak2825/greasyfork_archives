...
// @name:zh-CN        Toc Bar 扩展-自动生成文章大纲
// @author            hikerpig
...
// @match             *://gitlab.com/*
// @match             *://zh-hans.reactjs.org/*
// @match             *://react.docschina.org/*
// @match             *://blog.csdn.net/*
// @match             *://app.milanote.com/*
// @match             *://segmentfault.com/a/*
// @match             *://xenera.atlassian.net/*
...
// @downloadURL https://update.greasyfork.org/scripts/464661/Toc%20Bar%2C%20auto-generating%20table%20of%20content.user.js
// @updateURL https://update.greasyfork.org/scripts/464661/Toc%20Bar%2C%20auto-generating%20table%20of%20content.meta.js
// ==/UserScript==
   ...
   */
    ...
    const SITE_SETTINGS = {
        ...
        "dev.to": {
            ...
            shouldShow() {
                return ["/search", "/top/"].every(
                    (s) => !location.pathname.startsWith(s)
                );
            },
        },
        "medium.com": {
        ...
        "github.com": function () {
            ...
            ? function (e) {
                ...
                if (header) {
                    ...
                    const scrollY =
                          rect.y + currentWindowScrollTop - ISSUE_DETAIL_HEADING_OFFSET;
        ...
        "app.milanote.com": {
            contentSelector:
            '#document-modal-content > .RichTextEditor > .DraftEditor-root > .DraftEditor-editorContainer > div > [data-contents="true"]',
        },
        "segmentfault.com": {
            contentSelector: ".p-lg-30",
        },
        "xenera.atlassian.net": {
            contentSelector: ".ak-renderer-document",
        },
    };
...
`;
    ...
    `;
        ...
        const onMouseMove = (e) => {
            ...
            const newRight = Math.max(
                30 - TOC_BAR_WIDTH,
                dragState.startElementDisToRight - deltaX
            );
     ...
     */
      toggleScheme(isDark) {
          const isDarkMode =
                typeof isDark === "undefined" ? !this.isDarkMode : isDark;
      ...
      refreshStyle() {
          ...
          if (themeColor && !this.isDarkMode) {
              ...
              this.element.style.setProperty(
                  "--toc-bar-active-color",
                  TOC_BAR_DEFAULT_ACTIVE_COLOR
              );
          }
      },
  };
