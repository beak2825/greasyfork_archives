...
// @grant        none
// @license      none
// @downloadURL https://update.greasyfork.org/scripts/504384/zentao4HAT-2.user.js
// @updateURL https://update.greasyfork.org/scripts/504384/zentao4HAT-2.meta.js
// ==/UserScript==
...
async function zentaoAssociate(){
    ...
    if(window.location.href.includes('bug-view-')||window.location.href.includes('story-view-')){
        ...
        const deviceListy = ['无需','31','41','51','251','52','61','161','71','81','1001','933','119']
