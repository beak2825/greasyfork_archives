// ==UserScript==
// @name AudioBookBay hide category: LGBT
// @description Hide LGBT category
...
// @downloadURL https://update.greasyfork.org/scripts/484556/AudioBookBay%20hide%20category%3A%20LGBT.user.js
// @updateURL https://update.greasyfork.org/scripts/484556/AudioBookBay%20hide%20category%3A%20LGBT.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'LGBT'
    $(".post").has(".postInfo:contains('LGBT')").hide();
});
