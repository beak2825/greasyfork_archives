...
// @namespace    楊遠徵
// @version      3.6.5
// @description  智慧树挂机脚本。支持屏蔽弹窗题目、自动切换下一节，章测试和考试支持自动答题，视频自动倍速播放、线路选择、默认静音等。
// @author       楊遠徵
// @match        *://*.zhihuishu.com/*
// @connect      47.112.225.172
// @run-at       document-end
// @grant        unsafeWindow
// @grant        GM_xmlhttpRequest
// @grant        GM_setClipboard
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/403206/%E6%99%BA%E6%85%A7%E6%A0%91%E7%BD%91%E8%AF%BE%E7%B2%BE%E7%81%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/403206/%E6%99%BA%E6%85%A7%E6%A0%91%E7%BD%91%E8%AF%BE%E7%B2%BE%E7%81%B5.meta.js
// ==/UserScript==

// 设置修改后，需要刷新或重新打开网课页面才会生效
var setting = {
    // 8E3 == 8000，科学记数法，表示毫秒数
    time: 5E3 // 默认响应速度为5秒，不建议小于5s
...
function beforeFind() {
    setting.div = $(
        '<div style="border: 2px dashed rgb(0, 85, 68); width: 330px; position: fixed; top: 0; left: 0; z-index: 99999; background-color: #FF7F00; overflow-x: auto;">' +
            '<span style="font-size: medium;"></span>' +
            '<div style="font-size: medium;">正在搜索|答案不对加群反馈332063335</div>' +
...
function findAnswer(tip) {
    ...
    GM_xmlhttpRequest({
        method: 'POST',
        url: 'http://47.112.225.172/zhihuishu/api.php' ,
        headers: {
        ...
        onload: function(xhr) {
            if (!setting.loop) {
                ...
                if (obj.code == 1) {
                    setting.div.children('div:eq(0)').text('正在搜索|答案不对加群反馈332063335');
