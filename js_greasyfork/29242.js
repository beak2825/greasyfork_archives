// ==UserScript==
// @name         i-Comic Simplified Chinese Search Query
// @name:zh-CN   i-Comic 爱动漫 简体中文搜索支持
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Search Enhancement
// @description:zh-CN    搜索时转换简体中文至繁体
// @author       Yifan Gu
// @match        http://www.i-comic.net/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/29242/i-Comic%20Simplified%20Chinese%20Search%20Query.user.js
// @updateURL https://update.greasyfork.org/scripts/29242/i-Comic%20Simplified%20Chinese%20Search%20Query.meta.js
// ==/UserScript==
...
(function() {
    ...
    var form = q.parentElement;
    form.onsubmit = function(event){
        event.preventDefault();
        var inStr = inputBox.value;
        var outStr = '';
        for (var i = 0; i < inStr.length; i++) {
            var inChar = inStr[i];
            var inCharIndex = S.indexOf(inChar);
            if (inCharIndex >= 0) {
                var outChar = T[inCharIndex];
                outStr += outChar;
            } else {
                outStr += inChar;
            }
        ...
        window.location.href = '/search/?q=' + outStr;
    };
})();
