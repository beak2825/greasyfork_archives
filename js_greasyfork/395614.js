...
/* Changelog:
    *
    *  0.3.0.0 - updated to https://greasyfork.org/en/scripts/525577-geoportal-waze-integration
    *
    *  This code is no longer maintained, please update to the script from the URL above
    *  
