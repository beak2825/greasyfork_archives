...
// @grant			unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/432675/UDMap.user.js
// @updateURL https://update.greasyfork.org/scripts/432675/UDMap.meta.js
// ==/UserScript==
...
// Building links to wiki added by http://wiki.urbandead.com/index.php/User:Thvortex

// Last modified by Aichon on 2014-07-22

/*
 * ====================================================================================
 * THESE VALUES CAN BE EDITED BY YOU TO CUSTOMIZE THE MAP
 * 
 * INSTRUCTIONS: Each line represents a type of building. Check the end of the line to
 * see what type of building each line represents.
 * 
 * Once you find the building type you want to edit, you can change the "visible" value
 * by modifying the true/false, or you can change the "color" value by choosing any web
 * color from a site like http://www.colorpicker.com
 * 
 * The "visible" true/false value dictates whether a building type is colored in
 * (i.e. made visible, true), or is colored like it's a generic building (i.e. false).
 * 
 * The "color" value dictates what color that type of building will show up as if it's
 * set to be true for visible. For instance, hospitals are a shade of pink, necrotech
 * are purple, outdoor locations are nearly black, etc..
 * 
 * Feel free to mess around with any of the colors or visibilities to suit your needs.
 * 
 * ====================================================================================
 */
var BUILDING_TYPES = [];
BUILDING_TYPES[0]=null;		// JUST IGNORE THIS ONE...I'M TOO LAZY TO GET RID OF IT
BUILDING_TYPES[1]={visible: true, color: "#99dd88"};		// armory
BUILDING_TYPES[2]={visible: false, color: "#887766"};		// arms
BUILDING_TYPES[3]={visible: true, color: "#eeaa44"};		// autoshop
BUILDING_TYPES[4]={visible: true, color: "#334433"};		// bank
BUILDING_TYPES[5]={visible: false, color: "#AAAADD"};		// building
BUILDING_TYPES[6]={visible: true, color: "#071A07"};		// carpark
BUILDING_TYPES[7]={visible: false, color: "#FFFFFF"};		// cathedral
BUILDING_TYPES[8]={visible: true, color: "#071A07"};		// cemetary
BUILDING_TYPES[9]={visible: false, color: "#FFFFFF"};		// church
BUILDING_TYPES[10]={visible: true, color: "#334433"};		// cinema
BUILDING_TYPES[11]={visible: true, color: "#334433"};		// club
BUILDING_TYPES[12]={visible: true, color: "#aa8855"};		// factory
BUILDING_TYPES[13]={visible: false, color: "#BC1F19"};		// fire
BUILDING_TYPES[14]={visible: true, color: "#99dd88"};		// fort
BUILDING_TYPES[15]={visible: true, color: "#ee88bb"};		// hospital
BUILDING_TYPES[16]={visible: false, color: "#CC9944"};		// hotel
BUILDING_TYPES[17]={visible: false, color: "#776655"};		// junkyard
BUILDING_TYPES[18]={visible: true, color: "#aabbaa"};		// library
BUILDING_TYPES[19]={visible: true, color: "#99dd88"};		// mall
BUILDING_TYPES[20]={visible: false, color: "#EEEEE"};		// mansion
BUILDING_TYPES[21]={visible: true, color: "#071A07"};		// monument
BUILDING_TYPES[22]={visible: true, color: "#aabbaa"};		// museum
BUILDING_TYPES[23]={visible: true, color: "#8855aa"};		// necrotech
BUILDING_TYPES[24]={visible: true, color: "#071A07"};		// park
BUILDING_TYPES[25]={visible: true, color: "#4444ee"};		// police
BUILDING_TYPES[26]={visible: false, color: "#AAAAAA"};		// power
BUILDING_TYPES[27]={visible: false, color: "#888888"};		// railway
BUILDING_TYPES[28]={visible: true, color: "#aabbaa"};		// school
BUILDING_TYPES[29]={visible: false, color: "#99CC99"};		// stadium
BUILDING_TYPES[30]={visible: true, color: "#071A07"};		// street
BUILDING_TYPES[31]={visible: false, color: "#EEEEEE"};		// towers
BUILDING_TYPES[32]={visible: false, color: "#998877"};		// warehouse
BUILDING_TYPES[33]={visible: true, color: "#071A07"};		// wasteland
BUILDING_TYPES[34]={visible: true, color: "#071A07"};		// zoo
BUILDING_TYPES[35]={visible: false, color: "#AAAADD"};		// zoo_enclosure
...
var suburbNames=[];
var B = [];
var coords, i, player, suburbTable, worldTable;

function PopulateBulkData()
{
    suburbNames[0][0]="Dakerstown";
    suburbNames[0][1]="Jensentown";
    suburbNames[0][2]="Quarlesbank";
    suburbNames[0][3]="West Boundwood";
    suburbNames[0][4]="East Boundwood";
    suburbNames[0][5]="Lamport Hills";
    suburbNames[0][6]="Chancelwood";
    suburbNames[0][7]="Earletown";
    suburbNames[0][8]="Rhodenbank";
    suburbNames[0][9]="Dulston";
    suburbNames[1][0]="Roywood";
    suburbNames[1][1]="Judgewood";
    suburbNames[1][2]="Gatcombeton";
    suburbNames[1][3]="Shuttlebank";
    suburbNames[1][4]="Yagoton";
    suburbNames[1][5]="Millen Hills";
    suburbNames[1][6]="Raines Hills";
    suburbNames[1][7]="Pashenton";
    suburbNames[1][8]="Rolt Heights";
    suburbNames[1][9]="Pescodside";
    suburbNames[2][0]="Peddlesden Village";
    suburbNames[2][1]="Chudleyton";
    suburbNames[2][2]="Darvall Heights";
    suburbNames[2][3]="Eastonwood";
    suburbNames[2][4]="Brooke Hills";
    suburbNames[2][5]="Shearbank";
    suburbNames[2][6]="Huntley Heights";
    suburbNames[2][7]="Santlerville";
    suburbNames[2][8]="Gibsonton";
    suburbNames[2][9]="Dunningwood";
    suburbNames[3][0]="Dunell Hills";
    suburbNames[3][1]="West Becktown";
    suburbNames[3][2]="East Becktown";
    suburbNames[3][3]="Richmond Hills";
    suburbNames[3][4]="Ketchelbank";
    suburbNames[3][5]="Roachtown";
    suburbNames[3][6]="Randallbank";
    suburbNames[3][7]="Heytown";
    suburbNames[3][8]="Spracklingbank";
    suburbNames[3][9]="Paynterton";
    suburbNames[4][0]="Owsleybank";
    suburbNames[4][1]="Molebank";
    suburbNames[4][2]="Lukinswood";
    suburbNames[4][3]="Havercroft";
    suburbNames[4][4]="Barrville";
    suburbNames[4][5]="Ridleybank";
    suburbNames[4][6]="Pimbank";
    suburbNames[4][7]="Peppardville";
    suburbNames[4][8]="Pitneybank";
    suburbNames[4][9]="Starlingtown";
    suburbNames[5][0]="Grigg Heights";
    suburbNames[5][1]="Reganbank";
    suburbNames[5][2]="Lerwill Heights";
    suburbNames[5][3]="Shore Hills";
    suburbNames[5][4]="Galbraith Hills";
    suburbNames[5][5]="Stanbury Village";
    suburbNames[5][6]="Roftwood";
    suburbNames[5][7]="Edgecombe";
    suburbNames[5][8]="Pegton";
    suburbNames[5][9]="Dentonside";
    suburbNames[6][0]="Crooketon";
    suburbNames[6][1]="Mornington";
    suburbNames[6][2]="North Blythville";
    suburbNames[6][3]="Brooksville";
    suburbNames[6][4]="Mockridge Heights";
    suburbNames[6][5]="Shackleville";
    suburbNames[6][6]="Tollyton";
    suburbNames[6][7]="Crowbank";
    suburbNames[6][8]="Vinetown";
    suburbNames[6][9]="Houldenbank";
    suburbNames[7][0]="Nixbank";
    suburbNames[7][1]="Wykewood";
    suburbNames[7][2]="South Blythville";
    suburbNames[7][3]="Greentown";
    suburbNames[7][4]="Tapton";
    suburbNames[7][5]="Kempsterbank";
    suburbNames[7][6]="Wray Heights";
    suburbNames[7][7]="Gulsonside";
    suburbNames[7][8]="Osmondville";
    suburbNames[7][9]="Penny Heights";
    suburbNames[8][0]="Foulkes Village";
    suburbNames[8][1]="Ruddlebank";
    suburbNames[8][2]="Lockettside";
    suburbNames[8][3]="Dartside";
    suburbNames[8][4]="Kinch Heights";
    suburbNames[8][5]="West Grayside";
    suburbNames[8][6]="East Grayside";
    suburbNames[8][7]="Scarletwood";
    suburbNames[8][8]="Pennville";
    suburbNames[8][9]="Fryerbank";
    suburbNames[9][0]="New Arkham";
    suburbNames[9][1]="Old Arkham";
    suburbNames[9][2]="Spicer Hills";
    suburbNames[9][3]="Williamsville";
    suburbNames[9][4]="Buttonville";
    suburbNames[9][5]="Wyke Hills";
    suburbNames[9][6]="Hollomstown";
    suburbNames[9][7]="Danversbank";
    suburbNames[9][8]="Whittenside";
    suburbNames[9][9]="Miltown";
...
// Parses the player's coordinates in the city from the page's HTML and then returns it as a array in the format [x,y]
function ParsePlayerCoords()
{
    var coords, neighborBtns, offset;
    
    neighborBtns = document.evaluate("//td[@class='cp']/table[@class='c']/tbody/tr[count(td/input) = 1]/td/form/input[@name='v']", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
    if(neighborBtns.snapshotLength == 0) { return; }
    
    coords = neighborBtns.snapshotItem(0).value.split('-');
    offset = neighborBtns.snapshotItem(0).parentNode.parentNode.nextSibling ? 1: -1;
    
    return [parseInt(coords[0], 10) + offset, parseInt(coords[1], 10)];
}

// Updates an existing world map to have the proper suburbs highlighted, presumably in response to a new suburb being selected
function UpdateWorldMap(suburbCol, suburbRow)
{
    var i, playerCellNumber, selectedCellNumber, tdsSuburbs, worldMapTable;
    worldMapTable = document.getElementById("WorldMap");
    
    if(worldMapTable)
    {
        tdsSuburbs = worldMapTable.getElementsByTagName("td");
        
        selectedCellNumber = (suburbRow * 10) + suburbCol;
        
        playerCellNumber = Math.floor(player.row/10)*10 + Math.floor(player.col/10);
        
        for( i = 0; i < tdsSuburbs.length; i++)
        {
            tdsSuburbs.item(i).style.backgroundColor = '';
        }
        
        tdsSuburbs.item(selectedCellNumber).style.backgroundColor = 'lime';
        tdsSuburbs.item(playerCellNumber).style.backgroundColor = '#879ac7';
    }
}

// Creates the world table and returns it
function MakeWorldMap(suburbCol, suburbRow)
{
    var i, j, mapCaption, suburbName, suburbTD, suburbTR, worldMapTable;
    
    worldMapTable = document.createElement("table");
    worldMapTable.id="WorldMap";
    worldMapTable.setAttribute("style","border-collapse:collapse;");
    
    mapCaption = worldMapTable.createCaption();
    mapCaption.innerHTML = '<a style="color:#BBCCBB" target="_blank" href="http://dssrzs.org/map/">World Map</a>';
    mapCaption.setAttribute("style","text-align:left;margin-top:2px;font-size:14px;");
    
    for(i = 0; i < 10; i++)
    {
        suburbTR = worldMapTable.insertRow(i);
        
        for(j = 0; j < 10; j++)
        {
            suburbTD = suburbTR.insertCell(j);
            suburbTD.setAttribute("style","height:15px;width:11px;border:1px solid #223322;");
            
            suburbName = suburbNames[i][j].replace(/ /, '&nbsp;' );
            
            suburbTD.setAttribute("onmouseover","document.getElementById('w_map_text').innerHTML='" + suburbName + "'");
            suburbTD.setAttribute("onmouseout","document.getElementById('w_map_text').innerHTML=''");
            
            //SwitchMap function needs any coord within it
            suburbTD.setAttribute("onclick","window.SwitchMap(" + j + "," + i + ")");
            
            // If this is the suburb the player is standing in, set the color for them appropriately
            if(i == player.suburbRow && j == player.suburbCol)
            {
                suburbTD.setAttribute("style","height:15px;width:11px;border:1px solid #223322;background-color:#879AC7;");
            }
        }
    }
...
// Creates the suburb table and returns it
function MakeSuburbMap(suburbCol, suburbRow)
{
    var blockCol, blockRow, blockCoord, blockInfo, blockType, blockLink, blockName, i, j, mapCaption, suburbMapTable, suburbName, suburbTD, suburbTR;
    
    suburbMapTable = document.createElement("table");
    suburbMapTable.id="SuburbMap";
    suburbMapTable.setAttribute("style","border-collapse:collapse;");
    
    mapCaption = suburbMapTable.createCaption();
    suburbName = suburbNames[suburbRow][suburbCol].replace(/ /,'&nbsp;');
    mapCaption.innerHTML = '<a style="color:#BBCCBB" target="_blank" href="http://dssrzs.org/map/' + suburbName.replace(/&nbsp;/g, "_") + '">' + suburbName + '</a>';
    mapCaption.setAttribute("style","text-align:left;margin-top:2px;font-size:14px;");
    
    for(i = 0; i < 10; i++)
    {
        suburbTR = suburbMapTable.insertRow(i);
        ...
        for(j = 0; j < 10; j++)
        {
            ...
            blockCol = 10 * suburbCol + j;
            blockRow = 10 * suburbRow + i;
            blockInfo = B[blockRow][blockCol];
            blockType = blockInfo[0];
            blockName = blockInfo[1];
            blockLink = blockInfo[2];
            
            if(BUILDING_TYPES[blockType].visible == true)
            {
                suburbTD.style.backgroundColor = BUILDING_TYPES[blockType].color;
            }
            
            // If this is the cell the player is standing in, set the color for them appropriately
            if(blockRow == player.row && blockCol == player.col)
            {
                suburbTD.setAttribute("style","height:15px;width:11px;border:1px solid #223322;background-color:#879AC7;");
            }
            
            // To keep the map working properly in a DumbWitness screenshot, we have to use single quotes (') in the
            // Javascript code attached to events. However, since hospital names also use a single quote, it has to
            // be escaped properly here.
            blockName = blockName.replace("'", "\\'");
            
            blockCoord = "[" + blockCol + "," + blockRow + "] ";
            suburbTD.setAttribute("onclick","window.open('http://wiki.urbandead.com/index.php/" + blockLink + "');");
            suburbTD.setAttribute("onmouseover","wmt=document.getElementById('w_map_text');wmt.innerHTML='" + blockCoord + blockName + "';wmt.style.textAlign='left';");
            suburbTD.setAttribute("onmouseout","wmt=document.getElementById('w_map_text');wmt.innerHTML='';wmt.style.textAlign='right';");
        }
    }
    return(suburbMapTable);  
}

// Grabs the existing suburb table and swaps it for a new suburb
function SwitchMap(suburbCol, suburbRow)
{
    var td;
    td = document.getElementById("suburb_cell");
    
    if(td != null)
    {
        td.replaceChild(MakeSuburbMap(suburbCol, suburbRow), td.childNodes.item(0) );
    }
    
    UpdateWorldMap(suburbCol, suburbRow);
    
    return true;
}

// Takes the suburb and world tables and inserts them in the page with other necessary elements
function MakeUDMapTable(suburbtable, worldtable)
{
    var cpChildren, suburbCell, textCell, worldCell, mapTextDiv, udmapMapRow, udmapTextRow, udmapTable;
    
    /* inserts two maps in a master table */
    udmapTable = document.createElement("table");
    
    udmapTable.setAttribute("style","padding-left:4px;padding-right:4px;border:4px solid #445544;background-color:#556655;font-family:trebuchet ms, verdana;width:100%;margin-top:5px;margin-bottom:5px;");
    udmapMapRow = udmapTable.insertRow(0);
    suburbCell = udmapMapRow.insertCell(0);
    suburbCell.id = "suburb_cell";
    suburbCell.setAttribute("style","vertical-align:bottom;width:165px;");
    suburbCell.appendChild(suburbtable);
    
    worldCell = udmapMapRow.insertCell(1);
    worldCell.setAttribute("style","vertical-align:bottom;");
    worldCell.appendChild(worldtable);
    
    mapTextDiv = document.createElement("div");
    mapTextDiv.setAttribute("style","width:310px;height:15px;text-align:right;");
    mapTextDiv.id="w_map_text";
    mapTextDiv.style.fontSize='14px';
    
    /* second row only contains div which holds changing info */
    udmapTextRow=udmapTable.insertRow(1);
    textCell = udmapTextRow.insertCell(0);
    textCell.setAttribute("colspan",2);
    textCell.appendChild(mapTextDiv);
    
    cpChildren = document.evaluate('//tr/td[@class="cp"]/*', document, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
    if(cpChildren.snapshotLength > 0)
    {
        cpChildren.snapshotItem(0).parentNode.appendChild(udmapTable);
    }
}

/*
 * ======================================
 *  HERE'S THE CORE OF THE FUNCTIONALITY
 * ======================================
 */
coords = ParsePlayerCoords();

// If we're on a page from which we can parse coordinates, we'll want a map
if(coords != null)
{
    // Set up the arrays for the suburb names
    for(i = 0; i < 10; i++)
    {
        suburbNames[i] = [];
    }
    
    // Set up the arrays for the building information
    for(i = 0; i < 100; i++)
    {
        B[i] = [];
    }
    
    // Populate the data for the player's location, which will be used all over
    player = {
        row: parseInt(coords[1], 10),
        col: parseInt(coords[0], 10),
        suburbRow: Math.floor(parseInt(coords[1], 10) / 10),
        suburbCol: Math.floor(parseInt(coords[0], 10) / 10)
    };
    
    PopulateBulkData();
    
    // Set up the UI elements
    suburbTable = MakeSuburbMap(player.suburbCol, player.suburbRow);
    worldTable = MakeWorldMap(player.suburbCol, player.suburbRow);

    // Add the UI elements to the page
    MakeUDMapTable(suburbTable, worldTable);
}

// Workaround for GreaseMonkey security model. Because GreaseMonkey scripts run in a separate sandbox
// from the page scripts, the onclick method (running in the page script sandbox) cannot access the
// window.SwitchMap set here (in the GreaseMonkey sandbox). Using unsafeWindow.SwitchMap makes
// this function visible to the onclick method within the page script. Note that in GreaseKit on Safari
// using window.SwitchMap was sufficient because there is no unsafeWindow object, but will not work
// with NinjaKit, so another workaround will need to be developed.
window.SwitchMap = SwitchMap;

if(unsafeWindow !== undefined)
{
    unsafeWindow.SwitchMap = SwitchMap;
}