...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/443006/Sunflower%20Land%20Farmer.user.js
// @updateURL https://update.greasyfork.org/scripts/443006/Sunflower%20Land%20Farmer.meta.js
// ==/UserScript==
...
async function autoReload() {
  var container = document.querySelector("body > div.fade.modal.show > div > div > div > div > div > span:nth-child(1)");
  if (container != null && container.textContent == 'Something went wrong!'){
    location.reload();
  }
}
