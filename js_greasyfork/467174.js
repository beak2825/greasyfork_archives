...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/467174/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%20ULYANOVSK.user.js
// @updateURL https://update.greasyfork.org/scripts/467174/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%20ULYANOVSK.meta.js
// ==/UserScript==
...
const buttons = [
      ...
      },
     {
      ...
      content:
        ...
        `[B][COLOR=#FFFF00]${greeting}, уважаемый(ая) ${user.mention}[/COLOR]<br><br>`+
        `[COLOR=lavender]Ваша жалоба взята на рассмотрение, не создавайте дубликатов и ожидайте ответа от администрации.<br><br>`+
        `[COLOR=lavender]Приятной игры на [COLOR=#cc920c]ULYANOVSK[/COLOR].<br><br>`+
        '[url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/gcSnDLQF/download-4.gif[/img][/url][/CENTER][/B]<br>',
      prefix: PIN_PREFIX,
      status: true,
    },
     {
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
        `[B][CENTER][COLOR=#FFFF00]${greeting}, уважаемый(ая) ${user.mention} [/COLOR][/CENTER][/B]<br><br>`+
        `[B][CENTER][COLOR=lavender]Заголовок вашей жалобы составлен не по форме.<br>`+
        `[B][CENTER][COLOR=red]Отказано [COLOR=lavender],закрыто.<br>`+
         `[B][CENTER][COLOR=lavender]Приятной игры на  [COLOR=#cc920c]ULYANOVSK[/COLOR].<br><br>`+
           '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/BZM1VV8z/download-5.gif[/img][/url]<br>',
      prefix: UNACCEPT_PREFIX,
    ...
    },
{
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
    ...
    },
     {
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
        `[B][CENTER][COLOR=#FFFF00]${greeting}, уважаемый(ая) ${user.mention} [/COLOR][/CENTER][/B]<br><br>`+
        `[B][CENTER][COLOR=lavender]Ваша жалоба была передана [COLOR=RED]Главному[/COLOR] [COLOR=yellow]Куратору[/COLOR] [COLOR=#cc920c]Форума[/COLOR] @Sergey_Azarov⚡ на рассмотрение<br>`+
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
        `[B][CENTER][COLOR=#FFFF00]${greeting}, уважаемый(ая) ${user.mention} [/COLOR][/CENTER][/B]<br><br>`+
        `[B][CENTER][COLOR=lavender]Ваша жалоба была передана Техническому специалисту сервера, @Danill_Malenov, на рассмотрение<br>`+
        `[B][CENTER][COLOR=lavender]Возможно на рассмотрении жалобы потребуется больше времени. Просьба ожидать ответа и не создавать копий данной темы. <br>`+
         `[B][CENTER][COLOR=lavender]Приятной игры на  [COLOR=#cc920c]ULYANOVSK[/COLOR].<br><br>`+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
    ...
    },
{
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
        `[B][CENTER][COLOR=#FFFF00]${greeting}, уважаемый(ая) ${user.mention} [/COLOR][/CENTER][/B]<br><br>`+
        `[B][CENTER][COLOR=lavender]Ваша жалоба была передана Главному Администратору @Vladimir_Konyukhov🎖️ на рассмотрение<br>`+
        `[B][CENTER][COLOR=lavender]Возможно на рассмотрении жалобы потребуется больше времени. Просьба ожидать ответа и не создавать копий данной темы. <br>`+
     `[B][CENTER][COLOR=lavender]Приятной игры на  [COLOR=#cc920c]ULYANOVSK[/COLOR].<br><br>`+
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/dVnXV8xS/9.png[/img][/url]<br>' +
