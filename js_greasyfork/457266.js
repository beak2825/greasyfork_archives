...
(function() {
    ...
    setInterval(function() {
        if (window.location.href.includes("https://adsyou.biz/auto/currency/trx/")) {
            if ((document.querySelector(".h-captcha > iframe").getAttribute("data-hcaptcha-response").length > 0) && (timeoutEnd == false)) {
                document.getElementsByClassName("")[0].click();
                timeoutEnd = true;
            }
        } else if ((document.getElementsByClassName("")[0]) && (buttonAd == false)) {
            document.getElementsByClassName("")[0].click();
            buttonAd = true;
        } else if (end == false) {
            end = true;
            console.log("No PTC ads left for today! :)");
            window.alert("No PTC ads left for today! :)");
        }
    }, 5000);
   ...
   var websiteData = [
        ...
        {url : "https://adsyou.biz/auto/currency/trx", login: "", password: ""},
        {url : "https://bestcryptosites.org/", login: "", password: ""},
    ...
    var websiteMap = [
        ...
        {
            website: "adsyou.biz",
            timeoutbeforeMovingToNextUrl: 240000
        },

        {
            website: "bestcryptosites.org",
