...
// @downloadURL https://update.greasyfork.org/scripts/528869/tech.user.js
// @updateURL https://update.greasyfork.org/scripts/528869/tech.meta.js
// ==/UserScript==
...
},
{
	...
	content:
    "Здравствуйте, {{user.mention }}.<br><br>" +
	"Ваша тема закреплена и ожидает вердикта Куратора технических специалистов.",
	prefix: PIN_PREFIX,
	status: true,
},
{
...
},
{
	...
	content:
    "Здравствуйте, {{user.mention }}.<br><br>" +
    "Игрок будет заблокирован.<br><br>" +
	"Закрыто.",
},
{
...
},
{
    ...
    content:
    "Здравствуйте, {{ user.mention }}.<br><br>" +
    "1. Укажите ваш Telegram ID, если ваш игровой аккаунт был привязан к Telegram. Узнать его можно здесь: t.me/getmyid_bot<br><br>2. Укажите ваш оригинальный ID страницы ВКонтакте, которая привязана к аккаунту (взять его можно через данный сайт - https://regvk.com/ )<br><br>3. Укажите почту, которая привязана к аккаунту",
    prefix: TECHADM_PREFIX,
    status: true,
},
	{
...
},
{
	...
	content:
	"Здравствуйте, {{user.mention }}.<br><br>" +
	"Ваша тема передана Техническому Специалисту по Логированию для дальнейшего вердикта, ожидайте ответ в данной теме.",
	prefix: TECHADM_PREFIX,
	status: true,
},
{
...
},
{
     ...
     content:
	 "Здравствуйте, {{user.mention }}.<br><br>" +
     "Вы получили наказание, которое выдал не технический специалист. Обратитесь в раздел жалоб на администрацию Вашего сервера.<br>Форма для подачи жалобы: [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-администрацию.3429349/']нажмите[/URL]<br><br>" +
     "Закрыто.",
      prefix: CLOSE_PREFIX,
      status: false,
},
{
    ...
    content:
	"Здравствуйте, {{user.mention }}.<br><br>" +
    "Данная тема не относится к техническому разделу. Обратитесь в «Жалобы на игроков» Вашего сервера.<br>Форма подачи жалобы: [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-игроков.3429394/']нажмите[/URL]<br><br>" +
    "Закрыто.",
    prefix: CLOSE_PREFIX,
    status: false,
},
...
},
{
	...
	content:
    "Здравствуйте, {{user.mention }}.<br><br>" +
	"Ваша тема передана на тестирование.",
	prefix: WAIT_PREFIX,
	status: false,
},
{
	...
	// Добавление кнопок при загрузке страницы
        ...
        addButton('~A~', 'report_adm','border-radius: 20px; margin-right: 11px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5);');
	...
	const threadData = getThreadData();
        ...
        $('button#report_adm').click(() => moveThread(WAIT_PREFIX, 1910));
...
(function () {
    ...
    switchStyleBlock.innerHTML = `
            ...
            <span class="addingText" style="display: block; width: max-content; margin: 5px; margin-left: 43px; margin-top: 2px; color: lavender;">Blood</span>
            </span>
        `;
