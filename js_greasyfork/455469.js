// ==UserScript==
// @name                 Xbox Cloud Gaming Disable Add to Home Screen
// @name:zh-CN           Xbox Cloud Gaming 禁止添加到主屏幕
// @name:zh-TW           Xbox Cloud Gaming 禁止加入主畫面
// @namespace            http://tampermonkey.net/
// @version              0.7
// @description          Allows Xbox Cloud Gaming to be played directly in Safari, rather than needing to be added to the home screen first.
// @description:zh-CN    允许直接在 Safari 中游玩 Xbox Cloud Gaming 云游戏，而不是需要先添加到主屏幕
// @description:zh-TW    允許直接在 Safari 中游玩 Xbox Cloud Gaming 雲端游戲，而不是需要先加入主畫面
// @author               TGSAN
...
// @grant                unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/455469/Xbox%20Cloud%20Gaming%20Disable%20Add%20to%20Home%20Screen.user.js
// @updateURL https://update.greasyfork.org/scripts/455469/Xbox%20Cloud%20Gaming%20Disable%20Add%20to%20Home%20Screen.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (self.unsafeWindow) {
        console.log("[Xbox Cloud Gaming Disable Add to Home Screen] use unsafeWindow mode");
        windowCtx = self.unsafeWindow;
    } else {
        console.log("[Xbox Cloud Gaming Disable Add to Home Screen] use window mode (your userscript extensions not support unsafeWindow)");
    }
