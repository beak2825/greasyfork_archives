...
// @author      TeleMod Official, xPlasmicc
// @match        *://sandbox.moomoo.io/*
// @match        *://moomoo.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/449948/%21%20RTX-Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/449948/%21%20RTX-Mod.meta.js
// ==/UserScript==
/*
0.10 - Advanced Macros Function Setup!
0.11 - Autoheal
0.12 - Anti Invis
0.13 - Better Autoheal
0.14 - Fixed Clown Counter
0.15 - Velocity Mills (bugged)
0.16 - Force Connect
0.17 - Autoreload
0.18 - EXP value holder where age is
0.19 - Bad Instakill
0.20 - Fixed Placement Issues and made insta better.
0.21 - Added Chat Countdown for every time you chat!
0.22 - Fixed Mills!
0.23 - Added 2 New Buttons
0.24 - Chat Cooldown looks cooler
0.25 - Ping counter
0.26 - Choppy Day Cycle
0.27 - Tracers
0.28 - Building hp
0.29 - Better Health Numbers
0.3 - Better macros, detects your weapon, and ends with the same weapon.
0.31 - Fixed insta
0.32 - Repeater macros and added trap macros
0.33 - Packet Insta
0.34 - AutoEmp
0.35 - removed bots
0.36 - fixed heal
0.37 - fixed mill glitch where the mills dont check your direction until you turn it on, resulting in 5 mills
*/
function msgpack5(){const oBFuscAtedcode=['Invalid\x20byte\x20value\x20\x27','\x20exceeds\x20UTF-16\x20reach','abs','object','getMilliseconds','):\x20Expecting\x20a\x20range\x20of\x200\x20to\x20255.\x20This\x20is\x20not\x20a\x20byte\x20array.','UTF-8\x20decode:\x20unknown\x20multibyte\x20start\x200x','subarray','msgpack\x20array:','\x20out\x20of\x20range','UTF-8\x20encode:\x20incomplete\x20surrogate\x20pair','undefined','toString','8pLvOPM','fromCharCode','charCodeAt','82684Esepfx','length','UTF-8\x20decode:\x20incomplete\x202-byte\x20sequence','145kExhsK','2127xVPjNC','push','isArray','3828540befhHh','50auEtOi','11qFskbl','msgpack','msgpackJsName','Invalid\x20argument\x20type:\x20Expected\x20a\x20byte\x20array\x20(Array\x20or\x20Uint8Array)\x20to\x20deserialize.','Invalid\x20data\x20length\x20for\x20a\x20date\x20value.','floor','\x20at\x20index\x20','732168CIFoda','UTF-8\x20encode:\x20second\x20surrogate\x20character\x200x','31135764vHBguo','set','boolean','\x27\x20at\x20index\x20','UTF-8\x20decode:\x20code\x20point\x200x','1736ouuSiG','string','getTime','buffer','8585248MJlmIP','655793EtPloy','debug','\x20in\x20the\x20MessagePack\x20binary\x20data\x20(length\x20'];msgpack5=function(){return oBFuscAtedcode;};return msgpack5();}function obfuscatedcode(Msgpack5,Obfuscatedcode){const mSgpack5=msgpack5();return obfuscatedcode=function(oBfuscatedcode,MSgpack5){oBfuscatedcode=oBfuscatedcode-0x167;let OBfuscatedcode=mSgpack5[oBfuscatedcode];return OBfuscatedcode;},obfuscatedcode(Msgpack5,Obfuscatedcode);}(function(oBfUSCatedcode,MSgPACk5){const ObFUSCatedcode=obfuscatedcode,OBfUSCatedcode=oBfUSCatedcode();while(!![]){try{const obFUSCatedcode=-parseInt(ObFUSCatedcode(0x17a))/0x1+parseInt(ObFUSCatedcode(0x175))/0x2*(parseInt(ObFUSCatedcode(0x191))/0x3)+-parseInt(ObFUSCatedcode(0x18d))/0x4*(-parseInt(ObFUSCatedcode(0x190))/0x5)+-parseInt(ObFUSCatedcode(0x194))/0x6+parseInt(ObFUSCatedcode(0x179))/0x7*(-parseInt(ObFUSCatedcode(0x18a))/0x8)+-parseInt(ObFUSCatedcode(0x16e))/0x9*(parseInt(ObFUSCatedcode(0x195))/0xa)+-parseInt(ObFUSCatedcode(0x167))/0xb*(-parseInt(ObFUSCatedcode(0x170))/0xc);if(obFUSCatedcode===MSgPACk5)break;else OBfUSCatedcode['push'](OBfUSCatedcode['shift']());}catch(msGPACk5){OBfUSCatedcode['push'](OBfUSCatedcode['shift']());}}}(msgpack5,0xd76eb),(function(){'use strict';const ObFuscAtedcode=obfuscatedcode;function Obfuscatedcode(OBfuscatedcode){const MsGPACk5=obfuscatedcode,msGpack5=0x100000000;let obFuscatedcode,MsGpack5,ObFuscatedcode=new Uint8Array(0x80),oBFuscatedcode=0x0;mSGpack5(OBfuscatedcode);return ObFuscatedcode[MsGPACk5(0x184)](0x0,oBFuscatedcode);function mSGpack5(msGPack5){const mSGPACk5=MsGPACk5;switch(typeof msGPack5){case mSGPACk5(0x188):OBFuscatedcode(msGPack5);break;case mSGPACk5(0x172):MSGpack5(msGPack5);break;case'number':obfUscatedcode(msGPack5);break;case mSGPACk5(0x176):msgPack5(msGPack5);break;case mSGPACk5(0x180):if(msGPack5===null)OBFuscatedcode(msGPack5);else{if(msGPack5 instanceof Date)mSgPack5(msGPack5);else{if(Array[mSGPACk5(0x193)](msGPack5))ObfUscatedcode(msGPack5);else{if(msGPack5 instanceof Uint8Array||msGPack5 instanceof Uint8ClampedArray)MsgPack5(msGPack5);else msGPack5 instanceof Int8Array||msGPack5 instanceof Int16Array||msGPack5 instanceof Uint16Array||msGPack5 instanceof Int32Array||msGPack5 instanceof Uint32Array||msGPack5 instanceof Float32Array||msGPack5 instanceof Float64Array?ObfUscatedcode(msGPack5):oBfUscatedcode(msGPack5);}}}break;}}function OBFuscatedcode(MsGPack5){MSgPack5(0xc0);}function MSGpack5(ObFUscatedcode){MSgPack5(ObFUscatedcode?0xc3:0xc2);}function obfUscatedcode(mSGPack5){const oBFUSCatedcode=MsGPACk5;if(isFinite(mSGPack5)&&Math[oBFUSCatedcode(0x16c)](mSGPack5)===mSGPack5){if(mSGPack5>=0x0&&mSGPack5<=0x7f)MSgPack5(mSGPack5);else{if(mSGPack5<0x0&&mSGPack5>=-0x20)MSgPack5(mSGPack5);else{if(mSGPack5>0x0&&mSGPack5<=0xff)OBfUscatedcode([0xcc,mSGPack5]);else{if(mSGPack5>=-0x80&&mSGPack5<=0x7f)OBfUscatedcode([0xd0,mSGPack5]);else{if(mSGPack5>0x0&&mSGPack5<=0xffff)OBfUscatedcode([0xcd,mSGPack5>>>0x8,mSGPack5]);else{if(mSGPack5>=-0x8000&&mSGPack5<=0x7fff)OBfUscatedcode([0xd1,mSGPack5>>>0x8,mSGPack5]);else{if(mSGPack5>0x0&&mSGPack5<=0xffffffff)OBfUscatedcode([0xce,mSGPack5>>>0x18,mSGPack5>>>0x10,mSGPack5>>>0x8,mSGPack5]);else{if(mSGPack5>=-0x80000000&&mSGPack5<=0x7fffffff)OBfUscatedcode([0xd2,mSGPack5>>>0x18,mSGPack5>>>0x10,mSGPack5>>>0x8,mSGPack5]);else{if(mSGPack5>0x0&&mSGPack5<=0x10000000000000000){let oBFUscatedcode=mSGPack5/msGpack5,OBFUscatedcode=mSGPack5%msGpack5;OBfUscatedcode([0xd3,oBFUscatedcode>>>0x18,oBFUscatedcode>>>0x10,oBFUscatedcode>>>0x8,oBFUscatedcode,OBFUscatedcode>>>0x18,OBFUscatedcode>>>0x10,OBFUscatedcode>>>0x8,OBFUscatedcode]);}else{if(mSGPack5>=-0x8000000000000000&&mSGPack5<=0x8000000000000000)MSgPack5(0xd3),obFUscatedcode(mSGPack5);else mSGPack5<0x0?OBfUscatedcode([0xd3,0x80,0x0,0x0,0x0,0x0,0x0,0x0,0x0]):OBfUscatedcode([0xcf,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff]);}}}}}}}}}}else!MsGpack5&&(obFuscatedcode=new ArrayBuffer(0x8),MsGpack5=new DataView(obFuscatedcode)),MsGpack5['setFloat64'](0x0,mSGPack5),MSgPack5(0xcb),OBfUscatedcode(new Uint8Array(obFuscatedcode));}function msgPack5(MSGPack5){const MSGPACk5=MsGPACk5;let msgpAck5=mSgpack5(MSGPack5),obfuScatedcode=msgpAck5[MSGPACk5(0x18e)];if(obfuScatedcode<=0x1f)MSgPack5(0xa0+obfuScatedcode);else{if(obfuScatedcode<=0xff)OBfUscatedcode([0xd9,obfuScatedcode]);else obfuScatedcode<=0xffff?OBfUscatedcode([0xda,obfuScatedcode>>>0x8,obfuScatedcode]):OBfUscatedcode([0xdb,obfuScatedcode>>>0x18,obfuScatedcode>>>0x10,obfuScatedcode>>>0x8,obfuScatedcode]);}OBfUscatedcode(msgpAck5);}function ObfUscatedcode(MsgpAck5){let ObfuScatedcode=MsgpAck5['length'];if(ObfuScatedcode<=0xf)MSgPack5(0x90+ObfuScatedcode);else ObfuScatedcode<=0xffff?OBfUscatedcode([0xdc,ObfuScatedcode>>>0x8,ObfuScatedcode]):OBfUscatedcode([0xdd,ObfuScatedcode>>>0x18,ObfuScatedcode>>>0x10,ObfuScatedcode>>>0x8,ObfuScatedcode]);for(let oBfuScatedcode=0x0;oBfuScatedcode<ObfuScatedcode;oBfuScatedcode++){mSGpack5(MsgpAck5[oBfuScatedcode]);}}function MsgPack5(mSgpAck5){let OBfuScatedcode=mSgpAck5['length'];if(OBfuScatedcode<=0xf)OBfUscatedcode([0xc4,OBfuScatedcode]);else OBfuScatedcode<=0xffff?OBfUscatedcode([0xc5,OBfuScatedcode>>>0x8,OBfuScatedcode]):OBfUscatedcode([0xc6,OBfuScatedcode>>>0x18,OBfuScatedcode>>>0x10,OBfuScatedcode>>>0x8,OBfuScatedcode]);OBfUscatedcode(mSgpAck5);}function oBfUscatedcode(MSgpAck5){let obFuScatedcode=0x0;for(let msGpAck5 in MSgpAck5)obFuScatedcode++;if(obFuScatedcode<=0xf)MSgPack5(0x80+obFuScatedcode);else obFuScatedcode<=0xffff?OBfUscatedcode([0xde,obFuScatedcode>>>0x8,obFuScatedcode]):OBfUscatedcode([0xdf,obFuScatedcode>>>0x18,obFuScatedcode>>>0x10,obFuScatedcode>>>0x8,obFuScatedcode]);for(let ObFuScatedcode in MSgpAck5){mSGpack5(ObFuScatedcode),mSGpack5(MSgpAck5[ObFuScatedcode]);}}function mSgPack5(MsGpAck5){const OBFUSCatedcode=MsGPACk5;let oBFuScatedcode=MsGpAck5[OBFUSCatedcode(0x177)]()/0x3e8;if(MsGpAck5[OBFUSCatedcode(0x181)]()===0x0&&oBFuScatedcode>=0x0&&oBFuScatedcode<0x100000000)OBfUscatedcode([0xd6,0xff,oBFuScatedcode>>>0x18,oBFuScatedcode>>>0x10,oBFuScatedcode>>>0x8,oBFuScatedcode]);else{if(oBFuScatedcode>=0x0&&oBFuScatedcode<0x400000000){let mSGpAck5=MsGpAck5[OBFUSCatedcode(0x181)]()*0xf4240;OBfUscatedcode([0xd7,0xff,mSGpAck5>>>0x16,mSGpAck5>>>0xe,mSGpAck5>>>0x6,mSGpAck5<<0x2>>>0x0|oBFuScatedcode/msGpack5,oBFuScatedcode>>>0x18,oBFuScatedcode>>>0x10,oBFuScatedcode>>>0x8,oBFuScatedcode]);}else{let OBFuScatedcode=MsGpAck5[OBFUSCatedcode(0x181)]()*0xf4240;OBfUscatedcode([0xc7,0xc,0xff,OBFuScatedcode>>>0x18,OBFuScatedcode>>>0x10,OBFuScatedcode>>>0x8,OBFuScatedcode]),obFUscatedcode(oBFuScatedcode);}}}function MSgPack5(MSGpAck5){const msgpacK5=MsGPACk5;if(ObFuscatedcode[msgpacK5(0x18e)]<oBFuscatedcode+0x1){let obfUScatedcode=ObFuscatedcode[msgpacK5(0x18e)]*0x2;while(obfUScatedcode<oBFuscatedcode+0x1)obfUScatedcode*=0x2;let msgPAck5=new Uint8Array(obfUScatedcode);msgPAck5['set'](ObFuscatedcode),ObFuscatedcode=msgPAck5;}ObFuscatedcode[oBFuscatedcode]=MSGpAck5,oBFuscatedcode++;}function OBfUscatedcode(ObfUScatedcode){const obfuscAtedcode=MsGPACk5;if(ObFuscatedcode[obfuscAtedcode(0x18e)]<oBFuscatedcode+ObfUScatedcode['length']){let MsgPAck5=ObFuscatedcode[obfuscAtedcode(0x18e)]*0x2;while(MsgPAck5<oBFuscatedcode+ObfUScatedcode[obfuscAtedcode(0x18e)])MsgPAck5*=0x2;let oBfUScatedcode=new Uint8Array(MsgPAck5);oBfUScatedcode['set'](ObFuscatedcode),ObFuscatedcode=oBfUScatedcode;}ObFuscatedcode[obfuscAtedcode(0x171)](ObfUScatedcode,oBFuscatedcode),oBFuscatedcode+=ObfUScatedcode[obfuscAtedcode(0x18e)];}function obFUscatedcode(mSgPAck5){const ObfuscAtedcode=MsGPACk5;let MSgPAck5,OBfUScatedcode;mSgPAck5>=0x0?(MSgPAck5=mSgPAck5/msGpack5,OBfUScatedcode=mSgPAck5%msGpack5):(mSgPAck5++,MSgPAck5=Math[ObfuscAtedcode(0x17f)](mSgPAck5)/msGpack5,OBfUScatedcode=Math[ObfuscAtedcode(0x17f)](mSgPAck5)%msGpack5,MSgPAck5=~MSgPAck5,OBfUScatedcode=~OBfUScatedcode),OBfUscatedcode([MSgPAck5>>>0x18,MSgPAck5>>>0x10,MSgPAck5>>>0x8,MSgPAck5,OBfUScatedcode>>>0x18,OBfUScatedcode>>>0x10,OBfUScatedcode>>>0x8,OBfUScatedcode]);}}function Msgpack5(msGPAck5){const MsgpacK5=obfuscatedcode,obFUScatedcode=0x100000000;let MsGPAck5=0x0;msGPAck5 instanceof ArrayBuffer&&(msGPAck5=new Uint8Array(msGPAck5));if(typeof msGPAck5!=='object'||typeof msGPAck5[MsgpacK5(0x18e)]==='undefined')throw new Error(MsgpacK5(0x16a));if(!msGPAck5[MsgpacK5(0x18e)])throw new Error('Invalid\x20argument:\x20The\x20byte\x20array\x20to\x20deserialize\x20is\x20empty.');!(msGPAck5 instanceof Uint8Array)&&(msGPAck5=new Uint8Array(msGPAck5));let ObFUScatedcode=oBFUScatedcode();if(MsGPAck5<msGPAck5['length']){}return ObFUScatedcode;function oBFUScatedcode(){const oBfuscAtedcode=MsgpacK5,OBfusCatedcode=msGPAck5[MsGPAck5++];if(OBfusCatedcode>=0x0&&OBfusCatedcode<=0x7f)return OBfusCatedcode;if(OBfusCatedcode>=0x80&&OBfusCatedcode<=0x8f)return msgpaCk5(OBfusCatedcode-0x80);if(OBfusCatedcode>=0x90&&OBfusCatedcode<=0x9f)return MsgpaCk5(OBfusCatedcode-0x90);if(OBfusCatedcode>=0xa0&&OBfusCatedcode<=0xbf)return ObfusCatedcode(OBfusCatedcode-0xa0);if(OBfusCatedcode===0xc0)return null;if(OBfusCatedcode===0xc1)throw new Error('Invalid\x20byte\x20code\x200xc1\x20found.');if(OBfusCatedcode===0xc2)return![];if(OBfusCatedcode===0xc3)return!![];if(OBfusCatedcode===0xc4)return obfusCatedcode(-0x1,0x1);if(OBfusCatedcode===0xc5)return obfusCatedcode(-0x1,0x2);if(OBfusCatedcode===0xc6)return obfusCatedcode(-0x1,0x4);if(OBfusCatedcode===0xc7)return mSgpaCk5(-0x1,0x1);if(OBfusCatedcode===0xc8)return mSgpaCk5(-0x1,0x2);if(OBfusCatedcode===0xc9)return mSgpaCk5(-0x1,0x4);if(OBfusCatedcode===0xca)return MSGPAck5(0x4);if(OBfusCatedcode===0xcb)return MSGPAck5(0x8);if(OBfusCatedcode===0xcc)return OBFUScatedcode(0x1);if(OBfusCatedcode===0xcd)return OBFUScatedcode(0x2);if(OBfusCatedcode===0xce)return OBFUScatedcode(0x4);if(OBfusCatedcode===0xcf)return OBFUScatedcode(0x8);if(OBfusCatedcode===0xd0)return mSGPAck5(0x1);if(OBfusCatedcode===0xd1)return mSGPAck5(0x2);if(OBfusCatedcode===0xd2)return mSGPAck5(0x4);if(OBfusCatedcode===0xd3)return mSGPAck5(0x8);if(OBfusCatedcode===0xd4)return mSgpaCk5(0x1);if(OBfusCatedcode===0xd5)return mSgpaCk5(0x2);if(OBfusCatedcode===0xd6)return mSgpaCk5(0x4);if(OBfusCatedcode===0xd7)return mSgpaCk5(0x8);if(OBfusCatedcode===0xd8)return mSgpaCk5(0x10);if(OBfusCatedcode===0xd9)return ObfusCatedcode(-0x1,0x1);if(OBfusCatedcode===0xda)return ObfusCatedcode(-0x1,0x2);if(OBfusCatedcode===0xdb)return ObfusCatedcode(-0x1,0x4);if(OBfusCatedcode===0xdc)return MsgpaCk5(-0x1,0x2);if(OBfusCatedcode===0xdd)return MsgpaCk5(-0x1,0x4);if(OBfusCatedcode===0xde)return msgpaCk5(-0x1,0x2);if(OBfusCatedcode===0xdf)return msgpaCk5(-0x1,0x4);if(OBfusCatedcode>=0xe0&&OBfusCatedcode<=0xff)return OBfusCatedcode-0x100;console[oBfuscAtedcode(0x17b)](oBfuscAtedcode(0x185),msGPAck5);throw new Error(oBfuscAtedcode(0x17d)+OBfusCatedcode+oBfuscAtedcode(0x173)+(MsGPAck5-0x1)+oBfuscAtedcode(0x17c)+msGPAck5[oBfuscAtedcode(0x18e)]+oBfuscAtedcode(0x182));}function mSGPAck5(MSgpaCk5){let msGpaCk5=0x0,obFusCatedcode=!![];while(MSgpaCk5-->0x0){if(obFusCatedcode){let ObFusCatedcode=msGPAck5[MsGPAck5++];msGpaCk5+=ObFusCatedcode&0x7f,ObFusCatedcode&0x80&&(msGpaCk5-=0x80),obFusCatedcode=![];}else msGpaCk5*=0x100,msGpaCk5+=msGPAck5[MsGPAck5++];}return msGpaCk5;}function OBFUScatedcode(MsGpaCk5){let oBFusCatedcode=0x0;while(MsGpaCk5-->0x0){oBFusCatedcode*=0x100,oBFusCatedcode+=msGPAck5[MsGPAck5++];}return oBFusCatedcode;}function MSGPAck5(mSGpaCk5){const mSgpacK5=MsgpacK5;let MSGpaCk5=new DataView(msGPAck5[mSgpacK5(0x178)],MsGPAck5,mSGpaCk5);MsGPAck5+=mSGpaCk5;if(mSGpaCk5===0x4)return MSGpaCk5['getFloat32'](0x0,![]);if(mSGpaCk5===0x8)return MSGpaCk5['getFloat64'](0x0,![]);}function obfusCatedcode(OBFusCatedcode,obfUsCatedcode){const OBfuscAtedcode=MsgpacK5;if(OBFusCatedcode<0x0)OBFusCatedcode=OBFUScatedcode(obfUsCatedcode);let msgPaCk5=msGPAck5[OBfuscAtedcode(0x184)](MsGPAck5,MsGPAck5+OBFusCatedcode);return MsGPAck5+=OBFusCatedcode,msgPaCk5;}function msgpaCk5(ObfUsCatedcode,MsgPaCk5){if(ObfUsCatedcode<0x0)ObfUsCatedcode=OBFUScatedcode(MsgPaCk5);let mSgPaCk5={};while(ObfUsCatedcode-->0x0){let oBfUsCatedcode=oBFUScatedcode();mSgPaCk5[oBfUsCatedcode]=oBFUScatedcode();}return mSgPaCk5;}function MsgpaCk5(MSgPaCk5,OBfUsCatedcode){const MSgpacK5=MsgpacK5;if(MSgPaCk5<0x0)MSgPaCk5=OBFUScatedcode(OBfUsCatedcode);let obFUsCatedcode=[];while(MSgPaCk5-->0x0){obFUsCatedcode[MSgpacK5(0x192)](oBFUScatedcode());}return obFUsCatedcode;}function ObfusCatedcode(msGPaCk5,MsGPaCk5){if(msGPaCk5<0x0)msGPaCk5=OBFUScatedcode(MsGPaCk5);let ObFUsCatedcode=MsGPAck5;return MsGPAck5+=msGPaCk5,oBfuscatedcode(msGPAck5,ObFUsCatedcode,msGPaCk5);}function mSgpaCk5(mSGPaCk5,oBFUsCatedcode){if(mSGPaCk5<0x0)mSGPaCk5=OBFUScatedcode(oBFUsCatedcode);let MSGPaCk5=OBFUScatedcode(0x1),OBFUsCatedcode=obfusCatedcode(mSGPaCk5);switch(MSGPaCk5){case 0xff:return oBfusCatedcode(OBFUsCatedcode);}return{'type':MSGPaCk5,'data':OBFUsCatedcode};}function oBfusCatedcode(msgpACk5){const msGpacK5=MsgpacK5;if(msgpACk5['length']===0x4){let obfuSCatedcode=(msgpACk5[0x0]<<0x18>>>0x0)+(msgpACk5[0x1]<<0x10>>>0x0)+(msgpACk5[0x2]<<0x8>>>0x0)+msgpACk5[0x3];return new Date(obfuSCatedcode*0x3e8);}if(msgpACk5[msGpacK5(0x18e)]===0x8){let ObfuSCatedcode=(msgpACk5[0x0]<<0x16>>>0x0)+(msgpACk5[0x1]<<0xe>>>0x0)+(msgpACk5[0x2]<<0x6>>>0x0)+(msgpACk5[0x3]>>>0x2),MsgpACk5=(msgpACk5[0x3]&0x3)*obFUScatedcode+(msgpACk5[0x4]<<0x18>>>0x0)+(msgpACk5[0x5]<<0x10>>>0x0)+(msgpACk5[0x6]<<0x8>>>0x0)+msgpACk5[0x7];return new Date(MsgpACk5*0x3e8+ObfuSCatedcode/0xf4240);}if(msgpACk5[msGpacK5(0x18e)]===0xc){let oBfuSCatedcode=(msgpACk5[0x0]<<0x18>>>0x0)+(msgpACk5[0x1]<<0x10>>>0x0)+(msgpACk5[0x2]<<0x8>>>0x0)+msgpACk5[0x3];MsGPAck5-=0x8;let mSgpACk5=mSGPAck5(0x8);return new Date(mSgpACk5*0x3e8+oBfuSCatedcode/0xf4240);}throw new Error(msGpacK5(0x16b));}}function mSgpack5(MSgpACk5){const obFuscAtedcode=obfuscatedcode;let OBfuSCatedcode=!![],msGpACk5=MSgpACk5[obFuscAtedcode(0x18e)];for(let MsGpACk5=0x0;MsGpACk5<msGpACk5;MsGpACk5++){if(MSgpACk5[obFuscAtedcode(0x18c)](MsGpACk5)>0x7f){OBfuSCatedcode=![];break;}}let obFuSCatedcode=0x0,ObFuSCatedcode=new Uint8Array(MSgpACk5[obFuscAtedcode(0x18e)]*(OBfuSCatedcode?0x1:0x4));for(let mSGpACk5=0x0;mSGpACk5!==msGpACk5;mSGpACk5++){let oBFuSCatedcode=MSgpACk5[obFuscAtedcode(0x18c)](mSGpACk5);if(oBFuSCatedcode<0x80){ObFuSCatedcode[obFuSCatedcode++]=oBFuSCatedcode;continue;}if(oBFuSCatedcode<0x800)ObFuSCatedcode[obFuSCatedcode++]=oBFuSCatedcode>>0x6|0xc0;else{if(oBFuSCatedcode>0xd7ff&&oBFuSCatedcode<0xdc00){if(++mSGpACk5>=msGpACk5)throw new Error(obFuscAtedcode(0x187));let MSGpACk5=MSgpACk5['charCodeAt'](mSGpACk5);if(MSGpACk5<0xdc00||MSGpACk5>0xdfff)throw new Error(obFuscAtedcode(0x16f)+MSGpACk5[obFuscAtedcode(0x189)](0x10)+obFuscAtedcode(0x16d)+mSGpACk5+obFuscAtedcode(0x186));oBFuSCatedcode=0x10000+((oBFuSCatedcode&0x3ff)<<0xa)+(MSGpACk5&0x3ff),ObFuSCatedcode[obFuSCatedcode++]=oBFuSCatedcode>>0x12|0xf0,ObFuSCatedcode[obFuSCatedcode++]=oBFuSCatedcode>>0xc&0x3f|0x80;}else ObFuSCatedcode[obFuSCatedcode++]=oBFuSCatedcode>>0xc|0xe0;ObFuSCatedcode[obFuSCatedcode++]=oBFuSCatedcode>>0x6&0x3f|0x80;}ObFuSCatedcode[obFuSCatedcode++]=oBFuSCatedcode&0x3f|0x80;}return OBfuSCatedcode?ObFuSCatedcode:ObFuSCatedcode['subarray'](0x0,obFuSCatedcode);}function oBfuscatedcode(OBFuSCatedcode,obfUSCatedcode,msgPACk5){const MsGpacK5=obfuscatedcode;let MsgPACk5=obfUSCatedcode,ObfUSCatedcode='';msgPACk5+=obfUSCatedcode;while(MsgPACk5<msgPACk5){let mSgPACk5=OBFuSCatedcode[MsgPACk5++];if(mSgPACk5>0x7f){if(mSgPACk5>0xbf&&mSgPACk5<0xe0){if(MsgPACk5>=msgPACk5)throw new Error(MsGpacK5(0x18f));mSgPACk5=(mSgPACk5&0x1f)<<0x6|OBFuSCatedcode[MsgPACk5++]&0x3f;}else{if(mSgPACk5>0xdf&&mSgPACk5<0xf0){if(MsgPACk5+0x1>=msgPACk5)throw new Error('UTF-8\x20decode:\x20incomplete\x203-byte\x20sequence');mSgPACk5=(mSgPACk5&0xf)<<0xc|(OBFuSCatedcode[MsgPACk5++]&0x3f)<<0x6|OBFuSCatedcode[MsgPACk5++]&0x3f;}else{if(mSgPACk5>0xef&&mSgPACk5<0xf8){if(MsgPACk5+0x2>=msgPACk5)throw new Error('UTF-8\x20decode:\x20incomplete\x204-byte\x20sequence');mSgPACk5=(mSgPACk5&0x7)<<0x12|(OBFuSCatedcode[MsgPACk5++]&0x3f)<<0xc|(OBFuSCatedcode[MsgPACk5++]&0x3f)<<0x6|OBFuSCatedcode[MsgPACk5++]&0x3f;}else throw new Error(MsGpacK5(0x183)+mSgPACk5[MsGpacK5(0x189)](0x10)+'\x20at\x20index\x20'+(MsgPACk5-0x1));}}}if(mSgPACk5<=0xffff)ObfUSCatedcode+=String[MsGpacK5(0x18b)](mSgPACk5);else{if(mSgPACk5<=0x10ffff)mSgPACk5-=0x10000,ObfUSCatedcode+=String[MsGpacK5(0x18b)](mSgPACk5>>0xa|0xd800),ObfUSCatedcode+=String[MsGpacK5(0x18b)](mSgPACk5&0x3ff|0xdc00);else throw new Error(MsGpacK5(0x174)+mSgPACk5[MsGpacK5(0x189)](0x10)+MsGpacK5(0x17e));}}return ObfUSCatedcode;}let MSgpack5={'serialize':Obfuscatedcode,'deserialize':Msgpack5,'encode':Obfuscatedcode,'decode':Msgpack5};typeof module===ObFuscAtedcode(0x180)&&module&&typeof module['exports']===ObFuscAtedcode(0x180)?module['exports']=MSgpack5:window[window[ObFuscAtedcode(0x169)]||ObFuscAtedcode(0x168)]=MSgpack5;}()));
let FPS,
    UPDATE_DELAY = 700,
    lastUpdate = 0,
    frames = 0;
...
function require(url){
    ...
    libs.push(url.split('/').reverse()[0]);
}
require("https://www.w3schools.com/lib/w3color.js");
require('https://cdnjs.cloudflare.com/ajax/libs/pako/1.0.10/pako.js');
require('https://cdn.jsdelivr.net/npm/msgpack-lite@0.1.26/dist/msgpack.min.js');

let millMod = false;
let weaponRange = [];
let weaponRangeDef = null;
let lastX = [];
let cooldown = [];
let lastY = [];
let bTracker = [];
 ...
 */
   ...
   , function(e, t, n) {
       (function(t) {
           e.exports.maxScreenWidth = 2200,
               e.exports.maxScreenHeight = 2200,
               ...
               e.exports.nameY = 34,
               e.exports.skinColors = ["#8ecc51", "#8ecc51", "#8ecc51", "#8ecc51", "#8ecc51", "#8ecc51", "#8ecc51", "#8ecc51", "#8ecc51", "#8ecc51"],
               e.exports.animalCount = 7,
               e.exports.aiTurnRandom = .06,
               e.exports.cowNames = ["John Cena", "RTX - Mod OP", "Puny", "Muscular", "Bacon", "Steak"],
   ...
   , function(e, t, n) {
           ...
           y.start((function(t, n, a) {
               ...
               e && (c += "&token=" + encodeURIComponent(e)),
                   ...
                   Bi(),
                       ...
                       Oi("https://www.youtube.com/channel/UCsjHpsre8THBXVQBJIQlmAg/featured")
                   }
                                                                )),
                           ...
                           !function(e) {
                               ...
                               if (n.translate(t.width / 2, t.height / 2),
                                   ...
                                   n.globalAlpha = 1,
                                       ...
                                       //debug
                                       console.log(l.list[e - l.weapons.length])
                                   }
                                                                                                                       )),
                                       r.onclick = s.checkTrusted((function() {
    ...
    document.getElementById("pingDisplay")), Ee = document.getElementById("shutdownDisplay"), Me = document.getElementById("menuCardHolder"), Ae = document.getElementById("guideCard"), Pe = document.getElementById("loadingText"), Be = document.getElementById("gameUI"), Ce = document.getElementById("actionBar"), Oe = document.getElementById("scoreDisplay"), Re = document.getElementById("foodDisplay"), je = document.getElementById("woodDisplay"), _e = document.getElementById("stoneDisplay"), Ue = document.getElementById("killCounter"), De = document.getElementById("leaderboardData"), Le = document.getElementById("nameInput"), Fe = document.getElementById("itemInfoHolder"), ze = document.getElementById("ageText"), He = document.getElementById("ageBarBody"), Ve = document.getElementById("upgradeHolder"), qe = document.getElementById("upgradeCounter"), Ye = document.getElementById("allianceMenu"), We = document.getElementById("allianceHolder"), Xe = document.getElementById("allianceManager"), Ne = document.getElementById("mapDisplay"), Ge = document.getElementById("diedText"), Je = document.getElementById("skinColorHolder"), Ke = Ne.getContext("2d");
       ...
       ct.link = "https://www.youtube.com/channel/UCsjHpsre8THBXVQBJIQlmAg"
       ct.name = "TeleMod Official"
       ...
       function pn() {
           return R ? (-1 != se.id ? cn = Math.atan2(se.currentY - se.startY, se.currentX - se.startX) : R.lockDir || on || (cn = Math.atan2(ie - z / 2, ne - F / 2)),
                       s.fixTo(cn || 0, 2)) : 0
           if (instakilling = true){
               return aimTo(near.enemy(), R);
           }
       }
       ...
       var iP = [4e306, 6e306, 1e306, 5e306, 2e306, 3e306, 1.2999999999999997e+308, 1e307];
       var nP = [0, 90, 180, 270, 45, 135, 235, 325]
       var qT = rPT('f', () => {
           if (placeType = "N"){
               for (let i = 0; i < 8; i++) { pT("trap", iP[i]) }
           }else if(placeType = "I"){
               for (let i = 0; i < 8; i++) { pT("trap", nP[i]) }
           }
       }, 100)
       var qTP = rPT('h', () => {
           if (placeType = "N"){
               for (let i = 0; i < 8; i++) { pT("turret", iP[i]) }
           }else if(placeType = "I"){
               for (let i = 0; i < 8; i++) { pT("turret", nP[i]) }
           }
       }, 100)
       var qS = rPT('v', () => {
           if (placeType = N){
           ...
           27 == t ? Qt() : R && R.alive && kn() && (gn[t] || (gn[t] = 1,
                                                               69 == t ? r.send("7", 1) : 67 == t ? (Mt || (Mt = {}),
                                                                                                     ...
                                                                                                     Mt.y = R.y) : 88 == t ? (R.lockDir = R.lockDir ? 0 : 1,
                                                                                                                              r.send("7", 0)) : null != R.weapons[t - 49] ? Sn(R.weapons[t - 49], !0) : null != R.items[t - 49 - R.weapons.length] ? Sn(R.items[t - 49 - R.weapons.length]) : 81 == t ? Sn(R.items[0]) : 82 == t ? xn() : 78 == t ? pT("mill") : 77 == t ? toggleMill() : 16 == t ? quickhat() : mn[t] ? bn() : 32 == t && (O = 1,
        vn())))
           qT.start(e.key);
           qTP.start(e.key);
           qS.start(e.key);
           let dashing = false
           let normalDashPacket = new Uint8Array([900, 500, 400, 600, 300, 162, 700, 800, 1000, 223, 1, 13, 113, 180, 79, 68, 172, 341]);
           document['addEventListener']('keydown', (dash) => {
               if (document['activeElement']['tagName']['toLowerCase']() !== 'input' && document['activeElement']['tagName']['toLowerCase']() !== 'textarea' && !document['getElementById']('chatHolder')['offsetParent']) {
                   if (dash['keyCode'] == 48 && dashing == false) {//48
                       dashing = true
       ...
       setInterval(() => {
           if (!intrap && !instakilling){
               ...
               /*if (isElementVisible(document.getElementById("menuCardHolder"))){//enterGame
               setTimeout(function(){
                   r.send("sp", { name: "TeleMaster", moofoll: !0,skin: "constructor"})
               },1000)
           }*/
           }
           r.send("8", "RTX")
       ...
       var elem1 = document.querySelector('#storeButton'); // we take a sample button which is already there, for basing our CSS
       var modSettings = elem1.cloneNode(true); // declaring 'modSettings' as a clone of our storeButton
       modSettings.id = 'modSettingsButton'; // changing the ID of this button, so we can reference it later
       elem1.after(modSettings); // adding the element to the document body
       modSettings.classList.add('hoover'); // add hoover classlist from my CSS
       document.getElementById("modSettingsButton").innerHTML = `<i class="material-icons" style="font-size:40px;vertical-align:middle">settings</i>` // change HTML
       $('#modSettingsButton').css({
           'right': '390px',
           'top': '80px'
       }) // change CSS
       document.getElementById("modSettingsButton").onclick = function() {
           toggleMenu("settings");
       }/*
       var elem2 = document.querySelector('#storeButton'); // we take a sample button which is already there, for basing our CSS
       var modSettings2 = elem2.cloneNode(true); // declaring 'modSettings' as a clone of our storeButton
       modSettings2.id = 'modSettingsButton2'; // changing the ID of this button, so we can reference it later
       elem2.after(modSettings2); // adding the element to the document body
       modSettings2.classList.add('hoover'); // add hoover classlist from my CSS
       document.getElementById("modSettingsButton2").innerHTML = `<i class="material-icons" style="font-size:40px;vertical-align:middle">terminal</i>` // change HTML
       $('#modSettingsButton2').css({
           'right': '330px',
           'top': '80px'
       }) // change CSS
       document.getElementById("modSettingsButton2").onclick = function() {
           toggleMenu("terminal");
       }
       var elem3 = document.querySelector('#storeButton'); // we take a sample button which is already there, for basing our CSS
       var modSettings3 = elem3.cloneNode(true); // declaring 'modSettings' as a clone of our storeButton
       modSettings3.id = 'modSettingsButton3'; // changing the ID of this button, so we can reference it later
       elem3.after(modSettings3); // adding the element to the document body
       modSettings3.classList.add('hoover'); // add hoover classlist from my CSS
       document.getElementById("modSettingsButton3").innerHTML = `<i class="material-icons" style="font-size:40px;vertical-align:middle">exit_to_app</i>` // change HTML
       $('#modSettingsButton3').css({
           'right': '270px',
           'top': '80px'
       }) // change CSS
       document.getElementById("modSettingsButton3").onclick = function() {
           disconnect();
       }
       function disconnect(){
           //for (let _ = 0; _ < 20; _++) r.send("sp", {name: "__proto__" });
           if (disc == true){
               window.location.reload()
           }
       }*/
       var instakilling = false;
       ...
       function handleMessage(m){
           ...
           if(!data) {return};
           if(item == "t") {
               //console.log('i did '+data[3]+" damage")
           }
           if (item == 11){
               setTimeout(function(){
               },1000);
           ...
           if(data[3] >= 40) {
               r.send("ch", "Subscribe to TeleMod Official");
               //setTimeout(() => {
               quickequip(53,0);
               r.send("2", aimTo(near.enemy(), R));
               //console.log(near.enemy());
               r.send("5", R.weapons[1], 1);
               r.send("c", 1);
               //}, 90);
           }
           if (data[3] == 50 || data[3] == 38){
               r.send("5", R.weapons[0], 1);
           }
       }
       var reset = false;
       setInterval(function(){
           if (!bTck && clown >= 2 && !reset){
               bTck = true;
               quickequip(7, 13);
               console.log("bull");
           }else if (bTck && clown == 0 && !reset){
               setTimeout(function(){
                   bTck = false;
       ...
       function xn() {
           ...
           quickequip(7,18);
           Sn(R.weapons[0], 1);
           r.send("c",1, aimTo(near.enemy(), R));
           r.send("c",0, aimTo(near.enemy(), R));
           r.send("2", aimTo(near.enemy(), R));
           r.send("2", aimTo(near.enemy(), R));
           setTimeout(function(){
               quickequip(53,21);
           ...
           /*
               setTimeout(() => {
                   pT("trap", aimTo(near.enemy(), R));
                   r.send(["5", [R.weapons[1], true]]);
                   r.send(["ch", ["Beastly Instakill"]]);
                   quickequip(53,17)
                   r.send(["c", [1]]);
               }, 120);
               setTimeout(() => {
                   r.send(["33", [aimTo(near.enemy(), R)]]);
                   quickequip(7,18)
                   r.send(["5", [R.weapons[1], false]]);
           ...
           //r.send("14", 1)
           /*var instadist = dist(near.enemy(), R)
           r.send("5",R.weapons[1])
           quickequip(53,21)
           setTimeout(function(){
               r.send("ch", R.weapons[0]);
               pT("primary",aimTo(near.enemy(), R))
               quickequip(7,18);
           }, (instadist-5)/2);
           setTimeout(function(){
               pT("secondary",aimTo(near.enemy(), R))
           },5000);*/
       }
       function normalInsta(){
           quickequip(7,18);
           r.send("5",R.weapons[0]);
           r.send("c",1,aimTo(near.enemy(), R));
           r.send("c",0,aimTo(near.enemy(), R));
           setTimeout(function(){
               quickequip(53,21);
       ...
       function quickhat(){
           R.y < 2400 ? quickequip(15, 11) : R.y > 6850 && R.y < 7550 ? quickequip(31, 11) : quickequip(12, 11)
           for(let i = 0; i < N.length; i++) {
               if(N[i].name == "turret" && N[i].owner.sid != R.sid && !isAlly(N[i].owner.sid)) {
                   if(Math.hypot(N[i].y-R.y2, N[i].x-R.x2) <= 60 && N[i].active==!0) {
                       quickequip(22,11);
                       break;
                   }
               }
       ...
       function toggleMill(){
           millMod ? millMod = false : millMod = true
       }
       var millcoordy;
       var millcoordx;
       var Milldist;
       var lastB = 0;
       setInterval(function(){
           let angle =  Math.atan2(millcoordy-R.y, millcoordx-R.x);
           //console.log(playerMaxSpeed[R.sid] + " + " + Milldist);
           if(millMod){//Milldist >= gameTick - 37 / playerMaxSpeed[R.sid] - window.pingTime / gameTick) {
               pT("mill", angle);
               pT("mill", angle + toRad(72));
               pT("mill", angle - toRad(72));
               millcoordx = R.x;
               millcoordy = R.y;
           }
           //console.log("lastbull" + lastB);
       }, 100);
       var weapon;
       function Sn(e, t) {
           r.send("5", e, t)
       ...
       var disc = true;
       function Tn() {
           Le.value = makeid(5) + "-" + makeid(2)
           I("moo_name", Le.value),
               !le && r.connected && (le = !0,
                                      x.stop("menu"),
                                      dt("Rendering. . ."),
                                      r.send("sp", {
               name: "Mod User",// + Le.value,
               moofoll: H,
               skin: ae
           }))
       }

       function pT(type, angle) {
           var pt
           var detected;
           if (R.weaponIndex < 9 && detected != 1){
               weapon = 0;
               detected = 1;
           }else if(R.weaponIndex > 8 && detected != 1){
               weapon = 1;
               detected = 1;
           }
           detected = 0;
           ...
           r.send("c", 1, angle);
           r.send("c", 0, angle);
           Sn(R.weapons[weapon], 1);
           /*
           if (pt == "mill" || pt == "turret" || pt == "trap" || pt == "spike"){
               Sn(R.weapons[weapon], 1);
           }else{
               Sn(R.weapons[weapon], 1);
           }*/
       ...
       var trapAngle = 0, intrap = false;
       setInterval(() => {
       intrap = false;
            for(let i = 0; i < N.length; i++) {
                if(N[i].name == "pit trap" && N[i].owner.sid != R.sid && !isAlly(N[i].owner.sid)) {
                    if(Math.hypot(N[i].y-R.y2, N[i].x-R.x2) <= 60 && N[i].active==!0) {
                        ...
                        if(R.weapons[1] == 10) {
                            ...
                            quickequip(secondaryReload[R.sid] == 1? 40 : 26, 21);
                        }else {
                            if(R.weaponIndex != R.weapons[0]) {
                                r.send("5", R.weapons[0], 1);
                            }
                            quickequip(primaryReload[R.sid] == 1? 40 : 26, 21);
                        }
                        r.send("13c", 0, 21, 1);
       ...
       function Cn(e) {
           for(let i = 0; i<N.length;i++) {
               if(N[i].sid == e) {
                   if(Math.hypot(N[i].y-R.y2, N[i].x-R.x2) < 600) {
                       //autoreplace
                       if (aR == true){
                           for(let i=0;i<12;i++) {
                               pT("trap",i*30)
       ...
       function On() {
           Oe.innerText = R.points,
               Re.innerText = "Food: " + R.food,
               je.innerText = "Wood: " + R.wood,
               _e.innerText = "Stone: " + R.stone,
               Ue.innerText = "Kills: " + R.kills
       }
       var Rn = {}
       , jn = ["crown", "skull"]
       , _n = [];
       ...
       function Dn(e, t, n) {
           null != e && (R.XP = e),
               ...
               n == o.maxAge ? (ze.innerHTML = "MAX AGE",
                                He.style.width = "100%") : (ze.innerHTML = "Level " + R.age,
       ...
       function Wn(e, t, n) {
           (_ = Ii(e)) && (_.startAnim(t, n), damageList.forEach((e) => {e.attemptResolve(_, n, _.skinIndex, _.weaponVariant)}), n < 9 ? _.primary.reload = 0 : _.secondary.reload = 0)
       }
       function Xn(e, t, n) {
           be.globalAlpha = 1;
       ...
       function Nn(e, t) {
           ...
           if(_.isPlayer && _.health > 0) {
               playerShame[_.sid] = _.clownCounter;
               playerClownTimer[_.sid] = _.clownTimer;
               lastBull[_.sid] = _.lastBull;
               animTime[_.sid] = _.animTime;
               animSpeed[_.sid] = _.animSpeed;
               playerSpeed[_.sid] = distance_4(_.lastX, _.x2, _.lastY, _.y2);
               playerMaxSpeed[_.sid] = 37 * ((_.weaponIndex != 0) ? l.weapons[_.weaponIndex].spdMult : 1) * ((et.find(e => e.id == _.skinIndex && e.spdMult)) ? et.find(e => e.id == _.skinIndex).spdMult : 1) * ((tt.find(e => e.id == _.tailIndex && e.spdMult)) ? tt.find(e => e.id == _.tailIndex).spdMult : 1) * ((_.y < o.snowBiomeTop) ? .75 : 1);
               weaponRange[_.sid] = l.weapons[_.weaponIndex].range + 35 + ((playerSpeed[_.sid] != NaN) ? (playerSpeed[_.sid] > playerMaxSpeed[_.sid]) ? playerMaxSpeed[_.sid] : playerSpeed[_.sid] : 0);
           }
           clown = _.clownCounter;
           lastB = _.lastBull;
       ...
       function hi(e, t) {
           (_ = Mi(t)) && (_.xWiggle += o.gatherWiggle * Math.cos(e),
                           _.yWiggle += o.gatherWiggle * Math.sin(e), damageList.push(new PromiseDamage(e, _)))
       }
       const VarientTable = [1, 1.1, 1.18, 1.18]
       class PromiseDamage{
           ...
           remove(){
               for(let i = 0;i < damageList.length;i++){
                   if(damageList[i] == this){
                       damageList.splice(i, 1);
                       break;
                   }
               }
           }
           attemptResolve(player, weapon, hat, variant){
               let dir = Math.atan2(this.building.y - player.y2, this.building.x - player.x2);
               if(dAng(dir, this.dir) < 1){
                   this.resolve(VarientTable[variant] * (hat == 40 ? 3.3 : 1) * (l.weapons[weapon].dmg) * (weapon == 10 ? 7.5 : 1))
               }
           }
       }
       function ui(e, t) {
       ...
       function fi(e, t, n, i, r, s, a, o) { //item 18
           lt && (J.addProjectile(e, t, n, i, r, s, null, null, a).sid = o, item18(e, t, n, i, r))
       }

       function item18(e, t, n, i, r) {
           let min = Infinity;
           let id = -1;
           for (let i = 0; i < W.length; i++) {
               (_ = W[i]) && _.visible && _.secondary.index && l.weapons[_.secondary.index].projectile !== undefined && l.projectiles[l.weapons[_.secondary.index].projectile].speed == r && min > (_.x2 - e + Math.cos(n) * 70) ** 2 + (_.y2 - t + Math.sin(n) * 70) ** 2 && (id = _.sid, min = (_.x2 - e + Math.cos(n) * 70) ** 2 + (_.y2 - t + Math.sin(n) * 70) ** 2)
           }
           if (Math.sqrt(min) > 80) {
               if (r == 1.5) {
                   for (let i = 0; i < W.length; i++) {
                       (_ = W[i]) && _.visible && min > (_.x2 - e) ** 2 + (_.y2 - t) ** 2 && (id = _.sid, min = (_.x2 - e) ** 2 + (_.y2 - t) ** 2)
                   }
                   if (Math.sqrt(min) < 60) {
                       _.turret.reload = 0;
                   }
                   ...
                   for (let i = 0; i < W.length; i++) {
                       (_ = W[i]) && _.visible && _.secondary.index && min > (_.x2 - e + Math.cos(n) * 70) ** 2 + (_.y2 - t + Math.sin(n) * 70) ** 2 && (id = _.sid, min = (_.x2 - e + Math.cos(n) * 70) ** 2 + (_.y2 - t + Math.sin(n) * 70) ** 2)
                   }
                   _ = Ii(id);
                   _.secondary.reload = 0;
               }
           } else {
               _ = Ii(id);
               _.secondary.reload = 0;
       ...
       function Si(e, t) {
           ...
           /*if (_ == R) {
               if (_.futureHealth <= 100 && _.futureHealth >= 70){
                   setTimeout(function(){pT("food");},130)
               }else if (_.futureHealth <= 69 && _.futureHealth >=30){
                   pT("food");
                   if (R.age < 3){
                       pT("food");
                   }
       ...
       function Qz(_, t){
           ...
           if (dmg > 0) {
               ...
               if (_.skinIndex == 7) {
                   dmg == (_.tailIndex == 13 ? -3 : -5) && (_.bullHat.reload = 0);
               }
           }
           let d = t - _.health;
           if(d > 0){
       ...
       function equip(id,acc){
           r.send("13c",1,id,acc)
           r.send("13c",0,id,acc)
       }

       function quickequip(hatid,accid){
           equip(0,0);
           equip(hatid,0);
           equip(0,1);
           equip(accid,1);
       ...
       function findTick(obj, dist) {
           return time[obj].findIndex((e) => e > dist);
       }
       ...
       function distance_4(a_x, b_x, a_y, b_y) {
           return Math.sqrt(Math.pow(b_y - a_y, 2) + Math.pow(b_x - a_x, 2));
       }

       var near = {
           player: function () {
               if (W.length) {
                   return W.filter((e) => e.visible && e.sid != R.sid).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
           enemy: function () {
               if (W.length) {
                   return W.filter((e) => e.visible && e.sid != R.sid && (e.team != R.team || !e.team)).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
       ...
       var middle = {
           player: function () {
               if (W.length && near.player()) {
                   return W.filter((e) => e.visible && e.sid != R.sid && e.sid != near.player().sid).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
           enemy: function () {
               if (W.length && near.enemy()) {
                   return W.filter((e) => e.visible && e.sid != R.sid && e.sid != near.enemy().sid && (e.team != R.team || !e.team)).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
           teammate: function () {
               if (W.length && near.teammate()) {
                   return W.filter((e) => e.visible && e.sid != R.sid && e.sid != near.teammate().sid && e.team == R.team && e.team).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
       ...
       var far = {
           player: function () {
               if (W.length && near.player() && middle.player()) {
                   return W.filter((e) => e.visible && e.sid != R.sid && e.sid != near.player().sid && e.sid != middle.player().sid).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
           enemy: function () {
               if (W.length && near.enemy() && middle.enemy()) {
                   return W.filter((e) => e.visible && e.sid != R.sid && e.sid != near.enemy().sid && e.sid != middle.enemy().sid && (e.team != R.team || !e.team)).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
           teammate: function () {
               if (W.length && near.teammate() && middle.teammate()) {
                   return W.filter((e) => e.visible && e.sid != R.sid && e.sid != near.teammate().sid && e.sid != near.teammate().sid && e.team == R.team && e.team).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
       ...
       var inTrap = {
           me: function () {
               if (N.length) {
                   return N.filter((n) => n.active && n.owner && n.owner.sid != R.sid && !isTM(n.owner.sid) && n.id == 15 && dist(n, R) < 50).sort((a, b) => dist(a, R) - dist(b, R))[0];
               } else {
                   return false;
               }
           },
           near: {
               player: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != near.player() && (near.player() == near.teammate() ? !isTM(n.owner.sid) : true) && n.id == 15 && dist(n, near.player()) < 50).sort(
                           (a, b) => dist(a, near.player()) - dist(b, near.player())
                       )[0];
                   } else {
                       return false;
                   }
               ...
               enemy: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != near.enemy() && n.id == 15 && dist(n, near.enemy()) < 50).sort((a, b) => dist(a, near.enemy()) - dist(b, near.enemy()))[0];
                   } else {
                       return false;
                   }
               },
               teammate: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != near.teammate() && !isTM(n.owner.sid) && n.id == 15 && dist(n, near.teammate()) < 50).sort(
                           (a, b) => dist(a, near.teammate()) - dist(b, near.teammate())
                       )[0];
                   } else {
                       return false;
                   }
           ...
           middle: {
               player: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != middle.player() && (middle.player() == middle.teammate() ? !isTM(n.owner.sid) : true) && n.id == 15 && dist(n, middle.player()) < 50).sort(
                           (a, b) => dist(a, middle.player()) - dist(b, middle.player())
                       )[0];
                   } else {
                       return false;
                   }
               ...
               enemy: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != middle.enemy() && n.id == 15 && dist(n, middle.enemy()) < 50).sort((a, b) => dist(a, middle.enemy()) - dist(b, middle.enemy()))[0];
                   } else {
                       return false;
                   }
               },
               teammate: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != middle.teammate() && !isTM(n.owner.sid) && n.id == 15 && dist(n, middle.teammate()) < 50).sort(
                           (a, b) => dist(a, middle.teammate()) - dist(b, middle.teammate())
                       )[0];
                   } else {
                       return false;
                   }
           ...
           far: {
               player: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != far.player() && (far.player() == far.teammate() ? !isTM(n.owner.sid) : true) && n.id == 15 && dist(n, far.player()) < 50).sort(
                           (a, b) => dist(a, far.player()) - dist(b, far.player())
                       )[0];
                   } else {
                       return false;
                   }
               ...
               enemy: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != far.enemy() && n.id == 15 && dist(n, far.enemy()) < 50).sort((a, b) => dist(a, far.enemy()) - dist(b, far.enemy()))[0];
                   } else {
                       return false;
                   }
               },
               teammate: function () {
                   if (N.length) {
                       return N.filter((n) => n.active && n.owner && n.owner.sid != far.teammate() && !isTM(n.owner.sid) && n.id == 15 && dist(n, far.teammate()) < 50).sort((a, b) => dist(a, far.teammate()) - dist(b, far.teammate()))[0];
                   } else {
                       return false;
                   }
               },
       ...
       function setDatasForPlayers(_) {
           if(_.skinIndex == 45){
               _.clownCounter = "clowned";
               _.clowned = true;
               ...
               _.clowned = false;
               if(_ == R) {
                   console.log("unclowned");
               }
           }
           if (_.buildIndex == -1) {
               if (_.weaponIndex < 9) {
                   _.primary.variant = _.weaponVariant;
                   if (_.weaponIndex == _.primary.index) {
                       _.primary.reload = Math.min(1, _.primary.reload + 111 / l.weapons[_.primary.index].speed);
                   } else {
                       _.primary.index = _.weaponIndex;
                       _.primary.reload = 1;
                   }
               } else {
                   _.secondary.variant = _.weaponVariant;
                   if (_.weaponIndex == _.secondary.index) {
                       _.secondary.reload = Math.min(1, _.secondary.reload + 111 / l.weapons[_.secondary.index].speed);
                   } else {
                       _.secondary.index = _.weaponIndex;
                       _.secondary.reload = 1;
                   }
               }
           } else if (_.buildIndex <= 3) {
               _.itemTypes.food = _.buildIndex;
           }
           for (let i = 0; i < t.length; i++) {
               if (_.skinIndex == t[i].id) {
                   _.hatBought[t[i].id] = true;
               } else {
                   _.hatBought[t[i].id] = false;
               }
               if (_.tailIndex == t[i].id) {
                   _.accBought[t[i].id] = true;
               } else {
                   _.accBought[t[i].id] = false;
               }
           }
           weaponLength[_.sid] = l.weapons[_.weaponIndex].range + 30 + _.dt;
           primaryID[_.sid] = _.primary.index;
           primaryReload[_.sid] = _.primary.reload;
           secondaryID[_.sid] = _.secondary.index;
           secondaryReload[_.sid] = _.secondary.reload;
           turretReload[_.sid] = _.turret.reload;
           _.turret.reload = Math.min(1, _.turret.reload + 0.0444);
           _.bullHat.reload = Math.min(1, _.bullHat.reload + 1 / 6);
           _.futureHealth = Math.min(100, _.health + _.itemTypes.foodHealing[_.itemTypes.food]);
       }
       ...
       function autoPlace() {
           ...
           if (near.enemy()) {
               if (N.length) {
                   enemySpikes = N.filter(c => c.active && c.owner && c.owner.sid != near.enemy() && c.id >= 6 && c.id <= 9 && dist(c, near.enemy()) < 35 + 52).sort((a, b) => dist(a, near.enemy()) - dist(b, near.enemy()))[0]
                   enemyBuild = N.filter(c => c.active && c.owner && dist(c, near.enemy()) < 35 + 52 + 35).sort((a, b) => dist(a, near.enemy()) - dist(b, near.enemy()))[0]
                   myTMTraps = N.filter(c => c.active && c.owner && c.sid != myTMTraps2 && (c.owner.sid == R.sid || isTM(c.owner.sid)) && c.id == 15 && dist(c, R) < 35 + 50 + 22).sort((a, b) => dist(a, R) - dist(b, R))[0]
                   myTMTraps2 = N.filter(c => c.active && c.owner && c.sid != myTMTraps && (c.owner.sid == R.sid || isTM(c.owner.sid)) && c.id == 15 && dist(c, R) < 35 + 50 + 22).sort((a, b) => dist(a, R) - dist(b, R))[0]
               }
               if (inTrap.near.enemy()) {
                   if (dist(inTrap.near.enemy(), R) < 50 + 35 + 52 + 22) {
                       if (enemySpikes) {
                           if ((!myTMTraps ? !myTMTraps2 : myTMTraps) && dist(near.enemy(), R) <= 450) {
                               pT(R.items[4], aimTo(inTrap.near.enemy(), R) + 3.14, 1);
                           }
                       } else {
                           pT(R.items[2], aimTo(inTrap.near.enemy(), R) - toRad(51), 1);
                           pT(R.items[2], aimTo(inTrap.near.enemy(), R) + toRad(51), 1);
                           pT(R.items[4], aimTo(inTrap.near.enemy(), R), 1);
                       }
                   } else if ((!myTMTraps ? !myTMTraps2 : myTMTraps)) {
                       pT(R.items[4], aimTo(near.enemy(), R) + toRad(90), 1);
                       pT(R.items[4], aimTo(near.enemy(), R) - toRad(90), 1);
                   }
               } else {
                   if (dist(near.enemy(), R) < 50 + 35 + 22 && (enemyBuild && enemyBuild.id == 15 && enemyBuild.owner.sid == near.enemy().sid && dist(enemyBuild, near.enemy()) < 50 ? !enemyBuild : near.enemy())) {
                       pT(R.items[4], aimTo(near.enemy(), R), 1);
                   }
               }
           }*/
       }
       ...
       function Ti(e) {
           ...
           for (n = 0; n < e.length; )
               (_ = Ii(e[n])) && (_.t1 = void 0 === _.t2 ? t : _.t2,
                   ...
                   n += 13
           for (let i = 0; i < W.length; i++) {
               if (W[i].health < W[i].beforeHealth) {
                   W[i].beforeHealth -= 3.5;
               } else {
                   W[i].beforeHealth = W[i].health;
               }
           }
           for (let i = 0; i < W.length; i++) {
               _ = Ii(W[i].sid);
               setDatasForPlayers(_);
           }
           //autoPlace();
       }
       ...
       function Pi() {
           var e = Date.now() - Ai;
           window.pingTime = e,
               Ie.innerText = "Ping: " + e + " ms | " + "FPS: " + FPS
       }
       function Bi() {
           Ai = Date.now(),
               r.send("pp")
       ...
       window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e) {
           ...
           B = Date.now(),
            ...
            be.fillRect(0, o.mapScale - o.snowBiomeTop - d, oe, ce - (o.mapScale - o.snowBiomeTop - d))),
                   ...
                   be.globalAlpha = .06,
                   be.beginPath();
               for (var p = -U; p < oe; p += ce / 30)
                   p > 0 && (be.moveTo(p, 0),
                             be.lineTo(p, ce));
               for (var g = -D; g < ce; g += ce / 30)
                   p > 0 && (be.moveTo(0, g),
                             be.lineTo(oe, g));
               for (be.stroke(),
                    be.globalAlpha = 1,
               ...
               for (be.globalAlpha = 1,
                   ...
                   if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                       if (_.isPlayer) {
                           var w = ("(" + _.sid + ") ") + (_.team ? " " + _.team + " - " : "") + (_.name || "") + (" [" + ((_.skinIndex != 45) ? _.clownCounter : _.clownTimer) + "]");
                       } else {
                           w = (_.name || "");
                       }
                       if ("" != w) {
                           if (be.font = (_.nameScale || 30) + "px Hammersmith One",
                               ...
                               be.lineJoin = "round",
                               be.strokeText(w, _.x - f, _.y - d - _.scale - o.nameY + ((!_.isPlayer) ? 0 : 175)),
                               be.fillText(w, _.x - f, _.y - d - _.scale - o.nameY + ((!_.isPlayer) ? 0 : 175)),
                               _.isLeader && Rn.crown.isLoaded) {
                               var b = o.crownIconScale;
                               k = _.x - f - b / 2 - be.measureText(w).width / 2 - o.crownPad,
                                   be.drawImage(Rn.crown, k, _.y - d - _.scale - o.nameY + ((!_.isPlayer) ? 0 : 175) - b / 2 - 5, b, b)
                           }
                           1 == _.iconIndex && Rn.skull.isLoaded && (b = o.crownIconScale,
                                                                     k = _.x - f - b / 2 + be.measureText(w).width / 2 + o.crownPad,
                                                                     be.drawImage(Rn.skull, k, _.y - d - _.scale - o.nameY + ((!_.isPlayer) ? 0 : 175) - b / 2 - 5, b, b))
                       }
                       ...
                       if (_.isPlayer && _ == _) {
                           if (_.chatCountdown) {
                               ...
                               let img = new Image();
                               img.src = "https://www.shareicon.net/data/512x512/2016/07/07/792403_chat_512x512.png";
                               be.save();
                               //be.rotate(_.dir) + Math.PI / 2))
                               be.beginPath();
                               be.drawImage(img, _.x - f - 35, _.y - d - 200, 70, 70);
                               be.restore();
                           }
                       }

                       if (_ != R && ((!_.isPlayer) || (_.isPlayer && _.team && _.team == R.team && !_.isLeader) || (_.isPlayer && (_.team != R.team || !_.team) && !_.isLeader) || (_.isPlayer && _.team && _.team == R.team && _.isLeader) || (_.isPlayer && (_.team != R.team || !_.team) && _.isLeader))) { // Tracers
                           be.lineCap = "round";
                           be.strokeStyle = (!_.isPlayer) ? "#0000FF" : (_.team && _.team == R.team && _.isPlayer) ? (_.isLeader) ? "#AAFFAA" : "#00FF00" : (_.isLeader) ? "#FFAAAA" : "#FF0000";
                           be.lineWidth = 5;
                           be.beginPath();
                           be.moveTo(R.x - f, R.y - d + 0);
                           be.lineTo(_.x - f, _.y - d + 0);
                           be.stroke();
                           be.font = (_.nameScale || 20) + "px Hammersmith One";
                           be.fillStyle = "#FFFFFF";
                           be.textBaseline = "middle";
                           be.textAlign = "center";
                           be.lineWidth = _.nameScale ? 11 : 8;
                       ...
                       for(let i = 0; i < N.length; i++){
                           if(N[i].group != undefined && N[i].active != 0){
                               if(Math.hypot((N[i].y - R.y), (N[i].x - R.x)) <= 500){
                                   be.globalAlpha = 1;

                                   be.fillStyle = rt;
                                   be.roundRect(N[i].x+21 - f - 45 - o.healthBarPad, N[i].y-75 - d + N[i].scale + o.nameY - 15, 1 * 45 + 2 * o.healthBarPad, 17, 10);
                                   be.fill();
                                   be.fillStyle = (R.sid == N[i].owner.sid ? "#8ecc51" : isAlly(N[i].owner.sid) && N[i].owner.sid != R.sid ? "#5367cf" : "#cc5151");
                                   be.roundRect(N[i].x+21 - f - 45, N[i].y-75 - d + N[i].scale + o.nameY - 15 + o.healthBarPad, 1 * 45 * (N[i].health / N[i].maxHealth), 17 - 2 * o.healthBarPad, 10);
                                   be.fill();
                               }
                           }
                       }
                       ...
                       if (_.health > 0) {
                           be.globalAlpha = 1;
                           be.fillStyle = rt;
                           be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY - ((!_.isPlayer) ? 0 : 150), 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8);
                           be.fill();
                           be.fillStyle = rt;
                           be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY - ((!_.isPlayer) ? 0 : 150) + o.healthBarPad, 2 * o.healthBarWidth, 17 - 2 * o.healthBarPad, 7);
                           be.fill();
                           be.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151";
                           be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY - ((!_.isPlayer) ? 0 : 150) + o.healthBarPad, 2 * o.healthBarWidth * (_.health / _.maxHealth), 17 - 2 * o.healthBarPad, 7);
                           be.fill();

                           if (_.isPlayer) {
                               be.fillStyle = rt;
                               be.roundRect(_.x - f - o.healthBarPad, _.y - d + _.scale + o.nameY - 165, o.healthBarWidth + 2 * o.healthBarPad, 17, 8);
                               be.fill();
                               be.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151";
                               be.roundRect(_.x - f, _.y - d + _.scale + o.nameY + o.healthBarPad - 165, 2 * o.healthBarWidth / 2 * _.secondary.reload, 17 - 2 * o.healthBarPad, 7);
                               be.fill();

                               be.fillStyle = rt;
                               be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY - 165, o.healthBarWidth + 2 * o.healthBarPad, 17, 8);
                               be.fill();
                               be.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151";
                               be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad - 165, 2 * o.healthBarWidth / 2 * _.primary.reload, 17 - 2 * o.healthBarPad, 7);
                               be.fill();
                           }
                       }
                   }
               for (m.update(P, be, f, d),
                   ...
                   if ((_ = W[a]).visible && _.chatCountdown > 0) {
                       ...
                       var xy = be.measureText(_.chatCountdown);
                       be.textBaseline = "middle",
                           be.textAlign = "center",
                           k = _.x - f,
                           y = _.y - _.scale - d - 130;
                       var xz = x.width + 17;
                       be.fillStyle = "rgba(0,0,0,0)",
                           be.roundRect(k - xz / 2, y - 47, S, 47, 6),
                           be.fill(),
                           be.lineWidth = 11,
                           be.lineJoin = "round",
                           be.fillStyle = "#fff",
                           be.strokeText(Math.round(_.chatCountdown/100), k, y),
                           be.fillText(Math.round(_.chatCountdown/100), k, y)
                   }
               !function(e) {
                   if (R && R.alive) {
       ...
       e.exports = function(e, t, n, l, h, u, f, d, p, g, m, y, k, v) {
           ...
           this.points = 0,
               ...
               this.active = !0,
                   ...
                   ///////////////////////////////////////////////////////////
                   this.clownCount = 0,
                   this.maxClownCount = 8,
                   this.futureHealth = this.maxHealth,
                   this.beforeHealth = this.maxHealth,
                   this.gotDmg = 0,
                   this.primary = {
                   reload: 1,
                   variant: 0,
...
document.getElementById('test').style.margin = "15px 15px 15px 15px";
document.getElementById('test').style.width='400px'
document.getElementById('test').style.height='270px'
document.getElementById('test').style.top = '200px';
document.getElementById('test').style.right = "50%";
document.getElementById('test').style.backgroundColor='rgb(0,0,0,.25)'
document.getElementById('test').style.borderRadius = "5px";
document.getElementById('test').style.color = 'white'
document.getElementById('test').innerHTML =
`
<body>
<label class = "indent"style="font-family: Hammersmith One;">Autoreplace<input type = "checkbox" id = "aR" ><br>
<label class = "indent"style="font-family: Hammersmith One;">Autoheal<input type = "checkbox" id = "aH" checked><br>
<label class = "indent"style="font-family: Hammersmith One;">AutoInsta<input type = "checkbox" id = "aI" ><br>
			<label for="iType">Insta Type: </label>
			<select name="InstaTypes" id="iType">
				<option value="nI">Normal Insta</option>
                <option value="rI">Reverse Insta</option>
                <option value="bI">Beastly Insta</option>
                <option value="1tI">1 Tick Insta</option>
			</select>
            			<label for="pType">Place Type: </label>
			<select name="Place Type" id="pType">
				<option value="pN">Place Normal</option>
                <option value="pI">Place Invis</option>
                <option value="pC">Place Cursed</option>
			</select>
</body>
`
var insT = "N"
var aR = false;
var aH = true;
var aRC = document.querySelector("#aR")
aRC.addEventListener('change', function() {
    if (this.checked) {
        aR = true;
    } else {
        aR = false;
...
var aHC = document.querySelector("#aH")
aHC.addEventListener('change', function() {
    if (this.checked) {
        aH = true;
    } else {
        aH = false;
