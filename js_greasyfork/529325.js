// ==UserScript==
// @name         Для Руководства Сервера | ARZAMAS
// @namespace    https://forum.blackrussia.online
// @version      0.6
// @description  Для руководства Сервера
// @author       Nikita_Bagrov
// @match        https://forum.blackrussia.online/*
// @include      https://forum.blackrussia.online/
// @grant        Nikita_Bagrov
// @license      Nikita_Bagrov
// @collaborator Nikita_Bagrov
// @icon
// @downloadURL https://update.greasyfork.org/scripts/529325/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20%7C%20ARZAMAS.user.js
// @updateURL https://update.greasyfork.org/scripts/529325/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20%7C%20ARZAMAS.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
      {
            ...
            content:
            '[CENTER][B][SIZE=4][COLOR=rgb(247, 218, 100)]Доброго времени суток.[/COLOR]<br><br>' +
            "[CENTER]Администратор будет проинформирован. Спасибо за обращение.<br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'flex-grow: 1; font-family: JetBrains Mono; border-radius: 25px',
...
`[CENTER][B][COLOR=rgb(247, 218, 100)]Доброго времени суток.[/COLOR]<br><br>`+
    ...
    ` [COLOR=rgb(97, 189, 109)]Одобрено.[/COLOR][/B][/CENTER]`,
        ...
        },
      {
            ...
            '[CENTER][SIZE=4][COLOR=rgb(247, 218, 100)][B]Доброго времени суток.[/B][/COLOR]<br><br>' +
            "[CENTER][B][SIZE=4]Жалоба составлена не по форме. Подайте новую правильно.[/SIZE][/B][/CENTER] <br><br>" +
            "[CENTER][B][SIZE=4]Правила подачи жалоб - [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-лидеров.3429391/']*Нажми*[/URL][/SIZE][/B][/CENTER] <br><br>" +
            '[COLOR=rgb(226, 80, 65)][B]Закрыто.[/COLOR]',
            prefix: CLOSE_PREFIX,
            status: false,
            style: 'border-radius: 25px; font-family: JetBrains Mono',
