...
// @downloadURL https://update.greasyfork.org/scripts/558666/IZHEVSK%2011122025.user.js
// @updateURL https://update.greasyfork.org/scripts/558666/IZHEVSK%2011122025.meta.js
// ==/UserScript==
...
(function() {
    ...
    title: 'СВОЙ ОТВЕТ',
    content:
	"[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[B][CENTER]Твой текст [/CENTER][B]<br><br>"+
    '[B][CENTER]вердикт [/FONT][/CENTER][/B]'
    },
    {
    ...
    content:
	"[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[B][CENTER]Ваша жалоба взята на рссмотрение, ожидайте ответа в данной теме.[/CENTER][B]<br><br>"+
    '[B][CENTER]На рассмотрении[/FONT][/CENTER][/B]',
    prefix: PIN_PREFIX,
    status: true,
    },
    {
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Основному Заместителю Главного Администратора[/color] - @Artemy_Sovolev [Color=Orange]на рассмотрение[/color].[/CENTER]<br><br>",
    prefix: PIN_PREFIX,
    status: true,
    },
    {
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Заместителю Главного Администратора[/color] - @Tanechka_Muller [Color=Orange]на рассмотрение[/color].[/CENTER]<br><br>",
    prefix: PIN_PREFIX,
    status: true,
    },
    {
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Ваша жалоба передана [COLOR=rgb(255,255,0)]Специальной администрации.[/color][Color=Orange]На рассмотрение[/color].[/CENTER]<br><br>",
    prefix: SA_PREFIX,
    status: true,
    },
    {
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[B][CENTER]Наказание будет снято.[/CENTER][B]<br><br>"+
    '[B][CENTER]Одобрено[/FONT][/CENTER][/B]',
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Спасибо за обращение. С администратором будет проведена беседа.[/CENTER]<br>"+
    '[B][CENTER]Одобрено[/FONT][/CENTER][/B]',
    prefix: ACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Спасибо за обращение. С администратором будет проведена строгая беседа.[/CENTER]<br>"+
    '[B][CENTER]Одобрено[/FONT][/CENTER][/B]',
    prefix: ACCEPT_PREFIX,
    status: false,
    },
    ...
    '[B][CENTER][COLOR=#FF0000]Отказано.[/COLOR][/FONT][/CENTER][/B]<br>',
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Наказание было выдано по жалобе на форуме. Проверив доказательства администратором, было принято решение, что наказание выдано верно.<br>Впредь не нарушайте правила сервера, ознакомиться можно по ссылке - [URL='https://forum.blackrussia.online/index.php?threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%BE%D0%B2.312571/'][color=rgb(255,0,0)]«Общие правила серверов»[/color][/URL][/CENTER]<br>"+
    '[B][CENTER][COLOR=#FF0000]Отказано.[/COLOR][/FONT][/CENTER][/B]<br>',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Ваша жалоба составлена не по форме. Создайте повторную жалобу, соблюдая правила и форму подачи. Ссылка - [URL='https://forum.blackrussia.online/index.php?threads/3429349/']'Правила подачи жалоб на администрацию'[/URL][/CENTER]<br>"+
    '[B][CENTER]Отказано.[/FONT][/CENTER][/B]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    {
    ...
    '[B][CENTER]Закрыто.[/FONT][/CENTER][/B]',
    prefix: CLOSE_PREFIX,
    status: false,
    },
    {
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Жалоба с подобным содержанием не подлежит рассмотрению.[/CENTER]<br>"+
    '[B][CENTER]Закрыто.[/FONT][/CENTER][/B]',
    prefix: CLOSE_PREFIX,
    status: false,
    },
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Вам уже был дан развёрнутый овтет ранее в прошлой жалобе. За создание дубликатов этой темы ваш форумный аккаунт может быть заблокирован.[/CENTER]<br>"+
    '[B][CENTER]Закрыто.[/FONT][/CENTER][/B]',
    prefix: CLOSE_PREFIX,
    status: false,
    },
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]Прикрепите в новой жалобе скриншот, где показано окно блокировки.[/CENTER]<br>"+
    '[B][CENTER]Закрыто.[/FONT][/CENTER][/B]',
    prefix: CLOSE_PREFIX,
    status: false,
    },
    ...
    content:
    "[B][CENTER][FONT=georgia][ICODE]{{ greeting }} {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
    "[CENTER]С момента выдачи наказаняи прошло более 48-ми часов.[/CENTER]<br>"+
    '[B][CENTER]Отказано.[/FONT][/CENTER][/B]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
	...
	},
  {
	...
	},
   {
    ...
    $(document).ready(() => {
        ...
        addButton('На рассмотрении', 'pin', 'background: #422; border: 2px solid #FFA500; border-radius: 5px');
        addButton('Команде Проекта', 'teamProject', 'background: #423; border: 2px solid #FFFF00; border-radius: 5px');
        addButton('СА', 'Spec', 'background: #413; border: 2px solid #ff0000; border-radius: 5px');
        addButton('ГА', 'Ga', 'background: #413; border: 2px solid #ff0000; border-radius: 5px');
        addButton('Тех. Спец.', 'Texy', 'background: #191970; border: 2px solid #0000FF; border-radius: 5px');
        addButton('Одобрено', 'accepted', 'background: #556B2F; border: 2px solid #00FF00; border-radius: 5px');
        addButton('Решено', 'Resheno', 'background: #556B2F; border: 2px solid #00FF00; border-radius: 5px');
        addButton('Отказано', 'unaccept', 'background: #413; border: 2px solid #ff0000; border-radius: 5px');
        addButton('Закрыто', 'Zakrito', 'background: #413; border: 2px solid #ff0000; border-radius: 5px');
        addButton('Важно', 'Vajno', 'background: #413; border: 2px solid #a00; border-radius: 5px');
        addButton('Ожидание', 'Ojidanie', 'background: #696969; border: 2px solid #aaa; border-radius: 5');
        addAnswers();
        ...
        $('button#Spec').click(() => editThreadData(SA_PREFIX, true));
    ...
    function addAnswers() {
        $('.button--icon--reply').after(`<button type="button" class="button--cta uix_quickReply--button button button--icon button--icon--write rippleButton" id="selectAnswer" style="oswald: 3px; margin-left: 100px; border: 2px solid; border-radius: 5px; background: #420; padding: 0px 27px 0px 27px; font-family: JetBrains Mono; border-color: #00FFFF;">ОТВЕТЫ</button>`,
                                       );
    }
