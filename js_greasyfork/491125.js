...
// @grant        GM_getValue
// @grant unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/491125/battle_damage_tooltip.user.js
// @updateURL https://update.greasyfork.org/scripts/491125/battle_damage_tooltip.meta.js
// ==/UserScript==
...
let settings_interval = setInterval(() => {
    if (Object.keys(unsafeWindow.stage.pole.obj).length !== 0) {
        ...
        if (location.href.includes("&lt")) {
            ...
            if(test.style.display === "none") {show_button("pause_button"); pause_button_onRelease()}
...
const loadedInterval = setInterval(()=>{
    ...
    if (android || iOS) {
        const helpButtonHTML = `<div id="help_buttonScript" class="toolbars_mobile_img"><span style = "color:white;">урон</span><img src="https://dcdn.heroeswm.ru/i/combat/btn_help.png?v=6" style="opacity:0.5"><br></div>`
...
window.addEventListener("keyup", event => {
    ...
    if ((document.querySelector("#chattext") !== document.activeElement) && (document.querySelector("#chattext_classic") !== document.activeElement)) {
        if (["e", "E", "у", "У"].includes(event.key)) manageDamageCalc();
