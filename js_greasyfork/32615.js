...
// @downloadURL https://update.greasyfork.org/scripts/32615/Sangu%20Package.user.js
// @updateURL https://update.greasyfork.org/scripts/32615/Sangu%20Package.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (lastVersion.length === 1) {
        ...
        if ('8.90.0'.indexOf(lastVersion.text()) === 0) {
