...
// @grant none
// @description IXL AWARDS THING
// @icon https://www.ixl.com/ixl-favicon.png
// @version 1.1
// @author DankamaTank
// @downloadURL https://update.greasyfork.org/scripts/391967/IXL.user.js
// @updateURL https://update.greasyfork.org/scripts/391967/IXL.meta.js
// ==/UserScript==
(function() {
    const options = {
        'text': "'" ,
