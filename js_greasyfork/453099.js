// ==UserScript==
// @name         hakr mod Katana Musket AUTOHEAL Anti-Insta starter resources
// @version      v.1.11.9
// @description  bad mod XD auto heal slightly better :>
// @author       W4IT#1814
// @match        *://moomoo.io/*
// @match        *://*.moomoo.io/*
...
// @grant        none
// @namespace    https://greasyfork.org/en/users/playmaker680
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/453099/hakr%20mod%20Katana%20Musket%20AUTOHEAL%20Anti-Insta%20starter%20resources.user.js
// @updateURL https://update.greasyfork.org/scripts/453099/hakr%20mod%20Katana%20Musket%20AUTOHEAL%20Anti-Insta%20starter%20resources.meta.js
// ==/UserScript==
let AUTHOR = "Playmaker680"
...
document.getElementById('linksContainer2').innerHTML = 'hakr mod! ' ;
document.getElementById('gameName').innerHTML = 'hakr mod';
document.getElementById('loadingText').innerHTML = ' loading... '
document.getElementById('diedText').innerHTML = "bozo died, bozo respawn";
document.getElementById('diedText').style.color = "#fe3200";
document.title = ' hakr mod';
document.getElementById("leaderboard").append ('ur haking XD');
...
newImg.addEventListener("click", () => {
    let w = window.open("https://discord.gg", null, `height=650, width=1199, status=yes, toolbar=no, menubar=no, location=no`);
});
