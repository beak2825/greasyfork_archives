...
// @version         1.4.1
// @date            2016-05-14
// @downloadURL https://update.greasyfork.org/scripts/10274/WhatCD%20Snatched.user.js
// @updateURL https://update.greasyfork.org/scripts/10274/WhatCD%20Snatched.meta.js
// ==/UserScript==
...
(function () {
	...
	function StatusBox(title) {
		...
		return {
			...
			show: function(t) {
				if (global_hideStatusBox != 'true' || /what\.cd\/torrents\.php.type/.test(document.URL)) {
					t = t || 0;
					update_timer(t);
					set_visible(true);
				}
