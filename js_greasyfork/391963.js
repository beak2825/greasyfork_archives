...
// @include      *.18board.*
// @include      *.18p2p.*
// @downloadURL https://update.greasyfork.org/scripts/391963/Misc%20Stuff.user.js
// @updateURL https://update.greasyfork.org/scripts/391963/Misc%20Stuff.meta.js
// ==/UserScript==
...
添加至 Steam 愿望单</a>
        ...
        styl.type="text/css";
        styl.innerHTML="a.s_s_s_border_color:visited {outline:#ff0000 dashed 3px!important}";
        ...
        if(document.getElementById("post-list")){
            ...
            for(let i=0;i<imgthumbs.length;++i){
                let imglink=imgthumbs[i].firstElementChild;
                imglink.style="outline:#ffffff dashed 3px";
