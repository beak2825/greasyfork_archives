// ==UserScript==
// @name            layerjs-gm-with-css
// @author          aweleey.li
// @version         1.0.1
// @grant           GM_addStyle
// @note            layer - 通用 Web 弹出层组件
// @note            MIT Licensed
// @note            add layer style
// ==/UserScript==
...
!(function (window, undefined) {
    ...
    var isLayui = window.layui && layui.define,
        ...
        ready = {
            ...
            link: function (href, fn, cssname) {
                // console.log('layer lsakdfjslakdf', layer);
                //未设置路径，则不主动加载css
    ...
    window.layer = layer;
    // console.log('window.layer', window.layer);
...
function AddLayerStyle(){
    GM_addStyle(`
        ...
        .layui-layer-load{background:url(https://cdn.bootcdn.net/ajax/libs/layer/3.5.1/theme/default/loading-1.gif) #eee center center no-repeat;}
        ...
        .layui-layer-loading .layui-layer-content{width:60px; height:24px; background:url(https://cdn.bootcdn.net/ajax/libs/layer/3.5.1/theme/default/loading-0.gif) no-repeat;}
        .layui-layer-loading .layui-layer-loading1{width:37px; height:37px; background:url(https://cdn.bootcdn.net/ajax/libs/layer/3.5.1/theme/default/loading-1.gif) no-repeat;}
        .layui-layer-loading .layui-layer-loading2, .layui-layer-ico16{width:32px; height:32px; background:url(https://cdn.bootcdn.net/ajax/libs/layer/3.5.1/theme/default/loading-2.gif) no-repeat;}
        ...
        .layui-layer-iconext{background:url(https://cdn.bootcdn.net/ajax/libs/layer/3.5.1/theme/default/icon-ext.png) no-repeat;}
        ...
        .layui-layer-imgbar{position: fixed; left:0; right: 0; bottom:0; width:100%; height: 40px; line-height: 40px; background-color:#000; filter:Alpha(opacity=60); background-color: rgba(2,0,0,.35); color: #fff; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; font-size:0;}
        .layui-layer-imgtit{}
