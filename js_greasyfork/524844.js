...
;const MobileCommentModule = (function() {
  ...
  function appendReplyItem(replyData, isTopReply) {
      ...
      <div class="root-reply-container">
        ...
        <div class="content-warp">
          <div class="user-info">
            ...
            <span style="height: 14px; padding: 0 2px; margin-right: 4px; display: flex; align-items: center; font-size: 10px; color: white; border-radius: 2px; background-color: ${getMemberLevelColor(replyData.member.level_info.current_level)};">LV${replyData.member.level_info.current_level}</span>
            ${
    ...
    viewMoreBtn && viewMoreBtn.addEventListener('click', () => loadPaginatedSubReplies(replyData.rpid, subReplyList, replyData.rcount, 1));
  }
