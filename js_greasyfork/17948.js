// ==UserScript==
// @name          白度
// @namespace     https://greasyfork.org/zh-CN/users/33325
// @description   去右侧、去百毒、去跳转
// @include       *www.baidu.com*
// @version       0.1
// @grant         GM_xmlhttpRequest
// @author        蛤
// @run-at        document-start
// @downloadURL https://update.greasyfork.org/scripts/17948/%E7%99%BD%E5%BA%A6.user.js
// @updateURL https://update.greasyfork.org/scripts/17948/%E7%99%BD%E5%BA%A6.meta.js
// ==/UserScript==

// https://greasyfork.org/zh-CN/scripts/17848 AC-百度去广告
...
// https://greasyfork.org/zh-CN/scripts/13808  purify-baidu-search
setInterval(function() {
    if(document.querySelector('.op-soft-checkbox')) 
        document.querySelector('.op-soft-checkbox').checked = '';
}, 1000);
    
// https://greasyfork.org/zh-CN/scripts/11915 remove-the-jump-link-in-baidu
