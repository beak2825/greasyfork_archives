...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/432513/Prosperous%20Universe%20Commodity%20Exchange%20Scraper.user.js
// @updateURL https://update.greasyfork.org/scripts/432513/Prosperous%20Universe%20Commodity%20Exchange%20Scraper.meta.js
// ==/UserScript==
    ...
    window.scrape = function(){
        ...
        for (var i2 = 0; i2 < products.length; i2++){
            for (var i = 0; i < aTags.length; i++) {
                if (aTags[i].textContent == products[i2]) {
                    found = aTags[i];
