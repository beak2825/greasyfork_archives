...
// @downloadURL https://update.greasyfork.org/scripts/13864/Colombian%20WME%20Closure%20Sheet%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/13864/Colombian%20WME%20Closure%20Sheet%20Helper.meta.js
// ==/UserScript==

var wmecsh_version = "0.0.2";
...
function clickedClosureSheetHelper(event)
{
    ...
    for(var k in endobj)
    {
        ...
        if (!event.ctrlKey && !event.metaKey)
            ends += cityname + "\t";
        ends += k + "\t'";
        var plink = "https://www.waze.com/editor/?lon=" + tmplatlon.lon + "&lat=" + tmplatlon.lat + "&zoom=" + zoom + "&segments=" + thisUser.userName;
        var idss = "";
