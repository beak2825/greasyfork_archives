...
// @downloadURL https://update.greasyfork.org/scripts/548591/JINDISONNG.user.js
// @updateURL https://update.greasyfork.org/scripts/548591/JINDISONNG.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "MEIRU CHEN";
    const NEW_NAME = "JINDI SONG";
    const NEW_BIRTHDAY = "(**0720)";
    const NEW_EXPIRE_DATE = "2033-12-04";
