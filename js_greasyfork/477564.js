...
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/477564/%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%88%87%E6%8D%A2%5B%E6%89%8B%E6%9C%BA%E7%89%88%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/477564/%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%88%87%E6%8D%A2%5B%E6%89%8B%E6%9C%BA%E7%89%88%5D.meta.js
// ==/UserScript==

const punkDeafultMark = "Bing-Baidu-Google-yep-Fsou-Quark-Sougou-searXNG";
const punkAllSearchMark = "Bing-Baidu-Google-Zhihu-Fsou-360-Wuzhui-Quark-Sougou-yep-Yandex-Ecosia-DuckDuckGo-QwantLite-searXNG-Swisscows";
...
const searchUrlMap = [
    ...
    {name: "yep", searchUrl: "https://yep.com/web?q=", searchkeyName: ["q"], matchUrl:/yep\.com.*?q=/g, mark:"yep",},
    ...
    {name: "searXNG", searchUrl: "https://etsi.me/search?q=", searchkeyName: ["q"], matchUrl:/etsi\.me\/search.*?q=/g, mark:"etsi",},
...
const punkSocialMap = [
  {
      ...
      tabList:[
          ...
          {name: "searXNG", searchUrl: "https://etsi.me/search?q="},
  ...
  },
  {
      ...
      tabList:[
          ...
          {name: "安娜的档案", searchUrl: "https://annas-archive.org/search?q="},
          {name: "即刻TV", searchUrl: "https://www.jiketv.com/index.php/search/wd/"},
          {name: "人人影视", searchUrl: "https://www.renren.pro/search?wd="},
          {name: "豌豆Pro", searchUrl: "https://wandou.la/search/"},
          {name: "茶杯狐", searchUrl: "https://www.cupfox.app/s/"},
      ],
  },
  {
      tabName:"开发",
...
function addJumpSearchBox(){
  ...
  punkJumpButton.onclick = function () {
    let sss = prompt("请输入需要显示的引擎！\n格式举例：Quark-Zhihu-yep-360\n则导航为：夸克、知乎、yep、360", GM_getValue("punk_setup_search") || punkDeafultMark);
    if (sss) {
