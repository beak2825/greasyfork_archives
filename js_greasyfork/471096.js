// ==UserScript==
// @name                anidb Internationalization
// @name:zh-CN          anidb 汉化插件
// @name:ja             anidb 日本語
// @namespace           https://github.com/zhengwulin/anidb-i18n-plugin
// @version             0.001
// @description         Translate anidb.net
// @description:zh      anidb 汉化插件，包含人机翻译
// @description:zh-CN   anidb 汉化插件，包含人机翻译
// @description:ja      anidb 日本語プラグイン
// @author              k1995
// @match               https://anidb.net/*
// @match               http://anidb.net/*
// @grant               GM_xmlhttpRequest
// @grant               GM_getResourceText
// @icon		https://cdn-us.anidb.net/css/assets/images/touch/favicon-32x32.png?v=2023-06-18T15-17-39
// @resource            zh-CN https://raw.githubusercontent.com/zhengwulin/anidb-i18n-plugin/master/locales/zh-CN.json
// @resource            ja https://raw.githubusercontent.com/zhengwulin/anidb-i18n-plugin/master/locales/ja.json
// @require             https://cdn.staticfile.org/timeago.js/4.0.2/timeago.min.js
// @require             https://cdn.staticfile.org/jquery/3.4.1/jquery.min.js
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/471096/anidb%20Internationalization.user.js
// @updateURL https://update.greasyfork.org/scripts/471096/anidb%20Internationalization.meta.js
// ==/UserScript==
