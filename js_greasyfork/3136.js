...
// @downloadURL https://update.greasyfork.org/scripts/3136/Today%27s%20Projected%20Earnings%20Plus%20Graph.user.js
// @updateURL https://update.greasyfork.org/scripts/3136/Today%27s%20Projected%20Earnings%20Plus%20Graph.meta.js
// ==/UserScript==
...
function earningsChart(TodayChart){
        ...
        animate: !$.jqplot.use_excanvas,
                seriesDefaults: {
                        ...
                        pointLabels: { show: true, location: 'w', edgeTolerance: -15, formatString: '$%s/$' + dailyGoal },
                        shadowAngle: 135,
                        rendererOptions: {
                ...
                axes: {
                        xaxis: {
                                max: ((TodayChart < 90) ? 100 : (TodayChart + 10)),
                        },
                        yaxis: {
