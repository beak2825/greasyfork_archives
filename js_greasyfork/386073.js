...
// @version      0.48
// @description  Hangame theme for Jstris
// @author       Oki, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/386073/Hangame%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/386073/Hangame%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/FhorZcv.png",44);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/hwL7ZsY.png')";
...
function atGameStart() {
    ...
    bgLayer.width = 565
    bgLayer.height = 1000
    bgLayer.style.left = "-"+((1000-248)/2)/2+"px"
    bgLayer.style.top = "-"+((728-500)/2)/2+"px"
    this.drawBgGrid(1);
    var bgctx = bgLayer.getContext("2d");
    var img = new Image;
    img.onload = function(){
        bgctx.clearRect(0, 0, 505, 728);
        bgctx.drawImage(img,27,-61,554,799); // Or at whatever offset you like
    };
    img.src = "https://i.imgur.com/mgwZVzE.png";
...
queueCopy0.style.transform = "scale(.8,.8) translate(13px, 25px)"
queueCopy1.style.transform = "scale(.7,.7) translate(16px, 70px)"
queueCopy2.style.transform = "scale(0.7,0.7) translate(16px, 70px)"
queueCopy3.style.transform = "scale(0.7,0.7) translate(16px, 70px)"
queueCopy4.style.transform = "scale(0.7,0.7) translate(16px, 70px)"


holdCanvas.style.float = "none"
holdCanvas.style.position = "absolute"
holdCanvas.style.transform = "scale(0.7,0.7)"
holdCanvas.style.top = "93px"
holdCanvas.style.left = "-9px"
...
"https://ecdldaiiere.github.io/Eddiez-Soundz/Han_perfectclear.mp3",   //no sound exists for TB
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Hansong1.ogg",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/Hansong1.ogg"
