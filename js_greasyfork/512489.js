// ==UserScript==
// @name         Amazon Books to Z-library and Anna's Archive updated
...
// @downloadURL https://update.greasyfork.org/scripts/512489/Amazon%20Books%20to%20Z-library%20and%20Anna%27s%20Archive%20updated.user.js
// @updateURL https://update.greasyfork.org/scripts/512489/Amazon%20Books%20to%20Z-library%20and%20Anna%27s%20Archive%20updated.meta.js
// ==/UserScript==
...
(function () {
    ...
    function redirectToAnnasArchive() {
        ...
        if (!isbn13) {
            ...
            window.open('https://annas-archive.org/search?index=&page=1&q=' + isbn13);
        }
    }
