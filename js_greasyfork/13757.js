...
// @version	1.0.7
// @description  30条件指令版太原龙城修改版，纪念伟大而无耻的黑客XPQ——TrophyManager.com enhanced co editor. Created by XpQ
// @include		*trophymanager.com/tactics*
// @include		*trophymanager.com/national-teams/cn/tactics*

// @namespace https://greasyfork.org/users/15590
// @downloadURL https://update.greasyfork.org/scripts/13757/TM_enhanced_co_editor.user.js
// @updateURL https://update.greasyfork.org/scripts/13757/TM_enhanced_co_editor.meta.js
// ==/UserScript==
...
//====================================================================================
$(".order_box.cond_header.cond_box").append('<span id="maxCoList" style="cursor:pointer;float:right;">[口]</span>');
...
function listID() {
    ...
    $(".cond_order_plus").prepend('\
		<a class="upCopy" style="float:left;width:0px;line-height:20px;cursor:pointer;font-size:9px">▲粘</a>\
		<a class="downCopy" style="float:left;width:0px;line-height:80px;cursor:pointer;font-size:9px">▼</a>');  
    $(".upCopy:first,.downCopy:last").remove();
    $(".upCopy").click(upCopyCo);
    $(".downCopy").click(downCopyCo);
    //    
    $(".co_count").prepend('\
		<span class="upSort" style="float:left;width:0px;line-height:20px;cursor:pointer;font-size:11px;font-weight:bold">△换</span>\
		<span class="downSort" style="float:left;width:0px;line-height:80px;cursor:pointer;font-size:11px;font-weight:bold">▽</span>');
    $(".upSort:first,.downSort:last").remove();
    $(".upSort").click(upSortCo);
    $(".downSort").click(downSortCo);
    //
    $("#cond_orders_list div [player_link]").prepend("<span><span class='down' style='font-size:7px'>▼</span><span class='up' style='font-size:7px'>▲换</span></span>");
...
function maxCoList() {
    ...
    $("#tactics").attr('style','height:1870px;');
    $(".tactics_advanced").attr('style','height:1870px;');
