...
// @antifeature  ads
// @downloadURL https://update.greasyfork.org/scripts/445886/SurvivIO%20Aimbot%2C%20ESP%20%20X-Ray.user.js
// @updateURL https://update.greasyfork.org/scripts/445886/SurvivIO%20Aimbot%2C%20ESP%20%20X-Ray.meta.js
// ==/UserScript==
			...
			apply( target, thisArgs, args ) {
				...
				*/
				...
				if ( aimbotEnabled ) {
					...
					ctx.arc( targetPlayer.x, targetPlayer.y, radius, 0, Math.PI * 20 );
...
window.addEventListener( 'DOMContentLoaded', function () {
	...
	<div class="my-dialog">${shouldShowAd ? `<big></big>` : `<div class="my-close" onclick="this.parentNode.style.display='none';"></div>
