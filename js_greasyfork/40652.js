...
// @grant		   none
// @downloadURL https://update.greasyfork.org/scripts/40652/TBR%20Map%20TEST.user.js
// @updateURL https://update.greasyfork.org/scripts/40652/TBR%20Map%20TEST.meta.js
// ==/UserScript==
...
if (location.href.match(/^https:\/\/((nl|zz|svs|en).*\.tribalwars\.(nl|se|net)\/(game.php|public_report).*)/)) {
  ...
  (function (f) {
    ...
    /* would be stored in cookie/localStorage */
      ...
      config = {
        "opslaan": "https://elliptic-rollers.000webhostapp.com/index.php/opslaan.php?value=opslaan&",
        "note": "www.tbrmap.devs/note.php?",
        "info": "https://elliptic-rollers.000webhostapp.com/index.php/info.php?value=info&",
        "map": "https://elliptic-rollers.000webhostapp.com/index.php/map.php?value=map&",
        "version": "3.2.26",
        "farmrule": {
          "nl5": 1200,
          "nl10": 1800,
