// ==UserScript==
// @name         [AQUA] Кураторы Форума
// @namespace    https://forum.blackrussia.online
// @version      8.2
// @description  Создан для кураторов форума
// @author       Kirill_Orange
...
// @downloadURL https://update.greasyfork.org/scripts/501969/%5BAQUA%5D%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/501969/%5BAQUA%5D%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
...
title: 'DM',
content:
'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/B]<br>' +
...
title: 'Слив склада',
content:
'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE]<br>' +
...
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
    "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
"[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.08. [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] Запрещена любая форма аморальных действий сексуального характера в сторону игроков [/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]| Jail 30 минут / Warn[/SIZE][/FONT][/COLOR]<br><br>" +
"[B][CENTER][B][COLOR=lime][ICODE]Одобрено[/ICODE][/COLOR][/B]<br><br>"+
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B][/CENTER]<br>",
status: false,
},
...
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
    "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту правил государственных структур:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
"[SIZE=4][FONT=book antiqua][COLOR=rgb(255, 0, 0)]6.03. [/COLOR][COLOR=rgb(209, 213, 216)] Запрещено nRP поведение [/COLOR][COLOR=rgb(255, 0, 0)]| Warn[/COLOR][/FONT][/SIZE]<br><br>" +
'[LIST]<br><br>' +
"[*][SIZE=4][FONT=book antiqua][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]поведение, не соответствующее сотруднику УМВД.[/COLOR][/FONT][/SIZE]<br><br>" +
'[LIST]<br><br>' +
"[*][SIZE=4][FONT=book antiqua][COLOR=rgb(255, 0, 0)]Пример: [/COLOR][COLOR=rgb(209, 213, 216)]открытие огня по игрокам без причины, расстрел машин без причины, нарушение ПДД без причины, сотрудник на служебном транспорте кричит о наборе в свою семью на спавне.[/COLOR][/FONT][/SIZE]<br><br>" +
"[/LIST]<br><br>" +
"[B][CENTER][B][COLOR=lime][ICODE]Одобрено[/ICODE][/COLOR][/B]<br><br>"+
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B][/CENTER]<br>",
prefix: ACCEPT_PREFIX,
...
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
    "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
"[SIZE=4][COLOR=rgb(255, 0, 0)][FONT=book antiqua]2.52.[/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua] Запрещено располагать аксессуары на теле персонажа, нарушая нормы морали и этики, увеличивать аксессуары до слишком большого размера.[/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua] | При первом нарушении - обнуление аксессуаров, при повторном нарушении - обнуление аксессуаров + JAIL 30 минут[/FONT][/COLOR][/SIZE]<br><br>" +
'[LIST]<br><br>' +
"[*][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=book antiqua]Пример: [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua]слишком большие аксессуары на голове персонажа, имитация гитарой половых органов и тому подобное.[/FONT][/COLOR][/SIZE]<br><br>" +
"[/LIST]<br><br>" +
"[B][CENTER][B][COLOR=lime][ICODE]Одобрено[/ICODE][/COLOR][/B]<br><br>"+
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B][/CENTER]<br>",
prefix: ACCEPT_PREFIX,
...
{
title: 'изменение голоса в Voice чате',
content:
'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR]<br>' +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
    "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
"[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]3.19. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4] Запрещено использование любого софта для изменения голоса[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Mute 60 минут[/SIZE][/COLOR][/FONT]<br><br>" +
"[B][CENTER][B][COLOR=lime][ICODE]Одобрено[/ICODE][/COLOR][/B]<br><br>"+
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B][/CENTER]<br>",
prefix: ACCEPT_PREFIX,
status: false,
...
'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR]<br>' +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
    "[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]На вашей видеозаписи отсутствуют условия сделки.[/I][/SIZE][/FONT]<br><br>" +
...
'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR]<br>' +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
   "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Доказательства недоступны к просмотру - следовательно, рассмотрению ваша жалоба не подлежит. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее.[/I][/FONT][/SIZE]<br><br>" +
"[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/B]<br><br>" +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/CENTER][/B]<br><br>" ,
prefix: UNACCEPT_PREFIX,
status: false,
...
"[B][CENTER][COLOR=rgb(209, 213, 216)]Пожалуйста не создавайте дубликатов. Ожидайте ответа.[/COLOR][/B]<br>"+
...

	{
	  ...
	  content:
		...
		'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR]<br>' +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
		"[B][CENTER]Ваша жалоба была передана Техническому специалисту сервера. @Maestro_Astarot Ожидайте ответа.<br>"+
...
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B][/CENTER]<br>",
	...
	},
  {
	  ...
	  content:
		...
		'[CENTER][COLOR=AQUA][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR]<br>' +
"[B][URL='https://ibb.co/51gRYCr'][IMG]https://i.ibb.co/grLRvQS/image.png[/IMG][/URL][/B]<br><br>"+
		"[B][CENTER]Ваша жалоба была передана Главному Администратору и его Заместителям. Ожидайте ответа.<br>"+
