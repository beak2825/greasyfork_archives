...
// @downloadURL https://update.greasyfork.org/scripts/509639/Drug%20Empire%20issue.user.js
// @updateURL https://update.greasyfork.org/scripts/509639/Drug%20Empire%20issue.meta.js
// ==/UserScript==
/* jshint esversion: 6 */ (function () {
  "use strict"; // Original Bodega Bot script content
  (function (_Drug) {
    "use strict"; //*********** CONFIG ***********
    var CFG = {
    ...
    function removeAdContainer() {
      const adContainer = document.querySelector(
        'div[style*="width: 728px"][style*="height: 90px"][style*="position: fixed"][style*="bottom: 5px"]'
      );
      if (adContainer) {
        adContainer.remove();
      }
    ...
    function ensureRecaptchaLoaded() {
      ...
      function checkRecaptcha() {
        if (
          ...
          console.log("reCAPTCHA not loaded, retrying in 2 seconds");
          if (Date.now() - startTime < maxDuration) {
            setTimeout(checkRecaptcha, checkInterval);
          } else {
            console.log("Stopped retrying after 10 seconds");
          }
        } else {
    ...
    function initializeRecaptcha() {
      // Add your reCAPTCHA initialization code here
      // Example:
    ...
    function onStart() {
      ...
      function initializeScript() {
        if (
          !CTS.SocketTarget ||
          CTS.SocketTarget.readyState !== WebSocket.OPEN
        ) {
        ...
        try {
          ...
          Alert(
            GetActiveChat(),
            "<b><u>ERROR</u>:</b> Script initialization failed. Please refresh and try again."
          );
        }
      }
    ...
    window.CTSVersion = { Major: 1, Minor: 8, Patch: 65 };
    var MainElement,
      ChatLogElement,
      VideoListElement,
      SideMenuElement,
    ...
    var CTS = {
      ...
      Game: {
        ...
        Trivia: {
          ...
          Worth: 0,
          PlayerList: {},
          PriceList: { raid: 10000, spot: 500, ytbypass: 200 }
        },
        Drug: {
          ...
          NewAchievements: [],
          TypesOfDrugs: [
            ["💊😌 Xanax", 5, true], // Common and Prescription Drugs (5-30)
            ["💊🧠 Adderall", 5, true],
            ["💊😴 Ambien", 6, true],
            ["💊🏋️ Steroids", 6, true],
            ...
            ["💊🦋 Phenibut", 13, true],
            ["💊🧠 Modafinil", 14, true],
            ["💊🏔️ Dextroamphetamine", 14, true], // Moderately Available Illicit Drugs (31-60)
            ...
            ["💊🎆 DXM", 39, true],
            ["💊🧪 Bath Salts", 40, true],
            ["💨💎 Crystal Meth", 40, true], // Rare and Designer Drugs (61-100)
            ...
            ["💊🌌 DOx Series", 70, true], // Exotic and Research Chemicals (101-130)
            ["💊🌟 Tapentadol", 101, true],
            ["💊🔬 Etizolam", 101, true],
            ["💊🌈 ALD-52", 102, true],
            ["💊🌃 AL-LAD", 102, true],
            ...
            ["💊🦠 MDPV Analogues", 130, true], // Additional Exotic and Research Chemicals (continuing with 130)
            ...
            ["💊🌠 ALD-52 Analogues", 130, true],
            ["💊🌠 ETH-LAD", 130, true],
            ["💊🌠 ETH-LAD Analogues", 130, true], // Fantasy and Fictional Drugs
            ["🌺🌌 Soma", 130, true],
            ...
            ["💊🌌 Utopia", 130, true],
            ["💊🌌 Elysium", 130, true],
            ["💊🌌 Clarity", 130, true], // Production Scenarios
            ...
            [
              "🏭🔋 Power grid upgrade allows for increased production",
              80,
              true
            ],
            ...
            [
              "🌿🧬 Genetically modified plants yield higher THC content",
              86,
              true
            ...
            [
              "🚗🧊 Refrigerated transport acquired for sensitive products",
              82,
              true
            ],
            ...
            [
              "🚗🥸 Undercover distribution to high-end clients established",
              89,
              true
            ],
            ["📦🏭 Wholesale distribution center raided", 34, false],
            ["🚚🌫️ Stealth vehicle modifications perfected", 83, true], // Law Enforcement Interactions
            ...
            ["🔫🚔 Weapons cache discovered by authorities", 30, false], // Market Dynamics
            ...
            [
              "💵🖨️ Successful money laundering operation established",
              85,
              true
            ],
            ...
            ["💊🎭 Counterfeit product identified in supply", 33, false], // Client and Health Scenarios
            ...
            ["🚑🔊 Ambulance chatter suggests bad batch", 34, false], // Technology and Innovation
            [
              "🛰️📡 Satellite-based distribution tracking implemented",
              89,
              true
            ],
            ...
            [
              "🧬🔬 DNA-encoded tagging system for product authentication",
              87,
              true
            ],
            [
              "📡🌐 Mesh network established for secure communications",
              85,
              true
            ],
            ...
            ["🌡️📦 Smart packaging adjusts to maintain potency", 87, true], // Financial Operations
            ...
            ["💳🔒 New untraceable payment system", 89, true],
            ["🏛️🕵️ Central bank infiltration", 91, true],
            ["💼📉 Front company declares bankruptcy", 32, false],
            ["🌐💱 Foreign currency manipulation successful", 87, true],
            [
              "🏙️🌆 City development project secures clean investment",
              88,
              true
            ],
            ["📊🎰 Sports betting algorithm guarantees profits", 86, true],
            ["🏦💣 Bank heist traced back to organization", 31, false],
            ["💎👑 Jewelry store chain acquisition", 89, true],
            ...
            [
              "🏝️🏨 Resort chain facilitates tourism-based distribution",
              88,
              true
            ],
            ["🚢🐟 Fishing fleet expanded for maritime operations", 87, true],
            [
              "🌍🎓 International student exchange program compromised",
              35,
              false
            ],
            ...
            [
              "👥🏃 Courier network optimization increases efficiency",
              87,
              true
            ],
            ...
            [
              "📺🎭 Positive portrayal in popular TV series boosts sales",
              87,
              true
            ],
            ...
            [
              "👽🛸 Alien technology reverse-engineered for production",
              95,
              true
            ],
            [
              "🌋💨 Volcanic eruption distributes product across region",
              86,
              true
            ],
            [
              "🎭🏆 Undercover documentary wins award, raises suspicion",
              36,
              false
            ],
            [
              "🚀🌙 Lunar base established for extraterrestrial production",
              93,
              true
            ],
            [
              "🧬🔓 DNA-locked drugs hit market, revolutionizing security",
              91,
              true
            ],
            ["🦈💼 Shark tank disposal method revealed to public", 35, false],
            [
              "🕳️🌍 Wormhole discovery enables instant global transport",
              94,
              true
            ],
            ...
            [
              "🦸‍♂️🦹‍♀️ Superhero vs. villain battle damages production line",
              34,
              false
            ],
            ...
            [
              "🕰️🌀 Time travel technology secures future market share",
              96,
              true
            ],
            [
              "🌞☄️ Solar flare knocks out global surveillance systems",
              91,
              true
            ],
            ...
            [
              "🎮🕹️ Video game company acquired for virtual operations",
              89,
              true
            ],
            [
              "🚀🌌 Space tourism venture launches, enables orbital labs",
              93,
              true
            ],
            ...
            [
              "👓🥽 AR/VR tech company develops immersive experiences",
              88,
              true
            ],
            ...
            [
              "🍷🍇 Vineyard acquisition masks designer drug production",
              87,
              true
            ],
            [
              "📱🔊 Social media platform created for covert messaging",
              90,
              true
            ],
            ...
            [
              "🚁📦 Drone delivery startup enables aerial distribution",
              91,
              true
            ],
            ["🧘‍♀️🏝️ Meditation retreat center hosts VIP clients", 88, true],
            [
              "🎓🔬 Private research university founded for talent acquisition",
              92,
              true
            ],
            ...
            [
              "🏙️🦸 Superhero incident distracts from covert operation",
              87,
              true
            ],
            [
              "🌋🚁 Volcanic eruption covers tracks of emergency extraction",
              88,
              true
            ],
            ...
            [
              "🚑🏥 Ambulance clone enables high-speed evidence transport",
              86,
              true
            ],
            ...
            [
              "🦸‍♀️🦹‍♂️ Superhero-villain truce benefits underground economy",
              91,
              true
            ],
            [
              "🧬🔓 CRISPR tech creates undetectable organic compounds",
              93,
              true
            ],
            ...
            [
              "🛰️🔭 Private satellite network achieves global coverage",
              91,
              true
            ],
            ...
            [
              "🕳️🚪 Portable wormhole generator enables instant transport",
              95,
              true
            ],
            ...
            [
              "🌪️🧪 Weather control device secures outdoor operations",
              91,
              true
            ],
            ...
            [
              "🌍🔄 Perpetual energy source fuels infinite production",
              98,
              true
            ],
            ...
            [
              "🧠🔓 Mind-reading technology cracks organization codes",
              33,
              false
            ],
            ...
            [
              "🦄🔮 Magic realm crossing devastates synthetic market",
              31,
              false
            ],
            ...
            [
              "👨‍⚖️⚖️ Judge known for harsh sentences assigned to case",
              62,
              false
            ],
            ...
            [
              "🌐👁️ International intelligence agency opens investigation",
              92,
              false
            ],
            ["💉📺 High-profile overdose case makes national news", 79, false],
            [
              "🧬🔍 New forensic technique links evidence to operation",
              83,
              false
            ],
            ...
            [
              "🛰️🔭 Next-gen satellite tech compromises all hideouts",
              98,
              false
            ],
            [
              "🧠🔓 Experimental truth serum used on captured operative",
              94,
              false
            ],
            ["🌍🚫 Global law enforcement coalition formed", 99, false],
            [
              "💊💀 Mass casualty event tied to organization's product",
              100,
              false
            ]
          ]
    ...
    // Step 1: WebSocket and Message Queue Implementation
const MAX_RETRIES = 3;
...
function Send(type, message, handle, retry = 0) {
  const timestamp = Date.now();
  const messageKey = `${type}:${message}:${handle}`;

  // Check for recent duplicates
  const isDuplicate = recentMessages.some(m =>
    m.key === messageKey && (timestamp - m.timestamp) < DUPLICATE_WINDOW
  );

  if (isDuplicate) {
    console.log("Duplicate message detected, not sending:", { type, message, handle });
    return;
  }

  // Add to recent messages
  recentMessages.push({ key: messageKey, timestamp });

  // Cleanup old messages
  recentMessages = recentMessages.filter(m => (timestamp - m.timestamp) < DUPLICATE_WINDOW);

  console.log(`Send called at ${new Date().toISOString()} with:`, { type, message, handle, retry, stack: new Error().stack });

  if (messageQueue.some(msg => msg.type === type && msg.message === message && msg.handle === handle)) {
    console.log("Message already in queue, not adding again");
    return;
  }

  messageQueue.push({ type, message, handle, retry });
...
function processMessageQueue() {
  ...
  const { type, message, handle, retry } = messageQueue.shift();

  if (CTS.SocketTarget.readyState !== WebSocket.OPEN) {
    console.log("WebSocket not open, re-queueing message");
    messageQueue.unshift({ type, message, handle, retry });
  ...
  try {
    let payload;
    if (type === "msg") {
      payload = JSON.stringify({ tc: "msg", text: message });
    } else if (type === "pvtmsg" && handle) {
      payload = JSON.stringify({ tc: "pvtmsg", text: message, handle: handle });
    } else {
      payload = JSON.stringify({ tc: type, text: message, handle: handle });
    }

    CTS.SocketTarget.send(payload);
    ...
    if (retry < MAX_RETRIES) {
      console.log(`Retrying send (attempt ${retry + 1})`);
      messageQueue.unshift({ type, message, handle, retry: retry + 1 });
      setTimeout(processMessageQueue, RETRY_DELAY);
    } else {
      console.error("Max retries reached, message not sent:", message);
      setTimeout(processMessageQueue, MESSAGE_DELAY);
    }
  }
}
function reconnectWebSocket() {
  if (CTS.SocketTarget.readyState === WebSocket.CLOSED) {
...
function checkWebSocketStatus() {
  if (!CTS.SocketTarget || CTS.SocketTarget.readyState !== WebSocket.OPEN) {
        ...
        if (CTS.ScriptInit && CTS.SocketConnected) {
          ...
          if (CTS.Me.mod) {
            ...
            if (CTS.Room.YT_ON && CTS.Project.isTouchScreen)
              VideoListElement.querySelector(
                "#videos-footer>#videos-footer-youtube"
              ).classList.toggle("hidden"); //VideoListElement.querySelector("#videos-footer>#videos-footer-soundcloud").style.cssText = "display:block;";
          ...
          for (var g = 0; g < CTS.Room.Recent_Gifts.length; g++)
            recent_gifts += '<img src="' + CTS.Room.Recent_Gifts[g] + '" />'; //ALERT
          Settings(
            "<center><u>" +
    ...
    function CTSRoomInject() {
      if (window.CFG == null) {
        ...
        var CFG = {
          ...
          greetDelay: "1000", // 1 second delay before greeting
          greetCooldown: 10000, // 1 minute cooldown instead of 5 minutes
          greetWbTime: 300000, // 5 minutes instead of 10 minutes
          followupChance: 10, // Increase follow-up chance
          customGreetings: { USERNAME: "nickname" },
          Welcomes: [
            "Heyyy 👋😎",
            "Nǐ hǎo! 🌟👋",
            "Good to see you! 😊✨",
...
window.CTSNameColor = [
"#FF5733",  // Bright Orange-Red (Sunset Blaze)
"#FF33FF",  // Bright Pink (Neon Dream)
"#0033FF",  // Bright Blue (Electric Sky)
"#33A1FF",  // Lighter Sky Blue (Cyber Wave)
"#33FFFF",  // Bright Cyan (Aqua Pulse)
"#00FF99",  // Bright Mint Green (Minty Fresh)
"#33FF66",  // Neon Green (Lime Light)
"#66FF33",  // Light Green (Spring Burst)
"#00FF33",  // Bright Lime (Lime Zest)
"#FFFF33",  // Bright Yellow (Solar Flare)
"#FF9933",  // Bright Orange (Tangerine Glow)
"#FF3333",  // Vivid Red (Crimson Flash)
"#FF33A1",  // Neon Pink (Cyber Pink)
"#FF66CC",  // Soft Pink (Bubblegum Pop)
"#9933FF",  // Bright Purple (Violet Vibe)
"#222222",  // Dark Gray (Shadow)
"#FFFFFF",  // Bright White (Stark Contrast)
"#FF9900",  // Bright Orange (Amber Glow)
"#33FF33",  // Bright Green (Emerald Shine)
"#3366FF",  // Bright Blue (Sapphire Spark)
"#CC0066",  // Vivid Magenta (Magenta Rush)
"#CC3300"   // Bright Brick Red (Brick Blaze)
];
window.CTSChatCSS = [
  // Style #1: Classic Dark
  [
    [
      "#chat-wrapper{background:linear-gradient(313deg,rgba(26,26,26,0.75) 0%,rgba(44,44,44,0.65) calc(100% - 62px),rgba(61,61,61,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(313deg,rgba(45,45,45,0.6) 0%,rgba(45,45,45,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(313deg,rgba(45,45,45,0.7) 0%,rgba(45,45,45,0.9) 100%);border-radius:8px;padding:5px} .secondary-message{background:linear-gradient(313deg,rgba(45,45,45,0.5) 0%,rgba(45,45,45,0.7) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(45,45,45,0.7)} .PMPopup h2{background:linear-gradient(313deg,rgba(26,26,26,0.8) 0%,rgba(61,61,61,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:linear-gradient(313deg,rgba(74,74,74,0.7) 0%,rgba(74,74,74,0.7) 100%);transition:background .3s ease} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:linear-gradient(313deg,rgba(90,90,90,0.7) 0%,rgba(90,90,90,0.7) 100%)!important} #videos-footer-broadcast-wrapper.active>#videos-footer-broadcast,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button:focus{background:linear-gradient(313deg,rgba(60,60,60,0.8) 0%,rgba(60,60,60,0.8) 100%)!important} #videos-footer-push-to-talk.engaged{background:linear-gradient(313deg,rgba(255,69,0,0.8) 0%,rgba(255,69,0,0.8) 100%)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(313deg,rgba(26,26,26,0.75) 0%,rgba(61,61,61,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #2: Light Mode
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(240,240,240,0.75) 0%,rgba(224,224,224,0.65) calc(100% - 62px),rgba(208,208,208,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,255,255,0.6) 0%,rgba(255,255,255,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#333;text-shadow:none} .bot-message{background:linear-gradient(180deg,rgba(255,255,255,0.7) 0%,rgba(255,255,255,0.9) 100%);border-radius:8px;padding:5px} .secondary-message{background:linear-gradient(180deg,rgba(255,255,255,0.5) 0%,rgba(255,255,255,0.7) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,255,255,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(224,224,224,0.8) 0%,rgba(240,240,240,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:linear-gradient(0deg,rgba(192,192,192,0.7) 0%,rgba(192,192,192,0.7) 100%);transition:background .3s ease} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:linear-gradient(0deg,rgba(176,176,176,0.7) 0%,rgba(176,176,176,0.7) 100%)!important} #videos-footer-broadcast-wrapper.active>#videos-footer-broadcast,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button:focus{background:linear-gradient(0deg,rgba(208,208,208,0.8) 0%,rgba(208,208,208,0.8) 100%)!important} #videos-footer-push-to-talk.engaged{background:linear-gradient(0deg,rgba(0,128,0,0.8) 0%,rgba(0,128,0,0.8) 100%)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(224,224,224,0.75) 0%,rgba(240,240,240,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #3: Blue Ocean
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,51,102,0.75) 0%,rgba(0,85,153,0.65) calc(100% - 62px),rgba(0,119,204,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,85,153,0.6) 0%,rgba(0,85,153,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(0,85,153,0.7) 0%,rgba(0,85,153,0.9) 100%);border-radius:8px;padding:5px} .secondary-message{background:linear-gradient(180deg,rgba(0,85,153,0.5) 0%,rgba(0,85,153,0.7) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,68,119,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,51,102,0.8) 0%,rgba(0,119,204,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:linear-gradient(0deg,rgba(0,153,255,0.7) 0%,rgba(0,153,255,0.7) 100%);transition:background .3s ease} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:linear-gradient(0deg,rgba(51,181,255,0.8) 0%,rgba(51,181,255,0.8) 100%)!important} #videos-footer-broadcast-wrapper.active>#videos-footer-broadcast,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button:focus{background:linear-gradient(0deg,rgba(0,119,204,0.8) 0%,rgba(0,119,204,0.8) 100%)!important} #videos-footer-push-to-talk.engaged{background:linear-gradient(0deg,rgba(255,215,0,0.8) 0%,rgba(255,215,0,0.8) 100%)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,51,102,0.75) 0%,rgba(0,119,204,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #4: Forest Green
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,85,0,0.75) 0%,rgba(0,119,0,0.65) calc(100% - 62px),rgba(0,153,0,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,119,0,0.6) 0%,rgba(0,119,0,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(0,119,0,0.7) 0%,rgba(0,119,0,0.9) 100%);border-radius:8px;padding:5px} .secondary-message{background:linear-gradient(180deg,rgba(0,119,0,0.5) 0%,rgba(0,119,0,0.7) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,102,0,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,85,0,0.8) 0%,rgba(0,153,0,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:linear-gradient(0deg,rgba(0,187,0,0.7) 0%,rgba(0,187,0,0.7) 100%);transition:background .3s ease} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:linear-gradient(0deg,rgba(0,221,0,0.7) 0%,rgba(0,221,0,0.7) 100%)!important} #videos-footer-broadcast-wrapper.active>#videos-footer-broadcast,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button:focus{background:linear-gradient(0deg,rgba(0,153,0,0.8) 0%,rgba(0,153,0,0.8) 100%)!important} #videos-footer-push-to-talk.engaged{background:linear-gradient(0deg,rgba(255,165,0,0.8) 0%,rgba(255,165,0,0.8) 100%)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,85,0,0.75) 0%,rgba(0,153,0,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #5: Ruby Red
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(102,0,0,0.75) 0%,rgba(153,0,0,0.65) calc(100% - 62px),rgba(204,0,0,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(153,0,0,0.6) 0%,rgba(153,0,0,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(153,0,0,0.7) 0%,rgba(153,0,0,0.9) 100%);border-radius:8px;padding:5px} .secondary-message{background:linear-gradient(180deg,rgba(153,0,0,0.5) 0%,rgba(153,0,0,0.7) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(119,0,0,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(102,0,0,0.8) 0%,rgba(204,0,0,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:linear-gradient(0deg,rgba(255,0,0,0.7) 0%,rgba(255,0,0,0.7) 100%);transition:background .3s ease} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:linear-gradient(0deg,rgba(255,51,51,0.7) 0%,rgba(255,51,51,0.7) 100%)!important} #videos-footer-broadcast-wrapper.active>#videos-footer-broadcast,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button:focus{background:linear-gradient(0deg,rgba(204,0,0,0.8) 0%,rgba(204,0,0,0.8) 100%)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(102,0,0,0.75) 0%,rgba(204,0,0,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #6: Sunset Orange (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,69,0,0.75) 0%,rgba(255,99,71,0.65) calc(100% - 62px),rgba(255,127,80,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,99,71,0.6) 0%,rgba(255,99,71,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(255,99,71,0.7) 0%,rgba(255,99,71,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,87,34,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,69,0,0.8) 0%,rgba(255,127,80,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,140,0,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,165,0,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,69,0,0.75) 0%,rgba(255,127,80,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #7: Deep Purple (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(74,20,140,0.75) 0%,rgba(106,27,154,0.65) calc(100% - 62px),rgba(123,31,162,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(106,27,154,0.6) 0%,rgba(106,27,154,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(106,27,154,0.7) 0%,rgba(106,27,154,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(94,53,177,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(74,20,140,0.8) 0%,rgba(123,31,162,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(142,36,170,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(156,39,176,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(74,20,140,0.75) 0%,rgba(123,31,162,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #8: Teal Turquoise (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,121,107,0.75) 0%,rgba(0,137,123,0.65) calc(100% - 62px),rgba(0,150,136,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,137,123,0.6) 0%,rgba(0,137,123,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(0,137,123,0.7) 0%,rgba(0,137,123,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,137,123,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,121,107,0.8) 0%,rgba(0,150,136,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(38,166,154,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(77,182,172,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,121,107,0.75) 0%,rgba(0,150,136,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #9: Golden Amber (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,143,0,0.75) 0%,rgba(255,160,0,0.65) calc(100% - 62px),rgba(255,179,0,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,160,0,0.6) 0%,rgba(255,160,0,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(255,160,0,0.7) 0%,rgba(255,160,0,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,193,7,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,143,0,0.8) 0%,rgba(255,179,0,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,213,79,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,224,130,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,143,0,0.75) 0%,rgba(255,179,0,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #10: Slate Gray (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(55,71,79,0.75) 0%,rgba(69,90,100,0.65) calc(100% - 62px),rgba(84,110,122,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(69,90,100,0.6) 0%,rgba(69,90,100,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(69,90,100,0.7) 0%,rgba(69,90,100,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(69,90,100,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(55,71,79,0.8) 0%,rgba(84,110,122,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(96,125,139,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(120,144,156,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(55,71,79,0.75) 0%,rgba(84,110,122,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #11: Pastel Rainbow (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(45deg,rgba(255,205,210,0.7),rgba(248,187,208,0.6),rgba(225,190,231,0.6),rgba(209,196,233,0.6),rgba(197,202,233,0.6),rgba(187,222,251,0.6),rgba(179,229,252,0.6),rgba(178,235,242,0.6),rgba(178,223,219,0.6),rgba(200,230,201,0.6),rgba(220,237,200,0.6),rgba(240,244,195,0.6),rgba(255,249,196,0.6),rgba(255,236,179,0.6),rgba(255,224,178,0.6),rgba(255,204,188,0.6))!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,255,255,0.6) 0%,rgba(255,255,255,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#333;text-shadow:none} .bot-message{background:linear-gradient(180deg,rgba(255,255,255,0.7) 0%,rgba(255,255,255,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,255,255,0.7)} .PMPopup h2{background:linear-gradient(45deg,rgba(255,205,210,0.8),rgba(248,187,208,0.7),rgba(225,190,231,0.7))} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,255,255,0.6)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,255,255,0.8)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(45deg,rgba(255,205,210,0.7),rgba(248,187,208,0.6),rgba(225,190,231,0.6),rgba(209,196,233,0.6),rgba(197,202,233,0.6));box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #12: Neon Cyberpunk (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,0,0,0.75) 0%,rgba(26,26,26,0.65) calc(100% - 62px),rgba(51,51,51,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(26,26,26,0.6) 0%,rgba(26,26,26,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#0f0;text-shadow:0 0 5px #0f0,0 0 10px #0f0} .bot-message{background:linear-gradient(180deg,rgba(26,26,26,0.7) 0%,rgba(26,26,26,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(26,26,26,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,0,0,0.8) 0%,rgba(51,51,51,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(0,255,255,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,0,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,0,0,0.75) 0%,rgba(51,51,51,0.65) 100%);box-shadow:0 0 10px rgba(0,255,0,0.5)}"
    ]
  ],
  // Style #13: Sepia Vintage (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(210,180,140,0.75) 0%,rgba(222,184,135,0.65) calc(100% - 62px),rgba(244,164,96,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(222,184,135,0.6) 0%,rgba(222,184,135,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#8b4513;text-shadow:1px 1px 2px #d2b48c} .bot-message{background:linear-gradient(180deg,rgba(222,184,135,0.7) 0%,rgba(222,184,135,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(210,180,140,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(210,180,140,0.8) 0%,rgba(244,164,96,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(205,133,63,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(210,105,30,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(210,180,140,0.75) 0%,rgba(244,164,96,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #14: Inverted Dark (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,255,255,0.75) 0%,rgba(240,240,240,0.65) calc(100% - 62px),rgba(224,224,224,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(240,240,240,0.6) 0%,rgba(240,240,240,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#000;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(240,240,240,0.7) 0%,rgba(240,240,240,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,255,255,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,255,255,0.8) 0%,rgba(224,224,224,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(208,208,208,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(192,192,192,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,255,255,0.75) 0%,rgba(224,224,224,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #15: Ocean Depths (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,0,128,0.75) 0%,rgba(0,0,102,0.65) calc(100% - 62px),rgba(0,0,77,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,0,102,0.6) 0%,rgba(0,0,102,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#87ceeb;text-shadow:0 0 5px #4169e1} .bot-message{background:linear-gradient(180deg,rgba(0,0,102,0.7) 0%,rgba(0,0,102,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,0,128,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,0,128,0.8) 0%,rgba(0,0,77,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(65,105,225,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(30,144,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,0,128,0.75) 0%,rgba(0,0,77,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #16: Cherry Blossom (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,192,203,0.75) 0%,rgba(255,182,193,0.65) calc(100% - 62px),rgba(255,160,122,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,182,193,0.6) 0%,rgba(255,182,193,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#8b4513;text-shadow:1px 1px 2px #ffc0cb} .bot-message{background:linear-gradient(180deg,rgba(255,182,193,0.7) 0%,rgba(255,182,193,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,182,193,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,192,203,0.8) 0%,rgba(255,160,122,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,105,180,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,20,147,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,192,203,0.75) 0%,rgba(255,160,122,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #17: Emerald Forest (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(34,139,34,0.75) 0%,rgba(46,139,87,0.65) calc(100% - 62px),rgba(60,179,113,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(46,139,87,0.6) 0%,rgba(46,139,87,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#f0fff0;text-shadow:1px 1px 2px #006400} .bot-message{background:linear-gradient(180deg,rgba(46,139,87,0.7) 0%,rgba(46,139,87,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(46,139,87,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(34,139,34,0.8) 0%,rgba(60,179,113,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(50,205,50,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(0,250,154,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(34,139,34,0.75) 0%,rgba(60,179,113,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #18: Midnight Blue (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(25,25,112,0.75) 0%,rgba(0,0,128,0.65) calc(100% - 62px),rgba(0,0,139,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,0,128,0.6) 0%,rgba(0,0,128,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#e6e6fa;text-shadow:1px 1px 2px #000} .bot-message{background:linear-gradient(180deg,rgba(0,0,128,0.7) 0%,rgba(0,0,128,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,0,128,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(25,25,112,0.8) 0%,rgba(0,0,139,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(65,105,225,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(100,149,237,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(25,25,112,0.75) 0%,rgba(0,0,139,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #19: Sunset Gradient (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,69,0,0.75) 0%,rgba(255,99,71,0.65) calc(100% - 62px),rgba(255,127,80,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,99,71,0.6) 0%,rgba(255,99,71,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fffaf0;text-shadow:1px 1px 2px #8b0000} .bot-message{background:linear-gradient(180deg,rgba(255,99,71,0.7) 0%,rgba(255,99,71,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,99,71,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,69,0,0.8) 0%,rgba(255,127,80,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,160,122,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(250,128,114,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,69,0,0.75) 0%,rgba(255,127,80,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #20: Lavender Dreams (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(230,230,250,0.75) 0%,rgba(216,191,216,0.65) calc(100% - 62px),rgba(221,160,221,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(216,191,216,0.6) 0%,rgba(216,191,216,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#4b0082;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(216,191,216,0.7) 0%,rgba(216,191,216,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(216,191,216,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(230,230,250,0.8) 0%,rgba(221,160,221,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(147,112,219,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(138,43,226,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(230,230,250,0.75) 0%,rgba(221,160,221,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #21: Monochrome (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,0,0,0.75) 0%,rgba(51,51,51,0.65) calc(100% - 62px),rgba(102,102,102,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(51,51,51,0.6) 0%,rgba(51,51,51,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:1px 1px 2px #000} .bot-message{background:linear-gradient(180deg,rgba(51,51,51,0.7) 0%,rgba(51,51,51,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(51,51,51,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,0,0,0.8) 0%,rgba(102,102,102,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(153,153,153,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(204,204,204,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,0,0,0.75) 0%,rgba(102,102,102,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #22: Aquamarine Breeze (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(127,255,212,0.75) 0%,rgba(72,209,204,0.65) calc(100% - 62px),rgba(0,206,209,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(72,209,204,0.6) 0%,rgba(72,209,204,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#006400;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(72,209,204,0.7) 0%,rgba(72,209,204,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(72,209,204,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(127,255,212,0.8) 0%,rgba(0,206,209,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(32,178,170,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(64,224,208,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(127,255,212,0.75) 0%,rgba(0,206,209,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #23: Autumn Leaves (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(139,69,19,0.75) 0%,rgba(210,105,30,0.65) calc(100% - 62px),rgba(205,133,63,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(210,105,30,0.6) 0%,rgba(210,105,30,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fffaf0;text-shadow:1px 1px 2px #800000} .bot-message{background:linear-gradient(180deg,rgba(210,105,30,0.7) 0%,rgba(210,105,30,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(210,105,30,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(139,69,19,0.8) 0%,rgba(205,133,63,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(222,184,135,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(244,164,96,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(139,69,19,0.75) 0%,rgba(205,133,63,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #24: Neon Lights (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(45deg,rgba(255,0,255,0.75),rgba(0,255,255,0.65),rgba(255,0,255,0.75))!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:0 0 5px #f0f,0 0 10px #0ff} .bot-message{background:linear-gradient(180deg,rgba(0,0,0,0.7) 0%,rgba(0,0,0,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,0,0,0.7)} .PMPopup h2{background:linear-gradient(45deg,rgba(255,0,255,0.8),rgba(0,255,255,0.7))} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,0,255,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(0,255,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(45deg,rgba(255,0,255,0.75),rgba(0,255,255,0.65),rgba(255,0,255,0.75));box-shadow:0 0 10px rgba(255,0,255,0.5)}"
    ]
  ],
  // Style #25: Pastel Clouds (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(240,230,255,0.75) 0%,rgba(230,242,255,0.65) calc(100% - 62px),rgba(255,240,245,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(230,242,255,0.6) 0%,rgba(230,242,255,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#4b0082;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(230,242,255,0.7) 0%,rgba(230,242,255,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(230,242,255,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(240,230,255,0.8) 0%,rgba(255,240,245,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(176,224,230,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(224,255,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(240,230,255,0.75) 0%,rgba(255,240,245,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #26: Rastafarian (Refined and Updated v7)
  [
    [
      "#chat-wrapper{background:linear-gradient(45deg,rgba(255,0,0,0.7) 0%,rgba(255,255,0,0.7) 50%,rgba(0,255,0,0.7) 100%)!important} #cts-chat-content>.message{background:linear-gradient(45deg,rgba(0,0,0,0.3) 0%,rgba(0,0,0,0.5) 100%),linear-gradient(45deg,rgba(255,0,0,0.2) 0%,rgba(255,255,0,0.2) 50%,rgba(0,255,0,0.2) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:1px 1px 2px #000} .bot-message{background:linear-gradient(45deg,rgba(0,0,0,0.4) 0%,rgba(0,0,0,0.6) 100%),linear-gradient(45deg,rgba(255,0,0,0.3) 0%,rgba(255,255,0,0.3) 50%,rgba(0,255,0,0.3) 100%);border-radius:8px;padding:5px} .secondary-message{background:linear-gradient(45deg,rgba(0,0,0,0.2) 0%,rgba(0,0,0,0.4) 100%),linear-gradient(45deg,rgba(255,0,0,0.1) 0%,rgba(255,255,0,0.1) 50%,rgba(0,255,0,0.1) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,255,0,0.8)} .PMPopup h2{background:linear-gradient(45deg,rgba(0,255,0,0.8) 0%,rgba(255,0,0,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:linear-gradient(45deg,rgba(255,0,0,0.7) 0%,rgba(255,0,0,0.7) 100%);transition:background .3s ease} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:linear-gradient(45deg,rgba(255,255,0,0.7) 0%,rgba(255,255,0,0.7) 100%)!important} #videos-footer-broadcast-wrapper.active>#videos-footer-broadcast,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button,#videos-footer-broadcast-wrapper.active>#videos-footer-submenu-button:focus{background:linear-gradient(45deg,rgba(255,0,0,0.8) 0%,rgba(255,0,0,0.8) 100%)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(313deg,rgba(255,0,0,0.7) 0%,rgba(255,255,0,0.7) 50%,rgba(0,255,0,0.7) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #27: Deep Space (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,0,51,0.75) 0%,rgba(0,0,102,0.65) calc(100% - 62px),rgba(0,0,153,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,0,102,0.6) 0%,rgba(0,0,102,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:0 0 5px #0ff,0 0 10px #0ff} .bot-message{background:linear-gradient(180deg,rgba(0,0,102,0.7) 0%,rgba(0,0,102,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,0,102,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,0,51,0.8) 0%,rgba(0,0,153,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(0,0,204,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(0,0,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,0,51,0.75) 0%,rgba(0,0,153,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #28: Strawberry Lemonade (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,179,186,0.75) 0%,rgba(255,223,186,0.65) calc(100% - 62px),rgba(255,255,186,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,223,186,0.6) 0%,rgba(255,223,186,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#8b0000;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(255,223,186,0.7) 0%,rgba(255,223,186,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,223,186,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,179,186,0.8) 0%,rgba(255,255,186,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,105,180,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,20,147,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,179,186,0.75) 0%,rgba(255,255,186,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #29: Zen Garden (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(213,232,212,0.75) 0%,rgba(232,241,216,0.65) calc(100% - 62px),rgba(245,233,220,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(232,241,216,0.6) 0%,rgba(232,241,216,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#2f4f4f;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(232,241,216,0.7) 0%,rgba(232,241,216,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(232,241,216,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(213,232,212,0.8) 0%,rgba(245,233,220,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(143,188,143,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(60,179,113,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(213,232,212,0.75) 0%,rgba(245,233,220,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #30: Midnight Oil (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(44,62,80,0.75) 0%,rgba(52,73,94,0.65) calc(100% - 62px),rgba(58,63,70,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(52,73,94,0.6) 0%,rgba(52,73,94,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#ecf0f1;text-shadow:1px 1px 2px #000} .bot-message{background:linear-gradient(180deg,rgba(52,73,94,0.7) 0%,rgba(52,73,94,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(52,73,94,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(44,62,80,0.8) 0%,rgba(58,63,70,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(41,128,185,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(52,152,219,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(44,62,80,0.75) 0%,rgba(58,63,70,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #31: Arctic Frost (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(224,255,255,0.75) 0%,rgba(240,255,255,0.65) calc(100% - 62px),rgba(255,255,255,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(240,255,255,0.6) 0%,rgba(240,255,255,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#4682b4;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(240,255,255,0.7) 0%,rgba(240,255,255,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(240,255,255,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(224,255,255,0.8) 0%,rgba(255,255,255,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(135,206,250,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(30,144,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(224,255,255,0.75) 0%,rgba(255,255,255,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #32: Volcanic Ash (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(75,75,75,0.75) 0%,rgba(97,97,97,0.65) calc(100% - 62px),rgba(120,120,120,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(97,97,97,0.6) 0%,rgba(97,97,97,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#ff4500;text-shadow:1px 1px 2px #000} .bot-message{background:linear-gradient(180deg,rgba(97,97,97,0.7) 0%,rgba(97,97,97,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(97,97,97,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(75,75,75,0.8) 0%,rgba(120,120,120,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(169,169,169,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(211,211,211,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(75,75,75,0.75) 0%,rgba(120,120,120,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #33: Bubblegum Pop (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,105,180,0.75) 0%,rgba(255,20,147,0.65) calc(100% - 62px),rgba(255,0,255,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,20,147,0.6) 0%,rgba(255,20,147,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:1px 1px 2px #8b008b} .bot-message{background:linear-gradient(180deg,rgba(255,20,147,0.7) 0%,rgba(255,20,147,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,20,147,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,105,180,0.8) 0%,rgba(255,0,255,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,105,180,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,20,147,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,105,180,0.75) 0%,rgba(255,0,255,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #34: Desert Sands (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(244,164,96,0.75) 0%,rgba(210,180,140,0.65) calc(100% - 62px),rgba(222,184,135,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(210,180,140,0.6) 0%,rgba(210,180,140,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#8b4513;text-shadow:1px 1px 2px #ffe4b5} .bot-message{background:linear-gradient(180deg,rgba(210,180,140,0.7) 0%,rgba(210,180,140,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(210,180,140,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(244,164,96,0.8) 0%,rgba(222,184,135,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(205,133,63,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(210,105,30,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(244,164,96,0.75) 0%,rgba(222,184,135,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #35: Neon Jungle (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(45deg,rgba(0,255,0,0.75),rgba(255,0,255,0.65),rgba(0,255,255,0.75))!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:0 0 5px #0f0,0 0 10px #f0f,0 0 15px #0ff} .bot-message{background:linear-gradient(180deg,rgba(0,0,0,0.7) 0%,rgba(0,0,0,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,0,0,0.7)} .PMPopup h2{background:linear-gradient(45deg,rgba(0,255,0,0.8),rgba(255,0,255,0.7),rgba(0,255,255,0.8))} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(0,255,0,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,0,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(45deg,rgba(0,255,0,0.75),rgba(255,0,255,0.65),rgba(0,255,255,0.75));box-shadow:0 0 10px rgba(0,255,0,0.5)}"
    ]
  ],
  // Style #36: Golden Hour (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,143,0,0.75) 0%,rgba(255,160,0,0.65) calc(100% - 62px),rgba(255,179,0,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,165,0,0.6) 0%,rgba(255,165,0,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#8b4513;text-shadow:1px 1px 2px #fffacd} .bot-message{background:linear-gradient(180deg,rgba(255,165,0,0.7) 0%,rgba(255,165,0,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,165,0,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,143,0,0.8) 0%,rgba(255,179,0,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(218,165,32,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(184,134,11,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,143,0,0.75) 0%,rgba(255,179,0,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #37: Moonlit Night (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(25,25,112,0.75) 0%,rgba(0,0,128,0.65) calc(100% - 62px),rgba(65,105,225,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,0,128,0.6) 0%,rgba(0,0,128,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#e6e6fa;text-shadow:0 0 5px #87cefa} .bot-message{background:linear-gradient(180deg,rgba(0,0,128,0.7) 0%,rgba(0,0,128,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,0,128,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(25,25,112,0.8) 0%,rgba(65,105,225,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(65,105,225,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(30,144,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(25,25,112,0.75) 0%,rgba(65,105,225,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #38: Vintage Polaroid (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(240,230,140,0.75) 0%,rgba(222,184,135,0.65) calc(100% - 62px),rgba(210,180,140,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(222,184,135,0.6) 0%,rgba(222,184,135,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#8b4513;text-shadow:1px 1px 2px #fffaf0} .bot-message{background:linear-gradient(180deg,rgba(222,184,135,0.7) 0%,rgba(222,184,135,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(222,184,135,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(240,230,140,0.8) 0%,rgba(210,180,140,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(205,133,63,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(210,105,30,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(240,230,140,0.75) 0%,rgba(210,180,140,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #39: Electric Dreams (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(135deg,rgba(255,0,255,0.75),rgba(0,255,255,0.65),rgba(255,0,255,0.75))!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:0 0 5px #f0f,0 0 10px #0ff} .bot-message{background:linear-gradient(180deg,rgba(0,0,0,0.7) 0%,rgba(0,0,0,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(0,0,0,0.7)} .PMPopup h2{background:linear-gradient(135deg,rgba(255,0,255,0.8),rgba(0,255,255,0.7))} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(138,43,226,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(148,0,211,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(135deg,rgba(255,0,255,0.75),rgba(0,255,255,0.65),rgba(255,0,255,0.75));box-shadow:0 0 10px rgba(255,0,255,0.5)}"
    ]
  ],
  // Style #40: Zen Minimalist (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(245,245,245,0.75) 0%,rgba(255,255,255,0.65) calc(100% - 62px),rgba(240,240,240,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,255,255,0.6) 0%,rgba(255,255,255,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#333;text-shadow:none} .bot-message{background:linear-gradient(180deg,rgba(255,255,255,0.7) 0%,rgba(255,255,255,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,255,255,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(245,245,245,0.8) 0%,rgba(240,240,240,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(224,224,224,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(189,189,189,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(245,245,245,0.75) 0%,rgba(240,240,240,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.1)}"
    ]
  ],
  // Style #41: Cyberpunk City (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,0,0,0.75) 0%,rgba(26,26,26,0.65) calc(100% - 62px),rgba(51,51,51,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(26,26,26,0.6) 0%,rgba(26,26,26,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#0f0;text-shadow:0 0 5px #0f0,0 0 10px #0ff} .bot-message{background:linear-gradient(180deg,rgba(26,26,26,0.7) 0%,rgba(26,26,26,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(26,26,26,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,0,0,0.8) 0%,rgba(51,51,51,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,0,255,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(0,255,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,0,0,0.75) 0%,rgba(51,51,51,0.65) 100%);box-shadow:0 0 10px rgba(0,255,0,0.5)}"
    ]
  ],
  // Style #42: Ethereal Mist (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(230,230,250,0.75) 0%,rgba(240,248,255,0.65) calc(100% - 62px),rgba(248,248,255,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(240,248,255,0.6) 0%,rgba(240,248,255,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#4b0082;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(240,248,255,0.7) 0%,rgba(240,248,255,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(240,248,255,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(230,230,250,0.8) 0%,rgba(248,248,255,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(176,196,222,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(135,206,250,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(230,230,250,0.75) 0%,rgba(248,248,255,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #43: Tropical Paradise (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,206,209,0.75) 0%,rgba(64,224,208,0.65) calc(100% - 62px),rgba(72,209,204,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(64,224,208,0.6) 0%,rgba(64,224,208,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#006400;text-shadow:1px 1px 2px #f0fff0} .bot-message{background:linear-gradient(180deg,rgba(64,224,208,0.7) 0%,rgba(64,224,208,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(64,224,208,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,206,209,0.8) 0%,rgba(72,209,204,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(32,178,170,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(0,139,139,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,206,209,0.75) 0%,rgba(72,209,204,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #44: Retro Arcade (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,0,0,0.75) 0%,rgba(28,28,28,0.65) calc(100% - 62px),rgba(56,56,56,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(28,28,28,0.6) 0%,rgba(28,28,28,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#39ff14;text-shadow:0 0 5px #39ff14,0 0 10px #39ff14} .bot-message{background:linear-gradient(180deg,rgba(28,28,28,0.7) 0%,rgba(28,28,28,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(28,28,28,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,0,0,0.8) 0%,rgba(56,56,56,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,0,255,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(0,255,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,0,0,0.75) 0%,rgba(56,56,56,0.65) 100%);box-shadow:0 0 10px rgba(57,255,20,0.5)}"
    ]
  ],
  // Style #45: Soft Pink (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,182,193,0.6) 0%,rgba(255,105,180,0.5) calc(100% - 62px),rgba(255,20,147,0.4) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,105,180,0.5) 0%,rgba(255,105,180,0.7) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(255,105,180,0.6) 0%,rgba(255,105,180,0.8) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,182,193,0.6)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,105,180,0.6) 0%,rgba(255,20,147,0.5) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,105,180,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,20,147,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,105,180,0.6) 0%,rgba(255,20,147,0.5) 100%);box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #46: Light Blue and Black Gradient (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(83,182,239,0.75) 0%,rgba(83,182,239,0.55) calc(100% - 62px),rgba(83,182,239,0.75) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(0,0,0,0.5) 0%,rgba(0,0,0,0.7) 100%);border-radius:8px;padding:5px;margin-bottom:5px} .message,.bot-message{color:#fff;text-shadow:-1px 0 #000,0 1px #000,1px 0 #000,0 -1px #000} .bot-message{background:linear-gradient(180deg,rgba(83,182,239,0.65) 0%,rgba(83,182,239,0.85) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(83,182,239,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(70,160,220,0.7) 0%,rgba(83,182,239,0.5) 50%,rgba(135,206,250,0.6) 100%)} #videos-footer-broadcast-wrapper>.waiting{background:rgba(83,182,239,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:rgba(83,182,239,0.7)!important} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:rgba(70,160,220,0.7)!important} #videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(83,182,239,0.7)} #videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(70,160,220,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(70,160,220,0.7) 0%,rgba(83,182,239,0.5) 50%,rgba(135,206,250,0.4) 100%);box-shadow:0 0 10px rgba(0,0,0,0.3)}"
    ]
  ],
  // Style #47: Winter Wonderland (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(240,248,255,0.75) 0%,rgba(230,242,255,0.65) calc(100% - 62px),rgba(240,255,255,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(230,242,255,0.6) 0%,rgba(230,242,255,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#4682b4;text-shadow:1px 1px 2px #fff} .bot-message{background:linear-gradient(180deg,rgba(230,242,255,0.7) 0%,rgba(230,242,255,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(230,242,255,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(240,248,255,0.8) 0%,rgba(240,255,255,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(176,224,230,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(135,206,235,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(240,248,255,0.75) 0%,rgba(240,255,255,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.2)}"
    ]
  ],
  // Style #48: Galactic Explorer (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(0,0,51,0.75) 0%,rgba(25,25,112,0.65) calc(100% - 62px),rgba(65,105,225,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(25,25,112,0.6) 0%,rgba(25,25,112,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#e6e6fa;text-shadow:0 0 5px #4169e1,0 0 10px #1e90ff} .bot-message{background:linear-gradient(180deg,rgba(25,25,112,0.7) 0%,rgba(25,25,112,0.9) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(25,25,112,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(0,0,51,0.8) 0%,rgba(65,105,225,0.7) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(65,105,225,0.7)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(30,144,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(0,0,51,0.75) 0%,rgba(65,105,225,0.65) 100%);box-shadow:0 0 10px rgba(0,0,0,0.5)}"
    ]
  ],
  // Style #49: Enchanted Forest (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(34,139,34,0.75) 0%,rgba(46,139,87,0.65) calc(100% - 62px),rgba(60,179,113,0.55) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(46,139,87,0.6) 0%,rgba(46,139,87,0.8) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#f0fff0;text-shadow:1px 1px 2px #006400} .bot-message{background:linear-gradient(180deg,rgba(46,139,87,0.7) 0%,rgba(46,139,87,0.9) 100%);border-radius:8px;padding:5px}"
    ],
  ...
  // Style #50: Crystal Clear (Optimized and Updated)
  [
    [
      "#chat-wrapper{background:linear-gradient(0deg,rgba(255,255,255,0.4) 0%,rgba(255,255,255,0.3) calc(100% - 62px),rgba(255,255,255,0.2) 100%)!important} #cts-chat-content>.message{background:linear-gradient(180deg,rgba(255,255,255,0.5) 0%,rgba(255,255,255,0.7) 100%);border-radius:8px;padding:5px;margin-bottom:5px;color:#000;text-shadow:1px 1px 2px rgba(255,255,255,0.5)} .bot-message{background:linear-gradient(180deg,rgba(255,255,255,0.6) 0%,rgba(255,255,255,0.8) 100%);border-radius:8px;padding:5px}"
    ],
    [
      ".PMPopup .PMContent{background:rgba(255,255,255,0.7)} .PMPopup h2{background:linear-gradient(0deg,rgba(255,255,255,0.6) 0%,rgba(255,255,255,0.8) 100%)} #videos-footer-broadcast-wrapper>.waiting,#videos-footer-broadcast-wrapper>#videos-footer-submenu-button,#videos-footer-push-to-talk,#videos-footer-broadcast{background:rgba(255,255,255,0.5)} #videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover,#videos-footer-push-to-talk:hover,#videos-footer-broadcast:hover{background:rgba(255,255,255,0.7)!important}"
    ],
    [
      "#sidemenu{background:linear-gradient(0deg,rgba(255,255,255,0.5) 0%,rgba(255,255,255,0.3) 100%);box-shadow:0 0 10px rgba(0,0,0,0.1)}"
    ]
  ]
];
 //INSERT SCRIPT
      ...
      CTS.enablePMs =
        window.TinychatApp.BLL.SettingsFeature.prototype.getSettings().enablePMs; //TTS (TEXT-TO-SPEECH)
      if (
      ...
      VideoListElement.querySelector("#videolist").insertAdjacentHTML(
        ...
        '<div class="ctsdrop"><button class="ctsoptions" title="CTS Options">🔧</button><div class="ctsdrop-content"><div style="height:6px;background:#624482;"></div><button id="BackgroundUpdateRight" class="ctsoptions" title="Background">➖</button><button id="BackgroundUpdateLeft" class="ctsoptions" title="Background">➕</button><div style="height:6px;background:#624482;"></div><button id="FontSizeUpdate" class="ctsoptions" title="Font Size">🔍</button><button id="ChatCompact" class="ctsoptions" title="Compact Chat">💬</button><div style="height:6px;background:#624482;"></div>' +
          (!CTS.ThemeChange
            ...
            : "") +
          '<button id="ChatColor" class="ctsoptions" title="Chat Style">🔨</button><button id="CameraBorderToggled" class="ctsoptions" title="Camera Border">📷</button><button id="FeaturedToggled" class="ctsoptions" title="Featured Resize">📺</button><button id="PerformanceModeToggled" class="ctsoptions" title="Chat Only">📝</button>' +
          (!CTS.Project.isTouchScreen
            ? '<div style="height:6px;background:#624482;"></div><button id="ThemeChange" class="ctsoptions" title="Switch Layout">🔄</button><button id="ReloadSoundMeter" class="ctsoptions" title="Reload Sound Meter">🔊</button></div></div>'
            : "")
      );
                  ...
                  for (var c = 0; c < len; c++) {
                    ...
                    if (g[c].kind === "audioinput") {
                      ...
                      if (
                        ...
                        e.audio = { deviceId: { exact: d.audio.deviceId } };
                    }
                  }
                  if (
                    e.video !== null &&
      ...
      window.fullscreenManager.status = function () {
        ...
        if (
          ...
          CTS.isFullScreen =
            document.fullScreen ||
            document.mozFullScreen ||
            document.webkitIsFullScreen; // Fix FullScreen
    ...
    function CTSRoomLoad() {
      ...
      VideoListElement.querySelector(
        ...
        function () {
          ...
          VideoListElement.querySelector("#cts-vol-control").value =
            window.CTSMuted ? 0.1 : window.CTSRoomVolume * 100; // un/Mute Radio
      ...
      VideoListElement.querySelector("#ReloadSoundMeter").addEventListener(
        "click",
        function () {
          ReloadSoundMeter();
        },
        ...
        function (event) {
          ...
          if (CTS.Room.PTT === false)
            VideoListElement.querySelector("#videos-header-mic").style.display =
              arg; //VideoListElement.querySelector("#videos-header-snapshot").style.display = arg;
          VideoListElement.querySelector(
      ...
      }).observe(MainElement.querySelector("#modal"), { childList: true });
      new MutationObserver(function () {
        LoadMessage();
            ...
            if (
              ...
              if (CTS.Game.Trivia.Correct === arguments[1].toUpperCase()) {
                ...
                if (CTS.Game.Trivia.Attempts == 3) {
                  Send(
                    "msg",
                    "[👩‍🏫TRIVIA]\nNo one got it! Next round starts in 60 sec. Answer: " +
      ...
      if (CTS.UserList[arguments[0]].mod) {
        ...
        if (arguments[1].match(/^!bot$/i)) {
          ...
          if (CTS.Me.handle == arguments[2].handle && CTS.Room.YT_ON)
            YouTubePlayList(); //ELSE KEEP ON UNLESS HOSTWAITING (!WHOISBOT)
    ...
    function GamePrevention() {
      if (
        !CTS.CanSeeGames &&
        arguments[1] &&
        arguments[0].match(/^\[(DRUG EMPIRE|TRIVIA)\]/)
      )
        return false;
      return true;
    }
      ...
      SideMenuElement.querySelector("#sidemenu").style.cssText =
        !CTS.UserListDisplay
          ...
          : "min-width:400px;width:calc(400px + " +
            ...
            "%)!important;height:" +
            CTS.ChatHeight +
            "%!important;"; //UserListElement.querySelector("#button-banlist").style.cssText = "top:calc(" + CTS.ChatHeight + "% + 89px);";
      ...
      SideMenuElement.querySelector("#sidemenu").style.cssText =
        !CTS.ChatDisplay || !CTS.UserListDisplay
          ...
          : "min-width:400px;width:calc(400px + " +
            ...
            "%)!important;height:" +
            CTS.ChatHeight +
            "%!important;"; //UserListElement.querySelector("#button-banlist").style.cssText = (!CTS.ChatDisplay) ? "display:none" : "top:calc(" + CTS.ChatHeight + "% + 89px);";
      document.querySelector("#content").style.cssText =
        "width:calc(100% " +
        (CTS.ChatDisplay ? "- (400px + " + CTS.ChatWidth + "%)" : "") +
        ")";
    ...
    function Cameras() {
      ...
      for (var num = 0; num < Len; num++) {
        ...
        select.querySelector(".video").insertAdjacentHTML(
          "afterbegin",
          `
<style id="fixed">
  .video {
    ...
    function AddUserNotification() {
      if (CTS.FullLoad && CTS.ShowedSettings) {
        ...
        if (arguments[0] == 1) {
          ...
          UpdateScroll(2, true);
        } // Exclude name change notification from being sent to the chat
        if (
          arguments[0] != 3 &&
          arguments[0] != 4 &&
          CTS.NotificationToggle == 0
        ...
        if (CTS.NotificationToggle == 1) {
          Alert(0, Notification, arguments[2]);
        }
        if (
    ...
    function CTSWebSocket() {
        ...
        set: function set(Target, prop, value) {
          if (prop == "onmessage") {
            ...
            value = function value(event) {
              ServerMsg(JSON.parse(event.data), Target); // Avoid invoking the oldMessage handler if it's already been called.
              if (!event._handled) {
                oldMessage(event);
                event._handled = true; // Mark the event as handled.
              }
            };
          }
      ...
      var WebSocketProxy = new window.Proxy(window.WebSocket, {
        construct: function construct(Target, args) {
          ...
          debug("SOCKET::CONNECTING", args[0]); // Add new event handlers
          CTS.SocketTarget.onopen = function () {
            console.log("WebSocket connected");
            processMessageQueue(); // Process any queued messages
          };
          CTS.SocketTarget.onclose = function () {
    ...
    var CommandList = {
      ...
      drughost: function drughost() {
        ...
        Send(
          "msg",
          "✓ Command Accepted!\n" +
            (CTS.CanHostDrugGames
              ? "DRUG EMPIRE GAME HOSTING IS NOW ON!"
              : "DRUG EMPIRE GAME HOSTING IS NOW OFF!")
        );
        console.log(
          "DrugHost toggled. CanHostDrugGames:",
          CTS.CanHostDrugGames
        );
      },
...
var MessageQueueList = {
  add: function add(message) {
    ...
    Send(parsedMessage.tc, parsedMessage.text, parsedMessage.handle);
  },
  run: function run() {
    // This function is no longer needed, but keep it to prevent errors
    console.log("MessageQueueList.run is deprecated");
  }
};
var ServerSendList = {
  msg: function msg() {
    var obj = { tc: arguments[0] };
    if (arguments[2] !== undefined) {
      obj.handle = arguments[1];
      obj.text = arguments[2];
  ...
  pvtmsg: function pvtmsg() {
    ...
    MessageQueueList.add(JSON.stringify(obj));
      ...
      nick: function nick() {
        var obj = { tc: "nick", nick: arguments[1] };
...
// Debounced version of DrugCommandCheck
const debouncedDrugCommandCheck = debounce(DrugCommandCheck, 100); // 100ms delay
  ...
  joined: function joined() {
    ...
    CTS.SocketConnected = true;
      ...
      nick: function nick() {
        ...
        if (user != -1) {
          // Exclude name change notification from being sent to the chat
          if (CTS.UserList[user].username != arguments[0].nick) {
        ...
        if (CTS.ScriptInit) {
          ...
          if (user != -1) {
            if (
              ...
              Drug.GetPlayer(arguments[0].handle, true, false)
            )
              Send(
                "msg",
                "🚨 " +
                  CTS.Game.Drug.UserQuitLast +
                  " has gone off the grid. 🏃💨 Better lay low for a while. 🕵️"
              ); //SEND THEM OUT
            AddUserNotification(
              2,
              CTS.UserList[user].namecolor,
...
msg: function msg() {
  if (CTS.ScriptInit) {
    ...
    if (user != -1) {
      if (!LineSpam(arguments[0].text, CTS.UserList[user].mod)) {
        if (GamePrevention(arguments[0].text, CTS.UserList[user].mod)) {
          ...
          // Check for drug game commands
          if (text.startsWith('!drug')) {
            // Use debounce to prevent multiple rapid executions
            debouncedDrugCommandCheck(user, text);
          } //ALL USERS REPORT
                ...
                if (CTS.CanHostDrugGames)
                  DrugCommandCheck(user, arguments[0].text); // * change *
                if (CTS.HideCaps) {
                  if (capsCheck(text)) {
    ...
    var Drug = {
      ...
      Init: function () {
        console.log(
          "Drug.Init called. CanHostDrugGames:",
          CTS.CanHostDrugGames,
          "Host:",
          CTS.Host,
          "Me.handle:",
        ...
        if (
          CTS.Me.handle == CTS.Host &&
          CTS.CanHostDrugGames === true &&
          !CTS.Game.Drug.GameStarted
        ) {
          CTS.Game.Drug.GameStarted = true;
          this.currentCycle++;
          Send(
            "msg",
            "[🏙️ DRUG EMPIRE] 💊\n" +
          ...
          this.SetHeat();
          CTS.Game.Drug.StartTimeout = setTimeout(
            function (g) {
              g.StartRound();
            },
            5000,
          ...
          console.log(
            "Cannot initialize game. CanHostDrugGames:",
            CTS.CanHostDrugGames,
            "Host:",
            CTS.Host,
            "Me.handle:",
      ...
      FormatRoundOverview: function () {
        let msg = `[💊 DRUG EMPIRE] Round ${CTS.Game.Drug.Round}\n`;
        msg += `🌡️ Heat: ${this.GetHeatEmoji()} | `; // Add random event info here
        let randomEvent = this.TriggerRandomEvent();
        if (randomEvent) {
          msg += `📣 ${randomEvent.message}\n`;
        } else {
          msg += "\n";
        }
      ...
      AddPlayer: function AddPlayer(handle, username, nickname) {
        console.log("AddPlayer called:", handle, username, nickname); // Check if the player is already in the game
        if (this.GetPlayer(handle, false, false)) {
          console.log("Player already in game:", nickname);
          return false;
        } // Add player only if the game can host drug games
        if (CTS.CanHostDrugGames === true) {
          if (isSafeListed(username)) {
            CTS.Game.Drug.Player.push({
              ...
              Skills: { negotiation: 1, stealth: 1, chemistry: 1 },
              Inventory: { drugs: 0, cash: 7500 },
              Reputation: 0
            });
            console.log("Player added to game:", nickname); // Only start the game once
            if (!CTS.Game.Drug.GameStarted) {
              CTS.Game.Drug.GameStarted = true;
              this.StartRound();
            } else {
              Send(
                "",
                `🏙️ DRUG EMPIRE 💊 ${nickname}... has entered the drug game! 💼💊 Type !drug help 📜 for commands!`
              );
            }
            return true;
          } else {
            console.log("Player not safelisted:", nickname);
            Send(
              "msg",
              "[💊 DRUG EMPIRE] " +
                nickname +
                " is not allowed to join the game."
            );
            return false;
          }
        } else {
          console.log("Drug games not enabled");
          Send("msg", "[💊 DRUG EMPIRE] The drug game is currently disabled.");
          return false;
        }
      },
      StartRound: function () {
        if (CTS.Host === CTS.Me.handle && !CTS.Game.Drug.RoundInProgress) {
          console.log("Starting new round...");
          CTS.Game.Drug.RoundInProgress = true;
          if (this.GetPlayer() >= 0) {
            console.log("Players found. Checking round count...");
            if (CTS.Game.Drug.Round < this.roundsPerCycle) {
              CTS.Game.Drug.Round++;
              this.HotDrugs = [];
              this.LowDrugs = [];
              ...
              for (
                let i = 0;
                i < Math.min(3, CTS.Game.Drug.Player.length);
                i++
              ) {
                let player = CTS.Game.Drug.Player[i];
                let drugDeal = this.SimulateDrugDeal(player);
                let balanceUpdate = this.updateBalance(player, drugDeal.profit);
                msg += this.FormatPlayerInfo(player, drugDeal, balanceUpdate);
                this.CheckAchievements(player);
                this.AddExperience(player, drugDeal.profit);
              }
              msg += this.FormatRoundSummary();
              setTimeout(() => {
                Send("msg", msg);
                CTS.Game.Drug.ReCastTimeout = setTimeout(() => {
                  CTS.Game.Drug.RoundInProgress = false;
                  this.StartRound();
                }, Math.max(240000, 2000 * CTS.Game.Drug.Player.length));
              }, 2000);
            } else {
              this.EndCycle();
            }
          ...
          console.log("We are not the host or a round is already in progress.");
        }
      },
      EndCycle: function () {
        this.UpdateTopPlayers();
        this.Winner();
        this.UpgradePlayersAfterCycle();
        CTS.Game.Drug.Round = 0;
        CTS.Game.Drug.RoundInProgress = false;
        setTimeout(() => this.Init(), 30000); // Start next cycle after 30 seconds
      },
      UpgradePlayersAfterCycle: function () {
        CTS.Game.Drug.Player.forEach((player) => {
          player.Level += 1;
          player.Skills.negotiation += 1;
          player.Skills.stealth += 1;
          player.Skills.chemistry += 1; // Add more upgrades as needed
        });
        Send(
          "msg",
          "[💊 DRUG EMPIRE] Cycle ended! All players have been upgraded. Next cycle starts in 30 seconds!"
        );
      },
      UpdateTopPlayers: function () {
        this.topPlayers = CTS.Game.Drug.Player.sort(
          (a, b) => b.Money - a.Money
        ).slice(0, 5);
        if (this.topPlayers[0].Money > this.highestScore) {
          this.highestScore = this.topPlayers[0].Money;
          Send(
            "msg",
            `[💊 DRUG EMPIRE] New highest score! ${
              this.topPlayers[0].Nickname
            } has set a new record of $${this.FormatMoney(this.highestScore)}!`
          );
        }
      },
      GetPlayer: function GetPlayer(handle, remove, returnPlayer) {
        console.log("GetPlayer called with:", handle, remove, returnPlayer);
        var players = CTS.Game.Drug.Player;
        var len = players.length; // If no handle is provided, return the number of players
        if (handle === undefined) {
          return len - 1;
        ...
        for (var i = 0; i < len; i++) {
          if (players[i].Handle === handle) {
            ...
            if (remove) {
              CTS.Game.Drug.UserQuitLast = players[i].Nickname;
              players.splice(i, 1);
            }
            return true;
          }
        } // Player not found
        return returnPlayer ? -1 : false;
      }, // Function to update player's balance
      updateBalance: function (player, income) {
        let previousBalance = player.Money;
        let expenses = Math.floor(player.Money * 0.05); // 5% expenses
        player.Money = Math.max(
          0,
          Math.round((previousBalance + income - expenses) * 100) / 100
        );
        return {
      ...
      DetectRareDrugs: function (drug) {
        const baseRareChance = 0.1; // 10% base chance to detect a rare drug
        const valueMultiplier = 0.0005; // Increase chance based on drug value
        const rareChance = baseRareChance + drug[1] * valueMultiplier;
        if (Math.random() < rareChance) {
          const rareDrug =
            this.RareDrugs[Math.floor(Math.random() * this.RareDrugs.length)];
          console.log(
            `Rare drug detected: ${rareDrug.name} with value ${rareDrug.value}`
          );
          return rareDrug;
        }
        return null;
      ...
      RareDrugs: [
        { name: "Carfentanil", value: 69, multiplier: 2.0, emoji: "💉" },
        { name: "Bromo-DragonFLY", value: 69, multiplier: 2.0, emoji: "🌐" },
        {
          name: "25x-NBOMe Compounds",
          value: 70,
          multiplier: 2.1,
          emoji: "🌃"
        },
        { name: "DOx Series", value: 70, multiplier: 2.1, emoji: "🌌" },
        { name: "Tapentadol", value: 101, multiplier: 3.0, emoji: "🌟" },
        { name: "Etizolam", value: 101, multiplier: 3.0, emoji: "🔬" },
        { name: "ALD-52", value: 102, multiplier: 3.1, emoji: "🌈" },
        { name: "AL-LAD", value: 102, multiplier: 3.1, emoji: "🌃" },
        { name: "1P-LSD", value: 103, multiplier: 3.2, emoji: "🌠" },
        { name: "Diclazepam", value: 103, multiplier: 3.2, emoji: "🌙" },
        { name: "3-MeO-PCP", value: 104, multiplier: 3.3, emoji: "🌍" },
        { name: "DPT", value: 104, multiplier: 3.3, emoji: "🌌" },
        { name: "5-MeO-MIPT", value: 105, multiplier: 3.4, emoji: "🌌" },
        { name: "4-HO-MET", value: 105, multiplier: 3.4, emoji: "🌌" },
        {
          name: "DMT-Containing Snuffs",
          value: 106,
          multiplier: 3.5,
          emoji: "🌌"
        },
        { name: "Kratom Extracts", value: 106, multiplier: 3.5, emoji: "🌿" },
        {
          name: "Pharmaceutical Fentanyl",
          value: 107,
          multiplier: 3.6,
          emoji: "💊"
        },
        {
          name: "Research Chemical Psychedelics",
          value: 107,
          multiplier: 3.6,
          emoji: "🧪"
        },
        { name: "1B-LSD", value: 108, multiplier: 3.7, emoji: "🧬" },
        { name: "ETH-LAD", value: 108, multiplier: 3.7, emoji: "🧠" },
        { name: "PRO-LAD", value: 109, multiplier: 3.8, emoji: "🔬" },
        { name: "LSZ", value: 109, multiplier: 3.8, emoji: "🌈" },
        { name: "LSM-775", value: 110, multiplier: 3.9, emoji: "💎" },
        { name: "LSD-A", value: 110, multiplier: 3.9, emoji: "🌟" },
        { name: "LSD-B", value: 111, multiplier: 4.0, emoji: "🌠" },
        {
          name: "4-AcO-DMT Analogues",
          value: 111,
          multiplier: 4.0,
          emoji: "🍄"
        },
        {
          name: "4-HO-MET Analogues",
          value: 112,
          multiplier: 4.1,
          emoji: "🧬"
        },
        {
          name: "4-PO-DMT Analogues",
          value: 112,
          multiplier: 4.1,
          emoji: "🧪"
        },
        {
          name: "5-MeO-DMT Analogues",
          value: 113,
          multiplier: 4.2,
          emoji: "🌌"
        },
        { name: "MiPT Analogues", value: 113, multiplier: 4.2, emoji: "🧠" },
        { name: "DiPT Analogues", value: 114, multiplier: 4.3, emoji: "🔬" },
        { name: "MET Analogues", value: 114, multiplier: 4.3, emoji: "💊" },
        { name: "DPT Analogues", value: 115, multiplier: 4.4, emoji: "🌈" },
        {
          name: "5-MeO-MiPT Analogues",
          value: 115,
          multiplier: 4.4,
          emoji: "🌠"
        },
        { name: "LSD Analogues", value: 116, multiplier: 4.5, emoji: "💎" },
        {
          name: "Ergometrine Analogues",
          value: 116,
          multiplier: 4.5,
          emoji: "🧬"
        },
        {
          name: "Diethylamide Analogues",
          value: 117,
          multiplier: 4.6,
          emoji: "🧪"
        },
        {
          name: "Methylergonovine Analogues",
          value: 117,
          multiplier: 4.6,
          emoji: "💉"
        },
        {
          name: "Ergoline Derivatives",
          value: 118,
          multiplier: 4.7,
          emoji: "🧠"
        },
        {
          name: "Isolysergic Acid Analogues",
          value: 118,
          multiplier: 4.7,
          emoji: "🔬"
        }
      ...
      SimulateDrugDeal: function (player) {
        ...
        let adjustedValue = Math.max(baseValue + variation, 1); // Check for rare drugs
        let rareDrug = this.DetectRareDrugs(drug);
        let isRare = false;
        if (rareDrug) {
          drug = [rareDrug.name, rareDrug.value, true, rareDrug.emoji];
          adjustedValue = rareDrug.value * rareDrug.multiplier;
          isRare = true;
        } // Calculate profit based on player's skills and upgrades
        let profit = Math.floor(
          adjustedValue *
            100 *
            (1 + player.Upgrades.Territory * 0.1) *
            (1 + player.Upgrades.Product * 0.05) *
            (1 + player.Skills.negotiation * 0.05) *
            (1 + player.Skills.chemistry * 0.05) // Added chemistry skill impact
        ); // Apply heat multiplier
        profit = Math.floor(profit * this.GetHeatMultiplier()); // Update hot and low drugs
      ...
      FormatRoundSummary: function () {
        ...
        let topPlayers = CTS.Game.Drug.Player.slice(0, 3);
        let achievements = this.GetNewAchievements();
        let summary = "Market Status\n";
        summary += `🔥 HOT: ${hotDrugs}\n`;
        summary += `📉 LOW: ${lowDrugs}\n\n`;
        summary += `🏆 Top 3 Dealers: ${topPlayers
          .map((player, index) => `${index + 1}. ${player.Nickname}`)
          .join(", ")}\n`;
        summary += `🏆 Top Daily Dealer: ${
          topPlayers[0].Nickname
        } 💰 $${this.FormatMoney(topPlayers[0].Money)}\n\n`;
      ...
      FormatPlayerInfo: function (player, drugDeal, balanceUpdate) {
        let msg = `${player.Nickname} | $${this.FormatMoney(
          balanceUpdate.previousBalance
        )} + $${this.FormatMoney(drugDeal.profit)} - $${this.FormatMoney(
          balanceUpdate.expenses
        )} | $${this.FormatMoney(player.Money)}\n`;
        msg += `🏆 ${player.Level} 🕵️ ${player.Skills.stealth} 💼 ${player.Skills.negotiation} 🧪 ${player.Skills.chemistry} 🤝 ${player.Upgrades.Connections} 🌆 ${player.Upgrades.Territory}\n`;
        if (drugDeal.isRare) {
          msg += `Rare Drug: ${drugDeal.name} | Value: ${
            drugDeal.value
          } | Profit: $${this.FormatMoney(drugDeal.profit)} ${
            drugDeal.emoji
          }\n`;
        } else {
          msg += `${drugDeal.description} +${drugDeal.value} ${drugDeal.emoji}\n`;
        }
        msg += "\n";
        return msg;
      },
      ...
      FormatDrugMarket: function (hotDrugs, lowDrugs) {
        ...
        hotDrugs
          .slice(0, 2)
          .forEach((drug) => (msg += `${drug.emoji}(${drug.value}) `));
        msg += "📉 LOW: ";
        lowDrugs
          .slice(0, 2)
          .forEach((drug) => (msg += `${drug.emoji}(${drug.value}) `));
      ...
      FormatTopPlayers: function () {
        return (
          "🏅 TOP 5: " +
          CTS.Game.Drug.Player.slice(0, 5)
            .map((p) => p.Nickname.substr(0, 5))
            .join(", ") +
          "\n"
        );
      },
      GetAchievementName: function (level) {
        ...
        return achievements[
          Math.min(level - 1, achievements.length - 1)
        ].substr(0, 8);
      },
      GetHotDrugs: function () {
        this.HotDrugs.sort((a, b) => b[1] - a[1]);
        return this.HotDrugs.length > 0
          ? this.HotDrugs[0][0].split(" ")[0] + "(" + this.HotDrugs[0][1] + ")"
          : "";
      },
      GetLowDrugs: function () {
        this.LowDrugs.sort((a, b) => a[1] - b[1]);
        return this.LowDrugs.slice(0, 1)
          .map((drug) => `${drug[0].split(" ")[0]} (${drug[1]})`)
          .join("|");
      },
      GetNewAchievements: function () {
        let achievements = this.NewAchievements.map(
          (a) => `🎖 ${a.achievement}: ${a.player}`
        ).join("\n");
      ...
      SetHeat: function () {
        ...
        CTS.Game.Drug.Heat =
          heatLevels[Math.floor(Math.random() * heatLevels.length)];
        console.log("Heat set to: " + CTS.Game.Drug.Heat);
      },
        ...
        var events = [
          {
            ...
            impact: function impact() {
              CTS.Game.Drug.Player.forEach(
                (p) =>
                  (p.Inventory.drugs = Math.max(
                    p.Inventory.drugs - Math.floor(p.Inventory.drugs * 0.05),
                    0
                  ))
          ...
          {
            message:
              "New competitor: A rival gang is muscling in on your territory!",
            impact: function impact() {
          ...
          },
          {
            ...
            impact: function impact() {
              CTS.Game.Drug.Player.forEach(
                (p) => (p.Skills.stealth = Math.max(p.Skills.stealth - 0.5, 0))
          ...
          },
          {
            ...
            impact: function impact() {
              CTS.Game.Drug.Player.forEach((p) => {
                p.Inventory.drugs = Math.max(
                  p.Inventory.drugs - Math.floor(p.Inventory.drugs * 0.1),
                  0
          ...
          {
            message:
              "Drug breakthrough: Your chemist created a super-potent batch!",
            impact: function impact() {
              CTS.Game.Drug.Player.forEach((p) => {
          ...
          },
          {
            ...
            impact: function impact() {
              ...
              CTS.Game.Drug.Player.forEach(
                (p) =>
                  (p.Inventory.drugs = Math.floor(
                    p.Inventory.drugs * multiplier
                  ))
              );
            }
          }
      ...
      AddExperience: function (player, value) {
      ...
      CheckAchievements: function (player, type, value) {
        ...
        achievements.forEach((achievement) => {
          if (
            !player.Achievements.includes(achievement.name) &&
      ...
      AnnounceAchievement: function AnnounceAchievement(
        player,
        achievementMessage
      ) {
        Send(
      ...
      CheckUpgradeAchievements: function CheckUpgradeAchievements(player) {
        ...
        for (var i = 5; i <= 10; i++) {
          if (
            !player.Achievements.includes("Product Level " + i) &&
            player.Upgrades.Product >= i
          ) {
        ...
        for (var j = 5; j <= 20; j++) {
          if (
            !player.Achievements.includes("Connections Level " + j) &&
            player.Upgrades.Connections >= j
          ) {
        ...
        for (var k = 5; k <= 6; k++) {
          if (
            !player.Achievements.includes("Territory Level " + k) &&
            player.Upgrades.Territory >= k
          ) {
      ...
      Winner: function Winner() {
        ...
        setTimeout(() => {
          Send(
            "msg",
            "🏆 DRUG EMPIRE HIGH SCORE 🏆\n👑 ALL-TIME HIGH SCORE 👑:\n" +
              CTS.Game.Drug.HighScore[0] +
              " : 💰$" +
              this.FormatMoney(CTS.Game.Drug.HighScore[1]) +
              "\n\n🥇 ROUND WINNER 🥇:\n" +
              CTS.Game.Drug.Player[len].Nickname +
              " : 💰$" +
              this.FormatMoney(CTS.Game.Drug.Player[len].Money) +
      ...
      Ranking: function Ranking() {
        ...
        for (var u = arguments[0]; u >= 0; u--) {
          ...
          if (u < 5) {
            msg += `${place}. ${
              CTS.Game.Drug.Player[u].Nickname
            } [💰$${this.FormatMoney(CTS.Game.Drug.Player[u].Money)} - 🎖️Lvl ${
              CTS.Game.Drug.Player[u].Level
            }]\n`;
          }
      ...
      price: function (player) {
        if (player !== -1 && DrugTimerCheck(player)) {
          var msg = "[💊 DRUG EMPIRE] PRICE LIST\n";
          msg += "Product Quality:\n";
          msg += "  Current Level: " + player.Upgrades.Product + "\n";
          msg +=
            "  Next Upgrade: $" +
            Drug.FormatMoney(Drug.PriceList(player, 0)) +
            "\n\n";
          msg += "Connections:\n";
          msg += "  Current Level: " + player.Upgrades.Connections + "\n";
          msg +=
            "  Next Upgrade: $" +
            Drug.FormatMoney(Drug.PriceList(player, 1)) +
            "\n\n";
          msg += "Territory:\n";
          msg += "  Current Level: " + player.Upgrades.Territory + "\n";
          msg +=
            "  Next Upgrade: $" +
            Drug.FormatMoney(Drug.PriceList(player, 2)) +
            "\n\n";
          msg += "Protection:\n";
          msg +=
            "  Current Status: " +
            (player.Upgrades.Protection ? "Active" : "Inactive") +
            "\n";
          msg +=
            "  Activation Cost: $" +
            Drug.FormatMoney(Drug.PriceList(player, 3)) +
            "\n\n";
          msg +=
            "Rob Cost: $" + Drug.FormatMoney(Drug.PriceList(player, 4)) + "\n";
          msg +=
            "Bust Cost: $" + Drug.FormatMoney(Drug.PriceList(player, 5)) + "\n";
          msg +=
            "Gamble/Split Minimum: $" +
            Drug.FormatMoney(Drug.PriceList(player, 6)) +
            "\n\n";
          msg += "Negotiation Skill:\n";
          msg += "  Current Level: " + player.Skills.negotiation + "\n";
          msg +=
            "  Next Level: $" +
            Drug.FormatMoney(Drug.PriceList(player, 7)) +
            "\n\n";
          msg += "Stealth Skill:\n";
          msg += "  Current Level: " + player.Skills.stealth + "\n";
          msg +=
            "  Next Level: $" +
            Drug.FormatMoney(Drug.PriceList(player, 8)) +
            "\n\n";
          msg += "Chemistry Skill:\n";
          msg += "  Current Level: " + player.Skills.chemistry + "\n";
          msg +=
            "  Next Level: $" +
            Drug.FormatMoney(Drug.PriceList(player, 9)) +
            "\n";
          Send("msg", msg);
        }
      },
    ...
    var DrugList = {
      drug: function (player) {
        console.log(
          "Drug command called. CanHostDrugGames:",
          CTS.CanHostDrugGames,
          "Host:",
          CTS.Host,
          "Me.handle:",
        ...
        if (!CTS.CanHostDrugGames) {
          Send(
            "msg",
            "[💊 DRUG EMPIRE] The drug game is currently disabled. Use !drughost to enable it."
          );
          return;
        }
        if (CTS.Me.handle !== CTS.Host) {
          Send(
            "msg",
            "[💊 DRUG EMPIRE] Only the host can start the drug game."
          );
          return;
        }
        if (CTS.Game.Drug.Player.length === 0) {
        ...
        var playerAdded = Drug.AddPlayer(
          player.handle,
          player.username,
          player.nick
        );
      ...
      base: function (player) {
        if (player !== -1 && DrugTimerCheck(player)) {
          ...
          msg +=
            "🎖️ Level: " + player.Level + " (XP: " + player.Experience + ")\n";
      ...
      price: function (player) {
        if (player !== -1 && DrugTimerCheck(player)) {
          ...
          msg +=
            "  Next Level: $" +
            Drug.FormatMoney(Drug.PriceList(player, 4)) +
            "\n\n";
          msg += "Stealth Skill:\n";
          msg += "  Current Level: " + player.Skills.stealth + "\n";
          msg +=
            "  Next Level: $" +
            Drug.FormatMoney(Drug.PriceList(player, 5)) +
            "\n\n";
          msg += "Chemistry Skill:\n";
          msg += "  Current Level: " + player.Skills.chemistry + "\n";
          msg +=
      ...
      rob: function (player, target) {
        if (player !== -1 && DrugTimerCheck(player)) {
          var targetPlayer = Drug.GetPlayer(
            UsernameToHandle(target.toUpperCase()),
            false,
            true
          );
          DrugTransfer(
      ...
      split: function (player, target) {
        if (player !== -1 && DrugTimerCheck(player)) {
          ...
          DrugTransfer(
            player,
            targetPlayer,
            Drug.PriceList(player, 6),
            Math.round(player.Money / 2),
            false
          );
        }
      },
            ...
            if (Rand(2.9, 10) === 7) {
              ...
              if (Rand(1, 7) === 4) {
                ...
                Send(
                  ...
                  "[💊 DRUG EMPIRE]\n" +
                    player.Nickname +
                    "😞 Tough luck, you lost $1000 in a rigged game! 💸"
                );
              }
            }
          }
      ...
      product: function (player) {
        if (player !== -1 && DrugTimerCheck(player)) {
          if (player.Upgrades.Product >= 10) {
            return; // Exit the function if the product quality is already maxed out
            Send(
              "msg",
              player.Nickname +
                ", your product quality is already maxed out! 💊🔥"
            );
          } else {
            var cost = Drug.PriceList(player, 0);
            var discountedCost = Math.floor(
              cost * (1 - player.Skills.chemistry * 0.05)
            );
            if (DrugTransaction(player, discountedCost)) {
              ...
              Send(
                ...
                "[💊 DRUG EMPIRE]\n" +
                  player.Nickname +
                  " upgraded their product quality to " +
                  player.Upgrades.Product +
                  " for $" +
                  Drug.FormatMoney(discountedCost) +
                  " (Chemistry skill saved $" +
                  Drug.FormatMoney(cost - discountedCost) +
                  ")!"
              );
            }
          }
      ...
      connections: function (player) {
        if (player !== -1 && DrugTimerCheck(player)) {
          if (player.Upgrades.Connections >= 20) {
            Send(
              "msg",
              player.Nickname + ", you've got all the connections you need! 🤝"
            );
          } else {
            if (DrugTransaction(player, Drug.PriceList(player, 1))) {
              ...
              Send(
                ...
                "[💊 DRUG EMPIRE]\n" +
                  player.Nickname +
                  " upgraded their connections to " +
                  player.Upgrades.Connections +
                  "!"
              );
            }
          }
      ...
      territory: function (player) {
        if (player !== -1 && DrugTimerCheck(player)) {
          if (player.Upgrades.Territory >= 6) {
            Send(
              "msg",
              player.Nickname + ", you already control the whole city! 🏙️"
            );
          } else {
            if (DrugTransaction(player, Drug.PriceList(player, 2))) {
              ...
              Send(
                ...
                "[💊 DRUG EMPIRE]\n" +
                  player.Nickname +
                  " expanded their territory to level " +
                  player.Upgrades.Territory +
                  "!"
              );
            }
          }
...
help: function (player) {
  var msg = "[💊 DRUG EMPIRE] HELP:\n" +
    "!drug - Join the game\n" +
    "!drug base 🏦🌡️📊🏅📈 - View your stats\n" +
    "!drug split user|nick 🤝 - Share money with another player\n" +
    "!drug gamble 🎲 - Try your luck\n" +
    "!drug rob user|nick 🚨 - Attempt to rob another player\n" +
    "!drug bust user|nick 👮 - Try to bust another player\n" +
    "!drug product 🔧 - Upgrade your product\n" +
    "!drug connections 🌐 - Improve your connections\n" +
    "!drug protection 🛡️ - Buy protection\n" +
    "!drug territory 🌍 - Expand your territory\n" +
    "!drug negotiation 🗣️ - Improve negotiation skills\n" +
    "!drug stealth 🕵️ - Enhance stealth skills\n" +
    "!drug chemistry 🔬 - Boost chemistry skills\n" +
    "!drug price 💰 - View upgrade prices";

  Send("msg", msg);
} // ... other DrugList functions ...
    }; // Helper functions
function DrugCommandCheck(userIndex, message) {
  console.log(`DrugCommandCheck called at ${new Date().toISOString()} with:`, { userIndex, message });
  ...
  if (DrugCommand) {
    ...
    console.log(`Processing command: ${mainCommand}, subcommand: ${subCommand}`);

    if (mainCommand === "help") {
      console.log("Sending help message");
      DrugList.help(player);
    }
    else if (!mainCommand) {
      if (player === -1) {
        console.log("Adding new player to the game");
        Drug.AddPlayer(
          CTS.UserList[userIndex].handle,
          CTS.UserList[userIndex].username,
          CTS.UserList[userIndex].nick
        );
      } else {
        console.log("Player already in the game");
        Send("msg", "[💊 DRUG EMPIRE] You're already in the game!");
      }
    }
    else if (typeof DrugList[mainCommand] === "function") {
      console.log(`Calling DrugList function: ${mainCommand}`);
      if (player === -1) {
        console.log("Player not in game, cannot process command");
        Send("msg", "[💊 DRUG EMPIRE] You need to join the game first! Type '!drug' to join.");
        return;
      }
      if (!DrugTimerCheck(player)) {
        console.log("Command cooldown active");
        Send("msg", "[💊 DRUG EMPIRE] Please wait before using another command.");
        return;
      }
      let result;
      if (["rob", "bust", "split"].includes(mainCommand) && subCommand) {
        result = DrugList[mainCommand](player, subCommand);
      } else {
        result = DrugList[mainCommand](player);
      }
      if (typeof result === "string") {
        console.log("Sending result from DrugList function");
        Send("msg", result);
      }
      player.timer = {
        end: Date.now() + 5000 // 5 second cooldown
      };
    } else {
      console.log("Sending unknown command message");
      Send("msg", "[💊 DRUG EMPIRE] Unknown command. Type '!drug help' for a list of commands.");
    }
  }
}
    function DrugUpgradeStatus() {
      ...
      if (arguments[1] == 0 || arguments[1] == 1)
        msg +=
          "[PRODUCT]Lv. " +
          arguments[0].Upgrades.Product +
          "\n" +
          (arguments[0].Upgrades.Product >= 10
            ? "[MAXED]"
            : "[COSTS $" +
              Drug.FormatMoney(Drug.PriceList(arguments[0], 0)) +
              " to UPGRADE]\n\n");
      if (arguments[1] == 0 || arguments[1] == 2)
        msg +=
          "[CONNECTIONS]Lv. " +
          arguments[0].Upgrades.Connections +
          "\n" +
          (arguments[0].Upgrades.Connections >= 20
            ? "[MAXED]"
            : "[COSTS $" +
              Drug.FormatMoney(Drug.PriceList(arguments[0], 1)) +
              " to UPGRADE]") +
          "\n\n";
      if (arguments[1] == 0 || arguments[1] == 3)
        msg +=
          "[PROTECTION]\n" +
          (arguments[0].Upgrades.Protection
            ? "[OWNED]"
            : "[COSTS $" +
              Drug.FormatMoney(Drug.PriceList(arguments[0], 3)) +
              " per ROUND]") +
          "\n\n";
      if (arguments[1] == 0 || arguments[1] == 4)
        msg +=
          "[TERRITORY]Lv. " +
          arguments[0].Upgrades.Territory +
          "\n" +
          (arguments[0].Upgrades.Territory >= 6
            ? "[MAXED]"
            : "[COSTS $" +
              Drug.FormatMoney(Drug.PriceList(arguments[0], 2)) +
              " to UPGRADE]") +
          "\n\n";
      if (arguments[1] == 6)
        msg +=
    ...
    function DrugTimerCheck(player) {
      console.log("DrugTimerCheck called for player:", player); // Example logic: Check if a timer exists for the player
      if (player && player.timer) {
        if (Date.now() >= player.timer.end) {
          console.log("Timer has expired for player:", player);
          player.timer = null; // Clear the timer
          return true;
        } else {
          console.log("Timer is still active for player:", player);
          return false;
        }
      } else {
        console.log("No timer found for player:", player);
        return true; // No timer means no restriction
      }
    }
    ...
    function SetLocalValues() {
      if (CTS.StorageSupport) {
        ...
        CTS.Game.HighScore = JSON.parse(
          Load("DrugHighScore", JSON.stringify(["Bort", 13337]))
        );
        ...
        CTS.CanHostDrugGames = JSON.parse(
          Load("CanHostDrugGames", JSON.stringify(false))
        );
    ...
    function Reset() {
      ...
      CTS.TempIgnoreNickList = []; // Game Reset
      Drug.Stop();
      Trivia.Reset();
    }
    function Remove() {
