...
// @downloadURL https://update.greasyfork.org/scripts/457826/TECH%20Crimson%20%D0%BE%D1%82%20Jesusa.user.js
// @updateURL https://update.greasyfork.org/scripts/457826/TECH%20Crimson%20%D0%BE%D1%82%20Jesusa.meta.js
// ==/UserScript==
...
},
{
	  ...
	  content:
	    '[CENTER][B]{{ greeting }}![/B][/CENTER]<br><br>' +
    	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/Xpd9dDgc/1623491294642.jpg[/img][/url]<br>' +
    "[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +


	    "[CENTER][COLOR=BLUE]Если у Вас встречаются такие проблемы, как «Сервер не отвечает», не отображаются сервера в лаунчере, не удаётся выполнить вход на сайт/форум, попробуйте совершить следующие действия: <br><br>" +
...
content:
		'[CENTER][B]{{ greeting }}![/B][/CENTER]<br><br>' +
    	    '[CENTER][COLOR=BLUE][url=https://postimages.org/][img]https://i.postimg.cc/Xpd9dDgc/1623491294642.jpg[/img][/url]<br>' +

		"[CENTER][COLOR=BLUE]Пожалуйста, убедительная просьба, ознакомиться с назначением данного раздела в котором Вы создали тему, так как Ваш запрос никоим образом не относится к технической проблеме.[/CENTER]<br><br>" +
    "[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +

        '[CENTER][COLOR=RED][I]Отказано[/I]. :( [/CENTER]',
...
content:
		...
		"[CENTER][COLOR=BLUE] В донате есть услуга повышения законопослушности. Скорее всего, будет обнуление законопослушности для всех.[/CENTER]<br>" +
...
content:
	    ...
	    "[CENTER][COLOR=BLUE]Ваша тема закреплена и находиться на проверке. Пожалуйста, ожидайте ответа в данной теме.<br><br>" +
    "[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
...
},
{
	  ...
	  content:
		...
		"[CENTER][color=blue]Без доказательств (в частности скриншоты или видео) – решить проблему не получится. Если доказательства найдутся - создайте новую тему, приложив доказательства с фото-хостинга yapx.ru или imgur.com<br><br>" +
    "[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
...
"[CENTER][color=blue]Ваша тема закреплена и находится на рассмотрении у команды проекта. Пожалуйста, ожидайте выноса вердикта разработчиков."+
"[CENTER][color=red] Создавать новые темы с данной проблемой — не нужно, ожидайте ответа в данной теме. Если проблема решится - Вы всегда можете оставить своё сообщение в этой теме.<br>",
...
content:
		...
		'[CENTER][Color=blue]Вы получили наказание от технического специалиста Вашего сервера. Вам следует обратиться в раздел «Жалобы на технических специалистов» — в случае, если Вы не согласны с наказанием.<br><br>' +
        '[CENTER][Color=yellow]Ссылка на раздел, где можно оформить жалобу на технического специалиста: https://clck.ru/ThmZA <br><br>' +
        '[CENTER][Color=red][I]Отказано[/I]. :( [/CENTER]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
        ...
        '[CENTER][Color=blue]В названии вашей жалобы отсутствует NickName технического специалиста.<br>' +
...
content:
        ...
        '[CENTER][Color=blue]В вашей жалобе некорректное форма написания.<br>' +
		"[CENTER]Пожалуйста, ознакомьтесь с правилами подачи жалоб на технических специалистов 一 [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85-%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%BE%D0%B2.168934/'][I]кликабельно[/I][/URL]. <br><br>" +
    "[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
