...
// @license 	 MIT
// @downloadURL https://update.greasyfork.org/scripts/444408/leetcode-helper.user.js
// @updateURL https://update.greasyfork.org/scripts/444408/leetcode-helper.meta.js
// ==/UserScript==
...
(function () {
    ...
    window.onload = setTimeout(function () {
        var x = document.getElementsByClassName("mr-2 text-label-1 dark:text-dark-label-1 hover:text-label-1 dark:hover:text-dark-label-1 text-lg font-medium")[0];
    ...
    function copyImpl() {
        // 题目描述 内容 Dom
        var contentDom = $('.xFUwe')[0].outerHTML;
