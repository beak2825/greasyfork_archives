...
// @downloadURL https://update.greasyfork.org/scripts/427244/JAV%E8%80%81%E5%8F%B8%E6%9C%BA.user.js
// @updateURL https://update.greasyfork.org/scripts/427244/JAV%E8%80%81%E5%8F%B8%E6%9C%BA.meta.js
// ==/UserScript==
/* jshint -W097 */
(function () {
    'use strict';
        ...
        if ((/(javbd)*\/v\/*/g).test(document.URL)) {
            ...
            Common.search115Data(javID, function (BOOLEAN_TYPE, playUrl, pc) {
                ...
                Common.addAvImg(javID, function ($img) {
                    ...
                    var divEle = $("div[class='video-meta-panel")[0];
                    //$(divEle).attr("id", "video_info");
                    if (divEle) {
                        $(divEle).after($img);
                        $img.click(function () {
