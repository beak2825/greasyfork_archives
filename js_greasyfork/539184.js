...
// @downloadURL https://update.greasyfork.org/scripts/539184/Persona.user.js
// @updateURL https://update.greasyfork.org/scripts/539184/Persona.meta.js
// ==/UserScript==
...
title: '-----------------------------------------------------------------------ОБЖ-----------------------------------------------------------------------',
},
	    {
         title: `ВК`,
	 content:
	    `[FONT=verdana][SIZE=4]Здравствуйте.<br>` +

`Ваше обжалование [/SIZE][COLOR=rgb(224, 0, 12)][SIZE=4]отказано[/SIZE][/COLOR][SIZE=4],  поскольку не был указан аккаунт VK.<br>` +

`[FONT=verdana][SIZE=4][COLOR=red] Закрыто.[/COLOR][/SIZE][/FONT][/SIZE][/FONT]`,
        prefix: CLOSE_PREFIX,
        Status:false,  
		  },
        {
         title: `ЖБ НА АДМ`,
    content:
            `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+

`Если вы не согласны с выданным наказанием, обратитесь в раздел "Жалобы на Администрацию"<br><br>`+
    ...
    },
{
        ...
        content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
        `Ваше обращение находится на рассмотрении администрации сервера.\n`+
        `Предоставьте ссылку на вашу страницу ВКонтакте.<br><br>`+
        `[Color=orange] На рассмотрении.`,
        prefix: PIN_PREFIX,
        status: true,
    },
        ...
        title: `Обман`,
        content: `[FONT=Verdana][SIZE=4]Здравствуйте.<br><br>`+
        `Данное наказание можно обжаловать только при условии выдачи компенсации пострадавшей стороне. Для этого вы должны связаться с обманутой стороной, обсудить условия.<br>`+
        `[U]Примечание:[/U] обманутый игрок должен подтвердить ваши слова в игре.<br>`+
    ...
    },
    {
        title: `Тех раздел ЖБ`,
        content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
        `Обратитесь в раздел «Жалобы на Технических Специалистов» — [URL='https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9656-arkhangelsk.2471/']*Кликабельно*[/URL]<br>`+
        `[color=red]Закрыто.`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
        title: `Ошб сервера`,
        content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
        `Обратитесь в раздел «Обжалование наказаний» своего сервера.<br>`+
        `[color=red]Закрыто.`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    },
    ...
    },
    {
        title: `Соц сети`,
        content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
        ` Доказательства с социальных сетей не принимаются. Вам необходимо загрузить доказательства на imgur.com, далее создать новую тему.<br><br>`+
        `Советую ознакомиться с [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B7%D0%B0%D1%8F%D0%B2%D0%BA%D0%B8-%D0%BD%D0%B0-%D0%BE%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D1%8F.1884562/'] данной темой *Кликабельно*[/URL].[/FONT][/SIZE]<br>`+
        `[color=red]Закрыто.`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    },
    {
        title:  `нет док-вы`,
        content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
        `Вы не предоставили скриншот выдачи наказания, от администратора. Обращение не подлежит рассмотрению.<br><br>`+
        `[color=red] Закрыто.`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    },
    {
        ...
        content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
        `Предоставленная вами ссылка не работает/открывается или вовсе не действительна. Создайте новую тему и убедитесь что ссылка работает корректно.<br><br>`+
        `[color=red]Закрыто.`,
        prefix:UNACCEPT_PREFIX,
        status: false,
        },
        ...
        },
        {
            title: `Спец адм`,
            content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
            `Ваше обращение было передано [color=red]Cпециальной администрации проекта.[/color]<br>`+
            `Иногда решение/рассмотрение подобных обращений требует больше времени чем 3 дня. Настоятельно рекомендуем вам не создавать темы с подобным содержанием. Ответ будет дан в данной теме, как только это будет возможно.<br><br>`+
            `[color=orange] На рассмотрении.`,
        ...
        },
        {
            title: `КП`,
            content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
            `Ваше обжалование было передано [color=yellow] Руководству модерации.[/color]<br>`+
            `Иногда решение/рассмотрение подобных обжалований требует больше времени чем 3 дня. Настоятельно рекомендуем вам не создавать темы с подобным содержанием. Ответ будет дан в данной теме, как только это будет возможно.<br><br>`+
            `[color=orange] На рассмотрении.`,
        ...
        },
 {
            title: `GA`,
            content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
            `Ваше обжалование было передано [color=red] главному администратору.[/color]<br><br>`+
            `[color=yellow] На рассмотрении.`,
            prefix: GA_PREFIX,
            status: true,
        },
        {
            ...
            [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.1401/']Жалобы на лидеров.[/URL]<br>
            [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.1402/']Жалобы на игроков.[/URL]<br>
            [URL='https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-anapa.1416/']Технический раздел сервера.[/URL]<br>
            [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.1400/'] Жалобы на Администрацию.[/URL]<br><br>`+
            `[color=red]Закрыто.`,
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
	     {
		     title: `Ник `,
            content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
	    `[SIZE=4][FONT=verdana][SIZE=4]Здравствуйте.<br>` +

`Ваш аккаунт будет разблокирован на 24 часа, за это время вы должны сменить ник нейм. Если вы не выполните данные условия, то ваш аккаунт будет заблокирован без права на амнистию.<br>` +

`[FONT=verdana][SIZE=4][COLOR=red] На рассмотрении.[/COLOR][/SIZE][/FONT][/SIZE][/FONT]`,
		     prefix: PIN_PREFIX,
             status: true,
		       },
        {
            title: `ППВ`,
            content: `[FONT=verdana][SIZE=4]Здравствуйте.<br><br>`+
            ` Отпишитесь в данной теме, и предоставьте данную информацию;<br>`+
        ...
        {
            title: `Роспись`,
            content: `[IMG]https://vk.com/sticker/1-94510-256b[/IMG]`,
...
// @author       You
// @match        https://github.com/sak0v/ForumScript/blob/codespace-sak0v-shiny-space-waddle-6j4wgwqjw6phw67/ForumObz.js
