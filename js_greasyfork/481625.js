// ==UserScript==
// @name         Скрипт для чипули и никитки
// @namespace    http://tampermonkey.net/
// @version      2.9
// @description  Скрипт для Руководства сервера AQUA
// @author       чип
// @match        https://forum.blackrussia.online/threads/*
// @icon         https://klike.net/uploads/posts/2021-12/1638345168_12.jpg
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/481625/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%87%D0%B8%D0%BF%D1%83%D0%BB%D0%B8%20%D0%B8%20%D0%BD%D0%B8%D0%BA%D0%B8%D1%82%D0%BA%D0%B8.user.js
// @updateURL https://update.greasyfork.org/scripts/481625/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%87%D0%B8%D0%BF%D1%83%D0%BB%D0%B8%20%D0%B8%20%D0%BD%D0%B8%D0%BA%D0%B8%D1%82%D0%BA%D0%B8.meta.js
// ==/UserScript==
...
'[RIGHT][COLOR=FFFFFF][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервера [COLOR=rgb(139, 0, 255)]AQUA.[/B][/FONT][/SIZE][/RIGHT]',
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(65, 168, 95)]Одобрено[/COLOR], закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][COLOR=lavender]С уважением Администрация сервера [COLOR=rgb(139, 0, 255)]Saratov.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
	       prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    {
...
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервера [COLOR=rgb(139, 0, 255)]Saratov.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
       prefix: PINN_PREFIX,
      status: true,
    },,
	{
...
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервере [COLOR=rgb(139, 0, 255)]Saratov.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
         prefix: CLOSE_PREFIX,
      status: false,
    },
	{
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Админимстрация сервера [COLOR=rgb(139, 0, 255)]Saratov.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
         prefix: CLOSE_PREFIX,
      status: false,
    },
	{
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 255, 34)][SIZE=4][ICODE]На рассмотрении..[/ICODE][/SIZE][/COLOR][/CENTER]<br>" +
'[RIGHT][SIZE=4][FONT=arial][I]С уважением администрация сервера [/I][COLOR=rgb(0, 255, 255)][I]AQUA[/I][/COLOR][/FONT][/SIZE][/RIGHT]',
	       prefix: PINN_PREFIX,
      status: true,
    },
	{
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Ваша жалоба одобрена в сторону Администратора будут применены меры.[/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
         "[CENTER][COLOR=rgb(65, 168, 95)]Одобрено[/COLOR], закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=4][FONT=arial][I]С уважением администрация сервера [/I][COLOR=rgb(0, 255, 255)][I]AQUA[/I][/COLOR][/FONT][/SIZE][/RIGHT]',
	     prefix: ACCСEPT_PREFIX,
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Ваша жалоба передана [COLOR=rgb(255, 0, 0)]Главному Администратору . <br>[COLOR=rgb(255, 255, 255)]Ожидайте ответа в данной теме. Не создавайте повторные темы, в противном случае Вы можете получить блокировку форумного аккаунта.[/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Главному Администратору[/COLOR]. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=4][FONT=arial][I]С уважением администрация сервера [/I][COLOR=rgb(0, 255, 255)][I]AQUA[/I][/COLOR][/FONT][/SIZE][/RIGHT]',
       prefix: GA_PREFIX,
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Ваша жалоба передана [COLOR=rgb(255, 0, 0)]Специальному Администратору . <br>[COLOR=rgb(255, 255, 255)]Ожидайте ответа в данной теме. Не создавайте повторные темы, в противном случае Вы можете получить блокировку форумного аккаунта.[/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Специальному Администратору[/COLOR]. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=4][FONT=arial][I]С уважением администрация сервера [/I][COLOR=rgb(0, 255, 255)][I]AQUA[/I][/COLOR][/FONT][/SIZE][/RIGHT]',
       prefix: SPECY_PREFIX,
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][B]Доказательства в социальных сетях (VK,Instagram,FaceBook) не принимаются, загрузите доказательства на фотохостинг (Imgur,Yapix,Youtube). [/B][/FONT][/SIZE]<br>" +
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
        "[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=4][FONT=arial][I]С уважением администрация сервера [/I][COLOR=rgb(0, 255, 255)][I]AQUA[/I][/COLOR][/FONT][/SIZE][/RIGHT]',
	      prefix: CLOSE_PREFIX,
