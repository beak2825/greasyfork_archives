...
// @run-at         document-end
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/393499/Gelbooru%20Endless%20Scroll.user.js
// @updateURL https://update.greasyfork.org/scripts/393499/Gelbooru%20Endless%20Scroll.meta.js
// ==/UserScript==
...
(function(){
  ...
  page = function(doc) {
    ...
    var el = target(), rect1 = d.querySelector(".thumb:last-of-type"),
      el2 = d.querySelector(location.href.startsWith("https://gelbooru.com/") ? ".hidden-xs" : ".sidebar"), rect2;
