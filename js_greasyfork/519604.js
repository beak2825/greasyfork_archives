...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/519604/Custom%20Config%20Example.user.js
// @updateURL https://update.greasyfork.org/scripts/519604/Custom%20Config%20Example.meta.js
// ==/UserScript==
...
#searchFilters{margin-left: auto;padding:4pt;}
    ...
    function initializeUI(currentConfig) {
        ...
        function sortByCount(property) {
            ...
            Promise.all([
                getItem(userSettingUid),
                getItem(isEnabledKey)
            ]).then(([sortingOptionValue, isEnabled]) => {
