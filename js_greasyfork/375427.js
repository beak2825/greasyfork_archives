...
// @version      2.1
// @description  Créer un trajet n'auras jamais été aussi facile
// @author       Drigtime pour la création de Owl & Haaxed pour synthaxe de Flaty
...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/375427/Owl%20FlatyBot.user.js
// @updateURL https://update.greasyfork.org/scripts/375427/Owl%20FlatyBot.meta.js
// ==/UserScript==
...
<div class="modal fade" id="pathSetting" tabindex="-1" role="dialog" style="top: 100px;"></div>`;
    ...
    $('#path-creator-bar').on('click', '.fa-save', function () {
        ...
        txt += '\t\t{map = "191104002", changeMap = "261"}, --Devant banque Astrub--\r\n' +
            ...
            '\t\t{map = "54172457", changeMap = "358"}, --Devant banque Frigost--\r\n' +
            '\t\t{map = "54534165", changeMap = "424", npcBank = true}, --Banque Frigost--\r\n' +
            '\t\t{map = "147254", changeMap = "283"}, --Devant banque Bonta--\r\n' +
            '\t\t{map = "2885641", changeMap = "424", npcBank = true}, --Banque Bonta--\r\n' +
            ...
            '\t\t{map = "155157", changeMap = "242"}, --Devant banque Ottomaï--\r\n' +
