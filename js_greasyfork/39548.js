...
// @author       MasterNyborg + Lefty
// @icon         http://i.imgur.com/wS1IQwd.jpg
// @include      *google.com/evaluation/endor*
// @include      https://www.youtube.com/embed?*
// @include      https://www.youtube.com/embed/*
// @require      http://code.jquery.com/jquery-latest.min.js
// @downloadURL https://update.greasyfork.org/scripts/39548/John%20Doe%20banner.user.js
// @updateURL https://update.greasyfork.org/scripts/39548/John%20Doe%20banner.meta.js
// ==/UserScript==
...
$(document).ready(function() {
    if (window.location.href.includes('assignmentId=ASSIGNMENT_ID_NOT_AVAILABLE')) return;
        ...
        $('#yes-playable').click();
        $('input[name=speech-presence][value=YES]').click();
