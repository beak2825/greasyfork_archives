...
// @downloadURL https://update.greasyfork.org/scripts/9986/Roll2.user.js
// @updateURL https://update.greasyfork.org/scripts/9986/Roll2.meta.js
// ==/UserScript==
...
$.ajax({
  type: 'GET',
  url: "http://docs.google.com/uc?export=download&id=0B4Igp0h82K3yUDc4NWdQNEZQY0k",
  async: false,
...
var getStats = function(stat){
   switch(stat){
     ...
     case "ing":
       ...
       break;
     case "forme":
       return parseInt($('#statistiques .infos .stat_10_entier').text());
       break;
   }
} 
