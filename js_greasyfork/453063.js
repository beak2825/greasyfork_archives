...
// @namespace    mmd.com
// @version      1.7.32
// @description  社区访问优化&菜区综合助手
// @author       mmd
// @icon        
// @require      https://cdn.jsdelivr.net/npm/jquery@3.2.1/dist/jquery.min.js
// @require      https://greasyfork.org/scripts/398240-gm-config-zh-cn/code/GM_lazyloadconfiwg_zh-CN.js
...
// @downloadURL https://update.greasyfork.org/scripts/453063/%E5%B0%8F%E8%8D%89%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/453063/%E5%B0%8F%E8%8D%89%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
    ...
    function postFix(){
        if (localHref.match(/htm_(data|mob)\S*\.html|read\.php\?/) != null ){
            ...
            $('.tpc_cont').parent().each(function(){
                ...
                var tpc_author = $('.tpc_detail:first li', this).html().replace(/(\S*)(<br.*)/,'$1');
                var tpc_author_name = tpc_author.replace(/(\S*)(<.*)/,'$1');
                //tpc_author = tpc_author.substring(0, tpc_author.indexOf('#'));
                //console.log(tpc_author_name);

                if(tpc_author){
                    var link = '<a href="/@' + tpc_author_name + '" target="_blank">' + tpc_author + '</a>';
