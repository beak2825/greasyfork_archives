...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/15315/Theme%20Noel.user.js
// @updateURL https://update.greasyfork.org/scripts/15315/Theme%20Noel.meta.js
// ==/UserScript==
$('#logo img').remove();
$('#logo').append('<a href="http://worldaide.fr/"><span></span><img src="http://i.imgur.com/Y1mjeUZ.png" width="170" height="120" alt="Logo du forum sur les jeux vidéos RealityGaming"></a>')
...
$(document).ready(function(){
    ...
    var css = '#taigachat_box{height:300px;border:1px solid #C51616;padding:5px;margin:5px -2px 0 -2px;overflow:auto;overflow-y:scroll;font-size:11px;background: #060207 url("http://i.imgur.com/uU9AypH.jpg") center no-repeat;-webkit-text-size-adjust:none}';
