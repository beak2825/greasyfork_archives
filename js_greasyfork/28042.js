...
// @downloadURL https://update.greasyfork.org/scripts/28042/Hybrid%20-%20Calls%20-%20Contact%20%28With%20B%29.user.js
// @updateURL https://update.greasyfork.org/scripts/28042/Hybrid%20-%20Calls%20-%20Contact%20%28With%20B%29.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Contact")').length) {
    ...
    createButton('Biz on VM',0,0,2,2,'business name on voicemail');
    ...
    createButton('DC - Directory',2,2,2,2,'Disconnected - Directory');
    createButton('DC - Not Completed',2,2,2,2,'Disconnected - Could not be completed as dialed');
    createButton('Fax',3,2,2,2,'Fax');
