...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/483655/POC%20-%20Unhinged%20Msg%20Length%20Max.user.js
// @updateURL https://update.greasyfork.org/scripts/483655/POC%20-%20Unhinged%20Msg%20Length%20Max.meta.js
// ==/UserScript==

var currentlyEnabled = true; //to add enable/disable button

function createButton(){
    const userScriptLoader = false; //change to true if using something like tampermonkey
    if (userScriptLoader){
