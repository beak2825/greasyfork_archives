...
// * Display Ã¢â€šÂ¬ per (Mbit|Gb|Mhz) on hardware screen
...
// @downloadURL https://update.greasyfork.org/scripts/9027/SlaveHack%20Utilities.user.js
// @updateURL https://update.greasyfork.org/scripts/9027/SlaveHack%20Utilities.meta.js
// ==/UserScript==
...
if (isCaptcha || document.body.innerHTML.match('<script type="text/javascript" src="http://api.recaptcha.net/challenge?')) {
        ...
        ////
        // Calculate Ã¢â€šÂ¬/(Mhz|Gb|Mbit) for every Hardware
                ...
                if ( document.body.innerHTML.match('Collecting from all slaves....') ) {
                        ...
                        function sortSlaves(str) {
                                ...
                                if (disp) {
                                        ...
                                        // Added 2 new Collums -> MBit and Ã¢â€šÂ¬/h
