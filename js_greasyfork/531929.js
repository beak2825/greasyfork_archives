// ==UserScript==
// @name         SURGUT | Скрипт для ЗГС/ГС АП [by Pikcher_Smouk]
// @namespace    https://forum.blackrussia.online
// @version      1.6
// @description  По вопросам (ВК): https://vk.com/pikcher77
// @author       Pikcher
...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/531929/SURGUT%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%97%D0%93%D0%A1%D0%93%D0%A1%20%D0%90%D0%9F%20%5Bby%20Pikcher_Smouk%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/531929/SURGUT%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%97%D0%93%D0%A1%D0%93%D0%A1%20%D0%90%D0%9F%20%5Bby%20Pikcher_Smouk%5D.meta.js
// ==/UserScript==
	...
	const buttons = [
		{
			title: '| Роспись |',
			content:
			  '[HEADING=3][CENTER][FONT=courier new][I]Hello from Pikcher_Smouk[/i][/FONT][/CENTER][/HEADING]<br><br>' +
			  '[CENTER][URL=https://postimages.org/][IMG width="63px"]https://i.postimg.cc/hGWW7YHZ/1141158751466954902.webp[/CENTER][/URL]<br>'
		  },
       {
      title: 'Привет',
      content:
...
const buttonConfig = (text, href) => {
  ...
  return button;
    ...
    const Button2 = buttonConfig("Общие правила", "https://forum.blackrussia.online/threads/Общие-правила-серверов.312571/");
	
    bgButtons.append(Button2);

    const Button3 = buttonConfig("АП 86", "https://forum.blackrussia.online/forums/Раздел-для-агентов-поддержки.3809/");

	bgButtons.append(Button3);

    const Button4 = buttonConfig("Заявки АП 86", "https://forum.blackrussia.online/forums/Агенты-поддержки.3814/");
...
(function () {
    ...
    switchStyleBlock.innerHTML = `
            ...
            <span class="addingText" style="display: block; width: max-content; margin: 5px; margin-left: 42px; margin-top: 2px;">Включить режим снега</span>
            </span>
        `;
