// ==UserScript==
// @name         南宁理工学院刷课助手（南宁校区）
// @version      0.2.1
// @description  南宁理工学院刷课助手,自动识别验证码刷课，正版免费，认准同抖音原版。
// @author       Berry
...
// @license    	 MIT
// @connect      bwgl.3389.info
// @connect      bwgl.3389.info:9000
// @namespace    https://greasyfork.org/users/1388879
// @downloadURL https://update.greasyfork.org/scripts/516243/%E5%8D%97%E5%AE%81%E7%90%86%E5%B7%A5%E5%AD%A6%E9%99%A2%E5%88%B7%E8%AF%BE%E5%8A%A9%E6%89%8B%EF%BC%88%E5%8D%97%E5%AE%81%E6%A0%A1%E5%8C%BA%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/516243/%E5%8D%97%E5%AE%81%E7%90%86%E5%B7%A5%E5%AD%A6%E9%99%A2%E5%88%B7%E8%AF%BE%E5%8A%A9%E6%89%8B%EF%BC%88%E5%8D%97%E5%AE%81%E6%A0%A1%E5%8C%BA%EF%BC%89.meta.js
// ==/UserScript==
...
function getCode(code) {
    return new Promise((resolve, reject) => {
        ...
        GM_xmlhttpRequest({
            method: "POST",
            url: "http://bwgl.3389.info:9000/code",
            ...
            onload: function (response) {
                if (response.status == 200) {
                    if (response.responseText.indexOf("未被授权") != -1)
                    ...
                    try {
                        ...
                        if (response.responseText.indexOf("服务端错误") != -1)
                            addText(response.responseText);
                    }
                } else {
                    addText("请更新脚本，或关闭代理服务器");
                    addText("https://greasyfork.org/zh-CN/scripts/515681-%E5%8D%97%E5%AE%81%E7%90%86%E5%B7%A5%E5%AD%A6%E9%99%A2%E5%88%B7%E8%AF%BE%E5%8A%A9%E6%89%8B");
                }
            }
        });
    });
...
const addContainer = () => {
    ...
    header.text("南宁理工学院刷课助手 " + version)
    ...
    addText("作者邮箱:baomidou_2024@qq.com")
    addText("自动打验证码可联系 QQ 3936884135")
    addText("脚本失效请先更新脚本，不会使用请复制下方链接在浏览器打开查看教程")
    addText("脚本安装教程文档：http://hg.3389.info/s/7yU8")
    addText("脚本安装与更新视频教程：http://hg.3389.info/s/Q0uy")
    addText("启动成功...")
