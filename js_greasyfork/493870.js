// ==UserScript==
// @name        YAKUTSK | ГА/ЗГА/Кураторы
// @namespace    https://forum.blackrussia.online/
// @version      0.1
// @description  Специально для BlackRussia || YAKUTSK by W.Capone
// @author       T.Takigawa | YAKUTSK
...
// @downloadURL https://update.greasyfork.org/scripts/493870/YAKUTSK%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/493870/YAKUTSK%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B.meta.js
// ==/UserScript==
...
(async function () {
    ...
    //      `Пожалуйста, прикрепите доказательства к жалобе, которые подтверждают нарушение администратора.<br>`+
        //      `[COLOR=rgb(255, 0, 0)]Закрыто. <br><br>`+
    //             `Приятной игры на сервере [COLOR=rgb(0,204,255) YAKUTSK.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
    ...
    //         `[CENTER][SIZE=4][FONT=georgia]Недостаточно доказательств, которые потверждают нарушение администратора.<br>`+
    //         `[COLOR=rgb(255, 0, 0)]Отказано.<br><br>`+
    //            ``Приятной игры на сервере [COLOR=rgb(0,204,255) YAKUTSK. [/COLOR][/CENTER]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
    //  },
    //  {
    //         title: `Нарушений нет`,
    //         content:`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
    //         `[CENTER][SIZE=4][FONT=georgia]Исходя из выше приложенных доказательств нарушений со стороны администратора я не увидел!<br>`+
    //         `[COLOR=rgb(255, 0, 0)]Отказано.<br><br>`+
    //         `Приятной игры на сервере [COLOR=rgb(0,204,255) YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
	//  },
    //  {
    ...
    //     `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
	//   prefix: PIN_PREFIX,
	//   status: true,
    //  },
    //  {
	...
	// 	`[CENTER][COLOR=rgb(250, 197, 28)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
    //   prefix: PIN_PREFIX,
	//   status: true,
    //  },
     /*{
      ...
      `[CENTER]Обратитесь в раздел обжалований: [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний [/URL]![/CENTER]<br><br>` +
      `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},*/
    // {
    ...
    //   `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
	//   prefix: UNACCEPT_PREFIX,
	//   status: false,
	// },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
		`[CENTER][SIZE=4][FONT=georgia]Ваша жалоба была одобрена и будет проведена беседа с администратором.<br>` +
        `Ваше наказание будет снято в 24ч, если оно еще не снято.[/CENTER]<br>`+
        `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
	...
	},
    {
	  ...
	  content:
        ...
        `Ваше наказание будет снято в течении 24ч, если оно еще не снято.[/CENTER]<br><br>`+
        `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
	  prefix: ACCEPT_PREFIX,
	  status: false,
	...
	},
    {
            title: `Окно бана`,
            content: `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
            `[SIZE=4][FONT=georgia][CENTER]Зайдите в игру и сделайте скриншот окна с баном, после чего заново напишите жалобу.<br>`+
             `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
          `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
            prefix: UNACCEPT_PREFIX,
            status:false,
    ...
    },
    {
        ...
        content:
            ...
            `Ваш запрос никоим образом не относится к предназначению данного раздела.<br>`+
             `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
        prefix: UNACCEPT_PREFIX,
        status:false,
    ...
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
		`[CENTER]Внимательно ознакомившись с вашей жалобой, было решено, что вам нужно обраться в раздел жалоб на игроков.<br>` +
		 `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
    ...
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  [user=304273]Alexander_Litvinenko[/user]<br>`+
         `[CENTER][COLOR=rgb(255, 0, 0)]На рассмотрении.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  [user=239690]Aleksey_Bootman[/user] <br><br>`+
         `[CENTER][COLOR=rgb(255, 0, 0)]На расмотрении.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
	...
	//   content:
	// 	`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
    //     `[CENTER]Передаю вашу жалобу Главному Администратору — Wyatt_Capone <br><br>`+
    //     `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
    //   prefix: GA_PREFIX,
	//   status: true,
	// },
    // {
    ...
    },
    {
        ...
        `Ваше обжалование рассмотрено и принято решение о сокращении вашего наказания.<br><br>[/CENTER]`+
         `[CENTER][COLOR=rgb(255, 0, 0)]Одобрено.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
        prefix: ACCEPT_PREFIX,
        status: false,
    },
    ...
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю ваше обжалование Главному Администратору —  [user=308750]Wyatt Capone[/user] <br><br>`+
         `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
      prefix: GA_PREFIX,
	  status: true,
    ...
    //     `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]`,
    //   prefix: UNACCEPT_PREFIX,
    //   status: false,
    // },
    {
    ...
    },
    {
      ...
      content:
        ...
        `[CENTER][B][I][FONT=georgia]Рассмотрению не подлежит.[/CENTER]<br>` +
         `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER][B][I][FONT=georgia]В таких случаях нужнен фрапс[/CENTER]<br>`+
         `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
      prefix: UNACCEPT_PREFIX,
      status: false,
    ...
    const buttons3 = [
        {
            ...
            `[CENTER][COLOR=rgb(250, 197, 28)]На рассмотрении.[/COLOR]<br><br>`+
            `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
            prefix: PIN_PREFIX,
            status: true,
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER]Ваша жалоба была одобрена, с администратором будет проведена беседа.<br>` +
                 `[CENTER][COLOR=rgb(255, 0, 0)]Одобрено.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            content:
            `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
            `[CENTER][SIZE=4][FONT=georgia]Ваша жалоба передана - [COLOR=rgb(204, 19, 4)]Специальной Администрации[/COLOR].<br>`+
             `[CENTER][COLOR=rgb(251, 160, 38)]На расмотрении.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
            prefix: SPECIAL_PREFIX,
            status: true,
        },
        {
            ...
            content:
            `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
            `[CENTER][SIZE=4][FONT=georgia]Ваша жалоба передана - [COLOR=rgb(246, 207, 0)]Команде Проекта[/COLOR].<br>`+
             `[CENTER][COLOR=rgb(251, 160, 38)]На расмотрении.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER]Администратор совершил ошибку.<br>` +
                `Приносим свои извинения за предоставленные неудобства.[/CENTER]<br>` +
                 `[CENTER][COLOR=rgb(0, 255, 0)]Рассмотрено.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
            prefix: WATCHED_PREFIX,
            status: false,
        },
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER]Передаю вашу жалобу Главному Администратору —  [user=308750]Wyatt_Capone[/user] <br>`+
                 `[CENTER][COLOR=rgb(251, 160, 38)]На расмотрении.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
            prefix: GA_PREFIX,
            status: true,
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER]Жалоба составлена не по форме.<br>` +
                `Внимательно прочитайте правила составления жалобы - [URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-администрацию.3429349/']*ТЫК*[/URL]<br>` +
                 `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
            prefix: CLOSE_PREFIX,
            status: false,
        ...
        },
        {
            ...
            content: 	`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
            `[CENTER][SIZE=4][FONT=georgia]С момента выдачи наказания прошло более 48 часов.[/CENTER]<br>` +
            `[CENTER]Обратитесь в раздел обжалований: [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.2864/']*ТЫК*[/URL]![/CENTER]<br>` +
             `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
            prefix: UNACCEPT_PREFIX,
            status: false,
    ...
    },
    {
      ...
      content:
        `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Нарушитель будет наказан по данному пункту правил:<br> [Color=Red]2.05[/color]. Запрещены любые OOC обманы и их попытки, а также любые IC обманы с нарушением Role Play правил и логики [Color=Red]| PermBan[/color].[/CENTER]<br><br>` +
        `[CENTER][COLOR=rgb(0, 255, 0)]Одобрено.[/COLOR]<br><br>`+
        `Приятной игры на сервере [COLOR=rgb(0,204,255)] YAKUTSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
      prefix: ACCEPT_PREFIX,
      status: false,
    },
