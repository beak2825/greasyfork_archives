// ==UserScript==
// @name         MaSt Clan Extension Powerful and Useful!
...
// @match        http://gota.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/22792/MaSt%20Clan%20Extension%20Powerful%20and%20Useful%21.user.js
// @updateURL https://update.greasyfork.org/scripts/22792/MaSt%20Clan%20Extension%20Powerful%20and%20Useful%21.meta.js
// ==/UserScript==
window.onload = function() {
    ...
    //$( "head" ).append("<script>function chat() { if(document.getElementById('chat').checked) { document.getElementById('chatboxi').style.visibility = 'hidden'; } else { document.getElementById('chatboxi').style.visibility = 'visible'; }  }</script>");
    ...
    $( "select#gamemode" ).after("<input class='form-control' placeholder='Clan Tag' maxlength='10' autofocus style='width: 30%; float: right;'>");
    ...
    //$( "#overlays" ).append('<div id="Stats" style="position: fixed; top: 0px; left: 0px; width: 325px; height: 500px; background-color: #fff; border: 2px solid #000;"><div id="Container" align="center" style="float: left;"><h2 style="font-family: Ubuntu; font-size: 200%; text-align: center;">Clan</h2></div></div>');
    $( "head" ).append('<script type="text/javascript">function chatDeploy() { document.getElementById("chatboxi").style.height = "300px";} function chatHide() { document.getElementById("chatboxi").style.height = "0px";}</script>');
    $( "#options").append("<label><input type='button' id='hideChat' onclick='chatHide()' class='opts'><span>Hide Chat</span></label><label><input type='button' id='chat' onclick='chatDeploy()' class='opts'><span>Chat</span></label><label><input type='checkbox' id='hideGrid' onclick=''><span>Hide Grid Soon...</span></label>");
    ...
    addGlobalStyle("input#nick:focus { border: 3px solid #555; background-color: #6A6868; color: #fff; } ");
...
document.body.innerHTML += '<iframe id="chatboxi" src="https://kiwiirc.com/client/irc.epiknet.org/?&theme=cli#mast" style="border:0; width:500px; height:20px;"></iframe>';
var chi = document.getElementById("chatboxi");
chi.style.position = "fixed";
chi.style.bottom = "0px";
chi.style.right = "0px";
function chatDeploy() { document.getElementById("chatboxi").style.height = "300px";}
function chatHide() { document.getElementById("chatboxi").style.height = "0px";}