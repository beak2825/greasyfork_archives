...
// @version       0.20210922230518
// @downloadURL https://update.greasyfork.org/scripts/29480/Deezer%20DarkCube.user.js
// @updateURL https://update.greasyfork.org/scripts/29480/Deezer%20DarkCube.meta.js
// ==/UserScript==
(function() {var css = [
	"*::-webkit-scrollbar {",
	...
	"#page_exclusions .dropdown .dropdown-menu>li>a:hover, #page_exclusions .dropdown .dropdown-menu>li>button:hover {",
	"	background-color: #222;",
	"	color: #FF6400;",
	"}",
	...
	"#page_exclusions .dropdown .dropdown-menu, #page_exclusions .dropdown .dropdown-menu>li>a, #page_exclusions .dropdown .dropdown-menu>li>button,",
	"#page_content .dropdown .dropdown-menu, #page_content .dropdown .dropdown-menu>li>a, #page_content .dropdown .dropdown-menu>li>button {",
	"	background-color: #000;",
	"}",
	"#page_profile .dropdown .dropdown-menu>li>a, #page_profile .dropdown .dropdown-menu>li>button,",
	"#page_exclusions .dropdown .dropdown-menu>li>a, #page_exclusions .dropdown .dropdown-menu>li>button,",
	"#page_content .dropdown .dropdown-menu>li>a, #page_content .dropdown .dropdown-menu>li>button {",
	"	color: #ccc;",
	"}",
	"#page_profile .dropdown .dropdown-menu, #page_exclusions .dropdown .dropdown-menu,",
	"#page_content .dropdown .dropdown-menu {",
	...
	"	padding: 56px 0 0 0;",
	"}",
	".thumbnail .picture.overlay-hidden[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/86x86-000000-80-0-0.jpg\"] {",
	"	width: 86px;",
	"	height: 0px;",
	...
	"	padding: 86px 0 0 0;",
	"}",
	".thumbnail .picture.overlay-hidden[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/28x28-000000-80-0-0.jpg\"],",
	".thumbnail .picture-img[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/28x28-000000-80-0-0.jpg\"] {",
	"	width: 28px;",
	"	height: 0px;",
	...
	"	padding: 28px 0 0 0;",
	"}",
	".thumbnail .picture-img[src*=\"https://e-cdns-images.dzcdn.net/images/user/d41d8cd98f00b204e9800998ecf8427e/264x264-000000-80-0-0.jpg\"],",
	".thumbnail .picture-img[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/264x264-000000-80-0-0.jpg\"],",
	".thumbnail .picture-link[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/264x264-000000-80-0-0.jpg\"],",
	".thumbnail .picture-link[src*=\"https://e-cdns-images.dzcdn.net/images/user/d41d8cd98f00b204e9800998ecf8427e/264x264-000000-80-0-0.jpg\"],",
	"#page_naboo_artist img[src=\"https://e-cdn-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/264x264-000000-80-0-0.jpg\"] {",
	"	width: 264px;",
	"	height: 0px;",
	...
	"	padding: 264px 0 0 0;",
	"}",
	".thumbnail .picture-link[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/56x56-000000-80-0-0.jpg\"],",
	".thumbnail .picture-img[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/56x56-000000-80-0-0.jpg\"] {",
	"	width: 56px;",
	"	height: 0px;",
	...
	"	padding: 56px 0 0 0;",
	"}",
	".thumbnail .picture-link[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/100x80-000000-80-0-0.jpg\"],",
	".thumbnail .picture-img[src*=\"https://e-cdns-images.dzcdn.net/images/artist/d41d8cd98f00b204e9800998ecf8427e/100x80-000000-80-0-0.jpg\"] {",
	"	width: 80px;",
	"	height: 0px;",
	...
	"	padding: 100px 0 0 0;",
	"}",
	".thumbnail .picture.overlay-hidden[src*=\"https://e-cdns-images.dzcdn.net/images/user/d41d8cd98f00b204e9800998ecf8427e/32x32-000000-80-0-0.jpg\"] {",
	"	width: 32px;",
	"	height: 0px;",
	...
	"	border-color: #ff6400;",
	"}",
	"#page_profile .user-search .form-control, #page_exclusions .user-search .form-control, ",
	"#page_content .user-search .form-control {",
	"	background-color: #000;",
	"	border: 1px solid #333;",
	"	color: #929292;",
	"}",
	...
	"	border-color: #FF6400;",
	"}",
	"#page_profile .user-search .form-control:focus, #page_exclusions .user-search .form-control:focus,",
	"#page_content .user-search .form-control:focus {",
	"	border-color: #0096FF;",
	"}",
	...
	"#page_exclusions .user-search .form-control:focus::-webkit-input-placeholder, #page_exclusions .user-search .form-control:focus::placeholder,",
	"#page_content .user-search .form-control:focus::-webkit-input-placeholder, #page_content .user-search .form-control:focus::placeholder {",
	"	color: #d1d1d1;",
	"}",
	...
	"}",
	".logo-deezer-black {",
	"    background-image: url(\'data:image/png;base64,\');",
	"    height: 0px;",
	"    width: 125px;",
	"	padding: 0 0 32px 0;",
	"}",
	...
	"    border: none !important;",
	"}",
	".slider-track .gradient-teal {",
	"    background: linear-gradient(1deg,#0096FF 13%,#0096FF);",
	"}",
	"",
	"/*** NEW BUTTONS & UPDATES ***/",
	"",
	...
	"    --topbar-popper-suggest-highlight: #FF6400;",
	"    --topbar-popper-suggest: #aaa;",
	"}",
	".page-player .popper-player-settings .setting-label-info {",
	"    color: #0096FF;",
	"}",
	".page-topbar .popper-search .search-bold-label .search-history-query {",
	"    font-weight: bolder;",
	"}",
	".topbar-search-clear {",
	"    margin-left: 10px;",
	...
	"    background-color: #0096FF;",
	"}",
	".c0310:not(.c0324):hover {",
	"    border-color: #000;",
	"    background-color: #FF6400;",
	"    color: #000;",
	"}",
	".c0310:not(.c0324).dropdown-toggle:hover .svg-icon {",
	"    fill: black;",
	"}",
	".c0310:not(.c0324).c0323 {",
	"    color: #0096FF;",
	"    border-color: #222;",
	"    background-color: #333;",
	"}",
	".c0310:not(.c0324).c0323.dropdown-toggle:hover .svg-icon {",
	"    fill: #FF6400;",
	"}",
	".c0310:not(.c0324):active {",
	"    border-color: #000;",
	"    background-color: #FF6400;",
	"}",
	".slider-track .gradient-default, .slider-track .gradient-black, .slider-track .gradient-red, .slider-track .gradient-deep-orange, .slider-track .gradient-orange, .slider-track .gradient-yellow, .slider-track .gradient-green, .slider-track .gradient-teal, .slider-track .gradient-blue, .slider-track .gradient-indigo, .slider-track .gradient-deep-purple, .slider-track .gradient-purple, .slider-track .gradient-pink {",
	"    background: linear-gradient(1deg,#0096FF 13%,#0070FF);",
	"}",
	".page-contextmenu .menu-item {",
	...
	"}",
	".c0410:not(.c0424):hover {",
	"    border-color: #000;",
	"    background-color: transparent;",
	"    color: #FF6400;",
	"}",
	".page-contextmenu .playlist-filter .form-control {",
	"    background-color: var(--background-primary);",
	"    border: 1px solid #232323;",
	"    color: #929292;",
	"}",
	".page-contextmenu .playlist-create>.icon {",
	"	color: #fff;",
	"}",
	".c032 {",
	"    color: #fff;",
	...
	"/*** 10-06-20220  FIXES ***/",
	"",
	".containedPrimary-0-3-9 {",
	"    color: #FFFFFF;",
	"    background-color: #0096FF;",
	"}",
	".containedPrimary-0-3-9:not(.isDisabled-0-3-24):hover {",
	"    background-color: #FF6400;",
	"}",
	".containedSecondary-0-3-10:not(.isDisabled-0-3-24).isActive-0-3-23 {",
	"    color: #0096FF;",
	"    border-color: #333;",
	"    background-color: #000;",
	"}",
	".containedSecondary-0-3-10 {",
	"    color: #FFFFFF;",
	"    border-color: #333;",
	"    background-color: #000;",
	"}",
	".containedSecondary-0-3-10:not(.isDisabled-0-3-24):hover {",
	"    border-color: #FF6400 !important;",
	"    background-color: #000;",
	"}",
	".containedSecondary-0-3-10:not(.isDisabled-0-3-24):hover + .containedSecondary-0-3-10:not(.isDisabled-0-3-24).isActive-0-3-23 {",
	"    border-left-color: #FF6400 !important;",
	"}",
	".equalizer-12.equalizer-dark {",
	"    filter: invert(100%) !important;",
	"}",
	".containedPrimary-0-4-37 {",
	"    color: #FFFFFF;",
	"    background-color: #0096FF;",
	"}",
	".containedPrimary-0-4-37:not(.isDisabled-0-4-52):hover {",
	"    background-color: #FF6400;",
	"}",
	".containedSecondary-0-4-38 {",
	"    color: #0096FF;",
	"    border-color: #000;",
	"    background-color: #222;",
	"}",
	".containedSecondary-0-4-38:not(.isDisabled-0-4-52):hover {",
	"    border-color: #000;",
	"    color: #fff;",
	"    background-color: #FF6400;",
	"}",
	...
	"    color: #fff;",
	"}",
	".containedPrimary-0-3-92 {",
	"    color: #FFFFFF;",
	"    background-color: #0096FF;",
	"}",
	".containedPrimary-0-3-92:not(.isDisabled-0-3-107):hover {",
	"    background-color: #FF6400;",
	"}",
	".containedSecondary-0-3-93 {",
	"    color: #FFF;",
	"    border-color: #333;",
	"    background-color: #000;",
	"}",
	".containedSecondary-0-3-93:not(.isDisabled-0-3-107):hover {",
	"    border-color: #FF6400;",
	"    background-color: #000;",
	"}",
	"#modal_sharebox button[class*=\"containedSecondary\"] {",
	"    color: #0096FF;",
	"    border-color: #000;",
	"    background-color: #222;",
	"}",
	"#modal_sharebox button[class*=\"containedSecondary\"]:not([class*=\"isDisabled\"]):hover {",
	"    border-color: #000;",
	"    color: #fff;",
	"    background-color: #FF6400;",
	"}",
	"#modal_sharebox button[class*=\"containedPrimary\"] {",
	"    color: #FFFFFF;",
	"    background-color: #0096FF;",
	"}",
	"#modal_sharebox button[class*=\"containedPrimary\"]:not([class*=\"isDisabled\"]):hover {",
	"    background-color: #FF6400;",
	"}",
	"button[class*=\"containedSecondary\"]:not([class*=\"isDisabled\"])[class*=\"isActive\"] {",
	"    color: #0096FF;",
	"    border-color: #333;",
	"    background-color: #000;",
	"}",
	"#page_naboo_artist a[class*=\"containedWarning\"] {",
	"    color: #FFF !important;",
	...
	"    filter: invert(100%) hue-rotate(180deg) !important;",
	"}",
	"#page_naboo_artist ul.navbar-nav > li.navbar-item > a.navbar-link.navbar-button:hover {",
	"    background-color: transparent;",
	...
	"/*** 23-09-2021 ***/",
	"",
	".datagrid-row.song.active .eGhZom {",
	"    filter: drop-shadow(0 0 4px #000);",
	"}",
	".datagrid-cell-action.cell-love:hover .eGhZom {",
	"    filter: drop-shadow(0 0 4px #000);",
	"}",
	".eGhZom {",
	"    fill: currentcolor;",
	...
	"    --background-elevation:var(--color-dark-grey-200);",
	"    --background-accent:var(--color-coral-500);",
	"    --text-primary:var(--color-white);",
	"    --text-intermediate:var(--color-light-grey-800);",
	"    --text-secondary:var(--color-light-grey-700);",
	"    --text-inverse:var(--color-dark-grey-500);",
	...
	"    --sidebar-background-color:var(--color-dark-grey-700);",
	"    --primary-color:#0096FF;",
	"    --primary-hover-color:#0096FF;",
	"    --premium-color:#1daaa2;",
	"    --orange-color:#FF6400;",
	"    --download-color:#00d000;",
	"    --family-color:#0096FF;",
	"    --label-album-color:var(--text-secondary);",
	"    --label-album-background-color:#efefef;",
	"    --label-new-color:#FF6400;",
	"    --label-new-background-color:rgba(255,100,0,0.1);",
	"    --label-explicit-background-color:rgba(0,0,0,0);",
	"    --label-explicit-color:#929292;",
	"    --shadow-border-color:#232323;",
	"    --lyrics-gradient-color:0,0,0;",
	"    --popper-shadow:0 4px 20px 0 rgba(0,0,0,0.24);",
	"    --popper-marquee-gradient-color:rgb(50 50,50);",
	"    --marquee-gradient-transparent-color:rgba(35,35,35,0);",
	"    --modal-special-offers-primary-color:rgba(0,150,255,0.9);",
	"    --modal-special-offers-primary-hover-color:rgba(0,125,255,0.9);",
	"    --modal-sharebox-friend-hover-color:rgba(0,150,255,0.5);",
	...
	"    --color-coral-800:#FF6400;",
	"    --color-coral-700:#FF6400;",
	"    --color-coral-600:#0096FF;",
	"    --color-coral-500:#0096FF;",
	"    --color-coral-400:#0096FF;",
	"    --color-coral-300:#db7176;",
	"    --color-coral-200:#e7999c;",
	"    --color-coral-100:#f7ccd3;",
	"    --color-dark-grey-900:#121212;",
	"    --color-dark-grey-800:#191919;",
	"    --color-dark-grey-700:#191919;",
	"    --color-dark-grey-600:#232323;",
	"    --color-dark-grey-500:#323232;",
	"    --color-dark-grey-400:#424242;",
	"    --color-dark-grey-300:#525252;",
	...
	"    --color-light-grey-900:#727272;",
	"    --color-light-grey-800:#929292;",
	"    --color-light-grey-700:#a2a2a2;",
	"    --color-light-grey-600:#bebebe;",
	"    --color-light-grey-500:#d1d1d1;",
	"    --color-light-grey-400:#dfdfdf;",
	"    --color-light-grey-300:#eaeaea;",
	"    --color-light-grey-200:#f2f2f2;",
	"    --color-light-grey-100:#f4f4f4;",
	"    --color-light-grey-50:#f8f8f8;",
	...
	"    --label-new-color:#FF6400;",
	"    --label-new-background-color:rgba(255,100,0,0.1);",
	"    --label-explicit-background-color:#191919;",
	"    --label-explicit-color:#c2c2c2;",
	"    --shadow-border-color:var(--background-primary);",
	"    --lyrics-gradient-color:255,255,255;",
	"    --popper-shadow:0 4px 20px 0 rgba(25,25,25,0.24);",
	"    --marquee-gradient-transparent-color:hsla(0,0%,100%,0);",
	"    --scroller-shadow-color:rgba(25,25,25,0.12);",
	"    --modal-shadow-color:rgba(10,10,10,0.3);",
	"    --modal-special-offers-primary-color:rgba(0,150,255,0.9);",
	"    --modal-special-offers-primary-hover-color:rgba(0,125,255,0.9);",
	"    --modal-sharebox-friend-hover-color:rgba(0,150,255,0.5);",
