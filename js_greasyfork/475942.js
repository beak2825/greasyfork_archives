// ==UserScript==
// @name         YouTube Recommendations be Gone: Cleaner YouTube
// @name:zh-CN   干净油管：Youtube 去推荐（YouTube Recommendations be Gone）
// @version      1.3.10
...
// @downloadURL https://update.greasyfork.org/scripts/475942/YouTube%20Recommendations%20be%20Gone%3A%20Cleaner%20YouTube.user.js
// @updateURL https://update.greasyfork.org/scripts/475942/YouTube%20Recommendations%20be%20Gone%3A%20Cleaner%20YouTube.meta.js
// ==/UserScript==
  ...
  `);
    ...
    function checkRedirectV2() {
        ...
        if (isHomePage() && !redirectionProtection2s) {
            ...
            document.open();
            document.write('<html><head><meta http-equiv="refresh" content="0;url=https://www.youtube.com/feed/subscriptions"></head><body></body></html>'); // Replace 'https://example.com' with your desired redirection URL
            document.close();
            //window.location.href = "https://www.youtube.com/feed/subscriptions";
            console.log("checkRedirectV2():done");
            setTimeout(redirectionProtection2sOff, 1000);
            //}
        }
    }
