// ==UserScript==
// @name         Torn Church Prayer Streak Tracker (Torn PDA Only)
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Custom version of Church Prayer Tracker for Torn PDA only, fixes positioning and layout issues with Torn theme colors.
// @match        https://www.torn.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/545193/Torn%20Church%20Prayer%20Streak%20Tracker%20%28Torn%20PDA%20Only%29.user.js
// @updateURL https://update.greasyfork.org/scripts/545193/Torn%20Church%20Prayer%20Streak%20Tracker%20%28Torn%20PDA%20Only%29.meta.js
// ==/UserScript==

(function () {
  'use strict';

  // Check if we're on Torn PDA (e.g., by checking if we're on a mobile layout)
  if (!window.location.href.includes("torn.com") || window.innerWidth > 600) {
    return; // Exit if we're not on Torn PDA
  }
  ...
  (function injectStyles() {
    ...
    style.textContent = `
      ...
      /* Buttons with Torn theme colors */
      #prayerTracker .btn {
        color: inherit;
      ...
      @media (max-width: 600px) {
        #prayerTracker {
          ...
          font-size: 14px;
          padding: 10px;
          background-color: var(--main-bg-color); /* Background color from Torn's theme */
          color: var(--main-text-color); /* Text color from Torn's theme */
        }
        ...
        /* Position the tracker at the bottom of the page */
        #prayerTracker {
          display: flex;
          flex-direction: column;
  ...
  function createPanel() {
    ...
    // Append directly to the body for Torn PDA
