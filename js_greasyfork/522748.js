...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/522748/Hunter%20Stumblechat%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/522748/Hunter%20Stumblechat%20Script.meta.js
// ==/UserScript==
let webSocket;
...
function createBanListDiv(banList) {
    ...
    fileInput.addEventListener("change", (event) => {
        ...
        reader.onload = (e) => {
            ...
            // Update ban list with imported bans
            banList.splice(0, banList.length, ...importedBans);
            // Refresh ban list display
    ...
    saveButton.addEventListener("click", () => {
        // Convert banList to plain text
        const text = banList.join("\n");
 
        // Save bans to a file named "bans.txt"
...
// Retrieve bans from browser cache or initialize an empty array
const storedBans = localStorage.getItem("bans");
const banList = storedBans ? storedBans.split("\n") : [];
 
// Call the function to create ban list div
const banListDiv = createBanListDiv(banList);
 
// Append ban list div to the document body or wherever you want it to appear
document.body.appendChild(banListDiv);
 
// Function to toggle ban list visibility
