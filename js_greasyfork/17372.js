// ==UserScript==
// @name         ƵƓ▷ Public Extension
// @version      2.3
// @namespace    (Extension Editor: https://www.youtube.com/c/NEL99Graphics)-(Clan Channel: https://www.youtube.com/channel/UCJiD8iFGSEwPaoajiaQGbiA)
// @description  ƵƓ▷ Clan Extension 
// @author       Agarplus.io Developers + Some edits By NEL99
// @match        http://agar.io/*
// @match        https://agar.io/*
// @run-at       document-start
// @grant        GM_setClipboard
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/17372/%C6%B5%C6%93%E2%96%B7%20Public%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/17372/%C6%B5%C6%93%E2%96%B7%20Public%20Extension.meta.js
// ==/UserScript==
function loadScript(t, e) {
    ...
    // Edits
    document.getElementsByClassName("header")[0].innerHTML = '<div class="header99" style="color: rgb(255, 255, 255);"><a href="https://www.youtube.com/channel/UCyjEpj8QXLiQRUNgezhwX6w/" target="_blank"><u>Շŧ死</a></u></div>';
    document.getElementsByClassName("agario-panel agario-side-panel agarioProfilePanel level forums")[0].innerHTML = '<a href="https://www.youtube.com/channel/UCyjEpj8QXLiQRUNgezhwX6w/" target="_blank"><h4>Turbos YT</h4>';
    document.getElementsByClassName("agario-panel agario-side-panel agarioProfilePanel level forums")[0].innerHTML = '<a href="https://www.youtube.com/channel/UCyjEpj8QXLiQRUNgezhwX6w/" target="_blank"><h4>Turbos YT</h4>';
