...
// @downloadURL https://update.greasyfork.org/scripts/446570/whsfclick-app.user.js
// @updateURL https://update.greasyfork.org/scripts/446570/whsfclick-app.meta.js
// ==/UserScript==
        ...
        for (let i = 0; i < list.length; i++) {
            ...
            if(price_str.length>0){
                ...
                if(price<21000){
                    ...
                    if(dd.substring(0,1)==7 &&dd.substring(2)>20){
                        continue;
                    ...
                    if(qiangNum ==1 ){
                        ...
                        var msgs = "酒店通知:@@酒店名字="+dataLayer.prop_name+"@@日期=2022-"+dd.replace("/","-")+",总价格="+price+"@@程序位置="+machineNum+"@@通知时间="+new Date().toLocaleTimeString();
                        sendMsg(msgs);
                        end=true;
                         location.href=link;
                         //console.log("跳转url");
