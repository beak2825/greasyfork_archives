// ==UserScript==
// @name         SilverScripts updated with AI
...
// @downloadURL https://update.greasyfork.org/scripts/534009/SilverScripts%20updated%20with%20AI.user.js
// @updateURL https://update.greasyfork.org/scripts/534009/SilverScripts%20updated%20with%20AI.meta.js
// ==/UserScript==
    ...
    function addItemToDatabank(flashType,quantity){
        ...
        if(item.id != "" && item.id != undefined){
            ...
            {
                if (!itemGlobData || typeof itemGlobData !== 'object') {
    console.warn("❗ itemGlobData is invalid in addItemToDatabank", {
        itemId: item.id,
        quantity,
        typeOfItemGlobData: typeof itemGlobData,
        itemGlobData,
        availableKeys: typeof globalData === "object" && globalData !== null
            ? Object.keys(globalData)
            : "globalData is not available or not an object"
    });
    return;
}}
            ...
            item.type = itemGlobData.itemcat
                ? capitalizeFirstLetter(itemGlobData.itemcat)
            : "Unknown";
