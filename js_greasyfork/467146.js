// ==UserScript==
// @name         Скрипт для ГА/ЗГА/Куратор адм || Purple
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/467146/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D0%B0%D0%B4%D0%BC%20%7C%7C%20Purple.user.js
// @updateURL https://update.greasyfork.org/scripts/467146/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D0%B0%D0%B4%D0%BC%20%7C%7C%20Purple.meta.js
// ==/UserScript==
...
"[CENTER][ICODE][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/ICODE][/CENTER]<br>" +
"[CENTER] [IMG]https://i.yapx.ru/GFL6g.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[SIZE=3][FONT=trebuchet ms][COLOR=lime][B] Текст [/B][/FONT][/SIZE]<br>" +
...
'[RIGHT][COLOR=FFFFFF][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервера [COLOR=rgb(139, 0, 255)] Purple.[/B][/FONT][/SIZE][/RIGHT]',
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(65, 168, 95)]Одобрено[/COLOR], закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][COLOR=lavender]С уважением Администрация сервера [COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
	       prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    {
...
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервере [COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
         prefix: CLOSE_PREFIX,
      status: false,
    },
	{
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.yapx.ru/GFL6g.png[/IMG][/CENTER]<br>" +
"[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Админимстрация сервера [COLOR=rgb(139, 0, 255)]Purple.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
         prefix: CLOSE_PREFIX,
      status: false,
    },
	{
