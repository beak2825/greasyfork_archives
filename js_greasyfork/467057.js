...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/467057/super%20decifrador.user.js
// @updateURL https://update.greasyfork.org/scripts/467057/super%20decifrador.meta.js
// ==/UserScript==
...
(function() {
    ...
    function desencriptarArreglo(arregloEncriptado, llave) {
        ...
        var llaveWordArray = CryptoJS.enc.Utf8.parse(llave);
        ...
        var arregloDesencriptado = arregloEncriptado.map(function(encriptado) {
            var encriptadoWordArray = CryptoJS.enc.Hex.parse(encriptado);
