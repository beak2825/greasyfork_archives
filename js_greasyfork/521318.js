...
// @collaborator ya
// @icon 
// @downloadURL https://update.greasyfork.org/scripts/521318/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20CHERRY.user.js
// @updateURL https://update.greasyfork.org/scripts/521318/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20CHERRY.meta.js
// ==/UserScript==
...
"[CENTER][Color=rgb(255, 0, 0)]Отказано.[/color]",
...
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Жалобы от 3-его лица не рассматриваются.<br><br>"+
"[CENTER][Color=rgb(255, 0, 0)]Отказано.[/color]",
prefix: UNACCEPT_PREFIX,
status: false,
},
...
{
title: ' Ссылка на отказ ',
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Прикрепите ссылку на отказанную тему.<br><br>"+
"[CENTER][Color=rgb(255, 0, 0)]Закрыто.[/color]",
prefix: CLOSE_PREFIX,
status: false,
},
{
...
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Ваши доказательства отредактированы.<br><br>"+
"[CENTER][Color=rgb(255, 0, 0)]Отказано.[/color]",
prefix: UNACCEPT_PREFIX,
status: false,
},
...
"[CENTER]Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.436/'][COLOR=rgb(255,0,0)]««Обжалование наказаний»».[/color][/URL][/CENTER]<br><br>"+
"[CENTER][Color=rgb(255, 0, 0)]Отказано.[/color]",
prefix: UNACCEPT_PREFIX,
status: false,
},
{
title: ' В Обжалование Наказаний (Ник)',
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.436/'][COLOR=rgb(255,0,0)]««Обжалование наказаний»».[/color][/URL][/CENTER]<br><br>"+
"[CENTER][Color=rgb(255, 0, 0)]Отказано.[/color]",
...
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Данный администратор является или являлся техническим специалистом, поэтому вам необходимо обратиться в раздел [URL='https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%969-cherry.1190/'][COLOR=rgb(255,0,0)]««Жалобы на технических специалистов»».[/color][/URL][/CENTER]<br><br>"+
"[CENTER][Color=rgb(255, 0, 0)]Отказано.[/color]",
prefix: UNACCEPT_PREFIX,
status: false,
},
...
{
title: ' Наказание было снято (Адм) ',
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Наказание было снято, после того, как администратор увидел ошибку.<br><br>"+
"[CENTER][Color=rgb(255, 0, 0)]Закрыто.[/color]",
prefix: CLOSE_PREFIX,
status: false,
},
...
"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено.[/color]",
...
{
title: ' Наказание и GunWarn будут сняты ',
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Наказание и GunWarn будут сняты.<br><br>"+
"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено.[/color]",
prefix: ACCEPT_PREFIX,
status: false,
},
{
title: ' Наказание перевыдано ',
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Наказание перевыдано.<br><br>"+
"[CENTER][Color=rgb(255, 0, 0)]Закрыто.[/color]",
prefix: CLOSE_PREFIX,
status: false,
},
...
{
title: ' [Forum] Биография будет пересмотрена ',
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Биография будет пересмотрена.<br><br>"+
"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено.[/color]",
prefix: ACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Ваша жалоба будет передана [Color=rgb(255, 0, 0)]Главному администратору[/Color] - @Ronald Kõlman ☭︎ на рассмотрение.<br>"+
...
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Ваша жалоба будет передана [Color=rgb(255, 0, 0)]Заместителям Главного Администратора[/Color] -  @Vanya Donissimo @Nikolay_Kashtanov на рассмотрение.<br>"+
"[CENTER]Просьба не создавать подобных тем, иначе форумный аккаунт может быть заблокирован.<br><br>"+
'[CENTER][Color=rgb(255, 255, 0)]На Рассмотрении...[/Color][/CENTER][/SIZE]',
prefix: PIN_PREFIX,
status: true,
...
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Ваша жалоба будет передана [Color=rgb(255, 0, 0)]Специальной Администрации[/Color] на рассмотрение.<br>"+
"[CENTER]Просьба не создавать подобных тем, иначе форумный аккаунт может быть заблокирован.<br><br>"+
'[CENTER][Color=rgb(255, 255, 0)]На Рассмотрении...[/Color][/CENTER][/SIZE]',
prefix: SA_PREFIX,
status: true,
...
content:
'[SIZE=4][FONT=Times New Roman][CENTER][Color=rgb(255, 0, 255)]{{ greeting }},[/Color] уважаемый {{ user.mention }}!<br><br>'+
"[CENTER]Ваша жалоба будет передана Руководителям модераторов Forum/Discord на рассмотрение. Просьба не создавать подобных тем, иначе ваш Форумный аккаунт может быть [Color=rgb(255, 0, 0)][U]заблокирован.[/U][/Color][/CENTER]<br><br>"+
'[CENTER][Color=rgb(255, 255, 0)]На Рассмотрении...[/Color][/CENTER][/SIZE]',
