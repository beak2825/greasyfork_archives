// ==UserScript==
// @name         hs自用国家中小学智慧教育平台刷课脚本（16倍速，自动答题，自动切换列表中的视频，后台播放，学时不更新的解决方法看下面）
...
(function () {
  ...
  const rateMenu = [{ title: "1x", value: 1 }, { title: "1.5x", value: 1.5 }, { title: "2x", value: 2 }, { title: "2.5x", value: 2.5 }, { title: "3x", value: 3 }]
