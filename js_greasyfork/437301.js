// ==UserScript==
// @name			★Moomoo.io Reverse Name & Health Bar Working! 2021
// @version			1.0
// @description		Reverse!
// @author			xPlasmicc
// @match			*://moomoo.io/*
...
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/437301/%E2%98%85Moomooio%20Reverse%20Name%20%20Health%20Bar%20Working%21%202021.user.js
// @updateURL https://update.greasyfork.org/scripts/437301/%E2%98%85Moomooio%20Reverse%20Name%20%20Health%20Bar%20Working%21%202021.meta.js
// ==/UserScript==
                ...
                if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                    ...
                    if ("" != w) {
                        ...
                        _.isLeader && Rn.crown.isLoaded) {
                            ...
                            be.drawImage(Rn.crown, k, _.y - d - _.scale - o.nameY + 150 - b / 2 - 5, b, b)
                        }
                        1 == _.iconIndex && Rn.skull.isLoaded && (b = o.crownIconScale,
                        k = _.x - f - b / 2 + be.measureText(w).width / 2 + o.crownPad,
                        be.drawImage(Rn.skull, k, _.y - d - _.scale - o.nameY + 150 - b / 2 - 5, b, b))
                    }
                    _.health > 0 && (o.healthBarWidth,
                    be.fillStyle = rt,
                    be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY - 135, 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8),
                    be.fill(),
                    be.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151",
                    be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad - 135, 2 * o.healthBarWidth * (_.health / _.maxHealth), 17 - 2 * o.healthBarPad, 7),
                    be.fill())
                }
