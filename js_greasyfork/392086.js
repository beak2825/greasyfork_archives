// ==UserScript==
// @name        CosmosisT's TinyChat Script (CTS V1.8.66 FINAL)
// @version     1.8.66 (FINAL)
...
// @downloadURL https://update.greasyfork.org/scripts/392086/CosmosisT%27s%20TinyChat%20Script%20%28CTS%20V1866%20FINAL%29.user.js
// @updateURL https://update.greasyfork.org/scripts/392086/CosmosisT%27s%20TinyChat%20Script%20%28CTS%20V1866%20FINAL%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    popup.innerHTML = `
      <div id="tinychat-closed-popup" style="
        ...
        <div style="
          ...
          <div style="
            ...
            background:#eee;border-radius:50%;font-weight:bold;
            font-size:16px;line-height:1;">×</div>

          <h2 style="margin-top:0;">RIP Tinychat 😢</h2>
          <p>Yeah... whatever this is now, it’s not the Tinychat we loved.</p>
          <p>But good news: we’ve made a new home!</p>
          <a href="https://stumblechat.com" target="_blank" style="
             color:#007bff;font-weight:bold;display:block;margin-top:1rem;">
             👉 Visit StumbleChat.com</a>
          <p style="margin-top:1rem;">Forget this site. We moved on, you should too 💬❤️</p>
        </div>
      </div>
    `;
    document.body.appendChild(popup);

    popup.querySelector('div[style*="position:absolute"]').onclick = () => {
        popup.remove();
    };
    //DEBUGGER
