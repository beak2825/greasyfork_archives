...
// @grant        none
// @namespace https://greasyfork.org/users/1393284
// @downloadURL https://update.greasyfork.org/scripts/516502/Khan%20Answers.user.js
// @updateURL https://update.greasyfork.org/scripts/516502/Khan%20Answers.meta.js
// ==/UserScript==
...
(function () {
    ...
    class Answer {
        ...
        log() {
            ...
            const style = "color: darkred; -webkit-text-stroke: .5px black; font-size:24px; font-weight:bold;";
...
let item, question;
                    ...
                    try {
                        ...
                        if (errorIteration() < 4) {
                            ...
                            return console.log("%c An error occurred", "color: yellow; font-weight: bolder; font-size: 20px;");
                        }
                    }
            ...
            if (!window.loaded) {
                console.clear();
                console.log("%c Answer Revealer ", "color: lightblue; -webkit-text-stroke: .5px black; font-size:40px; font-weight:bolder; padding: .2rem;");
                console.log("%cCreated by Aarya Tiwari (@aarya_.t)", "color: lightgreen; -webkit-text-stroke: .5px black; font-size:15px; font-weight:bold;");
                window.loaded = true;
            }
...
// use tampermonkey(chrome extension) and go to create new script, click copy and paste