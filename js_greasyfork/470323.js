...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/470323/fix%EF%BC%9Anf%E6%8B%9B%E8%81%98%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/470323/fix%EF%BC%9Anf%E6%8B%9B%E8%81%98%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
(function () {
    ...
    let helloCount = 0;
     const updateButton = () => {
        el.innerText = checking ? `停止打招呼 (${helloCount}/${count})` : `自动打招呼 (${helloCount}/${count})`;
     ...
     const sayHello = () => {
        ...
        const button = list.querySelector(".resume-button button");
        if (button && button.innerText.includes("打招呼")) {
            button.click();
     ...
     el.addEventListener("click", function () {
        if (checking) {
            ...
            checking = setInterval(() => {
                timer = setTimeout(() => {
                    sayHello();
                    const chart = document.querySelector(".im-container.km-layout .km-main");
