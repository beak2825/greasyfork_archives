// ==UserScript==
// @name         ORENBRUG | Скрипт для Руководства
...
// @author       Matvey_Kyrdukov I don't write about love! <1
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @icon         https://icons.iconarchive.com/icons/papirus-team/papirus-apps/48/emerald-theme-manager-icon-icon.png
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/495371/ORENBRUG%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/495371/ORENBRUG%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            "[url=https://postimages.org/][img]https://i.postimg.cc/wMypxYkt/RLwzo.png[/img][/url]<br>"+
            "У администратора были запрошены доказательства выданного наказания.<br>"+
            "Ожидайте ответа.<br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/zXxrMRLf/2023-08-20-174519042.png[/img][/url]<br>"+
            '[COLOR=yellow]На рассмотрении.[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
            ...
            "[url=https://postimages.org/][img]https://i.postimg.cc/zXxrMRLf/2023-08-20-174519042.png[/img][/url]<br>"+
            "[CENTER][COLOR=#00FA9A]Одобрено[/COLOR], Закрыто.[/FONT][/CENTER]<br>"+
            "<br>"+
            '[FONT=Verdana]Приятной игры на сервере [COLOR=orange]ORENBURG[/COLOR][/FONT][/CENTER]',
            prefix: ACCEPT_PREFIX,
            status: false,
        },
         {
            title: 'Беседа с адм жб',
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/wMypxYkt/RLwzo.png[/img][/url]<br>"+
            "Ваша жалоба была рассмотрена и одобрена.<br>"+
            "Будут предприняты необходимые меры в отношении администратора.<br>"+
            "Приносим извинения за причиненные неудобства.<br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/zXxrMRLf/2023-08-20-174519042.png[/img][/url]<br>"+
            "[CENTER][COLOR=#00FA9A]Одобрено[/COLOR], Закрыто.[/FONT][/CENTER]<br>"+
            "<br>"+
        ...
        },
        {
            ...
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/wMypxYkt/RLwzo.png[/img][/url]<br>"+
            "После изучения представленных вами доказательств мы не обнаружили нарушений со стороны администратора.<br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/zXxrMRLf/2023-08-20-174519042.png[/img][/url]<br>"+
        ...
        },
        {
            ...
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/wMypxYkt/RLwzo.png[/img][/url][/url]<br>"+
            "Администратор предоставил доказательства.<br>"+
            "Наказание выдано верно.<br>"+
            "[url=https://postimages.org/][img]https://i.postimg.cc/zXxrMRLf/2023-08-20-174519042.png[/img]<br>"+
            "[COLOR=RED]Закрыто.[/COLOR][/FONT][/CENTER]<br>"+
            "<br>"+
            '[FONT=Verdana]Приятной игры на сервере [COLOR=orange]ORENBURG[/COLOR][/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
