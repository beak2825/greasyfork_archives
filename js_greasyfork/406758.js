// ==UserScript==
// @name         Rust Workshop Skin ID Collector
...
// @downloadURL https://update.greasyfork.org/scripts/406758/Rust%20Workshop%20Skin%20ID%20Collector.user.js
// @updateURL https://update.greasyfork.org/scripts/406758/Rust%20Workshop%20Skin%20ID%20Collector.meta.js
// ==/UserScript==

(function() {
    'use strict';

    // Short names table where the originating source failes to match.
  ...
  `);
    ...
    function parseSkinID() {
        ...
        var command = 'skin add ' + short_name + ' ' + model_ID;
    ...
    function displayNotification() {
        ...
        snack_bar.innerHTML = display_name + ' skin import command added to clipboard.';
