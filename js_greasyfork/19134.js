...
// @downloadURL https://update.greasyfork.org/scripts/19134/Flat%20Darkness%20-%20Stable.user.js
// @updateURL https://update.greasyfork.org/scripts/19134/Flat%20Darkness%20-%20Stable.meta.js
// ==/UserScript==
...
$(document).ready(function () {
    ...
    $('img[src$="https://hackforums.net/images/modern_bl/spinner_big.gif"]').attr('src', 'http://i.imgur.com/y3wDcUA.gif'); // Quick Reply Spinner Change
    ...
    if(showLogo === true){ // Show Logo
        $('img[src$="https://hackforums.net/images/modern_bl/logo_bl.gif"]').attr('src', 'http://i.imgur.com/fAzkq6w.png');
    ...
    if(window.location.pathname != "/private.php") {
        var userName = $('strong > a[href^="https://hackforums.net/member.php?action=profile&uid="]').text();
    ...
    if(badges === true) {
        ...
        for(var I = 0; I < staffList.length; I++) {
            $("a[href='https://hackforums.net/member.php?action=profile&uid=" + staffList[I] + "']").append('<img title="HF Staff" src="http://i.imgur.com/mfqIyM9.png" style="position: relative;top: 3px;left: 3px;">');
        }
        for(var I = 0; I < mentorList.length; I++) {
            $("a[href='https://hackforums.net/member.php?action=profile&uid=" + mentorList[I] + "']").append('<img title="HF Mentor" src="http://i.imgur.com/mfqIyM9.png" style="position: relative;top: 3px;left: 3px;">');
        }
        for(var I = 0; I < adminList.length; I++) {
            $("a[href='https://hackforums.net/member.php?action=profile&uid=" + adminList[I] + "']").append('<img title="Omniscient" src="http://i.imgur.com/mfqIyM9.png" style="position: relative;top: 3px;left: 3px;">');
        }
        for(var I = 0; I < groupLeadersList.length; I++) {
            $("a[href='https://hackforums.net/member.php?action=profile&uid=" + groupLeadersList[I] + "']").append('<img title="HF Group Leader" src="http://i.imgur.com/mfqIyM9.png" style="position: relative;top: 3px;left: 3px;">');
        }
    }
    ...
    $('a[href="https://hackforums.net/member.php?action=profile&uid=561239"] > span[class^="group"]').append('<img title="Developer of Flat Darkness" src="http://i.imgur.com/EpQPylI.png" style="position: relative;top: 3px;left: 3px;"/>');
    $('a[href="https://hackforums.net/member.php?action=profile&uid=2377407"] > span[class^="group"]').append('<img title="Developer of Flat Darkness" src="http://i.imgur.com/EpQPylI.png" style="position: relative;top: 3px;left: 3px;"/>');
