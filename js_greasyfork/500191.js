...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/500191/mail%20modifier.user.js
// @updateURL https://update.greasyfork.org/scripts/500191/mail%20modifier.meta.js
// ==/UserScript==
(function(){
	'use strict';
	...
	window.addEventListener('load', function(){
		...
		window.addEventListener('popstate', function(event) {
			...
			if(urlCheckResult.isQueryTargetMess){
				...
				setTimeout(() => fakeMail(),1000);
				setTimeout(() => fakeMail(),2000);
