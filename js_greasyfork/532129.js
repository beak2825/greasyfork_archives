// ==UserScript==
// @name         Moderator + Dropdown Roles Button
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/532129/Moderator%20%2B%20Dropdown%20Roles%20Button.user.js
// @updateURL https://update.greasyfork.org/scripts/532129/Moderator%20%2B%20Dropdown%20Roles%20Button.meta.js
// ==/UserScript==
 ...
 if (currentUrl.includes('/admin.php?moderators/add')) {
    ...
    if (currentUrl.includes('/admin.php?users/') && currentUrl.includes('/edit')) {
        window.addEventListener('load', () => {
            ...
            select.addEventListener('change', () => {
                const anapaCheckbox = document.querySelector('input[type="checkbox"][value="74"]');
    ...
    if (currentUrl.includes('/admin.php?moderators/add')) {
        window.addEventListener('load', () => {
            ...
            const eventOption = document.querySelector('select[name="type_id[node]"] option[value="2053"]');
            if (eventOption) {
                setTimeout(() => {
