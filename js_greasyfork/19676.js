...
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/19676/IRCTC.user.js
// @updateURL https://update.greasyfork.org/scripts/19676/IRCTC.meta.js
// ==/UserScript==
   ...
   if(document.getElementById('loginbutton')){
      ...
      //  document.getElementsByClassName('grid_16 omega g_box')[0].style="display: none";
          ...
          document.getElementById('loginbutton').addEventListener('click', function(){
           setCookie("loginid",document.getElementsByClassName('loginUserId')[0].value, 15);
           setCookie("loginpass",document.getElementsByClassName('loginPassword')[0].value, 15);
           ...
           function clock(){
            ...
            DateArr['seconds'] = date.getSeconds().toString();
             ...
             var lat=la.length;
              document.getElementsByClassName('grid_16 omega g_box')[0].style="FONT:bold 25px arial; width:13em;color:#FF0000;";
    ...
    function book(){
            if(getCookie("cty")){var cty=getCookie("cty");
              if (document.getElementById('refid1') && document.getElementById('avlAndFareForm:quota').value !=cty) {
                  setCookie("cty",document.getElementById('avlAndFareForm:quota').value,1);document.getElementsByName('cty')[0].value=getCookie("cty");}}
            ...
            if (document.getElementById('refid1')) {var bid = train+"-"+cls+"-"+cty+"-0";}
             if (document.getElementById('avlAndFareForm:cc').value == "false" && dq && (con=="Y"||con=="PY"))
...
function clock(){
           ...
           var at=a.length;
           if(sn<=snt && at>=5){document.getElementById('cno').click();$("#addPassengerForm\\:jpProceedBooking").click();return false;}
           window.setTimeout(clock, 1000);
             }
