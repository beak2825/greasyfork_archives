// ==UserScript==
// @name         my mediasite Caption Crawler
// @namespace    http://tampermonkey.net/
// @version      0.1.6
// @description  Download mediasite Captions, mostly copied from "Xuetangx Caption Crawler"(https://greasyfork.org/zh-CN/scripts/408878-xuetangx-caption-crawler)
// @author       hotongue
// @match        https://mediasite.csom.umn.edu/Mediasite/*
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/446174/my%20mediasite%20Caption%20Crawler.user.js
// @updateURL https://update.greasyfork.org/scripts/446174/my%20mediasite%20Caption%20Crawler.meta.js
// ==/UserScript==
...
function download_caption(){
    document.getElementsByClassName('mediasite-player-caption-item')[0].click();
    var title = document.getElementsByClassName('mediasite-player-caption-item')[0].innerText.split('\n')[0];
    var caption = document.getElementsByClassName('mediasite-player-caption-item')[0].innerText;
...
function create_download_button(){
    console.log('create_download_button');
    if(!document.getElementsByIdName('controls-left')[0]) {
        console.log('create_download_button failed');
        return;
    }
    ...
    //     try_download_caption();
    // }
    button_element.setAttribute("button", "ccDL");
    button_element.innerHTML = "下载本节字幕";
    ...
    document.getElementsByClassName('controls-left')[0].appendChild(button_element);
    console.log('create_download_button done!');
}
...
window.onload = function(){
    console.log('my mediasite Caption Crawler Running!');
