...
// @downloadURL https://update.greasyfork.org/scripts/505961/bod%20bot%20empire%20game.user.js
// @updateURL https://update.greasyfork.org/scripts/505961/bod%20bot%20empire%20game.meta.js
// ==/UserScript==
...
function processMessageQueue() {
  ...
  try {
    ...
    if (type === "msg") {
      ...
      throw new Error("Invalid Send type or missing handle for pvtmsg");
    }
    ...
    function reconnectWebSocket() {
      if (CTS.SocketTarget.readyState === WebSocket.CLOSED) {
        console.log("Attempting to reconnect WebSocket..."); // Implement your WebSocket reconnection logic here
        CTSWebSocket(); // Assuming this function initializes the WebSocket
        // You might want to add a delay or exponential backoff for repeated attempts
        setTimeout(checkWebSocketStatus, 5000); // Check again after 5 seconds
      }
    } // Example function to check WebSocket status
    ...
    function CTSRoomInject() {
      ...
      window.CTSChatCSS = [
        ...
        [
          //STYLE #25
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(240,240,240)0%,rgb(200,200,200)calc(100% - 62px),rgb(240,240,240)100%)!important;}#cts-chat-content>.message{background:#222;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#ddd;}.PMPopup h2{background:linear-gradient(0deg,rgb(100,100,100)0%,rgb(200,200,200)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#999;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#aaa;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#888;}#videos-footer-push-to-talk{background:#aaa;}#videos-footer-push-to-talk:hover{background:#888;}#videos-footer-broadcast:hover{background:#888;}#videos-footer-broadcast{background:#aaa;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(50,50,50)0%,rgb(100,100,100)100%);}"
          ]
        ],
        [
          //STYLE #26
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(255,182,193)0%,rgb(255,105,180)calc(100% - 62px),rgb(255,20,147)100%)!important;}#cts-chat-content>.message{background:#ff69b4;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#ffb6c1;}.PMPopup h2{background:linear-gradient(0deg,rgb(255,105,180)0%,rgb(255,182,193)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#ff69b4;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#ff69b4;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#ff1493;}#videos-footer-push-to-talk{background:#ff69b4;}#videos-footer-push-to-talk:hover{background:#ff1493;}#videos-footer-broadcast:hover{background:#ff1493;}#videos-footer-broadcast{background:#ff69b4;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(255,105,180)0%,rgb(255,20,147)100%);}"
          ]
        ],
        [
          //STYLE #27
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(75,0,130)0%,rgb(138,43,226)calc(100% - 62px),rgb(186,85,211)100%)!important;}#cts-chat-content>.message{background:#4b0082;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#9932cc;}.PMPopup h2{background:linear-gradient(0deg,rgb(138,43,226)0%,rgb(186,85,211)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#8a2be2;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#8a2be2;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#7b68ee;}#videos-footer-push-to-talk{background:#8a2be2;}#videos-footer-push-to-talk:hover{background:#7b68ee;}#videos-footer-broadcast:hover{background:#7b68ee;}#videos-footer-broadcast{background:#8a2be2;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(75,0,130)0%,rgb(138,43,226)100%);}"
          ]
        ],
        [
          //STYLE #28
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(135,206,250)0%,rgb(30,144,255)calc(100% - 62px),rgb(0,191,255)100%)!important;}#cts-chat-content>.message{background:#1e90ff;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#87cefa;}.PMPopup h2{background:linear-gradient(0deg,rgb(30,144,255)0%,rgb(135,206,250)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#00bfff;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#1e90ff;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#4682b4;}#videos-footer-push-to-talk{background:#1e90ff;}#videos-footer-push-to-talk:hover{background:#4682b4;}#videos-footer-broadcast:hover{background:#4682b4;}#videos-footer-broadcast{background:#1e90ff;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(30,144,255)0%,rgb(0,191,255)100%);}"
          ]
        ],
        [
          //STYLE #29
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(220,20,60)0%,rgb(255,69,0)calc(100% - 62px),rgb(255,99,71)100%)!important;}#cts-chat-content>.message{background:#ff4500;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#ff6347;}.PMPopup h2{background:linear-gradient(0deg,rgb(255,69,0)0%,rgb(220,20,60)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#ff4500;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#ff4500;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#dc143c;}#videos-footer-push-to-talk{background:#ff4500;}#videos-footer-push-to-talk:hover{background:#dc143c;}#videos-footer-broadcast:hover{background:#dc143c;}#videos-footer-broadcast{background:#ff4500;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(255,69,0)0%,rgb(255,99,71)100%);}"
          ]
        ],
        [
          //STYLE #30
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(47,79,79)0%,rgb(0,128,128)calc(100% - 62px),rgb(72,209,204)100%)!important;}#cts-chat-content>.message{background:#008b8b;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#48d1cc;}.PMPopup h2{background:linear-gradient(0deg,rgb(0,128,128)0%,rgb(47,79,79)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#00ced1;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#00ced1;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#20b2aa;}#videos-footer-push-to-talk{background:#00ced1;}#videos-footer-push-to-talk:hover{background:#20b2aa;}#videos-footer-broadcast:hover{background:#20b2aa;}#videos-footer-broadcast{background:#00ced1;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(0,128,128)0%,rgb(72,209,204)100%);}"
          ]
        ],
        [
          //STYLE #31
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(255,165,0)0%,rgb(255,140,0)calc(100% - 62px),rgb(255,215,0)100%)!important;}#cts-chat-content>.message{background:#ff8c00;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#ffa500;}.PMPopup h2{background:linear-gradient(0deg,rgb(255,140,0)0%,rgb(255,165,0)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#ff8c00;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#ff8c00;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#ff7f50;}#videos-footer-push-to-talk{background:#ff8c00;}#videos-footer-push-to-talk:hover{background:#ff7f50;}#videos-footer-broadcast:hover{background:#ff7f50;}#videos-footer-broadcast{background:#ff8c00;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(255,140,0)0%,rgb(255,215,0)100%);}"
          ]
        ],
        [
          //STYLE #32
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(124,252,0)0%,rgb(50,205,50)calc(100% - 62px),rgb(144,238,144)100%)!important;}#cts-chat-content>.message{background:#32cd32;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#90ee90;}.PMPopup h2{background:linear-gradient(0deg,rgb(50,205,50)0%,rgb(124,252,0)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#00fa9a;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#00fa9a;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#66cdaa;}#videos-footer-push-to-talk{background:#00fa9a;}#videos-footer-push-to-talk:hover{background:#66cdaa;}#videos-footer-broadcast:hover{background:#66cdaa;}#videos-footer-broadcast{background:#00fa9a;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(50,205,50)0%,rgb(144,238,144)100%);}"
          ]
        ],
        [
          //STYLE #33
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(255,255,0)0%,rgb(255,215,0)calc(100% - 62px),rgb(255,255,102)100%)!important;}#cts-chat-content>.message{background:#ffd700;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#ffffe0;}.PMPopup h2{background:linear-gradient(0deg,rgb(255,215,0)0%,rgb(255,255,0)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#ffeb3b;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#ffeb3b;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#ffc107;}#videos-footer-push-to-talk{background:#ffeb3b;}#videos-footer-push-to-talk:hover{background:#ffc107;}#videos-footer-broadcast:hover{background:#ffc107;}#videos-footer-broadcast{background:#ffeb3b;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(255,215,0)0%,rgb(255,255,102)100%);}"
          ]
        ],
        [
          //STYLE #34
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(47,79,79)0%,rgb(72,61,139)calc(100% - 62px),rgb(106,90,205)100%)!important;}#cts-chat-content>.message{background:#483d8b;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#6a5acd;}.PMPopup h2{background:linear-gradient(0deg,rgb(72,61,139)0%,rgb(106,90,205)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#7b68ee;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#7b68ee;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#9370db;}#videos-footer-push-to-talk{background:#7b68ee;}#videos-footer-push-to-talk:hover{background:#9370db;}#videos-footer-broadcast:hover{background:#9370db;}#videos-footer-broadcast{background:#7b68ee;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(72,61,139)0%,rgb(106,90,205)100%);}"
          ]
        ],
        [
          //STYLE #35
          [
            "#chat-wrapper{background:linear-gradient(0deg,rgb(255,69,0)0%,rgb(255,99,71)calc(100% - 62px),rgb(255,165,0)100%)!important;}#cts-chat-content>.message{background:#ff6347;color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
          ],
          [
            ".PMPopup .PMContent{background:#ff7f50;}.PMPopup h2{background:linear-gradient(0deg,rgb(255,99,71)0%,rgb(255,69,0)100%);}#videos-footer-broadcast-wrapper>.waiting{background:#ff4500;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:#ff4500;}#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:#dc143c;}#videos-footer-push-to-talk{background:#ff4500;}#videos-footer-push-to-talk:hover{background:#dc143c;}#videos-footer-broadcast:hover{background:#dc143c;}#videos-footer-broadcast{background:#ff4500;}"
          ],
          [
            "#sidemenu{background:linear-gradient(0deg,rgb(255,69,0)0%,rgb(255,165,0)100%);}"
          ]
        ],
        [
          //STYLE #36
...
//STYLE #45
[
  "#chat-wrapper{background:linear-gradient(0deg,rgba(255,105,180,0.5) 0%,rgba(139,0,139,0.5) calc(100% - 62px),rgba(255,105,180,0.5) 100%)!important;}",
  "#cts-chat-content>.message{background:rgba(139,0,139,0.5);color:#FFF;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;}"
],
[
  ".PMPopup .PMContent{background:rgba(255,105,180,0.5);}.PMPopup h2{background:linear-gradient(0deg,rgba(139,0,139,0.5) 0%,rgba(255,105,180,0.5) 100%);}",
  "#videos-footer-broadcast-wrapper>.waiting{background:linear-gradient(0deg,rgba(255,105,180,0.5) 0%,rgba(139,0,139,0.5) 100%);}",
  "#videos-footer-broadcast-wrapper>#videos-footer-submenu-button{background:linear-gradient(0deg,rgba(255,105,180,0.5) 0%,rgba(139,0,139,0.5) 100%);}",
  "#videos-footer-broadcast-wrapper>#videos-footer-submenu-button:hover{background:rgba(255,105,180,0.5);}",
  "#videos-footer-push-to-talk{background:linear-gradient(0deg,rgba(255,105,180,0.5) 0%,rgba(139,0,139,0.5) 100%);}",
  "#videos-footer-push-to-talk:hover{background:rgba(255,105,180,0.5);}",
  "#videos-footer-broadcast:hover{background:rgba(255,105,180,0.5);}",
  "#videos-footer-broadcast{background:linear-gradient(0deg,rgba(255,105,180,0.5) 0%,rgba(139,0,139,0.5) 100%);}"
],
[
  "#sidemenu{background:linear-gradient(0deg,rgba(255,105,180,0.5) 0%,rgba(139,0,139,0.5) 70%);}"
]
