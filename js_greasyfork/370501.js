...
// @downloadURL https://update.greasyfork.org/scripts/370501/Agar%20Video%20Skin%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/370501/Agar%20Video%20Skin%20Script.meta.js
// ==/UserScript==
		...
		var o = {
            ...
            f: {
                ...
                unload_video: function() {
                    o.l.video.src = "", o.l.video = !1, o.u.toggle_options(!1), o.u.unpopulate_nickname(), o.f.prototype_override("canvas", "drawImage", "before", function(e, t) {}), o.f.prototype_override("mc", "onPlayerSpawn", "before", function(e, t) {}), o.f.prototype_override("mc", "onPlayerDeath", "before", function(e, t) {})
                }
            },
            u: {
                ...
                html: function() {
                    ...
                    return e += '<button id="tcm-video-load">select video skin</button>', e += '<input type="file" accept="video/*" id="tcm-video-input" />', e += '<div id="tcm-videoskin-options">', e += '<button id="tcm-video-unload">unselect video skin</button>', e += '<button id="tcm-video-mute">mute audio</button>', e += "</div>", e += '<span id="tcm-videoskin-credits">Script made by <a href="http://www.jimboy3100.github.io" target="_blank">Jimboy3100</a>.</span>', e += "</div>"
                }
            }
        };
        document.getElementById("mainui-ads").insertAdjacentHTML("beforeBegin", o.u.html()), document.getElementById("tcm-video-load").addEventListener("click", function() {
