...
// @version      1.0.9
// @description  打开斗鱼官网的任意直播间即可自动解析出直播流地址，播放地址长期有效，该地址可以用 黑鸟播放器 或 VLC 或其他自定义URL的播放器打开播放..
// @author       黑鸟博客
// @include      http://www.douyu.com/*
// @include      https://www.douyu.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/374777/%E6%96%97%E9%B1%BC%E7%9B%B4%E6%92%AD%E5%9C%B0%E5%9D%80%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/374777/%E6%96%97%E9%B1%BC%E7%9B%B4%E6%92%AD%E5%9C%B0%E5%9D%80%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
...
(function() {
    ...
    var boxHtml = '未知错误！';
    if( window.$ROOM.show_status =='2'){
        boxHtml = '未知错误！<br>';
    }
    if(window.$ROOM.show_status =='1'){
        boxHtml = '未知错误！<br>';
        try{
                var absUrlzq = "解析错误！！";
                var preURL ="解析错误！！";
                boxHtml += '<div class="flv-url-item"><label>地址</label><input id="flv-url-1" value="解析错误！！"/><a onclick="copyFlvUrl(1)">复制</a></div><p align="center">BY <a href="https://guihet.com/" style="color:#0000FF">黑鸟博客</a></p>';
        }catch(e){
            boxHtml += '解析流数据错误';
            console.error(e);
        }
    ...
    if(window.$ROOM.show_status !='1' && window.$ROOM.show_status !='2'){
        boxHtml = '未知错误！当前无法解析流数据<br>';
    }
