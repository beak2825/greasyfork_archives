...
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/370192/Tieba%20Imagizer.user.js
// @updateURL https://update.greasyfork.org/scripts/370192/Tieba%20Imagizer.meta.js
// ==/UserScript==
			...
			$.ajax({
				...
				success:function(c){
					if(c.error_code) error(); else {
						var e='https://imgsa.baidu.com/forum/pic/item/'+c.info.pic_id_encode+'.jpg';
