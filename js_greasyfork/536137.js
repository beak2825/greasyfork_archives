...
// @icon         http://post-images.org/photo-page.php?photo=p40ZmQI2
// @grant        none
// @license    MIT
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/536137/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/536137/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=#ff0000]Главному администратору @ilya vifer♡[/COLOR], пожалуйста ожидайте ответа.<br><br>"+
                "[B][CENTER][COLOR=BLUE]С уважением [/COLOR][COLOR=BLUE]Главный Куратор Форума.[/COLOR]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url]<br>",
	  prefix: GA_PREFIX,
	  status: true,
