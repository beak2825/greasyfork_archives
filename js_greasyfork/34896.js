...
// @downloadURL https://update.greasyfork.org/scripts/34896/Hybrid%20-%20Categorize%20races%20in%20photos%202.user.js
// @updateURL https://update.greasyfork.org/scripts/34896/Hybrid%20-%20Categorize%20races%20in%20photos%202.meta.js
// ==/UserScript==

if ($('li:contains("11/6")').length) {
    var div = [],
        count = 2,
        divBy,
        color = '#8cffe6',
