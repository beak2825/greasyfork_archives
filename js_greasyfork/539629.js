// ==UserScript==
// @name         测试华医网脚本测试华医网脚本测试华医网脚本测试华医网脚本
...
// @downloadURL https://update.greasyfork.org/scripts/539629/%E6%B5%8B%E8%AF%95%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%84%9A%E6%9C%AC%E6%B5%8B%E8%AF%95%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%84%9A%E6%9C%AC%E6%B5%8B%E8%AF%95%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%84%9A%E6%9C%AC%E6%B5%8B%E8%AF%95%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/539629/%E6%B5%8B%E8%AF%95%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%84%9A%E6%9C%AC%E6%B5%8B%E8%AF%95%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%84%9A%E6%9C%AC%E6%B5%8B%E8%AF%95%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%84%9A%E6%9C%AC%E6%B5%8B%E8%AF%95%E5%8D%8E%E5%8C%BB%E7%BD%91%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
(function () {
  ...
  if (!['course_ware_polyv.aspx', 'course_ware_cc.aspx', 'exam.aspx', 'course.aspx', 'cme.aspx', 'exam_result.aspx'].includes(urlTip)) return
  // advis();
  ...
  function getHuayi() {
    return {
      ...
      seeVideo: function (e) {
        ...
        switch (e) {
          case 1:
            var defPolyvPlayer = window.polyvPlayer
            window.polyvPlayer = (params) => {
              if (typeof params === 'object') {
                params.ban_seek_by_limit_time = 'off';  // 允许随意拖拽进度条
                params.speed = [1, 2, 3];  // 开启倍速控制，网页视频的插件限制为最多为3
              }
              return defPolyvPlayer.call(window, params)
            }
            var timer = setInterval(() => {
              if (!window.player) return
              clearInterval(timer)
              window.s2j_onPlayerInitOver()
              window.player.once('s2j_onReadyPlay', () => {
                window.player.j2s_resumeVideo()
              })
              window.player.once('s2j_onPlayStart', () => {
                setTimeout(() => {
                  window.player.changeRate(3)
                  window.player.j2s_setVolume(0)
                  examherftest()
                  window.player.HTML5.observer._events.videoSeeked.forEach((e, index) => {
                    if (e.toString().indexOf('function () { [native code] }') < 0) {
                      window.player.HTML5.observer._events.videoSeeked[index] = () => { }
                    }
                  })
                }, 3000)
              })
      ...
      doResult: async function () {
        ...
        if (res == "考试通过" || res == "考试通过！" || res == "完成项目学习可以申请学分了" || res === "本课件已学习完毕") { //考试通过
          console.log("考试通过");
