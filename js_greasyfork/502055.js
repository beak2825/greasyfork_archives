...
// @downloadURL https://update.greasyfork.org/scripts/502055/for%20the%20management%20of%20the%20technical%20department.user.js
// @updateURL https://update.greasyfork.org/scripts/502055/for%20the%20management%20of%20the%20technical%20department.meta.js
// ==/UserScript==
...
(function () {
    ...
    },
    {
      ...
      {
		title: 'багоюз подарков',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
		content:
            "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
		'[COLOR=rgb(0, 255, 127)][FONT=georgia][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
		'[CENTER]К сожалению, ваш игровой аккаунт не может быть разблокирован, поскольку факт нарушения подтвержден. Если вы желаете продолжить игру, мы рекомендуем создать новый аккаунт.<br>Важно отметить, что обнаруженная недоработка не предполагает её использование. В будущем просим вас сообщать о любых обнаруженных недоработках нашим техническим специалистам.<br>[/CENTER]<br>'+
		'[CENTER]Сожалеем, но доступ к аккаунту [COLOR=rgb(255,0,0)]заблокирован.[/COLOR][/CENTER]<br><br>'+
          '[CENTER][COLOR=rgb(255,0,0)][SIZE=4][I][ICODE]Отказано.[/ICODE][/COLOR][/FONT][/CENTER]<br><br>'+
            "[CENTER][IMG width=695px]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG]<br>",
		...
		content:
            "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
		'[COLOR=rgb(0, 255, 127)][FONT=georgia][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
		'[CENTER]Для блогеров, как публичных лиц, у нас существует отдельный регламент и своя система наказаний.<br>Все решения, касающиеся таких игроков, тщательно обсуждаются и согласовываются с отделом маркетинга.<br>Помимо этого, к блогерам частично применяются соответствующие пункты правил из общего регламента проекта.<br><br>Все наказания выносятся с точки зрения правил проекта и внутренних установок в отделах.[/CENTER]<br><br>'+
    ...
    {
        title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠᅠ ᅠ Рассмотрение Жалоб на Кураторовᅠ ᅠ ᅠᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ',
        dpstyle: 'oswald: 3px;     color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
    },
        {
		...
		content:
            "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
		'[COLOR=rgb(0, 255, 127)][FONT=georgia][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
		'[CENTER]Ваша жалоба переадресована моему руководству.<br>Ваш аккаунт будет разблокирован после вынесения вердикта.<br>Пожалуйста, ожидайте ответа в данной теме и не создавайте копии.<br>[/CENTER]<br>'+
		'[CENTER][COLOR=rgb(255, 255, 0)][SIZE=4][I][ICODE]Передано руководству[/ICODE][/COLOR][/CENTER][/FONT][/SIZE]'+
            "[CENTER][IMG width=695px]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG]<br>",
		prefix: COMMAND_PREFIXX,
		status: true,
	},
    {
        ...
        '[CENTER][COLOR=rgb(255, 255, 0)][SIZE=4][I][ICODE]Остались ли у вас вопросы касаемо данной блокировки? Ожидаю ваш ответ.[/ICODE][/COLOR][/CENTER][/FONT][/SIZE]'+
        "[CENTER][IMG width=695px]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG]<br>",
		prefix: PIN_PREFIX,
		status: true,
	},
      ...
      '[COLOR=rgb(0, 255, 127)][FONT=georgia][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
        ...
        {
            title: 'Какие привязки привязаны к акку?',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
            '[COLOR=rgb(0, 255, 127)][FONT=georgia][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый игрок![/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
            '[CENTER]Укажите привязки[VK/Telegram/почта], которые были установлены к вашему игровому аккаунту.[/CENTER]<br><br>'+
            '[CENTER][COLOR=rgb(255, 255, 0)][SIZE=4][I][ICODE]Ваша жалоба принята к рассмотрению.[/ICODE][/COLOR][/CENTER][/FONT][/SIZE]'+
            "[CENTER][IMG width=695px]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/IMG]<br>",
		prefix: PIN_PREFIX,
		status: true,
     },
    ...
    },
    {
	...
	},
     {
		...
		content:
         "[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>"+
		'[COLOR=rgb(0, 255, 127)][FONT=georgia][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/COLOR]<br><br>' +
		"[CENTER]Ваш аккаунт заблокирован из-за серьезного нарушения правил сервера.<br>Мы не в силах уменьшить срок вашего наказания, снять блокировку или предоставить амнистию.<br><br>" +
        '[CENTER][COLOR=rgb(255,0,0)][SIZE=4][I][ICODE]В обжаловании отказано.[/ICODE][/COLOR][/FONT][/CENTER]'+
...
const Button51 = buttonConfig("Игроки 51", 'https://forum.blackrussia.online/forums/Жалобы-на-игроков.2290/');
const Button52 = buttonConfig("Игроки 52", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.2332/");
const Button53 = buttonConfig("Игроки 53", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.2374/");
const Button54 = buttonConfig("Игроки 54", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.2416/");
const Button55 = buttonConfig("Игроки 55", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.2458/")
const ButtonTech51 = buttonConfig("Тех 51", "https://forum.blackrussia.online/forums/Технический-раздел-tula.2262/")
const ButtonTech52 = buttonConfig("Тех 52", "https://forum.blackrussia.online/forums/Технический-раздел-ryazan.2304/")
const ButtonTech53 = buttonConfig("Тех 53", "https://forum.blackrussia.online/forums/Технический-раздел-murmansk.2346/")
const ButtonTech54 = buttonConfig("Тех 54", "https://forum.blackrussia.online/forums/Технический-раздел-penza.2388/")
const ButtonTech55 = buttonConfig("Тех 55", "https://forum.blackrussia.online/forums/Технический-раздел-kursk.2430/")
const ButtonComp51 = buttonConfig("Жб 51", "https://forum.blackrussia.online/forums/Сервер-№51-tula.2261/")
const ButtonComp52 = buttonConfig("Жб 52", "https://forum.blackrussia.online/forums/Сервер-№52-ryazan.2303/")
const ButtonComp53 = buttonConfig("Жб 53", "https://forum.blackrussia.online/forums/Сервер-№53-murmansk.2345/")
const ButtonComp54 = buttonConfig("Жб 54", "https://forum.blackrussia.online/forums/Сервер-№54-penza.2387/")
const ButtonComp55 = buttonConfig("Жб 55", "https://forum.blackrussia.online/forums/Сервер-№55-kursk.2429/")
