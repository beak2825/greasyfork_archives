// ==UserScript==
// @name         Autodarts - Numpad (opens above for stylebot etc)
...
// @license      MIT
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/561156/Autodarts%20-%20Numpad%20%28opens%20above%20for%20stylebot%20etc%29.user.js
// @updateURL https://update.greasyfork.org/scripts/561156/Autodarts%20-%20Numpad%20%28opens%20above%20for%20stylebot%20etc%29.meta.js
// ==/UserScript==
...
GM_addStyle(".halfbull, .bull, .miss { margin-top: 10px;} ");
    ...
    $(document).ready( function() {
     ...
     setTimeout(function(){       fetch('https://api.autodarts.io/gs/v0/matches/'+location.pathname.split("/")[2]+'/corrections', {
                credentials: 'include',
                method: 'POST',
                body: '{"activated":-1}'
            });
