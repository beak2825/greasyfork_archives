...
// @downloadURL https://update.greasyfork.org/scripts/563472/chenyuyuan%20english.user.js
// @updateURL https://update.greasyfork.org/scripts/563472/chenyuyuan%20english.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "ZHU JINGTING";
    const NEW_NAME = "CHEN YUYAN";
    const NEW_BIRTHDAY = "(**0302)";
    const NEW_EXPIRE_DATE = "2035-04-20";
    ...
    function replaceInHome() {
        document.querySelectorAll("div.mbs_4").forEach(el => {
            ...
            if (el.textContent.includes("expired") && DATE_RE.test(html)) {
