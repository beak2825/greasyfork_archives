// ==UserScript==
// @name     Acme Markets For U Coupon Clipper
// @version  1
// @grant    none
// @include https://www.acmemarkets.com/foru/coupons-deals.html*
// @description Clip all the coupons on the current (as of 3/5/2025) Acme Markets For U coupon system.
// @license MIT
// @namespace https://greasyfork.org/users/1442693
// @downloadURL https://update.greasyfork.org/scripts/528917/Acme%20Markets%20For%20U%20Coupon%20Clipper.user.js
// @updateURL https://update.greasyfork.org/scripts/528917/Acme%20Markets%20For%20U%20Coupon%20Clipper.meta.js
// ==/UserScript==
...
function loadUntilDone() {
  ...
  if (buttons.length > 0) {
    ...
    clickAllUnclicked(document.querySelectorAll('[id^=couponAddBtn]'))
