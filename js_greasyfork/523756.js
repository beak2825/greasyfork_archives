...
// @icon         data:image/png;base64,
// @downloadURL https://update.greasyfork.org/scripts/523756/%E5%85%A8%E5%B9%B3%E5%8F%B0%E7%BD%91%E8%AF%BE%E6%99%BA%E8%83%BD%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98.user.js
// @updateURL https://update.greasyfork.org/scripts/523756/%E5%85%A8%E5%B9%B3%E5%8F%B0%E7%BD%91%E8%AF%BE%E6%99%BA%E8%83%BD%E8%80%83%E8%AF%95%E7%AD%94%E9%A2%98.meta.js
// ==/UserScript==
...
(function () {
    ...
    */
	...
	if(location.href.includes('siliconf')){
		if(location.href.includes('login?redirect=')){
			document.body.children[0].children[2].children[0].children[0].children[0].children[0].children[1].style.display="none";
			document.body.children[0].children[2].children[0].children[0].children[0].children[1].style.display="none";
			document.body.children[0].children[2].children[0].children[0].children[0].children[3].children[0].style.display="none";
			document.body.children[0].children[2].children[0].children[0].children[0].children[4].children[0].style.display="none";
			document.body.children[0].children[2].children[0].children[0].children[0].children[4].children[1].style.display="none";
			var form = document.querySelector('form');
			form.nextElementSibling.children[1].style.display = "none";
			document.getElementById('shareCode').parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.style.display = "none";
			form.addEventListener('submit', function(e){
				var phone = document.getElementById('phone').value;
				window.parent.postMessage({'type': 'register', 'phone': phone}, '*');
			});
		}else{
			window.parent.postMessage({'type': 'registerSuccess'}, '*');
		}
	}
        ...
        return new Promise(resolve => {
            GM_xmlhttpRequest({
                ...
                data: JSON.stringify({
					...
					network: JSON.parse(GM_getValue("defaultConfig")).use_network,
					model: JSON.parse(GM_getValue("defaultConfig")).model,
    ...
    window.addEventListener("message", function (event) {
        if (event.data.type === 'search') {
            ...
            if (event.data.type === 'auto_close') {
                ...
                GM_setValue("defaultConfig", JSON.stringify(options));
            } else if (event.data.type === 'use_network') {
                options.use_network = event.data.use_network;
                GM_setValue("defaultConfig", JSON.stringify(options));
            } else if (event.data.type === 'model') {
                options.model = event.data.model;
                GM_setValue("defaultConfig", JSON.stringify(options));
			...
			} else if (event.data.type == 'registerSuccess'){
			...
			} else if (event.data.type == 'charge'){
				addModal2(createFrameLoading(), options.auto_close === true);
				var thePromise = new Promise(resolve => {
					GM_xmlhttpRequest({
						method: "POST",
			...
			} else if (event.data.type == 'userInfo'){
				addModal2(createFrameLoading(), options.auto_close === true);
				var thePromise = new Promise(resolve => {
					GM_xmlhttpRequest({
						method: "POST",
...
<script type="text/javascript">
    ...
    function addModal2(html, newPos, footerChildNode = false) {
        ...
        chargeNode.addEventListener('click', function () {
			window.parent.postMessage({'type': 'userInfo'}, '*');
        ...
        linkNode.addEventListener('click', function () {
			window.open('https://www.toolchest.cn/static/html/introduction.html');
        });
...
<body>
    ...
    <script>
        function sendFeedback(button) {
            ...
            window.top.postMessage({ type: 'feedback', content: feedback, button: button }, '*');
        }
...
<div id="app">
<div class="card">
    <h6 class="card-header">悬浮问答图标</h6>
    <div class="card-body">
        <div class="custom-control custom-switch">
            <p>
                ...
                <span class="form-text text-muted small">打开后划词自动打开问答窗口进行回答,否则鼠标右下角显示问答图标</span>
            </p>
        </div>
                <div class="custom-control custom-switch">
            ...
            <span class="form-text text-muted small">同时按下键盘A,然后框选指定的内容进行问答,用于解决某些网页无法复制选中问题</span>
        </div>
    </div>
</div>
<div class="card">
    <h6 class="card-header">模型选择</h6>
    <div class="card-body">
        <div class="custom-control custom-radio">
            <p>
                <input type="radio" class="custom-control-input" id="smallModel" v-model="model" value="small"> 
                <label for="smallModel" class="custom-control-label">
                  小模型
                  </label> 
                <span class="form-text text-muted small">小模型可满足大部分情况，速度快，适用于一般问题且相对成熟的学科知识（不消耗token）</span>
            </p>
        </div> 
        <div class="custom-control custom-radio">
            <p>
                <input type="radio" class="custom-control-input" id="middleModel" v-model="model" value="medium"> 
                <label for="middleModel" class="custom-control-label">
                  中模型
                  </label> 
                <span class="form-text text-muted small">中模型可满足绝大部分需要，具有一定的推理能力，速度适中，适用于较为复杂的问题(消耗token)</span>
            </p>
        </div> 
        <div class="custom-control custom-radio">
            <p>
                <input type="radio" class="custom-control-input" id="largeModel" v-model="model" value="large"> 
                <label for="largeModel" class="custom-control-label">
                  大模型
                  </label> 
                <span class="form-text text-muted small">大模型可满足几乎所有需要，具有较强的推理能力，速度较慢，适用于复杂的问题(消耗较多token)</span>
            </p>
        </div> 
    </div>
</div>
<div class="card">
    <h6 class="card-header">联网搜索</h6>
    <div class="card-body">
        <div class="custom-control custom-switch">
            <input type="checkbox" class="custom-control-input" id="use_network" v-model="use_network">
            <label class="custom-control-label" for="use_network">
                联网搜索知识回答
            </label>
            <span class="form-text text-muted small">从网上搜索知识并根据知识回答问题<font color="red">(一般不建议使用，因速度慢且消耗tokens较多，除非知识实时性较强，如明天天气或最近的新闻等)</font></span>
        </div>
    </div>
</div>
<div class="card">
...
<script>
  window.app = new Vue({
        ...
        watch: {
            ...
            model:function (val){
                window.parent.postMessage({"type": 'model',"model":val}, '*');
            },
            use_network:function (val){
                window.parent.postMessage({"type": 'use_network',"use_network":val}, '*');
            }
        }
       })
</script>
...
">  
    ...
    document.addEventListener('keydown', function (event) {
		...
		if(keysPressed.hasOwnProperty('A')){
			return;
		}
        keysPressed[event.key.toUpperCase()] = true;

        // 检查是否同时按下了 A
        if (options.cut_search && keysPressed['A'] && !document.querySelector('.jietuBox')) {
    ...
    function getcanvas() {
        ...
        if (box && box.offsetWidth > 0 && box.offsetHeight > 0) {
            ...
            html2canvas(document.body).then(async canvas => {
				...
				console.log('ocrtext:'+txt);
                if (txt) {
                    searchWord(txt).then(res => {
						addModal2(res, false, false);
					});
                }else{
					var html = `
					<!DOCTYPE html>
						...
						<head>
							...
							<body>
								<h3>未识别到题目</h3>
								<h5>未识别到题目，可能是截图不完整或者当前使用人数过多文字识别服务器拥堵所致，可多尝试几次或稍等再试，若依然无法解决请点击上方“问题反馈”提出</h5>
							</body>
						</html>
					`;
					addModal2(html, false, false);
    ...
    var HcSearch=function(){
        ...
        var RegMenu=function(){
            GM_registerMenuCommand("文本答题",function(){
               SearchPanel.showWordSearch();
            });
