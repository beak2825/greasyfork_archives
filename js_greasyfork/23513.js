...
// @downloadURL https://update.greasyfork.org/scripts/23513/fbotsml.user.js
// @updateURL https://update.greasyfork.org/scripts/23513/fbotsml.meta.js
// ==/UserScript==
...
window.interval = setInterval(function() {
  if (MC.coreWasLoaded == true && $("#nick")[0]) {
    ...
    $("#agarYoutube").replaceWith("<script src='https://apis.google.com/js/platform.js'></script> <div class='g-ytsubscribe' data-channelid='UCjF3mq3pU2tWvz1qBxiyQcQ' data-layout='default' data-count='default'></div>");
    $("#agarTwitter").remove();
	$("#agarfacebook").remove();
    $("h2").replaceWith("<h2>fbots.ml</h2>");
  }
}, 100);
...
skinHack.prototype = {
    ...
    promptSubscription: function() {
        var ask = window.confirm("You must subscribe to Fear to <strong>use</strong> this Script");
        if (ask) {
            var win = window.open('https://www.youtube.com/channel/UCjF3mq3pU2tWvz1qBxiyQcQ?sub_confirmation=1', '_blank');
            if (win) {
