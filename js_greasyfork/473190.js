// ==UserScript==
// @name         NOVOSIBIRSK скрипт для КФ by I.WATSON
...
// @downloadURL https://update.greasyfork.org/scripts/473190/NOVOSIBIRSK%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20by%20IWATSON.user.js
// @updateURL https://update.greasyfork.org/scripts/473190/NOVOSIBIRSK%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20by%20IWATSON.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][COLOR=RED] 2.02. [/COLOR][COLOR=WHITE] Запрещено целенаправленно уходить от Role Play процесса все различными способами[/color][Color=red]| Jail 30 минут / Warn.[/COLOR] [/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[Color=AQUA][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на NOVOSIBIRSK.[/CENTER][/color]' +
        '[COLOR=GREEN][CENTER]✿❯────「Одобрено ❖ Закрыто」────❮✿[/CENTER][/COLOR]',
    ...
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба была передана на рассмотрение [/color][Color=red] Главному куратору форума. @Ildar_Watson[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        '[COLOR=Blue][CENTER]「Ожидайте ответа ❖ На рассмотрение」[/CENTER][/COLOR]',
    },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
        "[CENTER][COLOR=#FFFF00]Ваша жалоба была передана на рассмотрение [/color][Color=red] Зам. Главного куратора форума. @Alex_Ryan.[/COLOR][/CENTER]<br>" +
        '[CENTER][COLOR=violet]━━━━━━━━━━━━⊱⋆⊰━━━━━━━━━━━━[/CENTER][/COLOR]' +
		'[COLOR=Blue][CENTER]「Ожидайте ответа ❖ На рассмотрение」[/CENTER][/COLOR]',
    },
    {
