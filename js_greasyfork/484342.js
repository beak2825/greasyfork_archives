...
// @run-at       document-end
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/484342/%E6%B9%96%E5%8D%97%E7%9C%81%E4%BA%8B%E4%B8%9A%E5%8D%95%E4%BD%8D%E5%B7%A5%E4%BD%9C%E4%BA%BA%E5%91%98%E5%9F%B9%E8%AE%AD%E7%BD%91%E7%BB%9C%E5%B9%B3%E5%8F%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/484342/%E6%B9%96%E5%8D%97%E7%9C%81%E4%BA%8B%E4%B8%9A%E5%8D%95%E4%BD%8D%E5%B7%A5%E4%BD%9C%E4%BA%BA%E5%91%98%E5%9F%B9%E8%AE%AD%E7%BD%91%E7%BB%9C%E5%B9%B3%E5%8F%B0.meta.js
// ==/UserScript==
	    ...
	    if (hre.match("ischinese.cn/learncenter/buycourse")) {
				...
				setTimeout(() => {
	    			var itemFlag = localStorage.getItem('itemFlag');
						if(itemFlag == null){
							if (confirm("执行专业科目选是,公共科目选否") == false) {
								document.getElementsByClassName('buyCoure_typeName1')[3].click();
	    					localStorage.setItem('itemFlag','0');
							}else{
								document.getElementsByClassName('buyCoure_typeName1')[4].click();
	            	...
	            	if(courceList.length !=0){
			            if(limit == courceList.length){
		    				...
		    				console.log("out ----  ischinese.cn/buycourse --- ");
