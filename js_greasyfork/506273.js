// ==UserScript==
// @name         pixels home mine 2
// @namespace    https://play.pixels.xyz
// @version      0.2
// @description  喝酒家里挖矿脚本
// @author       JackerYoung
// @include      http://*
// @include      https://*
// @grant        GM_addElement
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/506273/pixels%20home%20mine%202.user.js
// @updateURL https://update.greasyfork.org/scripts/506273/pixels%20home%20mine%202.meta.js
// ==/UserScript==
                ...
                async function sendMssage() {
                    ...
                    while (room){
                        ...
                        if(state.id.includes("terravilla")){
                            ...
                            await sleep(2000)
                            if (!map_list.includes(self_farm)){
                        ...
                        else if(state.id.includes("shareRent")){
                            let gostore=false
