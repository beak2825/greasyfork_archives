...
// @downloadURL https://update.greasyfork.org/scripts/553729/zhangchuchanghan.user.js
// @updateURL https://update.greasyfork.org/scripts/553729/zhangchuchanghan.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "TAN HOKIUMONIQUE";
    const NEW_NAME = "ZHANG CHUCHANGHAN";
    const NEW_BIRTHDAY = "(**0414)";
    const NEW_EXPIRE_DATE = "2028-12-25";
