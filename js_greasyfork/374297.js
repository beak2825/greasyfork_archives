// ==UserScript==
// @name        Orpheus Collage Building Helper
// @author      Z4ppy
...
// @include     https://*orpheus.network/collage.php*
// @include     https://*orpheus.network/artist.php*
...
// @version     1.0.3
// @date        2017-05-26
// @downloadURL https://update.greasyfork.org/scripts/374297/Orpheus%20Collage%20Building%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/374297/Orpheus%20Collage%20Building%20Helper.meta.js
// ==/UserScript==

// Changelog can be found at https://greasyfork.org/en/scripts/25309-pth-collage-building-helper
...
var URL = new Object();
function parseURL() {
	var URLArr = document.URL.match(/^(https:\/\/(?:ssl\.)?orpheus\.network)\/([\w\/\.]+?)(\?(.*?))?(#.*)?$/);
	URL.Host = URLArr[1]; //protocol + hostname, eg. https://orpheus.network
	URL.Path = URLArr[2];
	URL.Hash = URLArr[5];
