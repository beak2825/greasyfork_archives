// ==UserScript==
// @name         Для Куратора Администрации(34)
...
// @downloadURL https://update.greasyfork.org/scripts/501047/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%90%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%2834%29.user.js
// @updateURL https://update.greasyfork.org/scripts/501047/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%90%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%2834%29.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][B][FONT=times new roman][COLOR=rgb(255, 165, 0)]На рассмотрении.[/COLOR][/FONT][/CENTER]',
        prefix: PIN_PREFIX,
      status: true,
    },
    {
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Вы ошиблись разделом.<br>Обратитесь в раздел жалоб на [URL='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.1570/']администрацию[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/CENTER]',
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Вы ошиблись разделом.<br>Обратитесь в раздел жалоб на [URL='https://forum.blackrussia.online/forums/Жалобы-на-лидеров.1571/']лидеров[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Вы ошиблись разделом.<br>Вам было выдано наказание Техническим Специалистом.<br>Обратитесь в раздел жалоб на [URL='https://forum.blackrussia.online/forums/Сервер-№34-novosibirsk.1543/']технических специалистов[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Вы ошиблись разделом.<br>Обратитесь в раздел жалоб на [URL='https://forum.blackrussia.online/forums/Жалобы-на-игроков.1572/']игроков[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    ...
    {
        title: 'Скрин окна бана',
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman] Отсутствует окно блокировки.<br>Жалоба не подлежит рассмотрению. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    ...
    {
        title: 'плохое качество доков',
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Доказательсва были предоставлены в плохом качестве.<br>Пожалуйста, прикрепите более качественное фото/видео в вашей новой жалобе.[/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Прикрепите ссылку на ранее поданную жалобу в новой теме.[/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
