// ==UserScript==
// @name         Скрипт для ГА/ЗГА 
// @namespace    https://forum.blessrussia.online/index.php
// @version      3.1.5
// @description  Специально для Bless Russia ||
// @author       Salvador Unicorn
...
// @grant        none
// @license      none
// @supportURL   https://vk.com/hokage_077
// @downloadURL https://update.greasyfork.org/scripts/542656/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%90%D0%97%D0%93%D0%90.user.js
// @updateURL https://update.greasyfork.org/scripts/542656/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%90%D0%97%D0%93%D0%90.meta.js
// ==/UserScript==
     ...
     },
{
...
},
    {
      ...
      content:
        `[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `Вам нужно обратиться в раздел жалоб на Администрацию → [URL='https://forum.blessrussia.online/index.php?forums/40/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/CENTER][/FONT]`,
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
      ...
      content:
        `[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `Вам нужно обратиться в раздел Обжалование → [URL='https://forum.blessrussia.online/index.php?forums/42/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/CENTER][/FONT]`,
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
	  ...
	  content:
		`[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
		`Вам нужно обратиться в раздел жалоб на игроков → [URL='https://forum.blessrussia.online/index.php?forums/39/']*Кликабельно*[/URL]<br><br>`+
		`Закрыто.[/CENTER][/FONT]`,
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
		`[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
		`Вам нужно обратиться в раздел жалоб на лидеров → [URL='https://forum.blessrussia.online/index.php?forums/41/']*Кликабельно*[/URL]<br><br>`+
		`Закрыто.[/CENTER][/FONT]`,
        prefix: CLOSE_PREFIX,
        status: false,
	},
    {
      ...
      content:
        `[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `Вам нужно обратиться в раздел жалоб на технических специалистов → [URL='https://forum.blessrussia.online/index.php?forums/3/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/CENTER][/FONT]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
	  ...
	  content:
		`[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора по направлению ГОСС & ОПГ — @Cosmos_Ssewen.<br><br>` +
	...
	},
    {
	  ...
	  content:
		`[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `[CENTER]Передаю вашу жалобу Основному Заместителю Главного Администратора — @Tommy_Bellow.<br><br>`+
        `Ожидайте ответа.[/CENTER][/FONT]`,
      prefix: PIN_PREFIX,
	  status: true,
	},
    {
	  ...
	  content:
		`[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `[CENTER][FONT=verdana]Передаю вашу жалобу Главному Администратору — @Lelush Elegant 𓆩♡𓆪.<br><br>`+
        `Ожидайте ответа.[/CENTER][/FONT]`,
      prefix: GA_PREFIX,
	  status: true,
    },
    ...
    },
{
	...
	},
	{
     ...
     },
     {
	  ...
	  content:
		`[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
		`Перешлите мне эти сообщения в VK → https://vk.com/hokage_077.<br><br>`+
	...
	},
     {
	  ...
	  content:
		`[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
		`Ваша жалоба составлена не по форме. Ознакомьтесь с правилами подачи жалоб → [URL='https://forum.blessrussia.online/index.php?threads/11/']*Кликабельно*[/URL]<br><br>`+
		`Закрыто.[/CENTER][/FONT]`,
	  prefix: CLOSE_PREFIX,
	  status: false,
     },
	...
	},
{
    ...
    },
    {
      ...
      content:
        `[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `Обжалование составлено не по форме, ознакомьтесь с правилами подачи обжалований → [URL='https://forum.blessrussia.online/index.php?threads/13/']*Кликабельно*[/URL].<br><br>`+
        `Закрыто.[/CENTER][/FONT]`,
      prefix: CLOSE_PREFIX,
      status: false,
    },
    ...
    },
    {
	  ...
	  content:
		`[CENTER][FONT=verdana]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `Передаю ваше обжалование Главному Администратору — [USER=24]Lelush Elegant 𓆩♡𓆪[/USER].<br><br>`+
        `Ожидайте ответа.[/CENTER][/FONT]`,
      prefix: GA_PREFIX,
	  status: true,
    },
