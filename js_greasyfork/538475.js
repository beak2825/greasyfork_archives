// ==UserScript==
// @name         Blacket Yellow Theme
// @version      1.1.4
// @description  Yellow theme for Blacket!
...
// @downloadURL https://update.greasyfork.org/scripts/538475/Blacket%20Yellow%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/538475/Blacket%20Yellow%20Theme.meta.js
// ==/UserScript==

(async () => {
    setTimeout(() => {
        console.log(
            "%c[blacket yellow theme] loaded!",
            "color: #fff; padding: 10px; border-radius: 5px; font-size: 20px; font-weight: bold; text-shadow: 0px 0px 10px #d4c60f;"
        );
    }, 1000);
