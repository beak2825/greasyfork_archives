...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/380479/NGA%E8%AE%BA%E5%9D%9B%E7%A2%A7%E8%93%9D%E5%B9%BB%E6%83%B3%E8%A1%A8%E6%83%85%E5%8C%85.user.js
// @updateURL https://update.greasyfork.org/scripts/380479/NGA%E8%AE%BA%E5%9D%9B%E7%A2%A7%E8%93%9D%E5%B9%BB%E6%83%B3%E8%A1%A8%E6%83%85%E5%8C%85.meta.js
// ==/UserScript==
...
(function() {
  ...
  window.setGBFSticker = (btn) => {
    const stickerBox = document.getElementById('block-gbf-sticker')
    if (stickerBox) {
      if (stickerBox.style.display === 'block') {
        ...
        let btns = stickerBox.parentNode.parentNode.querySelectorAll('span>div:not(.gbf-sticker)')
  ...
  const insertBtn = () => {
    ...
    btnBlock.insertAdjacentHTML('afterend', '<button id="gbf-sticker" class="block_txt_big" onclick="window.setGBFSticker(this)">GBF</button>')
    const stcBlock = document.querySelector(`#${boxId} .div3>span:last-child>div:last-child`)
    stcBlock.insertAdjacentHTML('afterend', '<div id="block-gbf-sticker" class="gbf-sticker"></div>')
  }
