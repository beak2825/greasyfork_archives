...
// @version      1.7
// @description  По всем вопросам: https://vk.com/moskalev_a_v
// @author       Petr_Toretto
...
// @downloadURL https://update.greasyfork.org/scripts/521118/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D1%81%D0%B4%D0%B5%D0%BB%D0%B0%D0%BD%20%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D1%8C%D0%BD%D0%BE%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20AZURE.user.js
// @updateURL https://update.greasyfork.org/scripts/521118/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D1%81%D0%B4%D0%B5%D0%BB%D0%B0%D0%BD%20%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D1%8C%D0%BD%D0%BE%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20AZURE.meta.js
// ==/UserScript==
...
(function () {
	...
	const buttons = [
          {
          title: '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Предложения по улучшению - @Moskalev_a_v ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
          ...
          },
        {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография написана не по форме + Заголовок не по форме.<br>Пожалуйста, ознакомьтесь с темой [URL='https://forum.blackrussia.online/threads/azure-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.5829805/'][/url] Правила создания RolePlay биографии..<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
        {
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте "Юность" недостаточно информации.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте "Взрослая жизнь" недостаточно информации.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 11.1 и 11.2 недостаточно информации.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 11.2 и 11.3 недостаточно информации.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 11.1 и 11.3 недостаточно информации.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          {
            title: 'Во всех пунктах недостаточно инфы 11.1 11.2 11.3',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Во всех пунктах недостаточно информации 11.1 11.2 11.3.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 11.1 нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'В пункте 11.1 нет логики (Непр.1 пред)',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 11.1 нет логики, в первом предложении написано не логично или что-то не так..<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 11.2 нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'В пункте 11.2 нет логики (Непр.1 пред)',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 11.2 нет логики, в первом предложении написано не логично или что-то не так..<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 11.3 нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'В пункте 11.3 нет логики (Непр.1 пред)',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 11.3 нет логики, в первом предложении написано не логично или что-то не так..<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В заголовке вашей биографии и пункте 1 имена отличаются.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пунктах 1 и 11.1 имена разные, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Имя в пункте 1 и 11.2 отличается',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пунктах 1 и 11.2 имена разные, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Имя в пункте 1 и 11.3 отличается',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пунктах 1 и 11.3 имена разные, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В заголовке вашей биографии и пункте 1 фамилии отличаются.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Отчество вашего персонажа не соответствует имени отца.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Отчество вашего персонажа отсутствует, а значит это должно быть обыграно в вашей биографии.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 2 и 11.1 даты рождения отличаются.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии не совпадает дата рождения с возрастом.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Место рождения в пункте 11.1 отличается от места рождения в пункте 2.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии дата рождения написана не полностью.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
         {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии семья расписана не полностью, причина отсутствия одного из родителей должно быть расписана со всеми подробностями.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии информация про родителей должна быть расписана со всеми подробностями.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 3 укажите Ф.И.О родителей вашего персонажа.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 3 указаны не только родители, соответственно биография написана не по форме.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
         ...
         {
            title: 'Пункт 3 отличается от 11.1',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии информация про родителей в пункте 3 и пункт 11.1 отличаются.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Пункт 3 отличается от 11.2',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии информация про родителей в пункте 3 и пункт 11.2 отличаются.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Пункт 3 отличается от 11.3',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Биографии информация про родителей в пункте 3 и пункт 11.3 отличаются.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Нет логики 3 11.1 11.2 11.3',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Во всех пунктах в 11.1 11.2 11.3  отличаются/сделано не логично.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Недостаточно информации 3 11.1 11.2 11.3',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Во всех пунктах в 11.1 11.2 11.3 а так же пункт 3  недостаточно информации.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          {
            title: 'Нет логики 4 и 11.1',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункты 4 и 11.1 противоречат друг другу, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Нет логики 4 и 11.2',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункты 4 и 11.2 противоречат друг другу, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Нет логики 4 и 11.3',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункты 4 и 11.3, противоречат друг другу, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Нет логики 4 и 11.3 11.1 11.2',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункты 4 и 11.3,11.2,11.1 противоречат друг другу, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Нет логики пункт 4',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункты 4 строго должно быть написано *Среднее образование* или *Высшее образование*, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваш персонаж обязан отслужить в армии максимум 1 год, если он служит по контракту/не может по состоянию здоровья, то обыграйте это в своей биографии.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваш персонаж начал служить ранее или позднее 18-ти лет, соответственно нет логики.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
         ...
         {
            title: '8 пункт(подробно,расписано)',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4] Ваша RolePlay - биография отказана т.к в пункте 8. Период воинской службы (для мужчин) сделано не правельно.         Внимание: 6. Период воинской службы (для мужчин, дата должна быть полностью развернутой) Пример: 8. Период воинской службы (для мужчин): 07.11.2018 Закончил 07.11.2019.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Нет логики 8 пункт и 11.3',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4] Ваша RolePlay - биография отказана т.к в пункте 8 и 11.3 нет логики!. Пункт 11.3 должен совпадать с пунктом 3 или вы сделали что-то не так в вашей Role Play Биографии .<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
         ...
         {
            title: '11.3 пункт мало инфы про армию',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4] Ваша RolePlay - биография отказана т.к. в вашем пункте 11.3 мало написано про армию, расспишите более подробно про нее.  Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [URL='https://forum.blackrussia.online/threads/.-Правила-создания-roleplay-биографии.5829805/']*Нажмите сюда*[/URL] <br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
        {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4] Ваша RolePlay - биография отказана т.к. в вашем пункте 2 и пункт 8 нет логики, тоесть, у вас отличаются даты.  Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [URL='https://forum.blackrussia.online/threads/.-Правила-создания-roleplay-биографии.5829805/']*Нажмите сюда*[/URL] <br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
         ...
         {
            title: '8 и 11.3 разное армию',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4] Ваша RolePlay - биография отказана т.к. в вашем пункте 8 и пункт 11.3 нет логики, тоесть, у вас отличаются 8 пункт и 11.3.  Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [URL='https://forum.blackrussia.online/threads/.-Правила-создания-roleplay-биографии.5829805/']*Нажмите сюда*[/URL] <br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
         ...
         {
            title: '11.3 пункт нет армии',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4] Ваша RolePlay - биография отказана т.к. в вашем пункте 11.3 не написано про Армию, расспишите более подробно про нее.  Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [URL='https://forum.blackrussia.online/threads/.-Правила-создания-roleplay-биографии.5829805/']*Нажмите сюда*[/URL] <br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
         ...
         {
            title: 'В пункте 11.3 нет логики армия ',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            '[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 11.3 нет логики, у вас служба в армии не понятная.  [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>' +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            '[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 10 укажите Ф.И.О супруги вашего персонажа.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
{
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 10 укажите Ф.И.О детей вашего персонажа.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 10 напишите краткую информацию о супруге вашего персонажа.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 10 напишите краткую информацию о детях вашего персонажа.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Информация о вашей семье/детях в пунктах 11.1, 11.2, 11.3 отличается от указанной информации в пункте 10.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункт 11 написан не по форме, внимательно прочитайте правила РП Биографии в закрепленные в данном разделе.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          {
            title: 'Грамматические ошибки все пункты ',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография написана неграмотно, в 11.1 по 11.3.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[LIST]<br>" +
        ...
        {
            title: 'Грамматические ошибки в 11.1 ',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография написана неграмотно, ошибки в 11.1.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[LIST]<br>" +
            "[*][LEFT][FONT=georgia][COLOR=rgb(255, 0, 0)][SIZE=4]Примечание: [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Грамматическая ошибка - это ошибка в структуре языковой единицы: в структуре слова, словосочетания или предложения; это нарушение какой-либо грамматической нормы - словообразовательной, морфологической, синтаксической.[/SIZE][/COLOR][/FONT][/LEFT]<br>" +
            "[/LIST]<br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
        ...
        {
            title: 'Грамматические ошибки 11.2 ',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография написана неграмотно, в пункте 11.2.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[LIST]<br>" +
            "[*][LEFT][FONT=georgia][COLOR=rgb(255, 0, 0)][SIZE=4]Примечание: [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Грамматическая ошибка - это ошибка в структуре языковой единицы: в структуре слова, словосочетания или предложения; это нарушение какой-либо грамматической нормы - словообразовательной, морфологической, синтаксической.[/SIZE][/COLOR][/FONT][/LEFT]<br>" +
            "[/LIST]<br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
        ...
        {
            title: 'Грамматические ошибки 11.3 ',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[CENTER].[img]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/img].[/CENTER]<br>' +
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография написана неграмотно, в пункте 11.3.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[LIST]<br>" +
            "[*][LEFT][FONT=georgia][COLOR=rgb(255, 0, 0)][SIZE=4]Примечание: [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Грамматическая ошибка - это ошибка в структуре языковой единицы: в структуре слова, словосочетания или предложения; это нарушение какой-либо грамматической нормы - словообразовательной, морфологической, синтаксической.[/SIZE][/COLOR][/FONT][/LEFT]<br>" +
            "[/LIST]<br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография написана неграмотно.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункт 11.1 должен описываться с момента рождения вашего персонажа.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункт 11.1 начинается с рождения и заканчивается в 12 лет.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Уточните возраст вашего персонажа в начале/середине/конце пункта 11.1.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункт 11.2 начинается с 13 по 15 лет и заканчивается в 18 лет.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 11.2 опишите более подробно процесс обучения, сдачи экзаменов.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Уточните возраст вашего персонажа в начале/середине/конце пункта 11.2.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункт 11.3 начинается с 18 лет.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Уточните возраст вашего персонажа в начале/середине/конце пункта 11.3.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В пункте 11.1 должно быть написано, во сколько лет ваш персонаж пошёл в школу.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Пункты 11.1 и 11.2 противоречат друг другу, ваш персонаж должен быть в 6 классе, если пошел в школу в 7 лет.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Вашему персонажу должно быть 18 и более лет.<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Запрещено писать лишнее в своей биографии, вставлять какие-то gif/картинки..<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          ...
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 1 имеется/имеются ошибка(-и).<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 2 имеется/имеются ошибка(-и).<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 3 имеется/имеются ошибка(-и).<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 4 имеется/имеются ошибка(-и).<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 8 имеется/имеются ошибка(-и).<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 9 имеется/имеются ошибка(-и).<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 10 имеется/имеются ошибка(-и).<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратите внимание, в пункте 11 имеется/имеются ошибка(-и).<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
        {
            ...
            '[CENTER].[img]https://i.postimg.cc/pTsqT1nM/NiuhPJK.png[/img].[/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay - биография отказана т.к. она составлена не по форме. Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [URL='https://forum.blackrussia.online/threads/.-Правила-создания-roleplay-биографии.5829805/']*Нажмите сюда*[/URL]<br>[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4][ICODE]Отказано.[/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER].[img]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/img].[/CENTER]<br>' +
            "[I][CENTER][FONT=times new roman][SIZE=3][COLOR=rgb(209, 213, 216)]Приятной игры на[/COLOR][COLOR=rgb(0, 128, 255)][B] AZURE[/B][/COLOR] [/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
...
(function () {
	...
	const buttons = [
          {
          title: '~~~~~~~~~ Предложения по улучшению - @mosaklev_a_v ~~~~~~~~~',
          dpstyle: 'oswald: 3px;     color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
          },
...
(function () {
	...
	const buttons = [
 {
          ...
          dpstyle: 'oswald: 3px;     color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
                   ...
                   {
             title: 'Жалоба отказана (Свой ответ)',
             dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
             content:
             '[CENTER][COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][B]{{ greeting }}, уважаемый {{ user.mention }}.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             "[COLOR=rgb(209, 216, 213)][SIZE=4][FONT=times new roman][B] *Свой текст* .<br>" +
             'Соответственно, жалоба рассмотрению не подлежит.[/B][/FONT][/SIZE][/COLOR]<br><br>' +
             '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4] Отказано, закрыто. [/FONT][/SIZE][/COLOR][/CENTER]'
           },
{
	...
	function addReports() {
		$('.button--icon--reply').after(`<button type="button" class="button--cta uix_quickReply--button button button--icon button--icon--write rippleButton" id="selectReport" style="oswald: 3px; margin-left: 5px; margin-top: 10px; border-radius: 13px;">СВОИ ОТВЕТЫ</button>`,
	);
	}
