	...
	// @namespace    Cutemon
	// @version      0.71
	// @description  自学研究用，想到什么坑爹功能或者效果都会加上去试试……_(¦3」∠)_
	// @author       Cutemon
	// @match        http://live.bilibili.com/h5/189/baipiao
	// @require      http://static.hdslb.com/live-static/libs/jquery/jquery-1.11.3.min.js
	// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/37718/%E7%99%BD%E5%AB%96%E7%9C%9F%E6%98%AF%E5%A4%AA%E5%A5%BD%E4%BA%86.user.js
// @updateURL https://update.greasyfork.org/scripts/37718/%E7%99%BD%E5%AB%96%E7%9C%9F%E6%98%AF%E5%A4%AA%E5%A5%BD%E4%BA%86.meta.js
	// ==/UserScript==
						...
						<body>
							<div id="div-left" class="margin-style">
								<div id="btn" class="btn-group" role="group" aria-label="兑换池" style="text-align: center;">
									...
									<div style="margin-top: 20px;">
										开启时段：每小时<input style="width: 50px;" type="number" name="" id="start_min" value="58" min="0" max="59" />分<input style="width: 50px;" type="number" name="" id="start_sec" value="55" max="59"/>秒开始，<input style="width: 50px;" type="number" name="" id="end_min" value="59" min="0" max="59" />分<input style="width: 50px;" type="number" name="" id="end_sec" value="10" max="59" />秒结束，每<input style="width: 50px;" type="number" name="" id="exe_interval" value="150" min="100"/>毫秒兑换1次（1秒=1000毫秒）<br />
...
//				console.log(response.data);
				$('#daily-coin').append('每日扭蛋币：<span style="padding-left: 10px;">' + response.msg);
			}
		});
