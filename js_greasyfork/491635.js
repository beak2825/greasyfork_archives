// ==UserScript==
// @name   KF_script_by_Kent
// @name:ru 🚬 script Кураторы форума TAMBOV
// @description:ru Для доработки скрипта заполните форму https://forms.gle/Ba48hgs9PwFyqed67
// @autor Kevin_Kent
// @version 2.2.02
...
// @grant        none
// @license   MIT
// @supportURL vk.com/tanjiro.slayers | Kevin_Kent | Tambov
// @description Suggestions for improving the script write here ---> https://forms.gle/xt2YvQApsCDhXcwq8
// @downloadURL https://update.greasyfork.org/scripts/491635/KF_script_by_Kent.user.js
// @updateURL https://update.greasyfork.org/scripts/491635/KF_script_by_Kent.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]К сожалению, Вы ошиблись сервером. Данный раздел принадлежит серверу Tambov.[/CENTER]<br><br>" +
        '[CENTER][B][COLOR=rgb(255, 0, 0)]✿❯────「[SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman] Закрыто. [/FONT][/COLOR][/SIZE]」────❮✿ [/COLOR][/B] [/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    },
    ...
    },
{
      ...
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша неофициальная организация получает статус: [Color=Red]Отказано.[/color]<br>Причина: Заголовок вашей неофициальной организации составлен не по форме. Внимательно изучите правила составления неофициальных организаций.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
 ...
 $(document).ready(() => {
    ...
    addButton( '🚬Script by. Kent🚬', 'selectAnswer');
