...
// @version 6
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/396094/MPR.user.js
// @updateURL https://update.greasyfork.org/scripts/396094/MPR.meta.js
// ==/UserScript==
...
document.getElementById("ctl00_ContentPlaceHolder1_txtNoDays_AWC_SN_HCM").value = "1";
...
document.getElementById("ctl00_ContentPlaceHolder1_txtSNB_NOLW_MIN").value = "0";
  document.getElementById("ctl00_ContentPlaceHolder1_txtNoVHSND").value = "1";
...
document.getElementById("ctl00_ContentPlaceHolder1_txtNS_Nor_Girls_3y_5y").disabled = true;
   document.getElementById("ctl00_ContentPlaceHolder1_txtTPopu_0m_3m").disabled = true; 
clock();
}
document.getElementById("ctl00_ContentPlaceHolder1_txtTPopu_6m_3y").addEventListener("click", myFunction);
...
document.getElementById("ctl00_ContentPlaceHolder1_optAwcBuildType_2").click(checked = true); 
 ...
 // var dd3=document.getElementById("ctl00_ContentPlaceHolder1_txtSNB_Min_Out_TotBoys_6m_36m").value;//alert(dd3);
  ...
  var dd6=document.getElementById("ctl00_ContentPlaceHolder1_txtTPopu_6m_3y").value;
  ...
  var b03=parseInt(dd6*55/100);
  var g03=dd6-b03;
  var ee7=b03-(Number(ee1)+Number(ee2));//सामान्य 03 लड़का 
  var ee8=g03-(Number(ee3)+Number(ee4));//सामान्य 03 लड़की 
 ...
 var PW01=document.getElementById("ctl00_ContentPlaceHolder1_txtSNB_NOPW_SC").value;
  ...
  document.getElementById("ctl00_ContentPlaceHolder1_txtTPopu_0m_3m").value=document.getElementById("ctl00_ContentPlaceHolder1_txtTPopu_LM").value=LW3;
...
var b10=document.getElementById("ctl00_ContentPlaceHolder1_txtTPopu_3y_6y").value;
  ...
  var b36=parseInt(b10*55/100);
  var g36=b10-b36;
  var eee7=b36-(Number(eee1)+Number(eee2));//सामान्य 35 लड़का 
  var eee8=g36-(Number(eee3)+Number(eee4));//सामान्य 35 लडकी 
