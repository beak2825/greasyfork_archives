// ==UserScript==
// @name BLACK RUSSIA UFA
// @namespace https://forum.blackrussia.online
// @version 0.2.29
// @description Исходный код был взят с письменного разрешения от автора и нашего коллеги с 47 сервера - KRASNOYARSK. Скрипт полностью переписсан под наш сервер.
...
// @collaborator 
// @icon 
// @downloadURL https://update.greasyfork.org/scripts/528469/BLACK%20RUSSIA%20UFA.user.js
// @updateURL https://update.greasyfork.org/scripts/528469/BLACK%20RUSSIA%20UFA.meta.js
// ==/UserScript==
...
(function () {
    ...
    const START_COLOR_3 = `<font color=#8A2BE2>`
  ...
  const buttons = [
      {
         title: 'Приветствие',
         content:
         `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
      ...
      },
      {
          ...
          content:
         `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба передана ГКФ / ЗГКФ${END_COLOR} ${START_COLOR_1}на рассмотрение${END_COLOR}${START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Ожидайте ответа${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: WAIT_PREFIX,
          status: true,
      ...
      {
          title: `${START_COLOR_3}=======================================> ${END_COLOR}Отказы${START_COLOR_3} <================================== =====${END_COLOR}`,
      ...
      {
          title: 'Покупка / продажа дон.ценностей за ив',
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Покупка / продажа донат - ценностей за игровую валюту${END_COLOR} ${START_COLOR_1}запрещена${END_COLOR}${START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
      ...
      },
      {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Вы${END_COLOR} ${START_COLOR_1}ошиблись разделом${END_COLOR}${START_COLOR_2}.<br>Обратитесь в раздел жалоб на администрацию - *<a href='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.1165/'>Кликабельно</a>*${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
      ...
      },
      {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Вы${END_COLOR} ${START_COLOR_1}ошиблись разделом${END_COLOR}${START_COLOR_2}.<br>Обратитесь в раздел жалоб на лидеров - *<a href='https://forum.blackrussia.online/forums/Жалобы-на-лидеров.1166/'>Кликабельно</a>*${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
      ...
      },
      {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Вы${END_COLOR} ${START_COLOR_1}ошиблись разделом${END_COLOR}${START_COLOR_2}.<br>Обратитесь в раздел обжалований наказаний - *<a href='https://forum.blackrussia.online/forums/Обжалование-наказаний.1168/'>Кликабельно</a>*${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
      ...
      },
      {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Вы${END_COLOR} ${START_COLOR_1}ошиблись разделом${END_COLOR}${START_COLOR_2}.<br>Обратитесь в тех. раздел - *<a href='https://forum.blackrussia.online/forums/Технический-раздел-ufa.1138/'>Кликабельно</a>*${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
      ...
      },
      {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Вы${END_COLOR} ${START_COLOR_1}ошиблись разделом${END_COLOR}${START_COLOR_2}.<br>Обратитесь в раздел жалоб на тех. специалистов - *<a href='https://forum.blackrussia.online/forums/Сервер-№25-ufa.1206/'>Кликабельно</a>*${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
      ...
      {
          title: `${START_COLOR_3}=================================> ${END_COLOR}Правила RP процесса${START_COLOR_3} <================================${END_COLOR}`,
          color: 'border-radius: px; margin-right: 5px; border: 1px solid; background-color: #8A2BE2; border-color: #E6E6FA',
      },
       {
          title: 'nRP поведение',
    ...
    },
    {
     ...
     {
          title: 'Слив админ информации',
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]2.27. Запрещено распространение информации и материалов, непосредственно связанных с деятельностью администрации проекта, которые могут повлиять на работу и систему администрации | PermBan + ЧС проекта[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
     ...
     {
          title: 'Ущерб экономике сервера',
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]2.30. Запрещено пытаться нанести ущерб экономике сервера | Ban 15 - 30 дней / PermBan[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
     ...
     {
          title: 'Попытка продажи игр. имущества за реальные деньги',
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]2.42. Попытка продажи любого игрового имущества или игрового аккаунта за реальные деньги | PermBan[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
     ...
     {
         title: 'Покупка / продажа наград за реф. систему / промокод',
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]2.43. Запрещена продажа / обмен / покупка поощрительной составляющей от лица проекта, будь то бонус-код, либо промокод, который выдается безвозмездно игрокам в целях промоакций | Mute 120 минут[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
     ...
     {
          title: 'Покупка / продажа / трансфер репутации семьи',
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]2.48. Запрещена продажа, передача, трансфер или покупка репутации семьи любыми способами, скрытие нарушителей, читеров лидером семьи. | Обнуление рейтинга семьи / Обнуление игрового аккаунта лидера семьи[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
     ...
     {
          title: 'Некорректное название внутриигровым ценностям',
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]2.53. Запрещено устанавливать названия для внутриигровых ценностей с использованием нецензурной лексики, оскорблений, слов политической или религиозной направленности | Принудительная смена названия семьи / Ban 1 день / При повторном нарушении – обнуление бизнеса.[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
     ...
     },
     {
      ...
      {
          title: `${START_COLOR_3}================================> ${END_COLOR}Правила игровых чатов${START_COLOR_3} <================================${END_COLOR}`,
          color: 'border-radius: px; margin-right: 5px; border: 1px solid; background-color: #8A2BE2; border-color: #E6E6FA',
      },
      {
          title: 'CapsLock',
     ...
     },
     {
      ...
      {
          title: `${START_COLOR_3}==============================> ${END_COLOR}Правила игровых аккаунтов${START_COLOR_3} <=============================${END_COLOR}`,
          color: 'border-radius: px; margin-right: 5px; border: 1px solid; background-color: #8A2BE2; border-color: #E6E6FA',
      },
      {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]4.03. Передача своего личного игрового аккаунта третьим лицам | PermBan[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
      ...
      },
      {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]4.04. Разрешается зарегистрировать максимально только три игровых аккаунта на сервере | PermBan[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
      ...
      },
      {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша жалоба одобрена, нарушитель будет наказан${END_COLOR} ${START_COLOR_1}по пункту правил${END_COLOR}${START_COLOR_2}: [QUOTE]4.05. Запрещена передача либо трансфер игровых ценностей, между игровыми аккаунтами либо серверами, а также в целях удержания имущества | Ban 15 - 30 дней / PermBan[/QUOTE]${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Одобрено, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
     ...
     },
     {
      ...
      {
          title: `${START_COLOR_3}====================================> ${END_COLOR}Правила ОПГ${START_COLOR_3} <=====================================${END_COLOR}`,
          color: 'border-radius: px; margin-right: 5px; border: 1px solid; background-color: #8A2BE2; border-color: #E6E6FA',
      },
      {
    ...
    const biography = [
        ...
        },
        {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша Roleplay биография составлена${END_COLOR} ${START_COLOR_1}не по форме${END_COLOR}${START_COLOR_2}.<br>Ознакомиться с правилами составления Roleplay биографий вы можете в этой теме - *<a href='https://forum.blackrussia.online/threads/ufa-Форма-подачи-rp-Биографии.10975691/'>Кликабельно</a>*.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
     ...
     },
     {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Заголовок Вашей темы составлен${END_COLOR} ${START_COLOR_1}не по форме${END_COLOR}${START_COLOR_2}.<br>Ознакомиться с правилами составления Roleplay биографий вы можете в этой теме - *<a href='https://forum.blackrussia.online/threads/ufa-Форма-подачи-rp-Биографии.10975691/'>Кликабельно</a>*.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
     ...
     },
     {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}В Вашей Roleplay биографии отсутствует${END_COLOR}${START_COLOR_1} личное фото${END_COLOR}${START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
     ...
     },
     {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша Roleplay биография частично либо полностью${END_COLOR} ${START_COLOR_1}написана нейросетью${END_COLOR}${START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
     ...
     {
          title: 'Есть одобренная биография',
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}На нашем сервере у Вас уже есть${END_COLOR} ${START_COLOR_1}одобренная Roleplay биография${END_COLOR}${START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
    ...
    const situations = [
        ...
        },
        {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша Roleplay ситуация составлена${END_COLOR} ${START_COLOR_1}не по форме${END_COLOR}${START_COLOR_2}.<br>Ознакомиться с правилами составления Roleplay ситуации вы можете в этой теме - *<a href='https://forum.blackrussia.online/threads/ufa-Правила-написания-roleplay-ситуации.10975666/'>Кликабельно</a>*.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
    ...
    const organizations = [
        ...
        },
        {
          ...
          content:
          `${START_DECOR + START_COLOR_1}{{ greeting }}, уважаемый(-ая) {{ user.mention}}${END_COLOR + START_COLOR_2}.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Ваша Roleplay организация составлена${END_COLOR} ${START_COLOR_1}не по форме${END_COLOR}${START_COLOR_2}.<br>Ознакомиться с правилами составления Roleplay организаций вы можете в этой теме - *<a href='https://forum.blackrussia.online/threads/ufa-Правила-подачи-заявления-на-Неофициальную-rp-организацию.10975646/'>Кликабельно</a>*.${END_COLOR}<br><br>` +
          `${START_COLOR_2}Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.${END_COLOR}<br><br>` +
          `${START_COLOR_1}Отказано, закрыто${END_COLOR}${START_COLOR_2}.${END_COLOR}${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
...
const ButtonST = document.createElement("button");
const ButtonOR = document.createElement("button");
const ButtonPS = document.createElement("button");
 
ButtonZB.textContent = "Жалобы";
ButtonBG.textContent = "Биографии";
ButtonST.textContent = "Ситуации";
ButtonOR.textContent = "Организации";
ButtonPS.textContent = "ОПС";
 
bgButtons.append(ButtonZB);
bgButtons.append(ButtonBG);
bgButtons.append(ButtonST);
bgButtons.append(ButtonOR);
bgButtons.append(ButtonPS);
 
ButtonZB.style.marginLeft = "10px";
ButtonZB.style.background = "#E6E6FA"
ButtonZB.style.borderRadius = "10px"
ButtonZB.style.boreder = "5px solid #4a4b4d"
 
ButtonBG.style.marginLeft = "5px";
ButtonBG.style.background = "#E6E6FA"
ButtonBG.style.borderRadius = "10px"
ButtonBG.style.boreder = "5px solid #4a4b4d"
 
ButtonST.style.marginLeft = "5px";
ButtonST.style.background = "#E6E6FA"
ButtonST.style.borderRadius = "10px"
ButtonST.style.boreder = "5px solid #4a4b4d"
 
ButtonOR.style.marginLeft = "5px";
ButtonOR.style.background = "#E6E6FA"
ButtonOR.style.borderRadius = "10px"
ButtonOR.style.boreder = "5px solid #4a4b4d"
 
ButtonPS.style.marginLeft = "5px";
ButtonPS.style.background = "#E6E6FA"
ButtonPS.style.borderRadius = "10px"
ButtonPS.style.boreder = "5px solid #4a4b4d"
 
function BZB() {
    window.location.href = 'https://forum.blackrussia.online/forums/%D0%90%D0%B4%D0%BC%D0%B8%D0%BD-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB.1167/';
    };
 
function BBG() {
    window.location.href = 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.1147/';
    };
    
function BST() {
    window.location.href = 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.1146/';
    };
 
function BOR() {
    window.location.href = 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.1144/';
    };
...
ButtonPS.addEventListener("click", () => {
    ...
    $(document).ready(() => {
        ...
        addButton('На рассмотрение', 'pin', 'border-radius: 13px; margin-right: 5px; border: 1px solid; background-color: #0d0d0d; border-color: #FFA500');
        addButton('Тех. специалисту', 'tech', 'border-radius: 13px; margin-right: 5px; border: 1px solid; background-color: #0d0d0d; border-color: #0000FF');
        addButton('Одобрено', 'accepted', 'border-radius: 13px; margin-right: 5px; border: 1px solid; background-color: #0d0d0d; border-color: #008000');
        addButton('Отказано', 'unaccept', 'border-radius: 13px; margin-right: 5px; border: 1px solid; background-color: #0d0d0d; border-color: #FF0000');
        addButton('Меню жалоб', 'selectComplaintAnswer', 'border-radius: 13px; margin-right: 5px; border: 1px solid; background-color: #0d0d0d; border-color: #E6E6FA');
        addButton('Меню биографий', 'selectBiographyAnswer', 'border-radius: 13px; margin-right: 5px; border: 1px solid; background-color: #0d0d0d; border-color: #E6E6FA')
        addButton('Меню ситуаций', 'selectSituationsAnswer', 'border-radius: 13px; margin-right: 5px; border: 1px solid; background-color: #0d0d0d; border-color: #E6E6FA');
        addButton('Меню организаций', 'selectOrganizationsAnswer', 'border-radius: 13px; margin-right: 5px; border: 1px solid; background-color: #0d0d0d; border-color: #E6E6FA');
    ...
    function buttonsMarkup(buttons) {
        return `<div class="select_answer">${buttons
            ...
            `rippleButton" style="margin:5px; border-radius: 13px; margin-right: 5px; border: 1px solid; border-color: #E6E6FA; background-color: ${btn.color || "#0d0d0d"}"><span class="button-text">${btn.title}</span></button>`,
        )
            .join('')}</div>`;
    }
