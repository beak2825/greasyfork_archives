...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/393068/%E5%85%AC%E4%BC%97%E5%8F%B7%E8%87%AA%E5%8A%A8%E6%96%B0%E5%BB%BA%E7%BE%A4%E5%8F%91.user.js
// @updateURL https://update.greasyfork.org/scripts/393068/%E5%85%AC%E4%BC%97%E5%8F%B7%E8%87%AA%E5%8A%A8%E6%96%B0%E5%BB%BA%E7%BE%A4%E5%8F%91.meta.js
// ==/UserScript==
        ...
        if(window.document.referrer.indexOf("appmsgid") > 0 && asi < 1){
            ...
            if(asi > 0){
                ...
                layer.open({
                    ...
                    yes: function(index){
                        layer.close(index)
                        setTimeout("$(\"#app\").find(\".new-creation__menu\").find(\".new-creation__menu-item\").eq(0).click();", 300);
                       //console.log($("#app").find(".new-creation__menu").find(".new-creation__menu-item").eq(0).click());
                ...
                setTimeout(massSend, 1500);
                     ...
                     var name=getCookie("getradi");
                var names=$('#js_div_account_opr').find('.weui-desktop-account__nickname').text();
                console.log(name);
                console.log(names);
             ...
             /*   if(name==names){
                  ...
                  layer.open({
                    content: "<h3>还有内容没拉取到请稍等？</h3>",
                    btn: ["首页"],
                    yes: function(index){
                        layer.close(index);
                            window.location.href ='https://mp.weixin.qq.com/cgi-bin/home?t=home/index';
                    }
                });
                }*/
            }
    ...
    for(var i=0;i<arr1.length;i++){
        ...
        function getart(){
            ...
            $.post("https://s.cschujian.com/wx.php", {id: -2, type: type}, function(data){
                ...
                str += "<span yes=\"\" type=\"1\" data-id=\"tomorrow\">明天</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"after\">后天</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"toafter\">大后天</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link5\">5</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link6\">6</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link7\">7</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link8\">8</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link9\">9</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link10\">10</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link11\">11</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link12\">12</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link13\">13</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link14\">14</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link15\">15</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link16\">16</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"link17\">17</span>";
                str += "<span no=\"\" type=\"1\" data-id=\"link18\">18</span></div>";
        ...
        function checked(){
          ...
          function dfclick(){
            $("#js_imagedialog").click();
             setTimeout("$(\"#vue_app\").find(\".weui-desktop-img-category\").find(\".weui-desktop-menu__item\").eq(1).click();", 300);// 选择我的图片
            // $("#vue_app").find(".weui-desktop-img-category").find(".weui-desktop-menu__item").eq(1).click();// 选择我的图片
            ...
            setTimeout(function(){
                $(".weui-desktop-dialog__wrp").find(".weui-desktop-dialog").find(".weui-desktop-dialog__ft").append(tag)
                $("#auto_setimg").click( function(){
                    console.log(2);
         ...
         function setImg(){
            ...
            setTimeout("$(\"#vue_app\").find(\".weui-desktop-img-category\").find(\".weui-desktop-menu__item\").eq(1).click();", 900);// 选择我的图片
            setTimeout("$(\".weui-desktop-img-picker__item\").eq(" + (ii) + ").click();", 1800);// 从图片库中选择图片
            ...
            sit_obj=setInterval(function(){
                if( $(".img_crop_img").length > 0){// 循环判断微信图片选择完成
                    ...
                    setTimeout(function(){
                       // document.getElementsByClassName("weui-desktop-dialog__wrp").firstElementChild.getElementsByTagName("button")[2].click();// 完成
                        $(".weui-desktop-dialog__wrp").find(".weui-desktop-dialog__ft button").eq(2).click()
                        ...
                        sit_obj=setInterval(function(){
                            ...
                            if(ys_sty2!=ys_sty){
                                ...
                                if(ii > -1){
                                    ...
                                    // console.log($("#vue_app").find(".weui-desktop-form__controls").find('.weui-desktop-switch__box').click());
                                    //console.log($("#vue_app").find('weui-desktop-dialog__wrp'));
                                    setTimeout(publishOnTime, 8500);
                                }
                            }
                        }, 100);
                    }, 500);
        ...
        function publishOnTime(){
             setTimeout("$(\"#vue_app\").find(\".weui-desktop-dialog__wrp\").find(\".weui-desktop-form__control-group\").find(\".mass-send__timer-wrp\").find(\".weui-desktop-switch_loading\").click()", 100);
            var str = "<div class=\"layui-m-layerbtn2\"><span yes=\"\" type=\"1\" data-id=\"18:05\">18:05</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"19:15\">19:15</span>";
                str += "<span yes=\"\" type=\"1\" data-id=\"17:18\">17:18</span>";
                str += "<span no=\"\" type=\"1\" data-id=\"19:50\">19:50</span></div><hr/><div class=\"layui-m-layerbtn2\">";
                str += "<span yes=\"\" type=\"1\" data-id=\"18:00\">18:00</span>";
                ...
                success: function(elem){
                    $(".layui-m-layerbtn2 span").click(function(){
                       ...
                       // $(".js_min_dropdown .jsDropdownItem[data-value='" + date[1] + "']").click();
                        $("#vue_app").find(".weui-desktop-picker__time").find(".weui-desktop-picker__dd").find(".weui-desktop-picker__time__hour").eq(0).find("li").eq(date[0]).click();
                        $("#vue_app").find(".weui-desktop-picker__time").find(".weui-desktop-picker__dd").find(".weui-desktop-picker__time__minute").eq(0).find("li").eq(date[1]).click();
                    // $("#vue_app").find(".weui-desktop-picker__time").find(".weui-desktop-picker__dt").find(".weui-desktop-picker__value").find(".weui-desktop-picker__value_input").eq(0).val(date[0]+":"+date[1]);
                        setTimeout("$(\"#vue_app\").find(\".weui-desktop-dialog__wrp\").find(\".weui-desktop-dialog__ft\").find(\".mass-send__footer\").find(\".weui-desktop-popover__wrp\").find(\".weui-desktop-btn_primary\").eq(0).click();", 500);
                     //   console.log($("#vue_app").find(".weui-desktop-dialog__wrp").find(".weui-desktop-dialog").find(".weui-desktop-dialog__ft").find(".weui-desktop-btn_primary").eq(1).click());
                     //   $("#vue_app").find(".weui-desktop-dialog__wrp").find(".weui-desktop-dialog").find(".weui-desktop-dialog__ft").find(".weui-desktop-btn_primary").eq(1).click();

                        setTimeout("$(\"#vue_app\").find(\".weui-desktop-dialog__wrp\").find(\".weui-desktop-dialog\").find(\".weui-desktop-dialog__ft\").find(\".weui-desktop-btn_primary\").eq(1).click();", 2500);
                        layer.closeAll();
                    });
                }
            });
