// ==UserScript==
// @name          OverCompact
// @version       17.2017.4.25
// @namespace     github.io/spmbt
// @description   more compact forum forums.overclockers.ru
// @author        spmbt
// @icon          https://forums.overclockers.ru/favicon.ico
// @include       https://overclockers.ru/*
// @include       https://*.overclockers.ru/*
// @include       http://*.cnews.ru/*
// @include       https://*.cnews.ru/*
// @update        #wrapfooter fix width
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/1963/OverCompact.user.js
// @updateURL https://update.greasyfork.org/scripts/1963/OverCompact.meta.js
// ==/UserScript==
(function(){ //2017.1.8 - добавлен скрипт анти-адблокера, т.к. адблокер не давал запускаться даже стилям; прочее не поправлено, хотя многие мелочи нужно поправить

function AAK(){ //greasyfork.org/ru/scripts/23922-anti-adblock-killer-for-overclockers-ru/
	...
	new MO(function(ms){
		for(var m of ms)
			for(var n of m.addedNodes){
				var nI = n.innerHTML;
				if(n.nodeType === Node.ELEMENT_NODE && n.tagName =='SCRIPT' && /adblock|payment/ig.test(nI)){
					n.innerHTML = /adblock/i.test(nI) ? nI.replace(/\$(.*)["']body["'](.*);/ig,'')
						: nI.replace(/href/,'hash').replace(/http/,'\x20\u0434\u0430\x2C\x20\u043C\u044B\x20\u043A\u043E\u0437\u043B\u044B\x2C\x20\u0438\x20\u0432\u0441\u0435\x20\u044D\u0442\u043E\x20\u0437\u043D\u0430\u044E\u0442\x20');  //cnews
