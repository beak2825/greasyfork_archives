// ==UserScript==
// @name                WME Validator Localization for Colombia
// @version             1.0.0
// @description         This script localizes WME Validator for Colombia. You also need main package (WME Validator) installed.
// @match               https://editor-beta.waze.com/*editor/*
// @match               https://www.waze.com/*editor/*
// @grant               none
// @run-at              document-start
// @namespace https://greasyfork.org/users/9555
// @downloadURL https://update.greasyfork.org/scripts/27955/WME%20Validator%20Localization%20for%20Colombia.user.js
// @updateURL https://update.greasyfork.org/scripts/27955/WME%20Validator%20Localization%20for%20Colombia.meta.js
// ==/UserScript==
//
/*
...
window.WME_Validator_Colombia = {
  ...
  "city.2": "expandir la abreviatura",
  ...
  "131.params": {
    ...
    "regexp": "/^6:[1-4]:B(ogotá|arrancabermeja|arranquilla|ucaramanga|)|C(ali|artagena)|M(anizales|edellín))/i"
  },
  ...
  "132.params": {
    ...
    "solutionEN": "Lock the segment",
    "template": "${type}:${lock}:${city}",
    "regexp": "/^7:[12]:(B(ogotá|arrancabermeja|arranquilla|ucaramanga|)|C(ali|artagena)|M(anizales|edellín))/i"
  },
  ...
  "133.params": {
    ...
    "solutionEN": "Lock the segment",
    "template": "${type}:${lock}:${city}",
    "regexp": "/^2:[1]:B(ogotá|arrancabermeja|arranquilla|ucaramanga|)|C(ali|artagena)|M(anizales|edellín))/i"
  },
