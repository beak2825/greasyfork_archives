...
// @match        guangdiu.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/404970/%E9%80%9B%E4%B8%A2.user.js
// @updateURL https://update.greasyfork.org/scripts/404970/%E9%80%9B%E4%B8%A2.meta.js
// ==/UserScript==
...
(function() {
    ...
    let blacklist = ["一叶子","花洒","燕窝","虾选","硒鼓","高仕","羽森蛇毒","BB霜","发胶","胶原蛋白","蔻驰","防撞贴","马扎","采乐","雅顿","后视镜","集成灶","美迪惠尔","滋源","珂润","宝路华","项链","古驰","电饼铛","婴儿推车"
                    ...
                    ,"白酒","遮瑕盘","精华液","眼霜","减肥","防晒喷雾","路亚","白兰地","SWAROVSKI","钢笔","饮水机","红参","SOFINA","瑜伽环"]
