...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/504055/Heart%20Clicker%20Game%20Cheat%20GUI.user.js
// @updateURL https://update.greasyfork.org/scripts/504055/Heart%20Clicker%20Game%20Cheat%20GUI.meta.js
// ==/UserScript==
...
(function() {
    ...
    closeButton.addEventListener('click', () => {
        cheatGui.style.display = 'none';
        openButton.style.display = 'block';
    });
    cheatGui.appendChild(closeButton);
    ...
    // Create and add open GUI button
    const openButton = document.createElement('button');
    openButton.id = 'open-button';
    openButton.innerText = 'Open GUI';
