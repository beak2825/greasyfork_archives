...
// @name         SkittleGamer_TTV
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  Simple SS Theme using CSS Variables
// @author       You (and thanks to my bro on twitch Oltosuper for making and sending the code on discord to me for this go follow him on twitch)
// @match        https://shellshock.io/*
// @match        https://biologyclass.club/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/454747/SkittleGamer_TTV.user.js
// @updateURL https://update.greasyfork.org/scripts/454747/SkittleGamer_TTV.meta.js
// ==/UserScript==
...
* {
	...
	--ss-blue1: #95E2FE;
	--ss-blue2: #5EBBD9;
	--ss-blue3: #6c09ed; /*Lighter Box Borders*/
	...
	--ss-lightoverlay: linear-gradient(#00FFFF, #0213fa); /*Main Background*/
