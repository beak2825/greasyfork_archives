...
// @grant           none
// @downloadURL https://update.greasyfork.org/scripts/496474/DiscoDelate%20-%20Delete%20all%20messages%20in%20a%20Discord%20channel%20or%20DM%20%28Bulk%20deletion%29.user.js
// @updateURL https://update.greasyfork.org/scripts/496474/DiscoDelate%20-%20Delete%20all%20messages%20in%20a%20Discord%20channel%20or%20DM%20%28Bulk%20deletion%29.meta.js
// ==/UserScript==
(function () {
	'use strict';
...
`);
	...
	var buttonHtml = (`
<div id="undicord-btn" tabindex="0" role="button" aria-label="Delete Messages" title="Delete Messages with DiscoDelate">
    ...
    <div class="window-body" style="display: flex; flex-direction: row;">
        ...
        <div class="main col">
            ...
            <pre id="logArea" class="logarea scroll">
                ...
                <center>
                    <div>Star <a href="https://github.com/Red-Hat-offical" target="_blank" rel="noopener noreferrer">this project</a> on GitHub!</div>
                </center>
            </pre>
	...
	class UndiscordCore {
	  ...
	  async run(isJob = false) {
	    ...
	    log.debug(
	      ...
	      `hasFile = ${!!this.options.hasFile}`,0
	    );
