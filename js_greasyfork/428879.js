// ==UserScript==
// @name         ComicnettaiSpider
// @namespace    https://www.comicnettai.com/
// @version      0.5
// @description  A Manga Spider for comicnettai.com | V0.5 在序号1-9的图片文件名前加上前缀'0'
// @author       DD1969
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/428879/ComicnettaiSpider.user.js
// @updateURL https://update.greasyfork.org/scripts/428879/ComicnettaiSpider.meta.js
// ==/UserScript==

(async function(axios, JSZip, saveAs, ConfigDecoder, Page) {
  'use strict';

  start('https://www.comicnettai.com/api/viewer/c' + window.location.search);
