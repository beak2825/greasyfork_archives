// ==UserScript==
// @name FL Dynasty League
// @namespace glenncarr.com/greasemonkey
// @include http://hockey.fantasysports.yahoo.com/hockey/559*
...
// @grant GM_getValue
// @grant GM_addStyle
// @version 0.0.1.20150216215818
// @downloadURL https://update.greasyfork.org/scripts/8365/FL%20Dynasty%20League.user.js
// @updateURL https://update.greasyfork.org/scripts/8365/FL%20Dynasty%20League.meta.js
// ==/UserScript==
...
var ELIGIBILITY_FOOTNOTE = '*Exceeds rookie eligibility requirements for players (>82 GP) and goalies (>60 GP)';
...
return ( this.gamesStarted <= 82 );
else
return ( this.gamesPlayed <= 60 );
}
}
...
var FARM_ROSTERS_URL = "https://docs.google.com/spreadsheets/d/13RK08nWe_6yG4zIoEYx9X9wAOGnnHHXhasHA95aNWiA&output=txt";
...
var ownerID = null;
// baseball.fantasysports.yahoo.com/b1/26105/team?date=2009-03-20&week=1&mid=1
...
var html = new Array( '<thead><tr class="headerRow1"><th style="text-align:left; width: 150px; padding: 0px, 6px;">Player</th><th style="text-align:left; width: 150px; padding: 0px 0px;">Notes</th><th style="text-align:left; width: 150px; padding: 0px 0px;"><a id="gncGetCareerStats" href="#">Career Games/2014 Stats</a></th><th style="text-align:right; width: 75px; padding: 0px 0px;">GP</th><th style="text-align:right; width: 75px; padding: 0px 0px;">G/W</th><th style="text-align:right; width:75px; padding: 0px 0px;">A/GAA</th><th style="text-align:right; width: 75px; padding: 0px 6px 0px 0px;">PTS/SO</th></tr></thead>' );	
...
// console.dir(table); dumps every table on the page to the console
...
var matches = table.innerHTML.match(/Year/g); //matching innerhtml of the tables pulled earlier globally

//	console.dir(matches); dump matches to console
...
var offense = table.innerHTML.match(/offense/i); //*****fix this line****
console.dir(matches); 
...
if (offense)
{ 
if ( /2014/.test( row.cells[ 0 ].innerHTML ) && getDataValue( row, 'gp' ) ) //season skater stats
{
...
{ 
if ( /2014/.test( row.cells[ 0 ].innerHTML ) && getDataValue( row, 'w' ) ) //goalie stats
{
var seasonGames = getDataValue( row, 'gp' ); 
seasonGames = parseInt (seasonGames, 10);
tableGames.innerHTML = seasonGames + ' GP'; 
