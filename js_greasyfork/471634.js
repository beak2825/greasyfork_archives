// ==UserScript==
// @name         Flufffluffyplaysgamez's theme
// @namespace    http://tampermonkey.net/
// @version      1
// @description  GO FOLLOW fluffyplaysgamez GREAT TWITCH STREAMER
// @author       SilverHawk
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471634/Flufffluffyplaysgamez%27s%20theme.user.js
// @updateURL https://update.greasyfork.org/scripts/471634/Flufffluffyplaysgamez%27s%20theme.meta.js
// ==/UserScript==
...
* {
    ...
    --ss-lightoverlay: url("https://cdn.discordapp.com/attachments/1104426900765548554/1132515650716323961/ioozSoc4rmejFkDL5qSTMb.jpg");/*Main Background*/
    ...
    --ss-me-player-bg: url("https://cdn.discordapp.com/attachments/1104426900765548554/1132518597839826985/download.png")
}
...
.hardBoiledShield {
    ...
    transform: translateX(-50%);
    height: 100%;
  content: url('https://cdn.discordapp.com/attachments/1104426900765548554/1132775930062983308/shieldshs-removebg-preview__3_-removebg-preview.png');
}
...
#maskmiddle {
	background: url('https://cdn.discordapp.com/attachments/1104426900765548554/1132522121306841098/navybluescope_1.png') center center no-repeat;
...
.playerSlot--icons .vip-egg {
  ...
  content: url('https://cdn.discordapp.com/attachments/1104500998879334521/1104501138478333962/egg.png') !important;
  max-height: 1.3em;
  max-width: 1.3em;
}
...
#best_streak_container h1 {
    ...
    background-image: url('https://cdn.discordapp.com/attachments/1104426900765548554/1132518003691507794/image-removebg-preview_7.png');
...
.egg_icon {
   ...
   content: url(https://cdn.discordapp.com/attachments/1104426900765548554/1132516812584665088/images__1_-removebg-preview.png)
}
