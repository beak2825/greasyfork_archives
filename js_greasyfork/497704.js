// // ==UserScript==
    // @name         SPB | Forum Curators Script
    // @namespace    https://forum.blackrussia.online
    // @version      5.5.0
    // @description  Скрипт для Кураторов Форума SPB! Частое обновление! По вопросам писать в ВК https://vk.com/rabany9
    ...
    const buttons = [
        ...
        },
        {
          ...
          content:
            ...
            "[/LIST]<br>" +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(0, 255, 0)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
    ...
    "[COLOR=rgb(255, 0, 0)][SIZE=4]2.16. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещен SK (Spawn Kill) — убийство или нанесение урона на титульной территории любой фракции / организации, на месте появления игрока, а также на выходе из закрытых интерьеров и около них[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Jail 60 минут / Warn (за два и более убийства) [/SIZE][/COLOR]<br>" +
        ...
        },
        {
          ...
          content:
            ...
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на сервере SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(0, 255, 0)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
          prefix: ACCEPT_PREFIX,
          status: false,
        },
     ...
     
        {
          ...
          content:
            ...
            'Приятной игры на SPB[/I][/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR][/CENTER]',
          prefix: PIN_PREFIX,
          status: true,
        },
        {
          ...
          content:
            ...
            '[FONT=times new roman][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA RolePlay[/I][/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR][/CENTER]',
          prefix: TEX_PREFIX,
          status: true,
        },
        {
        ...
        },
    	{
         ...
         {
          title: 'Нрп КОП гибдд в/у',
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
            "[COLOR=rgb(255, 0, 0)][FONT=book antiqua]7.04. [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua]Запрещено отбирать водительские права во время погони за нарушителем [/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua]| Warn[/FONT][/COLOR]<br><br>" +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(0, 255, 0)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
          prefix: ACCEPT_PREFIX,
          status: false,
         ...
         {
          title: 'Нрп КОП выдача звезд/штраф без рп',
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
            "[COLOR=rgb(255, 0, 0)][FONT=book antiqua]7.02. [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua]Запрещено выдавать розыск, штраф без Role Play причины[/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua]| Warn[/FONT][/COLOR]<br><br>" +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(0, 255, 0)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
          prefix: ACCEPT_PREFIX,
          status: false,
        },
        {
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
            "[COLOR=rgb(255, 0, 0)][FONT=book antiqua]4.01. [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua]Запрещено редактирование объявлений, не соответствующих ПРО[/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua]| Mute 30 минут[/FONT][/COLOR]<br><br>" +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(0, 255, 0)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
          prefix: ACCEPT_PREFIX,
          status: false,
        },
         {
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
            "[COLOR=rgb(255, 0, 0)][FONT=book antiqua]2. [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua]Запрещено провоцировать сотрудников государственных организаций[/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua]| Jail 30 минут[/FONT][/COLOR]<br><br>" +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(0, 255, 0)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
          prefix: ACCEPT_PREFIX,
          status: false,
        },
        {
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
            "[COLOR=rgb(255, 0, 0)][FONT=book antiqua]3. [/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua]Запрещено провоцировать сотрудников криминальных организаций возле или на территории вражеской группировки[/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua]| Jail 30 минут[/FONT][/COLOR]<br><br>" +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(0, 255, 0)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
          prefix: ACCEPT_PREFIX,
          status: false,
        ...
        },
        {
          ...
          content:
            ...
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
        ...
        },
        {
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша жалоба составлена с нарушением. Внимательно прочитайте правила подачи жалоб на игроков - [/I][URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.3429394/']*нажмите сюда*[/URL].[/FONT][/SIZE]<br><br>" +
            "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на SPB[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4]Отказано.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
          prefix: UNACCEPT_PREFIX,
        ...
        },
        {
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]В вашей жалобе нету таймкодов.[/I][/FONT][/SIZE]<br><br>" +
            "[FONT=times new roman][SIZE=4][I]Напишите таймокоды в течение 24-х часов.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
            "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA RolePlay.[/SIZE][/FONT][/COLOR]<br><br>" +
            '[COLOR=rgb(255, 152, 0)][FONT=times new roman][SIZE=4]На рассмотрении.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
          prefix: UNACCEPT_PREFIX,
          status: false,
        },
        {
          title: 'Нету пинга(Читы)',
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        ...
        },
        {
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию - [/I][URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.1122/']*нажмите сюда*[/URL][/FONT][/SIZE]<br><br>" +
        ...
        },
        {
          ...
          content:
            ...
            "Приятной игры на SPB.[/I][/COLOR][/FONT]<br>" +
            '[I][FONT=times new roman][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/I][/SIZE][/CENTER]',
          prefix: UNACCEPT_PREFIX,
          status: false,
        },
    	{
          title: 'Не робит док-ва',
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[FONT=times new roman][COLOR=rgb(209, 213, 216)][I]Ваши доказательства не работают.<br>" +
            "Приятной игры на SPB.[/I][/COLOR][/FONT]<br>" +
            '[I][FONT=times new roman][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/I][/SIZE][/CENTER]',
          prefix: UNACCEPT_PREFIX,
          status: false,
        },
    	{
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[FONT=times new roman][COLOR=rgb(209, 213, 216)][I]Для данного нарушения нужен Фрапс(Видеозапись).<br>" +
            "Приятной игры на SPB.[/I][/COLOR][/FONT]<br>" +
            '[I][FONT=times new roman][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/I][/SIZE][/CENTER]',
          prefix: UNACCEPT_PREFIX,
          status: false,
    	...
    	{
          title: 'Плохое качество(Док-вы)',
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[FONT=times new roman][COLOR=rgb(209, 213, 216)][I]Доказательство плохого качества.<br>" +
    	...
    	{
          title: 'Чат не рассматривается',
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[FONT=times new roman][COLOR=rgb(209, 213, 216)][I]Чат не подлежит рассмотрению.<br>" +
            "Приятной игры на BLACK RUSSIA RolePlay.[/I][/COLOR][/FONT]<br>" +
            '[I][FONT=times new roman][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/I][/SIZE][/CENTER]',
          prefix: UNACCEPT_PREFIX,
          status: false,
        ...
        },
        {
          ...
          content:
           "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
            ...
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на SPB.[/COLOR][/I][/SIZE][/FONT]',
          prefix: ACCEPT_PREFIX,
          status: false,
        },
        {
        ...
        content:
           "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - биография отказана т.к. вы её не дополнили. [/COLOR]<br><br>" +
              "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/COLOR][/I][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
             "[CENTER][IMG width=695px]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA RolePlay.[/COLOR][/I][/SIZE][/FONT]',
          prefix: UNACCEPT_PREFIX,
          status: false,
        },
        {
        ...
        },
        {
          ...
          content:
            ...
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 21OLOR=rgb(0, 255, 255)]SPB[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=6)][I]Приятной игры на [/I][/COLOR][I][Cbook antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
          prefix: ACCEPT_PREFIX,
          status: false,
        },
        {
          ...
          content:
            ...
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - Ситуации - [/COLOR][/I][COLOR=rgb(209, 213, 216)][URL='https://forum.blackrussia.online/index.php?threads/sochi-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BD%D0%B0%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D1%81%D0%B8%D1%82%D1%83%D0%B0%D1%86%D0%B8%D0%B8.2368139/']*Нажмите сюда*[/URL][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)]SPB[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
        },
        {
        ...
        },
        {
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша Неофициальная RolePlay - организация одобрена.[/COLOR][/I][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)]SPB[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
          prefix: ACCEPT_PREFIX,
          status: false,
        },
        {
          ...
          content:
            '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша Неофициальная RolePlay - организация отказана.[/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания Неофициальной RP - Организации - [/COLOR][/I][COLOR=rgb(209, 213, 216)][URL='https://forum.blackrussia.online/index.php?threads/sochi-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B7%D0%B0%D1%8F%D0%B2%D0%BA%D0%B8.2368280/']*Нажмите сюда*[/URL][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на [/I][/COLOR][I][COLOR=rgb(0, 255, 255)]SPB[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
          prefix: UNACCEPT_PREFIX,
          status: false,
        },
        {
          ...
          content:
            ...
            "Даю вам 24 часа на ее дополнение.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
            '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)]Sochi[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
          prefix: PIN_PREFIX,
        }
      ];
    $(document).ready(() => {
        ...
        $(`button#selectAnswer`).click(() => {
            XF.alert(buttonsMarkup(buttons), null, 'Выберите вердикт by Jacob Anderson кофе монарх  ❤️ 💋');
