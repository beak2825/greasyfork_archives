// ==UserScript==
// @name         e itch.io exclude tag May 2023
// @namespace    itchiohide
// @description  Hide games tagged horror and horrible, and more
// @version      6
// @match        *://itch.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/464588/e%20itchio%20exclude%20tag%20May%202023.user.js
// @updateURL https://update.greasyfork.org/scripts/464588/e%20itchio%20exclude%20tag%20May%202023.meta.js
// ==/UserScript==
(function() {
...
Horror hidden : ${document.querySelectorAll('.tag-horror').length}<br>
Horrible hidden : ${document.querySelectorAll('.tag-horrible').length}
</div>`
