...
// @version      0.1.1
// @description  优化ERP展示的bug、蓝凌ERP
// @author       Andiest ziu
// @match        *erp.gddc.net.cn/*
// @grant        none
// @license      GPL-3.0 License
// @downloadURL https://update.greasyfork.org/scripts/494637/%E5%B9%BF%E4%B8%9C%E5%BE%B7%E8%AF%9AERP%E4%BC%98%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/494637/%E5%B9%BF%E4%B8%9C%E5%BE%B7%E8%AF%9AERP%E4%BC%98%E5%8C%96.meta.js
// ==/UserScript==
...
(async function() {
    'use strict';
    // lui-id-164
    if (window.location.href.indexOf("/fssc/payment/index.jsp") > -1 ) {
        // 4k显示器新建流程的选择框溢出处理；
        elmGetter.each('div[class="lui-component lui_dialog_main"]', document, dom => {
            dom.style.width = "90%";
            dom.style.left = "5%";
            dom.style.top = "5%";
        });
    }
    if (window.location.href.indexOf("dckj_work_work_main") > -1) {
        // 修改日志展示的overflow愚蠢样式；
        elmGetter.each('input[class="fdLastModifiedTime"]', document, dom => {
            dom.setAttribute("type", "text");
            dom.style.width = "100%";
        });
        elmGetter.each('div[class="fixTableDivHead"]', document, dom => {
            // dom.style.overflow = "unset !important";
