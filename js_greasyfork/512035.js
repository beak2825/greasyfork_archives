// ==UserScript==
// @name Drawaria.dark (Reupload)
// @namespace https://greasyfork.org/en/users/1056265-sashayesin
// @version 1.1
// @description Dark theme for Drawaria, fixed by me :3  |  made from sashayesin!!
// @author speedy :3
// @grant GM_addStyle
...
// @downloadURL https://update.greasyfork.org/scripts/512035/Drawariadark%20%28Reupload%29.user.js
// @updateURL https://update.greasyfork.org/scripts/512035/Drawariadark%20%28Reupload%29.meta.js
// ==/UserScript==
...
if (location.href.startsWith("https://drawaria.online")) {
  ...
  .playerlist-avatar-spawned {
      background: #a8a8a8;
      box-shadow: inset 0 0 10px 0 #a8a8a8;
  }
...
.pgdrawallowbox::after {
    text-color: #c2c2c2;
    }
    .pgdrawallowbox::before {
    text-color: #c2c2c2;
    }
  .playerlist-avatar {
      background: #0000;
...
.playerlist-row.playerlist-pgdrawallow {
  ...
  .playerlist-row.US::after {
  color: #959696;
  }
  .playerlist-row.CA::after {
  color: #959696;
}
.pgdrawallow {
color: #c2c2c2;
...
background-color: #c2c2c2;
  ...
  .playerlist-menu-playername {
  color: #ababac;
  }
   .playerlist-country {
   color: #777777;
  }
  .playerlist-exp-leveltext {
  color: #777777;
  }
  .i.fas.fa-thumbs-up {
  color: #777777;
  ...
  .table-borderless.table-sm.playerlist-statstable {
   color: #777777;
  }

  .popover745429.popover.fade.show.bs-popover-top {
   color: #111111;
}
  .playerlist-exp-bar {
      background: #575757;
  ...
  .btn.btn-light.btn-block.btn-sm.mutebutton {
background-color: #303030;
border-color: #494949;
color: #b6b6b6;
}
  .btn.btn-light.btn-block.btn-sm.hidedrawing {
background-color: #303030;
border-color: #494949;
color: #b6b6b6;
}
  .btn.btn-light.btn-block.btn-sm.reportbutton {
background-color: #303030;
border-color: #494949;
color: #b6b6b6;
}
  .btn.btn-light.btn-block.btn-sm.kickbutton {
background-color: #303030;
border-color: #494949;
color: #b6b6b6;
}
.btn.btn-primary.btn-block.pgdrawbutton {
background-color: #00ae85;
text-color: #acacac;
}
.btn.btn-primary.btn-block.spawnavatarbutton {
background-color: #00ae85;
text-color: #dcdcdc;
}
.popover888949.popover.fade.show.bs-popover-bottom::before {
    position: absolute;
    top: -16px;
    left: -16px;
    right: -16px;
    ...
    background: linear-gradient(to right, black, black, transparent),
                linear-gradient(to left, black, black, transparent),
                linear-gradient(to bottom, black, black, transparent),
                linear-gradient(to top, black, black, transparent);
    background-size: 16px 100%, 16px 100%, 100% 16px, 100% 16px;
    z-index: -1;
}
...
if (location.href.startsWith("https://drawaria.online")) {
  ...
  div.container:nth-child(5) > div:nth-child(1) > h1:nth-child(1) {text-align: center; color: #0000; margin: 0; background: #6f6f6f !important;
  } 
