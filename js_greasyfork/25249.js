...
// @downloadURL https://update.greasyfork.org/scripts/25249/Google%20with%20others.user.js
// @updateURL https://update.greasyfork.org/scripts/25249/Google%20with%20others.meta.js
// ==/UserScript==
...
//result number: 3->8
//Add showOnEnglishQuery option
//Disable all engines except baidu
//Baidu style: top:38px->0px, right:18px->-150px, _result-h2:13pt->12pt
//google result prepare links: li[@class="g"]=>div[@class="g"]
...
(function () {
    ...
    var showOnEnglishQuery = false;

    var hideGoogleLogo = false;
    ...
    Al_xSearch.push(['Bing', 1, "bingResult", 'http://www.bing.com/search?q=--keyword--', '//li[@class="b_algo"][--i--]', 'strong', 'https://cdn2.iconfinder.com/data/icons/social-icons-color/512/bing-128.png']);
...
`);
    ...
    function go() {
        ...
        var glo_style = _xID + ' p, ' + _xID + ' ul {margin: 0; padding:0;}'
            ...
            + _xID + ' div._result, .GoogleSpecial>div{max-height:520px;background:white;overflow:hidden;transition:max-height 0.2s ease 1s;}'
            + _xID + ' ._resultMore{max-height:none!important;}'
            + _xID + ' div._result h3, ' + _xID + ' div._result h2{font-size:12pt!important; border-bottom: 1px solid white; margin-bottom:2px;}'
            ...
            + _xID + ' div._result,.GoogleSpecial>div{margin-bottom:5px;}'
     ...
     // var bd_style = /*Baidu lenk BG img*/'div[id^="baiduResult_"]>div{padding: 5px 0 8px 13px !important;} div[id^="baiduResult_"] h3{margin-left:-8px;line-height:1.3em;} div[id^="baiduResult_"] .favurl{background-position: left center;background-repeat: no-repeat; padding-left: 16px;} div[id^="baiduResult_"] img.c-img, div[id^="baiduResult_"] div.c-row div.c-span6, div[id^="baiduResult_"] div[id^="tools_"].c-tools{display:none!important;}';
        ...
        var wb_style = /*Weibo style*/'div[id^="weiboResult_"] div.weibo_touxiang img{max-height:50px;} div[id^="weiboResult_"] div.weibo_touxiang{float: left; margin: 3px;} div[id^="weiboResult"] div.weibo_right{float: left; width: 80%;} div[id^="weiboResult"] h3.weibo_title{border: none !important;} div[id^="weiboResult"] div.weibofbbox{border: 2px solid #a7cDd6; margin: 10px;} div[id^="weiboResult"] div.weibofbbox>div.weibofbhandel, div[id^="weiboResult"] div.share_box{display: none;} div[id^="weiboResult"] div.weibo_right>div.weibo_handle{float: right;} div[id^="weiboResult"] ul.weibo_imgs>li{display: inline; margin: 3px;} div[id^="weiboResult_"]:hover div.onePicBig{display: block;} div[id^="weiboResult_"] div.onePicSmall{display: block;} div[id^="weiboResult_"] div.onePicBig{display: none;} div[id^="weiboResult_"]:hover div.onePicSmall{display: none;}';
        ...
        for (var a = 0; a < A_xSearch_l; a++) {
            ...
            if (A_xSearch[a][0] == 'ZSWeibo') {
                var keyw = urlEncode(decodeURIComponent(googlekeyword));
                A_xSearch[a][3] = A_xSearch[a][3].replace('--keyword--', keyw);
            } else {
	...
	div#rhs {position:absolute!important; top:38px; margin-left:0px!important; max-width:500px!important; width:auto!important; transition:transform 0.2s ease 0.3s; transform:scale(0.3); transform-origin:0 0; -webkit-transition:transform 0.2s ease 0.3s; -webkit-transform:scale(0.3); -webkit-transform-origin:0 0; z-index: 30000;} \
	...
	._T2 {padding-bottom: 0px!important;}';
        ...
        cssNode.innerHTML = close_style + glo_style + ex_style + tablestyle + li_style + hili_style + googlestyle + mat_style + gs_style + bd_style + bg_style + sg_style + sz_style + yd_style + wb_style + gm_style;
        ...
        */
        ...
        function fixweibo(_resultcontent) {
            ...
            if (!!Imgs[0]) {
                for (_i = 0; _i < Imgs.length; _i++) {
                    var lin = Imgs[_i].getAttribute('src');
                    if ((lin.indexOf('http://') != 0) && (lin.indexOf('https://') != 0)) {
                        if (lin.indexOf('/') == 0) lin = lin.slice(1);
                        Imgs[_i].src = 'http://t.zhongsou.com/' + lin;
                    }
                }
            }
        }
                ...
                for (_i = 0; _i < Imgs.length; _i++) {
                    if (/oimagea\d\.youdao\.com\/image\?/.test(Imgs[_i].src)) {
                        ...
                        if (_sc.length > 0) {
                            ...
                            for (_k = 0; _k < qpairs.length; _k++) {
                                console.log(qpairs[_k]);
        ...
        // "修复"百度Https链接
        function fixbd(_resultcontent) {
            var Links = _resultcontent.getElementsByTagName('a');
            if (!Links[0]) return;
            for (_i = 0; _i < Links.length; _i++) {
                if (Links[_i].href && Links[_i].href.indexOf('https://www.baidu.com/link') == 0)
                    Links[_i].href = Links[_i].href.replace('https://www', 'http://www');
            }
        }
    ...
    function displaybaidu() {
		var area = document.querySelector("#resultPlus");
