// ==UserScript==
// @name         MugenHelperlaborrtious
// @namespace    Joeyvan@Joybrick
// @version      2.7.2
// @description  use at your own risk
// @author       Joeyvan
// @match        *://behind.laborrtious.tk
...
// @run-at       document-end
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/421192/MugenHelperlaborrtious.user.js
// @updateURL https://update.greasyfork.org/scripts/421192/MugenHelperlaborrtious.meta.js
// ==/UserScript==
...
class Majo
{
    SetupUI()
    {
        ...
        else
        {
            ...
            $("#MajoOption").append("<option value='2'>力量之果(4000000 Gold)</option>");
            $("#MajoOption").append("<option value='3'>生命之果(4000000 Gold)</option>");
            $("#MajoOption").append("<option value='4'>智慧之果(4000000 Gold)</option>");
            $("#MajoOption").append("<option value='5'>精神之果(4000000 Gold)</option>");
            $("#MajoOption").append("<option value='6'>幸運之果(4000000 Gold)</option>");
            $("#MajoOption").append("<option value='7'>速度之果(4000000 Gold)</option>");
            $("#MajoOption").append("<option value='8'>熟練之書(10000000 Gold)</option>");
            $("#MajoOption").append("<option value='9'>太陽之鑰(12000000 Gold)</option>");
            $("#MajoOption").append("<option value='10'>希望之果(50000000 Gold)</option>");
            $("#MajoOption").append("<option value='11'>點數補給50點(80000000 Gold)</option>");
        }
