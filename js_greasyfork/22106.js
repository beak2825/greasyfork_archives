...
// @grant none 
// @run-at document-end 
// @downloadURL https://update.greasyfork.org/scripts/22106/Agario%20By%20Deez.user.js
// @updateURL https://update.greasyfork.org/scripts/22106/Agario%20By%20Deez.meta.js
// ==/UserScript==   
...
var Dingus = false; 
var imlost = 25; 
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_e'> Press <b>Shift</b> to split 4x</span></span></center>"; 
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_3'> Press <b>T</b> to split 3x</span></span></center>"; 
...
if (event.keyCode == 84 || event.keyCode == 65) { 
ilikedick(); 
setTimeout(ilikedick, imlost); 
setTimeout(ilikedick, imlost*2); 
} // Doublesplit 
