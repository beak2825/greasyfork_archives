...
// @version         0.2.1
// @grant           none
// @downloadURL https://update.greasyfork.org/scripts/385167/GNZ48%E5%85%AC%E6%BC%94%E7%A5%A8%E8%B4%AD%E4%B9%B0%E6%8F%92%E4%BB%B6%EF%BC%88%E5%A4%87%E4%BB%BD%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/385167/GNZ48%E5%85%AC%E6%BC%94%E7%A5%A8%E8%B4%AD%E4%B9%B0%E6%8F%92%E4%BB%B6%EF%BC%88%E5%A4%87%E4%BB%BD%EF%BC%89.meta.js
// ==/UserScript==
(function () {
	'use strict';
	...
	$("#auto-buy").after('<a href="javascript:void(0);" class="ma_r10" id="check-ticket" style="color:#FFF; padding:5px 10px; background:#59c4ec; display:block; border-radius: 5px; border:1px solid #59c4ec; float:left;">检查状态</a>');
	...
	$(function () {
		...
		$("#auto-buy").click(function () {
			...
			buyTools.getTime(function (data) {
				...
				//计算时间
				//切票等待的毫秒数
				var millisec = new Date(result).getTime() - parseInt(servTime) - delayTime;
				if (millisec <= 0) {
					alert("切票时间都过了，怎么切？");
					return;
				}
