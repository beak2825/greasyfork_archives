// ==UserScript==
// @name        Automatically resolve Duolingo's exercises
// @namespace   MetaverseNova
// @match       https://*.duolingo.com/*
// @grant       none
// @version     6
// @author      MetaverseNova
// @description For any doubts or questions about the script, reach out to me at @metaversenova
// @contributor Everything is listed here https://about.me/metaversenova
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/485002/Automatically%20resolve%20Duolingo%27s%20exercises.user.js
// @updateURL https://update.greasyfork.org/scripts/485002/Automatically%20resolve%20Duolingo%27s%20exercises.meta.js
// ==/UserScript==
...
function addButtons() {
    ...
    if (original === undefined) {
        ...
        solveAllButton.innerText = "Complete the skill";
        ...
        solveCopy.innerHTML = solvingIntervalId ? 'Pause Resolver' : 'Resolve everything';
        solveCopy.disabled = false;
        pauseCopy.innerHTML = 'Resolve';
...
function solving() {
    if (solvingIntervalId) {
        ...
        document.getElementById("solveAllButton").innerText = "Resolve everything";
        isAutoMode = false;
    } else {
        document.getElementById("solveAllButton").innerText = "Pause resolve";
        isAutoMode = true;
