// ==UserScript==
// @name BLACK RUSSIA TECH SCRIPT Для лучших форумников
...
// @downloadURL https://update.greasyfork.org/scripts/495322/BLACK%20RUSSIA%20TECH%20SCRIPT%20%D0%94%D0%BB%D1%8F%20%D0%BB%D1%83%D1%87%D1%88%D0%B8%D1%85%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%BD%D0%B8%D0%BA%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/495322/BLACK%20RUSSIA%20TECH%20SCRIPT%20%D0%94%D0%BB%D1%8F%20%D0%BB%D1%83%D1%87%D1%88%D0%B8%D1%85%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%BD%D0%B8%D0%BA%D0%BE%D0%B2.meta.js
// ==/UserScript==
...
(function () {
	...
	const buttons = [
	{
        ...
        {
	 title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ     ᅠ ᅠᅠ    ᅠ by Tester and Tech ᅠ ᅠᅠ        ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ',
	},

	{
        title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ⠀ᅠ ᅠ ᅠᅠᅠᅠ ⠀ᅠДля специалистов в направлении логированияᅠ ᅠ ᅠ ᅠ ᅠ ',
	...
	},
	{
...

      {
		...
		content:
		'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		"[CENTER] перношу вашу тему в нуждный раздел и в следущий раз будьте внимательнее<u>  </u><br>" +
		'[CENTER]<u></u><br>[CENTER][COLOR=rgb(255, 255, 0)][/COLOR][/CENTER][/FONT][/SIZE]',
		prefix: NO_PREFIX,
		status: true,
	},
        {
   ...
   },
   {
	...
	{ title: 'Служба поддержки',
		content:
		'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		"[CENTER]В срочном порядке обратитесь в службу поддержки  для дальнейшего решения. На сайте через виджет обратной связи или посредством месенджеров: ВКонтакте: vk.com/br_tech, Telegram: t.me/br_techBot<br " +
		'[CENTER][I][COLOR=rgb(255, 0, 0)]Решено.[/COLOR][/I].[/CENTER][/FONT][/SIZE]',
		prefix:WATCHED_PREFIX,
		status: false,
     },
      {
