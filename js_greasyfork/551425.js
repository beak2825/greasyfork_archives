...
// @version     203.003
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/551425/Control%20Panel%20for%20Twitter.user.js
// @updateURL https://update.greasyfork.org/scripts/551425/Control%20Panel%20for%20Twitter.meta.js
// ==/UserScript==
void function() {
...
const locales = {
  ...
  ja: {
    ADD_ANOTHER_TWEET: '别のツイートを追加する',
    ADD_MUTED_WORD: 'ミュートするキーワードを追加',
    GROK_ACTIONS: 'Grokのアクション',
    HOME: 'ホーム',
    LIKES: 'いいね',
    LIVE_ON_X: 'Xでライブ放送する',
    MOST_RELEVANT: '関连性が高い',
    MUTE_THIS_CONVERSATION: 'この会话をミュート',
    POST_ALL: 'すべてポスト',
    POST_UNAVAILABLE: 'このポストは表示できません。',
    PROFILE_SUMMARY: 'プロフィールの要约',
    QUOTE: '引用',
    QUOTES: '引用',
    QUOTE_TWEET: '引用ツイート',
    QUOTE_TWEETS: '引用ツイート',
  ...
  'zh-Hant': {
    ADD_ANOTHER_TWEET: '加入另一则推文',
    ADD_MUTED_WORD: '加入静音文字',
    GROK_ACTIONS: 'Grok 动作',
    HOME: '首页',
    LIKES: '喜欢的内容',
    LIVE_ON_X: 'X 上的直播',
    MOST_RELEVANT: '最相关',
    MUTE_THIS_CONVERSATION: '将此对话静音',
    POST_ALL: '全部发布',
    POST_UNAVAILABLE: '此贴文无法查看。',
    PROFILE_SUMMARY: '个人档案摘要',
    QUOTE: '引用',
    QUOTES: '引用',
    QUOTE_TWEET: '引用推文',
    QUOTE_TWEETS: '引用的推文',
    ...
    SHARED_TWEETS: '分享的推文',
    SHOW: '显示',
    SHOW_MORE_REPLIES: '显示更多回覆',
    SORT_REPLIES_BY: '回覆排序方式',
    TURN_OFF_QUOTE_TWEETS: '关闭引用的推文',
