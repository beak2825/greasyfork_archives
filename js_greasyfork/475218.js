...
// @author       You
// @license MIT
// @match        https://scriptcat.org/script-show-page/162
// @icon         https://www.google.com/s2/favicons?sz=64&domain=scriptcat.org
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/475218/New%20Userscript.user.js
// @updateURL https://update.greasyfork.org/scripts/475218/New%20Userscript.meta.js
// ==/UserScript==
            ...
            this.player.on('timeupdate', () => {
                if (Date.now() - 1000*60*8 >= this.now) {
                    ...
                    this.isAppreciation().then((data) => {
                        ...
                        this.player.play();
                        contextmenu.hide(offsetWidth / 2.5, offsetHeight / 3);
                    });
                }
            });
        }
