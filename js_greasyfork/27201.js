...
// @downloadURL https://update.greasyfork.org/scripts/27201/beemovie.user.js
// @updateURL https://update.greasyfork.org/scripts/27201/beemovie.meta.js
// ==/UserScript==
	...
	ej.lbot=[
			...
			},
		{
			...
			callback: function(data) {
				sock.chat("Tamabot v.1.3", data.user);
				}
			},
		{
            name: "Scriptcheck",
			...
			callback: function(data) {
				sock.chat("Most recent command: @Tamabot chance (of ___)", data.user);
				}
			},
		{
            name: "Scriptcheck",
			...
			},
		{
        ...
        },
          {
            ...
            callback: function(data){
                var msgArray = ["photo gallery: chaika, pepe, jampire, modern, frog"]; 
                if(busy === 0){ busy = 1; var count = -1; for(i=0; i<msgArray.length; i++){ setTimeout(function(){ count = count + 1; sock.chat(msgArray[count]); }, 1*i); } } busy = 0; } 
        },
          {
            name: "Jackers",
...
name: "Sodoku", regex: /kys/i, callback: function(data) { if(data.user === master && king){ sock.chat("", data.user); sock.cmd("leave"); } else{ sock.chat("Fucking kill yourself", data.user); 
			...
			},
		{
			...
			responses: [
				"Tamabot cooks an electronic steak, but it fails."
				]
			},
		{
            name: "Advice",
			...
			},
		{
			...
			responses: [
				"i choose rock", "i choose paper", "i choose scissors", "cbf", 
				]
			},
		{
            name: "Advice",
...
"inferno"]; 
			...
			},
		{
			...
			responses: [
                ...
                "The best user on epicmafia.com is Tamabot",
			...
			},
		{
			...
			responses: [
                ...
                "The winner of the lottery is... $1! Prize: A compliment. Type '@Tamabot compliment' for a compliment.",
                ...
                "The winner of the lottery is... $1! Prize: A insult. Type '@Tamabot insult' to recieve your free insult.",
                ...
                "The winner of the lottery is... $1! Prize: A free book. Type '@Tamabot library' to recieve your free book!",
                ...
                "The winner of the lottery is... $1! Prize:  Your very own command! PM Tamabot '87739571' and specify your command with what you want Tamabot to say in response.",
                "The winner of the lottery is... $1! Prize:  Your very own command! PM Tamabot '92835780' and specify your command with what you want Tamabot to say in response.",
                ...
                "The winner of the lottery is... $1! Prize:  Another lottery ticket to a knock-off lottery called 'lootery', type @Tamabot lootery to access.",
			...
			},
		{
			...
			responses: [
				"songs available: track1, track2"
				]
			},
		{
            name: "Toggle slavemode",
			regex: /^activate protocol 8/i,
			callback: function() {
				ej.settings^=OBEYME;
			...
			},
		{
			...
			callback: function(data) {
				if(data.user===master) {
					sock.chat("You have just been born. Congratulations(?) To continue, type @Tamabot next.", data.user);
					}
				else {
					sock.chat(arand(this.responses));
					}
			...
			},
		{
			...
			callback: function(data) {
				if(data.user===master) {
					sock.chat("You have just died. Sorry for your loss(?) To continue, type @Tamabot 678.", data.user);
					}
				else {
					sock.chat(arand(this.responses));
					}
		...
		{  
            ...
            callback: function(data){
                if(data.user===master) {
                var msgArray = ["After being born, you became a person with choices. This was inevitable, and now you have to make them.", "You are free to make them. Type @Tamabot makechoice"]; 
