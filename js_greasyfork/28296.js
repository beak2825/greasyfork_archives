...
// @downloadURL https://update.greasyfork.org/scripts/28296/Hybrid%20-%20Calls%20-%20Mailing%20Address%202244.user.js
// @updateURL https://update.greasyfork.org/scripts/28296/Hybrid%20-%20Calls%20-%20Mailing%20Address%202244.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Mailing Address")').length) {
    ...
    createButton('DC - Directory', 1,2,2,'Disconnected - Directory');
    createButton('Could Not Complete', 1,2,2,'Disconnected - Could not be completed as dialed');
    createButton('Fax', 2,2,2,'Fax');
    createButton('Generic VM', 0,2,2,'Voicemail has no info'); //3
    createButton('Personal VM', 0,2,2,'Personal voicemail'); //3
    ...
    createButton('Fast Busy', 1,2,2,'Fast busy Signal'); //3
    createButton('No Addy VM', 0,0,2,'Voicemail without address'); //3
    createButton('Hung Up', 0,2,2,'Hung up on me');
    createButton('I Love You So Much Baby', 0,0,0,'Hunter is everything');
