...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487323/Extra%20Attacking%20Info.user.js
// @updateURL https://update.greasyfork.org/scripts/487323/Extra%20Attacking%20Info.meta.js
// ==/UserScript==
...
(function() {
    ...
    function addCheckbox() {
        ...
        if (titleContainer) {
            ...
            span.textContent = 'Toggle big button';
    ...
    function addButton(topCoordination, height) {
        let wrapContainer = document.querySelector('.players___WPQ05');
        let originalButton = document.querySelector('.dialogButtons___nX4Bz .torn-btn.btn___RxE8_.silver');

        if (mobile.matches) {
            wrapContainer = document.querySelector('.playersModelWrap___rZigq');
    ...
    function calculateTimeRemaining() {
        ...
        let remainingTime = "In hospital for ";
