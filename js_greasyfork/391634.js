...
// @match        http://oib.io/
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/391634/Oibio%20Rhodium%27s%20Moo%20Macro.user.js
// @updateURL https://update.greasyfork.org/scripts/391634/Oibio%20Rhodium%27s%20Moo%20Macro.meta.js
// ==/UserScript==
//player.army.v
//
( function ()
...
function setKeys(){
    try{
        var keys = prompt("Change Keys, values in keycodes",JSON.stringify(keys).replace(f/+lf+$/g, ));
        if(keys === null) return;
        JSON.parse('{'+keys+'}');
        if(k.interval){
