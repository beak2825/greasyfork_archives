// ==UserScript==
// @name         MiniCRM Kivonulás Gomb
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  ProSec · Értékesítés > Kivonulási jegyzőkönyv
// @author       Vacsati
// @match        https://r3.minicrm.hu/20941/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/406614/MiniCRM%20Kivonul%C3%A1s%20Gomb.user.js
// @updateURL https://update.greasyfork.org/scripts/406614/MiniCRM%20Kivonul%C3%A1s%20Gomb.meta.js
// ==/UserScript==
...
(function() {
    ...
    function button_Creator() {
        ...
        var uri = window.location.href.split('/');
        var timer, max=20;
        var copy_Url = "https://www.prosec.hu/php/minicrm_kivonulas.php?q=form&pid="+uri[5];
        ...
        function create_copy_button(){
            ...
            var gomb = '<a href="'+copy_Url+'" target="_blank"><button type="button" class="btn btn-default btn-success btn-sm" style="min-width: 80px;;margin-bottom:4px;">Kivonulás</button></a>';
