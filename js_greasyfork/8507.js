...
// @downloadURL https://update.greasyfork.org/scripts/8507/WME%20Validator%20Localization%20for%20Tennessee.user.js
// @updateURL https://update.greasyfork.org/scripts/8507/WME%20Validator%20Localization%20for%20Tennessee.meta.js
// ==/UserScript==
//
window.WME_Validator_United_States = {
  ...
  "128.title": "Invalid city name",
  "128.problem.en": "Some of the segment properties matched against the user-defined regular expression (see Settings→Custom)",
  "128.problem": "The city name is not an incorporated municipality in Tennessee",
  "128.solution.en": "Solve the issue",
  "128.solution": "Check the city and if it not incorporated, move it to the Alt city name.",
  "129.enabled": true,
  "129.params": {
  ...
  "129.solution": "Rename the suffix Such as Road to Rd Please let me know about false positives",
  "130.enabled": true,
  "130.params": {
  ...
  "130.title": "Incorrect Highway",
  "130.problem.en": "The segment matched custom conditions",
  "130.problem": "Tennessee uses TN for state and US for national highway names",
  "130.solution.en": "Solve the issue",
  "130.solution": "Rename the Street or Alt Street or check for space in Interstate name",
  "131.enabled": true,
  "131.params": {
  ...
  "131.solution": "Make sure you are editing in TN and change it or disable script when working in another state",
  "132.enabled": true,
  "132.params": {
  ...
  "132.solution.en": "Check sources and change the street's name",
  ...
  "138.solution": "Change banner abbreviation to ALT, BUS, BYP, CONN, LOOP, SPUR, or TRUCK, check wiki for Scenic",
  "139.enabled": true,
  "139.params": {
