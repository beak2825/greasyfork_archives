...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/543003/%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%BE%D0%B3%D0%BE%20%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/543003/%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%BE%D0%B3%D0%BE%20%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%B0.meta.js
// ==/UserScript==
	...
	const buttons = [
		{
			title: 'ОТВЕТ',
			content:
				'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/X7BFZ3Z7/1000011947.gif[/img][/url]<br>' +
				'[CENTER]<br>' +
		...
		{
			title: 'Ответ (Руководству)',
			content:
				'[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>' +
				'[CENTER]<br>' +
				'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF8800]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
				'[CENTER]<br>' +
				'[CENTER]Ваша жалоба/обжалование передано <u>моему руководству</u> для выноса окончательного вердикта.<br>' +
		...
		},
		{
			...
			color:
				'oswald: 3px; color: #FFFF00; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #FFFF00',
		},
		{
		...
		},
		{
			...
			content:
				...
				'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF8800]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
				'[CENTER]<br>' +
				'[CENTER]Заполните форму:<br>1. Укажите ваш Telegram ID, если ваш игровой аккаунт был привязан к Telegram. Узнать его можно здесь: t.me/getmyid_bot<br>2. Укажите ваш оригинальный ID страницы ВКонтакте, которая привязана к аккаунту<br>3. Укажите почту, которая привязана к аккаунту<br>Ваша тема взята на рассмотрение, ожидайте ответ в ближайшее время<br>Часто рассмотрение темы может занять определенное время.<br>[CENTER][COLOR=rgb(255, 255, 0)]На рассмотрении[/COLOR][/CENTER][/FONT][/SIZE]' +
				'[CENTER]<br>',
			prefix: TECHADM_PREFIX,
			status: true,
		},
		{
			...
			content:
				...
				'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF8800]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
				'[CENTER]<br>' +
				'[CENTER]Написал вам в личные сообщения форума, ответьте мне там. На ответ даётся 24 часа.<br>Ваша тема взята на рассмотрение, ожидайте ответ в ближайшее время<br>Часто рассмотрение темы может занять определенное время.<br>[CENTER][COLOR=rgb(255, 255, 0)]На рассмотрении[/COLOR][/CENTER][/FONT][/SIZE]' +
				'[CENTER]<br>',
			prefix: TECHADM_PREFIX,
			status: true,
		},
		...
		{
			title: 'Ваш аккаунт будет заблокирован',
			content:
				'[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>' +
				'[CENTER]<br>' +
				'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF8800]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
				'[CENTER]<br>' +
				'[CENTER][SIZE=4][FONT=Veranda]После тщательной проверки вашего обращения, доказательств, а также системы логирования выношу вердикт: <br><br>[COLOR=#00FF00][FONT=verdana]Ваш игровой аккаунт будет заблокирован[/COLOR].[/CENTER]<br><br>' +
				'[CENTER][SIZE=4][FONT=Veranda][I][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR][/I].[/FONT][/CENTER]<br><br>' +
				'[CENTER]<br>',
			prefix: CLOSE_PREFIX,
		},
		{
			title: 'Ваш аккаунт будет разблокирован',
			content:
				'[CENTER][IMG width=695px]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/IMG]<br>' +
				'[CENTER]<br>' +
				'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF8800]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
				'[CENTER]<br>' +
				'[CENTER][SIZE=4][FONT=Veranda]После тщательной проверки вашего обращения, доказательств, а также системы логирования выношу вердикт:<br><br>[COLOR=#00FF00]Ваш игровой аккаунт будет разблокирован[/COLOR].[/CENTER]<br><br>' +
				'[CENTER]Передано <u>моему руководству</u> для выноса окончательного вердикта.<br>' +
				'[CENTER]<u>Создавать подобные темы не нужно</u>.<br><br>[CENTER][COLOR=rgb(255, 255, 0)]На рассмотрении[/COLOR][/CENTER][/FONT][/SIZE]' +
				'[CENTER]<br>',
			prefix: PIN_PREFIX,
			status: true,
		},
		...
		},
		{
			...
			content:
				...
				'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF8800]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
				'[CENTER]<br>' +
				'[CENTER]Вы получили наказание которое не относится к технической части, оно относится к [COLOR=rgb(255, 0, 0)]Административной части.[/COLOR]<br> Переношу ваше обращение в необходимый раздел.<br><br>' +
				'[CENTER][I][COLOR=rgb(255, 255, 0)]На рассмотрении[/COLOR][/I].[/CENTER][/FONT][/SIZE]' +
				'[CENTER]<br>',
		...
		},
		{
			...
			content:
				...
				'[CENTER][I]Ожидайте ответа от администрации.[/I].[/CENTER][/FONT][/SIZE]' +
				'[CENTER]<br>',
		...
		},
		{
			...
			content:
				...
				'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF8800]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
				'[CENTER]<br>' +
				'[CENTER]Вы получили наказание от [COLOR=rgb(255, 0, 0)]администратора своего сервера.[/COLOR]<br> Переношу ваше обращение в раздел обжалований наказаний вашего сервера.<br>' +
				'[CENTER][I][COLOR=rgb(255, 255, 0)]На рассмотрении[/COLOR][/I].[/CENTER][/FONT][/SIZE]' +
				'[CENTER]<br>',
		...
		},
		{
			...
			color:
				'oswald: 3px; color: #FFFF00; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
		},
		{
			title: 'Правила раздела',
			content:
	...
	function editThreadData(prefix, pin = false, kumiho = true) {
		...
		if (kumiho === true) {
			...
			if (prefix == TRANSFER_PREFIX3) {
				moveThread(prefix, 433);
			}
			if (prefix == TRANSFER_PREFIX4) {
				moveThread(prefix, 435);
			}
			if (prefix == TRANSFER_PREFIX5) {
				moveThread(prefix, 1530);
			}
			if (prefix == TRANSFER_PREFIX6) {
				moveThread(prefix, 436);
			}
		}
	}
...
const Button52 = buttonConfig(
	'ТР | 09',
	'https://forum.blackrussia.online/forums/Технический-раздел-cherry.408/'
  );
const Button53 = buttonConfig(
	'ЖБ НА ТЕХОВ | 09',
	'https://forum.blackrussia.online/forums/Сервер-№9-cherry.1190/');
const Button54 = buttonConfig(
	'ЖБ НА ИГРОКОВ | 09',
	'https://forum.blackrussia.online/forums/Жалобы-на-игроков.435/');
const Button55 = buttonConfig(
	'ОПС',
	'https://forum.blackrussia.online/threads/Общие-правила-серверов.312571/'
);
