...
// @downloadURL https://update.greasyfork.org/scripts/18182/InfoCompte3.user.js
// @updateURL https://update.greasyfork.org/scripts/18182/InfoCompte3.meta.js
// ==/UserScript==
			...
			{		
				...
				if(FireFox  || Tamper)
				{
					...
					*/
					...
					// **************************************************** end empire ******************************************
					var einhalt=document.getElementById('contentWrapper');//var einhalt=document.getElementById('inhalt');
