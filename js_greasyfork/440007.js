// ==UserScript==
// @name        ZiN's TinyChat Script
// @version     1.0.2
// @description Modified version of CosmosisT's TinyChat script.
// @author      CosmosisT (Modified by ZiN)
...
// @namespace https://greasyfork.org/users/876277
// @downloadURL https://update.greasyfork.org/scripts/440007/ZiN%27s%20TinyChat%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/440007/ZiN%27s%20TinyChat%20Script.meta.js
// ==/UserScript==
...
(function () {
    ...
    var CommandList = {
        gifttoggle: function () {
            CTS.GiftToggle = !CTS.GiftToggle;
            Save("GiftToggle", JSON.stringify(CTS.GiftToggle));
            Alert(GetActiveChat(), "✓ Command Accepted!\n" + ((CTS.GiftToggle) ? "Gifts have been enabled.\n" : "Gifts have been disabled.\n"));
        },
        banmessage: function () {
            if (arguments[0] === "") {
                Alert(
        ...
        share: function () {
            var msg = "ZiN's TinyChat Script:\nInstall...\n1. (Tamper Monkey Link)\nhttps://www.tampermonkey.net/\n2. (ZTS Link)\nhttps://greasyfork.org/en/scripts/440007";
            if (GetActiveChat() !== 0) {
    ...
    function SetLocalValues() {
        if (CTS.StorageSupport) {
            ...
            CTS.GiftToggle = JSON.parse(Load("GiftToggle", JSON.stringify(true)));
            CTS.BanMessage = Load("BanMessage", "🔨 Hammer Time");
        }
    }
