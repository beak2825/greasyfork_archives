...
// @name         Для технических чоколадок (л 61 + ф 32) / K. Stoyn
...
// @downloadURL https://update.greasyfork.org/scripts/529893/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%87%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BE%D0%BA%20%28%D0%BB%2061%20%2B%20%D1%84%2032%29%20%20K%20Stoyn.user.js
// @updateURL https://update.greasyfork.org/scripts/529893/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%87%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BE%D0%BA%20%28%D0%BB%2061%20%2B%20%D1%84%2032%29%20%20K%20Stoyn.meta.js
// ==/UserScript==
  ...
  const TRANSFER_PREFIX_TR49 = 20; // перенос в тех раздел
    const TRANSFER_PREFIX_TR32 = 25; // перенос в тех раздел 32
...
{
	title: 'Перенос в ЖБ на ТЕХОВ',
	color: 'oswald: 3px; color: #FF0000; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER]Вы получили наказание от технического специалиста Вашего сервера.<br>Перемещаю вашу тему в раздел «Жалобы на технических специалистов».<br><br>' +
	"[CENTER]Ожидайте огтвета. <br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER][COLOR=rgb(139, 0, 0)]Ожидание...[/COLOR][/CENTER][/FONT][/SIZE]',
	prefix: TRANSFER_PREFIX_TR32,
	status: open,
},
{
...
},
{
  ...
  $('button#transfer').click(() => editThreadData(TRANSFER_PREFIX_PLAYER49, false));
    $('button#transfer').click(() => editThreadData(TRANSFER_PREFIX_TR32, false));
...
if(prefix == TRANSFER_PREFIX_TR49) {
				moveThread(prefix, 2682);
			}
if(prefix == TRANSFER_PREFIX_TR32) {
				moveThread(prefix, 1459);
			}			
if(prefix == TRANSFER_PREFIX_OBJ49) {
				moveThread(prefix, 2703);
			}
if(prefix == TRANSFER_PREFIX_ADM49) {
				moveThread(prefix, 2700);
			}
if(prefix == TRANSFER_PREFIX_PLAYER49) {
				moveThread(prefix, 2702);
			}
	}
	}
...
const Button50 = buttonConfig("Жб на игроков 61", "https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2702/");
const ButtonTech50 = buttonConfig("Тех раздел 61", "https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-tolyatti.2682/")
const ButtonComp50 = buttonConfig("Жб на техов 61", "https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9661-tolyatti.2681/")
const ButtonTech53 = buttonConfig("Тех раздел 32", "https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-krasnodar.1460/")
