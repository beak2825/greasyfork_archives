...
// @noframes     
// @downloadURL https://update.greasyfork.org/scripts/555759/%C3%96BA%20Arka%20Planda%20Oynatma%20ve%20Otomatik%20%C4%B0lerleme%20%28ULTIMATE%29.user.js
// @updateURL https://update.greasyfork.org/scripts/555759/%C3%96BA%20Arka%20Planda%20Oynatma%20ve%20Otomatik%20%C4%B0lerleme%20%28ULTIMATE%29.meta.js
// ==/UserScript==

(function() {
    'use strict';

    // 1. AGRESİF ÇÖZÜM: Visibility API'yı Devre Dışı Bırakma
    ...
    try {
        ...
        // document.addEventListener'ı geçersiz kıl. visibilitychange olay dinleyicilerini engelle.
    ...
    $(document).ready(function(){
        ...
        // --- Oynatıcıları Bulma ve Pause Fonksiyonunu Devre Dışı Bırakma ---
        let myPlayer;
        ...
        if (myPlayer) {
            console.log("Video.js Player Nesnesi Bulundu. PAUSE FONKSİYONU DEVRE DIŞI BIRAKILIYOR.");
            
            // myPlayer.pause() fonksiyonunu boş bir fonksiyonla geçersiz kıl
            myPlayer.pause = function() {
                // Herhangi bir kod pause() komutu verdiğinde, hiçbir şey yapma!
                console.log("Video.js Durdurma Komutu Başarıyla Engellendi!");
                return this; 
            };
        }
        
        // Temel HTML video elemanını bul (yedek)
        ...
        // Bu kısım orijinal kodunuzdan alınmıştır ve ÖBA arayüzüne bağlıdır.
        setInterval(()=>{
            var sonVideo;
