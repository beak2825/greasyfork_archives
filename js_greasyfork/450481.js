// ==UserScript==
// @name         Forum Script для жб на адм/ОБЖ
// @namespace    https://forum.blackrussia.online
// @version      2.7
// @description  Скрипт для проверки жалоб/обж
// @author       Vladimir_Konyukhov
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @icon         https://icons.iconarchive.com/icons/aha-soft/iron-man/48/Ironman-Mask-3-Old-icon.png
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/450481/Forum%20Script%20%D0%B4%D0%BB%D1%8F%20%D0%B6%D0%B1%20%D0%BD%D0%B0%20%D0%B0%D0%B4%D0%BC%D0%9E%D0%91%D0%96.user.js
// @updateURL https://update.greasyfork.org/scripts/450481/Forum%20Script%20%D0%B4%D0%BB%D1%8F%20%D0%B6%D0%B1%20%D0%BD%D0%B0%20%D0%B0%D0%B4%D0%BC%D0%9E%D0%91%D0%96.meta.js
// ==/UserScript==
...
`[SIZE=4][FONT=georgia][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере «BLUE»[/COLOR][/FONT][/SIZE][/CENTER]`,
 prefix: UNACCEPT_PREFIX,
	...
	},
	{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба/обжалование передана/передано Главному Администратору —  @Vladimir_Konyukhov  <br><br>"+
	...
	},
 {
	...
	},
	{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]Ваше обжалование одобрено и наказание будет полностью снято.<br><br>" +
		`[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере «BLUE»[/COLOR][/FONT][/SIZE][/CENTER]`,
	  prefix: ACCEPT_PREFIX,
	  status: false,
	...
	},
	{
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER]В вашем обжаловании отказано. Срок вашего наказания снижен не будет.<br><br>" +
		`[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере «BLUE»[/COLOR][/FONT][/SIZE][/CENTER]`,
	  prefix: CLOSE_PREFIX,
	  status: false,
    ...
    },
    {
        title: `Special ADMIN`,
        content: ` [CENTER][SIZE=5][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
        "Ваша жалоба/обжалование передана/передано - Специальной Администрации. @Sander_Kligan and @Clarence Crown [/FONT] [COLOR=rgb(251, 160, 38)][FONT=georgia]<br>"+
    ...
    },
{
    ...
    },
    {
    ...
    },
     {
            title: `В тех раздел`,
            content:  ` [CENTER][SIZE=5][FONT=georgia]${greeting}, уважаемый ${user.mention} <br><br>`+
            `[CENTER] Пожалуйста составьте свою жалобу в "Техническом Разделе сервера"[URL='https://forum.blackrussia.online/index.php?forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-blue.228/'][SIZE=4][FONT=georgia](кликабельно)[/URL]<br><br>`+
        ...
        },
 {
            ...
            `[CENTER] Отказано,закрыто.<br><br>`+
         `[CENTER][SIZE=4][FONT=georgia]С уважением, Konstantin_Kingston<br>`+
            `[COLOR=blue]Вконтакте: [/COLOR] [/FONT][/SIZE][URL='https://vk.com/k.kingston007'][SIZE=4][FONT=georgia]@k.kingston007(кликабельно)[/FONT][/SIZE][/URL][/CENTER]<br>`+
        `[SIZE=4][FONT=georgia][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере «BLUE»[/COLOR][/FONT][/SIZE][/CENTER]`,
            prefix: WATCHED_PREFIX,
            status:false,
},
