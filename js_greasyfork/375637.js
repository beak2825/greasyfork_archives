// ==UserScript==
// @name         HIT Forker Auto
// @version      1.0.6.1
// @description  Monitors mturk.com for HITs
// @author       ThisPoorGuy
// @icon         http://nopurpose.org/stuff/avatars/Lj21396.gif
// @include      https://worker.mturk.com/?finder_betaa
// @include      https://worker.mturk.com/?hit_forkera
// @grant        GM_log
...
// @downloadURL https://update.greasyfork.org/scripts/375637/HIT%20Forker%20Auto.user.js
// @updateURL https://update.greasyfork.org/scripts/375637/HIT%20Forker%20Auto.meta.js
// ==/UserScript==
...
$('head').html(
  ...
  '<audio id="audio_1"><source src="https://www.soundjay.com/button/sounds/button-1.mp3" type="audio/mpeg"></audio>' +
  '<audio id="audio_2"><source src="https://www.soundjay.com/button/sounds/button-3.mp3" type="audio/mpeg"></audio>' +
  '<audio id="audio_3"><source src="https://www.soundjay.com/button/sounds/button-4.mp3" type="audio/mpeg"></audio>' +
  '<audio id="audio_4"><source src="https://www.soundjay.com/button/sounds/button-5.mp3" type="audio/mpeg"></audio>' +
  '<audio id="audio_beep"><source src="https://www.soundjay.com/button/sounds/beep-21.mp3" type="audio/mpeg"></audio>' +
  '<audio id="audio_beepbeep"><source src="https://www.soundjay.com/button/sounds/beep-24.mp3" type="audio/mpeg"></audio>' +
  '<audio id="audio_click"><source src="https://www.soundjay.com/button/sounds/button-20.mp3" type="audio/mpeg"></audio>' +
...
$('body').html(
  ...
  '<input type="checkbox" id="auto_accept" style="margin-left: 5px;">Auto</input>' +
  ...
  for (var i = 0; i < hits.length; i ++) {
    ...
    if (!hitlog[key]) {
      hitlog[key] = {
        ...
        PandaCrazy.addJob( "term", true, {hitTitle: title,requesterName: req_name,requesterId: req_id,hitValue: "value" });
