...
// @version     1.7.1
// @downloadURL https://update.greasyfork.org/scripts/2306/HUKD%20Toolkit.user.js
// @updateURL https://update.greasyfork.org/scripts/2306/HUKD%20Toolkit.meta.js
// ==/UserScript==
...
var dealPattern = /^https?:\/\/hukd\.mydealz\.de.+\/.+-\d+(?:\?page=\d+)?(?:#post\d+)?$|^https?:\/\/hukd\.mydealz\.de.+\/.+-\d+\?page=\d+&jc=true#post$/m;
...
if(!$(".visitor-name")[0]) {
	try { 
		...
		if (urlPathCheck(dealPattern)) {quoteEvent(); replaceQuoteButtons(); removeDealDescription(); commentLink(); pnLink();}
...
function siteNav()
{
    ...
    $(".js-menu-toggle")[0].textContent = '';
    $(".js-menu-toggle")[0].className = 'siteNav-lnk js-menu-toggle';

    myTab, $(".siteNav-mn-it")[0].style.display = 'none';
    myTab, $(".siteNav-mn-it")[1].style.display = 'none';
    myTab, $(".siteNav-mn-it")[2].style.display = 'none';
    
    var myTab = createElement('li', null, 'siteNav-mn-in', null);
    var aLink = createElement('a', null, 'siteNav-mn-lnk', 'myTab');
    aLink.href = 'http://hukd.mydealz.de/custom';
    myTab.appendChild(aLink);
	$(".siteNav-mn-in")[0].insertBefore(myTab, $(".siteNav-mn-it")[0]);
    
    var gSammler = createElement('li', null, 'siteNav-mn-in', null);
    var aLink = createElement('a', null, 'siteNav-mn-lnk', 'Gutscheinsammler');
    aLink.href = 'http://www.gutscheinsammler.de';
    aLink.target = '_blank';
    gSammler.appendChild(aLink);
	$(".siteNav-mn-in")[0].insertBefore(gSammler, $(".siteNav-mn-it")[6]);
    
    var abosGratis = createElement('li', null, 'siteNav-mn-in', null);
    var aLink = createElement('a', null, 'siteNav-mn-lnk', 'Abos gratis');
    aLink.href = 'https://www.abosgratis.de';
    aLink.target = '_blank';
    abosGratis.appendChild(aLink);
	$(".siteNav-mn-in")[0].insertBefore(abosGratis, $(".siteNav-mn-it")[6]);
    
    var uPiraten = createElement('li', null, 'siteNav-mn-in', null);
    var aLink = createElement('a', null, 'siteNav-mn-lnk', 'Urlaubspiraten');
    aLink.href = 'https://www.urlaubspiraten.de';
    aLink.target = '_blank';
    uPiraten.appendChild(aLink);
	$(".siteNav-mn-in")[0].insertBefore(uPiraten, $(".siteNav-mn-it")[6]);   
    
    /*rss*/
    try {
       $(".siteNav-it--rss")[0].style.display = 'none';
    } catch (e){}
...
function removeDealDescription()
{
    if ((retrievePageNumber() != "Seite 1") && (retrievePageNumber() != "1" ))
    {
        document.getElementsByClassName('thread-sect')[0].textContent = '';
    }
}
