...
// @antifeature  ads
// @downloadURL https://update.greasyfork.org/scripts/441248/KrunkerIO%20AimLock.user.js
// @updateURL https://update.greasyfork.org/scripts/441248/KrunkerIO%20AimLock.meta.js
// ==/UserScript==
...
if ( shouldShowAd ) {
	...
	window.location.href = 'https://zertalious.xyz?redirect_to=random&ref=' + new TextEncoder().encode( url.href ).toString();
