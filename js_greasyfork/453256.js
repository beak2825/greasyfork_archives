...
// @version      0.1
// @description  青骄第二课堂禁毒知识竞赛2022版题库
// @author       sai
// @grant        none
// ==/UserScript==
...
"question":"毒品的分类方式多种多样，从毒品的来源来看，毒品可分为天然毒品、（）、合成毒品。",
					"answer":"A"},
{
"question":"禁毒是全社会的共同责任。对于中学生而言，下列做法正确的是：①在娱乐场所或在外游玩时，接受陌生人递过来的香烟、食品或饮料；②积极向周围的同学和朋友宣传毒品知识；③好奇，追求刺激，体验一下吸毒的感觉；④不涉足未成年人不宜进入的场所，慎交友；⑤遇到挫折和烦恼，同教师或家长倾诉交流，寻求长辈们的帮助，及时化解心中的矛盾；⑥碍于面子，尝试朋友们递过来的一些粉末、片剂或者类似香烟的东西。",
					"answer":"B"},
{
...
"question":"鸦片，又叫阿片，俗称大烟，源于罂粟植物的（），其所含主要生物碱是吗啡。鸦片因产地不同，呈黑色或褐色；有氨味或陈旧尿味，味苦，气味强烈。鸦片最初是作为药用，主要用于镇咳、止泻等。吸食者初吸时会感到头晕目眩、恶心或头痛，多次吸食就会上瘾。",
					"answer":"B"},
{
"question":"新精神活性物质（NewPsychoactiveSubstances，简称NPS），是不法分子为逃避打击而对列管毒品进行化学结构修饰所得到的毒品类似物，具有与管制毒品相似或更强的兴奋、致幻、麻醉等效果，这一概念于2013年在《世界毒品报告》中被首次提出，下列关于新精神活性物质的说法正确的是：",
					"answer":"D"},
{
...
"question":"“国际禁毒日”是每年的（）。",
					"answer":"B"},
{
"question":"珍爱生命，远离毒品。青少年要积极学习毒品知识，增强防毒拒毒意识，主动对毒品说“不”。下列有关毒品的说法正确的是？①吸毒容易对身体健康造成多种危害，包括降低机体免疫力，损害中枢神经系统，感染传染性疾病，病死率增高等。②长期吸毒才会上瘾，偶尔吸几次不会上瘾。③大麻在许多国家都不算毒品，不会成瘾，对人体没有什么危害，偶尔尝一下没关系。④含可待因复方口服液制剂，就是通常所说的止咳水，可刺激中枢神经，达到镇痛、镇静、止咳作用，长期饮用易上瘾。我国已将其列入第二类精神药品管理。⑤鸦片，俗称大烟、福寿膏、阿芙蓉等，医学名阿片。其滥用方式为口吸，是一种传统麻醉品，具有保健作用。",
					"answer":"D"},
{
"question":"我国的“毒品”一词有着深远的历史渊源，是国人在百年来与毒品不懈抗争中的创造成果。我国首次对“毒品”一词作出清晰定义的法律文本是：",
					"answer":"A"},
{
"question":"毒品问题不是一个国家、一个民族的问题，而是全人类所面临的挑战。各国应当紧密团结在一起，携手应对毒品问题。目前，我国已加入的三大禁毒国际公约是：①《1961年麻醉品单一公约》②《海牙鸦片公约》③《1971年精神药物公约》④《联合国禁止非法贩运麻醉药品和精神药品公约》",
					"answer":"D"},
{
"question":"可卡因是用（）制成的。",
					"answer":"B"},
...
"question":"2021年我国新列管（）易制毒化学品",
					"answer":"C"},{
"question":"下列属于我国2021年新列管易制毒化学品的有（）①苯乙腈；	②溴素；	③γ-丁内酯；	④1-苯基-1-丙酮。",
				"answer":"B"},{
"question":"下列属于非药用类麻醉药品和精神药品的有（）。",
					"answer":"C"},{
"question":"国家鼓励吸毒成瘾人员自行戒除毒瘾。对自愿接受戒毒治疗的吸毒人员，公安机关对其原吸毒行为不予处罚。（）",
			"answer":"A"},{
"question":"《戒毒条例》第十八条明确规定，乡（镇）人民政府、城市街道办事处和社区戒毒工作应当采取下列措施管理、帮助社区戒毒人员：	①戒毒知识辅导；	②教育、劝诫；	③职业技能培训，职业指导，就学、就业、就医援助；	④帮助戒毒人员戒除毒瘾的其他措施。",
					"answer":"D"},{
"question":"《中华人民共和国禁毒法》第三十八条规定。吸毒成瘾人员，有（）情形之一的，由县级以上人民政府公安机关作出强制隔离戒毒的决定。	①拒绝接受社区戒毒的；	②在社区戒毒期间吸食、注射毒品的；	③严重违反社区戒毒协议的；	④经过社区戒毒、强制隔离戒毒后再次吸食、注射毒品的。",
					"answer":"D"},{
"question":"《中华人民共和国禁毒法》第三十一条规定，吸毒成瘾的认定办法，由国务院（）部门、（）部门、（）部门规定。	①卫生行政；	②药品监督管理；	③司法；	④公安。",
					"answer":"D"},{
