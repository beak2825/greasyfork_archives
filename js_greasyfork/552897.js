...
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/552897/MBSS%20FAST%20TAG%20WITH%20BOXES.user.js
// @updateURL https://update.greasyfork.org/scripts/552897/MBSS%20FAST%20TAG%20WITH%20BOXES.meta.js
// ==/UserScript==
...
(function() {
  ...
  const tags = {
    ...
    paysSystems: ["PayGO"],
    matchingPay: [
      "matching cashout p2p",
      "matching cashout sbp",
      "matching deposit p2p",
      "matching deposit sbp",
      "matching error",
      "matching cancel"],
    cashout: [
      "cashout",
    ...
    bonuses: [
      "loyalty for activity", "freespin for activity", "Bonus SNS",
  ...
  const categoriesBoxes = {
    ...
    matchingPay: createBoxForTags("yellow", "Метчинг"),
