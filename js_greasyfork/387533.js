...
// @downloadURL https://update.greasyfork.org/scripts/387533/Tweetdeck%3A%20Retro%20Dark%20Mode.user.js
// @updateURL https://update.greasyfork.org/scripts/387533/Tweetdeck%3A%20Retro%20Dark%20Mode.meta.js
// ==/UserScript==

//cross reference Documents/TEXT/BetterTweetdeck_Dark_Theme_Code if you get stuck
...
addGlobalStyle('html.dark .attach-compose-buttons .tweet-button {background-color:#485865 !important;}');
addGlobalStyle('html.dark .bg-color-twitter-midnight-dark-gray {background-color:#222426 !important;}');
addGlobalStyle('html.dark .accounts-drawer {background:#222426 !important;}');
addGlobalStyle('html.dark .account-remove-check {background:#222426 !important;}');
addGlobalStyle('html.dark .column {background-color:#222426 !important;}');
addGlobalStyle('html.dark .column-panel {background:#222426 !important;}');
addGlobalStyle('html.dark .column-nav:after {background-color:#222426;border-color:#14171a !important;}');
addGlobalStyle('html.dark .column-background-fill {background-color:#222426 !important;}');
addGlobalStyle('html.dark .location-form .typeahead-dropdown {background:#222426 !important;}');
addGlobalStyle('html.dark .column-type-scheduled {background-color:#222426 !important;}');
addGlobalStyle('html.dark .column-header, html.dark .column-header-temp {background-color:#292f33 !important;}');
addGlobalStyle('html.dark .column-message {background-color:#222426 !important;}');
addGlobalStyle('html.dark .edit-conversation-name {background-color:#222426 !important;}');
addGlobalStyle('html.dark .column-options {background-color:#292f33 !important;}');
addGlobalStyle('html.dark .column-options .button-tray {background-color:#292f33 !important;}');
addGlobalStyle('html.dark .stream-item {background-color:#222426 !important;}');
addGlobalStyle('html.dark .tweet-detail-wrapper {background:#222426 !important;}');
addGlobalStyle('html.dark .conversation-event {background-color:#222426 !important;}');
addGlobalStyle('html.dark .add-participant {background-color:#222426 !important;}');
addGlobalStyle('html.dark .accordion-divider-t {border-top:1px solid #222426 !important;}');
addGlobalStyle('html.dark .facet-type {position:relative;border-bottom:1px solid #222426} !important;}');
addGlobalStyle('html.dark .facet-type-thumb-size {border-top:1px solid #222426 !important;}');
addGlobalStyle('html.dark .facet-type.is-active {background-color:#222426 !important;}');
addGlobalStyle('html.dark .numbered-badge-onheader{border:2px solid #222426 !important;}');
addGlobalStyle('html.dark .dataminr{background-color:#222426 !important;}');
addGlobalStyle('html.dark .mdl{background-color:#222426 !important;}');
addGlobalStyle('html.dark .detail-view-inline{background-color:#222426 !important;}');
addGlobalStyle('html.dark .embed-modal .mdl-content{height:auto;border:none;background:#222426 !important;}');
addGlobalStyle('html.dark .keyboard-shortcut-list-modal .mdl-content{background:#222426 !important;}');
addGlobalStyle('html.dark .prf-meta{background:#222426 !important;}');
addGlobalStyle('html.dark .scroll-conversation{background:#181a1c !important;}');
addGlobalStyle('html.dark .dark-border{border:1px solid #444448 !important;}');
addGlobalStyle('html.dark .bg-color-twitter-midnight-darkest-gray {background-color:#181a1c !important;}');
...
//when likes are turned back to favs turn the text yellow instead of red
