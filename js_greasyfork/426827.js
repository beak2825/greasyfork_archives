...
// @downloadURL https://update.greasyfork.org/scripts/426827/Lot%20Tracker.user.js
// @updateURL https://update.greasyfork.org/scripts/426827/Lot%20Tracker.meta.js
// ==/UserScript==
...
async function main()
{
    var lots = document.querySelectorAll('tr[class="wb"]');
    var arts = loadArts();
    ...
    for(let i = 0 ; i < lots.length ; i++)
    {
        ...
        var artName = lot.querySelector('img').getAttribute('title').split('\n')[0].trim() ;
        ...
        getLotDetails(marketLink, lotID, durability).then(function (lotDetails)
        {
            ...
            lots[i].querySelector('tr').childNodes[1].innerHTML += '<br> Lowest Price: ' + lowestPrice ;
            lots[i].childNodes[1].innerHTML = '<a href="' + marketLink + '"><code style="color=green">#' + myLotNumber + '</code></a>&nbsp' + lots[i].childNodes[1].innerHTML;
        }
        ) ;
    }
