// ==UserScript==
// @name         Torn.com Enhanced Chat Buttons V2.1
// @namespace    http://tampermonkey.net/
// @version      2.63
// @description  Add customizable buttons to your chats in Torn to make your life easier
// @author       Created by Callz [2188704], updated by Weav3r [1853324], Lumberjacks Ready by WinterValor [3945658]
// @match        https://www.torn.com/*
// @grant        GM_setClipboard
// @downloadURL https://update.greasyfork.org/scripts/558362/Torncom%20Enhanced%20Chat%20Buttons%20V21.user.js
// @updateURL https://update.greasyfork.org/scripts/558362/Torncom%20Enhanced%20Chat%20Buttons%20V21.meta.js
// ==/UserScript==
...
(function() {
    ...
    const conditions = {
        ElimChat: chatBox => {
            // New chat version
            if (chatBox.id === 'elimination-32') return true;
            // Old chat version
            const oldTitle = chatBox.querySelector('.chat-box-header__name___jIjjM');
            return oldTitle && oldTitle.textContent === 'Lumberjacks';
        },
        TradeChat: chatBox => {
            // New chat version
            ...
            <div id="config-edit-tab" class="tab-content">
                <div>
                    ...
                    <select id="button-condition">
                        <option value="ElimChat">Elim Chat</option>
