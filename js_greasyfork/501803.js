// ==UserScript==
// @name             IMDb Torrent Search button (TGx TorrentGalaxy & EXT.TO)
// @description      Adds a torrent search button above the movie title on the IMDb page
...
// @grant            none
// @license          MIT
// @downloadURL https://update.greasyfork.org/scripts/501803/IMDb%20Torrent%20Search%20button%20%28TGx%20TorrentGalaxy%20%20EXTTO%29.user.js
// @updateURL https://update.greasyfork.org/scripts/501803/IMDb%20Torrent%20Search%20button%20%28TGx%20TorrentGalaxy%20%20EXTTO%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function waitForTitleAndAddButtons() {
        ...
        if (titleElement) {
            ...
            const extButton = createButton('ExtSearchButton', 'EXT Search', function() {
            ...
            buttonContainer.appendChild(extButton);
