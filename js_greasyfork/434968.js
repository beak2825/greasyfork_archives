// ==UserScript==
// @name         Freebitco.in - AutoRoll for HF
// @description  AutoRoll for HF - Freebitco.in
// @author       pepperoniss1
...
// @namespace    https://greasyfork.org/pl/users/828742-pepperoniss1
// @license      GPL
// @supportURL   https://www.hyipforum.pl/
// @homepage     https://www.hyipforum.pl/
// @homepageURL
// @copyright    2021, pepperoniss1
...
// @history      0.99.HF First version
 
// @downloadURL https://update.greasyfork.org/scripts/434968/Freebitcoin%20-%20AutoRoll%20for%20HF.user.js
// @updateURL https://update.greasyfork.org/scripts/434968/Freebitcoin%20-%20AutoRoll%20for%20HF.meta.js
// ==/UserScript==
...
var MULTIPLY_AT_NIGHT = false;   // Play multiply in nightiime
var HOURS_BETWEEN_MULTIPLY = 36; // How many hours to wait before to play multiply
var ROLL_P = 24;                // How many time to play multiply, AFTER roll AND AFTER HOURS passed; Values: 0-100
...
(function() {
    ...
    //XXX var referURL = "https://api.bitso.me/ser.php"; //new veneno website URL
...
function panelInit () {
    ...
    script_output_css += ".script-output h1 {color: lime; font-size:2.8em; font-weight:bold; }"
    script_output_css += ".script-output h4 {color: lime; font-size:1.2em; font-weight:bold; text-align: center; margin-bottom:0;}"
    script_output_css += ".cards-wrapper { display: grid; grid-gap: 1.5rem; grid-template-columns: 1fr 1fr; padding: 1.5rem 0rem; margin: 0 auto; width: auto }";
    ...
    script_output_css += ".bottom-card {color: white; position: relative; justify-content: center; margin: 0 -1em; padding:0.8em 1em; display: flex; background-color:#1d1d1d; text-decoration: none; text-align: left;}";
    ...
    if (referrer.length > 0) {
        script_output_33 += '<h1 class="mb0">AutoRoll for HF ver. '+script_version+'</h1>';
    } else {
        script_output_33 += '<h1 class="mb0">AutoRoll for HF ver. '+script_version+'</h1>';
    }
    ...
    //XXX script_output_33 += '<div class="card-button '+Boolean(ROLL)+'"><span class="card-button-top">ROLL</span><span class="card-button-bottom bold">'+Boolean(ROLL)+'</span></div> ';
    //XXX script_output_33 += '<div class="card-button '+Boolean(MULTIPLY)+'"><span class="card-button-top">MULTIPLY</span><span class="card-button-bottom bold">'+Boolean(MULTIPLY)+'</span></div> ';
    //XXX script_output_33 += '<div class="card-button '+Boolean(REWARDS)+'"><span class="card-button-top">BONUS RPs</span><span class="card-button-bottom bold">'+Boolean(REWARDS)+'</span></div> ';
    //XXX script_output_33 += '<div class="card-button '+Boolean(BONUS1000)+'"><span class="card-button-top">BONUS 1000</span><span class="card-button-bottom bold">'+Boolean(BONUS1000)+'</span></div> ';
    //XXX script_output_33 += '<div class="card-button '+Boolean(LOTTERY)+'"><span class="card-button-top">LOTTERY</span><span class="card-button-bottom bold">'+Boolean(LOTTERY)+'</span></div> ';
    ...
    script_output_33 += '<div class="single-column">';
    //XXX script_output_33 += '   <h4 class="coral">Spent</h4> ';
    script_output_33 += '   <div class="single-column">';
    //XXX script_output_33 += '       <span>RP Bonus: <span class="coral bold">'+tot_rp_spent_rewards+'</span></span> ';
    //XXX script_output_33 += '       <span>RP Captcha: <span class="coral bold">'+tot_rp_spent_captcha+'</span></span> ';
    //XXX script_output_33 += '       <span>Btc Lottery: <span class="coral bold">'+tot_lottery_tickets+'</span></span>';
    //script_output_33 += '       <span>&nbsp</span>';
    script_output_33 += '   </div>';
    script_output_33 += '</div>'; // column
    script_output_33 += '<div class="single-column">';
    //XXX script_output_33 += '   <h4>Multiply</h4> ';
    script_output_33 += '   <div class="single-column">';
    //XXX script_output_33 += '      <span>Balance: <span class="lime bold">'+tot_multiply_balance+'</span></span> ';
    //XXX script_output_33 += '       <span>Bets: <span class="lime bold">'+tot_multiply_bets+'</span></span> ';
    //XXX script_output_33 += '       <span>Sessions: <span class="lime bold">'+tot_multiply_games+'</span></span> ';
    script_output_33 += '   </div>';
    script_output_33 += '</div>'; // column
    script_output_33 += '</div>'; // close left second line
    script_output_33 += '<div class="ta-c cards-wrapper monospace"  style="width: 100%;">';
    script_output_33 += '   <span>1 BTC: <span id="usdxbtc" class="lime bold"></span> usd</span>';
    script_output_33 += '   <span>1 USD: <span id="satxusd" class="lime bold"></span> sat</span>';
    ...
    //XXX script_output_33 += '  <span>Donations are welcome</span> <span>BTC addr: 16X5fYAjFFo7zLEVY4T4ZzXcqrUekPbhjh </span>';
    //XXX script_output_33 += '  <span>Donations are welcome</span> <span>ETH addr: 0x4802aff120ece902594d408ade8c2a66dcd1ccce </span>';
    //XXX script_output_33 += '  <span>Donations are welcome</span> <span>USTD (TRX20) addr: THRcejS4XXMDmhfQnvu56zXzruo5RSoAVW </span>';
    //XXX script_output_33 += '  <span>Donations are welcome</span> <span>EOS addr: pepperoniss1 </span>';
    script_output_33 += '  <a href="http://tpmr.com/i/79921" target="_blank"> Freebitco.in registration </a>';
    script_output_33 += ' </div>';
 
    script_output_33 += ' <div class="single-column br-grey">';
    //XXX script_output_33 += '  <a href="https://bit.ly/2JsP12I" target="_blank">Config HowTo</a>';
    //XXX script_output_33 += '  <a href="https://greasyfork.org/en/scripts/404112-freebitco-in-auto-roll-no-captcha-status-console-advanced-human-behavior-all-bonuses/feedback" target="_blank"> Rate</a>';
    script_output_33 += '  <a href="http://tpmr.com/i/79921" target="_blank"> Freebitco.in registration </a>';
    script_output_33 += ' </div>';
 
    script_output_33 += ' <div class="single-column ta-r" >';
    script_output_33 += '  <span><span class="emoji">© </span>pepperoniss1</span><span>2021</span>';
    script_output_33 += ' </div>';
...
function Roll() {
    ...
    if ($('#free_play_form_button').is(':visible') && ! $('#play_without_captchas_button').is(':visible')) {
        ...
        if ( isNight() && Boolean(NIGHT_MODE) ) {
            ...
            if (r <= 5)        rand=random(2000,65000);
            else if (r <= 25)   rand=random(1500,35000);
            else               rand=random(500,12000);
            rolling_mode="Day";
        }
