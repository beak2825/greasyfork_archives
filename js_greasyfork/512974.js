...
// @license             GLPv3
// @downloadURL https://update.greasyfork.org/scripts/512974/115Rename.user.js
// @updateURL https://update.greasyfork.org/scripts/512974/115Rename.meta.js
// ==/UserScript==
...
(function () {
     ...
     * 添加按钮的定时任务
     */
    let interval = setInterval(buttonInterval, 200);

    // javbus
    let javbusBase = "https://www.javsee.lol/";
    // 有码
    ...
    function send_115(id, name, fh) {
        ...
        let files_new_name=`files_new_name[${id}]`;
        postData[files_new_name]=file_name;
