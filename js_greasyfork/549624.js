...
// @grant        unsafeWindow
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/549624/%5Bbuyi%5D%20%E6%8A%96%E9%9F%B3%E5%B7%A5%E5%85%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/549624/%5Bbuyi%5D%20%E6%8A%96%E9%9F%B3%E5%B7%A5%E5%85%B7.meta.js
// ==/UserScript==
    ...
    function main() {
        ...
        function addCopyTitleIcon() {
            ...
            for (let i = 0; i < titleNodes.length; i++) {
                ...
                // 如果已添加，则不重复添加
                if (titleWrapNode.querySelector('.copy-title-icon')) {
                    // log.log("已添加复制按钮")
                    continue
                }
                ...
                span1.style.right = "-30px"
                span1.style.bottom = "2px"
                span1.style.zIndex = "999999"
                copyIcon.className = "copy-title-icon"
                ...
                // 判断展开按钮是否显示
                // let zhankaiIsShow = titleWrapNode.querySelector('button').parentNode.style.display != ""
                
                span2.appendChild(copyIcon)
                span1.appendChild(span2)
                titleWrapNode.appendChild(span1)
            }
        }
        setInterval(() => {
            addCopyTitleIcon()
