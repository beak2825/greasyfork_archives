// ==UserScript==
// @name         Обжалование наказаний
// @namespace    https://forum.blackrussia.online
// @version      1.1.2
// @author      Sabina_Croups
// @description  -
...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/536759/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5%20%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.user.js
// @updateURL https://update.greasyfork.org/scripts/536759/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5%20%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.meta.js
// ==/UserScript==
...
const START_DECOR = `<div style="text-align: center"><span style="font-family: 'Verdana'; font-size: 13px">`;
...
const buttons = [
    {
	  ...
	  },
	  {
	    ...
	    content:
	  	  `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
	  	  "Ваше обжалование передано заместителю главного администратора на рассмотрение.<br><br>" +
	  	  `Ожидайте ответа.${END_DECOR}`,
	    prefix: WAIT_PREFIX,
	    status: true,
	  },
	  ...
	  },
    {
	    ...
	    content:
	  	  `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
	  	  "В вашем обжаловании не предоставлено достаточного объёма доказательств нарушений.<br><br>" +
	  	  `Закрыто.${END_DECOR}`,
	    prefix: CLOSED_PREFIX,
	    status: false,
	  },
	  ...
	  },
    {
	    ...
	    content:
	  	  `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
	  	  "Пересоздайте тему в разделе жалоб на технических специалистов → *[URL='https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9647-krasnoyarsk.2093/']Кликабельно[/URL]*<br><br>" +
        `Закрыто.${END_DECOR}`,
	    prefix: CLOSED_PREFIX,
	    status: false,
	  },
	  ...
	  },
    {
	    ...
	    content:
	  	  `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
	  	  "Разблокировка игрового аккаунта будет возможна только в случае возврата полной суммы причиненного ущерба, либо непосредственно самого имущества, которое было украдено (по решению обманутой стороны).<br><br>" +
	  	  `Закрыто.${END_DECOR}`,
	    prefix: CLOSED_PREFIX,
	    status: false,
	  },
    {
	    ...
	    content:
	  	  `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
	  	  "Аккаунт будет разблокирован.<br>" +
          "Приятной игры и времяпровождения.<br><br>" +
	  	  `Закрыто.${END_DECOR}`,
	    prefix: CLOSED_PREFIX,
	    status: false,
	  },
