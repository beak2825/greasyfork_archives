...
(function (vue, ElementPlus) {
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-38ef7174"), n = n(), vue.popScopeId(), n);
  const _hoisted_1 = { class: "fixed" };
  const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("p", null, "输入关键词用 | 隔开:", -1));
  ...
  const _sfc_main = {
    ...
    setup(__props) {
      ...
      const form = vue.reactive(getItem("_default_form", {
        onlyGreet: false,
        keyword: "",
        rule: "同时存在",
        age: [18, 33],
        exclude: ["不考虑", "月内活跃", "月活跃"]
      }));
      ...
      const handleClick = async () => {
        ...
        loading.value = true;
        const iframe = $("iframe[name=recommendFrame]").contents();
        const button = iframe.find(".btn.btn-greet");
        const keywordArr = form.keyword.split("|");
        const excludeArr = Object.values(form.exclude);
        for (let buttonElement of button) {
          buttonElement = $(buttonElement);
          let greet = false;
          if (buttonElement.hasClass("overdue-tip")) {
            console.log("沟通过");
            greet = true;
          } else if (!form.onlyGreet) {
            let cardEl = buttonElement.parent().parent().parent().parent().parent().parent();
            let text = cardEl.html();
            if (!text || !text.indexOf)
              continue;
            let age = text.match(/(\d+)岁/);
            age = age == null ? void 0 : age[1];
            if (age && !(age >= form.age[0] && age <= form.age[1])) {
              console.log("年龄不符合");
              continue;
            }
            if (excludeArr.length && checkKeyword(text, excludeArr)) {
              console.log("排除");
              continue;
            }
            if (checkKeyword(text, keywordArr, form.rule === "同时存在")) {
              console.log("匹配");
              greet = true;
            }
          }
          if (greet) {
            console.log("buttonElement", buttonElement[0]);
            iframe.scrollTop(buttonElement.offset().top - 200);
            buttonElement.click();
            await sleep(2e3);
          }
        }
        loading.value = false;
        setItem("_default_form", form);
        console.log("结束");
      };
      function checkKeyword(str, keywordArr, matchAll = false) {
        var matched = true;
        for (var i = 0; i < keywordArr.length; i++) {
          var keyword = keywordArr[i].trim();
          if (matchAll) {
          ...
          vue.createVNode(_component_el_dialog, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_el_form, {
                model: form,
                onSubmit: vue.withModifiers(handleClick, ["prevent", "stop"])
              }, {
                default: vue.withCtx(() => [
                  vue.createVNode(_component_el_form_item, { label: "只打招呼沟通过的" }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_el_switch, {
                        modelValue: form.onlyGreet,
                        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => form.onlyGreet = $event)
                      }, null, 8, ["modelValue"])
                    ]),
                    _: 1
                  }),
                  !form.onlyGreet ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                    vue.createVNode(_component_el_space, { fill: "" }, {
                      default: vue.withCtx(() => [
                        ...
                        vue.createVNode(_component_el_form_item, { label: "关键词" }, {
                          default: vue.withCtx(() => [
                            vue.createVNode(_component_el_input, {
                              modelValue: form.keyword,
                              "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => form.keyword = $event),
                              autocomplete: "off"
                            }, null, 8, ["modelValue"])
                          ]),
                          _: 1
                    ...
                    vue.createVNode(_component_el_form_item, { label: "判断规则" }, {
                      default: vue.withCtx(() => [
                        vue.createVNode(_component_el_radio_group, {
                          modelValue: form.rule,
                          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => form.rule = $event)
                        }, {
                          default: vue.withCtx(() => [
                            vue.createVNode(_component_el_radio, { label: "同时存在" }),
                            vue.createVNode(_component_el_radio, { label: "任一存在" })
                          ]),
                          _: 1
                        }, 8, ["modelValue"])
                      ]),
                  ...
                  vue.createVNode(_component_el_form_item, { label: "关键词" }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_el_checkbox_group, {
                        ...
                        "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => form.exclude = $event)
                      }, {
                        default: vue.withCtx(() => [
                  ...
                  vue.createVNode(_component_el_form_item, { label: "年龄" }, {
                    default: vue.withCtx(() => [
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-38ef7174"]]);
  ...
  const initApp = () => {
    var _a, _b;
    if (window.$ || ((_a = window == null ? void 0 : window.unsafeWindow) == null ? void 0 : _a.$)) {
      window.$ = window.$ || ((_b = window == null ? void 0 : window.unsafeWindow) == null ? void 0 : _b.$);
