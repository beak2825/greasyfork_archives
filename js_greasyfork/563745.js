...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/563745/f6.user.js
// @updateURL https://update.greasyfork.org/scripts/563745/f6.meta.js
// ==/UserScript==
(function() {
    ...
    const NEW_SEAT   = "Reserved Seat FLOOR Side F6. Row 7. 3"; // 座位信息
 
    const NEW_CODE   = "T2876638140";              // 票号
 
    const NEW_PRICE  = "₩143,000(General)";            // 票价
 
    const NEW_NAME   = "JIALIN ZHANG";              // 姓名
