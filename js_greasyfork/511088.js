...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/511088/Blooket%20Gui.user.js
// @updateURL https://update.greasyfork.org/scripts/511088/Blooket%20Gui.meta.js
// ==/UserScript==
    ...
    const cheat = (async () => {
        ...
        function GUI() {
            ...
            return makeElement("div", {
                ...
                onClick: () => window.open("https://github.com/MrSticker23", "_blank").focus(),
                style: {
                    cursor: "pointer"
                },
                href: "https://github.com/MrSticker23"
            }, "GitHub - MrSticker23")), makeElement("div", {
