// ==UserScript==
// @name         Sportradar FetchingScript - S kriketem
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/489661/Sportradar%20FetchingScript%20-%20S%20kriketem.user.js
// @updateURL https://update.greasyfork.org/scripts/489661/Sportradar%20FetchingScript%20-%20S%20kriketem.meta.js
// ==/UserScript==
...
if (sportId === "6" || sportId === "4") {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const Hometeam = matchData.doc[0].data.match.teams.home.name || "-";
const CricketScoreRuns = matchData.doc[0].data.match.resultinfo.innings[1]?.runs || 0;
const CricketScoreWickets = matchData.doc[0].data.match.resultinfo.innings[1]?.wickets || 0;
const Overs = matchData.doc[0].data.match.over || "00";
const Ball = matchData.doc[0].data.match.ball || "0";
const status = matchData.doc[0].data.match.status.name || "-";
            ...
            let tableHTML = `
    <tr><th id="hometeam">Home team:</th><td id="HometeamID">${Hometeam}</td></tr>
    <tr><th id="home-cricket-score">Cricket Score:</th><td id="home-cricket-score-value">${CricketScoreRuns}/${CricketScoreWickets} (${Overs}.${Ball})</td></tr>
    <tr><th id="status">Status:</th><td id="statusID">${status}</td></tr>
`;
