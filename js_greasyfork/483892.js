// ==UserScript==
// @name         Кураторы форума | BLACK RUSSIA | F. Kevik
// @namespace    http://tampermonkey.net/
// @version      1.3 full
// @description  По вопросам в ВК - https://vk.com/ilyabezzov
// @author       Felix_Kevik
// @match        https://forum.blackrussia.online/threads/*
// @grant        none
// @license 	 MIT
// @icon https://i.postimg.cc/02pB5YtL/kevik.png
// @downloadURL https://update.greasyfork.org/scripts/483892/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20BLACK%20RUSSIA%20%7C%20F%20Kevik.user.js
// @updateURL https://update.greasyfork.org/scripts/483892/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20BLACK%20RUSSIA%20%7C%20F%20Kevik.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    {
     title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴На рассмотрении (жалобы) ╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    },
    {
      title: 'На рассмотрении',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба взята на рассмотрение. <br> Не нужно создавать копии данной жалобы, ожидайте ответа в этой теме.[/COLOR][/FONT][/CENTER]<br><br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5][ICODE]На рассмотрении.[/ICODE][/COLOR][/FONT][/CENTER]',
        prefix: PIN_PREFIX,
      status: true,
    },
    {
    ...
    {
      title: 'передано згкф/гкф',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба была передана на рассмотрение  [COLOR=#00FF00]Заместителю Главного Куратора форума/[/COLOR][COLOR=#1E90FF]Главному Куратору Форума.[/COLOR] [/COLOR][/FONT][/CENTER]<br><br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ожидайте ответа в данной теме.[/COLOR][/FONT][/CENTER]<br><br>' +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]На рассмотрении у [COLOR=#1E90FF]ГКФ/[/COLOR][COLOR=#00FF00]ЗГКФ.[/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба была передана на рассмотрение [Color=#9365B8]Куратору Администрации.[/COLOR] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ожидайте ответа в данной теме.[/COLOR][/FONT][/CENTER]<br><br>' +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]На рассмотрении у [Color=#9365B8]Куратора Администрации.[/COLOR] [/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба была передана на рассмотрение [Color=#FFFF00]Заместителю Главного Администратора.[/COLOR] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ожидайте ответа в данной теме.[/COLOR][/FONT][/CENTER]<br><br>' +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]На рассмотрении у [Color=#FFFF00]Заместителя Главного Администратора.[/COLOR] [/COLOR][/FONT][/CENTER]',
      prefix: PIN_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба была передана на рассмотрение [Color=#FF4500]техническому специалисту.[/COLOR] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ожидайте ответа в данной теме.[/COLOR][/FONT][/CENTER]<br><br>' +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]На рассмотрении у [Color=#FF4500]технического специалиста.[/COLOR] [/COLOR][/FONT][/CENTER]',
      prefix: TEX_PREFIX,
	  status: 123,
    },
    {
      title: 'передано гл. адм',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба была передана на рассмотрение [Color=#DC143C]Главному Администратору.[/COLOR] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ожидайте его ответа.[/COLOR][/FONT][/CENTER]<br><br>' +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]На рассмотрении у [Color=#DC143C]Главного Администратора.[/COLOR] [/COLOR][/FONT][/CENTER]',
      prefix: GA_PREFIX,
	  status: true,
    },
    {
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Игрок будет наказан по пункту правил:<br>1.08. Запрещено использование фракционного транспорта в личных целях [Color=#00FF00] | Jail 30 минут [/color] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Одобрено, закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Игрок будет наказан по пункту правил:<br>1.13. Запрещено находиться в форме внутри казино, участвовать в битве за контейнеры, участвовать в захвате семейного контейнера, находится на Б/У рынке с целью покупки / продажи авто, а также устраиваться на сторонние работы в форме фракции [Color=#00FF00] | Jail 30 минут [/color] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Одобрено, закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Вы ошиблись разделом.<br>Обратитесь в раздел жалоб на администрацию - [URL='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.2829/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Закрыто.[/COLOR][/FONT][/CENTER]',
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Вы ошиблись разделом.<br>Обратитесь в раздел жалоб на лидеров - [URL='https://forum.blackrussia.online/forums/Жалобы-на-лидеров.2830/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Вы ошиблись разделом.<br>Обратитесь в раздел обжалований наказаний - [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.2832/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Вы ошиблись разделом.<br>Обратитесь в раздел жалоб на Агентов поддержки - [URL='https://forum.blackrussia.online/forums/Раздел-для-хелперов-сервера.2840/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Жалоба такого же содержания уже находится на рассмотрении.<br> Ожидайте ответа в прошлой жалобе и не нужно дублировать ее. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
...
$(document).ready(() => {
    ...
    addButton('Гл. Администратору 👑', 'Ga');
...
const buttons1 = [
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][Color=#00FFFF][FONT=courier new]А так же вы будете наказаны по пункту правил: <br>2.22. Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками [Color=#00FF00]| Ban 15 - 30 дней / PermBan[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
		'[CENTER][I][SIZE=4][FONT=arial][Color=#00FF00][ICODE]Рассмотрено, закрыто.[/ICODE][/COLOR][/I][/FONT][/SIZE]',
      prefix: RASSMOTENO_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[Color=#00FF00][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][FONT=courier new]Игрок будет наказан по пункту правил:<br>2.09. Запрещено сливать склад фракции / семьи путем взятия большого количестве ресурсов, или же брать больше, чем разрешили на самом деле [Color=#FFFF00]| Ban 15 - 30 дней / PermBan[/color]. [/COLOR][/FONT][/CENTER] <br>" +
        "[CENTER][Color=#00FFFF][FONT=courier new]А так же вы будете наказаны по пункту правил: <br>2.22. Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками [Color=#00FF00]| Ban 15 - 30 дней / PermBan[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
		'[CENTER][I][SIZE=4][FONT=arial][Color=#00FF00][ICODE]Рассмотрено, закрыто.[/ICODE][/COLOR][/I][/FONT][/SIZE]',
      prefix: RASSMOTENO_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=#00FF00][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][FONT=courier new]Игрок будет наказан по пункту правил:<br>3.18. Запрещено политическое и религиозное пропагандирование, а также провокация игроков к конфликтам, коллективному флуду или беспорядкам в любом из чатов [Color=#00FF00] | Mute 120 минут / Ban 10 дней [/color] [/COLOR][/FONT][/CENTER] <br>" +
        "[CENTER][Color=#00FFFF][FONT=courier new]А так же вы будете наказаны по пункту правил: <br>2.22. Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками [Color=#00FF00]| Ban 15 - 30 дней / PermBan[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
		'[CENTER][I][SIZE=4][FONT=arial][Color=#00FF00][ICODE]Рассмотрено, закрыто.[/ICODE][/COLOR][/I][/FONT][/SIZE]',
      prefix: RASSMOTENO_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=#00FF00][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][FONT=courier new]На видео видно как вы первые начали стрельбу, он лишь начал обороняться (тоесть ответный ДМ). <br> Вы будете наказаны по пункту правил:<br>2.19. Запрещен DM (DeathMatch) — убийство или нанесение урона без веской IC причины [Color=#00FF00] | Jail 60 минут [/color] [/COLOR][/FONT][/CENTER] <br>" +
        "[CENTER][Color=#00FFFF][FONT=courier new]А так же вы будете наказаны по пункту правил: <br>2.22. Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками [Color=#00FF00]| Ban 15 - 30 дней / PermBan[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
		'[CENTER][I][SIZE=4][FONT=arial][Color=#00FF00][ICODE]Рассмотрено, закрыто.[/ICODE][/COLOR][/I][/FONT][/SIZE]',
      prefix: RASSMOTENO_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=#00FF00][FONT=georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/FONT][/CENTER]<br>' +
        "[CENTER][Color=#00FFFF][FONT=courier new]Займ может быть осуществлен только через зачисление игровых ценностей на банковский счет. [/COLOR][/FONT][/CENTER] <br>" +
        "[CENTER][Color=#00FFFF][FONT=courier new]А так же вы будете наказаны по пункту правил: <br>2.22. Запрещено хранить / использовать / распространять стороннее программное обеспечение или любые другие средства, позволяющие получить преимущество над другими игроками [Color=#00FF00]| Ban 15 - 30 дней / PermBan[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
		'[CENTER][I][SIZE=4][FONT=arial][Color=#00FF00][ICODE]Рассмотрено, закрыто.[/ICODE][/COLOR][/I][/FONT][/SIZE]',
      prefix: RASSMOTENO_PREFIX,
	  status: false,
...
$(document).ready(() => {
	...
	// Добавление кнопок при загрузке страницы
    addButton('Сборка / ПО в жалобе ⚠️', 'selectAnswer1');
...
const buttons2 = [
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#00FF00]Одобрено.[/color] <br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило нарушение Правил написания RP биографий. <br><br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - Плагиат. <br><br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - Не дополнили биографию в течение 24-х часов. <br><br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - возраст не совпадает с датой рождения. <br><br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - матерные слова. <br><br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - грамматические ошибки. <br><br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография уже находится на рассмотрении, дополните ее в предыдущей теме. <br><br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      title: 'биография отказана(От 3 лица)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - биография написана от 3-го лица. <br><br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Вы ошиблись разделом.<br>Обратитесь в раздел жалоб на игроков - [URL='https://forum.blackrussia.online/forums/Жалобы-на-игроков.2831/']*Тык*[/URL]. [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
...
$(document).ready(() => {
	...
	// Добавление кнопок при загрузке страницы
    addButton('RP биографии 📖', 'selectAnswer2');
...
XF.alert(buttonsMarkup(buttons2), null, 'НАЖМИТЕ НА НУЖНЫЙ ОТВЕТ');
...
const buttons2 = [
    {
     title: ' ╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴Лидеры/Заместители ╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    },
    {
      title: 'жалоба одобрена',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Одобрено, игрок будет проинструктирован.[/color] [/COLOR][/I][/FONT][/SIZE] <br><br>" +
        '[I][FONT=times new roman][Color=#00FF00][SIZE=5][ICODE]Одобрено, закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Запросил доказательства у игрока, ожидайте ответа в данной теме [/COLOR][/FONT] <br><br>" +
        '[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5][ICODE]На рассмотрении.[/ICODE] [/COLOR][/FONT][/CENTER] <br>',
      prefix: PIN_PREFIX,
	  status: 123,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило нарушение [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-лидеров.3429391/']Правил подачи жалоб на лидеров[/URL]. <br><br>" +
        '[I][FONT=times new roman][Color=#FF0000][SIZE=5][ICODE]Отказано, закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      title: 'жалоба отказана(док-ва одобрена)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Проверив доказательства игрока, выношу вердикт - [Color=#FF0000]Отказано.[/COLOR] [/COLOR][/I][/FONT][/SIZE]<br><br>" +
        '[I][FONT=times new roman][Color=#FF0000][SIZE=5][ICODE]Отказано, закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      title: 'жалоба отказана(неадекват)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - неадеквытное поведение в жалобе.<br><br>" +
        '[I][FONT=times new roman][Color=#FF0000][SIZE=5][ICODE]Отказано, закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      title: 'жалоба отказана(неверный заголовок)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - неверный заголовок жалобы.<br><br>" +
        '[I][FONT=times new roman][Color=#FF0000][SIZE=5][ICODE]Отказано, закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    {
      title: 'жалоба отказана(плохое качество)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - плохое качество доказательств.<br><br>" +
        '[I][FONT=times new roman][Color=#FF0000][SIZE=5][ICODE]Отказано, закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Вы ошиблись разделом, обратитесь в [URL='https://forum.blackrussia.online/forums/Раздел-для-хелперов-сервера.2840/']Жалобы на агентов поддержки [/URL]. <br><br>" +
        '[I][FONT=times new roman][Color=#FF0000][SIZE=5][ICODE]Закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Вы ошиблись разделом, обратитесь в [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']Жалобы на игроков[/URL]. <br><br>" +
        '[I][FONT=times new roman][Color=#FF0000][SIZE=5][ICODE]Закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Вы ошиблись разделом, обратитесь в [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-администрацию.3429349/']Жалобы на администрацию сервера[/URL]. <br><br>" +
        '[I][FONT=times new roman][Color=#FF0000][SIZE=5][ICODE]Закрыто.[/ICODE][I][/FONT][/SIZE][/COLOR] <br>',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
...
$(document).ready(() => {
	...
	// Добавление кнопок при загрузке страницы
    addButton('Жалобы на Лидеров/Замесителей 💼', 'selectAnswer2');
...
const buttons3 = [
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП ситуация получает статус - [Color=#00FF00]Одобрено.[/color] <br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП ситуация получает статус - [Color=#FF0000]Отказано[/color] <br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП ситуация получает статус - [Color=#00FF00]Одобрено.[/color] <br> [QUOTE]Так же хочу отметить, что игровую валюту вы не получите за ограбление чего-либо по РП.[/QUOTE] <br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: SITAACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП ситуация получает статус - [Color=#FF0000]Отказано[/color] <br> [QUOTE]Так же хочу отметить, что игровую валюту вы не получите за ограбление чего-либо по РП.[/QUOTE] <br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: SITAUNACCEPT_PREFIX,
	  status: false,
    },
    {
...
$(document).ready(() => {
	...
	// Добавление кнопок при загрузке страницы
    addButton('rp cитуации', 'selectAnswer3');
...
XF.alert(buttonsMarkup(buttons3), null, 'НАЖМИТЕ НА НУЖНЫЙ ОТВЕТ');
...
const buttons3 = [
    ...
    },
    {
      ...
      content:
        ...
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Одобрено.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/XJCZ7tW2/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      title: 'Жалоба на рассм',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]На рассмотрении.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][I][FONT=times new roman][SIZE=5][Color=#00FF00]На рассмотрении.[/color][/I][/FONT][/CENTER] <br>',
	  status: 123,
    },
    {
      title: 'жалоба отказ',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Отказано, внимательно ознакомьтесь с первым сообщением в теме.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      title: 'жалоба отказ (обрез докв)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Отказано. Причиной отказа послужило обезаное доказательство.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      title: 'Жалоба отказ (доква в плохом качеств)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Отказано. Причиной отказа послужило обезаное доказательство.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
    ...
    {
     title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴Заявки на ранг ╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    },
    {
      title: 'Заявка одобрена',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша заявка получает статус - [Color=#00FF00]Одобрено.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/XJCZ7tW2/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      title: 'заявка на рассм',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша заявка получает статус - [Color=#00FF00]На рассмотрении.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][I][FONT=times new roman][SIZE=5][Color=#00FF00]На рассмотрении.[/color][/I][/FONT][/CENTER] <br>',
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша заявка получает статус - [Color=#00FF00]Отказано, внимательно ознакомьтесь с первым сообщением в теме.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      title: 'Отказ (обрез скринов)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Отказано. Причиной отказа послужили обрезаные скриншоты.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Отказано. Причиной отказа послужило Постороннее ПО на ваших скриншотах.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      title: 'отказ (нет лиценз)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Отказано. Причиной отказа послужило отсутсвие необходимых лицензий.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      title: 'отказ (маленький лвл)',
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Отказано. Причиной отказа послужило отсутствие необходимого игрового уровня.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый игрок.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша жалоба получает статус - [Color=#00FF00]Отказано. Причиной отказа послужил Non Role Play NickName.[/color] [/COLOR][/FONT][/CENTER] <br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/25BvV1FF/image.gif[/img][/url][/CENTER] <br>',
	  status: false,
    },
];
...
$(document).ready(() => {
	...
	// Добавление кнопок при загрузке страницы
    addButton('Жалобы на сотрудников / Заявления на ранги', 'selectAnswer3');
...
const buttons4 = [
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша Неофициальная RP организация получает статус - [Color=#00FF00]Одобрено.[/color] <br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша Неофициальная RP организация получает статус - [Color=#FF0000]Отказано[/color] <br> Приятной игры на [Color=#FF0000]Black Russia.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
...
$(document).ready(() => {
	...
	// Добавление кнопок при загрузке страницы
    addButton('Неофициальные организации', 'selectAnswer4');
    addButton('🎄 Скрипт от Felix_Kevik 🎄', '/');
