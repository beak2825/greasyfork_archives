...
// @downloadURL https://update.greasyfork.org/scripts/534946/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%BE%D1%87%D0%B5%D0%BD%D1%8C%20%D0%BA%D1%80%D1%83%D1%82%D0%BE%D0%B9%20%D0%B4%D0%BB%D1%8F%20%D0%BF%D0%B0%D1%86%D0%B0%D0%BD%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/534946/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%BE%D1%87%D0%B5%D0%BD%D1%8C%20%D0%BA%D1%80%D1%83%D1%82%D0%BE%D0%B9%20%D0%B4%D0%BB%D1%8F%20%D0%BF%D0%B0%D1%86%D0%B0%D0%BD%D0%BE%D0%B2.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Запросил доказательства у администратора. Ожидайте ответа. [/FONT][/B][/COLOR][/CENTER]<br><br>" +
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Жалоба взята на рассмотрение.[/FONT][/B][/COLOR][/CENTER]<br><br>" +
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Ваша жалоба передана на рассмотрение [Color=rgb(255, 0, 0)]Главному Администратору.[/COLOR] [/FONT][/B][/COLOR][/CENTER] <br>" +
        '[CENTER][B][FONT=times new roman][COLOR=rgb(230, 230, 250)]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: GA_PREFIX,
	  status: true,
    },
