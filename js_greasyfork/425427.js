// ==UserScript==
// @name        Twin Bullet Stack by Mekhi Maragh
// @include	    *://diep.io/*
// @author      Mekhi Maragh
// @description Makes a wall of bullets with Twin tank!
// @connect	    diep.io
// @namespace   aaa
// @version 69
// @downloadURL https://update.greasyfork.org/scripts/425427/Twin%20Bullet%20Stack%20by%20Mekhi%20Maragh.user.js
// @updateURL https://update.greasyfork.org/scripts/425427/Twin%20Bullet%20Stack%20by%20Mekhi%20Maragh.meta.js
// ==/UserScript==
...
(function(){//info
    ...
    info_container.style = "pointer-events: none; position: fixed; top:10px; left:10px; font-family: Ubuntu; color: #00FFFF; font-style: normal; font-variant: normal; text-shadow: black 2px 0px, black -2px 0px, black 0px -2px, black 0px 2px, black 2px 2px, black -2px 2px, black 2px -2px, black -2px -2px, black 1px 2px, black -1px 2px, black 1px -2px, black -1px -2px, black 2px 1px, black -2px 1px, black 2px -1px, black -2px -1px;";
document.body.appendChild(info_container);
	info_container.style.color = "cyan";
...
(function(){
    ...
    var sec=false;
	var tankData = [
        {name: "Twin Bullet Stack", cycleRate: 0.0625, maxAngle: Math.PI * 15 / 180, secondaryAngle: Math.PI * 15 / 180, NCANNON: 3}
        ];
	var tankIndex = 0;
