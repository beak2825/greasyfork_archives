...
// @match        *bloble.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/402503/BASE%20ATAQUE%20AUTOMATICA.user.js
// @updateURL https://update.greasyfork.org/scripts/402503/BASE%20ATAQUE%20AUTOMATICA.meta.js
// ==/UserScript==
...
if (a.keyCode==17){
setTimeout(function(){ gens1();},1000);setTimeout(function(){ gens1();},10000);setTimeout(function(){ gens1();},20000);setTimeout(function(){ gens1();},30000);setTimeout(function(){ gens1();},50000);setTimeout(function(){ gens1();},55000);setTimeout(function(){ camada311();},65000);setTimeout(function(){ micro();},79000);setTimeout(function(){ micro();},82000);setTimeout(function(){ barcks1();},85000);setTimeout(function(){ upbarcks1();},138000);setTimeout(function(){ barcks2();}, 145000);setTimeout(function(){ upbarcks2();}, 171000);setTimeout(function(){ venderGens();}, 260000);setTimeout(function(){ base();}, 261000);setTimeout(function(){ armory();}, 262000);setTimeout(function(){ armory();}, 263000);setTimeout(function(){ siege();}, 290000);setTimeout(function(){ barcks1();},291000);}
function gens1(){
...
if(2===units[i].type&&"square"==units[i].shape&&units[i].owner==player.sid){
