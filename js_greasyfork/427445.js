// ==UserScript==
// @name         Pixiv收藏夹自动标签-Dev
// @name:en      Label Pixiv Bookmarks-Dev
...
// @downloadURL https://update.greasyfork.org/scripts/427445/Pixiv%E6%94%B6%E8%97%8F%E5%A4%B9%E8%87%AA%E5%8A%A8%E6%A0%87%E7%AD%BE-Dev.user.js
// @updateURL https://update.greasyfork.org/scripts/427445/Pixiv%E6%94%B6%E8%97%8F%E5%A4%B9%E8%87%AA%E5%8A%A8%E6%A0%87%E7%AD%BE-Dev.meta.js
// ==/UserScript==
...
async function handleStart(addFirst, addSAFE, tag, retainComment, publicationType) {
  ...
  if (window.location.href.includes("https://www.pixiv.net/bookmark.php")) {
    ...
    uid = uidRes.slice(uidPos, uidEnd).split("\"")[1];
  } else {
    const uidArray = window.location.href.split("/");
    uid = uidArray[uidArray.indexOf("users") + 1];
  }
  // TODO
  // console.log(uid);
  ...
  const userTags = [];
  if (publicationType === "show") {
    for (let obj of tagsObj.body.public) {
      userTags.push(obj.tag);
    }
  } else {
...
(function() {
  ...
  promptDiv.innerHTML = `
    <div>如果对以下配置有疑惑，请参考
      <a href="https://greasyfork.org/zh-CN/scripts/423823-pixiv%E6%94%B6%E8%97%8F%E5%A4%B9%E8%87%AA%E5%8A%A8%E6%A0%87%E7%AD%BE?locale_override=1">文档</a>
    </div>
    <div>Please refer to the
      <a href="https://greasyfork.org/en/scripts/423823-pixiv%E6%94%B6%E8%97%8F%E5%A4%B9%E8%87%AA%E5%8A%A8%E6%A0%87%E7%AD%BE">document</a> if confused.
    </div>`;
  ...
  option00.innerText = "是 / Yes";
  option00.value = "true";
  const option01 = document.createElement("option");
  option01.innerText = "否 / No";
  option01.value = "false";
  ...
  option10.innerText = "是 / Yes";
  option10.value = "true";
  const option11 = document.createElement("option");
  option11.innerText = "否 / No";
