...
// @supportURL   https://greasyfork.org/zh-CN/scripts/383574/feedback
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/383574/%E5%AE%88%E6%8A%A4%E7%B2%BE%E7%81%B5%28%E5%87%86%E8%80%83%E4%B8%93%E7%89%88%29.user.js
// @updateURL https://update.greasyfork.org/scripts/383574/%E5%AE%88%E6%8A%A4%E7%B2%BE%E7%81%B5%28%E5%87%86%E8%80%83%E4%B8%93%E7%89%88%29.meta.js
// ==/UserScript==

// 设置修改后，需要刷新或重新打开网课页面才会生效
var setting = {
    // 5E3 == 5000，科学记数法，表示毫秒数
    time: 10E3 + Math.round(Math.random()*10) * 1E3 // 默认响应速度为5秒，不建议小于3秒
...
setting.div = $(
    '<div style="border: 2px dashed rgb(0, 85, 68); width: 330px; position: fixed; top: 0px;left: 0px;right: 0px;margin-left:auto;margin-right:auto; z-index: 99999; background-color: rgba(72, 118, 255, 0.6); overflow-x: auto;">' +
    ...
    '<span style="font-size: medium;"></span>' +
        '<div style="font-size: medium;">正在搜索答案...'+ setting.time/1E3 + '秒</div>' +
    ...
    if (num == -1) {
        ...
        if (setting.out) {
            ...
            setting.$div.text('正在搜索答案...'+ setting.time/1E3 + '秒');
            $(this).text('暂停答题');
        }
    } else if (num == 1) {
        setting.jump = 0;
...
function fillAnswer(obj, tip) {
    ...
    if ($next.length) {
        tip += setting.jump ? '，即将切换下一题' + setting.time/1E3 + '秒' : '，未开启自动切换';
