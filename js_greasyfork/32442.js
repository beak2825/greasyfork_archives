...
// @downloadURL https://update.greasyfork.org/scripts/32442/VIP%E8%A7%86%E9%A2%91%E7%A0%B4%E8%A7%A3.user.js
// @updateURL https://update.greasyfork.org/scripts/32442/VIP%E8%A7%86%E9%A2%91%E7%A0%B4%E8%A7%A3.meta.js
// ==/UserScript==

(function() {
    'use strict';
    var cracks=[
        {name:"解析接口一",url:"https://api.flvsp.com/?url=%s"},
        {name:"解析接口二",url:"https://jiexi.071811.cc/jx.php?url=%s"},
        {name:"解析接口三",url:"https://www.zuixiaopin.com/api/cloudVideo?url=%s"},
        {name:"解析接口四",url:"https://www.yymeier.com/api.php?url=%s"},
        {name:"解析接口五",url:"https://jxapi.nepian.com/ckparse/?url=%s"},
        {name:"解析接口六",url:"https://api.47ks.com/webcloud/?v=%s",title:"首选"},
        {name:"解析接口七",url:"https://ckplaer.duapp.com/hai2.php?url=%s",title:"播放器放在百度开发者平台"},
    ...
    select.innerHTML="<option value='https://jiexi.071811.cc/jx.php?url=%s' selected>默认解析接口</option>";
    ...
    quickAccess.innerHTML="<input type='checkbox' checked style='display:none'>已破解";
    ...
    embedLabel.title="";
    embedLabel.innerHTML="<input type='checkbox'checked  style='display:none'>无法播放请更换接口";
    ...
    showP.innerHTML='<img src="https://pic.sopili.net/pub/emoji/twitter/2/72x72/1f431.png" width=18 height=18>';
