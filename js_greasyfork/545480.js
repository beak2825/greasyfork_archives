  // ==UserScript==
    // @name         BLACK | 🍃Куратор форума by B.Capone🍃
    // @namespace    https://forum.blackrussia.online
    // @version      4.8
    // @description  Для Куратора форума - BLACK RUSSIA
    // @author       B.Capone
...
// @downloadURL https://update.greasyfork.org/scripts/545480/BLACK%20%7C%20%F0%9F%8D%83%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20BCapone%F0%9F%8D%83.user.js
// @updateURL https://update.greasyfork.org/scripts/545480/BLACK%20%7C%20%F0%9F%8D%83%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20BCapone%F0%9F%8D%83.meta.js
    // ==/UserScript==
    ...
    "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша жалоба взята на рассмотрение. Ожидайте пожалуйста ответа в ближайшее время.[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    ...
    "[CENTER][FONT=georgia][SIZE=4][COLOR=#FF8C00][I]На рассмотрении.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
      ...
      status:true,
        ...
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша жалоба переадресована [/COLOR][COLOR=#FF0000]Главному Администратору[/COLOR][COLOR=rgb(192, 192, 192)][/SIZE][/FONT][FONT=georgia][SIZE=4], ожидайте ответа в данной теме.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[CENTER][IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG][/CENTER]<br>"+
        "[CENTER][FONT=georgia][SIZE=4][I][COLOR=rgb(192, 192, 192)]Игрок не совершил никаких нарушений.[/I][/SIZE][/FONT][/CENTER]<br>" +
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[CENTER][FONT=georgia][SIZE=4][I][COLOR=rgb(192, 192, 192)]Жалобы от 3-го лица не подлежат рассмотрению[/I][/SIZE][/FONT][/CENTER]<br>" +
        "[CENTER][IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG][/CENTER]<br>"+
        "[CENTER][FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Примечание:[/I][/COLOR][COLOR=rgb(209, 213, 216)] Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/COLOR][/SIZE][/FONT][/CENTER]<br>" +
        "[CENTER][IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG][/CENTER]<br>"+
        "[CENTER][FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
        ...
        {
          title: '------------------------------------------------------| 🍃️RP Биографии🍃️ |------------------------------------------------------',
          content:
              '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>',
          },
        {
            title: '| 🍃️RP био одобрена🍃 |',
          content:
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][I][COLOR=rgb(192, 192, 192)]Ваша RolePlay биография поставлена на доработку.[/SIZE][/FONT]<br>" +
        "[HR][/HR]" +
        "[FONT=georgia][SIZE=4][I][COLOR=rgb(192, 192, 192)]Внимательно прочитайте правила создания RP - биографий, закрепленные в данном разделе. Вам даётся 24 часа для исправления ошибок.[/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay - биография отказана, так как в ней указан некорректный возраст.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay - биография отказана, так как в ней написано мало информации.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay - биография отказана, так как персонажу нет 18 лет.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[CENTER][FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay - биография отказана, так как написана от 1-го лица.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)]Внимательно изучите правила написания RP Биографии - [URL='https://forum.blackrussia.online/threads/black-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BD%D0%B0%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D1%8F-rp-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.12561030/']*Нажмите сюда*[/URL][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay - биография отказана, так как вы её не до работали.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay - биография отказана, так как в пункте *Детство* мало информации.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
          prefix: UNACCEPT_PREFIX,
           status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay - биография отказана, так как в пункте *Юность и Взрослая жизнь* мало информации.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
          prefix: UNACCEPT_PREFIX,
           status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay биография отказана по причине недостаточного объема информации в разделах *Детство* и *Юность и взрослая жизнь*.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
          prefix: UNACCEPT_PREFIX,
           status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Вы ошиблись разделом, это раздел для написания RP-ситуаций.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
          status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay Ситуация отказана, так как название темы указано не верно[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
          status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша RolePlay Ситуация отказана, так как в ней нет имеющего смысла.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
          status: false,
        ...
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Вы должны проявлять активность в организации. Раз в неделю прикрепляйте в данную тему любые скриншоты, видеозаписи об каких либо активных действиях в вашей организации. В случае отсутствия активности организация будет закрыта.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша Неофициальная RolePlay организация поставлена на доработку.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Вам нужно доработать свою неофиц. организацию и исправить всевозможные ошибки. На это вам даётся 24 часа.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>" +
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[CENTER][FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша Неофициальная RolePlay организация отказана.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Поскольку вы её не доработали и не исправили ошибки в отведённый срок.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
          prefix: V_PREFIX,
           status: false,
        ...
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша Неофициальная RolePlay организация отказана.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Деятельность вашей организации может нарушать какие-либо правила на проекте, что запрещается не только правилами проекта, но и правилами создания неофициальных организаций.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
          status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша Неофициальная RolePlay организация отказана, так как в ней нет имеющего смысла.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
          status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Ваша неофициальная RolePlay организация отказана, так как дата создания в заголовке указана некорректно.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
          status: false,
        ...
        "[HEADING=3][CENTER][I][COLOR=rgb(192, 192, 192)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]Вы ошиблись разделом, это раздел для создания неофициальных организаций.[/I][/SIZE][/FONT]<br>" +
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
        "[FONT=georgia][SIZE=4][COLOR=#FF0000][I]Отказано, закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
           prefix: UNACCEPT_PREFIX,
          status: false,
        ...
        },
        {
          ...
          content:
        "[HEADING=3][CENTER][FONT=georgia][SIZE=4][COLOR=rgb(192, 192, 192)][I]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/COLOR][/SIZE][/FONT][/HEADING]"+
        "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
