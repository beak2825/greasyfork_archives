...
// @downloadURL https://update.greasyfork.org/scripts/15051/WF%20ToolBox%20Beta.user.js
// @updateURL https://update.greasyfork.org/scripts/15051/WF%20ToolBox%20Beta.meta.js
// ==/UserScript==
...
//============================== URL ====================================//
var WFTB_BaseURL = 'https://www.waze.com';
var WFTB_url_usergroups = WFTB_BaseURL + '/forum/ucp.php?i=167';
var WFTB_URL_UserProfil_URI = '/user/editor/';

//============================== Recherche ==============================//
var WFTB_search_base_url = '//a[contains(@href,\'editor-beta.waze.com\') or contains(@href,\'www.waze.com\')][contains(@href,\'editor\')]';
...
function WFTB_updatePerma() {
 ...
 var WFTB_L_newURL = '';
 var WFTB_L_title = '';
 var WFTB_L_patt_editor = '';
 var WFTB_L_patt_user = '';
 var WFTB_L_cpt = 0;
 ...
 for(WFTB_L_cpt = 0; WFTB_L_cpt < WFTB_L_postlinkList.length; WFTB_L_cpt++) {
  ...
  if(!WFTB_L_patt_editor.test(WFTB_L_href) ||  WFTB_L_patt_user.test(WFTB_L_href)) continue;
 ...
 if(WFTB_beta_editor) for(WFTB_L_cpt = 0; WFTB_L_cpt < WFTB_L_WME_links.length; WFTB_L_cpt++) {
  ...
  if(WFTB_L_patt_editor.test(WFTB_L_href)) {
   ...
   WFTB_L_newURL = WFTB_L_href.replace(WFTB_L_patt_editor, 'editor-beta');
   ...
   WFTB_L_newURL = WFTB_L_href.replace(/editor-beta/, 'www');
...
function WFTB_AddUserProfil() {
 ...
 var WFTB_L_cpt = 0;
 var WFTB_L_patt = new RegExp('mode=viewprofile');
 var WFTB_L_LinkList = Array();
 
 if(WFTB_L_patt.test(window.location.href)) {
  // //*[@id="viewprofile"]/div[1]/div/dl/dd[1]/span
 ...
 else
 {
  ...
  WFTB_Log('WFTB_is_beta_editor', 5, 'url de la page' + window.location.href);
     
  if(WFTB_L_LST_A.length > 0) for(WFTB_L_cpt = 0; WFTB_L_cpt < WFTB_L_LST_A.length; WFTB_L_cpt++) {
   try {
    if(WFTB_L_patt.test(WFTB_L_LST_A[WFTB_L_cpt].href)) WFTB_L_LST_UserA.push(WFTB_L_LST_A[WFTB_L_cpt]); 
   }
   catch(e) {
  ...
  if(WFTB_L_LST_UserA.length > 0) for(WFTB_L_cpt = 0; WFTB_L_cpt < WFTB_L_LST_UserA.length; WFTB_L_cpt++) {
   WFTB_insertAfter(WFTB_Profil(WFTB_L_LST_UserA[WFTB_L_cpt].innerHTML, WFTB_L_LST_UserA[WFTB_L_cpt].style.color, 'fr'), WFTB_L_LST_UserA[WFTB_L_cpt]);
  }
 }
...
function WFTB_Profil(WFTB_L_UserName, WFTB_L_UserColor, WFTB_L_Lang) {
 ...
 WFTB_L_ProfilLink.href = WFTB_BaseURL + '/' + WFTB_L_Lang + WFTB_URL_UserProfil_URI + WFTB_L_UserName;
 ...
 WFTB_L_ProfilLink.innerHTML = '(Editor Profil)';
...
function WFTB_xpath(WFTB_L_query, WFTB_L_element) {
 ...
 for (var WFTB_L_cpt = 0; WFTB_L_cpt < WFTB_L_result.snapshotLength; WFTB_L_cpt++) WFTB_L_table.push(WFTB_L_result.snapshotItem(WFTB_L_cpt));
