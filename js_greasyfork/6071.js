// ==UserScript==
// @name		[Konachan / yande.re] Search: ID Navigation
// @namespace	Zolxys
...
// @include		/^https?://konachan\.(com|net)/post/?($|\?|#)/
// @include		/^https?://yande\.re/post/?($|\?|#)/
// @version		2.3
// @downloadURL https://update.greasyfork.org/scripts/6071/%5BKonachan%20%20yandere%5D%20Search%3A%20ID%20Navigation.user.js
// @updateURL https://update.greasyfork.org/scripts/6071/%5BKonachan%20%20yandere%5D%20Search%3A%20ID%20Navigation.meta.js
// ==/UserScript==
var c = 21;
...
var x = -1, xa = -1, m = 1, s = '', t = '', order = 'id_desc';
var sa = location.search.substr(1).split('&');
for (var i = 0; i < sa.length; ++i) { // Parse location.search and collect data
	var r;
	if ((r = /^page=(\d+)$/.exec(sa[i])) != null)
		...
		for (var j = 0; j < ta.length; ++j) {
			if ((r = /^id:([<>])(=?)(\d+)$/.exec(decodeURIComponent(ta[j]))) != null) {
				x = parseInt(r[3]);
				xa = ((r[1] == '>')? 1 : -1);
				if (r[2] == '=')
					x -= xa;
