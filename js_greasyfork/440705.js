...
// @downloadURL https://update.greasyfork.org/scripts/440705/%E7%81%BF%E8%80%80%E6%98%93%E5%AE%A2%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E5%85%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/440705/%E7%81%BF%E8%80%80%E6%98%93%E5%AE%A2%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E5%85%B7.meta.js
// ==/UserScript==
...
// @match      https://www.pinterest.com/*
    ...
    *{
    ...
    .operate-btn button,.bindBtn,.prohibitBtn,#synchronize{
        padding: 7px 20px;
        background-color: #1890ff;
        font-size: 14px;
        border-radius: 3px;
                    ...
                    success: function (res) {
                        ...
                        for(let key in res.aweme_list){
                            ...
                            if(res.aweme_list[key].aweme_type == 0){
                                ...
                                // 视频发布时间
                                starData[8] = res.aweme_list[key].create_time
        ...
        function resourceInfo(){
            ...
            req(apiHost+"/spider/browser/resourceInfo",JSON.stringify(dataBind),function(response){
                ...
                if(response.result.info.coolstar_state == 0){
                    ...
                    let bindBtn = `<a href="https://cy.oa.cyek.com/home/work/teamStar/sw" class="prohibitBtn" target="_blank">查看详情</a>`;
                    $(".ewm-bind").append(bindBtn)
