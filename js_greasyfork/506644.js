...
// @downloadURL https://update.greasyfork.org/scripts/506644/pixels%20home%20tree.user.js
// @updateURL https://update.greasyfork.org/scripts/506644/pixels%20home%20tree.meta.js
// ==/UserScript==
...
(() => {
  ...
  */
        ...
        //let jsonString = JSON.stringify(Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes[length_scenes-1].stateManager.room.state);
        ...
        let interval = setInterval(() => {
            ...
            if (unsafeWindow.spacepack) {
                ...
                let sell_info = ["Popberry", "Grainbow", "Queen Bee", "Honey", "Wax","Whittlewood Log","Sap","Craftbark Log"]
                ...
                RoomPrototype.dispatchMessage = function (m, R) {
                    ...
                    switch (T) {
                        ...
                        case 'updatePlayer':
                            length_scenes = unsafeWindow.Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes.length
                            playSchemaSerializer = unsafeWindow.Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes[length_scenes-1].stateManager.playerSerializer
                            //var mapId = unsafeWindow.Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes[length_scenes-1].stateManager.room.state.id
...
//                     let state = unsafeWindow.Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes[length_scenes-1].stateManager.room.state;
//                     //console.log(unsafeWindow.Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes[length_scenes-1].entities);
