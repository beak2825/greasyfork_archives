// ==UserScript==
// @name               字体渲染（自用脚本）lldxdy
// @name:zh-CN         字体渲染（自用脚本）lldxdy
// @name:zh-TW         字體渲染（自用腳本）lldxdy
// @name:ja            フォントレンダリング（カスタマイズ）lldxdy
// @name:en            Font Rendering (Customized)
// @version            2022.10.05.7
// @author             F9y4ng
...
// @downloadURL https://update.greasyfork.org/scripts/450625/%E5%AD%97%E4%BD%93%E6%B8%B2%E6%9F%93%EF%BC%88%E8%87%AA%E7%94%A8%E8%84%9A%E6%9C%AC%EF%BC%89lldxdy.user.js
// @updateURL https://update.greasyfork.org/scripts/450625/%E5%AD%97%E4%BD%93%E6%B8%B2%E6%9F%93%EF%BC%88%E8%87%AA%E7%94%A8%E8%84%9A%E6%9C%AC%EF%BC%89lldxdy.meta.js
// ==/UserScript==
...
~(function (trustedTypesPolicy) {
  ...
  const fontCheck = new Set([
    ...
    { ch: "更纱黑体 SC Semibold", en: "Sarasa Gothic SC Semibold", ps: "Sarasa-Gothic-SC-Semibold" },
    { ch: "更紗黑體 TC", en: "Sarasa Gothic TC", ps: "Sarasa-Gothic-TC-Regular" },
    { ch: "等距更纱黑体 SC", en: "Sarasa Mono SC", ps: "Sarasa-Mono-SC-Semibold" },
    { ch: "等距更纱黑体 SC Semibold", en: "Sarasa Mono SC Semibold", ps: "Sarasa-Mono-SC-Semibold" },
  ...
  !(async function FontRendering(loading) {
    ...
    const fontCss = fontStyle_db + fontStyle_container + fontStyle_tooltip + fontStyle_Progress;
