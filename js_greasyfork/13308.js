// ==UserScript==
// @name		v4c/InstaSynch Additional Features also IP hash check
// @namespace		v4c
...
// @grant		none
// @author		biggles
// @downloadURL https://update.greasyfork.org/scripts/13308/v4cInstaSynch%20Additional%20Features%20also%20IP%20hash%20check.user.js
// @updateURL https://update.greasyfork.org/scripts/13308/v4cInstaSynch%20Additional%20Features%20also%20IP%20hash%20check.meta.js
// ==/UserScript==
...
window.script = new function(){
	...
	self.changelog ="<li>Added ability to change chat font type and size. Check it out under the Chat Settings tab.</li>";
...
window.script.overwriteFunctions = function() {
	...
	var createUser = function(user) {
        ...
        //sym edit
				...
				var alt;
							for(runthroughlist = 0; runthroughlist<room.userlist.users.length;runthroughlist++){if (joinIP==room.userlist.users[runthroughlist].ip){alt=(room.userlist.users[runthroughlist].username);};};

		if (messages > 3) {
			if (alt==undefined){room.addMessage({username:'%modAction'}, savedName + '(' + joinIP + ') joined the room' ,"emote");}
...
script.$aniMemes={
        ...
        //anime
        'smuganime': '<img src="http://i.imgur.com/mKfn1C2.gif" width="50" height="55";">',
        'smuganime2': '<img src="http://i.imgur.com/GJSTjQj.png" width="65" height="88";">',
    ...
    'pew3': '<img src="http://i.imgur.com/fb5r3Bw.gif" width="66" height="52";">',
        ...
        'kirby2': '<img src="http://i.imgur.com/QXzjf7n.gif" width="40" height="40";">',
        'kirby3': '<img src="http://i.imgur.com/ND4xZaa.gif" width="40" height="40";">',
        'kirby4': '<img src="http://i.imgur.com/kpYgZz1.gif" width="40" height="40";">',
        'kirby5': '<img src="http://i.imgur.com/n0fvhXl.gif" width="40" height="40";">',
        'kirby6': '<img src="http://i.imgur.com/3vBa51P.gif" width="40" height="40";">',
    ...
    'fox': '<img src="http://i.imgur.com/u2JoaaP.gif" width="36" height="60";>',
    ...
    'gato': '<img src="http://i.imgur.com/uNVIDJM.gif" width="50" height="50";>',
        ...
        'boggle': '<img src="http://i.imgur.com/2Lidc4d.png" width="50" height="50";>',
		...
		$.extend(script.$newcodes, script.$metalMemes, script.$aniMemes);
...
window.script.setHTML = function() {
	if (!script.htmlIsSet) {
		...
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_showlogs_box" type="checkbox" value="ShowLogs">Show Join and Leave Logs</label></div>');
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_useemotes_box" type="checkbox" value="UseEmotes">Show Emotes in Chat</label></div>');
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_usetimestamps_box" type="checkbox" value="UseTimestamps">Display Chat Timestamps</label></div>');
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_fast_box" type="checkbox" value="Fast">Use :fast: Emote</label></div>');
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_spin_box" type="checkbox" value="Spin" disabled="disabled">Use :spin: Emote</label></div>');
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_showadd_box" type="checkbox" value="AddMsgs">Show Video Add Messages in Chat</label></div>');
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_showroll_box" type="checkbox" value="ShowRoll">Show $roll/$8ball Results in Chat</label></div>');
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_navbar_box" type="checkbox" value="FixedNavbar">Fixed Navbar</label></div>');
		$('#tabs_chat_settings_content').append('<div class="checkbox"><label><input id="toggle_logtochat_box" type="checkbox" value="LogToChat">Show Moderator Actions in Chat</label><span style="display: block;padding-left: 20px;color:orange">Display these actions:</span><div id="action_list"></div></div>');
		$('#tabs_chat_settings_content').append('<div class="fastspeedbox"><label><input id="marqueeinput" style="color:black" size="3" type="text" max="999" maxlength="3" onkeyup="script.fns.setFast($(this).val());return false;"> :fast: Scroll Speed <span style="color: #c00">(max 999)</span></label></div>');
