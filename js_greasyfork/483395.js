...
// @grant           GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/483395/Batch_Gift.user.js
// @updateURL https://update.greasyfork.org/scripts/483395/Batch_Gift.meta.js
// ==/UserScript==
    ...
    return new Promise((resolve, reject) => {
      fetch(
        `https://checkout.steampowered.com/checkout/inittransaction/`,
        {
          method: "POST",
          credentials: "include",
          body: `gidShoppingCart=${cartGid}&gidShoppingCart=${cartGid}&gidReplayOfTransID=-1&bUseAccountCart=0&PaymentMethod=steamaccount&bIsGift=1&GifteeAccountID=${targerSteamId}&GifteeEmail=&GifteeName=${giftName}&GiftMessage=${giftInfo}&Sentiment=%E7%A5%9D%E4%BD%A0%E5%A5%BD%E8%BF%90&Signature=${giftSign}&ScheduledSendOnDate=0&sessionid=${sessionId}`,
          headers: {
            "content-type":
