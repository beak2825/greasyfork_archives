...
// @name Бот
// @namespace Кирилл
// @description Бот для Agar.Io
// @include http://agar.io/
// @version 1.00
// @grant none
// @author vk.com/id225839500
// @downloadURL https://update.greasyfork.org/scripts/10227/%D0%91%D0%BE%D1%82.user.js
// @updateURL https://update.greasyfork.org/scripts/10227/%D0%91%D0%BE%D1%82.meta.js
// ==/UserScript==
...
sessionScore = Math.max(sessionScore, F);
    0 != F && (null == ba && (ba = new ca(24, '#FFFFFF')), ba.setValue('Очков: ' + ~~(F / 100) + ' || Лучший результат: ' + ~~(sessionScore / 100) + " || Лучшее время: " + bestTime + " сек."), c = ba.render(), b = c.width, e.globalAlpha = 0.2, e.fillStyle = '#000000', e.fillRect(10, r - 10 - 24 - 10, b + 10, 34), e.globalAlpha = 1, e.drawImage(c, 15, r - 10 - 24 - 5));
Na();
a = + new Date - a;
...
debugStrings.push("R - Доп. интерфейс: " + (!toggleDraw ? "Вкл." : "Выкл."));
debugStrings.push("Сервер: " + serverIP);
debugStrings.push("Время: " + nbSeconds + " секунд");
