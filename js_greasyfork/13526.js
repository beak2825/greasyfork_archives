...
// @match *://spinybackmanga.com/manga/*/*
// -- FOOLSLIDE START
...
// @match *://onetimescans.com/foolslide/read/*
...
// -- FOOLSLIDE END
// @downloadURL https://update.greasyfork.org/scripts/13526/Manga%20Loader.user.js
// @updateURL https://update.greasyfork.org/scripts/13526/Manga%20Loader.meta.js
// ==/UserScript==
...
var implementations = [{
  ...
  match: "^https?://(mngcow|mangadoom|mangaindo)\\.(co|id)/[^/]+/[0-9.]+",
  img: '.prw a > img',
  next: '.prw a[onclick]',
  ...
  name: 'senmanga-raw',
  match: "^https?://raw\\.senmanga\\.com/[^/]*/[^/]*/[0-9]*",
  img: function() {
    return W.new_image;
  },
  next: function() {
  ...
  name: 'senmanga',
  match: "^https?://www\\.senmanga\\.com/[^/]*/[^/]*/[0-9]*",
  img: '#picture',
  next: '#reader a',
  numpages: 'select[name=page]',
  curpage: 'select[name=page]',
  ...
  match: "^https?://(" + [
    ...
    "onetimescans.com/foolslide/read/.+",
    "necron99scans.com/reader/read/.+",
  ...
  name: 'spinybackmanga',
  match: '^https?://spinybackmanga.com/manga/.+/.+',
  img: '#ppp a img',
  next: 'li.next a',
  curpage: 'button[data-id=page-list] + div ul li.selected a span.text',
  numpages: 'button[data-id=page-list] + div ul',
  curchap: function() {
    var chaps = getEls('#chapter-list ul li');
    var chapter = 1;
    chaps.some(function(value, index) {
      if (value.classList.contains('active')) {
        chapter = chaps.length - index;
        return true;
      }
    });
    return chapter;
  },
  numchaps: '#chapter-list ul',
  nextchap: function() {
    var ctx = getEl('#chapter-list ul li.active').previousElementSibling;
    return ctx ? getEl('a', ctx).href : null;
  },
  prevchap: function() {
    var ctx = getEl('#chapter-list ul li.active').nextElementSibling;
    return ctx ? getEl('a', ctx).href : null;
  }
}];
// END OF IMPL
