// ==UserScript==
// @name Last.fm Zippyshare Search
// @author MadhATTER6
// @description Adds Zippyshare search links to the buy buttons on Last.FM
// @version 2.2.1
// @match http://last.fm/*
// @match http://www.last.fm/*
// @namespace https://greasyfork.org/users/2237
// @downloadURL https://update.greasyfork.org/scripts/11165/Lastfm%20Zippyshare%20Search.user.js
// @updateURL https://update.greasyfork.org/scripts/11165/Lastfm%20Zippyshare%20Search.meta.js
// ==/UserScript==
...
function createSearchItem(search){
  ...
  a = li.appendChild(document.createElement("a"));
    ...
    a.setAttribute("href",
                   "http://www.google.com/search?q=site%3Azippyshare.com+" + search);
    span = a.appendChild(document.createElement("span"));
      span.className = "media-body";
      img  = span.appendChild(document.createElement("img"));
        img.setAttribute("src", "http://www.zippyshare.com/images/favicon.ico");
        img.className = 'ecommerce-icon';
    a.appendChild(document.createTextNode("Zippyshare Search"));
    span = a.appendChild(document.createElement('span'));
