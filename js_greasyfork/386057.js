...
// @version      0.47
// @description  Tetris Battle theme for Jstris
// @author       Oki, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/386057/TB%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/386057/TB%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/faP1Rp3.png",36);
        loadGhostSkin("https://i.imgur.com/R76ixGK.png",36);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/wXJMZxq.png')";
...
function CustomSFXset(){
    ...
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_ready.wav",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/TB_go.wav",abs:1,set:0};
...
function atGameStart() {
    ...
    img.onload = function(){
        ...
        bgctx.drawImage(img,47,107,479,560); // Or at whatever offset you like
    };
    img.src = "https://i.imgur.com/YoLNvEW.png";
...
queueCopy0.style.transform = "scale(0.6,0.6) translate(13px, 30px)"
queueCopy1.style.transform = "scale(0.6,0.6) translate(13px, 60px)"
queueCopy2.style.transform = "scale(0.6,0.6) translate(13px, 70px)"
queueCopy3.style.transform = "scale(0.6,0.6) translate(13px, 70px)"
queueCopy4.style.transform = "scale(0.6,0.6) translate(13px, 60px)"


holdCanvas.style.float = "none"
holdCanvas.style.position = "absolute"
holdCanvas.style.transform = "scale(0.6,0.6)"
holdCanvas.style.top = "18px"
holdCanvas.style.left = "11px"
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/TBsong1.mp3",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/TBsong1.mp3"
