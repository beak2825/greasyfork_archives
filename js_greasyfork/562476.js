...
// @version      1.2.6
// @description  Best Undectable Cheats Out There
// @author       Retired
...
// @grant        GM_setValue
// @grant        GM_getValue
// @namespace https://greasyfork.org/users/Retired
// @downloadURL https://update.greasyfork.org/scripts/562476/KrunkerIO%20Aimbot%20%20ESP.user.js
// @updateURL https://update.greasyfork.org/scripts/562476/KrunkerIO%20Aimbot%20%20ESP.meta.js
// ==/UserScript==
...
(function() {
    ...
    const featureDescriptions = {
        ...
        verticalAdjustment: "Vertical Adjustment (8.8 Recommended)"
    };
        ...
        interfaceContainer.innerHTML = `
            ...
            <div class="nexus-interface ${config.uiCollapsed ? '' : 'expanded'}">
                <div class="interface-header">
                    <span class="interface-title">Settings</span>
                ...
                <div class="interface-content">
                    <div class="panel ${config.lastActivePanel === 'Targeting System' ? 'active' : ''}">
                        <div class="panel-header">
                            <span class="panel-title">Aimbot Settings</span>
                    ...
                    <div class="panel ${config.lastActivePanel === 'Visualization' ? 'active' : ''}">
                        <div class="panel-header">
                            <span class="panel-title">ESP Color</span>
                            <span class="panel-arrow">▶</span>
                        </div>
                        <div class="panel-content">
    ...
    (function createPersistentOverlay() {
        if (location.href.includes("social.html?p=profile&q=Buts") && displayLoadingOverlay) {
            ...
            const checkRedirect = () => {
                ...
                if (((!patchApplied || playerLag >= 10) && playerFPS >= 30)) {
                    setTimeout(() => {
                        ...
                        const SETTINGS_SYNC_PROFILE = "Butsi0";
