...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/491395/Make%20BiliBili%20Great%20Again.user.js
// @updateURL https://update.greasyfork.org/scripts/491395/Make%20BiliBili%20Great%20Again.meta.js
// ==/UserScript==
...
if (location.host === "www.bilibili.com") {
    GM_addStyle('.feed2 .container>*:has(a[href*="cm.bilibili.com"]),.feed2 .container>*:has(a[href*="live.bilibili.com"]),.floor-single-card,.recommended-swipe,.storage-box,.bili-live-card{display:none}.feed2 .container>*{margin-top:0 !important}');
}
