...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/539034/Torn%20Burglary%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/539034/Torn%20Burglary%20Helper.meta.js
// ==/UserScript==
...
(function() {
    ...
    function decorateTargetNode(node) {
        ...
        imageNode.title = `<strong>${targetName} - ${targetInfo.type}</strong><br>${targetInfo.safety} - Case ${targetInfo.cases} time(s).<br><br><strong> - Ammunition:</strong> ${targetInfo.ammo}<br><strong> - Interesting Loot:</strong> ${targetInfo.loot}<br><strong> - Unique:</strong> ${targetInfo.unique}`;
    }
