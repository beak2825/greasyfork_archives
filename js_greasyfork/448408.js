// ==UserScript==
// @name         Wayfarer Nomination NameCord Copy
// @version      3.0
// @description  Add Streetview to selected nomination
// @namespace    https://github.com/
// @homepageURL  https://github.com/
// @match        https://wayfarer.nianticlabs.com/*
// @downloadURL https://update.greasyfork.org/scripts/448408/Wayfarer%20Nomination%20NameCord%20Copy.user.js
// @updateURL https://update.greasyfork.org/scripts/448408/Wayfarer%20Nomination%20NameCord%20Copy.meta.js
// ==/UserScript==
    ...
    function addCoordinates(selected) {
        ...
        awaitElement(() => document.querySelector("app-submissions app-details-pane h4"))
            ...
            titleP.onclick = function() {
                navigator.clipboard.writeText(titleText+" "+cord);
            }
        });     
	}
