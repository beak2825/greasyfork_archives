...
// @homepage     https://site.com/Blum
// @downloadURL https://update.greasyfork.org/scripts/518077/Blum%20Autoclicker.user.js
// @updateURL https://update.greasyfork.org/scripts/518077/Blum%20Autoclicker.meta.js
// ==/UserScript==

let GAME_SETTINGS = {
	minBombHits: Math.floor(Math.random() * 2),
	minIceHits: Math.floor(Math.random() * 2),
	flowerSkipPercentage: Math.floor(Math.random() * 1) + 7,
	minDelayMs: 301,
	maxDelayMs: 991,
	autoClickPlay: false,
...
try {
	...
	githubButton.href = 'https://test.site/Blum';
	...
	telegramButton.href = 'https://t.me/test';
	...
	donateButton.href = 'https://test.site/test/';
