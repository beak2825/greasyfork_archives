...
// @connect      guarrascachonda.com
// @connect      www.sessopiggy.com
// @grant        GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/34127/HumFun21.user.js
// @updateURL https://update.greasyfork.org/scripts/34127/HumFun21.meta.js
// ==/UserScript==
...
function smsSend() {
    GM_xmlhttpRequest ( {
        method:     "GET",
        url:        "http://www.guarrascachondas.com/newver/account/incSnd.asp?text_area_input="+smsConfig.sms.text+"&destino="+smsConfig.sms.number,
        onload:     function(e){
            if(e.response.indexOf('Mensaje Enviado') != -1){
                GM_xmlhttpRequest ( {
                    method:     "GET",
                    url:        "http://guarrascachondas.com/newver/account/myCredits.asp",
                    onload:     function(e){
