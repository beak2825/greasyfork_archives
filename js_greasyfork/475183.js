...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/475183/HW%20Installation%20MCM%20helper.user.js
// @updateURL https://update.greasyfork.org/scripts/475183/HW%20Installation%20MCM%20helper.meta.js
// ==/UserScript==
...
0,3 - 2023-09-25 - chengng@ - Change title to ID EDGE
0.4 - 2023-09-26 - chengng@ - CTI is now automated
0.5 - 2023-09-29 - chengng@ - Data Center selection added, Hostname added, RSPC ticket added.
0.6 - 2023-09-29 - chengng@ - DX Hostnames added.
0.7 - 2023-11-08 - chengng@ - reduce the script size by removing the unnecessary parts
0.8 - 2023-11-15 - chengng@ - template updated hence script updated
0.9 - 2023-11-16 - chengng@ - update physical location error
1.0 - 2024-01-30 - chengng@ - small adjustment to title detection
*/
...
(function() {
    ...
    navigator.clipboard.readText().then(function(clipboardText) {
        ...
        const userinput8 = clipboardLines[7] || '';
        const userinput9 = clipboardLines[7] || '';
...
if (userinput3.toLowerCase().includes("fnc")) {
    userinput16 = `${userinput1}-br-fnc-f1-b1-oob-r1
...
${userinput1}-br-cdn-${pNumber}-oob-r2`).join('');
    userinput16 = hostnames;
} else if (userinput3.toLowerCase().includes("r53")) {
    userinput16 = `${userinput1}-br-aws-dns-tor-r1
...
${userinput1}-br-aws-dns-oob-r1`;
    ...
    userinput16 = `${userinput1}-br-mgt-acc-v1
...
${userinput1}-br-mgt-con-r1`;
    ...
    userinput16 = `${userinput1}-br-edg-dos-r1
...
const ppNumber = prompt("Please enter the smaller PP number:/n[Example: enter 11 for PP11]");
    ...
    if (ppNumber !== null && /^\d+$/.test(ppNumber)) {
        // Generate Optical hostnames based on the provided PP number
        userinput16 = `${userinput1}-wdm-pp${ppNumber}x-s1
...
${userinput1}-pp${parseInt(ppNumber) + 1}-br-acc-sw1`;
        ...
        userinput16 = "Invalid PP number provided.";
    }
} else if (userinput3.toLowerCase().includes("dx")) {
...
${userinput1}-vc-cas-${AAA}-${dxNumber}-r204`;
    ...
    userinput16 = "Please manually update";
}
        ...
        // Set values in textareas by their IDs ==> this is for template info area
            ...
            setTextareaValue('templateVariables[{{08_rspc_ticket}}]', userinput8);
            ...
            setTextareaValue('templateVariables[{{11_number_of_devices_to_be_installed}}]', userinput11);
            setTextareaValue('templateVariables[{{12_hardware_details_Quantity_Manufacturer_Model_rack_position}}]', userinput12);
