...
// @description MobileStoneage autobot script
...
// @downloadURL https://update.greasyfork.org/scripts/6125/MobileStoneage%20autobot.user.js
// @updateURL https://update.greasyfork.org/scripts/6125/MobileStoneage%20autobot.meta.js
// ==/UserScript==
...
var mobcodes = {
	...
	searchCodes: function() {
		...
		$jq('.broadcast p').each(function(){
			mobcodes.parseAllycode($jq(this).text()); //
		});
		$jq('.comment p').each(function(){
			mobcodes.parseAllycode($jq(this).text()); //
		});
