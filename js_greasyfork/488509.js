...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/488509/EASL%20basket.user.js
// @updateURL https://update.greasyfork.org/scripts/488509/EASL%20basket.meta.js
// ==/UserScript==
...
(function() {
    ...
    setInterval(function() {
        ...
        let personalFoulsIndex = titles.indexOf('Personal Fouls');
        let isHome = true;
        ...
        for (let i = 4; i < lastRowTds.length && i - 4 < titles.length; i++) {
            ...
            if (titles[i - 4] === 'Personal Fouls') {
                isHome = false;
            }

            if (titles[i - 4] !== 'Efficiency' && titles[i - 4] !== 'Plus Minus') {
                table1.innerHTML += `
                    <tr>
