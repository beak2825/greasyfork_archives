...
// @description		翻译选定文本 基于http://userscripts-mirror.org/scripts/show/150664  https://greasyfork.org/scripts/662/
// @namespace       https://greasyfork.org/zh-CN/scripts/6659
// @version 		2015.6.25
...
// @grant			GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/6659/Google%20Translator%20Tooltip%20Expanded.user.js
// @updateURL https://update.greasyfork.org/scripts/6659/Google%20Translator%20Tooltip%20Expanded.meta.js
// ==/UserScript==
...
function showLookupIcon(evt) {
	...
	divLookup = createElement('div', {
		id: 'divLookup',
		style: 'background-color:transparent; color:#000000; position:absolute; top:' + (evt.clientY + window.pageYOffset + 16) + 'px; left:' + (evt.clientX + window.pageXOffset + 16) + 'px; padding:0px; z-index:10000; border-radius:2px;'
	});
...
function addTextToSpeachLink(element, lang, text) {
	...
	speachLink.innerHTML = '<img src="data:image/png;base64," height="16" width="16"/>';
...
function openCloseOptions(evt) {
	...
	if (!divOptions) //显示选项
	{
		...
		try {
			...
			window.colorPicker.setHex(GM_getValue('backgroundColor', '#FCF9A2'));
