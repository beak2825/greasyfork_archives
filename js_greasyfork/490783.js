...
// @downloadURL https://update.greasyfork.org/scripts/490783/%D0%94%D0%BB%D1%8F%20%D0%92%D0%B5%D1%80%D1%82%D0%B5%D0%BB%D0%BA%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/490783/%D0%94%D0%BB%D1%8F%20%D0%92%D0%B5%D1%80%D1%82%D0%B5%D0%BB%D0%BA%D0%B0.meta.js
// ==/UserScript==
...
(function () {
     ...
     },
    {
    ...
    },
     {
        ...
        content:
        '[CENTER]Доброго времени суток, уважаемый(ая) {{ user.mention }}.<br><br>' +
        '[CENTER]Вы нарушили правило пункта 2.28 общих правил проекта. [SPOILER="2.28"][COLOR=rgb(255, 0, 0)]2.28.[/COLOR] Запрещена покупка/продажа внутриигровой валюты в любых ее проявлениях за реальные деньги | [COLOR=rgb(255, 0, 0)]PermBan с обнулением аккаунта + ЧС проекта[/COLOR][/SPOILER][/CENTER] <br>' +
        '[CENTER]Нарушений со стороны [COLOR=rgb(255, 69, 0)]Технического Специалиста[/COLOR] не обнаружено.[/CENTER]<br>' +
    ...
    },
    {
        ...
        '[CENTER] Впредь попросим больше не нарушать правила проекта, иначе — второго шанса дано не будет. Искренне надеемся, что Вы сделали правильные выводы.[/CENTER]<br>' +
        '[CENTER] Настоятельно рекомендую ознакомиться с правилами проекта![/CENTER]<br>' +
