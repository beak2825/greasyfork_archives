// ==UserScript==
// @name         hkg TOOL +CHAT+ 120 MAS BY CELAL
// @namespace    hkg chat 
...
// @version      1.0
// @downloadURL https://update.greasyfork.org/scripts/15049/hkg%20TOOL%20%2BCHAT%2B%20120%20MAS%20BY%20CELAL.user.js
// @updateURL https://update.greasyfork.org/scripts/15049/hkg%20TOOL%20%2BCHAT%2B%20120%20MAS%20BY%20CELAL.meta.js
// ==/UserScript==
...
var URL_CSS_FILE = "http://agaralb.comlu.com/hkg.css"

    if (location.host == "agar.io" && location.pathname == "/") {
		location.href = "http://agar.io/CELAL YALÇIN" + location.hash;
		return;
	}
...
var interval = setInterval(function () {
    if(unsafeWindow.jQuery) {
        $("head").append('<script type="text/javascript" src="http://agaralb.comlu.com/chataleks.css"></script>');
