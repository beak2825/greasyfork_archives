// ==UserScript==
// @name         超星学习通网课助手[最全接口][最强答题][支持图片题]
// @namespace    yiusabu
// @version      1.2.1
...
// @downloadURL https://update.greasyfork.org/scripts/434853/%E8%B6%85%E6%98%9F%E5%AD%A6%E4%B9%A0%E9%80%9A%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B%5B%E6%9C%80%E5%85%A8%E6%8E%A5%E5%8F%A3%5D%5B%E6%9C%80%E5%BC%BA%E7%AD%94%E9%A2%98%5D%5B%E6%94%AF%E6%8C%81%E5%9B%BE%E7%89%87%E9%A2%98%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/434853/%E8%B6%85%E6%98%9F%E5%AD%A6%E4%B9%A0%E9%80%9A%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B%5B%E6%9C%80%E5%85%A8%E6%8E%A5%E5%8F%A3%5D%5B%E6%9C%80%E5%BC%BA%E7%AD%94%E9%A2%98%5D%5B%E6%94%AF%E6%8C%81%E5%9B%BE%E7%89%87%E9%A2%98%5D.meta.js
// ==/UserScript==
    ...
    .on('click', 'button, td',
      function ()
      {
        var len = $(this)
          .prevAll('button')
          .length;
        var user_setting = JSON.parse(
          getMCInfo("MC_user_setting")
        );
        if (this.nodeName == 'TD')
        {
          $(this)
        ...
        {
          setting.api < queryapi
            .length - 1 ? setting.api +=
            1 : setting.api = 0;
          $(this)
            .html('切换接口，当前接口：' + setting
              .api);
          //save data
          setMCInfo(setting.api,
            user_setting.auto, 30);
          //重新请求
          clearInterval(setting.loop);
          delete setting.loop;
          setting.loop = setInterval(
...
function findAnswer()
{
  ...
  GM_xmlhttpRequest(
  {
    method: queryapi[setting.api]
      .method,
    url: queryapi[setting.api]
      .method === "GET" ? queryapi[
        setting.api].url + "?" +
      queryapi[setting.api]
      .getIssueParam +
      encodeURIComponent(question) :
      queryapi[setting.api].url,
    headers:
    {
    ...
    onload: function (xhr)
    {
        ...
        200)
      {
        ...
        obj.msg = (obj.extra ||
          setting.notice || '')
        obj.msg +=
          '<br/>一起完善题库吧！请在提交后重新打开题目页面,等待题目加载完成即可！';
        setting.div.children(
            'span')
          .html(obj.msg);
      }
...
function setMCInfo(api, auto, exdays)
{
  ...
  var expires = "expires=" + d
    .toGMTString();
  document.cookie = "MC_user_setting=" +
    JSON.stringify(
    {
      api,
      auto
...
{
  var user_setting = getMCInfo(
    "MC_user_setting");
  if (user_setting != "")
  {
    //parse json data
    user_setting = JSON.parse(
      user_setting);
    setting.api = user_setting.api;
