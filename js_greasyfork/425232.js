// ==UserScript==
// @name         Xhamster Middle Click Search v.2
// @namespace    https://greasyfork.org/fr/users/7434-janvier56
// @version      2.0.1
// @description  Middle clicking the search on Xhamster search icon opens the results in a new tab.  (fork of "Youtube Middle Click Search" by Adrien Pyke)
...
// @license      unlicense
// @grant        GM_openInTab
// @downloadURL https://update.greasyfork.org/scripts/425232/Xhamster%20Middle%20Click%20Search%20v2.user.js
// @updateURL https://update.greasyfork.org/scripts/425232/Xhamster%20Middle%20Click%20Search%20v2.meta.js
// ==/UserScript==
...
// XHAM
        const input = Util.q('input.search-text').value.trim();
        if (!input) return false;

//        const url = `${location.origin}/results?search_query=${Util.encodeURIWithPlus(input)}`;
// XHAM
        const url = `${location.origin}/search/${Util.encodeURIWithPlus(input)}`;
        if (e.button === 1) {
