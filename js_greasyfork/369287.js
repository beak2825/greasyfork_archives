// ==UserScript==
// @id             alt-photo-expander@masprivilegiado
// @name           ALT Photo Expander
// @version        1.4.1
...
// @run-at         document-end
// @downloadURL https://update.greasyfork.org/scripts/369287/ALT%20Photo%20Expander.user.js
// @updateURL https://update.greasyfork.org/scripts/369287/ALT%20Photo%20Expander.meta.js
// ==/UserScript==
...
function AddJQuery(callback)
{
    ...
    var jqNode  = document.querySelector("#sindriAddedJQ");
    if (jqNode)
    {
...
//    {
//	console.log("jQuery not yet available");
//	window.setTimeout(WaitOnJQuery, 1000);
//    } else {
//	$ = unsafeWindow.jQuery;
//	//jQuery.noConflict();
//	Main();
...
function Main($)
{
	...
	var icon = $('<IMG id="affpe_icon" alt="Photo Expander Configuration" width="48" height="48" />');
