// ==UserScript==
// @name         IOGARBOTS.COM | FOR SALE BOTS!
// @namespace    IOGARBOTS.COM
// @version      9.0.1
// @description  Best Agar.io & Agario clones games bots and Facebook Mass Bots, VIP Bots For Sale!
// @icon         https://agma.io/img/store/minions/minions_store.png
// @discord      https://discord.gg/rgabcsN
// @match       *.senpa.io/*
// @match       *.balz.io/*
// @match       *.popsplit.us/*
// @match       *.xgar.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/381769/IOGARBOTSCOM%20%7C%20FOR%20SALE%20BOTS%21.user.js
// @updateURL https://update.greasyfork.org/scripts/381769/IOGARBOTSCOM%20%7C%20FOR%20SALE%20BOTS%21.meta.js
// ==/UserScript==
...
setTimeout(function() {
   ...
   $( "#canvas" ).after( "<div style='position: absolute; top: 20px; left: 5px; color: #000; font-family: Ubuntu; width: 240px; height: 140px; background-image: radial-gradient(ellipse at center, rgba(255,255,255,1) 0%, rgba(184,184,184,0.4) 100%); padding: 20px; '><center> <span style='border-radius: 25px; background-color: #00000; padding: 5px 70px; color: #fff; top 20px; font-size: 17px; width: 200px; -webkit-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); -moz-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); box-shadow: 0px 0px 28px -5px rgba(0,0,0,1);'>BUY BOTS: IOGARBOTS.COM</span><br><br> <span style='padding: 5px; color: #00000;'>Bots Online: </span><span id='minionCount' style='border-radius: 25px; background-color: #f1c40f; padding: 5px 12px; color: #fff; top 20px; font-size: 17px; width: 200px; -webkit-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); -moz-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); box-shadow: 0px 0px 28px -5px rgba(0,0,0,1);'>0</span><br><br> <span style='padding: 5px; color: #2c3e50;'>Position: </span><span id='gh45nmvsy' style='border-radius: 25px; background-color: #f1c40f; padding: 5px 12px; color: #fff; top 20px; font-size: 17px; width: 200px; -webkit-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); -moz-box-shadow: 0px 0px 28px -5px rgba(0,0,0,1); box-shadow: 0px 0px 28px -5px rgba(0,0,0,1);'>0,0</span></center> <div id='dfdghehfj' style='display: none;'> </div> <div id='ismoveToMouse' style='display: none;'> </div><br><br> </div>" );
