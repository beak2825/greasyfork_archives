...
// @connect        s.ytimg.com
// @version        2.44
// @downloadURL https://update.greasyfork.org/scripts/452979/YouTube%20Links.user.js
// @updateURL https://update.greasyfork.org/scripts/452979/YouTube%20Links.meta.js
// ==/UserScript==
  ...
  function addCopyHandler(node) {
    forEach(dom.gT(node, "a"), function(idx, elm) {
      dom.addEvent(elm, "click", function(evt) {
        ...
        GM_download({
          url: dom.attr(me, "href")+"&__ref="+loc.href,
          name: "["+res+"]"+dom.attr(me, "download"),
          saveAs: true,
          onerror: function() {
