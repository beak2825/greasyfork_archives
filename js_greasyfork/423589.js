// ==UserScript==
// @name         查看B站用户高清头像 Bilibili High-Res Avatar Viewer 
...
// @downloadURL https://update.greasyfork.org/scripts/423589/%E6%9F%A5%E7%9C%8BB%E7%AB%99%E7%94%A8%E6%88%B7%E9%AB%98%E6%B8%85%E5%A4%B4%E5%83%8F%20Bilibili%20High-Res%20Avatar%20Viewer.user.js
// @updateURL https://update.greasyfork.org/scripts/423589/%E6%9F%A5%E7%9C%8BB%E7%AB%99%E7%94%A8%E6%88%B7%E9%AB%98%E6%B8%85%E5%A4%B4%E5%83%8F%20Bilibili%20High-Res%20Avatar%20Viewer.meta.js
// ==/UserScript==

(function() {
    'use strict';

    function addViewAvatarButton() {
        const avatarElement = document.querySelector('.avatar img');
        const insertLocation = document.querySelector('.upinfo-detail__top');

        if (!avatarElement || !insertLocation) {
            setTimeout(addViewAvatarButton, 1000);
            return;
        }

        const button = document.createElement('a');
        button.textContent = '查看高清头像';
        button.href = '#';
        ...
        button.addEventListener('click', function(e) {
            e.preventDefault();
            const imgSrc = avatarElement.src;
            const highResSrc = imgSrc.split('@')[0];
