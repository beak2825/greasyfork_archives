// ==UserScript==
// @id            https://greasyfork.org/scripts/43/Greasy Fork (Firefox)@greasespot.net
// @name          Greasy Fork (Firefox)
// @version       1.1.5
...
// @icon          https://mediacru.sh/sUzVT489XUfu.png
// @icon64URL     https://mediacru.sh/sUzVT489XUfu.png
// @run-at        document-end
// @grant         GM_setValue
// @grant         GM_getValue
// @grant         GM_addStyle
// @grant         GM_setClipboard
// @downloadURL https://update.greasyfork.org/scripts/389539/Greasy%20Fork%20%28Firefox%29.user.js
// @updateURL https://update.greasyfork.org/scripts/389539/Greasy%20Fork%20%28Firefox%29.meta.js
// ==/UserScript==

var gf_1 = '#',gf_2 = 'Name',gf_3 = 'Description',gf_4 = 'Author',gf_5 = 'Daily',gf_6 = 'Total',gf_7 = 'Created',gf_8 = 'Updated',gf_9 = 'Options',gf_10 = 'Greasy Fork Options',gf_11 = 'Install',gf_12 = 'Scripts per page (max 200)';
var gf_13 = 'Sort list on page open by',gf_14 = 'Theme (select &quot;Default&quot; if using a custom theme)',gf_15 = 'Name/Description cells tooltips',gf_16 = 'Author&apos;s script count';
var gf_17 = 'Highlight All Created/Updated cells (select days ago &amp; prior)',gf_18 = 'Create a link',gf_19 = 'Styles',gf_20 = 'Label',gf_21 = '&quot;Help&quot; Link',gf_22 = '&quot;Post a new script&quot; Link',gf_23 = 'Url';
var gf_24 = 'Filter by text in Name/Author',gf_25 = 'Case-sensitive',gf_26 = '',gf_27 = 'Options / Filtered \u2006';
...
var gf_34 = 'Size/Position filtered list popup:',gf_35 = 'Right-click to save prefs to clipboard',gf_36 = 'Size/Position filtered list popup in Options',gf_37 = 'Left-click for Options',gf_38 = 'English List only';
var gf_39 = 'Middle or Ctrl + Left-click to show/hide filtered list popup',gf_40 = 'Filter Ideograms';
...
#devtools-wrapper .dialog input[type="text"],#devtools-wrapper input[type="password"],#devtools-wrapper textarea,#devtools-wrapper select{-moz-appearance:none!important;-webkit-appearance:none!important;box-sizing:border-box!important;-webkit-box-sizing:border-box!important;background:#444!important;border:1px solid transparent!important;box-sizing:border-box!important;-webkit-box-sizing:border-box!important;color:#FFF!important;}\
...
#devtools-wrapper .dialog a:visited{color:#74198b!important;}\
		  ...
		  'default': {
			  css: '\
#devtools-wrapper .dialog{border-radius:10px!important;-webkit-border-radius:10px!important;box-shadow:0 0 50px #000!important;-webkit-box-shadow:0 0 50px #000!important;background-color:#eee !important;margin-bottom:5px!important;margin-top:5px!important;padding:4px!important;position:relative!important;}\
...
#devtools-wrapper .dialog .dialog-title{border-radius:5px!important;-webkit-border-radius:5px!important;background-color:#444!important;color:#eee!important;height:15px!important;padding:4px 0 7px 0!important;text-align:center!important}\
...
#devtools-wrapper .dialog .dialog-footer button:hover{background:linear-gradient(#222,#555)!important;background:-webkit-linear-gradient(#222,#555)!important;}\
#devtools-wrapper .dialog hr{background-color:#ddd!important;margin:7px 0 7px 0!important;}\
#devtools-wrapper .dialog fieldset{border-radius:4px!important;-webkit-border-radius:4px!important;border:1px solid #aaa!important}\
#devtools-wrapper .dialog label{-moz-box-align:center!important;-webkit-box-align:center!important;display:block!important;font-weight:bold!important;}\
...
#devtools-wrapper .dialog input[type="text"],#devtools-wrapper input[type="password"],#devtools-wrapper textarea,#devtools-wrapper select{border-radius:4px!important;-webkit-border-radius:4px!important;background:#444!important;border:1px solid transparent!important;color:#FFF!important}\
...
#devtools-wrapper .dialog .progress-bar{border-radius:5px!important;-webkit-border-radius:5px!important;background-color:#fafafa!important;border:1px solid #ddd!important}\
#devtools-wrapper .dialog .progress-bar-inner{border-radius:5px!important;-webkit-border-radius:5px!important;background-color:#444!important}\
...
ASUVORK5CYII%3D'
  ...
  devtools.config.init({
    title: gf_10,
    settings: {
      'perpage': { type: 'text', label: gf_12, defaultValue: '200' },
      'sort': { type: 'radio', label: gf_13, options: { 'Daily': '4', 'Total': '5', 'Created': '6', 'Updated': '7' }, defaultValue: '7' },
      'theme': { type: 'radio', label: gf_14, options: { 'Blue': '1', 'Brown': '2', 'Default': '3' }, defaultValue: '3' },
      ...
      'count': { type: 'checkbox', label: gf_16, defaultValue: false },
      ...
      'link1': { type: 'text', label: gf_23, defaultValue: 'http://forum.userstyles.org' },
      'create2': { type: 'checkbox', label: gf_18, defaultValue: false },
      'label2': { type: 'text', label: gf_20, defaultValue: 'Link 2' },
      'link2': { type: 'text', label: gf_23, defaultValue: 'http://userstyles.org' },
      ...
      'listwidth': { type: 'text', label: gf_30, defaultValue: '600px' },
      'listheight': { type: 'text', label: gf_31, defaultValue: '200px' },
      'listleft': { type: 'text', label: gf_32, defaultValue: '0px' },
      'listtop': { type: 'text', label: gf_33, defaultValue: '134px' },
      'custom': { type: 'checkbox', label: gf_28, defaultValue: false },
      'sitelink1': { type: 'text', label: '', defaultValue: gf_29 },
      'sitelink2': { type: 'text', label: '', defaultValue: gf_29 },
      'sitelink3': { type: 'text', label: '', defaultValue: gf_29 },
      'sitelink4': { type: 'text', label: '', defaultValue: gf_29 }
    },
...
#devtools-wrapper .dialog > .dialog-content input[type=radio]:first-child + span {position: relative !important; top: -2px !important}\
#devtools-wrapper .dialog > .dialog-content > label > input {margin-left: 6px !important; padding: 0 2px !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(1) {margin: 0 0 6px 0 !important; text-align: right !important; width: 51% !important}\
...
#devtools-wrapper .dialog > .dialog-content > div:nth-child(2) {margin-right: 10px !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(4) span {margin-right: 20px !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(5), #devtools-wrapper .dialog > .dialog-content > div:nth-child(6), \
#devtools-wrapper .dialog > .dialog-content > div:nth-child(7), #devtools-wrapper .dialog > .dialog-content > div:nth-child(8) {display: inline-block !important; margin-right: 21px !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(9), #devtools-wrapper .dialog > .dialog-content > div:nth-child(12) {display: inline-block !important; margin-top: 4px !important; width: 15% !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(10) > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(13) > input {width: 12% !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(10), #devtools-wrapper .dialog > .dialog-content > label:nth-child(11), \
#devtools-wrapper .dialog > .dialog-content > label:nth-child(13), #devtools-wrapper .dialog > .dialog-content > label:nth-child(14) {display: inline !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(11), #devtools-wrapper .dialog > .dialog-content > label:nth-child(14) {margin-left: 11px !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(11) > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(14) > input {width: 60% !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(15), #devtools-wrapper .dialog > .dialog-content > div:nth-child(16), #devtools-wrapper .dialog > .dialog-content > div:nth-child(17),\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(18), #devtools-wrapper .dialog > .dialog-content > div:nth-child(19) {display: inline-block !important; }\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(15), #devtools-wrapper .dialog > .dialog-content > div:nth-child(16), #devtools-wrapper .dialog > .dialog-content > div:nth-child(17), \
#devtools-wrapper .dialog > .dialog-content > div:nth-child(18), #devtools-wrapper .dialog > .dialog-content > div:nth-child(19) {border-top: 1px solid #AAA !important; margin-top: 2px !important; padding-top: 8px !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(15) {width: 28% !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(16) {width: 18% !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(17) {width: 18% !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(18) {width: 17% !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(19) {width: 16% !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(20) > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(21) > input,\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(22) > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(23) > input {border-radius: 0 !important; -webkit-border-radius: 0 !important; margin: 0 !important; width: 100% !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(20) > input {border-radius: 4px 4px 0 0 !important; -webkit-border-radius: 4px 4px 0 0 !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(23) {margin-bottom: 6px !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(23) > input {border-radius: 0 0 4px 4px !important; -webkit-border-radius: 0 0 4px 4px !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(24), #devtools-wrapper .dialog > .dialog-content > label:nth-child(25), #devtools-wrapper .dialog > .dialog-content > label:nth-child(26), \
#devtools-wrapper .dialog > .dialog-content > label:nth-child(27), #devtools-wrapper .dialog > .dialog-content > label:nth-child(28) {display: inline !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(25), #devtools-wrapper .dialog > .dialog-content > label:nth-child(26) {margin-left: 10px !important; text-align: center !important; width: 50px !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(27), #devtools-wrapper .dialog > .dialog-content > label:nth-child(28) {margin-left: 10px !important; text-align: center !important; width: 50px !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(25) > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(26) > input {text-align: center !important; width: 50px !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(27) > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(28) > input {text-align: center !important; width: 50px !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(29) {border-top: 1px solid #AAA !important; margin-top: 6px !important; padding-top: 8px !important}\
#devtools-wrapper .dialog > .dialog-content > div:nth-child(29) > label {text-align: center !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(30) > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(31) > input, \
#devtools-wrapper .dialog > .dialog-content > label:nth-child(32) > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(33) > input {border-radius: 0 !important; -webkit-border-radius: 0 !important; margin: 0 !important; width: 100% !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(30) > input {border-radius: 4px 4px 0 0 !important; -webkit-border-radius: 4px 4px 0 0 !important}\
#devtools-wrapper .dialog > .dialog-content > label:nth-child(33) > input {border-radius: 0 0 4px 4px !important; -webkit-border-radius: 0 0 4px 4px !important}\
#devtools-wrapper .dialog > .dialog-footer > button > img {margin: 1px 5px 0 0 !important; vertical-align: top !important}\
#devtools-wrapper .dialog > .dialog-content > label > input, #devtools-wrapper .dialog > .dialog-content > label:nth-child(24) {margin-top: -3px !important}\
...
#devtools-wrapper .dialog > .dialog-footer > button:hover {background: tan !important; border: 1px solid #444 !important; color: #000 !important}\
  ...
  function getFilterList() {
    if (filter) {
      ...
      if (!ideogram && !english) {
        var listdiv = $c('textarea', {id:'listBox', innerHTML:filterlist ? '\u2022 ' + filterlist.replace(/,/g, ' \u2022 ') : '', spellcheck:false});
    } }
    if (!filter) {
      if (ideogram && !english) {
        var ide = '\u2611 ideogram';
  ...
  var scriptID = 'https://greasyfork.org/scripts/43/Greasy Fork@greasespot.net', scriptVER = '1.1.2';
  ...
  var listleft = devtools.config.get('listleft'), listtop = devtools.config.get('listtop'), custom = devtools.config.get('custom'), sitelink1 = devtools.config.get('sitelink1'), sitelink2 = devtools.config.get('sitelink2');
  var sitelink3 = devtools.config.get('sitelink3'), sitelink4 = devtools.config.get('sitelink4'), sitelink = sitelink1.concat(sitelink2,sitelink3,sitelink4), filtertt = devtools.config.get('filtertt');
  var english = devtools.config.get('english'), ideogram = devtools.config.get('ideogram');
  var url = window.location.href.toLowerCase(), aUrl = url.split('?')[0];
...
#site-name > p, #script-list-sort { display: none; }\
...
#main-header nav > .user-profile-link { margin: 0 8px !important; padding: 0 !important; }\
#main-header .user-profile-link { margin-right: 8px !important; }\
#main-header #create-link1, #main-header #create-link2 { cursor: pointer !important; }\
#main-header #create-link1 { margin: 0 10px 0 0 !important; }\
#main-header #create-link2 { margin: 0 12px 0 0 !important; }\
#OptFil {border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 3px; -webkit-border-radius: 3px !important; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset, 2px 2px 3px rgba(0, 0, 0, 0.5); -webkit-box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset, 2px 2px 3px rgba(0, 0, 0, 0.5); font-size: 100%; font-weight: bold; }\
#OptFil { background: #4F738E; padding: 2px 3px; text-shadow: 1px 1px 2px #000; }\
...
#script-list-filter span.script-list-current { margin: 0 8px 0 6px !important; }\
input[type="submit"][value="Post new version"] { margin: 0 0 4px 10px; width: 120px; }\
#listBox { background: linear-gradient(#EEE, #AAA); background: -webkit-linear-gradient(#EEE, #AAA); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 3px; -webkit-border-radius: 3px !important; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset, 2px 2px 2px rgba(0, 0, 0, 0.5); -webkit-box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset, 2px 2px 2px rgba(0, 0, 0, 0.5); }\
#listBox { height: '+ listheight + '; width: '+ listwidth +'; font-size: 16px; top: '+ listtop +'; left: '+ listleft +'; padding: 4px; position: fixed; z-index: 1003; }\
#script-search { margin-bottom: 10px !important; margin-right: 12px !important; }\
#moderator-actions { -moz-user-select: none !important; color: #FFF !important; position: fixed !important; right: 224px !important; top: 6px !important; }\
...
#main-header { -moz-user-select: none !important; position: fixed !important; height: 62px !important; top: 0 !important; width: 100% !important; }\
#main-header h1 { font-size: 48px !important; margin: 0px 0 0 4px !important; }\
#site-name  p.subtitle { display: none !important; }\
#main-header nav { float: right !important; margin: 0 20px 0 0 !important; }\
#main-header nav > li { cursor: pointer !important; text-decoration: underline !important; }\
#main-header nav > li > a { text-decoration: underline !important; }\
#main-header nav > .scripts-index-link { margin: 0 0 0 12px !important; }\
#main-header nav > .help-link { margin: 0 4px 0 12px !important; }\
#main-header nav > p { float: left !important; margin: 0 4px 0 0 !important; }\
#main-header #sort-name:hover * { color: #FFF !important; }\
#main-header #sortLabel { text-decoration: underline !important; }\
...
#site-name img, #script-list-sort { display: none !important; }\
#script-list-filter { -moz-user-select: none !important; color: #CCC !important; left: 306px !important; position: fixed !important; top: 0px !important; }\
#script-list-filter span.script-list-current { color: #FFF !important; text-shadow: 1px 1px 2px #000; }\
#script-list-filter a { color: #CCC !important; }\
#script-list-filter a:hover { color: #FFF !important; }\
#script-list-filter { background: none !important; }\
#script-list-filter *:not(a) { display: inline !important; }\
#OptFil { background: linear-gradient(rgba(225, 0, 0, .7), rgba(225, 0, 0, .5)) !important; background: -webkit-linear-gradient(rgba(225, 0, 0, .7), rgba(225, 0, 0, .5)) !important; }\
#OptFil:hover { background: linear-gradient(rgba(255, 0, 0, .9), rgba(255, 0, 0, .9)) !important; background: -webkit-linear-gradient(rgba(255, 0, 0, .9), rgba(255, 0, 0, .9)) !important; }\
#moderator-actions li, input[type="submit"][value="Post script"], .preview-button, input[type="submit"][value="Post new version"], #install-area > .install-link, #script-links li a, .install-help-link, .pagination > a, .pagination span, #main-header #gf-option, input[name="q"], input[type="submit"] { background: linear-gradient(rgba(255, 255, 255, .75), rgba(255, 255, 255, .5)) !important; background: -webkit-linear-gradient(rgba(255, 255, 255, .75), rgba(255, 255, 255, .5)) !important; border: 1px solid rgba(255, 255, 255, 0.1) !important; border-radius: 3px !important; -webkit-border-radius: 3px !important; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset, 2px 2px 2px rgba(0, 0, 0, 0.5) !important; color: #000 !important; margin: 0 1px !important; padding: 2px 6px !important; text-decoration: none !important; }\
.pagination > a, .pagination span { padding: 0 6px !important; }\
.pagination { cursor: default !important; left: 305px !important; position: fixed !important; top: 38px !important; }\
.pagination .previous_page, .pagination .next_page, .pagination .current, .pagination span, #gf-option:hover { color: #000 !important; }\
...
.pagination .current { color: #FFF !important; font-weight: bold !important; margin: 0 4px !important; }\
#moderator-actions li:hover, input[type="submit"][value="Post script"]:hover, .preview-button:hover, input[type="submit"][value="Post new version"]:hover, #install-area > .install-link:hover, #script-links li:not(.current) a:hover, .install-help-link:hover, .pagination > a:not(.disabled):hover, .pagination span:not(.disabled):hover, #main-header #gf-option:hover, input[name="q"]:hover, input[name="q"]:focus, input[type="submit"]:hover { background: #FFF !important; }\
...
//#by-site-list { -moz-column-count: 4 !important; margin: 50px 0 16px 8px !important; padding-left: 4px !important; }\
//#by-site-list li { display: -moz-box !important; }\
#by-site-list li, #by-site-list a { color: #000 !important; text-decoration: none !important; }\
#by-site-list a:hover { text-decoration: underline !important; }\
#install-area > .install-link { border-radius: 10px !important; -webkit-border-radius: 10px !important; padding: 12px !important; }\
...
#script-table > tr > th { background: rgba(0,0,0,.1) !important; border-radius: 0 0 8px 8px !important; -webkit-border-radius: 0 0 8px 8px !important}\
...
#script-table > tr > th:not(#header2):hover { border-radius: 0 0 8px 8px !important; -webkit-border-radius: 0 0 8px 8px !important; box-shadow: none !important; -webkit-box-shadow: none !important; color: #FFF !important; }\
#script-table > tr > #header2 { background: transparent !important; border-radius: 0 !important; -webkit-border-radius: 0 !important; box-shadow: none !important; -webkit-box-shadow: none !important; }\
#script-table > tr > .header { cursor: pointer !important; padding: 0 8px !important; text-align: center !important; }\
#script-table > tr > #header0 { padding-left: 4px !important; text-align: right !important; }\
#script-table > tr > #header1 { padding-left: 8px !important; }\
...
#script-table > tr > td:nth-child(1) { text-align: right !important; width: 30px !important; padding: 0 0 0 4px !important; }\
#script-table > tr > td:nth-child(2) { max-width: 250px !important; overflow: hidden !important; padding-left: 8px !important; text-align: left !important; text-overflow: ellipsis !important; white-space: nowrap !important; }\
#script-table > tr > td:nth-child(3) { max-width: 400px !important; overflow: hidden !important; text-align: left !important; text-overflow: ellipsis !important; white-space: nowrap !important; }\
#script-table > tr > td:nth-child(4) { max-width: 140px !important; text-align: center !important; }\
#script-table > tr > td:nth-child(5) { text-align: center !important; width: 70px !important; }\
#script-table > tr > td:nth-child(6) { text-align: center !important; width: 70px !important; }\
#script-table > tr > td:nth-child(7) { text-align: center !important; width: 110px !important; }\
#script-table > tr > td:nth-child(8) { text-align: center !important; width: 110px !important; }\
#script-table > tr > td:nth-child(2) a:hover, #script-table tr > td:nth-child(4) a:hover { cursor: pointer !important; }\
#script-table > tr > td.recent { background: #4F738E !important; border-radius: 100% !important; -webkit-border-radius: 100% !important; }\
...
//#script-table > tr { display: -moz-box !important; }\
  ')

  if (onUserPage) {
    GM_addStyle('\
body h1 { visibility: collapse !important; }\
body > h2 { -moz-user-select: text !important; background: linear-gradient(rgba(255, 255, 255, .9), rgba(255, 255, 255, .6)) !important; background: -webkit-linear-gradient(rgba(255, 255, 255, .9), rgba(255, 255, 255, .6)) !important; border: 1px solid rgba(255, 255, 255, 0.1) !important; border-radius: 3px !important; -webkit-border-radius: 3px !important; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset !important; -webkit-box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset !important; color: #000 !important; cursor: default !important; font-size: 30px !important; left: 10px !important; padding: 2px 10px !important; position: fixed !important; text-shadow: 0 1px 0 #CCC !important; top: -11px !important; }\
header > h3 { display: none !important; }\
#user-control-panel { -moz-user-select: none !important; float: left !important; margin: 0 12px 4px 0 !important; }\
#user-control-panel > li { display: inline !important; }\
#user-control-panel > li > a { background: linear-gradient(rgba(255, 255, 255, .9), rgba(255, 255, 255, .6)) !important; background: -webkit-linear-gradient(rgba(255, 255, 255, .9), rgba(255, 255, 255, .6)) !important; border: 1px solid rgba(255, 255, 255, 0.1) !important; border-radius: 3px !important; -webkit-border-radius: 3px !important; box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset, 2px 2px 2px rgba(0, 0, 0, 0.5) !important; -webkit-box-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5) inset, 2px 2px 2px rgba(0, 0, 0, 0.5) !important; color: #000 !important; margin: 0 2px !important; padding: 0 6px !important; text-decoration: none !important; }\
#user-control-panel > li > a:hover { background: #FFF !important; color: #000 !important; }\
#user-control-panel > li > a[href="/users/sign_out"] { background: linear-gradient(rgba(245, 0, 0, .9), rgba(230, 0, 0, .5)) !important; background: -webkit-linear-gradient(rgba(245, 0, 0, .9), rgba(230, 0, 0, .5)) !important; border: 1px solid rgba(255, 255, 255, 0.1) !important; color: #FFF !important; text-shadow: 1px 1px 2px #000 !important; }\
#user-control-panel > li > a[href="/users/sign_out"]:hover { background: #F00 !important; }\
nav li { position: relative !important; top: 6px !important; }\
#script-table > tr > td:nth-child(4) { cursor: default !important; text-align: center !important; width: 70px; }\
#script-table > tr > td:nth-child(6) { text-align: center !important; width: 110px; }\
    ')
  }
	
  if (onMainPage && !onScriptPage) {
    GM_addStyle('\
body > p { margin-top: 70px !important; padding-left: 4px !important; }\
...
body > h3 { margin-left: 4px !important; }\
  ...
  if (onAuthorPage) {
    GM_addStyle('\
#script-links, #install-area { display: inline !important; }\
...
#install-area > br { display: none !important; }\
  ...
  if (onHelpPage) {
    GM_addStyle('\
body > ul { position: relative !important; top: 12px !important; }\
    ')
  }
...
#script-table > tr > th:not(#header2):not(.current) { background: linear-gradient(#0F4FA8, #E3F4FF) !important; background: -webkit-linear-gradient(#0F4FA8, #E3F4FF) !important; border: 1px solid #0F4FA8 !important; }\
...
#script-table > tr > th:not(#header2):not(.current) { background: linear-gradient(#555, #E1DAC9) !important; background: -webkit-linear-gradient(#555, #E1DAC9) !important; border: 1px solid #555 !important; }\
...
#script-table > tr > td:nth-child(2) a:hover, #script-table tr > td:nth-child(4) a:hover { color: #FFCC00 !important; text-shadow: 1px 1px 2px #000 !important; }\
  ...
  if (theme == '3') {
    GM_addStyle('\
//body { background: rgba(255, 0, 0, .3) !important; }\
#script-table > tr > th:not(#header2):not(.current) { background: linear-gradient(#670000, #FFF) !important; background: -webkit-linear-gradient(#670000, #FFF) !important; border: 1px solid #670000 !important; }\
...
#main-header nav > .help-link {display: none !important; }\
  ...
  if (url.match(/https:\/\/greasyfork\.org\/scripts\?/)) document.body.querySelector('a[href="/scripts"]').parentNode.style.display = 'none';
  ...
  //if (onSitePage) nav.insertBefore(bo.childNodes[13], nav.firstElementChild);
    ...
    var more2 = document.body.querySelector('a[href="/scripts/by-site"]');
		var more = document.body.querySelector('#OptFil');
    ...
    for (var i = 0; i < linkurl.length; i++) {
      ...
      var link = $c('a', {href:'/scripts/by-site/'+ nam +'?sort=updated', textContent:lab, title:nam});
      var sym = $c('text', {textContent:'\n | \n'});
      span.appendChild(link);
      span.appendChild(sym);
      slf.insertBefore(span, more);
			slf.insertBefore(more2, more);
  } }
		
  var cnt = scriptTable.querySelectorAll('tr[style="display: none;"]').length, lab = $c('text', {id:'filter-label', textContent:'\n | \n'});
