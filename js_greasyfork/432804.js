...
// @author       dashuo
// @match        https://opensea.io/collection/fatales
// @match        https://opensea.io/assets/fatales?*
// @match        https://opensea.io/collection/fatales?*
// @match        https://opensea.io/account
// @icon         https://www.google.com/s2/favicons?domain=opensea.io
// @grant        GM_getResourceText
// @resource DATALootRare https://raw.githubusercontent.com/a-dwarf/loot/main/fatales.json
...
// @downloadURL https://update.greasyfork.org/scripts/432804/fatales.user.js
// @updateURL https://update.greasyfork.org/scripts/432804/fatales.meta.js
// ==/UserScript==
...
function onwheelevent(event) {
    ...
    for (var i = 0; i < elements.length; i++) {
        ...
        var lootid = elements[i].innerText;
