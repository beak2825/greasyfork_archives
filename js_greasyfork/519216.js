...
// @downloadURL https://update.greasyfork.org/scripts/519216/%E5%AE%98%E7%A7%8D%E4%BF%9D%E7%A7%8D%E7%BB%9F%E8%AE%A1%E4%BF%AE%E6%94%B9%E7%89%88%E5%A2%9E%E5%8A%A0mv%E6%95%B0%E9%87%8F%E5%8A%A0%E6%88%90%E6%9F%A5%E7%9C%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/519216/%E5%AE%98%E7%A7%8D%E4%BF%9D%E7%A7%8D%E7%BB%9F%E8%AE%A1%E4%BF%AE%E6%94%B9%E7%89%88%E5%A2%9E%E5%8A%A0mv%E6%95%B0%E9%87%8F%E5%8A%A0%E6%88%90%E6%9F%A5%E7%9C%8B.meta.js
// ==/UserScript==
...
var parseSeedPage = (html, theConfig, seedColor, eleSeedList, eleTorItem, eleTorSize, eleTorSeedNum) => {
    ...
    for (var i = 0; i < torlist.length; i++) {
        ...
        if (true) {
            ...
            let torLink = $(element).find('a[href*="torrents.php"]').attr('href');
            let catValue = new URLSearchParams(torLink.split('?')[1]).get('cat');
            if (catValue === '413') {
                if (torSeederNum >= 5 && torSeederNum < 7) {
                    theConfig.groups[5].groupCount+= 0.4;
                    theConfig.groups[5].groupSize += torSize;
                }
                if (torSeederNum >= 3 && torSeederNum < 5) {
                    theConfig.groups[6].groupCount+= 0.6;
                    theConfig.groups[6].groupSize += torSize;
                }
                if (torSeederNum >= 0 && torSeederNum < 3) {
                    theConfig.groups[7].groupCount++;
                    theConfig.groups[7].groupSize += torSize;
                }
                theConfig.groups[8].groupSize = theConfig.groups[7].groupSize + theConfig.groups[6].groupSize + theConfig.groups[5].groupSize;
                theConfig.groups[8].groupCount = theConfig.groups[7].groupCount + theConfig.groups[6].groupCount  + theConfig.groups[5].groupCount;
            }
