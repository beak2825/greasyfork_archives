// ==UserScript==
// @name         BLACK | Скрипт для Кураторов Форума by J.Murphy (LightYellow)
...
// @downloadURL https://update.greasyfork.org/scripts/534566/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20JMurphy%20%28LightYellow%29.user.js
// @updateURL https://update.greasyfork.org/scripts/534566/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20JMurphy%20%28LightYellow%29.meta.js
// ==/UserScript==
...
const TEX_PREFIX = 13; // Префикс "Техническому специалисту"
    ...
    "[HEADING=3][CENTER][I][COLOR=rgb(250,235,215)][FONT=georgia][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов[/SIZE][/FONT][/COLOR][/I][/CENTER][/HEADING]" +
      "[CENTER][IMG width=695px]https://i.postimg.cc/nVj6Zm9v/112-20250428005036.png[/IMG]"+
            "[HEADING=3][CENTER][I][COLOR=rgb(250,235,215)][FONT=georgia][SIZE=4][COLOR=rgb(255, 222, 173)] 2.19. [/COLOR] Запрещен DB (DriveBy) — намеренное убийство / нанесение урона без веской IC причины на любом виде транспорта [COLOR=rgb(255, 222, 173)] | Jail 60 минут [/SIZE][/FONT][/COLOR][/I][/CENTER][/HEADING]" +
                  "[CENTER][IMG width=695px]https://i.postimg.cc/nVj6Zm9v/112-20250428005036.png[/IMG]"+
    ...
    },
{
    ...
    "[HEADING=3][CENTER][I][COLOR=rgb(250,235,215)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
      "[CENTER][IMG width=695px]https://i.postimg.cc/nVj6Zm9v/112-20250428005036.png[/IMG]"+
    "[HEADING=3][CENTER][I][COLOR=rgb(250,235,215)][FONT=georgia][SIZE=4]Ваша жалоба переадресована Главному Куратору Форума [/SIZE][/FONT][/COLOR][/I][/CENTER][/HEADING]" +
      "[CENTER][IMG width=695px]https://i.postimg.cc/nVj6Zm9v/112-20250428005036.png[/IMG]"+
             "[HEADING=3][CENTER][I][COLOR=rgb(250,235,215)][FONT=georgia][SIZE=4][COLOR=rgb(255, 222, 173)]Примечание:[/COLOR] Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.  [/SIZE][/FONT][/COLOR][/I][/CENTER][/HEADING]" +
              "[CENTER][IMG width=695px]https://i.postimg.cc/nVj6Zm9v/112-20250428005036.png[/IMG]"+
    "[HEADING=3][CENTER][COLOR=rgb(255, 228, 181)][I][B][FONT=georgia][SIZE=4]Ожидайте ответа[/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
...

{
    ...
    "[HEADING=3][CENTER][I][COLOR=rgb(250,235,215)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]" +
      "[CENTER][IMG width=695px]https://i.postimg.cc/nVj6Zm9v/112-20250428005036.png[/IMG]"+
    "[HEADING=3][CENTER][I][COLOR=rgb(250,235,215)][FONT=georgia][SIZE=4] Ошиблись сервером, переношу на нужный. [/SIZE][/FONT][/COLOR][/I][/CENTER][/HEADING]" +
      "[CENTER][IMG width=695px]https://i.postimg.cc/nVj6Zm9v/112-20250428005036.png[/IMG]"+
             "[HEADING=3][CENTER][I][COLOR=rgb(250,235,215)][FONT=georgia][SIZE=4][COLOR=rgb(255, 222, 173)]Примечание:[/COLOR] Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.  [/SIZE][/FONT][/COLOR][/I][/CENTER][/HEADING]" +
              "[CENTER][IMG width=695px]https://i.postimg.cc/nVj6Zm9v/112-20250428005036.png[/IMG]"+
    "[HEADING=3][CENTER][COLOR=rgb(255, 228, 181)][I][B][FONT=georgia][SIZE=4]На рассмотрении[/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
               prefix: UNACCEPT_PREFIX,
        status: false,
        },
 {
