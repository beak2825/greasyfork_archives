...
// @downloadURL https://update.greasyfork.org/scripts/3228/CrowdSource%3A%2055%20keywords.user.js
// @updateURL https://update.greasyfork.org/scripts/3228/CrowdSource%3A%2055%20keywords.meta.js
// ==/UserScript==
        ...
        function() {
            ...
            $(this).append(
                $("<button></button>", {
                    ...
                    var googleOrigin = (domain.match(/.*bing.*/) ? "http://www.google.com".format(domain) : "http://www.google.com".format(domain));
