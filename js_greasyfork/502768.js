// ==UserScript==
// @name         Jack Role Play  Скрипт by M.Extra
// @description  Для Кураторов Форума
// @namespace    http://forum.wh17701.web3.maze-host.ru/
// @version      1.4.1
// @author       Malfoy_Extra
// @match        http://forum.wh17701.web3.maze-host.ru/*
// @include      http://forum.wh17701.web3.maze-host.ru/
// @grant        none
// @license      MIT
// @icon https://icons.iconarchive.com/icons/thesquid.ink/free-flat-sample/128/support-icon.png
// @downloadURL https://update.greasyfork.org/scripts/502768/Jack%20Role%20Play%20%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20MExtra.user.js
// @updateURL https://update.greasyfork.org/scripts/502768/Jack%20Role%20Play%20%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20MExtra.meta.js
// ==/UserScript==
...
'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
    ...
    {
     title: '---------------------------------------------Пункты передачи by E.Yurievich---------------------------------------------',
    },
    {
...
'[B][CENTER][COLOR=red][ICODE]Передано ГА[/ICODE][/COLOR][/CENTER][/B]',
    ...
    {
     title: '-----------------------------------------------------БЕЗ ОПР. ПУНКТА by E.Yurievich-----------------------------------------------------',
     },
     {
      title: 'Не по форме',
      content:
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FRb3z3Xw/RLwzo.png[/img][/url]<br>' +
'[CENTER][COLOR=violet][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[CENTER][B][I]Ваша жалоба отказана, т.к. прошло более 72 часов с момента нарушения игрока.[/B][/CENTER]<br><br>' +
'[CENTER]"[url=https://postimages.org/][img]https://i.postimg.cc/MKb4gMwJ/2023-08-20-174519042.png[/img][/url]<br>'+
'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
          status: false,
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FRb3z3Xw/RLwzo.png[/img][/url]<br>' +
'[CENTER][COLOR=violet][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[CENTER][B][I]Ваша ссылка не кликабельна,либо же она не работает.[/B][/CENTER]<br><br>' +
'[CENTER]"[url=https://postimages.org/][img]https://i.postimg.cc/MKb4gMwJ/2023-08-20-174519042.png[/img][/url]<br>'+
'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
          status: false,
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FRb3z3Xw/RLwzo.png[/img][/url]<br>' +
'[CENTER][COLOR=violet][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[CENTER][B][I]Отсутствуют доказательства - следовательно, рассмотрению не подлежит. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее.[/B][/CENTER]<br><br>' +
'[CENTER]"[url=https://postimages.org/][img]https://i.postimg.cc/MKb4gMwJ/2023-08-20-174519042.png[/img][/url]<br>'+
'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
          status: false,
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FRb3z3Xw/RLwzo.png[/img][/url]<br>' +
'[CENTER][COLOR=violet][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[CENTER][B][I]Ваша жалоба отказана, т.к. она написана от 3-его лица.[/B][/CENTER]<br><br>' +
'[CENTER]"[url=https://postimages.org/][img]https://i.postimg.cc/MKb4gMwJ/2023-08-20-174519042.png[/img][/url]<br>'+
'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
          status: false,
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FRb3z3Xw/RLwzo.png[/img][/url]<br>' +
'[CENTER][COLOR=violet][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[CENTER][B][I]Ваша видеозапись обрывается. Загрузите полную видеозапись на видео-хостинг YouTube.[/B][/CENTER]<br><br>' +
'[CENTER]"[url=https://postimages.org/][img]https://i.postimg.cc/MKb4gMwJ/2023-08-20-174519042.png[/img][/url]<br>'+
'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
          status: false,
...
'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
    ...
    {
     title: '----------------------------------------Основные правила игры by E.Yurievich----------------------------------------',
    },
    {
...
'[CENTER][COLOR=violet][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[CENTER]<br>[I]Игроку будет выдано следующее наказание за нарушение данного пункта правил:[/I]<br><br>' +
'[COLOR=rgb(255, 0, 0)]2.02.[/COLOR][COLOR=rgb(209, 213, 216)] Запещено целенаправленно уходить от Role Play процесса всеразличными способами. [COLOR=rgb(255, 0, 0)]| Jail 30 минут / Warn[/COLOR][COLOR=rgb(209, 213, 216)]<br><br>' +
'[COLOR=rgb(209, 213, 216)][I] Ваша Жалоба получает статус: <br><br>' +
'[CENTER]"[url=https://postimages.org/][img]https://i.postimg.cc/MKb4gMwJ/2023-08-20-174519042.png[/img][/url]<br>'+
'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
...
'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
    ...
    {
     title: '----------------------------------------Игровой чат by E.Yurievich----------------------------------------',
    },
    {
...
'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
    ...
    {
     title: '-----------------------------------------------------Правила ГОСС by E.Yurievich-----------------------------------------------------',
    },
    {
	  title: 'нРП ГОСС',
	  content:
