...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/500548/KOSTROMA%20%7C%20%D0%97%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1%20by%20LKiar.user.js
// @updateURL https://update.greasyfork.org/scripts/500548/KOSTROMA%20%7C%20%D0%97%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1%20by%20LKiar.meta.js
// ==/UserScript==
    ...
    const buttons = [
        ...
        `Игровой уровень не менее 10-го. <br>`+
         ...
         `   Форма подачи заявления:[/FONT][/SIZE].<br><br>`+
          ...
          `  1. В анкетах всегда поощряется полное описание всего! Больше интересной информации могли вы представить -9 Вас как личность! Заявки(анкеты), это тоже один из важнейших этапов прохождения на пост лидерства, отнеситесь к этому очень серьезно!<br>`+
  ...
  `Никто из состава администрации не будет просить у вас все различные пароли, пин-коды, информация о привязках и так далее. Не ведитесь на обманы!`,
...

        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br>` +
                ...
                `С уважением,ЗГС ГОСС - General_Makarov .<br>` +
...

        {
            ...
            content: `[SIZE=4][color=red][FONT=georgia][CENTER]${greeting}, уважаемые игроки![/CENTER]<br>` +
...

        {
            ...
            content: `[SIZE=4][COLOR=red][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER][/COLOR]<br>` +
                `[color=yellow] Запрошиваю доказательства у заместителя.<br><br>` +
                `Пожалуйста ожидайте ответа.<br>` +
                `С уважением,[/color][COLOR=blue] ЗГС ГОСС -General_Makarov .[/color]<br>` +
                `[COLOR=orange]На рассмотрение.[/color] [/CENTER][/FONT][/SIZE]`,
            prefix: PIN_PREFIX,
