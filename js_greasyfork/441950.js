...
// @version          2.5.8
// @description    scdxjjwljytools
// @author       shenhua
// @match      *://*.chaoxing.com/*
// @icon         data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==
// @require      http://cdn.bootcss.com/jquery/1.8.3/jquery.min.js
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/441950/SCDXJJWLJY.user.js
// @updateURL https://update.greasyfork.org/scripts/441950/SCDXJJWLJY.meta.js
// ==/UserScript==
 ...
 */
                ...
                if(opD!=undefined){
                   if(opD.text().split("D")[1]!=undefined){
                    ...
                    if(len==1){
                        if(opA!=undefined){
                            if(opA.text().split("A")[1]!=undefined){//.replace(/(^\s*)|(\s*$)/g, "")
                                if(srhdaan.indexOf(opA.text().split("A")[1].replace(/\s*/g,""))!=-1&&srhdaan==opA.text().split("A")[1].replace(/\s*/g,"")){
                                if(opA.attr("class")!="Hover"){
                                    opA.children().eq(0).children().click();
                                }
                            }}}
                    if(opB!=undefined){
                        if(opB.text().split("B")[1]!=undefined){
                            if(srhdaan.indexOf(opB.text().split("B")[1].replace(/\s*/g,""))!=-1&&srhdaan==opB.text().split("B")[1].replace(/\s*/g,"")){
                                if(opB.attr("class")!="Hover"){
                                    opB.children().eq(0).children().click();
                                }
                            }}}
                    if(opC!=undefined){
                        if(opC.text().split("C")[1]!=undefined){
                            if(srhdaan.indexOf(opC.text().split("C")[1].replace(/\s*/g,""))!=-1&&srhdaan==opC.text().split("C")[1].replace(/\s*/g,"")){
                                if(opC.attr("class")!="Hover"){
                                    opC.children().eq(0).children().click();
                                }
                            }}}
                    if(opD!=undefined){
                        if(opD.text().split("D")[1]!=undefined){
                            if(srhdaan.indexOf(opD.text().split("D")[1].replace(/\s*/g,""))!=-1&&srhdaan==opD.text().split("D")[1].replace(/\s*/g,"")){
                                if(opD.attr("class")!="Hover"){
                                    opD.children().eq(0).children().click();
                                }
                            }}}
                    if(opE!=undefined){
                        if(opE.text().split("E")[1]!=undefined){
                            if(srhdaan.indexOf(opE.text().split("E")[1].replace(/\s*/g,""))!=-1&&srhdaan==opE.text().split("E")[1].replace(/\s*/g,"")){
                                if(opE.attr("class")!="Hover"){
                                    opE.children().eq(0).children().click();
                                }
                            }}}
                    ...
                    if(opC!=undefined){
                        if(opC.text().split("C")[1]!=undefined){
                            if(("C"+srhdaan.split("#")[4])==opC.text().replace(/\s*/g,"")||("C"+srhdaan.split("#")[3])==opC.text().replace(/\s*/g,"")||("C"+srhdaan.split("#")[2])==opC.text().replace(/\s*/g,"")||("C"+srhdaan.split("#")[1])==opC.text().replace(/\s*/g,"")||("C"+srhdaan.split("#")[0])==opC.text().replace(/\s*/g,"")||srhdaan.split("#")[0]==opC.text().split("C")[1].replace(/\s*/g,"")||srhdaan.split("#")[1]==opC.text().split("C")[1].replace(/\s*/g,"")||srhdaan.split("#")[2]==opC.text().split("C")[1].replace(/\s*/g,"")||srhdaan.split("#")[3]==opC.text().split("C")[1].replace(/\s*/g,"")||srhdaan.split("#")[4]==opC.text().split("C")[1].replace(/\s*/g,"")){
                                if(opC.attr("class")!="Hover"){
                                    opC.children().eq(0).children().click();
                                }
                            }}}
     ...
     var sub;
     var menu = $(".ZyTop").text();
     var domenu = $(".CeYan").children().eq(1).text();
     var subject = $(".headerwrap").text().replace(/\s*/g,"");
    if(subject.indexOf("英语")!=-1){
     ...
     $(".TiMu").each(function(i){
           ...
           if(len==4){
                ...
                console.log("网页选项：\n"+option);
                if($(".TiMu").eq(i).children().eq(2).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=undefined && $(".TiMu").eq(i).children().eq(2).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=""){
                   das = $(".TiMu").eq(i).children().eq(2).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "");
                }else{
                   das = $(".TiMu").eq(i).children().eq(2).text().split("我的答案：")[1].split("得分：")[0].replace(/(^\s*)|(\s*$)/g, "");
                }
               //das = $(".TiMu").eq(i).children().eq(2).text().split("正确答案：")[1].split("我的答案：")[0].replace(/(^\s*)|(\s*$)/g, "");
                console.log("检验本题结果======"+$(".TiMu").eq(i).children().eq(2).text().split("得分：")[1].split("分")[0].replace(/(^\s*)|(\s*$)/g, ""));
                ln = das.length;//ABD
                if(ln==1){
               ...
               if($(".TiMu").eq(i).children().eq(2).text().split("得分：")[1].split("分")[0].replace(/(^\s*)|(\s*$)/g, "")=="0.0"){
                   if($(".TiMu").eq(i).children().eq(2).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=undefined && $(".TiMu").eq(i).children().eq(2).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=""){
                       console.log("网页答案："+ da+"\n\r----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                       search(timu.replace(pattern, ""),da.replace(pattern, ""));
                   }else{
                       console.log("网页答案为非正确答案不录："+ da+"\n\r----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                   }
               }else{
                console.log("网页答案："+ da+"\n\r----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                search(timu.replace(pattern, ""),da.replace(pattern, ""));
               ...
               if($(".TiMu").eq(i).children().eq(2).text().split("得分：")[1].split("分")[0].replace(/(^\s*)|(\s*$)/g, "")=="0.0"){
                ...
                if($(".TiMu").eq(i).children().eq(1).text().split("我的答案：")[1]!=undefined){
                    console.log("网页选项：\n"+option);
                    timu = (TiMu + opA.replace(/(^\s*)|(\s*$)/g, "")+opB.replace(/(^\s*)|(\s*$)/g, "")).replace(/(^\s*)|(\s*$)/g, "");
                    if($(".TiMu").eq(i).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=undefined && $(".TiMu").eq(i).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=""){
                         das = $(".TiMu").eq(i).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "");
                    }else{
                         das = $(".TiMu").eq(i).children().eq(1).text().split("我的答案：")[1].split("得分：")[0].replace(/(^\s*)|(\s*$)/g, "");
                    }
                    console.log("检验本题结果======"+$(".TiMu").eq(i).children().eq(1).text().split("得分：")[1].split("分")[0].replace(/(^\s*)|(\s*$)/g, ""));
                    if(das=="√"){
                        da = "正确";
                    }else if(das=="×"){
                        da = "错误";
                    }
                    if($(".TiMu").eq(i).children().eq(1).text().split("得分：")[1].split("分")[0].replace(/(^\s*)|(\s*$)/g, "")=="0.0"){
                       if($(".TiMu").eq(i).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=undefined && $(".TiMu").eq(i).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=""){
                            search(timu.replace(pattern, ""),da.replace(pattern, ""));
                           console.log("网页答案："+da+"\n\r----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                       }else{
                      ...
                      var lenmin =  $(".readCompreHensionItem").length;
                       $(".readCompreHensionItem").each(function(n){
                           ...
                           if($(".readCompreHensionItem").eq(n).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=undefined && $(".readCompreHensionItem").eq(n).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=""){
                              das = $(".readCompreHensionItem").eq(n).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "");
                           }else{
                               das = $(".readCompreHensionItem").eq(n).children().eq(1).text().split("我的答案：")[1].split("得分：")[0].replace(/(^\s*)|(\s*$)/g, "");
                           }
                           console.log("检验本题结果======"+$(".readCompreHensionItem").eq(n).children().eq(1).text().split("得分：")[1].split("分")[0].replace(/(^\s*)|(\s*$)/g, ""));
                           if(das=="√"){
                               da = "正确";
                           }else if(das=="×"){
                               da = "错误";
                           }
                           if($(".readCompreHensionItem").eq(n).children().eq(1).text().split("得分：")[1].split("分")[0].replace(/(^\s*)|(\s*$)/g, "")=="0.0"){
                               if($(".readCompreHensionItem").eq(n).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=undefined && $(".readCompreHensionItem").eq(n).children().eq(1).text().split("我的答案：")[0].split("正确答案：")[1].replace(/(^\s*)|(\s*$)/g, "")!=""){
                                  search(timu.replace(pattern, ""),da.replace(pattern, ""));
                                  console.log("网页答案："+da+"\n\r----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                               }else{
     ...
     console.log("WARING：当前位于录题界面！");
     $(".TiMu").each(function(i){
           TiMu = $(".TiMu").eq(i).children().eq(0).children().eq(1).text().replace(/\s*/g,"");
           len = $(".TiMu").eq(i).children().eq(1).children('li').length;
           console.log("网页题目："+ TiMu);
           if(len==4){
                opA = $(".TiMu").eq(i).children().eq(1).children().eq(0);
                ...
                console.log("网页选项：\n"+option);
                if($(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1]!=undefined && $(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1]!=""){
                    das = $(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1];
                }else{
                    das = $(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("我的答案：")[1].split("得分：")[0];
                }
               console.log("检验本题结果======"+$(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("得分：")[1].split("分")[0]);
                ln = das.length;//ABD
                if(ln==1){
                        if(opA.text().indexOf(das)!=-1){
                         ...
                         if(das.indexOf(opA.text().replace(/\s*/g,"").split("、")[0])!=-1){
                              da1 = opA.text().replace(/\s*/g,"").split("A、")[1] + "#";
                         }else{
                              da1 = ""
                         }
                         if(das.indexOf(opB.text().replace(/\s*/g,"").split("、")[0])!=-1){
                              da2 = opB.text().replace(/\s*/g,"").split("B、")[1] + "#";
                         }else{
                              da2 = ""
                         }
                         if(das.indexOf(opC.text().replace(/\s*/g,"").split("、")[0])!=-1){
                              da3 = opC.text().replace(/\s*/g,"").split("C、")[1] + "#";
                         }else{
                              da3 = ""
                         }
                         if(das.indexOf(opD.text().replace(/\s*/g,"").split("、")[0])!=-1){
                              da4 = opD.text().replace(/\s*/g,"").split("D、")[1] + "#";
                         }else{
                              da4 = ""
                         }
                         da = da1 + da2 + da3 + da4;
                         da = da.substring(0,da.length-1).replace(/\s*/g,"");
                }
                 timu = (TiMu + option).replace(/\s*/g,"");
               if($(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("得分：")[1].split("分")[0]=="0.0"){
                   if($(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1]!=undefined && $(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1]!=""){
                       console.log("网页答案："+ da+"\n\r----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                       search(timu,da);
                   }else{
               ...
               console.log("检验本题结果======"+$(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("得分：")[1].split("分")[0]);
                ...
                if(ln==1){
                        if(opA.text().indexOf(das)!=-1){
                              ...
                              da = opE.text().replace(/\s*/g,"").split("E、")[1];
                        }
                }else{
                         if(das.indexOf(opA.text().replace(/\s*/g,"").split("、")[0])!=-1){
                              da1 = opA.text().replace(/\s*/g,"").split("A、")[1] + "#";
                         ...
                         if(das.indexOf(opE.text().replace(/\s*/g,"").split("、")[0])!=-1){
                              da5 = opE.text().replace(/\s*/g,"").split("E、")[1] + "#";
                         }else{
                              da5 = ""
                         }
                         da = da1 + da2 + da3 + da4 + da5;
               ...
               if($(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("得分：")[1].split("分")[0]=="0.0"){
                ...
                opA = "A、正确";
                opB = "B、错误";
                option = opA.replace(/\s*/g,"")+"\n"+opB.replace(/\s*/g,"")+"\n";
                console.log("网页选项：\n"+option);
                if($(".TiMu").eq(i).children().eq(1).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1]!=undefined && $(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1]!=""){
                    das = $(".TiMu").eq(i).children().eq(1).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1];
                }else{
                    das = $(".TiMu").eq(i).children().eq(1).text().replace(/\s*/g,"").split("我的答案：")[1].split("得分：")[0];
                }
               console.log("检验本题结果======"+$(".TiMu").eq(i).children().eq(1).text().replace(/\s*/g,"").split("得分：")[1].split("分")[0]);
                if(das=="√"){
                    da = "正确";
                }else if(das=="×"){
                    da = "错误";
                ...
                timu = (TiMu + option).replace(/\s*/g,"");
                if($(".TiMu").eq(i).children().eq(1).text().replace(/\s*/g,"").split("得分：")[1].split("分")[0]=="0.0"){
                    if($(".TiMu").eq(i).children().eq(1).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1]!=undefined && $(".TiMu").eq(i).children().eq(2).text().replace(/\s*/g,"").split("我的答案：")[0].split("正确答案：")[1]!=""){
                        console.log("网页答案："+da+"\n\r----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
                         //console.log("待录入题目："+ timu);
                        search(timu,da);
          ...
          $(".TiMu").each(function(i){
              ...
              if(len==4){
                  ...
                  option = opA.text().replace(/\s*/g,"")+"\n"+opB.text().replace(/\s*/g,"")+"\n";
                  console.log("网页选项：\n"+option);
                  timu = TiMu +"A、"+opA.text().split("A")[1].replace(/\s*/g,"")+"B、"+opB.text().replace(/\s*/g,"").split("B")[1];
                  doSearch(timu,opA,opB,opC,opD,opE,sub);
              }else if(len==5){
                  opA = $(".TiMu").eq(i).children().eq(1).children().eq(0).children().eq(0);
                  opB = $(".TiMu").eq(i).children().eq(1).children().eq(0).children().eq(1);
