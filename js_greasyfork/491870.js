// ==UserScript==
// @namespace        https://greasyfork.org/zh-CN/users/1283148-44%E5%B0%B144
// @name              轻松选择文本复制，无需登录
// @name:zh-TW           輕鬆選擇文字複製，無需登入
// @author            44944author
// @description       适用于大部分网站，可以不用登录即可复制文本，通过右键菜单选择文本复制、剪切
// @description:zh-TW 適用於大部分網站，可以不用登入即可複製文字，通過右鍵菜單選擇文字複製、剪切
// @supportURL         https://hui.leowu.online 
// @version           1.0.2
// @license     AGPL
// @match             *://*/*
...
// @downloadURL https://update.greasyfork.org/scripts/491870/%E8%BD%BB%E6%9D%BE%E9%80%89%E6%8B%A9%E6%96%87%E6%9C%AC%E5%A4%8D%E5%88%B6%EF%BC%8C%E6%97%A0%E9%9C%80%E7%99%BB%E5%BD%95.user.js
// @updateURL https://update.greasyfork.org/scripts/491870/%E8%BD%BB%E6%9D%BE%E9%80%89%E6%8B%A9%E6%96%87%E6%9C%AC%E5%A4%8D%E5%88%B6%EF%BC%8C%E6%97%A0%E9%9C%80%E7%99%BB%E5%BD%95.meta.js
// ==/UserScript==
(function() {
    'use strict';
 ...
 var hasFrame = false;
    ...
    var storageName = "fournineStorageName";
 ...
 function setBtnClick(){  
    ...
    GM_registerMenuCommand("开启复制 设置", setMenu)
    var userSetting = GM_getValue("rwl_userData");
 

    //添加按钮 func
    function addBtn(){
        var node = document.createElement("remove-web-limits-fournine");
        node.id = "rwl-fournine";
        ...
        node.innerHTML = '<lalala style="cursor:move; font-size:12px;">开启复制</lalala> <input type="checkbox" name="" id="black_node" >';
        ...
        node.addEventListener("mouseover",function(){
            node.classList.add("rwl-active-fournine");
        });
        node.addEventListener("mouseleave",function(){
            setTimeout(function(){
                node.classList.remove("rwl-active-fournine");
        ...
        var styleInner = "#rwl-fournine{" +
            ...
            "#rwl-fournine input{" +
                ...
                "cursor: pointer;" +
            "}" +
            "#rwl-fournine.rwl-active-fournine{" +
                "left: 0px;" +
        ...
        if(!rwl_userData.addBtn){
            var styleTemp = "#rwl-fournine{display:none}";
            style.innerHTML = styleInner + styleTemp;
        } else {
            style.innerHTML = styleInner;
        }
        if(document.querySelector("#rwl-fournine")){
            document.querySelector("#rwl-fournine").appendChild(style);
        } else {
    ...
    // 菜单
     function setMenu(){
            ...
            var innerH = "" +
                ...
                "<br>" +
                "<fourninebutton id='rwl-reset'>清空设置</fourninebutton> &nbsp;&nbsp;&nbsp;" +
                "<fourninebutton id='rwl-setMenuSave'>保存</fourninebutton> &nbsp;&nbsp;&nbsp;" +
                "<fourninebutton id='rwl-setMenuClose' onclick='this.parentNode.parentNode.removeChild(this.parentNode);' title='如果无法关闭 请刷新界面' >关闭</fourninebutton> &nbsp;&nbsp;&nbsp;" +
                ""
            "";
    ...
    // 增加拖动事件 func
    function dragBtn(){
        var rwl_node = document.querySelector("#rwl-fournine");
  ...
  // 鼠标点击后按钮后 检查是否在黑名单
    function black_check(bool){
        ...
        if (bool && !check) {
            ...
            rwl_userData.waitUpload.push(hostname); 
