...
// @downloadURL https://update.greasyfork.org/scripts/458250/Anapa%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/458250/Anapa%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
    ...
    },
    {
      ...
      content:
		'[Color=rgb(255, 128, 133)][FONT=verdana][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил: 2.01. Запрещено поведение, нарушающее нормы процессов Role Play режима игры | Jail 30 минут [/FONT][/I][/B][/CENTER] " +
                '[Color=rgb(250, 207, 210)][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER]Игрок будет наказан по данному пункту правил:<br><ins><b>2.02. Запрещено целенаправленно уходить от Role Play процесса всеразличными способами | Jail 30 минут / Warn[/CENTER]<br><b><ins>" +
                '[Color=rgb(250, 207, 210)][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][FONT=verdana][CENTER][I]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
	  ...
	  content:
		...
		'[Color=Red][FONT=verdana][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    },
    {
	...
	},
    {
      ...
      content:
		'[Color=rgb(255, 128, 133)][FONT=verdana][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=verdana][I]Заголовок вашей жалобы составлен не по форме. Убедительная просьба ознакомиться [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.885157/']с правилами подачи жалоб на игроков[/URL].[/CENTER]" +
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=Red][FONT=verdana][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
