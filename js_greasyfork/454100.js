...
// @license      GPL-3.0
// @downloadURL https://update.greasyfork.org/scripts/454100/mahjong-helper-majsoul.user.js
// @updateURL https://update.greasyfork.org/scripts/454100/mahjong-helper-majsoul.meta.js
// ==/UserScript==
...
(function () {
    'use strict';
    for (let i = 0; i < 5; i++) {
        console.log('%c [mahjong-helper-majsoul] 此脚本已停止更新!!!\n%c由于种种原因，通过油猴脚本转发至小助手的方式已被弃用，请使用基于mitmproxy的中间人攻击方式。\n该脚本代码已清空，请在脚本管理器中删除。\n新项目地址：https://github.com/Avenshy/mahjong-helper-majsoul-mitmproxy\n%c ' + i, 'color:red;background:yellow;font-size:20px;', 'color:red;background:white;font-size:10px;', 'font-size:0px;');
    }
    // Your code here...
})();
