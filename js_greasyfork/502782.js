...
// @downloadURL https://update.greasyfork.org/scripts/502782/YAKUTSK%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/502782/YAKUTSK%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B.meta.js
// ==/UserScript==
...
(async function () {
	...
	},
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  Aleksey_Bootman`+
        `[COLOR=rgb(251, 160, 38)]

        На рассмотрении. Приятной игры на сервере YAKUTSK[/COLOR][/CENTER]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
    // {
