...
// @downloadURL https://update.greasyfork.org/scripts/457400/UMMoodle%20enhancer.user.js
// @updateURL https://update.greasyfork.org/scripts/457400/UMMoodle%20enhancer.meta.js
// ==/UserScript==
'use strict';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  tgRoleBtn.onclick = function (event) {
    ...
    if (document.getElementsByClassName("meta role role-student").length > 0) { //already in student mode, return to regular role
      ...
      post('/course/switchrole.php', {
        id: courseID,
        switchrole: '5',
        returnurl: 'https://ummoodle.um.edu.mo/course/view.php?id=' + courseID,
        sesskey: sessionKey
      });
    }
  }
  ...
  chgRichBtn.onclick = function (event) {
    ...
    post('/user/editor.php', {
      id: userid,
      sesskey: sessionKey,
      _qf__user_edit_editor_form: '1',
      preference_htmleditor: 'tinymce'
    });
  ...
  chgTextBtn.onclick = function (event) {
    ...
    post('/user/editor.php', {
      ...
      sesskey: sessionKey,
      _qf__user_edit_editor_form: '1',
      preference_htmleditor: 'textarea'
    });
    var urlCoursePortal = 'https://ummoodle.um.edu.mo/course/view.php?id=' + courseID;
