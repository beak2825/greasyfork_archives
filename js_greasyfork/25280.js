...
// @copyright  2016, Nemo
// @namespace https://greasyfork.org/users/640
// @downloadURL https://update.greasyfork.org/scripts/25280/In-game%20profiles%20in%20the%20Smite%20Forums.user.js
// @updateURL https://update.greasyfork.org/scripts/25280/In-game%20profiles%20in%20the%20Smite%20Forums.meta.js
// ==/UserScript==

//var hirez_stats = "https://account.hirezstudios.com/smitegame/stats.aspx?player="; Very, very old
var hirez_stats = "https://www.smitegame.com/player-stats/?set_platform_preference=pc&player-name=";
...
if (location.pathname == "/member.php") {
    ...
    new_img.alt = "PC stats";
    new_img.title = "PC stats";
    ...
    new_a.appendChild(document.createTextNode(" PC stats"));
