...
// @downloadURL https://update.greasyfork.org/scripts/428214/%E3%80%90superman463%E4%B8%93%E7%94%A8-%E7%94%B5%E8%84%91%E6%89%8B%E6%9C%BA%E3%80%91VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/428214/%E3%80%90superman463%E4%B8%93%E7%94%A8-%E7%94%B5%E8%84%91%E6%89%8B%E6%9C%BA%E3%80%91VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
		...
		if ((self != top) || (document.title.match(/404\s*?Not\s*?Found/i) != null)) {
			...
			try {
				...
				function jxbvipobj() {
						...
						if (localStorage.getItem("httpsjk") != null) {
							...
							if (jxbpcobj) {
								if (objj.match(/bilibili\./)) {
									httpsjk = '1';
									localStorage.setItem("httpsjk", "1");
					...
					if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|qq|xiami|migu|ximalaya|app-echo|1ting|lrts|baidu|wbdy|u23c|web3v|9ku)\./)) {
						...
						if (objj.match(/(?:eggvod|eofelis)\./)) {
							...
							if (document.querySelector("body>div") == null) {} else {
						...
						if (obj.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|vku\.youku\.com\/live\/)/)) {
							...
							} else if (obj.match(/^https?:\/\/470\.web3v\.com\/\?0=s&1=/)) {
								cssobj('a[title*="初始"],a[title*="刷新"],o1,o2,o3,o4,o5,o6,o7,o8,o9,.po>span,.to,#qe');
								document.querySelector(".b").click(), document.querySelector("#qu").click();
							} else {}
							...
							if (obj.match(/^https?:\/\/zy\.aoxtv\.com\//)) {
								...
								titleobj('西瓜视频解析中');
							} else {} if (document.querySelector('body>div') != null) {
								pcspzdqpobj = setInterval(function() {
									if (document.querySelector('video')) {
								...
								if (document.querySelector("body").innerText.match(/"\s*?url\s*?"\s*?:\s*?"\s*?https?(?:%3A%2F%2F.+?%|:\\\/\\\/.+?\\\/)/img) != null) {
					...
					function jxbmmanzxobj() {
						...
						if (obj.match(/^https?:\/\/(?!.+?\.(?:og[gv]|m(?:p[34]|4a)|w(?:ebm|av)|flv)($|\?.+))(?:music\.163\.com\/|y\.music\.163\.com\/m\/(?:song|dj)\?id=|(?:(?:bd|www)\.)?kuwo\.cn\/|m\.kuwo\.cn\/newh5|www\.kugou\.com\/(?:song|mvweb)\/|m3ws\.kugou\.com\/(?:kgsong|mv)\/|m\.kugou\.com\/|(?:i\.)?y\.qq\.com\/|(?:www|h|m)\.xiami\.com\/|(?:m\.)?music\.migu\.cn\/|5sing\.kugou\.com\/|(?:www|m)\.ximalaya\.com\/|kg\.qq\.com\/node\/|www\.app-echo\.com\/|radio\.sky31\.com\/|www\.1ting\.com\/|(?:www|m)\.9ku\.com\/play\/|www\.lrts\.me\/playlist)/)) {
							if (objj.match(/music\.163\./)) {
								...
								btn.addEventListener('click', function() {
									...
									} else if (objj.match(/(?:kuwo|kugou|(?:y|kg)\.qq|xiami|migu|app-echo|radio\.sky31|lrts|9ku)\./)) {
										(function() {
											if (!document.querySelector("jxbyyxzjk")) {
												document.head.appendChild(document.createElement("jxbyyxzjk"));
												(function() {
						...
						(function() {
							...
							let aa = 1, bb = '<span><a1 style="display:none"></a1><a2 style="display:none">', cc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">', dd = '<span><a1 style="color:darkgreen">跳转</a1><a2 style="display:none">', ee = '<span><a1 style="color:darkgreen">小窗</a1><a2 style="display:none">', eee = '<span style="background-color:cyan"><a1 style="color:darkgreen">Json</a1><a2 style="display:none">', ff = '<span><a1 style="color:darkgreen">大窗</a1><a2 style="display:none">', ii = '<span style="background-color:hotpink"><a1 style="color:darkgreen"></a1><a2 style="display:none">', kk = '<span style="display:grid;background-color:aliceblue"><a1>自用</a1><a2 style="display:none">', jj = '<span style="background-color:darkorange"><a1 style="color:darkgreen"></a1><a2 style="display:none">', gg = '</a2><a3 style="color:#2196F3;zoom:0.8;font-weight:bold;">\u27bd</a3><a4>', hh = '</a2><a3 style="display:none"></a3><a4>', https = [{
								...
								name: ii + aa+++hh + "星驰",
								url: "https://www.dggzcw.com/@jiexi444444444/?url="
							}, {
								name: ii + aa+++hh + "星影",
								...
								name: ee + aa+++gg + "文笔",
								url: "http://470.web3v.com/?0=s&1=",
								vip: "强制弹小窗"
							}, {
								name: ee + aa+++gg + "人人",
								url: "http://www.idoki.xyz/dm/?url="
							}, {
								name: ee + aa+++gg + "大亨",
								...
								name: dd + aa+++gg + "历程",
								url: "https://jx.lache.me/ccds/api.php?url=",
								vip: "强制跳转"
							}, {
								name: ee + aa+++gg + "盒子",
								...
								name: dd + aa+++gg + "云栖",
								url: "https://api.jx.yh0523.cn/api/pgjx-1/api.php?url=",
								vip: "强制跳转"
							}, {
								name: ee + aa+++gg + "爱酷",
								...
								name: dd + aa+++gg + "对接",
								url: "https://jx.vodjx.top/m3u8/?url=",
								vip: "强制跳转"
							}, {
								name: dd + aa+++gg + "教案",
								url: "http://m3u8.tv.janan.net/json.php?url=",
								vip: "强制跳转"
							}, {
								name: dd + aa+++gg + "挚爱",
								url: "https://jx.cqzyw.net:8655/analysis/index/?uid=58&token=gmsuvyzGMQTWXZ2346&url=",
								vip: "强制跳转"
							}, {
								name: ff + aa+++gg + "狼云",
								...
								name: dd + aa+++gg + "浴霸",
								url: "https://jx.000180.top/180ds/api.php?url=",
								vip: "强制跳转"
							}, {
								name: ff + aa+++gg + "七年",
								url: "http://47.95.28.242/jx/mao/index.php?url=",
								vip: "强制弹大窗"
							}, {
								name: cc + aa+++gg + "闪电影视",
								vip: "闪电影视"
											...
											if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) {
												if (https[num].url != null || https[num].url != undefined) {
													if (https[num].title != null || https[num].title != undefined) {
														httpsvipli.title = '\u7279\u522b\u8bf4\u660e\uff1a\uff08' + https[num].title + '\uff09\u203b \u63a5\u53e3\u5730\u5740\uff1a\uff08' + https[num].url + '\uff09';
													}
													if (https[num].title == null || https[num].title == undefined) {
														httpsvipli.title = '\u63a5\u53e3\u5730\u5740\uff1a\uff08' + https[num].url + '\uff09';
													}
												}
												if (https[num].url == null || https[num].url == undefined) {
													if (https[num].title == null || https[num].title == undefined) {
													...
													try {
														...
														setTimeout(function() {
															if (document.querySelector(vip)) {
																if (jxb.match(new RegExp("^https:\/\/(?!.+?强制(?:弹[小大]窗|跳转))")) && !jxb.match(new RegExp("(?:布米米|视频选集|米侠|Youtube|闪电影视|麻花影视)"))) {
							...
							if (jxbpcobj) {
								...
								(function() {
									try {
										...
										let sjtzsjzdylwobj = /(?:人人|七年|蓝影|冰豆|师兄|麻瓜)/, sjqjpbzdylwobj = /(?:乐多|思古|历程|三二|17云|临时|丽江|云栖|云波|时光|锦云|说说|回响|夜空|星影|1717|8090|唯多|无名|墨鱼|哔哩|淘影|诺讯|大亨|小蒋|玩嗨|九八|恐龙|极速|刺客|七彩|音萌|恶灵|碟调|文笔|对接|教案|挚爱|浴霸|CKP|OK|Youtube|大师|解啦|酷点|一零|六六|盘古|和巴|星驰|云端|奇米|片库|狼云)/i, sjyyyzdypbobj = /(?:百度|月亮|看剧|玻璃|海绵|可乐|我爱|神马|酷看|七彩|久播|恶灵|吉塔|盖斯|思[云念]|蘑菇|迪奥|618G?|147|256|365|920|973|4080|黑云|九八|金桥)/i;
										for (let jxbqcsjjki = 0; jxbqcsjjki < jxbqcsjjk.length; jxbqcsjjki++) {
											...
											for (let jxbqcsjjkia = 0; jxbqcsjjkia < jxbqcsjjkmsa.length; jxbqcsjjkia++) {
												if (!localStorage.getItem("sjqbjkobj") == '1') {
													if (!jxbqcsjjk[jxbqcsjjki].innerText.match(sjtzsjzdylwobj) && jxbqcsjjkmsa[jxbqcsjjkia].innerText.match(/(?:搜索|跳转|[小大]窗|自用|Json)/)) {
														jxbqcsjjk[jxbqcsjjki].setAttribute('style', 'display:none!important')
													}
												} else {
													if (jxbqcsjjkmsa[jxbqcsjjkia].innerText.match(/(?:搜索|自用|Json)/i)) {
														jxbqcsjjk[jxbqcsjjki].setAttribute('style', 'display:none!important');
													}
										...
										if (pcliwaiobj && !objj.match('ixigua\.')) {
											(function() {
												try {
													...
													localStorage.setItem("httpsjk", createRandom2(1, document.querySelectorAll("ul#httpsvipul>li").length - 22, document.querySelectorAll("ul#httpsvipul>li").length - 10));
													setTimeout(function() {
														try {
															$("ul#httpsvipul>li>span").css("backgroundImage", "");
															document.querySelector("ul#httpsvipul>li:nth-child(" + localStorage.getItem("httpsjk") + ")>span").style.backgroundImage = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=)";
										...
										if (pcliwaiobj && !objj.match('ixigua\.')) {
											(function() {
												try {
													...
													localStorage.setItem("httpsjk", createRandom2(1, 4, document.querySelectorAll("ul#httpsvipul>li").length - 22));
													setTimeout(function() {
														try {
															$("ul#httpsvipul>li>span").css("backgroundImage", "");
															document.querySelector("ul#httpsvipul>li:nth-child(" + localStorage.getItem("httpsjk") + ")>span").style.backgroundImage = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=)";
