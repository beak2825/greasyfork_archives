...
// @match *://*.escnation.com/*
// @match *://*.www.escnation.com/*
// @downloadURL https://update.greasyfork.org/scripts/439057/ESC%20Nation%20Facelift%20%28Dark%29.user.js
// @updateURL https://update.greasyfork.org/scripts/439057/ESC%20Nation%20Facelift%20%28Dark%29.meta.js
// ==/UserScript==
...
if ((location.hostname === "escnation.com" || location.hostname.endsWith(".escnation.com")) || (location.hostname === "www.escnation.com" || location.hostname.endsWith(".www.escnation.com"))) {
		css += `
		/*::-webkit-scrollbar {
...
if (location.href.startsWith("http://www.escnation.com/mbnews/index.php?action=view") || location.href.startsWith("http://escnation.com/mbnews/index.php?action=view")) {
  ...
  ul li > span.tit:before, ul li > b:before { display: inline-block; content: "\\25B8"; margin-left: -11px; margin-right: -1px; color: #333; font-weight: bold; }
  ul li { padding-left: 6px; border-left: 3px #333 solid; }
  ul li:hover { border-left-color: #555; }
  ul li ul li:hover > span[title]:before, ul li:hover > span.tit:before, ul li ul li:hover > a > span.tit:before, ul li:hover > b:before, ul li ul li:hover > b:before { color: #555; }
  `;
}
...
if (location.href.startsWith("http://www.escnation.com/mbnews/mbrules.php") || location.href.startsWith("http://escnation.com/mbnews/mbrules.php")) {
		css += `
		body {
			background-image: none !important;
			background-color: #222 !important;
		}
		*[color=black] { color: #EEE !important; }
		`;
}
