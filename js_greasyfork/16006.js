// ==UserScript==
// @name        Reddit Overwrite Extended With List of Alternatives
// @namespace   Reddit
// @description This script is a modification of Reddit Overwrite with an extended exit message expressing dissatisfaction with reddit management and announcing a migration to a reddit alternative. It will overwrite your Reddit comment history. To use it, go to Reddit, log in, click on your username, then click on the comments tab, then click on the new OVERWRITE button. If you want to modify the message that is left over your comments, it is on line 88.
// @include     https://*.reddit.com/*
// @include     http://*.reddit.com/*
// @version     1.2.9
// @downloadURL https://update.greasyfork.org/scripts/16006/Reddit%20Overwrite%20Extended%20With%20List%20of%20Alternatives.user.js
// @updateURL https://update.greasyfork.org/scripts/16006/Reddit%20Overwrite%20Extended%20With%20List%20of%20Alternatives.meta.js
// ==/UserScript==
