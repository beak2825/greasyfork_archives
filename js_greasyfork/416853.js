...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/416853/JVChatPremium%20fix%20Fixed%20by%20Luffydev%20%21.user.js
// @updateURL https://update.greasyfork.org/scripts/416853/JVChatPremium%20fix%20Fixed%20by%20Luffydev%20%21.meta.js
// ==/UserScript==
...
function clearPage(document) {
	...
	document.querySelector('.layout__content').className = "layout__content";
	document.querySelector('.layout__content').style = "position: absolute !important;display: block !important;margin: 0 1px 0 187px !important;grid-row: none !important;grid-column: none !important;";
    ...
    if (configuration["night_mode"]) {
        document.querySelector('.layout__content').classList.add("jvchat-night-mode");
    }
...
function toggleNightModeOption(event) {
    ...
    saveConfig();
    document.querySelector('.layout__content').classList.toggle("jvchat-night-mode");
}
