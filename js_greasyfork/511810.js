...
// @namespace    https://forum.lite-crmp.ru/
// @version      1.2
...
// @match        https://forum.lite-crmp.ru/threads/*
// @include      https://forum.lite-crmp.ru/threads/
// @grant        none
// @license      MIT
// @icon https://freepngimg.com/thumb/eagle/20-eagle-black-siluet-png-image-download-thumb.png
// @downloadURL https://update.greasyfork.org/scripts/511810/%D0%9A%D0%A3%D0%A0%D0%90%D0%A2%D0%9E%D0%A0%D0%AB%20%D0%A4%D0%9E%D0%A0%D0%A3%D0%9C%D0%90.user.js
// @updateURL https://update.greasyfork.org/scripts/511810/%D0%9A%D0%A3%D0%A0%D0%90%D0%A2%D0%9E%D0%A0%D0%AB%20%D0%A4%D0%9E%D0%A0%D0%A3%D0%9C%D0%90.meta.js
// ==/UserScript==
(function() {
    'use strict';
...
const buttons = [
    ...
    },
    {
	  ...
	  content:
        ...
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ASTRAKHAN[/COLOR][/CENTER]",
	  prefix: PIN_PREFIX,
	  status: true
	},
    {
    ...
    },
    {
        ...
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ASTRAKHAN[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    },
    {
        ...
        "[FONT=trebuchet ms][SIZE=4]Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ASTRAKHAN[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    },
    {
        ...
        "[COLOR=rgb(255, 0, 0)]Отказано. Закрыто[/COLOR]<br><br>"+
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ASTRAKHAN[/COLOR][/SIZE][/FONT][/CENTER]<br><br>",
        prefix: UNACCEPT_PREFIX,
        status: false
    },
    {
    ...
    },
    {
        ...
        "Создайте новую RolePlay ситуацию руководствуясь правилами подачи - [URL='https://forum.blackrussia.online/index.php?threads/ASTRAKHAN-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BD%D0%B0%D0%BF%D0%B8%D1%81%D0%B0%D0%BD%D0%B8%D1%8F-roleplay-%D1%81%D0%B8%D1%82%D1%83%D0%B0%D1%86%D0%B8%D0%B8.3137988/']*ссылка*[/URL]<br><br>"+
        "[COLOR=rgb(255, 0, 0)]Отказано. Закрыто[/COLOR]<br><br>"+
        "Приятной игры на просторах [COLOR=rgb(0, 0, 0)]BLACK [/COLOR][COLOR=rgb(255, 0, 0)]RUSSIA [/COLOR][COLOR=rgb(255, 255, 255)]ASTRAKHAN[/COLOR][/SIZE][/FONT][/CENTER]",
        prefix: UNACCEPT_PREFIX,
        status: false
