// ==UserScript==
// @name              KeepChatGPT--平台修改版
// @description       支持上传文件对话；这是一个ChatGPT的畅聊与增强插件。开源免费。不仅能解决所有报错不再刷新，还有保持活跃、取消审计、克隆对话、净化首页、展示大屏、展示全屏、言无不尽、拦截跟踪、日新月异等多个高级功能。
// @version           14.94
// @author            akmibo
...
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/467378/KeepChatGPT--%E5%B9%B3%E5%8F%B0%E4%BF%AE%E6%94%B9%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/467378/KeepChatGPT--%E5%B9%B3%E5%8F%B0%E4%BF%AE%E6%94%B9%E7%89%88.meta.js
// ==/UserScript==
...
<br>· 如果你希望鼓励、激励作者投入更多的时间精力提升项目，欢迎各位支持和鼓励本项目`, `更多鼓励方式`, function(t) {
    ...
    const loadKCG = function() {
        ...
        ndivkcg._symbol1_innerHTML = `<img src='${icon}' />Keep${ndivkcg.id.slice(1,2).toUpperCase()}hatGPT by 平台修改版；点我设置`;
...
(function() {
    ...
    fileInput.style.bottom = '10%';
    fileInput.style.right = '20%';
    fileInput.style.width = '200px';
    fileInput.style.height = '50px';
    fileInput.title = "文本文件，不宜过大";
    ...
    fileInput.addEventListener('change', function(event) {
        ...
        reader.onload = function(e) {
            ...
            var vvs = document.getElementById("prompt-textarea").value
            document.getElementById("prompt-textarea").value = `${vvs} ${e.target.result}`;
...
// 获取<main>元素的显示文本
const mainText = getVisibleText(mainElement);
...
downloadLink.download = 'chatgpt.md';
