// // ==UserScript==
// @name         Скрипт для ГА/ЗГА/КА || IRKUTSK
// @namespace    https://forum.blackrussia.online
// @version      1.2
// @description  Скрипт для Руководства сервера
// @author       Denzel_Galkin
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @grant        none
// @license      MIT
// @icon         https://klike.net/uploads/posts/2021-12/1638345168_12.jpg
// @downloadURL https://update.greasyfork.org/scripts/457650/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D0%90%20%7C%7C%20IRKUTSK.user.js
// @updateURL https://update.greasyfork.org/scripts/457650/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D0%90%20%7C%7C%20IRKUTSK.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][FONT=georgia][I][B]Запрошу доказательства у данного Администратора[Color=Red]Ожидайте ответа.[/COLOR]. " +
        '[Color=Yellow][CENTER]Закрыто,на рассмотрении.[/color].<br> ' +
        "[CENTER] Приятной игры на [Color=Green]IRKUTSK [/I][/CENTER][/color][/FONT]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        "[CENTER] Приятной игры на [Color=Green]Novosibirsk [/I][/CENTER][/color][/FONT]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
    ...
    },
     {
      ...
      content:
        ...
        '[Color=Lime][CENTER]Одобрено, закрыто.[/CENTER][/color] <br>' +
        "[CENTER]Приятной игры на [Color=Green]Novosibirsk [/I][/CENTER][/color][/FONT][/B]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      title: 'Оск 3.07',
content:
     '[Color=rgb(148, 0, 211)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]' +
     "[CENTER]Нарушитель будет наказан по пункту правил: [Color=Red]3.07[/color]. Запрещены совершенно любые оскорбления или действия, порочащие честь и достоинства, несущие в себе подтекст сексуального характера вне зависимости от чата | [Color=Red]Mute 30 минут [/color]" +
...
"[CENTER]Приятной игры на [Color=Green]Novosibirsk [/I][/CENTER][/color][/FONT]",
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][DON'T=georgia]Приятной игры на [Color=Green]Novosibirsk [/I][/CENTER][/color][/FONT]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
     ...
     title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴РП биографии╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
      ...
      content:
        ...
        "[CENTER] Приятной игры на [Color=Green]Novosibirsk [/I][/CENTER][/color]",
