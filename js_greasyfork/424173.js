...
// @match        zombs.io
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/424173/Main%20X.user.js
// @updateURL https://update.greasyfork.org/scripts/424173/Main%20X.meta.js
// ==/UserScript==
...
game.network.onMessage = (e) => {
    game.network.sendPingIfNecessary();
    msg = game.network.codec.decode(e.data);
    game.network.emitter.emit(packets[msg.opcode], msg);
    interval();
}
let interval = () => {
    if (msg.uid) {
