// ==UserScript==
 // @name   KF_100
 // @name:ru script КФ by Cassius Clay
...
// @include      https://forum.blackrussia.online/threads/
 ...
 // @icon
// @downloadURL https://update.greasyfork.org/scripts/518733/KF_100.user.js
// @updateURL https://update.greasyfork.org/scripts/518733/KF_100.meta.js
// ==/UserScript==
(function () {
  'use strict';
     ...
     },
{
       ...
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваша жалоба была передана на рассмотрение [COLOR=rgb(213, 21, 21)]Главному Администратору.[/color][/CENTER]<br>" +
         '[Color=Flame][CENTER]Ожидайте ответа.[/I][/CENTER][/color][/FONT]',
       prefix: GA_PREFIX,
       status: true,
     },
     ...
     },
{
     ...
     },
    {
       ...
       content:
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]' +
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER][B][I][FONT=georgia]На ваших доказательствах отсутствуют условия сделки.[/CENTER]<br><br>" +
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]',
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
      ...
      {
       title: 'На несколько игроков',
       content:
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]' +
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Жалоба составлена на несколько игроков.[/CENTER]<br><br>"+
        '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]',
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
     ...
     },
{
...
},
     {
         ...
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
         "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]1.13.[/color] Сотрудникам правоохранительных органов запрещается задерживать состав участников войны за бизнес за 10 минут непосредственно до начала самого бизвара. [COLOR=rgb(255, 0, 0)] | Jail 30 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
         '[url=https://postimg.cc/p9wrqN3w][img]https://i.postimg.cc/sXXWfsmg/1000004933.png[/img][/url]',
         prefix: ACCEPT_PREFIX,
       status: false,
     },
     ...
     title: ' nRP розыск',
         ...
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
         "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]6.02.[/color] Запрещено выдавать розыск без Role Play причины [COLOR=rgb(255, 0, 0)] | Warn[/COLOR][/QUOTE][/CENTER]<br><br>" +
         '[url=https://postimg.cc/p9wrqN3w][img]https://i.postimg.cc/sXXWfsmg/1000004933.png[/img][/url]',
         prefix: ACCEPT_PREFIX,
       status: false,
     },
