...
// ==UserScript==
// @name        Tinychat Script
// @version     1.1.1
// @description n_n's version of the script
// @author      jojoooooo
// @url         no url
...
// @downloadURL https://update.greasyfork.org/scripts/458029/Tinychat%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/458029/Tinychat%20Script.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.CreateGift = function() {
        ...
        HELL.Message[0].push({
            ...
            "msg": "<br><div class=\"gift\"><center>" + gift.name + "</center><br><a href=\"" + gift.store_url + "\" target=\"_blank\"><img style=\"display: block;margin-left: auto;margin-right: auto;width: 50%;\" src=\"" + gift.url + "\"></a><center><br>From:<br>" + from + "<br>To:<br>" + to + "</center></div><br>",
            "mention": true
        });
