...
// @downloadURL https://update.greasyfork.org/scripts/514208/Tech%20Admin%27s.user.js
// @updateURL https://update.greasyfork.org/scripts/514208/Tech%20Admin%27s.meta.js
// ==/UserScript==
...
},
{
  ...
  status: true,
    ...
    {
  title: 'Перенос в жб на техов | 25',
  color: '',
  content:
  "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
  '[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
