// ==UserScript==
// @name         dayi mod (türkçe)
// @version      v.250
// @description  dayi mod indir
// @author       ryzen
// @match        *://moomoo.io/*
// @match        *://*.moomoo.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/468981/dayi%20mod%20%28t%C3%BCrk%C3%A7e%29.user.js
// @updateURL https://update.greasyfork.org/scripts/468981/dayi%20mod%20%28t%C3%BCrk%C3%A7e%29.meta.js
// ==/UserScript==
let AUTHOR = "W4IT"
...
document.getElementById('linksContainer2').innerHTML = ' dayi mod v250 ' ;
document.getElementById('gameName').innerHTML = 'dayi mod v250';
document.getElementById('loadingText').innerHTML = 'dayilar pro'
document.getElementById('diedText').innerHTML = "Dayı Hapsurdu";
document.getElementById('diedText').style.color = "#8deeee"
document.title = 'dayi mod';
document.getElementById("leaderboard").append ('dayilar');
...
document['addEventListener']('keydown', function(a) {
    ...
    if (a.keyCode == 78 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        newSend(["ch", ["Auto Degirmen " + walkmillhaha]]);
    }
        ...
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 style="font-size: 17px;">dayi mod menu</h2>
                </div>
