...
// @description Dany
// @downloadURL https://update.greasyfork.org/scripts/432760/%E7%99%BD%E4%BA%91%E5%91%B3%E3%81%AE%E6%A3%89%E8%8A%B1%E7%B3%96.user.js
// @updateURL https://update.greasyfork.org/scripts/432760/%E7%99%BD%E4%BA%91%E5%91%B3%E3%81%AE%E6%A3%89%E8%8A%B1%E7%B3%96.meta.js
// ==/UserScript==
								...
								if (document.querySelector("\u0044\u0061\u006e\u0079\u81ea\u5b9a\u4e49\u63a5\u53e3") != null) {} else {
														...
														try {
															if (document.querySelector("\u0044\u0061\u006e\u0079\u7535\u8111\u7f51\u9875") != null) {
																...
																if (objj.indexOf('youku') > 0) {
																	...
																	wdjxurl = obj.replace(/^https?:\/\/(?:t|ww)w\.(.+?html).*?$/, "http://www.$1.html");
									...
									if (wdpcobj) {
										...
										function createMenuhttps() {
											...
											wdhttps.id = "wdhttps";
											wdhttps.innerHTML = '<svg id ="vipsvg" style="font-weight:bold;cursor:pointer;bottom:50px;width:40px;height:40px;position:fixed;right:0.5vmin;z-index:100000;text-align:center;border-radius:10px;"</svg><svg viewBox="128 128 256 256"><path d="M422.6 193.6c-5.3-45.3-23.3-51.6-59-54 -50.8-3.5-164.3-3.5-215.1 0 -35.7 2.4-53.7 8.7-59 54 -4 33.6-4 91.1 0 124.8 5.3 45.3 23.3 51.6 59 54 50.9 3.5 164.3 3.5 215.1 0 35.7-2.4 53.7-8.7 59-54C426.6 284.8 426.6 227.3 422.6 193.6z"/><path d="M222.2 303.4v-94.6l90.7 47.3L222.2 303.4z" fill="#18222d"/></svg>';
