...
// ==UserScript==
// @name         Super_preloaderPlus_one_Polaris
// @name:zh-CN   Super_preloaderPlus_one_Polaris
// @name:zh-TW   Super_preloaderPlus_one_Polaris
...
// @author       Polaris(原作者 Mach6&&ywzhaiqi && NLF)
// @version      7.11.11
// @license      GNU GPL v3
// @homepageURL  https://greasyfork.org/en/scripts/373438-super-preloaderplus-one-new
// @supportURL   https://greasyfork.org/en/scripts/373438-super-preloaderplus-one-new/feedback
...
// @downloadURL https://update.greasyfork.org/scripts/373438/Super_preloaderPlus_one_Polaris.user.js
// @updateURL https://update.greasyfork.org/scripts/373438/Super_preloaderPlus_one_Polaris.meta.js
// ==/UserScript==
(function() {
  const scriptInfo = {
    version: "7.11.11",
    ...
    homepageURL: "https://greasyfork.org/en/scripts/373438-super-preloaderplus-one-new",
    downloadUrl: "https://greasyfork.org/scripts/373438-super-preloaderplus-one-new/code/Super_preloaderPlus_one_New.user.js",
    metaUrl: "https://greasyfork.org/scripts/373438-super-preloaderplus-one-new/code/Super_preloaderPlus_one_New.meta.js"
  };

  const upgradeNotification = {
    text: {
      zh_CN: "规则指南https://machsix.github.io/Super-preloader/siterule.html",
      en_US: ""
    },
  ...
  var SITEINFO = [
    ...
    {
      name: "性感尤物",
      url: /^https?:\/\/www\.xgmn\.org\/[^\/]*\/[^\/]*\.html/,
      nextLink: '//div[@class="page"]/a[text()="后"]',
      autopager: {
        pageElement: '//div[@class="img"]/p',
        ipages: [true, 30],
      },
      exampleUrl: "http://www.xgmn.org/Xgyw/Xgyw6874.html",
    },
    {
      name: "宅男女神",
      url: "^https?://www\\.nvshens\\.net\\/.\\/\\d+\\/",
      nextLink: '//div[@id="pages"]/span/following::a[not(@class) and not(@id)]',
      exampleUrl: "http://www.nvshens.net/g/17951/",
      autopager: {
        enable: true,
