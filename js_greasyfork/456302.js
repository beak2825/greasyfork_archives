// ==UserScript==
// @name      just a little sum
// @namespace    -
// @version      v0.5
// @description f for trap. v for r for spike (you have to press mouse to place not macro)
// @author      IamGD_GaMeR
// @match        *://sandbox.moomoo.io/*
// @match        *://moomoo.io/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/456302/just%20a%20little%20sum.user.js
// @updateURL https://update.greasyfork.org/scripts/456302/just%20a%20little%20sum.meta.js
// ==/UserScript==
!function(e) {
    var t = {};
    function n(i) {
...
, function(e, t, n) {
    ...
    window.addEventListener("keydown", s.checkTrusted((function(e) {
        ...
        Mt.y = R.y) : 88 == t ? (R.lockDir = R.lockDir ? 0 : 1,
                                 r.send("7", 0)) : null != R.weapons[t - 49] ? Sn(R.weapons[t - 49], !0) : null != R.items[t - 49 - R.weapons.length] ? Sn(R.items[t - 49 - R.weapons.length]) : 81 == t ? Sn(R.items[0]) : 82 == t ? xn() : 70 == t ? Sn(R.items[4]) : 82 == t ? Sn(R.items[2]) : 16 == t ? Sn(R.items[2]) : mn[t] ? bn() : 32 == t && (O = 1,
        vn())))
    }
    ))),
