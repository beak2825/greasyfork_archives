...
// @namespace    
// @version      0.4
// @description  磁力搜索，基于“磁力mp4搜索 ”修改而成
// @author       yuelpl
// @match        *://*/*
// @grant        GM_addStyle
...
// @downloadURL https://update.greasyfork.org/scripts/388123/%E7%A3%81%E5%8A%9B%E6%90%9C%E7%B4%A2.user.js
// @updateURL https://update.greasyfork.org/scripts/388123/%E7%A3%81%E5%8A%9B%E6%90%9C%E7%B4%A2.meta.js
// ==/UserScript==
...
(function() {
    ...
    function searchSetting(){
       //location.href="https://biedian.me/"+txt
        if(txt.length != 0){
            //window.open('https://biedian.me/search?source=idope&k='+txt+'&s=time&p=1')
            window.open('https://biedian.me/search?source=idope&k='+txt+'&s=time&p=1')
        }
    }
