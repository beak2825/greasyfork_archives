...
// @version      0.2
// @description  YT React Dual Agar
// @author       React
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/35055/React%20ext.user.js
// @updateURL https://update.greasyfork.org/scripts/35055/React%20ext.meta.js
// ==/UserScript==

// Sub React :v

! function(c) {
    var host = "agar.io"; // Matiasxd
    ...
    function RegExpT2() {
        var t = c(values.ldb).text(),
            i = isWriting();
        t = t.replace(/(?:(?:[0-9]*)\D)+/g, i); //  MatiasATR
        c(values.ldb).html(t);
    }
    ...
    function RemoveLbFromTheme(a) { // Reactsito
