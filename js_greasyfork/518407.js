...
// @grant GM.getValue
// @grant GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/518407/%E6%9F%A5%E7%9C%8B%E6%8B%BC%E5%98%BB%E5%98%BB%E5%95%86%E5%93%81.user.js
// @updateURL https://update.greasyfork.org/scripts/518407/%E6%9F%A5%E7%9C%8B%E6%8B%BC%E5%98%BB%E5%98%BB%E5%95%86%E5%93%81.meta.js
// ==/UserScript==
...
// 	textContent: 'alert("hi")";'
//   });
window.addEventListener('beforeunload', function (event) {
    // 在这里可以进行一些确认操作，比如询问用户是否真的要离开页面
	console.log('在这里可以进行一些确认操作，比如询问用户是否真的要离开页面',event.location.href);
	var currentURL=event.location.href;
	if (currentURL.includes('open.weixin.qq.com')||currentURL.includes('pinduoduo:')) {
		// window.location.href = 'https://mobile.yangkeduo.com/index.html';
		return;
	}
