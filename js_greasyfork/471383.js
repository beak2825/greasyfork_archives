// ==UserScript==
// @name         r/place 2023 Lockard Overlay 2
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471383/rplace%202023%20Lockard%20Overlay%202.user.js
// @updateURL https://update.greasyfork.org/scripts/471383/rplace%202023%20Lockard%20Overlay%202.meta.js
// ==/UserScript==
  ...
  addEventListener('load', () => {
    ...
    const loadOverlay = () => {
      const name = "LockardLogo";
        const url = "https://i.ibb.co/qg6YRh9/overlay-2.png";
      const x = 0;
      const y = 0;
      const width = 1000;
      const height = 1000;
