...
// @grant       GM_addStyle
// @version     1.0 
// @downloadURL https://update.greasyfork.org/scripts/3398/IMDb%2B.user.js
// @updateURL https://update.greasyfork.org/scripts/3398/IMDb%2B.meta.js
// ==/UserScript==
// 
jQuery(document).ready(function($) {
	...
	l.am = ["allMovie", "http://www.allmovie.com/search/movies/" + m.TtYr, "http://www.allmovie.com/favicon.ico"];
	// TV Series
	...
	l.rr = ["Rutor", "http://rutor.org/search/" + m.TtYr, "http://rutor.org/favicon.ico"];
	...
	l.hdt = ["HDTracker", "http://hdtracker.org/browse.php?search=" + m.TtYr, "http://hdtracker.org/favicon.ico"];
