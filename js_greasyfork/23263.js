// ==UserScript==
// @name         Ogario By Zek v1
// @namespace    OgarZek
// @version      1
// @description  Extension modificada de Szymy
// @author       Zek
// @match        http://agar.io/*
// @run-at       document-start
// @grant        GM_xmlhttpRequest
// @connect      agar.io
// @downloadURL https://update.greasyfork.org/scripts/23263/Ogario%20By%20Zek%20v1.user.js
// @updateURL https://update.greasyfork.org/scripts/23263/Ogario%20By%20Zek%20v1.meta.js
// ==/UserScript==

// Copyright © 2016 Zek

if (location.host == "agar.io" && location.pathname == "/") {
    location.href = "http://agar.io/OgarZek" + location.hash;
    return;
}
...
function inicio() {
    document.title = "Ogario By Zek :)";
   modificarTextoMinimapa("By Zek");
    modificarTextoLeaderboard("Ogario By Zek");
    modificarFooter("Sigueme en Twitter!", "https://twitter.com/callmezek");
    panelDerecho();
    ocultarBotonAdelante();
    ocultarBotonAtras();
    redondearPanelCentral();
    redondearPanelDerecho();
    modificarMargenesPanel();
        redondearControles("");
    colorPanelCentral("#222222");
    colorPanelDerecho("#222222");
    colorTextoPestaña("#ffffff");
    colorPestañaActiva("#8b8b8b");
 
    colorBotonPlay("#920998", "#cc11d4");
    bordeBotonPlay("#000000", "#000000");
 
    colorBotonLoginAndPlay("#075061", "#02797d");
    bordeBotonLoginAndPlay("#2E7D32", "#2E7D32");
 
    colorBotonLogout("#bd0f57", "#c22b69");
    bordeBotonLogout("#000000", "#000000");
 
    colorBotonFacebook("#3c6f9a", "#4b8ac1");
    bordeBotonFacebook("#000000", "#000000");
 
    colorBotonGoogle("#D34C3D", "#de6457");
    bordeBotonGoogle("#000000", "#000000");
 
    colorBotonSpectate("#7705f6", "#8a2cf4");
    bordeBotonSpectate("#000000", "#000000");
 
    colorBotonCopy("#660e9a", "#940be3");
    bordeBotonCopy("#000000", "#000000");
 
    colorBotonCreate("#15117b", "#312d92");
    bordeBotonCreate("#000000", "#000000");
 
    colorBotonJoin("#920998", "#cc11d4");
    bordeBotonJoin("#000000", "#000000");
 
    colorBotonStreamMode("#2d2d2d", "#2d2d2d");
 
    colorBotonHideUrl("#222222", "#222222");
 
    colorBotonFreeCoins("#5cb85c", "#398439");
    bordeBotonFreeCoins("#000000", "#000000");
 
    colorBotonShop("#ff7900", "#954700");
    bordeBotonShop("#000000", "#000000");
 
 
    colorBotonResetHotkeys("#1565C0", "#1565C0");
    bordeBotonResetHotkeys("#000000", "#000000");
 
    colorBotonSaveHotkeys("#660e9a", "#940be3");
    bordeBotonSaveHotkeys("#000000", "#000000");
 
    colorBotonCloseHotkeys("#C62828", "#C62828");
    bordeBotonCloseHotkeys("#000000", "#000000");
 
    colorBotonSaveTheme("#660e9a", "#940be3");
    bordeBotonSaveTheme("#000000", "#000000");
 
 
    colorInput("#2d2d2d");
    colorTextoInput("#ffffff");
   
    colorSelect("#2d2d2d");
    colorTextoSelect("#FFFfff");
