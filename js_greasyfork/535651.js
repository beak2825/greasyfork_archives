...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/535651/CHEREPOVETS%20%D0%9A%D0%A4%20by%20ROLEX.user.js
// @updateURL https://update.greasyfork.org/scripts/535651/CHEREPOVETS%20%D0%9A%D0%A4%20by%20ROLEX.meta.js
// ==/UserScript==
...
const buttons = [
    { title: 'Приветствие',
	  ...
	  content:
              "[FONT=georgia][B][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		...
		'[B][CENTER][COLOR=yellow][ICODE]На рассмотрении[/ICODE][/COLOR][/CENTER][/B][/FONT]',
	  prefix: PIN_PREFIX,
	  status: true,
	},
      {
	...
	},
    {
	  ...
	  content:
		...
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B][/FONT]',
	...
	},
    {
	  ...
	  content:
		"[B][FONT=georgia][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
	...
	},
    {
	  ...
	  content:
		...
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/B][/FONT]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
	...
	},
    {
	  ...
	  content:
		"[FONT=georgia][B][FONT][CENTER][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
	...
	},
  {
	...
	},
    {
	...
	},
     {
	  ...
	  content:
		"[B][CENTER][FONT=georgia][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		...
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR][/CENTER][FONT][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
	...
	},
    {
	  title: '| Нету /time |',
	  content:
		"[B][CENTER][/FONT][COLOR=#FF0080][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
	...
	},
 {
          ...
          },
    {
	  ...
	  content:
		...
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=#00FA9A][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B][/FONT]',
          ...
          },
{
	...
	},
    {
	  ...
	  content:
		"[FONT=georgia][B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
	...
	},
{
          ...
          },
    {
	  ...
	  content:
		...
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Передано Главному Администратору[/ICODE][/COLOR][/CENTER][/B][/FONT]',
	  prefix: GA_PREFIX,
	  status: true,
	},
    {
	  ...
	  content:
        ...
        "[B][CENTER][COLOR=lavender]Возможно на рассмотрении жалобы потребуется больше времени. Просьба ожидать ответа и не создавать копий данной темы. <br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=blue][ICODE]Передано Техническому специалисту [/ICODE][/COLOR][/CENTER][/B][/FONT]',
	  prefix: TEX_PREFIX,
	  status: true,
	},
    {
	  ...
	  content:
        ...
        "[B][CENTER][COLOR=lavender]Возможно на рассмотрении жалобы потребуется больше времени. Просьба ожидать ответа и не создавать копий данной темы. <br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=#7C706B][ICODE]Передано Главному Куратору Форума [/ICODE][/COLOR][/CENTER][/B][/FONT]',
	  prefix: GA_PREFIX,
	  status: true,
	},
    {
