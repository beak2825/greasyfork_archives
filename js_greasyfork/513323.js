...
// @downloadURL https://update.greasyfork.org/scripts/513323/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Bsk%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/513323/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Bsk%5D.meta.js
// ==/UserScript==
(function (f) {
    var d = document,
    ...
    if (isDefined(window.TWDB)) {
        new west.gui.Dialog(
            TWDB.script.name,
            '<div class="txcenter"><b><br>Používateľský skript ClothCalc je nainštalovaný dvakrát, s rôznymi jazykovými verziami. Jednu z nich je nutné odinštalovať, aby skript fungoval správne!</br></b></div>',
        ...
        TWDB.Util = (function (e) {
            ...
            var u = function (e) {
                if (localStorage.getItem("twdb_0_embackup") !== "TRUE") {
                    return;
                }
                var t = [],
                    n,
                ...
                if (e === true) {
                    ...
                    localStorage.removeItem("twdb_0_embackup");
                } else {
                    for (s = 0; s < t.length; s++) {
        ...
        TWDB.ClothCalc = {
            ...
            checkCache: function () {
                ...
                if (e || t || n) {
                    var i = "Dáta sú zastaralé, klikni pre obnovu";
                    if (e) {
                        i += " [Inventár]";
                    }
                    if (t) {
                    ...
                    r = jQuery('<div title="Dáta sú v poriadku" style="position:absolute;top:0px;right:0px;width:20px;height:20px;background: url(' + TWDB.images.iconData + ')no-repeat -20px 0px;" /></div>');
                    this.up2date = true;
                }
            ...
            open: function (e, t) {
                ...
                this.gui.job.sort = jQuery('<div style="position:absolute;top:10px;left:0px;height:20px;" />')
                    .append('<img src="' + TWDB.images.iconName + '" title=" Zoradiť abecedne " alt=" Zoradiť abecedne " onclick="javascript:TWDB.ClothCalc.joblist.order(\'name\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                    .append(
                        '<img src="' +
                            TWDB.images.iconExperience +
                            '" title=" Zoradiť podľa skúseností " alt=" Zoradiť podľa skúseností " onclick="javascript:TWDB.ClothCalc.joblist.order(\'experience\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    )
                    .append(
                        '<img src="' + TWDB.images.iconDollar + '" title=" Zoradiť podľa zárobku " alt=" Zoradiť podľa zárobku " onclick="javascript:TWDB.ClothCalc.joblist.order(\'wages\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    )
                    .append(
                        '<img src="' + TWDB.images.iconLuck + '" title=" Zoradiť podľa šťastia " alt=" Zoradiť podľa šťastia " onclick="javascript:TWDB.ClothCalc.joblist.order(\'luck1\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    )
                    .append(
                        '<img src="' +
                            TWDB.images.iconLaborpoints +
                            '" title=" Zoradiť podľa pracovných bodov " alt=" Zoradiť podľa pracovných bodov " onclick="javascript:TWDB.ClothCalc.joblist.order(\'laborpoints\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    )
                    .append(
                        '<img src="' +
                            TWDB.images.iconMoti +
                            '" title=" Zoradiť podľa motivácie " alt=" Zoradiť podľa motivácie " onclick="javascript:TWDB.ClothCalc.joblist.order(\'motivation\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    )
                    .append(
                        '<img src="' +
                            TWDB.images.iconDanger +
                            '" title=" Zoradiť podľa nebezpečenstva " alt=" Zoradiť podľa nebezpečenstva " onclick="javascript:TWDB.ClothCalc.joblist.order(\'danger\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    );
                this.gui.job.title = jQuery('<div style="position:absolute;top:37px;left:0px;width:187px;height:19px;font-weight:bold;text-align:center;white-space: nowrap;">Vybrať prácu >></div>');
                this.gui.job.mode = jQuery(
                    "<div style=\"position:absolute;top:10px;right:30px;width:20px;height:20px;background:url('" + TWDB.images.jobTime + '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:block;" title=" Čas práce " />'
                );
                this.gui.job.search = jQuery(
                    "<div style=\"position:absolute;top:35px;right:50px;width:20px;height:20px;background:url('" +
                        ...
                        '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:none;" title=" Vyhľadať prácu na mape " />'
                );
                ...
                this.gui.job.checkbox.setTooltip("Skry práce, ktoré nemôžeš robiť");
                this.gui.job.checkbox.getMainDiv().css({ position: "absolute", top: "35px", right: "30px" });
                this.gui.job.button = jQuery(
                    '<div style="position:absolute;top:35px;right:4px;width:26px;height:20px;background:url(\'/images/window/character/title_editbtn.jpg\') no-repeat scroll 0 0 transparent;cursor:pointer;" title=" Vybrať prácu " />'
                );
                ...
                this.gui.job.calc = $('<div title=" Aktuálne odmeny " style="position:absolute;top:60px;width:100px;right:1px;height:30px;display:block;;font-weight:bold;text-align:center;" />');
                ...
                this.gui.custom.title = jQuery('<div style="position:absolute;top:36px;left:0px;width:210px;height:19px;font-weight:bold;text-align:center;">Vybrať prácu >></div>');
                this.gui.custom.settings = jQuery('<div title="Nastavenia" style="position:absolute;top:35px;right:30px;width:20px;height:20px;background:url(' + TWDB.images.iconSetting + ');cursor:pointer;" />');
                ...
                this.gui.window = wman
                    ...
                    .addTab("Práca", "Jobs", o)
                    .addTab("Vlastné atribúty", "Custom", o)
                ...
                var u = $(
                    '<div title="Uložiť pozíciu" style="width:20px;height:20px;position:absolute;left:0px;top:0px;background:url(\'' + TWDB.images.iconSave + "') no-repeat scroll 0px -20px transparent;cursor:pointer;display:block;\" />"
                )
                    .hover(
                        function () {
            ...
            jobs: {
                ...
                getJobPopup: function (e) {
                    ...
                    n =
                        ...
                        '<tr><td><img src="' +
                        TWDB.images.iconExperience +
                        '" title=" Skúsenosti " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.experience +
                        "</td>" +
                        '<td><img src="' +
                        TWDB.images.iconDollar +
                        '" title=" Zárobok " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.wages +
                        "</td></tr>" +
                        '<tr><td><img src="' +
                        TWDB.images.iconLuck +
                        '" title=" Zvýšená šanca na výhru " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.luck1 +
                        "-" +
                        t.luck2 +
                        "</td>" +
                        '<td><img src="' +
                        TWDB.images.iconDanger +
                        '" title=" Nebezpečie " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.danger +
                        "</td></tr>" +
                        '<tr><td><img src="' +
                        TWDB.images.iconLaborpoints +
                        ...
                        '" title=" Trvanie " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.duration +
                        "</td></tr>" +
                        '<tr><td><img src="' +
                        TWDB.images.iconMoti +
                        '" title=" Motivácia "  height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.resmotivation * 100 +
                        " (" +
            ...
            customs: {
                ...
                showConfig: function () {
                    var e = this;
                    var t = jQuery(
                        '<div title="Upraviť" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' +
                            Game.cdnURL +
                            "/images/window/messages/head-icons.png') repeat scroll 0 16px transparent;\" />"
                    );
                    var n = jQuery(
                        '<div title="Zmazať" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' + Game.cdnURL + "/images/icons/delete.png') repeat scroll 0px 0px transparent;\" />"
                    );
                    var r = jQuery(
                        '<div title="Pridať" style="display:block;margin-top:2px;vertical-align:top;height:20px;width:25px;cursor:pointer;background:url(\'' +
                            Game.cdnURL +
                    ...
                    this.parent.gui.custom.config = new west.gui.Dialog("Vlastné atribúty", i);
                ...
                addConfig: function () {
                    ...
                    if (e >= 15) {
                        new UserMessage("príliš veľa súprav, dovolených je len 10", UserMessage.TYPE_ERROR).show();
                    } else {
                        e++;
                        this.editConfig(e);
                    }
                ...
                editConfig: function (e, t) {
                    if (typeof t == "undefined") {
                        ...
                        o.append('<tr><td colspan="2">Prosím, choď na tw-db.info a skopíruj sem získaný kód z <a href="https://tw-db.info/?strana=calc" target="_blank">tw-db.info Kalkulátor</a></td></tr>');
                ...
                for (var i = 0; i < t.length; i++) {
                    ...
                    u.append(
                        jQuery('<td style="text-align:left;vertical-align:middle">').append(
                            jQuery(
                                '<img src="' + TWDB.images.arrow + '" title="Smer" style="cursor:pointer;-moz-transform: ' + o + "-webkit-transform:" + o + "-rotat-transform:" + o + "-ms-transform:" + o + "transform:" + o + '" />'
                            ).click(
                                (function (e, t) {
                                    return function () {
                                        GameMap.center(e, t);
        ...
        (function ($) {
                ...
                t.reset = function (n, s) {
                    try {
                        if (n) {
                            ...
                            var u = e("<div><h2>Určite chceš vymazať celú Cache pamäť scriptu tw-db?</h2></div>");
            ...
            var Importer = (function (e) {
                ...
                //n = Loader.add("Importer", "tw-db Importersystem", r, { Window: true }); //changed by Maco
                var i = function () {
            ...
            var Settings = (function (e) {
                ...
                var o = function () {
                    ...
                    m.addItem("left", "vľavo").addItem("right", "vpravo").addItem("custom", "Uložená pozícia");
                    m.select(String(n["clothPos"]));
                    e("tr.placeholder_clothPos", a).removeClass("placeholder_clothPos").append(e('<td colspan="2" />').append(m.getMainDiv(), "<span>&nbsp;vpravo</span>"));
                ...
                var i = function () {
                    try {
                        ...
                        JobWindow.prototype.getBestWearButton = function () {
                            ...
                            var n = this;
                            return t.append(
                                e('<div class="twdb_bestwear" title="Zobraziť túto prácu v okne ClothCalc">').click(function (e) {
            ...
            var Updater = (function (e) {
                ...
                var s = function () {
                    ...
                    if (!Cache.load("version")) Cache.save("version", Script.version + " " + Script.revision);
                        ...
                        var t = '<div class="txcenter">Script =1= bol aktualizovaný. Chceš sa pozrieť na zoznam zmien?</div>';
                ...
                var o = function (e, t) {
                    ...
                    var r = '<div class="txcenter">Pre script =1= je dostupná nová verzia, prosím zvoľ ok pre aktualizovanie scriptu.</div>';
                ...
                var k = function () {
                    ...
                    var t = e(
                        '<div class="fancytable">' +
                            ...
                            '<span title="Meno" style="cursor:pointer, margin-bottom:3px;">' +
                            '<img src="' +
                            Images.iconName +
                            '" />' +
                            "</span>" +
                            ...
                            '<span title="Zvýšená šanca na výhru">' +
                            '<img src="' +
                            Images.iconLuck +
                            '" />' +
                            "</span>" +
                    ...
                    for (var u in s) {
                        ...
                        m.data("avg-t", "&Oslash; " + String((f.duration / (3600 * f.count)).round(2)) + " hodín");
                        w.append(m);
                    ...
                    m.data("sum", "&sum;");
                    m.data("sum-t", "prepnúť na &Oslash;");
                    m.data("avg", "&Oslash;");
                    m.data("avg-t", "prepnúť na &sum;");
                    l.footer.append(m);
                    ...
                    m.data("avg-t", "&Oslash; " + String((i.duration / (3600 * i.count)).round(2)) + "hodín");
                    l.footer.append(m);
                    ...
                    var o = e('<div style="margin: 0px 6px 0px 6px;width:680px;" />')
                        .append(
                            e('<a href="#">Prepnúť medzi odmenami a nájdenými vecami</a>')
            ...
            var Map = (function (e) {
                ...
                var d = function () {
                    ...
                    var n = function () {
                        ...
                        var a = e('<img title="Zobraziť na mape súradnice" src="' + Images.iconCount + '" />').click(function () {
            ...
            var BonusJobs = (function (e) {
                ...
                var u = function () {
                    ...
                    var n = function () {
                        var t = e('<div id="mmap_twdb_bonusjobs" />')
                            .append(
                                e('<input title="Zobraziť zlaté práce" type="checkbox" ' + (i.gold ? 'checked="checked"' : "") + " />").change(function () {
                                    i.gold = e(this).is(":checked");
                                    a();
                                })
                            )
                            .append('<div title="Zobraziť zlaté práce" style="background-color:yellow; border:1px solid red;" />')
                            .append(
                                e('<input title="Zobraziť strieborné práce" type="checkbox" ' + (i.silver ? 'checked="checked"' : "") + " />").change(function () {
                                    i.silver = e(this).is(":checked");
                                    a();
                                })
                            )
                            .append('<div title="Zobraziť strieborné práce" style="background-color:white; border:1px solid black;" />')
                            .append(
                                e('<img title="Bonusové práce Export" src="' + Images.iconExport + '" />').click(function () {
                                    f();
                                })
                            )
                            .append(
                                e('<img title="Bonusové práce Import" src="' + Images.iconImport + '" />').click(function () {
                                    l();
                                })
                            )
                            .append(
                                e('<img title="Bonusové práce Vynulovať" src="' + Images.iconReset2 + '" />').click(function () {
                                    c();
                                })
                            );
                ...
                var f = function () {
                    ...
                    var h = e("<div />")
                        ...
                        .append(
                            e('<img src="' + Images.iconName + '" title=" Zoradiť abecedne "  style="margin:0px 2px 0px 2px;cursor:pointer;" />').click(function () {
                                c("name");
                            })
                        )
                        .append(
                            e('<img src="' + Images.iconCount + '" title=" Zoradiť podľa krajiny " style="margin:0px 2px 0px 2px;cursor:pointer;" />').click(function () {
                                c("country");
                            })
                        );
                    new west.gui.Dialog("Bonusové práce Export", e("<div />").append(h).append(a)).addButton("ok").show();
                };
                var l = function () {
                ...
                var c = function (e) {
                    try {
                        if (e) {
                            ...
                            var u = '<div class="txcenter">Bonusové práce Vynulovať</div>';
                    ...
                    if (r) {
                        e.divMain.append(
                            '<img src="' +
                                ...
                                i +
                                '" title=" Tento predmet ešte nemáš " style="position:absolute;bottom:4px;right:0px;width:19px;height:19px;padding:0px;border:0px;margin:0px;" />'
                        );
                    }
                };
                return t;
            ...
            var Collector = (function (e) {
                    ...
                    if (Settings.get("collector", true)) {
                        ...
                        GameInject.injectTrader("collector", function (e) {
                            if (t.isNewItem(e.item_id)) {
                                var n = '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" Tento predmet ešte nemáš " ' + ' style="position:absolute;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />';
                                return n;
                            }
                            return "";
                        });
                ...
                var s = function (e) {
                    ...
                    if (t.isNewItem(e.obj.item_id)) {
                        e.divMain.append('<img src="' + Images.iconNew + '" class="TWDBcollector" title=" Tento predmet ešte nemáš " style="position:absolute;top:-8px;left:-15px;padding:0px;border:0px;margin:0px;" />');
                    }
                };
                var o = function (e) {
                    if (t.isNewItem(e)) {
                        return '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" Tento predmet ešte nemáš " style="width:18px;height:18px;position:relative;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />';
                    } else {
                        return "";
                    }
                };
            ...
            var BuyTip = (function (e) {
                ...
                var f = function (e, t) {
                    ...
                    if (t == "market") {
                        ...
                        return '<img id="TWDBbuyTip' + i + '" src="' + Images["iconStar3"] + '" class="TWDBbuyTip" width="18px" height="18px" title="Výpočet prebieha, prosím čakajte..." style="padding:0px;border:0px;margin:0px;" />';
                    }
                    if (isDefined(r[n])) {
                        if (t == "shop") {
                            var s = h(n);
                    ...
                    e.divMain.append(
                        '<img src="' +
                            Images["iconStar3"] +
                            '" class="TWDBbuyTip" width="25px" height="25px"     title="Výpočet prebieha, prosím čakajte..."  style="position:absolute;bottom:-8px;right:-5px;padding:0px;border:0px;margin:0px;" />'
                    );
                    Worker.add(
                        (function (e, t) {
                            return function () {
                ...
                var p = function (e) {
                    ...
                    if (!ClothCalc.isItemUsable(e)) {
                        var n = ItemManager.get(e);
                        t += '<td colspan="2" style="text-align:center; font-weight:bold;">Úroveň ' + n.level + "</td></tr><tr>";
                    }
                ...
                var QuestbookSwitch = function () {
                    try {
                        ...
                        QuestGroupWindowView.showSolvedQuest = function (e) {
                            ...
                            var r = $('<a href="#"> Zobraziť záverečný text </a>')
                                .addClass("introshown")
                                .click(function () {
                                    var e = $(this),
                ...
                var enhanceMarketSellDialog = function () {
                    ...
                    MarketWindow.TWDB_touchUpSellDialog = function (n) {
                        ...
                        $("tr:nth-last-child(5) td:nth-child(2) span.tw2gui_textfield", i).after(
                            ...
                            'title="Upraviť (vynásobiť) aktuálnu cenu týmto číslom" ' +
                            ...
                            'title="Použiť maximálny počet predmetov" ' +
                            'class="linkstyle"' +
                        ...
                        $("#twdb_msd_desc_cc", r).append(
                            $('<div class="tw2gui-iconset tw2gui-icon-save" title="Uložiť popis pre budúce akcie">').click(function () {
                                u("description", $("textarea#auction_description", r).val());
                            }),
                            $('<div class="tw2gui-iconset tw2gui-icon-abort" title="Zrušiť popis">').click(function () {
                                u("description", "");
                        ...
                        $("#twdb_msd_bid_btn_cc", r).append(
                            ...
                            $('<span class="tw2gui-iconset tw2gui-icon-abort" title="Zrušiť možnosti" style="display: inline-block;">').click(function () {
                        ...
                        $("#twdb_msd_buy_cc", r)
                            ...
                            .append(
                                $('<div class="tw2gui_checkbox" title="Vložiť kúpnu cenu predmetu">')
                            ...
                            .append("&nbsp;&nbsp;")
                            .append(new west.gui.Checkbox("", "twdb_msd_buy_fix", o).setTitle("Použiť ako predvolenú cenu").setValue(1).divMain)
                            .append(
                                $('<div class="tw2gui_checkbox" title="Vložiť predajnú cenu predmetu">')
                        ...
                        $("#twdb_msd_bid_cc", r)
                            .append(new west.gui.Checkbox("", "twdb_msd_bid_fix", o).setTitle("Použiť ako predvolenú cenu").setValue(2).divMain)
                            .append(
                                $('<div class="tw2gui_checkbox" title="Vložiť kúpnu cenu predmetu">')
                                    .append('<span class="invPopup_buyicon" style="height:20px;">')
                                    .click(function () {
                            ...
                            .append("&nbsp;&nbsp;")
                            .append(new west.gui.Checkbox("", "twdb_msd_bid_fix", o).setTitle("Použiť ako predvolenú cenu").setValue(1).divMain)
                            .append(
                                $('<div class="tw2gui_checkbox" title="Vložiť predajnú cenu predmetu">')
                                    .append('<span class="invPopup_sellicon" style="height:20px;">')
                                    .click(function () {
                        ...
                        $("#twdb_msd_opt_cc", r).append(
                            $('<span class="tw2gui-iconset tw2gui-icon-save" title="Uložiť trvanie a práva pre budúce akcie" style="display: inline-block;">').click(function () {
                ...
                var weeklyCrafting = function () {
                    if (w.Character.professionId && w.Character.professionSkill > 599) {
                        var e = function (e) {
                            ...
                            var r =
                                "<div style='text-align:center;'>Môžeš znova vyrábať!<br />" +
                            ...
                            TitleTicker.setNotifyMessage("Remeslá");
                        };
                        var t = function () {
                ...
                _self.injectTaskJobs = function () {
                    try {
                        ...
                        TaskJob = function () {
                            ...
                            t.getTitle = function () {
                                return t.__twdb__getTitle() + "PB: " + (this.data.job_points < 0 ? "<b class='text_red'>" : "<b>") + this.data.job_points + "</b><br />";
                            };
                            return t;
                        };
                    } catch (t) {
                            ...
                            if (!$("#CC_pin_items").length) {
                                Inventory.DOM.children(".actions").append(
                                    $('<div id="CC_pin_items" class="tw2gui_iconbutton" />')
                                        .attr({ title: "Prepnúť mód pripínania vecí".twdb_twiceHTMLUnescape() })
                            ...
                            t.contentPane
                                ...
                                .before(
                                    $('<div class="telegram-source"><div>BB</div></div>')
                                        .attr("title", "Prepnúť medzi formátovaným telegramom a zdrojom")
                                        .click(function () {
                    ...
                    var n = function (t) {
                                        ...
                                        if (r.jsInfo.type == "inventory_changed") {
                                            ...
                                            if (s) {
                                                e(this)
                                                    ...
                                                    .after(
                                                        '<span title="Zobraziť túto prácu v okne ClothCalc" class="quest_mmaplink" title="" onclick="javascript:void(Quest.CCopen(\'' +
                                                            s.name +
                                                            "','item'))\"><img src=\"" +
                                                            Images.iconLight +
                                                            '" /></span>'
                        ...
                        if ((t.group < 142 && (t.group != 69 || t.id >= 2e4)) || [200, 201].indexOf(t.group) > -1) {
                            t.el
                                ...
                                .append(
                                    '<a target="_blank" title="Zobraziť danú úlohu na tw-db.info" href="' +
                                        Script.protocol +
                                        "://" +
                                        Script.url +
                ...
                var s = function () {
                    try {
                        ...
                        QuestWindow.cancelQuest = function (t) {
                            new west.gui.Dialog("Zrušiť úlohu?", "Si si istý, že chceš zrušiť túto úlohu?")
            ...
            var Customs = (function (e) {
                ...
                t.open = function () {
                    ...
                    i = new west.gui.Dialog("Vlastné atribúty", t)
                        .addButton("ok", function () {
                ...
                var f = function (e) {
                    ...
                    new west.gui.Dialog("Zmazať - Vlastné atribúty", "Zmazať: " + String(n[e].name).escapeHTML() + "?").addButton("ok", r).addButton("cancel").show();
                };
                var l = function () {
                    var e = 0;
                    for (var t in n) {
                ...
                var c = function (t) {
                    if (isDefined(n[t])) {
                        ...
                        var s = "Upraviť - Vlastné atribúty";
                    } else {
                        var r = "";
                        var i = "";
                        var s = "Pridať - Vlastné atribúty";
                    }
                    ...
                    var f = e('<table width="400px" />')
                        .append(e("<tr />").append('<td style="vertical-align:middle">Meno:</td>').append(e("<td />").append(o.getMainDiv())))
                        .append(e("<tr />").append('<td style="vertical-align:middle">Kód:</td>').append(e("<td />").append(u.getMainDiv())))
                        .append(e('<tr><td colspan="2">Prosím, choď na tw-db.info a skopíruj sem získaný kód z <a href="https://' + Script.url + '/?strana=calc" target="_blank">tw-db.info Kalkulátor</a></td></tr>'));
            ...
            var DuelMotivation = (function (e) {
                ...
                var m = function (e) {
                    ...
                    d(t + "%", "Duelová motivácia:&nbsp;" + t + "%", e ? "duelmot_dim" : "");
                };
                var g = function (e) {
                    if (f) {
                        w.clearInterval(f);
                    ...
                    a = "<div style='text-align:center;'>Čas KO<br />";
                    if (!c && n > t && !e) {
                        a += "Kóma - suspendované duely do&nbsp;" + new Date(n).toLocaleString() + "<br />";
                    ...
                    u = Math.max(0, u);
                    a += "Kóma - duelová ochrana do&nbsp;" + new Date(r).toLocaleString() + "</div>";
            ...
            var Bank = (function (e) {
                ...
                var s = function () {
                    ...
                    btn.click(function () {
                        o();
                    }).addMousePopup("Uložiť peniaze");
                };
                var o = function () {
                    new west.gui.Dialog("Uložiť peniaze", e("<span class='twdb_banking'>Peniaze: " + w.Character.money + "</span>"))
                        .setIcon(west.gui.Dialog.SYS_QUESTION)
                        .setModal(true, false)
                        .addButton("yes", function () {
                            a(1);
                ...
                var u = function () {
                    try {
                        ...
                        if (w.Character.position.x == w.Character.homeTown.x && w.Character.position.y == w.Character.homeTown.y) {
                            if (n) {
                                n = false;
                                new west.gui.Dialog("Uložiť peniaze", e("<span class='twdb_banking'>Dorazil si do svojho mesta. Chceš si uložiť peniaze? <br />Peniaze: " + w.Character.money + "</span>"))
                                    .setIcon(west.gui.Dialog.SYS_QUESTION)
                                    .setModal(true, false)
                                    .addButton("yes", function () {
                                        n = true;
            ...
            var Market = (function (e) {
                ...
                var o = function () {
                    ...
                    if (Settings.get("marketmap", true)) {
                        GameInject.addTabOnMarketWindow("Mapa trhu", "marketmap", function () {
                            c();
                        });
                ...
                var l = (function (e) {
                    ...
                    var u = function (t) {
                        var r = n[t],
                            ...
                            s = new OnGoingEntry();
                        s.init();
                        s.setTooltip("aukcia: " + i.name + ", Koniec: " + Number(r.ends - new Date().getTime() / 1e3).getTimeString4Timestamp());
                        s.setImage(e('<img src="' + Images.notiBell + '" />'));
                        WestUi.NotiBar.add(s);
                        TitleTicker.setNotifyMessage("aukcia: " + i.name + ", Koniec: " + Number(r.ends - new Date().getTime() / 1e3).getTimeString4Timestamp());
                        AudioController.play(AudioController.SOUND_NEWMSG);
                        o(t);
                    };
                    t.create = function (r, i) {
                        var u = e("<div />").append('<span style="position:relative; width:100%;display:block;">Koniec aukcie: ' + r.auction_ends_in.getTimeString4Timestamp() + "</span>"),
                            a = new west.gui.Textfield("twdb_analyser_last").maxlength(4).onlyNumeric().setLabel("Pripomenúť pred skončením aukcie: ").setPlaceholder("minút");
                        u.append(a.getMainDiv());
                        ...
                        var f = new west.gui.Dialog("Trhová pripomienka", u)
                            .setIcon(west.gui.Dialog.SYS_QUESTION)
                ...
                var c = function () {
                    try {
                        ...
                        window.MarketWindow.window.setTitle("Mapa trhu").setSize(840, 655).addClass("premium-buy");
                        var t = -111,
                            s = -1;
                ...
                var v = function () {
                    ...
                    e("<img src='" + to_cdn("images/map/minimap/icons/miniicon_pos.png") + "' />")
                        ...
                        .attr({ class: "mmap_mappoint", id: "mmap_icon_pos", title: "Tvoja pozícia" })
                        .appendTo(r);
                    m();
                };
                var m = function () {
                    try {
                        ...
                        for (var u = 0; u < t.length; u++) {
                            ...
                            o +=
                                ...
                                a.name +
                                "</a>" +
                                ' <a title="Ukázať mesto na mape" onclick="GameMap.center(' +
                                a["x"] +
                                ", " +
                                a["y"] +
                                ')"><img src="' +
                                ...
                                " Vzdialenosť: " +
                                a["distance"] +
                                ' <a title="Cestovať do mesta" onclick="TaskQueue.add(new TaskWalk(' +
                                a.town_id +
                                ",'town'))\"><img src=\"" +
                                Game.cdnURL +
                ...
                var inject = function () {
                    try {
                        ...
                        newfunction = newfunction
                            ...
                            .replace(/\.appendToThCell\('head', ?'evaluated' ?,.*?,.*?\);/, ".appendToThCell('head','healthpoints','Zoradiť podľa zdravia','<span class=\"sort sort-healthpoints\">'+'Lp'+'</span>');")
                            .replace(
                        ...
                        fb_sort = fb_sort
                            ...
                            .replace(
                                ...
                                "else if(key=='healthpoints'){title='Zoradiť podľa zdravia';sorting.append(getSortLink('Stúpajúce aktuálne zdravie','>currhealth'));sorting.append(getSortLink('Klesajúce aktuálne zdravie','<currhealth')); sorting.append(getSortLink('Stúpajúce max. zdravie','>maxhealth'));sorting.append(getSortLink('Klesajúce max. zdravie','<maxhealth'));sorting.append('<br />');sorting.append(getSortLink('Stúpajúca vzdialenosť','>distance'));sorting.append(getSortLink('Klesajúca vzdialenosť','<distance'));sorting.append(getVisLink(hidden(null,'-3','atfort')?'Zobraziť hráčov v pevnosti':'Skryť hráčov v pevnosti','atfort'));sorting.append(getVisLink(hidden(null,'-3','nearbyfort')?'Zobraziť hráčov pri pevnosti':'Skryť hráčov pri pevnosti','nearbyfort'));sorting.append(getVisLink(hidden(null,'-3','notatfort')?'Zobraziť hráčov mimo pevnosti':'Skryť hráčov mimo pevnosti','notatfort'));}return{message:sorting,title:title};"
                            );
                        eval(fb_sort);
