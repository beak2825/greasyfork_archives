...
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/482821/VoiceLinks.user.js
// @updateURL https://update.greasyfork.org/scripts/482821/VoiceLinks.meta.js
// ==/UserScript==

(function () {
  'use strict';
  const RJ_REGEX = new RegExp("R[JE][0-9]{8}", "gi");
  ...
  const Parser = {
      ...
      linkify: function (textNode) {
          ...
          for (let i = 0; i < matches.length; ++i) {
              ...
              let substring;
              if (substring = nodeOriginalText.substring(matches[i].index + 10, upper)) {
