(function() {
// ==UserScript==
// @name         Super_preloaderPlus_one默认iframe模式
...
// @downloadURL https://update.greasyfork.org/scripts/18699/Super_preloaderPlus_one%E9%BB%98%E8%AE%A4iframe%E6%A8%A1%E5%BC%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/18699/Super_preloaderPlus_one%E9%BB%98%E8%AE%A4iframe%E6%A8%A1%E5%BC%8F.meta.js
// ==/UserScript==
...
var prefs={
    ...
    pauseA: true,            // 快速停止自动翻页(当前模式为翻页模式的时候生效.);
        Pbutton: [2, 0, 0],     // 需要按住的键.....0: 不按住任何键;1: shift键;2: ctrl键; 3: alt键;(同时按3个键.就填 1 2 3)(一个都不按.就填 0 0 0)
...
//上一页关键字
var prePageKey=[
    '上一页', '上一页', '上1页', '上1页', '上页', '上页',
    '翻上页', '翻上页',
    '上一张', '上一张', '上一幅', '上一章', '上一节', '上一节', '上一篇',
    '前一页', '前一页',
    '后退', '后退', '上篇',
