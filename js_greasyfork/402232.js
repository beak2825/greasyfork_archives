// ==UserScript==
// @name         Webcamdarts Dual View Streaming size for test
// @name:fr      Webcamdarts Dual View Streaming taille TEST
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/402232/Webcamdarts%20Dual%20View%20Streaming%20size%20for%20test.user.js
// @updateURL https://update.greasyfork.org/scripts/402232/Webcamdarts%20Dual%20View%20Streaming%20size%20for%20test.meta.js
// ==/UserScript==
...
addGlobalStyle('#myvideo, #content > div > div > div > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div > div:nth-child(2){max-width:50%;position:fixed;left:0px;bottom:70px;z-index:1;    height: auto;border:1px green;}');
addGlobalStyle('#content > div > div > div > div:nth-child(4) {width: 50%;position:fixed;right:0px;top:0px;z-index:1;}');
addGlobalStyle('#remotevideo {width: 50%;position:fixed;right:0px;bottom:70px;height:auto;z-index:1;}');
