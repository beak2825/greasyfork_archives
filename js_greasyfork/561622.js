...
// @version      3.15
// @description  По вопросам в ВК , туда же и по предложениям на улучшение скрипта)
// @author       Sergey_Bellucci by Azamat_Mascherano
// @match        https://forum.blackrussia.online/threads/*
// @icon         https://forum.blackrussia.online/data/avatars/o/11/11193.jpg?1680968342
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/561622/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%84%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20ANAPA.user.js
// @updateURL https://update.greasyfork.org/scripts/561622/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%84%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20ANAPA.meta.js
// ==/UserScript==
...
},
{
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
		"[B][CENTER][FONT=times new roman][COLOR=lavender][Color=#ff0000]2.35.[/color] На игровых серверах запрещено устраивать IC и OOC конфликты на почве разногласия о национальности и/или религии совершенно в любом формате [Color=#ff0000]| Mute 120 минут / Ban 7 дней [/color].[/COLOR][/CENTER][/B]<br><br>"+
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
        "[B][CENTER][FONT=times new roman][COLOR=#ccff00]Одобрено.[/CENTER]<br><br>" +
    '[CENTER][CENTER][FONT=times new roman][COLOR=	#ffc6b4]Приятного время проведения на сервере Anapa[/CENTER][/FONT]',
      prefix: ACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		"[B][CENTER][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br>"+
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Согласно пункту 2.28 общих правил серверов запрещено покупать для автомобилей в семью у игроков. <br><br>"+
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
        "[B][CENTER][FONT=times new roman][COLOR=#FF0000]Отказано.[/CENTER]<br><br>" +
    '[CENTER][CENTER][FONT=times new roman][COLOR=	#ffc6b4]Приятного время проведения на сервере Anapa[/CENTER][/FONT]',
      prefix: UNACCСEPT_PREFIX,
