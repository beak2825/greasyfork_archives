...
(function () {
    ...
    searchButton.addEventListener('click', async function () {
        ...
        // Close all search pages after 30 seconds
        setTimeout(function () {
            for (let i = 0; i < pages.length; i++) {
                const page = pages[i];
                page.close();
            }
        }, 30000); // Changed to 30 seconds delay
    });
