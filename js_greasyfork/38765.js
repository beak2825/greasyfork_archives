// ==UserScript==
// @name        JR Mturk Panda Crazy (SalemBeats "Delete On Once" Fork)
// @version     0.6.3a
...
// @downloadURL https://update.greasyfork.org/scripts/38765/JR%20Mturk%20Panda%20Crazy%20%28SalemBeats%20%22Delete%20On%20Once%22%20Fork%29.user.js
// @updateURL https://update.greasyfork.org/scripts/38765/JR%20Mturk%20Panda%20Crazy%20%28SalemBeats%20%22Delete%20On%20Once%22%20Fork%29.meta.js
// ==/UserScript==
...
function processResults( theNumber, result, finalUrl, jobData ) {
    ...
    switch(result) {
        ...
        case "ACCEPTED":
            ...
            updateHitCell(theNumber);
			gDelayedSave = true;
            let acceptOnceCheckbox = document.getElementById("deleteAfterAcceptOnce");
            if(acceptOnceCheckbox && acceptOnceCheckbox.checked) {
                if(hitData.once) {
                    removeJob(theNumber);
                    if (gNotifications) { showNotification( "Auto Deleted HIT", "The last HIT was automatically deleted per your settings as a 'once' HIT.", "autodeleted", hitData.groupId); }
                }
            }
            break;
    }
					...
					setTimeout( function() {
						...
						setTimeout( function() {
							...
							setTimeout( function() {
                                ...
                                document.querySelector("span.JRButton[title^='Find help and tips']").parentElement.parentElement.parentElement.insertAdjacentHTML("afterend", ` <span style="float: right;"><label><input type="checkbox" id="deleteAfterAcceptOnce"> Delete after accept once.</label></span>`);
								setTimeout( function() {
									$.modal.close();
