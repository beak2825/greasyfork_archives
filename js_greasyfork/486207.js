...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/486207/Luogu%20Chat%20Plus.user.js
// @updateURL https://update.greasyfork.org/scripts/486207/Luogu%20Chat%20Plus.meta.js
// ==/UserScript==
...
function dictEncode(message)
{
  ...
  for(let i=0;i<message.length;i+=3)
  {
    ...
    a1=base64dict.indexOf(a1);
    a2=base64dict.indexOf(a2);
    a3=base64dict.indexOf(a3);
    log=log+" a[]={"+a1+","+a2+","+a3+"}";
...
function dictDecode(message)
{
  ...
  let fill=base64dict.indexOf(ret[ret.length-1]);
