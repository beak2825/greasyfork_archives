...
// grant          GM_openInTab
// @downloadURL https://update.greasyfork.org/scripts/380670/WEXNET%20Edit%20Shipment.user.js
// @updateURL https://update.greasyfork.org/scripts/380670/WEXNET%20Edit%20Shipment.meta.js
// ==/UserScript==
// 
...
$("#B4693812645036355").parent().parent().parent().append(txtLog);
  $("#logbeforesave").click(function(){    
    ...
    shipment.COMMENTS=csr($("#P271_COMMENTS").val());
      shipment.READYTIME=csr($("#P271_READYTIME").val());
      shipment.CLOSETIME=csr($("#P271_CLOSETIME").val());
