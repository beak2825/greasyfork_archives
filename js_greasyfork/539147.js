...
// v3.8.9  优化预览图加载顺序，优化预览图加载问题。（如遇预览图无法加载成功，优先考虑更新最新chrome版本再使用新版脚本）
...
// @downloadURL https://update.greasyfork.org/scripts/539147/JAV%E8%80%81%E5%8F%B8%E6%9C%BA-%E5%A4%87%E4%BB%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/539147/JAV%E8%80%81%E5%8F%B8%E6%9C%BA-%E5%A4%87%E4%BB%BD.meta.js
// ==/UserScript==
/* jshint -W097 */
(function () {
    'use strict';
    ...
    class Common {
        ...
        static avIdToDmmId(avid) {
            if (/^FC2(-PPV)?-\d+$/.test(avid)) {
            return avid.match(/\d+$/)[0];
            }
            return avid;
        }
        /**
        ...
        static getOneJavSearchUrl(avid) {
            ...
            return "https://missav.ai/cn/search/" + avid;
        }
        /**
            ...
            w.setFourthCallback((elems) => { // todo 20190404
                ...
                if ((/(JavDB)/g).test(document.title) && elems) {
                    elems.toArray().forEach(e => {
                        ...
                        if (!$("#waterfall").hasClass("v cols-4 vcols-8")) {
                            $div.append(`
                                        <a title="Nyaa 搜索" href="https://sukebei.nyaa.si/?f=0&c=0_0&q=${Common.avIdToDmmId(avid)}" target="_blank">
                                            <span class="tag hobby" style="margin-right: 5px;background-color:#00d1b2;">Nyaa</span>
                                        </a>
                                        <a title="115" href="https://115.com/?url=%2F%3Faid%3D1%26cid%3D0%26old_cid%3D0%26old_cid_name%3D%25E6%25A0%25B9%25E7%259B%25AE%25E5%25BD%2595%26search_value%3D${Common.avIdToDmmId(avid)}%26ct%3Dfile%26ac%3Dsearch%26is_wl_tpl%3D1&submode=wangpan&mode=search" target="_blank">
                                            <span class="tag hobby" style="margin-right: 0px;background-color:#418fa7;">115</span>
                                        </a>
                                        <a title="MISSAV 在线看" href="https://missav.ai/cn/search/${Common.avIdToDmmId(avid)}" target="_blank">
                                            <span class="tag hobby" style="margin-right: 3px;background-color:#ad1d18;">MISSAV</span>
                                        </a>
                                        <a title="无码 FC2PPVDB" href="https://fc2ppvdb.com/articles/${Common.avIdToDmmId(avid)}" target="_blank">
                                            <span class="tag hobby" style="margin-right: 3px;background-color:#5D5560;">FC2DB</span>
                                        </a>
                                        <a title="有码 JAVLibrary" href="https://${GM_getValue('javlib_url')}/cn/vl_searchbyid.php?keyword=${avid}" target="_blank">
