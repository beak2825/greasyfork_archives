// ==UserScript==
// @name         Mousehunt Birthday Map Color Coder 2022
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/440829/Mousehunt%20Birthday%20Map%20Color%20Coder%202022.user.js
// @updateURL https://update.greasyfork.org/scripts/440829/Mousehunt%20Birthday%20Map%20Color%20Coder%202022.meta.js
// ==/UserScript==

//credits to @Chirpphixel#8006 for his birthday map color coder: https://greasyfork.org/en/scripts/379354-mousehunt-birthday-map-color-coder
...
function colorize() {
    ...
    var bdMaps = [
        "birthday_f_list", // Birthday Event Map
        "birthday_2021_gilded", // guess
        "birthday_2021_gilded_party_size" // Party Size Gilded Birthday Event Map
    ];

    var map = $(".treasureMapRootView-content > .treasureMapView"); //only show gwh decoration headers if it's a BD map.

    if (!bdMaps.some(mapName => map.hasClass(mapName))) { //exit function if ajax call is not displaying a GWH map
        return;
    }
