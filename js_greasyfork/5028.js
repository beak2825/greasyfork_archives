...
// @downloadURL https://update.greasyfork.org/scripts/5028/CleanHide%20%20Enable%20RightClick-Copy.user.js
// @updateURL https://update.greasyfork.org/scripts/5028/CleanHide%20%20Enable%20RightClick-Copy.meta.js
// ==/UserScript==
...
function keys(evt)  
  {  //var evt=evt?evt:(window.event?window.event:null);
      ...
      {  //var CleanHideObj=new CleanHideClass();
          ...
          alert("清除隐藏文字&解除右键限制！！ 快捷键: CTRL+Q"); 
 
      } 
  } 
document.addEventListener('keydown', keys, false); 
GM_registerMenuCommand  ('清除隐藏文字&解除右键限制',
function(e){
CleanHideObj.on(0,1)
alert("清除隐藏文字&解除右键限制！！ 快捷键: CTRL+Q");
});
