...
// @author       jim
// @include        /http[s]?\:\/\/([a-z\.]*\.)?[myjavbay|eporner|footfan|sis001|theporn|av6k|eqpp|bdsmx|vjav|soav|pornlulu|arival|avtb|wk2024].*\..*/
// @exclude        *://*.doubleclick.*/*
// @exclude        *://*advertising*
// @exclude        *://*banner*
// @grant         GM_getValue
...
// @downloadURL https://update.greasyfork.org/scripts/456203/remove%20ads.user.js
// @updateURL https://update.greasyfork.org/scripts/456203/remove%20ads.meta.js
// ==/UserScript==
...
async function withJQuery(callback, safe = false, unsafeWindow) {
    let dollar
    if (typeof $ != "undefined")
        dollar = $
...
withJQuery(async function ($, win) {
    await remove_adds($, win)
})