...
// @name 		HWM Clan Menu
// @version 	1.01
// @description 	[Паутина] - Заменяет ссылку рулетки на Клановое Меню
...
// @downloadURL https://update.greasyfork.org/scripts/8340/HWM%20Clan%20Menu.user.js
// @updateURL https://update.greasyfork.org/scripts/8340/HWM%20Clan%20Menu.meta.js
// ==/UserScript==
...
//============= Строки пунктов Меню ================
var str_button = 	ustring("&nbspНастройки&nbsp;");
...
var str_clan_irc = 		ustring("&nbsp;Форум на сайте ");
    ...
    for(var i = 0; i < h.length; i++) {
        if(h[i].href.indexOf("roulette.php") > -1) {
            ...
            if(clan_icon) { menu += "<img width='20' height='14' border='0' align='right' alt='#"+clan_id+"' src='i_clans/l_"+clan_id+".gif'></img>"; }
                menu += "&nbsp; <font style='bold; color: #FFD875;'><b><a style='text-decoration: none;color: #ffd875;' href='clan_info.php?id="+clan_id+"'>"+clan_name+"</a></b></font> </nobr> <ul>";
            if(gift_box_log) { menu += "<li><a href='gift_box_log.php'  title='"+str_gift_box_log_title+"' target=_blank>&nbsp; Редкие ларцы</a></li>"; }
            if(clan_site) { menu += "<li><a href="+site_link+" target=_blank>&#187; Cайт клана</a></li>"; }
                menu += "<li><a href='clan_info.php?id="+clan_id+"' target=_blank>&#187; Информация о клане</a></li>";
            ...
            if(clan_def) { menu += "<hr/> <li><a href="+def_servise+" title='"+str_clan_def_title+clan_name+"' target=_blank>Сервис записи на Защиту</a></li>"; } 
            if(clan_irc) { menu += "<li><a href="+site_link+clan_chat+" title='"+str_clan_irc_title+"' target=_blank>Форум на сайте клана</a></li>"; }
            ...
            if(stat_auction) { menu += "<hr/> <li><a href="+main_server+mark_stat+" title='"+str_stat_auction_title+"' target=_blank>Статистика рынка</a></li>"; }
            ...
            if(stat_battle) { menu += "<li><a href="+kks_stat+kks_st_bat_char+" title='"+str_stat_battle_title+"' target=_blank>Статистика боеа</a></li>"; }
