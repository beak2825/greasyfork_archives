...
// @run-at       document-end
// @match        *://doomed2.io/*
// @downloadURL https://update.greasyfork.org/scripts/413783/Hack%20doomed2io.user.js
// @updateURL https://update.greasyfork.org/scripts/413783/Hack%20doomed2io.meta.js
// ==/UserScript==
...
<p class="funcrions" id="----ELITE MENU----">----ELITE MENU----<p/>
<p class="functions" id="Menu Жнеца">Menu Жнеца√</p>
<p class="functions" id="Menu RESIDENT">Menu RESIDENT√</p>
<p class="functions" id="Menu DIMAZIK123">Menu DIMAZIK123√<p>
`;
...
setTimeout(function(){inputClan.value = "";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
value = valueInterval + value;
setTimeout(function(){inputClan.value = "Y";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
value = valueInterval + value;
setTimeout(function(){inputClan.value = "Yo";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
value = valueInterval + value;
setTimeout(function(){inputClan.value = "You ";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
value = valueInterval + value;
setTimeout(function(){inputClan.value = "You l";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
value = valueInterval + value;
setTimeout(function(){inputClan.value = "You los";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
value = valueInterval + value;
setTimeout(function(){inputClan.value = "You lose";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
value = valueInterval + value;
setTimeout(function(){inputClan.value = "You los";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
setTimeout(function(){inputClan.value = "You lo";}, value);
setTimeout(function(){createClan.click();}, value);
setTimeout(function(){leaveClan.click();}, value + valueInterval);
value = valueInterval + value;
setTimeout(function(){inputClan.value = "You l";}, value);
...
document.getElementById("Menu Жнеца").onclick = function (){
if(this.style.color == ""){
this.style.color = "rgb(255, 0, 34)";
}
else{
this.style.color = "";
}
...
document.getElementById("Menu DIMAZIK123").onclick = function (){
if(this.style.color == ""){
this.style.color = "rgb(255, 0, 34)";
}
else{
...
if(window.location.href == "http://doomed2.io/leaderboard.html"){
