...
// @grant		unsafeWindow
// @grant		GM_info
// @downloadURL https://update.greasyfork.org/scripts/30640/MouseHunt%20AutoBot%20Enhanced%20Edition.user.js
// @updateURL https://update.greasyfork.org/scripts/30640/MouseHunt%20AutoBot%20Enhanced%20Edition.meta.js
// ==/UserScript==
...
function embedTimer(targetPage) {
    if (showTimerInPage) {
        ...
        if (headerElement) {
			...
			else if (targetPage && browser != 'chrome' && browser != 'firefox')
