// ==UserScript==
// @name   🌱【免费版】徐州市建筑施工企业安管人员安全生产知识继续教育培训|如需自动下一集、自动换课程、无人值守等高级功能见收费版本：https://doc.zhanyc.cn/pages/xzsjzsgqy/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制、自动下一集功能。如需自动下一集、自动换课程、全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://218.3.178.60*
// @include    *://*xzit.edu.cn*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/506098/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%BE%90%E5%B7%9E%E5%B8%82%E5%BB%BA%E7%AD%91%E6%96%BD%E5%B7%A5%E4%BC%81%E4%B8%9A%E5%AE%89%E7%AE%A1%E4%BA%BA%E5%91%98%E5%AE%89%E5%85%A8%E7%94%9F%E4%BA%A7%E7%9F%A5%E8%AF%86%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E5%9F%B9%E8%AE%AD%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxzsjzsgqy.user.js
// @updateURL https://update.greasyfork.org/scripts/506098/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%BE%90%E5%B7%9E%E5%B8%82%E5%BB%BA%E7%AD%91%E6%96%BD%E5%B7%A5%E4%BC%81%E4%B8%9A%E5%AE%89%E7%AE%A1%E4%BA%BA%E5%91%98%E5%AE%89%E5%85%A8%E7%94%9F%E4%BA%A7%E7%9F%A5%E8%AF%86%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E5%9F%B9%E8%AE%AD%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxzsjzsgqy.meta.js
// ==/UserScript==
(function () {
    ...
    let docUrl = "http://doc.zhanyc.cn/pages/xzsjzsgqy/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/mytraining/trainvideo.ftl")) {
                plugMain.page_video();
            } else if (url.includes("/StTrain/loadCourseDetail?")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/index")) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/StExam/gotoExam/")) {
                plugMain.page_gotoExam();
            }
        },
        async page_video() {
            ...
            await plugMain.waitOf((a) => $(".play_list li").length > 0);
            await plugMain.waitTimeout(1000);
            let $el = null;
            let checkYCTime = 2 * 60;
            let checkYCTimeTemp = checkYCTime;
            let lastTime = 0;
            $(".play_list li").each((i, el) => {
                let zt = $(el).find("h3").next().find(">span:first").text();
                if (zt == "已学习") {
                    return true;
                }
                $el = $(el);
            ...
            if ($el == null) {
                plugMain.confirmRun("当前课程学习完毕，准备学习下一门课程").then((a) => {
                    plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
                });
                return;
            }
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    // 答题测试 控制台执行： courseWareTime[4].learningtime=parseInt(curcourseware.playtime)+2
                    if (plugMain.getElByText($(".popupHead"), "课件学习答题") != null) {
                        plugMain.pageData.waitTime = 10;
                        let index = plugMain.formatAnswerOption(unsafeWindow.curAnswerStd);
                        if (unsafeWindow.curAnswerStd == "0") index = 1;
                        else if (unsafeWindow.curAnswerStd == "1") index = 0;
                        $(".test_content_nr_main label").eq(index).click();
                        await plugMain.waitTimeout(1000);
                        plugMain.getElByText($("a"), "提交答案")[0].click();
                        layer.msg("等待10秒");
                        return;
                    }
                    ...
                    if ($tips != null) {
                        plugMain.pageData.waitTime = 10;
                        plugMain.confirmRun("检测到问题，从头学").then((a) => {
                            plugMain.getElByText($("a.l-btn:visible"), "确定")[0].click();
                        });
                        return;
                    }
                    ...
                    if (lastTime == plugMain.getCurTime()) {
                        checkYCTimeTemp -= timeout;
                        if (checkYCTimeTemp <= 0) {
                            plugMain.pageData.waitTime = 20;
                            checkYCTimeTemp = checkYCTime;
                            plugMain.confirmRun("检测到出现异常，准备刷新页面").then((a) => {
                                location.reload();
                            });
                            return;
                        }
