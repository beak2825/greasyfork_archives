// ==UserScript==
// @name Téléchargez les vidéos Youtube grâce à Nadiro
// @description Ajoute un bouton "Nadiro" sur Youtube pour télécharger des vidéos.
// @author Nadiro (designed by Gantt)
// @version 1.8.7
// @date 2016-03-19
...
// @downloadURL https://update.greasyfork.org/scripts/18752/T%C3%A9l%C3%A9chargez%20les%20vid%C3%A9os%20Youtube%20gr%C3%A2ce%20%C3%A0%20Nadiro.user.js
// @updateURL https://update.greasyfork.org/scripts/18752/T%C3%A9l%C3%A9chargez%20les%20vid%C3%A9os%20Youtube%20gr%C3%A2ce%20%C3%A0%20Nadiro.meta.js
// ==/UserScript==
...
(function () {
  ...
  var BUTTON_TEXT={'ar':'Nadiro','cs':'Nadiro','de':'Nadiro','en':'Nadiro','es':'Nadiro','fr':'Nadiro','hi':'Nadiro','hu':'Nadiro','id':'Nadiro','it':'Nadiro','ja':'ダウンロード','ko':'Nadiro','pl':'Nadiro','pt':'Nadiro','ro':'Nadiro','ru':'Nadiro','tr':'Nadiro','zh':'Nadiro','zh-TW':'Nadiro'};
  var BUTTON_TOOLTIP={'ar':'تنزيل هذا الفيديو','cs':'Stáhnout toto video','de':'Dieses Video herunterladen','en':'Download this video with Nadiro','es':'Descargar este vídeo con Nadiro','fr':'Télécharger cette vidéo grâce à Nadiro','hi':'वीडियो डाउनलोड करें','hu':'Videó letöltése (Nadiro)','id':'Unduh video ini (Nadiro)','it':'Scarica questo video (Nadiro)','ja':'Nadiroとこのビデオをダウンロードする','ko':'이 비디오를 내려받기 (Nadiro)','pl':'Pobierz plik wideo','pt':'Baixar este vídeo (Nadiro)','ro':'Descărcați acest videoclip (Nadiro)','ru':'Скачать это видео(Nadiro)','tr': 'Bu videoyu indir','zh':'下载此视频','zh-TW':'下載此影片'};
  var DECODE_RULE=[];
