...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/481792/Modify%20Checkout%20Page%20and%20Auto-fill%20Form1.user.js
// @updateURL https://update.greasyfork.org/scripts/481792/Modify%20Checkout%20Page%20and%20Auto-fill%20Form1.meta.js
// ==/UserScript==
...
(function() {
        ...
        <div class="form-group ng-scope">
            ...
            <div class="margin-bottom-small">
                <div class="row">
                    ...
                    <span class="col-xs-12 col-sm-8" name="order[delivery_data][location_code]" ng-non-bindable="" translate="no">274838</span>
                </div>
                <div class="row">
                    <span class="col-xs-12 col-sm-4">已選擇門市名稱:</span>
                    <span class="col-xs-12 col-sm-8" name="order[delivery_data][location_name]" ng-non-bindable="" translate="no">逢科門市</span>
                </div>
                <div class="row">
                    <span class="col-xs-12 col-sm-4">門市地址:</span>
                    <span class="col-xs-12 col-sm-8" name="order[delivery_data][store_address]" ng-non-bindable="">臺中市西屯區青海路二段556號</span>
                </div>
            </div>
    ...
    fillTextInputById('recipient-phone', '0985312009');
