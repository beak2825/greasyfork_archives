// ==UserScript==
 // @name   KF - 100
 // @name:ru Aron Razo - Script Vologda
 // @description  Suggestions for improving the script write here ---> https://vk.com/dragon.vladislav
 // @description:ru Предложения по улучшению скрипта и информацию о багах писать сюда ---> https://vk.com/dragon.vladislav
// @version 2.1 3.0 2.2 2.7
 // @namespace https://forum.blackrussia.online
 // @match        https://forum.blackrussia.online/threads/*
// @match      https://forum.blackrussia.online/threads/
 // @grant        none
 // @license   MIT
 // @supportURL https://vk.com/dragon.vladislav
 // @icon https://i.postimg.cc/0yXcdK38/1000008008-round.png
// @downloadURL https://update.greasyfork.org/scripts/540828/KF%20-%20100.user.js
// @updateURL https://update.greasyfork.org/scripts/540828/KF%20-%20100.meta.js
// ==/UserScript==
(function () {
  'use strict';
     ...
     },
{
       ...
       content:
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]' +
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Данный игрок уже был наказан.[/CENTER]<br><br>" +
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]',
       prefix: CLOSE_PREFIX,
       status: false,
      },
    {
       ...
       content:
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]' +
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER][B][I][FONT=georgia]Ответ уже был дан в прошлой жалобе[/CENTER]<br><br>" +
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]',
       prefix: CLOSE_PREFIX,
       status: false,
     },
    {
       ...
       content:
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]' +
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER][B][I][FONT=georgia]На ваших доказательствах нет условий сделки, мы не сможем ее рассмотреть.[/CENTER]<br><br>" +
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]',
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
      {
       ...
       content:
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]' +
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваши доказательства обрываются, мы не сможем вынести вердикт, загрузите видеодоказательства на YouTube.[/CENTER]<br><br>"+
        '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]',
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
       ...
       content:
         '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]' +
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Если видеодоказательство длится 3 минуты и более, вам следует указать таймкоды, в противном случае жалоба будет отказана.[/CENTER]<br><br>"+
        '[url=https://postimg.cc/kVLv7ng1][img]https://i.postimg.cc/Tw37q1M6/1000004939.png[/img][/url]',
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
     ...
     },
{
...
},
     {
         ...
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
         "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]1.07.[/color]Запрещено находиться в форме внутри казино, учавствовать в битве за контейнера, учавствовать в захвате семейного контейнера, находиться на авторынке с целью продажи/покупки авто. [COLOR=rgb(255, 0, 0)] | Jail 30 минут" +
         '[url=https://postimg.cc/p9wrqN3w][img]https://i.postimg.cc/sXXWfsmg/1000004933.png[/img][/url]',
         prefix: ACCEPT_PREFIX,
         status: false,
     },
     ...
     title: 'нонрп коп',
         ...
         '[url=https://postimg.cc/p9wrqN3w][img]https://i.postimg.cc/sXXWfsmg/1000004933.png[/img][/url]' +
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Игрок будет наказан по пункту правил государственных организаций[/CENTER]<br><br>" +
         "[CENTER]Запрещено выдавать розыск без Role Play причины [COLOR=rgb(255, 0, 0)] | Warn" +
         '[url=https://postimg.cc/p9wrqN3w][img]https://i.postimg.cc/sXXWfsmg/1000004933.png[/img][/url]',
         prefix: ACCEPT_PREFIX,
       status: false,
     },
     ...
     title: 'замена /ad',
         ...
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Игрок будет наказан по пункту правил государственных организаций[/CENTER]<br><br>" +
         "[CENTER]Запрещено редактировать поданные объявления в личных целях заменяя текст объявления на несоответствующий отправленному игроком  [COLOR=rgb(255, 0, 0)] | Ban 7 дней + ЧС организации" +
         '[url=https://postimg.cc/p9wrqN3w][img]https://i.postimg.cc/sXXWfsmg/1000004933.png[/img][/url]',
         prefix: ACCEPT_PREFIX,
       status: false,
     },
     ...
     {
 		title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ                                ᅠ⠀             ⠀ ⠀⠀ᅠ RolePlay биография  ⠀        ⠀    ⠀      ⠀ᅠ     ᅠ ᅠ     ᅠ ᅠ ᅠ ',
         dpstyle: 'oswald: 3px;     color: #FFD700; background: #181513; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 1px solid #FFD700; width: 96%',
},
      {
     ...
     },
  {
     ...
     },
     {
       ...
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
         "🍃 Причина: Отсутствие личного даты рождения. [/CENTER][/FONT]",
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
     {
     ...
     },
     {
       ...
       '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
         " 🍃 Причина: У Вас уже есть существующая RolePlay биография. [/CENTER][/FONT]",
       prefix: UNACCEPT_PREFIX,
       status: false,
     }, 
  {
     ...
     },
      {
       ...
       status: false,
             ...
             {
       title: 'Недостаточно инфы о юности и взрослой жизни',
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
         "🍃 Причина:  Недостаточно информации о юности и взрослой жизни вашего персонажа. [/CENTER][/FONT]",
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
                {
       title: 'Недостаточно инфы о настоящем времени',
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
         "🍃 Причина:  Недостаточно информации о настоящем времени вашего персонажа. [/CENTER][/FONT]",
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
      {
     ...
     },
     {
      ...
      {
 		title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ                                ᅠ⠀             ⠀ ⠀⠀ᅠ ᅠ ᅠ RolePlay ситуации     ⠀ᅠ     ᅠ ᅠ     ᅠ ᅠ ᅠ ',
         dpstyle: 'oswald: 3px;     color: #FFD700; background: #181513; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 1px solid #FFD700; width: 96%',
},
          {
       title: 'Ошиблись разделом',
     ...
     },
  {
       ...
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         '[CENTER]Ваша RolePlay ситуация получает статус: [Color=Red] Отказано. [/color]',
      prefix: UNACCEPT_PREFIX,
       status: false,
     },
          {
       ...
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваша RolePlay ситуация получает статус: [Color=Lime] 🍃 Одобрено 🍃.[/I][/CENTER][/color][/FONT]",
       prefix: ACCEPT_PREFIX,
       status: false,
     },
          {
 		title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ                                ᅠ⠀             ⠀ ⠀⠀ᅠ ᅠᅠRolePlay организации    ⠀        ⠀    ⠀      ⠀ᅠ     ᅠ ᅠ     ᅠ ᅠ ᅠ ',
         dpstyle: 'oswald: 3px;     color: #FFD700; background: #181513; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: 1px solid #FFD700; width: 96%',
},
              {
       title: 'Ошиблись разделом',
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]К сожалению, Вы ошиблись разделом. Данный раздел предназначен для написания неофициальных RolePlay организаций.[/CENTER]<br><br>" +
         '[CENTER][B][COLOR=rgb(255, 0, 0)]🍃「[SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman] Закрыто. [/FONT][/COLOR][/SIZE]」🍃 [/COLOR][/B] [/CENTER]',
       prefix: UNACCEPT_PREFIX,
       status: false,
     },
  {
       ...
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         '[CENTER]Ваша неофициальная RolePlay организация получает статус: [Color=Red] Отказано. [/color]',
      prefix: UNACCEPT_PREFIX,
       status: false,
     },
          {
       ...
       content:
         '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER]Ваша неофициальная RolePlay организация получает статус: [Color=Lime] 🍃 Одобрено 🍃.[/I][/CENTER][/color][/FONT]",
       prefix: ACCEPT_PREFIX,
       status: false,
     },
];
