// ==UserScript==
// @name         Pop Theme (Shellshock.io)
// @namespace    http://tampermonkey.net/
// @version      0.42
// @description  Become a pop!
// @author       Blizzard
...
// @grant        none
// @lisense MIT
// @downloadURL https://update.greasyfork.org/scripts/445089/Pop%20Theme%20%28Shellshockio%29.user.js
// @updateURL https://update.greasyfork.org/scripts/445089/Pop%20Theme%20%28Shellshockio%29.meta.js
// ==/UserScript==
...
* {
	...
	--ss-lightoverlay: url("https://amyshealthybaking.com/wp-content/uploads/2018/03/stovetop-air-popped-popcorn-1618.jpg"); /*Main Background*/
...
.hardBoiledShield {
    ...
    transform: translateX(-50%);
    height: 100%;
  content: url('https://media.discordapp.net/attachments/965471212153217044/965784867604422716/j.png');
}
...
#maskmiddle {
	background: url('https://media.discordapp.net/attachments/968123052267294761/975951313764495421/pop.png') center center no-repeat;
...
.playerSlot--icons .vip-egg {
  ...
  content: url('https://media.discordapp.net/attachments/965471212153217044/965576829786267688/Screen_Shot_2022-04-18_at_18.07.05.png') !important;
  max-height: 1.3em;
  max-width: 1.3em;
}
...
#best_streak_container h1 {
    ...
    background-image: url('https://pngimg.com/uploads/popcorn/popcorn_PNG52.png');
...
.egg_icon {
   ...
   content: url(https://www.pngmart.com/files/3/Popcorn-PNG-Transparent-Image.png)
}

#killBox::before{
  font-size: 1.4em;
  font-weight: 900;
  content: ' 🏵YOU POPPED🏵'!important;
  color: yellow;
  }
#killBox h3{
  display:none;
...
#deathBox::before{
  font-size: 1.4em;
  font-weight: 900;
  content: '🏵 YOU WERE POPPED BY🏵 '!important;
  color: yellow;
}
