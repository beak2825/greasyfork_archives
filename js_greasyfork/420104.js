...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/420104/Auto%20Loot.user.js
// @updateURL https://update.greasyfork.org/scripts/420104/Auto%20Loot.meta.js
// ==/UserScript==
...
function add10xBtn() {
    function genBtn(txt, time, index) {
        ...
        console.log('loot' + time.toString() + 'x' + (index).toString())
