...
// @downloadURL https://update.greasyfork.org/scripts/510536/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20EFrozen.user.js
// @updateURL https://update.greasyfork.org/scripts/510536/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20EFrozen.meta.js
// ==/UserScript==
...
const buttons = [
     {
      ...
      content:
        ...
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
		...
		'[Color=AQUA][CENTER][ICODE]Приятной игры на NOVGOROD.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>',
	  status: false,
    },
     {
      title: 'Отказано, закрыто',
      content: '[Color=Red][CENTER][ICODE]Отказано, закрыто.[/ICODE][/CENTER][/color]',
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      title: 'Одобрено, закрыто',
      content: '[Color=LimeGreen][CENTER][ICODE]Одобрено, закрыто.[/ICODE][/CENTER][/color]',
      prefix: ACCСEPT_PREFIX,
	 status: false,
    },
    {
      title: 'Закрыто',
      content: '[COLOR=RED][CENTER][ICODE]Закрыто.[/ICODE][/CENTER][/COLOR]',
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
      ...
      content:
		"[B][FONT=Times New Roman][CENTER][COLOR=Red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/FONT][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
        "[CENTER][FONT=Times New Roman][COLOR=#FFFF00][ICODE]Ваша жалоба взята на рассмотрение.<br>Просьба ожидать ответа и не создавать дубликаты данной темы.[/ICODE][/FONT][/COLOR][/CENTER]<br>" +
        '[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>' +
		'[Color=AQUA][CENTER][FONT=Times New Roman][ICODE]Ожидайте ответа.[/ICODE][/COLOR][/CENTER]'+
         '[url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]',
      prefix: PINN_PREFIX,
	  status: false,
    },
    {
      title: 'Нарушений не найдено лд',
	  content:
		"[B][CENTER][COLOR=Red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
		"[CENTER][COLOR=#FFFF00][ICODE]Нарушений со стороны лидера не было найдено.[/ICODE][/COLOR][/CENTER]<br>" +
        '[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на NOVGOROD.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
        '[Color=#ff0000][FONT=times new roman][CENTER][I][ICODE]Закрыто.[/ICODE][/I][/CENTER][/color][/FONT]',
    ...
    },
    {
      ...
      content:
		...
		'[Color=AQUA][CENTER][ICODE]Приятной игры на NOVGOROD.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
		'[Color=LimeGreen][FONT=times new roman][CENTER][I][ICODE]Одобрено.[/ICODE][/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
{
      ...
      content:
        ...
        '[Color=AQUA][CENTER][ICODE]Приятной игры на NOVGOROD.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
		'[Color=GREEN][CENTER][I][ICODE]Одобрено, закрыто.[/ICODE][/I][/CENTER][/color]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=Red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
        "[CENTER][COLOR=#FFFF00]Вы ошиблись разделом.<br>Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.3553/']Жалобы на администрацию[/URL].[/COLOR][/CENTER]<br>" +
		'[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на NOVGOROD.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
        '[Color=#ff0000][FONT=times new roman][CENTER][I][ICODE]Отказано, закрыто.[/ICODE][/I][/CENTER][/color][/FONT]',
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=Red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
        "[CENTER][COLOR=#FFFF00]Вы ошиблись разделом.<br>Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.3556/']Обжалование наказаний[/URL].[/COLOR][/CENTER]<br>" +
		'[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на NOVGOROD.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
        '[Color=#ff0000][FONT=times new roman][CENTER][I][ICODE]Отказано, закрыто.[/ICODE][/I][/CENTER][/color][/FONT]',
    ...
    },
    {
		...
		"[B][CENTER][COLOR=Red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MHkstLPP/RvBD5.gif[/img][/url]<br>'+
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://forum.blackrussia.online/threads/n-novgorod-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.10560601/']с правилами написания RolePlay биографий.[/URL][/CENTER]<br>" +
