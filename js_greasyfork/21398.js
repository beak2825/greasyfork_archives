...
// @namespace    http://amcgaming.net/chatbox/
// @version      1.0
// @description  Avoir le smilies Grandma dancing et Dab sur la Shoutbox AMCGaming
// @author       Marentdu93
// @match        http://amcgaming.net/
// @match        http://amcgaming.net/chatbox/
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/21398/%28Dab%29%20%28Gran%29%20shout.user.js
// @updateURL https://update.greasyfork.org/scripts/21398/%28Dab%29%20%28Gran%29%20shout.meta.js
// ==/UserScript==
	...
	CheckFA: function(){
		...
		for(var i in msg) {
            ...
            if(msg_text.indexOf(this.fatext) != -1){
              ...
              document.getElementById('taigachat_message_' + id).getElementsByTagName('span')[2].getElementsByTagName('div')[0].innerHTML = lol +'<img src="http://image.noelshack.com/fichiers/2016/28/1468590111-images.png" width="50" height="35">'+ lol2;
