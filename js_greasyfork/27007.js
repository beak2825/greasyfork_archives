...
// @downloadURL https://update.greasyfork.org/scripts/27007/Hybrid%20-%20Calls%20-%20Contact.user.js
// @updateURL https://update.greasyfork.org/scripts/27007/Hybrid%20-%20Calls%20-%20Contact.meta.js
// ==/UserScript==
...
if ($('li:contains("Radius")').length) {
    ...
    createButton('Biz on vm',0,0,2,2,'business on voicemail');
