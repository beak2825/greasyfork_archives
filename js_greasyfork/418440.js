...
// @grant          GM_openInTab
// @license	   MIT
// @downloadURL https://update.greasyfork.org/scripts/418440/hwm_time_restore.user.js
// @updateURL https://update.greasyfork.org/scripts/418440/hwm_time_restore.meta.js
// ==/UserScript==
...
// (c) 01.02.2023 6.4.4, перф: изменение кода отображения времени следующей охоты на странице карты.
...
(function() {
  ...
  function setTexts(){
    ...
    if (url.match('lordswm')) {
      ...
      obj = {
        ...
        regexp_go_timer : 'Охота будет доступна через',
  ...
  function checkMapHunter(){
    ...
    if (temp_nl.length > 0 && !document.querySelector("img[src*='btns/HuntBtnGold_Pass.png']")) {
      options.map_hunter = 'false';
    ...
    var delta2 = /MapHunterDelta = (\d+)/.exec(b.innerHTML);
