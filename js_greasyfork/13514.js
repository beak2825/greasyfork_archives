...
// @downloadURL https://update.greasyfork.org/scripts/13514/GreasyFork%20Bullshit%20Filter%20-%20for%20TS%20Citrus%20Gfork.user.js
// @updateURL https://update.greasyfork.org/scripts/13514/GreasyFork%20Bullshit%20Filter%20-%20for%20TS%20Citrus%20Gfork.meta.js
// ==/UserScript==
...
(function() {
	...
	if (isOnForum) {
		...
		site.cssDebug = '.discussion-list-item.filtered { background-color: khaki !important; } ' + commonCss;
		...
		site.applyFilter = function(el, activeFilter) {
			let temp = el.children[1].innerText;
