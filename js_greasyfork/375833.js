...
// @downloadURL https://update.greasyfork.org/scripts/375833/EH%E6%B1%89%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/375833/EH%E6%B1%89%E5%8C%96.meta.js
// ==/UserScript==
//==============================================变量声明==============================================
...
var Page 		=
{
	"main":
	{
		...
		,"#lb a:contains('Donations')"		:"捐款"
		,"#lb a:contains('Hath Perks')"		:"特殊功能"
		,"#lb a:contains('Hath Exchange')"	:"Hath交易"
		,"#lb a:contains('GP Exchange')"	:"GP交易" //Gallery Points
		...
		,"#toppane h1.ih:contains('E-Hentai Galleries: The Free Hentai Doujinshi, Manga and Image Gallery System')":
			"<a href='https://goo.gl/OJksVO'>E-Hentai图库: 免费的同人志、漫画、图片画册系统</a>"
		,"#toppane h1.ih:contains('ExHentai.org - The X Makes It Sound Cool')":
			"<a href='https://goo.gl/OJksVO'>ExHentai.org - The X Makes It Sound Cool</a>"
		,"#searchbox p.nopm a:contains('Show Advanced Options')"	:"显示高级选项"
		,"#searchbox p.nopm a:contains('Show File Search')"			:"显示文件搜索"
		...
		[
			...
			,["html","div.dp"
				...
				,"后使用本站功能."]
			,["html","div.ido p.ip a"	,"Visit the E-Hentai Main Site"	,"E-Hentai主站"]
			,["html","div.ido p.ip a"	,"Visit the E-Hentai Forums"	,"E-Hentai论坛"]
			,["html","div.ido p.ip a"	,"E-Hentai @ Twitter"			,"E-Hentai推特"]
			,["html","div.ido p.ip a"	,"Play the HentaiVerse Minigame","E-Hentai小游戏"]
			,["html","div.ido p.ip a"	,"Lo-Fi Version"				,"E-Hentai移动版"]
			...
			,["attr","#searchbox p.nopm a:contains('显示高级选项')"	,	"title"	,"显示/隐藏高级选项"]
			,["attr","#searchbox p.nopm a:contains('显示文件搜索')"	,	"title"	,"显示/隐藏文件搜索"]
	...
	"e-hentai.org/":
	{
		//主页
		 "#newshead strong:contains('Welcome to E-Hentai Classic, the portal to the E-Hentai Universe.')":
			"欢迎来到E-Hentai首页：通往E-Hentai大宇宙的星门所在."
		...
		,"div[id='gcb']:contains('(This space was intentionally left blank.)')"	:"(无描述)"
	...
	{
		//主页
		 "div.stuffbox h1:contains('Hentai@Home Clients')"			:"Hentai@Home Hentai@Home客户端"
		...
		,"#div_clients table.hct th:contains('Hathrate')"			:"Hath比率"
		...
		,"td.infota:contains('Advanced Settings')"					:"高级选项"
		...
		,"td.infotv:contains('The settings below are optional advanced settings.')":"以下高级选项请先了解后更改"
		...
		[
			...
			,["html","#div_download p"
				...
				,"Hentai@Home的发布是基于开放源代码计划中，第三版本的GNU通用公共授权条款."]
			,["html","#div_download p"
			...
			,["html","div.infotext p"
				...
				+"<br>Hath的获得'基本上'是由上传文件的单位时间获取比率所决定"
				+"<br>所以越大的空间也代表更多的文件获取量，取得更多Hath"
			...
			,["html","div.infotext p"
				...
				,"<br>可以把H@H客户端当作浏览图片的代理服务器 ( 仅限E-Hentai )."]
	...
	"bitcoin.php":
	{
		...
		,"#tdon th:contains('Daily Hath')"		:"每日Hath"
		...
		[
			...
			*/
			...
			,["html","div.stuffbox p:contains('Three confirmations are required for')"
				...
				,"本页可让你在电脑、手机上，从在线服务或本地钱包转帐比特币至E-Hentai，"]
			,["html","div.stuffbox p:contains('Three confirmations are required for')"
			...
			,["html","#tdon td.tdon5","Credits"	,"<font color='Teal'>Credits</font>"]
			,["html","#tdon td.tdon5","GP"		,"<font color='RoyalBlue'>GP</font>"]
			,["html","#tdon td.tdon6","Hath"	,"<font color='DarkOrchid'>Hath</font>"]
	...
	"manage.php":
	{
		...
		,"div.ui form td:contains('Gallery Description')"			:"画册描述"
		...
		,"div.stuffbox td:contains('Desc:')" :"描述："
		...
		,"div.stuffbox a:contains('Modify Title or Description')"	:"更改标题或描述"
		...
		[
			...
			,["html","select[name='publiccat']","Artist CG Sets","画师图片 - Artist CG Sets"]
			,["html","select[name='publiccat']","Game CG Sets"	,"游戏CG - Game CG Sets"]
			...
			,["html","select[name='publiccat']","Cosplay"		,"角色扮演 - Cosplay"]
	...
	"toplist.php":
	{
		 "div.ido h1 a:contains('EHG Toplists')"			:"E-Hentai排行总榜"
		...
		,"div.ido h2:contains('Hentai@Home Toplists')"	:"Hentai@Home排行"
		,"div.ido a:contains('Hentai@Home All-Time')"	:"Hentai@Home时间总排行"
		,"div.ido a:contains('Hentai@Home Past Year')"	:"Hentai@Home去年排行榜"
		,"div.ido a:contains('Hentai@Home Past Month')"	:"Hentai@Home上个月排行"
		,"div.ido a:contains('Hentai@Home Yesterday')"	:"Hentai@Home昨天排行榜"
	...
	"bounty_post.php":
	{
		...
		,"span:contains('Detailed Bounty Description:')"		:"悬赏详细描述："
		...
		[	
			...
			,["html","td:contains('in Credits and/or Hath.')"
				...
				,"使用<font color='RoyalBlue'>绅士币</font>或<font color='DarkOrchid'>Hath</font>. "
				+"<br>最低赏金为 20000 <font color='RoyalBlue'>绅士币</font>或 2 <font color='DarkOrchid'>Hath</font>."]
			,["html","td:contains(' Credits')"
				," Credits"
				," <font color='RoyalBlue'>绅士币 ( Credits )</font>"]
			,["html","td:contains(' Hath')"
				," Hath"
				," <font color='DarkOrchid'>Hath ( Hath )</font>"]
	...
	"bounty.php":
	{
		...
		[
			...
			,["html","div.brd td.bd2"," Hath"," <font color='DarkOrchid'>Hath</font>"]
			,["attr","input[value='Rescind']"			,	"value","撤销"]
			,["html","div.brd p"
				,"If you wish, you can throw in some more Credits or Hath for this reward."
				,"可以照想法加码<font color='RoyalBlue'>绅士币</font>或<font color='DarkOrchid'>Hath</font>."]
			,["html","div.brd p"
			...
			,["html","div.brd p strong:contains('Hath')"	,"Hath"		,"<font color='DarkOrchid'>Hath</font>"]
			...
			,["html","div.brd form p"," Hath "				," <font color='DarkOrchid'>Hath</font> "]
			...
			,["html","div.stuffbox div[style*='wanted.png'] p"," Hath"," <font color='DarkOrchid'>Hath</font>"]
	...
	"home.php":
	{
		...
		[
			...
			,["html","div.homebox td","GP from Hentai@Home"			,"<font color='green'>图币</font>来自于Hentai@Home"]
			
			,["html","div.homebox td","You are currently:"		,"当前排名："]
			,["html","div.homebox td","on the "					,"名位于 "]
			,["html","div.homebox td"," toplist"				," 排行榜"]
			//EHG Toplists
			,["html","div.homebox td a","Hentai@Home "			,"Hentai@Home"]
			...
			,["html","div.homebox td","Uploads/H@H"		,"上传/H@H"]
	...
	"uconfig.php":
	{
		...
		,"#outer h2:contains('Hentai@Home Proxy')"		:"Hentai@Home"
		...
		[
			...
			,["html","div.optmain p"
				...
				,"下面输入Hentai@Home的网络IP跟通信端口，所有图片都会通过此客户端连接，"]
			,["html","div.optmain p"
			...
			,["html","div.optmain p"
				...
				,"但是Hentai@Home的默认值，客户端必须是同台电脑或同局域网路才可准许连接  ( 或更改设置但不建议 )."]
	...
	"hathperks.php":
	{
		 "div.stuffbox h1:contains('Hath Perks')"	:
			"Hath(Hath)：<a href='https://youtu.be/mJsnsKs5ZHQ' target='_bank'>特异功能</a>"
		 
		,"div.stuffbox a[href*='exchange.php?type=hath']:contains('Hath Exchange')"	:"Hath Exchange ( Hath交易 ) "
		...
		[	
			...
			,["html","div.stuffbox p"
				...
				,"执行 Hentai@Home Hentai@Home客户端，将会随着时间获得特殊加分："]
			,["html","div.stuffbox p"
				,". These are rewards for people who help keeping this site free, "
				," Hath(一种币值). <br>这些是人们免费帮助网站的奖励，"]
			,["html","div.stuffbox p"
			...
			,["html","div.stuffbox p"
				...
				,"如果不想使用 Hentai@Home Hentai@Home，你也可以使用 Credits (绅士币/信用点) 购买交换，就在 "]
	...
	"exchange.php":
	{
		...
		//The Hath Exchange
		,"h1:contains('The Hath Exchange')"			:"Hath交易 (-Hath-)"
		,"h2:contains('Last 8 Hours (per Hath)')"	:"近8小时 (单Hath)"
		,"h2:contains('Last 24 Hours (per Hath)')"	:"近24小时 (单Hath)"
		,"h2:contains('Buy Hath')"					:"购买Hath"
		,"h2:contains('Sell Hath')"					:"卖出Hath"
		,"#buyform  a:contains('Buy Hath!')"		:"<font color='red'>购买</font>Hath!"
		,"#sellform a:contains('Sell Hath!')"		:"<font color='red'>卖出</font>Hath!"
		...
		[
			...
			//The Hath Exchange
			,["html","#buyform"  ,"Bid Price/Hath:"	,"<br>出价/单Hath："]
			,["html","#sellform" ,"Ask Price/Hath:"	,"<br>询价/单Hath："]
			//The GP Exchange
	...
	"logs.php":
	{
		...
		[
			...
			,["html","div[style='overflow:hidden']" ,"Hath Exchange Transaction "	
				,"<font color='DarkOrchid'>Hath</font>交易 "]
			...
			,["html","div[style='overflow:hidden']" ," Hath "	
				," <font color='DarkOrchid'>Hath</font> "]
	...
	"GalleryMode":
	{
		...
		[
			...
			,["modi","#tagmenu_act"	,{
				 ">Vote Up<"				:">加分<"
				,">Vote Down<"				:">扣分<"
				,">Show Tagged Galleries<"	:">显示有此标签的画册<"
			...
			,["attr","textarea[name='commenttext']"	
				,"placeholder"
				,"在此处输入评论后发表，如果最后一则评论是你的，将会自动沿展评论区."]
...
function make_nb() { //主导航
    ...
    array_EN_CH.push([">Settings<"			, ">设置<"]);
    array_EN_CH.push([">Favorites<"			, ">收藏<"]);
...
//类型类
	...
	"slime girl":"史莱姆(怪物娘)",
	"themeless":"无主题的",
	"cervix penetration":"子宫透视",
	"prostitution":"卖淫/援交",
	"hairy":"多毛的",
	"robot":"机器人",
	"sole male":"单一男主",
	"sole female":"单一女主",
	"sole dickgirl":"单一扶她/人妖",
	"oni":"鬼(日本神话)",
	"females only":"只有女性",
	"low lolicon":"合法萝莉",
	"alien girl":"外星女孩",
...
var GalleryCategory = {
	...
	,"Manga"			:"漫画 : Manga"
	,"Artist CG Sets"	:"画师图片 : Artist CG Sets"
	,"Game CG Sets"		:"游戏CG : Game CG Sets"
	,"Western"			:"西方的 : Western"
	,"Non-H"			:"无色情 : Non-H"
