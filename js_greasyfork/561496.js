// ==UserScript==
// @name           searchEngineJump 搜索引擎快捷跳转-备份
...
// @downloadURL https://update.greasyfork.org/scripts/561496/searchEngineJump%20%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%BF%AB%E6%8D%B7%E8%B7%B3%E8%BD%AC-%E5%A4%87%E4%BB%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/561496/searchEngineJump%20%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%BF%AB%E6%8D%B7%E8%B7%B3%E8%BD%AC-%E5%A4%87%E4%BB%BD.meta.js
// ==/UserScript==
...
(function () {
    ...
    function iqxinstart(){
        ...
        var rules = [
            ...
            {name: "google网页搜索",// 你要加载的网站的名字(方便自己查找)
                ...
                // 插入文档,相关
                    ...
                    // where 四种:
                        ...
                        // 'afterEnd'(插入到给定元素的后面);.
                insertIntoDoc: {
                    target: 'css;div.Fgyi2e.rZj61.caNvfd',
                    // 若 keyword 使用函数获取
                    // keyword: function () {
            ...
            {
                name: 'Nyaa',
                url: /^https?:\/\/sukebei\.nyaa\.si\/\?f=\d+&c=\d+_\d+&q=/,
                engineList: 'download',
                enabled: true,
                style: '\
                    margin-top:-10px;\
                ...
                ',
                insertIntoDoc: {
                    keyword: 'css;input.form-control',
                    target: 'css;div.container:has(.center)',
                    where: 'beforeBegin',
                },
            },
            {
                name: 'BTSOW',
                url: /^https?:\/\/btsow\.lol\/.*$/i,
                engineList: 'download',
                enabled: true,
                style: '\
                    margin-top: 65px;\
