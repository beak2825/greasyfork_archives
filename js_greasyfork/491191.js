...
// @version      1.2.2
// @description  Modified version of Heasley's egg navigator
...
// kudos to the original creator https://greasyfork.org/en/scripts/463484-heasley-s-egg-navigator
// @downloadURL https://update.greasyfork.org/scripts/491191/Deez%20Nuts.user.js
// @updateURL https://update.greasyfork.org/scripts/491191/Deez%20Nuts.meta.js
// ==/UserScript==
'use strict';
...
function insertNormal() {
  console.log("[Heasley][Egg Navigator] Inserting normally...");
    if (!document.getElementById("eggTraverse")) {
        ...
        let easterspans = `
            <div class="eeh-link"><a href="${href}" id="eggTraverse" target="_blank"><span class="eeh-icon">${easteregg_svg}</span><span class="eeh-name">Egg Navigator (${linkIndex})</span></a></div>
            `;
