...
#secondary.ytd-watch-flexy, #secondary.ytd-watch-grid { width: 402px !important; min-width: 300px !important }
...
a.ytd-mini-guide-entry-renderer[title="You"] .title.ytd-mini-guide-entry-renderer, #endpoint.yt-simple-endpoint.ytd-guide-entry-renderer.style-scope[title="You"] .title.ytd-guide-entry-renderer { visibility: hidden !important }
...
ytd-guide-section-renderer.ytd-guide-renderer.style-scope:nth-of-type(4) { display: none }
ytd-guide-section-renderer.ytd-guide-renderer.style-scope:nth-last-of-type(2) { display: none }
ytd-guide-section-renderer.ytd-guide-renderer.style-scope:nth-last-of-type(1) { display: block !important }
ytd-guide-section-renderer.ytd-guide-renderer.style-scope:nth-of-type(3) ytd-guide-entry-renderer > a[href*="studio.youtube.com/channel"] { margin-top: -120px !important; margin-bottom: 120px !important }
...
ytd-guide-entry-renderer > a[href*="/feed/podcasts"], ytd-guide-entry-renderer > a[href*="/playables/saved"], ytd-guide-downloads-entry-renderer, ytd-mini-guide-downloads-entry-renderer, #endpoint.yt-simple-endpoint.ytd-guide-entry-renderer.style-scope[title="Your movies & TV"] { display: none !important }
...
ytd-guide-section-renderer.ytd-guide-renderer.style-scope:nth-of-type(3) ytd-guide-entry-renderer[active] #endpoint.yt-simple-endpoint.ytd-guide-entry-renderer.style-scope[title="Playlists"] path, ytd-guide-entry-renderer[aria-expanded="true"] path { d: path("M18.4 14.6 12 8.3l-6.4 6.3.8.8L12 9.7l5.6 5.7z") !important }
