...
// @version     1.9.5
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/452/ShinjukuWatch.user.js
// @updateURL https://update.greasyfork.org/scripts/452/ShinjukuWatch.meta.js
// ==/UserScript==
...
(function() {
    ...
    define('shinjuku/loader/RelatedVideo',['jquery'], function($) {
      ...
      RelatedVideo.prototype = {
        ...
        load: function(watchId) {
          ...
          window.require('watchapp/init/VideoExplorerInitializer').relatedVideoAPILoader.load(
            {'video_id': watchId},
            function(err, result) {
              if (timeoutTimer) {
      ...
      NicoplayerResizer.prototype = {
        ...
        _getCssTemplate: function() {
           var tpl = (function() {/*
             ...
             body.size_normal.w_size_custom:not(.full_with_browser):not(.videoExplorer) #playlist {
  ...
  //          'VGA---': [ 512,  512 / 16 * 9]
    ...
    window.require([
        ...
        'WatchApp',
        'watchapp/model/WatchInfoModel',
        'watchapp/init/PlayerInitializer',
        'watchapp/init/VideoExplorerInitializer',
        'watchapp/init/DeflistInitializer',
        'watchapp/model/player/NicoPlayerConnector',

        'shinjuku/loader/RelatedVideo',
        'shinjuku/util/NicoplayerResizer',
        ],
      function(
        $,
        _,
      ...
      WatchApp.mixin(window.Shinjuku, {
        initialize: function() {
          window.console.time('init Shinjuku');
          if (window.WatchJsApi) { // WatchAppだけだとコメント編集画面にも来てしまうため
            //this.initializeUserConfig();
            this._watchInfoModel      = WatchInfoModel.getInstance();
        ...
        initializeOsusumeOnly: function() {
          console.log('%cosusume Only', 'background: lightgreen;');
  ...
  //        $('body').addClass('Shinjuku');
        ...
        initializeTag: function() {
          // タグ自動更新キャンセラー
          NicoPlayerConnector.onTagDataReceived = function() {};

          // タグ領域のピン留め
          require(['watchapp/init/TagInitializer'], function(TagInitializer) {
        ...
        initializeVideoExplorer: function() {
          ...
          var controller = VideoExplorerInitializer.videoExplorerController;
            ...
            initialize: function() {
              ...
              var $container = this.$container
                ...
                .on('click', '.deflistButton', function(e) {
                  ...
                  DeflistInitializer.deflistEditAPILoader.add(videoId, {
        ...
        initializePlaylist: function() {
          this.playlistController = {
            _playlist: require('watchapp/init/PlaylistInitializer').playlist,
        ...
        initializeScroll: function() {
          ...
          var scrollToPlayer = function() {
            ...
            // 縦幅に余裕がある時はプレーヤーが画面中央に来るように
              ...
              WindowUtil.scrollFitMinimum(topElement, 400);
            }
          ...
          (function(watchInfoModel) {
           ...
           var WindowUtil = require('watchapp/util/WindowUtil');
           WindowUtil.checkInview = function() { return true; };
...
-->
        ...
        initializePlayerResizer: function() {
          if (this.config.get('autoResizePlayer')) {
            this._playerResizer = new NicoplayerResizer();
            this._playerResizer.run();
          }
        },
        initializeOther: function() {
          ...
          if (this.config.get('noNews') === true || this.config.get('autoResizePlayer') === true) {
            ...
            // 通信を止める
            var tmi = require('watchapp/init/TextMarqueeInitializer');
