// ==UserScript==
// @name         Backloggd - Metacritic & HowLongToBeat Integration
...
// @license      MIT
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/525552/Backloggd%20-%20Metacritic%20%20HowLongToBeat%20Integration.user.js
// @updateURL https://update.greasyfork.org/scripts/525552/Backloggd%20-%20Metacritic%20%20HowLongToBeat%20Integration.meta.js
// ==/UserScript==
...
(function() {
    ...
    function renderIntegrationSection(metacriticData, hltbData) {
        ...
        const linkStyle = "display:inline-block; text-decoration:none; color:white; "
            + "border-radius:4px; padding:8px 12px; border:1px solid #d1d1d1; "
    ...
    <div class="integration-container" style="${containerStyle}">
        <a href="${metacriticData.url}"
           target="_blank"
           style="${linkStyle} background-color:#287FC2;">
