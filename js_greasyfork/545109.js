// ==UserScript==
// @name         [IRKUTSK] | Куратор администрации
...
// @downloadURL https://update.greasyfork.org/scripts/545109/%5BIRKUTSK%5D%20%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8.user.js
// @updateURL https://update.greasyfork.org/scripts/545109/%5BIRKUTSK%5D%20%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8.meta.js
// ==/UserScript==
...
const buttons = [
	...
	},
    {
	  title: '| Приветствие |',
	  content:
		"[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
	...
	},	
	{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=lavender] Ваша жалоба взята на [COLOR=#ffff00]рассмотрение[/COLOR], пожалуйста ожидайте ответа.<br><br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=AQUA]IRKUTSK[/COLOR].<br><br>"+
...
},
  {
      ...
      content:
        ...
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/B]<br>',
      prefix: CLOSE_PREFIX,
      status: false,
    },
   {
      ...
      content:
        "[B][CENTER][COLOR=#EE32EE][ICODE] Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Ваша жалоба составлена не по форме.<br>" +
        "[B][CENTER][COLOR=lavender] Внимательно прочитайте правила составления жалоб: [URL= https://forum.blackrussia.online/threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.3429349/]*Нажмите сюда*[/URL]<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/B]<br>',
      prefix: CLOSE_PREFIX,
      status: false,
...

{
	...
	},
	{
	  ...
	  content:
		"[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Представленные доказательства были отредактированы.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
...
'[B][CENTER] [COLOR=RED][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]',
     ...
     },
     {
	...
	},
	  {
        ...
        content:
        "[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Ответ на Вашу жалобу был дан в прошлой вашей теме, прочитайте вердикт более внимательнее.<br>"+
        "[B][CENTER][COLOR=lavender] Напоминаю, за дублирование тем ваш форумный аккаунт может быть заблокирован.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/B]',
        prefix: CLOSE_PREFIX,
	...
	},
	{
	  ...
	  content:
        "[B][CENTER][COLOR=#EE32EE][ICODE] Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Администратор будет проинструктирован по поводу проверок жалоб.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=#00FA9A][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
      prefix: ACCEPT_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
        "[B][CENTER][COLOR=#EE32EE][ICODE] Доброго времени суток, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Администратор получит наказание за халатное рассмотрение жалоб.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=#00FA9A][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
      prefix: ACCEPT_PREFIX,
	  status: false,
	...
	},
	{
	  ...
	  content:
		"[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба была одобрена, администратор получит наказание.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
		'[B][CENTER][COLOR=#00FA9A][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},		
	{
	...
	},
	 {
	  ...
	  content:
        "[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] В вашей жалобе не указан Nick-Name администратора, жалоба не подлежит рассмотрению.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	 {
	  ...
	  content:
        "[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] В вашей жалобе не указан Nick-Name игрока, жалоба не подлежит рассмотрению.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	 {
	  ...
	  content:
        "[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Нужна ссылка на жалобу, пожалуйста предоставьте ссылку на данную жалобу.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	 {
	  ...
	  content:
        "[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] В ваших доказательств отсутствует /myreports. Без данной команды жалоба не будет рассмотрена.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	...
	},	
	{
	...
	},
	 {
      ...
      content:
        "[B][CENTER][COLOR=#EE32EE][ICODE] Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Ваша жалоба передана [/COLOR][COLOR=rgb(255, 0, 0)]Главному Администратору [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR]<br>" +
        "[B][CENTER][COLOR=lavender] Ожидайте ответа в данной теме, копии создавать не нужно.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
    ...
    },
	 {
      ...
      content:
        "[B][CENTER][COLOR=#EE32EE][ICODE] Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Ваша жалоба передана [/COLOR][COLOR=rgb(255, 0, 0)]Заместителю Главного Администратора [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR]<br>" +
        "[B][CENTER][COLOR=lavender] Ожидайте ответа в данной теме, копии создавать не нужно. <br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/IMG]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Передано Заместителю Главного Админа[/ICODE][/COLOR][/CENTER][/B]',
        prefix: PIN_PREFIX,
	  status: true,
    },
    {
	  ...
	  content:
        "[B][CENTER][COLOR=#EE32EE][ICODE] Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Ваша жалоба передана [/COLOR][COLOR=rgb(30, 144, 255)]Руководителю модерации Discord [/COLOR][COLOR=rgb(230, 230, 250)][/COLOR]<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
`[COLOR=rgb(255, 140, 0)][ICODE]Взято на рассмотрение..[/ICODE][/COLOR][/CENTER]`,
     prefix: PIN_PREFIX,
	 status: true,
	},
	{
                      title: 'Передано КП',
      content:
        "[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Ваша жалоба передана [/COLOR][COLOR=rgb(255, 0, 0)]Команде Проекта [/COLOR][COLOR=rgb(209, 213, 216)][/COLOR]<br>" +
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=rgb(250, 197, 28)][ICODE]На рассмотрении[/ICODE][/COLOR][/CENTER][/B]',
...
content:
       "[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/CENTER][/B]<br><br>"+
       "[B][CENTER][COLOR=lavender] Доказательства в социальных сетях и т.д. не принимаются. Загрузите доказательства на фото-видео хостинги YouTube,Imgur, Yapx и так далее.<br><br>"+
       "[B][CENTER][COLOR=lavender] Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.<br>"+
       "[B] [CENTER] [COLOR=lavender] Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=AQUA]IRKUTSK[/COLOR]<br>"+
       "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
       '[B][CENTER][COLOR=rgb(250, 197, 28)][ICODE]Тема была рассмотрена и закрыта[/ICODE][/COLOR][/CENTER][/B]',
prefix: WATCHED_PREFIX,
status: false,
},
	{
	  ...
	  content:
		"[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Пожалуйста составьте свою жалобу в Технический раздел сервера : [URL= https://forum.blackrussia.online/forums/Технический-раздел-irkutsk.1712/]*Нажмите сюда*[/URL]<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
  {
	  ...
	  content:
		"[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Вам было выдано наказания Техническим специалистом, обратитесь в раздел жалоб на технических специалистов. Вы можете написать жалобу здесь : [URL= https://forum.blackrussia.online/forums/Сервер-№38-irkutsk.1711/]*Нажмите сюда*[/URL]<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
{
      ...
      content:
        "[B][CENTER][COLOR=#EE32EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][COLOR=lavender] Обратитесь в раздел обжалований наказаний.<br>"+
        "[CENTER][IMG width=695px]https://i.postimg.cc/rFTrQQ92/C0ffE.png[/img]<br>"+
        '[B][CENTER][COLOR=red][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]<br>',
      prefix: CLOSE_PREFIX,
      status: false,
