...
// @downloadURL https://update.greasyfork.org/scripts/543613/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Beng%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/543613/The%20West%20-%20tw-dbinfo%20Cloth%20Calc%20%5Beng%5D.meta.js
// ==/UserScript==
(function (f) {
    var d = document,
    ...
    if (isDefined(window.TWDB)) {
        new west.gui.Dialog(
            TWDB.script.name,
            '<div class="txcenter"><b><br>The UserScript ClothCalc is installed twice, with two different language versions. You will have to uninstall one of them for the script to work properly!</br></b></div>',
        ...
        TWDB.script = new Object({
            ...
            update: "",//"tw-db.info/cache/userscripts/clothcalc/clothcalc_eng.user.js",
        ...
        TWDB.Util = (function (e) {
            ...
            var u = function (e) {
                ...
                var t = [],
                    n,
                    r,
                    i = "backup_twdb_" + Character.playerId + "_",
                    s;
        ...
        TWDB.ClothCalc = {
            ...
            checkCache: function () {
                ...
                if (e || t || n) {
                    var i = "the Data is outdated, click for Update";
                    if (e) {
                        i += " [Inventory]";
                    }
                    if (t) {
                    ...
                    r = jQuery('<div title="the Data is up to Date" style="position:absolute;top:0px;right:0px;width:20px;height:20px;background: url(' + TWDB.images.iconData + ')no-repeat -20px 0px;" /></div>');
                    this.up2date = true;
                }
            ...
            open: function (e, t) {
                ...
                this.gui.job.sort = jQuery('<div style="position:absolute;top:10px;left:0px;height:20px;" />')
                    .append('<img src="' + TWDB.images.iconName + '" title=" Sort by name " alt=" Sort by name " onclick="javascript:TWDB.ClothCalc.joblist.order(\'name\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                    .append(
                        '<img src="' +
                            TWDB.images.iconExperience +
                            '" title=" Sort by experience " alt=" Sort by experience " onclick="javascript:TWDB.ClothCalc.joblist.order(\'experience\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    )
                    .append('<img src="' + TWDB.images.iconDollar + '" title=" Sort by wages " alt=" Sort by wages " onclick="javascript:TWDB.ClothCalc.joblist.order(\'wages\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                    .append('<img src="' + TWDB.images.iconLuck + '" title=" Sort by luck " alt=" Sort by luck " onclick="javascript:TWDB.ClothCalc.joblist.order(\'luck1\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />')
                    .append(
                        '<img src="' +
                            TWDB.images.iconLaborpoints +
                            '" title=" Sort by workpoints " alt=" Sort by workpoints " onclick="javascript:TWDB.ClothCalc.joblist.order(\'laborpoints\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    )
                    .append(
                        '<img src="' + TWDB.images.iconMoti + '" title=" Sort by motivation " alt=" Sort by motivation " onclick="javascript:TWDB.ClothCalc.joblist.order(\'motivation\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />'
                    )
                    .append('<img src="' + TWDB.images.iconDanger + '" title=" Sort by danger " alt=" Sort by danger " onclick="javascript:TWDB.ClothCalc.joblist.order(\'danger\')" style="margin:0px 2px 0px 2px;cursor:pointer;" />');
                this.gui.job.title = jQuery('<div style="position:absolute;top:37px;left:0px;width:187px;height:19px;font-weight:bold;text-align:center;white-space: nowrap;">Select job here >></div>');
                this.gui.job.mode = jQuery(
                    "<div style=\"position:absolute;top:10px;right:30px;width:20px;height:20px;background:url('" + TWDB.images.jobTime + '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:block;" title=" Job time " />'
                );
                this.gui.job.search = jQuery(
                    "<div style=\"position:absolute;top:35px;right:50px;width:20px;height:20px;background:url('" +
                        ...
                        '\') no-repeat scroll 0 0 transparent;cursor:pointer;display:none;" title=" Find this job on the map " />'
                );
                ...
                this.gui.job.checkbox.setTooltip("Hide Jobs you could not do");
                this.gui.job.checkbox.getMainDiv().css({ position: "absolute", top: "35px", right: "30px" });
                this.gui.job.button = jQuery(
                    '<div style="position:absolute;top:35px;right:4px;width:26px;height:20px;background:url(\'/images/window/character/title_editbtn.jpg\') no-repeat scroll 0 0 transparent;cursor:pointer;" title=" Select job here " />'
                );
                ...
                this.gui.job.calc = $('<div title=" Current rewards " style="position:absolute;top:60px;width:100px;right:1px;height:30px;display:block;;font-weight:bold;text-align:center;" />');
                ...
                this.gui.custom.title = jQuery('<div style="position:absolute;top:36px;left:0px;width:210px;height:19px;font-weight:bold;text-align:center;">Select job here >></div>');
                ...
                var u = $(
                    '<div title="save Position" style="width:20px;height:20px;position:absolute;left:0px;top:0px;background:url(\'' + TWDB.images.iconSave + "') no-repeat scroll 0px -20px transparent;cursor:pointer;display:block;\" />"
                )
                    .hover(
                        function () {
            ...
            jobs: {
                ...
                getJobPopup: function (e) {
                    ...
                    n =
                        ...
                        '<tr><td><img src="' +
                        TWDB.images.iconExperience +
                        '" title=" Experience " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.experience +
                        "</td>" +
                        '<td><img src="' +
                        TWDB.images.iconDollar +
                        '" title=" Wages " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.wages +
                        "</td></tr>" +
                        '<tr><td><img src="' +
                        TWDB.images.iconLuck +
                        '" title=" Luck " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.luck1 +
                        "-" +
                        t.luck2 +
                        "</td>" +
                        ...
                        '" title=" Danger " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.danger +
                        "</td></tr>" +
                        '<tr><td><img src="' +
                        TWDB.images.iconLaborpoints +
                        ...
                        '" title=" Duration " height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.duration +
                        "</td></tr>" +
                        '<tr><td><img src="' +
                        TWDB.images.iconMoti +
                        '" title=" Motivation "  height="15px" width="15px" /></td><td style="font-size:10px;vertical-align:bottom;">' +
                        t.resmotivation * 100 +
                        " (" +
            ...
            customs: {
                ...
                showConfig: function () {
                    var e = this;
                    var t = jQuery(
                        '<div title="Edit" style="display:inline-block;vertical-align:top;height:16px;width:16px;cursor:pointer;background:url(\'' +
                            Game.cdnURL +
                    ...
                    var r = jQuery(
                        '<div title="add" style="display:block;margin-top:2px;vertical-align:top;height:20px;width:25px;cursor:pointer;background:url(\'' +
                            Game.cdnURL +
                    ...
                    this.parent.gui.custom.config = new west.gui.Dialog("Custom skills", i);
                ...
                addConfig: function () {
                    ...
                    if (e >= 15) {
                        new UserMessage("too much entries, only ten are allowed", UserMessage.TYPE_ERROR).show();
                    } else {
                        e++;
                        this.editConfig(e);
                    }
                ...
                editConfig: function (e, t) {
                    if (typeof t == "undefined") {
                        ...
                        o.append(jQuery("<tr />").append('<td style="vertical-align:middle">Name:</td>').append(jQuery("<td />").append(this.parent.gui.custom.name.getMainDiv())));
                        o.append(jQuery("<tr />").append('<td style="vertical-align:middle">code:</td>').append(jQuery("<td />").append(this.parent.gui.custom.code.getMainDiv())));
                        o.append('<tr><td colspan="2">please go to tw-db.info an get the code snippets to inserts here from there <a href="https://tw-db.info/?strana=calc" target="_blank">tw-db.info Calculator</a></td></tr>');
                        var o = new west.gui.Dialog(s + "Custom skills", o);
                        ...
                        var u = function (e) {
                            new UserMessage("the inserts you have done are incorrect: " + e, UserMessage.TYPE_ERROR).show();
                            return false;
                        };
                ...
                deleteConfig: function (e, t) {
                    if (typeof t == "undefined") {
                        var n = this;
                        var r = new west.gui.Dialog("delete - Custom skills", "delete: " + this.parent.data.custom[e].name + "?");
                ...
                for (var i = 0; i < t.length; i++) {
                    ...
                    u.append(
                        jQuery('<td style="text-align:left;vertical-align:middle">').append(
                            jQuery(
                                '<img src="' + TWDB.images.arrow + '" title="Direction" style="cursor:pointer;-moz-transform: ' + o + "-webkit-transform:" + o + "-rotat-transform:" + o + "-ms-transform:" + o + "transform:" + o + '" />'
                            ).click(
                                (function (e, t) {
                                    return function () {
                                        Map.center(e, t);
        ...
        (function ($) {
            ...
            var Loader = (function (e) {
                ...
                var l = function () {
                    ...
                    if (o === false) {
                        ...
                        try {
                            ...
                            Error.report(e, "");
                            new UserMessage("failed to register tw-db.info script on TheWestApi", UserMessage.TYPE_FATAL).show();
                            return d();
                        }
                        if (TWDB.Util.isNewIDsystem()) {
                ...
                var h = function () {
                    ...
                    var r = e("<div style='font-family:comic sans ms; font-size:13pt; padding-top:10px; text-align:center;' />").append(
                        "The UserScript ClothCalc is a project created by the TW-DB.info team. It offers plenty of features and extensions that will give you an enhanced game experience - saving your time and optimizing some of your activities.",
                        n,
                        "Thank you!"
                    );
                    t.setGui(r);
                ...
                t.reset = function (n, s) {
                    try {
                        if (n) {
                            ...
                            var u = e("<div><h2>do you really want to reset the whole Cache of tw-db Userscript?</h2></div>");
            ...
            var Window = (function (e) {
                ...
                var u = function () {
                    ...
                    var t = e('<div title="tw-db.info" class="menulink" />')
                    ...
                    r.appendToContentPane(
                        e(
                            '<div style="width:100%;text-align:center;position:absolute;bottom:0px;left:0px;height:15px;display:block;font-size:12px;color:#000000;">.:powered by tw-db team:. | <a href="https://tw-db.info" style="font-weight:normal;color:#000000;" target="_blank">.:tw-db.info:.</a> | ' +
                                (Script.version / 100 + " rev. " + Script.revision) +
                                "</div>"
                        )
                    );
                    r.appendToContentPane(
            ...
            var Support = (function (e) {
                ...
                t.open = function () {
                    var t = e(
                        '<p style="margin:10px;">Please include the text displayed below in a bug report sent using <a href="https://tw-db.info/?strana=contact" target="_blank">our contact form</a> and also try to describe how to reproduce this error (what did you do when it occured). Thanks!</p>'
                    );
                                ...
                                switch (f.type) {
                                    ...
                                    case "character":
                                        if (f.bonus && f.key === "level") {
                                            ...
                                            var value = Character.level * f.bonus.value;
                                            if (h === "floatceil") {
                                                value = Math.ceil(value); // direct use without cast to int
                                            } else if (typeof Math[h] === "function") {
                                                value = Math[h](value);
                                            } else {
                                                console.warn("TWDB: Unknown rounding method:", h);
                                            ...
                                            if (f.bonus.type === "skill") {
                                                ...
                                                n[level]["jobs"][f.bonus.job] += value;
                                            }
                                        }
                                        break;
                                    default:
            ...
            var Importer = (function (e) {
                ...
                //n = Loader.add("Importer", "tw-db Importersystem", r, { Window: true }); //changed by Macostem", r, { Window: true });
                var i = function () {
            ...
            var Settings = (function (e) {
                ...
                var s = function () {
                    ...
                    r = Window.addTab("settings", "settings", "settings", o);
                    i.ready = true;
                };
                ...
                var o = function () {
                    ...
                    var s = [
                        [9, "", "Inventory", false],
                        [0, "jobBoniTooltip", "show laborpoint information on inventory window for the selected job", false],
                        [0, "collector", "mark items on Traders and Market you did not own", false],
                        [0, "buyTip", "show buy tip on traders", false],
                        [0, "sellTip", "show sell tip on inventory window", false],
                        [0, "sellTip1", "sell items you have more than once", "Settings for Sell-Tip"],
                        [0, "sellTip2", "sell items which are not used on any job", "Settings for Sell-Tip"],
                        [0, "sellTip3", "never sell named items", "Settings for Sell-Tip"],
                        [0, "sellTip4", "never sell item, which could only be found", "Settings for Sell-Tip"],
                        [0, "sellTip5", "Never sell Set-Items", "Settings for Sell-Tip"],
                        [0, "pinitems", "Enable pinning items in the recently used section of Inventory", false],
                        [0, "collectorsell", "add a button to sell all but one of the selected item to the Mobile Trader", false],
                        [9, "", "Quests", false],
                        [0, "questwiki", "Include tw-db and ClothCalc into Quest Windows", false],
                        [0, "questcancle", "On Canceling a Quest you will get a Question if you realy want to do that", false],
                        [0, "qbswitch", "Enable switching between introduction and completion text in the Quest book", false],
                        [0, "qfulltext", "Always display full quest story texts", false],
                        [9, "", "Market", false],
                        [0, "marketmap", "Use the Marketmap", false],
                        [0, "marketreminder", "Add a Reminder for Marketauctions", false],
                        [0, "marketselldialog", "Enhance the market sell dialog", false],
                        [9, "", "Jobs", false],
                        [0, "jobwin_ccbutton", "Add ClothCalc to job windows", false],
                        [0, "jobwin_showlp", "Show labor points in job windows", false],
                        [9, "", "Task list", false],
                        [0, "tasklistpoints", "show labor points and LP-hints on the task list", false],
                        [9, "", "GUI", false],
                        [0, "duelmotivation", "Add the Duel Motivation as permanent Indicator", false],
                        [0, "directsleep", "Get a Button to directly go to Hotel or Barrack", false],
                        [0, "deposit", "Add a button for deposit Money", false],
                        [0, "noshopsale", "disable Shop SALE notification", false],
                        [0, "expbarvalues", "show values on experience bar; Credits & thanks to Leones/Slygoxx", false],
                        ...
                        [9, "", "Mini map", false],
                        [0, "showbonusjobs", "Show Bonus Jobs on minimap", false],
                        [0, "showscrollto", "Add a scroll-to coordinate input field to the minimap", false],
                        [9, "", "Fort", false],
                        [0, "fortrecruitment", "Show the Fortrecruitment Overview", false],
                        [0, "enhancedfortrecruitment", "show Player near Fort", false],
                        [9, "", "Miscellaneous", false],
                        [0, "chat", "use chat enhancement", false],
                        [0, "notes", "use the Notes-Feature", false],
                        [0, "forumlastpage", "Add an Icon on Forum for directly open the last Threadpage", false],
                        [0, "fastskillchange", "activate fast Skill Change on Skill-Window (Hold Mouse Button down)", false],
                        [0, "autodeposit", "Get a Deposit Hint if you arrive at your Hometown with Money", false],
                        [0, "chestanalyser", "Create a Statistic for Chests you open", false],
                        [0, "weeklycrafting", "Get notified when the crafting waiting period expires", false],
                        [0, "noworkqueuepa", "Remove Hints for the Automation PA", "Premium settings"],
                        [0, "nofetchallpa", "Deactivate Premium prompt when fetching all items from the market", "Premium settings"],
                        [0, "nowofnuggets", "Don&#38;#39;t use nuggets as default payment in event games (when available)", "Premium settings"],
                        [0, "instanthotel", "Add a hotel button to town signs", false],
                        [0, "telegramsource", "add button to switch to unformatted text in telegrams", false],
                        [8, "clothPos"],
                        [0, "wear_openmin", "open Equipment window minimized when opening ClothCalc", false],
                    ];
                    var o = {};
                    var a = e("<table />");
                    var f = {};
                    for (var l = 0; l < s.length; l++) {
                        ...
                        if (s[l][3]) {
                            ...
                            if (!isDefined(f[v])) {
                                ...
                                a.append(
                                    e(
                                        '<tr><td style="width:25px;cursor:pointer;" /><td style="cursor:pointer;" class="item_sell"><span class="twdb_cat butMinus" style="margin-top: -3px;" />&nbsp;&nbsp;' +
                    ...
                    m.addItem("left", "left").addItem("right", "right").addItem("custom", "saved Position");
                    m.select(String(n["clothPos"]));
                    e("tr.placeholder_clothPos", a).removeClass("placeholder_clothPos").append(e('<td colspan="2" />').append(m.getMainDiv(), "<span>&nbsp;right</span>"));
                    a.append(e("<tr><td>&nbsp;</td></tr>"));
                    var g = new west.gui.Button("Save", function () {
                        switch (m.getValue()) {
                            case "left":
                                n["clothPos"] = "left";
                                break;
                    ...
                    var y = e('<div style="width:100%;text-align:right;" />').append(
                        e('<img style="position:relative;top:-20px;cursor:pointer;" title=" reset local Storage" src="' + Images.iconReset + '" />').click(function () {
                            Cache.reset();
                        })
                    );
                    i.appendContent(a);
                ...
                var i = function () {
                    try {
                        ...
                        JobWindow.prototype.getBestWearButton = function () {
                            ...
                            var n = this;
                            return t.append(
                                e('<div class="twdb_bestwear" title="Show this Job at ClothCalc Window">').click(function (e) {
                ...
                var s = function () {
                    try {
                        ...
                        JobWindow.prototype.initView = function () {
                            ...
                            var n = "&nbsp;&nbsp;(" + (this.currSkillpoints - this.job.workpoints) + "&nbsp;LP)";
            ...
            var Updater = (function (e) {
                ...
                var s = function () {
                    ...
                    if (!Cache.load("version")) Cache.save("version", Script.version + " " + Script.revision);
                        ...
                        i = true;
                        var e = "The Userscript was Updated";
                        var t = '<div class="txcenter">The Userscript =1= was updated. Do you want to see the Release-Notes?</div>';
                ...
                var o = function (e, t) {
                    var n = "The Userscript needs an Update";
                    var r = '<div class="txcenter">for userscript =1= is a new version available, please click ok to update the Userscript.</div>';
                    ...
                    var s = function () {
                        window.open(i);
                        new west.gui.Dialog(Script.name, "Please reload the game after installing.", "warning").setModal(true, false, true).show();
                    };
                ...
                var u = function () {
                    ...
                    for (var i = 0; i < Script.notes.length; i++) {
                        var s = e("<h3><a>Version " + String(Script.notes[i].version / 100) + "</a></h3>")
                ...
                t.check = function (e, t, n) {
				    ...
				    if (e > Script.version || (e === Script.version && t > Script.revision)) {
                        o(e, t);
                    }
                };
                return t;
            ...
            var Sleep = (function (e) {
                ...
                var v = function () {
                    ...
                    n.addMousePopup("sleep").click(function (e) {
                ...
                var m = function (t, n, r) {
                    ...
                    for (var s = 0; s < r; s++) if (t[s].stage !== 0) i.addItem(s, "Stage&nbsp;" + t[s].stage + "&nbsp;" + t[s].distance.formatDuration() + "&nbsp;|&nbsp;" + t[s].name);
            ...
            var Analyser = (function (e) {
                ...
                var p = function () {
                    ...
                    s = e.extend(true, {}, r);
                    GameInject.addTabOnMessagesWindow("Job-Analyser", "analyser-job", function () {
                        T("job");
                    });
                    if (Settings.get("chestanalyser", true)) {
                        GameInject.ItemUse(v.add);
                        GameInject.addTabOnMessagesWindow("Chest Analyser", "analyser-chest", function () {
                            v.show();
                        });
                    }
                    h.ready = true;
                ...
                var k = function () {
                    ...
                    for (var u in s) {
                        ...
                        m.data("sum-t", String((f.duration / 3600).round(2)) + " hours");
                        m.data("avg", (f.duration / (3600 * f.count)).round(2));
                        m.data("avg-t", "&Oslash; " + String((f.duration / (3600 * f.count)).round(2)) + " hours");
                        w.append(m);
                    ...
                    m.data("sum", i.jobs);
                    m.data("sum-t", i.jobs + " Jobs");
                    m.data("avg", i.jobs);
                    m.data("avg-t", i.jobs + " Jobs");
                    l.footer.append(m);
                    ...
                    m.data("sum", "&sum;");
                    m.data("sum-t", "switch to &Oslash;");
                    m.data("avg", "&Oslash;");
                    m.data("avg-t", "switch to &sum;");
                    l.footer.append(m);
                    ...
                    m.data("sum-t", String((i.duration / 3600).round(2)) + "hours");
                    m.data("avg", (i.duration / (3600 * i.count)).round(2));
                    m.data("avg-t", "&Oslash; " + String((i.duration / (3600 * i.count)).round(2)) + "hours");
                    l.footer.append(m);
                    ...
                    var o = e('<div style="margin: 0px 6px 0px 6px;width:680px;" />')
                        .append(
                            e('<a href="#">Switch between rewards and found items</a>')
            ...
            var Notes = (function (e) {
                ...
                var i = function () {
                    ...
                    if (Settings.get("notes", true)) {
                        GameInject.addTabOnMessagesWindow("Notes", "notes", function () {
                            s();
                        });
                    }
                    r.ready = true;
                    ...
                    n.append(e('<div style="margin-left:8px" />').append(new west.gui.Bbcodes(r).getMainDiv()))
                        ...
                        .append(
                            e('<div style="margin-left:8px" />')
                                .append(
                                    new west.gui.Button("Save".escapeHTML(), function () {
                                        o(r.getContent());
                                        a(r.getContent());
                                    }).getMainDiv()
                                )
                                .append(
                                    new west.gui.Button("Preview".escapeHTML(), function () {
                                        a(r.getContent());
                                    }).getMainDiv()
                                )
                        );
                ...
                var a = function (t) {
                    ...
                    n.append(e('<div style="margin:8px" />').append(r.getMainDiv())).append(
                        e('<div style="margin-left:8px" />')
                            ...
                            .append(
                                new west.gui.Button("Edit".escapeHTML(), function () {
                                    u(t);
                                }).getMainDiv()
                            )
                    );
            ...
            var Map = (function (e) {
                ...
                t.getNearestJob = function (e) {
                    ...
                    for (var o = 0; o < r.length; o++) {
                        ...
                        var c = window.Map.calcWayTime({ x: r[o][0], y: r[o][1] }, s);
                ...
                var d = function () {
                    ...
                    var n = function () {
                        ...
                        var u = new west.gui.Button(
                            ...
                            null,
                            null,
                            "Scroll the map to the given coordinates"
                        ).setWidth("48");
                        var a = e('<img title="Show map coordinates" src="' + Images.iconCount + '" />').click(function () {
            ...
            var BonusJobs = (function (e) {
                ...
                var u = function () {
                    ...
                    var n = function () {
                        var t = e('<div id="mmap_twdb_bonusjobs" />')
                            .append(
                                e('<input title="Show Gold-Bonus Jobs" type="checkbox" ' + (i.gold ? 'checked="checked"' : "") + " />").change(function () {
                                    i.gold = e(this).is(":checked");
                                    a();
                                })
                            )
                            .append('<div title="Show Gold-Bonus Jobs" style="background-color:yellow; border:1px solid red;" />')
                            .append(
                                e('<input title="Show Silver-Bonus Jobs" type="checkbox" ' + (i.silver ? 'checked="checked"' : "") + " />").change(function () {
                                    i.silver = e(this).is(":checked");
                                    a();
                                })
                            )
                            .append('<div title="Show Silver-Bonus Jobs" style="background-color:white; border:1px solid black;" />')
                            .append(
                                e('<img title="Bonus-Jobs Export" src="' + Images.iconExport + '" />').click(function () {
                                    f();
                                })
                            )
                            .append(
                                e('<img title="Bonus-Jobs Import" src="' + Images.iconImport + '" />').click(function () {
                                    l();
                                })
                            )
                            .append(
                                e('<img title="Bonus-Jobs Reset" src="' + Images.iconReset2 + '" />').click(function () {
                                    c();
                                })
                            );
                ...
                var f = function () {
                    ...
                    var h = e("<div />")
                        ...
                        .append(
                            e('<img src="' + Images.iconName + '" title=" Sort by name "  style="margin:0px 2px 0px 2px;cursor:pointer;" />').click(function () {
                                c("name");
                            })
                        )
                        .append(
                            e('<img src="' + Images.iconCount + '" title=" Sort by Country " style="margin:0px 2px 0px 2px;cursor:pointer;" />').click(function () {
                                c("country");
                            })
                        );
                    new west.gui.Dialog("Bonus-Jobs Export", e("<div />").append(h).append(a)).addButton("ok").show();
                };
                var l = function () {
                    ...
                    new west.gui.Dialog("Bonus-Jobs Import", t).addButton("ok", r).addButton("cancel").show();
                };
                var c = function (e) {
                    try {
                        if (e) {
                            ...
                            Cache.save("bonusjobs", n);
                            a();
                            new UserMessage("Bonus-Jobs Reset", UserMessage.TYPE_SUCCESS).show();
                        } else {
                            var o = "tw-db Bonus-Jobs Reset";
                            var u = '<div class="txcenter">Bonus-Jobs Reset</div>';
                            new west.gui.Dialog(o, u, west.gui.Dialog.SYS_QUESTION)
                                .addButton("All", function () {
                                    c("all");
                                })
                                .addButton("Gold jobs", function () {
                                    c("silver");
                                })
                                .addButton("Silver jobs", function () {
                                    c("gold");
                                })
                                .addButton("cancel")
                                .show();
            ...
            var Chat = (function (e) {
                ...
                var g = function (t) {
                    ...
                    var v = new west.gui.Checkbox("*bold*", l.bold ? "tw2gui_checkbox_checked" : "", function () {
                        l.bold = l.bold ? false : true;
                    });
                    e(v.getMainDiv()).css("display", "block").css("margin-bottom", "5px");
                    d.append(v.getMainDiv());
                    var v = new west.gui.Checkbox("CAPITALIZE", l.caps ? "tw2gui_checkbox_checked" : "", function () {
                    ...
                    m.append('<span style="width:140px;height:15px;display:inline-block;text-align:center;padding: 4px 0px 2px 0px;font-size:11px;">history</span>');
                ...
                var s = function (e) {
                    ...
                    if (Settings.get("sellTip1", true)) {
                        ...
                        if (s || (o && o.obj.item_id == n.item_id)) {
                            ...
                            if (u > 1) {
                                r = true;
                                i = "this item you have more than once".escapeHTML();
                            }
                        }
                    }
                    if (Settings.get("sellTip2", true) && ClothCalc.isLoaded()) {
                        if (!ClothCalc.isUsedItem(n.item_id)) {
                            r = true;
                            i = "this item is not used for any job or custom defined activity (ClothCalc)".escapeHTML();
                        }
                    }
                    ...
                    if (r) {
                        e.divMain.append(
                            '<img src="' +
                                ...
                                i +
                                '" title=" this item you have not yet " style="position:absolute;bottom:4px;right:0px;width:19px;height:19px;padding:0px;border:0px;margin:0px;" />'
                        );
                    }
                };
                return t;
            ...
            var Collector = (function (e) {
                    ...
                    if (Settings.get("collector", true)) {
                        ...
                        GameInject.injectTrader("collector", function (e) {
                            if (t.isNewItem(e.item_id)) {
                                var n = '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" this item you have not yet " ' + ' style="position:absolute;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />';
                                return n;
                            }
                            return "";
                        });
                ...
                var s = function (e) {
                    ...
                    if (t.isNewItem(e.obj.item_id)) {
                        e.divMain.append('<img src="' + Images.iconNew + '" class="TWDBcollector" title=" this item you have not yet " style="position:absolute;top:-8px;left:-15px;padding:0px;border:0px;margin:0px;" />');
                    }
                };
                var o = function (e) {
                    if (t.isNewItem(e)) {
                        return '<img src="' + Images.iconNew + '" class="TWDBcollector" title=" this item you have not yet " style="width:18px;height:18px;position:relative;top:0px;left:0px;padding:0px;border:0px;margin:0px;" />';
                    } else {
                        return "";
                    }
                };
            ...
            var BuyTip = (function (e) {
                ...
                var f = function (e, t) {
                    ...
                    if (t == "market") {
                        ...
                        return '<img id="TWDBbuyTip' + i + '" src="' + Images["iconStar3"] + '" class="TWDBbuyTip" width="18px" height="18px" title="Calculating, please wait..." style="padding:0px;border:0px;margin:0px;" />';
                    }
                    if (isDefined(r[n])) {
                        if (t == "shop") {
                            var s = h(n);
                    ...
                    e.divMain.append(
                        '<img src="' + Images["iconStar3"] + '" class="TWDBbuyTip" width="25px" height="25px"     title="Calculating, please wait..."  style="position:absolute;bottom:-8px;right:-5px;padding:0px;border:0px;margin:0px;" />'
                    );
                    Worker.add(
                        (function (e, t) {
                            return function () {
                ...
                var QuestbookSwitch = function () {
                    try {
                        ...
                        QuestGroupWindowView.showSolvedQuest = function (e) {
                            ...
                            var r = $('<a href="#"> Show completion text </a>')
                                .addClass("introshown")
                                .click(function () {
                                    var e = $(this),
                                    ...
                                    t.toggle(r);
                                    n.toggle(!r);
                                    e.text(r ? " Show introduction text " : " Show completion text ");
                ...
                var enhanceMarketSellDialog = function () {
                    ...
                    MarketWindow.TWDB_touchUpSellDialog = function (n) {
                        ...
                        $("tr:nth-last-child(5) td:nth-child(2) span.tw2gui_textfield", i).after(
                            '<span id="twdb_msd_mult_cc" ' +
                            'title="Adjust (multiply) the current price with this count" ' +
                            'style="background-image:url(/images/ranking/town_ranking_icons.png);' +
                            'display:inline-block;height:16px;width:16px;' +
                            'background-position:0px -80px;cursor:pointer;">&nbsp;</span>' +
                            '<span id="twdb_msd_mult_max_cc" ' +
                        ...
                        $("#twdb_msd_desc_cc", r).append(
                            $('<div class="tw2gui-iconset tw2gui-icon-save" title="Save description for future auctions">').click(function () {
                                u("description", $("textarea#auction_description", r).val());
                            }),
                            $('<div class="tw2gui-iconset tw2gui-icon-abort" title="Reset description">').click(function () {
                                u("description", "");
                                $("textarea#auction_description", r).val("");
                            })
                        );
                        $("#twdb_msd_bid_btn_cc", r).append(
                            /*$('<span class="tw2gui-iconset tw2gui-icon-save" title="Save default prices" style="display: inline-block;">').click(function () {
                            ...
                            $('<span class="tw2gui-iconset tw2gui-icon-abort" title="Reset options" style="display: inline-block;">').click(function () {
                        ...
                        $("#twdb_msd_buy_cc", r)
                            .append(new west.gui.Checkbox("", "twdb_msd_buy_fix", o).setTitle("Use as default price").setValue(2).divMain)
                            .append(
                                $('<div class="tw2gui_checkbox" title="Set item&#38;#39;s buying price">')
                            ...
                            .append("&nbsp;&nbsp;")
                            .append(new west.gui.Checkbox("", "twdb_msd_buy_fix", o).setTitle("Use as default price").setValue(1).divMain)
                            .append(
                                $('<div class="tw2gui_checkbox" title="Set item&#38;#39;s selling price">')
                        ...
                        $("#twdb_msd_bid_cc", r)
                            .append(new west.gui.Checkbox("", "twdb_msd_bid_fix", o).setTitle("Use as default price").setValue(2).divMain)
                            .append(
                                $('<div class="tw2gui_checkbox" title="Set item&#38;#39;s buying price">')
                                    .append('<span class="invPopup_buyicon" style="height:20px;">')
                                    .click(function () {
                            ...
                            .append("&nbsp;&nbsp;")
                            .append(new west.gui.Checkbox("", "twdb_msd_bid_fix", o).setTitle("Use as default price").setValue(1).divMain)
                            .append(
                                $('<div class="tw2gui_checkbox" title="Set item&#38;#39;s selling price">')
                                    .append('<span class="invPopup_sellicon" style="height:20px;">')
                                    .click(function () {
                        ...
                        const $stackInput = $("#market_sell_itemStack", r);
                        const maxCount = Bag.getItemByItemId(e.item_id).count;
                        if (maxCount && maxCount > 1) {
                            $("#twdb_msd_mult_max_cc")
                                .text("(" + maxCount + ")")
                                .click(function () {
                                    // 1) set max stack
                                    $stackInput.val(maxCount).keyup();

                                    // 2) reuse existing multiplier logic
                                    $("#twdb_msd_mult_cc").click();
                                });
                        }
                        $("#twdb_msd_opt_cc", r).append(
                            $('<span class="tw2gui-iconset tw2gui-icon-save" title="Save duration and rights for future auctions" style="display: inline-block;">').click(function () {
                ...
                var weeklyCrafting = function () {
                    if (w.Character.professionId && w.Character.professionSkill > 599) {
                        var e = function (e) {
                            ...
                            var r =
                                "<div style='text-align:center;'>You can craft again!<br />" +
                ...
                _self.injectTaskJobs = function () {
                    try {
                        ...
                        TaskJob = function () {
                            ...
                            t.getTitle = function () {
                                return t.__twdb__getTitle() + "LP: " + (this.data.job_points < 0 ? "<b class='text_red'>" : "<b>") + this.data.job_points + "</b><br />";
                            };
                            return t;
                        };
                    } catch (t) {
                            ...
                            if (!$("#CC_pin_items").length) {
                                Inventory.DOM.children(".actions").append(
                                    $('<div id="CC_pin_items" class="tw2gui_iconbutton" />')
                                        .attr({ title: "Toggle item pinning mode".twdb_twiceHTMLUnescape() })
                            ...
                            t.contentPane
                                ...
                                .before(
                                    $('<div class="telegram-source"><div>BB</div></div>')
                                        .attr("title", "Switch between formatted telegram and source")
                                        .click(function () {
                                    ...
                                    localStorage.setItem(
                                        ...
                                        JSON.stringify([
                                            ...
                                            },
                                            {
                                                ...
                                                date: new ServerDate().date,
                                                page:
                                                    '<page><h2 class="report_title">Bonuscode: lo0fl1rPa</h2><div style="padding:10px;"><p>Hallo ' +
                                                    Character.name +
                                                    ", der Bondumtausch konnte bei dir leider nicht korrekt ausgefÃ¼hrt werden, da du keine 5.000 Bonds besitzt. Eine weitere Verwendung des Bonuscode ist nun leider nicht mehr mÃ¶glich.</p></div></page>",
                                                animated: 0,
                                            },
                                            { upbs: Character.upb },
                                        ])
                    ...
                    var n = function (t) {
                                        ...
                                        if (r.jsInfo.type == "inventory_changed") {
                                            ...
                                            if (s) {
                                                e(this)
                                                    ...
                                                    .after(
                                                        '<span title="Show this Job at ClothCalc Window" class="quest_mmaplink" title="" onclick="javascript:void(Quest.CCopen(\'' +
                                                            s.name +
                                                            "','item'))\"><img src=\"" +
                                                            Images.iconLight +
                                                            '" /></span>'
                        ...
                        if ((t.group < 142 && (t.group != 69 || t.id >= 2e4)) || [200, 201].indexOf(t.group) > -1) {
                            t.el
                                ...
                                .append(
                                    '<a target="_blank" title="show that quest at tw-db.info" href="' +
                                        Script.protocol +
                                        "://" +
                                        Script.url +
                ...
                var s = function () {
                    try {
                        ...
                        QuestWindow.cancelQuest = function (t) {
                            new west.gui.Dialog("Cancel Quest?", "Are you sure that you want to cancel that Quest?")
            ...
            var Customs = (function (e) {
                ...
                t.open = function () {
                    ...
                    i = new west.gui.Dialog("Custom skills", t)
                        .addButton("ok", function () {
                ...
                var f = function (e) {
                    ...
                    new west.gui.Dialog("delete - Custom skills", "delete: " + String(n[e].name).escapeHTML() + "?").addButton("ok", r).addButton("cancel").show();
                };
                var l = function () {
                    var e = 0;
                    for (var t in n) {
                ...
                var c = function (t) {
                    if (isDefined(n[t])) {
                        ...
                        var s = "Edit - Custom skills";
                    } else {
                        var r = "";
                        var i = "";
                        var s = "add - Custom skills";
                    }
                    ...
                    var f = e('<table width="400px" />')
                        .append(e("<tr />").append('<td style="vertical-align:middle">Name:</td>').append(e("<td />").append(o.getMainDiv())))
                        .append(e("<tr />").append('<td style="vertical-align:middle">code:</td>').append(e("<td />").append(u.getMainDiv())))
                        .append(e('<tr><td colspan="2">please go to tw-db.info an get the code snippets to inserts here from there <a href="https://' + Script.url + '/?strana=calc" target="_blank">tw-db.info Calculator</a></td></tr>'));
            ...
            var DuelMotivation = (function (e) {
                ...
                var m = function (e) {
                    ...
                    d(t + "%", "Duel Motivation:&nbsp;" + t + "%", e ? "duelmot_dim" : "");
                };
                var g = function (e) {
                    if (f) {
                        w.clearInterval(f);
                    ...
                    a = "<div style='text-align:center;'>K.O. time<br />";
                    if (!c && n > t && !e) {
                        a += "Duel suspension until&nbsp;" + new Date(n).toLocaleString() + "<br />";
                    ...
                    u = Math.max(0, u);
                    a += "Duel protection until&nbsp;" + new Date(r).toLocaleString() + "</div>";
            ...
            var Bank = (function (e) {
                ...
                var s = function () {
                    ...
                    btn.click(function () {
                        o();
                    }).addMousePopup("Deposit your Cash");
                };
                var o = function () {
                    new west.gui.Dialog("Deposit your Cash", e("<span class='twdb_banking'>Money: " + w.Character.money + "</span>"))
                        .setIcon(west.gui.Dialog.SYS_QUESTION)
                        .setModal(true, false)
                        .addButton("yes", function () {
                            a(1);
                ...
                var u = function () {
                    try {
                        ...
                        if (w.Character.position.x == w.Character.homeTown.x && w.Character.position.y == w.Character.homeTown.y) {
                            if (n) {
                                n = false;
                                new west.gui.Dialog("Deposit your Cash", e("<span class='twdb_banking'>You have arrived to your Hometown. Would you like to deposit your Cash? <br />Money: " + w.Character.money + "</span>"))
                                    .setIcon(west.gui.Dialog.SYS_QUESTION)
                                    .setModal(true, false)
                                    .addButton("yes", function () {
                                        n = true;
            ...
            var Market = (function (e) {
                ...
                var o = function () {
                    ...
                    if (Settings.get("marketmap", true)) {
                        GameInject.addTabOnMarketWindow("Marketmap", "marketmap", function () {
                            c();
                        });
                ...
                var l = (function (e) {
                    ...
                    var u = function (t) {
                        var r = n[t],
                            ...
                            s = new OnGoingEntry();
                        s.init();
                        s.setTooltip("auction: " + i.name + ", End: " + Number(r.ends - new Date().getTime() / 1e3).getTimeString4Timestamp());
                        s.setImage(e('<img src="' + Images.notiBell + '" />'));
                        WestUi.NotiBar.add(s);
                        TitleTicker.setNotifyMessage("auction: " + i.name + ", End: " + Number(r.ends - new Date().getTime() / 1e3).getTimeString4Timestamp());
                        AudioController.play(AudioController.SOUND_NEWMSG);
                        o(t);
                    };
                    t.create = function (r, i) {
                        var u = e("<div />").append('<span style="position:relative; width:100%;display:block;">End of Auction: ' + r.auction_ends_in.getTimeString4Timestamp() + "</span>"),
                            a = new west.gui.Textfield("twdb_analyser_last").maxlength(4).onlyNumeric().setLabel("Remind before Auction ends: ").setPlaceholder("Minutes");
                        u.append(a.getMainDiv());
                        ...
                        var f = new west.gui.Dialog("Marketreminder", u)
                            .setIcon(west.gui.Dialog.SYS_QUESTION)
                ...
                var h = function (e, t, n, r, s, o, u) {
                    if (!isDefined(i[e])) {
                        i[e] = { name: t, town_id: e, x: n, y: r, count: 0, offers_end: {}, offers_unend: {}, money: 0, distance: window.Map.calcWayTime(window.Character.position, { x: n, y: r }).formatDuration() };
                    }
                    var a = i[e];
                    if (s !== "") {
                ...
                var v = function () {
                    for (var t in i) {
                        ...
                        s += "</div>";
                        e("<div />")
                            .css({ left: (n.x / (181 * window.Map.tileSize)) * 770 - 5 + "px", top: (n.y / (79 * window.Map.tileSize)) * 338 - 5 + "px" })
                    ...
                    e("<img src='" + to_cdn("images/map/minimap/icons/miniicon_pos.png") + "' />")
                        .css({ left: (Character.position.x / (181 * window.Map.tileSize)) * 770 - 8 + "px", top: (Character.position.y / (79 * window.Map.tileSize)) * 338 - 8 + "px", width: "16px", height: "16px" })
                        .attr({ class: "mmap_mappoint", id: "mmap_icon_pos", title: "Your Position" })
                        .appendTo(r);
                    m();
                };
                var m = function () {
                    try {
                        ...
                        for (var u = 0; u < t.length; u++) {
                            ...
                            o +=
                                ...
                                a.name +
                                "</a>" +
                                ' <a title="Show Town on Map" onclick="Map.center(' +
                                a["x"] +
                                ", " +
                                a["y"] +
                                ')"><img src="' +
                                ...
                                " Distance: " +
                                a["distance"] +
                                ' <a title="Travel to Town" onclick="TaskQueue.add(new TaskWalk(' +
                                a.town_id +
                                ",'town'))\"><img src=\"" +
                                Game.cdnURL +
            ...
            var Fort = (function ($) {
                ...
                var inject = function () {
                    try {
                        var gradeValues = { TRAITOR: "-2", RESERVIST: "-1", RECRUIT: "0", PRIVATE: "1", SERGEANT: "2", CAPTAIN: "3", GENERAL: "4" };
                        var gradeNames = { "-2": "traitor", "-1": "reservist", 0: "recruit", 1: "private", 2: "sergeant", 3: "captain", 4: "general" };
                        ...
                        newfunction = newfunction
                            .replace(/totalCnt\s{0,1}=\s{0,1}0;/, "totalCnt=0, totalCntTotal=0, gradeCountTotal={ '-2':0, '-1':0, '0':0, '1':0, '2':0, '3':0, '4':0 };")
                            ...
                            .replace(/\.appendToThCell\('head', ?'evaluated' ?,.*?,.*?\);/, ".appendToThCell('head','healthpoints','Sort by health','<span class=\"sort sort-healthpoints\">'+'Lp'+'</span>');")
                            .replace(
                        ...
                        fb_sort = fb_sort
                            ...
                            .replace(
                                ...
                                "else if(key=='healthpoints'){title='Sort by health';sorting.append(getSortLink('Ascending current Health','>currhealth'));sorting.append(getSortLink('Descending current Health','<currhealth')); sorting.append(getSortLink('Ascending maximum Health','>maxhealth'));sorting.append(getSortLink('Descending maximum Health','<maxhealth'));sorting.append('<br />');sorting.append(getSortLink('Ascending Distance','>distance'));sorting.append(getSortLink('Descending Distance','<distance'));sorting.append(getVisLink(hidden(null,'-3','atfort')?'show Player at Fort':'hide Player at Fort','atfort'));sorting.append(getVisLink(hidden(null,'-3','nearbyfort')?'show Player near Fort':'hide Player near Fort','nearbyfort'));sorting.append(getVisLink(hidden(null,'-3','notatfort')?'show Player not near Fort':'hide Player not near Fort','notatfort'));}return{message:sorting,title:title};"
                            );
                        eval(fb_sort);
