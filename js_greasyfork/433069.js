...
// @match *://*.figma.com/*
// @downloadURL https://update.greasyfork.org/scripts/433069/Luxury%20Figma.user.js
// @updateURL https://update.greasyfork.org/scripts/433069/Luxury%20Figma.meta.js
// ==/UserScript==

(function() {
let css = `
#react-page [class*="userIconAvatar"] {
...
#react-page [data-tooltip="Missing fonts"] path {
    fill: var(--bg-overlay-active);
}

#react-page [class*="checkbox"]:checked:after {
    border-color: var(--bg-overlay-active);
