// ==UserScript==
// @name         SalesForce case helper - ONCC (Network)
// @namespace    http://tampermonkey.net/
// @version      0.3
// @description  Adds a few helpful buttons to the bottom right of the screen of Network cases to generate email subject; ONCC Handoff template
// @author       You
// @match        https://zayo.my.salesforce.com/5000z*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/402121/SalesForce%20case%20helper%20-%20ONCC%20%28Network%29.user.js
// @updateURL https://update.greasyfork.org/scripts/402121/SalesForce%20case%20helper%20-%20ONCC%20%28Network%29.meta.js
// ==/UserScript==
var subjectCopyText = "";
(function() {
    'use strict';
    ...
    floatingHelperdiv.style.background = "transparent";
...
//Finally, we create the button
    ...
    var customerName = "Network Case";
    var CID = document.getElementById('00N60000001iwjl_ileinner').innerText;
    ...
    var customerContactInfo = "N/A - Network Case";
    ...
    function buildHandoffTXT () {
        ...
        handoffTXT = handoffTXT.concat("N/A");
    ...
    //Create a button to copy the TTN to clipboard (I couldn't figure out how to make this into a link, so a button will have to do)
    var ttnTXT = "Copy TTN";
    var ttnButton = document.createElement("input"); //create and style the button
    ttnButton.type = "button";
    ttnButton.name = ttnTXT;
    ttnButton.value = ttnTXT;

    ttnButton.onclick = function() {
        document.getElementById("phSearchInput").value = TTN; //typically, you'd want to create a hidden text field and put the text to be coppied into it, but I don't see the point. This just puts it in the search field at the top of the page
        document.getElementById("phSearchInput").select(); //select all the text in the search field
        document.execCommand("copy"); //Copy the selected text to the clipboard
        document.getElementById("phSearchInput").value = ""; //Clear the search box at the top, like it never happened
    };
    ...
    floatingHelperdiv.appendChild(ttnButton); //Add the "Copy TTN" button
