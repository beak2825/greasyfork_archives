...
// @license      GNU GPLv3
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/447644/ExHentai%20%E6%9B%B4%E6%94%B9%E6%A8%99%E9%A1%8C%E5%AD%97%E4%B8%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/447644/ExHentai%20%E6%9B%B4%E6%94%B9%E6%A8%99%E9%A1%8C%E5%AD%97%E4%B8%B2.meta.js
// ==/UserScript==
...
$(document).ready(function () {
    ...
    n.text().match(/[0-9]{4}年[1-9]{1}月号/) && ( n.text(n.text().replace(/([1-9]{1}月号)/g,'0$1')) );
    ...
    n.text().match(/(【|\[|\()?((中国|中國|中文)(語|语)?(翻译|翻譯|翻訳)?|[^\x00-\xff]+(汉化|漢化|嵌字|制作|製作)(組|组)?(?!所)|CHINESE)(】|\]|\)?)/gi) && ( n.text(n.text().replace(/(【|\[|\(|\（)?\s?((中国|中國|中文)(語|语)?(翻译|翻譯|翻訳|制作|製作)?|[^\x00-\xff]+(汉化|漢化|嵌字|制作|製作)(組|组)?(?!所)|CHINESE)\s?(】|\]|\)|\）?)/gi,'[中国翻訳]')) );
