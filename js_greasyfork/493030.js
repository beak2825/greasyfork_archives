// ==UserScript==
// @name           豆瓣资源随便下1.4.6
// @description    聚合几十家家资源网站，通过右侧边栏1秒告诉你哪些网站能下载豆瓣页面上的电影|电视剧|纪录片|综艺|动画|音乐|图书等
// @author         全网搜：yunsou.xyz
// @contributor    Rhilip
// @connect        *
...
// @downloadURL https://update.greasyfork.org/scripts/493030/%E8%B1%86%E7%93%A3%E8%B5%84%E6%BA%90%E9%9A%8F%E4%BE%BF%E4%B8%8B146.user.js
// @updateURL https://update.greasyfork.org/scripts/493030/%E8%B1%86%E7%93%A3%E8%B5%84%E6%BA%90%E9%9A%8F%E4%BE%BF%E4%B8%8B146.meta.js
// ==/UserScript==
...
if (typeof GM_registerMenuCommand !== "undefined") {
    ...
    function changeTagBColor() {
        ...
        let name = prompt("请依次输入代表'点击进入','点击进入','站点需要登陆','站点解析错误'颜色的Hex值，并用英文逗号分割。当前值为：", `${now_bcolor_list.join(',')}`);
        if (name != null && name !== "") {
            try {
    ...
    function changeTagFColor() {
        ...
        let name = prompt("请依次输入代表'点击进入','点击进入','站点需要登陆','站点解析错误'颜色的Hex值，并用英文逗号分割。当前值为：", `${now_fcolor_list.join(',')}`);
        if (name != null && name !== "") {
            try {
...
$(document).ready(function () {
    ...
    if (douban_id) {
        ...
        $("#content div.aside").prepend(`<div id="drdm_req_status" style="color: #C65E24; padding: 10px; margin-bottom: 20px; word-wrap: break-word;display: none;">
<div style="text-align: "> <p style="color: red;">豆瓣资源随便下1.4.6</p><a href="javascript:void();" id="drdm_req_status_hide"></a> </div>
<span id="drdm_req_help">
</span>
</div>
<div id='drdm_sites'></div>`);
        $("#drdm_req_status_hide").click(function () { $("#drdm_req_status").hide(); });
        $("#drdm_hide_fail").click(function () {
            $("#drdm_sites a[title!=\"点击进入\"]").hide();
        ...
        function update_req_status() {
            ...
            $("#drdm_req_success").text($("#drdm_sites a[title=\"点击进入\"]").length);
            $("#drdm_req_asking").text(asking_length);
            $("#drdm_req_noexist").text($("#drdm_sites a[title=\"点击进入\"]").length);
...
<div class="rating_more" style="display:none"></div>`); // 修复部分情况$("div.rating_betterthan")不存在情况
            ...
            site_map.push({
                name: "云盘搜索",
                label: [
                    { name: '网盘论坛', link: 'https://wpzy.cc/?q=' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: '网盘影视', link: 'https://wpzy.me/?q=' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: '网盘盘搜', link: 'https://ipanso.cc/search/?kw=' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: '云搜影视', link: 'https://yunsou.xyz/s/' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: '无朋影视', link: 'https://wpys.cc/s/' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: '博哥影视', link: 'https://blog.wpys.cc/search/' + unititle, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                ]
            });
            /** if (has_imdb || is_ywm) {
                site_map.push({
            ...
            site_map.push({
                name: "图书网盘搜索",
                label: [
                    { name: '云搜搜书', link: 'https://yunsou.xyz/s/' + title, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: '无朋搜书', link: 'https://wpys.cc/s/' + title, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                ]
            });
            ...
            site_map.push({
                name: "图书免费网站",
                label: [
                    { name: '网盘搜书', link: 'https://wpzy.cc/?q=' + title, ajax: "https://aliyunshare.cn/api/discussions?page%5Blimit%5D=3&include=mostRelevantPost&filter%5Bq%5D=" + title, type: "json", selector: 'data.length > 0' },
            ...
            if (_version === "完整版") {
             ...
             site_map.push({
                name: "无损音乐网盘搜索",
                label: [
                    { name: '云搜搜歌', link: 'https://yunsou.xyz/s/' + title, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                    { name: '无朋搜歌', link: 'https://wpys.cc/s/' + title, selector: 'ul.DiscussionList-discussions > li[data-id]' },
                ]
            });
            site_map.push({
                name: "在线音乐播放",
