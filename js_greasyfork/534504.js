// ==UserScript==
// @name         Ed 4Rec  dkb.kl.bo@t-online.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/534504/Ed%204Rec%20%20dkbklbo%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/534504/Ed%204Rec%20%20dkbklbo%40t-onlinede.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  2770},  // 72000
        { index: 1, adjustmentAmount:  2770},  // 72000
        { index: 2, adjustmentAmount:  2770},  // 72000
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    // Define the target text content to search for (case and whitespace insensitive)
       var targetTextContent1 = "DE43 2069 0500";
       var targetTextContent2 = " 0000 6639 30";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 2770; // Adjust the amount as needed  // 72000
