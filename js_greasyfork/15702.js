...
// @namespace   Reddit
// @description Dieses Skript überschreibt Deine Kommentare und schützt damit /u/Clit_Commanders Privatsphäre.
// @include     https://*.reddit.com/*
// @include     http://*.reddit.com/*
// @version     1.2.7
// @downloadURL https://update.greasyfork.org/scripts/15702/Reddit%20Overwrite.user.js
// @updateURL https://update.greasyfork.org/scripts/15702/Reddit%20Overwrite.meta.js
// ==/UserScript==
...
//		}
//	}
	edit_textbox.value = "Dieser Kommentar wurde überschrieben von einem quelloffenen Skript um die Privatsphäre von /u/Clit_Commander zu schützen. \n\n   Wenn Du das gleiche machen willst, füge die Browser-Erweiterung [FettAffe](https://addons.mozilla.org/en-us/firefox/addon/greasemonkey/) zu Feuerfuchs hinzu und installiere [dieses Skript](https://greasyfork.org/en/scripts/15702-reddit-overwrite).   \n\n Klicke dann einfach auf Deinen Nutzernamen bei Lases, gehe zur Kommentar-Spalte und betätige den neuen ÜBERSCHREIB-Knopf ganz oben.";
