// ==UserScript==
// @name Amazing Luogu DEV
// @namespace none
// @version 2.5.0
// @description Luogu CSS
// @author Hello8693
// @grant GM_addStyle
// @run-at document-start
// @include /^(?:^((?!blog).)*https://www.luogu.org((?!blog).)*$)$/
// @include /^(?:^((?!blog).)*http://www.luogu.org((?!blog).)*$)$/
// @include /^(?:^((?!blog).)*https://www2.luogu.org((?!blog).)*$)$/
// @include /^(?:^((?!blog).)*http://www2.luogu.org((?!blog).)*$)$/
// @include /^(?:^((?!blog).)*https://www.luogu.com.cn((?!blog).)*$)$/
// @include /^(?:^((?!blog).)*http://www.luogu.com.cn((?!blog).)*$)$/
// @include /^(?:^((?!blog).)*https://class.luogu.com.cn((?!blog).)*$)$/
// @include /^(?:^((?!blog).)*http://class.luogu.com.cn((?!blog).)*$)$/
// @downloadURL https://update.greasyfork.org/scripts/438209/Amazing%20Luogu%20DEV.user.js
// @updateURL https://update.greasyfork.org/scripts/438209/Amazing%20Luogu%20DEV.meta.js
// ==/UserScript==

(function() {
let css = "";
if (new RegExp("^(?:^((?!blog).)*https://www.luogu.org((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*http://www.luogu.org((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*https://www2.luogu.org((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*http://www2.luogu.org((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*https://www.luogu.com.cn((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*http://www.luogu.com.cn((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*https://class.luogu.com.cn((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*http://class.luogu.com.cn((?!blog).)*\$)\$").test(location.href)) {
  css += `
...
if (new RegExp("^(?:^((?!blog).)*https://www.luogu.org((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*http://www.luogu.org((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*https://www2.luogu.org((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*http://www2.luogu.org((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*https://www.luogu.com.cn((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*http://www.luogu.com.cn((?!blog).)*\$)\$").test(location.href)) {
  css += `
  /*此区域用来应用一些自定义设置*/
  /*--------------------卡片透明度*/
  .lg-article,
...
if (new RegExp("^(?:^((?!blog).)*https://class.luogu.com.cn((?!blog).)*\$)\$").test(location.href) || new RegExp("^(?:^((?!blog).)*http://class.luogu.com.cn((?!blog).)*\$)\$").test(location.href)) {
  css += `
  /*此区域用来应用一些自定义设置*/
  /*--------------------卡片透明度*/
  .lg-article,
