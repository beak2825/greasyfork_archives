...
// @name         Для технических чоколадок / K. Stoyn
...
// @downloadURL https://update.greasyfork.org/scripts/529120/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%87%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BE%D0%BA%20%20K%20Stoyn.user.js
// @updateURL https://update.greasyfork.org/scripts/529120/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%87%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BE%D0%BA%20%20K%20Stoyn.meta.js
// ==/UserScript==
  ...
  const TRANSFER_PREFIX_TR46 = 20; // перенос в тех раздел 11
  const TRANSFER_PREFIX_OBJ46 = 21; // перенос обжалования 11
  const TRANSFER_PREFIX_ADM46 = 22; // перенос в жб адм 11
  const TRANSFER_PREFIX_PLAYER46 = 23; // перенос в жб игроков 11
  const TRANSFER_PREFIX_TR47 = 25; // перенос в тех раздел 12
  const TRANSFER_PREFIX_OBJ47 = 26; // перенос обжалования 12
  const TRANSFER_PREFIX_ADM47 = 27; // перенос в жб адм 12
  const TRANSFER_PREFIX_PLAYER47 = 28; // перенос в жб игроков 12
  const TRANSFER_PREFIX_TR48 = 29; // перенос в тех раздел 13
  const TRANSFER_PREFIX_OBJ48 = 30; // перенос обжалования 13
  const TRANSFER_PREFIX_ADM48 = 31; // перенос в жб адм 13
  const TRANSFER_PREFIX_PLAYER48 = 32; // перенос в жб игроков 13
  const TRANSFER_PREFIX_TR49 = 33; // перенос в тех раздел 14
  const TRANSFER_PREFIX_OBJ49 = 34; // перенос обжалования 14
  const TRANSFER_PREFIX_ADM49 = 35; // перенос в жб адм 14
  const TRANSFER_PREFIX_PLAYER49 = 36; // перенос в жб игроков 14
  const TRANSFER_PREFIX_TR50 = 37; // перенос в тех раздел 15
  const TRANSFER_PREFIX_OBJ50 = 38; // перенос обжалования 15
  const TRANSFER_PREFIX_ADM50 = 39; // перенос в жб адм 15
  const TRANSFER_PREFIX_PLAYER50 = 40; // перенос в жб игроков 15
...
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER]После проведения дополнительной тщательной проверки информации, осуществленной с использованием специализированного сайта, было принято обоснованное решение о снятии вашего наказания. Мы подтверждаем, что данное наказание будет официально аннулировано в течение 24 часов.<br>Мы понимаем, что подобные ситуации могут вызывать значительное беспокойство и неудобства. Поэтому, позвольте нам выразить наши искренние извинения за причиненные неудобства. Мы осознаем, что каждый пользователь имеет право на корректное и справедливое обращение, и сожалеем о том, что возникшая ситуация могла повлиять на ваше доверие.<br><br>' +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в тех.раздел 11)',
...
{
	title: 'Ошибся разделом (перемещ в обж 11)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 11)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 11)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в тех.раздел 12)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 12)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 12)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 12)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в тех.раздел 13)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 13)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 13)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 13)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в тех.раздел 14)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 14)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 14)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 14)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в тех.раздел 15)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в обж 15)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перемещ в жб на адм 15)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
{
	title: 'Ошибся разделом (перепещ в жб на игроков 15)',
	color: 'oswald: 3px; color: #ff6600; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=trebuchet ms][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
