...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/369832/Anti-Censure%20JVC%2020.user.js
// @updateURL https://update.greasyfork.org/scripts/369832/Anti-Censure%20JVC%2020.meta.js
// ==/UserScript==
...
for (var i = 0; i < bloc_msg.length; i++) {
    ...
    shill_img.setAttribute("onclick", "this.parentElement.parentElement.parentElement.children[0].setAttribute('style', 'color:red');");
