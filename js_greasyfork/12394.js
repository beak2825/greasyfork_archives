...
// @name         GSIX
// @version      1.2
// @description  Secret Clan Extension
// @author       Kemal Dikkulak
// @match        http://agar.io
// @match        https://agar.io
// @match        http://agar.io/?ip=127.0.0.1:80
// @match        https://agar.io/?ip=127.0.0.1:80
...
//                 0.9 - Skins are uploaded for the clan and colour improvements
//                 1.1 - Defaults are changed
...
// @namespace 
// @downloadURL https://update.greasyfork.org/scripts/12394/GSIX.user.js
// @updateURL https://update.greasyfork.org/scripts/12394/GSIX.meta.js
// ==/UserScript==
...
var debugMonkeyReleaseMessage = "<h3>Welcome to the XXL official extension</h3><p>" +
    "Hey guys. Please use our Facebook group chat till we activate our own teamspeak server. <br><br>" +
    "Let's move!<br>" +
    "<br>Leader, KemalDikkulak<br>" +
 "<br>Co-Leader, RyanGoffinet";
...
(function(d, f) {
    ...
    var miniMapCtx=jQuery('<canvas id="mini-map" width="175" height="175" style="border:3px solid #999;text-align:center;position:fixed;bottom:5px;right:5px;"></canvas>')
...
// ======================   Skins    ==================================================================
    ...
    var extendedSkins = {
        ...
        "[gѕιχ]Rєαℓιѕтι¢" : "http://i.imgur.com/UnneVyS.jpg",
    ...
    var skinsSpecial = {
        ...
        "[gѕιχ]яєαℓιѕтι¢" : "http://i.imgur.com/UnneVyS.jpg",
        "[gѕιχ]тнєσ" : "http://i.imgur.com/MPI5ZPe.png",
        "[gѕιχ]∂σğυкαη" : "https://i.imgur.com/4y8szAE.png",
        "ﾒﾒﾚ¶尺◊んﾑ刀" : "http://i.imgur.com/wxCfUws.jpg",
        "ﾒﾒﾚ¶ズ乇ﾶﾑﾚ" : "http://i.imgur.com/StNJkWj.jpg",
    };
...
'<h4 class="modal-title">GSIX Extension v' +GM_info.script.version + '</h4>'+
'</div>'+
...
jQuery('#ZCOverlayBody').append('<div id="ZCStats" style="position:relative;width:100%; background-color: #FFFFFF; border-radius: 15px; padding: 5px 15px 5px 15px;">'+
    ...
    '<li role="presentation">                 <a href="#page2" id="configTab" role="tab" data-toggle="tab">Options</a></li>' +
    '<li role="presentation">                 <a href="#page3" id="helpTab" role="tab" data-toggle="tab">Shortcuts</a></li>' +
    '<li role="presentation">                 <a href="#page1" id="statsTab"  role="tab" data-toggle="tab">Level</a></li>' +
