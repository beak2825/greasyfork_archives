...
// @downloadURL https://update.greasyfork.org/scripts/27142/Xthor%20shoutbox.user.js
// @updateURL https://update.greasyfork.org/scripts/27142/Xthor%20shoutbox.meta.js
// ==/UserScript==
...
#control_label_casino {
    ...
    width:29px;
    height:31px;
    background:url("https://img.xthor.tk/2019/04/54feef_DH0lGFshout_casino_ico.png") no-repeat center center #1f1f1f;
    border-radius:0 5px 5px 0;
    -moz-border-radius:0 5px 5px 0;
    -webkit-border-radius:0 5px 5px 0;
...
#control_label_custom {
    ...
    width:29px;
    height:31px;
    background:url("https://img.xthor.tk/2017/06/54feef_shout2.png") no-repeat center center #1f1f1f;
    border-radius:0 5px 5px 0;
    -moz-border-radius:0 5px 5px 0;
    -webkit-border-radius:0 5px 5px 0;
  -webkit-transition: all .25s linear;
...
HideConf["system_request"] = false;
HideConf["system_potcommun"] = false;
HideConf["system_jeton"] = false;
HideConf["system_staffgift"] = false;
        ...
        $(` <div id="control_panel_custom" class="" style="left: -180px;">
            ...
            <div class="style_block">
                <form class="form-vertical">
                    ...
                    <div class="checkbox">
                      <label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="system_jeton" class="detect_change" type="checkbox" value="">
                         Jeton
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="system_request" class="detect_change" type="checkbox" value="">
                         Requêtes/Primes
                      </label>
                    </div>
                    <div class="checkbox">
                    ...
                    <div class="checkbox">
                      <label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="system_staffgift" class="detect_change" type="checkbox" value="">
                         Cadeau staff
                      </label>
                    </div>
                    <div class="checkbox">
...
val = readBoolLocalStorage('system_request'); $('#system_request').prop('checked', val); HideConf.system_request=val;
val = readBoolLocalStorage('system_potcommun'); $('#system_potcommun').prop('checked', val); HideConf.system_potcommun=val;
val = readBoolLocalStorage('system_jeton'); $('#system_jeton').prop('checked', val); HideConf.system_jeton=val;
val = readBoolLocalStorage('system_staffgift'); $('#system_staffgift').prop('checked', val); HideConf.system_staffgift=val;
...
$('.detect_change').change(function() {
    ...
    if(this.id=="system")
    {
        ...
        HideConf.system_request=val;   writeLocalStorage("system_request",val);   $("#system_request").prop('checked', val);
        HideConf.system_potcommun=val;   writeLocalStorage("system_potcommun",val);   $("#system_potcommun").prop('checked', val);
        HideConf.system_jeton=val;   writeLocalStorage("system_jeton",val);   $("#system_jeton").prop('checked', val);
        HideConf.system_staffgift=val;   writeLocalStorage("system_staffgift",val);   $("#system_staffgift").prop('checked', val);
    }
...
function setupHook(xhr) {
  function getter() {
    ...
    delete xhr.responseText;
         ...
         if (!HideConf.dupe && !HideConf.member && !HideConf.system_casino && !HideConf.system_gang && !HideConf.system_bookmaker &&
             !HideConf.system_tombola && !HideConf.system_chifoumi && !HideConf.system_forum && !HideConf.system_upload &&
             !HideConf.system_comment && !HideConf.system_market && !HideConf.system_request && !HideConf.system_potcommun &&
             !HideConf.system_jeton  && !HideConf.system_staffgift)
        ...
        doc.find("tr").each(function() {
            ...
            if (HideConf.system_casino || HideConf.system_gang || HideConf.system_bookmaker || HideConf.system_tombola || HideConf.system_chifoumi ||
                HideConf.system_forum || HideConf.system_upload || HideConf.system_comment || HideConf.system_market || HideConf.system_request ||
                HideConf.system_potcommun || HideConf.system_jeton || HideConf.system_staffgift)
            {
                        ...
                        if (ValueAttributeClass.indexOf("fa-globe")!=-1)
                        {
                            ...
                            if (remove_after==false && HideConf.system_casino)
                            {
                                ...
                                if (ListBaliseA.length>0)
                                {
                                    ...
                                    {
                                        if (ListBaliseA[i].getAttribute("href").indexOf("https://xthor.tk/casino.php?takebet=")!== -1)
                                            remove_after=true;
                                        else if (ListBaliseA[i].getAttribute("href").indexOf("https://xthor.tk/casino.php")!== -1)
                                            remove_after=true;
                                    }
                                }
                                if(remove_after==false)
                                {
                                    ...
                                    if (ListBaliseI.length>0)
                                    {
                                        for (let i = 0; i < ListBaliseI.length; i++)
                                        {
                                            if (ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa-gamepad")!== -1)
                                                remove_after=true;
                                        }
                                    }
                                }
                            ...
                            if (remove_after==false && HideConf.system_bookmaker)
                            {
                                ...
                                if (ListBaliseI.length>0)
                                {
                                    ...
                                    {
                                        if (IsUpload==false && ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa-futbol")!== -1)
                                            remove_after=true;
                                        else if (ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa fa-download")!== -1)
                                        {
                                            remove_after=false;
                                            IsUpload=true;
                                        }
                                ...
                                if(IsUpload==false && remove_after==false)
                                {
                                    ListBaliseA =  $(this).find('a');
                                    if (ListBaliseA.length>0)
                                    {
                                        for (var i = 0; i < ListBaliseA.length; i++)
                                        {
                                            if (ListBaliseA[i].getAttribute("href").indexOf("https://xthor.tk/soccer_players.php")!== -1)
                                                remove_after=true;
                                        }
                                    }
                                }
                            ...
                            if (remove_after==false && HideConf.system_forum)
                            {
                                ...
                                if (ListBaliseI.length>0)
                                {
                                    for (var i = 0; i < ListBaliseI.length; i++)
                                    {
                                        if (ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa-comment")!== -1)
                                            remove_after=true;
                                    }
                                }
                            }
                            ...
                            if (remove_after==false && HideConf.system_potcommun)
                            {
                                ...
                                if (ListBaliseA.length>0)
                                {
                                    for (var i = 0; i < ListBaliseA.length; i++)
                                    {
                                        if (ListBaliseA[i].getAttribute("href").indexOf("https://xthor.tk/shop.php?freeleech")!== -1)
                                            remove_after=true;
                                    }
                                }
                            }
                            ...
                            if (remove_after==false && HideConf.system_market)
                            {
                                ...
                                if (ListBaliseA.length>0)
                                {
                                    for (var i = 0; i < ListBaliseA.length; i++)
                                    {
                                        //./pic/smilies/trump-icon.png https://xthor.tk/shop.php?&market
                                        if (ListBaliseA[i].getAttribute("href").indexOf("https://xthor.tk/shop.php?&market")!== -1)
                                            remove_after=true;
                                        if (ListBaliseA[i].getAttribute("href").indexOf("srrdb.com")!== -1)
                                            srrdb=true;
                                    }
                                }
                                ...
                                if (ListBaliseImg.length>0)
                                {
                                    ...
                                    {
                                        if (ListBaliseImg[i].getAttribute("src").indexOf("graphpeche.gif")!== -1 || ListBaliseImg[i].getAttribute("src").indexOf("kerviel.png")!== -1 || ( ListBaliseImg[i].getAttribute("src").indexOf("telephone.gif")!== -1 && srrdb==false) )
                                            remove_after=true;
                                    }
                                }
                            }

                            if (remove_after==false && HideConf.system_request)
                            {
                                srrdb=false;
                                ListBaliseA =  $(this).find('a');
                                if (ListBaliseA.length>0)
                                ...
                                if (ListBaliseImg.length>0)
                                {
                                    ...
                                    {
                                        //req
                                        if (ListBaliseImg[i].getAttribute("src").indexOf("bow.gif")!== -1)
                                            remove_after=true;
                                        //prime
                                        if (ListBaliseImg[i].getAttribute("src").indexOf("telephone.gif")!== -1)
                                            remove_after=true;
                                    }
                                }
                            }
                            ...
                            if (remove_after==false && HideConf.system_tombola)
                            {
                                ...
                                if (ListBaliseA.length>0)
                                {
                                    for (var i = 0; i < ListBaliseA.length; i++)
                                    {
                                        if (ListBaliseA[i].getAttribute("href").indexOf("https://xthor.tk/tombola.php")!== -1)
                                            remove_after=true;
                                    }
                                }
                            }
                            ...
                            if (remove_after==false && HideConf.system_gang)
                            {
                                ...
                                if (ListBaliseI.length>0)
                                {
                                    ...
                                    for (var i = 0; i < ListBaliseI.length; i++)
                                    {
                                        if (ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa-gavel")!== -1)
                                            gravel=true;
                                        else if (ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa-truck")!== -1)
                                            truck=true;
                                        ...
                                        if (ListBaliseI[i].getAttribute("class") && ListBaliseI[i].getAttribute("class").indexOf("fa-download")!== -1)
                                        {
                                            $(this).find("a").each(function() {
                                                ...
                                                if (href_val && href_val.indexOf("gang.php")!=-1)
                                                    $(this).remove();
                                            });
                                            let price = $("span", this).last().text();
                                            if (price.indexOf(" $")!=-1)
                                                $("span", this).last().remove();
                                        }
                                    }
                                    if (gravel==true && truck==true)
                                    {
                                        remove_after=true;
                                    }
                                }
                            ...
                            if (remove_after==false && HideConf.system_jeton)
                            {
                                ListBaliseImg =  $(this).find('img');
                                if (ListBaliseImg.length>0)
                                {
                                    for (var i = 0; i < ListBaliseImg.length; i++)
                                    {
                                        if (ListBaliseImg[i].getAttribute("src").indexOf("strongbench.gif")!== -1)
                                            remove_after=true;
                                    }
                                }
                            }

                            if (remove_after==false && HideConf.system_staffgift)
                            {
                                txt_sysmsg =  $(this).text();
                                if (txt_sysmsg.length>0)
                                {
                                    if (txt_sysmsg.indexOf(" a été récompensé d'une invitation")!== -1)
                                        remove_after=true;
                                }
                            }
