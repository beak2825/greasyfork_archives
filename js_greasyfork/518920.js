...
// @author        Dortai_Dortaevich 
// @match         https://forum.blackrussia.online/threads/*
// @include       https://forum.blackrussia.online/threads/
// @icon          https://icons.iconarchive.com/icons/google/noto-emoji-food-drink/256/32343-watermelon-icon.png
// @grant         none
// @license       none
// @downloadURL https://update.greasyfork.org/scripts/518920/Black%20Russia%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/518920/Black%20Russia%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            '[FONT=times new roman][CENTER][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [COLOR=rgb(255, 255, 0)]YELLOW.[/COLOR][/SIZE][/CENTER][/FONT]',
        ...
        },
        {
            ...
            "[SIZE=4][CENTER][FONT=times new roman][COLOR=rgb(209, 213, 216)]Ваша RolePlay биография - отказана.[/COLOR][/CENTER]<br><br>" +
            ...
            '[FONT=times new roman][SIZE=4][CENTER][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [COLOR=rgb(255, 255, 0)]YELLOW.[/COLOR][/CENTER][/SIZE][/FONT]',
        ...
        },
        {
            ...
            '[FONT=times new roman][CENTER][SIZE=4][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [COLOR=rgb(255, 255, 0)]YELLOW.[/COLOR][/SIZE][/CENTER][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            '[FONT=times new roman][SIZE=4][CENTER][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [COLOR=rgb(255, 255, 0)]YELLOW.[/COLOR][/SIZE][/FONT][/CENTER][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            '[FONT=times new roman][SIZE=4][CENTER][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [COLOR=rgb(255, 255, 0)]YELLOW.[/COLOR][/SIZE][/CENTER][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][CENTER][SIZE=4]{{ greeting }}, уважаемый(ая) {{ user.mention }}[/FONT][/CENTER][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][CENTER][COLOR=rgb(209, 213, 216)]Ваша RolePlay биография - отказана т.к она написана от 3-его лица. [/COLOR][/CENTER]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][CENTER]Внимательно прочитайте правила создания RolePlay биографий закрепленные в данном разделе [/COLOR][/CENTER][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=times new roman][SIZE=4][CENTER][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [COLOR=rgb(255, 255, 0)]YELLOW.[/COLOR][/SIZE][/CENTER][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
            ...
            '[FONT=times new roman][SIZE=4][CENTER][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [COLOR=rgb(255, 255, 0)]YELLOW.[/COLOR][/CENTER][/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][FONT=times new roman][CENTER][SIZE=4]{{ greeting }}, уважаемый(ая) {{ user.mention }}[/FONT][/CENTER][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][CENTER][COLOR=rgb(209, 213, 216)]Ваша RolePlay биография - отказана т.к вы ее скопировали у другого человека. [/COLOR][/CENTER]<br><br>" +
        ...
        },
        {
            ...
            content:
            '[COLOR=rgb(255, 0, 0)][CENTER][FONT=times new roman][SIZE=4]{{ greeting }}, уважаемый(ая) {{ user.mention }}[/FONT][/CENTER][/COLOR]<br><br>' +
            "[SIZE=4][FONT=times new roman][CENTER][COLOR=rgb(209, 213, 216)]Ваша RolePlay биография - отказана т.к ваша семья расписана не полностью. [/CENTER][/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)][CENTER]Внимательно прочитайте правила создания RolePlay биографий закрепленные в данном разделе [/COLOR][/CENTER][COLOR=rgb(209, 213, 216)][/COLOR][/FONT][/SIZE]<br><br>" +
            '[FONT=times new roman][SIZE=4][CENTER][COLOR=rgb(209, 213, 216)]Приятной игры на BLACK RUSSIA [COLOR=rgb(255, 255, 0)]YELLOW.[/COLOR][/CENTER][/SIZE][/FONT][/COLOR]',
            prefix: UNACCEPT_PREFIX,
            status: false,
