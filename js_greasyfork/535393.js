...
// @match        https://mais.sbt.com.br/vod/6363765919112?t=0&removidos=*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/535393/SBT%2B%20Chaves%20-%20EPs%20Removidos.user.js
// @updateURL https://update.greasyfork.org/scripts/535393/SBT%2B%20Chaves%20-%20EPs%20Removidos.meta.js
// ==/UserScript==

(function () {
  'use strict';

  const API_URL = atob("aHR0cHM6Ly9kYXRhbWluZXJici5naXRodWIuaW8vcmVtb3ZlZHNfc2J0L2NoYXZlcy5qc29u");
  ...
  async function exibirEpisodiosRemovidos() {
    ...
    episodiosRemovidos.forEach(ep => {
      ...
      const cardLink = `https://mais.sbt.com.br/vod/6363765919112?t=0&removidos=${ep.id}`;
