...
// @grant        GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/478536/yapi-create.user.js
// @updateURL https://update.greasyfork.org/scripts/478536/yapi-create.meta.js
// ==/UserScript==

(e=>{const t=document.createElement("style");t.dataset.source="vite-plugin-monkey",t.textContent=e,document.head.append(t)})(" .menu[data-v-4f6c7ed9]{position:fixed;z-index:10;border:1px solid #ebeef5;box-shadow:0 2px 12px #0000001a;transition:display 0s}.input[data-v-ce9a698d]{margin-top:20px}.confirm[data-v-ce9a698d]{margin:20px auto;display:block}.bottom-line[data-v-ce9a698d]{display:flex;justify-content:start;align-items:center;gap:20px;margin-top:10px} ");
...
(function (vue, ElementPlus) {
  ...
  function getTemplates(init2 = false) {
    let _tabs2;
    const tempalte = _GM_getValue("customAxiosTemplate", "");
    try {
      _tabs2 = JSON.parse(tempalte);
    } catch (e) {
      _tabs2 = [];
    }
    if (init2 || !_tabs2.length) {
      _tabs2 = [
        {
          title: "默认格式",
          name: 0,
          content: `function (describtion,name,method,url,header,params){
    const paramsType = params ? params : 'any';
    const headerType = header.length ? \`,{headers:\${header} }\` : '';
    return \`/** \${describtion} */
export const \${name} = <T = any>(params: \${paramsType}): Promise<T> => {
    return axios.\${method}('\${url}', \${method === 'get' ? \`{ params\${headerType} }\` : \`params\${headerType}\`});
};\`
}`
        },
        {
          title: "默认格式 try-catch",
          name: 1,
          content: `function (describtion,name,method,url,header,params){
    const paramsType = params ? params : 'any';
    const headerType = header.length ? \`,{headers:\${header} }\` : '';
    return \`/** \${describtion} */
export const \${name} = async<T = any>(params: \${paramsType}): Promise<{ code: number; data: T[] }> => {
    let res: any;
    try {
        res = await axios.\${method}('\${url}', \${method === 'get' ? \`{ params\${headerType} }\` : \`params\${headerType}\`});
    } catch (e) {
        res = {
            code: 500,
            data: [],
...
export const \${name} = async<T = any>(params: \${paramsType}): Promise<{ code: number; data: T[] }> => {
  ...
  function updateIndex(panel) {
    ...
    panel == null ? void 0 : panel.querySelectorAll(".ant-table-body .ant-table-thead tr th").forEach((item, index) => {
      ...
      } else if ((_b = item.textContent) == null ? void 0 : _b.includes("类型")) {
        responsetableIndex.type = index + 1;
      } else if ((_c = item.textContent) == null ? void 0 : _c.includes("是否必须")) {
  ...
  function getRequestType(panel) {
    ...
    Array.from(trList || []).forEach((tr) => {
      ...
      let type = ((_b = tr.querySelector(`td:nth-child(${responsetableIndex.type})`)) == null ? void 0 : _b.textContent) || "any";
      if (type == null ? void 0 : type.includes("文本")) {
        type = "string";
      }
      const required = (_d = (_c = tr.querySelector(`td:nth-child(${responsetableIndex.required})`)) == null ? void 0 : _c.textContent) == null ? void 0 : _d.includes("是");
...
` : "";
      const item = `${description}    ${name2}${required ? "" : "?"}: ${type};\r
`;
      obj += item;
    });
    obj += "}";
  ...
  const _sfc_main$3 = /* @__PURE__ */ vue.defineComponent({
    __name: "CreateAxios",
    setup(__props) {
      const dialogVisible = vue.inject("dialogVisible");
      let _tabs = getTemplates();
      const tabs = vue.ref(JSON.parse(JSON.stringify(_tabs)));
      const activeKey = vue.ref(0);
      vue.watch(dialogVisible, (val) => {
        if (!val) {
          _tabs = getTemplates();
          tabs.value = JSON.parse(JSON.stringify(_tabs));
        }
      });
      ...
      function getHeaders() {
        ...
        let header2 = "{\r\n";
        for (let i2 = 0; i2 < domList.length; i2++) {
          if ((_a2 = domList[i2].textContent) == null ? void 0 : _a2.includes("请求参数")) {
            const title = (_b = domList[i2].nextElementSibling) == null ? void 0 : _b.querySelector(".col-title");
            if ((_c = title == null ? void 0 : title.textContent) == null ? void 0 : _c.toLowerCase().includes("headers")) {
              const rows = ((_e = (_d = domList[i2]) == null ? void 0 : _d.nextElementSibling) == null ? void 0 : _e.querySelectorAll(".ant-table-row")) || [];
              for (let j2 = 0; j2 < rows.length; j2++) {
                const key = (_g = (_f = rows[j2].firstChild) == null ? void 0 : _f.textContent) == null ? void 0 : _g.trim();
                if (key) {
                  header2 += `    '${key}': '${rows[j2].childNodes[1].textContent}',\r
`;
                }
              }
            } else {
      ...
      const createTemplate = ({
        ...
        var _a2, _b;
        const content = ((_b = (_a2 = tabs.value.find((item) => item.name === activeKey.value)) == null ? void 0 : _a2.content) == null ? void 0 : _b.trim()) || "";
        const match = content.match(/^function\s*\(\s*describtion\s*,\s*name\s*,\s*method\s*,\s*url\s*,\s*header\s*,\s*params\s*\)\s*{(.*)}$/s);
        if (!match) {
          ElementPlus.ElMessage.error("模版格式错误");
          return "";
        }
        let func = eval("(" + match[0] + ")");
        let result = func(describtion, name, method, url, header, params);
        return result == null ? void 0 : result.trim();
      };
      const handleClick = () => {
        var _a2, _b, _c, _d, _e, _f, _g, _h, _i;
        const panel = (_c = (_b = (_a2 = btnRef.value) == null ? void 0 : _a2.parentElement) == null ? void 0 : _b.parentElement) == null ? void 0 : _c.nextElementSibling;
        if (panel) {
          ...
          const paramsPanel = (_i = (_h = (_g = document.querySelector(".copy-request-type-btn")) == null ? void 0 : _g.parentElement) == null ? void 0 : _h.parentElement) == null ? void 0 : _i.nextElementSibling;
          updateIndex(paramsPanel);
          const params2 = getRequestType(paramsPanel);
          ...
          vue.createVNode(_component_el_dropdown, {
            ...
            dropdown: vue.withCtx(() => [
              vue.createVNode(_component_el_dropdown_menu, null, {
                default: vue.withCtx(() => [
                  (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(tabs.value, (item, index) => {
            ...
            default: vue.withCtx(() => {
              var _a2;
              return [
                vue.createTextVNode(" 复制axios请求(" + vue.toDisplayString((_a2 = tabs.value.find((item) => item.name === activeKey.value)) == null ? void 0 : _a2.title) + ") ", 1)
              ];
            }),
            _: 1
          })
  ...
  const _withScopeId$1 = (n) => (vue.pushScopeId("data-v-4f6c7ed9"), n = n(), vue.popScopeId(), n);
    ...
    setup(__props2) {
      ...
      function modifyDom(dom) {
        dom.addEventListener("contextmenu", (e) => {
          ...
          const x2 = e.clientX;
          const y2 = e.clientY;
          const menuDom = (_a2 = btnRef2.value) == null ? void 0 : _a2.querySelector(".menu");
          menuDom == null ? void 0 : menuDom.setAttribute("style", `left: ${x2 + 8}px; top: ${y2 - 25}px;`);
      ...
      function getResponseTypes(panel, level = 0, tab = 0, start = 0, end = Infinity) {
        ...
        if ((!trList || !trList.length) && level === 0) {
          ...
          const match2 = panel == null ? void 0 : panel.className.match(/ant-table-row-level-(\d+)/);
          if (match2) {
            level = parseInt(match2[1]);
          }
...
`;
      ...
      const handleClick2 = () => {
        var _a2, _b, _c;
        let panel = (_c = (_b = (_a2 = btnRef2.value) == null ? void 0 : _a2.parentElement) == null ? void 0 : _b.parentElement) == null ? void 0 : _c.nextElementSibling;
        let obj = "{\r\n";
        updateIndex(panel);
        if (type.value === "request") {
          obj = getRequestType(panel);
      ...
      const copyItemTypes = () => {
        var _a2, _b, _c;
        const panel = (_c = (_b = (_a2 = btnRef2.value) == null ? void 0 : _a2.parentElement) == null ? void 0 : _b.parentElement) == null ? void 0 : _c.nextElementSibling;
        updateIndex(panel);
      ...
      vue.onMounted(() => {
        var _a2, _b, _c, _d, _e, _f, _g;
        const text = (_c = (_b = (_a2 = btnRef2.value) == null ? void 0 : _a2.parentElement) == null ? void 0 : _b.parentElement) == null ? void 0 : _c.textContent;
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", {
          class: vue.normalizeClass({ "copy-request-type-btn": type.value === "request" }),
          ref_key: "btnRef",
          ref: btnRef2
        }, [
  ...
  const CreateTypes = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4f6c7ed9"]]);
  class Text {
    /**
  ...
  function gutters(config2) {
    ...
    if (config2 && config2.fixed === false)
      result2.push(unfixGutters.of(true));
    return result2;
  }
  ...
  function codeFolding(config2) {
    let result2 = [foldState, baseTheme$1$2];
    if (config2)
      result2.push(foldConfig.of(config2));
    return result2;
  }
  ...
  class RegExpQuery extends QueryType {
    ...
    getReplacement(result2) {
      return this.spec.unquote(this.spec.replace).replace(/\$([$&\d+])/g, (m, i2) => i2 == "$" ? "$" : i2 == "&" ? result2.match[0] : i2 != "0" && +i2 < result2.match.length ? result2.match[i2] : m);
    }
    matchAll(state, limit) {
    ...
    content2.push({
      render(completion, _s, _v, match2) {
        ...
        for (let j2 = 0; j2 < match2.length; ) {
          let from = match2[j2++], to = match2[j2++];
          if (from > off)
  ...
  class ActiveResult extends ActiveSource {
    constructor(source, explicitPos, result2, from, to) {
  ...
  */
  ...
  var F = Object.assign(Object.assign({}, z), B), P = vue.defineComponent({ name: "VueCodemirror", props: Object.assign({}, w), emits: Object.assign({}, F), setup: function(t2, s) {
    var f = vue.shallowRef(), d = vue.shallowRef(), C2 = vue.shallowRef(), D2 = Object.assign(Object.assign({}, h), vue.inject(y, {})), U2 = vue.computed(function() {
      var e = {};
      return Object.keys(vue.toRaw(t2)).forEach(function(n) {
        var o;
    ...
    return vue.onMounted(function() {
      ...
      var n = function(e2) {
        ...
        }, n2 = S(e2).run, o = x(e2, [EditorView.editable.of(false), EditorState.readOnly.of(true)]), r = x(e2, keymap.of([indentWithTab])), u = S(e2).run, a = S(e2).run, i2 = S(e2).run, c = S(e2).run;
      ...
      }, { immediate: true }), vue.watch(function() {
      ...
      return vue.h("div", { class: "v-codemirror", style: { display: "contents" }, ref: f });
    };
  } }), T = P;
  class Stack {
    /**
  ...
  const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props2, { emit }) {
      ...
      const view = vue.shallowRef();
      const handleReady = (payload) => {
        view.value = payload.view;
      };
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createBlock(vue.unref(T), {
          "model-value": _ctx.code,
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => emit("update:code", $event)),
          placeholder: "Code goes here...",
          style: { height: "400px", "font-size": "16px" },
          autofocus: true,
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-ce9a698d"), n = n(), vue.popScopeId(), n);
  const _hoisted_1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("p", null, "在下方输入框中输入你的axios模版，采用es6的模版方式解析，提供了6个变量，describtion，name，method，url，header,params(均为字符串) ：", -1));
  const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("p", { style: { "margin-bottom": "15px" } }, [
    /* @__PURE__ */ vue.createTextVNode("保证你的代码是在 "),
    /* @__PURE__ */ vue.createElementVNode("span", { style: { "font-size": "20px" } }, "function (describtion,name,method,url,header,params){ }"),
    /* @__PURE__ */ vue.createTextVNode(" 里面 ")
  ], -1));
  const _hoisted_3 = { class: "custom-tabs-label" };
  const _hoisted_4 = ["onUpdate:modelValue"];
  const _hoisted_5 = { class: "bottom-line" };
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    __name: "CustomAxiosDialog",
    setup(__props2) {
      const dialogVisible2 = vue.inject("dialogVisible");
      let _tabs2 = getTemplates();
      vue.watch(dialogVisible2, (val) => {
        if (!val) {
          _tabs2 = getTemplates();
          tabs2.value = JSON.parse(JSON.stringify(_tabs2));
        }
      });
      function save() {
        _GM_setValue("customAxiosTemplate", JSON.stringify(tabs2.value));
        ElementPlus.ElMessage.success("保存成功");
      }
      const activeKey2 = vue.ref(0);
      const tabs2 = vue.ref(JSON.parse(JSON.stringify(_tabs2)));
      let tabIndex = tabs2.value.length - 1;
      const handleTabsEdit = (targetName, action) => {
        if (action === "add") {
          const newTabName = +`${++tabIndex}`;
          tabs2.value.push({
            title: `默认格式${newTabName}`,
            name: newTabName,
            content: 'function (describtion,name,method,url,header,params){\n	/** 这是你的代码 */\n	return "";\n}'
          });
          activeKey2.value = newTabName;
        } else if (action === "remove") {
          let activeName = activeKey2.value;
          if (activeName === targetName) {
            tabs2.value.forEach((tab, index) => {
              if (tab.name === targetName) {
                const nextTab = tabs2.value[index + 1] || tabs2.value[index - 1];
                if (nextTab) {
          ...
          activeKey2.value = activeName;
          tabs2.value = tabs2.value.filter((tab) => tab.name !== targetName);
        }
      };
      function restore() {
        _tabs2 = getTemplates(true);
        activeKey2.value = 0;
        tabs2.value = JSON.parse(JSON.stringify(_tabs2));
      }
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_el_dialog, {
          ...
          "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => vue.isRef(dialogVisible2) ? dialogVisible2.value = $event : null),
          title: "自定义axios模版"
        }, {
          default: vue.withCtx(() => [
            _hoisted_1,
            ...
            vue.createVNode(_component_el_tabs, {
              modelValue: activeKey2.value,
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => activeKey2.value = $event),
              type: "card",
              editable: "",
              onEdit: handleTabsEdit
            }, {
              default: vue.withCtx(() => [
                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(tabs2.value, (item) => {
                  return vue.openBlock(), vue.createBlock(_component_el_tab_pane, {
                    ...
                    label: vue.withCtx(() => [
                      vue.createElementVNode("span", _hoisted_3, [
                        vue.withDirectives(vue.createElementVNode("input", {
                          ...
                          onKeydown: _cache[0] || (_cache[0] = vue.withModifiers(() => {
                          }, ["stop"])),
                    ...
                    default: vue.withCtx(() => [
                      vue.createVNode(_sfc_main$1, {
                        code: item.content,
                        "onUpdate:code": ($event) => item.content = $event
            ...
            vue.createElementVNode("div", _hoisted_5, [
              vue.createVNode(_component_el_button, { onClick: restore }, {
                default: vue.withCtx(() => [
                  vue.createTextVNode("复原默认模版")
                ]),
                _: 1
              }),
  ...
  const CustomAxiosDialog = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ce9a698d"]]);
  const cssLoader = (e) => {
  ...
  async function init() {
    ...
    domList.forEach((el) => {
        ...
        case "请求参数":
          ...
          while (el) {
            if (!el.innerHTML.includes("button")) {
              if (((_b = (_a2 = el == null ? void 0 : el.firstChild) == null ? void 0 : _a2.textContent) == null ? void 0 : _b.startsWith("Query")) || ((_d = (_c = el == null ? void 0 : el.firstChild) == null ? void 0 : _c.textContent) == null ? void 0 : _d.startsWith("Body"))) {
      ...
      for (let i2 = 0; i2 < list.length; i2++) {
        vue.createApp(com).use(ElementPlus).provide("dialogVisible", dialogVisible).mount(
          (() => {
