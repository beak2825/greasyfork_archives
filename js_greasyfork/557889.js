...
// @run-at      document-end
// @downloadURL https://update.greasyfork.org/scripts/557889/Qiuwei%20Chat%20Assistant.user.js
// @updateURL https://update.greasyfork.org/scripts/557889/Qiuwei%20Chat%20Assistant.meta.js
// ==/UserScript==
    ...
    function capturePageContent(forceCapture = false, retryCount = 0) {
        try {
            ...
            if (activeCard) {
                ...
                const nameDiv = activeCard.querySelector('[class*="text-[14px]"]') || 
