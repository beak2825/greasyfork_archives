...
// @tag          reddit
// @downloadURL https://update.greasyfork.org/scripts/516739/Old%20Reddit%20with%20New%20Reddit%20Profile%20Pictures%20-%20API%20Key%20Version%20-%20Reddit-Stream%20Version.user.js
// @updateURL https://update.greasyfork.org/scripts/516739/Old%20Reddit%20with%20New%20Reddit%20Profile%20Pictures%20-%20API%20Key%20Version%20-%20Reddit-Stream%20Version.meta.js
// ==/UserScript==
				...
				mutation.addedNodes.forEach((node) => {
					if (node.nodeType === Node.ELEMENT_NODE) {
						const newComments = Array.from(
							node.querySelectorAll('.author, .c-username'),
						).filter((comment) => !processedComments.has(comment));
