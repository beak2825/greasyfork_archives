// ==UserScript==
// @name         Скрипт для Dmitriy_Velence
// @namespace    https://forum.blackrussia.online/
// @version      2.1.0
// @description  Скрипт для модерирования форума BlackRussia Dmitriy_Velence by A.Kobzev mod
// @author       Angel_Kobzev
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license MIT
// @icon https://forum.blackrussia.online/data/avatars/o/1734/1734064.jpg
// @downloadURL https://update.greasyfork.org/scripts/563632/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20Dmitriy_Velence.user.js
// @updateURL https://update.greasyfork.org/scripts/563632/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20Dmitriy_Velence.meta.js
// ==/UserScript==
...
(function () {
	...
	const buttons = [
		...
		content:
        '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
		'[COLOR=rgb(209, 213, 216)]Ваш текст[/COLOR][/CENTER][/FONT][/SIZE][/I]',
	    },
        {
        title: 'Одобрено, отказано, на рассмотрении',
	    ...
	    dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; border-radius: 20px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 0, 0);',
		content:
        '[SIZE=4][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый[B] Игрок[/B]!<br><br>' +
		'[COLOR=rgb(255,0,0)]Отказано[/COLOR][COLOR=rgb(209, 213, 216)], причина: .[/COLOR][/CENTER][/FONT][/SIZE][/I]',
	    },
        {
		title: 'Одобрено (ответ в теме)',
	    dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; border-radius: 20px; margin-right: 5px; border: 2px solid; border-color: rgb(0, 255, 0);',
		content:
        '[SIZE=4][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый[B] Игрок[/B]!<br><br>' +
		'[COLOR=rgb(0,255,0)]Одобрено[/COLOR][/CENTER][/FONT][/SIZE][/I]',
        },
        {
		...
		content:
		'[SIZE=4][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый[B] Игрок[/B]!<br><br>' +
		'[COLOR=rgb(209, 213, 216)]Ваше заявление взято[/COLOR][COLOR=rgb(250,197,28)] на рассмотрение.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
        },
        {
        title: 'Отчёты + закрыть заявления',
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
	    },
        {
	    ...
	    dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; border-radius: 20px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 69, 0);',
		content:
        '[CENTER][SIZE=4][FONT=Georgia][I]{{ greeting }}, уважаемый[B] Следящий ОПГ[/B]!<br><br>' +
		'[COLOR=rgb(209, 213, 216)]Ваш ежедневный отчёт [/COLOR][COLOR=rgb(0,255,0)]рассмотрен[/COLOR][COLOR=rgb(209, 213, 216)].[/COLOR][/CENTER][/FONT][/SIZE][/I]',
	    },
        {
		title: 'Рассмотрен норматив (лд)',
	    dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; border-radius: 20px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 69, 0);',
		content:
        '[CENTER][SIZE=4][FONT=Georgia][I]{{ greeting }}, уважаемый[B] Лидер ОПГ[/B]!<br><br>' +
		'[COLOR=rgb(209, 213, 216)]Ваш ежедневный отчёт [/COLOR][COLOR=rgb(0,255,0)]рассмотрен[/COLOR][COLOR=rgb(209, 213, 216)].[/COLOR][/CENTER][/FONT][/SIZE][/I]',
	    },
        {
	    ...
	    dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; border-radius: 20px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 69, 0);',
		content:
        '[CENTER][SIZE=4][FONT=Georgia][I]{{ greeting }}, уважаемый {{ user.mention2 }}! <br><br>' +
		'[COLOR=rgb(209, 213, 216)]Ваш еженедельный отчёт [/COLOR][COLOR=rgb(0,255,0)]рассмотрен[/COLOR][COLOR=rgb(209, 213, 216)].[/COLOR][/CENTER][/FONT][/SIZE][/I]',
	    ...
	    dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; border-radius: 20px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 0, 0);',
		content:
        '[CENTER][SIZE=4][FONT=Georgia][I]{{ greeting }}, уважаемые[B] игроки![/B]<br><br>' +
		'[COLOR=rgb(209, 213, 216)]Подача заявлений [/COLOR][COLOR=rgb(255,0,0)]закрыта[/COLOR][COLOR=rgb(209, 213, 216)] до окончательного вынесения вердикта.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
        prefix: CLOSE_PREFIX,
        status: false,
        },
        {
        title: ' Ответ на жалобы на лд',
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
	    },

        {
            ...
            '[COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: PIN_PREFIX,
            status: true,
          },
		...
		content:
        '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
		'[COLOR=rgb(209, 213, 216)]В ходе беседы с лидером, и рассмотрев доказательства лидера, выяснилось что наказание выдано[/COLOR][COLOR=rgb(0,255,0)] верно.[/COLOR][/CENTER][/SIZE]<br><br>' +
        '[COLOR=rgb(255,0,0)]Отказано[/COLOR][/CENTER][/FONT][/SIZE][/I]',
		...
		content:
		'[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
		'[COLOR=rgb(209, 213, 216)]По результатам рассмотрения вашей жалобы, выношу вердикт:[/COLOR][COLOR=rgb(255,0,0)]Отказано[/COLOR][COLOR=rgb(209, 213, 216)]поскольку нарушений со стороны лидера не выявлено. При наличии новых нарушений, вы можете предоставить их в новой жалобе, предоставив так же доказателсьства о нарушениях.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
        prefix: UNACCEPT_PREFIX,
        status: false,
	    },
        {
		...
		content:
		'[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
		'[COLOR=rgb(209, 213, 216)]В результате беседы с лидером и рассмотрения представленных им доказательтсв, было выявлено, что с его стороны допущена ошибка. В отношении лидера будет проведена необходимая работа, с целью недопущения подобных ситуаций в дальнейшем.[/COLOR]<br>' +
        '[COLOR=rgb(0,255,0)]Рассмотрено.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
        prefix: WATCHED_PREFIX,
        status: false,
	    },
        {
		...
		content:
        '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
		'[COLOR=rgb(209, 213, 216)]С лидером будет проведена необходимая работа с целью недопущения подобных нарушений в дальнейшем.[/COLOR]<br>' +
        '[COLOR=rgb(0,255,0)]Рассмотрено.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
        prefix: WATCHED_PREFIX,
        status: false,
	    },
        ...
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
	    },
         {
          ...
          },
          {
            ...
            '[COLOR=rgb(209, 213, 216)]•[/COLOR][COLOR=rgb(255, 0, 0)] Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]нанесение урона с целью защиты особняка или его территории, а также нанесение урона после ДТП не является веской IC причиной, для войны семей предусмотрено отдельное системное мероприятие.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
          ...
          },
          {
            ...
            '[COLOR=rgb(209, 213, 216)]•[/COLOR][COLOR=rgb(255, 0, 0)]Исключение:[/COLOR][COLOR=rgb(209, 213, 216)] Блокировка за включенный счетчик FPS не выдается.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]2.13.[/COLOR][COLOR=rgb(209, 213, 216)] Запрещен DB (DriveBy) — намеренное убийство / нанесение урона без веской IC причины на любом виде транспорта.[/COLOR][COLOR=rgb(255, 0, 0)] | Jail 60 минут[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Нарушитель буден наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>" +
            "[COLOR=rgb(255, 0, 0)]3.08.[/COLOR][COLOR=rgb(209, 213, 216)]Запрещены любые формы «слива» посредством использования глобальных чатов.[/COLOR][COLOR=rgb(255, 0, 0)] | PermBan[/COLOR][/CENTER][/FONT][/SIZE][/I]<br>",
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
              ...
              "• [COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=rgb(209, 213, 216)]исключение всех или части игроков из состава семьи без ведома лидера также считается сливом.[/COLOR][/CENTER][/FONT][/SIZE][/I]<br>",
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Нарушитель буден наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>' +
            '[COLOR=rgb(255, 0, 0)]2.21.[/COLOR][COLOR=rgb(209, 213, 216)] Запрещено пытаться обходить игровую систему или использовать любые баги сервера[/COLOR][COLOR=rgb(255, 0, 0)] | Ban 15 - 30 дней / PermBan[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)] если игрок использует баги, связанные с анимацией, и при этом не влияет на игровой процесс других игроков, а также не получает преимущество перед другими игроками, последует наказание в виде Jail на 60 минут.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
           ...
           '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
           '[COLOR=rgb(209, 213, 216)]Нарушитель буден наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>' +
           '[COLOR=rgb(255, 0, 0)]4.10.[/COLOR][COLOR=rgb(209, 213, 216)]Запрещено создавать никнейм, повторяющий или похожий на существующие никнеймы игроков или администраторов по их написанию[/COLOR][COLOR=rgb(255, 0, 0)] | Устное замечание + смена игрового никнейма / PermBan[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
        ...
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] Телефонное общение также является IC чатом.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Нарушитель буден наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>" +
            '[COLOR=rgb(255, 0, 0)]3.02.[/COLOR][COLOR=rgb(209, 213, 216)] Запрещено использование верхнего регистра (CapsLock) при написании любого текста в любом чате.[/COLOR][COLOR=rgb(255, 0, 0)] | Mute 30 минут[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Нарушитель буден наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>" +
            '[COLOR=rgb(255, 0, 0)]3.05.[/COLOR][COLOR=rgb(209, 213, 216)] Запрещен флуд — 3 и более повторяющихся сообщений от одного и того же игрока.[/COLOR][COLOR=rgb(255, 0, 0)] | Mute 30 минут[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Исключение:[/COLOR][COLOR=rgb(209, 213, 216)] Если упоминание родных было совершено в ходе Role Play процесса и не содержало в себе прямого или завуалированного оскорбления.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)Нарушитель буден наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>" +
            '[COLOR=rgb(255, 0, 0)]3.03.[/COLOR][COLOR=rgb(209, 213, 216)] Любые формы оскорблений, издевательств, расизма, дискриминации, религиозной враждебности, сексизма в OOC чате запрещены[/COLOR][COLOR=rgb(255, 0, 0)] | Mute 30 минут[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Исключение:[/COLOR][COLOR=rgb(209, 213, 216)] обоюдное согласие обеих сторон.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)] Оскорбление администрации в любой чат, включая репорт подлежит наказанию в виде блокировки доступа к использованию всех видов чатов -[/COLOR][COLOR=rgb(255, 0, 0)] Mute 180 минут.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Нарушитель будет наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>" +
            '[COLOR=rgb(255, 0, 0)]3.10.[/COLOR][COLOR=rgb(209, 213, 216)] Запрещена выдача себя за администратора, если таковым не являетесь.[/COLOR][COLOR=rgb(255, 0, 0)] | Ban 7 - 15 дней.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)]за предоставление услуг по прохождению обзвонов на различные должности, а также за услуги, облегчающие процесс обзвона, может быть выдан чёрный список проекта[/COLOR][COLOR=rgb(255, 0, 0)] | PermBan + ЧС проекта[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] блокировка аккаунта выдаётся в случае, если есть прямые угрозы жизни, здоровью игрока или его близким. По решению главного администратора может быть выдана перманентная блокировка.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)] Игрок сознательно берёт долг через трейд, не планируя его возвращать, считая, что по правилам это не считается долгом и наказания не будет.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Нарушитель буден наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>" +
            '[COLOR=rgb(255, 0, 0)]2.35.[/COLOR][COLOR=rgb(209, 213, 216)]На игровых серверах запрещено устраивать IC и OOC конфликты на почве разногласия о национальности и / или религии совершенно в любом формате.[/COLOR][COLOR=rgb(255, 0, 0)] | Mute 120 минут / Ban 7 дней[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)]«???????», «!!!!!!!», «Дааааааааааааааааааааааа» и так далее.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
        ...
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
         },
         {
            ...
            '[COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)] Реклама Discord серверов, групп, сообществ, ютуб каналов и т.д.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)] Если игрок упомянет промокод, распространяемый через официальную публичную страницу ВКонтакте либо через официальный Discord в любом из чатов, наказание ему не выдается.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] Если игрок не использует глобальный чат, чтобы дать свои контактные данные для связи, это не будет являться рекламой.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
        ...
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
	      },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] Разблокировка игрового аккаунта нарушителя будет возможна только в случае возврата полной суммы причиненного ущерба, либо непосредственно самого имущества, которое было украдено (по решению обманутой стороны).[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]]2.[/COLOR][COLOR=rgb(209, 213, 216)]За нарушение правил нападения на Военную Часть.[/COLOR][COLOR=rgb(255, 0, 0)] | Jail 30 минут (NonRP нападение) / Warn (Для сотрудников ОПГ)[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            title: 'Nrp Поведение, провокация ГОСС',
            dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; border-radius: 20px; margin-right: 5px; border: 2px solid; border-color: rgb(234, 117, 0)',
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Нарушитель буден наказан по следующему пункту общих правил серверов:[/COLOR]<br><br>" +
            ...
            '• [COLOR=rgb(255, 0, 0)]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] ездить на крышах транспортных средств, бегать или ходить по столам в казино, целенаправленная провокация сотрудников правоохранительных органов с целью развлечения, целенаправленная помеха в проведении различных собеседований и так далее.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)] Слишком большие аксессуары на голове персонажа, имитация гитарой половых органов и тому подобное.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)] Таран дальнобойщиков, инкассаторов под разными предлогами.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
        ...
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] Наказание выдается по аналоги с пунктом правил 2.03[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Нарушитель буден наказан по одному из следующих пунктов правил государственных структур:[/COLOR]<br><br>" +
            '[COLOR=rgb(255, 0, 0)]3.01.[/COLOR][COLOR=rgb(209, 213, 216)] Запрещено оказывать услуги адвоката на территории ФСИН находясь вне комнаты свиданий[/COLOR][COLOR=rgb(255, 0, 0)] | Warn[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 0, 0)]4.04.[/COLOR][COLOR=rgb(209, 213, 216)] Запрещено редактировать поданные объявления в личных целях заменяя текст объявления на несоответствующий отправленному игроком[/COLOR][COLOR=rgb(255, 0, 0)] | Ban 7 дней + ЧС организации[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)]Игрок обращается к сотруднику больницы с просьбой о лечении. Сотрудник применяет команду лечения, а затем выполняет команду для смены пола.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '- сотрудник на служебном транспорте кричит о наборе в свою семью на спавне. [/QUOTE][/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
          ...
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Примечание:[/COLOR][COLOR=rgb(209, 213, 216)] Нарушения данного пункта правил регулируются лидером, в случае обращения к нему напрямую или через специальные темы на форуме.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '• [COLOR=rgb(255, 0, 0)]Пример:[/COLOR][COLOR=rgb(209, 213, 216)] сотруднику ФСИН не понравилось имя заключенного и он решил его наказать выговором или посадить в карцер[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
        ...
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=#C0C0C0]Для жалобы на [COLOR=#FFA500]технических специалистов[/COLOR][COLOR=#C0C0C0], обратитесь в жалобы на [/COLOR][COLOR=#FFA500]технических специалистов[/COLOR][COLOR=#C0C0C0] - [URL='https://forum.blackrussia.online/forums/Сервер-№82-vologda.3604/']*Нажмите сюда*[/URL][/COLOR]<br>" +
            ...
            '[COLOR=#FF0000]Отказано.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: true,
          },
	      {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Передаю вашу жалобу[/COLOR][COLOR=rgb(255, 102, 0)] Техническому Разделу - [USER=99701]Marcus Laid[/USER], [USER=1747019]Milly Cramer🐉[/USER],[USER=1356861]Franklin_Mattonis ✟[/USER][/COLOR][COLOR=rgb(209, 213, 216)] для рассмотрение данной жалобы.<br><br>"+
          ...
          },
          {
            ...
            '[COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/COLOR][/CENTER][/FONT][/SIZE][/I]<br>' ,
            prefix: PIN_PREFIX,
            status: true,
          },
          {
          ...
          },
          {
            ...
            "[COLOR=rgb(209, 213, 216)]Ваша жалоба переадресована[/COLOR][COLOR=rgb(255, 0, 0)] Главному администратору - [USER=1342540]Elya_Monier 𓆩♡𓆪[/USER][/COLOR][COLOR=rgb(209, 213, 216)] для рассмотрение данной жалобы.[/COLOR]<br><br>" +
          ...
          },
          {
            ...
            "[COLOR=rgb(209, 213, 216)]Ваша жалоба переадресована[/COLOR][COLOR=rgb(255, 0, 0)] Заместителю Главного администратора по ГОСС и ОПГ - [USER=286578]Maksim_Strahov[/USER][/COLOR][COLOR=rgb(209, 213, 216)] для рассмотрение данной жалобы.[/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/COLOR]<br>",
            prefix: PIN_PREFIX,
            status: true,
          },
          {
            ...
            content:
            '[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Ваша жалоба переадресована[/COLOR][COLOR=rgb(255, 0, 0)] Основному Заместителю Главного администратора - [USER=341032]Kati Freez[/USER][/COLOR][COLOR=rgb(209, 213, 216)] для рассмотрение данной жалобы.[/COLOR]<br><br>" +
            "[COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/COLOR]<br>",
            prefix: PIN_PREFIX,
            status: true,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Вы ошиблись разделом, обратитесь в раздел жалобы на администрацию - [URL='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.3623/']*Нажмите сюда*[/URL][/COLOR][/CENTER][/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Вы ошиблись разделом, обратитесь в раздел жалобы на игроков - [URL='https://forum.blackrussia.online/forums/Жалобы-на-игроков.3625/']*Нажмите сюда*[/URL][/COLOR][/CENTER][/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров - [URL='https://forum.blackrussia.online/forums/Жалобы-на-лидеров.3624/']*Нажмите сюда*[/URL][/COLOR][/CENTER][/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Вы ошиблись разделом, обратитесь в раздел жалоб на Агентов поддержки - [URL='https://forum.blackrussia.online/threads/vologda-Жалобы-на-Агентов-Поддержки.14181869/']*Нажмите сюда*[/URL][/COLOR][/CENTER][/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Вы ошиблись разделом, обратитесь в жалобы на сотрудников фракции.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Вы ошиблись разделом, обратитесь в раздел Обжалование наказаний - [URL='https://forum.blackrussia.online/forums/Обжалование.3626/']*Нажмите сюда*[/URL].[/COLOR][/CENTER][/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
           },
        ...
        dpstyle: 'font-family: Georgia; font-weight: bold; font-style: italic; text-transform: none; font-size: 15px; oswald: 10px; color: rgb(255, 255, 255); background: rgb(0, 0, 255); box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); cursor: default;',
	      },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Предоставленных вами доказательств недостаточно для корректного рассмотрения жалобы.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Качество предоставленных Вами доказательств не позволяет корректно рассмотреть жалобу.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Доказательства не предоставлены, следовательно, жалоба не подлежит рассмотрению без доказательств (п. 3.6 Правил подачи жалоб на игроков: «Прикрепление доказательств обязательно»). Пожалуйста, загрузите материалы на фото/видео‑хостинг (YouTube, Япикс, Imgur и др.) и прикрепите в "Доказательства" действующие ссылки.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
          ...
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Предоставленная видеозапись обрывается или является неполной. Просьба загрузить полную версию видео (если такова имеется) на видеохостинг (например, YouTube).[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Доказательства подверглись редактированию и, следовательно, не подлежат рассмотрению (п. 3.7 Правил подачи жалоб на игроков: «Доказательства должны быть представлены в первоначальном виде»).[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Для объективного рассмотрения вашей жалобы необходима видеофиксация (запись экрана) всех ключевых моментов, без неё мы не сможем установить обстоятельства и дать квалифицированный ответ.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Предоставленные доказательства размещены в социальных сетях и не подлежат рассмотрению (п. 3.6 Правил подачи жалоб на игроков). Доказательства следует загрузить на фото/видео‑хостинг (например YouTube, Япикс, Imgur и др.).[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]На ваших доказательствах отсутствуют дата и время. Следовательно такая жалоба не подлежит рассмотрению (Пункт 3.2. Правил подачи жалоб на игроков).[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Ваша жалоба отказана, т.к в ней нету таймкодов. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]В предоставленных доказательствах отсутствуют условия сделки.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]По результатам рассмотрения представленных вами доказательств нарушений со стороны игрока не выявлено.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            "• Примечание: в случае истечения срока жалоба рассмотрению не подлежит.»).<br>Правила подачи жалоб: [URL='https://forum.blackrussia.online/forums/Правила-подачи-жалоб.202/']Тут[/URL].[/COLOR][/CENTER][/FONT][/SIZE][/I]",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
          ...
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]На вашу жалобу уже был дан ответ в предыдущей(-их) жалобе(-ах).[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Ваша жалоба отказана по причине: нельзя писать одну жалобу на двух и белее игроков (на каждого игрока отдельная жалоба).[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
          ...
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            "[COLOR=rgb(209, 213, 216)]Заголовок жалобы не соответствует установленной форме и поэтому не подлежит рассмотрению (п. 1.3. Правил подачи жалоб: «Если название вашей темы не соответствует правилам подачи, будет выдан отказ с последующим закрытием жалобы.»). Правила подачи жалоб: [URL='https://forum.blackrussia.online/forums/Правила-подачи-жалоб.202/']Тут[/URL].[/COLOR][/CENTER][/FONT][/SIZE][/I]<br>",
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
          {
          ...
          },
          {
            ...
            content:
            '[CENTER][I][FONT=georgia][SIZE=4][COLOR=rgb(0, 255, 127)]{{ greeting }}, уважаемый[B] {{ user.mention }}[/B]![/COLOR]<br><br>' +
            '[COLOR=rgb(209, 213, 216)]Данный игрок уже был наказан ранее.[/COLOR][/CENTER][/FONT][/SIZE][/I]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
