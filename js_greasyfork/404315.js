...
// @note         2020.6.7 v2.0.2: 默认隐藏boss直聘内已经沟通过的hr所对应的职位。2019.09.24-V2.0 添加百度百聘、58同城支持，添加导航，修复部分BUG，调整部分样式（感谢反馈的朋友，欢迎大家反馈提意见）
...
// @grant        GM.setValue
// @grant		 GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/404315/%E9%AB%98%E7%BA%A7%E6%B1%82%E8%81%8C%E5%8A%A9%E6%89%8B%E6%8B%9B%E8%81%98%E7%BD%91%E7%AB%99%E5%8A%A9%E6%89%8B%EF%BC%88boss%E7%9B%B4%E8%81%98%E4%BF%AE%E5%A4%8D%E7%89%88%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/404315/%E9%AB%98%E7%BA%A7%E6%B1%82%E8%81%8C%E5%8A%A9%E6%89%8B%E6%8B%9B%E8%81%98%E7%BD%91%E7%AB%99%E5%8A%A9%E6%89%8B%EF%BC%88boss%E7%9B%B4%E8%81%98%E4%BF%AE%E5%A4%8D%E7%89%88%EF%BC%89.meta.js
// ==/UserScript==
"use strict";
...
(function($) {
    ...
    function blacklistRefresh() {
        blacklistFilter(), function() {
            if(blacklistFunction.WebName == "BOSS直聘"){
                var elist = $("span:contains(继续沟通)").closest("li")
                elist.hide();
                //console.log(elist);
            }
            blacklistFunction.HtmlToList().each(function(index, element) {
                if (0 === $(element).find(".xyzs-del-div").length) blacklistFunction.ItemToNameJq(element).after($('<div style="' + blacklistFunction.DleButtonStyle + '" class="xyzs-features-div"></div>').append($('<div title="加入黑名单" class="xyzs-del-div"><i class="fa fa-trash xyzs-del-ico"></i></div>').click(function() {
                    ...
                    !1;
                })).append($('<div title="天眼查" class="xyzs-search-div"><i class="fa fa-search xyzs-search-ico"></i></div>').click(function() {
                    ...
                    !1;
                })).append($('<div title="看准" class="xyzs-search-div"><i class="fa fa-search-plus xyzs-search-ico"></i></div>').click(function() {
                    return window.open("https://www.kanzhun.com/search/?q=" + encodeURI(blacklistFunction.NameJqToNameText(blacklistFunction.ItemToNameJq(blacklistFunction.DleButtonToItem(this))))),
                    !1;
                })
                ));
            });
