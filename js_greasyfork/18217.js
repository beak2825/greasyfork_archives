// ==UserScript==
// @name            automated csgodouble.com
// @description     An userscript for profit
// @namespace       eikeka
// @version         0054
// @author          Eikeka
...
// @run-at          document-end
// @grant           none
// @downloadURL https://update.greasyfork.org/scripts/18217/automated%20csgodoublecom.user.js
// @updateURL https://update.greasyfork.org/scripts/18217/automated%20csgodoublecom.meta.js
// ==/UserScript==
/* jshint -W097 */
...
function Automated() {
    ...
    menu.innerHTML = '' +
        '<div class="row">' +
            '<div class="col-lg-9">' +
                '<h2>CSGODouble.com Automated<i id="automated-theme-switch" class="fa fa-lightbulb-o" style="cursor: pointer;"></i></h2>' +
