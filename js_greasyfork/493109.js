...
// @downloadURL https://update.greasyfork.org/scripts/493109/The%20West%20-%20Toolkit.user.js
// @updateURL https://update.greasyfork.org/scripts/493109/The%20West%20-%20Toolkit.meta.js
// ==/UserScript==
/*
...
(function (fn) {
  ...
  TWBattleToolkit = {
    ...
    setsURL: "https://raw.githubusercontent.com/thathankatw/TW-Toolkit/master/files/sets.json",
    chartURL:
    ...
    ru_lang: {
      "updateAvailable": "Новая версия скрипта доступна!",
      "updateDownload": "Скачать",
      "open_number": "Сколько предметов вы хотите использовать?",
      "open_info": "Прогресс...",
      "open_result": "Вы получаете...",
      "buy_number": "Сколько предметов вы хотите купить ?",
      "buy_item_value": "Закупочная цена",
      "buy_total_value": "Общая стоимость",
      "buy_confirm_title": "Покупака",
      "buy_confirm_text1": "Вы уверены что хоитте потратить $",
      "buy_confirm_text2": " купить ",
      "buy_error_location": "Вы должны быть в городе",
      "buy_error_money": "У вас недостаточно денег!",
      "fbpopup_player": "Игрок",
      "fbpopup_appoint_major_general": "Провозгласить генерал-майором",
      "fbpopup_appoint_captain": "Пожаловать капитана",
      "fbpopup_appoint_private": "Назначить рядовым",
      "fbpopup_appoint_sergeant": "Назначить сержантом",
      "fbpopup_appoint_recruit": "Назначить рекрутом",
      "fbpopup_appoint_reservist": "Демобилизовать",
      "fbpopup_appoint_traitor": "Объявить предателем",
      "fbpopup_error_rank": "Вы не можете демобилизовать бойцов того же или более высокого ранга.",
      "fbpopup_error_self": "(И особенно не для себя)",
      "fbcemetery_head_cri": "Критические удары",
      "fbinfo_total": "ВСЕГО",
      "fbinfo_hit": "Попаданий",
      "fbinfo_missed": "Промахов",
      "fbinfo_gotshot": "Пропущенно ударов",
      "fbinfo_dodge": "Уворотов",
      "fbinfo_totaldmg": "Нанесенный урон (кроме ком)",
      "fbinfo_lastdmg": "Последних ударов",
      "fbinfo_resetselect": "Сбросить текущий выбор",
      "pref_apply": "Применить и перезагрузить",
      "pref": "Настройки",
      "buy_info": "Начало покупки предметов..",
      "buy_success": "Все предметы были куплены",
      ...
      "calendar": "Откройте календарь! !",
      "script_lang": "Язык скрипта :",
      "grouped_telegram": "Персональный список",
      "prefs": {
          "use_items": "Использовать мешки с обычными продуктами и Мешочек с бархатцами (?) ",
          "buy_items": "Покупка несколько предметов в магазине",
          "fb_popup": "Больше информаций на экране фортовой битвы (нанесенный урон и тд.)",
          "critical_hits": "Колонка критических удоров в фортовой статистике (Кладбище)",
          "fb_hits": "Отоброжать все попродания промохи и пропущенные удары в каждом раунде",
          "fb_info": "Общий урон и здоровье выбранных игроков - Отображает здоровье для выбранных играков в битве",
          "ids_popup": "Показывать ID предметов",
          "vote": "Напоминание проголосовать",
          "advent_calendar": "Напоминание открыть календарь",
          "grouped_telegrams": {
              "allys": "Альянсы",
              "towns": "Города",
              "extra_players": "Игроки",
              "remove_players": "Игроки исключены"
          },
          "fbanalyzer": "Статистика битвы в живом времени",
          "owned_forts": "Информация о владельцах форта в профиле города",
          "fbanalyzerHtml5": "Статистика битвы в живом времени (Html5)",
          "ifbc_reminder": "Показывать напоминания для битв IFBC 3"
      },
      "stop": "Стоп",
      "players": "Игроки",
      "create_list": "Создать список",
      "send_telegram": "Отправить письмо",
      "bestequip_title": "Лучшее снаряжение",
      "bestequip_button": "Показать лучшее снаряжение",
      "bestequip_val": "Значение : ",
      "lvl": "Уровень",
      "attackers": "Атакующие",
      "defenders": "Защитники",
      "round": "Раунд",
      ...
      "graph": "Chart",
      "ready": "Готов",
      "fbclosed": "Эта битва еще не началась",
      "connecting": "Соединение...",
      "connected": "Соединение",
      "connection_closed": "Соединение закрыто",
      "fbover": "Фортовая битва закончена",
      "nbplayers": "Игроки",
      "losthp": "Потеряно здоровья",
      "hpwarning": "Текущее здоровье меньше, чем было потрачено",
      "openanalyzer": "Открыть статистику",
      "forts": "Форты",
      "fort_size": "Размер",
      "fort_sizes": {
          "0": "Малый",
      ...
      "classes": "Типы персонажа",
      "fbcemetery_head_gho": "Бонусов авантюриста"
  },
    icons: {
      crithits:
      ...
      TWBattleToolkit.preferences.lang =
        TWBattleToolkit.preferences.lang == null
          ? TWBattleToolkit.langs[Game.locale]
            ...
            : "en_US"
          : TWBattleToolkit.preferences.lang;
          TWBattleToolkit.lang = TWBattleToolkit.ru_lang;
    ...
    fbPopup: {
      ...
      getPrivileges: function (player, pp, ownPriv, preBattle) {
        ...
        if (pp < ownPriv) {
          if (pp != gv.MAJOR_GENERAL)
            grades.append(
              TWBattleToolkit.fbPopup.getPrivLink(
                player,
                gv.MAJOR_GENERAL,
                TWBattleToolkit.lang.fbpopup_appoint_major_general
              )
            );
  ...
  FortBattleWindow.showBattleHtml5 = function(response) {
    ...
    this.battlegroundEl = $('#' + this.mainId + '_battleground', mainEl);
    this.infoareaEl = $('#' + this.mainId + '_infoarea', mainEl);
    this.isLeader = false;
    this.defaultClickMode = 0;
    this.addButtonEventHtml5();
    EventHandler.listen(this.mainId + '_received_map_info', this.handleMapInfoSignal, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_received_player_info', this.handlePlayerInfoSignal, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_connection_opened', this.handleConnectionOpened, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_connection_closed', this.handleConnectionClosed, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_connection_error', this.handleConnectionError, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_received_game_info', this.handleGameInfoSignal, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_received_round_info', this.handleRoundInfoSignal, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_received_online_state', this.handleOnlineStateSignal, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_received_swap_state', this.handleSwapStateSignal, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_received_confirmation', this.handleConfirmationSignal, this, {
        boundto: this.window
    });
    EventHandler.listen(this.mainId + '_received_finish_msg', this.handleFinishMsgSignal, this, {
        boundto: this.window
    });
    $(document).on('visibilitychange.' + this.mainId, this.jumpForwardAnimations.bind(this));
    ...
    FortBattle.flashConnectAttempt(this.fortId);
    FortBattle.wsClient[this.fortId] = new FortBattleClient(response.sessionId,this.fortId);
    this.window.addEventListener('WINDOW_DESTROY', function() {
        FortBattle.wsClient[this.fortId].close();
        $(document).off('visibilitychange.' + this.mainId);
    }, this);
}
...
FortBattleWindow.renderPreBattle = function(preBattle) {
  ...
  this.mainId = 'fort_battle_' + this.fortId;
  var mapData = this.preBattle.mapData;
  var content = '<div id="' + this.mainId + '_battleground" class="fort_battle_battleground">' + '<div class="battleground_terrain battleground_layer"></div>' + '<div class="battleground_cellborders battleground_layer"></div>' + '<div class="battleground_tiles battleground_layer" style="background-image: url(/gameservice/getfortimage/' + this.fortId + '.png?draw=tiles);"></div>' + '<div class="battleground_spawnareas battleground_layer" style="background-image: url(/gameservice/getfortimage/' + this.fortId + '.png?draw=spawnareas);"></div>' + '<div class="battleground_layer">' + this.getBattleCells() + '</div>' + '<div class="battleground_sectors battleground_layer" style="background-image: url(/gameservice/getfortimage/' + this.fortId + '.png?draw=sectors);"></div>' + '<div class="battleground_marker battleground_layer"></div>' + '<div class="battleground_sector_labels battleground_layer" style="display: none"></div>' + '<div class="battleground_fog battleground_layer"></div>' + '<div class="battleground_layer"></div>' + '</div>' + this.getControlButtons() + '<div class="fort_battle_timer">' + '<div class="fort_battle_timertext">' + 'Начало сражения:' + '</div>' + '<div class="fort_battle_timertimer"></div>' + '</div>' + '<div id="' + this.mainId + '_infoarea" class="fort_battle_infoarea">' + '<div class="fort_battle_instructions">' + this.getInfoArea() + '</div>' + getHelpDescription() + '<div class="fort_battle_playerlist">' + '<a href="javascript: void(0);" class="show_instructions fb_back_arrow"> ' + 'Назад' + '</a><br />' + 'Соратники:' + '<div class="fort_battle_playerlist_list">' + '</div>' + '</div>' + '<div class="fort_battle_recruitlist">' + '<div class="fort_battle_recruitlist_list"></div>' + '<div class="fort_battle_recruitlist_count"></div>' + '<div class="fort_battle_recruitlist_info">' + '<div class="recruitlist_name"></div>' + '<div class="recruit_fort_pos">' + '<img src="https://westru.innogamescdn.com/images/fort/battle/fort_terrain.jpg" alt="" />' + '<img src="gameservice/getfortimage/' + this.fortId + '.png?draw=tiles" alt="" />' + '<div class="recruit_pos"></div>' + '</div>' + '<div class="recruit_leveltown"></div>' + '<br />' + '<div class="recruit_health_container">' + '<div class="recruit_healthbar"></div>' + '<div class="recruit_health"></div>' + '</div>' + '<img src="https://westru.innogamescdn.com/images/fort/battle/divider.png" style="margin-top:10px; margin-bottom:10px;" alt="" />' + '<div class="recruit_weapon"></div>' + '<div class="recruit_damage"></div>' + '<div style="margin-top:10px;"><img style="width:10px; height:10px;" src="https://westru.innogamescdn.com/images/town/cityhall/green.png" alt="" class="recruit_status_img" /> <span class="recruit_status"></span></div>' + '</div>' + '</div>' + '</div>' + '<div class="progress_status"></div>';
  ...
  this.renderOwnChar();
  this.renderChars();
  this.addMapFog(preBattle.cellSize, mapData, true);
  this.addSectorLabels(preBattle.cellSize, mapData.width, mapData.height, mapData.cells, mapData.sectors);
}
