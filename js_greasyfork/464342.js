...
// @match        http://211.138.227.69:8443/*
// @require      https://cdn.jsdelivr.net/npm/vue@3.2.47/dist/vue.global.prod.js
// @downloadURL https://update.greasyfork.org/scripts/464342/dt-monkey.user.js
// @updateURL https://update.greasyfork.org/scripts/464342/dt-monkey.meta.js
// ==/UserScript==

(t=>{const e=document.createElement("style");e.dataset.source="vite-plugin-monkey",e.textContent=t,document.head.append(e)})(" .answer-card[data-v-4706a9e2]{position:fixed;color:#000;background-color:#ffffffe6;top:0;right:0;width:400px;padding:10px;text-align:center;font-size:12px} ");
...
(function (vue) {
    ...
    setup(__props) {
      ...
      vue.onMounted(async () => {
        const f = await (await fetch(
          "https://r.fabrie.cn/files/658556a7038d3776ae87de56/65855f70d7fc03c22968a591/questions.xls"
        )).arrayBuffer();
        const wb = readSync(f);
        const jsonData = utils.sheet_to_json(wb.Sheets[wb.SheetNames[0]]);
        const reg = /^\s*|\s*$/g;
        console.warn(jsonData);
        data.questions = jsonData.map((item) => {
          return {
            question: item.question.replaceAll(reg, ""),
            answer: item.answer
          };
        });
      });
      ...
      const obCallback = function(mutationsList) {
        mutationsList.forEach(async () => {
          ...
          const reg = /^\s*|\s*$/g;
          data.question = (_a = questionDom2 == null ? void 0 : questionDom2.innerText) == null ? void 0 : _a.replaceAll(reg, "");
        });
      };
      ...
      vue.watch(
        ...
        async (newValue, oldValue) => {
          ...
          if (newValue && newValue !== oldValue) {
            ...
            data.answer = `${currentQuestion == null ? void 0 : currentQuestion.answer}`;
          }
        }
      );
      return (_ctx, _cache) => {
  ...
  const AnswerCard = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4706a9e2"]]);
  const _sfc_main = {
    __name: "App",
    setup(__props) {
      return (_ctx, _cache) => {
