...
// @version      0.33
// @description  Star Wars theme for Jstris
// @author       Oki, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/386474/SW%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/386474/SW%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/LRbEcR2.png",250);
        loadGhostSkin("https://i.imgur.com/OvH7LA4.png",36);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/YQ2tlqB.jpg')";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_lock.mp3",abs:1};
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_ready.mp3",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_go.wav",abs:1,set:0};
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_died.mp3",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_hold.mp3",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_move.wav",abs:1,set:0};
    this.linefall={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_linefall.wav",abs:1,set:0};
};
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_tspinsingle.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_tspinmini.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_clear1.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_tspindouble.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_clear2.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_clear3.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_tspintriple.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_clear4.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_perfectclear.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_b2btspin.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/SW_b2btetris.mp3"
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/SWsong1.mp3",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/SWsong1.mp3"
