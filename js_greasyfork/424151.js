...
// @match        http://zombs.io/
// @grant        Ryan Wolf
// @downloadURL https://update.greasyfork.org/scripts/424151/%3C%3E%20Kurt%20%20Java%20Sava%C5%9F%20Pen%C3%A7esi.user.js
// @updateURL https://update.greasyfork.org/scripts/424151/%3C%3E%20Kurt%20%20Java%20Sava%C5%9F%20Pen%C3%A7esi.meta.js
// ==/UserScript==
...
background-image: url("https://cdn.discordapp.com/emojis/778648679409647668.gif?v=1");
}
...
<hr />
<h3>• Kurt & Java Savaş Pençesi</h3>
<hr />
<button class="TFvalidKey">•</button>
<button class="TFvalidKey">•</button>
<button class="TFvalidKey">•</button>
<button class="TFvalidKey">•</button>
<button class="TFvalidKey">•</button>
<button class="TFvalidKey">•</button>
<br><br>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\"  id=\"XKeyAR\">Yıkım Modu &</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Bf\">Analizli Base Kurucu &</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Sd\">Insta Öldürücü &</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Ey\">Eşyalarını Yükselt &</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Hp\">Savaş Modu &</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Kf\">Koruma Modu &</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Bff\">Balta Fulle</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Kc\">Kılıç Fulle</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Of\">Ok Fulle</button>
<button class=\"btn btn-blue\"style=\" ;width: 45%;\" id=\"Bfff\">Bomba Fulle</button>
<button  id=\"opt\" class=\"btn btn-blue\" style=\"width: 90%;\">Klon Gönder</button>
`
...
getId("XKeyAR").onclick = () => {
    if (XKeyOn) {
        ...
        getId("XKeyAR").textContent = "Yıkım Modu &Kapalı"
    } else {
        XKeyOn = true;
        getId("XKeyAR").setAttribute("class", "btn btn-blue");
        getId("XKeyAR").textContent = "Yıkım Modu &Açık"
    }
}
...
getId("Sd").onclick = () => {
    if (SdOn) {
        ...
        getId("Sd").textContent = "Insta Öldürücü &Kapalı"
    } else {
        SdOn = true;
        getId("Sd").setAttribute("class", "btn btn-blue");
        getId("Sd").textContent = "Insta Öldürücü &Açık"
    }
}
...
getId("Ey").onclick = () => {
    if (EyOn) {
        ...
        getId("Ey").textContent = "Eşyalarını Yükselt &Kapalı"
    } else {
        EyOn = true;
        getId("Ey").setAttribute("class", "btn btn-blue");
        getId("Ey").textContent = "Eşyalarını Yükselt &Açık"
    }
}
...
getId("Hp").onclick = () => {
    if (HpOn) {
        HpOn = false;
        getId("Hp").setAttribute("class", "btn btn-red");
        getId("Hp").textContent = "Savaş Modu &Kapalı"
    } else {
        HpOn = true;
        getId("Hp").setAttribute("class", "btn btn-blue");
        getId("Hp").textContent = "Savaş Modu &Açık"
    }
}
...
getId("Kf").onclick = () => {
    if (KfOn) {
        KfOn = false;
        getId("Kf").setAttribute("class", "btn btn-red");
        getId("Kf").textContent = "Koruma Modu &Kapalı"
    } else {
        KfOn = true;
        getId("Kf").setAttribute("class", "btn btn-blue");
        getId("Kf").textContent = "Koruma Modu &Açık"
    }
}
...
Game.currentGame.ui._events.playerTickUpdate.push(({ health, maxHealth }) => {
    ...
    if (XKeyOn) {
        ...
        if (Game.currentGame.ui.playerTick.weaponName !== "Bow") {
            Game.currentGame.network.sendRpc({
                name: "BuyItem",
                itemName: "Bow",
                tier: 1
