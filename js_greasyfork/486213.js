// ==UserScript==
// @name                 Xbox CLoud Gaming TOOL REMAKE BY NGUYỄN ÁNH
// @version              3.9
// @author               NGUYENANH
// @license              MIT
...
//
// @downloadURL https://update.greasyfork.org/scripts/486213/Xbox%20CLoud%20Gaming%20TOOL%20REMAKE%20BY%20NGUY%E1%BB%84N%20%C3%81NH.user.js
// @updateURL https://update.greasyfork.org/scripts/486213/Xbox%20CLoud%20Gaming%20TOOL%20REMAKE%20BY%20NGUY%E1%BB%84N%20%C3%81NH.meta.js
// ==/UserScript==
(function () {
    'use strict';
    // Your code here...
  ...
  const settingsConfig = [
    ...
    },
    {
        ...
        checkedValue: NFTconfig['regionBlock']['options']['USA'],
        needHr: false
    },
    {
        label: 'Độ Phân giải：',
  ...
  function generateSettingsPage() {
    let settingsHTML = `
        <div style="padding: 10px;color: black;display:none;" class="settingsBackgroud" id="settingsBackgroud">
            <div class="settingsBox"><span class="blink-text" ></span>
    `;
    ...
    settingsHTML += `
                ...
                <div style="text-align: right;margin-top: 8px;font-size: 16px;">
                    ...
                    <a style="outline: none;color: #107c10;text-decoration: underline;" href="https://www.facebook.com/nguyenanhhh14/">Nguyễn Ánh</a>
                </div>
            </div>
        </div>
    `;
