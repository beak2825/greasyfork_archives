...
// @require      https://cdn.jsdelivr.net/npm/element-plus@2.6.3/dist/index.full.min.js
// @resource     element-plus/dist/index.css  https://cdn.jsdelivr.net/npm/element-plus@2.6.3/dist/index.css
// @grant        GM_addStyle
// @grant        GM_getResourceText
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/472728/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98%E6%89%B9%E9%87%8F%E9%87%8D%E5%91%BD%E5%90%8D.user.js
// @updateURL https://update.greasyfork.org/scripts/472728/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98%E6%89%B9%E9%87%8F%E9%87%8D%E5%91%BD%E5%90%8D.meta.js
// ==/UserScript==

(e=>{if(typeof GM_addStyle=="function"){GM_addStyle(e);return}const a=document.createElement("style");a.textContent=e,document.head.append(a)})(' #batchBtn[data-v-6e9afcbf]{position:fixed;bottom:120px;right:48px;font-size:14px;background:#637dff;border-radius:100px;color:#fff;cursor:pointer;transition:all .3s ease;box-shadow:0 3px 8px #1c1c201f,0 3px 5px #1c1c200a;padding:8px 16px;font-weight:500;z-index:9999999}[data-v-6e9afcbf] .el-space__item{flex:1}[data-v-6e9afcbf] .el-dialog__body{padding:20px 40px}[data-v-6e9afcbf] .el-dialog{border-radius:10px}.tips ul[data-v-6e9afcbf]{display:block;list-style-type:disc;padding-left:0}.tips ul li[data-v-6e9afcbf]{margin:1em 0}.tips ul ul[data-v-6e9afcbf]{margin:1em 0;padding-left:20px;list-style-type:circle}.card-header[data-v-6e9afcbf]{display:flex;justify-content:space-between;align-items:center}.card-header .btn[data-v-6e9afcbf]{display:flex;align-items:center}.card-header .btn span[data-v-6e9afcbf]{margin-right:10px}[data-v-6e9afcbf] .el-card__header{padding:10px 20px}[data-v-6e9afcbf] .el-card__body{padding:0}.sort-wrap[data-v-6e9afcbf]{display:flex;line-height:39px;padding:0;box-sizing:border-box;height:500px;width:100%;overflow-y:scroll}.sort-wrap .index-wrap[data-v-6e9afcbf]{display:flex;flex-direction:column;margin-right:14px;text-align:right;padding:10px 0}.sort-wrap .index-wrap span[data-v-6e9afcbf]{width:40px;font-size:14px;border-bottom:1px solid transparent}.sort-wrap .list-wrap[data-v-6e9afcbf]{flex:1}.sort-wrap .list-wrap .item[data-v-6e9afcbf]{-webkit-user-select:none;user-select:none;margin:0;font-size:14px;box-sizing:border-box;position:relative;letter-spacing:1px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:flex;justify-content:space-between}.sort-wrap .list-wrap .item.list-group-item[data-v-6e9afcbf]{display:flex}.sort-wrap .list-wrap .item.list-group-item .name[data-v-6e9afcbf]{flex:1;overflow:clip;text-overflow:ellipsis;white-space:nowrap}.sort-wrap .list-wrap .item.list-group-item .remove[data-v-6e9afcbf]{cursor:pointer;color:#999;font-size:14px;position:relative;width:39px;height:39px;display:flex}.sort-wrap .list-wrap .item.list-group-item .remove[data-v-6e9afcbf]:before{width:39px;font-weight:200;content:"\xD7";font-size:30px;text-align:center;justify-content:center}.sort-wrap .list-wrap .item .name[data-v-6e9afcbf],.sort-wrap .list-wrap .item .format-name[data-v-6e9afcbf]{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1;border-bottom:1px dashed #999}.sort-wrap .list-wrap .item .format-name[data-v-6e9afcbf]{margin-left:50px;border-bottom:1px solid #dedede}.flip-list-move[data-v-6e9afcbf],.no-move[data-v-6e9afcbf]{transition:all ease .5s}.ghost[data-v-6e9afcbf]{opacity:.5;background:#c8ebfb}.list-group[data-v-6e9afcbf]{min-height:20px;width:100%;padding:10px 0}.list-group-item[data-v-6e9afcbf]{cursor:grab}[data-v-6e9afcbf]::-webkit-scrollbar{width:5px;background:#fff}[data-v-6e9afcbf]::-webkit-scrollbar-thumb{background:#f5f5f5;border-radius:5px} ');
...
(function (require$$0, ElementPlus) {
  ...
  const _withScopeId = (n) => (require$$0.pushScopeId("data-v-6e9afcbf"), n = n(), require$$0.popScopeId(), n);
  const _hoisted_1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ require$$0.createElementVNode("br", null, null, -1));
  const _hoisted_2 = { class: "card-header" };
  const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ require$$0.createElementVNode("span", null, "预览", -1));
  const _hoisted_4 = { class: "btn" };
  const _hoisted_5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ require$$0.createElementVNode("span", null, "过滤非视频文件", -1));
  const _hoisted_6 = { class: "sort-wrap" };
  const _hoisted_7 = { class: "index-wrap" };
  const _hoisted_8 = { class: "list-wrap" };
  const _hoisted_9 = { class: "item list-group-item" };
  const _hoisted_10 = { class: "name" };
  const _hoisted_11 = ["onClick"];
  const _hoisted_12 = { class: "dialog-footer" };
  const _hoisted_13 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ require$$0.createElementVNode("br", null, null, -1));
  const _hoisted_14 = { class: "sort-wrap" };
  const _hoisted_15 = { class: "index-wrap" };
  const _hoisted_16 = { class: "list-wrap" };
  const _hoisted_17 = { class: "list-group" };
  const _hoisted_18 = { class: "item" };
  const _hoisted_19 = { class: "name" };
  const _hoisted_20 = { class: "format-name" };
  ...
  const _sfc_main = {
    ...
    setup(__props) {
      ...
      let needFilter = require$$0.ref(true);
      ...
      function handleBatchBtnClick() {
        if (nextMarker) {
          ElementPlus.ElMessage.warning(`当前目录还有未加载完的文件，请滚动页面加载`);
        } else {
          handleFilter(true);
      ...
      return (_ctx, _cache) => {
        const _component_el_alert = require$$0.resolveComponent("el-alert");
        ...
        return require$$0.openBlock(), require$$0.createElementBlock("div", null, [
          require$$0.createVNode(_component_el_dialog, {
            ...
            default: require$$0.withCtx(() => [
              require$$0.createVNode(_component_el_alert, {
                closable: false,
                title: "文件已自动排序，如顺序不对，请手动拖动排序，然后点击确定",
                type: "info"
              }),
              _hoisted_1,
              require$$0.createVNode(_component_el_card, { shadow: "never" }, {
                  ...
                  require$$0.createElementVNode("div", _hoisted_6, [
                    require$$0.createElementVNode("div", _hoisted_7, [
                      (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(data.sortList, (item, index2) => {
                        return require$$0.openBlock(), require$$0.createElementBlock("span", { key: index2 }, require$$0.toDisplayString(index2 + 1), 1);
                      }), 128))
                    ]),
                    require$$0.createElementVNode("div", _hoisted_8, [
                      require$$0.createVNode(require$$0.unref(draggable), {
                        ...
                        item: require$$0.withCtx(({ element }) => [
                          require$$0.createElementVNode("li", _hoisted_9, [
                            require$$0.createElementVNode("p", _hoisted_10, require$$0.toDisplayString(element.name), 1),
          ...
          require$$0.createVNode(_component_el_dialog, {
            ...
            footer: require$$0.withCtx(() => [
              require$$0.createElementVNode("span", _hoisted_21, [
                require$$0.createVNode(_component_el_button, {
                  loading: require$$0.unref(loading),
                                  ...
                                  require$$0.createVNode(_component_el_checkbox_group, {
                                    ...
                                    default: require$$0.withCtx(() => [
                                      require$$0.createVNode(_component_el_checkbox, {
                                        ...
                                        default: require$$0.withCtx(() => [
                                          require$$0.createTextVNode(" 全局搜索 -g ")
                                        ]),
                                        _: 1
                                      }),
                                      require$$0.createVNode(_component_el_checkbox, { label: "i" }, {
                                        default: require$$0.withCtx(() => [
                                          require$$0.createTextVNode(" 忽略大小写 -i ")
                                        ]),
                                        _: 1
                                      }),
                                      require$$0.createVNode(_component_el_checkbox, { label: "m" }, {
                                        default: require$$0.withCtx(() => [
                                          require$$0.createTextVNode(" 多行模式 -m ")
                                        ]),
                                        _: 1
                                      }),
                                      require$$0.createVNode(_component_el_checkbox, { label: "s" }, {
                                        default: require$$0.withCtx(() => [
                                          require$$0.createTextVNode(" 包含换行符 -s ")
                                        ]),
                                        _: 1
                                      })
                                    ]),
                ...
                default: require$$0.withCtx(() => [
                  require$$0.createElementVNode("div", _hoisted_14, [
                    ...
                    require$$0.createElementVNode("div", _hoisted_16, [
                      require$$0.createElementVNode("ul", _hoisted_17, [
                        (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(data.sortList, (item, index2) => {
                          return require$$0.openBlock(), require$$0.createElementBlock("li", _hoisted_18, [
                            require$$0.createElementVNode("p", _hoisted_19, require$$0.toDisplayString(item.name), 1),
                            require$$0.createElementVNode("p", _hoisted_20, require$$0.toDisplayString(formatName(item, index2)), 1)
                          ]);
                        }), 256))
                      ])
                    ])
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6e9afcbf"]]);
  const cssLoader = (e) => {
