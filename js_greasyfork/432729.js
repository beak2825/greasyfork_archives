...
// @downloadURL https://update.greasyfork.org/scripts/432729/Testing%20MaD%20MoD.user.js
// @updateURL https://update.greasyfork.org/scripts/432729/Testing%20MaD%20MoD.meta.js
// ==/UserScript==
...
var ctr, global_id; (async () => {
    ...
    var INT = setInterval(()=>{
        if (switched == 1) {
            ...
            , kBS = 76
            , kBM = 79
            , aChat = "AnGrY F34R RAG3"
            , acBool = !1
            , acFill = "-"
            , iChat = "     R  A  G  E        "
            , icBool = !1
            , rChat = "AnGeR UnLeAsHeD"
            , ezBool = !1
            , ezChat = "RaGe CaLmEd DoWn"
            , irBool = !1
            , cPlayer = !1
            , wLag = !0
            , TankGearKey = 67
...
`;
            ...
            const connectBot = code => {
                ...
                botws.onopen = async () => {
                    ...
                    await wait(100);
                    botws.emit(['sp', [{ name: 'RaGe MoD', moofoll: '1', skin: "__proto__" }]]);

                    botws.emit(["8", [genRand("RaGe MoD")]]);
                    botws.healON = true;
                    setInterval(()=>{
