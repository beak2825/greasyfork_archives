// ==UserScript==
// @name        v4c/InstaSynch Additional test Mk.V
// @namespace       v4c
...
// @downloadURL https://update.greasyfork.org/scripts/17802/v4cInstaSynch%20Additional%20test%20MkV.user.js
// @updateURL https://update.greasyfork.org/scripts/17802/v4cInstaSynch%20Additional%20test%20MkV.meta.js
// ==/UserScript==
    ...
    window.room.addMessage = function(user, message, extraStyles) { //extraStyles = additional classes FOR THE MESSAGE STYLE
      ...
      if (user.username != '' && user.username != '%modAction' && user.username != 'mod' && user.username != '%addVideo' && (window.script.notAfkTest.indexOf(user.username) == -1)){window.script.notAfkTest.push(user.username);}
        ...
        if (splitmsg[0] == '$chance') {
            ...
            if (user.loggedin && room.user.isMod && message.length == 6) {
                if (message === '/sonic') {                
                        if (Date.now() - script.lastskip >= 10000) {
                            console.log("thomas detected. skipped.");
                            room.sendcmd('skip');
                            script.lastskip = Date.now();
                }
                else {
                console.log("too soon since last skip, thomas ignored.");
                }
            }
        }
        if (splitmsg[0] == '$bump') {
...
"idontwantthat" : '<img src="https://i.imgur.com/nKa8o.png" width="41" height="30" onclick="script.fns.playSound(script.emoteSounds.no);">',
...
'ran': '<img src="https://i.imgur.com/tHE7uAe.gif" width="72" height="55";">',
...
'moe3': '<img src="https://i.imgur.com/IBsFH0E.gif" width="36" height="64";>',    
...
'bye': '<img src="http://i.imgur.com/D2kvAo7.gif" width="88" height="65";>',
 ...
 'mfw2': '<img src="https://i.imgur.com/4Y5ZTWN.gif" width="90" height="60">',
...
'runaway': '<img src="https://i.imgur.com/9GC5OgS.gif" width="53" height="65";>',
...
'2016': '<img src="https://i.imgur.com/c1X7QLC.png" width="56" height="48";>',
...
'nofun2' : '<img src="https://i.imgur.com/6H2PFkG.png" width="50" height="53">',
