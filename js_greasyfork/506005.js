// ==UserScript==
// @name   🌱【免费版】贵州公需课|贵州省专业技术人员继续教育平台|收费版含秒过+考试见文档：https://doc.zhanyc.cn/gzszyjs/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.2
// @description  当前是免费版本，只包含视频1倍速自动下一集功能。如需秒过、考试答题等高级功能请使用付费版本，一杯咖啡钱，保你无忧学习|接各类脚本开发工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.gzsrs.cn/*
// @include    *://*gzsrs.cn*
// @grant       GM_getValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/506005/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E8%B4%B5%E5%B7%9E%E5%85%AC%E9%9C%80%E8%AF%BE%7C%E8%B4%B5%E5%B7%9E%E7%9C%81%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E5%B9%B3%E5%8F%B0%7C%E6%94%B6%E8%B4%B9%E7%89%88%E5%90%AB%E7%A7%92%E8%BF%87%2B%E8%80%83%E8%AF%95%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccngzszyjs.user.js
// @updateURL https://update.greasyfork.org/scripts/506005/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E8%B4%B5%E5%B7%9E%E5%85%AC%E9%9C%80%E8%AF%BE%7C%E8%B4%B5%E5%B7%9E%E7%9C%81%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E7%BB%A7%E7%BB%AD%E6%95%99%E8%82%B2%E5%B9%B3%E5%8F%B0%7C%E6%94%B6%E8%B4%B9%E7%89%88%E5%90%AB%E7%A7%92%E8%BF%87%2B%E8%80%83%E8%AF%95%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccngzszyjs.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = "当前使用的是免费版本，仅包含视频1倍速自动下一集、防挂机功能，如需秒过、考试答题等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/gzszyjs/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("/learning?")) {
                ...
                plugMain.page_list();
            } else if (url.includes("/show-question")) {
                plugMain.showPaidContent(`免费版本不包含考试答题功能，欢迎使用收费版本，1秒完成答题`)
            } else if (
                url == "https://www.gzjxjy.gzsrs.cn/" ||
                url == "https://www.gzjxjy.gzsrs.cn" ||
                url == "http://www.gzjxjy.gzsrs.cn/" ||
                url == "http://www.gzjxjy.gzsrs.cn"
            ) {
                plugMain.tipsMsg("脚本加载成功")
            }
        },

        async page_video() {
            console.log("%c page_video", "background:rgb(0,0,0);color:#fff");
            await plugMain.waitOf((a) => $(".el-step").length > 0);
            plugMain.showPaidContent(`免费版本不包含秒过功能，欢迎使用收费版本，极速秒过`);
            await plugMain.waitTimeout(2000);
            let $el = null;
            $(".el-step").each((i, el) => {
                if ($(el).find(".status-tip").text().trim() != "已学完") {
                    $el = $(el);
                    return false;
                }
            });
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (
                        plugMain.getElByText($("span,p"), "防挂机提醒，请点击确定继续学习") !=
                        null
                    ) {
        ...
        nextVideo() {
            setTimeout(() => {
                plugMain.confirmRun("准备刷新页面").then((a) => {
                    location.reload();
                });
            }, 10 * 1000);
        },
