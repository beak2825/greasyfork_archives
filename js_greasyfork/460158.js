// ==UserScript==
// @name         BLACK | Скрипт Главного куратора форума by R. Pirojkov
// @namespace    https://forum.blackrussia.online
// @version      1.02
// @description  Специально для BlackRussia | BLACK by R. Pirojkov (Не актуальная версия регламента выдачи наказаний)
// @author       R. Pirojkov
...
// @downloadURL https://update.greasyfork.org/scripts/460158/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%93%D0%BB%D0%B0%D0%B2%D0%BD%D0%BE%D0%B3%D0%BE%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20R%20Pirojkov.user.js
// @updateURL https://update.greasyfork.org/scripts/460158/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%93%D0%BB%D0%B0%D0%B2%D0%BD%D0%BE%D0%B3%D0%BE%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20R%20Pirojkov.meta.js
// ==/UserScript==
...
const buttons = [
      ...
      },
    {
      title: 'NICK',
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }} ваша жалоба пересмотрена.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
    ...
    },
    {
      title : 'Оск проекта' ,
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Здравствуйте, уважаемый {{ user.mention }} ваша жалоба пересмотрена.[/I][/FONT][/COLOR]<br><br>' +
    ...
    },
    {
      title : 'Нет таймкодов',
     content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }} ваша жалоба пересмотрена.[/I][/FONT][/COLOR]<br><br>' +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }} ваша RP биография пересмотрена.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
    ...
    content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }} ваша RP биография пересмотрена.[/I][/FONT][/COLOR]<br><br>' +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }} ваша RP ситуация пересмотрена.[/I][/FONT][/COLOR]<br><br>' +
    ...
    },
    {
      ...
      content:
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }} ваша Неофициальная RP организация пересмотрена.[/I][/FONT][/COLOR]<br><br>' +
