...
// @downloadURL https://update.greasyfork.org/scripts/531630/Black%2010%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/531630/Black%2010%20Script.meta.js
// ==/UserScript==
...
(function () {
...

    {
        ...
        content:
         "[CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER]<br><br>"+
      "[CENTER] [COLOR=AQUA][ICODE]Ваша жалоба передана на рассмотрение [COLOR=rgb(255, 0, 0)] Специальной Администрации. Один из ее представителей тщательно изучит все обстоятельства и примет решение в соответствии[/ICODE][/COLOR][/CENTER]<br><br>"+
