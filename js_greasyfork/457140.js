// ==UserScript==
// @name    Forum Curators |  for Stas_Kolkov
// @name:ru Кураторы Форума | for Stas_Kolkov
// @name:uk Куратори форуму | for Stas_Kolkov
...
// @downloadURL https://update.greasyfork.org/scripts/457140/Forum%20Curators%20%7C%20%20for%20Stas_Kolkov.user.js
// @updateURL https://update.greasyfork.org/scripts/457140/Forum%20Curators%20%7C%20%20for%20Stas_Kolkov.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            content:
            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
            "[CENTER][COLOR=rgb(61, 142, 185)][I][B][SIZE=6][FONT=georgia]На рассмотрении![/FONT][/SIZE][/B][/I][/COLOR][/CENTER]",
            prefix: PINN_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content:
            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
            '[CENTER][FONT=georgia][I][B]Нарушитель будет наказан по следующему пункту правил управления казино:  [Color=Red]2.03.[/COLOR] [/FONT][/I][/I]'+
            "[CENTER][FONT=georgia][I][B]Охраннику казино запрещено выгонять игрока без причины [Color=Red]| Jail 30 минут.[/color][/FONT][/I][/B][/CENTER]"+
        ...
        },
        {
            ...
            content:
            '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
            "[CENTER]Давая вдолг вы идете на страх и риск, это рп процесс.[/CENTER]<br>" +
