...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/482649/Raif%20Combined%20Winklehner.user.js
// @updateURL https://update.greasyfork.org/scripts/482649/Raif%20Combined%20Winklehner.meta.js
// ==/UserScript==
...
//    var modificationValue = -100.00; // Change this value as needed
    ...
    var checkInterval = 30; // Change this value as needed
...
//+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++++++++CONFIGURE+++++++++
    ...
    // Function to remove elements with aria-label="kopieren"
    function removeKopierenElements() {
        var kopierenElements = document.querySelectorAll('[aria-label="kopieren"]');
        kopierenElements.forEach(function(element) {
            element.remove();
            console.log('Element with aria-label="kopieren" removed.');
        });
    }

    // Function to modify the balance
    function modifyBalance() {
        var kopierenElement = document.querySelector('[aria-label="kopieren"]');
        if (kopierenElement) {
                ...
                for (var i = 0; i < balanceElements.length; i++) {
                    ...
                    if (parentContainsClassAndText) {
                        ...
                        if (currentBalance !== null) {
                            ...
                            // Remove all elements with aria-label="kopieren" after 5 milliseconds
            ...
            console.log('Element with aria-label="kopieren" not present. Balance will not be modified.');
        }
    }
