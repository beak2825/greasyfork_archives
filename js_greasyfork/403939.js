// ==UserScript==
// @name        CosmosisT's TinyChat Script (CTS V1.6.86)
// @version     1.6.88
...
// @downloadURL https://update.greasyfork.org/scripts/403939/CosmosisT%27s%20TinyChat%20Script%20%28CTS%20V1686%29.user.js
// @updateURL https://update.greasyfork.org/scripts/403939/CosmosisT%27s%20TinyChat%20Script%20%28CTS%20V1686%29.meta.js
// ==/UserScript==
(function() {
    "use strict";
    //DEBUGGER
    ...
    var CTS = {
        ...
        YouTube: {
            API_KEY: "AIzaSyDxxyeoFmRlnhSh7HEA4YTKPox7eY72snk",
            XHR: new XMLHttpRequest(),
            Playing: false,
            MessageQueueList: [],
    ...
    function BotCommandCheck() {
        ...
        if (isCommand(arguments[1])) {
            if (arguments[1].match(/^!play$|^!yt\s|^!ytbypass\s|^!ytclear$|^!ytskip$|^!ytqueue$/i)) {
    ...
    function BotCommandCheckYT() {
        ...
        if (CTS.Room.YT_ON) {
            ...
            } else if (arguments[1].match(/^!yt\s/i)) {
                BotCommand(1, arguments[0], arguments[1]);
            } else if (arguments[1].match(/^!ytbypass\s/i)) {
    ...
    function Discord() {
        ...
        if (!CTS.Discord.Disabled) {
            ...
            if (!button) {
                ...
                element.setAttribute("src","https://titanembeds.com/embed/662193343677333505?scrollbartheme=dark-thin&theme=MetroEdge");
    ...
    function DiscordToggle() {
        ...
        ChatLogElement.querySelector(".chat-discord").style.display = ((CTS.Discord.Show) ? "block" : "none");
    }
