// ==UserScript==
// @name   🌱【免费版】海西教育网研修平台|如需秒过、全自动无人值守等高级功能见收费版本：https://doc.zhanyc.cn/pages/hxjywyxpt/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      2.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需秒过、全自动无人值守、自动换学生账号等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*stu.t-px.cn/*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/510919/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%B5%B7%E8%A5%BF%E6%95%99%E8%82%B2%E7%BD%91%E7%A0%94%E4%BF%AE%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E7%A7%92%E8%BF%87%E3%80%81%E5%85%A8%E8%87%AA%E5%8A%A8%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpageshxjywyxpt.user.js
// @updateURL https://update.greasyfork.org/scripts/510919/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%B5%B7%E8%A5%BF%E6%95%99%E8%82%B2%E7%BD%91%E7%A0%94%E4%BF%AE%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E7%A7%92%E8%BF%87%E3%80%81%E5%85%A8%E8%87%AA%E5%8A%A8%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpageshxjywyxpt.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需秒过、全自动无人值守、自动换学生账号等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/hxjywyxpt/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("intoSelectCourseVideo?")) {
                plugMain.page_video();
            } else if (/.*stu.t-px.cn\/#*$/.test(url)) {
                plugMain.showPaidContent(`免费版本不包含自动换账号功能，如需使用请安装收费版本`);
            } else if (url.includes("intoStudentStudy")) {
                plugMain.showPaidContent(`免费版本不包含自动换课功能，如需使用请安装收费版本`);
            }
        },

        async setVideoAnswer(isFinish = false) {
        ...
        async page_video() {
            ...
            plugMain.alertMsg("这个网站不需要学习就记录时长，所以脚本这里不会给你去学习课程", 10 * 1000)
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if ($tips != null) {
                        let code = $tips.parents(".layui-layer").find("#codespan").text()
                        $tips.parents(".layui-layer").find("#code").val(code);
        ...
        nextVideo(waitTime = 10) {
            ...
            setTimeout(() => {
                plugMain.confirmRun("准备前往列表页面").then((a) => {
                    if ($(`[aria-label="限时作答"]:visible`).length > 0) {
                        plugMain.setVideoAnswer(true)
