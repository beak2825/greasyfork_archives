...
// @downloadURL https://update.greasyfork.org/scripts/400903/Dark_Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/400903/Dark_Mod.meta.js
// ==/UserScript==
...
document.getElementById('enterGame').innerHTML = '🎮Go to hell🎮';
document.getElementById('loadingText').innerHTML = '. . . . . . . . . Load Dark Mod . . . . . . . . . ';
document.getElementById('nameInput').placeholder = "Type";
document.getElementById('chatBox').placeholder = "DIE";
document.getElementById('diedText').innerHTML = 'RETURN!!!';
...
document.getElementById("gameName").innerHTML = "Dark Mod"
...
$('#leaderboard').append('Dark_Mod YOU KILL ALL');
...
function animate(space, chance) {
    ...
    let characters;
    if(space) {
        characters = 'Hi, I Luna and I need lover';
    } else {
        characters = 'Derk'
    }
    if(space) {
