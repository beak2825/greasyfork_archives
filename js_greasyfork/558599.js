// ==UserScript==
// @name         🎯 学习通全自动AI刷课工具｜⚡ 一键启动挂机模式｜🧠 智能AI题目作答｜📀 自动刷章节视频+测试｜💎 持续维护更新
// @namespace    http://tampermonkey.net/
// @version      1.0.6
// @description  采用DeepSeek大模型，全面支持各类题型。自动完成视频进度、章节测试与作业，稳定可靠，长期可用。
// @author       talyor
// @match        *://*.chaoxing.com/*
