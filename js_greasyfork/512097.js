// ==UserScript==
// @name         Boosty socionics style
// @namespace    http://tampermonkey.net/
// @version      1.5.3
// @description  Добавление тима рядом с именем, небольшие визуальные корректировки. Замена названия аспекта из двух букв- картинкой. Цветные тимы в тексте. Кнопки навигации
// @author       IDtwelve
// @match        https://boosty.to/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=boosty.to
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/512097/Boosty%20socionics%20style.user.js
// @updateURL https://update.greasyfork.org/scripts/512097/Boosty%20socionics%20style.meta.js
// ==/UserScript==
...
window.addEventListener('load', function() {
	...
	const timDerivatives = {
		...
		'Драйзер': [
			'Драйзер', 'Драйзера', 'Драйзеру', 'Драйзером', 'Драйзере', 'Драйзеры', 'Драйзеров', 'Драйзерам', 'Драйзерами', 'Драйзерах', 'драйзерка', 'драйзерки', 'драйзерке', 'драйзерку', 'драйзеркой', 'драйзерках', 'драй', 'драя', 'драю', 'драи', 'драем', 'драев', 'драями', 'драях', 'драйка', 'драйки', 'драйке', 'драйку', 'драйкой', 'драйках', 'драйское', 'Драйзерша', 'Драйзерши', 'Драйзерше', 'Драйзершу', 'Драйзершей', 'Драйзерш', 'Драйзершам', 'Драйзершами', 'Драйзершах', 'ЭСИ', 'Драйзерам', 'Драям', 'Драи', 'Драйзеры', 'Драйзеров', 'Драйзерам', 'Драйзерами', 'Драйзерах', 'Драйзерке', 'Драйзеркой', 'Драйзерках', 'Драйзерше', 'Драйзершу', 'Драйзершей', 'Драйзерших', 'Драйского', 'Драйскому', 'Драйским', 'Драйском',
		],
		'Штирлиц': [
