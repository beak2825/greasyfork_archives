...
// @downloadURL https://update.greasyfork.org/scripts/17425/%E2%84%95%E2%82%AEC%CE%94RT%CE%A3R%20%CE%A3x%D5%A7.user.js
// @updateURL https://update.greasyfork.org/scripts/17425/%E2%84%95%E2%82%AEC%CE%94RT%CE%A3R%20%CE%A3x%D5%A7.meta.js
// ==/UserScript==
function loadScript(a, b) {
    ...
    $("div.header").replaceWith('<div id="NEL99Header" class="header" style="color:#ce93d8; font-size:35px;"><b>ℕ₮</b><style="color:#ff5a00; font-size:35px;"><b>CΔRTΣR</b></div>');
    $("div.agario-panel.agario-side-panel.agarioProfilePanel.level.forums").replaceWith('<div class="agario-panel agario-side-panel agarioProfilePanel level forums" style="display: block !important;text-align:center"<p style="font-size:20px;"><b>Ƈσɗєɗ ву ?ŦųŖƂØ?  ??? ??????.??/ƝƬƇαятєя</b></p></div>');
    $("div.agario-panel.agario-side-panel.agarioProfilePanel.level:nth-last-child(1)").after('<div id="NEL99YtChannelPanel" class="agario-panel agario-side-panel"></div>');
    $("#NEL99YtChannelPanel").append('<script src="https://apis.google.com/js/platform.js"></script><div class="g-ytsubscribe" data-channelid="UCyjEpj8QXLiQRUNgezhwX6w" data-layout="full" data-theme="dark" data-count="default" style="text-indent: 0px; margin: 0px; padding: 0px; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; width: 163px; height: 48px; background: transparent;"><iframe frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" style="position: static; top: 0px; width: 163px; margin: 0px; border-style: none; left: 0px; visibility: visible; height: 48px;"></div>');
}
...
window.stop(), document.documentElement.innerHTML = null, "agar.io" == location.host && "/" == location.pathname && (location.href = "http://agar.io/ℕ₮CΔRTΣR" + location.hash), loadScript(URL_JQUERY, function () {
