...
// @downloadURL https://update.greasyfork.org/scripts/9502/oAutoPagerize.user.js
// @updateURL https://update.greasyfork.org/scripts/9502/oAutoPagerize.meta.js
// ==/UserScript==
//
			...
			,addPage:function(htmlDoc, pages) {
				...
				if (!this.nodeInsert) (function(){
					if (window.opera) {
						...
						if (!dummy.relatedNode) { // MutationEventsãŒã‚­ãƒãƒ³ã¨å‹•ã‹ãªã„ãƒ–ãƒ©ã‚¦ã‚¶ã®æ•‘æ¸ˆå‡¦ç½®
