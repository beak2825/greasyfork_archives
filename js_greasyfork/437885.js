...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/437885/Showdown%20Translation.user.js
// @updateURL https://update.greasyfork.org/scripts/437885/Showdown%20Translation.meta.js
// ==/UserScript==
var translations={
    "Sort:":"排序方式",
    ...
    "Always results in a critical hit. Hits 3 times.":"必定会心，攻击3次",
    "Fails if the target has no held item.":"目标没有持有道具时使用失败",
    ...
    "Hits twice. 30% chance to make the target flinch.":"攻击2次，30%的几率使目标陷入畏缩状态",
    "User on Psychic Terrain: 1.5x power, hits foes.":"在精神场地上，威力x1.5倍，且同时攻击对方2只宝可梦",
    "2x power if the user had a stat lowered this turn.":"若该回合内自身能力阶级曾降低过，则招式威力变成２倍",
    "Power doubles if user moves before the target.":"若当回合目标未曾行动过（包括后手行动以及当回合被替换上场），招式的威力会变成２倍",
    "Raises an ally's Attack and Defense by 1.":"令队友物攻和物防提升1级",
    "100% chance to lower target's Sp. Atk by 1.":"100%降低目标1级特攻",
    "100% chance to lower the foe(s) Attack by 1.":"100%降低对手全部宝可梦1级物攻",
    "Hits twice. Doubles: Tries to hit each foe once.":"攻击2次，对方有2只宝可梦时分别攻击1次",
    "100% chance to lower the foe(s) Attack by 1.":"100%降低目标1级攻击",
    "User on Grassy Terrain: +1 priority.":"使用者在青草场地上时，攻击先制度+1",
