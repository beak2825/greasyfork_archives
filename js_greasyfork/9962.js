// ==UserScript==
// @name LabaBot
// @description Бот для лабы Fcity.su (3 жемчуга-медленно)
// @author Catchme
// @license MIT
// @version 2.1.6
// @include http://www.fcity.su/*
// @namespace https://greasyfork.org/users/10566
// @downloadURL https://update.greasyfork.org/scripts/9962/LabaBot.user.js
// @updateURL https://update.greasyfork.org/scripts/9962/LabaBot.meta.js
// ==/UserScript==
			...
			// Атакуем
			  ...
			  battle.find(':contains("Бот-атаки: 1")').each(function() {
			   battle.find(':contains("Волк")').each(function() {
				battle.find(':contains("Задание: Собрать 3 cиние")').each(function() {
				mainFrame.location.href = 'http://www.fcity.su/lab.php?buykill=1';
