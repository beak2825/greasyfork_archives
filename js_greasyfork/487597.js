// ==UserScript==
// @name         Скрипт для Неофициальных организаций |  Black Russia UFA 2.0
...
// @grant        none
// @license    MIT
// @icon         https://i.postimg.cc/HLB6Xx2q/image.png
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/487597/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9D%D0%B5%D0%BE%D1%84%D0%B8%D1%86%D0%B8%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D1%85%20%D0%BE%D1%80%D0%B3%D0%B0%D0%BD%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D0%B9%20%7C%20%20Black%20Russia%20UFA%2020.user.js
// @updateURL https://update.greasyfork.org/scripts/487597/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9D%D0%B5%D0%BE%D1%84%D0%B8%D1%86%D0%B8%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D1%85%20%D0%BE%D1%80%D0%B3%D0%B0%D0%BD%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D0%B9%20%7C%20%20Black%20Russia%20UFA%2020.meta.js
// ==/UserScript==
...
(function () {
  ...
  const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>" +
        "[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>" +
        "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]В вашей RolePlay Организации заголовок написан не по форме, внимательно прочитайте правила РП Организаций, закрепленые в данном разделе[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>" +
        "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
      prefix: UNACCEPT_PREFIX,
      status: false,
  ...
  $(document).ready(() => {
    ...
    addButton("НЕОФ ОРГАНИЗАЦИИ💣", "selectAnswer");
  ...
  function editThreadData(prefix, pin = false) {
    ...
    if (prefix == UNACCEPT_PREFIX) {
      moveThread(prefix, 1164);
    }
    if (prefix == ACCEPT_PREFIX) {
      moveThread(prefix, 1162);
    }
    if (prefix == PIN_PREFIX) {
      moveThread(prefix, 1163);
    }
  }
