// ==UserScript==
// @name              无剑3.0代码
// @description       无剑3.0代码，由在线版移植而来，順便《略改》
// @description:zh-TW 無劍3.0，由在線版移植而來，順便《略改》
...
$(() => {
  function init() {
    GreasyFork.getScriptData("516845").then(data => {
  ...
  unsafeWindow.PLU = {
    ...
    initSignInMaps() {
      ...
      this.signInMaps = [{
        ...
        n: _("庆典礼包", "慶典禮包"),
        go: "jh 5;#2 n;e;event_1_4888998;jh 8;w;nw;#4 n;w;event_1_96215258;event_1_29261227;event_1_96215258;"
      }, {
        n: _("天机日常", "天機日常"),
        go: "jh ;#2 event_1_67899597;e;#4 s;#5 event_1_76955770;#4 n;e;e;event_1_99837182;#4 n;event_1_46430872;#4 s;#2 w;#10 look_npc lingshou tianjizongyizhi_jgb 1;home;"
      }, {
        n: "",
        go: "home;"
      }, {
  ...
  const data_language = _("dataFile_version_CN", "dataFile_version_TW")
	if (!localStorage.getItem('dataFile') || !localStorage.getItem(data_language)) {
			...
			GreasyFork.getScriptData(database).then(data => {
				...
				GreasyFork.getScriptCode(database,true).then(data => {
