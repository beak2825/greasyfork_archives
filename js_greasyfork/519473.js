...
// @downloadURL https://update.greasyfork.org/scripts/519473/%D0%93%D0%90%20%20%D0%97%D0%93%D0%90%20%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%7C%7C%20Makhachkala.user.js
// @updateURL https://update.greasyfork.org/scripts/519473/%D0%93%D0%90%20%20%D0%97%D0%93%D0%90%20%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%7C%7C%20Makhachkala.meta.js
// ==/UserScript==
    ...
    const buttons = [
     {
      ...
      content:
         `[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`,
     },
{
      title: `--------------------------------------------------------------------> АДМИН РАЗДЕЛ <--------------------------------------------------------------------`,
     ...
     },
{
...
},
    {
      ...
      content:
        `[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `Вам нужно обратиться в раздел жалоб на Администрацию → [URL='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.1910/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/CENTER][/FONT]`,
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
      ...
      content:
        `[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `Вам нужно обратиться в раздел Обжалование → [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.1913/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/CENTER][/FONT]`,
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
	  ...
	  content:
		`[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
		`Вам нужно обратиться в раздел жалоб на игроков → [URL='https://forum.blackrussia.online/forums/Жалобы-на-игроков.1912/']*Кликабельно*[/URL]<br><br>`+
		`Закрыто.[/CENTER][/FONT]`,
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	...
	},
    {
      ...
      content:
        `[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `Вам нужно обратиться в раздел жалоб на технических специалистов → [URL='https://forum.blackrussia.online/forums/Сервер-№42-makhachkala.1883/']*Кликабельно*[/URL]<br><br>`+
        `Закрыто.[/CENTER][/FONT]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
	  ...
	  content:
		`[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора по направлению ГОСС & ОПГ — [USER=624741]Anatoly_Shelby[/USER].<br><br>` +
	...
	},
    {
	  ...
	  content:
		`[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `[CENTER]Передаю вашу жалобу Основному Заместителю Главного Администратора — [USER=1899524]Daniil Korobka[/USER].<br><br>`+
        `Ожидайте ответа.[/CENTER][/FONT]`,
      prefix: PIN_PREFIX,
	  status: true,
	},
    {
	  ...
	  content:
		`[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
        `[CENTER][FONT=Courier New]Передаю вашу жалобу Главному Администратору — [USER=454761]Egor_Kristofer👑[/USER].<br><br>`+
        `Ожидайте ответа.[/CENTER][/FONT]`,
      prefix: GA_PREFIX,
	  status: true,
    },
    {
      ...
      content:
         `[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
         `[CENTER] [FONT=Courier New]Ваша жалоба передана Специальной Администрации.<br><br>`+
         `Ожидайте ответа.[/CENTER][/FONT]`,
    ...
    },
{
...
},
    {
	  ...
	  content:
		`[CENTER][COLOR=#FFFF00][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
         '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J4v7nzq5/crPNFEh.png[/img][/url]<br>'+
		`С администратором будет проведена необходимая беседа.<br><br>`+
		`Приносим извинения за предоставленное неудобство.[/CENTER][/FONT]`,
	...
	},
{
    ...
    },
    {
      title: `Неадекват ОБЖ`,
        dpstyle: `oswald: 3px;     color: #FF2B2B; background: #212428; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #FF0000`,
      content:`[CENTER][FONT=Courier New]${greeting}, уважаемый ${user.mention}.<br><br>`+
