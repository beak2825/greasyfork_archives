...
// @match
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/403536/LAG%2020.user.js
// @updateURL https://update.greasyfork.org/scripts/403536/LAG%2020.meta.js
// ==/UserScript==
...
function juntar(){
    ...
    // Your code here...
)();addEventListener('keydown', function(a){//KING.JS DESENHOS ;--; FLWS BOYS
    if(a.keyCode==56){
