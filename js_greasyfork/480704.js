// ==UserScript==
// @name         Faucet Rotator - Star Coins
// @namespace    Faucet Rotator - Star Coins
// @version      1.6
// @description  Earn free crypto using this script instantly
// @author       BleemV
// @match        https://starcoins.ws/*
// @connect      starcoins.ws
// @icon         https://www.google.com/s2/favicons?sz=64&domain=starcoins.ws
// @noframes
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_xmlhttpRequest
// @antifeature  referral-link
// @downloadURL https://update.greasyfork.org/scripts/480704/Faucet%20Rotator%20-%20Star%20Coins.user.js
// @updateURL https://update.greasyfork.org/scripts/480704/Faucet%20Rotator%20-%20Star%20Coins.meta.js
// ==/UserScript==
...
(function() {
	...
	var websiteData = [
		{ url: "https://starcoins.ws/bitcoin-faucet/?r=bleem.rapid@gmail.com", coin: "bitcoin-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/dogecoin-faucet/?r=bleem.rapid@gmail.com", coin: "dogecoin-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/litecoin-faucet/?r=bleem.rapid@gmail.com", coin: "litecoin-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/tron-faucet/?r=bleem.rapid@gmail.com", coin: "tron-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/bnb-faucet/?r=bleem.rapid@gmail.com", coin: "bnb-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/solana-faucet/?r=bleem.rapid@gmail.com", coin: "solana-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/tether-faucet/?r=bleem.rapid@gmail.com", coin: "tether-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/cardano-faucet/?r=bleem.rapid@gmail.com", coin: "cardano-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/polygon-faucet/?r=bleem.rapid@gmail.com", coin: "polygon-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/ethereum-faucet/?r=bleem.rapid@gmail.com", coin: "ethereum-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/bch-faucet/?r=bleem.rapid@gmail.com", coin: "bch-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/dash-faucet/?r=bleem.rapid@gmail.com", coin: "dash-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/zcash-faucet/?r=bleem.rapid@gmail.com", coin: "zcash-faucet", address: faucetpayEmail },
		{ url: "https://starcoins.ws/digibyte-faucet/?r=bleem.rapid@gmail.com", coin: "digibyte-faucet", address: faucetpayEmail },
	];
	...
	var websiteMap = [{
		website: ["starcoins.ws"],
		inputTextSelector: ["#address"],
		inputTextSelectorButton: [".form > div:nth-child(4) > button:nth-child(1)"],
