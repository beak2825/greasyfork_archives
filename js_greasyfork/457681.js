...
(function () {
  ...
  const setVideoHandler = () => {
    interval = setInterval(() => {
      try {
        var popup = false;
        [".nqti-option", ".index-module_footer_wewZ2 .fish-btn", ".fish-modal-confirm-btns .fish-btn"].forEach(selector => {
