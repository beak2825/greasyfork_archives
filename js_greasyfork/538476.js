// ==UserScript==
// @name         Blacket Green Theme
// @version      1.1.4
// @description  Green theme for Blacket!
...
// @downloadURL https://update.greasyfork.org/scripts/538476/Blacket%20Green%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/538476/Blacket%20Green%20Theme.meta.js
// ==/UserScript==

(async () => {
    setTimeout(() => {
        console.log(
            "%c[blacket green theme] loaded!",
            "color: #fff; padding: 10px; border-radius: 5px; font-size: 20px; font-weight: bold; text-shadow: 0px 0px 10px #0a8a0a;"
        );
    }, 1000);
