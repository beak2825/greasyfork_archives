...
// @description       修改自https://greasyfork.org/zh-CN/scripts/449291-linkswift。仅修改夸克：仅保留RPC，可配合rpc切换。其余无修改
...
<span><div class="pl-dropdown-menu-item pl-button-mode" data-mode="rpc" style="font-size: 20px;margin-left: auto;">RPC发送</div></span>
			</div>`);
