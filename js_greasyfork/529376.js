...
// @compatible	      Safari
// @compatible	      Opera
// @downloadURL https://update.greasyfork.org/scripts/529376/LinkSwift00.user.js
// @updateURL https://update.greasyfork.org/scripts/529376/LinkSwift00.meta.js
// ==/UserScript==
/**
 * @name LinkSwift
 * @template （改）网盘直链下载助手
			...
			list.forEach((v, i) => {
				...
				if (!dlink || !dlink.includes("http")) {
					...
					if (temp.mode === "aria2") {
						...
						content.find(".pl-main").append(`<div class="pl-item">
							<div class="pl-item-name listener-tip" data-size="${size}"><div class="name">${filename}</div><div class="size">${base.sizeFormat(size)}</div></div>
							<button class="pl-item-link pl-btn-primary pl-btn-default listener-aria2-download" data-filename="${filename}" data-link="${dlink}"><svg class="pl-icon"><use xlink:href="#pl-icon-fa-cloud-arrow-up"/></svg><span>推送 Aria2</span></button>
...
.pl-item-name{width:60%;text-align:left;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;cursor:default}
