...
// @downloadURL https://update.greasyfork.org/scripts/428078/showDoc%E5%A2%9E%E5%BC%BA.user.js
// @updateURL https://update.greasyfork.org/scripts/428078/showDoc%E5%A2%9E%E5%BC%BA.meta.js
// ==/UserScript==
...
(async function (open) {
    ...
    function getJsonAsync(url) {
        return new Promise((resolve, reject) => {
            ...
            const page_id = window.location.search.split('=')[1]
    ...
    function createCopyTs() {
        if (!document.querySelector('.copy_ts')) {
            const titleDom = document.querySelector('#doc-title')
            const button = document.createElement('button')
            button.innerHTML = '复制TypeScript接口'
            button.classList.add('copy_ts')
            titleDom.prepend(button)
        }
    }
    ...
    function setClipboardDisplay(e) {
        ...
        // document.querySelector('#cliDisplaySpan').textContent = 
        // highlight()
        // e.clearSelection()
    }
    function clipboard() {
