...
// Star 样式
$('head').append("<style>.giveMeOneStar:hover{color:#FF69B4;} .passport-login-container{z-index:-9999 !important}</style>");
$('head').append("<style id='login_zindex'>.passport-login-container{display:none !important;}</style>");
// 设置窗口文字效果
if (isFirefox()) {
...
* 登录弹窗移除&需要登录弹窗展示
*/
function changLoginBox(){
    $('.toolbar-btn-login').click(function(){
        $('#login_zindex').html(".passport-login-container{z-index:9999 !important}");
    });
}
