...
// @grant        unsafeWindow
// @grant        GM_download
// @namespace https://greasyfork.org/users/1055276
// @downloadURL https://update.greasyfork.org/scripts/463638/111.user.js
// @updateURL https://update.greasyfork.org/scripts/463638/111.meta.js
// ==/UserScript==


var _ACCOUNT = 'EC2726FCEA1A1B6441450F390D55CDAF';

var _OpenDownload = 1; //是否打开下载模块，1为是，0为否
var _OpenFav = 1; //是否打开收藏夹模块，1为是，0为否
var _ExtJpeg = 0; //强制贴图统统用jpeg格式保存，以减少文件体积，1为是，0为否（代表用原图格式保存）
...
IconIndex=1`;
    ...
    addbtnfunc = function() {
        ...
        if(p && !button_dw) {
            ...
            info.style.cssText = "color: #00d500; text-shadow: 0 0 3px #000000; z-index: 99; line-height: 1.5em; margin-top: 30px; font-size: 12px; font-weight: bold; letter-spacing: 1px; position: relative; text-align: right; padding-right: 10px;";
    ...
    var dodownload = function() {
        ...
        dl_btn.innerHTML = "";
        if (Object.keys(saveimagecache2).length > 0 && Object.keys(saveimagecache1).length != Object.keys(saveimagecache2).length) {
