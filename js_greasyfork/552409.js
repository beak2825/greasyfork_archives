...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/552409/Pay%201%20Title%20Banner.user.js
// @updateURL https://update.greasyfork.org/scripts/552409/Pay%201%20Title%20Banner.meta.js
// ==/UserScript==
...
const pay1Titles = [
    ...
    "Manada Kadalu", "Demonte Colony *", "Ten Hours", "Blackdog", "The Exorcism", "The Seed of the Sacred Fig",
    ...
    "Gulkand", "Pune Highway", "Jora Kaiya Thattunga", "Devmanus", "Naale Rajaa Koli Majaa", "Romeo S*",
    "23 (Iravai Moodu)", "Sri Sri Sri Raajavaru", "Madras Matinee", "Sidlingu 2", "Maargan", "Show Time",
    "Edagaie Apaghatakke Karana", "* BHK", "Oh Bhama Oyye Rama", "Hitman 2", "Paradha", "Chennai City Gangsters",
    "*** Konjoottan", "Kuladalli Keelyavudo", "The Forbidden Fairytale", "Padai Thalaivan", "Suryapet Junction",
    "United Kingdom of Kerala", "Oddity", "Jinn the Pet", "Handsome Guys", "Nadikar", "The 47", "The Legend of Ochi",
    "Badmashulu", "Maadeva", "Sanju Weds Geetha", "Sees Kaddi", "Phoenix", "Soothravakyam", "Dheeran", "Trending",
    "Timmana Mottegalu", "Kanya Kumari", "Ravindra Nee evide", "Bun Butter Jam", "Demon Hunters", "Love Marriage",
    "Aksharsham: Operation Vajra Shakti", "Outhouse", "Atomic Blonde", "Perumani", "Sanju Weds Geetha 2", "Shoshana",
    "The 100", "Bakasura Restaurant", "Kothalavadi", "Meesha", "Jenma Natchathiram", "Ye Re Ye Re Paisa 3",
    "Detective Ujjwalan", "Good Things Like These", "Junior", "Anna", "Apporva Puthranmaar", "This Time Next Year",
    "Our Ronaldo Chithiram", "Hebbuli Cut", "Maine Pyar Kiya", "The Smashing Machine", "Sheelavathi The Ghaati Queen",
    "Tribanadhari Barbarik", "Rudhiram", "Andondittu Kaala", "Bomb", "KISS", "Thanal", "The Life Of Chuck",
    "Arjun Chakravarthy", "Daksha: The Deadly Conspiracy", "Rippan Swamy", "Sahasam", "Thalavara", "Aarpar",
    "Sarangapani Jathakam", "Holy Ghost"
    ];
