...
// @version      3.9
// @description  last update 02.06.25
// @author       ensemble
// @match        https://forum.blackrussia.online/threads/*
// @grant        none
// @license 	 MIT
// @icon https://i.postimg.cc/s2LH4FPV/photo-2025-03-19-22-56-32.jpg
// @downloadURL https://update.greasyfork.org/scripts/538015/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%BE%D1%87%D0%B5%D0%BD%D1%8C%20%D0%BA%D1%80%D1%83%D1%82%D0%BE%D0%B9%20%D0%B4%D0%BB%D1%8F%20%D0%BF%D0%B0%D1%86%D0%B0%D0%BD%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/538015/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%BE%D1%87%D0%B5%D0%BD%D1%8C%20%D0%BA%D1%80%D1%83%D1%82%D0%BE%D0%B9%20%D0%B4%D0%BB%D1%8F%20%D0%BF%D0%B0%D1%86%D0%B0%D0%BD%D0%BE%D0%B2.meta.js
// ==/UserScript==
...
const buttons = [
    {
      ...
      content:
        ...
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman] А [/COLOR][/FONT][/CENTER]<br><br>" +
        '[CENTER][B][FONT=times new roman][COLOR=red][ICODE] Закрыто. [/ICODE][/COLOR][/FONT][/CENTER]',
    },
    {
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][B][FONT=times new roman][COLOR=LIME][ICODE] Одобрено. [/ICODE][/COLOR][/FONT][/CENTER]',
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][FONT=times new roman][COLOR=red][ICODE] Закрыто. [/ICODE][/COLOR][/FONT][/CENTER]',
    ...
    },
    {
      ...
      content:
        ...
        '[FONT=times new roman][COLOR=red][ICODE] Закрыто. [/ICODE][/COLOR][/FONT]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Переношу вашу тему в нужный раздел[/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=rgb(230, 230, 250)]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: WAIT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Запрошу доказательства у администратора. Ожидайте ответа. [/FONT][/B][/COLOR][/CENTER]<br><br>" +
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Жалоба взята на рассмотрение. Создавать копии данной темы не требуется, ответ будет дан в этой теме, как только это будет возможно.[/FONT][/B][/COLOR][/CENTER]<br><br>" +
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Ваша жалоба была передана на рассмотрение [Color=red]Специальной администрации[/COLOR] проекта.[/FONT][/B][/COLOR][/CENTER] <br>" +
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Ваша жалоба была передана на рассмотрение  [Color=red] Заместителю Главного Администратора. [/Color] [/FONT][/B][/COLOR][/CENTER] <br><br>" +
        '[CENTER][B][FONT=times new roman][COLOR=rgb(230, 230, 250)]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: GA_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Ваша жалоба была передана на рассмотрение [Color=red] Основному Заместителю Главного Администратора. [/Color] [/FONT][/B][/COLOR][/CENTER] <br>" +
        '[CENTER][B][FONT=times new roman][COLOR=rgb(230, 230, 250)]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: GA_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Ваша жалоба передана на рассмотрение [Color=red]Главному Администратору.[/COLOR] [/FONT][/B][/COLOR][/CENTER] <br>" +
        '[CENTER][B][FONT=times new roman][COLOR=rgb(230, 230, 250)]<br>Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: GA_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Жалоба передана на рассмотрение Руководству сервера. [/FONT][/B][/COLOR][/CENTER] <br>" +
        '[CENTER][B][FONT=times new roman][COLOR=rgb(230, 230, 250)]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: GA_PREFIX,
	  status: true,
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Ваша жалоба была передана на рассмотрение [Color=ORANGE]Tехническому специалисту.[/COLOR] [/FONT][/B][/COLOR][/CENTER] <br>" +
        '[CENTER][B][FONT=times new roman][COLOR=rgb(230, 230, 250)]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix: TEX_PREFIX,
	  status: 123,
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Жалоба передана на рассмотрение[Color=YELLOW]Команде проекта.[/COLOR] [/FONT][/B][/COLOR][/CENTER] <br>" +
        '[CENTER][B][FONT=times new roman][COLOR=rgb(230, 230, 250)]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Жалоба передана на рассмотрение[Color=#1E90FF]Руководству модерации проекта.[/COLOR] [/FONT][/B][/COLOR][/CENTER] <br>" +
        '[CENTER][B][FONT=times new roman][COLOR=rgb(230, 230, 250)]Ожидайте ответа.[/COLOR][/FONT][/CENTER]',
      prefix:  COMMAND_PREFIX,
	  status: true,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]Наказание будет снято, с администратором будет проведена необходимая работа. Приносим извинения за доставленные неудобства.[/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=LIME][ICODE] Одобрено. [/ICODE][/COLOR][/FONT][/CENTER]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman] С администратором будет проведена необходимая работа.<br>Приносим извинения за доставленные неудобства.[/color][/FONT][/CENTER] <br>" +
    ...
    },
    {
      ...
      content:
		'[CENTER][COLOR=rgb(238, 130, 238)][B][ICODE]{{ greeting }}, уважаемый {{ user.name }}.[/ICODE][/B][/COLOR][/CENTER] <br><br>' +
        "[CENTER][COLOR=rgb(230, 230, 250)][B][FONT=times new roman]С администратором будет проведена беседа, приносим извинения за доставленные неудобства.[/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][FONT=times new roman][COLOR=LIME][ICODE] Одобрено. [/ICODE][/COLOR][/FONT][/CENTER]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
