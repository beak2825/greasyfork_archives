...
// @downloadURL https://update.greasyfork.org/scripts/511632/%D0%9A%D0%BE%D0%BC%D0%B0%D0%BD%D0%B4%D0%B0%20teha.user.js
// @updateURL https://update.greasyfork.org/scripts/511632/%D0%9A%D0%BE%D0%BC%D0%B0%D0%BD%D0%B4%D0%B0%20teha.meta.js
// ==/UserScript==
...
'[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]King Russia[/color].[/size][/font][/CENTER]',
...
'[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]King Russia[/color].[/size][/font][/CENTER]',
    ...
    {
	  title: 'Адм не виноват',
	  content:
'[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
'[CENTER][size=15px][font=Trebuchet MS]Ознакомившись с доказательствами, нарушений со стороны администратора выявлено не было.[/size][/font][/CENTER]<br><br>' +
'[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]King Russia[/color].[/size][/font][/CENTER]',
	  prefix: UNACCEPT_PREFIX,
    status: false,
    },
    {
	  ...
	  content:
'[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
'[CENTER][size=15px][font=Trebuchet MS]Ознакомившись с доказательствами, было выявлено нарушение со стороны администратора.[/size][/font][/CENTER]<br><br>' +
'[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]King Russia[/color].[/size][/font][/CENTER]',
    ...
    },
    {
	  ...
	  content:
'[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(255,200,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
'[CENTER][size=15px][font=Trebuchet MS]Ознакомившись с вашей жалобой, было принято решение снять вам наказание.[/size][/font][/CENTER]<br><br>' +
'[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]King Russia[/color].[/size][/font][/CENTER]',
