...
// @grant        GM_addStyle
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/529197/Unlimit-Web%2B.user.js
// @updateURL https://update.greasyfork.org/scripts/529197/Unlimit-Web%2B.meta.js
// ==/UserScript==
...
`;
    ...
    const rmc = () => {
      ...
      //修改alt触发
const altHandler = function(e) {
    if (e.altKey && !e.ctrlKey && !e.metaKey && !e.shiftKey) {
        e.preventDefault();
        eNumUnLimit();
        // 立即移除自身监听
        document.removeEventListener('keydown', altHandler, true);
    }
};
document.addEventListener('keydown', altHandler, true);
      //修改完毕
