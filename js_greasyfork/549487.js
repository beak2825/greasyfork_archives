...
// @downloadURL https://update.greasyfork.org/scripts/549487/ruoyanhuang.user.js
// @updateURL https://update.greasyfork.org/scripts/549487/ruoyanhuang.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "EWXAKVIF NRNSFG";
    const NEW_NAME = "RUOYAN HUANG";
    const NEW_BIRTHDAY = "(**0409)";
    const NEW_EXPIRE_DATE = "2034-01-17";
