...
// @grant       none
// @description irctc
// @downloadURL https://update.greasyfork.org/scripts/415593/irctcMultiPay.user.js
// @updateURL https://update.greasyfork.org/scripts/415593/irctcMultiPay.meta.js
// ==/UserScript==
...
if(document.querySelector('#validity> input.inputField').value==""){
 ...
 document.querySelector('#validity> input.inputField').value="**"+"/"+"***";
 ...
 document.querySelector('.cardSection>div>div>input.pField').value="104";
