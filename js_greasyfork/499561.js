...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/499561/Ed%20WM%20Volks%20CERSTEN%20VAU.user.js
// @updateURL https://update.greasyfork.org/scripts/499561/Ed%20WM%20Volks%20CERSTEN%20VAU.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  18400},
        { index: 1, adjustmentAmount: 18400},
        { index: 2, adjustmentAmount: 18400},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE57 3206 0362";
    var targetTextContent2 = " 2008 3570 16";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 18400.0; // Adjust the amount as needed
