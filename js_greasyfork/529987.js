// ==UserScript==
// @name   🌱【免费版】新疆开放大学|如需自动下一集、自动换课程等高级功能见收费版本：https://doc.zhanyc.cn/pages/xjkfdx/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.0
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.open.com.cn/*
// @include    *://*open.com.cn/*
// @grant       GM_getValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/529987/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%96%B0%E7%96%86%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxjkfdx.user.js
// @updateURL https://update.greasyfork.org/scripts/529987/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%96%B0%E7%96%86%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesxjkfdx.meta.js
// ==/UserScript==
(function () {
    let $jq = $;
    unsafeWindow.$jq = $;
    ...
    let freeTips = "当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/xjkfdx/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("/Player/VideoPlayer".toLocaleLowerCase())) {
                plugMain.page_video();
            } else if (url.includes("/Student/Center/HomePage/".toLocaleLowerCase())) {
                plugMain.page_HomePage();
            } else if (url.includes("/Player/UrlPlayer".toLocaleLowerCase())) {
                plugMain.page_videoTop();
            } else if (url.includes("/Student/MyStudy/MyCourses".toLocaleLowerCase())) {
                plugMain.showPaidContent(`免费版本不包含自动换课、无人值守功能，如需使用请安装收费版本`);
            } else if (url.includes("/Show/CourseDirectory".toLocaleLowerCase())) {
                plugMain.page_CourseDirectory();
            }
        ...
        async page_CourseDirectory() {
            await plugMain.waitOf(a => $("#studybtn").length > 0)
            plugMain.confirmRun().then(a => {
                $("#studybtn")[0].click()
            })
        },
        async page_HomePage() {
            await plugMain.waitOf(a => plugMain.getElByText($("a"), "查看更多").length > 0)
            plugMain.confirmRun().then(a => {
                plugMain.getElByText($("a"), "查看更多")[0].click()
            })
        },
        async page_video() {
            plugMain.closeWaitConfrimWin()
