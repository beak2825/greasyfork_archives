...
let css = `
  ...
  HTML {background-color: #001!important;}
  ...
  #outside > DIV:last-child, .iogc-tourny-odd, .iogc-favoritePanel-list {background-color: #001!important;}
  .cf-section.cf-highlight.cf-status-display, .my-8.bg-gradient-gray {background: #001!important;}
  ...
  .hmenu .current, .list-item.list-odd, .menu2, #forum .header, .iogc-SidePanel-inner, .iogc-GameWindow-container,
  .gwt-TabBarItem, .iogc-BonusProgress, .summary, .gwt-TabBarItem.gwt-TabBarItem-selected {background-color: #002!important;}
  INPUT, SELECT, TEXTAREA {background-color: #111!important;border: 1px solid black!important;}
  .gwt-DialogBox, .iogc-MessagePanel-messages, .iogc-ChatPanel-messages {background-color: #111!important;}
  ...
  .menu2 li a:hover {background-color: #004!important;}
  ...
  .iogc-ChangeTableDialog-tile.iogc-ChangeTableDialog-tile-selected {background-color: #333!important;border-color: dodgerblue!important;}
  ...
  .iogc-notice, .iogc-hint, .iogc-tourny-flash {background-color: #400!important;}
...
/*   .iogc-NewButton-white {background: linear-gradient(#F0FFF0, #DCDCDC) repeat scroll 0 0 transparent!important;} */
  ...
  .iogc-SidePanel-inner {border: 2px solid #003!important;}
  .iogc-PlayerFavoritePanel {border-color: #003!important;} 
  ...
  .statLine TD, #profile h3 .line {border-color: #003!important;}
  ...
  DIV[style="border-bottom:2px dotted #ddd;margin:10px 0;"] {border-bottom-color: #003!important;}
  ...
  DIV[style="border-top:3px solid #CCC"], #forum .header, .iogc-SidePanel-inner, .list-item {border-top-color: #003!important;}
  ...
  DIV[style="color:#888"], .footer, .pages, B, TH, P, .label, .col1MonthLabel, .iogc-tourny-itemout, .gwt-HTML,
  .col2Label, .field-label, .iogc-ChangeTableDialog-hint, .xsketch-controlLabel {color: silver!important;}
  .iogc-tourny-flash, .iogc-SidePanel-title, .iogc-LoginPanel-nameHeading, .profilemenu a.current {color: gold!important;}
   .iogc-BonusProgress-label, .iogc-TouryCountdownPanel-desc {color: gainsboro!important;}
