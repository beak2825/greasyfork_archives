...
// @downloadURL https://update.greasyfork.org/scripts/442428/Buster%28ex%29.user.js
// @updateURL https://update.greasyfork.org/scripts/442428/Buster%28ex%29.meta.js
// ==/UserScript==
(function() {
    'use strict';
    var solved = false;
...
setInterval(Reflesh, 60000)
  ...
  console.log('Working')
    document
        .querySelector("#recaptcha-reload-button")
    .click()
}

setInterval(Reflesh2, 90000)

    function Reflesh3() {
  console.log('Working')
    document
        .querySelector("body > div:nth-child(25) > div:nth-child(1)")
        .click()
}

setInterval(Reflesh3, 120000)
