...
// @downloadURL https://update.greasyfork.org/scripts/522553/%21%20123.user.js
// @updateURL https://update.greasyfork.org/scripts/522553/%21%20123.meta.js
// ==/UserScript==
	...
	const buttons = [
     {
	  ...
	  content:
            ...
            "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]{{ greeting }}[/COLOR][/CENTER][/size]<br><br>" +
