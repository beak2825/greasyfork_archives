...
// @downloadURL https://update.greasyfork.org/scripts/466844/%D0%A4%D0%BE%D1%80%D1%83%D0%BC.user.js
// @updateURL https://update.greasyfork.org/scripts/466844/%D0%A4%D0%BE%D1%80%D1%83%D0%BC.meta.js
// ==/UserScript==
...
const buttons = [
{
         ...
         },
    {
         ...
         },
     {
      ...
      content:
		'[CENTER][FONT=times new roman][SIZE=4]{{ greeting }}, уважаемый игрок.[/CENTER][/SIZE][/FONT]<br>' +
         "[CENTER][FONT=times new roman][SIZE=4]Отстутствуют доказательства на нарушения от Администратора.[/CENTER][/SIZE][/FONT]<br>" +
         '[CENTER][FONT=times new roman][SIZE=4]Отказано,закрыто.[/CENTER][/SIZE][/FONT]<br>',
      prefix: CLOSE_PREFIX,
	  status: false,
         },
