// ==UserScript==
// @name AudioBookBay hide category: Spiritual & Religious
// @description Hide Spiritual & Religious category
...
// @downloadURL https://update.greasyfork.org/scripts/484574/AudioBookBay%20hide%20category%3A%20Spiritual%20%20Religious.user.js
// @updateURL https://update.greasyfork.org/scripts/484574/AudioBookBay%20hide%20category%3A%20Spiritual%20%20Religious.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Spiritual'
    $(".post").has(".postInfo:contains('Spiritual')").hide();
});
