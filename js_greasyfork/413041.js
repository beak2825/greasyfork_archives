...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/413041/mentionNotification.user.js
// @updateURL https://update.greasyfork.org/scripts/413041/mentionNotification.meta.js
// ==/UserScript==
...
const mentionNotification = async () => {
    ...
    const t = {
            ...
            icon: "https://shikme.chat/default_images/icon.png?v=1528136794",
            sound: "https://shikme.chat/sounds/username.mp3",
            volume: 50,
            timeout: 6
        },
