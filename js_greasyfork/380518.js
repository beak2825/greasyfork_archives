...
// @homepageURL    https://greasyfork.org/zh-CN/scripts/380518-whutbbcode
...
// @downloadURL https://update.greasyfork.org/scripts/380518/WhutBBCode%2B.user.js
// @updateURL https://update.greasyfork.org/scripts/380518/WhutBBCode%2B.meta.js
// ==/UserScript==
...
(function () {
	...
	WhutBB.db = {
		...
		buttons: {
			b: {title: '加重', icon: 'bold'},
			i: {title: '斜体', icon: 'italic'},
			u: {title: '下划线', icon: 'text-width'}, //underline
			s: {title: '删除线', icon: 'minus'},
			code: {display: 'c', title: '代码', icon: 'leaf'},
			important: {display: '!', title: '重要文字', icon: 'exclamation-sign'},
			color: {type: 1, display: '\u25ee', prompt: 'Enter a #hexadecimal or color name.', title: '字体颜色', val: '#', icon: 'tint'},
			size: {type: 1, display: '\u00b1', prompt: 'Enter a number.', title: '字体大小', val: 3, icon: 'text-height'},
			align: {type: 1, display: '-', title: '对齐文字', icon: 'align-left'},
			left: {display: '<', title: '靠左对齐', icon: 'align-left'},
			center: {display: '\u2013', title: '居中对齐', icon: 'align-center'},
			right: {display: '>', title: '靠右对齐', icon: 'align-right'},
			'#': {type: 3, title: '序号列表', icon: 'list-alt'},
			'*': {type: 3, title: '符号列表', icon: 'list'},
			url: {type: 1, prompt: 'Enter a Link', title: '插入url', val: 'http://', icon: 'globe'},
			img: {title: '插入图片', icon: 'picture'},
			quote: {type: 1, display: 'q', prompt: 'Enter an author or name', title: '引用', placeholder: 'author', icon: 'comment'},
			pre: {title: '预格式化文字/代码块', icon: 'asterisk'},
			hide: {display: 'h', title: '隐藏内容/Spoilers', icon: 'warning-sign'},
			spoiler: {display: '_', title: 'Spoilers!', icon: 'exclamation-sign'},
			mature: {display: 'm', title: '隐藏成人内容', icon: 'eye-open'},
			artist: {display: 'a', title: '链接站内艺人/乐队', icon: 'music'},
			user: {display: 'p', title: '链接站内用户', icon: 'user'},
			wiki: {type: 4, tag: ['[[', ']]'], display: 'w', title: '链接站内Wiki文章', icon: 'share'},
			tex: {display: 't', title: 'LaTeX', icon: 'pencil'},
			plain: {display: 'x', title: '禁用BBcode标签', icon: 'ban-circle'},
			youtube: {type: 2, display: 'yt', title: 'YouTube video', icon: 'film'},
			font: {type: 1, display: 'f', prompt: 'Enter a font\'s name', title: '字体', val: 'Arial', icon: 'font'},
			torrent: {display: 'id', title: '链接站内种子ID', icon: 'download'},
			search: {type: 1, display: '@', prompt: 'Enter a search term', title: 'Link to a search term', val: 'keywords', icon: 'search'},
			table: {display: 'tbl', title: '插入表格', icon: 'th-large'},
			...
			heading: {type: 4, tag: '=', display: '=', title: '插入标题', icon: 'arrow-right'},
			...
			// Gazelle
			gz_left: {tag: 'align', val: 'left', type: 1, noPrompt: true, display: '<', title: '靠左对齐', icon: 'align-left'},
			gz_center: {tag: 'align', val: 'center', type: 1, noPrompt: true, display: '\u2013', title: '居中对齐', icon: 'align-center'},
			gz_right: {tag: 'align', val: 'right', type: 1, noPrompt: true, display: '>', title: '靠右对齐', icon: 'align-right'},
			gz_src: {macro: ['quote', 'pre'], type: -3, display: '<>', title: '源代码', icon: 'tasks'},
			gz_rule: {tag: 'rule', title: '链接站内规则', icon: 'info-sign', display: 'r' },
			// Panels
			emoticon: {display: ':]', toggle: ';]', title: '表情', type: -1, icon: 'fire'},
			settings: {display: '%', title: '设置', type: -1, icon: 'wrench'},
			shortcut: {display: '?', title: '快捷键', type: -1, icon: 'question-sign'},
			erase: {display: '-', title: '清除内容', type: -2, icon: 'remove-sign'}
		},
		emoticons: {
