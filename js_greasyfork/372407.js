// ==UserScript==
// @name         wsmud_pluginss 魔改版
// @namespace    HB_zy
// @version      0.0.30.24
// @date         01/07/2018
// @modified     04/01/2019
// @homepage     https://greasyfork.org/zh-CN/scripts/372407
// @re-homepage  原脚本网址https://greasyfork.org/zh-CN/scripts/371372
...
// @downloadURL https://update.greasyfork.org/scripts/372407/wsmud_pluginss%20%E9%AD%94%E6%94%B9%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/372407/wsmud_pluginss%20%E9%AD%94%E6%94%B9%E7%89%88.meta.js
// ==/UserScript==
// 2019年1月1 版本更新
...
(function () {
    'use strict';
    var updateinfo = "注意:本次更新后监控都暂停了,若需使用监控,请先在监控编辑面板中开启该监控 ";
    ...
    var npcs = {
     ...
     var place = {
        ...
        "武当派-紫林间小径": "jh fam 1 start;go west;go northup;go north;go west;go northup;go northup;go northup;go north;go north;go north;go north",
        ...
        "峨嵋派-紫走廊": "jh fam 4 start;go west;go south;go west",
        ...
        "逍遥派-紫地下石室": "jh fam 5 start;go down",
        "丐帮-树洞内部": "jh fam 6 start",
        "丐帮-树洞下": "jh fam 6 start;go down",
        "丐帮-暗道": "jh fam 6 start;go down;go east",
        "丐帮-紫暗道": "jh fam 6 start;go down;go east;go east;go east;go east",
...
<label>人花分值：5000  地花分值：6500  天花分值：8000</label>
    ...
    <span><label for="wudao_pfm">武道自动攻击： </label><input id="wudao_pfm" name="wudao_pfm" type="text" style="width:80px"
            value>
    </span>
    ...
    <span><label for="ks_pfm">叫杀延时(ms)： </label><input id="ks_pfm" name="ks_pfm" type="text" style="width:80px" value>
    </span>
    ...
    <span><label for="unautopfm"> 自动施法黑名单(使用半角逗号分隔)： </label>
        <span><textarea class="settingbox hide" id="unauto_pfm" name="unauto_pfm" style="display: inline-block;">  </textarea></span>
    </span><label for="store_info"> 输入自动存储的物品名称(使用半角逗号分隔):</label>
    <span><textarea class="settingbox hide" id="store_info" style="display: inline-block;">  </textarea></span>
...
<div class = "item-commands"  id = "zml_show"></div>
        ...
        ztjk_edit: function () {
            ...
            messageClear();
            var edithtml = `<div class='zdy_dialog' style='text-align:right;width:280px'>
            <span><label> 本功能目前支持status(状态) 监控 text(文本) msg(聊天信息) 监控,聊天及文本监控可以不用输入action</label></span>
