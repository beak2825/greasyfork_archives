// ==UserScript==
// @name        bangumi search select
// @name:zh-CN  bangumi下拉搜索
// @namespace   https://github.com/zhifengle
// @match       https://bgm.tv/subject/*/add_related/*
// @match       https://bangumi.tv/subject/*/add_related/*
// @match       https://chii.in/subject/*/add_related/*
// @version     0.3
// @license     MIT
// @description search select in bangumi
// @description:zh-cn bangumi下拉搜索
// @author      zhifengle
// @run-at      document-end
// @grant       GM_addStyle
// @grant       GM_getResourceText
// @resource    select2_css https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/css/select2.min.css
// @downloadURL https://update.greasyfork.org/scripts/487526/bangumi%20search%20select.user.js
// @updateURL https://update.greasyfork.org/scripts/487526/bangumi%20search%20select.meta.js
// ==/UserScript==
...
function getPinyin(str) {
  ...
  for (var i = 0; i < str.length; i++) {
    ...
    if (code >= start && code <= end) result += pyt[code - start];
    else result += str[i];
  }
  return result;
}
...
function matchCustom(params, data) {
  ...
  if (getPinyin(data.text).toLowerCase().indexOf(params.term) > -1) {
    return data;
  }
...
$(document).ready(function () {
  $('form[action*="/add_related/"] select').select2({
    matcher: matchCustom,
  });
});
