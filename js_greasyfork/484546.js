// ==UserScript==
// @name AudioBookBay hide category: Crime
// @description Hide Crime category
...
// @downloadURL https://update.greasyfork.org/scripts/484546/AudioBookBay%20hide%20category%3A%20Crime.user.js
// @updateURL https://update.greasyfork.org/scripts/484546/AudioBookBay%20hide%20category%3A%20Crime.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Crime'
    $(".post").has(".postInfo:contains('Crime')").hide();
});
