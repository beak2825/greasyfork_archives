...
// @downloadURL https://update.greasyfork.org/scripts/435458/BR%20%7C%20Script%20forum.user.js
// @updateURL https://update.greasyfork.org/scripts/435458/BR%20%7C%20Script%20forum.meta.js
// ==/UserScript==
...
(function () {
  ...
  const buttons = [{
    ...
    },
    {
      ...
      content: '[FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.mention }}[/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил: 3.04. Запрещено оскорбление или косвенное упоминание родных вне зависимости от чата (IC или OOC) | Mute 60 минут / Ban 7 - 15 дней<br><br>" +
        '[CENTER]Одобрено,закрыто.[/CENTER][/FONT]',
    },
    {
      title: 'Оскорбление',
