...
// @downloadURL https://update.greasyfork.org/scripts/427642/MT_hy3%E6%88%BF6%E4%BA%A7.user.js
// @updateURL https://update.greasyfork.org/scripts/427642/MT_hy3%E6%88%BF6%E4%BA%A7.meta.js
// ==/UserScript==
(function() {
    'use strict';
    //0餐食和2餐食检测部分
    ...
    function startIt(){
        ...
        */
        ...
        function isNoName(name) {
            if (name.substr(name.length-1, 1) == "减" || name.substr(name.length-1, 1) == "返"|| name.substr(name.length-1, 1) == "价") {
                return "";
            }
            return name;
        }
