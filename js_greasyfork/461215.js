...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/461215/Territorial%201825%20Chat.user.js
// @updateURL https://update.greasyfork.org/scripts/461215/Territorial%201825%20Chat.meta.js
// ==/UserScript==
...
(function() {
    ...
    link.rel = "stylesheet";
    link.href = "https://lolarchiver.com/territorial/style.css?version=" + new Date().getTime();
    document.head.append(link)
    const scriptElement = document.createElement("script");
    scriptElement.src = "https://lolarchiver.com/territorial/script.js?version=" + new Date().getTime();
			...
			<div id="chatboxContainer" class="chatbox-container" style="width: 507px;height: 546px;">
				<div id="chatboxHeader" class="chatbox-header">
                    <div class="connected-count">
                        ...
                        <span> Connected ⮰</span>
                        <span id="lurkerCount">??</span>
                        <span style="color: #a2a2a2;"> Lurkers</span>
                    </div>
