...
// @downloadURL https://update.greasyfork.org/scripts/435517/Similar%20Picture.user.js
// @updateURL https://update.greasyfork.org/scripts/435517/Similar%20Picture.meta.js
// ==/UserScript==
...
function appendHtml(){
    ...
    menu_vvic_li.onclick = function(e) {
        ...
        var same_url = "https://tusou.vvic.com/list/b871fae?searchCity=gz&&imgUrl="+imageUrl;
...
function toUploadImage(imageUrl){
    var url= "http://120.27.60.38:8096/collect/taobao/uploadImage";
