// ==UserScript==
// @name         Blue OPG Moderators
// @namespace    https://forum.blackrussia.online
// @version      4.1
// @description  Скрипт для Модераторов Форума | Black Russia BLUE by M.Grozniy
// @author       BLUE
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @grant        none
// @license    MIT
// @icon https://cdn3.emoji.gg/emojis/3635-comfy.png
// @downloadURL https://update.greasyfork.org/scripts/446008/Blue%20OPG%20Moderators.user.js
// @updateURL https://update.greasyfork.org/scripts/446008/Blue%20OPG%20Moderators.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил: 2.01. Запрещено поведение, нарушающее нормы процессов Role Play режима игры | Jail 30 минут [/FONT][/I][/B][/CENTER] " +
                '[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Blue.[/I][/CENTER][/color][/FONT]' +
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по данному пункту правил:<br><ins><b>2.46. Запрещено ездить по полям на любом транспорте | Jail 30 минут[/CENTER]<br><b><ins>" + 
                '[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Blue.[/I][/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][FONT=times new roman][CENTER][I]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    ...
    {
      title: 'ДМ на территории(Нонрп коп)(ФСИН)',
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
    ...
    },
    {
	  ...
	  content:
		...
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Blue.[/I][/CENTER][/color][/FONT]' +
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Имя и фамилия персонажа должны быть указаны на русском языке, без пробелов, как в заголовке, так и в самой теме.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
	  status: false,
    },
    {
      title: 'Меньше 18-65 лет',
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Минимальный возраст в биографии - 18 лет, максимальный - 65 лет.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>В биографие имеются множество грамматических ошибок.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
	  status: false,
    },
    {
