...
// @license     MIT
// @copyright   2020, Bell
// @description Increased brush size range, ability to view a lobby's owner
// @run-at      document-start
// @require     https://code.jquery.com/jquery-3.5.1.min.js
// @downloadURL https://update.greasyfork.org/scripts/410807/Sketchful%2B%2B.user.js
// @updateURL https://update.greasyfork.org/scripts/410807/Sketchful%2B%2B.meta.js
// ==/UserScript==
/* jshint esversion: 6 */

const modScript = 'https://faust.s-ul.eu/vwephith';

(function replaceGameScript() {
	window.YETT_BLACKLIST = [/sketchful\.io\/js\/bundle/];
...
function updateSlider() {
	const sizeSlider = document.querySelector("#gameToolsColorPreview");
	sizeSlider.min = 1;
	sizeSlider.max = 72;
	sizeSlider.step = 4;
}