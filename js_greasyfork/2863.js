...
// @version     0.9
// @downloadURL https://update.greasyfork.org/scripts/2863/Top%20Records%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/2863/Top%20Records%20Script.meta.js
// ==/UserScript==
...
function topRecordsListInit() {
    ...
    /* Set Google Toggle variable when new option is selected */
    $( "#googleToggleInput" ).change( function() {

        var settingsCheck = localStorage.getItem( "googleToggleInputSetting" );

        if ( settingsCheck == 'true' ) {

            localStorage.setItem( "googleToggleInputSetting", "false" );

        } else {

            localStorage.setItem( "googleToggleInputSetting", "true" );
...
function topRecordsTaskInit() {
    ...
    ifrm.setAttribute( 'style', 'background-color:#FAFAFA; position: absolute; z-index:1001; width: ' + $( '#metal' ).width() * zoomFactor + 'px; height: ' + ifrmHeight + 'px; left:' + ifrmTop.left + 'px; top:' + ( ifrmTop.top - ( ifrmTop2 * zoomFactor ) + 20 ) + 'px;' );
    ...
    if ( localStorage.getItem( 'googleToggleInputSetting' ) == 'true' ) {
        var search1Temp = $( '#assignment_name' ).attr('value');
        var search2Temp = $( '#assignment_address' ).attr('value');
        var search3Temp = search1Temp.replace(/&/g, "%26");
        var search4Temp = search2Temp.replace(/&/g, "%26");
        window.open( 'https://www.google.com/search?q=' + search3Temp + ' ' + search4Temp, 'gsearch' );
    }
...
function elTopRecord( i ) {
    ...
    if ( $( ".form-control.metal-attr" ).is( ":focus" ) ) {
        ...
        if ( i.keyCode == 71 ) { //G: Search for Name + address
            var search1 = $( '#assignment_name' ).attr('value');
            var search2 = $( '#assignment_address' ).attr('value');
            var search3 = search1.replace(/&/g, "%26");
            var search4 = search2.replace(/&/g, "%26");
            window.open( 'https://www.google.com/search?q=' + search3 + ' ' + search4, 'gsearch' );
        }
    }
}
...
function showUserSettings() {
    ...
    var userSettingsDiv = document.createElement( "DIV" ),
        ...
        googleToggleInput = document.createElement( 'input' );
    ...
    googleToggleInput.setAttribute( 'id', 'googleToggleInput' );
    googleToggleInput.type = "checkbox";
    googleToggleInput.setAttribute( 'style', 'position: relative; z-index: 2011;' );
    ...
    /* Set to saved preferences */
    if ( localStorage.getItem( "googleToggleInputSetting" ) == 'true' ) {
        googleToggleInput.checked = true;
    } else {
        googleToggleInput.checked = false;
    }
    ...
    $( '.userSettingsDiv' ).append(
        ...
        .html( "<tr><td class='nozoom' id='tr1td1'></td><td class='nozoom' id='tr1td2'></td><td class='nozoom' id='tr1td3'></td><td class='nozoom' id='tr1td4'></td></tr>" +
            "<tr><td class='nozoom' id='tr2td1'></td><td class='nozoom' id='tr2td2'></td><td class='nozoom' id='tr2td3'></td><td class='nozoom' id='tr2td4'></td></tr>" )
    );
    ...
    $( '#tr2td4' ).append( googleToggleInput );
    $( '#tr2td4' ).append( document.createTextNode( ' - Auto Google Search ' ) );
