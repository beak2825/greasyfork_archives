'use strict';
// ==UserScript==
// @name         虎牙pluspromaxultra
// @namespace    http://tampermonkey.net/
// @icon         https://www.huya.com/favicon.ico
// @version      1.0.39
// @description  网页全屏回车发弹幕，移除礼物栏，虎牙自动领取任务经验、开宝箱，复制直播流链接，简化页面，去广告, 夜间模式，自动进入剧场模式, 我的订阅页面视频预览
// @author       gesla
// @match        *://*.huya.com/*
...
// @grant        unsafeWindow
// @license      MIT
// @original-script https://greasyfork.org/scripts/402279 (c) Francis
// @require      https://cdn.bootcdn.net/ajax/libs/flv.js/1.6.1/flv.min.js
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/427805/%E8%99%8E%E7%89%99pluspromaxultra.user.js
// @updateURL https://update.greasyfork.org/scripts/427805/%E8%99%8E%E7%89%99pluspromaxultra.meta.js
// ==/UserScript==
...
#player-subscribe-wap, .player-app-qrcode,.banner-ab-warp{
    display:none !important;}

#player-ctrl-wrap #match-replay-progress{
    height: 0px;
}
