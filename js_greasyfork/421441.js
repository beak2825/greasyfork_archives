// ==UserScript==
// @name           JVChatPremium fix Fixed by Luffydev !
// @description    Outil de discussion instantanée pour les forums de Jeuxvideo.com (Fixed by Luffydev)
// @author         Blaff
...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/421441/JVChatPremium%20fix%20Fixed%20by%20Luffydev%20%21.user.js
// @updateURL https://update.greasyfork.org/scripts/421441/JVChatPremium%20fix%20Fixed%20by%20Luffydev%20%21.meta.js
// ==/UserScript==
...
function clearPage(document) {
	...
	document.querySelector('.layout__contentMain').className = "layout__contentMain";
	document.querySelector('.layout__contentMain').style = "position: absolute !important;display: block !important;margin: 0 1px 0 187px !important;grid-row: none !important;grid-column: none !important;";
    ...
    document.getElementById("page-messages-forum").insertAdjacentHTML("afterbegin", "<div id='jvchat-alerts'><div id='jvchat-fixed-alert' class='jvchat-hide'><div class='alert-row'></div></div><div id='jvchat-turbo-warning' class='jvchat-hide'><button class='close jvchat-alert-hide' aria-hidden='true' data-dismiss='alert' type='button'>×</button><div class='alert-row'></div></div><div id='jvchat-degraded-refresh-warning' class='jvchat-hide'><div class='alert-row'></div></div></div>");
     ...
     document.getElementById("page-messages-forum").insertAdjacentHTML("beforebegin", PANEL);
    ...
    if (configuration["night_mode"]) {
        document.querySelector('.layout__contentMain').classList.add("jvchat-night-mode");
    }
...
function toggleNightModeOption(event) {
    ...
    saveConfig();
    document.querySelector('.layout__contentMain').classList.toggle("jvchat-night-mode");
}
...
function isScrollDown() {
    let element = document.getElementById("page-messages-forum");
