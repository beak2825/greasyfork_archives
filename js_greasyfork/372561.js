...
// @grant              GM_setValue
// @namespace SY
// @downloadURL https://update.greasyfork.org/scripts/372561/FUT%2020%20Auto%20Buyer.user.js
// @updateURL https://update.greasyfork.org/scripts/372561/FUT%2020%20Auto%20Buyer.meta.js
// ==/UserScript==
// ==OpenUserJS==
// @author Sy
// ==/OpenUserJS==
(function () {
    ...
    $(document).bind('DOMNodeInserted', function(event) {
      ...
      // AJOUT DU BOUTON START/STOP AUTO BUYER
        ...
        if ($(event.target).find('#autoBuyerButton').length === 0) {
          ...
          $('#autoBuyerButton').click(function () {
          ...
          $('#autoBuyerCrezipAllButton').click(function () {
            globalCrezipActive = "all";
            // STOP AUTO BUY
            if ($('#autoBuyerCrezipAllButton').hasClass('started') || globalAutoBuyerStarted)
            {
              stopAutoBuyer();
            }
            // START AUTO BUY
          ...
          $('#autoBuyerCrezipGardienButton').click(function () {
            globalCrezipActive = "gardien";
            // STOP AUTO BUY
            if ($('#autoBuyerCrezipGardienButton').hasClass('started') || globalAutoBuyerStarted)
            {
              stopAutoBuyer();
            }
            // START AUTO BUY
          ...
          $('#autoBuyerCrezipDefenseurButton').click(function () {
            globalCrezipActive = "defenseur";
            // STOP AUTO BUY
            if ($('#autoBuyerCrezipDefenseurButton').hasClass('started') || globalAutoBuyerStarted)
            {
              stopAutoBuyer();
            }
            // START AUTO BUY
          ...
          $('#autoBuyerCrezipMilieuxButton').click(function () {
            globalCrezipActive = "milieux";
            // STOP AUTO BUY
            if ($('#autoBuyerCrezipMilieuxButton').hasClass('started') || globalAutoBuyerStarted)
            {
              stopAutoBuyer();
            }
            // START AUTO BUY
          ...
          $('#autoBuyerCrezipAttaquantButton').click(function () {
            globalCrezipActive = "attaquant";
            // STOP AUTO BUY
            if ($('#autoBuyerCrezipAttaquantButton').hasClass('started') || globalAutoBuyerStarted)
            {
              stopAutoBuyer();
            }
            // START AUTO BUY
  ...
  function createSearchCriteria()
  {
    ...
    var oldSearchCriteria = getSearchCriteria();
    var searchCriteria = new transferobjects.SearchCriteria();
    searchCriteria.acquiredDate = oldSearchCriteria.acquiredDate;
    searchCriteria.category = oldSearchCriteria.category;
    searchCriteria.club = oldSearchCriteria.club;
    searchCriteria.count = oldSearchCriteria.count;
    searchCriteria.isExactSearch = oldSearchCriteria.isExactSearch;
    searchCriteria.league = oldSearchCriteria.league;
    searchCriteria.level = oldSearchCriteria.level;
    searchCriteria.maskedDefId = oldSearchCriteria.maskedDefId;
    searchCriteria.maxBid = oldSearchCriteria.maxBid;
    searchCriteria.maxBuy = oldSearchCriteria.maxBuy;
    searchCriteria.minBid = oldSearchCriteria.minBid;
    searchCriteria.minBuy = oldSearchCriteria.minBuy;
    searchCriteria.nation = oldSearchCriteria.nation;
    searchCriteria.offset = oldSearchCriteria.offset;
    searchCriteria.playStyle = oldSearchCriteria.playStyle;
    searchCriteria.position = oldSearchCriteria.position;
    searchCriteria.sort = oldSearchCriteria.sort;
    searchCriteria.type = oldSearchCriteria.type;
    searchCriteria.untradeables = oldSearchCriteria.untradeables;
    searchCriteria.zone = oldSearchCriteria.zone;
      ...
      setTimeout(function() {
          if (!globalIsPause)
          {
              ...
              else
              {
                  ...
                  if (globalToggleIPP)
                  {
                    gConfigurationModel.getConfigObject('itemsPerPage')[models.ConfigurationModel.ITEMS_PER_PAGE.TRANSFER_MARKET] = globalItemPerPage;
  ...
  function searchV2()
  {
    if (getConfigShowNotificationLog()) console.log('SEARCH V2');
