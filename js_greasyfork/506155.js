...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/506155/Resurviv%20UI%20Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/506155/Resurviv%20UI%20Mod.meta.js
// ==/UserScript==
...
(function() {
    ...
    function toggleUIElementDisplay(enabled) {
        if (enabled) {
            ...
            healthBarWidthCopy.style.top = '50%';
            healthBarWidthCopy.style.left = '46.5%';
            healthBarWidthCopy.style.transform = 'translate(-50%, -50%)';
            ...
            ammoCountCopy.style.bottom = '47.8%';
            ammoCountCopy.style.left = '53.5%';
            ammoCountCopy.style.transform = 'translate(-50%, -50%)';
