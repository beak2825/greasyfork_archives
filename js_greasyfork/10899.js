...
// @grant    GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/10899/Kadokado%20Magic%20Data%20Extractor.user.js
// @updateURL https://update.greasyfork.org/scripts/10899/Kadokado%20Magic%20Data%20Extractor.meta.js
// ==/UserScript==
...
function PrepareAdvancedExtraction()
{
	...
	var buttonForum = document.evaluate("//div[@class='actions']/ul/li/a[@href='/tid/forum']", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
	if (!buttonForum)
	{
		// Forum not available

		// Extracting clan data from the current document!
		ExtractMembersData(document);
	}
	else
	{
