...
// @name         Better Publy
// @version      0.3
// @description  Supply a font setting dialog for Publy
// @author       lqez
// @include      https://publy.co/*
// @namespace    publy.co
// @grant        GM.setValue
// @grant        GM.getValue
// @downloadURL https://update.greasyfork.org/scripts/391347/Better%20Publy.user.js
// @updateURL https://update.greasyfork.org/scripts/391347/Better%20Publy.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    function apply(key) {
        ...
        if (key == 'colorScheme') {
            node = document.querySelector("div#app");
            ...
            nodes = document.querySelectorAll(".fixed-container-medium");
            ...
            nodes = document.querySelectorAll("article #sections p, article #sections p *, article #sections q");
            for (i = 0; i < nodes.length; i++) {
                node = nodes[i];
