...
// @license        MIT
// @downloadURL https://update.greasyfork.org/scripts/375781/HWM%20Market%20Style%20MOD%20g.user.js
// @updateURL https://update.greasyfork.org/scripts/375781/HWM%20Market%20Style%20MOD%20g.meta.js
// ==/UserScript==
...
/* Style */
   var cssStyle = "";
   cssStyle += ".price{display:inline-block;text-align:center;padding:3px 6px;margin:0;font-size:11px;font-weight:bold;line-height:14px;color:#fff;vertical-align:baseline;white-space:nowrap;text-shadow:0 -1px 0 rgba(0, 0, 0, .25);background-color:#666;text-decoration:none;box-shadow:0 0 2px rgba(0, 0, 0, .3);}.price:hover,.price:focus{color:#fff;opacity:.85;text-decoration:none;cursor:pointer;}.price-red{background-color:#b94a48;}.price-yellow{background-color:#C87E43;}.price-green{background-color:#468847;}.price-blue{background-color:#3a87ad;}.price-black{background-color:#333;}td.price{width:20%;}td>.tool-tip,.tool-tip,span>.tool-tip,div>.tool-tip{opacity:0;visibility:hidden;margin-top:10px;-webkit-transform:translateX(-8px);-moz-transform:translateX(-8px);-ms-transition:translateX(-8px);-o-transition:translateX(-8px);transition:translateX(-8px);}td:hover>.tool-tip,span:hover>.tool-tip,span .tool-tip:hover,td .tool-tip:hover,div:hover>.tool-tip,div .tool-tip:hover{opacity:1;visibility:visible;overflow:visible;margin-top:31px;display:inline;-webkit-transform:translateX(-8px);-moz-transform:translateX(-8px);-ms-transition:translateX(-8px);-o-transition:translateX(-8px);transition:translateX(-8px);}.tool-tip{background:#383838;color:#fff;padding:5px 8px;font-size:12px;line-height:12px;white-space:nowrap;text-shadow:0 -1px 0 black;margin-left:-40px;z-index:10;height:auto;line-height:20px;font-family:Georgia, serif;font-weight:400;font-style:italic;text-shadow:1px 1px 1px rgba(0, 0, 0, .1);text-align:center;border:4px solid #fff;text-indent:0;border-radius:5px;position:absolute;pointer-events:none;opacity:0;box-shadow:4px 4px 8px rgba(0, 0, 0, .3);-webkit-transition:all .3s ease-in-out;-moz-transition:all .3s ease-in-out;-ms-transition:all .3s ease-in-out;-o-transition:all .3s ease-in-out;transition:all .3s ease-in-out;}.tool-tip:before{content:'';display:block;border:0;border-top:1px solid transparent;border-right:1px solid transparent;width:10px;height:10px;margin-left:15px;margin-top:-11px;position:absolute;-webkit-transform:rotate(-45deg);-moz-transform:rotate(-45deg);-ms-transition:rotate(-45deg);-o-transform:rotate(-45deg);transform:rotate(-45deg);}.tool-tip--black{background-color:#1A1818;text-shadow:0 -1px 0 #1A1818;}.tool-tip--black.tool-tip:before{background-color:#1A1818;border-top-color:#1A1818;border-right-color:#1A1818;}.tool-tip--red{background-color:#b34e4d;text-shadow:0 -1px 0 #5a2626;}.tool-tip--red.tool-tip:before{background-color:#b34e4d;border-top-color:#b34e4d;border-right-color:#b34e4d;}.tool-tip--yellow{background-color:#C87E43;text-shadow:0 -1px 0 #6d5228;}.tool-tip--yellow.tool-tip:before{background-color:#C87E43;border-top-color:#C87E43;border-right-color:#c09854;}.tool-tip--green{background-color:#458746;text-shadow:0 -1px 0 #1a331a;}.tool-tip--green.tool-tip:before{background-color:#458746;border-top-color:#458746;border-right-color:#458746;}.tool-tip--blue{background-color:#3986ac;text-shadow:0 -1px 0 #193c4c;}.tool-tip--blue.tool-tip:before{background-color:#3986ac;border-top-color:#3986ac;border-right-color:#3986ac;}";
...
menu.childNodes[0].innerHTML = '<label for=check_tolko_pribyl1 style="cursor:pointer;" title="' + str1 + '">' +
                                   '<input type=checkbox ' + (check_tolko_pribyl==1?'checked':'') + ' id=check_tolko_pribyl1>' + str2 +
                                '</label>\xA0 ' +
                                '<label for=check_tolko_zelye1 style="cursor:pointer;" title="' + str3 + '">'+
                                    '<input type=checkbox ' + (check_tolko_zelye==1?'checked':'') + ' id=check_tolko_zelye1>' + str4 + '</label><br />' +
                               '<label for=check_tolko_gos1 style="cursor:pointer;" title="' + str5 + '">' +
                                   '<input type=checkbox ' + (check_tolko_gos==1?'checked':'') + ' id=check_tolko_gos1>' + str6 +
                               '</label>';
menu.childNodes[4].innerHTML = '<div class="price price-black" style="width: 120px;">' +
                                  '<span id=time_ex title="' + str7 + '">0 ms</span>'+
                                  '<span class="tool-tip">\u0412\u0440\u0435\u043C\u044F \u0437\u0430\u0442\u0440\u0430\u0447\u0435\u043D\u043D\u043E\u0435<br />'+
                                      '\u043D\u0430 \u043E\u0431\u0440\u0430\u0431\u043E\u0442\u043A\u0443 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u044B'+
                                  '</span>' +
                                 ' | <a href="javascript:void(0);" style="text-decoration: none;color: inherit;" id="open_transfer_id">Bonus</a>' +
                               '</div><br />' +
...
if ( parent.id != 'check_style_ex2' ) {
	...
	if ( pribyl > -1 ) {
		add_elem.innerHTML = '<tbody>' +
                                '<tr>' +
                                   '<td class="price price-black">' + sebes_arta + '<span class="tool-tip tool-tip--black"> себестоимость арта<br />цена за бой: ' + arts_cost_proch.toFixed(2) + '</span></td>' +
		...
		add_elem.innerHTML = '<tbody>' +
                                '<tr>' +
                                   '<td class="price price-black">' + sebes_arta + '<span class="tool-tip tool-tip--black"> себестоимость арта<br />цена за бой: ' + arts_cost_proch.toFixed(2) + '</span></td>' +
                                   '<td class="price price-yellow">' + pribyl_na_boj + '<span class="tool-tip tool-tip--yellow">цена за бой:<br /> переплата ' + Math.abs(pribyl_na_boj) + ' зол.</span></td>' +
                                   '<td class="price price-red">' + pribyl + '<span class="tool-tip tool-tip--red">себестоимость арта:<br /> переплата ' + Math.abs(pribyl) + ' зол.</span></td>' +
                                '</tr>' +
                             '</tbody>';
	}
