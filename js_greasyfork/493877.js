...
// @version      12.2
// @description  Версия для сервера TULA
// @author       Clifford Arankay
...
// @copyright 2023,
// @downloadURL https://update.greasyfork.org/scripts/493877/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B4%D0%B5%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/493877/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B4%D0%B5%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
  ...
  const buttons = [
      ...
      },
      {
        ...
        content:
          ...
          `Ваша жалоба взята в процессе рассмотрения. Не создавайте дубликаты данной темы.<br><br>` +
      ...
      },
      {
        ...
        content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Ваша жалоба передана на рассмотрение техническому специалисту.<br><br>` +
          `Ожидайте ответа.${END_DECOR}`,
        prefix: TECH_PREFIX,
        status: true,
        move: 0,
      ...
      },
      {
        ...
        content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `В данной ситуации обязательно должен быть полный фрапс(видеофиксация) нарушения игрока.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
        prefix: FAIL_PREFIX,
        status: false,
        move: 0,
      ...
      },
      {
        ...
        content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Обратитесь в раздел жалоб  на администрацию → *[URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.2288/']Кликабельно[/URL]*<br><br>` +
          `Закрыто.${END_DECOR}`,
        prefix: CLOSE_PREFIX,
        status: false,
        move: 0,
      },
      {
        ...
        content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Обратитесь в раздел обжалований наказаний → *[URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.2291/']Кликабельно[/URL]*<br><br>` +
          `Закрыто.${END_DECOR}`,
        prefix: CLOSE_PREFIX,
        status: false,
        move: 0,
      ...
      },
      {
        ...
        content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Нарушитель будет наказан по пункту правил:[QUOTE]2.05. Запрещены любые OOC обманы и их попытки, а также любые IC обманы с нарушением Role Play правил и логики | PermBan.[/QUOTE]<br><br>` +  `Приятной игры на сервере TULA <3 <br><br>`
      ...
      },
      {
        ...
        content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Нарушитель будет наказан по причине [QUOTE]Попытка Покупки/Продажи ИВ/Non rp обман , т.к слоты запрещено покупать/продвать это приравнивается к пункту правил 2.28[/QUOTE]<br><br>` +
          `Одобрено, закрыто.${END_DECOR}`,
        prefix: OKAY_PREFIX,
        status: false,
        move: 0,
  ...
  const biography = [
      ...
      },
      {
        ...
        content:
          ...
          "Подробнее ознакомиться с правилами составления RolePlay биографий можно тут → *[URL='https://forum.blackrussia.online/threads/red-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BE%D1%84%D0%BE%D1%80%D0%BC%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F-%D0%A0%D0%9F-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B9.7912578/']Кликабельно[/URL]*<br><br>" +
          `На доработку у вас есть 24 часа.${END_DECOR}`,
        prefix: WAIT_PREFIX,
        status: true,
        open: true,
      ...
      },
      {
        ...
        content:
          `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
          "Ваша RolePlay биография составлена не по форме. Ниже представлена актуальная форма:*[URL='https://forum.blackrussia.online/threads/red-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BE%D1%84%D0%BE%D1%80%D0%BC%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F-%D0%A0%D0%9F-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B9.7912578/']Кликабельно[/URL]*<br><br>" +
          `Отказано, закрыто.${END_DECOR}`,
        prefix: FAIL_PREFIX,
        status: false,
        move: 63,
