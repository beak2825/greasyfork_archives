...
// @grant none 
// @downloadURL https://update.greasyfork.org/scripts/396254/AmazonBot.user.js
// @updateURL https://update.greasyfork.org/scripts/396254/AmazonBot.meta.js
// ==/UserScript==   
...
function getSeller() {
    try {
        return document.getElementById('merchant-info').getElementsByTagName('a')[0].text } catch (e) { return null } 
}

(async function () {
    'use strict'; const password = 'your password'; const refresh_interval = 2000; const product_codes = ['B07573632C', 'B016DCAOOA', 'B07MJKHYDC', 'B07571223K', 'B07T3MNKKW', 'B07T5V4TCV', 'B0015R1BL4', 'B00FX4EBS0'] 
    ...
    if (current_url.match('/signin*') !== null) {
        ...
        let product_id = document.getElementById('ASIN').value // When out of stock
