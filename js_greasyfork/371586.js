...
// @icon         https://raw.githubusercontent.com/trailyy/umextension/master/L8dIOR9.png
// @downloadURL https://update.greasyfork.org/scripts/371586/ARR%20Clan%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/371586/ARR%20Clan%20Script.meta.js
// ==/UserScript==
...
// Cosmetics //
///////////////
GM_addStyle('#logo {background-image: url("https://i.imgur.com/xMhuuxK.png");}');
...
GM_addStyle('#main-scrimmage {color: aqua !important; border-color: aqua !important}');
/////////////////
// Other Stuff //
/////////////////
...
$('#btn-play').text('Rekt Bitchs');
$(".main-bottom-left").append('<a id="umdiscord" href="https://discord.gg/xAthAVy" target="_blank">Discord</a>');
$("#arrdiscord").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "aqua",
...
$("#main-content").append('<a id="Sasuk" href="https://www.youtube.com/channel/UCD5BW7glkOS4ax0XvHIK2GA?view_as=subscriber" target="_blank">Sasuke is the best</a>');
$("#sasukeisthebest").css({
    "border-style": "solid",
    "border-width": "1px",
    "border-color": "red",
...
console.log("%cARR Clan Script is enabled. Message Sasuke(Sasuke#7237) if help needed.", "font-size: 25px; font-weight: bold; background: red; color: white; padding: 10px; border: solid 2px orange;");
