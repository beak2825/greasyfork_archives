...
// @downloadURL https://update.greasyfork.org/scripts/3350/Avatars%20Plus%21%20and%20More%20for%20Google%2B.user.js
// @updateURL https://update.greasyfork.org/scripts/3350/Avatars%20Plus%21%20and%20More%20for%20Google%2B.meta.js
// ==/UserScript==
                ...
                setInterval(function () {
                    if (document.getElementsByClassName('Sla').length == 0) {
                        ...
                        for (var i = 0; i < userRanksArr.length; i++) {
                            ...
                            if (storedUserRankArr[i][4] > 0)
                                document.getElementsByClassName("gbrlvc")[i].style.color = "#259b24";
                            else if (storedUserRankArr[i][4] == 0) {
                                document.getElementsByClassName("gbrlvc")[i].style.color = "#9e9e9e";
                                document.getElementsByClassName("gbrlvc")[i].style.display = "none";
                            }
                            else if (storedUserRankArr[i][4] < 0 || storedUserRankArr[i][4] < 0)
                                document.getElementsByClassName("gbrlvc")[i].style.color = "#e51c23";
                            else
                                document.getElementsByClassName("gbrlvc")[i].style.color = "#ff9800";
                            if (storedUserRankArr[i][12] == "ssl.gstatic.com/s2/profiles/images/silhouette64.png") {
                                document.getElementsByClassName("gbrlvc")[i].innerHTML = "NOT FOUND";
                                document.getElementsByClassName("gbrlvc")[i].style.color = "#d01716";
                ...
                if (document.getElementsByClassName('Ypa jw Yc am')[2] != undefined) {
                    ...
                    for (var i = 0; i < userRanksArr.length; i++) {
                        ...
                        if (storedUserRankArr[i][12] == "ssl.gstatic.com/s2/profiles/images/silhouette64.png") {
                            ...
                            document.getElementsByClassName("gbrlvc")[i].style.opacity = "#d01716";
                        }
                        document.getElementById("gbaupdt").addEventListener('click', updateManually);
                    }
                }
...
var css_Relevance_Aprox = ".gbrlvc:hover {opacity: 1;-webkit-transition: all .5s ease-in-out;font-weight: bold;}.gbrlvc {opacity: 0.9;position: absolute;background-color: #fff;-webkit-transition: all .5s ease-in-out;z-index: 1;font-weight: normal;font-size: 12px;}";
