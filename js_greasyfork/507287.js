...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/507287/pixels-not-cooking-2.user.js
// @updateURL https://update.greasyfork.org/scripts/507287/pixels-not-cooking-2.meta.js
// ==/UserScript==
                    ...
                    while (room){
                        ...
                        if (state.id.includes("shareRent")) {
                            ...
                            while (energy > 100) {
                                ...
                                console.log(unsafeWindow.Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes[length_scenes-1])
...
//                             await move_distance(3492, 3000)
                            ...
                            while (ElementsName.length>0){
                                ...
                                if (name === 'Copperite Screw'||(skillType==='cooking'||skillType==='stoneshaping'||skillType==='woodwork'||skillType==='forestry'||skillType==='petcare'||skillType==='business'||skillType==='metalworking')){
                                    id = id+1
                                    continue;
                                }
