// ==UserScript==
// @name         town star pumpkin
// @namespace    wiolentmonkey
// @version      2.5
// @description  pumpkinpie
// @author       gela
// @match        https://townstar.sandbox-games.com/launch/
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/437515/town%20star%20pumpkin.user.js
// @updateURL https://update.greasyfork.org/scripts/437515/town%20star%20pumpkin.meta.js
// ==/UserScript==
...
(function() {
    ...
    const trackedItems = [
        ...
        {item: 'Lumber', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Oak_Barrel', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Wine_Bottle', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Pinot_Noir', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Steel', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Candy_Canes', count: 0, first: 0, oneMin: 6, oneHour: 0},
    ];
    let loaded = 0;
 
    const craftedItems = [
       {item: 'Candy_Canes', keepAmt: 0, sellMin: 10},
       {item: 'Peppermint', keepAmt: 0, sellMin: 10},
       {item: 'Pumpkin', keepAmt: 5, sellMin: 10},
       {item: 'Pumpkin_Pie', keepAmt: 0, sellMin: 10},
       {item: 'Oak_Barrel', keepAmt: 0, sellMin: 10},
       {item: 'Oak_Wood', keepAmt: 0, sellMin: 10},
        {item: 'Wine_Bottle', keepAmt: 0, sellMin: 10},
        {item: 'Pinot_Noir_Grapes', keepAmt: 10, sellMin: 10},
        {item: 'Pinot_Noir', keepAmt: 0, sellMin: 10},
        {item: 'Wood', keepAmt: 8, sellMin: 10},
        {item: 'Lumber', keepAmt: 3, sellMin: 10},
        {item: 'Sugarcane', keepAmt: 0, sellMin: 10},
        {item: 'Sugar', keepAmt: 0, sellMin: 10},
        {item: 'Wheat', keepAmt: 0, sellMin: 10},
        {item: 'Wool', keepAmt: 0, sellMin: 10},
        {item: 'Wool_Yarn', keepAmt: 0, sellMin: 10},
        {item: 'Cotton', keepAmt: 0, sellMin: 10},
        {item: 'Cotton_Yarn', keepAmt: 0, sellMin: 10},
        {item: 'Uniforms', keepAmt: 0, sellMin: 10},
        {item: 'Jet_Fuel', keepAmt: 0, sellMin: 10},
        {item: 'Water_Drum', keepAmt: 5, sellMin: 10},
        {item: 'Feed', keepAmt: 0, sellMin: 10},
        {item: 'Milk', keepAmt: 0, sellMin: 10},
        {item: 'Salt', keepAmt: 0, sellMin: 10},
        {item: 'Eggs', keepAmt: 0, sellMin: 10},
        {item: 'Energy', keepAmt: 2, sellMin: 10},
        {item: 'Petroleum', keepAmt: 5, sellMin: 10},
        {item: 'Gasoline', keepAmt: 10, sellMin: 10},
        {item: 'Iron', keepAmt: 0, sellMin: 10},
        {item: 'Limestone', keepAmt: 0, sellMin: 10},
        {item: 'Chromium', keepAmt: 0, sellMin: 10},
