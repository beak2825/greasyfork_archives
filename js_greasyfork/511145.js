// ==UserScript==
// @name               dwai Exporter
// @name:zh-CN         dwai Exporter
// @namespace          dwai
// @version            1.1
// @author             dwai
// @description        改自ChatGPT Exporter开源项目，用于导出dwai聊天记录
// @description:zh-CN  轻松导出 ChatGPT 聊天记录，以便进一步分析或分享。
// @license            MIT
// @icon               https://dwai.work/favicon.ico
// @match              https://*.dwai.work/*
// @match              https://dwai.work/*
// @match              https://*.dwai.work/*
...
// @grant              unsafeWindow
// @run-at             document-end
// @downloadURL https://update.greasyfork.org/scripts/511145/dwai%20Exporter.user.js
// @updateURL https://update.greasyfork.org/scripts/511145/dwai%20Exporter.meta.js
// ==/UserScript==
