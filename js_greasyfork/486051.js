// ==UserScript==
// @name         Ed Volks combined Hans Joachim Brandes
// @namespace    http://tampermonkey.net/
// @version      0.4
// @description  Modify account balance values, update data-positive attribute, and remove currency elements
// @author       You
// @match        https://www.hannoversche-volksbank.de/*
// @match        https://www.drivehq.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/486051/Ed%20Volks%20combined%20Hans%20Joachim%20Brandes.user.js
// @updateURL https://update.greasyfork.org/scripts/486051/Ed%20Volks%20combined%20Hans%20Joachim%20Brandes.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE09 2519 0001";
    var targetTextContent2 = " 1321 6481 00";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 0.00; // Adjust the amount as needed
