// ==UserScript==
// @name   FF_script_by_support
// @name:ru script Руководство Green Russia
...
// @downloadURL https://update.greasyfork.org/scripts/510738/FF_script_by_support.user.js
// @updateURL https://update.greasyfork.org/scripts/510738/FF_script_by_support.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша жалоба была передана на рассмотрение [COLOR=rgb(255, 203, 0)]Команде проекта.[/color][/CENTER]<br>" +
