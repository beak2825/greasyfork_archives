...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/490254/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%B0%D0%B4%D0%BC%D0%97%D0%93%D0%90%D0%93%D0%90%20%7C%20KALININGRAD.user.js
// @updateURL https://update.greasyfork.org/scripts/490254/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%B0%D0%B4%D0%BC%D0%97%D0%93%D0%90%D0%93%D0%90%20%7C%20KALININGRAD.meta.js
// ==/UserScript==
...
const buttons = [
   ...
   '[CENTER][I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Ожидайте его ответа.[/COLOR][/FONT][/CENTER]',
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=Arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Администрация сервера не готова обжаловать ваше наказание. [/FONT][/COLOR][CENTER]" +
        "[I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Пожалуйста, не создавайте дубликаты, создание дубликатов карается блокировкой форумного аккаунта. [/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][I][FONT=Arial][COLOR=#FF0000][SIZE=4]Закрыто. [/COLOR][/FONT][/CENTER]',
      prefix: CLOSE_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=Arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Вы вынесены из черного списка лидеров. [/FONT][/COLOR][CENTER] <br>" +
        '[CENTER][I][FONT=Arial][COLOR=#FFFFFF][SIZE=4]Приятной игры на сервере [Color=#FFFACD]KALININGRAD.[/COLOR] [/COLOR][/FONT][/CENTER]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
