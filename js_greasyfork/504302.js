...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/504302/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82.user.js
// @updateURL https://update.greasyfork.org/scripts/504302/%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82.meta.js
// ==/UserScript==
...
},
{
  ...
  },
  {
    ...
    content:
      '[SIZE=4][FONT=Verdana]Здравствуйте.<br><br>' +
      'Переношу вашу тему в раздел жалоб на администрацию.<br><br>' +
      'Отказано.[/FONT][/SIZE]',
    ...
    },
{
	...
	content:
	'[SIZE=4][FONT=Verdana]Здравствуйте.<br><br>' +
	"Срок написания жалобы составляет три дня (72 часа) с момента совершенного нарушения со стороны игрока сервера. В случае истечения срока жалоба рассмотрению не подлежит.<br><br>" +
	'Закрыто.[/FONT][/SIZE]',
	prefix: ACCEPT_PREFIX,
	status: false,
    },
{
	...
	content:
	'[SIZE=4][FONT=Verdana]Здравствуйте.<br><br>' +
	"Для рассмотрения данного нарушения требуется предоставить видеозапись, на которой чётко зафиксировано нарушение со стороны игрока.<br><br>" +
	'Закрыто.[/FONT][/SIZE]',
	prefix: UNACCEPT_PREFIX,
	status: false,
    },
