// ==UserScript==
// @name        gwdang_youdaoGWZS
// @description 购物党&有道购物助手
// @version     2015.10.16
// @namespace   https://greasyfork.org/zh-CN/users/5280-wh-t https://greasyfork.org/zh-CN/scripts/7753-youdaogwzs
// @icon        http://www.gwdang.com/favicon.ico
// @grant GM_getValue
// @grant GM_setValue
...
// @include http://*.jd.com/*
// @downloadURL https://update.greasyfork.org/scripts/6548/gwdang_youdaoGWZS.user.js
// @updateURL https://update.greasyfork.org/scripts/6548/gwdang_youdaoGWZS.meta.js
// ==/UserScript==
(function(){
var s;s=document.createElement("script");s.type="text/javascript";s.charset="utf-8";s.src="http://www.gwdang.com/get.js?f=/js/gwdang_extension.js";document.body.appendChild(s);
    ...
    daogw_s.src = 'https://shared-https.ydstatic.com/gouwuex/ext/script/extension_' + version.replace('.', '_') + '.js?vendor=youdao&browser=firefox&version=' + version;    document.getElementsByTagName('head')[0].appendChild(daogw_s);
})();