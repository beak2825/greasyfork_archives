...
// @downloadURL https://update.greasyfork.org/scripts/388180/Google%20Search%20%22View%20Image%22%20Button.user.js
// @updateURL https://update.greasyfork.org/scripts/388180/Google%20Search%20%22View%20Image%22%20Button.meta.js
// ==/UserScript==
...
function addButton(node) {
  if (node.nodeType === Node.ELEMENT_NODE) {
    if (node.classList.contains('irc_ris')) {
      ...
      link.href = link.attributes.hrefbase.value + src;
    }
  }
}
