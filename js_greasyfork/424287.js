// ==UserScript==
// @name Mover Army Minas Ggg donidonadeli
...
// @copyright 2012+, You
// @downloadURL https://update.greasyfork.org/scripts/424287/Mover%20Army%20Minas%20Ggg%20donidonadeli.user.js
// @updateURL https://update.greasyfork.org/scripts/424287/Mover%20Army%20Minas%20Ggg%20donidonadeli.meta.js
// ==/UserScript==
...
var Lanceiros_De_Dardos = 16540; // M_P1
var Arietes = 41; // M_C1
var Carrinhos = 2999; // M_CT
var Cavalaria_Leve = 3196; // M_K1
var Arqueiros_Cavalo_Leve = 18; // M_K4

var Balistas = 149; // M_C4
var Cavalaria_Pesada = 19037; // M_K2
var Arqueiros_Pesados = 4579; // M_S2
var Espadaschis_Pesados = 43777; // M_M2
var Espadachins_Leves = 330; // M_M1
var Arqueiros_Leves = 236; // M_S1
...
// Verificação do ouro
if(parseFloat($("#resources-list #gold a").text().trim()) < 0)
{
window.open("https://mp3.fastupload.co/data/1615671550/07-Break-Me-Out.mp3");
}
});
