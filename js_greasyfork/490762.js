...
// @grant		none
// @run-at		document-end
// @downloadURL https://update.greasyfork.org/scripts/490762/%CA%80%EA%9C%B1%E1%B4%9B%CA%9F%E6%94%B9.user.js
// @updateURL https://update.greasyfork.org/scripts/490762/%CA%80%EA%9C%B1%E1%B4%9B%CA%9F%E6%94%B9.meta.js
// ==/UserScript==
console.clear(), window.gVar = {
    Waves: [],
    isActive: true,    
    trip:'unknown',
    mapStat: true
    ...
    start = () => ! function(t) {
        ...
        var d = function() {
            function t() {
                    ...
                    this.nameTextZoom = 100,
                    this.massTextZoom = 100,
                    this.massOverlapSize = 22500,
                    this.toggleHotKeys = {
                    ShowName: 78,
                    ShowMass: -1,
                    ShowCursorLine: -1,
        ...
        var p = function() {
                ...
                return t.texts_jp = {
                    ...
                    ShowOrderRing3: "ShowOrderRing(type3)",
                    ...
                    MarkerLight: "マーカー軽量化",
                    MarkerExtend: "マーカー拡張",
                    ShowPrivateMessageNotification: "プライベートメッセージの通知を表示する",
                    hkSplit: "分裂",
                    hkFeedOne: "餌単発",
                    hkFeed: "餌連射",
                    ...
                    lbtNameTextZoom: "nameTextZoom",
                    lbtMassTextZoom: "massTextZoom",
                    lbtMassOverlapSize: "massOverlapSize",
                    hdrTheme: "テーマ",
                    hdrColor: "色",
                    hdrWallpaper: "壁紙"
                }, t.texts_en = {
                    ...
                    ShowPrivateMessageNotification: "ShowPrivateMessageNotification",
        ...
        var b = function() {
            ...
            return t.prototype.ShowDebugValue = function(t, e) {
                ...
                if (this.chatAppModel) this.chatAppModel.SendMessageOnGameChatSession(t);
            ...
            }, t.prototype.StatesUpdationProc = function(tab) {
                    g.TimeChecker.Start("StatusUpdationProc"), 
                    this.nodeMan.RecordLatencyCheckStartTime(), 
                    this.conn.SendLatencyCheckRequest(tab), 
                    ...
                    f.TNodeData.Pool.capacity, 
                    f.TNodeData.Pool.pool.length, 
                    g.TimeChecker.Stop()
                ...
                navigator.userAgent.indexOf("Firefox") >= 0 ? e.addEventListener("DOMMouseScroll", n, !1) : e.onmousewheel = n, this.nodeMan.selfUnitsDeadCallback = this.SelfUnitsDeadProc.bind(this);
            }, t.prototype.Reset = function() {
                this.seqUseInfoStrSent = null, this.isSuspend = !1
            }, t.prototype.ConnectToGameServer = function(t) {
                void 0 === t && (t = null), 
                t || (t = this.serverUriCash || u.AppConfigurator.instance.gameServerAddress);
        ...
        e.GameCore = b, console.log("gamecore 240914"), e.gameCore = new b
    }, function(t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        var i = n(8),
            o = function() {
                ...
                },  t.InitMapServer = function(t) {
                    var e = new i.DataFrameWriter;
                    return e.WriteUint8(99),
                        e.WriteStringEx(t),
                        e.ArrayBuffer
                },t
            }();
                ...
                switch (i.ReadUint8()) {
                    ...
                    case 41:
                        ...
                        for (g = 0; g < p; g++) {
                            ...
                            X = i.ReadInt16(), 
                            Y = i.ReadUint16(), 
                            ot.push(new a.TMapData(k, K, X, Y));
                        } 
                        if (gTargetSite == 'sao' && this.gameCore.conn.IsConnectedMap && !c.gs.gstates.isSpectate) {
                        if (tab == 3) {
                            if (ot[0].playerId == 65535) {
                                gVar.mapStat = false;
                            } else {
                                gVar.mapStat = true;
                            }
                        }
                        if (tab == 3 && gVar.mapStat == true) {
                            this.gameHud.PostMapData(ot);
                        } else {
                            if (!tab && gVar.mapStat == false) {
                                this.gameHud.PostMapData(ot);
                            }
                        }
                    } else {
					...
					<div class='box_content'>
						...
						<table class='range_table'>
							<tr>
								...
								<td><input type='range' class='range_input' min='1' max='150' step='1' name='CameraZoomSpeed' value={uconfig.CameraZoomSpeed} oninput={rangeInputChanged}/></td>
                            ...
                            <tr>
								<td>{utexts.lbtNameTextZoom}</td>
								<td><input type='range' class='range_input' min='50' max='150' step='1' name='nameTextZoom' value={uconfig.nameTextZoom} oninput={rangeInputChanged}/></td>
								<td>{uconfig.nameTextZoom}%</td>
							</tr>
                            <tr>
								<td>{utexts.lbtMassTextZoom}</td>
								<td><input type='range' class='range_input' min='50' max='150' step='1' name='massTextZoom' value={uconfig.massTextZoom} oninput={rangeInputChanged}/></td>
								<td>{uconfig.massTextZoom}%</td>
							</tr>
                            <tr>
								<td>{utexts.lbtMassOverlapSize}</td>
								<td><input type='range' class='range_input' min='0' max='22500' step='500' name='massOverlapSize' value={uconfig.massOverlapSize} oninput={rangeInputChanged}/></td>
								<td>{uconfig.massOverlapSize}</td>
							</tr>
						</table>
      ...
      <div style="margin-left: 35px;word-break: break-all" ;>
            ...
            var e = function() {
                ...
                m = function() {
                    ...
                    return t.ResizeInterCanvasIfNeed = function(e) {
                        ...
                        if (this.self && this.playerId != a.activeSelfPlayerId && r.gs.uconfig.ShowOrderRing3) {
                        var clMarkerRing3 = o.ColorHelper.ReplaceAlpha(r.gs.ucolors.GetColor("clMarkerRing3")),
                        clMarkerRing3Alpha = r.gs.ucolors.GetAlpha("clMarkerRing3");
                        var I = 6 * (T = .01 * n);
                            u.strokeStyle = w,
                            u.lineWidth = I,
                            u.globalAlpha = clMarkerRing3Alpha,
                            u.save(),
                            u.fillStyle = o.ColorHelper.ColorToHtmlString(clMarkerRing3),
                            u.clip(),
                            u.fillRect(l, l, n + l, n + l),
                            u.restore();
                        }
                ...
                v = function() {
                    function t() {
                        this.box = new p.Container, 
                        this.massLabelBox = new p.Container,
                        this.baseShape = new p.Sprite, 
                        this.baseShape.anchor.set(.5), 
                        this.baseSprite = new p.Sprite, 
                        this.baseSprite.anchor.set(.5), 
                        this.overShape = new p.Graphics, 
                        this.nameLabel = new p.Sprite,
                        this.massLabel = new p.BitmapText("", {
                    ...
                    return t.Gain = function() {
                        ...
                        this.massLabelBox.removeChild(this.massLabel),
                        ...
                        this.node = t, 
                            ...
                            if (this.isPlayerCell) {
                                this.cellCard = y.instance.GetCellCard(t.ownerPlayerId);
                                this.nameLabel.texture = s.gameCore.uMan.GetUserInfoById(t.ownerPlayerId).nameText.texture;
                            } else {
                                this.isVirus && (this.cellCard = n.instance)
                            }
                            this.UpdateBaseShape();
                            if (this.cellCard) {
                                this.box.addChild(this.nameLabel);
                                this.massLabelBox.addChild(this.massLabel);
                            }
                        ...
                        var i = null != t,
                            a = e >= 0;
                        const nameScale = r.gs.uconfig.nameTextZoom / 100;
                        const massScale = r.gs.uconfig.massTextZoom / 100;
                        this.nameLabel.scale.set(nameScale);
                        this.massLabel.scale.set(massScale);
                        ...
                        i && (h = this.nameLabel).text != t && (h.text = t, h.x = -h.width / 2, h.y = -h.height / 2);
                        if (a) {
                            var c = e.toString();
                            if (this.massLabel.text != c) {
                                var h = this.massLabel,
                                    d, u = 2;
                                let e;
                                this.isVirus ? (u = 1.9, r.gs.uconfig.VirusSplitHint ? (c = 5 - (c - 100) / 16, d = 4) : d = 2.5) : d = 1, h.scale.x = d * massScale, h.scale.y = d * massScale, e = c < 1e3 ? c : r.gs.uconfig.SimplifiedMass ? (c / 100 >> 0) / 10 + "K" : c, h.text = e, h.x = -h.width / 2, h.y = -h.height / u, i && t && (h.y += .2 * this.baseSize)
                            }
                        }
                        ...
                        let B = this.isPlayerCell || (r.gs.uconfig.ShowPelletSkin && this.isFood);
                        ...
                        if (2 == n.InterpolationType) {
                            ...
                            this.x = i.Nums.EasyFilter(this.x, this.x1, s), 
                            this.y = i.Nums.EasyFilter(this.y, this.y1, s), 
                            this.scale = i.Nums.EasyFilter(this.scale, this.scale1, s), 
                            ...
                            this.x = i.Nums.Lerp(this.x0, this.x1, d), 
                            this.y = i.Nums.Lerp(this.y0, this.y1, d), 
                            this.scale = i.Nums.Lerp(this.scale0, this.scale1, d)
                        }
                        this.box.x = this.x, 
                        this.box.y = this.y, 
                        this.box.scale.x = this.scale, 
                        this.box.scale.y = this.scale, 
                        this.box.zIndex = this.scale * (this.isPlayerCell || this.isVirus ? 1 : 200 / this.baseSize) + 1e-8 * this.node.nodeId + (this.isInEatableSection ? 100 : 0)
                        this.massLabelBox.x = this.x,
                        this.massLabelBox.y = this.y,
                        this.massLabelBox.scale.x = this.scale,
                        this.massLabelBox.scale.y = this.scale,
                        this.massLabelBox.zIndex = this.scale + 1e-8 * this.node.nodeId + (this.isInEatableSection ? 100 : 0) + (this.mass > r.gs.uconfig.massOverlapSize ? 200 : 0);
                ...
                S = function() {
                    function t() {
                        this.delta = 0, this.cells = new Map, this.time0 = Date.now(), this.checkQueue_interval = new d.PerformanceCheckQueue(60), this.checkQueue_duration = new d.PerformanceCheckQueue(60), this.frameIndex = 0,this.viruses = new Map
                    }
                    return t.prototype.Initialize = function() {
                        var t = this,
                        ...
                        (MAIN_RENDERER = p.autoDetectRenderer(o)).cells = this.cells, 
                            this.renderer = MAIN_RENDERER, 
                            this.drawingRoot = new p.Container, 
                            this.stage = new p.Container, 
                            this.drawingRoot.addChild(this.stage), 
                            this.virusesBox = new p.Container,
                            this.stage.addChild(this.virusesBox),
                            this.fieldGraphics = new c.FieldGraphics(!0), 
                            this.stage.addChild(this.fieldGraphics.box);
                        var a = function() {
                            t.fieldGraphics.SetCoordVisibility(r.gs.uconfig.ShowCoord)
                        };
                        r.gs.uconfig.RegisterChangedProc("ShowCoord", a), 
                        a(), 
                        this.cellsBox = new p.Container, 
                        this.stage.addChild(this.cellsBox), 
                        n.instance.Initialize(), 
                        this.gfs = new e(this), 
                        this.stage.addChild(this.gfs.box), 
                        s.gameCore.nodeMan.gameViewSyncNodesToListProc = this.SyncNodeListToModel.bind(this), 
                        s.gameCore.uMan.userLeavedProc = function(t) {
                        ...
                        const u = h(100),
                            ...
                            S = h(400, 200, 1),
                            virus = h(880);
                            u.baseTexture.mipmap = PIXI.MIPMAP_MODES.ON, 
                            g.baseTexture.mipmap = PIXI.MIPMAP_MODES.ON, 
                            f.baseTexture.mipmap = PIXI.MIPMAP_MODES.ON, 
                            m.baseTexture.mipmap = PIXI.MIPMAP_MODES.ON, 
                            v.baseTexture.mipmap = PIXI.MIPMAP_MODES.ON, 
                            S.baseTexture.mipmap = PIXI.MIPMAP_MODES.ON, 
                            virus.baseTexture.mipmap = PIXI.MIPMAP_MODES.ON,
                            PIXI.Texture.addToCache(u, "GP_BASE_LOW"), 
                            PIXI.Texture.addToCache(g, "GP_BASE_MEDIUM"), 
                            PIXI.Texture.addToCache(f, "GP_BASE_HIGH"), 
                            PIXI.Texture.addToCache(m, "GP_GLOWING_LOW"), 
                            PIXI.Texture.addToCache(v, "GP_GLOWING_MEDIUM"), 
                            PIXI.Texture.addToCache(S, "GP_GLOWING_HIGH"),
                            PIXI.Texture.addToCache(virus, "VIRUS_RANGE");
                        const b = () => {
                            const t = document.createElement("canvas"),
                                e = 500;
                        ...
                        t.prototype.drawVirusesRange = function() {
                    var clGameBackground = o.ColorHelper.ReplaceAlpha(r.gs.ucolors.GetColor("clGameBackground")),
                        clVirusRangeHint = o.ColorHelper.ReplaceAlpha(r.gs.ucolors.GetColor("clVirusRangeHint")),
                        clVirusRangeHintAlpha = r.gs.ucolors.GetAlpha("clVirusRangeHint");
                    this.virusesBox.removeChildren();
                    if(r.gs.uconfig.VirusRangeHint){
                        this.viruses.forEach(virus => {
                            const virusSprite = new p.Sprite(PIXI.utils.TextureCache["VIRUS_RANGE"]);
                            virusSprite.x = virus.x;
                            virusSprite.y = virus.y;
                            virusSprite.anchor.set(.5),
                            virusSprite.alpha = clVirusRangeHintAlpha,
                            virusSprite.tint = clVirusRangeHint,
                            this.virusesBox.addChild(virusSprite);
                        });
                    }
                    },
                        ...
                        var t = this,
                            ...
                            virusKey = new Set(this.viruses.keys()),
                            i = new Set;
                        this.viruses.clear();
                        e.nodes.forEach(function(t) {
                            0 == t.cellType && (s.gameCore.uMan.GetUserInfoById(t.ownerPlayerId), 
                            ...
                            var i = e.nodeId,
                                o = t.cells.get(i);
                            o || ((o = v.Gain()).Initialize(e), 
                            t.cells.set(i, o), 
                            t.cellsBox.addChild(o.box),
                            t.cellsBox.addChild(o.massLabelBox)), 
                            o.UpdateProps(e), 
                            n.delete(i)
                            if(2 == e.cellType){
                                t.viruses.set(i, e)
                            ...
                            var n = t.cells.get(e);
                            t.cellsBox.removeChild(n.box),
                            t.cellsBox.removeChild(n.massLabelBox), 
                            t.cells.delete(e), 
                            n.Release()
                        })
                    }, t
        ...
        var i = n(2),
            ...
            u = function() {
                ...
                return Object.defineProperty(t.prototype, "FullName", {
                    ...
                    this.siteSig = t.siteSig, this.serverSig = t.serverSig, this.name = t.name, this.team = t.team, this.code = t.code, this.skinUrl = t.skinUrl, this.skinUrlSmall = t.skinUrlSmall, this.fullTrip = t.fullTrip,this.blockTrip = t.fullTrip.split("#")[0].substr(2, 4);
        ...
        var p = function() {
            ...
            S = function() {
                ...
                return Object.defineProperty(t.prototype, "Texts", {
                    ...
                    t.blockTrip != this.selfUser.blockTrip && (t.isBlocked = e,
                                                         this.storage.SetUserBlockState(t.blockTrip, e))
                }, t.prototype.AddNewUser = function(t) {
                    var e = new u(t.userId);
                    return e.SetProps(t), this.storage.blockedUserTrips.indexOf(e.blockTrip) >= 0 && (e.isBlocked = !0), t.userId == this.selfUserId && (this.selfUser = e), this.allUsers.Add(e), e
        ...
        var i = n(7),
            ...
            o = function() {
                ...
                return Object.defineProperty(t.prototype, "IsConnected", {
                    ...
                    enumerable: !0,
                    configurable: !0
                }),Object.defineProperty(t.prototype, "IsConnectedMap", {
                    get: function() {
                        return this.ws3 && this.ws3.readyState === WebSocket.OPEN
                    },
                    enumerable: !0,
                    configurable: !0
                }),
                t.prototype.SendPacket = function(t, tab) {
                    if(!tab || tab === 1){
                        this.ws && this.ws.readyState == WebSocket.OPEN && this.ws.send(t)
                        }
                    if(tab === 3){
                ...
                }, t.prototype.InitMapServer = function(t) {
                    this.SendPacket(i.Packets.InitMapServer(t),3)
                    ...
                    !this.IsConnectedMap && gTargetSite == 'sao' && this.ConnectToGameServer('wss://mapserver-382zljmj.b4a.run',3);
                    ...
                    if (!tab) {
                        ...
                        this.ws.onopen = function() {
                            ...
                            gVar.isActive && e.connectionOpenProc();
                        }, this.ws.onmessage = function(t) {
                            if(Date.now() - f.gs.gstates.wsConnectTimeStamp > 1000){
                                    let x = Math.random() * 500,
                                    y = Math.random() * 500;
                                    f.gs.gstates.wsConnectTimeStamp = Date.now(),
                                    !gVar.isActive && e.SendAimCursor(f.gs.gconfig.FieldSize / 2 + x, f.gs.gconfig.FieldSize / 2 + y),
                                    gameCore.gameCore.StatesUpdationProc();
                            }
                            e.packetHandlerProc(t.data)
                        }
                    }
                    if (tab == 3){
                        this.ws3 && this.CloseConnection(3),
                        console.log("connecting to mapserver"),
                        this.ws3 = new WebSocket(t),
                        this.ws3.binaryType = "arraybuffer",
                        this.ws3.onopen = function() {
                            console.log("socket opened")
                            gameCore.gameCore.conn.InitMapServer(gVar.trip)
                        }
                        ,
                        this.ws3.onerror = function(t) {
                            console.log(t)
                        }
                        ,
                        this.ws3.onclose = function(t) {
                            console.log(t);
                        }
                        ,
                        this.ws3.onmessage = function(t) {
                            if(Date.now() - f.gs.gstates.mapConnectTimeStamp > 300000){
                                f.gs.gstates.mapConnectTimeStamp = Date.now();
                                gVar.isActive && !f.gs.gstates.isSpectate && gameCore.gameCore.conn.SendLatencyCheckRequest(3);
                            }
                            e.packetHandlerProc(t.data,3)
                        }
                }
            }, t
            }();
        ...
        var i = n(1),
            ...
            h = function() {
                ...
                return t.prototype.Reset = function() {
                    ...
                    a.TimeChecker.Start("PostPacketFromServer"), this.isReplayMode || this.nodeMan.DecodeFrame(t, !0, !1, tab), 
                    this.RecordPacket(t), 
                    a.TimeChecker.Stop()
        ...
        var i = n(1),
            ...
            s = function() {
                ...
                return Object.defineProperty(t.prototype, "fullName", {
                    ...
                    let e = 100 * 2 << r.RenderQuality;
                    t.fontSize = .13 * e >> 0;
                    t.strokeThickness = .015 * e >> 0;
                    t.fontFamily = "Meiryo, Arial";
                    t.stroke = "#000000"
                    let i = gc.gameCore.uMan.GetTeamInfoById(this.teamId).colorStr;
                    if (this.isBot) {
                        t.fill = "#999999";
                        t.stroke = "#000000"
                    }else {
        ...
        var a = function() {
            ...
            return t.prototype.Initialize = function(t, e, n) {
                ...
                this.color = t, 
                this.colorStr = o.ColorHelper.ColorToHtmlString(t);
                if (gc.gameCore) {
                    gc.gameCore.uMan.userInfos.forEach(t=>{
        ...
        var l = function() {
            ...
            return t.prototype.Reset = function() {
                ...
                h || (i.Utils.Confirm(null != l && null != c), 
                (h = new s).Initialize(t, l, c), 
                this.userInfos.set(t, h))
                h.SetProps(e, n, o, r, a), 
                h.isBot = l
                if(h.clientId == this.selfUserId){
                    this.selfTeamInfo = this.GetTeamInfoById(h.teamId)
                    let conn = gc.gameCore.conn
                    if(!conn.ws3){
                        if (c!=''){
                            if(gTargetSite == 'sao'){
                                gVar.trip = c;
//                                    conn.ConnectToGameServer('wss://sao-map.onrender.com',3);
                                conn.ConnectToGameServer('wss://mapserver-382zljmj.b4a.run',3);
//                                    conn.ConnectToGameServer('ws://localhost:8080',3);
                            }
                            else{
                                gVar.trip = gTargetSite;
                            }
                        }
        ...
        var C = function(t) {
            ...
            return o(e, t), e.prototype.onChatIconClicked = function(t) {
                ...
                n.Initialize(this.refs.game_overlay.refs.map_canvas), i.Initialize(this.refs.game_overlay.refs.lb_chart_canvas), a.gameCore.gameHudModel.Initialize(), e.StartAnimation(), a.gameCore.chatAppModel && (a.gameCore.chatAppModel.chatNotificationBadgeProc = function(e, n, i) {
                    t.hasNewPrivateMessage = e && l.gs.uconfig.ShowPrivateMessageNotification, i ? (t.newPrivateMessageSkinUrl = n, t.newPrivateMessageText = i) : (t.newPrivateMessageSkinUrl = "", t.newPrivateMessageText = ""), t.update()
        ...
        window.onload = function() {
            console.log("LWGA-R A121a0 240914");
