...
// @grant        unsafeWindow
// @run-at        document-end
// @downloadURL https://update.greasyfork.org/scripts/483873/MHRoutineAM7.user.js
// @updateURL https://update.greasyfork.org/scripts/483873/MHRoutineAM7.meta.js
// ==/UserScript==
 
// when(time in 24 hours) and how long(hours) for taking rest.must be from large to small hour.
var restTimes = [ [ 20, 1 ], [ 7, 7 ], [ 1, 1 ] ];
