// ==UserScript==
// @name         SundayWebrySpider
// @namespace    https://www.sunday-webry.com/
// @version      0.2
// @description  Image spider for www.sunday-webry.com | V0.2 在序号1-9的图片文件名前加上前缀'0'
// @author       DD1969
// @match        https://www.sunday-webry.com/episode/*
// @match        https://www.sunday-webry.com/volume/*
// @match        https://www.sunday-webry.com/magazine/*
...
// @downloadURL https://update.greasyfork.org/scripts/435781/SundayWebrySpider.user.js
// @updateURL https://update.greasyfork.org/scripts/435781/SundayWebrySpider.meta.js
// ==/UserScript==
...
(async function (axios, JSZip, saveAs) {
  ...
  document.querySelector('.episode-header').innerHTML += `
    <div class="download-panel" style="display: flex; align-items: center; margin: 0 auto 24px auto; width: 980px;">
      ...
      <button id="dl-btn" style="padding: 1px; width: 100px; height: 26px; cursor: pointer; background-color: #eee; border: 1px solid #555; border-radius: 3px;">下载</button>
    </div>
  `;
