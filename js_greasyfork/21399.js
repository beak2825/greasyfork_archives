...
// @exclude             https://www.mturk.com/mturk/searchbar?selectedSearchType=hitgroups&searchWords=A9%20validate&minReward=0.00&qualifiedFor=on&x=7&y=11
// @include 		    https://www.mturk.com*farmer*
// @require             http://code.jquery.com/jquery-latest.min.js
// @downloadURL https://update.greasyfork.org/scripts/21399/%2AMulti%20Hoard%20Deluxe.user.js
// @updateURL https://update.greasyfork.org/scripts/21399/%2AMulti%20Hoard%20Deluxe.meta.js
// ==/UserScript==
...
function fork(){
var decision = true; //confirm('HITs gone. Continue reloading?');
if (decision == true) {
...
if (window.location.toString().indexOf("thclosers") != -1 && window.location.toString().indexOf("3XFOW6US4GF8LZYOTP6URUTYPLRF7N") == -1) {
    listen();
}
function listen(){   
