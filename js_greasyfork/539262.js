...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/539262/Cursor-Sheerid-Bypass.user.js
// @updateURL https://update.greasyfork.org/scripts/539262/Cursor-Sheerid-Bypass.meta.js
// ==/UserScript==
...
(function () {
    ...
    const modifyCountryParam = (url) => {
        ...
        if (urlObj.searchParams.has('country')) {
            urlObj.searchParams.set('country', 'TW');
