// ==UserScript==
// @name Cкрипт ЗГКФ || Purple (06)
// @namespace http://tampermonkey.net/
// @version 3.0 (Leha_Pon)
// @description Cкрипт для ЗГКФ - Leha_Pon 06 PURPLE
// @author Leha_Pon
...
// @license MIT
// @downloadURL
// @downloadURL https://update.greasyfork.org/scripts/556149/C%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%97%D0%93%D0%9A%D0%A4%20%7C%7C%20Purple%20%2806%29.user.js
// @updateURL https://update.greasyfork.org/scripts/556149/C%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%97%D0%93%D0%9A%D0%A4%20%7C%7C%20Purple%20%2806%29.meta.js
// ==/UserScript==
...
const TotleEnd = "[B][CENTER][COLOR=lavender]С уважением[/COLOR][COLOR=blue] Заместитель Главного Куратора Форума - Leha_Pon[/COLOR].<br><br>";
...
},
{
	  ...
	  TotlePhotoTxt1 +
		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как никнейм игрока указан неверно. <br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
		TotleEnd,
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  TotlePhotoTxt1 +
		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как заголовок написан неверно. <br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
		TotleEnd,
      prefix: UNACCСEPT_PREFIX,
...
"[B][CENTER][COLOR=white][FONT=courier new]Причиной послужило - Неправильное написание заголовка биографии. <br>"+
 ...
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=yellow]На доработке[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной послужило - Отсутствие фотографий и иные материалов(Несколько), относящихся к истории вашего персонажа. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]На внесение изменений дается 24 часа, в противном случаи Биография будет отказана<br><br>"+
               TotlePhotoTxt1 +
			TotleEnd,
...
},
{
 ...
 TotlePhotoTxt1 +
  ...
  {
    	  title: '| Ситуация отказ (граматика) |',
	  content:
	   		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Ситауция получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило 1.2. RP ситуация должна быть составлена грамотно, с соблюдением правил орфографии и пунктуации. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Ситуаций, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
  ...
  {
    	  title: '| Ситуация отказ (Не реалестично) |',
	  content:
	   		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Ситауция получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило 1.3. RP ситуация должна быть правдоподобной и реалистичной; в ней не должно быть сверхъестественных явлений. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Ситуаций, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
  ...
  {
    	  title: '| Ситуация отказ (Нет медиа) |',
	  content:
	   		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Ситауция получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило 1.4. RP ситуацию должны сопровождать скриншоты или видеоматериалы с места событий. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Ситуаций, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
  ...
  {
    	  title: '| Ситуация отказ (Заголовок) |',
	  content:
	   		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Ситауция получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило неправельное написание заголовка. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Ситуаций, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
  ...
  {
    	  title: '| Ситуация отказ (не читабельна) |',
	  content:
	   		"[B][CENTER][COLOR=#CCCCCC][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Ситауция получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило 1.9. RP ситуация должна быть читабельной. Минимальный размер шрифта — 15. Разрешенные шрифты: Verdana, Times New Roman. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Ситуаций, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
 ...
 TotlePhotoTxt1 +
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Ситауция получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Причиной отказа послужило: Ваша RP ситуация скопировна. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Убедительная просьба ознакомиться с правилами подачи Ситуаций, закрепленные в данном разделе.<br>"+
               TotlePhotoTxt1 +
			TotleEnd,
     prefix: UNACCСEPT_PREFIX,
