// ==UserScript==
// @name         Tetris (N3TWORK) Theme
// @namespace    http://tampermonkey.net/
// @version      0.5
// @description  Tetris (N3TWORK) Theme for Jstris
// @author       Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/411516/Tetris%20%28N3TWORK%29%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/411516/Tetris%20%28N3TWORK%29%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/EMtUZl1.png",100);
        loadGhostSkin("https://i.imgur.com/7IST2Vc.png",100);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/QzFOYX5.png)";
        document.body.style.backgroundSize="100% 100%";
        document.getElementById("app").style.backgroundColor="rgba(0, 0, 0, 0)";
        document.getElementById("app").style.height="1000px";
        document.getElementById("myCanvas").style.backgroundColor="rgba(12, 26, 73, 100)";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_HardDrop.wav",abs:1};
    ...
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_GameOver_Lose.wav",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Hold.wav",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Move.wav",abs:1,set:0};
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_TSpin.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_TSpin.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Clear1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_TSpin.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_TSpin.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Clear4.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_clear5.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_ClearAll.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_TSpin_B2B.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Clear4_B2B.wav"
];
...
Game['rotationSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Rotate_CCW.wav", //rotate left
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Rotate_CW.wav", //rotate right
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Rotate_CW.wav" //rotate 180°
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Music.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Music.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Music.wav"
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/Retro_Music.wav"
