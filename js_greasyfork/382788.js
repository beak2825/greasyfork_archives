...
// @grant          none
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/382788/Spacom%20Fast%20Map.user.js
// @updateURL https://update.greasyfork.org/scripts/382788/Spacom%20Fast%20Map.meta.js
// ==/UserScript==
...
//var kek_star = 'https://spacom.ru/image/star/f.png';
...
self.imageCanvas = new fabric.Text('*', {
                   left: (center.x)-8,
                        top: (center.y)-16,
...
if (this.turn == 2 && this.owner == 'pirate'){
this.image_color = "white";
}
if (this.turn == 1 && this.owner == 'pirate'){
this.image_color = "pink";
}
    ...
    Fleet.prototype.drawOn = function (canvas, target) {
        ...
        if (target === undefined)
            target = 'all';
        if (((target == 'all') || (target == 'image')) && ((this.garrison == "1") || (this.weight > 500 && (this.owner == "peace" || this.owner == "own")) || (this.owner == "other" || this.owner == "pirate"))) {
            if (this.image_state == false) {
                this.image_state = true;
                this.image_rendered = false;
                map.queueToRender++;
