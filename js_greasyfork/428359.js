...
// @author         Blaff (edited by luffydev)
...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/428359/JVChat%20Premium.user.js
// @updateURL https://update.greasyfork.org/scripts/428359/JVChat%20Premium.meta.js
// ==/UserScript==
...
.jvchat-night-mode #jvchat-leftbar-config-open, .jvchat-night-mode #jvchat-leftbar-reduce, .jvchat-night-mode #jvchat-leftbar-config-close{
    color: #fff!important;
}

#jvchat-leftbar-config-open, #jvchat-leftbar-reduce, #jvchat-leftbar-config-close{
    color: #212121!important;
}


.jvchat-night-mode #jvchat-topic-nb-connected, .jvchat-night-mode #jvchat-topic-nb-messages {
    color: #fff!important;
}
...
.jvchat-night-mode h4#jvchat-user-pseudo, .jvchat-night-mode h4.titre-info-fofo, .jvchat-night-mode #jvchat-turbo-span, .jvchat-night-mode .panel-jv-forum {
    color: #fff!important;
}

.jvchat-night-mode .jv-header-menu .jv-account-number-mp, .jvchat-night-mode .jv-header-menu .jv-account-number-notif {
    color: #fff !important;
}
