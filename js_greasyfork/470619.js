...
// @downloadURL https://update.greasyfork.org/scripts/470619/For%20guidance%20by%20Kokojambo.user.js
// @updateURL https://update.greasyfork.org/scripts/470619/For%20guidance%20by%20Kokojambo.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    
    {
        ...
        content:
        '[CENTER][/CENTER]' +
        	'[Color=LightSkyBlue][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
        '[Color=LightSkyBlue][CENTER][B]С уважением Главный Администратор сервера ORENBURG .[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
      ...
      '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
        "[COLOR=LightSkyBlue][CENTER][B]С уважением Главный Администратор сервера ORENBURG[/CENTER][/B][/COLOR]",
...
'[Color=white][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]'+
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
	"[CENTER][B][COLOR=LightSkyBlue]С уважением Главный Администратор сервера ORENBURG [/B][/CENTER][/COLOR]",
      prefix: PIN_PREFIX,
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
	...
	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
            '[Color=LightSkyBlue][CENTER][B]Закрыто.[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
        {
	...
	},
    {
        ...
        "[B][CENTER]Ваш аккаунт будет разблокирован на 24 часа, за это время вам необходимо изменить свой nickname. Доказательства прикрепить в данной теме.[/B][/CENTER]"+
        	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
        '[B][COLOR=LightSkyBlue][CENTER] С уважением Главный Администратор сервера ORENBURG [/B][/CENTER][/COLOR]',
        prifix: PIN_PREFIX,
        status: true,
    },
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
		'[Color=LightSkyBlue][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]',
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
	  ...
	  status: true,
	...
	},
       {
        ...
        '[CENTER][/CENTER]' +
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/rz26k9s9/Pics-Art-07-12-01-23-44.png[/img][/url][/CENTER]' +
        "[B][CENTER][COLOR=LightSkyBlue]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]<br><br>" +
		"[B][CENTER][Color=LightSkyBlue] Запрошу доказательства у [/color][/CENTER][/B]данного администратора.<br><br>" +
