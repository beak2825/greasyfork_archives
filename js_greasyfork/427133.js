...
// @version      0.1
// @description  over powered bloble hack
// @author       John Dave
...
// @downloadURL https://update.greasyfork.org/scripts/427133/op%20bloble%20hack.user.js
// @updateURL https://update.greasyfork.org/scripts/427133/op%20bloble%20hack.meta.js
// ==/UserScript==
 
//anti-kick
setInterval(function(){if(window.socket){window.socket.emit("2",window.camX,window.camY)}},20000000000000000000000000000000000000000000) 
...
function tema(){
darkColor = "#041d91",backgroundColor = "#010409",outerColor = "#000000",indicatorColor = "#041d9170",turretColor = "#ffffff90",bulletColor = "#a8a8a8",redColor = "#041d91",targetColor = "#a8a8a8"
}
tema();
...
instructionsList = "UltronScript V1".split(";");
