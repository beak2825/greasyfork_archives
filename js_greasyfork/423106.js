...
// @run-at      document-end
// @downloadURL https://update.greasyfork.org/scripts/423106/MangaDex%20Update%20Hider.user.js
// @updateURL https://update.greasyfork.org/scripts/423106/MangaDex%20Update%20Hider.meta.js
// ==/UserScript==
...
function addIcons() {
    ...
    for(const title of titles){
        title.parentElement.prepend(createBanIcon());
    }
}
...
function createBanIcon(){
    ...
    ban.style = "margin-right: 5px;"
    ban.onclick = () => {
        let temp = ban.nextElementSibling;
        let title = temp.nextElementSibling.title;
        hideMe(title);
