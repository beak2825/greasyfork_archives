...
// @downloadURL https://update.greasyfork.org/scripts/555873/FIX%20404%20genre.user.js
// @updateURL https://update.greasyfork.org/scripts/555873/FIX%20404%20genre.meta.js
// ==/UserScript==
...
(function() {
    ...
    const customGenres = {
        ...
        'Yuri': { ids: [34], ru: 'Юри', en: 'Yuri' },
        'Shoujo Ai': { ids: [26], ru: 'Сёдзё-ай', en: 'Shoujo Ai' },
        'Shounen Ai': { ids: [28], ru: 'Сёнен-ай', en: 'Shounen Ai' },
        'Yaoi': { ids: [33], ru: 'Яой', en: 'Yaoi' }
    };
