...
// @downloadURL https://update.greasyfork.org/scripts/428860/indefined%E7%9A%84%E8%84%9A%E6%9C%AC%E6%8E%92%E7%89%88%E4%BF%AE%E6%94%B9.user.js
// @updateURL https://update.greasyfork.org/scripts/428860/indefined%E7%9A%84%E8%84%9A%E6%9C%AC%E6%8E%92%E7%89%88%E4%BF%AE%E6%94%B9.meta.js
// ==/UserScript==
...
(function() {
    'use strict';
    GM_addStyle('.storey-title { margin:90px 0 0px ; }');
    GM_addStyle('#recommend .card-list>.zone-list-box.storey-box { width:80% !important ; margin-left:70px ; }');
    GM_addStyle('#recommend .storey-box, #ranking-all ul.rank-list{ height: calc(404px / 2 * 4 ) ; }');
    GM_addStyle('#recommend .video-card-common { width:25% ; height:33% ; padding:0.13333vw 0.13333vw ; margin-bottom:0px !important ; }');
    GM_addStyle('.video-card-common .card-pic { height:100% ; }');
    GM_addStyle('.video-card-common .title { font-size:16px ; height:60px ; margin:4px 0px 0px ; padding-right:0px ; }');
    GM_addStyle('.video-card-common .up { display:none }');
    GM_addStyle('.video-card-common .card-pic a .count { font-size:14px ; }');
    GM_addStyle('.btn.btn-change { font-size:14px ; width:100px !important; height:30px ; }');
})();