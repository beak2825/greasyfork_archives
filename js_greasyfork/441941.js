// ==UserScript==
// @name            MNDZONGLINETEST
// @namespace    http://tampermonkey.net/
// @version          1.3
// @description    mndzonglinetesttools
// @author       shenhua
// @match      https://zzx.ouchn.edu.cn/edu/public/student/*
// @icon         data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==
// @require      http://cdn.bootcss.com/jquery/1.8.3/jquery.min.js
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/441941/MNDZONGLINETEST.user.js
// @updateURL https://update.greasyfork.org/scripts/441941/MNDZONGLINETEST.meta.js
// ==/UserScript==
 ...
 */
  ...
  if(menIndex =="返回考试列表"||menIndex =="返回模拟考列表"){
    console.log("若模拟测试录题，请刷新网页后在8秒时间内保存试卷，方可完成录题！");

    setTimeout(function(){
      console.log($(".check").attr("style"));
      if($(".check").attr("style")!="display: none;"){
            ...
            if($(".subject").eq(i).text()==undefined){
                console.log("重新获取.......");
                  ...
                  if(len==3){
                      ...
                      if(opA.text().replace(/\s*/g,"").split("A.")[1]==undefined){
                      ...
                      if(opA.text().indexOf(da)!=-1){
                                ...
                                if(opB.text().replace(/\s*/g,"").split("B.")[1]==undefined){
                                      da = opB.text().replace(/\s*/g,"").split("B")[1];
                                }else{
                                    da = opB.text().replace(/\s*/g,"").split("B.")[1];
                                }
                      }else if(opC.text().indexOf(da)!=-1){
                                if(opC.text().replace(/\s*/g,"").split("C.")[1]==undefined){
                      ...
                      if(opA.text().indexOf(da)!=-1){
                                ...
                                if(opD.text().replace(/\s*/g,"").split("D.")[1]==undefined){
