...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/24394/R%C3%A9ponses%20pr%C3%A9d%C3%A9finies%20sur%20le%20profil.user.js
// @updateURL https://update.greasyfork.org/scripts/24394/R%C3%A9ponses%20pr%C3%A9d%C3%A9finies%20sur%20le%20profil.meta.js
// ==/UserScript==
...
(function() {
    ...
    if($('.member_view').length >= 1)
    {
        ...
        $('#staffButton').click(function(){
            $('textarea[placeholder="Ecrire quelque chose..."]').val("Bienvenue dans le staff "+ $('h1[itemprop="name"]').children().children().text() +" :love: ");
        });
    }
})();