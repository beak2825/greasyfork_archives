...
// @version      1.3.0.2
// @description  长江雨课堂网课自动化脚本 基于 scnu 华南师范大学 长江雨课堂 网课自动化脚本
// @author       sakuraiHisahiro
// @grant        GM_getValue
// @grant        GM_setValue
// @grant        unsafeWindow
// @match        https://zju.yuketang.cn/pro/*
// @run-at       document-end
// @license      MIT
// @require https://cdn.bootcss.com/jquery/1.10.2/jquery.min.js
// @downloadURL https://update.greasyfork.org/scripts/468171/ZJU%E3%80%8A%E5%88%9B%E4%B8%9A%E5%90%AF%E7%A8%8B%E3%80%8B%E9%95%BF%E6%B1%9F%E9%9B%A8%E8%AF%BE%E5%A0%82.user.js
// @updateURL https://update.greasyfork.org/scripts/468171/ZJU%E3%80%8A%E5%88%9B%E4%B8%9A%E5%90%AF%E7%A8%8B%E3%80%8B%E9%95%BF%E6%B1%9F%E9%9B%A8%E8%AF%BE%E5%A0%82.meta.js
// ==/UserScript==
...
(function () {
    ...
    window.onload = function () {
        ...
        const getElementInterval = setInterval(function () {
            ...
            if (elTooltipItemList) {
                for (let index = 0; index < elTooltipItemList.length; index++) {
                    // 寻找未完成
                    if (elTooltipItemList[index].innerText.indexOf('已完成') == -1) {
                        // 判断是否是习题
                        ...
                        // 判断是否是讨论
                        if (elTooltipItemList[index].innerText.indexOf('讨论') != -1){
                            continue;
                        }
                        // 判断是否是测试
                        if (elTooltipItemList[index].innerText.indexOf('测试') != -1){
                            continue;
                        }
                        // 判断是否是主观题
                        if (elTooltipItemList[index].innerText.indexOf('主观题') != -1){
                            continue;
                        }
                        // 判断是否已过学习时间
