...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/14778/Special%20Gym%20Ratios.user.js
// @updateURL https://update.greasyfork.org/scripts/14778/Special%20Gym%20Ratios.meta.js
// ==/UserScript==
...
jQuery.noConflict(true)(document).ready(function($) {
	...
	var getStats = function($doc) {
        ...
        $doc.find('h3:contains("Strength"), h3:contains("Defense"), h3:contains("Speed"), h3:contains("Dexterity")').each(function() {
            ...
            if (statName === "strength" || statName === "defense" || statName === "speed" || statName === "dexterity") {
