...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/424058/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.user.js
// @updateURL https://update.greasyfork.org/scripts/424058/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.meta.js
// ==/UserScript==
        ...
        onLoad() {
            ...
            this.waitFor(_=>this.token).then(_ => {
                ...
                if ( this.isElectron() || !this.isDefined(GM) ) {
                    ...
                    if (confirm('This Script Needs Updating by Krunker Extra, visit Krunker Extra On YouTube now?\n\nCancel will attempt to use the script anyway \n(CHANCE OF BAN)')) {
