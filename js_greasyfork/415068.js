...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/415068/jira%E6%97%A5%E5%BF%97%E8%AE%B0%E5%BD%95%E5%8A%9F%E8%83%BD%E5%A2%9E%E5%BC%BA.user.js
// @updateURL https://update.greasyfork.org/scripts/415068/jira%E6%97%A5%E5%BF%97%E8%AE%B0%E5%BD%95%E5%8A%9F%E8%83%BD%E5%A2%9E%E5%BC%BA.meta.js
// ==/UserScript==
...
(function() {
  ...
  const WORKLOGOBSTACLES = () => {return window.location.href.includes('UPGRADE')  ? []: ['一线给了错误信息','文档找不到或缺失','文档错误','流程不清晰','__SPACE__','环境特殊','内网','需搭建环境','__SPACE__','未到约定沟通日期','客户无响应','客户配合意愿较低','__SPACE__','未跟进','反复修改需求','难还原待复现','不知道找谁/找了进度慢'];};
...
//    if(!GM_config.get("localization")) return;
  ...
  window.isModuleExpert = function(){
    const MEList = ['Albert.Lu', 'Dolores', 'caster', 'Chenxing.Yu', 'Daisy.Zhang', 'Johnny.Xue', 'kaimi', 'Kivia', 'Larry', 'LeoYuan', 'Leslie.Zhang', 'Phyli.Zhou', 'XuYeqiang','Alyssa','Bob','Simple','limerence.c','Eric.Tian','Sunny.Zhou']
