// ==UserScript==
// @name         Localhost — DOM patcher (no toggle, final clean version)
// @namespace    http://tampermonkey.net/
// @version      1.4
// @description  Автоматично прилага всички текстови и HTML замени на localhost без бутон или интерфейс елементи.
// @match        https://winbet.bg/my-account/history/sport/settled*
// @run-at       document-end
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/554396/Localhost%20%E2%80%94%20DOM%20patcher%20%28no%20toggle%2C%20final%20clean%20version%29.user.js
// @updateURL https://update.greasyfork.org/scripts/554396/Localhost%20%E2%80%94%20DOM%20patcher%20%28no%20toggle%2C%20final%20clean%20version%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    function textEquals(el, target) {
        return el && el.textContent && el.textContent.trim() === target;
    }
