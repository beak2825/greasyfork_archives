...
// @connect      agar.io
// @downloadURL https://update.greasyfork.org/scripts/23400/ZR%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/23400/ZR%20Extension.meta.js
// ==/UserScript==
...
function inicio() {
    ...
    modificarTextoMinimapa("ZR");
    modificarTextoLeaderboard("ZR Extension");
    modificarCanalYoutube("Gamer_ZR", "UCmXb3Dbr21WHlRVePcmvXFg");
    modificarFooter("CLANZR.TEAMSPEAK.ME", "www.youtube.com/channel/UCmXb3Dbr21WHlRVePcmvXFg");
    panelDerecho();
    ocultarBotonAdelante();
    ocultarBotonAtras();
    redondearPanelCentral("20");
    redondearPanelDerecho("20");
    modificarMargenesPanel(20);
    redondearControles();
    colorPanelCentral("#8b0505");
    colorPanelDerecho("#feffff");
    colorTextoPestaña("#FF0013");
    colorPestañaActiva("#FBFF00");
 
    colorBotonPlay("#1565C0", "#1565C0");
    bordeBotonPlay("#1565C0", "#1565C0");
 
    colorBotonLoginAndPlay("#2E7D32", "#2E7D32");
    bordeBotonLoginAndPlay("#2E7D32", "#2E7D32");
 
    colorBotonLogout("#C62828", "#C62828");
    bordeBotonLogout("#C62828", "#C62828");
    ...
    colorBotonSpectate("#FF8F00", "#FF8F00");
    bordeBotonSpectate("#FF8F00", "#FF8F00");
 
    colorBotonCopy("#1565C0", "#1565C0");
    bordeBotonCopy("#1565C0", "#1565C0");
 
    colorBotonCreate("#2E7D32", "#2E7D32");
    bordeBotonCreate("#2E7D32", "#2E7D32");
 
    colorBotonJoin("#2E7D32", "#2E7D32");
    bordeBotonJoin("#2E7D32", "#2E7D32");
 
    colorBotonStreamMode("#C62828", "#C62828");
 
    colorBotonHideUrl("#C62828", "#C62828");
...
function modificarTextoMinimapa(titulo) {
    ...
    CanvasRenderingContext2D.prototype._fillText = function(){
        if(arguments[0] == 'ogario.ovh'){
            arguments[0] = titulo; // arguments[0] = 'ву ABO3TB ♔'; // Borra el texto transparente encima del minimapa
        }
