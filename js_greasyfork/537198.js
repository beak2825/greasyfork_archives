// ==UserScript==
// @name         he_config_manager_plus
// @namespace    http://tampermonkey.net/
// @version      1.0.2
// @description  HE配置管理工具页面增强
// @author       ren.wang@happyelements.com
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/537198/he_config_manager_plus.user.js
// @updateURL https://update.greasyfork.org/scripts/537198/he_config_manager_plus.meta.js
// ==/UserScript==
...
(function() {
  ...
  function initSuccess(appConfig, dataObj) {
    ...
    if (appConfig.app_name_prefix == "x001_tw") {
      ...
      // 不加devId
    }else if(appConfig.app_name_prefix == "SH01_out" || appConfig.app_name_prefix == "SH01_prod" || appConfig.app_name_prefix == "SH01_h5prod" || appConfig.app_name_prefix == "SH01") {
      if (appConfig.app_name_prefix == "SH01_h5prod") {
        devName = "SH01_dev";
      }else {
        devName = "SH01_dev";
      }
      ...
      if(appConfig.app_name_prefix == "SH01_out" || appConfig.app_name_prefix == "SH01_prod" || appConfig.app_name_prefix == "SH01_h5prod") {
