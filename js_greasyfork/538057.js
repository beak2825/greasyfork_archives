// ==UserScript==
// @name         Internet Roadtrip Permanent Radio - WMUAx
// @description  Overrides Internet Roadtrip radio with WMUAx(Online only).
...
// @icon         https://fastcast4u.com/player/dferre05/_user/cover/d/dferre05/ch0_permanent.jpg
// @downloadURL https://update.greasyfork.org/scripts/538057/Internet%20Roadtrip%20Permanent%20Radio%20-%20WMUAx.user.js
// @updateURL https://update.greasyfork.org/scripts/538057/Internet%20Roadtrip%20Permanent%20Radio%20-%20WMUAx.meta.js
// ==/UserScript==
...
// Check if we've shown the migration alert before
  ...
  warningText.innerHTML = `This version of Internet Roadtrip WMUAx Radio will no longer receive updates.<br><br>
  ...
  container.state.updateData = new Proxy(originalUpdateData, {
    apply: (target, thisArg, args) => {
      args[0].station = {
        name: "WMUAx",
        url: "https://usa17.fastcast4u.com/proxy/dferre05?mp=/1",
        distance: 0,
      };
