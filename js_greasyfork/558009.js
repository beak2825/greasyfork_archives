...
// @description         Скрипт с новогодним стилем, подходящий для всех серверов, предназначен для быстрой реакции кураторов форума в различных разделах. Также в скрипт встроен счётчик слов в РПБ.
