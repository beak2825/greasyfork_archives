// ==UserScript==
// @name         Black Magic
// @namespace    Black Magic
// @version      3.1.3
// @description  Unleash Agma.io with this extension - inofficial successor or Miracle Scripts!
// @author       Ventron
// @license      MIT
// @icon         https://abload.de/img/mh3k8o.png
// @match        *://agma.io/
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/397910/Black%20Magic.user.js
// @updateURL https://update.greasyfork.org/scripts/397910/Black%20Magic.meta.js
// ==/UserScript==
...
(function() {
  ...
  window.blackMagic = {
    ...
    init: function() {
      ...
      console.log('🔮 Black Magic successfully loaded!');
    },
    ...
    config: function() {
      ...
      var loadSettings = function (stringifiedSettings) {
        ...
        if (stringifiedSettings == null) {
          ...
          if (typeof settings.nameChangeDelay === 'undefined') {
            settings.nameChangeDelay = 1000;
            localStorage.setItem('miracleScripts', JSON.stringify(settings));
          }
      ...
      if (settings.installedVersion < this.getVersionAsInt()) {
        if (settings.installedVersion > 1) { // We do not want to inform new scripts user of past updates
          if (settings.installedVersion < this.getVersionAsInt('3.1.0')) {
             self.swal(
                'Black Magic Update',
                'New: Use the /skins command to open a super cool skin browser! It\'s much better than the built-in skin browser.');
          }
        }
      ...
      var applyPrimaryColor = function () {
        var primaryColorCss = '.magic-primary-color-font { color: ' + self.settings.primaryColor + ' !important } .magic-primary-color-background { background-color: ' + self.settings.primaryColor + ' !important }; ';
      ...
      setTimeout(function () {
        ...
        var $settingsButton = $('<button class="spec" style="width: 40px; margin-left: 7px; text-align: center; padding: 10px 0 20px 0" title="Black Magic Settings">🔮</button>');
        ...
        var deleteKey = function () {
          ...
          $('#magic-settings input[name=key_' + action + ']').val('undefined');
        ...
        var $modal = $('<div id="miracle-settings" class="magic-primary-color-font" style="position: fixed; width: 100%; height: 100%; overflow-y: auto; padding: 50px; background-color: rgba(0,0,0,0.95); z-index: 999; display: none"></div>');
        $modal.append('<h1>Black Magic Settings</h1>');
        ...
        $element = $('<a href="#" data-action="skin1" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        ...
        $element = $('<a href="#" data-action="skin2" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $firstRow.append($element);
        ...
        $element = $('<a href="#" data-action="skin3" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $firstRow.append($element);
        ...
        $element = $('<a href="#" data-action="skin4" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $firstRow.append($element);
        ...
        $element = $('<a href="#" data-action="skin5" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $firstRow.append($element);
        ...
        $element = $('<a href="#" data-action="skin6" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        ...
        $element = $('<a href="#" data-action="skin7" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $secRow.append($element);
        ...
        $element = $('<a href="#" data-action="skin8" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $secRow.append($element);
        ...
        $element = $('<a href="#" data-action="skin9" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $secRow.append($element);
        ...
        $element = $('<a href="#" data-action="animation" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        ...
        $element = $('<a href="#" data-action="paste" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $thirdRow.append($element);
        ...
        $element = $('<a href="#" data-action="dance" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $thirdRow.append($element);
        ...
        $element = $('<a href="#" data-action="chatLog" class="magic-primary-color-background" style="display: inline-block; padding: 3px 10px; color: white">✕</a>').click(deleteKey);
        $thirdRow.append($element);
        ...
        $modal.append($('<br><a href="#" class="magic-primary-color-background" style="display: inline-block; margin-top: 20px; padding: 10px; color: white">Close</a>').click(function () {
          $modal.hide();
        }));
        $modal.append($('<a href="#" class="magic-primary-color-background" style="display: inline-block; margin-left: 20px; margin-top: 20px; padding: 10px; color: white">Export settings</a>').click(function () {
          self.download('magic_settings.txt', localStorage.getItem('miracleScripts'));
        }));
        $modal.append($('<a href="#" class="magic-primary-color-background" style="display: inline-block; margin-left: 20px; margin-top: 20px; padding: 10px; color: white">Import settings</a>').click(function () {
        ...
        $modal.append($('<a href="http://agarioforums.net/showthread.php?tid=61388" target="_blank" class="magic-primary-color-background" style="display: inline-block; margin-left: 20px; margin-top: 20px; padding: 10px; color: white">Support</a>'));
        $modal.append($('<a href="#" class="magic-primary-color-background" style="display: inline-block; margin-left: 20px; margin-top: 20px; padding: 10px; color: white">Help</a>').click(function () {
          $modal.hide();
          self.$helpModal.show();
        }));
        ...
        window.addEventListener('magicCommand', function(commandEvent) {
          if (commandEvent.command === '/magicsettings' || commandEvent.command === '/magicconfig' || commandEvent.command === '/bmsettings') {
            $modal.show();
            $('#chtbox').val('');
          }
        });
    ...
    paste: function () {
      ...
      var css = '#magic-emojis .magic-emoji { display: inline-block; width: 40px; margin: 0 2px 2px 0; padding: 5px; border: 1px solid #333; font-size: ' + emojiFontSize + 'px; }\n' +
          '#magic-emojis .magic-emoji:hover { background-color: #FF69B4 }';

      var emojis = this.emojis.split(' ');
      var emojiCode = '';

      emojis.forEach(function (emoji) {
        emojiCode += '<a href="#" class="magic-emoji">' + emoji + '</a>';
      });

      var addEmoji = function () {
        setTimeout(function () {
          var $pasteInput = $(document).find('#magic-emojis input[name=paste]');
      ...
      var $modal = $('<div id="magic-emojis" class="magic-primary-color-font" style="position: fixed; width: 100%; height: 100%; padding: 50px; color: #FF69B4; background-color: rgba(0,0,0,0.95); overflow-y: auto; z-index: 999; display: none"></div>');
      ...
      $modal.append($('<br><a href="#" class="magic-primary-color-background" style="display: inline-block; margin-top: 20px; padding: 10px; color: white">Add</a>').click(addEmoji));
      $modal.append($('<a href="#" class="magic-primary-color-background" style="display: inline-block; float: right; margin-top: 20px; padding: 10px; color: white">Cancel</a>').click(function () {
        $modal.hide();
      }));
      ...
      $modal.click(function (event) {
        if (event.target.classList.contains('magic-emoji')) {
    ...
    chatLog: function () {
      ...
      CanvasRenderingContext2D.prototype.fillText = function () {
        if (this.canvas.id !== 'leaderboard' && this.canvas.height === 23) {
          ...
          if (typeof text === 'string' && (this.fillStyle === '#f5f6ce' || this.fillStyle === '#444444')) {
            ...
            if (!found) {
                var legit = text.indexOf(self.watermark) > -1 ? 'class="legit" title="🛡️ This seems to be a legit Black Magic message"' : '';
      ...
      var performSearch = function (searchElement) {
        ...
        $('#magic-complete-chatlog div').each(function () {
          var $entry = $(this);
      ...
      var $modal = $('<div id="magic-chatlog" class="magic-primary-color-font" style="position: fixed; width: 100%; height: 100%; padding: 50px; color: #FF69B4; background-color: rgba(0,0,0,0.95); user-select: text; overflow-y: auto; z-index: 999; display: none"></div>');
      $modal.append('<style>#magic-complete-chatlog div:hover { background-color: rgba(255,255,255,0.1) } #magic-complete-chatlog .time { padding-right: 10px; color: #666; } #magic-complete-chatlog div.legit { font-style: italic }</style>');
      $modal.append('<h1>Complete Chat Log</h1><br>');
      $modal.append('<div id="magic-complete-chatlog"></div>');
      ...
      $('#magic-complete-chatlog').dblclick(function (event) {
        var $clickTarget;
      ...
      var showChatlog = function() {
        $('#magic-complete-chatlog').html(chatLogCode);
        $modal.toggle();
    ...
    performDance: function () {
      var self = this ? this : window.blackMagic;
    ...
    fpsPing: function () {
      ...
      window.addEventListener('magicCommand', function(commandEvent) {
        ...
        if (commandEvent.command === 'fps' || commandEvent.command === '/fps') {
          ...
          $('#chtbox').val('has ' + fps + ' frames per second (fps). ' + fpsRating + self.watermark).focus();
        }
      });
    },
    ...
    skinApplier: function() {
      ...
      skinBrowser: function() {
          var self = this;

          var $modal = $('<div class="magic-primary-color-font" style="position: fixed; width: 100%; height: 100%; padding: 50px; background-color: rgba(0,0,0,0.95); z-index: 999; overflow-y: auto; display: none"></div>');
          $modal.append('<h1 style="margin-bottom: 50px">Skin Browser</h1>');

          $modal.append($('<a href="#" class="magic-primary-color-background" title="Close" style="position: fixed; display: inline-block;  width: 40px; right: 50px; top: 50px; padding: 15px; outline: 10px solid black; line-height: 10px; color: white">✕</a>').click(function () {
              $modal.hide();
          }));

          var $skins = $('<div id="magic-skin-browser">');
          $modal.append($skins);

          $modal.append('<style>#magic-skin-browser img { width: 128px; height: 128px; margin: 10px; padding: 3px; border-radius: 100%; cursor: pointer; transition: opacity 1s ease-out; } #magic-skin-browser img:hover { box-shadow: 0 0 20px #FF0000; filter: brightness(150%); }</style>');

          $('body').append($modal);

          $skins.click(function() {
              if (event.target.src) {
                  var skinUri = event.target.src;
                  var id = parseInt(skinUri.substr(skinUri.indexOf('skins/') + 6));
                  self.useSkin(id);
                  $modal.hide();
              }
          });
        ...
        var maxId;
          ...
          var loadSkins = function(limit, animate) {
              for (var id = maxId; id < maxId + limit; id++) {
                  $skins.append('<img src="https://agma.io/skins/' + id + '_lo.png" title="ID: ' + id + '" onerror="this.style.display=\'none\'">');
              }
              maxId = id;
          }
        ...
        $modal.scroll(function(event)
        {
            ...
            if (scrollTop + window.innerHeight >= $skins.height() + $skins.get(0).offsetTop) {
                loadSkins(30);
            }
        });
          ...
          window.addEventListener('magicCommand', function(commandEvent) {
              if (commandEvent.command === '/skins' || commandEvent.command === '/skinbrowser' || commandEvent.command === '/browser') {
                  $('#chtbox').val('');
                  $skins.html('');
    ...
    help: function() {
      var $modal = $('<div class="magic-primary-color-font" style="position: fixed; width: 100%; height: 100%; padding: 50px; background-color: rgba(0,0,0,0.95); z-index: 999; display: none"></div>');
      $modal.append('<h1>Black Magic Help</h1>');

      var helpText = '<br><span style="color: #717171">Available chat commands are: </span><br><br><table>' +
          '<tr><th style="padding-right: 70px"><i>Command</i></th><th><i>Description</i></th></tr>' +
          '<tr><td><code>/help</code></td><td>Show this help</td></tr>' +
          '<tr><td><code>/magic</code></td><td>Show version info</td></tr>' +
          '<tr><td><code>/magicsettings</code></td><td>Show the black magic settings page</td></tr>' +
          '<tr><td><code>/skins</code></td><td>Open skin browser that shows all skins</td></tr>' +
          '<tr><td><code>/skin<n></code></td><td>Change to skin &lt;n></td></tr>' +
          '<tr><td><code>/skin<n> this</code></td><td>Store current skin as skin <n></td></tr>' +
          '<tr><td><code>/skin<n> &lt;id></code></td><td>Store skin with ID &lt;id> as skin &lt;n></td></tr>' +
          ...
          '<tr><td><code>/say&lt;n> &lt;text></code></td><td>Send chat message with fancy font number &lt;n></td></tr>' +
    ...
    commands: function () {
      ...
      $('#chtbox').keydown(function (event) {
        if (event.keyCode === 13) {
          ...
          if (command === '/magic' || command === '/bm' || command === '/blackmagic') {
            var miracleInfo =  'is using 𝘉𝘭𝘢𝘤𝘬 𝘔𝘢𝘨𝘪𝘤, version ';
            ...
            $('#chtbox').val(miracleInfo + self.watermark).focus();
          }
          ...
          if (command === '/powerups' || command === '/powers') {
            ...
            var powerups = ($('#invRecombine p').text() || 0) + ' rec, ' +
                ...
                ($('#invSpawnMothercell p').text() || ($('#invSpawnMothercell').css('display') === 'none' ? 0 : 1)) + ' red virus, ' +
          ...
          var commandEvent = new Event('magicCommand');
    ...
    swal: function (title, message, html) {
      ...
      window.swal({
        title: '📢 <span class="magic-primary-color-font">' + title + '</span>',
        text: message,
        html: html
      });
    },
