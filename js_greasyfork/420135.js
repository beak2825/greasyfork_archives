...
// @downloadURL https://update.greasyfork.org/scripts/420135/GRCT%20kein%20Silber.user.js
// @updateURL https://update.greasyfork.org/scripts/420135/GRCT%20kein%20Silber.meta.js
// ==/UserScript==
        ...
        e.iron, e.power = -1 < k.url.indexOf("decrease_build_time_with_favor") ? 400 : 0, RepConv.Debug && console.log(e)), $.each(Layout.wnd.getAllOpen(), function(g, u) {
          ...
          switch(g.getController()) {
            ...
            case "wonders":
              ...
              try {
                RepConv.settings[RepConv.Cookie + "_wonder_trade"] && 0 < u && (WorldWonders.spinners.wood.setValue(u / 2), WorldWonders.spinners.stone.setValue(u / 2));
              } catch (D) {
              }
              Va(g);
              break;
