...
// @downloadURL https://update.greasyfork.org/scripts/21774/WME%20URComments%20India%20English%20List.user.js
// @updateURL https://update.greasyfork.org/scripts/21774/WME%20URComments%20India%20English%20List.meta.js
// ==/UserScript==
...
if (UrcommentsIndiaEnglishUpdateMessage === "yes") {
    if (localStorage.getItem('UrcommentsIndiaEnglishVersion') !== UrcommentsIndiaEnglishVersion) {
        alert(UrcommentsIndiaEnglishVersionUpdateNotes);
...
window.UrcommentsIndiaEnglishURC_URL[8] = "https://docs.google.com/presentation/d/1zwdKAejRbnkUll5YBfFNrlI2I3Owmb5XDIbRAf47TVU";
...
window.UrcommentsIndiaEnglishURC_USER_PROMPT[2] = "List can not be found-you can find the list and instructions at https://wiki.waze.com/wiki/Scripts/URComments";
...
"Close without reply",
"No further information was received and the request is being closed. As you travel, keep on reporting any map issue you encounter to make the map better.\r\rWiki Waze India: https://wiki.waze.com/wiki/India",
"NotIdentified",

"Close Missing Road", 
"We tried to add as many missing roads as we could, but it is not always possible to identify them correctly from satellite imagery. The good news is that you can add new roads yourself while driving over them: \rTap the orange button > Map Issue > Pave. \rStart driving. \rOnce done, tap the Map Issue icon at the left of the screen > Stop. \rYou can provide information about the new road -such as it's name- by reporting another Map Issue.  Thanks!\r\rWiki Waze India: https://wiki.waze.com/wiki/India",
"NotIdentified",
...
"The problem is solved. The changes should reach your device within a few days (check the 'INTL map tiles' at status.waze.com).\r\rThank you for your help improving the map. As you travel, keep on reporting any map issue you encounter to make the map better.\r\rWiki Waze India: https://wiki.waze.com/wiki/India",
"Solved",

"Solved adding road",
"We added a road to the location of your report. The changes should reach your device within a few days (check the “INTL map tiles” at status.waze.com). Thank you for your help improving the map!\r\rDid you know that you can add roads yourself from the app? \rTap the orange button > Map Issue > Pave. \rStart driving. \rOnce done, tap the Map Issue icon at the left of the screen > Stop. \rYou can provide information about the new road -such as it's name- by reporting another Map Issue.\r\rOf course, keep on reporting any map issue you encounter to make the map better. Thank you!\r\rWiki Waze India: https://wiki.waze.com/wiki/India",
"Solved",

"Solved adding Place",
"Thanks for your report. We added the place. The changes should reach your device within a few days (check the “INTL map tiles” at status.waze.com).\r\rNext time, you can also add a missing place at your drive by tapping the orange button > Place. If you add a photo, make sure it won’t contain any personal information. Thanks in advance!\r\rWiki Waze India: https://wiki.waze.com/wiki/India",
"Solved",

"Solved adding Speed Limit",
"We added the speed limit according to your report. The update should reach your device within a few days (check the “INTL map tiles” at status.waze.com).\r\rBecause of the lack of street view, we don't know where the speed limit changes. You would help us a lot if you can report these at the exact location of the change by reporting a map issue:\rTap the orange button > Map Issue > General Error\rIf possible, write down if it is the start or the end of the speed limit\rThank you for your help improving the map!\r\rWiki Waze India: https://wiki.waze.com/wiki/India\r\r",
"Solved",

"Train",
"Thanks for your report! Apparently, you are using Waze on the train. We added a rail road here, but please be aware that Waze is meant for car drivers. Using it on public transport will contaminate the data, which in turn decreases the accuracy for drivers. Waze-drivers will be grateful if you don't use Waze on the train. Thank you. \r\rWiki Waze India: https://wiki.waze.com/wiki/India",
"NotIdentified",

"Keep map simple",
"Thanks for your report! Please be aware that Waze is meant for car drivers. All features not necessary for driving will make map maintenance more complex and data usage larger. Therefore, we try to keep the map simple and effective. Thank you. \r\rWiki Waze India: https://wiki.waze.com/wiki/India",
"NotIdentified",
...
"SL Speedometer",
"If you would like to have the current speed limit displayed at all times, please go to Settings > Speedometer > Show speed limit.\rOf course, keep on reporting any map issue you encounter to make the map better. Thank you!\r\rWiki Waze India: wiki.waze.com/wiki/India",
"NotIdentified",

"Add Camera",
"Thanks for your report! You can add a camera from the app. Use Report > Camera, and choose Speed, Red Light or Fake. Editors will then approve it. Of course, keep on reporting any map issue you encounter to make the map better. Thank you!\r\rWiki Waze India: https://wiki.waze.com/wiki/India",
"NotIdentified",
...
"To get an updated result, remove the location from your navigation history and favorites (click the 3 dots on the right, see bit.ly/delWazehis). Then search for the location again.\r\rWe will leave this report open for a while if you need further help.",
"Open",
...
"App Bug",
"Unfortunately, this seems to be a bug of the app and we editors cannot help. Please send logs and report this to Waze directly, see support.google.com/waze/answer/6270063?hl=en&ref_topic=6262587. \r\rWe will leave this report open for a while in case you have further questions.",
"Open",

"Max routing distance",
"The search and navigation capabilities of Waze are limited to about 1000-1500 km, depending on the road network and map quality. When the route to your destination yields an error, you can split up your travel, and choose one or more stops in between. More info: wiki.waze.com/wiki/Problems,_bugs_and_limitations \r\rHappy travels and keep on Wazing!\r\rWiki Waze India: wiki.waze.com/wiki/India",
"NotIdentified",

"Detours / Odd-Routing",
"Thank you for your report! We can't find anything on the map to explain the route Waze gave you. Waze routes (sometimes complex) detours to save time. Try the suggested route a few times, it may be faster. If not, Waze learns that this route is slower, and the faster route will become preferred. Of course, keep on reporting any problem you encounter to make the map better.\r\rWiki Waze India: wiki.waze.com/wiki/India",
"NotIdentified",

"Valid Route",
"Thanks for your report! We reviewed the issue and did not find any map errors. It looks like Waze provided you with a valid route. Try the suggested route a few times, as it may be faster. If not, Waze learns that this route is slower, and the faster route will become preferred. Of course, keep on reporting any problem you encounter to make the map better.\r\rWiki Waze India: wiki.waze.com/wiki/India",
"NotIdentified",

"Bad GPS",
"Thanks for your report! Probably your device was having GPS trouble. GPS signals do not travel through vehicles or tall buildings. Please make sure your device is somewhere with a clear view of the sky. To be sure, you may test your device with a GPS app. As we cannot provide further help in this case, we will close the report. Of course, keep on reporting any problem you encounter to make the map better.\r\rWiki Waze India: wiki.waze.com/wiki/India",
"NotIdentified",
