...
// @version      0.1.3
// @description  LinkedIn - Perpetually Growing NETwork - Stable
// @author       TH
// @include      https://www.linkedin.com/*
// @grant        GM_setValue
// @grant        GM_getValue
// @require      https://code.jquery.com/jquery-3.3.1.min.js
// @downloadURL https://update.greasyfork.org/scripts/367988/L_PGNET_LST.user.js
// @updateURL https://update.greasyfork.org/scripts/367988/L_PGNET_LST.meta.js
// ==/UserScript==

let prefix = 'L_PGNET_LST > ';
...
jQuery( document ).ready(function( $ ) {
    ...
    let start_button = $('<button class="pgnet-btn feed-follows-module-recommendation__follow-btn button-secondary-small-muted ml2 follow ember-view"><span class="">⌹ ►</span> L_PGNET_LST</button>').appendTo('.application-outlet');
    start_button.css('position','fixed')
    start_button.css('bottom','10px')
    start_button.css('left','10px')
    start_button.css('width', '200px')

    start_button.click(function(e){
        console.log(prefix + 'Asking for a go')
        setTimeout(function(){
            window.location = 'https://www.linkedin.com/mynetwork/?pgnet=true'
        },1000)
    })
    ...
    function addFilteredUsers() {
        console.log(prefix + 'Looking for new invitations to send')
