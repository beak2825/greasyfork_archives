// ==UserScript==
// @name         Premium Blooket Gui
// @namespace    https://github.com/05Konz/Blooket-Cheats/tree/main
// @version      2.3
// @description  Version 2.3: Updated, its not patched anymore (I AM WORKING ON THE BAN DEFLECT DO NOT USE THIS ON YOUR MAIN ACCOUNT!!!)
// @author       Austin Skeeber
// @match        *://*.blooket.com/*
// @match        *://blooket.com/*
...
// @run-at       document-end
// @license      Rylan
// @source       https://github.com/05Konz/Blooket-Cheats/blob/main/cheats/gui.js
// @downloadURL https://update.greasyfork.org/scripts/528147/Premium%20Blooket%20Gui.user.js
// @updateURL https://update.greasyfork.org/scripts/528147/Premium%20Blooket%20Gui.meta.js
// ==/UserScript==
...
(async () => {
    ...
    let p,
        ...
        _ = l("div", {
            ...
            innerHTML: "Too good - Rylan Rude",
            onclick: () => window.open("https://github.com/Rylan-Rude/blooketcheatsplus", "_blank").focus()
        }), $ = l("div", {
            id: "controlButtons",
            style: {
                display: "flex",
        ...
        credits: [{
            element: l("div", {
                ...
                const creditsList = [{
                    ...
                    name: "Thatoneguy54321",
                    description: "Co-Founder of Blooket Cheats Plus and updates old versions"
                }, {
                    name: "Minesraft2",
