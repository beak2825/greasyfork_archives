// ==UserScript==
// @name     全网vip视频解析
// @namespace  http://118.24.85.50/
// @version    1.2
// @description  一键破解[优酷|腾讯|乐视|爱奇艺|芒果|AB站|音悦台]等VIP或会员视频，解析接口。
// @author     novip
...
// @grant    GM_openInTab
// @grant    GM.openInTab
// @downloadURL https://update.greasyfork.org/scripts/376216/%E5%85%A8%E7%BD%91vip%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/376216/%E5%85%A8%E7%BD%91vip%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
...
(() => {
  ...
  GMaddStyle(`
    ...
    /*TMHYIframe*/
    #TMHYul{position:fixed;top:7em;left:0;padding:0;z-index:999999;}
    #TMHYul li{list-style:none;}
    #TMHYul svg{float:right;}
    .TM1{opacity:0.3;position:relative;padding-right:.5em;width:2.5em;cursor:pointer;}
    .TM1:hover{opacity:1;}
    .TM1 span{display:block;background-color:#ffff00;border:0;font:bold 1.6em "微软雅黑"!important;color:#ff0000;margin:0;padding:1em .3em;}
    .TM3{position:absolute;top:0;left:2.5em;display:none;}
    .TM3 li{float:none;width:6em;margin:0;font-size:1.2em;padding:.15em 1em;cursor:pointer;color:#3a3a3a!important;background:rgba(255,255,0,0.8);}
  ...
  var defaultapi = {
    title: "novip",
    url: "http://118.24.85.50/vip/?url="
  };
  //apis name:显示的文字  url:接口  title:提示文字  intab:是否适合内嵌(嵌入判断:GMgetValue("replaceRaw",false)值||intab值)
  var apis =[
    {name:"novip"+VQQIcon,url:"http://118.24.85.50/vip/?url=",title:"转圈圈就换线路",intab:0},
    {name:"百域阁"+VQQIcon,url:"http://app.baiyug.cn:2019/vip/?url=",title:"转圈圈就换线路",intab:0},
    {name:"搜你妹"+YoukuIcon,url:"http://www.sonimei.cn/?url=",title:"综合接口",intab:0},
    {name:"玩的嗨"+YoukuIcon,url:"http://tv.wandhi.com/go.html?url=",title:"综合接口",intab:0},
    {name:"leutv"+VQQIcon,url:"https://vip.leutv.cn/leutv/?url=",title:"支持腾讯",intab:0},
    {name:"人人发布"+VQQIcon,url:"http://v.renrenfabu.com/jiexi.php?url=",title:"综合，多线路",intab:0}
  ];
  //嵌入页面播放
  ...
  div.innerHTML = `
    <ul id="TMHYul">
      ...
      <li class="TM1"><span id="TMSet">㊖</span><ul class="TM3"><img src="https://vip-1253375638.cos.ap-guangzhou.myqcloud.com/hongbao.jpg" alt="" class="icon_vip_pic"></ul></li>
    </ul>
  `;
...
// 资源参考https://greasyfork.org/zh-CN/users/104201-%E9%BB%84%E7%9B%90
