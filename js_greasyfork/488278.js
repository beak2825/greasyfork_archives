// ==UserScript==
// @name         EVGKas for Cur/Zga/GA | Modded
// @namespace    https://forum.blackrussia.online/
// @version      1.3
// @description  Специально для BlackRussia || Tula by EVGKas
// @author       EVGKas 
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @match        https://forum.blackrussia.online/forums/*
// @include      https://forum.blackrussia.online/forums/
// @match        https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9651-tula.2263/
// @include      https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9651-tula.2263/
// @icon         https://i.postimg.cc/RCD81tZ2/1518863898-igra-hard-party.jpg
// @grant        none
// @license      MIT
// @supportURL   https://vk.com/johnydash
// @downloadURL https://update.greasyfork.org/scripts/488278/EVGKas%20for%20CurZgaGA%20%7C%20Modded.user.js
// @updateURL https://update.greasyfork.org/scripts/488278/EVGKas%20for%20CurZgaGA%20%7C%20Modded.meta.js
// ==/UserScript==
...
(async function () {
    ...
    //  },
     /*{
      ...
      `[CENTER]Обратитесь в раздел обжалований: [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.2291/']*ТЫК*[/URL]![/CENTER]<br><br>` +
	...
	},*/
    {
        ...
        content:
            ...
            `[CENTER]Пожалуйста обратитесь в раздел - [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.2291/']Обжалование (кликабельно)[/URL]<br>`+
    ...
    //     `Приносим свои извинения за предоставленные неудобства.Наказание будет снято в течении часа.[/CENTER]<br><br>` +
	// 	`[CENTER][COLOR=rgb(255, 0, 0)]Закрыто.[/COLOR][/CENTER]<br>`,
	//   prefix: ACCEPT_PREFIX,
	//   status: false,
	// },
    ...
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора ГОСС/ОПГ  —  [user=714306]Oskar_Moreno[/user]<br><br>`+
	...
	},
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Основному Заместителю Главного Администратора —  [user=872772]Clifford_Arankay[/user] <br><br>`+
        `[COLOR=rgb(251, 160, 38)]На рассмотрении.[/COLOR][/CENTER]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
	...
	//   content:
	// 	`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
    //     `[CENTER]Передаю вашу жалобу Главному Администратору —  [user=139947]Rodrigo_Osuna[/user] <br><br>`+
    //     `[COLOR=rgb(251, 160, 38)]На рассмотрении.[/COLOR][/CENTER]<br>`,
    //   prefix: GA_PREFIX,
	//   status: true,
	// },
    ...
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю ваше обжалование Главному Администратору —  [user=139947]Rodrigo Osuna[/user] <br><br>`+
        `[COLOR=rgb(251, 160, 38)]На рассмотрении.[/COLOR][/CENTER]<br>`,
      prefix: GA_PREFIX,
	  status: true,
    },
    ...
    const buttons3 = [
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
                `[CENTER]Передаю вашу жалобу Главному Администратору —  [user=139947]Rodrigo Osuna[/user] <br><br>`+
                `[COLOR=rgb(251, 160, 38)]На рассмотрении.[/COLOR][/CENTER]<br>`,
            prefix: GA_PREFIX,
            status: true,
        },
    ...
    $(document).ready(() => {
        ...
        addButton(`Специальному`, `specialAdmin`);
