...
// @version        2023.05.15.1
// @downloadURL https://update.greasyfork.org/scripts/520623/WoD%20%E4%BA%BA%E7%89%A9%E5%8D%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/520623/WoD%20%E4%BA%BA%E7%89%A9%E5%8D%A1.meta.js
// ==/UserScript==
...
var WoDTool = {
	...
	getAttr : function ( context ) {
		...
		WoDTool.walker( 'form > table:nth-of-type(2) tbody tr > td:nth-of-type(3) table.content_table td', function ( td ) {
			var skill = [];
			if ( td.childNodes[1] && td.childNodes[1].innerHTML) {
...
(function () {
    ...
    function () {
      ...
      WoDTool.loadHeroAll().done(function () {
        ...
        var rows = Math.ceil(
          (WoDTool.attrs.length + WoDTool.skills.length) / 2
        );
        ...
        navigator.clipboard
          .writeText(output.replaceAll("<br />", "\n"))
          .then(() => {
            alert("人物卡已复制到剪贴板");
          })
          .catch((err) => {
            alert("不能复制人物卡到剪贴板，可能未授予剪贴板权限，请手动复制");
