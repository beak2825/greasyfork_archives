...
// @match        http://gota.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/36851/SW%27X%20TOOL%20By%20Rkw.user.js
// @updateURL https://update.greasyfork.org/scripts/36851/SW%27X%20TOOL%20By%20Rkw.meta.js
// ==/UserScript==
 
//para SW :v
 
! function(c) {
    var host = "agar.io"; // anti moneyclip xd
    if (location.host == host) {
        location.href = "http://dual-agar.online/";
        return;
    }
    ...
    c("#pelletColorGroup").append("<input id='lbh' style='width: 300px;margin-top: 20px;height: 30px;' placeholder='Change leaderboard title'></input>");
    function isWriting() {
    ...
    function RegExpT2() {
        var t = c(values.ldb).text(),
            i = isWriting();
        t = t.replace(/(?:(?:[0-9]*)\D)+/g, i); // actually i think it doesn't do anything xd
        c(values.ldb).html(t);
    }
    ...
    function ThTab() {
        if (c("#tab_theme").text().indexOf() !== "THEMES") {
