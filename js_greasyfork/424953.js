...
// @version      2.62
// @description  新点软件公共安全条线设计评审外附工具
// @author       deming
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/424953/SE-%E8%AE%BE%E8%AE%A1%E8%AF%84%E5%AE%A1%E5%B7%A5%E5%85%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/424953/SE-%E8%AE%BE%E8%AE%A1%E8%AF%84%E5%AE%A1%E5%B7%A5%E5%85%B7.meta.js
// ==/UserScript==
...
(function () {
    ...
    //#region 需求流程处理页面
    if (window_url.indexOf("https://oa.epoint.com.cn/productrelease/cpzt/demandmanage/demandbasicinfo_detail?") != -1 || window_url.indexOf("https://oa.epoint.com.cn/productrelease/cpzt/demandmanagezw/demandbasicinfo_detail?") != -1 || window_url.indexOf("https://oa.epoint.com.cn/productrelease/cpzt/demandmanagezw/demandbasicinfonew_detail?") != -1) {
        // 需求信息
                    ...
                    if (data.success) {
                        ...
                        if (data.custom.hasSigned == "0") {
                            signBtn = createBtn("签收", function () {
                                loadDemandInfo();
                                request.post(DEMAND_DESIGN_INFO, {demandDTO: JSON.stringify(demandInfo)}, function () {
                                    if (data.success) {
                                        loadBtn();
                                        epoint.showTips("签收成功!");
                                    }
                                })
                            });
                        ...
                        if (data.custom.hasPlaned == "1") {
                            ...
                            planBtn = createFeedbackBtn('设计安排', 'sjap');
                            planBtn.render(domToolBar);
                        }
                    }
                }
