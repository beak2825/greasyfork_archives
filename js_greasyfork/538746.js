...
// @downloadURL https://update.greasyfork.org/scripts/538746/Ufa%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/538746/Ufa%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1.meta.js
// ==/UserScript==
  (function () {
    'use strict';
  ...
  const buttons = [
  {
        ...
        },
        {
          ...
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
          '[CENTER][COLOR=rgb(255, 0, 255)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          "[CENTER][I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша жалоба составлена не по форме. Ознакомьтесь с правилами подачи жалобы - *[/SIZE][/FONT][/COLOR][/I][URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-лидеров.3429391/'][I][COLOR=rgb(209, 213, 216)][FONT=times new roman][COLOR=rgb(255, 0, 0)][SIZE=4]Нажмите сюда[/SIZE][/COLOR][/FONT][/COLOR][/I][/URL][I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]*.[/SIZE][/FONT][/COLOR][/I][/CENTER]" +
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
            '[I][CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman]Отказано, закрыто.[/SIZE][/CENTER][/COLOR][/FONT]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         ...
         },
         {
          ...
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
          '[CENTER][COLOR=rgb(255, 0, 255)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Доказательства из каких-либо соц. сетей не принимаются, необходимо загрузить доказательства на какой-либо фото/видео хостинг.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
             '[I][CENTER][SIZE=4][COLOR=rgb(255, 0, 0)][FONT=times new roman]Отказано, закрыто.[/SIZE][/CENTER][/COLOR][/FONT]',
          prefix: UNACCEPT_PREFIX,
          status: false,
         ...
         },
         {
          ...
          content:
          '[CENTER][url=https://i.yapx.cc/][img]https://i.yapx.cc/STT74.png[/img][/url][/CENTER]<br>' +
          '[CENTER][COLOR=rgb(255, 255, 255)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемые кандидаты.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          "[I][CENTER][COLOR=rgb(124, 252, 0)][FONT=times new roman][SIZE=4]Заявки взяты на рассмотрение[/SIZE][/FONT][/I][/COLOR]"+
          "[I][CENTER][COLOR=rgb(124, 252, 0)][I][FONT=times new roman][SIZE=4]Руководством ГОСС[/SIZE][/FONT][I][/COLOR][/CENTER]<br><br>" +
          '[CENTER][COLOR=rgb(255, 255, 255)][FONT=times new roman][SIZE=4][I]Администрация ни при каких обстоятельствах не будет запрашивать Ваши пароли. Ответственность за Ваш аккаунт несёте Вы сами.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          '[CENTER][COLOR=rgb(255, 255, 255)][FONT=times new roman][SIZE=4][I]Не сообщайте никому никакие коды/пароли и не включайте демонстрацию экрана людям, в которых Вы не уверены, дабы избежать потерю доступа к Вашему аккаунту[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          '[CENTER][COLOR=rgb(255, 255, 255)][FONT=times new roman][SIZE=4][I]Все обзвоны проходят в официальном Дискорд-канале Уфы, где Вы с лёгкостью можете удостоверить личность Администратора[/I][/SIZE][/FONT][/COLOR]<br><br>' +
          '[CENTER][COLOR=rgb(255, 255, 255)][FONT=times new roman][SIZE=4][I]ГС/ЗГС никогда не запросят пароль от Вашего аккаунта и не добавят Вас в какие-либо подозрительные беседы. Будьте внимательны![/I][/SIZE][/FONT][/COLOR]<br><br>' +
          '[CENTER][COLOR=rgb(255, 255, 255)][FONT=times new roman][SIZE=4][I]Всем отличного дня и хорошего настроения![/I][/SIZE][/FONT][/COLOR]<br><br>' +
          '[CENTER][url=https://i.postimg.cc/][img]https://i.postimg.cc/q7pLC4Bz/RLwzo.png[/img][/url][/CENTER]<br><br>' +
          '[I][CENTER][SIZE=4][COLOR=rgb(124, 252, 0)][FONT=times new roman]Просьба не спамить в личные сообщения ГС/ЗГС с вопросами о проверке заявок. Заявки проверяются сразу же после их закрытия и требуют времени для проверки всех кандидатов.[/SIZE][/CENTER][/COLOR][/FONT]',
          status: false
         },
         {
