...
// @downloadURL https://update.greasyfork.org/scripts/499603/WarframeMarketTranslation.user.js
// @updateURL https://update.greasyfork.org/scripts/499603/WarframeMarketTranslation.meta.js
// ==/UserScript==
                ...
                for (let i = 0; i < WarframeMarketWantToSellNode.length; i++) {
                    ...
                    if (elementToModifyElement.innerHTML.includes("|")) {
                        ...
                        (function (index) {
                            ...
                            let imgPath = `#panel > section.user__profile.content--UwhYJ.grow--Q24fj > div.content__body--qkyqR.flex--root > div.container > div.order__content--ORU7n > div.sellOrders--nsRSO.listingSell > div.infinite-scroll > div > div:nth-child(${i + 1}) > div.order-own__item-icon--aCi6u > a > img`; // 需要确保选择的是 img 元素
