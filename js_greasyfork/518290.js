...
// @downloadURL https://update.greasyfork.org/scripts/518290/Google%20%20baidu%20Switcher%20%28ALL%20in%20One%29.user.js
// @updateURL https://update.greasyfork.org/scripts/518290/Google%20%20baidu%20Switcher%20%28ALL%20in%20One%29.meta.js
// ==/UserScript==
      ...
      void (async function (getConfigureData, getResultFilterData, requestRemoteIcon, GMnotification) {
        ...
        void (async function (getUpdateAddress) {
          const listSite = {
            ...
            google: {
              siteTypeID: 2,
              siteButtonName: "PPT课件",
              siteNickName: IS_CHN ? "𝐆𝐨𝐨𝐠𝐥𝐞 搜索" : "𝐆𝐨𝐨𝐠𝐥𝐞.𝐜𝐨𝐦",
              siteHostName: "www.google.com",
              webURL: "https://www.baidu.com/s?ie=utf-8&rqlang=cn&wd= PPT课件 ",
