...
// @version      1.4.8.8
// @description  I hope the og dev of deez script won't punch me to death ^_^
// @author       An0
...
// @connect      gitlab.com
// @downloadURL https://update.greasyfork.org/scripts/468861/SimpleDiscordCrypt.user.js
// @updateURL https://update.greasyfork.org/scripts/468861/SimpleDiscordCrypt.meta.js
// ==/UserScript==
    ...
    Object.assign(Utils, {
        ...
        NewDb: function(callback, cancelCallback) {
            NewdbWindow.Show(async (password) => {
                DataBase = { isEncrypted: password !== "", keys: {}, channels: {}, autoKeyExchange: "" };
                Cache = { keys: {} };
                if(DataBase.isEncrypted)
                {
...
async function processSystemMessage(message, sysmsg) {
    ...
    switch(messageType) {
        case 'DH KEY': {
            message.content = "💻 Let's fuck some niggers togetha bruh? ❤️";
        ...
        case 'DH RESPONSE': {
            message.content = "💻 Sure bruh anytime! ❤️";
            if(oldMessage) return false;
        ...
        case 'PERSONAL KEY': {
            message.content = "💻 Here is my nigguh fucka 3000, now we can fuck niggas any time!!❤️";
            if(oldMessage) return false;
        ...
        case 'KEY REQUEST': {
            message.content = "💻 Hey, can you tell me how to fuck em niggas?❤️";
            if(oldMessage) return false;
        ...
        case 'KEY SHARE': {
            ...
            const statusMsgs = {
                'OK': "💻 Of course, fuck em all!❤️",
                'DENIED': "💻 That's a secret!!!💔",
                'NOT FOUND': "💻 Huh? I dunno💔"
            };
