...
// @include      http*://j.gs*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/372047/Baymack.user.js
// @updateURL https://update.greasyfork.org/scripts/372047/Baymack.meta.js
// ==/UserScript==
        ...
        var rellenar_entradas = function (videos_restantes) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#entradas", info_container).html("Anda mempunyai " + total_entradas + " entries (Maksimal 200 entries).");
                }
            });
        };
