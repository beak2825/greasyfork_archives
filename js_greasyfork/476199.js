// ==UserScript==
// @name          c.ai Neo Panel tt
// @namespace     c.ai Neo Panel tt
...
// @grant         none
// @downloadURL https://update.greasyfork.org/scripts/476199/cai%20Neo%20Panel%20tt.user.js
// @updateURL https://update.greasyfork.org/scripts/476199/cai%20Neo%20Panel%20tt.meta.js
// ==/UserScript==
...
button.style.right = '140px';
  ...
  // Adjust 'left' style to 65% for phones
    ...
    socket.addEventListener('message', (event) => {
        try {
            ...
            if (response.command === 'update_turn') {
                //console.log('[CUSTOM] Processing update_turn command');
            window.location.reload();
