...
// @grant        none
// @license		 GNU
// @downloadURL https://update.greasyfork.org/scripts/439606/Venus%20Smart%20Planning.user.js
// @updateURL https://update.greasyfork.org/scripts/439606/Venus%20Smart%20Planning.meta.js
// ==/UserScript==
	...
	function getPlannings() {
		...
		for (var i = 2; i < htmlPlannings.length; i++) { //each planning
			...
			for (var j = 1; j < appointments.length; j++) { //each appointment
				...
				if (planning.name.match(new RegExp('e\\.|hosp|mam', 'gi'))) //echography planning = doctor
