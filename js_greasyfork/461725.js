// ==UserScript==
// @name         NOVOSIBIRSK для КФ | M.Grozny S. Crown
// @namespace    https://forum.blackrussia.online
// @version      2.0
// @description  Скрипт для Модераторов Форума 
// @author       Muhamad,S.Crown
...
// @downloadURL https://update.greasyfork.org/scripts/461725/NOVOSIBIRSK%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%20MGrozny%20S%20Crown.user.js
// @updateURL https://update.greasyfork.org/scripts/461725/NOVOSIBIRSK%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%20MGrozny%20S%20Crown.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#ff0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>'+
        "[CENTER][COLOR=#FFFF00][ICODE]Ваша жалоба была передана на рассмотрение техническому специалисту. [/ICODE] @Orchid_Malevolence[/COLOR][/CENTER]<br>" +
         '[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>' +
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#ff0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>'+
        "[CENTER][COLOR=#FFFF00][ICODE]Ваша жалоба была передана на рассмотрение Главному Администратору. [/ICODE] @Kenzo_Fantasy[/COLOR][/CENTER]<br>" +
        '[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>' +
		'[Color=AQUA][CENTER][ICODE]Ожидайте ответа [/ICODE].[/CENTER][/COLOR]'+
        '[url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>',
      prefix: GA_PREFIX,
    ...
    },
    {
      ...
      content:
		"[B][CENTER][COLOR=#ff0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>'+
        "[CENTER][COLOR=#FFFF00][ICODE]Ваша жалоба была передана на рассмотрение Главному куратору форума,а так же его Заместителю.[/ICODE]  @Muhamad_Grozny @Sogeking Crown ♅[/COLOR][/CENTER]<br>" +
        '[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>' +
		'[Color=AQUA][CENTER][ICODE]Ожидайте ответа [/ICODE].[/CENTER][/COLOR]'+
        '[url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>',
    },
     ...
     },
    {
      ...
      content:
        ...
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>' +
        "[CENTER][COLOR=#ffff00][ICODE]Нет доказательств.[/ICODE][/CENTER][/COLOR]<br>" +
		'[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>'+
        '[Color=AQUA][CENTER][ICODE]Спасибо за Ваше обращение!<br>Приятной игры на NOVOSIBIRSK.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>'+
     ...
     },
    {
      ...
      content:
		"[CENTER][COLOR=#ff0000]Доброго времени суток уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>' +
        "[CENTER][COLOR=#ffff00][ICODE]Вы ошиблись разделом, обратитесь в раздел *Жалобы на сотрудников*.[/ICODE][/CENTER][/COLOR]<br>" +
		'[url=https://postimages.org/][img]https://i.postimg.cc/VsXdc0M3/C0ffE.png[/img][/url]<br>'+
        '[Color=AQUA][CENTER][ICODE]Спасибо за Ваше обращение!<br>Приятной игры на NOVOSIBIRSK.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/fy4k2Vjj/RvBD5.gif[/img][/url]<br>'+
		'[Color=#FF0000][CENTER][I][ICODE]Отказано, закрыто.[/ICODE][/I][/CENTER][/color]',
