...
// @version        3.1
// @downloadURL https://update.greasyfork.org/scripts/35356/XKCD%20enhancments.user.js
// @updateURL https://update.greasyfork.org/scripts/35356/XKCD%20enhancments.meta.js
// ==/UserScript==
// change these for light theme: titleWrap.style.color = "#fff"; 
//								switch rgb values and ">"<=>"<"	
...
function appendHover (jsonObj) {
	...
	var altTitle = document.createElement("div");
		altTitle.innerHTML = jsonObj.year + "-" + ((jsonObj.month<10) ? ("0" + jsonObj.month) : jsonObj.month) + "-" + ((jsonObj.day<10) ? ("0" + jsonObj.day) : jsonObj.day) + "</br>" + decodeURIComponent(escape(jsonObj.alt));
