...
// @icon         https://cdn.discordapp.com/attachments/1116478498719137913/1135082390658764840/dance-loli.gif

// @grant        none

// @downloadURL https://update.greasyfork.org/scripts/472269/Drawaria%20Drawing%20Bot.user.js
// @updateURL https://update.greasyfork.org/scripts/472269/Drawaria%20Drawing%20Bot.meta.js
// ==/UserScript==
...
(() => {
	...
	if (!document.getElementById('Engine-Cheatcontainer')) {
		...
		window['___BOT'] = new Player('|elpajaslokas =V|');
