...
// @include        https://*kingdomofloathing.com/account_tattoos.php*
// @include        http://kol.coldfront.net/thekolwiki/index.php/Tattoo
// @include        http://kol.coldfront.net/thekolwiki/index.php/Tattoos
// @version        1.2.3
// @grant          GM_getValue
// @grant          GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/4203/Tattoo%20Counter.user.js
// @updateURL https://update.greasyfork.org/scripts/4203/Tattoo%20Counter.meta.js
// ==/UserScript==
...
function gather() {
    ...
    console.log('Loaded '+count+' tattoos from the wiki');
    if (count>0) {
