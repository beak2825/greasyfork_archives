...
const CONTROLLER_PAGE = atob("aHR0cHM6Ly9rc3cyLW1vb21vby5nbGl0Y2gubWU="); var ctr, global_id; (async () => {
...
} else if (windowloc == "moomoo.io" || windowloc == "sandbox.moomoo.io" || windowloc == "beta.moomoo.io") {
    let execOpen = false;
    GM_getTabs(e => {
    ...
    _ls = (locServ = (window.location.protocol + "//code.jquery.com/jquery-3.3.1.slim.min.js"), isCache = false) => {
            ...
            (locServ.includes("bundle.js") || locServ.includes("quasar")) && (
...
Respawn !!~_Da-rrkX_~!!? <input id="respawnGBots" type="checkbox" checked><br>
...
`;
    ...
    <div id="overlay"><center style="font-family: verdana; font-size: 50px; color: blue;">
    <br>
    Select a GOOD mod:<br><br>
    <button class="modBtn" id="superModLoad">Super Lost</button>
    <button class="modBtn" id="xwareLoad">X-Lost</button>
    <button class="modBtn" id="quasarLoad">Quasar Lost (Latest)</button>
    <button class="modBtn" id="justMod">JustLost</button>
    </center></div>
    <style>
    #overlay {
 ...
 */
        class Gui {
            constructor(title) {
                this._colors = ['#000000', '#0000ff', '#ff0000', '#6690EA', '#E7D063', '#EA6666', '#92EA66', '#66EAE6'];
                this._buttons = [];
                this._notifications = [];
