...
// @version     3.28-Black
// @grant       GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/406528/Amo%20-%20Cheater%20-%20Black.user.js
// @updateURL https://update.greasyfork.org/scripts/406528/Amo%20-%20Cheater%20-%20Black.meta.js
// ==/UserScript==
...
NoweMenu.innerHTML = '<table style="text-align: left; width: 960px;" border="0" cellpadding="0" cellspacing="0">'
  				   + '<tbody>'
    			   + '<tr>'
      			   + '<td><div id="statystyki" class="menubutton" style="background: url(http://amorion.pl/gui2/button_off.png);"><img src="gui2/statystyki.png" onmouseover="AlterImgMenu(\'statystyki\', \'gui2/button_on.png\')" onmouseout="AlterImgMenu(\'statystyki\', \'gui2/button_off.png\')" onclick="Link(\'dynamic\', \'stats.php\')"></div></td>'
     			   + '<td><div id="bogactwa" class="menubutton" style="background: url(http://amorion.pl/gui2/button_off.png);"><img src="gui2/bogactwa.png" onmouseover="AlterImgMenu(\'bogactwa\', \'gui2/button_on.png\')" onmouseout="AlterImgMenu(\'bogactwa\', \'gui2/button_off.png\')" onclick="Link(\'dynamic\', \'wealth.php\')"></div></td>'
     			   + '<td><div id="ekwipunek" class="menubutton" style="background: url(http://amorion.pl/gui2/button_off.png);"><img src="gui2/ekwipunek.png" onmouseover="AlterImgMenu(\'ekwipunek\', \'gui2/button_on.png\')" onmouseout="AlterImgMenu(\'ekwipunek\', \'gui2/button_off.png\')" onclick="Link(\'dynamic\', \'inventory.php\')"></div></td>'
      			   + '<td><div id="klan" class="menubutton" style="background: url(http://amorion.pl/gui2/button_off.png);"><img src="gui2/klan.png" onmouseover="AlterImgMenu(\'klan\', \'gui2/button_on.png\')" onmouseout="AlterImgMenu(\'klan\', \'gui2/button_off.png\')" onclick="Link(\'dynamic\', \'klany.php?view=my\')"></div></td>'
      			   + '<td><div id="premium" class="menubutton" style="background: url(http://amorion.pl/gui2/button_off.png);"><img src="gui2/premium.png" onmouseover="AlterImgMenu(\'premium\', \'gui2/button_on.png\')" onmouseout="AlterImgMenu(\'premium\', \'gui2/button_off.png\')" onclick="Link(\'dynamic\', \'premin.php\')"></div></td>'
     			   + '<td><div id="pamietnik" class="menubutton" style="background: url(http://amorion.pl/gui2/button_off.png);"><img src="gui2/pamietnik.png" onmouseover="AlterImgMenu(\'pamietnik\', \'gui2/button_on.png\')" onmouseout="AlterImgMenu(\'pamietnik\', \'gui2/button_off.png\')" onclick="Link(\'dynamic\', \'notatnik.php\')"></div></td>'
     			   + '<td><div id="opcje" class="menubutton" style="background: url(http://amorion.pl/gui2/button_off.png);"><img src="gui2/opcje.png" onmouseover="AlterImgMenu(\'opcje\', \'gui2/button_on.png\')" onmouseout="AlterImgMenu(\'opcje\', \'gui2/button_off.png\')" onclick="Link(\'dynamic\', \'account.php\')"></div></td>'
     			   + '<td><div id="wyloguj" class="menubutton" style="background: url(http://amorion.pl/gui2/button_off.png);"><img src="gui2/wyloguj.png" onmouseover="AlterImgMenu(\'wyloguj\', \'gui2/button_on.png\')" onmouseout="AlterImgMenu(\'wyloguj\', \'gui2/button_off.png\')" onclick="Go(\'logout.php?did=403\')"></div></td>'
    			   + '</tr>'
  				   + '</tbody>'
				   + '</table>'
