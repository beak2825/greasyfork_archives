...
// @license         MIT License
// @downloadURL https://update.greasyfork.org/scripts/7097/Produs%20%28Proddable%20Pardus%29.user.js
// @updateURL https://update.greasyfork.org/scripts/7097/Produs%20%28Proddable%20Pardus%29.meta.js
// ==/UserScript==
...
function getModElement(mod_desired)
{
    ...
    switch (mod_desired)
    {
        ...
        case mod.CLEAN_WH:
            new_element.setAttribute('src', 'data:image/png;base64,');
        break;
