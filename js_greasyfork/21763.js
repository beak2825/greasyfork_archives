...
// @grant          none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/21763/Endless%20E-hentai%20Pages.user.js
// @updateURL https://update.greasyfork.org/scripts/21763/Endless%20E-hentai%20Pages.meta.js
// ==/UserScript==
...
function page(html){
    ...
    this.nextURL = htmlDecode(
        ...
        /*Images*/function(){var str=safeArray(html.match(/<a onclick="([^>]*?)" href="([^>]*?)"><img id="img" src="([^>]{150,}?)"/i),2);return(str&&str!=currentPage.nextURL)?str:"";}()
        );
...
function html2dom(html){
    var container = (type == 3) ? document.createElement("div") : document.createElement("tbody");
