// ==UserScript==
// @name         Cкрипт КФ (зктс 16-20)
// @namespace    https://forum.blackrussia.online
// @version      4.1
// @description  For Admins with Love <3
// @author       NEclipse
...
// @downloadURL https://update.greasyfork.org/scripts/474532/C%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D0%A4%20%28%D0%B7%D0%BA%D1%82%D1%81%2016-20%29.user.js
// @updateURL https://update.greasyfork.org/scripts/474532/C%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%9A%D0%A4%20%28%D0%B7%D0%BA%D1%82%D1%81%2016-20%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #ff0000',
        },
        {
        ...
        {
            title: 'Игровые чаты',
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #ffa500',
        },
        {
            title: 'Транслит',
            content:
        ...
        },
        {
            ...
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #ffff00',
        },
        {
            title: 'Фейк аккаунт',
            content:
...

        {
            ...
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #008000',
        },
        {
        ...
        },
        {
            ...
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #42aaff',
        },
        {
        ...
        {
            title: 'Правила ОПГ',
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #0000ff',
        },
        {
        ...
        },
        {
            ...
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #8b00ff',
        },
        {
        ...
        {
            title: 'РП СИТУАЦИИ',
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #ffc0cb',
        },
        {
        ...
        {
            title: '╴Неофицал.орг.',
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #00ff00',
        },
        {
        ...
        {
            title: 'РП биография',
            dpstyle: 'width: 96%; color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #808080',
        },
        {
    ...
    $(document).ready(() => {
        ...
        addButton('На рассмотрении', 'pin', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 173, 51, 0.5);');
        addButton('Команде проекта', 'teamProject', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 240, 110, 0.5);');
        addButton('Главному Администратору', 'Ga', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(220, 89, 89, 0.5);');
        addButton('Спец. Администратору', 'Spec', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(220, 89, 89, 0.5);');
        addButton('Одобрено', 'accepted', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(110, 192, 113, 0.5);');
        addButton('Отказано', 'unaccept', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(220, 89, 89, 0.5);');
        addButton('Техническому специалисту', 'Texy', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(17, 92, 208, 0.5);');
        addButton('Решено', 'Resheno', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(110, 192, 113, 0.5);');
        addButton('Закрыто', 'Zakrito', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(220, 89, 89, 0.5);');
        addButton('Ответы', 'selectAnswer', 'margin: 3px; border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 240, 110, 0.5);');
