...
// @grant		none
// @run-at		document-end
// @downloadURL https://update.greasyfork.org/scripts/449973/%CA%80%EA%9C%B1%E1%B4%9B%CA%9F.user.js
// @updateURL https://update.greasyfork.org/scripts/449973/%CA%80%EA%9C%B1%E1%B4%9B%CA%9F.meta.js
// ==/UserScript==
console.clear();
PIXI = null;
...
, function(t, e, n) {
    ...
    var b = function() {
        ...
        t.prototype.SelfUnitsDeadProc = function() {
            ...
            t.conn.SendRequestStartSpectate())
        }
        ,
        ...
        var p = function() {
          ...
          , i = function() {
            ...
            I.prototype.Update = function() {
                ...
                x ? t.skinUrl = B.gameCore.userEntryMan.curInfo.skinUrl2 : t.skinUrl = d,
