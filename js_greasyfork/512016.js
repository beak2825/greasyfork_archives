// ==UserScript==
// @name   🌱【免费版】学考网|重庆理工大学自动网课助手|如需自动播放、自动下一集功能见收费版本：https://doc.zhanyc.cn/pages/53b1a4/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*360xkw.com/*
// @grant       GM_getValue
// @grant       GM_setValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/512016/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%AD%A6%E8%80%83%E7%BD%91%7C%E9%87%8D%E5%BA%86%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%E8%87%AA%E5%8A%A8%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E6%92%AD%E6%94%BE%E3%80%81%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpages53b1a4.user.js
// @updateURL https://update.greasyfork.org/scripts/512016/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%AD%A6%E8%80%83%E7%BD%91%7C%E9%87%8D%E5%BA%86%E7%90%86%E5%B7%A5%E5%A4%A7%E5%AD%A6%E8%87%AA%E5%8A%A8%E7%BD%91%E8%AF%BE%E5%8A%A9%E6%89%8B%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E6%92%AD%E6%94%BE%E3%80%81%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpages53b1a4.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/53b1a4/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (
                url.includes("gxlearningcenter/rebackVideo.html") ||
                url.includes("gxlearningcenter/learning.html")
            ) {
                plugMain.showPaidContent(`免费版本不包含自动下一集、无人值守功能，如需使用请安装收费版本`);
                plugMain.page_video();
            }
        },

        async page_video() {
            await plugMain.gmAuthDownScore("61dafa330cfe4d6c9b5ae779331c770c");
            layer.msg("脚本已经开始运行");
            console.log("%c page_video", "background:rgb(0,0,0);color:#fff");
            let lastTime = 0;

            let index = setInterval(() => {
                // console.log(`zfk ${video[0].currentTime} / ${video[0].duration}`);
                let title = `进度：${plugMain.getCurTime().toFixed(0)}/${plugMain
                    .getTotalTime()
                    .toFixed(0)}`;
                $("title").text(title);
                if (lastTime == video[0].duration) {
                    if (video[0].currentTime >= video[0].duration - 2) {
                        console.log(`zfk 这一集学完了`);
                        layer.msg("这一集学完了，准备自动点击下一个视频~");
                        clearInterval(index);
                        setTimeout(() => {
                            plugMain.nextVideo();
                        }, 5000);
