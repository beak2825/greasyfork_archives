...
// @connect         eu-north-1.exyezed.cc
// @connect         ap-south-1.exyezed.cc
// @connect         eu-west-3.exyezed.cc
// @connect         us-east-2.exyezed.cc
// @connect         af-south-1.exyezed.cc
// @connect         eu-west-1.exyezed.cc
// @connect         me-central-1.exyezed.cc
// @connect         eu-central-1.exyezed.cc
// @connect         sa-east-1.exyezed.cc
// @connect         ap-east-1.exyezed.cc
// @connect         ap-northeast-1.exyezed.cc
// @connect         us-east-1.exyezed.cc
// @connect         ap-northeast-2.exyezed.cc
// @connect         ap-northeast-3.exyezed.cc
// @connect         eu-west-2.exyezed.cc
// @connect         us-west-2.exyezed.cc
// @connect         us-west-1.exyezed.cc
// @connect         ap-southeast-1.exyezed.cc
// @connect         ap-southeast-2.exyezed.cc
// @grant           GM_addStyle
// @grant           GM_xmlhttpRequest
// @grant           unsafeWindow
// @run-at          document-start
// @downloadURL https://update.greasyfork.org/scripts/551198/TwitterX%20Media%20Batch%20Downloader%20Pro.user.js
// @updateURL https://update.greasyfork.org/scripts/551198/TwitterX%20Media%20Batch%20Downloader%20Pro.meta.js
// ==/UserScript==
...
(function (preact, signals, hooks, i18next, dayjs, Dexie, fileSaverEs, gifshot, fflate) {
  ...
  var IconDots = createPreactComponent("outline", "dots", "Dots", [["path", { "d": "M5 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0", "key": "svg-0" }], ["path", { "d": "M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0", "key": "svg-1" }], ["path", { "d": "M19 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0", "key": "svg-2" }]]);
  ...
  var IconFileText = createPreactComponent("outline", "file-text", "FileText", [["path", { "d": "M14 3v4a1 1 0 0 0 1 1h4", "key": "svg-0" }], ["path", { "d": "M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z", "key": "svg-1" }], ["path", { "d": "M9 9l1 0", "key": "svg-2" }], ["path", { "d": "M9 13l6 0", "key": "svg-3" }], ["path", { "d": "M9 17l6 0", "key": "svg-4" }]]);
  ...
  var IconFileZip = createPreactComponent("outline", "file-zip", "FileZip", [["path", { "d": "M6 20.735a2 2 0 0 1 -1 -1.735v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2h-1", "key": "svg-0" }], ["path", { "d": "M11 17a2 2 0 0 1 2 2v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1v-2a2 2 0 0 1 2 -2z", "key": "svg-1" }], ["path", { "d": "M11 5l-1 0", "key": "svg-2" }], ["path", { "d": "M13 7l-1 0", "key": "svg-3" }], ["path", { "d": "M11 9l-1 0", "key": "svg-4" }], ["path", { "d": "M13 11l-1 0", "key": "svg-5" }], ["path", { "d": "M11 13l-1 0", "key": "svg-6" }], ["path", { "d": "M13 15l-1 0", "key": "svg-7" }]]);
  ...
  var IconRepeat = createPreactComponent("outline", "repeat", "Repeat", [["path", { "d": "M4 12v-3a3 3 0 0 1 3 -3h13m-3 -3l3 3l-3 3", "key": "svg-0" }], ["path", { "d": "M20 12v3a3 3 0 0 1 -3 3h-13m3 3l-3 -3l3 -3", "key": "svg-1" }]]);
  ...
  const DEFAULT_APP_OPTIONS = {
    ...
    fontFamily: "system",
    version: pkg.version,
    convertAnimatedGifs: false,
    convertGifsExternal: false,
    downloadConcurrency: 1,
    mediaType: "all",
    includeRetweets: false,
    apiServer: "washington",
    apiTimeout: 60
  };
  const THEMES = [
    "abyss",
  ...
  class AppOptionsManager {
    ...
    loadAppOptions() {
      ...
      if ("fetchMode" in migrated) {
        delete migrated.fetchMode;
      }
      if ("timelineType" in migrated) {
        delete migrated.timelineType;
      }
      if (migrated.mediaType && !["all", "image", "video", "gif", "text"].includes(migrated.mediaType)) {
        migrated.mediaType = "all";
      }
      const oldApiServers = {
        "oregon": "washington"
};
      if (migrated.apiServer && oldApiServers[migrated.apiServer]) {
        migrated.apiServer = oldApiServers[migrated.apiServer];
      }
      this.appOptions = {
        ...this.appOptions,
        ...migrated
      ...
      } else if (newVersion.startsWith("1.1") && oldVersion.startsWith("1.0")) {
        setTimeout(() => this.saveAppOptions(), 0);
      }
...
u(Trans, { ns: "common", i18nKey: "Error:" }),
  ...
  const API_SERVERS = {
    stockholm: "https://eu-north-1.exyezed.cc",
    mumbai: "https://ap-south-1.exyezed.cc",
    paris: "https://eu-west-3.exyezed.cc",
    cleveland: "https://us-east-2.exyezed.cc",
    capetown: "https://af-south-1.exyezed.cc",
    dublin: "https://eu-west-1.exyezed.cc",
    dubai: "https://me-central-1.exyezed.cc",
    frankfurt: "https://eu-central-1.exyezed.cc",
    saopaulo: "https://sa-east-1.exyezed.cc",
    hongkong: "https://ap-east-1.exyezed.cc",
    tokyo: "https://ap-northeast-1.exyezed.cc",
    washington: "https://us-east-1.exyezed.cc",
    seoul: "https://ap-northeast-2.exyezed.cc",
    osaka: "https://ap-northeast-3.exyezed.cc",
    london: "https://eu-west-2.exyezed.cc",
    portland: "https://us-west-2.exyezed.cc",
    sanfrancisco: "https://us-west-1.exyezed.cc",
    singapore: "https://ap-southeast-1.exyezed.cc",
    sydney: "https://ap-southeast-2.exyezed.cc"
  };
  function getAPITimeout() {
    const timeout = appOptionsManager.get("apiTimeout") ?? 60;
    return Math.min(Math.max(timeout, 1), 300) * 1e3;
  }
  function getSelectedServer() {
    const server = appOptionsManager.get("apiServer") ?? "washington";
    return API_SERVERS[server] || API_SERVERS.washington;
  }
    ...
    async fetchMediaData(username, authToken, patreonAuth, params) {
      ...
      if (dateSince || dateUntil) {
        ...
        baseRequestBody = {
          ...
          start_date: dateSince || "",
          end_date: dateUntil || "",
          media_filter: mediaType,
          retweets: includeRetweets,
          batch_size: 200,
patreon_auth: patreonAuth === "xbatchdemo" ? null : patreonAuth,
          demo_code: patreonAuth === "xbatchdemo" ? "xbatchdemo" : null
        };
      } else {
        endpoint = "/timeline";
        let timelineType;
        if (mediaType === "text" || includeRetweets) {
          timelineType = "tweets";
        } else {
...
media_type: mediaType,
      ...
      const globalTimeout = getAPITimeout();
      let fetchCompleted = false;
      const globalTimeoutId = setTimeout(() => {
        if (!fetchCompleted && abortSignal && !abortSignal.aborted) {
          const callback = abortSignal.__timeoutCallback;
          if (callback && typeof callback === "function") {
            callback();
          }
          const controller = abortSignal.__controller;
      ...
      try {
        while (!completed && !abortSignal?.aborted) {
          ...
          const batchResponse = await this.makePostRequest(selectedServer + endpoint, requestBody, abortSignal);
          if (abortSignal?.aborted) {
            break;
          }
          const newTimelineItems = batchResponse.timeline || [];
          ...
          if (deduplicatedItems.length > 0) {
            allTimeline.push(...deduplicatedItems);
            totalFetched += deduplicatedItems.length;
          }
          if (!allAccountInfo && batchResponse.account_info) {
            allAccountInfo = batchResponse.account_info;
          }
          cursor = batchResponse.cursor || batchResponse.metadata?.cursor || null;
          const responseCompleted = batchResponse.completed ?? batchResponse.metadata?.completed ?? false;
          const hasMore = !!cursor && !responseCompleted;
          completed = !cursor || responseCompleted;
          if (abortSignal?.aborted) {
            break;
          }
          if (!abortSignal?.aborted && onProgress && deduplicatedItems.length > 0) {
            onProgress(totalFetched, deduplicatedItems.length, cursor, deduplicatedItems, allAccountInfo || void 0);
          }
          if (abortSignal?.aborted) {
            break;
          }
        ...
        if (abortSignal?.aborted && cursor) {
          return {
            account_info: allAccountInfo || {
              name: username,
              nick: username,
              date: "",
              followers_count: 0,
        ...
        if (allTimeline.length === 0) {
          ...
          this.validateNonEmptyResult(emptyResponse);
        ...
        const finalResponse = {
          ...
          metadata: {
            batch_size: 200,
            cursor: cursor || null,
            has_more: !completed && cursor !== null,
            new_entries: allTimeline.length,
page: 0
          },
          timeline: allTimeline
    ...
    async makePostRequest(url, body, abortSignal) {
      return new Promise((resolve, reject) => {
        if (typeof GM_xmlhttpRequest !== "undefined") {
          GM_xmlhttpRequest({
            method: "POST",
            ...
            ontimeout: () => {
              ...
              const error = new Error(apiError.message);
              error.apiError = apiError;
              error.apiError.isRetryable = true;
              reject(error);
            }
          });
        } else {
          this.makePostRequestWithFetch(url, body).then(resolve).catch(reject);
        }
      });
    },
      ...
      try {
        ...
        if (error instanceof Error) {
          if (error.name === "AbortError") {
            ...
            err2.apiError.isRetryable = true;
            throw err2;
          }
          throw error;
        }
    ...
    async makePostRequestWithFetch(url, body, abortSignal) {
      if (abortSignal?.aborted) {
        const apiError = this.createAPIError("Request aborted");
        const error = new Error(apiError.message);
        error.apiError = apiError;
        throw error;
      }
...
validateNonEmptyResult(data) {
    ...
    async verifyPatreonAuth(patreonAuth) {
      ...
      const selectedServer = getSelectedServer();
      const url = selectedServer + endpoint;
      const requestBody = { patreon_auth: patreonAuth };
      return new Promise((resolve, reject) => {
        if (typeof GM_xmlhttpRequest !== "undefined") {
          GM_xmlhttpRequest({
            method: "POST",
          ...
          GM_xmlhttpRequest({
            ...
            onload: (response) => {
              try {
                if (response.status === 401) {
                  const errorData = JSON.parse(response.responseText);
                  const errorMsg = errorData.error || errorData.detail || "Invalid Patreon authentication";
                ...
                if (!data || typeof data !== "object" || !Array.isArray(data.tokens)) {
                  reject(new Error("Invalid token response structure"));
                  return;
                }
                const result = {
                  success: data.success ?? true,
                  tokens: data.tokens ?? [],
                  count: data.count ?? data.tokens?.length ?? 0,
                  message: data.message ?? "Tokens retrieved successfully"
                };
                resolve(result);
              } catch (parseError) {
  ...
  class MediaDownloaderDB extends Dexie {
    ...
    constructor() {
      ...
      this.version(5).stores({
        accounts: "++id, username, cached_at, batch_identifier, batch_mode, group",
        auth_settings: "++id",
        groups: "++id, name, created_at"
      });
    }
  ...
  const mediaDownloaderDB = {
    async saveAccount(data) {
      return await mediaDB.transaction("rw", mediaDB.accounts, async () => {
        const account = {
          ...data,
          cached_at: Date.now()
        };
        let existing;
        if (account.batch_mode === "date_range") {
          const dateRangeAccounts = await mediaDB.accounts.where("username").equals(data.username).filter(
            (acc) => acc.batch_mode === "date_range" && acc.date_since === data.date_since && acc.date_until === data.date_until && acc.media_type === data.media_type
          ).toArray();
          ...
          const regularAccounts = await mediaDB.accounts.where("username").equals(data.username).filter((acc) => {
            const sameMode = !acc.batch_mode || acc.batch_mode !== "date_range";
            const sameDateRange = !acc.date_since && !data.date_since || acc.date_since === data.date_since && acc.date_until === data.date_until;
            const sameMediaType = acc.media_type === data.media_type;
            return sameMode && sameDateRange && sameMediaType;
          }).toArray();
          if (regularAccounts.length > 0) {
            regularAccounts.sort((a, b) => b.cached_at - a.cached_at);
            existing = regularAccounts[0];
          }
        }
        let id2;
        if (existing) {
        ...
        if (account.group) {
          await this.addGroup(account.group);
        }
    ...
    async getAccounts(page = 1, limit = 3, filterByBatch = false, filterByDateRange = false, filterByBatchDateRange = false) {
      ...
      } else if (filterByBatchDateRange) {
        collection = collection.filter((acc) => acc.batch_mode === "date_range");
      } else if (filterByBatch) {
        collection = collection.filter((acc) => !acc.batch_mode || acc.batch_mode !== "date_range");
      }
    ...
    async getAccountsCount(filterByBatch = false, filterByDateRange = false, filterByBatchDateRange = false) {
      if (filterByDateRange) {
        ...
        return await mediaDB.accounts.filter((acc) => !acc.batch_mode || acc.batch_mode !== "date_range").count();
      }
    ...
    async getAccountsByUsernameAndMode(username, mode, dateSince, dateUntil, mediaType) {
      if (mode === "date_range") {
        return await mediaDB.accounts.where("username").equals(username).filter(
          (acc) => acc.batch_mode === "date_range" && acc.date_since === dateSince && acc.date_until === dateUntil && acc.media_type === mediaType
        ).toArray();
      } else {
        return await mediaDB.accounts.where("username").equals(username).filter(
          (acc) => (!acc.batch_mode || acc.batch_mode !== "date_range") && acc.media_type === mediaType
        ).toArray();
      }
    },
    async updateAccount(id2, data) {
      ...
      if (data.group) {
        await this.addGroup(data.group);
      }
      dbState.dbChangeSignal.value++;
    },
    ...
    async saveAuthSettings(authToken, patreonAuth, showAuthToken, showPatreonAuth) {
      ...
      const settings = {
        ...
        show_auth_token: showAuthToken !== void 0 ? showAuthToken : base.show_auth_token,
        show_patreon_auth: showPatreonAuth !== void 0 ? showPatreonAuth : base.show_patreon_auth
      };
      if (existing) {
    ...
    async saveTokenList(tokenList, currentIndex = 0) {
      const existing = await mediaDB.auth_settings.toCollection().first();
      if (existing) {
        await mediaDB.auth_settings.update(existing.id, {
        ...
        await mediaDB.auth_settings.add({
          auth_token: tokenList[currentIndex] || "",
          patreon_auth: "",
          token_list: tokenList,
          current_token_index: currentIndex,
          last_token_refresh: Date.now(),
    ...
    async getNextToken() {
      const settings = await mediaDB.auth_settings.toCollection().first();
      if (!settings || !settings.token_list || settings.token_list.length === 0) {
        return null;
      }
      const currentIndex = settings.current_token_index ?? 0;
      if (currentIndex >= settings.token_list.length) {
        return null;
      }
      const token = settings.token_list[currentIndex];
      if (!token) {
        return null;
      }
      await mediaDB.auth_settings.update(settings.id, {
        current_token_index: currentIndex + 1,
        auth_token: token,
        updated_at: Date.now()
      });
      return token;
    ...
    async getAllGroups() {
      try {
        await mediaDB.open();
        const groups = await mediaDB.groups.toArray();
        return groups.map((g2) => g2.name).sort();
      } catch (error) {
    ...
    async addGroup(groupName) {
      try {
        await mediaDB.open();
        const existing = await mediaDB.groups.where("name").equals(groupName).first();
        if (!existing) {
          await mediaDB.groups.add({
            name: groupName,
            created_at: Date.now()
          });
        }
    ...
    async removeGroup(groupName) {
      try {
        await mediaDB.open();
        await mediaDB.groups.where("name").equals(groupName).delete();
      } catch (error) {
        if (error?.name !== "NotFoundError" && error?.name !== "InvalidStateError") {
  ...
  class MediaDownloader {
    ...
    async downloadAccountMedia(account, onProgress, batchInfo) {
      ...
      try {
        ...
        const username = mediaDownloaderAPI.formatUsername(account.username);
        ...
        if (batchInfo?.mode === "date_range" || dateRangeSuffix) {
        ...
        if (shouldConvertGifs) {
          await this.downloadWithGifConversion(zipFilename, files, onProgress, this.abortController?.signal);
        } else {
    ...
    createFileList(timeline, username) {
      ...
      const mediaGroups = {
        ...
        text: timeline.filter((item) => item.type === "text")
      };
    ...
    async downloadWithGifConversion(zipFilename, files, onProgress, abortSignal) {
      ...
      for (let i = 0; i < gifFiles.length; i++) {
        if (abortSignal?.aborted) {
          if (convertedFiles.length > 0) {
            const partialFiles = [
              ...files.filter((f2) => !f2.filename.startsWith("gif/")),
              ...convertedFiles
            ];
            const downloadProgressCallback2 = (current, total, file) => {
        ...
        try {
          const gifData = await this.convertVideoToGifWithAbort(gifFile.url, abortSignal);
          if (gifData) {
            gifFile.url = gifData;
            convertedFiles.push(gifFile);
          }
        } catch (error) {
          if (error?.message === "Download aborted") {
            if (convertedFiles.length > 0) {
    ...
    convertVideoToGifWithAbort(videoUrl, abortSignal) {
      if (!abortSignal) {
        return this.convertVideoToGif(videoUrl);
      }
      return new Promise((resolve, reject) => {
        if (abortSignal.aborted) {
          reject(new Error("Download aborted"));
        ...
        this.convertVideoToGif(videoUrl).then((result) => {
          if (onAbort) {
  ...
  const databaseDownloadState = {
    ...
    downloadProgress: signals.signal({}),
    downloadCurrent: signals.signal({}),
    downloadTotal: signals.signal({}),
    downloadCurrentFile: signals.signal({}),
    downloadConverting: signals.signal({}),
    resetDownloadState(accountId) {
      this.downloadProgress.value = { ...this.downloadProgress.value, [accountId]: 0 };
      this.downloadCurrent.value = { ...this.downloadCurrent.value, [accountId]: 0 };
      this.downloadTotal.value = { ...this.downloadTotal.value, [accountId]: 0 };
      this.downloadCurrentFile.value = { ...this.downloadCurrentFile.value, [accountId]: "" };
      this.downloadConverting.value = { ...this.downloadConverting.value, [accountId]: false };
    },
    clearDownloadState(accountId) {
      if (this.downloadingId.value === accountId) {
        this.downloadingId.value = null;
      }
      this.resetDownloadState(accountId);
    }
  };
  const authState = {
...
u("form", { method: "dialog", class: "modal-backdrop", children: u("button", { "aria-label": "Close", children: "close" }) })
  ...
  function Dashboard({ loadFromDatabaseAccount } = {}) {
    ...
    const previousMediaCount = signals.useSignal(null);
    const mediaIncrement = signals.useSignal(0);
    const incrementTimeoutRef = signals.useSignal(null);
    ...
    const showTimeoutModal = signals.useSignal(false);
    const hasResumeCursor = signals.useSignal(false);
    const isRetrying = signals.useSignal(false);
    const fetchAbortController = signals.useSignal(null);
    const currentFetchTotal = signals.useSignal(0);
    ...
    const advancedSettingsOpen = signals.useSignal(false);
    const fetchElapsedSeconds = signals.useSignal(0);
    const fetchStartTime = signals.useSignal(null);
    const lastFetchDuration = signals.useSignal(null);
    hooks.useEffect(() => {
      if (isLoading.value) {
        fetchStartTime.value = Date.now();
        fetchElapsedSeconds.value = 0;
        const interval = setInterval(() => {
          if (fetchStartTime.value) {
            const elapsed = Math.floor((Date.now() - fetchStartTime.value) / 1e3);
            fetchElapsedSeconds.value = elapsed;
          }
        }, 1e3);
        return () => {
          clearInterval(interval);
          if (fetchStartTime.value) {
            const duration = Math.floor((Date.now() - fetchStartTime.value) / 1e3);
            lastFetchDuration.value = duration;
          }
          fetchStartTime.value = null;
          fetchElapsedSeconds.value = 0;
        };
      } else {
        fetchStartTime.value = null;
    ...
    const getRemainingTime = () => {
      const timeout = appOptionsManager.get("apiTimeout") ?? 60;
      const remaining = timeout - fetchElapsedSeconds.value;
    ...
    const checkDBData = async (username) => {
      try {
        ...
        const hasDateRange = !!(dateSince.value || dateUntil.value);
        ...
        if (hasDateRange) {
          const dateRangeAccounts = await mediaDB.accounts.where("username").equals(cleanUsername).filter(
            (acc) => acc.batch_mode === "date_range" && acc.date_since === dateSince.value && acc.date_until === dateUntil.value && acc.media_type === currentMediaType
          ).count();
          count = dateRangeAccounts;
        } else {
          const regularAccounts = await mediaDB.accounts.where("username").equals(cleanUsername).filter(
            (acc) => (!acc.batch_mode || acc.batch_mode !== "date_range") && acc.media_type === currentMediaType
          ).count();
          count = regularAccounts;
        }
    ...
    hooks.useEffect(() => {
      ...
      if (accountInfo.username) {
        ...
        if (accountInfo.media_type) {
          mediaType.value = accountInfo.media_type;
          appOptionsManager.set("mediaType", accountInfo.media_type);
        }
    ...
    const retryWithTokenGeneration = async (cleanUsername, authSettings) => {
      ...
      while (isRetrying.value && !controller.signal.aborted) {
        ...
        try {
          const nextToken = await mediaDownloaderDB.getNextToken();
          let tokenToUse;
          if (nextToken) {
            tokenToUse = nextToken;
            const settings = await mediaDownloaderDB.getAuthSettings();
            retryTokenCurrent.value = (settings?.current_token_index ?? 1) - 1;
            retryTokenTotal.value = settings?.token_list?.length ?? 0;
          } else {
            const tokenResult = await mediaDownloaderAPI.generateAuthToken(authSettings.patreon_auth);
            tokenToUse = tokenResult.auth_token;
          ...
          authSettings.auth_token = tokenToUse;
          authState.authToken.value = tokenToUse;
    ...
    const handleFetchMedia = async (skipOverwriteCheck = false) => {
      ...
      const latestToken = authState.authToken.value || authSettings.auth_token;
      if (latestToken && latestToken !== authSettings.auth_token) {
        authSettings.auth_token = latestToken;
      }
      ...
      if (!skipOverwriteCheck) {
        const batchMode = dateSince.value || dateUntil.value ? "date_range" : void 0;
      ...
      const resetBatchState = () => {
        dashboardState.currentPage.value = 0;
      ...
      try {
        const existingAccounts = await mediaDownloaderDB.getAccountsByUsername(cleanUsername);
        if (existingAccounts.length > 0) {
          const matchingAccount = existingAccounts.filter(
            (acc) => acc.media_type === mediaType2 && acc.date_since === (dateSince.value || void 0) && acc.date_until === (dateUntil.value || void 0)
          ).sort((a, b) => b.cached_at - a.cached_at)[0];
          if (matchingAccount?.metadata?.cursor && matchingAccount.metadata.has_more) {
            resumeCursor = matchingAccount.metadata.cursor;
          }
        }
      } catch (error) {
      }
      ...
      currentFetchTotal.value = 0;
      abortController.signal.__timeoutCallback = () => {
        if (isLoading.value && !abortController.signal.aborted) {
          fetchStartTime.value = null;
          fetchElapsedSeconds.value = 0;
          showTimeoutModal.value = true;
        }
      };
      abortController.signal.__controller = abortController;
      if (resumeCursor) {
        try {
          const existingAccounts = await mediaDownloaderDB.getAccountsByUsername(cleanUsername);
          const matchingAccount = existingAccounts.filter(
          ...
          if (matchingAccount && matchingAccount.timeline.length > 0) {
            dashboardState.aggregatedTimeline.value = matchingAccount.timeline;
            dashboardState.aggregatedCount.value = matchingAccount.timeline.length;
            previousMediaCount.value = matchingAccount.timeline.length;
          } else {
            dashboardState.aggregatedTimeline.value = [];
            dashboardState.aggregatedCount.value = 0;
            previousMediaCount.value = 0;
          }
        } catch (error) {
          dashboardState.aggregatedTimeline.value = [];
          dashboardState.aggregatedCount.value = 0;
      ...
      dashboardState.fetchedPages.value = [];
      dashboardState.pageMediaCounts.value = {};
      if (incrementTimeoutRef.value !== null) {
        clearTimeout(incrementTimeoutRef.value);
        incrementTimeoutRef.value = null;
      }
      mediaIncrement.value = 0;
      ...
      try {
        const data = await mediaDownloaderAPI.fetchMediaData(
          ...
          authSettings.patreon_auth,
          {
            ...
            initialCursor: resumeCursor || void 0,
            onProgress: (total, newItems, cursor, newTimeline, accountInfo) => {
              currentFetchTotal.value = total;
              if (newTimeline && newTimeline.length > 0) {
                ...
                dashboardState.aggregatedCount.value = newCount;
                let increment = 0;
                if (previousMediaCount.value !== null) {
                  increment = newCount - previousMediaCount.value;
                } else {
                  increment = newCount;
                }
                if (increment > 0) {
                  mediaIncrement.value = increment;
                  if (incrementTimeoutRef.value !== null) {
                    clearTimeout(incrementTimeoutRef.value);
                  }
                  incrementTimeoutRef.value = window.setTimeout(() => {
                    mediaIncrement.value = 0;
                    incrementTimeoutRef.value = null;
                  }, 1e3);
                }
                previousMediaCount.value = newCount;
                const accountInfoToUse = accountInfo || accountData.value?.account_info || {
                  name: cleanUsername,
                  nick: cleanUsername,
                  date: "",
                  followers_count: 0,
                ...
                accountData.value = {
                  account_info: accountInfoToUse,
                  timeline: merged,
                  metadata: {
                    batch_size: 200,
                    cursor: cursor || null,
                    has_more: cursor !== null,
                    new_entries: merged.length,
page: 0
                  }
                };
                if (!abortController.signal.aborted && accountData.value && merged.length > 0) {
                  const batchMode = dateSince.value || dateUntil.value ? "date_range" : void 0;
                  mediaDownloaderDB.saveAccount({
                    username: cleanUsername,
                    account_info: accountData.value.account_info,
                    metadata: {
                      ...accountData.value.metadata,
                      new_entries: merged.length
                    },
                    timeline: merged,
                    batch_mode: batchMode,
                    batch_identifier: void 0,
media_type: mediaType2,
                    date_since: dateSince.value || void 0,
                    date_until: dateUntil.value || void 0
                  }).then(() => {
                    if (!abortController.signal.aborted) {
                      checkDBData(cleanUsername).catch(() => {
                      });
                    }
                  }).catch(() => {
                  });
        ...
        if (abortController.signal.aborted) {
          if (dashboardState.aggregatedTimeline.value.length > 0 && accountData.value) {
            try {
              const batchMode = dateSince.value || dateUntil.value ? "date_range" : void 0;
              await mediaDownloaderDB.saveAccount({
                ...
                metadata: {
                  ...accountData.value.metadata,
                  new_entries: dashboardState.aggregatedTimeline.value.length
                },
...
metadata: {
        ...
        dashboardState.currentBatchTimeline.value = dashboardState.aggregatedTimeline.value;
        dashboardState.hasMore.value = Boolean(data?.metadata?.has_more);
        dashboardState.currentPage.value = data?.metadata?.page ?? 0;
        if (!showAccountInfo.value) {
          showAccountInfo.value = true;
        }
        if (accountData.value) {
          try {
            ...
            await mediaDownloaderDB.saveAccount({
              ...
              timeline: accountData.value.timeline,
              batch_mode: batchMode,
              batch_identifier: void 0,
media_type: mediaType2,
              date_since: dateSince.value || void 0,
        ...
        mediaIncrement.value = 0;
        previousMediaCount.value = dashboardState.aggregatedCount.value || 0;
      } catch (error) {
        const apiError = error?.apiError;
        const errorData = error?.errorData;
        const raw = error instanceof Error ? error.message : "";
        const isDemoMode = (authSettings.patreon_auth || "").trim() === "xbatchdemo";
        const isTimeoutError = raw.includes("timeout") || raw.includes("Timeout");
        const isGalleryDLAuthError = raw.includes("Could not authenticate you") || raw.includes("Failed to fetch data") && raw.includes("401");
        const shouldRetry = apiError?.isRetryable === true || isGalleryDLAuthError || isTimeoutError;
    ...
    const checkResumeCursor = async () => {
      try {
        const rawUsername = detectedUsername.value || "";
        if (!rawUsername) {
          hasResumeCursor.value = false;
          return;
        }
        const cleanUsername = mediaDownloaderAPI.formatUsername(rawUsername);
        const mediaType2 = appOptionsManager.get("mediaType") ?? "all";
        ...
        hasResumeCursor.value = !!(matchingAccount?.metadata?.cursor && matchingAccount.metadata.has_more);
      } catch (error) {
        hasResumeCursor.value = false;
      }
    };
    ...
    const handleTimeoutGenerateToken = async () => {
      ...
      try {
        const authSettings = await mediaDownloaderDB.getAuthSettings();
        if (authSettings?.patreon_auth) {
          let newToken = null;
          const settings = await mediaDownloaderDB.getAuthSettings();
          if (settings?.token_list && settings.token_list.length > 0) {
            const currentIndex = settings.current_token_index ?? 0;
            if (currentIndex < settings.token_list.length) {
              const nextToken = await mediaDownloaderDB.getNextToken();
              if (nextToken) {
          ...
          if (!newToken) {
            try {
              await mediaDownloaderAPI.refreshAuthTokens(authSettings.patreon_auth);
              const updatedSettings = await mediaDownloaderDB.getAuthSettings();
              if (updatedSettings?.token_list && updatedSettings.token_list.length > 0) {
                const nextToken = await mediaDownloaderDB.getNextToken();
                if (nextToken) {
                  newToken = nextToken;
                }
          ...
          if (!newToken) {
            const tokenResult = await mediaDownloaderAPI.generateAuthToken(authSettings.patreon_auth);
            if (tokenResult.auth_token) {
              newToken = tokenResult.auth_token;
            }
          }
          if (newToken) {
            await mediaDownloaderDB.saveAuthSettings(newToken, authSettings.patreon_auth);
            authState.authToken.value = newToken;
            fetchStartTime.value = null;
            fetchElapsedSeconds.value = 0;
            await new Promise((resolve) => setTimeout(resolve, 100));
            await handleFetchMedia(true);
          } else {
            errorMessage.value = t("Failed to generate token");
            playErrorSound();
          }
        }
      } catch (error) {
    ...
    hooks.useEffect(() => {
      checkResumeCursor();
      const unsubscribe = detectedUsername.subscribe(() => {
        checkResumeCursor();
      });
      return unsubscribe;
    }, []);
...
media_type: mediaType2,
    ...
    const handleDownloadMedia = async () => {
      ...
      try {
        ...
        const batchMode = dateSince.value || dateUntil.value ? "date_range" : void 0;
        const batchInfo = { mode: batchMode, page: dashboardState.currentPage.value };
...
u(IconChevronLeft, { size: 16 }),
              ...
              (isLoadedFromDB.value || isUpdating.value) && u("div", { class: "join", children: [
                hasResumeCursor.value && u("button", { class: "btn btn-info btn-sm join-item", onClick: handleResume, disabled: isLoading.value, children: [
u(IconRefresh, { size: 16 }),
                  t("Resume")
                ] }),
u("button", { class: "btn btn-accent btn-sm join-item", onClick: handleUpdateDataClick, disabled: isLoading.value, children: isLoading.value && isUpdating.value ? u(preact.Fragment, { children: [
...
u("div", { class: "ml-auto flex items-center gap-2", children: (() => {
              ...
              dashboardState.currentPage.value;
              isLoading.value && dashboardState.loadingDirection.value === "prev";
              isLoading.value && dashboardState.loadingDirection.value === "next";
              return null;
            })() })
          ] }),
...
u("p", { class: "text-sm opacity-50 mt-1", children: [
                ...
                (() => {
                  if (isLoadedFromDB.value) {
                    return u(preact.Fragment, { children: [
                      t("Media: {{media}}", { media: metadata.new_entries.toLocaleString() }),
                      mediaIncrement.value > 0 && u("span", { class: "text-success font-semibold ml-1", children: [
                        "+",
                        mediaIncrement.value.toLocaleString()
                      ] })
                    ] });
                  }
                  const mediaCount = dashboardState.aggregatedCount.value || metadata.new_entries;
                  return u(preact.Fragment, { children: [
                    t("Media: {{media}}", { media: mediaCount.toLocaleString() }),
                    mediaIncrement.value > 0 && u("span", { class: "text-success font-semibold ml-1", children: [
                      "+",
                      mediaIncrement.value.toLocaleString()
                    ] })
                ...
                lastFetchDuration.value !== null && !isLoading.value && u(preact.Fragment, { children: [
                  " • ",
u("span", { class: "opacity-60", children: t("Fetched in {{time}}", { time: formatTime(lastFetchDuration.value) }) })
                ] })
              ] })
            ] })
          ] }) }) }),
...
u(
                    "button",
                    {
                      ...
                      onClick: async () => {
                        ...
                        if (dashboardState.aggregatedTimeline.value.length > 0 && accountData.value) {
                          try {
                            const cleanUsername = mediaDownloaderAPI.formatUsername(detectedUsername.value || "");
                            const batchMode = dateSince.value || dateUntil.value ? "date_range" : void 0;
                            await mediaDownloaderDB.saveAccount({
                              username: cleanUsername,
                              account_info: accountData.value.account_info,
...
u("div", { class: "flex items-center gap-1 text-xs opacity-60", children: [
u("span", { class: "font-mono", children: formatTime(fetchElapsedSeconds.value) }),
u("span", { children: "/" }),
u("span", { class: "font-mono", children: formatTime(getRemainingTime()) })
                ] })
              ] })
            ) : u(preact.Fragment, { children: [
              (() => {
...
u(Modal, { show: showTimeoutModal.value, onClose: handleTimeoutStop, title: t("Request timeout"), class: "max-w-sm", children: u("div", { class: "space-y-4", children: [
u("p", { class: `text-sm${isArabic ? " text-right" : ""}`, dir: isArabic ? "rtl" : void 0, children: t("Request timeout - please try again") }),
u("div", { class: "modal-action", children: [
u(
              "button",
              {
                class: "btn btn-sm btn-ghost",
                onClick: handleTimeoutStop,
                children: t("Stop Fetch")
              }
            ),
u(
              "button",
              {
                ...
                onClick: handleTimeoutGenerateToken,
                children: [
u(IconKey, { size: 16 }),
...
u("div", { class: "collapse collapse-arrow bg-base-200 border border-base-300 rounded-box", children: [
u(
            "input",
            {
              type: "checkbox",
              checked: advancedSettingsOpen.value,
              onChange: (e) => {
                advancedSettingsOpen.value = e.target.checked;
              }
            }
          ),
u("div", { class: "collapse-title text-sm font-medium", children: t("Advanced Settings") }),
u("div", { class: "collapse-content", children: u("div", { class: "space-y-4 pt-2", children: [
...
u(
                "select",
                {
                  ...
                  onChange: (e) => {
                    ...
                    appOptionsManager.set("mediaType", value);
                  },
                  children: [
u("option", { value: "all", children: t("All Media") }),
u("option", { value: "image", children: t("Images") }),
u("option", { value: "video", children: t("Videos") }),
u("option", { value: "gif", children: t("GIFs") }),
u("option", { value: "text", children: t("Text (No Media)") })
                  ]
                }
              )
            ] }),
u("div", { class: "flex justify-between items-center", children: [
u("span", { class: "text-sm", children: t("Include Retweets") }),
u(
                "input",
                {
                  type: "checkbox",
...
u("div", { class: "card bg-base-100 card-border", children: u("div", { class: "card-body p-4", children: [
...
u("div", { class: "flex flex-col items-center gap-2", children: [
u("div", { class: "join", children: isLoading.value && !isRetrying.value ? u(preact.Fragment, { children: [
u(
              "button",
              {
...
u("div", { class: "join", children: [
              hasResumeCursor.value && u(
                "button",
                {
                  class: "btn btn-info btn-sm join-item",
                  onClick: handleResume,
                  disabled: !detectedUsername.value || !authState.patreonVerified.value || isLoading.value,
                  children: [
u(IconRefresh, { size: 16 }),
                    t("Resume")
                  ]
...
u(IconPlayerStop, { size: 16 }),
                    ...
                    const fetchKey = mediaType.value === "all" ? "Fetch" : mediaType.value === "video" ? "Fetch Videos" : mediaType.value === "image" ? "Fetch Images" : mediaType.value === "gif" ? "Fetch GIFs" : mediaType.value === "text" ? "Fetch Text" : "Fetch";
                    return u(preact.Fragment, { children: [
...
u(IconPhotoEdit, { size: 16 }),
          ...
          isLoading.value && u("div", { class: "flex items-center gap-1 text-xs opacity-60", children: [
u("span", { class: "font-mono", children: formatTime(fetchElapsedSeconds.value) }),
u("span", { children: "/" }),
u("span", { class: "font-mono", children: formatTime(getRemainingTime()) }),
            currentFetchTotal.value > 0 && u(preact.Fragment, { children: [
u("span", { class: "opacity-50", children: "•" }),
u("span", { children: [
                currentFetchTotal.value,
                " items"
              ] })
            ] })
          ] })
...
u(IconWriting, { size: 16 }),
  ...
  function ViewDatabaseModal({ isOpen, onClose, account, onDeleteEntry, onLoadDatabase }) {
    ...
    const isCopied = signals.useSignal(false);
    const failedThumbnails = signals.useSignal( new Set());
    hooks.useEffect(() => {
    ...
    const photoCount = account.timeline.filter((i) => i.type === "photo").length;
    const videoCount = account.timeline.filter((i) => i.type === "video").length;
    const gifCount = account.timeline.filter((i) => i.type === "animated_gif").length;
    ...
    const handleOpenPreview = (item, itemIndex) => {
      previewIndex.value = itemIndex;
      previewType.value = item.type;
      previewUrl.value = item.type === "text" ? "text" : item.url;
    };
    ...
    const handleDownloadFile = async (url, date, type, tweetId, content) => {
      const fileKey = `${tweetId}_${url || "text"}`;
    ...
    const getTypeIcon = (type) => {
      switch (type) {
        case "photo":
          return u(IconPhoto, { size: 24 });
        case "video":
          return u(IconVideo, { size: 24 });
        case "animated_gif":
          return u(IconGif, { size: 24 });
        case "text":
          return u(IconFileText, { size: 24 });
        default:
          return null;
      }
    };
    ...
    const getThumbnailUrl = (url, type, tweetId) => {
      if (!url) return url;
      if (type === "animated_gif" && url.includes("tweet_video/")) {
        const match = url.match(/tweet_video\/([^\/\.]+)/);
        if (match && match[1]) {
          return `https://pbs.twimg.com/tweet_video_thumb/${match[1]}?format=jpg&name=360x360`;
        }
      }
      if (url.includes("name=orig")) {
        return url.replace("name=orig", "name=360x360");
      }
      if (url.includes("name=large")) {
        return url.replace("name=large", "name=360x360");
      }
      if (url.includes("name=medium")) {
        return url.replace("name=medium", "name=360x360");
      }
      if (url.includes("name=thumb")) {
        return url.replace("name=thumb", "name=360x360");
      }
      if (url.includes("pbs.twimg.com/media/")) {
        const separator = url.includes("?") ? "&" : "?";
        return `${url}${separator}name=360x360`;
      }
      return url;
    };
    const handleSwipeLeft = () => {
      if (previewIndex.value < filteredTimeline.length - 1) {
        ...
        if (nextItem) {
          ...
          previewUrl.value = nextItem.type === "text" ? "text" : nextItem.url;
        }
      }
    };
    const handleSwipeRight = () => {
      if (previewIndex.value > 0) {
        ...
        if (prevItem) {
          ...
          previewUrl.value = prevItem.type === "text" ? "text" : prevItem.url;
        }
      }
    };
    ...
    hooks.useEffect(() => {
      if (!previewUrl.value && previewType.value !== "text") return;
    ...
    }, [previewUrl.value, previewType.value, previewIndex.value, filteredTimeline]);
    return u(preact.Fragment, { children: [
...
u("span", { class: "font-bold", children: account.account_info.friends_count.toLocaleString() }),
        ...
        account.media_type === "all" && u("div", { class: "flex items-center gap-2 justify-between", children: [
u("div", { class: "flex items-center gap-2", children: [
u("div", { class: "tooltip", "data-tip": `${t("All Media")} (${account.timeline.length.toLocaleString()})`, children: u(
              "button",
              {
                class: `btn btn-sm btn-square ${typeFilter.value === "all" ? "btn-neutral" : "btn-ghost"}`,
                onClick: () => handleTypeFilter("all"),
                "aria-label": t("All Media"),
                children: u(IconLibraryPhoto, { size: 18 })
              }
            ) }),
            photoCount > 0 && u("div", { class: "tooltip", "data-tip": `${t("Images")} (${photoCount.toLocaleString()})`, children: u(
              "button",
              {
            ...
            videoCount > 0 && u("div", { class: "tooltip", "data-tip": `${t("Videos")} (${videoCount.toLocaleString()})`, children: u(
              "button",
              {
            ...
            gifCount > 0 && u("div", { class: "tooltip", "data-tip": `${t("GIFs")} (${gifCount.toLocaleString()})`, children: u(
              "button",
              {
...
u("div", { class: "tooltip tooltip-left", "data-tip": t("Last Page"), children: u(
        ...
        account.media_type !== "all" && totalPages > 1 && u("div", { class: "flex justify-start", children: u("div", { class: "join", children: [
u("div", { class: "tooltip tooltip-right", "data-tip": t("First Page"), children: u(
            "button",
            {
              class: "join-item btn btn-sm",
              onClick: () => currentPage.value = 1,
...
u("div", { class: "tooltip tooltip-right", "data-tip": t("Last Page"), children: u(
            "button",
            {
              class: "join-item btn btn-sm",
              onClick: () => currentPage.value = totalPages,
...
u("div", { class: "space-y-4", children: (() => {
          ...
          const items = filteredTimeline.slice(startIndex, endIndex);
...
u("div", { class: "shrink-0", children: (item.type === "photo" || item.type === "animated_gif") && !failedThumbnails.value.has(item.url) ? u(
                  "div",
                  {
                    class: "w-12 h-12 rounded overflow-hidden bg-base-300 flex items-center justify-center relative cursor-pointer hover:opacity-80 transition-opacity",
                    onClick: () => {
                      const itemIndex = filteredTimeline.findIndex((i) => `${i.tweet_id}|${i.url}` === key);
                      if (item.type === "text") {
                        handleOpenPreview(item, itemIndex);
                      } else if (item.url) {
                        handleOpenFile(item.url);
                      }
                    },
                    role: "button",
                    tabIndex: 0,
                    ...
                    children: u(
                      "img",
                      {
                        src: getThumbnailUrl(item.url, item.type, item.tweet_id),
                        alt: "Thumbnail",
                        class: "w-full h-full object-cover",
                        loading: "lazy",
                        onError: () => {
                          failedThumbnails.value = new Set([...failedThumbnails.value, item.url]);
                        }
                      }
                    )
                  }
                  ...
                  "div",
                  {
                    class: `w-12 h-12 rounded flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity ${item.type === "photo" ? "bg-primary/20" : item.type === "video" ? "bg-secondary/20" : item.type === "text" ? "bg-warning/20" : "bg-accent/20"}`,
                    onClick: () => {
                      const itemIndex = filteredTimeline.findIndex((i) => `${i.tweet_id}|${i.url}` === key);
                      if (item.type === "text") {
                        handleOpenPreview(item, itemIndex);
                    ...
                    children: u("div", { class: `${item.type === "photo" ? "text-primary" : item.type === "video" ? "text-secondary" : item.type === "text" ? "text-warning" : "text-accent"}`, children: getTypeIcon(item.type) })
                  }
                ) }),
...
u("div", { class: "tooltip tooltip-left", "data-tip": isConverting ? t("Converting...") : item.type === "animated_gif" && (appOptionsManager.get("convertAnimatedGifs") ?? true) ? t("Convert & Download") : t("Download"), children: u(
                    "button",
                    {
                      ...
                      onClick: () => handleDownloadFile(item.url, item.date, item.type, item.tweet_id, "content" in item ? item.content : void 0),
...
u(
      ...
      (previewUrl.value || previewType.value) && $(
u(
          "div",
          {
            class: "fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center z-1000 px-4",
...
u(
              ...
              (() => {
                ...
                if (currentItem) {
                  return u("div", { class: "absolute top-4 left-1/2 transform -translate-x-1/2 flex flex-wrap items-center justify-center gap-3 px-4 py-2 bg-black/70 backdrop-blur-sm rounded-lg text-xs text-white", children: [
                    currentItem.view_count !== void 0 && u("div", { class: "flex items-center gap-1", children: [
u(IconEye, { size: 14 }),
u("span", { children: formatNumber(currentItem.view_count) })
                    ] }),
                    currentItem.favorite_count !== void 0 && u("div", { class: "flex items-center gap-1", children: [
u("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", children: u("path", { d: "M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" }) }),
u("span", { children: formatNumber(currentItem.favorite_count) })
                    ] }),
                    currentItem.retweet_count !== void 0 && u("div", { class: "flex items-center gap-1", children: [
u(IconRepeat, { size: 14 }),
u("span", { children: formatNumber(currentItem.retweet_count) })
                    ] }),
                    currentItem.bookmark_count !== void 0 && u("div", { class: "flex items-center gap-1", children: [
u("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", children: u("path", { d: "M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" }) }),
u("span", { children: formatNumber(currentItem.bookmark_count) })
                    ] }),
                    currentItem.source && u("div", { class: "flex items-center gap-1", children: u("span", { children: currentItem.source }) }),
                    currentItem.tweet_id && u("div", { class: "flex items-center gap-1 opacity-60", children: u("span", { children: currentItem.tweet_id }) })
                  ] });
                }
                return null;
              })(),
u("div", { class: "absolute bottom-4 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2", children: [
u("div", { class: "px-4 py-2 bg-black/70 backdrop-blur-sm rounded-lg text-xs text-white", children: u("span", { class: "text-sm", children: [
                ...
                (() => {
                  const currentItem = filteredTimeline[previewIndex.value];
                  if (currentItem) {
                    return u("div", { class: "px-4 py-2 bg-black/70 backdrop-blur-sm rounded-lg text-xs text-white whitespace-nowrap", children: u("span", { class: "text-xs", children: [
              ...
              ) : previewType.value === "text" ? u("div", { class: "relative", children: [
                (() => {
                  const currentItem = filteredTimeline[previewIndex.value];
                  if (currentItem && "content" in currentItem && currentItem.content) {
                    return u(
                      "button",
                      {
                        class: `btn btn-sm btn-square absolute -top-2 -right-2 z-10 ${isCopied.value ? "btn-success" : "btn-primary"}`,
                        onClick: () => handleCopyText(currentItem.content),
                        "aria-label": t("Copy"),
                        children: isCopied.value ? u(IconCircleCheck, { size: 16 }) : u(IconCopy, { size: 16 })
                      }
                    );
                  }
                  return null;
                })(),
u("div", { class: "max-w-2xl w-full max-h-[80vh] overflow-auto bg-base-100 rounded-lg p-4 md:p-6", children: (() => {
                  const currentItem = filteredTimeline[previewIndex.value];
                  if (currentItem && "content" in currentItem && currentItem.content) {
                    const linkifyText = (text) => {
                      ...
                      return parts.map((part, index) => {
                        ...
                        return u("span", { children: part }, index);
                      });
                    };
                    return u("div", { class: "prose prose-sm max-w-none", children: u("p", { class: "whitespace-pre-wrap wrap-break-word", children: linkifyText(currentItem.content) }) });
                  }
                  return u("div", { class: "text-center opacity-50", children: u("p", { children: t("No content available") }) });
                })() })
              ] }) : u(
                "video",
                {
  ...
  function Database({ isVisible, onCountChange, onLoadToDashboard } = {}) {
    const { t, i18n } = useTranslation();
    const isArabic = (i18n.language || "").startsWith("ar");
    const allFilteredAccounts = signals.useSignal([]);
    ...
    const filterByGroup = signals.useSignal(null);
    const showGroupModal = signals.useSignal(false);
    const accountToGroup = signals.useSignal(null);
    const availableGroups = signals.useSignal([]);
    const allAccounts = signals.useSignal([]);
    const newGroupName = signals.useSignal("");
    const totalPages = signals.computed(() => Math.max(1, Math.ceil(allFilteredAccounts.value.length / ITEMS_PER_PAGE)));
    const accounts = signals.computed(() => {
      const startIndex = (currentPage.value - 1) * ITEMS_PER_PAGE;
      const endIndex = startIndex + ITEMS_PER_PAGE;
      return allFilteredAccounts.value.slice(startIndex, endIndex);
    });
    ...
    const selectedAccounts = signals.useSignal( new Set());
    const isBulkDownloading = signals.useSignal(false);
    ...
    hooks.useEffect(() => {
      const unsubscribe = dbState.dbChangeSignal.subscribe(() => {
        loadAccounts();
      });
      return unsubscribe;
    }, []);
    const loadAccounts = async () => {
      try {
        isLoading.value = true;
        const accounts2 = await mediaDownloaderDB.getAllAccounts();
        allAccounts.value = accounts2;
        try {
          const groups = await mediaDownloaderDB.getAllGroups();
          availableGroups.value = groups;
        } catch (error) {
          console.error("Error loading groups:", error);
          availableGroups.value = [];
        }
        let filtered = accounts2;
        if (filterByDateRange.value) {
          filtered = filtered.filter(
            (acc) => acc.date_since && acc.date_until && (acc.batch_mode === "date_range" || acc.batch_mode === "batch_date_range")
          );
        }
        if (filterByGroup.value !== null) {
          if (filterByGroup.value === "") {
            filtered = filtered.filter((acc) => !acc.group);
          } else {
            filtered = filtered.filter((acc) => acc.group === filterByGroup.value);
          }
        }
        totalCount.value = accounts2.length;
        dateRangeCount.value = accounts2.filter(
          (acc) => acc.date_since && acc.date_until && (acc.batch_mode === "date_range" || acc.batch_mode === "batch_date_range")
        ).length;
        filtered.sort((a, b) => b.cached_at - a.cached_at);
        allFilteredAccounts.value = filtered;
    ...
    const processJsonFile = async (text, fileName) => {
      try {
        ...
        let normalizedBatchMode = void 0;
        if (data.batch_mode === "date_range" || data.batch_mode === "batch_date_range") {
          normalizedBatchMode = "date_range";
        } else if (data.batch_mode === "single" || data.batch_mode === "batch" || data.batch_mode === "auto") {
          normalizedBatchMode = void 0;
        }
        let normalizedMediaType = data.media_type || "all";
        if (normalizedMediaType && !["all", "image", "video", "gif", "text"].includes(normalizedMediaType)) {
          normalizedMediaType = "all";
        }
        const normalizedTimeline = (data.timeline || []).map((item) => ({
          date: item.date,
...
width: item.width,
        ...
        const account = {
          ...
          metadata: data.metadata || { new_entries: 0 },
          batch_mode: normalizedBatchMode,
...
media_type: normalizedMediaType,
        ...
        await mediaDownloaderDB.saveAccount(account);
        playSuccessSound();
      } catch (error) {
    ...
    const handleDownloadAccount = async (account) => {
      if (!account.id) return;
      downloadingId.value = account.id;
      databaseDownloadState.resetDownloadState(account.id);
      try {
        const batchMode = account.batch_mode === "date_range" ? "date_range" : void 0;
        const batchInfo = batchMode ? { mode: batchMode, page: 1 } : void 0;
        await mediaDownloader.downloadAccountMedia(account, (progress) => {
          downloadProgress.value = { ...downloadProgress.value, [account.id]: progress.percentage };
          downloadCurrent.value = { ...downloadCurrent.value, [account.id]: progress.current };
          downloadTotal.value = { ...downloadTotal.value, [account.id]: progress.total };
          downloadCurrentFile.value = { ...downloadCurrentFile.value, [account.id]: progress.currentFile || "" };
          downloadConverting.value = { ...downloadConverting.value, [account.id]: progress.converting || false };
        }, batchInfo);
        playSuccessSound();
      } catch (error) {
        if (error?.message !== "Download aborted") {
        ...
        databaseDownloadState.clearDownloadState(account.id);
      }
    };
    const handleBulkDownload = async () => {
      if (selectedAccounts.value.size === 0) return;
      isBulkDownloading.value = true;
      const accountsToDownload = allFilteredAccounts.value.filter((acc) => acc.id && selectedAccounts.value.has(acc.id));
      try {
        for (const account of accountsToDownload) {
    ...
    const toggleSelectAccount = (accountId) => {
      if (!accountId) return;
      const newSelected = new Set(selectedAccounts.value);
      if (newSelected.has(accountId)) {
        newSelected.delete(accountId);
      } else {
        newSelected.add(accountId);
      }
      selectedAccounts.value = newSelected;
    };
    const toggleSelectAll = () => {
      const allFilteredIds = new Set(allFilteredAccounts.value.filter((acc) => acc.id).map((acc) => acc.id));
      const allSelected = allFilteredIds.size > 0 && Array.from(allFilteredIds).every((id2) => selectedAccounts.value.has(id2));
      if (allSelected) {
        selectedAccounts.value = new Set();
      } else {
        selectedAccounts.value = new Set(allFilteredIds);
      }
    };
    const selectedCount = signals.computed(() => selectedAccounts.value.size);
    const exportAccount = async (account) => {
      ...
      try {
        ...
        const exportData = {
          ...
          cached_at_formatted: formatDate(account.cached_at),
          exported_at: Date.now(),
          exported_at_formatted: formatDate(Date.now()),
          date_time_format: dateFormat.value || appOptionsManager.get("dateTimeFormat") || "YYYY-MM-DD HH:mm:ss"
        };
        ...
        const fileName = `${sanitizeFilename(account.username)}_${exportTs}${mediaTypeSuffix}.json`;
    ...
    const confirmDelete = async () => {
      ...
      try {
        ...
        await loadAccounts();
        if (onCountChange) {
          const allAccounts2 = await mediaDownloaderDB.getAllAccounts();
          onCountChange(allAccounts2.length);
        }
      } catch (error) {
    ...
    const handleLoadDatabase = () => {
      ...
      onLoadToDashboard({
        username: account.username,
        batch_mode: account.batch_mode === "date_range" ? "date_range" : void 0,
        date_since: account.date_since,
        date_until: account.date_until,
        media_type: account.media_type
      });
    ...
    const formatTimeAgo = (timestamp) => {
      ...
      if (diff < 3600) return t("{{minutes}}m ago", { minutes: Math.floor(diff / 60) });
      if (diff < 86400) return t("{{hours}}h ago", { hours: Math.floor(diff / 3600) });
      if (diff < 604800) return t("{{days}}d ago", { days: Math.floor(diff / 86400) });
    ...
    const exportAllAccounts = async () => {
      try {
        ...
        const allAccounts2 = await mediaDownloaderDB.getAllAccounts();
        if (!allAccounts2.length) return;
        const fmt = dateFormat.value || appOptionsManager.get("dateTimeFormat") || "YYYY-MM-DD HH:mm:ss";
        const now = dayjs();
        const exportTs = now.format("YYYYMMDD_HHmmss");
        const files = allAccounts2.map((account, index2) => {
          const exportData = {
            username: account.username,
            account_info: account.account_info,
            metadata: account.metadata,
          ...
          const mediaTypeSuffix = account.media_type && account.media_type !== "all" ? `_${account.media_type}` : "";
          const uniqueSuffix = allAccounts2.filter((a) => a.username === account.username).length > 1 ? `_${index2 + 1}` : "";
          const fileName = `${sanitizeFilename(account.username)}_${exportTs}${mediaTypeSuffix}${uniqueSuffix}.json`;
...
u("div", { class: "tooltip tooltip-right", "data-tip": t("Filter by Date Range"), children: u(
              "button",
              {
                class: `btn btn-sm btn-square ${filterByDateRange.value ? "btn-active btn-primary" : ""}`,
...
u("div", { class: "dropdown dropdown-bottom", children: [
u("div", { tabIndex: 0, role: "button", class: "btn btn-sm", children: [
                filterByGroup.value === null ? t("All Groups") : filterByGroup.value === "" ? t("Ungroup") : u(preact.Fragment, { children: [
                  filterByGroup.value,
                  " (",
                  allFilteredAccounts.value.length,
                  ")"
                ] }),
u("svg", { width: "12px", height: "12px", class: "mt-px hidden size-2 fill-current opacity-60 sm:inline-block ml-auto", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 2048 2048", children: u("path", { d: "M1799 349l242 241-1017 1017L7 590l242-241 775 775 775-775z" }) })
              ] }),
u("ul", { tabIndex: 0, class: "dropdown-content menu bg-base-200 rounded-box z-20 w-52 p-2 shadow-lg border border-base-300", children: [
u("li", { children: u(
                  "button",
                  {
                    class: filterByGroup.value === null ? "active" : "",
                    onClick: () => {
                      filterByGroup.value = null;
                      currentPage.value = 1;
                      loadAccounts();
                    },
                    children: t("All Groups")
                  }
                ) }),
u("li", { children: u(
                  "button",
                  {
                    class: filterByGroup.value === "" ? "active" : "",
                    onClick: () => {
                      filterByGroup.value = "";
                      currentPage.value = 1;
                      loadAccounts();
                ...
                availableGroups.value.map((group) => {
                  const count = allAccounts.value.filter((acc) => acc.group === group).length;
                  return u("li", { children: u(
                    "button",
                    {
                      class: filterByGroup.value === group ? "active" : "",
                      onClick: () => {
                        filterByGroup.value = group;
                        currentPage.value = 1;
                        loadAccounts();
                      },
                      children: [
...
u("div", { tabIndex: 0, role: "button", class: "btn btn-sm btn-square btn-ghost", "aria-label": t("More options"), children: u(IconDots, { size: 16 }) }),
u("ul", { tabIndex: 0, class: "dropdown-content menu bg-base-200 rounded-box z-20 w-52 p-2 shadow-lg border border-base-300", children: [
u("li", { children: u(
                  "button",
                  {
...
u("div", { class: "tooltip tooltip-left", "data-tip": t("Download"), children: u(
              "button",
              {
                class: "btn btn-success btn-sm",
                onClick: handleBulkDownload,
                disabled: selectedCount.value === 0 || isBulkDownloading.value || downloadingId.value !== null,
                children: isBulkDownloading.value ? u(preact.Fragment, { children: [
u("span", { class: "loading loading-spinner loading-xs" }),
                  t("Downloading...")
                ] }) : u(preact.Fragment, { children: [
u(IconFileZip, { size: 16 }),
                  selectedCount.value > 0 ? `${t("Download")} (${selectedCount.value})` : t("Download")
                ] })
              }
            ) })
          ] })
        ] }),
        allFilteredAccounts.value.length > 0 && u("div", { class: "flex items-center gap-2 pb-2", children: [
u(
            "input",
            {
              type: "checkbox",
              ...
              checked: (() => {
                const allFilteredIds = new Set(allFilteredAccounts.value.filter((acc) => acc.id).map((acc) => acc.id));
                return allFilteredIds.size > 0 && Array.from(allFilteredIds).every((id2) => selectedAccounts.value.has(id2));
              })(),
              indeterminate: (() => {
                const allFilteredIds = new Set(allFilteredAccounts.value.filter((acc) => acc.id).map((acc) => acc.id));
                return selectedAccounts.value.size > 0 && selectedAccounts.value.size < allFilteredIds.size;
              })(),
              onChange: toggleSelectAll
            }
          ),
u("span", { class: "text-sm opacity-70", children: selectedCount.value > 0 ? `${selectedCount.value} ${t("selected")}` : t("Select All") })
        ] }),
        accounts.value.map((account) => u("div", { class: "relative w-full", children: [
          account.group && u("div", { class: "badge badge-soft badge-info badge-sm absolute -top-2 -left-2 z-10", children: account.group }),
u(
            "button",
            {
              class: "btn btn-circle btn-xs btn-error absolute -top-2 -right-2 z-10",
...
u("div", { class: "card bg-base-200 border border-base-300 w-full overflow-visible", children: [
u("div", { class: "card-body p-4 overflow-visible", children: u("div", { class: "flex items-center gap-4", children: [
u("div", { class: "flex items-center gap-2", children: u(
                "input",
                {
                  type: "checkbox",
                  class: "checkbox checkbox-sm",
                  checked: account.id ? selectedAccounts.value.has(account.id) : false,
                  onChange: () => toggleSelectAccount(account.id),
                  disabled: !account.id
                }
              ) }),
u("div", { class: "flex flex-col items-center gap-1", children: u("div", { class: "avatar", children: u(
                "div",
                {
                  class: "w-16 rounded-xl cursor-pointer hover:opacity-80 transition-opacity",
                  onClick: () => {
...
u("h3", { class: "font-semibold text-base", children: account.account_info.nick }),
                  account.batch_mode === "date_range" && account.date_since && account.date_until && u("div", { class: "badge badge-soft badge-info badge-sm", children: [
                    account.date_since,
                    " → ",
                    account.date_until
                  ] })
...
u("div", { class: "flex gap-2 mt-1", children: [
                  account.media_type && u("div", { class: "badge badge-soft badge-primary badge-sm", children: account.media_type === "all" ? t("All Media") : account.media_type === "image" ? t("Images") : account.media_type === "video" ? t("Videos") : account.media_type === "gif" ? t("GIFs") : account.media_type === "text" ? t("Text") : t("All Media") }),
u("div", { class: "badge badge-soft badge-secondary badge-sm", children: account.metadata.new_entries.toLocaleString() })
                ] }),
...
u("div", { class: "dropdown dropdown-end dropdown-top", children: [
u("div", { tabIndex: 0, role: "button", class: "btn btn-sm btn-square btn-ghost", "aria-label": t("More options"), children: u(IconDots, { size: 16 }) }),
u("ul", { tabIndex: 0, class: "dropdown-content menu bg-base-200 rounded-box z-50 w-48 p-2 shadow-lg border border-base-300", children: [
u("li", { children: u(
                      "button",
                      {
                        onClick: async () => {
                          accountToGroup.value = account;
                          newGroupName.value = account.group || "";
                          try {
                            const groups = await mediaDownloaderDB.getAllGroups();
                            availableGroups.value = groups;
                          } catch (error) {
...
u("li", { children: u(
                      ...
                      {
                        onClick: () => {
                          if (!account.username || !onLoadToDashboard) return;
                          onLoadToDashboard({
                            username: account.username,
                            batch_mode: account.batch_mode === "date_range" ? "date_range" : void 0,
                            date_since: account.date_since,
                        ...
                        disabled: deletingId.value === account.id || !onLoadToDashboard,
                        children: [
u(IconDatabaseImport, { size: 16 }),
                          t("Load Database")
                        ]
...
u("li", { children: u(
                      "button",
                      {
                        ...
                        disabled: exportingId.value === account.id || deletingId.value === account.id || downloadingId.value === account.id,
                        children: [
                          exportingId.value === account.id ? u("span", { class: "loading loading-spinner loading-xs" }) : u(IconDatabaseExport, { size: 16 }),
u("span", { children: [
                            t("Export"),
                            " (.json)"
                          ] })
...
u("div", { class: "tooltip tooltip-left", "data-tip": t("Download"), children: u(
                  "button",
                  {
                    ...
                    onClick: () => handleDownloadAccount(account),
                    disabled: downloadingId.value === account.id || deletingId.value === account.id || exportingId.value === account.id,
                    children: downloadingId.value === account.id ? u("span", { class: "loading loading-spinner loading-xs" }) : u(IconFileZip, { size: 16 })
                  }
                ) })
              ] })
            ] }) }),
            downloadingId.value === account.id && account.id && downloadProgress.value[account.id] !== void 0 && u("div", { class: "px-4 pb-4 space-y-2", children: [
u("div", { class: "flex justify-between text-sm", children: [
u("span", { children: [
                  downloadConverting.value[account.id] ? t("Converting GIFs...") : t("Downloading..."),
                  (downloadTotal.value[account.id] ?? 0) > 0 && ` (${(downloadCurrent.value[account.id] ?? 0).toLocaleString()}/${(downloadTotal.value[account.id] ?? 0).toLocaleString()})`
                ] }),
u("span", { children: [
                  downloadProgress.value[account.id],
                  "%"
                ] })
              ] }),
u(
                "progress",
                {
                  ...
                  value: downloadProgress.value[account.id],
                  max: "100"
                }
              ),
              downloadCurrentFile.value[account.id] && u("div", { class: "text-xs opacity-70 truncate", children: downloadCurrentFile.value[account.id] }),
u("div", { class: "flex justify-center", children: u(
                "button",
                {
                  class: "btn btn-error btn-sm",
                  onClick: () => mediaDownloader.abortDownload(),
...
u(
        Modal,
        {
          show: showGroupModal.value,
          onClose: () => {
            showGroupModal.value = false;
            accountToGroup.value = null;
            newGroupName.value = "";
          },
          title: t("Group Account"),
          class: "max-w-sm",
          children: u("div", { class: "space-y-2", children: [
            availableGroups.value.length > 0 && u("div", { class: "flex items-center gap-2", children: [
u(
                "select",
                {
                  ...
                  children: [
u("option", { value: "", children: t("Select a group") }),
                    availableGroups.value.map((group) => u("option", { value: group, children: group }, group))
                  ]
                }
              ),
              availableGroups.value.length > 0 && u("div", { class: "tooltip tooltip-left", "data-tip": t("Delete selected group"), children: u(
                "button",
                {
                  class: "btn btn-sm btn-square btn-error",
                  disabled: !newGroupName.value || !availableGroups.value.includes(newGroupName.value),
                  onClick: () => {
                    if (newGroupName.value && availableGroups.value.includes(newGroupName.value)) {
                      const groupToDelete = newGroupName.value;
                      const accountsInGroup = allAccounts.value.filter((acc) => acc.group === groupToDelete);
                      Promise.all(accountsInGroup.map(
                        (acc) => acc.id ? mediaDownloaderDB.updateAccount(acc.id, { group: void 0 }) : Promise.resolve()
                      )).then(() => {
                        return mediaDownloaderDB.removeGroup(groupToDelete);
                      }).then(() => {
                        playSuccessSound();
                        loadAccounts();
                        showGroupModal.value = false;
...
u("div", { children: u(
              "input",
              {
                ...
                value: newGroupName.value,
                onInput: (e) => {
                  newGroupName.value = e.target.value;
                },
                onFocus: (e) => {
                  const select = e.target.closest(".space-y-2")?.querySelector("select");
                  if (select && newGroupName.value) {
                    const optionValues = Array.from(select.options).map((opt) => opt.value);
                    if (optionValues.includes(newGroupName.value)) {
                      select.value = "";
                    }
                  }
                },
                onKeyDown: (e) => {
                  if (e.key === "Enter") {
                    ...
                    if (groupName && accountToGroup.value?.id) {
                      playClickSound();
                      mediaDownloaderDB.updateAccount(accountToGroup.value.id, { group: groupName }).then(() => {
                        playSuccessSound();
                        newGroupName.value = "";
                        loadAccounts();
                        showGroupModal.value = false;
...
u("div", { class: "modal-action", children: [
              accountToGroup.value?.group && u(
                "button",
                {
                  class: "btn btn-sm btn-ghost",
                  onClick: () => {
                    if (accountToGroup.value?.id) {
                      playClickSound();
                      mediaDownloaderDB.updateAccount(accountToGroup.value.id, { group: void 0 }).then(() => {
                        playSuccessSound();
                        loadAccounts();
                        showGroupModal.value = false;
                        accountToGroup.value = null;
...
u(
                "button",
                {
                  ...
                  onClick: () => {
                    ...
                    if (groupName && accountToGroup.value?.id) {
                      playClickSound();
                      mediaDownloaderDB.addGroup(groupName).then(() => {
                        return mediaDownloaderDB.updateAccount(accountToGroup.value.id, { group: groupName });
                      }).then(async () => {
                        try {
                          const groups = await mediaDownloaderDB.getAllGroups();
                          availableGroups.value = groups;
                  ...
                  disabled: !newGroupName.value.trim() || !accountToGroup.value?.id,
                  children: t("Add")
                }
              )
            ] })
...
u(
  ...
  function Auth() {
    ...
    const isRefreshing = signals.useSignal(false);
    ...
    const refreshMessage = signals.useSignal("");
    const refreshSuccess = signals.useSignal(false);
    const isCopied = signals.useSignal(false);
    const lastVerifiedPatreonAuth = signals.useSignal("");
    const hasInvalidVerify = signals.useSignal(false);
    const hasTokenList = signals.useSignal(false);
    hooks.useEffect(() => {
      const initAuth = async () => {
        await loadAuthSettings();
        await checkAndAutoRefreshToken();
      };
      initAuth();
      const interval = setInterval(() => {
    ...
    const loadAuthSettings = async () => {
      try {
        ...
        if (settings) {
          ...
          if (settings.show_auth_token !== void 0) {
            showAuthToken.value = settings.show_auth_token;
          }
          if (settings.show_patreon_auth !== void 0) {
            showPatreonAuth.value = settings.show_patreon_auth;
          }
          hasTokenList.value = Boolean(settings.token_list && settings.token_list.length > 0);
          if (isPatreonValid.value) {
            lastVerifiedPatreonAuth.value = settings.patreon_auth;
          } else if (settings.patreon_auth && settings.patreon_verified === false && settings.patreon_verified_auth === settings.patreon_auth) {
            lastVerifiedPatreonAuth.value = settings.patreon_auth;
            hasInvalidVerify.value = true;
          }
        }
      } catch (error) {
      }
    ...
    const autoSaveAuthToken = async (value) => {
      try {
        await mediaDownloaderDB.saveAuthSettings(value, patreonAuth.value, showAuthToken.value, showPatreonAuth.value);
    ...
    const autoSavePatreonAuth = async (value) => {
      try {
        await mediaDownloaderDB.saveAuthSettings(authToken.value, value, showAuthToken.value, showPatreonAuth.value);
        await mediaDownloaderDB.setPatreonVerified(false);
        authState.patreonAuth.value = value;
        authState.patreonVerified.value = false;
      } catch (error) {
      }
      if (value !== lastVerifiedPatreonAuth.value) {
        hasInvalidVerify.value = false;
    ...
    const verifyPatreonAuth = async () => {
      ...
      try {
        ...
        lastVerifiedPatreonAuth.value = patreonAuth.value;
        hasInvalidVerify.value = !data.valid;
        if (data.valid) {
          playSuccessSound();
        } else {
          playErrorSound();
    ...
    const refreshAuthTokens = async (silent = false, skipLoadingState = false) => {
      if (!isPatreonValid.value) {
        if (!silent) {
          refreshMessage.value = t("Please verify Patreon auth first");
          setTimeout(() => refreshMessage.value = "", 2e3);
        }
        return;
      }
      try {
        ...
        const data = await mediaDownloaderAPI.refreshAuthTokens(patreonAuth.value);
        if (data.success && data.tokens && data.tokens.length > 0) {
          await mediaDownloaderDB.saveTokenList(data.tokens, 0);
          const firstToken = data.tokens[0];
          if (firstToken) {
            authToken.value = firstToken;
            await autoSaveAuthToken(firstToken);
            authState.authToken.value = firstToken;
          }
          hasTokenList.value = true;
          refreshSuccess.value = true;
          if (!silent) {
            refreshMessage.value = `Tokens refreshed successfully. ${data.count} tokens available.`;
            playSuccessSound();
          }
        } else {
          refreshSuccess.value = false;
          hasTokenList.value = false;
          if (!silent) {
            refreshMessage.value = t("Failed to refresh tokens");
            playErrorSound();
          }
        }
        if (!silent) {
          setTimeout(() => refreshMessage.value = "", 3e3);
        }
      } catch (error) {
        const raw = error instanceof Error ? error.message : "";
        const httpMatch = raw.match(/^HTTP error! status: (\d+)/);
        const msg = httpMatch ? t("HTTP error! status: {{status}}", { status: httpMatch[1] }) : (raw ? t(raw) : "") || "Token refresh failed. Please try again";
        refreshSuccess.value = false;
        if (!silent) {
    ...
    const checkAndAutoRefreshToken = async () => {
      try {
        const settings = await mediaDownloaderDB.getAuthSettings();
        if (!settings || !settings.patreon_verified || !settings.patreon_auth) {
          return;
        }
        if (settings.patreon_verified_auth !== settings.patreon_auth) {
          return;
        }
        const lastRefresh = settings.last_token_refresh;
        if (!lastRefresh) {
          return;
        }
        const now = Date.now();
        ...
        if (timeSinceLastRefresh >= twentyFourHours) {
          patreonAuth.value = settings.patreon_auth;
          isPatreonValid.value = true;
          await refreshAuthTokens(true);
        }
      } catch (error) {
      }
    };
    const generateAuthToken = async () => {
      ...
      try {
        ...
        const settings = await mediaDownloaderDB.getAuthSettings();
        if (!settings?.token_list || settings.token_list.length === 0) {
          await refreshAuthTokens(true, true);
          const updatedSettings = await mediaDownloaderDB.getAuthSettings();
          if (updatedSettings?.token_list && updatedSettings.token_list.length > 0) {
            const nextToken = await mediaDownloaderDB.getNextToken();
            if (nextToken) {
              authToken.value = nextToken;
              await autoSaveAuthToken(nextToken);
              authState.authToken.value = nextToken;
              generationSuccess.value = true;
              const currentIndex = updatedSettings.current_token_index ?? 0;
              generationMessage.value = `Token generated successfully. Token ${currentIndex} of ${updatedSettings.token_list.length}`;
              playSuccessSound();
              setTimeout(() => generationMessage.value = "", 2e3);
              return;
            }
        ...
        if (settings?.token_list && settings.token_list.length > 0) {
          ...
          if (nextToken) {
            ...
            generationSuccess.value = true;
            const currentIndex = settings.current_token_index ?? 0;
            generationMessage.value = `Token generated successfully. Token ${currentIndex} of ${settings.token_list.length}`;
            playSuccessSound();
            setTimeout(() => generationMessage.value = "", 2e3);
            return;
          }
...
u("div", { children: [
u("label", { class: "label mb-1", children: u("span", { class: "text-sm flex items-center gap-1", children: [
          t("Patreon Auth"),
u("div", { class: "tooltip tooltip-right max-w-[200px] sm:max-w-none", "data-tip": t("Subscribe for $5 on Patreon and your auth code will be automatically emailed to you within a few minutes."), children: u(IconInfoCircle, { size: 14, class: "opacity-70" }) })
        ] }) }),
...
u("svg", { class: `h-4 w-4 ${!patreonAuth.value.trim() ? "opacity-50" : isPatreonValid.value ? "text-success" : hasInvalidVerify.value && patreonAuth.value === lastVerifiedPatreonAuth.value ? "text-error" : "opacity-50"}`, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: u(
              "g",
              {
...
u(
              "span",
              {
                ...
                onClick: async () => {
                  showPatreonAuth.value = !showPatreonAuth.value;
                  try {
                    await mediaDownloaderDB.saveAuthSettings(authToken.value, patreonAuth.value, showAuthToken.value, showPatreonAuth.value);
                  } catch (error) {
                  }
                },
...
u("label", { class: "label mb-1", children: u("span", { class: "text-sm flex items-center gap-1", children: [
          t("Auth Token"),
u("div", { class: "tooltip tooltip-right max-w-[200px] sm:max-w-none", "data-tip": t("Paid members can automatically generate auth tokens after verifying Patreon auth—no manual searching required."), children: u(IconInfoCircle, { size: 14, class: "opacity-70" }) })
        ] }) }),
u("div", { class: "join w-full", children: [
u("div", { class: "flex-1", children: u("label", { class: "input input-bordered input-sm join-item flex items-center gap-2 w-full", children: [
u("svg", { class: `h-4 w-4 ${authToken.value.trim() ? "text-success" : "opacity-50"}`, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", children: u(
              "g",
              {
                strokeLinejoin: "round",
                strokeLinecap: "round",
...
u(
            "button",
            {
              class: `btn btn-sm join-item w-28 ${isCopied.value ? "btn-success" : "btn-neutral"}`,
              onClick: async () => {
                if (authToken.value) {
                  try {
              ...
              disabled: !authToken.value,
              children: isCopied.value ? u(preact.Fragment, { children: [
u(IconCircleCheck, { size: 16 }),
                t("Copied")
              ] }) : u(preact.Fragment, { children: [
u(IconCopy, { size: 16 }),
...
u("div", { class: "join w-full mt-2", children: [
u(
            "button",
            {
              ...
              children: isGenerating.value ? u("span", { class: "loading loading-spinner loading-xs" }) : u(preact.Fragment, { children: [
u(IconKey, { size: 16 }),
                t("Generate")
              ] })
            }
...
u(
            "button",
            {
              ...
              onClick: () => refreshAuthTokens(false),
              disabled: isRefreshing.value || !isPatreonValid.value || patreonAuth.value.trim() === "xbatchdemo",
              children: isRefreshing.value ? u(preact.Fragment, { children: [
u("span", { class: "loading loading-spinner loading-xs" }),
                t("Refreshing"),
                "..."
              ] }) : u(preact.Fragment, { children: [
...
u("span", { dir: isArabic ? "rtl" : void 0, children: generationMessage.value })
        ...
        refreshMessage.value && u("div", { role: "alert", class: `alert alert-soft mt-2 ${refreshSuccess.value ? "alert-success" : "alert-error"}`, children: [
          refreshSuccess.value ? u(IconCircleCheck, { size: 20 }) : u(IconCircleX, { size: 20 }),
u("span", { dir: isArabic ? "rtl" : void 0, children: refreshMessage.value })
        ] })
      ] }),
...
u("div", { children: [
          ...
          " ",
u("a", { class: "text-primary opacity-80 hover:opacity-100", href: "mailto:support@exyezed.cc", children: "Email" }),
          " ",
          t("or"),
          " ",
u("a", { class: "text-primary opacity-80 hover:opacity-100", href: "https://wa.me/6285212034908", target: "_blank", rel: "noopener noreferrer", children: "WhatsApp" })
        ] })
      ] })
    ] }) });
  }
  const flagSE = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20id='flag-icons-se'%20viewBox='0%200%20640%20480'%3e%3cpath%20fill='%23005293'%20d='M0%200h640v480H0z'/%3e%3cpath%20fill='%23fecb00'%20d='M176%200v192H0v96h176v192h96V288h368v-96H272V0z'/%3e%3c/svg%3e";
  ...
  const flagGB = "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20id='flag-icons-gb'%20viewBox='0%200%20640%20480'%3e%3cpath%20fill='%23012169'%20d='M0%200h640v480H0z'/%3e%3cpath%20fill='%23FFF'%20d='m75%200%20244%20181L562%200h78v62L400%20241l240%20178v61h-80L320%20301%2081%20480H0v-60l239-178L0%2064V0z'/%3e%3cpath%20fill='%23C8102E'%20d='m424%20281%20216%20159v40L369%20281zm-184%2020%206%2035L54%20480H0zM640%200v3L391%20191l2-44L590%200zM0%200l239%20176h-60L0%2042z'/%3e%3cpath%20fill='%23FFF'%20d='M241%200v480h160V0zM0%20160v160h640V160z'/%3e%3cpath%20fill='%23C8102E'%20d='M0%20193v96h640v-96zM273%200v480h96V0z'/%3e%3c/svg%3e";
  ...
  function Settings() {
    ...
    const currentConfig = SERVER_CONFIG[currentServer] || SERVER_CONFIG.washington;
    return u("div", { class: "space-y-4", children: [
u("div", { class: "flex items-center justify-between", children: [
...
u("div", { class: "w-24 truncate text-xs text-left", children: currentConfig.name }),
u(
                  "svg",
                  {
                    width: "12px",
...
u(
            ...
            {
              tabIndex: 0,
              class: "dropdown-content bg-base-200 text-base-content rounded-box mt-2 max-h-52 overflow-y-auto border-(length:--border) border-white/5 shadow-2xl outline-(length:--border) outline-black/5",
...
u("li", { class: "menu-title text-xs", children: t("Server") }),
                Object.entries(SERVER_CONFIG).map(([key, config]) => u("li", { children: u(
                  "button",
                  {
                    class: cx("gap-3 px-2", currentServer === key && "[&_svg]:visible"),
                    onClick: () => {
                      playRadioClickSound();
...
u("span", { class: "text-sm flex items-center gap-1", children: [
          t("Server Timeout"),
u("div", { class: "tooltip tooltip-right", "data-tip": t("Timeout for server responses in seconds. Auto-generate token if timeout occurs."), children: u(IconInfoCircle, { size: 14, class: "opacity-70" }) })
        ] }),
u(
          "input",
          {
            ...
            value: appOptionsManager.get("apiTimeout") ?? 60,
            onChange: (e) => {
              const v = parseInt(e.target.value, 10);
              let safe = Number.isFinite(v) && v >= 1 ? v : 60;
              if (safe > 300) {
                safe = 300;
              }
              appOptionsManager.set("apiTimeout", safe);
              force((x) => x + 1);
            },
            onBlur: (e) => {
              const v = parseInt(e.target.value, 10);
...
u("div", { class: "tooltip tooltip-right", "data-tip": t("If downloads fail, use concurrent 1"), children: u(IconInfoCircle, { size: 14, class: "opacity-70" }) })
        ] }),
u(
          "input",
          {
...
u(
                "button",
                {
                  ...
                  onClick: () => {
                    ...
                    appOptionsManager.set("apiServer", "washington");
                    appOptionsManager.set("apiTimeout", 60);
                    appOptionsManager.set("mediaType", "all");
                    appOptionsManager.set("includeRetweets", false);
                    appOptionsManager.set("convertAnimatedGifs", false);
                    appOptionsManager.set("convertGifsExternal", false);
...
u("div", { class: "modal-box transition-all duration-300 ease-in-out overflow-visible", children: [
u("div", { class: "flex items-center justify-between mb-4", children: [
u(Title, {}),
u("div", { class: "flex items-center gap-2", children: [
u(
...
u(
  ...
  function MediaDownloaderApp() {
    ...
    const databaseDownloadProgress = signals.computed(() => {
      const accountId = databaseDownloadState.downloadingId.value;
      if (accountId === null) return 0;
      return databaseDownloadState.downloadProgress.value[accountId] ?? 0;
    });
    const showDatabaseProgress = signals.computed(() => {
      return databaseDownloadState.downloadingId.value !== null && databaseDownloadProgress.value > 0;
    });
    return u(preact.Fragment, { children: [
u("style", { children: `
          @keyframes sparkle {
...
u(IconBrandTwitter, { size: 48, "stroke-width": 1.25, class: "text-white" }),
            ...
            showDatabaseProgress.value && !showMediaDownloader.value && u("div", { class: "absolute -bottom-1 -right-1 flex items-center justify-center", children: u(
              "div",
              {
                class: "radial-progress text-info bg-base-100",
                style: `--value:${databaseDownloadProgress.value}; --size:2rem; --thickness:4px;`,
                role: "progressbar",
                "aria-valuenow": Math.round(databaseDownloadProgress.value),
                children: u("span", { class: "text-[10px] font-bold", children: Math.round(databaseDownloadProgress.value) })
              }
            ) })
          ]
        }
    ...
    if (typeof window.GM_addStyle !== "undefined") {
      ...
      if (chromeRuntime && chromeRuntime.sendMessage) {
        chromeRuntime.sendMessage(
          { action: "fetchFontCSS" },
          (response) => {
            if (response && response.success && response.css) {
              const style = document.createElement("style");
              style.id = "tmd-google-fonts";
