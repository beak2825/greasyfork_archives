// ==UserScript==
// @name         Google Maps remember me
// @namespace    http://tampermonkey.net/
// @version      1.3
// @description  Remembers your last used Google (Maps) user
// @author       JKamsker
// @grant        none
...
// @downloadURL https://update.greasyfork.org/scripts/486950/Google%20Maps%20remember%20me.user.js
// @updateURL https://update.greasyfork.org/scripts/486950/Google%20Maps%20remember%20me.meta.js
// ==/UserScript==
...
(function () {
  ...
  function getLocalStorageKey() {
    if (window.location.href.includes("/maps")) {
      return "authuserIdMaps";
    } else {
      return "authuserIdGoogle";
    }
  }

  function getAuthUserId() {
    let localStorageKey = getLocalStorageKey();
    let authuserId = localStorage.getItem(localStorageKey);
    return authuserId;
  }
  ...
  function ensureAuthUser() {
    ...
    if (authUserIdIsSet) {
      ...
      let localStorageKey = getLocalStorageKey();
      let storedAuthuserId = localStorage.getItem(localStorageKey);
      if (authuserId !== storedAuthuserId) {
        localStorage.setItem(localStorageKey, authuserId);
      }
    }
  }
