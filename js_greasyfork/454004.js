...
// @downloadURL https://update.greasyfork.org/scripts/454004/Tools%3A%20Tyler.user.js
// @updateURL https://update.greasyfork.org/scripts/454004/Tools%3A%20Tyler.meta.js
// ==/UserScript==
...
var menu = document.querySelector("#rga");

let raffle = document.createElement('li');
raffle.innerHTML = "<a href=purchasepolicy><font color=#00ff00>RGA: TTVILLE2</a>"

insertAfter(raffle, menu.children[3]);
...
#sum_chaos,#sum_power,#sum_ele,#sum_atk,#sum_hp,#sum_wilderness{color:#454545 !important;}
`);
...
<th class="account"><b>POWER &#9662;<br><span id="sum_power"></span></b></th>
<th class="account"><b>ELE &#9662;<br><span id="sum_ele"></span></b></th>
<th class="account"><b>ATK &#9662;<br><span id="sum_atk"></span></b></th>
<th class="account"><b>HP &#9662;<br><span id="sum_hp"></span></b></th>
<th class="account"><b>CHAOS &#9662;<br><span id="sum_chaos"></span></b></th>
<th class="account"><b>WILDERNESS &#9662;<br><span id="sum_wilderness"></span></b></th>
...
sum_power += parseInt((power[1]).replaceAll(",",""))
sum_ele += parseInt((eledmg[1]).replaceAll(",",""))
sum_atk += parseInt((attack[1]).replaceAll(",",""))
sum_hp += parseInt((hp[1]).replaceAll(",",""))
sum_chaos += parseInt((chaos[1]).replaceAll(",",""))
sum_wilderness += parseInt((wilderness[1]).replaceAll(",",""))

document.querySelector("#sum_power").innerHTML = sum_power.toLocaleString("en-US")
document.querySelector("#sum_ele").innerHTML = sum_ele.toLocaleString("en-US")
document.querySelector("#sum_atk").innerHTML = sum_atk.toLocaleString("en-US")
document.querySelector("#sum_hp").innerHTML = sum_hp.toLocaleString("en-US")
document.querySelector("#sum_chaos").innerHTML = sum_chaos.toLocaleString("en-US")
document.querySelector("#sum_wilderness").innerHTML = sum_wilderness.toLocaleString("en-US")
