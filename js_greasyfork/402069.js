...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/402069/SPARTAN%20DZ%20GAMER%20agario%20y%20copias%20de%20agario.user.js
// @updateURL https://update.greasyfork.org/scripts/402069/SPARTAN%20DZ%20GAMER%20agario%20y%20copias%20de%20agario.meta.js
// ==/UserScript==
    ...
    function miniMapInit() {
        ...
        if ($('#mini-map-options').length === 0) {
            ...
            var help_btn = $('<button>')
                ...
                .text('FB')
                .on('click', function(e) {
                    window.open('https://www.facebook.com/pato.phiolitha');
                    help_btn.blur();
                    return false;
                })
                .appendTo(form_group);
