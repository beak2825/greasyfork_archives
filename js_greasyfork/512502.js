// ==UserScript==
// @name         TORN: Revive Percentage2
// @namespace    medicare.private.revivepercentage
// @version      1.0.5.3
// @author       Medicare [2192547]
// @description  Show whether a revive would be covered under the contract.
// @icon         https://www.google.com/s2/favicons?sz=64&domain=torn.com
// @match        https://www.torn.com/profiles.php*
// @grant        GM_addStyle
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/512502/TORN%3A%20Revive%20Percentage2.user.js
// @updateURL https://update.greasyfork.org/scripts/512502/TORN%3A%20Revive%20Percentage2.meta.js
// ==/UserScript==
...
(function () {
  ...
  const REVIVE_CONTRACTS = [
    { faction: "Carbon", percentage: 50 },
     { faction: "Natural Selection II", percentage: 50 },
     { faction: "The Wolverines", percentage: 50 },
     { faction: "ODB", percentage: 50 },
     { faction: "HAKA", percentage: 50 },
      ];
