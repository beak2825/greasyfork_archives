...
// @name            UBits认领
// @name:en         UB adopt
// @namespace       https://ubits.club/
// @version         0.0.4
// @description     一键认领
// @description:en  one key claim all the seeding torrents in hdmayi.com.
// @author          Lancertony
// @match           https://ubits.club/userdetails.php?id=*
// @license         MIT
// @grant           unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/479347/UBits%E8%AE%A4%E9%A2%86.user.js
// @updateURL https://update.greasyfork.org/scripts/479347/UBits%E8%AE%A4%E9%A2%86.meta.js
// ==/UserScript==
  ...
  unsafeWindow.ClassificationClaimTorrents = async function (element, maxClaim) {
    ...
    for (const el of element) {
      ...
      if (claimId > 0) {
        ...
        xhr.open('POST', 'https://ubits.club/ajax.php', true);
