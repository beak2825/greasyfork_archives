// ==UserScript==
// @name        TinyChat Script (CTS V1.8.60) - UPDATED TRIVIA
// @version     1.8.60
...
//              jshint esversion: 6
// @namespace https://greasyfork.org/users/1239344
// @downloadURL https://update.greasyfork.org/scripts/489416/TinyChat%20Script%20%28CTS%20V1860%29%20-%20UPDATED%20TRIVIA.user.js
// @updateURL https://update.greasyfork.org/scripts/489416/TinyChat%20Script%20%28CTS%20V1860%29%20-%20UPDATED%20TRIVIA.meta.js
// ==/UserScript==
                ...
                if (!isCommand(arguments[1])) {
                    ...
                    if (arguments[1].length == 1 && CTS.Game.Trivia.ANum.includes(arguments[1].toUpperCase()) && !Guessed && !CTS.Game.Trivia.Waiting) {
                        if (CTS.Game.Trivia.Correct === arguments[1].toUpperCase()) {
                            ...
                            const wrongGuessValue = CTS.Game.Trivia.Worth >= 70 ? Math.round(CTS.Game.Trivia.Worth / 4) : Math.round(CTS.Game.Trivia.Worth / 3);
                            // Save Progress
