// ==UserScript==
// @name         Google Cool Theme
// @version      1.0
// @description  Cool google theme
...
// @downloadURL https://update.greasyfork.org/scripts/373394/Google%20Cool%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/373394/Google%20Cool%20Theme.meta.js
// ==/UserScript==

function initStyle() {
    jQuery("html, body").css("color", "#666");
    jQuery("html, body").css("background-color", "	#FF69B4");
    jQuery(".fbar").css("background-color", "	#FF69B4");
    jQuery("#fbar").css("background-color", "	#FF69B4");
    jQuery("#fbar").css("border-top", "1px solid #FF69B4");
    jQuery("#topabar").css("background-color", "	#FF69B4");
    jQuery("#hdtbSum").css("border-bottom", "1px solid 	#FF69B4");
    jQuery("#center_col ._Ak").css("border-bottom", "1px solid 	#FF69B4");
    jQuery("a:visited").css("color", "#fff");
    jQuery("a").css("color", "#8B8B8B");
    jQuery("h3.r a").css("color", "#000000");
