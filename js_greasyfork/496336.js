// ==UserScript==
// @name         BIT-网瑞达科技的资源访问控制系统（WebVPN） 助手
// @name:en     BIT - WebVPN Assistant from Netreda Technologies
// @namespace    http://tampermonkey.net/
// @version      1.1.9
// @description  更方便地使用北理的WebVPN服务，允许访问其他校内地址
// @description:en  Easier access to NLM's WebVPN service, which allows access to other on-campus addresses
// @author       aspen138
// @license      MIT
// @icon         https://vpn.jlu.edu.cn/favicon.ico
// @match        https://webvpn.bit.edu.cn/
// @match        https://webvpn.bit.edu.cn/http*
// @grant        GM_setValue
// @grant        GM_getValue
// @require      https://cdn.staticfile.org/vue/2.6.12/vue.min.js
// @require      https://cdn.staticfile.org/element-ui/2.14.1/index.min.js
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/496336/BIT-%E7%BD%91%E7%91%9E%E8%BE%BE%E7%A7%91%E6%8A%80%E7%9A%84%E8%B5%84%E6%BA%90%E8%AE%BF%E9%97%AE%E6%8E%A7%E5%88%B6%E7%B3%BB%E7%BB%9F%EF%BC%88WebVPN%EF%BC%89%20%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/496336/BIT-%E7%BD%91%E7%91%9E%E8%BE%BE%E7%A7%91%E6%8A%80%E7%9A%84%E8%B5%84%E6%BA%90%E8%AE%BF%E9%97%AE%E6%8E%A7%E5%88%B6%E7%B3%BB%E7%BB%9F%EF%BC%88WebVPN%EF%BC%89%20%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".body[data-v-593a5798]{position:fixed;z-index:1999;left:0;top:0;height:100%;width:420px;background-color:#fff;transition:all 0.5s;box-shadow:2px 3px 3px 0 rgba(0,0,0,0.1)}.btn-toggle[data-v-593a5798]{transition:all 0.5s;border-radius:0 30px 30px 0;width:30px;height:60px;background-color:#0078d4;cursor:pointer;position:absolute;right:-30px;top:50%;transform:translateY(-50%);text-align:center;z-index:2999}.btn-toggle svg[data-v-593a5798]{height:20px;width:20px;position:absolute;right:5px;top:20px;transition:all 0.5s}.body-hide[data-v-593a5798]{left:-420px;box-shadow:2px 3px 3px 0 rgba(0,0,0,0)}.body-hide .btn-toggle svg[data-v-593a5798]{transform:rotate(180deg)}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
// NAMESPACE OBJECT: ./src/logic/storage/mock.js
var mock_namespaceObject = {};
__webpack_require__.r(mock_namespaceObject);
__webpack_require__.d(mock_namespaceObject, {
  "getValue": () => (getValue),
  "setValue": () => (setValue)
});

// NAMESPACE OBJECT: ./src/logic/storage/actual.js
var actual_namespaceObject = {};
__webpack_require__.r(actual_namespaceObject);
__webpack_require__.d(actual_namespaceObject, {
  "getValue": () => (actual_getValue),
  "setValue": () => (actual_setValue)
});
    ...
    [
      _c(
        ...
        [
          ...
          _c("PluginPanel", {
            ref: "panel",
            on: { onOpenAddBookmarkDialog: _vm.handleOpenAddBookmarkDialog },
          }),
          _vm._v(" "),
          _c(
            "div",
      ...
      _vm._v(" "),
      _c("AddBookmarkDialog", {
        ref: "addBookmarkDialog",
        on: { onSuccess: _vm.handleAddBookmark },
      }),
    ],
    1
  )
...
const AppName = " 网瑞达科技的资源访问控制系统（WebVPN） 助手"
    ...
    [
      _c("el-scrollbar", [
        _c(
          ...
          [
            _c("h3", { staticClass: "sub-title" }, [_vm._v("直接跳转")]),
            _vm._v(" "),
            _c(
              "el-input",
              {
                staticClass: "input-with-select",
                attrs: { placeholder: "输入要跳转的链接" },
                nativeOn: {
              ...
              [
                _c("template", { slot: "prepend" }, [_vm._v("输入完整url")]),
                _vm._v(" "),
                _c("el-button", {
          ...
          [
            _c(
              ...
              [
                _vm._v("\n        收藏\n        "),
                _c("el-button", {
                  staticClass: "sub-title-btn",
                  attrs: {
                    type: _vm.bookmark.editMode ? "danger" : "primary",
                    icon: _vm.bookmark.editMode
                      ? "el-icon-close"
                      : "el-icon-edit",
                    size: "small",
                  },
                  on: {
                    click: function ($event) {
                      _vm.bookmark.editMode = !_vm.bookmark.editMode
                    },
                  },
                }),
                _vm._v(" "),
            ...
            _c(
              "el-table",
              {
                ...
                attrs: { data: _vm.bookmark.data, "show-header": false },
              },
              [
                _c("el-table-column", {
                        ...
                        return [
                          _c(
                            "el-button",
                            {
                              ...
                              on: {
                                click: function ($event) {
                                  return _vm.jumpTo(scope.row.url)
                                },
                              },
                            },
                            [
                ...
                _vm._v(" "),
                _vm.bookmark.editMode
                  ? _c("el-table-column", {
                      attrs: { fixed: "right", label: "操作", width: "65" },
                      scopedSlots: _vm._u(
                        [
                          {
                            key: "default",
                            fn: function (scope) {
                              return [
                                _c("el-button", {
                                  ...
                                  on: {
                                    click: function ($event) {
                                      return _vm.handleRemoveBookmark(
                                        scope.row.name
                                      )
                                    },
                                  },
            ...
            !_vm.isVpnHall()
              ? _c(
                  "el-button",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        return _vm.handleBookmarkCurrent()
                      },
                    },
                  },
                  [_vm._v("收藏当前页面")]
        ...
        //               {
        //                 // attrs: {
        //                 //   href: "https://github.com/kaaass/jlu-webvpn-assistant",
        //                 // },
        //               },
        //               [_c("i", { staticClass: "el-icon-umbrella" })]
        //             ),
        //           ],
        //           1
        //         ),
...
var aes_js = __webpack_require__(826);
var aes_js_default = /*#__PURE__*/__webpack_require__.n(aes_js);
;// CONCATENATED MODULE: ./src/logic/vpn/aes-helper.js


const Utf8 = (aes_js_default()).utils.utf8;
const Hex = (aes_js_default()).utils.hex;
const ModeCfb = (aes_js_default()).ModeOfOperation.cfb;
...
;// CONCATENATED MODULE: ./src/logic/config.js

const vpnCryptIv = 'Didida1127Didida';

const vpnCryptKey = 'Didida1127Didida';

const vpnHost = 'https://webvpn.bit.edu.cn';

;// CONCATENATED MODULE: ./src/logic/vpn/encrypt.js
 ...
 */
const parse = (data) => {
  return encrypt(data, vpnCryptKey, vpnCryptIv);
};
 ...
 */
const unparse = (data) => {
  return decrypt(data, vpnCryptKey);
};

;// CONCATENATED MODULE: ./src/logic/vpn/url-helper.js


const URL_NORMAL = 0;
const URL_RELATIVE = 1;
const URL_SAME_PROTOCOL = 2;
const URL_FULL_SCHEME = 3;
 ...
 * @returns {string|*}
 */
const makeUrlFromType = function (url, urlType) {
...
// EXTERNAL MODULE: ./node_modules/lodash/_arrayReduce.js
var _arrayReduce = __webpack_require__(663);
var _arrayReduce_default = /*#__PURE__*/__webpack_require__.n(_arrayReduce);
;// CONCATENATED MODULE: ./src/logic/vpn/url-transformer.js
 ...
 */
const url_transformer_parse = (origin, baseURL, url, additionQuery = "", shouldEncrypt = false) => {
  // url 合并附加参数
  if (additionQuery) {
  ...
  // 域名加密
  if (shouldEncrypt) {
    url.set("hostname", parse(url["hostname"]));
  }
  // 拼接
  url = origin + "/"
  ...
  // 拼接结果
  return makeUrlFromType(url_parse_default()(url), urlType);
};
 ...
 * @returns {*|string}
 */
const url_transformer_unparse = (origin, url, shouldEncrypt) => {
  // 去除 vpn 相关参数
  ...
  if (!urlType)
    return url;
  url = url_parse_default()(url, origin)
  // 不是 VPN Url
...
;// CONCATENATED MODULE: ./src/logic/storage/mock.js
...
;// CONCATENATED MODULE: ./src/logic/storage/actual.js
/**
 * 取得存储值
 * @param key
 * @param defaultValue
 * @returns {*}
 */
const actual_getValue = (key, defaultValue) => {
 ...
 * @param value
 */
const actual_setValue = (key, value) => {
  GM_setValue(key, value);
};

;// CONCATENATED MODULE: ./src/logic/storage/index.js




let selected = actual_namespaceObject;
// 开发环境启用 Mock
if (isDev) {
  selected = mock_namespaceObject;
}

const storage_getValue = selected.getValue;

const storage_setValue = selected.setValue;
...
const setObject = (key, obj) => {
  storage_setValue(key, JSON.stringify(obj));
};
 ...
 */
const getObject = (key) => {
  return JSON.parse(storage_getValue(key, 'null'));
};
 ...
 * @returns {*|string}
 */
const encryptVpnUrl_modified = (url) => {
  return encrypt_URL(url)
  if (url.indexOf('://') === -1) {
    url = 'http://' + url;
  }
  return url_transformer_parse(vpnHost, '', url, '', true);
};
 ...
 * @returns {*|string}
 */
const decryptVpnUrl = (url) => {
  return url_transformer_unparse(vpnHost, url, true);
};
...
/* harmony default export */ const PluginPanelvue_type_script_lang_js_ = ({
  ...
  methods: {
     ...
     */
    jumpTo(url) {
      const encryptedUrl = encryptVpnUrl_modified(url);
      if (encryptedUrl) {
        this.goUrl = '';
     ...
     */
    isVpnHall() {
      return window.location.href === 'https://webvpn.bit.edu.cn/';
    },
  }
});
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/AddBookmarkDialog.vue?vue&type=template&id=69f0cd9f&scoped=true&
var AddBookmarkDialogvue_type_template_id_69f0cd9f_scoped_true_render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "el-dialog",
    {
      attrs: { title: "添加收藏", visible: _vm.visible },
      on: {
...
var AddBookmarkDialogvue_type_template_id_69f0cd9f_scoped_true_staticRenderFns = []
AddBookmarkDialogvue_type_template_id_69f0cd9f_scoped_true_render._withStripped = true


;// CONCATENATED MODULE: ./src/components/AddBookmarkDialog.vue?vue&type=template&id=69f0cd9f&scoped=true&

;// CONCATENATED MODULE: ./node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/AddBookmarkDialog.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ const AddBookmarkDialogvue_type_script_lang_js_ = ({
...
;// CONCATENATED MODULE: ./src/components/AddBookmarkDialog.vue?vue&type=script&lang=js&
 /* harmony default export */ const components_AddBookmarkDialogvue_type_script_lang_js_ = (AddBookmarkDialogvue_type_script_lang_js_);
;// CONCATENATED MODULE: ./src/components/AddBookmarkDialog.vue
...
/* normalize component */
;
var AddBookmarkDialog_component = normalizeComponent(
  components_AddBookmarkDialogvue_type_script_lang_js_,
  AddBookmarkDialogvue_type_template_id_69f0cd9f_scoped_true_render,
  AddBookmarkDialogvue_type_template_id_69f0cd9f_scoped_true_staticRenderFns,
  false,
  null,
  "69f0cd9f",
  null
...
/* hot reload */
if (false) { var AddBookmarkDialog_api; }
AddBookmarkDialog_component.options.__file = "src/components/AddBookmarkDialog.vue"
/* harmony default export */ const AddBookmarkDialog = (AddBookmarkDialog_component.exports);
...
/* harmony default export */ const PluginDrawervue_type_script_lang_js_ = ({
  name: 'PluginDrawer',
  components: {AddBookmarkDialog: AddBookmarkDialog, PluginPanel: PluginPanel, ArrowIcon: ArrowIcon, Header: Header},
  data() {
    return {
      isHide: true,
    }
