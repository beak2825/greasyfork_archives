...
// @downloadURL https://update.greasyfork.org/scripts/2279/RYM%3A%20Quick%20Edit%20List.user.js
// @updateURL https://update.greasyfork.org/scripts/2279/RYM%3A%20Quick%20Edit%20List.meta.js
// ==/UserScript==
...
$('.quick_edit').on('click', function(event) {
    ...
    if (!$(this).data('editing')) {
        ...
        if (item_type == 'l') {
        	assoc_id = parseInt($td.find('a.album:first').attr('title').match(/\d*]/)[0]);
        } else if (item_type == 'g') {
            assoc_id = 0;
        } else {
