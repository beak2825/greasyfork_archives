// ==UserScript==
// @name         BIMG上传脚本
// @namespace    https://image.baidu.la/
// @version      0.25
// @description  BIMG快捷上传工具
// @author       BIMG
// @match        http://*/*
// @match        https://*/*
// @license      GPL
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/450817/BIMG%E4%B8%8A%E4%BC%A0%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/450817/BIMG%E4%B8%8A%E4%BC%A0%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
(function() {
    ...
    //创建一个显示按钮
    function imgurl(){
	    //$("body").append('<div id = "imgbtn" style = "position:fixed;right:1em;bottom:1em;z-index:88;cursor:pointer;" onclick = "showImgurl()"><img src = "https://image.baidu.la/static/image.png" width = "36px" height = "36px" /></div>');
	    //使用原生js添加按钮
	    var div = document.createElement("div");
	    div.innerHTML = '<div id = "imgbtn" style = "position:fixed;right:1em;bottom:1em;z-index:88;cursor:pointer;" onclick = "showImgurl()"><img src = "https://image.baidu.la/static/image.png" width = "36px" height = "36px" /></div>';
	    document.body.appendChild(div);
    }
    //显示上传按钮
    window.showImgurl = function(){
	    var up = layerstart;
	    up += '<iframe src = "https://image.baidu.la/" width="100%" height="660px" frameborder="0"></iframe>';
	    up += layerend;
	    //$("body").append(up);
	    var div = document.createElement("div");
	    div.innerHTML = up;
