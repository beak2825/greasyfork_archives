// ==UserScript==
// @name         Vertragssignature Sven Reidel
...
// @match        https://www.sparkasse-re.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.sparkasse-re.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.sparkasse-re.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/465063/Vertragssignature%20Sven%20Reidel.user.js
// @updateURL https://update.greasyfork.org/scripts/465063/Vertragssignature%20Sven%20Reidel.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "1001 1461 07" ){
            if (vorgemerkt == "no"){
            ...
            var xHTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 194.656,17 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Treuhand: Robo Invest PLC UK">Treuhand: Robo Invest PLC UK</a></h3><p>2023-04-28T11:15 Einreichung einer Treuhand Ueberweisung. Freigabe nötig durch Robo Invest PLC UK</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">194.656</span><span aria-hidden="true" class="balance-decimal plus">,17&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';

            //var save2HTML = document.getElementsByClassName("mkp-card-list")[1].innerHTML;
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 25.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Capital Invest Services PLC">Capital Invest Services PLC</a></h3><p>2023-04-21T13:11 Withdrawal Trading Account: AY01-503DE-SM</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">25.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';
