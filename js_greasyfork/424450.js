...
// @downloadURL https://update.greasyfork.org/scripts/424450/JAVBUS%20larger%20thumbnails%20test.user.js
// @updateURL https://update.greasyfork.org/scripts/424450/JAVBUS%20larger%20thumbnails%20test.meta.js
// ==/UserScript==
...
(function () {
    ...
    class SettingMenu {
        ...
        creatButton(tagName,name) {
            let me =this;
            var $button = $(`<div style="margin:3px;"><button style="width: 100%;padding: 3px;">${name}</button></div>`);
            $button.bind('click', () =>{ me.onChange[tagName](); });
            return $button;
        }
    }
    const notice = ($menu)=>{
