// ==UserScript==
// @name брест шенген покупки рандом даты
// @namespace брест шенген покупки рандом даты
// @description брест шенген покупки рандом даты.
...
// @grant GM_getValue
// @grant unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/16308/%D0%B1%D1%80%D0%B5%D1%81%D1%82%20%D1%88%D0%B5%D0%BD%D0%B3%D0%B5%D0%BD%20%D0%BF%D0%BE%D0%BA%D1%83%D0%BF%D0%BA%D0%B8%20%D1%80%D0%B0%D0%BD%D0%B4%D0%BE%D0%BC%20%D0%B4%D0%B0%D1%82%D1%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/16308/%D0%B1%D1%80%D0%B5%D1%81%D1%82%20%D1%88%D0%B5%D0%BD%D0%B3%D0%B5%D0%BD%20%D0%BF%D0%BE%D0%BA%D1%83%D0%BF%D0%BA%D0%B8%20%D1%80%D0%B0%D0%BD%D0%B4%D0%BE%D0%BC%20%D0%B4%D0%B0%D1%82%D1%8B.meta.js
// ==/UserScript==


 var testMode=true;
 var brestTestId = 1023;
 var brestId = 1023;
 var city = 93;
 var sepr = ' || ';
  ...
  if(lastValue != -1 && typeof(lastValue) != 'undefined'){
   ...
   $('<input name="ctl00$cp$btnRezerwuj" value="Зарегистрироваться">').attr('type','hidden').appendTo('#form1');
     ...
     setTimeout(function() {$("#form1").submit();}, 1);
        ...
        location.href = "https://by.e-konsulat.gov.pl/Uslugi/RejestracjaTerminu.aspx?IDUSLUGI=8&IDPlacowki=93";
   return;
    }
 } else if ($('#cp_lblBrakTerminow').text().length > 0) {
 	document.title = "Неудача " + $('#cp_lblBrakTerminow').text();
 	setTimeout(function() {location.href = "https://by.e-konsulat.gov.pl/Uslugi/RejestracjaTerminu.aspx?IDUSLUGI=8&IDPlacowki=93";}, 1500);
 	return;
