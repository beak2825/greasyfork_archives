...
// @downloadURL https://update.greasyfork.org/scripts/381190/%E4%BC%8A%E8%8E%89%E7%9C%8B%E6%BC%AB%E7%95%AB%28%E5%8D%B7%E8%BB%B8%29.user.js
// @updateURL https://update.greasyfork.org/scripts/381190/%E4%BC%8A%E8%8E%89%E7%9C%8B%E6%BC%AB%E7%95%AB%28%E5%8D%B7%E8%BB%B8%29.meta.js
// ==/UserScript==
(function (){
    ...
    if( isMobile() ){
        ...
        button.id = 'see_btn_2';
        button.innerHTML = '看漫畫(卷軸)';
        document.querySelector('#pgt').appendChild(button);
        document.querySelector('#see_btn_2').addEventListener('click', function(){
            if(document.readyState == "complete"){
                newWin();
            }else{
                alert("等所有資源載入完!!將開啟視窗");
