// ==UserScript==
// @name AudioBookBay hide category: Historical Fiction
// @description Hide Historical Fiction category
...
// @downloadURL https://update.greasyfork.org/scripts/484552/AudioBookBay%20hide%20category%3A%20Historical%20Fiction.user.js
// @updateURL https://update.greasyfork.org/scripts/484552/AudioBookBay%20hide%20category%3A%20Historical%20Fiction.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact phrase 'Historical Fiction'
    $(".post").has(".postInfo:contains('Historical Fiction')").hide();
});
