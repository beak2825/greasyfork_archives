// ==UserScript==
// @name         PuzzleTeam confirm New Puzzle
// @namespace    httsp://xandaros.dyndns.org/
// @version      1.0
// @description  Simple script to make the "New Puzzle" button on PuzzleTeam's websites show a confirmation dialogue
// @author       Xandaros
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/425843/PuzzleTeam%20confirm%20New%20Puzzle.user.js
// @updateURL https://update.greasyfork.org/scripts/425843/PuzzleTeam%20confirm%20New%20Puzzle.meta.js
// ==/UserScript==
...
(function() {
    ...
    $(function() {
      $('#btnNew').attr('onclick', 'return confirm("Are you sure?");');
    });
})();