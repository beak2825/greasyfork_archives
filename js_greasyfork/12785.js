...
// @downloadURL https://update.greasyfork.org/scripts/12785/MyAnimeList%28MAL%29%20-%20Random%20AnimeMangaPeople%20%20Characters%20%28Rx%20filter%29.user.js
// @updateURL https://update.greasyfork.org/scripts/12785/MyAnimeList%28MAL%29%20-%20Random%20AnimeMangaPeople%20%20Characters%20%28Rx%20filter%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function getRandomAnime() {
        ...
        $.get('/includes/ajax.inc.php?t=64&id=' + r, function(result) {
            if (result.length > 29 && !result.match(/(Hentai|Kids)/)) {
    ...
    function getRandomManga() {
        ...
        $.get('/includes/ajax.inc.php?t=65&id=' + r, function(result) {
            if (result.length > 0 && !result.match(/(Hentai|Yaoi|Yuri|Kids)/)) {
