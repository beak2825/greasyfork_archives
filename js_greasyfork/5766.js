...
// @version     1.36
// @grant     	GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/5766/dA_quick_img_pop.user.js
// @updateURL https://update.greasyfork.org/scripts/5766/dA_quick_img_pop.meta.js
// ==/UserScript==
...
(function(){
	...
	function start(){
		...
		ins.id="dA_quick_img_pop_cont";
		ins.style="position: absolute;right: 0;top: 0;";
		ins.innerHTML="";
		if(favcount>gfavcount)
			ins.innerHTML+="<img class='dA_quick_img_pop_but' src='"+imgblF+"' alt='over "+gfavcount+" favourites: "+favcount+"' title='over "+gfavcount+" favourites: "+favcount+"' style='float: right;'/>";
		if(comcount>gcomcount)
			ins.innerHTML+="<img class='dA_quick_img_pop_but' src='"+imggrC+"' alt='over "+gcomcount+" comments: "+comcount+"' title='over "+gcomcount+" comments: "+comcount+"' style='float: right;'/>";
		if(timetick<(60*60*24*gtimetick1))//1 day
			ins.innerHTML+="<img class='dA_quick_img_pop_but' src='"+imgtuT+"' alt='younger than "+gtimetick1+" days: "+timemat[2]+"' title='younger than "+gtimetick1+" days: "+timemat[2]+"' style='float: right;'/>";
		if(timetick>(60*60*24*gtimetick2))//60 day
			ins.innerHTML+="<img class='dA_quick_img_pop_but' src='"+imgroT+"' alt='older than "+gtimetick2+" days: "+timemat[2]+"' title='older than "+gtimetick2+" days: "+timemat[2]+"' style='float: right;'/>";
		titlel.appendChild(ins);
	...
	function confmenu(){
		...
		if(!document.getElementById("dA_quick_img_pop_conf")){
			...
			conf.setAttribute("style","width:220px;height:220px;position:absolute;top:50%;left:50%;margin-left:-130px;margin-top:-130px;padding:20px");
