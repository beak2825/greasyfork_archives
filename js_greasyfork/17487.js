...
// @downloadURL https://update.greasyfork.org/scripts/17487/VersedForce.user.js
// @updateURL https://update.greasyfork.org/scripts/17487/VersedForce.meta.js
// ==/UserScript==
...
function loadScript(a, b) {
    ...
    var tt = $("div#mainPanel.agario-panel").prepend('<h2 id="NEL99Title" style="color:#0700fc; text-align:center; font-size: 50px"><b>VersedForce</b></h2><sup><h4 id="NEL99Subtitle" style="text-align:right">By Krayton</h4></sup>');
    ...
    var tt = $("div#mainPanel.agario-panel").prepend('<h2 id="NEL99text" style="color:#b92b1a; text-align: left; font-size: 20px"><b>TS3:73.13.225.28/b></h2><sup><h5 id="NEL99Subtitle" style="text-align:right">Join teamspeak to become a member. This extension is by krayton and is not to be changed!</h5></sup>');
