...
// @name         Для технических чоколадок 66 (для вумен) / K. Stoyn
...
// @downloadURL https://update.greasyfork.org/scripts/536214/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%87%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BE%D0%BA%2066%20%28%D0%B4%D0%BB%D1%8F%20%D0%B2%D1%83%D0%BC%D0%B5%D0%BD%29%20%20K%20Stoyn.user.js
// @updateURL https://update.greasyfork.org/scripts/536214/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%87%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BE%D0%BA%2066%20%28%D0%B4%D0%BB%D1%8F%20%D0%B2%D1%83%D0%BC%D0%B5%D0%BD%29%20%20K%20Stoyn.meta.js
// ==/UserScript==
  ...
  const TRANSFER_PREFIX_PLAYER49 = 23; // перенос в жб игроков
    ...
    {
	title: 'Приветствие',
	color: 'oswald: 3px; color: #ffc0cb; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	content:
...
},
  {
	...
	color: 'oswald: 3px; color: #FF00FF; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR][/CENTER]<br><br>" +
	'[CENTER] [HR][/HR]<br>[FONT=times new roman][B]Вам было выдано наказание за нарушение регламента[COLOR=rgb(255, 0, 0)] 2.28[/COLOR]<br>[SPOILER="2.28"][COLOR=rgb(255, 0, 0)]2.28.[/COLOR] Запрещена покупка/продажа внутриигровой валюты в любых ее проявлениях за реальные деньги [COLOR=rgb(255, 0, 0)]| PermBan с обнулением аккаунта + ЧС проекта[/COLOR][/SPOILER][/B][/FONT][/CENTER]<br>[TABLE][TR][TD][/TD][/TR][/TABLE]<br>' +
	'[CENTER] [CENTER][FONT=times new roman][B] является ботом. Все переводы ив от ботов игрокам расцениваются как покупка ив.[/B][/FONT][/CENTER] <br><br>' +
	'[CENTER] [CENTER][B][COLOR=rgb(250, 197, 28)][FONT=times new roman]Передано руководству на рассмотрение. [/FONT][/COLOR][/B][/CENTER] <br>' +
	...
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR][/CENTER]<br><br>" +
	'[CENTER] [HR][/HR]<br>[FONT=times new roman][B]Вы получили свое наказание за нарушение [COLOR=rgb(255, 0, 0)]4.05[/COLOR] пункта правил.<br>[SPOILER="4.05"][COLOR=rgb(255, 0, 0)]4.05.[/COLOR] Запрещено передавать любые игровые ценности между игровыми аккаунтами, а также в целях удержания имущества [COLOR=rgb(255, 0, 0)]| Ban 15 - 30 дней / PermBan[/COLOR][/SPOILER][/FONT][/CENTER]<br>[TABLE][TR][TD][/TD][/TR][/TABLE]<br>' +
	'[CENTER] [CENTER][FONT=times new roman] Взаимодействий между этими аккаунтами в живую нет. Все переводы и игра на этих двух аккаунтов переводится с одного IP - адреса, то бишь с одного интернета.[/B][/FONT][/CENTER] <br><br>' +
	'[CENTER] [CENTER][B][COLOR=rgb(250, 197, 28)][FONT=times new roman]Передано руководству на рассмотрение. [/FONT][/COLOR][/B][/CENTER] <br>' +
...
},
{
	...
	color: 'oswald: 3px; color: #FF00FF; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; width: 43%',
	content:
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR][/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
},
{
	...
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER][SIZE=4][FONT=times new roman][I][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR][/FONT][/CENTER]",
},
{
...
const Button49 = buttonConfig("Игроки 66", 'https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2863/');
const ButtonTech49 = buttonConfig("Тех раздел 66", "https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-bryansk.2843/")
const ButtonComp49 = buttonConfig("Жб на техов 66", "https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9666-bryansk.2842/")

bgButtons.append(Button49);
bgButtons.append(ButtonTech49);
bgButtons.append(ButtonComp49);
