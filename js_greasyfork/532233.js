...
// @author       Akropolix (Originally HKR)
...
// @downloadURL https://update.greasyfork.org/scripts/532233/%5BDiscord%5D%20Status%20Animator%20%28Manual%20editNon-UI%29.user.js
// @updateURL https://update.greasyfork.org/scripts/532233/%5BDiscord%5D%20Status%20Animator%20%28Manual%20editNon-UI%29.meta.js
// ==/UserScript==
...
(() => {
	...
	async function loop() {
		...
		await blink("😳","You are homosex", 3000, 1);
		
		if(await skip(10, "u")) return;
			
		await text("I am doing your mom");
		await wait(5000);
        
        await blink ("😇", "I'm tweaking out", 3000, 1);
