// ==UserScript==
// @name     Auto Farm Change Button and Maximum Distance
// @description Farms automatically with loot assistant
// @version 1.2.3.8
// @require https://code.jquery.com/jquery-3.2.1.min.js
// @include https://*/game.php?village=*&screen=am_farm*
// @namespace https://greasyfork.org/users/151096
// @downloadURL https://update.greasyfork.org/scripts/33738/Auto%20Farm%20Change%20Button%20and%20Maximum%20Distance.user.js
// @updateURL https://update.greasyfork.org/scripts/33738/Auto%20Farm%20Change%20Button%20and%20Maximum%20Distance.meta.js
// ==/UserScript==

// Set maximum farm distance
window.maxDistance = 20; // Change this value to set maximum farm distance for A
window.maxDistanceBC = 10; // Change this value to set maximum farm distance for B and C
...
var switchVillSpeed = 1; // No idea what this is
...
if (switchVillSpeed == "1") {
	var switchVillSpeed = random(2000, 4000); // Switch village between a random number between 2 and 4 seconds
} else {
