...
// @downloadURL https://update.greasyfork.org/scripts/449927/%E7%A6%81%E7%94%A8S1%E7%B9%81%E7%AE%80%E8%BD%AC%E6%8D%A2.user.js
// @updateURL https://update.greasyfork.org/scripts/449927/%E7%A6%81%E7%94%A8S1%E7%B9%81%E7%AE%80%E8%BD%AC%E6%8D%A2.meta.js
// ==/UserScript==
...
(function () {
    ...
    function substituteText(elementId) {
        ...
        for (const match of text.matchAll(regex)) {
            result += encode(text.substring(lastEnd, match.index), {
                allowUnsafeSymbols: true,
            });
            result += text.substr(match.index, match[0].length);
            lastEnd = match.index + match[0].length;
        }
        result += encode(text.substring(lastEnd, text.length));
