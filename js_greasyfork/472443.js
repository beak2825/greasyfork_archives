// ==UserScript==
// @name         [Rews] Klanowicze online
// @namespace    https://www.margonem.pl/profile/view,9871878
// @author       Reskiezis (Rews edit)
// @description  Dodatek pokazujący klanowiczy którzy są online.
// @version      2.0.2
// @match        *://*.margonem.pl/
// @match        *://*.margonem.com/
// @run-at       document-idle
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/472443/%5BRews%5D%20Klanowicze%20online.user.js
// @updateURL https://update.greasyfork.org/scripts/472443/%5BRews%5D%20Klanowicze%20online.meta.js
// ==/UserScript==
...
/*
  ...
  - - - -
  Edit zrobiony przez Rews (discord: itsrews)
  - Wygląd inspirowany editem przez Lord Asidmi, który spodobał mi się wyglądowo, lecz gryzł się z Maddonzem

  W skrócie wziąłem dodatek od Reskiezis, oraz usunąłem funkcjonalność zmniejszenia okienka oraz button do zwinięcia listy klanowiczy, a button do zmniejszenia okienka teraz zwija liste klanowiczy.

  Linki do powiązanych dodatków:
  Klanowicze Online od Reskiezis - https://forum.margonem.pl/?task=forum&show=posts&id=450345&ps=42#post45034542 / https://greasyfork.org/pl/scripts/375636-klanowicze-online
  Klanowicze Online, edit by Lord Asidmi - https://forum.margonem.pl/?task=forum&show=posts&id=450345&ps=41#post44929924 / https://pastebin.com/RfeiBPef
  - - - -
