// ==UserScript==
// @name         DSS: Torn APHT & ABO
// @namespace    Dsuttz Scripts
// @version      0.7
// @description  Display remaining hospital time on attack loader page with reload button + Enable attack button on profiles when user is in hospital
...
// @grant        GM_getValue
// @grant        GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/546928/DSS%3A%20Torn%20APHT%20%20ABO.user.js
// @updateURL https://update.greasyfork.org/scripts/546928/DSS%3A%20Torn%20APHT%20%20ABO.meta.js
// ==/UserScript==
    ...
    function handleApiResponse(jsonObj) {
        ...
        if (!status || status.state !== "Hospital") {
            ...
            if (wasInHosp) {
                ...
                let randomDelay = Math.random() * 2000 + 1000; // 1-3 seconds
                setTimeout(() => {
