...
// @match        https://azbit.com/*
// @connect      adbtc.top
// @noframes
// @grant        GM_xmlhttpRequest
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/491724/Adbtctop%20collector%20and%20claim%20satoshi%28BTC%29.user.js
// @updateURL https://update.greasyfork.org/scripts/491724/Adbtctop%20collector%20and%20claim%20satoshi%28BTC%29.meta.js
// ==/UserScript==
(function() {
   ...
   var websiteData = [
    ...
    var websiteMap = [
        ...
        {
            website: "adbtc.top",
            defaultButtonSelectors: ["input.btn"],
    ...
    function adbtcTop() {
        ...
        for(let j=0; j<document.querySelectorAll(".dropdown-content.select-dropdown").length; j++){
            for(let i=0; i<document.querySelectorAll(".dropdown-content.select-dropdown")[j].getElementsByTagName("li").length; i++){
                if( document.querySelectorAll(".dropdown-content.select-dropdown")[j].getElementsByTagName("li")[i].innerText.includes("Turnstile") &&
