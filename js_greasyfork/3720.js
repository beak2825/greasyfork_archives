...
// @downloadURL https://update.greasyfork.org/scripts/3720/MTurk%20HIT%20DataBase.user.js
// @updateURL https://update.greasyfork.org/scripts/3720/MTurk%20HIT%20DataBase.meta.js
// ==/UserScript==
...
HITStorage.format_csv_line = function(hit)
{
    ...
    line.push('"' + hit.hitId + '"');
    line.push('"' + hit.date + '"');
    line.push('"' + hit.requesterName + '"');
    line.push('"' + hit.requesterId + '"');
    line.push('"' + hit.title + '"');
    line.push(hit.reward.toFixed(2));
    line.push('"' + hit.status + '"');
    line.push('"' + hit.feedback + '"');
    line.push('\n');
    return line;
}
