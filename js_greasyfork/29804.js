...
// @version      0.1.3
// @description   Save media from twitter page
// @author       forinec
// @match        *://twitter.com/*
// @grant    GM_xmlhttpRequest
// @downloadURL https://update.greasyfork.org/scripts/29804/Twitter%20media%20download.user.js
// @updateURL https://update.greasyfork.org/scripts/29804/Twitter%20media%20download.meta.js
// ==/UserScript==

var header = document.getElementsByClassName("client-and-actions")[0];
var photoContainer = document.querySelectorAll(".permalink-tweet .AdaptiveMedia-photoContainer");
var images = [];

console.log(header);
console.log(photoContainer);

for (var item of photoContainer) {
  console.log(item);
  var origURL = item.getAttribute("data-image-url") + ":orig";
  console.log(origURL);
  images.push(origURL);
}
