...
// @description    - установка зарплаты 81% от среднегородской
// @version        1.42+
// @include        http://virtonomic*.*/*/window/unit/employees/engage/*
// @include        http://igra.aup.*/*/window/unit/employees/engage/*
// @downloadURL https://update.greasyfork.org/scripts/6385/virtonomica%3A%D0%97%D0%B0%D1%80%D0%BF%D0%BB%D0%B0%D1%82%D1%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/6385/virtonomica%3A%D0%97%D0%B0%D1%80%D0%BF%D0%BB%D0%B0%D1%82%D1%8B.meta.js
// ==/UserScript==
...
//			alert("fix 2");
  ...
  var input_81 = $('<button id=b100>81%</button>').click(function() {
	$('#salary').prop('value', prize * 0.81);
	appriseEmployeeLevel();
  });
...
var input_f = $("<input> ").prop({type: 'text', value: '', size: '6'}).change(function() {
  ...
  container.append( $('<table><tr>').append('<td>').append(input_95).append('<td>').append(input_f).append('<td>').append(input_plus).append('<td>').append(input_100).append('<td>').append(input_81).append('<td>').append(input_ret) );
}
