...
// @include        https://178.248.235.15/inventory.php*
...
// @downloadURL https://update.greasyfork.org/scripts/402263/hwmtakeoffon.user.js
// @updateURL https://update.greasyfork.org/scripts/402263/hwmtakeoffon.meta.js
// ==/UserScript==
...
prochka_regexp2 = ( url.match('lordswm') ? /<li>Durability: <font color="red">(\d+)<\/font>\/(\d+)/ : /<li>\u041f\u0440\u043e\u0447\u043d\u043ec\u0442\u044c: <font color="red">(\d+)<\/font>\/(\d+)/ );
    ...
    var kukla_tbl = getI( "//img[contains(@src, 'i/kukla')]" ).snapshotItem(0) ;
    if( kukla_tbl )
    {
    	o1 = kukla_tbl.parentNode.parentNode.parentNode.parentNode.parentNode;
    	...
    	td.setAttribute( 'colspan' , 2 ) ;
    	td.setAttribute( 'align' , 'center' ) ;
    	td.innerHTML = '<b>\u041f\u0435\u0440\u0435\u0434\u0430\u0447\u0438:</b> <div style="float:right;margin:0 5px;cursor:pointer;font-weight:bold;" title="\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438" id="jsset">?</div>' ;
    	tr.appendChild( td ) ;
    	o1.insertBefore( tr , o1.firstChild.nextSibling );
//*************************************************************************************************
    	document.getElementById('jsset').onclick = function(){setting();};
