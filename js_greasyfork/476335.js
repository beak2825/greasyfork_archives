...
// @version     1.0
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/476335/DEMENTUL%20PERSIA.user.js
// @updateURL https://update.greasyfork.org/scripts/476335/DEMENTUL%20PERSIA.meta.js
// ==/UserScript==
...
TWPT.NineTimesFifteenButton = {
    init() {
        ...
        JobWindow.initView = function() {
            ...
            const createButton = (label, durationClass, bottom, left) => {
                const button = new west.gui.Button(label, () => {
                    button.disable();
                    ...
                    $(this.window.divMain)
                        .find(`.job_durationbar.${durationClass}`)
                        .click();
                    setTimeout(() => {
                        button.enable();
            ...
            createButton('9x 15s', 'job_durationbar_short', '25px', '300px');
            createButton('9x 10min', 'job_durationbar_middle', '90px', '200px');
            createButton('9x 1H', 'job_durationbar_long', '120px', '100px');
        };
    },
};
