...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/482754/Test.user.js
// @updateURL https://update.greasyfork.org/scripts/482754/Test.meta.js
// ==/UserScript==
 ...
 if (typeof ah !== 'undefined') {
  ah.proxy({
   ...
   //alert (response.config.url);
     ...
     lsres.data.photo_url="https://oss1.52ydda.cn/staff_photo/618312817218.jpg";
     lsres.data.is_simulation=0;
     lsres.data.is_exam=0;
     console.log(lsres.data);
     let newres = lsres;
