...
// @downloadURL https://update.greasyfork.org/scripts/480878/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98%E6%89%B9%E9%87%8F%E9%87%8D%E5%91%BD%E5%90%8D-%E4%BF%AE%E6%94%B9.user.js
// @updateURL https://update.greasyfork.org/scripts/480878/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98%E6%89%B9%E9%87%8F%E9%87%8D%E5%91%BD%E5%90%8D-%E4%BF%AE%E6%94%B9.meta.js
// ==/UserScript==

(t=>{if(typeof GM_addStyle=="function"){GM_addStyle(t);return}const a=document.createElement("style");a.textContent=t,document.head.append(a)})(" #batchBtn[data-v-42670219]{position:fixed;bottom:120px;right:48px;font-size:14px;background:#637dff;border-radius:100px;color:#fff;transition:all .3s ease;box-shadow:0 3px 8px #1c1c201f,0 3px 5px #1c1c200a;padding:8px 16px;font-weight:500;cursor:pointer}[data-v-42670219] .el-space__item{flex:1}[data-v-42670219] .el-dialog__body{padding:20px 40px}[data-v-42670219] .el-dialog{border-radius:10px}.tips ul[data-v-42670219]{display:block;list-style-type:disc;padding-left:0}.tips ul li[data-v-42670219]{margin:1em 0}.tips ul ul[data-v-42670219]{margin:1em 0;padding-left:20px;list-style-type:circle}.card-header[data-v-42670219]{display:flex;justify-content:space-between;align-items:center}.card-header .btn[data-v-42670219]{display:flex;align-items:center}.card-header .btn span[data-v-42670219]{margin-right:10px}[data-v-42670219] .el-card__header{padding:10px 20px}[data-v-42670219] .el-card__body{padding-right:4px;padding-left:0}.sort-wrap[data-v-42670219]{display:flex;line-height:39px;padding-right:16px;box-sizing:border-box;height:500px;width:100%;overflow-y:scroll}.sort-wrap .index-wrap[data-v-42670219]{display:flex;flex-direction:column;margin-right:14px;text-align:right}.sort-wrap .index-wrap span[data-v-42670219]{width:40px;font-size:14px;border-bottom:1px solid transparent}.sort-wrap .list-wrap[data-v-42670219]{flex:1;width:calc(100% - 60px)}.sort-wrap .list-wrap .item[data-v-42670219]{-webkit-user-select:none;user-select:none;margin:0;font-size:14px;box-sizing:border-box;position:relative;letter-spacing:1px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:flex;justify-content:space-between}.sort-wrap .list-wrap .item.list-group-item span[data-v-42670219]{flex:1}.sort-wrap .list-wrap .item span[data-v-42670219]{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;border-bottom:1px dashed #999;width:30%}.sort-wrap .list-wrap .item span+span[data-v-42670219]{flex:1;margin-left:50px;border-bottom:1px solid #dedede}.flip-list-move[data-v-42670219],.no-move[data-v-42670219]{transition:all ease .5s}.ghost[data-v-42670219]{opacity:.5;background:#c8ebfb}.list-group[data-v-42670219]{min-height:20px;width:100%}.list-group-item[data-v-42670219]{cursor:grab} ");
...
(function (require$$0, ElementPlus) {
  ...
  const _withScopeId = (n) => (require$$0.pushScopeId("data-v-42670219"), n = n(), require$$0.popScopeId(), n);
  ...
  const _hoisted_11 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ require$$0.createElementVNode("br", null, null, -1));
  const _hoisted_12 = { class: "sort-wrap" };
  const _hoisted_13 = { class: "index-wrap" };
  const _hoisted_14 = { class: "list-wrap" };
      ...
      function formatName(item, i) {
        ...
        if (activeTab.value === 1) {
          ...
          if(prefix.value.includes('{}')){
            name = `${prefix.value.replace('{}',i+1)}${name}${suffix.value}`
          }else{
      ...
      return (_ctx, _cache) => {
        ...
        return require$$0.openBlock(), require$$0.createElementBlock("div", null, [
                      ...
                      require$$0.createVNode(require$$0.unref(draggable), {
                        ...
                        item: require$$0.withCtx(({ element }) => [
                          require$$0.createElementVNode("li", _hoisted_9, [
                            require$$0.createElementVNode("span", null, require$$0.toDisplayString(element.name), 1)
                          ])
                        ]),
                        _: 1
                      }, 8, ["modelValue"])
          ...
          require$$0.createVNode(_component_el_dialog, {
            ...
            "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => require$$0.isRef(dialogVisible2) ? dialogVisible2.value = $event : dialogVisible2 = $event),
            closable: false,
            keyboard: false,
            maskClosable: false,
            destroyOnClose: "",
            ...
            footer: require$$0.withCtx(() => [
              require$$0.createElementVNode("span", _hoisted_16, [
                require$$0.createVNode(_component_el_button, {
                  loading: require$$0.unref(loading),
                  onClick: _cache[13] || (_cache[13] = ($event) => require$$0.isRef(dialogVisible2) ? dialogVisible2.value = false : dialogVisible2 = false)
                }, {
                  default: require$$0.withCtx(() => [
                    require$$0.createTextVNode(" 取消 ")
                  ]),
            ...
            default: require$$0.withCtx(() => [
              require$$0.createVNode(_component_el_tabs, {
                ...
                "onUpdate:modelValue": _cache[12] || (_cache[12] = ($event) => require$$0.isRef(activeTab) ? activeTab.value = $event : activeTab = $event),
                type: "border-card",
                ...
                default: require$$0.withCtx(() => [
                  require$$0.createElementVNode("div", _hoisted_12, [
                    ...
                    require$$0.createElementVNode("div", _hoisted_14, [
                      (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(data.sortList, (item, index2) => {
                        return require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_15, [
                          require$$0.createElementVNode("span", null, require$$0.toDisplayString(item.name), 1),
                          require$$0.createElementVNode("span", null, require$$0.toDisplayString(formatName(item, index2)), 1)
                        ]);
                      }), 256))
                    ])
                  ])
  ...
  const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-42670219"]]);
  const cssLoader = (e) => {
    const t = GM_getResourceText(e);
    return GM_addStyle(t), t;
  };
  cssLoader("element-plus/dist/index.css");
  const app = require$$0.createApp(Index);
  const appContainer = () => {
