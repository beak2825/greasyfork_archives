...
// @downloadURL https://update.greasyfork.org/scripts/517920/bi-girl.user.js
// @updateURL https://update.greasyfork.org/scripts/517920/bi-girl.meta.js
// ==/UserScript==
...
function ChangeList(){
	$('.img_a.img_all').each(function(){
		...
		let Getname = (img)=>{
			return document.title.substring(0,10) + new Date().getTime() + href.match(/\.jpg|\.jpeg|\.png|\.webp|\.gif|\.mp4|\.wmp/g)[0];
		}
		if($(window).height()>$(window).width()){
