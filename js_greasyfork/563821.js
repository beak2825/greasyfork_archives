...
fetch('https://hordes.io/play')
    ...
    origin = origin.replace('this.player=e,', 'Object.assign(window.'+name+
                            ',{world:'+world+
                            ',me:e'+
                            ',coder:'+coder+
                            ',ws:'+ws+
    ...
    function toggleAutoLootSettings() {
        if (!autoLootUI) {
            const uiHTML = '<style>.grid-content{display:grid;grid-template-columns:2fr 1fr;grid-gap:8px;align-items:center}.container.auto-loot-ui{min-width:350px;max-width:600px;width:90%;height:60%;min-height:350px;max-height:600px;z-index:9}.window.auto-loot-window{padding:5px;height:100%;display:grid;grid-template-rows:30px 1fr;grid-gap:4px;transform-origin:inherit;min-width:fit-content}.titleframe.auto-loot-titleframe{line-height:1em;display:flex;align-items:center;position:relative;letter-spacing:.5px}.titleicon.auto-loot-titleicon{margin:3px}.title.auto-loot-title{width:100%;padding-left:4px;font-weight:700}.slot.auto-loot-slot{min-height:0}.restore-default-settings{width:450px;margin-right:4px}.close-ui{width:35px}</style><div class="absCentered container auto-loot-ui"><div class="window panel-black auto-loot-window"><div class="titleframe auto-loot-titleframe"><img src="/data/ui/icons/bag.svg" class="titleicon svgicon auto-loot-titleicon"><div class="textprimary title auto-loot-title"><div name="title">Auto Loot <small class="textgrey">v1.11</small></div></div><div class="btn red restore-default-settings"><img src="/data/ui/icons/cog.svg" class="svgicon"> Restore Default Settings</div><div class="btn black close-ui"><img src="/data/ui/icons/cross.svg" class="svgicon"></div></div><div class="slot scrollbar auto-loot-slot"><div class="panel-black"><h3 class="textprimary"></h3><div class="grid-content scripts"><div>Automatic Looting</div><div class="btn checkbox" name="looting"></div><div>Anti AFK</div><div class="btn checkbox" name="antiAfk"></div><div>Concatenate Inventory Items</div><div class="">ControlRight</div></div><h3 class="textprimary">Coins Meter</h3><div class="grid-content coins-meter"><div>Session Time</div><div class="coins-meter-time"></div><div>Coins Earned</div><div class="coins-meter-earned"><span class="textgold">00</span> <img class="texticon" src="/data/ui/currency/gold.webp"><span class="textsilver">00</span> <img class="texticon" src="/data/ui/currency/silver.webp"><span class="textcopper">00</span> <img class="texticon" src="/data/ui/currency/copper.webp"></div><div>Coins / Minute</div><div class="coins-meter-earned-minute"><span class="textgold">00</span> <img class="texticon" src="/data/ui/currency/gold.webp"><span class="textsilver">00</span> <img class="texticon" src="/data/ui/currency/silver.webp"><span class="textcopper">00</span> <img class="texticon" src="/data/ui/currency/copper.webp"></div><div>Coins / Hour</div><div class="coins-meter-earned-hour"><span class="textgold">00</span> <img class="texticon" src="/data/ui/currency/gold.webp"><span class="textsilver">00</span> <img class="texticon" src="/data/ui/currency/silver.webp"><span class="textcopper">00</span> <img class="texticon" src="/data/ui/currency/copper.webp"></div><div></div><div class="btn grey coins-meter-reset">Reset</div></div><h3 class="textprimary">Delay</h3><div class="grid-content delay"><div>Fixed Delay<br><small class="textgrey fixed-delay-indicator">ms</small></div><input type="range" class="fixed-delay" name="delay" min="0" max="1000"><div>With Randomness<br><small class="textgrey random-delay-indicator">ms</small></div><input type="range" class="random-delay" name="random-delay" min="0" max="1000"></div><h3 class="textprimary">Main</h3><div class="grid-content main"><div>Gold</div><div class="btn checkbox" name="gold"></div><div>Rune</div><div class="btn checkbox" name="rune"></div><div>Misc</div><div class="btn checkbox" name="misc"></div></div><h3 class="textprimary">Equipment</h3><div class="grid-content equipment"><div>Default Presets<br><small class="textgrey my-class-indicator"></small></div><select class="default-presets-select"><option disabled selected>Select a preset</option><option value="0">Warrior</option><option value="1">Mage</option><option value="2">Archer</option><option value="3">Shaman</option></select><div class="textprimary">Main 1</div><div></div><div><img src="/data/ui/slotbg/101.webp" class="svgicon"> Sword <img src="/data/ui/classes/0.webp" class="svgicon"></div><div class="btn checkbox" name="sword"></div><div><img src="/data/ui/slotbg/101.webp" class="svgicon"> Staff <img src="/data/ui/classes/1.webp" class="svgicon"></div><div class="btn checkbox" name="staff"></div><div><img src="/data/ui/slotbg/101.webp" class="svgicon"> Bow <img src="/data/ui/classes/2.webp" class="svgicon"></div><div class="btn checkbox" name="bow"></div><div><img src="/data/ui/slotbg/101.webp" class="svgicon"> Hammer <img src="/data/ui/classes/3.webp" class="svgicon"></div><div class="btn checkbox" name="hammer"></div><div class="textprimary">Main 2</div><div></div><div><img src="/data/ui/slotbg/109.webp" class="svgicon"> Shield <img src="/data/ui/classes/0.webp" class="svgicon"></div><div class="btn checkbox" name="shield"></div><div><img src="/data/ui/slotbg/109.webp" class="svgicon"> Orb <img src="/data/ui/classes/1.webp" class="svgicon"></div><div class="btn checkbox" name="orb"></div><div><img src="/data/ui/slotbg/109.webp" class="svgicon"> Quiver <img src="/data/ui/classes/2.webp" class="svgicon"></div><div class="btn checkbox" name="quiver"></div><div><img src="/data/ui/slotbg/109.webp" class="svgicon"> Totem <img src="/data/ui/classes/3.webp" class="svgicon"></div><div class="btn checkbox" name="totem"></div><div class="textprimary">Body</div><div></div><div><img src="/data/ui/slotbg/102.webp" class="svgicon"> Armlet</div><div class="btn checkbox" name="armlet"></div><div><img src="/data/ui/slotbg/103.webp" class="svgicon"> Armor</div><div class="btn checkbox" name="armor"></div><div><img src="/data/ui/slotbg/104.webp" class="svgicon"> Bag</div><div class="btn checkbox" name="bag"></div><div><img src="/data/ui/slotbg/105.webp" class="svgicon"> Boot</div><div class="btn checkbox" name="boot"></div><div><img src="/data/ui/slotbg/106.webp" class="svgicon"> Glove</div><div class="btn checkbox" name="glove"></div><div><img src="/data/ui/slotbg/107.webp" class="svgicon"> Ring</div><div class="btn checkbox" name="ring"></div><div><img src="/data/ui/slotbg/108.webp" class="svgicon"> Amulet</div><div class="btn checkbox" name="amulet"></div><div class="textprimary">Rarity</div><div></div><div class="textgrey">Common (0% - 49%)</div><div class="btn checkbox" name="loot1"></div><div class="textgreen">Uncommon (50% - 69%)</div><div class="btn checkbox" name="loot2"></div><div class="textblue">Rare (70% - 89%)</div><div class="btn checkbox" name="loot3"></div><div class="textpurp">Epic (90% - 100%)</div><div class="btn checkbox" name="loot4"></div><div>Item Quality% Minimum<br><small class="textgrey quality-range-indicator">%</small></div><input type="range" class="quality-range" name="quality" min="0" max="100"></div><h3 class="textprimary">Books</h3><div class="grid-content books"><div>Lv. 1</div><div class="btn checkbox" name="book1"></div><div>Lv. 2</div><div class="btn checkbox" name="book2"></div><div>Lv. 3</div><div class="btn checkbox" name="book3"></div><div>Lv. 4</div><div class="btn checkbox" name="book4"></div><div>Lv. 5</div><div class="btn checkbox" name="book5"></div></div><h3 class="textprimary"></h3></div></div></div></div>';
            
            document.querySelector(".l-ui.layout > .container:first-child").insertAdjacentHTML('afterend', uiHTML);
            ...
            document.querySelector('.auto-loot-ui .equipment .my-class-indicator').innerHTML = '<img src="/data/ui/classes/'+vr.me.class+'.webp" class="svgicon"> '+vr.classes[vr.me.class].name;
