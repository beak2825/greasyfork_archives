// ==UserScript==
// @name            MiniblogImgPop - 微博浮图 - 兼容新版微博
// @namespace       wuuashen
...
// @grant           none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/439808/MiniblogImgPop%20-%20%E5%BE%AE%E5%8D%9A%E6%B5%AE%E5%9B%BE%20-%20%E5%85%BC%E5%AE%B9%E6%96%B0%E7%89%88%E5%BE%AE%E5%8D%9A.user.js
// @updateURL https://update.greasyfork.org/scripts/439808/MiniblogImgPop%20-%20%E5%BE%AE%E5%8D%9A%E6%B5%AE%E5%9B%BE%20-%20%E5%85%BC%E5%AE%B9%E6%96%B0%E7%89%88%E5%BE%AE%E5%8D%9A.meta.js
// ==/UserScript==
...
(function() {
  ...
  var MIPConfig = {
    ...
    'twitter.com':{
      feedSelector:'[aria-label][data-testid="tweetPhoto"]',
      sFrag       :['900x900', 'small', '360x360', '240x240'],
	  // small, medium, large, 4096x4096, orig
      bFrag       :['medium', 'medium', 'medium', '4096x4096']
    },
    'gelbooru.com':{
      feedSelector:'article.thumbnail-preview',
      sFrag       :['thumbnails/', 'thumbnail_'],
      bFrag       :['/images/', '']
    },
  };
  ...
  var PopImg = {
    ...
    show: function(e) {
      ...
      imgReady(src, function() {
        ...
        if (window.innerHeight > imgDisplayHeight) {
          ...
          that.img.style.top = (scrollTop + (window.innerHeight - imgDisplayHeight)/2 + 15 - 160) + 'px';
    ...
    layoutImg: function(e) {
      ...
      var width = Math.min(this.imgWidth, 1000);
      // 如果小图右边放不下
  ...
  var MiniblogImgPop = {
    ...
    prepare: function() {
      ...
      this.config = MIPConfig[this.sitename];
        console.log(MIPConfig[this.sitename], 123)
    },
    ...
    addImgsEventListener: function() {
      ...
      document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape') {
          if(document.getElementById('miniblogImgPop').style.visibility === 'visible')
          PopImg.hide();
        }
      });      
    },
