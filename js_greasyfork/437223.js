// ==UserScript==
// @name               New ru.wiktionary.org_optimization
// @name:zh-CN         新版ru.wiktionary.org单词查询优化
...
// @downloadURL https://update.greasyfork.org/scripts/437223/New%20ruwiktionaryorg_optimization.user.js
// @updateURL https://update.greasyfork.org/scripts/437223/New%20ruwiktionaryorg_optimization.meta.js
// ==/UserScript==
...
(function() {
    ...
    */
    ...
    var addRuEnZhLink=function(){
        ...
        el.setAttribute('href',"https://el.wiktionary.org/wiki/"+word);
        el.innerHTML="&nbsp;&nbsp;EL&nbsp;&nbsp;"//把百分号编码转回去
        h.appendChild(ru);
        h.appendChild(en);
        h.appendChild(zh);
        h.appendChild(el);
        ...
        qianyi.setAttribute('href',"https://w.qianyix.com/index.php?q="+word);
        qianyi.innerHTML="&nbsp;&nbsp;新千亿"
