...
// @downloadURL https://update.greasyfork.org/scripts/5547/CnC%20Tiberium%20Alliances%20Autopilot%20-%20German%20%5Bde-DE%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/5547/CnC%20Tiberium%20Alliances%20Autopilot%20-%20German%20%5Bde-DE%5D.meta.js
// ==/UserScript==
                ...
                qx.Class.define("FlunikTools.Main", {
                    ...
                    members: {
                        ...
                        initialize: function () {
                            ...
                            _this.listbox = new qx.ui.form.TextArea().set({ readOnly: true, height: 180, width: 470 });
                        ...
                        autoUpgradePopupOeffnen: function () {
                            ...
                            var tabPageAUG = new qx.ui.tabview.Page("Autoupgrade", null).set({ padding: 5, decorator: "pane-light-opaque" });
                            ...
                            var boxA = new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({ margin: 0, padding: 5, decorator: "pane-light-opaque" });
                            var boxB = new qx.ui.container.Composite(new qx.ui.layout.HBox(5)).set({ margin: 0, padding: 5, decorator: "pane-light-opaque" });
                            var boxC = new qx.ui.container.Composite(new qx.ui.layout.HBox(20)).set({ margin: 0, padding: 5, decorator: "pane-light-opaque" });
                            ...
                            for (basis in allebasen) {
                                ...
                                var page = new qx.ui.tabview.Page(name, null).set({ maxWidth: 700, minWidth: 350, });
                                var reihe = 3;
                                var spalte = 0;
                            ...
                            var textH = new qx.ui.form.TextArea().set({ readOnly: true, height: 140, maxHeight: 140, width: 250, maxWidth: 300 }); //statusbox
                            boxH.add(lblHb);
                            boxH.add(lblHa);
                            boxH.add(ckboxH);
                            boxH.add(textH);
