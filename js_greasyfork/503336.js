// ==UserScript==
// @name         BLACK RUSSIA PINK  || Скрипт для Vlad_kraken.
...
// @downloadURL https://update.greasyfork.org/scripts/503336/BLACK%20RUSSIA%20PINK%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20Vlad_kraken.user.js
// @updateURL https://update.greasyfork.org/scripts/503336/BLACK%20RUSSIA%20PINK%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20Vlad_kraken.meta.js
// ==/UserScript==
        ...
        },
{
            ...
            content:
              "[CENTER][COLOR=RED][I] [SIZE=4][FONT=times new roman]{{ greeting }} уважаемый[COLOR=WHITE],  {{ user.mention }}.<br><br>"+
        "[CENTER][I] [SIZE=4][FONT=times new roman]С момента выдачи наказания прошло более 48-ми часов.<br>"+
        "Обжалованию не подлежит[/FONT]<br><br>"+
