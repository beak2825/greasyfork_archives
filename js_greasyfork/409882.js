// ==UserScript==
// @name Grinjr's Flipping Script
// @description Helps with loading flipping tables.
// @version 0.2.2
// @include https://www.gw2bltc.com/en/tp/search?*
// @namespace https://greasyfork.org/users/682281
// @downloadURL https://update.greasyfork.org/scripts/409882/Grinjr%27s%20Flipping%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/409882/Grinjr%27s%20Flipping%20Script.meta.js
// ==/UserScript==
...
function RemoveRows(evt) {
  ...
  for (i = 0; i < items.length; i++) {
    ...
    var offers = parseInt(items[i].children[offersCol].innerText);
    var bids = parseInt(items[i].children[bidsCol].innerText);
    if (sold < bought /*|| bids > offers*/) {
