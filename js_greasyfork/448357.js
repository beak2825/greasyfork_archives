// ==UserScript==
// @name         Bass Ogretmenlik For Alacaatlı Group
...
// @downloadURL https://update.greasyfork.org/scripts/448357/Bass%20Ogretmenlik%20For%20Alacaatl%C4%B1%20Group.user.js
// @updateURL https://update.greasyfork.org/scripts/448357/Bass%20Ogretmenlik%20For%20Alacaatl%C4%B1%20Group.meta.js
// ==/UserScript==
...
$(document).ready(function(){
    ...
    setInterval(()=>{
        if($(baslik).find(".progress-check-icon").length){
            document.location.href = "https://www.oba.gov.tr/egitim/oynatma/basogretmenlik-egitim-programi-semineri-meb-personeli-283/3193";
        }
