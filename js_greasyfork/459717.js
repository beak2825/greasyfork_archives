...
// @description  code: Follow twitter
// @include     https://twitter.com/intent/user?*
// @license      MIT
// @version     0.01
// @grant       GM_openInTab
// @grant       window.close
// @downloadURL https://update.greasyfork.org/scripts/459717/Follow%20twitter.user.js
// @updateURL https://update.greasyfork.org/scripts/459717/Follow%20twitter.meta.js
// ==/UserScript==
...
(function () {
    ...
    executeWithSleepBegin(oneSecond * 3, () => {
        // ativa notificação
        if (document.querySelector('main  div[aria-label="Turn on Tweet notifications"] > div ') ) {
            console.log("ativa notificação");
            document.querySelector('main  div[aria-label="Turn on Tweet notifications"] > div ').click()
        }
    })
