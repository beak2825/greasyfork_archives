// ==UserScript==
// @name         115漂流瓶获取分享链接
// @description  通过115漂流瓶活动获取分享链接
// @namespace    http://tampermonkey.net/
// @version      2024-02-18
// @description  try to take over the world!
// @author       You
// @match        https://v.115.com/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=115.com
// @require      https://code.jquery.com/jquery-1.12.4.min.js
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487595/115%E6%BC%82%E6%B5%81%E7%93%B6%E8%8E%B7%E5%8F%96%E5%88%86%E4%BA%AB%E9%93%BE%E6%8E%A5.user.js
// @updateURL https://update.greasyfork.org/scripts/487595/115%E6%BC%82%E6%B5%81%E7%93%B6%E8%8E%B7%E5%8F%96%E5%88%86%E4%BA%AB%E9%93%BE%E6%8E%A5.meta.js
// ==/UserScript==
...
(function() {
    ...
    function add() {
        $('.panel-nav').append('<a class="getUrl" style="cursor:pointer">复制分享链接</a>')
    ...
    function share(data) {
        ...
        for (var i = data.length - 1; i >= 0; i--) {
            url += '资源名：' + data[i]['plp_info']['name'] + "\n" + 
                    '资源大小：' + renderSize(data[i]['plp_info']['total_size']) + "\n" + 
                    '分享地址：' + 'https://115.com/s/' + data[i]['plp_info']['share_code'] + '?password=' + data[i]['plp_info']['receive_code'] + "\n\n"
        }
        copy(url)
    }
    ...
    function copy(value) {
        ...
        cocoMessage().success('分享链接已复制到粘贴板');
    }
    ...
    $(document).on('click','.getUrl',function() {
        $.ajax({
            ...
            crossDomain: true,
            url: "https://act.115.com/api/1.0/web/1.0/act2024plp/collect_list?stime=&etime=&start=0&limit=10000",
            success: function(res){
                console.log(res.data)
                share(res.data.list)
            },
            error: function(res){
                error_message(res.responseJSON.msg)
            }
        });
    })
