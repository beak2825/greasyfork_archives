...
// @name           IITC Plugin: Player tracker Modified + time
// @category       Layer
// @version        0.0.3.20170717.21732
...
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/400657/IITC%20Plugin%3A%20Player%20tracker%20Modified%20%2B%20time.user.js
// @updateURL https://update.greasyfork.org/scripts/400657/IITC%20Plugin%3A%20Player%20tracker%20Modified%20%2B%20time.meta.js
// ==/UserScript==
...
window.plugin.playerTracker.NAME_WIDTH = 150;
...
window.plugin.playerTracker.setupCSS = function() {
  ...
  +'.plugin-player-tracker-names{'
    ...
    +'text-align:left;padding: 2px;'  // padding needed so shadow doesn't clip
    +'overflow:hidden;'
  ...
  $.each(plugin.playerTracker.stored, function(plrname, playerData) {
    ...
    var label = L.marker(gllfe(last), {
      icon: L.divIcon({
        ...
        html: plrname + ', ' + ago(last.time, now)
      }),
      guid: guid,
    });
