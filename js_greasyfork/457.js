...
// @version       0.2
// @dtversion     1404260002
// @timestamp     1398458678447
// @qrversion     4.0
...
//  init
//
// @downloadURL https://update.greasyfork.org/scripts/457/QR-PluginsIMGWrapBBCode.user.js
// @updateURL https://update.greasyfork.org/scripts/457/QR-PluginsIMGWrapBBCode.meta.js
// ==/UserScript==
//
...
function handleClick(){
  ...
  var imgStrRgx = "\\b(https?:\\/\\/(?:[a-z0-9\\-]+\\.)+[a-z]{2,6}(?:\\/[^/#?\\n]+)+\\.(?:"+extpat+"))\\b";
