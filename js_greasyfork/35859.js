...
// @version     1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/35859/Auto%20wacker.user.js
// @updateURL https://update.greasyfork.org/scripts/35859/Auto%20wacker.meta.js
// ==/UserScript==
        ...
        setTimeout(() => {
            if(this._timeoutId>=0) {
                ...
                if (shouldContinue && this._timeoutId>=0) {
                    clearTimeout(this._timeoutId);
                    this._timeoutId = setTimeout(() => { if(this._timeoutId>=0)this.start(true); }, 500);
                }
            }
