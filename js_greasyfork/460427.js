...
// @downloadURL https://update.greasyfork.org/scripts/460427/chatgpt-helper.user.js
// @updateURL https://update.greasyfork.org/scripts/460427/chatgpt-helper.meta.js
// ==/UserScript==
...
\`\`\``;
      ...
      function getFileName() {
        var _a;
        return ((_a = document.querySelectorAll(".dark .overflow-y-auto a.bg-gray-800")[0]) == null ? void 0 : _a.innerText) ?? "snapshot";
      }
      ...
      function handleCopyMarkdown() {
        ...
        const markdown = turndownService.turndown(content2);
