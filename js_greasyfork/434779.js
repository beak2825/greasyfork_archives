...
// @run-at document-end
// @namespace 
// @downloadURL https://update.greasyfork.org/scripts/434779/%E6%96%B0%E7%89%88%20%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/434779/%E6%96%B0%E7%89%88%20%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
		...
		if (self != top) {
			...
			if (location.href.match(/\.163\..+?\/store/)) {} else {
				try {
					...
					function jxbvipobj() {
						let jxbtupiana = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAMCAMAAACHgmeRAAAABGdBTUEAALGPC/xhBQAAAAFzUkdCAK7OHOkAAAAbUExURX//AIH8BobyGoT/CZP/J4nxIIL5C5T8LJj0PW2hJpgAAAAeSURBVAjXY2BlY4QABiZGBiigNouVGQoYONhZIAAAEpYAdsB2b4AAAAAASUVORK5CYII=", jxbtupianb = "data:image/png;base64,", jxbtupianc = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAECAYAAACp8Z5+AAAAFUlEQVQImWPMPHPpPwMSYGJAA4QFAMZ5Aw4eXQtVAAAAAElFTkSuQmCC", jxbtupiand = "data:image/png;base64,"
						...
						async function jxbloadobj(src, callback) {
						...
						var arra = [],
							arrb = [],
							vipdsobj, mmxgbobj, mmxgbdsobj, jsonvipjk, arrahttpsjk, arrbhttpsjk, httpsjk, vipzdjx, vipjxtb, vipjxss, vipjxkjj, gbdmobj, vipvideotg, gbkjjjobj, jstgggobj, pdssgjcobj, mgzdgq, lkzdzt, zdbfqp, zdwbfobj, sjtzjx, jxbzdjxdsqobj, jishu, jxbzdws, byjxbzdws, jxbzdwstitle, jxbzdwsjs;
						...
						async function cjthzdxjobj() {
							...
							mmxgbobj = setInterval(function() {
								if (document.querySelector("div#江小白 video")) {
									if (!document.querySelector("替换自动下一集")) {
										document.body.appendChild(document.createElement("替换自动下一集"));
										h5zdbfobj();
										try {
											document.querySelector("div#江小白 video").addEventListener('ended', () => {
												try {
						...
						async function vipjkzdyjobj() {
							if (!document.querySelector("\u6211\u662f\u5c0f\u767d")) {
						...
						const jxbvipjxyyystyle = 'style="width:100%;max-width:100%;height:100%;max-height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"', jxbvipjximg = 'marginwidth="0" marginheight="0" width="100%" height="100%" ' + jxbvipjxyyystyle, jxbvipjxidstyle = 'style="width:100%;max-width:100%;height:100%;max-height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;background-color:black;display:flex;justify-content:center;align-items:center;flex-direction:column;font-size:xx-large;"', jxbvipjxstrongstyle = 'font-weight:bold;display:flex;justify-content:space-evenly;align-items:center;width:100%;max-width:100%;max-width:80%;"', jxbvipyyy = '<iframe id="江小白" data-ad="false" autoLoad="true" autoplay="autoplay" loading="lazy" allowtransparency="true" frameborder="0" scrolling="no" security="restricted" sandbox="allow-top-navigation allow-same-origin allow-forms allow-scripts" allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen" src="', jxbvipjxyyy = '<div id="江小白" ' + jxbvipjxidstyle + '><div id="小白" style="letter-spacing:2px;color:#f8964c;' + jxbvipjxstrongstyle + '><img src="' + jxbtupiand + '" style="width:80%;"></div>' + jxbvipyyy, jxbjsonvipjxyyy = '<div id="江小白" ' + jxbvipjxidstyle + '>' + jxbvipyyy, jxbyyy = '<div id="江小白" style="width:100%;max-width:100%;height:100%;max-height:100%;background-color:black;"></div>';
						function jxqzsxobj() {
							try {
								if (document.querySelector("iframe#江小白")) {
									document.querySelector("div#江小白").innerHTML = '<img id="江小白" src="https://api.dujin.org/bing/1920.php" ' + jxbvipjximg + '>';
						...
						if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:isyour|douyin|kuaishou|douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|qq|xiami|migu|ximalaya|app-echo|1ting|lrts|haokan|baidu|wbdy|web3v|9ku)\./)) {
							...
							cssobj('[data-role*="-zt-"],[class*="_zt_"],[id*="_zt_"],[class*="bg"][style*="background-image:"]:not([class*="tem"]),[id*="bg"][style*="background-image:"]:not([id*="tem"]),[data-ad-stat][class*="btn"],script+div[class][id]:not([style])>a[class][id][onclick][style],script+div[class][id]:not([style])>a[class][id][onclick][style]+div[class][id][style]');
							...
							vipdsobj = '2345';
							if (jxbpclwobj) {
								cssobj('div#jxbhttps{top:70px!important;left:5px!important;transform:scale(0.5)!important;}ul#httpsvipul>li{margin:-7.5px -17.5px -7.5px -17.5px!important;transform:scale(0.75)!important;}ul#httpsvipul{top:115px!important;width:432px!important;}ul#httpsvipul>li>span{height:15px;font-size:medium!important;}963540817');
							} else {}
							function jszdqc() {
								try {
									setTimeout(function() {
							...
							if (obj.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|vku\.youku\.com\/live\/)/)) {
								...
								cssobj('.player_headline{text-align:center;}.player_container .txp_mod_barrage{left:0!important;text-align:center;}div.mod_hanger{background-color:transparent!important;}.wrapper_side .mod_title .title,div.figure_detail_row{color:#d8d4d3;}963540817');
						...
						cssobj('恢复声音,替换自动下一集,计时开始,计时结束,小白,白江,小江,江小白,白小江,小白江,我是小白,江小白是我,我是江小白,强制刷新,万能元素解析,江小白标题,江小白电脑,江小白手机,江小白电脑网页,江小白手机网页,我是江小白生活很简单,江小白监控视频播放结束,我是电脑芒果,江小白自动点击接口,跳过广告,江小白自动判断多余,江小白全屏,qqjstzobj,zddj,jxqvipimg,jxbsjqq,jxbvideo');
						async function zdbt() {
							setTimeout(function() {
										...
										try {
											...
											if (document.querySelector("\u6c5f\u5c0f\u767d\u624b\u673a\u7f51\u9875") != null) {
												if (obj.match(/^https?:\/\/(?:3g|m)\.v\.qq\.com/)) {
													...
													byjxbzdws = document.querySelector('[class*="title"] [class*="name"]').innerText.replace(/\s+?第.*?$/, "");
													jxbzdwstitle = byjxbzdws;
													sessionStorage.setItem('搜索关键词', byjxbzdws);
												} else {
						...
						if (vipzdjxwzobj) {
							cssobj('ul#小白::-webkit-scrollbar{width:0px!important;height:0px!important;}ul#小白::-moz-scrollbar{width:0px!important;height:0px!important;}ul#小白::-ms-scrollbar{width:0px!important;height:0px!important;}963540817');
							if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
							...
							setTimeout(() => {
								if (document.querySelector("\u6c5f\u5c0f\u767d\u81ea\u5b9a\u4e49\u63a5\u53e3") != null) {} else {
									...
									try {
										sessionStorage.removeItem('允许重复');
									...
									if (localStorage.getItem("jkqhmsobj") == '2') {
										...
										httpsaobj = [{
											...
											name: "萌欣",
											url: "https://vip.mmkv.cn/tv.php?url=",
											jj: "1"
										}, {
											name: "木穆",
									...
									cssobj('div.maomibtn ul>li#json,div.maomibtn ul>li#jkqhmsobjli{display:block!important;}963540817');
									zdbt();
									if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
											...
											if (jxbpcobj) {} else {
												...
												httpsvipli.onclick = function() {
													try {
														...
														if (sessionStorage.getItem('首次解析') == null || sessionStorage.getItem('首次解析') == undefined || sessionStorage.getItem('首次解析') == '') {
														...
														} else {} if ((sessionStorage.getItem('允许重复') == '允许重复') || ((sessionStorage.getItem('首次解析') != null || sessionStorage.getItem('首次解析') != undefined || sessionStorage.getItem('首次解析') != '') && ((sessionStorage.getItem('再次解析') == null || sessionStorage.getItem('再次解析') == undefined || sessionStorage.getItem('再次解析') == '') || sessionStorage.getItem('再次解析') != https[num].name)) || (document.querySelector('img#江小白') && https[num].url.match(jsonvipjklxa) && (https[num].vip == null || https[num].vip == undefined || https[num].vip == '' || !https[num].vip.match(/[强制跳转弹小大窗搜索选集]/)))) {
															...
															try {
																...
																if (localStorage.getItem("objjbo") == '1') {
																	if (https[num].json == '小白' && https[num].vip.match(/DP播放器/i)) {
																		jxbloadobj(atob('aHR0cHM6Ly9jZG4uc3RhdGljZmlsZS5vcmcvaGxzLmpzLzAuMTIuNC9obHMubWluLmpz'));
																		jxbloadobj(atob('aHR0cHM6Ly9jZG4uc3RhdGljZmlsZS5vcmcvZHBsYXllci8xLjI2LjAvRFBsYXllci5taW4uanM='));
																		jxbloadobj(atob('aHR0cHM6Ly9jZG4uc3RhdGljZmlsZS5vcmcvZHBsYXllci8xLjI1LjAvRFBsYXllci5taW4uY3Nz'));
																		jxbloadobj(atob('aHR0cHM6Ly9jZG4uanNkZWxpdnIubmV0L25wbS9mbHYuanMvZGlzdC9mbHYubWluLmpz'));
																	} else if (https[num].json == '小白' && https[num].vip.match(/记忆播放器/)) {
																		localStorage.removeItem('aliplayer_lang_data_h5_2_9_3_zh-cn');
																		sessionStorage.setItem('自动下一集', '关闭');
																		jxbloadobj(atob('aHR0cHM6Ly9nLmFsaWNkbi5jb20vZGUvcHJpc21wbGF5ZXIvMi45LjMvc2tpbnMvZGVmYXVsdC9hbGlwbGF5ZXItbWluLmNzcw=='));
																		jxbloadobj(atob('aHR0cHM6Ly9nLmFsaWNkbi5jb20vZGUvcHJpc21wbGF5ZXIvMi45LjMvYWxpcGxheWVyLW1pbi5qcw=='));
																		jxbloadobj(atob('aHR0cHM6Ly9wbGF5ZXIuYWxpY2RuLmNvbS9hbGlwbGF5ZXIvcHJlc2VudGF0aW9uL2pzL2FsaXBsYXllcmNvbXBvbmVudHMubWluLmpz'));
																	} else if (https[num].json == '小白' && https[num].vip.match(/[7七]牛播放器/)) {
																		jxbloadobj(atob('aHR0cHM6Ly9zZGstcmVsZWFzZS5xbnNkay5jb20vcWluaXUtd2ViLXBsYXllci0xLjIuMy5qcw=='));
																	} else {}
																	...
																	jsonimga = setTimeout(function() {
																		try {
																			if (document.querySelector('div#江小白>div#小白>img')) {
																				document.querySelector('div#江小白>div#小白').remove();
																			} else {}
																		} catch (err) {}
																	}, 4321);
																}
															...
															try {
																...
																if (document.querySelector("万能元素解析") == null) {} else {
																	...
																	if (!document.querySelector("jxbvideo")) {
																		...
																		diyobj('<meta name="referrer" content="never"><meta http-equiv="Access-Control-Allow-Origin" content="*"><meta http-equiv="Access-Control-Allow-Headers" content="Origin,X-Requested-With,Content-Type,Accept">');
																		try {
																			if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) {
																				const sjjkslobj = document.querySelectorAll("#httpsvipul>li");
																...
																let tctha = '<div id="江小白" ' + jxbvipjxyyystyle + '><img id="江小白" src="https://api.dujin.org/bing/1920.php" ' + jxbvipjximg + '></img></div>';
																let tcthb = '<div id="江小白" ' + jxbvipjxyyystyle + '><img id="江小白" src="' + jxbimg + '" ' + jxbvipjximg + '></img></div>';
																try {
																		...
																		if (objj.indexOf('youku') > 0) {
																			...
																			function sjiqiyidszx() {
																				if (document.querySelector('div[time*=":"][class="m-box"]>div[style]:not([class]):not([id])')) {
																					...
																					document.body.appendChild(document.createElement("小江"));
																					cssobj('[name="m-videoInfo"]{margin-top:7.5%;}.m-video-player{background:black!important;}.m-video-player-wrap{top:-200px!important}963540817');
																...
																function vipobj(vip) {
																	...
																	try {
																		...
																		function vipjxdmaobj() {
																			setTimeout(function() {
																				function tcthaobj() {
																					if (document.querySelector(vip)) {
																						if ((https[num].tp != null || https[num].tp != undefined) && (https[num].tp.match(/^\s*?https:\/\//))) {
																							document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxyyystyle + '><img id="江小白" src="' + https[num].tp.replace(/(?:^\s*|\s*$)/, "") + '" ' + jxbvipjximg + '></img></div>';
																						} else {
																				...
																				try {
																					if (jxb.match(new RegExp("^https:\/\/(?!.+?(?:强制(?:弹[小大]窗|跳转|搜索)|播放器))")) && !(jxb.match(new RegExp("(?:透明无接口|布米米|视频选集)")))) {
																						if (objj.match('acfun') || (pcliwaiobj && localStorage.getItem("jxywyfsgbobj") != null & !(sessionStorage.getItem("jxywygdfsgbobj") == '1'))) {
																							if (objj.match('acfun') || localStorage.getItem("jxywyfsgbobj") == '1') {
																								tcthaobj();
																								window.open(jxb.replace(bfqzl, ""), "bkmk_popup", jxbjxqptdc)
																							} else if (localStorage.getItem("jxywyfsgbobj") == '2') {
																								tcthaobj();
																								window.open(jxb.replace(bfqzl, ""), "bkmk_popup")
																							} else if (localStorage.getItem("jxywyfsgbobj") == '3') {
																								tcthaobj();
																								window.open(jxb.replace(bfqzl, ""), "bkmk_popup", jxbjxqptck)
																							}
																						} else {
																							try {
																							...
																							if (document.querySelector(vip)) {
																								function tcthcobj() {
																									...
																									tcthcobj();
																									window.open(jxb.replace(/强制跳转.*?$/, "").replace(bfqzl, ""), "bkmk_popup");
																								} else if (https[num].vip.match(new RegExp("强制弹大窗"))) {
																									tcthcobj();
																									window.open(jxb.replace(/强制弹大窗.*?$/, "").replace(bfqzl, ""), "bkmk_popup", jxbjxqptdc);
																									...
																									if (sessionStorage.getItem("jxyxkdfsgbobj") == '1') {
																										...
																										tcthcobj();
																										window.open(jxb.replace(/强制弹小窗.*?$/, "").replace(bfqzl, ""), "bkmk_popup", jxbjxqptck);
																									} else if (localStorage.getItem("jxcxkfsgbobj") == '1') {
																										tcthcobj();
																										window.open(jxb.replace(/强制弹小窗.*?$/, "").replace(bfqzl, ""), "bkmk_popup", jxbjxqptdc);
																									} else if (localStorage.getItem("jxcxkfsgbobj") == '2') {
																										tcthcobj();
																										window.open(jxb.replace(/强制弹小窗.*?$/, "").replace(bfqzl, ""), "bkmk_popup");
																									} else {
																										tcthcobj();
																										window.open(jxb.replace(/强制弹小窗.*?$/, "").replace(bfqzl, ""), "bkmk_popup", jxbjxqptck);
																									}
																						...
																						if (jxb.match(new RegExp("透明无接口"))) {
																							try {
																								...
																								if (document.querySelector(vip)) {
																									document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxyyystyle + '><img id="江小白" src="https://ceo30.coding.net/p/ceo30/d/sjtp/git/raw/master/1.png" ' + jxbvipjximg + ' onclick="document.getElementById(\'jxbhttps\').click();"></img></div>';
																									jxqzsxobj()
																								} else {}
																							}
																		...
																		if ((https[num].json == null || https[num].json == undefined || https[num].json == '' || https[num].json == '0' || https[num].json.match(new RegExp("(?:跳转?|^\s*?(?<![非不])套壳浏?览?器?|^\s*?(?<!开)关\s*?$)")) || localStorage.getItem("objjbo") != '1') || (https[num].json != null || https[num].json != undefined || https[num].json != '') && (localStorage.getItem("objjbo") != '1')) {
																			...
																			if (https[num].json == null || https[num].json == undefined || https[num].json == '' || https[num].json == '0') {
																				...
																				if (document.querySelector(vip)) {
																					if ((https[num].tp != null || https[num].tp != undefined) && (https[num].tp.match(/^\s*?https:\/\//))) {
																						...
																						document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxyyystyle + '><img id="江小白" src="' + jxbimg + '" ' + jxbvipjximg + '></img></div>';
																					}
																				} else {}
																				jxqzsxobj();
																				window.open(jxb.replace(bfqzl, ""), "bkmk_popup");
																			...
																			if (localStorage.getItem("objjbo") == '1') {
																				...
																				byjxpd.dbfqobj = function(dbfqobja) {
																					document.querySelector(vip).innerHTML = jxbyyy;
																					try {
																						document.querySelector("div#小白").remove();
																						byjxpd.dsqcobj();
																					} catch (e) {}
																					new DPlayer({
																						element: document.querySelector('div[id="江小白"]'),
																						video: {
																							url: dbfqobja,
																							autoplay: true
																						},
																				...
																				byjxpd.qbfqobj = function(qbfqobja) {
																					...
																					new QPlayer({
																						container: document.querySelector('div[id="江小白"]'),
																						url: qbfqobja,
																						autoplay: true,
																						loggerLevel: 3,
																					});
																						...
																						try {
																							if (Jsonkg) {
																								...
																								if (document.querySelector('div#江小白>div#小白>img')) {
																									...
																									try {
																										window.open(atob(https[num].url) + jxbjxurl, "bkmk_popup", jxbjxqptck);
																									} catch (e) {
																										window.open(unescape(https[num].url) + jxbjxurl, "bkmk_popup", jxbjxqptck);
																									}
																								} else {}
																							} else {}
																						} catch (err) {}
																				...
																				if (document.querySelector(vip)) {
																					document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxidstyle + '><div id="小白" style="letter-spacing:2px;color:#f8964c;' + jxbvipjxstrongstyle + '><img src="' + jxbtupiand + '" style="width:80%;"></div></div>';
																					jxqzsxobj();
																				} else {}
																				try {
																					var flag = 'true',
																						...
																						if (https[num].tp != null || https[num].tp != undefined) {
																							...
																							setTimeout(() => {
																								if (sessionStorage.getItem("失败执行") == '1') {
																									...
																									try {
																										if ((document.querySelector("iframe#江小白") != null) || (document.querySelector("img#江小白") != null) || (document.querySelector("video#江小白") != null)) {} else {
																											try {
																												if (sessionStorage.getItem("解析失败") != null) {
																													if (document.querySelector('div#江小白>div#小白>img')) {
																														document.querySelector('div#江小白>div#小白').innerHTML = sessionStorage.getItem("解析失败");
																													} else {}
																													sessionStorage.removeItem('解析失败');
																												} else {
																						...
																						if (Jsonkg) {
																							...
																							if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																								...
																								if (https[num].vip.match(/强制弹小窗/)) {
																									window.open(https[num].bfq + encodeURIComponent(bfqtcobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup", jxbjxqptck);
																								} else if (https[num].vip.match(/强制弹大窗/)) {
																									window.open(https[num].bfq + encodeURIComponent(bfqtcobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup", jxbjxqptdc);
																								} else {
																									window.open(https[num].bfq + encodeURIComponent(bfqtcobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup");
																								}
																							}
																					...
																					byjxpd.bfqyyyobj = function(bfqyyyobja) {
																						...
																						if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																							if (Jsonkg) {
																								Jsonkg = false;
																								document.querySelector(vip).innerHTML = jxbvipjxyyy + https[num].bfq + encodeURIComponent(bfqyyyobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")) + '" ' + jxbvipjximg + '></iframe></div>';
																								jxqzsxobj();
																								try {
																									document.querySelector("div#小白").remove();
																									byjxpd.dsqcobj();
																							...
																							if (Jsonkg) {
																								...
																								if (https[num].vip.match(/强制弹小窗/)) {
																									byjxpd.byjxpbobj();
																									window.open(https[num].bfq + encodeURIComponent(bfqyyyobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup", jxbjxqptck);
																								} else if (https[num].vip.match(/强制弹大窗/)) {
																									byjxpd.byjxpbobj();
																									window.open(https[num].bfq + encodeURIComponent(bfqyyyobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup", jxbjxqptdc);
																								} else {
																									byjxpd.byjxpbobj();
																					...
																					byjxpd.jsonvipjkyyyobj = function(jsonvipjkyyyobja) {
																						...
																						if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																							if (Jsonkg) {
																								Jsonkg = false;
																								document.querySelector(vip).innerHTML = jxbvipjxyyy + jsonvipjk + encodeURIComponent(jsonvipjkyyyobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")) + '" ' + jxbvipjximg + '></iframe></div>';
																								jxqzsxobj();
																								try {
																									document.querySelector("div#小白").remove();
																									byjxpd.dsqcobj();
																							...
																							if (Jsonkg) {
																								...
																								if (https[num].vip.match(/强制弹小窗/)) {
																									byjxpd.byjxpbobj();
																									window.open(jsonvipjk + encodeURIComponent(jsonvipjkyyyobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup", jxbjxqptck);
																								} else if (https[num].vip.match(/强制弹大窗/)) {
																									byjxpd.byjxpbobj();
																									window.open(jsonvipjk + encodeURIComponent(jsonvipjkyyyobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup", jxbjxqptdc);
																								} else {
																									byjxpd.byjxpbobj();
																					...
																					byjxpd.jsonvipjktcobj = function(jsonvipjktcobjb) {
																						if (Jsonkg) {
																							...
																							if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																								...
																								if (https[num].vip.match(/强制弹小窗/)) {
																									window.open(jsonvipjk + encodeURIComponent(jsonvipjktcobjb.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup", jxbjxqptck);
																								} else if (https[num].vip.match(/强制弹大窗/)) {
																									window.open(jsonvipjk + encodeURIComponent(jsonvipjktcobjb.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup", jxbjxqptdc);
																								} else {
																									window.open(jsonvipjk + encodeURIComponent(jsonvipjktcobjb.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")), "bkmk_popup");
																								}
																							}
																					...
																					byjxpd.jsonvipbybfqaobj = function(jsonvipbybfqaobja) {
																						if (Jsonkg) {
																							...
																							if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																								...
																								if (https[num].vip.match(/强制弹小窗/)) {
																									window.open(jsonvipbybfqa + encodeURIComponent(jsonvipbybfqaobja.replace(/\\\//g, "/")).replace(bfqzl, ""), "bkmk_popup", jxbjxqptck);
																								} else if (https[num].vip.match(/强制弹大窗/)) {
																									window.open(jsonvipbybfqa + encodeURIComponent(jsonvipbybfqaobja.replace(/\\\//g, "/")).replace(bfqzl, ""), "bkmk_popup", jxbjxqptdc);
																								} else {
																									window.open(jsonvipbybfqa + encodeURIComponent(jsonvipbybfqaobja.replace(/\\\//g, "/")).replace(bfqzl, ""), "bkmk_popup");
																								}
																							}
																					...
																					byjxpd.xiaobaiobj = function(xiaobaiobja) {
																						...
																						if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																							...
																							if (https[num].vip.match(bfqzl)) {
																								if (objj.match(bfqlwobj)) {
																									if (https[num].bfq == null || https[num].bfq == undefined || https[num].bfq == '') {
																										if (jsonvipjk.match(jsonvipjklxa)) {
																											if (Jsonkg) {
																												Jsonkg = false;
																												document.querySelector(vip).innerHTML = jxbvipjxyyy + jsonvipjk + encodeURIComponent(xiaobaiobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")) + '" ' + jxbvipjximg + '></iframe></div>';
																												jxqzsxobj();
																												try {
																													document.querySelector("div#小白").remove();
																													byjxpd.dsqcobj();
																										...
																										if (https[num].bfq == null || https[num].bfq == undefined || https[num].bfq == '') {
																											if (Jsonkg) {
																												Jsonkg = false;
																												document.querySelector(vip).innerHTML = jxbvipjxyyy + https[num].bfq + encodeURIComponent(xiaobaiobja.replace(/\\\//g, "/").replace(/undefined\s*?$/, "")) + '" ' + jxbvipjximg + '></iframe></div>';
																												jxqzsxobj();
																												try {
																													document.querySelector("div#小白").remove();
																													byjxpd.dsqcobj();
																								...
																								if (Jsonkg) {
																									Jsonkg = false;
																									window.open(xiaobaiobja.replace(/\\\//g, "/"), "bkmk_popup", jxbjxqptck);
																								} else {}
																							} else if (https[num].vip.match(/强制弹大窗/)) {
																								if (Jsonkg) {
																									Jsonkg = false;
																									window.open(xiaobaiobja.replace(/\\\//g, "/"), "bkmk_popup", jxbjxqptdc);
																								} else {}
																							} else {
																								if (Jsonkg) {
																									Jsonkg = false;
																													...
																													if (https[num].url.match(jsonvipjklxa)) {
																														...
																														if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																															if (https[num].json.match(jsonvipthm)) {
																																try {
																																	if (Jsonkg) {
																																		document.querySelector(vip).innerHTML = jxbjsonvipjxyyy + atob(https[num].url) + jxbjxurl + '" ' + jxbvipjximg + '></iframe></div>';
																																		try {
																																			document.querySelector("div#小白").remove();
																																			byjxpd.dsqcobj();
																																			Jsonkg = false;
																																	...
																																	if (Jsonkg) {
																																		document.querySelector(vip).innerHTML = jxbjsonvipjxyyy + unescape(https[num].url) + jxbjxurl + '" ' + jxbvipjximg + '></iframe></div>';
																																		try {
																																			document.querySelector("div#小白").remove();
																																			byjxpd.dsqcobj();
																																			Jsonkg = false;
																																...
																																if (Jsonkg) {
																																	...
																																	byjxpd.byjxpbobj();
																																	try {
																																		window.open(atob(https[num].url) + jxbjxurl, "bkmk_popup");
																																	} catch (e) {
																																		window.open(unescape(https[num].url) + jxbjxurl, "bkmk_popup");
																																	}
																																} else {}
																															}
																														} else {
																															if (Jsonkg) {
																																...
																																if (https[num].vip.match(/强制弹小窗/)) {
																																	...
																																	try {
																																		window.open(atob(https[num].url) + jxbjxurl, "bkmk_popup", jxbjxqptdc);
																																	} catch (e) {
																																		window.open(unescape(https[num].url) + jxbjxurl, "bkmk_popup", jxbjxqptdc);
																																	}
																																} else {
																																	try {
																																		window.open(atob(https[num].url) + jxbjxurl, "bkmk_popup");
																														...
																														if (bxmlc.match(jsonvipthd)[1].replace(/\\\//g, "/").match(/^https:\/\//)) {
																															...
																															if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																																if (https[num].json.match(jsonvipthm)) {
																																	if (Jsonkg) {
																																		Jsonkg = false;
																																		document.querySelector(vip).innerHTML = jxbjsonvipjxyyy + bxmlc.match(jsonvipthd)[1].replace(/\\\//g, "/") + '" ' + jxbvipjximg + '></iframe></div>';
																																		try {
																																			document.querySelector("div#小白").remove();
																																			byjxpd.dsqcobj();
																																		} catch (e) {}
																																...
																																if (https[num].vip.match(bfqzl)) {
																																	if (objj.match(bfqlwobj)) {
																																		if (https[num].bfq == null || https[num].bfq == undefined || https[num].bfq == '') {
																																			if (jsonvipjk.match(jsonvipjklxa)) {
																																				if (Jsonkg) {
																																					Jsonkg = false;
																																					document.querySelector(vip).innerHTML = jxbvipjxyyy + jsonvipjk + encodeURIComponent(bxmlc.match(jsonvipthd)[1].replace(/\\\//g, "/").replace(/undefined\s*?$/, "")) + '" ' + jxbvipjximg + '></iframe></div>';
																																					jxqzsxobj();
																																					try {
																																						document.querySelector("div#小白").remove();
																																						byjxpd.dsqcobj();
																																			...
																																			if (https[num].bfq == null || https[num].bfq == undefined || https[num].bfq == '') {
																																				if (Jsonkg) {
																																					Jsonkg = false;
																																					document.querySelector(vip).innerHTML = jxbvipjxyyy + https[num].bfq + encodeURIComponent(bxmlc.match(jsonvipthd)[1].replace(/\\\//g, "/").replace(/undefined\s*?$/, "")) + '" ' + jxbvipjximg + '></iframe></div>';
																																					jxqzsxobj();
																																					try {
																																						document.querySelector("div#小白").remove();
																																						byjxpd.dsqcobj();
																																	...
																																	if (Jsonkg) {
																																		Jsonkg = false;
																																		byjxpd.byjxpbobj();
																																		window.open(bxmlc.match(jsonvipthd)[1].replace(/\\\//g, "/"), "bkmk_popup", jxbjxqptck);
																																	} else {}
																																} else if (https[num].vip.match(/强制弹大窗/)) {
																																	if (Jsonkg) {
																																		Jsonkg = false;
																																		byjxpd.byjxpbobj();
																																		window.open(bxmlc.match(jsonvipthd)[1].replace(/\\\//g, "/"), "bkmk_popup", jxbjxqptdc);
																																	} else {}
																																} else {
																																	if (Jsonkg) {
																																		Jsonkg = false;
																	...
																	if ((document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) && (localStorage.getItem("vipvideotg") == '1') && (localStorage.getItem("vipzdjx") != '1')) {
																		try {
									...
									if (jxbpcobj) {
												...
												if (localStorage.getItem("jkqhmsobj") == '2') {
													for (let jxbqcsjjki = 0; jxbqcsjjki < jxbqcsjjk.length; jxbqcsjjki++) {
														...
														for (let jxbqcsjjkia = 0; jxbqcsjjkia < jxbqcsjjkmsa.length; jxbqcsjjkia++) {
															...
															if (!objj.match(/\.acfun\./)) {
																if (jxbqcsjjkmsa[jxbqcsjjkia].innerText.match(/(?:跳转|[小大]窗|手机)/i)) {
										...
										(function() {
											let jxbewj = '', jxbwjstyle = 'float:left;border-radius:3.5px;color:#000!important;box-shadow:inset rgba(255,254,255,.6) 0 0.3em 0.3em,inset rgba(0,0,0,.15) 0 -0.1em 0.3em,#d82661 0 0.1em 3px,#b7144a 0 0.3em 1px,rgba(0,0,0,.2) 0 0.5em 5px;background:0 0;font-weight:700;font-size:16px;padding:5px 2.5px 5px 2.5px;border:2.5px outset buttonface;text-decoration:none;background-color:#4CAF50;', jxbhttpsew = [{
												...
												name: jxbewj + '<span id="sjqbvipjk" style="' + jxbwjstyle + '" href="javascript:void(0);" onclick="localStorage.removeItem(\'jkqhmsobj\');location.reload();">\u5168\u90e8</span>'
											}, {
											...
											function createSelectew(jxbhttpsew) {
												...
												document.body.insertAdjacentHTML('beforeend', '<style type="text/css">div[id^="jjxxkk"]{margin:0px;padding:0px;position:fixed;width:max-content;bottom:75px;left:50%;transform:translateX(-50%);z-index:102030;overflow:auto hidden;text-align:center;}div[id^="jjxxkk"]>span,div[id^="jjxxkk"]>a{font-weight:bold;float:left;border-radius:25%;padding:10px 5px 10px 5px;font-size:large;border:4px outset buttonface;color:midnightblue;text-decoration:none;background-color:violet;}</style><div id="jjxxkka" style="display:none;"><span id="sjzdws">备用解析</span><span><a href="https://greasyfork.org/zh-CN/scripts/431238">辅助脚本</a></span></div>');
								...
								(function() {
									if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875")) {
										...
										jxqvipimg.addEventListener('click', function() {
											if (document.querySelector("img#江小白")) {} else {
												try {
													document.querySelector("video").pause();
												} catch (e) {}
												try {
													document.querySelector("div#江小白").innerHTML = '<div id="江小白" ' + jxbvipjxyyystyle + '><img id="江小白" src="https://api.dujin.org/bing/1920.php" ' + jxbvipjximg + '></img></div>';
												} catch (e) {}
												tcthbobj();
												jxqzsxobj();
											}
						...
						function zddjobj() {
							...
							setTimeout(function() {
								...
								function jiangxiaobaiviphyzdpd() {
									...
									} else {} if (document.querySelector("div#江小白") && !document.querySelector("恢复声音")) {
										document.body.appendChild(document.createElement("恢复声音"));
										jxbvolumeaobj();
										log("%c江小白： 已经自动打开了声音", "border-left:5px solid #A0B;color:#A0B;padding:3px");
									} else {} if (document.querySelector('div#江小白 video') && document.querySelector('div#江小白>div#小白>img')) {
										document.querySelector('div#江小白>div#小白').remove();
									} else {} if (document.querySelector('江小白电脑网页')) {
										if (!document.querySelector('div#江小白') && document.querySelector("jiangxiaobai") && ((mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 1 || vipzdjx == 2 || (vipzdjx != 1 && vipvideotg == 1)))) {
											if (!document.querySelector("\u8df3\u8fc7\u5e7f\u544a") && vipzdjx != 1 && vipvideotg == 1) {
													...
													if (obj.match(/^https?:\/\/v(?:-wb)?\.youku\.com\/v_show\/id_/)) {
														...
														if (localStorage.getItem("ymyypdobj") == '0') {
															if ((((!document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl]') && document.querySelector('[class*="item"][class$=" current"]:not([tabindex]) i[class="mark_v"]>img[src*="_vip"]:not([alt])[src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])')) || (document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl] i[class="mark_v"]>img[src*="_vip"][alt][src$=".png"]:not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*=".png/"])') && document.querySelector('[class*="item"][class$=" current"]:not([tabindex]) i[class="mark_v"]>img[src*="_vip"][src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])')) || document.querySelector('[class*="item"][class$=" current"]:not([tabindex])[tl] i[class="mark_v"]>img[src*="_vip"]:not([alt])[src$=".png"]:not([src*="_trai"]):not([src*="_only"]):not([src*="_self"]):not([src*="_full"]):not([src*="_number"]):not([src*=".png/"])[srcset*="_vip"][srcset$=".png 2x"]:not([srcset*="_trai"]):not([srcset*="_only"]):not([srcset*="_self"]):not([srcset*="_full"]):not([srcset*="_number"]):not([srcset*=".png/"])')) && document.querySelector("video") != null) && !$("txpdiv.txp_ad_inner txpdiv.txp_ad_control txpdiv.txp_ad_skip_text:contains('关闭'):contains('广告')")[0]) {
																dnzddjobj("%c江小白-电脑-腾讯会员自动解析-00-a-工作中");
															}
														} else {}
														if ($("txpdiv.txp_alert_info:contains('试看')")[0] && $("txpdiv.txp_alert_info txpdiv:contains('会员')")[0]) {
															...
															dnzddjobj("%c江小白-电脑-腾讯会员自动解析-03-工作中");
														...
														if (localStorage.getItem("ymyypdobj") == '0') {
															if ((document.querySelector('ul>li[class*="item"][class$=" selected"] img[src*="/vip"][src$=".png"]:not([src*=".png/"])[srcset*="/vip"][srcset*=".png"]:not([srcset*=".png/"])') || document.querySelector('ul>li[class*="item"][class$=" selected"] img[src*="/VIP"][src$=".png"]:not([src*=".png/"])[srcset*="/VIP"][srcset*=".png"]:not([srcset*=".png/"])')) && document.querySelector('[tabindex="-1"][data-player-hook]>video[src^="blob:http"]')) {
																document.querySelector("jiangxiaobai").remove();
																setTimeout(function() {
																	dnzddjobj("%c江小白-电脑-爱奇艺会员自动解析-00-a-工作中");
																}, 1234);
																...
																document.querySelector("jiangxiaobai").remove();
																setTimeout(function() {
																	dnzddjobj("%c江小白-电脑-爱奇艺会员自动解析-00-b-工作中");
																}, 1234);
												...
												dnzddjobj("%c江小白-电脑全局自动解析-工作中");
											} else {}
										} else {}
									} else if (document.querySelector('江小白手机网页')) {
										if (!document.querySelector('div#江小白') && vipzdjx == 2 && document.querySelector("jiangxiaobai")) {
											document.querySelector("jiangxiaobai").remove();
											jxbvolumebobj();
											zdztsp();
											setTimeout(function() {
							...
							if (vipzdjxwzobj) {
								readyobj();
								ready('div#江小白 video', function(element) {
									if (document.querySelector('div#江小白 video') && document.querySelector('div#江小白>div#小白>img')) {
										document.querySelector('div#江小白>div#小白').remove();
									} else {}
								});
							} else {}
							...
							"complete" == document.readyState && setTimeout(function() {
								try {
									if (location.href.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|m\.youku\.com\/.+?\/id_|[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)|v\.qq\.com\/(?:x\/cover|.+?\/p\/topic)\/|(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)|w(?:ww)?\.mgtv\.com\/(?:b|act)\/|m\.mgtv\.com\/b\/|www\.iqiyi\.com\/(?:[awv]_|kszt\/)|tw\.iqiyi\.com\/v_|m\.iqiyi\.com\/v_|tv\.sohu\.com\/v\/|film\.sohu\.com\/album\/|m\.tv\.sohu\.com\/(?:v|phone_play_film\?aid=)|www\.le\.com\/ptv\/vplay\/|m\.le\.com\/vplay_|v\.pptv\.com\/show\/|m\.pptv\.com\/show\/|vip\.1905\.com\/play\/|www\.ixigua\.com\/\d{10,}|m\.ixigua\.com\/video\/\d{10,}|www\.bilibili\.com\/bangumi\/play\/|m\.bilibili\.com\/bangumi\/play\/|www\.acfun\.cn\/bangumi\/|m\.acfun\.cn\/v\/)/) && !(location.href.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/(?:a_|kszt\/)/) && document.title.match(new RegExp("在线观看"))) && !(location.href.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/v_/) && document.title.match(new RegExp("名师课堂")))) {
										if (document.querySelector("div#jxbhttps") != null) {} else {
											setTimeout(function() {
												if (document.querySelector("\u6c5f\u5c0f\u767d\u624b\u673a\u7f51\u9875") != null) {
													if (localStorage.getItem("vipzdjx") == '2') {
														if (document.querySelector("div#江小白") == null) {
										...
										(function() {
											try {
												...
												document.addEventListener('visibilitychange', function() {
													try {
														let videoaobj = document.querySelector('video'), videobobj = document.querySelector('div#江小白'), videocobj = document.querySelector('div#江小白 video');
									...
									if (jxbpcobj && (pcliwaiobj || ttbkjjliobj || mmkjjtjobj || obj.match(/^https?:\/\/(?:www\.bilibili\.com\/(?!bangumi\/play\/)|www\.acfun\.cn\/(?!bangumi\/))/))) {
										try {
													...
													if (pcliwaiobj || ttbkjjliobj) {
														if (pcliwaiobj) {
															(function() {
																...
																try {
																	if (document.querySelector("img#江小白")) {} else {
																		if (document.querySelector('div#江小白 button[data-balloon="全屏"]:not([data-balloon*="页面"])')) {
																			document.querySelector('div#江小白 button[data-balloon="全屏"]:not([data-balloon*="页面"])').click();
																		} else if (document.querySelector('div#江小白 [class="prism-cc-btn"][id^="江小白"]')) {
																			try {
																				document.querySelector('div#江小白 [class="prism-fullscreen-btn"]').click();
																			} catch (err) {}
																		} else if (document.querySelector("iframe#江小白")) {
																			if (document.querySelector('video')) {
																				if (document.querySelector('div#江小白 button[data-balloon="全屏"]:not([data-balloon*="页面"])')) {} else if (document.querySelector('div#江小白 [class="prism-cc-btn"][id^="江小白"]')) {} else {
																					setTimeout(function() {
																						try {
											...
											function sddjb() {
												try {
													if (pcliwaiobj || ttbkjjliobj) {
														sessionStorage.setItem('允许重复', '允许重复');
														jxqzsxobjzdbtobj();
														zddjjk();
													} else {}
												} catch (e) {}
												...
												try {
													if ((pcliwaiobj && !jxbpclwobj) || objj.match('(?:bilibili|acfun)')) {
														(function() {
															try {
																(async() => {
																	const videos = Array.from((!document.querySelector("#江小白") && document.querySelectorAll('video')) || document.querySelectorAll('div#江小白 video')).filter(video => video.readyState != 0).filter(video => video.disablePictureInPicture == false).sort((v1, v2) => {
