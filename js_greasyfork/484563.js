// ==UserScript==
// @name AudioBookBay hide category: Paranormal
// @description Hide Paranormal category
...
// @downloadURL https://update.greasyfork.org/scripts/484563/AudioBookBay%20hide%20category%3A%20Paranormal.user.js
// @updateURL https://update.greasyfork.org/scripts/484563/AudioBookBay%20hide%20category%3A%20Paranormal.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact phrase 'Paranormal'
    $(".post").has(".postInfo:contains('Paranormal')").hide();
});
