...
// @namespace    mr.a.j.jd
// @version      1.2
// @description  黄牛内部专用的京东抢购助手，可以抢购任何商品，比如小米9、IQOO等，超强直接下单。
...
// @downloadURL https://update.greasyfork.org/scripts/379440/%E4%BA%AC%E4%B8%9C%E6%8A%A2%E8%B4%AD%E7%A7%92%E6%9D%80%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/379440/%E4%BA%AC%E4%B8%9C%E6%8A%A2%E8%B4%AD%E7%A7%92%E6%9D%80%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
function appendBtn() {
    var btn = '<div id="kaiguandiv"><button class="mybtn" id="gotologin">→ 提前登录 ←</button><div class="mymsg" id="banben"></div><button class="mybtn" id="kaiguanbtn">选择型号后，点我下单<br/>【微信公众号：今天好无聊】</button></div>';
    $("body").append(btn);
    $("#kaiguandiv").css({
        'position': 'fixed',
        'top': '0px',
