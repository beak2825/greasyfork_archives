// ==UserScript==
// @name         Swipe word search on Douban
// @version      2025-01-07T1523
// @namespace    http://tampermonkey.net/
// @description  Swipe word search, quickly select search engine, one-click search, jump to Baidu, Google, Bing, etc. Note: The first icon is the button to open the URL, which is only available when the Chinese text is selected as the link.
// @author       Sufjan
...
// @grant        GM_getValue
// @license      Sufjan
// @downloadURL https://update.greasyfork.org/scripts/523098/Swipe%20word%20search%20on%20Douban.user.js
// @updateURL https://update.greasyfork.org/scripts/523098/Swipe%20word%20search%20on%20Douban.meta.js
// ==/UserScript==
...
(function () {
    ...
    var iconArray = [
        ...
        // },
        {
            name: '夸克',
            image: 'data:image/png;base64,',
            host: ['www.kuafuzys.com'],
            popup: function (text) {
                open(`https://www.kuafuzys.com/search-${text}-1-0-1.htm`);
            }
        },
