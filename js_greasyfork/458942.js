// ==UserScript==
// @name         Getcoin Cryptopedia Rotator
...
// @match        https://getcoin.cryptopedia.id/
// @connect      getcoin.cryptopedia.id
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_xmlhttpRequest
// @antifeature  referral-link
// @downloadURL https://update.greasyfork.org/scripts/458942/Getcoin%20Cryptopedia%20Rotator.user.js
// @updateURL https://update.greasyfork.org/scripts/458942/Getcoin%20Cryptopedia%20Rotator.meta.js
// ==/UserScript==
...
(function() {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                                 //
    // INSTALL THE SCRIPT AND RECAPTCHA SOLVER                                                         //
    // EDIT WITH YOUR FAUCETPAY EMAIL ADDRESS BELOW                                                    //
    // THEN GOTO https://getcoin.cryptopedia.id/?ref=4678 AND LEAVE THE TAB OPEN                       //
    //                                                                                                 //
    /////////////////////////////////////////////////////////////////////////////////////////////////////



     var faucetpayemailaddress = "lotocamion@gmail.com";//EDIT WITH YOUR FAUCETPAY EMAIL ADDRESS
    ...
    var websiteData = [
        ...
        {url : "https://getcoin.cryptopedia.id/user/faucet/BTC", regex: "BTC"},
        {url : "https://getcoin.cryptopedia.id/user/faucet/BNB", regex: "BNB"},
        {url : "https://getcoin.cryptopedia.id/user/faucet/DGB", regex: "DGB"},
        {url : "https://getcoin.cryptopedia.id/user/faucet/DOGE", regex: "DOGE"},
        {url : "https://getcoin.cryptopedia.id/user/faucet/LTC", regex: "LTC"},
        {url : "https://getcoin.cryptopedia.id/user/faucet/SOL", regex: "SOL"},
        {url : "https://getcoin.cryptopedia.id/user/faucet/TRX", regex: "TRX"},
    ...
    var websiteMap = [
                       ...
                       {website : ["getcoin.cryptopedia.id"],
                       captchaButtonSubmitSelector: ["#btnSubmit > div > button","body > div:nth-child(1) > main > div > div > div > div > div > form > button","#subbutt","#page-top > div.row > div > div > div > form > div > button"],
                       allMessageSelectors: [".swal2-title",".alert.alert-danger.text-center",".alert.alert-warning",".alert.alert-success",".alert.alert-danger",".swal2-html-container",".next-button.lh-1.mb-1.font-weight-bold",".fas.fa-sync.fa-spin"],
                       successMessageSelectors: [".alert.alert-success"],
                       messagesToCheckBeforeMovingToNextUrl: ["time","to your wallet","sufficient funds","please comeback again tomorrow","has been sent to your FaucetPay","API Key used","Safety Limit reached","The faucet does not have sufficient funds for this transaction","insufficient","you have reached", "tomorrow","wrong order", "locked", "was sent to your", "You have to wait","Login not valid","You have already claimed","claimed successfully","Claim not Valid","rate limited"],
     ...
     if (window.location.href.includes("https://getcoin.cryptopedia.id/User/Dashboard")) {
     window.location.replace("https://getcoin.cryptopedia.id/user/faucet/BTC");
     }},10000)
   ...
   var ablinksSolved = false;
    ...
    var delayBeforeMovingToNextUrl = 80000;
