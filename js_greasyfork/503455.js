...
// @downloadURL https://update.greasyfork.org/scripts/503455/%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE%2009.user.js
// @updateURL https://update.greasyfork.org/scripts/503455/%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%BE%2009.meta.js
// ==/UserScript==
...
(function () {
    ...
    title: 'СВОЙ ОТВЕТ',
    content:
    '[SIZE=4][FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "Твой текст <br><br>"+
     "Приятной игры и времяпровождения на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/FONT][/CENTER][/SIZE]",
    },
    {
    ...
    '[CENTER]На рассмотрении.[/CENTER][/SIZE]',
    prefix: PIN_PREFIX,
    status: true,
    },
    {
    ...
    content:
    '[SIZE=4][FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба взята на рассмотрение. Просьба не создавать подобных тем, иначе форумный аккаунт может быть заблокирован[/CENTER]<br><br>"+
    '[CENTER]Ожидайте ответа.[/CENTER][/SIZE]',
    prefix: PIN_PREFIX,
    status: true,
    },
    {
        title: 'Одобренные / [Закрыто] жалобы',
        style: 'width: 97%; background: #8a0002; box-shadow: 0px 0px 5px #fff',
    },
    {
    ...
    '[CENTER]Приятной игры и времяпровождения на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/SIZE]',
    ...
    {
    title: 'будет рассмотрено (Заявки)',
    content:
    '[SIZE=4][FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    ...
    content:
    '[SIZE=4][FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Скоро всё будет рассмотрено, сроки рассмотрения не нарушаются.[/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождения на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/SIZE]',
    prefix: CLOSE_PREFIX,
    status: false,
    },
    ...
    {
    title: 'Окно бана отредактировано',
    content:
    '[SIZE=4][FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Скриншот блокировки аккаунта отредактирован, жалоба не подлежит рассмотрению.[/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождения на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Заместителям главного администратора[/color] - @Vanya Donissimo, @Nikolay_Kashtanov [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>",
    prefix: PIN_PREFIX,
    status: true,
    },
    {
    ...
    '[CENTER]На рассмотрении.[/Color][/CENTER][/SIZE]',
    prefix: SA_PREFIX,
    status: true,
    },
    {
