// ==UserScript==
// @name        SpyShareNoCommander
// @namespace   SpyShareNamespaceNoCommander
// @author		GigelFrone
// @include     *.ogame.gameforge.com/game/*
// @require     http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js
// @description SpyShare for Ogame: Allows you to share spy reports with your buddies even if you are not in the same alliance. No Commander required
// @version     2.0
// @downloadURL https://update.greasyfork.org/scripts/4740/SpyShareNoCommander.user.js
// @updateURL https://update.greasyfork.org/scripts/4740/SpyShareNoCommander.meta.js
// ==/UserScript==

var SSR = {};
var noSpyShareTxt = "\n\n\ If you see this message then you don't have the SpyShare Tool, it is not active/working. For more info check the[url=https://greasyfork.org/scripts/4740-spysharenocommander] SpyShareNoCommander Page [/url]";
...
SSR.Updater = {
	...
	call: function(alertResp) {
		GM_xmlhttpRequest({
			method: 'GET',
			url: 'https://greasyfork.org/scripts/4740-spysharenocommander/code/' + this.scriptId + '.meta.js',
		...
		try{
			...
			if (newVersion > this.currVersion) {
				if (confirm('A new version of the ' + this.scriptName + ' user script is available. Do you want to update?')) {
					...
					top.location.href = 'https://greasyfork.org/scripts/4740-spysharenocommander/code/' + this.scriptId + '.user.js';
				}
				else {
