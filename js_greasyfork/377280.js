...
// @match        *://*.yuekeyun.com/*
// @include      *://*
// @downloadURL https://update.greasyfork.org/scripts/377280/lark-ui-route.user.js
// @updateURL https://update.greasyfork.org/scripts/377280/lark-ui-route.meta.js
// ==/UserScript==
...
(function () {
    ...
    if(document.title.indexOf('凤凰云智') > -1){
        ...
        reissueReportBtn.bind('click', function(){
            sendDingTalk("补发详细报告：" + reportUrl + "/report/uiAutoRouteReport");
            alert("补发一级路由报告成功!")
        });
        ...
        function testOpenTab() {
            try {
                ...
                if (tabIndex < tabLen && sessionStorage.getItem('helper-tabOpenTest')=== 'true'){
                    ...
                    // 等待10s,统计结果落库再发送
                    setTimeout(function(){
                        sendDingTalk("详细报告：" +  reportUrl + "/report/uiAutoRouteReport");
