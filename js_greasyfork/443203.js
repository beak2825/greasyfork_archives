...
// @downloadURL https://update.greasyfork.org/scripts/443203/%E5%85%A8%E7%BD%91VIP%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90%E6%92%AD%E6%94%BE%E5%99%A8%28%E5%B7%B2%E9%80%82%E9%85%8D%E6%89%8B%E6%9C%BA%29.user.js
// @updateURL https://update.greasyfork.org/scripts/443203/%E5%85%A8%E7%BD%91VIP%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90%E6%92%AD%E6%94%BE%E5%99%A8%28%E5%B7%B2%E9%80%82%E9%85%8D%E6%89%8B%E6%9C%BA%29.meta.js
// ==/UserScript==
/**
 * 任务清单：
 */
        ...
        if (window === top) {
            ...
            */
            settings.NoAD解析 = {    // TODO by 17kyun.com/api.php?url=    // TODO by tv.hzwdd.cn
                ...
                "多视口": "https://video.isyour.love/player/getplayer?url=",    // TODO (待测试)
                "多视口": "https://video.isyour.love/player/getplayer?url=",    // TODO (待测试)
                "TV解析": "https://jx.bozrc.com:4433/player/?url=",    // TODO 腾讯 (芒果)
                "天翼解析": "https://video.isyour.love/player/getplayer?url=",    // TODO 腾讯 (芒果) (B站)
                "爱解析": "https://jx.iztyy.com/svip/?url=",    // TODO 腾讯 (芒果)
                "咸鱼解析": "https://jx.xyflv.com/?url=" || "https://okjx.cc/?url=" || "https://m2090.com/?url=",    // TODO 优质: 腾讯 (爱奇艺) 优酷 乐视 芒果 PPTV (华数)
                "全民解析": "https://www.administratorw.com/video.php?url=" || "https://chaxun.truechat365.com/?url=",    // TODO 已失效
            };
        ...
        if (window === top) {
            ...
            function readyPlayerBox(Tip, displayNones, srcs, cssString, doFunction, doHref = null) {
                ...
                doElement(cssString, async playerBox => {
                    ...
                    iframe.onload = () => {
                        // 判断iframe加载完成的时间
                        if (new Date().getTime() - iframeStartTime < 1) {
