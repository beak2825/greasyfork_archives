// ==UserScript==
// @name         Metacritic: YouTube Game Review Search
// @description  Adds YouTube search links to Metacritic game pages
// @version      0.7
// @author       mica
// @namespace    greasyfork.org/users/12559
// @match        https://www.metacritic.com/*
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/392492/Metacritic%3A%20YouTube%20Game%20Review%20Search.user.js
// @updateURL https://update.greasyfork.org/scripts/392492/Metacritic%3A%20YouTube%20Game%20Review%20Search.meta.js
// ==/UserScript==

function makeLink() {
    setTimeout(() => {
        var title = document.querySelector('.c-productHero_title').innerText;
        var link = 'https://www.youtube.com/results?search_query=' + encodeURIComponent(title) + ' game review';
        var html = `
        <div style="margin: 0 0 0 27px">
            <a href="${link}">
            <p style="font-size: smaller; color: black; line-height: 17px; margin: 0">Search Reviews on</p>
            <svg viewBox="0 0 381 85">
                <path fill="red" d="M118.9 13.3c-1.4-5.2-5.5-9.3-10.7-10.7C98.7 0 60.7 0 60.7 0s-38 0-47.5 2.5C8.1 3.9 3.9 8.1 2.5 13.3 0 22.8 0 42.5 0 42.5s0 19.8 2.5 29.2C3.9 76.9 8 81 13.2 82.4 22.8 85 60.7 85 60.7 85s38 0 47.5-2.5c5.2-1.4 9.3-5.5 10.7-10.7 2.5-9.5 2.5-29.2 2.5-29.2s.1-19.8-2.5-29.3z"/>
                <path fill="white" d="M48.6 60.7l31.6-18.2-31.6-18.2z"/>
