...
// @downloadURL https://update.greasyfork.org/scripts/30572/%E6%B7%98%E7%B1%B3%E8%BE%85%E5%8A%A9%E5%B7%A5%E5%85%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/30572/%E6%B7%98%E7%B1%B3%E8%BE%85%E5%8A%A9%E5%B7%A5%E5%85%B7.meta.js
// ==/UserScript==
...
(function() {
    ...
    */
    ...
    window.onload = function(){
        ...
        if( sWindowUrl.indexOf('aliyun.com') !=-1){
            ...
            wanwang.fixDomainSearchInfoForDetailLinks();
        }
        // 兼容聚名网
    ...
    */
    ...
    function WanWang(){
        ...
        this.fixDomainSearchInfoForDetailLinks = function(){
            // https://www.benmi.com/whois/qiniuyun.com?spm=5176.8071224.1023.6.234e468695nf3L&file=qiniuyun.com
            setInterval(function(){
                $('#domainSearchBtns a').each(function(i, e){
                    if($(e).attr('data-spm-anchor-id')){
                        $(e).attr('href', $(e).attr('href').replace(/spm=[0-9a-zA-Z\.]+&(file=[0-9a-zA-Z\.]+)?/, '').replace(/\?$/,''));
                    }
                });
            },50);
        }
