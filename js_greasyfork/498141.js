...
// @downloadURL https://update.greasyfork.org/scripts/498141/%E6%8A%96%E9%9F%B3%E5%B7%A5%E5%85%B7%E6%B5%8B%E8%AF%95.user.js
// @updateURL https://update.greasyfork.org/scripts/498141/%E6%8A%96%E9%9F%B3%E5%B7%A5%E5%85%B7%E6%B5%8B%E8%AF%95.meta.js
// ==/UserScript==
...
setTimeout(function(){
    ...
    $(function(){
        ...
        if(rex.match(/https:\/\/www.douyin.com\/user\/*/) != null){
            ...
            const isKeyword = unsafeWindow.location.search.split("?type=")[1]=="keyword"
            // 检测到搜索页面跳转过来时 自动抓取
            if(isKeyword) {
                ...
                // 获取90天前的时间戳
                let ninetyDaysAgo = currentTimeStamp - (90 * 24 * 60 * 60 * 1000);
                const sec_uid = unsafeWindow.location.pathname.split("/")[2]
                getWorkData(ninetyDaysAgo,sec_uid)
            }
            // 同步作品
