...
// @downloadURL https://update.greasyfork.org/scripts/6430/OiNKPlus.user.js
// @updateURL https://update.greasyfork.org/scripts/6430/OiNKPlus.meta.js
// ==/UserScript==
//
// ------------------------------------------------------------------------
//
...
// 29.3.1       2022/02/20
//
//      change: Fix Deezer search URL.
//
// 29.3         2022/02/18
//
//      change: Tracker Apollo renamed Orpheus.
//              Replaced Google search for iTunes with Apple Music search and renamed 'The iTunes Store' to 'Apple Music (US)'.
//      remove: Trackers NotWhat, Shellife and Waffles (RIP. Especially Shellife :'()
//
// 29.2         2017/02/20
//
...
//         add: Trackers Apollo.RIP, DEEPBASSNiNE, Efecto Doppler, NoStream, NotWhat.CD and PassTheHeadphones.
...
var sitFields = {
  ...
  'show_itunes': {'type': 'checkbox', 'label': 'Add Apple Music', 'default': true, 'title': 'Add the search link to OiNKPlus'},
...
var extData = [
  ...
  ['Apple Music (US)', 'itunes', 'https://music.apple.com/us/search/artist?term=%ARTIST%', false, '',
   false, '', '',
  ...
  ['Deezer', 'deezer', 'http://www.deezer.com/search/%ARTIST%', false, '/%2F/g, \'%20\'',
   false, '', '',
...
var traData = [
  ...
  ['Orpheus', 'orpheus', '1', true,
   ...
   'return null;',
   'var titles = document.getElementsByTagName("title");\n  if (titles.length > 0) {\n    var str = titles[0].textContent;\n    str = str.replace(/(.+?) - (.+) \\[\\d{4}\\]( :: What\.CD)?/, \'$2\');\n    return str;\n  } else return \'\';',
   'png', ''],
