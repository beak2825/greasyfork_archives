// ==UserScript==
// @name AudioBookBay hide category: Zombies
// @description Hide Zombies category
...
// @downloadURL https://update.greasyfork.org/scripts/484580/AudioBookBay%20hide%20category%3A%20Zombies.user.js
// @updateURL https://update.greasyfork.org/scripts/484580/AudioBookBay%20hide%20category%3A%20Zombies.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Zombies'
    $(".post").has(".postInfo:contains('Zombies')").hide();
});
