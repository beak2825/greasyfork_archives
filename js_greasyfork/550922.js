...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/550922/CSS%20EDITOR.user.js
// @updateURL https://update.greasyfork.org/scripts/550922/CSS%20EDITOR.meta.js
// ==/UserScript==
...
(() => {
  ...
  createStyle('inventory-style', `
    .inventory-slot, .inventory-item, .slot, .item {
      background-color: rgba(144, 238, 144) !important;
      border: 2px solid ${config.neonColor} !important;
      box-shadow: 0 0 10px ${config.neonColor}cc, inset 0 0 6px ${config.neonColor}aa !important;
