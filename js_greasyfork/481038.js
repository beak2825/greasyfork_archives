// ==UserScript==
// @name        CosmosisT's TinyChat Script (CTS V1.8.57) added features
// @version     1.8.57
...
// @downloadURL https://update.greasyfork.org/scripts/481038/CosmosisT%27s%20TinyChat%20Script%20%28CTS%20V1857%29%20added%20features.user.js
// @updateURL https://update.greasyfork.org/scripts/481038/CosmosisT%27s%20TinyChat%20Script%20%28CTS%20V1857%29%20added%20features.meta.js
// ==/UserScript==
...
(function() {
    ...
    var CTS = {
        ...
        Room: {},
        ScriptInit: false,
        MainBackground: "radial-gradient(white, black) #000",
...
//                    Send("msg", (window.CTSWelcomes[Rand(0, window.CTSWelcomes.length - 1)] + arguments[0].nick.toUpperCase()) + ((CTS.GreetMode) ? ".\n" + (((user != "GUEST") ? "You are signed in as " + user : "You are not signed in") + ".\nWelcome to the room!") : "!"));
    ...
    function SetLocalValues() {
        if (CTS.StorageSupport) {
            ...
            CTS.MainBackground = Load("MainBackground", "radial-gradient(white, black) #000");
