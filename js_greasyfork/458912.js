// ==UserScript==
// @name         Скрипт для жалоб на игроков by A.Yurev
...
// @license 	 MIT
// @copyright 2022,
// @downloadURL https://update.greasyfork.org/scripts/458912/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1%20%D0%BD%D0%B0%20%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2%20by%20AYurev.user.js
// @updateURL https://update.greasyfork.org/scripts/458912/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1%20%D0%BD%D0%B0%20%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2%20by%20AYurev.meta.js
// ==/UserScript==
...
const buttons = [
    {
	  title: 'Приветствие',
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте уважаемый  {{ user.mention }}.[/CENTER]<br><br>' +
		"[CENTER][/CENTER]<br><br>" +
    ...
    {
	  title: '____________________ОТКАЗАТЬ____________________',
	},
    {
	  title: '____________________ОТКАЗАТЬ____________________',
	},
	...
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
		"[CENTER]В ваших доказательствах нет нарушений со стороны игрока.<br><br>" +
		'[CENTER]Отказано, закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: FAIL_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
		"[CENTER]В вашей жалобе не предоставлено достаточного объёма доказательств нарушений от игрока.<br><br>" +
		'[CENTER]Отказано, закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: FAIL_PREFIX,
	  status: false,
	},
	...
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
		"[CENTER]В названии темы необходимо указать никнейм игрока, на которого подается жалоба, и суть жалобы.<br><br>" +
		'[CENTER]Отказано, закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: FAIL_PREFIX,
	  status: false,
	},
    ...
    {
	  title: '______________________ОДОБРИТЬ______________________',
	},
    {
	  title: '______________________ОДОБРИТЬ______________________',
	},
	...
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]Общепризнанный язык сервера — русский. Общение в IC чатах во всех Role Play ситуациях обязательно должно проходить исключительно на русском языке | Устное замечание / Mute 30 минут.[/SIZE][/QUOTE][/CENTER]<br><br>" +
		'[CENTER]Одобрено, закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: OKAY_PREFIX,
	  status: false,
	},
	...
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
        "[CENTER]Ваша жалоба передана на рассмотрение техническому специалисту, пожалуйста ожидайте ответа.[/CENTER]<br><br>" +
		'[CENTER]На рассмотрение.[/CENTER][/FONT][/SIZE]',
	  prefix: OKAY_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
		"[CENTER]Ваша жалоба передана на рассмотрение Главному Администратору, пожалуйста ожидайте ответа.[/CENTER]<br><br>" +
		'[CENTER]Ожидайте ответа.[/CENTER][/SIZE][/FONT]',
	  prefix: WAIT_PREFIX,
	  status: true,
	},
      {
	  title: 'Передать жалобу ГКФ/ЗГКФ',
	  content:
		'[SIZE=4][FONT=Georgia][CENTER]Здравствуйте,  {{ user.mention }}.[/CENTER]<br><br>' +
		"[CENTER]Ваша жалоба передана на рассмотрение Главному Куратору Форума или его заместителю, пожалуйста ожидайте ответа.[/CENTER]<br><br>" +
		'[CENTER]Ожидайте ответа.[/CENTER][/SIZE][/FONT]',
	  prefix: WAIT_PREFIX,
	  status: true,
	},
