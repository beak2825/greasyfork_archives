// ==UserScript==
// @name        fixed SBB's take on scripting.
// @include	    *://diep.io/*
// @author      Sbb and Dep_
// @description Makes some tanks more powerful (Tri-angle branch, spread shot, penta shot, octo tank, gunner trapper, streamliner).
// @connect	    diep.io
// @namespace   aaa
// @version 0.0.1.20200227000440
// @downloadURL https://update.greasyfork.org/scripts/454260/fixed%20SBB%27s%20take%20on%20scripting.user.js
// @updateURL https://update.greasyfork.org/scripts/454260/fixed%20SBB%27s%20take%20on%20scripting.meta.js
// ==/UserScript==
...
(function(){
	...
	var tankData = [
        {name: "Fighter", cycleRate: 0.003095, maxAngle: Math.PI * 150 / 180, secondaryAngle: Math.PI/2, NCANNON: 3},
        {name: "Tri-angle", cycleRate: 0.003095, maxAngle: Math.PI * 150 / 180, NCANNON: 2},
        ...
        {name: "Tank", cycleRate: 0.003095, maxAngle: Math.PI * 180 / 180, NCANNON: 2},
	];
	var tankIndex = 0;
