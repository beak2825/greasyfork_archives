// // ==UserScript==
// @name SOCHI | Admins Script for forum by Tsoy
...
// @downloadURL https://update.greasyfork.org/scripts/458438/SOCHI%20%7C%20Admins%20Script%20for%20forum%20by%20Tsoy.user.js
// @updateURL https://update.greasyfork.org/scripts/458438/SOCHI%20%7C%20Admins%20Script%20for%20forum%20by%20Tsoy.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[COLOR=rgb(209, 213, 216)]Приятной игры на [/COLOR][/I][COLOR=rgb(209, 213, 216)][I]BLACK RUSSIA Sochi.<br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Обратитесь в технический раздел - [/SIZE][/FONT][/COLOR][/I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][URL='https://clck.ru/NM4QK']*нажмите сюда*[/URL]<br>" +
        "[I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Закрыто.[/I][/SIZE][/FONT][/COLOR][/CENTER]',
      prefix: CLOSE_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        ...
        "Приятной игры на BLACK RUSSIA Sochi.[/I][/SIZE][/COLOR][/FONT]<br><br>" +
