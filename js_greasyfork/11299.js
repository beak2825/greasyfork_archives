...
// @copyright  2013+, You
// @downloadURL https://update.greasyfork.org/scripts/11299/Netflix%20-%20Import%20Cookie%20Premium.user.js
// @updateURL https://update.greasyfork.org/scripts/11299/Netflix%20-%20Import%20Cookie%20Premium.meta.js
// ==/UserScript==
...
if (location.href.indexOf('movies') == -1)
    $(local).children().first().before('<div style="width: 100%; max-width: 500px; padding: 5px; border: #000 solid 3px; background-color: #FFF;"><span>'+msg+'</span><br><textarea id="cookie_text" style="width:98%; height: 400px;"></textarea><br><center><a href="#" onclick="return false;" style="color:#FFF; background-color: red;" id="cookie_login">Login com Cookie</a></center><br><span style="float: right;">by FernandoXLR</span><br></div>');
