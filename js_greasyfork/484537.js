...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/484537/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%7C%20GOLD.user.js
// @updateURL https://update.greasyfork.org/scripts/484537/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20%7C%7C%20GOLD.meta.js
// ==/UserScript==
...
},
{
	 title: 'На рассмотрении',
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][COLOR=YELLOW][SIZE=4]Ваша жалоба взята на рассмотрение, ожидайте ответа в данной теме.[/SIZE][/COLOR][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][COLOR=YELLOW][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/COLOR][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
            '[I][CENTER][SIZE=3][COLOR=rgb(255, 140, 0)][ICODE]На рассмотрение...[/ICODE][/SIZE][/CENTER][/COLOR]',
        prefix: PINN_PREFIX,
	  status: true,
    },
{
	    title: 'На рассмотрении у ГКФ',
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/Mqs0cgwx/IMG-20240103-233852.jpg[/img][/url][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][COLOR=YELLOW][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][COLOR=YELLOW][SIZE=4]Ваша жалоба передана главному куратору форума[/COLOR][COLOR=BLUE] (@Aleks_Yurievich),[/COLOR][COLOR=YELLOW] ожидайте ответа в данной теме.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][COLOR=YELLOW][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/COLOR][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
            '[I][CENTER][SIZE=3][COLOR=rgb(255, 140, 0)][ICODE]На рассмотрение...[/ICODE][/SIZE][/CENTER][/COLOR]',
        prefix: PINN_PREFIX,
	  status: true,
},
{
    ...
    content:
    "[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Доброго времени суток, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
    "[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан. [/SIZE][/FONT] <br><br>"+
          "[B][CENTER][FONT=georgia][SIZE=4][COLOR=GREEN][ICODE]Одобрено[/ICODE][/COLOR][/SIZE][/FONT]<br><br>",
            prefix: ACCСEPT_PREFIX,
    status: false,
},
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Доброго времени суток, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба передана на рассмотрение[/COLOR] [COLOR=BLUE]Техническому специалисту сервера [/COLOR], [COLOR=lavender]ожидайте ответа.[/SIZE][/COLOR][/FONT]<br><br>"+
                "[B][CENTER][COLOR=BLUE][ICODE]На рассмотрении у тех. специалиста[/ICODE][/COLOR]<br><br>",
        prefix: TEXY_PREFIX,
	  status: true,
},
{
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша жалоба [COLOR=GREEN]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для силовых структур: [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][COLOR=lavender][FONT=times new roman][Color=#ff0000]7.02.[/color] Запрещено выдавать розыск, штраф без Role Play причины [Color=#ff0000]| Warn[/color].[/COLOR][/CENTER][/B]<br><br>"+
                 "[B][CENTER][FONT=georgia][SIZE=4][COLOR=GREEN][ICODE]Одобрено[/ICODE][/COLOR][/SIZE][/FONT]<br><br>",
        prefix: ACCСEPT_PREFIX,
	  status: false,
},
...
},
{
	  title: 'Недостаточно док-в',
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][COLOR=YELLOW][SIZE=4]Недостаточно доказательств для корректного рассмотрения вашей жалобы.[/SIZE][/COLOR][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 254, 253)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
},
{
      title: 'Отсутствуют док-ва',
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][COLOR=YELLOW][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/COLOR][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][COLOR=YELLOW][SIZE=4]Отсутствуют доказательства - следовательно, рассмотрению не подлежит. Загрузите доказательства на фото-видео хостинги[/COLOR][COLOR=RED]YouTube,[/COLOR][COLOR=GREEN] Imgur,[/COLOR][COLOR=PURPLE] Yapix[/COLOR][COLOR=YELLOW] и так далее.[/COLOR][/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>" +
              "[I][CENTER][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=rgb(255, 165, 0)][B][SIZE=1]Role Play[/SIZE][/B][/COLOR]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
},
{
    ...
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
        ...
        "[B][CENTER][SIZE=4][FONT=TIMES NEW ROMAN][COLOR=YELLOW]Форма для подачи жалобы на игрока будет предоставлена ниже. [/B][/CENTER][/SIZE][/FONT][/COLOR]<br><br>"+
        "[B][CENTER][SIZE=4][FONT=TIMES NEW ROMAN][COLOR=ORANGE] 1. Ваш Nick_Name: [/B][/CENTER][/SIZE][/FONT][/COLOR]<br><br>"+
        "[B][CENTER][SIZE=4][FONT=TIMES NEW ROMAN][COLOR=ORANGE] 2. Nick_Name игрока: [/B][/CENTER][/SIZE][/FONT][/COLOR]<br><br>"+
        "[B][CENTER][SIZE=4][FONT=TIMES NEW ROMAN][COLOR=ORANGE] 3. Суть жалобы: [/B][/CENTER][/SIZE][/FONT][/COLOR]<br><br>"+
        "[B][CENTER][SIZE=4][FONT=TIMES NEW ROMAN][COLOR=ORANGE]  4. Доказательство: [/B][/CENTER][/SIZE][/FONT][/COLOR]<br><br>"+
                "[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR]<br><br>",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
},
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
    ...
    },
    {
      ...
      content:
      "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>"+
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br><br>'+
        '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[B][CENTER][SIZE=5][FONT=GEORGIA][COLOR=YELLOW] Вы сами совершили ошибку при совершении сделки. Ваша жалоба получает префикс [/COLOR][COLOR=RED]отказано.[/B][/CENTER][/SIZE][/FONT][/COLOR]<br><br>"+
        "[B][CENTER][SIZE=5][FONT=GEORGIA][COLOR=YELLOW] В следующий раз будьте внимательнее.[/B][/CENTER][/SIZE][/FONT][/COLOR]"+
        "[B][CENTER][SIZE=3][FONT=GEORGIA][COLOR=RED][ICODE]Отказано[/ICODE][/B][/CENTER][/SIZE][/FONT][/COLOR]<br><br>",
       prefix: 4,
        status:false,
    },
{
...
},
{
...
},
  {
	  ...
	  content:
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=#2c82c9]Доброго времени суток, уважаемый {{ user.mention }}[/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][FONT=georgia][SIZE=3][COLOR=lavender] Ваша RolePlay-биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], так как в ней содержится недостаточное количество информации о Вашем персонаже.               Заполните каждый пункт максимально подробно. [/SIZE][/FONT] <br><br>"+
                "[B][CENTER][COLOR=RED][ICODE]Отказано[/ICODE][/COLOR]<br><br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
},
