...
// @downloadURL https://update.greasyfork.org/scripts/438546/VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/438546/VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91%E8%87%AA%E5%8A%A8%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
								...
								if (document.querySelector("\u6c5f\u5c0f\u767d\u81ea\u5b9a\u4e49\u63a5\u53e3") != null) {} else {
									...
									if (localStorage.getItem("jkqhmsobj") == '2') {
										...
										httpsaobj = [{
											...
											name: "猪蹄",
											url: "https://jx.iztyy.com/Bei/?url=",
											ys: "1",
											jj: "1"
										},{
											name: "乐多",
												...
												try {
													if (https[num].vip != null || https[num].vip != undefined) {
														if (https[num].vip.match(/\u65e0\u63a5\u53e3/)) {
															...
															if ((https[num].vip.match(/^\s*?[&\?]/) && !https[num].vip.match(/[强制跳转弹小大窗搜索选集](?!播放器)/))) {
																httpsvipli.innerHTML = bb + aa+++hh + https[num].name;
															...
															try {
																...
																if (document.querySelector('\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875')) {
																	if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																		...
																		if (https[num].vip.match(/[强制跳转弹小大窗搜索选集]/)) {} else {
																			cjthzdxjobj();
																		}
																	}
																} else {}
																				...
																				try {
																					...
																					byjxpd.jsonvipbybfqaobj = function(jsonvipbybfqaobja) {
																						if (Jsonkg) {
																							...
																							byjxpd.byjxpbobj();
																							if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '') {
																								window.open(jsonvipbybfqa + encodeURIComponent(jsonvipbybfqaobja.replace(/\\\//g, "/")), "bkmk_popup");
																							} else {
																								if (https[num].vip.match(/强制弹小窗/)) {
																									window.open(jsonvipbybfqa + encodeURIComponent(jsonvipbybfqaobja.replace(/\\\//g, "/")), "bkmk_popup", jxbjxqptck);
																								} else if (https[num].vip.match(/强制弹大窗/)) {
																									window.open(jsonvipbybfqa + encodeURIComponent(jsonvipbybfqaobja.replace(/\\\//g, "/")), "bkmk_popup", jxbjxqptdc);
																								} else {
																									window.open(jsonvipbybfqa + encodeURIComponent(jsonvipbybfqaobja.replace(/\\\//g, "/")), "bkmk_popup");
																								}
																							}
								...
								function jxbspad() {
									if (!document.querySelector("\u8df3\u8fc7\u5e7f\u544a")) {
										...
										if (objj.match(/\.youku\./)) {
											...
											try {
												jxbvideoada = setInterval(function() {
													let qqvideogg = document.querySelectorAll('.txp_ad video');
													if (qqvideogg.length) {
