...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/452832/Bheese%20CSS.user.js
// @updateURL https://update.greasyfork.org/scripts/452832/Bheese%20CSS.meta.js
// ==/UserScript==
setInterval(() => {
$("#room").css({background: "rgba(204, 0, 204, 0.5)" });
$("#room .more").css({background: "rgba(204, 0, 204, 0.5)"});
$("#room .expand").css({background: "rgba(204, 0, 204, 0.5)"});
$("#room .more .info:hover").css({background: "rgba(204, 0, 204, 0.5)"});
$("#room .more .new").css({background: "rgba(204, 0, 204, 0.5)"});
$("#room .more").css({background: "rgba(204, 0, 204, 0.5)"});
$("#room .more .new:hover").css({background: "rgba(204, 0, 204, 0.5);"});
$(".ugly-button").css({background: "rgba(247, 218, 69, 0)", "border-radius": "8px", "-webkit-border-radius": "8px", "-moz-border-radius": "8px" });
...
$(".notification-body").css({background: "rgba(153, 51, 255, 0.5)", "backdrop-filter": "blur(2px)"});
$(".notification .x:hover").css({background: "rgba(153, 51, 255, 0.5)"});
$(".notification-body").css({background: "rgba(204, 51, 255, 0.5)", "backdrop-filter": "blur(2px)"});
$(".ugly-button .stuck").css({background: "rgba(204, 51, 255, 0.5)"});
document.body.style = `background-image: url('https://w.wallhaven.cc/full/5d/wallhaven-5d1mx7.jpg'); background-position: 25% 75%; background-size: cover; backdrop-effect: blur(2px);`
}, 1);
