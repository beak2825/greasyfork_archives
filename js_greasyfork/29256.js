// ==UserScript==
// @name          WaniKani SRS REORDER
// @namespace     https://www.wanikani.com
// @description   WaniKani Review Order by starplayer, based on Wanikani Review Order
// @version 0.35
// @include       https://www.wanikani.com/review/session
// @include       http://www.wanikani.com/review/session
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/29256/WaniKani%20SRS%20REORDER.user.js
// @updateURL https://update.greasyfork.org/scripts/29256/WaniKani%20SRS%20REORDER.meta.js
// ==/UserScript==
function get(id) {
...
function reorder(){
    ...
    for(var i=0;i<revList.length;i++){
        var it=revList[i];
        if(it.rad)
            console.log('rad '+it.rad+it.srs);
        else if(it.kan)
           console.log('kan '+it.kan+it.srs);
        else if(it.voc)
            console.log('voc '+it.voc+it.srs);
    }
