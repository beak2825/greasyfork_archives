...
// @name           Virtonomica: PriceVeraStepanov
...
// @include        http*://virtonomica*.*/vera/main/unit/view/*/trading_hall
// @include        http*://virtonomica*.*/olga/main/unit/view/*/trading_hall


// @version        0.04
// @grant          A
// @description Quick installation prices of goods in the trading hall.
// @downloadURL https://update.greasyfork.org/scripts/392545/Virtonomica%3A%20PriceVeraStepanov.user.js
// @updateURL https://update.greasyfork.org/scripts/392545/Virtonomica%3A%20PriceVeraStepanov.meta.js
// ==/UserScript==
...
var run = function () {
  ...
  $tbody.parent().before("<div><input id='qps_costPrice' type='text' value='20'>доля рынка"
    ...
    $tbody.children("tr").each(function() {
      ...
      if ($tr.children("td").length === 1) {
        ...
        if ((group === -1 || group === groupId) && (item === -1 || item === itemId)) {
          ...
          if(itemCost > price){ price = itemCost * 1.2;}
       ...
       else if  (price < 10000000 )price = Math.round( price/50000 ) *50000;
