// ==UserScript==
// @name        WME Form Filler - Happy_Lyn Fork
...
// @author      crazycaveman, then modified by Happy_Lyn
// @license     null
// @run-at      document-end
...
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/387823/WME%20Form%20Filler%20-%20Happy_Lyn%20Fork.user.js
// @updateURL https://update.greasyfork.org/scripts/387823/WME%20Form%20Filler%20-%20Happy_Lyn%20Fork.meta.js
// ==/UserScript==
...
//removed all forms other than Michigan (West) Closures
        forms = [{
            //https://docs.google.com/forms/d/e/1FAIpQLSduBiLMhbg6nRpsEVCTcVbV4eWmHDXdIKGtuaOvzy6NZLbSgw/viewform?entry.423113505=username&entry.925483030=CLOSED&entry.1351627132=permalink&entry.742680589=Two-Way&entry.1767715296=reason&entry.1625107686=2016-09-20+03:00&entry.1721084517=street+name&entry.419741702=from+street&entry.264371504=to+street&entry.1867193205=SC&entry.1714138473=county&entry.1119784099=city&entry.1881823075=source&entry.1633056272=notes
            name: "Michigan (West) Closures",
            url: "https://docs.google.com/forms/d/e/1FAIpQLScMLLOYQJx7fg34HIiX5S85VupT4pn0_6C73wsr1uira5P6IA/viewform",
            fields: {
                username: "423113505",
                closureStatus: "925483030",
                permalink: "1351627132",
                closedDir: "742680589",
                closedReason: "1767715296",
                endDate: "1625107686",
                streetname: "1721084517",
                fromStreet: "419741702",
                toStreet: "264371504",
