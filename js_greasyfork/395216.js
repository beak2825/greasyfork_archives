// ==UserScript==
	...
	// @author       zeluqa 
	// @contributor  bagdet45, azules500, Globani
	// @match        *://shadowlog.com/*
	// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/395216/Shadowlog%20Translation.user.js
// @updateURL https://update.greasyfork.org/scripts/395216/Shadowlog%20Translation.meta.js
	// ==/UserScript==
	...
	(function() {
	    ...
	    var words_trends = {
	        ...
	        '2Pick対戦':'Take Two',
	        '対戦解析ログ':'Match Data',
                '「アルティメットコロシアム」に対応しました。':'Ultimate Colosseum is supported.',
		...
		'※上記のデッキ別勝率は当サイトの利用ユーザーの方の裁量に任せた手動でのデータ入力になっているため、一部のデッキの勝率が高くなってしまう傾向がありますのでご了承ください。':'※Please note that the above win rates for each deck tend to be higher for some decks because the data is manually entered at the discretion of the user of this site.',
	    ...
	    var words_archetypes = {
	        ...
	        '自然ロイヤル':'Natura Sword',
	    	'ペインレスロイヤル':'Steadfast Samurai Sword',
	        ...
	        'バーンウィッチ':'Burn Rune',
		    '魔道具専門店ウィッチ':'Arcane Item Shop Rune',
	    	'自然ウィッチ':'Natura Rune',
	    	'式神ウィッチ':'Shikigami Rune',
