// ==UserScript==
// @name         InDriver Chat History Extractor
...
// @downloadURL https://update.greasyfork.org/scripts/524739/InDriver%20Chat%20History%20Extractor.user.js
// @updateURL https://update.greasyfork.org/scripts/524739/InDriver%20Chat%20History%20Extractor.meta.js
// ==/UserScript==
...
(function() {
    ...
    async function getOldestUuid(requestId) {
        ...
        const headers = {
            ...
            'authorization': 'Bearer eyJhbGciOiJFZERTQSIsImtpZCI6IjIwMjMxMjEzIiwidHlwIjoiSldUIn0.eyJzdXBwb3J0X3VzZXIiOnsiaWQiOiJBWXZ3WUF6NWNObUZISjVBeXNwTTlRPT0iLCJhY2Nlc3MiOnsicmVhZCI6dHJ1ZSwid3JpdGUiOnRydWV9fSwiaXNzIjoianVzdCIsImV4cCI6MTczNzY1Njc4MCwiaWF0IjoxNzM3NjIwNzgwfQ.0eiNrtkxag-NJZuEPQ1eH23q26tJ_ONnTKrymBUTvgpHvTUUnqntbtuyuM7_T-A3Zm3itoBr_PUqNVfA-EbpCA'
        };
