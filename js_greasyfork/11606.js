// ==UserScript==
// @name        	Block Advertising Servers
// @namespace       https://greasyfork.org/en/scripts/11606-block-advertising-servers
// @version     	1.0
// @description 	Automatiacally block advertising urls.
// @author       	euverve/thatskie
// @include         http://*
// @include         https://*
// @exclude         https://greasyfork.org/*
// @run-at          document-start
// @downloadURL https://update.greasyfork.org/scripts/11606/Block%20Advertising%20Servers.user.js
// @updateURL https://update.greasyfork.org/scripts/11606/Block%20Advertising%20Servers.meta.js
// ==/UserScript==

//Block malware domains
var badurls =[['007-gateway.com', 'admedia.com', 'affiliationcash.com', 'bstrtb.com', 'deplayer.net', 'futureresiduals.com', 'iunbrudy.net', 'milabra.com', 'performanceadvertising.mobi', 'saltamendors.com', 'tldadserv.com', 'wigetstudios.com'],
			['0icep80f.com', 'ad-media.org', 'affiliation-france.com', 'btnibbler.com', 'deployads.com', 'futureus.com', 'ivism.org', 'millennialmedia.com', 'performance-based.com', 'salvador24.com', 'tlvmedia.com', 'winbuyer.com'],
			['101m3.com', 'admedias.net', 'affiliationworld.com', 'btrll.com', 'derlatas.com', 'fwmrm.net', 'iwantmoar.net', 'millionairesurveys.com', 'performancetrack.info', 'saple.net', 'tnyzin.ru', 'wingads.com'],
...
for (var i = 0, len = badurls.length; i < len; i++) {
	var urls = badurls[i];
	for (var j = 0, len = urls.length; j < len; j++) {
		var regexp = new RegExp(urls[j]);
