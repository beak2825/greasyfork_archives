...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/25151/Torto%27s%20Macro.user.js
// @updateURL https://update.greasyfork.org/scripts/25151/Torto%27s%20Macro.meta.js
// ==/UserScript==
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> Made By <b>Torto<b></span></span></center>";
load();
function load() {
