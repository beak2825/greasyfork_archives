// ==UserScript==
// @name         BLACK | Скрипт для Кураторов Форума by D.Luv
...
// @downloadURL https://update.greasyfork.org/scripts/520420/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20DLuv.user.js
// @updateURL https://update.greasyfork.org/scripts/520420/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20by%20DLuv.meta.js
// ==/UserScript==
...
const buttons = [
      ...
      content:
          '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][ICODE][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>',
      },
    {
      title: 'помеха рп процессу',
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
     "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
     ...
     "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     ...
     "[HEADING=3][CENTER][COLOR=#00FF00][I][B][FONT=georgia][SIZE=4][ICODE]Одобрено![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]<br><br>",
     ...
     },
    {
     ...
     },
     {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
     "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br>" +
     "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    ...
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
    "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>"+
    "[HEADING=3][CENTER][COLOR=#00FF00][I][B][FONT=georgia][SIZE=4][ICODE]Одобрено![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
       prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
   ...
   },
   {
       ...
       content:
          '[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][ICODE][I]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR]<br><br>',
    },
    {
        title: 'Тех спецу',
      content:
    ...
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 255, 0)][I][B][FONT=georgia][SIZE=4][ICODE]На рассмотрении![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
       prefix: TEX_PREFIX,
      status: false,
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[COLOR=rgb(255, 0, 0)][I][FONT=georgia][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=georgia][SIZE=4]ГКФ @Greenfield Stoyn , ЗГКФ @Joseph Murphy  [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=georgia][SIZE=4], ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
    "[SPOILER][I][FONT=georgia][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 255, 0)][I][B][FONT=georgia][SIZE=4][ICODE]На рассмотрении![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
     ...
     content:
         "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
     "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
     "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Вы ошиблись разделом, обратитесь в раздел жалоб на технических специалистов - [/I][URL='https://forum.blackrussia.online/index.php?forums/Сервер-№10-black.1191/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/B][/I][/CENTER][/HEADING]<br><br>" +
     ...
     "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Закрыто![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
        prefix: CLOSE_PREFIX,
        status: false,
   },
    {
        ...
        content:
          "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
     "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
     "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию - [/I][URL='https://forum.blackrussia.online/index.php?forums/Жалобы-на-администрацию.468/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/B][/I][/CENTER][/HEADING]<br><br>" +
     "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
     "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Закрыто![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
  ...
  },
    {
        ...
        content:
          "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
          "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
          "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Вы ошиблись разделом, обратитесь в раздел жалоб на хелперов - [/I][URL='https://forum.blackrussia.online/threads/black-Жалобы-на-Агентов-Поддержки-Для-Игроков.4847458/page-3#post-22446785']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/B][/I][/CENTER][/HEADING]<br><br>" +
          ...
          "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
          "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
          "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Закрыто![/ICODE][/SIZE][/FONT][/B][/COLOR][/CENTER][/HEADING]",
       prefix: CLOSE_PREFIX,
       status: false,
  },
    {
        ...
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
        "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
        "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров - [/I][URL='https://forum.blackrussia.online/index.php?forums/Жалобы-на-лидеров.469/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/B][/I][/CENTER][/HEADING]<br><br>" +
        "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
        "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
        "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
        "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Закрыто![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
   ...
   },
    {
        ...
        content:
           "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
           "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
           "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Вы ошиблись разделом, обратитесь в раздел жалоб на сотрудников в разделе вашей организации.[/SIZE][/FONT][/COLOR][/B][/I][/CENTER][/HEADING]<br><br>" +
           "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
           "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
           "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
           "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Закрыто![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
        ...
        content:
           "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
           "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
           "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Вы ошиблись разделом, обратитесь в раздел обжалований наказаний - [/I][URL='https://forum.blackrussia.online/index.php?forums/Обжалование-наказаний.471/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/B][/I][/CENTER][/HEADING]<br><br>" +
           "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
           "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
           "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
           "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Закрыто![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
      ...
      },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Вы ошиблись разделом, обратитесь в технический раздел - [/I][URL='https://forum.blackrussia.online/index.php?forums/Технический-раздел-black.488/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Закрыто![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    "[HEADING=3][CENTER][COLOR=#00FF00][I][B][FONT=georgia][SIZE=4][ICODE]Одобрено![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Обмен автокейса, покупка доп слота на машину в семью и тд на виртуальную валюту запрещен, соответственно никакого нарушения со стороны игрока нет.  [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Вам нужно было подать жалобу в игре в /report > 1, а не на форум. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[SPOILER][FONT=georgia][I][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/SIZE][/I][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
       prefix: UNACCEPT_PREFIX,
      status: false,
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Нельзя писать одну жалобу на двух и белее игроков ( на каждого игрока отдельная жалоба). [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[SPOILER][FONT=georgia][I][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/SIZE][/I][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Недостаточно доказательств для корректного рассмотрения вашей жалобы. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[SPOILER][FONT=georgia][I][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/SIZE][/I][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Отсутствуют доказательства - следовательно, рассмотрению не подлежит. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша жалоба отказана т.к написана от 3го лица. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[SPOILER][FONT=georgia][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваши доказательства не открываются. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее еще раз и сделайте новую жалобу. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[SPOILER][FONT=georgia][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша жалоба отказана, так как Видео-доказательства обрываются. Загрузите полную Видеозапись на видео-хостинг YouTube. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Доказательства были подвергнуты редактированию - следовательно, рассмотрению не подлежит. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[SPOILER][FONT=georgia][I][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Доказательства в социальных сетях и т.д. не принимаются. Загрузите доказательства на фото-видео хостинги YouTube,Imgur, Yapx и так далее. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[SPOILER][FONT=georgia][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваши доказательства в плохом качестве. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[SPOILER][FONT=georgia][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Нарушений со стороны игрока не было замечено. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно изучите общие правила серверов - [/I][URL='https://forum.blackrussia.online/index.php?threads/%D0%9E%D0%B1%D1%89%D0%B8%D0%B5-%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%BE%D0%B2.312571/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] На доказательствах отсутствуют условия сделки - следовательно, рассмотрению не подлежит. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] На доказательствах отсутствуют дата и время (/time). [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша жалоба отказана, т.к. в ней нет таймкодов. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша жалоба отказана, т.к. с момента нарушения прошло более 72-ух часов. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша жалоба отказана, т.к. ранее уже был дан ответ. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][ICODE]{{ greeting }}, уважаемый {{ user.mention }}.[/ICODE][/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша жалоба составлена не по форме. Внимательно прочитайте правила подачи жалоб на игроков, закрепленные в этом разделе. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[FONT=georgia][SPOILER][SIZE=4][I][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][/I][COLOR=rgb(209, 213, 216)]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован. [/COLOR][/I][/SIZE][/FONT][/SPOILER]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4][ICODE]Отказано![/ICODE][/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]",
    ...
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay - биография одобрена. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay - биография на доработке. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay - биография отказана т.к у вас NonRP NickName. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay - биография отказана т.к. заголовок оформлен неправильно. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4]Отказано![/SIZE][/FONT][/B][/I][/COLOR][/CENTER][/HEADING]<br>",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay - биография отказана т.к запрещено создавать более одной RP Биографии на один Nick. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4]Отказано![/SIZE][/FONT][/I][/B][/COLOR][/CENTER][/HEADING]<br>",
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay - биография отказана т.к. написана от 1го лица. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP - биографий закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    "[HEADING=3][CENTER][COLOR=rgb(255, 0, 0)][I][B][FONT=georgia][SIZE=4]Отказано![/SIZE][/FONT][/B][/I][/COLOR][/CENTER][/HEADING]<br>",
      ...
      },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay Ситуация одобрена. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[FONT=georgia][SIZE=4][CENTER][SPOILER][I][B][COLOR=rgb(0, 221, 0)]Одобрено [/COLOR][/CENTER][/SPOILER][/I][/SIZE][/FONT]<br><br>" ,
       prefix: ACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay Ситуация отказана. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP ситуаций закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay Ситуация отказана т.к она скопирована. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP ситуаций закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay Ситуация отказана т.к она составлена не по форме. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP ситуаций закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[FONT=georgia][SIZE=4][CENTER][I][B][COLOR=rgb(255, 0, 0,)]Отказано![/COLOR][/CENTER][/I][/SIZE][/FONT]<br><br>" ,
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay Ситуация отказана т.к название темы указано не верно [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[FONT=georgia][SIZE=4][CENTER][I][B][COLOR=rgb(255, 0, 0,)]Отказано![/COLOR][/CENTER][/I][/SIZE][/FONT]<br><br>" ,
       prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша RolePlay Ситуация отказана т.к в ней нет имеющего смысла. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Внимательно прочитайте правила создания RP ситуаций закрепленные в данном разделе [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[FONT=georgia][SIZE=4][CENTER][I][B][COLOR=rgb(255, 0, 0,)]Отказано![/COLOR][/CENTER][/I][/SIZE][/FONT]<br><br>" ,
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша Неофициальная RolePlay организация одобрена. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша Неофициальная RolePlay организация отказана. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша Неофициальная RolePlay организация отказана т.к в ней нет имеющего смысла. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[FONT=georgia][SIZE=4][CENTER][I][B][COLOR=rgb(0, 221, 0)]Отказано! [/COLOR][/CENTER][/I][/SIZE][/FONT]<br><br>" ,
       prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша Неофициальная RolePlay организация отказана т.к у вас нет стартового состава от 3ёх+ человек. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[FONT=georgia][SIZE=4][CENTER][I][B][COLOR=rgb(0, 221, 0)]Отказано! [/COLOR][/CENTER][/I][/SIZE][/FONT]<br><br>" ,
       prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша Неофициальная RolePlay организация отказана т.к составлена не по форме. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[FONT=georgia][SIZE=4][CENTER][I][B][COLOR=rgb(0, 221, 0)] Отказано! [/COLOR][/CENTER][/I][/SIZE][/FONT]<br><br>" ,
       prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/dtjwvqrV/1805-2.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR][/HEADING]<br><br>" +
    "[HEADING=3][CENTER][I][B][I][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4] Ваша Неофициальная RolePlay организация отказана т.к она скопирована. [/SIZE][/FONT][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br><br>" +
    "[IMG]https://i.postimg.cc/k4zLNHSZ/OXMgDyr.png[/IMG][/CENTER]<br>"+
     "[HEADING=3][CENTER][B][COLOR=rgb(0, 0, 0)][SIZE=5][FONT=georgia]Приятной игры на [/FONT][COLOR=rgb(255, 255, 255)][FONT=georgia]Black Russia[/FONT][/COLOR][/SIZE][/COLOR][SIZE=5][COLOR=rgb(0, 0, 0)][FONT=georgia] BLACK[/FONT][/COLOR][/SIZE][/B][I][B][I][COLOR=rgb(209, 213, 216)][SIZE=5][FONT=georgia].[/FONT][/SIZE][/COLOR][/I][/B][/I][/CENTER][/HEADING]<br>" +
     "[FONT=georgia][SIZE=4][CENTER][I][B][COLOR=rgb(0, 221, 0)]Отказано! [/COLOR][/CENTER][/I][/SIZE][/FONT]<br><br>" ,
       prefix: UNACCEPT_PREFIX,
