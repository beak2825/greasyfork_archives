...
// @downloadURL https://update.greasyfork.org/scripts/435297/%5B%E5%AE%9E%E9%AA%8C%5D%20DCF%20%E6%8A%96%E9%9F%B3%E6%96%87%E5%AD%97%E5%B0%81%E9%9D%A2%E5%AF%BC%E5%85%A5%E5%8A%A9%E6%89%8B%20v2.user.js
// @updateURL https://update.greasyfork.org/scripts/435297/%5B%E5%AE%9E%E9%AA%8C%5D%20DCF%20%E6%8A%96%E9%9F%B3%E6%96%87%E5%AD%97%E5%B0%81%E9%9D%A2%E5%AF%BC%E5%85%A5%E5%8A%A9%E6%89%8B%20v2.meta.js
// ==/UserScript==

// 定义基础变量
const btn1Id = '_lab_douyin_task_btn'
const btn2Id = '_lab_douyin_tmpl_btn'
const storageTemplaeKey = '_template'
const apiBase = 'http://10.10.0.10:3002/2110/makedy'
...
function showButton1() {
    const $container = $('video').parent().parent().parent()
    $container.parent().css('overflow', 'visible')
    $container.before(`
      <div id="${btn1Id}" style="display: hidden; position: relative; top: 74px; left: -30px; width: 25px; height: 25px; cursor: pointer; color: white; font-weight: bold; text-align: center; line-height: 24px;"></div>
    `);
}
...
function showButton2() {
    ...
    $container.parent().css('overflow', 'visible')
    $container.before(`
      <div id="${btn2Id}" style="position: relative; left: -30px; top: 80px; width: 25px; height: 25px; background: gray; cursor: pointer; color: white; text-align: center; line-height: 25px;">${template}</div>
    `);
}
