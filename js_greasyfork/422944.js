...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/422944/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.user.js
// @updateURL https://update.greasyfork.org/scripts/422944/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.meta.js
// ==/UserScript==
        ...
        onLoad() {
            ...
            this.waitFor(_=>this.token).then(_ => {
                ...
                if ( this.isElectron() || !this.isDefined(GM) ) {
                    ...
                    alert("This Script Needs Updating, Head Over To Krunker Extra On YouTube");
...
<div class="imageButton Yt Here" onmouseenter="playTick()" onclick="openURL('https://www.youtube.com/channel/UCKN9qye5ZIGvCvq0fwrRNjg')"><span style='display:inline'></span></div>`
