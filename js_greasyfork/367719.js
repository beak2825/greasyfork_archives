...
// @author       GeTing
// @match        http://www.missevan.com/sound/player?id=*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/367719/%E7%8C%AB%E8%80%B3%E7%AE%80%E5%8D%95%E8%BF%87%E6%BB%A4%E5%BC%B9%E5%B9%95.user.js
// @updateURL https://update.greasyfork.org/scripts/367719/%E7%8C%AB%E8%80%B3%E7%AE%80%E5%8D%95%E8%BF%87%E6%BB%A4%E5%BC%B9%E5%B9%95.meta.js
// ==/UserScript==
...
},{"fbjs/lib/invariant":13,"fbjs/lib/warning":15,"./lib/ReactPropTypesSecret":23}],8:[function(require,module,exports) {
...
},{"object-assign":11,"fbjs/lib/invariant":13,"fbjs/lib/emptyObject":12,"fbjs/lib/warning":15,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":14}],5:[function(require,module,exports) {
'use strict';
...
},{"fbjs/lib/invariant":13,"react":5,"fbjs/lib/warning":15,"fbjs/lib/ExecutionEnvironment":17,"object-assign":11,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":14,"fbjs/lib/getActiveElement":21,"fbjs/lib/shallowEqual":19,"fbjs/lib/containsNode":20,"fbjs/lib/emptyObject":12,"fbjs/lib/hyphenateStyleName":18,"fbjs/lib/camelizeStyleName":22}],6:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":9}],10:[function(require,module,exports) {
var bundleURL = null;
...
var FilterButton = /** @class */function (_super) {
    ...
    function FilterButton() {
        ...
        _this.timer = null;
        _this.filterDM = function () {
            $("#commentCanvas > div").filter(function (index, el) {
                var v = $(el).html() || "";
                _this.state.blackList.forEach(function (word) {
                    if (v.includes(word)) {
                        $(el).css("opacity", "0");
                    }
                });
        ...
        _this.onKeyDown = function (e) {
            if (e.which === 13) {
                var blackList = _this.state.blackList;
                var addValue = _this.input.value;
                var obj_1 = {};
                blackList = [addValue].concat(blackList).filter(function (w) {
                    if (obj_1[w]) return false;
                    obj_1[w] = true;
                    return true;
                });
        ...
        _this.onRemove = function (word) {
            var blackList = _this.state.blackList;
            blackList = blackList.filter(function (v) {
                return v !== word;
            });
            _this.setState({ blackList: blackList });
            localStorage.setItem("blackList", blackList.join(","));
    ...
    FilterButton.prototype.componentDidMount = function () {
        var _this = this;
        var v = localStorage.getItem("blackList");
        this.setState({ blackList: v ? v.split(",") : [] });
        this.timer = setInterval(function () {
            _this.filterDM();
        }, 500);
        $("body").click(function (e) {
            if (!_this.main.contains(e.target)) {
                _this.setState({ show: false });
            }
        });
    };
    FilterButton.prototype.componentWillUnmount = function () {
    ...
    FilterButton.prototype.render = function () {
        ...
        return React.createElement(
            ...
            { ref: function ref(c) {
                    return _this.main = c;
                }, key: "1", className: "dmbtn-container" },
            React.createElement(
                "div",
                { className: "mpcdm", style: { width: "50px", textAlign: "center" }, onClick: this.onToggle },
                "\u8FC7\u6EE4\u5217\u8868"
            ),
            React.createElement(
                "div",
                { id: "dm-controller", style: { display: show ? "block" : "none", height: "200px", top: "auto", bottom: "30px" } },
                React.createElement(
                    "div",
                    { className: "dm-controller", style: { display: "flex", flexDirection: "column" } },
                    React.createElement(
                        "div",
                        { style: { flexGrow: 1, overflow: "auto", paddingRight: "10px" } },
                        blackList.map(function (v) {
                            return React.createElement(
                                "div",
                                { key: v, style: { display: "flex", lineHeight: "28px" } },
                                React.createElement(
                                    "span",
                                    { style: { flexGrow: 1 } },
                                    v
                    ...
                    React.createElement("input", { ref: function ref(c) {
                        ...
                        }, placeholder: "\u5173\u952E\u5B57", onKeyDown: this.onKeyDown, style: {
                            padding: "4px 8px",
...
var insertDOM = function insertDOM() {
    if ($("#myList")[0]) {
        clearInterval(timer);
        return;
    }
    $("#mpin").css("width", "560px");
    $("#prdm").append("<div id=\"myList\"></div>");
    ReactDOM.render(React.createElement(FilterButton, null), document.getElementById("myList"));
};
timer = setInterval(function () {
    insertDOM();
}, 1000);
},{"react":5,"react-dom":6,"./index.scss":4}],28:[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '6278' + '/');
