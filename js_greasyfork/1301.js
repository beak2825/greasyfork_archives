...
// @downloadURL https://update.greasyfork.org/scripts/1301/Red%20Skin%20Images%20SLIM.user.js
// @updateURL https://update.greasyfork.org/scripts/1301/Red%20Skin%20Images%20SLIM.meta.js
// ==/UserScript==
...
{
if(images[cross].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/cross.png")
{
...
{
if(images[wo].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/whos_online.gif")
{
...
while(wo<images.length)
{
if(images[wo].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/birthday.gif")
{
...
while(wo<images.length)
{
if(images[wo].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/stats.gif")
{
...
{
if(images[pm].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/pm_new.gif")
{
...
while(pm<images.length)
{
if(images[pm].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/pm_old.gif")
{
...
while(pm<images.length)
{
if(images[pm].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/pm_forwarded.gif")
{
...
while(pm<images.length)
{
if(images[pm].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/pm_replied.gif")
{
...
{
if(images[co].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/collapse_thead.gif")
{
...
while(co<images.length)
{
if(images[co].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/collapse_thead_collapsed.gif")
{
...
while(co<images.length)
{
if(images[co].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/collapse_tcat.gif")
{
images[co].src = "http://www.zeldauniverse.net/forums/members/5354883-albums3659-picture32453.png";
}
co=co+1;
...
while(co<images.length)
{
if(images[co].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/collapse_tcat_collapsed.gif")
{
images[co].src = "http://www.zeldauniverse.net/forums/members/5354883-albums3659-picture32470.png";
}
co=co+1;
...
{
if(images[status].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/user_online.gif")
{
...
while(status<images.length)
{
if(images[status].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/user_offline.gif")
{
...
while(status<images.length)
{
if(images[status].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/user_invisible.gif")
{
...
{
if(images[quote].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/viewpost.gif")
{
...
{
if(images[subforum].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/subforum_new.gif")
{
...
while(subforum<images.length)
{
if(images[subforum].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/subforum_old.gif")
{
...
while(subforum<images.length)
{
if(images[subforum].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/subforum_old_lock.gif")
{
...
while(subforum<images.length)
{
if(images[subforum].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/subforum_new_lock.gif")
{
images[subforum].src = "http://www.zeldauniverse.net/forums/members/5354883-albums3821-picture34162.png";
}
subforum=subforum+1;
...
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/navbits_finallink_ltr.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/navbits_start.gif")
{
...
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/header.jpg")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/threadclosed.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/subscribe.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/sortdesc.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/sortasc.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/reputation.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/report.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/reply_small.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/reply.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/quote.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/post_thanks.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/multiquote_on.gif")
{
...
while(b<images.length)
{
if(images[b].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/multiquote_off.gif")
{
...
{
if(images[u].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/lastpost.gif")
{
...
while(u<images.length)
{
if(images[u].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/ip.gif")
{
...
while(u<images.length)
{
if(images[u].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/home.gif")
{
...
while(u<images.length)
{
if(images[u].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/forward.gif")
{
...
while(u<images.length)
{
if(images[u].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/firstnew.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/reply.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/edit.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_hot.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_dot.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_dot_hot.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_new.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_hot_new.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_dot_new.gif")
{
...
while(t<images.length)
{
if(images[t].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_dot_hot_new.gif")
{
...
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_lock.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_lock_new.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_dot_lock.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_dot_lock_new.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_hot_lock.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_dot_hot_lock.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_hot_lock_new.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_dot_hot_lock_new.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_moved.gif")
{
...
while(l<images.length)
{
if(images[l].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/thread_moved_new.gif")
{
images[l].src = "http://www.zeldauniverse.net/forums/members/5354883-albums3821-picture34209.png";
}
l=l+1;
...
{
if(images[f].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/forum_old_lock.gif")
{
...
while(f<images.length)
{
if(images[f].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/forum_old.gif")
{
...
while(f<images.length)
{
if(images[f].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/forum_new.gif")
{
...
while(f<images.length)
{
if(images[f].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/forum_new_lock.gif")
{
...
{
if(images[h].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/menu_open.gif")
{
...
while(h<images.length)
{
if(images[h].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/im_skype.gif")
{
...
while(h<images.length)
{
if(images[h].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/infraction.gif")
{
...
while(h<images.length)
{
if(images[h].src == "http://www.zeldauniverse.net/forums/images/zumain/buttons/quickreply.gif")
{
...
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/color.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/smilie.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/undo.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/redo.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/bold.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/italic.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/underline.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/justifyleft.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/justifycenter.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/justifyright.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/insertorderedlist.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/insertunorderedlist.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/outdent.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/indent.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/createlink.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/unlink.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/email.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/insertimage.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/quote.gif")
{
...
while(e<images.length)
{
if(images[e].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/separator.gif")
{
...
{
if(images[editor].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/cut.gif")
{
...
while(editor<images.length)
{
if(images[editor].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/copy.gif")
{
...
while(editor<images.length)
{
if(images[editor].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/paste.gif")
{
...
while(editor<images.length)
{
if(images[editor].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/switchmode.gif")
{
...
while(editor<images.length)
{
if(images[editor].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/removeformat.gif")
{
...
while(editor<images.length)
{
if(images[editor].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/code.gif")
{
...
while(editor<images.length)
{
if(images[editor].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/html.gif")
{
...
while(editor<images.length)
{
if(images[editor].src == "http://www.zeldauniverse.net/forums/images/zumain/editor/php.gif")
{
...
{
if(images[wegh].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/announcement_new.gif")
{
...
while(wegh<images.length)
{
if(images[wegh].src == "http://www.zeldauniverse.net/forums/images/zumain/statusicon/announcement_old.gif")
{
...
while(wegh<images.length)
{
if(images[wegh].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/poll_posticon.gif")
{
...
while(wegh<images.length)
{
if(images[wegh].src == "http://www.zeldauniverse.net/forums/images/zumain/misc/calendar.gif")
{
