...
//安全网址请填写在上方空白区域
// @downloadURL https://update.greasyfork.org/scripts/481080/%E7%83%9B%E9%80%9A%E5%8A%A9%E6%89%8B%E7%AE%80%E5%8C%96%E7%BE%8E%E5%8C%96%E7%89%88%F0%9F%8C%BC.user.js
// @updateURL https://update.greasyfork.org/scripts/481080/%E7%83%9B%E9%80%9A%E5%8A%A9%E6%89%8B%E7%AE%80%E5%8C%96%E7%BE%8E%E5%8C%96%E7%89%88%F0%9F%8C%BC.meta.js
// ==/UserScript==
(() => {
    ...
    <body>
        <div class="row" style="margin: 10px;">
            <div class="col-md-6 col-md-offset-3">
                <div class="header clearfix" style="background-color: #69FF43; border-radius:15px; color:#6200ed; padding:5px;">
                    <h3 class="text-muted" style="margin-top: 0;margin-bottom: 0;float: left; color:#6200ed;"style="margin-top: 20px;margin-bottom: 0;float: left;"><a href="https://scriptcat.org/script-show-page/336" target="view_window" style="color:#6200ed;">烛通Pro Max v1.0&ensp;</a></h3><div id="onlineNum"></div>
                </div>
                <hr style="margin-top: 10px;margin-bottom: 20px;">
                <div class="panel panel-info" id="normalQuery">
                    <div class="panel-heading" style="background-color: #6200ed; color:#fff;">任务配置</div>
                    <div class="panel-body">
                        <div>
                            ...
                            <div  style=" margin-top: 10px;">
                                ...
                                <div class="panel-body">
                                    <h1 style="background-color: #69FF43; border-radius:15px; color:#6200ed; padding:15px;">知止而后定<br>——INJU银烛</h1>
                ...
                <div class="panel panel-info">
                    <div class="panel-heading" style="background-color: #6200ed; color:#fff;">任务列表</div>
                    <div class="panel-body" id='joblist'>
                    </div>
                </div>
                <div class="panel panel-info">
                    <div class="panel-heading" style="background-color: #6200ed; color:#fff;">运行日志</div>
                    <div class="panel-body">
                        <div id="result" style="overflow:auto;line-height: 30px;border-color:#000;">
                            <div id="log">
                ...
                <div class="panel panel-info" id='workPanel' style="display: none;height: 1000px;">
                    <div class="panel-heading" style="background-color: #6200ed; color:#fff;">章节测试</div>
