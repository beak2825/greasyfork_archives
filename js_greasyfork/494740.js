// ==UserScript==
// @name         dogefree.in [2023] - Auto Roll - New Bonuses - Multiply - Lottery - Status Console
...
// @note         Or send some satoshi at this address 1JaaggQgh692AYPGR1gtuexnn1CH5zTKtF
...
// @downloadURL https://update.greasyfork.org/scripts/494740/dogefreein%20%5B2023%5D%20-%20Auto%20Roll%20-%20New%20Bonuses%20-%20Multiply%20-%20Lottery%20-%20Status%20Console.user.js
// @updateURL https://update.greasyfork.org/scripts/494740/dogefreein%20%5B2023%5D%20-%20Auto%20Roll%20-%20New%20Bonuses%20-%20Multiply%20-%20Lottery%20-%20Status%20Console.meta.js
// ==/UserScript==
...
var MAX_ROLLS_AT_MULTIPLY = 8000; //how many rolls in multiply. It will safely play till it win or reach maxbet.
var MAX_PLAY = 40000; // How many time maximum will play martingale. How much time BASE_BET is played.
var MAX_WIN = 0.0000100000; // Target Win, Stop to play multiply when those sats won.
var MAX_BET = 0.0000400960; // MAX BET reached, STOP condition

// Bet Amounts Vars.
var MIN_BET = 0.00008; // STUFF BET to play till don't lose LOSSES_BEFORE_PLAY times; Just work in MODE = manual.
var BAS_BET = 0.00008; // BASE BET when begin the PLAY
