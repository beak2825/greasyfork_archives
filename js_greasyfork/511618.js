// ==UserScript==
// @name         IdlePixel+ Teams QoL modified by rng
...
// @downloadURL https://update.greasyfork.org/scripts/511618/IdlePixel%2B%20Teams%20QoL%20modified%20by%20rng.user.js
// @updateURL https://update.greasyfork.org/scripts/511618/IdlePixel%2B%20Teams%20QoL%20modified%20by%20rng.meta.js
// ==/UserScript==
        ...
        constructor() {
            ...
            this.settings = {
                ...
                quick_deposit_ores: {
                    ...
                    'xp_geode': true,'stone_geode': true,'grey_geode': true,'blue_geode': true,'green_geode': true,
                    'red_geode': true,'cyan_geode': true,'ancient_geode': true,
                ...
                quick_deposit_seeds: {
                    ...
                    'potato_seeds': true,'carrot_seeds': true,'beet_seeds': true,'broccoli_seeds': true,
                    'poppy_flower_seeds': true, 'rose_flower_seeds': true, 'tulip_flower_seeds': true,
                ...
                quick_deposit_brewing_ingredients: {
                    ...
                    'cooks_dust': true,'fighting_dust': true,'tree_dust': true,'farm_dust': true,
                    'strange_leaf': true, 'stranger_leaf': true, 'strangest_leaf': true
                },
                quick_deposit_logs: {
                    'flexible_logs': true, 'logs': true, 'oak_logs': true, 'willow_logs': true, 'maple_logs': true,
                ...
                quick_deposit_raw: {
                    ...
                    'raw_shrimp_shiny': true, 'raw_anchovy_shiny': true, 'raw_sardine_shiny': true, 'raw_crab_shiny': true,
                    'raw_piranha_shiny': true, 'raw_salmon_shiny': true, 'raw_trout_shiny': true, 'raw_pike_shiny': true,
                    'raw_eel_shiny': true, 'raw_rainbow_fish_shiny': true, 'raw_tuna_shiny': true, 'raw_swordfish_shiny': true,
                    'raw_manta_ray_shiny': true, 'raw_shark_shiny': true, 'raw_whale_shiny': true,
                ...
                quick_deposit_invention: {
					'evil_blood': true, 'cleansed_blood': false, 'blood_chicken_foot': true, 'blood_rat_tail': true,
					'blood_spider_legs': true, 'blood_bee_wings': true, 'blood_lizard_head': true, 'blood_snake_head': true,
                    'blood_ant_remains': true, 'blood_wolf_paw': true, 'blood_logs': true, 'blood_thief_skull':	true,
                    'blood_bat_wing': true, 'blood_goblin_fingers': true, 'blood_bear_paw': true,
					'blood_skeleton_ribcage': true, 'blood_fire_snake_tongue': true, 'blood_fire_hawk_wing': true,
					'blood_fire_golem_head': true, 'blood_fire_witch_web': true, 'stinger_pieces': true, 'stinger_handle': true,
                    'stinger_edge': true, 'dagger_pieces': true, 'dagger_handle': true, 'dagger_blade':	true,
                    'skeleton_sword_pieces': true, 'skeleton_sword_handle': true, 'skeleton_sword_blade': true,
					'bone_amulet_pieces': true, 'bone_amulet_ashes_medalion': true, 'bone_amulet_ice_medalion': true,
					'bone_amulet_blood_medalion': true, 'scythe_pieces': true, 'scythe_blade': true, 'trident_head': true,
				},
                quick_deposit_combat: {
                    "fighting_dust_potion": false, "feathers": true, "fire_feathers": true, "ice_feathers": true, "ancient_feathers": true,
                    "string": true, "poison": true, "ant_needles": true, "puffer_needles": true, "shark_tooth": true,
                    "molten_glass": true, "dense_molten_glass": true, "sea_molten_glass": true, "lantern": true, "sea_helmet": false,
                    ...
                    "gold_rapier": false, "poison_rapier": false, "poison_gold_rapier": false, "skeleton_shield": true, "stinger_dagger": true, "long_spear": true,
                    ...
                    "reaper_hood": true,"reaper_body": true,"reaper_skirt": true,"reaper_gloves": true,"reaper_boots": true,
                    "reaper_super_hood": true,"reaper_super_body": true,"reaper_super_skirt": true,"reaper_super_gloves": true,"reaper_super_boots": true,
                    "ghost_essence": true,"combat_xp_lamp": true,"tainted_coins": true,
            ...
            this.quickDepositIcons = {
                ...
                quick_deposit_invention: "https://cdn.idle-pixel.com/images/invention.png",
            ...
            this.storable_items = {'coins': 'Special', 'stardust': 'Special', 'fight_points': 'Special', 'energy': 'Special', 'criptoe': 'Special', 'donor_coins': 'Special', 'treasure_chest': 'Special', 'green_treasure_chest': 'Special', 'red_treasure_chest': 'Special', 'blue_pickaxe_orb': 'Special', 'blue_hammer_orb': 'Special', 'blue_woodcutting_orb': 'Special', 'blue_oil_storage_orb': 'Special', 'blue_oil_well_orb': 'Special', 'blue_farming_orb': 'Special', 'blue_breeding_anti_sickness_orb': 'Special', 'green_arrow_orb': 'Special', 'green_boat_orb': 'Special', 'green_bone_orb': 'Special', 'green_charcoal_orb': 'Special', 'green_log_orb': 'Special', 'red_farming_orb': 'Special', 'red_woodcutting_orb': 'Special', 'red_combat_orb': 'Special', 'red_oil_factory_orb': 'Special', 'red_stardust_watch_orb': 'Special', 'rocket_fuel': 'Mining', 'stone': 'Mining', 'copper': 'Mining', 'iron': 'Mining', 'silver': 'Mining', 'gold': 'Mining', 'promethium': 'Mining', 'titanium': 'Mining', 'ancient_ore': 'Mining', 'dragon_ore': 'Mining', 'moonstone': 'Mining', 'grey_geode': 'Mining', 'blue_geode': 'Mining', 'green_geode': 'Mining', 'red_geode': 'Mining', 'cyan_geode': 'Mining', 'ancient_geode': 'Mining', 'blue_marble_mineral': 'Mining', 'amethyst_mineral': 'Mining', 'sea_crystal_mineral': 'Mining', 'dense_marble_mineral': 'Mining', 'fluorite_mineral': 'Mining', 'clear_marble_mineral': 'Mining', 'jade_mineral': 'Mining', 'lime_quartz_mineral': 'Mining', 'opal_mineral': 'Mining', 'purple_quartz_mineral': 'Mining', 'amber_mineral': 'Mining', 'smooth_pearl_mineral': 'Mining', 'sulfer_mineral': 'Mining', 'topaz_mineral': 'Mining', 'tanzanite_mineral': 'Mining', 'magnesium_mineral': 'Mining', 'frozen_mineral': 'Mining', 'blood_crystal_mineral': 'Mining', 'sapphire': 'Mining', 'emerald': 'Mining', 'ruby': 'Mining', 'diamond': 'Mining', 'blood_diamond': 'Mining', 'gathering_sapphire_fragments': 'Mining', 'gathering_emerald_fragments': 'Mining', 'gathering_ruby_fragments': 'Mining', 'gathering_diamond_fragments': 'Mining', 'bronze_bar': 'Crafting', 'iron_bar': 'Crafting', 'silver_bar': 'Crafting', 'gold_bar': 'Crafting', 'promethium_bar': 'Crafting', 'titanium_bar': 'Crafting', 'ancient_bar': 'Crafting', 'dragon_bar': 'Crafting', 'charcoal': 'Crafting', 'iron_bucket': 'Crafting', 'lava': 'Crafting', 'plasma': 'Crafting', 'ancient_broken_key': 'Crafting', 'junk': 'Gathering', 'gathering_loot_bag_mines': 'Gathering', 'gathering_loot_bag_fields': 'Gathering', 'gathering_loot_bag_forest': 'Gathering', 'gathering_loot_bag_fishing_pond': 'Gathering', 'gathering_loot_bag_gem_mine': 'Gathering', 'gathering_loot_bag_kitchen': 'Gathering', 'gathering_loot_bag_castle': 'Gathering', 'bonemeal': 'Farming', 'bones': 'Farming', 'big_bones': 'Farming', 'ashes': 'Farming', 'ice_bones': 'Farming', 'blood_bones': 'Farming', 'dotted_green_leaf_seeds': 'Farming', 'green_leaf_seeds': 'Farming', 'lime_leaf_seeds': 'Farming', 'gold_leaf_seeds': 'Farming', 'crystal_leaf_seeds': 'Farming', 'red_mushroom_seeds': 'Farming', 'stardust_seeds': 'Farming', 'mega_dotted_green_leaf_seeds': 'Farming', 'mega_green_leaf_seeds': 'Farming', 'mega_lime_leaf_seeds': 'Farming', 'mega_gold_leaf_seeds': 'Farming', 'mega_crystal_leaf_seeds': 'Farming', 'mega_red_mushroom_seeds': 'Farming', 'tree_seeds': 'Farming', 'oak_tree_seeds': 'Farming', 'willow_tree_seeds': 'Farming', 'apple_tree_seeds': 'Farming', 'maple_tree_seeds': 'Farming', 'banana_tree_seeds': 'Farming', 'stardust_tree_seeds': 'Farming', 'orange_tree_seeds': 'Farming', 'pine_tree_seeds': 'Farming', 'redwood_tree_seeds': 'Farming', 'palm_tree_seeds': 'Farming', 'dragon_fruit_tree_seeds': 'Farming', 'bone_tree_seeds': 'Farming', 'lava_tree_seeds': 'Farming', 'strange_tree_seeds': 'Farming', 'potato_seeds': 'Farming', 'carrot_seeds': 'Farming', 'beet_seeds': 'Farming', 'broccoli_seeds': 'Farming', 'poppy_flower_seeds': 'Farming', 'rose_flower_seeds': 'Farming', 'tulip_flower_seeds': 'Farming', 'dotted_green_leaf': 'Brewing', 'green_leaf': 'Brewing', 'lime_leaf': 'Brewing', 'gold_leaf': 'Brewing', 'crystal_leaf': 'Brewing', 'red_mushroom': 'Brewing', 'strange_leaf': 'Brewing', 'stranger_leaf': 'Brewing', 'strangest_leaf': 'Brewing', 'shooting_star': 'Brewing', 'blue_shooting_star': 'Brewing', 'green_shooting_star': 'Brewing', 'red_shooting_star': 'Brewing', 'seaweed': 'Brewing', 'cooks_dust': 'Brewing', 'fighting_dust': 'Brewing', 'tree_dust': 'Brewing', 'farm_dust': 'Brewing', 'flexible_logs': 'Woodcutting', 'logs': 'Woodcutting', 'oak_logs': 'Woodcutting', 'willow_logs': 'Woodcutting', 'maple_logs': 'Woodcutting', 'stardust_logs': 'Woodcutting', 'pine_logs': 'Woodcutting', 'redwood_logs': 'Woodcutting', 'dense_logs': 'Woodcutting', 'raw_chicken': 'Raw', 'raw_bird_meat': 'Raw', 'raw_meat': 'Raw', 'raw_shrimp': 'Raw', 'raw_shrimp_shiny': 'Raw', 'raw_anchovy': 'Raw', 'raw_anchovy_shiny': 'Raw', 'raw_sardine': 'Raw', 'raw_sardine_shiny': 'Raw', 'raw_crab': 'Raw', 'raw_crab_shiny': 'Raw', 'raw_piranha': 'Raw', 'raw_piranha_shiny': 'Raw', 'raw_salmon': 'Raw', 'raw_salmon_shiny': 'Raw', 'raw_trout': 'Raw', 'raw_trout_shiny': 'Raw', 'raw_pike': 'Raw', 'raw_pike_shiny': 'Raw', 'raw_eel': 'Raw', 'raw_eel_shiny': 'Raw', 'raw_rainbow_fish': 'Raw', 'raw_rainbow_fish_shiny': 'Raw', 'raw_tuna': 'Raw', 'raw_tuna_shiny': 'Raw', 'raw_swordfish': 'Raw', 'raw_swordfish_shiny': 'Raw', 'raw_manta_ray': 'Raw', 'raw_manta_ray_shiny': 'Raw', 'raw_shark': 'Raw', 'raw_shark_shiny': 'Raw', 'raw_whale': 'Raw', 'raw_whale_shiny': 'Raw', 'raw_small_stardust_fish': 'Raw', 'raw_medium_stardust_fish': 'Raw', 'raw_large_stardust_fish': 'Raw', 'raw_angler_fish': 'Raw', 'heat': 'Food', 'cooked_shrimp': 'Food', 'cooked_anchovy': 'Food', 'cooked_sardine': 'Food', 'cooked_crab': 'Food', 'cooked_piranha': 'Food', 'cooked_salmon': 'Food', 'cooked_trout': 'Food', 'cooked_pike': 'Food', 'cooked_eel': 'Food', 'cooked_rainbow_fish': 'Food', 'cooked_tuna': 'Food', 'cooked_swordfish': 'Food', 'cooked_manta_ray': 'Food', 'cooked_shark': 'Food', 'cooked_whale': 'Food', 'cooked_small_stardust_fish': 'Food', 'cooked_medium_stardust_fish': 'Food', 'cooked_large_stardust_fish': 'Food', 'cooked_angler_fish': 'Food', 'cooked_chicken': 'Food', 'cooked_bird_meat': 'Food', 'cooked_meat': 'Food', 'honey': 'Food', 'cheese': 'Food', 'apple': 'Food', 'maple_syrup': 'Food', 'banana': 'Food', 'orange': 'Food', 'maggots': 'Food', 'potato': 'Food', 'carrot': 'Food', 'beet': 'Food', 'broccoli': 'Food', 'coconut': 'Food', 'dragon_fruit': 'Food', 'egg': 'Food', 'flour': 'Food', 'chocolate': 'Food', 'dotted_salad': 'Food', 'chocolate_cake': 'Food', 'lime_leaf_salad': 'Food', 'golden_apple': 'Food', 'banana_jello': 'Food', 'orange_pie': 'Food', 'pancakes': 'Food', 'coconut_stew': 'Food', 'dragon_fruit_salad': 'Food', 'potato_shake': 'Food', 'carrot_shake': 'Food', 'beet_shake': 'Food', 'broccoli_shake': 'Food', 'bait': 'Bait', 'super_bait': 'Bait', 'mega_bait': 'Bait', 'string': 'Drops', 'poison': 'Drops', 'ant_needles': 'Drops', 'puffer_needles': 'Drops', 'shark_tooth': 'Drops', 'molten_glass': 'Drops', 'dense_molten_glass': 'Drops', 'sea_molten_glass': 'Drops', 'lizard_skin': 'Drops', 'bat_skin': 'Drops', 'bear_fur': 'Drops', 'reaper_silk': 'Drops', 'crocodile_hide': 'Drops', 'frozen_crocodile_hide': 'Drops', 'green_gaurdian_key': 'Drops', 'blue_gaurdian_key': 'Drops', 'purple_gaurdian_key': 'Drops', 'mixed_gaurdian_key': 'Drops', 'feathers': 'Combat', 'fire_feathers': 'Combat', 'ice_feathers': 'Combat', 'ancient_feathers': 'Combat', 'wooden_arrows': 'Combat', 'fire_arrows': 'Combat', 'ice_arrows': 'Combat', 'ancient_arrows': 'Combat', 'stinger': 'Combat', 'poison_stinger': 'Combat', 'iron_dagger': 'Combat', 'skeleton_sword': 'Combat', 'club': 'Combat', 'spiked_club': 'Combat', 'dense_club': 'Combat', 'spiked_dense_club': 'Combat', 'scythe': 'Combat', 'double_scythe': 'Combat', 'rapier': 'Combat', 'gold_rapier': 'Combat', 'poison_rapier': 'Combat', 'poison_gold_rapier': 'Combat', 'stinger_dagger': 'Combat', 'poison_stinger_dagger': 'Combat', 'skeleton_defender': 'Combat', 'battle_axe': 'Combat', 'long_spear': 'Combat', 'trident': 'Combat', 'long_trident': 'Combat', 'long_bow': 'Combat', 'toy_slingshot': 'Combat', 'haunted_bow': 'Combat', 'balista': 'Combat', 'skeleton_shield': 'Combat', 'lantern': 'Combat', 'undead_staff': 'Combat', 'undead_hp_staff': 'Combat', 'undead_mana_staff': 'Combat', 'undead_defence_staff': 'Combat', 'undead_full_staff': 'Combat', 'evil_blood': 'Invention', 'cleansed_blood': 'Invention', 'blood_chicken_foot': 'Invention', 'blood_rat_tail': 'Invention', 'blood_spider_legs': 'Invention', 'blood_bee_wings': 'Invention', 'blood_lizard_head': 'Invention', 'blood_snake_head': 'Invention', 'blood_ant_remains': 'Invention', 'blood_wolf_paw': 'Invention', 'blood_logs': 'Invention', 'blood_thief_skull': 'Invention', 'blood_bat_wing': 'Invention', 'blood_goblin_fingers': 'Invention', 'blood_bear_paw': 'Invention', 'blood_skeleton_ribcage': 'Invention', 'blood_fire_snake_tongue': 'Invention', 'blood_fire_hawk_wing': 'Invention', 'blood_fire_golem_head': 'Invention', 'blood_fire_witch_web': 'Invention', 'stinger_pieces': 'Invention', 'stinger_handle': 'Invention', 'stinger_edge': 'Invention', 'dagger_pieces': 'Invention', 'dagger_handle': 'Invention', 'dagger_blade': 'Invention', 'skeleton_sword_pieces': 'Invention', 'skeleton_sword_handle': 'Invention', 'skeleton_sword_blade': 'Invention', 'bone_amulet_pieces': 'Invention', 'bone_amulet_ashes_medalion': 'Invention', 'bone_amulet_ice_medalion': 'Invention', 'bone_amulet_blood_medalion': 'Invention', 'scythe_pieces': 'Invention', 'scythe_blade': 'Invention', 'trident_head': 'Invention', 'lizard_mask': 'Armour', 'lizard_body': 'Armour', 'lizard_legs': 'Armour', 'lizard_gloves': 'Armour', 'lizard_boots': 'Armour', 'bat_mask': 'Armour', 'bat_body': 'Armour', 'bat_legs': 'Armour', 'bat_gloves': 'Armour', 'bat_boots': 'Armour', 'bear_mask': 'Armour', 'bear_body': 'Armour', 'bear_legs': 'Armour', 'bear_gloves': 'Armour', 'bear_boots': 'Armour', 'moonstone_mask': 'Armour', 'moonstone_body': 'Armour', 'moonstone_legs': 'Armour', 'moonstone_gloves': 'Armour', 'moonstone_boots': 'Armour', 'crocodile_mask': 'Armour', 'crocodile_body': 'Armour', 'crocodile_legs': 'Armour', 'crocodile_gloves': 'Armour', 'crocodile_boots': 'Armour', 'frozen_crocodile_mask': 'Armour', 'frozen_crocodile_body': 'Armour', 'frozen_crocodile_legs': 'Armour', 'frozen_crocodile_gloves': 'Armour', 'frozen_crocodile_boots': 'Armour', 'dragon_helmet': 'Armour', 'dragon_body': 'Armour', 'dragon_legs': 'Armour', 'dragon_gloves': 'Armour', 'dragon_boots': 'Armour', 'sea_helmet': 'Armour', 'flippers': 'Armour', 'bone_amulet': 'Armour', 'ashes_amulet': 'Armour', 'ice_amulet': 'Armour', 'blood_amulet': 'Armour', 'amulet_of_healing_rain': 'Armour', 'reaper_hood': 'Armour', 'reaper_skirt': 'Armour', 'reaper_gloves': 'Armour', 'reaper_boots': 'Armour', 'reaper_body': 'Armour', 'reaper_super_hood': 'Armour', 'reaper_super_skirt': 'Armour', 'reaper_super_gloves': 'Armour', 'reaper_super_boots': 'Armour', 'reaper_super_body': 'Armour', 'stardust_potion': 'Potions', 'energy_potion': 'Potions', 'anti_disease_potion': 'Potions', 'tree_speed_potion': 'Potions', 'smelting_upgrade_potion': 'Potions', 'great_stardust_potion': 'Potions', 'farming_speed_potion': 'Potions', 'rare_monster_potion': 'Potions', 'super_stardust_potion': 'Potions', 'gathering_unique_potion': 'Potions', 'heat_potion': 'Potions', 'bait_potion': 'Potions', 'bone_potion': 'Potions', 'furnace_speed_potion': 'Potions', 'promethium_potion': 'Potions', 'super_rare_monster_potion': 'Potions', 'ultra_stardust_potion': 'Potions', 'cooks_dust_potion': 'Potions', 'fighting_dust_potion': 'Potions', 'tree_dust_potion': 'Potions', 'farm_dust_potion': 'Potions', 'magic_shiny_crystal_ball_potion': 'Potions', 'birdhouse_potion': 'Potions', 'rocket_potion': 'Potions', 'titanium_potion': 'Potions', 'raids_hp_potion': 'Potions', 'blue_orb_potion': 'Potions', 'geode_potion': 'Potions', 'magic_crystal_ball_potion': 'Potions', 'stone_converter_potion': 'Potions', 'rain_potion': 'Potions', 'combat_loot_potion': 'Potions', 'raids_mana_potion': 'Potions', 'gathering_worker_potion': 'Potions', 'rotten_potion': 'Potions', 'merchant_speed_potion': 'Potions', 'ancient_potion': 'Potions', 'green_orb_potion': 'Potions', 'raids_crits_potion': 'Potions', 'guardian_key_potion': 'Potions', 'red_orb_potion': 'Potions'};
            this.storage_sections = ['Special', 'Mining', 'Crafting', 'Gathering', 'Farming', 'Brewing', 'Woodcutting', 'Raw', 'Food', 'Bait', 'Drops', 'Combat', 'Invention', 'Armour', 'Potions', 'Uncategorized'];
            this.initCustomCSS();
        }
