...
// @version      1.0
// @description  Créer un trajet n'a jamais été aussi facile.
// @author       Drigtime pour la création de Owl & modifié par Vok pour OnlyBot
...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/520339/Owl%20OnlyBot.user.js
// @updateURL https://update.greasyfork.org/scripts/520339/Owl%20OnlyBot.meta.js
// ==/UserScript==
...
(function () {
    ...
    var ressourcesFr=[
    {itemId:10,itemName:"Ortie"},
    {itemId:11,itemName:"Sauge"},
    {itemId:12,itemName:"Trèfle à 5 feuilles"},
    {itemId:13,itemName:"Menthe Sauvage"},
    {itemId:14,itemName:"Orchidée Freyesque"},
    {itemId:15,itemName:"Edelweiss"},
    {itemId:16,itemName:"Graine de Pandouille"},
    {itemId:17,itemName:"Ginseng"},
    {itemId:18,itemName:"Belladone"},
    {itemId:19,itemName:"Mandragore"},
    {itemId:20,itemName:"Perce-Neige"},
    {itemId:21,itemName:"Salikrone"},
    {itemId:22,itemName:"Tulipe en Papier"},
    {itemId:25,itemName:"Goujon"},
    {itemId:26,itemName:"Greuvette"},
    {itemId:27,itemName:"Truite"},
    {itemId:28,itemName:"Crabe Sourimi"},
    {itemId:29,itemName:"Poisson-Chaton"},
    {itemId:30,itemName:"Poisson Pané"},
    {itemId:31,itemName:"Carpe Iem"},
    {itemId:32,itemName:"Sardine Brillante"},
    {itemId:33,itemName:"Brochet"},
    {itemId:34,itemName:"Kralamoure"},
    {itemId:35,itemName:"Anguille"},
    {itemId:36,itemName:"Dorade Grise"},
    {itemId:37,itemName:"Perche"},
    {itemId:38,itemName:"Raie Bleu"},
    {itemId:39,itemName:"Lotte"},
    {itemId:40,itemName:"Requin Marteau-Faucille"},
    {itemId:41,itemName:"Bar Rikain"},
    {itemId:42,itemName:"Morue"},
    {itemId:43,itemName:"Tanche"},
    {itemId:44,itemName:"Espadon"},
    {itemId:45,itemName:"Poisskaille"},
    {itemId:46,itemName:"Patelle"},
    {itemId:47,itemName:"Pichon Encre"},
    {itemId:51,itemName:"Fer"},
    {itemId:52,itemName:"Cuivre"},
    {itemId:53,itemName:"Bronze"},
    {itemId:54,itemName:"Kobalte"},
    {itemId:55,itemName:"Etain"},
    {itemId:56,itemName:"Manganese"},
    {itemId:57,itemName:"Bauxite"},
    {itemId:58,itemName:"Silicate"},
    {itemId:59,itemName:"Argent"},
    {itemId:60,itemName:"Or"},
    {itemId:61,itemName:"Dolomite"},
    {itemId:62,itemName:"Obsidienne"},
    {itemId:63,itemName:"Ecume de mer"},
    {itemId:64,itemName:"Cendrepierre"},
    {itemId:65,itemName:"Cristal liquide"},
    {itemId:66,itemName:"Cristal pliable"},
    {itemId:70,itemName:"Bois de Frêne"},
    {itemId:71,itemName:"Bois de Châtaignier"},
    {itemId:72,itemName:"Bois de Noyer"},
    {itemId:73,itemName:"Bois de Chêne"},
    {itemId:74,itemName:"Bois de Bombu"},
    {itemId:75,itemName:"Bois Erable"},
    {itemId:76,itemName:"Bois Oliviolet"},
    {itemId:77,itemName:"Bois de Pin"},
    {itemId:78,itemName:"Bois If"},
    {itemId:79,itemName:"Bois de Bambou"},
    {itemId:80,itemName:"Bois de Merisier"},
    {itemId:81,itemName:"Bois de Noisetier"},
    {itemId:82,itemName:"Bois Ebène"},
    {itemId:83,itemName:"Bois de Kaliptus"},
    {itemId:84,itemName:"Bois de Charme"},
    {itemId:85,itemName:"Bois de Bambou Sombre"},
    {itemId:86,itemName:"Bois Orme"},
    {itemId:87,itemName:"Bois de Bambou Sacré"},
    {itemId:88,itemName:"Bois de Tremble"},
    {itemId:89,itemName:"Bois Aquajou"},
    {itemId:90,itemName:"Blé"},
    {itemId:91,itemName:"Orge"},
    {itemId:92,itemName:"Avoine"},
    {itemId:93,itemName:"Houblon"},
    {itemId:94,itemName:"Lin"},
    {itemId:95,itemName:"Seigle"},
    {itemId:96,itemName:"Riz"},
    {itemId:97,itemName:"Malt"},
    {itemId:98,itemName:"Chanvre"},
    {itemId:99,itemName:"Maïs"},
    {itemId:100,itemName:"Millet"},
    {itemId:101,itemName:"Frostiz"},
    {itemId:102,itemName:"Quisnoa"},
    {itemId:110,itemName:"Eau"}
];

var ressourcesEn=[
    {itemId:10,itemName:"Nettle"},
    {itemId:11,itemName:"Sage"},
    {itemId:12,itemName:"Five-Leaf Clover"},
    {itemId:13,itemName:"Wild Mint"},
    {itemId:14,itemName:"Freyesque Orchid"},
    {itemId:15,itemName:"Edelweiss"},
    {itemId:16,itemName:"Pandkin"},
    {itemId:17,itemName:"Ginseng"},
    {itemId:18,itemName:"Belladonna"},
    {itemId:19,itemName:"Mandrake"},
    {itemId:20,itemName:"Snowdrop"},
    {itemId:21,itemName:"Salikrone"},
    {itemId:22,itemName:"Paper Tulip"},
    {itemId:25,itemName:"Gudgeon"},
    {itemId:26,itemName:"Greuvette"},
    {itemId:27,itemName:"Trout"},
    {itemId:28,itemName:"Crab Sourimi"},
    {itemId:29,itemName:"Kittenfish"},
    {itemId:30,itemName:"Breaded Fish"},
    {itemId:31,itemName:"Ediem Carp"},
    {itemId:32,itemName:"Shiny Sardine"},
    {itemId:33,itemName:"Pike"},
    {itemId:34,itemName:"Kralove"},
    {itemId:35,itemName:"Eel"},
    {itemId:36,itemName:"Grey Sea Bream"},
    {itemId:37,itemName:"Perch"},
    {itemId:38,itemName:"Ray"},
    {itemId:39,itemName:"Monkfish"},
    {itemId:40,itemName:"Sickle-Hammerhead Shark"},
    {itemId:41,itemName:"Lard Bass"},
    {itemId:42,itemName:"Cod"},
    {itemId:43,itemName:"Tench"},
    {itemId:44,itemName:"Swordfish"},
    {itemId:45,itemName:"Icefish"},
    {itemId:46,itemName:"Limpet"},
    {itemId:47,itemName:"Inkfish"},
    {itemId:51,itemName:"Iron"},
    {itemId:52,itemName:"Copper"},
    {itemId:53,itemName:"Bronze"},
    {itemId:54,itemName:"Cobalt"},
    {itemId:55,itemName:"Tin"},
    {itemId:56,itemName:"Manganese"},
    {itemId:57,itemName:"Bauxite"},
    {itemId:58,itemName:"Silicate"},
    {itemId:59,itemName:"Silver"},
    {itemId:60,itemName:"Gold"},
    {itemId:61,itemName:"Dolomite"},
    {itemId:62,itemName:"Obsidian"},
    {itemId:63,itemName:"Sea Foam"},
    {itemId:64,itemName:"Ashstone"},
    {itemId:65,itemName:"Liquid Crystal"},
    {itemId:66,itemName:"Flexible Crystal"},
    {itemId:70,itemName:"Ash Wood"},
    {itemId:71,itemName:"Chestnut Wood"},
    {itemId:72,itemName:"Walnut Wood"},
    {itemId:73,itemName:"Oak Wood"},
    {itemId:74,itemName:"Bombu Wood"},
    {itemId:75,itemName:"Maple Wood"},
    {itemId:76,itemName:"Oliviolet Wood"},
    {itemId:77,itemName:"Pine Wood"},
    {itemId:78,itemName:"Yew Wood"},
    {itemId:79,itemName:"Bamboo Wood"},
    {itemId:80,itemName:"Cherry Wood"},
    {itemId:81,itemName:"Hazel Wood"},
    {itemId:82,itemName:"Ebony Wood"},
    {itemId:83,itemName:"Kaliptus Wood"},
    {itemId:84,itemName:"Hornbeam Wood"},
    {itemId:85,itemName:"Dark Bamboo Wood"},
    {itemId:86,itemName:"Elm Wood"},
    {itemId:87,itemName:"Holy Bamboo Wood"},
    {itemId:88,itemName:"Aspen Wood"},
    {itemId:89,itemName:"Aquajou Wood"},
    {itemId:90,itemName:"Wheat"},
    {itemId:91,itemName:"Barley"},
    {itemId:92,itemName:"Oats"},
    {itemId:93,itemName:"Hop"},
    {itemId:94,itemName:"Flax"},
    {itemId:95,itemName:"Rye"},
    {itemId:96,itemName:"Rice"},
    {itemId:97,itemName:"Malt"},
    {itemId:98,itemName:"Hemp"},
    {itemId:99,itemName:"Corn"},
    {itemId:100,itemName:"Millet"},
    {itemId:101,itemName:"Frostiz"},
    {itemId:102,itemName:"Quisnoa"},
    {itemId:110,itemName:"Water"}
];

var ressourcesEs=[
    {itemId:10,itemName:"Ortiga"},
    {itemId:11,itemName:"Salvia"},
    {itemId:12,itemName:"Trébol de 5 hojas"},
    {itemId:13,itemName:"Menta salvaje"},
    {itemId:14,itemName:"Orquídea freyesca"},
    {itemId:15,itemName:"Edelweiss"},
    {itemId:16,itemName:"Pandoja"},
    {itemId:17,itemName:"Ginseng"},
    {itemId:18,itemName:"Belladona"},
    {itemId:19,itemName:"Mandrágora"},
    {itemId:20,itemName:"Campanilla de invierno"},
    {itemId:21,itemName:"Salikrone"},
    {itemId:22,itemName:"Tulipán de papel"},
    {itemId:25,itemName:"Gobio"},
    {itemId:26,itemName:"Greuvette"},
    {itemId:27,itemName:"Trucha"},
    {itemId:28,itemName:"Cangrejo surimi"},
    {itemId:29,itemName:"Pez gatito"},
    {itemId:30,itemName:"Pescado empanado"},
    {itemId:31,itemName:"Carpa de Iem"},
    {itemId:32,itemName:"Sardina brillante"},
    {itemId:33,itemName:"Lucio"},
    {itemId:34,itemName:"Kralamar"},
    {itemId:35,itemName:"Anguila"},
    {itemId:36,itemName:"Dorada exploradora"},
    {itemId:37,itemName:"Perca"},
    {itemId:38,itemName:"Raya azul"},
    {itemId:39,itemName:"Rape"},
    {itemId:40,itemName:"Tiburón Martillo-Hoz"},
    {itemId:41,itemName:"Lubina mericana"},
    {itemId:42,itemName:"Bacaladilla"},
    {itemId:43,itemName:"Tenca"},
    {itemId:44,itemName:"Pez espada"},
    {itemId:45,itemName:"Inverluza"},
    {itemId:46,itemName:"Lapa"},
    {itemId:47,itemName:"Pichón Tinta"},
    {itemId:51,itemName:"Hierro"},
    {itemId:52,itemName:"Cobre"},
    {itemId:53,itemName:"Bronce"},
    {itemId:54,itemName:"Kobalto"},
    {itemId:55,itemName:"Estaño"},
    {itemId:56,itemName:"Manganeso"},
    {itemId:57,itemName:"Bauxita"},
    {itemId:58,itemName:"Silicato"},
    {itemId:59,itemName:"Plata"},
    {itemId:60,itemName:"Oro"},
    {itemId:61,itemName:"Dolomita"},
    {itemId:62,itemName:"Obsidiana"},
    {itemId:63,itemName:"Espuma de mar"},
    {itemId:64,itemName:"Cenizapiedra"},
    {itemId:65,itemName:"Cristal líquido"},
    {itemId:66,itemName:"Cristal flexible"},
    {itemId:70,itemName:"Madera de fresno"},
    {itemId:71,itemName:"Madera de castaño"},
    {itemId:72,itemName:"Madera de nogal"},
    {itemId:73,itemName:"Madera de roble"},
    {itemId:74,itemName:"Madera de bombú"},
    {itemId:75,itemName:"Madera de arce"},
    {itemId:76,itemName:"Madera de olivioleta"},
    {itemId:77,itemName:"Madera de pino"},
    {itemId:78,itemName:"Madera de tejo"},
    {itemId:79,itemName:"Madera de bambú"},
    {itemId:80,itemName:"Madera de cerezo"},
    {itemId:81,itemName:"Madera de avellano"},
    {itemId:82,itemName:"Madera de ébano"},
    {itemId:83,itemName:"Madera de kalipto"},
    {itemId:84,itemName:"Madera de carpe"},
    {itemId:85,itemName:"Madera de bambú oscuro"},
    {itemId:86,itemName:"Madera de olmo"},
    {itemId:87,itemName:"Madera de bambú sagrado"},
    {itemId:88,itemName:"Madera de álamo temblón"},
    {itemId:89,itemName:"Madera de aquajou"},
    {itemId:90,itemName:"Trigo"},
    {itemId:91,itemName:"Cebada"},
    {itemId:92,itemName:"Avena"},
    {itemId:93,itemName:"Lúpulo"},
    {itemId:94,itemName:"Lino"},
    {itemId:95,itemName:"Centeno"},
    {itemId:96,itemName:"Arroz"},
    {itemId:97,itemName:"Malta"},
    {itemId:98,itemName:"Cáñamo"},
    {itemId:99,itemName:"Maíz"},
    {itemId:100,itemName:"Mijo"},
    {itemId:101,itemName:"Frostiz"},
    {itemId:102,itemName:"Quisnoa"},
    {itemId:110,itemName:"Agua"}
];
...
<div class="modal fade" id="pathSetting" tabindex="-1" role="dialog" style="top: 100px;"></div>`;
    ...
    function gatherFigh(index, array) {
        ...
        if (array[index].gather)
            changeMap = ", gather = true";
        if (array[index].fight)
            changeMap += ", fight = true";
        return changeMap;
    }
    ...
    $('#path-creator-bar').on('click', '.fa-save', function () {
        var firstIf = false;
        var txt = "-- Généré par OWL pour OnlyBot (Contact: Vok2022) --\r\n" +
            "-- Nom : " + $('#file-name-field').val() + "\r\n" +
            "-- Zone : " + $('#area-field').val() + "\r\n" +
            "-- Type : " + ($('#type-field').val() ? $('#type-field').val() : "") + "\r\n" +
            "-- Version : " + $('#version-field').val() + "\r\n" +
            "-- Auteur : " + $('#author-field').val() + "\r\n\r\n" +
            "ELEMENTS_TO_GATHER = {" + ($('#ressources-selecter').val() ? $('#ressources-selecter').val() : "") + "}\r\n" +
            "MAX_PODS = 90\r\n\r\n" +
            "";
        if (pathLinearData.length !== 0) {
            ...
            txt +=
                ...
                '\t\treturn {\r\n' +
                '\t\t\t{map = map:currentPos(), custom = processMap, gather = true, fight = true}\r\n' +
                '\t\t}\r\n' +
                ...
                '\t\treturn {\r\n' +
                '\t\t\t{map = map:currentPos(), custom = processMap, forcegather = true}\r\n' +
                '\t\t}\r\n' +
                ...
                '\t\treturn {\r\n' +
                '\t\t\t{map = map:currentPos(), custom = processMap, forcefight = true}\r\n' +
                '\t\t}\r\n' +
            ...
            for (let key in pathLinearData) {
                txt += '\t{map = "' + pathLinearData[key].map.replace(' ', '') + '", changeMap = {"' + getLinearAction(1, key) + '"' + (pathLinearData[key].index >= 2 ? ', "' + getLinearAction(2, key) + '"' : '') + (pathLinearData[key].index >= 3 ? ', "' + getLinearAction(3, key) + '"' : '') + (pathLinearData[key].index >= 4 ? ', "' + getLinearAction(4, key) + '"' : '') + '}' + gatherFigh(key, pathLinearData) + '},\r\n';
            }
            for (let key in pathData) {
            ...
            if (havenbagCheck('move')) {
                ...
                for (let index = 0; index < havenBagData.length; index++) {
                    if (havenBagData[index].move) {
                        if (!firstIf) {
                            txt += "\t\tif actualMap == \"" + havenBagData[index].map + "\" then\r\n\t\t\tmap:changeMap(\"zaap(125,196," + havenBagData[index].mapidToGo + ")\")\r\n";
                            firstIf = true;
                        } else
                            txt += "\t\telseif actualMap == \"" + havenBagData[index].map + "\" then\r\n\t\t\tmap:changeMap(\"zaap(125,196," + havenBagData[index].mapidToGo + ")\")\r\n";
                    }
        ...
        txt += "\treturn {\r\n";
        for (let key in bankData) {
            txt += '\t\t{map = "' + bankData[key].map.replace(" ", "") + '", changeMap = "' + pathGenerator(key, bankData) + '"},\r\n';
        }
        txt += '\t\t{map = "191104002", changeMap = "261"}, --Devant banque Astrub--\r\n' +
        ...
        for (let key in phenixData) {
            if (checkPhenixPos(phenixData[key].map.replace(" ", ""))[0]) {
                txt += '\t\t{map = "' + phenixPos[checkPhenixPos(phenixData[key].map.replace(" ", ""))[1]].map + '", phenix = "' + phenixPos[checkPhenixPos(phenixData[key].map.replace(" ", ""))[1]].cellid + '", changeMap = "' + pathGenerator(key, phenixData) + '"},\r\n';
            } else {
                txt += '\t\t{map = "' + phenixData[key].map.replace(" ", "") + '", changeMap = "' + pathGenerator(key, phenixData) + '"},\r\n';
            }
        }
        txt += '\t}\r\nend\r\n';
        // Here we can add a lost function to return to Astrub Zaap for exemple
        txt += '\r\n';
        txt += 'function lost()\r\n';
        txt += '    global:printMessage("Careful, your bot got lost on "..map:currentPos().." / "..tostring(map:currentMapId()))\r\n';
        if($("#lost-return-zaap").val() != "-1") {
            if($("#lost-return-zaap").val() != "havresac") {
                txt += '    if map:currentPos() ~= "0,0" then\r\n';
                txt += '        return { { map = map:currentMapId(), havenbag = true } }\r\n';
                txt += '    else\r\n';
                txt += '        return { { map = "0,0", changeMap = "zaap(110,190,'+$("#lost-return-zaap").val()+')" } }\r\n';
                txt += '    end\r\n';
            }
            else {
                txt += '    return { \r\n';
                txt += '        { map = map:currentMapId(), havenbag = true },\r\n';
            }
        }
        txt += 'end';
