// ==UserScript==
// @name    FC | KEMEROVO | M.Kreee ЖБ
// @name:ru КФ | KEMEROVO | M.Kreee ЖБ
// @name:uk КФ | KEMEROVO | M.Kreee ЖБ
// @version 0.0.2
...
// @downloadURL https://update.greasyfork.org/scripts/521007/FC%20%7C%20KEMEROVO%20%7C%20MKreee%20%D0%96%D0%91.user.js
// @updateURL https://update.greasyfork.org/scripts/521007/FC%20%7C%20KEMEROVO%20%7C%20MKreee%20%D0%96%D0%91.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER]Ваша жалоба переадресована [COLOR=rgb(255, 215, 0)]Главному Куратору Форума или Заместителю Главного Куратора Форума[/COLOR].[/CENTER]<br>" +
        '[Color=Flame][CENTER]Ожидайте, когда администрация вынесет окончательный вердикт.[/I][/CENTER][/color][/FONT]'+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/gJBmpfSc/c321ae32c6fb3e32ee0266dff534357f.gif[/img][/url][/CENTER]<br>',
      prefix: PINN_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=Flame][CENTER]Ожидайте, когда технический специалист вынесет окончательный вердикт.[/I][/CENTER][/color][/FONT]'+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/qvL2Rhqf/42d64a9b35502f0e33cf1abd523bc464.gif[/img][/url][/CENTER]<br>',
      prefix: PINN_PREFIX,
      prefix: TEXY_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=Flame][CENTER]Ожидайте, когда Главный администратор вынесет окончательный вердикт.[/I][/CENTER][/color][/FONT]'+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/qvL2Rhqf/42d64a9b35502f0e33cf1abd523bc464.gif[/img][/url][/CENTER]<br>',
      prefix: PINN_PREFIX,
      prefix: GA_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=Flame][CENTER]Ожидайте, когда администрация вынесет окончательный вердикт.[/I][/CENTER][/color][/FONT]'+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/cCh8JP1R/e3d8c2216634263d66c4d5c305a92ec8.gif[/img][/url][/CENTER]<br>',
      prefix: PINN_PREFIX,
      prefix: PINN_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/gcSBn8ht/1e4d3563f58a50682cec0339eabd204a.gif[/img][/url][/CENTER]<br>'+
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/KzYD2p0G/9d3ae374fb85d7d1d95213d1767772d4-1.gif[/img][/url][/CENTER]<br>'+
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/Bns6mfRR/512fc362a4ca2663778db016c2b7f703.gif[/img][/url][/CENTER]<br>'+
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/WzFmDFRx/8345b0f231caac70e7b1387c2b56a070.gif[/img][/url][/CENTER]<br>'+
        '[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]',
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/NF36RsBF/415393c1783b28b507ead708e4dfd88d.gif[/img][/url][/CENTER]<br>'+
        '[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]',
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/8CZLtBNq/c54b8ec9d12edf715086e9f87ea476d7.gif[/img][/url][/CENTER]<br>'+
        '[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]',
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]VLADIMIR[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/kG8kWCMv/c3e1e47113a4bea928309e341b245dac.gif[/img][/url][/CENTER]<br>'+
