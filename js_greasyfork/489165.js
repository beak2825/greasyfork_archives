// ==UserScript==
// @name         Ed ING combined Bruno Sander
...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/489165/Ed%20ING%20combined%20Bruno%20Sander.user.js
// @updateURL https://update.greasyfork.org/scripts/489165/Ed%20ING%20combined%20Bruno%20Sander.meta.js
// ==/UserScript==
...
////CONFIGURE/////////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE/////
    ...
    const topGesamtSaldoAdjustmentAmount = 17000;  // Change this to your desired amount

    // Define an array for account balance adjustments
    const accountBalanceAdjustments = [
        { index: 1, amount: 17000},
        { index: 3, amount: 17000},// Example: change the first account's balance by -1000 EUR
    //    { index: 2, amount: 100 },
        // Add more objects as needed for each account balance adjustment
    ];

    // Specify your IBAN and custom transactions here
    const yourIBAN = 'DE63 5001 0517 0471 2645 40'; // Replace with your IBAN
     // Specify the balance change you want to make (positive for increase, negative for decrease)
    const balanceChange = 17000.0; // Example: decrease balance by 100.00 EUR
