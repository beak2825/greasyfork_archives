// ==UserScript==
// @name Скрипт для начальства CHERRY
// @namespace https://forum.blackrussia.online
// @version 1.7.5
// @description Жб АДМ+ОБЖ Cherry[09]
// @author Руководство CHERRY
...
// @downloadURL https://update.greasyfork.org/scripts/491115/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BD%D0%B0%D1%87%D0%B0%D0%BB%D1%8C%D1%81%D1%82%D0%B2%D0%B0%20CHERRY.user.js
// @updateURL https://update.greasyfork.org/scripts/491115/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BD%D0%B0%D1%87%D0%B0%D0%BB%D1%8C%D1%81%D1%82%D0%B2%D0%B0%20CHERRY.meta.js
// ==/UserScript==
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Свяжитесь со мной вконтакте: <br> vk.com/id682193669[/CENTER]<br>" +
...
{
title: 'Передача спец админу',
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
'[CENTER]Ваша жалоба передана Специальному Администратору.[/CENTER]<br>'+
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Администратор предоставил доказательства вашего нарушения.<br>Нарушений со стороны администратора нет.[/CENTER]<br><br>" +
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
'[CENTER]Ваше наказание снято, с администратором проведена беседа.<br>Приятного времяпровождения.[/CENTER][/SIZE]<br>' +
'[CENTER]Закрыто[/CENTER][/FONT]',
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]С данным администратором будет проведена строгая профилактическая беседа.[/CENTER]<br>" +
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Ваша тема не относиться к жалобам на администрацию, вам в технический раздел нашего сервера Cherry[09] - [URL='https://forum.blackrussia.online/index.php?forums/Технический-раздел-cherry.408/']клик[/URL] [/CENTER]<br>" +
'[CENTER]Закрыто.[/CENTER][/FONT]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Вам было выдано наказание от технического специалиста, обратитесь в раздел 'Жалобы на технических специалистов' нашего сервера Cherry[09] -[URL='https://forum.blackrussia.online/index.php?forums/Сервер-№9-cherry.1190/']клик[/URL]<br>" +
'[CENTER]Закрыто.[/CENTER][/FONT]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Ваша жалоба рассмотрению не подлежит так как после момента выдачи наказания прошло более 72 часов.[/CENTER]<br>" +
'[CENTER]Закрыто.[/CENTER][/FONT]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Обратитесь в раздел Обжалование наказаний нашего сервера Cherry[09]- [URL='https://forum.blackrussia.online/index.php?forums/Обжалование-наказаний.436/']клик[/URL][/CENTER]<br>" +
'[CENTER]Закрыто.[/CENTER][/FONT]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Доказательства путем использования соц.сетей ( ВК, Инстаграм ) запрещены.[/CENTER]<br>" +
'[CENTER]Закрыто.[/CENTER][/FONT]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Данная тема является дубликатом предыдущей, при 3-ем дублировании ваш форумный аккаунт будет заблокирован.[/CENTER]<br>" +
'[CENTER]Закрыто.[/CENTER][/FONT]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Если вы считаете что наказание было выдано неверно обратитесь в раздел жалоб на администрацию - [URL='https://forum.blackrussia.online/index.php?forums/Жалобы-на-администрацию.433/']клик[/URL].<br>" +
'[CENTER]Отказано.[/CENTER][/FONT][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Вам было выдано наказание от технического специалиста, обратитесь в раздел 'Жалобы на технических специалистов' нашего сервераCherry[09] -[URL='https://forum.blackrussia.online/index.php?forums/Сервер-№9-cherry.1190/']клик[/URL]<br>" +
'[CENTER]Закрыто.[/CENTER][/FONT]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
{
title: 'Присутствуют редактирования',
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Доказательства должны быть в первоначальном виде, без присутствия редактирования с помощью сторонних программ.[/CENTER]<br>" +
'[CENTER]Закрыто.[/CENTER][/FONT]',
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER] Если вы готовы возместить ущерб игроку, свяжитесь с игроком для возврата имущества, затем он должен оформить обжалование.​[/CENTER]<br>" +
'[CENTER] Закрыто.[/CENTER][/FONT]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Рассмотрев ваше наказание было принято решение о снятие наказания.[/CENTER]<br>" +
...
content:
'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' +
"[CENTER]Даю вам 24 часа для смены никнейма.[/CENTER]<br>" +
'[CENTER]На рассмотрении.[/CENTER][/FONT]',
prefix: PIN_PREFIX,
status: true,
},
