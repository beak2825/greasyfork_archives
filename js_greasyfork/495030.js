...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/495030/loudong.user.js
// @updateURL https://update.greasyfork.org/scripts/495030/loudong.meta.js
// ==/UserScript==
class Dialog {
    static list = []
            ...
            function() {
                ...
                .then(async (res) => {
                    ...
                    function dataAnalysis() {
                        ...
                        .filter(({properties}) => {
                            const {sourceLayer, targetLayer} = properties
                            return ( sourceLayer == '2' && (targetLayer == '1' || targetLayer == '55'))
                        })
                        .filter(relation => {
