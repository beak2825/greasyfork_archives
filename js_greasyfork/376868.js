...
// @downloadURL https://update.greasyfork.org/scripts/376868/Virtonomica%3A%20%D0%A1%D0%BD%D0%B0%D0%B1%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5.user.js
// @updateURL https://update.greasyfork.org/scripts/376868/Virtonomica%3A%20%D0%A1%D0%BD%D0%B0%D0%B1%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5.meta.js
// ==/UserScript==
...
var department = getTypeUnit( img );
...
var wc = $("<li><div class=my_btn id=medical_supply> <img title='Рассчитать снабжение' width=24px alt='Расчет снабжения' src=https://cdn4.iconfinder.com/data/icons/48x48-free-object-icons/48/Lorry.png> </div>").click( function() {
...
$.get(Murl,function(data){
	...
	//console.log( max_personal );
    // коэффициент продаж
    var k = 0;
	for(key in Med_info) {
		if (type != key) continue;
		if ( Med_info[key][0]['all'] == null) continue;
		k = Med_info[key][0]['all']/max_personal[ department ];
		break;
	}
...
var container = $("li:last", $("ul.tabu") ).parent();
