// ==UserScript==
// @name          apollo.rip - Top Filter
// @author        FerretGuy
// @version       1.11
// @namespace     http://apollo.rip
// @description   Allows for filter of top 100/250
// @include       https://apollo.rip/top10.php?type=torrents&limit=*
// @include       http://apollo.rip/top10.php?type=torrents&limit=*
// @include       https://ssl.apollo.rip/top10.php?type=torrents&limit=*
// @downloadURL https://update.greasyfork.org/scripts/26244/apollorip%20-%20Top%20Filter.user.js
// @updateURL https://update.greasyfork.org/scripts/26244/apollorip%20-%20Top%20Filter.meta.js
// ==/UserScript==
...
if(!window.chrome) {
	require_input.value = GM_getValue('apollorip_filter_require') ? GM_getValue('apollorip_filter_require') : '';
	exclude_input.value = GM_getValue('apollorip_filter_exclude') ? GM_getValue('apollorip_filter_exclude') : '';
}else{
	require_input.value = localStorage.getItem('apollorip_filter_require') ? localStorage.getItem('apollorip_filter_require') : '';
	exclude_input.value = localStorage.getItem('apollorip_filter_exclude') ? localStorage.getItem('apollorip_filter_exclude') : '';
}
parseFilter();
...
function saveFilter() {
	if(!window.chrome) {
		GM_setValue('apollorip_filter_require', (require_input.value));
		GM_setValue('apollorip_filter_exclude', (exclude_input.value));
	}else{
		localStorage.setItem('apollorip_filter_require', (require_input.value));
		localStorage.setItem('apollorip_filter_exclude', (exclude_input.value));
	}
}