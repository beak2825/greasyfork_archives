// ==UserScript==
// @name         1win Token TapTap
// @namespace    https://cryptocklicker-frontend-rnd-prod.100hp.app/
// @version      1.0
...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/500985/1win%20Token%20TapTap.user.js
// @updateURL https://update.greasyfork.org/scripts/500985/1win%20Token%20TapTap.meta.js
// ==/UserScript==
    ...
    const observer = new MutationObserver(function(mutations) {
        mutations.forEach(function(mutation) {
            if (mutation.addedNodes.length) {
                // В случае если необходимо выполнять дополнительные действия при изменении DOM, добавить код сюда
            }
        });
    });
