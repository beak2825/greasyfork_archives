// ==UserScript==
// @name         不背单词生词本导出Excel单词+翻译+音标
// @namespace    http://tampermonkey.net/
// @version      1.1
// @description  通过不背单词生词本创建Excel单词本，修改自https://greasyfork.org/zh-CN/scripts/494993-%E4%B8%8D%E8%83%8C%E5%8D%95%E8%AF%8D%E5%AF%BC%E5%87%BAexcel%E5%8D%95%E8%AF%8D%E6%9C%AC
// @author       NG
// @original     shiquda/GuanZi
// @match        https://www.bbdc.cn/newword
// @grant        none
// @require      https://cdn.jsdelivr.net/npm/xlsx@0.18.0/dist/xlsx.full.min.js
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/520998/%E4%B8%8D%E8%83%8C%E5%8D%95%E8%AF%8D%E7%94%9F%E8%AF%8D%E6%9C%AC%E5%AF%BC%E5%87%BAExcel%E5%8D%95%E8%AF%8D%2B%E7%BF%BB%E8%AF%91%2B%E9%9F%B3%E6%A0%87.user.js
// @updateURL https://update.greasyfork.org/scripts/520998/%E4%B8%8D%E8%83%8C%E5%8D%95%E8%AF%8D%E7%94%9F%E8%AF%8D%E6%9C%AC%E5%AF%BC%E5%87%BAExcel%E5%8D%95%E8%AF%8D%2B%E7%BF%BB%E8%AF%91%2B%E9%9F%B3%E6%A0%87.meta.js
// ==/UserScript==
...
(function () {
                    ...
                    for (const item of data.data_body.wordList) {
                        for (const sentence of item.sentenceList) {
                            ...
                            words.push({
                                ...
                                ukpron: item.ukpron,
                                liju: sentence.originalContext,
                                fanyi: sentence.translationContext,
                            });
                        }
                    }
    ...
    function manipulateWords() {
        ...
        const ws = XLSX.utils.json_to_sheet(words.map(wordObj => ({ 单词: wordObj.word, 音标: wordObj.ukpron,释义: wordObj.translation,例句:wordObj.liju,翻译:wordObj.fanyi})));
       ...
       // ws['!ref'] = 'A1:B' + (words.length + 1);,
        ...
        ws['!cols'] = [
            { header: 'A', width: 20 },
            { header: 'B', width: 15.67 },
            { header: 'C', width: 35.25},
            { header: 'D', width: 40.58},
            { header: 'E', width: 40.58},
        ];
