...
// @downloadURL https://update.greasyfork.org/scripts/503632/Prototype.user.js
// @updateURL https://update.greasyfork.org/scripts/503632/Prototype.meta.js
// ==/UserScript==
...
},
{
	...
	{
	title: 'Для логистов ᅠ ᅠ ᅠᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ',
...
{
title: 'для форума ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠᅠ ᅠ ᅠ',
color: 'oswald: 3px; color: #FF69B4; background: #000000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	},
...
},
{
	...
	status: false,
        ...
        {
title: 'передача в разделы ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠᅠ ᅠ ᅠ',
},
        {
	title: 'в жб на адм',
	color: '',
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Переношу ваше обращение в соответствующий раздел.[/CENTER]<br>",
	prefix: PIN_PREFIXX,
	status: false,
},
        {
