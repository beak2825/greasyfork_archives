...
// @downloadURL https://update.greasyfork.org/scripts/532344/Tech%20Admin%27s.user.js
// @updateURL https://update.greasyfork.org/scripts/532344/Tech%20Admin%27s.meta.js
// ==/UserScript==
...
{
            title: 'Докажите привязки',
            content:
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fW8wjTc0/TECH.gif[/img][/url][/CENTER]' +
             "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Courier New][SIZE=20px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)][ICODE]{{ user.name }}[/ICODE][/COLOR].[/CENTER][/SIZE]" +
            "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Courier New][SIZE=20px]Здравствуйте! Для разблокировки аккаунта, нам нужно убедиться что вы имеете доступ к привязкам аккаунта. Пожалуйста,назовите ваши привязки. 1. Укажите ваш Telegram ID, если ваш игровой аккаунт был привязан к Telegram. Узнать его можно здесь: https://t.me/getmyid_bot 2. Укажите ваш оригинальный ID страницы ВКонтакте, которая привязана к аккаунту (взять его можно через данный сайт - https://regvk.com/ ) 3. Укажите почту, которая привязана к аккаунту. Мы не просим ваш пароль и не собираемся красть ваш аккаунт и ваши данные. Мы всего лишь должны их сверить с вашими привязками..[/SIZE][/FONT][/COLOR][/CENTER]" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrBq57RZ/S2qGP.png[/img][/url][/CENTER]' +
            '[CENTER][SIZE=25px][COLOR=rgb(255, 152, 0)][ICODE]На рассмотрении...[/ICODE][/SIZE][/CENTER][/COLOR]',
            prefix: TECHADM_PREFIX,
            status: true,
},
