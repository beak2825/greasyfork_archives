// ==UserScript==
// @name         百度网盘直接下载助手 Payne
// @namespace    undefined
// @version      0.2
// @description  直接下载百度网盘和百度网盘分享的文件,避免下载文件时调用百度网盘客户端,获取网盘文件的多種下载地址
// @author       Payne
...
// @downloadURL https://update.greasyfork.org/scripts/38185/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%9B%B4%E6%8E%A5%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B%20Payne.user.js
// @updateURL https://update.greasyfork.org/scripts/38185/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%9B%B4%E6%8E%A5%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B%20Payne.meta.js
// ==/UserScript==
...
(function() {
    ...
    function PanHelper(){
            ...
            if(id == 'download-direct'){
                ...
                if(result.errno === 0){
                    if(downloadType == 'dlink')
                        ...
                        downloadLink = downloadLink.replace("https://www.baidupcs.com/rest/2.0/pcs/file?method=batchdownload", "https://pcs.baidu.com/rest/2.0/pcs/file?devuid=a7b43bf15e7d951ab3baefa1d6b06a70&cuid=a7b43bf15e7d951ab3baefa1d6b06a72&time=1517811886&clienttype=21&version=2.2.0&vip=1&method=batchdownload");
        ...
        function getDownloadLinkWithRESTAPIBaidu(path){
            ...
            var arr = getDownloadLinkWithClientAPI(path);
            debugger;
            var link = arr.urls[0].url;
            return link;
        }
        ...
        function getDownloadLinkWithClientAPI(path){
            var result;
            var url = clientAPIUrl + 'file?devuid=a7b43bf15e7d951ab3baefa1d6b06a70&cuid=a7b43bf15e7d951ab3baefa1d6b06a72&time='+getTimestamp()+'&clienttype=21&version=2.2.0&vip=1&method=locatedownload&app_id=250528&esl=1&ver=4.0&dtype=1&ehps=1&check_blue=1&path=' + encodeURIComponent(path) +'&err_ver=1.0';
            $.ajax({
                url:url,
                method:'POST',
                xhrFields: {
