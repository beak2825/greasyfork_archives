...
// @downloadURL https://update.greasyfork.org/scripts/461530/Jon_Vinici.user.js
// @updateURL https://update.greasyfork.org/scripts/461530/Jon_Vinici.meta.js
// ==/UserScript==
	...
	const buttons = [
{
	...
	"[CENTER] текст [/CENTER][/FONT][/SIZE]'<br>"+
	'[RIGHT][SIZE=3][FONT=trebuchet ms]С уважением [COLOR=PURPLE]Зам. Главного Администратор[/COLOR] Jon_Vinici [COLOR=PURPLE]Purple.[/COLOR][/FONT][/SIZE][/RIGHT]',
},
{
...
},
{
	...
	"[CENTER]Ожидайте ответа.[/CENTER][/FONT]'<br>"+
	'[RIGHT][SIZE=3][FONT=trebuchet ms]С уважением [COLOR=PURPLE]Зам. Главного Администратор[/COLOR] Jon_Vinici [COLOR=PURPLE]Purple.[/COLOR][/FONT][/SIZE][/RIGHT]',
	prefix: PIN_PREFIX,
	status: true,
},
...
},
{
	...
	"[CENTER]На рассмотрении[/CENTER][/FONT]'<br>"+
	'[RIGHT][SIZE=3][FONT=trebuchet ms]С уважением [COLOR=PURPLE]Зам. Главного Администратор[/COLOR] Jon_Vinici [COLOR=PURPLE]Purple.[/COLOR][/FONT][/SIZE][/RIGHT]',
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' + 
	'[CENTER]Ваше наказание снято, с администратором проведена беседа.<br>Приятного время припровождения.[/CENTER][/SIZE]<br>' +
	"[CENTER]Закрыто[/CENTER][/FONT]'<br>"+
	'[RIGHT][SIZE=3][FONT=trebuchet ms]С уважением [COLOR=PURPLE]Зам. Главного Администратор[/COLOR] Jon_Vinici [COLOR=PURPLE]Purple.[/COLOR][/FONT][/SIZE][/RIGHT]',
...
},
{
	...
	"[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]'<br>"+
	'[RIGHT][SIZE=3][FONT=trebuchet ms]С уважением [COLOR=PURPLE]Зам. Главного Администратор[/COLOR] Jon_Vinici [COLOR=PURPLE]Purple.[/COLOR][/FONT][/SIZE][/RIGHT]',
	prefix: UNACCEPT_PREFIX,
	status: false,
},
...
},
{
	...
	content: 
	'[SIZE=4][FONT=Veranda][CENTER]Доброе время суток, уважаемый {{ user.mention }}![/CENTER]<br><br>' + 
	"[CENTER]Созданная тема никоим образом не относится к назначению и задачам данного раздела или же написана не по форме.[/CENTER]<br>" +
	"[CENTER]Закрыто.[/CENTER][/FONT]'<br>"+
	'[RIGHT][SIZE=3][FONT=trebuchet ms]С уважением [COLOR=PURPLE]Зам. Главного Администратор[/COLOR] Jon_Vinici [COLOR=PURPLE]Purple.[/COLOR][/FONT][/SIZE][/RIGHT]',
	prefix: UNACCEPT_PREFIX,
	status: false,
