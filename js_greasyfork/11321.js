...
// @version     6
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/11321/LibraryThing%20more%20%22editions%22%20links.user.js
// @updateURL https://update.greasyfork.org/scripts/11321/LibraryThing%20more%20%22editions%22%20links.meta.js
// ==/UserScript==
...
if (url.indexOf("catalog_bottom.php") > -1) {  
  ...
  for (var i=0; i<catalogLinks.snapshotLength; i++) {
    ...
    newLink = document.createElement('span');
    newLink.className = "moreeditions";
    newLink.innerHTML = '(<a href="' + link.href.replace("/book/","/editions/") + '" target="_top">editions</a>)'
    var par = link.parentNode;
    var space = document.createTextNode(" ");
    par.insertBefore(newLink, link.nextSibling);
    par.insertBefore(space, newLink);
