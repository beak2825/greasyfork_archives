...
// @author        Geckofox
// @namespace     https://greasyfork.org/zh-CN/users/12644-geckofox
// @downloadURL https://update.greasyfork.org/scripts/10576/Tieba%20Tail%20Plus.user.js
// @updateURL https://update.greasyfork.org/scripts/10576/Tieba%20Tail%20Plus.meta.js
// ==/UserScript==
...
/*    var screen=window.screen.width+"*"+window.screen.height;
    ...
    if(userAgent.indexOf("windows nt 6.1")>=1){var S="Windows 7";}
        ...
        if(userAgent.indexOf("windows nt 10.0")>=1){var S="Windows 10";}
    else
 ...
 /*else {
    ...
    if ((userAgent.indexOf('msie') >= 0) && (navigator.userAgent.indexOf('microsoft internet explorer') < 0)){
      ...
      var Browser = Blogo + Browser;

    var imfor = OS + "　" + Browser;
    
    //------土豪金图片------//
    var Joke = '<img changedsize="true" pic_type="0" class="BDE_Image" src="http://ww1.sinaimg.cn/bmiddle/6c256f91gw1ed74z2p79dg208w050u0x.gif" width="320" height="180"></img>';
    //============//
    ...
    var weiba=["<br>"+imfor+"　"+d,Bookmark+theBr+navigator.userAgent+theBr+Date(),Bookmark+"<br>"+Joke,""];
    ...
    var ws=GM_getValue('wStyle','0');
     ...
     //添加选择框按钮
    $(".poster_component.editor_content_wrapper.ueditor_container").after('<label>回复内容</label><select id="huifuList" name="selectDropDown" style="left:5px"><option name="huifu" id="huifu1">随机内容</option><option  name="huifu" id="huifu2">挽尊</option><option  name="huifu" id="huifu3">好帖</option><option  name="huifu" id="huifu4">MLGB</option><option name="huifu" id="huifu5">帅的含义</option><option name="huifu" id="huifu6">觉水</option><option name="huifu" id="huifu7">觉厉</option><option name="huifu" id="huifu8">自己输入</option></select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>内容格式</label><select id="huifustyleList" name="selectDropDown" style="left:5px"><option name="huifustyle" id="huifustyle1">红色</option><option  name="huifustyle" id="huifustyle2">加粗</option><option  name="huifustyle" id="huifustyle3">红色加粗</option><option  name="huifustyle" id="huifustyle4">默认</option></select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>尾巴内容</label><select id="weibaList" name="selectDropDown" style="left:5px"><option name="weiba" id="weiba1">随机尾巴</option><option  name="weiba" id="weiba2">中文UA+农历</option><option  name="weiba" id="weiba3">UA+Date</option><option  name="weiba" id="weiba4">随兴</option><option  name="weiba" id="weiba5">无</option></select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>尾巴格式</label><select id="weibastyleList" name="selectDropDown" style="left:5px"><option name="weibastyle" id="weibastyle1">红色</option><option  name="weibastyle" id="weibastyle2">加粗</option><option  name="weibastyle" id="weibastyle3">红色加粗</option><option  name="weibastyle" id="weibastyle4">默认</option></select><br><br>')//position:relative; 
    //添加尾巴发表按钮
