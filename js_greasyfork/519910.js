...
// @version      1.0.1
// @description  для техов логирования
// @author       Yuma
...
// @downloadURL https://update.greasyfork.org/scripts/519910/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9%20%D0%A1%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82.user.js
// @updateURL https://update.greasyfork.org/scripts/519910/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9%20%D0%A1%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82.meta.js
// ==/UserScript==
...

{
  ...
  '@Raf_Piatigorsky , @Vitaliy_Snow<br><br>'+
...
},
{
	...
	color: 'oswald: 3px; color: #ffffff; background: #ff0000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #ffffff',
	},
{
	title: 'Рассмотрение',
	color: '#FF8C00',
...
},
{
  ...
  '[CENTER]@Raf_Piatigorsky , @Vitaliy_Snow[/CENTER][/FONT][/SIZE]<br><br>'+
...
{
title: 'ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠᅠ ᅠ  Для Форумников ᅠ ᅠ ᅠᅠ ᅠ ᅠ ᅠ ᅠᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ᅠ ',
	color: 'oswald: 3px; color: #ffffff; background: #ff0000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #ffffff',
	},
{
	title: 'ФОРМА',
	...
	'[CENTER][I][COLOR=rgb(139, 0, 0)]Закрыто[/COLOR][/CENTER][/I][/FONT][/SIZE]',
	prefix: CLOSE_PREFIX,
	status: false,
},
{
...
},
{
    ...
    '[CENTER][I]Раассмотрено[/I][/CENTER][/FONT][/SIZE]',
    prefix: WATCHED_PREFIX,
    status: false,
},
{
...
},
{
	...
	addButton('КП', 'teamProject', '#FFCF40');
	addButton('Рассмотрено', 'watched', '#228B22');
  ...
  addButton('Одобрено', 'odobreno', '#44944A');
	addAnswers();
