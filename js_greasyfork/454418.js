// ==UserScript==
// @name          Кураторы форума | 34
// @namespace    https://forum.blackrussia.online
// @version      1.3.1
// @description  Переделал почти полностью сборку К/Ф
// @author       Nikita_Darkness
...
// @downloadURL https://update.greasyfork.org/scripts/454418/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%2034.user.js
// @updateURL https://update.greasyfork.org/scripts/454418/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%2034.meta.js
// ==/UserScript==
	...
	},
{
	  ...
	  content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Заблокировал все ваши [Color=Red]Fake [/color][Color=lavender] аккаунты.<br>" +
		"[CENTER][COLOR=lavender]Спасибо за информацию. <br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=#00FA9A][ICODE]Рассмотрено[/ICODE][COLOR=#FF0000][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]',
	...
	},
{
	  ...
	  content:
		"[B][CENTER][COLOR=#EE82EE][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Заблокировал все [Color=Red]Fake [/color][Color=lavender] аккаунты.<br>" +
		"[CENTER][COLOR=lavender]Спасибо за информацию. <br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=#00FA9A][ICODE]Рассмотрено[/ICODE][COLOR=#FF0000][ICODE]Закрыто[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: WATCHED_PREFIX,
	...
	},
{
	...
	},
    {
	  title: '| Приветствие |',
	  content:
		"[B][CENTER][COLOR=#FFDEAD][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
	...
	},
  {
	...
	},
	{
	  ...
	  content:
		"[B][CENTER][COLOR=#FFDEAD][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]2.13 | [color=lavender] Запрещен DB (DriveBy) — намеренное убийство / нанесение урона без веской IC причины на любом виде транспорта [color=red] | Jail 30 минут. [/Spoiler]<br>"+
	...
	},
	{
	  ...
	  content:
		"[B][CENTER][COLOR=#FFDEAD][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]2.15 | [color=lavender] Запрещен TK (Team Kill) — убийство члена своей или союзной фракции, организации без наличия какой-либо IC причины.[color=red]  | Jail 30 минут / Warn (за два и более убийства)[/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Наказание будет выдано в течение 24 часов.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=#00FA9A][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	...
	},
   {
	...
	},
    {
	  ...
	  content:
		"[B][CENTER][COLOR=#FFDEAD][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказание.[Spoiler][color=red]2.47 | [color=lavender] Запрещено ездить по полям на грузовом транспорте (работа дальнобойщика) [color=red]  | Jail 60 минут[/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Наказание будет выдано в течение 24 часов.<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
		'[B][CENTER][COLOR=#00FA9A][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	...
	},
	{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=lavender]Просьба не создавать повторных РП биографий<br>"+
		"[B][CENTER][COLOR=lavender]Ожидайте выноса вердикта в ближайшее время<br>"+
		"[CENTER][IMG width=695px]https://i.postimg.cc/qBmYpvQv/C0ffE.png[/IMG]<br>"+
