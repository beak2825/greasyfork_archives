// ==UserScript==
// @name        MaelstromTools Dev 15.3 Patch
// @namespace   MaelstromTools
// @description Just a set of statistics & summaries about repair time and base resources. Mainly for internal use, but you are free to test and comment it.
// @version     0.1.3.2
// @author      Maelstrom, HuffyLuf, KRS_L and Krisan, fix for patch 15.3 by chertosha
// @include     http*://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @downloadURL https://update.greasyfork.org/scripts/13716/MaelstromTools%20Dev%20153%20Patch.user.js
// @updateURL https://update.greasyfork.org/scripts/13716/MaelstromTools%20Dev%20153%20Patch.meta.js
// ==/UserScript==
...
//                var myRepair = repairData.CanRepairAll(viewMode);
//                repairData.UpdateCachedFullRepairAllCost(viewMode);
///////                repairData.get_CachedFullRepairAllCost(viewMode);
                  if (viewMode==1){
                  var xxCond=ncity.GetBuildingsConditionInPercent();
                  } else if (viewMode==4){
                  var xxCond=ncity.GetOffenseConditionInPercent();
                  }
                  if (xxCond==-1) {xxCond=100;}
//                  console.log(ncity.m_SupportDedicatedBaseName, " ", xxCond, " ", viewMode);
                return ((xxCond<100) && (!ncity.get_IsLocked() || (viewMode != ClientLib.Vis.Mode.ArmySetup)));
