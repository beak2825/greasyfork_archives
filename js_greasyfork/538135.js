...
// @match        https://agar.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/538135/Agario%3A%20Subir%20Imagen%20con%20Bot%C3%B3n%20de%20Borde%20Personalizado.user.js
// @updateURL https://update.greasyfork.org/scripts/538135/Agario%3A%20Subir%20Imagen%20con%20Bot%C3%B3n%20de%20Borde%20Personalizado.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function() {
        ...
        colorBorderContainer.style.flexDirection = 'row';
        colorBorderContainer.style.justifyContent = 'center';
        colorBorderContainer.style.marginTop = '10px';
        ...
        // Posicionar los elementos correctamente debajo del selector de colores
        ...
        if (colorSelector) {
            ...
            // Posicionar los botones de color del borde justo debajo del botón "Subir Imagen"
            colorBorderContainer.style.left = `${rect.left}px`;
            colorBorderContainer.style.top = `${uploadButton.offsetTop + uploadButton.offsetHeight + 10}px`; // 10px debajo del botón "Subir Imagen"
