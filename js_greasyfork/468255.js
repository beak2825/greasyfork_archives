// ==UserScript==
// @name         TheresMore 自动点击建筑、研究、资源加速、军队强化
// @version      0.92
// @description  加速 TheresMore, 自动点击列表功能, 军队强化功能
// @author       wdjwxh, Maggot Huangyichun
// @match        https://theresmoregame.g8hh.com/
// @license      MIT
// @run-at       document-start
// @namespace http://www.huangyichun.com
// @downloadURL https://update.greasyfork.org/scripts/468255/TheresMore%20%E8%87%AA%E5%8A%A8%E7%82%B9%E5%87%BB%E5%BB%BA%E7%AD%91%E3%80%81%E7%A0%94%E7%A9%B6%E3%80%81%E8%B5%84%E6%BA%90%E5%8A%A0%E9%80%9F%E3%80%81%E5%86%9B%E9%98%9F%E5%BC%BA%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/468255/TheresMore%20%E8%87%AA%E5%8A%A8%E7%82%B9%E5%87%BB%E5%BB%BA%E7%AD%91%E3%80%81%E7%A0%94%E7%A9%B6%E3%80%81%E8%B5%84%E6%BA%90%E5%8A%A0%E9%80%9F%E3%80%81%E5%86%9B%E9%98%9F%E5%BC%BA%E5%8C%96.meta.js
// ==/UserScript==
...
async function autoClickBuilding() {
    //建筑
    if(autoUpdateIsRunning) {
        return
    }
...
async function autoClickResearch() {
    //研究
    closeDialog()
    ...
    console.log('正在寻找可升级研究')
    for (const [i, node] of list.entries()) {
        let hasClick = false
        if (
            !node.classList.value.includes('btn-off') &&
            !dangerList.some((word) => node.textContent.includes(word))
        ) {
            console.log(`${new Date().toLocaleString()} 研究: `, node.textContent , ' , MaggotScheduler running.')
            node.click()
            hasClick = true
            break
        }
...
function closeDialog() {
    ...
    const reportNode = document.querySelector('#headlessui-dialog-\\:rp\\:')
    reportNode && reportNode.querySelector('.sr-only').parentNode.click()
}
