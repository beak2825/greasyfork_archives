// ==UserScript==
// @name    FC | KEMEROVO | A.Goodman ЖБ на АДМ
// @name:ru КФ | KEMEROVO | A.Goodman ЖБ на АДМ
// @name:uk КФ | KEMEROVO | A.Goodman ЖБ на АДМ
// @version 0.0.1
...
// @downloadURL https://update.greasyfork.org/scripts/493131/FC%20%7C%20KEMEROVO%20%7C%20AGoodman%20%D0%96%D0%91%20%D0%BD%D0%B0%20%D0%90%D0%94%D0%9C.user.js
// @updateURL https://update.greasyfork.org/scripts/493131/FC%20%7C%20KEMEROVO%20%7C%20AGoodman%20%D0%96%D0%91%20%D0%BD%D0%B0%20%D0%90%D0%94%D0%9C.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
    ...
    },
  {
    ...
    },
    {
     ...
     {
     title: '★----★----★---Снижение срока---★----★----★----★----★----★----★----★----★----★----★----★----★----★----★----★----★',
    },
    {
      title: 'Срок снижен до 15 дней',
      content:
        '[Color=rgb(255, 128, 0)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        '[CENTER]Срок блокировки аккаунта будет снижен до 15 дней.<br>С момента разблокировки аккаунта, не повторяйте подобных действий.<br>' +
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(238, 119, 0)][SIZE=4][FONT=courier new]KEMEROVO[/FONT][/SIZE][/COLOR][COLOR=rgb(255, 255, 255)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman]✿❯────「Одобрено ❖ Закрыто」────❮✿ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
