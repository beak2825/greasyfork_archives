// ==UserScript==
// @name         Twitch Multi-Redirect, but for streamsniper.tv
// @namespace    RexOmni
// @version      1.2
...
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/416421/Twitch%20Multi-Redirect%2C%20but%20for%20streamsnipertv.user.js
// @updateURL https://update.greasyfork.org/scripts/416421/Twitch%20Multi-Redirect%2C%20but%20for%20streamsnipertv.meta.js
// ==/UserScript==
...
(function() {
    ...
    tmr.redirects = { // Redirect functions
        'TwitchLS' : ()=> { window.location.replace('https://www.streamsniper.tv/live/t/' + tmr.channel); }
    };
