...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/481783/%D0%B6%D0%B1%20%20%D0%BE%D0%B1%D0%B6.user.js
// @updateURL https://update.greasyfork.org/scripts/481783/%D0%B6%D0%B1%20%20%D0%BE%D0%B1%D0%B6.meta.js
// ==/UserScript==
	...
	},
{
	...
	},
     {
	  ...
	  content:
		`[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}[/CENTER]<br><br>` +
		"[CENTER][SIZE=4][FONT=georgia]Ваша жалоба была одобрена и будет проведена беседа с администратором.Ваше наказание будет снято.[/FONT][/SIZE]<br>" +
