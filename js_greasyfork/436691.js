...
// @name        Tools UEO 简书-剔除外链拦截
// @description 去掉恶心的外链拦截
// @match       *://*.jianshu.com/*
// @author      AD
// @version     0.1
// @namespace   aboutdev
...
// @downloadURL https://update.greasyfork.org/scripts/436691/Tools%20UEO%20%E7%AE%80%E4%B9%A6-%E5%89%94%E9%99%A4%E5%A4%96%E9%93%BE%E6%8B%A6%E6%88%AA.user.js
// @updateURL https://update.greasyfork.org/scripts/436691/Tools%20UEO%20%E7%AE%80%E4%B9%A6-%E5%89%94%E9%99%A4%E5%A4%96%E9%93%BE%E6%8B%A6%E6%88%AA.meta.js
// ==/UserScript==
...
(function (){
  'use strict';
   ...
   for (var i in links){
       ...
       if(link&&link.indexOf('https://links.jianshu.com/go?')!= -1)
       {
           const decodelink = decodeURIComponent(link)
           const newlink = decodelink.substr(decodelink.lastIndexOf("?") + 4,decodelink.length)
           links[i].href=newlink
           console.log('1原来的链接：',decodelink,'\n1现在的链接：',links[i].href)
       }
       else if(link&&link.indexOf('https://link.jianshu.com/?t=')!= -1)
       {
           const decodelink = decodeURIComponent(link)
           const newlink = decodelink.substr(decodelink.lastIndexOf("?") + 3,decodelink.length)
           links[i].href=newlink
           console.log('2原来的链接：',decodelink,'\n2现在的链接：',links[i].href)
       }
   }
})()