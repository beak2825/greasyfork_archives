...
// @require      https://cdn.jsdelivr.net/npm/@arco-design/web-vue@2.57.0/dist/arco-vue.min.js
// @resource     bilibili_music_backend_bg  https://fastly.jsdelivr.net/npm/@ocyss/bilibili-music-backend@0.2.0/bilibili_music_backend_bg.wasm
...
// @updateURL https://update.greasyfork.org/scripts/498677/Bilibili%F0%9F%8E%B6%E9%9F%B3%E4%B9%90%E5%A7%AC.meta.js
// ==/UserScript==
...
(async function (vue, webVue) {
  ...
  async function rm(selector, ...args) {
    if (Array.isArray(selector)) {
      await Promise.all(selector.map((s) => {
  ...
  function request({
    ...
    return new Promise(async (resolve, reject) => {
      ...
      console.log("music-log/requests", {
        url,
        data,
        method,
        headers,
  ...
  var audiobufferToBlob = audioBufferToBlob;
  const audiobufferToBlob$1 = /* @__PURE__ */ getDefaultExportFromCjs(audiobufferToBlob);
  const __vite__wasmUrl = _GM_getResourceURL("bilibili_music_backend_bg");
...
${val.stack}`;
  ...
  function main$2(file, option) {
    try {
      const retptr = wasm$1.__wbindgen_add_to_stack_pointer(-16);
      const ptr0 = passArray8ToWasm0(file, wasm$1.__wbindgen_export_0);
      const len0 = WASM_VECTOR_LEN;
      wasm$1.main(retptr, ptr0, len0, addHeapObject(option));
  ...
  function lyrics_clip$1(ranges, lyrics) {
    try {
      const retptr = wasm$1.__wbindgen_add_to_stack_pointer(-16);
      wasm$1.lyrics_clip(retptr, addHeapObject(ranges), addHeapObject(lyrics));
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
      if (r2) {
  ...
  function handleError(f, args) {
    try {
      ...
      wasm$1.__wbindgen_export_3(addHeapObject(e));
    }
  }
  ...
  function __wbg_log_a7be58316bec4884(arg0, arg1) {
  ...
  function __wbg_error_f851667af71bcfc6(arg0, arg1) {
    ...
    try {
      ...
      wasm$1.__wbindgen_export_2(deferred0_0, deferred0_1, 1);
    }
  }
  ...
  URL = globalThis.URL;
  const __vite__wasmModule = await( __vite__initWasm({ "./bilibili_music_backend_bg.js": {
    ...
    "__wbg_getwithrefkey_edc2c8960f0f1191": __wbg_getwithrefkey_edc2c8960f0f1191,
    "__wbindgen_is_undefined": __wbindgen_is_undefined,
    "__wbindgen_in": __wbindgen_in,
    "__wbg_log_a7be58316bec4884": __wbg_log_a7be58316bec4884,
    ...
    "__wbg_isSafeInteger_f7b04ef02296c4d2": __wbg_isSafeInteger_f7b04ef02296c4d2,
  ...
  const main$1 = __vite__wasmModule.main;
  const lyrics_clip = __vite__wasmModule.lyrics_clip;
  const wav_clip = __vite__wasmModule.wav_clip;
    ...
    setup(__props) {
      ...
      function main2() {
        ...
        request.get({
          ...
          stepIndex.value++;
          const request2 = await fetch(audioUrl);
          if (!request2.ok) {
            console.log({
              audioUrl,
              request: request2
          ...
          const blob = await new Promise((reactive2) => {
            request2.arrayBuffer().then((arrBuf) => {
              stepIndex.value++;
              audioCtx.decodeAudioData(arrBuf, (buf) => {
                const blob2 = audiobufferToBlob$1(buf);
                reactive2(blob2);
              });
            }).catch((e) => {
              console.log(e);
          ...
          stepIndex.value++;
          let imgBuf = new ArrayBuffer(0);
          if (fromData.coverUrl) {
            const img = await fetch(fromData.coverUrl.replace("http://", "https://"));
          ...
          const option = {
            ...
            album: ((_a2 = fromData.data) == null ? void 0 : _a2.album) ?? "",
          ...
          const res = main$2(await blobToUint8Array(blob), option);
          stepIndex.value++;
      ...
      function uint8ArrayToBlob(array, type) {
  ...
  const StepAudio = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-1f289761"]]);
  const _hoisted_1$3 = {
    ...
    setup(__props, {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [vue.createVNode(_component_a_spin, {
          ...
          default: vue.withCtx(() => [vue.createElementVNode("div", _hoisted_2$2, [vue.createElementVNode("div", null, [vue.createVNode(_component_a_button, {
            onClick: endAtCurrent
          }, {
            default: vue.withCtx(() => [..._cache[0] || (_cache[0] = [vue.createTextVNode("从这开头", -1)])]),
            _: 1
          }), vue.createVNode(_component_a_button, {
            onClick: startFromCurrent
          }, {
            default: vue.withCtx(() => [..._cache[1] || (_cache[1] = [vue.createTextVNode("从这结尾", -1)])]),
            _: 1
            ...
            default: vue.withCtx(() => [_cache[2] || (_cache[2] = vue.createTextVNode(" 开始记录 ", -1))]),
            _: 1
            ...
            default: vue.withCtx(() => [_cache[3] || (_cache[3] = vue.createTextVNode(" 结束记录 ", -1))]),
            _: 1
          ...
          }, [vue.createElementVNode("div", _hoisted_3$2, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(deletedSections.value, (section) => {
            ...
            default: vue.withCtx(() => [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(deletedSections.value, (section) => {
              return vue.openBlock(), vue.createBlock(_component_a_list_item, {
                ...
                default: vue.withCtx(() => [vue.createElementVNode("span", _hoisted_4$1, [vue.createElementVNode("a", {
                  onClick: ($event) => seekTo(section.start)
                }, vue.toDisplayString(section.start.toFixed(2)) + "s", 9, _hoisted_5$1), _cache[4] || (_cache[4] = vue.createTextVNode(" - ", -1)), vue.createElementVNode("a", {
                  onClick: ($event) => seekTo(section.end)
                }, vue.toDisplayString(section.end.toFixed(2)) + "s", 9, _hoisted_6$1)]), vue.createVNode(_component_a_button, {
                  status: "danger",
  ...
  const StepMontage = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-35764355"]]);
  ...
  const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, {
        ...
        if (noSubtitle.value) {
        ...
        } else {
          {
            ...
            if (fromData.clipRanges && fromData.clipRanges.length > 0) {
              lyricsData = lyrics_clip$1(fromData.clipRanges, lyricsData);
            }
          }
        }
      ...
      const onlineLyricsDiff = vue.computed(() => {
        var _a2;
        if (!((_a2 = editLyricsData.value) == null ? void 0 : _a2.data)) return [];
      ...
      const lyricsBodyLine = vue.computed(() => {
        var _a2;
        if (!((_a2 = editLyricsData.value) == null ? void 0 : _a2.data)) return [0, 0, 0];
...
返回纠正后的表，要严格按照格式输出`
      ...
      function editLyrics(item) {
        ...
        if (editLyricsData.value.data) {
          if (fromData.clipRanges && fromData.clipRanges.length > 0) {
            editLyricsData.value.data._lyricsBody = lyrics_clip$1(fromData.clipRanges, editLyricsData.value.data.body.map((item2) => [Math.round(item2.from * 1e3), item2.content]));
  ...
  const _sfc_main = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      ...
      vue.onMounted(() => {
        ...
        if (music_id) {
          console.log("获取到的Music ID:", music_id, bgmTag == null ? void 0 : bgmTag.__vue__);
  ...
  _GM_getResourceURL("bilibili_music_backend_bg");
  const main = () => {
