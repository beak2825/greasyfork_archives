...
// @version      2025-10-15
// @description  进入番茄小说官网直接复制小说文本
// @author       You
// @match        https://fanqienovel.com/reader*
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/552657/%E7%95%AA%E8%8C%84%E5%B0%8F%E8%AF%B4%E5%A4%8D%E5%88%B6%E6%96%87%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/552657/%E7%95%AA%E8%8C%84%E5%B0%8F%E8%AF%B4%E5%A4%8D%E5%88%B6%E6%96%87%E6%9C%AC.meta.js
// ==/UserScript==

(function() {
'use strict';
document.body.innerHTML = document.body.innerHTML.replace('noselect', '')
const CODE_ST = 58344;
const CODE_ED = 58715;
...
try {
let novelContent = document.getElementsByClassName('muye-reader-content');
if (novelContent.length === 0) return; // 如果找不到元素，则直接返回

let novel = novelContent[0].firstChild;
if (!novel || !novel.children) return; // 如果没有子元素，则直接返回

for (var p of novel.children) {
if (p.classList.contains('text-processed')) continue; // 跳过已处理的段落
...
p.innerText = newText;
p.classList.add('text-processed'); // 标记段落为已处理
}
} catch(err) {
console.log(err);
}
