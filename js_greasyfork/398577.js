...
// @downloadURL https://update.greasyfork.org/scripts/398577/EbayEmbedSampleLinks.user.js
// @updateURL https://update.greasyfork.org/scripts/398577/EbayEmbedSampleLinks.meta.js
// ==/UserScript==
...
(function() {
    ...
    var desc = document.getElementById("desc_ifr");
    var links = null;
    ...
    GM.xmlHttpRequest({
        ...
        onload: function(response) {
            ...
            var main_div = document.getElementById("vi-desc-maincntr");
            ...
            temp_audio_element.setAttribute('style', 'height:"20px";width:51%;align:left;');
            ...
            if(video_list != null){
                ...
                for (var i = 0; i < video_list.length; i++){
                    ...
                    temp_video_element.setAttribute('style', 'height:"20px";width:51%;align:left;');
            ...
            if (desc_text.includes('clyp.it/')){
                ...
                temp_iframe.setAttribute('style', 'height:"100px";width:51%;align:left;');
            ...
            if(desc_text.includes("https://www.dropbox.com/s/")){
                ...
                for(var i = 1; i < links.length; i++){
                    ...
                    temp_audio_element.setAttribute('class', 'audio');
                    temp_audio_element.setAttribute("controls", "controls");
                    temp_audio_element.setAttribute('style', 'height:"150px";width:51%;align:left;');
            ...
            if(desc_text.includes("https://app.box.com/s/")){
                ...
                for(var i = 1; i < links.length; i++){
                    ...
                    temp_iframe.setAttribute('class', 'audio');
                    temp_iframe.setAttribute("controls", "controls");
                    temp_iframe.setAttribute('style', 'height:150px;width:51%;align:left;');
