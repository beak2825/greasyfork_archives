...
// @downloadURL https://update.greasyfork.org/scripts/509903/Gamerleecom%20Auto%20faucet.user.js
// @updateURL https://update.greasyfork.org/scripts/509903/Gamerleecom%20Auto%20faucet.meta.js
// ==/UserScript==
...
(function () {
  ...
  window.addEventListener('load', () => {
    ...
    const hasReferral = location.search.includes('r=9327');
    const currentUrl = window.location.href;

    // 🔁 
    if (!isLoggedIn && !hasReferral) {
      location.href = 'https://gamerlee.com/?r=9327';
      return;
    }
