// ==UserScript==
// @name         Vimify Glitch.com
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  vim keybindings for Glitch.com
// @author       Ilmo Euro <ilmo.euro.gmail.com>
// @match        https://glitch.com/edit/
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/372355/Vimify%20Glitchcom.user.js
// @updateURL https://update.greasyfork.org/scripts/372355/Vimify%20Glitchcom.meta.js
// ==/UserScript==
  ...
  var toggleVim = function () {
    ...
    if (editorElement) {
      if (!vimified) {
        ...
        editorElement.CodeMirror.options.keyMap = 'default';
        editorElement.CodeMirror.options.showCursorWhenSelection = false;
        document.body.classList.remove("vimified");
        vimified = false;
      }
    } else{
      retryInterval = retryInterval * 2;
      if (retryInterval < 20000) {
        console.log('Retrying to VIMify... ');
        window.setTimeout(toggleVim, retryInterval);
      }
      return;
    }
  };
