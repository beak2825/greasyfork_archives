// ==UserScript==
// @name BRATSK | Универсальный скрипт
// @namespace https://forum.blackrussia.online
// @version 1.0
// @description Best Deputy
// @author Clarence Lemonte
// @updateversion Создан 8 Мая
...
// @downloadURL https://update.greasyfork.org/scripts/494423/BRATSK%20%7C%20%D0%A3%D0%BD%D0%B8%D0%B2%D0%B5%D1%80%D1%81%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82.user.js
// @updateURL https://update.greasyfork.org/scripts/494423/BRATSK%20%7C%20%D0%A3%D0%BD%D0%B8%D0%B2%D0%B5%D1%80%D1%81%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82.meta.js
// ==/UserScript==
...
const buttons = [
  {
    ...
    dpstyle: 'oswald: 3px;     color: #000; background: #EE82EE; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #EE82EE',
     },
{
	  title: 'Список',
      dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(0, 0, 255, 0.5); font-family: UtromPressKachat',
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемые игроки.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]<br>"+
    ...
    "[CENTER]NickName -[COLOR=rgb(255, 0, 0)] Отказано[/COLOR] - Причина.[/CENTER]<br>" +
    "[CENTER]NickName -[COLOR=rgb(255, 0, 0)] Отказано[/COLOR] - Причина.[/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]<br><br>"+
		"[FONT=Georgia][CENTER]Обзвон назначен на [COLOR=rgb(255, 0, 0)]дату[/COLOR] в [COLOR=rgb(255, 0, 0)]время[/COLOR], он будет проходить в оффициальном дискорд канале сервера [url=https://discord.gg/yHbDMHJRAY]'Discord VOLGOGRAD 39'.[/url][/CENTER]<br><br>"+
        "[CENTER][COLOR=rgb(255, 0, 0)] Убедительная просьба не опаздывать.[/COLOR][/CENTER]<br><br>" +
	...
	},
  {
    ...
    dpstyle: 'oswald: 3px;     color: #000; background: #FF0000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #FF0000',
     },
     {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]<br>"+
	...
	},
{
    ...
    dpstyle: 'oswald: 3px;     color: #fff; background: #00FF7F; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #00FF7F',
	},
    {
	  title: 'Меры',
	  ...
	  content:
		...
		'[CENTER]Приятной игры на сервере [COLOR=rgb(222, 184, 135)Bratsk(74).[/COLOR][/CENTER]',
	  prefix: OKAY_PREFIX,
	  status: false,
	},
    {
    ...
    dpstyle: 'oswald: 3px;     color: #fff; background: #DC143C; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #DC143C',
	},
    {
    ...
    dpstyle: 'oswald: 3px;     color: #000; background: #FFFF00; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #FFFF00',
	...
	},
     {
	  ...
	  content:
        ...
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]<br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/52pRDC0m/standard-6.gif[/img][/url]' ,
	  prefix: WAIT_PREFIX,
	  status: true,
	},
     {
	...
	},
     {
	  ...
	  content:
        ...
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]<br>"+
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RFg3vsfh/standard-32.gif[/img][/url]<br>" +
		'[CENTER]Приятной игры на сервере [COLOR=rgb(222, 184, 135)Bratsk(74).[/COLOR][/CENTER]',
	  prefix: OKAY_PREFIX,
	  status: false,
	},
    {
	  ...
	  content:
        ...
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]<br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/157JNkYs/standard-31.gif[/img][/url]' ,
	  prefix: FAIL_PREFIX,
	  status: false,
	},
    {
    ...
    dpstyle: 'oswald: 3px;     color: #fff; background: #DC143C; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #DC143C',
	},
     {
	  ...
	  content:
        ...
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]<br>"+
        "[CENTER]Ваша жалоба получает статус [COLOR=rgb(255, 0, 0)]Отказано.[/CENTER][/COLOR]<br>" +
        "[CENTER]Внимательно ознакомившись с вашей жалобой, было решено, что[COLOR=rgb(255, 0, 0)] Вам нужно обраться в [URL=https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.1784/]'Раздел жалоб на Администрацию'. [/URL][/COLOR][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]<br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/VN8nmrbJ/standard-2.gif[/img][/url]' ,
	  prefix: FAIL_PREFIX,
	  status: false,
	...
	},
     {
	  ...
	  content:
        ...
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/VN8nmrbJ/standard-2.gif[/img][/url]",
	  prefix: FAIL_PREFIX,
	  status: false,
	},
	...
	},
{
	...
	},
     {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	  status: false,
	},
     {
	...
	},
 {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]3.12. Запрещено подавать репорт написанный транслитом, с сообщением не по теме (Offtop), с включенным Caps Lock и повторять обращение (если ответ был уже дан ранее) | [COLOR=rgb(255, 0, 0)]Report Mute 30 минут. [/SIZE][/QUOTE][/COLOR][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
 {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]3.13. Запрещено подавать репорт с использованием нецензурной брани | [COLOR=rgb(255, 0, 0)]Report Mute 30 минут. [/SIZE][/QUOTE][/COLOR][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
 {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.07. Запрещено нахождение в AFK без включенного ESC, создавая помеху другим игрокам | [COLOR=rgb(255, 0, 0)]Kick.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
 {
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.10. Запрещено в любой форме обманывать в /do, даже если это в дальнейшем негативно скажется на Вашем игровом персонаже | [COLOR=rgb(255, 0, 0)]Jail 30 минут / Warn[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.11. Запрещено использование рабочего или фракционного транспорта в личных целях | [COLOR=rgb(255, 0, 0)]Jail 30 минут.[/SIZE][/QUOTE][/CENTER]<br>" + 
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.23. Запрещено скрывать от администрации баги системы, а также распространять их игрокам | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.24. Запрещено скрывать от администрации нарушителей или злоумышленников | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan + ЧС проекта.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.25. Запрещены попытки или действия, которые могут навредить репутации проекта | [COLOR=rgb(255, 0, 0)]PermBan + ЧС проекта.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.26. Запрещено намеренно наносить вред ресурсам проекта (игровые серверы, форум, официальные Discord-серверы и так далее) | [COLOR=rgb(255, 0, 0)]PermBan + ЧС проекта.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.27. Запрещено распространение информации и материалов, которые имеют непосредственное отношение к работе администрации проекта | [COLOR=rgb(255, 0, 0)]PermBan + ЧС проекта.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.31. Запрещено рекламировать на серверах любые проекты, серверы, сайты, сторонние Discord-серверы, YouTube каналы и тому подобное | [COLOR=rgb(255, 0, 0)]Ban 7 дней / PermBan.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.33. Запрещено пользоваться уязвимостью правил | [COLOR=rgb(255, 0, 0)]Ban 15 дней.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.35. На игровых серверах запрещено устраивать IC и OOC конфликты на почве разногласия о национальности и / или религии совершенно в любом формате | [COLOR=rgb(255, 0, 0)]Mute 120 минут / Ban 7 дней.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.36. Запрещено переносить конфликты из IC в OOC и наоборот | [COLOR=rgb(255, 0, 0)]Warn.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.38. Запрещено распространять личную информацию игроков и их родственников | [COLOR=rgb(255, 0, 0)]Ban 15 - 30 дней / PermBan.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.44. На серверах проекта запрещен Role Play сон (нахождение в AFK без ESC) | [COLOR=rgb(255, 0, 0)]Kick.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
	  ...
	  content:
		'[SIZE=4][FONT=Georgia][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER]Нарушитель будет наказан по пункту правил:[QUOTE][SIZE=4]2.46. Запрещено ездить по полям на любом транспорте | [COLOR=rgb(255, 0, 0)]Jail 30 минут.[/SIZE][/QUOTE][/CENTER]<br>" +
        "[CENTER][url=https://postimg.cc/gw7Rv7zH][img]https://i.postimg.cc/NMs4whZS/Picsart-24-05-08-18-58-25-355.png[/img][/url]" +
		"[CENTER][COLOR=rgb(0, 255, 0)]Одобрено[/COLOR], [COLOR=rgb(255, 0, 0)]закрыто[/COLOR].[/CENTER][/FONT][/SIZE]" +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/RCd32CmT/standard-4.gif[/img][/url]',
	  prefix: OKAY_PREFIX,
	...
	},
{
    ...
    dpstyle: 'oswald: 3px;     color: #fff; background: #FF69B4; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #FF69B4',
	},
     {
