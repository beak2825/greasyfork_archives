...
// @downloadURL https://update.greasyfork.org/scripts/443987/elaw%27s%20iAm%20TC%20bot%20%28iAM%20V27%29.user.js
// @updateURL https://update.greasyfork.org/scripts/443987/elaw%27s%20iAm%20TC%20bot%20%28iAM%20V27%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function BotCommandCheck() {
        ...
        if (isCommand(arguments[1])) {
            ...
            } else if (arguments[1].match(/^!whoisbot$|^!8ball |^!banks$|^!modalert$ |^!coin$|^!social$|^!urb |^!guest$|^!dad$|^!P$|^!advice$/i)) {
