...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/36911/Bangumi%20Show%20Watching%20Days.user.js
// @updateURL https://update.greasyfork.org/scripts/36911/Bangumi%20Show%20Watching%20Days.meta.js
// ==/UserScript==
    ...
    if($('#browserItemList li.item')){
        ...
        itemsList.forEach( (elem, index) => {
            ...
            if(window.location.href.match(/\/list\/(\S+)\/do|on_hold/)){
                ...
                if(Time_do && !localStorage.getItem(User+'Time_do'+ID))
                ...
                if(Time_finish && !localStorage.getItem(User+'Time_finish'+ID)) localStorage.setItem(User+'Time_finish'+ID,Time_finish.textContent);
