...
// @downloadURL https://update.greasyfork.org/scripts/563716/zhangtengyue.user.js
// @updateURL https://update.greasyfork.org/scripts/563716/zhangtengyue.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "CUI MENGYUAN";
    const NEW_NAME = "ZHANG TENGYUE";
    const NEW_BIRTHDAY = "(**1223)";
    const NEW_EXPIRE_DATE = "2035-07-17";
