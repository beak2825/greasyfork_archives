// ==UserScript==
// @name Forum Curators | Novosibirsk
// @name:ru Кураторы Форума | Novosibirsk 
// @name:uk Куратори форуму | Novosibirsk
// @description  Suggestions for improving the script write here ---> https://vk.com/scrufe
// @description:ru Предложения по улучшению скрипта писать сюда --->  https://vk.com/scrufe
// @description:uk Пропозиції щодо покращення скрипту писати сюди ---> https://vk.com/scrufe
// @version 4.0.1
...
// @downloadURL https://update.greasyfork.org/scripts/454329/Forum%20Curators%20%7C%20Novosibirsk.user.js
// @updateURL https://update.greasyfork.org/scripts/454329/Forum%20Curators%20%7C%20Novosibirsk.meta.js
// ==/UserScript==
