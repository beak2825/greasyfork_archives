...
// @downloadURL https://update.greasyfork.org/scripts/26335/Fallen%20London%20stacker.user.js
// @updateURL https://update.greasyfork.org/scripts/26335/Fallen%20London%20stacker.meta.js
// ==/UserScript==
        ...
        layout: {
            apply: function() {
                mFL.c('style').set({type: "text/css",id: 'mFL_style'}).html('\
                    ul#cards.hand-size5 li { width: 81px;}\
