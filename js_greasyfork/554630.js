...
// @version      1.1
// @description  华医公共卫生自动化工具
// @author       BN_Dou
// @match        https://gwpx.91huayi.com/*
...
// @downloadURL https://update.greasyfork.org/scripts/554630/%E5%8D%8E%E5%8C%BB_%E5%85%AC%E5%85%B1%E5%8D%AB%E7%94%9F.user.js
// @updateURL https://update.greasyfork.org/scripts/554630/%E5%8D%8E%E5%8C%BB_%E5%85%AC%E5%85%B1%E5%8D%AB%E7%94%9F.meta.js
// ==/UserScript==
...
(function() {
        ...
        if (dialogBox && dialogBox.style.display === 'block') {
            ...
            if (courseIdMatch && courseIdMatch[1]) {
                ...
                if (updatedCourseIds.length > 0) {
                    ...
                    if (nextCourseId.BJY) {
                        window.location.href = `https://gwpx.91huayi.com/exercise/ExerciseCourse/BJYCoursePlay?courseware_id=${nextCourseId.id}`;
                    } else {
                        window.location.href = `https://gwpx.91huayi.com/exercise/ExerciseCourse/CoursePlay?courseware_id=${nextCourseId.id}`;
                    }
                } else {
                    // 先重定向到首页
                    window.location.href = 'https://gwpx.91huayi.com/exercise/ExerciseHome/index';
                }
            }
        }
    }
        ...
        if (isRunning === 1) {            
            ...
            if (currentUrl.includes('ExerciseHome/index')) {
                if (courseIds.length > 0) {
                    ...
                    if (course.BJY) {
                        window.location.href = `https://gwpx.91huayi.com/exercise/ExerciseCourse/BJYCoursePlay?courseware_id=${course.id}`;
                    } else {
                        window.location.href = `https://gwpx.91huayi.com/exercise/ExerciseCourse/CoursePlay?courseware_id=${course.id}`;
                    }
                } else {
                    // 显示完成弹窗
    ...
    function doExercise() {
        ...
        // 获取课程列表
        const url = "https://gwpx.91huayi.com/exercise/ExerciseCourse/GetLearnCourseList";
        const data = {
    ...
    function processExerciseData(courseData, progressMsg) {
        ...
        function processNextCourse() {
            ...
            const exerciseUrl = "https://gwpx.91huayi.com/exercise/ExerciseExam/SaveExerciseInfo";
            const exerciseData = {
