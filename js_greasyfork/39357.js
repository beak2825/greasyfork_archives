...
// @namespace InGame
// @downloadURL https://update.greasyfork.org/scripts/39357/Ladotogro.user.js
// @updateURL https://update.greasyfork.org/scripts/39357/Ladotogro.meta.js
// ==/UserScript==
...
$(document).ready( function() {
	function makeDollAppearsMap() {
		if (true === $('#meuble_171140').hasClass('ladotogros')) return;
		
		$('#meuble_' + id_meuble).css({	'background-position' : '0px',
										'background' : 'url("https://image.noelshack.com/fichiers/2018/10/5/1520634105-lado-pouf-map.png")'});
		...
		$('.infoBoxFixed').each( function() {
			if(true === RegExp('N°' + id_meuble, 'g').test($(this).html())) {
				...
				$(this).find('.conteneur_image_small div:eq(0)').css({	'width' : '230px',
																		...
																		'top' : '0px',
																		'left' : '0px',
																		'background' : 'url("https://image.noelshack.com/fichiers/2018/10/5/1520633322-lado-pouf-3.png"'});
			}
		});
	}
