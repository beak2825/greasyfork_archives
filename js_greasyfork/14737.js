// ==UserScript==
// @name        Not bloomed - Late bloomer - 6 TI - 7 TI
...
// @grant        all
// @downloadURL https://update.greasyfork.org/scripts/14737/Not%20bloomed%20-%20Late%20bloomer%20-%206%20TI%20-%207%20TI.user.js
// @updateURL https://update.greasyfork.org/scripts/14737/Not%20bloomed%20-%20Late%20bloomer%20-%206%20TI%20-%207%20TI.meta.js
// ==/UserScript==
                 ...
                 function return_starting_blooming(Last_Season_Avg_Ti,Season_Avg,SI,age)
                        {var Age = parseInt(age);
                         ...
                         if ((Last_Season_Avg_Ti < 9) && (Last_Season_Avg_Ti > -1))
                             if ((Season_Avg < 8) && (Season_Avg > 6))
                                 if ((SIN > 1000) && (SIN < 8000))
                                     return "YES" ;
                                 else
                                     return "----";
                            else
