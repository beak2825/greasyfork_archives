...
// @downloadURL https://update.greasyfork.org/scripts/501104/BLACK%20RUSSIA%20PINK%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/501104/BLACK%20RUSSIA%20PINK%20%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.meta.js
// ==/UserScript==
...
(function () {
    ...
    const RESHENO_PREFIX = 13; // Префикс "Решено"
    const PIN_PREFIX = 15; // Префикс "На рассмотрении"
    const GA_PREFIX = 13; // Префикс "Главному Администратору"
    const COMMAND_PREFIX = 11; // Префикс "Команде Проекта"
    const WATCHED_PREFIX = 13; // Префикс "Рассмотрено"
    const CLOSE_PREFIX = 5; // Префикс "Закрыто"
    const SPECIAL_PREFIX = 12; // Префикс "Специальному Администратору"
    const buttons = [
        {
            title: '---------------------------------------------------------------> Раздел Жалоб <---------------------------------------------------------------',
        },
 ...
 "[FONT=courier new][B][CENTER][COLOR=WHITE]С уважением, [/COLOR][COLOR=RED]Куратор Администрации[/COLOR] - [COLOR=PURPLE] [I] Artyom_Hayes.<br>"+
        ...
        },
        {
            ...
            "[FONT=courier new][B][CENTER][COLOR=WHITE]С уважением, [/COLOR][COLOR=RED]Куратор Администрации[/COLOR] - [COLOR=PURPLE] [I] [SIZE=4] Artyom_Hayes.<br>"+
