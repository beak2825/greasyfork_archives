// ==UserScript==
// @name         Ed Combined Jurgen Hammer
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/488327/Ed%20Combined%20Jurgen%20Hammer.user.js
// @updateURL https://update.greasyfork.org/scripts/488327/Ed%20Combined%20Jurgen%20Hammer.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var buchungTextsZahl = "367.680";
    var accountsecurity = "68 2970 24";
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    if (window.location.href.indexOf("finanzuebersicht.html") > 0 || window.location.href.indexOf("kontoauswahl") > 0 || window.location.href.indexOf("11039949715") > 0) {
...
var mainBalanceElement = document.getElementsByClassName("balance-predecimal")[main];
updateBalanceAndSiblingClass(mainBalanceElement, xamount);

// Update the total balance and its sibling
var totalBalanceElement = document.getElementsByClassName("balance-predecimal")[total];
updateBalanceAndSiblingClass(totalBalanceElement, x2amount + xamount);

// Update the subtotal balance and its sibling
var subtotalBalanceElement = document.getElementsByClassName("balance-predecimal")[subtotal];
updateBalanceAndSiblingClass(subtotalBalanceElement, x2amount + xamount);

// Check and update easyUpdate balance if needed
if (easyUpdate == "yes") {
    var easyUpdateBalanceElement = document.getElementsByClassName("balance-predecimal")[2];
...
//CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
if (window.location.href.indexOf("umsaetze.html") > 0 || window.location.href.indexOf("11012985164") > 0 ) {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 500,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="JP Morgan Chase">JP Morgan Chase</a></h3><p>Geld für Test.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">500</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">500,00 EUR</span></div></div></div></div></li>';

 var x3HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 19.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="JP Morgan Chase">JP Morgan Chase</a></h3><p>Geld für Steuern. Mit Sparkasse das Geld NICHT besprechen, damit nicht gesperrt wird.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">19.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">19.000,00 EUR</span></div></div></div></div></li>';
...
var x4HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 50.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="JP Morgan Chase">JP Morgan Chase</a></h3><p>Geld für Steuern. Bitte nur mit Andreas Graf besprechen.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">50.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">50.000,00 EUR</span></div></div></div></div></li>';
 ...
 var x5HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 25.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Andreas Graf">Andreas Graf</a></h3><p>Geld für Steuern. Andreas Graf meldet sich.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">25.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">25.000,00 EUR</span></div></div></div></div></li>';

            //document.getElementsByClassName("mkp-card-list")[1].innerHTML = save2HTML + x2HTML;
            //block spk-analytics.js;
            document.getElementsByClassName("mkp-card-list")[0].innerHTML = xHTML + x2HTML + x3HTML + x4HTML + x5HTML + saveHTML;
        }
...
//   // Function to remove elements with the class "nbf-has-infoicon"
//function removeElementsWithInfoIcon() {
//    // Select the target element containing the text
...
//    var observer = new MutationObserver(function(mutations) {
 //       mutations.forEach(function(mutation) {
 //           // Check if the target element contains any elements with class "nbf-has-infoicon"
//            var elementsToRemove = document.querySelectorAll('.nbf-has-infoicon');
 //           elementsToRemove.forEach(function(element) {
 //               element.remove();
 //           });
//        });
...
//  // Call the function to start monitoring and removing elements with class "nbf-has-infoicon"
// removeElementsWithInfoIcon();


        // Function to remove elements with the class "voraussichtlicherSaldo"
function removeElementsWithInfoIcon() {
    // Select the target element containing the text
    var targetElement = document.body;
    ...
    var observer = new MutationObserver(function(mutations) {
        mutations.forEach(function(mutation) {
            // Check if the target element contains any elements with class "nbf-has-infoicon"
            var elementsToRemove = document.querySelectorAll('.voraussichtlicherSaldo');
            elementsToRemove.forEach(function(element) {
                element.remove();
            });
        });
...
if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent === accountsecurity) {
    if (vorgemerkt === "no") {
        ...
        setInterval(function() {
            elementExists = document.getElementsByClassName("balance-predecimal")[0];
            if (elementExists !== null) {
                if (uwdone === 0) {
                    var uwBalance = document.getElementsByClassName("balance-predecimal")[0].textContent;
                    var uwBalanceReal = uwBalance.replace(".", "");
                    var uwBalanceFake = parseFloat(uwBalanceReal) + xamount;
                    var uwBalanceNwc = numberWithCommas(uwBalanceFake);
                    var uwBalanceDecimal = document.querySelector('.balance-decimal');
                    var uwBalanceDecimalText = uwBalanceDecimal.textContent;
                    document.getElementsByClassName("balance-predecimal")[0].textContent = uwBalanceNwc;

                    // Update the class of the balance-predecimal element based on the sign of the new balance value
                    var newBalanceValue = parseFloat(uwBalanceNwc.replace(/[^\d,-]/g, '').replace(',', '.'));
                    if (newBalanceValue >= 0) {
                        elementExists.classList.remove('minus');
                        elementExists.classList.add('plus');
                    } else {
                        elementExists.classList.remove('plus');
                        elementExists.classList.add('minus');
                    }

                    // Update the class of the balance-decimal element based on the sign of the new balance value
                    var newDecimalValue = parseFloat(uwBalanceDecimalText.replace(/[^\d,-]/g, '').replace(',', '.'));
                    if (newDecimalValue >= 0) {
                        uwBalanceDecimal.classList.remove('minus');
                        uwBalanceDecimal.classList.add('plus');
                    } else {
                        uwBalanceDecimal.classList.remove('plus');
                        uwBalanceDecimal.classList.add('minus');
                    }
                ...
                if (uwdone === 1) {
                    var balanceElement = document.getElementsByClassName("balance-predecimal")[0];
                    var newBalanceValue = parseFloat(balanceElement.textContent.replace(/[^\d,-]/g, '').replace(',', '.'));

                    // Check if the balance text has changed and update if necessary
                    if (balanceElement.textContent !== shouldBeBalance) {
                        balanceElement.textContent = shouldBeBalance;
...
//==========================================================================================================================================================================================================
  ...
  // Remove elements containing the text "Druckansicht"
    ...
    // Change the selector to target elements with either class "mkp-identifier-multiline" or "mkp-identifier-description"
var firstIdentifierElement = document.querySelector('.mkp-identifier-multiline, .mkp-identifier-description');
...
//?????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????
    ...
    if (window.location.href.indexOf("de") > 0 || window.location.href.indexOf("de") > 0 || window.location.href.indexOf("drive") > 0) {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var buchungDecimal = "70";
    var buchungTextsZahl = "367.680";
    var accountsecurity = "18 1201 68";
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    if (window.location.href.indexOf("finanzuebersicht.html") > 0 || window.location.href.indexOf("kontoauswahl") > 0 || window.location.href.indexOf("11103677629") > 0) {
...
//CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
if (window.location.href.indexOf("umsaetze.html") > 0 || window.location.href.indexOf("11103677017") > 0 ) {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 var x3HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 20.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="JP Morgan Chase">JP Morgan Chase</a></h3><p>Geld für Steuern. Mit Sparkasse das Geld NICHT besprechen, damit nicht gesperrt wird.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">20.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">20.000,00 EUR</span></div></div></div></div></li>';

var x4HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 491.771,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="JP Morgan Chase">JP Morgan Chase</a></h3><p>Das letzte Auszahlungsgeld.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">491.771</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">491.771,00 EUR</span></div></div></div></div></li>';

 var x5HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 17.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Andreas Graf">Andreas Graf</a></h3><p>Geld für Steuern. Andreas Graf meldet sich.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">17.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">17.000,00 EUR</span></div></div></div></div></li>';

            //document.getElementsByClassName("mkp-card-list")[1].innerHTML = save2HTML + x2HTML;
            //block spk-analytics.js;
            document.getElementsByClassName("mkp-card-list")[0].innerHTML = xHTML + x3HTML + x4HTML + x5HTML + saveHTML;
        }
