// ==UserScript==
// @name         Extension Clan Tк◈|Private Extension
...
// @connect      agar.io
// @downloadURL https://update.greasyfork.org/scripts/23137/Extension%20Clan%20T%D0%BA%E2%97%88%7CPrivate%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/23137/Extension%20Clan%20T%D0%BA%E2%97%88%7CPrivate%20Extension.meta.js
// ==/UserScript==
 
// Copyright © 2016 ogario.ovh
 
if (location.host == "agar.io" && location.pathname == "/") {
    location.href = "http://agar.io/ClanTк◈" + location.hash;
    return;
}
...
function inicio() {
    document.title = "CLAN Tк◈";
    modificarTextoMinimapa("By iEazy & Brayan");
    modificarTextoLeaderboard("CLAN Tк◈");
    modificarCanalYoutube("Suscribanse al canal", "UC52JW6d475jx7izciHkfZCA");
    modificarFooter("Visita el grupo del CLAN Ƥк◈", "https://www.facebook.com/groups/1078997128856095");
    panelDerecho();
    ...
    $("#clantag").attr("placeholder", "tag Tк◈");
 
    setTimeout(function() {
        alert("Bienvenido al CLAN Tк◈ Creador por iEazy & Brayan");
    }, 2000);
