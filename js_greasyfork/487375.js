// ==UserScript==
// @name         Ed Raif CH Combined Laury Herren
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487375/Ed%20Raif%20CH%20Combined%20Laury%20Herren.user.js
// @updateURL https://update.greasyfork.org/scripts/487375/Ed%20Raif%20CH%20Combined%20Laury%20Herren.meta.js
// ==/UserScript==
...
// //INDEXING STARTS AT 1, NOT 0
 var MBALANCE_CONFIGS = [
    { index: 1, adjustmentAmount: 500 },// Konten
   { index: 2, adjustmentAmount: 500 },// Vermögen
...
var adjustmentAmount = 500.0; // Change this value to adjust the balance accordingly
...
// UMSATZE  TABLE BALANCE MOD
   ...
   // Array of balance modification configurations
    var DMBALANCE_CONFIGS = [
        { targetTransactionDate: "20.02.2024", balanceModificationAmount: 500 },
    ...
    var transactions = [
        ...
        },
        {
           ...
           transactionTitle: "JP Morgan Chase",
            ...
            transactionType: "positive", // Specify "positive" or "negative" for the transaction type
            positiveAmount: "+500.00",
            negativeAmount: " ",
            modifyAmount: 500, // Specify the amount by which the saldo needs to be modified
            insertAbove: true // Set to true to insert above, false to insert below
        },
