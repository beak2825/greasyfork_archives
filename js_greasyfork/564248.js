...
// @version      0.0.2
// @description  Gcores 增强
// @license      mit
// @icon         https://vitejs.dev/logo.svg
// @match        https://www.gcores.com/*
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/564248/gcores-enhance.user.js
// @updateURL https://update.greasyfork.org/scripts/564248/gcores-enhance.meta.js
// ==/UserScript==
...
(function () {
  ...
  function FullscreenButton() {
    ...
    return jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: isFullscreen ? jsxRuntimeExports.jsx(
          "svg",
          {
            width: "18",
            height: "18",
            ...
            style: { display: "block" },
            children: jsxRuntimeExports.jsx("path", { d: "M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3" })
          }
          ...
          "svg",
          {
            ...
            strokeLinejoin: "round",
            style: { display: "block" },
            children: jsxRuntimeExports.jsx("path", { d: "M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3" })
          }
        )
      }
    );
  ...
  function patchedSetActionHandler(action, handler) {
    if (action === "previoustrack" || action === "nexttrack") {
      console.log("patchedSetActionHandler", action, handler);
      return;
    }
  ...
  function setupMediaControl() {
    ...
    originalSetActionHandler("previoustrack", () => {
      const audio = document.querySelector("audio");
      if (audio) {
        audio.currentTime = Math.max(0, audio.currentTime - 30);
      }
    });
    originalSetActionHandler("nexttrack", () => {
      const audio = document.querySelector("audio");
      if (audio) {
