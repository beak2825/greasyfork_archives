...
// @name           BvS BillyMaze
// @namespace      rvMaze
// @description    Remembers your moves in the BillyMaze
// @include        http*://*animecubed.com/billy/bvs/festival.html
// @include        http*://*animecubedgaming.com/billy/bvs/festival.html
// @version        1.1.2
// @history        1.1.2 New domain - animecubedgaming.com - Channel28
// @history        1.1.1 (5/19/2017) Now https compatible (by Channel28)
// @history        1.1.0 (1/11/2015) Chrome Suppport (by North)
// @history        1.0.9 (9/11/2014) Added Family Autograph Bonus. (by Channel28)
// @history        1.0.8 (9/9/2014) Added grant permissions.
// @history        1.0.7 (7/16/2012) Shortened texts to find on page
...
// @grant          GM_setValue
// @grant          GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/4327/BvS%20BillyMaze.user.js
// @updateURL https://update.greasyfork.org/scripts/4327/BvS%20BillyMaze.meta.js
// ==/UserScript==
...
function load(e) {
	try {
		var snap = document.evaluate("//table[@bgcolor='FFFFDD']//td/b/i/text()", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
...
function parsePage() {
	...
	if (match = mainText.match("your ancestors are calling to you, from the (\\w+) exit"))
		correctDirection = match[1];
...
function attachEventToForm(element, eventfunction) {
	...
	var snap = document.evaluate("//a[@href='javascript:document." + formName + ".submit();']", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE, null);
	for (var i = 0; i < snap.snapshotLength; i++) {
		var a = snap.snapshotItem(i);
		a.href = '#';
