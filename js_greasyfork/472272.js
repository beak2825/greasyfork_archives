// ==UserScript==
// @name         Скрипт для Кураторов Форума || SARATOV
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/472272/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%7C%20SARATOV.user.js
// @updateURL https://update.greasyfork.org/scripts/472272/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%7C%20SARATOV.meta.js
// ==/UserScript==
...
const buttons = [
{
	  title: '✅️✅️ Доступность кураторам форума ✅️✅️'
},
{
	  title: 'DM',
	  content:
		 "[B][CENTER][FONT=times new roman][COLOR=lavender][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/FONT][/CENTER][/B]<br><br>" +
...
},
{
	  ...
	  content:
		"[B][CENTER][FONT=times new roman][COLOR=lavender][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/FONT][/CENTER][/B]<br><br>" +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
        "[B][CENTER][COLOR=lavender][FONT=times new roman][Color=#ff0000]6.02.[/color] Запрещено выдавать розыск без Role Play причины[Color=#ff0000]| Warn // Jail 30[/color].[/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][FONT=times new roman][COLOR=#ccff00]Одобрено.[/COLOR]<br><br>",
      prefix: ACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		"[B][CENTER][FONT=times new roman][COLOR=lavender][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/FONT][/CENTER][/B]<br><br>" +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
        "[B][CENTER][COLOR=lavender][FONT=times new roman][Color=#ff0000]7.02.[/color] Запрещено выдавать штраф без Role Play причины [Color=#ff0000]| Warn // Jail 30[/color].[/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][FONT=times new roman][COLOR=#ccff00]Одобрено.[/COLOR]<br><br>",
      prefix: ACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		"[B][CENTER][FONT=times new roman][COLOR=lavender][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/FONT][/CENTER][/B]<br><br>" +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
        "[B][CENTER][COLOR=lavender][FONT=times new roman][Color=#ff0000]7.04.[/color] Запрещено отбирать водительские права без Role Play причины [Color=#ff0000]| Warn // Jail 30[/color].[/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][FONT=times new roman][COLOR=#ccff00]Одобрено.[/COLOR]<br><br>",
      prefix: ACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		"[B][CENTER][FONT=times new roman][COLOR=lavender][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/FONT][/CENTER][/B]<br><br>" +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
        "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]7.04.[/color] Запрещено отбирать водительские права во время погони за нарушителем [Color=#ff0000]| Warn // Jail 30[/color].[/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][FONT=times new roman][COLOR=#ccff00]Одобрено.[/COLOR]<br><br>",
      prefix: ACCСEPT_PREFIX,
	  status: false,
},
...
},
{
	  ...
	  content:
		"[B][CENTER][FONT=times new roman][COLOR=lavender][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/FONT][/CENTER][/B]<br><br>" +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
        "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]8.05.[/color] Запрещено проводить обыск игрока без Role Play отыгровки и причины[Color=#ff0000]| Warn[/color].[/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][FONT=times new roman][COLOR=#ccff00]Одобрено.[/COLOR]<br><br>",
      prefix: ACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		"[B][CENTER][FONT=times new roman][COLOR=lavender][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/FONT][/CENTER][/B]<br><br>" +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
        "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]6.03.[/color] Запрещено оказывать задержание без Role Play отыгровки [Color=#ff0000]| Warn // jail 30 минут[/color].[/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][FONT=times new roman][COLOR=#ccff00]Одобрено.[/COLOR]<br><br>",
      prefix: ACCСEPT_PREFIX,
	  status: false,
},
...
{
	  title: '✅️✅️✅️✅️✅️✅️ На рассмотрение ✅️✅️✅️✅️✅️✅️'
},
{
...
{
      title: '✅️✅️✅️✅️ Перенаправление жалоб ✅️✅️✅️✅️'
},
{
	  title: 'В ЖБ на Адм.',
	  content:
...
{
	  title: '✅️✅️✅️✅️✅️ Наказания для ФА ✅️✅️✅️✅️✅️'
},
{
	  title: 'Неадекват',
	  content:
...
{         title: 'Нарушение подачи',
          content:
		"[B][CENTER][FONT=times new roman][COLOR=lavender][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/FONT][/CENTER][/B]<br><br>" +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Ваша жалоба нарушает правила подачи жалоб на игроков, при повторном нарушении вы можете получить наказание на свой Форумный Аккаунт.<br><br>"+
        "[B][CENTER][FONT=times new roman][COLOR=#ff0000]Отказано.[/COLOR]<br><br>",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
},
{
  ...
  {
    	  title: '✅️✅️✅️✅️✅️ RolePlay Биографии ✅️✅️✅️✅️✅️'
},
{
