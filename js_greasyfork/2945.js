// ==UserScript==
// @name            Hack Forums Add to Group - Archive
// @namespace       Snorlax
// @description     Adds people to groups
// @require         http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js
// @include         *hackforums.net/member.php?action=profile&uid=*
// @version         1.3.4
// @downloadURL https://update.greasyfork.org/scripts/2945/Hack%20Forums%20Add%20to%20Group%20-%20Archive.user.js
// @updateURL https://update.greasyfork.org/scripts/2945/Hack%20Forums%20Add%20to%20Group%20-%20Archive.meta.js
// ==/UserScript==

var uid = $(location).attr('href').replace(/[^0-9]/g, '')
var name = $("span[class*='group']").text();

if($("img[src*='archive']").length >= 1) {
