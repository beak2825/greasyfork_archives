// ==UserScript==
// @name ORPH Populate Label Collage
// @namespace orpheus.network
// @description Finds missing releases in label collages
// @version 1.0.2
// @match https://*.orpheus.network/collage*.php*id=*
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/374393/ORPH%20Populate%20Label%20Collage.user.js
// @updateURL https://update.greasyfork.org/scripts/374393/ORPH%20Populate%20Label%20Collage.meta.js
// ==/UserScript==
var ORIGINAL = 0;
var REMASTER = 1;
// Ajax handler
...
var urls = [];
var base = 'https://orpheus.network/torrents.php?id=';
var elems = dom.qsa('.group input', table);
for (var i = elems.length; i--; ) {
