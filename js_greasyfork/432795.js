...
// @namespace    Nothing
// @version      NiGgEr
// @description  Nothing U nigger also check out my other OP mod called FuCk MoD
...
// @downloadURL https://update.greasyfork.org/scripts/432795/~%21%20PYTHON%20MOD%20%21~.user.js
// @updateURL https://update.greasyfork.org/scripts/432795/~%21%20PYTHON%20MOD%20%21~.meta.js
// ==/UserScript==
...
var ctr, global_id; (async () => {
    ...
    var INT = setInterval(()=>{
        if (switched == 1) {
            ...
            , kBS = 76
            , kBM = 79
            , aChat = "PYTHON THE NIGGER"
            , acBool = !1
            , acFill = "-"
            , iChat = "PYTHON THE NIGGER"
            , icBool = !1
            , rChat = "NOGGER 100%"
            , ezBool = !1
            , ezChat = "BYEEE NIGGER"
...
`;
            ...
            const connectBot = code => {
                ...
                botws.onopen = async () => {
                    ...
                    await wait(100);
                    botws.emit(['sp', [{ name: 'NiGgEr jr', moofoll: '1', skin: "__proto__" }]]);

                    botws.emit(["8", [genRand("Nigger ")]]);
                    botws.healON = true;
                    setInterval(()=>{
