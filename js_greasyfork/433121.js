...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/433121/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.user.js
// @updateURL https://update.greasyfork.org/scripts/433121/Krunker%20%20Dogeware%20-%20by%20The%20Gaming%20Gurus.meta.js
// ==/UserScript==
                    ...
                    if (this.settings.fovbox) {
                        ...
                        for (let i = 0; i < targets.length; i++) {
                            ...
                            switch (this.settings.fovBoxSize) {
                                    // medium
                                case 2:
                                    fovBox = [width * 0.2, height / 3, width * 0.1, height / 3]
                                    break
                                    // small
                                case 3:
