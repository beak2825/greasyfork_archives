...
// @downloadURL https://update.greasyfork.org/scripts/411216/Check%20Yth%20Pulls%20Feed%20V3.user.js
// @updateURL https://update.greasyfork.org/scripts/411216/Check%20Yth%20Pulls%20Feed%20V3.meta.js
// ==/UserScript==
...
function iniz_form() {
  ...
  div_area.innerHTML =
    '<div style="position: absolute; z-index: 1;background-color: #4e7525 ; width: 186px; height: 120px; margin-top: 60px; color: white;  outset; display:inline;"><table id = \'table\' style="margin-top: -1em; margin-bottom: 1em; position:relative; top:0px;left:5px">&nbsp;<tr><td>Done: </td><td>' +
    "" +
...
function runCheck(leauges_array) {
  for (var i = 0; i < leauges_array.length; i++) {
    Promises_Array.push(request(leauges_array[i]));
  }
}
...
function BuildResult(ids_array) {
  div_area.innerHTML =
    '<div style="position: absolute; z-index: 1;background-color: #4e7525 ; width: 186px; height: 550px; margin-top: 60px; color: white;  outset; display:inline;"><table id = \'table\' style="margin-top: -1em; margin-bottom: 1em; position:relative; top:0px;left:5px">&nbsp;<tr><td>Done: </td><td>' +
    "YES" +
    " </td></tr><tr><td>IDs: </td><td> " +
    "</td></tr>      </table></b></div>";
