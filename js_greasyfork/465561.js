...
// @version      0.1.1
// @description  pms 快速选择项目
// @author       HolmesZhao
// @match        *://pms.zuoyebang.cc/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=zuoyebang.cc
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/465561/PMS%20%E5%BF%AB%E9%80%9F%E9%80%89%E6%8B%A9%E9%A1%B9%E7%9B%AE.user.js
// @updateURL https://update.greasyfork.org/scripts/465561/PMS%20%E5%BF%AB%E9%80%9F%E9%80%89%E6%8B%A9%E9%A1%B9%E7%9B%AE.meta.js
// ==/UserScript==
...
(function() {
    ...
    const buttonConfigs = [
        { text: '我的需求', color: 'white', data: { business_id: 'MB_MB', business_name: '喵宝' }, url: `http://pms.zuoyebang.cc/head/ReqList?issueId=112965&issueType=%E9%9C%80%E6%B1%82&jira_project_id=12993` },
        { text: '喵宝 BugList', color: 'white', data: { business_id: 'MB_MB', business_name: '喵宝' }, url: `http://pms.zuoyebang.cc/head/BugListPage?currentPage=1` },
        { text: '作业帮智能 BugList', color: 'white', data: { business_id: 'HARDWAER_HARDWAER', business_name: '创新硬件' }, url: `http://pms.zuoyebang.cc/head/BugListPage?currentPage=1` },
        { text: '喵喵机发版页面', color: 'white', data: { business_id: 'MB_MB', business_name: '喵宝' }, url: `http://pms.zuoyebang.cc/head/SprintList?jira_project_id=12993&currentPage=1` },
        { text: '国际版喵喵机发版页面', color: 'white', data: { business_id: 'MB_MB', business_name: '喵宝' }, url: `http://pms.zuoyebang.cc/head/SprintList?jira_project_id=13243&currentPage=1` },
        { text: '作业帮智能 app 发版页面', color: 'white', data: { business_id: 'HARDWAER_HARDWAER', business_name: '创新硬件' }, url: `http://pms.zuoyebang.cc/head/SprintList?jira_project_id=13808&currentPage=1` },
    ];
