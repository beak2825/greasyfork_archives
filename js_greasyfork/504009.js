...
// @namespace    https://bereavednickel7.com
// @version      0.1.1
...
// @downloadURL https://update.greasyfork.org/scripts/504009/casesGG%20-%20Check%20tickets.user.js
// @updateURL https://update.greasyfork.org/scripts/504009/casesGG%20-%20Check%20tickets.meta.js
// ==/UserScript==
...
(function() {
    ...
    async function fetchData() {
        ...
        if (window.location.href.indexOf("battle") === -1 || window.location.href === "https://cases.gg/csgo-case-battles") {
            return;
        }
        let currentLink = window.location.href;
        let battleLink = currentLink.toString().replace("https://cases.gg/csgo-case-battles/", "");
        let battleUrl = "/api/battles/"+battleLink+"/details/";
        if (currentLink.toString().includes("password")){
            let password = currentLink.toString();
            password = password.replace("https://cases.gg/csgo-case-battles/", "")
