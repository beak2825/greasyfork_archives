// // ==UserScript==
// @name         SOCHI | Script for forum by Tsoy
...
// @downloadURL https://update.greasyfork.org/scripts/468295/SOCHI%20%7C%20Script%20for%20forum%20by%20Tsoy.user.js
// @updateURL https://update.greasyfork.org/scripts/468295/SOCHI%20%7C%20Script%20for%20forum%20by%20Tsoy.meta.js
// ==/UserScript==
...
const buttons = [
      ...
      title: '|',
      content:
        '[SIZE=4][COLOR=rgb(0, 255, 255)][I][FONT=times new roman]Доброго времени суток, уважаемый {{ user.mention }}.[/FONT][/I][/COLOR][/SIZE]',
    },
    {
      title: 'DM',
      content:
...
"[COLOR=rgb(255, 0, 0)][SIZE=4]2.16. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещен SK (Spawn Kill) — убийство или нанесение урона на титульной территории любой фракции / организации, на месте появления игрока, а также на выходе из закрытых интерьеров и около них[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Jail 60 минут / Warn (за два и более убийства) [/SIZE][/COLOR]<br>" +
    ...
    },
    {
      ...
      content:
        ...
        "[FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]6.03. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]7.02. Запрещено выдавать розыск, штраф без Role Play причин[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Warn[/SIZE][/COLOR][/FONT]<br><br>" +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA RolePlay.[/SIZE][/FONT][/COLOR]<br><br>" +
        '[COLOR=rgb(0, 255, 255)][FONT=times new roman][SIZE=4]Одобрено.[/SIZE][/FONT][/COLOR][/I][/CENTER]',
      prefix: ACCEPT_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        ...
        "[COLOR=rgb(209, 213, 216)]Внимательно прочитайте правила создания RP - биографий - [/COLOR][/I][COLOR=rgb(209, 213, 216)][URL='https://forum.blackrussia.online/index.php?threads/sochi-%D0%A4%D0%BE%D1%80%D0%BC%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-rp-%D0%91%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.2368162/']*Нажмите сюда*[/URL][/COLOR][/FONT][/SIZE]<br><br>" +
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)]Sochi[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
