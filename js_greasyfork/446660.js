// ==UserScript==
// @name         Tetris Madness Theme
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  Tetris Madness theme for Jstris
// @author       Oki, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/446660/Tetris%20Madness%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/446660/Tetris%20Madness%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/5T77PM0.png",40);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/2yn0GSr.png')";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_lock.wav",abs:1};
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/blank.wav",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/blank.wav",abs:1,set:0};
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/blank.wav",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/blank.wav",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/blank.wav",abs:1,set:0};
    this.comboTones={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/blank.wav",abs:1,set:2,duration:2500,spacing:500,cnt:8};
    this.linefall={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",abs:1,set:0};
...
function atGameStart() {
    ...
    img.onload = function(){
        ...
        bgctx.drawImage(img,2,75,560,499*(608/518)); // Or at whatever offset you like
    };
    img.src = "https://i.imgur.com/fTJfX4V.png";
...
queueCopy0.style.transform="scale(0.75,0.75) translate(36px, -10px)"
queueCopy1.style.transform = "scale(.7,.7) translate(35px, 10px)"
queueCopy2.style.transform = "scale(0.7,0.7) translate(35px, 33px)"
queueCopy3.style.transform = "scale(0.7,0.7) translate(42px, 60px)"
queueCopy4.style.transform = "scale(0.7,0.7) translate(40px, 80px)"


holdCanvas.style.float = "none"
holdCanvas.style.position = "absolute"
holdCanvas.style.transform = "scale(0.75,0.75)"
holdCanvas.style.top = "-5px"
holdCanvas.style.left = "-20px"
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",
...
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",   //no sound exists for TB
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/madness_linefall.wav"
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/madnessmusic.ogg",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/madnessmusic.ogg"
