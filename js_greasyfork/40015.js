...
// @name        Rückspielbutton AT
// @include     http://fussballcup.at/*
// @version    	0.1
// @description Zeigt "Rückspielbutton" auf der Startseite!
// @author 	Philipp, edited by mot33 / 2016
// @connect <value>
// @namespace https://greasyfork.org/users/83290
// @downloadURL https://update.greasyfork.org/scripts/40015/R%C3%BCckspielbutton%20AT.user.js
// @updateURL https://update.greasyfork.org/scripts/40015/R%C3%BCckspielbutton%20AT.meta.js
// ==/UserScript==
	...
	function scheduleSimGame(playerId){
		findSquad(playerId, function(squadId){
			if(squadId == -1){
				...
				// request game
				window.location.href = '#/index.php?area=user&module=simulation&action=index&leagues=19&squad=' + squadId + '&_=1470592297';
				// go to homepage
