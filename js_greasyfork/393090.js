...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/393090/Blobleio%20NoobScript%20V3%20QuickSelect%20Fragment.user.js
// @updateURL https://update.greasyfork.org/scripts/393090/Blobleio%20NoobScript%20V3%20QuickSelect%20Fragment.meta.js
// ==/UserScript==
    ...
    if (a === 81) { // All troops except commander
        ...
        units.forEach((unit) => {
            if (unit.owner === player.sid && unit.type === 1) {
                ...
                unit.info.name !== 'Commander,Siege Ram' && selUnits.push(unit)
