// ==UserScript==
// @name         Ed 4Rec  vb.klaus_gruenewald@t-online.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/537543/Ed%204Rec%20%20vbklaus_gruenewald%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/537543/Ed%204Rec%20%20vbklaus_gruenewald%40t-onlinede.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  9500},
        { index: 1, adjustmentAmount:  9500},
        { index: 2, adjustmentAmount:  57},
        { index: 3, adjustmentAmount: 9500},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    // Define the target text content to search for (case and whitespace insensitive)
       var targetTextContent1 = "DE83 5409 0000";
       var targetTextContent2 = " 0055 0858 97";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 9500; // Adjust the amount as needed
...
(function() {
    ...
    // Define the target text content to search for (case and whitespace insensitive)
    var targetTextContent1 = "DE02 5409 0000";
    var targetTextContent2 = " 0055 0858 03";
