...
// @downloadURL https://update.greasyfork.org/scripts/415929/MW%20Rave%20Plug-in.user.js
// @updateURL https://update.greasyfork.org/scripts/415929/MW%20Rave%20Plug-in.meta.js
// ==/UserScript==
(function() {
    'use strict';
    //debugger;
 ...
 var initialResponse = function () {
     ...
     var Soap = function () {
        ...
        var exec = function () {
            var caseController = angular.element($('#breadcrumb')).data().$scope.caseController
                var blank = ""
                var irTemplate = '<div><span>Problem Description '+ blank + '</span><div></div><div>========================'+ blank +'<br></span><div><br></div><div>Object'+blank+ '</span><div></div><div>========================'+ blank+'<br></div><div><br></div><div>Troubleshooting and Analysis'+blank+ '</span><div></div><div>========================'+ blank+'<br></div><div><br></div><div>Next Plan'+blank+ '</span><div></div><div>========================'+ blank
                //$('#emailComposeBox').prepend(irTemplate)
    ...
    var openCasenumber = function () {
        ...
        var exec = function (tag) {
            ...
            window.open('http://purussvr.fareast.corp.microsoft.com/PurusReview/ReviewDetails.aspx?ticket='+Casenumber)
        }
        return {
            'init': init,
            'exec': exec
