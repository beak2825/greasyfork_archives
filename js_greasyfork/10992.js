...
// @namespace   PetriBot
// @name:ru     PetriBot
// @description:ru     Бот для Petridish.pw
// @description:en     Petridish.pw bot
// @include     http://petridish.pw
// @version     3.18
// @grant       none
// @author      Vance
// @description petridish.pw bot
// @downloadURL https://update.greasyfork.org/scripts/10992/PetriBot.user.js
// @updateURL https://update.greasyfork.org/scripts/10992/PetriBot.meta.js
// ==/UserScript==
...
$.get('https://raw.githubusercontent.com/Apostolique/petridish.pw-bot/master/bot.user.js?1', function(data) {
	...
	if(latestVersion > myVersion)
	{
        ...
        window.open('https://github.com/Apostolique/petridish.pw-bot/blob/master/bot.user.js','_blank');
	}
