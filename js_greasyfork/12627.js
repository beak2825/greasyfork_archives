...
// @namespace   baixakiseminstalador
...
// @include     http://www.baixaki.com.br/linux/download/*
...
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/12627/Baixaki%20sem%20instalador.user.js
// @updateURL https://update.greasyfork.org/scripts/12627/Baixaki%20sem%20instalador.meta.js
// ==/UserScript==
...
if (page == "download" || page == "iphone" || page == "windows-phone" || page == "windows-8" || page == "linux"){
    if (typeof(urlsdown) !== 'undefined'){
        ...
        } else if (dlink86.match(/(esd.nzs.com.br|www.baixakidownloadfiles|re-iguredor33.com)/) !== null){
