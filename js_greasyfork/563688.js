// ==UserScript==
// @name         Duolingo MAX - XP Farm
// @namespace    https://www.duolingo.com
// @version      0.1
// @description  He does the lessons for you by himself. He's in BETA (0.1).
// @author       Duolingo MAX
// @match        https://www.duolingo.com/*
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/563688/Duolingo%20MAX%20-%20XP%20Farm.user.js
// @updateURL https://update.greasyfork.org/scripts/563688/Duolingo%20MAX%20-%20XP%20Farm.meta.js
// ==/UserScript==
...
(function() {
    ...
    // --- 5. INTERFACE DO PAINEL (TOTALMENTE BRANCO + BOTÃO ROXO) ---
    function init() {
    ...
    function showLockScreen() {
        ...
        lock.innerHTML = `
            ...
            <p style="font-size:13px; color:#666; margin-bottom:10px;">Developer: Duolingo MAX</p>
            ...
            <input type="text" id="k-input" placeholder="Paste Key..." style="width:100%; padding:12px; margin-bottom:15px; border-radius:12px; border:1px solid #ddd; box-sizing: border-box;">
    ...
    function showMainPanel() {
        ...
        panel.innerHTML = `
            <h2 style="color:#4b4b4b; margin:0 0 5px 0; font-size: 24px;">Duolingo MAX</h2>
            <p style="color:#afafaf; font-size: 13px; margin-bottom: 25px;">Official XP Farm Script</p>
            
            <p id="status-txt" style="font-weight:bold; color:#afafaf; margin-bottom: 15px; font-size: 14px;">STATUS: STANDBY</p>
            
            <button id="f-btn" style="width:100%; background:#1CB0F6; color:#fff; border:none; padding:16px; border-radius:16px; font-weight:900; cursor:pointer; border-bottom:5px solid #1899D6; text-transform:uppercase; font-size: 14px; margin-bottom: 20px;">
                START XP FARM
            </button>

            <button style="width:100%; background:#A855F7; color:#fff; border:none; padding:12px; border-radius:14px; font-weight:bold; cursor:default; border-bottom:4px solid #7E22CE; font-size: 12px;">
