...
// @downloadURL https://update.greasyfork.org/scripts/408761/Twitch%20GIF%20picker%20DEV.user.js
// @updateURL https://update.greasyfork.org/scripts/408761/Twitch%20GIF%20picker%20DEV.meta.js
// ==/UserScript==
...
$(document).ready(() => {
              ...
              if (node.querySelector) {
                ...
                if (link) {
                  ...
                  new Promise((resolve) => {
                    ...
                    $(node).find('div.tw-relative').first().append(gif.wrapper);
                    $(link).hide();
  ...
  const main = () => {
    ...
    $('<button/>', {'class': 'tw-core-button tw-button-icon', 'click': () => widget.toggle(event.target)}).append(gifIconSvg)
        .insertBefore(chatButton.parentNode.previousSibling);
