// ==UserScript==
// @name         Luigi's Mansion 3 Theme
// @namespace    http://tampermonkey.net/
// @version      0.17
// @description  T99 Luigi's Mansion 3 Theme for Jstris
// @author       Eddie, SimonTime
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/391614/Luigi%27s%20Mansion%203%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/391614/Luigi%27s%20Mansion%203%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/QLWGHl0.png",48);
        loadGhostSkin("https://i.imgur.com/SDdshoj.png",48);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/soeMGOK.png)";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_lock.wav",abs:1};
    ...
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_died.wav",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/t99hold.wav",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_move.wav",abs:1,set:0};
...
function atGameStart() {
    ...
    img.src = "https://i.imgur.com/0XOQIbm.png";
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_tspinsingle.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_tspinsingle.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_clear1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_tspindouble.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_tspintriple.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_clear4.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_clear5.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/t99_perfectclear.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_tspindouble.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_b2btetris.mp3"
];
...
Game['rotationSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_rotate.wav", //rotate left
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_rotate.wav", //rotate right
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigi_rotate.wav" //rotate 180°
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigisong1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigisong2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/Luigisong3.wav"
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/Luigisong1.wav"
