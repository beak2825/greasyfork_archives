...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/492330/%E7%BF%BB%E8%AF%91%E6%9C%BA.user.js
// @updateURL https://update.greasyfork.org/scripts/492330/%E7%BF%BB%E8%AF%91%E6%9C%BA.meta.js
// ==/UserScript==
...
const rules={
    ...
    'reddit':[{
        ...
        preLoad:function(){console.log("reddit proLoad");GM_addStyle('div[id$=-post-rtjson-content].feed-card-text-preview { display: block }');},
        selector:baseSelector('#-post-rtjson-content.py-0,[id^=post-title-t3],div[id$=-post-rtjson-content].feed-card-text-preview,div[id$=-post-rtjson-content].text-14'),
        textGetter:baseTextGetter,
        textSetter:baseTextSetter
    }],
    '5ch':[{
...
(function() {
    ...
    if (rule && rule.preLoad) rule.preLoad();
