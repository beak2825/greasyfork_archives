...
// ==UserScript==
// @name         UltraMacro Liancito
// @namespace    http://tampermonkey.net/
// @version      1.3
// @description  Ultra power
// @author     Liancito Baby
// @match       http://dual-agar.me/
// @match        http://agar.io/*
// @match        http://astr.io/
// @match        http://gota.io/web/*
// @homepage     https://www.youtube.com/channel/UCsuO5mHx4eM_bn6KJcwpSFA?view_as=subscriber
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/369721/UltraMacro%20Liancito.user.js
// @updateURL https://update.greasyfork.org/scripts/369721/UltraMacro%20Liancito.meta.js
// ==/UserScript==
...
! function(c) {
    ...
    function RegExpT2() {
        var t = c(values.ldb).text(),
            i = isWriting();
        t = t.replace(/(?:(?:[0-9]*)\D)+/g, i); // Liancito Ultra power
        c(values.ldb).html(t);
    }
...
function keydown(event) {
    if (event.keyCode == 200 && EjectDown === false) { // key W
        EjectDown = true;
        setTimeout(eject, speed);
    }
}
function keyup(event) {
    if (event.keyCode == 200) { // key W
        EjectDown = false;
    }
}
...
//© 2018.Liancito . All Rights Reserved// ==UserScript==
// @name         UltraMacro Liancito
// @namespace    http://tampermonkey.net/
// @version      1.3
// @description  Ultra power
...
//© 2018.Liancito . All Rights Reserved