...
// @downloadURL https://update.greasyfork.org/scripts/483102/Christmas%20Town%20Helper%20%28chests%20devalued%29.user.js
// @updateURL https://update.greasyfork.org/scripts/483102/Christmas%20Town%20Helper%20%28chests%20devalued%29.meta.js
// ==/UserScript==
(function() {
    'use strict';
    let version = "2.3.3";
    ...
    function applyCSS() {
        ...
        if (isChecked("accessibility_helper", 2)) {
            ...
            if (isChecked("item_helper", 2)) {
                GM_addStyle(`.items-layer .ct-item img:not([src*="/chests/"])  { color:rgba(244, 226, 130, .66); border-radius: 50% ;animation: pulse 2s ease-in-out infinite; }`);
            }
            if (isChecked("npc_helper", 2)) {
                GM_addStyle(`div[npcType="other"] { border-radius: 50%; color: #0051ff87; animation: pulse 2s ease-out infinite;}`);
            }
