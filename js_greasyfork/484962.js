// ==UserScript==
// @name         EYE CLIENT v3.6
// @namespace    
// @version      3.6
// @description  I FIXED MORE BUGS AND ADDED INSTA (MI NICK NAME 20 FPS xVIPx) 
// @author       20 FPS xVIPx
// @license      MIT
// @icon
// @match        *://moomoo.io/*
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/484962/EYE%20CLIENT%20v36.user.js
// @updateURL https://update.greasyfork.org/scripts/484962/EYE%20CLIENT%20v36.meta.js
// ==/UserScript==
...
let changes = `<div id="subConfirmationElement"><a href="https://discord.gg/jcgfPpc5B5">Join Dynasty!</a></div>`;
...
document.getElementById("gameName").innerHTML = "EYE CLIENT V2";
...
//document.getElementById("loadingText").innerHTML = ".V.I.P.";
document.getElementById("diedText").innerHTML = "R.I.P";
document.getElementById("diedText").style.color = "#d9534f; ";
document.title = "EYE CLIENT";
document.getElementById("leaderboard").append("DEMONS TOP");
...
document.getElementById('promoImgHolder').innerHTML =
  ...
  - Created EYE CLIENT, devlopment beings<br>
...
if (nameInputElement) {
    nameInputElement.style.color = "#d9534f;";
}

const guideCardDiv = document.getElementById("guideCard");
if (guideCardDiv) {
    guideCardDiv.style.cssText += shadowStyle;
    setupCardDiv.style.backgroundColor = "#d9534f;";
    guideCardDiv.style.backgroundColor = "#d9534f;";
}
...
function handleMessage(m) {
    ...
    /*if(item == "P"){
      setTimeout(() => {
          doNewSend(["M", [{name: "V.I.P"  "",moofoll: 1,skin: "#d9534f"}]]);
      }, 200);
      }*/
...
const handleMutations = (mutationsList) => {
    for (const mutation of mutationsList) {
        if (mutation.target.id === "killCounter") {
            ...
            if (count > prevCount) {
                doNewSend(["6", ["EYE CLIENT V2 KILL YOU"]]);
                setTimeout(()=>{
                    doNewSend(["6", ["    1    "]]);
                },650);
                prevCount = count;
...
$("body").after(`
  <div id="infomenu">
  <hr>
  <div class="nameblock">EYE CLIENT V2</div>
  <hr>
  <ul>
