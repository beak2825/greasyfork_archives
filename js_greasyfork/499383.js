// ==UserScript==
// @name         Скрипт для ГC ОПГ для жалоб на игроков
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/499383/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93C%20%D0%9E%D0%9F%D0%93%20%D0%B4%D0%BB%D1%8F%20%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1%20%D0%BD%D0%B0%20%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/499383/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93C%20%D0%9E%D0%9F%D0%93%20%D0%B4%D0%BB%D1%8F%20%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1%20%D0%BD%D0%B0%20%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.meta.js
// ==/UserScript==
...
{
	  title: '|______________________________________ Правила RolePlay процесса ______________________________________|'
},
{
    ...
    "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]2.01.[/color] Запрещено поведение, нарушающее нормы процессов Role Play режима игры [Color=#ff0000]| Jail 30 минут[/color].[/COLOR]<br><br>" +
                ...
                "[B][CENTER][COLOR=PINK]С уважением [/COLOR][COLOR=RED]Главный Следящий за ОПГ.[/COLOR]<br>"+
...
{
	  title: '|______________________________________ Chat Правила ______________________________________|'
},
{
...
{
	  title: '|______________________________________ Передача на рассмотрение ______________________________________|'
},
{
...
{
	  title: '|______________________________________ В другой раздел ______________________________________|'
},
{
	  title: '| В жб на адм |',
	  content:
...
{
	  title: '|______________________________________ Правила форума ______________________________________|'
},
{
	  title: '| Неадекват |',
	  content:
...
{
	  title: '|______________________________________ Правила госс. структур ______________________________________|'
},
{
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил для СМИ:<br><br>"+
                "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]4.01.[/color] Запрещено редактирование объявлений, не соответствующих П/Р/О [Color=#ff0000]| Mute 30 минут[/color].[/COLOR][/Spoiler][/CENTER][/B]<br><br>"+
                "[B][CENTER][COLOR=PINK]С уважением [/COLOR][COLOR=RED]Главный Следящий за ОПГ.[/COLOR]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url]<br>",
...
{
	  title: '|__________________________________________________ Правила ОПГ  __________________________________________________|'
},
{
...
{
	  title: '|______________________________________ Отказ жалобы ______________________________________|'
},
{
...
{
	  title: '| Нет в системе логирования |',
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/k4v0KjRf/f3eabafac57241f0ac0dd6776a1c00ff.gif[/img][/url]<br>' +
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как в системе логирования, нарушений со стороны данного игрока не было найдено. <br><br>"+
                "[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=PINK]С уважением [/COLOR][COLOR=RED]Главный Следящий за ОПГ.[/COLOR]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
  ...
  {
    	  title: '|______________________________________ RolePlay Биографии ______________________________________|'
},
{
        	  title: '| Био одобрена |',
	  content:
...
},
  {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша Биография получает статус - [COLOR=#FF0000]Отказано[/COLOR], Причиной отказа послужило - Написание Биографии от 3-его лица. <br><br>"+
                "[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=PINK]С уважением [/COLOR][COLOR=RED]Главный Следящий за ОПГ.[/COLOR]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
