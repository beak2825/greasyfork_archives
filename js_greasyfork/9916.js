...
// @version     1.1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/9916/HWM_Repair_Costs.user.js
// @updateURL https://update.greasyfork.org/scripts/9916/HWM_Repair_Costs.meta.js
// ==/UserScript==
var percents = [10,20,30,47,57,67,77,87,97]; // проценты
var kuznec = {'_Брат_ ': [50,47,0], 'урс74':[90,100,100]} // кузнецы ('имя': [эффект, цена,+золотаСверху])
