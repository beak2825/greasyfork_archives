...
// @description BT
// @include      http://bt.kltvv.com/*
// @include      http://www.sosobta.com*
// @include      http://www.btwalk.net/wiki/*
// @include      https://btdigg.org/search*
// @include      *www.btcili.net/*
// @include      *www.nms8.net/*
// @include      *www.sosobt.com/*
// @include      http://*.jav*.*
// @include      https://*.jav*.*
...
// @downloadURL https://update.greasyfork.org/scripts/27879/All%20Magnet%20to%20BT.user.js
// @updateURL https://update.greasyfork.org/scripts/27879/All%20Magnet%20to%20BT.meta.js
// ==/UserScript==
...
function code2down1(str) {
    ...
    torrentURL = "http://yun.kltvv.com/vod.html?url=" + btih;
	return torrentURL;
}
...
function code2down2(str) {
	var btih, torrentURL;
	btih = str.toLocaleUpperCase();
	torrentURL = "http://api.kltvv.com/api/api.php?u=magnet:?xt=urn:btih:" + btih;
	return torrentURL;
}
function code2down3(str) {
	var btih, torrentURL;
    btih = str.toLocaleUpperCase();
    torrentURL = "http://api.kltvv.top/api/ap.php?u=bt://" + btih;
	return torrentURL;
}
