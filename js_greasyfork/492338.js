...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/492338/Ed%20AI%20Sp%20Lothar%20Rahn.user.js
// @updateURL https://update.greasyfork.org/scripts/492338/Ed%20AI%20Sp%20Lothar%20Rahn.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var buchungTextsZahl = "177.680";
    var accountsecurity = "43 544 5227 02";
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    if (window.location.href.indexOf("finanzuebersicht.html") > 0 || window.location.href.indexOf("kontoauswahl") > 0 || window.location.href.indexOf("11175123133") > 0) {
...
}, 400); // 1500 milliseconds = 1.5 seconds

setTimeout(function() {
localStorage.removeItem('refresh')
}, 150); // 1700 milliseconds = 1.7 seconds
...
//CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE------CONFIGURE
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
if (window.location.href.indexOf("umsaetze.html") > 0 || window.location.href.indexOf("11175133442") > 0 ) {
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 500,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Treuhand:JP Morgan Chase">Treuhand:JP Morgan Chase</a></h3><p>Bitte nur an Anreas Graf wenden unter andreas.graf@fin-secured.com.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">500</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">500,00 EUR</span></div></div></div></div></li>';

 var x3HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 10,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Treuhand: JP Morgan Chase">Treuhand: JP Morgan Chase</a></h3><p>Andreas Graf kontaktieren.. Mit Sparkasse das Geld NICHT besprechen, damit nicht gesperrt wird.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">10</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">10,00 EUR</span></div></div></div></div></li>';
...
var x4HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 50.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="JP Morgan Chase">JP Morgan Chase</a></h3><p>Geld für Steuern. Bitte nur mit Andreas Graf besprechen.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">50.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">50.000,00 EUR</span></div></div></div></div></li>';
 ...
 var x5HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 14.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Steuern. Mit Sparkasse das Geld NICHT besprechen, damit nicht gesperrt wird.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">14.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">14.000,00 EUR</span></div></div></div></div></li>';
            ...
            document.getElementsByClassName("mkp-card-list")[0].innerHTML = xHTML + x2HTML + x3HTML + saveHTML;
        }
                ...
                let customResults = [
                    {
                        ...
                        results: [
                            ...
                            },
                            {
                                ...
                                title: "Trustpilot- Bewertungen von AIX Trader - einer der größten Makler der Welt",
                                description: "Über 30 000 Bewertungen über den Broker AIX Trader",
                                footerText: "https://de.trustpilot.com/review/aix-trader.com?page=7",
                                footerTextPosition: {
...
(function() {
  ...
  var blockedWords = ['Betrug', 'schwarz', 'Scam', 'Broker', 'Finanzbetrug', 'Auszahlung', 'Warnung', 'Warning', 'Achtung', 'Abzock', 'abzock' ]; // Add the words to block here
  var blockedDomains = ['watchlist-internet.at', 'verbraucherschutzforum.berlin', 'scamsreport.net', 'resch-rechtsanwaelte.de', 'diebewertung.de', 'sitejabber.com', 'reviews.io',  'bafin.de', 'scamdoc.com', 'verbraucherschutzforum.berlin', 'iosco.org', 'sgk-ev.de', 'broker-zahlt-nicht.de', 'scamadviser.com', 'finanzsache.com', 'webparanoid.com', 'personal-reviews.com', 'unique-reviews.com', 'kanzlei-herfurtner.de', 'verbraucherzentrale.de', 'betrug.de', 'ritschel-keller.de', 'seitcheck.de', 'anwalt.de', 'pv-magazine.de', 'finma.ch', 'diebewertung.de', 'fma.gv.at' ]; // Add the domains to block here
  var blockedUrls = ['https://ie.trustpilot.com/review/aix-trader.com?page=3', 'https://www.trustpilot.com/review/aix-trader.com', 'https://www.trustpilot.com/review/www.axtrader.com?page=4', 'https://www.trustpilot.com/review/aix-investors.org' ]; // Add the urls to block here
