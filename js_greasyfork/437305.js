...
// @version      6.2
// @description  實現移調、級數功能，兼容Safari手機版與網頁版
// @author       You
...
// @grant        GM_addStyle
// @license      AGPL
// @downloadURL https://update.greasyfork.org/scripts/437305/91%E8%AD%9Cios%E6%8D%B7%E5%BE%91%E9%9B%99%E7%94%A8v62.user.js
// @updateURL https://update.greasyfork.org/scripts/437305/91%E8%AD%9Cios%E6%8D%B7%E5%BE%91%E9%9B%99%E7%94%A8v62.meta.js
// ==/UserScript==
...
//去掉吉他和弦圖
GM_addStyle('#tone_chord{display:none !important}');
//只針對song去除廣告
GM_addStyle('#adGeek-slot-div-gpt-ad-1603436830996-0{display:none !important}');
GM_addStyle('#adGeek-slot-div-gpt-ad-1624530373449-0{display:none !important}');
GM_addStyle('#adGeek-slot-div-gpt-ad-1631793585502-0{display:none !important}');
GM_addStyle('#adGeek-slot-div-gpt-ad-1567069820127-0{display:none !important}');
GM_addStyle('#adGeek-slot-div-gpt-ad-1567070020978-0{display:none !important}');
GM_addStyle('#adGeek-slot-div-gpt-ad-1567070135884-0{display:none !important}');

GM_addStyle('.update_vip_bar{display:none !important}');
GM_addStyle('.a-post-show{display:none !important}');
GM_addStyle('.AV60d5e8e57ded8c5ae273efb5{display:none !important}');
GM_addStyle('.gliaplayer-wrapper{display:none !important}');
GM_addStyle('.parent_accucrazy_91pu_curation_desktop_bottom_gam{display:none !important}');

//v3 增大移調按鈕（去除惱人的廣告）
//v4 再把按鈕變超級大（避免有人找不到），放置在譜上方
//v5 新增同音異名調的變換功能，點擊灰色按鈕即可，例如 F# -> Gb, Db -> C#
//v6 把按鈕字體加大，精簡一點語法
//v6.1 移除吉他和弦圖，移除手機版網頁部分廣告

//iPhone/iPad 都兼容 手機版/電腦版網頁
...
var nowkey = "沒找到";
var tone_z_str = "沒找到";
var tone_z_num_full = "沒找到"; //全型
var tone_z_num_half = "沒找到"; //半形
var is_read = false;
...
if (is_mobile) {
    ...
    //電腦版 要新增在指定元素前面
    //let pos = document.querySelector('.cset');
    //let pos = document.querySelector('.update_vip_bar');
    pos = document.querySelector('.showToneInfo');

    //pos.parentElement.insertAfter(btn1, pos);
    //pos.parentElement.insertAfter(btn2, pos);
    //pos.parentElement.insertAfter(btn3, pos);
    //pos.parentElement.insertAfter(btn4, pos);
