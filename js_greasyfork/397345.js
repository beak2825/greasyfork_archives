...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/397345/SourceGraph.user.js
// @updateURL https://update.greasyfork.org/scripts/397345/SourceGraph.meta.js
// ==/UserScript==

(function() {
    'use strict';
    var target = document.querySelector("#js-repo-pjax-container > div.pagehead.repohead.hx_repohead.readability-menu.bg-gray-light.pb-0.pt-3 > div > ul");
    if (target){
