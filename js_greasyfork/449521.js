// ==UserScript==
// @name         Client - Starblast
// @namespace    https://greasyfork.org/en/users/926687-m4tr1x
// @version      1.3
// @description  Red-themed Client
// @author       Alex_#8943
// @match        https://starblast.io/
// @icon         https://cdn.upload.systems/uploads/pMm90TX9.png
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/449521/Client%20-%20Starblast.user.js
// @updateURL https://update.greasyfork.org/scripts/449521/Client%20-%20Starblast.meta.js
// ==/UserScript==
    ...
    if (window.location.pathname == "/") {
      ...
      function themeclient() {
        ...
        if (document.getElementById("play").style.color != `#fff`) {
          ...
          document.getElementById("play").style.background = `linear-gradient(to right,#94140a 0,${localStorage.clientcoloralt} 190%)`
