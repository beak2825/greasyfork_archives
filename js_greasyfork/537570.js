...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/537570/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D1%80%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20AQUA.user.js
// @updateURL https://update.greasyfork.org/scripts/537570/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D1%80%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20AQUA.meta.js
// ==/UserScript==
...
(async function () {
      ...
      },
 {
	...
	},
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  [user=418913]Andrey_Kawai ღ[/user]<br><br>`+
	...
	},
    {
	 ...
	 },
     {
      ...
      // {
       //  title: `Рук Модерации`,
       //  content: `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
       //  `[CENTER][SIZE=4][FONT=georgia]Ваша жалоба передана - Руководству Модерации.<br><br>`+
        // `[COLOR=rgb(251, 160, 38)]На рассмотрении.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
       //  prefix: SPECIAL_PREFIX,
      //   status: true,
    // },
    ...
    },
    {
    ...
    },
       {
        ...
        content:`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}<br><br>Пожалуйста внимательно прочитайте тему «[URL='https://forum.blackrussia.online/threads/Правила-подачи-заявки-на-обжалование-наказания.3429398/']Правила подачи заявки на обжалование наказания[/URL][B]»[/B]<br>И обратите своё внимание, на данный пункт правил:[/FONT][/SIZE][/CENTER]<br>`+
        `[QUOTE]`+
        `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]3.3. [/COLOR]Прикрепите ссылку на вашу страницу VK.[/SIZE][/CENTER]`+
        `[/QUOTE]<br>`+
        `[CENTER][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/CENTER]`,
        prefix: CLOSE_PREFIX,
        status: false,
        ...
        content:`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}<br><br>Пожалуйста внимательно прочитайте тему «[URL='https://forum.blackrussia.online/threads/Правила-подачи-заявки-на-обжалование-наказания.3429398/']Правила подачи заявки на обжалование наказания[/URL][B]»[/B]<br>И обратите своё внимание, на данный пункт правил:[/FONT][/SIZE][/CENTER]<br>`+
        `[QUOTE]`+
        `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]3.3. [/COLOR]Данное наказание не подлежит обжалованию.[/SIZE][/CENTER]`+
        `[/QUOTE]<br>`+
        `[CENTER][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/CENTER]`,
        prefix: CLOSE_PREFIX,
        status: false,
