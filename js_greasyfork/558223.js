// ==UserScript==
// @name         WorldGuessr Unreal Cheat - 2025/26
...
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/558223/WorldGuessr%20Unreal%20Cheat%20-%20202526.user.js
// @updateURL https://update.greasyfork.org/scripts/558223/WorldGuessr%20Unreal%20Cheat%20-%20202526.meta.js
// ==/UserScript==
...
(function() {
    ...
    const cheaterTextStr = atob("Q0hFQVRFUiE=");
    const style = create('style', { html: `
        ...
        #gmf-cheater-container { display:flex; flex-direction:column; align-items:center; position: fixed; z-index: 2147483652; opacity: 0; transition: opacity 1s ease, transform 1s ease; }
        #gmf-cheater-container img { width:150px; height:auto; margin-top:10px; }
        #gmf-cheater-container div { color:red; font-size:32px; font-weight:bold; margin-top:5px; }
        ...
        #gmf-fake-coords { margin-top:8px; font-size:14px; color:#a0d8f0; }
    `});
    ...
    const fakeCoordsEl = create('div', { id: 'gmf-fake-coords', text: '' });
    panel.appendChild(fakeCoordsEl);
    ...
    const cheaterContainer = create('div', { id:'gmf-cheater-container' });
    const cheaterImage = create('img', { src:'https://cdn3.emoji.gg/emojis/8370-mocking.png' });
    const cheaterTextEl = create('div', { text: cheaterTextStr });
    cheaterContainer.appendChild(cheaterImage);
    cheaterContainer.appendChild(cheaterTextEl);
