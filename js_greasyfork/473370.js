// ==UserScript==
// @name Для Кураторов Форума | CHERRY [09]
// @version 0.6.6
// @description KF
...
// @downloadURL https://update.greasyfork.org/scripts/473370/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20CHERRY%20%5B09%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/473370/%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20CHERRY%20%5B09%5D.meta.js
// ==/UserScript==
...
"[CENTER]Ваша жалоба взята [Color=Orange]на рассмотрение[/Color], ожидайте ответа от администрации сервера..<br>Просьба не создавать подобных тем, иначе форумный аккаунт может быть [Color=Red]заблокирован.[/CENTER]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Ваша жалоба передана [Color=Red]Главному администратору[/Color] - @Ronald Kõlman ☭︎ <br>Просьба не создавать подобных тем, иначе форумный аккаунт может быть [Color=Red]заблокирован.[/CENTER]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Ваша жалоба передана [Color=Red]Заместителю главного администратора[/Color] - @Nikolay_Kashtanov, @Vanya Donissimo. <br>Просьба не создавать подобных тем, иначе форумный аккаунт может быть [Color=Red]заблокирован.[/CENTER]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Ваша жалоба передана на рассмотрение [Color=Red] Специальному администратору – @Sander_Kligan [/Color], а также его заместителям – @Clarence Crown, @Dmitry Dmitrich, @Myron_Capone, @Liana_Mironova <br>Просьба не создавать подобных тем, иначе форумный аккаунт может быть [Color=Red]заблокирован.[/CENTER]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Долг выдается только через банк."+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]После проверки Ваших доказательств, я выношу Вердикт - Вы не придержались условий сделки.."+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]В доказательствах отсутствуют условия сделки.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER] С момента нарушения игрока прошло 72 часа. <br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Обратитесь в жалобы на сотрудников. Выберите нужную организацию, в которой заметили нарушение со стороны сотрудника:<br>[URL='https://clck.ru/3LBHp5']Правительство (кликабельно)[/URL]<br>[URL='https://clck.ru/3LBKPK']ФСБ (кликабельно)[/URL]<br>[URL='https://clck.ru/3LBKXS']ГИБДД (кликабельно)[/URL]<br>[URL='https://clck.ru/3LBKeb']УМВД (кликабельно)[/URL]<br>[URL='https://clck.ru/3LBL6G']Армия (кликабельно)[/URL]<br>[URL='https://clck.ru/3LBLTb']Больница (кликабельно)[/URL]<br>[URL='https://clck.ru/3LBLfK']СМИ (кликабельно)[/URL]<br>[URL='https://clck.ru/3LBM5C']ФСИН(кликабельно)[/URL]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER] Вам в жалобы на администрацию. <br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER] Вам в жалобы на лидеров.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER] Обратитесь в технический раздел Вашего сервера. Ссылка на технический раздел — https://forum.blackrussia.online/forums/Технический-раздел.22/ <br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Нарушений со стороны игрока не найдено.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Нету логитипа сервера.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Вы ошиблись сервером. Переношу Вашу тему в нужный Вам раздел. Ожидайте вынесения вердикта от администрации Вашего сервера.[/CENTER]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]",
},
{
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[CENTER]Жалоба с подобным содержанием уже есть на рассмотрении, ожидайте ответа там. Новые темы создавать - не нужно.[/CENTER]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/1zcGTzsD/twL1KNg.png[/img][/url]"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/CC0000/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[CENTER]Нарушитель будет наказан по пункту регламента: <br>"+
"[Color=Red]3.10.[/Color] Запрещена выдача себя за администратора, если таковым не являетесь [Color=Red]| Ban 7 - 15[/Color]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/2BA94F/20/1/4nxpbfgou5ejdwfy4nk7b8qoua.png[/img][/url]"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
...
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/2BA94F/20/1/4nxpbfgou5ejdwfy4nk7b8qoua.png[/img][/url]"+'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
},
{
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"Ваша Role Play биография написана от 3-го лица.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"Ваша Role Play биография скопирована, либо украдена.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/f70810/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"У Вас nRP nick_name, соответстсвенно, биография не может быть рассмотрена.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/f70810/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"У Вас уже есть РП биография, которая находится на рассмотрении. Исправляйте все указанные ошибки там. Создавать новые темы - не нужно.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/f70810/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"Ваша Role Play ситуация получает статус:<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/21ca49/20/1/4nxpbfgou5ejdwfy4nk7b8qoua.png[/img][/url]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"Ваша Role Play ситуация составлена не по форме.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/f70810/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
{
title: 'Небрежное/неправильное оформление',
content:
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"Ваша Role Play ситуация составлена небрежное или неправильное оформление. (Грамматические/пунктуационные ошибки и тд).<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/f70810/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
...
{
title: '♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥ Неофициальная организация ♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥♥'
},
{
title: 'Одобрено',
content:
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"Ваша неофициальная организация получает статус:<br>При отсутствии проявлении активности ваша организация может быть закрыта.<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/21ca49/20/1/4nxpbfgou5ejdwfy4nk7b8qoua.png[/img][/url]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
'[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]CHERRY[/COLOR].[/CENTER][/B][/SIZE]',
prefix: ACCEPT_PREFIX,
...
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"Ваша неофициальная RolePlay организация может быть закрыта по пункту правил: Неактив в топике организации более недели, она закрывается. Прикрепите фото-видео отчёт о активности вашей организации. У Вас есть 24ч на предоставление отчета. Если его не будет или он будет некорректный - организация будет закрыта.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>",
},
{
title: 'Активность не предоставлена',
content:
'[SIZE=4][FONT=times new roman][COLOR=#e393f8][CENTER][B]{{ greeting }}, уважаемый[/color] {{ user.mention }}!<br>'+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"Я вынужден закрыть Вашу неофициальную RolePlay организацию, поскольку активность не была предоставлена.<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/sXWGdyB9/image.png[/img][/url]<br>"+
"[url=http://x-lines.ru/][img]http://x-lines.ru/letters/i/cyrillicgothic/1066/f70810/20/1/rdej7wfn4nppbrgo19ejbwr74nxy.png[/img][/url]",
prefix: UNACCEPT_PREFIX,
status: false,
