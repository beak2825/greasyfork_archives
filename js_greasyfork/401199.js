// ==UserScript==
// @name         Webcamdarts Dual View Streaming size for joiner
// @name:fr      Webcamdarts Dual View Streaming (pour celui qui est invité à jouer)
// @namespace    http://tampermonkey.net/
// @version      1.13
// @description  To see your webcam to the right with dualview when you're invite to play. Desactivate Better design for Host in this case and activate this one.
// @description:fr Design de l'espace match - Quand vous êtes invité à jouer par qqn, cela place votre score à droite au-dessus de votre cible. Désactiver l'autre script et rechargé la page avec F5. 
// @author       Antoine Maingeot
// @match        https://game.webcamdarts.com/game
// @grant        none

// @downloadURL https://update.greasyfork.org/scripts/401199/Webcamdarts%20Dual%20View%20Streaming%20size%20for%20joiner.user.js
// @updateURL https://update.greasyfork.org/scripts/401199/Webcamdarts%20Dual%20View%20Streaming%20size%20for%20joiner.meta.js
// ==/UserScript==
...
addGlobalStyle('#content > div > div > div > div:nth-child(1) > div.row.ng-scope > div > div:nth-child(2) > div > div:nth-child(1) > div > div:nth-child(1){padding:0px;}');
   //Cancel
     addGlobalStyle('#content > div > div > div > div:nth-child(1) > div:nth-child(3){ display:block;width:fit-content;bottom:4px; position:fixed;right:0px;padding-left:0px;z-index:100;}');
...
addGlobalStyle('.ng-scope {position: relative;z-index: 102;}');
})();