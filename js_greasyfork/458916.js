// ==UserScript==
// @name Тестовый скрипт для технических проблем
...
// @downloadURL https://update.greasyfork.org/scripts/458916/%D0%A2%D0%B5%D1%81%D1%82%D0%BE%D0%B2%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D0%BF%D1%80%D0%BE%D0%B1%D0%BB%D0%B5%D0%BC.user.js
// @updateURL https://update.greasyfork.org/scripts/458916/%D0%A2%D0%B5%D1%81%D1%82%D0%BE%D0%B2%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D0%BF%D1%80%D0%BE%D0%B1%D0%BB%D0%B5%D0%BC.meta.js
// ==/UserScript==
...
const buttons = [
{
	...
	'[CENTER] текст [/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	'[CENTER]Технический специалист предоставил доказательства вашего нарушения. [B]Выдано верно.[/B]<br>Закрыто.​[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: CLOSE_PREFIX,
	status: false,
},
    {
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	'[CENTER]Ваш аккаунт будет <B>разблокирован</B>, приносим извинения за доставленные неудобства. С техническим специалистом будет проведена профилактическая работа.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	'[CENTER]Наказание будет снижено.<br>Рассмотрено.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: WATCHED_PREFIX,
status: false,
},

 {
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]В обжаловании вашего наказания <b>отказано.</b><br><br>" +
	'[CENTER][I]Отказано[/I].[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	'[CENTER]Ваша тема взята на рассмотрение, ожидайте ответ.<br>Создавать новые темы - не нужно, ответ будет дан, как только это будет возможно. Благодарим за ожидание.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: PIN_PREFIX,
	status: true,
},
{
	...
	'[CENTER]<u>Создавать подобные темы не нужно</u>.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: PIN_PREFIX,
	status: true,
},
{
...
},
{
	...
	'[CENTER][I]Закрыто[/I].[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: CLOSE_PREFIX,
	status: false,
},
{
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Ваша тема не как не относится к жалобам на технических специалистов, обратитесь с данной темой в <u>технический раздел вашего сервера</u>  [URL='https://forum.blackrussia.online/index.php?forums/Технический-раздел-indigo.493/']клик[/URL]<br>" +
	'[CENTER][I]Отказано[/I].[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: UNACCEPT_PREFIX,
	status: false,
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Ваше наказание обжалованию не подлежит.<br>Вы получили блокировку за серьезное нарушение, которое невозможно обжаловать/обнулить." +
	'[CENTER]Закрыто.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: UNACCEPT_PREFIX,
	status: false,
},
{
...
},
{
	...
	'[CENTER]К сожалению, иногда решение подобных вопросов требует много времени. Надеемся, что Вы сможете восстановить доступ к аккаунту!<br>  [I]Рассмотрено[/I].[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: WATCHED_PREFIX,
	status: false,
},
{
...
},
{
	...
	'[CENTER][I]Решено[/I].[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
...
},
{
	...
	"[CENTER]📹 Включение продемонстрировано на видео: https://youtu.be/Wft0j69b9dk[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]",
	prefix: CLOSE_PREFIX,
	status: false,
},
{
...
},
{
	...
	'[CENTER]Решено.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
    status: false,
    prefix: DECIDED_PREFIX,
},
{
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Ваше обращение актуально?[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]",
	prefix: NO_PREFIX,
	status: true,
},
{
...
},
{
	...
	'[CENTER]Создавать новые темы с данной проблемой — не нужно.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Ваша тема передана на тестирование.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]",
  	prefix: WAIT_PREFIX,
  	status: false,
},
{
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	'[CENTER]Если вы выставили свои вещи на аукцион а их никто не купил, то воспользуйтесь командой [COLOR=rgb(251, 160, 38)]/reward[/COLOR]<br> В случае отсутствии вещей там, приложите скриншоты с +/time в новой теме<br>Закрыто. [/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: CLOSE_PREFIX,
	status: false,
},
{
...
},
{
	...
	'[CENTER] Решено, закрыто.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
  prefix: DECIDED_PREFIX,
  status: false,
},
{
...
},
{
	...
	'[CENTER][I]Рассмотрено[/I].[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
  prefix: WATCHED_PREFIX,
  status: false,
},
{
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	'[CENTER]Скоро будете выпущены,ожидайте.[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: CLOSE_PREFIX,
	status: false,
	},
{
...
},
{
	...
	"[CENTER] Создавать новые темы с данной проблемой — не нужно, ожидайте ответа в данной теме. Если проблема решится - Вы всегда можете оставить своё сообщение в этой теме.<br><br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]",
...
},
{
	...
	content:
	'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	'[CENTER] Для активации какой либо прошивки необходимо поставить все детали данного типа "SPORT" "SPORT+" и т.п.<br>Закрыто[/CENTER][/FONT][/SIZE]<br><br>[RIGHT][B] Полезная информация:[/B] https://clck.ru/32ikeV [/RIGHT]',
	prefix: CLOSE_PREFIX,
	status: false,
},
];
