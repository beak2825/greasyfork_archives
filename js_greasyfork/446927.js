// ==UserScript==
// @name         PSChina Server Translation
// @namespace    http://tampermonkey.net/
// @version      1.5.8
// @license MIT  Northumberland
// @description  PSChina Server Translation剑盾DLC2汉化脚本
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/446927/PSChina%20Server%20Translation.user.js
// @updateURL https://update.greasyfork.org/scripts/446927/PSChina%20Server%20Translation.meta.js
// ==/UserScript==
var translations = {
    ...
    // 携带-的战报
  	...
  	"[The opposing Landorus-Therian's Intimidate]": "[对手的土地云-灵兽的威吓]",
	  "[Landorus-Therian's Intimidate]": "[土地云-灵兽的威吓]",
    "[The opposing Rayquaza-Mega's Delta Stream]": "[对手的超级烈空坐的德尔塔气流]",
    "[Rayquaza-Mega's Delta Stream]": "[超级烈空坐的德尔塔气流]",
    ...
    "If held by a Zamazenta, this item changes its forme to Crowned Shield.": "藏玛然特携带后，在对战中会以藏玛然特-王形态登场",
    "If held by a Zacian, this item changes its forme to Crowned Sword.": "苍响携带后，在对战中会以苍响-王形态登场",
    ...
    "You've passed the cave.time to go back":"你已经通过了山洞。该回去了",
    "You defeat the void and become a new champion":"你战胜了虚空，成为了新的冠军",
    "Skip":"跳过",
    "Evo All":"进化全部PM",
    "Evo A Pokemon":"随机进化一只PM",
    "Retransmission PokemonSet":"重发PM全部配置",
    "Retransmission Moves Pool":"重发PM技能配置",
    "Choose":"选择",
    "Rand":"随机",
    "Two":"两项",
    "Three":"三项",
    "Half":"变为126",
    "Fill":"拉满",
    "Choose One Mon Hp Another fill":"选择一只PM的HP与随机另一项努力值拉满",
    "Choose One Mon Atk Spe fill":"选择一只PM物攻与速度努力值拉满",
    "Choose One Mon Spa Spe fill":"选择一只PM特攻与速度努力值拉满",
    "Choose One Mon Get Specific Item":"选择一只PM获得专属道具",
    "Hp":"HP",
    "Atk":"物攻",
    "Def":"物防",
    "Spa":"特攻",
    ...
    "White Devil":"白色恶魔",
    // Abilities Translations
    "Bomber": "轰炸机（物攻特攻翻倍所有技能pp变成1下场回复pp）",
    //"Hide": "隐藏（免斗，鬼系技能*1.5）",
    "Diffuser": "扩散器（aoe技能*1.3）",
    "Concentrator": "集中器（单体技能*1.5）",
    "Hard Shell": "坚硬甲壳（减伤）",
    "Giant Killer": "巨人杀手（对超过200kg的精灵伤害*1.3）",
    "Irreducible": "永恒净体（能力等级绝对不被降低）",
    "Defense Power": "防御力量（入场时攻击=防御）",
    "Hyperactivity": "多动症（自动解除锁招）",
    "Immolating": "献祭（出场时获得你倒下的精灵的数量*等级*80%的最大hp）",
    "Fortitude Shield": "刚毅护盾（你受到伤害不可大于你的血量的一半（向上取整））",
    //专属特性
    "Shop Man": "店长（免疫所有伤害）",
    "Rich Loli": "富萝莉（对面命中-85%）",
    "An Fist": "安拳（拳类技能4倍威力）",
    "Defense Power": "防守力量（入场时攻击=防御）",
    "Ununown": "未知未知（受到攻击有50%概率变成抵抗属性）",
    "Malicious Pluck": "恶意啄食（使用者的鸟嘴类技能先制+1并拍落对手道具）",
    "Protean Pattern": "花纹变换（开始1/3概率降低对面攻击1/3概率回复1/4hp，用变化技能速度+1用攻击技能atk+1）",
    "Whale Fall": "鲸落（死后对友方场地使用治愈之愿）",
    "Principal Dancer": "首席舞者（舞蹈类技能先制度+1）",
    "Magic Beam": "魔法光线（使用吸取类技能时降低1级敌方当前计算能力值最高的属性，同时提升一级自己的对应属性）",
    // Items Translations
    "Super Band": "超级头巾",
    "Super Specs": "超级眼镜",
    "Super Scarf": "超级围巾",
    "Super Vest": "超级背心",
    "Super Muscle Band": "超级力量头带（物攻*1.2）",
    "Super Wise Glasses": "超级博学眼镜（特攻*1.2）",
    "Super Quick Claw": "超级先制之爪（40%概率）",
    "Super Life Orb": "超级生命宝玉（伤害*1.5）",
    "Super Metronome": "超级节拍器（增幅为30%）",
    "Super Bright Powder": "超级光粉（敌人命中率-20%对精英无效）",
    "Super Expert Belt": "超级达人带（克制技能伤害*1.4）",
    "Berserk Gene": "破坏因子",
    "Diseviolite": "奇石（无条件双防*1.5）",
    "Intact Apple": "完整的苹果（回合结束回1/8的血）",
    "Adaptive Slate": "自适应石板（本系技能的加成变成1.8）",
    "Sight Lens": "瞄准镜（命中*1.2）",
    "Explosive Arm": "易爆护臂（伤害翻倍自身双防减半）",
    "Double-edged Sword": "双刃剑（以每次损失30%的血为代价伤害*2.5）",
    "Flexible Device": "灵动机械（伤害和速度*1.3双防*0.666）",
    "Pain Connector": "痛楚共分（双方回血反甲）",
    "Immunity Herb": "免疫香草（免疫第一次受到的攻击）",
    "Deep Sea Dew": "深海之露（所有攻击技能带旋涡特效）",
    "Seismic Lever": "阿基米德杠杆（所有攻击技能额外造成自己等级/2的伤害）",
    "Azure Flute": "天界之笛（回合结束有1/32的概率使对面阵亡）",
    "Gladiator Helmet": "角斗士头盔（“坚硬脑袋”+提升10%招式威力）",
    "Huge Berry": "巨树果（血低于25%食用回70%hp）",
    "Wonderful Berry": "抗all果（受到效果拔群的攻击后发动，减半该伤害）",
    "Eject Station": "避难所（无限使用的避难背包）",
    // Moves Translation
    "Super Steel Beam": "超级铁蹄光线（200威力）",
    "Sheer Colder": "绝对更加零度（命中率冰系50%其他40%）",
    "Double Impression": "迎头双击（迎头一击*2）",
    "Super Light of Ruin": "超级破灭之光（190威力）",
    "Swamp Power": "淤泥之力（110威力特攻地面系减自己1级速）",
    "Stim Pack": "兴奋剂（物攻特攻速度+1，掉15%HP）",
    "Super Silver Wind": "超级银色旋风（80威力30%全属性+1）",
    "Super Parabolic Charge": "超级抛物面充电（85威力）",
    "Super False Surrender": "超级假跪真撞（90威力）",
    "Dual Ace": "双返（飞行系物理55威力100命中2下）",
    "PhotonGeyser": "光子喷涌",
    "DoubleIronBash": "钢拳双击",
    "Prism Charge": "棱镜充能（提升12级特工每回合下降1级特工）",
    "Stasis Ward": "静滞陷阱（冰系，钉子类技能，冰冻下一个上场的地面非冰系精灵）",
    "Psychic Sword": "念力剑（125 100% 超能特殊，计算目标物防，降低自己一级命中）",
    "Backdraft": "回火（60 100% 火系特殊 回25%血）",
    "Spring": "喷泉（60 100% 水系特殊 回30%血）",
    //专属技能
    "Hidden Power Legend": "觉醒力量传说（对所有属性造成克制伤害）",
    "Toxic Wrap": "剧毒束缚（35 85% 毒物理 附带束缚效果并且有50%概率使目标麻痹或中毒）",
    "Fearow Drill Peck": "大嘴雀啄钻（110 95% 飞物理 若目标物防能力值低于使用者攻击能力值则有50%概率畏缩）",
    "Whale Leap": "鲸跃（~ 90% 水物理 HP比对方越高威力越高，最高250）",
    "Bird Facade": "鸟系硬撑（70 100% 飞行物理 威力异常状态翻倍）",
    "Swan Dance": "天鹅舞（80 100% 水特攻 仙场下伤害翻倍）",
    "Spiritual Tide": "精神潮汐（80 100% 水特攻 雨天下开启超能场地）",
    "Zen Whirlpool": "意念漩涡（70 100% 超能特攻 带束缚效果）",
    // Elite Remains
    "Artirain": "人工降雨",
    "Artihail": "人工冰雹",
    "Artistorm": "人工沙暴",
    ...
    "Confident Start": "自信开始（第一回合随机友方的能力等级，次数随着层数增加）",
    "Focus Device": "集中设备（精灵有道具并且满血被秒时消耗道具并且留下1点血）",
    "Angel Halo":"天使光环（每局随机一个精灵全属性*1.2）",
    "Industrial Plant":"工业工厂（钢场，友方精灵受到克制伤害减少15%，钢系技能*1.3）",
    "Egg Of Compassion":"同情心蛋（场地，友方草系技能对飞火虫毒钢龙造成一倍伤害）",
    "Dancing Floor":"舞池（场地，电系伤害*1.2，电系对地面系伤害*0.5，电系技能造成伤害时有20%概率麻痹）",
    "Dragon Thrones":"龙椅（场地，友方龙系精灵的第一个技能会变成炽魂热舞烈音爆）",
    "Ticket Of Colosseum":"竞技场门票（第一回合开启拳击场地友方格斗系技能威力降低25%可以攻击鬼系并且对自身特效变成物攻+1）",
    "Acupressure Mat":"趾压板（第一回合对对面使用Spikes）",
    "Potion Of Rapid Growth":"草钉（第一回合对对面使用永久寄生种子）",
    "Gravity Generator":"重力发生器（第一回合开启重力）",
    "Trick Props":"魔术道具（第一回合开启戏法空间）",
    "Soy Milk":"豆浆（第一回合开启游击场地，你的单次攻击技能变成5次，所有伤害*0.2）",
    "Garden Guardian":"花园守护者（你的仙系精灵无法被ct，被攻击会增加对应的防御）",
    "Pole Tracker":"极点定位器（第一回合开启冰山，你的冰系精灵每回合回复1/8并提高1.5倍物防，敌人的非冰系精灵每回合掉1/16）",
    "Industrial Emissions":"工业污染（第一回合开启酸雨，所有毒系攻击*1.5，超能系攻击*0.5，敌方非毒系精灵每回合掉1/16）",
    "Combustible":"可燃物（开启炼狱场地，火系技能使对面陷入火海）",
    "Sun Shower":"太阳雨（开启彩虹场地，水系技能使己方获得彩虹）",
    "Guardian Shield":"守护者护盾（降低敌方20%非接触伤害）",
    "Sword of Trying":"审判之剑（第一回合对敌方精灵造成敌方精灵hp-1的伤害）",
    "Sleight of Hand":"妙手（敌方精灵的道具有33%概率变成负面道具）",
    "Infestation": "害虫横行（敌方精灵第一次受到我方虫系精灵攻击后全属性-1）",
    "Gang Guarantee": "帮派担保（第一回合开启帮派地盘，恶系技能+15威力并且恶系精灵的恶本加成变为2）",
    "False Moon": "虚假之月（第一回合开启百鬼夜行，鬼系技能威力*1.5获得穿透效果但pp消耗*4）",
    "Gun of Nerf": "削弱之枪（第一回合开启普通强度，普通系精灵获得普通皮肤和胆气,变化技能先制+1）",
    "Eight Diagrams drawing": "八卦图纸（第一回合开启八卦阵，地面系精灵的地面属性抗性翻转且双攻*1.2）",
    "Obscenities": "垃圾话（开局对对面用抛下狠话）",
    "Overdrive": "过载器（开启过载场地，非z技能威力*300%但是需要充能）",
    "Time Jewel": "时光宝珠（加速时间，使我方宝可梦速度提高30%）",
    "Fairy Egg": "精灵蛋（我方获得一个小精灵，每次攻击后对敌方宝可梦造成最大生命值10%的伤害）",
    "Tri Force": "人工德尔塔天气",
...
var regex_rougepmmoves = new RegExp(/your ([A-z -]+) relearned ([A-z -]+),([A-z -]+),([A-z -]+),([A-z -]+)/);
var regex_rougeabilities = new RegExp(/ ([A-z -]+) \//);
//PSRouge end
...
var t = function (originalStr) {
    ...
    if (originalStr.match(regex_rougepmmoves)) {
        return translations[RegExp.$2] + ',' + translations[RegExp.$3] + ',' + translations[RegExp.$4] + ',' + translations[RegExp.$5];
    }
    if (originalStr.match(regex_rougeabilities)) {
        return translations[RegExp.$1] + " ";
    }
    //PSRouge end
