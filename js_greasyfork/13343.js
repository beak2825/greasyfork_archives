...
// -- FOOLSLIDE END
// @downloadURL https://update.greasyfork.org/scripts/13343/Manga%20Loader.user.js
// @updateURL https://update.greasyfork.org/scripts/13343/Manga%20Loader.meta.js
// ==/UserScript==
...
var implementations = [{
  ...
  name: 'foolslide',
  match: "^(" + [
    "http://manga.redhawkscans.com/reader/read/.+",
    "http://reader.s2smanga.com/read/.+",
    "http://casanovascans.com/read/.+",
    "http://reader.vortex-scans.com/read/.+",
    "http://reader.roseliascans.com/read/.+",
    "http://mangatopia.net/slide/read/.+",
    "http://www.twistedhelscans.com/read/.+",
    "http://reader.sensescans.com/reader/read/.+",
    "http://reader.kireicake.com/read/.+",
    "http://substitutescans.com/reader/read/.+",
    "http://mangaichiscans.mokkori.fr/fs/read/.+",
    "http://reader.shoujosense.com/read/.+",
    "http://www.friendshipscans.com/slide/read/.+",
    "http://manga.famatg.com/read/.+",
    "http://www.demonicscans.com/FoOlSlide/read/.+",
    "http://necron99scans.com/reader/read/.+",
    "http://www.demonicscans.com/FoOlSlide/read/.+",
    "http://reader.psscans.info/read/.+",
    "http://onetimescans.com/foolslide/read/.+",
    "http://necron99scans.com/reader/read/.+",
    "http://manga.inpowerz.com/read/.+",
    "http://reader.evilflowers.com/read/.+",
    "http://reader.cafeconirst.com/read/.+",
    "http://kobato.hologfx.com/reader/read/.+",
  ].join('|') + ")",
  img: function() {
  ...
  UI.btnMoreStats.addEventListener('click', function(evt) {
    if(isMessageFloating() && UI.lastFloat === evt.target) {
      ...
      showFloatingMsg([
        ...
        (pageStats.curChap !== null && pageStats.numChaps !== null ? (pageStats.curChap + '/' + pageStats.numChaps + ' chapters read ' + ((pageStats.curChap / pageStats.numChaps * 100).toFixed(2) + '%') + ' of series') : ''),
      ].join('<br>'), null, true);
    }
  });
