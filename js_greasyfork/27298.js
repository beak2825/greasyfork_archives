// ==UserScript==
// @name EXTENCION PARA HAPPYFOR.WIN DE Diego :v el krak xdxd
...
// @grant none
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/27298/EXTENCION%20PARA%20HAPPYFORWIN%20DE%20Diego%20%3Av%20el%20krak%20xdxd.user.js
// @updateURL https://update.greasyfork.org/scripts/27298/EXTENCION%20PARA%20HAPPYFORWIN%20DE%20Diego%20%3Av%20el%20krak%20xdxd.meta.js
// ==/UserScript==
...
document.getElementById("instructions").innerHTML += "INSTRUCCIONES: Tecla A x2 = x16 ESPACIOS                  Tecla D = Doblesplit";
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> Hecho por:<b> <strong>ᗪєηмαяк?</strong> Leader de: <strong>◄Ɗɱ►????</strong></b>!</span></span></center>";
