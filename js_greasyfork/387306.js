...
// @grant       GM_addStyle
// @version 2019.07.09
// @downloadURL https://update.greasyfork.org/scripts/387306/UnMod_cf.user.js
// @updateURL https://update.greasyfork.org/scripts/387306/UnMod_cf.meta.js
// ==/UserScript==
var UM_VER = '2019.07.09';
//
var conowego = 'Co nowego?\n\n\
2019.07.08: poprawki by czapka & FaZiR\n\
';
var hajs;
function UNMOD() {
        ...
        if (document.getElementById('hc_c0')) {
          ...
          document.getElementById('nowy').addEventListener('click', function () {
            ...
            for (i = 0; i < itemS.length; i++) {
              ...
              if (parseInt(koszt) < GM_getValue(id + 'UM_zkclean', '25000') && parseInt(koszt) > 49) {
