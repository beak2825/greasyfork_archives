// ==UserScript==
// @name         Simple Shellshockers Theme Example
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/455472/Simple%20Shellshockers%20Theme%20Example.user.js
// @updateURL https://update.greasyfork.org/scripts/455472/Simple%20Shellshockers%20Theme%20Example.meta.js
// ==/UserScript==
...
* {
	...
	--ss-black: #000;
	--ss-white: #de8416; /*White Text*/
	--ss-offwhite: #FFF3E4;
	--ss-yellow0:#F7FFC1;
	--ss-yellow: #1F51FF;
	--ss-yolk0: #f1c59a;
	--ss-yolk: #22bdf5; /*Yellow Buttons*/
	--ss-yolk2: #d97611;
	--ss-red0: #e29092;
	--ss-red: #d15354;
	--ss-red2: #801919;
	...
	--ss-blue1: #95E2FE;
	--ss-blue2: #5EBBD9;
	--ss-blue3: #1F51FF; /*Lighter Box Borders*/
	--ss-blue4: #FF5F1F; /*Blue Subtitles, Darker Box Borders*/
	--ss-blue5: #0a5771;
	--ss-green0: #87ddbb;
	--ss-green1: #3ebe8d;
	--ss-green2: #2a7256;
	...
	--ss-lightoverlay: url("https://img.freepik.com/free-photo/cosmic-background-with-colorful-laser-lights_181624-26485.jpg?w=2000"); /*Main Background*/
