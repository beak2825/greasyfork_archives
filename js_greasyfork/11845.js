// ==UserScript==
// @name        Sparpa Military Prospect
// @namespace   http://honor.glory.war.forumfree.it/?f=64580107
// @description Voi venite qua e il tool dello Sparpa vi dice quanti generali sono :) e quanto vi costa
// @include     http://honor.glory.war.forumfree.it/?f=64580107
// @author      Martino
// @version     1.0.2
// @date        2015-08-20
// @icon        http://i44.tinypic.com/v4rok8.png
// @downloadURL https://update.greasyfork.org/scripts/11845/Sparpa%20Military%20Prospect.user.js
// @updateURL https://update.greasyfork.org/scripts/11845/Sparpa%20Military%20Prospect.meta.js
// ==/UserScript==
...
var savioPiccolaFlotta=	'500+700+160+0+0+180+120+0+30+200+70';
var savioMediaFlotta=		'700+1000+220+0+0+225+200+60+30+300+100';
var savioGrandeFlotta=	'700+1300+280+0+0+270+280+60+30+400+120';
...
var	savioPiccoleTruppe= '3500+0+1000+3000+0+0+420+60+160+90+350+300+50+20';
var	savioMedieTruppe= 	'4000+0+1000+4000+0+0+504+60+200+90+350+400+80+20';
var	savioGrandiTruppe= 	'5000+0+1000+5000+0+0+504+60+200+90+350+500+80+20';
...
var nome='Sparpa Military Project ';
var versione='1.0.2';
...
function AggiornaTruppe (d) {
    ...
    case '7': valori =savioPiccoleTruppe.split("+");break;
    case '8': valori =savioMedieTruppe.split("+");break;
    case '9': valori =savioGrandiTruppe.split("+");break;
  break; 
  default:
	}
	if (s!='0') {
...
//    case '4': valori =laraFlotta.split("+");break;
    ...
    case '7': valori =savioPiccolaFlotta.split("+");break;
    case '8': valori =savioMediaFlotta.split("+");break;
    case '9': valori =savioGrandeFlotta.split("+");break;
  break; 
  default:
	}
	if (s!='0') {
...
function sparpaMilitary(){if (!(document.getElementsByName('submit')[0]) ) {
	  ...
	  oInSimCuoco.addEventListener('keyup',soloNumeretti,false);
		...
		oInSimSelezionaTruppe.appendChild(opzTruppe6);
				var opzTruppe7=document.createElement("option");
		opzTruppe7.setAttribute('value','7');
		opzTruppe7.innerHTML="Savio Piccole Truppe";
		oInSimSelezionaTruppe.appendChild(opzTruppe7);
						var opzTruppe8=document.createElement("option");
		opzTruppe8.setAttribute('value','8');
		opzTruppe8.innerHTML="Savio Medie Truppe";
		oInSimSelezionaTruppe.appendChild(opzTruppe8);
						var opzTruppe9=document.createElement("option");
		opzTruppe9.setAttribute('value','9');
		opzTruppe9.innerHTML="Savio Grandi Truppe";
		oInSimSelezionaTruppe.appendChild(opzTruppe9);		
...
//		opzFlotta4.innerHTML="Lara Flotta";
		...
		opzFlotta6.innerHTML="Non Si Fanno Nomi";
				var opzFlotta7=document.createElement("option");
		opzFlotta7.setAttribute('value','7');
		opzFlotta7.innerHTML="Savio Flotte Minime";
						var opzFlotta8=document.createElement("option");
		opzFlotta8.setAttribute('value','8');
		opzFlotta8.innerHTML="Savio Flotte Medie";
						var opzFlotta9=document.createElement("option");
		opzFlotta9.setAttribute('value','9');
		opzFlotta9.innerHTML="Savio Flotte Massime";
//		oInSimSelezionaFlotta.appendChild(opzFlotta4);
		...
		oInSimSelezionaFlotta.appendChild(opzFlotta7);
		oInSimSelezionaFlotta.appendChild(opzFlotta8);
		oInSimSelezionaFlotta.appendChild(opzFlotta9);
