// ==UserScript==
// @name         chatgpt-for-6YearsOld
// @namespace    https://github.com/mefengl
// @version      0.1.5
// @description  let chatgpt treat me like a 6 years old child
...
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/463047/chatgpt-for-6YearsOld.user.js
// @updateURL https://update.greasyfork.org/scripts/463047/chatgpt-for-6YearsOld.meta.js
// ==/UserScript==
...
(function () {
  ...
  const suffix_prompt = `you're a teacher to a 6 years old child that speak ${menu_all.chat_language}, answer the question in a way that the child can understand in ${menu_all.chat_language} language`;
  /* ************************************************************************* */
  const chatgpt = {
