...
// @downloadURL https://update.greasyfork.org/scripts/448827/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E5%85%B7%E9%A2%84%E5%8F%91%E5%B8%83.user.js
// @updateURL https://update.greasyfork.org/scripts/448827/%E6%B5%8F%E8%A7%88%E5%99%A8%E5%B7%A5%E5%85%B7%E9%A2%84%E5%8F%91%E5%B8%83.meta.js
// ==/UserScript==
...
(function() {
    ...
    *{
    ...
    .mask,.infoContact,.record,.data,.transfer,.renew,.bindStatus{
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
    ...
    .close,.record-close,.data-close,.renew-close,.transfer-close,.bindStatus-close{
        position: absolute;
        top: 10px;
        right: 10px;
        cursor: pointer;
    ...
    let div = `<div class="loginBox">
        ...
        <div class="login-box">
            ...
            <div class="login-tel">
                <span>手机号：</span>
                <input type="tel" placeholder="请输入你的手机号" name="phone" id="phone" autocomplete="off" tabindex="1" />
            </div>
            <div class="login-pwd">
                <span>密码：</span>
                <input type="password" placeholder="请输入密码" name="pwd" id="pwd" autocomplete="off" tabindex="2" />
            </div>
            <div class="login-btn">
                <button>登录</button>
            </div>
            ...
            <div class="form-enter">
                <div>
                    <div class="added">
                        ...
                        <div class="added-list" id="added-phone"></div>
                    </div>
                    <div class="form-list">
                        <span>手机：</span>
                ...
                <div>
                    <div class="added">
                        ...
                        <div class="added-list" id="added-wechat"></div>
                    </div>
                    <div class="form-list">
                        <span>微信：</span>
                ...
                <div>
                    <div class="added">
                        ...
                        <div class="added-list" id="added-qq"></div>
                    </div>
                    <div class="form-list">
                        <span>QQ：</span>
    ...
    <div class="data">
        <div class="data-box">
            ...
            <div class="data-content">
                ...
                <div class="data-select data-cate" id="cate1">
                    <div class="select-title">分类选择</div>
                    <div class="select-content">
                ...
                <div class="data-select data-cate" id="cate2">
                    <div class="select-title">分类选择</div>
                    <div class="select-content">
 ...
 */
  ...
  var Cates = {
    ...
    // apiHost
    var apiHost = "https://pre.api.oa.cyek.com/";
    ...
    $(function(){
        ...
        if(rex.match(/https:\/\/www.douyin.com\/user\/*/) != null){
            ...
            // 获取小红书数据
            let text = $("#app").parent().parent().next().text();
            let txtStr = text.substr(62)
            console.log(JSON.parse(txtStr.substr(0,txtStr.length - 1)))
            let user = JSON.parse(txtStr.substr(0,txtStr.length - 1)).userDetail
            // 粉丝数
            follower_count = "";
            // 粉丝数
            fans_count = "";
            ...
            like_count = "";
            // 作品数
            video_count = JSON.parse(txtStr.substr(0,txtStr.length - 1)).notesDetail.length;
            // 平台id
            platform_id = 4;
            // 自定义字段
            diy = {
            ...
            follower_count = "";
            // id
            sec_uid = window.location.pathname.split("/")[2];
            // 抖音author_id
            author_id = window.location.pathname.split("/")[2];
            // 昵称
            nick = $(".female span").text() == "" ? $(".male span").text() : $(".female span").text();
            // account号
        ...
        // }else if(rex.match(/https:\/\/weibo.com\/n\/*/) != null || rex.match(/https:\/\/weibo.com\/u\/*/) != null){
            ...
            function setData(){
                ...
                }else if(rex.match(/https:\/\/weibo.com\/u\/*/) != null){
                    userData = {
                    ...
                    success: function (res) {
                        ...
                        if(res.ok == 1){
                            ...
                            if(rex.match(/https:\/\/weibo.com\/u\/*/) == null){
                                window.location.href = "https://weibo.com/u/"+sec_uid
                            }
                        }else{
        ...
        }else if(rex.match(/https:\/\/author.baidu.com\/*/) != null || rex.match(/https:\/\/baijiahao.baidu.com\/u*/) != null){
                ...
                success: function (response) {
                    ...
                    if(response.code == 1000){
                        ...
                        if(response.result.info.qrcode != ""){
                            ...
                            $(".operate-ewm span").text("APP扫码发送私信");
                        }
                        ...
                        tabs(".data-tab div",".data-tabContent");
                        $(".data-tab>div:first-child").addClass("active")
                        $(".data-tabContent").append(contentData)
                        $(".data-tabContent>div:first-child").addClass("active")
        ...
        // 判断手机密码是否存储 存储就登录
        if(storagePhone!=null&&storagePwd!=null){
            if(rex.match(/https:\/\/www.kuaishou.com\/profile\/*/) == null && rex.match(/https:\/\/live.kuaishou.com\/profile\/*/) == null){
                resourceInfo();
            }
        }
        ...
        $(".operate-record").click(throttle(function(){
            ...
            $.ajax({
                type: "post",
                url: apiHost+"/spider/browser/starLog",
                cache:false,
                data: dataRecord,
                dataType: "json",
                success: function (response) {
        ...
        $(".data-btn button").click(function(){
            ...
            // 分类id
            var cateId1 = btnId($("#skill"),$("#skill option"));
            var cateId2 = btnId($("#skill1"),$("#skill1 option"));
            var cateId3 = btnId($("#skill2"),$("#skill2 option"));
            var cate_id = [cateId1,cateId2,cateId3];
            // console.log(cate_id)
            var cateArr = [];
            cate_id.forEach(function(self,index){
                // console.log(self)
                if(self != ""){
                    cateArr.push(self)
                }
            ...
            $.ajax({
                type: "post",
                url: apiHost+"/spider/browser/update/info",
                cache:false,
                data: dataSelect,
                success: function (response) {
                    console.log(response);
        ...
        $(".talent").on("click","#bindNow",function(){
            ...
            $.ajax({
                type: "post",
                url: apiHost+"/spider/browser/doBind",
                cache:false,
                data: dataSelect,
                success: function (response) {
                    console.log(response);
        ...
        $(".confirm-success").click(function(){
            ...
            $.ajax({
                type: "post",
                url: apiHost+"/spider/browser/moveto",
                cache:false,
                data: dataTransfer,
                success: function (response) {
                    console.log(response);
        ...
        function refresh_om(){
            $("#refresh_om").on("click",throttle(function(){
                ...
                $.ajax({
                    type: "post",
                    url: apiHost+"/spider/browser/refresh",
                    cache:false,
                    data: dataRefresh,
                    success: function (response) {
                        console.log(response);
