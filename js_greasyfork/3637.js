...
///0 Main Page; 1 Search Result; 2 Video Page
...
{    
    ...
    if (PageTYPE == 0)
    {
        ...
        for(var i = 0; i < items.length; i++)
        {
            ...
            block.style.left = (link.clientWidth - 26) + "px";
...
{           
    ...
    AddStyle("YTF_BL", ".blockLINKS{position: absolute;top: 0px;visibility: hidden; z-index: 100;} .blockLINKS a:nth-child(2){line-height:normal; background-color:yellow; border: 1px solid blue; display:block;text-align:center;}");
