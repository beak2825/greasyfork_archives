...
// @name           : HWM : Progress Bar : ToolTip Mod [Old Style] :
// @name:en        : HWM : Progress Bar : ToolTip Mod [Old Style] :
...
// @downloadURL https://update.greasyfork.org/scripts/374743/%3A%20HWM%20%3A%20Progress%20Bar%20%3A%20ToolTip%20Mod%20%5BOld%20Style%5D%20%3A.user.js
// @updateURL https://update.greasyfork.org/scripts/374743/%3A%20HWM%20%3A%20Progress%20Bar%20%3A%20ToolTip%20Mod%20%5BOld%20Style%5D%20%3A.meta.js
// ==/UserScript==
...
.silentios_progress {
    ...
    background-image: -webkit-linear-gradient(#65541B, #8C7526 50%, #65541B);
    padding: 0 auto;
    box-shadow: 0 1px 1px #666, inset 0 1px 1px #222;
}
.silentios_progress_bar {
    ...
    background-image: -moz-linear-gradient(#e7ae6b, #be8d55 50%, #a57b4b 51%, #ae804c);
    background-image: -webkit-linear-gradient(#e7ae6b, #be8d55 50%, #a57b4b 51%, #ae804c);
...
.tooltip .tooltiptext::after {
    ...
    border-width: 5px;
    border-style: solid;
    border-color: transparent #65541B transparent transparent;
}
