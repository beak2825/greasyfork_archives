...
// @downloadURL https://update.greasyfork.org/scripts/522491/v%20%3D%20spikes%20f%20%3D%20trap%20n%20%3D%20mill%20%3A%29.user.js
// @updateURL https://update.greasyfork.org/scripts/522491/v%20%3D%20spikes%20f%20%3D%20trap%20n%20%3D%20mill%20%3A%29.meta.js
// ==/UserScript==
...
document.getElementById('diedText').style.color = '';
document.getElementById('gameName').style.color = '';
document.getElementById('leaderboard').style.color = '';
document.getElementById('loadingText').innerHTML = 'loading...';

document.getElementById("storeHolder").style = "height: 1500px; width: 450px;"
$('#leaderboard').append('leaderboard');

document.getElementById('ageText').style.color = '';
