// ==UserScript==
// @name         Для технических специалистов
// @namespace    https://forum.lite-crmp.ru/
// @version      1.3
// @description  для Fiery Russia
// @author       Wladimir_Leted
// @match        https://forum.lite-crmp.ru/threads/*
// @include      https://forum.lite-crmp.ru/threads/
// @grant        none
// @license  MIT
// @icon https://forum.lite-crmp.ru/data/assets/logo/1000040235.jpg
// @downloadURL https://update.greasyfork.org/scripts/511806/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/511806/%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%BE%D0%B2.meta.js
// ==/UserScript==
	...
	const PIN_PREFIX = 2; 
    const TRANSFER_PREFIXX = 20; 
    const TRANSFER_PREFIXXX = 21; 
...
},
{
  ...
  'Поясню причину и суть вашей блокировки:<br><br>'+
	'Передано руководству для выноса окончательного вердикта.<br><br>' +
  '@Ilya Suzdal<br><br>'+
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Ваша тема не как не относится к жалобам на технических специалистов, обратитесь с данной темой в <u>технический раздел вашего сервера</u> - [URL='https://forum.lite-crmp.ru/index.php?categories/Технический-раздел.139/']клик[/URL]<br><br>" +
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Ваша тема закреплена и ожидает вердикта <u>Руководства</u>.<br><br>" +
  '[CENTER]@Ilya Suzdal[/CENTER][/FONT][/SIZE]<br><br>'+
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Пожалуйста, убедительная просьба, ознакомьтесь с правилами восстановлений - [URL='https://forum.lite-crmp.ru/index.php?threads/В-каких-случаях-мы-не-восстанавливаем-игровое-имущество.435/']клик[/URL]<br> Вы создали тему, которая не относится к технической проблеме.[/CENTER]<br><br>" +
	'[CENTER][I][COLOR=rgb(139, 0, 0)]Отказано[/COLOR][/I][/CENTER][/FONT][/SIZE]',
	prefix: UNACCEPT_PREFIX,
	status: false,
},
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Ваше обращение не относится к жалобам на технических специалистов.<br> Пожалуйста ознакомьтесь с праивилами данного раздела: [URL='https://forum.lite-crmp.ru/index.php?forums/Информация-для-игроков.140/']клик[/URL] <br>" +
	'[CENTER][I][COLOR=rgb(139, 0, 0)]Отказано[/COLOR][/I][/CENTER][/FONT][/SIZE]',
	prefix: UNACCEPT_PREFIX,
	status: false,
},
...
},
{
	...
	"[CENTER]Ссылка на раздел, где можно оформить жалобу на технического специалиста - [URL='https://forum.lite-crmp.ru/index.php?categories/Жалобы-на-технических-специалистов.141/']клик[/URL] <br><br>" +
	'[CENTER][I][COLOR=rgb(139, 0, 0)]Отказано[/COLOR][/I][/CENTER][/FONT][/SIZE]',
	prefix: UNACCEPT_PREFIX,
	status: false,
},
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Вы получили наказание которое не относится к технической части, оно относится к Административной части.<br> Обратитесь в раздел Жалобы на администрацию вашего сервера.<br>Форма для подачи жалобы - [URL='https://forum.lite-crmp.ru/index.php?forums/Жалоба-на-Администратора.167/']тут[/URL]<br>" +
	'[CENTER][I][COLOR=rgb(139, 0, 0)]Закрыто[/COLOR][/I][/CENTER][/FONT][/SIZE]',
	prefix: CLOSE_PREFIX,
	status: false,
},
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Данная тема не относится к техническому разделу.<br>Данное действие было совершено игроком и нарушает правила сервера, пожалуйста обратитесь в <br>'Жалобы на игроков'<br>Вашего сервера.<br>Форма подачи жалобы - [URL='https://forum.lite-crmp.ru/index.php?forums/Жалоба-на-Игроков.170/']тык[/URL]" +
	'[CENTER][I][COLOR=rgb(139, 0, 0)]Закрыто[/COLOR][/I][/CENTER][/FONT][/SIZE]',
	prefix: CLOSE_PREFIX,
	status: false,
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Вы получили наказание от администратора своего сервера.<br> Для его снижения/обжалования обратитесь в раздел<br><<Обжалования>> вашего сервера.<br>Форма подачи темы - [URL='https://forum.lite-crmp.ru/index.php?forums/Обжалование-Наказаний.171/']клик[/URL]" +
	'[CENTER][I][COLOR=rgb(139, 0, 0)]Закрыто[/COLOR][/I][/CENTER][/FONT][/SIZE]',
	prefix: CLOSE_PREFIX,
	status: false,
},
...
},
{
    ...
    content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
    '[CENTER]Система построена таким образом, что деньги не спишутся, пока наша платформа не уведомит платежную систему о зачислении Донат-Валюты. Для проверки зачисления Донат-Валюты необходимо ввести в игре команду: /donat.<br>' +
    '[CENTER]В остальных же случаях, если не была зачислена Донат-Валюта — вероятнее всего, была допущена ошибка при вводе реквизитов. <br>В данном случае мы не восстанавливаем денежные средства согласно нашей политике оферты<br>' +
    '[CENTER]Если Вы считаете, что ошибки быть не может и с момента оплаты не прошло более 24-х часов, то в обязательном порядке обратитесь в данное сообщество для дальнейшего решения: https://t.me/Technical_Support_FR<br>' +
...
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	"[CENTER]Команда технических специалистов не решает назначение на какую-либо должность, которая присутствует на проекте.<br>Для этого существуют заявления в главном разделе форума - [URL='https://forum.lite-crmp.ru/index.php?categories/Заявление-на-пост-Лидера-Агента-Поддержки.152/'тык[/URL] , где Вы можете ознакомиться с открытыми должностями и формами подач.<br>Приятной игры и желаем удачи в карьерной лестнице!<br><br>" +
	'[CENTER][I][COLOR=rgb(139, 0, 0)]Отказано[/COLOR][/I][/CENTER][/FONT][/SIZE]',
	prefix: CLOSE_PREFIX,
	status: false,
},
{
	...
	content:
	'[SIZE=4][FONT=Verdana][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
	'[CENTER]Ваша тема не относится к технической проблеме, если вы хотите предложить изменения в игровом моде - обратитесь в раздел <br> [URL="https://forum.lite-crmp.ru/index.php?categories/Предложение-по-Улучшению.144/"] Предложения по улучшению → нажмите сюда[/URL]<br>[CENTER][I][COLOR=rgb(139, 0, 0)]Закрыто[/COLOR][/I][/CENTER][/FONT][/SIZE]' ,
	prefix: CLOSE_PREFIX,
	status: false,
},
{
