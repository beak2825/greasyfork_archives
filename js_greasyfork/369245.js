...
// @grant        unsafeWindow
// @grant        window.close
// @downloadURL https://update.greasyfork.org/scripts/369245/termpttcc%20%E8%87%AA%E5%8B%95%E7%99%BB%E5%85%A5.user.js
// @updateURL https://update.greasyfork.org/scripts/369245/termpttcc%20%E8%87%AA%E5%8B%95%E7%99%BB%E5%85%A5.meta.js
// ==/UserScript==
...
;(function() {
	...
	const XWebSocket = function(...args) {
		...
		instance.close = (...args) => {
			XWebSocket.instances = XWebSocket.filter(x => x !== instance)
	...
	unsafeWindow.onload = () => unsafeWindow.addEventListener('beforeunload', () => (closeWarning ? 'c8763' : null))
})()