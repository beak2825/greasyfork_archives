...
// @downloadURL https://update.greasyfork.org/scripts/469278/%E7%BD%91.user.js
// @updateURL https://update.greasyfork.org/scripts/469278/%E7%BD%91.meta.js
// ==/UserScript==
...
(function() {
	...
	if (window.location.host == "www.rarclouds.com" || window.location.host == "www.rarwp.com") {
		if (window.location.pathname.split("/")[1].indexOf("vip.php") == 0) {
			...
			downurl = "https://pandown.huajicloud.ml/api/rardisk?file=" + fid
			getdown.open("get", downurl);
			getdown.send(null);
		}
		return;
	...
	if (window.location.host == "www.567yun.cn" || window.location.host == "www.567file.com") {
		...
		document.getElementsByClassName("row-fluid")[1].childNodes[3].innerHTML = ""
	...
	htmlButtonElement.onclick = function() {
		...
		getDurl(function(result) {
			if (window.location.hostname == "www.eos-53.com") {
				if (result.match(/pt1/)) {
