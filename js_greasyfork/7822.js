...
// @namespace InGame
// @downloadURL https://update.greasyfork.org/scripts/7822/La-cado.user.js
// @updateURL https://update.greasyfork.org/scripts/7822/La-cado.meta.js
// ==/UserScript==
...
$(document).ready( function() {
	...
	function makeDollAppearsContainer() {
		...
		$('[id*="' + objectId + '"]').attr('src','https://i.ibb.co/8j7B8H8/ladollxcf-mini.png');
		...
		infos.find('.conteneur_image img').attr('src','https://i.ibb.co/ctjdNFc/ladollxcf-medium.png');
	...
	function send_message_to_mistress() {
		...
		$.ajax({
			type: 'POST',
			url: 'http://www.dreadcast.net/Menu/Messaging/NewMessage',
...
function saveCookie(name,val) {
	...
	if(!navigator.cookieEnabled) return;
		document.cookie = name + '=' + val + ';expires=Wed, 01 Jan 2030 00:00:00 GMT; path=/';
}
