// ==UserScript==
// @name         Autotrading (Sell) Kontinen
// @version      3
// @description  Auto buy
// @include      https://*/game.php*screen=market&mode=exchange*
// @namespace https://greasyfork.org/users/1388863
// @downloadURL https://update.greasyfork.org/scripts/536915/Autotrading%20%28Sell%29%20Kontinen.user.js
// @updateURL https://update.greasyfork.org/scripts/536915/Autotrading%20%28Sell%29%20Kontinen.meta.js
// ==/UserScript==
...
(function() {
    ...
    function village_checking() {
        let villages = [19233, 17420, 17569, 17431, 19156];
        ...
        if ( ressbyk > 1 && availableMerchant > 0) {
            ...
            if (!reloadScheduled || !reloadAt) {
                const additionalMinutes = Math.floor(Math.random() * 5) + 8; // 8–10 menit
