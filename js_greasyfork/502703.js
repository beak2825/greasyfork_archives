// ==UserScript==
// @name   🌱【免费版】水利云播|中国水利工程协会|如需高级收费版本见文档：https://doc.zhanyc.cn/pages/slyb/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制、自动下一集功能。如需过人脸识别、全自动无人值守等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*slyb.top/*
// @include    *://*slyunbo.com/*
// @grant       GM_getValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/502703/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%B0%B4%E5%88%A9%E4%BA%91%E6%92%AD%7C%E4%B8%AD%E5%9B%BD%E6%B0%B4%E5%88%A9%E5%B7%A5%E7%A8%8B%E5%8D%8F%E4%BC%9A%7C%E5%A6%82%E9%9C%80%E9%AB%98%E7%BA%A7%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccnpagesslyb.user.js
// @updateURL https://update.greasyfork.org/scripts/502703/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E6%B0%B4%E5%88%A9%E4%BA%91%E6%92%AD%7C%E4%B8%AD%E5%9B%BD%E6%B0%B4%E5%88%A9%E5%B7%A5%E7%A8%8B%E5%8D%8F%E4%BC%9A%7C%E5%A6%82%E9%9C%80%E9%AB%98%E7%BA%A7%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccnpagesslyb.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制、自动下一集功能。如需过人脸识别、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/slyb/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("ZXXX/IndexCLASS?")) {
                plugMain.page_video();
            } else if (url.includes("/Home/Index")) {
                plugMain.listenerVideoFinishBox()
            } else if (plugMain.matchUrl("/ZXXX/JXJYIndex")) {
                await plugMain.page_list();
            } else if (url.includes("/ZXXX/RZPage")) {
                plugMain.page_RZPage()
            } else if (plugMain.matchUrl("ZXXX/JXJYLXFL")) {
                await plugMain.page_list2();
            }
        },
        listenerVideoFinishBox() {
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (
                        plugMain.getElByText($("div"), "本节学习完成，请点击下一节课继续学习。") != null
                    ) {
                        plugMain.getElByText($("div"), "本节学习完成，请点击下一节课继续学习。")
                            .parents(".layui-layer:first")
                            .find(".layui-layer-btn0")[0]
                            .click();
                    }
        ...
        async page_video() {
            ...
            let timeout = 2;
            plugMain.showPaidContent(`免费版本不包含过人脸识别功能，如需使用请安装收费版本`);
            top.plugMain.listenerVideoFinishBox()
            plugMain.alertMsg("脚本启动成功，会在视频播放完毕后自动点击下一集。注意别最小化浏览器！", 10 * 1000)
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    let txt = $(".menu li:last").find("span:last").text().trim()
                    if (txt == '已完成') {
                        plugMain.pageData.waitTime = 20;
                        plugMain.confirmRun("当前课程已经学完，前往列表页面").then(a => {
                            history.back()
                        })
                        return
                    }
        ...
        async page_RZPage() {
            console.log("%c page_RZPage", "background:rgb(0,0,0);color:#fff");
            plugMain.showPaidContent(`免费版本不包含过人脸识别功能，如需使用请安装收费版本`);
        },
        async page_list2() {
            console.log("%c page_index", "background:rgb(0,0,0);color:#fff");
            await plugMain.waitOf((a) => plugMain.getElByText($("a"), "开始学习") != null || plugMain.getElByText($("a"), "继续学习") != null);
            let $btn = null
            $(".layui-table tbody tr").each((i, el) => {
                let txt = $(el).find('a.layui-btn').text()
                if (['继续学习', '开始学习'].includes(txt)) {
                    $btn = $(el).find('a.layui-btn')
                    return false
                }
            })
