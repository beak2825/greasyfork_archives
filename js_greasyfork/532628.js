...
// @downloadURL https://update.greasyfork.org/scripts/532628/_-%2A%3AGPT-MOD%3A%2A-_.user.js
// @updateURL https://update.greasyfork.org/scripts/532628/_-%2A%3AGPT-MOD%3A%2A-_.meta.js
// ==/UserScript==
...
let Config = {
    ...
    last: Date.now(),
    chat: ["♫©§☼­<­◄­ø▲►>§²¯-_®♫♀↨§", "OW U ME HACK X.+*!-?", "MI HACK IS GPT BEST HACK", "MI HACK IS GPT BEST HACK", "AND THE HACK IS CREATED BY I", "", "IS", "PRO NO noob¡"] ,
    isJson: (data) => {
        try {
            JSON.parse(data);
        } catch (e) {
