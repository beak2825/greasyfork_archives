...
// @version      2.2
// @description  CraftNite cheat client. Credits to 🄱u𝕥c🅷e𝕣_B𝙤🅈 for icon.
// @author       towelgreen
...
// @downloadURL https://update.greasyfork.org/scripts/480477/CheatNite.user.js
// @updateURL https://update.greasyfork.org/scripts/480477/CheatNite.meta.js
// ==/UserScript==
 
//credits to 🄱u𝕥c🅷e𝕣_B𝙤🅈 for icon
...
var a914 = "[joined with towelgreen's advanced CheatNite client (on Greasyfork)]";
...
var checkElementsInterval = setInterval(function() {
    ...
    if (el && discord && topleft && !playBtn.disabled) {
        ...
        anchor.textContent = "CheatNite loaded!";
