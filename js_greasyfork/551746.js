...
// @downloadURL https://update.greasyfork.org/scripts/551746/LinkedinClipperCML.user.js
// @updateURL https://update.greasyfork.org/scripts/551746/LinkedinClipperCML.meta.js
// ==/UserScript==
...
function useEffectUrl(callback) {
  let prevSlug = getProfileSlug(location.href);

  callback(location.href);

  const observer = new MutationObserver(() => {
    if (getProfileSlug(location.href) !== prevSlug) {
      prevSlug = getProfileSlug(location.href);;
      callback(location.href);
    }
  });
