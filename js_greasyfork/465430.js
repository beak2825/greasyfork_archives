...
// @connect      *
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/465430/Arcaea%20Score%20Update.user.js
// @updateURL https://update.greasyfork.org/scripts/465430/Arcaea%20Score%20Update.meta.js
// ==/UserScript==
    ...
    async function startCalcB30(songs, user_rating, user_id) {
        ...
        for (let n in querySongs) {
            ...
            const response = await new Promise((resolve, reject) => {
                RequestFunc({
                    method: "GET",
                    url: `https://webapi.lowiro.com/webapi/score/song/friend?song_id=${songId}&difficulty=${songDifficulty}&start=0&limit=30`,
                    onload: (response) => {
                        resolve(response);
                    },
