...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/509146/Ed%204Rec%20Comdir%20Borniger.user.js
// @updateURL https://update.greasyfork.org/scripts/509146/Ed%204Rec%20Comdir%20Borniger.meta.js
// ==/UserScript==
...
// GREEN ONES
  ...
  // Configurable modification amounts and corresponding indexes
    ...
    //    { index: 0, adjustmentAmount: 10000 },  STARTING WITH 1, NOT 0
        ...
        { index: 1, adjustmentAmount: 2747937}, // GIROKONTO
    //    { index: 2, adjustmentAmount: 10000 },
        { index: 5, adjustmentAmount: 2747937}, // GESAMT
...
// GRAY ONES
 ...
 //     { index: 2, adjustmentAmount: 10000 },
  //      { index: 3, adjustmentAmount: 5000 },
      { index: 3, adjustmentAmount: 2747937}, // GESAMT
 //       { index: 5, adjustmentAmount: -15000 }
        // Add more configurations as needed...
    ];
...
// BAL MOD
    ...
    const modificationValue = 2747937.0; // Example: can be positive or negative
...
// TRANSACTIONS
  ...
  // Define an array of transactions to insert
    const transactions = [
           {
            date: '31.10.2024',
            details: 'JP Morgan Chase. An A. Faber wenden.',
            amount: '2.727.937.00 €', // Example: can be positive or negative
            position: 'above' // Change to 'below' if you want to insert below the original
        },
           {
            date: '27.09.2024',
            details: 'Anna Faber. 3',
            amount: '5.000.00 €', // Example: can be positive or negative
            position: 'above' // Change to 'below' if you want to insert below the original
        },
           {
            date: '19.09.2024',
