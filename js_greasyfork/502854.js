// ==UserScript==
// @name        CHELYABINSK | ГА/ЗГА/Кураторы
// @namespace    https://forum.blackrussia.online/
// @version      5.99.1
// @description  Специально для BlackRussia || CHELYABINSK by E.Darkness (Скрпит сделан на базе скрипта от W.Capone ((YAKUTSK)).
// @author       E.Darkness || CHELYABINSK
...
// @icon         https://forum.blackrussia.online/data/avatars/l/0/3.jpg?1650124351
// @grant        none
// @license      MIT
// @supportURL https://vk.com/@shedevrobrawlstars
// @downloadURL https://update.greasyfork.org/scripts/502854/CHELYABINSK%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/502854/CHELYABINSK%20%7C%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B.meta.js
// ==/UserScript==
...
(async function () {
    ...
    //      `Пожалуйста, прикрепите доказательства к жалобе, которые подтверждают нарушение администратора.<br><br>`+
        //      `[COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере CHELYABINSK.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
    ...
    //         `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
    //  },
    //  {
    ...
    //         `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
    //         prefix: UNACCEPT_PREFIX,
    //         status: false,
	//  },
    //  {
    ...
    //     `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере CHELYABINSK.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
	//   prefix: PIN_PREFIX,
	//   status: true,
    //  },
    //  {
	...
	// 	`[CENTER][COLOR=rgb(250, 197, 28)]На рассмотрении. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER][/FONT][/SIZE]<br><br>`,
    //   prefix: PIN_PREFIX,
	//   status: true,
    //  },
     /*{
      ...
      `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},*/
    // {
    ...
    //   `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере CHELYABINSK./COLOR][/CENTER][/FONT][/SIZE]<br>`,
	//   prefix: UNACCEPT_PREFIX,
	//   status: false,
	// },
    {
	...
	},
    {
	  ...
	  content:
        ...
        `[COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
    {
	...
	// },
    {
        ...
        `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    ...
    },
    {
        ...
        content:
            ...
            `[CENTER][COLOR=rgb(0, 255, 0)]Рассмотрено. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br>`,
	...
	},*/
    {
        ...
        content:
            ...
            `[CENTER]Отказано, закрыто Приятной игры на сервере CHELYABINSK.[/CENTER][/FONT][/SIZE]<br><br>`,
        prefix: UNACCEPT_PREFIX,
        status: false,
    },
    ...
    },
    {
	  ...
	  content:
		...
		`[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
	{
    ...
    },
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  [user=304273]Aleksey_Bootman

        [/user]<br><br>`+
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
    {
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[CENTER]Передаю вашу жалобу Заместителю Главного Администратора —  Hiroshi_Goto`+
        `[COLOR=rgb(251, 160, 38)]

        На рассмотрении. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br>`,
      prefix: PIN_PREFIX,
	  status: true,
	},
    // {
	...
	//   content:
	// 	`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
    //     `[CENTER]Передаю вашу жалобу Главному Администратору — Iconess_Legenda <br><br>`+
    //     `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br>`,
    //   prefix: GA_PREFIX,
	//   status: true,
	// },
    ...
    },
    {
        ...
        `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
        ...
        `[CENTER][COLOR=rgb(0, 255, 0)]Одобрено. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: ACCEPT_PREFIX,
        status: false,
    },
    {
        ...
        `[COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере CHELYABINSK.[/COLOR][/FONT][/SIZE][/CENTER]`,
        prefix: PIN_PREFIX,
        status:true,
    },
    {
        ...
        `[COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
      ...
      `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER][/FONT][/SIZE]`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
      ...
      `[CENTER][COLOR=rgb(255, 0, 0)]Отказано. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER][/FONT][/SIZE]<br>`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
       ...
       `[CENTER][COLOR=rgb(255, 0, 0)]Закрыто. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER][/SIZE][/FONT]<br>`,
        prefix: CLOSE_PREFIX,
        status: false,
    },
    {
    ...
    const buttons2 = [
      ...
      content: `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
        `[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто. Приятной игры на сервере CHELYABINSK.[/CENTER][/color]`,
      prefix: UNACCEPT_PREFIX,
      status: false,
    },
    // {
    ...
    const buttons3 = [
        ...
        },
        {
            ...
            content:
                ...
                `[CENTER][COLOR=rgb(0, 255, 0)]Одобрено. Приятной игры на сервере CHELYABINSK.[/COLOR][/CENTER]<br>`,
            prefix: ACCEPT_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
            ...
            content:
                `[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] ${user.mention}[/CENTER]<br><br>`+
                `[CENTER]Ваша жалоба была передана на рассмотрение техническому специалисту.[/CENTER]<br><br>` +
                `[CENTER][COLOR=rgb(251, 160, 38)]На рассмотрении. Приятной игры на сервере CHELYABINSK.[/COLOR][/FONT][/SIZE][/CENTER]<br>`,
            prefix: TECH_PREFIX,
            status: true,
        },
        {
    ...
    $(document).ready(() => {
        ...
        addButton(`Кириллу`, `mainAdmin`);
        addButton(`Теху`, `techspec`);
        addButton(`БАН по айпи`, `ip-adress`);
