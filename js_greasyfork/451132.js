...
// @require      https://greasyfork.org/scripts/450948-reader/code/Reader.js?version=1096860
...
// @downloadURL https://update.greasyfork.org/scripts/451132/yth%E9%9A%8F%E6%89%8B%E5%B0%8F%E8%AF%B4%E4%B8%8B%E8%BD%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/451132/yth%E9%9A%8F%E6%89%8B%E5%B0%8F%E8%AF%B4%E4%B8%8B%E8%BD%BD.meta.js
// ==/UserScript==
(function () {
    'use strict';
    ...
    const SETTING_KEYS = ["listSelector", "textSelector", "jammerSelector", "frameText", "customListFunc", "customItemFunc", "customTextFunc"];
    ...
    function getRestList(doc){
        ...
        function downGetList(doc){
            ...
            console.log('nextListHref',nextListHref);
    ...
    function getElementText(element) { //参考“怠惰小说下载器”
        ...
        for (let childNode of element.childNodes) {
            ...
            var text='';
            if(typeof childNode.innerText=='string') text = childNode.innerText;
            else text=childNode.textContent||'';
            text = text.replace(/[\u00A0\u2002\u2003\u2005\u200C\u200D]/g, '');
