// ==UserScript==
// @name         HWM Favourite Smith
// @namespace    https://greasyfork.org/ru/scripts/419026-hwm-favourite-smith
// @version      0.11
// @description  Выбрать любимого кузнеца
// @author       achepta
...
// @grant    GM_log
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/419026/HWM%20Favourite%20Smith.user.js
// @updateURL https://update.greasyfork.org/scripts/419026/HWM%20Favourite%20Smith.meta.js
// ==/UserScript==
...
(function (window, undefined) {
	...
	function processSmith2() {
		...
		if (!isNaN(inputValue) && inputValue !== 0) {
			set("fav_smith_percent", $('smith-percent').value - 0)
			smith3()
		}
	}
	...
	function main() {
		...
		if (nickname) {
			arts.forEach(art => {
				if (art.durability1 === 0 && art.transfer_ok === 1) {
					getArtInfo(art.art_id, art.id)
				}
			})
		}
	}
