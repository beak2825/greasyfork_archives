...
// @downloadURL https://update.greasyfork.org/scripts/563974/%E3%83%AC%E3%82%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/563974/%E3%83%AC%E3%82%B0.meta.js
// ==/UserScript==
...
class NoFog extends Module {
    ...
    const module_moduleManager = {
        ...
        init() {
            this.addModules(new ArrayList, new Watermark, new ClickGUI, new Airjump, new Instabreak, new Nuker, new AdBypass, new Fly, new Speed, new FreeHeadcoins, new Fill, new Chams, new FOVChanger, new Scaffold, new Killaura, new GunModifier, new Disabler, new Aimbot, new NoClip, new HitAllModule, new TeleportModule, new NoFog, new CustomCrosshair, new HitModule), events.on("render", (() => {
