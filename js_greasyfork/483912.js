...
// @downloadURL https://update.greasyfork.org/scripts/483912/For%20guidance%20by%20Kokojambo.user.js
// @updateURL https://update.greasyfork.org/scripts/483912/For%20guidance%20by%20Kokojambo.meta.js
// ==/UserScript==
...
const buttons = [
...

    {
        ...
        content:
        '[CENTER][/CENTER]' +
        	'[Color=#F984E5][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]' +
	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
        '[Color=#F984E5][CENTER][B]С уважением Главный Администратор сервера ORENBURG .[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
      ...
      '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
        "[COLOR=#F984E5][CENTER][B]С уважением Главный Администратор сервера ORENBURG[/CENTER][/B][/COLOR]",
...
'[Color=white][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]'+
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
	"[CENTER][B][COLOR=#F984E5]С уважением Главный Администратор сервера ORENBURG [/B][/CENTER][/COLOR]",
      prefix: PIN_PREFIX,
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
	...
	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
            '[Color=#F984E5][CENTER][B]Закрыто.[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
        {
	...
	},
    {
        ...
        "[B][CENTER]Ваш аккаунт будет разблокирован на 24 часа, за это время вам необходимо изменить свой nickname. Доказательства прикрепить в данной теме.[/B][/CENTER]"+
        	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
        '[B][COLOR=#F984E5][CENTER] С уважением Главный Администратор сервера ORENBURG [/B][/CENTER][/COLOR]',
        prifix: PIN_PREFIX,
        status: true,
    },
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
		'[Color=#F984E5][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]',
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
	  ...
	  status: true,
	...
	},
       {
        ...
        '[CENTER][/CENTER]' +
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/P5zSrgJ9/Picsart-24-01-05-02-59-12-637.png[/img][/url][/CENTER]' +
        "[B][CENTER][COLOR=#F984E5]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER][/B]<br><br>" +
		"[B][CENTER][Color=#F984E5] Запрошу доказательства у [/color][/CENTER][/B]данного администратора.<br><br>" +
