...
// @grant       GM_addStyle
// @version     3.0.1-fixed
// @author      Deepseek ChatGPT
// @require     https://cdn.jsdelivr.net/npm/@violentmonkey/dom@2
// @description 禁漫天堂去广告、优化布局
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/554101/jm-remove-ad%EF%BC%88%E6%94%B9%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/554101/jm-remove-ad%EF%BC%88%E6%94%B9%EF%BC%89.meta.js
// ==/UserScript==
...
const ADS_SELECTORS = [
  ...
  `div[style*="position: fixed"]:has(iframe[scrolling="no"])` // 本子阅读页 底部弹窗广告
];

GM_addStyle(`
  /* 阅读页底部弹窗广告（固定定位 + iframe） */
  div[style*="position: fixed"]:has(iframe[scrolling="no"]) {
  ...
  /* 阅读页顶部与底部广告容器（防止闪烁） */
  [data-group*="photo_center"],
  [data-group*="photo_bottom"] {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
  }
