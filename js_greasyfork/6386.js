...
// @description    Отображение максимального числа сотрудников, которое держит топ,
// @description    также максимальной технологии установленной в подразделении. 
// @description    Показ процентного соотношения зарплаты от среднегородской.
// @description    Добавлена информация Нагрузка топ-3 120%  остаток / общее
...
// @downloadURL https://update.greasyfork.org/scripts/6386/iks%3Avirtonomic_kvala_personal_indicator_zarplaty.user.js
// @updateURL https://update.greasyfork.org/scripts/6386/iks%3Avirtonomic_kvala_personal_indicator_zarplaty.meta.js
// ==/UserScript==
...
var run = function() {
    ...
    $("td:contains('Суммарное')").next().each(function() {
        ...
        str+='<br>Свободно рабов 120%: <b>'+Math.floor(pers*1.2-total)+'<b> / <b>'+Math.floor(pers*1.2)+'</b>';
        str+= '</b></font>';
