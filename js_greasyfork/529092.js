...
// @license      GPL-3.0
// @downloadURL https://update.greasyfork.org/scripts/529092/MoviePilot-V1%E8%87%AA%E5%8A%A8%E7%99%BB%E5%BD%95.user.js
// @updateURL https://update.greasyfork.org/scripts/529092/MoviePilot-V1%E8%87%AA%E5%8A%A8%E7%99%BB%E5%BD%95.meta.js
// ==/UserScript==
...
(function () {
    ...
    function autoLogin() {
        let usernameInput = document.querySelector('input[id="input-0"]');
        let passwordInput = document.querySelector('input[id="input-2"]');
        ...
        setInterval(() => {
            if (window.location.href.includes('/#/login')) {
                let checkLoginForm = setInterval(() => {
                    if (document.querySelector('input[id="input-0"]') && document.querySelector('input[id="input-2"]')) {
