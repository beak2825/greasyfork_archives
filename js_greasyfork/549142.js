...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/549142/Previo%20Redmine%20Spent%20Time.user.js
// @updateURL https://update.greasyfork.org/scripts/549142/Previo%20Redmine%20Spent%20Time.meta.js
// ==/UserScript==
...
(function () {
    ...
    var PrevioSpentTime = {
        ...
        outputIssues: function(){
            if(PrevioSpentTime.outputted){
                return;
            }
            PrevioSpentTime.outputted = true;
