...
// @grant        GM_addStyle
// @license 0x88
// @downloadURL https://update.greasyfork.org/scripts/505690/Forum%20Enhancement.user.js
// @updateURL https://update.greasyfork.org/scripts/505690/Forum%20Enhancement.meta.js
// ==/UserScript==
...
.button.primary.block:active {
    ...
    // Обработка для ника goodplayer
        ...
        if (k1erry) {
            createRainbowText(k1erry, 'Спонсор Анимок 0х88, 111RUB', '💰');
        }
})();