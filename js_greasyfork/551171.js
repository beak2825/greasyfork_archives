// ==UserScript==
// @name        NAV-Reporte de programa de citas de descarga
...
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/551171/NAV-Reporte%20de%20programa%20de%20citas%20de%20descarga.user.js
// @updateURL https://update.greasyfork.org/scripts/551171/NAV-Reporte%20de%20programa%20de%20citas%20de%20descarga.meta.js
// ==/UserScript==
...
(function() {
    ...
    async function fetchShipmentActivityLog(uuid) {
        ...
        const url = "https://yard-visibility-na12.api.project44.com/v1/shipment/activity-log/search?start=1&end=10&shipment_id=" + 
            encodeURIComponent(uuid) + "&site=nava&activity_type=arrival";
    ...
    function buildSearchUrl(params) {
        let baseUrl = "https://yard-visibility-na12.api.project44.com/v1/shipment/delivery/search?module=listing&site=nava&gateAppt=true";
                    ...
                    try {
                        ...
                        if (assetLog && assetLog.data && assetLog.data.length > 0) {
                            ...
                            for (const logEntry of assetLog.data) {
                                ...
                                // Get comment data from snapshot_details.asset_details.comment when site is not "nava"
                                if (logEntry.site !== 'nava' && 
