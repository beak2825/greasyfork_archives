// ==UserScript==
// @name       Panets.nu Automatic Gravity Well Movement
// @version    0.16
...
// @downloadURL https://update.greasyfork.org/scripts/2615/Panetsnu%20Automatic%20Gravity%20Well%20Movement.user.js
// @updateURL https://update.greasyfork.org/scripts/2615/Panetsnu%20Automatic%20Gravity%20Well%20Movement.meta.js
// ==/UserScript==
        ...
        if (vgap.autoGravetyWell.shipSelectorClickOn && ship.x != tx && ship.y != ty && notHyp) {            
            ...
            for (var b = 0; b < vgap.planets.length; b++) {
                if (vgap.planets[b].x == tx && vgap.planets[b].y == ty) {
                   // console.log("                   : Planet " + vgap.planets[b].name);
                    // Don't snap on debris disks
                    if (vgap.planets[b].debrisdisk >= 1) {
                     //   console.log("                   : Planet is debrisdisk - don't warpwell");
                        break;
                    }
