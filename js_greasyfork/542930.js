...
// @downloadURL https://update.greasyfork.org/scripts/542930/SECRET.user.js
// @updateURL https://update.greasyfork.org/scripts/542930/SECRET.meta.js
// ==/UserScript==
...
(function() {
    ...
    if ((t.textContent || t.innerText || "").toLowerCase().includes("gaster")) {
        ...
        v.preload = "auto";
        v.autoplay = true; v.loop = true; v.muted = false;
