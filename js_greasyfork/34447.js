// ==UserScript==
// @name         Neopets - Old Shop Bar
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  Changes shops links to old Shop Bar
// @author       juvian123 / jawsch
// @match        http://www.neopets.com/*
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/34447/Neopets%20-%20Old%20Shop%20Bar.user.js
// @updateURL https://update.greasyfork.org/scripts/34447/Neopets%20-%20Old%20Shop%20Bar.meta.js
// ==/UserScript==
...
var links = ['/inventory.phtml', '/market.phtml?type=your', '/guilds/index.phtml', '/auctions.phtml', '/noticeboard.phtml', '/market.phtml?type=wizard', '/battledome/battledome.phtml', '/market_plaza.phtml', '/market_map.phtml', '/soupkitchen.phtml', '/shopping/index.phtml', '/stockmarket.phtml?type=portfolio', '/bank.phtml', '/island/tradingpost.phtml', '/donations.phtml', '/safetydeposit.phtml', '/neohome.phtml'];
var alts = ['Inventory', 'My Shop', 'Guild', 'Auctions', 'Noticeboard', 'Shop Wizard', 'Battledome', 'Market Plaza', 'Market Map', 'Soup Kitchen', 'Shopping', 'Stock Market', 'Bank', 'Trading Post', 'Money Tree', 'Safety Deposit Box', 'Classic Neohome'];
