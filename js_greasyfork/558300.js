...
// @grant        GM_addStyle
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/558300/TP%20Overhaul.user.js
// @updateURL https://update.greasyfork.org/scripts/558300/TP%20Overhaul.meta.js
// ==/UserScript==
...
/* Le conteneur interne s’adapte à la largeur du terminal */
#tpo_content {
    width: 100%;
    max-height: 60vh;
    overflow: auto;
    box-sizing: border-box;
    padding-right: 6px; /* Pour laisser respirer la scrollbar */
}

/* Le header suit la largeur */
#tpo_header {
    width: 100%;
    box-sizing: border-box;
}
