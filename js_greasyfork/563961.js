...
// @downloadURL https://update.greasyfork.org/scripts/563961/f4.user.js
// @updateURL https://update.greasyfork.org/scripts/563961/f4.meta.js
// ==/UserScript==
...
(function () {
    ...
    /** ===== 你要改的内容 ===== */
    const NEW_CODE  = "T2874898210";
    const NEW_SEAT  = "Reserved Seat FLOOR Side F4. Row 12. 13";
    const NEW_PRICE = "₩143,000(General)";
    const NEW_NAME  = "GAO ZHOULE";
    const NEW_MASK  = "(**0616)";
    ...
    function modifyDetail(root = document) {
        root.querySelectorAll('div.ticket-detail_ticketInfo__2knEE').forEach(div => {
            ...
            if (h2s.length >= 2) {
                h2s[0].textContent = "26.01.25(Sun) 18:00"; // 原日期，如果你想修改可改
                h2s[1].textContent = NEW_SEAT;
            }
