// ==UserScript==
// @name           RatingR4 CN
// @version        5.1.0.2017122503
// @description    REREC(+b), Season TI, RatingR4(beta) JP/EN/CN
...
// @namespace   RatingR4 
// @downloadURL https://update.greasyfork.org/scripts/19755/RatingR4%20CN.user.js
// @updateURL https://update.greasyfork.org/scripts/19755/RatingR4%20CN.meta.js
// ==/UserScript==
var wage_rate = 15.8;
var weightR4 = [
  [0.51872935,
...
var positionFullNames = [
  ...
  'Midfielder Left',
  'Midfielder Right',
  'Offensive Midfielder Center',
  'Offensive Midfielder Left',
  'Offensive Midfielder Right',
  'Forward',
  'Goalkeeper'],
  /* JP */
  [
  ...
  [
    ...
    'Forsvar Venstre',
    'Forsvar Højre',
    'Defensiv Midtbane Centralt',
    'Defensiv Midtbane Venstre',
    'Defensiv Midtbane Højre',
    'Midtbane Centralt',
    'Midtbane Venstre',
    'Midtbane Højre',
    'Offensiv Midtbane Centralt',
    'Offensiv Midtbane Venstre',
    'Offensiv Midtbane Højre',
    'Angriber',
    'Målmand'
  ],
  /* I  */
  [
    ...
    'Difensore Sinistro',
    'Difensore Destro',
    'Centrocampista Difensivo Centrale',
    'Centrocampista Difensivo Sinistro',
    'Centrocampista Difensivo Destro',
    'Centrocampista Centrale',
    'Centrocampista Sinistro',
    'Centrocampista Destro',
    'Centrocampista Offensivo Centrale',
    'Centrocampista Offensivo Sinistro',
    'Centrocampista Offensivo Destro',
    'Attaccante',
    'Portiere'
  ],
  /* H  */
  [
    ...
    'Mediocampista Defensivo Izquierdo',
    'Mediocampista Defensivo Derecho',
    'Mediocampista Central',
    'Mediocampista Izquierdo',
    'Mediocampista Derecho',
    'Mediocampista Ofensivo Central',
    'Mediocampista Ofensivo Izquierdo',
    'Mediocampista Ofensivo Derecho',
    'Delantero',
    'Portero'
  ],
  /* F  */
  ...
  [
    ...
    'Obrambeni Lijevo',
    'Obrambeni Desno',
    'Defenzivni vezni Sredina',
    'Defenzivni vezni Lijevo',
    'Defenzivni vezni Desno',
    'Vezni Sredina',
    'Vezni Lijevo',
    'Vezni Desno',
    'Ofenzivni vezni Sredina',
    'Ofenzivni vezni Lijevo',
    'Ofenzivni vezni Desno',
    'Napadač',
    'Golman'
  ],
  /* G  */
  [
    ...
    'Verteidiger Links',
    'Verteidiger Rechts',
    'Defensiver Mittelfeldspieler Zentral',
    'Defensiver Mittelfeldspieler Links',
    'Defensiver Mittelfeldspieler Rechts',
    'Mittelfeldspieler Zentral',
    'Mittelfeldspieler Links',
    'Mittelfeldspieler Rechts',
    'Offensiver Mittelfeldspieler Zentral',
    'Offensiver Mittelfeldspieler Links',
    'Offensiver Mittelfeldspieler Rechts',
    'Stürmer',
    'Torhüter'
  ],
  /* PO */
  [
    ...
    'Médio Defensivo Direito',
    'Medio Centro',
    'Medio Esquerdo',
    'Medio Direito',
    'Medio Ofensivo Centro',
    'Medio Ofensivo Esquerdo',
    'Medio Ofensivo Direito',
    'Avançado',
    'Guarda-Redes'
  ],
  /* R  */
  [
    ...
    'Fundas Stânga',
    'Fundas Dreapta',
    'Mijlocas Defensiv Central',
    'Mijlocas Defensiv Stânga',
    'Mijlocas Defensiv Dreapta',
    'Mijlocas Central',
    'Mijlocas Stânga',
    'Mijlocas Dreapta',
    'Mijlocas Ofensiv Central',
    'Mijlocas Ofensiv Stânga',
    'Mijlocas Ofensiv Dreapta',
    'Atacant',
    'Portar'
  ],
  /* T  */
  [
    ...
    'Defans Sol',
    'Defans Sağ',
    'Defansif Ortasaha Orta',
    'Defansif Ortasaha Sol',
    'Defansif Ortasaha Sağ',
    'Ortasaha Orta',
    'Ortasaha Sol',
    'Ortasaha Sağ',
    'Ofansif Ortasaha Orta',
    'Ofansif Ortasaha Sol',
    'Ofansif Ortasaha Sağ',
    'Forvet',
    'Kaleci'
  ],
  /* RU */
  ...
  [
    ...
    'Obránce Levý',
    'Obránce Pravý',
    'Defenzivní Záložník Střední',
    'Defenzivní Záložník Levý',
    'Defenzivní Záložník Pravý',
    'Záložník Střední',
    'Záložník Levý',
    'Záložník Pravý',
    'Ofenzivní záložník Střední',
    'Ofenzivní záložník Levý',
    'Ofenzivní záložník Pravý',
    'Útočník',
    'Gólman'
  ],
  /* HU */
  [
    ...
    'Védő , bal oldali',
    'Védő , jobb oldali',
    'Védekező Középpályás , középső',
    'Védekező Középpályás , bal oldali',
    'Védekező Középpályás , jobb oldali',
    'Középpályás , középső',
    'Középpályás , bal oldali',
    'Középpályás , jobb oldali',
    'Támadó középpályás , középső',
    'Támadó középpályás , bal oldali',
    'Támadó középpályás , jobb oldali',
    'Csatár',
    'Kapus'
  ],
  /* GE */
  [
    ...
    'მცველი მარცხენა',
    'მცველი მარჯვენა',
    'საყრდენი ნახევარმცველი ცენტრალური',
    'საყრდენი ნახევარმცველი მარცხენა',
    'საყრდენი ნახევარმცველი მარჯვენა',
    'ნახევარმცველი ცენტრალური',
    'ნახევარმცველი მარცხენა',
    'ნახევარმცველი მარჯვენა',
    'შემტევი ნახევარმცველი ცენტრალური',
    'შემტევი ნახევარმცველი მარცხენა',
    'შემტევი ნახევარმცველი მარჯვენა',
    'თავდამსხმელი',
    'მეკარე'
  ],
  /* FI */
  [
    ...
    'Puolustaja Vasen',
    'Puolustaja Oikea',
    'Puolustava Keskikenttä Keski',
    'Puolustava Keskikenttä Vasen',
    'Puolustava Keskikenttä Oikea',
    'Keskikenttä Keski',
    'Keskikenttä Vasen',
    'Keskikenttä Oikea',
    'Hyökkäävä Keskikenttä Keski',
    'Hyökkäävä Keskikenttä Vasen',
    'Hyökkäävä Keskikenttä Oikea',
    'Hyökkääjä',
    'Maalivahti'
  ],
  /* SV */
  [
    ...
    'Försvarare Vänster',
    'Försvarare Höger',
    'Defensiv Mittfältare Central',
    'Defensiv Mittfältare Vänster',
    'Defensiv Mittfältare Höger',
    'Mittfältare Central',
    'Mittfältare Vänster',
    'Mittfältare Höger',
    'Offensiv Mittfältare Central',
    'Offensiv Mittfältare Vänster',
    'Offensiv Mittfältare Höger',
    'Anfallare',
    'Målvakt'
  ],
  /* NO */
  [
    ...
    'Forsvar Venstre',
    'Forsvar Høyre',
    'Defensiv Midtbane Sentralt',
    'Defensiv Midtbane Venstre',
    'Defensiv Midtbane Høyre',
    'Midtbane Sentralt',
    'Midtbane Venstre',
    'Midtbane Høyre',
    'Offensiv Midtbane Sentralt',
    'Offensiv Midtbane Venstre',
    'Offensiv Midtbane Høyre',
    'Angrep',
    'Keeper'
  ],
  /* SC */
  [
    ...
    'Defensive Midfielder Left',
    'Defensive Midfielder Richt',
    'Midfielder Centre',
    'Midfielder Left',
    'Midfielder Richt',
    'Offensive Midfielder Centre',
    'Offensive Midfielder Left',
    'Offensive Midfielder Richt',
    'Forward',
    'Goalkeeper'
  ],
  /* VL */
  [
    ...
    'Verdediger Links',
    'Verdediger Rechts',
    'Verdedigende Middenvelder Centraal',
    'Verdedigende Middenvelder Links',
    'Verdedigende Middenvelder Rechts',
    'Middenvelder Centraal',
    'Middenvelder Links',
    'Middenvelder Rechts',
    'Aanvallende Middenvelder Centraal',
  ...
  [
    ...
    'Meia Ofensivo Central',
    'Meia Ofensivo Esquerdo',
    'Meia Ofensivo Direito',
    'Atacante',
    'Goleiro'
  ],
  /* GR */
  [
    ...
    'Αμυντικός Αριστερός',
    'Αμυντικός Δεξιός',
    'Αμυντικός Μέσος Κεντρικός',
    'Αμυντικός Μέσος Αριστερός',
    'Αμυντικός Μέσος Δεξιός',
    'Μέσος Κεντρικός',
    'Μέσος Αριστερός',
    'Μέσος Δεξιός',
    'Επιθετικός μέσος Κεντρικός',
    'Επιθετικός μέσος Αριστερός',
    'Επιθετικός μέσος Δεξιός',
    'Επιθετικός',
    'Τερματοφύλακας'
  ],
  /* BG */
  [
    ...
    'Защитник Ляв',
    'Защитник Десен',
    'Дефанзивен Халф Централен',
    'Дефанзивен Халф Ляв',
    'Дефанзивен Халф Десен',
    'Халф Централен',
    'Халф Ляв',
    'Халф Десен',
    'Атакуващ Халф Централен',
    'Атакуващ Халф Ляв',
    'Атакуващ Халф Десен',
    'Нападател'
  ],
...
if (location.href.indexOf('/players/') != - 1) {
  ...
  function computeRating(table, skills) {
    ...
    if (FP[0] != FP[1]) {
      ...
      minR[0] = funFix2(REREC[2][FP[0]] * (65 / 93 + (1 - (20 - skills[1]) * 6.2 / 200) * 28 / 93)) + '/' + funFix2(REREC[2][FP[1]] * (65 / 93 + (1 - (20 - skills[1]) * 6.2 / 200) * 28 / 93));
      ...
      minR[0] = funFix2(REREC[2][FP[0]] * (65 / 93 + (1 - (20 - skills[1]) * 6.2 / staGK / 200) * 28 / 93));
      var ratingR4 = rattd.innerHTML;
      var rouEffect = funFix2(REREC[2][FP[0]] * 1 - REREC[1][FP[0]] * 1);
      var R4Pure = REREC[1][FP[0]];
      var ratingR2 = funFix2(R4Pure * (1 + rou * 0.4 * 0.00405));
    }
    recth.innerHTML = '<b style="color: white;">评级B</b>';
    recbth.innerHTML = '<b style="color: white;">评级A</b>';
    ratth.innerHTML = '<b style="color: white;">RatingR4</b>';
    ...
    gettr[6].getElementsByTagName('th') [0].appendChild(ratth);
    gettr[6].getElementsByTagName('td') [0].appendChild(rattd);
    ...
    if (positionIndex != 13) {
      ...
      var CK = funFix2((skills[8] + skills[13] + skills[9] / 2 + rou2 * 2.5)*0.3);
      var FK = funFix2((skills[12] + skills[13] + skills[9] / 2 + rou2 * 2.5)*0.3);
      var PK = funFix2((skills[11] + skills[13] + skills[9] / 2 + rou2 * 2.5)*0.3);
      div_area.innerHTML = '<div style="position: absolute; z-index: 1; width: 175px; margin-top: 10px; background: #5F8D2D; padding-left: 5px; color: white; border: 2px #333333 outset; display:inline;"><table style="margin-top: 3px; margin-bottom: 6px;"><tr><td>身体属性之和: </td><td>' + phySum + ' (' + Math.round(phySum / peak[0] * 5) + '%)</td></tr><tr><td>战术属性之和: </td><td>' + tacSum + ' (' + Math.round(tacSum / peak[1] * 5) + '%)</td></tr><tr><td>技术属性之和: </td><td>' + tecSum + ' (' + Math.round(tecSum / peak[2] * 5) + '%)</td></tr><tr><td>总属性之和: </td><td>' + allSum + ' + ' + remainder + ' </td></tr><tr><td></td><td>&nbsp;</td></tr><tr><td>角球: </td><td>' + CK + '</td></tr><tr><td>直接任意球: </td><td>' + FK + '</td></tr><tr><td>点球评值: </td><td>' + PK + '</td></tr></tr><tr><td>&nbsp;</td></tr><tr><td>原始Rating4: </td><td>' + R4Pure + '</td></tr><tr><td>经验影响: </td><td>' + rouEffect + ' </td></tr><tr><td>RatingR4: </td><td>' + ratingR4 + ' </td></tr><tr><tr><td>65 分钟: </td><td>' + minR[1] + ' </td></tr><tr><td>75 分钟: </td><td>' + minR[2] + ' </td></tr><tr><td>85 分钟: </td><td>' + minR[4] + ' </td></tr><tr><td>全场平均: </td><td>' + minR[0] + ' </td></tr><td>RatingR2: </td><td>' + ratingR2 + ' </td></tr></table></b></div>';
    } 
    else {
      var peak = [
        4,
      ...
      div_area.innerHTML = '<div style="position: absolute; z-index: 1; width: 175px; margin-top: 10px; background: #5F8D2D; padding-left: 5px; color: white; border: 2px #333333 outset; display:inline;"><table style="margin-top: 3px; margin-bottom: 6px;"><tr><td>身体属性之和: </td><td>' + phySum + ' (' + Math.round(phySum / peak[0] * 5) + '%)</td></tr><tr><td>战术属性之和: </td><td>' + tacSum + ' (' + Math.round(tacSum / peak[1] * 5) + '%)</td></tr><tr><td>技术属性之和: </td><td>' + tecSum + ' (' + Math.round(tecSum / peak[2] * 5) + '%)</td></tr><tr><td>总属性之和: </td><td>' + allSum + ' + ' + remainder + ' </td></tr><tr><td></td><td>&nbsp;</td></tr><tr><td>原始Rating4: </td><td>' + R4Pure + '</td></tr><tr><td>经验影响: </td><td>' + rouEffect + ' </td></tr><tr><td>RatingR4: </td><td>' + ratingR4 + ' </td></tr><tr><td>65 分钟: </td><td>' + minR[1] + ' </td></tr><tr><td>75 分钟: </td><td>' + minR[2] + ' </td></tr><tr><td>85 分钟: </td><td>' + minR[4] + ' </td></tr><tr><td>全场平均: </td><td>' + minR[0] + ' </td></tr><tr><td>RatingR2: </td><td>' + ratingR2 + ' </td></tr></table></b></div>';
    }
    ...
    if (hidden[0].innerHTML != '') {
      ...
      if (positionIndex != 13) {
        ...
        div.setAttribute('style', 'position: absolute; z-index: 1; width: 175px; margin-top: 380px; background: #5F8D2D; padding-left: 5px; border: 2px #333333 outset; display:inline;');
        div.innerHTML = '<p><b>RatingR4: 全位置</b></p>';
  ...
  function seasonTI(playerID, gettr, SI) {
    ...
    var today = new Date();
    var SS = new Date('10 31 2016 10:30:00 GMT'); // season start
    var training1 = new Date('10 31 2016 22:00:00 GMT'); // first training (summur time 23:00, other 22:00)
    ...
    if (wage == 30000 || (playerID > 116961439 && count == 0)) { // s48 youth player ID
      sitd.innerHTML = '---';
    } 
    else {
