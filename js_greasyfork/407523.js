// ==UserScript==
// @name         Agma.io Bots 2019
// @namespace    http://200bots.ga/#AgmaBots
// @version      0.1
...
// @downloadURL https://update.greasyfork.org/scripts/407523/Agmaio%20Bots%202019.user.js
// @updateURL https://update.greasyfork.org/scripts/407523/Agmaio%20Bots%202019.meta.js
// ==/UserScript==
...
function pushBots114514(gsv) {
    ...
    window.pushDayo = setInterval(() => {
        if(ii > 102) return;
        window.bots.push(new test114514(sv));
        ii++;
    }, 200);
}
...
window.onload = function() {
    ...
    //for (let i = 0; i < 110; i++) window.bots.push(new test114514());
    window.test364364 = setserver;
