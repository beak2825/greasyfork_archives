...
// @downloadURL https://update.greasyfork.org/scripts/27141/Hybrid%20-%20Calls%20-%20Mailing%20Address.user.js
// @updateURL https://update.greasyfork.org/scripts/27141/Hybrid%20-%20Calls%20-%20Mailing%20Address.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Mailing Address")').length) {
    ...
    createButton('No', 0,0,3,'');
    createButton('Biz on VM', 0,0,3,'Business on voicemail');
    createButton('Wrong Biz', 0,1,3,'');
    createButton('DC', 2,2,3,'Disconnected');
    createButton('Fax', 3,2,3,'Fax');
    createButton('Generic VM', 0,2,3,'Voicemail has no info'); //3
    createButton('Ringing', 1,2,3,'Kept ringing'); //3
    createButton('Silence', 0,2,3,'Rang until silence'); //3
    createButton('Busy', 0,2,3,'Busy Signal'); //3
    createButton('No Addy VM', 0,0,3,'Voicemail without address'); //3
    createButton('Hung Up', 0,2,3,'Hung up on me');
