...
// @downloadURL https://update.greasyfork.org/scripts/438057/BLACK%20RUSSIA%3A%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/438057/BLACK%20RUSSIA%3A%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D1%85%20%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%BE%D0%B2.meta.js
// ==/UserScript==
	...
	},
{
	...
	{ 
	  ...
	  content:
	    ...
	    "[CENTER]• Сменить IP-адрес любыми средствами; <br>" +
   "[CENTER]• Переключиться на Wi-Fi/мобильный интернет или на любую доступную сеть; <br>"+
    "[CENTER]• Использование VPN; <br>"+
    "[CENTER]• Перезагрузка роутера.<br>" +

"[CENTER]Если методы выше не помогли, то переходим к следующим шагам: <br>" +
   
  '[CENTER]1. Устанавливаем приложение «1.1.1.1: Faster & Safer Internet» Ссылка: https://clck.ru/ZP6Av и переходим в него.<br>'+
  '[CENTER]2. Соглашаемся со всей политикой приложения.<br>'+
  '[CENTER]3. Нажимаем на ползунок и ждем, когда текст изменится на «Подключено».<br>'+
  '[CENTER]4. Проверяем: Отображаются ли серверы? Удается ли выполнить вход в игру? Работают ли другие источники (сайт, форум)? <br>' +
...
$(`button#selectAnswer`).click(() => {
  XF.alert(buttonsMarkup(buttons), null, '✌️Добавьте ответ:✌️');
