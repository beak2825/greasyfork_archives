// ==UserScript==
// @name   KF_script_by_alix_kumbo
// @name:ru KF SCRIPT | MAGENTA
...
// @grant        none
// @license   MIT
// @supportURL vk.com/eeeh_blin | Alix_Kumbo | Magenta
// @icon https://emoji.gg/assets/emoji/9372-blurple-boost-level-9.png
// @downloadURL https://update.greasyfork.org/scripts/444743/KF_script_by_alix_kumbo.user.js
// @updateURL https://update.greasyfork.org/scripts/444743/KF_script_by_alix_kumbo.meta.js
// ==/UserScript==
	...
	},
{
    ...
    },
 {
    ...
    },
    {
     ...
     {
      title: 'жен перс в муж роде',
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
        "Причина: Рп биография написана о женском персонаже, а в тексте присутствует множество упоминаний в мужском роде, что является нелогичным.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
      title: 'муж перс в жен роде',
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
        "Причина: Рп биография написана о мужском персонаже, а в тексте присутствует множество упоминаний в женском роде, что является нелогичным.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
      title: 'мало инфы во всех пунктах',
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(222, 143, 255)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
        "Причина: В вашей РП биографии мало информации во всех периодах жизни персонажа.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
