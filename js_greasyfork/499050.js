// ==UserScript==
// @name         KNYAZEV MOBILE: скрипт для моих любимых сотрудников
// @namespace    https://forum-knyazevmobile.ru/index.php
// @version      1.0
// @description  Для моих любимых сотрудников)
// @author       Dionis
// @match        https://forum-knyazevmobile.ru/index.php*
// @include      https://forum-knyazevmobile.ru/index.php/
// @grant        none
// @license 	 MIT
...
// @downloadURL https://update.greasyfork.org/scripts/499050/KNYAZEV%20MOBILE%3A%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B8%D1%85%20%D0%BB%D1%8E%D0%B1%D0%B8%D0%BC%D1%8B%D1%85%20%D1%81%D0%BE%D1%82%D1%80%D1%83%D0%B4%D0%BD%D0%B8%D0%BA%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/499050/KNYAZEV%20MOBILE%3A%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B8%D1%85%20%D0%BB%D1%8E%D0%B1%D0%B8%D0%BC%D1%8B%D1%85%20%D1%81%D0%BE%D1%82%D1%80%D1%83%D0%B4%D0%BD%D0%B8%D0%BA%D0%BE%D0%B2.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
	...
	},
	{
	  ...
	  content:
		'[CENTER]{{ greeting }}, уважаемый(-ая)[B] {{ user.name }}[/B]![/CENTER]<br><br>' +
		"[CENTER]{00ffff}Проверив вашу тему, никаких багов/ошибок мы не нашли.[/CENTER]<br><br>" +
        '[CENTER]Возвращаем тему Техническому Специалисту.[/CENTER]',
	...
	},
{
    ...
    "[LEFT]Обратитесь в раздел «Жалобы» Вашего сервера.<br><br>"+
	...
	},
{
	...
	},
  {
	...
	},
	{
	  ...
	  content:
		'[CENTER]{{ greeting }}, уважаемый(-ая)[B] {{ user.name }}[/B]![/CENTER]<br><br>' +
		"[CENTER]Ваше игровое имущество/денежные средства будут восстановлены в течение трех дней. Убедительная просьба, не менять никнейм до момента восстановления.<br><br>" +
	...
	},
    {
	  ...
	  content:
        ...
        '[CENTER]В остальных же случаях, если не была зачислена донат валюта — вероятнее всего, была допущена ошибка при вводе реквизитов. К нашему сожалению, из-за большого количества попыток обмана, мы перестали рассматривать подобные жалобы. Вам необходимо быть внимательными при осуществлении покупок. <br><br>' +
        '[CENTER]Если Вы считаете, что ошибки быть не может и с момента оплаты не прошло более 7 дней, то в обязательном порядке сообщите в данной теме.<br><br>' +
	...
	},
    {
	  ...
	  content:
        ...
        '[CENTER]Ссылка на раздел, где можно оформить жалобу на технического специалиста: https://vk.cc/cy05pk <br><br>' +
        '[CENTER]Закрыто.[/CENTER]'
	},
];
