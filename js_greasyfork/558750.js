// ==UserScript==
// @name         Скрипт для ГС/ЗГС ГОСС-ГС/ЗГС ОПГ KOSTROMA
// @namespace    https://forum.blackrussia.online/
// @version      3.49
// @description  Версия для сервера KOSTROMA
// @author       Nurserik_Detta
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license      MIT
// @icon https://forum.blackrussia.online/data/avatars/o/11/11193.jpg?1680968342
// @downloadURL https://update.greasyfork.org/scripts/558750/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1-%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93%20KOSTROMA.user.js
// @updateURL https://update.greasyfork.org/scripts/558750/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1-%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93%20KOSTROMA.meta.js
// ==/UserScript==
...
},
{
    ...
    "[B][CENTER][FONT=times new roman][SIZE=4][COLOR=#FF0000][ICODE]Список не допущенных к обзвону: [/ICODE][/COLOR]<br><br>"+
     ...
     '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/cCG97p5p/Pics-Art-07-12-03-23-18-1.png[/img][/url][/CENTER]' +
           "[B][CENTER][FONT=times new roman][SIZE=4][COLOR=Red][ICODE]Обзвон состоится ДАТА.МЕС.ГОД в ВРЕМЯ по МСК.[/ICODE][/COLOR][COLOR=#FFFFFF][ICODE] Он будет проходить в официальном дискорд канале сервера Kostroma За 10-5 минут до обзвона вам необходимо поставить префикс в дискорде [/ICODE][COLOR=#FFFFFF][ICODE] [K/L/] Nick_Name. Всем удачи на обзвоне![/ICODE]<br><br>"+
      "[B][CENTER][FONT=times new roman][SIZE=4][COLOR=ffffff][ICODE]Обзвон будет проходит на официальном дискорд канале [/ICODE][COLOR=ffffff] [URL=' https://discord.gg/5yCprs6pe']*Кликабельно*[/URL] [/COLOR]<br><br>"+
   "[I][CENTER][SIZE=5][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] BLACK RUSSIA[/B][/COLOR] [/SIZE][/I][COLOR=#ffc6b4][B][SIZE=5] Kostroma [/SIZE][/B][/COLOR]",
 },
     {
...
const buttons = [
   {
    ...
    },
    {
    ...
    },
     {
      ...
      addButton('Aвтор:Nurserik_Detta', '', 'border-radius: 13px; margin-right: 5px; margin-bottom: 5px; border: 2px solid; border-color: rgb(235, 21, 21, 0.5);');
