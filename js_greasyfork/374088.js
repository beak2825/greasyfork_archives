...
// @downloadURL https://update.greasyfork.org/scripts/374088/Stats%20since%20last.user.js
// @updateURL https://update.greasyfork.org/scripts/374088/Stats%20since%20last.meta.js
// ==/UserScript==

(function() {
  'use strict';

  if((window.location.href.indexOf("threadid=1781") != -1 && window.location.host.indexOf('redacted') != -1) || (window.location.href.indexOf("threadid=30532") != -1 && window.location.host.indexOf('popcorn') != -1) || (window.location.href.indexOf("threadid=660") != -1 && window.location.host.indexOf('orpheus') != -1))
    showSettings();
