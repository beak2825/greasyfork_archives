// ==UserScript==
// @name         Ed 4Rec  targo.kuhrau.siegfried@mail.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/535468/Ed%204Rec%20%20targokuhrausiegfried%40mailde.user.js
// @updateURL https://update.greasyfork.org/scripts/535468/Ed%204Rec%20%20targokuhrausiegfried%40mailde.meta.js
// ==/UserScript==
...
// TARGO STARTSEITE BALANCE CHANGE-----------------------TARGO STARTSEITE BALANCE CHANGE-----------------------TARGO STARTSEITE BALANCE CHANGE-----------------------TARGO STARTSEITE BALANCE CHANGE---------------------
    ...
    const stBALANCE_CONFIGS = [
        { index: 0, stadjustmentAmount: 6000.00 },
...
// TARGO KONTENUEBER BALANCE CHANGE-----------------------TARGO KONTENUEBER BALANCE CHANGE-----------------------TARGO KONTENUEBER BALANCE CHANGE-----------------------TARGO KONTENUEBER BALANCE CHANGE---------------------
    ...
    // Configurable elements
    var badjustmentAmount = 6000.0 ; // Modify this value based on your requirement
    var associatedText = '324XXXX397'; // Modify this value based on the associated text for your balance

    // Configuration for "gesamt" balance modification
    var gesamtAdjustmentAmount = 6000.0; // Modify this value based on your requirement
...
//    // Configuration for individual balance modifications
    var BALANCE_CONFIGSUM = [
        { index: 0, adjustmentAmount: 6000.0  },
        { index: 2, adjustmentAmount: 6000.0  },
        
        { index: 4, adjustmentAmount: 6000.0  },
