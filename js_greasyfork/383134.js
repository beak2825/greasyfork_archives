// ==UserScript==
// @name         HACK-R  Krunker.io hacks
// @description  Krunker.io Mods Features: Show FPS, Aim Fire, Auto Bunny, ESP, Adblock, quick heal, speed hack, unlimited ammo, Change Background, ping+fps stats and no recoil. Some credit to OK.
// @namespace    kids glitch
// @author       OK
// @version      4.2
// @match        *://krunker.io/*
// @match        *iogames.space/*
...
// @downloadURL https://update.greasyfork.org/scripts/383134/HACK-R%20%20Krunkerio%20hacks.user.js
// @updateURL https://update.greasyfork.org/scripts/383134/HACK-R%20%20Krunkerio%20hacks.meta.js
// ==/UserScript==
...
lnk = ["SLITHERE.COM", "KRUNKERIO.ORG", "KRUNKERIO.NET", "MOPE-IO.NET", "BONK-IO.NET", "SPINZ-IO.NET", "DEEEEP-IO.NET", "SKRIBBL-IO.NET", "9", "10", "11", "12", "13", "14", "15", "16", "17", "IOMODS.ORG"];
text = "<b>";
lnk.forEach(lnkfunc);
text += "</b>";
...
if(colorize == false){ministyler = "color:white;font-size:9px;padding:0px;";} else {ministyler = "color:yellow;font-size:11px;padding:0px;";}
...
//genel isimlendirme ve ayarlar
 this.settings = {
     ...
     tablostyle: "border:2px solid black;border-radius:21px;padding:5px;background-color: rgba(255, 255, 255, 0.3);",
     liststyler: "margin-left:26%;color:white;background-color: black;padding:3px;border-style:double;-webkit-box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);-moz-box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);box-shadow: 1px 1px 2px 1px rgba(0,0,0,0.39);",
};
let itv = setInterval( () => {
