...
// @description  Notion的 100% 简体汉化脚本
// @match        *://www.notion.so/*
// @match        *://*.notion.site/*
// @grant        none
// @run-at       document-start
// @license      MIT
// @version 0.0.1.20230726081458
// @downloadURL https://update.greasyfork.org/scripts/471748/Notion%20%E4%B8%AD%E6%96%87%E7%AE%80%E4%BD%93%E6%B1%89%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/471748/Notion%20%E4%B8%AD%E6%96%87%E7%AE%80%E4%BD%93%E6%B1%89%E5%8C%96.meta.js
// ==/UserScript==
(function() {
	"use strict";
	var lang = "zh-CN";
	...
	script.text = JSON.stringify({
		...
		"adminConnectionsSettings.connectionRestrictions.allowList.caption": "工作区成员只能安装由管理员预先批准的连接。",
		"adminConnectionsSettings.connectionRestrictions.info.title": "管理员可以随时安装和批准新连接。",
		...
		"appTemplates.projects.advancedTaskProjectStatus.name": "未开始、进行中、完成、已归档",
		...
		"auditlogEventFilter.actionNames.member_team_role_updated": "已更新团队空间的成员角色",
		...
		"auditlogEventFilter.actionNames.saml_enforce_toggled": "已切换至强制执行 SAML",
		...
		"auditlogEventFilter.actionNames.team_creation_admins_setting_toggled": "已更改只有管理员才能创建团队空间的限制",
		...
		"auditlogEventFilter.actionNames.team_workspace_default_permission_updated": "已更新团队空间的工作区默认权限",
		...
		"blockPermissionsSettings.publicPermission.tooltip": "知道链接的任何人都可以访问此页面。",
		...
		"database.statusProperty.groupName.current": "已完成",
		"database.statusProperty.groupName.future": "已完成",
		...
		"loadingDots.label": "载入中…",
		"loadingShimmer.label": "载入中…",
		...
		"pageViewBlock.templatePageBanner.editTemplateLabel": "<mediumtext>你正在编辑</mediumtext> {pageTitleWithIcon} 中的模板",
		...
		"pageViewBlock.templatePageBanner.viewTemplateLabel": "<mediumtext>你正在查看</mediumtext> {pageTitleWithIcon} 中的模板 `",
		...
		"spaceSubscriptionSettings.upgradeModal.billingIntervalSection.header": "账单间隔",
		...
		"subscriptionHelpers.billingInterval.monthly.option.title": "月付 – 每人每月 {memberPrice}",
		"subscriptionHelpers.billingInterval.monthly.title": "月付",
		"subscriptionHelpers.billingInterval.yearly.option.title": "<pre>年付 – 每人每月 {memberPrice} <span>节省 {yearlySavingsPercent}</span></pre>",
		...
		"subscriptionSettings.upgradeToBusinessDialog.message": "你将以每位成员每月 {price} 的价格订阅 Notion 商业版。{br}系统将在扣除帐户余额后，按比例向你收取费用。",
		...
		"templateCreatorSubmission.creatorDetail.form.email": "电子邮件",
		...
		"templateCreatorSubmission.creatorDetail.form.handleHelperText": "可通过其访问你的个人资料页面的唯一名称。不允许有空格。",
