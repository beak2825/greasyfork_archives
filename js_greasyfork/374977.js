// ==UserScript==
// @name         KillerMod;all in one|The BEST moomoo.io mod/hack!Spike/trap hotkey/autobull/autoheal/and more
// @namespace    KillerMod
// @version     1.7
...
// @downloadURL https://update.greasyfork.org/scripts/374977/KillerMod%3Ball%20in%20one%7CThe%20BEST%20moomooio%20modhack%21Spiketrap%20hotkeyautobullautohealand%20more.user.js
// @updateURL https://update.greasyfork.org/scripts/374977/KillerMod%3Ball%20in%20one%7CThe%20BEST%20moomooio%20modhack%21Spiketrap%20hotkeyautobullautohealand%20more.meta.js
// ==/UserScript==
...
<h1 id="settingsTitle">KillerMod Settings</h1>
...
<hr id="hrule"/>
<div id="endwrap">
<h3 id="createdEnd">Created by WaelReguig | <a href="https://www.youtube.com/channel/UChkkNK_LzCh7pYSBFmdGLhw">Subscribe My Channel</a></h3>
</div>
`
...
$("#mapDisplay").on("click", (event) => {
    ...
    infoDiv.innerHTML = `<h1 id="autotitle">You are currently in KillerMod auto-pilot.</h1>
...
document.title="KillerMod: Autoheal ON"
...
document.addEventListener('keypress', (e)=>{
   ...
   if (e.keyCode == 116 && document.activeElement.id.toLowerCase() !== 'chatbox'){
       ...
       document.title = document.title=`KillerMod: Autoheal ${autoheal ? "ON" : "OFF"}` //"Heal " + (autoheal ? "ON" : "OFF") + " / Bull Hat " + (autobull ? "ON" : "OFF");
