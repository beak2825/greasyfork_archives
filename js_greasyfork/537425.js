...
// @downloadURL https://update.greasyfork.org/scripts/537425/Tech%20Script%20.user.js
// @updateURL https://update.greasyfork.org/scripts/537425/Tech%20Script%20.meta.js
// ==/UserScript==
...

{
	...
	content:
"[FONT=Verdana][SIZE=13px]Приветствую, уважаемый {{ user.mention }}.<br><br><br><br>" +
' [/FONT]',
},
          {
	title: 'ОТВЕТ РАНЕЕ',
    ...
    "Ответ был дан ранее. За создание дубликатов следует наказание.<br>"+
     '[HR][/HR]<br>'+
      "ссылка<br>",
...
},
 {
	...
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "Переношу тему в нужный раздел.<br>",
},
     {
	title: 'ПРОДАЖА ИВ',
	color: 'oswald: 3px; color: #DC143C; background: #DCDCDC; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "Нарушение пункта правил [COLOR=RED]2.28[/COLOR], который запрещает покупку/продажу внутриигровой валюты за реальные деньги в любом виде, привело к блокировке вашего аккаунта.<br>"+
     '[HR][/HR]<br>'+
      "текст<br>"+
      '[HR][/HR]<br>'+
      "Взаимодействий между вами ранее не было, договоренности о том, что это был долг/подарок так же не было.<br>"+
       '[HR][/HR]<br>'+
	'Тема передана ЗКТС/КТС 71-75',
},
           {
	title: 'ПОКУПКА ИВ',
	color: 'oswald: 3px; color: #DC143C; background: #DCDCDC; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "На ваш банковский счет были зачислены средства от пользователя, известного как продавец игровой валюты. Вы, не задумываясь, сняли эти средства, будучи в курсе о происхождении перевода. Отсутствие каких-либо договоренностей или взаимодействий в игре до или после этого момента не оставляет сомнений в том, что средства были получены в результате предполагаемой покупки игровой валюты. Именно это стало причиной блокировки вашего аккаунта.<br>"+
     '[HR][/HR]<br>'+
      "текст<br>"+
      '[HR][/HR]<br>'+
	'Тема передана ЗКТС/КТС 71-75',
	...
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "На ваш банковский счет поступили денежные средства от Ботовода. Бот – это программа, задачей которой является выполнение определенных функций с целью заработать игровую валюту для последующей продажи. Прошло некоторое время, и вы без колебаний решили снять эти средства с банковского счета. Это было ожидаемо, так как вы знали о предстоящем переводе.<br>"+
     '[HR][/HR]<br>'+
      "текст<br>"+
      '[HR][/HR]<br>'+
	'Тема передана ЗКТС/КТС 71-75',
	...
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "Нарушение пункта правил [COLOR=RED]4.05[/COLOR], который запрещает передачу имущества между основным и твинк-аккаунтом, привело к блокировке вашего аккаунта.<br>"+
     '[HR][/HR]<br>'+
      "текст<br>"+
      '[HR][/HR]<br>'+
      "Этот аккаунт оказался вашим твинк-аккаунтом, что можно доказать с помощью системы логирования. Передача имущества с одного аккаунта на другой запрещена и рассматривается как нарушение правил проекта.<br>"+
       '[HR][/HR]<br>'+
	'Тема передана ЗКТС/КТС 71-75',
},

{
	...
	content:
    "[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "Уточните, пожалуйста, согласны ли вы с выданным наказанием и хотите сократить его либо вовсе снять, или же категорически не согласны и требуете объяснения причин блокировки аккаунта?<br><br>" +
    'Тема закреплена и находится на рассмотрении.<br><br>',
	...
	content:
    "[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "Ваш аккаунт будет переблокирован в связи со сторонней привязкой.<br><br>" +
    'Тема передана ЗКТС/КТС 71-75.<br><br>',
    prefix: PIN_PREFIX,
	status: true,
},
        {
	...
	content:
    "[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "Ваш аккаунт будет заблокирован в связи с его взломом. Аккаунт игрока, на которого перешли ваши средства, будет блокирован из-за манипуляций (махинаций). Если желаете выйти из блокировки, создайте повторную тему в разделе Жалобы на технических специалистов.<br><br>" +
    'Закрыто.<br><br>',
    prefix: CLOSE_PREFIX,
	status: true,
},
	...
	content:
    "[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "1. Укажите ваш Telegram ID, если ваш игровой аккаунт был привязан к Telegram. Узнать его можно здесь: t.me/getmyid_bot<br>" +
    "2. Укажите ваш оригинальный ID страницы ВКонтакте, которая привязана к аккаунту (взять его можно через данный сайт - https://regvk.com/<br>" +
    "3. Укажите почту, которая привязана к аккаунту<br><br>" +
    'У вас есть 24 часа чтобы дать ответ.<br><br>',
        prefix: TECHADM_PREFIX,
	status: true,
},
   {
	title: 'СКРИН СО СБРОСОМ',
	content:
    "[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
    "Сбросьте пароль через бота во вконтакте, а так же через бота в телеграмм и прикрепите 2 скриншота в данную тему с ЗАМАЗАННЫМ паролем.<br><br>" +
    'Ожидаю обратной связи.<br><br>',
    prefix: TECHADM_PREFIX,
	status: true,
},
{
...
},
{
	...
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
	"Ваша тема закреплена и ожидает вердикта ЗКТС/КТС 71-75.<br>" +
	'Создавать подобные темы не нужно.<br><br>На рассмотрении.[/FONT][/SIZE]',
	prefix: PIN_PREFIX,
	status: true,
},
{
	title: 'Передача Руководству (НЕ ПОДЛ ОБЖ)',
	color: '',
	content:
	"[FONT=Verdana][SIZE=13px]Приветствую, {{ user.mention }}.<br><br>" +
...

{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER]Ваша тема никак не относится к жалобам на технических специалистов, обратитесь с данной темой в <u>технический раздел вашего сервера</u> - [URL='https://forum.blackrussia.online/index.php?forums/Технический-раздел.22/']клик[/URL]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...

{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	'[CENTER]После дополнительной перепроверки было выявлена ошибка, ваш аккаунт будет разблокирован в течении 24-х часов.<br>[/CENTER]<br>'+
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
...
},
{
	...
	"[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER][SIZE=4][FONT=Verdana]После проверки доказательств и системы логирования, вердикт:<br><br>[COLOR=rgb(255, 0, 0)]Недостаточно доказательств для блокировки игрока[/COLOR][/CENTER]<br><br>" +
	'[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>' +
	"[CENTER][SIZE=4][FONT=Verdana][I][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR][/FONT][/CENTER]",
},
	{
