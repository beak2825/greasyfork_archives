// ==UserScript==
// @name         更好的 CSDNGreener
// @namespace    https://github.com/Ujhhgtg
// @version      4.2.6a
// @license      MIT
// @description  不含使用情况统计及广告的 CSDNGreener|⚡️全新4.0版本！拥有数项独家功能的最强CSDN脚本，不服比一比⚡️|🕶无需登录CSDN，获得比会员更佳的体验|🖥自定义背景图，分辨率自适配，分屏不用滚动|💾超级预优化|🔖独家超级免会员|🏷独家原创文章免登录展开|🔌独家推荐内容自由开关|📠独家免登录复制|🔗独家防外链重定向|📝独家论坛未登录自动展开文章、评论|🌵全面净化|📈沉浸阅读|🧴净化剪贴板|📕作者信息文章顶部展示
...
// @supportURL   https://github.com/Ujhhgtg/CSDNGreener/issues/new?assignees=Ujhhgtg&labels=help+wanted&template=ISSUE_TEMPLATE.md&title=
// @contributionURL https://doc.stackoverflow.wiki/web/#/21?page_id=138
// @grant        GM_addStyle
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_setClipboard
// @note         25-12-20 4.2.6a 合并上游
...
// @downloadURL https://update.greasyfork.org/scripts/446239/%E6%9B%B4%E5%A5%BD%E7%9A%84%20CSDNGreener.user.js
// @updateURL https://update.greasyfork.org/scripts/446239/%E6%9B%B4%E5%A5%BD%E7%9A%84%20CSDNGreener.meta.js
// ==/UserScript==
var version = "4.2.6a";
...
function common(num, times) {
    var loop = setInterval(function () {
        ...
        if (num === 1) {
            ...
            let did = false;
            let configHTML = '';
            configHTML += '<div class="configContainer"><p><a class="title" href="https://github.com/Ujhhgtg/CSDNGreener" target="_blank">CSDNGreener</a> <sup>V' + version + ' ' + settings_svg + '</sup></p>';
            ...
            configHTML += '<br><br>';
            configHTML += '<a href="https://github.com/Ujhhgtg/CSDNGreener" target="_blank" class="giveMeOneStar">' + star_svg + ' <b>转到脚本 GitHub</b> 动动小手在 GitHub 点个 Star 和关注，支持我继续维护脚本 :)</a><br><br>';
