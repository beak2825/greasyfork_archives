// ==UserScript==
// @name             Regeneration [GW 2]
// @namespace        http:
// @description      Более подробная информация о выздоровлении персонажа.
// @include          http://www.ganjawars.ru/me.php
// @version          2.1
// @author           W_or_M (редакция UltramarinKS)
// @downloadURL https://update.greasyfork.org/scripts/33754/Regeneration%20%5BGW%202%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/33754/Regeneration%20%5BGW%202%5D.meta.js
// ==/UserScript==
...
var color    = 'red'; // цвет надписи, формат - #XXXXXX (X - от 0 до F)
//-----------------------------------
...
// мы на главной
if (root.location.href.indexOf('http://www.ganjawars.ru/me.php') >= 0) {
