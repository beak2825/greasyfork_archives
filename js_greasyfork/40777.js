...
// @namespace    https://greasyfork.org/en/users/180594-james-williams
// @version      2018.2.2.2
...
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/40777/MLB%20The%20Show%20Nation%20Profit%20Calculator.user.js
// @updateURL https://update.greasyfork.org/scripts/40777/MLB%20The%20Show%20Nation%20Profit%20Calculator.meta.js
// ==/UserScript==
    ...
    $('.updateButton').click(function(){
        $('.sortable > tbody  > tr').each(function() {
            ...
            $.ajax({ url: rowURL, async: false, success: function(data) {
                ...
                var dates = [];
                dates = [];
                $(jQuery.parseHTML(data)).find('.completed-order').each(function(i){var thisDate = new Date($(this).find('.date').text()); dates.push(thisDate);});
                var numHour = 0;
                var numThreeHours = 0;
                var numToday = 0;
