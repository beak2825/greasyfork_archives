...
// @version      1.0
// @description  优化版西交大自动评教脚本：支持打分等功能。
// @author       crosspi (原作者)，zhou0930 (优化版)
...
// @grant        GM_addStyle
// @license      GPL-3.0
// @downloadURL https://update.greasyfork.org/scripts/553972/XJTU-zdpj-Plus.user.js
// @updateURL https://update.greasyfork.org/scripts/553972/XJTU-zdpj-Plus.meta.js
// ==/UserScript==
...
(function() {
    ...
    function zdpj() {
        ...
        var btnlist2 = document.querySelectorAll("div.fzItem.bh-pull-left");
        for (var i = 0; i < btnlist2.length; i++) {
            btnlist2[i].parentNode.querySelector("div:last-child").click();}

        var btnlist = document.querySelectorAll("label:nth-child(1).bh-radio-label");
        for (var i2 = 0; i2 < btnlist.length; i2++) {
            btnlist[i2].click();}
