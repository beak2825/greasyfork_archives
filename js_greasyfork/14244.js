// ==UserScript==
// @name         WME VENEZUELA  MMR 1-12-15
// @namespace    http://your.homepage/
// @version     1.3
// @description  polygons for MapRaid groups in a WME "vENEZUELA MMR 2015" layer
...
// @downloadURL https://update.greasyfork.org/scripts/14244/WME%20VENEZUELA%20%20MMR%201-12-15.user.js
// @updateURL https://update.greasyfork.org/scripts/14244/WME%20VENEZUELA%20%20MMR%201-12-15.meta.js
// ==/UserScript==
...
function InitMapRaidOverlay(){
    ...
    var mro_mapLayers = mro_Map.getLayersBy("uniqueName","__WME VENEZUELA MMR 2015");

    var raid_mapLayer = new mro_OL.Layer.Vector("WME VENEZUELA MMR 1-12-15", {
        displayInLayerSwitcher: true,
        uniqueName: "__WME VENEZUELA MMR"
    });

    I18n.translations.en.layers.name["__WME VENEZUELA MMR"] = "WME VENEZUELA MMR";
    mro_Map.addLayer(raid_mapLayer);
    raid_mapLayer.setVisibility(true);


    var V01 = [{lon:'-71.77187',lat:'10.76585'},{lon:'-71.77187',lat:'10.50370'},{lon:'-71.63475',lat:'10.50100'},{lon:'-71.60863',lat:'10.57209'},{lon:'-71.60203',lat:'10.63393'},{lon:'-71.58460',lat:'10.66307'},{lon:'-71.59160',lat:'10.68989'},{lon:'-71.57971',lat:'10.70212'},{lon:'-71.65830',lat:'10.76750'}];
    AddRaidPolygon(raid_mapLayer, V01,"#4186F0","- MARACAIBO");
