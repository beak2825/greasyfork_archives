// ==UserScript==
// @name         Background Mini-Profile Viewer (Double-Click)
// @namespace    http://tampermonkey.net/
// @version      1
// @description  Убираем все лишние элементы с фона двойным кликом и делаем его в оригинальной окраске
// @author       MSHR
// @license      MSHR
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/504368/Background%20Mini-Profile%20Viewer%20%28Double-Click%29.user.js
// @updateURL https://update.greasyfork.org/scripts/504368/Background%20Mini-Profile%20Viewer%20%28Double-Click%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function setupDblClickListeners() {
        document.querySelectorAll('.top.memberCustomBackground').forEach(el => {
