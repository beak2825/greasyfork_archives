...
// @downloadURL https://update.greasyfork.org/scripts/486573/%E6%97%A0%E5%89%91Mud%E8%BE%85%E4%BF%AE%28alpha%29.user.js
// @updateURL https://update.greasyfork.org/scripts/486573/%E6%97%A0%E5%89%91Mud%E8%BE%85%E4%BF%AE%28alpha%29.meta.js
// ==/UserScript==
...
unsafeWindow.init = function () {
  ...
  PLU.UTIL = UTIL;
  $.ajax({
    url: "https://update.greasyfork.org/scripts/486271/%E6%97%A0%E5%89%91Mud%E8%BE%85%E4%BF%AE%E6%95%B0%E6%8D%AE.js?t=".concat(
      Date.now()
    ),
    dataType: "text",
    crossDomain: "true",
...
unsafeWindow.PLU = {
  ...
  initVersion: function initVersion() {
    ...
    YFUI.writeToOut(
      "<span style='color:yellow;'>\n            +===========================+\n                 脚本名称：无剑Mud辅助  版本："
        ...
        .concat(this.nickName)
        .concat(this.developerMode ? "（已开启开发者模式）" : "")
        .concat(
    ...
    if (!g_gmain.is_fighting) {
      PLU.getSkillsList(function (allSkills, tupoSkills) {
        ...
        var lxSkill =
          ((_g_obj_map$get = g_obj_map.get("msg_attrs")) === null ||
          _g_obj_map$get === void 0
            ? void 0
            : _g_obj_map$get.get("practice_skill")) || 0;
        if (lxSkill) {
          ...
          if (cmd[1]) {
            ...
            switch (cmd[1]) {
              case "recl":
                ...
                proxy_clickButton(
                  "reclaim recl ".concat(n, " go ").concat(cmd[4]),
                  1
                );
                break;
              case "buy":
                ...
                proxy_clickButton(
                  "reclaim buy ".concat(n, " go ").concat(cmd[4]),
                  1
                );
                break;
            }
  ...
  getCache: function getCache(key) {
    var _PLU$CACHE$key;
    return (_PLU$CACHE$key = PLU.CACHE[key]) !== null &&
      _PLU$CACHE$key !== void 0
      ? _PLU$CACHE$key
      : "";
  },
  //================================================================================================
    ...
    UTIL.addSysListener("listenNotice", function (b, type, subtype, msg) {
      ...
      if (msgTxt.match("你打坐完毕") && PLU.getCache("autoDZ") == 1) {
        ...
        if (l && l.length > 3) {
          ...
          if (PLU.getCache("listenQL") == 1) {
            var keysStr = PLU.getCache("listenQL_keys")
              .split("|")[1]
              .split(",")
              .map(function (e) {
                return e == "*" ? ".*" : e.replace("*", "\\*");
    ...
    UTIL.addSysListener("listenChannel", function (b, type, subtype, msg) {
      ...
      if (msgTxt.match("慌不择路") && msgTxt.indexOf("跨服") < 0) {
        ...
        if (_l4 && _l4.length > 3) {
          ...
          if (PLU.getCache("listenKFQL") == 1) {
            var keysStr = PLU.getCache("listenKFQL_keys")
              .split("|")[1]
              .split(",")
              .map(function (e) {
                return e == "*" ? ".*" : e.replace("*", "\\*");
          ...
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
            ...
            PLU.TODO.push({
              ...
              param: [
                ...
                (_ref =
                  (_npc$name_new = npc.name_new) !== null &&
                  _npc$name_new !== void 0
                    ? _npc$name_new
                    : npc.name_tw) !== null && _ref !== void 0
                  ? _ref
                  : npc.name,
              ],
    ...
    UTIL.addSysListener("listenJianzhen", function (b, type, subtype, msg) {
      ...
      if (msgTxt.match(/(.*)阵升级完毕！成功升级到/)) {
        setTimeout(function () {
          ...
          var room =
            (_g_obj_map$get2 = g_obj_map.get("msg_room")) === null ||
            _g_obj_map$get2 === void 0
              ? void 0
              : _g_obj_map$get2.get("short");
    ...
    setInterval(function () {
      ...
      if (PLU.TODO.length > 0 && !PLU.STATUS.isBusy && UTIL.inHome()) {
        ...
        if (nowDate.getTime() < ctd.timeout) {
          if (ctd.type == "cmds") {
            ...
            var _PLU;
            if (ctd.param)
              (_PLU = PLU)[ctd.cmds].apply(_PLU, _toConsumableArray(ctd.param));
            else PLU[ctd.cmds]();
          }
        }
      }
      ...
      for (var k in PLU.MPFZ) {
        if (k < nowTime) delete PLU.MPFZ[k];
          ...
          $("#topMonitor").append(
            '<div title="'
              .concat(f.v, '" style="display:inline-block;width:40%;')
              .concat(flo, '">')
              .concat(f.n.substr(0, 1), ' <span style="color:#9CF;">[')
              .concat(f.p, ']</span> <span style="color:#DDD;">')
              .concat(dt, "</span></div>")
          );
          bi++;
        }
  ...
  toSignIn: function toSignIn() {
    ...
    var ckeds =
      ((_PLU$getCache = PLU.getCache("signInArray")) === null ||
      _PLU$getCache === void 0
        ? void 0
        : _PLU$getCache.split(",")) ||
      this.signInMaps.map(function (e, i) {
        return i;
      });
    var htm =
    ...
    this.signInMaps.forEach(function (e, i) {
      if (!e.n) htm += '<span style="width:92px;">&nbsp;</span>';
        ...
        htm += '<span><button class="signInBtn" data-sid="'
          .concat(
            i,
            '" style="font-size:12px;padding:1px 2px;cursor:pointer;">GO</button>\n            <label data-id="'
          )
          .concat(i, '" style="font-size:13px;margin:0 3px 5px 0;">')
          .concat(e.n, '<input type="checkbox" name="signInId" value="')
          .concat(i, '"\n             ')
          .concat(ckeds.includes(i + "") || e.f ? "checked" : "", " ")
          .concat(e.f ? "disabled" : "", " /></label></span>");
    });
    htm +=
  ...
  toricrw: function toricrw() {
    ...
    var ckeds =
      ((_PLU$getCache2 = PLU.getCache("signInArrayrc")) === null ||
      _PLU$getCache2 === void 0
        ? void 0
        : _PLU$getCache2.split(",")) ||
      this.rcrenwu.map(function (e, i) {
        return i;
      });
    var htm =
      '<div style="display:flex;flex-direction:row;flex-wrap: wrap;justify-content: space-between;width: 100%;align-content: flex-start;line-height:2;">';
  ...
  autoGetVipReward: function autoGetVipReward(callback) {
    ...
    if (
      ((_vipInfo$get = vipInfo.get("saodang_fb_1")) !== null &&
        _vipInfo$get !== void 0 &&
        _vipInfo$get.split(",")[2]) ||
      0 % 1000 < 4
    )
      acts += "#4 vip finish_fb dulongzhai;";
    if (
      ((_vipInfo$get2 = vipInfo.get("saodang_fb_2")) !== null &&
        _vipInfo$get2 !== void 0 &&
        _vipInfo$get2.split(",")[2]) ||
      0 % 1000 < 4
    )
      acts += "#4 vip finish_fb junying;";
    if (
      ((_vipInfo$get3 = vipInfo.get("saodang_fb_3")) !== null &&
        _vipInfo$get3 !== void 0 &&
        _vipInfo$get3.split(",")[2]) ||
      0 % 1000 < 4
    )
      acts += "#4 vip finish_fb beidou;";
    if (
      ((_vipInfo$get4 = vipInfo.get("saodang_fb_4")) !== null &&
        _vipInfo$get4 !== void 0 &&
        _vipInfo$get4.split(",")[2]) ||
      0 % 1000 < 4
    )
      acts += "#4 vip finish_fb youling;";
    if (
      ((_vipInfo$get5 = vipInfo.get("saodang_fb_5")) !== null &&
        _vipInfo$get5 !== void 0 &&
        _vipInfo$get5.split(",")[2]) ||
      0 % 1000 < 3
    )
      acts += "#3 vip finish_fb siyu;";
    if (
      ((_vipInfo$get6 = vipInfo.get("saodang_fb_6")) !== null &&
        _vipInfo$get6 !== void 0 &&
        _vipInfo$get6.split(",")[2]) ||
      0 % 1000 < 3
    )
      acts += "#3 vip finish_fb changleweiyang;";
    if (
      ((_vipInfo$get7 = vipInfo.get("saodang_fb_7")) !== null &&
        _vipInfo$get7 !== void 0 &&
        _vipInfo$get7.split(",")[2]) ||
      0 % 1000 < 3
    )
      acts += "#3 vip finish_fb heishuihuangling;";
    if (
      ((_vipInfo$get8 = vipInfo.get("saodang_fb_8")) !== null &&
        _vipInfo$get8 !== void 0 &&
        _vipInfo$get8.split(",")[2]) ||
      0 % 1000 < 3
    )
      acts += "#3 vip finish_fb jiandangfenglingdu;";
    if (
      ((_vipInfo$get9 = vipInfo.get("saodang_fb_9")) !== null &&
        _vipInfo$get9 !== void 0 &&
        _vipInfo$get9.split(",")[2]) ||
      0 % 1000 < 3
    )
      acts += "#3 vip finish_fb tianshanlongxue;";
    if (
      ((_vipInfo$get10 = vipInfo.get("saodang_fb_10")) !== null &&
        _vipInfo$get10 !== void 0 &&
        _vipInfo$get10.split(",")[2]) ||
      0 % 1000 < 3
    )
      acts += "#3 vip finish_fb sizhanguangmingding;";
    if (
      ((_vipInfo$get11 = vipInfo.get("saodang_fb_11")) !== null &&
        _vipInfo$get11 !== void 0 &&
        _vipInfo$get11.split(",")[2]) ||
      0 % 1000 < 3
    )
  ...
  autoShaodan: function autoShaodan(callback) {
    ...
    if (
      ((_vipInfo$get12 = vipInfo.get("saodang_fb_1")) !== null &&
        _vipInfo$get12 !== void 0 &&
        _vipInfo$get12.split(",")[2]) ||
      0 % 1000 < 4
    ) {
    ...
    if (
      ((_vipInfo$get13 = vipInfo.get("saodang_fb_2")) !== null &&
        _vipInfo$get13 !== void 0 &&
        _vipInfo$get13.split(",")[2]) ||
      0 % 1000 < 4
    )
      if (isVip) acts += "#4 vip finish_fb junying;";
        ...
        acts +=
          ...
          "team create;fb 2;;ak;;e;n;event_1_48728674;fb 2;e;s;event_1_41361248;fb 2;e;e;;event_1_43484736;;ka;@赫造基的尸体;@严廷殷的尸体;";
    if (
      ((_vipInfo$get14 = vipInfo.get("saodang_fb_3")) !== null &&
        _vipInfo$get14 !== void 0 &&
        _vipInfo$get14.split(",")[2]) ||
      0 % 1000 < 4
    ) {
    ...
    if (
      ((_vipInfo$get15 = vipInfo.get("saodang_fb_4")) !== null &&
        _vipInfo$get15 !== void 0 &&
        _vipInfo$get15.split(",")[2]) ||
      0 % 1000 < 4
    ) {
    ...
    if (
      ((_vipInfo$get16 = vipInfo.get("saodang_fb_5")) !== null &&
        _vipInfo$get16 !== void 0 &&
        _vipInfo$get16.split(",")[2]) ||
      0 % 1000 < 3
    ) {
    ...
    if (
      ((_vipInfo$get17 = vipInfo.get("saodang_fb_6")) !== null &&
        _vipInfo$get17 !== void 0 &&
        _vipInfo$get17.split(",")[2]) ||
      0 % 1000 < 3
    ) {
    ...
    if (
      ((_vipInfo$get18 = vipInfo.get("saodang_fb_7")) !== null &&
        _vipInfo$get18 !== void 0 &&
        _vipInfo$get18.split(",")[2]) ||
      0 % 1000 < 3
    )
    ...
    if (
      ((_vipInfo$get19 = vipInfo.get("saodang_fb_8")) !== null &&
        _vipInfo$get19 !== void 0 &&
        _vipInfo$get19.split(",")[2]) ||
      0 % 1000 < 3
    )
    ...
    if (
      ((_vipInfo$get20 = vipInfo.get("saodang_fb_9")) !== null &&
        _vipInfo$get20 !== void 0 &&
        _vipInfo$get20.split(",")[2]) ||
      0 % 1000 < 3
    )
      if (isVip) acts += "#3 vip finish_fb tianshanlongxue;";
      else acts += "team create;fb 9;;ak;n;;n;;n;;n;;n;;ka;";
    if (
      ((_vipInfo$get21 = vipInfo.get("saodang_fb_10")) !== null &&
        _vipInfo$get21 !== void 0 &&
        _vipInfo$get21.split(",")[2]) ||
      0 % 1000 < 3
    )
      if (isVip) acts += "#3 vip finish_fb sizhanguangmingding;";
      else acts += "team create;fb 10;;ak;n;;n;;n;;n;;n;;ka;";
    if (
      ((_vipInfo$get22 = vipInfo.get("saodang_fb_11")) !== null &&
        _vipInfo$get22 !== void 0 &&
        _vipInfo$get22.split(",")[2]) ||
      0 % 1000 < 3
    )
  ...
  initrichangrenwu: function initrichangrenwu() {
    ...
    this.rcrenwu = [
      ...
      {
        n: "副本十一",
        go: "fb 11;ak;nw;se;n;s;ne;sw;e;w;se;nw;s;n;sw;ne;w;w;e;e;nw;nw;se;se;n;n;s;s;ne;ne;sw;sw;e;e;w;w;se;se;nw;nw;s;s;n;n;sw;sw;=4000;ka;vs:event_1_68529291;",
      },
      {
        n: "幽冥后院",
      ...
      {
        n: "阎王十殿",
        go: "rank go 223;nw;event_1_42827171;=200;ak;;ka;;event_1_45876452;;=500;",
      },
      {
        n: "讨天命丹",
        fn: PLU.askTianmd,
  ...
  rongbaoz: function rongbaoz(callback) {
    ...
    var curName = UTIL.filterMsg(
      ((_g_obj_map$get3 = g_obj_map.get("msg_room")) === null ||
      _g_obj_map$get3 === void 0
        ? void 0
        : _g_obj_map$get3.get("short")) || ""
    );
    if (curName == "拱辰楼十三层") {
      PLU.execActions(
  ...
  nanzzouy: function nanzzouy(callback) {
    ...
    PLU.execActions("golook_room;");
    var curName = UTIL.filterMsg(
      ((_g_obj_map$get4 = g_obj_map.get("msg_room")) === null ||
      _g_obj_map$get4 === void 0
        ? void 0
        : _g_obj_map$get4.get("short")) || ""
    );
    if (curName == "容宝斋") {
  ...
  killtalin: function killtalin(callback) {
    ...
    PLU.execActions("golook_room;");
    var curName = UTIL.filterMsg(
      ((_g_obj_map$get5 = g_obj_map.get("msg_room")) === null ||
      _g_obj_map$get5 === void 0
        ? void 0
        : _g_obj_map$get5.get("short")) || ""
    );
    var cmd = "";
    if (curName == "大鹳淜洲") {
      cmd =
        "w;sw;s;s;sw;sw;sw;get tianlongsi_putiguo;se;se;se;ne;get tianlongsi_xiaoxianglu;ne;ne;;get tianlongsi_putiguo;nw;nw;nw;";
    } else {
      cmd =
        "rank go 236;nw;n;n;n;n;n;n;nw;nw;n;n;nw;nw;n;n;nw;ne;event_1_1996692;event_1_10567243;w;sw;s;s;sw;sw;sw;get tianlongsi_putiguo;se;se;se;ne;get tianlongsi_xiaoxianglu;ne;ne;;get tianlongsi_putiguo;nw;nw;nw;";
    }
    PLU.execActions(cmd, function () {
      PLU.execActions("ak;ka;=500;home;");
  ...
  nanzwenz: function nanzwenz(callback) {
    ...
    PLU.execActions("golook_room;");
    var curName = UTIL.filterMsg(
      ((_g_obj_map$get6 = g_obj_map.get("msg_room")) === null ||
      _g_obj_map$get6 === void 0
        ? void 0
        : _g_obj_map$get6.get("short")) || ""
    );
      ...
      UTIL.addSysListener("nanzwenz", function (b, type, subtype, msg) {
        if (type === "main_msg") {
          ...
          if (
            ...
            msgTxt.match("你正在诊治中，请耐心对待病人。") ||
            msgTxt.match("于是你拿起医圣的银针")
          ) {
  ...
  choujiang: function choujiang() {
    ...
    UTIL.addSysListener("choujjuan", function (b, type, subtype, msg) {
      if (
        ...
        YFUI.writeToOut(
          "<span style='color:#FFFF55;'>当前抽奖卷数量: " +
            choujjuan +
            "</span>"
        );
        if (!choujjuan) {
        ...
        countcj &&
        type === "notice" &&
        msg.indexOf("抽奖10次额外获得") !== -1
      ) {
        PLU.execActions("go_choujiang 10");
        countcj--;
      } else if (
        type === "notice" &&
        (msg.indexOf("剩余抽奖次数不够") !== -1 ||
          msg.indexOf("抽奖次数已经用完") !== -1)
      ) {
        UTIL.delSysListener("choujjuan");
        setTimeout(function () {
          UTIL.delSysListener("choujjuan");
          ...
          YFUI.writeToOut(
            "<span style='color:yellow;'>=====完成抽奖=====</span>"
          );
          YFUI.writeToOut(
            "<span style='color:#FF0000;'>获得神秘渔护: " +
              countProte +
              "</span>"
          );
          YFUI.writeToOut(
            "<span style='color:#FF0000;'>获得龙神试炼锦囊: " +
              countTalisman +
              "</span>"
          );
          YFUI.writeToOut(
            "<span style='color:#FF0000;'>获得龙神试炼福袋: " +
              countLSDBag +
              "</span>"
          );
        }, 500);
    ...
    setTimeout(function () {
      PLU.execActions(
        "items get_store /obj/shop/choujiangquan;items info obj_choujiangquan;"
      );
    }, 250);
  },
  ...
  givehuf: function givehuf() {
    //交虎符
    PLU.execActions(
      "jh 1;e;#3 n;n;w;event_1_90287255 go go_lsyj;=200;items get_store /obj/quest/jinyuhufusuipian;event_1_56364978;event_1_51700868;=200;home;"
    );
  },
  ...
  zbjianshen: function zbjianshen() {
    ...
    setTimeout(function () {
      YFUI.writeToOut("<span style='color:yellow;'> ==剑神套完毕!== </span>");
    }, 1500);
  },
  zbchuidiao: function zbchuidiao() {
    ...
    setTimeout(function () {
      YFUI.writeToOut("<span style='color:yellow;'> ==垂钓套完毕!== </span>");
    }, 1500);
  },
  ...
  Qubaos: function Qubaos() {
    PLU.execActions(
      "items get_store /obj/baoshi/lvbaoshi2;" +
        //绿宝石裂开
  ...
  QuTianss: function QuTianss() {
    PLU.execActions(
      "items get_store /obj/baoshi/lvbaoshi8;" +
        //绿宝石天神
  ...
  buyXueLian: function buyXueLian() {
    PLU.execActions(
      "jh 1;e;n;n;n;w;" +
        "#10 buy /map/snow/npc/obj/ice_lotus_N_10 from snow_herbalist;" +
        //购买100雪莲
        "home;"
    );
  },
  LLBao: function LLBao() {
    PLU.execActions(
      "jh 2;#7 n;lq_chunhui_lb;lq_fuai_lb;" +
        //礼包：春晖 父爱
  ...
  QuLiCai: function QuLiCai() {
    PLU.execActions(
      "items get_store /obj/shop/jiuzhuanshendan;" +
        //九转神丹
  ...
  actions: function actions(params) {
    ...
    if (curAct.indexOf("wait#") > -1 || curAct.indexOf("wait ") > -1) {
      var _npc = curAct.substring(
        curAct.indexOf(" ") + curAct.indexOf("?") + 2
      );
      if (
        UTIL.getRoomAllNpc().some(function (e) {
        ...
        UTIL.addSysListener("wait", function (b, type, subtype, msg) {
          if (UTIL.inHome()) {
    ...
    if (curAct.indexOf("ask#") > -1) {
      if (curAct.indexOf("?") > -1) {
        ...
        var npc =
          (_UTIL$findRoomNpc = UTIL.findRoomNpc(
            curAct.substring(curAct.indexOf("?") + 1),
            0,
            1
          )) === null || _UTIL$findRoomNpc === void 0
            ? void 0
            : _UTIL$findRoomNpc.key;
      } else {
    ...
    if (curAct.indexOf("place?") > -1) {
      ...
      if (pName != curName) {
        if (parseInt(backStep)) {
          ...
          var _params$paths;
          (_params$paths = params.paths).slice.apply(
            _params$paths,
            [params.idx, 0].concat(_toConsumableArray(backStep.split(",")))
          );
  ...
  autoFight: function autoFight(params) {
    ...
    var fightAct =
      (_params$fightKind = params.fightKind) !== null &&
      _params$fightKind !== void 0
        ? _params$fightKind
        : "kill";
    var performTime = 0;
    ...
    if (params.targetCommand != "none") {
      clickButton(
        (_params$targetCommand = params.targetCommand) !== null &&
          _params$targetCommand !== void 0
          ? _params$targetCommand
          : fightAct + " " + params.targetKey,
        0
      );
    }
  },
  ...
  toAutoMoke: function toAutoMoke($btn) {
    ...
    PLU.getAllItems(function (list) {
      ...
      var daoNum =
        (daoItems === null || daoItems === void 0 ? void 0 : daoItems.num) || 0;
    ...
    YFUI.showInput({
      ...
      onOk: function onOk(val) {
        ...
        if (arr.length > 1) {
          ...
          PLU.TMP.master =
            (_g_obj_map = g_obj_map) === null ||
            _g_obj_map === void 0 ||
            (_g_obj_map = _g_obj_map.get("msg_attrs")) === null ||
            _g_obj_map === void 0
              ? void 0
              : _g_obj_map.get("master_name");
  ...
  loopSearchFamilyQS: function loopSearchFamilyQS(keys, cmd) {
    ...
    UTIL.addSysListener(
      ...
      function (b, type, subtype, msg) {
        if (type == "main_msg") {
          if (
            msg.indexOf("".concat(PLU.TMP.master, "一拂袖")) >= 0 ||
        ...
        setTimeout(function (o) {
          $(document).one("click", function (o) {
            ...
            if (snpc && snpc.length >= 2) {
              var _snpc$;
              var param =
                (_snpc$ = snpc[3]) !== null && _snpc$ !== void 0 ? _snpc$ : 0;
        ...
        setTimeout(function (o) {
          $(document).one("click", function (o) {
            ...
            if (snpc && snpc.length >= 2) {
              var _snpc$2;
              var param =
                (_snpc$2 = snpc[3]) !== null && _snpc$2 !== void 0
                  ? _snpc$2
                  : 0;
  ...
  autoCombineMasterGem: function autoCombineMasterGem(
    startLvl,
    delay,
    gemCode,
    count
  ...
  toSellLaji: function toSellLaji($btn) {
    ...
    YFUI.showInput({
      title: "清理垃圾",
      text: '格式：物品词组<br>\n                        物品词组：以英文逗号分割多个关键词<br>\n                        <span style="color:red;">例如：</span><br>\n                        [例1] <span style="color:blue;">'.concat(
        defaultList,
        "</span><br>\n                        "
      ),
  ...
  //================================================================================================
  tryVisitQixia: function tryVisitQixia(
    qxName,
    giveNum,
    objectFN,
    ifAutoMj,
    ...
    PLU.getQixiaList(function (qxlist) {
      ...
      var objectFriendNum =
        objectFN !== null && objectFN !== void 0
          ? objectFN
          : PLU.YFD.qixiaFriend.find(function (e) {
              return e.name == qxName;
            }).skillFN;
      ...
      onOk: function onOk() {
        setTimeout(function (o) {
          $(document).one("click", function (o) {
            ...
            var snpc = npcbtn[0].outerHTML.match(
  ...
  setListen: function setListen($btn, listenKey, stat) {
    ...
    if (listenKey == "listenQL") {
        ...
        value:
          ...
          (_ref3 = []).concat
            .apply(
              _ref3,
              _toConsumableArray(
                PLU.YFD.youxiaList.map(function (e) {
                  return e.v;
                })
              )
            )
      ...
      YFUI.writeToOut(
        "<span style='color:#7FFF00;'>当前元宝数量: ".concat(
          yuanbao || "未知",
          "</span>"
        )
      );
  ...
  npcDataUpdate: function npcDataUpdate() {
    var wayList = _toConsumableArray(
      new Set(
        PLU.YFD.mapsLib.Npc.map(function (e) {
          return e.way;
        })
      )
    );
    ...
    PLU.UTIL.addSysListener("look_npc", function (b, type, subtype, msg) {
      ...
      var jh =
        (_PLU$YFD$cityId$roomI = PLU.YFD.cityId[roomInfo.get("map_id")]) !==
          null && _PLU$YFD$cityId$roomI !== void 0
          ? _PLU$YFD$cityId$roomI
          : roomInfo.get("map_id");
      ...
      PLU.YFD.mapsLib.Npc_New.push({
        ...
        id: b.get("id") || "",
        desc: ansi_up.ansi_to_text(
          (_b$get = b.get("long")) === null || _b$get === void 0
            ? void 0
            : _b$get.split("\n")[1]
        ),
        way: wayList[i],
  ...
  //================================================================================================
  toCheckFollowKill: function toCheckFollowKill(
    attacker,
    defender,
    fightType,
    msgText
  ...
  updateShowLog: function updateShowLog(e) {
    var html = '<div style="'
      .concat(e.ext.style, '">')
      .concat(UTIL.getNow(e.ext.time), " ")
      .concat(e.ext.msg, "</div>");
    PLU.logHtml += html;
  ...
  queryRoomPath: function queryRoomPath() {
    ...
    var jh =
      PLU.YFD.cityId[
        (_g_obj_map2 = g_obj_map) === null ||
        _g_obj_map2 === void 0 ||
        (_g_obj_map2 = _g_obj_map2.get("msg_room")) === null ||
        _g_obj_map2 === void 0
          ? void 0
          : _g_obj_map2.get("map_id")
      ];
    if (jh) {
      var _g_obj_map3, _PLU$queryNpc$;
      var room = ansi_up.ansi_to_text(
        (_g_obj_map3 = g_obj_map) === null ||
          _g_obj_map3 === void 0 ||
          (_g_obj_map3 = _g_obj_map3.get("msg_room")) === null ||
          _g_obj_map3 === void 0
          ? void 0
          : _g_obj_map3.get("short")
      );
      return (_PLU$queryNpc$ = PLU.queryNpc(
        jh + "@" + room + "@.*道",
        true
      )[0]) === null || _PLU$queryNpc$ === void 0
        ? void 0
        : _PLU$queryNpc$.way;
    }
  },
  ...
  queryNpc: function queryNpc(name, quiet) {
    ...
    if (findList.length == 0)
      findList = npcLib.filter(function (e) {
        if (
          (e.jh == jh || !jh) &&
          (e.name.match(name) ||
            (e.name_tw && e.name_tw.match(name)) ||
    ...
    if (findList && findList.length > 0) {
      findList.forEach(function (e) {
        var str = [e.jh, e.loc, _(e.name, e.name_tw)]
          .filter(function (s) {
            return !!s;
          })
          .join("-");
      ...
      onPathsFail: function onPathsFail(msg) {
        if (params.count) {
          params.idx = params.paths.indexOf(
            params.paths.find(function (e, i) {
  ...
  killXLR: function killXLR() {
    YFUI.showInput({
      ...
      onOk: function onOk(val) {
        ...
        var ways = val
          ...
          .map(function (v) {
            ...
            if (String(v).indexOf("-") > 0) {
              var m = v.split("-");
              return PLU.YFD.mapsLib.Map.slice(
                parseInt(m[0]) - 1,
                parseInt(m[1])
              )
                .map(function (e) {
                ...
                .join(";");
            } else return (_PLU$YFD$mapsLib$Map = PLU.YFD.mapsLib.Map[parseInt(v) - 1]) === null || _PLU$YFD$mapsLib$Map === void 0 ? void 0 : _PLU$YFD$mapsLib$Map.way;
          })
          .join(";")
          .split(";");
        UTIL.addSysListener("meigui", function (b, type, subtype, msg) {
          if (
            ...
            if (meigui < 100) {
              PLU.execActions(
                "#".concat(
                  Math.ceil((100 - meigui) / 10),
                  " shop buy shop26_N_10"
                )
              );
            }
            PLU.goPathFindNpc({
        ...
        setTimeout(function () {
          PLU.execActions(
            "items get_store /obj/shop/meiguihua;items info meigui hua;"
          );
        }, 250);
      },
      onNo: function onNo() {},
  ...
  toQueryMiTi: function toQueryMiTi() {
    ...
    YFUI.showPop({
      ...
      text: '选择地图, 输入关键词（人物，地点，物品）列表（英文逗号隔开）<br>可模糊匹配<br>\n            <div style=\'margin:10px 0;\'>\n              <span>去哪找: </span>\n              <select id="pathFindMap" style="font-size:15px;height:32px;width:81%;border:1px solid #444;">\n                '
        ...
        .concat(
          PLU.getCache("pathFindKeyword") || "柴绍,李秀宁,大鹳淜洲,天罗紫芳衣",
          '" style="font-size:14px;height:26px;width:80%;border:1px solid #444;"></input>\n            </div>'
        ),
      onOk: function onOk() {
        var mapStr = $.trim($("#pathFindMap").val()),
  ...
  openCombineGem: function openCombineGem() {
    ...
    htm += "</div>";
    htm +=
      '<div style="margin:10px 0 0 3px;position:absolute;left:15px;bottom:10px;">每次连续合成最多 <input id="maxCombine" type="number" value="1" style="width:50px;height:25px;line-height:25px;" maxlength="3" min=1 max=9999 oninput="if(value.length>4)value=value.substr(0,4)"/> 颗宝石。</div>';
    YFUI.showPop({
      title: "合成宝石",
      text: htm,
      width: "382px",
  ...
  combineGem: function combineGem(type, grade) {
    ...
    var needGem = function needGem(gemGrade, needNum, gemList) {
      ...
      var gemNum =
        (_objGem$num =
          objGem === null || objGem === void 0 ? void 0 : objGem.num) !==
          null && _objGem$num !== void 0
          ? _objGem$num
          : 0;
      if (gemNum >= needNum) {
...
unsafeWindow.UTIL = {
  ...
  getItemFrom: function getItemFrom(name) {
    ...
    if (g_gmain.is_fighting) return;
    var item =
      (_g_obj_map$get7 = g_obj_map.get("msg_room")) === null ||
      _g_obj_map$get7 === void 0
        ? void 0
        : _g_obj_map$get7.elements.find(function (it) {
            return (
              it.key.substring(0, 4) == "item" && it.value.indexOf(name) >= 0
            );
          });
    if (item) {
...
unsafeWindow.YFUI = {
  ...
  showPop: function showPop(params) {
    ...
    var ph =
      '<div style="z-index:9999;position:fixed;top: 40%;left:50%;width:100%;height:0;font-size:14px;" id="myTools_popup">\n            <div class="popup-content" style="width:'
        .concat(
          params.width || "70%",
    ...
    if (params.onNo)
      ph +=
        '<button style="margin-right: 15px;padding: 5px 20px;border: 1px solid #000;border-radius:5px;" class="btnno">'.concat(
          noText,
          "</button>"
        );
    ph +=
      '<button style="padding: 5px 20px;background-color: #963;color:#FFF;border: 1px solid #000;border-radius: 5px;" class="btnok">'.concat(
        okText,
        "</button>\n            </div></div></div>"
      );
    var $ph = $(ph);
  ...
  showInput: function showInput(params) {
    ...
    if (params.inputs && params.inputs.length > 1) {
      for (var i = 0; i < params.inputs.length; i++) {
        ...
        popParams.text +=
          '<div><div style="width:20%;float:left;margin:5px 0;line-height:2;text-align:right;">'.concat(
            params.inputs[i],
            ': </div><div style="width:73%;margin-left:21%;">'
          );
        popParams.text +=
          params.type == "textarea"
            ? '<textarea id="myTools_popup_input_'
                .concat(i, '" rows="4" style="')
                .concat(inpstyle, '">')
                .concat(val, "</textarea></div></div>")
            : '<input id="myTools_popup_input_'
                .concat(i, '" type="text" value="')
                .concat(val, '" style="')
                .concat(inpstyle, '"/></div></div>');
      }
      ...
      popParams.text +=
        params.type == "textarea"
          ? '<div><textarea id="myTools_popup_input" rows="4" style="'
              .concat(inpstyle, '">')
              .concat(params.value || "", "</textarea></div>")
          : '<div><input id="myTools_popup_input" type="text" value="'
              .concat(params.value || "", '" style="')
              .concat(inpstyle, '"/></div>');
      popParams.onOk = function () {
  ...
  showInfoPanel: function showInfoPanel(params) {
    ...
    var $ph = $(
      '<div style="z-index:9900;position:fixed;top:10%;left:0;width:100%;height:0;font-size:12px;" id="myTools_InfoPanel">\n            <div class="infoPanel-content" style="width:'
        ...
        .concat(
          params.text || "",
          '</div>\n                <div style="text-align:right;padding: 10px;">\n                <button style="padding: 5px 20px;background-color: #969;color:#FFF;border: 1px solid #000;border-radius: 5px;margin-right:25px;" class="btnno">'
        )
        .concat(
          noText,
          '</button>\n                <button style="padding: 5px 20px;background-color: #963;color:#FFF;border: 1px solid #000;border-radius: 5px;" class="btnok">'
        )
        .concat(
          okText,
          "</button>\n                </div>\n            </div></div>"
...
if (GM_info.script.name == "无剑Mud辅修(OL)(alpha)") {
  PLU.version = GM_info.script.version;
  unsafeWindow.init();
} else {
  $.ajax({
    url: "https://update.greasyfork.org/scripts/486573.json?t=".concat(
      Date.now()
    ),
    dataType: "text",
    crossDomain: "true",
    ...
    PLU.version = JSON.parse(res)["version"];
