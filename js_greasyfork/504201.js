...
// @description  Предупреждение. Закрытая тема
...
// @downloadURL https://update.greasyfork.org/scripts/504201/WarningTheme.user.js
// @updateURL https://update.greasyfork.org/scripts/504201/WarningTheme.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    function createWarningBanner() {
        ...
        warningBanner.style.background = "#342B1C";
        warningBanner.style.color = "#E6BF4A";
