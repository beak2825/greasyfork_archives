// ==UserScript==
// @name       Hybrid - Calls - Contact (With B)
// @version    2.01
// @author	   jawz
...
// @downloadURL https://update.greasyfork.org/scripts/28038/Hybrid%20-%20Calls%20-%20Contact%20%28With%20B%29.user.js
// @updateURL https://update.greasyfork.org/scripts/28038/Hybrid%20-%20Calls%20-%20Contact%20%28With%20B%29.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Contact")').length) {
    ...
    createButton('No',0,0,1,1,'no longer works for company');
    createButton('Wrong Biz',0,1,2,2,'wrong business');
    createButton('Out of Biz',0,1,1,1,'out of business');
    createButton('DC',2,2,2,3,'Disconnected');
    createButton('DC - Directory',2,2,2,3,'Disconnected - Directory');
    createButton('DC - Not Completed',2,2,2,3,'Disconnected - Could not be completed as dialed');
    createButton('Fax',3,2,2,3,'Fax');
    createButton('Generic VM',0,2,2,2,'Generic oicemail with no info.');
    createButton('Personal VM',0,2,2,2,'Personal voicemail with no info.');
    createButton('Ringing', 3,2,2,2,'Kept ringing');
    createButton('Silence',3,2,2,2,'Rang until silence');
    createButton('Regular Busy',0,2,2,2,'Regular busy signal');
    createButton('Fast Busy',2,2,2,2,'Fast busy signal');
