...
// @downloadURL https://update.greasyfork.org/scripts/369752/Test%201.user.js
// @updateURL https://update.greasyfork.org/scripts/369752/Test%201.meta.js
// ==/UserScript==
...
for (var i = 0; i < tags.length; i++) {
        if(tags[i].src.match(/\/\/cfile.*\/daumcdn.*\//i)){
                ...
                link.href = tags[i].src.replace(' ', '?original');
