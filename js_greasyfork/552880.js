// ==UserScript==
// @name         Queslar 2 简中汉化脚本
// @version      0.0.3
// @description  基于QS1简中汉化的 Queslar 2 的简体中文汉化脚本。
// @author       好阳光的小锅巴, 麦子, LemonApostle
...
// @namespace https://greasyfork.org/users/1489939
// @downloadURL https://update.greasyfork.org/scripts/552880/Queslar%202%20%E7%AE%80%E4%B8%AD%E6%B1%89%E5%8C%96%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/552880/Queslar%202%20%E7%AE%80%E4%B8%AD%E6%B1%89%E5%8C%96%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==

var cnItems = {
    _OTHER_: [],
    "Increases member resource gain by": "增加成员资源获取量",
    "Increases member gold gain by": "增加成员金币获取量",
    "Increases member stat drop chance by": "增加成员属性掉落几率",
    "Increases member drop chance by": "增加成员掉落几率",
    "Increases village armory size by": "增加村庄军械库容量",
    "Increases member experience gain by": "增加成员经验获取量",
    "Increases member tax efficiency by": "增加成员税收效率",
    "Increases village quest rewards by": "增加村庄任务奖励",
    "Increases member quest rewards by": "增加成员任务奖励",
    "Increases member slots by": "增加成员槽位",
    "Increases member house token drop amounts by": "增加成员房屋代币掉落数量",
    "Increases village map movement speed by": "增加村庄地图移动速度",
    "Increses member potion effects by": "增加成员药水效果",
    "No items selected": "未选择任何物品",
    "Add Stat": "添加属性要求",
    "No stat requirements added": "未添加属性要求",
    "for": "以",
    "Livingroom": "客厅",
    "No active queue to speed up": "没有可加速的生效中队列",
    "Queue Slot": "队列槽位",
    "Time:": "时间：",
    "Village message": "村庄消息",
    "Saving strength for member slots": "为成员槽位保留实力",
    "Newcomer": "新来者",
    "Exploration Attack Token": "探索攻击代币",
    "Upgrade Cost": "升级成本",
    "Player activity": "玩家活动",
    "Partner Experience": "伙伴经验",
    "Partner Speed Flat": "伙伴速度（固定值）",
    "Partner Intelligence Flat": "伙伴智力（固定值）",
    "Partner As Meat": "伙伴产出转为肉类",
    "Partner As Iron": "伙伴产出转为铁矿",
    "Partner As Wood": "伙伴产出转为木材",
    "Partner As Stone": "伙伴产出转为石料",
    "Crafting Experience": "制造经验",
    "Crafting Experience Flat": "制造经验（固定值）",
    "Battling lvl": "战斗等级",
    "% to lvl": "升级进度(%)",
    "Daily Gains": "每日收益",
    "Battling Gold": "战斗金币",
    "Weekly Gains": "每周收益",
    "Member since": "成为成员于",
    "Total Contribution": "总贡献",
    "Village Impact": "村庄影响力",
    "Space -": "空格 -",
    "Availability": "可用状态",
    "Loaned": "已借出",
    "Available": "可借用",
    ...
    "Prefer": "偏好",
    "Refresh Quests": "刷新任务",
    "Daily refreshes:": "每日刷新次数：",
    "View Queued Quests": "查看已接任务",
    "Tireless Workers": "不知疲倦的工人",
    "HARD": "困难",
    "Member actions": "成员行动",
    "Master Explorers": "探索大师",
    "Village explorations completed": "已完成的村庄探索",
    "Prosperous Village": "繁荣的村庄",
    "Gold taxed": "已征税金币",
    "Economic Growth": "经济增长",
    "MEDIUM": "中等",
    "Village Explorations": "村庄探索",
    "Show Preview": "显示预览",
    "No past explorations found.": "未找到过去的探索记录。",
    "Start your first exploration to begin your village's adventure!": "开始你的第一次探索，开启你们村庄的冒险吧！",
    "Village Groups": "村庄分组",
    "Create Group": "创建分组",
    ...
    "Augment": "优化",
    "augment": "优化",
    "Compare to equipped": "与已装备的比较",
    "Permissions": "权限",
    "Building & Strength": "建筑与实力",
    "Upgrade Buildings": "升级建筑",
    "Assign Strength": "分配实力点",
    ...
    "Fight again": "再次战斗",
    "Character Name": "角色名称",
    "Pending Applications": "待处理的申请",
    "No pending applications": "无待处理的申请",
    "Sent Invites": "已发送的邀请",
    "No pending invites": "无已发送的邀请",
    "Message of the Day": "每日消息",
    "This message will be displayed to all village members.": "这条消息将对所有村庄成员显示。",
    "Armory Settings": "军械库设置",
    "Leave Village": "离开村庄",
    "Last World Boss": "上一个世界首领",
    "Last Spawn": "上次刷新",
    "Boss Level": "首领等级",
    "View latest leaderboards": "查看最新排行榜",
    "No World Boss Rewards": "无世界首领奖励",
    "Your world boss rewards will appear here when you participate in world boss battles.": "当你参与世界首领战后，你的奖励将显示在此处。",
    "titles": "称号",
    "Title creator": "称号创建者",
    "Title Text": "称号文本",
    "Enter any text to view the modification menu": "输入任意文本以查看修改菜单",
    "Preview:": "预览：",
    "Create Title": "创建称号",
    "Your Credits:": "你的代币：",
    "Amount (Credits)": "数量 (代币)",
    "Exchange Rate": "汇率",
    "Credits for $": "代币换 $",
    "VIP Package": "VIP礼包",
    "Benefits": "权益",
    "Multiplicative gold income": "乘法金币收入",
    "Multiplicative experience gain": "乘法经验增益",
    "Multiplicative increased drop chances": "乘法增加掉落几率",
    "Multiplicative increased stat drop chances": "乘法增加属性掉落几率",
    "Multiplicative resource income": "乘法资源收入",
    "Duration": "持续时间",
    "Day": "天",
    "credits": "代币",
    "Quality of Life Package": "生活质量礼包",
    "Your actions will go idle after 72 hours of inactivity": "在无活动72小时后，你的行动将进入挂机状态",
    "3 additional quests can be added to the quest queue at once": "任务队列可同时额外增加3个任务",
    "3 additional quests can be be added to the house queue at once": "房屋队列可同时额外增加3个任务",
    "Your character auto joins world bosses": "你的角色自动加入世界首领战",
    "Your fighers run 60 dungeons automatically every hour": "你的战士每小时自动进行60次地下城",
    "Fighter Cave": "战士洞穴",
    "Icons (": "图标 (",
    "Characters": "角色",
    "Monsters": "怪物",
    ...
    "Local Time": "本地时间",
    "Choose your timezone preference": "选择你的时区偏好",
    "Clock Format": "时钟格式",
    "24 Hour": "24小时制",
    "Time display format": "时间显示格式",
    "Number Formatting": "数字格式化",
    "Letters (1.23M)": "字母 (1.23M)",
    "How large numbers are displayed": "大数字的显示方式",
    "Number Locale": "数字地区格式",
    "How number separation is displayed": "数字分隔符的显示方式",
    "Info Boxes": "信息框",
    "On Hover": "悬停时",
    "How info boxes are triggered": "信息框的触发方式",
    "Delay before info boxes appear on hover": "悬停后信息框出现的延迟",
    "Item Naming": "物品命名",
    "Standard (Random Names)": "标准 (随机名称)",
    "How items are named in the game": "游戏中物品的命名方式",
    "Default pagination": "默认分页",
    "The default number of rows in tables": "表格中默认的行数",
    "Enable Emotes": "启用表情",
    "Show emotes in chat": "在聊天中显示表情",
    "Enable titles": "启用称号",
    "Player generated titles use custom styling": "玩家生成的称号使用自定义样式",
    "Shattered Currency Selector": "破碎货币选择器",
    "Default shattered currency selection state": "破碎货币选择器的默认状态",
    "Save Changes": "保存更改",
    "Notifications": "通知",
    "Manage push notifications for game events": "管理游戏事件的推送通知",
    "Enable Notifications": "启用通知",
    "Receive push notifications for game events": "接收游戏事件的推送通知",
    "Chat Settings": "聊天设置",
    "Customize your chat experience": "自定义你的聊天体验",
    "Display all channels in a single view": "在单一视图中显示所有频道",
    "Reverse Chat": "反转聊天",
    "Show newest messages at the bottom": "在新消息显示在底部",
    "Auto Reply": "自动回复",
    "Automatically send reply when whispered": "在收到私聊时自动发送回复",
    "Save Chat Settings": "保存聊天设置",
    "Ignore User": "忽略用户",
    "Ignore messages from specific users": "忽略特定用户的消息",
    "Ignore": "忽略",
    "Ignore List": "忽略列表",
    "You are not ignoring anyone": "你没有忽略任何人",
    "Ignored By": "忽略你的人",
    "Nobody is ignoring you": "没有人忽略你",
    "Account Information": "账户信息",
    "Your account details and security settings": "你的账户详情和安全设置",
    "Account Created": "账户创建于",
    "Two-Factor Authentication": "双因素认证",
    "Add an extra layer of security to your account": "为你的账户增加一层额外的安全保障",
    "Start activation": "开始激活",
    "Update your account password": "更新你的账户密码",
    "Active Sessions": "生效中的会话",
    "Manage your active sessions across different devices": "管理你在不同设备上生效中的会話",
    "sessions": "个会话",
    "Change Email Address": "更改邮箱地址",
    "Update your account email address": "更新你的账户邮箱地址",
    "New Email Address": "新邮箱地址",
    "Metric": "指标",
    "Action": "行动",
    "Hour": "小时",
    "Experience Taxed": "已征税经验",
    "Gold Taxed": "已征税金币",
    "Relics Taxed": "已征税圣物",
    "Iron Taxed": "已征税铁矿",
    "Meat Taxed": "已征税肉类",
    "Stone Taxed": "已征税石料",
    "Wood Taxed": "已征税木材",
    "Quick Menu Settings": "快捷菜单设置",
    "Configure which items appear in your quick menu and their order. Drag enabled items to reorder them.": "配置哪些项目在你的快捷菜单中显示及其顺序。拖动已启用的项目以重新排序。",
    "Enabled Menus": "已启用的菜单",
    "No items enabled. Toggle items below to add them to your quick menu.": "无已启用的项目。切换下方的项目以将其添加到你的快捷菜单。",
    "Available Menus": "可用的菜单",
    "Partner Quick Access": "伙伴快捷访问",
    "Active Character Quest": "当前角色任务",
    "Recipes Quick Access": "配方快捷访问",
    "Personal Taxes": "个人税率",
    "Configure what percentage of rewards you want to contribute from various activities to your village (0-100%)": "配置你希望从各种活动中贡献给你村庄的奖励百分比 (0-100%)",
    "Reset to Defaults": "重置为默认",
    "Confirmation Settings": "确认设置",
    "Choose which actions require confirmation dialogs to prevent accidental actions": "选择哪些操作需要确认对话框以防止误操作",
    "General Actions": "通用操作",
    "Resets": "重置",
    "Reset menus": "重置菜单",
    "Various upgrades": "各种升级",
    "Currency transfers": "货币转移",
    "Deletions": "删除",
    "Deleting items": "删除物品",
    "Un/equipping items": "穿/脱装备",
    "Kick Member": "踢出成员",
    "Removing party members": "移除队伍成员",
    "Modifying party settings": "修改队伍设置",
    "Joining/Leaving current party": "加入/离开当前队伍",
    "Disbanding your party": "解散你的队伍",
    "Market Actions": "市场操作",
    "Purchasing currency": "购买货币",
    "Selling currency": "出售货币",
    "Purchasing items": "购买物品",
    "Selling items": "出售物品",
    "Village Actions": "村庄操作",
    "Village upgrades": "村庄升级",
    "Modifying village settings": "修改村庄设置",
    "Donating to village": "向村庄捐赠",
    "Invite Member": "邀请成员",
    "Inviting new members": "邀请新成员",
    "Removing village members": "移除村庄成员",
    "Joining/Leaving current village": "加入/离开当前村庄",
    "Disband": "解散",
    "Disbanding your village": "解散你的村庄",
    "Theme Settings": "主题设置",
    "Customize your application's colors and typography.": "自定义你的应用程序的颜色和排版。",
    "Dark Mode": "暗色模式",
    "Import CSS": "导入CSS",
    "Export CSS": "导出CSS",
    "Interactive": "交互",
    ...
    "No API key found. Generate one to get started with programmatic access.": "未找到API密钥。生成一个以开始程序化访问。",
    "Generate API Key": "生成API密钥",
    "API Documentation": "API文档",
    "Can also be found at": "也可以在以下地址找到",
    "Open Menu": "打开菜单",
    "Open Search": "打开搜索",
    "Keyboard Shortcut:": "键盘快捷键：",
    "CTRL": "CTRL",
    "Open API Client": "打开API客户端",
    ...
    "Expand Test": "展开测试",
    "Test": "测试",
    "Expand Character": "展开角色",
    "Expand Party": "展开队伍",
    "Expand Partner": "展开伙伴",
    "Expand Fighter": "展开战士",
    "Expand Village": "展开村庄",
    "World Bosses": "世界首领",
    "Expand World Boss": "展开世界首领",
    "Queslar API": "Queslar API",
    "Download OpenAPI Document": "下载 OpenAPI 文档",
    "json": "json",
    "yaml": "yaml",
    "API for V2.Queslar.com": "V2.Queslar.com 的 API",
    "Server:": "服务器：",
    ...
    "Python": "Python",
    "More": "更多",
    "from all clients": "来自所有客户端",
    "Shell Curl": "Shell Curl",
    "GET": "GET",
    "Send get request to": "发送 GET 请求至",
    "Close Client": "关闭客户端",
    "Auth": "认证",
    "Cookies": "Cookies",
    "Headers": "请求头",
    ...
    "Authentication": "验证",
    "Required": "必需",
    "Selected Auth Type:": "已选择的认证类型：",
    "ApiKeyAuth": "API密钥认证",
    "Show Password": "显示密码",
    "Variables": "变量",
    "Cookie Enabled": "启用Cookie",
    "Cookie Key": "Cookie键",
    "Cookie Value": "Cookie值",
    "Key": "键",
    "Clear": "清除",
    "All Headers": "所有请求头",
    "Header Enabled": "启用请求头",
    "Header Key": "请求头键",
    "Header Value": "请求头值",
    "Query Parameters": "查询参数",
    "Parameter Enabled": "启用参数",
    "Parameter Key": "参数键",
    "Parameter Value": "参数值",
    "Code Snippet": "代码片段",
    "(Collapsed)": "(已折叠)",
    "Curl": "Curl",
    "Back to Dungeon": "返回地下城",
    "Filter by outcome:": "按结果筛选：",
    "Win": "胜利",
    "Loss": "失败",
    "No battle log entries": "无战斗日志条目",
    "Your fighter dungeon battles will appear here.": "你的战士在地下城中的战斗将显示在此处。",
    "Min": "最低",
    "Loading": "加载中",
    "level": "等级",
    "Maximum depth for rush depth mode": "速通模式最大深度",
    "(Main)": "(主手)",
    "(Off)": "(副手)",
    "to": "至",
    "referrals": "推荐",
    ...
    "Partner Drops": "伙伴掉落",
    "Sanctum": "圣所",
    "Available actions": "可用行动点",
    "Active Potions": "生效中的药水",
    "You can have up to": "你最多可以同时激活",
    "different types of potions active at once": "种不同类型的药水",
    "No active potions. Activate potions below to gain bonuses.": "无生效中的药水。激活下方的药水以获得增益。",
    "Available Potions": "可用药水",
    "Activate potions to gain temporary bonuses for 1 hour": "激活药水以获得持续1小时的临时增益",
    "Inactive": "未激活",
    "gold multiplier": "金币倍率",
    "minutes": "分钟",
    "Available:": "可用数量：",
    "Activate": "激活",
    "meat multiplier": "肉类倍率",
    "chance for additional quest progress": "额外任务进度几率",
    "stats multiplier": "属性倍率",
    "drop multiplier": "掉落倍率",
    "wood multiplier": "木材倍率",
    "iron multiplier": "铁矿倍率",
    "stone multiplier": "石料倍率",
    "Automated world boss participations": "自动参与世界首领次数",
    "Automated dungeons an hour": "每小时自动地下城次数",
    "type": "类型",
    "crafted": "已打造",
    "Favored": "偏好",
    "favored": "偏好",
    "Stat filter": "属性筛选",
    "stats": "属性",
    "Configure stats": "配置属性",
    "Req": "要求",
    "No gem equipped": "未装备宝石",
    "No enchant equipped": "未装备附魔",
    "Gold Potion": "金币药水",
    "Meat Potion": "肉类药水",
    "Quest Progress Potion": "任务进度药水",
    "Stats Potion": "属性药水",
    "Drops Potion": "掉落药水",
    "Wood Potion": "木材药水",
    "Iron Potion": "铁矿药水",
    "Stone Potion": "石料药水",
    "World Boss Potion": "世界首领药水",
    "Dungeons Potion": "地下城药水",
    "Stats Potion market": "属性药水市场",
    "Back to Dungeon": "返回地下城",
    "Filter by outcome:": "按结果筛选：",
    "Win": "胜利",
    "Loss": "失败",
    ...
    "Your fighter dungeon battles will appear here.": "你的战士在地下城中的战斗将显示在此处。",
    "Base Stats": "基础属性",
    "Highest Monster": "最高（击败）怪物",
    "Dungeon Level": "地下城等级",
    "Daily Battling Actions": "每日战斗行动",
    "Daily Battling Gold": "每日战斗金币",
    "Create New Set": "创建新套装",
    "No equipment sets created yet.": "尚未创建任何装备套装。",
    "Show slot boost effects": "显示槽位增益效果",
    "Virtue is a consumable currency required by some recipes": "“美德”是一些配方所需的消耗性货币",
    "Link item in chat": "在聊天中链接物品",
    "The req is the character level requirement for you to be able to equip the item": "Req 是你装备该物品所需的角色等级要求",
    "The total is the sum of all the stats on the item": "Total 是物品上所有属性的总和",
    "The iLevel (Item level) of the item determines the value of its base stats": "物品的 iLevel (物品等级) 决定了其基础属性的数值",
    "Battle Boosts": "战斗增益",
    "Partner Boosts": "伙伴增益",
    "Income Boosts": "收入增益",
    "Increases Crit Chance during combat actions": "在战斗行动中增加暴击率",
    "Increases Crit Damage during combat actions": "在战斗行动中增加暴击伤害",
    "Increases Multistrike during combat actions": "在战斗行动中增加多次攻击几率",
    "Increases Healing during combat actions": "在战斗行动中增加治疗效果",
    "Increases Defense during combat actions": "在战斗行动中增加防御力",
    "Partner XP": "伙伴经验",
    "Increases experience gained by partners from all activities": "增加伙伴从所有活动中获得的经验",
    "Partner XP Tile": "伙伴经验地块",
    "Premium Boosts": "高级增益",
    "VIP": "VIP",
    "Meat Income": "肉类收入",
    "Increases meat gained from hunting partner actions": "增加狩猎伙伴行动中获得的肉类",
    "Hunting Boost": "狩猎增益",
    "Resource Tile": "资源地块",
    "Meat Tile": "肉类地块",
    "Potion": "药水",
    "Iron Income": "铁矿收入",
    "Increases iron gained from mining partner actions": "增加采矿伙伴行动中获得的铁矿",
    "Mining Boost": "采矿增益",
    "Iron Tile": "铁矿地块",
    "Wood Income": "木材收入",
    "Increases wood gained from woodcutting partner actions": "增加伐木伙伴行动中获得的木材",
    "Woodcutting Boost": "伐木增益",
    "Wood Tile": "木材地块",
    "Stone Income": "石料收入",
    "Increases stone gained from stonecarving partner actions": "增加石刻伙伴行动中获得的石料",
    "Stonecarving Boost": "石刻增益",
    "Stone Tile": "石料地块",
    "Partner Income as Meat": "伙伴收入转为肉类",
    "Adds meat as a % of your partner income": "将伙伴收入的一部分按百分比转化为肉类",
    "Partner Income as Meat Tile": "伙伴收入转为肉类地块",
    "Partner Income as Iron": "伙伴收入转为铁矿",
    "Adds iron as a % of your partner income": "将伙伴收入的一部分按百分比转化为铁矿",
    "Partner Income as Iron Tile": "伙伴收入转为铁矿地块",
    "Partner Income as Wood": "伙伴收入转为木材",
    "Adds wood as a % of your partner income": "将伙伴收入的一部分按百分比转化为木材",
    "Partner Income as Wood Tile": "伙伴收入转为木材地块",
    "Partner Income as Stone": "伙伴收入转为石料",
    "Adds stone as a % of your partner income": "将伙伴收入的一部分按百分比转化为石料",
    "Partner Income as Stone Tile": "伙伴收入转为石料地块",
    "Increases gold gained globally": "全局增加获得的金币",
    "Gold Tile": "金币地块",
    "Experience boost": "经验增益",
    "Increases experience gained globally": "全局增加获得的经验",
    "Experience Tile": "经验地块",
    "Stat boost": "属性增益",
    "Increases stat gained globally": "全局增加获得的属性",
    "Stat Tile": "属性地块",
    "Drop boost": "掉落增益",
    "Increases drop gained globally": "全局增加获得的掉落",
    "Drop Tile": "掉落地块",
    "Potion Effect": "药水效果",
    "Increases the effect of potions": "增加药水的效果",
    "Potent": "强效",
    "Potion Effect Tile": "药水效果地块",
    "Relics Amount": "圣物数量",
    "Increases your value of relics when dropped": "增加你掉落时圣物的价值",
    "Increased Base Relics": "已增加基础圣物",
    "Potion Count": "药水数量",
    "Increases your max active potion count": "增加你最大生效药水数量",
    "Quest Rewards": "任务奖励",
    "Increases quest rewards": "增加任务奖励",
    "House Tokens": "房屋代币",
    "Increases house token drop amounts": "增加房屋代币掉落数量",
    "Track your ranking and performance progress over time": "追踪你长期的排名和表现进度",
    "positions": "个名次",
    "Best:": "最佳：",
    "From": "从",
    "Rank:": "排名：",
    "Your Referrals": "你的推荐",
    "You receive a bonus of 2.5% of relic drops and 5% of credit purchases from referred characters": "你将从被推荐的角色处获得 2.5% 的圣物掉落和 5% 的代币购买加成",
    "Ref link": "推荐链接",
    "character": "个角色",
    "from referred users": "来自被推荐用户",
    "No referrals yet": "尚无推荐",
    "Characters created by users you've referred will appear here.": "由你推荐的用户所创建的角色将显示在此处。",
    "Min": "最低",
    "Loading": "加载中",
    "found +": "发现了 +",
    "Lives together with": "与...共同生活",
    "Toggle Fighter Gold": "切换战士金币",
    "Allocate Gold": "分配金币",
    "Preset Allocated": "已分配预设",
    "Remaining Gold": "剩余金币",
    ...
    "Back Row": "后排",
    "Empty Slot": "空槽位",
    "An assigned preset will take preference over the active preset": "已指定的预设将优先于当前激活的预设",
    "Fighter Gold": "战士金币",
    "Your Formation": "你的阵型",
    "helmet": "头盔",
    "shield": "盾牌",
    "No fighters assigned to your formation": "你的阵型中没有已指定的战士",
    "Set an active preset on the fighters page": "请在战士页面设定一个激活的预设",
    "Enter Battle!": "进入战斗！",
    "You need at least one fighter in your formation to battle": "你的阵型中至少需要一名战士才能战斗",
    "Combat Stats": "战斗属性",
    "Join/create channel": "加入/创建频道",
    "View Cave": "查看洞穴",
    "Cave Exploration Settings": "洞穴探索设置",
    "Deeper Limit": "深入探索生命值下限",
    "Fighters will not go deeper if % health is lower than input": "当生命值百分比低于输入值时，战士将停止深入探索",
    "Leave Limit": "撤离生命值下限",
    "Fighters will try to leave if % health is lower than input": "当生命值百分比低于输入值时，战士将尝试离开",
    "Skip Boss": "跳过首领",
    "Fighters will skip bosses above input difficulty": "战士将跳过难度高于输入值的首领",
    "Default Mode": "默认模式",
    "Focus specials": "集中使用特殊技能",
    "Exploration mode": "探索模式",
    "Fighters will leave when reaching this depth depth": "达到此深度时战士将离开",
    "Rush Depth Max": "速通最大深度",
    "Closest Tile Depth": "最近地块距离阈值",
    "Fighters will go to next depth if the closest tile is further than input": "如果最近的地块距离超过输入值，战士将前往下一深度",
    "Closest Tile Depth Type": "最近地块类型目标",
    "What type of tiles to target in the closest tile check": "在最近地块检查中要以何种类型的地块为目标",
    "Exploration & Navigation": "探索与导航",
    "Loot Enhancement": "战利品强化",
    "Increases your visibility range in a cave. (Diminishing returns of 97.5% per depth)": "增加你在洞穴中的视野范围。（每深入一层，效果递减97.5%）",
    "compass": "指南针",
    "Increases the average size of every room in a cave by a %": "按百分比增加洞穴中每个房间的平均大小",
    "map": "地图",
    "No cave history": "无洞穴历史记录",
    "Complete some caves to see your history here.": "完成一些洞穴来在此处查看你的历史记录。",
    "Ending Depth": "最终深度",
    "Min level": "最低等级",
    "virtue": "潜能",
    "Item Level": "物品等级",
    ...
    "previous page": "上一页",
    "next page": "下一页",
    "an automation to edit": "一个自动化操纵进行编辑",
    "Empty Enchant Slot. Click to equip": "空的附魔槽。点击装备",
    "two gem pieces to": "两颗宝石来",
    "Enhances a random tier of an existing equipment piece by +1": "将一件现有装备的一个随机层级强化 +1",
    "Enhances a random tier of an existing fighter equipment piece by +1": "将一件现有战士装备的一个随机层级强化 +1",
    "Enhances a random tier of an existing pet by +1": "将一只现有宠物的一个随机层级强化 +1",
    "Merges the stats of two items, keeping the rarest base. At most 2 locks will remain": "合并两个物品的属性，保留稀有度更高的底材。最多保留2个锁定",
    "Merges the modifiers and stats of two pets, keeping the rarest base. At most 2 locks will remain": "合并两只宠物的词条和属性，保留稀有度更高的底材。最多保留2个锁定",
    "Removes all locks from stats of an existing equipment piece": "移除一件现有装备上的所有属性锁定",
    "Removes all locks from stats of an existing pet": "移除一只现有宠物上的所有属性锁定",
    "game data": "游戏数据",
    "filters": "过滤器",
    "emotes": "表情",
    'Staff Tracker': '物品追踪器',
    "REWRITTEN": "重制版",
    "Join the open beta!": "加入公开测试！",
    "Welcome back to the OPEN BETA, adventurer!": "欢迎回到公开测试，冒险者！",
    "Previews": "预览",
    "Redesigned world bosses": "重新设计的世界Boss",
    "Game Log": "游戏日志",
    "Navigation": "导航",
    "Action tracker": "行动追踪",
    "Quick menu": "快捷菜单",
    ...
    "Loading emotes...": "正在加载表情...",
    "Loading more messages": "正在加载更多消息...",
    "Load more": "加载更多",
    "BETA - Characters will reset on release.": "测试版 - 角色将在正式发布时重置。",
    "Release planned - October 10th": "计划发布日期 - 10月10日",
    "No drops found": "未发现掉落物",
    "Solo Ironman": "单人铁人模式",
    "The default experience with full trading capabilities and multiplayer interactions. Play alongside other players, trade items, and participate in all social features.": "拥有完整交易能力和多人互动的默认体验。与其他玩家并肩作战，交易物品，并参与所有社交功能。",
    "Solo self-sufficient mode where you must obtain everything yourself. Grouped play still exists, but no market and trading. A true test of individual skill and dedication.": "你需要自给自足的单人模式。组队游戏仍然存在，但没有市场和交易。这是对个人技巧和奉献精神的真正考验。",
    "Ironman, but for the true lone wolf. No trading, no group play. The ultimate solo experience.": "铁人模式，但专为真正的独狼玩家设计。没有交易，没有组队。终极的单人体验。",
    "Pay for mercenary fighters. Train them and send them off to the dungeons and hope they survive to provide loot back to you. Send them against other players mercenaries. Rule the strongest army and climb to the top of the ladder.": "雇佣佣兵战士。训练他们，派他们进入地牢，并期望他们能活着带回战利品。派他们与其他玩家的佣兵对抗。统治最强的军队，攀登天梯之巅。",
    "Explore countless other features and systems designed to provide endless entertainment and strategic depth in your medieval adventure.": "探索无数其他功能和系统，它们旨在为你的中世纪冒险提供无尽的娱乐和战略深度。",
    "Combat": "战斗",
    "battling": "战斗中",
    "Activities": "活动",
    "Active": "当前",
    ...
    "rounds": "回合",
    "After": "经过",
    "rounds you have": "回合后，你",
    "come out victorious": "取得了胜利",
    "The monster dropped": "怪物掉落了",
    "gold": "金币",
    "Avg:": "平均:",
    "DPR | Crits:": "每回合伤害 | 暴击:",
    "Multistrikes:": "多重攻击:",
    ...
    "Forging": "锻造",
    "equipped": "已装备",
    "Empty Gem Slot. Click to equip": "空的宝石槽。点击装备",
    "Empty Item Slot. Click to equip": "空的物品槽。点击装备",
    "Go to Body upgrade": "前往身体升级",
    "Click to change item": "点击更换物品",
    "Blah Games. All rights reserved": "Blah Games. 保留所有权利",
    "exp": "经验",
    "BP": "BP",
    "DMs": "私信",
    "OWNER": "所有者",
    ...
    "min": "分钟",
    "sec": "秒",
    "Bulk Modify All": "批量修改全部",
    "Toggle Shattered Currency": "切换破碎货币",
    "Start Actions": "开始行动",
    "Continue": "继续",
    "Cancel": "取消",
    "Create Enchantment": "创建附魔",
    "Upgrade slot": "升级槽位",
    "Equip Pet": "装备宠物",
    "gained": "获得",
    "Upgrade intelligence": "升级智力",
    "Upgrade speed": "升级速度",
    "Hunting Experience": "狩猎经验",
    "Desert": "沙漠", // 地名
    "boost": "加成",
    "combat": "战斗",
    "utility": "功能",
    "gathering": "采集",
    "Create powerful enchantments to boost your equipment.": "创建强大的附魔来强化你的装备。",
    "Enchant Type": "附魔类型",
    "Enchant Level": "附魔等级",
    "Power Scale:": "能量等级:",
    "Conservative (1%)": "保守 (1%)",
    "Risky (100%)": "激进 (100%)",
    "Output Range - 95% confidence interval": "产出范围 - 95% 置信区间",
    "Based on random enchanting mechanics - output can be outside range": "基于随机附魔机制 - 产出结果可能超出范围",
    "Be aware, the enchant level must be at or below the equipment iLevel": "注意，附魔等级必须等于或低于装备等级",
    "Equipped Pets": "已装备的宠物",
    "You can equip one pet of each type. Pet slots can be upgraded to increase their effectiveness by 1% per.": "每种类型的宠物你都可以装备一个。宠物槽可以升级，每次升级使其效果增加1%。",
    "Slot Level:": "槽位等级:",
    "No pet equipped": "未装备宠物",
    "Smart Partner": "聪明的伙伴",
    "EASY": "简单",
    "Team Player": "团队协作者",
    "This questline can be done in any order.": "该任务线可以按任意顺序完成。",
    "Equipment Recipe": "装备配方",
    "Equipment rerolls": "装备重置",
    "Equipment Reroll": "装备重置",
    "Shattered Relics": "破碎遗物",
    "Partner intelligence upgrades": "伙伴智力升级",
    "Parties joined/created": "加入/创建的队伍",
    "Intelligence is how big % of stats the partner gain of your character stats. This can be seen in the 'Partner stats' panel in the bottom middle. Partners gain 3 resources per 100 stats": "智力决定了伙伴能继承你角色属性的百分比。这可以在中下方的“伙伴属性”面板中查看。伙伴每100点属性可获得3点资源。",
    "Speed is how fast your partner is. The partner actions stop, at the same time yours do.": "速度决定了你伙伴的行动快慢。伙伴的行动会与你的行动同时停止。",
    "Partners have 2 upgrades: Intelligence and Speed.\n\nSpeed decreases the time between actions, and intelligence improves the amount of resources gained.\n\nUpgrade your partner intelligence. This can be done with either some of the shattered gold you have received earlier, or from gold gained through combat.": "\n伙伴有2项升级：智力和速度。\n\n速度可以减少行动间隔，而智力可以提高获得的资源量。\n\n升级你伙伴的智力。这可以使用你之前收到的一些破碎金币，或者通过战斗中获得的金币来完成。\n",
    "An earlier quest rewarded an equipment reroll recipe. These are used to reroll the tiers of the stats in an item.\n\nHigher tiers provide a higher modifier to the value of the stat, boosting its powers.\n\nChoose an equipment piece with some low stat tiers, and try reroll it for (hopefully) an improvement.\n\nYou will come to find out that a lot of different recipes exist throughout the game - fundamentally they are used to create or modify all the various items.": "\n之前的某个任务奖励了一张装备重置配方。这些配方用于重置物品上词缀的阶级。\n\n更高的阶级会为属性值提供更高的修正，从而增强其效果。\n\n选择一件词缀阶级较低的装备，然后尝试重置它以期获得提升。\n\n你会发现游戏中存在许多不同的配方——它们基本上都用于创建或修改各种物品。\n",
    "As the final piece of this questline, go experience the community by joining or creating a party.\n\nThe questing system will after this quest become a set of repeatable quest types rewarding various currencies such as recipes, potions or crafting currencies.": "\n作为此任务线的最后一部分，去加入或创建一个队伍来体验社区吧。\n\n在此任务之后，任务系统将变为一系列可重复的任务类型，奖励各种货币，如配方、药水或制造货币。\n",
    "Queued quests": "已接取的任务",
    "No available quests. Click \"Refresh Quests\" to generate new ones!": "没有可用的任务。点击“刷新任务”来生成新任务！",
    "No Quest History": "没有任务历史",
    "Your quest history will appear here when you complete quests.": "当你完成任务后，你的任务历史将显示在这里。",
    "Reduces actions by 4% each": "每次减少4%的行动",
    "Start new DM": "开始新私信",
    "Sanctums": "圣所",
    "Lvl": "等级", // Level的缩写
    "Automations": "自动化",
    "You are currently doing": "你当前正在进行",
    "Start a recipe by navigating to one of the submenus": "请通过导航至子菜单来开始一个配方",
    "Instantaneous": "瞬时完成",
    "Complete instantly at additional recipe cost": "支付额外配方成本来立即完成",
    "Craft basic equipment for your character": "为你的角色制造基础装备",
    "Recipes to queue": "待执行的配方",
    "Additional Recipes": "额外配方",
    "Force Type": "强制类型",
    "Costs 6x more currency": "花费6倍的货币",
    "Random": "随机",
    "Expected Output": "预期产出",
    "Total Cost": "总花费",
    "Start Recipe": "开始配方",
    "Random Rarity": "随机稀有度",
    "Create powerful gems": "制造强大的宝石",
    "Hunt and train a new pet": "狩猎并训练一只新宠物",
    "Filter by recipe type:": "按配方类型筛选：",
    "Toggle All": "切换全部",
    "No recipe history": "没有配方历史",
    "Your completed recipes will appear here.": "你已完成的配方将显示在这里。",
    "Automation Types": "自动化类型",
    "Available Automations": "可用的自动化",
    "automations created yet.": "被创建的自动化。",
    "Import Clipboard ID": "导入剪贴板ID",
    "Select an automation to edit": "选择一个自动化来编辑",
    "Choose an automation from the left sidebar or create a new one.": "从左侧栏选择一个自动化或创建一个新的。",
    "Equipment": "装备",
    "Pet": "宠物",
    "Pets": "宠物",
    "Gem": "宝石",
    ...
    "Select Pet": "选择宠物",
    "Select Gem": "选择宝石",
    "Reroll the tiers of an existing equipment piece": "重置一件现有装备的词缀阶级",
    "Select an equipment piece to reroll": "选择一件要重置的装备",
    "Reroll the stats types (keeping the tiers) of an existing equipment piece": "重置一件现有装备的属性类型（保留阶级）",
    "Select an equipment piece to enhance": "选择一件要强化的装备",
    "Locks a random unlocked stat of an existing equipment piece, preventing future modifications. Unlocks all existing locked stats": "锁定一件现有装备上的一个随机未锁定属性，以防止未来被修改。同时解锁所有已锁定的属性。",
    "Select an equipment piece to lock": "选择一件要锁定的装备",
    "Select two equipment pieces to merge": "选择两件要合并的装备",
    "Craft basic equipment for your fighters": "为你的佣兵制造基础装备",
    "Write detailed descriptions for caves": "为洞穴编写详细描述",
    "Merges the stats of two gems, keeping the highest level base": "合并两颗宝石的属性，保留最高等级的基础",
    "Select two gem pieces to merge": "选择两颗要合并的宝石",
    "Reroll the tiers of an existing pet": "重置一只现有宠物的词缀阶级",
    "Select a pet to reroll": "选择一只来重置的宠物",
    "Reroll the modifier and stat types (keeping the tiers) of an existing pet": "重置一只现有宠物的修正值和属性类型（保留阶级）",
    "Select a pet to enhance": "选择一只来强化的宠物",
    "Locks a random unlocked modifier or stat of an existing pet, preventing future modifications. Unlocks all existing locked modifiers and stats": "锁定一只现有宠物上的一个随机未锁定修正或属性，以防止未来被修改。同时解锁所有已锁定的修正和属性。",
    "Select a pet to lock": "选择一只来锁定的宠物",
    "Select two pets to merge": "选择两只要合并的宠物",
    "Shattered Gold": "破碎金币",
    "Quest Reward": "任务奖励",
    "Total Boost": "总加成",
    "Added Quest Queue": "已添加的任务队列",
    "Recipe Types": "配方类型",
    "Random Type": "随机类型",
    "Equipment": "装备",
    "equipment": "装备",
    "pets": "宠物",
    "Solo Ironman character": "单人铁人角色",
    "Fighter Equipment Enhancing": "佣兵装备强化",
    "Gem": "宝石",
    "an equipment piece to": "一件装备以",
    "two equipment pieces to": "两件装备以",
    "a fighter gear piece to": "一件佣兵装备以",
    "a pet to": "一只宠物以",
    "two pets to": "两只宠物以",
    "an automation to": "一个自动化以",
    "Decimal rewards are rounded by its decimal chance": "小数奖励会根据其小数概率进行四舍五入",
    "The max amount of queued quests at once": "一次最多可排队的任务数量",
    "QOL": "便捷性优化",
    "Wilderness": "荒野",
...
var cnPostfix = {
    ...
    " lock": "锁定",
    " merge": "合并",
    " has double drop chance": " 有双倍掉落几率",
    " upgrade": "升级",
    //
    "                   ": "",
    "                  ": "",
...
var cnRegReplace = new Map([
    [/^Complete (\d+) (partner\sactions|recipes|party\sactions)$/, function(match, times, actiontype) {
        const actionMap = {
            "partner actions" : "伙伴行动",
            "recipes": "配方",
            "party actions" : "队伍行动"
        };
        return `完成${times}次${actionMap[actiontype]}`;
    }],
    [/^Complete (\d+) (.+) as a villager$/, '作为村民完成 $2 次 $1'],
    [/^-\s*Level\s*(\d+)$/, '- 等级 $1'],
    [/^Increases your (.+) by ([\d\.]+%?)$/, '增加你的 $1 $2'],
    [/^Increases (.+) by ([\d\.]+%?)$/, '增加 $1 $2'],
    [/^Complete (\d+) (.+) as a village$/, '作为村庄完成 $2 $1'],
    [/^Collect ([\d,]+) gold in taxes for the village$/, '为村庄征收 $1 金币的税'],
    [/^My Titles \((\d+)$/, '我的称号 ($1'],
    [/^\((\d+)\s*Credits\)$/, '($1 代币)'],
    [/^((?:\d+d\s*)?(?:\d+h\s*)?(?:\d+m\s*)?(?:\d+s))\s*ago$/, '$1前'],
    [/^(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{1,2}),\s(\d{4}),\s(\d{2}:\d{2}:\d{2})$/, function(match, month, day, year, time) {
        const monthMap = {
            "Jan": "1月", "Feb": "2月", "Mar": "3月", "Apr": "4月", "May": "5月", "Jun": "6月",
            "Jul": "7月", "Aug": "8月", "Sep": "9月", "Oct": "10月", "Nov": "11月", "Dec": "12月"
        };
        return `${year}年 ${monthMap[month]} ${day}日 ${time}`;
    }],
    [/^Resetting will set all your relics (.+) boosts back to 0\. You will be refunded ([\d,]+) Shattered Relics\.$/, '重置会将你的所有圣物 $1 增益归零。你将被返还 $2 个破碎圣物。'],
    [/^\/(\d+)$/, '/ $1'],
    [/^Monster Lvl (\d+)$/, '怪物 等级 $1'],
    [/^(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{1,2}),\s(\d{4})$/, function(match, month, day, year) {
        const monthMap = {
            "Jan": "1月", "Feb": "2月", "Mar": "3月", "Apr": "4月", "May": "5月", "Jun": "6月",
            "Jul": "7月", "Aug": "8月", "Sep": "9月", "Oct": "10月", "Nov": "11月", "Dec": "12月"
        };
    ...
    [/^(\d+m\s*\d+s)\s+ago$/, '$1前'],
    [/^\/\s*(\d+)\s*Sets$/, ' / $1 套'],
    [/^Resetting will set your partner's speed and intelligence boosts back to 0. You will be refunded (\d+) Shattered Gold.$/, '重置操作会将你伙伴的速度和智力加成归零。你将被退还 $1 个破碎金币。'],
    [/^Reset Partner (\d+)'s Boosts$/, '重置伙伴 $1 的加成'],
    //
...
// 解决“一词多义”的问题。比如，一个 "Open" 在按钮上可能表示“打开”，但在一个列表里可能表示状态“开启”。
// 当 cnItem 发现一个词的翻译是个对象时，就会调用这个函数，并传入这个对象（itemgroup）和文本所在的HTML节点（node）
...
// 这是整个脚本最核心的部分，负责将一段英文文本翻译成中文。它的处理流程非常严谨：
...
// 遍历整个 <body> 里的所有静态内容，找出所有英文文本，并把翻译任务添加到一个任务管理器中
// 如果找到一个纯文本节点 (#text)，它就取出文本内容，交给 cnItem 函数去翻译。
// 翻译后的结果如果与原文不同，就通过 transTaskMgr.addTask 创建一个“替换任务”。
...
! function() {
    ...
    let observer = new MutationObserver(function(e) {
        ...
        for (let mutation of e) {
            // 翻译 <script> 标签里的内容会直接导致网页的 JavaScript 脚本语法错误，使网页功能失灵。
            // 翻译 <style> 标签里的 CSS 规则同样会破坏页面样式。
            // 翻译 <textarea> 里的内容会干扰用户的正常输入。
            // 如果匹配到这三者，就用 continue 跳过本次循环，完全不处理这个变化，直接进入下一个变化记录的判断。
            if (mutation.target.nodeName === "SCRIPT" || mutation.target.nodeName === "STYLE" || mutation.target.nodeName === "TEXTAREA") continue;
            // 处理纯文本节点的变化
            if (mutation.target.nodeName === "#text") {
                mutation.target.textContent = cnItem(mutation.target.textContent, mutation.target);
            }
            // 处理只包含文本的简单元素。 变化发生在一个元素上，并且这个元素内部没有其他子元素（即它是一个“叶子”元素），只包含文本。
