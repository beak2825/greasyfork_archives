...
// @match https://forum.grandmanager.ru/*
// @include https://forum.grandmanager.ru/
// @grant t.me/cyberalg
// @license t.me/cyberalg
// @collaborator t.me/cyberalg
// @icon https://i.yapx.ru/ViO6c.png
// @downloadURL https://update.greasyfork.org/scripts/490684/BLACK%20RUSSIA%20TECH%20SCRIPT.user.js
// @updateURL https://update.greasyfork.org/scripts/490684/BLACK%20RUSSIA%20TECH%20SCRIPT.meta.js
// ==/UserScript==
...
(function () {
	...
	const buttons = [
	{
		...
		'[CENTER]Ваш текст[/CENTER][/FONT][/SIZE]',
	},
    	{
		title: 'Передать тему',
		content:
		'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
		'[CENTER]Передаю вашу тему в нужный раздел. Не дублируйте эту тему. Ожидайте ответа.[/CENTER][/FONT][/SIZE]',
	},
      {
		title: '2.28',
		content:
		'[SIZE=4][FONT=Veranda][CENTER]Доброго времени суток, уважаемый[B] {{ user.mention }}[/B]!<br><br>' +

        'Хочу вам напомнить что согласно пункту 4.01 общих правил серверов:[/FONT][/CENTER]<br><br>' +
        '[QUOTE]<br><br>' +
        '[CENTER][FONT=verdana][COLOR=rgb(255, 0, 0)]4.01.[/COLOR] Создавая игровой аккаунт на нашем проекте, игрок автоматически соглашается со всеми правилами проекта.[/FONT][/CENTER]<br><br>' +
        '[/QUOTE]<br><br>' +
        '[CENTER][FONT=verdana]Вы нарушили следующий пункт общих правил серверов:[/FONT][/CENTER]<br><br>' +
        '[QUOTE]<br><br>' +
        '[CENTER][FONT=verdana][COLOR=rgb(255, 0, 0)]2.28.[/COLOR] Запрещена покупка/продажа внутриигровой валюты в любых ее проявлениях за реальные деньги | PermBan с обнулением аккаунта + ЧС проекта[/FONT][/CENTER]<br><br>' +
        '[/QUOTE]<br><br>',
        prefix: PIN_PREFIX,
        status: true,
	},
	...
	},
    {
		...
		content:
		'[CENTER][SIZE=4][FONT=verdana]Доброго времени суток уважаемый.<br><br>' +

      'От вас не поступило ответа в течении 48 часов(2 дня).<br><br>' +

      'Если ваш вопрос все ещё актуальный, создайте новую тему.<br><br>' +

      'С уважением Alexander_Wannted.[/FONT][/SIZE]<br><br>' +
    '[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=verdana]Закрыто.[/FONT][/SIZE][/COLOR][/CENTER]',
		prefix: CLOSE_PREFIX,
		status: false,
	},
	{
	...
	},
	{
	  ...
	  content:
		...
		'[CENTER][COLOR=chartreuse]Одобрено![/COLOR] Закрыто.[/CENTER]',
	},
       	{
	  title: 'ППВ-',
	  content:
		...
		'[CENTER][COLOR=scarlet ]Отказано![/COLOR] Закрыто.[/CENTER]',
	},
   	{
	  title: 'Сборка+',
	  content:
