...
// @description  쿠빈님의 Soop 라이브 방송화면과 채팅창을 캡처 해줍니다.
// @description:ko  쿠빈님의 Soop 라이브 방송화면과 채팅창을 캡처 해줍니다.
// @author       haruB☆
// @match        https://play.sooplive.co.kr/kubin970515*
// @icon         https://res.sooplive.co.kr/afreeca.ico
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/550189/%EC%BF%A0%EB%B9%88%20%EB%B0%A9%EC%86%A1%ED%99%94%EB%A9%B4%20%EC%BA%A1%EC%B2%98.user.js
// @updateURL https://update.greasyfork.org/scripts/550189/%EC%BF%A0%EB%B9%88%20%EB%B0%A9%EC%86%A1%ED%99%94%EB%A9%B4%20%EC%BA%A1%EC%B2%98.meta.js
// ==/UserScript==
...
(function () {
  ...
  function captureKubin() {
    ...
    try {
      ...
      link.download = `쿠빈 방송 캡처 ${getFormattedTimestamp()}.png`;
      link.click();
  ...
  function chattingCapture() {
    ...
    function doCapture() {
      window.html2canvas(chat, {
        ...
        const link = document.createElement('a');
        link.href = canvas.toDataURL('image/png');
        link.download = `쿠빈 채팅 캡처 ${getFormattedTimestamp()}.png`;
        link.click();
