    // ==UserScript==
    // @name         GitHub in vscode.dev
    // @description  Open a repo in VS Code using vscode.dev
    // @version      0.0.1
    ...
    // @run-at       document-end
// @namespace https://greasyfork.org/users/798775
// @downloadURL https://update.greasyfork.org/scripts/435400/GitHub%20in%20vscodedev.user.js
// @updateURL https://update.greasyfork.org/scripts/435400/GitHub%20in%20vscodedev.meta.js
    // ==/UserScript==
    ...
    <li>
      <div class="d-block js-toggler-container js-social-container">
        <button id="vscode-btn" class="btn btn-sm" aria-label="Open in VS Code" title="Open in VSCode Online">
      ...
      `)
      $('#vscode-btn').click(() => { window.location.href = window.location.href.replace('github.com', 'vscode.dev/#https://github.com') })
    })()