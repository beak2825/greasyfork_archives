...
(function () {
    ...
    if (topWindow == window) {
        ...
        LpBtn.innerHTML = "云令牌";
        LpBtn.style.margin = "4px";
        LpBtn.style.width = "60px";
        LpBtn.style.height = "30px";
        // 在点击按钮时输出日志到文本框中
        LpBtn.onclick = async function () {
            if (rewrite == 0) {
                writeLog("请先开启监听！宝贝")
                return
            }
                ...
                let mimiid
                try{
                    mimiid=document.querySelector("iframe").contentWindow.MFC.userInfo.uid
                }
                catch(e){
                    mimiid=MFC.userInfo.uid
                }
                try {
                        let input = document.createElement('input');
                        document.body.appendChild(input);
                        let value = {
                            mimiID: localStorage["mimiID" + mimiid.toString()],
                        ...
                        writeLog("复制异常,请重新启动再尝试!");
                    }
            }


        };
        div.appendChild(LpBtn);
        ...
        logTextArea.placeholder = "b站搜 代码块 三个字 获取全新云挂机"
