...
// @downloadURL https://update.greasyfork.org/scripts/549277/mengyufei.user.js
// @updateURL https://update.greasyfork.org/scripts/549277/mengyufei.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "YING GUAN";
    const NEW_NAME = "MENG YUFEI";
    const NEW_BIRTHDAY = "(**0129)";
    const NEW_EXPIRE_DATE = "2033-07-11";
