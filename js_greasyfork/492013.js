...
// @downloadURL https://update.greasyfork.org/scripts/492013/%D0%9D%D0%B0%D0%B2%D0%BE%D1%80%D0%BA%D0%B0%D0%BB.user.js
// @updateURL https://update.greasyfork.org/scripts/492013/%D0%9D%D0%B0%D0%B2%D0%BE%D1%80%D0%BA%D0%B0%D0%BB.meta.js
// ==/UserScript==
    ...
    },
   {
     ...
     title: '---------------------------------------------------------------> ПРОЧЕЕ <---------------------------------------------------------------',
...
},
        {
            ...
            "Ответственность за действия на аккаунте несёт исключительно владелец этого аккаунта.<br><br>"+
...
},
        {
            ...
            "Укажите список привязок на аккаунте, а именно Вк,тг,почта, а так же укажите примерную дату регистрации аккаунта, страну и город, в котором регестрировался аккаунт. У вас есть 24 часа на ответ. <br>"+
          '[COLOR=orange][FONT=times new roman]На рассмотрении... [/COLOR][/CENTER]',
            prefix: PIN_PREFIX,
            status: false,
},
