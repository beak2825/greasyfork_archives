...
// @version      1.0.0
// @description  给浏览器添加繁简转换功能。默认设置为繁体版本，推荐港澳台繁体区域使用这个版本
// @author       夜法之书
// @license      GPL V3
// @include      http://*
// @include      https://*
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/492935/%E7%B9%81%E7%AE%80%E8%BD%AC%E6%8D%A2.user.js
// @updateURL https://update.greasyfork.org/scripts/492935/%E7%B9%81%E7%AE%80%E8%BD%AC%E6%8D%A2.meta.js
// ==/UserScript==
...
(function() {
    ...
    function setInitialButtonText() {
        if (targetEncoding == 1) {
            floatingIcon.innerHTML = '<span style="display: block; width: 100%; height: 100%; line-height: 50px; text-align: center; color: white;">' + msgToTraditionalChinese + '</span>';
        } else {
            floatingIcon.innerHTML = '<span style="display: block; width: 100%; height: 100%; line-height: 50px; text-align: center; color: white;">' + msgToSimplifiedChinese + '</span>';
        }
    }

    // 在页面加载完成后执行 setInitialButtonText 函数
    window.addEventListener('load', setInitialButtonText);

    // 点击悬浮图标时运行 translatePage 函数
