// ==UserScript==
// @name AudioBookBay hide category: Plays & Theater
// @description Hide Plays & Theater category
...
// @downloadURL https://update.greasyfork.org/scripts/484564/AudioBookBay%20hide%20category%3A%20Plays%20%20Theater.user.js
// @updateURL https://update.greasyfork.org/scripts/484564/AudioBookBay%20hide%20category%3A%20Plays%20%20Theater.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact phrase 'Plays & Theater'
    $(".post").has(".postInfo:contains('Plays & Theater')").hide();
});
