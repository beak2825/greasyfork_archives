...
// @name					LS助手
// @version					1.10
// @description				LS助手1.10
// @author					enncy
// @license					MIT
// @namespace				https://enncy.cn
// @homepage				https://dLS.LSjs.com
// @source					https://github.com/LSjs/LSjs
// @icon					https://cdn.LSjs.com/logo.ico
// @connect					enncy.cn
// @connect					icodef.com
// @connect					LSjs.com
// @connect					localhost
...
// @downloadURL https://update.greasyfork.org/scripts/460788/LS%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/460788/LS%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==


/*!
 * LS ( https://github.com/LSjs/LSjs#readme )
 * LS - online course script 在线网络课程辅助工具
 * copyright enncy
 * license MIT
 */
...
(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.LS = {}));
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("div", {
          ...
          hide.value ? (openBlock(), createBlock(unref(Tooltip), {
            ...
            title: `LS \u7F51\u8BFE\u52A9\u624B ${unref(useStore)("VERSION")}<br>\u5355\u51FB\u62D6\u52A8<br>\u53CC\u51FB\u5C55\u5F00<br>\u8FDE\u7EED\u6309\u4E0BLS\u4E09\u4E2A\u952E\u53EF\u590D\u539F\u4F4D\u7F6E<br>\u60F3\u8981\u5B8C\u5168\u9690\u85CF\u53EF\u79FB\u51FA\u5C4F\u5E55`
          }, {
            default: withCtx(() => [
              createBaseVNode("img", {
                ref_key: "logo",
                ref: logo,
                class: "LS-icon",
                src: "https://i.postimg.cc/4xByQBrV/image.png",
            ...
            createBaseVNode("div", {
              ref_key: "panelHeader",
              ref: panelHeader,
              class: "LS-panel-header draggable"
            }, [
            ...
            createBaseVNode("div", {
              ref_key: "panelFooter",
              ref: panelFooter,
              class: "LS-panel-footer draggable"
            }, [
              createBaseVNode("span", {
                class: "hide-btn",
                onClick: _cache[2] || (_cache[2] = ($event) => hide.value = true)
              }, " \u70B9\u51FB\u7F29\u5C0F "),
              createBaseVNode("span", null, " LS \u7F51\u8BFE\u52A9\u624B " + toDisplayString(unref(useStore)("VERSION")), 1)
            ], 512)
          ], 64))
        ], 2);
      };
  ...
  function start(options) {
    ...
    if (top === window) {
      let showPanels = function() {
        ...
        logger("info", `LS ${useStore("VERSION")} \u52A0\u8F7D\u6210\u529F`);
      };
      const ctx = useContext();
    ...
    setup(props, ctx) {
      ...
      return () => createVNode(Fragment, null, [createVNode("label", null, [props.label]), createVNode("div", null, [createVNode(Tooltip, {
        ...
        default: () => [createVNode("span", {
          "class": "pointer",
          "onClick": () => {
            window.open("https://dLS.LSjs.com/dLS/work");
          }
        }, [createTextVNode("\u2753")])]
      })])])]);
    }
  ...
  const ExamSettingPanel = defineComponent({
    setup() {
      ...
      return () => createVNode("div", {
        "class": "LS-setting-panel"
      }, [createVNode("div", {
        "class": "LS-setting-items"
  ...
  async function mapRecognize() {
    ...
    const res = await request("https://cdn.LSjs.com/resources/font/table.json", {
      type: "GM_xmlhttpRequest",
      method: "get",
      contentType: "json"
    });
  ...
  async function ocrRecognize() {
    const ocr = new OCR({
      langPath: "https://cdn.LSjs.com/resources/tessdata",
      corePath: "https://cdn.LSjs.com/resources/tesseract/tesseract-core.wasm.js",
      workerPath: "https://cdn.LSjs.com/resources/tesseract/worker.min.js"
    });
    const { cx } = useContext();
    if (window === top) {
      cx.isRecognizing = false;
    ...
    routes: [
      {
        ...
        async onload() {
          if (top === window) {
            message("warn", "LS\u7F51\u8BFE\u52A9\u624B\u4E0D\u652F\u6301\u65E7\u7248\u8D85\u661F, \u5373\u5C06\u5207\u6362\u5230\u8D85\u661F\u65B0\u7248, \u5982\u6709\u5176\u4ED6\u7B2C\u4E09\u65B9\u63D2\u4EF6\u8BF7\u5173\u95ED, \u53EF\u80FD\u6709\u517C\u5BB9\u95EE\u9898\u9891\u7E41\u9891\u7E41\u5207\u6362\u3002");
            await sleep(1e3);
  ...
  (function(module2) {
    var runtime2 = function(exports3) {
      ...
      function wrap(innerFn, outerFn, self2, tryLLSList) {
        var protoGenerator = outerFn && outerFn.prototype instanceof Generator ? outerFn : Generator;
        var generator = Object.create(protoGenerator.prototype);
        var context = new Context(tryLLSList || []);
      ...
      exports3.async = function(innerFn, outerFn, self2, tryLLSList, PromiseImpl) {
        if (PromiseImpl === void 0)
          PromiseImpl = Promise;
        var iter = new AsyncIterator(wrap(innerFn, outerFn, self2, tryLLSList), PromiseImpl);
      ...
      function pushTryEntry(lLS) {
        var entry = { tryLoc: lLS[0] };
        if (1 in lLS) {
          entry.catchLoc = lLS[1];
        }
        if (2 in lLS) {
          entry.finallyLoc = lLS[2];
          entry.afterLoc = lLS[3];
        }
      ...
      function Context(tryLLSList) {
        this.tryEntries = [{ tryLoc: "root" }];
        tryLLSList.forEach(pushTryEntry, this);
        this.reset(true);
      }
...
const LS_STYLE = `
/*!
 * LSjs ( https://github.com/LSjs/LSjs#readme )
 * LS - online course script 在线网络课程辅助工具
 * copyright enncy
 * license MIT
 */
...
#LS-panel .LS-panel-header .title {
...
#LS-panel .LS-panel-header .title.active {
  background: white;
  color: black;
}
#LS-panel .LS-panel-header .title.active span::after {
  content: '';
...
#LS-panel .LS-panel-header .title:hover {
  background: white;
}
#LS-panel .LS-panel-header.hide {
  display: none;
}
#LS-panel .LS-panel-container {
  font-size: 12px;
  padding: 4px;
  overflow: auto;
  max-height: 500px;
...
#LS-panel .LS-panel-container ul li {
  list-style: inside;
}
#LS-panel .LS-panel-container.hide {
  display: none;
}
#LS-panel .draggable {
  cursor: move;
...
#LS-panel .LS-panel-footer.hide {
  border-top: none;
}
#LS-panel .LS-panel-footer .hide-btn {
  float: left;
  cursor: pointer;
}
#LS-panel .LS-setting-items {
  display: grid;
...
#LS-panel .LS-setting-items label {
  padding-right: 4px;
}
#LS-panel .LS-setting-items label + div {
  display: inline-flex;
  align-items: center;
  gap: 2px;
}
#LS-panel .LS-setting-items label::after {
  content: ': ';
}
#LS-panel .LS-setting-items select {
  font-size: 12px;
  outline: none;
  border: none;
...
#LS-panel .LS-setting-items input {
  outline: none;
  border: none;
...
#LS-panel .LS-setting-items .input-switch {
  appearance: none;
  width: fit-content;
  min-width: 32px;
  height: 16px;
...
#LS-panel .LS-setting-items .input-switch:checked {
  background: #1890ff !important;
}
#LS-panel .LS-setting-items .input-switch:checked::before {
  transform: translate(100%, 0px);
}
#LS-panel .LS-setting-items .input-switch::before {
...
#LS-panel .LS-setting-items input:not([type='checkbox'], [type='radio']) {
  width: 100%;
}
#LS-panel .LS-setting-items input[type='checkbox'],
#LS-panel .LS-setting-items input[type='radio'],
#LS-panel .LS-setting-items input[type='range'] {
  accent-color: #0e8ee2;
}
#LS-panel .LS-btn-primary {
  outline: none;
  border: none;
  cursor: pointer;
  background: #1890ff;
...
#LS-panel .terminal level {
  padding: 0px 2px;
  border-radius: 2px;
}
#LS-panel .terminal level.info {
  background-color: #2196f3a3;
}
#LS-panel .terminal level.warn {
  background-color: #ffc107db;
}
#LS-panel .terminal level.error {
  background-color: #f36c71cc;
}
#LS-panel .terminal level.debug {
  background-color: #9e9e9ec4;
}
#LS-panel .terminal *::selection {
  background-color: #ffffff6b;
}
#LS-panel #search-results a {
  text-decoration: underline;
}
#LS-panel #search-results .search-result-modal {
  max-height: 600px;
  max-width: 800px;
  overflow: auto;
...
#LS-panel #search-results .search-results-title {
  padding: 2px 0px;
}
#LS-panel #search-results .search-results-container {
  padding-left: 12px;
}
#LS-panel #search-results .search-results-item {
  margin-bottom: 8px;
  background: #f6ffed;
...
#LS-panel .tooltip.dark {
  background: black;
  color: white;
  opacity: 0.8;
}
#LS-panel .tooltip.light {
  background: white;
  color: inherit;
}
#LS-panel .alert-container {
  margin-bottom: 4px;
  position: absolute;
  z-index: 999999;
  bottom: 100%;
...
#LS-panel .alert-container .alert-closer {
  float: right;
  border-radius: 50%;
  border: 1px solid;
  text-align: center;
...
#LS-panel .alert-container .hide .alert {
  width: 200px;
  transform: translate(-82px, 0px);
}
#LS-panel .alert-container .alert {
  border-radius: 4px;
  margin-bottom: 4px;
  padding: 4px;
  font-size: 12px;
}
#LS-panel .alert-container .alert .alert-text {
  letter-spacing: 1px;
  font-weight: bold;
}
#LS-panel .alert-container .alert.error {
  background-color: #ff000699;
  color: #fff;
  border: 1px solid #f36c70;
}
#LS-panel .alert-container .alert.info {
  background-color: #2196f3a3;
  color: white;
  border: 1px solid #1890ff;
}
#LS-panel .alert-container .alert.success {
  background-color: #84d346d1;
  color: #fff;
  border: 1px solid #6fd91d;
}
#LS-panel .alert-container .alert.warn {
...
(function () {
    ...
    LS.start({
        ...
        // 支持拖动
        draggable: true,
        // 加载默认脚本列表，默认 LS.definedScripts
        scripts: LS.definedScripts,
    });
})();
