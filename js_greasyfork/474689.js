...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/474689/Copy%20SPU%20Text.user.js
// @updateURL https://update.greasyfork.org/scripts/474689/Copy%20SPU%20Text.meta.js
// ==/UserScript==
...
(function() {
    ...
    function handleElementClick() {
        ...
        // 插入话术并去除最后的逗号
        textArea.value = generateMessage(copiedTextArray);
    ...
    // 生成话术消息
    function generateMessage(copiedTextArray) {
        return `你好，你提审的商品参数“${copiedTextArray.join("、 ")}”填写与商详标题展示信息不一致，请修改后重新提交审核。`;
    }
