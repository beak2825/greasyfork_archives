...
// @collaborator Sochi
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/460174/Sochi%20%7C%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/460174/Sochi%20%7C%7C%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
...
const buttons = [
    {
	  title: '-----> Sochi | Кураторы Форума <------'
	},
    {
	  title: '| Не по форме |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url][/url]<br>' +
		...
		"[CENTER][B][COLOR=RED]| [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.2372192/'][Color=lavender]Правила подачи жалоб[/URL] [COLOR=RED]|<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
	...
	},
    {
	  title: '| Нету док-во |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
	...
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Вам уже был дан ответ в подобной жалобе, пожалуйста перестаньте делать дубликаты, иначе ваш Форумный аккаунт будет заблокирован.<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=RED][ICODE]Отказано. Закрыто. [/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	...
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Видео запись не полная либо же нет условий сделки. <br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано. Закрыто. [/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша ссылка на доказательства не рабочая, или же закрыт доступ к просмотру.<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано. Закрыто. [/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Представленные вами доказательства были подвергнуты редактированию. Предоставьте доказательства в первоначальном виде.<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Отказано. Закрыто. [/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	...
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба взята на рассмотрение, пожалуйста не создавайте дубликатов данной темы. Ожидайте ответа.<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=yellow][ICODE]Приятной игры на BLACK RUSSIA || SOCHI[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: PIN_PREFIX,
	  status: true,
	},
	{
	  ...
	  content:
		...
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=red][ICODE]Приятной игры на BLACK RUSSIA || SOCHI[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: GA_PREFIX,
	  status: true,
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба передана Техническому специалисту сервера. Ожидайте ответа.<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=blue][ICODE]Приятной игры на BLACK RUSSIA || SOCHI[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: TEX_PREFIX,
	  status: true,
	},
	{
	  ...
	  content:
		...
		"[CENTER][COLOR=lavender] Приятной игры на BLACK RUSSIA || SOCHI <br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
	...
	},
   {
	...
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказания.[Spoiler][color=red]2.47 | [color=lavender] Запрещено ездить по полям на любом виде транспорта. Исключение: разрешено передвижение на кроссовых мотоциклах и внедорожниках.[color=red]  | Jail 30 минут[/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Приятной игры на BLACK RUSSIA || SOCHI <br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	...
	},
    {
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказания.[Spoiler][color=red]2.47 | [color=lavender] Запрещено ездить по полям на грузовом транспорте, инкассаторских машинах (работа дальнобойщика, инкассатора) [color=red]  | Jail 60 минут[/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Приятной игры на BLACK RUSSIA || SOCHI <br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	...
	},
	{
	  ...
	  content:
		...
		"[CENTER][COLOR=lavender] Приятной игры на BLACK RUSSIA || SOCHI <br>"+
		"Приятной игры на BLACK RUSSIA || SOCHI <br>"+
		'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	  status: false,
	},
	...
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказания.[Spoiler][color=red]3.21 | [color=lavender] Запрещается реклама промокодов в игре, а также их упоминание в любом виде во всех чатах. Исключение: промокоды, предоставленные разработчиками, а также распространяемые через официальные ресурсы проекта. [color=red]  | Ban 30 дней.[/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Приятной игры на BLACK RUSSIA || SOCHI <br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	...
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]Ваша жалоба была рассмотрена и одобрена, игрок получит следующие наказания.[Spoiler][color=red]* | [color=lavender] Запрещено выдавать розыск без Role Play причины[color=red]  | Warn [/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Приятной игры на BLACK RUSSIA || SOCHI<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=green][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: ACCEPT_PREFIX,
	...
	},
	{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender]В название темы необходимо указать NickName Игрока, на которого подается жалоба, и суть жалобы  .[Spoiler][color=red]*  | [color=lavender] Пример :[color=red] Mercedes_Maybach | DM [/Spoiler]<br>"+
		"[CENTER][COLOR=lavender] Приятной игры на BLACK RUSSIA || SOCHI<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/MZ355bG4/12-14-33-TD3-M4.png[/img][/url]<br>"+
		'[B][CENTER][COLOR=green][ICODE]Отказано. Закрыто. [/ICODE][/COLOR][/CENTER][/B]',
	  prefix: CLOSE_PREFIX,
