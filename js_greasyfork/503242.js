...
// @version      0.8
// @description  for use with https://userstyles.world/style/13722/roblox-2011-classic-updated-61224
// @author       Melo, Edited by ItsWAWGaming
// @match        *://*.roblox.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/503242/Roblox%202011.user.js
// @updateURL https://update.greasyfork.org/scripts/503242/Roblox%202011.meta.js
// ==/UserScript==
...
document.querySelector('link[rel="icon"]').href= 'data:image/x-icon;base64,'
    ...
    AccountBalanc.href = "https://www.roblox.com/transactions"
