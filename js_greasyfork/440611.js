// ==UserScript==
// @name         DemonicMod | Katana + Musket | AUTOHEAL |  Anti-Insta  |  Starter resources and more STUFF!!
// @version      v.10.6.4
// @description  This was SISI's HacK but I decided to name it DemonicMod. Not only the name of the mod was changed, also the power of it! To know how to use it read the description! Hope you enjoy!!(Also this is a sadistic mod copy of Pancake mod)
// @author       W4IT#1814
// @match        *://moomoo.io/*
// @match        *://*.moomoo.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/440611/DemonicMod%20%7C%20Katana%20%2B%20Musket%20%7C%20AUTOHEAL%20%7C%20%20Anti-Insta%20%20%7C%20%20Starter%20resources%20and%20more%20STUFF%21%21.user.js
// @updateURL https://update.greasyfork.org/scripts/440611/DemonicMod%20%7C%20Katana%20%2B%20Musket%20%7C%20AUTOHEAL%20%7C%20%20Anti-Insta%20%20%7C%20%20Starter%20resources%20and%20more%20STUFF%21%21.meta.js
// ==/UserScript==
...
autoreloadloop = setInterval(function () {
    if (autoreloadenough < 5) {
        ...
        clearInterval(autoreloadloop);
        document.title = "Akatsuki";
        setTimeout(function () {document.title = "Back For More?";}, 1000)
    }
}, 50);
...
document.getElementById('linksContainer2').innerHTML = ' Hello There :] ' ;
document.getElementById('gameName').innerHTML = 'DemonicMod';
document.getElementById('loadingText').innerHTML = ' Back For More? '
document.getElementById('diedText').innerHTML = "!!You're Sadistic!!";
document.getElementById('diedText').style.color = "#fe3200";
document.title = ' Demonic mod';
document.getElementById("leaderboard").append ('Hello there');
...
function n() {
    ...
    this.buffer. prototype = new Uint8Array;
    this.type = 0;
}
        ...
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 style="font-size: 17px;">Demonic mod menu</h2>
                </div>
