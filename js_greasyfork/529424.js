...
// @downloadURL https://update.greasyfork.org/scripts/529424/%E7%AB%A5%E8%AF%9D%E7%BF%BB%E8%AF%91.user.js
// @updateURL https://update.greasyfork.org/scripts/529424/%E7%AB%A5%E8%AF%9D%E7%BF%BB%E8%AF%91.meta.js
// ==/UserScript==
            ...
            if (this.readyState === 4 && this._interceptedUrl.includes("api/MAdults/MonsterMAdults/")) {
                ...
                if (this.responseType === "arraybuffer") {
                    ...
                    try {
                        ...
                        const translationJsonUrl = "https://pub-8c5e69e127a7478d9f9bec549ff7d8d5.r2.dev/MAdults_CN/" + lastPartOfUrl + ".json";
                ...
                if (this.responseType === "arraybuffer") {
                    ...
                    try {
                        const originalText = textDecoder.decode(this.response);
                        let originalJson = JSON.parse(originalText);
                        const translationJsonUrl = "https://pub-8c5e69e127a7478d9f9bec549ff7d8d5.r2.dev/MScenes_CN/" + lastPartOfUrl + ".json";
                        const translationData = loadTranslationJsonSync(translationJsonUrl);
