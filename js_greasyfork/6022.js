// ==UserScript==
// @name 	Kick-o-matic
// @description Ускоряет процесс раздачи погон (Acelera el proceso de asignación de rangos en batallas)
...
// @downloadURL https://update.greasyfork.org/scripts/6022/Kick-o-matic.user.js
// @updateURL https://update.greasyfork.org/scripts/6022/Kick-o-matic.meta.js
// ==/UserScript==
...
exec(function() {
    ...
    Grander = {
        ...
        "scriptSite": "http://userscripts-mirror.org/scripts/show/96262",
        "loading": false,
...
////                text += '<li><small>Так же может заинтересовать:</small> <a href="http://userscripts-mirror.org/scripts/show/154884" target="_blank">TW Gold Jobs Finder - поиск золотых и сереряных работ</a></li>';
////                break;
////            default:
////                text += '<li>2.03 compatibility</li>';
////                text += '<li>Check this out: <a href="http://userscripts-mirror.org/scripts/show/154884" target="_blank">TW Gold Jobs Finder</a></li>';
////                break;
////        }
//        text += '</ul>';
    ...
    Grander.init = function() {
        ...
        Grander.langs = {
            ...
            "es_ES": {
                ...
                // new in 1.40
                "update_available": "Kick-o-Matic actualización disponible",
                "update_question": "Puede descargar la última versión desde greasyfork.org. Visite la web?"
            },
            "it_IT": {
