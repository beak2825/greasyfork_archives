...
// @run-at       document-end
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/528957/swagger-ui-270.user.js
// @updateURL https://update.greasyfork.org/scripts/528957/swagger-ui-270.meta.js
// ==/UserScript==
            ...
            function registerSearchUI() {
              ...
              dom.append([
                '<div style="text-align: center;">',
                  '<br/>',
                '<small style="margin-bottom: 10px">双击或长按Shift搜索 Esc关闭</small>',
                '</div>',
