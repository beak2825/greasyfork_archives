...
// @downloadURL https://update.greasyfork.org/scripts/454999/abooo.user.js
// @updateURL https://update.greasyfork.org/scripts/454999/abooo.meta.js
    // ==/UserScript==
    ...
    $(document).ready(function(){
        ...
        setInterval(()=>{
            if($(baslik).find(".progress-check-icon").length){
                document.location.href = "https://www.oba.gov.tr/egitim/oynatma/hesap-tablosu-programi-office-excel-egitimi-kursu-1-kasim-2022-mesleki-calisma-449/6589";
            }
