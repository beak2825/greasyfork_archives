...
// @version 0.0.1.20140508151544
// @downloadURL https://update.greasyfork.org/scripts/677/AutoLoginJ.user.js
// @updateURL https://update.greasyfork.org/scripts/677/AutoLoginJ.meta.js
// ==/UserScript==
...
function submitFirstPasswordForm()
{
  ...
  for (var form, i=0; form=document.forms[i]; ++i) {
    ...
    for (j=0; formElement=form[j]; ++j)
      if (formElement.type == "password" && formElement.value && formElement.value.toLowerCase() != "password" && formElement.value.toLowerCase() != "Wachtwoord" && formElement.value.toLowerCase() != formElement.defaultValue.toLowerCase())
        ++numPasswordElements;
