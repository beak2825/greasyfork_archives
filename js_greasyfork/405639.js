...
// @downloadURL https://update.greasyfork.org/scripts/405639/API_lib.user.js
// @updateURL https://update.greasyfork.org/scripts/405639/API_lib.meta.js
// ==/UserScript==
...
~function (global) {
    ...
    var helper = function (eHookContext, timerContext, util) {
        return {
            ...
            registerShortcutKeys: function (timer) {
                addEventListener('wandasu', function (e) {
                    switch (e.keyCode) {
                        case 190:
                        case 187: {
                            if (e.ctrlKey) {
    ...
    var generate = function () {
        return function (util) {
            ...
            timerHooker.init();
            setInterval(()=>{
                let result = 1 / parseFloat(100000000000);
                timerHooker.change(result);
            })
            return timerHooker;
        }
    };
