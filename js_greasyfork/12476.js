...
// @include        http://imdb.com/title/*/combined*
// @include        http://imdb.com/title/*/maindetails*
// @include        http://*.imdb.com/title/tt*/?ref*
// @grant 		GM_addStyle 
// @grant 		GM_openInTab 
// @version 0.0.1.20150916040315
// @downloadURL https://update.greasyfork.org/scripts/12476/IMDB2Other.user.js
// @updateURL https://update.greasyfork.org/scripts/12476/IMDB2Other.meta.js
// ==/UserScript==
...
//isoHunt
//trackers.push(new SearchEngine("isoHunt (Video/Movies)", "http://isohunt.com/torrents/%title?ihp=1&iht=1&ihs1=2&iho1=d", false, //"http://www.picpanda.com/images/cq63g612sahn2olouqpc.ico"));
...
//ThePirateBay
trackers.push(new SearchEngine("PirateBay", "https://thepiratebay.se/search/%title/0/99/200", false, "https://thepiratebay.se/favicon.ico"));
...
//http://www.icheckmovies.com/search/movies/?query=x
//icheckmovies
trackers.push(new SearchEngine("iCheckMovies", "http://www.icheckmovies.com/search/movies/?query=" + document.URL.substring(document.URL.indexOf("/tt")+1).substring(0, document.URL.substring(document.URL.indexOf("/tt")+1).indexOf("/")), false, "https://www.icheckmovies.com/favicon.ico"));
...
function SearchEngine(shortname, searchurl, usesIMDBID, icon) {
	...
	this.getHTML = function (title, id) {
        var html = '';
        /*if(shortname = 'isohunt'){
        	html += <br>;
        }*/
		html += "<a href=\"" + this.getSearchUrl(title, id) + "\"><img class=\"img\" style=\"-moz-opacity: 0.4;\" border=\"0\" width=\"16\" height=\"16\" src=\"" + this.icon + "\" title=\"" + this.shortname + "\"><\/a>&nbsp;";
		return html;
	}
 ...
 if (!iconbar || iconbar.snapshotLength != 1) {
  ...
  for (var i = 0; i < trackers.length; i++) {
    ...
    if(i  == 0){
      ...
      innerhtml += trackers[i].getHTML(title, id);
    tdimg.innerHTML = innerhtml;
