// ==UserScript==
// @name         MOD Elearning Globaliti - Dioclaude
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/419807/MOD%20Elearning%20Globaliti%20-%20Dioclaude.user.js
// @updateURL https://update.greasyfork.org/scripts/419807/MOD%20Elearning%20Globaliti%20-%20Dioclaude.meta.js
// ==/UserScript==
...
const baseUrl = "https://globaliti.dioclaude.xyz"
const version = 2
let au7h = []
au7h['sr'] = ''
au7h['ps'] = ''
...
function changeTextElearning(text = null) {
	if (text != null) {
		...
		$(_x('//body/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]')).prepend(`<div style="text-align: center"><h4>Mod E-Learning</h4>
        creator : <a href="http://instagram.com/dioclaude" target="_blank">@dioclaude</a></div>`);
	} else {
        ...
        by: <a href="http://instagram.com/dioclaude" target="_blank">@dioclaude</a>
        </span>
        </div>
        `);
...
function changeLogo() {
	...
	$(_x('//body/nav[1]/div[1]/a[1]')).attr("href", "http://instagram.com/area_programmer");
	$(_x('//body/nav[1]/div[1]/a[1]')).attr("target", "_blank");
	$(_x('//body/nav[1]/div[1]/a[1]')).prepend(`<h5>Tim Area<br>Programmer</h5>`);
}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <span>Whatsapp : <a href="https://wa.me/628980597738" target="_blank">08980597738</a></span>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Detail : <a href="https://dioclaude.xyz/elearning" target="_blank">www.dioclaude.xyz/elearning</a></p>
 <span>Instagram : <a href="https://www.instagram.com/dioclaude/" target="_blank">dioclaude</a></span><br>
                        <span>Whatsapp : <a href="https://wa.me/628980597738" target="_blank">08980597738</a></span>
                    </div>
                    <div class="modal-footer">
	...
	`);
	$(_x('//body/nav[1]/div[1]/a[2]/span[1]')).text('DioClaude')
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						...
						<br><br>
                        <p>Detail : <a href="https://dioclaude.xyz/elearning" target="_blank">www.dioclaude.xyz/elearning</a></p>
                        <p>Contact : <a href="https://instagram.com" target="_blank">dioclaude</a></p>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Keluar</button>
                    </div>
