...
// @version      20230318+tiku
// @description  问题反馈位置： https://github.com/TechXueXi/techxuexi-js/issues 。读文章,看视频，做习题。只做测试学习，不得以其他用途\途径使用。
// @author       techxuexi ，荷包蛋，Huang。
...
// @grant        GM_openInTab
// @license  none
// @downloadURL https://update.greasyfork.org/scripts/466816/%E4%B8%8D%E5%AD%A6%E4%B9%A0%E4%BD%95%E4%BB%A5%E5%BC%BA%E5%9B%BD-beta.user.js
// @updateURL https://update.greasyfork.org/scripts/466816/%E4%B8%8D%E5%AD%A6%E4%B9%A0%E4%BD%95%E4%BB%A5%E5%BC%BA%E5%9B%BD-beta.meta.js
// ==/UserScript==
var study_tiku_css = ".egg_study_tiku_btn{	outline:0;	border-radius:10px;	cursor:pointer;	background-color:#fff;color:#d90609;	font-size:14px;	font-weight:bold;	text-align:center;	box-shadow:0 0 9px #666777	}"
...
//按键1 题库案件
    function setBut1(){
        const tikuDiv = document.createElement("div");
        tikuDiv.setAttribute('id', 'tikuDivId');
        tikuDiv.setAttribute('class', 'egg_setting_item');
        tikuDiv.textContent = '题库';
        const button = document.createElement("button");
        button.innerHTML = "题库";
        button.className = "egg_study_tiku_btn";
        button.onclick = function(){
            //confirm('俺是一个个性化按钮');
            //window.location.href="http://techxuexi.js.org/tiku";
            window.open("http://techxuexi.js.org/tiku", '_blank');

            return;
        };
        tikuDiv.appendChild(button);
        const baiduContainer = document.getElementById('config_id');
        //baiduContainer.parentNode.insertBefore(button, baiduContainer.endChild);
        baiduContainer.insertBefore(tikuDiv, baiduContainer.firstChild);;
    }
