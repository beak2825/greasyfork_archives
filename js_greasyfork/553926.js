// ==UserScript==
// @name         Asclepius Revive Requests
// @namespace    http://tampermonkey.net/
// @version      1.0.1
// @description  Adds a button to request a revive from Asclepius
// @author       Stig [2648238]
...
// @downloadURL https://update.greasyfork.org/scripts/553926/Asclepius%20Revive%20Requests.user.js
// @updateURL https://update.greasyfork.org/scripts/553926/Asclepius%20Revive%20Requests.meta.js
// ==/UserScript==
'use strict';
 
const owner = "Asclepius";
const source = "Asclepius Script";
const buttonLabel = "Request Revive from Asclepius";
const colour = "#e83131";
...
function handleResponse(response) {
  ...
  if (contract) {
    ...
    alert(`Request has been sent to ${owner}. Please pay your reviver $1m. Thank you!`);
  }
}
