...
// @license     GNU GPLv3
// @downloadURL https://update.greasyfork.org/scripts/523637/%5BTORN%5D%5BDEV%5D%20OC%2020%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/523637/%5BTORN%5D%5BDEV%5D%20OC%2020%20Helper.meta.js
// ==/UserScript==
    ...
    if (!myAPIData) {
      try {
        ...
        if (_successfulGetAPIData.error) {
          ...
          $(".OC2-memberTableErrorDisplay").html(`<span style="margin-left: 20px">Error occured: ${_successfulGetAPIData.error.error}. Please visit the <a href="https://www.torn.com/OC2_Settings_Page" target="_blank" style="color: inherit; font-weight: bold; text-decoration: underline">Settings Page</a> to set up an API key</span>`)
...
async function getAndAnalyzeAPIData() {
  ...
  return await $.ajax({
    ...
    //console.log("getAndAnalyzeAPIData:", data)
...
async function generateInsertHTML() {
  ...
  <div class="category-wrap OC2-memberViewer m-top10">
    <div class="title-black top-round t-overflow">OC 2.0 Overview <a href="https://www.torn.com/OC2_Settings_Page" target="_top"><span title="Go to Settings Page" class="extraSettingsButton">&#9881;</span></a><span class="hideLazyMembersButton OC2-hideAtStart"></span><span class="hideCrimesButton OC2-hideAtStart"></span></div>
...
async function runOnceFunction() {
  ...
  if ($(location).attr("pathname").search("OC2_Settings_Page") >= 0) {
    ...
    console.log("Trying to load settings page")
    prepareSettingsPage()
    getSavedValues()
    settingsFillSelect()
  }
