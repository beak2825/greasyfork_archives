...
// @downloadURL https://update.greasyfork.org/scripts/396546/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%9B%B4%E9%93%BE%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/396546/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E7%9B%B4%E9%93%BE%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
...
!function () {
    ...
    function a() {
        function e() {
            it = R(), nt = K(), at = J(), ot = r(), ht = F(), "all" == ht && (ft = N()), "category" == ht && (vt = U()), "search" == ht && (mt = z()), a(), i(), n();
        }

        function i() {
            "all" == ht ? lt = L() : "category" == ht ? lt = H() : "search" == ht && (lt = q());
        }
        ...
        function d() {
            $(document).on("click", ".exe-download", function (t) {
                ...
                I() || (i = {"User-Agent": b}), GM_xmlhttpRequest({
                    method: "HEAD",
                    headers: i,
                        ...
                        if (i) {
                            var n = x.domain + ":" + x.port + "/jsonrpc", a = {
                                ...
                                params: ["token:" + x.token, [i], {
                                    dir: x.dir,
                                    out: e,
                                    header: I() ? ["User-Agent:" + y] : ["User-Agent:" + b]
                                }]
                            };
                            GM_xmlhttpRequest({
                                method: "POST",
        ...
        function T() {
            ...
            var y = $('<span class="g-button-menu" style="display:block"></span>'),
                ...
                G = $('<a id="batchhttplink-api" class="g-button-menu" href="javascript:;">显示链接</a>'),
                M = $('<a id="appid-setting" class="g-button-menu" href="javascript:;">神秘代码</a>'),
                S = $('<a id="default-setting" class="g-button-menu" href="javascript:;" style="color: #999;">恢复默认</a>');
            _.append(A).append(G).append(M).append(S), y.append(x.append(k).append(_)), y.hover(function () {
                x.toggleClass("button-open");
            }), A.click(P), G.click(D), M.click(E), S.click(j);
            var T = $('<span class="g-button-menu" style="display:block;cursor: pointer">分享选中文件</span>'),
                I = $('<iframe src="https://ghbtns.com/github-btn.html?user=syhyz1990&repo=baiduyun&type=star&count=true" frameborder="0" scrolling="0" style="height: 20px;max-width: 120px;padding: 0 5px;box-sizing: border-box;margin-top: 5px;"></iframe>');
            T.click(X), i.append(y).append(d).append(h).append(T).append(I), t.append(e).append(i), t.hover(function () {
        ...
        function P(e) {
            ...
            if ("download-direct" == i) {
                ...
                1 == dt.length && (a = 1 === dt[0].isdir ? "batch" : "dlink"), dt.length > 1 && (a = "batch"), st = B(dt);
                var o = Q(a);
        ...
        function O(t) {
            ...
            return $.each(dt, function (i, n) {
                ...
                a = 0 == n.isdir ? "dlink" : "batch", st = B([n]), s = Q(a), 0 == s.errno ? ("dlink" == a ? o = s.dlink[0].dlink : "batch" == a && (o = s.dlink), o = o.replace(/^([A-Za-z]+):/, t)) : o = "error", e.push({
                    filename: n.filename,
                    downloadlink: o
                });
            }), e;
        ...
        function X() {
            ...
            var e = "https://pan.baidu.com/share/set?channel=chunlei&clienttype=0&web=1&channel=chunlei&web=1&app_id=250528&bdstoken=" + at + "&logid=" + ot + "&clienttype=0",
                i = Y(), n = {schannel: 4, channel_list: JSON.stringify([]), period: 0, pwd: i, fid_list: B(dt)};
            $.ajax({
        ...
        this.init = function () {
            ...
            e(), l(), S(), T(), tt(), gt = new c({addCopy: !0}), t("下载助手加载成功！当前版本：", h);
        };
    }
    ...
    function o() {
        ...
        function g() {
            ...
            n.append(l).append(d).append(r).append(c).append(o).append(p), e.append(i), t.append(e).append(n), t.hover(function () {
                t.toggleClass("button-open");
            }), o.click(_), s.click(A), l.click(F), c.click(K), d.click(K), r.click(G), p.click(k), $("div.module-share-top-bar div.bar div.x-button-box").append(t);
        }
        ...
        this.init = function () {
            ...
            e(), g(), bt = new c({addCopy: !1}), yt = new p(H, q), M(), S(), a() || U(), t("下载助手加载成功！当前版本：", h);
        };
    }
    ...
    function c() {
        ...
        this.open = function (t) {
            if (a = t, e = [], "link" == t.type && (e = t.list.urls, $("div.dialog-header h3 span.dialog-title", o).text(t.title + "：" + t.list.filename), $.each(t.list.urls, function (t, e) {
                e.url = n(e.url)
