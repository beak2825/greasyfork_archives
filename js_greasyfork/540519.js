// ==UserScript==
// @name         Bless Russia | RED Chief script
...
// @downloadURL https://update.greasyfork.org/scripts/540519/Bless%20Russia%20%7C%20RED%20Chief%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/540519/Bless%20Russia%20%7C%20RED%20Chief%20script.meta.js
// ==/UserScript==
...
$(document).ready(() => {
  ...
  function addButton(name, id) {
    $('.button--icon--reply').before(
      `<button type="button" class="button rippleButton" id="${id}" style="border-radius: 7px; margin-right: 5px; color: #000; background: #ff0f0f; border: 1px solid;">${name}</button>`,
    );
  }
