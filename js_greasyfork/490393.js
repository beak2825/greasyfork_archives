...
// @license         MIT
// @icon            data:image/jpeg;base64,
// @grant           none
// @downloadURL https://update.greasyfork.org/scripts/490393/Jergu%C5%A1%20Gombit.user.js
// @updateURL https://update.greasyfork.org/scripts/490393/Jergu%C5%A1%20Gombit.meta.js
// ==/UserScript==
...
(function() {
    ...
    Vajda.createSetGui = function() {
        ...
        if ( Vajda.travelSet != -1 ) {
            travelSetText = Vajda.sets[Vajda.travelSet]?.name || None
        }

        let jobSetText = "None"
        if ( Vajda.jobSet != -1 ) {
            jobSetText = Vajda.sets[Vajda.jobSet]?.name || None
        }

        let healthSetText = "None"
        if ( Vajda.healthSet != -1 ) {
            healthSetText = Vajda.sets[Vajda.healthSet]?.name || "None"
        }
                ...
                <ol style=${listStyle}>
                    ...
                    <li>
                        ...
                        <ul style=${nestedListStyle}>
                            <li>The setting has to be enabled <i>before</i> you start Jerguš, it won't work otherwise</li>
                            <li>The <i>Add motivation</i> setting has to be enabled as well</li>
                            <li>Do not start Jerguš with low energy and consumables on cooldown</li>
                            <li>Do not use consumables yourself while it's running</li>
                            <li>
                                You don't have to select consumables manually with this setting, Jerguš will do it for you. Just make sure
                                you have enough of them butt plugs and decorations
                            </li>
                        </ul>

                        These restrictions are simply the cost of having Jerguš refill energy <i>while</i> doing jobs.
                    </li>

                    <li>
                        Jerguš can <strong>travel</strong> to jobs that you can't do in travel set (unless you are super low level).
                    </li>
                    ...
                    <li>
                        Jerguš will display <strong>all silver jobs</strong>, not just those you can do and are closest to yoor character. This
                    ...
                    <li>
                        When <strong>Auto Refresh</strong> is enabled, Jerguš will refresh the page and start automatically <i>n</i> minutes
                        after starting a job (or walking to one). Starting new jobs will restart this countdown. Do not set the delay to low numbers,
                        Jerguš enforces a minimum of 2.5 minutes anyway, however, I do recommend a slightly longer delay (about 5 minutes). Consider travel
                        time as well.
                    </li>
                </ol>
            </div>
    ...
    Vajda.createMenuIcon = function() {
        ...
        let link = $('<div id="vajda_menu" class="menulink" onclick=Vajda.loadJobs() title="Jerguš Gombit" />').css('background-image', 'url(' + menuImage + ')')
        $('#ui_menubar').append((div).append(link).append('<div class="menucontainer_bottom" />'))
    }


    Vajda.createWindow = function(isHumanAction = true) {
        const window = wman.open("vajda").setResizeable(false).setMinSize(650, 480).setSize(650, 480).setMiniTitle("Jerguš Gombit")
        const tabs = {
            "jobs": "Jobs",
