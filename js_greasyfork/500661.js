// ==UserScript==
// @name         Bonk Commands + Monochrome Style
...
// @grant        none
// @unwrap
// @downloadURL https://update.greasyfork.org/scripts/500661/Bonk%20Commands%20%2B%20Monochrome%20Style.user.js
// @updateURL https://update.greasyfork.org/scripts/500661/Bonk%20Commands%20%2B%20Monochrome%20Style.meta.js
// ==/UserScript==
// Test

var vv = ["255 255 255","255 255 255", "253 253 253", "252 252 252","250 250 250", "245 245 245", "240 240 240", "235 235 235", "230 230 230", "225 225 225", "220 220 220", "215 215 215", "210 210 210", "205 205 205", "200 200 200", "195 195 195", "190 190 190", "185 185 185", "180 180 180", "175 175 175", "170 170 170", "165 165 165", "160 160 160", "155 155 155", "150 150 150", "145 145 145", "140 140 140", "135 135 135", "130 130 130", "125 125 125", "120 120 120", "115 115 115", "110 110 110", "105 105 105", "100 100 100","95 95 95","90 90 90","85 85 85","80 80 80","75 75 75","70 70 70","65 65 65","60 60 60","57 57 57","56 56 56","55 55 55","54 54 54","53 53 53","52 52 52","52 52 52","53 53 53","54 54 54","55 55 55","56 56 56","57 57 57","60 60 60","65 65 65","70 70 70","75 75 75","80 80 80","85 85 85","90 90 90","95 95 95","100 100 100" ,"105 105 105" ,"110 110 110" ,"115 115 115" ,"120 120 120" ,"125 125 125" ,"130 130 130" ,"135 135 135" ,"140 140 140" ,"145 145 145" ,"150 150 150" ,"155 155 155" ,"160 160 160" ,"165 165 165" ,"170 170 170" ,"175 175 175" ,"180 180 180" ,"185 185 185" ,"190 190 190" ,"195 195 195" ,"200 200 200" ,"205 205 205" ,"210 210 210" ,"215 215 215" ,"220 220 220" ,"225 225 225" ,"230 230 230" ,"235 235 235" ,"240 240 240" ,"245 245 245" ,"250 250 250","252 252 252" ,"253 253 253" ,"255 255 255","255 255 255",];
var rindex = 0
var idklol = false;
var firstt = false;
...
scope.adv_help = {"help":"Shows all command names.",
                ...
                "mstyle":"Change the color of your username, level, and background to monochrome.",
...
scope.commandhandle = function(chat_val){
    ...
    else if (chat_val.substring(1,7)=="mstyle"){
        if (idklol == false) {
            if (firstt == false) {
            firstt = true;
            }
                                            displayInChat("Monochrome style enabled","#DA0808","#1EBCC1");
            idklol = true;
                    changecolor2();
        }else{
                                            displayInChat("Monochrome style disabled","#DA0808","#1EBCC1");
      idklol = false;
        }
    }
