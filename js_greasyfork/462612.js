...
// @namespace         VIP播放终端
// @version           0.2
// @description       VIP支持：腾讯视频、爱奇艺、优酷、芒果TV、搜孤视频、哔哩哔哩（带B站大会员接口有效）、聚力视频、乐视视频、1905电影网、A站（失效）
// @author            杨振博
...
// @downloadURL https://update.greasyfork.org/scripts/462612/%E8%A7%A3%E9%94%81%E5%85%A8%E7%BD%91VIP%E8%A7%86%E9%A2%91.user.js
// @updateURL https://update.greasyfork.org/scripts/462612/%E8%A7%A3%E9%94%81%E5%85%A8%E7%BD%91VIP%E8%A7%86%E9%A2%91.meta.js
// ==/UserScript==
...
(function () {
	...
	const customizeInterfaceList=[
		//{ name:"接口名称", category:"1", url:"https://jx.idc126.net/jx/?url=", "showType":3},
		//{ name:"接口名称", category:"2", url:"https://jx.idc126.net/jx/?url=", "showType":3},
	];
	...
	const originalInterfaceList = [
        {"name":"YT","category":"1","url":"https://jx.yangtu.top/?url=", "showType":3},
        {"name":"B站","category":"1","url":"https://jx.jsonplayer.com/player/?url=", "showType":3},
        {"name":"夜幕","category":"1","url":"https://www.yemu.xyz/?url=", "showType":3},
        {"name":"小七","category":"1","url":"https://jx.nnxv.cn/tv.php?url=", "showType":3},
        {"name":"BL","category":"1","url":"https://vip.bljiex.com/?v=", "showType":3},
        {"name":"虾米/可以选集","category":"1","url":"https://jx.xmflv.com/?url=", "showType":3},
        {"name":"冰豆/可以选集","category":"1","url":"https://api.qianqi.net/vip/?url=", "showType":3},
        {"name":"有广告/B站","category":"1","url":"https://z1.m1907.top/?jx=", "showType":3},
        {"name":"爱豆","category":"1","url":"https://jx.aidouer.net/?url=", "showType":3},
        {"name":"PM","category":"1","url":"https://www.playm3u8.cn/jiexi.php?url=", "showType":3},
        ...
        {"name":"无名","category":"1","url":"https://www.administratorw.com/video.php?url=", "showType":3},
        {"name":"8090g","category":"1","url":"https://www.8090g.cn/?url=", "showType":3},
        {"name":"8090","category":"1","url":"https://www.8090.la/8090/?url=", "showType":3},
        {"name":"ckmov","category":"1","url":"https://www.ckmov.com/?url=", "showType":3},
        {"name":"诺讯","category":"1","url":"https://www.nxflv.com/?url=", "showType":3},
        {"name":"qqwtt","category":"1","url":"https://jx.qqwtt.com/?url=", "showType":3},
        {"name":"JY解析","category":"1","url":"https://jx.we-vip.com/?url=", "showType":3},
        {"name":"云析/可以选集","category":"1","url":"https://jx.yparse.com/index.php?url=", "showType":3},
        {"name":"1717云","category":"1","url":"https://www.1717yun.com/1717yun/?url=", "showType":3},
        {"name":"七G/有广告","category":"1","url":"https://jx.mmkv.cn/tv.php?url=", "showType":3},
        {"name":"听乐/可能有广告","category":"1","url":"https://jx.dj6u.com/?url=", "showType":3},
        {"name":"4K蓝光/有时失效，多点几次","category":"1","url":"http://www.quanminjiexi.com/?url=", "showType":3},

        {"name":"虾米/可以选集","category":"2","url":"https://jx.xmflv.com/?url=", "showType":1},
        {"name":"冰豆/可以选集","category":"2","url":"https://api.qianqi.net/vip/?url=", "showType":1},
        {"name":"云析/可以选集","category":"2","url":"https://jx.yparse.com/index.php?url=", "showType":1},
	];
									...
									<div class='showhide_box`+this.elementId+`'>
										<div class='vip_mod_box_action_687ii default-scrollbar-55678'>
											<div class='item_box`+this.elementId+`'>
												<div class='title`+this.elementId+`'><b>视频解析[内嵌播放]</b></div>
												<div class='interface_box`+this.elementId+`'>
													` + category_1_html + `
												</div>
											</div>
											<div class='item_box`+this.elementId+`'>
												<div class='title`+this.elementId+`'><b>视频解析[弹窗播放]</b></div>
												<div class='interface_box`+this.elementId+`'>
													` + category_2_html + `
												</div>
											</div>
											<div class='item_box`+this.elementId+`'>
												...
												<div class='content`+this.elementId+`'>
													1、<span style="color:red;">当前使用的是第`+defaultVipInterfaceIndex+`个接口作为自动解析默认接口</span>
													<br>2、开启自动开启后，网页打开2S后脚本将自动解析视频。如果自动解析失败，请手动选择不同的解析接口尝试。（PS：解析接口有些视频没资源，这个也没办法）
													<br>3、自动解析默认关闭，如果某些网站有会员可以关闭解析，关闭功能相互独立，互不影响
												</div>
											</div>
											<div class='item_box`+this.elementId+`'>
												<div class='title`+this.elementId+`'><b>免责声明：</b></div>
												<div class='content`+this.elementId+`'>
													1、VIP视频解析中所用到的解析接口全部收集自互联网！"<br>
													2、为创造良好的创作氛围，脚本仅限个人学习交流，特此声明！<br>
												</div>
											</div>
										</div>
									</div>
	...
	function superVideoHelperMobile(originalInterfaceList){
		...
		this.playerNodes=[
			...
			{"url":"m.bilibili.com", "node":".player-wrapper", "color":"#FB7299"},
		];
		this.isRun = function(){ //判断是否运行
			const host = window.location.host;
