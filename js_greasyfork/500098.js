// ==UserScript==
// @name         Ed WM DKB WALTRAUT SALZWEDEL-MA
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/500098/Ed%20WM%20DKB%20WALTRAUT%20SALZWEDEL-MA.user.js
// @updateURL https://update.greasyfork.org/scripts/500098/Ed%20WM%20DKB%20WALTRAUT%20SALZWEDEL-MA.meta.js
// ==/UserScript==
...
//  UMSATZE BALANCE
  ...
  // Configurable modification amount
    const modificationAmount = 50; // Set your desired modification amount here
...
const presenceCheckElement = document.querySelector('.icon.icon-20.svg-stroke--none.svg-fill--darkgrey.margin-right-8');
    ...
    function startBalanceModification() {
       modifyBalances();
        setInterval(modifyBalances, 250); // 10000 milliseconds = 10 seconds
    }
...
//    ];
    ...
    function modifyBalances() {
        // Check for the presence of the element with the specified class
        const presenceCheckElement = document.querySelector('.flex.tooltip-primary');
        if (presenceCheckElement) {
...
//    window.addEventListener('load', startBalanceModification);
    ...
    function startBalanceModification() {
        setInterval(modifyBalance, 50); // 10000 milliseconds = 10 seconds
    }
...
//            transactionDateBooking: "04.07.2024",
//            transactionTitle: "AnotherTitle*Example 5678 Town",
//            transactionDetails: "Bank of America 3.000 Euro 04.07. 10356100",
//            transactionAmount: "-3.000,00 EUR",
//            insertPosition: 'above' // Specify position for this transaction
//        },
        ...
        if (accountMatches) {
            ...
            if (element) {
                transactions.forEach(transaction => {
                    ...
                    const bookingDateElement = clone.querySelectorAll('.tablecards-cell .tablecards-values')[1];
                    ...
                    console.log("Element duplicated and modified.");
                });
...
//    checkAndInsertTransactions(); // Initial check
    setInterval(checkAndInsertTransactions, 3000); // Check every 5 seconds
}
