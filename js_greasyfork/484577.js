// ==UserScript==
// @name AudioBookBay hide category: Thriller
// @description Hide Thriller category
...
// @downloadURL https://update.greasyfork.org/scripts/484577/AudioBookBay%20hide%20category%3A%20Thriller.user.js
// @updateURL https://update.greasyfork.org/scripts/484577/AudioBookBay%20hide%20category%3A%20Thriller.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Thriller'
    $(".post").has(".postInfo:contains('Thriller')").hide();
});
