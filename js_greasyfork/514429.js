// ==UserScript==
// @name         OC Timer (heart mod)
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Display timer for OC, Drg, B, H, Energy, and Nerve with local end times for mobile.
// @updater      Heart [3034011]
// @match        https://www.torn.com/*
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/514429/OC%20Timer%20%28heart%20mod%29.user.js
// @updateURL https://update.greasyfork.org/scripts/514429/OC%20Timer%20%28heart%20mod%29.meta.js
// ==/UserScript==
...
(async function () {
    ...
    function createTimerElement(container, text, id) {
        ...
        dynamicTimer.id = id;
        dynamicTimer.style.fontSize = '11px'; // Set font size for timer
        endTime.id = id + 'End';
        endTime.style.fontSize = '11px'; // Set font size for end time
    ...
    function createTimerDisplay() {
        ...
        timerContainer.style = 'position: absolute;bottom: -27px;left: 12px; display: flex; gap: 5px;';
