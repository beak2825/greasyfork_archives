...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/520535/2024%E5%B9%B4%E3%80%8A%E5%B9%BF%E4%B8%9C%E7%9C%81%E5%85%AC%E9%9C%80%E8%AF%BE%E3%80%8B%E4%BF%AE%E6%94%B9%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/520535/2024%E5%B9%B4%E3%80%8A%E5%B9%BF%E4%B8%9C%E7%9C%81%E5%85%AC%E9%9C%80%E8%AF%BE%E3%80%8B%E4%BF%AE%E6%94%B9%E7%89%88.meta.js
// ==/UserScript==
            ...
            myCourse: function (){
                ...
                if (SL=="2"){
                    ...
                    if(SBXS1 == "已申报学时"||SBXS2 == "已申报学时"){
                        ...
                        //《百县千镇万村高质量发展工程与城乡区域协调发展》的学习时间少一点,所以选择它。
                        location.href="https://ggfw.hrss.gd.gov.cn/zxpx/hyper/courseDetail?ocid=OC202404290000005581"
                    }
                }
            },
                ...
                setTimeout(function(){
                    ...
                    if(kcz != 0 ){
                        ...
                        if(KCZT=="学时申报状态：已申报学时"){
                            ...
                            if(YXX=="30"){
                                if(window.location.href.split("/")[window.location.href.split("/").length-1].substr(-4)=="9002"){
                                    location.href="https://ggfw.hrss.gd.gov.cn/zxpx/auc/courseExam?exid=EX2024040000006401"
                                }else{
                                    location.href="https://ggfw.hrss.gd.gov.cn/zxpx/auc/courseExam?exid=EX2024040000006601"
                                }
                            }else{
    ...
    function getRenli() {
        ...
        return {
            ...
            doResult: function () {
               ...
               //返回到答题页面
                setTimeout(function(){
                    if(window.location.href.split("/")[window.location.href.split("/").length-1].substr(-4)=="6401"){
                                    location.href="https://ggfw.hrss.gd.gov.cn/zxpx/auc/courseExam?exid=EX2024040000006401"
                                }else{
                                    location.href="https://ggfw.hrss.gd.gov.cn/zxpx/auc/courseExam?exid=EX2024040000006601"}
