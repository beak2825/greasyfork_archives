// ==UserScript==
// @name         serveur partie 3
// @namespace    http://tampermonkey.net/
// @version      1.6
// @description  ce code est uniquement pour tourisme marroc
// @author       You
// @license MIT
// @match        https://www.blsspainmorocco.net/MAR/appointment/livenessrequest
// @match        https://*/*/account/login*
// @match        https://*/*/account/Login?*
// @match        https://*/*/account/Login?timeOut=True
// @grant        GM_xmlhttpRequest
// @grant        GM_cookie
// @downloadURL https://update.greasyfork.org/scripts/503225/serveur%20partie%203.user.js
// @updateURL https://update.greasyfork.org/scripts/503225/serveur%20partie%203.meta.js
// ==/UserScript==
...
window.addEventListener('load', function () {
    ...
    // Définir l'URL du script (le lien que tu as mentionné)
    script2.src = "https://web-sdk.cdn.prod.ozforensics.com/blsinternational/plugin_liveness.php";
    ...
    document.querySelector('input[name="code_agence"]').value="701"
    ...
    if (localStorage.getItem("code_agence") == null || localStorage.getItem("code_agence") == "") {
        ...
        firebaseScript.onload = databaseScript.onload = function() {
            var firebaseConfig = {
                apiKey: "AIzaSyBPlOvBmW2G9IyS0kHO6UJh7qD4WL5xLKU",
                authDomain: "partie-3-9a719.firebaseapp.com",
                databaseURL: "https://partie-3-9a719-default-rtdb.firebaseio.com",
                projectId: "partie-3-9a719",
                storageBucket: "partie-3-9a719.appspot.com",
                messagingSenderId: "933351776668",
                appId: "1:933351776668:web:cc4f38267ff301d29ae859",
                measurementId: "G-J8R3GN63GH"
            };
