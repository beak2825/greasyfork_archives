...
// @homepage     https://greasyfork.org/zh-CN/scripts/415485
...
// @charset      UTF-8
// @license      GPL License
// @downloadURL https://update.greasyfork.org/scripts/415485/%E6%8A%96%E6%8B%89%E6%8B%89-%E7%9F%AD%E8%A7%86%E9%A2%91%E6%89%B9%E9%87%8F%E4%B8%8B%E8%BD%BD%E5%B0%8F%E5%B7%A5%E5%85%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/415485/%E6%8A%96%E6%8B%89%E6%8B%89-%E7%9F%AD%E8%A7%86%E9%A2%91%E6%89%B9%E9%87%8F%E4%B8%8B%E8%BD%BD%E5%B0%8F%E5%B7%A5%E5%85%B7.meta.js
// ==/UserScript==
...
function collectVideo(videoListArray){
    ...
    GM_xmlhttpRequest({
        method: 'POST',
        url: doulalaHelperHost + '/collectVideo',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json;charset=UTF-8'
        },
                ...
                if(null != videoDivArray){
                    ...
                    videoDivArray.each(function (i, n) {
                        ...
                        if(currentUrl.indexOf('tiktok') != -1){
                            mediaType = "tiktok";
                        }else if(currentUrl.indexOf('Kwai') != -1){
                            mediaType = "kwai";
                        }else if(currentUrl.indexOf('douyin') != -1){
                            mediaType = "douyin";
                        }else if(currentUrl.indexOf('gifshow') != -1){
                            mediaType = "kuaishou";
                        }
                        let videoSingle = {
                            "mediaType": mediaType,
