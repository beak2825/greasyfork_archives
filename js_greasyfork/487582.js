...
// @grant t.me/arefuer
// @license t.me/arefuer
// @collaborator t.me/arefuer
// @icon https://i.yapx.ru/ViO6c.png
// @downloadURL https://update.greasyfork.org/scripts/487582/TECH%20SCRIPT.user.js
// @updateURL https://update.greasyfork.org/scripts/487582/TECH%20SCRIPT.meta.js
// ==/UserScript==
...
(function () {
	...
	const buttons = [
	{
		...
		'[CENTER] Введи текст [/CENTER][/FONT][/SIZE]',
        dpstyle: 'flex-grow: 1; border-radius: 25px; font-family: JetBrains Mono',
	},
	{
        title: 'Для специалистов в направлении логирования',
        dpstyle: 'width: 97%; background: #e37602; box-shadow: 0px 0px 5px #fff',
	},
	{
	...
	function editThreadData(prefix, pin = false, transfer = true) {
