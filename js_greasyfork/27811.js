// ==UserScript==
// @name         NotWhat-Autofill from torrent
// @version      1.3.5.1
...
// @downloadURL https://update.greasyfork.org/scripts/27811/NotWhat-Autofill%20from%20torrent.user.js
// @updateURL https://update.greasyfork.org/scripts/27811/NotWhat-Autofill%20from%20torrent.meta.js
// ==/UserScript==
...
function fileAdded(a, format, bitrate, full, event)
{
  ...
  else if(f.indexOf('flac' && '24bit') != -1)
  {
    formatTemp=2;
    bitrateTemp=11;
  }
