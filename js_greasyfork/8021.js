// ==UserScript==
// @name                MTurk Captcha Alert
// @author              Chet Manley (Modified by Lowlife)
// @version             0.2
// @namespace           Space
// @description         Alerts when a captcha is encountered. (modified to focus text box)
// @include             https://www.mturk.com/mturk/accept*
// @include             https://www.mturk.com/mturk/continue*
// @include             https://www.mturk.com/mturk/preview*
// @include             https://www.mturk.com/mturk/return*
// @require             http://code.jquery.com/jquery-latest.min.js
// @downloadURL https://update.greasyfork.org/scripts/8021/MTurk%20Captcha%20Alert.user.js
// @updateURL https://update.greasyfork.org/scripts/8021/MTurk%20Captcha%20Alert.meta.js
// ==/UserScript==

// v0.1, 2013-10-10     Alerts when a captcha is encountered.
//                      ---------------------------------------------------------------------------
...
$(document).ready(function () {
    ...
    if ($('input[name="userCaptchaResponse"]').length > 0) {
        ...
        function titleMarquee() {
            ...
            $("input[name='userCaptchaResponse']").focus()
        }
