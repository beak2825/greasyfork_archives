...
// @namespace https://greasyfork.org/users/2964
// @downloadURL https://update.greasyfork.org/scripts/2729/Mouseover%20Popup%20Image%20Viewer.user.js
// @updateURL https://update.greasyfork.org/scripts/2729/Mouseover%20Popup%20Image%20Viewer.meta.js
// ==/UserScript==
...
function existsUnscaled(url, parent) {
	...
	for(var i = imgs.length, img; i-- && (img = imgs[i]);) {
		if(img.src == url && Math.max((img.naturalHeight || img.videoHeight)/img.offsetHeight, (img.naturalWidth || img.videoHeight)/img.offsetWidth) < cfg.scale) return true;
	}
}
