...
// @version      1.3.0
// @description  e-journals download redirect for NUS students V1.3.0 (fixed overlap & delay only for AIP sites)
...
// @downloadURL https://update.greasyfork.org/scripts/531476/NUS%20e-journals%20download%20redirect.user.js
// @updateURL https://update.greasyfork.org/scripts/531476/NUS%20e-journals%20download%20redirect.meta.js
// ==/UserScript==
...
(function () {
    ...
    const redirect = () => {
        document.location.href = href
            .replace('advanced.onlinelibrary.wiley.com', 'advanced-onlinelibrary-wiley-com.libproxy1.nus.edu.sg') // Put first
    ...
    if (href.includes('aip.scitation.org') || href.includes('pubs.aip.org')) {
        const delay = Math.random() * (1852 - 1143) + 1143; // 1143 ms to 1852 ms
