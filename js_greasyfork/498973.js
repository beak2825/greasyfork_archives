...
// @description  Предложения по улучшению скрипта писать сюда ---> https://vk.com/dmitriikolobrodov
// @description:ru Предложения по улучшению скрипта писать сюда ---> https://vk.com/dmitriikolobrodov
...
// @downloadURL https://update.greasyfork.org/scripts/498973/Forum%20Curators%20%7C%20%20for%20Black%20Russia.user.js
// @updateURL https://update.greasyfork.org/scripts/498973/Forum%20Curators%20%7C%20%20for%20Black%20Russia.meta.js
// ==/UserScript==
...
(async function () {
    ...
    $(document).ready(() => {
        ...
        $(`button#pinn`).click(() => pasteContent2(0, threadData, true));
        ...
        $(`button#ne_rabochaya_opra`).click(() => pasteContent2(14, threadData, true));
        $(`button#osk`).click(() => pasteContent2(15, threadData, true));


        $(`button#player-otvet`).click(() => {
            XF.alert(buttonsMarkup(buttons), null, `Здарова, выбери ответ:`);
