...
// @grant        unsafeWindow
// @imgSize 800
// @downloadURL https://update.greasyfork.org/scripts/386675/%E8%AF%A6%E6%83%85%E4%B8%BB%E5%9B%BE%E8%8E%B7%E5%8F%96.user.js
// @updateURL https://update.greasyfork.org/scripts/386675/%E8%AF%A6%E6%83%85%E4%B8%BB%E5%9B%BE%E8%8E%B7%E5%8F%96.meta.js
// ==/UserScript==
...
(function () {
    ...
    $(document).ready(function () {
        ...
        function KuJiaLe(imgAttr) {
            ...
            imgMap('.model-list .cover-wp', imgAttr, '', options);
        };
            ...
            if (options.label === 'Jd') {
                ...
                $(`${parent} ${options.imgEle}[${imgAttr}]`).map(function () {
                    ...
                    if (options.imgEle === 'img') {
                        ...
                        `;
                    } else if (options.imgEle === 'li'){
                        $thisUrl = $this.find('cover').attr('src').replace(options.replaceSearch, options.replaceVal);
                        if ($thisUrl === undefined) return;
                        li = `
                            <li>
                                <img src="${$thisUrl}">
