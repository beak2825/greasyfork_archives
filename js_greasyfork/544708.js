// ==UserScript==
// @name         Greasyfork Search with Sleazyfork Results
// @name:es         Búsqueda de Greasyfork con resultados de Sleazyfork
// @name:ca         Greasyfork Cerca amb resultats de Sleazyfork
// @namespace    hoothin
// @version      1.6.7-mod-by-anna
// @description  Merge adult results of sleazyfork into greasyfork. Add rating score and version for scripts.
// @description:es  Fusionar los resultados adultos de sleazyfork en greasyfork. Agregue puntuación de calificación y versión para scripts.
// @description:ca  Fusioneu els resultats adults de sleazyfork en greasyfork. Afegiu puntuació de puntuació i versió per als scripts.
// @author       hoothin (cleaned by Anna)
...
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/544708/Greasyfork%20Search%20with%20Sleazyfork%20Results.user.js
// @updateURL https://update.greasyfork.org/scripts/544708/Greasyfork%20Search%20with%20Sleazyfork%20Results.meta.js
// ==/UserScript==
