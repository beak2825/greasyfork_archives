// ==UserScript==
// @name         WME LevelReset N4DOG
// @namespace    n4dog.waze@gmail.com
// @version      0.2.4
...
// @downloadURL https://update.greasyfork.org/scripts/31467/WME%20LevelReset%20N4DOG.user.js
// @updateURL https://update.greasyfork.org/scripts/31467/WME%20LevelReset%20N4DOG.meta.js
// ==/UserScript==

// initialize LevelReset and do some checks
function LevelReset_bootstrap() {
    // Check initialisation
    if (typeof W == 'undefined' || typeof I18n == 'undefined' || typeof W.loginManager == 'undefined' || typeof W.loginManager.user == 'undefined') {
        setTimeout(LevelReset_bootstrap, 1000);
...
function LevelReset_init() {
    ...
    function scanArea() {
        ...
        try {
            var ABBR =  cntryDB[W.model.countries.top.abbr];
