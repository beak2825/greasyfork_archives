...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/557189/Garticio%20Tokens.user.js
// @updateURL https://update.greasyfork.org/scripts/557189/Garticio%20Tokens.meta.js
// ==/UserScript==
        ...
        try {
            window.turnstile.render("#cf-turnstile", {
                ...
                callback: function (token) {
                    ...
                    fetch("https://moonfive.alwaysdata.net/add-token", {
                        method: "POST",
                        headers: {
