...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/501485/%E6%95%B0%E6%8D%AE%E5%A1%AB%E5%85%85%E8%84%9A%E6%9C%AC%2B20%E6%95%B0%E6%8D%AE%E5%A1%AB%E5%85%85%E8%AE%B0%E5%BF%86%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/501485/%E6%95%B0%E6%8D%AE%E5%A1%AB%E5%85%85%E8%84%9A%E6%9C%AC%2B20%E6%95%B0%E6%8D%AE%E5%A1%AB%E5%85%85%E8%AE%B0%E5%BF%86%E7%89%88.meta.js
// ==/UserScript==
...
// 布局扶梯定期检验FDformBox 创建一个包含多个小方框和保存按钮的方框
  const FDformBox = document.createElement('div');
      FDformBox.style.backgroundColor = '#f9f9f9';
      FDformBox.style.padding = '2px';
      FDformBox.style.border = '1px solid #ccc';
      FDformBox.style.display = 'flex'; // 使用Flexbox布局
      FDformBox.style.display = 'grid'; // 使用网格布局
      FDformBox.style.gridTemplateColumns = '220px 220px'; // 分成两列
      FDformBox.style.gridGap = '0.10px'; // 设置网格间距
      FDformBox.style.flexDirection = 'column'; // 垂直方向排列
      FDformBox.style.alignItems = 'flex-start'; // 元素水平居左对齐
      FDformBox.innerHTML = `
    <div style="margin-bottom: 2px;">
   ...
   <div style="margin-bottom: 2px;">
    ...
    <div style="margin-bottom: 2px;">
      ...
      <input type="text" id="FDinput15.3" placeholder="" value="15" style="width: 8%; margin-left: 1px;">
    </div>
    <div style="margin-bottom: 2px;">
    ...
    <div style="margin-bottom: 2px;">
      ...
      <input type="text" id="FDinput28.4FD" placeholder="" value="变频" style="width: 12%; margin-left: 1px;">
    </div>
    <div style="margin-bottom: 2px;">
  ...
  const formBox = document.createElement('div');
      formBox.style.backgroundColor = '#f9f9f9';
      formBox.style.padding = '2px';
      formBox.style.border = '1px solid #ccc';
      formBox.style.display = 'flex'; // 使用Flexbox布局
      formBox.style.display = 'grid'; // 使用网格布局
      formBox.style.gridTemplateColumns = '200px 200px'; // 分成两列
      formBox.style.gridGap = '0.10px'; // 设置网格间距
      formBox.style.flexDirection = 'column'; // 垂直方向排列
      formBox.style.alignItems = 'flex-start'; // 元素水平居左对齐
      formBox.innerHTML = `
    <div style="margin-bottom: 2px;">
    ...
    <div style="margin-bottom: 2px;">
      <label for="input0.2" style="display: inline-block; width: 90px;">下次检测日：</label>
      <input type="text" id="input0.2" placeholder="" style="width: 80%; margin-left: 1px;">
    </div>
    <div style="margin-bottom: 2px;">
    ...
    <div style="margin-bottom: 2px;">
     ...
     <div style="margin-bottom: 2px;">
      <label for="input3.2" style="display: inline-block; width: 90px;">制动试验日：</label>
   ...
   <div style="margin-bottom: 2px;">
    ...
    <div style="margin-bottom: 2px;">
      <label for="input27" style="display: inline-block; width: 90px;">27重锤：</label>
    ...
    <button id="saveButton"style="width: 80px; height: 20px;" >保存数据</button>
    <button id="clearButton"style="width: 80px; height: 20px;" >清理数据</button>
  `;

//布局不同电梯名称的
    const MCformBox = document.createElement('div');
    MCformBox.style.backgroundColor = '#f9f9f9';
    MCformBox.style.padding = '2px';
    MCformBox.style.border = '1px solid #ccc';
//   DTMCformBox.style.display = 'flex'; // 使用Flexbox布局
    MCformBox.style.display = 'grid'; // 使用网格布局
//    MCformBox.style.gridTemplateColumns = '100px 100px 100px 100px'; // 分成两列
    MCformBox.style.gridGap = '0.10px'; // 设置网格间距
    MCformBox.style.flexDirection = 'column'; // 垂直方向排列
    MCformBox.style.alignItems = 'flex-start'; // 元素水平居左对齐
  ...
  const button1 = document.createElement("button");
    ...
    button1.onclick = function () {
      console.log('点击了按钮');
          ...
          document.getElementById('1702641013571d39a').lastElementChild.innerHTML='≤30';//24 门间隙2≤30
          ...
          document.getElementById('input24.2').value ='≤30';
	...
	button2.onclick = function (){
		...
		console.log('点击了按键');
          ...
          document.getElementById('input0.2').value =document.getElementById('170486608684702b3').lastElementChild.innerHTML;//下次检测日期
          document.getElementById('input5').value ='/';
          document.getElementById('input14.1').value ='/';
          document.getElementById('input14.2').value ='/';
          document.getElementById('input16').value ='/';
  ...
  button11.onclick = function () {
    ...
    return;
      ...
      // 创建并插入垂直梯出具复检
        ...
        examinationButton.textContent = '垂梯出具复检';
        //examinationButton.display = 'inline-block';
        examinationButton.style.width = "100px";
...
//            document.getElementById('15554029989396383').lastElementChild.innerHTML='17333212083';
      ...
      // 创建并插入防爆梯出具复检
        ...
        FBexaminationButton.textContent = '防爆出具复检';
        //FBexaminationButton.display = 'inline-block';
        FBexaminationButton.style.width = "100px";
...
//            observer.observe(document.body, { childList: true, subtree: true });
      ...
      // 创建直梯定检抬头
        const ZTDJButton = document.createElement('button');
        ZTDJButton.textContent = '直梯定检';
        //ZTDJ.style.display = 'inline-block';
        ZTDJButton.style.width = "80px";
        ZTDJButton.style.height = "20px";
        ZTDJButton.style.align = "center";
      // 创建扶梯定检抬头
        const FTDJButton = document.createElement('button');
        FTDJButton.textContent = '扶梯定检';
        //FTDJ.style.display = 'inline-block';
        FTDJButton.style.width = "80px";
        FTDJButton.style.height = "20px";
        FTDJButton.style.align = "center";
       ...
       // 新按钮点击事件
        ...
        // 每次点击更新点击次数
            ...
            if (clicktoggleButton % 2 === 1) {
                ...
                MCformBox.innerHTML = '';
                MCformBox.appendChild(FTDJButton);
                formBox3.appendChild(toggleButton);//切换选项
                formBox3.appendChild(examinationButton);//出具复检
                formBox3.appendChild(FBexaminationButton);//防爆复检
                container.appendChild(MCformBox);
                container.appendChild(FDformBox);
             ...
             //container.appendChild(textBoxLabel); // 重新插入说明文字
                ...
                container.innerHTML = ''; // 清空容器内容
                MCformBox.innerHTML = '';
                MCformBox.appendChild(ZTDJButton);
                ...
                container.appendChild(MCformBox);
                //container.appendChild(formBox3);
                container.appendChild(formBox2);
...
//       $('#170264247697664b1>#1702640910772148a>span.widget-content').text('≥7');//29 啮合尺寸≥7 ID:170264247697664b1 SPAN:1702640910772148a
...
//       const childElementId = ids.slice(1).join(' '); // 子辈元素的ID

/*    if (ids.length > 1) {
        const parentElementId = ids[0];
        const childElementId = ids[1];
        $('#' + parentElementId + ' ' + childElementId).text(inputData);
    } else {
        $('#' + ids[0]).text(inputData);
    }*/
...
//       $('#' + parentElementId + ' ' + childElementId+'>span.widget-content').text(inputData);
   ...
   //清理数据，并恢复默认数据
      ...
      //再把空白格的数据保存
       ...
       /*document.getElementById( 'input0').value = document.getElementById('1581261440012c13e').lastElementChild.innerHTML ;//检验日期   TD 158125898109086f SPAN1581261440012c13e
       document.getElementById( 'input0.2').value = document.getElementById('170486608684702b3').lastElementChild.innerHTML ;//下次检测日期
       document.getElementById( 'input1').value = document.getElementById('1555396405619e7a5').lastElementChild.innerHTML ;//电梯管理员
       document.getElementById( 'input2').value = document.getElementById('1595319577630fe27').lastElementChild.innerHTML ;//电梯管理员手机SPAN1595319577630fe27
       document.getElementById( 'input3').value = document.getElementById('170264546896268b8').lastElementChild.lastElementChild.innerHTML ;//维保员  TD 170264546896268b8 SPAN 1555402991327aca9
       document.getElementById( 'input3.1').value = document.getElementById('15554029989396383').lastElementChild.innerHTML ;//维保员手机
       document.getElementById( 'input3.2').value = document.getElementById('17014878048050a06').lastElementChild.innerHTML ;//制动试验日期
       document.getElementById( 'input4').value = document.getElementById('1700887220897829').lastElementChild.innerHTML ;//4缓冲器
       document.getElementById( 'input5').value = document.getElementById('1700887220897d0b').lastElementChild.innerHTML ;//5 接地保护
       document.getElementById( 'input6.1').value = document.getElementById('1700887220897d51').lastElementChild.innerHTML ;//6 旁路1
       document.getElementById( 'input6.2').value = document.getElementById('17008872208971d0').lastElementChild.innerHTML ;
       document.getElementById( 'input6.3').value = document.getElementById('1700887220897c04').lastElementChild.innerHTML ;
       document.getElementById( 'input6.4').value = document.getElementById('170088722089843f').lastElementChild.innerHTML ;//6 旁路4
       document.getElementById( 'input7').value = document.getElementById('1702637271087a233').lastElementChild.lastElementChild.innerHTML ;//7 制动器监测 TD 1702637271087a233 SPN 17014953212526364
       document.getElementById( 'input8.1').value = document.getElementById('1700887253052c45').lastElementChild.innerHTML ;//8 紧急电动1
       document.getElementById( 'input8.2').value = document.getElementById('1702637397596a1c8').lastElementChild.innerHTML ;//8 紧急电动2
       document.getElementById( 'input9').value = document.getElementById('1700887253052388').lastElementChild.innerHTML ;//9 紧急操作与动态测试
       document.getElementById( 'input11').value = document.getElementById('17008872530524c8').lastElementChild.innerHTML ;//11 驱动主机停止装置
       document.getElementById( 'input12').value = document.getElementById('170088725305217c').lastElementChild.innerHTML ;//12鼓式制动器
       document.getElementById( 'input13.1').value = document.getElementById('17026392202310dfa').lastElementChild.innerHTML ;//13盘车（3） 17026392202310dfa
       document.getElementById( 'input13.2').value = document.getElementById('1702639220233e667').lastElementChild.innerHTML ;//13盘车（4）1702639220233e667
       document.getElementById( 'input14.1').value = document.getElementById('1702639220238f5df').lastElementChild.innerHTML ;//14 钢丝绳1
       document.getElementById( 'input14.2').value = document.getElementById('1700709338998a55').lastElementChild.innerHTML ;//14 钢丝绳2
       document.getElementById( 'input15.1').value = document.getElementById('1702640008268ba47').lastElementChild.lastElementChild.innerHTML ;//15 钢带1 1702640008268ba47 17014953212526364
       document.getElementById( 'input15.2').value = document.getElementById('17026400082683fb0').lastElementChild.lastElementChild.innerHTML ;//15 钢带2 17026400082683fb0 1700887671314b16
       document.getElementById( 'input16').value = document.getElementById('1700887671315b62').lastElementChild.innerHTML ;//16 端部固定
       document.getElementById( 'input17').value = document.getElementById('1700887671315781').lastElementChild.innerHTML ;//17 悬挂装置异常伸长
       document.getElementById( 'input18.1').value = document.getElementById('17008876713155fc').lastElementChild.innerHTML ;//18 塑料轮1 span17008876713155fc
       document.getElementById( 'input18.2').value = document.getElementById('1700887671315642').lastElementChild.innerHTML ;// 1700887671315642
       document.getElementById( 'input18.3').value = document.getElementById('17008876713153f8').lastElementChild.innerHTML ;//1702640008268acd4,SPAN17008876713153f8
       document.getElementById( 'input18.4').value = document.getElementById('1700887671315573').lastElementChild.innerHTML ;//18 塑料轮4
       document.getElementById( 'input19').value = document.getElementById('170263999535843a9').lastElementChild.innerHTML ;//19 安全窗 170263999535843a9
       document.getElementById( 'input24.1').value = document.getElementById('17015040141996243').lastElementChild.innerHTML ;//24 门间隙1≤6
       document.getElementById( 'input24.2').value = document.getElementById('1702641013571d39a').lastElementChild.innerHTML ;//24 门间隙1≤30
       document.getElementById( 'input24.3').value = document.getElementById('17007072568871c6').lastElementChild.innerHTML ;//24 门间隙1
       document.getElementById( 'input24.4').value = document.getElementById('1702640903045fe9a').lastElementChild.innerHTML ;//24 门间隙2
       document.getElementById( 'input27').value = document.getElementById('1706319611211eddb').lastElementChild.lastElementChild.innerHTML ;//27 无重锤 170088725305269b 170088725305269b
       document.getElementById( 'input33').value = document.getElementById('1713778561163c9fc').lastElementChild.lastElementChild.innerHTML ;//33 限速器自动复位1713778561163c9fc 170088725305269b
       document.getElementById( 'input37.1').value = document.getElementById('1713594974152179e').lastElementChild.lastElementChild.innerHTML ;//37 意外移动1  TD 1713594974152179e 1713594974152179e SPAN 1700887253052098 1700887253052098
       document.getElementById( 'input37.2').value = document.getElementById('1713594974152ef0e').lastElementChild.lastElementChild.innerHTML ;//37 意外移动2
       document.getElementById( 'input37.3').value = document.getElementById('1702644130870e7e2').lastElementChild.innerHTML ;//37 意外移动3
       document.getElementById( 'input37.4').value = document.getElementById('170264413087205ba').lastElementChild.innerHTML ;//37 意外移动4 */
