...
// @name         Copy title
// @name:zh-CN   畅捷复制页签
// @namespace    https://greasyfork.org/zh-CN/users/1392077-yihan-lee
// @version      1.0.1
// @description  use control + q copy title; option(Mac)/alt(Win) + q copy title and url, create markdown
// @description:zh-CN   control + q 复制页签标题；option(Mac)/alt(Win) + q 复制页签标题及链接，生成 markdown 格式
// @author       Liyihan
// @icon         https://tsz.netlify.app/img/favicon.png
// @match        http*://*/*
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/516066/Copy%20title.user.js
// @updateURL https://update.greasyfork.org/scripts/516066/Copy%20title.meta.js
// ==/UserScript==
