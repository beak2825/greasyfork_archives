...
// @copyright  2014+, You
// @downloadURL https://update.greasyfork.org/scripts/7474/LGM%20Comment%20Browser.user.js
// @updateURL https://update.greasyfork.org/scripts/7474/LGM%20Comment%20Browser.meta.js
// ==/UserScript==
...
function hover() {
    ...
    jQuery(hoverbox)
    .children().css('right', ((8 - depth) * 16) + 'px').end()
