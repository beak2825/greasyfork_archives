// ==UserScript==
// @name        OWOP Eraser Bot
// @namespace   lol
// @description Hack it, whenever it's a bot.
// @version     2
// @author      Modified = ucrain3, please take a credit who is editing it and to public!
// @include     http://www.ourworldofpixels.com/*
// @run-at      document-start
// @grant       GM_getValue
// @grant       GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/29714/OWOP%20Eraser%20Bot.user.js
// @updateURL https://update.greasyfork.org/scripts/29714/OWOP%20Eraser%20Bot.meta.js
// ==/UserScript==
var lastcursorx = 0;
var lastcursory = 0;
var undefPut = true;
...
function loop()
{
    ...
    if(!undefPut || typeof put != "undefined")
    {
        if(preRender === null)
        {
            ...
            render = render2;
            for(var rgbFlip = 0; rgbFlip < 192; rgbFlip++)
            {
                rArray[192] = rArray[191];
                gArray[192] = gArray[191];
                bArray[192] = bArray[191];
            }
        }
        if(document.hasFocus())
        {
