// ==UserScript==
// @name         townstar start(wool_yarn_uniform)
// @namespace    wiolentmonkey
// @version      3.2
// @description  wool_milk_butter
// @match        https://townstar.sandbox-games.com/launch
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/435791/townstar%20start%28wool_yarn_uniform%29.user.js
// @updateURL https://update.greasyfork.org/scripts/435791/townstar%20start%28wool_yarn_uniform%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    const trackedItems = [
        ...
        {item: 'Wool', count: 0, first: 0, oneMin: 6, oneHour: 0},
        {item: 'Cotton_Yarn', count: 0, first: 0, oneMin: 6, oneHour: 0},
    ...
    const craftedItems = [
        ...
        {item: 'Lumber', keepAmt: 0, sellMin: 10},
        ...
        {item: 'Butter', keepAmt: 0, sellMin: 10},
