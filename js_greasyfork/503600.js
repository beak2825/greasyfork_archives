// ==UserScript==
// @name         pixels apiary not drink
// @namespace    https://play.pixels.xyz
// @version      0.1
// @description  非vip蜂蜜不喝酒
// @author       JackerYoung
// @include      http://*
// @include      https://*
// @grant        GM_addElement
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/503600/pixels%20apiary%20not%20drink.user.js
// @updateURL https://update.greasyfork.org/scripts/503600/pixels%20apiary%20not%20drink.meta.js
// ==/UserScript==
                    ...
                    while (room){
                        ...
                        if(state.id.includes("terravilla")){
                            ...
                            if (queenbee<4&&cur_coins>1000){
                                ...
                                Array.prototype.push.apply(map_list, apiary_map);

                            }
                            if(apiary_bool){
                                unsafeWindow.alert("已经跑完一轮蜂蜜")
                            }else{
                                await sleep(2000)
                                if(map_list.length>0){
                                    const mapid = map_list.shift()
