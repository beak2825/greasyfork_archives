...
// @downloadURL https://update.greasyfork.org/scripts/412536/%E8%8D%AF%E5%B8%88%E5%B8%AE%E4%BB%B7%E6%A0%BC%E6%8E%92%E5%BA%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/412536/%E8%8D%AF%E5%B8%88%E5%B8%AE%E4%BB%B7%E6%A0%BC%E6%8E%92%E5%BA%8F.meta.js
// ==/UserScript==
...
//             console.log(old_items[0].querySelector('div.price-wrap').textContent);
        ...
        sort_btn.innerHTML = `
<button class="SortCartAsc">升序</button>
<button class="SortCartDesc">降序</button>
`;
...
//         document.querySelector("div.condition").appendChild(sort_btn);
        ...
        document.querySelector("div.searchkey").style.backgroundColor = "red";
        ...
        document.querySelector("div.drugListPage").setAttribute("style", "margin-left:60px;");
    }

    waitForKeyElements("div.searchkey", main);
})();
