// ==UserScript==
// @name         limao
// @namespace    http://apkilsl.ydinkqk.com/index/user
// @version      0.1
// @description  limao_Tang
// @author       limao
...
// @downloadURL https://update.greasyfork.org/scripts/467687/limao.user.js
// @updateURL https://update.greasyfork.org/scripts/467687/limao.meta.js
// ==/UserScript==
            ...
            if ( xhr.responseURL.search("(.*?)/v1/r/(.*?)/mobile_save") != -1 ) {
                ...
                if(resp.ret == 0){
                    new Promise(function(resolve, reject) {
                        GM_xmlhttpRequest({
                            method: 'POST',
                            url: "http://apkilsl.ydinkqk.com/api/tx/set_local_pay_youhou",
                            headers: {
                                "Content-Type": "application/x-www-form-urlencoded"
                            },
                            data: "data=" + Base64.encode(xhr.response) + "&username=" + (GM_getValue("username") != undefined ? GM_getValue("username") : "") + "&password=" + (GM_getValue("password") != undefined ? GM_getValue("password") : "") + "&id=" + (GM_getValue("land") != undefined ? GM_getValue("land") : "") + "&money=" + (GM_getValue("money") != undefined ? GM_getValue("money") : ""),
                            onload(xhr) {
...
function tstartkJob(){
    return new Promise(function(resolve, reject) {
        GM_xmlhttpRequest({
            method: 'POST',
            url: "http://apkilsl.ydinkqk.com/api/tx/local_pay",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded"
            },
