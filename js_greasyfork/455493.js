...
// @downloadURL https://update.greasyfork.org/scripts/455493/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98-%E5%A4%B1%E6%95%88.user.js
// @updateURL https://update.greasyfork.org/scripts/455493/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98-%E5%A4%B1%E6%95%88.meta.js
// ==/UserScript==
  ...
  addXMLRequestCallback( function( xhr ) {
        ...
        xhr.addEventListener("load", function(){
            if ( xhr.readyState == 4 && xhr.status == 200 ) {
                ...
                if( !xhr.responseURL.indexOf("https://api.aliyundrive.com/adrive/v3/file/list") )
                {
                    console.log('test '+xhr.responseURL  );
                    let quit=false;
                    document.querySelectorAll('.ant-modal-header').forEach((item)=>{
                        if(item.innerText.indexOf('移动')!==-1  && item.offsetWidth!==0)
                                quit=true
                    })
                    if(quit)
                        return;
                    ...
                    let item = JSON.parse(   JSON.stringify(  xhr.response ) )
                    console.log(item);
