...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/541439/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%D0%97%D0%93%D0%A1%D0%A4%D0%93%D0%A1%D0%A4%20%7C%7C%20Blue.user.js
// @updateURL https://update.greasyfork.org/scripts/541439/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%D0%97%D0%93%D0%A1%D0%A4%D0%93%D0%A1%D0%A4%20%7C%7C%20Blue.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
title: '| Одобрено |',
	  content:
                 "[HEADING=2][CENTER][FONT=arial][B][COLOR=#CCCCCC] {{ greeting }}, уважаемый {{ user.name }} [/COLOR][/B][/CENTER][/HEADING]"+
...
},
{
	  ...
	  content:
                 "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
                 "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
                 "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение - [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], возврат средств возможен только при инициативе самого обманщика, если у него будет желание получить разблокировку аккаунта, он свяжется с Вами и в конечном итоге вы должны будете сойтись в компенсации, потом составляется обжалование от лица обманщика, предварительно Вы пишите ему на ФА условия компенсации.[/COLOR][COLOR=rgb(255, 255, 255)][/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
                 "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
                 "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
	  status: false,
},
...
title: '| Док-ва в вертикальном формате |',
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение - [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], так как доказательства в вертикальном формате не подлежат рассмотрению.[/COLOR][COLOR=rgb(255, 255, 255)][/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
},
{
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], доказательства загруженные в соц. сетях, не подлежат рассмотрению. Для загрузки фото можно воспользоваться: Imgur, Япикс, Postimages. Для видео: YouTube, RuTube, ВК Видео. [/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
title: '| Не относится к Жалобам на игроков (Добавить в какой раздел игроку обратиться) |',
	  content:
                 "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
                 "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
                 "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], так как оно не относится к нашему разделу.[/COLOR][COLOR=rgb(255, 255, 255)].[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
                 "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
                 "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
title: '| 10 дней после срока долга|',
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], так как прошло более 10 дней после указанного срока возврата.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
...
title: '| Слив склада семьи (Что требуется показать игроку) |',
	  content:
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] Добрый день, уважаемый [B]Marko_Vesovic[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение [I][COLOR=#8A2BE2]отказано[/COLOR][/I][COLOR=#FFFFFF], так как оно составлено не по правилам. Предоставьте Фрапс следующим образом: [/COLOR][/COLOR][/SIZE][/B][/CENTER][/HEADING]"+
      "[HEADING=2][LIST]"+
...
title: '|Time коды не по форме|',
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], так как тайм-коды не по форме. Они должны выглядеть следующим образом:[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/85JcBMxJ/ZQ5h-HFi-Rs-2-OFvw05pe-Yw-PUTS2-Qt-Zpsend2nl-AU7-V57ik-RMP0-FYuzok-Nk-Xr-Et22im-Gi-DR6e-Fr-P9-FQK5b-Sx-XZu-jpg.jpg[/img][/url][/CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
},
{
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], так как для фиксации данного нарушения необходим видеоролик.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
title: '| Оскорбление в IC |',
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], так как оскорбления в IC (RolePlay) чате не наказуемы.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
title: '| Неадекватное поведение в жалобе |',
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваше обращение [I][COLOR=#8A2BE2]отказано[/I][/COLOR][COLOR=#FFFFFF], так как в жалобе присутствует неадекватное поведение.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
      prefix: UNACCСEPT_PREFIX,
	  status: false,
...
},
{
...
},
  {
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваша биография [I][COLOR=#8A2BE2]отказана[/I][/COLOR][COLOR=#FFFFFF], так как биография составлена не по форме.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
},
  {
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваша биография [I][COLOR=#8A2BE2]отказана[/I][/COLOR][COLOR=#FFFFFF], так как недостаточно RolePlay информации о Вашем персонаже. Добавьте больше информации в пункты: Жизнь в детстве и юности, Взрослая жизнь.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
...
},
  {
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваша биография [I][COLOR=#8A2BE2]отказана[/I][/COLOR][COLOR=#FFFFFF], так как повествование в ней ведется от 3-го лица.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
...
},
  {
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваша биография [I][COLOR=#8A2BE2]отказана[/I][/COLOR][COLOR=#FFFFFF], так как возраст не соответствует минимальному. Минимальный возраст для персонажа в RP Биографии – 18 Лет.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
...
title: '| Био отказ (Возраст велик) |',
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваша биография [I][COLOR=#8A2BE2]отказана[/I][/COLOR][COLOR=#FFFFFF], так как указанный возраст превышает максимальный. Максимальный возраст для персонажа в RP Биографии – 65 Лет.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
...
title: '| Био отказ (Ошибки) |',
      ...
      "[CENTER][URL='https://postimages.org/'][IMG]https://i.postimg.cc/X7NHmW8Y/image.gif[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER][B][COLOR=rgb(255, 255, 255)] {{ greeting }}, уважаемый [B]{{ user.name }}[/B][/COLOR][/B][/CENTER][/HEADING]"+
      "[HEADING=2][CENTER][B][SIZE=4][COLOR=rgb(255, 255, 255)] Ваша биография [I][COLOR=#8A2BE2]отказана[/I][/COLOR][COLOR=#FFFFFF], так как обнаружено много грамматических ошибок.[/COLOR][/SIZE][/B][/CENTER][/HEADING][CENTER]"+
      "[URL='https://postimg.cc/XpswHptJ'][IMG]https://i.postimg.cc/T36CPb9r/image-1.png[/IMG][/URL][/CENTER]"+
      "[HEADING=2][CENTER]Приятного времяпровождения на Black Russia![/CENTER][/HEADING]",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
