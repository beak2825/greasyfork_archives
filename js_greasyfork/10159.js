...
// @version     0.2
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/10159/TiebaOldUserCard.user.js
// @updateURL https://update.greasyfork.org/scripts/10159/TiebaOldUserCard.meta.js
// ==/UserScript==

(function(){
	if(location.host == 'www.baidu.com'){
		addEventListener('message', function(e){
			if(e.data.name == 'tiebaOldUserCard' && e.data.user){
			...
			iframe.contentWindow.addEventListener('DOMContentLoaded', function(){
				...
				addEventListener('message', function(e){
					if(e.data.name == 'tiebaOldUserCard' && e.data.msgId == msgId && e.data.uk){
						removeEventListener('message', arguments.callee, false);
