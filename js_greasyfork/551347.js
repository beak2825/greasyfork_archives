...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/551347/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%D0%9C%D0%B5%D0%BD%D1%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/551347/%D0%A1%D0%BF%D0%B5%D1%86%20%D0%B7%D0%B0%D0%BA%D0%B0%D0%B7%20%D0%B4%D0%BB%D1%8F%20%D0%9C%D0%B5%D0%BD%D1%8F.meta.js
// ==/UserScript==
...
const buttons = [
     {
      ...
      dpstyle: 'oswald: 3px;  color: #00FFFF; background: #FF0000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #FFA500',
      },
    {
    ...
    },
   {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url]<br>[/CENTER]' +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Ответ на ваше обращение был дан в [URL='https://forum.blackrussia.online/threads/Взлом-аккаунта.13474164/']прошлой теме[/URL] (кликабельно).[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Если вы хотите разблокировать ваш аккаукт, то обратитесь в технический раздел вашего сервера.<br><br>[/COLOR][/CENTER][/B]`+
    ...
    },
    {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]<br>' +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Ваш аккаунт был взломан.[/COLOR][/CENTER][/B]<br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Злоумышленник перевел все имущество и игровую валюту на другой аккаунт.[/COLOR][/CENTER][/B]<br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Затем от вашего аккаунта поступали сообщения: "продаю верты 1кк 40руб тг *******".[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Данные действия были приняты за продажу игровой валюты.[/COLOR][/CENTER][/B]<br><br>`+
    ...
    },
    {
      ...
      content:
        ...
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Посмотреть ответ вы можете в [URL='https://forum.blackrussia.online/threads/Обжалование-игрока-kirill_dianon.13605754/']прошлой теме[/URL] (кликабельно).[/COLOR][/CENTER][/B]<br><br>` +
    ...
    },
   {
    ...
    },
    {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]<br>' +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Мы не имеем возможности переносить имущество на другой аккаунт.[/COLOR][/CENTER][/B]<br><br>` +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR].[/CENTER][/B]<br>`+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]',
      prefix: ZAKRUTO_PREFIX,
      status: false,
    },
   {
    ...
    },
    {
      ...
      content:
        ...
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Ваше обращение никак не связано с жалобами на технических специалистов.[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Переношу вашу тему в раздел жалоб на игроков сервера LIME.[/COLOR][/CENTER][/B]<br>`+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]',
      prefix: OJIDANIE_PREFIX,
      status: false,
    },
    {
      title: ' Напишите в обжалования наказаний 07',
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]<br>' +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Ваше наказание было выдано не техническим специалистом.[/COLOR][/CENTER][/B]<br>` +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Пожалуйста, обратитесь в раздел [URL='https://forum.blackrussia.online/forums/Обжалование-наказаний.353/']обжалование наказаний[/URL].[/COLOR][/CENTER][/B]<br><br>` +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR].[/CENTER][/B]<br>`+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]',
      prefix: ZAKRUTO_PREFIX,
      status: false,
    ...
    {
      title: ' Напишите в жб на админа 07',
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]<br>' +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Ваше наказание выдано не техническим специалистом.[/COLOR][/CENTER][/B]<br>` +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Пожалуйста, обратитесь в раздел [URL='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.350/']жалобы на администрацию[/URL].[/COLOR][/CENTER][/B]<br><br>` +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=rgb(255, 0, 0)]Закрыто[/COLOR].[/CENTER][/B]<br>`+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]',
      prefix: ZAKRUTO_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]<br>' +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]13 09 2025 года в 21:49 вы сняли со своего банковского счета 11 000 000 ИВ. [/COLOR][/CENTER][/B]<br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Также, данные действия были сделанны всего через 7 минут, после того как пришла игровая валюта на счет.[/COLOR][/CENTER][/B]<br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]При этом, было доказано, что аккаунт Oleg_Merrichev, который переводил вам ИВ, является ботом, который продает игровую валюту.[/COLOR][/CENTER][/B]<br>`+
    ...
    },
    {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]<br>' +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]13 09 2025 года в 23:00 вы сняли со своего банковского счета №459827 сумму - 576 000 ИВ.[/COLOR][/CENTER][/B]<br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Также, данные действия были сделанны всего через 2 минуты, после того как пришла игровая валюта на счет.[/COLOR][/CENTER][/B]<br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]При этом, было доказано, что аккаунт Jerry_Makiattos, который переводил вам ИВ, является ботом, который продает игровую валюту.[/COLOR][/CENTER][/B]<br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Данные действия были приняты за покупку игровой валюты у аккаунта Jerry_Makiattos c помощью банковской системы, что нарушает пункт правил 2.28.[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с пунктом правил 2.28.[/COLOR][/CENTER][/B]<br><br>`+
    ...
    //  `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender] [/COLOR][/CENTER][/B]<br><br>`+
    ...
    },
     {
      ...
      content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/J0kFRJ26/IMG-6163.png[/img][/url][/CENTER]<br>' +
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=#FF4500]${greeting}, уважаемый(ая) ${user.mention}[/COLOR][/CENTER][/B]<br><br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]10 09 2025 года в 13:06 вы получали от аккаунта Artem_Scala (затем смнил ник на Artem_IlIl) 65 000 000 ИВ через трейд.[/COLOR][/CENTER][/B]<br>`+
        `[FONT=georgia][SIZE=5][B][CENTER][COLOR=lavender]При этом, в данный момент аккаунт Artem_Scala был взломан.[/COLOR][/CENTER][/B]<br>`+
