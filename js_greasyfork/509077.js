// ==UserScript==
// @name         Blooket Hacks for phone
// @description  Bl00ket Hacks for ph0ne
// @match        *://*.blooket.com/*
// @match        *://blooket.com/*
...
// @downloadURL https://update.greasyfork.org/scripts/509077/Blooket%20Hacks%20for%20phone.user.js
// @updateURL https://update.greasyfork.org/scripts/509077/Blooket%20Hacks%20for%20phone.meta.js
// ==/UserScript==
...
.cheat:hover {
    ...
    let autoAnswer = false, highlightAnswers = true, choiceESP = true, autoPassword = true, chestESP = true, changePass = false;
    let passes = ["@poly_08", "NeHemIaS_009", "Z10N0101", "uncommonCommoner56", "Tax@Toucan@INC", "player2", "player", "iHaveStripes324", "spikey@Spikes", "baseball972", "CatLover90", "agent007", "i_dont_know_dude", "x_CoolGamer_x", "JCGCS", "eggsToast&Bacon-pls", "noPasswordHere", "living-on-the-edge", "unicorn345", "Woof333", "rabbts332", "stopLookingAtMe", "RobotLeader325", "redBird32"];
    ...
    loop = setInterval(() => {
        ...
        if (curPage == "crypto" && autoPassword) {
            ...
            if(changePass && stage != "intro"){
                reactHandler().stateNode.state.password = passes[Math.floor(Math.random()*24)]; //change 24(length) to any number after editing passes list
            }
        }
