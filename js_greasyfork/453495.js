...
// @downloadURL https://update.greasyfork.org/scripts/453495/fasterNODOS2.user.js
// @updateURL https://update.greasyfork.org/scripts/453495/fasterNODOS2.meta.js
// ==/UserScript==
...
(function() {
 ...
 if( window.location.pathname === "/index.cgi"){ //
     $('.foottext').append(' - Script fasterNodos2 V 0.1 (21/10/22) - Leo Demartin');
       ...
       //Primer td a th
        ...
        for (var i=1; i<cantidad; i++){ //Recorro las nuevas celdas
            ...
            if (nodos[mac]){//Si la mac es de un AP de FASTER
                ...
                var row_nf = document.getElementById('survey').rows[i];
                document.getElementById('survey').deleteRow(i);
            }
        }//fin for
