...
// @name:ru Script by МгЕ Johnn_Watson ❄️
...
// @include    https://forum-limerussia.hgweb.ru/index.php
// @grant        none
// @license   none
// @supportURL vk.com/kkuk7 | Johnn_Watson | ROSTOV
// @description Скрипт для кураторов сервера ROSTOV
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/542223/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20ROSTOV%2029.user.js
// @updateURL https://update.greasyfork.org/scripts/542223/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D0%A4%20ROSTOV%2029.meta.js
// ==/UserScript==
...
const buttons = [

    {
      ...
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
    ...
    },
     {
      ...
      content:
        ...
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Приветствую.[/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][FONT=georgia][I][B]В вашей жалобе указан не приправильный никнейм нарушителя .[/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][B][COLOR=rgb(252, 94, 3)][SIZE=5][FONT=times new roman] ☯ На рассмотрении ☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: PINN_PREFIX,
      status: true,
    },
     {
      title: 'Условия сделки не корректные',
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Приветствую.[/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][FONT=georgia][I][B]Ваши условия сделаки составлены некорректно.[/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][B][COLOR=rgb(209, 21, 0)][SIZE=6][FONT=times new roman] ☯ Отказано,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: CLOSE_PREFIX,
      status: false,
    },
{
      ...
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Приветствую.[/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][FONT=georgia][I][B]Доказательства размещенные в соц. сетях рассмотрению не подлежат.[/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][B][COLOR=rgb(209, 21, 0)][SIZE=6][FONT=times new roman] ☯ Отказано,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: CLOSE_PREFIX,
      status: false,
    },
    {
      ...
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        ...
        "[CENTER][B][COLOR=rgb(0, 224, 11)][SIZE=6][FONT=times new roman] ☯ Одобрено,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ODOBRENOBIO_PREFIX,
      status: true,
    },
     {
      title: 'Ошибка разделом, перенос',
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Приветствую.[/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][FONT=georgia][I][B]К сожалению, Вы ошиблись разделом., переношу вашу тему в нужный раздел.[/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][B][COLOR=rgb(252, 94, 3)][SIZE=5][FONT=times new roman] ☯ На рассмотрении ☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: PINN_PREFIX,
      status: true,
    },
    ...
    {
      title: 'Не предоставлены таймкоды',
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
         '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
 ...
 {
      title: 'Не правильные условия',
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Указанные условия вами - не корректны.[/CENTER]<br><br>" +
       "[CENTER][B][COLOR=rgb(209, 21, 0)][SIZE=6][FONT=times new roman] ☯ Отказано,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: CLOSE_PREFIX,
      status: false,
    },
 {
      title: 'Больше 1 нарушителя',
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
         '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]В вашей жалобе присутствуют нарушения нескольких игроков. Необходимо оформить жалобу на каждого игрока по отдельности .[/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(209, 21, 0)][SIZE=6][FONT=times new roman] ☯ Отказано,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: CLOSE_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Данное нарушение не может быть подтверждено через определенные ресурсы .[/CENTER]<br><br>" +
       "[CENTER][B][COLOR=rgb(209, 21, 0)][SIZE=6][FONT=times new roman] ☯ Отказано,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: CLOSE_PREFIX,
      status: false,
    },
    ...
    },
    {
      ...
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]К сожалению, Вы ошиблись сервером. Данный раздел принадлежит серверу CHITA.[/CENTER]<br><br>" +
         "[CENTER][B][COLOR=rgb(209, 21, 0)][SIZE=6][FONT=times new roman] ☯ Отказано,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: CLOSE_PREFIX,
      status: false,
    },
    ...
    },
    {
     ...
     {
      title: 'NRP полицейский',
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
         '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]7.02.[/color] Запрещено выдавать розыск, штраф, отбирать В/У без Role Play причины [COLOR=rgb(255, 0, 0)] | Warn [/COLOR][/QUOTE][/CENTER]<br><br>" +
      "[CENTER][B][COLOR=rgb(0, 224, 11)][SIZE=6][FONT=times new roman] ☯ Одобрено,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    ...
    },
     {
      ...
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по пункту правил[/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=rgb(255, 0, 0)]2.18.[/color] Запрещено редактировать поданные объявления в личных целях заменяя текст объявления на несоответствующий отправленному игроком [COLOR=rgb(255, 0, 0)] |Ban 7 дней + ЧС организации[/COLOR][/QUOTE][/CENTER]<br><br>" +
       "[CENTER][B][COLOR=rgb(0, 224, 11)][SIZE=6][FONT=times new roman] ☯ Одобрено,Закрыто.☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
	...
	},
{
    ...
    },
    {
      ...
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
        '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
         "[CENTER][FONT=georgia][I][B]Ваша РП биография получает статус: На расмотрении [/FONT][/I][/B][/CENTER]<br><br> " +
        "[CENTER][B][COLOR=rgb(252, 94, 3)][SIZE=5][FONT=times new roman] ☯ На рассмотрении ☯ [/FONT][/SIZE][/COLOR][/B][/CENTER]",
      prefix: ODOBRENOBIO_PREFIX,
      status: false,
    },
    ...
    {
      title: 'Не читабельна БИО',
      content:
         "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
       '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
        "Ваша биография не читабельная.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
      title: 'Пропущены пробелы возле знаков',
      content:
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/9MBQ9sft/image.png[/img][/url][/CENTER]<br>" +
       '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
        "В вашей РП биографии пропущены пробелы возле знаков: ; : - .[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
    {
    ...
    },
 {
      ...
      content:
         ...
         '[Color=rgb(0, 196, 131)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br><br>" +
        "Причина: Мало информации о вашем персонаже, дополните еще информации.[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
      status: false,
    },
     {
    ...
    },
{
 ...
 $(document).ready(() => {
    ...
    addButton('by Johnn_Watson🐻', 'selectAnswer');
