// ==UserScript==
// @name         SonicHackingContest Navbar Scroll (test1)
...
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/434000/SonicHackingContest%20Navbar%20Scroll%20%28test1%29.user.js
// @updateURL https://update.greasyfork.org/scripts/434000/SonicHackingContest%20Navbar%20Scroll%20%28test1%29.meta.js
// ==/UserScript==
...
.bg-shc-blaze {
  background-color: var(--shc-blaze, #6848ae) !important;
}
.border-shc-blaze {
  border-color: var(--shc-blaze, #6848ae) !important;
}
.bg-shc-blaze-light {
...
.btn-shc-blaze:not(.btn-shc-grey) {
  color: #fff;
  background-color: var(--shc-blaze, #6848ae);
  border-color: var(--shc-blaze, #6848ae);
}
...
.bg-shc-blaze + .shc-entry-body {
  box-shadow: 0 4px 0 #c797e8 inset;
}
.shc-entry-body .bg-shc-blaze.shc-entry-banner {
  box-shadow: 0 4px 0 #c797e8;
}
...
.bg-shc-shadow-light a {
  color: #03a9f4;
}
.bg-shc-shadow-light a:hover {
  color: #00709f;
}
...
.bg-shc-shadow-light .shc-comment-body {
  ...
  border-bottom-color: #323838 !important;
}
