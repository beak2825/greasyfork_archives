...
// @name:fa      یوتیوب - مسدود کردن پیش‌نمایش خودکار تصویر بندانگشتی و تریلر کانال
...
// @description:bn      ইউটিউব থাম্বনেল হোভার প্রিভিউ (WebP এবং ভিডিও) ব্লক করে এবং চ্যানেল ট্রেলার (ভিডিও + অডিও) বন্ধ করে। প্রোগ্রেস বার, প্লে বোতাম এবং স্থির ছবি রাখে। সব পৃষ্ঠায় কাজ করে, লগইন বা অনুমতি ছাড়া, পৃষ্ঠা লোড হওয়ার সাথে সাথে চলে এবং ডকুমেন্ট-স্টার্টে রান করে।
...
// @description:eu      Blokeatu thumbnail hover aurrebista (WebP eta bideoa) eta gelditu kanalaren trailerra (bideoa + audioa). Mantentzen ditu aurrerapen-barrak, erreproduzitzeko botoiak eta irudi estatikoak. Saioa hasi gabe eta baimenik gabe, orria kargatzean exekutatzen da.
// @description:fa      پیش‌نمایش خودکار تصویر بندانگشتی هنگام هاور (WebP و ویدیو) و تریلر کانال‌ها (ویدیو + صدا) را مسدود می‌کند. نوار پیشرفت، دکمه‌های پخش و تصاویر ثابت را حفظ می‌کند. در تمام صفحات کار می‌کند، نیازی به ورود یا مجوز نیست و در زمان بارگذاری صفحه اجرا می‌شود.
...
// @description:ta      யூடியூபில் தம்ப்னெயில் ஹோவர் முன்னோட்டங்களை (WebP & வீடியோ) தடைசெய்து, சேனல் டிரெய்லர்களை (வீடியோ + ஆடியோ) நிறுத்துகிறது. முன்னேற்றப் பட்டைகள், பிளே பட்டன்கள் மற்றும் நிலையான படங்களை வைத்திருக்கும். அனைத்து பக்கங்களிலும் வேலை செய்யும், உள்நுழைவு அல்லது அனுமதி தேவையில்லை, பக்கம் ஏற்றும்போது இயங்கும்.
...
// @description:ur      یوٹیوب تھمب نیل ہوور پر پیش نظارہ (WebP اور ویڈیو) کو بلاک کرتا ہے اور چینل ٹریلر (ویڈیو + آڈیو) کو روکتا ہے۔ پروگریس بار، پلے بٹن اور سٹیٹک تصاویر کو برقرار رکھتا ہے۔ تمام صفحات پر کام کرتا ہے، لاگ ان یا اجازت کی ضرورت نہیں، صفحہ لوڈ ہوتے ہی چلتا ہے۔
