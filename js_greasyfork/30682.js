...
// @grant        none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/30682/DRAx.user.js
// @updateURL https://update.greasyfork.org/scripts/30682/DRAx.meta.js
// ==/UserScript==
...
document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> <span style='color: #FDC944'><b><font size='4'><u>Instrukcja Gry :</u></font></b></span> </span></span></center><br></br>";
...
document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_d'> <span style='color: #5b7ace'><b><u>Prawoklik</u></b></b> Aby wykonać <b>Full Split (x8)<b></span></span></center>";
    document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> <span style='color: #686CEE'><b><font size='4'><u></u></font></b></span> </span></span></center><br></br>";
    document.getElementById("footer").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_d'> <span style='color: #f60101'><b>Poza tym, możesz grać normalnie. Nawet mając włączony skrypt, możesz używać zwykłej klawiszologii.</b></span></span></center>";
