...
// @version      1.2
// @description  宁夏大学（网络教育）全自动在线挂机学习
// @author       jiaming
...
// @grant        unsafeWindow
// @match        *://student.nxu.com/console/main.html*
// @match        *://student.nxu.com/console/apply/student/student_learn.jsp*
// @match        *://learning.nxu.com/learning*
// @match        *://ispace.nxu.com/ispace2_sync/scormplayer/index_sco.jsp*
// @match        *://ispace.nxu.com/ispace2_upload/scormplayer/index_sco.jsp*
// @match        *://ispace.nxu.com/ispace2_upload/*/ch_index.html*
...
// 版本: v1.2
// ****************************************************************************************
// @downloadURL https://update.greasyfork.org/scripts/461142/%E5%AE%81%E5%A4%8F%E5%A4%A7%E5%AD%A6%E6%8C%82%E6%9C%BA%E5%AE%9D.user.js
// @updateURL https://update.greasyfork.org/scripts/461142/%E5%AE%81%E5%A4%8F%E5%A4%A7%E5%AD%A6%E6%8C%82%E6%9C%BA%E5%AE%9D.meta.js
// ==/UserScript==
...
function studentLogin(){
    $.ajax({
        url:"https://student.nxu.com/console/user_info.jsp?" +  Math.random(),
        dataType: "json",
...
function studentLearn(){
    ...
    $.ajax({
        url: "https://student.nxu.com/rs/loginCheck/learning?" + Math.random(),
        type: "POST",
        data: {
...
function openOtherInfo(){
    layer.open({
        ...
        offset: 'rb',
        shade :0,
        content: '<div style="padding: 10px;">不要相信这里显示内容，否则后果自负' +
