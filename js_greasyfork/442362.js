...
// @downloadURL https://update.greasyfork.org/scripts/442362/SKRIPT%20%7C%20for%20GOLD.user.js
// @updateURL https://update.greasyfork.org/scripts/442362/SKRIPT%20%7C%20for%20GOLD.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить нарушение правил составления RP биографий, внимательно ознакомьтесь с ними.[/CENTER][/FONT]",
    ...
    },
    {
      ...
      content:
		'[Color=Cyan][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП ситуация получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить, нарушение правил составления RP ситуаций, внимательно ознакомьтесь с ними.[/CENTER][/FONT]",
