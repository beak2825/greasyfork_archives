...
// @icon https://www.casa-olarului.com/wp-content/uploads/biginv.ico
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/32027/TW%20Big%20Inventory.user.js
// @updateURL https://update.greasyfork.org/scripts/32027/TW%20Big%20Inventory.meta.js
// ==/UserScript==
(function(fn) {
    ...
    $("<link href='https://www.casa-olarului.com/wp-content/uploads/1/inv.css' rel='stylesheet' type='text/css'>").appendTo("head");
    var langs;
    langs = {
        it_IT: {
		...
		es_SP: {
            lang_select: 'Idioma seleccionado',
            language: 'Español',
            ApiGui: 'Este script aumenta el espacio en el inventario.',
            contact: 'Contacto',
            title: 'Gran Inventario',
            update: 'Actualizar',
            updateAvailable: 'Nueva versión del script está disponible.',
            name: 'Gran Inventario',
            msgme: 'Mensaje en el juego',
            mailme: 'Enviarme un correo electrónico',
            Doppioni : {
                tip : 'Mostrar solo duplicados',
                upgradeable:'Actualizables',
                noset : 'Sin artículos de conjunto',
                sellable : 'Vendibles',
                auctionable : 'Subastables',
                tipuse : 'Mostrar solo los utilizables',
                tiprecipe : 'Mostrar solo recetas',
                tipsets : 'Mostrar solo artículos de conjunto',
                tutteOpz : 'Todo',
            }
        },
        ru_RU: {
            ...
            addCheckBoxBag: function (div) {
                if ($('#bagFilterIsCollect', Inventory.DOM).length === 0) {
                    ...
                    var duplicat = $("<span title='" + MPlang.Doppioni.tip + "' id='inventory_doublons'"
                        ...
                        + '" style="cursor: pointer; position: relative; background: url(https://www.casa-olarului.com/wp-content/uploads/1/small.png) no-repeat; background-position: -2px 0;" />'
                        + "</span>");
                    ...
                    var utilizz = $('<span title="'
                        ...
                        + '" style="cursor: pointer; position: relative; background: url(https://www.casa-olarului.com/wp-content/uploads/1/small.png) no-repeat; background-position: -45px 0;">'
                        + "</span>");
                    ...
                    var ricetta = $('<span title="'
                        ...
                        + '" style="position: relative; background: url(https://www.casa-olarului.com/wp-content/uploads/1/small.png) no-repeat; cursor: pointer; background-position: -88px 0;" >'
                        + '</span>');
                    ...
                    var naboru = $('<span title="'
                        ...
                        + '" style="cursor: pointer; position: relative; background: url(https://www.casa-olarului.com/wp-content/uploads/1/small.png) no-repeat; background-position: -131px 0;" >'
                        + "</span>");
