...
// @downloadURL https://update.greasyfork.org/scripts/440619/%E6%8A%96%E9%9F%B3%E5%B7%A5%E5%85%B7.user.js
// @updateURL https://update.greasyfork.org/scripts/440619/%E6%8A%96%E9%9F%B3%E5%B7%A5%E5%85%B7.meta.js
// ==/UserScript==
...
(function() {
    ...
    *{
    ...
    .record-phone,.tab-phone{
        width: 20%;
    }
    .record-wechat,.tab-wechat{
        width: 20%;
    }
    .record-qq,.tab-qq{
        width: 20%;
    }
    .record-total,.tab-total{
        width: 10%;
    }
    .data-box{
        width: 600px;
    ...
    let div = `<div class="login">
        ...
        <div class="login-tel">
            <span>手机号：</span>
            <input type="tel" placeholder="请输入你的手机号" name="phone" id="phone" autocomplete="off">
        </div>
        <div class="login-pwd">
            <span>密码：</span>
        ...
        <div class="cy-tool">灿耀易客浏览器工具1.0.0</div>
    </div>
    <div class="mask">
        <div class="mask-form">
            ...
            <div class="form-enter">
                <div>
                    <div class="form-list">
                        <span>手机：</span>
                        <input class="tel" type="tel" placeholder="请输入手机号" name="tel" autocomplete="off" maxlength="11">
                        <div class="form-add">
                            <svg t="1645166902470" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1893" width="32" height="32"><path d="M512 936.915619c-234.672764 0-424.915619-190.243879-424.915619-424.915619S277.327236 87.083357 512 87.083357c234.676857 0 424.916643 190.243879 424.916643 424.915619S746.676857 936.915619 512 936.915619zM724.45781 469.50414 554.491767 469.50414 554.491767 299.546284l-84.983533 0 0 169.957857L299.54219 469.50414l0 84.99172 169.966043 0 0 169.966043 84.983533 0L554.491767 554.49586l169.966043 0L724.45781 469.50414z" p-id="1894"></path></svg>
                        </div>
                    </div>
                </div>
                <div>
            ...
            <div class="form-bind">
                <label for="bind">绑定：</label>
                <input type="checkbox" name="bind" id="bind">
                <label for="bind">勾选后可绑定该达人</label>
            </div>
            <div class="form-btn">
                <button>提交</button>
            </div>
            <div class="close"><svg t="1645093506233" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2049" width="32" height="32"><path d="M512 128C300.8 128 128 300.8 128 512s172.8 384 384 384 384-172.8 384-384S723.2 128 512 128zM512 832c-179.2 0-320-140.8-320-320s140.8-320 320-320 320 140.8 320 320S691.2 832 512 832z" p-id="2050"></path><path d="M672 352c-12.8-12.8-32-12.8-44.8 0L512 467.2 396.8 352C384 339.2 364.8 339.2 352 352S339.2 384 352 396.8L467.2 512 352 627.2c-12.8 12.8-12.8 32 0 44.8s32 12.8 44.8 0L512 556.8l115.2 115.2c12.8 12.8 32 12.8 44.8 0s12.8-32 0-44.8L556.8 512l115.2-115.2C684.8 384 684.8 364.8 672 352z" p-id="2051"></path></svg></div>
        </div>
    </div>
    <div class="info">
        <div class="info-box">
            <div class="info-title">绑定成功</div>
    ...
    <div class="operate">
        ...
        <div class="operate-box">
            ...
            <div class="operate-btn">
                ...
                <button class="operate-record">更新记录</button>
            </div>
            <div class="cy-tool">灿耀易客浏览器工具1.0.0</div>
        </div>
    </div>
    <div class="record">
        <div class="record-box">
            <div class="record-title">更新记录</div>
            <div class="record-info">
                <table class="record-table" cellspacing="0" cellpadding="0">
                    <thead class="record-tab">
                        <td class="tab-time">时间</td>
                        <td class="tab-phone">手机</td>
                        <td class="tab-wechat">微信</td>
                        <td class="tab-qq">QQ</td>
                        <td class="tab-total">总分值</td>
                    </thead>
                    <tbody class="record-content"></tbody>
                </table>
            </div>
            <div class="record-close"><svg t="1645093506233" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2049" width="32" height="32"><path d="M512 128C300.8 128 128 300.8 128 512s172.8 384 384 384 384-172.8 384-384S723.2 128 512 128zM512 832c-179.2 0-320-140.8-320-320s140.8-320 320-320 320 140.8 320 320S691.2 832 512 832z" p-id="2050"></path><path d="M672 352c-12.8-12.8-32-12.8-44.8 0L512 467.2 396.8 352C384 339.2 364.8 339.2 352 352S339.2 384 352 396.8L467.2 512 352 627.2c-12.8 12.8-12.8 32 0 44.8s32 12.8 44.8 0L512 556.8l115.2 115.2c12.8 12.8 32 12.8 44.8 0s12.8-32 0-44.8L556.8 512l115.2-115.2C684.8 384 684.8 364.8 672 352z" p-id="2051"></path></svg></div>
        </div>
    </div>
    <div class="data">
        <div class="data-box">
            ...
            <div class="data-content">
                ...
                <div class="data-select" id="cate0">
                    <div class="select-title">分类选择</div>
                    <div class="select-content">
                        <div class="select-list"><select id="talent"></select></div>
                        <div class="select-list"><select id="skill"></select></div>
                    </div>
                </div>
                <div class="data-select" id="cate1">
                    <div class="select-title">分类选择</div>
                    <div class="select-content">
                        <div class="select-list"><select id="talent1"></select></div>
                        <div class="select-list"><select id="skill1"></select></div>
                    </div>
                </div>
                <div class="data-select" id="cate2">
                    <div class="select-title">分类选择</div>
                    <div class="select-content">
                        <div class="select-list"><select id="talent2"></select></div>
                        <div class="select-list"><select id="skill2"></select></div>
                    </div>
                </div>
            ...
            <div class="data-close"><svg t="1645093506233" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2049" width="32" height="32"><path d="M512 128C300.8 128 128 300.8 128 512s172.8 384 384 384 384-172.8 384-384S723.2 128 512 128zM512 832c-179.2 0-320-140.8-320-320s140.8-320 320-320 320 140.8 320 320S691.2 832 512 832z" p-id="2050"></path><path d="M672 352c-12.8-12.8-32-12.8-44.8 0L512 467.2 396.8 352C384 339.2 364.8 339.2 352 352S339.2 384 352 396.8L467.2 512 352 627.2c-12.8 12.8-12.8 32 0 44.8s32 12.8 44.8 0L512 556.8l115.2 115.2c12.8 12.8 32 12.8 44.8 0s12.8-32 0-44.8L556.8 512l115.2-115.2C684.8 384 684.8 364.8 672 352z" p-id="2051"></path></svg></div>
        </div>
    </div>
 ...
 */
  ...
  var Cates = {
    ...
    console.log(decode);
    var user = decode[27].user.user;
    console.log(user);
    // 粉丝数
    var  follower_count = user.followerCount;
    // 粉丝数
    var  fans_count = user.mplatformFollowersCount;
    // 抖音sec_uid
    var sec_uid = user.secUid;
    // 抖音author_id
    var author_id = user.uid;
    // 昵称
    var nick = user.nickname;
    // 抖音号
    var account = user.uniqueId;
    // 抖音short_id
    var short_id = user.shortId;
    // 头像
    var avatar = user.avatar300Url;
    // 简介
    var desc = user.desc;
    // 获赞数
    var like_count = user.totalFavorited;
    // 作品数
    var video_count = user.awemeCount;
    ...
    $(".form-add").click(function(){
        ...
        var deleteEle = '<div class="form-delete"><svg t="1645496440023" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1896" width="32" height="32"><path d="M512 70.89056c-245.574045 0-444.650079 199.077058-444.650079 444.651103 0 245.573021 199.077058 444.650079 444.650079 444.650079s444.650079-199.077058 444.650079-444.650079c0-245.575068-199.077058-444.651103-444.650079-444.651103z m228.41934 465.322911H296.317753v-50.517557h444.101587v50.517557z" p-id="1897" fill="#000000"></path></svg></div>';
    ...
    // 查找联动id值
    function searchId(object, value) {
        for (var key in object) {
            if (object[key] == value) return [key];
            if (typeof (object[key]) == "object") {
                var temp = searchId(object[key], value);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response.code == 1000){
                        ...
                        // 获取账号密码 存储session
                        localStorage.setItem("storagePhone",phone.value);
                        localStorage.setItem("storagePwd",md5(pwd.value));
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                console.log(response);
                                $(".operate-ewm img").attr("src",response.result.info.qrcode);
                                ...
                                // 返回结果为0  选框变灰 不可选择
                                if(isBind == 0){
                                    $(".form-bind label").css("color","#ccc");
                                    $(".form-bind").css("pointer-events","none");
                                    var bindTxt = "<span>该达人已被绑定</span>";
                                    $(".form-bind").append(bindTxt);
                                }
                                ...
                                console.log(cateArr[2]);
                                if(cate_id != ""){
                                    // 分类选择
                                    cateArr.forEach(function(self, index, arr){
                                        $("#cate"+index).distpickerCate({
                                            province: searchCate(Cates,self)[0],
                                            city: searchCate(Cates,self)[1],
                                        });
                                    })
                                    if(cateArr.length < 3){
                                       if(cateArr.length < 2){
                                           $("#cate1").distpickerCate({
                                               autoSelect: false
                                           });
                                           $("#cate2").distpickerCate({
                                               autoSelect: false
                                           });
                                       }else{
                                           $("#cate2").distpickerCate({
    ...
    $(".info-name").text(nick);
    $(".follower_count span").text(follower_count);
    $(".fans_count span").text(fans_count);
    $(".video_count span").text(video_count);

    // 判断手机密码是否存储 存储就登录
    if(storagePhone!=null&&storagePwd!=null){
        // 检测达人是否可以绑定
        var dataBind = {
            "app_id": 1,
            "sign": 1,
    ...
    $(".form-btn button").click(function(){
        // 定义提交数据
        var tel = info(".tel");
        var wechat = info(".wechat");
        var qq = info(".qq");
        var bind = $("#bind").prop("checked") ? 1 : 0;
        //console.log(bind);
        ...
        $.ajax({
            type: "post",
            url: apiHost+"/spider/browser/submitStarData",
            cache:false,
            data: dataInfo,
            dataType: "json",
            success: function (response) {
                console.log(response);
                if(response.code == 1000){// 提交完成关闭弹窗
                    // 清空弹窗数据并隐藏
                    $(".form-list input").val("");
                    $(".form-bind input").prop("checked",false);
                    $(".form-list:first-child").nextAll().remove();
                    $(".mask").hide();

                    // 显示积分情况
                   var bind_result = response.result.bind_result == 0 ? "绑定失败,该达人已被绑定或未勾选绑定达人" : "绑定成功";
                    $(".info-title").text(bind_result);
    ...
    $(".operate-record").click(function(){
        if(fans_count < 50000){
            ...
            $.ajax({
                type: "post",
                url: apiHost+"/spider/browser/starSupplyLists",
                cache:false,
                data: dataRecord,
                dataType: "json",
                success: function (response) {
                    ...
                    if(response.code == 1000){
                        var recordContent = "";
                        response.result.data.forEach(function(self,index){
                            //console.log(self);
                            var phoneContent = [],wechatContent = [],qqContent = [];
                            // 手机号
                            response.result.data[index].phone.forEach(function(self){
                                var phoneTxt = self.value;
                                phoneContent.push(phoneTxt);
                            })
                            // 微信号
                            response.result.data[index].wechat.forEach(function(self){
                                var phoneTxt = self.value;
                                wechatContent.push(phoneTxt);
                            })
                            // QQ号
                            response.result.data[index].qq.forEach(function(self){
                                var phoneTxt = self.value;
                                qqContent.push(phoneTxt);
                            })
                            recordContent += "<tr><td class='record-time'><span>"+ self.add_time_str +"</span></td>"+
                                    "<td class='record-phone'><span>"+ phoneContent.join(",") +"</span></td>"+
                                    "<td class='record-wechat'><span>"+ wechatContent.join(",") +"</span></td>"+
                                    "<td class='record-qq'><span>"+ qqContent.join(",") +"</span></td>"+
                                    "<td class='record-total'><span>"+ self.integral +"</span></td></tr>";
                        })
                        $(".record-content").append(recordContent);
                        $(".record").show();
                    }else if(response.code == 1002){
                        alert(response.message);
                         localStorage.removeItem("token");
    ...
    output: function (type) {
      ...
      districts = $.isNumeric(code) ? Cates[code] : null;
    ...
    // Save the other distpickerCate
    Distpicker.other = $.fn.distpickerCate;

    // Register as jQuery plugin
    $.fn.distpickerCate = function (option) {
    ...
    $.fn.distpickerCate.Constructor = Distpicker;
    $.fn.distpickerCate.setDefaults = Distpicker.setDefaults;

    // No conflict
    $.fn.distpickerCate.noConflict = function () {
    $.fn.distpickerCate = Distpicker.other;
    return this;
    };

    $(function () {
    $('[data-toggle="distpickerCate"]').distpickerCate();
    });
    ...
    $(".data-btn button").click(function(){
        // 省市区id
        var province_id = searchId(ChineseDistricts,$("#province").val()) == undefined ? 0 : searchId(ChineseDistricts,$("#province").val())[1];
        var city_id = searchId(ChineseDistricts,$("#city").val()) == undefined ? 0 : searchId(ChineseDistricts,$("#city").val())[1];
        var district_id = searchId(ChineseDistricts,$("#district").val()) == undefined ? 0 : searchId(ChineseDistricts,$("#district").val())[1];
        // 分类id
        var cateId1 = searchId(Cates,$("#skill").val()) == undefined ? "" : searchId(Cates,$("#skill").val())[1];
        var cateId2 = searchId(Cates,$("#skill1").val()) == undefined ? "" : searchId(Cates,$("#skill1").val())[1];
        var cateId3 = searchId(Cates,$("#skill2").val()) == undefined ? "" : searchId(Cates,$("#skill2").val())[1];
        var cate_id = [cateId1,cateId2,cateId3];
        var cateArr = [];
        for(var i in cate_id){
            if(cate_id[i] != ""){
                cateArr.push(cate_id[i]);
            }
        }
/*         cate_id.forEach(function(self,index,arr){
            console.log(arr.indexOf(self));
            //console.log(index);
            //arr.indexOf(self) === index ? cateArr.push(self) : null;
        }) */
        console.log(cateArr);
        // 性别id
        var sexVal = $("#sex").val();
        ...
        var sex_id = "";
        for(var j=0;j<4;j++){
            if(sex[j].getAttribute("value") == sexVal){
                sex_id = sex[j].getAttribute("data-code");
            }
        }
