// ==UserScript==
// @name         Tetra Online Theme
// @namespace    http://tampermonkey.net/
// @version      0.16
// @description  Tetra Online theme for Jstris
// @author       Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/417298/Tetra%20Online%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/417298/Tetra%20Online%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/dIbiyuU.png",32);
        loadGhostSkin("https://i.imgur.com/wEsRfg5.png",32);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://i.imgur.com/CqiOGkr.gif')";
...
function CustomSFXset(){
    this.volume=1;
    this.lock={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/to_lock.wav",abs:1};
    this.ready={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/to_ready.wav",abs:1,set:1};
    this.go={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/to_go.wav",abs:1,set:0};
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/to_died.wav",abs:1,set:1};
    this.hold={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/to_hold.wav",abs:1,set:0};
    this.move={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/to_move.wav",abs:1,set:0};
    this.linefall={url:"blank.wav",abs:1,set:0};
    this.comboTones={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/to_combo.mp3",abs:1,set:2,duration:1500,spacing:500,cnt:20};
};

/************************************
    Tetra Online Grid Script
************************************/
(function() {
    window.addEventListener('load', function(){
...
function atGameStart() {
    ...
    img.onload = function(){
        ...
        bgctx.drawImage(img,-18,98,595,562); // Or at whatever offset you like
    };
    img.src = "https://i.imgur.com/GDUbSCY.png";
...
queueCopy0.style.transform = "scale(0.9,0.9) translate(15px, 10px)"
queueCopy1.style.transform = "scale(0.8,0.8) translate(4px, 60px)"
queueCopy2.style.transform = "scale(0.8,0.8) translate(4px, 80px)"
queueCopy3.style.transform = "scale(0.8,0.8) translate(4px, 120px)"
queueCopy4.style.transform = "scale(0.8,0.8) translate(4px, 150px)"


holdCanvas.style.float = "none"
holdCanvas.style.position = "absolute"
holdCanvas.style.transform = "scale(1,1)"
holdCanvas.style.top = "5px"
holdCanvas.style.left = "-14px"


rInfoBox.style.position = "absolute"
rInfoBox.style.zIndex = 100
rInfoBox.style.marginLeft = "132px"
rInfoBox.style.marginTop = "40px"
...
Game['eventSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_tspinsingle.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_tspinminisingle.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_clear1.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_tspindouble.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_clear2.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_clear3.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_tspintriple.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_clear4.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_clear5.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_perfectclear.wav",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_b2btspin.mp3",
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_b2btetris.mp3"
];
...
Game['rotationSounds']  = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_rotate.wav", //rotate left
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_rotate.wav", //rotate right
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_rotate.wav" //rotate 180°
];
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/to_russianrave.wav",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/to_russianrave.wav"
