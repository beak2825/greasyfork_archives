...
// @exclude        */chat.php*
// @exclude        */ticker.html*
// @downloadURL https://update.greasyfork.org/scripts/1250/hwmxcharfind.user.js
// @updateURL https://update.greasyfork.org/scripts/1250/hwmxcharfind.meta.js
// ==/UserScript==
...
if (url.match('lordswm')) {
	...
	text_find = 'Поиск персонажа/клана';
...
newdiv.innerHTML = '<table cellspacing=4 cellpadding=0 bgcolor="#f5f3ea">'+
'<tr><td><center><b>'+text_find+'</b></center></td></tr>'+
'<tr><td>'+text_go1+'</td></tr>'+
'<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=text id="hwm_s_name" value="" maxlength="20"> <input type="submit" id="hwm_s_name_ok" value="&darr;"> <input type="submit" id="hwm_s_name_ok2" value="&uarr;"></td></tr>'+
'<tr><td>'+text_go2+'</td></tr>'+
'<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=text id="hwm_s_id" value="" maxlength="20"> <input type="submit" id="hwm_s_id_ok" value="&darr;"> <input type="submit" id="hwm_s_id_ok2" value="&uarr;"></td></tr>'+
'<tr><td>'+text_go3+'</td></tr>'+
'<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=text id="hwm_s_clanid" value="" maxlength="20"> <input type="submit" id="hwm_s_clanid_ok" value="&darr;"> <input type="submit" id="hwm_s_clanid_ok2" value="&uarr;"></td></tr>'+
'</table>';
