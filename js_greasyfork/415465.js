...
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/415465/%EB%B3%B4%EB%B0%B0%EB%93%9C%EB%A6%BC%20%EB%8B%89%EB%84%A4%EC%9E%84%EC%B0%A8%EB%8B%A8_%EB%B0%B1%EC%97%85.user.js
// @updateURL https://update.greasyfork.org/scripts/415465/%EB%B3%B4%EB%B0%B0%EB%93%9C%EB%A6%BC%20%EB%8B%89%EB%84%A4%EC%9E%84%EC%B0%A8%EB%8B%A8_%EB%B0%B1%EC%97%85.meta.js
// ==/UserScript==
    ...
    for (const nmt of target) {
        for (const undi of blockUserLists) {
            if(nmt.innerHTML.toString().indexOf(undi)!=-1 || check_enc_id(decodeURIComponent(nmt.firstElementChild.getAttribute('onclick').split("')")[0].split("('")[1]))){
                ...
                var current_title = nmt.parentElement.children[1].firstElementChild.getAttribute("title")==null?nmt.parentElement.children[1].children[0].firstChild.data:nmt.parentElement.children[1].firstElementChild.getAttribute("title");
