...
// @version      0.3
// @description  自动遍历学堂在线课程中的"作业"小节，收集题目类型、内容和答案，导出为 JSON 或者 Markdown。支持单选题、多选题、判断题、填空题和主观题。
// @author       ChatGPT 5.1&
// @match        https://www.xuetangx.com/*
// @run-at       document-end
// @grant        none
// @license      AGPL License
// @downloadURL https://update.greasyfork.org/scripts/561895/%E5%AD%A6%E5%A0%82%E5%9C%A8%E7%BA%BF%E4%BD%9C%E4%B8%9A%E7%AD%94%E6%A1%88%E6%94%B6%E9%9B%86%E5%99%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/561895/%E5%AD%A6%E5%A0%82%E5%9C%A8%E7%BA%BF%E4%BD%9C%E4%B8%9A%E7%AD%94%E6%A1%88%E6%94%B6%E9%9B%86%E5%99%A8.meta.js
// ==/UserScript==
...
(function () {
  ...
  function extractCurrentQuestion(chapterInfo) {
    ...
    else if (/填空题/.test(titleText)) type = 'fill';
    ...
    if (type === 'subjective') {
      ...
      // 填空题：正确答案在 .rightAnswer 中
      const rightAnswers = document.querySelectorAll('.rightAnswer');
      if (rightAnswers.length > 0) {
        answers = Array.from(rightAnswers)
          .map(p => p.textContent.replace('正确答案:', '').trim())
          .filter(Boolean);
      }
