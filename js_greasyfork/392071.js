...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/392071/New%20Userscript.user.js
// @updateURL https://update.greasyfork.org/scripts/392071/New%20Userscript.meta.js
// ==/UserScript==
    ...
    var token = setInterval(function(){
       ...
       if(frame.readyState == "complete")
       {
           ...
           //frame.getElementsByClassName("empty")[0].checked = true;
            frame.getElementsByClassName("empty")[1].parentElement.click();
