...
// @downloadURL https://update.greasyfork.org/scripts/520955/Tech%20Admin%27s.user.js
// @updateURL https://update.greasyfork.org/scripts/520955/Tech%20Admin%27s.meta.js
// ==/UserScript==
...
'[CENTER] текст [/CENTER][/FONT]',
    ...
    {
    title: "Перенос в жб на техов | 03",
    color: "",
    content: "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
                ...
                "[CENTER]Переношу вашу тему в раздел жалобы на тех специалистов.<br><br>" +
                "[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>" +
    ...
    {
    title: "Перенос в жб на техов | 38",
    color: "",
    content: "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
                "[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>" +
                "[CENTER]Переношу вашу тему в раздел жалобы на тех специалистов.<br><br>" +
...
{
    title: "Данная тема не подлежит обажалованию",
    color: "",
    content: "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Verdana][SIZE=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)]{{ user.name }}[/COLOR].[/CENTER]<br><br>" +
                "[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>" +
                "[CENTER]Ваше наказание не подлежит обажалованию.<br>" +
                "[CENTER]Наказания которые не подлежат обажалованию: Покупка игровой волюты,продажа игровой волюты, махинации,трансфер между серверами и тд.<br>" +
                "[CENTER]С полным списком можно ознакомиться по ссылке: → [URL='https://forum.blackrussia.online/threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BE%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F-%D0%BD%D0%B0%D1%80%D1%83%D1%88%D0%B5%D0%BD%D0%B8%D1%8F-%D0%BF%D1%80%D0%B8-%D0%B2%D1%8B%D0%B4%D0%B0%D1%87%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D1%8F-%D0%BE%D1%82-%D1%82%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%BE%D0%B3%D0%BE-%D1%81%D0%BF%D0%B5%D1%86%D0%B8%D0%B0%D0%BB%D0%B8%D1%81%D1%82%D0%B0.7552345/']Тык[/URL][/CENTER][/FONT]<br><br>" +
                "[CENTER][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/CENTER]<br>" +
                "[CENTER][COLOR=rgb(255, 255, 0)][/color][/CENTER][/FONT][/SIZE]",
    prefix: CLOSE_PREFIX,
    status: {
...
},
{
  ...
  $('button#pin2').click(() => editThreadData(SOSI_IRKUTSK, true));
  ...
  if(prefix == SOSI_BLUE) {
  moveThread(prefix, 1184);
  }
  if(prefix == SOSI_IRKUTSK) {
  moveThread(prefix, 1711);
  }
	}
	}
