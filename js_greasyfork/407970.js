...
// @downloadURL https://update.greasyfork.org/scripts/407970/%E7%A0%B4%E8%A7%A3VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91%E9%9B%86%E5%90%88.user.js
// @updateURL https://update.greasyfork.org/scripts/407970/%E7%A0%B4%E8%A7%A3VIP%E4%BC%9A%E5%91%98%E8%A7%86%E9%A2%91%E9%9B%86%E5%90%88.meta.js
// ==/UserScript==
/**!
 * 第一部分，函数功能区
 * 以及接口数据
...
const comIntabPlayer = {
    ...
    <div id="bar" @mousedown="move">
      <button @click="sizeCode='small'">小屏</button>
      <button @click="sizeCode='medium'">中屏</button>
      <button @click="sizeCode='large'">大屏</button>
      <button @click="sizeCode='fill'">充满</button>
...
addStyle(`
  ...
  #intabPlayer #bar button{background:yellow;padding:0px 10px;font-size:15px;line-height:30px;border:1px solid #3a3a3a}
...
const comMain = {
    ...
    `<div>
         ...
         <edit-apis></edit-apis>
         <div id="crackVIPSet" ref="crackVIPSet" :style="styleTop">
              <div id="nav">
