...
// @downloadURL https://update.greasyfork.org/scripts/32434/Contact%20Accuracy%20-%20Contacts.user.js
// @updateURL https://update.greasyfork.org/scripts/32434/Contact%20Accuracy%20-%20Contacts.meta.js
// ==/UserScript==
...
if ($('li:contains("2694")').length) {
    ...
    number.append('<br>');
     ...
     //Answers//
    createButton('Yes/Linkedin', 0,0,0,0);
    createButton('Yes/Company Website', 0,1,0,0);
    createButton('Yes/News Story', 0,2,0,0);
    createButton('Yes/Other Website', 0,3,0,0);
    number.append('<br>');
    createButton('Recently/Linkedin', 1,0,0,0);
    createButton('Recently/Company Website', 1,1,0,0);
    createButton('Recently/News Story', 1,2,0,0);
    createButton('Recently/Other Website', 1,3,0,0);
    number.append('<br>');
    createButton('Previously/Linkedin', 2,0,0,0);
    createButton('Previously/Company Website', 2,1,0,0);
    createButton('Previously/News Story', 2,2,0,0);
    createButton('Previously/Other Website', 2,3,0,0);
    number.append('<br>');
    createButton('No evidence', 3,4,4,4);
