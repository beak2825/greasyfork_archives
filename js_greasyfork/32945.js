// ==UserScript==
// @name           WME URComments Ukrainian List
// @description    This script is for Ukrainian comments, to be used with the main script WME URComments (Stable)
...
// @downloadURL https://update.greasyfork.org/scripts/32945/WME%20URComments%20Ukrainian%20List.user.js
// @updateURL https://update.greasyfork.org/scripts/32945/WME%20URComments%20Ukrainian%20List.meta.js
// ==/UserScript==

window.UrcommentsCustomReminderPosistion = 24;

//this is the note that is added to the the reminder link  option
window.UrcommentsCustomReplyInstructions = 'Для відповіді, використовуйте додаток Waze або перейдіть до '; //followed by the URL - superdave, rickzabel, t0cableguy 3/6/2015
...
window.UrcommentsCustomdef_names[6] = "Невірний поворот"; //"Incorrect turn";
window.UrcommentsCustomdef_names[7] = "Невірна адреса"; //"Incorrect address";
window.UrcommentsCustomdef_names[8] = "Невірний маршрут"; //"Incorrect route";
window.UrcommentsCustomdef_names[9] = "Відсутня об'їзний"; //"Missing roundabout";
window.UrcommentsCustomdef_names[10] = "Загальна помилка"; //"General error";
window.UrcommentsCustomdef_names[11] = "Поворот не допускається"; //"Turn not allowed";
window.UrcommentsCustomdef_names[12] = "Невірний вузол"; //"Incorrect junction";
window.UrcommentsCustomdef_names[13] = "Відсутній міст/шляхопровід"; //"Missing bridge overpass";
window.UrcommentsCustomdef_names[14] = "Неправильний напрямок руху"; //"Wrong driving direction";
window.UrcommentsCustomdef_names[15] = "Відсутній виїзд"; //"Missing Exit";
window.UrcommentsCustomdef_names[16] = "Відсутня дорога"; //"Missing Road";
window.UrcommentsCustomdef_names[18] = "Відсутній орієнтир"; //"Missing Landmark";
window.UrcommentsCustomdef_names[19] = "Заблокована дорога"; //"Blocked Road";
window.UrcommentsCustomdef_names[21] = "Відсутня назва вулиці"; //"Missing Street Name";
window.UrcommentsCustomdef_names[22] = "Некоректна Вулиця (префікс або суфікс)"; //"Incorrect Street Prefix or Suffix";
window.UrcommentsCustomdef_names[23] = "Обмеження швидкості"; //"Missing or invalid speed limit";
...
window.UrcommentsCustomURC_Text_tooltip[3] = "Оновити карту";

window.UrcommentsCustomURC_Text_tooltip[4] = "Number of URs Shown";

//tab names
window.UrcommentsCustomURC_Text[5] = "Коментарі";
window.UrcommentsCustomURC_Text[6] = "Фільтри";
window.UrcommentsCustomURC_Text[7] = "Налаштування";
...
window.UrcommentsCustomArray2 = [
    ...
    "Fixed",
    "Завдяки вашому звіту ми знайшли і виправели проблему на карті. Виправлення повинно досягти мобільних пристроїв протягом кількох днів. У рідкісних випадках це може зайняти ближче до тижня.", //2017/05/26
    "Solved",
