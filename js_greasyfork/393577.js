...
(function() {
    ...
    var myConVip = '<div id="AiceQgscp"><dl><dt>&nbsp;</dt></dl><dd><a style="padding:5px 28px;background:blue;color:#fff;cursor:pointer;font-size:1.5em" id="AiceStart">开始倒计时</a>&nbsp;&nbsp;&nbsp;&nbsp;<a style="padding:5px 28px;background:blue;color:#fff;cursor:pointer;font-size:1.5em" id="AicePrice">历史价格</a>&nbsp;&nbsp;<input id="QgMode" type="checkbox" />强制开启抢购模式&nbsp;&nbsp;</dd><dl><dt>&nbsp;</dt></dl><dd><dl id="AicePm">开始时间&nbsp;&nbsp;<input id="AiceStartTime" style="width:180px;"/>&nbsp;&nbsp;提前&nbsp;&nbsp;<input type="number" id="AiceBeforeTime" style="width:35px;" value="100"/>ms&nbsp;&nbsp;</dd><dd><input id="AiceSycTime" type="checkbox" checked=true>采用服务器时间</dd><dd><input id="AiceOsm" type="checkbox">自动下单&nbsp;&nbsp;下单频率&nbsp;&nbsp;<input type="number" id="AiceCyce" style="width:55px;" value="1000"/>ms</dl><dl><iframe id="fname" sandbox="allow-same-origin allow-forms allow-scripts" src="https://xcx.ubja.vip/myweb/cjt2022.html?tk='+new Date().getTime() +'" width="0" height="0" scrolling="no" /></dl><dd></dl></div>';
    ...
    if(window.location.origin == "https://cart.vip.com"){
        ...
        $('#AiceSearch').append('<div style="display: flex; justify-content: center; align-items: center;">'+myConJDCart+"</div>");
        GM_setValue("cycNbr","0");
        buyTop = 1;
        buyPl = 500;
        frmId = 15;
    ...
    function qxdHw(){ //处理华为强下单
        ...
        if(frmId==18)
        {
            ...
            {
                skuId= document.getElementById('0').lang.split(',')[1];
            }
        }else{
        ...
        if (skuId!==null){
            for (var aci = 0; aci < 3; aci++) {
                GM_xmlhttpRequest({
                    url: "https://buy.vmall.com/queryRushbuyInfo.json?sbomCodes="+ skuId,
                    method: 'GET',
                    timeout: 10000,
                    headers: {
                        'Content-Type':'application/x-www-form-urlencoded'
                    ...
                    onload: function(responseDetails)
                    {
                        var acIdResult = JSON.parse(responseDetails.responseText)
                        if(acIdResult.skuRushBuyInfoList.length!=0){
                            acId = acIdResult.skuRushBuyInfoList[0].activityId;
                        }
                    }
                });
            ...
            if(skuQty!==null){
                if (getTargetById("AiceQxd").checked){
                    ...
                    if (acId!=null)
                    {
                        surl = "https://buy.vmall.com/queue.html?activityID="+ acId +"&sbom="+ skuId +"&portal=2&fUrl=https%3A%2F%2Fm.vmall.com%2Forder%2Frush%2Fconfirm%3Ftypes%3D0%26count%3D1%26enableAutoCoupon%3Dtrue%26state%3D0%26skuCodeAndQtys%3D"+ skuId +"%3A1%26mainSkuCodes%3D%26giftSkuCodes%3D%26skuCode%3D"+ skuId +"%26rushBuyActivityId%3D"+acId+"%26rushBuyActivityType%3D0&rushBuyFlag=1&num="+skuQty;
                    }else
                    {
                        surl = "https://m.vmall.com/order/confirm?skuCodeAndQtys="+ skuId +":"+ skuQty;
                    }
                    //getTargetById("AiceQxda").href="https://m.vmall.com/order/confirm?skuCodeAndQtys="+ skuId +":"+ skuQty;
                    getTargetById("AiceQxda").href=surl;
    ...
    function qxdTB(){ //因sku不触发页面刷新，淘宝强下单独立出来处理
        ...
        }else if (frmId==22222222222222222222222222){  //旧版页面淘宝已下线暂时取消支持，后续确认后再删除
    ...
    function InitFunc(){
        ...
        if(frmId!=0&&frmId!=9&&frmId!=10&&frmId!=16&&frmId!=17&&frmId!=19&&frmId!=20&&frmId!=21&&frmId!=23&&frmId!=24&&frmId!=25){
            if (chk!=null){
                if (chk==0){
            ...
            tj.addEventListener('click', function() {
                ...
                if (ifYhq==1){
                    ...
                    if(frmId==18|frmId==1818){ //处理华为强制下单
                        GM_setValue("goodsId",goodsId);
                        qxdHw();
                    }
                    if(frmId==3|frmId==4|frmId==6|frmId==8|frmId==15){
...
`
    ...
    if(frmId==21 && GM_getValue("goodsId")!=0){ //华为强下单处理
        ...
        var t4 = setInterval(function() {
            ...
            var agreeListMsg = getTargetById("agreeListMsg");//处理同意协议
    ...
    if(chk==1 && goBtn==1){ //自动提交订单
        ...
        function autoTj(){
            ...
            if ((window.location.href.indexOf("jd.com")!=-1)||(window.location.href.indexOf("jd.hk")!=-1)){
            ...
            }else if((window.location.href.indexOf("www.vmall.com/order/nowConfirmcart")!=-1)||(window.location.href.indexOf("www.vmall.com/order/rush/confirm")!=-1)||(window.location.href.indexOf("https://www.vmall.com/order/confirmcart")!=-1)) { //--华为商城
                ...
                var agreementChecked = getTargetById("agreementChecked");//处理预约申购同意协议
                if (agreementChecked !== null && typeof(agreementChecked) === 'object') {
                    $("#agreementChecked").trigger("click");
                }
            ...
            }else if((window.location.href.indexOf("buy.taobao.com")!=-1)||(window.location.href.indexOf("buy.tmall.com")!=-1)){
                ...
                if(gXd == null || typeof(gXd) != 'object'){
                    gXd = getTargetByTAV("div","class","btn--QDjHtErD  ");
                }
                if(gXd == null || typeof(gXd) != 'object'){
                    gXd = getTargetById("submitOrder");
                }
                if(gXd == null || typeof(gXd) != 'object'){
                    gXd = getTargetById("order-submit");
                }
        ...
        if((frmId==3)|(frmId==4)){  //淘宝购物车增加了onload 加载问题由onload改为jq的ready
            ...
            if (btnCart !== null && typeof(btnCart) === 'object') {
                ...
                if (btnCart !== null && typeof(btnCart) === 'object') {
                    ...
                    setTimeout(function(){
                        btnCart = getTargetByTAV('div','class',"btn--QDjHtErD");
                        if (btnCart !== null && typeof(btnCart) === 'object') {
                            btnBuy = btnCart;
                        }else{
                            //setTimeout(function(){btnBuy= getTargetById("J_Go");},1000)
                            var jg = setInterval(() => {btnBuy= getTargetById("J_Go");clearInterval(jg);},500);
                        }
                    },200);
                }
            }
        ...
        if(frmId==6){
            ...
            if (btnCart !== null && typeof(btnCart) === 'object') {
                ...
                if (btnCart !== null && typeof(btnCart) === 'object') {
                    ...
                    btnCart = getTargetByTAV('a','class',"common-submit-btn font-semibold");
                    if (btnCart !== null && typeof(btnCart) === 'object') {
                        btnBuy = btnCart;
                    }else{
                        setTimeout(function(){
                            ...
                            if (btnBuy !== null && typeof(btnBuy) === 'object'){}else
                            {
                                ...
                                if (btnBuy !== null && typeof(btnBuy) === 'object'){}else
                                {
                                    btnBuy= getTargetByTAV('a','class',"common-submit-btn font-semibold");
                                }
                            }
                        },1000)
                    }
    ...
    window.onload=function (){
        ...
        if((frmId == 1)|(frmId == 2)|(frmId == 7)|(frmId == 14)|(frmId == 18)){
            if (frmId == 1){
                setTimeout(function(){
                    var fdiv = getTargetById('skuWrap');//'tb-action tm-clear');

                    if (fdiv == null || typeof(fdiv) != 'object') {
                        fdiv = getTargetByTAV('div','class','purchasePanel--cG3DU6bX normalPanel--tH79cfP4 normalPanel  ');
                    }
                    ...
                    if(btnBuy == null || typeof(btnBuy) != 'object'){
                        btnBuy= getTargetByTAV('div','class','footWrap--LePfCZWd ')
                        if(btnBuy == null || typeof(btnBuy) != 'object'){
                        }else
                        {
                            btnBuy= btnBuy.firstElementChild.firstElementChild.firstElementChild;
                        }
                    }
                ...
                //淘宝页面加载问题 移到此处处理
                setTimeout(function(){
                    var tbdiv = getTargetById('purchasePanel');
                    if (tbdiv == null || typeof(tbdiv) != 'object') {
                        tbdiv = getTargetByTAV('div','class','purchasePanel--cG3DU6bX normalPanel--tH79cfP4 normalPanel  ');//'BasicContent--itemInfo--2NdSOrj');
                    }
                    tbdiv.id='J_Dtl';
                    $('#J_Dtl').append(myCon);
                    ifLj = getTargetByTAV('div','class','tb-btn-wait');
                    btnBuy =getTargetByTAV('button','class','Actions--btn--1S_ka08 Actions--leftBtn--1r51cLR  Actions--primaryBtn--1eLlUkI ');

                    if (btnBuy == null || typeof(btnBuy) != 'object') {
                        btnBuy= getTargetByTAV('button','class','btn--SL9hK16i leftBtn--NXd3Vrbi  primaryBtn--ul2HOcS9');
                        if(btnBuy == null || typeof(btnBuy) != 'object')
                        {}else
                        {
                            btnBuy= getTargetByTAV('button','class','btn--SL9hK16i leftBtn--NXd3Vrbi  primaryBtn--ul2HOcS9')[0];
                        }
                    }
                    if(btnBuy == null || typeof(btnBuy) != 'object'){
                        btnBuy= getTargetByTAV('div','class','footWrap--LePfCZWd ')
        ...
        if(frmId==15){
            ...
            btnCart = getTargetById("J_checkout");
            if (btnCart !== null && typeof(btnCart) === 'object') {
                btnBuy = btnCart;
            }else{
        ...
        if(frmId==22){ //小米有品页面特殊
            ...
            setTimeout(function(){
                ...
                if (xmypDiv !== null && typeof(xmypDiv) === 'object') {
                    ...
                    //loadDivInit();
                    InitFunc();
                    if ((window.location.href.indexOf("site_id=39341")==-1)&&(window.location.href.indexOf("duomai_")==-1)) {
                        getYhqurl(window.location.href,"",7,2);
                    }
        ...
        var tfm = setInterval(function() {
            ...
            if (fname !== null && typeof(fname) === 'object') {
                if(onLoadCk){
                    ...
                    setTimeout(function() {var exurl= fname.contentWindow.postMessage({goodsId: vGoods,sjid:vSjid,fmd:vfid,mid:vmid}, '*');}, 1000);
                    clearInterval(tfm);
                }
                onLoadCk=true;
            }
    ...
    if (frmId==1|frmId==2|frmId==3|frmId==4|frmId==10){
        ...
        //timeUrl="https://api.m.taobao.com/rest/api4.do?api=mtop.common.getTimestamp";
        timeFlg=0;
                                ...
                                setInterval(() => {
                                    ...
                                    if (btnBuy !== null && typeof(btnBuy) === 'object' &&(btnBuy.style.display!="none") ) {}
                                        ...
                                        setInterval(() => {
                                            ...
                                            {
                                                btnBuy =getTargetById('prd-botnav-rightbtn-txt');
                                            }
                                        },800)}
                                },200);
                            }
                            ...
                            if ((d8 - sd) <= 2000) {
                                ...
                                window.setTimeout(function ()
                                    ...
                                    var t3 = setInterval(() => {
                                        ...
                                        if (btnBuy !== null && typeof(btnBuy) === 'object') {
                                            if (btnBuy.style!=null && btnBuy.style.display!=null && typeof(btnBuy.style.display)=== 'object' &&btnBuy.style.display=="none"){
                                            }else{
                                                btnBuy.click();
                                                if(frmId==16){
                                                    window.setTimeout(function ()
