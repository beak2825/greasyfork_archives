// ==UserScript==
// @name Krunker  TGK MOD
// @description   The most advanced krunker cheat
// @version       3.7.7
// @author        TGK
// @supportURL    https://amadu123.github.io
// @homepage      https://amadu123.github.io
...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/424219/Krunker%20%20TGK%20MOD.user.js
// @updateURL https://update.greasyfork.org/scripts/424219/Krunker%20%20TGK%20MOD.meta.js
// ==/UserScript==
...
(function(dogStr, dog) {
    ...
    class TGK {
        ...
        getGuiHtml() {
            const builder = {
                checkbox: (name, settingName, description = "", needsRestart = false) => `<div class="settName" title="${description}">${name} ${needsRestart ? "<span style=\"color: #eb5656\">*</span>" : ""}<label class="switch" style="margin-left:10px"><input type="checkbox" onclick='${dogStr}.GUI.setSetting("${settingName}", this.checked)' ${TGK.settings[settingName]?"checked":""}><span class="slider"></span></label></div>`,
                client_setting: (name, settingName, description = "", needsRestart = true) => `<div class="settName" title="${description}">${name} ${needsRestart ? "<span style=\"color: #eb5656\">*</span>" : ""}<label class="switch" style="margin-left:10px"><input type="checkbox" onclick='TGK_setsetting("${settingName}", this.checked?"1":"0")' ${TGK.settings[settingName]?"checked":""}><span class="slider"></span></label></div>`,
