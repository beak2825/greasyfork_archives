// ==UserScript==
// @name           OPS: TEST FLAC Upload Quick Buttons
// @description    Adds buttons to quickly set release type / format / media for FLAC uploads
// @author         mrpoot (modified for OPS by b1100101)
// @version        0.3
// @match          https://orpheus.network/upload.php*
// @grant          none
// @run-at         document-end
// @namespace      https://greasyfork.org/de/users/580795-b1100101
// @downloadURL https://update.greasyfork.org/scripts/410839/OPS%3A%20TEST%20FLAC%20Upload%20Quick%20Buttons.user.js
// @updateURL https://update.greasyfork.org/scripts/410839/OPS%3A%20TEST%20FLAC%20Upload%20Quick%20Buttons.meta.js
// ==/UserScript==

(() => {

// don't touch these or I'll bite your fingers off:
...
function Format() {
    ...
    if ($('#format').raw().options[$('#format').raw().selectedIndex].value == 'AAC') {
        $('#format_warning').raw().innerHTML = 'AAC torrents may only be uploaded if they represent editions unavailable on Redacted in any other format sourced from the same medium and edition <a href="rules.php?p=upload#r2.1.24">(2.1.24)</a>';
    } else {
