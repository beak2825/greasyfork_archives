// ==UserScript==
// @name AudioBookBay hide category: Mystery
// @description Hide Mystery category
...
// @downloadURL https://update.greasyfork.org/scripts/484561/AudioBookBay%20hide%20category%3A%20Mystery.user.js
// @updateURL https://update.greasyfork.org/scripts/484561/AudioBookBay%20hide%20category%3A%20Mystery.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact phrase 'Mystery'
    $(".post").has(".postInfo:contains('Mystery')").hide();
});
