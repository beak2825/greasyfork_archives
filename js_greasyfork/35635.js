// ==UserScript==
// @name         花專用
// @namespace    http://swordman-s1.yytou.com/?id=4287598&time=1495045905107&key=91843da41becf489efdebadfb67a6620&s_line=1&lan=tw&lan=tw&lan=tw
// @version      0.4
// @description  try to take over the world!
// @author       MARBO&jj
// @match        http://swordman-s1.yytou.com/?id=4287598&time=1495045905107&key=91843da41becf489efdebadfb67a6620&s_line=1&lan=tw&lan=tw&lan=tw
// @grant        http://swordman-s1.yytou.com/?id=4287598&time=1495045905107&key=91843da41becf489efdebadfb67a6620&s_line=1&lan=tw&lan=tw&lan=tw
// @downloadURL https://update.greasyfork.org/scripts/35635/%E8%8A%B1%E5%B0%88%E7%94%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/35635/%E8%8A%B1%E5%B0%88%E7%94%A8.meta.js
// ==/UserScript==
...
var enforcePoints = '925';
var mySkillLists = '孔雀翎';
skillLists = '';
buttonWidth = '80px';
buttonHeight = '30px';
currentPos = 50;
...
buttonhideButton.style.right = '290px';
...
function hideButton(){
	   ...
	   answerQuestionsButton.style.visibility="hidden";
           ...
           lolButton.style.visibility="hidden";
...
function showButton(){
		...
		answerQuestionsButton.style.visibility="visible";
                ...
                lolButton.style.visibility="visible";
...
function CheckIn(){ // 進入揚州
    ...
    clickButton('event_1_94628102', 1);  //領每周禮包
	...
	clickButton('vip finish_family', 0); //師門
	clickButton('vip finish_family', 0);
	clickButton('vip finish_family', 0);
	clickButton('vip finish_family', 0);
	clickButton('vip finish_family', 0);
	clickButton('vip finish_family', 0);
	...
	clickButton('vip finish_family', 0);
	clickButton('vip finish_family', 0);
	clickButton('vip finish_clan', 0);  //幫派
	clickButton('vip finish_clan', 0);
	clickButton('vip finish_clan', 0);
	clickButton('vip finish_clan', 0);
	clickButton('vip finish_clan', 0);
	clickButton('vip finish_clan', 0);
	...
	clickButton('vip finish_clan', 0);
	clickButton('vip finish_clan', 0);
	clickButton('vip finish_dig', 0); // 挖寶
	clickButton('vip finish_dig', 0);
	clickButton('vip finish_dig', 0); // 挖寶
	clickButton('vip finish_dig', 0);
	clickButton('vip finish_dig', 0);
	clickButton('vip finish_dig', 0);
	...
	clickButton('vip finish_fb dulongzhai', 0);
	clickButton('vip finish_fb junying', 0);  //本2
	clickButton('vip finish_fb junying', 0);
	clickButton('vip finish_fb beidou', 0);  //本3
	clickButton('vip finish_fb beidou', 0);
}
// 領取獎勵 ------------------------------------------------------------------------------------------------------
...
answerQuestionsButton.style.right = '0px';
...
function book(){
	...
	clickButton('go east');
	clickButton('go east');
	clickButton('event_1_9179222', 0);
	clickButton('go east');
	clickButton('event_1_11720543', 0);
	clickButton('go west');
	clickButton('go north');
	clickButton('go east');
	clickButton('go east');
...
// 鱷魚 ------------------------------------------------------------------------------------------------------
//document.body.removeChild(CheckInButton);
var lolButton = document.createElement('button');
lolButton.innerText = '鱷魚';
lolButton.style.position = 'absolute';
lolButton.style.right = '0px';
lolButton.style.top = currentPos + 'px';
currentPos = currentPos + delta;
lolButton.style.width = buttonWidth;
lolButton.style.height = buttonHeight;
document.body.appendChild(lolButton);
lolButton.addEventListener('click', lol)
function lol(){
    clickButton('jh 37');
	clickButton('go north');
	clickButton('go east');
	...
	clickButton('go southeast');
	clickButton('go north');
	clickButton('event_1_97487911', 0);
}
// 準備茅山 ------------------------------------------------------------------------------------------------------
//document.body.removeChild(CheckInButton);
...
function llol(){
	...
	clickButton('enableskill enable parry shiyangjian', 1);
}
// 取消茅山 ------------------------------------------------------------------------------------------------------
//document.body.removeChild(CheckInButton);
