// ==UserScript==
// @name         Скрипт для себя || Purple
// @namespace    http://tampermonkey.net/
// @version      3.0
// @description  Скрипт для себя
// @author       Raf Khumaryan
// @match        https://forum.blackrussia.online/index.php?threads/*
// @icon         https://klike.net/uploads/posts/2021-12/1638345168_12.jpg
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/467331/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B5%D0%B1%D1%8F%20%7C%7C%20Purple.user.js
// @updateURL https://update.greasyfork.org/scripts/467331/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D1%81%D0%B5%D0%B1%D1%8F%20%7C%7C%20Purple.meta.js
// ==/UserScript==
...
const buttons = [
	{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=default] Текст <br><br>"+
...
{
	 title: '|(--(-(->╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴Правила RolePlay процесса╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴<-)-)--)-|<br>'
},
{
...
},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=#8B00FF]Куратору Администрации @Timofei_Oleinik ღ .[/COLOR], пожалуйста ожидайте ответа.<br><br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/bvzbc50C/download-4.gif[/img][/url]<br>",
	  prefix: PINN_PREFIX,
...
{
	  title: '| Бесмысленный/оск Nik фам |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил пользования форумом:<br><br>"+
...
title: '| Одобрена |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша заявление получает статус - [COLOR=#00FF00]Одобрено[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/qqpxm7bR/download-2.gif[/img][/url]<br>",
	  status: false,
...
title: '| Отказано |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша заявление получает статус - [COLOR=#FF0000]Отказано[/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/qqpxm7bR/download-2.gif[/img][/url]<br>",
	  status: false,
...
title: '| Проверено |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=lavender] Все выше проверено и получает статус - [COLOR=#00FF00]Одобрено[/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/qqpxm7bR/download-2.gif[/img][/url]<br>",
	  status: false,
...
title: '| На рассмотрении |',
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=lavender] Все выше на [COLOR=#ffff00]рассмотрение[/COLOR], - пожалуйста ожидайте ответа.<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>"+
"[url=https://postimages.org/][img]https://i.postimg.cc/qqpxm7bR/download-2.gif[/img][/url]<br>",
	  status: false,
...
},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, отчет Raf_Khumaryan [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=RED] 1. Ник: [COLOR=BLACK]Raf_Khumaryan[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 2. Ваша должность: [COLOR=BLACK]ГР/КФ[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 3. Ссылка на /astats: [COLOR=BLACK] *Ссылка* [/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 4. Доп работа(Мп. Посты и т.п):<br>"+
		"[B][CENTER][COLOR=RED] КФ: *Ссылка*<br>"+
		"[B][CENTER][COLOR=RED] МП: *Ссылка*<br>"+
		"[B][CENTER][COLOR=RED] Пост: *Ссылка*<br>"+
		"[B][CENTER][COLOR=RED] 5. Количество заработанных баллов за день: [COLOR=BLACK] *Число* [/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 6. Дата отчёта: [COLOR=BLACK] *Число* [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, Raf_Khumaryan просит снять наказание [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=RED] 1. Ник: [COLOR=BLACK]Raf_Khumaryan[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 2. Ваша должность: [COLOR=BLACK]ГР/КФ[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 3. Дата получения выговора/предупреждения: [COLOR=BLACK] *Число* [/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 4. Что снять (выговор/пред/устник):<br>"+
		"[B][CENTER][COLOR=RED] 5.Статистика: [COLOR=BLACK] За баллы [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, Raf_Khumaryan не может работать :( [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=RED] 1. Ник: [COLOR=BLACK]Raf_Khumaryan[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 2. Уровень администрирования: [COLOR=BLACK]4[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 3. Занимая должность: [COLOR=BLACK] ГР/КФ [/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 4. Есть ли в ближайшее время обзвоны/важные мероприятия: (Если есть, укажите лицо подменяющее вас): [COLOR=BLACK]Нет[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 5. Срок неактива: (с - по -, Максимум неделя): [COLOR=BLACK] *Число* [/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 6. Причина неактива: [COLOR=BLACK] По семейным обстоятельствам [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, Raf_Khumaryan не может присутствовать [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=RED] 1. Ник: [COLOR=BLACK]Raf_Khumaryan[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 2. Уровень администрирования: [COLOR=BLACK]4[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 3. Занимая должность: [COLOR=BLACK] ГР/КФ [/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 4. Дата собрания, на который нужен отгул: [COLOR=BLACK]Нет[/COLOR]<br>"+
		"[B][CENTER][COLOR=RED] 5. Причина неактива: [COLOR=BLACK] По семейным обстоятельствам [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
{
	  ...
	  content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, Raf_Khumaryan хочет совершить сделку с игроком [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOT=RED] 1. Ник: [COLOR=BLACK]Raf_Khumaryan[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 2. Ник игрока: [COLOR=BLACK] *Ник* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 3. Дата провидения: [COLOR=BLACK] *Дата* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 4. Условия сделки: [COLOR=BLACK] *Условия* [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, отчет Raf_Khumaryan [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOT=RED] 1. Ник: [COLOR=BLACK]Raf_Khumaryan[/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] 2. Ваш Раздел: [COLOR=BLACK] Оба р [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Количество тем, рассмотренных за понедельник: [COLOR=BLACK] *Числр* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Количество тем, рассмотренных за втроник: [COLOR=BLACK] *Числр* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Количество тем, рассмотренных за среду: [COLOR=BLACK] *Числр* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Количество тем, рассмотренных за четверг: [COLOR=BLACK] *Числр* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Количество тем, рассмотренных за пятницу: [COLOR=BLACK] *Числр* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Количество тем, рассмотренных за субботу: [COLOR=BLACK] *Числр* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Количество тем, рассмотренных за воскресенье: [COLOR=BLACK] *Числр* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Количество заработанных баллов: [COLOR=BLACK] *Число* [/COLOR]<br>"+
		"[B][CENTER][COLOT=RED] Итого тем рассмотрено: [COLOR=BLACK] *Число* [/COLOR]<br><br>"+
        "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]PURPLE[/COLOR].<br>"+
        "[B][CENTER][COLOR=indigo]С уважением Главный редактор группы - Raf_Khumaryan[/COLOR] <br><br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url]<br>",
},
