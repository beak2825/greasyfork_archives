...
// @downloadURL https://update.greasyfork.org/scripts/472137/Anapa%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/472137/Anapa%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
    ...
    title: 'На рассмотрении',
      content:
        ...
        "[CENTER][FONT=georgia][I][B]Ваша жалоба передана руководству сервера для дальнейшего рассмотрения[/FONT][/I][/B][/CENTER] " +
		'[Color=LimeGreen][CENTER][I][/I]"Ожидайте окончательного вердикта" [/CENTER][/color][/FONT]',
    ...
    },
    {
      ...
      content:
        ...
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил: 2.01. Запрещено поведение, нарушающее нормы процессов Role Play режима игры | Jail 30 минут [/FONT][/I][/B][/CENTER] " +
                '[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по данному пункту правил:<br><ins><b>2.02. Запрещено целенаправленно уходить от Role Play процесса всеразличными способами | Jail 30 минут / Warn[/CENTER]<br><b><ins>" +
                '[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
 ...
 title: 'Долг',
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B][/FONT]Примечание: займ может быть осуществлен только через зачисление игровых ценностей на банковский счет, максимальный срок займа 30 календарных дней.[/I][/B][/CENTER] " +
                '[Color=DeepSkyBlue][CENTER][/I]Если займ не был возвращен, аккаунт должника блокируется.[/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][CENTER][I][FONT=times new roman]Отказано, закрыто[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    },
    {
title: 'Отказ от предложение/взаимодействие',
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B][/FONT]Вы можете отказаться от данного предложения.[/I][/B][/CENTER] " +
                '[Color=DeepSkyBlue][CENTER]Нарушений со стороны игрока нет.[/I][/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][CENTER][I][FONT=times new roman]Отказано, закрыто[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B][/FONT]Ответ игрока должен быть в РП чат.[/I][/B][/CENTER] " +
                '[Color=DeepSkyBlue][CENTER][/I]Нарушений со стороны игрока нет.[/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][CENTER][I][FONT=times new roman]Отказано, закрыто[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    },
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, Здравствуйте, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Слив склада семьи не наказуем со стороны Администрации сервера.[/FONT][/I][/B][/CENTER] " +
		'[Color=LimeGreen][CENTER][I][/I]За своей семьёй лидер должен следить сам.[/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по данному пункту правил:<br>2.32. Запрещено введение в заблуждение, обман, оскорбление, неконструктивная критика администрации на всех ресурсах проекта | Ban 7 - 15 дней / PermBan[/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][FONT=times new roman][CENTER][I]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Игрок будет наказан по данному пункту правил:<br>2.54. Запрещено неуважительное обращение, неадекватное поведение, угрозы в любом их проявлении по отношению к администрации | Mute 180 минут[/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Спасибо за Ваше обращение!<br>Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=LimeGreen][FONT=times new roman][CENTER][I]Одобрено, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    ...
    },
    {
	  ...
	  content:
		...
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
    ...
    },
    {
	  ...
	  content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
		"[CENTER]Ответ был дан в прошлой жалобе.[/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=Red][FONT=times new roman][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Дублирование темы.<br>Если вы дальше будете заниматься данной деятельностью (дублированием тем), то ваш форумный аккаунт будет заблокирован на 3 дня и более.[/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=Red][FONT=times new roman][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Вы ошиблись разделом.<br>Обратитесь в раздел [URL='https://forum.blackrussia.online/index.php?forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.638/']Жалобы на администрацию[/URL].[/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=Red][FONT=times new roman][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Вы ошиблись разделом.<br>Обратитесь в раздел [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B7%D0%B0%D1%8F%D0%B2%D0%BA%D0%B8-%D0%BD%D0%B0-%D0%BE%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D1%8F.1158779/']Обжалование наказаний[/URL].[/CENTER]<br>" +
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=Red][FONT=times new roman][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
	...
	},
    {
	  ...
	  content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
		"[CENTER]В течении 24х часов укажите тайм-коды, иначе жалоба будет отказана.[/CENTER]<br>" +
	...
	},
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=times new roman][I]Заголовок вашей жалобы составлен не по форме. Убедительная просьба ознакомиться [URL='https://forum.blackrussia.online/index.php?threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.885157/']с правилами подачи жалоб на игроков[/URL].[/CENTER]" +
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=Red][FONT=times new roman][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]В случае ответного ДМ нужен видео-запись. Пересоздайте тему и прикрепите видео-запись.[/CENTER]" +
		'[Color=DeepSkyBlue][CENTER]Приятной игры на Anapa.[/I][/CENTER][/color][/FONT]' +
		'[Color=Red][FONT=times new roman][CENTER][I]Отказано, закрыто.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    ...
    },
{
    ...
    },
    {
      ...
      content:
		'[Color=Fuchsia][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП ситуация получает статус: [Color=Red]Отказано.[/color]",
...
// @author       You
// @match        https://greasyfork.org/ru/script_versions/new
