...
// @include http://www.dreadcast.eu/Main
// @compat Firefox, Chrome
// @downloadURL https://update.greasyfork.org/scripts/596/VousAvezUnMessage.user.js
// @updateURL https://update.greasyfork.org/scripts/596/VousAvezUnMessage.meta.js
// ==/UserScript==
...
$('#one').attr('src', 'https://www.thesoundarchive.com/email/mp_grail.mp3');
...
$('#endAudio').css('background-position','0px 0px').css('left','123px').css('top','22px').css('background-size','15px 15px').addClass('link');
