...
// @downloadURL https://update.greasyfork.org/scripts/23089/Modern%20HF.user.js
// @updateURL https://update.greasyfork.org/scripts/23089/Modern%20HF.meta.js
// ==/UserScript==
...
$(document).ready(function () {
    ...
    $('img[src$="http://hackforums.net/images/modern_bl/dot_folder.gif"]').attr('src', 'http://i.imgur.com/daTyYqY.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_hotfolder.gif"]').attr('src', 'http://i.imgur.com/LE4UwJd.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_hotlockfolder.gif"]').attr('src', 'http://i.imgur.com/0NWbPuv.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_lockfolder.gif"]').attr('src', 'http://i.imgur.com/0NWbPuv.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_newfolder.gif"]').attr('src', 'http://i.imgur.com/qM3JIrf.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_newhotfolder.gif"]').attr('src', 'http://i.imgur.com/HNUOGI8.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_newhotlockfolder.gif"]').attr('src', 'http://i.imgur.com/0NWbPuv.png');
    $('img[src$="http://hackforums.net/images/modern_bl/dot_newlockfolder.gif"]').attr('src', 'http://i.imgur.com/0NWbPuv.png');
    $('img[src$="http://hackforums.net/images/modern_bl/folder.gif"]').attr('src', 'http://i.imgur.com/aJ2w6yP.png');
    $('img[src$="http://hackforums.net/images/modern_bl/hotfolder.gif"]').attr('src', 'http://i.imgur.com/43KhKX8.png');
    $('img[src$="http://hackforums.net/images/modern_bl/hotlockfolder.gif"]').attr('src', 'http://i.imgur.com/0NWbPuv.png');
    $('img[src$="http://hackforums.net/images/modern_bl/lockfolder.gif"]').attr('src', 'http://i.imgur.com/0NWbPuv.png');
    $('img[src$="http://hackforums.net/images/modern_bl/newfolder.gif"]').attr('src', 'http://i.imgur.com/RWNNegB.png');
    $('img[src$="http://hackforums.net/images/modern_bl/newhotfolder.gif"]').attr('src', 'http://i.imgur.com/zO3rsjP.png');
    $('img[src$="http://hackforums.net/images/modern_bl/newhotlockfolder.gif"]').attr('src', 'http://i.imgur.com/0NWbPuv.png');
    $('img[src$="http://hackforums.net/images/modern_bl/newlockfolder.gif"]').attr('src', 'http://i.imgur.com/0NWbPuv.png');
