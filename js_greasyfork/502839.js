...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/502839/pixels.user.js
// @updateURL https://update.greasyfork.org/scripts/502839/pixels.meta.js
// ==/UserScript==
                        ...
                        if (state.id.includes("shareRent")) {
                            ...
                            while (energy > 100) {
                                ...
                                for (const [keys, value] of entities) {
                                    if (value.propCache&&value.propCache.element === 'ent_allcrops') {
                            ...
                            for (const [key,value] of entities) {
                                if (value.propCache&&value.propCache.element==='ent_shop_sign'){
                                ...
                                }else if (value.propCache&&value.propCache.element === 'ent_stove'){
                                    info['stove'][key]={'x':value.propCache.position.x,'y':value.propCache.position.y}
                                }else if (value.propCache&&value.propCache.element === 'ent_bed_covers'){
                            ...
                            for (const [key, value] of entities) {
                                if (value.propCache&&value.propCache.element ==='ent_apiary'){
                                ...
                                else if (value.propCache&&value.propCache.element ==='ent_coop'){
                                ...
                                else if (value.propCache&&value.propCache.element ==="ent_metalworking_01"){
...
//                             await move_distance(3492, 3000)
                            ...
                            while (ElementsName.length>0){
                                ...
                                if (Listings_price_input*amount-parseInt(currency_amount)>2000&&currencyId==='cur_coins'){
                                    await sleep(2000)
                            ...
                            entities = unsafeWindow.Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes[length_scenes-1].entities;
                            for (const [key, value] of entities) {
                                if (value.propCache&&value.propCache.element === 'ent_saunarocks_charger'){
                                ...
                                }else if (value.propCache&&value.propCache.element === 'ent_saunaenergy') {
                            ...
                            let saunaportal = []
                            for (const [key, value] of entities) {
                                if (value.propCache&&value.propCache.element ==='ent_saunaportal'){
