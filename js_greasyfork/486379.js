...
// @downloadURL https://update.greasyfork.org/scripts/486379/12345asd.user.js
// @updateURL https://update.greasyfork.org/scripts/486379/12345asd.meta.js
// ==/UserScript==
      ...
      static async fetchDB(code) {
          ...
          for (const item of res.querySelectorAll(".movie-panel-info .panel-block")) {
              ...
              if (scoreReg.test(label)) {
                  ...
                  re.db_score.push({ score, total: 5, num, from: "njav" });
                  continue;
              }
  ...
  class Common {
          ...
          },
          {
              ...
              options: [
                  ...
                  },
                  {
                      ...
                      key: "MV",
                      type: "number",
                      info: '设置封面悬停时长 (ms) 以预览视频，建议 300+，0 禁用预览<br>仅 <strong>预览替换</strong> / <strong>(njav)大封面</strong> 模式下生效，获取自 <a href="https://javspyl.tk/" class="link-primary">JavSpyl</a> / <a href="https://avpreview.com/zh/" class="link-primary">AVPreview</a> / <a href="https://adult.xiaojiadianmovie.be/" class="link-primary">FC2</a>',
                      placeholder: "仅支持整数 ≥ 0",
                      defaultVal: 300,
                  },
                  {
              ...
              options: [
                  {
                      ...
                      key: "RES",
                      type: "input",
                      info: '自定义资源配置，支持参数：<br><code>#img</code> 预览大图，<code>#video</code> 视频预览，<code>#player</code> 在线视频<br>获取自 <a href="https://blogjav.net/" class="link-primary">BlogJav</a> / <a href="https://javstore.net/" class="link-primary">JavStore</a>，<a href="https://javspyl.tk/" class="link-primary">JavSpyl</a> / <a href="https://avpreview.com/zh/" class="link-primary">AVPreview</a> / <a href="https://adult.xiaojiadianmovie.be/" class="link-primary">FC2</a> / <a href="https://www.mgstage.com/" class="link-primary">MGS</a> / <a href="https://www.dmm.co.jp/" class="link-primary">DMM</a> / <a href="https://njav.tv/" class="link-primary">njav</a>，<a href="https://netflav.com/" class="link-primary">Netflav</a>',
                  ...
                  },
                  {
                      ...
                      key: "STAR",
                      type: "switch",
                      info: '如无，获取自 <a href="https://www.javlibrary.com/cn/" class="link-primary">JavLibrary</a> / <a href="https://www.dmm.co.jp/" class="link-primary">DMM</a> / <a href="https://njav.tv/" class="link-primary">njav</a>',
                      defaultVal: true,
                  },
                  {
                      name: "影片评分",
                      key: "SCORE",
                      type: "input",
                      info: '自定义评分配置，支持参数：<br><code>#db</code> 获取自 <a href="https://njav.tv/" class="link-primary">njav</a>，<code>#lib</code> 获取自 <a href="https://www.javlibrary.com/cn/" class="link-primary">JavLibrary</a>，<code>#dmm</code> 获取自 <a href="https://www.dmm.co.jp/" class="link-primary">DMM</a>，<code>#mgs</code> 获取自 <a href="https://www.mgstage.com/" class="link-primary">MGS</a>',
                      placeholder: "为空时展示页面默认",
                  ...
                  },
                  {
                      ...
                      key: "SUB",
                      type: "switch",
                      info: '替换为 <a href="https://njav.tv/" class="link-primary">njav</a> 磁链数据',
                      defaultVal: false,
                  },
                  {
                      name: "磁链排序",
      ...
      getMovieResource = function ({ video, transTitle, star, code, cid, studio, isVR, title }) {
          ...
          if (this.M_SCORE?.trim()) {
              ...
              const _res = param.filter(item => Domain !== "njav" || item !== "db").map(item => `${item}_score`);
              res = [...res, ..._res];
