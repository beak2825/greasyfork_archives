...
// @downloadURL https://update.greasyfork.org/scripts/551437/BARNAUL%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%9A%D0%A4%D0%97%D0%93%D0%9A%D0%A4%D0%93%D0%A1%D0%97%D0%93%D0%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/551437/BARNAUL%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%9A%D0%A4%D0%97%D0%93%D0%9A%D0%A4%D0%93%D0%A1%D0%97%D0%93%D0%A1.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]2.28.[/color] Запрещена покупка/продажа внутриигровой валюты в любых ее проявлениях за реальные деньги [Color=#ff0000]| PermBan с обнулением аккаунта + ЧC проекта[/color].[/COLOR]<br><br>"+
...
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zv50wL7h/57-20250815142452.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=#ff0000]Заместителю Главного Администратора[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=WHITE] Приятной игры на сервере [/COLOR][COLOR=CORNFLOWERBLUE] BARNAUL [/COLOR]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/sgF1TpSn/2776718330-preview-P84-Rw.png[/img][/url]<br>",
	  prefix: PINN_PREFIX,
	  status: true,
},
{
   title: '| Главному администратору |',
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zv50wL7h/57-20250815142452.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба передана на [COLOR=#ffff00]рассмотрение[/COLOR] [COLOR=#ff0000]Главному администратору[/COLOR]<br><br>"+
                "[B][CENTER][COLOR=WHITE] Приятной игры на сервере [/COLOR][COLOR=CORNFLOWERBLUE] BARNAUL [/COLOR]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/sgF1TpSn/2776718330-preview-P84-Rw.png[/img][/url]<br>",
	  prefix: GA_PREFIX,
	  status: true,
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как нарушений со стороны данного игрока не было найдено. <br><br>"+
               ...
               "[B][CENTER][COLOR=WHITE] Приятной игры на сервере [/COLOR][COLOR=CORNFLOWER BLUE] BARNAUL [/COLOR]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/sgF1TpSn/2776718330-preview-P84-Rw.png[/img][/url]<br>",
      prefix: UNACCCEPT_PREFIX,
	  status: false,
},
...
},
{
	  ...
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zv50wL7h/57-20250815142452.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=AQUA][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#FF0000]отказана[/COLOR], так как с момента совершенного нарушения со стороны игрока прошло более 72 часов. Cрок написания жалобы составляет три дня (72 часа) с момента совершенного нарушения со стороны игрока сервера.<br><br>"+
                "[B][CENTER][COLOR=lavender]Убедительная просьба ознакомиться с правилами подачи жалоб на игроков, закрепленные в данном разделе.<br>"+
                "[B][CENTER][COLOR=WHITE] Приятной игры на сервере [/COLOR][COLOR=CORNFLOWERBLUE] BARNAUL [/COLOR]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/sgF1TpSn/2776718330-preview-P84-Rw.png[/img][/url]<br>",
      prefix: UNACCCEPT_PREFIX,
