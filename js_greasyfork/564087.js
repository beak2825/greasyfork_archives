...
// @modifier     Christophero, lunzhiPenxil
// @version      2025.01.26.3
// @downloadURL https://update.greasyfork.org/scripts/564087/WoD%20%E7%89%A9%E5%93%81%E6%89%B9%E9%87%8F%E5%AD%98%E6%94%BE%E4%BB%93%E5%BA%93%5B%E6%94%B9%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/564087/WoD%20%E7%89%A9%E5%93%81%E6%89%B9%E9%87%8F%E5%AD%98%E6%94%BE%E4%BB%93%E5%BA%93%5B%E6%94%B9%5D.meta.js
// ==/UserScript==
...
(function () {
  ...
  // 非耗材入库状态key
  const AUTO_SAVE_DIS_CONSUMABLE = "wod_awesome_warehouse_save_dis_consumable";
  ...
  class Controller {
    constructor() {
      ...
      this.createAutoFunWithItemReturnToPosition(
        ...
        "非耗材入库",
        "将非耗材放入宝库",
        AUTO_SAVE_DIS_CONSUMABLE,
        ITEM_POSITION.GROUP,
        (select) => {
          selectBox.setGroup(select ? 0 : 2);
          this.autoSelectByDisConsumable(AUTO_SAVE_DIS_CONSUMABLE);
        }
      );
    ...
    autoSelectByDisConsumable(flag) {
      this.autoSelectBy(() => {
        selectBox.setConsumable(2);
      }, flag);
    }
