...
// @grant        GM_addStyle
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/419821/360%20tableIns.user.js
// @updateURL https://update.greasyfork.org/scripts/419821/360%20tableIns.meta.js
// ==/UserScript==
...
(function () {
    ...
    const initStyle = `#wrap{min-width:1280px!important;}
                        ...
                        .mvgrid table td {overflow: hidden;text-overflow: ellipsis; white-space: nowrap;}
   ...
   // trs[0].childNodes[10].insertAdjacentHTML("afterend", nickth);
    ...
    function render() {
        ...
        for (let i = 1; i < trs.length; i++) {
            ...
            const c =trs[i].querySelectorAll("td")[0].textContent[0]=="内" ?
                          trs[i].querySelectorAll("td")[0].textContent.slice(1) :
                          trs[i].querySelectorAll("td")[0].textContent;
            let d;
