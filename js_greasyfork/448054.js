// ==UserScript==
// @name         英华在线实训平台专门开发（颖宝专用）
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  自动连播网课
// @author       lingshu
// @match        *://wuhues.pinlankeji.com/user/node?*
// @match        *://wuhues.pinlankeji.com/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/448054/%E8%8B%B1%E5%8D%8E%E5%9C%A8%E7%BA%BF%E5%AE%9E%E8%AE%AD%E5%B9%B3%E5%8F%B0%E4%B8%93%E9%97%A8%E5%BC%80%E5%8F%91%EF%BC%88%E9%A2%96%E5%AE%9D%E4%B8%93%E7%94%A8%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/448054/%E8%8B%B1%E5%8D%8E%E5%9C%A8%E7%BA%BF%E5%AE%9E%E8%AE%AD%E5%B9%B3%E5%8F%B0%E4%B8%93%E9%97%A8%E5%BC%80%E5%8F%91%EF%BC%88%E9%A2%96%E5%AE%9D%E4%B8%93%E7%94%A8%EF%BC%89.meta.js
// ==/UserScript==
...
class Course {
	constructor(courseId) {
        this.prefixURL1 = 'https://wuhues.pinlankeji.com';
        this.prefixURL2 = 'https://wuhues.pinlankeji.com/user/study_record.json?courseId=';
        this.index = -1; //本视频索引
		this.nodeId = "";
		this.chapterId = "";
    ...
    parseIndex() { //分析当前视频索引
        ...
        for(let [k, v] of obj.entries()) {
            if(v.innerText == "章节测验") continue;
                ...
                v.href = `https://wuhues.pinlankeji.com/user/node?courseId=${this.courseId}&chapterId=${this.chapterId}&nodeId=${/nodeId=(\d+)/.exec(v.href)[1]}`;
                this._urls.push(v);
            }
        }
        //获取视频索引
...
class YHAssistant {
	constructor() {
        ...
        if(/\w+:\/\/wuhues\.pinlankeji\.com\/user\/node\?\S+/.exec(location.href)) this.init();
        else {
            this.initOther();
    ...
    exec() {
        ...
        if(this.course.finished && this.autoplay) { //该视频已完成
            ...
            if(confirm('恭喜, 宝子看完了"跳转至下一视频!')) { //确定
                this.jumpNext()
                return true;
            }
        }
...
function playBeep() {
    ...
    var beepURL = "http://music.163.com/song/media/outer/url?id=317151.mp3";
