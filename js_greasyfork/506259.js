// ==UserScript==
// @name         MouseHunt - Valour Treasure Map Colourer
// @author       auggy98
// @namespace    https://greasyfork.org/en/users/1361543-auggy98
// @version      1.0.1
// @description  Color codes mice on Valour Treasure Maps according to tiers. Max ML shown per group and AR shown individually.
// @match        http://www.mousehuntgame.com/*
// @match        https://www.mousehuntgame.com/*
// @include      https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js
// @downloadURL https://update.greasyfork.org/scripts/506259/MouseHunt%20-%20Valour%20Treasure%20Map%20Colourer.user.js
// @updateURL https://update.greasyfork.org/scripts/506259/MouseHunt%20-%20Valour%20Treasure%20Map%20Colourer.meta.js
// ==/UserScript==
// Credits:
// maidenless - I used their code as the starting point
...
const Tier1 = [
    ["Wound Up White","24.30%"],
    ["Hapless Marionette", "22.83%"],
    ["Toy Sylvan", "22.65%"],
    ["Clockwork Samurai", "14.11%"],
    ["Sock Puppet Ghost", "13.97%"],
    ["Puppet Master", "2.14%"]
];
const Tier2 = [
    ["Lockpick","20.12%"],
...
const miceGroups = [
    ...
    ["Tier 1", Tier1, 11, "Tier 1", 0, "#ff1100"],
    ["Tier 2", Tier2, 13, "Tier 2", 0, "#ff9100"],
    ["Tier 3", Tier3, 52, "Tier 3", 0, "#ffff00"],
    ["Tier 4", Tier4, 90, "Tier 4", 0, "#3cff00"],
    ["Tier 5", Tier5, 64, "Tier 5", 0, "#001aff"],
    ["Tier 6", Tier6, 84, "Tier 6", 0, "#8000ff"],
    ["Tier 7", Tier7, 100, "Tier 7", 0, "#ee00ff"],
    ["Tier 8", Tier8, 98, "Tier 8", 0, "#ff006f"]
];
