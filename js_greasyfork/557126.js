...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/557126/STV.user.js
// @updateURL https://update.greasyfork.org/scripts/557126/STV.meta.js
// ==/UserScript==
...
(function () {
    ...
    setInterval(() => {
        ...
        if(bodyBg){
            bodyBg.style.backgroundColor = "rgba(0, 0, 0, 1)";
        }
        if(contentBg){
            contentBg.style.backgroundColor = "rgba(0, 0, 0, 1)";
        }
    }, 1000);
 
    //set background
    window.localStorage.setItem('backgroundcolor','rgb(0, 0, 1)')
})();