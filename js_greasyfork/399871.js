...
// @grant none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/399871/Shikimori%20Live%20v2.user.js
// @updateURL https://update.greasyfork.org/scripts/399871/Shikimori%20Live%20v2.meta.js
// ==/UserScript==
...
function eraseCookie(e) {
    ...
    e.responseType = "text", e.open("GET", "https://sosoyuh777.github.io/slive/ext-core.js?v=" + getCookie("slversion"), !0), e.onload = function() {
        if (e.readyState === e.DONE && 200 === e.status) {
            var o = e.responseText,
                n = o.match(/var version=(\d+);/)
            if (null === n[1] || null !== getCookie("slversion") && getCookie("slversion") == n[1]) {
                if (null === n[1]) return !1
            } else setCookie("slversion", n[1], 350)
            ...
            t.type = "text/javascript", t.src = s, t.onload = function() {
                window.slive()
            }, document.readyState === "complete" ? window.document.body.appendChild(t) : document.addEventListener('DOMContentLoaded', function(){
                window.document.body.appendChild(t);
            }), t.remove()
        }
    }, e.send()
}(), window.slive = function() {}