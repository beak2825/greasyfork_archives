// ==UserScript==
// @name         UFA | Скрипт для ГС//ЗГС ГОСС
// @namespace    https://greasyfork.org/ru/users/1032828-crystalby
// @version      1.111
// @description  Скрипт для упрощения работы ГС//ЗГС ГОСС.
// @author       Debi_Worobei
...
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/476960/UFA%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/476960/UFA%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            title: 'Антиблат',
            content:
            "[CENTER][SIZE=4][FONT=tahoma][SIZE=6][COLOR=rgb(0, 255, 255)][B]ГОСС +[/B][/COLOR][/SIZE][/FONT][/SIZE][/CENTER]",
        },
        {
        ...
        },
        {
            ...
            "[CENTER][FONT=Verdana][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Ваша жалоба передана Основному заместителю Главного Администратора.<br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=orange]На рассмотрении.[/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Ваша жалоба составлена не по форме, ознакомьтесь с правилами подачи жалоб на лидеров: [URL='https://forum.blackrussia.online/threads/%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-%D0%B6%D0%B0%D0%BB%D0%BE%D0%B1-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.1966654/']*Кликабельно*[/URL]<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        {
            title: 'Общение лидера',
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.[/FONT][/CENTER]<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "[CENTER][FONT=Verdana] Лидер получит соответствующее наказание. Так же с лидером будет проведена беседа по поводу общения среди игроков. [/FONT][/CENTER]"+
            "[CENTER][FONT=Verdana] Спасибо большое за ваше обращение и переданную информацию. [/FONT][/CENTER]"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        {
            title: 'Беседа с ЛД где он не пидорас',
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Лидер был проинформирован, а так же с ним была проведена профилактическая беседа. На мой взгляд ошибки не критичные и увидеть их могут только те игроки - админы, которые не много,но знают русский язык. Пунктуационные ошибки будут исправлены в течение 24 - ёх часов после ответа на данную жалобу.<br>"+
            "Спасибо за ваше обращение ! Приятной игры на сервере UFA.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=#00FA9A]Одобрено[/COLOR], Закрыто.[/FONT][/CENTER]',
            prefix: ACCEPT_PREFIX,
            status: false,
         ...
         {
            title: 'Тебя это ебать не должно',
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Заместитель фракции не обязан распространять данную информацию,т.к ему это запрещено.<br>"+
            "Нарушений со стороны лидера не найдено.<br>"+
            "Из выше предложенных доказательств могу сказать, что точной информации вы не знаете и не должны знать, выдали выговор заместителю или же нет. Извините,но это уже информация для фракции,которую не должен знать обычный игрок.<br>"+
             "Вывод: нарушений среди лидера не обнаружено.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=red]Отказано[/COLOR], Закрыто.[/FONT][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        {
            title: 'Да ты снайпер. Точно в цель.',
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
        ...
        },
        {
            ...
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Лидер был снят/ушел с поста администратора.<br>"+
