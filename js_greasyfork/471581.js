...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/471581/BLACK%20%7C%20Forum%20Script%20%D0%B4%D0%BB%D1%8F%20%D0%A1%D1%82%D0%A5.user.js
// @updateURL https://update.greasyfork.org/scripts/471581/BLACK%20%7C%20Forum%20Script%20%D0%B4%D0%BB%D1%8F%20%D0%A1%D1%82%D0%A5.meta.js
// ==/UserScript==
    ...
    const buttons = [
        {
            ...
            content:
               `[CENTER] [CENTER][FONT=georgia][SIZE=4][COLOR=rgb(97, 189, 109)]Одобрено,[/COLOR] ждём вашего[COLOR=rgb(250, 197, 28)] [U]возвращения[/U]![/COLOR][/SIZE][/FONT]<br>`+
                `[FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
        ...
        },
       {
            ...
            content:
               ...
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
                `[SIZE=4][FONT=georgia][CENTER][COLOR=black] Приятной игры и времяпровождение  на сервере BLACK (10)[/COLOR][/FONT][/SIZE][/CENTER]`,
        },
        {
        ...
        },
        {
            ...
            content:
               ...
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
               `[COLOR=black][CENTER][FONT=georgia]Приятной игры и времяпровождение  на сервере BLACK (10)[/FONT][/COLOR][/CENTER]`,
        },
        {
            title: `Отказан выг`,
            content:
        ...
        {
            title: `Отказан 100/50к`,
            content:
               `[CENTER][B][I][I][I][SIZE=4][FONT=georgia][COLOR=rgb(226, 80, 65)]Отказано[/COLOR],[COLOR=rgb(255, 255, 255)] [U]Причина:[/U][/COLOR] обменять баллы можно только на[COLOR=rgb(250, 197, 28)][U] 100 или 50 k ИВ.[/U][/COLOR][/SIZE][/B][/FONT][/CENTER]<br><br>`+
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
               `[SIZE=4][FONT=georgia][CENTER][COLOR=black] Приятной игры и времяпровождение  на сервере BLACK (10)[/COLOR][/FONT][/SIZE][/CENTER]`,
        },
        {
            ...
            content:
               ...
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
               `[FONT=georgia][COLOR=black] Приятной игры и времяпровождение  на сервере BLACK (10)[/COLOR][/FONT][/I][/I][/I][/CENTER]`,
        },
        {
            ...
            content:
               ...
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
               `[FONT=georgia][COLOR=black] Приятной игры и времяпровождение  на сервере BLACK (10)[/COLOR][/FONT]`,
        },
        {
            title: `Не АП`,
            content:
               ...
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
               `[COLOR=black] Приятной игры и времяпровождение  на сервере BLACK (10)[/COLOR][/FONT][/CENTER]`,
        },
        {
            title: `Одобрено выше`,
            content:
        ...
        
{
           ...
           `[B][FONT=georgia][SIZE=4]Благодарим за бдительность.[/SIZE][/FONT][/B]<br>`+
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
           `[COLOR=black] [FONT=georgia]Приятной игры и времяпровождение  на сервере BLACK (10)[/FONT][/COLOR]
            [/CENTER]`,
},
{
           ...
           `[CENTER][B][FONT=georgia][SIZE=4][COLOR=rgb(235, 107, 86)]Отказано[/COLOR],[I] [U]Причина:[/U][/I] на [COLOR=rgb(250, 197, 28)][U]данную дату[/U][/COLOR] собрание [COLOR=rgb(250, 197, 28)][U]не планировалось.[/U][/COLOR][/SIZE][/FONT][/B]<br><br>`+
               `[SIZE=4][FONT=georgia][SIZE=4] С уважением [COLOR=rgb(243, 121, 52)]Администратор сервера [/COLOR] [color=black] BLACK.[/SIZE][/FONT][/CENTER]<br>`+
           `[CENTER][FONT=georgia][COLOR=black] Приятной игры и времяпровождение  на сервере BLACK (10)[/COLOR][/FONT]
            [/CENTER]`,
},
