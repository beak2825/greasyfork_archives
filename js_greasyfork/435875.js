    ...
    // ==UserScript==
    // @name         Scryfall - Image Hover [Full Card]
    // @namespace    http://tampermonkey.net/
    // @version      1.1
    // @description  Hover over images to show the fullsize card beside the mouse cursor.
    // @author       Gondola#7671
...
// @downloadURL https://update.greasyfork.org/scripts/435875/Scryfall%20-%20Image%20Hover%20%5BFull%20Card%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/435875/Scryfall%20-%20Image%20Hover%20%5BFull%20Card%5D.meta.js
    // ==/UserScript==
    ...
    $(document).ready(function(){
        ...
        $("body").append("<img id='img_hover_container' style='border-radius:30px; float:left; position:absolute; max-width:200px; overflow:hidden; z-index:9999;' src=''>")


        $(".card").mouseenter(function()
        {
            $("#img_hover_container").attr("src",$(this).attr('src').replace("normal","large"))
