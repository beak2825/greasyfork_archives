// ==UserScript==
// @name           Virtonomica: autosupply for shops
// @namespace      virtonomica
// @version        1.8
// @description    Автовыбор поставщиков в магазинах. Без ТМок
// @include        https://virtonomic*.*/*/window/unit/supply/create/*/step2
// @include        https://virtonomic*.*/*/main/unit/view/*/supply
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/39680/Virtonomica%3A%20autosupply%20for%20shops.user.js
// @updateURL https://update.greasyfork.org/scripts/39680/Virtonomica%3A%20autosupply%20for%20shops.meta.js
// ==/UserScript==
var run = function () {
  var price_q = {
  };
...
//    alert(price_quantifier);
    ...
    $('#supply_content table tr').each(function () {
      ...
      if (isNaN(price) || isNaN(qual)) {
        ...
        // return $(this).find('td:nth-of-type(4) img').
        // class="brandname_img"
        console.log(cels[0]);
        console.log($(cels[0]).hasClass('brandname_img'));
        console.log(cels[1]);
//      if (price < good_price && qual > good_quality && (!cels.parent().hasClass('myself') || (cels.parent().hasClass('myself') && cels.children('a:eq(0)').text() == "Терминал"))) {
      if (price < good_price && qual > good_quality && !$(cels[0]).hasClass('brandname_img')) {
