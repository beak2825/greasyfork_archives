...
// @namespace    none
// @version      0.3
// @description  UwU Mod Password : ThankYou
// @author       Nowzy
// @license      MIT
// @icon         https://upload.wikimedia.org/wikipedia/commons/6/6e/Uwunow.gif?20240605181358
// @match        *://moomoo.io/*
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/497145/UwU%20Mod%2003.user.js
// @updateURL https://update.greasyfork.org/scripts/497145/UwU%20Mod%2003.meta.js
// ==/UserScript==
/* KEYBINDS
    n - auto triple mills
    v - spikes
...
let changes = `<div id="subConfirmationElement"><a href="https://www.youtube.com/@The_Nowzy">Youtube</a></div>`;
...
document.getElementById("gameName").innerHTML = "UwU 𝕞𝕠𝕕";
let changes2 = `<div id="customMenuName"><h3 style="font-size: 50px;" class = "indent">�-UwU Mod-�</a></div>`;
...
document.getElementById("loadingText").innerHTML = `<div id="UwU Mod" class="loader">`
//document.getElementById("loadingText").innerHTML = "Please Wait..";
document.getElementById("diedText").innerHTML = "UwU Died :(";
document.getElementById("diedText").style.color = "#ed00ff";
document.title = "UwU 𝕞𝕠𝕕";
document.getElementById("leaderboard").append("UwU Mod !");
...
(function () {
    ...
    madeByLabel.textContent = "Made by Zod324myers Thank You Zod324myers";
...
$("body").after(`
  <div id="infomenu">
  <hr>
  <div class="nameblock">UWU 𝕞𝕠𝕕</div>
  <hr>
  <ul>
  ...
  <br> My youtube channel The_Nowzy <br>
  </ul>
  <hr>
  </div>
