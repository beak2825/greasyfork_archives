...
// @downloadURL https://update.greasyfork.org/scripts/28298/Hybrid%20-%20Calls%20-%20Mailing%20Address%202244.user.js
// @updateURL https://update.greasyfork.org/scripts/28298/Hybrid%20-%20Calls%20-%20Mailing%20Address%202244.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Mailing Address")').length) {
    ...
    createButton('No', 0,0,2,'This is not the business address');
    createButton('Past Address', 0,0,2,'The business used to be located at this address');
    createButton('Biz on VM', 0,0,2,'The business is listed on the voicemail but with no information pertaining to the contact');
    ...
    createButton('Personal VM', 0,2,2,'Voice mail did identify the contact but no title information'); //3
