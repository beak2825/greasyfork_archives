...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/556023/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D0%BE%D1%82%20Evans_Borzovich.user.js
// @updateURL https://update.greasyfork.org/scripts/556023/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D0%BE%D1%82%20Evans_Borzovich.meta.js
// ==/UserScript==hhhhhhhhhhhhhhhhttps://update.greasyfork.org/scripts/478810/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%94%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20SARATOV.user.js
    ...
    },
{
    ...
    "[B][CENTER][FONT=Arial][size=14px]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]Bless Russia[/color].[/FONT][/size][/CENTER][/B]",
       ...
       {
title: 'На рассмотрении Биография',
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 215, 0)',
	  content:
	 	"[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Ожидайте окончательного ответа! [/FONT][/size][/CENTER][/B]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]Выношу вердикт по вашей RolePlay Биографии - [COLOR=#FFA500]На рассмотрении...[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][size=14px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, команда Курирования форума Bless Russia [COLOR=rgb(255,200,0)]Bless Russia[/color].[/FONT][/size][/CENTER][/B]",
},
...
},
{
    ...
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[/COLOR][URL='https://forum.Blessrussia.com/index.php?forums/39/'] [U] «Жалобы на администрацию»[/U][/color].[/URL][/FONT][/size][/CENTER]<br><br>" +
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[/COLOR][URL='https://forum.Blessrussia.com/index.php?forums/37/'] [U] «Жалобы на лидеров»[/U][/color].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, команда Курирования форума Bless Russia [COLOR=rgb(255,200,0)]Bless Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
 	  "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[/COLOR][URL='https://forum.Blessrussia.com/index.php?forums/113/'] [U] «Обжалование наказаний»[/U][/color].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, команда Курирования форума Bless Russia [COLOR=rgb(255,200,0)]Bless Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[URL='https://forum.Blessrussia.com/index.php?forums/37/'] [U] «Жалобы на игроков»[/U].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, команда Курирования форума Bless Russia [COLOR=rgb(255,200,0)]Bless Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  ...
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Вы ошиблись разделом.[/FONT][/size][/CENTER]<br><br>"+
 	  "[B][CENTER][FONT=Arial][size=14px]Обратитесь в раздел[/COLOR][URL='https://forum.Blessrussia.com/index.php?forums/2/'] [U] «Технический раздел»[/U][/color].[/URL][/FONT][/size][/CENTER]<br><br>" +
	  "[B][CENTER][FONT=Arial][size=14px][COLOR=#ff0000]Закрыто.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, команда Курирования форума Bless Russia [COLOR=rgb(255,200,0)]Bless Russia[/color].[/FONT][/size][/CENTER][/B]",
    prefix: CLOSE_PREFIX,
...
move: 149,
 ...
 {
title: 'RED | Биография (отказ)',
   dpstyle: 'oswald: 3px;     color: #fff; background: #8B0000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #32CD32',
prefix: UNACCEPT_PREFIX,
move: 47,
    },
 {
title: 'RED | Биография (одобрено)',
   dpstyle: 'oswald: 3px;     color: #fff; background: #228B22; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #32CD32',
prefix: ACCEPT_PREFIX,
move: 46,
    },
 {
title: 'GREEN | Биография (Отказ)',
   dpstyle: 'oswald: 3px;     color: #fff; background: #8B0000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #32CD32',
prefix: ACCEPT_PREFIX,
move: 91,
    },
 {
title: 'GREEN | Биография (Одобрено)',
   dpstyle: 'oswald: 3px;     color: #fff; background: #228B22; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #32CD32',
prefix: UNACCEPT_PREFIX,
move: 92,
   },
 {
title: 'BLUE | Биография (отказ)',
   dpstyle: 'oswald: 3px;     color: #fff; background: #8B0000; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #32CD32',
prefix: UNACCEPT_PREFIX,
move: 144,
    },
 {
title: 'BLUE | Биография (одобрено)',
   dpstyle: 'oswald: 3px;     color: #fff; background: #228B22; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #32CD32',
prefix: ACCEPT_PREFIX,
move: 143,
    },
    ...
    $(document).ready(() => {
      ...
      addAnswers();
            addButton('Взять на рассмотрение', 'selectBiographyAnswer', 'border-radius: 13px; margin-right: 5px; margin-left: 5px; margin-bottom: 5px; border: 2px solid; background: #483D8B');
...
$('.button--icon--reply').before(`<button type="button" class="button--cta uix_quickReply--button button button--icon button--icon--write rippleButton" id="selectComplaintAnswer2" style="oswald: 3px; margin-bottom: 5px; border-radius: 13px; background: #483D8B;">Перенаправление жалобы</button>`,
	);
	}
