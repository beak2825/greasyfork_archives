...
// @author       You
// @match        https://managment.io/admin/banktransfer
// @grant        *
// @downloadURL https://update.greasyfork.org/scripts/421911/Methods%20view.user.js
// @updateURL https://update.greasyfork.org/scripts/421911/Methods%20view.meta.js
// ==/UserScript==
...
boxes_parent.className='recurring_element'
  ...
  function method_shower(method) {
    ...
    button.addEventListener("click", (event) => {
      ...
      let output =
        "Включите метод " + method + " и распределите трафик, пожалуйста: \r\n";
      ...
      if (counter_active == 0)
        navigator.clipboard.writeText("Выключите, пожалуйста, метод " + method);
...
function pdets(to_check_provider_id,node)
{ if(!make_req) return
  async function approved_withs(id) {
