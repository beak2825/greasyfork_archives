...
// -- FOOLSLIDE END
// @downloadURL https://update.greasyfork.org/scripts/440896/Manga%20Loader.user.js
// @updateURL https://update.greasyfork.org/scripts/440896/Manga%20Loader.meta.js
// ==/UserScript==
 
console.log('---loaded new manga loader .35--');
...
console.log('mautoload is', storeGet('mAutoload'));
 if (storeGet('mAutoload') === null || typeof storeGet('mAutoload') === 'undefined') {
    storeSet('mAutoload', true);
  }
  if (storeGet('mLoadNum') === null || typeof storeGet('mLoadNum') === 'undefined') {
    storeSet('mLoadNum', 2);
  }
// manually set by user in menu
var mAutoload = storeGet('mAutoload') || true;
// should we load less pages at a time?
var mLoadNum = storeGet('mLoadNum') || 2;
