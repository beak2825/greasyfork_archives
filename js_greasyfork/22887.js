...
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/22887/Krayagar.user.js
// @updateURL https://update.greasyfork.org/scripts/22887/Krayagar.meta.js
// ==/UserScript==
window.addEventListener('keydown', keydown);
window.addEventListener('keyup', keyup);
    //replaces title
    //h2 selects all h2 elements
    $("h2").replaceWith('<h2>Krayagar</h2>');
var Feed = false;
var Dingus = false;
var imlost = 25;
