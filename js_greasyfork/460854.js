...
// @author       啦A多梦
// @license      MIT
// @match        https://h5dghr.dshploiuvx.com/static/player/dplayer.html
// @icon         https://www.google.com/s2/favicons?sz=64&domain=dshpbcgsvz.com
// @grant        GM_setValue
// @grant        GM_getValue
// @grant        GM_log
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/460854/%E4%BF%AE%E6%94%B9%E6%B5%81%E6%96%87%E4%BB%B6%E6%96%B9%E5%BC%8F%EF%BC%88iPad%E4%B8%93%E7%94%A8%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/460854/%E4%BF%AE%E6%94%B9%E6%B5%81%E6%96%87%E4%BB%B6%E6%96%B9%E5%BC%8F%EF%BC%88iPad%E4%B8%93%E7%94%A8%EF%BC%89.meta.js
// ==/UserScript==
...
(function() {
    ...
    //记录上次观看进度
    var dpurl = window.location.pathname;
    if(document.querySelector("video") != null && GM_getValue("history") == undefined){
        GM_setValue("history", dpurl);
        setInterval(()=>{
            GM_setValue("historyStatus", document.querySelector("video").currentTime);
        },10000);
    }else if(document.querySelector("video") != null && GM_getValue("history") == dpurl){
        if(GM_getValue("historyStatus") > 0){
            let lasttime = GM_getValue("historyStatus");
            ...
            tips.innerText = "上次播放位置为" + vdoleng(GM_getValue("historyStatus"));
