// ==UserScript==
// @name NeoGAF Live Thread (modified by sharkiller)
...
// @grant unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/3581/NeoGAF%20Live%20Thread%20%28modified%20by%20sharkiller%29.user.js
// @updateURL https://update.greasyfork.org/scripts/3581/NeoGAF%20Live%20Thread%20%28modified%20by%20sharkiller%29.meta.js
// ==/UserScript==
...
function checkReponse(response) {
    ...
    function updatePage(posts, spacer) {
        ...
        unsafeWindow.mq_init(fetch_object("posts"));
