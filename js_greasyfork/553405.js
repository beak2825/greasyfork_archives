...
// @downloadURL https://update.greasyfork.org/scripts/553405/DH.user.js
// @updateURL https://update.greasyfork.org/scripts/553405/DH.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "FAN SHAO XUAN";
    const NEW_NAME = "CHIANG HAO HUNG";
    const NEW_BIRTHDAY = "(**1126)";
    const NEW_EXPIRE_DATE = "2032-12-24";
