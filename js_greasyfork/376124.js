...
// @homepage       https://greasyfork.org/en/users/83005
...
// @include        https://qrator.heroeswm.ru/*
...
// @grant          GM_log
// @grant          GM_openInTab
// @downloadURL https://update.greasyfork.org/scripts/376124/SetsMaster.user.js
// @updateURL https://update.greasyfork.org/scripts/376124/SetsMaster.meta.js
// ==/UserScript==
...
(function() {
    ...
    var script_name = "SetsMaster: Наборы армии, навыков и оружия – 3 в 1 (by Tamozhnya1 & Demin & перф & Небылица)";
    ...
    var nick = "_";
    if (document.body.innerHTML.match (/pl_hunter_stat\.php\?id=(\d+)/)) { nick = RegExp.$1 + "_"; }
