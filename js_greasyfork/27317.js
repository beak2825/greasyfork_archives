// ==UserScript==
// @name        NOTWHATCD :: Collage Building Helper
// @author      Z4ppy
// @namespace   Z4ppy.What.CD
// @description Make it easier to build your collage.
// @include     https://*notwhat.cd/torrents.php*
// @include     https://*notwhat.cd/collages.php*
// @include     https://*notwhat.cd/collage.php*
// @include     https://*notwhat.cd/artist.php*
// @include     https://*notwhat.cd/bookmarks.php*
// @grant       GM_setValue
// @grant       GM_getValue
...
// @version     1.0.1
// @date        2013-03-05
// @downloadURL https://update.greasyfork.org/scripts/27317/NOTWHATCD%20%3A%3A%20Collage%20Building%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/27317/NOTWHATCD%20%3A%3A%20Collage%20Building%20Helper.meta.js
// ==/UserScript==

var collageID, collName;
// Momenticons: http://findicons.com/icon/263495/folder_open_add
var ICON_ADD = 'http://i.imgur.com/snd3Doj.png=';
// Yusuke Kamiyamane: http://findicons.com/icon/118036/cross
var ICON_ERR = 'http://i.imgur.com/djo7YFS.png=';
// Yusuke Kamiyamane: http://findicons.com/icon/119015/tick
var ICON_OK = 'http://i.imgur.com/jCdKolj.png';
// ajaxload.info
...
var URL = new Object();
function parseURL() {
	var URLArr = document.URL.match(/^(https:\/\/(?:ssl\.)?notwhat\.cd)\/([\w\/\.]+?)(\?(.*?))?(#.*)?$/);
	URL.Host = URLArr[1]; //protocol + hostname, eg. https://notwhat.cd
	URL.Path = URLArr[2];
	URL.Hash = URLArr[5];
...
GM_registerMenuCommand("notwhat.cd :: Collage Building Helper - MathRange checkboxes", function() {
