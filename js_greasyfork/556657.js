...
// @downloadURL https://update.greasyfork.org/scripts/556657/KF_script.user.js
// @updateURL https://update.greasyfork.org/scripts/556657/KF_script.meta.js
// ==/UserScript==
...
const buttons = [
  ...
  '[CENTER][size=15px][font=georgia]Ваша жалоба взята [Color=rgb(255, 155 ,0)]на рассмотрение.[/color] <br> Ожидайте, пожалуйста, ответа от администрации и не нужно создавать копии этой темы.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на сервере [COLOR=Green]Green[/color]![/size][/font][/CENTER]',
        prefix: PINN_PREFIX,
        status: true,
      },
  {
...
},
{
 ...
 prefix: CLOSE_PREFIX,
  ...
  content:
    ...
    '[CENTER][size=15px][font=georgia][COLOR=LawnGreen]Одобрено[/COLOR], [COLOR=red]закрыто[/COLOR].[/FONT][/SIZE][/CENTER]<br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на сервере [COLOR=Green]Green[/color]![/size][/font][/CENTER]',
    ...
    },
   {
    ...
    '[CENTER][size=15px][font=georgia]Приятной игры на сервере [COLOR=Green]Green[/color]![/size][/font][/CENTER]',
	...
	},
      {
        ...
        content:
    '[CENTER][size=15px][font=georgia]{{ greeting }}, уважаемый [COLOR=rgb(247, 218, 100)] {{ user.name }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Выношу вердик по Вашей биографии - [color=YellowGreen]Одобрено[/color].[/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на сервере [COLOR=Green]Green[/color]![/size][/font][/CENTER]',
        prefix: RESHENO_PREFIX,
        status: false,
    },
