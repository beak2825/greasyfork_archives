...
// @downloadURL https://update.greasyfork.org/scripts/534305/Flying%20OC%20Alert%20PDA.user.js
// @updateURL https://update.greasyfork.org/scripts/534305/Flying%20OC%20Alert%20PDA.meta.js
// ==/UserScript==
                ...
                <div class="delimiter">
                    <div class="msg right-round messageContent___LhCmx">
                        <div style="display:flex;justify-content: space-between;align-items: center;">
                            ...
                            <div id="flying-oc-settings-button" class="btn torn-btn btn-action-tab btn-dark-bg" style="display:inline-block;float:right">
                                Settings
                            </div>
                        </div>
