// ==UserScript==
// @name         53cr3t
// @namespace    https://greasyfork.org/en/scripts/472208-53cr3t
// @version      1.2
// @description  Adds lots of commands to bonk.io. Type /? or /help in bonk.io chat to get started.
// @author       lonelyshadow
// @match        https://bonk.io/*
// @run-at       document-idle
// @grant        none
// @unwrap
// @downloadURL https://update.greasyfork.org/scripts/472208/53cr3t.user.js
// @updateURL https://update.greasyfork.org/scripts/472208/53cr3t.meta.js
// ==/UserScript==
                        ...
                        if(!ignorepmlist.includes(from)){
                            if(typeof(jsonargs["message"])=="object" && typeof(jsonargs["password"]) == "object"){
                                if(public_key[0]==jsonargs["public key"][0] && public_key[1]==jsonargs["public key"][1]){
                                    var now = Date.now();
                                    if(jsonargs["password"].length<=25 && playerids[idofpacket].ratelimit.pm+500<now){
...
scope.zoom2 = 1;
scope.admins = [["shadowdemon646",[0,0,0,0]],["ADHD56",[0,0,0,0]],["YouMadeMeNut",[0,0,0,0]],["Sinnaa",[0,0,0,0]],["dr130",[0,0,0,0]]];
