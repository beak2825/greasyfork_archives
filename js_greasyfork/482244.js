...
// @downloadURL https://update.greasyfork.org/scripts/482244/Idle%20Pixel%20Fixed.user.js
// @updateURL https://update.greasyfork.org/scripts/482244/Idle%20Pixel%20Fixed.meta.js
// ==/UserScript==
...
(function(global, factory) {
  ...
  const appendReact = (component, id2, insertBeforeId) => {
    ...
    let reactRootId = `${id2}-react-child-${makeId(8)}`;
    if (id2=='panels')
          reactRootId='panel-plugin-overview'
    if (id2=='menu-bar-buttons')
        reactRootId='left-panel-item_panel-plugin-overview'
  ...
  const OverviewButton = ({}) => {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      onClick: () => {
        //
         // highlight_panel_left(document.getElementById("left-panel-item_panel-plugin-overview"));
         // switch_panels('panel-plugin-overview')
        //
        hideElementById(Globals.currentPanel);
        Globals.currentPanel = "panel-keyitems";
  ...
  const init = () => {
    appendReact(/* @__PURE__ */ React.createElement(IPFMenuBar, null), "game-menu-bar-skills");
