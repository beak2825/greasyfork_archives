...
// @downloadURL https://update.greasyfork.org/scripts/562829/Maosiyuan.user.js
// @updateURL https://update.greasyfork.org/scripts/562829/Maosiyuan.meta.js
// ==/UserScript==
...
(function () {
    ...
    /************ 配置区 ************/
    const OLD_NAME = "CHENG FANJIA"; // 英文名字
    const NEW_NAME = "MAO SIYUAN"; // 新名字
    const NEW_BIRTHDAY = "(**1018)";
    const NEW_EXPIRE_DATE = "2035-12-01";
