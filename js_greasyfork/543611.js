// ==UserScript==
// @name   KF_script_By_Crown
// @name:ru  Кураторы форума
...
// @grant        none
// @license   MIT
// @supportURL  | Fantom_Crown Red
// @icon https://i.postimg.cc/ZKwZvbfd/Developer.png
// @downloadURL https://update.greasyfork.org/scripts/543611/KF_script_By_Crown.user.js
// @updateURL https://update.greasyfork.org/scripts/543611/KF_script_By_Crown.meta.js
// ==/UserScript==
...
const buttons = [
 ...
 prefix: CLOSE_PREFIX,
  ...
  content:
    ...
    "[QUOTE][FONT=Georgia][I][CENTER][COLOR=gold] 2.05. [/COLOR] Запрещены любые OOC обманы и их попытки, а также любые IC обманы с нарушением Role Play правил и логики [COLOR=Indigo] | Ban 5-30 дней / PermBan [/COLOR]<br><br>" +
...
},
{
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.13.[/color] Запрещен DB (DriveBy) — намеренное убийство / нанесение урона без веской IC причины на любом виде транспорта [COLOR=Indigo] | Jail 30 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
    ...
    },
    {
    ...
    },
     {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
       "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.20.[/color] Запрещен Mass DM [COLOR=gold](Mass DeathMatch)[/color] — убийство или нанесение урона трем и более игрокам без веской IC причины, при этом действия игрока должны иметь логическое объяснение в рамках сюжета и персонажа. [COLOR=Indigo] | Warn / Ban 3 - 30 дней[/COLOR][/QUOTE][/CENTER]<br><br>" +
          "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=Book Antiqua] ✦✧ Одобрено,[COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
        "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
  ...
  status: false,
    ...
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
       "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.08.[/color] Запрещена любая форма аморальных действий сексуального характера в сторону игроков [COLOR=Indigo] | Jail 30 минут / Warn / Ban 10-30 дней [/COLOR][/QUOTE][/CENTER]<br><br>" +
      "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=Book Antiqua] ✦✧ Одобрено,[COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
        "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    {
      ...
      content:
       "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]<br>" +
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.02.[/color] [COLOR=red]Запрещено[/color] целенаправленно уходить от[COLOR=gold] Role Play[/color] процесса различными способами — действия, которые мешают нормальному ролевому взаимодействию или препятствуют его продолжению. [COLOR=Indigo] | Jail 30 минут / Warn / Ban 1-30 дней [/COLOR][/QUOTE][/CENTER]<br><br>" +
          "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=Book Antiqua] ✦✧ Одобрено,[COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
        "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
        prefix: RESHENO_PREFIX,
        status: false,
    ...
    },
    {
    ...
    },
     {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
      "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.33.[/color]  [COLOR=red]Запрещено[/color] пользоваться уязвимостью правил [COLOR=Indigo] | На усмотрение руководства руководящей администрации сервера / проекта [/COLOR][/QUOTE][/CENTER]<br><br>" +
       "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено,[COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
        "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    ...
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.31.[/color] [COLOR=red]Запрещенo[/color] рекламировать на серверах любые проекты, серверы, сайты, сторонние Discord-серверы, YouTube каналы и тому подобное [COLOR=Indigo] | Mute 10-180 минут / Ban 7 дней / PermBan[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено,[COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
        "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
 {
    ...
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.44.[/color][COLOR=red]Запрещена[/color] продажа или покупка репутации семьи любыми способами, скрытие нарушителей, читеров лидером семьи. [COLOR=Indigo] | Обнуление рейтинга семьи / Обнуление игрового аккаунта лидера семьи[/COLOR][/QUOTE][/CENTER]<br><br>" +
         "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено,[COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
        "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.45.[/color] [COLOR=red]Запрещены[/color]  задержания, аресты, а также любые действия со стороны игроков, состоящих во фракциях в интерьере аукциона, казино, а также во время системных мероприятий [COLOR=Indigo] | Ban 7 - 15 дней + увольнение из организации[/COLOR][/QUOTE][/CENTER]<br><br>" +
         "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено,[COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
        "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]2.47.[/color] [COLOR=red]Запрещено[/color] располагать аксессуары на теле персонажа, нарушая нормы морали и этики, увеличивать аксессуары до слишком большого размера. [COLOR=Indigo] | При первом нарушении - обнуление аксессуаров, при повторном нарушении - обнуление аксессуаров + JAIL 30 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
            "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено,[COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
        "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    ...
    },
   {
    ...
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]3.09.[/color][COLOR=red]Запрещена[/color] выдача себя за администратора, если таковым не являетесь [COLOR=Indigo] |  Ban 7 - 15 дней + ОЧС администрации [/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено [COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
       "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
     {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]3.10.[/color][COLOR=red]Запрещено[/color] введение игроков проекта в заблуждение путем злоупотребления командами [COLOR=Indigo] |  Ban 15 - 30 дней / PermBan[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено [COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
       "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]3.11.[/color][COLOR=red]Запрещено[/color] подавать репорт написанный транслитом, с сообщением не по теме (Offtop), с включенным Caps Lock и повторять обращение (если ответ был уже дан ранее) [COLOR=Indigo] |  Report Mute 30 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено [COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
       "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]3.13.[/color][COLOR=red]Запрещено[/color] включать музыку в Voice Chat [COLOR=Indigo] | Mute 60 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено [COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
       "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]3.14.[/color][COLOR=red]Запрещено[/color] создавать посторонние шумы или звуки [COLOR=Indigo] | Mute 30 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено [COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
       "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]3.17.[/color][COLOR=red]Запрещено[/color] использование любого софта для изменения голоса [COLOR=Indigo] | Mute 60 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено [COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
       "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
    },
    {
      ...
      content:
        ...
        '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER][ICODE] Игрок будет наказан по пункту правил [/ICODE][/CENTER]<br><br>" +
        "[CENTER][QUOTE][COLOR=gold]3.18.[/color][COLOR=red]Запрещено[/color] использование транслита в любом из чатов  [COLOR=Indigo] | Mute 10-180 минут[/COLOR][/QUOTE][/CENTER]<br><br>" +
        "[CENTER][B][COLOR=rgb(0, 255, 0)][SIZE=4][FONT=times new roman] ✦✧ Одобрено [COLOR=#FF0000]Закрыто[/COLOR] ✧✦  [/FONT][/SIZE][/COLOR][/B][/CENTER]" +
       "<br>[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]",
      prefix: RESHENO_PREFIX,
      status: false,
