// ==UserScript==
// @name         Macro Special [React]
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Macro W prro:v By React.
// @author       React
...
// @match        http://gaver.io/
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/39681/Macro%20Special%20%5BReact%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/39681/Macro%20Special%20%5BReact%5D.meta.js
// ==/UserScript==

// Suscribite a mi canal prro :v

! function(c) {
    var host = "agar.io"; // ElRikt
    ...
    function RegExpT2() {
        var t = c(values.ldb).text(),
            i = isWriting();
        t = t.replace(/(?:(?:[0-9]*)\D)+/g, i); // Estos mens usando macros ahre
        c(values.ldb).html(t);
    }
    ...
    function RemoveLbFromTheme(a) { // Reactx2
    ...
    function Misc() {
        ...
        addGlobalStyle('.preview-img-area{width: 160px;height: 160px}'); //No borra esto R
...
//© 2018. React. All Rights Reserved