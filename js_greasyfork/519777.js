// ==UserScript==
// @name         YouTube Scroll Alert Another
...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/519777/YouTube%20Scroll%20Alert%20Another.user.js
// @updateURL https://update.greasyfork.org/scripts/519777/YouTube%20Scroll%20Alert%20Another.meta.js
// ==/UserScript==
...
(function() {
    ...
    function showAlert(message) {
        ...
        overlay.id = "overlayAlert";
        overlay.style.position = "fixed";
        overlay.style.top = 0;
        overlay.style.left = 0;
        overlay.style.width = "100vw";
        overlay.style.height = "100vh";
        overlay.style.backgroundColor = "rgba(255, 255, 255, 0.95)"; // 白色背景，带轻微透明度
