// ==UserScript==
// @name         Modded moo mod to mod modded moomoo mod
// @namespace    none
// @version      10.1
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/434693/Modded%20moo%20mod%20to%20mod%20modded%20moomoo%20mod.user.js
// @updateURL https://update.greasyfork.org/scripts/434693/Modded%20moo%20mod%20to%20mod%20modded%20moomoo%20mod.meta.js
// ==/UserScript==
...
<div id="ItemCount">Not defined...</div>
<style>
    #ItemCount {
        position: absolute;
        color: #fff;
    ...
    if (item === 'ch' && id != myID) {
        ...
        for (let i of what) {
            if (chat.toLowerCase().includes(i.toLowerCase())) {
                send.Packet("ch", "Name cheat: MooMooMod Last")
            }
        }
    }
    if (item === 'ch' && id == myID) {
