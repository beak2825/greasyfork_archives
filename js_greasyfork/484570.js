// ==UserScript==
// @name AudioBookBay hide category: SHTF
// @description Hide SHTF category
...
// @downloadURL https://update.greasyfork.org/scripts/484570/AudioBookBay%20hide%20category%3A%20SHTF.user.js
// @updateURL https://update.greasyfork.org/scripts/484570/AudioBookBay%20hide%20category%3A%20SHTF.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact word 'SHTF'
    $(".post").has(".postInfo:contains('SHTF')").hide();
});
