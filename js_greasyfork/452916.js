// ==UserScript==
// @name               AdBlock Script for WebView Debug
// @name:zh-CN         套壳油猴的广告拦截脚本 调试
// @author             Lemon399
// @version            2.8.6c
...
// @copyright          GPL-3.0
// @license            GPL-3.0
// @downloadURL https://update.greasyfork.org/scripts/452916/AdBlock%20Script%20for%20WebView%20Debug.user.js
// @updateURL https://update.greasyfork.org/scripts/452916/AdBlock%20Script%20for%20WebView%20Debug.meta.js
// ==/UserScript==
/* 以下部分是脚本猫的脚本配置，使用其他脚本管理器请忽略 */

/* ==UserConfig==
配置:
  rules:
    title: 自定义规则
    description: 添加自定义的 ABP 隐藏规则
    type: textarea
    rows: 10
    default: |-
      ! 不支持的规则和开头为 ! 的行会忽略
...
/* 脚本猫 脚本配置 结束 */
/* eslint-disable no-redeclare, no-unused-vars, require-yield, no-prototype-builtins */
/* global GM_info, GM, unsafeWindow, GM_registerMenuCommand, GM_unregisterMenuCommand, GM_getValue, GM_deleteValue, GM_setValue, GM_addStyle, GM_xmlhttpRequest, GM_getResourceText, GM_listValues, GM_download */
...
`,
    ...
    onlineRules: [
      {
        标识: `jiekouAD`,
        地址: `https://slink.ltd/https://raw.githubusercontent.com/damengzhu/banad/main/jiekouAD.txt`,
        在线更新: true,
        筛选后存储: true,
      },
      {
        标识: `CSSRule`,
        地址: `https://slink.ltd/https://raw.githubusercontent.com/damengzhu/abpmerge/main/CSSRule.txt`,
        在线更新: true,
        筛选后存储: false,
      },
    ],
  ...
  const $polyfills = {
        ...
        : {
            script: {
              ...
              resources: [
                {
                  name: "jiekouAD",
                  url: "https://slink.ltd/https://raw.githubusercontent.com/damengzhu/banad/main/jiekouAD.txt",
                },
                {
                  name: "CSSRule",
                  url: "https://slink.ltd/https://raw.githubusercontent.com/damengzhu/abpmerge/main/CSSRule.txt",
                },
              ],
              unwrap: false,
              version: "2.8.6c",
    ...
    parseValue: function parseValue(stored) {
      var _a;
      let value = void 0;
      const valid =
      ...
      try {
        value = valid
          ? (_a = JSON.parse(stored)[0]) !== null && _a !== void 0
            ? _a
            : void 0
          : void 0;
      } catch (_b) {
      ...
      typeof GM_getValue == "function"
        ...
        : function DM_getValue(key, defaultValue) {
            const stor = globalThis.localStorage.getItem(
              "$DMValue$AdBlock Script for WebView Debug$" + key,
            );
        ...
        : function DM_listValues() {
            ...
            for (
              ...
              if (
                key === null || key === void 0
                  ? void 0
                  : key.startsWith("$DMValue$AdBlock Script for WebView Debug$")
              ) {
                keysArray.push(
                  key.replace("$DMValue$AdBlock Script for WebView Debug$", ""),
                );
              }
            }
            return keysArray;
    ...
    GM_download:
      ...
      !Array.isArray(GM_download.toString().match(/load\(\) {};$/))
        ? GM_download
        : function DM_download(objectOrURL, filename) {
  ...
  ***************************************************************************** */
    ...
    const data = {
      ...
      alertLog: false,
      receivedRules: "",
      customRules: preset.userConfig.rules,
      allRules: "",
      genHideCss: "",
      genExtraCss: "",
      spcHideCss: "",
    ...
    function logger$1(type, ...data$1) {
      ...
      switch (type) {
        ...
        case "data": {
          console.table(data$1[0]);
          break;
        }
        case "color": {
          console.log(
            `%c ${data$1[0]}`,
            `display: inline-block; color: white; background: ${data$1[1]}; border-radius: .75em; padding: 2px 5px`,
            ...data$1.splice(2),
          );
          break;
        }
        case "count": {
          console.count(data$1[0]);
          break;
        }
      }
    }
    function speed(item, mark) {
      try {
        if (mark === "start") {
          logger$1("color", `${item} 开始`, "purple");
        ...
        logger$1("error", typeof error == "string" ? error : error.message);
      }
    }
    ...
    const values = {
        black(value) {
          return __awaiter(this, void 0, void 0, function* () {
            if (value === void 0) {
              const arrayString = yield gmValue(
                "get",
                false,
        ...
        rules(value) {
          return __awaiter(this, void 0, void 0, function* () {
            return value === void 0
              ...
              : yield gmValue("set", true, "ajs_saved_abprules", value);
          });
        },
        css(value_1) {
          return __awaiter(
            ...
            arguments,
            void 0,
            function* (value, host = location.hostname) {
              return value === void 0
                ? yield gmValue(
                    "get",
                    true,
                ...
                : yield gmValue("set", true, `ajs_saved_styles_${host}`, value);
            },
          );
        },
        time(value) {
          return __awaiter(this, void 0, void 0, function* () {
            return value === void 0
              ...
              : yield gmValue("set", false, "ajs_rules_ver", value);
          });
        },
        etags(value) {
          return __awaiter(this, void 0, void 0, function* () {
            return value === void 0
              ...
              : yield gmValue("set", true, "ajs_rules_etags", value);
          });
        },
        brules(value) {
          return __awaiter(this, void 0, void 0, function* () {
            return value === void 0
              ...
              : yield gmValue("set", true, "ajs_modifier_rules", value);
          });
        },
        hash(value) {
          return __awaiter(this, void 0, void 0, function* () {
            return value === void 0
              ...
              : yield gmValue("set", false, "ajs_custom_hash", value);
          });
        },
      },
      menus = {
        ...
        update: {
          ...
          text() {
            return __awaiter(this, void 0, void 0, function* () {
              var _a;
              const time =
                (_a = yield values.time()) !== null && _a !== void 0 ? _a : "0";
        ...
        count: {
          ...
          text() {
            return __awaiter(this, void 0, void 0, function* () {
              ...
              const cssCounts = yield getCssLength();
              return data.isClean
        ...
        export: {
          ...
          text() {
            ...
            return Promise.resolve(
              `下载统计报告 ${data.saved ? `CSS ${String(cssCount.split("*/").length - 1)}` : `规则 ${String(data.appliedCount)} / ${String(data.allRules.split("\n").length)}`}`,
            );
          },
        },
      };
    ...
    function gmChooser(gm1, gm4) {
      ...
      if (gm1 && gm4) {
        ...
        return (_a = gm1 !== null && gm1 !== void 0 ? gm1 : gm4) !== null &&
          _a !== void 0
          ? _a
          : void 0;
      }
    ...
    function gmMenu(name, callback) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (id !== void 0 && typeof gmu == "function") {
          logger$1("color", `删除菜单 ${name}`, "red");
          menus[name].id = void 0;
          yield gmu(id);
        }
        if (typeof callback == "function") {
          logger$1("color", `添加菜单 ${name}`, "green");
          menus[name].id = yield gmr(yield menus[name].text(), callback);
        }
        console.info(name, id, menus[name].id);
        logger$1("data", {
          菜单: "ID",
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (action) {
          case "get": {
            try {
              let v =
                (_a = gmChooser(tm.GM_getValue, tm.GM.getValue)) === null ||
                _a === void 0
                  ? void 0
              ...
              logger$1("error", "GM_getValue", error.message);
              return value;
            }
          }
          case "set": {
            try {
              return value === null || value === void 0
                ? void ((_b = gmChooser(
                    ...
                    ? void 0
                    : _b(key))
                : void ((_c = gmChooser(tm.GM_setValue, tm.GM.setValue)) ===
                    null || _c === void 0
                    ? void 0
                    : _c(key, json ? JSON.stringify(value) : value));
            } catch (error) {
              logger$1("error", "GM_setValue", error.message);
              return void ((_d = gmChooser(
                tm.GM_deleteValue,
                tm.GM.deleteValue,
              )) === null || _d === void 0
                ? void 0
     ...
     */
    function getUserConfig(property) {
      return __awaiter(this, void 0, void 0, function* () {
        var _a;
        return (_a = yield gmValue("get", false, `配置.${property}`)) !==
          null && _a !== void 0
          ? _a
    ...
    function addStyle(css_1) {
      return __awaiter(this, arguments, void 0, function* (css, pass = 0) {
        ...
        const element = yield (_a = gmChooser(
          tm.GM_addStyle,
          tm.GM.addStyle,
        )) === null || _a === void 0
          ? void 0
          : _a(css);
        logger$1("info", "<style>", element, pass);
        if (
    ...
    function promiseXhr(details) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        let loaded = false;
        const gmXhr = gmChooser(tm.GM_xmlhttpRequest, tm.GM.xmlHttpRequest);
        if (typeof gmXhr != "function") {
          throw {
            error: "noxhr",
          };
        }
        logger$1("info", "XHR 配置", details);
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          return yield (_a = gmChooser(
            ...
            tm.GM.getResourceText,
          )) === null || _a === void 0
            ? void 0
            : _a(key);
        } catch (error) {
          logger$1("error", "GM_getResourceText", error.message);
          return null;
        }
      });
    }
    ...
    function gmReport() {
      logger$1("data", {
        GM_getValue:
          typeof tm.GM_getValue == "function"
            ? tm.GM_getValue.name.startsWith("DM_")
              ? "DM"
              : "OK"
            : "NO",
        GM_setValue:
          typeof tm.GM_setValue == "function"
            ? tm.GM_setValue.name.startsWith("DM_")
              ? "DM"
              : "OK"
            : "NO",
        GM_listValues:
          typeof tm.GM_listValues == "function"
            ? tm.GM_listValues.name.startsWith("DM_")
              ? "DM"
              : "OK"
            : "NO",
        GM_deleteValue:
          typeof tm.GM_deleteValue == "function"
            ? tm.GM_deleteValue.name.startsWith("DM_")
              ? "DM"
              : "OK"
            : "NO",
        "GM.getValue": typeof tm.GM.getValue == "function" ? "OK" : "NO",
        "GM.setValue": typeof tm.GM.setValue == "function" ? "OK" : "NO",
        "GM.listValues": typeof tm.GM.listValues == "function" ? "OK" : "NO",
        "GM.deleteValue": typeof tm.GM.deleteValue == "function" ? "OK" : "NO",
        GM_registerMenuCommand:
        ...
        GM_download:
          typeof tm.GM_download == "function"
            ? tm.GM_download.name.startsWith("DM_")
              ? "DM"
              : "OK"
            : "NO",
        GM_getResourceText:
        ...
        GM_addStyle:
          typeof tm.GM_addStyle == "function"
            ? tm.GM_addStyle.name.startsWith("DM_")
              ? "DM"
              : "OK"
            : "NO",
      });
      logger$1("info", "GM_info", tm.GM_info);
      logger$1("info", "GM", tm.GM);
    }
    /**
     * 保证只运行一次
     * @async
     ...
     */
    function runOnce(key, function_) {
      return __awaiter(this, void 0, void 0, function* () {
        if (key in tm.unsafeWindow) {
          return yield Promise.reject(new Error(key));
        }
        tm.unsafeWindow[key] = true;
        const result = yield function_();
        return result;
      });
    }
    const OnErrorLogger = (error, source, line, col) => {
      logger$1("error", [error, source, line, col].join("\n"));
    };
    /**
     * 监听并打印脚本运行错误
     */
    function errorListen() {
      ...
      tm.unsafeWindow.onerror = OnErrorLogger;
    }
    /**
     * GM_download 代理
    ...
    function getSavedHosts(host) {
      return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        const keys =
          (_b = yield (_a = gmChooser(tm.GM_listValues, tm.GM.listValues)) ===
            null || _a === void 0
            ? void 0
            : _a()) !== null && _b !== void 0
            ? _b
            : [];
        logger$1("color", "values", "royalblue", keys);
        const domains = (
          Array.isArray(keys)
            ? keys
            : // Rains
    ...
    function getComment() {
      var _a;
      return (_a = tm.GM_info.script.options.comment) !== null && _a !== void 0
        ? _a
        : "";
    }
    /**
    ...
    function getCssLength() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const savedHost of savedHosts) {
          const co = yield values.css(void 0, savedHost);
    ...
    /**
     * @adguard/extended-css - v2.0.59 - Mon Dec 02 2024
   ...
   */
     ...
     */
    function domainChecker(domains, currentDomain = location.hostname) {
      var _a;
      const results = [],
        invResults = [],
        urlSuffix =
          (_a = /\.+?[\w-]+$/.exec(currentDomain)) === null || _a === void 0
            ? void 0
            : _a[0];
     ...
     * @returns {boolean} 结果
     */
    function hasSome(string_, array) {
    ...
    function ruleToCss(rule, preset, full) {
      ...
      return {
        css: `/* ${String(rule.type)}${rule.place} */ ${rule.sel + (isStyle ? "" : ",")} \n`,
        sel: isStyle
          ? (_b =
              (_a = CSRE.exec(rule.sel)) === null || _a === void 0
                ? void 0
                : _a[1]) !== null && _b !== void 0
            ? _b
            : rule.sel
    ...
    function cssToAbp(css) {
      var _a;
      const flags = ["##", "#?#", "#$#", "#$?#"];
      const [, typeString, isDomain, place, style, sel] =
        (_a = CCRE.exec(css)) !== null && _a !== void 0 ? _a : [];
      if (typeString === void 0) {
        return null;
      }
      const type = Number.parseInt(typeString);
      return {
...
（如果可以）立即清空脚本存储（全选，删除，填 {}，保存），然后删除脚本`)
          ...
          yield values.rules(null);
          yield values.time(null);
          yield values.etags(null);
          yield values.brules(null);
          const saves = yield getSavedHosts();
          for (const save of saves) {
            yield values.css(null, save);
          }
          data.isClean = true;
          yield gmMenu("update");
          yield gmMenu("export");
...
`;
      ...
      {
        logger$1("info", "页面地址: " + location.href);
        if (records.length > 0) {
          logger$1("data", records);
        }
      }
      if (text.length > 0) {
...
${text}`,
    ...
    function saveCss() {
      return __awaiter(this, void 0, void 0, function* () {
        if (data.autoCleanSize > 0) {
          ...
          logger$1("info", "总预存大小", cssLength, data.autoCleanSize);
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const sname of styleBoxes) {
          if (styles[sname].length > 0) {
            data.saved = true;
            data.update =
              (_b = styles.needUpdate) !== null && _b !== void 0 ? _b : true;
      ...
      return __awaiter(this, void 0, void 0, function* () {
        if (location.protocol === "https:") {
          const hash = new Uint32Array(
            yield globalThis.crypto.subtle.digest(
              "SHA-1",
              yield new Blob([data.customRules]).arrayBuffer(),
            ),
          ).toString();
          logger$1("color", "HASH", "magenta", hash, data.customRules);
          if (saveHash) {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        abpRules =
          (_a = yield values.rules()) !== null && _a !== void 0
            ? _a
            : defaultValues.rules;
        speed("@resource", "start");
        for (const rule of preset.onlineRules) {
          const resourceRule = yield getRuleFromResource(rule.标识);
          logger$1("data", {
            规则: rule.标识,
            values: abpRules[rule.标识].length,
            resource:
              resourceRule === null || resourceRule === void 0
                ? void 0
                : resourceRule.length,
          });
    ...
    function parseRules() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        function addRule(rule, box) {
          const { css, sel, isStyle } = ruleToCss(rule, data.preset);
          const index = (box % 2) + (rule.generic ? 0 : 2);
          const checkResult = ExtendedCss.validate(sel);
    ...
    function styleApplyExec(type) {
      const csss = data[styleBoxes[type]]
        ...
        .replaceAll("\n", "");
      if (csss !== "") {
        logger$1("info", "appling...", type, csss.length, csss);
        new ExtendedCss({
          styleSheet: csss,
        }).apply();
        if (!(type % 2 == 1)) {
    ...
    function extrEtag(resp) {
      const etag = getEtag(
        typeof resp.headers == "object"
          ? // 海阔世界
            resp.headers.etag[0]
          : typeof resp.responseHeaders == "string"
            ? // Tampermonkey
      ...
      logger$1("data", {
        monkey:
          typeof resp.responseHeaders == "string" ? resp.responseHeaders : null,
        hiker: resp.headers.etag[0],
        standard: resp.getAllResponseHeaders(),
        parsed: etag,
      });
      return etag;
    }
    ...
    function storeRule(rule, resp) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        logger$1(
          "info",
          "XHR 响应",
          (_b = resp.responseText) === null || _b === void 0
            ? void 0
            : _b.length,
        );
    ...
    function fetchRuleBody(rule) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const getResp = yield promiseXhr({
          ...
          data.alertLog &&
            logger$1("error", "规则: ", url, " 下载错误: ", error);
        });
        if (
          (_a =
    ...
    function fetchRuleGet(rule, resp) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        logger$1("info", "XHR HEAD 响应", resp);
        if (
          (_a = resp.responseText) === null || _a === void 0
            ? void 0
            : _a.length
        ) {
          logger$1("warn", "不支持 HEAD");
          ...
          if (
            ...
            return (yield fetchRuleBody(rule))
              ? undefined
    ...
    function fetchRule(rule) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (headResp) {
          yield fetchRuleGet(rule, headResp);
          return;
        } else {
          // Via HEAD 会超时，但可以得到 ETag
          if (
            (_a = headRespError.resp) === null || _a === void 0
              ? void 0
              : _a.responseHeaders
          ) {
            yield fetchRuleGet(rule, headRespError.resp);
          } else {
    ...
    function fetchRules() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        logger$1(
          "info",
          `在线规则 ${String(preset.onlineRules.length)} 个地址`,
        );
        for (const rule of preset.onlineRules) {
          if (rule.在线更新) {
            speed(`下载 ${rule.标识}`, "start");
            yield fetchRule(rule).catch((error) => {
              console.error("获取规则", rule, "发生错误:", error);
              hasUpdate--;
            });
            speed(`下载 ${rule.标识}`, "end");
          } else {
            hasUpdate--;
          }
        }
        logger$1("info", "在线规则下载结束");
    ...
    function performUpdate(force) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        force
          ? logger$1("color", "无条件更新", "darkslateblue")
          : logger$1(
              "color",
              "日期变更更新",
              "darkslateblue",
    ...
    function main() {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        // 初始化 data
        const blacks = yield values.black();
        data.disabled =
          (_a =
            blacks === null || blacks === void 0
              ? void 0
              : blacks.includes(location.hostname)) !== null && _a !== void 0
            ? _a
            : false;
        ...
        {
          logger$1("count", "执行次数");
          logger$1("info", "iframe: ", data.isFrame);
          gmReport();
          logger$1("data", {
          ...
          const blackss = yield values.black();
          const rules = yield values.rules();
          const time = yield values.time();
          const hash = yield values.hash();
          const etags = yield values.etags();
          const brules = yield values.brules();
          logger$1("data", {
            black:
              blackss === null || blackss === void 0
                ? void 0
                : blackss.join(","),
            rules: rules
              ? Object.keys(
            ...
            etags: etags
              ? Object.keys(
                  etags !== null && etags !== void 0
                    ? etags
                    : defaultValues.etags,
                ).join(",")
              : etags,
            hides:
              brules === null || brules === void 0 ? void 0 : brules.length,
          });
          logger$1("info", "禁用: ", location.hostname, data.disabled);
        }
        let finish = false;
        ...
        const hashNow = yield getCustomHash(false);
        const hashStored = yield values.hash();
        logger$1(
          "color",
          "应用预存 ?",
          "royalblue",
          yield getSavedHosts(location.hostname),
          data.saved,
          hashStored === hashNow,
        );
        saved: {
          yield makeInitMenu();
          if (hashStored !== hashNow) {
