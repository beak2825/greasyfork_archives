// ==UserScript==
// @name   🌱【免费版】南方教师在线|广东开放大学|清远市教师专业发展与管理平台|如需自动下一集、自动换课程、视频中途答题等高级功能见收费版本：https://doc.zhanyc.cn/pages/qysjs/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.3
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、视频中途答题、全自动无人值守高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*ttcn.cn/*
// @include    *://*chaoxing.com/*
// @include    *://*southteacher.com/*
// @include    *://*.ttcn.cn/*
// @include    *://*.chaoxing.com/*
// @include    *://*.southteacher.com/*
// @grant       GM_getValue
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/513551/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%8D%97%E6%96%B9%E6%95%99%E5%B8%88%E5%9C%A8%E7%BA%BF%7C%E5%B9%BF%E4%B8%9C%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%7C%E6%B8%85%E8%BF%9C%E5%B8%82%E6%95%99%E5%B8%88%E4%B8%93%E4%B8%9A%E5%8F%91%E5%B1%95%E4%B8%8E%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E8%A7%86%E9%A2%91%E4%B8%AD%E9%80%94%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesqysjs.user.js
// @updateURL https://update.greasyfork.org/scripts/513551/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%8D%97%E6%96%B9%E6%95%99%E5%B8%88%E5%9C%A8%E7%BA%BF%7C%E5%B9%BF%E4%B8%9C%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%7C%E6%B8%85%E8%BF%9C%E5%B8%82%E6%95%99%E5%B8%88%E4%B8%93%E4%B8%9A%E5%8F%91%E5%B1%95%E4%B8%8E%E7%AE%A1%E7%90%86%E5%B9%B3%E5%8F%B0%7C%E5%A6%82%E9%9C%80%E8%87%AA%E5%8A%A8%E4%B8%8B%E4%B8%80%E9%9B%86%E3%80%81%E8%87%AA%E5%8A%A8%E6%8D%A2%E8%AF%BE%E7%A8%8B%E3%80%81%E8%A7%86%E9%A2%91%E4%B8%AD%E9%80%94%E7%AD%94%E9%A2%98%E7%AD%89%E9%AB%98%E7%BA%A7%E5%8A%9F%E8%83%BD%E8%A7%81%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%EF%BC%9Ahttps%3Adoczhanyccnpagesqysjs.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需自动下一集、自动换课程、视频中途答题、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "https://doc.zhanyc.cn/pages/qysjs/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            ...
            if (url.includes("studyWorkVideo")
                || url.includes('fileRead')
                || url.includes('/RateLearning')) {
                plugMain.page_video();
            } else if (url.includes("/training/special/")) {
        ...
        async page_video() {
            ...
            await plugMain.waitOf(a => $(`[role="treeitem"]`).length > 0)

            await plugMain.waitTimeout(1000)
            if ($(".logo_text1").text() == '已完成') {
                plugMain.alertMsg("已经学完")
                return
            }
            plugMain.waitOf(a => plugMain.getElByText($(".btn1"), "继续学习") != null).then(a => {
                plugMain.getElByText($(".btn1"), "继续学习").click()
            })
            let timeout = 2;
            let lastTime = null;
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (location.href.includes('fileRead')) {
                        plugMain.pageData.waitTime = 15
                        plugMain.confirmRun("非视频任务，只学习10秒钟", 10 * 1000).then(a => {
                            location.href = plugMain.getGMData("RateLearningUrl", "/")
                        })
                        return
                    }
                    ...
                    if (plugMain.getElByText($(".ant-modal-title"), "随堂提问") != null) {
                        plugMain.pageData.waitTime = 15
