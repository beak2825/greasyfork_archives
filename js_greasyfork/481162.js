...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/481162/Combined%20KLAUS%20GAPPA.user.js
// @updateURL https://update.greasyfork.org/scripts/481162/Combined%20KLAUS%20GAPPA.meta.js
// ==/UserScript==
...
(function() {
    ...
    var x2amount = 0;
    var buchung = 20000;
    var buchungDecimal = "47";
    var buchungTextsZahl = "539.291";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10658326133") > 0 || window.location.href.indexOf("1047") > 0) {
...
if (KontosBoxElement) {
    ...
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10658327351") > 0  ) {
