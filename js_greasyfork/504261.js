...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/504261/WNBA%20Tabulka.user.js
// @updateURL https://update.greasyfork.org/scripts/504261/WNBA%20Tabulka.meta.js
// ==/UserScript==
...
(function() {
    ...
    function extractTeamData(selector, index) {
        ...
        if (tableData.length === 0) {
            console.error('No rows found in table index:', index);
        }
    ...
    function createTable(tableData, title, tableIndex) {
        if (tableData.length === 0) {
            console.error('No data available to create the table for index:', tableIndex);
            return;
        }
    ...
    function createTableWithTotals(selector, index, title) {
        console.log('Creating table with totals for index:', index);
