...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/533180/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20ensemble%20mansory.user.js
// @updateURL https://update.greasyfork.org/scripts/533180/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20ensemble%20mansory.meta.js
// ==/UserScript==
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Вы ошиблись разделом, обратитесь в раздел обжалований наказаний. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Вы ошиблись разделом, обратитесь в Технический раздел. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Вы ошиблись разделом, обратитесь в раздел Жалоб на технических специалистов <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
	  status: false,
...
"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
 {
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]У вашего персонажа nRP Nick_Name. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с [URL='https://forum.blackrussia.online/threads/kaluga-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D0%B7%D0%B4%D0%B0%D0%BD%D0%B8%D1%8F-%D0%B8-%D1%84%D0%BE%D1%80%D0%BC%D0%B0-role-play-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.9805301/']«правилами подачи RolePlay биографий» — *Кликабельно*[/URL]<br>"+
                "[FONT=times new roman][SIZE=4][COLOR=#FF0000]Отказано.[/COLOR][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
     prefix: UNACCСEPT_PREFIX,
 ...
 $(document).ready(() => {
    ...
    addButton('Ответ (для игроков)', 'selectAnswer' );
