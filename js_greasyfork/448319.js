// ==UserScript==
// @name         Magenta | KF SKRIPT by V Sherbakov
// @namespace    https://forum.blackrussia.online
// @version      4.0
// @description  Внимательнее прочьтите инструкцию. vk: miniibabyjon
// @author       Vlad Sherbakov
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @grant        none
// @license    MIT
// @icon https://ibb.co/tPLwdDh
// @downloadURL https://update.greasyfork.org/scripts/448319/Magenta%20%7C%20KF%20SKRIPT%20by%20V%20Sherbakov.user.js
// @updateURL https://update.greasyfork.org/scripts/448319/Magenta%20%7C%20KF%20SKRIPT%20by%20V%20Sherbakov.meta.js
// ==/UserScript==
...
const buttons = [
     {
      ...
      content: '[Color=Red][CENTER][ICODE]Отказано, закрыто.[/CENTER][/color]' + '[CENTER]  [/CENTER]',
    },
    {
      title: 'Одобрено, закрыто',
      content: '[Color=Green][CENTER][ICODE]Одобрено, закрыто.[/CENTER][/color]' + '[CENTER]  [/CENTER]',
    },
    {
      title: 'На рассмотрении...',
      content: '[Color=Orange][font=times new Roman][i][CENTER]На рассмотрении...[/CENTER][/font][/i][/color]' + '[CENTER] [/CENTER]',
    },
    {
    ...
    },
    {
      ...
      content:
		...
		'[Color=Green][CENTER][ICODE]Одобрено, закрыто.[/ICODE][/color][/FONT]',
    ...
    },
    {
	  ...
	  content:
		...
		'[Color=Red][CENTER][ICODE]Отказано, закрыто.[/ICODE][/color][/FONT]',
 ...
 title: 'Ссылка на ФА',
    ...
    },
    {
      ...
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из [URL='https://forum.blackrussia.online/index.php?threads/moscow-Правила-создания-и-форма-role-play-биографии.1809168/']Правила создания и форма Role-Play биографии[/URL].[/CENTER][/FONT]",
    ...
    },
    {
      ...
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Ваша RolePlay Биография Скоприрована [/URL].[/CENTER][/FONT]",
      prefix: OTKAZBIO_PREFIX,
	  status: false,
    },
    {
    ...
    title: '1 лицо',
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП биография получает статус: [Color=Red]Отказано.[/color]<br>Причина: Ваша РП биография написана от 1-го лица. Внимательно изучите [URL='https://forum.blackrussia.online/index.php?threads/moscow-Правила-создания-и-форма-role-play-биографии.1809168/']Правила Role-Play биографий[/URL][/CENTER][/FONT]",
      prefix: OTKAZRP_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER]Ваша РП ситуация получает статус: [Color=Red]Отказано.[/color]<br>Причиной отказа могло послужить какое-либо нарушение из [URL='https://forum.blackrussia.online/index.php?threads/moscow-Правила-role-play-ситуаций.1809166/']Правила Role-Play ситуаций[/URL][/CENTER][/FONT]",
      prefix: OTKAZRP_PREFIX,
	  status: false,
    },
    {
    ...
    },
   {
    ...
    },
    {
     ...
     {
     title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴Правила Каз/Клуб.╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    },
    {
    title: '2.01 Принятие за деньги',
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил: 2.01. Владельцу и менеджерам казино и ночного клуба запрещено принимать работников за денежные средства на должность охранника, крупье или механика.  | Ban 3-5 дней [/FONT][/I][/B][/CENTER] " +
		'[Color=Green][CENTER][ICODE]Одобрено, закрыто.[/ICODE][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
      {
      title: '2.02 Взимание налогов',
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил: 2.02. Владельцу и менеджерам казино и ночного клуба запрещено взимать у работников налоги в виде денежных средств за должность в казино | Ban 3 - 5 дней. [/FONT][/I][/B][/CENTER] " +
		'[Color=Green][CENTER][ICODE]Одобрено, закрыто.[/ICODE][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
    {
    title: '2.03 Кик без причины',
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил: 2.03. Охраннику казино запрещено выгонять игрока без причины | Увольнение с должности | Jail 30 минут. [/FONT][/I][/B][/CENTER] " +
		'[Color=Green][CENTER][ICODE]Одобрено, закрыто.[/ICODE][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
     {
    title: '3.01 Продал/передал СТО/казик',
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Игрок будет наказан по пункту правил:После покупки казино владелец обязан ждать срока окончания владения Казино/СТО - 15 суток. Запрещено продавать и передавать казино/СТО третьим лицам, продавать бизнес в государство и выкупать обратно, любые другие виды и способы сохранения бизнеса у себя | Ban 15 дней. [/FONT][/I][/B][/CENTER] " +
		'[Color=Green][CENTER][ICODE]Одобрено, закрыто.[/ICODE][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
	  status: false,
    },
     {
    title: 'Адм не увольняет из казика',
      content:
		'[Color=violet][FONT=times new roman][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][FONT=georgia][I][B]Администрация не увльняет сотрудников казино. [/FONT][/I][/B][/CENTER] " +
		'[Color=Red][CENTER][ICODE]Отказано, закрыто.[/ICODE][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
	  status: false,
    },
