// ==UserScript==
// @name         BetterAnime: Controles + Autoplay + Skip Opening + Recusar + Avançar Episódio + Botão Countdown
// @namespace    http://tampermonkey.net/
// @version      4.1
// @description  Adiciona painel para ativar/desativar pular abertura, recusar retomar, avançar episódio e botão de contagem regressiva no BetterAnime
// @match        https://betteranime.net/anime/*/episodio-*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/552095/BetterAnime%3A%20Controles%20%2B%20Autoplay%20%2B%20Skip%20Opening%20%2B%20Recusar%20%2B%20Avan%C3%A7ar%20Epis%C3%B3dio%20%2B%20Bot%C3%A3o%20Countdown.user.js
// @updateURL https://update.greasyfork.org/scripts/552095/BetterAnime%3A%20Controles%20%2B%20Autoplay%20%2B%20Skip%20Opening%20%2B%20Recusar%20%2B%20Avan%C3%A7ar%20Epis%C3%B3dio%20%2B%20Bot%C3%A3o%20Countdown.meta.js
// ==/UserScript==
    ...
    const waitForIframe = setInterval(() => {
        ...
        const videoCheck = setInterval(() => {
            ...
            if (video) {
                ...
                // Avançar episódio automaticamente ao fim
                if (settings.autoNext) {
                    ...
                    // === Botão de contagem regressiva ===
                    const countdownBtn = document.createElement('button');
                    countdownBtn.style.position = 'fixed';
                    countdownBtn.style.bottom = '20px';
                    countdownBtn.style.right = '20px';
                    countdownBtn.style.padding = '10px 20px';
                    countdownBtn.style.fontSize = '16px';
                    countdownBtn.style.background = '#28a745';
                    countdownBtn.style.color = '#fff';
                    countdownBtn.style.border = 'none';
                    countdownBtn.style.borderRadius = '5px';
                    countdownBtn.style.cursor = 'pointer';
                    countdownBtn.style.zIndex = '9999';
                    countdownBtn.style.display = 'none';
                    countdownBtn.textContent = 'Próximo episódio em 80s';
