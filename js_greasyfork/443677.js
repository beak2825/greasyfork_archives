...
// @namespace      https://userscripts-mirror.org/users/vovcacik modded by stig
// @license        Creative Commons Attribution-Share Alike http://creativecommons.org/licenses/by-sa/3.0/
// @grant          none
// @include        http://audiobookbay.li/*audio-books/*
// @resource       
// @downloadURL https://update.greasyfork.org/scripts/443677/Magnet%20Nipper.user.js
// @updateURL https://update.greasyfork.org/scripts/443677/Magnet%20Nipper.meta.js
// ==/UserScript==
...
function main() {
  ...
  function makeMagnet(hash) {
    ...
    desu="udp://tracker.desu.sh:6969";
    opentrackr="udp://tracker.opentrackr.org:1337/announce";
    tinyvps="udp://tracker.tiny-vps.com:6969/announce";
    vanitycore="udp://tracker.vanitycore.co:6969/announce";
    leechersparadise="udp://tracker.leechers-paradise.org:6969";
    baravik="http://tracker.baravik.org:6970/announce";
    wasabii="http://tracker2.wasabii.com.tw:6969/announce";
    ...
    return "<a href=magnet:?xt=urn:btih:"+hash+"&dn="+encodeURIComponent(name)+"&tr="+encodeURIComponent(explodie)+"&tr="+encodeURIComponent(desu)+"&tr="+encodeURIComponent(opentrackr)+"&tr="+encodeURIComponent(tinyvps)+"&tr="+encodeURIComponent(vanitycore)+"&tr="+encodeURIComponent(leechersparadise)+"&tr="+encodeURIComponent(baravik)+"&tr="+encodeURIComponent(wasabii)+"&tr="+encodeURIComponent(openbittorrent)+"&tr="+encodeURIComponent(publicbt)+"&tr="+encodeURIComponent(istole)+"&tr="+encodeURIComponent(ccc)+"><img src='data:image/gif;base64,' alt='Magnet link' border='0' width='14' height='14'/></a>";
  }
