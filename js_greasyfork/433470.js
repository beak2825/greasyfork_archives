...
// @namespace    idk, idc
// @version      10.9.6
// @description  Why did u do this? Why u have 2 bully me? Why bully me?
...
// @downloadURL https://update.greasyfork.org/scripts/433470/WHYmod.user.js
// @updateURL https://update.greasyfork.org/scripts/433470/WHYmod.meta.js
// ==/UserScript==
...
`;
            ...
            const connectBot = code => {
                ...
                botws.onopen = async () => {
                    ...
                    await wait(100);
                    botws.emit(['sp', [{ name: ' Why bots', moofoll: '1', skin: "__proto__" }]]);
