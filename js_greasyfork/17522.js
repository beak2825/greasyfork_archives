...
// @run-at      document-end
// @version     3.0.7
// @downloadURL https://update.greasyfork.org/scripts/17522/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E5%8A%A9%E6%89%8B%E2%80%A2%E6%94%B92.user.js
// @updateURL https://update.greasyfork.org/scripts/17522/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E5%8A%A9%E6%89%8B%E2%80%A2%E6%94%B92.meta.js
// ==/UserScript==
...
(function (){
    ...
    var helperMenuBtns=(function(){
        ...
        function createHelperBtn(btn) {
            ...
            $(newnode).attr('id','').attr('href','javascript:void(0)').attr('data-key','fawgaggawhhju').attr('node-type','gfefadwafa').attr('onclick','').css({width:63}).html(html.replace(/[\u4E00-\u9FA5]{2,4}(\(.*\)|\uff08.*\uff09)?/,'\u7f51\u76d8\u52a9\u624b')).unbind();
            var o=$('<div class="fawggawg" style="display:inline-block;">').append(newnode)[0];
            btn.parentNode.insertBefore(o, btn.nextSibling);
            return o;
        }
        var helperBtn = $('.fawggawg'),helperMenu = $('#panHelperMenu'),
        menuFun = function() {
