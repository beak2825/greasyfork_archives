...
// @downloadURL https://update.greasyfork.org/scripts/29596/The%20West%20-%20westernblumis%20Toolkit.user.js
// @updateURL https://update.greasyfork.org/scripts/29596/The%20West%20-%20westernblumis%20Toolkit.meta.js
// ==/UserScript==
(function (fn) {
  ...
  WTK.DailyItemHelper = {
    ...
    getQuestsFromArray: function (questArray) {
      ...
      for (var quest of questArray) {
        ...
        if (quest.minLevel <= Character.level && (!quest.maxLevel || Character.level <= quest.maxLevel)) {
          var color = 'black';
          if (itCt < quest.amount)
            color = 'red';
          else if (itCt == quest.amount)
            color = 'blue';
          text += '<span style="color: ' + color + '";>' + ItemManager.get(itID).name + ' ' + itCt + '/' + quest.amount + '</span><br>';
        }
      }
      return text;
    },
    ...
    showDailyItems: function () {
      ...
      scrollPane.appendContent('<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.saloon + ':</b><br>' + gqa(dih.others) + '</div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.indianVillage + ':</b><br>' + gqa(dih.indianVillage) + '</div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.ghostTown + ':</b><br>' + gqa(dih.ghostTown) + '</div>' +
        '<div style="clear:both"></div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.monday + ':</b><br>' + gqa(dih.daily.monday) + '</div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.tuesday + ':</b><br>' + gqa(dih.daily.tuesday) + '</div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.wednesday + ':</b><br>' + gqa(dih.daily.wednesday) + '</div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.thursday + ':</b><br>' + gqa(dih.daily.thursday) + '</div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.friday + ':</b><br>' + gqa(dih.daily.friday) + '</div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.saturday + ':</b><br>' + gqa(dih.daily.saturday) + '</div>' +
        '<div style="float: left; padding: 10px 30px 5px 5px;"><b>' + WTKlang.sunday + ':</b><br>' + gqa(dih.daily.sunday) + '</div>' +
        '<div style="clear:both"></div>');
