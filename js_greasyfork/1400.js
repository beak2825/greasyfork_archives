...
// @version        09.06.24
// @downloadURL https://update.greasyfork.org/scripts/1400/rrtrace%20%28alt%29.user.js
// @updateURL https://update.greasyfork.org/scripts/1400/rrtrace%20%28alt%29.meta.js
// ==/UserScript==
            ...
            if (play_data[0][pl].id == elemInput.name) {
                ...
                for (var cf=0; cf<play_data.length-3; cf++) {
                    try {
                        ...
                        var x1 = play_data[cf][p].x+7;//*3;
                        var y1 = play_data[cf][p].y+7;//*3;
                        var x2 = play_data[cf+1][idx].x+7;//*3;
                        var y2 = play_data[cf+1][idx].y+7;//*3;
