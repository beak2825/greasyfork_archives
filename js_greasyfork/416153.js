/// ==UserScript==
// @name         Agar.io +200 Best Bots
// @namespace    Agar.io
// @version      2020 Version
// @description  New Twenty Twenty Bots bots for everygame like agar.io! Join Our Discord For Get Free Bots: discord.gg/cwJAGRR
// @author       2020
// @match       *.agar.io/*
// @match       *.agariotime.com/*
// @match       *.agar.bz/*
// @match       *.agar.red/*
// @match       *.agariopvp.eu/*
// @match       *.agarlove.com/*
...
// @match       *.kakobots.esy.es/*
// @match       *.127.0.0.1:3356/*
// @match       *.cellcraft.io/*
// @match       *.ugar.pw/*
// @match       *.agarios.com/*
// @match       *.mgar.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/416153/Agario%20%2B200%20Best%20Bots.user.js
// @updateURL https://update.greasyfork.org/scripts/416153/Agario%20%2B200%20Best%20Bots.meta.js
// ==/UserScript==
...
setTimeout(function() {
    ...
    var socket = io.connect('ws://dopegar-kemoisking.c9users.io:8081');
    var canMove = true;
