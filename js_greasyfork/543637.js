...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/543637/Bless%20Russia.user.js
// @updateURL https://update.greasyfork.org/scripts/543637/Bless%20Russia.meta.js
...

{
    ...
    "[B][CENTER][FONT=Arial][size=14px]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][FONT=Arial][size=14px]Причина отказа: [COLOR=#ff0026]Ваш текст[/COLOR][/FONT][/size][/CENTER]<br><br>"+
...
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5)',
	  content:
	  "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]В вашей биографии присутствует несколько [COLOR=#ff0026]ошибок:[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[B][CENTER][FONT=Arial][size=14px]Выношу вердикт - [COLOR=#ff0026]Отказано.[/COLOR][/FONT][/size][/CENTER]<br><br>"+
    "[CENTER][size=15px][font=Arial]Благодарим вас за ваше обращение.[/size][/font][/CENTER]<br>"+
    "[B][CENTER][FONT=Arial][size=14px]С уважением, Старшая Администрация [COLOR=rgb(255,200,0)]Bless Russia[/color].[/FONT][/size][/CENTER][/B]",
},
{
    ...
    dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5',
	  content:
    "[B][CENTER][FONT=Arial][size=14px][CENTER]Приветствую, уважаемый игрок [COLOR=orange] {{ user.name }}[/color].[/FONT][/size][/CENTER]<br>" +
	  "[B][CENTER][FONT=Arial][size=14px]Ваша RolePlay биография (ваш текст).[/FONT][/size][/CENTER]<br><br>"+
...

{
 ...
 move: 47,
    ...
    $(document).ready(() => {
      ...
      addButton('ПЕРЕМЕЩЕНИЕ RED', 'selectMoveTask', 'border-radius: 13px; margin-right: 5px; margin-bottom: 5px; border: 2px solid; background: #4682B4');
      addButton('ПЕРЕМЕЩЕНИЕ GREEN', 'selectMoveTask2', 'border-radius: 13px; margin-right: 5px; margin-bottom: 5px; border: 2px solid; background: #4682B4');
