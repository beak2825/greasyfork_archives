...
// @name        VTEPA_DMG
// @namespace   localhost
// @description VTEPA_DMG_info
// @include     http://primera.e-sim.net/militaryUnitStorage.html*
// @include     http://primera.e-sim.org/militaryUnitStorage.html
// @version     2
// @downloadURL https://update.greasyfork.org/scripts/16029/VTEPA_DMG.user.js
// @updateURL https://update.greasyfork.org/scripts/16029/VTEPA_DMG.meta.js
// ==/UserScript==
...
$(document).ready(function() {
	...
	// JSONP betöltése
    var url = "http://mkhl.php5.sk/VTEPA/dmg_vtepa.php?callback=parseRequest";
    var script = document.createElement("script");  
