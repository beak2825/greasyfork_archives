// ==UserScript==
// @name         Lost mod for moo moo io remake
// @namespace    FZ was astonished
// @version      1
// @description working Lost Mod
...
// @icon         https://moomoo.io/img/icons/crown.png
...
Anti-Trap Chat (if enabled) <input type="text" id="antiTrapChat" checked value="~|>Lost Anti Trap<|~"><br>
...
<div class="i-palomita">Made By : Lost_Gaming and <a href="https://www.youtube.com/channel/UCfPlaEXq5BWJQzRwr5Qywwg?sub_confirmation=1">FZ</a></div>
</div>
                    ...
                    if (n) switch (t) {
                        ...
                        */
                        ...
                        case "ch":
                            ...
                            break;
                        case "2":
                            null != names[n[1][1]] ? names[n[1][1]] != n[1][2] ? (console.log("{", names[n[1][1]], "} => {", n[1][2], "} [", n[1][1], "]"), cPlayer && chat("{" + names[n[1][1]] + "} => {" + n[1][2] + "}")) : (console.log("{", names[n[1][1]], "} will die"), cPlayer && chat("{" + names[n[1][1]] + "} will die")) : (console.log("{", n[1][2], "} [", n[1][1], "]"), cPlayer && chat("{" + n[1][2] + "} [" + n[1][1] + "]")), names[n[1][1]] = n[1][2], theirPrimary[n[1][1]] = 0, theirSecondary[n[1][1]] = void 0;
                            break;
                        case "6":
