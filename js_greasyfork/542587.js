...
// @run-at      document-end
// @downloadURL https://update.greasyfork.org/scripts/542587/Qiuwei%20Chat%20Assistant.user.js
// @updateURL https://update.greasyfork.org/scripts/542587/Qiuwei%20Chat%20Assistant.meta.js
// ==/UserScript==
        ...
        container.innerHTML = `
            ...
            <div class="ant-card-body">
                ...
                <div>
                    ...
                    <div id="result-container" contenteditable="true" class="ant-input ant-textarea" style="min-height: 150px; max-height: 600px; overflow-y: auto; word-break: break-all; white-space: pre-wrap;" placeholder="结果将显示在这里..."></div>
                </div>
            </div>
        `;
