...
// @downloadURL https://update.greasyfork.org/scripts/2036/Pagar%20Comunidad.user.js
// @updateURL https://update.greasyfork.org/scripts/2036/Pagar%20Comunidad.meta.js
// ==/UserScript==
...
razon[0]=0;  
    ...
    for(pago=0; pago<nombre.length; pago++){
        ...
        cartel.innerHTML = "enviando pago "+pago+" de "+(nombre.length-1);
