...
// @downloadURL https://update.greasyfork.org/scripts/550670/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98SVIP%E8%A7%A3%E6%9E%90%E9%AB%98%E9%80%9F%E4%B8%8B%E8%BD%BD-%E5%BA%A6%E5%A8%98%E5%8A%A0%E9%80%9F.user.js
// @updateURL https://update.greasyfork.org/scripts/550670/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98SVIP%E8%A7%A3%E6%9E%90%E9%AB%98%E9%80%9F%E4%B8%8B%E8%BD%BD-%E5%BA%A6%E5%A8%98%E5%8A%A0%E9%80%9F.meta.js
// ==/UserScript==
...
(function () {
    ...
    var config = {
        gonggao: "每8小时1次200G大文件解析，21次2G左右小文件解析，小文件解析等待时间1到10分钟左右！",
        host_list: {
            "1": "https://bdb.shzxkq.com",
            "2": "https://ty.shzxkq.com",
            "3": ""
        },
        bd_password: "asdf",
        title_name: "度娘加速",
        ...
        $('#downbtn_main').click(function () {
            ...
            <div class="layui-tab layui-tab-card" id="tab" lay-filter="demo">
                <ul class="layui-tab-title" style="">
                    <li class="layui-this my_tab_br" lay-id="1">大文件解析</li>
                    <li class="my_tab_br" lay-id="2">1.6G左右小文件解析</li>
                    ...
                    dropdown.render({
                        ...
                        click: function (obj) {
                            ...
                            if (String(obj.download_url).indexOf("http") == -1) {
                                layer.msg("排队解析中，请耐心等待1到5分钟后查询直链！！！！");
                                return false;
                            }
