...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/512293/Grant%27s%20Standard.user.js
// @updateURL https://update.greasyfork.org/scripts/512293/Grant%27s%20Standard.meta.js
// ==/UserScript==
    ...
    const buttons = [
        {
            title: 'Норматив',
            content:
            '[CENTER][B][COLOR=rgb(247, 218, 100)]1. NickName: [/COLOR]Nunzio_Grant<br>' +
            '[COLOR=rgb(247, 218, 100)]2. Уровень админ-прав: [/COLOR]1<br>' +
            '[COLOR=rgb(247, 218, 100)]3. Должность: [/COLOR]Младший Модератор<br>' +
            '[COLOR=rgb(226, 80, 65)]4. За какой день подается отчёт:[/COLOR] 07.10.2024<br>' +
            '[COLOR=rgb(251, 160, 38)]5. Скриншот нормы (/astats):[/COLOR] - <br>' +
            '[COLOR=rgb(247, 218, 100)]6. Дополнительные баллы (ссылка на фото):[/COLOR] - <br>' +
            '[COLOR=rgb(247, 218, 100)]7. Скриншот отчёта следящего/модератора форума ( если являетесь им ):[/COLOR] - <br>' +
            '[COLOR=rgb(97, 189, 109)]8. Примерное количество баллов:[/COLOR] - [/B][/CENTER]' ,
