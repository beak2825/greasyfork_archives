...
// @downloadURL https://update.greasyfork.org/scripts/31915/Chios%20System%20script.user.js
// @updateURL https://update.greasyfork.org/scripts/31915/Chios%20System%20script.meta.js
// ==/UserScript==
...
//Creates ease of use buttons
        ...
        var ns = '<button type="button" id="ns">(4) Not Sure</button>';
        $("#reasons").before("<br>");
        $("#reasons").before(oql);
        $("#oql").click(function(){
