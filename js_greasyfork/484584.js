// ==UserScript==
// @name AudioBookBay hide category: Westerns
// @description Hide Westerns category
...
// @downloadURL https://update.greasyfork.org/scripts/484584/AudioBookBay%20hide%20category%3A%20Westerns.user.js
// @updateURL https://update.greasyfork.org/scripts/484584/AudioBookBay%20hide%20category%3A%20Westerns.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Westerns'
    $(".post").has(".postInfo:contains('Westerns')").hide();
});
