// ==UserScript==
// @name AudioBookBay hide category: Horror
// @description Hide Horror category
...
// @downloadURL https://update.greasyfork.org/scripts/484554/AudioBookBay%20hide%20category%3A%20Horror.user.js
// @updateURL https://update.greasyfork.org/scripts/484554/AudioBookBay%20hide%20category%3A%20Horror.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Horror'
    $(".post").has(".postInfo:contains('Horror')").hide();
});
