// ==UserScript==
// @name         KasperAgar customes macro
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Be the best macro
// @author       Kasper agar
// @match        http://agar.io/*
// @grant        none
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/26249/KasperAgar%20customes%20macro.user.js
// @updateURL https://update.greasyfork.org/scripts/26249/KasperAgar%20customes%20macro.meta.js
// ==/UserScript==
...
var Dingus = false;
var imlost = 25;
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_e'> Press <b>E</b> or <b>2</b> to split 2x</span></span></center>";
...
document.getElementById("instructions").innerHTML += "<center><span class='text-muted'><span data-itr='instructions_q'> Made by KasperAgarYT</span></span></center>";
load();
function load() {
...
function keydown(event) {
    ...
    if (event.keyCode == 16 || event.keyCode == 16) { //( ͡° ͜ʖ ͡°)
        ilikedick();
    ...
    if (event.keyCode == 69 || event.keyCode == 69) {
        ilikedick();
        setTimeout(ilikedick, imlost);
    } // Split
    if (event.keyCode == 49) {
