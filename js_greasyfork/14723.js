// ==UserScript==
// @name         CSGOROLL.IT Bet-BOT
// @namespace    http://steamcommunity.com/profiles/76561197993156901/
// @version      0.4 Beta Release
// @description  A simple bot made to auto-bet on CSGOROLL.IT
// @author       2HIGH2FLY
// @match        http://www.csgoroll.it
// @include      http://csgoroll.it
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/14723/CSGOROLLIT%20Bet-BOT.user.js
// @updateURL https://update.greasyfork.org/scripts/14723/CSGOROLLIT%20Bet-BOT.meta.js
// ==/UserScript==
...
function getStatus() {
  ...
  if (hasSubString(a, 'rolled')) {
    ...
    return lastRollColor = getColor(b),
    'rolled'
  }
  return 'unknown'
}
