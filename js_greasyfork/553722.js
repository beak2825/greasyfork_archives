// ==UserScript==
// @name         官种保种统计2
// @namespace    https://greasyfork.org/zh-CN/scripts/553722
// @version      0.16.11
...
// @match        https://pterclub.net/userdetails.php?id=*
// @match        https://pterclub.net/getusertorrentlist.php?*&type=seeding*
...
// @grant        GM_addElement
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/553722/%E5%AE%98%E7%A7%8D%E4%BF%9D%E7%A7%8D%E7%BB%9F%E8%AE%A12.user.js
// @updateURL https://update.greasyfork.org/scripts/553722/%E5%AE%98%E7%A7%8D%E4%BF%9D%E7%A7%8D%E7%BB%9F%E8%AE%A12.meta.js
// ==/UserScript==
...
var config = [
  ...
  var PTER_SEED_URL = 'https://pterclub.net/getusertorrentlist.php';
...
function parseOneSeedPage(seedHtml, theConfig){
  ...
  for (var i = 0; i < seedList.length; i++) {
    ...
    if (theConfig.host == "pterclub.net") {
...
async function getSeedList(seedHtml, theConfig) {
    ...
    else if (theConfig.host == "pterclub.net"){
  ...
  (function () {
    ...
    if (window.location.host == "pterclub.net" && window.location.pathname.indexOf("getusertorrentlist.php") > 0 ){
