// ==UserScript==
// @name         r/place 2023 Canada GERMAN Overlay
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471297/rplace%202023%20Canada%20GERMAN%20Overlay.user.js
// @updateURL https://update.greasyfork.org/scripts/471297/rplace%202023%20Canada%20GERMAN%20Overlay.meta.js
// ==/UserScript==
...
if (window.top !== window.self) {
  addEventListener('load', () => {
    ...
    const loadOverlay = () => {
      const name = "canada";
      const url = "https://i.ibb.co/W6HjdRB/overlay-Canada-Germany.png";
      const x = 0;
      const y = 0;
      const width = 1000;
      const height = 1000;
