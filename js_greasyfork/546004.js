...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/546004/MZ%20-%20P%C3%A1gina%20de%20partidos.user.js
// @updateURL https://update.greasyfork.org/scripts/546004/MZ%20-%20P%C3%A1gina%20de%20partidos.meta.js
// ==/UserScript==
...
(function() {
    ...
    const colors = {
        ...
        "Desafío de Clash de Federaciones": "#b087c9",
    };
        ...
        document.querySelectorAll(".teams-wrapper dl").forEach(teamContainer => {
            ...
            function addBadge(teamElement, position) {
                ...
                if (!teamID && teamElement.innerHTML.includes("<strong>")) {
                    teamID = ""; // <--- PON ENTRE LAS COMILLAS DE AQUÍ LA ID DE TU EQUIPO
                }
