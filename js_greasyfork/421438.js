...
// @copyright		shubos
// @grant			none
// @downloadURL https://update.greasyfork.org/scripts/421438/%E4%B9%A6%E5%8D%9A%E5%A3%AB.user.js
// @updateURL https://update.greasyfork.org/scripts/421438/%E4%B9%A6%E5%8D%9A%E5%A3%AB.meta.js
// ==/UserScript==
...
var payurl = "https://bs.datacdn.cn/";	
	...
	if (isSearch&&notAdvsearch&&notBaoku) {
		...
		if ( isDuxiu||isCcelib) {
			...
			for (var i = 0; i < mybooks.length; i++) {
				...
				var scgAnchor=payurl+"ebook="+ssid;
	...
	if (myurl.indexOf("bookDetail.jsp?") != -1) {
		...
		if (myurl.indexOf("/views/specific/") == -1) {
			...
			*/
			...
			var oldstr="bookDetail.jsp?dxNumber=";
			var newstr="book.do?go=showmorelib&type=1&dxid=";
			var newAnchor=payurl+"ebook="+ssid;
