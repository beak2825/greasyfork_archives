...
// @grant        none
// @license      none
// @downloadURL https://update.greasyfork.org/scripts/472874/zentao4HAT-2.user.js
// @updateURL https://update.greasyfork.org/scripts/472874/zentao4HAT-2.meta.js
// ==/UserScript==
...
async function zentaoAssociate(){
    ...
    if(window.location.href.includes('bug-view-')||window.location.href.includes('story-view-')){
        ...
        const deviceListy = ['无需','HA','31','41','51','251','52','53','61','161','71','81','1001','933','119']
