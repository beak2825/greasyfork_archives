...
// @grant        unsafeWindow
// @connect      *
// @downloadURL https://update.greasyfork.org/scripts/38312/%E6%89%93%E5%8D%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/38312/%E6%89%93%E5%8D%A1.meta.js
// ==/UserScript==

(function() {
    'use strict';

    var html="用户名：<input type='text' id='username' value=''><br/>"+
             "密　码：<input type='password' id='password' value=''><br/>"+
             "设备ID：<input type='text' id='deviceId' value=''><p/>"+
    ...
    function loginClickin(deviceId,username,password){
        GM_xmlhttpRequest({//登录
            ...
            headers: {
                ...
                "User-Agent":"Dalvik/2.1.0 (Linux; U; Android 7.0.0; HUAWEI Y325-T00 Build/HUAWEIY325-T00)"
            },
            responseType:"json",
            data:JSON.stringify({"deviceId":deviceId,"password":password,"userAgent":"3/1.4.3;Android 7.0.0;HUAWEI;HUAWEI Y325-T00","username":username}),
    ...
    function clickin(ticket,longitude,latitude,place,note){
        ...
        GM_xmlhttpRequest({//打卡
            ...
            headers: {
                "ticket": ticket,
                "User-Agent":"Mozilla/5.0 (Linux; Android 7.0.0; HUAWEI Y325-T00 Build/HUAWEIY325-T00; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/64.0.3282.137 Mobile Safari/537.36 3/1.4.3;Android 7.0.0;HUAWEI;HUAWEI Y325-T00",
                "Content-Type": "application/json; charset=UTF-8",
