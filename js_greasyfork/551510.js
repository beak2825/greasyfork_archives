// ==UserScript==
// @name         TangThuVien.Net downloader
// @namespace    https://nntoan.com/
// @description  Tải truyện từ tangthuvien.net định dạng epub.
// @version      1.1.8
...
// @match        http://truyen.tangthuvien.net/doc-truyen/*
...
// @downloadURL https://update.greasyfork.org/scripts/551510/TangThuVienNet%20downloader.user.js
// @updateURL https://update.greasyfork.org/scripts/551510/TangThuVienNet%20downloader.meta.js
// ==/UserScript==
        ...
        $.widget('nntoan.mbDownloader', $.nntoan.mbDownloader, {
            _create: function () {
                ...
                this.options.xhr.chapter.data = $.extend(this.options.xhr.chapter.data, {
                    story_id: location.pathname.split('/')[3]
                });
