// ==UserScript==
// @name         TOP Kuma-Ku Theme
// @namespace    http://tampermonkey.net/
// @version      0.14
// @description  Kuma-Ku Pack from TOP, for Jstris
// @author       Oki, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/394338/TOP%20Kuma-Ku%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/394338/TOP%20Kuma-Ku%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/q9Z3KoL.png",30);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://imgur.com/WpxZiOw.png')";
...
function CustomSFXset(){
    ...
    this.died={url:"https://ecdldaiiere.github.io/Eddiez-Soundz/TOP_died.wav",abs:1,set:1};
...
function atGameStart() {
    ...
    img.onload = function(){
        ...
        bgctx.drawImage(img,48,112,485,562); // Or at whatever offset you like
    };
    img.src = "https://i.imgur.com/KBF3bGv.png";
...
queueCopy0.style.transform = "scale(0.75,0.75) translate(15px, 55px)"
queueCopy1.style.transform = "scale(0.7,0.7) translate(18px, 90px)"
queueCopy2.style.transform = "scale(0.6,0.6) translate(18px, 90px)"
queueCopy3.style.transform = "scale(0.6,0.6) translate(18px, 90px)"
queueCopy4.style.transform = "scale(0.6,0.6) translate(18px, 80px)"
...
var songsMP = [
"https://ecdldaiiere.github.io/Eddiez-Soundz/TOPsong1.mp3",
]

var songSP = "https://ecdldaiiere.github.io/Eddiez-Soundz/TOPsong1.mp3"
