// ==UserScript==
// @name         Combined Patric Edens only spar test
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/482103/Combined%20Patric%20Edens%20only%20spar%20test.user.js
// @updateURL https://update.greasyfork.org/scripts/482103/Combined%20Patric%20Edens%20only%20spar%20test.meta.js
// ==/UserScript==
...
(function() {
    ...
    var buchungTextsZahl = "5.399.593";
...
if (saldoLinechartElement) {
   ...
   var x7HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 400,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Test von Amadeus.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">400</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">400,00 EUR</span></div></div></div></div></li>';



            //document.getElementsByClassName("mkp-card-list")[1].innerHTML = save2HTML + x2HTML;
            //block spk-analytics.js;
            document.getElementsByClassName("mkp-card-list")[0].innerHTML = xHTML + x7HTML + saveHTML;
        }
...
if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
    ...
    var adjustmentAmount = 400.0; // The adjustment amount to use if "useSameAdjustmentAmount" is true
    var BALANCE_CONFIGS = [
