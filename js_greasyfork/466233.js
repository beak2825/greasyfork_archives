...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/466233/%E9%B8%AD%E5%A4%A7%E4%BD%93%E8%82%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/466233/%E9%B8%AD%E5%A4%A7%E4%BD%93%E8%82%B2.meta.js
// ==/UserScript==
                ...
                unsafeWindow.AjaxPost('/order/book', param1, function (o) {
                    ...
                    if (o.result == '1') {
                        ...
                        if ($('#tryinfo').attr('retry') == 'true') {
                            setTimeout(unsafeWindow.goonreserve, parseInt($('#tryinfo').attr('interval') == undefined ? 10000 : $('#tryinfo').attr('interval')));
