// ==UserScript==
// @name         Newrow Multi-Task Script BETA
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Multitask your work by embedding your class connect in the lesson page!
// @author       You
// @match        https://security-gateway.k12.com/*
// @match        https://learning.k12.com/d2l/le/enhancedSequenceViewer/*
// @icon         https://www.google.com/s2/favicons?domain=newrow.com
// @grant        GM_setValue
// @grant        GM_getValue
// @require      http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js
// @downloadURL https://update.greasyfork.org/scripts/434276/Newrow%20Multi-Task%20Script%20BETA.user.js
// @updateURL https://update.greasyfork.org/scripts/434276/Newrow%20Multi-Task%20Script%20BETA.meta.js
// ==/UserScript==

if (document.URL.includes('security-gateway') && !document.URL.includes('d2l')) {
...
setTimeout(function(){//Make this whole thing take place 1 second after the page loads
    ...
    //let link = 'https://discord.com/channels/799001730783772733/803335636874166342';
    ...
    <div id="newrowFrame" style="border-radius: 8px; resize: both; overflow: auto; position: absolute; padding: 10px; background-color: #fff; top: 10%; left: 1%; box-shadow: -2px 2px 3px 0px #00000050; border: 1px solid #808080; min-height: 280px; min-width: 365px; z-index: 1000;">
        ...
        <div id="iframeWrapper" style="width: 100%; height: 80%; padding: 0; overflow: hidden;">
            <iframe id="newrowIFrame" src="`+link+`" style="border-radius: 8px; width: 100%; height: 100%;"></iframe><hr>
        </div>
