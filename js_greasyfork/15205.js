...
$(document).ready(function(){
                ...
                var css = '.menuVisiteur{position:fixed;top:0;left:50px;-webkit-box-shadow:0px 2px 5px rgba(206, 12, 38, 0.22);-moz-box-shadow:0px 2px 5px rgba(206, 12, 38, 0.22);-khtml-box-shadow:0px 2px 5px rgba(206, 12, 38, 0.22);box-shadow:0px 2px 5px rgba(206, 12, 38, 0.22);position:fixed;z-index:2147;-webkit-border-radius:0px 0px 3px 3px;-moz-border-radius:0px 0px 3px 3px;-khtml-border-radius:0px 0px 3px 3px;border-radius:0px 0px 3px 3px;border-top:none!important;border:1px solid rgb(106,155,179);border:1px solid #CE0C26;_border:1px solid rgb(106,155,179);background:##010213 url("styles/realitygaming/images/main/pattern3-ts.png") repeat-x bottom!important;height:30px;line-height:10px;margin-top:-5px}';
...
$(document).ready(function(){
                ...
                var css = '.PageNav a.currentPage{color:#fff;background:url(rgba.php?r=20&g=122&b=191&a=127);background:##010213;_filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#7F147ABF,endColorstr=#7F147ABF);border-color: #CE0C26;position:relative}';
...
$(document).ready(function(){
    ...
    $(document).ready(function(){
                ...
                var css = '::-webkit-scrollbar-thumb{cursor:pointer!important;-webkit-border-radius:10px;-webkit-border-radius:0px;-moz-border-radius:0px;-khtml-border-radius:0px;border-radius:0px;background: #CE0C26;}';
    ...
    $('head').append('<style>' + css + '</style>');
     ...
     $(document).ready(function(){
                ...
                var css = '.primaryContent a{color:#CE0C26}';
    ...
    $('head').append('<style>' + css + '</style>');
     ...
     $(document).ready(function(){
                ...
                var css = '.message .publicControls .Author:hover{-webkit-border-radius:3px;-moz-border-radius:3px;-khtml-border-radius:3px;border-radius:3px;color:#CE0C26;-webkit-box-shadow:0px 0px 0px 1px rgba(44,110,188,0.4);-moz-box-shadow:0px 0px 0px 1px rgba(44,110,188,0.4);-khtml-box-shadow:0px 0px 0px 1px rgba(44,110,188,0.4);box-shadow:0px 0px 0px 1px rgba(206, 12, 38, 0.34)}';
...
$(document).ready(function(){
    ...
    var css = '.titleBar h1{color:#CE0C26}';
...
$(document).ready(function(){
    ...
    var css = '#taigachat_box{height:300px;border:1px solid #C51616;padding:5px;margin:5px -2px 0 -2px;overflow:auto;overflow-y:scroll;font-size:11px;background: #FFFFFF url("http://i.imgur.com/uU9AypH.jpg") center no-repeat;-webkit-text-size-adjust:none}';
...
$(document).ready(function(){
    ...
    var css = '.button.primary{background-color: #ce0c26;background-image:none;color:white;text-shadow:none}';
...
$(document).ready(function(){
    ...
    var css = '.secondaryContent a{color: #ce0c26;}';
...
$(document).ready(function(){
    ...
    var css = '.Popup .PopupControl:hover,.Popup.PopupContainerControl:hover{color:#ce0c26;text-decoration:none}}';
...
$(document).ready(function(){
    ...
    var css = '::-webkit-scrollbar-thumb:hover{background:#ce0c26}';
...
$(document).ready(function(){
    ...
    var css = '.helpSideBar a:hover{background-image:none;color:#ce0c26!important}';
...
$(document).ready(function(){
    ...
    var css = '.message .publicControls a.ReplyQuote:hover{text-decoration:none!important;color: #ce0c26;}';
...
$(document).ready(function(){
    ...
    var css = '.message .publicControls a.MultiQuoteControl:hover{text-decoration:none!important;color:#ce0c26}';
...
$(document).ready(function(){
    ...
    var css = '.xenOverlay .section,.xenOverlay .sectionMain{padding:0px;border:5px solid #032A46;-webkit-border-radius:3px;-moz-border-radius:3px;-khtml-border-radius:3px;border-radius:3px;-webkit-box-shadow:0px 20px 39px rgba(0,0,0,0.6);-moz-box-shadow:0px 20px 39px rgba(0,0,0,0.6);-khtml-box-shadow:0px 20px 39px rgba(0,0,0,0.6);box-shadow:0px 20px 39px rgba(0,0,0,0.6);border-color:rgb(3,42,70);border-color: rgba(206,12,38,0.5);_border-color:rgb(3,42,70)}';
...
$(document).ready(function(){
    ...
    var css = '.button:hover,.callToAction span:hover{border:none!important;background:url("http://i.imgur.com/9qvx5R0.png") no-repeat 98% 0%,url("http://i.imgur.com/7fUPWTv.png") no-repeat 2% 98%,url("http://i.imgur.com/dlDP7Ad.png") no-repeat 50% 2%;background-color: #010213}';
...
$(document).ready(function(){
    ...
    var css = '.sharePage .textHeading{color: #ce0c26!important;border-bottom: 1px dotted #ce0c26;}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie351{width:30px;height:30px;background:url(http://i.imgur.com/AGF6X12.png) no-repeat 0px -1px}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie352{width:30px;height:30px;background:url(http://i.imgur.com/YRADR1x.png) no-repeat 0px -1px}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie355{width:30px;height:30px;background:url(http://i.imgur.com/MoUfpMG.png) no-repeat 0px -1px}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie356{width:30px;height:30px;background:url(http://i.imgur.com/fP1up0l.png) no-repeat 0px -1px}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie357{width:30px;height:30px;background:url(http://i.imgur.com/zIXwgiN.png) no-repeat 0px -1px}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie358{width:30px;height:30px;background:url(http://i.imgur.com/muiyAQX.png) no-repeat 0px -1px}';
...
$(document).ready(function(){
    ...
    var css = 'img.mceSmilieSprite.mceSmilie359{width:30px;height:30px;background:url(http://i.imgur.com/3NTmCiI.png) no-repeat 0px -1px}';
