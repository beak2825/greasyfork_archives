// ==UserScript==
// @name	DC - Bullets alert - QC EDITION
// @author	Ladoria, Lorkah(fix), Shadows(Voice)
// @version	1
// @grant       none
...
// @namespace	InGame
// @downloadURL https://update.greasyfork.org/scripts/427049/DC%20-%20Bullets%20alert%20-%20QC%20EDITION.user.js
// @updateURL https://update.greasyfork.org/scripts/427049/DC%20-%20Bullets%20alert%20-%20QC%20EDITION.meta.js
// ==/UserScript==
...
$('body').append('<audio id="DC_bullets_low_charger" src="https://bacon-network.net/dreadcast/voix_rechargement_1.mp3" type="audio/waw"></audio><audio id="DC_bullets_empty_charger" src="https://bacon-network.net/dreadcast/voix_rechargement_2.mp3" type="audio/waw"></audio>');
