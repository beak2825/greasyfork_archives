...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/502812/%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D0%A3%D0%A0%D0%90%D0%A2%D0%9E%D0%A0%D0%90%D0%9C.user.js
// @updateURL https://update.greasyfork.org/scripts/502812/%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D0%A3%D0%A0%D0%90%D0%A2%D0%9E%D0%A0%D0%90%D0%9C.meta.js
// ==/UserScript==
 ...
 },
{
     title: 'Снижено до 7',
     content: '[Color=turquoise][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый уважаемый [B]{{ user.mention }}[/B].[/color][/CENTER]<br>' +
   "[CENTER]Ваше наказание будет снижено до 7 дней в течение 24-х часов.[/CENTER]<br><br>" +
   '[CENTER][COLOR=Lightgreen]Решено.[/CENTER]',
     prefix: RESHENO_PREFIX,
    status: false,
  },
...
{
     title: 'Возврат имущ конец',
     content: '[Color=turquoise][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый уважаемый [B]{{ user.mention }}[/B].[/color][/CENTER]<br>' +
   "[CENTER]Имущество было отдано в полном размере.Больше на поддавайтесь таким способом обмана..[/CENTER]<br><br>" +
   '[CENTER][COLOR=Lightgreen]Решено.[/CENTER]',
     prefix: RESHENO_PREFIX,
    status: false,
  },
...
{
     title: 'НЕ ГОТОВЫ ИДТИ НА ВСТРЕЧУ',
     content:'[Color=turquoise][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый уважаемый [B]{{ user.mention }}[/B].[/color][/CENTER]<br>' +
   "[CENTER]Мы не готовы пойти к вам на встречу.[/CENTER]<br><br>" +
   "[CENTER][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/CENTER]",
     prefix: UNACCEPT_PREFIX,
    status: false,
  },
  {
     ...
     content: '[Color=turquoise][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый уважаемый [B]{{ user.mention }}[/B].[/color][/CENTER]<br>' +
"[CENTER]Мы не уверены, что Вы осознали вину своего нарушения.[/CENTER]<br><br>"+
   ...
   "[CENTER][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/CENTER]",
    ...
    status: false,
     ...
     title: 'Обж с постр',
     content: '[Color=turquoise][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый уважаемый [B]{{ user.mention }}[/B].[/color][/CENTER]<br>' +
"[CENTER]Обжалование должно подаваться со строны потерпевшего.[/CENTER]<br><br>"+
  ...
  },
 {
     title: 'Сыллка на вк',
     content: '[Color=turquoise][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый уважаемый [B]{{ user.mention }}[/B].[/color][/CENTER]<br>' +
"[CENTER]Прикрипите сыллку на свой вк.[/CENTER]<br><br>"+'[CENTER]  [/CENTER]',
 },
{
     title: 'НЕ ПО ФОРМЕ ОБЖ',
     content: '[Color=turquoise][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый уважаемый [B]{{ user.mention }}[/B].[/color][/CENTER]<br>' +
   "[CENTER]Ваше обжалование составлено не по форме.[/CENTER]<br><br>" +
   "[CENTER][COLOR=red]Отказано.[/COLOR][/FONT][/CENTER]",
     prefix: UNACCEPT_PREFIX,
    status: false,
  },
  ...
  },
  {
   ...
   "[CENTER][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/FONT][/CENTER]",
  ...
  },
    {
     ...
     content:
     '[Color=turquoise][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый уважаемый [B]{{ user.mention }}[/B].[/color][/CENTER]<br>' +
   "[CENTER]Аккаунт игрока будет разблокирован на 24 часа для возврата обманутого имущества.При передачи имущества на твинк аккаунт,будут заблокированы все аккаунты.После возврата имущества прикрепите видеофиксацию на его возвращение.[/CENTER]<br><br>" +
   "[CENTER][COLOR=Orange]На рассмотрении[/COLOR].[/FONT][/CENTER]",
     prefix: PIN_PREFIX,
    status: true,
  },
