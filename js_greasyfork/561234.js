...
// @license MIT
// @name Pikexs
// @description Very good hack right click for more options and , for on\off all scripts
// @version 4.2.9
// @author IIIyka
...
// @downloadURL https://update.greasyfork.org/scripts/561234/Pikexs.user.js
// @updateURL https://update.greasyfork.org/scripts/561234/Pikexs.meta.js
// ==/UserScript==
//  
(() => {
    "use strict";
...
class TeleportModule extends Module {
    constructor() {
        ...
        this.toggleKey = "KeyY"; // ativa/desativa módulo (menu)
        this.teleportKey = "KeyT"; // teleporta
    ...
    handleKeys(e) {
        ...
        if (this.enabled && e.code === this.teleportKey && !e.repeat) {
            this.teleport();
        }
    }
