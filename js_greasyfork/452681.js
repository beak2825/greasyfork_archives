...
// @connect      gitee.com
// @downloadURL https://update.greasyfork.org/scripts/452681/KiraBot.user.js
// @updateURL https://update.greasyfork.org/scripts/452681/KiraBot.meta.js
// ==/UserScript==
(function() {
    'use strict';
    var topicId = 32780
    ...
    console.log(getNowTime()+" kirabot start");
    //首次加载执行一次
    getBlackList()
    main()
