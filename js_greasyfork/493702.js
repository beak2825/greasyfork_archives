...
// @namespace    none
// @version      1
// @description  Chimken killer🔥-A simple mod with simple things such as autoheal, R-Insta, F-Trap, V-Spike, and much more Enjoy!
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/493702/Chimken-mod.user.js
// @updateURL https://update.greasyfork.org/scripts/493702/Chimken-mod.meta.js
// ==/UserScript==
/*Mod Log
    V0.1 - Created Chimken mod, devlopment beings
...
let changes2 = `<div id="customMenuName"><h3 style="font-size: 50px;" class = "indent">By Mr-Chimken_Lord</a></div>`;
...
//document.getElementById("loadingText").innerHTML = "Chimken Loading";
document.getElementById("diedText").innerHTML = "Chimken Died :c";
document.getElementById("diedText").style.color = "#FFFFFF";
document.title = " Chimken-mod";
document.getElementById("leaderboard").append("Chimken-mod");
...
document.getElementById('promoImgHolder').innerHTML =
  ...
  p { font-size: 20px;}#noticationDisplay {
      ...
      <div>
  <i class="fa-solid fa-rectangle-list"style="font-size: 25px";></i><p>Update V13</p> <div style="font-size: 15px">
  - added boost tick<br>
...
const handleMutations = (mutationsList) => {
    for (const mutation of mutationsList) {
        if (mutation.target.id === "killCounter") {
            ...
            if (count > prevCount) {
                doNewSend(["6", ["Chimken-mod "]]);
                setTimeout(()=>{
                    doNewSend(["6", ["- +1 chimken -"]]);
                },650);
                prevCount = count;
            }
        }
...
$("body").after(`
  <div id="infomenu">
  <hr>
  <div class="nameblock">Chimken-mod</div>
  <hr>
  <ul>
  ...
  <hr>
  <div class="nameblock">Chimken Controls:</div>
  <hr>
