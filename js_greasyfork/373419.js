...
// @grant          GM_openInTab
// @run-at         document-end
// @resource iconData.json https://greasyfork.org/scripts/12430-search-engine-icon-base64-json/code/search%20%20engine%20icon%20base64%20json.js?version=74578
// @include http*
// @exclude     http://www.gdtgw.cn:8080/*
// @downloadURL https://update.greasyfork.org/scripts/373419/search%20engine%20jump%20for%20ziji.user.js
// @updateURL https://update.greasyfork.org/scripts/373419/search%20engine%20jump%20for%20ziji.meta.js
// ==/UserScript==
    ...
    {name: "极影",
        ...
        insertIntoDoc: {
            ...
            where: 'beforeBegin',
				...
				name: '蜜柑计划',
				url: /^https?:\/\/mikanani\.me\/Home\/Search/i,
				engineList: 'download',
				enabled: true,
				insertIntoDoc: {
					keyword: 'css;#header-search',
					target: 'css;#sk-top-nav',
					where: 'afterEnd',
				},
			}, {
				name: 'acgrip',
				...
				name: '字幕组',
				url: /^https?:\/\/www\.zimuzu\.tv\/search/i,
				engineList: 'download',
				enabled: true,
				insertIntoDoc: {
					keyword: 'css;.keywords',
				...
				name: '西林街',
				url: /^https?:\/\/www\.xilinjie\.com\/s/i,
				engineList: 'download',
				enabled: true,
				insertIntoDoc: {
					keyword: 'css;#xlj-search-form-input',
					target: 'css;#xlj-search-header',
					where: 'afterEnd',
				},
			}, {
				name: '胖次网盘', //https://alongwith.me/
				url: /^https?:\/\/www\.panc\.cc\/s/i,
				engineList: 'download',
				enabled: true,
				insertIntoDoc: {
					keyword: 'css;#pusin',
...
function getFaviconUrl(url, type) {
    ...
    switch(type) {
        ...
        default:
        //    return 'https://www.google.com/s2/favicons?domain=' + uri.host;
            return 'https://api.byi.pw/favicon?url=' + uri.protocol + '://' + uri.host;
    }
}
...
function cc(){
            if(oTitle!=document.title){
                // console.log('标题发生了变化,MutationObserver被禁用');
