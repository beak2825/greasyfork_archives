// ==UserScript==
// @name        HIT Scraper WITH EXPORT [dev] - notifications
// @author      feihtality
...
// @version     4.0.032
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/17132/HIT%20Scraper%20WITH%20EXPORT%20%5Bdev%5D%20-%20notifications.user.js
// @updateURL https://update.greasyfork.org/scripts/17132/HIT%20Scraper%20WITH%20EXPORT%20%5Bdev%5D%20-%20notifications.meta.js
// ==/UserScript==
                ...
                return found; // [ blocklist,includelist ]
                    ...
                    notify: function(c,r) {//{{{
                        ...
                        if(c.included) {
                            ...
                            notification.onshow = function() { setTimeout(function() { notification.close() }, 1000) }; // Need to set a close time for Chrome
                        }
