...
// ==UserScript==
// @name         Кураторы Форума | for ARZAMAS🍹
// @namespace    https://forum.blackrussia.online
// @version      2.3.0
// @description  <3
// @author       by August_Morozov
// @match        https://forum.blackrussia.online/index.php?threads/*
// @include      https://forum.blackrussia.online/index.php?threads/
// @grant        none
// @license    MIT
// @icon https://emoji.gg/assets/emoji/9372-blurple-boost-level-9.png
// @downloadURL https://update.greasyfork.org/scripts/452021/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20for%20ARZAMAS%F0%9F%8D%B9.user.js
// @updateURL https://update.greasyfork.org/scripts/452021/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20for%20ARZAMAS%F0%9F%8D%B9.meta.js
// ==/UserScript==
...
const buttons = [
     ...
     {
      title: 'Отказано, закрыто. | Приятной игры на сервере | ARZAMAS ☔',
      content: '[Color=Red][CENTER]Отказано, закрыто. | Приятной игры на сервере | ARZAMAS ☔.[/CENTER][/color]' + '[CENTER]  [/CENTER]',
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
      title: 'Одобрено, закрыто. | Приятной игры на сервере | ARZAMAS ☔',
      content: '[Color=Green][CENTER]Одобрено, закрыто. | Приятной игры на сервере | ARZAMAS ☔.[/CENTER][/color]' + '[CENTER]  [/CENTER]',
    ...
    },
    {
      ...
      content:
        ...
        '[Color=Green][CENTER]Одобрено, закрыто. | Приятной игры на сервере | ARZAMAS ☔.[/I][/CENTER][/color][/FONT]',
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
    ...
    },
     {
      ...
      content:
        '[Color=Yellow][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Игрок будет наказан по пункту правил:[/FONT][/I][/B][FONT=georgia][I][B]2.37. Запрещены OOC угрозы, в том числе и завуалированные | Mute 120 минут / Ban 7 дней[/B][/I][/FONT][B][I][FONT=georgia]Одобрено, закрыто. | Приятной игры на сервере | ARZAMAS ☔[/FONT][/I][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        '[Color=Yellow][FONT=Courier New][CENTER][I]{{ greeting }}, уважаемый игрок.[/color][/CENTER]<br>' +
        "[CENTER][B][I][FONT=georgia]Игрок будет наказан по пункту правил:[/FONT][/I][/B][FONT=georgia][I][B]3.09. Запрещены любые угрозы о наказании игрока со стороны администрации | Mute 30 минут [/B][/I][/FONT][B][I][FONT=georgia]Одобрено, закрыто. | Приятной игры на сервере | ARZAMAS ☔[/FONT][/I][/B][/CENTER]",
      prefix: ACCСEPT_PREFIX,
      status: false,
    },
    {
    ...
    },
    {
      ...
      content:
        ...
        '[Color=Red][CENTER]Отказано, закрыто. | Приятной игры на сервере | ARZAMAS ☔.[/I][/CENTER][/color][/FONT]',
      prefix: UNACCСEPT_PREFIX,
      status: false,
    },
    {
