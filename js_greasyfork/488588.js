...
// @namespace    jkkowo
// @version      1.91
// @description  买买买（基于作者out脚本，新增悠悠有品的支持）
// @author       jkkowo
...
// @downloadURL https://update.greasyfork.org/scripts/488588/%E9%A5%B0%E5%93%81%E6%AF%94%E4%BE%8B%E8%AE%A1%E7%AE%97%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/488588/%E9%A5%B0%E5%93%81%E6%AF%94%E4%BE%8B%E8%AE%A1%E7%AE%97%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
const $ = window.jQuery;
var site;
var low;
...
function start(){
    ...
    }else if($('div.grey.f14.mt20').length !== 0){
        site = "yyyp";
        setTimeout(function(){
            query($('div.grey.f14.mt20 > a').attr("href"));
        },2000)
    }
}
                    ...
                    onload: function(data){
                        ...
                        if(obj){
                            ...
                            if(site=="c5"){
                                ...
                                GM_addStyle(`.grey.f14.mt20 > span { display:none;}`);
                                $("div.grey.f14.mt20").prepend($pinfo);
                            }
...
function steamlogin(){
    ...
    if(site=="c5"){
        ...
        $('div.grey.f14.mt20').append($login);
    }
}
...
function calcratio(){
    var t = setInterval(function(){
        ...
        if(site == "c5"){
            ...
            siteprice = getFloat($("li:nth-child(1) > div.t-4.price-wrapper > span > span").text());
        }
