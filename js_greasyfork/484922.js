...
// @author       Patrick_Dandelion
// @match        https://forum.blackrussia.online/threads/*
// @grant        none
// @license 	 MIT
// @icon https://forum.blackrussia.online/data/avatars/o/11/11193.jpg
// @downloadURL https://update.greasyfork.org/scripts/484922/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20PSKOV.user.js
// @updateURL https://update.greasyfork.org/scripts/484922/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%7C%20PSKOV.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    {
	title: 'конфликт из ООС в IC',
	content:
	          '[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Игрок будет наказан по пункту правил:<br>2.36. Запрещено переносить конфликты из IC в OOC и наоборот | Warn [/color] [/COLOR][/FONT][/CENTER] <br>" +
        '[CENTER][I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Одобрено, закрыто.[/COLOR][/FONT][/CENTER]',
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
...
const buttons2 = [
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#00FF00]Одобрено.[/color] <br> Приятной игры на сервере [Color=#228B22] Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило нарушение [URL='https://forum.blackrussia.online/threads/pskov-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D1%81%D1%82%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F-%D0%A0%D0%9F-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B9.6503252/']Правил написания RP биографий[/URL]. <br><br> Приятной игры на сервере [Color=#228B22]PSKOV.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - Плагиат. <br><br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - Не дополнили биографию в течение 24-х часов. <br><br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - возраст не совпадает с датой рождения. <br><br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - матерные слова. <br><br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография получает статус - [Color=#FF0000]Отказано.[/color]<br>Причиной отказа послужило - грамматические ошибки. <br><br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП биография уже находится на рассмотрении, дополните ее в предыдущей теме. <br><br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: BIOUNACCEPT_PREFIX,
	  status: false,
    },
    {
...
const buttons3 = [
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП ситуация получает статус - [Color=#00FF00]Одобрено.[/color] <br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: SITAACCEPT_PREFIX,
	  status: false,
    },
    {
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП ситуация получает статус - [Color=#FF0000]Отказано[/color] <br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП ситуация получает статус - [Color=#00FF00]Одобрено.[/color] <br> [QUOTE]Так же хочу отметить, что игровую валюту вы не получите за ограбление чего-либо по РП.[/QUOTE] <br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: SITAACCEPT_PREFIX,
	  status: false,
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша РП ситуация получает статус - [Color=#FF0000]Отказано[/color] <br> [QUOTE]Так же хочу отметить, что игровую валюту вы не получите за ограбление чего-либо по РП.[/QUOTE] <br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
      prefix: SITAUNACCEPT_PREFIX,
	  status: false,
    },
    {
...
const buttons4 = [
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша Неофициальная RP организация получает статус - [Color=#00FF00]Одобрено.[/color] <br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
    ...
    },
    {
      ...
      content:
		'[CENTER][I][SIZE=4][FONT=arial][COLOR=#FFFF00]{{ greeting }}, уважаемый {{ user.mention }}.[/COLOR][/FONT][/SIZE][/I] <br><br>' +
        "[I][FONT=times new roman][COLOR=#FFFF00][SIZE=5]Ваша Неофициальная RP организация получает статус - [Color=#FF0000]Отказано[/color] <br> Приятной игры на сервере [Color=#228B22]Novosibirsk.[/COLOR] [/COLOR][/FONT][/CENTER] <br>",
...
$(document).ready(() => {
    ...
    addButton('⚠ Скрипт изменён by Nik_Golub ⚠', '/');
 },
