    ...
    (this.sid = e),
        ...
        (this.init = function (p, h, m, w, v) {
            (this.x = p),
                ...
                (this.name || "").startsWith("ğŸ’€") && (this.isVolcanoAi = !0),
...
const j = [
    ...
    xc = [
        ...
        { id: 14, type: 1, age: 6, name: "mc grabby", desc: "steals resources from enemies", src: "grab_1", length: 130, width: 210, xOff: -8, yOff: 53, dmg: 0, steal: 250, knock: 0.2, spdMult: 1.05, range: 125, gather: 0, speed: 700 },
        {
            id: 15,
            type: 1,
            age: 9,
    ...
    dt = [
        ...
        { group: j[3], name: "windmill", desc: "generates gold over time", req: ["wood", 50, "stone", 10], health: 400, pps: 1, turnSpeed: 0.0016, spritePadding: 25, iconLineMult: 12, scale: 45, holdOffset: 20, placeOffset: 5 },
        {
            age: 5,
            pre: 1,
            group: j[3],
...
function Sn(e) {
    (uo = e), (mt = (e && window.devicePixelRatio) || 1), (Nn.checked = e), Di("native_resolution", e.toString()), ws();
}
function df() {
...
let Ti;
function vs() {
    return E ? (!E.lockDir && !ii && (Ti = Math.atan2(yo - yt / 2, go - gt / 2)), C.fixTo(Ti || 0, 2)) : 0;
}
var He = {},
...
function Ro(e, t, i) {
    e != null && (E.XP = e), t != null && (E.maxXP = t), i != null && (E.age = i), i == T.maxAge ? ((gr.innerHTML = "MAX AGE"), (yr.style.width = "100%")) : ((gr.innerHTML = "AGE " + E.age), (yr.style.width = (E.XP / E.maxXP) * 100 + "%"));
}
function Df(e) {
    ...
    for (let i = 0; i < e.length; i += 3)
        (function (s) {
            C.generateElement({
                ...
                parent: mr,
                children: [
                    C.generateElement({ class: "leaderboardItem", style: "color:" + (e[s] == mo ? "#fff" : "rgba(255,255,255,0.6)"), text: t + ". " + (e[s + 1] != "" ? e[s + 1] : "unknown") }),
                    C.generateElement({ class: "leaderScore", text: C.kFormat(e[s + 2]) || "0" }),
                ],
            });
        })(i),
            t++;
...
function Of() {
    {
        ...
        T.snowBiomeTop - c <= 0 && T.mapScale - T.snowBiomeTop - c >= re
            ...
            : T.snowBiomeTop - c >= 0
            ? ((M.fillStyle = "#fff"), M.fillRect(0, 0, se, T.snowBiomeTop - c), (M.fillStyle = "#b6db66"), M.fillRect(0, T.snowBiomeTop - c, se, re - (T.snowBiomeTop - c)))
            : ((M.fillStyle = "#b6db66"), M.fillRect(0, 0, se, T.mapScale - T.snowBiomeTop - c), (M.fillStyle = "#dbc666"), M.fillRect(0, T.mapScale - T.snowBiomeTop - c, se, re - (T.mapScale - T.snowBiomeTop - c))),
            Ei ||
            ...
            (M.globalAlpha = 0.06),
            M.beginPath();
        for (var i = -Re; i < se; i += re / 18) i > 0 && (M.moveTo(i, 0), M.lineTo(i, re));
        for (let a = -_e; a < re; a += re / 18) i > 0 && (M.moveTo(0, a), M.lineTo(se, a));
        M.stroke(), (M.globalAlpha = 1), (M.strokeStyle = ei), zt(-1, l, c), (M.globalAlpha = 1), (M.lineWidth = Xe), br(0, l, c), Ir(l, c, 0), (M.globalAlpha = 1);
        ...
        if ((zt(0, l, c), br(1, l, c), zt(1, l, c), Ir(l, c, 1), zt(2, l, c), zt(3, l, c), (M.fillStyle = "#000"), (M.globalAlpha = 0.09), l <= 0 && M.fillRect(0, 0, -l, re), T.mapScale - l <= se)) {
            var s = Math.max(0, -c);
        ...
        (M.globalAlpha = 1), (M.fillStyle = "rgba(0, 0, 70, 0.35)"), M.fillRect(0, 0, se, re), (M.strokeStyle = kr);
        ...
        for (var t = 0; t < J.length; ++t)
            if (((y = J[t]), y.visible && y.chatCountdown > 0)) {
                (y.chatCountdown -= be), y.chatCountdown <= 0 && (y.chatCountdown = 0), (M.font = "32px Hammersmith One");
                ...
                const m = 47,
                    w = u.width + 17;
                (M.fillStyle = "rgba(0,0,0,0.2)"), M.roundRect(n - w / 2, s - m / 2, w, m, 6), M.fill(), (M.fillStyle = "#fff"), M.fillText(y.chatMessage, n, s);
            }
    }
    lf(be);
}
...
function Hf(e) {
    ...
    if (!s) {
        ...
        if ((o.translate(r.width / 2, r.height / 2), o.rotate(C.randFloat(0, Math.PI)), (o.strokeStyle = ei), (o.lineWidth = Xe), e.type == 0)) {
            ...
            if (t == 2) (o.fillStyle = "#606060"), Ie(o, 6, e.scale * 0.3, e.scale * 0.71), o.fill(), o.stroke(), (o.fillStyle = "#89a54c"), Q(0, 0, e.scale * 0.55, o), (o.fillStyle = "#a5c65b"), Q(0, 0, e.scale * 0.3, o, !0);
            else {
...
function Ss(e, t) {
    ...
    if (!i || t) {
        ...
        if ((a.translate(c.width / 2, c.height / 2), a.rotate(t ? 0 : Math.PI / 2), (a.strokeStyle = ei), (a.lineWidth = Xe * (t ? c.width / 81 : 1)), e.name == "apple")) {
            ...
            (a.fillStyle = "#cca861"), Q(0, 0, e.scale, a), (a.fillStyle = "#937c4b");
            ...
            (a.fillStyle = "#f4f3ac"), Q(0, 0, e.scale, a), (a.fillStyle = "#c3c28b");
            for (var s = 4, n = Ze / s, r, o = 0; o < s; ++o) (r = C.randInt(e.scale / 2.5, e.scale / 1.7)), Q(r * Math.cos(n * o), r * Math.sin(n * o), C.randInt(4, 5), a, !0);
            ...
            Ie(a, u, e.scale * 1.1, e.scale * 1.1), a.fill(), a.stroke(), (a.fillStyle = e.name == "castle wall" ? "#9da4aa" : e.name == "wood wall" ? "#c9b758" : "#bcbcbc"), Ie(a, u, e.scale * 0.65, e.scale * 0.65), a.fill();
            ...
            var l = e.scale * 0.6;
            Ie(a, e.name == "spikes" ? 5 : 6, e.scale, l), a.fill(), a.stroke(), (a.fillStyle = "#a5974c"), Q(0, 0, l, a), (a.fillStyle = "#c9b758"), Q(0, 0, l / 2, a, !0);
        } else if (e.name == "windmill" || e.name == "faster windmill" || e.name == "power mill")
            (a.fillStyle = "#a5974c"), Q(0, 0, e.scale, a), (a.fillStyle = "#c9b758"), En(0, 0, e.scale * 1.5, 29, 4, a), (a.fillStyle = "#a5974c"), Q(0, 0, e.scale * 0.5, a);
        else if (e.name == "mine") (a.fillStyle = "#939393"), Ie(a, 3, e.scale, e.scale), a.fill(), a.stroke(), (a.fillStyle = "#bcbcbc"), Ie(a, 3, e.scale * 0.55, e.scale * 0.65), a.fill();
        else if (e.name == "sapling")
            for (var o = 0; o < 2; ++o) {
                var l = e.scale * (o ? 0.5 : 1);
                Ie(a, 7, l, l * 0.7), (a.fillStyle = o ? "#b4db62" : "#9ebf57"), a.fill(), o || a.stroke();
            }
        ...
        else if (e.name == "boost pad") (a.fillStyle = "#7e7f82"), kt(0, 0, e.scale * 2, e.scale * 2, a), a.fill(), a.stroke(), (a.fillStyle = "#dbd97d"), Lf(e.scale * 1, a);
        else if (e.name == "turret") {
            (a.fillStyle = "#a5974c"), Q(0, 0, e.scale, a), a.fill(), a.stroke(), (a.fillStyle = "#939393");
            const u = 50;
            ...
            e.name == "healing pad"
                ? ((a.fillStyle = "#7e7f82"), kt(0, 0, e.scale * 2, e.scale * 2, a), a.fill(), a.stroke(), (a.fillStyle = "#db6e6e"), En(0, 0, e.scale * 0.65, 20, 4, a, !0))
                : e.name == "spawn pad"
                ? ((a.fillStyle = "#7e7f82"), kt(0, 0, e.scale * 2, e.scale * 2, a), a.fill(), a.stroke(), (a.fillStyle = "#71aad6"), Q(0, 0, e.scale * 0.6, a))
                : e.name == "blocker"
                ? ((a.fillStyle = "#7e7f82"), Q(0, 0, e.scale, a), a.fill(), a.stroke(), a.rotate(Math.PI / 4), (a.fillStyle = "#db6e6e"), En(0, 0, e.scale * 0.65, 20, 4, a, !0))
                : e.name == "teleporter" && ((a.fillStyle = "#7e7f82"), Q(0, 0, e.scale, a), a.fill(), a.stroke(), a.rotate(Math.PI / 4), (a.fillStyle = "#d76edb"), Q(0, 0, e.scale * 0.5, a, !0));
        (i = c), t || (Rr[e.id] = i);
    }
    return i;
}
...
function Wf(e, t) {
    (y = Ho(t)), y && ((y.xWiggle += T.gatherWiggle * Math.cos(e)), (y.yWiggle += T.gatherWiggle * Math.sin(e)));
}
function Xf(e, t) {
    (y = Ho(e)), y && ((y.dir = t), (y.xWiggle += T.gatherWiggle * Math.cos(t + Math.PI)), (y.yWiggle += T.gatherWiggle * Math.sin(t + Math.PI)));
}
...
function iu(e) {
    const t = Date.now();
    for (var i = 0; i < J.length; ++i) (J[i].forcePos = !J[i].visible), (J[i].visible = !1);
...
function su() {
    const e = Date.now() - Fo;
    (window.pingTime = e), (Qt.innerText = "Ping: " + e + "Â ms");
}
let Pn;
function Vo() {
