...
// @require           https://unpkg.com/sweetalert2@11.26.3/dist/sweetalert2.min.js
// @resource          swalStyle https://unpkg.com/sweetalert2@11.26.3/dist/sweetalert2.min.css
// @match             *://*/*
// @noframes
...
// @downloadURL https://update.greasyfork.org/scripts/555711/%E7%BD%91%E9%A1%B5%E5%8A%A0%E9%80%9F%E5%99%A8.user.js
// @updateURL https://update.greasyfork.org/scripts/555711/%E7%BD%91%E9%A1%B5%E5%8A%A0%E9%80%9F%E5%99%A8.meta.js
// ==/UserScript==
...
(function () {
    ...
    const CONFIG = Object.freeze({
        ...
        allowQueryLinks: true,
        enableStoreLink: true,
        enableTargetSelf: false,
    ...
    let main = {
        initValue() {
            if (util.getValue('setting_success_times') === undefined) {
        ...
        inExcludeList() {
            ...
            return CONFIG.excludeDomains.includes(host);
        },
        ...
        instantPage() {
            ...
            const allowQueryString = 'instantAllowQueryString' in document.body.dataset || CONFIG.allowQueryLinks;
            const allowExternalLinks = 'instantAllowExternalLinks' in document.body.dataset || CONFIG.allowExternalLinks;
            const useWhitelist = 'instantWhitelist' in document.body.dataset;
            const mousedownShortcut = 'instantMousedownShortcut' in document.body.dataset;
            const DELAY_TO_NOT_BE_CONSIDERED_A_TOUCH_INITIATED_ACTION = 1111;
            const enableAnimation = CONFIG.enableAnimation;
            const enableTargetSelf = CONFIG.enableTargetSelf;
            const enableStoreLink = CONFIG.enableStoreLink;
            window.instantLoaded = true;
            const excludeKeyword = CONFIG.excludeKeywords;

            let delayOnHover = CONFIG.delayOnHover;
