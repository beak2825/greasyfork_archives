    ...
    // @version 0.0.1
// @namespace https://greasyfork.org/users/1270250
// @downloadURL https://update.greasyfork.org/scripts/488986/Ajustar%20Ataque%20con%20Heroe%20-%20MODIFICADO.user.js
// @updateURL https://update.greasyfork.org/scripts/488986/Ajustar%20Ataque%20con%20Heroe%20-%20MODIFICADO.meta.js
    // ==/UserScript==
    ...
    function commandsChange() {
        ...
        if (foundAttack && listaElementos.children != null) {
            for (var child of listaElementos.children) {
                if (child.getAttribute('data-commandtype') === 'revolts') {
                    child.remove();
                }
                if ((child.children[0].children[1].children[2] == null) || (child.children[0].children[1].children[2].classList.contains("indicatorAankomst"))) {
                    ...
                    var existingIndicator = child.children[0].children[1].querySelector('.indicatorAankomst');
                    if (existingIndicator && child.children[0].children[1].children[2].classList.contains("indicatorAankomst")){
                        child.children[0].children[1].replaceChild(indicador, existingIndicator)
                    }else{
    ...
    function loadCSS() {
        ...
        var style='.sandy-box .item.command{   height: 54px !important;}.indicador {	color: rgba(0, 0, 0, 0.5) ;	font-size: xx-small ;   position: relative;   display: flex;   line-height: 0px;}'
