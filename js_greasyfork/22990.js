...
// @namespace    ZR.v2
// @version      2
// @description  Es una edición de OGARio ZR
// @author       Abo3tb
// @match        http://agar.io/*
// @run-at       document-start
// @grant        GM_xmlhttpRequest
// @connect      agar.io
// @downloadURL https://update.greasyfork.org/scripts/22990/ZR%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/22990/ZR%20Extension.meta.js
// ==/UserScript==
...
function inicio() {
    document.title = "ZR Extension :)";
    modificarTextoMinimapa("By ABO3TB");
    modificarTextoLeaderboard("ZR Extension");
    modificarCanalYoutube("Gamer_ZR", "UCmXb3Dbr21WHlRVePcmvXFg");
    modificarFooter("xZR.ts.io", "https://www.youtube.com/channel/UCmXb3Dbr21WHlRVePcmvXFg");
    panelDerecho();
    ...
    redondearControles();
    colorPanelCentral("#a24440");
    colorPanelDerecho("#f2f2f2");
    colorTextoPestaña("#FF0013");
    colorPestañaActiva("#a24440");
 
    colorBotonPlay("#ffffff", "#e16400");
    bordeBotonPlay("#e16400", "#ffffff");
 
    colorBotonLoginAndPlay("#ffffff", "#e16400");
    bordeBotonLoginAndPlay("#e16400", "#ffffff");
 
    colorBotonLogout("#ffffff", "#e16400");
    bordeBotonLogout("#e16400", "#1b0101");
 
    colorBotonFacebook("#3071a9", "#e16400");
    bordeBotonFacebook("#e16400", "#1b0101");
 
    colorBotonGoogle("#D34C3D", "#e16400");
    bordeBotonGoogle("#e16400", "#D34C3D");
 
    colorBotonSpectate("#FF8F00", "#e16400");
    bordeBotonSpectate("#e16400", "#FF8F00");
 
    colorBotonCopy("#1565C0", "#e16400");
    bordeBotonCopy("#e16400", "#1565C0");
 
    colorBotonCreate("#2E7D32", "#e16400");
    bordeBotonCreate("#e16400", "#2E7D32");
 
    colorBotonJoin("#2E7D32", "#e16400");
    bordeBotonJoin("#e16400", "#2E7D32");
 
    colorBotonStreamMode("#ffffff", "#e16400");
 
    colorBotonHideUrl("#ffffff", "#C62828");
 
    colorBotonFreeCoins("#ffffff", "#398439");
    bordeBotonFreeCoins("#ffffff", "#398439");
 
    colorBotonShop("#ffffff", "#954700");
    bordeBotonShop("#ffffff", "#954700");
 
 
    colorBotonResetHotkeys("#ffffff", "#1565C0");
    bordeBotonResetHotkeys("#ffffff", "#1565C0");
 
    colorBotonSaveHotkeys("#ffffff", "#2E7D32");
    bordeBotonSaveHotkeys("#ffffff", "#2E7D32");
 
    colorBotonCloseHotkeys("#ffffff", "#C62828");
    bordeBotonCloseHotkeys("#ffffff", "#C62828");
 
    colorBotonSaveTheme("#ffffff", "#2e7d32");
    bordeBotonSaveTheme("#ffffff", "#2e7d32");
 
 
    colorInput("#ffffff");
    colorTextoInput("#05F7FF");
 
    colorSelect("#ffffff");
    colorTextoSelect("#FFFB05");
 
    colorPicker("red");
 
    nuevoCursor("http://ani.cursors-4u.net/cursors/cur-12/cur1103.png");
