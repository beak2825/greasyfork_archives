...
// @version      2.10.4
// @description  备份的一个脚本库，不是本人编写！！！！原来简介都在里面--》在B站笔记中：打开笔记快捷键：Ctrl+Shift+↑，关闭笔记快捷键：Ctrl+Shift+↓，笔记窗口切换到视频窗口：Ctrl+Shift+←，视频窗口切换到笔记窗口：Ctrl+Shift+→，截图+时间戳快捷键：Ctrl+↓，时间戳+截图快捷键：Ctrl+↑，时间戳快捷键：Ctrl+←，截图快捷键：Ctrl+→，下载视频笔记Ctrl+Shift+S，将字幕装载进笔记Ctrl+Shift+V
// @author       读书的苏
...
// @downloadURL https://update.greasyfork.org/scripts/468584/B%E7%AB%99%E7%AC%94%E8%AE%B0%E5%BF%AB%E6%8D%B7%E9%94%AE%E2%86%90%E2%86%93%E2%86%92.user.js
// @updateURL https://update.greasyfork.org/scripts/468584/B%E7%AB%99%E7%AC%94%E8%AE%B0%E5%BF%AB%E6%8D%B7%E9%94%AE%E2%86%90%E2%86%93%E2%86%92.meta.js
// ==/UserScript==
...
document.addEventListener("keydown", function (event) {
        ...
        if (event.keyCode == 39) {//快进10秒——快捷键：Alt+→
            if (event.altKey) {
         ...
         if (event.keyCode == 37) {//后退10秒——快捷键：Alt+←
            if (event.altKey) {
...
window.onload=function(){
    ...
    function getSelect(){
        ...
        if(window.getSelection){
            ...
            var isP = select.focusNode?(select.focusNode.parentElement?select.focusNode.parentElement.nodeName:""):"";
            if(isP != "P"){
   ...
   // };
    ...
    oIcon.onclick = function (e) {
        let myIconDom=document.querySelector("#my_icon");
        myIconDom.style.boxShadow="rgba(0, 0, 0, 0.24) 0px 3px 8px";
        myIconDom.style.backgroundColor="#f1f2f3";
        setTimeout(function (){
            myIconDom.style.boxShadow="0 0 0 1px rgb(0 0 0 / 5%), 0 2px 3px 0 rgb(0 0 0 / 10%)";
            myIconDom.style.backgroundColor="#fff";
        }, 500);
