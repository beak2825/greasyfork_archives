...
// @version      1.0.0
// @description  ChatGPT Question Navigation sidebar
...
// @downloadURL https://update.greasyfork.org/scripts/548443/ChatGPT%20Question%20sidebar.user.js
// @updateURL https://update.greasyfork.org/scripts/548443/ChatGPT%20Question%20sidebar.meta.js
// ==/UserScript==
(function () {
    'use strict';
    ...
    function App() {
      ...
      const filtered = reactExports.useMemo(() => {
        ...
        if (!q2)
          return questions.map((text, index) => ({ text, index }));
        return questions.map((text, index) => ({ text, index })).filter(({ text }) => text.toLowerCase().includes(q2));
      }, [questions, query]);
      const scrollToIndex = (index) => {
        ...
        (_a = questionEls == null ? void 0 : questionEls[index]) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
      };
      const handleKeyDown = (e) => {
        ...
        if (e.key === "ArrowDown") {
          ...
          e.preventDefault();
          setFocusedIndex((prev) => {
            const next = prev === null ? filtered.length - 1 : Math.max(prev - 1, 0);
            return next;
          });
  ...
  *,::before,::after{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgba(0,0,0,0);--un-ring-shadow:0 0 rgba(0,0,0,0);--un-shadow-inset: ;--un-shadow:0 0 rgba(0,0,0,0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgba(147,197,253,0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}::backdrop{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgba(0,0,0,0);--un-ring-shadow:0 0 rgba(0,0,0,0);--un-shadow-inset: ;--un-shadow:0 0 rgba(0,0,0,0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgba(147,197,253,0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}
  ...
  .focus-visible\\:ring-brand-primary:focus-visible{--un-ring-opacity:1;--un-ring-color:rgba(25,195,125,var(--un-ring-opacity));}
  .focus\\:ring-brand-primary:focus{--un-ring-opacity:1;--un-ring-color:rgba(25,195,125,var(--un-ring-opacity));}
  ...
  [scrollbar~="w-4px"]{--scrollbar-width:4px;}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `transition-width ${show ? "w-[var(--app-width)]" : "w-22px"} `, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center select-none justify-between pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden whitespace-nowrap flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: "📄" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Questions" }),
              show && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "ml-1 rounded-full bg-gray-100 px-1.5 py-0.5 text-10px text-gray-600",
                  "aria-label": `${questions.length} items`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                className: `cursor-pointer rounded p-1 leading-none focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary ${show ? "" : "opacity-70 grayscale"}`,
                onClick: handleClickEye,
                title: show ? "Hide panel" : "Show panel",
                "aria-label": show ? "Hide panel" : "Show panel",
                "aria-pressed": show,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: "👁️" })
              }
            )
          ] }),
          show && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "sr-only", htmlFor: "question-search", children: "Search questions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                id: "question-search",
                ...
                placeholder: "Search...",
                className: "w-full rounded border border-gray-200 px-2 py-1 text-12px outline-none focus:ring-2 focus:ring-brand-primary",
                "aria-label": "Search questions"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative after:content-[''] after:absolute after:bottom-0 after:right-4px after:w-full after:h-.7em after:bg-gradient-to-t after:from-white after:from-opacity-90 after:to-white after:to-opacity-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "ul",
            {
              ref: elRef,
              ...
              tabIndex: 0,
              children: [
                filtered.map(({ text, index }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "li",
                  {
                    className: `hover:text-brand-primary hover:bg-gray-50 rounded-md box-border w-full cursor-pointer overflow-hidden whitespace-nowrap py-1 px-1 leading-snug last-of-type:pb-.7em ${show ? "text-ellipsis" : "pl-8px"} ${focusedIndex === i ? "bg-gray-100" : ""}`,
                ...
                !filtered.length && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "text-12px text-gray-400 py-1 px-1", children: "No results" })
              ]
            }
          ) })
        ] })
    ...
    const baseStyle = "*{margin:0;padding:0}:host{--app-width: 20vw;--app-max-list-height: 70vh;--card-bg: #fff;--card-border: rgba(0,0,0,.08);--shadow: 0 8px 20px rgba(0, 0, 0, .08);--ring: #3b82f6;position:fixed;top:10vh;right:16px;padding:8px 8px 0;border-radius:6px;background:var(--card-bg);border:1px solid var(--card-border);box-shadow:var(--shadow)}@media (prefers-color-scheme: dark){:host{--card-bg: #111318;--card-border: rgba(255,255,255,.08);--shadow: 0 8px 20px rgba(0, 0, 0, .4)}}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border-width:0}\n";
