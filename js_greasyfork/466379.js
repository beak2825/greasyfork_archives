...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/466379/%E3%80%8A%E7%9B%90%E5%9F%8E%E5%B7%A5%E5%AD%A6%E9%99%A2%E3%80%8B%E5%AD%A6%E4%B9%A0%E8%84%9A%E6%9C%AC-%E5%B7%A6%E6%89%8B%E5%A4%A9%E6%89%8D.user.js
// @updateURL https://update.greasyfork.org/scripts/466379/%E3%80%8A%E7%9B%90%E5%9F%8E%E5%B7%A5%E5%AD%A6%E9%99%A2%E3%80%8B%E5%AD%A6%E4%B9%A0%E8%84%9A%E6%9C%AC-%E5%B7%A6%E6%89%8B%E5%A4%A9%E6%89%8D.meta.js
// ==/UserScript==
(function () {
    'use strict';
    infos()
    ...
    document.querySelector("body > div.el-message-box__wrapper > div > div.el-message-box__content > div.el-message-box__message")
    function Secondary(){
        setTimeout(function () {
            console.log("3")
        ...
        jQuery(document).ready(() => {
            ...
            setInterval(function() {
                ...
                if (document.querySelector('.el-progress-bar__inner').style.width == "100%") {
                    ...
                    if ($(".vjs-play-control").attr("title") == "Play"||$(".vjs-play-control").attr("title") == "Replay") { //获取播放状态，如果是“Play”是暂停状态；如果是“Pause”是播放;如果是“Replay”是暂停但可以重播状态。
                        $(".vjs-play-control").click();
                    } else if (b == "100%;") { //完成一个视频，点击下一节
                        $("div.navigate > ul > li").children().eq(2).click();
                    }else  if ($("div.el-message-box__wrapper").css("display") !== "none") {
                        if(document.querySelector("div.el-message-box__message").innerText.includes("最后一节")){
        ...
        jQuery(document).ready(() => {
            ...
            setInterval(function() {
                ...
                if (document.querySelector('.el-progress-bar__inner').style.width == "100%") {
                    ...
                    //                     }
                    //                 } else {
                    if ($(".vjs-play-control").attr("title") == "Play") { //获取播放状态，如果是“Play”是暂停；如果是“Pause”是暂停;如果是“Replay”是可以重播。
                        $(".vjs-play-control").click();
                    } else if ($(".vjs-play-control").attr("title") == "Replay") { //因为时长不够，所以这边要进行重播，而不是下一节
                        $(".vjs-play-control").click();
                    } else if ($("div.el-message-box__wrapper").css("display") !== "none") {
                        $("div.el-message-box__btns").children("button.el-button").click();
                    }
