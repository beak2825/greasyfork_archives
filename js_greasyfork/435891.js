// ==UserScript==
// @name         town star energy
// @namespace    wiolentmonkey
// @version      0.2
// @description  craft energy
// @author       gela
// @match        https://townstar.sandbox-games.com/launch/
// @grant        none
// @run-at       document-start
// @downloadURL https://update.greasyfork.org/scripts/435891/town%20star%20energy.user.js
// @updateURL https://update.greasyfork.org/scripts/435891/town%20star%20energy.meta.js
// ==/UserScript==
...
(function() {
    ...
    const trackedItems = [
        ...
        {item: 'Crude_Oil', count: 0, first: 0, oneMin: 6, oneHour: 0},
    ...
    const craftedItems = [
        {item: 'Energy', keepAmt: 0, sellMin: 100},
        {item: 'Sugarcane', keepAmt: 4, sellMin: 10},
        {item: 'Brine', keepAmt: 4, sellMin: 10},
        {item: 'Wheat', keepAmt: 4, sellMin: 10},
