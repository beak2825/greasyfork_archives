// ==UserScript==
// @name        MaelstromTools PTE
// @namespace   MaelstromTools
// @description Just a set of statistics & summaries about repair time and base resources. Mainly for internal use, but you are free to test and comment it.
// @version     0.8.15
// @author      Maelstrom, HuffyLuf, KRS_L and Krisan, White X Dragon, Der_Flake, BlinDManX, Tool amalgamation Ghostleader1402, fuchsma
// @include     http*://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @downloadURL https://update.greasyfork.org/scripts/29993/MaelstromTools%20PTE.user.js
// @updateURL https://update.greasyfork.org/scripts/29993/MaelstromTools%20PTE.meta.js
// ==/UserScript==
(function () {
              ...
              try {
                ...
                if (!this.mainMenuWindow) {
                  ...
                  if (MT_Preferences.Settings.useDedicatedMainMenu) {
                    ...
                    this.mainMenuWindow.setDecorator(new qx.ui.decoration.Decorator().set({
            ...
            addToDesktop: function (name, button) {
              try {
                ...
                app.getDesktop().add(button, {
                  ...
                  bottom: 150 - (42 * (desktopPosition - 1))
                });
            ...
            runAutoCollectTimer: function () {
              try {
                ...
                if (!CCTAWrapperIsInstalled())
                  return; // run timer only then wrapper is running
            ...
            updateCache: function (onlyForCity) {
              try {
                ...
                for (var cname in MT_Cache.Cities) {
                  ...
                  var ncity = MT_Cache.Cities[cname].Object;
                  if (typeof(this.Cache[cname]) !== 'object')
                    this.Cache[cname] = {};
                  if (typeof(this.Cache[cname][MaelstromTools.Statics.Tiberium]) !== 'object')
                    this.Cache[cname][MaelstromTools.Statics.Tiberium] = {}; // all have to be checked,
                  if (typeof(this.Cache[cname][MaelstromTools.Statics.Crystal]) !== 'object')
                    this.Cache[cname][MaelstromTools.Statics.Crystal] = {}; // this.Cache[cname] can be created inside different namespaces
                  if (typeof(this.Cache[cname][MaelstromTools.Statics.Power]) !== 'object')
                    this.Cache[cname][MaelstromTools.Statics.Power] = {}; // like the RepairTime etc... without those objs
                  if (typeof(this.Cache[cname][MaelstromTools.Statics.Dollar]) !== 'object')
