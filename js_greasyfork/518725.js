// ==UserScript==
// @name         Discord/Shapes - Events
// @namespace    http://tampermonkey.net/
// @version      0.4
// @description  Events Feature for Shapes
// @author       Vishanka
// @match        https://discord.com/channels/*
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/518725/DiscordShapes%20-%20Events.user.js
// @updateURL https://update.greasyfork.org/scripts/518725/DiscordShapes%20-%20Events.meta.js
// ==/UserScript==
...
(function() {
    ...
    function waitForStoragePanel() {
        if (typeof unsafeWindow.DCstoragePanel !== 'undefined') {
            initializeButton();
        } else {
    ...
    function initializeButton() {
        ...
        unsafeWindow.DCstoragePanel.appendChild(button);
    }
