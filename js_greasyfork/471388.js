// ==UserScript==
// @name         r/place 2023 Kanye Gradbear Overlay
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/471388/rplace%202023%20Kanye%20Gradbear%20Overlay.user.js
// @updateURL https://update.greasyfork.org/scripts/471388/rplace%202023%20Kanye%20Gradbear%20Overlay.meta.js
// ==/UserScript==
...
if (window.top !== window.self) {
  addEventListener('load', () => {
    ...
    const loadOverlay = () => {
      const name = "KanYe";
      const url = "https://media.discordapp.net/attachments/420916452879499264/1131974625077768253/image.png";
      const x = 500;
      const y = 933;
      const width = 55;
      const height = 46;
