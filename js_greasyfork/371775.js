...
// @namespace https://greasyfork.org/users/63534
// @downloadURL https://update.greasyfork.org/scripts/371775/Abdulaziz%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/371775/Abdulaziz%20Extension.meta.js
// ==/UserScript==
...
var ExtensionCSS = '<link href="https://abdulazizext.000webhostapp.com/AIXT.css" rel="stylesheet"></link>';
...
function inject(page) {
    var _page = page.replace("</head>", Macro + ExtensionCSS + FONT + "</head>");
    ...
    _page = _page.replace("</body>", Macro + AbdulazizExt + ExtensionCSS + FONT + "</body>");
    return _page;
}
window.stop();
