...
// @grant		none
// @downloadURL https://update.greasyfork.org/scripts/387304/FF14%E9%87%87%E9%9B%86%E6%97%B6%E9%92%9F%E6%B1%89%E5%8C%96.user.js
// @updateURL https://update.greasyfork.org/scripts/387304/FF14%E9%87%87%E9%9B%86%E6%97%B6%E9%92%9F%E6%B1%89%E5%8C%96.meta.js
// ==/UserScript==
...
reduceLangMap = {
	...
	var translateDataCh = {
		"item": {
			...
			"砕星砂": {ch: "砕星砂"},
			"紫洲小判": {ch: "紫洲小判"},
			"コッター朝の宝飾": {ch: "コッター朝の宝飾"},
			"ギラバニアピグメント": {ch: "ギラバニアピグメント"},
			"黄葛根": {ch: "黄葛根"},
			"ヘマタイト原石": {ch: "ヘマタイト原石"},
			"硬金鉱": {ch: "硬金矿"},
			"ダイアスポア原石": {ch: "ダイアスポア原石"},
			"高地天然水": {ch: "高地天然水"},
			"野生生物の落とし物": {ch: "野生生物の落とし物"},
			"ラズライト原石": {ch: "ラズライト原石"},
			"霊青岩": {ch: "霊青岩"},
			"巨大生物の食痕": {ch: "巨大生物の食痕"},
			"トリプライト原石": {ch: "トリプライト原石"},
			"嵐性岩": {ch: "嵐性岩"},
			"光曜石": {ch: "光曜石"},
			"強ソーダ水": {ch: "強ソーダ水"},
			"賢銅鉱": {ch: "賢銅鉱"},
			...
			"賢銅砂": {ch: "賢銅砂"},
			"闇霊銀砂": {ch: "闇霊銀砂"},
			"シャドウクォーツ": {ch: "シャドウクォーツ"},
			"ホワイトオークの枝": {ch: "ホワイトオークの枝"},
			"ピクシーアップル": {ch: "ピクシーアップル"},
			"フラントーヨ": {ch: "フラントーヨ"},
			"ホワイトオーク原木": {ch: "ホワイトオーク原木"},
			"ミラクルアップル原木": {ch: "ミラクルアップル原木"},
			"ホワイトアッシュ原木": {ch: "ホワイトアッシュ原木"},
			"オオミツバチの巣": {ch: "オオミツバチの巣"},
			"アンバークローヴ": {ch: "アンバークローヴ"},
			"サンドチーク原木": {ch: "サンドチーク原木"},
			"ハーコット": {ch: "ハーコット"},
			"リトルレモン": {ch: "リトルレモン"},
			"リグナムバイタ原木": {ch: "リグナムバイタ原木"},
			"サンダルウッド原木": {ch: "サンダルウッド原木"},
			"ダークペッパー": {ch: "ダークペッパー"},
			"パープルカロット": {ch: "パープルカロット"},
			"カーリーパセリ": {ch: "カーリーパセリ"},
			"ブラッドトマト": {ch: "ブラッドトマト"},
			"白亜麻": {ch: "白亜麻"},
			"ガーデンビート": {ch: "ガーデンビート"},
			"ブロードビーン": {ch: "ブロードビーン"},
			"虹マユ": {ch: "虹マユ"},
			"アップランド小麦": {ch: "アップランド小麦"},
			"ペパーミント": {ch: "ペパーミント"},
			"妖綿花": {ch: "妖綿花"},
			"クリームマッシュルーム": {ch: "クリームマッシュルーム"},
			"ロイヤルグレープ": {ch: "ロイヤルグレープ"},
			"ラセットポポト": {ch: "ラセットポポト"},
			"白玉土": {ch: "白玉土"},
			"スイートアリッサム": {ch: "スイートアリッサム"},
			"スイートマジョラム": {ch: "スイートマジョラム"},
			"ピナータラベンダー": {ch: "ピナータラベンダー"},
			"ミストスピナッチ": {ch: "ミストスピナッチ"},
			"コーヒービーン": {ch: "コーヒービーン"},
			"ボンバライス": {ch: "ボンバライス"},
			"ライムバジル": {ch: "ライムバジル"},
			"ドワーフ綿花": {ch: "ドワーフ綿花"},
		...
		"aetheryte": {
			...
			"トゥワイン": {ch: "トゥワイン"},
			"リダ・ラーン": {ch: "リダ・ラーン"},
			"プラ・エンニ茸窟": {ch: "プラ・エンニ茸窟"},
			"ヴォレクドルフ": {ch: "ヴォレクドルフ"},
			"スリザーバウ": {ch: "スリザーバウ"},
			"ファノヴの里": {ch: "ファノヴの里"},
			"オンドの潮溜まり": {ch: "オンドの潮溜まり"},
			"マカレンサス広場": {ch: "マカレンサス広場"},
		}
	};
