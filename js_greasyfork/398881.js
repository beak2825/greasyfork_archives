...
// @match        https://www.grupeer.com/*/my-investments*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/398881/Grupeer%20bulk%20download%20agreements.user.js
// @updateURL https://update.greasyfork.org/scripts/398881/Grupeer%20bulk%20download%20agreements.meta.js
// ==/UserScript==
    ...
    if($){
        ...
        async function action_save_pdfs(){
            ...
            for(var i=0; i<number_loans; i++){
                ...
                download_pdf(url_pdf, 'Grupeer Agreement - ' + agreement_id + ' - ' + project_id + ' (' + loan_originator + ').pdf');
