...
// @downloadURL https://update.greasyfork.org/scripts/28582/Hybrid%20-%20Calls%20-%20DCS.user.js
// @updateURL https://update.greasyfork.org/scripts/28582/Hybrid%20-%20Calls%20-%20DCS.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Contact")').length) {
    ...
    createButton('Past',0,0,1,3,'The contact used to work there, however they no longer do','Unsure');
