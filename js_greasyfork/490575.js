// ==UserScript==
// @name          ❤【超星学习通小助手】【正则改】注意打开章节学习界面脚本才会运行，修复无法关闭自动答题自动提交还有开启激活挂机功能】【完全免费】视频-章节测试|自动挂机|防清进度|不占资源
// @namespace    unrival
// @version      3.4.5
// @description  ▶▶▶上次更新：2025.5.20◀◀◀【💻可最小化💻】🆒支持超星视频、文档、答题、自定义正确率、掉线自动登录🤘取消视频文件加载，多开也不占用网速，放心追剧🍊自定义答题正确率，提高学习效率🍆每日功能测试，在发现问题前就解决问题，防清进度，无不良记录
// @author       unrival
// @run-at       document-end
...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>学习通小助手QQ交流群：808911108（群里有刷课软件分享）</title>
        ...
        <div class="row" style="margin: 10px;">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-info" id="normalQuery">
                    <div class="panel-heading">任务配置、代看地址：ffwk.2025ffwk.sbs<a href="http://ffxc.2025ffwk.sbs" target="view_window">点击这里打开代看</a></div>
                    <div class="panel-body">
                        <div>
                            ...
                            <div  style=" margin-top: 10px;">
                                 <div style="padding: 0;font-size: 20px;float: left;">代看地址：ffxc.2025ffwk.sbs</div>
                                <input type="text" id="token" style="width: 150px;" value="`+GM_getValue("tikutoken")+`">
                                 <a id='updateToken' class="btn btn-default" >保存</a>
                                 
                                 <br/>
                                 代看地址：ffxc.2025ffwk.sbs，新系统zy.ffwks.sbsQQ交流群：924255206群里不定时发放刷课软件及交流<br/>
                                 (哥哥)

                                <div class="panel-body">
                                    <img src="`+ base222 + `" alt="Smiley face" width="0" height="0">
                                    <p>过程很长，但我更加明白了『走捷径就是绕远路』这句话了<p/>
                                    <p>过程很长，但我更加明白了『走捷径就是绕远路』这句话了<p/>
                                    <p>代看地址：ffxc.2025ffwk.sbs，新系统zy.ffwks.sbs(复制链接浏览器打开)QQ交流群：924255206群里不定时发放刷课软件及交流<p/>
                                    <p>过程很长，但我更加明白了『走捷径就是绕远路』这句话了<p/>
                                </div>
                            </div>
                        </div>
...
`;
        var logs = {
            ...
            loopjob = () => {
                if (_w.top.unrivalScriptList.length > 1) {
                    logs.addLog('您同时开启了多QQ交流群：808911108（群里有刷课软件分享）个刷课脚本，会挂科，会挂科，会挂科，会挂科，会挂科，会挂科，会挂科，会挂科', 'red');
                }
                if (cVersion < 8.6 * 10) {
                    logs.addLog(
                        '\u60a8\u7684\u6d4f\u89c8\u5668\u5185\u6838\u8fc7\u8001\uff0c\u8bf7\u66f4\u65b0\u7248\u672c\u6216\u4f7f\u7528\u4e3b\u6d41\u6d4f\u89c8\u5668\uff0c\u63a8\u8350\u003c\u0061\u0020\u0068\u0072\u0065\u0066\u003d\u0022\u0068\u0074\u0074\u0070\u0073\u003a\u002f\u002f\u0077\u0077\u0077\u002e\u006d\u0069\u0063\u0072\u006f\u0073\u006f\u0066\u0074\u002e\u0063\u006f\u006d\u002f\u007a\u0068\u002d\u0063\u006e\u002f\u0065\u0064\u0067\u0065\u0022\u0020\u0074\u0061\u0072\u0067\u0065\u0074\u003d\u0022\u0076\u0069\u0065\u0077\u005f\u0077\u0069\u006e\u0064\u006f\u0077\u0022\u003e\u0065\u0064\u0067\u0065\u6d4f\u89c8\u5668\u003c\u002f\u0061\u003e',
        ...
        var video_getReady = (item) => {
            ...
            doVideo = (item) => {
                ...
                logs.addLog('如遇脚本使用异常情况，请检查脚本版本是否为最新版，<a href="http://www.2025ffwk.sbs" target="view_window">点我(脚本猫)</a>或<a href="http://www.2025ffwk.sbs" target="view_window">点我(greasyfork)</a>检查', 'orange');
                if (disableMonitor) {
