    ...
    // @namespace   https://greasyfork.org/zh-CN/scripts/29092/
    // @match       *trophymanager.com/matches/*
// @downloadURL https://update.greasyfork.org/scripts/29092/TMVN%20Match%20Compare.user.js
// @updateURL https://update.greasyfork.org/scripts/29092/TMVN%20Match%20Compare.meta.js
    // ==/UserScript==
...
(function () {
    ...
    function showInfo() {
        ...
        newdiv.innerHTML =
            "<br><div id=\"mystarbox\" class=\"home color\" style=\"background-color:rgb(127,127,127)\"><b style=\"color: gold;\">" + "评星:" + (clubDatas.get(homeClubId).REC / 11).toFixed(4) + " R5:" + (clubDatas.get(homeClubId).R5 / 11).toFixed(2) + "</b></div><div class=\"away color\"  style=\"background-color:rgb(10,5,76)\"><b style=\"color: gold;\">" + "评星:" + (clubDatas.get(awayClubId).REC / 11).toFixed(4) + " R5:" + (clubDatas.get(awayClubId).R5 / 11).toFixed(2) + "</b></div>" +

            "<br><div id=\"myxp\" class=\"home color\" style=\"background-color:rgb(127,127,127)\"><b style=\"color: gold;\">" + "经验:" + (clubDatas.get(homeClubId).XP / 11).toFixed(1) + " 年龄:" + (clubDatas.get(homeClubId).Age / 11 / 12).toFixed(1) + " SI:" + (clubDatas.get(homeClubId).ASI / 11).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "</b></div><div class=\"away color\"  style=\"background-color:rgb(10,5,76)\"><b style=\"color: gold;\">" + "经验:" + (clubDatas.get(awayClubId).XP / 11).toFixed(1) + " 年龄:" + (clubDatas.get(awayClubId).Age / 11 / 12).toFixed(1) + " SI:" + (clubDatas.get(awayClubId).ASI / 11).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "</b></div>" +

            "<br><div id=\"myxp\" class=\"home color\" style=\"background-color:rgb(127,127,127)\"><b style=\"color: gold;\">" + "身价:" + (clubDatas.get(homeClubId).BP / 11 / 1000).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " 工资:" + (clubDatas.get(homeClubId).Wage / 11 / 1000).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "</b></div><div class=\"away color\"  style=\"background-color:rgb(10,5,76)\"><b style=\"color: gold;\">" + "身价:" + (clubDatas.get(awayClubId).BP / 11 / 1000).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " 工资:" + (clubDatas.get(awayClubId).Wage / 11 / 1000).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "</b></div>";
