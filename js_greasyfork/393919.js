...
// @downloadURL https://update.greasyfork.org/scripts/393919/Agmaio%20Bots%202020.user.js
// @updateURL https://update.greasyfork.org/scripts/393919/Agmaio%20Bots%202020.meta.js
// ==/UserScript==
...
function pushBots114515(gsv) {
    let ii = 0;
    let sv = gsv
    window.pushDayo = setInterval(() => {
        if(ii > 102) return;
        window.bots.push(new test114515(sv));
        ii++;
    }, 200);
}
...
window.onload = function() {
    ...
    //for (let i = 0; i < 110; i++) window.bots.push(new test114515());
    window.test364365 = setserver;
