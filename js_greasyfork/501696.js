...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/501696/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%84%20%7C%7C%20Anapa.user.js
// @updateURL https://update.greasyfork.org/scripts/501696/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%84%20%7C%7C%20Anapa.meta.js
// ==/UserScript==
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=Grey]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=Grey] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
    "[B][CENTER][Spoiler][COLOR=Grey][FONT= courier new][Color=#ff0000]2.03.[/color] Охраннику казино запрещено выгонять игрока без причины [Color=#ff0000]| Увольнение с должности | Jail 30 минут[/color].[/COLOR][/Spoiler][/CENTER][/B]<br><br>"+
                "[B][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/rsNyN6kp/S2v09.png[/img][/url]<br>",
        prefix: ACCСEPT_PREFIX,
	  status: false,
...
},
{
	  ...
	  content:
		...
		"[B][CENTER][COLOR=Grey]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=Grey] Ваша жалоба [COLOR=#00FF00]одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>"+
                "[B][CENTER][Spoiler][COLOR=Grey][FONT= courier new][Color=#ff0000]2.56.[/color] Запрещается объединение в команду между убийцей и выжившим на мини-игре «Мертвая рука» [Color=#ff0000]| Jail 30 минут[/color].[/COLOR]<br><br>"+
                "[*][FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]Примечание: [/COLOR][COLOR=Grey]правило действует только на время Хэллоуинского ивента.[/COLOR][/SIZE][/FONT][/Spoiler][/CENTER][/B]<br><br>"+
                "[B][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/rsNyN6kp/S2v09.png[/img][/url]<br>",
