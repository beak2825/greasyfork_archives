...
// @license      No License
// @downloadURL https://update.greasyfork.org/scripts/559271/Black%20Russia%20Forum.user.js
// @updateURL https://update.greasyfork.org/scripts/559271/Black%20Russia%20Forum.meta.js
// ==/UserScript==
(function() {
    'use strict';
    ...
    const WALLPAPER_GALLERY = {
        "<i class='fas fa-magic'></i> В разработке": [""],
        "<i class='fas fa-tree'></i> В разработке": [""],
        "<i class='fas fa-snowflake'></i> В разработке": [""],
        "<i class='fas fa-city'></i> В разработке": [""],
        "<i class='fas fa-ghost'></i> В разработке": [""]
    };
