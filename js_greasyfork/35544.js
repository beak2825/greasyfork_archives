// ==UserScript==
// @name        PTE Custom Flunik Tools 2
// @namespace   FlunikTools
// @description Upgrades Offense or Defense or Buildings but not RT CY CC DEFFac or DefHQ.
// @version     17.6.18.2
// @author      dbendure, modified by FanTisi
// @include     http*://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/35544/PTE%20Custom%20Flunik%20Tools%202.user.js
// @updateURL https://update.greasyfork.org/scripts/35544/PTE%20Custom%20Flunik%20Tools%202.meta.js
// ==/UserScript==
(function (){
                ...
                if (typeof qx != 'undefined' && qx.core.Init.getApplication() && qx.core.Init.getApplication().getUIItem(ClientLib.Data.Missions.PATH.BAR_NAVIGATION) && qx.core.Init.getApplication().getUIItem(ClientLib.Data.Missions.PATH.BAR_NAVIGATION).isVisible()) {
                    ...
                    if (typeof ClientLib.API.Util.GetUnitMaxHealth == 'undefined'){
                        for (var key in ClientLib.Base.Util)
                        {
                            ...
                            if (strFunction.search(/function\s*\(a,b,c\).*\*=\s*1.1/g) != -1 ||
                                strFunction.search(/function\s*\(a,b\).*\*=\s*1.1/g) != -1)
                            {
