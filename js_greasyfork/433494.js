  ...
  // @name         A-bot erev
  // @version      1.22
  // @description  Nice script for erev
  // @author       Ahi
...
// @downloadURL https://update.greasyfork.org/scripts/433494/A-bot%20erev.user.js
// @updateURL https://update.greasyfork.org/scripts/433494/A-bot%20erev.meta.js
  // ==/UserScript==

/*
Script is active on erevollution battle page where you type how many hits you wanna do (or press ok then 200 is choosed) and then it's auto selected weapons
  ...
  (function () {
    ...
    function init() {
      if (currentHref === 'index') {
        ...
        setTimeout(() => {
          location.href="https://www.erevollution.com/en/companies";
      ...
      if (currentHref === 'companies') {
        ...
        setTimeout(() => {
            ...
            location.href = 'https://www.erevollution.com/en/training-grounds';
        }, 4000);
      }
      if (currentHref === 'training-grounds') {
        ...
        setTimeout(() => {
            ...
            location.href = 'https://www.erevollution.com/en/wars';
        }, 4000);
      }
      ...
      if (kills <= possibleKills) {
        console.log(`kills: ${kills}`)
          ...
          if (currentEnergy < 150) {
              ...
              setTimeout(function () {
                  location.href = 'https://erevollution.com/en/index';
                  document.querySelector('#energyButton').click(); console.log("Recovered energy...");
              }, 1000);
          }
      } else {
...
//*
    function pickUpBattle() {
      ...
      if (myCampText === myCountry || myCampText === 'Serbia' || myCampText === 'Croatia' || myCampText === 'Romania' || myCampText === 'Turkey' || myCampText === 'India' || myCampText === 'Italy') {
