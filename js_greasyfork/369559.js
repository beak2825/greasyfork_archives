// ==UserScript==
// @name           Virtonomica:ShopColoredPrices
// @namespace      virtonomic*
// @version        2.0
// @author         UnclWish
// @description    Добавление расцветки полей ввода цен в магазинах в зависимости от себестоимости
// @include        http*://virtonomic*.*/*/main/unit/view/*/trading_hall
// @downloadURL https://update.greasyfork.org/scripts/369559/Virtonomica%3AShopColoredPrices.user.js
// @updateURL https://update.greasyfork.org/scripts/369559/Virtonomica%3AShopColoredPrices.meta.js
// ==/UserScript==
...
if(hidd){$('table.grid>tbody>tr[class]').each(function(){
if($('input[name*="[price]"]',this).parent().prev().prop('textContent')=="---")
...
if($('input[name*="[price]"]',this).parent().prev().prop('textContent')=="---"){$(this).css('display',disp);}
...
show==1?inp.insertBefore($('table.grid>tbody>tr td>input[name*="[price]"][ss]:first')):inp.insertBefore($('table.grid>tbody>tr td>input[name*="[price]"][ss!=""]:first'));
...
var ss=$('input[name*="[price]"]',this).parent().prev().prop('textContent').replace(/[^\d\.]/g,'').replace(' ', '');
var sss=parseFloat($('input[name*="[price]"]',this).parent().prev().prop('textContent').replace(/[^\d\.]/g,'').replace(' ', ''));
...
hidd==0?inp.insertBefore($('table.grid>tbody>tr td>input[name*="[price]"][ss]:first')):inp.insertBefore($('table.grid>tbody>tr td>input[name*="[price]"][ss!=""]:first'));
$('input#xxx').css('width',"80px");
...
////////////////////////////////////////////////////////Одиночные изменения////////////////////////////////////////
$('table.grid>tbody>tr[class]>td>input[name*="[price]"]').dblclick(function(e){
var elem=$(this);
