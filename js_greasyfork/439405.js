...
function zip(){
  ...
  if(res==0){
  if($('#double_your_btc_stake').val()*1=="0.00000001"*1){
if($('#double_your_btc_payout_multiplier').val()=="21.00"){
...
if($('#double_your_btc_payout_multiplier').val()=="30.00"){
  $('#double_your_btc_payout_multiplier').val("28.00");
  $('#double_your_btc_stake').val("0.00000005"*1);
}else{
  $('#double_your_btc_payout_multiplier').val((odd+1).toString()+".00");
}
res =1;
  ...
  if(res==0){
  if($('#double_your_btc_stake').val()*1=="0.00000005"*1){
if($('#double_your_btc_payout_multiplier').val()=="33.00"){
  $('#double_your_btc_payout_multiplier').val("16.00");
