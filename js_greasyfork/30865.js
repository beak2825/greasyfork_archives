...
// @downloadURL https://update.greasyfork.org/scripts/30865/AMWEIA%20JIRA%20Links.user.js
// @updateURL https://update.greasyfork.org/scripts/30865/AMWEIA%20JIRA%20Links.meta.js
// ==/UserScript==

localStorage['issue-patterns'] = "AMWEIA-\\d+";
localStorage['jira-url'] = "https://amway-prod.tt.com.pl/jira/browse/";
...
function createLinkFromID(match) {
    ...
    link.href= jiraUrl + match[0].replace(/([A-Z]+)(\d+)/,'\$1-\$2');
