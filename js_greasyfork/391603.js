...
// @name:fr      Krunker.io Mod menu
// @namespace    KillerMic67 et Drpxx
// @version      1.7.9
// @description  Krunker Aimbot and other mod
// @description:fr  Krunker Aimbot and other mod
// @author       KillerMic67 et Drpxx
// @match        *://krunker.io/*
// @run-at       document-start
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/391603/Krunkerio%20Mod%20menu.user.js
// @updateURL https://update.greasyfork.org/scripts/391603/Krunkerio%20Mod%20menu.meta.js
// ==/UserScript==
...
function patch(script) {
    ...
    script = script.replace(/(this\[\'procInputs\'\]=function\((\w+),(\w+),(\w+)\)\{)/,
      `$1
        inputs = $2;
