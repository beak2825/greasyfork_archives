// ==UserScript==
// @name UserStyles.World (USw) - WideScreen v.66
...
// @downloadURL https://update.greasyfork.org/scripts/429033/UserStylesWorld%20%28USw%29%20-%20WideScreen%20v66.user.js
// @updateURL https://update.greasyfork.org/scripts/429033/UserStylesWorld%20%28USw%29%20-%20WideScreen%20v66.meta.js
// ==/UserScript==

(function() {
let css = "";
if ((location.hostname === "userstyles.world" || location.hostname.endsWith(".userstyles.world"))) {
  css += `

  /* ==== 0- UserStyles.World (USw) - WideScreen ) v.66 (new66) - TEST > ENABLE-OPT : A / B / A+B -(URL PREF) ==== */
...
if ((location.hostname === "userstyles.world" || location.hostname.endsWith(".userstyles.world"))) {
  css += `
  /* GM - Userstyles World Stats Keeper v 1.19 (new65) === */
...
if (location.href.startsWith("https://userstyles.world/search?q=") || location.href.startsWith("https://userstyles.world/search?") || location.href === "https://userstyles.world/explore" || location.href === "https://userstyles.world/") {
  css += `
...
if (location.href === "https://userstyles.world/") {
  css += `
  /* HOME  */
...
if (location.href.startsWith("https://userstyles.world/search?q=") || location.href.startsWith("https://userstyles.world/search?")) {
  css += `
  /* SEARCH */
...
if (location.href === "https://userstyles.world/explore") {
  css += `
  /* EXPLORE */
...
if (location.href.startsWith("https://userstyles.world/account/") || location.href.startsWith("https://userstyles.world/account#") || location.href === "https://userstyles.world/account") {
  css += `
  /* ACCOUNT */
...
if (location.href.startsWith("https://userstyles.world/user/")) {
  css += `
  /* USER */
  ...
  /* (new45) USER - SECTION - SOCIALS / LINKS - BUTTONS */
  ...
  /* (new62+) MY REVIEWS for OTHERS USERSTYLES - RIGHT */
  #content section.reviews.timeline {
      position: fixed  !important;
      display: inline-block !important;
      float: none !important;
      clear: none !important;
  ...
  #content section.reviews.timeline:hover {
      width: 100% !important;
      min-width: 83.6% !important;
  ...
  #content section.reviews.timeline > h2 {
      text-align: right  !important;
  }
  #content section.reviews.timeline article {
      display: inline-block !important;
      width: 33% !important;
  ...
  #content section.reviews.timeline article header + div {
  ...
  #content section.reviews.timeline article::before {
      content: ''!important;
      position: absolute !important;
      display: block !important;
      width: 1px !important;
      height: calc(100% - 3rem)!important;
      margin: 1em 0 0 calc(-1rem + 4px) !important;
  background-color: aqua !important;
  }

  /* HOVER */
  #content section.reviews.timeline article:hover {
      display: inline-block !important;
      width: 33% !important;
      height: 17vh !important;
      margin: 0 0 5px 0 !important;
  ...
  #content section.reviews.timeline article:hover header + div {
      display: -webkit-box !important;
  ...
  #content section.reviews.timeline article:hover::before {
    content: ''!important;
      position: absolute !important;
      display: block !important;
      width: 4px !important;
  ...
  /* (new66) TOP FIRST ONE - WITH SORT */
  #content section#styles > .flex:not(.rwrap):has(.count) .Form.Form-inline{
      position: fixed !important;
      display: inline-block !important;
      width: 100% !important;
      min-width: 18vw !important;
  ...
  #content section#styles > .flex:not(.rwrap):has(.count) .Form.Form-inline .Form-menu {
      display: flex;
      align-items: center;
      height: 3vh !important;
      margin: -0.2vh 0px 0 0px !important;
  }
  #content section#styles > .flex:not(.rwrap):has(.count) .Form.Form-inline .Form-menu .Form-select {
      min-height: 3vh !important;
      max-height: 3vh !important;
      line-height: 3vh !important;
  ...
  /* (new62) DARK */
  html[data-color-scheme="dark"] .card-footer .fg\\:3.flex:nth-child(2) .ml\\:s[data-tooltip]::before {
      color: gold !important;
  }
  /* NOT DARK */
  html:not([data-color-scheme="dark"]) .card-footer .fg\\:3.flex:nth-child(2) .ml\\:s[data-tooltip]::before {
      color: red !important;
  }

  /* (new62) DOWNLOAD  */
  .card-footer  .ai\\:c + small:not(.rating) svg{
      position: relative;
      display: flex !important;
...
if (location.href.startsWith("https://userstyles.world/style/")) {
  css += `
  /* STYLE */
  ...
  /* (new62) URL PREF - STYLE - IMPORTED FROM */
  ...
  /* (new53) STYLE - SECTIONS - HEADER - RIGHT */
  ...
  /* (new47) STYLE - MIRROR BUT - TOOLTIP */
  ...
  /* (new54) STYLE - SECTIONS - DESCRPTIONS  - RIGHT */
  ...
  /* (new63) STYLE - SECTIONS - NOTES - RIGHT */
  ...
  /* (new43)STYLE - SECTIONS - STATS / DETAILS - RIGHT */
  ...
  /* (new48) DETAILS - CODE CHECKSUM */
  #content section#details > p:last-of-type{
  ...
  /* (new50) STYLE - SECTIONS- DETAILS TAGS - RIGHT  */
  ...
  /* (new49) STYLE - SECTIONS - CODE - RIGHT */
  ...
  /* REVIEWS  */
  /* (new46) STYLE - SECTIONS - REVIEW - RIGHT */
  ...
  /* ===== (new53) STYLE - ENABLE-OPT A + B ==== */

  /* (new54) STYLE - ENABLE-OPT A + B [SIDEBAR + NEW DESIGN] - WIDESCSREEN - ALL */
  ...
  /* (new53) STYLE - ENABLE-OPT A + B - SECTIONS - ALL - NOT PREVIEW / REVIEWS ! ;*/
  ...
  /* (new54) STYLE - ENABLE-OPT A + B - SECTIONS - PREVIEW */
  ...
  /* (new54) STYLE - ENABLE-OPT A + B - SECTIONS - IMPORTED FROM */
  ...
  /* (new56) STYLE - ENABLE-OPT A + B - SECTIONS - HEADER */
  ...
  /* (new56) STYLE - ENABLE-OPT A + B - SECTIONS - DETAILS  */
  /* (new62)  COR FLOAT */
  html body[data-flags*="view_redesign"] > main#content section#details ,
  ...
  /* (new62)  COR FLOAT */
  /* (new53)STYLE - ENABLE-OPT A + B - SECTIONS - STATS  */
  ...
  /* (new53) STYLE - ENABLE-OPT A + B - SECTIONS - DESCRIPTION */
  ...
  /* (new53) STYLE - ENABLE-OPT A + B - SECTIONS - NOTES */
  ...
  /* (new53) STYLE - ENABLE-OPT A + B - SECTIONS - CODE */
  ...
  /* (new62) STYLE - ENABLE-OPT A + B / Same NO OPTIONS  - SECTIONS - REVIEWS  */

  /* (new62 STYLE - ENABLE-OPT A + B - SECTIONS - REVIEW - RIGHT */
  ...
  html body[data-flags*="view_redesign"] > main#content section#reviews  {
      ...
      right: 23.244% !important;
      margin:  1.3vh 0 0 0px !important;
      padding: 0 0.5rem !important;
      overflow: hidden !important;
  border: 1px solid red  !important;
  border-left: 3px solid red !important;
...
if (location.href.startsWith("https://userstyles.world/docs/")) {
  css += `
  /* DOCS (new61) */
  ...
  /* (new61) */
  html body > main > .docs.md li a  + ul {
      width: 64% !important;
...
if (location.href.startsWith("https://userstyles.world/edit/")) {
  css += `
  /* EDIT USERSTYLES */
  ...
  /* (new63) */
  form:not(.Form)[action^="/edit/"] textarea#description  {
      display: inline-block !important;
      float: none !important;
      clear: none !important;
      width: 100% !important;
