...
// @author       LSJD
// @match        https://www.flamzy.com/videos*
// @match        https://www.flamzy.com/entry*
...
// @include      http*://j.gs*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/372045/Flamzy.user.js
// @updateURL https://update.greasyfork.org/scripts/372045/Flamzy.meta.js
// ==/UserScript==
...
(function() {
    ...
    if(window.document.title.toLowerCase() == "flamzy"){
        ...
        var rellenar_entradas = function (videos_restantes) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#entradas", info_container).html("Anda mempunyai " + total_entradas + " entries (Maksimal 10 entries).");
                }
            });
        };
        ...
        var rellenar_videos_faltantes = function(videos_restantes){
            if(videos_restantes > 1)
                $("#videos_restantes", info_container).html("Tinggal " + videos_restantes + " video yang tersisa.");
            else if(videos_restantes == 1)
                $("#videos_restantes", info_container).html("Ini adalah video yang terakhir.");
        };
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if(response.showCaptcha){
                                    ...
                                    print_status("PERINGATAN: Ada Captcha!");
                                }
