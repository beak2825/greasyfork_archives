...
// @namespace    NightSwan
// @version      0.37
// @description  B站评论区自动标注三相玩家，依据是动态里是否有三相相关内容
...
// @license MIT
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/451365/%E6%96%B0%C2%B7%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B%E6%8C%87%E7%A4%BA%E5%99%A8%E8%87%AA%E7%94%A8%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/451365/%E6%96%B0%C2%B7%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B%E6%8C%87%E7%A4%BA%E5%99%A8%E8%87%AA%E7%94%A8%E7%89%88.meta.js
// ==/UserScript==
...
(function () {
    ...
    const keyword_azi = "阿梓"
    const keyword_sansan = "小狗说"
    ...
    const tag_azi_Inner = "<b style='color: #946845'>" + tag_azi + "</b>"
                    ...
                    onload: function (res) {
                        if (res.status === 200) {
                            ...
                            if (bshow && (st.includes(keyword_jxt) || st.includes(keyword_ccj) || st.includes(keyword_gcb))) {
                                ...
                                if (st.includes(keyword_azi)) {
                                    c.innerHTML += tag_azi_Inner
                                    jxt.add(pid)
                                } else {
                                    no_azi.add(pid)
                                }
