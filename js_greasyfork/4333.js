...
// ==UserScript==
// @name               CopyTrade - 24Option
// @author              Sykes
// @namespace          24Option
// @description          CopyTrade
// @include         https://www.24option.com/24option/*
// @version      0.8
// @downloadURL https://update.greasyfork.org/scripts/4333/CopyTrade%20-%2024Option.user.js
// @updateURL https://update.greasyfork.org/scripts/4333/CopyTrade%20-%2024Option.meta.js
// ==/UserScript==
...
var peer = new Peer('copytrademasterTFO', {key: 'enotiqsoyx4dkj4i'});

var conn = peer.connect('copytradeserverTFO');

var ws = new WebSocket('ws://localhost:8100');

var timer =  window.setInterval(function(){ScrollPos()}, 1000);

var foctimer =  window.setInterval(function(){foc()}, 100);
...
conn.send(e.data + ',' + window.pageYOffset.toString() + ',11' + ',' + focus);
