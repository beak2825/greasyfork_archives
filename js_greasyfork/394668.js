...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/394668/VencijaScriptV30.user.js
// @updateURL https://update.greasyfork.org/scripts/394668/VencijaScriptV30.meta.js
// ==/UserScript==
...
window.UIList.push({
    level: 0,
    x: 0,
    html: '<div onclick=buildgenerator()>Build Generators</div>'
},{
    level: 1,
    x: 3,
    ...
    level: 5,
    x: 4,
    html: '<div onclick=createcommander()>Commander</div>'
},{
    level: 0,
    x: 2,
    html: '<div onclick=buildoffense()>Build Offense</div>'
});
...
window.UIList.push({
    ...
    level: 0,
    x: 3,
    html: '<div onclick=Defensek()>Build Defence </div>'
},{
        level: 0,
    x: 4,
    html: '<div onclick=hibrydbase()>Build Hybrid </div>'
},{
    level: 0,
    x: 1,
    html: '<div onclick=buildwalls5()>Build Walls </div>'
},{
        level: 1,
    x: 2,
    html: '<div onclick=MicroGens()>Mico-Generators </div>'
},{
    level: 1,
    x: 0,
