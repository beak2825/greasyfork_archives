...
// @version      2.0
// @description  可以查看大部分视频，但必须手动注册登录
// @author       y.346.ecui.top
// @license      MIT
...
// @downloadURL https://update.greasyfork.org/scripts/484983/hj20.user.js
// @updateURL https://update.greasyfork.org/scripts/484983/hj20.meta.js
// ==/UserScript==
...
/*
  ...
  // 延时1秒后执行的代码
        ...
        //document.getElementsByClassName('preview-title')[0].remove()
        //console.log("textsent", textsent)
        runAsync("http://1.92.71.103/getnmm6", "POST", textsent).then((result) => { return result; }).then(function (result) {
            //console.log(result);
            alert("视频解析成功！用的好的话，希望大家多打赏，达不到预期我只好收费卖去了，没精力用爱发电。视频需要下载的请下载安装油猴脚本说明界面里的脚本就可以了");
