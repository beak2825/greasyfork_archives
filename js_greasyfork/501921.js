// ==UserScript==
// @name         Форумный скрипт для взрослого лисёнка❤️
// @namespace    https://forum.blackrussia.online
// @version      1.1
// @description  Форумный скрипт для мужа Амирчика❤️
// @author       Kumiho
...
// @downloadURL
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/501921/%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%B2%D0%B7%D1%80%D0%BE%D1%81%D0%BB%D0%BE%D0%B3%D0%BE%20%D0%BB%D0%B8%D1%81%D1%91%D0%BD%D0%BA%D0%B0%E2%9D%A4%EF%B8%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/501921/%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%BD%D1%8B%D0%B9%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%B2%D0%B7%D1%80%D0%BE%D1%81%D0%BB%D0%BE%D0%B3%D0%BE%20%D0%BB%D0%B8%D1%81%D1%91%D0%BD%D0%BA%D0%B0%E2%9D%A4%EF%B8%8F.meta.js
// ==/UserScript==
...
(function () {
    ...
    const TRANSFER_PREFIX4 = 19; // перенос в жб на игроков 35
    const TRANSFER_PREFIX5 = 20; // перенос в жб на лидеров 35
    const TRANSFER_PREFIX6 = 21; // перенос в обжалования 35
    const NO_PREFIX = 0;
	const buttons = [
	{
		title: 'Амурский Кумихо ❤️',
		content:
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/X7BFZ3Z7/1000011947.gif[/img][/url]<br>' +
        '[CENTER]<br>' +
		'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF0000]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/nVRNk8HD/Picsart-23-10-14-02-48-00-592.png[/img][/url]<br>' +
	...
	},
{
	...
	},
	{
		...
		content:
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/X7BFZ3Z7/1000011947.gif[/img][/url]<br>' +         '[CENTER]<br>' +
		'[SIZE=4][FONT=Veranda][CENTER][COLOR=#FF0000]{{ greeting }}, уважаемый[/COLOR][B] {{ user.mention }}[/B]![/CENTER]<br><br>' +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/nVRNk8HD/Picsart-23-10-14-02-48-00-592.png[/img][/url]<br>' +
        '[CENTER]<br>' +
    ...
    },
{
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/nVRNk8HD/Picsart-23-10-14-02-48-00-592.png[/img][/url]<br>' +
        '[CENTER]<br>' +
        '[CENTER]Ваш аккаунт будет разблокирован в течении 24-х часов. [/CENTER]<br>' +
...
const Button51 = buttonConfig("ТР 31", 'https://forum.blackrussia.online/forums/Технический-раздел-ekb.1458/');
const Button52 = buttonConfig("ТР 32", "https://forum.blackrussia.online/forums/Технический-раздел-krasnodar.1460/");
const Button53 = buttonConfig("ТР 33", "https://forum.blackrussia.online/forums/Технический-раздел-arzamas.1502/");
const Button54 = buttonConfig("ТР 34", "https://forum.blackrussia.online/forums/Технический-раздел-novosibirsk.1544/");
const Button55 = buttonConfig("ТР 35", "https://forum.blackrussia.online/forums/Технический-раздел-grozny.1586/")
...
const ButtonTech53 = buttonConfig("ЖБ 33", "https://forum.blackrussia.online/forums/Сервер-№33-arzamas.1501/")
const ButtonTech54 = buttonConfig("ЖБ 34", "https://forum.blackrussia.online/forums/Сервер-№34-novosibirsk.1543/")
const ButtonTech55 = buttonConfig("ЖБ 35", "https://forum.blackrussia.online/forums/Сервер-№35-grozny.1585/")
const ButtonComp51 = buttonConfig("ИГР 31", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.1444/")
const ButtonComp52 = buttonConfig("ИГР 32", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.1488/")
const ButtonComp53 = buttonConfig("ИГР 33", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.1531/")
const ButtonComp54 = buttonConfig("ИГР 34", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.1572/")
const ButtonComp55 = buttonConfig("ИГР 35", "https://forum.blackrussia.online/forums/Жалобы-на-игроков.1614/")
