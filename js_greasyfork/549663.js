...
// @downloadURL https://update.greasyfork.org/scripts/549663/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/549663/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.meta.js
// ==/UserScript==
...
(function () {
    ...
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(0,168,133)]IZHEVSK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: ACCEPT_PREFIX,
    status: false,
    },
    {
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/Сервер-№85-izhevsk.3746/']«Жалобы на технических Специалистов [Color=rgb(128,0,64)]CHERRY[/color]».[/URL][/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(0,168,133)]IZHEVSK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Обратитесь со своей проблемов в  [URL='https://forum.blackrussia.online/forums/Технический-раздел-izhevsk.3747/']«Технический раздел [Color=rgb(128,0,64)]CHERRY[/COLOR]».[/URL][/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(0,168,133)]IZHEVSK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Главному Администратору[/color] - @Anna_Provinceva [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>",
    prefix: GA_PREFIX,
    status: true,
    },
    {
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Заместителям Главного Администратора[/color] - @Nikolay Lubimov,@Michael Tratyu [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>",
    prefix: PIN_PREFIX,
    status: true,
    },
    {
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [COLOR=rgb(204,6,5)]Специальной Администрации[/color] - @Sander_Kligan, @Clarence Crown, @Dmitry Dmitrich, @Myron_Capone, @Liana_Mironova,@Gleb Xovirs.[/CENTER]<br><br>"+
    '[CENTER][Color=Orange]На рассмотрении.[/Color][/CENTER][/B][/SIZE]',
    prefix: SA_PREFIX,
    status: true,
    },
