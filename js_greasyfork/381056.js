// ==UserScript==
// @name         超星刷课助手
// @namespace    1031296630@qq.com
// @version      1.0
// @description  自动挂机看超星尔雅MOOC，支持后台、切换窗口不暂停，视频自动切换，屏蔽视频内的题目，倍速播放、进度条拖动、快进快退
// @author       1031296630
// @match        *://*.chaoxing.com/*
// @require      https://greasyfork.org/scripts/18715/code/Hooks.js?version=661566
// @connect      http://xxk.chuh.cc/
// @run-at       document-end
// @grant        unsafeWindow
...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/381056/%E8%B6%85%E6%98%9F%E5%88%B7%E8%AF%BE%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/381056/%E8%B6%85%E6%98%9F%E5%88%B7%E8%AF%BE%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==

// 设置修改后，需要刷新或重新打开网课页面才会生效
var setting = {
    // 3E3 == 3000，科学记数法，表示毫秒数
    time: 3E3 // 默认响应速度为3秒，不建议小于3秒
...
function findAnswer() {
    ...
    GM_xmlhttpRequest({
        method: 'POST',
        url: 'http://xxk.chuh.cc/' + (setting.token || 0) + '/' + encodeURIComponent(question),
        headers: {
