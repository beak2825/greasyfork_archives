...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/540654/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20AQUA.user.js
// @updateURL https://update.greasyfork.org/scripts/540654/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20AQUA.meta.js
// ==/UserScript==
...
(async function () {
      ...
      },
 {
	...
	},
	{
	  ...
	  content:
		`[CENTER][SIZE=4][FONT=georgia][COLOR=rgb(255, 0, 0)]${greeting}, уважаемый(-ая)[/COLOR] ${user.mention}[/FONT][/SIZE][/CENTER]<br><br>`+
		`[CENTER]Внимательно ознакомившись с вашей жалобой, было решено, что вам нужно обраться в раздел обжалование наказани.<br><br>` +
		`[CENTER][COLOR=rgb(255, 0, 0)]Отказано.[/COLOR][/CENTER]<br>`,
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
