// ==UserScript==
// @name        FUTBIN - Vivalemuc autobuyer PGP
// @version     1.0.0
// @description Advanced mode from PGP
// @license     MIT
// @author      Vivalemuc
...
// @downloadURL https://update.greasyfork.org/scripts/435577/FUTBIN%20-%20Vivalemuc%20autobuyer%20PGP.user.js
// @updateURL https://update.greasyfork.org/scripts/435577/FUTBIN%20-%20Vivalemuc%20autobuyer%20PGP.meta.js
// ==/UserScript==
...
(function() {
    ...
    $('.page-header-top')[0].appendChild(a);
    ...
    $('.page-header-top')[0].appendChild(aX);
    ...
    $('.page-header-top')[0].appendChild(aP);
