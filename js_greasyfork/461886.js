...
// @homepage https://greasyfork.org/ru/scripts/435537

// @include *heroeswm.ru/clan_info.php*
// @grant none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/461886/clanSort.user.js
// @updateURL https://update.greasyfork.org/scripts/461886/clanSort.meta.js
// ==/UserScript==
window.onload = function () {
	...
	function sortIvent() {
		if (iventCol < 0) {
			alert('Места в ивенте не определяются. Видимо, нет кланового ивента...');
			return 0;
		}
	...
	function sortLevel() {
		if (levelCol < 0) {
			alert('Уровни не определяются. Да ХЗ почему...');
			return 0;
		}
	...
	function sortFrac() {
		if (fracCol < 0) {
			alert('Фракции не определяются. Видимо, клан воюет...');
			return 0;
		}
	...
	function sortAbc() {
		if (abcCol < 0) {
			alert('Не вижу колонки с именами. Херня какая-то...');
			return 0;
		}
