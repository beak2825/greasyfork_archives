// ==UserScript==
// @name         ED Combined CH R Marlies Fegbleroth
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/489296/ED%20Combined%20CH%20R%20Marlies%20Fegbleroth.user.js
// @updateURL https://update.greasyfork.org/scripts/489296/ED%20Combined%20CH%20R%20Marlies%20Fegbleroth.meta.js
// ==/UserScript==
...
// //INDEXING STARTS AT 1, NOT 0
 var MBALANCE_CONFIGS = [
   ...
   { index: 4, adjustmentAmount: 0},// Vermögen
...
var adjustmentAmount = 0; // Change this value to adjust the balance accordingly

// Configurable desired IBAN
var desiredIban = "543 CH04 8080 8005 1061 1417 6";
...
function checkAndReinsertTransactions() {
    ...
    transactionDetailsArray.forEach(function(transactionDetails) {
        ...
        if (!transactionDetails.inserted) {
            ...
            // Check if the transaction is still present on the page
            var transactionFound = isTransactionPresent(transactionDetails.title);
            if (!transactionFound) {
                console.log("Transaction not found on the page. Reinserting...");
                insertTransactions();
                return; // Exit the loop after reinserting one transaction
            }
            console.log("Transaction already inserted:", transactionDetails.title);
