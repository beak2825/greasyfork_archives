...
// @namespace https://greasyfork.org/users/7446
// @downloadURL https://update.greasyfork.org/scripts/6832/Google%2B%20Photos%20Download.user.js
// @updateURL https://update.greasyfork.org/scripts/6832/Google%2B%20Photos%20Download.meta.js
// ==/UserScript==
var MAX_IMAGES = 100;
...
(function()
{
	...
	var append = '<div id="gplus"><div class="d-k-l b-c b-c-R b-c-da-ja mFd i1d" id="PicasaDownload">Picasa</div>';

	append += '<div class="d-k-l b-c b-c-R b-c-da-ja mFd i1d" id="NewPage">Full Size Images</div>';
	
	append += '<div class="d-k-l b-c b-c-R b-c-da-ja mFd i1d" id="ScrollToBottom">︾</div></div>';	
...
//	console.log($('.Koa').offset().top);
	$('#gplus').css('top', 12);
	$('#gplus').css('left', $(document).width()-600);
...
var ap = '<div class="downloadIt"><div class="yKm1Pc ufIVef"></div><span class="wILgub ufIVef" data-tooltip="Open in new tab" data-tooltip-align="b" style="left:50px !important;"><a  href="';
var ap2 = '" target="_blank"><img alt="Im" src="http://cdn1.iconfinder.com/data/icons/fatcow/32x32_0500/image_add.png" style="z-index:1000;width:26px;height:auto;" /></a></span></div>';
	$(document).off('mouseover', '.PkkLkd');
	$(document).on('mouseover', '.PkkLkd', function() {
...
//			var t = $(this).find('.m-la-qONoCf-Id-soaiwe-b');
			...
			$(this).append(ap + url +ap2);
		}
	});
	
	$(document).off('mouseover', '.downloadIt');
	$(document).on('mouseover', '.downloadIt', function(e) {
		$(this).removeClass('ufIVef');
	});
