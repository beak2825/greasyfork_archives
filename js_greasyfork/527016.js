// ==UserScript==
// @name         Для кураторов форума Black Russia | PENZA
// @namespace    https://forum.blackrussia.online/
// @version      1.2
// @description  Специально созданный скрипт для КФ PENZA
// @author       I.Forest
...
// @license      MIT
// @icon         none
// @downloadURL https://update.greasyfork.org/scripts/527016/%D0%94%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Black%20Russia%20%7C%20PENZA.user.js
// @updateURL https://update.greasyfork.org/scripts/527016/%D0%94%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Black%20Russia%20%7C%20PENZA.meta.js
// ==/UserScript==
	...
	},
	{
        title: ' ᅠᅠ.... Обычные темы регламента ....      ',
	},
         {
            ...
            content:
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(238, 238, 238)][FONT=Georgia][SIZE=4]Ваша жалоба взята на рассмотрение, ожидайте ответа в данной теме.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(238, 238, 238)][FONT=Georgia][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
             '[CENTER][SIZE=5][COLOR=rgb(255,255,255)][FONT=Georgia]Приятной игры на сервере [/COLOR][COLOR=rgb(0, 255, 0)] PENZA [/COLOR][/FONT][/SIZE][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
               "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
              ...
              "[LIST]<br>" +
              "[*][LEFT][FONT=book antiqua][COLOR=rgb(255, 0, 0)][SIZE=4]Примечание: [/SIZE][/COLOR][COLOR=rgb(0, 255, 0)][SIZE=4]разрешен ответный DM в целях защиты, обязательно иметь видео доказательство в случае наказания администрации, нанесение урона по транспорту также является нарушением данного пункта правил.[/SIZE][/COLOR][/FONT][/LEFT]<br>" +
              "[*][LEFT][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 255, 0)][FONT=book antiqua][SIZE=4]нанесение урона с целью защиты особняка или его территории, а также нанесение урона после ДТП не является веской IC причиной, для войны семей предусмотрено отдельное системное мероприятие.[/SIZE][/FONT][/COLOR][/CENTER][/LEFT]<br>" +
              "[/LIST]<br>" +

              '[CENTER][SIZE=5][COLOR=rgb(255,255,255)][FONT=Georgia]Приятной игры на сервере [/COLOR][COLOR=rgb(0,204,255)] PENZA [/COLOR][/FONT][/SIZE][/CENTER]',
          ...
          },
{
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил госс организаций:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
{
        ...
        },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
{
            ...
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(236, 124, 38, 0.5)',
            content:
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][ICODE]{{ greeting }}, уважаемый {{ user.name }}[/ICODE].[/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
              ...
              "[/LIST]<br><br>" +
              "[I][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Приятной игры на BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=Georgia][SIZE=4]Role Play[/SIZE][/FONT][/COLOR][COLOR=rgb(0, 140, 240)][FONT=Georgia][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" ,
            prefix: ACCEPT_PREFIX,
            status: false,
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Нарушитель буден наказан по пункту общих правил серверов[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
      	...
      	},
        {
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Данный промокод является системным, или был выпущен  разработчиками[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
	...
	},
    {
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил ограблений/похищений :[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Нарушитель буден наказан по следующему пункту правил государственных структур::[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Нарушитель буден наказан по следующему пункту правил нападения на Военскую часть:[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
	...
	},
	 {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 102, 0)][I][FONT=Georgia][SIZE=4]Техническому Специалисту[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Ваша жалоба переадресована [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Главному администратору[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Просьба не создавать дубликаты данной темы, иначе ваш форумный аккаунт может быть заблокирован.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию - [/I][URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8E.3053/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров - [/I][URL='https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%BB%D0%B8%D0%B4%D0%B5%D1%80%D0%BE%D0%B2.3054/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Вы ошиблись разделом, обратитесь в раздел жалоб на Агентов поддержки - [/I][URL='https://forum.blackrussia.online/index.php?threads/ekb-Жалобы-на-Агентов-Поддержки.4295218/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Вы ошиблись разделом, обратитесь в жалобы на сотрудников фракции[/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Вы ошиблись разделом, обратитесь в раздел Обжалование наказаний - [/I][URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.3056/']*Нажмите сюда*[/URL][/SIZE][/FONT][/COLOR][/CENTER]<br><br>" +
	...
	},
    {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Недостаточно доказательств для корректного рассмотрения вашей жалобы.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Отсутствуют доказательства - следовательно, рассмотрению не подлежит. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Ваши доказательства не рабочие или же битая ссылка.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Ваша видеозапись обрывается. Загрузите полную видеозапись на видео-хостинг YouTube.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Доказательства были подвергнуты редактированию - следовательно, рассмотрению не подлежит.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]В данной ситуации обязательнодолжен быть фрапс(видео фиксация)всех моментов.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4] Доказательства в соц. сетях не принимаются. Загрузите доказательства на фото-видео хостинги YouTube, Imgur, Yapx и так далее.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Видео фиксация не полная либо же нет условий сделки.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]На доказательствах отсутствуют дата и время[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Ваша жалоба отказана, т.к в ней нету таймкодов. Если видео длится больше 3-ех минут - Вы должны указать таймкоды нарушений.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]В предоставленных доказательствах отсутствуют условия сделки.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Нарушений со стороны игрока не было замечено. [/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
    {
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Ваш заголовок составлен не по форме. Внимательно прочтите правила создания темы, прикрепленные в этом разделе.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Ваша жалоба отказана по причине: нельзя писать одну жалобу на двух и более игроков ( на каждого игрока отдельная жалоба)[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Ваша жалоба составлена не по форме. Внимательно прочитайте правила подачи жалоб на игроков, закрепленные в этом разделе.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Данный нарушитель уже был наказан ранее.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Вам уже был дан ответ в прошлых жалобах[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]С моменты нарушения прошло более 72-х часов[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
              "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4]Ваша жалоба написана от 3-его лица. Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
	   ...
	   },
       {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Биография получает статус [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(152, 251, 152)][I][FONT=Georgia][SIZE=4]Одобрено[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Биография получает статус [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]В пункте *Детство* и *Юность и Взрослая* жизнь мало информации.[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]В вашей RolePlay Биографии заголовок написан не по форме, внимательно прочитайте правила РП Биографии в закрепленые в данном разделе[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Биография написана не по форме [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Вы не дополнили свою RolePlay Биографию [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Биография оформлена неграмотно.[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[LIST]<br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][SIZE=4]Ваша RolePlay Биография оформлена неграмотно.[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=Georgia][FONT=Georgia][SIZE=4] Обратите внимание на знаки препинания!.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[LIST]<br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Биография написана от 3-его лица [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Вы приписали своему персонажу суперспособности  [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Биография скопирована у другого человека[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]У вас NonRp NickName [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]В вашей RolePlay Биографии не совпадает дата рождения с возрастом [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            '[CENTER][SIZE=5][COLOR=rgb(255,255,255)][FONT=Georgia]Приятной игры на сервере [/COLOR][COLOR=rgb(0, 255, 0)] PENZA [/COLOR][/FONT][/SIZE][/CENTER]',
            prefix: UNACCEPT_PREFIX,
            status: false,
          },
         {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]В ваша RolePlay Биографии семья расписано не полностью[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]В ваша RolePlay Биографии дата рождения расписано не полностью [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Биография взята на доработку[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]У вас есть 24 часа чтобы дополнить RP Биографию[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
	...
	},
      {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Ситуация получает статус [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(152, 251, 152)][I][FONT=Georgia][SIZE=4]Одобрено[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Вы ошиблись разделом [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Ситуация написана не по форме [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
         {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Ситуация получает статус [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Ситуация взята на доработку[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]У вас есть 24 часа чтобы дополнить свою RP Ситуацию[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Ситуация написана не грамотно т.е в ней много ошибок.[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Ситуация скопирована у другого человека[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
         {
          title: 'Не дополнили',
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Вы не дополнили свою RolePlay Ситуацию [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]В вашей RolePlay Ситуации заголовок написан не по форме, внимательно прочитайте правила РП Ситуации в закрепленые в данном разделе[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
        ...
        dpstyle: 'oswald: 3px;     color: #fff; background: #7851A9; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #7851A9',
	},
         {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Организация получает статус [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(152, 251, 152)][I][FONT=Georgia][SIZE=4]Одобрено[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Организация написана не по форме [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Организация получает статус [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Организация взята на доработку[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]У вас есть 24 часа чтобы дополнить свою RP Организация [/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
          {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Организация написана не грамотно т.е вы допустили ней много ошибок.[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
       {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Ваша RolePlay Организация скопирована у другого человека[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
         {
          title: 'Не дополнили',
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]Вы не дополнили свою RolePlay Организацию [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
          ...
          },
         {
            ...
            '[COLOR=rgb(255, 153, 0)][FONT=Georgia][SIZE=4][I][CENTER]{{ greeting }}, уважаемый {{ user.name }}[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(255, 255, 255)][FONT=Georgia][SIZE=4]В вашей RolePlay Организации заголовок написан не по форме, внимательно прочитайте правила РП Организации в закрепленые в данном разделе[/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=Georgia][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
...
// @name        New script blackrussia.online
// @namespace   Violentmonkey Scripts
// @match       https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9654-penza.2389/*
// @grant       none
// @version     1.0
// @author      -
// @description 09.01.2025, 22:17:52
// ==/UserScript==
