...
// @downloadURL https://update.greasyfork.org/scripts/447388/TECH%20BLACK.user.js
// @updateURL https://update.greasyfork.org/scripts/447388/TECH%20BLACK.meta.js
// ==/UserScript==
...
content:
	    '[CENTER][B]{{ greeting }}![/B][/CENTER]<br><br>' +
	    "[CENTER]Ваша тема закреплена и находиться на рассмотрении.<br><br>" +
...
content:
		'[CENTER][B]{{ greeting }}![/B][/CENTER]<br><br>' +
        '[CENTER]Обратитесь в жалобы на администрацию своего сервера.<br>' +
        '[CENTER][I]Отказано[/I]. :( [/CENTER]',
	prefix: UNACCEPT_PREFIX,
	status: false,
},
