...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/544851/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B%2020.user.js
// @updateURL https://update.greasyfork.org/scripts/544851/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B%2020.meta.js
// ==/UserScript==
(function () {
'esversion 6' ;
const FAIL_PREFIX = 4;
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>' +
"[CENTER]Данные действия не наказуемы.[/CENTER]<br><br>" +
'[CENTER][COLOR=#ff0000]Отказано, закрыто.[/COLOR][/CENTER]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>' +
"[B][CENTER][COLOR=lavender]Данная тема уже находится на рассмотрении. Не нужно создавать копии​<br><br>" +
'[CENTER][COLOR=#ff0000]Отказано, закрыто.[/COLOR][/CENTER][/FONT][/SIZE]',
prefix: CLOSE_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>'+
"[B][CENTER][COLOR=lavender] Загрузка доказательств в соц. сети (ВКонтакте, instagram) запрещается, доказательства должны быть загружены на фото/видео хостинги (YouTube, Япикс, imgur).<br><br>" +
'[CENTER][COLOR=#ff0000]Отказано, закрыто.[/COLOR][/CENTER][/FONT][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>'+
"[B][CENTER][COLOR=lavender]Заявка от третьего лица не принимается (заявка должна быть подана владельцем аккаунта)..<br><br>" +
'[CENTER][COLOR=#ff0000]Отказано, закрыто.[/COLOR][/CENTER][/FONT][/SIZE]',
prefix: UNACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>'+
"[CENTER]Вы будете вынесены из Черного Списка Администрации, впредь не совершайте подобных ошибок..[/CENTER]<br><br>"+
'[CENTER][COLOR=#38ff4c]Одобрено, закрыто.[/COLOR][/CENTER][/FONT][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
        },
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>'+
"[CENTER]Вы будете вынесены из Черного Списка Сервера, впредь не совершайте подобных ошибок..[/CENTER]<br><br>"+
'[CENTER][COLOR=#38ff4c]Одобрено, закрыто.[/COLOR][/CENTER][/FONT][/SIZE]',
prefix: ACCEPT_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>'+
"[B][CENTER][COLOR=lavender] Ваше обжалование передано Специальному Администратору, а так же его Заместителям, пожалуйста ожидайте ответа..<br><br>" +
'[B][CENTER][COLOR=yellow]Передано Специальной Администрации[/FONT][/COLOR][/CENTER][/B]',
prefix: SPECIAL_PREFIX,
status: true,
},
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>'+
"[B][CENTER][COLOR=lavender] Ваше обжалование передано Главному Администратору , пожалуйста ожидайте ответа.<br><br>" +
'[CENTER][COLOR=#ff0000]Передано Главному Администратору.[/COLOR][/CENTER][/FONT][/SIZE]',
prefix: GA_PREFIX,
status: true,
},
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>' +
"[B][CENTER][COLOR=lavender]Вы попали на заблокированный айпи адрес. Ваш аккаунт не находится в блокировке, переживать не стоит. Причиной попадания в данную ситуацию могло быть разное, например, смена мобильного интернета, переезд и тому подобное. Чтобы избежать данную ситуацию, вам необходимо перезагрузить телефон или воспользоваться услугами VPN.​<br><br>" +
'[CENTER][COLOR=#ff0000]Отказано, закрыто.[/COLOR][/CENTER][/FONT][/SIZE]',
prefix: CLOSE_PREFIX,
status: false,
},
...
content:
'[SIZE=4][FONT=Times New Roman][COLOR=#db7093][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>' +
"[B][CENTER][COLOR=lavender]Ваш аккаунт будет разблокирован на 24 часа для исправления нарушения.После передачи украденного имущества прикрепите запись сделки. В случае передачи имущества на твинк-аккаунт вы будете заблокированы навсегда без возможности обжалования.​<br><br>" +
'[CENTER][COLOR=#ffd838]На рассмотрении…[/COLOR][/CENTER][/FONT][/SIZE]',
prefix: PIN_PREFIX,
status: true,
},
...
// addButton('Тех. спецу', 'tech');
    ...
    addButton('Закрыто', 'close', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5);')
