...
// @version     1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/35858/Auto%20wacker.user.js
// @updateURL https://update.greasyfork.org/scripts/35858/Auto%20wacker.meta.js
// ==/UserScript==
    ...
    constructor() {
        ...
        if (typeof savedTimeout != "undefined") {
            ...
            if (!Number.isNaN(savedTimeout))
                this._wackTimeout = savedTimeoutl
        }
