...
// @grant               GM_getValue
// @grant               GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/20888/Steam%20Free%20License%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/20888/Steam%20Free%20License%20Helper.meta.js
// ==/UserScript==
...
if( location.href.match( /^https:\/\/steamdb\.info\/search\/.*sub_keyname.*$/ ) ) {
    ...
    var sflh_btns = $( '<span style="float:right; ">' +
                      ...
                      '<button type="button" id="getlist" class="btn" style="margin-top: -7px; margin-right: -9px; margin-left: 6px;">Update Steam FLH ' + sflh_type + ' subs list</button>' +
                      '</span>' ); // modify by leeairw 2018/04/03 add id="getlist",remove js call
    ...
    if ( sflh_typeID === 'sflh_fods' || sflh_typeID == 'sflh_nocs' ) {
        ...
        // modify by leeairw 2018/04/03 bind click function
        var listbox = document.getElementById("getlist");
        ...
        console.dir($( '#table-sortable > tbody' ));
