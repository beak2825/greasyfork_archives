...
// @downloadURL https://update.greasyfork.org/scripts/548071/%F0%9F%8D%83%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20GRAND%20by%20HMyrphy%20%F0%9F%8D%83.user.js
// @updateURL https://update.greasyfork.org/scripts/548071/%F0%9F%8D%83%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20GRAND%20by%20HMyrphy%20%F0%9F%8D%83.meta.js
    // ==/UserScript==
    ...
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Игрок написал на вас жалобу, исходя из этой жалобы вам было выдано наказание.[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Проверю верность вредикта куратора форума , ожидайте ответа.[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Приятной игры на сервере BLACK [/COLOR][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=#FFD700][I]Ожидайте ответа.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
       prefix: PIN_PREFIX,
      status:true,
    },
    ...
    "[HEADING=3][CENTER][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/COLOR][/SIZE][/FONT][/HEADING]"+
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Ваша жалоба взята на рассмотрение. Ожидайте, пожалуйста, ответа от администрации и не нужно создавать копии этой темы.[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Приятной игры на сервере BLACK [/COLOR][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=#FFD700][I]Ожидайте ответа.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
    ...
    "[HEADING=3][CENTER][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/COLOR][/SIZE][/FONT][/HEADING]"+
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Попробуйте изменить подключение на вашем устройстве. Пример: зайти в игру с подключением к Wi-Fi, мобильным интернетом или с сервисом VPN[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]После проделанного метода вы должны оставить сообщение в данной теме, получилось или нет.[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Приятной игры на сервере BLACK [/COLOR][/SIZE][/FONT][/CENTER] <br>" +
  "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=#FFD700][I]Ожидаем вашего ответа.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
    ...
    "[HEADING=3][CENTER][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/COLOR][/SIZE][/FONT][/HEADING]"+
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]По результатам проверки установлено, что администратор выдал вам наказание ошибочно. Наказание будет снято, приносим извинения за недоразумение[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Приятной игры на сервере  BLACK [/COLOR][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=#FFD700][I]Закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
       prefix: CLOSE_PREFIX,
      status:true,
    },
    ...
    "[HEADING=3][CENTER][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/COLOR][/SIZE][/FONT][/HEADING]"+
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]После тщательной проверки поданной жалобы в отношении администратора будут приняты меры. Благодарим вас за информацию[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Приятной игры на сервере BLACK [/COLOR][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=#FFD700][I]Ожидайте ответа.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
    ...
    "[HEADING=3][CENTER][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]{{ greeting }}, уважаемый(-ая) {{ user.mention }}.[/I][/COLOR][/SIZE][/FONT][/HEADING]"+
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Администратор предоставил все необходимые доказательства подтверждающие правмерность решения.На основание предоставленных материалов наказание было назначено верно и в соответствие с правилами[/SIZE][/FONT][FONT=georgia][SIZE=4].[/I][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=rgb(169, 169, 169)][I]Приятной игры на сервере BLACK [/COLOR][/SIZE][/FONT][/CENTER]<br>" +
    "[IMG width=695px]https://i.ibb.co/4FnVsC8/image.png[/IMG]<br>"+
    "[HEADING=3][CENTER][I][B][I][FONT=georgia][SIZE=4][COLOR=#FFD700][I]Закрыто.[/I][/COLOR][/SIZE][/FONT][/CENTER]",
