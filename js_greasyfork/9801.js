...
// @grant		none
// @author		biggles
// @downloadURL https://update.greasyfork.org/scripts/9801/v4cInstaSynch%20Additional%20Features.user.js
// @updateURL https://update.greasyfork.org/scripts/9801/v4cInstaSynch%20Additional%20Features.meta.js
// ==/UserScript==
...
window.script.setListeners = function() {
	...
	$('#cin').on('focus', function() {
		if (script.newMsg) {
			script.newMsg = false;
			var roomname = room.roomName.toLowerCase();
			if (roomname == "toastergrind") script.fns.setFavIcon('http://i.imgur.com/DmMh2O9.png'); else script.fns.setFavIcon('/favicon.ico');
		}
	});
