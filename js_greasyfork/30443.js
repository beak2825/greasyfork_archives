// ==UserScript==
// @name         Download MP3 - Youtube
// @namespace    https://www.youtubeinmp3.com
// @version      1.1.2.1
// @description  download whatever you want as a MP3
// @author       Arden Xie
...
// @include      http*://youtu.be/*
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/30443/Download%20MP3%20-%20Youtube.user.js
// @updateURL https://update.greasyfork.org/scripts/30443/Download%20MP3%20-%20Youtube.meta.js
// ==/UserScript==
...
function polymerInject(){
    ...
    addButton.appendChild(document.createTextNode("I want this!"));
...
function run(){
    ...
    if(!document.getElementById("parentButton") && window.location.href.substring(0, 25).indexOf("youtube.com") > -1 && window.location.href.indexOf("watch?") > -1){
        ...
        childButton.appendChild(document.createTextNode("gimme my mp3 pls"));
