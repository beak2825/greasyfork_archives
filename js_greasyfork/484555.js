// ==UserScript==
// @name AudioBookBay hide category: Humor
// @description Hide Humor category
...
// @downloadURL https://update.greasyfork.org/scripts/484555/AudioBookBay%20hide%20category%3A%20Humor.user.js
// @updateURL https://update.greasyfork.org/scripts/484555/AudioBookBay%20hide%20category%3A%20Humor.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Humor'
    $(".post").has(".postInfo:contains('Humor')").hide();
});
