// ==UserScript==
// @name          WaniKani Review Order (SRS)
// @namespace     https://www.wanikani.com
// @description   WaniKani Review Order by Alucardeck.  Modified to sort on srs level by Xebikr
// @version 0.1
// @include       https://www.wanikani.com/review/session
// @include       http://www.wanikani.com/review/session
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/4064/WaniKani%20Review%20Order%20%28SRS%29.user.js
// @updateURL https://update.greasyfork.org/scripts/4064/WaniKani%20Review%20Order%20%28SRS%29.meta.js
// ==/UserScript==
function get(id) {
...
function reorder(){
    ...
    for(var i=0;i<revList.length;i++){
        var it=revList[i];
        if(it.rad)
        	console.log('rad '+it.rad + ' srs ' + it.srs);
        else if(it.kan)
           	console.log('kan '+it.kan + ' srs ' + it.srs);
        else if(it.voc)
            console.log('voc '+it.voc + ' srs ' + it.srs);
    }
