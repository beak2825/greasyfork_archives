...
// @downloadURL https://update.greasyfork.org/scripts/7312/TW-Collections-BR%20Translation.user.js
// @updateURL https://update.greasyfork.org/scripts/7312/TW-Collections-BR%20Translation.meta.js
// ==/UserScript==
					   ...
					   // START OF LANGUAGE VARS
							...
							Options : {
								...
								checkbox_text : {
									...
									inventory : {
										title : 'Botões para o inventário',
									...
									miscellaneous : {
										...
										options : {
											...
											deleteAllReports : 'Adicionar deletar todos relatórios',
											showFees : 'Adicionar Tarifas Bancárias em Mouseover',
											popupTWT:'Abra o menu de TW Coleções no mouseover'
										}
									},
									twdbadds : {
										title : 'Add-on do Cloth Calc',
										options : {
											filterBuyMarket : 'Filtro Mercado: mostrar apenas itens marcados em falta (adicionar tw-db)'
										}
									}
								},
								message : {
									title : 'Informações',
									message : 'As preferências foram aplicadas.',
