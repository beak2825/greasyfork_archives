// ==UserScript==
// @name            Nexusphp PT种子一键认领和取消认领
// @name:en         Nexusphp PT torrents addclaim & removeclaim
// @namespace       https://public.ecustpt.eu.org/
// @version         0.0.1
// @description     种子一键认领和取消认领
// @description:en  One key claim or removeclaim all the seeding torrents in Nexusphp PT.
// @author          Lancertony
// @match           http*://*/userdetails.php?id=*
// @license         MIT
// @icon            https://fastly.jsdelivr.net/gh/xiaomlove/nexusphp/public/favicon.ico
// @grant           unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/486655/Nexusphp%20PT%E7%A7%8D%E5%AD%90%E4%B8%80%E9%94%AE%E8%AE%A4%E9%A2%86%E5%92%8C%E5%8F%96%E6%B6%88%E8%AE%A4%E9%A2%86.user.js
// @updateURL https://update.greasyfork.org/scripts/486655/Nexusphp%20PT%E7%A7%8D%E5%AD%90%E4%B8%80%E9%94%AE%E8%AE%A4%E9%A2%86%E5%92%8C%E5%8F%96%E6%B6%88%E8%AE%A4%E9%A2%86.meta.js
// ==/UserScript==
...
(function () {
  ...
  // Your code here...
  // 获取当前页面的主机名（例如：public.ecustpt.eu.org）
  ...
  unsafeWindow.ClassificationClaimTorrents = async function (element, maxClaim) {
    ...
    for (const el of element) {
      ...
      if (claimId > 0) {
        ...
        xhr.open('POST', 'https://' + currentHostname + '/ajax.php', true);
