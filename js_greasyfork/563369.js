...
Your content has been found to contain generative AI artwork, which is strictly prohibited on Furvilla. As stated in our news post, we consider this a form of plagiarism and art theft.
...
Your account has been permanently banned for using generative AI content on Furvilla. As stated in our news post, we have a zero-tolerance policy for AI-generated content as we consider it a form of plagiarism and art theft.
...
MOD-{modname}`,
    ...
    function createTemplatesUI() {
        ...
        select.className = 'fv-mod-select';
        ...
        // button group for Copy and Auto-fill
        ...
        select.addEventListener('change', () => {
            const selected = select.value;
            if (selected && templates[selected]) {
                preview.textContent = templates[selected].message || 'Select a template to preview it here';
            } else {
                preview.textContent = 'Select a template to preview it here';
            }
        });
