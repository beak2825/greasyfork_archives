...
// @date         8/08/2018
// @modified     03/10/2018
// @homepage     https://greasyfork.org/zh-CN/scripts/373168
...
// @downloadURL https://update.greasyfork.org/scripts/373168/wsmud_lib.user.js
// @updateURL https://update.greasyfork.org/scripts/373168/wsmud_lib.meta.js
// ==/UserScript==
(function () {
    'use strict';
        ...
        var _send_cmd = function () {
            if (!ws || ws.readyState != 1) {
                ...
                if (!cmd_queue[cmd_queue.length - 1].timestamp) {
                    ...
                    setTimeout(_send_cmd, send_dirdect > 20 ? 400 : 250);
                } else {
                    cmd_busy = false;
                }
            } else {
