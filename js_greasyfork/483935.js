...
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/483935/%D0%90%D0%B2%D1%82%D0%BE%D0%B0%D0%BF%20%D1%82%D0%B5%D0%BC.user.js
// @updateURL https://update.greasyfork.org/scripts/483935/%D0%90%D0%B2%D1%82%D0%BE%D0%B0%D0%BF%20%D1%82%D0%B5%D0%BC.meta.js
// ==/UserScript==

const _xfToken = document.querySelector('input[name="_xfToken"]').value;
const threads = [
    "https://zelenka.guru/threads/6227093/", "https://zelenka.guru/threads/6395061/" // Добавьте другие ссылки на темы здесь, добавлять именно в таком формате, чтобы в конце был /
];

const time = 12; // Время в часах между поднятием тем, согласно вашим правам
