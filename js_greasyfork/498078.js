...
// @downloadURL https://update.greasyfork.org/scripts/498078/Bot%20panel.user.js
// @updateURL https://update.greasyfork.org/scripts/498078/Bot%20panel.meta.js
// ==/UserScript==
...
window.onload = function () {
    ...
    const chat = createButton("100px", "25px", "Çat", () => {
    ...
    const exit = createButton("100px", "25px", "Çıxış", () => {
    ...
    const kick = createButton("100px", "25px", "Təpik", () => {
