...
// @updateURL
// @downloadURL https://update.greasyfork.org/scripts/482010/KIROV%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/482010/KIROV%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
	...
	},
{
	  ...
	  content:
		...
		"[CENTER]Ваша жалоба взята на рассмотрении,просьба не создавать данную тему повторно.[/CENTER]<br><br>" +
		`[CENTER]На рассмотрении.[/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере «KIROV» [/COLOR][/FONT][/SIZE][/CENTER]`,
	     prefix: PIN_PREFIX,
	     status: true,
	       },
     {
	     status: true, title: `Главному куратору форума `,
	  content:
		`[SIZE=4][FONT=georgia][CENTER]Здравствуйте, уважаемый игрок[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба передана на рассмотрение Главному куратору форума.[/CENTER]<br><br>" +
		`[CENTER]На рассмотрении.[/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере «KIROV» [/COLOR][/FONT][/SIZE][/CENTER]`,
	     prefix: PIN_PREFIX,
	     status: true,
     ...
     {
	      title: `Заму.Главного куратора форума `,
	  content:
		`[SIZE=4][FONT=georgia][CENTER]Здравствуйте, уважаемый игрок[/CENTER]<br><br>` +
		"[CENTER]Ваша жалоба передана на рассмотрение Заместителю Главного куратора форума.[/CENTER]<br><br>" +
		`[CENTER]На рассмотрении.[/CENTER][/FONT][/SIZE]<br><br>`+
                 `[SIZE=4][FONT=georgia][CENTER][COLOR=lightgrey] Приятной игры и времяпровождение  на сервере «KIROV» [/COLOR][/FONT][/SIZE][/CENTER]`,
	     prefix: PIN_PREFIX,
	     status: true,
    ...
    {	 
     title: 'Пункт не заполнен',
	  content:
	    "[B][CENTER][COLOR=#FF0000][ICODE]Доброго времени суток, уважаемый игрок. [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER]В вашей жалобе не заполнен какой либо пункт, посьба создать новю жалоб и заполнить все пункты..<br><br>" +
		'[B][CENTER][COLOR=red][ICODE]Закрыто.[/ICODE][/COLOR][/CENTER][/B]',
	  prefix: UNACCEPT_PREFIX,
	  status: false,
	},
...
},
    {
     ...
     },
     {
      ...
      content:
        ...
        "[B][CENTER]Ваша РП Биография получает статус:<br><br>" +
		'[B][CENTER][COLOR=red][ICODE]Отказано.[/ICODE][/COLOR][/CENTER][/B]' +
		"Причиной послужило большое колицество орфографически/пунктуационных ошибок.<br>",
      prefix: UNACCEPT_PREFIX,
	  status: false,
     },
     {
      ...
      content:
        ...
        "[B][CENTER]Ваша РП Биография получает статус:<br><br>" +
		'[B][CENTER][COLOR=red][ICODE]Отказано.[/ICODE][/COLOR][/CENTER][/B]' +
		"Причиной послужило слишком малое количество иформации.<br>",
      prefix: UNACCEPT_PREFIX,
	  status: false, 
     },
{
    ...
    },
{
	 ...
	 },
	 {
      ...
      content:
        ...
        "[B][CENTER]Ваша РП Ситуация получает статус:<br><br>" +
		'[B][CENTER][COLOR=RED][ICODE]Отказано.[/ICODE][/COLOR][/CENTER][/B]' +
		"Причиной послужило малое содержание текста ситуации.<br>",
      prefix: UNACCEPT_PREFIX,
	  status: false,
    },
	 {
