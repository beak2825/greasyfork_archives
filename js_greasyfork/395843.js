...
// @author       nobody
// @match        https://chdx.class.gaoxiaobang.com/*
// @run-at       document-end
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/395843/%E9%AB%98%E6%A0%A1%E9%82%A6%E4%BF%AE%E6%94%B9%E8%A7%86%E9%A2%91%E8%BF%9B%E5%BA%A6%E8%84%9A%E6%9C%AC-CHD.user.js
// @updateURL https://update.greasyfork.org/scripts/395843/%E9%AB%98%E6%A0%A1%E9%82%A6%E4%BF%AE%E6%94%B9%E8%A7%86%E9%A2%91%E8%BF%9B%E5%BA%A6%E8%84%9A%E6%9C%AC-CHD.meta.js
// ==/UserScript==
/* jshint -W097 */
'use strict';
...
function f_exec(){
    ...
    else
    {
        ...
        //
        var infoUrl = "https://chdx.class.gaoxiaobang.com/class/"+arg2+"/chapter/"+arg1+"/api?"+time;
        $.post(infoUrl,function(result){
            var maxViewTime = result.userRecord.maxViewTime;
            if(!maxViewTime){
                maxViewTime = 0;
            }
            var url="https://chdx.class.gaoxiaobang.com/log/video/"+arg1+"/"+arg2+"/api?"+time;
