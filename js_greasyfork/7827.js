...
// @version      1.5
// @description  auto_open
// @author       Yan
// @include      http*://*pvs.jnpr.net/jss-ciat/app/home*
// @include      http*://*pvs.juniper.net/jss-ciat/app/home*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/7827/auto-open.user.js
// @updateURL https://update.greasyfork.org/scripts/7827/auto-open.meta.js
// ==/UserScript==
function delete_cookie(name) {
  document.cookie = name +'=; Path=/jss-ciat/app; Expires=Thu, 01 Jan 1970 00:00:01 GMT;';
}

function openALLPR_onthisPage () {
    delete_cookie('pWrD4jBo');
