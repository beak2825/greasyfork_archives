// ==UserScript==
// @name   KF_script_by_Explosion
// @name:ru  Кураторы форума by S.Explosion
...
// @downloadURL https://update.greasyfork.org/scripts/526959/KF_script_by_Explosion.user.js
// @updateURL https://update.greasyfork.org/scripts/526959/KF_script_by_Explosion.meta.js
// ==/UserScript==
 ...
 prefix: CLOSE_PREFIX,
  ...
  status: false,
    ...
    },
    {
     ...
     {
	  title: '♠️Раннее был заблокирован♠️',
	  content:
	 "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/FscvGMVP/49224-CE2-6-B89-42-F1-8-B9-D-248-F3970945-F.gif[/img][/url][/CENTER]<br>" +
    '[Color=turquoise][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
...
},
{
 ...
 // Добавление кнопок при загрузке страницы
    addButton('❄️ by. Explosion ❄️', 'selectAnswer');
