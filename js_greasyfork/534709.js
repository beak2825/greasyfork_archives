...
// @license      MIT
// @homepageURL  https://github.com/superpung/pages2github
// @supportURL   https://github.com/superpung/pages2github
// @match        *://*.github.io/*
// @icon         https://pages.github.com/favicon.ico
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/534709/Pages%20to%20GitHub.user.js
// @updateURL https://update.greasyfork.org/scripts/534709/Pages%20to%20GitHub.meta.js
// ==/UserScript==
...
(function () {
  ...
  .gh-float-button:hover .gh-username {
    opacity: 1;
  }
  `;
  ...
  button.className = 'gh-float-button';
  button.innerHTML = `
