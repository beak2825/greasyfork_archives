// ==UserScript==
// @name         Reddit Mobile Smart Navbar (Clean Version)
// @namespace    https://www.reddit.com/user/legendary_warrior_1/
// @version      9.7
// @description  Smart Navbar. Videos play silently at first. If you UNMUTE one, following videos play with sound (Global Sync). NO Looping. Manual Pause supported. Removed Chat/Search buttons.
// @author       legendary_warrior_1
// @match        https://www.reddit.com/*
// @match        https://reddit.com/*
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/563505/Reddit%20Mobile%20Smart%20Navbar%20%28Clean%20Version%29.user.js
// @updateURL https://update.greasyfork.org/scripts/563505/Reddit%20Mobile%20Smart%20Navbar%20%28Clean%20Version%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function updateState() {
        ...
        if (isFeedPage()) {
            ...
            // Clean up if we switch pages (though buttons are no longer injected, we keep this structure clean)
        }
    }
    ...
    function injectCustomButtons() {
        ...
        if (createBtn) {
            ...
            // We keep the container styling to ensure the navbar looks neat,
            // even without the extra buttons.
