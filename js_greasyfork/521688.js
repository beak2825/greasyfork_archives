// ==UserScript==
// @name         Кураторы форума Penza v1.5
// @namespace    https://forum.blackrussia.online
// @version      1.1
// @description  Скрипт для кураторов форума Black Russia PENZA. Заменены левые ссылки, добавлены и редактированы новые темы для ответов. Предложение по улучшению обращайтесь к руководству
// @author       K.Ken and D.WInchester
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license    MIT
// @icon        https://sun9-78.userapi.com/impg/zlHTcSZAgJJLmOrTUKtrgmLrGAbeLcWdr2zMAg/hN4cdZo4DJA.jpg?size=1000x1000&quality=95&sign=07d2474e94e4386a20cebc534372a717&type=album
// @downloadURL https://update.greasyfork.org/scripts/521688/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Penza%20v15.user.js
// @updateURL https://update.greasyfork.org/scripts/521688/%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Penza%20v15.meta.js
// ==/UserScript==
    ...
    },
{
	...
	},
   {
    ...
    {
      title: 'Слова не найдены',
      content:
		"[B][CENTER][COLOR=#ff0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/CKmKMxjF/undefined-Imgur-1.png[/img][/url]<br>' +
        "[CENTER][COLOR=#FFFF00][ICODE]Такие слова не логируются в базе данных игрока. Это может быть связано с тем, что вы отредактировали скриншот.[/ICODE][/COLOR][/CENTER]" +
         '[url=https://postimages.org/][img]https://i.postimg.cc/9MpSRHqY/nDEIHay.gif[/img][/url]<br>' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на сервере Penza.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MKdRrVzK/1P76bnn.png[/img][/url]<br>'+
        '[Color=#FF0000][FONT=times new roman][CENTER][I][ICODE]✿❯────「Отказано, ❖ Закрыто」────❮✿[/ICODE][/I][/CENTER][/color][/FONT]',
    ...
    {
        title: 'Мало РП инфо в детстве',
        content:
        "[B][CENTER][COLOR=#ff0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/CKmKMxjF/undefined-Imgur-1.png[/img][/url]<br>'+
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://forum.blackrussia.online/threads/penza-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%B8-%D0%A4%D0%BE%D1%80%D0%BC%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-roleplay-%D0%91%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B9.5818174/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
        '[CENTER][COLOR=#FFFF00]Причина отказа: [COLOR=#FFFFFF]Мало RolePlay информации в пункте Детство.[/B][/COLOR]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/9MpSRHqY/nDEIHay.gif[/img][/url]<br>' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на сервере Penza.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MKdRrVzK/1P76bnn.png[/img][/url]<br>',
      prefix: OTKAZBIO_PREFIX,
    ...
    },
    {
        ...
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/CKmKMxjF/undefined-Imgur-1.png[/img][/url]<br>'+
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://forum.blackrussia.online/threads/penza-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%B8-%D0%A4%D0%BE%D1%80%D0%BC%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-roleplay-%D0%91%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B9.5818174/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
        '[CENTER][COLOR=#FFFF00]Причина отказа: [COLOR=#FFFFFF]Недостаточно РП информации. А именно: мало информации о вашем персонаже. Рекомендуется от 300 слов в каждом пункте «Детство, юность и взрослая жизнь»[/B][/COLOR]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/9MpSRHqY/nDEIHay.gif[/img][/url]<br>' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на сервере Penza.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MKdRrVzK/1P76bnn.png[/img][/url]<br>',
      prefix: OTKAZBIO_PREFIX,
    ...
    {
        title: 'Нету полного инициала',
        content:
        "[B][CENTER][COLOR=#ff0000][ICODE]Доброго времени суток уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        '[B][CENTER][url=https://postimages.org/][img]https://i.postimg.cc/CKmKMxjF/undefined-Imgur-1.png[/img][/url]<br>'+
		"[CENTER][COLOR=#FFFF00]Ваша RolePlay биография была проверена и получает статус - [COLOR=#FF0000]Отказано.[/COLOR]<br>[COLOR=#FFFF00]Убедительная просьба ознакомиться[/COLOR] [URL='https://forum.blackrussia.online/threads/penza-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D0%B8-%D0%A4%D0%BE%D1%80%D0%BC%D0%B0-%D0%BF%D0%BE%D0%B4%D0%B0%D1%87%D0%B8-roleplay-%D0%91%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B9.5818174/']с правилами написания RolePlay биографий[/URL].[/CENTER]<br>" +
        '[CENTER][COLOR=#FFFF00]Причина отказа: [COLOR=#FFFFFF]Нету полного инициала. Пример: Иванов Иван Иванович.[/B][/COLOR]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/9MpSRHqY/nDEIHay.gif[/img][/url]<br>' +
        '[Color=AQUA][CENTER][ICODE]Приятной игры на сервере Penza.[/ICODE][/CENTER][/color]' +
        '[url=https://postimages.org/][img]https://i.postimg.cc/MKdRrVzK/1P76bnn.png[/img][/url]<br>',
      prefix: OTKAZBIO_PREFIX,
