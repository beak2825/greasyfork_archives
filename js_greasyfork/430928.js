// ==UserScript==
// @name        MusicBrainz: Import from iTunes (fork)(NoV)
...
//
// @downloadURL https://update.greasyfork.org/scripts/430928/MusicBrainz%3A%20Import%20from%20iTunes%20%28fork%29%28NoV%29.user.js
// @updateURL https://update.greasyfork.org/scripts/430928/MusicBrainz%3A%20Import%20from%20iTunes%20%28fork%29%28NoV%29.meta.js
// ==/UserScript==
//**************************************************************************//
...
function addArtworkLink() {
    ...
    // 1: var splitSrcset = srcset.split(',')
    // 1: var src = splitSrcset[splitSrcset.length - 1].slice(0, -5);
    // 2: var imageImg = product.getElementsByClassName('media-artwork-v2__image')[0];
    // 2: var srcset = imageImg.getAttribute('srcset');
