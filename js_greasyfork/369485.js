...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/369485/WeiboDL%20%E5%BC%82%E6%AD%A5%E5%A2%9E%E5%BC%BA%E7%89%88%20%E5%BE%AE%E5%8D%9A%E5%9B%BE%E7%89%87%E4%B8%8B%E8%BD%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/369485/WeiboDL%20%E5%BC%82%E6%AD%A5%E5%A2%9E%E5%BC%BA%E7%89%88%20%E5%BE%AE%E5%8D%9A%E5%9B%BE%E7%89%87%E4%B8%8B%E8%BD%BD.meta.js
// ==/UserScript==
//增加元素样式到html
...
function generateUrl(t, i) {
    var e, i = arguments.length > 1 && void 0 !== arguments[1]
        ? arguments[1]
        : "bmiddle", o = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
    if (("undefined" == typeof i && (i = "bmiddle"),
        "undefined" == typeof o && (o = !1),
        "w" == t[9] || ("y" == t[9] && t.length >= 32))) {
        var n = 1 + (3 & generateN(t)), s = "g" == t[21] ? "gif" : "jpg";
        e = o
            ? "w" == t[9]
...
class WeiBoDL {
  ...
  `;
            //添加容器到页面
            var nav = document.querySelectorAll('div[role="navigation"]')?.[0] ||
