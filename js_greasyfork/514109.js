...
// @downloadURL https://update.greasyfork.org/scripts/514109/Herramientas%20telecentro.user.js
// @updateURL https://update.greasyfork.org/scripts/514109/Herramientas%20telecentro.meta.js
// ==/UserScript==
            ...
            if (event2.origin === "http://10.190.30.36:8080") {
                if (event2.data === "script1activo") {
                    document.addEventListener('keydown', function (event) {
                        if (event.key === '9' && event.code === 'Numpad9') {
