// ==UserScript==
// @name         双融双创教师培训平台(改)::pc-srsc.gdedu
...
// @grant        none
// @license      GPLv3
// @downloadURL https://update.greasyfork.org/scripts/455074/%E5%8F%8C%E8%9E%8D%E5%8F%8C%E5%88%9B%E6%95%99%E5%B8%88%E5%9F%B9%E8%AE%AD%E5%B9%B3%E5%8F%B0%28%E6%94%B9%29%3A%3Apc-srscgdedu.user.js
// @updateURL https://update.greasyfork.org/scripts/455074/%E5%8F%8C%E8%9E%8D%E5%8F%8C%E5%88%9B%E6%95%99%E5%B8%88%E5%9F%B9%E8%AE%AD%E5%B9%B3%E5%8F%B0%28%E6%94%B9%29%3A%3Apc-srscgdedu.meta.js
// ==/UserScript==
...
function handleCourseContent() {
    ...
    //PPT播放监测
    setCurHrefInterval(() => {
        let PDFNode = document.querySelector('pdf-container');
        if (!PDFNode) {
                let But = Array.from(document.querySelectorAll(`.el-button`));
                But = But.filter(v=>{
                   return (v.innerText == '下一页')? true : false}
                                );
                //But = But.map()
                if (But.length == 1) {
                    console.log('下一页');
