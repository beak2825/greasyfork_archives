...
// @version 1.13
// @grant none
// @downloadURL https://update.greasyfork.org/scripts/512861/TW%20Gold%20Jobs%20Finder%20%28More%20Languages%29.user.js
// @updateURL https://update.greasyfork.org/scripts/512861/TW%20Gold%20Jobs%20Finder%20%28More%20Languages%29.meta.js
// ==/UserScript==
...
(function (fn) {
  ...
  GJ.updateLang();
  GJ.parseWholeGameMap = function (tiles, onLoad) {
    this.loaded = 0;
    var x,
    y;
    var arr = [];
      ...
      case 'open':
        if (!GJ.hasOwnProperty('tilesWithJobs')) {
          ...
          GJ.getAllTiles(function () {
            GJ.parseWholeGameMap(GJ.tilesWithJobs, onLoad);
          });
        } else {
          onLoad();
        }
