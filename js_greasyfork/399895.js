// ==UserScript==
// @name           Japanese DLSite Trans/Tags & Genres
// @description    Replaces Japanese text on DLSite
// @include        http*://*.dlsite.com/*
// @exclude        http*://*.dlsite.com/*eng*
// @grant          none
// @Created by     JoeSimmons
// @Updated by     7seven182
// @version        1.2.2
// @namespace https://greasyfork.org/users/476941
// @downloadURL https://update.greasyfork.org/scripts/399895/Japanese%20DLSite%20TransTags%20%20Genres.user.js
// @updateURL https://update.greasyfork.org/scripts/399895/Japanese%20DLSite%20TransTags%20%20Genres.meta.js
// ==/UserScript==
(function () {
    'use strict';
...
//Focus / Appeals
        ...
        '/(:|^)アンソロジー(|| )(:|$)/g' : 'Anthology ',
        '/(:|^)マニアック/変態(|| )(:|$)/g' : 'Maniac/Pervert ',
        '/(:|^)技術書(|| )(:|$)/g' : 'Technical Book ',
        '/(:|^)バイノーラル/ダミヘ(|| )(:|$)/g' : 'Binaural/Damihe ',
        '/(:|^)評論(|| )(:|$)/g' : 'Critical Essay ',
...
//Characters
       ...
       '/(:|^)母親(|| )(:|$)/g' : 'Mother ',
        ...
        '/(:|^)女主人公(|| )(:|$)/g' : 'Female Protagonist ',
        '/(:|^)男主人公(|| )(:|$)/g' : 'Male Protagonist ',
        '/(:|^)フタナリ(|| )(:|$)/g' : 'Futanari ',
        '/(:|^)ロボット/アンドロイド(|| )(:|$)/g' : 'Robot/Android ',
        '/(:|^)おねショタ(|| )(:|$)/g' : 'One-Shota ',
        '/(:|^)サキュバス/淫魔(|| )(:|$)/g' : 'Succubus/Incubus ',
        '/(:|^)おやじ(|| )(:|$)/g' : 'Middle-aged Man ',
        '/(:|^)体育会系/スポーツ選手(|| )(:|$)/g' : 'Jock/Athlete/Sports ',
        '/(:|^)くノ一(|| )(:|$)/g' : 'Kunoichi (Ninja Girl) ',
//Outfits / Occupations
        '/(:|^)制服(|| )(:|$)/g' : 'Uniform ',
...
//Situations / Tastes
        ...
        '/(:|^)寝取り(|| )(:|$)/g' : 'Netori ',
        '/(:|^)歴史(|| )(:|$)/g' : 'History ',
        '/(:|^)料理/グルメ(|| )(:|$)/g' : 'Cooking/Gourmet ',
//Actions / Sexual Preferences
        '/(:|^)手コキ(|| )(:|$)/g' : 'Hand Job ',
        '/(:|^)足コキ(|| )(:|$)/g' : 'Foot Job ',
        '/(:|^)ぶっかけ(|| )(:|$)/g' : 'Bukkake ',
        '/(:|^)顔射(|| )(:|$)/g' : 'Facial ',
        ...
        '/(:|^)バイ(|| )(:|$)/g' : 'Bisexual ',
        '/(:|^)レイプ(|| )(:|$)/g' : 'Rape ',
        '/(:|^)羞恥/恥辱(|| )(:|$)/g' : 'Shame/Humiliation ',
        '/(:|^)SM(|| )(:|$)/g' : 'BDSM ',
        '/(:|^)ゲイ/男同士(|| )(:|$)/g' : 'Male Homosexuality ',
        '/(:|^)ささやき(|| )(:|$)/g' : 'Whispering ',
        '/(:|^)耳舐め(|| )(:|$)/g' : 'Ear Licking ',
        '/(:|^)潮吹き(|| )(:|$)/g' : 'Squirting ',
//Appearance
...
//other
        ...
        '最近チェックした作品' : 'Recently viewed items',
        '/(:|^)レビュー(:|$)/g' : 'User Reviews',
        'ユーザーレビュー' : 'User Comments',
        ...
        '/(:|^)実績(:|$)/g' : 'Achievement',
        '/(:|^)販売数(:|$)/g' : 'Sales',
        '/(:|^)お気に入り数(:|$)/g' : 'Favorites Number',
        '/(:|^)レビュー数(:|$)/g' : 'Reviews Number',
        ...
        '/(:|^)体験版で必ず動作確認をしてください(:|$)/g' : 'See demo/trial to confirm.',
//account
 ...
 '/(:|^)ログインIDに使用出来ない文字が含まれています。(:|$)/g' : 'Login ID contains characters that can not be used.',
        ...
        '/(:|^)成年コミック(:|$)/g' : 'Adult Comics',
        '/(:|^)ポイントアップ中の作品(:|$)/g' : 'Items with increased point rate',
        '/(:|^)無料作品(:|$)/g' : 'Items with Free trial',
