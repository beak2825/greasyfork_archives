...
// @downloadURL https://update.greasyfork.org/scripts/28163/Hybrid%20-%20Calls%20Contact%20%28Direct%20Dial%29.user.js
// @updateURL https://update.greasyfork.org/scripts/28163/Hybrid%20-%20Calls%20Contact%20%28Direct%20Dial%29.meta.js
// ==/UserScript==
...
if ($('li:contains("Call")').length) {
    ...
    createButton('Biz on Voicemail',0,0,3,2,3,'Business on Voicemail');
    createButton('No',0,0,2,1,2,'');
    createButton('No (Previous)',0,0,1,1,2,'');
    createButton('Wrong Biz',0,1,3,2,3,'Wrong business');
    createButton('DC',1,2,3,2,3,'Disconnected');
    createButton('DC (Directory)',1,2,3,2,3,'Disconnected - Directory');
    createButton('DC (Cant complete)',1,2,3,2,3,'Disconnected - Cant complete');
    createButton('Fax',2,2,3,3,3,'Fax');
    createButton('Ringing',0,2,3,3,3,'Kept ringing','Kept ringing');
    createButton('Silence',0,2,3,2,3,'Rang until silence');
    createButton('Hung Up',0,2,3,2,3,'Hung up on me');
    createButton('Busy',0,2,3,2,3,'Busy signal');
    createButton('Generic VM',0,2,3,2,3,'Voicemail with no info.');
    createButton('Personal VM',0,2,3,2,3,'Personal voicemail');
