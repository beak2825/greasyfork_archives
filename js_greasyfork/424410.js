// ==UserScript==
// @name        Overlord Drone Spread Script Made By Mekhi Maragh
// @include	    *://diep.io/*
// @author      Mekhi Maragh
// @description Makes orginal fighter script a little more powerful using the side barrels instead of the back ones
// @connect	    diep.io
// @namespace   aaa
// @version 9000
// @downloadURL https://update.greasyfork.org/scripts/424410/Overlord%20Drone%20Spread%20Script%20Made%20By%20Mekhi%20Maragh.user.js
// @updateURL https://update.greasyfork.org/scripts/424410/Overlord%20Drone%20Spread%20Script%20Made%20By%20Mekhi%20Maragh.meta.js
// ==/UserScript==
...
document.body.appendChild(info_container); 
	info_container.style.color = "red";
...
(function(){
    ...
    var sec=false;
	var tankData = [
        {name: "Overlord Drone Spread", cycleRate: 0.003125, maxAngle: Math.PI * 25 / 35, secondaryAngle: Math.PI/4, secondaryAngle: Math.PI/4, NCANNON: 2}
        ];
	var tankIndex = 0;
