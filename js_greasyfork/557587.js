...
// @downloadURL https://update.greasyfork.org/scripts/557587/KF_script.user.js
// @updateURL https://update.greasyfork.org/scripts/557587/KF_script.meta.js
// ==/UserScript==
...
const buttons = [
  ...
  '[CENTER][size=15px][font=georgia]Ваша жалоба взята [Color=rgb(255, 155 ,0)]на рассмотрение.[/color] <br> Ожидайте, пожалуйста, ответа от администрации и не нужно создавать копии этой темы.[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на проекте [COLOR=aqua]Rage Russia[/color]![/size][/font][/CENTER]',
        prefix: PINN_PREFIX,
        status: true,
      },
  {
        ...
        content:
    '[CENTER][size=15px][font=georgia]{{ greeting }}, уважаемый [COLOR=rgb(247, 218, 100)] {{ user.name }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Ваша жалоба была передана на дальнейшее рассмотрение [COLOR=red]Специальному администратору[/color].[/size][/font][/CENTER]<br><br>' +
...
},
{
        ...
        content:
    '[CENTER][size=15px][font=georgia]{{ greeting }}, уважаемый [COLOR=rgb(247, 218, 100)] {{ user.name }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Ваша жалоба была передана на дальнейшее рассмотрение [COLOR=red]Главному администратору[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Ожидайте ответа и не нужно создавать копии этой темы.[/CENTER]<br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на проекте [COLOR=aqua]Rage Russia[/color]![/size][/font][/CENTER]',
        prefix: GA_PREFIX,
        status: true,
},
    {
        ...
        content:
    '[CENTER][size=15px][font=georgia]{{ greeting }}, уважаемый [COLOR=rgb(247, 218, 100)] {{ user.name }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Ваша жалоба была передана на дальнейшее рассмотрение в [COLOR=Aqua]Технический отдел[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Ожидайте ответа и не нужно создавать копии этой темы.[/CENTER]<br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на проекте [COLOR=aqua]Rage Russia[/color]![/size][/font][/CENTER]',
        prefix: TEXY_PREFIX,
        status: true,
...
},
{
 ...
 prefix: CLOSE_PREFIX,
    ...
    '[CENTER][size=15px][font=georgia][COLOR=orange]На рассмотрении.[/FONT][/COLOR][/SIZE][/CENTER]<br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на проекте [COLOR=aqua]Rage Russia[/color]![/size][/font][/CENTER]',
      prefix: PINN_PREFIX,
      status: true,
           },
  ...
  content:
    ...
    '[CENTER][size=15px][font=georgia][COLOR=Lawnaqua]Одобрено[/COLOR], [COLOR=red]закрыто[/COLOR].[/FONT][/SIZE][/CENTER]<br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на проекте [COLOR=aqua]Rage Russia[/color]![/size][/font][/CENTER]',
...
},
 {
    ...
    '[CENTER][size=15px][font=georgia][/COLOR], [COLOR=red]закрыто[/COLOR].[/FONT][/SIZE][/CENTER]<br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на проекте [COLOR=aqua]Rage Russia[/color]![/size][/font][/CENTER]',
      prefix: RESHENO_PREFIX,
      status: false,
},
    ...
    },
   {
    ...
    '[CENTER][size=15px][font=georgia]Приятной игры на проекте [COLOR=aqua]Rage Russia[/color]![/size][/font][/CENTER]',
	...
	},
      {
        ...
        content:
    '[CENTER][size=15px][font=georgia]{{ greeting }}, уважаемый [COLOR=rgb(247, 218, 100)] {{ user.name }}[/color].[/size][/font][/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Выношу вердик по Вашей биографии - [color=Yellowaqua]Одобрено[/color].[/CENTER]<br><br>' +
    '[CENTER][size=15px][font=georgia]Приятной игры на проекте [COLOR=aqua]Rage Russia[/color]![/size][/font][/CENTER]',
        prefix: RESHENO_PREFIX,
        status: false,
    },
