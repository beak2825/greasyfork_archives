// ==UserScript==
// @name         Extension Clan ๖ۣۜƘᗷ❥|Private Extension
...
// @connect      agar.io
// @downloadURL https://update.greasyfork.org/scripts/23040/Extension%20Clan%20%E0%B9%96%DB%A3%DB%9C%C6%98%E1%97%B7%E2%9D%A5%7CPrivate%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/23040/Extension%20Clan%20%E0%B9%96%DB%A3%DB%9C%C6%98%E1%97%B7%E2%9D%A5%7CPrivate%20Extension.meta.js
// ==/UserScript==
 
// Copyright © 2016 ogario.ovh
 
if (location.host == "agar.io" && location.pathname == "/") {
    location.href = "http://agar.io/Clan๖ۣۜƘᗷ❥" + location.hash;
    return;
}
...
function inicio() {
    document.title = "CLAN ๖ۣۜƘᗷ❥";
    modificarTextoMinimapa("By ZetaBlack");
    modificarTextoLeaderboard("CLAN ๖ۣۜƘᗷ❥");
    modificarCanalYoutube("Suscribanse al canal", "UC52JW6d475jx7izciHkfZCA");
    modificarFooter("Visita el grupo del CLAN ๖ۣۜƘᗷ❥", "https://www.facebook.com/groups/306586019702473//?ref=nf_target&fref=nf");
    panelDerecho();
    ...
    $("#clantag").attr("placeholder", "tag ๖ۣۜƘᗷ❥");
 
    setTimeout(function() {
        alert("Bienvenido al CLAN ๖ۣۜƘᗷ❥");
    }, 2000);
