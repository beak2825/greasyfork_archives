...
// @downloadURL https://update.greasyfork.org/scripts/397759/Hq%20NO%20CLONW%202.user.js
// @updateURL https://update.greasyfork.org/scripts/397759/Hq%20NO%20CLONW%202.meta.js
// ==/UserScript==
...
let healSpeed = 15;
let healToggle = 1111111111111111111122200000000000000000000222222222222202222222222222222222222222212222;22222200000
...
function handleMessage(m){
    ...
    if(item == "h" && data[1] == myPlayer.id) {
        if(data[2] < 100 & data[2] > 0 && healToggle == 0) {
            setTimeout( () => {
                place(foodType, null);
            }, healSpeed);
...
const healer = repeater(81, () => {place(foodType)}, 35);
const boostPlacer = repeater(70, () => {place(boostType)}, 0.2);
const spikePlacer = repeater(86, () => {place(spikeType)}, 0.2);
const millPlacer = repeater(78, () => {place(millType)}, 0.2);
const turretPlacer = repeater(72, () => {place(turretType)}, 0.2);
