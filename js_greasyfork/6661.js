...
// @downloadURL https://update.greasyfork.org/scripts/6661/MouseHunt%20AutoBot%20Enhanced%20Edition.user.js
// @updateURL https://update.greasyfork.org/scripts/6661/MouseHunt%20AutoBot%20Enhanced%20Edition.meta.js
// ==/UserScript==
    ...
    if (showTimerInPage) {
        ...
        if (headerElement) {
            ...
            if (fbPlatform) {
                ...
                if (secureConnection)
                    preferenceHTMLStr += 'window.location.href=\'https://www.mousehuntgame.com/index.php\';"/>';
                else
                    preferenceHTMLStr += 'window.location.href=\'http://www.mousehuntgame.com/index.php\';"/>';
            }
            preferenceHTMLStr += '&nbsp;&nbsp;&nbsp;</td>';
            preferenceHTMLStr += '</tr>';
