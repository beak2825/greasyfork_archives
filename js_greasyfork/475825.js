...
// @version      0.2
// @description  try to take over the world!88
// @author       You
// @license MIT
// @match        https://greasyfork.org/zh-CN/script_versions/new
// @icon         https://www.google.com/s2/favicons?sz=64&domain=greasyfork.org
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/475825/New%20Userscript.user.js
// @updateURL https://update.greasyfork.org/scripts/475825/New%20Userscript.meta.js
// ==/UserScript==
                ...
                this.player.on('timeupdate', () => {
                    if (false) {
                        ...
                        this.isAppreciation().then((data) => {
                            ...
                            this.player.pause();
                            contextmenu.shop(offsetWidth / 2.5, offsetHeight / 3);
                        });
                    }
                });
