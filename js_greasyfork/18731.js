// ==UserScript==
// @name         Nfx [Members+ Only]
// @namespace    slitio.szymy
// @version      v1
// @description  NF CLans slither.io Ext By MrSuperMan
// @author       Harvey - MrSuperMan
// @match        http://slither.io/*
// @run-at       document-body
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/18731/Nfx%20%5BMembers%2B%20Only%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/18731/Nfx%20%5BMembers%2B%20Only%5D.meta.js
// ==/UserScript==

// F**K YOU MISTIK! YOU STOLE MY CODE!

// Source: http://ogario.ovh/download/SLITio.user.js

(function(w) {
    var modVersion = "v0.1.13",
    ...
    function setMenu() {
        ...
        if (login) {
            ...
            div.textContent = "Ɲ̶ℱ♔ Clan Ts3: Nf.AgarHub.io";
            ...
            sltMenu.innerHTML = "<strong>Ɲ̶ℱx By MrSuperMan</strong> | <strong>" + modVersion + "</strong>";
            ...
            select.appendChild(option);
            // Menu footer
            sltMenu.innerHTML += '<a href="https://www.youtube.com/channel/UCayVlZTtwwsYBbpFuI4Ynpw" target="_blank" style="color: #FFF; opacity: 0.35;">YT Channel</a> | ';
            sltMenu.innerHTML += '<a href="http://Agar.io" target="_blank" style="color: #FFF; opacity: 0.35;">Short Cut To Agar.io</a>';
            // Get IP input
    ...
    function resizeView() {
        if (w.resize) {
            ...
            if (wh < 800) {
                ...
                w.trf && w.trf(login, "scale(" + w.lgbsc + "," + w.lgbsc + ")");
            }
        } else {
