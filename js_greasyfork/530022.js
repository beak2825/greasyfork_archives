...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/530022/%E8%8E%B7%E5%8F%96%E7%AD%94%E9%A2%98%E7%BB%93%E6%9E%9C.user.js
// @updateURL https://update.greasyfork.org/scripts/530022/%E8%8E%B7%E5%8F%96%E7%AD%94%E9%A2%98%E7%BB%93%E6%9E%9C.meta.js
// ==/UserScript==
...
(function () {
  ...
  const check_data = (e, q) => {
    ...
    if (selectSwitch == 0) {
      ...
      q.currentTarget.dataset.selectSwitch = 0;
      const indexToRemove = SELECT_INDEX.indexOf(e);
      if (indexToRemove > -1) {
        SELECT_INDEX.splice(indexToRemove, 1);
      }
      const childElements = document.querySelectorAll(
        `.check_data_${e} .small`
      );
