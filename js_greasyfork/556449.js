...
// @run-at      document-end
// @downloadURL https://update.greasyfork.org/scripts/556449/Qiuwei%20Chat%20Assistant.user.js
// @updateURL https://update.greasyfork.org/scripts/556449/Qiuwei%20Chat%20Assistant.meta.js
// ==/UserScript==
...
;(function() {
    ...
    function handleSubmit() {
        ...
        setTimeout(() => {
            ajaxRequest({
                method: "POST",
                url: "https://plugin.fengyu-ai.com/api/n8n/assistantChat",
                data: JSON.stringify({
