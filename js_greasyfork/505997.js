// ==UserScript==
// @name   🌱【免费版】国家食品药品安全专业技术人员培训网|如需秒过、答题、全自动无人值守等高级收费版本见文档：https://doc.zhanyc.cn/pages/gjsya/
// @namespace    http://jb.zhanyc.cn/
// @icon    https://js.zhanyc.cn/img/js-logo.svg
// @version      1.1
// @description  当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制功能。如需如需秒过、答题、全自动无人值守等高级功能可升级付费版本，一杯咖啡钱，保你无忧学习，且永久使用|接各类脚本开发、代挂工作，微信：zhanyc_cn 备用微信:zhanfengkuo 个人网站：http://doc.zhanyc.cn
// @author       zfk
// @include    *://*.gwypx.com.cn/*
// @include    *://*.nmpaied.com/*
// @include    https://*.uucps.edu.cn/*
// @grant       GM_getValue
// @grant       GM_setValue
// @grant       GM_addStyle
...
// @antifeature 
// @license GPL
// @downloadURL https://update.greasyfork.org/scripts/505997/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%9B%BD%E5%AE%B6%E9%A3%9F%E5%93%81%E8%8D%AF%E5%93%81%E5%AE%89%E5%85%A8%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E5%9F%B9%E8%AE%AD%E7%BD%91%7C%E5%A6%82%E9%9C%80%E7%A7%92%E8%BF%87%E3%80%81%E7%AD%94%E9%A2%98%E3%80%81%E5%85%A8%E8%87%AA%E5%8A%A8%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccnpagesgjsya.user.js
// @updateURL https://update.greasyfork.org/scripts/505997/%F0%9F%8C%B1%E3%80%90%E5%85%8D%E8%B4%B9%E7%89%88%E3%80%91%E5%9B%BD%E5%AE%B6%E9%A3%9F%E5%93%81%E8%8D%AF%E5%93%81%E5%AE%89%E5%85%A8%E4%B8%93%E4%B8%9A%E6%8A%80%E6%9C%AF%E4%BA%BA%E5%91%98%E5%9F%B9%E8%AE%AD%E7%BD%91%7C%E5%A6%82%E9%9C%80%E7%A7%92%E8%BF%87%E3%80%81%E7%AD%94%E9%A2%98%E3%80%81%E5%85%A8%E8%87%AA%E5%8A%A8%E6%97%A0%E4%BA%BA%E5%80%BC%E5%AE%88%E7%AD%89%E9%AB%98%E7%BA%A7%E6%94%B6%E8%B4%B9%E7%89%88%E6%9C%AC%E8%A7%81%E6%96%87%E6%A1%A3%EF%BC%9Ahttps%3Adoczhanyccnpagesgjsya.meta.js
// ==/UserScript==
(function () {
    ...
    let freeTips = " 当前是免费版本，只包含了视频页面自动播放、解除播放暂停限制。如需秒过、答题、全自动无人值守等高级功能，可点击下方按钮查看付费版本"
    let docUrl = "http://doc.zhanyc.cn/pages/gjsya/";
    let plugMain = Object.assign(baseConfig, {
        ...
        async runByUrl(url) {
            if (url.includes("/model/media.htm")) {
                plugMain.page_video();
            } else if (url.includes("/pc/index.htm") && url.includes("course_exam")) {
            } else if (url.includes("/video_play?")) {
                plugMain.page_video();
            } else if (url.includes("/pc/index.htm") && url.includes("assess_list")) {
                plugMain.page_assess_list();
            } else if (
                url.includes("/pc/index.htm") &&
                url.includes("/person_center/my_class/user_class?show_details_id")
            ) {
                plugMain.page_list();
            } else if (url.includes("/pc/index.htm") && url.includes("/my_survey")) {
                plugMain.page_keepLoginInfo();
            }
        },
        async page_video() {
            ...
            plugMain.showPaidContent(`免费版本不包含自动换课、秒过功能，如需使用请安装收费版本`);
            ...
            plugMain.pageData.video.index = setInterval(async () => {
                try {
                    ...
                    if (
                        plugMain.getElByText($(".el-dialog__body"), "是否继续学习？") != null
                    ) {
                        zfk
                            .getElByText($(".el-dialog__body"), "是否继续学习？")
                            .next()
                            .find("button")
                            .click();
                    }
        ...
        nextVideo(waitOf = 10 * 1000) {
            layer.msg("视频即将结束，等待下一步操作", { time: waitOf });
        ...
        async page_keepLoginInfo(timeout = 10 * 60 * 1000) {

            plugMain.showPaidContent(`免费版本不包含防掉线功能，如需使用请安装收费版本`);
        },
        async page_assess_list() {
            if (zfk.pageData.lastAccessListRunTime != 0) {
                if (zfk.now() - zfk.pageData.lastAccessListRunTime < 5000) {
                    return
                }
            }
            console.log("%c page_assess_list", "background:rgb(0,0,0);color:#fff");
        ...
        async page_list() {
            ...
            plugMain.closeWaitConfrimWin()
            await plugMain.waitOf((a) => $(".uncomplete_course li").length > 0);

            plugMain.showPaidContent(`免费版本不包含自动换课、评估功能，如需使用请安装收费版本`);
        },
        checkVideoPlay() {
