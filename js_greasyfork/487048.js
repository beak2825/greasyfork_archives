...
// @author       diehard2k0
// @match        *://stake.com/casino/games/dragon-tower
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487048/DTower%28COM%29.user.js
// @updateURL https://update.greasyfork.org/scripts/487048/DTower%28COM%29.meta.js
// ==/UserScript==
    ...
    class dtower extends StakeUsPlusPlugin {
        ...
        async startBot() {
            ...
            if (StakeUsPlus.plugins.dtower.getConfig("boton") == true) {
                ...
                if (button1.innerHTML == "Bet" && setplay == 0) {
                    setplay = 1
