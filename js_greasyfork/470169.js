// ==UserScript==
// @name         Ekşi - Takipçileri takip et
// @namespace    http://tampermonkey.net/
// @version      1
// @description  "Kişininin takipçilerini takip eden bot". En sevdiğiniz yazarı takip eden herkesi takip et. Kıskanç köpek.
// @author       angusyus
// @include      https://eksisozluk*.com/biri/*
// @include      https://eksisozluk*.com/takipci/*
// @include      https://eksisozluk*.com/takip/*

// @license MIT
/*jshint esversion: 10 */
// @downloadURL https://update.greasyfork.org/scripts/470169/Ek%C5%9Fi%20-%20Takip%C3%A7ileri%20takip%20et.user.js
// @updateURL https://update.greasyfork.org/scripts/470169/Ek%C5%9Fi%20-%20Takip%C3%A7ileri%20takip%20et.meta.js
// ==/UserScript==
...
(function() {
    ...
    setTimeout(() => {
        ...
        const lastDateOfRecordCommand = localStorage.getItem('startFollowerFollowDate');
        ...
        const storedYazarName = localStorage.getItem('followerFollowYazarName');
    ...
    if(buttonTab != null) {
        buttonTab.appendChild(createButton("start-follower-follow", "Takipçileri Takip"));
        document.querySelector("#start-follower-follow").addEventListener("click", onFollowStartButtonClick);
    }
})();
...
function onFollowStartButtonClick(zEvent) {
    ...
    localStorage.setItem('startFollowerFollowDate', currentDate);
    localStorage.setItem('followerFollowYazarName', yazarName);

    var stats = document.getElementById("user-entry-stats");
    var link = stats.getElementsByTagName("li")[1].getElementsByTagName("a")[0].href;
    location.replace(link);
}

async function startRecording() {
    var followers = await scrollToBottom();
...
function startFollowingOperation() {
    ...
    for (var i = 0; i < list.length; i++) {
        ...
        try {
            var buttonText = spanList[spanList.length-1].innerText
        } catch (error) {
