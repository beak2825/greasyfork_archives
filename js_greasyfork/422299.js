// ==UserScript==
// @name            WME Simple Permalink (from WME KeepMyLayers) tm fork mod
// @namespace       https://greasyfork.org/en/scripts/422299-wme-simple-permalink-from-wme-keepmylayers-tm-fork-mod
// @version         2024.03.07.02.tm
...
// @run-at          document-end
// @downloadURL https://update.greasyfork.org/scripts/422299/WME%20Simple%20Permalink%20%28from%20WME%20KeepMyLayers%29%20tm%20fork%20mod.user.js
// @updateURL https://update.greasyfork.org/scripts/422299/WME%20Simple%20Permalink%20%28from%20WME%20KeepMyLayers%29%20tm%20fork%20mod.meta.js
// ==/UserScript==
/* jshint -W097 */
...
// quick hack fork: corrects functionality, removes Marker from PL, fixes hovertext, moves icon up slightly (Ugly!)
...
var initSimplePermalink = function() {
    if (!document.getElementById('kmlPLPlaceholder')) {        var kmlKeyPresses = Array(2);
        ...
        var getKMLPermalink = function(currPl) {
            ...
            kmlShortPL = kmlShortPL.replace(/&marker=true/ig,'').replace("/", "");
        ...
        var wazePermalinkEl = document.querySelector('.WazeControlPermalink>a.permalink'),
            wazeCopyPlNote = "Ctrl/Cmd + C to copy permalink",
