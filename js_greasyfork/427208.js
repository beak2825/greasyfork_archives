...
// @description     支持记录pixiv历史记录，快速打开pixiv图片原图，快速收藏图片（按照设定填充标签），快速获取页面所有显示图片原图链接，储存所有获取的链接并打包下载，鼠标悬停图片进行大图浏览（图片与gif），下载作者所有作品等
// @version         3.7.6
// @namespace       akari
// @license         MIT
// @author          Pikaqian
...
// @downloadURL https://update.greasyfork.org/scripts/427208/pixiv%E5%BF%AB%E9%80%9F%E6%89%93%E5%BC%80%E5%8E%9F%E5%9B%BE%EF%BC%86%E8%87%AA%E5%8A%A8%E6%94%B6%E8%97%8F%EF%BC%86%E5%8E%9F%E5%9B%BE%E9%93%BE%E6%8E%A5%E6%89%93%E5%8C%85%E4%B8%8B%E8%BD%BD%E5%9B%BE%E7%89%87%E9%A2%84%E8%A7%88.user.js
// @updateURL https://update.greasyfork.org/scripts/427208/pixiv%E5%BF%AB%E9%80%9F%E6%89%93%E5%BC%80%E5%8E%9F%E5%9B%BE%EF%BC%86%E8%87%AA%E5%8A%A8%E6%94%B6%E8%97%8F%EF%BC%86%E5%8E%9F%E5%9B%BE%E9%93%BE%E6%8E%A5%E6%89%93%E5%8C%85%E4%B8%8B%E8%BD%BD%E5%9B%BE%E7%89%87%E9%A2%84%E8%A7%88.meta.js
// ==/UserScript==
...
(function() {
    ...
    var className_list_home=[
        ["relative group","div.relative.group"],//精选新作
        ["sc-e6de33c8-0 sc-c6a20d66-0 fhUcsb fbFqaQ","ul.sc-e6de33c8-0.sc-c6a20d66-0.fhUcsb.fbFqaQ"],//推荐作品
        ["w-full border-border border-0 border-b border-solid","div.w-full.border-border.border-0.border-b.border-solid"]//下面滚动的推荐作品部分
    ]
    var className_list_artwork=[
        ["sc-f0c26a5e-4 eoaxji","div.sc-f0c26a5e-4.eoaxji"],//作者其它作品（横向滚动）
        ["sc-bf8cea3f-1 bCxfvI","ul.sc-bf8cea3f-1.bCxfvI"],//相关作品
        ["sc-9222a8f6-2 kufPoS","div.sc-9222a8f6-2.kufPoS"]//“查看全部”按钮最近的div元素
    ]
    var className_list_search=[
        ["sc-ad8346e6-1 iwHaa-d","ul.sc-ad8346e6-1.iwHaa-d"]//搜索页面全部作品
    ]
    var className_list_user=[
        ["sc-7d21cb21-1 jELUak","ul.sc-7d21cb21-1.jELUak"]//作者页面全部作品
    ]
    var className_list_bookmark=[
        //["sc-7d21cb21-1 jELUak","ul.sc-7d21cb21-1.jELUak"]//收藏页面全部作品
        ["sc-bf8cea3f-1 bCxfvI","ul.sc-bf8cea3f-1.bCxfvI"]//收藏页面全部作品
    ]
    var className_list_userImgUl=[
        ["userImgUl","ul.userImgUl"]//作者作品部分全部作品（脚本功能）
    ]
    var className_list="{}"
    className_list=JSON.parse(className_list)
    className_list.home=className_list_home
    className_list.artwork=className_list_artwork
    className_list.search=className_list_search
    className_list.user=className_list_user
    className_list.bookmark=className_list_bookmark
    className_list.userImgUl=className_list_userImgUl
  ...
  #blackcover{
    ...
    if(getCookie('resolution')==''){//显示分辨率
        setCookie('resolution',0,90)//1为开启，0为关闭
    }
    ...
    */
	...
	<div class="recommend_inner_all" id="recommend_inner_all" style="height:225px;position: relative;z-index: 0;overflow: auto;">
        ...
        var No14 = document.createElementNS("http://www.w3.org/2000/svg", "svg");
        var path22 = document.createElementNS("http://www.w3.org/2000/svg", 'path');
        No14.setAttribute("aria-hidden","true");
        No14.setAttribute('viewbox', '0 0 24 24');
        No14.setAttribute('width', '24px');
        No14.setAttribute('height', '24px');
        path22.setAttribute('d','M967.09632 50.98496H56.9088C27.71456 50.98496 3.96288 74.73664 3.96288 103.93088v631.5008c0 29.18912 23.75168 52.9408 52.94592 52.9408H389.888v88.84224H277.83168c-26.45504 0-47.90272 21.44256-47.90272 47.8976s21.44768 47.90784 47.90272 47.90784h468.34176c26.46016 0 47.90272-21.44768 47.90272-47.90784s-21.44256-47.8976-47.90272-47.8976h-112.05632v-88.84224h332.9792c29.19424 0 52.94592-23.75168 52.94592-52.9408V103.93088c0-29.19424-23.75168-52.94592-52.94592-52.94592zM538.30656 877.2096H485.69344v-88.84224h52.608v88.84224z m380.88192-189.69088H104.81152V151.8336h814.37696v535.68512zM727.9616 522.51136h85.72416V250.752H560.9984v85.72416h166.9632zM463.18592 499.82464H296.23808V313.78432H210.51392v271.76448h252.672z')
        path22.style.transform="scale(0.0121) translate(216px, -2px) rotate(17deg)"
        path22.id='path22'
        if(getCookie('resolution')==0){
            path22.setAttribute('fill', '#fff');
        }
        else{
            path22.setAttribute('fill', '#f00');
        }
        No14.appendChild(path22);
        No14.id = 'No14';
        No14.setAttribute('class', 'No');
        var No14_title=document.createElement('div')
        No14_title.id='No14_title'
        No14_title.title=No14_title_text
        document.getElementById('divnew').appendChild(No14_title)
        document.getElementById("No14_title").appendChild(No14);
        ...
        divNew.insertBefore(No14_title,oText)
    ...
    function getPageNumNew(imgId){
        return fetch(`https://www.pixiv.net/ajax/illust/${imgId}?lang=zh`)
            .then(result=>{
            if(result.ok){
                return result.json()
            }
    ...
    function userAllPic(k,id){
        ...
        if(document.getElementById('userImgBack')==null){
            ...
            userImg_underImg.style.backgroundColor="rgba(0,0,0,0.4)"
            userImg_underImg.style.cursor="pointer"
            userImg_underImg.style.zIndex=1
                            ...
                            onload: function(res) {
                                if(res.status === 200){
                                    ...
                                    for(var j=0;j<min_length;j++){
                                        ...
                                        var userImgPicA=document.createElement('a')
                                        userImgPicA.className='userImgPicA'
                                        userImgPicA.href=href
                                        userImgAll.appendChild(userImgPicA)
                                        ...
                                        userImgPicA.appendChild(userImgPic)
    ...
    async function getFinalUrl(k,e,num){//k=0为ctrl事件，k=1为alt事件,k=2为核爆，e为event即事件，num为图片数量
        cookie_size()
        if(getCookie('Size')==2){
            if(k!=0){
                return
        ...
        var num_alt=num.body.pageCount
        var lastUrl=""//最终需要设置为cookie的元素
        var set_moe
        if(k==2&&document.getElementsByClassName("sc-9cbefcd0-1 flPFEB")[0].children.length!=0){//核爆事件；"document"部分用来判定页面上是否有可以核爆的元素，防止报错
            var ULpicture=document.getElementsByClassName("sc-9cbefcd0-1 flPFEB")[0].children
            for(var w=0;w<ULpicture.length;w++){
                var num_explode=getPageNum(0,ULpicture[w])
                console.log(num_explode)
        ...
        if(e!=-1){
            if(getCookie("outUrl")==0){//0为cat
                ...
                var moe_pid=num.body.illustId
                if(moe_pid!=null){
                    GM_xmlhttpRequest({
                        method: "GET",
                        url: "https://www.pixiv.net/ajax/illust/"+moe_pid,
                        headers:{
                            "User-Agent": navigator.userAgent,
                        },
                        onload: function(res) {
                            if(res.status === 200){
                                ...
                                // if(p_json.body.pageCount>0){
                                var moe_url2=p_json.body.urls.original
                                var moe_url_model="https://i.pixiv.re/"+moe_url2.split("i.pximg.net/")[1]//+"@progressive.webp"//https://api.pixiv.moe/image/i.pximg.net/img-original/img/2021/10/14/00/49/28/93428795_p0.png@progressive.webp
                                // }
                                var slider=getCookie('slider')
                                var num_open=p_json.body.pageCount
                                if(slider<num_open){
                                    num_open=1
                                }
                                for(var i=0;i<num_open;i++){
                                    if(k==0){
    ...
    function r18_block(blur){
        ...
        new MutationObserver(mutations => {//动图预览相关
            if(window.location.href.match('#preview')!=null){
                ...
                // }
                // console.log('------------------')
                if(canvas_end==false&&document.getElementsByClassName('sc-e6a9a33b-1 DXNrc').length!=0){
                    var canvas_div=document.getElementsByClassName('sc-e6a9a33b-1 DXNrc')[0]
                    canvas_div.style.position='fixed'
                    canvas_div.style.top='0px'
                    canvas_div.style.width=canvas_div.childNodes[0].width+'px'
                    canvas_div.style.height=canvas_div.childNodes[0].height+'px'
                    canvas_div.childNodes[0].id='iframe_canvas'
                    document.body.appendChild(canvas_div)
                    for(var ii=0;ii<document.body.childNodes.length;ii++){
                        if(document.body.childNodes[ii].className!='sc-e6a9a33b-1 DXNrc'){
                            document.body.childNodes[ii].style.visibility='hidden'
                        }
                    }
                    document.body.style.visibility='visible'
                    canvas_end=true
                }
                else if(canvas_end!=true){
                    document.body.style.visibility='hidden'
                }
                /*                 console.log(mutations)
                for(var k=0;k<mutations.length;k++){
                    if(qq==0&&mutations[k].addedNodes[0]!=null&&mutations[k].addedNodes[0].className!='sc-e6a9a33b-1 DXNrc'&&mutations[k].addedNodes[0].getElementsByClassName('sc-e6a9a33b-2 fXRMZT').length==0){
                        // mutations[k].addedNodes[0].remove()
                    }
                    else if(qq==0&&mutations[k].addedNodes[0]!=null&&mutations[k].addedNodes[0].className!='sc-e6a9a33b-1 DXNrc'&&mutations[k].addedNodes[0].getElementsByClassName('sc-e6a9a33b-2 fXRMZT').length>0){
                        console.log('a')
                    }
                } */
                // for(var k=0;k<mutations.length;k++){
                //     if(qq==0&&mutations[k].addedNodes[0]!=null&&mutations[k].addedNodes[0].className=='sc-e6a9a33b-1 DXNrc'){
            ...
            for(var i=0;i<mutations.length;i++){
                if(mutations[i].addedNodes.length!=0){
                    if(mutations[i].addedNodes[0].src!=null){
                        ...
                        var user_out=document.getElementsByClassName('sc-acab085f-7 cRLlKW')[0]//用户悬停弹窗中“已关注”部分的父节点
                        if(user_out!=null){
                ...
                for(var e=0;e<mutations.length;e++){
                    if(mutations[e].addedNodes.length!=0){
                        for(var r=0;r<mutations[e].addedNodes.length;r++){
                            ...
                            if(mutations[e].addedNodes.legnth!=0&&mutations[e].addedNodes[r].getElementsByClassName(className_list.artwork[2][0]).length!=0){//作品页展开按钮
                                //console.log(mutations[e].addedNodes[r])
                                console.log('click')
                                mutations[e].addedNodes[r].getElementsByClassName(className_list.artwork[2][0])[0].click()
                            }
                        }
                    }
                }
            ...
            if(el!=null){
                ...
                if(event.ctrlKey==true){
                    ...
                    if(event.altKey!=true&&event.shiftKey!=true){
                        ...
                        var imgId=event.target.closest('a').href.match(/\d+/)[0]
                        event.preventDefault()
                        var pageNum=await getPageNumNew(imgId)
                        console.log(pageNum)
                    ...
                    GM_xmlhttpRequest({
                        ...
                        onload: function(res) {
                            if(res.status === 200){
                                ...
                                var p=res.responseText
                                var p_json=JSON.parse(p)
                                var final=p_json.body.tags.tags
                                for(var i=0;i<final.length;i++){
                                    final[i]=final[i].tag.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
                                }
                ...
                if(event.altKey==true&&event.ctrlKey==true){
                    ...
                    event.preventDefault()
                    getFinalUrl(1,event,await getPageNumNew(id))
                    // }
                }
                if(event.altKey!=true&&event.ctrlKey!=true&&event.target.closest('svg')!=null&&event.target.closest('button')!=null){
                    isProhibit=0//0为未屏蔽，1为屏蔽
                    cookie_tag=[]
                    id=event.target.closest('div').previousSibling.previousSibling.href.match(/\d{6,10}/)[0]
                    event.preventDefault()
                    GM_xmlhttpRequest({
                        method: "GET",
                        url: "https://www.pixiv.net/ajax/illust/"+id,
    ...
    function checkCookie(){
        window.addEventListener('contextmenu',async function (event){
            ...
            if(event.altKey==true&&event.ctrlKey!=true){
                if(event.target.src!=null){
                    var imgId=event.target.closest('a')
                    if(imgId!=null){
                        imgId=imgId.href.match(/\d+/)
                        if(imgId!=null){
                            imgId=imgId[0]
                        }
                    }
                    event.preventDefault()
                    getFinalUrl(1,event,await getPageNumNew(imgId))
                }
                num=lastcookie()
                event.preventDefault()
            }
        ...
        morefunction.addEventListener('click',()=>{
            ...
            if(w>0){
                ...
                elem_14.style.opacity="0.20"

                elem_1.style.transform="rotate(57deg) translateX(98px)"
                // elem_2.style.transform="rotate(-16deg) translateX(91px)"
                elem_3.style.transform="rotate(28deg) translateX(86px)"
                elem_4.style.transform="rotate(50deg) translateX(132px)"
                elem_5.style.transform="rotate(-51deg) translateX(143px)"
                elem_6.style.transform="rotate(70deg) translateX(141px)"
                elem_7.style.transform="rotate(-5deg) translateX(83px)"
                elem_8.style.transform="rotate(10deg) translateX(130px)"
                elem_9.style.transform="rotate(-68deg) translateX(146px)"
                elem_10.style.transform="rotate(-32deg) translateX(135px)"
                elem_11.style.transform="rotate(-32deg) translateX(96px)"
                elem_12.style.transform="rotate(31deg) translateX(128px)"
                elem_13.style.transform="rotate(-57deg) translateX(105px)"
                elem_14.style.transform="rotate(-12deg) translateX(133px)"
                click_num++
            }
            else if(w<0){
        ...
        No3.addEventListener('click',()=>{
            ...
            if(v>0){
                ...
                elem_23.style.transform="rotate(0deg) translateX(-10px)"
                    ...
                    for(var ie=0;ie<parseInt(intercept.split("\n")[ic].split("*")[1]);ie++){
                        if(intercept.split("\n")[ic].split("*")[1]==1){
                            if(intercept.split("\n")[ic].match(/\d{4}\/\d{2}/)==null){
                                ...
                                intercept_final=intercept_final+"https://i.pixiv.moe/i.pximg.net/img-original/img/"+intercept.split("\n")[ic].split("*")[0]+"\n"//+"@progressive.webp\n"
                            }
                        }
                        else{
                            if(intercept.split("\n")[ic].match(/\d{4}\/\d{2}/)==null){
    ...
    window.addEventListener('keydown',function(event){//判断是否按下回车，与手动查看标签相关
        ...
        if(event.keyCode==13&&window.getSelection()!=null&&(window.getSelection().focusNode.id=='checkInput'||window.getSelection().focusNode.id=='check')&&text.value!=""){//点击是否为回车，分别为判断光标位置是否为空，光标指向的id是否为输入框或输入框外围，输入框内部是否为""
            GM_xmlhttpRequest({
                method: "GET",
                url: "https://www.pixiv.net/ajax/illust/"+textValue,
                headers:{
                    "User-Agent": navigator.userAgent,
                },
                onload: function(res) {
                    if(res.status === 200){
                        ...
                        var p=res.responseText
                        var p_json=JSON.parse(p)
                        var tags=p_json.body.tags.tags
                        var user_tags=""
                        for(var i=0;i<tags.length;i++){
                            user_tags+=tags[i].tag
                            if(tags[i].translation!=null){
                                user_tags+=" ("+tags[i].translation.en+")"
                            }
                            user_tags+=",    "
                        }
                                    ...
                                    if(res.status === 200){
                                        ...
                                        for(var k=0;k<illust_IdPage.length;k++){
                                            if(illust_IdPage[k].split("**")[1]==1){
                                                textFinal=textFinal+'https://pixiv.cat/'+illust_IdPage[k].split("**")[0]+'.png\n'
                                            }
                                            else{
                                                for(var h=0;h<parseInt(illust_IdPage[k].split("**")[1]);h++){
                                                    textFinal=textFinal+'https://pixiv.cat/'+illust_IdPage[k].split("**")[0]+'-'+(h+1)+'.png\n'
                                                }
                                            }
                                        }
    ...
    No14.addEventListener('click',function(e){
        if(getCookie('resolution')==0){
            setCookie('resolution',1,90)
            document.getElementById('path22').style.fill='red'
        }
        else{
            setCookie("resolution",0,90)
            document.getElementById('path22').style.fill='white'
        }
    })

    var resolution_className=[
        ".sc-324476b7-10.bEKCzM",//作品页面-作者其他作品、作品页面-相关作品、收藏页面-所有作品、搜索页面-所有作品
        ".sc-9cbefcd0-2.edWkcL",//首页-精选新作、首页-推荐作品
        ".userImgPic"]
    var resolution_className_exclude=["ul.sc-13f0472e-3.bJnszw","div.sc-f0c26a5e-4.eoaxji"]
    // var answer=[]
    // for(var item in className_list){
    //     var search_item=className_list[item]
    //     for(var i=0;i<search_item.length;i++){
    //         // for(var j=0;j<search_item[i].length;j++){
    //         var a=document.querySelectorAll(search_item[i][1])
    //         if(a.length!=0){
    //             var b=a[0].getElementsByTagName('img')
    //             if(b.length!=0){
    //                 if(answer.indexOf(b[0].className)==-1){
    //                     answer.push(b[0].className)
    //                 }
    //             }
    //         }
    //         // }
    ...
    //     }
    // }
    if(getCookie('resolution')==1){
        new MutationObserver(async(mutations) => {
            var new_elem=[]
            var pid=[]
            var pid_string=""
            var exclude_selector=''
            for(var i=0;i<resolution_className_exclude.length;i++){
                exclude_selector+=`:not(${resolution_className_exclude[i]} *)`
            }
            for(i=0;i<resolution_className.length;i++){
                new_elem.push(...document.querySelectorAll(`a:has(${resolution_className[i]}):not([size-added])${exclude_selector}`))
                // new_elem.push(...document.querySelectorAll(`a:has(${resolution_className[i]}):not([size-added]):not(ul.sc-13f0472e-3.bJnszw *)`))
            }
            if(new_elem.length!=0){
                // console.log("element:")
                // console.log(new_elem)
                for(i=0;i<new_elem.length;i++){
                    new_elem[i].setAttribute("size-added",1)
                }
                new_elem.forEach(item => {
                    pid.push(item.href.match(/(?<=\/)\d+/)[0])
                    pid_string+=item.href.match(/(?<=\/)\d+/)[0]+','
                })
                pid_string=pid_string.substr(0,pid_string.length-1)
                // console.log("pid:")
                // console.log(pid)
                // console.log(pid_string)
                await fetch("https://www.pixiv.net/rpc/illust_list.php?page=discover&illust_ids="+pid_string).then(response=>{
                    if(response.ok){ return response.json()}
                }).then(json=>{
                    for(var i=0;i<json.length;i++){
                        var span=document.createElement('span')
                        span.innerText=json[i].illust_width+'x'+json[i].illust_height
                        span.style='pointer-events: none;position: absolute;left: 2%;top: 87%;background-color: white;padding-left: 5px;padding-right: 5px;padding-top: 3px;padding-bottom: 3px;border-radius: 5px;font-size: 12px;font-weight: 550;cursor:pointer'
                        if(new_elem[i].className=='userImgPicA'){
                            span.style.left='2%'
                            span.style.top='77%'
                            span.style.zIndex=3
                        }
                        new_elem[i].parentNode.appendChild(span)
                    }
                })
            }
        }).observe(document.body, {childList: true, subtree: true})
    ...
    document.body.addEventListener('mousemove',function(event){
        ...
        if((pre_check=="1"||pre_check=="2"||pre_check=="3")&&event.ctrlKey!=true){
            ...
            //     }
            var className=false
            for(var key in className_list){
                for(var i=0;i<className_list[key].length;i++){
                    if(eventt.closest(className_list[key][i][1])!=null){
                        className=true
                        break
                        console.log('aaa')
                    }
            ...
            if(kid.match("square1200")!=null||kid.match("custom1200")!=null){
    ...
    document.body.addEventListener('mousemove',function(event){
        ...
        // if(eventT_ul!=null){
        //     if(ab!=false&&eventT_ul!=null&&(eventT_ul.className=="sc-iasfms-1 hYfnPb"||eventT_ul.className=="sc-iasfms-3 jDiPOg"||eventT_ul.className=="sc-l7cibp-1 krFoBL"||eventT_ul.className=="sc-1kr69jw-0 hkzusx"||eventT_ul.className=="sc-9y4be5-1 jtUPOE"||eventT_ul.className=="sc-1olyam9-0 sc-yxl4jc-0 hjtPnz bpXOJR"||eventT_ul.className=='sc-l7cibp-1 hdRpMN'||eventT_ul.className=='userImgUl'||eventT_ul.className=='sort_ul'||eventT_ul.className=='sc-e6de33c8-0 sc-96f10c4f-0 fhUcsb cCkJMN'||eventT_ul.className=='sc-7d21cb21-1 jELUak'||eventT_ul.className=='sc-ad8346e6-1 iwHaa-d'||event.target.closest('.relative.group')!=null)){//分别对应“大图片页面下推荐图片部分单个图片”和“主页面部分图片单个图片”、“大图片页面画师信息下滚动部分单个图片”、搜索页面单个图片、更多作者图片部分ul元素、首页“推荐作品”部分ul元素（关注作者的作品的部分下面的部分）、首页“精选新作”部分上层的div元素（关注作者的作品的部分）
        //         var ab=true
        //         }
        //     else{
        //         ab=false
    ...
    window.addEventListener('mouseup',function(e){
        if(e.button==4||e.button==3){
            if((document.getElementById("bigImg_1")!=null||document.getElementById("bigImg")!=null)){
                ...
                if(e.button==3&&preNum!=-1){
                    if(preNum!=0){
                        preview.src=preSrc[0]+"_p"+(preNum-1)+"_"+preSrc[1]
                    }
                }
                else if(e.button==4&&preNum!=-1){
                    preview.src=preSrc[0]+"_p"+(preNum+1)+"_"+preSrc[1]
                }
                e.preventDefault()
            }
    ...
    document.addEventListener('contextmenu',function(event){
        if(event.target.id=='user_svg_background'||event.target.id=='user_svg'){
            if(document.getElementById('user_svg')!=null&&document.getElementById('user_svg').closest('div')!=null){
                var id=document.getElementById('user_svg').closest('div.sc-acab085f-3.kIkMnj').childNodes[0].href.match(/\d+/)[0]//获取作者id
                userAllPic(1,id)
                event.preventDefault()
            }
        }
    ...
    */
    ...
    /*     window.addEventListener('keydown',async function(event){
        if(event.shiftKey==true&&event.altKey==true&&event.key=="S"){
            ...
            // var ids=["120508911","110552277","108882396","114459713","107740041","117038097","91199411","119277850","119488710","33373804","67213393","91562021","119123217","78166169","64036208","116761929","117126298","110529030","116535470","113197871","68435814","117184160","118079159","69938888","94009097","71075162","79933848","9486359","91909285","117979621","92848682","116688400","32490405","89336068","20977616","18272076","84769019","86072691","98554588","112297877","114237404","79919021","109568369","116555091","113041462","116168368","116624507","51851354","57307491","104773503","73281656","58390650","97520214","111273485","108817347","114979166","116502470","116175519","112895340","115362121","116590359","98281111","68714169","115107950","115558460","79121001","74274880","59327999","107016505","115411637","99186286","99090251","112805079","100899297","99210293","109538576","108674162","108847117","111678320","108015877","108387721","116224822","94454254","93879503","75809500","59598385","68455266","18639432","25932255","26300308","105247769","113548178","113600225","89893322","68532396","107246896","86402041","98684552","99771414","101351606","101490371","102437042","103688104","103920632","112358140","110562134","109252360","109978315","107985575","106250092","71157017","111047763","110474488","66552544","79193070","83514063","115194087","114838907","111840079","111936067","106710098","101954555","96814410","61519552","104391296","103847529","104243280","112838625","112874940","92093397","108876136","109378587","113176016","112166064","85580902","85618946","108511926","73923117","74980879","95589672","60104382","105076163","86480587","73551476","71148842","98406916","97807038","110478735","91384802","87977897","91851239","71187055","103219034","105182886","104137476","104036420","111107938","111064304","111249366","100732285","104561694","104805436","111046153","98373871","923358","110766897","111587758","108343772","112138140","112297484","52057896","112238730","109672383","107819095","103369201","112168012","111630627","103965435","25857189","31479986","34477621","34562864","34477857","34871530","34683993","42655610","47004232","47042374","86200724","108405757","88291854","77032931","89553729","112199752","108099251","81519046","102826670","102791074","67329067"]
            // var ids=["118043273","121764304","109684152","117182732","90782802","129100232","100393415","124676643","106680942","128094973","119579702","120068005","107644862","42657076","94879006","84120766","120415725","94074872","94074948","94176792","75545697","90915938","57909873","125540636","122343667","77012854","109335267","124789172","108681222","124538495","124286070","117183164","116257414","79711189","116351600","116351139","116320617","85056686","122445407","110531525","110532869","121248306","122265579","113059051","119904240","58715886","52683536","48784070","48319281","61768301","62703347","87777372","60312012","98349804","75327301","121515343","86651423","73611880","98223253","71663996","53707487","66401382","71292988","65965236","69432712","69797469","120474484","120515922","120508911","110552277","108882396","114459713","107740041","117038097","91199411","119277850","119488710","33373804","67213393","91562021","119123217","78166169","64036208","116761929","117126298","110529030","116535470","113197871","68435814","117184160","118079159","69938888","94009097","71075162","79933848","9486359","91909285","117979621","92848682","116688400","32490405","89336068","20977616","18272076","84769019","86072691","98554588","112297877","114237404","79919021","109568369","116555091","113041462","116168368","116624507","51851354","57307491","104773503","73281656","58390650","97520214","111273485","108817347","114979166","116502470","116175519","112895340","115362121","116590359","98281111","68714169","115107950","115558460","79121001","74274880","59327999","107016505","115411637","99186286","99090251","112805079","100899297","99210293","109538576","108674162","108847117","111678320","108015877","108387721","116224822","94454254","93879503","75809500","59598385","68455266","18639432","25932255","26300308","105247769","113548178","113600225","89893322","68532396","107246896","86402041","98684552","99771414","101351606","101490371","102437042","103688104","103920632","112358140","110562134","109252360","109978315","107985575","106250092","71157017","111047763","110474488","66552544","79193070","83514063","115194087","114838907","111840079","111936067","106710098","101954555","96814410","61519552","104391296","103847529","104243280","112838625","112874940","92093397","108876136","109378587","113176016","112166064","85580902","85618946","108511926","73923117","74980879","95589672","60104382","105076163","86480587","73551476","71148842","98406916","97807038","110478735","91384802","87977897","91851239","71187055","103219034","105182886","104137476","104036420","111107938","111064304","111249366","100732285","104561694","104805436","111046153","98373871","923358","110766897","111587758","108343772","112138140","112297484","52057896","112238730","109672383","107819095","103369201","112168012","111630627","103965435","25857189","31479986","34477621","34562864","34477857","34871530","34683993","42655610","47004232","47042374","86200724","108405757","88291854","77032931","89553729","112199752","108099251","81519046","102826670","102791074","67329067"]
            var a=document.getElementsByClassName('sc-7d21cb21-1 jELUak')[0].childNodes
            var b=[]
            for(var i=0;i<a.length;i++){
                if(a[i].getElementsByClassName('sc-5a760b36-6 bsJslY')[0].href!=null){
                    b.push(a[i].getElementsByClassName('sc-5a760b36-6 bsJslY')[0].href.match(/\d+$/)[0])
                }
            }
            var ids=b
            console.log(ids)
            ...
            var cookie_tag_safe=[]
            var new_time=0;
            function outputRecursive(i,max) {
                cookie_tag_safe=[]
                if (i == max) return;
                ...
                setTimeout(() => {
                        ...
                        onload: function(res) {
                            if(res.status === 200){
                                ...
                                if(isProhibit==0){
                                    ...
                                    var interval_time=timestamp-new_time
                                    new_time=timestamp
                                    fetch("https://www.pixiv.net/ajax/illusts/bookmarks/add",{
                                        headers: {
                                            "accept": "application/json",
                                        ...
                                        console.log("time: "+interval_time+"; id: "+id+"; tags "+cookie_tag_safe)
                                    })
                                }
                                else{
                                    alert('包含屏蔽标签'+isProhibit)
                    ...
                    event.preventDefault()
                    outputRecursive(i + 1, max);
                }, delay);
            }

            outputRecursive(0, ids.length);
