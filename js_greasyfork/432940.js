// ==UserScript==
// @name         Notion-zh_CN safari UserScript 插件 支持
// @namespace    http://tampermonkey.net/
// @version      0.0.4
// @description  Notion-zh_CN 汉化 支持 safari UserScript 插件
// @author       reamd7
// @match        *://www.notion.so/*
// @grant        none
...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/432940/Notion-zh_CN%20safari%20UserScript%20%E6%8F%92%E4%BB%B6%20%E6%94%AF%E6%8C%81.user.js
// @updateURL https://update.greasyfork.org/scripts/432940/Notion-zh_CN%20safari%20UserScript%20%E6%8F%92%E4%BB%B6%20%E6%94%AF%E6%8C%81.meta.js
// ==/UserScript==
(function () {
  "use strict";
  const l = document.querySelectorAll(('script[defer]'));
  const d = Array.from(l).map(v => v.src)
  l.forEach(v => v.setAttribute('defer', true))
  ...
  routes.id = "routes";
  routes.type = "application/javascript";
