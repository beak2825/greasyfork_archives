...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/27605/Shoutbox.user.js
// @updateURL https://update.greasyfork.org/scripts/27605/Shoutbox.meta.js
// ==/UserScript==
var scc = {
	color: "#C2EAFF",
	notif: true,
...
var customChat = {
	...
	notify: function(msg) {
		if(scc.notif){
			if(!("Notification"in window)){console.error("Ce navigateur ne supporte pas les notifications !")}else if(Notification.permission==="granted"){var notification=new Notification(msg, {icon: 'http://realitygaming.fr/attachments/rg-png.14121/'})}else if(Notification.permission!=="denied"){Notification.requestPermission(function(e){if(!("permission"in Notification)){Notification.permission=e}if(e==="granted"){var t=new Notification(msg, {icon: 'http://realitygaming.fr/attachments/rg-png.14121/'})}})}
		}
		else {
