// ==UserScript==
// @name         The Angry Ugvs Auto Message
...
// @downloadURL https://update.greasyfork.org/scripts/552248/The%20Angry%20Ugvs%20Auto%20Message.user.js
// @updateURL https://update.greasyfork.org/scripts/552248/The%20Angry%20Ugvs%20Auto%20Message.meta.js
// ==/UserScript==
...
(async function () {
    ...
    const html = `
    <div id="dms-wrapper" style="position:fixed;top:50px;right:50px;z-index:9999;background:#829381;color:white;border-radius:8px;font-size:13px;width:300px;box-shadow:0 0 8px rgba(0,0,0,0.6);user-select:none;font-family:Arial,sans-serif;">
      <div id="dms-titlebar" style="cursor:move;background:#010300;padding:6px 10px;border-radius:8px 8px 0 0;display:flex;justify-content:space-between;align-items:center;user-select:none;">
        <span style="font-weight:bold;">Ugvs Mod Menu</span>
        <div style="display:flex;align-items:center;gap:10px;">
          <span id="dms-status" style="font-weight:bold;color:#fa020b;">Stop</span>
    ...
    function log(msg, isError = false) {
        ...
        line.style.color = isError ? "#010300" : "#829381";
