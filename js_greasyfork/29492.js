...
// @match        https://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/29492/%E6%A0%91%E7%9A%AE%E7%BA%B9%E5%AE%8C%E7%BE%8E%E7%89%88OK-05-18.user.js
// @updateURL https://update.greasyfork.org/scripts/29492/%E6%A0%91%E7%9A%AE%E7%BA%B9%E5%AE%8C%E7%BE%8E%E7%89%88OK-05-18.meta.js
// ==/UserScript==
(function() {var css = [
	"/* Basic fonts and color scheme. */",
"html,body{background-image:url(http://www.css3maker.com/images/body_bg_new.jpg)!important;font-family: 'Microsoft Yahei'!important;}",
"a{color:#0196e3!important;}",
...
"div#imgDiv{background-color: rgba(0, 0, 0,0.1);box-shadow: 0px 0px 50px #3c78d8;}",
...
"div#s_ctner_menus.s-ctner-menus.s-opacity-blank8{box-shadow: 0px 0px 60px #3c78d8!important;}",
...
"body{",
"SCROLLBAR-FACE-COLOR: rgba(28, 28, 28,255);",
"SCROLLBAR-HIGHLIGHT-COLOR: rgba(28, 28, 28,255);",
"SCROLLBAR-SHADOW-COLOR:#3c78d8;",
"SCROLLBAR-3DLIGHT-COLOR: rgba(28, 28, 28,255);",
"SCROLLBAR-ARROW-COLOR: rgba(28, 28, 28,255);",
"SCROLLBAR-TRACK-COLOR:  rgba(28, 28, 28,255);",
"SCROLLBAR-DARKSHADOW-COLOR: rgba(28, 28, 28,255);",
"}",
...
".H-Logo {width: 122px!important;height:45px!important;float:left!important;background-image: url(https://i1.letvimg.com/lc07_img/201703/06/10/26/logo.png)!important;}",
 /*中华珍宝网背景设置*/
"div#map,div#imgview{background-image:url(http://www.css3maker.com/images/body_bg_new.jpg)!important;}",
 /*推特宽屏设置*/
...
".stream-item:not(.no-header-background-module),  .dashboard.dashboard-right{box-shadow: 0px 0px 40px #000!important;}",/*黑色背景下发光*/
".content-main {",
"    padding-left:0.2em;",
...
".DashboardProfileCard{border-top:hidden!important;border-color:#000!important;}",/*新增 信息卡框线颜色改变*/
...
"._82fo9, ._cag6k, ._gs7sp, ._h2d1o, ._mbp5e, ._s6b3o{background-color:rgba(0, 0, 0,0.2)!important;box-shadow: 0px 0px 80px #3c78d8!important;}",/*新增页面信息流发光效果*/
"._ea084,._n3cp9,._tjnr4,._ksjel,._a1rcs{background-image:url(http://www.css3maker.com/images/body_bg_new.jpg)!important;}", /*ins点击图片后文本背景设置*/
...
/*知乎搜索下拉背景色不透明,宽度自动树皮纹*/
".ac-renderer {width: auto!important;background-image:url(http://www.css3maker.com/images/body_bg_new.jpg)!important;}", 
].join("\n");
