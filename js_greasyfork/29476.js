// ==UserScript==
// @name         Overlay ILDOT Flood Closure
// @namespace    https://greasyfork.org/users/45389
// @version      0.4.002
// @description  Adds Line overlay for IL flood closure
// @author       MapOMatic
...
// @downloadURL https://update.greasyfork.org/scripts/29476/Overlay%20ILDOT%20Flood%20Closure.user.js
// @updateURL https://update.greasyfork.org/scripts/29476/Overlay%20ILDOT%20Flood%20Closure.meta.js
// ==/UserScript==
// thanks to MapOmatic for creating script. Modified by ggrane for IL Flood

(function() {
    'use strict';

    var _settingsStoreName = 'wme_ILDOT_Roads';
    ...
    var _stateSettings = {
       IL: {
            baseUrl: '',
            mapLayers: [
                { layerID:'http://ags10s2.dot.illinois.gov/ArcGIS/rest/services/GAI/FloodingClosuresDbLayer/MapServer/0', outFields:[''] },
    ...
    function log(message, level) {
        if (message && level <= _debugLevel) {
            console.log('WME ILfood: ' + message);
        }
    }
    ...
    function initLayer(){
        ...
        _mapLayer = new OpenLayers.Layer.Vector("Overlay - ILDOT Flood closure ", {
            uniqueName: "__ILDOTflood",
            displayInLayerSwitcher: false
        });
        I18n.translations.en.layers.name.__FCLayer = "ILDOT flood";
        ...
        WazeWrap.Interface.AddLayerCheckbox("overlay", "ILDOT Flood Closure", _settings.layerVisible, onLayerToggleChanged);
    }
