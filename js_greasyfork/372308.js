// ==UserScript==
// @name       自用视频解析
// @namespace  https://greasyfork.org/zh-CN/users/212842
// @version    19.9.344
// @description  一键解析各大网站视频，无广告。解析接口贵精不贵多，绝对够用。
// @author     jjkkk
// @noframes
// @match    *://*.iqiyi.com/*
// @match    *://*.youku.com/*
...
// @grant    GM_openInTab
// @grant    GM.openInTab
// @downloadURL https://update.greasyfork.org/scripts/372308/%E8%87%AA%E7%94%A8%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/372308/%E8%87%AA%E7%94%A8%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
...
(() => {
  ...
  `);
  var defaultapi = {
    title: "默认用爱看解析，失效请更换接口",
    url: "http://aikan-tv.com/?url="
  };
  //apis name:显示的文字  url:接口  title:提示文字  intab:是否适合内嵌(嵌入判断:GMgetValue("replaceRaw",false)值||intab值)
  var apis =[
    {name:"52X",url:"http://jx.52xftv.cn/?url=",title:"转圈圈就换线路",intab:1},
    {name:"17云1",url:"https://www.1717yun.com/jx/ty.php?url=",title:"转圈圈就换线路",intab:1},
    {name:"秒播a",url:"http://y.mt2t.com/lines?url=",title:"转圈圈就换线路",intab:1},
    {name:"速度牛",url:"http://api.wlzhan.com/sudu/?url=",title:"转圈圈就换线路",intab:1},
    {name:"vis解析",url:"http://api.visaok.net/?url=",title:"转圈圈就换线路",intab:1},
    {name:"OK",url:"http://okjx.cc/?url=",title:"转圈圈就换线路",intab:1},
    {name:"17k云",url:"http://17kyun.com/api.php?url=",title:"转圈圈就换线路",intab:1},
    {name:"稳多多",url:"http://yuhu68.top/?url=",title:"转圈圈就换线路",intab:1},
    {name:"寒曦朦",url:"http://jx.hanximeng.com/api.php?url=",title:"转圈圈就换线路",intab:1},
    {name:"久看解析",url:"http://jx.9kyy.com/vip/?url=",title:"转圈圈就换线路",intab:1},
    {name:"思念视频",url:"https://api.7kki.cn/api/?url=",title:"转圈圈就换线路",intab:1},
  {name:"JXe解析",url:"http://yun.jxegc.com/vip.php?url=",title:"转圈换线路",intab:1},
    {name:"V解析",url:"http://v.tt-hk.cn/beac.php?url=",title:"转圈换线路",intab:1},
    {name:"思古云解",url:"http://api.bbbbbb.me/yunjx/?url=",title:"转圈圈就换线路",intab:1},
    {name:"思古解析",url:"http://api.bbbbbb.me/sg/?url=",title:"转圈圈就换线路",intab:1},
  ];
  //嵌入页面播放
  ...
  function intabSetting(){
    ...
    .then((ag)=>{
      ...
      <fieldset>
        ...
        <label for="TMpH"><span class="TMHYspan150">高度</span><input type="text" id="TMpH" value="${intabSize.height}"  class="TMHYmti" placeholder='如"300px"或者"65%"'/></label>
        <label for="TMpW"><span class="TMHYspan150">宽度</span><input type="text" id="TMpW" value="${intabSize.width}"  class="TMHYmti" placeholder='如"300px"或者"65%"'/></label><br />
        <label for="TMpL"><span class="TMHYspan150">左边距</span><input type="text" id="TMpL" value="${intabSize.left}"  class="TMHYmti" placeholder='如"300px"或者"65%"'/></label>
        <label for="TMpT"><span class="TMHYspan150">上边距</span><input type="text" id="TMpT" value="${intabSize.top}"  class="TMHYmti" placeholder='如"300px"或者"65%"'/></label>
      </fieldset>
...
/** Plugin for own use. Code from Huang Yan, thank you.   */
