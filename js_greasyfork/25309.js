...
// @namespace   jungletek.redacted.ch
...
// @include     https://*redacted.ch/collage.php*
...
// @version     1.0.4
// @date        2019-10-12
// @downloadURL https://update.greasyfork.org/scripts/25309/Redacted%20Collage%20Building%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/25309/Redacted%20Collage%20Building%20Helper.meta.js
// ==/UserScript==
...
var URL = new Object();
function parseURL() {
	var URLArr = document.URL.match(/^(https:\/\/(?:ssl\.)?redacted\.ch)\/([\w\/\.]+?)(\?(.*?))?(#.*)?$/);
	URL.Host = URLArr[1]; //protocol + hostname, eg. https://redacted.ch
	URL.Path = URLArr[2];
	URL.Hash = URLArr[5];
