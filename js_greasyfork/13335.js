...
// @grant        all
// @downloadURL https://update.greasyfork.org/scripts/13335/TI.user.js
// @updateURL https://update.greasyfork.org/scripts/13335/TI.meta.js
// ==/UserScript==
...
function calcularRotinas()
{
  $('.routine').remove();
	...
	$("tr.header").append("<th class='routine' title='' style='width: 40px; cursor: pointer;''>SI</th>");
