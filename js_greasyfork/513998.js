...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/513998/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20PSKOV.user.js
// @updateURL https://update.greasyfork.org/scripts/513998/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20PSKOV.meta.js
// ==/UserScript==
...
"[CENTER][SIZE=3][FONT=times new roman][B] Текст [/B][/FONT][/SIZE][/CENTER]<br>" +
"[CENTER][SIZE=3][FONT=times new roman][B][IMG]https://i.postimg.cc/9FPsW7YM/image.png[/IMG][/CENTER]<br>" +
'[CENTER][COLOR=#FF0000]Закрыто.[/COLOR] [/FONT][/SIZE][/CENTER]<br>',
    },
     {
...
"[CENTER][SIZE=3][FONT=times new roman][B][IMG]https://i.postimg.cc/9FPsW7YM/image.png[/IMG][/CENTER]<br>" +
'[CENTER][COLOR=#FFFF00]На рассмотрении[/COLOR]. [/FONT][/SIZE][/CENTER]<br>',
       prefix: PINN_PREFIX,
      status: true,
    },
{
                    title: '._________________________Ответы на жалобы на Лидера__________________________.',
},
       {
                        	  title: 'Беседа с лд',
	  content:
...
"[CENTER][B]Приветствую уважаемый(- ая) [COLOR=rgb(243, 121, 52)]{{ user.mention }}[/COLOR]. [/CENTER]<br>" +
"[CENTER] [IMG]https://i.postimg.cc/9FPsW7YM/image.png[/IMG][/B][/FONT][/SIZE][/CENTER]<br>" +
"[CENTER][SIZE=3][FONT=times new roman][B]Данный игрок больше не является лидером. [/B][/FONT][/SIZE][/CENTER]<br>" +
"[CENTER][SIZE=3][FONT=times new roman][B][IMG]https://i.postimg.cc/9FPsW7YM/image.png[/IMG][/CENTER]<br>" +
...
"[CENTER][SIZE=3][FONT=times new roman][B][IMG]https://i.postimg.cc/9FPsW7YM/image.png[/IMG][/CENTER]<br>" +
        '[CENTER][COLOR=#FF0000]Закрыто. [/color][/FONT][/SIZE][/CENTER]',
	      prefix: CLOSE_PREFIX,
      status: false,
    },
     {
...
"[CENTER][SIZE=3][FONT=trebuchet ms][B][IMG]https://i.postimg.cc/9FPsW7YM/image.png[/IMG][/CENTER]<br>" +
        "[CENTER][COLOR=rgb(255, 0, 0)]Отказано[/COLOR], Закрыто. [/FONT][/SIZE][/CENTER]<br>" +
'[RIGHT][SIZE=3][FONT=trebuchet ms][B]С уважением Администрация сервера [COLOR=#008000]PSKOV.[/COLOR][/B][/FONT][/SIZE][/RIGHT]',
	      prefix: CLOSE_PREFIX,
      status: false,
    },
];
