...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/15833/Theme%20Noel.user.js
// @updateURL https://update.greasyfork.org/scripts/15833/Theme%20Noel.meta.js
// ==/UserScript==
$('#logo img').remove();
$('#logo').append('<a href="http://rootflash.fr/"><span></span><img src="http://i.imgur.com/Y1mjeUZ.png" width="170" height="120" alt="Logo du forum sur les jeux vidéos ROOTFLASH"></a>')
