// ==UserScript==
// @name         WME Overlay GA Cherockee Co Parcels
...
// @downloadURL https://update.greasyfork.org/scripts/26465/WME%20Overlay%20GA%20Cherockee%20Co%20Parcels.user.js
// @updateURL https://update.greasyfork.org/scripts/26465/WME%20Overlay%20GA%20Cherockee%20Co%20Parcels.meta.js
// ==/UserScript==
...
(function() {
    ...
    var _settingsStoreName = 'wme_us_GA_cherockeeCo_boundaries';
    ...
    function getUrl(extent, zoom) {
        ...
        var url = 'http://gis.cherokeega.com/arcgis/rest/services/TaxParcelsNew/MapServer/6/query?geometry=' + encodeURIComponent(geometryStr);  //must be https:// //
        ...
        //url += '&outFields=' + encodeURIComponent('PropAddr_HouseNumber');
        url += '&outFields=' + encodeURIComponent('CompleteAddress');
    ...
    function processStateBorders(states) {
        ...
        states.forEach(function(state) {
            var attributes = {
                //name: state.attributes.PropAddr_HouseNumber
                name: state.attributes.CompleteAddress
            };
    ...
    function initLayer(){
        ...
        _mapLayer = new OpenLayers.Layer.Vector("Overlay - GA Cherockee Co Parcels", {
            uniqueName: "__WMEUSGACHCOpar",
        ...
        I18n.translations.en.layers.name.__FCLayer = "US GA CherockeeCo Boundaries";
