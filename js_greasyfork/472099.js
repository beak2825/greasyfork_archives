// ==UserScript==
// @name   Forum Curators |  Khabarovsk
// @name:ru Кураторы форума | Khabarovsk
...
// @downloadURL https://update.greasyfork.org/scripts/472099/Forum%20Curators%20%7C%20%20Khabarovsk.user.js
// @updateURL https://update.greasyfork.org/scripts/472099/Forum%20Curators%20%7C%20%20Khabarovsk.meta.js
// ==/UserScript==
...
const buttons = [
     {
      title: 'Приветствие',
      content: '[FONT=Courier New][CENTER]{{ greeting }}, уважаемый {{ user.name }}..[/CENTER]<br>' + '[CENTER]  [/CENTER][/FONT]',
    },
     {
 ...
 title: '╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴Правила Role Play процесса ╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴╴',
    },
    {
      ...
      content:
        ...
        '[Color=rgb(65, 105, 225)][FONT=Georgia][CENTER][I]{{ greeting }}, уважаемый {{ user.name }}.[/color][/CENTER]<br>' +
        ...
        '[CENTER][B][SIZE=4][FONT=times new roman]Приятной игры на [/FONT][FONT=courier new]Black Russia[/FONT] [/SIZE][COLOR=rgb(65, 105, 225)][SIZE=4][FONT=courier new]Khabarovsk[/FONT][/SIZE][/COLOR][COLOR=rgb(65, 105, 225)][SIZE=4][FONT=courier new]![/FONT][/SIZE][/COLOR][/B][/CENTER]<br><br>' +
