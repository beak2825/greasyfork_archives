...
// @run-at       context-end
// @license      GPL v3
// @downloadURL https://update.greasyfork.org/scripts/439617/BiliBili%20%E6%B6%88%E6%81%AF%E6%B8%85%E7%90%86%E5%8A%A9%E6%89%8B%EF%BC%88%E7%A7%81%E4%BF%A1%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/439617/BiliBili%20%E6%B6%88%E6%81%AF%E6%B8%85%E7%90%86%E5%8A%A9%E6%89%8B%EF%BC%88%E7%A7%81%E4%BF%A1%EF%BC%89.meta.js
// ==/UserScript==
...
(async function() {
  ...
  const clean = async () => {
    let deleteButton = document.querySelector("div.list-item:not(.top) .close");
    ...
    while (isActive && !isEmpty(deleteButton)) {
      ...
      deleteButton = document.querySelector("div.list-item:not(.top) .close");
  ...
  const init = () => {
    if (
      activeMenu &&
      (
        activeMenu.href.indexOf("whisper") > -1)
    ) {
      if (!actionButton) {
        createActionButton();
      } else {
  ...
  const load = async () => {
    ...
    while (isEmpty(activeMenu)) {
      ...
      activeMenu = document.querySelector(".router-link-active");
