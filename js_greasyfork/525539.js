// ==UserScript==
// @name         Скрипт для Куратора администрации || Penza
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/525539/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20%7C%7C%20Penza.user.js
// @updateURL https://update.greasyfork.org/scripts/525539/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D0%B0%D0%B4%D0%BC%D0%B8%D0%BD%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D0%B8%20%7C%7C%20Penza.meta.js
// ==/UserScript==
...
const buttons = [
               ...
               },
    {
	  ...
	  content:
        "[CENTER][FONT=verdana][B][SIZE=4]Здравствуйте ува[/SIZE][/B][SIZE=4]жаем[B]ый игрок.[/B][/SIZE]<br><br>" +
        '[SIZE=4][FONT=verdana]Передано [COLOR=rgb(255, 0, 0)]Главному Администратору[/COLOR] - @Evgeniy_Lorenzo ღ.[/FONT][/SIZE]<br>' +
		"<br>"+
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/FONT][/B][FONT=verdana] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
               ...
               },
    {
	  ...
	  content:
        "[CENTER][FONT=verdana][B][SIZE=4]Здравствуйте ува[/SIZE][/B][SIZE=4]жаем[B]ый игрок.[/B][/SIZE]<br><br>" +
        '[SIZE=4][FONT=verdana]Передано [COLOR=rgb(255, 0, 0)]Заместителям Главного Администратора[/COLOR] - @Denis Savinov ღ.[/FONT][/SIZE]<br><br>' +
        "[FONT=verdana][B][SIZE=4][COLOR=white][I]С уважением[/I][/COLOR][/SIZE][/B] [SIZE=4][COLOR=rgb(200, 0, 200)][B][I]Куратор администрации.[/I][/B][/COLOR][/SIZE][/FONT][/CENTER]<br>",
