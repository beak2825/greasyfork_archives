// ==UserScript==
// @name         DouyinWebSign
// @namespace    douyin-web-sign
// @version      1.0.0
// @description  DouyinWebSign Utils
...
var DouyinWebSign = (function (exports) {
    ...
    function getABogus(url, user_agent) {
        if (url.includes('https://')) {
            url = new URLSearchParams(new URL(url).search).toString()
        }
        !user_agent ? user_agent = navigator.userAgent : user_agent
        return generate_a_bogus(url, user_agent)
    }

    function getVerifyFp() {
        var e = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("")
        , t = e.length
        , r = new Date().getTime().toString(36)
        , n = [];
    ...
    exports.getVerifyFp = getVerifyFp;
