// ==UserScript==
// @description de-sponsors 2
// @name        de-sponsors Click4Win Automaizer
// @version     1.5
// @date        2012-10-20
// @author      mleha (mleha@xakep.ru)
// @include     http://*/login.php?page=klick4win*
// @include     http://*/klick4wingoto.php?k4csid=*
// @include     http://*/login.php?page=klick4win*
...
// @downloadURL https://update.greasyfork.org/scripts/35539/de-sponsors%20Click4Win%20Automaizer.user.js
// @updateURL https://update.greasyfork.org/scripts/35539/de-sponsors%20Click4Win%20Automaizer.meta.js
// ==/UserScript==
...
function tryGetLink(){
	...
	if (s.indexOf(SITE+'/login.php?page=klick4win&navaction=textlinks')>0) {
		var tx=getContText();
		var cont = eval(tx);
	...
	if (s.indexOf(SITE+'/login.php?page=klick4win')>0) {
		var tx=getContText();
		var cont = eval(tx);
		var MyLinks="<div style=\"text-align:center\">";
	...
	if (s.indexOf(SITE+'/klick4wingoto.php?k4csid=')>0){
...
function opensurfbanner(){
	...
	var regE = /<a href=\"klick4wingoto.php[^>]+><img[^>]+><\/a>/gi;
	...
	//-------------start click text
	var regE2 = /<a href=\"klick4wingoto.php[^>]+>[^<]+<\/a>/gi;
...
function prepareLinks(){
	var inText = new String(document.body.innerHTML);
	var regE = /<a href=\"klick4wingoto.php[^>]+>[^>]+?<\/a>/gi;
	var n=1;
	while((find = regE.exec(inText)) != null) {
		BannerArr[n]=find;
		n+=1;
