// ==UserScript==
// @name минск шенген иные рандом даты
// @namespace минск шенген иные рандом даты
// @description минск шенген иные рандом даты.
...
// @grant GM_getValue
// @grant unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/16310/%D0%BC%D0%B8%D0%BD%D1%81%D0%BA%20%D1%88%D0%B5%D0%BD%D0%B3%D0%B5%D0%BD%20%D0%B8%D0%BD%D1%8B%D0%B5%20%D1%80%D0%B0%D0%BD%D0%B4%D0%BE%D0%BC%20%D0%B4%D0%B0%D1%82%D1%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/16310/%D0%BC%D0%B8%D0%BD%D1%81%D0%BA%20%D1%88%D0%B5%D0%BD%D0%B3%D0%B5%D0%BD%20%D0%B8%D0%BD%D1%8B%D0%B5%20%D1%80%D0%B0%D0%BD%D0%B4%D0%BE%D0%BC%20%D0%B4%D0%B0%D1%82%D1%8B.meta.js
// ==/UserScript==
  ...
  if(lastValue != -1 && typeof(lastValue) != 'undefined'){
   ...
   $('<input name="ctl00$cp$btnRezerwuj" value="Зарегистрироваться">').attr('type','hidden').appendTo('#form1');
     ...
     setTimeout(function() {$("#form1").submit();}, 1);
        ...
        location.href = "https://by.e-konsulat.gov.pl/Uslugi/RejestracjaTerminu.aspx?IDUSLUGI=8&IDPlacowki=94";
   return;
    }
 } else if ($('#cp_lblBrakTerminow').text().length > 0) {
 	document.title = "Неудача " + $('#cp_lblBrakTerminow').text();
 	setTimeout(function() {location.href = "https://by.e-konsulat.gov.pl/Uslugi/RejestracjaTerminu.aspx?IDUSLUGI=8&IDPlacowki=94";}, 1500);
 	return;
