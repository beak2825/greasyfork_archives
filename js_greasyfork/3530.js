...
// @history        2014-07-04 - v0.6 - i.polyakov
//					* В связи с обновлением до Firefox 30.0 перестали работать методы GM_getValue, GM_setValue. @grant не помогло, поэтому воспользовался localStorage.
//					* Добавлен стиль для ограничения списка файлов.
...
// @downloadURL https://update.greasyfork.org/scripts/3530/Task%20tracker%20tweak.user.js
// @updateURL https://update.greasyfork.org/scripts/3530/Task%20tracker%20tweak.meta.js
// ==/UserScript==
...
unsafeWindow.comment_textarea_init = function(comment_textarea) {
	...
	var comment_content = localStorage.getItem(name);
	if (comment_content)
