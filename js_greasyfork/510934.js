...
// @run-at             document-end
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/510934/nHentai%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/510934/nHentai%20Helper.meta.js
// ==/UserScript==
...
${EXPORT_HEADER_TITLE_PRETTY}${prettyTitles.join(EXPORT_SEPARATOR)}`;
        ...
        setup(__props, { expose: __expose }) {
          ...
          return (_ctx, _cache) => {
            return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElDialog), {
              ...
              "onUpdate:modelValue": _cache[26] || (_cache[26] = ($event) => show.value = $event),
              center: true,
              top: "50px"
            }, {
                      ...
                      vue.createVNode(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElSwitch), {
                            ...
                            "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => vue.unref(writeableSettings).galleryContextmenuPreview = $event)
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      }, 8, ["label"]),
                      vue.createVNode(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElCheckbox), {
                            ...
                            "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => vue.unref(writeableSettings).judgeDownloadedByEnglish = $event),
                            label: vue.unref(t2)("common.english")
                          }, null, 8, ["modelValue", "label"]),
                          vue.createVNode(vue.unref(elementPlus.ElCheckbox), {
                            modelValue: vue.unref(writeableSettings).judgeDownloadedByJapanese,
                            "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => vue.unref(writeableSettings).judgeDownloadedByJapanese = $event),
                            label: vue.unref(t2)("common.japanese")
                          }, null, 8, ["modelValue", "label"]),
                          vue.createVNode(vue.unref(elementPlus.ElCheckbox), {
                            modelValue: vue.unref(writeableSettings).judgeDownloadedByPretty,
                            "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => vue.unref(writeableSettings).judgeDownloadedByPretty = $event),
                      ...
                      vue.createVNode(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElCheckboxGroup), {
                            ...
                            "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => vue.unref(writeableSettings).addMetaFile = $event)
                          }, {
                            default: vue.withCtx(() => [
                              vue.createVNode(vue.unref(elementPlus.ElCheckbox), {
                                label: "ComicInfo.xml",
                      ...
                      vue.unref(writeableSettings).addMetaFile.includes("ComicInfoXml") ? (vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElSelect), {
                            ...
                            "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => vue.unref(writeableSettings).metaFileTitleLanguage = $event)
                          }, {
                            default: vue.withCtx(() => [
                              vue.createVNode(vue.unref(elementPlus.ElOption), {
                                label: vue.unref(t2)("common.english"),
                      ...
                      vue.unref(IS_NHENTAI) ? (vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElSelect), {
                            ...
                            "onUpdate:modelValue": _cache[20] || (_cache[20] = ($event) => vue.unref(writeableSettings).nHentaiDownloadHost = $event),
                      ...
                      vue.createVNode(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElInput), {
                            ...
                            "onUpdate:modelValue": _cache[21] || (_cache[21] = ($event) => vue.unref(writeableSettings).customDownloadUrl = $event)
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      }, 8, ["label"]),
                      vue.createVNode(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElSwitch), {
                            ...
                            "onUpdate:modelValue": _cache[22] || (_cache[22] = ($event) => vue.unref(writeableSettings).compressionStreamFiles = $event)
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      }, 8, ["label"]),
                      vue.createVNode(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElSwitch), {
                            ...
                            "onUpdate:modelValue": _cache[23] || (_cache[23] = ($event) => vue.unref(writeableSettings).seriesMode = $event)
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      }, 8, ["label"]),
                      vue.createVNode(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElSwitch), {
                            ...
                            "onUpdate:modelValue": _cache[24] || (_cache[24] = ($event) => vue.unref(writeableSettings).streamDownload = $event),
                      ...
                      vue.unref(IS_NHENTAI) ? (vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElFormItem), {
                        ...
                        default: vue.withCtx(() => [
                          vue.createVNode(vue.unref(elementPlus.ElSwitch), {
                            ...
                            "onUpdate:modelValue": _cache[25] || (_cache[25] = ($event) => vue.unref(writeableSettings).preventConsoleClearing = $event)
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      }, 8, ["label"])) : vue.createCommentVNode("", true),
      ...
      const SettingsDialog = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-af333a79"]]);
...
(function() {
    ...
    downloadAllBtn.innerText = '批量下載';
    downloadAllBtn.style.position = 'fixed';
    downloadAllBtn.style.bottom = '20px';
    ...
    downloadAllBtn.style.zIndex = '10000';
    document.body.appendChild(downloadAllBtn);

    // 點擊按鈕後執行批量下載
    downloadAllBtn.addEventListener('click', () => {
        let downloadButtons = Array.from(document.querySelectorAll('.download-zip-btn')); // 替換為實際的按鈕類名
        ...
        let completed = 0;
        let retryQueue = []; // 儲存下載失敗的按鈕
        downloadAllBtn.innerText = `批量下載 (${completed}/${downloadButtons.length})`; // 顯示進度

        // 定義下載與重試函數
        const downloadWithRetry = (btn, index, retries = 0, delay = 500) => {
            setTimeout(() => {
                try {
                    btn.click(); // 模擬下載按鈕點擊
                    completed++;
                    downloadAllBtn.innerText = `批量下載 (${completed}/${downloadButtons.length})`; // 更新進度
                } catch (error) {
                    console.error(`下載失敗: ${btn}`, error);
                    if (retries < 3) { // 最大重試次數設定為3次
                        retryQueue.push({ btn, retries: retries + 1 });
                    }
                }

                // 若下載序列完成且存在重試隊列，開始重試
                if (index === downloadButtons.length - 1 && retryQueue.length > 0) {
                    downloadButtons = retryQueue.slice(); // 將重試隊列放入下載隊列
                    retryQueue = []; // 清空重試隊列
                    completed = 0; // 重設進度計數
                    downloadButtons.forEach((item, idx) => downloadWithRetry(item.btn, idx, item.retries, 1000)); // 重試下載失敗項，延遲時間可調
                }
            }, index * delay);
        };

        // 開始下載初次的下載按鈕
        downloadButtons.forEach((btn, index) => downloadWithRetry(btn, index));
    });
})();
