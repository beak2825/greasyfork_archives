// ==UserScript==
// @name         Simple Global CPS Autoclicker (R/F + ALT+M)
...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/559154/Simple%20Global%20CPS%20Autoclicker%20%28RF%20%2B%20ALT%2BM%29.user.js
// @updateURL https://update.greasyfork.org/scripts/559154/Simple%20Global%20CPS%20Autoclicker%20%28RF%20%2B%20ALT%2BM%29.meta.js
// ==/UserScript==
...
(function () {
    ...
    function dispatchClickAtCursor(buttonType) {
        ...
        // For right click, also contextmenu on many pages
        if (buttonType === 2) {
    ...
    function createPopup() {
        ...
        // Prevent key events inside popup from triggering shortcuts
    ...
    console.log('[Autoclicker] Loaded. R = left, F = right, ALT+M = CPS popup (1–' + MAX_CPS + ').');
})();
