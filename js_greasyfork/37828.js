...
// @downloadURL https://update.greasyfork.org/scripts/37828/ScrapTF%20Raffle%20Killer.user.js
// @updateURL https://update.greasyfork.org/scripts/37828/ScrapTF%20Raffle%20Killer.meta.js
// ==/UserScript==
    ...
    function openRaffle(i){
        ...
        if (i !== document.getElementsByClassName("panel-raffle").length){
            if (document.getElementsByClassName("panel-raffle")[i].style.opacity == ""){
                ...
                setTimeout(function(){ openRaffle(newI); }, 4000 + Math.floor((Math.random() * 2000) + 1));
            } else {
                openRaffle(newI);
            }
        }
