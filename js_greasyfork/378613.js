...
// @exclude      http://www.neopets.com/charitycorner/2019/*
// @run-at       document-body
// @grant        GM_addStyle
// @require      http://code.jquery.com/jquery-3.3.1.min.js
// @namespace    https://greasyfork.org/users/248719
// @author       http://twitter.com/RotomDex
// @downloadURL https://update.greasyfork.org/scripts/378613/Neopets%3A%20Custom%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/378613/Neopets%3A%20Custom%20Theme.meta.js
// ==/UserScript==
...
addGlobalStyle('#content {min-height:695px !important}');
/*Header Stuff
addGlobalStyle('ul.dropdown {border: 1px solid #000000;background-color: #989898;}'
               ...
               +'#nst {color: #000000;}');*/
//Footer stuff
addGlobalStyle('img.footerNifty {visibility:hidden !important;}'
               +'.newPetImg {position:absolute; bottom:0px; right:0px; z-index:99; overflow:hidden;}'
               /*+'.footerForm {color: #B0B3B9;}'
...
if(url.includes('market_your.phtml')){
    addGlobalStyle('td.content form table{margin-left:auto; margin-right:auto}')}
...
if(noPremium === true){
    addGlobalStyle('#content {min-height:714px !important}');
    // Bank
