...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/522761/Hunter%20Stumblechat%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/522761/Hunter%20Stumblechat%20Script.meta.js
// ==/UserScript==
let webSocket;
...
function isUserBanned(username) {
    // Retrieve the allow list from browser cache
    ...
    // Check if the lowercase username is in the allow list (also converted to lowercase)
    ...
    if (!isAllowed) {
        // If the user is not allowed (not in the allow list), send a ban message to the WebSocket server
