...
// @grant        none
// @license    MIT
// @version 0.0.1.20250425143230
// @downloadURL https://update.greasyfork.org/scripts/533949/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%84.user.js
// @updateURL https://update.greasyfork.org/scripts/533949/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%84.meta.js
// ==/UserScript==
...
(function () {
  ...
  const RASMOTRENIE = 17 // На рассмотрении
...
const buttons = [
{
	  ...
	  content:
        ...
        "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>"+
                "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]RYAZAN[/COLOR].<br><br>",
},
{
...
{
                	  title: '| Био промежуток (Рассмотрение) |',
	  content:
	    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=red][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
		"[B][CENTER][COLOR=white][FONT=courier new] Ваша Биография получает статус - [COLOR=#FF0000]На доработке[/COLOR]<br><br>"+
                 "[B][CENTER][COLOR=white][FONT=courier new]Смените заголовок темы на имя фамилия в родительном падеже. Пример: Скай Полкановой. <br>"+
                "[B][CENTER][COLOR=white][FONT=courier new]Так же убедительная просьба ознакомиться с правилами подачи Биографий, закрепленные в данном разделе.<br>"+
                '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
		"[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=indigo]RYAZAN[/COLOR].<br><br>",
     prefix: NARASSMOTRENIIRP_PREFIX,
	  status: false,
