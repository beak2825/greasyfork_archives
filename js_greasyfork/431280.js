// ==UserScript==
// @name         Edit for BluePhantom
// @namespace    http://tampermonkey.net/
// @version      0.1
// @icon         https://surviv.io/favicon.ico
// @description  Some changed for BluePhantom
// @author       [SPT]Cream_onYT
 
 
// Extra Information
// Made by: [SPT]Cream_onYT
// For: surviv.io
...
// @downloadURL https://update.greasyfork.org/scripts/431280/Edit%20for%20BluePhantom.user.js
// @updateURL https://update.greasyfork.org/scripts/431280/Edit%20for%20BluePhantom.meta.js
// ==/UserScript==
// <==========GUN_HUD==========> \\
(function() {
    'use strict';
...
const runScripts = () => {
    ...
    sp.innerHTML = `Player:𝔹𝕃𝕦𝕖ℙ𝕙𝕒𝕟𝕥𝟘𝕞`;
    a.appendChild(sp);
    ...
    let xd = document.createElement(`span`);
    xd.innerHTML = `Join TM please`;
    c.appendChild(xd);
 
    let d = document.querySelector(`#numWrapper`);
    document.querySelector(`#ui-bottom-center-0`).insertBefore(c, d);
}
...
if(window.location.href.includes("stats")){
    ...
    document.getElementById("background").style = "filter:brightness(50%);background-image:url(https://cdn.discordapp.com/attachments/844127430477086762/879368403201175633/unknown.png);";
