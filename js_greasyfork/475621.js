...
// @downloadURL https://update.greasyfork.org/scripts/475621/JAV%20%E6%B7%BB%E5%8A%A0%E8%B7%B3%E8%BD%AC%E5%9C%A8%E7%BA%BF%E8%A7%82%E7%9C%8B%20Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/475621/JAV%20%E6%B7%BB%E5%8A%A0%E8%B7%B3%E8%BD%AC%E5%9C%A8%E7%BA%BF%E8%A7%82%E7%9C%8B%20Mod.meta.js
// ==/UserScript==
...
(function (preact) {
  ...
  const libSites = [
    ...
    },
    {
      name: "javbus",
      enable: true,
      href: /^https?:\/\/(\w*\.)?(javbus|seejav|javsee)*\.(com|co|me|life|bid).*$/,
      querys: {
  ...
  const siteList = [
    ...
    {
      name: "MISSAV_",
      hostname: "missav789.com",
      url: "https://missav789.com/{{code}}/",
      fetchType: "get",
      domQuery: {
        // 标签区的第一个一般是字幕标签
        subQuery: '.space-y-2 a.text-nord13[href="https://missav789.com/chinese-subtitle"]',
        // 有个「切換無碼」按钮，藏在分享按钮旁边……
        leakQuery: ".order-first div.rounded-md a[href]:last-child",
      },
    },
    ...
    },
    {
      ...
      url: "https://www4.bestjavporn.com/search/{{code}}",
      fetchType: "parser",
      domQuery: {
    ...
    {
      name: "JAVMENU",
      hostname: "javmenu.one",
      url: "https://javmenu.one/{{code}}",
      fetchType: "get",
      domQuery: {
    ...
    {
      name: "18av",
      hostname: "maa1828.com",
      url: "https://maa1828.com/zh/fc_search/all/{{code}}/1.html",
      fetchType: "parser",
      domQuery: {
    ...
    },
    {
      ...
      hostname: "javdb523.com",
      url: "https://javdb523.com/search?q={{code}}",
      fetchType: "parser",
      domQuery: {
    ...
    },
    {
      ...
      hostname: "k72s.com",
      url: "https://www.k72s.com/cn/vl_searchbyid.php?keyword={{code}}",
      fetchType: "parser",
      domQuery: {
