// ==UserScript==
// @name         anime1.me收藏番剧（交互优化版）
// @namespace    http://tampermonkey.net/
// @version      0.3.3
// @license      MPL-2.0
// @description  添加了收藏番剧功能（来自@c4r的脚本）优化了UI和交互，去除了广告，增加了自动简繁转换功能
// @author       c4r feat.皮蛋萌
// @match        *://anime1.me/*
// @grant        none
// @require      https://code.jquery.com/jquery-latest.js
// @downloadURL https://update.greasyfork.org/scripts/381478/anime1me%E6%94%B6%E8%97%8F%E7%95%AA%E5%89%A7%EF%BC%88%E4%BA%A4%E4%BA%92%E4%BC%98%E5%8C%96%E7%89%88%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/381478/anime1me%E6%94%B6%E8%97%8F%E7%95%AA%E5%89%A7%EF%BC%88%E4%BA%A4%E4%BA%92%E4%BC%98%E5%8C%96%E7%89%88%EF%BC%89.meta.js
// ==/UserScript==
...
(function () {
    ...
    $(".search-form").submit(function(){
        //console.log($(this).children('label').children('.search-field')[0])
        $(this).children('label').children('.search-field')[0].value = s2t($(this).children('label').children('.search-field')[0].value)
    });
    ...
    function addPlaylist(title, url) {
        ...
        if (strPlaylist.includes('title :' + title + ' url :' + url)) {
            ...
            $("#menu-subscribe").attr('value',"订阅");
        } else {

            strPlaylist = strPlaylist + 'title :' + title + ' url :' + url + '\r\n'
            localStorage.setItem('anime1Playlist', strPlaylist)
            // location.reload()
            $('#subscribe > ul').append('<li title="'+title+'" style="display: flex;">\
                <a unsubscribed url="'+
                url + '" name="' + title + '" title="退订">[x] </a>\
                <a href='+
                url + '> ' + title + '</a>\
                </li>')
            $("#menu-subscribe").attr('value',"退订");
        }
    }
    ...
    function showPlaylist() {
        ...
        arrayPlaylist.forEach(item => {
            $('#subscribe > ul').append('<li title="'+item.title+'" style="display: flex;">\
            <a unsubscribed url="'+
                item.url + '" name="' + item.title + '" title="退订">[x] </a>\
            <a href='+
    ...
    $(document).ready(function () {
        ...
        if ($('footer span.cat-links').length > 0) {
            ...
            // 添加订阅按钮
            $('<section class="widget widget_search"><input id="menu-subscribe" type="submit" class="search-submit" value="'+value+'"></section>').insertBefore($('#recent-posts-6'))
        ...
        $(document).on('click', 'a[unsubscribed]', (event) => {
            ...
            if(title == $('footer span.cat-links:eq(0) > a').text()){$("#menu-subscribe").attr('value',"订阅");}
            delSub(title, url)
            // location.reload()
