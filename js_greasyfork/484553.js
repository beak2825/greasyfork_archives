// ==UserScript==
// @name AudioBookBay hide category: History
// @description Hide History category
...
// @downloadURL https://update.greasyfork.org/scripts/484553/AudioBookBay%20hide%20category%3A%20History.user.js
// @updateURL https://update.greasyfork.org/scripts/484553/AudioBookBay%20hide%20category%3A%20History.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'History'
    $(".post").has(".postInfo:contains('History')").hide();
});
