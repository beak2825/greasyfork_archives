// ==UserScript==
// @name         AI Chat to Microsoft Word & Markdown FORK
...
// @downloadURL https://update.greasyfork.org/scripts/562153/AI%20Chat%20to%20Microsoft%20Word%20%20Markdown%20FORK.user.js
// @updateURL https://update.greasyfork.org/scripts/562153/AI%20Chat%20to%20Microsoft%20Word%20%20Markdown%20FORK.meta.js
// ==/UserScript==
        ...
        answers.forEach((answer, index) => {
            ...
            if (index === answers.length - 1) {
                if (!container.querySelector('.sep-all')) {
                    ...
                    container.appendChild(createButton('Copy MD All', (e) => copyMarkdownToClipboard(getCombinedNode(), e.target)));
                }
            }
        });
    }
