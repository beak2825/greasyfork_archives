...
// @downloadURL https://update.greasyfork.org/scripts/522472/%E8%87%AA%E7%94%A8%E6%B5%8B%E8%AF%95.user.js
// @updateURL https://update.greasyfork.org/scripts/522472/%E8%87%AA%E7%94%A8%E6%B5%8B%E8%AF%95.meta.js
// ==/UserScript==

var max_rewards = 40; //重复执行的次数
var simulation = 10; // 在前simulation次搜索中使用特定的User-Agent
    ...
    while (current_source_index < keywords_source.length) {
        ...
        try {
            const response = await fetch("https://api.gumengya.com/Api/" + source, {
                headers: {
                    'User-Agent': currentSearchCount < simulation ? 
                        'Mozilla/5.0 (Linux; Android 9; SM-G960U Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.87 Mobile Safari/537.36' :
                        navigator.userAgent
                }
            }); // 发起网络请求
            if (!response.ok) {
