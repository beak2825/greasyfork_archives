// ==UserScript==
// @name         Luv-Burrito Theme
// @namespace    http://tampermonkey.net/
// @version      1
// @description  Subscribe to B-Go and Luv-Burrito
// @author       B-GO
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/440441/Luv-Burrito%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/440441/Luv-Burrito%20Theme.meta.js
// ==/UserScript==
...
* {
	...
	--ss-lightoverlay: url("https://cdn.discordapp.com/attachments/938295753279930408/945586660089921596/Image.7.PNG"); /*Main Background*/
...
#maskmiddle {
	background: url('https://cdn.discordapp.com/attachments/938295753279930408/945587581058441296/images_8.png') center center no-repeat;
...
#best_streak_container h1 {
    ...
    background-image: url('https://cdn.discordapp.com/attachments/938295753279930408/945588166851690496/download__17_-removebg-preview.png');
...
.egg_icon {
    ...
    content: url(https://cdn.discordapp.com/attachments/938295753279930408/945588683539632178/download__18_-removebg-preview.png);
}
