// ==UserScript==
// @name                BETA-WME Validator North Carolina Localization
// @namespace           https://greasyfork.org/users/6285
// @version             2023.03.28.00
// @author              s18slider
// @description         This is the BETA script to localize WME Validator for North Carolina, USA. You also need main package (WME Validator) installed.  THIS SCRIPT MAY HAVE ERRORS AS IT IS FOR TESTING!
// @match               https://beta.waze.com/*editor*
// @match               https://www.waze.com/*editor*
// @exclude             https://www.waze.com/*user/*editor/*
// @grant               none
// @run-at              document-start
// @icon                data:image/png;base64,
// @downloadURL https://update.greasyfork.org/scripts/17614/BETA-WME%20Validator%20North%20Carolina%20Localization.user.js
// @updateURL https://update.greasyfork.org/scripts/17614/BETA-WME%20Validator%20North%20Carolina%20Localization.meta.js
// ==/UserScript==
//
/*
Updated to translate US English language in WME - 31Mar2017
*/
...
window.WME_Validator_United_States = {
  ...
  ".author": "s18slider",
  ".updated": "2021-02-26",
  ".link": "https://greasyfork.org/en/scripts/17614-test-wme-validator-north-carolina-localization",
  ".lng": "EN-US",
  ...
  "163.params": {
    "titleEN": "Bad Ramp Name",
    "problemEN": "Ramp Name has been identified as incorrect.",
    "solutionEN": "'Exit:' and 'Exit to' should not be used. Change the name to say 'Exit ###:' or 'to'",
    "regexp": ".*\\b(Exit: |Exit to )\\b/i"
  },
  "163.title.en": "Bad Ramp Name",
  "163.title": "Bad Ramp Name",
  "163.problem.en": "Ramp Name has been identified as incorrect.",
  "163.problem": "Ramp Name has been identified as incorrect.",
  "163.solution.en": "'Exit:' and 'Exit to' should not be used. Change the name to say 'Exit ###:' or 'to'",
  "163.solution": "'Exit:' and 'Exit to' should not be used. Change the name to say 'Exit ###:' or 'to'",
  "170.enabled": true,
  "170.params": {
  ...
  "129.enabled": true,
  "129.solutionLink": "W:North_Carolina#Road_Names",
  "129.params": {
    "titleEN": "Bad NC Secondary Road Name",
    "problemEN": "NC Secondary Road Name isn't correct.",
    "solutionEN": "Correct the NC Secondary Road Name (SR-####) (refer to NC wiki).",
    "template": "${state}:${street}#${altStreet[#]}#`",
    "regexp": "/^North Carolina:.*\\b(?:(NC-|SR |CR |CR-|Co Rd |County Rd |County Road |State Rd |State Road |State Rte )[0-9]{4,})\\b/i"
  },
  "129.solutionLink": "W:North_Carolina#Road_Names",
  "129.title.en": "Bad NC Secondary Road Name",
  "129.title": "Bad NC Secondary Road Name",
  "129.problem.en": "NC Secondary Road Name isn't correct.",
  "129.problem": "NC Secondary Road Name isn't correct.",
  "129.solution.en": "Correct the NC Secondary Road Name (SR-####) (refer to NC wiki).",
  "129.solution": "Correct the NC Secondary Road Name (SR-####) (refer to NC wiki).",
  "130.enabled": true,
  "130.params": {
    ...
    "solutionEN": "Change abbreviation to ALT, BUS, BYP, CONN, SCN, or SPUR in ALL CAPS",
    "template": "${street}#${altStreet[#]}#`",
    "regexp": "/!?[0-9].+(Alt|Business|Bus|Byp|Conn|Scn|Spur)\\b/"
  },
  "130.solutionLink": "",
  "130.title.en": "Potential Incorrect Abbreviation",
  "130.title": "Potential Incorrect Abbreviation",
  "130.problem.en": "Name abbreviation may be incorrect. Alternative routes should be labeled ALT and abbreviations ALT, BUS, BYP, CONN, LOOP, SCN, and SPUR should be in ALL CAPS",
  "130.problem": "Name abbreviation may be incorrect. Alternative routes should be labeled ALT and abbreviations ALT, BUS, BYP, CONN, LOOP, SCN, and SPUR should be in ALL CAPS",
  "130.solution.en": "Change abbreviation to ALT, BUS, BYP, CONN, SCN, or SPUR in ALL CAPS",
  "130.solution": "Change abbreviation to ALT, BUS, BYP, CONN, SCN, or SPUR in ALL CAPS",
  "131.enabled": true,
  "131.params": {
  ...
  "131.solutionLink": "W:North_Carolina#Roads",
  "131.title.en": "Wrong name on US Highway",
  "131.title": "Wrong name on US Highway",
  "131.problem.en": "All US highways should be named US-XXX",
  "131.problem": "All US highways should be named US-XXX",
  "131.solution.en": "Change name to US-XX and verify with GIS the highway name is correct.",
  "131.solution": "Change name to US-XX and verify with GIS the highway name is correct.",
  "132.enabled": true,
  "132.params": {
  ...
  "132.title.en": "Wrong name on state highway",
  "132.title": "Wrong name on state highway",
  "132.problem.en": "All state highways should be named NC-XXX in North Carolina",
  "132.problem": "All state highways should be named NC-XXX in North Carolina",
  "132.solution.en": "Change name to NC-XX and verify with GIS the highway name is correct.",
  "132.solution": "Change name to NC-XX and verify with GIS the highway name is correct.",
  "133.enabled": true,
  "133.params": {
  ...
  "133.title.en": "Wrong road type (Major)",
  "133.title": "Wrong road type (Major)",
  "133.problem.en": "All US Highways should be at least Major Highway (except BUS, SPUR, LOOP)",
  "133.problem": "All US Highways should be at least Major Highway (except BUS, SPUR, LOOP)",
  "133.solution.en": "Change the road type to Major Highway",
  "133.solution": "Change the road type to Major Highway",
  "134.enabled": true,
  "134.params": {
  ...
  "134.title.en": "Wrong road type (Minor)",
  "134.title": "Wrong road type (Minor)",
  "134.problem.en": "All US BUS, SPUR, LOOP Highways and all State Highways (except BUS, SPUR, LOOP) should be at least Minor Highway type",
  "134.problem": "All US BUS, SPUR, LOOP Highways and all State Highways (except BUS, SPUR, LOOP) should be at least Minor Highway type",
  "134.solution.en": "Change the road type to Minor Highway",
  "134.solution": "Change the road type to Minor Highway",
  "135.enabled": true,
  "135.params": {
  ...
  "135.title.en": "Wrong road type (Primary)",
  "135.title": "Wrong road type (Primary)",
  "135.problem.en": "All State BUS, SPUR, LOOP Highways should be at least Primary Street type",
  "135.problem": "All State BUS, SPUR, LOOP Highways should be at least Primary Street type",
  "135.solution.en": "Change the road type to Primary Street",
  "135.solution": "Change the road type to Primary Street",
  "136.enabled": true,
  "136.severity": "N",
  "136.params": {
    "titleEN": "One Way Segment Direction",
    "problemEN": "One Way Segment Direction set as B->A",
    "solutionEN": "Reverse One Way Segment Nodes and set direction as A->B",
    "template": "${direction}",
    "regexp": "/2/"
  },
  "136.solutionLink": "",
  "136.title.en": "One Way Segment Direction",
  "136.title": "One Way Segment Direction",
  "136.problem.en": "One Way Segment Direction set as B->A",
  "136.problem": "One Way Segment Direction set as B->A",
  "136.solution.en": "Reverse One Way Segment Nodes and set direction as A->B",
  "136.solution": "Reverse One Way Segment Nodes and set direction as A->B",
  "137.enabled": false,
  "137.params": {
    "titleEN": "Dirt Road Function Class",
    "problemEN": "Incorrect Function Class - Do not use Dirt Road / 4X4 Trail Function Class",
    "solutionEN": "Change Function Class and use Unpaved check box",
    "template": "${typeRank}",
    "regexp": "/^8$/"
  },
  "137.solutionLink": "",
  "137.title.en": "Dirt Road Function Class",
  "137.title": "Dirt Road Function Class",
  "137.problem.en": "Incorrect Function Class - Do not use Dirt Road / 4X4 Trail Function Class",
  "137.problem": "Incorrect Function Class - Do not use Dirt Road / 4X4 Trail Function Class",
  "137.solution.en": "Change Function Class and use Unpaved check box",
  "137.solution": "Change Function Class and use Unpaved check box",
  "138.enabled": true,
  "138.params": {
  ...
  "138.title.en": "User-defined custom check (green)",
  "138.title": "Bad TTS Street name",
  "138.problem.en": "Some of the segment properties matched against the user-defined regular expression (see Settings→Custom)",
  ...
  "167.enabled": true,
  "167.params": {
      "solutionEN": "Railroad Name should be set to None. Exceptions are: Blue Ridge Scenic Railway, Craggy Mountain Line, Great Smoky Mountains Railroad, and New Hope Valley Railway",
      "regexp": "!/(Blue Ridge Scenic Railway|Craggy Mountain Line|Great Smoky Mountains Railroad|New Hope Valley Railway)$/",
  },
  ...
  "167.solution.en": "Railroad Name should be set to None. Exceptions are: Blue Ridge Scenic Railway, Craggy Mountain Line, Great Smoky Mountains Railroad, and New Hope Valley Railway",
  "167.solution": "Railroad Name should be set to None. Exceptions are: Blue Ridge Scenic Railway, Craggy Mountain Line, Great Smoky Mountains Railroad, and New Hope Valley Railway",
  "174.enabled": true,
  "174.solutionLink": "W:North_Carolina#Roads",
  "174.params": {
    "titleEN": "Bad Street Name",
    "problemEN": "Street Name has been identified as incorrect.",
    "solutionEN": "Correct the street name, remove names dfa, nul, null, no street or US-29 ALT. US-29 ALT is not a valid highway in NC.",
    "template": "${state}:${street}#${altStreet[#]}#`",
    "regexp": "/^North Carolina:.*\\b(?:dfa|nul|null|no street|Unknown Name*|US-29 Alt)\\b/i"
//    "template": "${street}#${altStreet[#]}#`",
//    "regexp": "/(?:dfa|nul|null|no street|Unknown Name*|US-29 Alt)\\b/i"
  },
  "174.solutionLink": "",
  "174.title.en": "Bad Street Name",
  "174.title": "Bad Street Name",
  "174.problem.en": "Street Name has been identified as incorrect.",
  "174.problem": "Street Name has been identified as incorrect.",
  "174.solution.en": "Correct the street name, remove names dfa, nul, null, no street or US-29 ALT. US-29 ALT is not a valid highway in NC.",
  "174.solution": "Correct the street name, remove names dfa, nul, null, no street or US-29 ALT. US-29 ALT is not a valid highway in NC.",
};