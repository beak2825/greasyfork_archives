        ...
        <body>
            ...
            <script>
                ...
                function handlePerformanceAnalysis() {
                    ...
                    const analysisHeaders = ['關鍵字/ASIN', '等級', '支出', '曝光', '點擊', '訂單', 'CTR', 'CVR', 'ACoS', 'RoAS', '廣告建議'];
                    const resultsHTML = \`
                        <div class="card">
