...
// @icon         https://www.google.com/s2/favicons?sz=64&domain=buxcoin.io
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/498927/buxcoinio.user.js
// @updateURL https://update.greasyfork.org/scripts/498927/buxcoinio.meta.js
// ==/UserScript==
...
(function() {
  ...
  const email = '';
  const password = '';
  const redirectUrl = 'https://buxcoin.io/faucet';
  const timerRedirect = false;

  if (window.location.href.includes("/dashboard")) {
    window.location.href = 'https://buxcoin.io/faucet';
  }

  if (window.location.href === "https://buxcoin.io/" || window.location.href === "https://buxcoin.io") {
    window.location.href = "https://buxcoin.io/login";
  }
