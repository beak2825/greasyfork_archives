...
// @downloadURL https://update.greasyfork.org/scripts/507913/ST%20BOT%20v3.user.js
// @updateURL https://update.greasyfork.org/scripts/507913/ST%20BOT%20v3.meta.js
// ==/UserScript==
...
let intervalId4 = null;
  ...
  if (acceptdraw4Enabled) {
    let messages = [
    '42[10,'+ws.id+',[1,6,150,120,100,120]]',
    '42[10,' + ws.id + ',[1,6,100,120,100,170]]',
    '42[10,' + ws.id + ',[1,6,100,170,150,170]]',
    '42[10,' + ws.id + ',[1,6,150,170,150,220]]',
    '42[10,' + ws.id + ',[1,6,150,220,100,220]]',
    '42[10,' + ws.id + ',[5,"xFF0013"]]',
    '42[10,' + ws.id + ',[1,6,180,120,280,120]]',
    '42[10,' + ws.id + ',[1,6,230,120,230,220]]',
    '42[10,' + ws.id + ',[5,"x000000"]]',
    '42[10,' + ws.id + ',[1,6,310,120,310,220]]',
    '42[10,' + ws.id + ',[1,6,310,120,360,120]]',
    '42[10,' + ws.id + ',[1,6,360,120,360,170]]',
    '42[10,' + ws.id + ',[1,6,360,170,310,170]]',
    '42[10,' + ws.id + ',[1,6,335,170,360,220]]',
    '42[10,' + ws.id + ',[5,"xFF0013"]]',
    '42[10,' + ws.id + ',[1,6,390,120,390,220]]',
    '42[10,' + ws.id + ',[1,6,440,120,440,220]]',
    '42[10,' + ws.id + ',[1,6,390,120,440,120]]',
    '42[10,' + ws.id + ',[1,6,390,170,440,170]]',
    '42[10,' + ws.id + ',[5,"x000000"]]',
    '42[10,' + ws.id + ',[1,6,470,120,520,120]]',
    '42[10,' + ws.id + ',[1,6,470,170,520,170]]',
    '42[10,' + ws.id + ',[1,6,470,120,470,170]]',
    '42[10,' + ws.id + ',[1,6,520,120,520,220]]',
    '42[10,' + ws.id + ',[1,6,520,220,470,220]]',
    '42[10,' + ws.id + ',[5,"xFF0013"]]',
    '42[10,' + ws.id + ',[1,6,550,145,600,145]]',
    '42[10,' + ws.id + ',[1,6,550,205,600,205]]',
    '42[10,' + ws.id + ',[1,6,550,145,550,205]]',
    '42[10,' + ws.id + ',[1,6,600,145,600,205]]',
    '42[10,' + ws.id + ',[1,6,550,145,600,205]]',
    '42[10,' + ws.id + ',[5,"x000000"]]',
    '42[10,' + ws.id + ',[1,6,630,120,630,220]]',
    '42[10,' + ws.id + ',[1,6,680,120,680,220]]',
    '42[10,' + ws.id + ',[1,6,630,120,680,220]]',
...
.textx {
  ...
  font-size: 20px;
        ...
        #avatarlist {
            ...
            display:none;text-align:center;opacity:none;font-size:10pt;color:#ff0000;
            position: fixed; left: 27.4%; top: 35%;padding:5px 3px !important;margin:0px;background:#000000;font-family: 'Roboto', sans-serif;border:2px solid #ff0000;
        ...
        .avatarbtn button,.avatarbtn button{cursor:pointer;border:none;background:#ff0000;color:#000000;padding:5px 0px;border-radius:50px;font-size:11pt;margin-top:5px;}
        .avatarbtn button:hover{background:#b70000;transition:0.2s;}
        ...
        .STBOT input[type=range]:focus::-webkit-slider-runnable-track { background: #3071A9; }
         ...
         #STBOT2 {
            ...
            display:block;text-align:center;alignItems:center;opacity:none;font-size:10pt;color:#ff0000;
        ...
        #STBOT3 {
            ...
            overflow-x:hidden;width:100%;max-height:100px;overflow-y:hidden;
            display:block;text-align:center;opacity:none;font-size:10pt;color:#ff0000;
            position: fixed; left: -0.3%; top: 43.8%; transform: translateX(28%);padding:5px 3px !important;margin:0px;background:#000000;font-family: 'Roboto', sans-serif;
            border:2px solid #ff0000;border-radius:15px;z-index:999999999;display:block;height:450px !important;width:240px !important;-index:999999999;display:block;height:100px !important;width:240px !important;
        }
        #STBOT4 {

            overflow-x:hidden;width:100%;max-height:160px;overflow-y:hidden;
            display:block;text-align:center;opacity:none;font-size:10pt;color:#ff0000;
            position: fixed; left: -0.3%; top:41.3%; transform: translateX(28%);padding:5px 3px !important;margin:0px;background:#000000;font-family: 'Roboto', sans-serif;
            border:2px solid #ff0000;border-radius:15px;z-index:999999999;display:block;height:450px !important;width:240px !important;-index:999999999;display:block;height:160px !important;width:240px !important;
        }
...
openLinkButton.addEventListener('click', () => {
  ...
  const link = 'https://greasyfork.org/en/users/1353946-stragon-x';
