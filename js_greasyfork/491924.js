// ==UserScript==
// @name         Для кураторов FORUMA. By Sanya Vavilov
// @namespace    https://forum.blackrussia.online
// @version      1.3
// @description  Сделано для облегчения работы Кураторам Форума BLACK RUSSIA.
// @author       Sanya Vavilov
...
// @downloadURL https://update.greasyfork.org/scripts/491924/%D0%94%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20FORUMA%20By%20Sanya%20Vavilov.user.js
// @updateURL https://update.greasyfork.org/scripts/491924/%D0%94%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20FORUMA%20By%20Sanya%20Vavilov.meta.js
// ==/UserScript==
(function () {
'use strict';
'esversion 6' ;
...
content: `[CENTER][SIZE=4][FONT=times new roman][COLOR=rgb(255, 0, 0)]Доброго времени суток, уважаемый[/COLOR] {{ user.mention }}[/FONT][/SIZE][/CENTER]<br><br>`+
...
{
    title: 'Редакция ОбЪявления в Л/Ц',
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
...
{
title: 'Угроза о наказ. со стороны Адм',
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
...
{
title: 'ЕПП Дальнобойщик/Инкоссатор',
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
...
{
title: 'Покупка игровых ценностей',
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Вы и игрок будете наказаны по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
"[COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]2.28. [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] Запрещена покупка/продажа внутриигровой валюты в любых ее проявлениях за реальные деньги [/SIZE][/FONT][/COLOR][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]| PermBan с обнулением аккаунта + ЧС проекта[/SIZE][/FONT][/COLOR]<br><br>" +
'[LIST]<br><br>' +
"[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] любые попытки покупки/продажи, попытки поинтересоваться о ней у другого игрока и прочее - наказуемы. [/SIZE][/FONT][/COLOR]<br><br>" +
"[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Примечание: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] также запрещен обмен доната на игровые ценности и наоборот; [/SIZE][/FONT][/COLOR]<br><br>" +
"[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Пример: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] пополнение донат счет любого игрока взамен на игровые ценности; [/SIZE][/FONT][/COLOR]<br><br>" +
"[*][COLOR=rgb(255, 0, 0)][FONT=book antiqua][SIZE=4]Исключение: [/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4] официальная покупка через сайт. [/SIZE][/FONT][/COLOR]<br><br>" +
"[/LIST]<br><br>" +
"[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Приятной игры на BLACK RUSSIA [/SIZE][/FONT][/COLOR][COLOR=rgb(0, 255, 255)][FONT=times new roman][SIZE=4][/SIZE][/FONT][/COLOR][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4].[/SIZE][/FONT][/COLOR][/I]<br><br>" +
'[COLOR=rgb(51, 204, 51)][FONT=times new roman][SIZE=4][I]Одобрено.[/I][/SIZE][/FONT][/COLOR]',
prefix: ACCEPT_PREFIX,
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4][I]По данным доказательствам нельзя выдать наказание игроку. Все нарушения должны быть подтверждены через определенные ресурсы, а не только по предоставленным доказательствам.[/I][/SIZE][/FONT]<br><br>" +
...
{
title : 'Некорректный текст при подаче ЖБ используя оск/мат' ,
content:
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE ][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша жалоба отказана, т.к с момента нарушения прошло более 72-ух часов.[/FONT]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты этой темы, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br> <br>" +
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию - [/I][URL='https://forum.blackrussia.online/forums/Жалобы-на-администрацию.1612/']*Нажмите сюда*.[/FONT][/SIZE]<br><br>" +
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Заголовок вашей RolePlay - биографии составлен не по форме, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии[/I][URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша RolePlay - биография составлена не по форме, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами и формой написания RolePlay - биографии[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]В вашей RolePlay - биографии большое количество ошибок, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
status: false,
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша RolePlay - биография написана от 1-го лица, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
...
{
title : 'Ранее Биография была одобрена' ,
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/FONT][/COLOR]<br><br>' +
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша RolePlay - биография отказана т.к вы приписали суперспособности своему персонажу, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша RolePlay - биография отказана т.к вы ее скопировали у другого человека, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша RolePlay - биография отказана т.к у вас NonRP NickName, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
...
{
title : 'NickName на Англ. языке' ,
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша RolePlay - биография отказана т.к ваш NickName должен быть написан на русском языке, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
...
{
title : 'Несовпадение даты рожд. с возрастом' ,
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша RolePlay - биография отказана т.к дата рождения не совпадает с возрастом., что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Ваша RolePlay - биография отказана т.к ваша дата рождения расписана не полностью, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/URL][/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
...
content:
'[COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
"[COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]В вашей RolePlay - биографии указано менее 18-ти лет, что нарушает правила написания RolePlay - биографии.[/FONT][/SIZE]<br><br>" +
"[FONT=times new roman][SIZE=4][I]Просьба, ознакомьтесь с правилами написания RolePlay - биографии -[/I] [URL='https://forum.blackrussia.online/threads/grozny-Правила-написания-rp-биографии.3687452/'] *Нажмите сюда*.[/FONT][/SIZE]<br><br>"  +
"[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA[/I][/COLOR][I][COLOR=rgb(0, 255, 255)][/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]<br><br>" +
'[COLOR=rgb(255, 0, 0)][SIZE=4][FONT=times new roman][I]Отказано.[/I][/FONT][/SIZE][/COLOR]',
prefix: UNACCEPT_PREFIX,
...
'[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/SIZE][/FONT][/COLOR]',
prefix: UNACCEPT_PREFIX,
status: false,
},
{
