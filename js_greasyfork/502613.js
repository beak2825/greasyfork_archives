// ==UserScript==
// @name         研修网学习脚本，多页面学习全自动切换！
// @namespace    https://greasyfork.org/
// @version      1.5
// @description  代刷+V{lly6655}效适用于教师研修网学习，暂停时自动继续播放，多页面自动切换！完成时自动切换下一视频
// @author       You
...
// @license      咀嚼
// @downloadURL https://update.greasyfork.org/scripts/502613/%E7%A0%94%E4%BF%AE%E7%BD%91%E5%AD%A6%E4%B9%A0%E8%84%9A%E6%9C%AC%EF%BC%8C%E5%A4%9A%E9%A1%B5%E9%9D%A2%E5%AD%A6%E4%B9%A0%E5%85%A8%E8%87%AA%E5%8A%A8%E5%88%87%E6%8D%A2%EF%BC%81.user.js
// @updateURL https://update.greasyfork.org/scripts/502613/%E7%A0%94%E4%BF%AE%E7%BD%91%E5%AD%A6%E4%B9%A0%E8%84%9A%E6%9C%AC%EF%BC%8C%E5%A4%9A%E9%A1%B5%E9%9D%A2%E5%AD%A6%E4%B9%A0%E5%85%A8%E8%87%AA%E5%8A%A8%E5%88%87%E6%8D%A2%EF%BC%81.meta.js
// ==/UserScript==

(function() {
    'use strict';
    var playButton = document.getElementsByClassName('alarmClock-wrapper');//获取点击播放弹窗
    var playButton2 = document.getElementsByClassName('vcp-poster');//获取点击播放弹窗
       ...
       if((window.location.href).substring(0,36)==='https://ipx.yanxiu.com/grain/course/')
        {
            ...
            if(test_have_url===false)
            {
                var time = prompt("如果你要学习此页面请输入时间单位为：分钟", ""); //将输入的内容赋给变量 name ，
                 ...
                 if (time)//如果返回的有内容
                 {
                      $.cookie('get_url',window.location.href+'&tt='+time,{path:'/',domain:'yanxiu.com'});
    ...
    setInterval(function() {
        if((window.location.href).substring(0,36)==='https://ipx.yanxiu.com/grain/course/')
        {
          ...
          try{
            ...
            if (playButton2[0].style.display !== 'none')//自动继续播放
            {
                playButton2[0].click();
            }
                      }catch (error) {}
