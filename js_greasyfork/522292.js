...
// @name              极乐禁地|观看vip金币付费视频
// @homepage          https://vip.yotade.cc
// @version           1.0.20
// @updateDesc        观看全站vip金币付费视频
// @description       🔥(新脚本「糖心」已上线)观看全站vip金币付费视频，复制播放链接，下载视频(日限)，去广告🔥
// @icon              https://vip.yotade.cc/static/jljd.png
// @namespace         https://vip.yotade.cc/detail?app_id=0002
// @author            yota
// @include           *://h5d*.*.*/*
// @include           *://*.h5d*.*.*/*
// @include           *://aaw*.*.*/*
// @include           *://*.aaw*.*.*/*
// @include           *://d1ra935cee4n7e.cloudfront.net/*
// @include           *://d1ibyof3mbdf0n.cloudfront.net/*
...
// @downloadURL https://update.greasyfork.org/scripts/522292/%E6%9E%81%E4%B9%90%E7%A6%81%E5%9C%B0%7C%E8%A7%82%E7%9C%8Bvip%E9%87%91%E5%B8%81%E4%BB%98%E8%B4%B9%E8%A7%86%E9%A2%91.user.js
// @updateURL https://update.greasyfork.org/scripts/522292/%E6%9E%81%E4%B9%90%E7%A6%81%E5%9C%B0%7C%E8%A7%82%E7%9C%8Bvip%E9%87%91%E5%B8%81%E4%BB%98%E8%B4%B9%E8%A7%86%E9%A2%91.meta.js
// ==/UserScript==
                ...
                methods: {
                    ...
                    parse(url, res) {
                        if (res.code == 200 && res.msg == "success") {
                            ...
                            this.reqByCROS(`${this.server}/${this.entrance}/parse2`, 'POST', headers, JSON.stringify(data)).then((res) => {
                                if (res.code == 200) {
                                    let res_data = JSON.parse(res.data);
                                    if (res_data.code == 200) {
                                ...
                                get: () => {
                                    ...
                                    try {
                                        ...
                                        if (res.code == 200 && res.msg == "success") {
                                            ...
                                            this.reqByCROS(`${this.server}/jljd/parsevideo`, 'POST', headers, data).then((res) => {
                                                if (res.code == 200) {
