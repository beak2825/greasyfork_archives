...
// @grant        all
// @downloadURL https://update.greasyfork.org/scripts/18605/Not%20bloomed%20TM%20-%20V113.user.js
// @updateURL https://update.greasyfork.org/scripts/18605/Not%20bloomed%20TM%20-%20V113.meta.js
// ==/UserScript==
                ...
                { var player_index = transfer_info_ar[i]["id"] ;
                 ...
                 function Last_Season_Avg_Ti(TI,Season_TI,session,months,playerID,wage) {
                    ...
                    { var This_Season = months + 1;
                      ...
                      if ((playerID > 112870168) || (wage < 30001))
                          return 0;
                      else{
