// ==UserScript==
// @name         VORONEZH | Скрипт для Руководства
...
// @grant        none
// @license 	 none
// @downloadURL https://update.greasyfork.org/scripts/499564/VORONEZH%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/499564/VORONEZH%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0.meta.js
// ==/UserScript==
...
(function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            content:
            "[FONT=Verdana] [SIZE=7]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "Ваше обжалование взято на рассмотрение.<br>"+
            "Ожидайте ответа, не нужно создавать копии данной темы.<br>"+
            '[COLOR=orange]На рассмотрении.[/SIZE][/COLOR][/FONT]',
            prefix: PIN_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
            ...
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Обжалование было рассмотрено и одобрено.<br>"+
            "Ваш ЧС был снят. Впредь не давайте повода выдать его вам.<br>"+
            "Приятной игры на сервере BLACK RUSSIA | VORONEZH.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=#00FF00]Одобрено.[/COLOR][/FONT][/CENTER]',
            prefix: ACCEPT_PREFIX,
        ...
        },
        {
            ...
            "Важно подметить, что обманутая сторона должна сама писать обжалование на ваше наказание. Только в таком случае заявка будет рассмотрена. Также не забудьте прикрепить окно блокировки аккаунта игрока.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
        ...
        {
            title: 'очс, мин пол года',
            content:
            "[CENTER][FONT=Verdana]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            "Вы совершили грубое нарушение, находясь на должности нашего сервера.<br>"+
            "Ваше наказание будет обжаловано не ранее, чем через пол года с момента выдачи.<br>"+
            "На данный момент в обжаловании отказано.<br>"+
            "[url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=RED]Закрыто.[/COLOR][/FONT][/CENTER]',
            prefix: CLOSE_PREFIX,
            status: false,
