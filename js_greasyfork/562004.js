...
// @license       MIT
// @downloadURL https://update.greasyfork.org/scripts/562004/Bazaar%20Scanner%20GOD%20MODE.user.js
// @updateURL https://update.greasyfork.org/scripts/562004/Bazaar%20Scanner%20GOD%20MODE.meta.js
// ==/UserScript==
    ...
    async function scanAllFavorites() {
        ...
        if (favItems.length === 0) {
            sidebar.innerHTML = `
                ...
                <div class="bz-empty">No favorites to scan${selectedCategories.size > 0 ? ' in selected categories' : ''}</div>
            `;
            sidebar.querySelector('.bz-close-btn').addEventListener('click', () => {
                sidebar.remove();
            });
...
`);
    ...
    function render() {
        ...
        // NEW: Category checkbox listeners
