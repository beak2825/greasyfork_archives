...
// @downloadURL https://update.greasyfork.org/scripts/474665/hj209.user.js
// @updateURL https://update.greasyfork.org/scripts/474665/hj209.meta.js
// ==/UserScript==
  ...
  function main(url) {
    try {
      let init = function() {
        ...
        jumpLink2 = $(
          '<a class="crack_title" target="_blank" id="crack_jump">播放线路2（推荐）</a>'
        ).hide();
        copyBtn = $(
