...
// @downloadURL https://update.greasyfork.org/scripts/7073/WME%20UR%20Comments%20Custom%20List%20%28s18slider%29.user.js
// @updateURL https://update.greasyfork.org/scripts/7073/WME%20UR%20Comments%20Custom%20List%20%28s18slider%29.meta.js
// ==/UserScript==
/* Changelog
...
//Custom list
window.UrcommentsCustomArray2 = ["Errors with no text",
    ...
    "Missing Exit", //15
    "Volunteer responding, Waze did not send us enough information to fix your request. Would you please let us know as much as possible about the missing exit? Thanks!",
    "Open",

    "Missing Road", //16
    "Volunteer responding, Would you tell us as much as possible about the road you believe is missing? Thanks!",
    "Open",
    ...
    "Volunteer responding, It appears that you followed the route Waze suggested. Would you please let us know what went wrong with the route Waze gave you? Would you tell us your destination as you entered it into Waze? Thanks!",
    "Open",
    ...
    "There are no issues with the intersection’s turn restrictions. Waze's developers are working on a fix for this issue but we do not have an ETA. Please feel free use the turn until the issue is resolved. Thanks!",
    "NotIdentified",
