// ==UserScript==
// @name           MooMoo.io | TJ's First Mod | 2020
// @namespace      - yes
// @version          ╳TJMOD1.0╳
// @description -【MOD MENU】 ➜ 〖 AUTO HEAL 〗 〖 MENU - ESC 〗 〖 INSTAKILL - R 〗 〖 SPIKE - V 〗 〖 MORE FPS 〗    〖 AUTO CLAN - 2 [Numpad] OR ▼ 〗 〖 AUTOCHAT - 8 [Numpad] OR ▲ 〗 〖 BOOST + SPIKE - G 〗 〖 WINDMILL - N 〗         〖 MACRO 【U CAN CHANGE A KEY FOR HAT MACRO】 〗 〖 PREMIUM MEAP 〗 〖 CIRCLE'O'WINDMILLS - O 〗 〖 INSTATRAPS / BOOSTPADS - I 〗 〖 CX INSTA - SPACEBAR 〗 〖 CIRCLE'O'SPIKES - ; 〗〖 BIG SHOP 〗 〖AUTOHAT - M 【Booster & monkey tail - grass | Winter cap & monkey tail - snow】〗
// @author         TJ
// @match          *://moomoo.io/*
// @match          *://dev.moomoo.io/*
...
// @description【MOD MENU】 ➜ 〖 AUTO HEAL 〗 〖 MENU - ESC 〗 〖 INSTAKILL - R 〗 〖 SPIKE - V 〗 〖 MORE FPS 〗    〖 AUTO CLAN - 2 [Numpad] OR ▼ 〗 〖 AUTOCHAT - 8 [Numpad] OR ▲ 〗 〖 BOOST + SPIKE - G 〗 〖 WINDMILL - N 〗         〖 MACRO 【U CAN CHANGE A KEY FOR HAT MACRO】 〗 〖 PREMIUM MEAP 〗 〖 CIRCLE'O'WINDMILLS - O 〗 〖 INSTATRAPS / BOOSTPADS - I 〗 〖 CX INSTA - SPACEBAR 〗 〖 CIRCLE'O'SPIKES - ; 〗〖 BIG SHOP 〗 〖AUTOHAT - M 【Booster & monkey tail - grass | Winter cap & monkey tail - snow】〗
// @downloadURL https://update.greasyfork.org/scripts/402002/MooMooio%20%7C%20TJ%27s%20First%20Mod%20%7C%202020.user.js
// @updateURL https://update.greasyfork.org/scripts/402002/MooMooio%20%7C%20TJ%27s%20First%20Mod%20%7C%202020.meta.js
// ==/UserScript==
...
document.getElementById("gameName").innerHTML = "TJ's Mod"
...
<label class="container">More FPS
        ...
        <div class="modal-body" style="font-size: 17px;">
            <div class="flexControl">
                ...
                <h3 class="menuPrompt">Samurai Armor : </h3> <input value="${String.fromCharCode(SpikeGearKey)}" id="samurai" class="keyPressLow" maxlength="1" onkeyup="this.value = this.value.toUpperCase();" type="text"/>
