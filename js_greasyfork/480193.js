...
// @icon        blob:https://tenor.com/89fdc7d5-c22b-43d3-86a9-6ccd9a8f9adb
// @grant        none
// @namespace    https://greasyfork.org/en/users/752105-w4it
// @downloadURL https://update.greasyfork.org/scripts/480193/devil%20mod.user.js
// @updateURL https://update.greasyfork.org/scripts/480193/devil%20mod.meta.js
// ==/UserScript==
let AUTHOR = "dad"
...
document.getElementById('linksContainer2').innerHTML = ' devil is so nice👹👹👹 ' ;
document.getElementById('gameName').innerHTML = '👿devil mod 👿';
document.getElementById('loadingText').innerHTML = ' devil is coming for you '
document.getElementById('diedText').innerHTML = "skill isuues";
document.getElementById('diedText').style.color = "#fe3200";
document.title = 'playing moomoo io';
document.getElementById("leaderboard").append ('👹devil mod👹');
...
setInterval(function() {
    if (autosecondary == true) {
        newSend(["9", [secondary, true]]);
    }
}, 10);
setInterval(function() {
    if (autoprimary == true) {
        newSend(["9", [primary, true]]);
    }
}, 19);
setInterval(function() {
    if (q == true) {
...
$("#mapDisplay").css({background: `url('https://media0.giphy.com/media/fByehYIrOIzO8XolJK/200w.webp?cid=ecf05e47wu2b9vjage98816nvnx2f7t4wgvvh2mlxc9riku6&ep=v1_gifs_search&rid=200w.webp&ct=g')`});
$("#mapDisplay").css({
...
let intrap = false;
let trapid = null;
document.getElementById("mainMenu").style.backgroundImage = "url('https://media.tenor.com/z0NBmHhuIN4AAAAM/devil-firceforce.gif')";
...
menuChange.id = "settings";
menuChange.innerHTML = `
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">
                    <span class="closeBtn">&times;</span>
                    <h2 style="font-size: 17px;">deViL mod MENU</h2>
                </div>
