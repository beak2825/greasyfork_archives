// ==UserScript==
// @name        Howrse | Competities: Cross v1.0
// @namespace   NL howrse
// @include     http*://nl.howrse.com/elevage/competition/inscription?cheval=*&competition=cross
// @version     1.0
// @grant       none
// @description Automatische inschrijving op vrije competitie Cross | Automatische inschrijving op willekeurige competitie Cross als er geen vrije competities beschikbaar zijn | Automatische inschrijving op paarden van het team Ｖｉｖｅ Ｌａ Ｖｉｅ
// @downloadURL https://update.greasyfork.org/scripts/21074/Howrse%20%7C%20Competities%3A%20Cross%20v10.user.js
// @updateURL https://update.greasyfork.org/scripts/21074/Howrse%20%7C%20Competities%3A%20Cross%20v10.meta.js
// ==/UserScript==
...
if ( sessionStorage.getItem("doPushCross") == 1) {
document.title = account + ": [ doPushCross ]"      
setTimeout(function(){
    countPublicCompetitions = document.getElementById("public").getElementsByClassName("highlight").length;
    console.log("Aantal competities die toegankelijk zijn voor alle paarden: " + countPublicCompetitions);
    for (i = 0; i < countPublicCompetitions; i++) {
...
setTimeout(function(){ location.reload(); }, randomBetween(180000,300000));
