// ==UserScript==
// @name AudioBookBay hide category: Poetry
// @description Hide Poetry category
...
// @downloadURL https://update.greasyfork.org/scripts/484565/AudioBookBay%20hide%20category%3A%20Poetry.user.js
// @updateURL https://update.greasyfork.org/scripts/484565/AudioBookBay%20hide%20category%3A%20Poetry.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the exact phrase 'Poetry'
    $(".post").has(".postInfo:contains('Poetry')").hide();
});
