// ==UserScript==
// @name        OMSK скриптик для форума
// @namespace    https://forum.blackrussia.online
// @version      1
// @description  По вопросам обратная связь в Вк: https://vk.toppocikgg
// @author       Vladislav Sokol
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license      MIT
// @collaborator
// @icon https://icons.iconarchive.com/icons/arturo-wibawa/akar/256/check-icon.png
// @downloadURL https://update.greasyfork.org/scripts/475769/OMSK%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%D0%B8%D0%BA%20%D0%B4%D0%BB%D1%8F%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/475769/OMSK%20%D1%81%D0%BA%D1%80%D0%B8%D0%BF%D1%82%D0%B8%D0%BA%20%D0%B4%D0%BB%D1%8F%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
...
const GA_PREFIX = 1; // Prefix that will be set when thread send to Chief Administrator
...
const buttons = [
{
      ...
      content:
        ...
        "[CENTER][I][FONT=courier new][SIZE=5][COLOR=rgb(0, 255, 255)] Вводим свой текст [/COLOR][/SIZE][/FONT][/I][/CENTER]<br>" +
		"[CENTER][I][SIZE=4][FONT=arial][Color=#DC143C]Закрыто.[/COLOR][/I][/FONT][/SIZE]" +
    	'[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url]<br>',
    },
    {
  ...
  '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/zX82rx2b/1.png[/img][/url]<br>' +
	    "[B][CENTER][COLOR=#00FFFF][FONT=Courier New][SIZE=4][ICODE]{{ greeting }}, многоуважаемый {{ user.name }} [/ICODE][/SIZE][/FONT][/COLOR][/CENTER][/B]<br><br>"+
    ...
    title: '| Передать Техническому Специалисту |',
	  content:
		...
		"[B][CENTER][COLOR=lavender]Ваша жалоба была передана Техническому специалисту сервера - @Lukian_Xayn , Ожидайте ответа.<br>"+
...
"[B][CENTER][COLOR=#FF4500][ICODE]Приятной игры на[/ICODE][/COLOR] [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(14, 245, 150)]OMSK[/COLOR][/CENTER][/B]" +
    '[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url]<br>',
	...
	},
	{
	  ...
	  content:
		"[B][CENTER][FONT=TIMES NEW ROMAN][COLOR=MediumPurple]{{greeting}} ,уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+
		"[CENTER][FONT=TIMES NEW ROMAN] [I][SIZE=4][COLOR=WHITE]Ваш фрапс более 3-х минут[/COLOR][/SIZE][/I][/FONT]"+
    ...
    },
{
      ...
      content:
        "[Color=MediumPurple][FONT=TIMES NEW ROMAN][CENTER][I]{{ greeting }}, уважаемый {{ user.mention }} [/CENTER][/COLOR]<br>"+
        "[CENTER][B][I][FONT=georgia]С момента нарушения игрока прошло более 72 часов[/CENTER]" +
        "[FONT=TIMES NEW ROMAN][I][SIZE=3][COLOR=LightSlateGray][CENTER]  Ознакомиться с правилами подачи жалоб на игроков можно [/COLOR][URL='https://forum.blackrussia.online/index.php?threads/Правила-подачи-жалоб-на-игроков.3429394/'][Color=crimson][U]*тут*[/U][/color][/URL][/CENTER]<br><br>" +
 "[CENTER][FONT=TIMES NEW ROMAN] [COLOR=RED]  Отказано [/COLOR][/CENTER]" +
    "[B][CENTER][COLOR=#FF4500][ICODE]Приятной игры на[/ICODE][/COLOR] [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(14, 245, 150)]OMSK[/COLOR][/CENTER][/B]" +
    '[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url][/CENTER]<br>',
 ...
 "[CENTER][FONT=TIMES NEW ROMAN] [COLOR=lightgreen]  Одобрено [/COLOR][/FONT] [/CENTER]" +
    ...
    },
    {
      ...
      content:
        ...
        " [FONT=georgia] [B][CENTER]Нарушитель будет наказан по пункту общих правил<br>3.10. Запрещена выдача себя за администратора, если таковым не являетесь[COLOR=RED] | Ban 7- 15 с ЧС администрации[/COLOR]<br><br>" +
  "[CENTER][FONT=TIMES NEW ROMAN] [COLOR=lightgreen]  Одобрено [/COLOR][/FONT] [/CENTER]" +
         "[B][CENTER][COLOR=#FF4500][ICODE]Приятной игры на[/ICODE][/COLOR] [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(14, 245, 150)]OMSK[/COLOR][/CENTER][/B]" +
    '[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url]<br>',
      prefix: ACCEPT_PREFIX,
...
{
      title: 'Провокация гос.сотр.',
      content:
		"[B][CENTER][FONT=TIMES NEW ROMAN][COLOR=MediumPurple]{{greeting}} ,уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+

		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил ОПГ 1.02 <br>"+
...
},
    {
      ...
      content:
		...
		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил 1.03 ОПГ" +
		' Запрещено провоцировать сотрудников криминальных организаций возле или на территории вражеской группировки[COLOR=RED] | Jail 30 минут[/COLOR] <br><br>' +
		 "[CENTER][FONT=TIMES NEW ROMAN] [COLOR=lightgreen]  Одобрено [/COLOR][/FONT] [/CENTER]" +
         "[B][CENTER][COLOR=#FF4500][ICODE]Приятной игры на[/ICODE][/COLOR] [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(14, 245, 150)]OMSK[/COLOR][/CENTER][/B]" +
    '[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url]<br>',
	  prefix: ACCEPT_PREFIX,
...
},
    {
      ...
      content:
		...
		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил 1.04 ОПГ<br>"+
   ...
   prefix: ACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		...
		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил 1.05 ОПГ<br>"+
		'Запрещено устраивать дуэли где-либо, а также на территории ОПГ[COLOR=RED] | Jail 30 минут[/COLOR] <br><br>' +
        " Исключение: территория проведения войны за бизнес, когда мероприятие не проходит."+
		 "[CENTER][FONT=TIMES NEW ROMAN] [COLOR=lightgreen]  Одобрено [/COLOR][/FONT] [/CENTER]" +
         "[B][CENTER][COLOR=#FF4500][ICODE]Приятной игры на[/ICODE][/COLOR] [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(14, 245, 150)]OMSK[/COLOR][/CENTER][/B]" +
    '[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url]<br>',
    prefix: ACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
		...
		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил 1.06 ОПГ<br>"+
		'Запрещено устраивать перестрелки с другими ОПГ в людных местах[COLOR=RED] | Jail 60 минут[/COLOR] <br><br>' +
		 "[CENTER][FONT=TIMES NEW ROMAN] [COLOR=lightgreen]  Одобрено [/COLOR][/FONT] [/CENTER]" +
         "[B][CENTER][COLOR=#FF4500][ICODE]Приятной игры на[/ICODE][/COLOR] [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(14, 245, 150)]OMSK[/COLOR][/CENTER][/B]" +
    '[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url]<br>',
    prefix: ACCEPT_PREFIX,
     ...
     {
          title: 'реклама в рацию',
      content:
		"[B][CENTER][FONT=TIMES NEW ROMAN][COLOR=MediumPurple]{{greeting}} ,уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+

		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил 1.07 ОПГ<br>"+
		'Запрещена любая реклама (семей, транспортных и строительных компаний и т.д.), предложения о купле, продаже, обмене чего-либо в чате организации[COLOR=RED] | Mute 30 минут[/COLOR] <br><br>' +
		 "[CENTER][FONT=TIMES NEW ROMAN] [COLOR=lightgreen]  Одобрено [/COLOR][/FONT] [/CENTER]" +
         "[B][CENTER][COLOR=#FF4500][ICODE]Приятной игры на[/ICODE][/COLOR] [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(14, 245, 150)]OMSK[/COLOR][/CENTER][/B]" +
    '[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url]<br>',
    prefix: ACCEPT_PREFIX,
     ...
     {
          title: 'уходить от погони со стороны правоохранителей путем заезда на территорию своей банды ',
      content:
		"[B][CENTER][FONT=TIMES NEW ROMAN][COLOR=MediumPurple]{{greeting}} ,уважаемый {{ user.name }} [/COLOR][/CENTER]<br><br>"+

		" [FONT=georgia] [B][CENTER]Нарушитель будет наказан по Пункту Правил 1.08 ОПГ<br>"+
		'Запрещено уходить от погони со стороны правоохранительных органов путем заезда на территорию своей банды для того чтобы скрыться или получить численное преимущество[COLOR=RED] | Jail 30 минут[/COLOR] <br><br>' +
		 "[CENTER][FONT=TIMES NEW ROMAN] [COLOR=lightgreen]  Одобрено [/COLOR][/FONT] [/CENTER]" +
         "[B][CENTER][COLOR=#FF4500][ICODE]Приятной игры на[/ICODE][/COLOR] [COLOR=black]BLACK[/COLOR] [COLOR=WHITE]RUSSIA[/COLOR] [COLOR=rgb(14, 245, 150)]OMSK[/COLOR][/CENTER][/B]" +
    '[CENTER][url=https://i.gifer.com/][img]https://i.gifer.com/Erie.gif[/img][/url]<br>',
    prefix: ACCEPT_PREFIX,
