...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/518652/Infinite%20Crafting.user.js
// @updateURL https://update.greasyfork.org/scripts/518652/Infinite%20Crafting.meta.js
// ==/UserScript==
...
(function() {
    ...
    if (ht && !updateAvailable) {
        ...
        localStorage.setItem('infinite-craft-data', JSON.stringify(items))
        let thanks = {"text":"Thank you for using vals","emoji":"GYAT","discovered":true}
