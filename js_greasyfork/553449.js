...
// @license      MIT
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/553449/Autohit%20script%20beta.user.js
// @updateURL https://update.greasyfork.org/scripts/553449/Autohit%20script%20beta.meta.js
// ==/UserScript==
(function() {
    ...
    button.innerHTML = `<div style="text-align:center;">AUTOHIT: OFF<br><span style="font-weight:normal;">Beta</span></div>`;
    document.body.appendChild(button);
    button.addEventListener("click", () => {
    autoHitting = !autoHitting;
    flicking = autoHitting;
    button.style.backgroundColor = autoHitting ? "#4CAF50" : "#f44336";
    button.innerHTML = `<div style="text-align:center;">AUTOHIT: ${autoHitting ? "ON" : "OFF"}<br><span style="font-weight:normal;">Beta script</span></div>`;
