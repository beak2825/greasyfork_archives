...
// @downloadURL https://update.greasyfork.org/scripts/524222/Autodarts%20-%20Volkers%20Darts.user.js
// @updateURL https://update.greasyfork.org/scripts/524222/Autodarts%20-%20Volkers%20Darts.meta.js
// ==/UserScript==

(function() {
    'use strict';

const players = ["Reptile", "Hedman", "PZ8G4", "ALX", "Winmau"];
...
players.sort();
    ...
    $(document).on('click','button:contains("Open Lobby")', function(){
        ...
        var search_start_button = setInterval(function() {
            ...
            if( $('button:contains("Start game")').length != 0 && location.pathname.split("/")[1] == 'lobbies') {
