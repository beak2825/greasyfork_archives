// ==UserScript==
// @name ORANGE [05] | Скрипт для Руководства сервера ORANGE
// @version 1.2.0
// @author Kostya_Belik
...
// @downloadURL https://update.greasyfork.org/scripts/546284/ORANGE%20%5B05%5D%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20ORANGE.user.js
// @updateURL https://update.greasyfork.org/scripts/546284/ORANGE%20%5B05%5D%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D1%81%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0%20ORANGE.meta.js
// ==/UserScript==
...
const buttons = [
  {
    ...
    dpstyle: "padding: 6px 16px; font-family: Arial, sans-serif; font-size: 13px; font-weight: bold; color: #fff; text-shadow: 0 0 3px #ff8c00; background: linear-gradient(to bottom, #ff6a00, #ff4500); border: none; border-radius: 5px; box-shadow: 0 0 8px rgba(255, 140, 0, 0.4), inset 0 1px 1px rgba(255, 255, 255, 0.1), 0 2px 0 #cc5500, 0 3px 5px rgba(0, 0, 0, 0.2); cursor: pointer; transition: all 0.1s ease; line-height: 1;"
     ...
     {
  title: 'Приветствие',
  dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid rgba(255, 0, 0, 0.5); font-family: UtromPressKachat',
  content: `
    [SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(222, 184, 135)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]
    [FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>
    [CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]
  `
},
     {
	  ...
	  content:
		'[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
        "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
	...
	},
    {
	  ...
	  content:
		'[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
        "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
        "[CENTER]Ваша жалоба передана [COLOR=rgb(255, 255, 0)]на рассмотрение[/COLOR] [COLOR=rgb(255, 0, 0)]Главному Администратору.[/CENTER][/COLOR]" +
        "[CENTER]Убедительная просьба [COLOR=rgb(255, 0, 0)]не создавать копий данной темы.[/COLOR][/CENTER]<br>" +
        "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
         "[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Главному Администратор[/ICODE][/COLOR][/CENTER]<br><br>"+
		'[CENTER][COLOR=rgb(255, 0, 0)]Ожидайте ответа.[/COLOR][/CENTER]',
	  prefix: GA_PREFIX,
	  status: true,
	},
     {
            title: 'На рассмотрение',
                dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 69, 0); font-family: UtromPressKachat',
            content:
            "[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 255, 255)]Доброго времени суток, уважаемый(-ая) {{ user.name }}.<br><br>"+
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "Запросил доказательства у администратора.<br>"+
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            '[COLOR=orange][ICODE]На рассмотрении.[/ICODE][/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
        },
     {
	...
	{
	  title: 'Не тот сервер (Перенос)',
      dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 0, 0, 0.5); font-family: UtromPressKachat',
	  content:
		'[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
        "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
        "[CENTER]При составлении жалобы, Вы ошиблись сервером.[/CENTER]<br>" +
		"[CENTER]Подаю жалобу в раздел Вашего сервера.[/CENTER]<br>" +
        "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
		 "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
	  prefix: UNACCEPT_PREFIX,
	  status: false,
    ...
    dpstyle: "padding: 6px 16px; font-family: Arial, sans-serif; font-size: 13px; font-weight: bold; color: #fff; text-shadow: 0 0 3px #ff8c00; background: linear-gradient(to bottom, #ff6a00, #ff4500); border: none; border-radius: 5px; box-shadow: 0 0 8px rgba(255, 140, 0, 0.4), inset 0 1px 1px rgba(255, 255, 255, 0.1), 0 2px 0 #cc5500, 0 3px 5px rgba(0, 0, 0, 0.2); cursor: pointer; transition: all 0.1s ease; line-height: 1;"
     },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
           "[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER]<br><br>"+
            "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
           "[COLOR=RED][ICODE]Закрыто.[/ICODE][/COLOR][/FONT][/CENTER]<br>"+
            "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
            prefix: CLOSE_PREFIX,
            status: false,
...
"[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER]<br><br>"+
            "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/FONT][/CENTER][/SIZE]",
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
...
"[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER]<br><br>"+
        ...
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "[COLOR=RED]Отказано[/COLOR], Закрыто.[/FONT][/CENTER]<br>"+
                         "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
            prefix: UNACCEPT_PREFIX,
            status: false,
        ...
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "[COLOR=#00FA9A]Одобрено[/COLOR], Закрыто.[/FONT][/CENTER]<br>"+
                         "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
...
"[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER]<br><br>"+
		...
		{
            title: 'Нет нарушений (Правило 3.23 [Вода/Суша])',
             dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 69, 0); font-family: UtromPressKachat',
            content:
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "Исходя из приложенных выше доказательств - нарушения со стороны администратора отсутствуют.<br>"+
			"Администрация вправе доставать из воды, но не обязана.<br>"+
			"Пункт правил Администрации, который это гласит:<br>"+
			"[QUOTE][SIZE=5][COLOR=red]3.23.[/COLOR] Администрация проекта вправе оказывать помощь игрокам в решении проблем, которые они не могут устранить самостоятельно.<br>"+
			"[COLOR=red]Пример:[/COLOR] транспортное средство игрока оказалось в воде или остановилось в поле без топлива, при этом добраться до ближайшего магазина 24/7 сложно или занимает много времени.[/QUOTE][/SIZE]<br>"+
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
			"[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER]<br><br>"+
            "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
        ...
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "[COLOR=#00FA9A][ICODE]Рассмотрено.[/ICODE][/COLOR][/FONT][/CENTER]<br>"+
                         "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
        ...
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "[COLOR=red][ICODE]Передано Главному Администратору[/ICODE][/COLOR][/FONT][/CENTER]<br>"+
                         "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
            prefix: GA_PREFIX,
            status: true,
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "[COLOR=red][ICODE]Передано Специальному Администратору.[/ICODE][/COLOR][/FONT][/CENTER]<br>"+
                         "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
            prefix: SPECIAL_PREFIX,
            status: true,
...
"[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER]<br><br>"+
        ...
        },
   {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "Ответ на ваш вопрос был дан агентом поддержки, вы можете написать жалобу здесь : [URL='https://forum.blackrussia.online/threads/orange-Жалобы-на-Агентов-Поддержки.6297249//']*Нажмите сюда*[/URL]<br>"+
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
"[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER]<br><br>"+
                         "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
        ...
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "[COLOR=red]Отказано[/COLOR], Закрыто.<br>"+
                        "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
            prefix: CLOSE_PREFIX,
            status: false,
        },
  {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "Возможно вы попали на IP адрес который был заблокирован.<br>"+
            "Чтобы решить эту проблему, попробуйте изменить IP-адрес любым возможным способом..<br>"+
            "[CENTER][CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br><br>"+
            "Закрыто.<br>"+
                        "[FONT=Verdana][CENTER]Приятной игры на сервере [COLOR=rgb(255, 165, 0)]Orange(05).[/COLOR][/CENTER][/FONT]<br>"+
            "[CENTER]С уважением, [COLOR=red]Заместитель главного администратора.[/COLOR][/CENTER]",
        ...
        {
            title: 'Не по форме',
            dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(244, 164, 96); font-family: UtromPressKachat',
            content:
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
        ...
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "[CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
           "[CENTER][COLOR=rgb(255, 0, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER]",
            prefix: CLOSE_PREFIX,
            status: false,
        },
        {
        ...
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=orange][ICODE][ICODE]На рассмотрение[/ICODE][/ICODE][/COLOR][/FONT][/CENTER]',
            prefix: PIN_PREFIX,
            status: true,
        },
        {
        ...
        },
        {
           ...
           '[SIZE=4][FONT=Verdana][CENTER][COLOR=rgb(255, 165, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br><br>' +
            ...
            "Ожидайте ответа в данной теме, не нужно создавать копии этой темы.<br>"+
            "[CENTER][url=https://ibb.co/51gRYCr][img]https://i.ibb.co/grLRvQS/image.png[/img][/url]<br>"+
            '[COLOR=orange][ICODE]На рассмотрение[/ICODE][/COLOR][/FONT][/CENTER]',
            prefix: GA_PREFIX,
            status: true,
        },
        {
...
(function() {
    ...
    function init() {
        ...
        const options = [
            ...
            { text: "Раздел заявок на лидера", href: "https://forum.blackrussia.online/forums/Лидеры.3093/" },
            { text: "Раздел заявок на АП", href: "https://forum.blackrussia.online/forums/Агенты-поддержки.3092/" },
            { text: "Раздел сервера ORANGE", href: "https://forum.blackrussia.online/forums/Сервер-№5-orange.246/" },
            { text: "ЖБ на администрацию", href: "https://forum.blackrussia.online/forums/Жалобы-на-администрацию.271/" },
            { text: "ЖБ на лидеров", href: "https://forum.blackrussia.online/forums/Жалобы-на-лидеров.272/" },
            { text: "ЖБ на игроков", href: "https://forum.blackrussia.online/forums/Жалобы-на-игроков.273/" },
            { text: "Обжалование наказаний", href: "https://forum.blackrussia.online/forums/Обжалование-наказаний.274/" },
            ...
            { text: "АРХИВ", href: "https://forum.blackrussia.online/forums/Архив.257/" }
        ];
