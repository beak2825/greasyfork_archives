// ==UserScript==
// @name         FreeEthereum.com (Pescador de Cripto)
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/410978/FreeEthereumcom%20%28Pescador%20de%20Cripto%29.user.js
// @updateURL https://update.greasyfork.org/scripts/410978/FreeEthereumcom%20%28Pescador%20de%20Cripto%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    function freeethereum_com(){
        ...
        if (window.location.href.indexOf("freeethereum.com/free") > -1) {
            setInterval(function(){
                window.history.go(0);
            },300000);
        }
    ...
    function open(){
        if (window.location.href.indexOf("pescadordecripto.com/dashboard") > -1) {
            window.open("https://freeethereum.com/free", "_blank","width=10,height=10,left=-3000,top=-3000");
        }
    ...
    if (window.location.href.indexOf("pescadordecripto.com/dashboard") > -1) {
        ...
        a.id = 'freeethereum-com';
        a.className = 'faucet-link faucet-active';
        a.innerHTML = 'FREEETHEREUM.COM';
    ...
    if (window.location.href.indexOf("pescadordecripto.com/install") > -1) {
        document.getElementById('freeethereum-com').classList.add("faucet-active");
    }
})();