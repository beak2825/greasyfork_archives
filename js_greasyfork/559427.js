...
// @downloadURL https://update.greasyfork.org/scripts/559427/Mobile%20Interface%20Optimizer%20%28Touch%20Fix%29.user.js
// @updateURL https://update.greasyfork.org/scripts/559427/Mobile%20Interface%20Optimizer%20%28Touch%20Fix%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    // --- 2. FIND LOCATION & INSERT BUTTON (LOGIC VỊ TRÍ CŨ) ---
    function insertButton() {
        ...
        btn.innerText = "©"; // Giữ nguyên icon cũ
        ...
        // Logic tìm vị trí chèn nút dựa trên text bản quyền (Như script gốc)
    ...
    // --- 4. EVENT HANDLER (SỬ DỤNG GM_setClipboard ĐỂ CHỐNG XÓA) ---
    function handleCopy() {
        try {
            const content = extractQuestions();
            
            // Đây là phần quan trọng nhất giúp chống xóa clipboard:
            GM_setClipboard(content, { type: 'text', mimetype: 'text/plain' });
            
            // Xóa nút sau khi copy
            removeButtonForever();
        } catch (e) {
            console.error("Lỗi:", e);
        }
