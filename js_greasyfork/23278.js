...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/23278/Deplacer%20Actu%20de%20la%20Sidebar.user.js
// @updateURL https://update.greasyfork.org/scripts/23278/Deplacer%20Actu%20de%20la%20Sidebar.meta.js
// ==/UserScript==
...
function deplacer(){
   ...
   if (actu1 > 7){
       var actu = $('div.section')[3].innerHTML;
    ...
    var actu4 = $('div.section')[4].innerHTML;
    $('div.section')[5].remove();
    var car = {type:"", model:"500", color:"white"};
