// ==UserScript==
// @name         WME Overlay GA Cobb Co Parcels
// @namespace    https://greasyfork.org/users/
// @version      0.3.3.001
// @description  Adds Parcel layer to display for Cobb County GA
// @author       MapOMatic
...
// @downloadURL https://update.greasyfork.org/scripts/27164/WME%20Overlay%20GA%20Cobb%20Co%20Parcels.user.js
// @updateURL https://update.greasyfork.org/scripts/27164/WME%20Overlay%20GA%20Cobb%20Co%20Parcels.meta.js
// ==/UserScript==
...
(function() {
    ...
    var _settingsStoreName = 'wme_GA_Cobbco_parcels_boundaries';
    ...
    function log(message, level) {
        if (message && (!level || (level <= _debugLevel))) {
            console.log('GA CobbCo Parcels Boundaries: ', message);
        }
    }
    ...
    function getUrl(extent, zoom) {
        ...
        var url = 'http://www.cobbgis.org:81/arcgislb1/rest/services/cobbpublic/cobbparcelsmapwm_public/MapServer/3/query?geometry=' + encodeURIComponent(geometryStr);  //must be https:// //
        ...
        url += '&outFields=' + encodeURIComponent('SITUS_ADDR');     // shows full address  //
        //url += '&outFields=' + encodeURIComponent('ST_NUMBER');        // shows House # only  //
        //url += '&outFields=' + encodeURIComponent('BLDG_NUM');      // shows Building # only all others null //
    ...
    function processStateBorders(states) {
        ...
        states.forEach(function(state) {
            var attributes = {
                name: state.attributes.SITUS_ADDR     // shows full address  //
                //name: state.attributes.ST_NUMBER        // shows House # only  //
                //name: state.attributes.BLDG_NUM       // shows Building # only all others null //
               };
    ...
    function initLayer(){
        ...
        _mapLayer = new OpenLayers.Layer.Vector("Overlay - GA Cobb Co Parcels", {
            uniqueName: "__WMEGACobbcopar",
        ...
        I18n.translations.en.layers.name.__FCLayer = "GA Cobb Co Parcels Boundaries";
