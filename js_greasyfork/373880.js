...
// @downloadURL https://update.greasyfork.org/scripts/373880/Dent%20JIRA%20Links.user.js
// @updateURL https://update.greasyfork.org/scripts/373880/Dent%20JIRA%20Links.meta.js
// ==/UserScript==

localStorage['issue-patterns'] = "DENT(DTSS)?(ECOM)?-\\d+";
localStorage['jira-url'] = "https://jira.epam.com/jira/";
localStorage['jira-url-dtss'] = "https://jiraeu.epam.com/";
...
function createLinkFromID(match) {
    ...
    if(match[0].startsWith("DENTDTSS") || match[0].startsWith("DENTECOM")){
        jiraUrl = localStorage['jira-url-dtss'];
    }        
