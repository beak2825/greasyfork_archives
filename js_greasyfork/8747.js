...
// @downloadURL https://update.greasyfork.org/scripts/8747/WME%20Validator%20Localization%20for%20Illinois.user.js
// @updateURL https://update.greasyfork.org/scripts/8747/WME%20Validator%20Localization%20for%20Illinois.meta.js
// ==/UserScript==
//
/*
...
window.WME_Validator_United_States = {
  ...
  ".author": "xanderb",
  ".updated": "2017-03-31",
  ".link": "https://greasyfork.org/en/scripts/8747-wme-validator-localization-for-illinois",
  ".lng": "EN-US",
  ...
  "129.problem": "Illinois uses SR-xx for state and US-xx for national highway names",
  ...
  "130.title": "Improper Exit Naming",
  "130.problem.en": "The segment matched custom conditions",
  "130.problem": "This segment has an entrance / exit name which does not follow the USA standards for exit naming, or is a ramp with non entrance / exit name",
  "130.solution.en": "Solve the issue",
  "130.solution": "For numbered exits use \"Exit(s) ##: Name / Other Name\". For entrances & unnumbered exits use \"to Name / Other Name\". Separate all shields and names with slashes (/) and spaces. Verify if this is supposed to be a ramp",
  "131.enabled": true,
  "131.params": {
  ...
  "131.solution": "Make sure you are editing in IL and change it",
  "132.enabled": true,
  "132.params": {
    ...
    "template": "${state}:${street}#${altStreet[#]}",
    "regexp": "/Illinois:.*(Co(unty)? (H(ighway|wy)|R(oa)?d) |C[hSsr]-)/"
  },
  ...
  "133.title": "Alley not PLR",
  "133.problem.en": "The segment matched custom conditions",
  "133.problem": "Alleys should be set to the PLR Road Type",
  "133.solution.en": "Solve the issue",
  "133.solution": "Change Road Type",
  "134.enabled": true,
  "134.params": {
  ...
  "134.title": "City Name on Freeway",
  "134.problem.en": "The segment matched custom conditions",
  "134.problem": "City names on Freeway segments can cause detours",
  "134.solution.en": "Solve the issue",
  "134.solution": "Remove the City Name",
  "135.enabled": true,
  "135.params": {
  ...
  "136.problem": "Names on Railroads are not needed for routing and clutter the app UI",
  "136.solution.en": "Solve the issue",
  "136.solution": "Remove the Names and Cities from Railroad segments",
  "150.enabled": true,
