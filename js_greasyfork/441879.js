...
// @namespace      https://www.eurofotbal.cz
// @description    Skryje příspěvky vybraných uživatelů na Eurofotbal.cz
// @include        https://www.eurofotbal.cz/*
// @author         Whites (Potty), owny
// @version        2.0.0
// @downloadURL https://update.greasyfork.org/scripts/441879/EuroFotbal%20DiscussCleaner.user.js
// @updateURL https://update.greasyfork.org/scripts/441879/EuroFotbal%20DiscussCleaner.meta.js
// ==/UserScript==
...
function main() {
	...
	function initUI() {
		...
		$('.chk2').append('<label for="settings-mode">Skrýt celý příspěvek (může rozbít strukturu diskuze)</label>');
