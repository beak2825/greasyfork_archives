...
// @grant        none
// @license      ISC
// @downloadURL https://update.greasyfork.org/scripts/503236/PINK%20%7C%20Forum%20Script%20for%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93.user.js
// @updateURL https://update.greasyfork.org/scripts/503236/PINK%20%7C%20Forum%20Script%20for%20%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%D0%9E%D0%9F%D0%93.meta.js
// ==/UserScript==
...
(async function () {
    ...
    const buttons = [
        ...
        },
        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br><br>` +
            `[CENTER]Пожалуйста, убедительная просьба, ознакомьтесь с назначением данного раздела, так как ваш запрос никоим образом не относится к предназначению данного раздела.<br>` +
            `[COLOR=red]Отказано[/COLOR], закрыто.[/CENTER][/FONT][/SIZE]`,
            prefix: UNACCEPT_PREFIX,
            status: false,
        },
