// ==UserScript==
// @name                WME Aerial Shifter
// @version             1.7
// @description         This script allows you to adjust the position and opacity of the underlying satellite imagery
// @include             /^https:\/\/(www|beta)\.waze\.com\/(?!user\/)(.{2,6}\/)?editor\/?.*$/
// @grant               none
// @icon                http://s3.amazonaws.com/uso_ss/icon/176646/large.png?1391605696
// @namespace           https://greasyfork.org/en/users/172995-dajonel
// @author              DaJoNel
// @contributor         byo
// @contributor         berestovskyy
// @contributor         iainhouse
// @contributor         ragacs
// @downloadURL https://update.greasyfork.org/scripts/39020/WME%20Aerial%20Shifter.user.js
// @updateURL https://update.greasyfork.org/scripts/39020/WME%20Aerial%20Shifter.meta.js
// ==/UserScript==
/*
...
(function()
{
    ...
    {
        // init shortcuts
        if(!(WM = window.W.map) || !$('#search').length)
        {
            window.console.log("WME Aerial Shifter v" + version + ": waiting for WME...");
            setTimeout(init, 500);
            return;
        }
