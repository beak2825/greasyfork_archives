// ==UserScript==
// @name         Internet Roadtrip Permanent Radio - WMUA
// @description  Overrides Internet Roadtrip radio with WMUA 91.1 FM.
...
// @icon         https://pbs.twimg.com/profile_images/1841916142371127296/StTp86-k_200x200.jpg
// @downloadURL https://update.greasyfork.org/scripts/537997/Internet%20Roadtrip%20Permanent%20Radio%20-%20WMUA.user.js
// @updateURL https://update.greasyfork.org/scripts/537997/Internet%20Roadtrip%20Permanent%20Radio%20-%20WMUA.meta.js
// ==/UserScript==
...
// Check if we've shown the migration alert before
  ...
  warningText.innerHTML = `This version of Internet Roadtrip WMUA Radio will no longer receive updates.<br><br>
  ...
  container.state.updateData = new Proxy(originalUpdateData, {
    apply: (target, thisArg, args) => {
      args[0].station = {
        name: "WMUA 91.1 FM",
        url: "https://usa5.fastcast4u.com/proxy/qernhlca?mp=/1",
        distance: 0,
      };
