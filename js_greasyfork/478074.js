...
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/478074/SteamGiftscom%20Giveaway%20Entry.user.js
// @updateURL https://update.greasyfork.org/scripts/478074/SteamGiftscom%20Giveaway%20Entry.meta.js
// ==/UserScript==
// Since 2020-05-21
...
(function () {
    ...
    function startRandomReloadTimer() {
        const minReloadInterval = 14400000; // 4 hour in milliseconds
        const maxReloadInterval = 28800000; // 6 hours in milliseconds
    ...
    window.addEventListener('load', startRandomReloadTimer);
