// ==UserScript==
// @name        Personal Turkmaster - Whisper Theme - Left Dock
...
// @grant       GM_getValue
// @grant       GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/11372/Personal%20Turkmaster%20-%20Whisper%20Theme%20-%20Left%20Dock.user.js
// @updateURL https://update.greasyfork.org/scripts/11372/Personal%20Turkmaster%20-%20Whisper%20Theme%20-%20Left%20Dock.meta.js
// ==/UserScript==
...
var SettingsDialog = function() {
	...
	function _addStyle() {
		addStyle("\
			...
			#settingsDialog li input[type='text'] { background-color: #232A2F; color: #AFCCDE; width: 3em; font-size: 80%; margin-right: 0.8em; text-align: right; padding-right: 0.5em }\
...
var DispatchUI = {
	...
	addStyle: function() {
		addStyle("#dispatcher { background-color: #232A2F; position: fixed; top: 0px; float: left; left: 0; height: 100%;  width: 270px; font-size: 8pt;  margin-left: 0px; transition: left 0.5s ease; }\
			#dispatcher.tm-hidden { left: -240px }\
			#content_container { position: absolute; left: 270px; top: 0; right: 0; border-left: 2px solid #232A2F; transition: left 0.5s ease; background-color: #232A2F }\
			...
			#dispatcher .watcher.running .details { background-color: #7B8F8F; background-color: rgba(123, 143, 143, 1); }\
			#dispatcher .watcher.updated { background-color: #7B8F8F; background-color: rgba(123, 143, 143, 1) }\
			#dispatcher .watcher .details { width: 25px; text-align: center; float: right; background-color: rgba(31, 56, 71, 1); position: absolute; top: 0; bottom: 0; right: 0; font-size: 90%; color: #1F3847; transition: background-color 0.5s }\
			...
			#dispatcher .watcher .name { font-size 130%; color: #AFCCDE; text-decoration: none; display: inline-block; margin-top: -3px}\
			#dispatcher .watcher .name:hover { text-decoration: underline }\
			#dispatcher .watcher.dragging .name:hover { text-decoration: none }\
			#dispatcher .watcher .time { color: #7B8F8F; display: block; float: left; font-size: 80% }\
			.on_off { float: right; cursor: pointer }\
			.on_off a { color: #458B00; margin: 1px; font-size: 56%; font-weight: bold }\
			.on_off a:nth-child(2) { background-color: #394752; color: #AFCCDE; border-radius: 12px; padding: 3px 6px; }\
			...
			#dispatcher .watcher .last_updated { position: absolute; right: 30px; bottom: 4px; font-size: 80%; color: #CADA95}\
			...
			#dispatcher .watcher .color_code.url div       { rgba(202, 218, 149, .7); }\
