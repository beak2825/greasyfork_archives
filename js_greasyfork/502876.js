...
// @downloadURL https://update.greasyfork.org/scripts/502876/pixels%20mine.user.js
// @updateURL https://update.greasyfork.org/scripts/502876/pixels%20mine.meta.js
// ==/UserScript==
...
//                  RoomPrototype.connection.send(encryptUtils.encryptSend(action, data));
                ...
                async function sendMssage() {
                    console.log("房间开始加载")
                    await sleep(7000);
                    while (!unsafeWindow.Phaser.Display.Canvas.CanvasPool.pool[0].parent.game.scene.scenes[1]){
