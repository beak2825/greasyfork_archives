...
// @downloadURL https://update.greasyfork.org/scripts/30349/Contact%20Calls%205%20Questions%20%28YRVBNF%29.user.js
// @updateURL https://update.greasyfork.org/scripts/30349/Contact%20Calls%205%20Questions%20%28YRVBNF%29.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Contact")').length) {
    ...
    createButton('Nope',0,0,2,3,0,'This person does not work there, the person I spoke to was not aware of past employment');
    createButton('Wrong Biz',0,1,3,2,2,'This number connected to the wrong business');
    number.append('<br>');
    number.append('<br>');
