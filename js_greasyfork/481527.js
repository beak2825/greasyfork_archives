...
// @match           https://star-space.net/claim.php?uid=*
// @license         MIT
// @grant           unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/481527/NP%E4%B8%80%E9%94%AE%E8%AE%A4%E9%A2%86.user.js
// @updateURL https://update.greasyfork.org/scripts/481527/NP%E4%B8%80%E9%94%AE%E8%AE%A4%E9%A2%86.meta.js
// ==/UserScript==
...
(function () {
  ...
  window.onload = function () {
      if (location.href.match(/^https:\/\/star-space.net\/claim.php/)) {
  ...
  unsafeWindow.ClassificationDeClaimTorrents = async function (element) {
    ...
    for (const el of element) {
      ...
      if (claimId > 0) {
        ...
        var endpoint = '';
        if (location.href.match(/^https:\/\/star-space.net\//)) {
            endpoint = 'https://star-space.net/ajax.php';
        }
