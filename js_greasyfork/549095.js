// ==UserScript==
// @name        NAV-Estado de patio inbound - ALMACENES
...
// @license     MIT
// @downloadURL https://update.greasyfork.org/scripts/549095/NAV-Estado%20de%20patio%20inbound%20-%20ALMACENES.user.js
// @updateURL https://update.greasyfork.org/scripts/549095/NAV-Estado%20de%20patio%20inbound%20-%20ALMACENES.meta.js
// ==/UserScript==
...
function fetchTaskData() {
  ...
  // Update warehouse incident for a trailer
  ...
  function exportToExcel() {
    ...
    try {
      ...
      // Add headers - Updated to remove inspection columns and add new timestamp columns
      const headers = [
        ...
        'Inicio inspección entrada', 'Fin inspección entrada',
        'Inicio inspección salida', 'Fin inspección salida',
  ...
  // Fallback CSV export - Updated to remove inspection columns and add new timestamp columns
...
function fetchYardData(manualFetch = false) {
  ...
  // Sort data based on current sort configuration - Updated column indices for removed inspection columns
  function sortData(data) {
    ...
    return [...data].sort((a, b) => {
      ...
      // Extract values based on column (updated for new column count with removed inspection columns)
      switch(sortConfig.column) {
        ...
        case 23: // Inicio inspección entrada
          ...
          break;
        case 24: // Fin inspección entrada  
          ...
          break;
        case 25: // Inicio inspección salida
  ...
  // Filter data based on current filter values - Updated column indices for removed inspection columns
  ...
  // Update the table with fetched yard data - Updated to remove inspection columns and make timestamp columns view-only
  function updateTable() {
    ...
    if (yardData.length === 0) {
      ...
      emptyRow.innerHTML = '<td colspan="32" style="text-align: center; padding: 20px;">NO HAY DATOS DISPONIBLES</td>';
    ...
    if (displayData.length === 0) {
      const emptyRow = document.createElement('tr');
      emptyRow.innerHTML = '<td colspan="32" style="text-align: center; padding: 20px;">NO HAY RESULTADOS PARA LOS FILTROS ACTUALES</td>';
      tableBody.appendChild(emptyRow);
      return;
    }
    ...
    Promise.all(enrichPromises).then(enrichedItems => {
      enrichedItems.forEach((item, index) => {
        try {
          ...
          // Security incident data - Now view only
          ...
          // Security incident column - Now view only
          ...
          // Warehouse incident column - Now editable with <y></y> tag
          ...
          // Timestamp columns - Now view only
          ...
          // Append all cells to the row (updated to remove inspection columns)
  ...
  function showConsole() {
    ...
    // Create header row with sortable and filterable headers - Updated to remove inspection columns
    ...
    const headers = [
      ...
      'Diferencia vs. cita', 'Sección cita', 'Incidente seguridad',
      'Incidente transporte', 'Localizador', 'Incidente Almacén', 'Razón de Rechazo',
      'Inicio Inspeccion Entrada', 'Fin Inspeccion Entrada',
      'Inicio Inspeccion Salida', 'Fin Inspeccion Salida',
      'Hora de ingreso', 'Hora de llegada a rampa',
      'Hora de fin de carga/descarga', 'Hora de salida de rampa', 'Status'
    ];
  ...
  // Create sample data for testing - Updated to remove inspection data
    ...
    const samples = [
      {
        trailer: {
          ...
          comment: "<a><b>angel</b><c>espinoza</c><d></d><e></e><f></f><g></g><h></h><i>380</i><j></j><k>2017</k><l>kenworth</l><m>20942063</m><n>y2a0ct</n><o>2012</o><p>hytr</p><u>mxtraabe</u><s1>1736790117367902</s1><critico></critico></a>\n<q></q>\n<r></r>\n<s></s>\n<t></t>\n<s2></s2><x>Incidente con llanta trasera</x><w>Problema con documentación</w><lo>ZN-A-01</lo><y>Problema con material dañado</y><rr>R1-RECHAZO LLANTA POCHADA</rr><as>" + (now - 1800000) + "</as><ae>" + (now - 1200000) + "</ae><ds>" + (now - 900000) + "</ds><de>" + (now - 600000) + "</de>",
          load_information: [
            {
              sku: "000000000002010099-env mod especial 12 oz granel premium",
              qty: 50
      ...
      },
      {
        trailer: {
          ...
          comment: "<w>Revisión de equipo necesaria</w><lo>ZN-B-15</lo><y>Revisión de documentos pendiente</y><as>" + (now - 3600000) + "</as>"
        },
        status: "loaded",
