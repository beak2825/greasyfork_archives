// ==UserScript==
// @name         BLACK | Скрипт для кураторов форума A.Gordeev
// @namespace    https://forum.blackrussia.online
// @version      1.42
// @description  Специально для BlackRussia | BLACK A.Gordeev
// @author       A.Gordeev
// @match        https://forum.blackrussia.online/threads/*
// @include      https://forum.blackrussia.online/threads/
// @grant        none
// @license      MIT
// @collaborator A.Gordeev
// @icon https://icons.iconarchive.com/icons/google/noto-emoji-people-bodyparts/512/12003-OK-hand-light-skin-tone-icon.png
// @downloadURL https://update.greasyfork.org/scripts/469907/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20AGordeev.user.js
// @updateURL https://update.greasyfork.org/scripts/469907/BLACK%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20AGordeev.meta.js
// ==/UserScript==
...
const buttons = [
      ...
      content:
       ...
       "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        ...
        "[COLOR=rgb(209, 213, 216)][I][FONT=times new roman][SIZE=4]Ваша жалоба взята на рассмотрение, ожидайте ответа в данной теме.[/SIZE][/FONT]<br><br>" +
           "[CENTER][IMG width=695px]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
         '[B][CENTER][COLOR=#d60000][ICODE]Закрыто![/ICODE][/COLOR][/CENTER][/B]',
      prefix: PIN_PREFIX,
      status: true,
    },
    {
    ...
    },
    {
      ...
      content:
         "[CENTER][IMG width=695px]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/IMG]<br>"+
       "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[SPOILER][COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в раздел жалоб на администрацию [/URL][/FONT][/SIZE][/SPOILER]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
       "[CENTER][IMG width=695px]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
          '[B][CENTER][COLOR=#FF0000][ICODE]Отказано![/ICODE][/COLOR][/CENTER][/B]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
         "[CENTER][IMG width=695px]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/IMG]<br>"+
       "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[SPOILER][COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в раздел жалоб на хелперов [/URL][/FONT][/SIZE][/SPOILER]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
        "[CENTER][IMG width=695px]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
          '[B][CENTER][COLOR=#FF0000][ICODE]Отказано![/ICODE][/COLOR][/CENTER][/B]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
        "[CENTER][IMG width=695px]https://i.postimg.cc/JnbTx0Q8/P0ZTE.png[/IMG]<br>"+
       "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[SPOILER][COLOR=rgb(209, 213, 216)][SIZE=4][FONT=times new roman][I]Вы ошиблись разделом, обратитесь в раздел жалоб на лидеров [/URL][/FONT][/SIZE][/SPOILER]<br><br>" +
        "[FONT=times new roman][SIZE=4][I]Просьба не создавать дубликаты данной темы в этом разделе, иначе ваш форумный аккаунт может быть заблокирован.[/I][/SIZE][/FONT][/COLOR]<br><br>" +
       "[CENTER][IMG width=695px]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
          '[B][CENTER][COLOR=#FF0000][ICODE]Отказано![/ICODE][/COLOR][/CENTER][/B]',
      prefix: UNACCEPT_PREFIX,
    ...
    },
    {
      ...
      content:
       ...
       "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        "[SPOILER][FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]2.32. [/COLOR][COLOR=rgb(209, 213, 216)]Запрещено введение в заблуждение, обман администрации на всех ресурсах проекта[/COLOR][COLOR=rgb(255, 0, 0)] |  Ban 7 - 15 дней | PermBan[/COLOR] [/SIZE][/FONT][/SPOILER]<br><br>" +
        "[CENTER][IMG width=695px]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
          '[B][CENTER][COLOR=#00FF00][ICODE]Одобрено![/ICODE][/COLOR][/CENTER][/B]',
      prefix: ACCEPT_PREFIX,
      status: false,
      ...
      content:
       ...
       "[B][CENTER][COLOR=#00FFFF][ICODE]Доброго времени суток уважаемый Игрок [/ICODE][/COLOR][/CENTER][/B]<br><br>"+
        "[SIZE=4][FONT=times new roman][I][COLOR=rgb(209, 213, 216)]Ваша RolePlay - сиуация одобрена.[/COLOR][/I][/FONT][/SIZE]<br><br>" +
         "[CENTER][IMG width=695px]https://i.postimg.cc/j2pLjFs5/2776718330-preview-P84-Rw.png[/IMG]<br>"+
        '[B][CENTER][COLOR=#008000][ICODE]Одобрено[/ICODE][/COLOR][/CENTER][/B]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
