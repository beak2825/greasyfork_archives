// ==UserScript==
// @name           Amazon - Show percentages for review scores
// @description    Adds the percentage of people who gave each rating to the review table
...
// @match          *://*.amazon.tld/*
// @grant          none
// @downloadURL https://update.greasyfork.org/scripts/11238/Amazon%20-%20Show%20percentages%20for%20review%20scores.user.js
// @updateURL https://update.greasyfork.org/scripts/11238/Amazon%20-%20Show%20percentages%20for%20review%20scores.meta.js
// ==/UserScript==
...
(function(window, document) {
  ...
  /* Match elements using selector, call func(elem, idx) on each */
  ...
  var el = document.querySelector('#summaryStars, .totalReviewCount'),
      total = el && parseInt(el.textContent)

  if (total) {
    $each('#histogramTable td:last-child a', a => {
      var num = parseInt(a.textContent),
          pct = 100 * (num / total)
