...
// @description Dany
// @downloadURL https://update.greasyfork.org/scripts/432755/Dany1121167890.user.js
// @updateURL https://update.greasyfork.org/scripts/432755/Dany1121167890.meta.js
// ==/UserScript==
																...
																if (objj.indexOf('youku') > 0) {
																	...
																	function pcqqdszx() {
																		if (document.querySelector('#mod_player')) {
																			...
																			document.body.appendChild(document.createElement("Dany1"));
																			ggobj('#dark_layer');
