// ==UserScript==
// @name         华医网助手（自动跳过考试）v2.2.3
// @namespace    http://tampermonkey.net/
// @version      2.2.3
// @description  自动播放华医网视频，跳过弹窗，跳过考试，状态面板，跳转下一个视频。作者：Yik Liu
// @author       Yik Liu
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/538092/%E5%8D%8E%E5%8C%BB%E7%BD%91%E5%8A%A9%E6%89%8B%EF%BC%88%E8%87%AA%E5%8A%A8%E8%B7%B3%E8%BF%87%E8%80%83%E8%AF%95%EF%BC%89v223.user.js
// @updateURL https://update.greasyfork.org/scripts/538092/%E5%8D%8E%E5%8C%BB%E7%BD%91%E5%8A%A9%E6%89%8B%EF%BC%88%E8%87%AA%E5%8A%A8%E8%B7%B3%E8%BF%87%E8%80%83%E8%AF%95%EF%BC%89v223.meta.js
// ==/UserScript==
        ...
        video.addEventListener("ended", () => {
            ...
            setTimeout(() => {
                ...
                if (examBtn && !examBtn.disabled) {
                    updateStatusPanel("监控中", "忽略进入考试", "跳过", examErrorCount, document.title);
                }
    ...
    function autoJumpToLearningVideo() {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            if (text.includes('学习中')) {
                target = items[i]; status = '学习中'; index = i; break;
            }
        }
        ...
        if (!target) {
            for (let i = 0; i < items.length; i++) {
                ...
                if (text.includes('未学习')) {
                    target = items[i]; status = '未学习'; index = i; break;
                }
            }
        }
