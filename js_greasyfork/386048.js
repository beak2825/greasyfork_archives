...
// @version      0.50
// @description  Tetris Online Poland theme for Jstris
// @author       Oki, Eddie
// @match        https://*.jstris.jezevec10.com/*
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/386048/TOP%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/386048/TOP%20Theme.meta.js
// ==/UserScript==
...
(function() {
    ...
    window.addEventListener('load', function(){
        ...
        loadSkin("https://i.imgur.com/P71JsB7.png",30);

        //Jstris Custom Background Image
        document.head.getElementsByTagName("style")[0].innerHTML="";
        document.body.style.backgroundImage="url('https://imgur.com/KlMVod3.png')";
...
function atGameStart() {
    ...
    img.onload = function(){
        ...
        bgctx.drawImage(img,50,114,485,562); // Or at whatever offset you like
    };
    img.src = "https://i.imgur.com/9WRKdeL.png";
...
queueCopy2.style.transform = "scale(0.6,0.6) translate(18px, 100px)"
