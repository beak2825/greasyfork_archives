// ==UserScript==
// @name           Petui - Report Stats (unxix)
// @version        1.1
// @namespace      https://openuserjs.org/users/petui
// @license        GPL version 3 or any later version; http://www.gnu.org/copyleft/gpl.html
// @author         petui, adujusted by unxix
// @description    Calculates combined RT and CP costs and loot of multiple combat reports, /CP cost added
// @include        http*://prodgame*.alliances.commandandconquer.com/*/index.aspx*
// @downloadURL https://update.greasyfork.org/scripts/25436/Petui%20-%20Report%20Stats%20%28unxix%29.user.js
// @updateURL https://update.greasyfork.org/scripts/25436/Petui%20-%20Report%20Stats%20%28unxix%29.meta.js
// ==/UserScript==
'use strict';
        ...
        function createReportStats() {
            ...
            qx.Class.define('ReportStats', {
                ...
                statics: {
                    ...
                    StatusbarHeight: 55,	// height to add to BaseInfoWindow to accomodate statusbar being visible
                ...
                members: {
                        ...
                        for (var tabIndex = 1; tabIndex <= 2; tabIndex++) {
                            ...
                            table.getChildControl('statusbar').set({
                                ...
                                toolTip: new qx.ui.tooltip.ToolTip().set({
                                    label: '"Loot" is the sum of resources gained, plunder and own repair costs.<br/>'
                                    +'"∑ ressources" includes Tiberium, crystal and $<br/>'
                                    + 'Tip: You can select multiple reports at once by holding down the Shift key.<br/>'
                                    + 'If you are saving RT, it will turn green',
                                    rich: true
                                })
                            });
                        }
                    ...
                    onAllReportsLoaded: function() {
                        ...
                        if (hasSelectedReports) {
                            ...
                            var lootRow = 'Loot:';
                            var ressourcestotale = 0;
                            var lootRow2 = 'Loot/10CP: ';
                            ...
                            for (var resourceType in loot) {
                                ...
                                lootRow2 += ' <img width="17" height="17" src="' + ReportStats.ResourceTypes[resourceType] + '" style="vertical-align: text-bottom;"/>';
                                ...
                                if (loot[resourceType] < 0) {
                                    ...
                                    lootRow2 += phe.cnc.gui.util.Numbers.formatNumbersCompact(loot[resourceType]/minCommandPointCosts*10);
                                    var ressourcestotale =  ressourcestotale + loot[resourceType]
                                    }
                            }
                            var ressourcestotale = ressourcestotale - loot[resourceType]
                            lootRow2 += '; ∑ ressources = ' + phe.cnc.gui.util.Numbers.formatNumbersCompact(ressourcestotale/minCommandPointCosts*10) + '  ; RT = ' + (repairTimeCosts/minCommandPointCosts<360 ? '<span style="color:#04B431;">' : '<span style="color:#FF0000;">') + phe.cnc.Util.getTimespanString(repairTimeCosts/minCommandPointCosts*10) + (repairTimeCosts/minCommandPointCosts<360 ? '</span>' : '</span>')
