...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/455357/Svitla%20ID%20Tools.user.js
// @updateURL https://update.greasyfork.org/scripts/455357/Svitla%20ID%20Tools.meta.js
// ==/UserScript==
...
(function() {
    ...
    async function selectDays() {
        const days = [...document.getElementsByClassName('day')].filter(isWeekend).filter(isOtherMonth).filter(isEntered);
