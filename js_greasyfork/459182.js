...
// @version      2.4.9
// @description  wos核心论文集下载机器人-单次下载1000/txt-用原大佬的
// @author       AngelLiang
...
// @connect      *
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/459182/Wos%20Download%20Bot.user.js
// @updateURL https://update.greasyfork.org/scripts/459182/Wos%20Download%20Bot.meta.js
// ==/UserScript==
...
(function() {
    ...
    function requestFileByIndex(start, stop, total, callback) {
        ...
        $.when(reqAjax).done(function(){
            var nextStart = parseInt(start) + 1000
            var nextStop = parseInt(stop) + 1000
            if (nextStart > total) {
                enableDownloadButton()
                console.log("===下载完成===");
                alert('下载完成')
