// ==UserScript==
// @name         46 | Скрипт для модераторов форума
...
// @license 	 none
// @copyright 2023,
// @downloadURL https://update.greasyfork.org/scripts/515030/46%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B4%D0%B5%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/515030/46%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BC%D0%BE%D0%B4%D0%B5%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
  ...
  const buttons = [
      {
          title: 'Приветствие',
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br><br><br>${END_DECOR}`,
          move: 0,
      },
      {
          ...
          `Ваша жалоба взята на рассмотрение. Пожалуйста, не создавайте дубликаты данной темы.<br><br>` +
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Ваша жалоба передана техническому специалисту на рассмотрение.<br><br>` +
          `Ожидайте ответа.${END_DECOR}`,
          prefix: TECH_PREFIX,
          status: true,
          move: 0,
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Передаю Вашу жалобу Заместителю Главного Администратора.<br><br>` +
          `Ожидайте ответа.${END_DECOR}`,
          prefix: WAIT_PREFIX,
          status: true,
          move: 0,
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Передаю Вашу жалобу Главному Администратору.<br><br>` +
          `Ожидайте ответа.${END_DECOR}`,
          prefix: HA_PREFIX,
          status: true,
          move: 0,
      ...
      {
          title: '___________________________________________________________ОТКАЗЫ___________________________________________________________',
      },
      {
          title: 'Не по форме',
          content:
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Вы ошиблись сервером при подаче заявки. Пересоздайте жалобу в разделе нужного вам сервера → *[URL='https://forum.blackrussia.online/index.php#igrovye-servera.12']Кликабельно[/URL]*.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Обратитесь в раздел жалоб на технических специалистов → *[URL='https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%9646-chelyabinsk.2051/']Кликабельно[/URL]*.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Обратитесь в технический раздел для решения Вашей проблемы → *[URL='https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-chelyabinsk.2052/']Кликабельно[/URL]*.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `На подобные виды нарушений необходимо предоставить видеозапись.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Владелец компании вправе самостоятельно выбирать спетень пообщрения для сотрудников. Нарушений со стороны игрока нет.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      ...
      {
      title: 'Слив склада отказ',
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `В описании семьи должны быть указаны условия взаимодействия со складом. Лидер самостоятельно несет ответственность за выдачу доступа игрока. и за возможные последствия своих действий. Жалобы по данному пункту правил рассматриваются только от лица лидера семьи.<br><br>` +
          `Отказано, закрыто.${END_DECOR}`,
          prefix: DECLINED_PREFIX,
          status: false,
          move: 0,
      ...
      {
          title: '___________________________________________________________ОДОБРЕНИЯ___________________________________________________________',
      },
      {
          title: 'НРП Обман',
          content:
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Нарушитель будет наказан по пункту правил:[QUOTE]4.03. Запрещена совершенно любая передача игровых аккаунтов третьим лицам | PermBan.[/QUOTE]<br><br>` +
          `Одобрено, закрыто.${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
          move: 0,
      ...
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Нарушитель будет наказан по пункту правил:[QUOTE]6.03. Запрещено nRP поведение | Warn[/QUOTE]<br><br>` +
          `Одобрено, закрыто.${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
          move: 0,
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Нарушитель будет наказан по пункту правил:[QUOTE]6.02. Запрещено выдавать розыск без Role Play причины | Warn[/QUOTE]<br><br>` +
          `Одобрено, закрыто.${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
          move: 0,
      },
      {
          ...
          content:
          `${START_DECOR}Здравствуйте, {{ user.mention }}.<br><br>` +
          `Нарушитель будет наказан по пункту правил:[QUOTE]7.04. Запрещено отбирать водительские права во время погони за нарушителем | Warn[/QUOTE]<br><br>` +
          `Одобрено, закрыто.${END_DECOR}`,
          prefix: APPROVED_PREFIX,
          status: false,
          move: 0,
    ...
    const biography = [
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "Ваша RolePlay биография проверена и одобрена.<br><br>" +
            `Одобрено, закрыто.${END_DECOR}`,
            prefix: APPROVED_PREFIX,
            status: false,
            move: 2085,
        ...
        {
            title: '____________________________________________ДОРАБОТКА____________________________________________',
        },
        {
            ...
            "Подробнее ознакомиться с правилами составления RolePlay биографий можно тут → *[URL='https://forum.blackrussia.online/threads/chelyabinsk-%D0%9F%D1%80%D0%B0%D0%B2%D0%B8%D0%BB%D0%B0-%D1%81%D0%BE%D1%81%D1%82%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D1%8F-roleplay-%D0%B1%D0%B8%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D0%B8.10825583/']Кликабельно[/URL]*<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "В тексте вашей теме допущены ошибки.<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "В пункте «Детство» указано мало информации. Распишите этот пункт подробнее.<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "В пункте «Юность и взрослая жизнь» указано мало информации. Распишите этот пункт подробнее.<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "В пункте «Настоящее время» указано мало информации. Распишите этот пункт подробнее.<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "В нескольких пунктах описания вашей жизни указано мало информации. Распишите эти пункты подробнее.<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "Дата рождения персонажа не сходится с его возрастом в текущий момент.<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "События, которые вы описали в биографии не могли произойти с человеком указанного вами возраста.<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "Имя в форме биографии не соответствует заголовку.<br><br>" +
            `На доработку у вас есть 24 часа.${END_DECOR}`,
            prefix: WAIT_PREFIX,
            status: true,
            open: true,
        ...
        {
            title: '____________________________________________ОТКАЗЫ____________________________________________',
        },
        {
            title: 'Истёк срок рассмотрения',
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "По истечению 24-х часов полного объёма изменений не последовало.<br><br>" +
            `Отказано, закрыто.${END_DECOR}`,
            prefix: DECLINED_PREFIX,
            status: false,
            move: 2087,
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "Ваше сообщение никаким образом не относится к теме данного раздела.<br><br>" +
            `Отказано, закрыто.${END_DECOR}`,
            prefix: DECLINED_PREFIX,
            status: false,
            move: 2087,
        ...
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "Ваша RolePlay биография скопирована или слишком схожа с одной из уже существующих.<br><br>" +
            `Отказано, закрыто.${END_DECOR}`,
            prefix: DECLINED_PREFIX,
            status: false,
            move: 2087,
        },
        {
            ...
            content:
            `${START_DECOR}Здравствуйте,  {{ user.mention }}.<br><br>` +
            "В вашей теме допущено слишком много ошибок.<br><br>" +
            `Отказано, закрыто.${END_DECOR}`,
            prefix: DECLINED_PREFIX,
            status: false,
            move: 2087,
