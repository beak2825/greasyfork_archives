...
// @version      2.1.8
// @author       du
// @description  如有问题联系QQ群:【321412228】任何问题及时联系群主更新]自动挂机看尔雅MOOC，支持视频、音频、文档、图书自动完成，章节测验自动答题提交，支持自动切换任务点、挂机阅读时长、自动登录等，解除各类功能限制，开放自定义参数
// @license      MIT
// @icon         https://api.maho.cc/random-img/pc.php
// @match        *://*.chaoxing.com/*
// @match        *://*.edu.cn/*
// @match        *://*.nbdlib.cn/*
// @match         *://*.hnsyu.net/*
...
// @antifeature  ads      支持付费代看
// @antifeature  payment  不支持答题付费代看
// @downloadURL https://update.greasyfork.org/scripts/488423/%E2%9D%A4%EF%B8%8F%E8%B6%85%E6%98%9F%E5%AD%A6%E4%B9%A0%E9%80%9A%E7%BD%91%E8%AF%BE%E5%B0%8F%E5%8A%A9%E6%89%8B%F0%9F%8D%86.user.js
// @updateURL https://update.greasyfork.org/scripts/488423/%E2%9D%A4%EF%B8%8F%E8%B6%85%E6%98%9F%E5%AD%A6%E4%B9%A0%E9%80%9A%E7%BD%91%E8%AF%BE%E5%B0%8F%E5%8A%A9%E6%89%8B%F0%9F%8D%86.meta.js
// ==/UserScript==
...
(function (vue, pinia, rxjs, md5, ElementPlus) {
        ...
        queryApis: [
          {
            name: "海量题库",
            token: "",
            url: "http://www.dubainow.top/index/index"
          }
          // {
          //     name: '一之题库',
          //     token: '',
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("div", null, [
          vue.createVNode(_component_el_divider, {
            ...
            default: vue.withCtx(() => [
              vue.createVNode(_component_el_text, { style: { "font-size": "12px", "font-weight": "normal", "color": "#909399" } })
            ]),
            _: 1
          }),
  ...
  const ScriptHome = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-55cd8b76"]]);
  ...
  const _hoisted_1$2 = /* @__PURE__ */ vue.createTextVNode("代看地址：yy.ffwk.life");
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          vue.createVNode(_component_el_input, {
            ...
            placeholder: "复制地址http://www.dubainow.top/index/index到浏览器即可QQ群321412228"
          }, {
            prepend: vue.withCtx(() => [
          ...
          vue.withDirectives(vue.createElementVNode("div", null, [
            vue.createVNode(_component_el_empty, { description: "复制地址http://www.dubainow.top/index/index到浏览器即可" })
          ], 512), [
            [vue.vShow, !__props.questionList.length]
          ])
        ], 64);
  ...
  const _hoisted_2$1 = /* @__PURE__ */ vue.createTextVNode(" 代看地址：");
  const _hoisted_3 = /* @__PURE__ */ vue.createElementVNode("a", null , "http://www.dubainow.top/index/index", -1);
  const _hoisted_4 = [
    _hoisted_2$1,
    _hoisted_3
  ];
        ...
        if (this.questions.length) {
          ...
          for (const [index, question] of this.questions.entries()) {
            ...
            if (answerData.code === 200) {
              ...
              question.answer[0] = answerData.msg + '<a style="font</a>';
            }
        ...
        if (this.questions.length) {
          ...
          for (const [index, question] of this.questions.entries()) {
            ...
            if (answerData.code === 200) {
              ...
              this.addLog(`第${index + 1}道题搜索失败，点击上方答题查看原因`, "danger");
              question.answer[0] = answerData.msg + '<a http://www.dubainow.top/index/index=</a>';
            }
            this.addQuestion(question);
  ...
  const _sfc_main$3 = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props, { emit }) {
      ...
      const urlLogicPairs = [
        ...
        { keyword: "mycourse/stu?courseid", logic: () => console.log(101112) },
  ...
  const CardBody = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-6d489ae0"]]);
            ...
            header: vue.withCtx(() => [
              vue.createElementVNode("div", {
                ...
                vue.withDirectives(vue.createElementVNode("div", _hoisted_2, [
                  vue.createElementVNode("div", null, vue.toDisplayString(vue.unref(configStore).platformParams[vue.unref(configStore).platformName].name), 1),
                  isShow.value && !vue.unref(configStore).isMinus ? (vue.openBlock(), vue.createBlock(_component_el_tooltip, {
                    key: 0,
                    teleported: "",
                    effect: "dark",
                    placement: "top-start",
                    content: "<span>注意事项：<br/>请尽量使用新版，不要使用旧版。有人脸建议代看地址http://www.dubainow.top/index/index<br/></span>",
                    "raw-content": ""
                  }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(_component_el_icon, { style: { "margin-left": "5px" } }, {
                        default: vue.withCtx(() => [
  ...
  const Layout = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d228382d"]]);
