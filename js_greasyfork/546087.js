...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/546087/Kickcom%20Chat%20Spammer.user.js
// @updateURL https://update.greasyfork.org/scripts/546087/Kickcom%20Chat%20Spammer.meta.js
// ==/UserScript==
...
(function() {
    ...
    function sendMessage(message, delay) {
        const chatInput = document.querySelector('textarea.chat-input'); // Ajusta el selector según la estructura real del chat
        if (chatInput) {
            ...
            chatInput.dispatchEvent(sendEvent);
            if (delay > 0) {
                setTimeout(() => {
                    sendMessage(message, delay);
                }, delay);
