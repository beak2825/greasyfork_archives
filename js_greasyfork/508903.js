...
// @author       Alexey rUSSS
// @match        https://forum.blackrussia.online/forums/%D0%91%D0%B0%D1%82%D1%8B%D1%80%D0%B5%D0%B2%D1%81%D0%BA%D0%B0%D1%8F-%D0%9E%D0%9F%D0%93.1947/
// @include      https://forum.blackrussia.online/forums/%D0%91%D0%B0%D1%82%D1%8B%D1%80%D0%B5%D0%B2%D1%81%D0%BA%D0%B0%D1%8F-%D0%9E%D0%9F%D0%93.1947/
// @grant        none
// @license    MIT
// @icon https://emoji.gg/assets/emoji/9372-blurple-boost-level-9.png
// @downloadURL https://update.greasyfork.org/scripts/508903/%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%7C%20ARusso.user.js
// @updateURL https://update.greasyfork.org/scripts/508903/%D0%93%D0%A1%D0%97%D0%93%D0%A1%20%7C%20ARusso.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
const buttons = [
    ...
    },
    {
      ...
      content:
        '[Color=rgb(128, 128, 0)][FONT=Georgia][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]С сотрудником будет проведена беседа![/CENTER]<br><br>" +
      ...
      content:
        '[Color=rgb(128, 128, 0)][FONT=Georgia][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Сотрудник был уволен![/CENTER]<br><br>" +
      ...
      content:
        '[Color=rgb(128, 128, 0)][FONT=Georgia][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER] Ваша малява одобрена , с уважением положенец ![/CENTER]<br><br>" +
      ...
      content:
        '[Color=rgb(128, 128, 0)][FONT=Georgia][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Доказательство сотрудником были предоставлены и наказание выдано верно[/CENTER]<br><br>" +
      ...
      content:
        '[Color=rgb(128, 128, 0)][FONT=Georgia][CENTER]{{ greeting }}, уважаемый {{ user.mention }}.[/color][/CENTER]<br>' +
        "[CENTER]Данный игрок не является сотрудником [/CENTER]<br><br>" +
