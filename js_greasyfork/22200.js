...
// @downloadURL https://update.greasyfork.org/scripts/22200/Hybrid%20-%20Categorize%20races%20in%20photos.user.js
// @updateURL https://update.greasyfork.org/scripts/22200/Hybrid%20-%20Categorize%20races%20in%20photos.meta.js
// ==/UserScript==

if ($('li:contains("Airbnb")').length) {
    for (i=0;i<20;i++) 
    ...
    $(document).keyup(function (event) {
        ...
        if (key=='13') {
            ...
            comboAnswer(0,5);
        else if (key == 103) //Numpad 7 = One White
            comboAnswer(1,0);
