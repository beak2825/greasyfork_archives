// ==UserScript==
// @name Для Руководства PINK (08) by Bennet
...
// @downloadURL https://update.greasyfork.org/scripts/499762/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20PINK%20%2808%29%20by%20Bennet.user.js
// @updateURL https://update.greasyfork.org/scripts/499762/%D0%94%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20PINK%20%2808%29%20by%20Bennet.meta.js
// ==/UserScript==
...
(function () {
    ...
    "Твой текст <br><br>"+
     "Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]PINK[/COLOR].[/FONT][/CENTER][/B][/SIZE]",
    },
    {
    ...
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]PINK[/COLOR].[/CENTER][/B][/SIZE]',
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Обратитесь в раздел [URL='https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%968-pink.1189/']«Жалобы на технических Специалистов [Color=rgb(128,0,64)]PINK[/color]».[/URL][/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]PINK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Обратитесь со своей проблемов в  [URL='https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-pink.396/']«Технический раздел [Color=rgb(128,0,64)]PINK[/COLOR]».[/URL][/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]PINK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Вы ошиблись сервером. Переношу вашу жалобу в нужный сервер.[/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]PINK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Жалобы с подобным содержанием не подлежат рассмотрению т.е оскорбления в жалобе/теме доказательств.[/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]PINK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Если хотите как-то снизить свое наказание, то можете написать в раздел [URL='https://forum.blackrussia.online/forums/%D0%9E%D0%B1%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D0%BD%D0%B0%D0%BA%D0%B0%D0%B7%D0%B0%D0%BD%D0%B8%D0%B9.395/'][Color=rgb(255,0,0)]«Обжалование наказаний»[/COLOR][/URL], но не факт, что обжалование одобрят.<br> Перед написанием обжалования внимательно ознакомьтесь с правилами подачи заявок на обжалование наказания[/CENTER]<br><br>"+
    '[CENTER]Приятной игры и времяпровождение на сервере [COLOR=rgb(144,0,32)]PINK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: UNACCEPT_PREFIX,
    status: false,
    },
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Главному Администратору/Заместителю Главного Администратора[/color] - @Jesus Mackenzie @Sincerity_Screamz ✞ [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>",
    prefix: GA_PREFIX,
    status: true,
    },
    {
    ...
    content:
    '[SIZE=4][FONT=Times New Roman][CENTER][B]{{ greeting }}, уважаемый {{ user.mention }}!<br><br>'+
    "[CENTER]Ваша жалоба будет передана [Color=Red]Заместителям Главного Администратора[/color] -@Sincerity_Screamz ✞ [Color=Orange]на рассмотрение[/color]. Просьба не создавать подобных тем.[/CENTER]<br>",
    prefix: PIN_PREFIX,
    status: true,
    },
    {
    ...
    '[CENTER]Приятной игры на сервере [COLOR=rgb(144,0,32)]PINK[/COLOR].[/CENTER][/B][/SIZE]',
    prefix: ACCEPT_PREFIX,
    status: false,
    },
    {
