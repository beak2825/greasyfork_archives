...
// @downloadURL https://update.greasyfork.org/scripts/531616/Xxandy%20Busca%20de%20V%C3%ADdeos%20Personalizada%20%2B%20Atalhos%20%2B%20Dura%C3%A7%C3%A3o%20%28Corrigido%29.user.js
// @updateURL https://update.greasyfork.org/scripts/531616/Xxandy%20Busca%20de%20V%C3%ADdeos%20Personalizada%20%2B%20Atalhos%20%2B%20Dura%C3%A7%C3%A3o%20%28Corrigido%29.meta.js
// ==/UserScript==
...
(function() {
    ...
    document.addEventListener('keydown', function(event) {
        if (event.ctrlKey && event.shiftKey && event.key === 'V') { // CTRL + SHIFT + V = Buscar vídeos normais
            ...
            if (query) searchVideos(query);
        } else if (event.ctrlKey && event.shiftKey && event.key === 'X') { // CTRL + SHIFT + X = Buscar vídeos adultos
