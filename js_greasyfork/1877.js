...
// @name        HEU_DMG
// @namespace   localhost
// @description HEU_DMG_info
// @include     http://primera.e-sim.net/militaryUnitStorage.html*
// @include     http://primera.e-sim.org/militaryUnitStorage.html
// @version     2
// @downloadURL https://update.greasyfork.org/scripts/1877/HEU_DMG.user.js
// @updateURL https://update.greasyfork.org/scripts/1877/HEU_DMG.meta.js
// ==/UserScript==
...
$(document).ready(function() {
	...
	// JSONP betöltése
    var url = "http://mkhl.php5.sk/dmg_heu.php?callback=parseRequest";
    var script = document.createElement("script");  
