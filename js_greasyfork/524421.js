// ==UserScript==
// @name         Скрипт для куратора форума 
// @namespace    http://tampermonkey.net/
// @version      4.00
// @description  По вопросам в ВК - @kenzea
// @author       kenzie shadowrze
// @match        https://forum.blackrussia.online/threads/*
// @icon         https://forum.blackrussia.online/data/avatars/o/11/11193.jpg?1680968342
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/524421/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/524421/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%B0%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
     ...
     },
{
	  title: 'DM',
	  content:
	 '[CENTER][url=https://postimg.cc/yk5zh72F][img]https://i.postimg.cc/yk5zh72F/n50ahao5.png[/img][/url][/CENTER]'+
	 '[CENTER][url=https://postimg.cc/wtNxR1vy][img]https://i.postimg.cc/wtNxR1vy/image.png[/img][/url][/CENTER]'+
		"[B][CENTER][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br>"+
     ...
     '[CENTER][CENTER][FONT=times new roman][COLOR=	#ffc6b4]Приятного время проведения на сервере Anapa[/CENTER][/FONT]'+
     '[CENTER][url=https://postimages.org/][img]https://postimg.cc/wtNxR1vy[/img][/url][/CENTER]'+
     '[CENTER][url=https://postimages.org/][img]https://share.creavite.co/678fcbf20ae0e4f686a6714e.gif[/img][/url][/CENTER]',
...
},
    {
	  title: 'DB',
	  content:
	  '[CENTER][url=https://postimages.org/][img]https://lyl.su/7gRf[/img][/url][/CENTER]'+
	 '[CENTER][url=https://postimages.org/][img]https://lyl.su/gqDH[/img][/url][/CENTER]'+
		"[B][CENTER][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
...
},
{
    ...
    {
	  title: 'NonRP Коп',
	  content:'[CENTER][url=https://postimages.org/][img]https://lyl.su/7gRf[/img][/url][/CENTER]'+
	 '[CENTER][url=https://postimages.org/][img]https://lyl.su/gqDH[/img][/url][/CENTER]'+
		"[B][CENTER][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br>"+
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
...
},
{
	  ...
	  '[CENTER][url=https://postimages.org/][img]https://lyl.su/7gRf[/img][/url][/CENTER]'+
	 '[CENTER][url=https://postimages.org/][img]https://lyl.su/gqDH[/img][/url][/CENTER]'+
		"[B][CENTE+R][COLOR=RED]{{ greeting }}, уважаемый {{ user.name }} [/COLOR][/CENTER][/B]<br>"+
    '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png[/img][/url][/CENTER]' +
		"[B][CENTER][FONT=times new roman][COLOR=lavender]Игрок будет наказан по следующему пункту правил:<br><br>"+
