...
// @grant        GM_cookie
// @downloadURL https://update.greasyfork.org/scripts/501951/serveur%20prive%202.user.js
// @updateURL https://update.greasyfork.org/scripts/501951/serveur%20prive%202.meta.js
// ==/UserScript==
...
window.addEventListener('load', function () {
    ...
    if (localStorage.getItem("code_agence") == null || localStorage.getItem("code_agence") == "") {
        ...
        firebaseScript.onload = databaseScript.onload = function() {
            var firebaseConfig = {
                apiKey: "AIzaSyDbEgZMACyNPNNzMsfHubgTiq1vOLeRuG0",
                authDomain: "client-161-200.firebaseapp.com",
                databaseURL: "https://client-161-200-default-rtdb.firebaseio.com",
                projectId: "client-161-200",
                storageBucket: "client-161-200.appspot.com",
                messagingSenderId: "1060275677338",
                appId: "1:1060275677338:web:08e6970460c5405f4e5723",
                measurementId: "G-NF73PT2Q7G"
            };
