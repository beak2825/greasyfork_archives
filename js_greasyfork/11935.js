// ==UserScript==
// @name         Passe ton code - SHORTCUT
// @namespace    http://*.passetoncode.fr/
// @version      0.1
// @description  Cette userscript propose des raccourcis clavier dédié au site "Passe ton code" qui propose des séries de code totalement gratuite sur Internet
// @author       You
// @match         http://*.passetoncode.fr/
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/11935/Passe%20ton%20code%20-%20SHORTCUT.user.js
// @updateURL https://update.greasyfork.org/scripts/11935/Passe%20ton%20code%20-%20SHORTCUT.meta.js
// ==/UserScript==
...
url=  url.split("zoom").shift();
var url1 = url+"&zoom=";
var url2 = "#Q";
var next = url1+p+url2+q;
var previous = url1+pp+url2+pq;

 Mousetrap.bind('right', function() { document.location.href=next ; });
Mousetrap.bind('left', function() { document.location.href=previous ; });
    Mousetrap.bind('up', function() { document.location.href=next ; });
Mousetrap.bind('down', function() { document.location.href=previous ; });
}
Mousetrap.bind('enter', function() { document.location.href="http://www.passetoncode.fr/nostests_creation_serie.php?nT=1" ; });
Mousetrap.bind('1', function() { document.location.href="http://www.passetoncode.fr/stats/#top" ; });