...
// @downloadURL https://update.greasyfork.org/scripts/29100/%E4%B9%9D%E6%8C%8A.user.js
// @updateURL https://update.greasyfork.org/scripts/29100/%E4%B9%9D%E6%8C%8A.meta.js
// ==/UserScript==
...
var main = {
  ...
  jav: {
    type: 0,
    re: /(avio|avso|avxo|av28|avmo).*movie.*/,
  ...
  javlibrary: {
    type: 0,
    re: /(javlibrary|javlib|javl10|jav11b|13vlib).*\?v=.*/,
        ...
        if (t) {
          Array.from(t).forEach(function (elem) {
            data.push({
              ...
              "src": "https://btdb.to" + elem.firstChild.getAttribute("href"),
            });
          });
        }
        else {
