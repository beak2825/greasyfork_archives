// ==UserScript==
// @name         IdlePixel XP Calculator - GodofNades Fork (rehost)
...
// @downloadURL https://update.greasyfork.org/scripts/527970/IdlePixel%20XP%20Calculator%20-%20GodofNades%20Fork%20%28rehost%29.user.js
// @updateURL https://update.greasyfork.org/scripts/527970/IdlePixel%20XP%20Calculator%20-%20GodofNades%20Fork%20%28rehost%29.meta.js
// ==/UserScript==
...
<h5>XP Calculator:<button id="crafting-visibility-button">Hide</button></h5>
    ...
    <span>Required SD: <span id="crafting-sd-required"></span></span>
     <span>Required bars: <span id="crafting-bars-required">
        ...
        <span><img style="height: 32px; width: 32px;" src="https://d1xsc8x7nc5q8t.cloudfront.net/images/titanium_bar.png"> <span id="crafting-calculator-titanium"> 0</span> </span>
        <span><img style="height: 32px; width: 32px;" src="https://d1xsc8x7nc5q8t.cloudfront.net/images/ancient_bar.png"> <span id="crafting-calculator-ancient"> 0</span> </span>
        <span><img style="height: 32px; width: 32px;" src="https://d1xsc8x7nc5q8t.cloudfront.net/images/dragon_bar.png"> <span id="crafting-calculator-dragon"> 0</span> </span>
        </span>
        </span>
    </div>
...
<div id="mining-calculator-div">
    ...
    <span>Required SD: <span id="mining-sd-required"></span></span>
        ...
        <span><img style="height: 32px; width: 32px;" src="https://d1xsc8x7nc5q8t.cloudfront.net/images/titanium.png"> <span id="mining-calculator-titanium"> 0</span> </span>
        <span><img style="height: 32px; width: 32px;" src="https://d1xsc8x7nc5q8t.cloudfront.net/images/ancient_ore.png"> <span id="mining-calculator-ancient"> 0</span> </span>
        <span><img style="height: 32px; width: 32px;" src="https://d1xsc8x7nc5q8t.cloudfront.net/images/dragon_ore.png"> <span id="mining-calculator-dragon"> 0</span> </span>
        </span>
        </span>
    </div>
...
<span>Outfit bonus: </span> <span id="farming-outfit-bonus" style="margin-right: 10px;">0</span>
            ...
            seeds.forEach((seeds)=>{
                farmingHTML += `<span><img style="height: 32px; width: 32px;" src="https://d1xsc8x7nc5q8t.cloudfront.net/images/${seeds}.png"> <span id="farming-calculator-${seeds}"> 0</span> </span>`
            })
