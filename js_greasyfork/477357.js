...
// @license MIT
// @run-at document-end
// @downloadURL https://update.greasyfork.org/scripts/477357/%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B.user.js
// @updateURL https://update.greasyfork.org/scripts/477357/%E4%B8%89%E7%9B%B8%E4%B9%8B%E5%8A%9B.meta.js
// ==/UserScript==
...
(function () {
    ...
    const is_new = document.getElementsByClassName('item goback').length
    ...
    const tag_jn_Inner = "<b style='color: #00FF00'>" + tag_cj + "</b>"
                ...
                GM_xmlhttpRequest({
                    ...
                    onload: function (res) {
                        if (res.status === 200) {
                            ...
                            unknown.delete(pid)
                            //vtuber
                            if (bshow && (st.includes(keyword_jxt) || st.includes(keyword_ccj) || st.includes(keyword_gcb)||st.includes(keyword_mml)||st.includes(keyword_sc)||st.includes(keyword_dwr)||st.includes(keyword_bjx)||st.includes(keyword_nql)||st.includes(keyword_xxx)||st.includes(keyword_xhz))) {
                                c.innerHTML += "<b style='color: #000000' >【 隐藏 |  </b>"
                                //添加嘉然标签
