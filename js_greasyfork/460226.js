// ==UserScript==
// @name         Gradescope Paste and Drag to Upload Naughty (WIP)
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/460226/Gradescope%20Paste%20and%20Drag%20to%20Upload%20Naughty%20%28WIP%29.user.js
// @updateURL https://update.greasyfork.org/scripts/460226/Gradescope%20Paste%20and%20Drag%20to%20Upload%20Naughty%20%28WIP%29.meta.js
// ==/UserScript==
...
`
    ...
    document.getElementById("submit-variable-length-pdf").addEventListener("click", function() {
        var ranNum = Math.floor(Math.random() * 70)
        if (ranNum == 69) {
        document.querySelector(".js-fileUploadPrompt").innerText = "Please cum in my asshole daddy";
        }
        else {
