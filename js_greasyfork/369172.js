...
// @downloadURL https://update.greasyfork.org/scripts/369172/Peaks%20Increment%20Calculator%20V20.user.js
// @updateURL https://update.greasyfork.org/scripts/369172/Peaks%20Increment%20Calculator%20V20.meta.js
// ==/UserScript==
...
div_area.innerHTML = "<div style=\"position: absolute; z-index: 1; width: 186px; height: 249px; margin-top: 476px; background: url(https://image.ibb.co/eOtQ0y/omer_omer.png);  color: white;  outset; display:inline;\">&nbsp;<p style=\"text-decoration: underline;\"><b><\p><table style=\"margin-top: -1em; margin-bottom: 1em; position:relative; top:0px;left:5px\">&nbsp;<tr><td>PhySum: </td><td>" + phySum + " (" + 0 + "%)</td></tr><tr><td>TacSum: </td><td>" + phySum + " (" + 0 + "%)</td></tr><tr><td>TecSum: </td><td>" + phySum + " (" + 0 + "%)</td></tr><tr><td>AllSum: </td><td>" + phySum + "</td></tr></table></b></div>";
...
{   var first_age = document.getElementById("mi").value ;
   ...
   try {
    ...
    {var c = b[0].getElementsByClassName("graph jqplot-target");
     ...
     if ((first_age_index < mi_index+1)&&(second_age_index >= first_age_index) && (tac_diff > 0)&& (phy_diff > 0)&& (tec_diff > 0)){
