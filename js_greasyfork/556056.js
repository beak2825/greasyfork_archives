...
// @downloadURL https://update.greasyfork.org/scripts/556056/New%20script%20vlad%20elegant.user.js
// @updateURL https://update.greasyfork.org/scripts/556056/New%20script%20vlad%20elegant.meta.js
// ==/UserScript==
...
const biography = [
    ...
    },
    {
        ...
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/7ZvzpWkf/RLwzo.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=lavender]Благодарим вас за ваше обращение.<br><br>" +
        "[CENTER][COLOR=lavender]С уважением, команда Курирования форума [COLOR=rgb(255,200,0)]Bless Russia[/color] [COLOR=#df2606]RED[/color].[/COLOR][/CENTER]",
    },
    {
    ...
    {
        title: 'На рассмотрении ваша биография',
        dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 215, 0)',
        content:
        "[B][CENTER][COLOR=red][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/7ZvzpWkf/RLwzo.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=white][FONT=courier new] Ваша RolePlay биография находится на рассмотрении. Ожидайте окончательного вердикта.<br><br>" +
        "Статус: [COLOR=#FFA500]На рассмотрении...[/COLOR][/FONT][/COLOR][/CENTER][/B]<br>" +
        '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/7ZvzpWkf/RLwzo.png[/img][/url]<br>' +
        "[B][CENTER][COLOR=lavender]Благодарим вас за ваше обращение.<br><br>" +
        "[CENTER][COLOR=lavender]С уважением, команда Курирования форума [COLOR=rgb(255,200,0)]Bless Russia[/color] [COLOR=#df2606]RED[/color].[/COLOR][/CENTER]",
    }
