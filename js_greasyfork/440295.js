...
// @license      MIT License
// @downloadURL https://update.greasyfork.org/scripts/440295/Import%20Pinterest%20images%20to%20LingQuan.user.js
// @updateURL https://update.greasyfork.org/scripts/440295/Import%20Pinterest%20images%20to%20LingQuan.meta.js
// ==/UserScript==

(function () {
  if (location.href.indexOf("pinterest.") === -1) {
    alert("此脚本仅适用于pinterest.com (This script only works on pinterest.com)");
    return;
  }
