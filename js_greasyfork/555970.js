// ==UserScript==
// @name         Destiny Kick Volume
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Custom volume for Kick iframe on destiny.gg
// @match        https://www.destiny.gg/*
// @match        https://player.kick.com/*
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/555970/Destiny%20Kick%20Volume.user.js
// @updateURL https://update.greasyfork.org/scripts/555970/Destiny%20Kick%20Volume.meta.js
// ==/UserScript==
...
(function() {
    ...
    GM_addStyle(`
        ...
        /* Visible state */
        #kick-volume-control.visible {
            opacity: 1;
        }

        /* While dragging we slightly dim it */
    ...
    function init() {
        ...
        // Append to body (position is fixed, so DOM order doesn't matter visually)
        ...
        function dragStart(e) {
            ...
            if (e.target === container || e.target === label || e.target === valueDisplay) {
                ...
                container.classList.add('visible'); // keep visible while dragging
            }
        }
        ...
        // ===== Show/hide logic based on hover =====
        let overIframe = false;
        let overControl = false;

        function updateVisibility() {
            if (overIframe || overControl || isDragging) {
        ...
        // When mouse enters/leaves the iframe area
        kickIframe.addEventListener('mouseenter', () => {
            overIframe = true;
            updateVisibility();
        });

        kickIframe.addEventListener('mouseleave', () => {
            overIframe = false;
            updateVisibility();
        });

        // When mouse enters/leaves the control itself
