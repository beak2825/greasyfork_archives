// ==UserScript==
// @name         Overlay NE Lincoln County
// @namespace    https://greasyfork.org/users/45389
// @version      0.4.4.001
// @description  Adds a layer to display Parcel info for Lincoln County Nebraska
// @author       MapOMatic
...
// @downloadURL https://update.greasyfork.org/scripts/38170/Overlay%20NE%20Lincoln%20County.user.js
// @updateURL https://update.greasyfork.org/scripts/38170/Overlay%20NE%20Lincoln%20County.meta.js
// ==/UserScript==
...
(function() {
    ...
    var _settingsStoreName = 'wme_NE_Lincoln_Co-Parcel';
    ...
    function log(message, level) {
        if (message && (!level || (level <= _debugLevel))) {
            console.log('NE Lincoln Co parcel: ', message);
        }
    }
    ...
    function getUrl(extent, zoom) {
        ...
        var url = 'https://gis2.gisworkshop.com/arcgis/rest/services/Lincoln/MapServer/2/query?geometry=' + encodeURIComponent(geometryStr);
        ...
        if (_mapLayer !== null) {
            ...
            for (var i=0;i<_mapLayer.features.length;i++){
                ...
                if(feature.geometry.containsPoint(mapCenter)) {
                    ...
                    url = 'https://report.gisworkshop.com/report.ashx?county=lincoln&id=' + num + '&type=assessor&subs=true&format=html';
    ...
    function initLayer(){
        ...
        _mapLayer = new OpenLayers.Layer.Vector("Overlay NE Lincoln Co Parcels", {
            uniqueName: "__WMENElincolncopar",
        ...
        WazeWrap.Interface.AddLayerCheckbox("overlay", "NE Lincoln Co Parcel", _settings.layerVisible, onLayerToggleChanged);
    }
