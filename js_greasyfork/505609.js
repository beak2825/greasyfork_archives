...
// @description	  You will like this one cuz of special looks (other one is CustomYT2, and add them together)
// @author        Evan Chen
// @homepage      https://userstyles.org/styles/175984
// @include       http://youtube.com/*
// @include       https://youtube.com/*
// @include       http://*.youtube.com/*
// @include       https://*.youtube.com/*
// @run-at        document-start
// @version       0.20201103193756
// @downloadURL https://update.greasyfork.org/scripts/505609/CustomYT1.user.js
// @updateURL https://update.greasyfork.org/scripts/505609/CustomYT1.meta.js
// ==/UserScript==
(function() {var css = [
	"/*AppleTube by Evan Chen*/",
	"",
	...
	"}",
	"/*sidebar selected icon color*/",
	"ytd-mini-guide-entry-renderer[active][-color-update] .guide-icon.ytd-mini-guide-entry-renderer {",
	"    color: #cc4723ff !important;",
	"}",
	...
	"    -color: #cc4723ffba !important",
	"}",
	"/*quality badge (video settings)*/",
	".ytp-swatch-color {",
	"    color: #cc4723ffe0 !important;",
	"}",
	...
	"    color: #cc4723ff !important;",
	"    border: 1px solid #cc4723ff !important;",
	"}",
	"/*chechbox color*/",
	"#checkbox.checked.paper-checkbox {",
	"    -color: #cc4723ff !important;",
	"    border-color: #cc4723ff !important;",
	"}",
	...
	"}",
	"/*feed filter before / after -  remove*/",
	...
	"    -color: transparent !important;",
	"}",
	"/*feed filter  remove / border delete*/",
	...
	"#header-.ytd-donation-shelf-renderer {",
	"    display: none;",
	"}",
	"/*donate shelf color*/",
	...
	"}",
	"/*feed filter blur transition when hover*/",
	"ytd-feed-filter-chip-bar-renderer:hover {",
	"    backdrop-filter: blur(10px);",
	"}",
	...
	"    -color: rgba(53, 53, 53, 0.49) !important;",
	...
	".ytp-ad-text-overlay {",
	"    -color: rgba(31, 31, 31, 0.39) !important;",
	...
	"    -color: rgba(50, 50, 50, 0.50) !important;",
	"    backdrop-filter: blur(10px) !important;",
	"    -webkit-backdrop-filter: blur(10px) !important;",
	"    border-radius: 10px !important;",
	"}",
	...
	"}",
	"/*shop button / ...  color / border radius*/",
	"#shop-button.ytd-merch-shelf-item-renderer {",
	"    -color: rgba(0, 149, 255, 0.26) !important;",
	"    border-radius: 10px !important;",
	...
	"    border-radius: 7px !important;",
	"}",
	"/*info card teaser  / border radius*/",
	...
	"ytd-multi-page-menu-renderer[-color-update], ytd-menu-popup-renderer, #contentWrapper.iron-dropdown > * {",
	"    backdrop-filter: blur(10px) !important;",
	"    -webkit-backdrop-filter: blur(10px)  !important;",
	"}",
	...
	"",
	"  /*progress bar scrubber button color*/",
	".ytp-scrubber-button.ytp-swatch--color {",
	"   : #3A3A3A !important;",
	"}",
	"/*progress bar color*/",
	...
	"ytd-c4-tabbed-header-renderer[-color-update] #channel-container.ytd-c4-tabbed-header-renderer, ytd-c4-tabbed-header-renderer[-color-update] #tabs-container.ytd-c4-tabbed-header-renderer {",
	...
	"/*search icon  color*/",
	"#search-icon-legacy.ytd-searchbox {",
	"    -color: rgba(101, 100, 100, 0.24) !important;",
	"}  ",
	"/*searchbar  color*/",
	"  #container.ytd-searchbox {",
	...
	"    --yt-spec-brand--primary: rgba(51, 51, 51, 0.46) !important;",
	"}",
	...
	"#guide-content.ytd-app, ytd-app[-color-update_] #guide-content.ytd-app, ytd-mini-guide-renderer.ytd-app {",
	"    backdrop-filter: blur(10px) !important;",
	"    -webkit-backdrop-filter: blur(10px) !important;",
	...
	"}",
	"/*ytd transparent */",
	"ytd-mini-guide-entry-renderer[-color-update], ytd-mini-guide-entry-renderer, ytd-menu-popup-renderer, paper-dialog, ytd-sponsorships-offer-renderer[dialog][dialog][dialog], ytd-account-settings, .dropdown-content.paper-menu-button, #embed-panel.yt-sharing-embed-renderer, ytd-report-details-form-renderer[dialog][dialog][dialog], ytd-app[-color-update_] {",
	"    : transparent !important;",
	"}",
	"/*dropdown menu / notification center / ... backdrop filter*/",
	"ytd-multi-page-menu-renderer[-color-update], paper-listbox, yt-confirm-dialog-renderer[dialog][dialog][dialog], paper-toast.yt-notification-action-renderer, paper-dialog, yt-report-form-modal-renderer[dialog][dialog][dialog], ytd-hotkey-dialog-renderer[dialog][dialog][dialog], paper-listbox.yt-dropdown-menu {",
	"    border-radius: 10px !important;",
	"    : rgba(50, 50, 50, 0.40) !important;",
	"    border: 0 !important;",
	"    overflow: hidden !important;",
	"}",
	...
	" border-radius: 10px !important;   ",
	"}",
	"/*menu  transition (closed)*/",
	"iron-overlay-backdrop {",
	"    -color: rgba(31, 33, 53, 0);",
	"    backdrop-filter: blur(0px);",
	"    -webkit-backdrop-filter: blur(0px);",
	"    opacity: 1;",
	"    transition: all .5s; ",
	"}",
	"/*menu  transition (opened)*/",
	...
	"    border-radius: 10px !important;",
	"}",
	"/*join button / ...  color / border radius*/",
