...
// @downloadURL https://update.greasyfork.org/scripts/28025/Hybrid%20-%20Calls%20-%20Contact%20%28No%20Title%29.user.js
// @updateURL https://update.greasyfork.org/scripts/28025/Hybrid%20-%20Calls%20-%20Contact%20%28No%20Title%29.meta.js
// ==/UserScript==
...
if ($('li:contains("Call - Contact")').length) {
    ...
    createButton('DC',1,2,2,'Disconnected - Directory message');
    createButton('DC',1,2,2,'Disconnected - Did not connect');
