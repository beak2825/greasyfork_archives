...
// @downloadURL https://update.greasyfork.org/scripts/463503/%E6%B5%B7%E8%A7%92%E7%A4%BE%E5%8C%BA%E8%84%9A%E6%9C%AC.user.js
// @updateURL https://update.greasyfork.org/scripts/463503/%E6%B5%B7%E8%A7%92%E7%A4%BE%E5%8C%BA%E8%84%9A%E6%9C%AC.meta.js
// ==/UserScript==
...
(function (DPlayer, hls_js, $) {
  ...
  function main() {
    try {
      ...
      if (!isHaiJiaoPid)
        return;
      const crackBtn = $('<div class="crack_title" id="crack_anal">解析</div>');
      const jumpLink1 = $(
      ...
      const container = $(`<div class="crack_container"></div>`).append(crackBtn).append(jumpLink1).append(jumpLink2).append(copyBtn);
