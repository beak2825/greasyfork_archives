...
// @downloadURL https://update.greasyfork.org/scripts/382970/WME%20Beta%20Review%20Edits.user.js
// @updateURL https://update.greasyfork.org/scripts/382970/WME%20Beta%20Review%20Edits.meta.js
// ==/UserScript==
...
//                     }
        ...
        function RE_waitForSegmentEditDiv(callback, callCount = 0) {
            ...
            if ((div_S.length) || (div_V.length)) {
                ...
                const selection = W.selectionManager.getSelectedFeatures()[0];
                callback();
...
//           var eID;
           var selectedObject = W.selectionManager.getSelectedFeatures()[0]._wmeObject.type;
//               console.log('RPP');
               ...
               a = $.ajax(
                   ...
                   success: function(data)
                       {
                           RE_log('Descartes API call complete. Returned was: ' + a)
                       },
                   async: false
