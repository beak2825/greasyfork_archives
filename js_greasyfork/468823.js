...
// @grant        none
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/468823/Skript%20%D0%93%D0%A1%D0%97%D0%93%D0%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/468823/Skript%20%D0%93%D0%A1%D0%97%D0%93%D0%A1.meta.js
// ==/UserScript==
...
`[I][B][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][CENTER]{{ greeting }},  уважаемый игрок[/CENTER][I][B]<br>` +
   ...
   '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/2yyZ1f9J/1.png[/img][/url][CENTER]'+
`[I][B][COLOR=rgb(255, 0, 0)][FONT=georgia][SIZE=4][CENTER]{{ greeting }},  уважаемый игрок[/CENTER][I][B]<br>` +
    "[I][B][color=#D1D5D8][FONT=georgia][SIZE=4][CENTER] Нарушений со стороны Агента поддержки нет. [/color][/CENTER][/FONT][I][B]<br>" +
    "[I][B][color=red][FONT=georgia][CENTER][ICODE] Отказано.[/ICODE] [/CENTER][/color][/FONT][I][B]<br><br>"+
            "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR] [COLOR=crimson][/COLOR]",
    status: false,
},
