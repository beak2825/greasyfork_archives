...
// @downloadURL https://update.greasyfork.org/scripts/422074/Solved%20Media%20Plus.user.js
// @updateURL https://update.greasyfork.org/scripts/422074/Solved%20Media%20Plus.meta.js
// ==/UserScript==
                ...
                if(solver1.length>0){
                    setTimeout(function(){
                        ...
                        Tesseract.recognize(base64img,'eng',{logger: m => console.log(m)}).then(({data: { text }}) => {
                            ...
                            text=text.replace('’',"'");
                            text=text.replace(/\n/g,' ').trim();
                            console.log('Captcha generated solution: '+text);
