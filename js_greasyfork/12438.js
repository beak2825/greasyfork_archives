...
// @author         Cefín E Otero (cotero2002) 11/22/2015  Last Edited 09/06/2016
// @license        MIT/BSD/X11
...
// @downloadURL https://update.greasyfork.org/scripts/12438/WME%20URComments%20Spanish%20List.user.js
// @updateURL https://update.greasyfork.org/scripts/12438/WME%20URComments%20Spanish%20List.meta.js
// ==/UserScript==
/*jshint multistr: true */
var URCommentSpanishVersion = GM_info.script.version; 
//var URCommentSpanishVersion = "0.4.5"; //manually change this version number to match the script's version 
...
v.0.4.3 2016-09-03 - se modificó el comentario estandar para los reportes de velocidad incorrecta o faltante (cotero2002)";
...
"Estimado usuario - Gracias por tu reporte. La carretera ha sido cerrada.", //Cotero2002 11/20/15
...
"Estimado usuario - La descripción del problema no fue clara y los editores voluntarios no recibimos una respuesta, por lo que estamos cerrando este reporte. Mientras viaja, por favor siéntase bienvenido a informar de cualquier problema que encuentre en el mapa. ¡Gracias!", //Cotero2002 11/20/15
"NotIdentified", 
...
"Estimado usuario - Mientras Waze intenta que la ruta a su destino sea de manera eficiente, no sabe si tiene un transponder para el pago de peaje. Lo sentimos mucho decirle que los editores de mapa voluntarios no pueden ser de mucha ayuda aquí. Mientras viaja, por favor siéntase bienvenido a reportar cualquier problema encuentre en el mapa. ¡Gracias! ", //Cotero2002 11/20/15 11/20/2015
"NotIdentified", 
...
"Estimado usuario - No se recibió mas información sobre el problema, por lo cual este reporte se cierra en este momento. Mientras use Waze, por favor siéntase bienvenido a reportar cualquier problema que encuentre en el mapa. ¡Gracias!", //Carlos Laso
...
"Estimado usuario - ¿Podría dejarnos saber con qué giro está teniendo problemas? ¿Podría decirnos su destino tal y como lo introdujo en Waze? ¡Gracias!", //cotero2002
"Open",
...
//"Volunteer responding - Waze did not send us enough information to fix your request. Would you please let us know what went wrong with the route Waze gave you? Would you tell us your destination as you entered it into Waze? Thanks!", //rickzabel 12/9/14
"Estimado usuario - Waze no nos envió la información suficiente para arreglar su reporte relacionado a alguna intersección incorrecta. ¿Podría por favor hacernos saber lo que salió mal con la ruta Waze te dio? ¿Podría decirnos su destino tal como lo introdujo en Waze? ¡Gracias!", //Carlos Laso
"Open",
...
"Estimado usuario - ¿Podría decirnos lo más detallado posible sobre la carretera que considera que falta? ¡Gracias!", //Cotero2002 09/03/16
"Open",
...
"Estimado usuario - ¿Podría por favor dejarnos saber lo siguiente: ¿Qué carretera está cerrada? ¿Entre qué intersecciones está la carretera cerrada? ¿Sabes cuánto tiempo está previsto el cierre de esta carretera? ¡Gracias!", //Carlos Laso, Cotero2002 11/20/2015
"Open",
...
//Modificado por jcglazo para su uso en Guatemala 12/03/2017