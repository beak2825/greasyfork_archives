// ==UserScript==
// @name         CRYSTAL's Torn Mail Templates
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Manage mail templates with subject & content, modal popup, import/export, edit, load, delete!
// @author       Crystal
// @match        https://www.torn.com/messages.php*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/552200/CRYSTAL%27s%20Torn%20Mail%20Templates.user.js
// @updateURL https://update.greasyfork.org/scripts/552200/CRYSTAL%27s%20Torn%20Mail%20Templates.meta.js
// ==/UserScript==
...
(function () {
  ...
  function loadIntoEditor(htmlContent) {
    ...
    alert('Could not find the message editor.');
  }
  ...
  function createTemplatesButton() {
    const container = document.querySelector('.message-buttons-wrap') || document.querySelector('div[class*="buttons"]');
    if (!container || document.getElementById('openTemplatesBtn')) return;
  ...
  function createTemplateModal() {
    ...
    modal.innerHTML = `
      <h3 style="margin-top: 0;">Manage Mail Templates</h3>
    ...
    importBtn.addEventListener('click', () => {
      const json = prompt('Paste templates JSON here:');
      if (!json) return;
      try {
