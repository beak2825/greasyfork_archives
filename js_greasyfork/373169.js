...
// @date         01/07/2018
// @modified     01/01/2019
// @homepage     https://greasyfork.org/zh-CN/scripts/373169
...
// @grant        GM_addStyle
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/373169/wsmud_plugins.user.js
// @updateURL https://update.greasyfork.org/scripts/373169/wsmud_plugins.meta.js
// ==/UserScript==
(function () {
    "use strict";
    //快捷键功能
    ...
    if (send_cmd == undefined) {
        ...
        document.getElementsByClassName("signinfo")[0].innerHTML += "<br><HIY>请安装前置</HIY><a target='_blank'  href='https://greasyfork.org/zh-CN/scripts/371517'><HIY>https://greasyfork.org/zh-CN/scripts/373168</HIY></a>"
    ...
    const C = {
        ...
        path: {
            ...
            "峨嵋派-紫": "jh fam 4 start;go west;go south;go west;go south",
        ...
        mpz_path: {
            ...
            "峨嵋派": "jh fam 4 start;go west;go south;go west;go south",
...
战斗时间30分钟，结束条件是对方或己方掌门被击杀。</hiy>*/
        ...
        login: function () {
            ...
            if ($(".WG_log").length == 0) {
                ...
                <span class="zdy-item liaoshang">疗伤</span>
...
`;
    ...
    $(document).ready(function () {
        KEY.init();
        WG.init();
        $("head").append("<link href='https://cdnjs.cloudflare.com/ajax/libs/jquery-contextmenu/2.7.1/jquery.contextMenu.min.css' rel='stylesheet'>");
        $.contextMenu({
            selector: ".container",
            autoHide: 0,
            items: {
                ...
                "门派传送": {
                    ...
                    "items": {
                        ...
                        "mp4": { name: "峨眉", callback: function (key, opt) { WG.go("峨嵋派-紫"); }, },
