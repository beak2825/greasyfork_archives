...
// @description       Скрипт, который подходит для сервера MAKHACHKALA , предназначен для быстрой реакции кураторов форума в различных разделах. Он разработан с учётом размеров экрана телефона.
// @downloadURL https://update.greasyfork.org/scripts/560505/%5BMAKHACHKALA%5D%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%5B%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D0%BB%D0%B5%D1%84%D0%BE%D0%BD%D0%B0%5D.user.js
// @updateURL https://update.greasyfork.org/scripts/560505/%5BMAKHACHKALA%5D%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20%5B%D0%94%D0%BB%D1%8F%20%D1%82%D0%B5%D0%BB%D0%B5%D1%84%D0%BE%D0%BD%D0%B0%5D.meta.js
// ==/UserScript==
...
},
{
    ...
    content:
         ...
         'Ваша жалоба передана [COLOR=rgb(255, 255, 0)]на рассмотрение[/COLOR] [COLOR=rgb(255, 0, 0)]Заместителю Главного Администратора.[/COLOR]<br>' +
...
},
{
    ...
    content: 
          '[CENTER][SIZE=4][FONT=Verdana][color=#7FFFD4]Доброго времени суток, уважаемый(-ая)[/COLOR]<br> {{ user.mention }}.<br><br>' +
          '[url=https://postimg.cc/14M7JHxP][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png  [/img][/url]<br><br>' +
          'Ваша жалоба передана [COLOR=rgb(255, 255, 0)]на рассмотрение[/COLOR] [COLOR=rgb(0, 0, 255)]Главному  Кураторy Форума.[/COLOR]<br>' +
          'Убедительная просьба не создавать копий данной темы.<br><br>' +
          '[url=https://postimg.cc/14M7JHxP][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png  [/img][/url]<br><br>' +
          '[COLOR=rgb(0, 0, 255)][ICODE]ГКФ[/ICODE][/COLOR]<br><br>' +
          'Ожидайте ответа.[/FONT][/SIZE][/CENTER]',
    prefix: PIN_PREFIX,
    status: true,
},
...
},
{
    ...
    content:
          ...
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на [COLOR=red]BLACK RUSSIA.[/COLOR]<br>' +
          'С уважением, [COLOR=red]администрация MAKHACHKALA![/COLOR] [/CENTER][/FONT][/SIZE]<br>',
    prefix: ACCEPT_PREFIX,
    status: false,
},    
{
...
},                
{
    ...
    content:
          ...
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на [COLOR=red]BLACK RUSSIA.[/COLOR]<br>' +
          'С уважением, [COLOR=red]администрация MAKHACHKALA![/COLOR] [/CENTER]<br>',
    prefix: ACCEPT_PREFIX,
    status: false,
},                 
{
    ...
    content:
          ...
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>' +
          'Приятной игры на [COLOR=red]BLACK RUSSIA.[/COLOR]<br>' +
          'С уважением, [COLOR=red]администрация MAKHACHKALA![/COLOR] [/FONT][/SIZE][/CENTER]<br>',
    prefix: ACCEPT_PREFIX,
    status: false,
},                     
{
...
},
{
    ...
    content:
          ...
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>'+
          'Приятной игры на [COLOR=red]BLACK RUSSIA.[/COLOR]<br>'+
          'С уважением, администрация MAKHACHKALA![/CENTER][/FONT][/SIZE]<br>',
    prefix: ACCEPT_PREFIX,
    status: false,
},        
{
...
},
{
    ...
    content:
          ...
          '[url=https://postimg.cc/14M7JHxP][img]https://i.postimg.cc/fTh4W2B3/RLwzo.png  [/img][/url]<br>'+
          '[COLOR=rgb(0, 255, 0)][ICODE]Одобрено[/ICODE][/COLOR]<br><br>'+
          'Приятной игры на [COLOR=red]BLACK RUSSIA.[/COLOR]<br>'+
          'С уважением, [COLOR=red]администрация MAKHACHKALA![/COLOR] [/CENTER][/FONT][/SIZE]<br>',
    prefix: ACCEPT_PREFIX,
