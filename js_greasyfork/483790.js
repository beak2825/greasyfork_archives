// ==UserScript==
// @name   script_by_morozoov
// @description:ru Предложения по улучшению скрипта и информацию о багах писать в лс https://vk.com/nikita_moroozoov78532
// @name:ru script morozoov
...
// @license   MIT
// @icon .
// @version 0.0.1.20240103231536
// @description Suggestions for improving the script write here ---> https://forms.gle/xt2YvQApsCDhXcwq8
// @downloadURL https://update.greasyfork.org/scripts/483790/script_by_morozoov.user.js
// @updateURL https://update.greasyfork.org/scripts/483790/script_by_morozoov.meta.js
// ==/UserScript==
// @username Morozoov
(function () {
  'use strict';
  ...
  function getThreadData() {
    ...
    return {
      user: {
        id: authorID,
        name: authorName,
        mention: `[USER=${authorID}]${N.Morozoov}[/USER]`,
      },
      greeting: () =>
        4 < hours && hours <= 11 ?
        'Доброе утро' :
