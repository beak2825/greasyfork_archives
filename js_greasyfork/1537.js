...
// @version        0.08
// @include     https://virtonomica.ru/*/main/brokergame/view/*
// @exclude     https://virtonomica.ru/*/main/brokergame/view/*/players
// @exclude     https://virtonomica.ru/*/main/brokergame/view/*/result
// @downloadURL https://update.greasyfork.org/scripts/1537/Virtonomica%3A%20BrokerYard%20History.user.js
// @updateURL https://update.greasyfork.org/scripts/1537/Virtonomica%3A%20BrokerYard%20History.meta.js
// ==/UserScript==
var run = function() {
...
var wc2 = $("<li id=by_history style='cursor:pointer; color: white;'> <img title='Просмотр прошлого хода' alt='Просмотр прошлого хода' src='https://cdn0.iconfinder.com/data/icons/Toolbar_Icon_Set_2_by_shlyapnikova/32/hourglass.png' width=24px>").click( function() {
   ...
   //console.log( "step ===" + id );
    if ( $("#info_man").html() != "" ) {
        ...
        $.get(url, function(data) {
            ...
            str += "</table>";
			var users = ["uniquai", "test01", "DeMonyan"];
			for( var k=0;k< users.length; k++) {
				str = str.replace( users[k],"<font color=maroon><b>" + users[k] + "</b></font>");
			} 
...
/*
   ...
   if (BrYard[id]['step'] != step ){
    ...
    var wc_back = $("<span id=bt_prev style='cursor:pointer;'> <img width=12px src=https://cdn3.iconfinder.com/data/icons/ginux/Png/Backward-64.png alt='назад' title='назад'></span>");
    var wc_next = $("<span id=bt_next style='cursor:pointer;'> <img width=12px src=https://cdn3.iconfinder.com/data/icons/ginux/Png/Forward-64.png alt='вперед' title='вперед'></span>");
