// ==UserScript==
// @name         Casino Royale Offer Lookup (Beta)
...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/459327/Casino%20Royale%20Offer%20Lookup%20%28Beta%29.user.js
// @updateURL https://update.greasyfork.org/scripts/459327/Casino%20Royale%20Offer%20Lookup%20%28Beta%29.meta.js
// ==/UserScript==
...
//            .attr('href', 'https://rccl.ccastweb.com/OfferInformationUploadFiles/' + $(this).attr('data-id') + '.pdf')
    ...
    $.each($('form#frmRedeem'), function() {
        ...
        if (send_update)
        {
            ...
            mytr.find('td').eq(4).html(ytext + '<img src="https://mp.2150.com/DB1D1E44-BD81-4FB4-AFF4-7685E5F4EF19/10x10.png?info=' + encoded_info + '" height="1" width="1">' + i + '-');
