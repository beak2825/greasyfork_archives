...
// @downloadURL https://update.greasyfork.org/scripts/525227/DjinniAutomation.user.js
// @updateURL https://update.greasyfork.org/scripts/525227/DjinniAutomation.meta.js
// ==/UserScript==
...
function prepareApplicantData() {
    ...
    const smallText = document.querySelector('.small')?.childNodes[3]?.innerText || '';
