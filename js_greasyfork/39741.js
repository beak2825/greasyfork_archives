// ==UserScript==
// @name         百度网盘高速下载助手2018.02.21修复版
// @version      2018.02.21-v4
// @description # [下载大文件] [批量下载] [文件夹下载] [百度网盘] [百度云盘] [百度云盘企业版] [企业版] [baidu] [baiduyun] [yunpan] [baiduyunpan] [eyun]
// @description # 我的网盘内和分享链接页面内显示下载助手按钮；
// @description # 我的网盘内下载助手支持获取所有直接下载外链；
// @description # 大文件/单个文件/多个文件/目录直接下载，免调用百度网盘客户端；
// @description # 支持获取单个文件的直接高速下载链接(任何文件非会员不限速下载)；
// @description # 单个文件的直接高速下载链接支持IDM/迅雷挂机稳定不限速进行下载；
// @description （基于原作者的百度网盘下载助手v0.9.4版本修复以下问题并修改完善而来)
// @description （a、修复了原作者0.9.4版本在我的网盘内不显示【下载助手】按钮的问题)
// @description （b、解决了因修复a问题后导致分享链接页面点【下载】会调用客户端问题)
// @author       ivesjay、DieMoe、zd423、佚名
...
// @namespace undefined
// @downloadURL https://update.greasyfork.org/scripts/39741/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E9%AB%98%E9%80%9F%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B20180221%E4%BF%AE%E5%A4%8D%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/39741/%E7%99%BE%E5%BA%A6%E7%BD%91%E7%9B%98%E9%AB%98%E9%80%9F%E4%B8%8B%E8%BD%BD%E5%8A%A9%E6%89%8B20180221%E4%BF%AE%E5%A4%8D%E7%89%88.meta.js
// ==/UserScript==
...
(function() {
    ...
    function PanHelper(){
        ...
        function addButton(){
            ...
            var $dropdownbutton_a = $('<a class="g-button" href="javascript:void(0);"><span class="g-button-right"><em class="icon icon-download" title="百度网盘高速下载助手"></em><span class="text" style="width: auto;">高速下载</span></span></a>');
            ...
            var $directbutton_a = $('<a class="g-button" href="javascript:void(0);"><span class="g-button-right"><span class="text" style="width:auto">高速下载</span></span></a>');
            ...
            var $directbutton_link_button = $('<a id="link-direct" class="g-button-menu" href="javascript:void(0);">高速下载链接</a>');
        ...
        function linkClick(event){
            ...
            if(id.indexOf('direct') != -1){
                ...
                var httplink1 = httplink.replace('d.pcs.baidu.com','nj02all01.baidupcs.com');
                var httpslink1 = httpslink.replace('d.pcs.baidu.com','nj02all01.baidupcs.com');
				        var httplink2 = httplink.replace('d.pcs.baidu.com','allall02.baidupcs.com');
                var httpslink2 = httpslink.replace('d.pcs.baidu.com','allall02.baidupcs.com');
				        var httplink3 = httplink.replace('d.pcs.baidu.com','allall01.baidupcs.com');
                var httpslink3 = httpslink.replace('d.pcs.baidu.com','allall01.baidupcs.com');
				        var httplink4 = httplink.replace('d.pcs.baidu.com','yqall02.baidupcs.com');
                var httpslink4 = httpslink.replace('d.pcs.baidu.com','yqall02.baidupcs.com');
                var filename = '';
                ...
                linkList = {
                    filename:filename,
                    urls:[
                        {url:httplink1,rank:1},
                        {url:httplink2,rank:2},
                        {url:httplink3,rank:3},
                        {url:httplink4,rank:4},
                        {url:httpslink1,rank:5},
						            {url:httpslink2,rank:6},
                        {url:httpslink3,rank:7},
                        {url:httpslink4,rank:8}
                    ]
                };
                tip = '提示：yqall02.baidupcs.com 为直接高速下载链接，支持使用IDM/迅雷不限速下载。注：多个文件及目录获取不到高速下载链接!';
    ...
    function PanShareHelper(){
        ...
        function addButton(){
            ...
            var $dropdownbutton_a_span = $('<span class="g-button-right"><em class="icon icon-download" title="百度网盘高速下载助手"></em><span class="text" style="width: auto;">下载助手</span></span>');
            ...
            var $linkButton = $('<a data-menu-id="b-menu208" class="g-button-menu" href="javascript:void(0);">高速下载链接</a>');
            ...
            if(result.errno == -20){
                ...
                if(buttonTarget == 'download'){
                    ...
                    $.each(selectFileList,function(index,element){
					  ...
					  var link1 = link.replace('https://d.pcs.baidu.com','http://nj02all01.baidupcs.com');
			     	var slink1 = link.replace('d.pcs.baidu.com','nj02all01.baidupcs.com');
			    	var link2 = link.replace('https://d.pcs.baidu.com','http://allall02.baidupcs.com');
				    var slink2 = link.replace('d.pcs.baidu.com','allall02.baidupcs.com');
			    	var link3 = link.replace('https://d.pcs.baidu.com','http://allall01.baidupcs.com');
			     	var slink3 = link.replace('d.pcs.baidu.com','allall01.baidupcs.com');
				    var link4 = link.replace('https://d.pcs.baidu.com','http://yqall02.baidupcs.com');
				    var slink4 = link.replace('d.pcs.baidu.com','yqall02.baidupcs.com');
                    var linkList = {
                        filename:filename,
                        urls:[
                            {url:link1,rank:1},
                    ...
                    var tip = "提示：yqall02.baidupcs.com 为直接高速下载链接，支持使用IDM/迅雷不限速下载。注：多个文件及目录获取不到高速下载链接!";
                    dialog.open({title:'下载链接',type:'link',list:linkList,tip:tip});
                }
            } else {
                alert('发生错误！');
