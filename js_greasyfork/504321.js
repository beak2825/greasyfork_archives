...
// @downloadURL https://update.greasyfork.org/scripts/504321/Speedrun%20Tools.user.js
// @updateURL https://update.greasyfork.org/scripts/504321/Speedrun%20Tools.meta.js
// ==/UserScript==
...
fetch(`https://hitbox.io/bundle.js`)
    ...
    stateMaker[codeNames.simulation[1]].get = (player,frame) => {
        if (overrideInputs && TAS) {
            return getTasInput(frame) || stateMaker[codeNames.simulation[1]].gettr(player,frame);
        }else{
    ...
    keyDivs.Timer.style.background = 'rgb(0,0,0,0)';
    setTimeout(() => {
        document.querySelector("#appContainer > div.cornerButton.left > div.items.left > div:nth-child(10)").click();
        document.querySelector("#appContainer > div:nth-child(23) > div > div.button.leftButton").click();
    },1500);
