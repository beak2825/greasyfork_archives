// ==UserScript==
// @name         jmzxx
// @namespace    http://jsgl.jiangmen.cn/
// @version      3.03
// @description  jmzxxjs
// @author       Cosil.C
// @match        http*://jsgl.jiangmen.cn/*
// @match        http*://jjsgl.jiangmen.cn/login*
// @icon         https://http://jsgl.jiangmen.cn/#/study/activity
// @license      GPL
// @downloadURL https://update.greasyfork.org/scripts/454883/jmzxx.user.js
// @updateURL https://update.greasyfork.org/scripts/454883/jmzxx.meta.js
// ==/UserScript==

/**
 * jsxx.gdedu.gov.cn域名流控
 */
if (window.location.href.includes('jsgl.jiangmen.cn')) {
