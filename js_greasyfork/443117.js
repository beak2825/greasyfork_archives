...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/443117/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%97%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1.user.js
// @updateURL https://update.greasyfork.org/scripts/443117/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%97%D0%93%D0%A1%20%D0%93%D0%9E%D0%A1%D0%A1.meta.js
// ==/UserScript==
  ...
  `Никто из состава администрации не будет просить у вас все различные пароли, пин-коды, информация о привязках и так далее. Не ведитесь на обманы!`,
...

        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br>` +
                ...
                `С уважением,ЗГС ГОСС - Rostik_Ford.<br>` +
        ...
        },
        {
            ...
            content:
                ...
                "[CENTER]С уважением,ЗГС ГОСС - Rostik_Ford. <br><br>" +
...

        {
            ...
            content: `[SIZE=4][FONT=georgia][CENTER]${greeting}, уважаемый ${user.mention}![/CENTER]<br>` +
                ...
                `Пожалуйста ожидайте ответа от ГС ОПГ - @Kucas_King.<br><br>` +
                `С уважением,ЗГС ГОСС - Rostik_Ford.<br>` +
                `[COLOR=orange]На рассмотрение.[/color] [/CENTER][/FONT][/SIZE]`,
            prefix: PIN_PREFIX,
            status: true,
