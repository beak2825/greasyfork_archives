// ==UserScript==
// @name        CSGODoubleDOTcom
// @namespace   CSGODOUBLE.COM
// @description A CSGODouble.com betting bot
// @include     http://www.csgodouble.com/
// @version     1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/15740/CSGODoubleDOTcom.user.js
// @updateURL https://update.greasyfork.org/scripts/15740/CSGODoubleDOTcom.meta.js
// ==/UserScript==
...
function checkBalance() {
    return getBalance() < currentBetAmount ? (window.alert("BANKRUPT! Not enough balance for next bet, aborting."), clearInterval(refreshIntervalId), !1) : !0
}
