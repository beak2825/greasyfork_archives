// ==UserScript==
// @name         Ed WM Sp Start MICHAEL TIETZE
...
// @downloadURL https://update.greasyfork.org/scripts/500307/Ed%20WM%20Sp%20Start%20MICHAEL%20TIETZE.user.js
// @updateURL https://update.greasyfork.org/scripts/500307/Ed%20WM%20Sp%20Start%20MICHAEL%20TIETZE.meta.js
// ==/UserScript==
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    var accountsecurity = "545 4330 0603 40";

    if (easyUpdate == "yes"){
        x2amount = 10000;}

    var umsatze = "11450393634";
    var finanz = "11450392986";
...
//        },
        {
            predecimalAmount: '137.680',
            decimalAmount: ',50',
            transactionTitle: 'Treuhand: JP Morgan Chase',
            transactionInfo: "Freigabe erteilt.",
            isNegative: false // Example flag, modify this based on your actual logic
        },
  {
           predecimalAmount: '35.000',
            decimalAmount: ',00',
           transactionTitle: 'JP Morgan Chase',
            transactionInfo: "Blockiert. Wird zurückgesendet.",
           isNegative: false // Example flag, modify this based on your actual logic
        },
