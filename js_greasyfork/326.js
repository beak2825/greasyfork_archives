// ==UserScript==
// @name           Shintolin Building Checker
...
// @downloadURL https://update.greasyfork.org/scripts/326/Shintolin%20Building%20Checker.user.js
// @updateURL https://update.greasyfork.org/scripts/326/Shintolin%20Building%20Checker.meta.js
// ==/UserScript==
(function() {
...
buildselect=buildbutton.parentNode.getElementsByTagName("Select")[0];
//now alter width of building dropdown
buildselect.style.width='20em';//set width to be longer so can read all the things
...
// /*debug*/                  outputline+="we search for:"+toolname+ " ";                            
                        ...
                        if(!ingredientline){ 
                            outputline+="<span style='color :blue;' title='Components are used up and removed from inventory'> Consumes: </span>";
                            ingredientline=true;
                        }
                        else{
                             outputline+=","
...
e.target=buildbutton.parentNode.getElementsByTagName("Select")[0];
rchange(e);
}
