...
// @version      1.1
// @description  Auto Login e faucet rotator
// @author       White
// @match        https://doge25.in/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=doge25.in
// @grant        GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/475832/DOGE25.user.js
// @updateURL https://update.greasyfork.org/scripts/475832/DOGE25.meta.js
// ==/UserScript==
...
(async function() {
    ...
    const claimUrls = ["btc","ada","bch","doge","ltc","sol","trx","bnb","zec","dash","dgb","eth","xrp","matic","fey"]
...
const redirectToNextURL = async () => {
    ...
    for (let i = 0; i < claimUrls.length; i++) {
        if (currentURL.includes(claimUrls[i])) {
            ...
            try {
                await delay(5000);
                window.location.href = `https://doge25.in/faucet/currency/${nextURL}`;
...
const claimUrlPrefix = "https://doge25.in/faucet/currency/";

async function init() {
    const targetUrl = "https://doge25.in/?r=496";
...
function redirectToRandomURL() {
    ...
    const randomURL = `https://doge25.in/faucet/currency/${claimUrls[randomIndex]}`;
...
async function Logic() {
  ...
  if (currentUrl === "https://doge25.in/" || currentUrl === "https://doge25.in") {
    window.location.href = "https://doge25.in/?r=496";
  }
}
