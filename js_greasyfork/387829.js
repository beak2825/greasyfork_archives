...
// @version     0.1.1
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/387829/RemoveAVSiteAD.user.js
// @updateURL https://update.greasyfork.org/scripts/387829/RemoveAVSiteAD.meta.js
// ==/UserScript==
...
if (/imgseeds.com|imgcandy.net|imgban.com|imgicy.com|picmoza.com|coimages.xyz/.test(location.hostname)) {
  var continuetoimage = document.querySelector("#continuetoimage input[type='submit']");
  if (continuetoimage) { continuetoimage.click(); }
