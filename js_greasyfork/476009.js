// ==UserScript==
// @name             新国开/国家开放大学免费自动刷课（不答题考试，答题找群主处理）
// @namespace        http://ibaiyu.top/
// @version          1.1.2
// @description   国家开放大学自动刷课（不答题考试，答题找QQ群756253160群主处理） 支持自动处理课件视频、自动发帖回帖，非卖品，全程免费！
// @note             1.1.1: 本次更新已修复无法刷课程的问题 目前已测试过【查看页面】任务【观看视频】任务已正常使用
// @author           一心向善
...
// @downloadURL https://update.greasyfork.org/scripts/476009/%E6%96%B0%E5%9B%BD%E5%BC%80%E5%9B%BD%E5%AE%B6%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%E5%85%8D%E8%B4%B9%E8%87%AA%E5%8A%A8%E5%88%B7%E8%AF%BE%EF%BC%88%E4%B8%8D%E7%AD%94%E9%A2%98%E8%80%83%E8%AF%95%EF%BC%8C%E7%AD%94%E9%A2%98%E6%89%BE%E7%BE%A4%E4%B8%BB%E5%A4%84%E7%90%86%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/476009/%E6%96%B0%E5%9B%BD%E5%BC%80%E5%9B%BD%E5%AE%B6%E5%BC%80%E6%94%BE%E5%A4%A7%E5%AD%A6%E5%85%8D%E8%B4%B9%E8%87%AA%E5%8A%A8%E5%88%B7%E8%AF%BE%EF%BC%88%E4%B8%8D%E7%AD%94%E9%A2%98%E8%80%83%E8%AF%95%EF%BC%8C%E7%AD%94%E9%A2%98%E6%89%BE%E7%BE%A4%E4%B8%BB%E5%A4%84%E7%90%86%EF%BC%89.meta.js
// ==/UserScript==
...
(async function (window, document) {
    ...
    function openApiMaterial() { // 用API去完成查看附件
        ...
        res.catch((xhr, status, error) => {
            console.log(`这里出现了一个异常，联系群主解决 | status: ${status}`);
    ...
    async function openForum() {
        ...
        contentElem.innerHTML = `<p>好好学习，天天向上，答题找QQ群756253160群主。${Date.now()}</p>`;
        submitElem.click();
    ...
    async function courseIndex() {
        await new Promise(resolve => {
            console.log("正在展开所有课程任务，答题找QQ群756253160群主");
            let timeId = setInterval(() => {
                ...
                if (!allCollapsedElement && !allExpandedElement) { throw new Error("无法展开所有课程 可能是元素已更改，请联系群主更新。"); } {
                    console.log("课程展开完成。");
                    clearInterval(timeId);
                    resolve();
                }
        ...
        if (courseElement) {
            console.log("发现未完成的课程，答题找QQ群756253160群主");
            $(courseElement).click();
        } else {
            console.log("课程可能全部完成了，答题找QQ群756253160群主");
        }
    ...
    function main() {
        if (/https:\/\/lms.ouchn.cn\/course\/\d+\/ng.*#\//m.test(document.URL)) {
            ...
            switch (typeEum) {
                case "page":
                    console.log("正在查看页面，答题找QQ群756253160群主。");
                    openViewPage();
                    return;
                case "online_video":
                    openOnlineVideo();
                    return;
                case "web_link":
                    console.log("正在点击外部链接，答题找QQ群756253160群主~");
                    openWebLink();
                    return;
                case "forum":
                    console.log("发帖中！答题找QQ群756253160群主");
                    openForum();
                    return;
                case "material":
