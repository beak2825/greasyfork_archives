...
// @homepage      https://userstyles.org/styles/146429
...
// @downloadURL https://update.greasyfork.org/scripts/33793/Mal%20Dark%20Theme.user.js
// @updateURL https://update.greasyfork.org/scripts/33793/Mal%20Dark%20Theme.meta.js
// ==/UserScript==
(function() {var css = [
	...
	"	{",
	"		background-color: var(--second-background) !important;",
    "       background-image: url(\"https://raw.githubusercontent.com/RaitaroH/MyAnimeList-DeepDark/master/Images/logo.png\") !important;",
	"	}",
	"	/*[[logo]]*/",
	"",
	"	/*Button*/",
	...
	"	}",
	"	.page-common #searchBar.searchBar #topSearchValue, .page-common #searchBar.searchBar .form-select-outer",
	"	{",
	"		height: 22px !important;",
	"	}",
	"	.page-common #searchBar.searchBar #topSearchValue:hover",
	"	{",
	...
	"",
	"	/*Search results*/",
	"	.anime-search-form-block .anime-search-form-search .inputtext, .anime-search-form-block .anime-search-form-search .inputButton",
	"	{",
	"		background-color: var(--second-background) !important;",
	"		color: var(--main-text) !important;",
	"		border-color: var(--hover-background) !important;",
	...
	"	{",
	"		background-image: url(\"https://raw.githubusercontent.com/RaitaroH/MyAnimeList-DeepDark/master/Images/icon_pict_score_mem.png\") !important;",
	"	}",
	"",
	...
	"		opacity: .9;",
	"	}",
	"	.page-common a:hover, .page-common a:visited:hover",
	"	{",
	"		color: var(--main-color) !important;",
	"		opacity: 1;",
	"	}",
	...
	"		border-color: var(--hover-background) !important;",
	"	}",
	"	body.news .news-container .title, .featured-article-body h1, .featured-article-body h2, .featured-article-body h3, .featured-article-body h4, .featured-article-body h5, .featured-article-body h6",
	"	{",
	"		color: var(--main-text) !important;",
	"	}",
	"	hr",
	...
	"	{",
	"		background-image: url(\"https://raw.githubusercontent.com/RaitaroH/MyAnimeList-DeepDark/master/Images/icon-star-score.png\"),url(\"https://raw.githubusercontent.com/RaitaroH/MyAnimeList-DeepDark/master/Images/icon-triangles-completed.png\") !important;",
	"	}",
	"	.user-status-block .form-user-status",
	"	{",
	"		background-color: transparent !important;",
	"		border-color: var(--hover-background) !important;",
	"		background-image: url(\"https://raw.githubusercontent.com/RaitaroH/MyAnimeList-DeepDark/master/Images/icon-triangles-completed.png\") !important;",
	"		color: var(--main-text) !important;",
	"	}",
	...
	"		display: none !important;",
	"	}",
	"	/* > Quick Add Anime/Manga */",
	"	.quickadd-content .quickAdd-anime-result-unit:nth-of-type(odd), .quickadd-content .quickAdd-manga-result-unit:nth-of-type(odd) {",
	"		background-color: var(--second-background) !important;",
	"	}",
	"	.quickadd-content .quickAdd-anime-result-unit:nth-of-type(even), .quickadd-content .quickAdd-manga-result-unit:nth-of-type(even) {",
	"		background-color: var(--hover-background) !important;",
	"	}",
	...
	"		color: var(--main-color) !important;",
	"	}",
	"	.quickadd-content .quickadd-form-search .inputtext:focus, input:focus{",
