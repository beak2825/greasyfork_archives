...
// @downloadURL https://update.greasyfork.org/scripts/472971/BLACK%20RUSSIA%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/472971/BLACK%20RUSSIA%20%7C%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%A0%D1%83%D0%BA%D0%BE%D0%B2%D0%BE%D0%B4%D1%81%D1%82%D0%B2%D0%B0%20%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80%D0%B0.meta.js
// ==/UserScript==
...
const buttons = [
    ...
    },
   {
    ...
    },
    {
      ...
      content:
		"[B][CENTER][SIZE=4][FONT=georgia][COLOR=rgb(184, 49, 47)]Доброго времени суток, уважаемый игрок.[/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>"+
		"[CENTER][B][SIZE=3][FONT=georgia]Ваша жалоба была одобрена, с администратором будет проведена беседа.<br>Также ваше наказание будет снято в течении 24-ёх часов.[/SIZE][/FONT][/B]<br><br>"+
		'[B][CENTER][SIZE=3][FONT=georgia][COLOR=rgb(97, 189, 109)][ICODE]Одобрено[/ICODE][/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>',
      prefix: ACCСEPT_PREFIX,
	  status: true,
    },
    ...
    },
    {
      ...
      content:
		"[B][CENTER][SIZE=4][FONT=georgia][COLOR=rgb(184, 49, 47)]Доброго времени суток, уважаемый игрок.[/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>"+
		"[CENTER][B][FONT=georgia][SIZE=3]В вашей жалобе отсутствуют доказательства о выдачи наказания со стороны администратора.[/SIZE][/FONT][/B]<br><br>"+
    ...
    },
    {
    ...
    },
     {
	  ...
	  status: true,
             ...
             {
      title: 'Ограниченные док-ва',
      content:
		"[B][CENTER][SIZE=4][FONT=georgia][COLOR=rgb(184, 49, 47)]Доброго времени суток, уважаемый игрок.[/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>"+
		"[CENTER][B][FONT=georgia][SIZE=3]Ваши доказательства с ограниченным доступом либо они нерабочие.[/SIZE][/FONT][/B]<br><br>"+
		'[B][CENTER][SIZE=3][COLOR=rgb(184, 49, 47)][FONT=georgia][ICODE]Отказано[/ICODE][/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>',
      prefix: UNACCСEPT_PREFIX,
	  status: true,
    },
    ...
    },
    {
      ...
      content:
		"[B][CENTER][SIZE=4][FONT=georgia][COLOR=rgb(184, 49, 47)]Доброго времени суток, уважаемый игрок.[/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>"+
		"[CENTER][B][FONT=georgia][SIZE=3]Прикрепите окно блокировки вашего аккаунта.[/SIZE][/FONT][/B]<br><br>"+
		'[B][CENTER][SIZE=3][COLOR=rgb(184, 49, 47)][FONT=georgia][ICODE]Закрыто[/ICODE][/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>',
      prefix: CLOSE_PREFIX,
	  status: true,
    },
    ...
    },
    {
      ...
      content:
		"[B][CENTER][SIZE=4][FONT=georgia][COLOR=rgb(184, 49, 47)]Доброго времени суток, уважаемый игрок.[/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>"+
		"[CENTER][B][FONT=georgia][SIZE=3]Ваша жалоба была передана Заместителю Главного администратора сервера.<br> Ожидайте ответа.[/SIZE][/FONT][/B]<br><br>"+
		'[B][CENTER][SIZE=3][COLOR=rgb(184, 49, 47)][FONT=georgia][ICODE]Передано ЗГА[/ICODE][/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>',
	    prefix: NARASSMOTRENIIBIO_PREFIX,
        status: false,
    },
    {
    ...
    },
   {
      ...
      content:
		"[B][CENTER][SIZE=4][FONT=georgia][COLOR=rgb(184, 49, 47)]Доброго времени суток, уважаемый игрок.[/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>"+
		"[CENTER][B][FONT=georgia][SIZE=3]Ваше обжалование составлено не по форме.[/SIZE][/FONT][/B]<br><br>"+
		'[B][CENTER][SIZE=3][COLOR=rgb(184, 49, 47)][FONT=georgia][ICODE]Закрыто[/ICODE][/COLOR][/FONT][/SIZE][/CENTER][/B]<br><br>',
      prefix: CLOSE_PREFIX,
	  status: true,
    },
