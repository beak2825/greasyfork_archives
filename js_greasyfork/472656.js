// ==UserScript==
// @name         5AD(拦截屏蔽广告推广去除登录弹框) 🦄️
// @version      0.1.14
// @namespace    http://www.tampermonkey.net/
// @name:en              No ADs(Block ADs & promotion,remove login box) 🦄️
// @name:zh-CN              5AD(拦截屏蔽广告推广去除登录弹框) 🦄️
// @name:zh-TW              5AD(攔截屏蔽廣告推廣去除登錄彈框) 🦄️
// @description  登录个锤子 + 去除登录弹框❌ | 去除所有广告💯| 去除右键复制另存限制🚫  | ⭕持续更新...
// @description:en      Remove login box ❌ | Remove all ads 💯| Remove restriction of right-click, copy & save🚫 | ⭕Ongoing Updates...
// @description:zh-CN      登录个锤子 + 去除登录弹框❌ | 去除所有广告💯| 去除右键复制另存限制🚫  | ⭕持续更新...
// @description:zh-TW      登錄個錘子 + 去除登錄彈框❌ | 去除所有廣告💯| 去除右鍵復製另存限製🚫  | ⭕持續更新...
// @author       xQQ
// @icon         data:image/x-icon;base64,
// @license MIT
// @copyright    2025, xQQ
...
// @note         Version Update log: 
// @note         0.1.x 代码升级，以适配更多网站
// @note         0.1.x 代码升级，优化去登录弹框的逻辑
// @note         0.1 自用第一版
// @resource     https://code.jquery.com/jquery-3.7.1.min.js
// @Remarks      The Special symbols used: 🦄️❌💯🚫⭕   #️⃣✅❌ Selectstatus(Default+EnabledALL+Disabled)   ✨version,💬feedback; 
// @downloadURL https://update.greasyfork.org/scripts/472656/No%20ADs%28Block%20ADs%20%20promotion%2Cremove%20login%20box%29%20%F0%9F%A6%84%EF%B8%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/472656/No%20ADs%28Block%20ADs%20%20promotion%2Cremove%20login%20box%29%20%F0%9F%A6%84%EF%B8%8F.meta.js
// ==/UserScript==
...
(function() {
    ...
    if(url.indexOf('zhihu.com')!=-1)
    {
        ...
        GM_addStyle('.css-1wq6v87,.css-nk32ej{display:none !important}');//右下方登录提示2
        GM_addStyle('#Popover5-toggle{display:none !important}');////屏蔽无用的"分享"按钮
    ...
    else if(url.indexOf('csdn.net')!=-1)
    {
        ...
        GM_addStyle('.passport-login-mark {display:none !important}');//CSDN登录弹窗2
        GM_addStyle('#csdn-toolbar-profile-nologin {display:none !important}');//登录提示弹窗
        GM_addStyle('.passport-login-tip-container {display:none !important}');//右下角登录提示弹窗
        //<-
        //右侧悬浮导航栏广告
    ...
    else if(url.indexOf('jianshu.com')!=-1)
    {
        ...
        GM_addStyle('._23ISFX-mask, ._23ISFX-wrap _23ISFX-wrap-middle, ._23ISFX{display:none !important}');   //简书二维码弹窗去除
...
function Clean_csdn(){
    ...
    if (GM_getValue("menu_GAEEScript_tc_CSDN")) {
        if(url.match(re_article_details)){
            ...
            Clean_csdn_article_details();//跳转到简化文章详情页
        }
        else if(url.match(re_blog_home)){
            console.log("[CSDN]检测到个人博客页面");
            Clean_csdn_blog_home();//跳转到简化个人博客页
        }
        //简化首页
        //(...)
    }
...
function Clean_csdn_article_details(){
    ...
    var page_width_Y = page_width + 20;//页面居中后宽度     //CSDN宽屏（1.文章详情页）
    GM_addStyle('.nodata .container {left; width:90%; min-width:700px !important}'); //文章的页面居中
    ...
    var _this = unsafeWindow.setInterval(function () {//多次加载增加健壮性
...
function Clean_csdn_blog_home(){
    ...
    //页面居中 & CSDN宽屏 ->
    var count = 0;
    var page_width = $("#mainBox").width(); //博客正文部分页面#mainBox的原始宽度(使用页面总宽度totalWidth)
    var page_width_Y = page_width + 120;//页面居中后宽度     //CSDN宽屏（2.Blog个人博客页）
    //GM_addStyle('#mainBox {width:96%; min-width:1000px !important}');  //CSDN宽屏（Blog个人博客页）
    GM_addStyle('.justify-content-center {left; width:90%; min-width:700px !important}'); //页面居中
    ...
    /*var _page = unsafeWindow.setInterval(function () {
        ...
        if(page_width === undefined){
            ...
            GM_addStyle('#mainBox {align:center !important}');
        }
    },10); */
    //页面居中 & CSDN宽屏 <-

    GM_addStyle('.blog_container_aside {display:none !important}');///隐藏侧边栏
    GM_addStyle('#rightAside {display:none !important}'); ///隐藏博客右侧“热门开源项目”
    GM_addStyle('#gitRelatedProjects {display:none !important}'); ///隐藏博客右侧“热门开源项目”2
    GM_addStyle('.left-toolbox {display:none !important}');///隐藏博客左侧工具箱
    GM_addStyle('.toolbar-btns.onlyUser{display:none !important}');///隐藏顶部右侧会员等无用菜单（无效）
    GM_addStyle('.toolbar-btn.toolbar-btn-vip.csdn-toolbar-fl { display: none !important; }'); ;///隐藏顶部右侧会员等无用菜单
    GM_addStyle('.tool-active-list {display:none !important}');///隐藏收藏提示
    GM_addStyle('.csdn-side-toolbar {display:none !important}');///隐藏右侧导航栏
    //GM_addStyle('.blog-footer-bottom {display:none !important}');///隐藏底部提示  --保留
}
...
function Clean_zhihu(){
    if(GM_getValue("menu_GAEEScript_tc_Zhihu")){
        ...
        GM_addStyle('.Question-mainColumn {width:96%; min-width:1000px !important}');//知乎宽屏
...
function Clean_jianshu(){
    if(GM_getValue("menu_GAEEScript_tc_Jianshu")){
        ...
        GM_addStyle('._gp-ck {width:96%;min-width:1000px !important}');//简书宽屏
...
function Script_setting(){
    ...
    function registerMenuCommand() {
        ...
        menu_ID[menu_ID.length] = GM_registerMenuCommand(`✨ 当前版本 ${version}`, function () {window.GM_openInTab('https://greasyfork.org/zh-CN/scripts/472656', {active: true,insert: true,setParent: true});});
        menu_ID[menu_ID.length] = GM_registerMenuCommand('💬 反馈 & 建议', function () {window.GM_openInTab('https://greasyfork.org/zh-CN/scripts/472656-5ad-%E6%8B%A6%E6%88%AA%E5%B1%8F%E8%94%BD%E5%B9%BF%E5%91%8A%E6%8E%A8%E5%B9%BF%E5%8E%BB%E9%99%A4%E7%99%BB%E5%BD%95%E5%BC%B9%E6%A1%86/feedback', {active: true,insert: true,setParent: true});});
    }
    ...
    function setWidthByClass(className, width) {
        ...
        for (var i = 0; i < elements.length; i++) {
            ...
            if (element.hasAttribute('style')) {
                // 如果有，追加宽度设置
                element.setAttribute('style', element.getAttribute('style') + ' width: ' + width + 'px;');
            } else {
                // 如果没有，设置宽度
