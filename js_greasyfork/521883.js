...
// @version      1.0
// @description  скрипт для феры калашникава
// @author       фера
...
// @downloadURL https://update.greasyfork.org/scripts/521883/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B5%20%D0%A7%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BA%D0%B8.user.js
// @updateURL https://update.greasyfork.org/scripts/521883/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B5%20%D0%A7%D0%BE%D0%BA%D0%BE%D0%BB%D0%B0%D0%B4%D0%BA%D0%B8.meta.js
// ==/UserScript==
 ...
 },
	{
        ...
        dpstyle: 'oswald: 3px;     color: #fff; background: #db2309; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #f53317',
          ...
          
          {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)][ICODE]{{ user.name }}[/ICODE][/COLOR].[/CENTER][/size]<br><br>" +
"[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px] После проверки системы Логирования выяснилось, что выданная блокировка оказалась ошибочной, приносим свои извинения .[/size][/FONT][/COLOR][/CENTER]<br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
            '[CENTER][size=15px][COLOR=rgb(255, 152, 0)][ICODE]На рассмотрении Руководства Технических специалистов...[/ICODE][/size][/CENTER][/COLOR]',
            prefix: PIN_PREFIX,
            status: true,
          }, 
{
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/mrhcH5vR/1621526767066.png[/img][/url][/CENTER]<br>' +
            "[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px][CENTER]{{ greeting }}, уважаемый [/COLOR][COLOR=rgb(255, 204, 0)][ICODE]{{ user.name }}[/ICODE][/COLOR].[/CENTER][/size]<br><br>" +
"[CENTER][COLOR=rgb(209, 213, 216)][FONT=Arial][size=15px] На ваш игровой аккаунт заходило 3-ье лицо. Дабы удостоверится, принадлежит ли вам игровой аккаунт, я отписал (-а) Вам в Личные Сообщения форума..[/size][/FONT][/COLOR][/CENTER]<br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/tgD5Xwhj/1618083711121.png[/img][/url][/CENTER]<br>' +
            '[CENTER][size=15px][COLOR=rgb(255, 152, 0)][ICODE]Жду ответа. На рассмотрении...[/ICODE][/size][/CENTER][/COLOR]',
            prefix: PIN_PREFIX,
            status: true,
          }, 
];
...
const Button54 = buttonConfig("Тех 07", "https://forum.blackrussia.online/forums/Технический-раздел-lime.365/");
const Button55 = buttonConfig("Тех 05", "https://forum.blackrussia.online/forums/%D0%A2%D0%B5%D1%85%D0%BD%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B8%D0%B9-%D1%80%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB-orange.245/");
const Button56 = buttonConfig("жб игроков 05", "https://forum.blackrussia.online/forums/%D0%96%D0%B0%D0%BB%D0%BE%D0%B1%D1%8B-%D0%BD%D0%B0-%D0%B8%D0%B3%D1%80%D0%BE%D0%BA%D0%BE%D0%B2.273/");
const Button57 = buttonConfig("жб тех 05", "https://forum.blackrussia.online/forums/%D0%A1%D0%B5%D1%80%D0%B2%D0%B5%D1%80-%E2%84%965-orange.1186/");
