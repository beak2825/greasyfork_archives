...
// @downloadURL https://update.greasyfork.org/scripts/428416/Torn%3A%20Stats%20on%20Profile%20v2.user.js
// @updateURL https://update.greasyfork.org/scripts/428416/Torn%3A%20Stats%20on%20Profile%20v2.meta.js
// ==/UserScript==
...
(function () {
  ...
  let str, def, dex, spd, tot;
    ...
    if(uid == 1360035) // PUT YOUR ID HERE IF YOU DONT WANT TO SEE IT ON YOUR PROFILE!
      return;
  ...
  const requests = {
    ...
    let y = getStatsEstimate('169777','stats');
    console.log(y);
