...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/533448/SCIRPT%20For%20%D0%9A%D0%A4%20by%20DGrimov.user.js
// @updateURL https://update.greasyfork.org/scripts/533448/SCIRPT%20For%20%D0%9A%D0%A4%20by%20DGrimov.meta.js
// ==/UserScript==
    ...
    const buttons = [
      ...
      },
      {
        ...
        content:
          ...
          "[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/65pRzTQt/animated-line-image-0383.gif[/img][/url]<br><br>" +
          ...
          "[url=https://postimages.org/][img]https://i.postimg.cc/65pRzTQt/animated-line-image-0383.gif[/img][/url]<br><br>" +
      ...
      },
      {
        ...
        content:
          ...
          "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/65pRzTQt/animated-line-image-0383.gif[/img][/url]<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/C10n8xty/image.gif[/img][/url]<br>",
      ...
      },
      {
        ...
        content:
          ...
          "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/65pRzTQt/animated-line-image-0383.gif[/img][/url]<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/t416QfPc/image.gif[/img][/url]<br>",
      ...
      },
      {
        ...
        content:
          ...
          "[B][CENTER][COLOR=#25E225][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>" +
          "[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#00FF00]Одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>" +
          "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]2.31.[/color] Запрещено рекламировать на серверах любые проекты, серверы, сайты, сторонние Discord-серверы, YouTube-каналы и тому подобное [Color=#ff0000]| Ban 7 дней /permban[/color].[/COLOR][/Spoiler][/CENTER][/B]<br><br>" +
          "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/65pRzTQt/animated-line-image-0383.gif[/img][/url]<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/t416QfPc/image.gif[/img][/url]<br>",
        prefix: ACCСEPT_PREFIX,
      ...
      },
      {
        ...
        content:
          ...
          "[B][CENTER][COLOR=#25E225][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>" +
          "[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#00FF00]Одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>" +
          "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]4.10.[/color] Запрещено создавать никнейм, повторяющий или похожий на существующие никнеймы игроков или администраторов по их написанию [Color=#ff0000]| Устное замечание + смена игрового никнейма /permban[/color].[/COLOR][/Spoiler][/CENTER][/B]<br><br>" +
          "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/65pRzTQt/animated-line-image-0383.gif[/img][/url]<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/t416QfPc/image.gif[/img][/url]<br>",
        prefix: ACCСEPT_PREFIX,
      ...
      },
      {
        ...
        content:
          ...
          "[B][CENTER][COLOR=#25E225][ICODE]{{ greeting }}, уважаемый {{ user.name }} [/ICODE][/COLOR][/CENTER][/B]<br><br>" +
          "[B][CENTER][COLOR=lavender] Ваша жалоба [COLOR=#00FF00]Одобрена[/COLOR], игрок будет наказан по следующему пункту правил:<br><br>" +
          "[B][CENTER][Spoiler][COLOR=lavender][FONT=times new roman][Color=#ff0000]2.01.[/color] Запрещено поведение, нарушающее нормы процессов Role Play режима игры [Color=#ff0000]| Jail 30 минут​[/color].[/COLOR][/Spoiler][/CENTER][/B]<br><br>" +
          "[B][CENTER][COLOR=lavender]Приятной игры на [COLOR=black]BLACK[/COLOR] [COLOR=RED]RUSSIA[/COLOR].<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/65pRzTQt/animated-line-image-0383.gif[/img][/url]<br><br>" +
          "[url=https://postimages.org/][img]https://i.postimg.cc/t416QfPc/image.gif[/img][/url]<br>",
        prefix: ACCСEPT_PREFIX,
