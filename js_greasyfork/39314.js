...
// @author			AColdWall
// @description		Easily paste your cops into a spreadsheet
// @version			0.0.3
// @date			2018.03.08
...
// @downloadURL https://update.greasyfork.org/scripts/39314/TaoBao%20Spreadsheet%20Easy%20Paster.user.js
// @updateURL https://update.greasyfork.org/scripts/39314/TaoBao%20Spreadsheet%20Easy%20Paster.meta.js
// ==/UserScript==
...
function ChangeTitle(title){
    ...
    if(ImageRef !== null){
        ...
        if(locale == "US"){
             ImageLink = "".concat("=image(\"",ImageLink,"\",4,100,100)\t=GoogleTranslate(\"",oTitle,"\", \"CN\",\"EN\")\t",window.location.href,"\t",title,"¥","\t=ROUND((GOOGLEFINANCE(\"CURRENCY:CNY",currency,"\")*",title,"),2)","\t=CHAR(10)&CHAR(10)&CHAR(10)&CHAR(10)&CHAR(10)");
        } else {
            ImageLink = "".concat("=image(\"",ImageLink,"\";4;100;100)\t=GoogleTranslate(\"",oTitle,"\"; \"CN\";\"EN\")\t",window.location.href,"\t",title,"¥","\t=ROUND((GOOGLEFINANCE(\"CURRENCY:CNY",currency,"\")*",title,");2)","\t=CHAR(10)&CHAR(10)&CHAR(10)&CHAR(10)&CHAR(10)");
        }
