// ==UserScript==
// @name         CustomChat v2 by Wayz ! Noel
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/21014/CustomChat%20v2%20by%20Wayz%20%21%20Noel.user.js
// @updateURL https://update.greasyfork.org/scripts/21014/CustomChat%20v2%20by%20Wayz%20%21%20Noel.meta.js
// ==/UserScript==
...
var customChat = {
    ...
    hello: function() {
        if((Date.now() - scc.lastH) >= 3600000){
            ...
            $("#taigachat_message").val("Salut aux membre de la shoutbox  " + userinchat + " membres actuellement sur le chat :)");
            this.save();
        }
        else{
