...
// @author		Kirlovon REMIX  LOL KEK CHEBUREK
...
// @downloadURL https://update.greasyfork.org/scripts/476559/Kinopoisk%20Watch.user.js
// @updateURL https://update.greasyfork.org/scripts/476559/Kinopoisk%20Watch.meta.js
// ==/UserScript==
...
const PLAYER_LINK = 'https://www.sspoisk.ru/film/';
...
function updateBanner() {
	...
	if (!movieId || !movieType || !MOVIE_TYPES.includes(movieType)) {
		...
		document.getElementById(BANNER_ID).setAttribute('href', link.toString()+movieId);
	}
}
