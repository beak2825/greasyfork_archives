...
// @downloadURL https://update.greasyfork.org/scripts/2399/Jira%20Deployment%20Helper.user.js
// @updateURL https://update.greasyfork.org/scripts/2399/Jira%20Deployment%20Helper.meta.js
// ==/UserScript==
...
mainCode = function($) {
	...
	function allIssuesDefault(version) {
		if (jQuery('*[data-item-id="allissues"][aria-checked="false"]').length && window.location.href.indexOf('/?filter=') > 1) {
