// ==UserScript==
// @name         answer-in-my-language
// @namespace    http://tampermonkey.net/
// @version      0.5
// @description  Add a "answer in my language" prefix to chatgpt textarea
// @license      BSD
// @author       Julius Kiesian
// @match        https://chat.openai.com/*
// @icon         https://www.google.com/s2/favicons?sz=64&domain=openai.com
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/472346/answer-in-my-language.user.js
// @updateURL https://update.greasyfork.org/scripts/472346/answer-in-my-language.meta.js
// ==/UserScript==
(function () {
    'use strict';
    ...
    function replaceText(textarea) {
        ...
        if (currentValue.length < 2) {
            textarea.value = `Answer me in ${huidegeTaal}. \n${currentValue}`;
        } else {
    ...
    function mijnFunctie() {
        console.log("De website is volledig geladen!");
