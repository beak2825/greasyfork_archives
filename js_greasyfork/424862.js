// ==UserScript==
// @name Krunker  Dogeware - Krunker Cheat
...
// @grant         none
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/424862/Krunker%20%20Dogeware%20-%20Krunker%20Cheat.user.js
// @updateURL https://update.greasyfork.org/scripts/424862/Krunker%20%20Dogeware%20-%20Krunker%20Cheat.meta.js
// ==/UserScript==
        ...
        onLoad() {
            ...
            this.waitFor(_=>this.token).then(_ => {
                ...
                if ( this.isElectron() || !this.isDefined(GM) ) {
                    ...
                    if (confirm('This Script Needs Updating, visit krunker extra youtube now?\n\nCancel will attempt to use the script anyway \n(CHANCE OF BAN)')) {
                        return window.location.assign("https://www.youtube.com/cheats2win");
                    } else {
                        const loader = new Function("WP_fetchMMToken", "Module", this.gamePatch());
                        loader(new Promise(res=>res(this.token)), { csv: async () => 0 });
                        return this.hooking();
...
<div class="imageButton discordSocial" onmouseenter="playTick()" onclick="openURL('https://www.youtube.com/cheats2win')"><span style='display:inline'></span></div>`
