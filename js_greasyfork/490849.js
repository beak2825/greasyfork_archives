...
// @downloadURL https://update.greasyfork.org/scripts/490849/TAMBOV%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.user.js
// @updateURL https://update.greasyfork.org/scripts/490849/TAMBOV%20%7C%20%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D0%A4%D0%BE%D1%80%D1%83%D0%BC%D0%B0.meta.js
// ==/UserScript==
	...
	const buttons = [
        ...
        dpstyle: 'oswald: 3px;     color: #fff; background: #7851A9; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #7851A9',
     	},
           {
            ...
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/d0pnfVgs/vGgCZhi.png[/img][/url][/CENTER]<br>' +
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }} нашего сервера TAMBOV нашего сервера TAMBOV [/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
        ...
        dpstyle: 'oswald: 3px;     color: #fff; background: #7851A9; box-shadow: 0 0 2px 0 rgba(0,0,0,0.14),0 2px 2px 0 rgba(0,0,0,0.12),0 1px 3px 0 rgba(0,0,0,0.2); border: none; border-color: #7851A9',
           ...
           '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
            ...
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Причиной тому послужило - нарушение правил подачи Role Play Биографии, а именно [COLOR=rgb(139, 0, 0)][/COLOR]. Вам стоит исправить ошибки и отправить вашу биографию заново. Перед написанием новой биографии рекомендую ознакомиться с правилами подачи по ссылке - [/FONT][URL='https://forum.blackrussia.online/threads/ivanovo-Правила-создания-roleplay-биографии.6391603/'][FONT=courier new][COLOR=rgb(209, 175, 133)]Правила подачи RP Биографии[/COLOR][/FONT][/URL][FONT=courier new]<br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=6]Данную тему я закрываю.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/d0pnfVgs/vGgCZhi.png[/img][/url][/CENTER]<br>' +
            '[CENTER][SIZE=4][COLOR=rgb(255, 255, 255)]Приятной игры на нашем сервере[/COLOR][COLOR=rgb(209, 175, 133)] TAMBOV[/COLOR]' +
            '[CENTER][SIZE=4][COLOR=rgb(255, 255, 255)]С уважением[/COLOR][COLOR=rgb(97, 189, 109)] Куратор форума [/COLOR]',
          ...
          },
          {
           ...
           '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }} нашего сервера TAMBOV [/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография, мною была рассмотрена и получает статус [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Причиной тому послужило - то что вы скопировари RolePlay Биографию у другого чигрока. Перед написанием новой биографии рекомендую ознакомиться с правилами подачи по ссылке - [/FONT][URL='https://forum.blackrussia.online/threads/ivanovo-Правила-создания-roleplay-биографии.6391603/'][FONT=courier new][COLOR=rgb(209, 175, 133)]Правила подачи RP Биографии[/COLOR][/FONT][/URL][FONT=courier new]<br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=6]Данную тему я закрываю.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/d0pnfVgs/vGgCZhi.png[/img][/url][/CENTER]<br>' +
            '[CENTER][SIZE=4][COLOR=rgb(255, 255, 255)]Приятной игры на нашем сервере[/COLOR][COLOR=rgb(209, 175, 133)] TAMBOV[/COLOR]' +
            '[CENTER][SIZE=4][COLOR=rgb(255, 255, 255)]С уважением[/COLOR][COLOR=rgb(97, 189, 109)] Куратор форума [/COLOR]',
           ...
           '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/vZ2f6V91/2.png[/img][/url][/CENTER]<br>' +
            ...
            '[COLOR=rgb(0, 255, 127)][FONT=times new roman][SIZE=4][I][CENTER][ICODE]{{ greeting }}, уважаемый {{ user.name }} нашего сервера TAMBOV [/ICODE].[/CENTER][/I][/SIZE][/FONT][/COLOR]<br><br>' +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Ваша RolePlay Биография, мною была рассмотрена и получает статус [/SIZE][/FONT][/I][/COLOR][COLOR=rgb(255, 0, 0)][I][FONT=times new roman][SIZE=4]Отказано[/SIZE][/FONT][/COLOR][/CENTER][/I]<br><br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][FONT=times new roman][SIZE=4]Причиной тому послужило - Заголовок RolePlay Биографии написан не по форме. Перед написанием новой биографии рекомендую ознакомиться с правилами подачи по ссылке - [/FONT][URL='https://forum.blackrussia.online/threads/ivanovo-Правила-создания-roleplay-биографии.6391603/'][FONT=courier new][COLOR=rgb(209, 175, 133)]Правила подачи RP Биографии[/COLOR][/FONT][/URL][FONT=courier new]<br>" +
            "[I][CENTER][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=6]Данную тему я закрываю.[/SIZE][/FONT][/COLOR][/CENTER][/I]<br>" +
            '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/d0pnfVgs/vGgCZhi.png[/img][/url][/CENTER]<br>' +
            '[CENTER][SIZE=4][COLOR=rgb(255, 255, 255)]Приятной игры на нашем сервере[/COLOR][COLOR=rgb(209, 175, 133)] TAMBOV[/COLOR]' +
            '[CENTER][SIZE=4][COLOR=rgb(255, 255, 255)]С уважением[/COLOR][COLOR=rgb(97, 189, 109)] Куратор форума [/COLOR]',
