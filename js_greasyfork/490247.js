// ==UserScript==
// @name       KAZAN |Скрипт для STAFF
// @namespace    https://forum.black-russia.9ab.ru/
// @version      1.3
// @description  По вопросам обратная связь в Вк: vk.com/gdz_po_algebre_3_klass
// @author      Bones_Wick
// @match        https://forum.black-russia.9ab.ru/*
// @include      https://forum.black-russia.9ab.ru/
// @grant        none
// @license      MIT
// @collaborator
// @icon https://icons.iconarchive.com/icons/papirus-team/papirus-apps/48/emerald-theme-manager-icon-icon.png
// @downloadURL https://update.greasyfork.org/scripts/490247/KAZAN%20%7C%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20STAFF.user.js
// @updateURL https://update.greasyfork.org/scripts/490247/KAZAN%20%7C%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20%D0%B4%D0%BB%D1%8F%20STAFF.meta.js
// ==/UserScript==
 
(function () {
  'use strict';
const UNACCEPT_PREFIX = 8; // Prefix that will be set when thread closes
const ACCEPT_PREFIX = 13; // Prefix that will be set when thread accepted
const RASSMOTRENO_PREFIX = 4; // Prefix that will be set when solving the problem
const PIN_PREFIX = 1; // Prefix that will be set when thread pins
const GA_PREFIX = 15; // Prefix that will be set when thread send to Chief Administrator
const COMMAND_PREFIX = 16; // Prefix that will be set when thread send to Project Team
const WATCHED_PREFIX = 9;  // Prefix that will be set when thread reviewed by
const CLOSE_PREFIX = 8; // Prefix that will be set when thread closed
const TEX_PREFIX = 14; // Prefix that will be set when thread send to Technical Specialist
const SPEC_PREFIX = 17; // Prefix that will be set when thread send to Special Administrator
const buttons = [
	{
...
"[I][SIZE=1][COLOR=rgb(255, 255, 255)]Приятной игры на[/COLOR][COLOR=rgb(255, 0, 0)][B] Black Russia[/B]", 
      prefix: ACCEPT_PREFIX,
	  status: false,
    },
	{
