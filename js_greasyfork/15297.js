...
// @author       Marentdu93
// @match        https://worldaide.frfr/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/15297/Theme%20Noel.user.js
// @updateURL https://update.greasyfork.org/scripts/15297/Theme%20Noel.meta.js
// ==/UserScript==
$('#logo img').remove();
...
$(document).ready(function(){
    ...
    var css = '#taigachat_box{height:300px;border:1px solid #090100;padding:5px;margin:5px -2px 0 -2px;overflow:auto;overflow-y:scroll;font-size:11px;background: #FFFFFF url("http://i.imgur.com/uU9AypH.jpg") center no-repeat;-webkit-text-size-adjust:none}';
