// ==UserScript==
// @name         DigDig.io AutoOreX Amongus Fork
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  A fork from the original DigDig.io AutoOreX, this include a button to turn off or on the script, also you can press "T" in your keyboard to turn off or on the script!!
// @author       Elmero me ro meron
// @match        *://digdig.io/*
// @icon         https://www.google.com/s2/favicons?domain=digdig.io
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/474439/DigDigio%20AutoOreX%20Amongus%20Fork.user.js
// @updateURL https://update.greasyfork.org/scripts/474439/DigDigio%20AutoOreX%20Amongus%20Fork.meta.js
// ==/UserScript==
...
document.addEventListener('keydown', function (event) {
    if (event.key === 't' || event.key === 'T') {
        toggleScriptAndButton();
    }
});

function toggleScriptAndButton() {
    isRunning = !isRunning;
    setButtonText();
}
