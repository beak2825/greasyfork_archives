// ==UserScript==
// @name         Скрипт by ensemble mansory тф верион
...
// @grant        none
// @license    MIT
// @downloadURL https://update.greasyfork.org/scripts/523668/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20ensemble%20mansory%20%D1%82%D1%84%20%D0%B2%D0%B5%D1%80%D0%B8%D0%BE%D0%BD.user.js
// @updateURL https://update.greasyfork.org/scripts/523668/%D0%A1%D0%BA%D1%80%D0%B8%D0%BF%D1%82%20by%20ensemble%20mansory%20%D1%82%D1%84%20%D0%B2%D0%B5%D1%80%D0%B8%D0%BE%D0%BD.meta.js
// ==/UserScript==
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Рассмотрев ваши доказательства было принято решение, что наказание выдать не можем. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=RED]Закрыто.[/COLOR][/CENTER]<br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Нарушений со стороны данного игрока не было найдено. <br><br>"+
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Семейный слот - не является элементом рыночных отношений. Системно его передача, покупка напрямую другим игрокам не предусмотрена. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][COLOR=#FF0000]Отказано.[/COLOR][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Доказательств на нарушение от данного игрока  отсутствуют. Пожалуйста, для более оперативного рассмотрения вашего обращения создайте новую тему и прикрепите доказательства. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][COLOR=#FF0000]Отказано.[/COLOR][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Доказательства на нарушение от игрока были подвергнуты редактированию/монтажу/склейкам, к сожалению, мы вынуждены отказать. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][COLOR=#FF0000]Отказано.[/COLOR][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE] В данной ситуации необходим фрапс(запись экрана). Предоставленных доказательств недостаточно. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][COLOR=#FF0000]Отказано.[/COLOR][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Видео-доказательство обрывается. Возможно это связано с тем, что хостинг «imgur» не обрабатывает видео, которые занимают более одной минуты (0:59). Смените видеохостинг.  <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][COLOR=#FF0000]Отказано.[/COLOR][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
...
},
{
	  ...
	  content:
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>' +
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=AQUA]{{ greeting }}, уважаемый {{ user.mention }} [/COLOR][/CENTER]<br><br>"+
		"[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Ваши доказательства не открываются/не являются рабочими. <br><br>"+
                "[FONT=times new roman][SIZE=4][CENTER][COLOR=WHITE]Убедительная просьба ознакомиться с «Правилами подачи жалоб на игроков» — [URL='https://forum.blackrussia.online/threads/Правила-подачи-жалоб-на-игроков.3429394/']*Кликабельно*[/URL].<br>"+
                "[FONT=times new roman][SIZE=4][COLOR=#FF0000]Отказано.[/COLOR][CENTER]<br>"+
		"[url=https://postimages.org/][img]https://i.postimg.cc/0Qmc3DdF/image.png[/img][/url]<br>",
      prefix: UNACCСEPT_PREFIX,
