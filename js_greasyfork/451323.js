// ==UserScript==
// @name         MyAnimeList Dubs Latin Spanish
// @name:es      MyAnimeList Doblajes al español latino
// @namespace    https://github.com/nameless0u0
// @version      0.1.11
// @description  Labels Latin Spanish dubbed titles on MyAnimeList.net and adds dub only filtering
// @description:es  Etiqueta de títulos doblados al español latino en MyAnimeList.net y agrega filtrado de solo doblaje
// @author       li0w0
// @supportURL   https://github.com/nameless0u0/MAL-Dubs-Latin-Spanish/issues
// @match        https://myanimelist.net/*
// @iconURL      https://raw.githubusercontent.com/MAL-Dubs/nameless0u0/MAL-Dubs-Latin-Spanish/images/icon.png
// @license      GNU AGPLv3; https://www.gnu.org/licenses/agpl-3.0.html
// @resource     CSS https://raw.githubusercontent.com/nameless0u0/MAL-Dubs-Latin-Spanish/main/css/style.css
...
// @downloadURL https://update.greasyfork.org/scripts/451323/MyAnimeList%20Dubs%20Latin%20Spanish.user.js
// @updateURL https://update.greasyfork.org/scripts/451323/MyAnimeList%20Dubs%20Latin%20Spanish.meta.js
// ==/UserScript==
...
const IDURL = 'https://raw.githubusercontent.com/nameless0u0/MAL-Dubs-Latin-Spanish/main/data/dubInfo.json';
...
function placeHeaderMenu() {
  ...
  menuContainer.innerHTML += '<a id="menu-toggle" title="MAL-dubs" tabindex="0" class="header-dub-button text1"><span id="menu-toggle" class="dub-icon icon"></span></a><div id="dub-dropdown"><ul><li><a id="theme-toggle" href="#"><i class="dub-icon mr6"></i>Switch Style</a></li><li><a href="https://doblaje.fandom.com/es/wiki/Categor%C3%ADa:Anime"><i class="fa-solid fa-calendar-clock mr6"></i>Doblaje wikia</a></li><li><a href="https://github.com/nameless0u0/MAL-Dubs-Latin-Spanish/issues/new/choose" target="_blank" rel="noreferrer"><i class="fa-brands fa-github mr6"></i>Report an Issue</a></li></ul></div>';
