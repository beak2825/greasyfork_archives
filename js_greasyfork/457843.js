...
// @author       -
// @license      MIT
// @description  v2026.01.17.01. 减少启动提示v2025.07.03.01. 修复缓考的学生带来的跳页v2025.07.02.01. 增加提示内容v2025.07.01.01. 对登分册四舍五入和系统的不一样带来的一分差异给与提示。v2024.1.13.03.代码从2018年开始建立，经过多次的修改，形成了稳定版本。
...
(async function () {
    ...
    const msg = "粘贴学号和成绩";
    const hit = "自助版批量粘贴成绩";
    const description = `v2026.01.17.01. 减少启动提示
