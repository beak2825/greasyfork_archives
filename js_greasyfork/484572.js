// ==UserScript==
// @name AudioBookBay hide category: Science
// @description Hide Science category
...
// @downloadURL https://update.greasyfork.org/scripts/484572/AudioBookBay%20hide%20category%3A%20Science.user.js
// @updateURL https://update.greasyfork.org/scripts/484572/AudioBookBay%20hide%20category%3A%20Science.meta.js
// ==/UserScript==

// Wait for the document to be ready
$(document).ready(function() {
    // Hide posts containing the word 'Science'
    $(".post").has(".postInfo:contains('Science')").hide();
});
