...
// @version      -
// @match        *://moomoo.io/*
// @description A pathfinder made by WYND C:
// @match        *://dev.moomoo.io/*
// @match        *://sandbox.moomoo.io/*
// @author       Wynd
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/472622/Pathfinder.user.js
// @updateURL https://update.greasyfork.org/scripts/472622/Pathfinder.meta.js
// ==/UserScript==
const WorkerCode = `
self.onmessage = (msg) => {
    let bitmap = msg.data;
...
window.cpmstarAPI = function(e) {
    ...
    window.addEventListener("keydown", s.checkTrusted((function(e) {
        ...
        69 == t ? r.send("7", 1) : 67 == t ? Tach.setWaypoint("quick", R) : 88 == t ? (R.lockDir = R.lockDir ? 0 : 1,
    ...
    function Ti(e) {
        ...
        for (n = 0; n < e.length; )
            ...
            _.visible = !0),
            n += 13;
        Pathfinder.setPos(R.x2, R.y2);
        Tach.setSend(r.send.bind(r));
        Tach.setSelf(R);
        Tach.updatePlayers(W);
    }
    function Ii(e) {
        for (var t = 0; t < W.length; ++t)
            if (W[t].sid == e)
    ...
    function e() {
        ...
        function() {
            ...
            if(R){
                ...
                be.save();
                be.translate(-f, -d);
                Pathfinder.drawPath(be, "#0000FF", R, "#00FF00");
                Tach.drawWaypoints(be, R.skinRot);
                be.restore();
            }
            for (be.globalAlpha = 1,
