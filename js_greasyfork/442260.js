...
// @downloadURL https://update.greasyfork.org/scripts/442260/Obj.user.js
// @updateURL https://update.greasyfork.org/scripts/442260/Obj.meta.js
// ==/UserScript==
...
const buttons = [
    {
      title: 'Обж одобр до 30',
      content:
		'[FONT=times news roman][CENTER]{{ greeting }}, уважаемый игрок.[/CENTER]<br>' + '[CENTER]  [/CENTER][/FONT]' +
        "[CENTER][FONT=times news roman][I][B]Наказание будет снижено до 30 дней. [/FONT][/I][/B][/CENTER] " +
"[CENTER][FONT=times news roman][I][B]С момента разблокировки просьба не повторять подобных действий. [/FONT][/I][/B][/CENTER] " +
		'[Color=red][CENTER]Одобрено, закрыто.[/CENTER][/color]',
