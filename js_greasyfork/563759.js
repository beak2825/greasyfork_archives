...
// @downloadURL https://update.greasyfork.org/scripts/563759/sunziyue.user.js
// @updateURL https://update.greasyfork.org/scripts/563759/sunziyue.meta.js
// ==/UserScript==
...
(function () {
    ...
    /*** 全局配置 ***/
    const OLD_NAME = "SUN HUI";
    const NEW_NAME = "SUN ZIYUE";
    const NEW_BIRTHDAY = "(**0302)";
    const NEW_EXPIRE_DATE = "2034-08-06";
