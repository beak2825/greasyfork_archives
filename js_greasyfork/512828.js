...
(function () {
    ...
    rootEle.innerHTML =
        ...
        '<input id="searchPrompts" type="text" placeholder="搜索提示词" style="font-size: 14px; flex-grow: 1; padding: 8px; border-radius: 6px; border: 1px solid #D1D5DB; background-color: #f9fafb; color: #111111;"/>' +
        '<button id="clearSearch" style="z-index: 1999999; padding: 8px; border-radius: 6px; cursor: pointer; transition: background-color 0.3s; background-color: #f56565; color: #D1D5DB; display: none;">清除</button>' +
        ...
        '<span id="addPrompt" style="margin:8px; padding: 8px; height:40px; border-radius: 6px; cursor: pointer; transition: background-color 0.3s; background-color: #48bb78; color: #D1D5DB; display: flex; justify-content: center; align-items: center;">添加提示</span>' +
        '<span id="closeBoardButton" style="margin:8px; padding: 8px; height:40px; border-radius: 6px; cursor: pointer; transition: background-color 0.3s; background-color: #f56565; color: #D1D5DB; display: flex; justify-content: center; align-items: center;">关闭</span>' +
        '</div>' +
        ...
        '<div id="promptInputHeader" style="user-select: none; cursor: move; display: flex; color: white; font-size: 16px; font-family: Arial; justify-content: center; align-items: center; padding-bottom: 8px;">输入新的提示词</div>' +

        '<input id="promptName" type="text" placeholder="提示名称" style="font-size: 12px; font-family: Arial; width: 100%; padding: 8px; border-radius: 6px; border: 1px solid #D1D5DB; background-color: #f9fafb; color: #111111;"/>' +
        '<textarea id="promptValue" placeholder="提示内容" rows="4" style="font-size: 12px; font-family: Arial; width: 100%; min-width: 100%; max-width: 100%; margin: 8px 0px; padding: 8px; border-radius: 6px; border: 1px solid #D1D5DB; background-color: #f9fafb; color: #111111;"></textarea>' +

        '<div style="display: flex; justify-content: space-between; align-items: center; bottom: 0; width: 100%; padding: 8px;">' +
        '<button id="submitPrompt" style="padding: 8px; border-radius: 6px; cursor: pointer; transition: background-color 0.3s; background-color: #48bb78; color: #D1D5DB;">添加</button>' +
        '<button id="cancelPrompt" style="padding: 8px; border-radius: 6px; cursor: pointer; transition: background-color 0.3s; background-color: #f56565; color: #D1D5DB;">取消</button>' +
        '</div>' +
