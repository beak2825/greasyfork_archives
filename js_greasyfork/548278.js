// ==UserScript==
// @name         GOG Game Page - GG.Deals & PCGW with Icons + Clean Asterisk Search
// @namespace    http://tampermonkey.net/
// @version      1.4
// @description Adds GG.Deals and PCGamingWiki links to GOG game pages with icons + asterisk that performs a clean PCGW search (simplified title without subtitles or editions)
// @author       -
// @match        https://www.gog.com/*/game/*
// @grant        none
// @license MIT
// @run-at       document-idle
// @downloadURL https://update.greasyfork.org/scripts/548278/GOG%20Game%20Page%20-%20GGDeals%20%20PCGW%20with%20Icons%20%2B%20Clean%20Asterisk%20Search.user.js
// @updateURL https://update.greasyfork.org/scripts/548278/GOG%20Game%20Page%20-%20GGDeals%20%20PCGW%20with%20Icons%20%2B%20Clean%20Asterisk%20Search.meta.js
// ==/UserScript==

(function () {
  'use strict';

  const GGDEALSIconUrl = 'hgg.deals/favicon-32x32.png';
  ...
  const manualSlugOverrides = {
    ...
    'dark souls iii - game of the year edition': 'Dark_Souls_III',
    ...
    return new Promise((resolve, reject) => {
      ...
      const check = () => {
        ...
        if (titleEl) resolve(titleEl);
          ...
          elapsed += interval;
          if (elapsed >= maxMs) reject('Titre introuvable');
  ...
  waitForTitle()
    .then(titleEl => {
      ...
      const GGDEALSUrl = `https://gg.deals/game/${slugFull}/`;
      ...
      const GGDEALSLink = makeLinkWithIcon(GGDEALSUrl, 'GG.deals', GGDEALSIconUrl);
      ...
      asterisk.title = 'Recherche approximative sur PCGamingWiki';
      ...
      container.appendChild(GGDEALSLink);
    ...
    .catch(err => {
      console.warn('Error script GGDEALS/PCGW :', err);
    });
})();
