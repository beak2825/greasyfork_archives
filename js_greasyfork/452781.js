...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/452781/Pikachu%20CSS.user.js
// @updateURL https://update.greasyfork.org/scripts/452781/Pikachu%20CSS.meta.js
// ==/UserScript==
setInterval(() => {
$("#room").css({background: "rgba(247, 218, 69, 0.5)" });
$("#room .more").css({background: "rgba(247, 218, 69, 0.5)"});
$("#room .expand").css({background: "rgba(247, 218, 69, 0.5)"});
$("#room .more .info:hover").css({background: "rgba(247, 218, 69, 0.5)"});
$("#room .more .new").css({background: "rgba(247, 218, 69, 0.5)"});
$("#room .more").css({background: "rgba(247, 218, 69, 0.5)"});
...
$(".notification-body").css({background: "rgba(247, 218, 69, 0.5)", "backdrop-filter": "blur(2px)"});
$(".notification .x:hover").css({background: "rgba(247, 218, 69, 0.5)"});
$(".notification-body").css({background: "rgba(247, 218, 69, 0.5)", "backdrop-filter": "blur(2px)"});
$(".ugly-button .stuck").css({background: "rgba(247, 218, 69, 0.5)"});
document.body.style = `background-image: url('https://i.ibb.co/tKLN9cc/Pika.png'); background-position: 25% 75%; background-size: cover; backdrop-effect: blur(2px);`
}, 1);
