// ==UserScript==
// @name            排序（新）暂时记录·pixiv快速打开原图＆自动收藏＆原图链接打包下载&图片预览
...
// @downloadURL https://update.greasyfork.org/scripts/453351/%E6%8E%92%E5%BA%8F%EF%BC%88%E6%96%B0%EF%BC%89%E6%9A%82%E6%97%B6%E8%AE%B0%E5%BD%95%C2%B7pixiv%E5%BF%AB%E9%80%9F%E6%89%93%E5%BC%80%E5%8E%9F%E5%9B%BE%EF%BC%86%E8%87%AA%E5%8A%A8%E6%94%B6%E8%97%8F%EF%BC%86%E5%8E%9F%E5%9B%BE%E9%93%BE%E6%8E%A5%E6%89%93%E5%8C%85%E4%B8%8B%E8%BD%BD%E5%9B%BE%E7%89%87%E9%A2%84%E8%A7%88.user.js
// @updateURL https://update.greasyfork.org/scripts/453351/%E6%8E%92%E5%BA%8F%EF%BC%88%E6%96%B0%EF%BC%89%E6%9A%82%E6%97%B6%E8%AE%B0%E5%BD%95%C2%B7pixiv%E5%BF%AB%E9%80%9F%E6%89%93%E5%BC%80%E5%8E%9F%E5%9B%BE%EF%BC%86%E8%87%AA%E5%8A%A8%E6%94%B6%E8%97%8F%EF%BC%86%E5%8E%9F%E5%9B%BE%E9%93%BE%E6%8E%A5%E6%89%93%E5%8C%85%E4%B8%8B%E8%BD%BD%E5%9B%BE%E7%89%87%E9%A2%84%E8%A7%88.meta.js
// ==/UserScript==
...
(function() {
  ...
  #blackcover{
        ...
        new MutationObserver(mutations => {//动图预览相关
            ...
            for(var i=0;i<mutations.length;i++){
                if(mutations[i].addedNodes.length!=0){
                    ...
                    else if(mutations[i].addedNodes[0].childNodes[0]!=null&&mutations[i].addedNodes[0].childNodes[0].getElementsByClassName('sc-162tykz-1 bmXCSR')!='null'){//预览图部分预览作者
    ...
    function sortRequest(page,sortTag,stop,isR18){
        allBookmark=[]
        GM_xmlhttpRequest({
            method: "GET",
            ...
            onload: function(res) {
                if(res.status === 200){
                    ...
                    for(var r=0;r<30;r++){
                        ...
                        if(sort_info[6]=="true"&&isR18==1){
                            continue
                        }
                        else if(sort_info[6]=="false"&&isR18==2){
                            continue
                        }
                    ...
                    if(stop==false){
                        sortRequest(page+1,sortTag,true,isR18)
                    }
                }
            }
        })
    ...
    function checkCookie(){
        ...
        morefunction.addEventListener('click',()=>{
            ...
            if(w>0){
                ...
                elem_4.style.transform="rotate(46deg) translateX(130px)"
                elem_5.style.transform="rotate(-41deg) translateX(140px)"
                elem_6.style.transform="rotate(65deg) translateX(138px)"
                elem_7.style.transform="rotate(1deg) translateX(79px)"
                elem_8.style.transform="rotate(3deg) translateX(126px)"
                elem_9.style.transform="rotate(-60deg) translateX(148px)"
                elem_10.style.transform="rotate(-19deg) translateX(132px)"
                elem_11.style.transform="rotate(-54deg) translateX(102px)"
                elem_12.style.transform="rotate(25deg) translateX(127px)"
                click_num++
            }
            else if(w<0){
    ...
    No12.addEventListener('click',function(e){
        ...
        if(sortTag!=null){
            sortRequest(1,sortTag,false,isR18)
        }
        ...
        sort_more_background.onclick=function(){
            ...
            */
            ...
            sortRequest(sort_search_page+1,sortTag,false,isR18)
        }
    })
    //————————————————————————————————————————————————————————————
    ...
    document.body.addEventListener('mousemove',function(event){
        ...
        if((pre_check=="1"||pre_check=="2"||pre_check=="3")&&event.ctrlKey!=true){
            ...
            for(var ab=0;ab<10;ab++){
                ...
                else if(eventt.className=="sc-1nhgff6-4 boBnlf"||eventt.className=="sc-l7cibp-1 krFoBL"||eventt.className=="sc-9y4be5-1 jtUPOE"||eventt.className=="sc-1kr69jw-0 hkzusx"||eventt.className=="userImgUl"||eventt.className=="sort_ul"){//分别对应“大图页面画师下方滚动图”，“大图页面图片推荐、主页‘推荐作品’”，“主页除‘推荐作品’以外大部分位置”，更多作者图片ul元素，收藏数排序图片ul元素
                    var className=true
                    break
                }
                else{
