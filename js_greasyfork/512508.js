// ==UserScript==
// @name         script for kenza balbes
// @namespace    https://forum.blackrussia.online
// @version      3.3
// @description  script for kenza balbesik
// @author       Давид
...
// @downloadURL https://update.greasyfork.org/scripts/512508/script%20for%20kenza%20balbes.user.js
// @updateURL https://update.greasyfork.org/scripts/512508/script%20for%20kenza%20balbes.meta.js
// ==/UserScript==
  ...
  const buttons = [
      {
        ...
        },
        {
         ...
         '[CENTER][COLOR=#8a2be2]{{ greeting }}, уважаемый {{ user.name }} <br><br>' +
          ...
          '[CENTER][url=https://postimages.org/][img]https://i.ibb.co/rF87DNV/23e304932c71453a.png[/img][/url][/CENTER]<br>' +
           '[CENTER][url=https://postimages.org/][img]https://share.creavite.co/670c26bc7b08427e2459b7a9.gif[/img][/url][/CENTER]<br>' ,
          prefix: PIN_PREFIX,
          status: true,
        },
        {
