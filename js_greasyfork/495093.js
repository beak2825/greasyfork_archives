// ==UserScript==
// @name         Bottless Leaderboard for Legend Express Agario Mod
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/495093/Bottless%20Leaderboard%20for%20Legend%20Express%20Agario%20Mod.user.js
// @updateURL https://update.greasyfork.org/scripts/495093/Bottless%20Leaderboard%20for%20Legend%20Express%20Agario%20Mod.meta.js
// ==/UserScript==
...
(function() {
    ...
    function extractNicks() {
        ...
        if (
            ...
            legendmod.hasOwnProperty("leaderboard")
        ) {
            let nicks = legendmod.leaderboard.map((obj) => obj.nick);
            nicks.forEach((nick) => {
...
`;
        ...
        const targetDiv = document.querySelector(".agario-exp-bar progress");
        if (targetDiv) {
