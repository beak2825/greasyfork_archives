...
// @match       http://cl.xclcl.org/htm_data/*
// @match       http://www.javbus.in/*
// @match       http://t66y.com/htm_data/*
// @match       http://www.bthand.com/*
// @match       http://www.cilihome.com/*
...
// @grant       GM_openInTab
// @run-at      document-end
// @downloadURL https://update.greasyfork.org/scripts/15218/CL115%E7%A6%BB%E7%BA%BF%E5%8A%A9%E6%89%8B.user.js
// @updateURL https://update.greasyfork.org/scripts/15218/CL115%E7%A6%BB%E7%BA%BF%E5%8A%A9%E6%89%8B.meta.js
// ==/UserScript==
var X_userID = '0'; //115用户ID
X_userID = GM_getValue('X_userID', '0'); //115用户ID缓存
// alert('user id: ' + X_userID);
//获取115ID
if (X_userID == '0') {
...
$('body').find('a').each(function () {
  if ($(this).html().indexOf('magnet:') >= 0) {
    ...
    //     alert('magnet: ' + maglink);
    LXTo115($(this).html());
  }
});

// http://www.cililian.com/
...
if (thisURL.indexOf('#') >= 0) {
  ...
  //将种子下载地址转换为磁力链接
  var magnet = 'magnet:?xt=urn:btih:' + $('a:contains(\'rmdown\')').text().split('=') [1].slice(3);
