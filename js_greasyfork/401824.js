// ==UserScript==
// @name         MZExtension.MaxeosColores.ClonarTacticas.Floodish
// @namespace    floodish
// @version      5.13
// @description  Complemento para colorear maxeos/no maxeos de jugadores en MZ. Clonar Tacticas de manera sencilla.
// @author       van (edit by floodish)
...
// @downloadURL https://update.greasyfork.org/scripts/401824/MZExtensionMaxeosColoresClonarTacticasFloodish.user.js
// @updateURL https://update.greasyfork.org/scripts/401824/MZExtensionMaxeosColoresClonarTacticasFloodish.meta.js
// ==/UserScript==
...
var vanGmMzModel = {
    ...
    language: {
        ...
        es: {
            ...
            AutoRun1: "A medida que se actualiza/refresh la pagina de MZ",
...
var vanGmMz = {
    ...
    initgw: function () {
        ...
        css.type = 'text/css';
        css.innerHTML = ".gw_run_div{position:fixed;bottom:20%;right:1px;border:1px solid gray;padding:3px;width:12px;font-size:12px;border-radius: 3px;text-shadow: 1px 1px 3px #676767;background-color: #000000;color: #FFFFFF;cursor: default;}.gw_run{cursor:pointer;}.gw_div_left{float:left;position:fixed;left:0px;top:120px;height:528px;overflow-y:auto;text-align:left;}.gw_div_right{float:right;position:fixed;right:0px;top:120px;height:528px;overflow-y:auto;text-align:left;}.shupai{writing-mode:tb-rl;-webkit-writing-mode:vertical-rl;}.gm_ytc{font-style:italic;text-decoration:underline;}.gm_scout_h{font-weight: bold;text-decoration:underline dotted black;}.gm_s1{color:forestgreen;}.gm_s2{color:orange;}.gm_s3{color:fuchsia;}.gm_s4{color:deepskyblue;}";
