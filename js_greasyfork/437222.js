// ==UserScript==
// @name               New w.qianyix.com_optimization
// @name:zh-CN         新版qianyix.com单词查询优化
// @namespace          w.qianyix.com.words
// @version            0.0.6
// @description        simplify w.qianyix.com (remove irrelevant contents, such as ads); add a ru_wiktionary link; convert blanks to <br>; reorder contents
// @description:zh-CN  【已完成】精简w.qianyix.com单词页面（删除无关内容，比如广告和最上方那一栏）；增加到ru_wiktionary的链接；；内容顺序修改(div-id-dict#)，把变格变位移动到基础释义和行业释义中间；行业释义到蓝色链接无效，直接删除；基础释义处反查链接（正则匹配连续俄文字符或者利用空格和方括号分隔）。【待实现】行业释义里li元素的换行符修正（按钮控制）
// @author             Sasha
// @match              *://w.qianyix.com/*
// @downloadURL https://update.greasyfork.org/scripts/437222/New%20wqianyixcom_optimization.user.js
// @updateURL https://update.greasyfork.org/scripts/437222/New%20wqianyixcom_optimization.meta.js
// ==/UserScript==
...
(function() {
    ...
    var addRuLink=function(){
        ...
        //eg. https://w.qianyix.com/index.php?q=%s
        ...
        //向已有的元素追加这个新元素
        var parentNode=document.getElementsByClassName("form-index")[0];
