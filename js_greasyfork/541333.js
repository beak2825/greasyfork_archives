// ==UserScript==
// @name         Enhanced Fight Helper - PRO
...
// @downloadURL https://update.greasyfork.org/scripts/541333/Enhanced%20Fight%20Helper%20-%20PRO.user.js
// @updateURL https://update.greasyfork.org/scripts/541333/Enhanced%20Fight%20Helper%20-%20PRO.meta.js
// ==/UserScript==
...
(function () {
    ...
    function checkAttackable(data, userId, buttonEl) {
        if ("startErrorTitle" in data) {
            buttonEl.innerText = "Check again";
        } else {
            if (
                ...
                // Appliquer le style positionné
                positionCustomButton(buttonEl2, defaultWeapon);
            } else {
                const parentElement = buttonEl.parentElement;
                parentElement.removeChild(buttonEl);
    ...
    function addReloadButton(data, userId, buttonEl) {
        ...
        buttonEl2.addEventListener("click", () =>location.reload());
        parentElement.insertBefore(buttonEl2, parentElement.firstChild);
