// ==UserScript==
// @name         Masterix BumpyBall Client (Improved)
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/533738/Masterix%20BumpyBall%20Client%20%28Improved%29.user.js
// @updateURL https://update.greasyfork.org/scripts/533738/Masterix%20BumpyBall%20Client%20%28Improved%29.meta.js
// ==/UserScript==
    ...
    window.WebSocket = function(...args) {
        ...
        ws.send = function(data) {
            if (data instanceof ArrayBuffer) {
                ...
                //select car
                if(selectedCar==0){
                    var car0 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 0, 56, 1];
                    originalSend.call(this, new Uint8Array(car0));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 1) {
                    var car1 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 1, 56, 1];
                    originalSend.call(this, new Uint8Array(car1));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 2) {
                    var car2 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length,...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 2, 56, 1];
                    originalSend.call(this, new Uint8Array(car2));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 3) {
                    var car3 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 3, 56, 1];
                    originalSend.call(this, new Uint8Array(car3));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 4) {
                    var car4 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 4, 56, 1];
                    originalSend.call(this, new Uint8Array(car4));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 5) {
                    var car5 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 5, 56, 1];
                    originalSend.call(this, new Uint8Array(car5));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 6) {
                    var car6 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 6, 56, 1];
                    originalSend.call(this, new Uint8Array(car6));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 7) {
                    var car7 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length,...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 7, 56, 1];
                    originalSend.call(this, new Uint8Array(car7));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 8) {
                    var car8 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 8, 56, 1];
                    originalSend.call(this, new Uint8Array(car8));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 9) {
                    var car9 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 9, 56, 1];
                    originalSend.call(this, new Uint8Array(car9));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 10) {
                    var car10 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 10, 56, 1];
                    originalSend.call(this, new Uint8Array(car10));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 11) {
                    var car11 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 11, 56, 1];
                    originalSend.call(this, new Uint8Array(car11));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 12) {
                    var car12 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 12, 56, 1];
                    originalSend.call(this, new Uint8Array(car12));
                    gameInstance.SendMessage('NetworkLayer','SetSkin', selectedCar);
                }
                if (selectedCar == 13) {
                    var car13 = [8, 1, 18, usernamearray.length + 37, 10, usernamearray.length, ...usernamearray, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 13, 56, 1];
                ...
                // NOT AVAILABLE
                // if (selectedCar == 14) {
                //     var car14 = [8, 1, 18, 45, 10, 6, 77, 84, 88, 54, 54, 54, 18, 28, 65, 85, 51, 115, 49, 111, 120, 101, 86, 113, 79, 80, 74, 116, 56, 87, 114, 104, 52, 104, 69, 102, 52, 121, 102, 56, 57, 50, 24, 230, 6, 32, 14, 56, 1];
