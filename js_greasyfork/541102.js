...
// @downloadURL https://update.greasyfork.org/scripts/541102/Forum%20Curators%20Script.user.js
// @updateURL https://update.greasyfork.org/scripts/541102/Forum%20Curators%20Script.meta.js
// ==/UserScript==
var images = document.getElementsByTagName("img");
var x = 0;
while (x < images.length) {
    if (images[x].src == "https://forum.blackrussia.online/threads/") {
...
const buttons = [
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
'[I][FONT=times new roman][COLOR=rgb(209, 213, 216)][SIZE=4]Нарушитель будет наказан по следующему пункту общих правил серверов:[/SIZE][/COLOR]<br>' +
"[COLOR=rgb(255, 0, 0)][SIZE=4]2.16. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещен SK (Spawn Kill) — убийство или нанесение урона на титульной территории любой фракции / организации, на месте появления игрока, а также на выходе из закрытых интерьеров и около них[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Jail 60 минут / Warn (за два и более убийства) [/SIZE][/COLOR]<br>" +
    ...
    },
	{
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]Доброго времени суток, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель будет наказан по следующему пункту правил для государственных организаций:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
