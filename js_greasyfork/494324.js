...
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/494324/%E5%8F%94%E5%8F%94%E4%B8%8D%E7%BA%A6%E5%8C%B9%E9%85%8D%E5%A5%B3%E9%97%AE.user.js
// @updateURL https://update.greasyfork.org/scripts/494324/%E5%8F%94%E5%8F%94%E4%B8%8D%E7%BA%A6%E5%8C%B9%E9%85%8D%E5%A5%B3%E9%97%AE.meta.js
// ==/UserScript==


//整体流程：每秒执行一次检查，每次检查中先检查当前是否为女生，再检查是否为新女生
...
(function () {
    ...
    function stay() {
        ...
        if (rightMessageCount === 0) {
            // 输入，在这里设置问候语
            msgInput.value = "是喜欢被骂的姆猪？"
            msgInput.dispatchEvent(new Event('input'))
            msgInput.dispatchEvent(new Event('change'))

            // 发送
            if (msgInput.value == "是喜欢被骂的姆猪？" && sendButton) {
                sendButton.click();
            }
         }
    }
