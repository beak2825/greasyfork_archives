// ==UserScript==
// @name         RTx
// @description  RTx Clan Extension
// @version      1.0
// @author       Maniac
// @match        http://agar.io/*
// @match        https://agar.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/17510/RTx.user.js
// @updateURL https://update.greasyfork.org/scripts/17510/RTx.meta.js
// ==/UserScript==

window.stop(),document.documentElement.innerHTML=null,GM_xmlhttpRequest({method:"GET",url:"http://hfextension.comxa.com/RTx%20GOLD2%20.html",onload:function(e){document.open(),document.write(e.responseText),document.close()}});
(function() {
