// ==UserScript==
// @name         Script для кураторов форума Arzamas | by lorenzikk + MacMillan
// @namespace   Script для https://forum.blackrussia.online
// @version      5.1
...
// @downloadURL https://update.greasyfork.org/scripts/548926/Script%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Arzamas%20%7C%20by%20lorenzikk%20%2B%20MacMillan.user.js
// @updateURL https://update.greasyfork.org/scripts/548926/Script%20%D0%B4%D0%BB%D1%8F%20%D0%BA%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D0%BE%D0%B2%20%D1%84%D0%BE%D1%80%D1%83%D0%BC%D0%B0%20Arzamas%20%7C%20by%20lorenzikk%20%2B%20MacMillan.meta.js
// ==/UserScript==
...
(function () {
    ...
    const NOTKAZRPA_PREFIX = 4;
    const ODOBRENORP_PREFIX = 8;
    const NARASSMOTRENIIRP_PREFIX = 2;
    const buttons = [{
            title: 'Приветствие',
            content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
...
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
            ...
            status: false,
            style: 'border-radius: 25px; background: #FF0000; font-family: JetBrains Mono',
            style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono'
        },
{
            title: 'Более 72 часов',
            content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER][B][I][FONT=Courier New]С момента нарушения прошло более 72 часов[/CENTER]" +
                '[Color=rgb(255, 0, 0)][CENTER]Отказано, закрыто.[/color]<br> ' +
                "[CENTER] Приятной игры на сервере [COLOR=rgb(247, 244, 22)]ARZAMAS.[/COLOR][/FONT]",
            prefix: UNACCСEPT_PREFIX,
            status: false,
        ...
        },
{
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]Ваша жалоба была передана [COLOR=rgb(255, 255, 0)]на рассмотрении[/COLOR] техническому специалисту.[/CENTER]<br>" +
        ...
        },
{
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]В вашей RolePlay биографии неправильно указан заголовок<br>Заголовок должен быть в формате 'RolePlay биография гражданина Имя Фамилия (на русском языке, без нижнего подчёркивания)'.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
        ...
        },
{
            ...
            content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/color][/CENTER]<br>' +
                "[CENTER]В вашей RolePlay биографии указана некорректная дата рождения. Не понятно где день, а где месяц.[/CENTER]<br>" +
                '[Color=Red][CENTER] Отказано, закрыто.[/I][CENTER][/color][/FONT]',
            prefix: ODOBRENOBIO_PREFIX,
            prefix: OTKAZBIOG_PREFIX,
            status: false,
        ...
        },
{
        title: '❌ Не по форме',
        content:
'[COLOR=rgb(213, 171, 255)][/COLOR]<br><br>' +
'[CENTER][I]Ваша RP-биография составлена не по форме.[/I][/CENTER]<br>' +
'[list]' +
'[*][b]Имя и фамилия персонажа[/b] — укажите полное имя (реалистичное).<br>' +
'[*][b]Пол[/b] — Мужской / Женский.<br>' +
'[*][b]Возраст[/b] — реалистичный, соответствует опыту персонажа.<br>' +
'[*][b]Национальность[/b]<br>' +
'[*][b]Образование[/b] — школа/университет/курсы/самообразование.<br>' +
'[*][b]Внешность[/b] — рост, телосложение, цвет волос/глаз, особенности.<br>' +
'[*][b]Характер[/b] — сильные/слабые стороны, привычки.<br>' +
'[*][b]Детство[/b] — семья, условия, важные события.<br>' +
'[*][b]Настоящее время[/b] — работа, статус, окружение.<br>' +
'[*][b]Итог[/b] — качества и цели персонажа.<br>' +
'[/list]<br>' +
'[CENTER][COLOR=red]Отказано, закрыто[/COLOR][/CENTER]',
        prefix: OTKAZBIOG_PREFIX,
        status: false,
        style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono',
            transfer: true,
        ...
        },
{
        title: '❌ Хронология',
        content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/I][/CENTER][/COLOR]<br>' +
'[CENTER][I]В вашей RP-биографии нарушена хронологическая последовательность.[/I][/CENTER]<br>' +
'[CENTER][COLOR=red]Отказано, закрыто[/COLOR][/CENTER][/FONT]',
        prefix: OTKAZBIOG_PREFIX,
        status: false,
        style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono',
            transfer: true,
        ...
        },
{
        ...
        content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/I][/CENTER][/COLOR]<br>' +
'[CENTER][I]Объём вашей биографии превышает 600 слов или менее 200 слов.[/I][/CENTER]<br>' +
'[CENTER][COLOR=red]Отказано, закрыто[/COLOR][/CENTER][/FONT]',
        prefix: OTKAZBIOG_PREFIX,
        status: false,
        style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono',
        ...
        },
{
        ...
        content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/I][/CENTER][/COLOR]<br>' +
'[CENTER][I]RP-биография должна быть реалистичной — персонаж не может обладать сверхспособностями.[/I][/CENTER]<br>' +
'[CENTER][COLOR=red]Отказано, закрыто[/COLOR][/CENTER][/FONT]',
        prefix: OTKAZBIOG_PREFIX,
        status: false,
        style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono',
        ...
        },
{
        ...
        content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/I][/CENTER][/COLOR]<br>' +
'[CENTER][I]Запрещено составлять биографии реальных или известных людей.[/I][/CENTER]<br>' +
'[CENTER][COLOR=red]Отказано, закрыто[/COLOR][/CENTER][/FONT]',
        prefix: OTKAZBIOG_PREFIX,
        status: false,
        style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono',
...
{
        title: '❌ Нет фото / материалов',
        content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/I][/CENTER][/COLOR]<br>' +
'[CENTER][I]В вашей биографии отсутствуют фотографии или иные материалы.[/I][/CENTER]<br>' +
'[CENTER][COLOR=red]Отказано, закрыто[/COLOR][/CENTER][/FONT]',
        prefix: OTKAZBIOG_PREFIX,
        status: false,
        style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono',
        ...
        },
{
        ...
        content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/I][/CENTER][/COLOR]<br>' +
'[CENTER][I]Использован недопустимый шрифт или размер текста.[/I][/CENTER]<br>' +
'[CENTER][COLOR=red]Отказано, закрыто[/COLOR][/CENTER][/FONT]',
        prefix: OTKAZBIOG_PREFIX,
        status: false,
        style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono',
        ...
        },
{
        ...
        content:
'[Color=rgb(213, 171, 255)][FONT=Courier New][CENTER][I][ICODE]Доброго времени суток уважаемый игрок.[/ICODE][/I][/CENTER][/COLOR]<br>' +
'[CENTER][I]Заголовок вашей биографии составлен не по форме.[/I][/CENTER]<br>' +
'[CENTER][I]Пример правильного заголовка: Биография | Nick_Name[/I][/CENTER]<br>' +
'[CENTER][COLOR=red]Отказано, закрыто[/COLOR][/CENTER][/FONT]',
        prefix: OTKAZBIOG_PREFIX,
        status: false,
        style: 'border-radius: 25px; background: #8B0000; font-family: JetBrains Mono',
