...
// @downloadURL https://update.greasyfork.org/scripts/19293/iIronicBeta.user.js
// @updateURL https://update.greasyfork.org/scripts/19293/iIronicBeta.meta.js
// ==/UserScript==
...
setTimeout(function() {
    ...
    var socket = io.connect('ws://www.testbot-iironicgameryt.c9users.io:8081');
    var canMove = true;
   ...
   socket.on('spawn-count', function(data) {
    ...
    $("#instructions").replaceWith('<br><div class="input-group"><span class="input-group-addon" id="basic-addon1">Special Code Give To iIronic</span><input type="text" value="' + client_uuid + '" readonly class="form-control"</div>');
