// ==UserScript==
// @name         DLsite 购买记录分析工具_Extensions
// @namespace    https://github.com/linyaocrush/DLsite-Purchase-Analyzer
// @version      1.1
// @description  基于用户行为的DLsite购买记录深度分析工具，支持可视化图表、交互式弹窗和智能数据导出，脚本化以方便使用
// @author       linyaocrush
// @match        https://www.dlsite.com/*
// @grant        GM_registerMenuCommand
// @icon         https://www.dlsite.com/images/web/common/favicon.ico
// @license MIT
// @downloadURL https://update.greasyfork.org/scripts/530432/DLsite%20%E8%B4%AD%E4%B9%B0%E8%AE%B0%E5%BD%95%E5%88%86%E6%9E%90%E5%B7%A5%E5%85%B7_Extensions.user.js
// @updateURL https://update.greasyfork.org/scripts/530432/DLsite%20%E8%B4%AD%E4%B9%B0%E8%AE%B0%E5%BD%95%E5%88%86%E6%9E%90%E5%B7%A5%E5%85%B7_Extensions.meta.js
// ==/UserScript==
...
(function() {
    ...
    // 判断是否是目标页面
    const isTargetPage = () => {
        return window.location.href.startsWith('https://www.dlsite.com/maniax/mypage/userbuy');
    };

    // 主要功能函数
    const Purchase_Analyzer = () => {
        const utils = {
    ...
    // 注册菜单命令(其他页面执行分析函数)
    GM_registerMenuCommand('开始分析购买记录', () => {
        if (isTargetPage()) {
            Purchase_Analyzer();
        } else {
