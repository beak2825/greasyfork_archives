// ==UserScript==
// @name         DOTA2饰品价格对比脚本_Steam挂刀助手版
// @connect      *
// @version      2.2.6
// @description  将各个DOTA2饰品交易平台的价格放在一起显示，省去打开多个网页的繁琐操作！该版本原作者为RookieHong，因饰品平台接口网页已更新过原版本不适用，因此大地球就更新了下，有问题可在公众号（Steam挂刀助手）反馈给我，感谢大家支持。 支持平台：BUFF、C5、IGXE、悠悠有品
// @updater      大地球
// @origin_author RookieHong
// @grant        GM_xmlhttpRequest
// @match        https://buff.163.com/market/dota2*
// @require      https://cdn.bootcss.com/jquery/3.3.1/jquery.min.js
// @namespace https://greasyfork.org/users/692515
// @license GNU GPLv3
// @downloadURL https://update.greasyfork.org/scripts/467382/DOTA2%E9%A5%B0%E5%93%81%E4%BB%B7%E6%A0%BC%E5%AF%B9%E6%AF%94%E8%84%9A%E6%9C%AC_Steam%E6%8C%82%E5%88%80%E5%8A%A9%E6%89%8B%E7%89%88.user.js
// @updateURL https://update.greasyfork.org/scripts/467382/DOTA2%E9%A5%B0%E5%93%81%E4%BB%B7%E6%A0%BC%E5%AF%B9%E6%AF%94%E8%84%9A%E6%9C%AC_Steam%E6%8C%82%E5%88%80%E5%8A%A9%E6%89%8B%E7%89%88.meta.js
// ==/UserScript==
        ...
        onload: function (response) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (Trim(name) == Trim(itemName)) {
                    ...
                    var url = 'https://www.c5game.com/dota2?keyword=' + name + '&page=1';
            ...
            if (!hasNextPage) $(li).html('<a href="javascript:return false;" style="padding: 0px"><span class="myTitle">C5：</span><span style="color: #FF0000">查找不到数据！</span></a>');  //若没有下一页则可以判断没有该物品的数据
                ...
                var url = 'https://www.c5game.com/dota2?keyword=' + itemName + '&page=' + next_page;
    ...
    GM_xmlhttpRequest({
        ...
        onload: function (response) {
            ...
            if (!hasNextPage) $(li).html('<a href="javascript:return false;" style="padding: 0px"><span class="myTitle">IGXE：</span><span style="color: #FF0000">查找不到数据！</span></a>');  //若没有下一页则可以判断没有该物品的数据
                ...
                url = 'https://www.igxe.cn/market/dota2?sort=3&keyword=' + itemName + '&page_no=' + page_no.toString();
...
function buff() {
    $('#j_market_card').on('mouseenter', '#j_list_card li:not([class])', function () {
        ...
        //var c5URL = 'https://www.c5game.com/csgo/default/result.html?k=' + itemName + '&page=1';
        //var c5URL = 'https://www.c5game.com/csgo?keyword=' + itemName + '&page=1';
        var c5URL = 'https://www.c5game.com/dota2?keyword=' + itemName + '&page=1';
        ...
        // var igxeURL = 'https://www.igxe.cn/csgo/730?keyword=' + itemName;
        //var igxeURL = 'https://www.igxe.cn/market/csgo?sort=3&keyword=' + itemName;
        var igxeURL = 'https://www.igxe.cn/market/dota2?sort=3&keyword=' + itemName;
