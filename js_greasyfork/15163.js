...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/15163/Theme%20Noel%20Fragile.user.js
// @updateURL https://update.greasyfork.org/scripts/15163/Theme%20Noel%20Fragile.meta.js
// ==/UserScript==
$('#logo img').remove();
$('#logo').append('<a href="http://www.worldaide.fr/"><span></span><img src="http://i.imgur.com/Y1mjeUZ.png" width="170" height="120" alt="Logo du forum sur les jeux vidéos WorldAide"></a>')
