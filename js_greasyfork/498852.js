...
// @license      None
// @downloadURL https://update.greasyfork.org/scripts/498852/Logging%20System%20Design.user.js
// @updateURL https://update.greasyfork.org/scripts/498852/Logging%20System%20Design.meta.js
// ==/UserScript==
(function () {
    'use strict';
    ...
    function createStyleContainerBg(element) {
        ...
        const colors = ['-------МЯГКИЕ-------', 'PINK', 'ORANGE', 'SANDY BROWN','MEDIUM PURPLE', 'KHAKI', 'SKYBLUE', 'PALEGREEN', '', '-------ЯРКИЕ-------', 'RED', 'DARK ORANGE', 'BLUE VIOLET', 'LIME', 'CYAN', 'WHITE', 'YELLOW', 'MAGENTA', 'DEEPPINK',];
        const colorCodes = {
            'PINK': '#FFC0CB',
            'ORANGE': '#FFA500',
            'SANDY BROWN': '#F4A460',
        ...
        bugReportVK.href = 'https://vk.com/id561044581'
