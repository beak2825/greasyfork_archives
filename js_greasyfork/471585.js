// ==UserScript==
// @name         For guidance by Kokojambo koko
...
// @downloadURL https://update.greasyfork.org/scripts/471585/For%20guidance%20by%20Kokojambo%20koko.user.js
// @updateURL https://update.greasyfork.org/scripts/471585/For%20guidance%20by%20Kokojambo%20koko.meta.js
// ==/UserScript==
...
const buttons = [
	...
	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
		...
		'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
        '[Color=Red][CENTER][B]С уважением Основой Заместитель Главного Администратора .[/CENTER][/color][/B]',
	  prefix: CLOSE_PREFIX,
	  status: false,
	},
    {
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
      ...
      '[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
        "[COLOR=Red][CENTER][B]С уважением Основой Заместитель Главного Администратора[/CENTER][/B][/COLOR]",
...
'[Color=white][CENTER][B]Ожидайте ответа.[/CENTER][/color][/B]'+
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
	"[CENTER][B][COLOR=Red]С уважением Основой Заместитель Главного Администратора [/B][/CENTER][/COLOR]",
      prefix: PIN_PREFIX,
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
	  ...
	  content:
		...
		"[B][CENTER]У вас есть ровно 24 часа чтобы вернуть игроку имущество или средства на которые вы провели NonRP обман, если за данное время это сделано не будет, то ваш аккаунт блокируется навсегда без права на обжалование.Доказательства прикрепите в данной теме.[/CENTER][/B]<br><br>" +
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
		'[Color=Red][CENTER][B]С уважением Основой Заместитель Главного Администратора .[/CENTER][/color][/B]',
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
	...
	},
    {
        ...
        "[B][CENTER]Ваш аккаунт будет разблокирован на 24 часа, за это время вам необходимо изменить свой nickname. Доказательства прикрепить в данной теме.[/B][/CENTER]"+
        	'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
        '[B][COLOR=Red][CENTER] С уважением Основой Заместитель Главного Администратора [/B][/CENTER][/COLOR]',
        prifix: PIN_PREFIX,
        status: true,
    },
...
'[CENTER][url=https://postimages.org/][img]https://i.postimg.cc/sXGVGm4p/Picsart-23-07-24-14-44-44-695.png[/img][/url][CENTER]'+
		...
		"[B][CENTER][Color=Red] Запрошу доказательства у [/color][/CENTER][/B]данного администратора.<br><br>" +
