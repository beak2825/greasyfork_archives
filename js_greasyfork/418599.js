// ==UserScript==
// @name            Discord inline LaTeX
// @namespace       makamys
// @match           https://discord.com/*
// @version         0.1
// @description     User Script for Inline LaTeX Rendering in Discord
...
// @grant           GM_addStyle
// @downloadURL https://update.greasyfork.org/scripts/418599/Discord%20inline%20LaTeX.user.js
// @updateURL https://update.greasyfork.org/scripts/418599/Discord%20inline%20LaTeX.meta.js
// ==/UserScript==

// Acknowledgement
// This script was sloppily hacked together from
// https://greasyfork.org/en/scripts/394829-notion-inline-math-equations
// and
...
function renderInlineLaTeX() {
  document.querySelector("[class^=textArea]").classList.add("textArea");
  renderMathInElement(document.querySelector("[class^=messagesWrapper]"), {
    delimiters: [
