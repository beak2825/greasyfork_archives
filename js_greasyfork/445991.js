// ==UserScript==
// @name         BlackRussia AZURE | Curator's Team Script for forum by R. Tesla
// @namespace    https://forum.blackrussia.online
// @version      0.1
// @description  Tesla number one
// @author       Roni_Tesla
// @match        https://forum.blackrussia.online/index.php?threads/*
// @grant        none
// @license      MIT
// @icon https://cdn-images-1.listennotes.com/podcasts/geekcast/geekcast-08-ffko-2019-9lDjXpewLrF-wJMQCienTmk.1400x1400.jpg
// @downloadURL https://update.greasyfork.org/scripts/445991/BlackRussia%20AZURE%20%7C%20Curator%27s%20Team%20Script%20for%20forum%20by%20R%20Tesla.user.js
// @updateURL https://update.greasyfork.org/scripts/445991/BlackRussia%20AZURE%20%7C%20Curator%27s%20Team%20Script%20for%20forum%20by%20R%20Tesla.meta.js
// ==/UserScript==
(function () {
  'use strict';
...
"[COLOR=rgb(255, 0, 0)][SIZE=4]2.16. [/SIZE][/COLOR][COLOR=rgb(209, 213, 216)][SIZE=4]Запрещен SK (Spawn Kill) — убийство или нанесение урона на титульной территории любой фракции / организации, на месте появления игрока, а также на выходе из закрытых интерьеров и около них[/SIZE][/COLOR][COLOR=rgb(255, 0, 0)][SIZE=4] | Jail 60 минут / Warn (за два и более убийства) [/SIZE][/COLOR]<br>" +
    ...
    },
    {
      ...
      content:
        '[CENTER][COLOR=rgb(255, 0, 0)][FONT=times new roman][SIZE=4][I]{{ greeting }}, уважаемый {{ user.mention }}.[/I][/SIZE][/FONT][/COLOR]<br><br>' +
        "[I][COLOR=rgb(209, 213, 216)][FONT=times new roman][SIZE=4]Нарушитель буден наказан по следующему пункту общих правил серверов:[/SIZE][/FONT][/COLOR][/I]<br><br>" +
        "[FONT=book antiqua][SIZE=4][COLOR=rgb(255, 0, 0)]2.32. [/COLOR][COLOR=rgb(209, 213, 216)]Запрещено введение в заблуждение, обман, оскорбление, неконструктивная критика администрации на всех ресурсах проекта [/COLOR][COLOR=rgb(255, 0, 0)]| | Ban 7 - 15 дней [/COLOR][/SIZE][/FONT]<br><br>" +
        '[LIST]<br><br>' +
    ...
    },
    {
      ...
      content:
        ...
        '[FONT=book antiqua][SIZE=4][COLOR=rgb(209, 213, 216)][I]Приятной игры на BLACK RUSSIA [/I][/COLOR][I][COLOR=rgb(0, 255, 255)]Azure[/COLOR][/I][/SIZE][/FONT][COLOR=rgb(209, 213, 216)][FONT=book antiqua][SIZE=4][I].[/I][/SIZE][/FONT][/COLOR]',
      prefix: ACCEPT_PREFIX,
      status: false,
    },
    {
