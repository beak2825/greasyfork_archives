...
// @downloadURL https://update.greasyfork.org/scripts/442628/Bypass%20All%20Shortlinks.user.js
// @updateURL https://update.greasyfork.org/scripts/442628/Bypass%20All%20Shortlinks.meta.js
// ==/UserScript==
// ============================================
...
(function () {
  ...
  if (window.location.hostname == "faucetpayrotator.blogspot.com") {
  } else {
    const listhide = document.querySelectorAll(
      "#frame,#iframe,#particles-js,#canvas,.banner-inner,.vanta-canvas,.particles-js-canvas-el,#s65c,#overlay,#footerads,.oulcsy,.blog-item,.sticky-bottom,.separator,html body iframe,html iframe,#cookie-pop,.vmyor,.tnjmvneldp"
    );
    for (const element of listhide) {
      element.remove();
    }
  }
  ...
  function BypassedByakuiiki(domainReg, objectOfPaths) {
  ...
  BypassedByakuiiki(/ultraten.net|uniqueten.net|techydino.net|crewbase.net|crewus.net|shinchu.net|thumb8.net|allcryptoz.net|topcryptoz.net|thumb9.net|shinbhu.net/, function () {
  ...
  if (elementExists("#url_qu")) {
    setTimeout(function () {
      document.querySelector(".ad-banner.btn-captcha.btn-primary.btn").click();
    }, 3000);
  }
  // ============================================
  // setInterval Mode
  ...
  if (elementExists("div.col-md-4:nth-child(2)")) {
    setInterval(function () {
      document.querySelector("div.col-md-4:nth-child(2) > span:nth-child(1) > img:nth-child(1)").click();
    }, 5000);
  }
  if (elementExists(".tdc_zone")) {
    setInterval(function () {
      document.querySelector("a.btn-success").click();
    }, 5000);
  }
  if (elementExists("#makingdifferenttimer")) {
    setInterval(function () {
      document.querySelector("#url_qu > a:nth-child(1)").click();
    }, 3000);
  }
  if (elementExists("#mainlink")) {
    setInterval(function () {
      document.querySelector(".s-btn-f").click();
    }, 5000);
  }
  if (elementExists("#surl")) {
    setInterval(function () {
      document.querySelector("#surl.btn-success.m-2.btn").click();
    }, 5000);
  }
  // Old Codes
  if (window.location.hostname == "toptechtalk.xyz") {
    setInterval(function () {
      document.querySelector("#cbt.btn-primary.btn-warningbtn.btn").click();
    }, 5000);
  }
  if (window.location.hostname == "atlai.club") {
    setInterval(function () {
      document.querySelector("#cbt.btn-primary.btn-warningbtn.btn").click();
    }, 5000);
  }
  if (window.location.hostname == "doctor-groups.com") {
    setInterval(function () {
      document.querySelector(".skip-ad > a:nth-child(1)").click();
    }, 3000);
  }
  if (
    location.href.indexOf("linksly.co") != -1 ||
    location.href.indexOf("shrinke.me") != -1 ||
    location.href.indexOf("health-and.me") != -1 ||
    location.href.indexOf("stfly.me") != -1 ||
    location.href.indexOf("cutdl.xyz") != -1 ||
    location.href.indexOf("zagl.info") != -1 ||
    location.href.indexOf("100count.net") != -1
  ) {
    clickIfElementExists(".get-link.btn-lg.btn-success.btn", 5, "setInterval");
  }
  if (window.location.hostname == "www.lootlinks.xyz") {
    clickIfElementExists("#get-link", 5, "setInterval");
  }
  if (window.location.hostname == "profitlink.info") {
    clickIfElementExists(".btn-captcha.btn-primary.btn", 3, "setInterval");
  }
  if (window.location.hostname == "profitlink.info") {
    setInterval(function () {
      document.querySelector(".calc-earn.get-link.btn-lg.btn-success.btn").click();
    }, 5000);
  }
  if (window.location.hostname == "freebcc.org") {
    setInterval(function () {
      document.querySelector(".get-link.btn-sm.btn-primary.btn").click();
    }, 5000);
  }
  ...
  if (window.location.hostname == "tei.ai") {
    window.addEventListener("DOMContentLoaded", (event) => {
      var linkbypass = atob(`aH${document.querySelector("#link-view [name='token']").value.split("aH").slice(1).join("aH")}`);
      window.location.href = "" + linkbypass;
    });
  } else {
  }
  let $ = window.jQuery;
  if (location.href.indexOf("temp-late.xyz") != -1 || location.href.indexOf("template-zone.xyz") != -1 || location.href.indexOf("top-blog.xyz") != -1) {
  } else if (window.location.hostname == "upfiles.io") {
  ...
  } else if (location.href.indexOf("ay.live") != -1 || location.href.indexOf("aylink.co") != -1) {
    var form = $("#go-link");
    $.ajax({
      type: "POST",
      async: true,
      ...
      .submit(function (e) {
        ...
        $.ajax({
          ...
          beforeSend: function (xhr) {
            ...
            $("a.get-link").text("Bypassed by akuiiki");
            notforsale.replaceWith('<button class="btn btn-default , col-md-12 text-center" onclick="javascript: return false;"><b>Thanks for using Bypass All Shortlinks Scripts and for Donations , Regards : akuiiki</b></button>');
            blogger.replaceWith('<button class="btn btn-default , col-md-12 text-center" onclick="javascript: return false;"><b>Thanks for using Bypass All Shortlinks Scripts and for Donations , Regards : akuiiki</b></button>');
            pemula.replaceWith('<button class="btn btn-default , col-md-12 text-center" onclick="javascript: return false;"><b>Thanks for using Bypass All Shortlinks Scripts and for Donations , Regards : akuiiki</b></button>');
          },
  ...
  if (window.location.hostname == "za.uy") {
  ...
  const l = ((h) => {
    switch (h.host) {
      case "adinsurance.xyz":
        if (h.pathname === "/verify/" && /^\?([^&]+)/.test(h.search)) {
          const m = document.createElement("meta");
          m.name = "referrer";
          m.content = "origin";
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://blog.adinsurance.xyz/" + RegExp.$1;
          a.click();
        }
        break;
      case "7apple.net":
      ...
      case "crazyblog.in":
        ...
        break;
      case "studyuo.com":
        if (h.pathname === "/pro/" && h.searchParams.has("link")) {
          return "https://shrinkpay.crazyblog.in" + h.searchParams.get("link");
        } else if (h.pathname === "/short/verify/" && /^\?([^&]+)/.test(h.search)) {
          return "https://redd.crazyblog.in/" + RegExp.$1;
        } else if (h.pathname === "/blog/verify/" && /^\?([^&]+)/.test(h.search)) {
          return "https://speedynews.xyz/verify/?" + RegExp.$1;
        } else if (h.pathname === "/pro2/verify/" && /^\?([^&]+)/.test(h.search)) {
          const m = document.createElement("meta");
          m.name = "referrer";
          m.content = "origin";
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://csd.xmod.in/" + RegExp.$1;
          a.click();
        }
        break;
      case "speedynews.xyz":
        if (h.pathname === "/verify/" && /^\?([^&]+)/.test(h.search)) {
          ...
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://additionalgamer.com/blog/" + RegExp.$1;
          a.click();
        }
        break;
      case "www.crazyblog.in":
        if (h.pathname === "/" && h.searchParams.has("postid")) {
          return h.searchParams.get("postid");
        }
        break;
      case "blog.crazyblog.in":
        if (/^\/step\d+?\/([^/]+)$/.test(h.pathname)) {
          return "https://wplink.online/" + RegExp.$1;
        } else if (/^\/visit\d+?\/step\d+?\/([^/]+)$/.test(h.pathname)) {
          return "https://cblink.crazyblog.in/" + RegExp.$1;
        }
        break;
      case "dogeearn.com":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://myhealths.icu/" + h.searchParams.get("link");
        } else if (/^\/coinsurl\/([^/]+)/.test(h.pathname)) {
          return "https://coinsurl.com/" + RegExp.$1;
        }
        break;
      case "techmody.io":
        if (h.pathname === "/" && h.searchParams.has("check")) {
          ...
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = decodeURIComponent(h.searchParams.get("check"));
          a.click();
        }
        break;
      case "insuranceblog.xyz":
        if (h.pathname === "/blog/" && h.searchParams.has("link")) {
          return "https://gos.insuranceblog.xyz/" + h.searchParams.get("link");
        }
        break;
      case "netfile.cc":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://next.netfile.cc/" + h.searchParams.get("link");
        }
        break;
      case "gifans.com":
      case "www.gifans.com":
        ...
        break;
      case "amazingdarpon.com":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://go.zolomix.in/" + h.searchParams.get("link");
        }
        break;
      case "coinbaze.in":
      case "techmart4u.in":
        if (/^\/coinbazeads\/([^\/]+)/.test(h.pathname)) {
          return "https://urlfiles.com/" + RegExp.$1;
        }
        break;
      case "coinsearns.com":
        if (/^\/cryptoads\/([^/]+)/.test(h.pathname)) {
          return "https://cryptoads.space/" + RegExp.$1;
        }
        break;
      case "uniqueten.net":
      case "www.ultraten.net":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://ultraten.net/home/sh/" + h.searchParams.get("link");
        }
        break;
      case "ultraten.net":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://ultraten.net/" + h.searchParams.get("link");
        }
        break;
      case "allcryptoz.net":
      case "topcryptoz.net":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://allcryptoz.net/home/sh/" + h.searchParams.get("link");
        }
        break;
      case "mercedesellington.com":
      case "model-tas-terbaru.com":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "http://yousm.link/" + h.searchParams.get("link");
        }
        break;
      case "wpking.in":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://o.ovlinks.com/" + h.searchParams.get("link");
        }
        break;
      case "anime.dutchycorp.space":
      case "movies.dutchycorp.space":
      case "tech.dutchycorp.space":
      case "cool-time.dutchycorp.space":
        if (/^\/redir[^.]+?\.php$/.test(h.pathname) && h.searchParams.has("code")) {
          return h.searchParams.get("code") + "?verif=0";
        }
        break;
      case "blogginglass.com":
        if (h.pathname === "/" && h.searchParams.has("getlink")) {
          return "http://go.mozlink.net/" + h.searchParams.get("getlink");
        } else if (h.pathname === "/blog/" && h.searchParams.has("getlink")) {
          return "http://go.fire-link.net/" + h.searchParams.get("getlink");
        }
        break;
      case "madar-24.com":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          ...
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://coupon-fresh.com/" + decodeURIComponent(h.searchParams.get("link"));
          a.click();
        }
        break;
      case "clickscoin.com":
        if (/^\/short\/([^/]+)/.test(h.pathname)) {
          return "https://short.clickscoin.com/" + RegExp.$1;
        } else if (/^\/shortccsl\/([^/]+)/.test(h.pathname)) {
          return "https://ccsl.xyz/" + RegExp.$1;
        }
        break;
      case "dogeclick.net":
        if (/^\/short\/([^/]+)/.test(h.pathname)) {
          return "https://short.clickscoin.com/" + RegExp.$1;
        } else if (/^\/ccsl\/([^/]+)/.test(h.pathname)) {
          return "https://ccsl.xyz/" + RegExp.$1;
        }
        break;
      case "short.clickscoin.com":
      case "watchdoge.xyz":
      case "dogeclick.net":
        if (/^\/ccsl\/([^/]+)/.test(h.pathname)) {
          return "https://ccsl.xyz/" + RegExp.$1;
        }
        break;
      case "11bit.co.in":
        if (/^\/link\/([^/]+)/.test(h.pathname)) {
          return "https://sl.proinfinity.fun/" + RegExp.$1;
        } else if (/^\/bitshort\/([^/]+)/.test(h.pathname)) {
          return "https://bitshort.co/" + RegExp.$1;
        }
        break;
      case "nawahi1.com":
      ...
      case "urlily.com":
        if (h.pathname === "/verify/" && /^\?([^&]+)/.test(h.search)) {
          ...
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://ecwizon.com/" + RegExp.$1;
          a.click();
        }
        break;
      case "techrayzer.com":
        if (h.pathname === "/verify/" && /^\?([^&]+)/.test(h.search)) {
          ...
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://techrayzer.com/insurance/" + RegExp.$1;
          a.click();
        }
        break;
      case "crypto-faucet.xyz":
        if (/^\/claim\/link\/([^\/]+)/.test(h.pathname)) {
          return "https://doctor-groups.com/link/" + RegExp.$1;
        }
        break;
      case "konstantinova.net":
        if (/^\/verify\/([^\/]+)/.test(h.pathname)) {
          return "https://coin.mg/" + RegExp.$1;
        }
        break;
      case "faucet.100count.net":
        if (/^\/fo\/linko\/([^\/]+)/.test(h.pathname)) {
          return "https://100count.net/fo/linko/" + RegExp.$1;
        } else if (/^\/clickit\/sh\/([^/]+)/.test(h.pathname)) {
          return "https://100count.net/fileo/clicksfile/stats/" + RegExp.$1;
        }
        break;
      case "lux.adinsurance.xyz":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://go.adinsurance.xyz/" + h.searchParams.get("link");
        }
        break;
      case "adoco.in":
        if (/girl([mpwz])oro\/([^\/]+)/.test(h.pathname)) {
          return "https://girl" + RegExp.$1 + "oro.xyz/" + RegExp.$2;
        }
        break;
      case "okrzone.com":
        if (h.pathname === "/verify/" && /^\?([^&]+)/.test(h.search)) {
          ...
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://link.tokenoto.com/" + RegExp.$1;
          a.click();
        }
        break;
      case "cekip.site":
      case "www.cekip.site":
        ...
        break;
      case "foodyrecipe.xyz":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://paid4.link/" + h.searchParams.get("link");
        }
        break;
      case "www.gkqnaexam.com":
        if (/^\/yuidea\/$/.test(h.pathname) && /^\?([^&]+)/.test(h.search)) {
          const m = document.createElement("meta");
          m.name = "referrer";
          m.content = "origin";
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://web.url2link.com/" + RegExp.$1;
          a.click();
        }
        break;
      case "mcrypto.club":
        ...
        if (path == "ca/") {
          return "https://cryptoads.space/" + h.searchParams.get("link").substring(3);
        } else if (path == "cu/") {
          return "https://coinsurl.com/" + h.searchParams.get("link").substring(3);
        } else if (path == "mh/") {
          return "https://myhealths.icu/" + h.searchParams.get("link").substring(3);
        } else if (path == "cf/") {
          return "https://cryptoflare.cc/" + h.searchParams.get("link").substring(3);
        } else if (h.searchParams.get("link").substring(0, 1) == "/") {
          return "https://coinsparty.com/" + h.searchParams.get("link").substring(1);
        }
        break;
      case "digitalnaz.net":
        if (h.pathname === "/" && h.searchParams.has("getlink")) {
          return "https://go.linkfly.io//" + h.searchParams.get("getlink");
        }
        break;
      case "infinityfreescripts.xyz":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://technologylover.in/" + h.searchParams.get("link");
        }
        break;
      case "step0.shortlinks.click":
        if (/^\/([^\/]+)/.test(h.pathname)) {
          return "https://shortlinks.click/" + RegExp.$1;
        }
        break;
      case "coin-free.com":
        if (h.pathname === "/" && h.searchParams.has("wpsafelink")) {
          return h.searchParams.get("wpsafelink");
        }
        break;
      case "earnfree.cc":
        if (/^\/slc\/step1\/([^/]+)/.test(h.pathname)) {
          return "http://shortlinks.click/" + RegExp.$1;
        }
        break;
      case "technicalramno1.link":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://go.urlmoney.xyz/" + h.searchParams.get("link");
        }
        break;
      ...
      case "jiotech.net":
        if (h.pathname === "/" && h.searchParams.has("getlink")) {
          return "https://go.bitcoinly.in/" + h.searchParams.get("getlink");
        } else if (h.pathname === "/blog/" && h.searchParams.has("getlink")) {
          return "https://go.cashurl.in/" + h.searchParams.get("getlink");
        } else if (h.pathname === "/finance/" && h.searchParams.has("getlink")) {
          return "https://go.linkad.in/" + h.searchParams.get("getlink");
        }
        break;
      case "esenr.com":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://go.bcdshort.xyz/" + h.searchParams.get("link");
        }
        break;
      case "btc.freebcc.org":
      case "eth.freebcc.org":
        if (h.pathname === "/" && h.searchParams.has("claim")) {
          return "https://freebcc.org/" + h.searchParams.get("claim");
        }
        break;
      case "adcortoltda.agency":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          return "https://link.adcortoltda.agency/" + h.searchParams.get("link");
        }
        break;
      case "go.dogeearn.com":
        if (h.pathname === "/" && h.searchParams.has("go")) {
          return "https://cryptoads.space//" + h.searchParams.get("go");
        }
        break;
      case "takez.co":
      case "www.takez.co":
        if (h.pathname === "/" && h.searchParams.has("token")) {
          return "https://links.spidermods.in/" + h.searchParams.get("token");
        }
        break;
      ...
      case "go.owllink.net":
        ...
        break;
      case "forex-trnd.com":
        document.querySelector("#exfoary-form").submit();
        break;
      case "forex-lab.xyz":
        document.querySelector("body > center:nth-child(3) > div:nth-child(2) > form:nth-child(1)").submit();
        break;
      case "forexlap.com":
        document.querySelector("#molien > center:nth-child(2) > form:nth-child(3)").submit();
        break;
      case "www.digiromotion.com":
        if (h.pathname === "/" && h.searchParams.has("re")) {
          return "https://zipfy.link/" + h.searchParams.get("re");
        }
        break;
      case "linkstom.ml":
        if (h.pathname === "/" && h.searchParams.has("link")) {
          ...
          document.head.appendChild(m);
          const a = document.createElement("a");
          a.href = "https://links.earnfort.in/" + decodeURIComponent(h.searchParams.get("link"));
          a.click();
        }
        break;
      case "shrinkearn.com":
      case "clk.sh":
        ...
        if (l.href.includes("bloogerspoot.") && l.searchParams.has("url")) {
          ...
          window.location.assign("https://softindex.website" + i.pathname);
        }
        break;
      case "acortame.xyz":
        if (window.location.hash) {
          location.href = "" + atob(window.location.hash.substr(1));
        }
        break;
      case "techload.co":
      ...
      case "1link.club":
        ...
        break;
      case "coinsparty.com":
        document.querySelector(".box-body > form:nth-child(2)").submit();
        break;
      case "makemoneywithurl.com":
        document.querySelector("#hidden form").submit();
        break;
      case "adshort.space":
      case "go.techgeek.digital":
        document.querySelector(".text-center > form:nth-child(4)").submit();
        break;
      case "nulledsafe.com":
        if (/^\/link\/([^\/]+)/.test(h.pathname)) {
        ...
        break;
      case "1ink.cc":
        document.querySelector("#countingbtn").click();
        break;
      case "stfly.me":
        document.querySelector("#submit_data").submit();
        break;
      case "ashort1a.xyz":
      ...
      case "up-load.one":
        ...
        break;
      case "bildirim.eu":
        document.querySelector("#btnPermission").click();
        break;
      case "yoshare.net":
        document.querySelector("#yuidea-snp").submit();
        break;
      case "mdn.world":
      ...
      case "linkpay.cc":
        ...
        break;
      case "yalla-shoot-now.us":
      case "forexat.club":
        document.querySelector("#links > form:nth-child(2)").submit();
        break;
      case "intercelestial.com":
      case "tribuntekno.com":
        document.querySelector("#landing").submit();
        break;
      case "marocclickers.xyz":
        document.querySelector("#link-view > div:nth-child(5) > center:nth-child(5) > div:nth-child(1)").click();
        break;
      case "supersites.xyz":
        if (h.pathname === "/verifysl.php" && h.searchParams.has("url")) {
      ...
      case "linksos.live":
      case "yocto.link":
      case "sl.claimfreebits.com":
      case "playgotoken.com":
      case "tronex.biz":
        document.querySelector("button.btn:nth-child(4)").click();
        break;
      case "automotur.club":
      case "sanoybonito.club":
        document.querySelector("#page2").submit();
        break;
      case "shortit.pw":
        document.querySelector(".pulse.btn-primary.btn").click();
        break;
      case "jameeltips.us":
        document.querySelector("#continue_button_1").click();
        break;
      default:
        break;
    }
  ...
  function notify(txt, width = 850) {
    ...
    m.style.font = "normal bold 20px sans-serif";
  ...
  const bas = ((h) => {
    ...
    switch (h.host) {
      case "faucetpayrotator.blogspot.com":
        if (h.pathname === "/" && h.searchParams.has("url") && h.searchParams.has("sn")) {
          ...
          result.link = h.searchParams.get("url").replace("&m=1", "");
          result.redirectDelay = 5;
          result.isNotifyNeeded = true;
          return result;
        }
  ...
  if (bas) {
    ...
    if (isNotifyNeeded) {
      notify(`Please Wait a moment .....You will be Redirected to Your Destination in ${redirectDelay} seconds`);
    }
    setTimeout(() => {
      location.href = link;
    }, redirectDelay * 1000);
