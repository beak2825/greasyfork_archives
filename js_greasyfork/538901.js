...
// @description 目前功能
// @description 1. 战斗失败日志 回放最后一幕(暂不可用)
// @description 2. 人物使用技能统计,伤害, 次数, dps, 耗蓝
...
(async function () {
        ...
        let playerUId = "yyy"; // 应该会读取真正的uid
        const playerInfoUrl = "https://poe-test.faith.wang/api/character";
        const battleInfoUrl = "https://poe-test.faith.wang/api/battle/sse";

        const shareBattleUrl = "https://poe-test.faith.wang/watch/battle/";

        const watchBattleInfoUrl = "https://poe-test.faith.wang/api/battle/sse/watch";
        const watchPlayerInfoUrl = "https://poe-test.faith.wang/api/character/view";

        let sseUrl = battleInfoUrl;
        ...
        const MAGIC_TYPE = {
            ...
            "1128": "无法获得狂怒球",
            "1129": "无法获得耐力球",
            "1130": "技能获得等于基础魔力消耗 % 的基础生命消耗",
            "1131": "技能获得等于基础魔力消耗 % 的基础能量护盾消耗",
            "1135": "法术技能无法造成伤害",
            "1136": "你的法术被禁用了",
            "1137": "药剂生命回复速度加快 %",
            "1138": "更明显的打击效果",
            "1139": "你受到的【猛攻】效果提高 %",
            "1140": "被击中时，每个耐力球使你获得 % 秒的【猛攻】状态",
            "1141": "被击中时，你会失去所有的耐力球",
            "1142": "受到击中物理伤害的 % 视作闪电伤害",
            "1159": "闪电抗性视为%",
            "1218": "受到的物理伤害提高 %",
            "1232": "每 200 点命中值使投射物攻击伤害提高 %",
            "1233": "攻击击中你时额外承受 % 点物理伤害",
            "1252": "火焰抗性为 0",
            "1253": "冰霜抗性为 0",
            "1254": "闪电抗性为 0",
            "1215": "烈士意志",
            ...
            "1218": "受到的物理伤害提高",
            "3800": "药剂持续期间 命中值提高  %",
            "3801": "药剂持续期间 获得额外元素抗性 + %",
            "3802": "未满生命时使用，额外回复药剂生命回复量的  %",
            "3803": "药剂持续期间 护甲提高  %",
            "3804": "药剂持续期间 攻击伤害的  % 转化为生命偷取",
            "3805": "药剂持续期间 攻击速度提高  %",
            "3806": "药剂持续期间 有  % 几率避免被冰缓",
            "3807": "药剂持续期间 有  % 几率避免被冰冻",
            "3808": "药剂持续期间 有  % 几率避免被点燃",
            "3809": "药剂持续期间 有  % 几率避免被感电",
            "3810": "药剂持续期间 有  % 几率避免被晕眩",
            "3811": "药剂持续期间 你身上的流血持续时间缩短  %",
            "3812": "药剂持续期间 格挡与晕眩回复提高  %",
            "3813": "药剂持续期间 施法速度提高  %",
            "3814": "你造成暴击时有  % 几率获得 1 点充能",
            "3815": "充能回复提高  %",
            "3816": "你造成暴击时获得   点充能",
            "3817": "被敌人击中时获得   点充能",
            "3818": "受到暴击时获得   点充能",
            "3819": "每次使用的充能消耗  %",
            "3820": "药剂持续期间 你受到的冰缓效果降低  %",
            "3821": "药剂持续期间 暴击率  %",
            "3822": "药剂持续期间 你受到的诅咒效果降低  %",
            "3823": "持续时间提高  %",
            "3824": "持续时间总降  %",
            "3825": "药剂效果不会排队",
            "3826": "药剂效果提高  %",
            "3827": "未保留魔力充满时，药剂效果不会移除",
            "3828": "药剂持续期间 闪避值提高  %",
            "3829": "药剂持续期间 你身上的冰冻持续时间缩短  %",
            "3830": "药剂持续期间 有  % 几率造成冰冻、感电和点燃",
            "3831": "未满生命时使用，使周围敌人移动速度降低  %",
            "3832": "未满魔力时使用，使周围敌人移动速度降低  %",
            "3833": "药剂持续期间 你身上的点燃持续时间缩短  %",
            "3834": "药剂持续期间 免疫流血",
            "3835": "在流血时使用，获得   秒流血免疫",
            "3836": "药剂持续期间 免疫冰缓",
            "3837": "在冰缓时使用，获得   秒冰缓免疫",
            "3838": "药剂持续期间 免疫腐化之血",
            "3839": "受腐化之血影响时使用，获得   秒腐化之血免疫",
            "3840": "药剂持续期间 免疫冰冻",
            "3841": "被冻结时使用，获得   秒冰冻免疫",
            "3842": "受阻碍时使用，获得   秒阻碍免疫",
            "3843": "药剂持续期间 免疫点燃",
            "3844": "被点燃时使用，获得   秒点燃免疫",
            "3845": "被力竭时使用，获得   秒力竭免疫",
            "3846": "药剂持续期间 免疫中毒",
            "3847": "中毒时使用，获得   秒中毒免疫",
            "3848": "药剂持续期间 免疫感电",
            "3849": "被感电时使用，获得   秒感电免疫",
            "3850": "立即回复",
            "3851": "低血时立即回复",
            "3852": "回复量的  % 立即生效",
            "3853": "药剂持续期间 近战攻击会击退",
            "3854": "使用时，从魔力中移除等同于生命回复量的  %",
            "3855": "生命回复量提高  %",
            "3856": "召唤生物获得相当于药剂生命回复量的  %",
            "3857": "药剂持续期间 技能魔力消耗降低  %",
            "3858": "效果结束时瞬间回复魔力",
            "3859": "使用时，从生命中移除等同于魔力回复量的  %",
            "3860": "最大充能次数 + ",
            "3861": "药剂持续期间 移动速度提高  %",
            "3862": "药剂持续期间 物理攻击伤害的  % 转化为生命偷取",
            "3863": "药剂持续期间 物理攻击伤害的  % 转化为魔力偷取",
            "3864": "药剂持续期间 你身上的中毒持续时间缩短  %",
            "3865": "回复量提高  %",
            "3866": "低血时使用，回复量总增  %",
            "3867": "回复速率提高  %",
            "3868": "使用时移除全部燃烧",
            "3869": "使用时移除燃烧",
            "3870": "使用时移除诅咒",
            "3871": "药剂持续期间 你受到的感电效果降低  %",
            "3872": "药剂持续期间 法术伤害的  % 转化为能量护盾偷取",
            "3873": "药剂持续期间 结界提高  %",
            "3874": "药剂持续期间 暴击率特别幸运",
            "3875": "药剂持续期间 获得【迷踪】",
            "3876": "有  % 几率躲避法术伤害",
            ...
            "3883": "受到的持续伤害降低  %",
            "3884": "持盾时近战打击范围 +  米",
            "3885": "附近至少   个敌人时，近战打击范围 +  米",
            "3886": "使用时嘲讽附近敌人",
            "3887": "药剂持续期间，若你曾被晕眩则无法被晕眩",
            "3888": "使用时恢复护体值"
        }
        ...
        async function getPlayerInfo() {
            ...
            if (currentUrl.includes("watch")){
                ...
                const watchPlayerUId = pathParts.pop() || pathParts.pop(); // 防止末尾有斜杠的干扰
                data = await fetchOtherPlayerInfo(watchPlayerUId);
                sseUrl = watchBattleInfoUrl + "/" + watchPlayerUId;
            }else {
                const classElements = document.getElementsByClassName("class");
                data = await fetchPlayerInfo();
            }
            console.log(data);

            playerId = data.data.name;
            playerUId = data.data.id;
            let key = data.data.class;
            playerClassEmj = classEmojis[key];

            console.log(playerClassEmj + playerId + "(" + playerUId + ")");
        }
        ...
        async function fetchOtherPlayerInfo(uid){
            //查询其他玩家的基础信息
            const res = await fetch(watchPlayerInfoUrl+"/"+uid, {
                headers: {
                    'Authorization': 'Bearer ' + token
                }
            });
        ...
        // 记录上次释放技能时间 主要为了计算技能释放间隔
        let lastPlayerCastSkillTime = 0;
        //根据战斗id分成不同的战斗数据
        class TimePeriod {
        ...
        class SingleBattleData {
            constructor(id, startTime = 0) {
                this.id = id;
                this.time = [];
                this.currentPeriod = new TimePeriod(startTime);
                this.time.push(this.currentPeriod);
                //死亡时间段统计
                this.deathTime = [];
                //已经统计过的敌人id
                this.analyzedEnemyIds = new Set();
            }

            //更新当前时间
            update(timeStamp) {
                //明显是中断的情况下
                if (timeStamp - this.currentPeriod.end > 0.1) {
                    this.currentPeriod = new TimePeriod(timeStamp);
                    this.time.push(this.currentPeriod);
                    lastPlayerCastSkillTime = timeStamp;
                } else {
                    this.currentPeriod.end = timeStamp;
                }
            }

            // 计算所有时间段的总时长
            getTotalDuration() {
                return this.time.reduce((total, period) => {
                    return total + period.duration;
                }, 0);
            }

            updateDeath(currentTime, respawnRemaining) {
                // 1. 计算预期的复活时间点
                let respawnTime = currentTime + respawnRemaining;

                // 2. 创建一个新的死亡时间段
                let newDeathPeriod = new TimePeriod(currentTime);
                newDeathPeriod.end = respawnTime;

                // 3. 逻辑处理：检查是否需要合并或更新
                // 如果当前已经在死亡名单中，且新的复活时间更晚，则更新最后一个记录
                if (this.deathTime.length > 0) {
                    let lastDeath = this.deathTime[this.deathTime.length - 1];

                    // 如果这次死亡发生的时刻在上次复活之前，说明是“死亡状态重置/延长”
                    if (currentTime <= lastDeath.end) {
                        lastDeath.end = Math.max(lastDeath.end, respawnTime);
                        return;
                    }
                }

                // 4. 否则，作为一个新的死亡记录推入
                this.deathTime.push(newDeathPeriod);
            }

            getDeathDuration(){
                return this.deathTime.reduce((total, period) => {
                    return total + period.duration;
                }, 0);
            }

            getdeaths(){
                return this.deathTime.length;
            }

            updateEnemies(rightTeam){
                if (rightTeam !== undefined && Array.isArray(rightTeam)){
                    rightTeam.forEach(one => {
                        if (!this.analyzedEnemyIds.has(one.index)){
                            //分析敌人数据
                            enemyHpByRarity.update(one.rarity,one.hpMax);
                            if (one.esMax !== undefined && one.esMax !== 0){
                                enemyEsByRarity.update(one.rarity,one.esMax);
                            }
                            this.analyzedEnemyIds.add(one.index);
                        }
                        if (one.removed !== undefined && one.removed){
                            totalKills +=1;
                        }
                    })
                }
            ...
            getNumberOfEnemy(){
                return this.analyzedEnemyIds.size;
            }
        }
        ...
        class BattleManager {
            constructor() {
                // 使用 Map 代替 Array
                // key 是 id, value 是 BattleData 实例
                this.battles = new Map();
            }

            // 添加或创建战斗
            addBattle(id, time = 0) {
                this.battles.set(id,new SingleBattleData(id, time));
            }

            // 根据 ID 查询：瞬间定位，时间复杂度 O(1)
            getBattle(id) {
            ...
            globalTotalDuration() {
                let total = 0;
                // Map 的遍历也很方便
                for (let battle of this.battles.values()) {
                    total += battle.getTotalDuration();
                }
                return total;
            }
            ...
            globalDeathDuration(){
                ...
                // Map 的遍历也很方便
                for (let battle of this.battles.values()) {
                    total += battle.getDeathDuration();
                }
                return total;
            }

            update(battleId, timeStamp,rightTeam) {
                if (this.hasBattle(battleId)) {
                    this.getBattle(battleId).update(timeStamp);
                } else {
                    this.addBattle(battleId, timeStamp);
                    lastPlayerCastSkillTime = timeStamp;
                }
                if (rightTeam !== undefined){
                    ...
                    if (battle) {
                        battle.updateEnemies(rightTeam);
                    }
                }
            }

            updateDeath(battleId, timeStamp,respawnRemaining) {
                if (this.hasBattle(battleId)){
                    this.getBattle(battleId).updateDeath(timeStamp,respawnRemaining);
                }
            }
            ...
            getTotalDeaths(){
                ...
                // Map 的遍历也很方便
                for (let battle of this.battles.values()) {
                    total += battle.getdeaths();
                }
                return total;
            }

            getTotalNumberOfEnemy(){
                let total = 0;
                // Map 的遍历也很方便
                for (let battle of this.battles.values()) {
                    total += battle.getNumberOfEnemy();
                }
                return total;
            }
        }

        const battleManger = new BattleManager();
        ...
        class SkillStat {
            constructor(name, stoneId) {
                ...
                this.miss = 0;                                  // 未命中次数
                this.manaCost = new StatTracker();              // 蓝耗统计
            }
            ...
            updateManaCost(manaCost){
                this.manaCost.update(manaCost);
            }
            ...
            getAverageDPS() {
                ...
                if (totalTime !== null && totalTime !== undefined && totalTime !== 0) {
                    ...
                    return formatNumberSmart(totalDamage / battleManger.globalTotalDuration());
                }
            }
            ...
            getEffectiveInterval() {
                ...
                return formatNumberSmart(battleManger.globalTotalDuration() / totalCount);
            }

            toString() {
                if (this.stoneId !== "") {
                    return `🧪 技能: ${this.name}  (🆔 ${this.stoneId}) \n
                    🌀 魔力消耗: ${this.manaCost.toString()} \n
        ...
        class MagicStat {
            ...
            toString(denominator, coefficient = magicAvgMode) {
                ...
                //展示没中过魔法效果的 均值(根据系数决定是否要乘以覆盖率), 最小最大值 覆盖率
                if (coefficient === 1) {
        ...
        //清场空闲时间
        const waitTimeStat = new StatTracker();
        // 战斗时长记录 根据稀有度分类
        ...
        function connectSSEWithAuth({url, token, onMessage, onError, retryInterval = 1000}) {
            let controller = null;
            let isStopped = false;
            let heartbeatTimer = null;
            let lastMessageTime = Date.now();
            const heartbeatInterval = 1000;
            const maxSilentTime = 1000;
            ...
            sseConnection = connectSSEWithAuth({
                ...
                onMessage: ({event, data}) => {
                    ...
                    try {
                        ...
                        dataList.forEach(json => analyzeBattleType2(json));
                    } catch (e) {
                        myLog.error("❌ 单条数据解析错误");
                        myLog.error(e.stack);
                        const {dataList} = parseSSEChunk(data);
...
// 修改后的核心逻辑
         ...
         */
            //当前的战斗状态
        const BATTLE_STATUS_INIT = 0;
        const BATTLE_STATUS_IN_BATTLE = 1;
        const BATTLE_STATUS_DEATH = 2;
        const BATTLE_STATUS_WAIT = 3;
        const battleStatusLabels = {
            [BATTLE_STATUS_INIT]: "初始化",
            [BATTLE_STATUS_IN_BATTLE]: "战斗中",
            [BATTLE_STATUS_DEATH]: "死亡中",
            [BATTLE_STATUS_WAIT]: "清场空闲中"
        }
        let lastBattleStatus = BATTLE_STATUS_INIT;
        let deathStartTime = 0;
        let lastBattleTime = 0;

        function analyzeBattleType2(json) {
            if (printNextDetail) {
                console.log(json);
            }

            let battleTime = json.time;
            let battleId = json.battleId;
            if (battleTime === undefined) {
                //结算经验值 掉落 额外帧
                analyzeBattleResult2(json);
            } else {
                //时段记录
                battleManger.update(battleId, battleTime,json.rightTeam);
                let respawnRemainingSeconds = json.respawnRemainingSeconds;
                if (respawnRemainingSeconds !== undefined) {
                    //死亡时段记录
                    battleManger.updateDeath(battleId,battleTime,respawnRemainingSeconds)
                }
                //todo 战斗事件记录
         ...
         */
        let analyzedEnemyIds = new Set();

        function analyzeEnemies(enemyData) {
            //新建数据  根据稀有度统计数量
            let enemyCountArray = [0, 0, 0, 0, 0];
            //分析敌人血量, 稀有度, 护盾 需要考虑敌人重复问题
            enemyData.forEach(enemy => {
                if (!analyzedEnemyIds.has(enemy.index)) {
                    const {index, hpMax, esMax, rarity} = enemy;
                    // 统计 ES 值（有esMax即视为存在ES）
                    if (esMax !== undefined) {
                        enemyEs.update(esMax);
                        enemyEsByRarity.update(rarity, esMax)
                    ...
                    enemyCountArray[rarity] += 1;
                    //加入已统计id
                    analyzedEnemyIds.add(index);
                }
            })
        }

        function clearAnalyzedEnemyIds() {
            analyzedEnemyIds.clear();
        }
        ...
        function analyzeBattleResult2(json) {
            expStats.update(json.trophy?.exp ?? 0) // 安全读取 trophy.exp，默认值为 0

            //todo 分析掉落
        }

        function analyzeBattleStatusChange(json, currentBattleStatus) {
            let currentTime = json.time;
            if (currentBattleStatus === BATTLE_STATUS_DEATH && lastBattleStatus === BATTLE_STATUS_IN_BATTLE) {
                //如果当前为死亡 上一帧还在打怪, 记录下完整的一次战斗时间
                battleTimeStat.update(currentTime - deathStartTime)
                //并记录当前时间作为死亡时间
                deathStartTime = json.time;
            } else if (currentBattleStatus === BATTLE_STATUS_IN_BATTLE && lastBattleStatus === BATTLE_STATUS_DEATH) {
                //如果当前帧进入战斗, 上一帧为死亡, 那记录下完整的死亡时间
                searchTime.update(currentTime - deathStartTime)
            }
        }
        ...
        //分析玩家技能
        function _analyzeSkill(targets, skillName, stoneId = skillName, currentTime,manaCost) {
            const key = `${skillName}::${stoneId}`;

            if (!playerSkillStats[key]) {
                playerSkillStats[key] = new SkillStat(skillName, stoneId);
            }
            let interval = currentTime - lastPlayerCastSkillTime;

            // 空放技能，targets 可能为 undefined 或 null
            const t = Array.isArray(targets) ? targets : [];
            playerSkillStats[key].updateInterval(t.length, interval);
            lastPlayerCastSkillTime = currentTime;

            if (manaCost !== undefined && Number.isFinite(manaCost)){
                playerSkillStats[key].updateManaCost(manaCost);
            }
        }
        ...
        function _analyzePlayerBuff(buffs) {
            ...
            buffs.forEach(buff => {
                ...
                if (key.includes("猎首")) {
                    ...
                    //buff层数
                    playerBuffStats[key].update(1);
                    //奉献地面的每秒治疗作为魔法效果
                    playerBuffStats[key].updateMagic(-1, buff.healPerSecond);
                } else {
                    if (!playerBuffStats[key]) {
                        playerBuffStats[key] = new BuffStat(key, buff.type);
                    }
                    ...
                    if (buff.magics && typeof buff.magics === "object") {
                        ...
                        Object.entries(buff.magics).forEach(([magicKey, magicValues]) => {
                            ...
                            if (!Array.isArray(magicValues) || magicValues.length <= 0) {
                                //特殊buff类型
                                console.log(buffs)
                            }
        ...
        function analyzeBattleEvent(json) {
            ...
            if (json.actor === undefined) {
                ...
                //玩家释放技能
                //所有事件都统计buff
                if (json.leftTeam !== undefined) {
                    _analyzePlayerBuff(json.leftTeam[0].buffs ?? json.buffs ?? undefined);
                } else {
                    _analyzePlayerBuff(json.buffs ?? undefined);
                }
                const enemies = json.rightTeam;
                ...
                if (json.skill !== undefined) {
                    // 主动技能
                    skillName = json.skill.name || json.skill.id;
                    skillId = json.skill.stoneId;
                    if (json.eventType !== undefined && json.eventType !== "projectile_hit"){
                        _analyzeSkill(json.targets, skillName, skillId, json.time,json.skill.manaCost);
                    }
                    (json.targets ?? []).forEach(target => {
                        if (target.name === playerId) {
                            target.totalHeal !== undefined && _analyzeHeal(target, skillName);
                        } else {
            ...
            } else if (json.targets) {

                const leftPlayer = json.leftTeam?.[0];
                _analyzePlayerBuff(leftPlayer?.buffs ?? json.buffs ?? undefined);

                _analyzeEnemyBuff(json.buffs);

                const target = json.targets?.[0];
                if (target?.name === playerId) {
                    _analyzeTaken(target, json.skill?.name);
                }
            } else {
                console.log(json);
        ...
        function showData() {
            ...
            const winRate = (totalKills / (battleManger.getTotalDeaths() + totalKills) * 100).toFixed(2);

            myLog.log(`${playerClassEmj} 玩家: ${playerId} (${playerUId})`);

            myLog.log(`✅ 击杀: ${totalKills} 只 | ❌ 死亡: ${battleManger.getTotalDeaths()} 次 | 🏆 胜率: ${winRate}%`);

            myLog.log(`⏱️ 总计战斗时间: ${formatNumberSmart(battleManger.globalTotalDuration())}s | ⏳ 死亡读秒时间: ${formatNumberSmart(battleManger.globalDeathDuration())}s | 💀 死亡次数: ${battleManger.getTotalDeaths()} | ⏲️ 平均单次死亡时间: ${formatNumberSmart(battleManger.globalDeathDuration()/battleManger.getTotalDeaths())}s`);
            myLog.log(`🔄 平均刷怪间隔: ${formatNumberSmart( battleManger.globalTotalDuration()/battleManger.getTotalNumberOfEnemy())}s | ⚡ 每分钟刷怪数: ${formatNumberSmart( battleManger.getTotalNumberOfEnemy()/battleManger.globalTotalDuration() * 60)}只/min`);
...
.menu:hover .dropdown {
            ...
            <div class="menu">
                <button>⚙️ 高级分析 ▸</button>
                    <div class="dropdown">
                        ...
                        <button id="shareBattleLinkBtn">🔗 生成分享战斗链接</button>
                    </div>
            </div>
            <div class="menu">
                <button>🧩 其他功能 ▸</button>
  ...
  `;
            ...
            const shareBattleLinkBtn = modal.querySelector("#shareBattleLinkBtn");
...
// 鼠标释放
            ...
            btnTest.onclick = () => {
                if (printNextDetail){
                    myLog.logWithScroll("已经关闭在控制台(F12)打印战斗日志");
                    printNextDetail = false;
                }else {
                    myLog.logWithScroll("已经开启在控制台(F12)打印战斗日志, 注意战斗数据较多, 长时间开启可能会占用较多内存和性能");
                    printNextDetail = true;
                }
            };
            shareBattleLinkBtn.onclick = async () => {
                let shareLink = "🔗 " + shareBattleUrl + playerUId;
                myLog.logWithScroll(shareLink);
                try {
                    // 调用系统剪贴板 API
                    await navigator.clipboard.writeText(shareLink);

                    // 成功反馈（可以用你喜欢的 Emoji）
                    myLog.logWithScroll("🔗 链接已写入剪贴板！");
                } catch (err) {
                    // 失败反馈
                    myLog.logWithScroll("🔗 链接写入剪贴板失败, 请手动复制");
                }
            };
            updatelogBtn.onclick = () => {
                myLog.group("默认说明")
                myLog.log("小版本变化或者没有更新日志都是修复bug");
                myLog.groupEnd()

                myLog.group("v2.01")
                myLog.log("1. 适应新版本战斗数据, 新增耗蓝统计, 刷怪速度统计功能");
                myLog.log("2. 新增了一个生成分享战斗链接的功能");
                myLog.log("3. 如果在观战页面使用战斗插件 会统计观战目标而不是自己的数据");
                myLog.log("4. 目前死亡回放暂不可用");
                myLog.log("5. 目前对于投射物类技能, 会丢失大量敌人buff数据");
                myLog.groupEnd()
                ...
                myLog.logWithScroll("4. 遇怪分析, 怪物血量,护盾等");
                myLog.groupEnd()
            };
            feedbackBtn.onclick = () => {
