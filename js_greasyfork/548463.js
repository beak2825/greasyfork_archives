...
// @author              FAZE | SNIPER x Hrt x ttap
...
// @match               *://krunker.io/*
// @grant               none
// @downloadURL https://update.greasyfork.org/scripts/548463/YT_FAZE%20SNIPER.user.js
// @updateURL https://update.greasyfork.org/scripts/548463/YT_FAZE%20SNIPER.meta.js
// ==/UserScript==
// Custom hub
//Tells u if hack is working.
alert("INJECTED KRUNKER SNIPER")
//Hub change
document.title = "FAZE KRUNKER SNIPER";
document.getElementById("instructions").style.color = "Red";
document.getElementById('instructions').innerHTML = 'Loading Krunkerplus REWORKED by FAZE | SNIPER';
document.getElementById('modVote').innerHTML = 'KRUNKERSNIPER+';
document.getElementById("modVote").style.color = "Blue";
document.getElementById("texts3DHolder").innerHTML = 'GET MORE HACKS AT FAZE SNIPER CHANNEL';
// Adblock
...
// Chat messege
document.getElementById('voiceDisplay').innerHTML = '<div class="menuDebugInfo" id="zaresplusisapros"><span style="color:#DAE110">Working on 1.9.2<span class="chatMsg">| OVERHAX KRUNKERPLUS REWORKED <span class="chatMsg"><span style="color:#F18938"> | OVERHAX.ML</span></span></span><i id="voiceIcon" class="material-icons" style="color:#fff;font-size:40px">mic</i> <div id="recTimer">[V]</div></div></div></div>';
