// ==UserScript==
// @name         EU Parliament MEP Scraper -> csv _DE
...
// @downloadURL https://update.greasyfork.org/scripts/562414/EU%20Parliament%20MEP%20Scraper%20-%3E%20csv%20_DE.user.js
// @updateURL https://update.greasyfork.org/scripts/562414/EU%20Parliament%20MEP%20Scraper%20-%3E%20csv%20_DE.meta.js
// ==/UserScript==
...
(function() {
    ...
    const getGenderNickname = async (firstName, displayName) => {
        const fallbackGreeting = `Sehr geehrte Frau Abgeordnete/Sehr geehrter Herr Abgeordneter ${displayName}`;
        ...
        try {
            ...
            if (data.gender === 'female') {
                return `Sehr geehrte Frau Abgeordnete ${displayName}`;
            } else if (data.gender === 'male') {
                return `Sehr geehrter Herr Abgeordneter ${displayName}`;
            }
        } catch (err) {
