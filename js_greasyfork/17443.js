...
// @name         ？？？Ext
// @version      1.1
// @namespace    Creador por: ？？？
// @description  Only duo's pros
// @author       ？？？
// @match        http://agar.io/*
// @match        https://agar.io/*
...
// @downloadURL https://update.greasyfork.org/scripts/17443/%EF%BC%9F%EF%BC%9F%EF%BC%9FExt.user.js
// @updateURL https://update.greasyfork.org/scripts/17443/%EF%BC%9F%EF%BC%9F%EF%BC%9FExt.meta.js
// ==/UserScript==
function loadScript(a, b) {
    ...
    $("div.header").replaceWith('<div id="NEL99Header" class="header" style="color:#fc0000; font-size:35px;"><b>Ahhhh Iziiii</b></div>');
    $("div.agario-panel.agario-side-panel.agarioProfilePanel.level.forums").replaceWith('<div class="agario-panel agario-side-panel agarioProfilePanel level forums" style="display: block !important;text-align:center"<p style="font-size:20px;"><b>Agarplus.io v2 Editado Por:？？？</b></p></div>');
