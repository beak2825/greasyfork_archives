...
// @namespace https://greasyfork.org/users/315177
// @downloadURL https://update.greasyfork.org/scripts/411539/%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90.user.js
// @updateURL https://update.greasyfork.org/scripts/411539/%E8%A7%86%E9%A2%91%E8%A7%A3%E6%9E%90.meta.js
// ==/UserScript==
    (function() {
	...
	if(get_url.indexOf('eggvod.cn') == -1){
		...
		$("#zhm_jx_url_lr").click(function(){
            ...
            if(/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
                ...
                mobile_html += "<div><iframe src='http://192.168.115.129:231/?url="+play_jx_url +"' allowtransparency=true frameborder='0' scrolling='no' allowfullscreen=true allowtransparency=true name='jx_play'style='height:600px;width:100%'></iframe></div>"
                mobile_html += "</div>";
               $("body").html(mobile_html);
            } else {
                $.get('https://www.eggvod.cn/jxcode.php',{in:81566699},function(data){
                    location.href='http://192.168.115.129:231/?url='+play_jx_url;
               });
            }
		});
	//获取url参数;
