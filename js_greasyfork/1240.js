...
// @description    Время с секундами (by Demin)
...
// @grant          GM_log
// @grant          GM_openInTab
// @downloadURL https://update.greasyfork.org/scripts/1240/hwm_time_seconds.user.js
// @updateURL https://update.greasyfork.org/scripts/1240/hwm_time_seconds.meta.js
// ==/UserScript==
...
if (Number(GM_getValue("95725_last_synch_gm", '0')) + 21600000 < (new Date().getTime())) { get_time(); }
