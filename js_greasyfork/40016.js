// ==UserScript==
// @name       Simulationsbutton im Profil AT
// @include  http://fussballcup.at/*
// @version    0.1.1
// @description  Erzeugt in jedem Profil einen Simulations-Spiel-Button
// @copyright  Klaid, 2013 / mot33, 2018
// @connect <value>
// @namespace https://greasyfork.org/users/83290
// @downloadURL https://update.greasyfork.org/scripts/40016/Simulationsbutton%20im%20Profil%20AT.user.js
// @updateURL https://update.greasyfork.org/scripts/40016/Simulationsbutton%20im%20Profil%20AT.meta.js
// ==/UserScript==
...
function changes()
{
    	if(!document.getElementById("simuspiel"))
        {
    		...
    		document.getElementsByClassName("profile-actions")[0].innerHTML += "<a href='#/index.php?w=301&area=user&module=simulation&action=index&squad=" + user_id + "' class='button' id='simuspiel'><span>Simulationsspiel</span>";
