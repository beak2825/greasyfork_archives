// ==UserScript==
// @name        Myrmidon
// @description Myrmidons Fighting Script
...
// @grant       GM_info
// @grant       unsafeWindow
// @namespace https://greasyfork.org/users/2283
// @downloadURL https://update.greasyfork.org/scripts/5822/Myrmidon.user.js
// @updateURL https://update.greasyfork.org/scripts/5822/Myrmidon.meta.js
// ==/UserScript==
...
var engine = {
    ...
    setHTML : function()
    {
        var code = '<div style="position: absolute; top: 685px; right: 160px; width: 150px; text-align: center; background: white; border: 1px solid black;">';
        code += '<div id="'+this.prefix+'enable" style="cursor: pointer; padding: 5px 15px;">Start Myrmidon</div>';
        code += '<div id="'+this.prefix+'disable" style="cursor: pointer; padding: 5px 15px; display: none;">Stop Myrmidon</div>';
        code += '</div>';
        $('body').append(code);
