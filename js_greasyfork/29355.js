// ==UserScript==
// @name         Overlay MODOT Flood Closure
// @namespace    https://greasyfork.org/users/45389
// @version      0.4.001
// @description  Adds State Hwy/Routes layer for Missouri from MODOT
// @author       MapOMatic
...
// @connect      arcgis.com
// @connect      modot.org
// @icon          data:image/png;base64,
// @downloadURL https://update.greasyfork.org/scripts/29355/Overlay%20MODOT%20Flood%20Closure.user.js
// @updateURL https://update.greasyfork.org/scripts/29355/Overlay%20MODOT%20Flood%20Closure.meta.js
// ==/UserScript==

(function() {
    'use strict';

    var _settingsStoreName = 'wme_MODOT_FC';
    ...
    var _stateSettings = {
        MO: {
            baseUrl: '',
            mapLayers: [
                { layerID:'http://mapping.modot.org/arcgis/rest/services/Traveler-Information/Traveler_Information_Data/MapServer/13', outFields:[''] },
            ...
            colors: {closure:'#50fc53'}
        }
    };

    function log(message, level) {
        if (message && level <= _debugLevel) {
            console.log('MODOT FLood: ' + message);
        }
    }
    ...
    function getLineWidth() {
        return 30 * Math.pow(1.15, (W.map.getZoom()-1));
    }
    ...
    function initLayer(){
        ...
        _mapLayer = new OpenLayers.Layer.Vector("Overlay - MODOT Flood Closed ", {
            uniqueName: "__USMODOTFC",
            displayInLayerSwitcher: false
        });
        I18n.translations.en.layers.name.__FCLayer = "MODOT FC";
        ...
        WazeWrap.Interface.AddLayerCheckbox("overlay", "MODOT Flood Closure", _settings.layerVisible, onLayerToggleChanged);
    }
