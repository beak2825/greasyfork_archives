...
// @homepage     https://test.site/Blum
// @description  blumgametest
// @downloadURL https://update.greasyfork.org/scripts/511710/Blum%20Autoclicker.user.js
// @updateURL https://update.greasyfork.org/scripts/511710/Blum%20Autoclicker.meta.js
// ==/UserScript==
...
try {
  ...
  style.textContent = `
    ...
    .settings-button {
      ...
      bottom: 20px;
      right: 20px;
      background-color: rgba(36, 146, 255, 0);
      color: #fff;
      border: none;
      border-radius: 50%;
      width: 40px;
...
// @version     1.0
// @author      -
// @description 8/31/2024, 1:14:52 AM
// ==/UserScript==
