...
//安全网址请填写在上方空白区域
// @downloadURL https://update.greasyfork.org/scripts/520279/%E3%80%90wz%E3%80%91%E3%80%90xxt%E3%80%91.user.js
// @updateURL https://update.greasyfork.org/scripts/520279/%E3%80%90wz%E3%80%91%E3%80%90xxt%E3%80%91.meta.js
// ==/UserScript==
(() => {
        ...
        <div class="row" style="margin: 10px;">
            <div class="col-md-6 col-md-offset-3">
                <div class="header clearfix">
                    <h3 class="text-muted" style="margin-top: 20px;margin-bottom: 0;float: left;"><a href="https://scriptcat.org/script-show-page/336" target="view_window">刷v1.0&ensp;</a></h3><div id="onlineNum"></div>
                </div>
...
`;
        var logs = {
            ...
            loopjob = () => {
                ...
                if (busyThread <= 0) {
                    if (jumpType != 2) {
                        _w.top.jump = true;
                        logs.addLog('所有任务处理完毕，1秒后自动下一章', 'green');
                    } else {
        ...
        try {
            ...
            if (jumpType != 2) {
                _w.top.jump = true;
                logs.addLog('此页无任务，1秒后自动下一章', 'green');
            } else {
