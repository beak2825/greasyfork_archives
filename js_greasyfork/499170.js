// ==UserScript==
// @name        lezhinus.com downloader
// @namespace   https://*lezhinus.com/*/comic/
// @match       https://*lezhinus.com/*/comic/*
// @version     1.0.1
// @author      ssrankedghoul
// @description Downloads all images of a chapter or title on lezhinus.com
// @require     https://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js
// @license     MIT
// @noframes
// @downloadURL https://update.greasyfork.org/scripts/499170/lezhinuscom%20downloader.user.js
// @updateURL https://update.greasyfork.org/scripts/499170/lezhinuscom%20downloader.meta.js
// ==/UserScript==
/* jshint esversion: 11 */
;(() => {
	const debug = false
	...
	async function downloadImagesAsZip(alias, chapterName, silent = false) {
		...
		const chapterData = (
			await fetch(
				'https://www.lezhinus.com/lz-api/v2/inventory_groups/comic_viewer_k?' +
					Object.entries({
						platform: 'web',
						store: 'web',
						alias,
		...
		const bearerRes = await fetch(`https://www.lezhinus.com/en/comic/${alias}/${chapterName}`, {
			method: 'GET',
			credentials: 'include',
			mode: 'cors',
			headers,
