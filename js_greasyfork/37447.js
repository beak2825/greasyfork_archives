// ==UserScript==
// @name         Overlay NE Dodge County
// @namespace    https://greasyfork.org/users/45389
// @version      0.4.4.001
// @description  Adds a layer to display Parcel info for Dodge County Nebraska
// @author       MapOMatic
...
// @downloadURL https://update.greasyfork.org/scripts/37447/Overlay%20NE%20Dodge%20County.user.js
// @updateURL https://update.greasyfork.org/scripts/37447/Overlay%20NE%20Dodge%20County.meta.js
// ==/UserScript==
...
(function() {
    ...
    function getUrl(extent, zoom) {
        ...
        var url = 'https://gis3.gisworkshop.com/arcgis/rest/services/Dodge/MapServer/1/query?geometry=' + encodeURIComponent(geometryStr);
        ...
        if (_mapLayer !== null) {
            ...
            for (var i=0;i<_mapLayer.features.length;i++){
                ...
                if(feature.geometry.containsPoint(mapCenter)) {
                    ...
                    url = 'https://report.gisworkshop.com/report.ashx?county=dodge&id=' + num + '&type=assessor&subs=true&format=html';
    ...
    function initLayer(){
        ...
        WazeWrap.Interface.AddLayerCheckbox("overlay", "NE Dodge Co Parcel", _settings.layerVisible, onLayerToggleChanged);
    }
