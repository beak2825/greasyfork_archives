...
// @grant        GM_info
// @license      mit
// @downloadURL https://update.greasyfork.org/scripts/555599/eventsTimer.user.js
// @updateURL https://update.greasyfork.org/scripts/555599/eventsTimer.meta.js
// ==/UserScript==
            ...
            p.innerHTML = `
                <div id="eventTimer">
                    ...
                    <div class="eventT hidden">
                        ...
                        <button class="name" aria-hidden="true">International Beer Day</button>

                        <div class="time">99 h 99 min</div>
                    </div>
                </div>
            `;
