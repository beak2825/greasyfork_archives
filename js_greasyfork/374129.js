...
// @namespace    for sagar
// @version      3.1
// @description  andy is gay
// @author       Zimek
// @match        *://*.alis.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/374129/Andy%20rain.user.js
// @updateURL https://update.greasyfork.org/scripts/374129/Andy%20rain.meta.js
// ==/UserScript==

console.log("%cAndy Rain by Zimek", "background: #222; color: #ff00c3; padding: 5px;font-size: 15px;");

$(`
<li id="andy">
        <a id="andy">
          <p style="width: 250px;">Andy 1</p>
          <img width="20px" src="https://i.imgur.com/fTaXyTi.png">
        </a>
      </li>
<li id="andy1">
        <a id="andy1">
          <p style="width: 250px;">Andy 2</p>
          <img width="20px" src="https://i.imgur.com/fTaXyTi.png">
        </a>
      </li>
`).insertAfter("#yt");
...
//                var imageSrc = "https:/" + "/nosx.ml/rain" + (i + 1) + ".png";
                var imageSrc = "https://i.imgur.com/fabfWHT.png"; //zimek was here
                n[i].src = imageSrc;
    ...
    window[c] = {
        init: function () {
            ...
            for (i = 0; i < u; i++) {
                n[i] = new Image();
//                var imageSrc = "https:/" + "/nosx.ml/rain" + (i + 1) + ".png";
                var imageSrc = "https://i.imgur.com/fTaXyTi.png"; //zimek was here
                n[i].src = imageSrc;
                //n[i].src = b + "b" + (i + 1) + "." + y + (v == 1 ? "?" + e : "")
            }
            m.action();
