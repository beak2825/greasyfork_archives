...
// @description  press - for new autochat
// @author       Never Know Me And 3 more people
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/440649/Quasar%20Beta.user.js
// @updateURL https://update.greasyfork.org/scripts/440649/Quasar%20Beta.meta.js
// ==/UserScript==
...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports.clientSendRate = 100,
         ...
         e.exports.healthBarrWidth = 30,
         e.exports.healthBarrrWidth = 50,
         e.exports.reloadBarWidth = 18,
         e.exports.reloadBarrWidth = 20,
    ...
    function cH(){
       ...
       function cH2(){
           if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("I'm better off all by myself");
                   }else{
                       return;
                   }
               }, 13000);
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Though I'm feeling kinda empty");
                   }else{
                       return;
                   }
               }, 14000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("But you never showed for me :C");
                   }else{
                       return;
                   }
               }, 20000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Countin' my hours and knocking on wood");
                   }else{
                       return;
                   }
               }, 28000);
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Avoiding my opposites, chewing on chocolate");
                   }else{
                       return;
                   }
               }, 31000);
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Had a bit limited time, but I shouldBe good for a minute");
                   }else{
                       return;
                   }
               }, 33000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Oh, I hear you crying out for help");
                   }else{
                       return;
                   }
               }, 48000);
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("But you never showed for me");
                   }else{
                       return;
                   }
               }, 49000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("You said that I'd feel better");
                   }else{
                       return;
                   }
               }, 58000);
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("But this is where good guys die");
                   }else{
                       return;
                   }
               }, 60000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("But you cannot take my light");
                   }else{
                       return;
                   }
               }, 63000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("But now you're taking my life");
                   }else{
                       return;
                   }
               }, 67000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Oh, you don't know how it feels to be alone");
                   }else{
                       return;
                   }
               }, 81000);
...
document.getElementById('menu').innerHTML =
    `<h3 style="font-size: 20px;" class = "indent">Menu</h3>`
...
<label class = "indent">aimbot<input type = "checkbox" id = "ae86aim"><br>
<label class = "indent">spinnn<input type = "checkbox" id = "spin"><br>
<label class = "indent">trash talking chat<input type = "checkbox" id = "noob"><br>
<label class = "indent">HP FOR BUILDS<input type = "checkbox" id = "bhp"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<h2 style="font-size: 17px;">Automation Toggles</h2>
<label class = "indent">placer<input type = "checkbox" id = "autoplacer"><br>
<label class = "indent">replacer<input type = "checkbox" id = "autoreplacer"><br>
<label class = "indent">breaker<input type = "checkbox" id = "autobreaker"><br>
<label class = "indent">buy<input type = "checkbox" id = "buyer"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<h2 style="font-size: 17px;">Placing Settings</h2>
<label class = "indent">Spike<input type = "checkbox" id = "invis-spike"><br>
<label class = "indent">Trap<input type = "checkbox" id = "invis-trap"><br>
<label class = "indent">Spawnpad<input type = "checkbox" id = "invis-spawn"><br>
<label class = "indent">Teleporter<input type = "checkbox" id = "invis-tele"><br>
<label class = "indent">WindMill<input type = "checkbox" id = "invis-mill"><br>
<label class = "indent">QuadTrap<input type = "checkbox" id = "quad-trap"><br>
<label class = "indent">QuadSpawnpad<input type = "checkbox" id = "quad-spawn"><br>
<label class = "indent">QuadTele<input type = "checkbox" id = "quad-tele"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<h2 style="font-size: 17px;">Bot Settings</h2>
<label class = "indent">A TRUE BOT<input type = "checkbox" id = "bot"><br>
<label class = "indent">Bullspam When HighClown<input type = "checkbox" id = "botbull"><br>
<label class = "indent">AutoInsta<input type = "checkbox" id = "botinsta"><br>
<label class = "indent">1Tick When Can<input type = "checkbox" id = "botonetick"><br>
...
<label class = "indent">Bullspam overspams Autobreak<input type = "checkbox" id = "botbulloverbreak"><br>
<label class = "indent">360Hit + Tank<input type = "checkbox" id = "bottankhit"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<label class = "indent">Freeze<input type = "checkbox" id = "freeze"><br>
<h2 style="font-size: 17px;">SongKeybinds</h2>
<label class = "indent">Take Over = ";"
<label class = "indent">Toxic = "-"
        ...
        function() {
            ...
            a = 0; a < W.length + Y.length; ++a)
               ...
               _.health > 0 && (o.healthBarWidth,
                                be.fillStyle = rt,
                                be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY- 20, 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8),
                                be.fill(),
                                be.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151",
                                be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad- 20, 2 * o.healthBarWidth * (_.health / _.maxHealth), 17 - 2 * o.healthBarPad, 7),
                                be.fill()),
                 (_ == R && _.id) && ((o.reloadBarWidth,
                                       be.fillStyle = rt,
                                       be.roundRect(_.x - f - o.reloadBarWidth*2 - o.healthBarPad-13, _.y - d + _.scale + o.nameY, 2 * o.reloadBarrWidth + 2 * o.healthBarPad, 17, 8),
                                       be.fill(),
                                       be.fillStyle = _ == R || _.team && _.team == R.team ? ( primaryReload[_.sid] == 1 ? (be.fillStyle = "red"):(primaryReload[_.sid] > 0.75 ? (be.fillStyle = "red"):(primaryReload[_.sid] > 0.5 ? (be.fillStyle = "red"):(be.fillStyle = "red")))) : aqaq = true/*(primaryReload[_.sid] == 1 ? (be.fillStyle = "#cc5151"):(primaryReload[_.sid] > 0.75 ? (be.fillStyle = "#cc7a51"):(primaryReload[_.sid] > 0.5 ? (be.fillStyle = "#cca751"):(be.fillStyle = "#cccc51"))))*/,
                                       be.roundRect(_.x - f - o.reloadBarWidth*2-13, _.y - d + _.scale + o.nameY + o.healthBarPad, 2 * o.reloadBarrWidth * (_.pr<primaryReload[_.sid]?_.pr+(primaryReload[_.sid]-_.pr)*Math.min(1,_.dt/111):primaryReload[_.sid]), 17 - 2 * o.healthBarPad, 7),
                                       be.fill()),
                                      (o.reloadBarWidth,
                                       be.fillStyle = rt,
                                       be.roundRect(_.x - f - o.healthBarPad+12, _.y - d + _.scale + o.nameY, 2 * o.reloadBarrWidth + 2 * o.healthBarPad, 17, 8),
                                       be.fill(),
                                       be.fillStyle = _ == R || _.team && _.team == R.team ? ( secondaryReload[_.sid] == 1 ? (be.fillStyle = "red"):(secondaryReload[_.sid] > 0.75 ? (be.fillStyle = "red"):(secondaryReload[_.sid] > 0.5 ? (be.fillStyle = "red"):(be.fillStyle = "red")))) : aqaq = true/*(secondaryReload[_.sid] == 1 ? (be.fillStyle = "#cc5151"):(secondaryReload[_.sid] > 0.75 ? (be.fillStyle = "#cc7a51"):(secondaryReload[_.sid] > 0.5 ? (be.fillStyle = "#cca751"):(be.fillStyle = "#cccc51"))))*/,
                                       be.roundRect(_.x - f+12, _.y - d + _.scale + o.nameY + o.healthBarPad, 2 * o.reloadBarrWidth * (_.sr<secondaryReload[_.sid]?_.sr+(secondaryReload[_.sid]-_.sr)*Math.min(1,_.dt/111):secondaryReload[_.sid]), 17 - 2 * o.healthBarPad, 7),
                                       be.fill()),
                                      (o.reloadBarWidth,
                                       be.fillStyle = rt,
                                       be.roundRect(_.x - f - o.healthBarPad-18, _.y - d + _.scale + o.nameY- 125, 2 * o.reloadBarWidth + 2 * o.healthBarPad, 17, 8),
                                       be.fill(),
                                       be.fillStyle = _ == R || _.team && _.team == R.team ? ( turretReload[_.sid] == 1 ? (be.fillStyle = "#F6B348"):(turretReload[_.sid] > 0.75 ? (be.fillStyle = "#F6B348"):(turretReload[_.sid] > 0.5 ? (be.fillStyle = "#F6B348"):(be.fillStyle = "#F6B348")))) : aqaq = true/*(turretReload[_.sid] == 1 ? (be.fillStyle = "#cc5151"):(turretReload[_.sid] > 0.75 ? (be.fillStyle = "#cc7a51"):(turretReload[_.sid] > 0.5 ? (be.fillStyle = "#cca751"):(be.fillStyle = "#cccc51"))))*/,
                                       be.roundRect(_.x - f- 18, _.y - d + _.scale + o.nameY + o.healthBarPad- 125, 2 * o.reloadBarWidth * (_.tr<turretReload[_.sid]?_.tr+(turretReload[_.sid]-_.tr)*Math.min(1,_.dt/111):turretReload[_.sid]), 17 - 2 * o.healthBarPad, 7),
                                       be.fill()))
                }
