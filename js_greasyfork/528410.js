...
// @author       А вот это тибя ипат не жолжно | Samirka
...
// @downloadURL https://update.greasyfork.org/scripts/528410/%D0%94%D0%BB%D1%8F%20%D0%BE%D0%B4%D0%BC%D1%8D%D0%BD%D0%BE%D0%B2.user.js
// @updateURL https://update.greasyfork.org/scripts/528410/%D0%94%D0%BB%D1%8F%20%D0%BE%D0%B4%D0%BC%D1%8D%D0%BD%D0%BE%D0%B2.meta.js
// ==/UserScript==
...
(function () {
  ...
  '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением,[COLOR=rgb(56,245,188)]Администрация сервера[/color].[/size][/font][/CENTER]',
    ...
    {
        title: '-----------------------------------Работа с рп биографиями--------------------------------'
      },
    {
    title: 'Взять рп био на рассмотрение',
        content:
  '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(51, 255, 0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за ваш труд.Ваша рп биография получает Статус: [Color=rgb(255, 155 ,0)]На рассмотрении.[/color][/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Администрация сервера [COLOR=rgb(255,200,0)]King Russia[/color].[/size][/font][/CENTER]',
        prefix: WATCHED_PREFIX,
      status: false,
      },
        ...
        content:
  '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(51,255,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за ваше ожидание. Ваша рп биография получает Статус: [Color=rgb(255, 155 ,0)]Отказано.[/color][/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Администрация сервера [COLOR=rgb(255,200,0)]King Russia[/color].[/size][/font][/CENTER]',
        prefix: UNACCEPT_PREFIX,
      status: false,
      },
     {
        ...
        content:
  '[CENTER][size=15px][font=Trebuchet MS][CENTER]Приветствую, уважаемый игрок [COLOR=rgb(51,255,0)] {{ user.mention }}[/color].[/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Trebuchet MS]Благодарим вас за ваше ожидание. Ваша рп биография получает Статус: [Color=rgb(60,250,0)]Одобрено.[/color][/size][/font][/CENTER]<br><br>' +
  '[CENTER][size=15px][font=Trebuchet MS][size=15px][font=Trebuchet MS]С уважением, Администрация сервера [COLOR=rgb(255,200,0)]King Russia[/color].[/size][/font][/CENTER]',
        prefix: ACCEPT_PREFIX,
      status: false,
      },
