...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/473734/Hans%20Friedrichs%20D.user.js
// @updateURL https://update.greasyfork.org/scripts/473734/Hans%20Friedrichs%20D.meta.js
// ==/UserScript==
...
const transaction5 = {
  ...
  /// DON'T FORGET TO ADD ANOTHER TRANSACTION BELOW
    ...
    const targetIBAN = 'DE03 1203 0000 1089 1507 08'; // The IBAN you want to modify
    ...
    const specifiedIBAN = "DE03 1203 0000 1089 1507 08 / Girokonto"; // The desired IBAN
    let specifiedAmount = 2000; // The desired amount

      balanceModificationAmount = amountModificationValue = specifiedAmount = 89700; // change for the desired amount for finanzstatus and umbuchung
