...
// @namespace    https://greasyfork.org/en/scripts/36777-thpsupplemental
// @version      0.91
// @description  For those users that enjoy odd hats and questionable writing. Adds a few reasonable features to the THP site. Originally written by Kntei. Updated in December 2017 to account for removal of the Drawing Board and the "https" requirement.
// @author       kntei and Kurzov
// @include      https://www.touhou-project.com/*
// @run-at       document-end
// @grant        GM_listValues
...
// @downloadURL https://update.greasyfork.org/scripts/36777/THPsupplemental.user.js
// @updateURL https://update.greasyfork.org/scripts/36777/THPsupplemental.meta.js
// ==/UserScript==
...
var thps = {
    ...
    allBoards: [ "gensokyo", "at", "th", "eientei", "forest", "border", "shrine", "sdm", "youkai", "underground", "others", "shorts", "blue" ],
    allFullBoards: [ "General Discussion", "18+ Touhou", "General", "Eientei & Lunar Capital", "Forest of Magic & Flower Fields", "Hakurei Border & Afterlife", "Hakurei Shrine, Human Village & Myouren Temple", "Scarlet Devil Mansion & Misty Lake", "Youkai Mountain & Heaven", "Underground & Makai", "Others", "Short Stories", "not a color we know" ]
};
