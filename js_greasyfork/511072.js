// ==UserScript==
// @name   GR_script_tech_by_support
// @name:ru script Tech Green Russia
...
// @downloadURL https://update.greasyfork.org/scripts/511072/GR_script_tech_by_support.user.js
// @updateURL https://update.greasyfork.org/scripts/511072/GR_script_tech_by_support.meta.js
// ==/UserScript==
 
(function () {
	'use strict';
	const UNACCEPT_PREFIX = 15; // префикс отказано
	const PIN_PREFIX = 17; //  префикс закрепить
	const COMMAND_PREFIX = 9; // команде проекта
	const CLOSE_PREFIX = 12; // префикс закрыто
	const DECIDED_PREFIX = 13; // префикс решено
	const TECHADM_PREFIX = 6; // теху администратору
	const WATCHED_PREFIX = 1; // рассмотрено
	const WAIT_PREFIX = 10; // ожидание (для переноса в баг-трекер)
	const NO_PREFIX = 0;
	const buttons = [
	{
		title: 'Приветствие',
