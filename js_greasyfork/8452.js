...
// @downloadURL https://update.greasyfork.org/scripts/8452/Virtonomica%3A%20%D0%90%D0%BF%D0%B3%D1%80%D0%B5%D0%B9%D0%B4%20%D0%BE%D0%B1%D0%BE%D1%80%D1%83%D0%B4%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F.user.js
// @updateURL https://update.greasyfork.org/scripts/8452/Virtonomica%3A%20%D0%90%D0%BF%D0%B3%D1%80%D0%B5%D0%B9%D0%B4%20%D0%BE%D0%B1%D0%BE%D1%80%D1%83%D0%B4%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F.meta.js
// ==/UserScript==
...
//------------------------------------------------------------------------------------------------------------------------------------ 	
    	...
    	$( '#mainTable tr[class]' ).each( function() 
	{
		...
		var offer = parseInt( $(cells[2]).text().trim().replace( ' ', '' ).replace(' ', '') ); 
	        var price = parseFloat( $( cells[6] ).text().replace(/[^\d\.]/g,'') );   //replace(' ', '' ).replace(' ', '') );
