...
// @version      1.11.5
// @downloadURL https://update.greasyfork.org/scripts/437847/Steam%20Web%20Integration%E9%AD%94%E6%94%B9.user.js
// @updateURL https://update.greasyfork.org/scripts/437847/Steam%20Web%20Integration%E9%AD%94%E6%94%B9.meta.js
// ==/UserScript==
...
function integrate(userdata, decommissioned, cards, bundles, limited, dlc, lastCached) {
    ...
    const appSelector = [
        ...
        `img[src*="media.st.dl.eccdnx.com/steam/apps/"]`,//添加
...
.hotGame-mobile-buy .cdKey-mobile-list .cdKey-mobile-flex img[data-v-3c86f869] {
    width: 75%!important;
}
.hotGame-mobile-buy .cdKey-mobile-list .cdKey-mobile-flex img[data-v-22482012] {
    width: 100%!important;
}
.cdKey-mobile-con .cdKey-mobile-list .cdKey-mobile-flex img[data-v-28bab992] {
    width: 100%!important;
}
    .gameDiscount {"
    float:left;!important;
                //background:#da1106 !important;"
            }
            .swi-block {
