// ==UserScript==
// @name          Eternity Tower Ability Cooldown Alert
// @icon          https://www.eternitytower.net/favicon.png
// @namespace     http://mean.cloud/
// @version       1.12
// @description   Plays a sound when ability CDs have expired
// @match         *://eternitytower.net/*
// @match         *://www.eternitytower.net/*
// @author        psouza4@gmail.com
// @copyright     2017-2023, MeanCloud
// @run-at        document-end
// @downloadURL https://update.greasyfork.org/scripts/36634/Eternity%20Tower%20Ability%20Cooldown%20Alert.user.js
// @updateURL https://update.greasyfork.org/scripts/36634/Eternity%20Tower%20Ability%20Cooldown%20Alert.meta.js
// ==/UserScript==


////////////////////////////////////////////////////////////////
////////////// ** SCRIPT GLOBAL INITIALIZATION ** //////////////
function startup() { ET_CDAlertMod(); }
////////////////////////////////////////////////////////////////


ET_CDAlertMod = function()
{
    ET.MCMF.WantFasterAbilityCDs = true;
    //audioCDReady = new Audio('https://www.soundjay.com/misc/magic-chime-02.mp3');
	audioCDReady = new Audio('//www.damned.cloud/ETResources/audio/notificationlow.mp3');

    ET.MCMF.Ready(function()
    {
        ET.MCMF.EventSubscribe("abilitiesReady", function()
        {
            ET.MCMF.ToastMessageSuccess("Ablities are ready!");
