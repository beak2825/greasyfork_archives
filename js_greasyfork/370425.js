...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/370425/%E8%9C%9C%E8%9C%82%E4%BE%A0%EF%BC%88%E8%81%94%E9%80%9A%E6%B2%83%E6%94%AF%E4%BB%98%EF%BC%89.user.js
// @updateURL https://update.greasyfork.org/scripts/370425/%E8%9C%9C%E8%9C%82%E4%BE%A0%EF%BC%88%E8%81%94%E9%80%9A%E6%B2%83%E6%94%AF%E4%BB%98%EF%BC%89.meta.js
// ==/UserScript==
...
(function() {
		...
		<div class='row' id='robDiv'>
			<div class='col-xs-3'>
				<select class="form-control" id='amount' name='amount'>
                    <option  value="22">200元</option>
                    <option  value="23">300元</option>
					<option  value="25">500元</option>
				</select>
			</div>
			<div class='col-xs-2'>
    ...
    */}).toString().match(/[^]*\/\*([^]*)\*\/\}$/)[1];
    ...
    if(localStorage.getItem('WO_TICKET_PRICE') != null) {
          // alert(localStorage.getItem('WO_TICKET_PRICE'));
          $('#amount').find("option:selected").attr("selected",false);
          $('#amount').find("option[value='"+ localStorage.getItem('WO_TICKET_PRICE')+"']").attr("selected",true);
    }
    ...
    $("#getOrderBtn").on('click', function() {
        ...
        stop = false;
        cnt = 1;
        localStorage.setItem('WO_TICKET_PRICE', $('#amount').val());
