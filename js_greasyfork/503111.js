...
// @downloadURL https://update.greasyfork.org/scripts/503111/TEST.user.js
// @updateURL https://update.greasyfork.org/scripts/503111/TEST.meta.js
// ==/UserScript==
var translations = {
    /// 系统
...
function translateNode(node) {
    ...
    if (node.parentNode?.tagName == "STRONG" || node.parentNode?.getAttribute("class") == "col movenamecol" || node.parentNode?.parentNode?.getAttribute("class") == "tooltip tooltip-move" ||
        node.parentNode?.parentNode?.getAttribute("class") == "col movenamecol" || node.parentNode?.getAttribute("name") == "chooseMove" || node.parentNode?.getAttribute("name") == "send") {
        if (node.nodeValue == "Metronome") {
            ...
            node.nodeValue = "焕然一新";
            return;
        } else if (node.nodeValue == "Disable" && node.parentNode?.getAttribute("name") == "send") {
            node.nodeValue = "不开启";
            return;
