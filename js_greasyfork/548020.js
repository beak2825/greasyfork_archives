// ==UserScript==
    ...
    // @updateURL
// @downloadURL https://update.greasyfork.org/scripts/548020/script%20for%20forum%20to%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%D0%93%D0%A1%D0%97%D0%93%D0%A1%D0%93%D0%9A%D0%A4%D0%9A%D0%A4.user.js
// @updateURL https://update.greasyfork.org/scripts/548020/script%20for%20forum%20to%20%D0%93%D0%90%D0%97%D0%93%D0%90%D0%9A%D1%83%D1%80%D0%B0%D1%82%D0%BE%D1%80%D1%8B%D0%93%D0%A1%D0%97%D0%93%D0%A1%D0%93%D0%9A%D0%A4%D0%9A%D0%A4.meta.js
    // ==/UserScript==
    (function () {
    'esversion 6' ;
    const FAIL_PREFIX = 4;
    ...
    content:
    '[SIZE=4][FONT=Courier New][COLOR=#FF0000][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>'+
    ...
    "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    '[CENTER][COLOR=#ff0000]Вердикт[/COLOR][/CENTER][/FONT][/SIZE]',
    },
      {
     dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(83, 5, 252 , 0.5); font-family: UtromPressKachat',
    ...
    content:
    '[SIZE=4][][COLOR=#FF0000][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>' +
    "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    ...
    status: false,
        ...
        dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(170, 0, 0 , 1); font-family: UtromPressKachat',
    content:
    '[SIZE=4][FON=Courier New][COLOR=#FF0000][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>' +
    "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    ...
    title: '| Передать спецам |',
          dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 255, 25, 0.5); font-family: UtromPressKachat',
    content:
    '[SIZE=4][FONT=Courier New] [COLOR=#FF0000][CENTER]{{ greeting }}, уважаемый(ая) {{ user.mention }}![/COLOR][/CENTER]<br>'+
    "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
     ...
     dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(83, 5, 252 , 0.5); font-family: UtromPressKachat',
        title: '------------------------------------------------------------ Role Play Биографии ----------------------------------------------------------------',
    	},
         {
    	  ...
    	  content:
    		'[SIZE=4][FONT=Courier New][CENTER][COLOR=rgb(255, 25, 0)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
            "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    		...
    		'[FONT=Courier New][CENTER]Приятной игры на сервере [COLOR=rgb(255, 25, 0)]Podolsk(87).[/COLOR][/CENTER][/FONT]',
    	  prefix: OKAY_PREFIX,
    	  status: false,
    	},
        {
    	  ...
    	  content:
            ...
            "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    		"[CENTER]Ваша RolePlay биография получает статус [COLOR=rgb(255, 25, 0)]Отказано.[/COLOR] <br>" +
            "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    		"[CENTER][COLOR=rgb(255, 25, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER][/FONT][/SIZE]" +
    		'[FONT=Courier New][CENTER]Приятной игры на сервере [COLOR=rgb(255, 25, 0)]Podolsk(87).[/COLOR][/CENTER][/FONT]',
    	  prefix: FAIL_PREFIX,
    	  status: false,
    	},
     ...
     dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(83, 5, 252 , 0.5); font-family: UtromPressKachat',
    	...
    	},
        {
    	  ...
    	  content:
    		'[SIZE=4][FONT=Courier New][CENTER][COLOR=rgb(108, 5, 252)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
            "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    		"[CENTER]Ваша RolePlay ситуация получает статус [COLOR=rgb(255, 25, 0)][COLOR=rgb(255, 25, 0)]Отказано.[/COLOR][/COLOR] <br>" +
            "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    		"[CENTER][COLOR=rgb(255, 25, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER][/FONT][/SIZE]" +
    		'[FONT=Courier New][CENTER]Приятной игры на сервере [COLOR=rgb(255, 25, 0)]Podolsk(87).[/COLOR][/CENTER][/FONT]',
    	  prefix: FAIL_PREFIX,
     ...
     dpstyle: 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(83, 5, 252 , 0.5); font-family: UtromPressKachat',
    	...
    	},
        {
    	  ...
    	  content:
    		'[SIZE=4][FONT=Courier New][CENTER][COLOR=rgb(108, 5, 252)]Доброго времени суток, уважаемый (-ая)[/COLOR] {{ user.mention }}.[/CENTER]<br>' +
            "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    		"[CENTER]Ваша Неофициальная RolePlay организация получает статус [COLOR=rgb(255, 25, 0)]Отказано.[/COLOR] <br>" +
            "[CENTER][img]https://i.postimg.cc/nzp8DLJJ/Picsart-23-10-14-02-48-00-592.png[/img][/CENTER]<br><br>" +
    		"[CENTER][COLOR=rgb(255, 25, 0)][ICODE]Отказано, закрыто[/ICODE][/COLOR][/CENTER][/FONT][/SIZE]" +
    		'[FONT=Courier New][CENTER]Приятной игры на сервере [COLOR=rgb(255, 25, 0)]Podolsk(87).[/COLOR][/CENTER][/FONT]',
    	  prefix: FAIL_PREFIX,
    ...
    // addButton('Тех. спецу', 'tech');
        addButton('Закрыто', 'close', 'border-radius: 13px; margin-right: 5px; border: 2px solid; border-color: rgb(255, 36, 0, 0.5); font-family: UtromPressKachat',)
