...
// @grant        none
// @license      MIT
// @downloadURL https://update.greasyfork.org/scripts/462780/Heatmap%2020.user.js
// @updateURL https://update.greasyfork.org/scripts/462780/Heatmap%2020.meta.js
// ==/UserScript==
...
(async function () {
  ...
  const screenConfig = [
    ...
    },
    {
      ...
      cells: [
        ...
        { type: 'data', code: 'fl', range: [291, 332] },
        {
          type: 'text',
          code: 'fl',
          content: [
      ...
      cells: [
        ...
        },
        {
          ...
          content: [
            ...
            { text: 'NFA Damage', value: 'D349 (chunk 4)' }
          ]
        }
      ]
    },
    {
      ...
      cells: [
        { type: 'data', code: 'rh', range: [232, 261] },
        {
          ...
          code: 'rh',
          content: [
            { text: 'Damage', value: 'B235 - B236 (chunk 4)' },
            { text: 'High Velocity', value: 'B232 - B236 (chunk 1)' }
          ]
        },
        { type: 'data', code: 'rr', range: [200, 231] },
        {
          ...
          code: 'rr',
          content: [
            { text: 'HRV A', value: 'A218-219 ($ 1-2 / DMG 3-4)' },
            { text: 'HRV D', value: 'D242-243 ($ 1-2 / DMG 3-4)' },
            { text: 'OXIDIZERS', value: 'A200-203 (chunk 1-3)' }
          ]
        }
      ]
    }
  ...
  class Data {
    ...
    calculateTotalUtilization(zoneConfig) {
      ...
      if (validZones) {
        return (tmpUtilization / validZones).toFixed(2);
      }
