...
// @name         TEMP
// @version      0.1.1
// @description  new version, which reloads when absolutely necessary (watch the AJAX magic!), chooses from all free slots, WORKS FOR NICKNAME RAFFLES! (you will be asked if you wan't to only if you have the right nickname) and checks more often if a raffle is ending soon
// @author       mik13ST (ЖНИК)
// @match        http://csgorage.com/free-raffles/current
// @namespace    https://greasyfork.org/users/20071
// @grant        GM_setValue
// @grant        GM_getValue
// @downloadURL https://update.greasyfork.org/scripts/17175/TEMP.user.js
// @updateURL https://update.greasyfork.org/scripts/17175/TEMP.meta.js
// ==/UserScript==
