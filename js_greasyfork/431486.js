...
// @description 170403(841)
// @downloadURL https://update.greasyfork.org/scripts/431486/%E6%88%91%E6%98%AF%E9%B1%BC%E4%BD%A0%E6%98%AF%E9%A5%B5%EF%BC%8C%E6%9B%BE%E7%9B%B8%E5%BF%98%E4%BA%8E%E6%B1%9F%E6%B9%96.user.js
// @updateURL https://update.greasyfork.org/scripts/431486/%E6%88%91%E6%98%AF%E9%B1%BC%E4%BD%A0%E6%98%AF%E9%A5%B5%EF%BC%8C%E6%9B%BE%E7%9B%B8%E5%BF%98%E4%BA%8E%E6%B1%9F%E6%B9%96.meta.js
// ==/UserScript==
	...
	try {
		if (self != top) {
			...
			if (location.href.match(/\.163\..+?\/store/)) {} else {
				try {
					if (!document.querySelector("\u9c7c\u9975")) {
						document.body.appendChild(document.createElement("鱼饵"));
						try {
					...
					function jxbvipobj() {
						...
						const pcliwaiobj = obj.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)|v\.qq\.com\/(?:x\/cover|.+?\/p\/topic)\/|w(?:ww)?\.mgtv\.com\/(?:b|act)\/|www\.iqiyi\.com\/(?:[awv]_|kszt\/)|tw\.iqiyi\.com\/v_|tv\.sohu\.com\/v\/|film\.sohu\.com\/album\/|www\.le\.com\/ptv\/vplay\/|v\.pptv\.com\/show\/|vip\.1905\.com\/play\/|www\.bilibili\.com\/bangumi\/play\/|www\.acfun\.cn\/bangumi\/)/);
						const sjliwaiobj = obj.match(/^https?:\/\/(?:m\.youku\.com\/.+?\/id_|m\.mgtv\.com\/b\/|m\.pptv\.com\/show\/|vip\.1905\.com\/play\/|m\.tv\.sohu\.com\/(?:v|phone_play_film\?aid=)|m\.le\.com\/vplay_|m\.iqiyi\.com\/v_|(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)|m\.bilibili\.com\/bangumi\/play\/|m\.acfun\.cn\/v\/)/);
										...
										(function() {
											...
											let zdbfdsq = setInterval(function() {
												...
												if (zdbfaobj) {
													...
													log("%c鱼饵--01-H5视频自动播放", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
													...
													log("%c鱼饵--02-视频自动播放", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
													clearInterval(zdbfdsq);
													return false
												}++zdbf;
												if (zdbf > 25) {
						...
						async function videobfjhobj() {
							try {
								if (document.querySelector('video#鱼饵') == null) {} else {
									elevideo = document.querySelector('video#鱼饵');
									try {
						...
						const jxbvipjxstyle = 'style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:20170403;"', jxbvipjximg = 'marginwidth="0" marginheight="0" width="100%" height="100%" ' + jxbvipjxstyle, jxbvipjxidstyle = 'style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:20170403;background-color:black;display:flex;justify-content:center;align-items:center;flex-direction:column;font-size:xx-large;"', jxbvipjxstrongstyle = 'font-weight:bold;display:flex;justify-content:space-evenly;align-items:center;width:100%;max-width:50%;"', jxbvipjxyyy = '<div id="鱼饵" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:#FF0000;' + jxbvipjxstrongstyle + '><strong>吾</strong><strong>❤</strong><strong>丹</strong></div><iframe id="鱼饵" data-ad="false" autoLoad="true" autoplay="autoplay" loading="lazy" allowtransparency="true" frameborder="0" scrolling="no" security="restricted" sandbox="allow-top-navigation allow-same-origin allow-forms allow-scripts" allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen" src="', jxbvipjxvideoa = '<video id="鱼饵" controls="controls" autoplay="autoplay" name="media" style="width:100%;height:100%;background:black;"><source src="', jxbvipjxvideob = '" type="video/mp4"></video>';
						function jxqzsxobj() {
							try {
								if (document.querySelector("iframe#鱼饵")) {
									document.querySelector("div#鱼饵").innerHTML = '<img id="鱼饵" src="https://api.btstu.cn/sjbz/zsy.php" ' + jxbvipjximg + '>';
								} else if (document.querySelector("img#鱼饵")) {} else {
									if (!document.querySelector("jxbvideo") && !document.querySelector("\u9c7c\u9975\u662f\u6211")) {
										document.body.appendChild(document.createElement("鱼饵是我"));
										try {
											if (document.querySelector("div#鱼饵>iframe#鱼饵")) {} else if (document.querySelector("div#鱼饵>img#鱼饵")) {} else {
												(function() {
													try {
						...
						try {
							if (GM_getValue('json播放器') != null) {
								...
								if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") != null) {
						...
						if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:isyour|miao101|douyin|kuaishou|douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|qq|xiami|migu|ximalaya|app-echo|1ting|lrts|haokan|baidu|wbdy|web3v|9ku)\./)) {
							cssobj('ins,[data-ad-status],[data-adsbygoogle-status],[class*="_ad_more"],[id*="_ad_more"],[class*="pp"][class*="anner"],[id*="pp"][id*="anner"],[dt-eid*="pen"][dt-eid*="anner"]');
							...
							remove(jxbscysobj);
						} else {} if (!jxjkobj && !document.querySelector("\u9c7c\u9975")) {
							window.close();
						} else {}
						if (jxjkobj || objj.match(/(?:m1907|isyour)\./) || obj.match(/&autoplay=1&metareferer=/)) {
							...
							document.body.appendChild(document.createElement("鱼饵电脑网页"));
							function tzjkqp() {
								try {
									if (GM_getValue('跳转接口全屏') == null || GM_getValue('跳转接口全屏') == '开启') {
							...
							function jxbjkspbfjsobj() {
								try {
									(function() {
										if (!document.querySelector("\u9c7c\u9975\u76d1\u63a7\u89c6\u9891\u64ad\u653e\u7ed3\u675f")) {
											if (objj.match(/(?:m1907\.|jx\.2bjx\.com|4321s\.cc|wfy\d+?\.|xjqxz\.top)/)) {} else {
												document.body.appendChild(document.createElement("\u9c7c\u9975\u76d1\u63a7\u89c6\u9891\u64ad\u653e\u7ed3\u675f"));
												try {
													if (document.querySelector('video')) {
														if (obj.match(/&autoplay=1&metareferer=undefined$/)) {
															if (document.title.indexOf('\u9c7c\u9975') < 0) {
																document.title = '\u2265\u25b3\u2264 \u9c7c\u9975 \u2265\u25b3\u2264';
															} else {}
														} else {}
							...
							if (obj.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|vku\.youku\.com\/live\/)/)) {
								...
								cssobj('#鱼饵{position:relative!important;}div[class^="globallogin"]{z-index:2000000000!important;}[class^="pop-operates"],[id^="pop-operates"]');
							...
							document.body.appendChild(document.createElement("鱼饵手机网页"));
							var sjpdpthyobj;
							...
							if (obj.match(/^https?:\/\/(?:www\.wbdy\.tv|www\.ikukk\.com)\//)) {
								if (obj.match(/^https?:\/\/[^\/]+?\/$/)) {} else {
									...
									if (obj.match(/\/index.php\?m=vod-search/)) {
										...
										setTimeout(function() {
											try {
												if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875")) {
													if (pdssgjcobj.length == 1) {} else {
														try {
															GM_setValue('集数', '选集');
														} catch (err) {}
						...
						async function zdbt() {
							if (document.querySelector("\u9c7c\u9975\u6807\u9898") != null) {
								document.querySelector("\u9c7c\u9975\u6807\u9898").remove();
								document.body.appendChild(document.createElement("鱼饵标题"));
							} else {
								document.body.appendChild(document.createElement("鱼饵标题"));
							}
							if (document.querySelector("\u9c7c\u9975\u6807\u9898") != null) {
								if (document.title.match(/^[^：]+?：\s*?第.+?[部季集话部期]\s*?(?:[上下]\s*?)?$/) != null) {} else {
									try {
										...
										if (document.querySelector("\u9c7c\u9975\u624b\u673a\u7f51\u9875") != null) {
							...
							setTimeout(() => {
								if (document.querySelector("\u9c7c\u9975\u81ea\u5b9a\u4e49\u63a5\u53e3") != null) {} else {
									...
									httpsaobj = [{
										...
										name: "呆呆",
										url: "https%3A%2F%2Fjx.daidaitv.top%3A43810%2F%3Furl%3D",
										ys: "1",
										jj: "1",
										title: "可以自动播放下一集"
									}, {
										...
										name: "年报",
										url: "https%3A%2F%2Fjx.nbjx.cc%2F%3Furl%3D",
										jj: "1"
									}, {
										name: "刺客",
										...
										name: "零七",
										url: "https%3A%2F%2Fjx.pchj.net%2Fparwix%2Fanalysis.php%3Fv%3D",
										jj: "1"
									}, {
										name: "邦宁",
										...
										bfq: "https%3A%2F%2Fapi.jx.yh0523.cn%2Fapi%2Fpgjx-1%2Fdp.php%3Furl%3D",
										json: "1",
										hq: "1",
										jj: "1"
									}];
									...
									if (document.querySelector("\u9c7c\u9975\u81ea\u5b9a\u4e49\u63a5\u53e3") == null) {
										https = httpsaobj.concat(httpsbobj);
									} else {
										try {
											httpsobj = httpsaobj.concat(JSON.parse(localStorage.getItem('\u9c7c\u9975\u81ea\u5b9a\u4e49\u63a5\u53e3')));
									...
									if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") != null) {
										...
										jsonnn.onclick = function() {
											jsonnniframe = document.querySelector('iframe#鱼饵[src^="https://"][src$="&metareferer=undefined"]');
											...
											if (jxbpcobj) {} else {
												...
												httpsvipli.onclick = function() {
													try {
														...
														let tctha = '<div id="鱼饵" ' + jxbvipjxstyle + '><img id="鱼饵" src="https://api.btstu.cn/sjbz/" ' + jxbvipjximg + '></img></div>';
														let tcthb = '<div id="鱼饵" ' + jxbvipjxstyle + '><img id="鱼饵" src="' + jxbimg + '" ' + jxbvipjximg + '></img></div>';
														try {
															if (document.querySelector("div#鱼饵") != null) {
																zdydssjobj = '123';
															} else {
																zdydssjobj = '3456';
															}
														...
														try {
															if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") != null) {
																try {
																	if (!document.querySelector("\u9c7c\u9975\u7535\u8111")) {
																		document.body.appendChild(document.createElement("鱼饵电脑"));
																	} else {} if (document.querySelector('div#鱼饵')) {
																		pczdydssjobj = '123';
																...
																if (objj.indexOf('youku') > 0) {
																	...
																	if (obj.indexOf('mgtv.com/b/') > 0) {
																		...
																		if (!document.querySelector("#鱼饵") && document.querySelector("ul.v-lists")) {
															...
															} else {} if (document.querySelector("\u9c7c\u9975\u624b\u673a\u7f51\u9875") != null) {
																try {
																	if (document.querySelector('div#鱼饵')) {
																		sjzdydssjobj = '123';
																	} else if (localStorage.getItem("vipzdjx") == '0') {
																		sjzdydssjobj = '123';
																	} else if (localStorage.getItem("vipzdjx") == '1' || localStorage.getItem("vipzdjx") == '2') {
														...
														function vipobj(vip) {
															...
															try {
																if (document.querySelector("div#鱼饵") != null) {
																	if (document.querySelector("img#鱼饵") != null) {} else {
																		document.querySelector("div#鱼饵").remove()
																	}
																} else {
															...
															try {
																...
																function vipjxdmaobj() {
																	setTimeout(function() {
																			...
																			if (jxb.match(new RegExp("^https:\/\/(?!.+?强制(?:弹[小大]窗|跳转|搜索))")) && !(jxb.match(new RegExp("(?:透明无接口|布米米|视频选集|米侠|Youtube|麻花影视|旋风视频)")))) {
																				...
																				if (jxb.match(new RegExp("透明无接口"))) {
																					try {
																						...
																						if (document.querySelector(vip)) {
																							document.querySelector(vip).innerHTML = '<div id="鱼饵" ' + jxbvipjxstyle + '><img id="鱼饵" src="https://ceo30.coding.net/p/ceo30/d/sjtp/git/raw/master/1.png" ' + jxbvipjximg + ' onclick="document.getElementById(\'jxbhttps\').click();"></img></div>';
																							jxqzsxobj()
																						} else {}
																					}
																		...
																		try {
																			window.scrollTo(0, document.querySelector("div#鱼饵").offsetTop);
																		} catch (err) {}
																	}, 123);
																};
																if (https[num].json == null || https[num].json == undefined || https[num].json == '' || https[num].json == '0' || https[num].json.match(new RegExp("(?:跳|窗|^\s*?(?<!开)关\s*?$)")) || localStorage.getItem("objjbo") != '1') {
																	...
																	byjxpd.byjxsbobj = function() {
																		try {
																			jxqzsxobj();
																			if (document.querySelector(vip)) {
																				document.querySelector(vip).innerHTML = '<div id="鱼饵" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:yellow;' + jxbvipjxstrongstyle + '><strong>解</strong><strong>析</strong><strong>失</strong><strong>败</strong></div></div>';
																			} else {}
																		} catch (e) {}
																	};
																	if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '' || !https[num].vip.match(new RegExp("(?:跳|窗)"))) {
																		...
																		if (document.querySelector(vip)) {
																			document.querySelector(vip).innerHTML = '<div id="鱼饵" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:#FF0000;' + jxbvipjxstrongstyle + '><strong>吾</strong><strong>❤</strong><strong>丹</strong></div></div>';
																			setTimeout(() => {
																				if (sessionStorage.getItem("失败执行") == '1') {
																					sessionStorage.removeItem('失败执行');
																				} else {
																					try {
																						if (document.querySelector("iframe#鱼饵") != null || document.querySelector("img#鱼饵") != null || document.querySelector("div#鱼饵>div>strong:first-child").innerText == '解') {} else {
																							byjxpd.byjxsbobj();
																							if (https[num].json == '333') {
																								...
																								setTimeout(function() {
																									try {
																										if (pcliwaiobj) {
																											if (document.querySelector("div#鱼饵>div").innerText.match(/失/)) {
																												if (sessionStorage.getItem("解析失败") != null) {
																													document.querySelector("div#鱼饵>div").innerHTML = sessionStorage.getItem("解析失败");
																													sessionStorage.removeItem('解析失败');
																												} else {
																													if (sessionStorage.getItem("失败接口") != null) {
																														document.querySelector("div#鱼饵>div").innerHTML = '<p style="text-align:center;">该→' + sessionStorage.getItem("失败接口") + '←无法访问</p>';
																														sessionStorage.removeItem('失败接口');
																													} else {
																														document.querySelector("div#鱼饵>div").innerHTML = '<p style="text-align:center;">该Json无法访问</p>';
																													}
																												}
																											} else {}
																										} else {}
																	...
																	try {
																		...
																		byjxpd.byjxpdobj = function() {
																			setTimeout(() => {
																				document.querySelector(vip).innerHTML = '<div id="鱼饵" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:yellow;' + jxbvipjxstrongstyle + '><strong>备</strong><strong>用</strong><strong>解</strong><strong>析</strong></div></div>';
																				jxqzsxobj();
																			}, 567);
																		};
																		byjxpd.byjxpeobj = function() {
																			setTimeout(() => {
																				if (document.querySelector("img#鱼饵") != null) {} else {
																					if (document.querySelector(vip)) {
																						document.querySelector(vip).innerHTML = '<div id="鱼饵" ' + jxbvipjxstyle + '><img id="鱼饵" src="https://www.dmoe.cc/random.php" ' + jxbvipjximg + '></img></div>';
																					} else {}
																					jxqzsxobj()
																				}
																			}, 456);
																		...
																		byjxpd.byjxpfobj = function() {
																			try {
																				jxb = atob(https[num].byurl) + jxbjxurl;
																			} catch (e) {
																				jxb = unescape(https[num].byurl) + jxbjxurl;
																			}
																		};
																		byjxpd.byjxpgobj = function() {
																			if (document.querySelector("鱼饵电脑网页") != null) {
																				...
																				videobfjhjsobj = setInterval(function() {
																					try {
																						if (document.querySelector('video#鱼饵') != null) {
																							videobfjhobj();
																							jxbvolumeaobj();
																							try {
																								document.querySelector("video#鱼饵").play();
																							} catch (err) {}
																							try {
																								qpobj(document.querySelector('#鱼饵:not(div):not(img)'));
																							} catch (err) {}
																							clearInterval(videobfjhjsobj);
																						} else {}
																					} catch (err) {}
																		...
																		function xmlhttpRequest() {
																			if (https[num].name.match(new RegExp("饭团"))) {
																					...
																					if (bxml == 200 || bxml == '200') {
																						...
																						if ( !! bxmlc) {
																							if (bxmlc.match(jsonvipthf) != null) {
																								...
																								if (https[num].json == '3' || https[num].json == '33' || https[num].json == '333') {
																									try {
																										if (bxmlc.match(jsonvipthh) != null) {
																											...
																											if (unescape(bxmlc.match(jsonvipthg)[1].replace(/\\\//g, "/")).match(jsonvipthe)) {
																												...
																												if (https[num].json == '333') {
																													...
																													if ((https[num].bfq != null || https[num].bfq != undefined || https[num].bfq != '') && https[num].bfq.match(jsonvipjklxa) && https[num].json == '33') {
																														try {
																															jxb = atob(https[num].bfq) + bxmlc.match(jsonvipthg)[1].replace(/\\\//g, "/");
																														} catch (e) {
																															jxb = unescape(https[num].bfq) + bxmlc.match(jsonvipthg)[1].replace(/\\\//g, "/");
																														}
																														flag = "false";
																														vipjxdmaobj();
																													} else {
																										...
																										if (bxmlc.match(jsonvipthd) != null) {
																											...
																											if (unescape(bxmlb).match(jsonvipthe)) {
																												if (https[num].json == '2' || https[num].json == '22') {
																													...
																													try {
																														jxb = atob(https[num].bfq) + encodeURIComponent(bxmlb) + jsonvipjkcsa;
																													} catch (e) {
																														jxb = unescape(https[num].bfq) + encodeURIComponent(bxmlb) + jsonvipjkcsa;
																													}
																													flag = "false";
																													vipjxdmaobj();
																												}
																											} else {
																												if ((https[num].json == '11' || https[num].json == '22' || https[num].json == '222') && (https[num].byurl != null || https[num].byurl != undefined || https[num].byurl != '') && https[num].byurl.match(jsonvipjklxa)) {
																													byjxpd.byjxpfobj();
																													flag = "false";
																													vipjxdmaobj();
																												} else {
																											...
																											try {
																												log("%c获取到资源：", "border-left:5px solid #A0B;color:#A0B;padding:3px", bxmlb);
																											} catch (e) {}
																											flag = "false";
																										}
																									} catch (e) {
																										log("%c错误信息：", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px", bxmlc);
																									}
																								}
																							}
																						}
																						if ( !! bxmlb) {
																							if (https[num].json == '2' || https[num].json == '22') {
																								...
																								if (https[num].bfq != null && https[num].bfq.match(jsonvipjklxa)) {
																									try {
																										jxb = atob(https[num].bfq) + encodeURIComponent(bxmlc.match(jsonvipthb)[1].replace(/\\\//g, "/")) + jsonvipjkcsa;
																									} catch (e) {
																										jxb = unescape(https[num].bfq) + encodeURIComponent(bxmlc.match(jsonvipthb)[1].replace(/\\\//g, "/")) + jsonvipjkcsa;
																									}
																								} else if (localStorage.getItem("json播放器") != null) {
																									jxb = localStorage.getItem("json播放器") + encodeURIComponent(bxmlc.match(jsonvipthb)[1].replace(/\\\//g, "/")) + jsonvipjkcsa;
																								} else {
																									jxb = jsonvipjk + encodeURIComponent(bxmlc.match(jsonvipthb)[1].replace(/\\\//g, "/")) + jsonvipjkcsb;
																								}
																							}
																							flag = "false";
																							if (https[num].json == '2' || https[num].json == '22') {} else {
																								vipjxdmaobj();
																							}
																							try {
																								log("%c获取到资源：", "border-left:5px solid #A0B;color:#A0B;padding:3px", jxb);
																							} catch (e) {}
																						}
																					}
																				}
																			...
																			try {
																				log("%c发送链接：", "border-left:5px solid #A0B;color:#A0B;padding:3px", xmlurla);
																			} catch (e) {}
																		};
																		if (https[num].name.match(new RegExp("饭团"))) {
																			GM_xmlhttpRequest({
																					...
																					if (axml == 200 || axml == '200') {
																						...
																						if ( !! axmlc) {
																							try {
																								...
																								try {
																									log("%c获取错误：", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px", axmlc);
																									alert('获取不到json接口');
																								} catch (e) {}
																							}
																						}
																						if ( !! axmlb) {
																							...
																							try {
																								log("%c获取到接口：", "border-left:5px solid yellow;color:yellow;padding:3px", axmlb);
																							} catch (e) {}
																						}
																					}
																				}
															...
															if (localStorage.getItem("pcjkzdyj") == '0') {} else {
																if (!document.querySelector("\u6211\u662f\u9c7c\u9975")) {
																	document.body.appendChild(document.createElement("我是鱼饵"));
																	(function() {
																		try {
																			let zdjkhttpsjk_counter = 0;
																			let zdjkhttpsjk_jiankong = setInterval(function() {
																...
																setTimeout(function() {
																	try {
																		if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") != null) {
																			try {
																				if (document.querySelector("img#鱼饵") && !jxb.match(new RegExp("视频选集"))) {
																					try {
																						GM_setValue('视频自动全屏', '关闭');
																					} catch (err) {}
																				} else if (document.querySelector("iframe#鱼饵") && GM_getValue('视频自动全屏').match(/^\s*?开启\s*?$/) && !GM_getValue('视频自动全屏').match(/^\s*?关闭\s*?$/) && !jxb.match(new RegExp("视频选集"))) {
																					try {
																						qpobj(document.querySelector('iframe#鱼饵'));
																						setTimeout(function() {
																							qpobj(document.querySelector('iframe#鱼饵'));
																						}, 1234);
																						setTimeout(function() {
																						...
																						pcspzdqpaobj = setInterval(function() {
																							if (document.querySelector("iframe#鱼饵").offsetWidth == document.body.offsetWidth) {
															...
															} else {} if ((document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875")) && (localStorage.getItem("vipvideotg") == '1') && (localStorage.getItem("vipzdjx") != '1')) {
																try {
									...
									if (jxbpcobj) {
										...
										try {
											...
											try {
												...
												sjqjpbzdylwaobj = /(?:M19|邦宁|网吧|B站)/i, sjyyyzdypbobj = /(?:PAR|虾米|地衣|吾吾|爱跟|年报|老版|达人|[淘白][a-z0-9]|扫描|月亮|看剧|神马|酷看|久播|思[云念]|速云)/i, sjqjpbzdylwbobj = /(?:学习|猪蹄|七彩|刺客|扫描|神马|白玉|依托|法克|垫片|依齐|江湖|乐多|思古|[三八][一二]|17云|1717|8090|哔哩|九八|CKP|OK|Youtube|和巴|[方文学提教]案|布米米|视频选集|透明.*?接口)/i;
											...
											a[i].onclick = function() {
												for (let j = 0; j < l; j++) {
													if (this == a[j]) {
														...
														try {
															if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") != null) {} else {
																document.querySelector('ul#httpsvipul>li>span.wsjxbshhjd>a4').style.color = 'red';
															}
														} catch (err) {}
														if ((localStorage.getItem("pcjkzdyj") == '1') || (document.querySelector("\u9c7c\u9975\u624b\u673a\u7f51\u9875") != null)) {
								...
								setTimeout(function() {
									if (document.querySelector("#鱼饵") == null) {
										if (!obj.match(/^https?:\/\/(?:3g|m)\./) && (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") != null)) {
											if (objj.match(/mgtv/)) {
												setTimeout(function() {
						...
						function zddjobj() {
							if (!document.querySelector("\u9c7c\u9975\u81ea\u52a8\u70b9\u51fb\u63a5\u53e3")) {
								document.body.appendChild(document.createElement("鱼饵自动点击接口"));
								try {
									if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875")) {
										try {
											GM_setValue('视频自动全屏', '开启');
								...
								if (localStorage.getItem("vipzdjx") == '0') {} else {
									...
									if (obj.match(/^https?:\/\/m\.mgtv\./)) {} else {
										setTimeout(function() {
											if (document.querySelector("div#鱼饵>iframe#鱼饵")) {
												return false;
											} else if (document.querySelector("div#鱼饵>img#鱼饵")) {
												return false;
											} else {
												try {
													document.querySelector("jiangxiaobai").remove();
								...
								function spzddj(spzddja) {
									...
									let spjyzddjb = setInterval(function() {
										...
										if (spjyzddjc) {
											try {
												spjyzddjc.click();
												log("%c鱼饵-已经恢复音量", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
											} catch (e) {}
						...
						try {
							if (mgzdgq == 1 || mgzdgq == 2 || vipzdjx == 1 || vipzdjx == 2 || localStorage.getItem("zdpddy") == '1' || document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") && (obj.match(/&autoplay=1&metareferer=/) || (vipzdjx != 1 && vipvideotg == 1))) {
								try {
									function panduanshebeiobj() {
										...
										function zdpddyobj() {
											if (!document.querySelector("\u9c7c\u9975\u81ea\u52a8\u5224\u65ad\u591a\u4f59")) {
												document.body.appendChild(document.createElement("鱼饵自动判断多余"));
											} else {}
										}; if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") !== null) {
											function dnzdpdobj() {
												if (!document.querySelector("\u9c7c\u9975\u7535\u8111\u81ea\u52a8\u5224\u65ad")) {
													document.body.appendChild(document.createElement("鱼饵电脑自动判断"));
												} else {}
											};
											...
											function jiangxiaobaiviphyzdpd() {
												if (obj.match(/&autoplay=1&metareferer=/)) {
													if (document.fullscreen) {} else if (document.fullscreenElement) {} else {
														if (document.querySelector("\u9c7c\u9975\u5168\u5c4f")) {} else {
															try {
																		...
																		if (document.querySelector('video')) {
																			...
																			setTimeout(function() {
																				if (document.querySelector("video").currentTime > 0) {} else {
																					if (!document.querySelector("\u9c7c\u9975\u5168\u5c4f")) {
																						document.body.appendChild(document.createElement("鱼饵全屏"));
																					} else {}
																					alert('此接口暂时无法解析，请自行更换 接口');
																					window.close();
																				}
													...
													if (!document.querySelector("\u9c7c\u9975\u81ea\u52a8\u5224\u65ad\u591a\u4f59") && localStorage.getItem("zdpddy") == '1') {
														if (document.querySelector('div.maomibtn')) {
															...
															try {
																if ((document.querySelector('iframe[src^="http"][src*="=http"][allowfullscreen]:not([style*="display:none"]):not([style*="display: none"])').src.match(jxjkwzobj)) && document.querySelector('iframe[src^="http"][src*="=http"][allowfullscreen]:not([style*="display:none"]):not([style*="display: none"])').getAttribute('id') != '\u9c7c\u9975') {
																	try {
																		window.close();
																	} catch (err) {
																		zdpddyobj();
																	}
																} else {} if (document.querySelector("div#\u9c7c\u9975>div>strong") != null) {
																	if ((document.querySelector("div#\u9c7c\u9975>div>strong:first-child").innerText.match(/^[\u543e]$/)) && (document.querySelector("div#\u9c7c\u9975>div>strong:last-of-type").innerText.match(/^[\u4e39]$/))) {} else {
																		try {
																			window.close();
																		} catch (err) {
																			zdpddyobj();
														...
														try {
															if (obj.match(/^https?:\/\/v(?:-wb)?\.youku\.com\/v_show\/id_/)) {
																if ($("#toast_text:contains('试看')")[0] || $("#toast_text:contains('完整')")[0] || $("#toast_text:contains('购买')")[0]) {
																	...
																	dnzddjobj("%c鱼饵-电脑-优酷会员自动解析-03-工作中");
																	...
																	if ($("div.drm-error-layer div.note_normal_tit:contains('版权'):contains('加密'):contains('不支持')")[0] && document.querySelector('div.preplay-layer>img[src*="/"]') && $("div.note_error_item_title:contains('换'):contains('浏览器')")[0]) {
																		dnzddjobj("%c鱼饵-电脑-优酷会员自动解析-04-工作中");
																	} else {}
																} else {}
															} else if (obj.match(/^https?:\/\/[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)/)) {
																if ($("div.information-tips:contains('看'):contains('会员')")[0]) {
																	dnzddjobj("%c鱼饵-电脑-土豆会员自动解析-01-工作中");
																} else if ($("div.vip_info:contains('看'):contains('会员')")[0]) {
																	dnzddjobj("%c鱼饵-电脑-土豆会员自动解析-02-工作中");
																} else {}
																...
																if (vipzdjx == 2 && obj.match(/^https?:\/\/(?:ww)?w\.mgtv\.com\/b\//)) {
																	if ($("div.control-tips-line>p:contains('费'):contains('看')")[0]) {
																		dnzddjobj("%c鱼饵-电脑-芒果TV会员自动解析-01-工作中");
																		...
																		dnzddjobj("%c鱼饵-电脑-芒果TV会员自动解析-02-工作中");
																...
																if (localStorage.getItem("ymyypdobj") == '0') {
																	if ((document.querySelector('ul>li[class*="item"][class$=" selected"] img[src*="/vip"][src$=".png"]:not([src*=".png/"])[srcset*="/vip"][srcset*=".png"]:not([srcset*=".png/"])') || document.querySelector('ul>li[class*="item"][class$=" selected"] img[src*="/VIP"][src$=".png"]:not([src*=".png/"])[srcset*="/VIP"][srcset*=".png"]:not([srcset*=".png/"])')) && document.querySelector('[tabindex="-1"][data-player-hook]>video[src^="blob:http"]')) {
																		...
																		setTimeout(function() {
																			...
																			document.querySelector("jiangxiaobai").remove();
																			zddjobj();
																			log("%c鱼饵-电脑-爱奇艺会员自动解析-00-b-工作中");
																		}, 2345);
																	} else if ($('iqpdiv[class="iqp-layer-main"]:contains("播放"):contains("失败")')[0]) {
																		dnzddjobj("%c鱼饵-电脑-爱奇艺会员自动解析-00-c-工作中");
																	} else {}
																	...
																	dnzddjobj("%c鱼饵-电脑-爱奇艺会员自动解析-01-工作中");
																	...
																	dnzddjobj("%c鱼饵-电脑-爱奇艺会员自动解析-02-工作中");
																...
																if ($("div.sb-toggle-card.card-pay.card-active:contains('费')")[0] && $("div.pay-mod-notlogin>div.notlogin-login:contains('会员'):contains('看')")[0]) {
																	...
																	dnzddjobj("%c鱼饵-电脑-1905会员自动解析-02-工作中");
																...
																if (document.querySelector('li[class="single-p active"][data-href] span').innerText.match(/^\s*?(?:vip|付费|抢鲜)\s*?$/i)) {
																	dnzddjobj("%c鱼饵-电脑-AcFun会员自动解析-01-工作中");
																} else {}
															} else {}
														} catch (err) {}
													}
													if (vipzdjx == 1) {
														...
														setTimeout(function() {
															...
															zddjobj();
															dnzdpdobj();
															log("%c鱼饵-电脑全局自动解析-工作中", "border-left:5px solid #03A9F4;color:#03A9F4;padding:3px");
														}, 345);
													} else {}
												} else {}
											}
											...
											function sjzdpdobj() {
												if (!document.querySelector("\u9c7c\u9975\u624b\u673a\u81ea\u52a8\u5224\u65ad")) {
													document.body.appendChild(document.createElement("鱼饵手机自动判断"));
												} else {}
											};
													...
													if (document.querySelector('ul#jxbewjul')) {
														...
														try {
															if ((document.querySelector('iframe[src^="http"][src*="=http"][allowfullscreen]:not([style*="display:none"]):not([style*="display: none"])').src.match(jxjkwzobj)) && document.querySelector('iframe[src^="http"][src*="=http"][allowfullscreen]:not([style*="display:none"]):not([style*="display: none"])').getAttribute('id') != '\u9c7c\u9975') {
																...
																if ((document.querySelector("div#\u9c7c\u9975>div>strong:first-child").innerText.match(/^\u6c5f$/)) && (document.querySelector("div#\u9c7c\u9975>div>strong:last-of-type").innerText.match(/^\u767d$/))) {} else {
																	try {
																		window.close();
																	} catch (err) {
																		zdpddyobj();
									...
									try {
										if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875") && obj.match(/&autoplay=1&metareferer=/)) {
											panduanshebeiobj();
										} else {
											setTimeout(() => {
												pczdjxycobj = setInterval(function() {
													if (document.querySelector("\u6211\u662f\u9c7c\u9975\u751f\u6d3b\u5f88\u7b80\u5355") && document.querySelector("div#jxbhttps")) {
														if (document.querySelector("\u9c7c\u9975\u7535\u8111\u7f51\u9875")) {
															if (vipzdjx == 1) {
																(() => {
												...
												function sjjxbvipzcjxobj() {
													try {
														if (document.querySelector("\u9c7c\u9975\u624b\u673a\u7f51\u9875") && (vipzdjx == 1 || vipzdjx == 2)) {
															if (obj.match(/^https?:\/\/(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)/)) {
																if (document.querySelector("div#鱼饵") == null) {
																	try {
																		document.querySelector("jiangxiaobai").remove();
						...
						document.onreadystatechange = function() {
							"complete" == document.readyState && setTimeout(function() {
								try {
									if (location.href.match(/^https?:\/\/(?:v(?:-wb)?\.youku\.com\/v_show\/id_|m\.youku\.com\/.+?\/id_|[^\/]+?\.tudou\.com\/(?:v\/|.+?\/id_)|v\.qq\.com\/(?:x\/cover|.+?\/p\/topic)\/|(?:3g|m)\.v\.qq\.com\/.*?(?:[cv]id=|cover\/)|w(?:ww)?\.mgtv\.com\/(?:b|act)\/|m\.mgtv\.com\/b\/|www\.iqiyi\.com\/(?:[awv]_|kszt\/)|tw\.iqiyi\.com\/v_|m\.iqiyi\.com\/v_|tv\.sohu\.com\/v\/|film\.sohu\.com\/album\/|m\.tv\.sohu\.com\/(?:v|phone_play_film\?aid=)|www\.le\.com\/ptv\/vplay\/|m\.le\.com\/vplay_|v\.pptv\.com\/show\/|m\.pptv\.com\/show\/|vip\.1905\.com\/play\/|www\.bilibili\.com\/bangumi\/play\/|m\.bilibili\.com\/bangumi\/play\/|www\.acfun\.cn\/bangumi\/|m\.acfun\.cn\/v\/)/) && !(location.href.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/(?:a_|kszt\/)/) && document.title.match(new RegExp("在线观看"))) && !(location.href.match(/^https?:\/\/(?:www|m)\.iqiyi\.com\/v_/) && document.title.match(new RegExp("名师课堂")))) {
										...
										(function() {
											try {
												...
												document.addEventListener('visibilitychange', function() {
													try {
														let videoaobj = document.querySelector("video"), videobobj = document.querySelector('div#鱼饵');
											...
											(function() {
												try {
													...
													if (localStorage.getItem("vipjxtb") == '0') {
														...
														document.getElementById('vipjxtb').innerText = '只显丹丹';
													...
													if (pcliwaiobj || ttbkjjliobj) {
														if (pcliwaiobj) {
															(function() {
																...
																try {
																	if (document.querySelector("#鱼饵:not(div):not(img)")) {
																		try {
																			if (!document.querySelector("img#鱼饵")) {
																				if (document.querySelector("iframe#鱼饵")) {
																					try {
																						qpobj(document.querySelector('iframe#鱼饵'));
																					} catch (err) {}
																					...
																					if (localStorage.getItem("videobfjhobj") == '0') {
																						videobfjhobj();
																						try {
																							qpobj(document.querySelector('video#鱼饵'));
																						} catch (err) {}
																					} else {}
																				}
																			} else {}
																						...
																						(function() {
																							try {
																								...
																								let sdjxyywzdqp_jiankong = setInterval(function() {
																									let sdjxyywzdqp_btn = document.querySelector("#鱼饵:not(div):not(img)");
																									if (sdjxyywzdqp_btn) {
																										try {
																											qpobj(document.querySelector('#鱼饵:not(div):not(img)'))
																										} catch (err) {}
												...
												try {
													if ((pcliwaiobj && !jxbpclwobj) || objj.match('(?:bilibili|acfun)')) {
														(function() {
															try {
																(async() => {
																	const videos = Array.from(!document.querySelector("#鱼饵") && document.querySelectorAll('video')).filter(video => video.readyState != 0).filter(video => video.disablePictureInPicture == false).sort((v1, v2) => {
