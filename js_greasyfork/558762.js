// ==UserScript==
// @name           SearchEngineJumpPlus 搜索引擎快捷跳转+改
// @author         NLF & 锐经(修改) & iqxin(修改) & MUTED64(修改)
// @contributor    MUTED64
// @description    Fork版本搜索引擎跳转脚本，优化一些使用体验   修改弹窗的宽度 按钮文本的字号 部分元素的位置 移除黑暗模式
// @version        5.31.17
...
// @resource       GLOBAL_STYLE https://update.greasyfork.org/scripts/558761/SearchEngineJumpPlusGlobalStyle.user.css
...
// @downloadURL https://update.greasyfork.org/scripts/558762/SearchEngineJumpPlus%20%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%BF%AB%E6%8D%B7%E8%B7%B3%E8%BD%AC%2B%E6%94%B9.user.js
// @updateURL https://update.greasyfork.org/scripts/558762/SearchEngineJumpPlus%20%E6%90%9C%E7%B4%A2%E5%BC%95%E6%93%8E%E5%BF%AB%E6%8D%B7%E8%B7%B3%E8%BD%AC%2B%E6%94%B9.meta.js
// ==/UserScript==
  ...
  function mainLogic() {
    ...
    class SettingPanel {
      ...
      addContent() {
        ...
        var btnStr2 =
          "<div>" +
          "<span style='font-size: 10px;' id='xin-reset' title='慎点,出厂重置'>清空设置</span>" +
          "<span style='font-size: 10px;' id='xin-modification' title='edit 分享自己的配置或清空配置'>配置文件</span>" +
          // "<span style='font-size: 10px;' id='xin-importing' title='importing 导入更为专业的搜索引擎'>导入</span>" +
          "<span style='font-size: 10px;' id='xin-selectSearch' title='划词搜索, 只有非搜索页面才会生效, 开关功能需要刷新页面'>" +
          "<label>划词搜索<input id='iqxin-selectSearch' type='checkbox' name='' " +
          selectSearch_checked +
          " style='vertical-align:middle;'></label>" +
          "</span>" +
          "<span style='font-size: 10px;' id='xin-transtion' title='动画,该设置需要刷新页面生效'>" +
          "<label>动画<input id='iqxin-transtion' type='checkbox' name='' " +
          transition_checked +
          " style='vertical-align:middle;'></label>" +
          "</span>" +
          "<span style='font-size: 10px;' id='xin-foldlists' title='将当前所在搜索分类折叠'>" +
          "<label>折叠当前搜索分类<input id='iqxin-foldlist' type='checkbox' name='' " +
          foldlist_checked +
          " style='vertical-align:middle;'></label>" +
          "</span>" +
          "<span style='font-size: 10px;' id='iqxin-fixedTopS' title='fixedTop 当滚动页面时,固定到页面顶端。某些页面的样式存在问题'>" +
          "<label>固定到顶端<input id='iqxin-fixedTop' type='checkbox' name='' " +
          fixedTop_checked +
          " style='vertical-align:middle;'></label>" +
          "</span>" +
          "<span style='font-size: 10px;' id='iqxin-fixedTopUpward' title='固定到顶端后,仅向上滚动才显示,需要刷新网页生效'>" +
          "<label>仅上拉显示<input id='iqxin-fixedTopUpward-item' type='checkbox' name='' " +
          fixedTopUpward_checked +
          " style='vertical-align:middle;'></label>" +
          "</span>" +
          "<span style='font-size: 10px;' id='xin-HideTheSameLink' title='隐藏同站链接,如果想在同一个搜索网站,但是想通过不同语言来搜索, 可以取消该选项'>" +
          "<label>隐藏同站链接<input id='iqxin-HideTheSameLink' type='checkbox' name='' " +
          HideTheSameLink_checked +
          " style='vertical-align:middle;'></label>" +
          "</span>" +
          "<span style='font-size: 10px;' id='xin-setBtnOpacity' title='设置按钮透明度,需要刷新页面'>设置按钮透明度 <input type='range' step='0.05'  min='0' max='1' value='" +
        ...
        nSearchList.style.cssText =
          "visibility:hidden;opacity:0;transition:0.3s;position:absolute;bottom:20%;right:5%;padding:5px 10px;border-radius:4px;border:1px solid #EC6D51;color:#ec6d51;cursor:pointer;background:#fff;";
