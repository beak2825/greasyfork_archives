...
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/478745/AO3%20Review%20%2B%20Last%20Chapter%20Shortcut%20%2B%20Kudos-sortable%20Bookmarks.user.js
// @updateURL https://update.greasyfork.org/scripts/478745/AO3%20Review%20%2B%20Last%20Chapter%20Shortcut%20%2B%20Kudos-sortable%20Bookmarks.meta.js
// ==/UserScript==
...
// Change this to add the download links on the listing page. Starting June 23rd, 2022, it'll be turned off by default, AO3 limits how
//   many pageloads you do in a short while and if you do too many, you'll get the "Retry later" for a few minutes until you can use the site again
// If you want it to be on, change this value to true
var bListingShortcuts = false;
...
jQuery(window).ready(function() {
    ...
    jQuery.when(oBookmarksProcessed).done(function() {
        ...
        if(bListingShortcuts && jQuery('.header h4.heading').length)
        {
...
console.log('hi');
                    // Access first chapter of story to get download links
                    jQuery.get('https://archiveofourown.org/works/' + iStoryId, function(oData) {
                        //console.log(oData);
                        // No need to add the link to the last chapter as it's already part of AO3 functionality
        ...
        else if(jQuery('ul.work').length && !jQuery('ul.index').length)
        {
