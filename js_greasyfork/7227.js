...
// @author      StandNThrow
// @version    	1.30
// @description An advance user script to automate sounding the hunter horn in MouseHunt application in Facebook with MouseHunt version 3.0 (Longtail) supported and many other features. Enhanced version by Ooi, original creator.
...
// @downloadURL https://update.greasyfork.org/scripts/7227/Mousehunt%20Bot.user.js
// @updateURL https://update.greasyfork.org/scripts/7227/Mousehunt%20Bot.meta.js
// ==/UserScript==
...
function exeScript()
{
	...
	else if (mhPlatform)
	{
		if (window.location.href == "http://www.mousehuntgame.com/" ||
			...
			window.location.href.indexOf("mousehuntgame.com/") != -1)
			/*
...
function embedTimer(targetPage)
{
	if (showTimerInPage)
	{
		...
		if (headerElement)
		{
			...
			{
				titleElement.innerHTML = "<b>MouseHunt AutoBot (version " + scriptVersion + ")</b></a> - <font color='red'>Aggressive Mode</font>";
			}
			else
			{
				titleElement.innerHTML = "<b>MouseHunt AutoBot (version " + scriptVersion + ")</b></a>";
			}
