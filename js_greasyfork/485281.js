// ==UserScript==
// @name         阿里云盘助手(罗根修复版)
// @namespace    https://github.com/Ocyss/ali-video
// @version      3.0.1
// @author       罗根大人, Ocyss
// @description  fork自罗根大人，自用修复版。aliyundrive全部重定向到alipan，支持生成文件下载链接、修改文件后缀,支持第三方播放器Artplayer(突破视频2分钟限制,长按倍速,选集,历史播放)
// @license      MIT
...
// @grant        unsafeWindow
// @downloadURL https://update.greasyfork.org/scripts/485281/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98%E5%8A%A9%E6%89%8B%28%E7%BD%97%E6%A0%B9%E4%BF%AE%E5%A4%8D%E7%89%88%29.user.js
// @updateURL https://update.greasyfork.org/scripts/485281/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98%E5%8A%A9%E6%89%8B%28%E7%BD%97%E6%A0%B9%E4%BF%AE%E5%A4%8D%E7%89%88%29.meta.js
// ==/UserScript==

(t=>{const e=document.createElement("style");e.dataset.source="vite-plugin-monkey",e.innerText=t,document.head.appendChild(e)})(".icon-wrapper--3dbbo[data-v-8f28cc94]{height:28px;width:28px;display:-ms-flexbox;display:flex;border-radius:5px;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;color:var(--context_secondary);position:absolute;top:18px;right:16px;-webkit-transition:all .3s ease;-o-transition:all .3s ease;transition:all .3s ease;cursor:pointer;z-index:10}.notice2[data-v-8f28cc94]{margin:2px 0 0;color:red;font-size:8pt}.close-icon--33bP0[data-v-8f28cc94]{font-size:18px}.icon--d-ejA[data-v-8f28cc94]{display:-ms-inline-flexbox;display:inline-flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;text-align:center}.content-wrapper--1_WJv[data-v-8f28cc94]{display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-align:center;align-items:center}.notice[data-v-d83efe4b]{color:#6592f9;font-size:10pt}.notice1[data-v-d83efe4b]{margin:2px 0 0;color:#e6a23c;font-size:8pt}.notice2[data-v-d83efe4b]{margin:2px 0 0;color:red;font-size:8pt}.footer[data-v-d83efe4b]{height:68px;background:var(--background_secondary_blur);-webkit-backdrop-filter:blur(30px);backdrop-filter:blur(30px);margin:-20px;padding:0 20px;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:justify;justify-content:space-between;border-radius:0 0 10px 10px}.notice1[data-v-57160a75]{margin:2px 0 0;color:#e6a23c;font-size:8pt}.breadcrumb-item--tV9dn[data-v-57160a75]{font-size:12px}.td--SGrZj[data-v-57160a75]{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-negative:0;flex-shrink:0;height:52px;position:relative}.td---v-kp[data-v-57160a75]{position:relative;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-negative:0;flex-shrink:0;padding:0 24px}.cover--Mn1Bt[data-v-57160a75]{margin-right:20px}.folder-cover--ExDmp[data-v-57160a75]{position:relative;display:-ms-flexbox;display:flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;-ms-flex-negative:0;flex-shrink:0;-ms-flex-positive:0;flex-grow:0}.folder-cover--ExDmp[data-size=XXS][data-v-57160a75],.folder-cover--ExDmp[data-size=XXS] .fileicon--Ob-Oj[data-v-57160a75]{width:28px;height:28px}.fileicon---webs[data-v-57160a75]{max-width:100%;max-height:100%}.breadcrumb-wrap--Uq5Lb[data-v-57160a75]{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;font-size:16px;line-height:1.4;width:100%;overflow:hidden;position:relative}.breadcrumb-wrap--Uq5Lb[data-align=left][data-v-57160a75]{-ms-flex-pack:start;justify-content:flex-start}.breadcrumb-wrap--Uq5Lb .breadcrumb--gnRPG[data-v-57160a75]{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;min-width:24px}.breadcrumb-item--j8J5H[data-v-57160a75]{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;white-space:nowrap;color:var(--context_tertiary);cursor:pointer}.breadcrumb-item--j8J5H:first-child .breadcrumb-item-link--9zcQY[data-v-57160a75]{font-weight:500}.breadcrumb-item--j8J5H .breadcrumb-item-link--9zcQY[data-v-57160a75]{font-weight:400;line-height:1.4;-webkit-transition:all .3s ease;-o-transition:all .3s ease;transition:all .3s ease}.breadcrumb-item--j8J5H .breadcrumb-item-separator--MnbFV[data-v-57160a75]{line-height:1.4;margin:0 8px}.card[data-v-152c05f8]{margin-bottom:10px}.player[data-v-d648fbfe]{display:flex;height:100%;align-items:center;justify-content:center;flex-direction:column}.notice[data-v-f4968c85]{color:#6592f9;font-size:8pt}.notice2[data-v-f4968c85]{color:red;font-size:8pt}.notice[data-v-62c7214b]{color:#6592f9;font-size:10pt}.notice1[data-v-62c7214b]{margin:2px 0 0;color:#e6a23c;font-size:8pt}.notice2[data-v-62c7214b]{margin:2px 0 0;color:red;font-size:8pt}.footer[data-v-62c7214b]{height:68px;background:var(--background_secondary_blur);-webkit-backdrop-filter:blur(30px);backdrop-filter:blur(30px);margin:-20px;padding:0 20px;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:justify;justify-content:space-between;border-radius:0 0 10px 10px}");
...
(function(elementPlus, $2, axios2, vue, Hls2, Artplayer2) {
  ...
  const Aria2Set_vue_vue_type_style_index_0_scoped_8f28cc94_lang = "";
  ...
  const _withScopeId$4 = (n) => (vue.pushScopeId("data-v-8f28cc94"), n = n(), vue.popScopeId(), n);
  const _hoisted_1$6 = {
    key: 0,
  ...
  const Aria2Set = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-8f28cc94"]]);
  const DwoloadPage_vue_vue_type_style_index_0_scoped_d83efe4b_lang = "";
  const _withScopeId$3 = (n) => (vue.pushScopeId("data-v-d83efe4b"), n = n(), vue.popScopeId(), n);
  ...
  const _sfc_main$6 = {
    ...
    setup(__props) {
      ...
      function IDMPush() {
        var content = "", referer = "https://www.alipan.com/", userAgent = navigator.userAgent;
        fileList2.forEach(function(item, index) {
  ...
  const DwoloadPage = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-d83efe4b"]]);
...
<svg viewBox="0 0 1024 1024"><use xlink:href="#PDSPlayCircle"></use></svg>
  ...
  const SubTitle_vue_vue_type_style_index_0_scoped_57160a75_lang = "";
  const _withScopeId$2 = (n) => (vue.pushScopeId("data-v-57160a75"), n = n(), vue.popScopeId(), n);
  ...
  const _sfc_main$5 = {
    ...
    setup(__props, { expose, emit }) {
        ...
        try {
          ...
          search({
            ...
            if (parent_file_id == "root") {
              url.value = "https://www.alipan.com/drive/file/backup";
            } else {
              url.value = "https://www.alipan.com/drive/file/backup/" + parent_file_id;
            }
          }).catch((e) => {
            console.log(e);
            if (e && e + "" == "AxiosError: Request failed with status code 429") {
      ...
      function toUrlFile() {
        var link = url.value;
        if (link == "https://www.alipan.com/drive") {
  ...
  const SubTitle = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-57160a75"]]);
  ...
  const Selector_vue_vue_type_style_index_0_scoped_152c05f8_lang = "";
  ...
  const VideoPage_vue_vue_type_style_index_0_scoped_d648fbfe_lang = "";
  const _sfc_main$3 = {
    __name: "VideoPage",
    setup(__props) {
        ...
        homeWidgets().then((res) => {
          if (res.data && res.data.recentUsed) {
            ...
            videoList = videoList.map((item) => {
              let href = "https://www.alipan.com/drive/";
              if (item.compilationId) {
                ...
                href = "https://www.alipan.com/drive/folder/" + compilationId;
              }
              return {
                "category": "video",
                "name": item.name,
  ...
  let shareId = function() {
    ...
    var match = url.match(/alipan\.com\/s\/([a-zA-Z\d]+)/);
  ...
  const SignInPage_vue_vue_type_style_index_0_scoped_f4968c85_lang = "";
  const _withScopeId$1 = (n) => (vue.pushScopeId("data-v-f4968c85"), n = n(), vue.popScopeId(), n);
  const _hoisted_1$1 = {
    key: 0,
    class: "notice"
  };
  ...
  const apiConfig = () => {
    axios2.defaults.baseURL = "https://api.alipan.com";
    interceptRequest();
  };
  var exports$2 = {};
  ...
  const ConfigSessionDialog_vue_vue_type_style_index_0_scoped_62c7214b_lang = "";
  const _withScopeId = (n) => (vue.pushScopeId("data-v-62c7214b"), n = n(), vue.popScopeId(), n);
  ...
  function start() {
    ...
    if (currentURL.startsWith("https://www.aliyundrive.com/")) {
      window.location.href = currentURL.replace("https://www.aliyundrive.com/", "https://www.alipan.com/");
    }
    let token = user.getToken();
    if (token == null) {
    ...
    apiConfig();
    console.log(`${"\n"} %c ali.video.user.js v${"3.0.1"} 罗根大人 %c https://greasyfork.org/zh-CN/scripts/458626  ${"\n"}${"\n"}`, "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;");
