...
// @name        HARMONIA_DMG
// @namespace   localhost
// @description HARMONIA_DMG_info
// @include     https://harmonia.e-sim.net/militaryUnitStorage.html*
// @include     https://harmonia.e-sim.org/militaryUnitStorage.html
// @version     1
// @downloadURL https://update.greasyfork.org/scripts/33363/HARMONIA_DMG.user.js
// @updateURL https://update.greasyfork.org/scripts/33363/HARMONIA_DMG.meta.js
// ==/UserScript==
...
$(document).ready(function() {
	...
	// JSONP betöltése
    var url = "https://mkhl.php5.sk/HARMONIA/dmg_harmonia.php?callback=parseRequest";
    var script = document.createElement("script");  
