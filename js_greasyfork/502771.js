...
// @downloadURL https://update.greasyfork.org/scripts/502771/jav%E6%B8%85%E5%8D%95111.user.js
// @updateURL https://update.greasyfork.org/scripts/502771/jav%E6%B8%85%E5%8D%95111.meta.js
// ==/UserScript==
...
(function () {
    ...
    if (videoUrl.indexOf('javdb') > -1) {
        ...
        videoTitle = document
            .getElementsByClassName('post-title text')[0]
            .children[0].innerHTML.slice(document.getElementsByClassName('post-title text')[0].children[0].innerHTML.indexOf(' ') + 1);
    ...
    allValue.forEach(function (obj, i) {
        //数组
        var newListEle = {};
    ...
    newArray.forEach(function (obj, i) {
        //数组
        Object.values(GM_getValue(obj.name)).forEach(function (value, index) {
            //数组
    ...
    function listssettings() {
        ...
        newArray.forEach(function (value, i) {
            ...
            list.className = 'name';
            Object.values(GM_getValue(value.name)).forEach(function (value1, index1) {
                //数组
                //console.log(value.fanhao);
    ...
    function compare1(propertyName, m, n) {
        //番号排序逆序
        return function (object1, object2) {
            var value1;
            var value2;
    ...
    var showList = function (data, listname, n, s) {
        var listpageEle = document.getElementById('listpage');
        if (listpageEle) {
            listpageEle.style = '';
            listpageEle.innerHTML = '';
        } else {
            listpageEle = document.createElement('div');
            listpageEle.id = 'listpage';
            listpageEle.className = 'listpage';
            document.documentElement.appendChild(listpageEle); //元素加入body
        }
        ...
        downloadtxt.addEventListener('click', () => {
            GM_getValue(listname).forEach(function (value, i) {
                //数组
        ...
        if (s == 1) sortfanhao.style.color = '#d1d1d1';
        else sortfanhao.style.color = '#000';
        ...
        if (s == 2) sorttimerorder.style.color = '#d1d1d1';
        else sorttimerorder.style.color = '#000';
        ...
        if (s == 3) sorttimerreversedorder.style.color = '#d1d1d1';
        else sorttimerreversedorder.style.color = '#000';
        ...
        if (s == 4) sortaddtimerorder.style.color = '#d1d1d1';
        else sortaddtimerorder.style.color = '#000';
        ...
        if (s == 5) sortaddtimerreversedorder.style.color = '#d1d1d1';
        else sortaddtimerreversedorder.style.color = '#000';
        ...
        divc.style.marginLeft = 'auto';
        divc.style.marginRight = '15px';
        ...
        listpageEle.appendChild(newDiv);
        ...
        function paginationByJS(data, div, currentPage, pageCount, list, li) {
            ...
            function createBtn(totalPage) {
                ...
                newUl.id = 'pagination-list';
                newUl.className = 'pagination-list';
                listpageEle.appendChild(newUl);
            ...
            function displayData() {
                ...
                arr.forEach(i => {
                    ...
                    img2.className = 'cover bigCover';
                    img1.src = img2.src = i.cover;
