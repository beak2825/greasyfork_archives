// ==UserScript==
// @name         moomoo auto aim / aimbot for bows and auto heal, working after patch
// @namespace    -
// @version      1.2.1.1
...
// @match        *://moomoo.io/*
// @grant        none
// @downloadURL https://update.greasyfork.org/scripts/30969/moomoo%20auto%20aim%20%20aimbot%20for%20bows%20and%20auto%20heal%2C%20working%20after%20patch.user.js
// @updateURL https://update.greasyfork.org/scripts/30969/moomoo%20auto%20aim%20%20aimbot%20for%20bows%20and%20auto%20heal%2C%20working%20after%20patch.meta.js
// ==/UserScript==
...
function handleMessage(e){
    ...
    if (parsed[0] === "3"){ //position update
        ...
        if ((state === EnumStates.AIM || state === EnumStates.BOTH) && playersNear.length > 0){
            ...
            if (closestPlayer.getDistance() < 1250 && (closestPlayer.tribe !== user.tribe || user.tribe === null)) aimAt(closestPlayer);
        }
    }
    if (parsed[0] === "1" && !id){
        id = parsed[1];
