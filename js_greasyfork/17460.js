// ==UserScript==
// @name         ZeroRegrets Extension.
// @version      1.0
// @namespace    Zr
// @description  ZeroRegrets extension
...
// @downloadURL https://update.greasyfork.org/scripts/17460/ZeroRegrets%20Extension.user.js
// @updateURL https://update.greasyfork.org/scripts/17460/ZeroRegrets%20Extension.meta.js
// ==/UserScript==
//This script is not by krayton it is edited by krayton and P2W for ZeroRegrets.
//Enjoy the ext <3
function loadScript(a, b) {
    ...
    var lb = $("div.header").replaceWith('<div id="Agar.ioHeader" class="header" style="color:#FFFFFF; font-size:35px;"><b>Leaderboard</b></div>');
    ...
    $("#NEL99YtChannelPanel").append('<script src="https://apis.google.com/js/platform.js"></script><div class="g-ytsubscribe" data-channelid="UC6xue0QvR1-Kg9RKnFJ7KJQ" data-layout="full" data-theme="dark" data-count="default" style="text-indent: 0px; margin: 0px; padding: 0px; border-style: none; float: none; line-height: normal; font-size: 1px; vertical-align: baseline; display: inline-block; width: 163px; height: 48px; background: transparent;"><iframe frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" style="position: static; top: 0px; width: 163px; margin: 0px; border-style: none; left: 0px; visibility: visible; height: 40px;"></div>');
    var tt = $("div#mainPanel.agario-panel").prepend('<h2 id="NEL99Title" style="color:#00ffe1; text-align:center; font-size: 50px"><b>ZeroRegrets</b></h2><sup><h4 id="NEL99Subtitle" style="text-align:right">Edited By P2W&Krayton</h4></sup>');
    ...
    var tt = $("div#mainPanel.agario-panel").prepend('<h2 id="NEL99text" style="color:#b92b1a; text-align: left; font-size: 20px"><b>TS3:ZeroRegrets.freets.xyz</b></h2><sup><h5 id="NEL99Subtitle" style="text-align:right">Join teamspeak to become a member.</h5></sup>');
