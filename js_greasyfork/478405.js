// ==UserScript==
// @name         HACK DUO TIẾNG VIỆT V5
// @namespace    Violentmonkey Scripts
// @version      5.9
// @author      lê minh châu 5B
// @description Hack Duo v5[tự động hack trong duolingo]
// @match       https://*.duolingo.com/*
// @grant       none
// @downloadURL https://update.greasyfork.org/scripts/478405/HACK%20DUO%20TI%E1%BA%BENG%20VI%E1%BB%86T%20V5.user.js
// @updateURL https://update.greasyfork.org/scripts/478405/HACK%20DUO%20TI%E1%BA%BENG%20VI%E1%BB%86T%20V5.meta.js
// ==/UserScript==
    ...
    if (original === undefined) {
        ...
        if (storiesContinue === undefined) {
            ...
            solveAllButton.addEventListener('click', () => {
                ...
                setInterval(() => {
                    const startButton = document.querySelector('[data-test="start-button"]');
                    if (startButton && startButton.innerText.startsWith("BẮT ĐẦU")) {
                        startButton.click();
                    }
                }, 1000);
                startButton.click();
...
//        const wrapper = document.getElementsByClassName('_10vOG')[0];
        ...
        solveCopy.innerHTML = solvingIntervalId ? 'ĐANG LÀM TẤT CẢ' : 'LÀM TẤT CẢ';
        solveCopy.disabled = false;
        pauseCopy.innerHTML = 'LÀM 1 CÂU';
...
<div class="boxFirst">
    <a href="https://duolingoprowebsite.framer.website" target="_blank" rel="noopener noreferrer">
        <div class="SeeRoadmapButton">
            <p class="SeeRoadmapButtonTextOne">XEM VẤN ĐỀ & LỘ TRÌNH</p>
            <div class="SendFeedbackButtonNewTagOne">
                <p class="SendFeedbackButtonNewTagOneTextOne">MỚI</p>
            </div>
        </div>
    </a>
    <div class="SendFeedbackButtonAndSettingsButtonBox">
        <div class="SendFeedbackButtonOne">
            <p class="SendFeedbackButtonTextOne">GỬI PHẢN HỒI</p>
        </div>
        <div class="DuolingoProSettingsButtonOne">
            <p class="DuolingoProSettingsButtonOneTextOne">CÀI ĐẶT</p>
            <div class="SendFeedbackButtonNewTagOne">
                <p class="SendFeedbackButtonNewTagOneTextOne">MỚI</p>
            </div>
        </div>
...
<path id="Vector" d="M2.74565 18.5C2.18774 18.5 1.70193 18.3759 1.2882 18.1276C0.880737 17.8857 0.564169 17.5569 0.338504 17.1411C0.112839 16.7316 0 16.2786 0 15.7823C0 15.3045 0.125376 14.8485 0.376113 14.4142L7.64456 1.86814C7.90157 1.4152 8.24008 1.07394 8.66007 0.844363C9.0863 0.614788 9.53451 0.5 10.0047 0.5C10.4686 0.5 10.9105 0.614788 11.3305 0.844363C11.7505 1.07394 12.0921 1.4152 12.3554 1.86814L19.6238 14.4142C19.7493 14.6313 19.8432 14.8578 19.9059 15.0936C19.9686 15.3231 20 15.5527 20 15.7823C20 16.2786 19.8872 16.7316 19.6615 17.1411C19.4358 17.5569 19.1161 17.8857 18.7024 18.1276C18.2949 18.3759 17.8122 18.5 17.2543 18.5H2.74565ZM10.0141 11.9943C10.6159 11.9943 10.9293 11.6841 10.9543 11.0635L11.1048 6.66132C11.1174 6.35728 11.017 6.10599 10.8039 5.90743C10.597 5.70268 10.3307 5.60031 10.0047 5.60031C9.67249 5.60031 9.40289 5.69958 9.19607 5.89813C8.98915 6.09668 8.892 6.35108 8.90452 6.66132L9.04557 11.0635C9.0707 11.6841 9.39345 11.9943 10.0141 11.9943ZM10.0141 15.2704C10.3526 15.2704 10.6409 15.168 10.8791 14.9632C11.1174 14.7523 11.2365 14.4824 11.2365 14.1535C11.2365 13.8309 11.1174 13.5641 10.8791 13.3532C10.6409 13.1421 10.3526 13.0367 10.0141 13.0367C9.66931 13.0367 9.37786 13.1421 9.13964 13.3532C8.90143 13.5641 8.78233 13.8309 8.78233 14.1535C8.78233 14.4824 8.90143 14.7523 9.13964 14.9632C9.38411 15.168 9.67557 15.2704 10.0141 15.2704Z"/>
                    ...
                    <p class="AutoSolverBoxAlertOneBoxTextOne">Chưa được hỗ trợ</p>
                </div>
...
<path id="Vector" d="M9.99998 20.5C8.63214 20.5 7.34419 20.2378 6.13613 19.7134C4.92808 19.1953 3.86384 18.476 2.94343 17.5551C2.023 16.6342 1.30073 15.5727 0.776601 14.3705C0.258868 13.1619 0 11.8701 0 10.4952C0 9.12667 0.258868 7.84131 0.776601 6.63907C1.30073 5.43044 2.01981 4.3657 2.93384 3.44483C3.85426 2.52398 4.91849 1.80455 6.12655 1.28657C7.3346 0.762189 8.62255 0.5 9.99039 0.5C11.3582 0.5 12.6462 0.762189 13.8543 1.28657C15.0687 1.80455 16.1329 2.52398 17.0469 3.44483C17.9674 4.3657 18.6896 5.43044 19.2138 6.63907C19.7379 7.84131 20 9.12667 20 10.4952C20 11.8701 19.7379 13.1619 19.2138 14.3705C18.6896 15.5727 17.9674 16.6342 17.0469 17.5551C16.1329 18.476 15.0719 19.1953 13.8639 19.7134C12.6558 20.2378 11.3678 20.5 9.99998 20.5ZM9.99998 12.0588C10.6136 12.0588 10.9332 11.739 10.9588 11.0995L11.1121 6.56234C11.1249 6.24899 11.0227 5.99 10.8054 5.78535C10.5944 5.57433 10.3228 5.46881 9.99039 5.46881C9.65163 5.46881 9.37678 5.57113 9.16585 5.77576C8.95492 5.98039 8.85584 6.24259 8.86863 6.56234L9.01244 11.0995C9.03802 11.739 9.36719 12.0588 9.99998 12.0588ZM9.99998 15.4352C10.3451 15.4352 10.6392 15.3297 10.8821 15.1186C11.1249 14.9013 11.2464 14.623 11.2464 14.2841C11.2464 13.9516 11.1249 13.6766 10.8821 13.4592C10.6392 13.2417 10.3451 13.1331 9.99998 13.1331C9.64843 13.1331 9.35122 13.2417 9.10832 13.4592C8.86544 13.6766 8.74399 13.9516 8.74399 14.2841C8.74399 14.623 8.86544 14.9013 9.10832 15.1186C9.3576 15.3297 9.65483 15.4352 9.99998 15.4352Z"/>
                    ...
                    <p class="AutoSolverBoxAlertTwoBoxTextOne">Độ trễ 5s khi kích hoạt</p>
                </div>
                <div class="AutoSolverBoxAlertTwoBox">
                    <p class="AutoSolverBoxAlertTwoBoxTextOne" style="color: #34C759 !important;">Rương hiện được mở tự động bằng Trình duyệt Chrome</p>
                </div>
            </div>
            <div class="AutoSolverBoxTitleSectionOne">
                <p class="AutoSolverBoxTitleSectionOneTextOne">Tự Động Hack</p>
                <div class="AutoSolverBoxTitleSectionOneBETATagOne">
                    <p class="AutoSolverBoxTitleSectionOneBETATagOneTextOne">5.0</p>
                </div>
            </div>
            <p class="AutoSolverBoxTitleSectionTwoTextOne">Bạn muốn Tự Động Hack bao nhiêu bài học?</p>
            <div class="AutoSolverBoxSectionThreeBox">
                ...
                <div class="AutoSolverBoxSectionThreeBoxSectionTwo" id="AutoSolverBoxSectionThreeBoxSectionTwoIDOne">
                    <div class="AutoSolverBoxSectionThreeBoxSectionTwoTextOne">Chế độ chỉ thực hành</div>
                ...
                <div class="AutoSolverBoxSectionThreeBoxSectionTwo" id="AutoSolverBoxSectionThreeBoxSectionTwoIDTwo">
                    <div class="AutoSolverBoxSectionThreeBoxSectionTwoTextOne">Chế độ lặp lại bài học</div>
                    <button class="AutoSolverBoxSectionThreeBoxSectionTwoButton" id="AutoSolverBoxSectionThreeBoxSectionTwoButtonIDTwo">ON</button>
                </div>
                <button class="AutoSolverBoxRepeatStartButton">BẮT ĐẦU</button>
            </div>
        </div>
    </div>
</div>
...
.DuolingoProSettingsButtonOneTextOne {
    ...
    user-select: none; // chrome and coccoc
...
function initializeAutoSolverBoxButtonInteractiveness() {
    ...
    if (autoSolverBoxRepeatAmount === 0 && !DuolingoProShadeLessonsMode) {
        wasAutoSolverBoxRepeatStartButtonPressed = false;
        sessionStorage.setItem('wasAutoSolverBoxRepeatStartButtonPressed', wasAutoSolverBoxRepeatStartButtonPressed);
        AutoSolverBoxRepeatStartButton.textContent = 'BẮT ĐẦU';
    }
 
    if (wasAutoSolverBoxRepeatStartButtonPressed === true) {
        AutoSolverBoxRepeatStartButton.textContent = 'DỪNG';
    ...
    AutoSolverBoxRepeatStartButton.addEventListener('click', () => {
        if (autoSolverBoxRepeatAmount > 0 || DuolingoProShadeLessonsMode) {
            AutoSolverBoxRepeatStartButton.textContent = AutoSolverBoxRepeatStartButton.textContent === 'BẮT ĐẦU' ? 'DỪNG' : 'BẮT ĐẦU';
    ...
    <div class="SendFeebackBoxBackground">
        <div class="SendFeebackBoxLayers">
            ...
            <div class="SendFeebackBoxSectionOne">
                <p class="SendFeebackBoxSectionOneTextOne">Gửi phản hồi cho tự động duo</p>
                ...
                <textarea class="SendFeebackBoxSectionTwo" id="SendFeebackBoxSectionTwoID" placeholder="Viết ở đây càng nhiều càng tốt với càng nhiều chi tiết càng tốt. Những câu trả lời ít hơn hai câu sẽ tự động bị xóa. Báo cáo lỗi không nêu rõ Khóa học và Trình duyệt web của bạn sẽ tự động bị bỏ qua."/></textarea>
 
                <p class="SendFeebackBoxSectionThree">Chọn loại phản hồi</p>
                ...
                <div class="SendFeebackBoxSectionFour">
                    <div class="SendFeebackBoxSectionFourButtonOneBackground" id="SendFeebackTypeButtonOne">
                        ...
                        <p class="SendFeebackBoxSectionFourButtonOneTextOne">Báo cáo lỗi</p>
                    </div>
                    <div class="SendFeebackBoxSectionFourButtonOneBackground" id="SendFeebackTypeButtonTwo">
                        <div class="SendFeebackBoxSectionFourButtonOneIconOne"/></div>
                        <p class="SendFeebackBoxSectionFourButtonOneTextOne">Gợi ý</p>
                    </div>
                </div>
 
                <!-- SINGLE LINE TEXT FIELD -->
                <p class="SendFeebackBoxSectionThree">Chọn ID người gửi</p>
                <div class="SendFeebackBoxSectionSix">
                    <div class="SendFeebackBoxSectionSixIconOneBox">
                        <div class="SendFeebackBoxSectionSixIconOne">
                        </div>
                    </div>
                    <div class="SendFeebackBoxSectionSixTextOne">ProID Duolingo của tôi <a href="https://duolingoprowebsite.framer.website/proID" target="_blank" rel="noopener noreferrer" style="color: rgb(255, 255, 255, 0.6); font-size: 16px; font-style: normal; font-weight: 700; line-height: normal;">&nbsp;(HỌC HỎI&nbsp;HƠN)</a></div>
...
<path d="M8 16.4536C3.75928 16.4536 0.265625 12.96 0.265625 8.71191C0.265625 4.47119 3.75195 0.977539 8 0.977539C12.2407 0.977539 15.7344 4.47119 15.7344 8.71191C15.7344 12.96 12.248 16.4536 8 16.4536ZM7.80225 10.1548C8.29297 10.1548 8.62988 9.89844 8.68848 9.56152C8.68848 9.53223 8.6958 9.49561 8.6958 9.47363C8.76172 9.12939 9.07666 8.88037 9.50879 8.59473C10.2998 8.09668 10.7173 7.66455 10.7173 6.80762C10.7173 5.52588 9.53076 4.71289 8.05127 4.71289C6.73291 4.71289 5.79541 5.26953 5.50244 6.0166C5.44385 6.16309 5.40723 6.30225 5.40723 6.46338C5.40723 6.88086 5.73682 7.1958 6.16162 7.1958C6.46924 7.1958 6.71094 7.07861 6.88672 6.84424L6.96729 6.73438C7.21631 6.36084 7.5166 6.20703 7.88281 6.20703C8.36621 6.20703 8.71777 6.51465 8.71777 6.91748C8.71777 7.34961 8.39551 7.55469 7.77295 7.97949C7.23828 8.36035 6.85742 8.73389 6.85742 9.33447V9.38574C6.85742 9.89111 7.19434 10.1548 7.80225 10.1548ZM7.80225 12.6304C8.38086 12.6304 8.82764 12.2642 8.82764 11.7002C8.82764 11.1509 8.38818 10.77 7.80225 10.77C7.21631 10.77 6.75488 11.1436 6.75488 11.7002C6.75488 12.2568 7.21631 12.6304 7.80225 12.6304Z"/>
                ...
                <div class="SendFeebackBoxSectionSeven">
                    <div class="SendFeebackBoxSectionSevenBoxTwo">
                        ...
                        <p class="SendFeebackBoxSectionSevenBoxTwoTextOne">Vô danh (Không có sẵn trong phiên bản trải nghiệm)</p>
...
<path d="M8 16.4536C3.75928 16.4536 0.265625 12.96 0.265625 8.71191C0.265625 4.47119 3.75195 0.977539 8 0.977539C12.2407 0.977539 15.7344 4.47119 15.7344 8.71191C15.7344 12.96 12.248 16.4536 8 16.4536ZM7.80225 10.1548C8.29297 10.1548 8.62988 9.89844 8.68848 9.56152C8.68848 9.53223 8.6958 9.49561 8.6958 9.47363C8.76172 9.12939 9.07666 8.88037 9.50879 8.59473C10.2998 8.09668 10.7173 7.66455 10.7173 6.80762C10.7173 5.52588 9.53076 4.71289 8.05127 4.71289C6.73291 4.71289 5.79541 5.26953 5.50244 6.0166C5.44385 6.16309 5.40723 6.30225 5.40723 6.46338C5.40723 6.88086 5.73682 7.1958 6.16162 7.1958C6.46924 7.1958 6.71094 7.07861 6.88672 6.84424L6.96729 6.73438C7.21631 6.36084 7.5166 6.20703 7.88281 6.20703C8.36621 6.20703 8.71777 6.51465 8.71777 6.91748C8.71777 7.34961 8.39551 7.55469 7.77295 7.97949C7.23828 8.36035 6.85742 8.73389 6.85742 9.33447V9.38574C6.85742 9.89111 7.19434 10.1548 7.80225 10.1548ZM7.80225 12.6304C8.38086 12.6304 8.82764 12.2642 8.82764 11.7002C8.82764 11.1509 8.38818 10.77 7.80225 10.77C7.21631 10.77 6.75488 11.1436 6.75488 11.7002C6.75488 12.2568 7.21631 12.6304 7.80225 12.6304Z"/>
                ...
                <div class="SendFeedbackBoxSectionEight">
                    <a class="SendFeebackBoxSectionEightEmailButton" href="mailto:sungv35879@gmail.com">LIÊN HỆ QUA EMAIL</a>
                    <button class="SendFeebackBoxSectionEightSendButton" id="SendFeebackBoxSectionEightSendButton">GỬI</button>
                </div>
                ...
                if (isSendFeebackBoxSectionEightSendButtonEnabled) {
                    ...
                    function checkFlag() {
                        if (sendFeedbackStatus === 'trying') {
                            SendFeebackBoxSectionEightSendButton.textContent = 'ĐÃ GỬI';
                            setTimeout(function() {
                                checkFlag();
                            }, 100);
                        } else if (sendFeedbackStatus === 'true') {
                            SendFeebackBoxSectionEightSendButton.textContent = 'ĐÃ GỬI THÀNH CÔNG';
                            setTimeout(function() {
                                location.reload();
                            }, 1000);
                        } else if (sendFeedbackStatus === 'error') {
                            SendFeebackBoxSectionEightSendButton.textContent = 'GỬI BỊ LỖI';
                            ...
                            setTimeout(function() {
                                SendFeebackBoxSectionEightSendButton.textContent = 'THỬ LẠI';
                            }, 2000);
 
                            setTimeout(function() {
                                SendFeebackBoxSectionEightSendButton.textContent = 'GỬI';
    ...
    <div class="WhatsNewBoxOneBackground">
        <div class="WhatsNewBoxOneSectionOne">
            ...
            <div class="WhatsNewBoxOneSectionOneBoxOne">
                <p class="WhatsNewBoxOneSectionOneBoxOneTextOne">2.0 BETA 8</p>
            </div>
        </div>
...
function modifyWhatsNewBox() {
    ...
    if (whatsNewInBetaStage === 1) {
        WhatsNewBoxOneSectionThreeTextOne.textContent = 'Sửa lỗi lớn';
        WhatsNewBoxOneSectionThreeTextTwo.textContent = 'Duo tiếng việt v5 có các bản sửa lỗi cho các lỗi phổ biến chính khiến các nút TỰ LÀM BÀI, LÀM 1 CÂU và LÀM TẤT CẢ không thể giải quyết một số câu hỏi nhất định.';
        WhatsNewBoxOneSectionTwoImageOneURL.src = 'https://framerusercontent.com/images/oaXxGJyRWwPc6cFDUM3fPxlDI.png';
        WhatsNewBoxOneSectionFourTextOne.textContent = 'KẾ TIẾP';
    } else if (whatsNewInBetaStage === 2) {
        WhatsNewBoxAnimations();
        setTimeout(function() {
            WhatsNewBoxOneSectionThreeTextOne.textContent = 'Chế độ hiệu suất thấp';
            WhatsNewBoxOneSectionThreeTextTwo.textContent = 'Chế độ hiệu suất thấp cho phép Duo và Duo v5 sử dụng ít sức mạnh xử lý hơn bằng cách hạn chế hoạt ảnh và tác vụ nền. Điều này có thể giảm độ trễ trên một số thiết bị cấp thấp hơn. Bạn có thể bật tính năng này trong Cài đặt Duo v5.';
            WhatsNewBoxOneSectionTwoImageOneURL.src = 'https://framerusercontent.com/images/yxmX51WMXqAJmg5DvHXzPR5aQak.png';
            WhatsNewBoxOneSectionFourTextOne.textContent = 'ĐÓNG';
        }, 100);
    } else {
        let WhatsNewBoxOneWholeDiv = document.querySelector('.WhatsNewBoxOneShadow');
        setTimeout(function() {
    ...
    <div class="DuolingoProSettingsBoxBackground">
        <div class="DuolingoProSettingsBoxLayers">
            <div class="DuolingoProSettingsBoxSectionOne">
                <p class="DuolingoProSettingsBoxSectionOneTextOne">Cài đặt (có thể cuộn)</p>
                <div class="DuolingoProSettingsBoxSectionOneBoxOne">
                    <p class="DuolingoProSettingsBoxSectionOneBoxOneTextOne">5.0</p>
                </div>
            </div>
            <div class="DuolingoProSettingsBoxSectionTwo">
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextThree">NÊN DÙNG</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Hiển thị Hộp Tự Động Hack</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">AutoSolver Box giúp việc giải quyết các câu hỏi một cách tự động dễ dàng hơn.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Hiển thị Chế độ Chỉ Thực hành cho Hộp HACK DUO</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">LƯU Ý: CHẾ ĐỘ NÀY HIỆN TẠI KHÔNG HOẠT ĐỘNG. HÃY TẮT TRỪ KHI BẠN MUỐN THỬ. Chế độ luyện tập cho phép AutoSolver chỉ thực hiện các bài luyện tập và lặp lại chúng.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextThree">NÊN DÙNG</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Hiển thị Chế độ Bài học Lặp lại cho Hộp Hack Duo</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Chế độ bài học lặp lại cho phép AutoSolver chỉ thực hiện một bài học đã định sẵn và lặp lại nó. Chế độ này cải thiện khả năng AutoSolver KHÔNG bị mắc kẹt ở loại câu hỏi không được hỗ trợ. Chúng tôi khuyên bạn nên sử dụng chế độ này với khóa học tiếng Tây Ban Nha/Pháp/Đức từ tiếng Anh NẾU mục tiêu chính của bạn là tự mình đạt được nhiều XP nhất.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Chế độ hiệu suất thấp</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Ở chế độ hiệu suất thấp, Duolingo Pro giảm hoạt ảnh và tác vụ nền để giảm độ trễ. Chỉ nên dùng cho các thiết bị có hiệu suất thấp hơn.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextFour">MỚI</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">HIỆN PRO</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Chế độ giải quyết nhân tạo, nhờ <a style="color: #007AFF;">DŨNG</a>, từng bước giải quyết từng câu hỏi, giảm đáng kể khả năng bị bắt và bị cấm.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextThree">NÊN DÙNG</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Quảng cáo ProBlock của Duo Pro</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">ProBlock xóa quảng cáo bật lên trên các tab Duo chính như Học, Thực hành và Mua sắm.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextFour">THỬ NGHIỆM</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Chế độ giải quyết Turbo</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Turbo Giải quyết, nhờ <a style="color: #007AFF;">DŨNG</a>,cải thiện tốc độ Tự Động Giải Quyết và Giải Quyết Tất Cả lên tới 5 lần. Đây là một tính năng thử nghiệm.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Chế độ giải quyết nhân tạo</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Chế độ giải quyết nhân tạo, nhờ <a style="color: #007AFF;">DŨNG</a>, từng bước giải quyết từng câu hỏi, giảm đáng kể khả năng bị bắt và bị cấm.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextFour">THỬ NGHIỆM</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">chế độ chạy vô hạn lần</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo">Với Chế độ hạn dừng, Duo Pro tiếp tục giải mà không có bất kỳ giới hạn số nào đối với Hộp Tự động Giải.</p>
                    </div>
                ...
                <div class="DuolingoProSettingsBoxSectionTwoBoxOne">
                    <div class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOne">
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextOne">Người đóng góp</p>
                        <p class="DuolingoProSettingsBoxSectionTwoBoxOneBoxOneTextTwo"><a style="color: #007AFF;">VĂN TRỌNG DŨNG</a> ,<a style="color: #007AFF;">THỊ TRANG</a>và<a style="color: #007AFF;">VÂN :></a></p>
                    </div>
                </div>
            </div>
            <div class="DuolingoProSettingsBoxSectionThree">
                <div class="DuolingoProSettingsBoxCancelButton">
                    <p class="DuolingoProSettingsBoxCancelButtonTextOne">ĐÓNG</p>
                </div>
                <div class="DuolingoProSettingsBoxSaveButton">
                    <p class="DuolingoProSettingsBoxSaveButtonTextOne">LƯU</p>
                </div>
            </div>
        </div>
    </div>
        ...
        if (!injectedDuolingoProSettingsBoxElement) {
            ...
            DuolingoProSettingsBoxSaveButton.addEventListener('click', () => {
                ...
                if (JSON.parse(localStorage.getItem('AutoSolverSettingsShowAutoSolverBox')) !== AutoSolverSettingsShowAutoSolverBox) {
                    settingsStuff("Duolingo Pro AutoSolver Box", AutoSolverSettingsShowAutoSolverBox ? 'BẬT' : 'TẮT');
                }
                ...
                if (JSON.parse(localStorage.getItem('AutoSolverSettingsShowPracticeOnlyModeForAutoSolverBox')) !== AutoSolverSettingsShowPracticeOnlyModeForAutoSolverBox) {
                    settingsStuff("Duolingo Pro Practice Only Mode", AutoSolverSettingsShowPracticeOnlyModeForAutoSolverBox ? 'BẬT' : 'TẮT');
                }
                ...
                if (JSON.parse(localStorage.getItem('AutoSolverSettingsShowRepeatLessonModeForAutoSolverBox')) !== AutoSolverSettingsShowRepeatLessonModeForAutoSolverBox) {
                    settingsStuff("Duolingo Pro Repeat Lesson Mode", AutoSolverSettingsShowRepeatLessonModeForAutoSolverBox ? 'BẬT' : 'TẮT');
                }
 
                if (JSON.parse(localStorage.getItem('AutoSolverSettingsLowPerformanceMode')) !== AutoSolverSettingsLowPerformanceMode) {
                    settingsStuff("Duolingo Pro Low Performance Mode", AutoSolverSettingsLowPerformanceMode ? 'BẬT' : 'TẮT');
                }
 
                if (JSON.parse(localStorage.getItem('DuolingoProSettingsProBlockMode')) !== DuolingoProSettingsProBlockMode) {
                    settingsStuff("Duolingo Pro ProBlock", DuolingoProSettingsProBlockMode ? 'BẬT' : 'TẮT');
                }
 
                if (JSON.parse(localStorage.getItem('DuolingoProSettingsTurboSolveMode')) !== DuolingoProSettingsTurboSolveMode) {
                    settingsStuff("Duolingo Pro TurboSolve Mode", DuolingoProSettingsTurboSolveMode ? 'BẬT' : 'TẮT');
                }
 
                if (JSON.parse(localStorage.getItem('DuolingoProSettingsHumaneSolvingMode')) !== DuolingoProSettingsHumaneSolvingMode) {
                    settingsStuff("Duolingo Pro Humane Solving Mode", DuolingoProSettingsHumaneSolvingMode ? 'BẬT' : 'TẮT');
                }
 
                if (JSON.parse(localStorage.getItem('DuolingoProSettingsNeverEndMode')) !== DuolingoProSettingsNeverEndMode) {
                    settingsStuff("Duolingo Pro Never End Mode", DuolingoProSettingsNeverEndMode ? 'BẬT' : 'TẮT');
                }
                ...
                console.log('Lưu trữ');
                notificationCall("Đã lưu cài đặt mới", "Đang tải lại tab và áp dụng cài đặt mới.");
                ...
                DuolingoProSettingsBoxSaveButtonTextElement.textContent = 'ĐÃ LƯU';
...
function updateDuolingoProSettingsToggle(element, value) {
    ...
    if (element.id === 'DuolingoProSettingsBoxToggleThreeID') {
        textElement.textContent = value ? "CỬA 1" : "TẮT";
    } else {
        textElement.textContent = value ? "BẬT" : "TẮT";
    }
    if (value) {
        element.style.background = '#007AFF';
        element.style.border = '2px solid rgba(0, 0, 0, 0.20)';
...
function iwantstolol() {
    ...
    try {
        let noideathree = document.querySelector('.WOZnx _275sd _1ZefG vpDIE _2XF-t _2Zb01 _1y5Ll');
        if (noideathree) {
            noideathree.click();
        }
    } catch (error) {}
...
let duolingoProCurrentVersion = "2.0 BETA 8";
...
<div class="BlockBoxOne">
    <div class="BlockBoxOneSectionOne">
        <p class="BlockBoxOneSectionOneTextOne">Duo Pro đang làm việc chăm chỉ, <a style="color: #007AFF;">bây giờ bạn có thể treo máy</a></p>
        <p class="BlockBoxOneSectionOneTextTwo">Bảo vệ Chống bị vang và <a style="color: #007AFF;">mất acc</a></p>
    </div>
    <div class="BlockBoxOneSectionTwo">
        <div class="BlockBoxOneSectionTwoBoxOne">KẾT THÚC BÀI HỌC</div>
        <div class="BlockBoxOneSectionTwoBoxTwo">HIỂN THỊ BÀI HỌC</div>
    </div>
    ...
    if (window.location.pathname.includes('/lesson') && wasAutoSolverBoxRepeatStartButtonPressed) {
        if (!injectedDuolingoProShadeElement) {
            ...
            DuolingoProShadeEndLessonButton.addEventListener('click', () => {
                ...
                DuolingoProShadeEndLessonButton.textContent = 'KẾT THÚC HOÀN TOÀN BÀI HỌC'
            });
            ...
            if (DuolingoProShadeLessonsMode) {
                ...
                DuolingoProShadeStatusOne.textContent = '1 Bài học còn lại';
            } else if (autoSolverBoxRepeatAmount === 0) {
                DuolingoProShadeStatusOne.textContent = 'Bài học cuối cùng';
            } else if (autoSolverBoxRepeatAmount) {
                DuolingoProShadeStatusOne.textContent = String(autoSolverBoxRepeatAmount + ' Bài học còn lại');
            }
 
            antiStuckProtectionTimerFunction();
        }
    } else {
        // Remove the content if it was previously injected
        if (injectedDuolingoProShadeElement) {
...
function antiStuckProtectionTimerFunction() {
    setTimeout(function() {
...
<div class="DuolingoProJustSolveThisLessonButtonOne">TỰ ĐỘNG GIẢI BÀI HỌC NÀY</div>
`;
...
<div class="BlockedByDuolingoProBoxBackground" id="DuolingoProNotificationBackgroundOneID">
    <div class="BlockedByDuolingoProBoxSectionOne">
        ...
        <p class="BlockedByDuolingoProBoxSectionOneTextTwo" id="DuolingoProNotificationHideButtonOneID">HIỂN THỊ</p>
    </div>
...
async function solving(forceState) {
    if (isAutoMode == false || forceState == true) {
        ...
        solveAllButton.innerText = "ĐANG LÀM TẤT CẢ";
        isAutoMode = true;
        ...
        let solveLoop = async () => {
            if (isAutoMode == true && isSolving == false) {
                isSolving = true;
                document.getElementById("solveAllButton") ? document.getElementById("solveAllButton").innerText = "ĐANG LÀM TÂT CẢ": undefined;
                await solve();
        ...
        document.getElementById("solveAllButton").innerText = "LÀM TẤT CẢ";
        isAutoMode = false;
    }
}
